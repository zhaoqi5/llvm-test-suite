...
# %bb.0:                                # %entry
	...
	add.d	$a1, $a2, $a1
	ldx.b	$a2, $a3, $a0
	pcalau12i	$a3, %pc_hi20(_ZL12info_version)
	pcalau12i	$a4, %pc_hi20(info_language_standard_default)
	ld.d	$a4, $a4, %pc_lo12(info_language_standard_default)
	pcalau12i	$a5, %pc_hi20(info_language_extensions_default)
	ld.d	$a5, $a5, %pc_lo12(info_language_extensions_default)
	addi.d	$a3, $a3, %pc_lo12(_ZL12info_version)
	ldx.b	$a3, $a3, $a0
	ldx.b	$a4, $a4, $a0
	ldx.b	$a0, $a5, $a0
	add.d	$a1, $a1, $a2
