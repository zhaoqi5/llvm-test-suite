...
.LBB0_7:                                # %vector.body
	...
	xvfsub.s	$xr2, $xr3, $xr2
	xvfadd.s	$xr2, $xr2, $xr6
	xvreplgr2vr.w	$xr3, $t7
	xvfsub.s	$xr4, $xr7, $xr5
	xvreplgr2vr.w	$xr5, $t6
	xvfmul.s	$xr4, $xr4, $xr5
	xvfmadd.s	$xr2, $xr2, $xr3, $xr4
	xvst	$xr2, $a5, 0
	addi.d	$a5, $a5, 32
	addi.d	$s7, $s7, -8
	addi.d	$a0, $a0, 32
...
# %bb.43:                               # %middle.block522
                                        #   in Loop: Header=BB0_37 Depth=1
	beq	$t6, $t2, .LBB0_36
# %bb.44:                               # %vec.epilog.iter.check526
                                        #   in Loop: Header=BB0_37 Depth=1
	move	$s1, $t6
	move	$t1, $t6
	beqz	$a2, .LBB0_48
.LBB0_45:                               # %vec.epilog.ph528
                                        #   in Loop: Header=BB0_37 Depth=1
	add.d	$a5, $s6, $s1
	alsl.d	$t1, $s1, $a7, 2
	alsl.d	$t4, $s1, $s0, 2
	alsl.d	$s1, $s1, $ra, 2
	.p2align	4, , 16
.LBB0_46:                               # %vec.epilog.vector.body531
                                        #   Parent Loop BB0_37 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $s1, 0
	vld	$vr1, $t4, 0
	...
	addi.d	$s1, $s1, 16
	bnez	$a5, .LBB0_46
# %bb.47:                               # %vec.epilog.middle.block536
                                        #   in Loop: Header=BB0_37 Depth=1
	move	$t1, $s2
	beq	$s2, $t2, .LBB0_36
...
# %bb.53:                               #   in Loop: Header=BB0_52 Depth=1
	...
	b	.LBB0_63
	.p2align	4, , 16
.LBB0_54:                               # %vector.main.loop.iter.check548
                                        #   in Loop: Header=BB0_52 Depth=1
	bgeu	$s3, $s0, .LBB0_56
# %bb.55:                               #   in Loop: Header=BB0_52 Depth=1
	...
	b	.LBB0_60
	.p2align	4, , 16
.LBB0_56:                               # %vector.body552.preheader
                                        #   in Loop: Header=BB0_52 Depth=1
	move	$a0, $fp
	move	$t1, $t7
	move	$s2, $t5
	.p2align	4, , 16
.LBB0_57:                               # %vector.body552
	...
	addi.d	$a0, $a0, 64
	bnez	$s2, .LBB0_57
# %bb.58:                               # %middle.block557
                                        #   in Loop: Header=BB0_52 Depth=1
	beq	$t5, $t2, .LBB0_51
# %bb.59:                               # %vec.epilog.iter.check561
                                        #   in Loop: Header=BB0_52 Depth=1
	move	$s2, $t5
	move	$t1, $t5
	beqz	$a2, .LBB0_63
.LBB0_60:                               # %vec.epilog.ph563
                                        #   in Loop: Header=BB0_52 Depth=1
	add.d	$a0, $t8, $s2
	alsl.d	$t1, $s2, $s1, 2
	alsl.d	$s2, $s2, $a4, 2
	.p2align	4, , 16
.LBB0_61:                               # %vec.epilog.vector.body566
                                        #   Parent Loop BB0_52 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $s2, 0
	vfmul.s	$vr0, $vr0, $vr0
	...
	addi.d	$s2, $s2, 16
	bnez	$a0, .LBB0_61
# %bb.62:                               # %vec.epilog.middle.block570
                                        #   in Loop: Header=BB0_52 Depth=1
	move	$t1, $t6
	beq	$t6, $t2, .LBB0_51
...
# %bb.70:                               #   in Loop: Header=BB0_69 Depth=1
	...
	b	.LBB0_74
	.p2align	4, , 16
.LBB0_71:                               # %vector.body585.preheader
                                        #   in Loop: Header=BB0_69 Depth=1
	move	$s6, $a7
	move	$s7, $s3
	move	$ra, $s4
	.p2align	4, , 16
.LBB0_72:                               # %vector.body585
...
# %bb.80:                               #   in Loop: Header=BB0_79 Depth=1
	...
	b	.LBB0_84
	.p2align	4, , 16
.LBB0_81:                               # %vector.body610.preheader
                                        #   in Loop: Header=BB0_79 Depth=1
	move	$s4, $s6
	move	$s3, $s5
	move	$t2, $s7
	.p2align	4, , 16
.LBB0_82:                               # %vector.body610
...
# %bb.89:                               #   in Loop: Header=BB0_88 Depth=1
	...
	b	.LBB0_93
	.p2align	4, , 16
.LBB0_90:                               # %vector.body636.preheader
                                        #   in Loop: Header=BB0_88 Depth=1
	move	$s6, $s4
	move	$s8, $s3
	move	$s7, $t2
	.p2align	4, , 16
.LBB0_91:                               # %vector.body636
...
# %bb.98:                               #   in Loop: Header=BB0_97 Depth=1
	...
	b	.LBB0_108
	.p2align	4, , 16
.LBB0_99:                               # %vector.main.loop.iter.check663
                                        #   in Loop: Header=BB0_97 Depth=1
	bgeu	$a1, $s3, .LBB0_101
# %bb.100:                              #   in Loop: Header=BB0_97 Depth=1
	...
	b	.LBB0_105
	.p2align	4, , 16
.LBB0_101:                              # %vector.body667.preheader
                                        #   in Loop: Header=BB0_97 Depth=1
	move	$t2, $s0
	move	$s7, $fp
	move	$s8, $t8
...
.LBB0_102:                              # %vector.body667
	...
	addi.d	$t2, $t2, 64
	bnez	$ra, .LBB0_102
# %bb.103:                              # %middle.block674
                                        #   in Loop: Header=BB0_97 Depth=1
	beq	$t6, $a1, .LBB0_96
# %bb.104:                              # %vec.epilog.iter.check678
                                        #   in Loop: Header=BB0_97 Depth=1
	move	$ra, $t6
	move	$s7, $t6
	beqz	$a6, .LBB0_108
.LBB0_105:                              # %vec.epilog.ph680
	...
	alsl.d	$ra, $ra, $s4, 2
	.p2align	4, , 16
.LBB0_106:                              # %vec.epilog.vector.body683
                                        #   Parent Loop BB0_97 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $ra, 0
	vld	$vr1, $s8, 0
	...
	addi.d	$ra, $ra, 16
	bnez	$t2, .LBB0_106
# %bb.107:                              # %vec.epilog.middle.block688
                                        #   in Loop: Header=BB0_97 Depth=1
	move	$s7, $t7
	beq	$t7, $a1, .LBB0_96
...
# %bb.113:                              #   in Loop: Header=BB0_112 Depth=1
	...
	b	.LBB0_123
	.p2align	4, , 16
.LBB0_114:                              # %vector.main.loop.iter.check706
                                        #   in Loop: Header=BB0_112 Depth=1
	bgeu	$a1, $s4, .LBB0_116
# %bb.115:                              #   in Loop: Header=BB0_112 Depth=1
	...
	b	.LBB0_120
	.p2align	4, , 16
.LBB0_116:                              # %vector.body710.preheader
                                        #   in Loop: Header=BB0_112 Depth=1
	move	$t2, $s2
	move	$s6, $s1
	move	$s7, $s0
...
.LBB0_117:                              # %vector.body710
	...
	addi.d	$t2, $t2, 64
	bnez	$ra, .LBB0_117
# %bb.118:                              # %middle.block719
                                        #   in Loop: Header=BB0_112 Depth=1
	beq	$t7, $a1, .LBB0_111
# %bb.119:                              # %vec.epilog.iter.check723
                                        #   in Loop: Header=BB0_112 Depth=1
	move	$ra, $t7
	move	$s6, $t7
	beqz	$a6, .LBB0_123
.LBB0_120:                              # %vec.epilog.ph725
                                        #   in Loop: Header=BB0_112 Depth=1
	add.d	$t2, $s3, $ra
	alsl.d	$s6, $ra, $s5, 2
	alsl.d	$s7, $ra, $a5, 2
	...
	alsl.d	$ra, $ra, $t3, 2
	.p2align	4, , 16
.LBB0_121:                              # %vec.epilog.vector.body728
                                        #   Parent Loop BB0_112 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $ra, 0
	vld	$vr1, $s7, 0
	...
	addi.d	$ra, $ra, 16
	bnez	$t2, .LBB0_121
# %bb.122:                              # %vec.epilog.middle.block734
                                        #   in Loop: Header=BB0_112 Depth=1
	move	$s6, $t8
	beq	$t8, $a1, .LBB0_111
...
# %bb.128:                              #   in Loop: Header=BB0_127 Depth=1
	...
	b	.LBB0_138
	.p2align	4, , 16
.LBB0_129:                              # %vector.main.loop.iter.check749
                                        #   in Loop: Header=BB0_127 Depth=1
	bgeu	$a1, $fp, .LBB0_131
# %bb.130:                              #   in Loop: Header=BB0_127 Depth=1
	...
	b	.LBB0_135
	.p2align	4, , 16
.LBB0_131:                              # %vector.body753.preheader
                                        #   in Loop: Header=BB0_127 Depth=1
	move	$a5, $t6
	move	$s0, $t5
	move	$s1, $t4
...
.LBB0_132:                              # %vector.body753
	...
	addi.d	$a5, $a5, 64
	bnez	$s2, .LBB0_132
# %bb.133:                              # %middle.block760
                                        #   in Loop: Header=BB0_127 Depth=1
	beq	$t0, $a1, .LBB0_126
# %bb.134:                              # %vec.epilog.iter.check764
                                        #   in Loop: Header=BB0_127 Depth=1
	move	$s2, $t0
	move	$s0, $t0
	beqz	$a6, .LBB0_138
.LBB0_135:                              # %vec.epilog.ph766
                                        #   in Loop: Header=BB0_127 Depth=1
	add.d	$a5, $t7, $s2
	alsl.d	$s0, $s2, $a3, 2
	alsl.d	$s1, $s2, $a2, 2
	alsl.d	$s2, $s2, $a4, 2
	.p2align	4, , 16
.LBB0_136:                              # %vec.epilog.vector.body769
                                        #   Parent Loop BB0_127 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr2, $s1, 0
	vld	$vr3, $s2, 0
	...
	addi.d	$s2, $s2, 16
	bnez	$a5, .LBB0_136
# %bb.137:                              # %vec.epilog.middle.block774
                                        #   in Loop: Header=BB0_127 Depth=1
	move	$s0, $t3
	beq	$t3, $a1, .LBB0_126
