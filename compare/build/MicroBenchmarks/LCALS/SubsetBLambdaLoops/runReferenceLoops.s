...
# %bb.33:                               #   in Loop: Header=BB4_32 Depth=1
	...
	b	.LBB4_37
	.p2align	4, , 16
.LBB4_34:                               # %vector.body165.preheader
                                        #   in Loop: Header=BB4_32 Depth=1
	move	$a5, $a3
	move	$a6, $a2
	move	$a7, $a1
...
# %bb.48:                               #   in Loop: Header=BB4_47 Depth=1
	...
	b	.LBB4_52
	.p2align	4, , 16
.LBB4_49:                               # %vector.body184.preheader
                                        #   in Loop: Header=BB4_47 Depth=1
	move	$a5, $a3
	move	$a6, $a2
	move	$a7, $a1
...
# %bb.75:                               #   in Loop: Header=BB4_74 Depth=1
	...
	b	.LBB4_79
	.p2align	4, , 16
.LBB4_76:                               # %vector.body203.preheader
                                        #   in Loop: Header=BB4_74 Depth=1
	move	$a5, $a3
	move	$a6, $a2
	move	$a7, $a1
...
# %bb.92:                               #   in Loop: Header=BB4_91 Depth=1
	...
	b	.LBB4_96
	.p2align	4, , 16
.LBB4_93:                               # %vector.body222.preheader
                                        #   in Loop: Header=BB4_91 Depth=1
	move	$a5, $a3
	move	$a6, $a2
	move	$a7, $a1
...
# %bb.109:                              #   in Loop: Header=BB4_108 Depth=1
	...
	b	.LBB4_113
	.p2align	4, , 16
.LBB4_110:                              # %vector.body241.preheader
                                        #   in Loop: Header=BB4_108 Depth=1
	move	$a5, $a3
	move	$a6, $a2
	move	$a7, $a1
