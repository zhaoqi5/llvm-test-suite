...
# %bb.2:                                # %for.cond20.preheader.lr.ph
	...
	ld.d	$a0, $a0, 0
	blez	$a0, .LBB0_30
# %bb.3:                                # %for.cond20.preheader.us.us.preheader
	alsl.d	$a3, $a0, $s3, 3
	alsl.d	$a4, $a0, $s2, 3
	alsl.d	$a5, $a0, $s4, 3
	alsl.d	$a6, $a0, $s5, 3
	...
	b	.LBB0_5
	.p2align	4, , 16
.LBB0_4:                                # %for.cond28.for.cond.cleanup32_crit_edge.us.us
                                        #   in Loop: Header=BB0_5 Depth=1
	addi.d	$s0, $s0, -1
	beqz	$s0, .LBB0_30
.LBB0_5:                                # %for.cond20.preheader.us.us
...
# %bb.6:                                #   in Loop: Header=BB0_5 Depth=1
	...
	b	.LBB0_10
	.p2align	4, , 16
.LBB0_7:                                # %vector.body106.preheader
                                        #   in Loop: Header=BB0_5 Depth=1
	move	$a7, $a5
	move	$t0, $a4
	move	$t1, $a2
	.p2align	4, , 16
.LBB0_8:                                # %vector.body106
	...
	addi.d	$a7, $a7, 64
	bnez	$t1, .LBB0_8
# %bb.9:                                # %middle.block111
                                        #   in Loop: Header=BB0_5 Depth=1
	move	$t1, $a2
	beq	$a0, $a2, .LBB0_12
.LBB0_10:                               # %for.body23.us.us.preheader
                                        #   in Loop: Header=BB0_5 Depth=1
	alsl.d	$a7, $t1, $s1, 3
	alsl.d	$t0, $t1, $s2, 3
	sub.d	$t1, $a0, $t1
	.p2align	4, , 16
.LBB0_11:                               # %for.body23.us.us
                                        #   Parent Loop BB0_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fld.d	$fa7, $a7, 0
	fadd.d	$fa7, $fa7, $fa4
	...
	addi.d	$t0, $t0, 8
	bnez	$t1, .LBB0_11
.LBB0_12:                               # %for.body33.us.us.preheader
                                        #   in Loop: Header=BB0_5 Depth=1
	beqz	$a6, .LBB0_14
...
.LBB0_18:                               # %pred.store.continue
	...
	andi	$t4, $t4, 1
	bnez	$t4, .LBB0_21
# %bb.19:                               # %pred.store.continue93
                                        #   in Loop: Header=BB0_16 Depth=2
	vpickve2gr.w	$t4, $vr9, 2
	andi	$t4, $t4, 1
	bnez	$t4, .LBB0_22
.LBB0_20:                               # %pred.store.continue95
                                        #   in Loop: Header=BB0_16 Depth=2
...
.LBB0_24:                               # %middle.block
	...
	move	$t3, $a3
	beq	$a0, $a3, .LBB0_4
.LBB0_25:                               # %for.body33.us.us.preheader114
                                        #   in Loop: Header=BB0_5 Depth=1
	alsl.d	$a7, $t3, $s2, 3
	alsl.d	$t0, $t3, $s4, 3
	alsl.d	$t1, $t3, $s3, 3
...
# %bb.6:                                #   in Loop: Header=BB1_4 Depth=1
	...
	b	.LBB1_10
	.p2align	4, , 16
.LBB1_7:                                # %vector.body275.preheader
                                        #   in Loop: Header=BB1_4 Depth=1
...
# %bb.9:                                # %middle.block288
	...
	move	$s8, $t0
	beq	$a3, $a0, .LBB1_16
.LBB1_10:                               # %for.body43.preheader292
                                        #   in Loop: Header=BB1_4 Depth=1
	alsl.d	$a0, $a6, $t5, 3
	alsl.d	$a1, $a6, $t2, 3
	alsl.d	$a2, $a6, $t1, 3
...
# %bb.21:                               #   in Loop: Header=BB1_4 Depth=1
	...
	b	.LBB1_25
	.p2align	4, , 16
.LBB1_22:                               # %vector.body249.preheader
                                        #   in Loop: Header=BB1_4 Depth=1
	move	$a1, $t5
	move	$a2, $t7
	move	$a3, $ra
...
# %bb.31:                               # %middle.block
	...
	move	$a2, $a0
	beq	$a3, $a0, .LBB1_34
.LBB1_32:                               # %for.body137.preheader291
                                        #   in Loop: Header=BB1_4 Depth=1
	alsl.d	$a0, $a2, $t5, 3
	alsl.d	$a1, $a2, $t2, 3
	sub.d	$a2, $a3, $a2
...
# %bb.3:                                # %for.cond26.preheader.lr.ph
	...
	bge	$a0, $a1, .LBB4_47
# %bb.4:                                # %for.cond26.preheader.lr.ph
	ld.d	$a0, $sp, 192                   # 8-byte Folded Reload
	ld.d	$a1, $sp, 272                   # 8-byte Folded Reload
	bge	$a0, $a1, .LBB4_47
# %bb.5:                                # %for.cond26.preheader.lr.ph
	bge	$s4, $s5, .LBB4_47
# %bb.6:                                # %for.cond26.preheader.us.us.us.preheader
	addi.w	$a0, $s5, 2
	...
	b	.LBB4_8
	.p2align	4, , 16
.LBB4_7:                                # %for.cond26.for.cond.cleanup27_crit_edge.split.us.split.us.us.us.us
                                        #   in Loop: Header=BB4_8 Depth=1
	ld.d	$s8, $sp, 160                   # 8-byte Folded Reload
	addi.d	$s8, $s8, -1
	beqz	$s8, .LBB4_47
.LBB4_8:                                # %for.cond26.preheader.us.us.us
                                        # =>This Loop Header: Depth=1
	...
	b	.LBB4_10
	.p2align	4, , 16
.LBB4_9:                                # %for.cond29.for.cond.cleanup31_crit_edge.split.us.us.us.us.us.us
	...
	beq	$a3, $a0, .LBB4_7
.LBB4_10:                               # %for.cond29.preheader.us.us.us.us.us
	...
	b	.LBB4_12
	.p2align	4, , 16
.LBB4_11:                               # %for.cond42.for.cond.cleanup44_crit_edge.us.us.us.us.us.us
	...
	beq	$s2, $a0, .LBB4_9
.LBB4_12:                               # %for.body32.us.us.us.us.us.us
                                        #   Parent Loop BB4_8 Depth=1
	...
	.p2align	4, , 16
.LBB4_13:                               # %invoke.cont118.us.us.us.us.us.us
                                        #   Parent Loop BB4_8 Depth=1
                                        #     Parent Loop BB4_10 Depth=2
	...
	fmov.d	$fs2, $ft5
	bceqz	$fcc1, .LBB4_25
.LBB4_14:                               # %invoke.cont123.us.us.us.us.us.us
	...
	fmov.d	$fa1, $fs3
	bceqz	$fcc2, .LBB4_27
.LBB4_15:                               # %invoke.cont137.us.us.us.us.us.us
                                        #   in Loop: Header=BB4_13 Depth=4
	fadd.d	$fa2, $fs4, $fa2
	fadd.d	$fa1, $fs2, $fa1
	...
	fadd.d	$fa1, $fa2, $fa5
	bceqz	$fcc0, .LBB4_29
.LBB4_16:                               # %invoke.cont143.us.us.us.us.us.us
                                        #   in Loop: Header=BB4_13 Depth=4
	fmul.d	$fa2, $fa0, $ft2
	fmul.d	$fa3, $fa0, $ft3
	fsub.d	$fa2, $fa2, $fa4
	...
	fst.d	$fa1, $fp, 0
	bceqz	$fcc2, .LBB4_31
.LBB4_17:                               # %invoke.cont158.us.us.us.us.us.us
                                        #   in Loop: Header=BB4_13 Depth=4
	fneg.d	$fa4, $fs7
	fmul.d	$fa1, $fs1, $fs6
	fmul.d	$fa2, $fs1, $fs3
	...
	fsub.d	$fa6, $fa2, $fa1
	bceqz	$fcc0, .LBB4_33
.LBB4_18:                               # %invoke.cont173.us.us.us.us.us.us
                                        #   in Loop: Header=BB4_13 Depth=4
	fmul.d	$fa1, $ft2, $fs1
	fmul.d	$fa3, $ft3, $fs1
	fmul.d	$fa2, $ft3, $fs7
	...
	fsub.d	$fa1, $fa3, $fa1
	bceqz	$fcc0, .LBB4_35
.LBB4_19:                               # %invoke.cont188.us.us.us.us.us.us
                                        #   in Loop: Header=BB4_13 Depth=4
	fmul.d	$fa2, $ft1, $fa2
	fmul.d	$fa3, $ft1, $fa1
	fmul.d	$fa1, $fa2, $fs2
	...
	fadd.d	$fa1, $fa2, $fa5
	bceqz	$fcc0, .LBB4_37
.LBB4_20:                               # %invoke.cont194.us.us.us.us.us.us
                                        #   in Loop: Header=BB4_13 Depth=4
	fmul.d	$fa2, $fs7, $fs7
	...
	fst.d	$fa1, $s4, 0
	bceqz	$fcc1, .LBB4_39
.LBB4_21:                               # %invoke.cont213.us.us.us.us.us.us
                                        #   in Loop: Header=BB4_13 Depth=4
	fneg.d	$fs4, $fs0
	fmul.d	$fa1, $fs5, $ft4
	fmul.d	$fa2, $fs5, $ft5
	...
	fsub.d	$fs7, $fa2, $fa1
	bceqz	$fcc0, .LBB4_41
.LBB4_22:                               # %invoke.cont230.us.us.us.us.us.us
                                        #   in Loop: Header=BB4_13 Depth=4
	fmul.d	$fa1, $ft2, $fs5
	fmul.d	$fa3, $ft3, $fs5
	fmul.d	$fa2, $ft3, $fs0
	...
	fsub.d	$fa1, $fa3, $fa1
	bceqz	$fcc0, .LBB4_43
.LBB4_23:                               # %invoke.cont246.us.us.us.us.us.us
                                        #   in Loop: Header=BB4_13 Depth=4
	fmul.d	$fa2, $ft1, $fa2
	fmul.d	$fa3, $ft1, $fa1
	fmul.d	$fa1, $fa2, $fs2
	...
	fadd.d	$fa1, $fa2, $fa5
	bceqz	$fcc0, .LBB4_45
.LBB4_24:                               # %invoke.cont254.us.us.us.us.us.us
                                        #   in Loop: Header=BB4_13 Depth=4
	...
	bnez	$s5, .LBB4_13
	b	.LBB4_11
.LBB4_25:                               # %complex_mul_imag_nan.i.i.us.us.us.us.us.us
                                        #   in Loop: Header=BB4_13 Depth=4
	fcmp.cor.d	$fcc0, $ft5, $ft5
	fmov.d	$fs4, $ft4
	fmov.d	$fs2, $ft5
	bcnez	$fcc0, .LBB4_14
# %bb.26:                               # %complex_mul_libcall.i.i.us.us.us.us.us.us
                                        #   in Loop: Header=BB4_13 Depth=4
	...
	fmov.d	$fs2, $fa1
	b	.LBB4_14
.LBB4_27:                               # %complex_mul_imag_nan.i.i118.us.us.us.us.us.us
                                        #   in Loop: Header=BB4_13 Depth=4
	fcmp.cor.d	$fcc0, $fs3, $fs3
	fmov.d	$fa2, $fs6
	fmov.d	$fa1, $fs3
	bcnez	$fcc0, .LBB4_15
# %bb.28:                               # %complex_mul_libcall.i.i120.us.us.us.us.us.us
                                        #   in Loop: Header=BB4_13 Depth=4
	fst.d	$fa0, $sp, 96                   # 8-byte Folded Spill
	fmov.d	$fa0, $fs5
	fmov.d	$fa1, $fs0
	...
	fld.d	$fa0, $sp, 96                   # 8-byte Folded Reload
	b	.LBB4_15
.LBB4_29:                               # %complex_mul_imag_nan.i.i154.us.us.us.us.us.us
                                        #   in Loop: Header=BB4_13 Depth=4
	fcmp.cor.d	$fcc0, $fa1, $fa1
	bcnez	$fcc0, .LBB4_16
# %bb.30:                               # %complex_mul_libcall.i.i156.us.us.us.us.us.us
                                        #   in Loop: Header=BB4_13 Depth=4
	movgr2fr.d	$fa4, $zero
	vldi	$vr1, -912
	fst.d	$fa0, $sp, 96                   # 8-byte Folded Spill
	...
	fld.d	$fa0, $sp, 96                   # 8-byte Folded Reload
	b	.LBB4_16
.LBB4_31:                               # %complex_mul_imag_nan.i.i180.us.us.us.us.us.us
                                        #   in Loop: Header=BB4_13 Depth=4
	fcmp.cor.d	$fcc0, $fs3, $fs3
	bcnez	$fcc0, .LBB4_17
# %bb.32:                               # %complex_mul_libcall.i.i182.us.us.us.us.us.us
                                        #   in Loop: Header=BB4_13 Depth=4
	fst.d	$fa0, $sp, 96                   # 8-byte Folded Spill
	fmov.d	$fa0, $fs5
	fmov.d	$fa1, $fs0
	...
	fmov.d	$fs3, $fa1
	b	.LBB4_17
.LBB4_33:                               # %complex_mul_imag_nan.i.i201.us.us.us.us.us.us
                                        #   in Loop: Header=BB4_13 Depth=4
	fcmp.cor.d	$fcc0, $fa6, $fa6
	bcnez	$fcc0, .LBB4_18
# %bb.34:                               # %complex_mul_libcall.i.i203.us.us.us.us.us.us
                                        #   in Loop: Header=BB4_13 Depth=4
	fst.d	$fa0, $sp, 96                   # 8-byte Folded Spill
	fmov.d	$fa0, $fs1
	fmov.d	$fa1, $fa4
	...
	fmov.d	$fa6, $fa1
	b	.LBB4_18
.LBB4_35:                               # %complex_mul_imag_nan.i.i228.us.us.us.us.us.us
                                        #   in Loop: Header=BB4_13 Depth=4
	fcmp.cor.d	$fcc0, $fa1, $fa1
	bcnez	$fcc0, .LBB4_19
# %bb.36:                               # %complex_mul_libcall.i.i230.us.us.us.us.us.us
                                        #   in Loop: Header=BB4_13 Depth=4
	fst.d	$fa0, $sp, 96                   # 8-byte Folded Spill
	fmov.d	$fa0, $fs1
	fmov.d	$fa1, $fa4
	...
	fld.d	$fa0, $sp, 96                   # 8-byte Folded Reload
	b	.LBB4_19
.LBB4_37:                               # %complex_mul_imag_nan.i.i266.us.us.us.us.us.us
                                        #   in Loop: Header=BB4_13 Depth=4
	fcmp.cor.d	$fcc0, $fa1, $fa1
	bcnez	$fcc0, .LBB4_20
# %bb.38:                               # %complex_mul_libcall.i.i268.us.us.us.us.us.us
                                        #   in Loop: Header=BB4_13 Depth=4
	movgr2fr.d	$fa4, $zero
	vldi	$vr1, -912
	fst.d	$fa0, $sp, 96                   # 8-byte Folded Spill
	...
	fld.d	$fa0, $sp, 96                   # 8-byte Folded Reload
	b	.LBB4_20
.LBB4_39:                               # %complex_mul_imag_nan.i.i294.us.us.us.us.us.us
                                        #   in Loop: Header=BB4_13 Depth=4
	fcmp.cor.d	$fcc0, $ft5, $ft5
	bcnez	$fcc0, .LBB4_21
# %bb.40:                               # %complex_mul_libcall.i.i296.us.us.us.us.us.us
                                        #   in Loop: Header=BB4_13 Depth=4
	fst.d	$fa0, $sp, 96                   # 8-byte Folded Spill
	fmov.d	$fa0, $fs1
	fmov.d	$fa1, $fs7
	...
	fmov.d	$ft5, $fa1
	b	.LBB4_21
.LBB4_41:                               # %complex_mul_imag_nan.i.i316.us.us.us.us.us.us
                                        #   in Loop: Header=BB4_13 Depth=4
	fcmp.cor.d	$fcc0, $fs7, $fs7
	bcnez	$fcc0, .LBB4_22
# %bb.42:                               # %complex_mul_libcall.i.i318.us.us.us.us.us.us
                                        #   in Loop: Header=BB4_13 Depth=4
	fst.d	$fa0, $sp, 96                   # 8-byte Folded Spill
	fmov.d	$fa0, $fs5
	fmov.d	$fa1, $fs4
	...
	fmov.d	$fs7, $fa1
	b	.LBB4_22
.LBB4_43:                               # %complex_mul_imag_nan.i.i343.us.us.us.us.us.us
                                        #   in Loop: Header=BB4_13 Depth=4
	fcmp.cor.d	$fcc0, $fa1, $fa1
	bcnez	$fcc0, .LBB4_23
# %bb.44:                               # %complex_mul_libcall.i.i345.us.us.us.us.us.us
                                        #   in Loop: Header=BB4_13 Depth=4
	fst.d	$fa0, $sp, 96                   # 8-byte Folded Spill
	fmov.d	$fa0, $fs5
	fmov.d	$fa1, $fs4
	...
	fld.d	$fa0, $sp, 96                   # 8-byte Folded Reload
	b	.LBB4_23
.LBB4_45:                               # %complex_mul_imag_nan.i.i381.us.us.us.us.us.us
                                        #   in Loop: Header=BB4_13 Depth=4
	fcmp.cor.d	$fcc0, $fa1, $fa1
	bcnez	$fcc0, .LBB4_24
# %bb.46:                               # %complex_mul_libcall.i.i383.us.us.us.us.us.us
                                        #   in Loop: Header=BB4_13 Depth=4
	movgr2fr.d	$fa4, $zero
	vldi	$vr1, -912
	fmov.d	$fs0, $fa0
...
.Ltmp14:                                # EH_LABEL
	...
	move	$fp, $a0
	beqz	$a1, .LBB4_53
# %bb.52:                               # %delete.notnull.i401
	move	$a0, $a1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB4_53:                               # %_ZN7ADomainD2Ev.exit403
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.Lfunc_end4:
