...
.LBB8_213:                              # %for.body72.i331
	...
	ld.d	$a0, $sp, 160                   # 8-byte Folded Reload
	beqz	$s0, .LBB8_224
# %bb.214:                              # %while.body.lr.ph.i.i.i.i.i335
                                        #   in Loop: Header=BB8_213 Depth=2
...
.LBB8_215:                              # %if.then.i.i.i.i.i.i.i.i474
	...
	masknez	$a1, $s7, $a1
	or	$a0, $a0, $a1
.LBB8_216:                              # %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i.i.i.i348
                                        #   in Loop: Header=BB8_217 Depth=3
	addi.w	$a0, $a0, 0
	slti	$a0, $a0, 0
	masknez	$a1, $s0, $a0
	...
	or	$s4, $a0, $a1
	beqz	$s0, .LBB8_219
.LBB8_217:                              # %while.body.i.i.i.i.i337
                                        #   Parent Loop BB8_153 Depth=1
	...
	or	$a2, $a0, $a1
	beqz	$a2, .LBB8_215
# %bb.218:                              # %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i.i.i.i.i344
                                        #   in Loop: Header=BB8_217 Depth=3
	ld.d	$a0, $s0, 32
	move	$a1, $fp
	pcaddu18i	$ra, %call36(memcmp)
	...
	b	.LBB8_215
	.p2align	4, , 16
.LBB8_219:                              # %_ZNKSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_PSt6vectorI8LoopStatSaIS9_EEESt10_Select1stISD_ESt4lessIS5_ESaISD_EE14_M_lower_boundEPSt18_Rb_tree_node_baseSL_RS7_.exit.i.i.i.i356
                                        #   in Loop: Header=BB8_213 Depth=2
	ld.d	$a1, $sp, 160                   # 8-byte Folded Reload
	move	$a0, $a1
	move	$s5, $s3
	...
	beq	$s4, $a1, .LBB8_224
# %bb.220:                              # %lor.lhs.false.i.i.i.i358
                                        #   in Loop: Header=BB8_213 Depth=2
	ld.d	$s0, $s4, 40
	sltu	$a0, $s0, $s6
	masknez	$a1, $s6, $a0
	...
	or	$a2, $a0, $a1
	beqz	$a2, .LBB8_222
# %bb.221:                              # %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i.i.i.i363
                                        #   in Loop: Header=BB8_213 Depth=2
	ld.d	$a1, $s4, 32
	move	$a0, $fp
	pcaddu18i	$ra, %call36(memcmp)
...
.LBB8_222:                              # %if.then.i.i.i.i.i.i.i469
	...
	masknez	$a1, $s7, $a1
	or	$a0, $a0, $a1
.LBB8_223:                              # %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i.i.i367
                                        #   in Loop: Header=BB8_213 Depth=2
	addi.w	$a0, $a0, 0
	slti	$a0, $a0, 0
	masknez	$a1, $s4, $a0
...
.Ltmp216:                               # EH_LABEL
	ori	$s4, $zero, 6
# %bb.227:                              # %for.cond86.preheader.i409
                                        #   in Loop: Header=BB8_213 Depth=2
	ld.d	$a0, $fp, 216
	ld.d	$a1, $fp, 208
	beq	$a0, $a1, .LBB8_232
# %bb.228:                              # %for.body91.lr.ph.i417
                                        #   in Loop: Header=BB8_213 Depth=2
	move	$s2, $zero
	ori	$s0, $zero, 1
	.p2align	4, , 16
.LBB8_229:                              # %for.body91.i418
                                        #   Parent Loop BB8_153 Depth=1
                                        #     Parent Loop BB8_213 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$a1, $sp, 744
...
# %bb.231:                              # %for.inc104.i432
	...
	addi.w	$s0, $s0, 1
	bltu	$s2, $a0, .LBB8_229
.LBB8_232:                              # %for.cond.cleanup90.i441
                                        #   in Loop: Header=BB8_213 Depth=2
	ld.d	$a0, $sp, 776
	ld.d	$a0, $a0, -24
	addi.d	$a1, $sp, 1016
...
.Ltmp229:                               # EH_LABEL
	b	.LBB8_211
	.p2align	4, , 16
.LBB8_239:                              # %for.cond.cleanup71.i388
                                        #   in Loop: Header=BB8_153 Depth=1
.Ltmp234:                               # EH_LABEL
	addi.d	$a0, $sp, 776
	pcaddu18i	$ra, %call36(_ZNSo5flushEv)
...
# %bb.240:                              # %invoke.cont116.i390
                                        #   in Loop: Header=BB8_153 Depth=1
	ld.d	$a0, $sp, 744
	addi.d	$a1, $sp, 760
	beq	$a0, $a1, .LBB8_242
# %bb.241:                              # %if.then.i.i147.i392
                                        #   in Loop: Header=BB8_153 Depth=1
	pcaddu18i	$ra, %call36(_ZdlPv)
	jirl	$ra, $ra, 0
.LBB8_242:                              # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit151.i393
                                        #   in Loop: Header=BB8_153 Depth=1
	ld.d	$a0, $sp, 88                    # 8-byte Folded Reload
	st.d	$a0, $sp, 776
	ld.d	$a0, $a0, -24
...
.Ltmp572:                               # EH_LABEL
	move	$s0, $a0
	b	.LBB10_316
.LBB10_292:                             # %lpad282.loopexit
.Ltmp496:                               # EH_LABEL
	b	.LBB10_307
.LBB10_293:                             # %lpad358.loopexit.split-lp
.Ltmp545:                               # EH_LABEL
	move	$s0, $a0
	b	.LBB10_310
.LBB10_294:                             # %lpad461.loopexit.split-lp
.Ltmp533:                               # EH_LABEL
	b	.LBB10_309
.LBB10_295:                             # %lpad350.loopexit
.Ltmp506:                               # EH_LABEL
	b	.LBB10_304
.LBB10_296:                             # %lpad352.loopexit.split-lp
.Ltmp548:                               # EH_LABEL
	b	.LBB10_299
.LBB10_297:                             # %lpad350.loopexit.split-lp
.Ltmp551:                               # EH_LABEL
	b	.LBB10_304
.LBB10_298:                             # %lpad352.loopexit
.Ltmp509:                               # EH_LABEL
.LBB10_299:                             # %lpad352
	move	$s0, $a0
	ld.d	$a0, $sp, 216
	addi.d	$a1, $sp, 232
	beq	$a0, $a1, .LBB10_305
# %bb.300:                              # %if.then.i.i749
	pcaddu18i	$ra, %call36(_ZdlPv)
	jirl	$ra, $ra, 0
	b	.LBB10_305
.LBB10_301:                             # %lpad.i.i.loopexit.split-lp
.Ltmp554:                               # EH_LABEL
	b	.LBB10_304
.LBB10_302:                             # %lpad461.loopexit
.Ltmp530:                               # EH_LABEL
	b	.LBB10_309
.LBB10_303:                             # %lpad.i.i.loopexit
.Ltmp503:                               # EH_LABEL
.LBB10_304:                             # %ehcleanup355
	move	$s0, $a0
.LBB10_305:                             # %ehcleanup355
	ld.d	$a0, $sp, 184
	bne	$a0, $s4, .LBB10_311
	b	.LBB10_312
.LBB10_306:                             # %lpad299
.Ltmp487:                               # EH_LABEL
.LBB10_307:                             # %ehcleanup507
	move	$s0, $a0
	b	.LBB10_312
.LBB10_308:                             # %lpad358.loopexit
.Ltmp542:                               # EH_LABEL
.LBB10_309:                             # %ehcleanup493
	move	$s0, $a0
	addi.d	$fp, $sp, 264
.LBB10_310:                             # %ehcleanup493
	ld.d	$a0, $sp, 248
	beq	$a0, $fp, .LBB10_312
.LBB10_311:                             # %if.then.i.i799
	pcaddu18i	$ra, %call36(_ZdlPv)
	jirl	$ra, $ra, 0
.LBB10_312:                             # %ehcleanup507
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
	beqz	$a0, .LBB10_314
# %bb.313:                              # %if.then.i.i.i807
	pcaddu18i	$ra, %call36(_ZdlPv)
	jirl	$ra, $ra, 0
.LBB10_314:                             # %ehcleanup520
	ld.d	$a0, $sp, 280
	addi.d	$a1, $sp, 296
	beq	$a0, $a1, .LBB10_316
.LBB10_315:                             # %if.then.i.i860
	pcaddu18i	$ra, %call36(_ZdlPv)
	jirl	$ra, $ra, 0
.LBB10_316:                             # %ehcleanup528
	ld.d	$a0, $sp, 312
	addi.d	$a1, $sp, 328
	beq	$a0, $a1, .LBB10_318
# %bb.317:                              # %ehcleanup530
...
# %bb.320:                              # %ehcleanup531
	...
	addi.d	$a1, $sp, 360
	bne	$a0, $a1, .LBB10_330
.LBB10_321:                             # %ehcleanup533
	ld.d	$a0, $sp, 376
	addi.d	$a1, $sp, 392
	bne	$a0, $a1, .LBB10_331
.LBB10_322:                             # %ehcleanup535
	ld.d	$a0, $sp, 408
	addi.d	$a1, $sp, 424
	bne	$a0, $a1, .LBB10_332
.LBB10_323:                             # %ehcleanup537
	ld.d	$a0, $sp, 440
	addi.d	$a1, $sp, 456
	bne	$a0, $a1, .LBB10_333
.LBB10_324:                             # %ehcleanup539
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB10_325:                             # %for.body.i.i875.preheader
	ld.d	$a1, $sp, 152                   # 8-byte Folded Reload
	b	.LBB10_327
	.p2align	4, , 16
.LBB10_326:                             # %_ZSt8_DestroyINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEvPT_.exit.i.i879
                                        #   in Loop: Header=BB10_327 Depth=1
	addi.d	$a1, $fp, 16
	ld.d	$a0, $sp, 176                   # 8-byte Folded Reload
	beq	$a1, $a0, .LBB10_319
.LBB10_327:                             # %for.body.i.i875
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $a1, 0
	addi.d	$fp, $a1, 16
	beq	$a0, $fp, .LBB10_326
# %bb.328:                              # %if.then.i.i.i.i.i878
                                        #   in Loop: Header=BB10_327 Depth=1
	pcaddu18i	$ra, %call36(_ZdlPv)
	jirl	$ra, $ra, 0
	b	.LBB10_326
.LBB10_329:                             # %if.then.i.i.i886
	pcaddu18i	$ra, %call36(_ZdlPv)
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 344
	addi.d	$a1, $sp, 360
	beq	$a0, $a1, .LBB10_321
.LBB10_330:                             # %if.then.i.i892
	pcaddu18i	$ra, %call36(_ZdlPv)
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 376
	addi.d	$a1, $sp, 392
	beq	$a0, $a1, .LBB10_322
.LBB10_331:                             # %if.then.i.i899
	pcaddu18i	$ra, %call36(_ZdlPv)
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 408
	addi.d	$a1, $sp, 424
	beq	$a0, $a1, .LBB10_323
.LBB10_332:                             # %if.then.i.i906
	pcaddu18i	$ra, %call36(_ZdlPv)
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 440
	addi.d	$a1, $sp, 456
	beq	$a0, $a1, .LBB10_324
.LBB10_333:                             # %if.then.i.i913
	pcaddu18i	$ra, %call36(_ZdlPv)
	jirl	$ra, $ra, 0
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_Unwind_Resume)
...
# %bb.153:                              #   in Loop: Header=BB12_117 Depth=3
	ld.d	$a2, $sp, 160                   # 8-byte Folded Reload
.LBB12_154:                             # %_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i834
                                        #   in Loop: Header=BB12_117 Depth=3
.Ltmp766:                               # EH_LABEL
	ext.w.b	$a1, $a0
	move	$a0, $a2
...
.LBB12_158:                             # %if.end289
	...
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
	beqz	$a0, .LBB12_56
# %bb.159:                              # %if.then.i.i.i519
                                        #   in Loop: Header=BB12_57 Depth=1
	pcaddu18i	$ra, %call36(_ZdlPv)
	jirl	$ra, $ra, 0
	b	.LBB12_56
.LBB12_160:                             # %for.cond.cleanup128
	ld.d	$a1, $sp, 392
	ld.d	$a2, $sp, 400
.Ltmp789:                               # EH_LABEL
...
.Ltmp791:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp792:                               # EH_LABEL
# %bb.162:                              # %invoke.cont299
.Ltmp793:                               # EH_LABEL
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_ZNSo5flushEv)
	jirl	$ra, $ra, 0
.Ltmp794:                               # EH_LABEL
# %bb.163:                              # %invoke.cont301
	ld.d	$a0, $sp, 264
	addi.d	$a1, $sp, 280
	beq	$a0, $a1, .LBB12_165
# %bb.164:                              # %if.then.i.i527
	pcaddu18i	$ra, %call36(_ZdlPv)
	jirl	$ra, $ra, 0
.LBB12_165:                             # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit532
	ld.d	$a0, $sp, 296
	addi.d	$a1, $sp, 312
	beq	$a0, $a1, .LBB12_167
# %bb.166:                              # %if.then.i.i534
	pcaddu18i	$ra, %call36(_ZdlPv)
	jirl	$ra, $ra, 0
.LBB12_167:                             # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit539
	ld.d	$a0, $sp, 24                    # 8-byte Folded Reload
	ld.d	$a1, $sp, 16                    # 8-byte Folded Reload
	beq	$a0, $a1, .LBB12_172
# %bb.168:                              # %for.body.i.i.preheader
	move	$a1, $s8
	b	.LBB12_170
	.p2align	4, , 16
.LBB12_169:                             # %_ZSt8_DestroyINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEvPT_.exit.i.i
	...
	addi.d	$a1, $fp, 16
	beq	$a1, $s7, .LBB12_172
.LBB12_170:                             # %for.body.i.i
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $a1, 0
	addi.d	$fp, $a1, 16
	beq	$a0, $fp, .LBB12_169
# %bb.171:                              # %if.then.i.i.i.i.i
                                        #   in Loop: Header=BB12_170 Depth=1
	pcaddu18i	$ra, %call36(_ZdlPv)
	jirl	$ra, $ra, 0
	b	.LBB12_169
.LBB12_172:                             # %invoke.cont.i542
	beqz	$s8, .LBB12_174
...
.LBB12_174:                             # %_ZNSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EED2Ev.exit
	...
	addi.d	$a1, $sp, 344
	beq	$a0, $a1, .LBB12_176
# %bb.175:                              # %if.then.i.i546
	pcaddu18i	$ra, %call36(_ZdlPv)
	jirl	$ra, $ra, 0
.LBB12_176:                             # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit551
	ld.d	$a0, $sp, 360
	addi.d	$a1, $sp, 376
	beq	$a0, $a1, .LBB12_178
# %bb.177:                              # %if.then.i.i553
	pcaddu18i	$ra, %call36(_ZdlPv)
	jirl	$ra, $ra, 0
.LBB12_178:                             # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit558
	ld.d	$a0, $sp, 392
	addi.d	$a1, $sp, 408
	beq	$a0, $a1, .LBB12_180
# %bb.179:                              # %if.then.i.i560
	pcaddu18i	$ra, %call36(_ZdlPv)
	jirl	$ra, $ra, 0
.LBB12_180:                             # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit565
	ld.d	$a0, $sp, 424
	addi.d	$a1, $sp, 440
	beq	$a0, $a1, .LBB12_182
# %bb.181:                              # %if.then.i.i567
	pcaddu18i	$ra, %call36(_ZdlPv)
	jirl	$ra, $ra, 0
.LBB12_182:                             # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit572
	...
	addi.d	$sp, $sp, 544
	ret
.LBB12_183:                             # %if.then.i.i10.invoke.i.i
.Ltmp780:                               # EH_LABEL
	pcalau12i	$a0, %pc_hi20(.L.str.53)
	addi.d	$a0, $a0, %pc_lo12(.L.str.53)
	pcaddu18i	$ra, %call36(_ZSt20__throw_length_errorPKc)
	jirl	$ra, $ra, 0
.Ltmp781:                               # EH_LABEL
# %bb.184:                              # %if.then.i.i10.cont.i.i
.LBB12_185:                             # %if.then.i.i.i.i389
.Ltmp777:                               # EH_LABEL
	pcalau12i	$a0, %pc_hi20(.L.str.53)
	addi.d	$a0, $a0, %pc_lo12(.L.str.53)
	pcaddu18i	$ra, %call36(_ZSt20__throw_length_errorPKc)
...
.Ltmp775:                               # EH_LABEL
# %bb.188:                              # %.noexc407
.LBB12_189:                             # %if.then.i.i.i815
.Ltmp759:                               # EH_LABEL
	pcaddu18i	$ra, %call36(_ZSt16__throw_bad_castv)
	jirl	$ra, $ra, 0
.Ltmp760:                               # EH_LABEL
# %bb.190:                              # %.noexc816
.LBB12_191:                             # %if.then.i.i.i841
.Ltmp771:                               # EH_LABEL
	pcaddu18i	$ra, %call36(_ZSt16__throw_bad_castv)
	jirl	$ra, $ra, 0
.Ltmp772:                               # EH_LABEL
# %bb.192:                              # %.noexc842
.LBB12_193:                             # %if.then.i.i.i778
.Ltmp783:                               # EH_LABEL
	pcaddu18i	$ra, %call36(_ZSt16__throw_bad_castv)
	jirl	$ra, $ra, 0
.Ltmp784:                               # EH_LABEL
# %bb.194:                              # %.noexc779
.LBB12_195:                             # %if.then.i.i.i749
.Ltmp786:                               # EH_LABEL
	pcaddu18i	$ra, %call36(_ZSt16__throw_bad_castv)
	jirl	$ra, $ra, 0
.Ltmp787:                               # EH_LABEL
# %bb.196:                              # %.noexc750
.LBB12_197:                             # %if.then.i.i.i665.invoke
.Ltmp798:                               # EH_LABEL
	pcaddu18i	$ra, %call36(_ZSt16__throw_bad_castv)
	jirl	$ra, $ra, 0
.Ltmp799:                               # EH_LABEL
# %bb.198:                              # %if.then.i.i.i665.cont
.LBB12_199:                             # %if.then.i.i.i723.invoke
.Ltmp795:                               # EH_LABEL
	pcaddu18i	$ra, %call36(_ZSt16__throw_bad_castv)
	jirl	$ra, $ra, 0
.Ltmp796:                               # EH_LABEL
# %bb.200:                              # %if.then.i.i.i723.cont
.LBB12_201:                             # %lpad15
.Ltmp630:                               # EH_LABEL
	move	$s0, $a0
	ld.d	$a0, $sp, 328
...
.Ltmp621:                               # EH_LABEL
	...
	beq	$a0, $a1, .LBB12_244
	b	.LBB12_253
.LBB12_207:                             # %lpad143.loopexit.split-lp
.Ltmp788:                               # EH_LABEL
	b	.LBB12_214
.LBB12_208:                             # %lpad136
.Ltmp700:                               # EH_LABEL
...
.Ltmp800:                               # EH_LABEL
	...
	beq	$a0, $a1, .LBB12_235
	b	.LBB12_238
.LBB12_212:                             # %ehcleanup312.thread
.Ltmp633:                               # EH_LABEL
	move	$s0, $a0
	b	.LBB12_245
.LBB12_213:                             # %lpad167.loopexit.split-lp
.Ltmp785:                               # EH_LABEL
.LBB12_214:                             # %ehcleanup290
	move	$s0, $a0
	ld.d	$s8, $sp, 72                    # 8-byte Folded Reload
	b	.LBB12_232
.LBB12_215:                             # %lpad143.loopexit
.Ltmp719:                               # EH_LABEL
	b	.LBB12_217
.LBB12_216:                             # %lpad167.loopexit
.Ltmp730:                               # EH_LABEL
.LBB12_217:                             # %ehcleanup290
	move	$s0, $a0
	b	.LBB12_232
.LBB12_218:                             # %lpad207.loopexit.split-lp
.Ltmp773:                               # EH_LABEL
	b	.LBB12_255
.LBB12_219:                             # %lpad254.loopexit.split-lp
.Ltmp761:                               # EH_LABEL
	b	.LBB12_255
.LBB12_220:                             # %lpad203.loopexit
.Ltmp743:                               # EH_LABEL
	b	.LBB12_222
.LBB12_221:                             # %lpad203.loopexit.split-lp
.Ltmp776:                               # EH_LABEL
.LBB12_222:                             # %lpad203
	move	$s0, $a0
	addi.d	$a1, $sp, 216
	ld.d	$a0, $sp, 200
	beq	$a0, $a1, .LBB12_230
# %bb.223:                              # %if.then.i.i489
	pcaddu18i	$ra, %call36(_ZdlPv)
	jirl	$ra, $ra, 0
	b	.LBB12_230
.LBB12_224:                             # %lpad201.loopexit.split-lp
.Ltmp779:                               # EH_LABEL
	b	.LBB12_229
.LBB12_225:                             # %lpad201.loopexit
.Ltmp740:                               # EH_LABEL
	b	.LBB12_229
.LBB12_226:                             # %lpad.i.i.loopexit.split-lp
.Ltmp782:                               # EH_LABEL
	b	.LBB12_229
.LBB12_227:                             # %lpad254.loopexit
.Ltmp758:                               # EH_LABEL
	b	.LBB12_255
.LBB12_228:                             # %lpad.i.i.loopexit
.Ltmp737:                               # EH_LABEL
.LBB12_229:                             # %ehcleanup
	move	$s0, $a0
.LBB12_230:                             # %ehcleanup
	...
	addi.d	$a1, $sp, 184
	beq	$a0, $a1, .LBB12_232
.LBB12_231:                             # %if.then.i.i513
	pcaddu18i	$ra, %call36(_ZdlPv)
	jirl	$ra, $ra, 0
.LBB12_232:                             # %ehcleanup290
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
	bnez	$a0, .LBB12_236
# %bb.233:                              # %ehcleanup303
	ld.d	$a0, $sp, 264
	addi.d	$a1, $sp, 280
	bne	$a0, $a1, .LBB12_237
.LBB12_234:                             # %ehcleanup310
	ld.d	$a0, $sp, 296
	addi.d	$a1, $sp, 312
	bne	$a0, $a1, .LBB12_238
.LBB12_235:                             # %ehcleanup312
	ld.d	$a0, $sp, 24                    # 8-byte Folded Reload
	ld.d	$a1, $sp, 16                    # 8-byte Folded Reload
	beq	$a0, $a1, .LBB12_239
	b	.LBB12_245
.LBB12_236:                             # %if.then.i.i.i521
	pcaddu18i	$ra, %call36(_ZdlPv)
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 264
	addi.d	$a1, $sp, 280
	beq	$a0, $a1, .LBB12_234
.LBB12_237:                             # %if.then.i.i574
	pcaddu18i	$ra, %call36(_ZdlPv)
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 296
	addi.d	$a1, $sp, 312
	beq	$a0, $a1, .LBB12_235
.LBB12_238:                             # %ehcleanup312
	pcaddu18i	$ra, %call36(_ZdlPv)
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 24                    # 8-byte Folded Reload
	ld.d	$a1, $sp, 16                    # 8-byte Folded Reload
	bne	$a0, $a1, .LBB12_245
.LBB12_239:                             # %invoke.cont.i598
	bnez	$s8, .LBB12_249
# %bb.240:                              # %ehcleanup313
	ld.d	$a0, $sp, 328
	addi.d	$a1, $sp, 344
	bne	$a0, $a1, .LBB12_250
.LBB12_241:                             # %ehcleanup315
	ld.d	$a0, $sp, 360
	addi.d	$a1, $sp, 376
	bne	$a0, $a1, .LBB12_251
.LBB12_242:                             # %ehcleanup317
	ld.d	$a0, $sp, 392
	addi.d	$a1, $sp, 408
	bne	$a0, $a1, .LBB12_252
.LBB12_243:                             # %ehcleanup319
	ld.d	$a0, $sp, 424
	addi.d	$a1, $sp, 440
	bne	$a0, $a1, .LBB12_253
.LBB12_244:                             # %ehcleanup321
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB12_245:                             # %for.body.i.i589.preheader
	move	$a1, $s8
	b	.LBB12_247
	.p2align	4, , 16
.LBB12_246:                             # %_ZSt8_DestroyINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEvPT_.exit.i.i593
                                        #   in Loop: Header=BB12_247 Depth=1
	addi.d	$a1, $fp, 16
	beq	$a1, $s7, .LBB12_239
.LBB12_247:                             # %for.body.i.i589
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $a1, 0
	addi.d	$fp, $a1, 16
	beq	$a0, $fp, .LBB12_246
# %bb.248:                              # %if.then.i.i.i.i.i592
                                        #   in Loop: Header=BB12_247 Depth=1
	pcaddu18i	$ra, %call36(_ZdlPv)
	jirl	$ra, $ra, 0
	b	.LBB12_246
.LBB12_249:                             # %if.then.i.i.i600
	move	$a0, $s8
	pcaddu18i	$ra, %call36(_ZdlPv)
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 328
	addi.d	$a1, $sp, 344
	beq	$a0, $a1, .LBB12_241
.LBB12_250:                             # %if.then.i.i606
	pcaddu18i	$ra, %call36(_ZdlPv)
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 360
	addi.d	$a1, $sp, 376
	beq	$a0, $a1, .LBB12_242
.LBB12_251:                             # %if.then.i.i613
	pcaddu18i	$ra, %call36(_ZdlPv)
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 392
	addi.d	$a1, $sp, 408
	beq	$a0, $a1, .LBB12_243
.LBB12_252:                             # %if.then.i.i620
	pcaddu18i	$ra, %call36(_ZdlPv)
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 424
	addi.d	$a1, $sp, 440
	beq	$a0, $a1, .LBB12_244
.LBB12_253:                             # %if.then.i.i627
	pcaddu18i	$ra, %call36(_ZdlPv)
	jirl	$ra, $ra, 0
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB12_254:                             # %lpad207.loopexit
.Ltmp770:                               # EH_LABEL
.LBB12_255:                             # %ehcleanup276
	move	$s0, $a0
	addi.d	$a1, $sp, 248
	ld.d	$a0, $sp, 232
	beq	$a0, $a1, .LBB12_232
