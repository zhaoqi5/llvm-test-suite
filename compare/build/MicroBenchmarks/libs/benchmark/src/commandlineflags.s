...
.Ltmp45:                                # EH_LABEL
	move	$fp, $a0
.LBB8_102:                              # %ehcleanup46.i
	addi.d	$a0, $sp, 152
	pcaddu18i	$ra, %call36(_ZNSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EED2Ev)
	jirl	$ra, $ra, 0
.LBB8_103:                              # %ehcleanup67.i
	addi.d	$a0, $sp, 176
...
.LBB8_106:                              # %ehcleanup
	...
	addi.d	$a1, $sp, 104
	beq	$a0, $a1, .LBB8_108
# %bb.107:                              # %if.then.i.i42
	ld.d	$a1, $sp, 104
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB8_108:                              # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit48
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.Lfunc_end8:
