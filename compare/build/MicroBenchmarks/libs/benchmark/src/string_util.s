...
# %bb.15:                               # %if.else.i.i
	...
	fcmp.cule.d	$fcc0, $fa0, $fs0
	bcnez	$fcc0, .LBB0_24
# %bb.16:                               # %for.body38.preheader.i.i
	fmul.d	$fa0, $fa1, $fs0
	vldi	$vr2, -912
...
# %bb.17:                               # %for.inc52.i.i
	...
	bcnez	$fcc0, .LBB0_45
# %bb.18:                               # %for.inc52.1.i.i
	fmul.d	$fa0, $fa1, $fa0
	fcmp.cle.d	$fcc0, $fa2, $fa0
	bcnez	$fcc0, .LBB0_51
# %bb.19:                               # %for.inc52.2.i.i
	fmul.d	$fa0, $fa1, $fa0
	fcmp.cle.d	$fcc0, $fa2, $fa0
	bcnez	$fcc0, .LBB0_52
# %bb.20:                               # %for.inc52.3.i.i
	fmul.d	$fa0, $fa1, $fa0
	fcmp.cle.d	$fcc0, $fa2, $fa0
	bcnez	$fcc0, .LBB0_53
# %bb.21:                               # %for.inc52.4.i.i
	fmul.d	$fa0, $fa1, $fa0
	fcmp.cle.d	$fcc0, $fa2, $fa0
	bcnez	$fcc0, .LBB0_54
# %bb.22:                               # %for.inc52.5.i.i
	fmul.d	$fa0, $fa1, $fa0
	fcmp.cle.d	$fcc0, $fa2, $fa0
	bcnez	$fcc0, .LBB0_55
# %bb.23:                               # %for.inc52.6.i.i
	fmul.d	$fa0, $fa1, $fa0
	vldi	$vr1, -912
	fcmp.cult.d	$fcc0, $fa0, $fa1
	bceqz	$fcc0, .LBB0_56
.LBB0_24:                               # %if.else67.invoke.i.i
	addi.d	$a0, $sp, 88
.Ltmp14:                                # EH_LABEL
	fmov.d	$fa0, $fs0
	pcaddu18i	$ra, %call36(_ZNSo9_M_insertIdEERSoT_)
...
.Ltmp30:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp31:                                # EH_LABEL
.LBB0_34:                               # %invoke.cont75.i.i
	ld.d	$a0, $sp, 8
	beq	$a0, $s3, .LBB0_39
# %bb.35:                               # %invoke.cont.thread.i154.i.i
	ld.d	$a1, $sp, 40
	beq	$a1, $s1, .LBB0_42
# %bb.36:                               # %if.then27.i156.i.i
	ld.d	$a2, $sp, 24
	vld	$vr0, $sp, 48
	st.d	$a1, $sp, 8
	vst	$vr0, $sp, 16
	beqz	$a0, .LBB0_41
.LBB0_37:                               # %if.then35.i164.i.i
	st.d	$a0, $sp, 40
	st.d	$a2, $sp, 56
	b	.LBB0_48
.LBB0_38:
...
# %bb.40:
	...
	vst	$vr0, $sp, 16
	bnez	$a0, .LBB0_37
.LBB0_41:                               # %if.else38.i166.i.i
	st.d	$s1, $sp, 40
	move	$a0, $s1
	b	.LBB0_48
.LBB0_42:                               # %if.then12.i167.i.i
	ld.d	$a2, $sp, 48
	beqz	$a2, .LBB0_47
# %bb.43:                               # %if.then12.i167.i.i
	ori	$a3, $zero, 1
	bne	$a2, $a3, .LBB0_46
# %bb.44:                               # %if.then.i25.i172.i.i
	ld.b	$a1, $a1, 0
	st.b	$a1, $a0, 0
	b	.LBB0_47
.LBB0_45:
	addi.w	$s1, $zero, -2
	b	.LBB0_57
.LBB0_46:                               # %if.end.i.i.i178.i.i
	pcaddu18i	$ra, %call36(memcpy)
	jirl	$ra, $ra, 0
.LBB0_47:                               # %if.end21.i173.i.i
	ld.d	$a0, $sp, 48
	ld.d	$a1, $sp, 8
	st.d	$a0, $sp, 16
	stx.b	$zero, $a1, $a0
	ld.d	$a0, $sp, 40
.LBB0_48:                               # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit183.i.i
	st.d	$zero, $sp, 48
	st.b	$zero, $a0, 0
	ld.d	$a0, $sp, 40
	beq	$a0, $s1, .LBB0_50
# %bb.49:                               # %if.then.i.i185.i.i
	ld.d	$a1, $sp, 56
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB0_50:                               # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit191.i.i
	move	$s1, $zero
	b	.LBB0_76
.LBB0_51:
	addi.w	$s1, $zero, -3
...
.LBB0_56:
	addi.w	$s1, $zero, -8
.LBB0_57:                               # %if.then40.i.i
	addi.d	$a0, $sp, 88
.Ltmp6:                                 # EH_LABEL
	pcaddu18i	$ra, %call36(_ZNSo9_M_insertIdEERSoT_)
	jirl	$ra, $ra, 0
.Ltmp7:                                 # EH_LABEL
# %bb.58:                               # %invoke.cont43.i.i
	ld.d	$a0, $sp, 136
	addi.d	$s2, $sp, 56
	st.d	$s2, $sp, 40
	st.d	$zero, $sp, 48
...
.Ltmp11:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp12:                                # EH_LABEL
.LBB0_62:                               # %invoke.cont19.i.i
	ld.d	$a0, $sp, 8
	beq	$a0, $s3, .LBB0_66
# %bb.63:                               # %invoke.cont.thread.i.i.i
	ld.d	$a1, $sp, 40
	beq	$a1, $s2, .LBB0_69
# %bb.64:                               # %if.then27.i.i.i
	ld.d	$a2, $sp, 24
	vld	$vr0, $sp, 48
	st.d	$a1, $sp, 8
	vst	$vr0, $sp, 16
	beqz	$a0, .LBB0_68
.LBB0_65:                               # %if.then35.i.i.i
	st.d	$a0, $sp, 40
	st.d	$a2, $sp, 56
	b	.LBB0_74
.LBB0_66:                               # %invoke.cont.i.i.i
	ld.d	$a1, $sp, 40
	beq	$a1, $s2, .LBB0_69
# %bb.67:
	move	$a0, $zero
...
.LBB0_76:                               # %cleanup78.i.i
	...
	ld.d	$s2, $a0, %got_pc_lo12(_ZTTNSt7__cxx1118basic_stringstreamIcSt11char_traitsIcESaIcEEE)
	ld.d	$a0, $s2, 0
	st.d	$a0, $sp, 72
	ld.d	$a1, $s2, 64
	ld.d	$a0, $a0, -24
...
# %bb.114:                              # %ehcleanup6.i
	ld.d	$a0, $sp, 8
	bne	$a0, $s3, .LBB0_118
.LBB0_115:                              # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit44.i
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB0_116:                              # %if.then.i.i30.i
	ld.d	$a0, $sp, 88
	addi.d	$a1, $a0, 1
	move	$a0, $a2
	pcaddu18i	$ra, %call36(_ZdlPvm)
