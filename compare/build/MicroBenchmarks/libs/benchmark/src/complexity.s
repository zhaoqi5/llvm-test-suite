...
# %bb.4:                                # %_ZN9benchmark8internal18GetNullLogInstanceEv.exit20
	pcalau12i	$a1, %pc_hi20(_ZZN9benchmark12FittingCurveENS_4BigOEEN3$_08__invokeEl)
	addi.d	$fp, $a1, %pc_lo12(_ZZN9benchmark12FittingCurveENS_4BigOEEN3$_08__invokeEl)
	slli.d	$a0, $a0, 2
...
.LBB3_5:                                # %sw.bb1.i101
	...
	addi.d	$fp, $a0, %pc_lo12(_ZZN9benchmark12FittingCurveENS_4BigOEEN3$_18__invokeEl)
	ld.d	$a1, $s1, 8
	ld.d	$a0, $s1, 0
	bne	$a1, $a0, .LBB3_10
	b	.LBB3_24
.LBB3_6:                                # %sw.bb10.i97
	...
	addi.d	$fp, $a0, %pc_lo12(_ZZN9benchmark12FittingCurveENS_4BigOEEN3$_48__invokeEl)
	ld.d	$a1, $s1, 8
	ld.d	$a0, $s1, 0
	bne	$a1, $a0, .LBB3_10
	b	.LBB3_24
.LBB3_7:                                # %sw.bb4.i100
	...
	addi.d	$fp, $a0, %pc_lo12(_ZZN9benchmark12FittingCurveENS_4BigOEEN3$_28__invokeEl)
	ld.d	$a1, $s1, 8
	ld.d	$a0, $s1, 0
	bne	$a1, $a0, .LBB3_10
	b	.LBB3_24
.LBB3_8:                                # %sw.bb7.i99
	...
	addi.d	$fp, $a0, %pc_lo12(_ZZN9benchmark12FittingCurveENS_4BigOEEN3$_38__invokeEl)
...
.LBB3_30:                               # %invoke.cont7.split
	...
	pcalau12i	$a0, %pc_hi20(_ZZN9benchmark12FittingCurveENS_4BigOEEN3$_58__invokeEl)
	addi.d	$s7, $a0, %pc_lo12(_ZZN9benchmark12FittingCurveENS_4BigOEEN3$_58__invokeEl)
	pcalau12i	$a0, %pc_hi20(.Lswitch.table._ZN9benchmark14MinimalLeastSqERKSt6vectorIlSaIlEERKS0_IdSaIdEENS_4BigOE)
	addi.d	$a0, $a0, %pc_lo12(.Lswitch.table._ZN9benchmark14MinimalLeastSqERKSt6vectorIlSaIlEERKS0_IdSaIdEENS_4BigOE)
	st.d	$a0, $sp, 24                    # 8-byte Folded Spill
	fld.d	$fs2, $fp, %pc_lo12(.LCPI3_0)
	move	$fp, $zero
	movgr2fr.d	$fs3, $zero
	b	.LBB3_32
	.p2align	4, , 16
...
.LBB3_44:                               #   in Loop: Header=BB3_32 Depth=1
	fmov.d	$fs6, $fs3
	fmov.d	$fs7, $fs3
.LBB3_45:                               # %invoke.cont17
                                        #   in Loop: Header=BB3_32 Depth=1
	fdiv.d	$fa1, $fs6, $fs7
	fsqrt.d	$fa0, $fa1
	fcmp.cor.d	$fcc0, $fa0, $fa0
	bceqz	$fcc0, .LBB3_48
# %bb.46:                               # %invoke.cont17.split
                                        #   in Loop: Header=BB3_32 Depth=1
	fdiv.d	$fa1, $fs4, $fs7
	fdiv.d	$fa0, $fa0, $fa1
...
.LBB3_48:                               # %call.sqrt322
	...
	bcnez	$fcc0, .LBB3_31
	b	.LBB3_47
.LBB3_49:                               # %_ZNSt6vectorIN9benchmark4BigOESaIS1_EED2Ev.exit
...
.LBB3_57:                               # %call.sqrt
	...
	jirl	$ra, $ra, 0
	b	.LBB3_30
.LBB3_58:                               # %lpad16.loopexit
.Ltmp5:                                 # EH_LABEL
	b	.LBB3_60
.LBB3_59:                               # %lpad16.loopexit.split-lp
.Ltmp2:                                 # EH_LABEL
.LBB3_60:                               # %lpad16
	move	$s0, $a0
	ld.d	$a0, $sp, 16                    # 8-byte Folded Reload
