...
.LBB4_57:                               # %_ZZN9benchmark12ComputeStatsERKSt6vectorINS_17BenchmarkReporter3RunESaIS2_EEEN11CounterStatD2Ev.exit.i.i.i.i.i.i.i
	...
	move	$fp, $a2
	beq	$s0, $s5, .LBB4_59
# %bb.58:                               # %if.then.i.i.i.i.i.i9.i.i.i
                                        #   in Loop: Header=BB4_22 Depth=2
	ld.d	$a0, $s5, 0
	addi.d	$a1, $a0, 1
	move	$a0, $s0
...
.LBB4_63:                               # %_ZZN9benchmark12ComputeStatsERKSt6vectorINS_17BenchmarkReporter3RunESaIS2_EEEN11CounterStatD2Ev.exit
	...
	srai.d	$a0, $s0, 3
	bgeu	$a0, $s2, .LBB4_21
# %bb.64:                               # %_ZNSt12_Vector_baseIdSaIdEE11_M_allocateEm.exit.i153
                                        #   in Loop: Header=BB4_22 Depth=2
	ld.d	$s5, $s3, 88
	slli.d	$a0, $s2, 3
.Ltmp20:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp21:                                # EH_LABEL
# %bb.65:                               # %call5.i.i.i.noexc168
                                        #   in Loop: Header=BB4_22 Depth=2
	move	$s4, $a0
	sub.d	$a2, $s5, $fp
	beq	$s5, $fp, .LBB4_67
# %bb.66:                               # %if.then.i.i.i.i160
                                        #   in Loop: Header=BB4_22 Depth=2
	move	$a0, $s4
	move	$a1, $fp
	move	$s5, $a2
	...
	jirl	$ra, $ra, 0
	move	$a2, $s5
.LBB4_67:                               # %_ZNSt6vectorIdSaIdEE11_S_relocateEPdS2_S2_RS0_.exit.i161
                                        #   in Loop: Header=BB4_22 Depth=2
	beqz	$fp, .LBB4_69
# %bb.68:                               # %if.then.i.i163
                                        #   in Loop: Header=BB4_22 Depth=2
	move	$a0, $fp
	move	$a1, $s0
	move	$fp, $a2
	...
	jirl	$ra, $ra, 0
	move	$a2, $fp
.LBB4_69:                               # %_ZNSt12_Vector_baseIdSaIdEE13_M_deallocateEPdm.exit.i164
                                        #   in Loop: Header=BB4_22 Depth=2
	st.d	$s4, $s3, 80
	add.d	$a0, $s4, $a2
	st.d	$a0, $s3, 88
...
.LBB4_75:                               # %for.body86
	...
	dbar	20
	beqz	$a0, .LBB4_119
.LBB4_76:                               # %invoke.cont89
                                        #   in Loop: Header=BB4_75 Depth=1
	ld.b	$a0, $s0, 0
	dbar	20
	beqz	$a0, .LBB4_121
.LBB4_77:                               # %invoke.cont91
                                        #   in Loop: Header=BB4_75 Depth=1
...
.Ltmp23:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp24:                                # EH_LABEL
# %bb.83:                               # %call5.i.i.i.i.noexc
                                        #   in Loop: Header=BB4_75 Depth=1
	move	$s3, $a0
	fld.d	$fa0, $s2, 432
	fstx.d	$fa0, $a0, $fp
	blt	$fp, $s4, .LBB4_85
# %bb.84:                               # %if.then.i.i.i.i.i200
                                        #   in Loop: Header=BB4_75 Depth=1
	move	$a0, $s3
	move	$a1, $s0
	move	$a2, $fp
...
.LBB4_87:                               # %_ZNSt6vectorIdSaIdEE17_M_realloc_appendIJRKdEEEvDpOT_.exit.i
	...
	ld.d	$a1, $sp, 760
	bne	$a0, $a1, .LBB4_80
.LBB4_88:                               # %if.else.i208
                                        #   in Loop: Header=BB4_75 Depth=1
	ld.d	$s0, $sp, 744
	sub.d	$fp, $a0, $s0
	ld.d	$a0, $sp, 80                    # 8-byte Folded Reload
	beq	$fp, $a0, .LBB4_210
# %bb.89:                               # %_ZNKSt6vectorIdSaIdEE12_M_check_lenEmPKc.exit.i.i215
                                        #   in Loop: Header=BB4_75 Depth=1
	srai.d	$a0, $fp, 3
	ori	$s4, $zero, 1
	sltu	$a1, $s4, $a0
...
.Ltmp25:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp26:                                # EH_LABEL
# %bb.90:                               # %call5.i.i.i.i.noexc231
                                        #   in Loop: Header=BB4_75 Depth=1
	move	$s3, $a0
	fld.d	$fa0, $s2, 440
	fstx.d	$fa0, $a0, $fp
	blt	$fp, $s4, .LBB4_92
# %bb.91:                               # %if.then.i.i.i.i.i228
                                        #   in Loop: Header=BB4_75 Depth=1
	move	$a0, $s3
	move	$a1, $s0
	move	$a2, $fp
	pcaddu18i	$ra, %call36(memcpy)
	jirl	$ra, $ra, 0
.LBB4_92:                               # %_ZNSt6vectorIdSaIdEE11_S_relocateEPdS2_S2_RS0_.exit.i.i222
                                        #   in Loop: Header=BB4_75 Depth=1
	beqz	$s0, .LBB4_94
# %bb.93:                               # %_ZNSt12_Vector_baseIdSaIdEE13_M_deallocateEPdm.exit.i.i.i224
                                        #   in Loop: Header=BB4_75 Depth=1
	move	$a0, $s0
	move	$a1, $fp
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB4_94:                               # %_ZNSt6vectorIdSaIdEE17_M_realloc_appendIJRKdEEEvDpOT_.exit.i225
                                        #   in Loop: Header=BB4_75 Depth=1
	add.d	$a0, $s3, $fp
	addi.d	$a0, $a0, 8
	st.d	$s3, $sp, 744
	...
	b	.LBB4_74
	.p2align	4, , 16
.LBB4_95:                               # %if.then.i303
                                        #   in Loop: Header=BB4_97 Depth=2
	fld.d	$fa0, $s3, 64
	fst.d	$fa0, $a0, 0
	addi.d	$a0, $a0, 8
	st.d	$a0, $s2, 88
.LBB4_96:                               # %invoke.cont128
                                        #   in Loop: Header=BB4_97 Depth=2
	move	$a0, $s3
	pcaddu18i	$ra, %call36(_ZSt18_Rb_tree_incrementPSt18_Rb_tree_node_base)
	jirl	$ra, $ra, 0
...
.LBB4_97:                               # %for.body112
	...
	addi.d	$s2, $sp, 704
	beqz	$s1, .LBB4_108
# %bb.98:                               # %while.body.lr.ph.i.i.i243
                                        #   in Loop: Header=BB4_97 Depth=2
	ld.d	$s4, $s3, 32
	ld.d	$s0, $s3, 40
	addi.d	$fp, $sp, 704
	b	.LBB4_101
	.p2align	4, , 16
.LBB4_99:                               # %if.then.i.i.i.i.i.i286
	...
	masknez	$a1, $s6, $a1
	or	$a0, $a0, $a1
.LBB4_100:                              # %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i.i256
                                        #   in Loop: Header=BB4_101 Depth=3
	addi.w	$a0, $a0, 0
	slti	$a1, $a0, 0
	masknez	$a0, $s1, $a1
...
.LBB4_101:                              # %while.body.i.i.i245
	...
	or	$a2, $a0, $a1
	beqz	$a2, .LBB4_99
# %bb.102:                              # %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i.i.i252
                                        #   in Loop: Header=BB4_101 Depth=3
	ld.d	$a0, $s1, 32
	move	$a1, $s4
	pcaddu18i	$ra, %call36(memcmp)
	...
	b	.LBB4_99
	.p2align	4, , 16
.LBB4_103:                              # %_ZNKSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_ZN9benchmark12ComputeStatsERKSt6vectorINS8_17BenchmarkReporter3RunESaISB_EEE11CounterStatESt10_Select1stISH_ESt4lessIS5_ESaISH_EE14_M_lower_boundEPSt18_Rb_tree_node_baseSP_RS7_.exit.i.i264
                                        #   in Loop: Header=BB4_97 Depth=2
	addi.d	$a2, $sp, 704
	move	$s2, $a2
	beq	$fp, $a2, .LBB4_108
# %bb.104:                              # %lor.lhs.false.i.i267
                                        #   in Loop: Header=BB4_97 Depth=2
	or	$a0, $a1, $a0
	ld.d	$s1, $a0, 40
	sltu	$a1, $s1, $s0
	...
	or	$a2, $a2, $a1
	beqz	$a2, .LBB4_106
# %bb.105:                              # %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i.i272
                                        #   in Loop: Header=BB4_97 Depth=2
	ld.d	$a1, $a0, 32
	move	$a0, $s4
	pcaddu18i	$ra, %call36(memcmp)
...
.LBB4_106:                              # %if.then.i.i.i.i.i281
	...
	masknez	$a1, $s6, $a1
	or	$a0, $a0, $a1
.LBB4_107:                              # %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i276
                                        #   in Loop: Header=BB4_97 Depth=2
	addi.w	$a0, $a0, 0
	slti	$a0, $a0, 0
	masknez	$a1, $fp, $a0
	...
	maskeqz	$a0, $a2, $a0
	or	$s2, $a0, $a1
.LBB4_108:                              # %invoke.cont118
                                        #   in Loop: Header=BB4_97 Depth=2
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
	ld.b	$a0, $a0, 0
	dbar	20
	beqz	$a0, .LBB4_117
.LBB4_109:                              # %invoke.cont122
                                        #   in Loop: Header=BB4_97 Depth=2
	ld.d	$a0, $s2, 88
	ld.d	$a1, $s2, 96
	bne	$a0, $a1, .LBB4_95
...
.Ltmp28:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp29:                                # EH_LABEL
# %bb.112:                              # %call5.i.i.i.i.noexc326
                                        #   in Loop: Header=BB4_97 Depth=2
	move	$s4, $a0
	fld.d	$fa0, $s3, 64
	fstx.d	$fa0, $a0, $fp
	blt	$fp, $s7, .LBB4_114
# %bb.113:                              # %if.then.i.i.i.i.i323
                                        #   in Loop: Header=BB4_97 Depth=2
	move	$a0, $s4
	move	$a1, $s0
	move	$a2, $fp
	pcaddu18i	$ra, %call36(memcpy)
	jirl	$ra, $ra, 0
.LBB4_114:                              # %_ZNSt6vectorIdSaIdEE11_S_relocateEPdS2_S2_RS0_.exit.i.i318
                                        #   in Loop: Header=BB4_97 Depth=2
	beqz	$s0, .LBB4_116
# %bb.115:                              # %_ZNSt12_Vector_baseIdSaIdEE13_M_deallocateEPdm.exit.i.i.i320
                                        #   in Loop: Header=BB4_97 Depth=2
	move	$a0, $s0
	move	$a1, $fp
	pcaddu18i	$ra, %call36(_ZdlPvm)
...
# %bb.122:                              # %init.i191
	...
	jirl	$ra, $ra, 0
	b	.LBB4_77
.LBB4_123:                              # %for.cond.cleanup85.loopexit
	ld.d	$a0, $sp, 64                    # 8-byte Folded Reload
	ld.d	$s3, $a0, 0
...
.LBB4_124:
	ld.d	$s5, $sp, 72                    # 8-byte Folded Reload
	move	$s3, $fp
.LBB4_125:                              # %for.cond.cleanup85
	lu12i.w	$s2, 59918
	ld.d	$s6, $sp, 8                     # 8-byte Folded Reload
.LBB4_126:                              # %for.cond.cleanup85
	addi.d	$a0, $sp, 680
	ld.d	$a1, $s3, 328
	ld.d	$fp, $s3, 320
	st.d	$a0, $sp, 664
...
# %bb.130:                              # %if.end.i.i
	bnez	$a1, .LBB4_132
# %bb.131:                              # %if.then.i.i.i180
	ld.b	$a1, $fp, 0
	st.b	$a1, $a0, 0
	b	.LBB4_133
.LBB4_132:                              # %if.end.i.i.i.i
	addi.d	$a2, $a1, 1
	move	$a1, $fp
	pcaddu18i	$ra, %call36(memcpy)
	jirl	$ra, $ra, 0
...
.Ltmp40:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp41:                                # EH_LABEL
# %bb.140:                              # %if.then160.cleanup166_crit_edge
	ld.d	$a1, $sp, 64                    # 8-byte Folded Reload
	ld.d	$a0, $a1, 8
	ld.d	$s1, $a1, 0
	sub.d	$a0, $a0, $s1
...
.LBB4_159:                              # %if.end221
	...
	st.w	$a0, $sp, 528
	b	.LBB4_164
.LBB4_160:                              # %if.then.i.i.i.i.i.i491
	...
	masknez	$a1, $s1, $a1
	or	$a0, $a0, $a1
.LBB4_161:                              # %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i.i488
                                        #   in Loop: Header=BB4_164 Depth=2
	addi.w	$a0, $a0, 0
	slti	$a0, $a0, 0
.LBB4_162:                              # %cleanup.thread.i
                                        #   in Loop: Header=BB4_164 Depth=2
	move	$a1, $s7
	move	$a2, $fp
	addi.d	$a3, $sp, 608
...
# %bb.168:                              # %invoke.cont251
	...
	addi.d	$s4, $sp, 608
	beqz	$s6, .LBB4_179
# %bb.169:                              # %while.body.lr.ph.i.i.i.i406
                                        #   in Loop: Header=BB4_164 Depth=2
	ld.d	$s0, $s3, 40
	ld.d	$fp, $s3, 32
	addi.d	$s7, $sp, 608
	b	.LBB4_172
	.p2align	4, , 16
.LBB4_170:                              # %if.then.i.i.i.i.i.i.i443
	...
	masknez	$a1, $s1, $a1
	or	$a0, $a0, $a1
.LBB4_171:                              # %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i.i.i417
                                        #   in Loop: Header=BB4_172 Depth=3
	addi.w	$a0, $a0, 0
	slti	$a1, $a0, 0
	masknez	$a0, $s6, $a1
	...
	or	$s7, $a1, $a0
	beqz	$s6, .LBB4_174
.LBB4_172:                              # %while.body.i.i.i.i408
                                        #   Parent Loop BB4_144 Depth=1
	...
	or	$a2, $a0, $a1
	beqz	$a2, .LBB4_170
# %bb.173:                              # %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i.i.i.i413
                                        #   in Loop: Header=BB4_172 Depth=3
	ld.d	$a0, $s6, 32
	move	$a1, $fp
	pcaddu18i	$ra, %call36(memcmp)
...
# %bb.175:                              # %lor.rhs.i426
	...
	or	$a2, $a2, $a1
	beqz	$a2, .LBB4_178
# %bb.176:                              # %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i431
                                        #   in Loop: Header=BB4_164 Depth=2
	ld.d	$a1, $a0, 32
	move	$a0, $fp
	pcaddu18i	$ra, %call36(memcmp)
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB4_178
# %bb.177:                              # %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i434
                                        #   in Loop: Header=BB4_164 Depth=2
	addi.w	$a0, $a0, 0
	move	$s4, $s7
...
# %bb.185:                              # %lor.rhs.i.i.i
	...
	or	$a2, $a0, $a1
	beqz	$a2, .LBB4_160
# %bb.186:                              # %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i.i.i485
                                        #   in Loop: Header=BB4_164 Depth=2
	ld.d	$a1, $fp, 32
	ld.d	$a0, $s5, 0
	pcaddu18i	$ra, %call36(memcmp)
	...
	b	.LBB4_160
	.p2align	4, , 16
.LBB4_187:                              # %if.then.i.i496
                                        #   in Loop: Header=BB4_164 Depth=2
	move	$fp, $a2
	ld.d	$a0, $s7, 32
	addi.d	$a1, $s7, 48
	beq	$a0, $a1, .LBB4_189
# %bb.188:                              # %if.then.i.i.i.i.i.i.i498
                                        #   in Loop: Header=BB4_164 Depth=2
	ld.d	$a1, $a1, 0
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
...
# %bb.198:                              # %if.then.i.i2.i
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB4_199:                              # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit7.i
                                        #   in Loop: Header=BB4_144 Depth=1
	ld.d	$a0, $sp, 384
	addi.d	$a1, $sp, 400
	beq	$a0, $a1, .LBB4_143
# %bb.200:                              # %if.then.i.i9.i
                                        #   in Loop: Header=BB4_144 Depth=1
	ld.d	$a1, $sp, 400
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
	b	.LBB4_143
.LBB4_201:                              # %for.cond.cleanup183
	ld.d	$a0, $sp, 664
	addi.d	$a1, $sp, 680
	beq	$a0, $a1, .LBB4_203
# %bb.202:                              # %if.then.i.i353
	ld.d	$a1, $sp, 680
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
...
.LBB4_205:                              # %_ZNSt6vectorIdSaIdEED2Ev.exit
	ld.d	$a0, $sp, 768
	beqz	$a0, .LBB4_207
# %bb.206:                              # %if.then.i.i.i363
	ld.d	$a1, $sp, 784
	sub.d	$a1, $a1, $a0
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB4_207:                              # %nrvo.skipdtor
...
.Ltmp32:                                # EH_LABEL
# %bb.209:                              # %.noexc325
.LBB4_210:                              # %if.then.i.i.i201.invoke
.Ltmp34:                                # EH_LABEL
	pcalau12i	$a0, %pc_hi20(.L.str.2)
	addi.d	$a0, $a0, %pc_lo12(.L.str.2)
	pcaddu18i	$ra, %call36(_ZSt20__throw_length_errorPKc)
...
.Ltmp39:                                # EH_LABEL
	...
	beqz	$a0, .LBB4_238
	b	.LBB4_241
.LBB4_214:                              # %ehcleanup297.thread
.Ltmp7:                                 # EH_LABEL
	move	$s0, $a0
	ld.d	$a0, $sp, 768
	beqz	$a0, .LBB4_239
	b	.LBB4_242
.LBB4_215:                              # %lpad88.loopexit.split-lp
.Ltmp36:                                # EH_LABEL
	b	.LBB4_227
.LBB4_216:                              # %lpad88.loopexit
.Ltmp27:                                # EH_LABEL
	b	.LBB4_227
.LBB4_217:                              # %terminate.lpad.i.i.i
.Ltmp92:                                # EH_LABEL
...
.Ltmp45:                                # EH_LABEL
	move	$s0, $a0
	b	.LBB4_236
.LBB4_219:                              # %lpad117.loopexit
.Ltmp30:                                # EH_LABEL
	b	.LBB4_227
.LBB4_220:                              # %lpad117.loopexit.split-lp
.Ltmp33:                                # EH_LABEL
	b	.LBB4_227
.LBB4_221:                              # %lpad.i.i.i.i.i.i
.Ltmp13:                                # EH_LABEL
...
.Ltmp14:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp15:                                # EH_LABEL
# %bb.222:                              # %unreachable.i.i.i.i.i.i
.LBB4_223:                              # %lpad5.i.i.i.i.i.i
.Ltmp16:                                # EH_LABEL
	move	$s0, $a0
.Ltmp17:                                # EH_LABEL
...
.Ltmp18:                                # EH_LABEL
	b	.LBB4_228
.LBB4_224:                              # %terminate.lpad.i.i.i.i.i.i
.Ltmp19:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB4_225:                              # %lpad37
...
.LBB4_226:                              # %lpad50
.Ltmp10:                                # EH_LABEL
.LBB4_227:                              # %_ZZN9benchmark12ComputeStatsERKSt6vectorINS_17BenchmarkReporter3RunESaIS2_EEEN11CounterStatD2Ev.exit176
	move	$s0, $a0
.LBB4_228:                              # %_ZZN9benchmark12ComputeStatsERKSt6vectorINS_17BenchmarkReporter3RunESaIS2_EEEN11CounterStatD2Ev.exit176
	ld.d	$s5, $sp, 72                    # 8-byte Folded Reload
	ld.d	$a0, $sp, 712
	pcaddu18i	$ra, %call36(_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_ZN9benchmark12ComputeStatsERKSt6vectorINS8_17BenchmarkReporter3RunESaISB_EEE11CounterStatESt10_Select1stISH_ESt4lessIS5_ESaISH_EE8_M_eraseEPSt13_Rb_tree_nodeISH_E)
	jirl	$ra, $ra, 0
...
.Ltmp81:                                # EH_LABEL
	move	$s0, $a0
.LBB4_234:                              # %ehcleanup272
	ld.d	$s5, $sp, 72                    # 8-byte Folded Reload
.LBB4_235:                              # %ehcleanup272
	addi.d	$a0, $sp, 104
	pcaddu18i	$ra, %call36(_ZN9benchmark17BenchmarkReporter3RunD2Ev)
	jirl	$ra, $ra, 0
.LBB4_236:                              # %ehcleanup287
	ld.d	$a0, $sp, 664
	addi.d	$a1, $sp, 680
	bne	$a0, $a1, .LBB4_240
# %bb.237:                              # %ehcleanup297
	...
	ld.d	$a0, $sp, 744
	bnez	$a0, .LBB4_241
.LBB4_238:                              # %_ZNSt6vectorIdSaIdEED2Ev.exit466
	ld.d	$a0, $sp, 768
	bnez	$a0, .LBB4_242
.LBB4_239:                              # %_ZNSt6vectorIdSaIdEED2Ev.exit473
	move	$a0, $s5
