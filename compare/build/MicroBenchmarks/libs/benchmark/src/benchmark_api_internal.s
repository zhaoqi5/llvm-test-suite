...
.LBB0_55:                               # %if.end18.i96
	...
	stx.b	$zero, $a1, $a0
	ld.d	$a0, $sp, 88
.LBB0_56:                               # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit106
	st.d	$zero, $sp, 96
	st.b	$zero, $a0, 0
	ld.d	$a0, $sp, 88
	addi.d	$a1, $sp, 104
	beq	$a0, $a1, .LBB0_58
# %bb.57:                               # %if.then.i.i108
	ld.d	$a1, $sp, 104
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
...
.Ltmp37:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp38:                                # EH_LABEL
# %bb.60:                               # %invoke.cont117
	addi.d	$a3, $fp, 128
	ld.d	$a0, $a3, 0
	ld.d	$a1, $sp, 64                    # 8-byte Folded Reload
	beq	$a0, $a1, .LBB0_64
# %bb.61:                               # %invoke.cont.thread.i116
	ld.d	$a1, $sp, 88
	addi.d	$a2, $sp, 104
	beq	$a1, $a2, .LBB0_67
# %bb.62:                               # %if.then24.i118
	...
	vst	$vr0, $fp, 136
	beqz	$a0, .LBB0_66
.LBB0_63:                               # %if.then30.i126
	st.d	$a0, $sp, 88
	st.d	$a3, $sp, 104
	b	.LBB0_73
.LBB0_64:                               # %invoke.cont.i141
	ld.d	$a1, $sp, 88
	addi.d	$a2, $sp, 104
	beq	$a1, $a2, .LBB0_67
# %bb.65:
	...
	vst	$vr0, $fp, 136
	bnez	$a0, .LBB0_63
.LBB0_66:                               # %if.else31.i128
	st.d	$a2, $sp, 88
	move	$a0, $a2
	b	.LBB0_73
.LBB0_67:                               # %if.then9.i129
	addi.d	$a2, $sp, 88
	beq	$a2, $a3, .LBB0_129
# %bb.68:                               # %if.then10.i133
	ld.d	$a2, $sp, 96
	beqz	$a2, .LBB0_72
# %bb.69:                               # %if.then10.i133
	ori	$a3, $zero, 1
	bne	$a2, $a3, .LBB0_71
# %bb.70:                               # %if.then.i25.i134
	ld.b	$a1, $a1, 0
	st.b	$a1, $a0, 0
	b	.LBB0_72
.LBB0_71:                               # %if.end.i.i.i140
	pcaddu18i	$ra, %call36(memcpy)
	jirl	$ra, $ra, 0
.LBB0_72:                               # %if.end18.i135
	ld.d	$a0, $sp, 96
	ld.d	$a1, $fp, 128
	st.d	$a0, $fp, 136
	stx.b	$zero, $a1, $a0
	ld.d	$a0, $sp, 88
.LBB0_73:                               # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit145
	st.d	$zero, $sp, 96
	st.b	$zero, $a0, 0
	ld.d	$a0, $sp, 88
	addi.d	$a1, $sp, 104
	beq	$a0, $a1, .LBB0_75
# %bb.74:                               # %if.then.i.i147
	ld.d	$a1, $sp, 104
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB0_75:                               # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit153
	ld.d	$a0, $fp, 256
.LBB0_76:                               # %if.end121
	ld.w	$a2, $a0, 136
	beqz	$a2, .LBB0_94
...
.Ltmp40:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp41:                                # EH_LABEL
# %bb.78:                               # %invoke.cont130
	addi.d	$a3, $fp, 160
	ld.d	$a0, $a3, 0
	ld.d	$a1, $sp, 56                    # 8-byte Folded Reload
	beq	$a0, $a1, .LBB0_82
# %bb.79:                               # %invoke.cont.thread.i155
	ld.d	$a1, $sp, 88
	addi.d	$a2, $sp, 104
	beq	$a1, $a2, .LBB0_85
# %bb.80:                               # %if.then24.i157
	...
	vst	$vr0, $fp, 168
	beqz	$a0, .LBB0_84
.LBB0_81:                               # %if.then30.i165
	st.d	$a0, $sp, 88
	st.d	$a3, $sp, 104
	b	.LBB0_91
.LBB0_82:                               # %invoke.cont.i180
	ld.d	$a1, $sp, 88
	addi.d	$a2, $sp, 104
	beq	$a1, $a2, .LBB0_85
# %bb.83:
	...
	vst	$vr0, $fp, 168
	bnez	$a0, .LBB0_81
.LBB0_84:                               # %if.else31.i167
	st.d	$a2, $sp, 88
	move	$a0, $a2
	b	.LBB0_91
.LBB0_85:                               # %if.then9.i168
	addi.d	$a2, $sp, 88
	beq	$a2, $a3, .LBB0_130
# %bb.86:                               # %if.then10.i172
	ld.d	$a2, $sp, 96
	beqz	$a2, .LBB0_90
# %bb.87:                               # %if.then10.i172
	ori	$a3, $zero, 1
	bne	$a2, $a3, .LBB0_89
# %bb.88:                               # %if.then.i25.i173
	ld.b	$a1, $a1, 0
	st.b	$a1, $a0, 0
	b	.LBB0_90
.LBB0_89:                               # %if.end.i.i.i179
	pcaddu18i	$ra, %call36(memcpy)
	jirl	$ra, $ra, 0
.LBB0_90:                               # %if.end18.i174
	ld.d	$a0, $sp, 96
	ld.d	$a1, $fp, 160
	st.d	$a0, $fp, 168
	stx.b	$zero, $a1, $a0
	ld.d	$a0, $sp, 88
.LBB0_91:                               # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit184
	st.d	$zero, $sp, 96
	st.b	$zero, $a0, 0
	ld.d	$a0, $sp, 88
	addi.d	$a1, $sp, 104
	beq	$a0, $a1, .LBB0_93
# %bb.92:                               # %if.then.i.i186
	ld.d	$a1, $sp, 104
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB0_93:                               # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit192
	ld.d	$a0, $fp, 256
.LBB0_94:                               # %if.end134
	ld.bu	$a1, $a0, 140
	ori	$s1, $zero, 1
...
.Ltmp43:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp44:                                # EH_LABEL
# %bb.96:                               # %if.then138.if.end142_crit_edge
	ld.d	$a0, $fp, 256
.LBB0_97:                               # %if.end142
	ld.bu	$a1, $a0, 142
	bne	$a1, $s1, .LBB0_103
...
.LBB0_108:                              # %if.end172
	...
	lu52i.d	$a1, $a1, 2047
	bgeu	$a0, $a1, .LBB0_138
.LBB0_109:                              # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKc.exit.i245.invoke
.Ltmp51:                                # EH_LABEL
	move	$a0, $s0
	move	$a1, $s2
	move	$a2, $s1
...
.Ltmp54:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp55:                                # EH_LABEL
# %bb.112:                              # %invoke.cont185
	addi.d	$a3, $fp, 224
	ld.d	$a0, $a3, 0
	ld.d	$a4, $sp, 48                    # 8-byte Folded Reload
	beq	$a0, $a4, .LBB0_116
# %bb.113:                              # %invoke.cont.thread.i252
	ld.d	$a1, $sp, 88
	addi.d	$a2, $sp, 104
	beq	$a1, $a2, .LBB0_119
# %bb.114:                              # %if.then24.i254
	ld.d	$a3, $a4, 0
	vld	$vr0, $sp, 96
	st.d	$a1, $fp, 224
	vst	$vr0, $fp, 232
	beqz	$a0, .LBB0_118
.LBB0_115:                              # %if.then30.i262
	st.d	$a0, $sp, 88
	st.d	$a3, $sp, 104
	b	.LBB0_125
.LBB0_116:                              # %invoke.cont.i277
	ld.d	$a1, $sp, 88
	addi.d	$a2, $sp, 104
	beq	$a1, $a2, .LBB0_119
# %bb.117:
	...
	vst	$vr0, $fp, 232
	bnez	$a0, .LBB0_115
.LBB0_118:                              # %if.else31.i264
	st.d	$a2, $sp, 88
	move	$a0, $a2
	b	.LBB0_125
.LBB0_119:                              # %if.then9.i265
	addi.d	$a2, $sp, 88
	beq	$a2, $a3, .LBB0_131
# %bb.120:                              # %if.then10.i269
	ld.d	$a2, $sp, 96
	beqz	$a2, .LBB0_124
# %bb.121:                              # %if.then10.i269
	ori	$a3, $zero, 1
	bne	$a2, $a3, .LBB0_123
# %bb.122:                              # %if.then.i25.i270
	ld.b	$a1, $a1, 0
	st.b	$a1, $a0, 0
	b	.LBB0_124
.LBB0_123:                              # %if.end.i.i.i276
	pcaddu18i	$ra, %call36(memcpy)
	jirl	$ra, $ra, 0
.LBB0_124:                              # %if.end18.i271
	ld.d	$a0, $sp, 96
	ld.d	$a1, $fp, 224
	st.d	$a0, $fp, 232
	stx.b	$zero, $a1, $a0
	ld.d	$a0, $sp, 88
.LBB0_125:                              # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit281
	st.d	$zero, $sp, 96
	st.b	$zero, $a0, 0
	ld.d	$a0, $sp, 88
	addi.d	$a1, $sp, 104
	beq	$a0, $a1, .LBB0_127
# %bb.126:                              # %if.then.i.i283
	ld.d	$a1, $sp, 104
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB0_127:                              # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit289
	ld.d	$a0, $fp, 256
.LBB0_128:                              # %if.end189
	vld	$vr0, $a0, 208
	addi.d	$a0, $fp, 408
...
.Ltmp16:                                # EH_LABEL
# %bb.137:                              # %.noexc26
.LBB0_138:                              # %if.then.i.i.i246.invoke
.Ltmp49:                                # EH_LABEL
	pcalau12i	$a0, %pc_hi20(.L.str.10)
	addi.d	$a0, $a0, %pc_lo12(.L.str.10)
	pcaddu18i	$ra, %call36(_ZSt20__throw_length_errorPKc)
...
.Ltmp8:                                 # EH_LABEL
	b	.LBB0_153
.LBB0_149:                              # %lpad61.loopexit.split-lp
.Ltmp17:                                # EH_LABEL
	b	.LBB0_156
.LBB0_150:                              # %lpad61.loopexit
.Ltmp14:                                # EH_LABEL
	b	.LBB0_156
.LBB0_151:                              # %lpad57
.Ltmp11:                                # EH_LABEL
...
.LBB0_152:                              # %lpad68
.Ltmp20:                                # EH_LABEL
.LBB0_153:                              # %ehcleanup197
	move	$s0, $a0
	b	.LBB0_158
.LBB0_154:                              # %lpad72.loopexit
.Ltmp23:                                # EH_LABEL
	b	.LBB0_156
.LBB0_155:                              # %lpad72.loopexit.split-lp
.Ltmp26:                                # EH_LABEL
.LBB0_156:                              # %lpad61
	move	$s0, $a0
	ld.d	$a0, $sp, 88
	addi.d	$a1, $sp, 104
	beq	$a0, $a1, .LBB0_158
# %bb.157:                              # %if.then.i.i33
	ld.d	$a1, $sp, 104
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB0_158:                              # %ehcleanup197
	addi.d	$a0, $fp, 312
