...
# %bb.93:                               # %call2.i5.i.noexc215
	ld.d	$a1, $sp, 472
	pcalau12i	$s2, %pc_hi20(.L.str.58)
	xvld	$xr0, $s2, %pc_lo12(.L.str.58)
	st.d	$a0, $sp, 920
	st.d	$a1, $sp, 936
	xvst	$xr0, $a0, 0
	ld.d	$a0, $sp, 920
...
.Ltmp371:                               # EH_LABEL
	b	.LBB18_548
.LBB18_541:                             # %lpad14.i588
.Ltmp362:                               # EH_LABEL
	b	.LBB18_554
.LBB18_542:                             # %lpad14.i466
.Ltmp353:                               # EH_LABEL
	b	.LBB18_554
.LBB18_543:                             # %ehcleanup.thread.i413
.Ltmp344:                               # EH_LABEL
	b	.LBB18_600
.LBB18_544:                             # %ehcleanup17.thread.i
.Ltmp330:                               # EH_LABEL
	move	$fp, $a0
	b	.LBB18_612
.LBB18_545:                             # %ehcleanup.thread.i353
.Ltmp314:                               # EH_LABEL
	move	$fp, $a0
	b	.LBB18_612
.LBB18_546:                             # %ehcleanup.thread.i318
.Ltmp298:                               # EH_LABEL
	move	$fp, $a0
	b	.LBB18_612
.LBB18_547:                             # %lpad14.i233
.Ltmp295:                               # EH_LABEL
.LBB18_548:                             # %lpad14.i233
	ld.d	$a2, $sp, 16
	move	$fp, $a0
	bne	$a2, $s1, .LBB18_551
# %bb.549:                              # %ehcleanup.i237
	ld.d	$a0, $sp, 56
	bne	$a0, $s4, .LBB18_582
.LBB18_550:                             # %ehcleanup19.i242
	ld.d	$a0, $sp, 88
	bne	$a0, $s3, .LBB18_590
	b	.LBB18_592
.LBB18_551:                             # %if.then.i.i77.i235
	ld.d	$a0, $sp, 32
	addi.d	$a1, $a0, 1
	move	$a0, $a2
	pcaddu18i	$ra, %call36(_ZdlPvm)
...
.LBB18_554:                             # %lpad14.i
	...
	move	$fp, $a0
	bne	$a2, $s1, .LBB18_557
# %bb.555:                              # %ehcleanup.i65
	ld.d	$a0, $sp, 56
	bne	$a0, $s8, .LBB18_558
.LBB18_556:                             # %ehcleanup19.i
	ld.d	$a0, $sp, 88
	bne	$a0, $s7, .LBB18_590
	b	.LBB18_592
.LBB18_557:                             # %if.then.i.i77.i
	ld.d	$a0, $sp, 32
	addi.d	$a1, $a0, 1
	move	$a0, $a2
	pcaddu18i	$ra, %call36(_ZdlPvm)
...
.LBB18_558:                             # %if.then.i.i84.i
	...
	beq	$a0, $s7, .LBB18_592
	b	.LBB18_590
.LBB18_559:                             # %ehcleanup.thread.i54
.Ltmp268:                               # EH_LABEL
	b	.LBB18_600
.LBB18_560:                             # %ehcleanup15.thread.i
.Ltmp256:                               # EH_LABEL
	move	$fp, $a0
	b	.LBB18_612
.LBB18_561:                             # %ehcleanup.thread.i6
.Ltmp242:                               # EH_LABEL
	move	$fp, $a0
	b	.LBB18_612
.LBB18_562:                             # %ehcleanup.thread.i
.Ltmp228:                               # EH_LABEL
	move	$fp, $a0
	b	.LBB18_612
.LBB18_563:                             # %lpad12.i1249
.Ltmp489:                               # EH_LABEL
	move	$fp, $a0
	ld.d	$a0, $sp, 56
	beq	$a0, $s4, .LBB18_550
	b	.LBB18_582
.LBB18_564:                             # %lpad8.i1257
.Ltmp492:                               # EH_LABEL
	move	$fp, $a0
	ld.d	$a0, $sp, 88
	bne	$a0, $s3, .LBB18_590
	b	.LBB18_592
.LBB18_565:                             # %lpad4.i1265
.Ltmp495:                               # EH_LABEL
	move	$fp, $a0
	b	.LBB18_592
.LBB18_566:                             # %lpad12.i1127
.Ltmp498:                               # EH_LABEL
	move	$fp, $a0
	ld.d	$a0, $sp, 56
	beq	$a0, $s8, .LBB18_556
	b	.LBB18_558
.LBB18_567:                             # %lpad8.i1135
.Ltmp501:                               # EH_LABEL
	move	$fp, $a0
	ld.d	$a0, $sp, 88
	bne	$a0, $s7, .LBB18_590
	b	.LBB18_592
.LBB18_568:                             # %lpad4.i1143
.Ltmp504:                               # EH_LABEL
	move	$fp, $a0
	b	.LBB18_592
.LBB18_569:                             # %lpad12.i1005
.Ltmp507:                               # EH_LABEL
	move	$fp, $a0
	ld.d	$a0, $sp, 56
	beq	$a0, $s8, .LBB18_556
	b	.LBB18_558
.LBB18_570:                             # %lpad8.i1013
.Ltmp510:                               # EH_LABEL
	move	$fp, $a0
	ld.d	$a0, $sp, 88
	bne	$a0, $s7, .LBB18_590
	b	.LBB18_592
.LBB18_571:                             # %lpad4.i1021
.Ltmp513:                               # EH_LABEL
	move	$fp, $a0
	b	.LBB18_592
.LBB18_572:                             # %lpad12.i766
.Ltmp516:                               # EH_LABEL
	move	$fp, $a0
	ld.d	$a0, $sp, 56
	beq	$a0, $s4, .LBB18_550
	b	.LBB18_582
.LBB18_573:                             # %lpad8.i774
.Ltmp519:                               # EH_LABEL
	move	$fp, $a0
	ld.d	$a0, $sp, 88
	bne	$a0, $s3, .LBB18_590
	b	.LBB18_592
.LBB18_574:                             # %lpad4.i782
.Ltmp522:                               # EH_LABEL
	move	$fp, $a0
	b	.LBB18_592
.LBB18_575:                             # %lpad12.i644
.Ltmp525:                               # EH_LABEL
	move	$fp, $a0
	ld.d	$a0, $sp, 56
	beq	$a0, $s8, .LBB18_556
	b	.LBB18_558
.LBB18_576:                             # %lpad8.i652
.Ltmp528:                               # EH_LABEL
	move	$fp, $a0
	ld.d	$a0, $sp, 88
	bne	$a0, $s7, .LBB18_590
	b	.LBB18_592
.LBB18_577:                             # %lpad4.i660
.Ltmp531:                               # EH_LABEL
	move	$fp, $a0
	b	.LBB18_592
.LBB18_578:                             # %lpad12.i522
.Ltmp534:                               # EH_LABEL
	move	$fp, $a0
	ld.d	$a0, $sp, 56
	beq	$a0, $s8, .LBB18_556
	b	.LBB18_558
.LBB18_579:                             # %lpad8.i530
.Ltmp537:                               # EH_LABEL
	move	$fp, $a0
	ld.d	$a0, $sp, 88
	bne	$a0, $s7, .LBB18_590
	b	.LBB18_592
.LBB18_580:                             # %lpad4.i538
.Ltmp540:                               # EH_LABEL
	move	$fp, $a0
	b	.LBB18_592
.LBB18_581:                             # %lpad12.i289
.Ltmp543:                               # EH_LABEL
	move	$fp, $a0
	ld.d	$a0, $sp, 56
	beq	$a0, $s4, .LBB18_550
.LBB18_582:                             # %if.then.i.i84.i240
	ld.d	$a1, $sp, 72
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
	...
	bne	$a0, $s3, .LBB18_590
	b	.LBB18_592
.LBB18_583:                             # %lpad8.i297
.Ltmp546:                               # EH_LABEL
	move	$fp, $a0
	ld.d	$a0, $sp, 88
	bne	$a0, $s3, .LBB18_590
	b	.LBB18_592
.LBB18_584:                             # %lpad4.i305
.Ltmp549:                               # EH_LABEL
	move	$fp, $a0
	b	.LBB18_592
.LBB18_585:                             # %lpad12.i167
.Ltmp552:                               # EH_LABEL
	move	$fp, $a0
	ld.d	$a0, $sp, 56
	beq	$a0, $s8, .LBB18_556
	b	.LBB18_558
.LBB18_586:                             # %lpad8.i175
.Ltmp555:                               # EH_LABEL
	move	$fp, $a0
	ld.d	$a0, $sp, 88
	bne	$a0, $s7, .LBB18_590
	b	.LBB18_592
.LBB18_587:                             # %lpad4.i183
.Ltmp558:                               # EH_LABEL
	move	$fp, $a0
	b	.LBB18_592
.LBB18_588:                             # %lpad12.i
...
.Ltmp564:                               # EH_LABEL
	...
	ld.d	$a0, $sp, 88
	beq	$a0, $s7, .LBB18_592
.LBB18_590:                             # %if.then.i.i91.i
	ld.d	$a1, $sp, 104
	addi.d	$a1, $a1, 1
.LBB18_591:                             # %ehcleanup23.i
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB18_592:                             # %ehcleanup23.i
	ld.d	$a0, $sp, 120
	beq	$a0, $s2, .LBB18_614
# %bb.593:                              # %if.then.i.i98.i
	ld.d	$a1, $sp, 136
	addi.d	$a1, $a1, 1
	b	.LBB18_613
.LBB18_594:                             # %lpad4.i
.Ltmp567:                               # EH_LABEL
	move	$fp, $a0
	b	.LBB18_592
.LBB18_595:                             # %ehcleanup35.i
.Ltmp459:                               # EH_LABEL
	ld.d	$a2, $sp, 120
	move	$fp, $a0
	beq	$a2, $s2, .LBB18_611
	b	.LBB18_609
.LBB18_596:                             # %ehcleanup.i44
.Ltmp265:                               # EH_LABEL
	ld.d	$a2, $sp, 120
	move	$fp, $a0
	beq	$a2, $s2, .LBB18_611
	b	.LBB18_609
.LBB18_597:                             # %lpad.i.i7.i
.Ltmp483:                               # EH_LABEL
	ld.d	$a2, $sp, 88
	move	$fp, $a0
	beq	$a2, $s1, .LBB18_592
.LBB18_598:                             # %ehcleanup11.i.sink.split
	ld.d	$a0, $sp, 104
	addi.d	$a1, $a0, 1
	move	$a0, $a2
	b	.LBB18_591
.LBB18_599:                             # %lpad.i.i.i
.Ltmp486:                               # EH_LABEL
.LBB18_600:                             # %ehcleanup.thread.i54
	ld.d	$a2, $sp, 120
	move	$fp, $a0
	beq	$a2, $s2, .LBB18_614
# %bb.601:                              # %ehcleanup15.thread26.i
	ld.d	$a0, $sp, 136
	addi.d	$a1, $a0, 1
	move	$a0, $a2
	b	.LBB18_613
.LBB18_602:                             # %ehcleanup.i877
.Ltmp417:                               # EH_LABEL
	ld.d	$a2, $sp, 120
	move	$fp, $a0
	beq	$a2, $s2, .LBB18_611
	b	.LBB18_609
.LBB18_603:                             # %ehcleanup.i397
.Ltmp341:                               # EH_LABEL
	ld.d	$a2, $sp, 120
	move	$fp, $a0
	beq	$a2, $s2, .LBB18_611
...
.Ltmp239:                               # EH_LABEL
	...
	bne	$a2, $s2, .LBB18_609
	b	.LBB18_611
.LBB18_606:                             # %lpad2.i840
.Ltmp403:                               # EH_LABEL
	ld.d	$a2, $sp, 120
	move	$fp, $a0
	beq	$a2, $s2, .LBB18_611
	b	.LBB18_609
.LBB18_607:                             # %lpad2.i803
.Ltmp387:                               # EH_LABEL
	ld.d	$a2, $sp, 120
	move	$fp, $a0
	beq	$a2, $s2, .LBB18_611
	b	.LBB18_609
.LBB18_608:                             # %lpad2.i361
.Ltmp327:                               # EH_LABEL
	ld.d	$a2, $sp, 120
	move	$fp, $a0
	beq	$a2, $s2, .LBB18_611
.LBB18_609:                             # %ehcleanup.i
	ld.d	$a0, $sp, 136
	addi.d	$a1, $a0, 1
	move	$a0, $a2
	pcaddu18i	$ra, %call36(_ZdlPvm)
	...
	beqz	$s1, .LBB18_614
	b	.LBB18_612
.LBB18_610:                             # %lpad2.i326
.Ltmp311:                               # EH_LABEL
	ld.d	$a2, $sp, 120
	move	$fp, $a0
	bne	$a2, $s2, .LBB18_609
.LBB18_611:                             # %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i7.i
	beqz	$s1, .LBB18_614
.LBB18_612:                             # %cleanup.action.i
	ori	$a1, $zero, 232
	move	$a0, $s0
