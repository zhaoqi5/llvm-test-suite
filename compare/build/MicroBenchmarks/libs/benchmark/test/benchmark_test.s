...
# %bb.4:                                # %for.body.us.preheader
	bgeu	$a2, $a1, .LBB1_24
# %bb.5:                                # %for.body.us.us.preheader
	movgr2fr.d	$fa0, $zero
	addi.w	$a1, $zero, -1
	.p2align	4, , 16
.LBB1_6:                                # %for.body.us.us
...
.LBB1_7:                                # %for.body.i.us.us
	...
	addi.w	$a2, $a2, 2
	bnez	$a3, .LBB1_7
# %bb.8:                                # %for.cond.cleanup.loopexit.i.us.us
                                        #   in Loop: Header=BB1_6 Depth=1
	addi.d	$s0, $s0, -1
	bnez	$s0, .LBB1_6
# %bb.9:                                # %for.cond.for.cond.cleanup_crit_edge.split.us.split.us
	vldi	$vr0, -784
	fadd.d	$fa0, $fa1, $fa0
	vldi	$vr1, -1008
	fmul.d	$fa0, $fa0, $fa1
...
.LBB15_2:                               # %vector.body
	...
	vadd.w	$vr3, $vr3, $vr4
	bne	$a2, $a1, .LBB15_2
# %bb.3:                                # %cond.end.loopexit
	pcalau12i	$a0, %pc_hi20(.LCPI15_1)
	vld	$vr3, $a0, %pc_lo12(.LCPI15_1)
	addi.d	$a0, $a1, -4
	vreplgr2vr.w	$vr4, $a0
	vor.v	$vr3, $vr4, $vr3
	vslt.wu	$vr0, $vr0, $vr3
...
# %bb.33:                               # %invoke.cont18.i
	...
	vld	$vr0, $a1, %pc_lo12(.LCPI33_0)
	pcalau12i	$a1, %pc_hi20(.LCPI33_1)
	vld	$vr1, $a1, %pc_lo12(.LCPI33_1)
	addi.d	$a1, $a0, 32
	st.d	$a1, $sp, 32
	vst	$vr0, $a0, 0
	vst	$vr1, $a0, 16
