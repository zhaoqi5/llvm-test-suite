...
.LBB16_956:                             # %ehcleanup149.i
	...
	addi.d	$a1, $sp, 560
	bne	$a0, $a1, .LBB16_963
# %bb.957:                              # %ehcleanup152.i
	ld.d	$a0, $sp, 576
	addi.d	$a1, $sp, 592
	bne	$a0, $a1, .LBB16_964
.LBB16_958:                             # %ehcleanup155.i
	ld.d	$a0, $sp, 608
	addi.d	$a1, $sp, 624
	bne	$a0, $a1, .LBB16_965
.LBB16_959:                             # %ehcleanup158.i
	ld.d	$a0, $sp, 640
	addi.d	$a1, $sp, 656
	bne	$a0, $a1, .LBB16_966
.LBB16_960:                             # %ehcleanup161.i
	ld.d	$a0, $sp, 672
	addi.d	$a1, $sp, 688
	bne	$a0, $a1, .LBB16_967
.LBB16_961:                             # %ehcleanup164.i
	ld.d	$a0, $sp, 704
	addi.d	$a1, $sp, 720
	bne	$a0, $a1, .LBB16_968
.LBB16_962:                             # %ehcleanup167.i
	ld.d	$a0, $sp, 736
	addi.d	$a1, $sp, 752
	bne	$a0, $a1, .LBB16_969
	b	.LBB16_970
.LBB16_963:                             # %if.then.i.i407.i
	ld.d	$a1, $sp, 560
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
...
.Ltmp635:                               # EH_LABEL
	...
	move	$s0, $s6
	b	.LBB16_970
.LBB16_1000:                            # %lpad30.i41
.Ltmp632:                               # EH_LABEL
	move	$s0, $s6
	move	$s3, $a0
	move	$s1, $zero
	b	.LBB16_970
.LBB16_1001:                            # %lpad28.i40
.Ltmp629:                               # EH_LABEL
	move	$s3, $a0
	move	$s1, $zero
	move	$s0, $s6
	b	.LBB16_972
.LBB16_1002:                            # %lpad23.i37
.Ltmp626:                               # EH_LABEL
	move	$s0, $s4
	move	$s3, $a0
	move	$s1, $zero
	b	.LBB16_972
.LBB16_1003:                            # %lpad21.i36
.Ltmp623:                               # EH_LABEL
	move	$s3, $a0
	move	$s1, $zero
	move	$s0, $s4
	b	.LBB16_974
.LBB16_1004:                            # %lpad16.i33
.Ltmp620:                               # EH_LABEL
	move	$s0, $s4
	move	$s3, $a0
	move	$s1, $zero
	b	.LBB16_974
.LBB16_1005:                            # %lpad14.i32
.Ltmp617:                               # EH_LABEL
	move	$s3, $a0
	move	$s1, $zero
	move	$s0, $s4
	b	.LBB16_976
.LBB16_1006:                            # %lpad9.i29
.Ltmp614:                               # EH_LABEL
	move	$s3, $a0
	move	$s1, $zero
	b	.LBB16_976
.LBB16_1007:                            # %lpad7.i28
.Ltmp611:                               # EH_LABEL
	b	.LBB16_1009
.LBB16_1008:                            # %lpad3.i22
.Ltmp608:                               # EH_LABEL
.LBB16_1009:                            # %ehcleanup182.i
	move	$s3, $a0
	move	$s1, $zero
	b	.LBB16_978
.LBB16_1010:                            # %lpad32.i
...
.LBB16_1034:                            # %ehcleanup53.i
	...
	bnez	$a0, .LBB16_1042
	.p2align	4, , 16
.LBB16_1035:                            # %arraydestroy.body56.i
                                        # =>This Inner Loop Header: Depth=1
	addi.d	$s0, $s0, -88
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_ZN8TestCaseD2Ev)
