...
# %bb.15:                               # %land.rhs.lr.ph.i71
	...
	slli.d	$a1, $a1, 50
	bltz	$a1, .LBB1_26
# %bb.16:                               # %land.rhs.lr.ph.i90.thread349
                                        #   in Loop: Header=BB1_8 Depth=1
	slli.d	$a1, $s4, 1
	ldx.hu	$a1, $a0, $a1
	slli.d	$a1, $a1, 50
...
# %bb.107:                              # %if.end67.i
	...
	movgr2cf	$fcc0, $a0
	bcnez	$fcc0, .LBB1_109
# %bb.108:                              # %lor.lhs.false70.i
                                        #   in Loop: Header=BB1_8 Depth=1
	fsub.d	$fa0, $fs2, $fs3
	fabs.d	$fa0, $fa0
	fcmp.cule.d	$fcc0, $fa0, $fs1
	bcnez	$fcc0, .LBB1_7
.LBB1_109:                              # %if.then73.i
                                        #   in Loop: Header=BB1_8 Depth=1
...
.LBB1_116:                              #   in Loop: Header=BB1_8 Depth=1
	...
	bnez	$s8, .LBB1_97
	b	.LBB1_5
.LBB1_117:                              # %if.then8.thread
	ld.d	$a0, $sp, 104                   # 8-byte Folded Reload
	beqz	$a0, .LBB1_120
.LBB1_118:                              # %skip_whitespace.exit
	bgeu	$s5, $s7, .LBB1_120
# %bb.119:                              # %land.rhs.lr.ph.i52
	pcaddu18i	$ra, %call36(__ctype_b_loc)
	jirl	$ra, $ra, 0
	ld.bu	$a1, $s5, 0
	ld.d	$a0, $a0, 0
...
.LBB1_129:
	move	$s1, $zero
	b	.LBB1_144
.LBB1_130:                              # %while.body.peel.i57
	addi.d	$s0, $s5, 1
	beq	$s0, $s7, .LBB1_135
# %bb.131:                              # %land.rhs.i60.preheader
