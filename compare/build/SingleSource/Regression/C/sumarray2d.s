...
# %bb.8:                                # %pred.store.if
	...
	addi.d	$t7, $t5, -7
	st.w	$t7, $t6, -16
.LBB1_9:                                # %pred.store.continue
                                        #   in Loop: Header=BB1_7 Depth=2
	vxor.v	$vr8, $vr7, $vr2
	vshuf4i.w	$vr8, $vr8, 8
	xvpermi.d	$xr9, $xr8, 78
	xvpickev.h	$xr8, $xr9, $xr8
	vpickve2gr.h	$t7, $vr8, 1
	andi	$t7, $t7, 1
	beqz	$t7, .LBB1_11
# %bb.10:                               # %pred.store.if30
                                        #   in Loop: Header=BB1_7 Depth=2
	addi.d	$t7, $t5, -6
	st.w	$t7, $t6, -12
.LBB1_11:                               # %pred.store.continue31
                                        #   in Loop: Header=BB1_7 Depth=2
	xvxor.v	$xr7, $xr7, $xr3
	xvpermi.q	$xr8, $xr7, 1
	...
	xvpermi.d	$xr9, $xr8, 78
	xvpickev.h	$xr8, $xr9, $xr8
	vpickve2gr.h	$t7, $vr8, 2
	andi	$t7, $t7, 1
	beqz	$t7, .LBB1_13
# %bb.12:                               # %pred.store.if32
                                        #   in Loop: Header=BB1_7 Depth=2
	addi.d	$t7, $t5, -5
	st.w	$t7, $t6, -8
.LBB1_13:                               # %pred.store.continue33
                                        #   in Loop: Header=BB1_7 Depth=2
	xvpermi.q	$xr7, $xr7, 1
	vshuf4i.w	$vr7, $vr7, 128
	xvpermi.d	$xr8, $xr7, 78
	xvpickev.h	$xr7, $xr8, $xr7
	vpickve2gr.h	$t7, $vr7, 3
	andi	$t7, $t7, 1
	beqz	$t7, .LBB1_15
# %bb.14:                               # %pred.store.if34
                                        #   in Loop: Header=BB1_7 Depth=2
	addi.d	$t7, $t5, -4
	st.w	$t7, $t6, -4
.LBB1_15:                               # %pred.store.continue35
                                        #   in Loop: Header=BB1_7 Depth=2
	xvseq.d	$xr8, $xr6, $xr4
	xvxor.v	$xr7, $xr8, $xr3
	xvpermi.d	$xr9, $xr7, 64
	xvpermi.d	$xr10, $xr9, 78
	xvpickev.h	$xr9, $xr10, $xr9
	vpickve2gr.h	$t7, $vr9, 4
	andi	$t7, $t7, 1
	beqz	$t7, .LBB1_17
# %bb.16:                               # %pred.store.if36
                                        #   in Loop: Header=BB1_7 Depth=2
	addi.d	$t7, $t5, -3
	stx.w	$t7, $a2, $t4
.LBB1_17:                               # %pred.store.continue37
                                        #   in Loop: Header=BB1_7 Depth=2
	vxor.v	$vr8, $vr8, $vr2
	vshuf4i.w	$vr8, $vr8, 8
	xvpermi.q	$xr8, $xr8, 2
	xvpermi.d	$xr9, $xr8, 78
	xvpickev.h	$xr8, $xr9, $xr8
	vpickve2gr.h	$t7, $vr8, 5
	andi	$t7, $t7, 1
	beqz	$t7, .LBB1_19
# %bb.18:                               # %pred.store.if38
                                        #   in Loop: Header=BB1_7 Depth=2
	addi.d	$t7, $t5, -2
	st.w	$t7, $t6, 4
.LBB1_19:                               # %pred.store.continue39
                                        #   in Loop: Header=BB1_7 Depth=2
	xvpermi.q	$xr8, $xr7, 1
	vshuf4i.w	$vr8, $vr8, 128
	xvpermi.q	$xr8, $xr8, 2
	xvpermi.d	$xr9, $xr8, 78
	xvpickev.h	$xr8, $xr9, $xr8
	vpickve2gr.h	$t7, $vr8, 6
	andi	$t7, $t7, 1
	beqz	$t7, .LBB1_21
# %bb.20:                               # %pred.store.if40
                                        #   in Loop: Header=BB1_7 Depth=2
	addi.d	$t7, $t5, -1
	st.w	$t7, $t6, 8
.LBB1_21:                               # %pred.store.continue41
                                        #   in Loop: Header=BB1_7 Depth=2
	xvpermi.q	$xr7, $xr7, 1
	vshuf4i.w	$vr7, $vr7, 128
	xvpermi.q	$xr7, $xr7, 2
	xvpermi.d	$xr8, $xr7, 78
	xvpickev.h	$xr7, $xr8, $xr7
	vpickve2gr.h	$t7, $vr7, 7
	andi	$t7, $t7, 1
	beqz	$t7, .LBB1_6
# %bb.22:                               # %pred.store.if42
                                        #   in Loop: Header=BB1_7 Depth=2
	st.w	$t5, $t6, 12
	b	.LBB1_6
	.p2align	4, , 16
