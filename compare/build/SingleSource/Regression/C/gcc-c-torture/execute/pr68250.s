...
# %bb.6:                                #   in Loop: Header=BB2_4 Depth=1
	...
	b	.LBB2_17
	.p2align	4, , 16
.LBB2_7:                                # %vector.main.loop.iter.check120
                                        #   in Loop: Header=BB2_4 Depth=1
	bgeu	$t3, $s0, .LBB2_9
...
.LBB2_9:                                # %vector.ph121
	...
	move	$s3, $s5
	.p2align	4, , 16
.LBB2_10:                               # %vector.body126
                                        #   Parent Loop BB2_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.w	$s3, $s3, -64
	bnez	$s3, .LBB2_10
# %bb.11:                               # %middle.block131
                                        #   in Loop: Header=BB2_4 Depth=1
	or	$s3, $t7, $t4
	sltu	$s3, $zero, $s3
	beq	$s5, $t3, .LBB2_18
# %bb.12:                               # %vec.epilog.iter.check139
                                        #   in Loop: Header=BB2_4 Depth=1
	andi	$s6, $t3, 56
	beqz	$s6, .LBB2_16
.LBB2_13:                               # %vec.epilog.ph138
                                        #   in Loop: Header=BB2_4 Depth=1
	xor	$s3, $s3, $s4
	move	$s4, $t3
	...
	sub.d	$s5, $s5, $s4
	.p2align	4, , 16
.LBB2_14:                               # %vec.epilog.vector.body148
                                        #   Parent Loop BB2_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.w	$s5, $s5, 8
	bnez	$s5, .LBB2_14
# %bb.15:                               # %vec.epilog.middle.block152
                                        #   in Loop: Header=BB2_4 Depth=1
	sltu	$t4, $zero, $t4
	or	$s3, $s3, $t8
	or	$s3, $s3, $t4
...
# %bb.28:                               #   in Loop: Header=BB2_26 Depth=1
	...
	b	.LBB2_39
	.p2align	4, , 16
.LBB2_29:                               # %vector.main.loop.iter.check78
                                        #   in Loop: Header=BB2_26 Depth=1
	bgeu	$t3, $s0, .LBB2_31
...
.LBB2_31:                               # %vector.ph79
	...
	move	$s3, $s5
	.p2align	4, , 16
.LBB2_32:                               # %vector.body84
                                        #   Parent Loop BB2_26 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.w	$s3, $s3, -64
	bnez	$s3, .LBB2_32
# %bb.33:                               # %middle.block89
                                        #   in Loop: Header=BB2_26 Depth=1
	or	$s3, $t7, $t4
	sltu	$s3, $zero, $s3
	beq	$s5, $t3, .LBB2_40
# %bb.34:                               # %vec.epilog.iter.check97
                                        #   in Loop: Header=BB2_26 Depth=1
	andi	$s6, $t3, 56
	beqz	$s6, .LBB2_38
.LBB2_35:                               # %vec.epilog.ph96
                                        #   in Loop: Header=BB2_26 Depth=1
	xor	$s3, $s3, $s4
	move	$s4, $t3
	bstrins.d	$s4, $zero, 2, 0
	...
	sub.d	$s5, $s5, $s4
	.p2align	4, , 16
.LBB2_36:                               # %vec.epilog.vector.body106
                                        #   Parent Loop BB2_26 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.w	$s5, $s5, 8
	bnez	$s5, .LBB2_36
# %bb.37:                               # %vec.epilog.middle.block110
                                        #   in Loop: Header=BB2_26 Depth=1
	sltu	$t4, $zero, $t4
	or	$s3, $s3, $t8
	or	$s3, $s3, $t4
