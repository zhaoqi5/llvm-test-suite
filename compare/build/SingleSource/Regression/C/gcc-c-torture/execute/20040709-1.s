...
# %bb.0:                                # %if.end144
	...
	pcalau12i	$a3, %pc_hi20(sE)
	addi.d	$a3, $a3, %pc_lo12(sE)
	vst	$vr0, $a3, 0
	ld.d	$a4, $a3, 8
	lu12i.w	$a5, -83436
	ori	$a5, $a5, 2109
...
# %bb.0:                                # %if.end138
	...
	vpickev.h	$vr1, $vr2, $vr3
	vpickev.b	$vr0, $vr1, $vr0
	pcalau12i	$a3, %pc_hi20(sF)
	vst	$vr0, $a3, %pc_lo12(sF)
	ld.d	$a4, $a3, %pc_lo12(sF)
	lu12i.w	$a5, -83436
	ori	$a5, $a5, 2109
	mul.d	$a5, $s0, $a5
	lu12i.w	$a6, 55977
...
# %bb.0:                                # %entry
	...
	vpickev.h	$vr1, $vr2, $vr3
	vpickev.b	$vr0, $vr1, $vr0
	pcalau12i	$a3, %pc_hi20(sG)
	vst	$vr0, $a3, %pc_lo12(sG)
	ld.wu	$a4, $a3, %pc_lo12(sG)
	mul.d	$a5, $s0, $a1
	add.d	$a6, $a5, $a2
	mul.d	$a5, $a6, $a1
	add.w	$a5, $a5, $a2
	...
	ori	$a6, $zero, 1
	st.w	$a7, $a3, %pc_lo12(sG)
	beqz	$a6, .LBB42_3
# %bb.1:                                # %if.end78
	bstrpick.d	$a4, $a4, 24, 0
	lu12i.w	$a6, -522277
	ori	$a6, $a6, 3253
	mul.d	$a5, $a5, $a6
	lu12i.w	$a6, -364478
...
# %bb.0:                                # %entry
	...
	vpickev.h	$vr1, $vr2, $vr3
	vpickev.b	$vr0, $vr1, $vr0
	pcalau12i	$a3, %pc_hi20(sH)
	vst	$vr0, $a3, %pc_lo12(sH)
	ld.wu	$a4, $a3, %pc_lo12(sH)
	mul.d	$a5, $s0, $a1
	add.d	$a6, $a5, $a2
	mul.d	$a5, $a6, $a1
	add.w	$a5, $a5, $a2
	...
	ori	$a6, $zero, 1
	st.w	$a7, $a3, %pc_lo12(sH)
	beqz	$a6, .LBB48_3
# %bb.1:                                # %if.end78
	bstrpick.d	$a4, $a4, 22, 0
	lu12i.w	$a6, -522277
	ori	$a6, $a6, 3253
	mul.d	$a5, $a5, $a6
	lu12i.w	$a6, -364478
...
# %bb.0:                                # %entry
	...
	vst	$vr0, $a3, %pc_lo12(sI)
	ld.hu	$a4, $a3, %pc_lo12(sI)
	mul.d	$a5, $s0, $a1
	add.d	$a5, $a5, $a2
	bstrpick.d	$a6, $a5, 31, 16
	move	$a7, $a4
	bstrins.d	$a7, $a6, 63, 7
	st.h	$a7, $a3, %pc_lo12(sI)
	ld.w	$a7, $a3, %pc_lo12(sI)
	mul.d	$a5, $a5, $a1
	add.w	$a5, $a5, $a2
...
# %bb.0:                                # %entry
	...
	vpickev.h	$vr1, $vr2, $vr3
	vpickev.b	$vr0, $vr1, $vr0
	pcalau12i	$a3, %pc_hi20(sQ)
	vst	$vr0, $a3, %pc_lo12(sQ)
	ld.w	$a4, $a3, %pc_lo12(sQ)
	ori	$a7, $a4, 4095
	mul.d	$a5, $s0, $a1
	add.d	$a6, $a5, $a2
	srli.d	$t0, $a6, 16
	...
	st.w	$t0, $a3, %pc_lo12(sQ)
	bnez	$t1, .LBB102_4
# %bb.1:                                # %lor.lhs.false
	bstrpick.d	$a7, $a7, 31, 12
	bnez	$a7, .LBB102_4
# %bb.2:                                # %lor.lhs.false
	ld.w	$a7, $a3, %pc_lo12(sQ)
...
# %bb.0:                                # %entry
	...
	vpickev.h	$vr1, $vr2, $vr3
	vpickev.b	$vr0, $vr1, $vr0
	pcalau12i	$a3, %pc_hi20(sR)
	vst	$vr0, $a3, %pc_lo12(sR)
	ld.w	$a4, $a3, %pc_lo12(sR)
	ori	$a7, $a4, 4095
	mul.d	$a5, $s0, $a1
	add.d	$a6, $a5, $a2
	srli.d	$t0, $a6, 16
	...
	st.w	$t0, $a3, %pc_lo12(sR)
	bnez	$t1, .LBB108_4
# %bb.1:                                # %lor.lhs.false
	bstrpick.d	$a7, $a7, 31, 12
	bnez	$a7, .LBB108_4
# %bb.2:                                # %lor.lhs.false
	ld.w	$a7, $a3, %pc_lo12(sR)
	bstrpick.d	$a6, $a6, 26, 16
	bstrpick.d	$t0, $a5, 26, 16
	add.d	$a7, $t0, $a7
	andi	$a7, $a7, 4095
...
# %bb.0:                                # %entry
	...
	vst	$vr0, $a3, %pc_lo12(sS)
	ld.h	$a4, $a3, %pc_lo12(sS)
	mul.d	$a5, $s0, $a1
	add.d	$a5, $a5, $a2
	bstrpick.d	$a6, $a5, 31, 16
	mul.d	$a5, $a5, $a1
	...
	st.h	$t0, $a3, %pc_lo12(sS)
	ld.w	$a7, $a3, %pc_lo12(sS)
	add.w	$a5, $a5, $a2
	bstrpick.d	$t0, $a5, 31, 16
	add.d	$a6, $t0, $a6
	add.d	$a7, $t0, $a7
...
# %bb.0:                                # %entry
	...
	vpickev.h	$vr1, $vr2, $vr3
	vpickev.b	$vr0, $vr1, $vr0
	pcalau12i	$a3, %pc_hi20(sU)
	vst	$vr0, $a3, %pc_lo12(sU)
	ld.h	$a4, $a3, %pc_lo12(sU)
	mul.d	$a5, $s0, $a1
	add.d	$a5, $a5, $a2
	srli.d	$a6, $a5, 16
	...
	move	$t0, $a4
	bstrins.d	$t0, $a7, 6, 6
	st.h	$t0, $a3, %pc_lo12(sU)
	ld.w	$a7, $a3, %pc_lo12(sU)
	mul.d	$a5, $a5, $a1
	add.w	$a5, $a5, $a2
	bstrpick.d	$t0, $a5, 31, 16
	srli.d	$a7, $a7, 6
...
# %bb.0:                                # %if.end115
	...
	vpickev.h	$vr1, $vr2, $vr3
	vpickev.b	$vr0, $vr1, $vr0
	pcalau12i	$a3, %pc_hi20(sX)
	addi.d	$a3, $a3, %pc_lo12(sX)
	vst	$vr0, $a3, 0
	st.d	$zero, $a3, 16
	ori	$a4, $zero, 0
	lu32i.d	$a4, 86016
...
# %bb.0:                                # %if.end115
	...
	vpickev.h	$vr1, $vr2, $vr3
	vpickev.b	$vr0, $vr1, $vr0
	pcalau12i	$a3, %pc_hi20(sY)
	addi.d	$a3, $a3, %pc_lo12(sY)
	vst	$vr0, $a3, 0
	st.d	$zero, $a3, 16
	ori	$a4, $zero, 0
	lu32i.d	$a4, 86016
