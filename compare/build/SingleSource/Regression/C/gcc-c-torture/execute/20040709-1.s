...
# %bb.0:                                # %entry
	...
	ld.d	$a5, $a3, %pc_lo12(sP)
	ori	$t0, $a5, 4095
	mul.d	$a4, $a4, $a1
	add.d	$a4, $a4, $a2
	bstrpick.d	$a7, $a4, 26, 16
	mul.d	$a4, $a4, $a1
	add.w	$a4, $a4, $a2
	st.w	$a4, $a0, %pc_lo12(myrnd.s)
	move	$a6, $a5
	bstrins.d	$a6, $a7, 11, 0
	xor	$t0, $a6, $t0
	srli.d	$t1, $t0, 35
