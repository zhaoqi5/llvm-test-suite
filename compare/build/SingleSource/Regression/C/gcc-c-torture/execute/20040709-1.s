...
# %bb.0:                                # %entry
	pcalau12i	$a1, %pc_hi20(sA)
	ld.w	$a2, $a1, %pc_lo12(sA)
	slli.d	$a0, $a0, 17
	add.d	$a2, $a2, $a0
	bstrpick.d	$a0, $a2, 31, 17
	st.w	$a2, $a1, %pc_lo12(sA)
	ret
.Lfunc_end5:
...
# %bb.0:                                # %if.end89
	...
	add.d	$a0, $a0, $a3
	srli.d	$a4, $a0, 16
	pcalau12i	$a5, %pc_hi20(sA)
	addi.d	$a5, $a5, %pc_lo12(sA)
	st.b	$a4, $a5, 0
	mul.d	$a0, $a0, $a2
	add.d	$a0, $a0, $a3
	srli.d	$a4, $a0, 16
	...
	st.w	$a2, $a5, 0
	bnez	$a4, .LBB6_4
# %bb.1:                                # %lor.lhs.false118
	andi	$a3, $a3, 64
	bnez	$a3, .LBB6_4
# %bb.2:                                # %lor.lhs.false118
...
# %bb.0:                                # %entry
	pcalau12i	$a1, %pc_hi20(sB)
	ld.w	$a2, $a1, %pc_lo12(sB)
	slli.d	$a0, $a0, 17
	add.d	$a2, $a2, $a0
	bstrpick.d	$a0, $a2, 31, 17
	st.w	$a2, $a1, %pc_lo12(sB)
	ret
.Lfunc_end11:
...
# %bb.0:                                # %if.end78
	...
	add.d	$a2, $a2, $a6
	addi.w	$a6, $a2, 0
	bstrpick.d	$a2, $a2, 26, 16
	move	$a7, $a5
	bstrins.d	$a7, $a2, 63, 17
	lu12i.w	$a2, -251351
	ori	$a2, $a2, 2665
	mul.d	$a2, $a6, $a2
	lu12i.w	$a6, -180799
	...
	mul.d	$a3, $a6, $a3
	add.d	$a3, $a3, $a4
	st.w	$a3, $a0, %pc_lo12(myrnd.s)
	bstrpick.d	$a0, $a3, 26, 16
	bstrins.d	$a5, $a2, 63, 17
	slli.d	$a3, $a0, 17
	add.d	$a3, $a5, $a3
	xor	$a4, $a3, $a7
	andi	$a5, $a4, 63
	st.w	$a3, $a1, 0
	bnez	$a5, .LBB12_4
# %bb.1:                                # %lor.lhs.false93
	bstrpick.d	$a1, $a4, 16, 6
	slli.d	$a1, $a1, 6
	bnez	$a1, .LBB12_4
# %bb.2:                                # %lor.lhs.false93
	bstrpick.d	$a1, $a3, 31, 17
	add.w	$a0, $a0, $a2
	addi.w	$a1, $a1, 0
	bne	$a0, $a1, .LBB12_4
# %bb.3:                                # %if.end117
...
# %bb.0:                                # %entry
	pcalau12i	$a1, %pc_hi20(sC+4)
	ld.w	$a2, $a1, %pc_lo12(sC+4)
	slli.d	$a0, $a0, 17
	add.d	$a2, $a2, $a0
	bstrpick.d	$a0, $a2, 31, 17
	st.w	$a2, $a1, %pc_lo12(sC+4)
	ret
.Lfunc_end17:
...
# %bb.0:                                # %entry
	pcalau12i	$a1, %pc_hi20(sG)
	ld.w	$a2, $a1, %pc_lo12(sG)
	slli.d	$a0, $a0, 25
	add.d	$a2, $a2, $a0
	bstrpick.d	$a0, $a2, 31, 25
	st.w	$a2, $a1, %pc_lo12(sG)
	ret
.Lfunc_end41:
...
# %bb.0:                                # %entry
	...
	xvpermi.d	$xr0, $xr2, 78
	xvpickev.b	$xr0, $xr0, $xr2
	pcalau12i	$a4, %pc_hi20(sG)
	vst	$vr0, $a4, %pc_lo12(sG)
	ld.wu	$a5, $a4, %pc_lo12(sG)
	mul.d	$a3, $a3, $a1
	add.d	$a6, $a3, $a2
	mul.d	$a3, $a6, $a1
	add.w	$a3, $a3, $a2
	st.w	$a3, $a0, %pc_lo12(myrnd.s)
	bstrpick.d	$a6, $a6, 22, 16
	move	$a7, $a5
	bstrins.d	$a7, $a6, 63, 25
	ori	$a6, $zero, 1
	st.w	$a7, $a4, %pc_lo12(sG)
	beqz	$a6, .LBB42_3
# %bb.1:                                # %if.end78
	bstrpick.d	$a5, $a5, 24, 0
	lu12i.w	$a6, -522277
	ori	$a6, $a6, 3253
	mul.d	$a3, $a3, $a6
	lu12i.w	$a6, -364478
	ori	$a6, $a6, 2015
	add.d	$a3, $a3, $a6
	bstrpick.d	$a6, $a3, 31, 16
	mul.d	$a1, $a3, $a1
	add.d	$a1, $a1, $a2
	st.w	$a1, $a0, %pc_lo12(myrnd.s)
	bstrpick.d	$a0, $a1, 31, 16
	slli.d	$a1, $a6, 25
	or	$a1, $a1, $a5
	slli.d	$a2, $a0, 25
	add.d	$a1, $a1, $a2
...
# %bb.0:                                # %entry
	pcalau12i	$a1, %pc_hi20(sH)
	ld.w	$a2, $a1, %pc_lo12(sH)
	slli.d	$a0, $a0, 23
	add.d	$a2, $a2, $a0
	bstrpick.d	$a0, $a2, 31, 23
	st.w	$a2, $a1, %pc_lo12(sH)
	ret
.Lfunc_end47:
...
# %bb.0:                                # %entry
	...
	xvpermi.d	$xr0, $xr2, 78
	xvpickev.b	$xr0, $xr0, $xr2
	pcalau12i	$a4, %pc_hi20(sH)
	vst	$vr0, $a4, %pc_lo12(sH)
	ld.wu	$a5, $a4, %pc_lo12(sH)
	mul.d	$a3, $a3, $a1
	add.d	$a6, $a3, $a2
	mul.d	$a3, $a6, $a1
	add.w	$a3, $a3, $a2
	st.w	$a3, $a0, %pc_lo12(myrnd.s)
	bstrpick.d	$a6, $a6, 24, 16
	move	$a7, $a5
	bstrins.d	$a7, $a6, 63, 23
	ori	$a6, $zero, 1
	st.w	$a7, $a4, %pc_lo12(sH)
	beqz	$a6, .LBB48_3
# %bb.1:                                # %if.end78
	bstrpick.d	$a5, $a5, 22, 0
	lu12i.w	$a6, -522277
	ori	$a6, $a6, 3253
	mul.d	$a3, $a3, $a6
	lu12i.w	$a6, -364478
	...
	slli.d	$a2, $a0, 23
	add.d	$a1, $a1, $a2
	bstrpick.d	$a2, $a1, 31, 23
	add.d	$a0, $a0, $a6
	andi	$a0, $a0, 511
	st.w	$a1, $a4, %pc_lo12(sH)
	bne	$a0, $a2, .LBB48_3
# %bb.2:                                # %if.end117
	ld.d	$s0, $sp, 0                     # 8-byte Folded Reload
	ld.d	$fp, $sp, 8                     # 8-byte Folded Reload
...
# %bb.0:                                # %entry
	pcalau12i	$a1, %pc_hi20(sI)
	ld.h	$a2, $a1, %pc_lo12(sI)
	slli.d	$a0, $a0, 7
	add.d	$a2, $a2, $a0
	bstrpick.d	$a0, $a2, 15, 7
	st.h	$a2, $a1, %pc_lo12(sI)
	ret
.Lfunc_end53:
...
# %bb.0:                                # %entry
	...
	xvpermi.d	$xr0, $xr2, 78
	xvpickev.b	$xr0, $xr0, $xr2
	pcalau12i	$a4, %pc_hi20(sI)
	vst	$vr0, $a4, %pc_lo12(sI)
	ld.hu	$a5, $a4, %pc_lo12(sI)
	mul.d	$a3, $a3, $a1
	add.d	$a3, $a3, $a2
	bstrpick.d	$a7, $a3, 31, 16
	move	$a6, $a5
	bstrins.d	$a6, $a7, 63, 7
	st.h	$a6, $a4, %pc_lo12(sI)
	ld.w	$t0, $a4, %pc_lo12(sI)
	mul.d	$a3, $a3, $a1
	add.w	$a6, $a3, $a2
	bstrpick.d	$a3, $a6, 31, 16
	srli.d	$t0, $t0, 7
	add.d	$t0, $t0, $a3
	add.d	$a3, $a3, $a7
	xor	$a3, $a3, $t0
	andi	$a3, $a3, 511
	st.w	$a6, $a0, %pc_lo12(myrnd.s)
	bnez	$a3, .LBB54_4
# %bb.1:                                # %if.end
	andi	$a3, $a5, 127
	mul.d	$a5, $a6, $a1
...
# %bb.0:                                # %entry
	...
	xvpermi.d	$xr0, $xr2, 78
	xvpickev.b	$xr0, $xr0, $xr2
	pcalau12i	$a4, %pc_hi20(sO)
	addi.d	$a4, $a4, %pc_lo12(sO)
	vst	$vr0, $a4, 0
	ld.d	$a5, $a4, 8
	ori	$t0, $a5, 4095
	mul.d	$a3, $a3, $a1
	add.d	$a3, $a3, $a2
	bstrpick.d	$a7, $a3, 26, 16
	mul.d	$a3, $a3, $a1
	add.w	$a3, $a3, $a2
	st.w	$a3, $a0, %pc_lo12(myrnd.s)
	move	$a6, $a5
...
# %bb.2:                                # %lor.lhs.false
	...
	bne	$a7, $t0, .LBB90_9
# %bb.3:                                # %lor.lhs.false
	bstrpick.d	$t0, $a3, 26, 16
	add.d	$t1, $t0, $a6
	andi	$t1, $t1, 4095
	add.w	$a7, $t0, $a7
	bne	$a7, $t1, .LBB90_9
# %bb.4:                                # %if.end
	bstrins.d	$a5, $zero, 11, 0
	mul.d	$a3, $a3, $a1
	add.d	$a3, $a3, $a2
	addi.w	$t0, $a3, 0
	bstrpick.d	$a7, $a3, 26, 16
...
# %bb.0:                                # %entry
	...
	xvpermi.d	$xr0, $xr2, 78
	xvpickev.b	$xr0, $xr0, $xr2
	pcalau12i	$a4, %pc_hi20(sP)
	vst	$vr0, $a4, %pc_lo12(sP)
	ld.d	$a5, $a4, %pc_lo12(sP)
	ori	$t0, $a5, 4095
	mul.d	$a3, $a3, $a1
	add.d	$a3, $a3, $a2
	bstrpick.d	$a7, $a3, 26, 16
...
# %bb.0:                                # %entry
	pcalau12i	$a1, %pc_hi20(sQ)
	ld.wu	$a2, $a1, %pc_lo12(sQ)
	add.d	$a3, $a2, $a0
	andi	$a0, $a3, 4095
	srli.d	$a2, $a2, 12
	bstrins.d	$a3, $a2, 63, 12
	st.w	$a3, $a1, %pc_lo12(sQ)
	ret
.Lfunc_end101:
...
# %bb.0:                                # %entry
	...
	xvpermi.d	$xr0, $xr2, 78
	xvpickev.b	$xr0, $xr0, $xr2
	pcalau12i	$a4, %pc_hi20(sQ)
	vst	$vr0, $a4, %pc_lo12(sQ)
	ld.w	$a5, $a4, %pc_lo12(sQ)
	ori	$a7, $a5, 4095
	mul.d	$a3, $a3, $a1
	add.d	$a6, $a3, $a2
	srli.d	$t0, $a6, 16
	...
	bstrins.d	$a5, $zero, 11, 0
	srli.d	$t1, $a5, 11
	bstrins.d	$t0, $t1, 63, 11
	xor	$a7, $t0, $a7
	bstrpick.d	$t1, $a7, 31, 25
	st.w	$t0, $a4, %pc_lo12(sQ)
	bnez	$t1, .LBB102_4
# %bb.1:                                # %lor.lhs.false
	bstrpick.d	$a7, $a7, 31, 12
	bnez	$a7, .LBB102_4
# %bb.2:                                # %lor.lhs.false
	ld.w	$a7, $a4, %pc_lo12(sQ)
	bstrpick.d	$a6, $a6, 26, 16
	bstrpick.d	$t0, $a3, 26, 16
	add.d	$a7, $t0, $a7
	andi	$a7, $a7, 4095
	add.w	$a6, $t0, $a6
...
# %bb.0:                                # %entry
	pcalau12i	$a1, %pc_hi20(sR)
	ld.wu	$a2, $a1, %pc_lo12(sR)
	add.d	$a3, $a2, $a0
	andi	$a0, $a3, 4095
	srli.d	$a2, $a2, 12
	bstrins.d	$a3, $a2, 63, 12
	st.w	$a3, $a1, %pc_lo12(sR)
	ret
.Lfunc_end107:
...
# %bb.0:                                # %entry
	...
	xvpermi.d	$xr0, $xr2, 78
	xvpickev.b	$xr0, $xr0, $xr2
	pcalau12i	$a4, %pc_hi20(sR)
	vst	$vr0, $a4, %pc_lo12(sR)
	ld.w	$a5, $a4, %pc_lo12(sR)
	ori	$a7, $a5, 4095
	mul.d	$a3, $a3, $a1
	add.d	$a6, $a3, $a2
	srli.d	$t0, $a6, 16
	...
	bstrins.d	$t0, $t1, 63, 11
	xor	$a7, $t0, $a7
	bstrpick.d	$t1, $a7, 31, 23
	st.w	$t0, $a4, %pc_lo12(sR)
	bnez	$t1, .LBB108_4
# %bb.1:                                # %lor.lhs.false
	bstrpick.d	$a7, $a7, 31, 12
	bnez	$a7, .LBB108_4
# %bb.2:                                # %lor.lhs.false
	ld.w	$a7, $a4, %pc_lo12(sR)
	bstrpick.d	$a6, $a6, 26, 16
	bstrpick.d	$t0, $a3, 26, 16
	add.d	$a7, $t0, $a7
	andi	$a7, $a7, 4095
...
# %bb.0:                                # %entry
	...
	xvpermi.d	$xr0, $xr2, 78
	xvpickev.b	$xr0, $xr0, $xr2
	pcalau12i	$a4, %pc_hi20(sS)
	vst	$vr0, $a4, %pc_lo12(sS)
	ld.h	$a5, $a4, %pc_lo12(sS)
	mul.d	$a3, $a3, $a1
	add.d	$a3, $a3, $a2
	bstrpick.d	$a6, $a3, 31, 16
	mul.d	$a3, $a3, $a1
	...
	st.h	$t0, $a4, %pc_lo12(sS)
	ld.w	$a7, $a4, %pc_lo12(sS)
	add.w	$a3, $a3, $a2
...
# %bb.0:                                # %entry
	...
	xvpermi.d	$xr0, $xr2, 78
	xvpickev.b	$xr0, $xr0, $xr2
	pcalau12i	$a4, %pc_hi20(sU)
	vst	$vr0, $a4, %pc_lo12(sU)
	ld.h	$a5, $a4, %pc_lo12(sU)
	mul.d	$a3, $a3, $a1
	add.d	$a3, $a3, $a2
	srli.d	$a6, $a3, 16
	bstrpick.d	$a7, $a3, 16, 16
	move	$t0, $a5
	bstrins.d	$t0, $a7, 6, 6
	st.h	$t0, $a4, %pc_lo12(sU)
	ld.w	$a7, $a4, %pc_lo12(sU)
	mul.d	$a3, $a3, $a1
	add.w	$a3, $a3, $a2
	bstrpick.d	$t0, $a3, 31, 16
	srli.d	$a7, $a7, 6
...
# %bb.0:                                # %if.end121
	...
	add.d	$a4, $a1, $a3
	srli.d	$a5, $a4, 16
	pcalau12i	$a1, %pc_hi20(sW)
	addi.d	$a1, $a1, %pc_lo12(sW)
	st.b	$a5, $a1, 0
	mul.d	$a4, $a4, $a2
	add.d	$a4, $a4, $a3
	srli.d	$a5, $a4, 16
...
# %bb.0:                                # %if.end115
	...
	xvpermi.d	$xr0, $xr2, 78
	xvpickev.b	$xr0, $xr0, $xr2
	pcalau12i	$a4, %pc_hi20(sX)
	addi.d	$a4, $a4, %pc_lo12(sX)
	vst	$vr0, $a4, 0
	st.d	$zero, $a4, 16
	ori	$a5, $zero, 0
	lu32i.d	$a5, 86016
...
# %bb.0:                                # %if.end115
	...
	xvpermi.d	$xr0, $xr2, 78
	xvpickev.b	$xr0, $xr0, $xr2
	pcalau12i	$a4, %pc_hi20(sY)
	addi.d	$a4, $a4, %pc_lo12(sY)
	vst	$vr0, $a4, 0
	st.d	$zero, $a4, 16
	ori	$a5, $zero, 0
	lu32i.d	$a5, 86016
...
# %bb.0:                                # %if.end82
	...
	add.d	$a4, $a0, $a3
	srli.d	$a5, $a4, 16
	pcalau12i	$a0, %pc_hi20(sZ)
	addi.d	$a0, $a0, %pc_lo12(sZ)
	st.b	$a5, $a0, 0
	mul.d	$a4, $a4, $a2
	add.d	$a4, $a4, $a3
	srli.d	$a5, $a4, 16
