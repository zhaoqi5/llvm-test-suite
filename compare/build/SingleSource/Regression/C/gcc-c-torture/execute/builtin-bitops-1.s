...
.LBB18_25:                              # %vector.body
	...
	xvseq.d	$xr0, $xr0, $xr1
	xvxor.v	$xr0, $xr0, $xr10
	xvpermi.q	$xr7, $xr0, 1
	vpickev.w	$vr7, $vr7, $vr0
	xvpermi.q	$xr6, $xr7, 2
...
.LBB18_57:                              # %vector.body1184
	...
	addi.d	$a2, $a1, 8
	bnez	$a3, .LBB18_59
# %bb.58:                               # %vector.body1184
                                        #   in Loop: Header=BB18_57 Depth=2
	xvaddi.du	$xr3, $xr3, 8
	xvaddi.du	$xr5, $xr5, 8
	bne	$a1, $s5, .LBB18_57
.LBB18_59:                              # %middle.split1189
                                        #   in Loop: Header=BB18_42 Depth=1
	beqz	$a3, .LBB18_61
# %bb.60:                               # %vector.early.exit1191
                                        #   in Loop: Header=BB18_42 Depth=1
	xvpickve2gr.d	$a1, $xr4, 0
	vinsgr2vr.b	$vr1, $a1, 0
	xvpickve2gr.d	$a1, $xr4, 1
