...
.LBB0_23:
	...
	addi.d	$sp, $sp, 16
	ret
.LBB0_24:                               # %if.then49.i34
	st.d	$a6, $sp, 8
	st.d	$t0, $sp, 0
	addi.d	$a0, $sp, 8
	addi.d	$a1, $sp, 0
	.p2align	4, , 16
.LBB0_25:                               # %do.body.i68.i
                                        # =>This Inner Loop Header: Depth=1
	ld.bu	$a2, $a0, 0
	ld.bu	$a3, $a1, 0
	addi.d	$a0, $a0, 1
