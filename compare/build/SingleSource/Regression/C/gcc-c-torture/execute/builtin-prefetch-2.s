...
# %bb.0:                                # %entry
	pcalau12i	$a0, %pc_hi20(glob_ptr_int)
	ld.d	$a0, $a0, %pc_lo12(glob_ptr_int)
	pcalau12i	$a1, %pc_hi20(glob_int_arr)
	addi.d	$a1, $a1, %pc_lo12(glob_int_arr)
	preld	0, $a1, 0
	preld	0, $a0, 0
...
# %bb.0:                                # %entry
	pcalau12i	$a0, %pc_hi20(ptr_str)
	ld.d	$a0, $a0, %pc_lo12(ptr_str)
	pcalau12i	$a1, %pc_hi20(str)
	addi.d	$a1, $a1, %pc_lo12(str)
	preld	0, $a1, 0
	preld	0, $a0, 0
	preld	0, $a1, 4
	preld	0, $a0, 4
