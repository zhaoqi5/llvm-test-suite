...
.LBB3_2:                                # %if.end12.us236.us
	...
	addi.d	$a3, $a3, -95
	blt	$t7, $a5, .LBB3_15
# %bb.3:                                # %if.end44.us.lr.ph.us.us
                                        #   in Loop: Header=BB3_2 Depth=1
	beqz	$s3, .LBB3_9
	.p2align	4, , 16
.LBB3_4:                                # %bi.us.us248.us
...
.LBB3_6:                                # %if.end140.us.us272.us
	...
	addi.w	$t3, $t3, 1
	blt	$t7, $a5, .LBB3_11
# %bb.7:                                # %if.end44.us.us246.us
                                        #   in Loop: Header=BB3_4 Depth=2
	bnez	$s3, .LBB3_4
# %bb.8:                                # %if.end44.us.us246.if.end51.split.us.split.us280_crit_edge.us
                                        #   in Loop: Header=BB3_2 Depth=1
	st.w	$t3, $t1, %pc_lo12(f)
.LBB3_9:                                # %if.end51.split.us.split.us280.us
                                        #   in Loop: Header=BB3_2 Depth=1
...
# %bb.10:                               # %cleanup176.split.us.us
	...
	move	$s3, $s2
	b	.LBB3_2
.LBB3_11:                               # %if.then30.us.cleanup181.split.us.split_crit_edge.split.us
	pcalau12i	$t4, %pc_hi20(an)
	ori	$t5, $zero, 5
	st.w	$t5, $t4, %pc_lo12(an)
	st.w	$t3, $t1, %pc_lo12(f)
.LBB3_12:                               # %cleanup181
	st.b	$a4, $a7, %pc_lo12(c)
	st.d	$t2, $t0, %pc_lo12(ss)
...
.LBB3_14:                               # %for.cond99
	...
	b	.LBB3_14
.LBB3_15:                               # %if.then30.lr.ph.split.us.split.cleanup181.split.us.split_crit_edge.split.us
