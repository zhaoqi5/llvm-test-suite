...
# %bb.0:                                # %entry
	...
	xvld	$xr3, $a3, %pc_lo12(.LCPI1_4)
	xvst	$xr0, $a2, 32
	vst	$vr1, $a2, 64
	xvst	$xr2, $a1, 0
	xvst	$xr3, $a1, 32
	pcalau12i	$a2, %pc_hi20(.LCPI1_5)
	xvld	$xr0, $a2, %pc_lo12(.LCPI1_5)
	addi.d	$a2, $a1, 32
	st.d	$a2, $a0, 64
	addi.d	$a2, $a1, 36
	xvst	$xr0, $a1, 64
	pcalau12i	$a3, %pc_hi20(.LCPI1_6)
	xvld	$xr0, $a3, %pc_lo12(.LCPI1_6)
	st.d	$a2, $a0, 72
	addi.d	$a2, $a1, 40
	st.d	$a2, $a0, 80
	xvst	$xr0, $a1, 96
	...
	addi.d	$a2, $a1, 60
	xvst	$xr0, $a1, 192
	pcalau12i	$a3, %pc_hi20(.LCPI1_10)
	xvld	$xr0, $a3, %pc_lo12(.LCPI1_10)
	st.d	$a2, $a0, 120
	addi.d	$a2, $a1, 64
	st.d	$a2, $a0, 128
	xvst	$xr0, $a1, 224
	...
	addi.d	$a2, $a1, 72
	xvst	$xr0, $a1, 256
	pcalau12i	$a3, %pc_hi20(.LCPI1_12)
	xvld	$xr0, $a3, %pc_lo12(.LCPI1_12)
	st.d	$a2, $a0, 144
	addi.d	$a2, $a1, 76
	st.d	$a2, $a0, 152
	xvst	$xr0, $a1, 288
	...
	xvld	$xr3, $a2, %pc_lo12(.LCPI1_14)
	vinsgr2vr.h	$vr0, $a1, 6
	vpickve2gr.h	$a1, $vr1, 6
	vinsgr2vr.h	$vr0, $a1, 7
	xvfcmp.cune.s	$xr1, $xr2, $xr3
	vpickve2gr.h	$a1, $vr1, 0
