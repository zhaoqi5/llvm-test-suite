...
.LBB0_2:                                # %for.cond
	...
	b	.LBB0_2
.LBB0_3:                                # %for.cond.us.preheader
	pcalau12i	$a0, %pc_hi20(f)
	ld.w	$a2, $a0, %pc_lo12(f)
	...
	stx.w	$zero, $a3, $a4
	beqz	$a2, .LBB0_5
# %bb.4:                                # %for.inc.us.preheader.peel
	st.w	$zero, $a0, %pc_lo12(f)
.LBB0_5:                                # %for.cond3.preheader.us.peel
	beqz	$a1, .LBB0_8
# %bb.6:                                # %for.cond3.us.preheader.peel
...
.LBB1_2:                                # %for.cond.i
                                        # =>This Inner Loop Header: Depth=1
	b	.LBB1_2
.LBB1_3:                                # %for.cond.us.i.preheader
	pcalau12i	$a0, %pc_hi20(f)
	ld.w	$a2, $a0, %pc_lo12(f)
	pcalau12i	$a1, %pc_hi20(c)
	ld.w	$a1, $a1, %pc_lo12(c)
	...
	stx.w	$zero, $a3, $a4
	beqz	$a2, .LBB1_5
# %bb.4:                                # %for.inc.us.preheader.i.peel
	st.w	$zero, $a0, %pc_lo12(f)
.LBB1_5:                                # %for.cond3.preheader.us.i.peel
	beqz	$a1, .LBB1_8
# %bb.6:                                # %for.cond3.us.preheader.i.peel
	pcalau12i	$a0, %pc_hi20(a)
	ori	$a1, $zero, 1
	st.w	$a1, $a0, %pc_lo12(a)
	.p2align	4, , 16
.LBB1_7:                                # %for.cond3.us.preheader.i
                                        # =>This Inner Loop Header: Depth=1
	b	.LBB1_7
.LBB1_8:                                # %if.end
	ld.w	$a0, $sp, 8
