...
# %bb.0:                                # %entry
	...
	pcalau12i	$a3, %pc_hi20(expected_c)
	addi.d	$a3, $a3, %pc_lo12(expected_c)
	pcalau12i	$a4, %pc_hi20(expected_b)
	addi.d	$a4, $a4, %pc_lo12(expected_b)
	pcalau12i	$a5, %pc_hi20(expected_a)
	addi.d	$a5, $a5, %pc_lo12(expected_a)
	move	$a6, $zero
	ori	$a7, $zero, 64
	.p2align	4, , 16
.LBB0_1:                                # %for.body
