...
# %bb.1:                                # %for.body.us.preheader
	move	$a0, $zero
	andi	$a1, $a1, 4
	pcalau12i	$a2, %pc_hi20(table)
	addi.d	$a2, $a2, %pc_lo12(table)
	ori	$a3, $zero, 31
	b	.LBB0_3
	.p2align	4, , 16
.LBB0_2:                                # %for.inc15.us
...
.LBB0_3:                                # %for.body.us
	...
	b	.LBB0_2
	.p2align	4, , 16
.LBB0_4:                                # %for.inc.us.us
                                        #   in Loop: Header=BB0_5 Depth=2
	beqz	$a4, .LBB0_2
.LBB0_5:                                # %for.body6.us.us
	...
	ld.d	$a4, $a4, 8
	beqz	$a6, .LBB0_4
# %bb.6:                                # %for.body6.us.us
                                        #   in Loop: Header=BB0_5 Depth=2
	beqz	$a1, .LBB0_4
# %bb.7:                                # %land.lhs.true10.us.us
                                        #   in Loop: Header=BB0_5 Depth=2
	ld.bu	$a5, $a5, 65
	beqz	$a5, .LBB0_4
.LBB0_8:                                # %if.then
...
.LBB3_2:                                # %for.body.us.i
	...
	b	.LBB3_1
	.p2align	4, , 16
.LBB3_3:                                # %for.inc.us.us.i
                                        #   in Loop: Header=BB3_4 Depth=2
	move	$a3, $a4
	beqz	$a4, .LBB3_1
.LBB3_4:                                # %for.body6.us.us.i
                                        #   Parent Loop BB3_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.bu	$a5, $a3, 64
	ld.d	$a4, $a3, 8
	beqz	$a5, .LBB3_3
# %bb.5:                                # %land.lhs.true10.us.us.i
                                        #   in Loop: Header=BB3_4 Depth=2
	ld.bu	$a3, $a3, 65
	beqz	$a3, .LBB3_3
# %bb.6:                                # %if.then.i
