...
# %bb.0:                                # %entry
	...
	ori	$s1, $zero, 1
	pcalau12i	$s2, %pc_hi20(strpool)
	pcalau12i	$s3, %pc_hi20(poolptr)
	pcalau12i	$a0, %pc_hi20(poolfilearr)
	addi.d	$s4, $a0, %pc_lo12(poolfilearr)
	move	$s5, $zero
	ori	$s6, $zero, 1
	b	.LBB1_2
	.p2align	4, , 16
...
.LBB1_5:                                # %while.body6
	...
	ld.d	$a1, $s3, %pc_lo12(poolptr)
	ld.b	$a2, $s0, 0
	addi.d	$s0, $s0, 1
	ld.d	$a3, $s2, %pc_lo12(strpool)
	addi.d	$a4, $a1, 1
	st.d	$a4, $s3, %pc_lo12(poolptr)
	addi.w	$a0, $a0, -1
	stx.b	$a2, $a3, $a1
	bltu	$s1, $a0, .LBB1_5
	b	.LBB1_1
