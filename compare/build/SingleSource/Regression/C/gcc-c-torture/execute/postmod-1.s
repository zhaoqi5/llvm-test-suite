...
# %bb.0:                                # %entry
	...
	move	$a1, $zero
	pcalau12i	$a2, %pc_hi20(array0)
	addi.d	$s0, $a2, %pc_lo12(array0)
	alsl.d	$a2, $a0, $s0, 2
	pcalau12i	$a3, %pc_hi20(array1)
	addi.d	$fp, $a3, %pc_lo12(array1)
	alsl.d	$a3, $a0, $fp, 2
	pcalau12i	$a4, %pc_hi20(array2)
	addi.d	$t8, $a4, %pc_lo12(array2)
	alsl.d	$a4, $a0, $t8, 2
	pcalau12i	$a5, %pc_hi20(array3)
	addi.d	$t7, $a5, %pc_lo12(array3)
	alsl.d	$a5, $a0, $t7, 2
	pcalau12i	$a6, %pc_hi20(array4)
	addi.d	$t6, $a6, %pc_lo12(array4)
	alsl.d	$a6, $a0, $t6, 2
	pcalau12i	$a7, %pc_hi20(array5)
	addi.d	$s1, $a7, %pc_lo12(array5)
	alsl.d	$a7, $a0, $s1, 2
