...
ret4:                                   # @ret4
# %bb.0:                                # %entry
	pcalau12i	$a0, %pc_hi20(c+8)
	ld.wu	$a0, $a0, %pc_lo12(c+8)
	andi	$a0, $a0, 31
	ret
.Lfunc_end3:
...
ret7:                                   # @ret7
# %bb.0:                                # %entry
	pcalau12i	$a0, %pc_hi20(d+8)
	ld.hu	$a0, $a0, %pc_lo12(d+8)
	ret
.Lfunc_end6:
...
ret8:                                   # @ret8
# %bb.0:                                # %entry
	pcalau12i	$a0, %pc_hi20(d+10)
	ld.bu	$a0, $a0, %pc_lo12(d+10)
	ret
.Lfunc_end7:
...
ret9:                                   # @ret9
# %bb.0:                                # %entry
	pcalau12i	$a0, %pc_hi20(d+11)
	ld.bu	$a0, $a0, %pc_lo12(d+11)
	ret
.Lfunc_end8:
...
# %bb.0:                                # %entry
	...
	ld.wu	$a2, $a1, %pc_lo12(b+8)
	add.d	$a0, $a2, $a0
	srli.d	$a2, $a2, 6
	bstrins.d	$a0, $a2, 63, 6
	st.w	$a0, $a1, %pc_lo12(b+8)
	ret
.Lfunc_end9:
...
fn4_1:                                  # @fn4_1
# %bb.0:                                # %entry
	pcalau12i	$a1, %pc_hi20(c+8)
	ld.wu	$a2, $a1, %pc_lo12(c+8)
	add.d	$a0, $a2, $a0
	srli.d	$a2, $a2, 5
	bstrins.d	$a0, $a2, 63, 5
	st.w	$a0, $a1, %pc_lo12(c+8)
	ret
.Lfunc_end12:
...
fn7_1:                                  # @fn7_1
# %bb.0:                                # %entry
	pcalau12i	$a1, %pc_hi20(d+8)
	ld.w	$a2, $a1, %pc_lo12(d+8)
	add.d	$a0, $a2, $a0
	st.h	$a0, $a1, %pc_lo12(d+8)
	ret
.Lfunc_end15:
...
# %bb.0:                                # %entry
	pcalau12i	$a0, %pc_hi20(b+8)
	ld.wu	$a1, $a0, %pc_lo12(b+8)
	addi.d	$a2, $a1, 1
	srli.d	$a1, $a1, 6
	bstrins.d	$a2, $a1, 63, 6
	st.w	$a2, $a0, %pc_lo12(b+8)
	ret
.Lfunc_end18:
...
# %bb.0:                                # %entry
	pcalau12i	$a0, %pc_hi20(c+8)
	ld.wu	$a1, $a0, %pc_lo12(c+8)
	addi.d	$a2, $a1, 1
	srli.d	$a1, $a1, 5
	bstrins.d	$a2, $a1, 63, 5
	st.w	$a2, $a0, %pc_lo12(c+8)
	ret
.Lfunc_end21:
...
# %bb.0:                                # %entry
	pcalau12i	$a0, %pc_hi20(c+8)
	ld.w	$a1, $a0, %pc_lo12(c+8)
	xori	$a1, $a1, 32
	st.w	$a1, $a0, %pc_lo12(c+8)
	ret
.Lfunc_end22:
...
# %bb.0:                                # %entry
	pcalau12i	$a0, %pc_hi20(d+8)
	ld.h	$a1, $a0, %pc_lo12(d+8)
	addi.d	$a1, $a1, 1
	st.h	$a1, $a0, %pc_lo12(d+8)
	ret
.Lfunc_end24:
...
# %bb.0:                                # %entry
	pcalau12i	$a0, %pc_hi20(d+11)
	ld.bu	$a1, $a0, %pc_lo12(d+11)
	slli.d	$a1, $a1, 24
	addu16i.d	$a1, $a1, 256
	srli.d	$a1, $a1, 24
	st.b	$a1, $a0, %pc_lo12(d+11)
	ret
.Lfunc_end26:
...
fn8_a:                                  # @fn8_a
# %bb.0:                                # %entry
	pcalau12i	$a1, %pc_hi20(d+10)
	ld.bu	$a2, $a1, %pc_lo12(d+10)
	div.wu	$a0, $a2, $a0
	st.b	$a0, $a1, %pc_lo12(d+10)
	ret
.Lfunc_end97:
...
fn9_a:                                  # @fn9_a
# %bb.0:                                # %entry
	pcalau12i	$a1, %pc_hi20(d+11)
	ld.bu	$a2, $a1, %pc_lo12(d+11)
	div.wu	$a0, $a2, $a0
	st.b	$a0, $a1, %pc_lo12(d+11)
	ret
.Lfunc_end98:
...
# %bb.0:                                # %entry
	pcalau12i	$a0, %pc_hi20(d+8)
	ld.wu	$a1, $a0, %pc_lo12(d+8)
	lu12i.w	$a2, -16
	ori	$a2, $a2, 21
	lu32i.d	$a2, 0
	and	$a1, $a1, $a2
	st.w	$a1, $a0, %pc_lo12(d+8)
	ret
.Lfunc_end132:
...
# %bb.0:                                # %entry
	pcalau12i	$a0, %pc_hi20(d+10)
	ld.bu	$a1, $a0, %pc_lo12(d+10)
	ori	$a2, $zero, 241
	mul.d	$a1, $a1, $a2
	srli.d	$a1, $a1, 12
	st.b	$a1, $a0, %pc_lo12(d+10)
	ret
.Lfunc_end160:
