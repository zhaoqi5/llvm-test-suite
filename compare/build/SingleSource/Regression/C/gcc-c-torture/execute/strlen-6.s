...
.LBB0_16:                               # %test_binary_cond_expr_global.exit
	...
	ld.h	$a1, $a0, 4
	ld.w	$a0, $a0, 0
	pcalau12i	$a2, %pc_hi20(.L__const.test_binary_cond_expr_local.lvb)
	addi.d	$a2, $a2, %pc_lo12(.L__const.test_binary_cond_expr_local.lvb)
	ld.h	$a3, $a2, 4
	ld.w	$a2, $a2, 0
	st.h	$a1, $sp, 20
	st.w	$a0, $sp, 16
