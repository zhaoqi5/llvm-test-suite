...
.Lfunc_end0:
	...
	.cfi_endproc
                                        # -- End function
	.globl	_Z11callsthrowsv                # -- Begin function _Z11callsthrowsv
	.p2align	5
	.type	_Z11callsthrowsv,@function
_Z11callsthrowsv:                       # @_Z11callsthrowsv
.Lfunc_begin0:
	.cfi_startproc
...
.Ltmp8:                                 # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Lfunc_end1:
	.size	_Z11callsthrowsv, .Lfunc_end1-_Z11callsthrowsv
	.cfi_endproc
...
# %bb.0:                                # %entry
	...
	.cfi_offset 22, -16
.Ltmp9:                                 # EH_LABEL
	pcaddu18i	$ra, %call36(_Z11callsthrowsv)
	jirl	$ra, $ra, 0
.Ltmp10:                                # EH_LABEL
# %bb.1:                                # %return.unreachable
.LBB3_2:                                # %lpad
.Ltmp11:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__cxa_begin_catch)
	jirl	$ra, $ra, 0
...
.Lstr.1:
	.asciz	"Caught something, rethrowing..."
	.size	.Lstr.1, 32
