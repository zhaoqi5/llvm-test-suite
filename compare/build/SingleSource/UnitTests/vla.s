...
# %bb.1:                                # %entry
	blt	$a1, $a3, .LBB2_13
# %bb.2:                                # %for.cond5.preheader.us.us.preheader
	move	$a5, $zero
	...
	slli.d	$a3, $a7, 2
	pcalau12i	$a7, %pc_hi20(bork2)
	addi.d	$a7, $a7, %pc_lo12(bork2)
	move	$t0, $a2
	.p2align	4, , 16
.LBB2_3:                                # %for.cond5.preheader.us.us
	...
	move	$t3, $a7
	.p2align	4, , 16
.LBB2_4:                                # %for.body9.us.us
                                        #   Parent Loop BB2_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t4, $t3, 0
	ld.w	$t5, $t2, 0
	bne	$t4, $t5, .LBB2_14
# %bb.5:                                # %for.cond5.us.us
                                        #   in Loop: Header=BB2_4 Depth=2
	addi.d	$t3, $t3, 4
	addi.d	$t1, $t1, -1
	addi.d	$t2, $t2, 4
	bnez	$t1, .LBB2_4
# %bb.6:                                # %for.cond5.for.inc22_crit_edge.us.us
                                        #   in Loop: Header=BB2_3 Depth=1
	addi.d	$a5, $a5, 1
	addi.d	$a7, $a7, 16
	add.d	$t0, $t0, $a3
	bne	$a5, $a0, .LBB2_3
# %bb.7:                                # %for.cond1.for.inc25_crit_edge.us
	ori	$a5, $zero, 1
	blt	$a1, $a5, .LBB2_13
# %bb.8:                                # %for.cond5.preheader.us.us.preheader.1
	move	$a5, $zero
	alsl.d	$a2, $a4, $a2, 2
	...
	.p2align	4, , 16
.LBB2_9:                                # %for.cond5.preheader.us.us.1
                                        # =>This Loop Header: Depth=1
	...
	move	$t0, $a1
	.p2align	4, , 16
.LBB2_10:                               # %for.body9.us.us.1
                                        #   Parent Loop BB2_9 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t1, $a6, 0
	ld.w	$t2, $a7, 0
	bne	$t1, $t2, .LBB2_14
# %bb.11:                               # %for.cond5.us.us.1
                                        #   in Loop: Header=BB2_10 Depth=2
	addi.d	$t0, $t0, -1
	addi.d	$a7, $a7, 4
	addi.d	$a6, $a6, 4
	bnez	$t0, .LBB2_10
# %bb.12:                               # %for.cond5.for.inc22_crit_edge.us.us.1
