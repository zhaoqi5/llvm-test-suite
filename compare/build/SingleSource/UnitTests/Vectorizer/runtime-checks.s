...
# %bb.11:                               # %vec.epilog.middle.block
	beq	$a3, $a6, .LBB47_14
.LBB47_12:                              # %for.body.i.i.i.preheader
	sub.d	$a0, $a0, $a4
	add.d	$a1, $a1, $a4
	add.d	$a2, $a4, $a2
	addi.d	$a2, $a2, -3
	.p2align	4, , 16
.LBB47_13:                              # %for.body.i.i.i
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a3, $a2, 0
	addi.d	$a3, $a3, 10
	st.b	$a3, $a1, 0
	...
	addi.d	$a2, $a2, 1
	bnez	$a0, .LBB47_13
.LBB47_14:                              # %"_ZSt10__invoke_rIvRZ4mainE3$_5JPhS2_jEENSt9enable_ifIX16is_invocable_r_vIT_T0_DpT1_EES4_E4typeEOS5_DpOS6_.exit"
	ret
.LBB47_15:
	addi.d	$a4, $a5, 3
	b	.LBB47_12
...
# %bb.11:                               # %vec.epilog.middle.block
	beq	$a3, $a6, .LBB51_14
.LBB51_12:                              # %for.body.i.i.i.preheader
	sub.d	$a0, $a0, $a4
	alsl.d	$a1, $a4, $a1, 2
	alsl.d	$a2, $a4, $a2, 2
	addi.d	$a2, $a2, -12
	.p2align	4, , 16
.LBB51_13:                              # %for.body.i.i.i
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a3, $a2, 0
	addi.d	$a3, $a3, 10
	st.w	$a3, $a1, 0
	...
	addi.d	$a2, $a2, 4
	bnez	$a0, .LBB51_13
.LBB51_14:                              # %"_ZSt10__invoke_rIvRZ4mainE3$_5JPjS2_jEENSt9enable_ifIX16is_invocable_r_vIT_T0_DpT1_EES4_E4typeEOS5_DpOS6_.exit"
	ret
.LBB51_15:
	addi.d	$a4, $a5, 3
	b	.LBB51_12
...
.LBB71_6:                               # %for.body.i.i.i
	...
	addi.d	$a2, $a2, -2
	bltu	$a3, $a0, .LBB71_6
.LBB71_7:                               # %"_ZSt10__invoke_rIvRZ4mainE3$_9JPhS2_jEENSt9enable_ifIX16is_invocable_r_vIT_T0_DpT1_EES4_E4typeEOS5_DpOS6_.exit"
	ret
.LBB71_8:                               # %vector.main.loop.iter.check
...
.LBB71_14:                              # %vec.epilog.ph
	...
	add.d	$a5, $a1, $a5
	.p2align	4, , 16
.LBB71_15:                              # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$t1, $a4, 6
	ld.b	$t2, $a4, 4
	ld.b	$t3, $a4, 2
...
.LBB83_12:                              # %vec.epilog.vector.body
	...
	vinsgr2vr.b	$vr3, $t8, 9
	vinsgr2vr.b	$vr3, $fp, 10
	vinsgr2vr.b	$vr3, $s0, 11
	vinsgr2vr.b	$vr3, $s1, 12
	vinsgr2vr.b	$vr3, $s2, 13
	vinsgr2vr.b	$vr3, $s3, 14
	vinsgr2vr.b	$vr3, $s4, 15
	vaddi.bu	$vr3, $vr3, 10
	vst	$vr3, $a6, 0
	xvadd.w	$xr1, $xr1, $xr2
	xvadd.w	$xr0, $xr0, $xr2
...
.LBB83_15:                              # %vector.body
	...
	xvpermi.q	$xr17, $xr10, 2
	xvaddi.bu	$xr5, $xr17, 10
	xvst	$xr5, $t0, 0
	xvadd.w	$xr3, $xr3, $xr4
	xvadd.w	$xr2, $xr2, $xr4
	xvadd.w	$xr1, $xr1, $xr4
...
.LBB95_12:                              # %vector.body
	...
	xvpermi.q	$xr1, $xr0, 2
	xvaddi.bu	$xr0, $xr1, 10
	xvstelm.b	$xr0, $a6, -32, 0
	xvstelm.b	$xr0, $a6, -30, 1
	xvstelm.b	$xr0, $a6, -28, 2
	xvstelm.b	$xr0, $a6, -26, 3
	xvstelm.b	$xr0, $a6, -24, 4
	xvstelm.b	$xr0, $a6, -22, 5
	xvstelm.b	$xr0, $a6, -20, 6
	xvstelm.b	$xr0, $a6, -18, 7
	xvstelm.b	$xr0, $a6, -16, 8
	xvstelm.b	$xr0, $a6, -14, 9
	xvstelm.b	$xr0, $a6, -12, 10
	xvstelm.b	$xr0, $a6, -10, 11
	xvstelm.b	$xr0, $a6, -8, 12
	xvstelm.b	$xr0, $a6, -6, 13
	xvstelm.b	$xr0, $a6, -4, 14
	xvstelm.b	$xr0, $a6, -2, 15
	xvstelm.b	$xr0, $a6, 0, 16
	xvstelm.b	$xr0, $a6, 2, 17
	xvstelm.b	$xr0, $a6, 4, 18
	xvstelm.b	$xr0, $a6, 6, 19
	xvstelm.b	$xr0, $a6, 8, 20
	xvstelm.b	$xr0, $a6, 10, 21
	xvstelm.b	$xr0, $a6, 12, 22
	xvstelm.b	$xr0, $a6, 14, 23
	xvstelm.b	$xr0, $a6, 16, 24
	xvstelm.b	$xr0, $a6, 18, 25
	xvstelm.b	$xr0, $a6, 20, 26
	xvstelm.b	$xr0, $a6, 22, 27
	xvstelm.b	$xr0, $a6, 24, 28
	xvstelm.b	$xr0, $a6, 26, 29
	xvstelm.b	$xr0, $a6, 28, 30
	xvstelm.b	$xr0, $a6, 30, 31
	addi.d	$t0, $t0, -32
	addi.d	$a6, $a6, 64
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB95_12
