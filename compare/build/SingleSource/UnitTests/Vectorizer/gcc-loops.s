...
# %bb.156:                              # %middle.block
	...
	beq	$a1, $a2, .LBB24_159
.LBB24_157:                             # %for.body.i.preheader1095
	addi.d	$a0, $a0, -4
	.p2align	4, , 16
.LBB24_158:                             # %for.body.i
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a1, $a0, 4
	addi.d	$a2, $a0, 4
	add.d	$a3, $a1, $a3
...
.Ltmp34:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp35:                                # EH_LABEL
# %bb.161:                              # %for.cond327.preheader
	beq	$s0, $fp, .LBB24_166
# %bb.162:                              # %for.body331.preheader
	sub.d	$a0, $s0, $fp
	srai.d	$s2, $a0, 2
	ori	$s3, $zero, 1
	pcalau12i	$a0, %got_pc_hi20(_ZSt4cout)
...
.LBB24_189:                             # %if.then.i.i.i969
	move	$s1, $a0
	b	.LBB24_194
.LBB24_190:                             # %lpad75
.Ltmp11:                                # EH_LABEL
.LBB24_191:                             # %if.then.i.i.i969
	st.d	$s5, $sp, 16                    # 8-byte Folded Spill
.LBB24_192:                             # %if.then.i.i.i969
	move	$s1, $a0
	b	.LBB24_196
.LBB24_193:                             # %lpad37
.Ltmp8:                                 # EH_LABEL
...
.LBB24_196:                             # %if.then.i.i.i969
	...
	jirl	$ra, $ra, 0
	b	.LBB24_201
.LBB24_197:                             # %ehcleanup345.thread1057
.Ltmp2:                                 # EH_LABEL
	move	$s1, $a0
	addi.d	$a0, $sp, 32
	pcaddu18i	$ra, %call36(_ZN5TimerD2Ev)
