...
# %bb.162:                              # %vec.epilog.middle.block
	...
	beq	$a0, $a4, .LBB24_165
.LBB24_163:                             # %for.body.i.preheader
	addi.d	$a0, $a3, -4
	.p2align	4, , 16
.LBB24_164:                             # %for.body.i
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a2, $a0, 4
	addi.d	$a3, $a0, 4
	add.d	$a1, $a2, $a1
...
.Ltmp34:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp35:                                # EH_LABEL
# %bb.167:                              # %for.cond327.preheader
	beq	$s0, $fp, .LBB24_172
# %bb.168:                              # %for.body331.preheader
	sub.d	$a0, $s0, $fp
	srai.d	$s2, $a0, 2
	ori	$s3, $zero, 1
	pcalau12i	$a0, %got_pc_hi20(_ZSt4cout)
