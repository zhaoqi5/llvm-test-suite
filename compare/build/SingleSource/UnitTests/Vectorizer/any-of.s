...
# %bb.12:                               # %vec.epilog.middle.block
	...
	ori	$a0, $a0, 3
	beq	$a4, $a3, .LBB12_15
.LBB12_13:                              # %for.body.i.i.i.preheader
	sub.d	$a3, $a3, $a4
	alsl.d	$a2, $a4, $a2, 2
	alsl.d	$a1, $a4, $a1, 2
	ori	$a4, $zero, 3
	.p2align	4, , 16
.LBB12_14:                              # %for.body.i.i.i
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a5, $a1, 0
	ld.w	$a6, $a2, 0
	slt	$a5, $a6, $a5
...
# %bb.12:                               # %vec.epilog.middle.block
	...
	ori	$a0, $a0, 3
	beq	$a4, $a3, .LBB17_15
.LBB17_13:                              # %for.body.i.i.i.preheader
	sub.d	$a3, $a3, $a4
	alsl.d	$a2, $a4, $a2, 2
	alsl.d	$a1, $a4, $a1, 2
	ori	$a4, $zero, 3
	.p2align	4, , 16
.LBB17_14:                              # %for.body.i.i.i
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a1, 0
	fld.s	$fa1, $a2, 0
	fcmp.clt.s	$fcc0, $fa1, $fa0
...
# %bb.12:                               # %vec.epilog.middle.block
	...
	ori	$a5, $a4, 3
	beq	$a3, $a2, .LBB22_15
.LBB22_13:                              # %for.body.i.i.i.preheader
	sub.d	$a2, $a2, $a3
	alsl.d	$a1, $a3, $a1, 1
	alsl.d	$a0, $a3, $a0, 1
	ori	$a3, $zero, 3
	.p2align	4, , 16
.LBB22_14:                              # %for.body.i.i.i
                                        # =>This Inner Loop Header: Depth=1
	ld.h	$a4, $a0, 0
	ld.h	$a6, $a1, 0
	slt	$a4, $a6, $a4
...
# %bb.12:                               # %vec.epilog.middle.block
	...
	ori	$a0, $a0, 3
	beq	$a4, $a3, .LBB26_15
.LBB26_13:                              # %for.body.i.i.i.preheader
	sub.d	$a3, $a3, $a4
	alsl.d	$a2, $a4, $a2, 2
	alsl.d	$a1, $a4, $a1, 2
	ori	$a4, $zero, 3
	.p2align	4, , 16
.LBB26_14:                              # %for.body.i.i.i
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a5, $a1, 0
	ld.w	$a6, $a2, 0
	slt	$a5, $a6, $a5
...
# %bb.12:                               # %vec.epilog.middle.block
	...
	ori	$a0, $a0, 3
	beq	$a4, $a3, .LBB30_15
.LBB30_13:                              # %for.body.i.i.i.preheader
	sub.d	$a3, $a3, $a4
	alsl.d	$a2, $a4, $a2, 2
	alsl.d	$a1, $a4, $a1, 2
	ori	$a4, $zero, 3
	.p2align	4, , 16
.LBB30_14:                              # %for.body.i.i.i
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a1, 0
	fld.s	$fa1, $a2, 0
	fcmp.clt.s	$fcc0, $fa1, $fa0
...
# %bb.12:                               # %vec.epilog.middle.block
	...
	ori	$a5, $a4, 3
	beq	$a3, $a2, .LBB34_15
.LBB34_13:                              # %for.body.i.i.i.preheader
	sub.d	$a2, $a2, $a3
	alsl.d	$a1, $a3, $a1, 1
	alsl.d	$a0, $a3, $a0, 1
	ori	$a3, $zero, 3
	.p2align	4, , 16
.LBB34_14:                              # %for.body.i.i.i
                                        # =>This Inner Loop Header: Depth=1
	ld.h	$a4, $a0, 0
	ld.h	$a6, $a1, 0
	slt	$a4, $a6, $a4
...
# %bb.12:                               # %vec.epilog.iter.check
	bnez	$a6, .LBB48_6
.LBB48_13:                              # %for.body.i.i.i.preheader
	sub.d	$a2, $a2, $a4
	alsl.d	$a1, $a4, $a1, 1
	alsl.d	$a0, $a4, $a0, 1
	ori	$a3, $zero, 3
	.p2align	4, , 16
.LBB48_14:                              # %for.body.i.i.i
                                        # =>This Inner Loop Header: Depth=1
	ld.hu	$a4, $a0, 0
	ld.hu	$a6, $a1, 0
	sltu	$a4, $a6, $a4
...
# %bb.12:                               # %vec.epilog.middle.block
	...
	or	$a0, $a0, $a6
	beq	$a5, $a4, .LBB52_15
.LBB52_13:                              # %for.body.i.i.i.preheader
	sub.d	$a4, $a4, $a5
	alsl.d	$a2, $a5, $a2, 2
	alsl.d	$a1, $a5, $a1, 2
	.p2align	4, , 16
.LBB52_14:                              # %for.body.i.i.i
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a5, $a1, 0
	ld.w	$a6, $a2, 0
	sltu	$a5, $a6, $a5
...
# %bb.12:                               # %vec.epilog.middle.block
	...
	or	$a0, $a0, $a6
	beq	$a5, $a4, .LBB56_15
.LBB56_13:                              # %for.body.i.i.i.preheader
	sub.d	$a4, $a4, $a5
	alsl.d	$a2, $a5, $a2, 2
	alsl.d	$a1, $a5, $a1, 2
	.p2align	4, , 16
.LBB56_14:                              # %for.body.i.i.i
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a1, 0
	fld.s	$fa1, $a2, 0
	fcmp.clt.s	$fcc0, $fa1, $fa0
...
# %bb.12:                               # %vec.epilog.middle.block
	...
	or	$a5, $a5, $a6
	beq	$a4, $a3, .LBB60_15
.LBB60_13:                              # %for.body.i.i.i.preheader
	sub.d	$a3, $a3, $a4
	alsl.d	$a2, $a4, $a2, 1
	alsl.d	$a1, $a4, $a1, 1
	.p2align	4, , 16
.LBB60_14:                              # %for.body.i.i.i
                                        # =>This Inner Loop Header: Depth=1
	ld.hu	$a4, $a1, 0
	ld.hu	$a6, $a2, 0
	sltu	$a4, $a6, $a4
