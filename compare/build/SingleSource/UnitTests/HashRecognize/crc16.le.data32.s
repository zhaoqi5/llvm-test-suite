...
.LBB0_1:                                # %crc_table.exit
	...
	srli.d	$a7, $a7, 8
	xor	$a7, $t3, $a7
	bstrpick.d	$t5, $a5, 31, 16
	xor	$a7, $t5, $a7
	andi	$a7, $a7, 255
	slli.d	$a7, $a7, 1
	ldx.hu	$a7, $a1, $a7
	srli.d	$t3, $t3, 8
	bstrpick.d	$a5, $a5, 31, 24
	andi	$t7, $a7, 255
	xor	$t3, $t7, $t3
	xor	$t3, $a5, $t3
	slli.d	$t3, $t3, 1
	...
	srli.d	$a7, $a7, 8
	xor	$a7, $t3, $a7
	pcalau12i	$t3, %pc_hi20(.L.crctable)
	addi.d	$t3, $t3, %pc_lo12(.L.crctable)
	ldx.hu	$a6, $t3, $a6
	xor	$a4, $a6, $a4
	xor	$a4, $t4, $a4
	andi	$a4, $a4, 255
