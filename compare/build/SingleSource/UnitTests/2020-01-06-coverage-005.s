...
# %bb.0:                                # %entry
	...
	and	$a3, $a5, $a3
	pcalau12i	$a5, %pc_hi20(s)
	st.d	$a2, $a5, %pc_lo12(s)
	pcalau12i	$a5, %pc_hi20(p)
	st.d	$a2, $a5, %pc_lo12(p)
	pcalau12i	$a5, %pc_hi20(t)
	st.d	$a1, $a5, %pc_lo12(t)
	pcalau12i	$a5, %pc_hi20(q)
	st.d	$a1, $a5, %pc_lo12(q)
	beqz	$a0, .LBB1_3
