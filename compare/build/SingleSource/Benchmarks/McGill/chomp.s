...
.LBB13_7:                               # %for.body
	...
	addi.d	$a4, $a4, 4
	bnez	$a3, .LBB13_7
.LBB13_8:                               # %for.cond2.preheader
	beq	$s0, $s1, .LBB13_16
# %bb.9:                                # %for.body5.preheader
...
.LBB13_12:                              # %vector.body21
	...
	addi.d	$a1, $a1, 32
	bnez	$a6, .LBB13_12
# %bb.13:                               # %middle.block24
	beq	$a4, $a5, .LBB13_16
.LBB13_14:                              # %for.body5.preheader27
	alsl.d	$a1, $a3, $a0, 2
	sub.d	$a2, $a2, $a3
	.p2align	4, , 16
.LBB13_15:                              # %for.body5
...
.LBB14_16:                              # %for.body.i
	...
	addi.d	$a2, $a2, 4
	bnez	$a3, .LBB14_16
.LBB14_17:                              # %for.body5.preheader.i
                                        #   in Loop: Header=BB14_8 Depth=2
...
# %bb.21:                               # %middle.block116
                                        #   in Loop: Header=BB14_8 Depth=2
	beq	$a2, $a3, .LBB14_24
.LBB14_22:                              # %for.body5.i.preheader
                                        #   in Loop: Header=BB14_8 Depth=2
	sub.d	$a0, $a6, $a1
	alsl.d	$a1, $a1, $s3, 2
	.p2align	4, , 16
.LBB14_23:                              # %for.body5.i
                                        #   Parent Loop BB14_4 Depth=1
                                        #     Parent Loop BB14_8 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	st.w	$s2, $a1, 0
	...
	addi.d	$a1, $a1, 4
	bnez	$a0, .LBB14_23
.LBB14_24:                              # %while.body.i.preheader
                                        #   in Loop: Header=BB14_8 Depth=2
	move	$a0, $s0
	ori	$a1, $zero, 4
	bltu	$s0, $a1, .LBB14_28
...
# %bb.27:                               # %middle.block
                                        #   in Loop: Header=BB14_8 Depth=2
	beq	$a1, $s0, .LBB14_30
.LBB14_28:                              # %while.body.i.preheader134
                                        #   in Loop: Header=BB14_8 Depth=2
	addi.d	$a1, $s1, -4
	alsl.d	$a1, $a0, $a1, 2
	alsl.d	$a2, $a0, $s3, 2
...
.LBB14_29:                              # %while.body.i
	...
	addi.d	$a2, $a2, -4
	bnez	$a0, .LBB14_29
.LBB14_30:                              # %while.cond.i.preheader
                                        #   in Loop: Header=BB14_8 Depth=2
	addi.d	$s4, $s0, 1
	addi.d	$a1, $s7, -4
	move	$a0, $s4
	.p2align	4, , 16
.LBB14_31:                              # %while.cond.i
                                        #   Parent Loop BB14_4 Depth=1
                                        #     Parent Loop BB14_8 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	beq	$a0, $fp, .LBB14_6
...
# %bb.34:                               # %if.then
	...
	bne	$a0, $fp, .LBB14_42
# %bb.35:                               # %while.cond.i38.preheader
                                        #   in Loop: Header=BB14_8 Depth=2
...
.LBB14_37:                              # %while.cond.i.i
	...
	beq	$a3, $fp, .LBB14_41
# %bb.38:                               # %land.rhs.i.i
                                        #   in Loop: Header=BB14_37 Depth=4
	ld.w	$a5, $a2, 0
	ld.w	$a6, $a4, 0
	addi.d	$a3, $a3, -1
	addi.d	$a4, $a4, -4
...
.LBB14_45:                              # %while.body.i40
	...
	move	$a5, $a0
	.p2align	4, , 16
.LBB14_46:                              # %while.cond.i.i41
                                        #   Parent Loop BB14_4 Depth=1
                                        #     Parent Loop BB14_8 Depth=2
                                        #       Parent Loop BB14_45 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
	beq	$a5, $fp, .LBB14_50
# %bb.47:                               # %land.rhs.i.i43
                                        #   in Loop: Header=BB14_46 Depth=4
	ld.w	$a7, $a4, 0
	ld.w	$t0, $a6, 0
	addi.d	$a5, $a5, -1
	addi.d	$a6, $a6, -4
	addi.d	$a4, $a4, -4
	beq	$a7, $t0, .LBB14_46
# %bb.48:                               # %equal_data.exit.i48
                                        #   in Loop: Header=BB14_45 Depth=3
	blez	$a5, .LBB14_50
# %bb.49:                               # %while.cond.i49
                                        #   in Loop: Header=BB14_45 Depth=3
	ld.d	$a3, $a3, 8
	bnez	$a3, .LBB14_45
	b	.LBB14_7
...
.LBB16_10:                              # %vector.body95
	...
	addi.d	$a3, $a3, 32
	bnez	$a2, .LBB16_10
# %bb.11:                               # %middle.block98
                                        #   in Loop: Header=BB16_5 Depth=2
	move	$a5, $s6
	beq	$s0, $a1, .LBB16_15
.LBB16_12:                              # %for.body.i.preheader
                                        #   in Loop: Header=BB16_5 Depth=2
	alsl.d	$a2, $a1, $a0, 2
	.p2align	4, , 16
.LBB16_13:                              # %for.body.i
...
# %bb.14:                               #   in Loop: Header=BB16_5 Depth=2
	move	$a5, $s6
.LBB16_15:                              # %for.body5.preheader.i
                                        #   in Loop: Header=BB16_5 Depth=2
	sub.d	$a2, $s2, $s0
	ori	$a1, $zero, 8
	bgeu	$a2, $a1, .LBB16_17
...
.LBB16_18:                              # %vector.body81
	...
	addi.d	$a5, $a5, 32
	bnez	$a4, .LBB16_18
# %bb.19:                               # %middle.block85
                                        #   in Loop: Header=BB16_5 Depth=2
	beq	$a2, $a3, .LBB16_22
.LBB16_20:                              # %for.body5.i.preheader
                                        #   in Loop: Header=BB16_5 Depth=2
	sub.d	$a2, $s2, $a1
	alsl.d	$a1, $a1, $a0, 2
	.p2align	4, , 16
.LBB16_21:                              # %for.body5.i
                                        #   Parent Loop BB16_4 Depth=1
                                        #     Parent Loop BB16_5 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	st.w	$s8, $a1, 0
	...
	addi.d	$a1, $a1, 4
	bnez	$a2, .LBB16_21
.LBB16_22:                              # %while.body.i.preheader
                                        #   in Loop: Header=BB16_5 Depth=2
	move	$a1, $s3
	ori	$a2, $zero, 4
	bltu	$s2, $a2, .LBB16_26
...
# %bb.25:                               # %middle.block
	...
	ld.d	$a2, $sp, 128                   # 8-byte Folded Reload
	beq	$a2, $s3, .LBB16_28
.LBB16_26:                              # %while.body.i.preheader101
                                        #   in Loop: Header=BB16_5 Depth=2
	addi.d	$a2, $fp, -4
	alsl.d	$a2, $a1, $a2, 2
	alsl.d	$a3, $a1, $a0, 2
...
.LBB16_27:                              # %while.body.i
	...
	addi.d	$a3, $a3, -4
	bnez	$a1, .LBB16_27
.LBB16_28:                              # %while.cond.i.preheader
                                        #   in Loop: Header=BB16_5 Depth=2
	ld.d	$a2, $sp, 136                   # 8-byte Folded Reload
	move	$a1, $s7
	.p2align	4, , 16
.LBB16_29:                              # %while.cond.i
                                        #   Parent Loop BB16_4 Depth=1
                                        #     Parent Loop BB16_5 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	beq	$a1, $s1, .LBB16_3
...
# %bb.32:                               # %if.end17
	...
	bne	$s6, $a0, .LBB16_5
	.p2align	4, , 16
# %bb.33:                               # %for.cond1.for.inc18_crit_edge
                                        #   in Loop: Header=BB16_4 Depth=1
	addi.w	$s8, $s8, 1
	bne	$s8, $s5, .LBB16_4
.LBB16_34:                              # %for.end20.loopexit40
...
.LBB21_16:                              # %where.exit
	...
	ld.d	$a2, $a2, 16
	beqz	$a2, .LBB21_32
# %bb.17:                               # %while.cond.i18.preheader
                                        #   in Loop: Header=BB21_10 Depth=1
	xori	$s7, $s2, 1
	b	.LBB21_19
	.p2align	4, , 16
...
.LBB21_19:                              # %while.cond.i18
	...
	ld.d	$fp, $a3, 0
	beqz	$a2, .LBB21_26
# %bb.20:                               # %while.cond.i.i20.preheader
                                        #   in Loop: Header=BB21_19 Depth=2
	add.d	$a3, $fp, $a0
	addi.d	$a3, $a3, -4
	move	$a4, $s8
.LBB21_21:                              # %while.cond.i.i20
                                        #   Parent Loop BB21_10 Depth=1
	...
	move	$a6, $a1
	.p2align	4, , 16
.LBB21_22:                              # %while.cond.i.i.i
                                        #   Parent Loop BB21_10 Depth=1
                                        #     Parent Loop BB21_19 Depth=2
                                        #       Parent Loop BB21_21 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
	beq	$a6, $s6, .LBB21_18
# %bb.23:                               # %land.rhs.i.i.i
...
# %bb.25:                               # %while.body.i.i
	...
	b	.LBB21_21
	.p2align	4, , 16
.LBB21_26:                              # %while.end.i
                                        #   in Loop: Header=BB21_10 Depth=1
	pcaddu18i	$ra, %call36(malloc)
	jirl	$ra, $ra, 0
	move	$s3, $a0
	beqz	$s4, .LBB21_28
# %bb.27:                               # %while.body.preheader.i.i
                                        #   in Loop: Header=BB21_10 Depth=1
	addi.w	$a0, $s5, -1
...
.LBB21_28:                              # %get_good_move.exit
                                        #   in Loop: Header=BB21_10 Depth=1
	beqz	$s3, .LBB21_32
# %bb.29:                               # %while.cond.i21.preheader
                                        #   in Loop: Header=BB21_10 Depth=1
	move	$a0, $zero
	addi.d	$a3, $zero, -1
	.p2align	4, , 16
.LBB21_30:                              # %while.cond.i21
                                        #   Parent Loop BB21_10 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.w	$a2, $s3, $a0
	ldx.w	$a1, $s0, $a0
