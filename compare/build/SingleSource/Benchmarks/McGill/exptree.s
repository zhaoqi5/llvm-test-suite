...
# %bb.1:                                # %for.body.lr.ph
	...
	addi.d	$s8, $a0, %pc_lo12(.LJTI6_1)
	pcalau12i	$a0, %pc_hi20(.LJTI6_0)
	addi.d	$s2, $a0, %pc_lo12(.LJTI6_0)
	b	.LBB6_3
	.p2align	4, , 16
.LBB6_2:                                # %if.then
...
.LBB10_13:                              # %for.body.i17
	...
	addi.d	$a1, $a1, 12
	bnez	$a2, .LBB10_13
.LBB10_14:                              # %for.body.i24.preheader
	ori	$a1, $zero, 1
	bne	$fp, $a1, .LBB10_16
# %bb.15:
	move	$a0, $zero
	b	.LBB10_19
.LBB10_16:                              # %vector.ph32
	slli.d	$a0, $a0, 1
	addi.d	$a1, $s0, 20
	move	$a2, $a0
	.p2align	4, , 16
.LBB10_17:                              # %vector.body35
                                        # =>This Inner Loop Header: Depth=1
	st.w	$zero, $a1, -12
	st.w	$zero, $a1, 0
	addi.d	$a2, $a2, -2
	addi.d	$a1, $a1, 24
	bnez	$a2, .LBB10_17
# %bb.18:                               # %middle.block38
	beq	$a0, $fp, .LBB10_21
.LBB10_19:                              # %for.body.i24.preheader41
	sub.d	$a1, $fp, $a0
	slli.d	$a2, $a0, 3
	alsl.d	$a0, $a0, $a2, 2
	add.d	$a0, $a0, $s0
	addi.d	$a0, $a0, 8
	.p2align	4, , 16
.LBB10_20:                              # %for.body.i24
                                        # =>This Inner Loop Header: Depth=1
	st.w	$zero, $a0, 0
	addi.d	$a1, $a1, -1
	addi.d	$a0, $a0, 12
	bnez	$a1, .LBB10_20
.LBB10_21:                              # %initCombList.exit29
	move	$a0, $fp
