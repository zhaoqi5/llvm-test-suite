...
# %bb.5:                                # %middle.block
	beq	$s4, $a2, .LBB1_8
.LBB1_6:                                # %for.body.i.i.preheader221
	sub.d	$a3, $s4, $a2
	alsl.d	$a0, $a2, $a0, 3
	alsl.d	$a1, $a2, $a1, 3
	.p2align	4, , 16
...
.LBB1_13:                               # %vector.body161
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB1_13
# %bb.14:                               # %middle.block166
	beq	$s1, $a2, .LBB1_17
.LBB1_15:                               # %for.body.i.i23.preheader220
	sub.d	$a3, $s1, $a2
	alsl.d	$a0, $a2, $a0, 3
	alsl.d	$a1, $a2, $a1, 3
	.p2align	4, , 16
...
.LBB1_25:                               # %vector.body193
	...
	addi.d	$a3, $a3, 64
	bnez	$a4, .LBB1_25
# %bb.26:                               # %middle.block198
	beq	$s1, $a1, .LBB1_40
.LBB1_27:                               # %for.body.i.preheader218
	sub.d	$a2, $s1, $a1
	alsl.d	$a3, $a1, $a0, 3
	alsl.d	$a1, $a1, $s5, 3
	.p2align	4, , 16
...
.LBB1_36:                               # %vector.body177
	...
	addi.d	$a3, $a3, 64
	bnez	$a4, .LBB1_36
# %bb.37:                               # %middle.block182
	beq	$s1, $a1, .LBB1_40
.LBB1_38:                               # %for.body.i44.preheader219
	sub.d	$a2, $s1, $a1
	alsl.d	$a3, $a1, $a0, 3
	alsl.d	$a1, $a1, $s5, 3
	.p2align	4, , 16
...
# %bb.66:                               # %for.body39.preheader
	ori	$a2, $zero, 12
	bltu	$s1, $a2, .LBB1_69
# %bb.67:                               # %vector.memcheck201
	alsl.d	$a2, $s4, $a0, 4
	addi.d	$a2, $a2, -24
	bgeu	$a1, $a2, .LBB1_82
# %bb.68:                               # %vector.memcheck201
	alsl.d	$a2, $s4, $a1, 3
	addi.d	$a2, $a2, -8
	bgeu	$a0, $a2, .LBB1_82
.LBB1_69:
	move	$a2, $zero
.LBB1_70:                               # %for.body39.preheader217
	nor	$a3, $a2, $zero
	add.d	$a3, $a3, $s4
	alsl.d	$a4, $a2, $a0, 4
	alsl.d	$a1, $a2, $a1, 3
