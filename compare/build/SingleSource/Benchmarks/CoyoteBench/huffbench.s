...
.LBB1_49:                               # %for.body200.preheader
	...
	b	.LBB1_52
	.p2align	4, , 16
.LBB1_50:                               # %land.rhs.while.end217_crit_edge
...
.LBB1_57:                               # %for.cond223
	...
	addi.d	$a1, $a1, 8
	beqz	$a2, .LBB1_57
# %bb.58:                               # %while.cond231.preheader
	beqz	$fp, .LBB1_65
# %bb.59:                               # %while.body234.preheader
	move	$a1, $zero
	move	$a7, $zero
	ori	$a2, $zero, 128
	addi.d	$a3, $sp, 264
...
.LBB1_66:
	...
	b	.LBB1_69
	.p2align	4, , 16
.LBB1_67:                               #   in Loop: Header=BB1_69 Depth=1
	move	$t1, $t4
.LBB1_68:                               # %heap_adjust.exit193
...
.LBB1_69:                               # %while.body
	...
	ori	$t5, $zero, 1
	blt	$a7, $a3, .LBB1_76
# %bb.70:                               # %while.body.lr.ph.i135
                                        #   in Loop: Header=BB1_69 Depth=1
	srai.d	$t5, $t4, 29
	ldx.d	$t6, $t5, $a4
	ori	$t5, $zero, 1
	.p2align	4, , 16
.LBB1_71:                               # %while.body.i137
                                        #   Parent Loop BB1_69 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	slli.w	$t7, $t5, 1
	bge	$t7, $a7, .LBB1_73
# %bb.72:                               # %land.lhs.true.i154
...
.LBB1_76:                               # %heap_adjust.exit161
	...
	slli.d	$t2, $t6, 32
	blt	$a7, $a3, .LBB1_68
# %bb.77:                               # %while.body.lr.ph.i167
                                        #   in Loop: Header=BB1_69 Depth=1
	srai.d	$t1, $t2, 29
	ldx.d	$t3, $t1, $a4
	ori	$t1, $zero, 1
	.p2align	4, , 16
.LBB1_78:                               # %while.body.i169
                                        #   Parent Loop BB1_69 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	slli.w	$t4, $t1, 1
	bge	$t4, $a7, .LBB1_80
# %bb.79:                               # %land.lhs.true.i186
