...
.LBB1_69:                               # %while.body
	...
	ori	$t4, $zero, 1
	blt	$a6, $a2, .LBB1_76
# %bb.70:                               # %while.body.lr.ph.i134
                                        #   in Loop: Header=BB1_69 Depth=1
	srai.d	$t4, $t3, 29
	ldx.d	$t5, $t4, $a3
	ori	$t4, $zero, 1
	.p2align	4, , 16
.LBB1_71:                               # %while.body.i136
                                        #   Parent Loop BB1_69 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	slli.w	$t6, $t4, 1
	bge	$t6, $a6, .LBB1_73
# %bb.72:                               # %land.lhs.true.i153
...
.LBB1_76:                               # %heap_adjust.exit160
	...
	slli.d	$t1, $t5, 32
	blt	$a6, $a2, .LBB1_68
# %bb.77:                               # %while.body.lr.ph.i165
                                        #   in Loop: Header=BB1_69 Depth=1
	srai.d	$t0, $t1, 29
	ldx.d	$t2, $t0, $a3
	ori	$t0, $zero, 1
	.p2align	4, , 16
.LBB1_78:                               # %while.body.i167
                                        #   Parent Loop BB1_69 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	slli.w	$t3, $t0, 1
	bge	$t3, $a6, .LBB1_80
# %bb.79:                               # %land.lhs.true.i184
