...
# %bb.0:                                # %entry
	...
	addi.d	$a1, $a1, %pc_lo12(e)
	fldx.d	$fa2, $a1, $s1
	fst.d	$fa2, $sp, 160                  # 8-byte Folded Spill
	add.d	$a1, $a1, $s1
	fld.d	$fa2, $a1, 8
	...
	fld.d	$fa0, $a1, 8
	fld.d	$fa1, $a1, 16
	pcalau12i	$a1, %pc_hi20(dinc)
	addi.d	$a1, $a1, %pc_lo12(dinc)
	fldx.d	$fa2, $a1, $s1
	...
	fmadd.d	$fa0, $fs3, $fs5, $fa0
	fmadd.d	$fs3, $fa0, $fs7, $fs1
	fmul.d	$fs4, $fs2, $fa1
	fmov.d	$fa0, $fs4
	pcaddu18i	$ra, %call36(cos)
	jirl	$ra, $ra, 0
	...
	fcmp.cult.d	$fcc0, $fa2, $fa4
	fsel	$fs4, $fa1, $fa3, $fcc0
	...
	pcaddu18i	$ra, %call36(sin)
	jirl	$ra, $ra, 0
	fmadd.d	$fs2, $fs5, $fa0, $fs2
	fmov.d	$fa0, $fs1
	pcaddu18i	$ra, %call36(cos)
	jirl	$ra, $ra, 0
	vldi	$vr1, -912
	pcalau12i	$a0, %pc_hi20(.LCPI1_9)
	fld.d	$fs0, $a0, %pc_lo12(.LCPI1_9)
...
.LBB1_10:                               # %while.end
	...
	fld.d	$ft0, $sp, 368                  # 8-byte Folded Reload
...
.LBB1_11:                               # %while.end.split
	...
	fld.d	$fs5, $sp, 160                  # 8-byte Folded Reload
	fmadd.d	$fs1, $fs5, $fa2, $fa3
	bceqz	$fcc0, .LBB1_15
