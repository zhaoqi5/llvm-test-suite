...
.LBB0_7:                                # %while.end
	...
	fld.d	$fa1, $s3, %pc_lo12(one)
	fld.d	$fs4, $s4, 16
	fneg.d	$fs3, $fa0
	fneg.d	$fa0, $fa1
	fst.d	$fa0, $s8, %pc_lo12(sa)
	move	$a0, $fp
	move	$a1, $zero
	pcaddu18i	$ra, %call36(gettimeofday)
	jirl	$ra, $ra, 0
...
.LBB0_14:                               # %for.body84
	...
	fsub.d	$fs5, $fs5, $fa2
	bnez	$s0, .LBB0_14
# %bb.15:                               # %for.cond81.for.end96_crit_edge
	fst.d	$fa0, $s8, %pc_lo12(sa)
.LBB0_16:                               # %for.end96
	move	$a0, $fp
	move	$a1, $zero
...
.LBB0_22:                               # %for.end190
	...
	pcaddu18i	$ra, %call36(printf)
	jirl	$ra, $ra, 0
	fld.d	$fa0, $s8, %pc_lo12(three)
	fld.d	$fa1, $s3, %pc_lo12(piref)
	fld.d	$fs2, $s4, 16
	fmul.d	$fa0, $fa0, $fs3
	fdiv.d	$fs4, $fa1, $fa0
	move	$a0, $fp
