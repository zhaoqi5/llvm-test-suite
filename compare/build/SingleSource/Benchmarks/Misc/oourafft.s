...
.LBB9_5:
	move	$t4, $a7
.LBB9_6:                                # %for.body81.preheader948
	alsl.d	$a0, $t4, $a2, 3
...
# %bb.12:                               # %for.body195.preheader
	...
	ori	$a0, $zero, 38
	bgeu	$a1, $a0, .LBB9_18
.LBB9_13:                               # %for.body195.preheader947
                                        #   in Loop: Header=BB9_11 Depth=1
...
.LBB9_18:                               # %vector.scevcheck746
	...
	move	$t2, $s4
	bltu	$a3, $a4, .LBB9_13
# %bb.19:                               # %vector.scevcheck746
                                        #   in Loop: Header=BB9_11 Depth=1
	alsl.w	$a3, $a0, $a7, 1
	move	$t2, $s4
	blt	$a3, $a7, .LBB9_13
# %bb.20:                               # %vector.scevcheck746
                                        #   in Loop: Header=BB9_11 Depth=1
	addi.w	$a5, $a0, 0
	move	$t2, $s4
	bltz	$a5, .LBB9_13
# %bb.21:                               # %vector.scevcheck746
                                        #   in Loop: Header=BB9_11 Depth=1
...
# %bb.24:                               # %vector.scevcheck746
	...
	move	$t2, $s4
	bltu	$t7, $t1, .LBB9_13
# %bb.25:                               # %vector.scevcheck746
                                        #   in Loop: Header=BB9_11 Depth=1
	alsl.w	$t7, $a0, $t0, 1
	move	$t2, $s4
	blt	$t7, $t0, .LBB9_13
# %bb.26:                               # %vector.scevcheck746
                                        #   in Loop: Header=BB9_11 Depth=1
	move	$t2, $s4
	bltz	$a5, .LBB9_13
# %bb.27:                               # %vector.scevcheck746
                                        #   in Loop: Header=BB9_11 Depth=1
	srli.d	$a5, $a1, 33
	move	$t2, $s4
	bnez	$a5, .LBB9_13
# %bb.28:                               # %vector.memcheck776
                                        #   in Loop: Header=BB9_11 Depth=1
...
.LBB9_59:                               # %vector.scevcheck553
	...
	move	$t2, $t4
	bltu	$a5, $s2, .LBB9_16
# %bb.60:                               # %vector.scevcheck553
                                        #   in Loop: Header=BB9_11 Depth=1
	alsl.w	$a5, $t8, $a1, 1
	move	$t2, $t4
	blt	$a5, $a1, .LBB9_16
# %bb.61:                               # %vector.scevcheck553
                                        #   in Loop: Header=BB9_11 Depth=1
	addi.w	$a5, $t8, 0
	move	$t2, $t4
	bltz	$a5, .LBB9_16
# %bb.62:                               # %vector.scevcheck553
                                        #   in Loop: Header=BB9_11 Depth=1
	...
	move	$t2, $t4
	bltu	$a7, $t5, .LBB9_16
# %bb.63:                               # %vector.scevcheck553
                                        #   in Loop: Header=BB9_11 Depth=1
	alsl.w	$a7, $t8, $t0, 1
	move	$t2, $t4
	blt	$a7, $t0, .LBB9_16
# %bb.64:                               # %vector.scevcheck553
                                        #   in Loop: Header=BB9_11 Depth=1
	move	$t2, $t4
	bltz	$a5, .LBB9_16
# %bb.65:                               # %vector.scevcheck553
                                        #   in Loop: Header=BB9_11 Depth=1
	srli.d	$a5, $a3, 33
	move	$t2, $t4
	bnez	$a5, .LBB9_16
# %bb.66:                               # %vector.memcheck570
                                        #   in Loop: Header=BB9_11 Depth=1
	alsl.d	$a7, $t4, $a2, 3
	slli.d	$a3, $a3, 3
	and	$s5, $a3, $s5
