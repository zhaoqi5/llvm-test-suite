...
.LBB0_10:                               # %pred.store.continue
	...
	andi	$a6, $a6, 1
	beqz	$a6, .LBB0_12
# %bb.11:                               # %pred.store.if117
                                        #   in Loop: Header=BB0_8 Depth=2
	vpickve2gr.d	$a6, $vr4, 1
	add.d	$a6, $a4, $a6
	st.d	$a2, $a6, 8
.LBB0_12:                               # %pred.store.continue118
                                        #   in Loop: Header=BB0_8 Depth=2
	vaddi.du	$vr4, $vr3, 2
	vand.v	$vr5, $vr4, $vr2
	vseqi.d	$vr5, $vr5, 8
...
.LBB0_14:                               # %pred.store.if119
	...
	andi	$a6, $a6, 1
	beqz	$a6, .LBB0_7
.LBB0_15:                               # %pred.store.if121
                                        #   in Loop: Header=BB0_8 Depth=2
	vpickve2gr.d	$a6, $vr4, 1
	add.d	$a6, $a4, $a6
	st.d	$a2, $a6, 8
	b	.LBB0_7
.LBB0_16:                               # %for.body28.preheader
	ori	$s1, $zero, 63
	addi.w	$s0, $zero, -1
	.p2align	4, , 16
.LBB0_17:                               # %for.body28
...
.LBB0_22:                               # %for.cond71.preheader
	...
	b	.LBB0_27
	.p2align	4, , 16
.LBB0_23:                               # %for.inc97.us
                                        #   in Loop: Header=BB0_24 Depth=2
	addi.d	$s5, $s5, 16
	addi.w	$s2, $s2, 1
	beqz	$s5, .LBB0_21
.LBB0_24:                               # %for.body74.us
