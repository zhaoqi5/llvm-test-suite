...
# %bb.0:                                # %entry
	...
	pcalau12i	$s2, %pc_hi20(four)
	lu52i.d	$a0, $zero, 1025
	st.d	$a0, $s2, %pc_lo12(four)
	pcalau12i	$a0, %pc_hi20(five)
	lu32i.d	$a2, 262144
	lu52i.d	$a2, $a2, 1025
	st.d	$a2, $a0, %pc_lo12(five)
	...
	fld.d	$fa4, $a1, %pc_lo12(A6)
	pcalau12i	$a1, %pc_hi20(A5)
	fld.d	$fa5, $a1, %pc_lo12(A5)
	pcalau12i	$a1, %pc_hi20(A4)
	fld.d	$fa6, $a1, %pc_lo12(A4)
	pcalau12i	$a1, %pc_hi20(A3)
	fld.d	$fa7, $a1, %pc_lo12(A3)
	pcalau12i	$a1, %pc_hi20(A2)
	fld.d	$ft0, $a1, %pc_lo12(A2)
	pcalau12i	$a1, %pc_hi20(A1)
	fld.d	$ft1, $a1, %pc_lo12(A1)
	fld.d	$fa3, $s0, %pc_lo12(one)
	pcalau12i	$a1, %pc_hi20(B6)
	fld.d	$ft2, $a1, %pc_lo12(B6)
	pcalau12i	$a1, %pc_hi20(B5)
	fld.d	$ft4, $a1, %pc_lo12(B5)
	pcalau12i	$a1, %pc_hi20(B4)
	fld.d	$ft6, $a1, %pc_lo12(B4)
	pcalau12i	$a1, %pc_hi20(B3)
	fld.d	$ft7, $a1, %pc_lo12(B3)
	pcalau12i	$a1, %pc_hi20(B2)
	fld.d	$ft8, $a1, %pc_lo12(B2)
	pcalau12i	$a1, %pc_hi20(B1)
	fld.d	$ft5, $a1, %pc_lo12(B1)
	movgr2fr.d	$ft3, $zero
	lu12i.w	$a1, 38146
	ori	$a1, $a1, 3983
	.p2align	4, , 16
.LBB0_1:                                # %for.body
	...
	fmadd.d	$ft11, $ft11, $ft10, $fa6
	fmadd.d	$ft11, $ft11, $ft10, $fa7
	fmadd.d	$ft11, $ft11, $ft10, $ft0
	fmadd.d	$ft11, $ft11, $ft10, $ft1
	fmadd.d	$ft11, $ft11, $ft10, $fa3
	fmul.d	$ft9, $ft9, $ft11
	fmadd.d	$ft11, $ft2, $ft10, $ft4
	fmadd.d	$ft11, $ft10, $ft11, $ft6
	fmadd.d	$ft11, $ft10, $ft11, $ft7
	fmadd.d	$ft11, $ft10, $ft11, $ft8
	fmadd.d	$ft11, $ft10, $ft11, $ft5
	fmadd.d	$ft10, $ft10, $ft11, $fa3
	fmadd.d	$ft3, $ft9, $ft10, $ft3
	bne	$a0, $a1, .LBB0_1
# %bb.2:                                # %for.end
	fdiv.d	$fa0, $fa1, $fa0
	fmul.d	$fa1, $fa0, $fa0
	fmadd.d	$fa4, $fa4, $fa1, $fa5
	fmadd.d	$fa4, $fa4, $fa1, $fa6
	fmadd.d	$fa4, $fa4, $fa1, $fa7
	fmadd.d	$fa4, $fa4, $fa1, $ft0
	fmadd.d	$fa4, $fa4, $fa1, $ft1
	fmadd.d	$fa4, $fa4, $fa1, $fa3
	fmul.d	$fa0, $fa0, $fa4
	fmadd.d	$fa4, $ft2, $fa1, $ft4
	fmadd.d	$fa4, $fa1, $fa4, $ft6
	fmadd.d	$fa4, $fa1, $fa4, $ft7
	fmadd.d	$fa4, $fa1, $fa4, $ft8
	fld.d	$fa5, $fp, %pc_lo12(two)
	fmadd.d	$fa4, $fa1, $fa4, $ft5
	fmadd.d	$fa1, $fa1, $fa4, $fa3
	fmul.d	$fa0, $fa0, $fa1
	fmadd.d	$fa0, $fa5, $ft3, $fa0
	fmul.d	$fa0, $fa2, $fa0
	fdiv.d	$fa0, $fa0, $fa5
