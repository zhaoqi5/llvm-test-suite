...
# %bb.0:                                # %entry
	...
	pcalau12i	$s0, %pc_hi20(piref)
	lu12i.w	$a0, 345154
	ori	$a0, $a0, 3352
	lu32i.d	$a0, -450053
	lu52i.d	$a0, $a0, 1024
	st.d	$a0, $s0, %pc_lo12(piref)
	pcalau12i	$s1, %pc_hi20(one)
	st.d	$a1, $s1, %pc_lo12(one)
	...
	pcaddu18i	$ra, %call36(puts)
	jirl	$ra, $ra, 0
	fld.d	$fa2, $s2, %pc_lo12(three)
	pcalau12i	$a0, %pc_hi20(.LCPI0_0)
	fld.d	$fa0, $a0, %pc_lo12(.LCPI0_0)
	fld.d	$fa3, $s0, %pc_lo12(piref)
	fmul.d	$fa0, $fa2, $fa0
	fdiv.d	$fa0, $fa3, $fa0
...
.LBB0_1:                                # %for.body
	...
	fmul.d	$ft4, $fa0, $ft3
	fmul.d	$ft5, $ft4, $ft4
	fmadd.d	$ft6, $fa4, $ft5, $fa7
	fmadd.d	$ft6, $ft6, $ft5, $ft0
	fmadd.d	$ft6, $ft6, $ft5, $ft1
	fmadd.d	$ft6, $ft6, $ft5, $ft2
	fmadd.d	$ft6, $ft6, $ft5, $fa6
	fmadd.d	$ft5, $ft6, $ft5, $fa1
	addi.d	$a0, $a0, -1
	fmadd.d	$fa5, $ft4, $ft5, $fa5
	bnez	$a0, .LBB0_1
# %bb.2:                                # %for.end
	fdiv.d	$fa2, $fa3, $fa2
	fmul.d	$fa3, $fa2, $fa2
	fmadd.d	$fa4, $fa4, $fa3, $fa7
	fmadd.d	$fa4, $fa4, $fa3, $ft0
	fmadd.d	$fa4, $fa4, $fa3, $ft1
	fmadd.d	$fa4, $fa4, $fa3, $ft2
	fld.d	$fa7, $fp, %pc_lo12(two)
	fmadd.d	$fa4, $fa4, $fa3, $fa6
	fmadd.d	$fa1, $fa4, $fa3, $fa1
	fmul.d	$fa1, $fa2, $fa1
	fmadd.d	$fa1, $fa7, $fa5, $fa1
	fmul.d	$fa0, $fa0, $fa1
	fdiv.d	$fa0, $fa0, $fa7
