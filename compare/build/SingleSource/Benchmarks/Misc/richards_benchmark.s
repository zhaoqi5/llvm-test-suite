...
# %bb.0:                                # %entry
	...
	jirl	$ra, $ra, 0
	slli.d	$a1, $s5, 3
	pcalau12i	$a2, %pc_hi20(tasklist)
	ld.d	$a3, $a2, %pc_lo12(tasklist)
	pcalau12i	$a4, %pc_hi20(tasktab)
	addi.d	$a4, $a4, %pc_lo12(tasktab)
	stx.d	$a0, $a4, $a1
	st.d	$a3, $a0, 0
	st.w	$s5, $a0, 8
	st.w	$s4, $a0, 12
...
# %bb.1:                                # %if.else
	...
	maskeqz	$a5, $t0, $a5
	or	$a5, $a5, $a6
	pcalau12i	$a6, %pc_hi20(alphabet)
	addi.d	$a6, $a6, %pc_lo12(alphabet)
	ldx.b	$t1, $a6, $a5
	st.b	$t1, $a0, 20
	addi.d	$t1, $a5, 1
	slt	$a5, $a7, $a5
...
# %bb.0:                                # %entry
	...
	pcalau12i	$a1, %pc_hi20(tasktab)
	addi.d	$s3, $a1, %pc_lo12(tasktab)
	st.d	$fp, $s3, 8
	st.d	$a0, $fp, 0
	ori	$a0, $zero, 1
	st.w	$a0, $fp, 8
