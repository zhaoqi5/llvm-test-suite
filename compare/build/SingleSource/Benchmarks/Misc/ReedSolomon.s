...
.LBB0_6:                                # %if.end
	...
	xvpermi.q	$xr1, $xr3, 18
	xvori.b	$xr2, $xr3, 0
	xvextrins.b	$xr2, $xr1, 0
	vpickve2gr.b	$a0, $vr0, 1
	xvreplgr2vr.b	$xr1, $a0
	xvpermi.q	$xr1, $xr2, 18
	xvextrins.b	$xr2, $xr1, 68
	vpickve2gr.b	$a0, $vr0, 2
	xvreplgr2vr.b	$xr1, $a0
	xvpermi.q	$xr1, $xr2, 18
	xvextrins.b	$xr2, $xr1, 136
	vpickve2gr.b	$a0, $vr0, 3
	xvreplgr2vr.b	$xr1, $a0
	xvpermi.q	$xr1, $xr2, 18
	xvextrins.b	$xr2, $xr1, 204
...
.LBB0_43:                               # %vector.ph125
	...
	slli.d	$fp, $t0, 2
	bstrins.d	$fp, $zero, 4, 0
	.p2align	4, , 16
.LBB0_44:                               # %vector.body126
                                        #   Parent Loop BB0_17 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	xvldx	$xr0, $a2, $t1
	xvstx	$xr0, $a3, $t1
...
.LBB0_94:
	ori	$s7, $zero, 1
.LBB0_95:                               # %for.end368.i
	beqz	$s5, .LBB0_100
.LBB0_96:                               # %for.body611.i.preheader
	move	$a0, $zero
	ori	$a1, $zero, 1020
	b	.LBB0_98
	.p2align	4, , 16
.LBB0_97:                               # %if.then615.i
