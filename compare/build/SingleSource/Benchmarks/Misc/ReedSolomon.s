...
.LBB0_38:                               # %vector.body114
	...
	xvinsgr2vr.w	$xr0, $s8, 1
	xvinsgr2vr.w	$xr0, $s6, 2
...
# %bb.39:                               # %middle.block119
	...
	beq	$a3, $t0, .LBB0_42
.LBB0_40:                               # %for.body181.i.preheader
                                        #   in Loop: Header=BB0_17 Depth=1
	sub.d	$t0, $t0, $a3
	slli.d	$a3, $a3, 2
	.p2align	4, , 16
.LBB0_41:                               # %for.body181.i
                                        #   Parent Loop BB0_17 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.w	$a7, $a2, $a3
	ldx.w	$t2, $t6, $a3
