...
# %bb.0:                                # %entry
	...
	fld.d	$fa5, $a0, %pc_lo12(D2)
	pcalau12i	$a0, %pc_hi20(D3)
	fld.d	$fa6, $a0, %pc_lo12(D3)
	pcalau12i	$a0, %pc_hi20(E2)
	fld.d	$fa7, $a0, %pc_lo12(E2)
...
.LBB0_1:                                # %for.body
	...
	fadd.d	$ft0, $fa0, $ft0
	fmul.d	$ft1, $fa1, $ft0
	fmadd.d	$ft2, $ft1, $fa6, $fa5
	fmadd.d	$ft2, $ft1, $ft2, $fa2
	fmadd.d	$ft3, $ft1, $fa4, $fa7
	fmadd.d	$ft3, $ft1, $ft3, $fa2
	fmadd.d	$ft1, $ft1, $ft3, $fa0
	fdiv.d	$ft1, $ft2, $ft1
	addi.d	$a0, $a0, -1
	fadd.d	$fa3, $fa3, $ft1
	bnez	$a0, .LBB0_1
