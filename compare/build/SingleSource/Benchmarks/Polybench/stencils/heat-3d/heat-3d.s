...
.LBB7_18:                               # %for.cond8.preheader.i
	...
	ori	$a0, $zero, 1
	bnez	$a6, .LBB7_22
# %bb.19:                               # %vector.body67.preheader
                                        #   in Loop: Header=BB7_18 Depth=3
	move	$a0, $zero
	.p2align	4, , 16
.LBB7_20:                               # %vector.body67
                                        #   Parent Loop BB7_16 Depth=1
                                        #     Parent Loop BB7_17 Depth=2
...
.LBB7_40:                               # %for.body10.i
	...
	srli.d	$t0, $a2, 48
	srli.d	$t1, $a2, 56
	bstrins.d	$a2, $s0, 63, 4
	add.d	$t2, $s2, $a0
	stx.b	$a2, $s2, $a0
	st.b	$a2, $t2, 1
	bstrins.d	$a3, $s0, 63, 4
	st.b	$a3, $t2, 2
	st.b	$a3, $t2, 3
	bstrins.d	$a4, $s0, 63, 4
	st.b	$a4, $t2, 4
	st.b	$a4, $t2, 5
	bstrins.d	$a5, $s0, 63, 4
	st.b	$a5, $t2, 6
	st.b	$a5, $t2, 7
	bstrins.d	$a6, $s0, 63, 4
	st.b	$a6, $t2, 8
	st.b	$a6, $t2, 9
	bstrins.d	$a7, $s0, 63, 4
	st.b	$a7, $t2, 10
	st.b	$a7, $t2, 11
	bstrins.d	$t0, $s0, 63, 4
	st.b	$t0, $t2, 12
	st.b	$t0, $t2, 13
	bstrins.d	$t1, $s0, 63, 4
	st.b	$t1, $t2, 14
	st.b	$t1, $t2, 15
	addi.d	$a0, $a0, 16
	addi.d	$a1, $a1, 8
