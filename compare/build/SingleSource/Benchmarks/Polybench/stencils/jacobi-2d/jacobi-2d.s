...
.LBB7_15:                               # %for.cond4.preheader.i
	...
	ori	$a4, $zero, 1
	bnez	$t8, .LBB7_19
# %bb.16:                               # %vector.body171.preheader
                                        #   in Loop: Header=BB7_15 Depth=2
	ori	$a4, $s4, 1920
	.p2align	4, , 16
.LBB7_17:                               # %vector.body171
                                        #   Parent Loop BB7_14 Depth=1
...
.LBB7_23:                               # %for.cond44.preheader.i
	...
	ori	$t3, $zero, 1
	bnez	$s2, .LBB7_27
# %bb.24:                               # %vector.body152.preheader
                                        #   in Loop: Header=BB7_23 Depth=2
	move	$t1, $a5
	.p2align	4, , 16
.LBB7_25:                               # %vector.body152
                                        #   Parent Loop BB7_14 Depth=1
...
.LBB7_35:                               # %for.body3.i42
	...
	b	.LBB7_32
	.p2align	4, , 16
.LBB7_36:                               # %vector.ph185
                                        #   in Loop: Header=BB7_33 Depth=1
	vreplgr2vr.d	$vr5, $t4
	move	$a6, $s2
	vori.b	$vr6, $vr3, 0
	.p2align	4, , 16
.LBB7_37:                               # %vector.body188
                                        #   Parent Loop BB7_33 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vaddi.du	$vr7, $vr6, 3
	vaddi.du	$vr6, $vr6, 2
...
.LBB7_40:                               # %for.cond4.preheader.i58
	...
	ori	$s8, $zero, 1
	bnez	$t1, .LBB7_44
# %bb.41:                               # %vector.body226.preheader
                                        #   in Loop: Header=BB7_40 Depth=2
	ori	$s7, $s4, 1920
	.p2align	4, , 16
.LBB7_42:                               # %vector.body226
                                        #   Parent Loop BB7_39 Depth=1
...
.LBB7_48:                               # %for.cond44.preheader.i82
	...
	ori	$s8, $zero, 1
	bnez	$a6, .LBB7_52
# %bb.49:                               # %vector.body205.preheader
                                        #   in Loop: Header=BB7_48 Depth=2
	move	$s7, $t6
	.p2align	4, , 16
.LBB7_50:                               # %vector.body205
                                        #   Parent Loop BB7_39 Depth=1
