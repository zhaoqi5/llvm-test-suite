...
.LBB7_32:                               # %for.cond39.preheader.i
	...
	ori	$a5, $a0, 1344
	bnez	$t6, .LBB7_36
# %bb.33:                               # %vector.body199.preheader
                                        #   in Loop: Header=BB7_32 Depth=2
	lu12i.w	$a6, -3
	ori	$s2, $a6, 2752
	.p2align	4, , 16
.LBB7_34:                               # %vector.body199
                                        #   Parent Loop BB7_24 Depth=1
...
# %bb.41:                               #   in Loop: Header=BB7_40 Depth=2
	...
	b	.LBB7_45
	.p2align	4, , 16
.LBB7_42:                               # %vector.body177.preheader
                                        #   in Loop: Header=BB7_40 Depth=2
	lu12i.w	$a6, -3
	ori	$s2, $a6, 2752
	.p2align	4, , 16
.LBB7_43:                               # %vector.body177
                                        #   Parent Loop BB7_24 Depth=1
...
# %bb.48:                               # %for.inc108.i
	...
	ori	$a6, $zero, 500
	bne	$t4, $a6, .LBB7_24
# %bb.49:                               # %vector.body238.preheader
...
.LBB7_55:                               # %for.body8.i88
	...
	b	.LBB7_52
	.p2align	4, , 16
.LBB7_56:                               # %vector.ph252
                                        #   in Loop: Header=BB7_53 Depth=1
	vld	$vr5, $ra, %pc_lo12(.LCPI7_1)
	vreplgr2vr.d	$vr4, $t2
	lu12i.w	$a6, -3
	ori	$s0, $a6, 2688
	.p2align	4, , 16
.LBB7_57:                               # %vector.body255
                                        #   Parent Loop BB7_53 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vaddi.du	$vr6, $vr5, 1
	vmul.d	$vr6, $vr6, $vr4
