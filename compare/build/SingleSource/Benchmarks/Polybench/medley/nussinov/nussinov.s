...
.LBB7_7:                                # %vector.body
	...
	xvpermi.q	$xr8, $xr7, 1
	vpickev.w	$vr8, $vr8, $vr7
	xvpermi.q	$xr9, $xr6, 1
	vpickev.w	$vr9, $vr9, $vr6
	xvpermi.q	$xr8, $xr9, 2
	vpickve2gr.h	$a3, $vr8, 0
	vinsgr2vr.h	$vr9, $a3, 0
	vpickve2gr.h	$a3, $vr8, 2
	vinsgr2vr.h	$vr9, $a3, 1
	vpickve2gr.h	$a3, $vr8, 4
	vinsgr2vr.h	$vr9, $a3, 2
	vpickve2gr.h	$a3, $vr8, 6
	vinsgr2vr.h	$vr9, $a3, 3
	xvpermi.d	$xr8, $xr8, 14
	vpickve2gr.h	$a3, $vr8, 0
	vinsgr2vr.h	$vr9, $a3, 4
	vpickve2gr.h	$a3, $vr8, 2
	vinsgr2vr.h	$vr9, $a3, 5
	vpickve2gr.h	$a3, $vr8, 4
	vinsgr2vr.h	$vr9, $a3, 6
	vpickve2gr.h	$a3, $vr8, 6
	vinsgr2vr.h	$vr9, $a3, 7
	xvpermi.q	$xr8, $xr5, 1
	vpickev.w	$vr8, $vr8, $vr5
	...
	xvpermi.d	$xr8, $xr8, 14
	vpickve2gr.h	$a3, $vr8, 0
	vinsgr2vr.h	$vr10, $a3, 4
	vpickve2gr.h	$a3, $vr8, 2
	vinsgr2vr.h	$vr10, $a3, 5
	vpickve2gr.h	$a3, $vr8, 4
	vinsgr2vr.h	$vr10, $a3, 6
	vpickve2gr.h	$a3, $vr8, 6
	vinsgr2vr.h	$vr10, $a3, 7
	...
	vpickve2gr.b	$a3, $vr9, 6
	vinsgr2vr.b	$vr8, $a3, 11
	vpickve2gr.b	$a3, $vr9, 8
	vinsgr2vr.b	$vr8, $a3, 12
	vpickve2gr.b	$a3, $vr9, 10
	vinsgr2vr.b	$vr8, $a3, 13
	vpickve2gr.b	$a3, $vr9, 12
	vinsgr2vr.b	$vr8, $a3, 14
	vpickve2gr.b	$a3, $vr9, 14
	vinsgr2vr.b	$vr8, $a3, 15
	xvpermi.q	$xr9, $xr3, 1
	vpickev.w	$vr10, $vr9, $vr3
	xvpermi.q	$xr9, $xr2, 1
	vpickev.w	$vr9, $vr9, $vr2
	...
	vpickve2gr.h	$a3, $vr10, 6
	vinsgr2vr.h	$vr9, $a3, 7
	xvpermi.q	$xr10, $xr1, 1
	vpickev.w	$vr10, $vr10, $vr1
	xvpermi.q	$xr11, $xr0, 1
	vpickev.w	$vr11, $vr11, $vr0
	...
	vpickve2gr.b	$a3, $vr9, 6
	vinsgr2vr.b	$vr10, $a3, 3
	vpickve2gr.b	$a3, $vr9, 8
	vinsgr2vr.b	$vr10, $a3, 4
	vpickve2gr.b	$a3, $vr9, 10
	vinsgr2vr.b	$vr10, $a3, 5
	vpickve2gr.b	$a3, $vr9, 12
	vinsgr2vr.b	$vr10, $a3, 6
	vpickve2gr.b	$a3, $vr9, 14
	vinsgr2vr.b	$vr10, $a3, 7
	xvpermi.d	$xr9, $xr9, 14
	vpickve2gr.b	$a3, $vr9, 0
	vinsgr2vr.b	$vr10, $a3, 8
	vpickve2gr.b	$a3, $vr9, 2
	vinsgr2vr.b	$vr10, $a3, 9
	vpickve2gr.b	$a3, $vr9, 4
	vinsgr2vr.b	$vr10, $a3, 10
	vpickve2gr.b	$a3, $vr9, 6
	vinsgr2vr.b	$vr10, $a3, 11
	vpickve2gr.b	$a3, $vr9, 8
	vinsgr2vr.b	$vr10, $a3, 12
	vpickve2gr.b	$a3, $vr9, 10
	vinsgr2vr.b	$vr10, $a3, 13
	vpickve2gr.b	$a3, $vr9, 12
	vinsgr2vr.b	$vr10, $a3, 14
	vpickve2gr.b	$a3, $vr9, 14
	vinsgr2vr.b	$vr10, $a3, 15
	xvpermi.q	$xr8, $xr10, 2
	xvaddi.bu	$xr8, $xr8, 1
	xvandi.b	$xr8, $xr8, 3
	add.d	$a3, $fp, $a0
	...
	xvadd.d	$xr1, $xr1, $xr12
	addi.d	$a0, $a0, 64
	xvadd.d	$xr0, $xr0, $xr12
	bnez	$a0, .LBB7_7
# %bb.8:                                # %vec.epilog.vector.body
	xvst	$xr12, $sp, 80                  # 32-byte Folded Spill
	lu12i.w	$a0, 48
	ori	$s8, $a0, 513
	stptr.w	$s8, $fp, 2496
	move	$a0, $s0
