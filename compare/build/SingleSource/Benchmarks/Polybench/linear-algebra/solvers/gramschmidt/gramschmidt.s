...
.LBB7_12:                               # %vector.body
	...
	vinsgr2vr.w	$vr13, $t4, 0
	xvpickve2gr.d	$t4, $xr12, 1
	vinsgr2vr.w	$vr13, $t4, 1
...
.LBB7_21:                               # %call.sqrt
	...
	bnez	$t7, .LBB7_19
	.p2align	4, , 16
.LBB7_22:                               # %vector.body66.preheader
                                        #   in Loop: Header=BB7_15 Depth=1
	xvldrepl.d	$xr0, $a0, 0
	ori	$a0, $s7, 2816
	ori	$a1, $zero, 1000
	.p2align	4, , 16
.LBB7_23:                               # %vector.body66
                                        #   Parent Loop BB7_15 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	add.d	$a2, $fp, $a0
	fldx.d	$fa1, $a2, $s1
...
.LBB7_31:                               # %for.body62.i
	...
	b	.LBB7_26
	.p2align	4, , 16
.LBB7_32:                               # %vector.body47.preheader
                                        #   in Loop: Header=BB7_27 Depth=2
	xvldrepl.d	$xr0, $a4, 0
	move	$a4, $zero
	ori	$a5, $zero, 1000
	.p2align	4, , 16
.LBB7_33:                               # %vector.body47
                                        #   Parent Loop BB7_15 Depth=1
                                        #     Parent Loop BB7_27 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	add.d	$a6, $a1, $a4
