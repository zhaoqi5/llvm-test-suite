...
# %bb.18:                               # %middle.block
                                        #   in Loop: Header=BB7_6 Depth=1
	beq	$t8, $s4, .LBB7_5
.LBB7_19:                               # %for.body15.i.preheader166
                                        #   in Loop: Header=BB7_6 Depth=1
	addi.d	$t8, $s2, -2000
	slli.d	$s2, $s2, 3
	.p2align	4, , 16
...
.LBB7_29:                               # %for.body67.i
	...
	b	.LBB7_26
	.p2align	4, , 16
.LBB7_30:                               # %vector.body138.preheader
                                        #   in Loop: Header=BB7_27 Depth=2
	vldrepl.d	$vr0, $t7, 0
	move	$t7, $a3
	move	$t8, $a6
	.p2align	4, , 16
.LBB7_31:                               # %vector.body138
                                        #   Parent Loop BB7_25 Depth=1
                                        #     Parent Loop BB7_27 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	fldx.d	$fa1, $t7, $t0
...
.LBB7_52:                               # %for.cond1.preheader.i29
	...
	mul.d	$s1, $s6, $s3
	beqz	$s6, .LBB7_63
# %bb.53:                               # %for.cond4.preheader.lr.ph.i32
	...
	b	.LBB7_56
	.p2align	4, , 16
.LBB7_54:                               # %for.cond4.preheader.for.end_crit_edge.i65
...
.LBB7_55:                               # %for.end.i48
	...
	add.d	$a2, $a2, $s3
	beq	$a1, $s6, .LBB7_59
.LBB7_56:                               # %for.cond4.preheader.i34
                                        #   Parent Loop BB7_52 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB7_58 Depth 3
	slli.d	$a3, $a1, 3
	beqz	$a1, .LBB7_54
# %bb.57:                               # %for.body6.lr.ph.i37
                                        #   in Loop: Header=BB7_56 Depth=2
	fldx.d	$fa0, $a0, $a3
	alsl.d	$a4, $a1, $a0, 3
	move	$a5, $s8
...
.LBB7_63:                               # %for.cond28.preheader.for.end47_crit_edge.i
	...
	fcmp.cor.d	$fcc0, $fa1, $fa1
	bcnez	$fcc0, .LBB7_62
.LBB7_64:                               # %call.sqrt347
                                        #   in Loop: Header=BB7_52 Depth=1
	pcaddu18i	$ra, %call36(sqrt)
	jirl	$ra, $ra, 0
	fmov.d	$fa1, $fa0
	b	.LBB7_62
.LBB7_65:                               # %for.cond1.preheader.i68.preheader
	...
	ori	$a4, $zero, 2000
	.p2align	4, , 16
.LBB7_66:                               # %for.cond1.preheader.i68
                                        # =>This Loop Header: Depth=1
