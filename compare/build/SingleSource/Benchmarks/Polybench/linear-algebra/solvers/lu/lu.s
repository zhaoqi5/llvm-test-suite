...
.LBB7_19:                               # %for.cond1.preheader.i20
	...
	beqz	$a1, .LBB7_18
# %bb.20:                               # %for.cond4.preheader.lr.ph.i23
                                        #   in Loop: Header=BB7_19 Depth=1
	move	$a6, $zero
	mul.d	$a5, $a1, $s2
	add.d	$a5, $s0, $a5
	...
	b	.LBB7_23
	.p2align	4, , 16
.LBB7_21:                               # %for.cond4.preheader.for.end_crit_edge.i60
...
.LBB7_22:                               # %for.end.i38
	...
	addi.d	$a7, $a7, 8
	beq	$a6, $a1, .LBB7_26
.LBB7_23:                               # %for.cond4.preheader.i25
                                        #   Parent Loop BB7_19 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB7_25 Depth 3
	slli.d	$t0, $a6, 3
	beqz	$a6, .LBB7_21
# %bb.24:                               # %for.body6.lr.ph.i28
                                        #   in Loop: Header=BB7_23 Depth=2
	fldx.d	$fa0, $a5, $t0
	alsl.d	$t1, $a6, $a5, 3
	move	$t2, $a4
...
.LBB7_26:                               #   in Loop: Header=BB7_19 Depth=1
	...
	move	$a7, $a1
	.p2align	4, , 16
.LBB7_27:                               # %for.cond31.preheader.us.i47
                                        #   Parent Loop BB7_19 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB7_28 Depth 3
	slli.d	$t0, $a7, 3
...
# %bb.29:                               # %for.cond31.for.inc51_crit_edge.us.i
	...
	bne	$a7, $a2, .LBB7_27
	b	.LBB7_18
.LBB7_30:                               # %for.cond1.preheader.i62.preheader
	move	$a0, $zero
	move	$a2, $zero
...
.LBB8_19:                               # %for.body55
	...
	b	.LBB8_16
	.p2align	4, , 16
.LBB8_20:                               # %vector.body9.preheader
                                        #   in Loop: Header=BB8_17 Depth=2
	vldrepl.d	$vr0, $t7, 0
	move	$t7, $a3
	move	$t8, $a6
	.p2align	4, , 16
.LBB8_21:                               # %vector.body9
                                        #   Parent Loop BB8_15 Depth=1
                                        #     Parent Loop BB8_17 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	fldx.d	$fa1, $t7, $t0
