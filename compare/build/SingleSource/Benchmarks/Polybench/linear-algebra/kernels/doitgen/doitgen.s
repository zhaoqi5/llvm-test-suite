...
# %bb.2:                                # %for.cond1.preheader.us.preheader
	...
	b	.LBB7_4
	.p2align	4, , 16
.LBB7_3:                                # %for.cond1.for.inc42_crit_edge.us
...
# %bb.5:                                # %for.cond4.preheader.us.us.preheader
	...
	b	.LBB7_7
	.p2align	4, , 16
.LBB7_6:                                # %for.inc39.us.us
                                        #   in Loop: Header=BB7_7 Depth=2
	addi.d	$t7, $t7, 1
	addi.d	$fp, $fp, 1280
	beq	$t7, $a1, .LBB7_3
.LBB7_7:                                # %for.cond4.preheader.us.us
...
.LBB7_9:                                # %for.body9.us.us.us
	...
	addi.d	$s5, $s5, 1280
	bnez	$s4, .LBB7_9
# %bb.10:                               # %for.cond7.for.inc22_crit_edge.us.us.us
                                        #   in Loop: Header=BB7_8 Depth=3
	addi.d	$s1, $s1, 1
	addi.d	$s2, $s2, 8
	bne	$s1, $a7, .LBB7_8
# %bb.11:                               # %for.body27.us.us.preheader
                                        #   in Loop: Header=BB7_7 Depth=2
	move	$s1, $zero
	bltu	$a2, $t5, .LBB7_16
# %bb.12:                               # %for.body27.us.us.preheader
                                        #   in Loop: Header=BB7_7 Depth=2
	bltu	$s0, $t6, .LBB7_16
...
# %bb.15:                               # %middle.block
	...
	move	$s1, $t1
	beq	$t1, $a7, .LBB7_6
.LBB7_16:                               # %for.body27.us.us.preheader80
                                        #   in Loop: Header=BB7_7 Depth=2
	slli.d	$s0, $s1, 3
	sub.d	$s1, $a7, $s1
	.p2align	4, , 16
.LBB7_17:                               # %for.body27.us.us
                                        #   Parent Loop BB7_4 Depth=1
                                        #     Parent Loop BB7_7 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	fldx.d	$fa1, $a5, $s0
...
# %bb.2:                                # %for.cond1.preheader.us.preheader
	...
	b	.LBB8_4
	.p2align	4, , 16
.LBB8_3:                                # %for.cond1.for.inc42_crit_edge.us
...
# %bb.5:                                # %for.cond4.preheader.us.us.preheader
	...
	b	.LBB8_7
	.p2align	4, , 16
.LBB8_6:                                # %for.inc39.us.us
                                        #   in Loop: Header=BB8_7 Depth=2
	addi.d	$t7, $t7, 1
	addi.d	$fp, $fp, 1280
	beq	$t7, $a1, .LBB8_3
.LBB8_7:                                # %for.cond4.preheader.us.us
...
# %bb.15:                               # %middle.block
	...
	move	$s1, $t1
	beq	$t1, $a7, .LBB8_6
.LBB8_16:                               # %for.body27.us.us.preheader80
                                        #   in Loop: Header=BB8_7 Depth=2
	slli.d	$s0, $s1, 3
	sub.d	$s1, $a7, $s1
	.p2align	4, , 16
.LBB8_17:                               # %for.body27.us.us
                                        #   Parent Loop BB8_4 Depth=1
                                        #     Parent Loop BB8_7 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	fldx.d	$fa1, $a5, $s0
...
# %bb.20:                               # %for.inc44.i
	...
	addi.d	$a3, $a3, 1280
	bne	$a1, $a2, .LBB9_18
# %bb.21:                               # %for.cond1.preheader.us.i.preheader
	move	$a0, $zero
	sub.d	$a1, $fp, $s1
	movgr2fr.d	$fa0, $zero
	ori	$a2, $zero, 1280
	...
	b	.LBB9_23
	.p2align	4, , 16
.LBB9_22:                               # %for.cond1.for.inc42_crit_edge.us.i
                                        #   in Loop: Header=BB9_23 Depth=1
	addi.d	$a0, $a0, 1
	add.d	$a7, $a7, $s4
	beq	$a0, $a6, .LBB9_33
.LBB9_23:                               # %for.cond1.preheader.us.i
                                        # =>This Loop Header: Depth=1
...
.LBB9_24:                               # %vector.body137
	...
	xvst	$xr1, $t4, 1216
	xvst	$xr2, $t4, 1248
.LBB9_25:                               # %for.inc39.us.us.i
                                        #   in Loop: Header=BB9_26 Depth=2
	addi.d	$t0, $t0, 1
	addi.d	$t3, $t3, 1280
	beq	$t0, $a5, .LBB9_22
.LBB9_26:                               # %for.cond4.preheader.us.us.i
...
.LBB9_28:                               # %for.body9.us.us.us.i
	...
	addi.d	$s5, $s5, 1280
	bne	$t8, $a2, .LBB9_28
# %bb.29:                               # %for.cond7.for.inc22_crit_edge.us.us.us.i
...
# %bb.30:                               # %vector.memcheck133
                                        #   in Loop: Header=BB9_26 Depth=2
	bltu	$a4, $t6, .LBB9_24
# %bb.31:                               # %for.body27.us.us.i.preheader
                                        #   in Loop: Header=BB9_26 Depth=2
	move	$t4, $zero
	.p2align	4, , 16
.LBB9_32:                               # %for.body27.us.us.i
                                        #   Parent Loop BB9_23 Depth=1
                                        #     Parent Loop BB9_26 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	fldx.d	$fa1, $s1, $t4
	...
	bne	$t4, $a2, .LBB9_32
	b	.LBB9_25
.LBB9_33:                               # %for.cond1.preheader.us.i49.preheader
	move	$a0, $zero
	sub.d	$a1, $s0, $s1
	movgr2fr.d	$fa0, $zero
	ori	$a2, $zero, 1280
	...
	b	.LBB9_35
	.p2align	4, , 16
.LBB9_34:                               # %for.cond1.for.inc42_crit_edge.us.i77
                                        #   in Loop: Header=BB9_35 Depth=1
	addi.d	$a0, $a0, 1
	add.d	$a7, $a7, $s4
	beq	$a0, $a6, .LBB9_45
.LBB9_35:                               # %for.cond1.preheader.us.i49
                                        # =>This Loop Header: Depth=1
...
.LBB9_36:                               # %vector.body147
	...
	xvst	$xr1, $t4, 1216
	xvst	$xr2, $t4, 1248
.LBB9_37:                               # %for.inc39.us.us.i74
                                        #   in Loop: Header=BB9_38 Depth=2
	addi.d	$t0, $t0, 1
	addi.d	$t3, $t3, 1280
	beq	$t0, $a5, .LBB9_34
.LBB9_38:                               # %for.cond4.preheader.us.us.i52
	...
	move	$t7, $s2
	.p2align	4, , 16
.LBB9_39:                               # %for.body6.us.us.us.i55
                                        #   Parent Loop BB9_35 Depth=1
	...
	fmov.d	$fa1, $fa0
	.p2align	4, , 16
.LBB9_40:                               # %for.body9.us.us.us.i59
                                        #   Parent Loop BB9_35 Depth=1
                                        #     Parent Loop BB9_38 Depth=2
	...
	addi.d	$s5, $s5, 1280
	bne	$t8, $a2, .LBB9_40
# %bb.41:                               # %for.cond7.for.inc22_crit_edge.us.us.us.i65
                                        #   in Loop: Header=BB9_39 Depth=3
	addi.d	$t5, $t5, 1
	addi.d	$t7, $t7, 8
	bne	$t5, $a3, .LBB9_39
# %bb.42:                               # %vector.memcheck143
                                        #   in Loop: Header=BB9_38 Depth=2
	bltu	$a4, $t6, .LBB9_36
# %bb.43:                               # %for.body27.us.us.i68.preheader
                                        #   in Loop: Header=BB9_38 Depth=2
	move	$t4, $zero
	.p2align	4, , 16
.LBB9_44:                               # %for.body27.us.us.i68
                                        #   Parent Loop BB9_35 Depth=1
                                        #     Parent Loop BB9_38 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	fldx.d	$fa1, $s1, $t4
