...
.LBB7_26:                               # %for.body3.i
	...
	b	.LBB7_23
	.p2align	4, , 16
.LBB7_27:                               # %vector.ph106
                                        #   in Loop: Header=BB7_24 Depth=1
	xvldrepl.d	$xr0, $t2, 0
	xvldrepl.d	$xr1, $t1, 0
	move	$t1, $a5
	.p2align	4, , 16
.LBB7_28:                               # %vector.body107
                                        #   Parent Loop BB7_24 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	add.d	$t2, $a4, $t1
	add.d	$t3, $s2, $t1
...
# %bb.32:                               # %for.inc45.i
	...
	addi.d	$a5, $a5, 8
	bne	$a2, $a4, .LBB7_30
# %bb.33:                               # %vector.memcheck120
	add.d	$a2, $s8, $s1
	bgeu	$s6, $a2, .LBB7_37
# %bb.34:                               # %vector.memcheck120
	add.d	$a2, $s6, $s1
	bgeu	$s8, $a2, .LBB7_37
...
.LBB7_36:                               # %for.body50.i
	...
	bnez	$a1, .LBB7_36
	b	.LBB7_39
.LBB7_37:                               # %vector.body128.preheader
	ori	$a2, $a0, 384
	.p2align	4, , 16
.LBB7_38:                               # %vector.body128
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a3, $s6, $a2
	xvldx	$xr0, $a3, $s1
	xvldx	$xr1, $a3, $a1
