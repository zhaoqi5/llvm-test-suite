...
.LBB5_11:                               # %vector.ph65
	...
	b	.LBB5_13
	.p2align	4, , 16
.LBB5_12:                               # %pred.store.continue89
                                        #   in Loop: Header=BB5_13 Depth=2
	xvaddi.du	$xr1, $xr1, 8
	addi.d	$a4, $a4, 32
	xvaddi.du	$xr0, $xr0, 8
	beq	$a5, $a4, .LBB5_29
.LBB5_13:                               # %vector.body70
                                        #   Parent Loop BB5_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	xvldx	$xr2, $s5, $a4
	xvseqi.w	$xr2, $xr2, 0
	...
	xvadd.d	$xr3, $xr1, $xr4
	bnez	$a6, .LBB5_21
# %bb.14:                               # %pred.store.continue75
                                        #   in Loop: Header=BB5_13 Depth=2
	xvpickve2gr.w	$a6, $xr2, 1
	andi	$a6, $a6, 1
	bnez	$a6, .LBB5_22
.LBB5_15:                               # %pred.store.continue77
                                        #   in Loop: Header=BB5_13 Depth=2
	xvpickve2gr.w	$a6, $xr2, 2
	andi	$a6, $a6, 1
	bnez	$a6, .LBB5_23
.LBB5_16:                               # %pred.store.continue79
                                        #   in Loop: Header=BB5_13 Depth=2
	xvpickve2gr.w	$a6, $xr2, 3
	andi	$a6, $a6, 1
	bnez	$a6, .LBB5_24
.LBB5_17:                               # %pred.store.continue81
                                        #   in Loop: Header=BB5_13 Depth=2
	xvpickve2gr.w	$a6, $xr2, 4
	andi	$a6, $a6, 1
	xvadd.d	$xr3, $xr0, $xr4
	bnez	$a6, .LBB5_25
.LBB5_18:                               # %pred.store.continue83
                                        #   in Loop: Header=BB5_13 Depth=2
	xvpickve2gr.w	$a6, $xr2, 5
	andi	$a6, $a6, 1
	bnez	$a6, .LBB5_26
.LBB5_19:                               # %pred.store.continue85
                                        #   in Loop: Header=BB5_13 Depth=2
	xvpickve2gr.w	$a6, $xr2, 6
	andi	$a6, $a6, 1
	bnez	$a6, .LBB5_27
.LBB5_20:                               # %pred.store.continue87
                                        #   in Loop: Header=BB5_13 Depth=2
...
# %bb.39:                               #   in Loop: Header=BB5_3 Depth=1
	move	$a1, $zero
	b	.LBB5_63
.LBB5_40:                               # %for.body.i14.preheader95
                                        #   in Loop: Header=BB5_3 Depth=1
	sub.d	$a2, $a2, $a3
	slli.d	$a3, $a3, 2
	b	.LBB5_42
...
# %bb.47:                               # %pred.store.continue
	...
	andi	$a4, $a4, 1
	bnez	$a4, .LBB5_55
.LBB5_48:                               # %pred.store.continue50
                                        #   in Loop: Header=BB5_46 Depth=2
	xvpickve2gr.w	$a4, $xr2, 2
	andi	$a4, $a4, 1
	bnez	$a4, .LBB5_56
.LBB5_49:                               # %pred.store.continue52
                                        #   in Loop: Header=BB5_46 Depth=2
	xvpickve2gr.w	$a4, $xr2, 3
	andi	$a4, $a4, 1
	bnez	$a4, .LBB5_57
.LBB5_50:                               # %pred.store.continue54
                                        #   in Loop: Header=BB5_46 Depth=2
	xvpickve2gr.w	$a4, $xr2, 4
	andi	$a4, $a4, 1
	xvadd.d	$xr3, $xr0, $xr4
	bnez	$a4, .LBB5_58
.LBB5_51:                               # %pred.store.continue56
                                        #   in Loop: Header=BB5_46 Depth=2
	xvpickve2gr.w	$a4, $xr2, 5
	andi	$a4, $a4, 1
	bnez	$a4, .LBB5_59
.LBB5_52:                               # %pred.store.continue58
                                        #   in Loop: Header=BB5_46 Depth=2
	xvpickve2gr.w	$a4, $xr2, 6
	andi	$a4, $a4, 1
	bnez	$a4, .LBB5_60
.LBB5_53:                               # %pred.store.continue60
                                        #   in Loop: Header=BB5_46 Depth=2
