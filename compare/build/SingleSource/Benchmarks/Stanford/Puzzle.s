...
.LBB3_7:                                # %pred.store.continue
	...
	andi	$t3, $t3, 1
	bnez	$t3, .LBB3_14
# %bb.8:                                # %pred.store.continue26
                                        #   in Loop: Header=BB3_5 Depth=1
	vpickve2gr.h	$t3, $vr2, 2
	andi	$t3, $t3, 1
	bnez	$t3, .LBB3_15
.LBB3_9:                                # %pred.store.continue28
                                        #   in Loop: Header=BB3_5 Depth=1
	vpickve2gr.h	$t3, $vr2, 3
	andi	$t3, $t3, 1
	bnez	$t3, .LBB3_16
.LBB3_10:                               # %pred.store.continue30
                                        #   in Loop: Header=BB3_5 Depth=1
	vpickve2gr.h	$t3, $vr2, 4
	andi	$t3, $t3, 1
	bnez	$t3, .LBB3_17
.LBB3_11:                               # %pred.store.continue32
                                        #   in Loop: Header=BB3_5 Depth=1
	vpickve2gr.h	$t3, $vr2, 5
	andi	$t3, $t3, 1
	bnez	$t3, .LBB3_18
.LBB3_12:                               # %pred.store.continue34
                                        #   in Loop: Header=BB3_5 Depth=1
	vpickve2gr.h	$t3, $vr2, 6
	andi	$t3, $t3, 1
	bnez	$t3, .LBB3_19
.LBB3_13:                               # %pred.store.continue36
                                        #   in Loop: Header=BB3_5 Depth=1
...
.LBB4_7:                                # %pred.store.continue
	...
	andi	$t2, $t2, 1
	bnez	$t2, .LBB4_14
# %bb.8:                                # %pred.store.continue11
                                        #   in Loop: Header=BB4_5 Depth=1
	vpickve2gr.h	$t2, $vr2, 2
	andi	$t2, $t2, 1
	bnez	$t2, .LBB4_15
.LBB4_9:                                # %pred.store.continue13
                                        #   in Loop: Header=BB4_5 Depth=1
	vpickve2gr.h	$t2, $vr2, 3
	andi	$t2, $t2, 1
	bnez	$t2, .LBB4_16
.LBB4_10:                               # %pred.store.continue15
                                        #   in Loop: Header=BB4_5 Depth=1
	vpickve2gr.h	$t2, $vr2, 4
	andi	$t2, $t2, 1
	bnez	$t2, .LBB4_17
.LBB4_11:                               # %pred.store.continue17
                                        #   in Loop: Header=BB4_5 Depth=1
	vpickve2gr.h	$t2, $vr2, 5
	andi	$t2, $t2, 1
	bnez	$t2, .LBB4_18
.LBB4_12:                               # %pred.store.continue19
                                        #   in Loop: Header=BB4_5 Depth=1
	vpickve2gr.h	$t2, $vr2, 6
	andi	$t2, $t2, 1
	bnez	$t2, .LBB4_19
.LBB4_13:                               # %pred.store.continue21
                                        #   in Loop: Header=BB4_5 Depth=1
...
.LBB5_13:                               # %vector.body72
	...
	andi	$a6, $a6, 1
	beqz	$a6, .LBB5_15
# %bb.14:                               # %pred.store.if75
                                        #   in Loop: Header=BB5_13 Depth=2
	add.d	$a6, $s2, $a4
	st.w	$fp, $a6, -16
.LBB5_15:                               # %pred.store.continue76
                                        #   in Loop: Header=BB5_13 Depth=2
	xvxor.v	$xr0, $xr0, $xr3
	...
	andi	$a6, $a6, 1
	bnez	$a6, .LBB5_22
# %bb.16:                               # %pred.store.continue78
                                        #   in Loop: Header=BB5_13 Depth=2
	vpickve2gr.h	$a6, $vr0, 2
	andi	$a6, $a6, 1
	bnez	$a6, .LBB5_23
.LBB5_17:                               # %pred.store.continue80
                                        #   in Loop: Header=BB5_13 Depth=2
	vpickve2gr.h	$a6, $vr0, 3
	andi	$a6, $a6, 1
	bnez	$a6, .LBB5_24
.LBB5_18:                               # %pred.store.continue82
                                        #   in Loop: Header=BB5_13 Depth=2
	vpickve2gr.h	$a6, $vr0, 4
	andi	$a6, $a6, 1
	bnez	$a6, .LBB5_25
.LBB5_19:                               # %pred.store.continue84
                                        #   in Loop: Header=BB5_13 Depth=2
	vpickve2gr.h	$a6, $vr0, 5
	andi	$a6, $a6, 1
	bnez	$a6, .LBB5_26
.LBB5_20:                               # %pred.store.continue86
                                        #   in Loop: Header=BB5_13 Depth=2
	vpickve2gr.h	$a6, $vr0, 6
	andi	$a6, $a6, 1
	bnez	$a6, .LBB5_27
.LBB5_21:                               # %pred.store.continue88
                                        #   in Loop: Header=BB5_13 Depth=2
...
.LBB5_24:                               # %pred.store.if81
	...
	andi	$a6, $a6, 1
	beqz	$a6, .LBB5_19
.LBB5_25:                               # %pred.store.if83
                                        #   in Loop: Header=BB5_13 Depth=2
	stx.w	$fp, $s2, $a4
	vpickve2gr.h	$a6, $vr0, 5
	andi	$a6, $a6, 1
	beqz	$a6, .LBB5_20
.LBB5_26:                               # %pred.store.if85
                                        #   in Loop: Header=BB5_13 Depth=2
	add.d	$a6, $s2, $a4
	st.w	$fp, $a6, 4
	vpickve2gr.h	$a6, $vr0, 6
...
.LBB5_27:                               # %pred.store.if87
	...
	andi	$a6, $a6, 1
	beqz	$a6, .LBB5_12
.LBB5_28:                               # %pred.store.if89
                                        #   in Loop: Header=BB5_13 Depth=2
	add.d	$a6, $s2, $a4
	st.w	$fp, $a6, 12
	b	.LBB5_12
.LBB5_29:                               # %middle.block92
                                        #   in Loop: Header=BB5_3 Depth=1
	bne	$a3, $a2, .LBB5_40
	.p2align	4, , 16
.LBB5_30:                               # %for.end.i
...
# %bb.39:                               #   in Loop: Header=BB5_3 Depth=1
	move	$a1, $zero
	b	.LBB5_63
.LBB5_40:                               # %for.body.i15.preheader95
                                        #   in Loop: Header=BB5_3 Depth=1
	sub.d	$a2, $a2, $a3
	slli.d	$a3, $a3, 2
	b	.LBB5_42
...
.LBB5_57:                               # %pred.store.if57
	...
	andi	$a4, $a4, 1
	beqz	$a4, .LBB5_52
.LBB5_58:                               # %pred.store.if59
                                        #   in Loop: Header=BB5_46 Depth=2
	stx.w	$zero, $s2, $a2
	vpickve2gr.h	$a4, $vr0, 5
	andi	$a4, $a4, 1
	beqz	$a4, .LBB5_53
.LBB5_59:                               # %pred.store.if61
                                        #   in Loop: Header=BB5_46 Depth=2
	add.d	$a4, $s2, $a2
	st.w	$zero, $a4, 4
	vpickve2gr.h	$a4, $vr0, 6
...
# %bb.0:                                # %entry
	...
	xvld	$xr1, $a3, %pc_lo12(.LCPI6_1)
	xvst	$xr0, $a2, 0
	pcalau12i	$a3, %pc_hi20(piecemax)
	addi.d	$a3, $a3, %pc_lo12(piecemax)
	xvst	$xr1, $a3, 0
	pcalau12i	$a4, %pc_hi20(.LCPI6_2)
	vld	$vr0, $a4, %pc_lo12(.LCPI6_2)
	stptr.w	$a0, $s2, 16384
	stptr.w	$a0, $s2, 16640
	stptr.w	$a0, $s2, 16896
	stptr.d	$a1, $s2, 18432
