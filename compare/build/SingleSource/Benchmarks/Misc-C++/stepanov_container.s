...
# %bb.26:                               # %if.then.i22.i.i
	...
	addi.d	$a6, $a3, 512
	b	.LBB5_29
.LBB5_27:                               # %if.then11.i.i
                                        #   in Loop: Header=BB5_29 Depth=1
	addi.d	$a1, $a1, 8
	beq	$a1, $a4, .LBB5_33
.LBB5_28:                               # %_ZNSt15_Deque_iteratorIdRdPdEppEv.exit59.i.i
                                        #   in Loop: Header=BB5_29 Depth=1
	fst.d	$fa1, $a1, 0
	fmov.d	$fa0, $fa1
	.p2align	4, , 16
.LBB5_29:                               # %while.cond.i.i
                                        # =>This Inner Loop Header: Depth=1
	addi.d	$a3, $a3, 8
	bne	$a3, $a6, .LBB5_31
# %bb.30:                               # %if.then.i30.i.i
                                        #   in Loop: Header=BB5_29 Depth=1
	ld.d	$a3, $a5, 8
	addi.d	$a5, $a5, 8
	addi.d	$a6, $a3, 512
.LBB5_31:                               # %_ZNSt15_Deque_iteratorIdRdPdEppEv.exit35.i.i
                                        #   in Loop: Header=BB5_29 Depth=1
	beq	$a3, $a0, .LBB5_34
# %bb.32:                               # %while.body.i.i54
                                        #   in Loop: Header=BB5_29 Depth=1
	fld.d	$fa1, $a3, 0
	fcmp.ceq.d	$fcc0, $fa0, $fa1
	bcnez	$fcc0, .LBB5_29
	b	.LBB5_27
.LBB5_33:                               # %if.then.i54.i.i
                                        #   in Loop: Header=BB5_29 Depth=1
	ld.d	$a1, $a2, 8
	addi.d	$a2, $a2, 8
	addi.d	$a4, $a1, 512
...
# %bb.35:                               # %if.then.i.i56
	addi.d	$a1, $s0, 8
	bgeu	$s3, $a1, .LBB5_39
# %bb.36:                               # %for.body.i.i.i.preheader
	addi.d	$a1, $s3, -8
	.p2align	4, , 16
.LBB5_37:                               # %for.body.i.i.i
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $a1, 8
	addi.d	$fp, $a1, 8
	ori	$a1, $zero, 512
