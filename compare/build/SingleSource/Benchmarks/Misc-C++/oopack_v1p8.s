...
.LBB2_1:                                # %vector.body
	...
	vneg.w	$vr6, $vr0
	vsub.w	$vr7, $vr2, $vr0
	vbitsel.v	$vr6, $vr6, $vr3, $vr5
	vbitsel.v	$vr4, $vr7, $vr4, $vr5
...
# %bb.1:                                # %for.body.preheader
	...
	addi.d	$s1, $a0, %pc_lo12(_ZN9Benchmark4listE)
	move	$s2, $zero
	.p2align	4, , 16
.LBB17_2:                               # %for.body
                                        # =>This Inner Loop Header: Depth=1
...
# %bb.0:                                # %entry
	...
	st.h	$a1, $sp, 112
	st.d	$a0, $sp, 104
	pcalau12i	$a0, %pc_hi20(.L__const.main.str3)
	addi.d	$a0, $a0, %pc_lo12(.L__const.main.str3)
	ld.w	$a1, $a0, 7
	ld.d	$a0, $a0, 0
	st.w	$a1, $sp, 95
	st.d	$a0, $sp, 88
	...
	st.d	$a1, $sp, 77
	st.d	$a0, $sp, 72
	pcalau12i	$a0, %pc_hi20(.L__const.main.str5)
	addi.d	$a0, $a0, %pc_lo12(.L__const.main.str5)
	ld.d	$a1, $a0, 7
	ld.d	$a0, $a0, 0
	st.d	$a1, $sp, 63
	st.d	$a0, $sp, 56
