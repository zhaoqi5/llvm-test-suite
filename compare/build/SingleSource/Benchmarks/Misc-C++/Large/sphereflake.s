...
.LBB0_17:                               #   in Loop: Header=BB0_19 Depth=3
	movgr2fr.d	$ft4, $zero
.LBB0_18:                               # %_ZL9ray_tracePK6node_tRK5ray_t.exit.us.i
                                        #   in Loop: Header=BB0_19 Depth=3
	addi.d	$a0, $a0, 1
	fadd.d	$fa3, $fa3, $ft4
	beq	$a0, $s8, .LBB0_13
.LBB0_19:                               # %for.body24.us.i
                                        #   Parent Loop BB0_12 Depth=1
	...
	fmov.d	$ft1, $fs4
	bnez	$a1, .LBB0_23
# %bb.20:                               # %while.body.i.i.us.i.preheader
                                        #   in Loop: Header=BB0_19 Depth=3
	addi.w	$a1, $zero, -99
	vldi	$vr9, -912
	.p2align	4, , 16
.LBB0_21:                               # %while.body.i.i.us.i
                                        #   Parent Loop BB0_12 Depth=1
                                        #     Parent Loop BB0_15 Depth=2
	...
	bcnez	$fcc0, .LBB0_23
# %bb.22:                               # %while.body.i.i.us.i
                                        #   in Loop: Header=BB0_21 Depth=4
	move	$a2, $a1
	addi.w	$a1, $a1, 1
	bnez	$a2, .LBB0_21
	.p2align	4, , 16
.LBB0_23:                               # %_ZNK3v_t4normEv.exit.us.i
                                        #   in Loop: Header=BB0_19 Depth=3
	frecip.d	$ft0, $ft1
	fmul.d	$fa5, $fa5, $ft0
	fmul.d	$fa6, $fa6, $ft0
	...
	b	.LBB0_25
	.p2align	4, , 16
.LBB0_24:                               # %if.end.i103.us.i
                                        #   in Loop: Header=BB0_25 Depth=4
	addi.d	$a1, $a1, 72
	bgeu	$a1, $s3, .LBB0_40
.LBB0_25:                               # %while.body.i51.us.i
                                        #   Parent Loop BB0_12 Depth=1
                                        #     Parent Loop BB0_15 Depth=2
                                        #       Parent Loop BB0_19 Depth=3
...
# %bb.26:                               # %if.end.i.i73.us.i
	...
	fmov.d	$ft8, $ft6
	bnez	$a2, .LBB0_30
# %bb.27:                               # %while.body.i.i.i75.us.i.preheader
                                        #   in Loop: Header=BB0_25 Depth=4
	addi.w	$a2, $zero, -99
	vldi	$vr16, -912
	.p2align	4, , 16
.LBB0_28:                               # %while.body.i.i.i75.us.i
                                        #   Parent Loop BB0_12 Depth=1
                                        #     Parent Loop BB0_15 Depth=2
                                        #       Parent Loop BB0_19 Depth=3
	...
	bcnez	$fcc0, .LBB0_30
# %bb.29:                               # %while.body.i.i.i75.us.i
                                        #   in Loop: Header=BB0_28 Depth=5
	move	$a3, $a2
	addi.w	$a2, $a2, 1
	bnez	$a3, .LBB0_28
	.p2align	4, , 16
.LBB0_30:                               # %_ZL8LLVMsqrtd.exit.i.i85.us.i
                                        #   in Loop: Header=BB0_25 Depth=4
	fadd.d	$ft7, $ft5, $ft8
	fsub.d	$ft5, $ft5, $ft8
	movgr2fr.d	$ft8, $zero
...
.LBB0_31:                               # %_ZNK8sphere_t9intersectERK5ray_t.exit.i93.us.i
                                        #   in Loop: Header=BB0_25 Depth=4
	fcmp.cult.d	$fcc0, $ft6, $ft4
	bceqz	$fcc0, .LBB0_39
# %bb.32:                               # %if.else.i100.us.i
                                        #   in Loop: Header=BB0_25 Depth=4
	fld.d	$ft5, $a1, 48
	fld.d	$ft6, $a1, 32
	fld.d	$ft7, $a1, 40
	...
	fsub.d	$ft9, $ft11, $ft9
	fmul.d	$ft11, $ft8, $ft8
	fadd.d	$ft12, $ft11, $ft9
	movgr2fr.d	$ft9, $zero
	fcmp.clt.d	$fcc0, $ft12, $ft9
	bcnez	$fcc0, .LBB0_24
# %bb.33:                               # %if.end.i41.i.us.i
                                        #   in Loop: Header=BB0_25 Depth=4
	fclass.d	$ft11, $ft12
	movfr2gr.d	$a2, $ft11
	andi	$a2, $a2, 64
	...
	fmov.d	$ft13, $ft11
	bnez	$a2, .LBB0_37
# %bb.34:                               # %while.body.i.i43.i.us.i.preheader
                                        #   in Loop: Header=BB0_25 Depth=4
	vldi	$vr21, -912
	move	$a2, $s7
	.p2align	4, , 16
.LBB0_35:                               # %while.body.i.i43.i.us.i
                                        #   Parent Loop BB0_12 Depth=1
                                        #     Parent Loop BB0_15 Depth=2
                                        #       Parent Loop BB0_19 Depth=3
                                        #         Parent Loop BB0_25 Depth=4
                                        # =>        This Inner Loop Header: Depth=5
	fmov.d	$ft14, $ft13
	fdiv.d	$ft13, $ft12, $ft13
	fadd.d	$ft13, $ft14, $ft13
	fmul.d	$ft13, $ft13, $fs7
	fsub.d	$ft14, $ft13, $ft14
	fabs.d	$ft14, $ft14
	fcmp.cule.d	$fcc0, $ft14, $fs0
	bcnez	$fcc0, .LBB0_37
# %bb.36:                               # %while.body.i.i43.i.us.i
                                        #   in Loop: Header=BB0_35 Depth=5
	move	$a3, $a2
	addi.w	$a2, $a2, 1
	bnez	$a3, .LBB0_35
	.p2align	4, , 16
.LBB0_37:                               # %_ZNK8sphere_t9intersectERK5ray_t.exit62.i.us.i
                                        #   in Loop: Header=BB0_25 Depth=4
	fadd.d	$ft12, $ft10, $ft13
	fsub.d	$ft10, $ft10, $ft13
	fcmp.clt.d	$fcc0, $ft9, $ft10
	fsel	$ft10, $ft12, $ft10, $fcc0
	fcmp.clt.d	$fcc0, $ft12, $ft9
	fsel	$ft10, $ft10, $ft11, $fcc0
	fcmp.cule.d	$fcc0, $ft4, $ft10
	bcnez	$fcc0, .LBB0_24
# %bb.38:                               # %if.then6.i.us.i
                                        #   in Loop: Header=BB0_25 Depth=4
	fmul.d	$ft0, $fa5, $ft10
	fmul.d	$ft1, $fa6, $ft10
	fmul.d	$ft2, $fa7, $ft10
...
.LBB0_39:                               # %if.then.i96.us.i
	...
	add.d	$a1, $a1, $a2
	bltu	$a1, $s3, .LBB0_25
.LBB0_40:                               # %_ZN6node_t9intersectILb0EEEvRK5ray_tR5hit_t.exit.us.i
                                        #   in Loop: Header=BB0_19 Depth=3
	fclass.d	$ft4, $ft3
	movfr2gr.d	$a1, $ft4
	andi	$a1, $a1, 64
...
# %bb.46:                               #   in Loop: Header=BB0_44 Depth=4
	movgr2fr.d	$ft3, $s6
	b	.LBB0_50
.LBB0_47:                               # %while.body.i.i.i.us.i.preheader
                                        #   in Loop: Header=BB0_44 Depth=4
	addi.w	$a2, $zero, -99
	vldi	$vr11, -912
	.p2align	4, , 16
.LBB0_48:                               # %while.body.i.i.i.us.i
                                        #   Parent Loop BB0_12 Depth=1
                                        #     Parent Loop BB0_15 Depth=2
                                        #       Parent Loop BB0_19 Depth=3
	...
	bcnez	$fcc0, .LBB0_50
# %bb.49:                               # %while.body.i.i.i.us.i
                                        #   in Loop: Header=BB0_48 Depth=5
	move	$a3, $a2
	addi.w	$a2, $a2, 1
	bnez	$a3, .LBB0_48
	.p2align	4, , 16
.LBB0_50:                               # %_ZL8LLVMsqrtd.exit.i.i.us.i
                                        #   in Loop: Header=BB0_44 Depth=4
	fadd.d	$ft2, $ft1, $ft3
	fcmp.clt.d	$fcc0, $ft2, $fa5
	bcnez	$fcc0, .LBB0_43
# %bb.51:                               # %_ZL8LLVMsqrtd.exit.i.i.us.i
                                        #   in Loop: Header=BB0_44 Depth=4
	fsub.d	$ft1, $ft1, $ft3
...
# %bb.54:                               #   in Loop: Header=BB0_44 Depth=4
	movgr2fr.d	$ft3, $s6
	b	.LBB0_58
.LBB0_55:                               # %while.body.i.i38.i.us.i.preheader
                                        #   in Loop: Header=BB0_44 Depth=4
	vldi	$vr11, -912
	move	$a2, $s7
	.p2align	4, , 16
.LBB0_56:                               # %while.body.i.i38.i.us.i
                                        #   Parent Loop BB0_12 Depth=1
                                        #     Parent Loop BB0_15 Depth=2
                                        #       Parent Loop BB0_19 Depth=3
                                        #         Parent Loop BB0_44 Depth=4
	...
	fcmp.cule.d	$fcc0, $ft5, $fs0
	bcnez	$fcc0, .LBB0_58
# %bb.57:                               # %while.body.i.i38.i.us.i
                                        #   in Loop: Header=BB0_56 Depth=5
	move	$a3, $a2
	addi.w	$a2, $a2, 1
	bnez	$a3, .LBB0_56
.LBB0_58:                               # %_ZL8LLVMsqrtd.exit.i48.i.us.i
                                        #   in Loop: Header=BB0_44 Depth=4
	fadd.d	$ft2, $ft1, $ft3
	fcmp.clt.d	$fcc0, $ft2, $fa5
	bcnez	$fcc0, .LBB0_60
# %bb.59:                               # %_ZL8LLVMsqrtd.exit.i48.i.us.i
                                        #   in Loop: Header=BB0_44 Depth=4
	fsub.d	$ft1, $ft1, $ft3
	fcmp.clt.d	$fcc0, $fa5, $ft1
	fsel	$ft1, $ft2, $ft1, $fcc0
	movgr2fr.d	$ft2, $s6
	fcmp.cne.d	$fcc0, $ft1, $ft2
	bcnez	$fcc0, .LBB0_62
.LBB0_60:                               # %cleanup.thread.i.us.i
                                        #   in Loop: Header=BB0_44 Depth=4
	addi.d	$a1, $a1, 72
	bltu	$a1, $s3, .LBB0_44
.LBB0_61:                               #   in Loop: Header=BB0_19 Depth=3
	movgr2fr.d	$ft1, $s6
.LBB0_62:                               # %_ZN6node_t9intersectILb1EEEvRK5ray_tR5hit_t.exit.us.i
                                        #   in Loop: Header=BB0_19 Depth=3
	fclass.d	$fa6, $ft1
	movfr2gr.d	$a1, $fa6
	andi	$a1, $a1, 64
...
# %bb.65:                               # %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i.i
	ld.bu	$a0, $fp, 56
	beqz	$a0, .LBB0_67
# %bb.66:                               # %if.then.i2.i.i.i
	ld.bu	$a0, $fp, 67
	b	.LBB0_68
.LBB0_67:                               # %if.end.i.i.i.i
	move	$a0, $fp
	...
	move	$a0, $fp
	jirl	$ra, $a2, 0
.LBB0_68:                               # %_ZL10trace_rgssii.exit
	ext.w.b	$a1, $a0
	pcalau12i	$a0, %got_pc_hi20(_ZSt4cout)
...
.LBB1_2:                                # %if.end
	...
	fld.d	$fs0, $a1, %pc_lo12(.LCPI1_9)
	ori	$s3, $zero, 6
	addi.w	$s8, $zero, -99
	vldi	$vr11, -928
	pcalau12i	$s4, %pc_hi20(.LCPI1_8)
