...
.LBB0_62:                               # %call.sqrt510
	...
	move	$a3, $s4
	b	.LBB0_27
.LBB0_63:                               # %call.sqrt511
	fld.d	$fa0, $sp, 48                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(sqrt)
	jirl	$ra, $ra, 0
	fmov.d	$fs2, $fa0
	b	.LBB0_38
.LBB0_64:                               # %call.sqrt512
	fmov.d	$fa0, $fa1
	pcaddu18i	$ra, %call36(sqrt)
	jirl	$ra, $ra, 0
	b	.LBB0_39
.LBB0_65:                               # %call.sqrt513
	move	$s1, $a3
	move	$s2, $a2
	movcf2gr	$a0, $fcc1
	st.d	$a0, $sp, 48
...
.LBB1_20:                               # %cond.false55.us.us.us.us.split
	...
	fsub.d	$fa0, $fa2, $fa0
	b	.LBB1_12
.LBB1_21:                               # %call.sqrt219
                                        #   in Loop: Header=BB1_13 Depth=4
	pcaddu18i	$ra, %call36(sqrt)
	jirl	$ra, $ra, 0
	fmov.d	$fa1, $fa0
	b	.LBB1_11
.LBB1_22:                               # %call.sqrt217
                                        #   in Loop: Header=BB1_13 Depth=4
	pcaddu18i	$ra, %call36(sqrt)
	jirl	$ra, $ra, 0
	fmov.d	$fa1, $fa0
...
.LBB1_36:                               # %cond.false55.us.us.us.us.1.split
	...
	fsub.d	$fa0, $fa2, $fa0
	b	.LBB1_28
.LBB1_37:                               # %call.sqrt223
                                        #   in Loop: Header=BB1_29 Depth=4
	pcaddu18i	$ra, %call36(sqrt)
	jirl	$ra, $ra, 0
	fmov.d	$fa1, $fa0
	b	.LBB1_27
.LBB1_38:                               # %call.sqrt221
                                        #   in Loop: Header=BB1_29 Depth=4
	pcaddu18i	$ra, %call36(sqrt)
	jirl	$ra, $ra, 0
	fmov.d	$fa1, $fa0
	b	.LBB1_31
.LBB1_39:                               # %call.sqrt220
                                        #   in Loop: Header=BB1_29 Depth=4
	fmov.d	$fa0, $fa1
	pcaddu18i	$ra, %call36(sqrt)
	jirl	$ra, $ra, 0
