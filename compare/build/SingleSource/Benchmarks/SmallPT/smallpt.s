...
.LBB0_62:                               # %call.sqrt503
	...
	move	$a3, $s4
	b	.LBB0_27
.LBB0_63:                               # %call.sqrt504
	fld.d	$fa0, $sp, 48                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(sqrt)
	jirl	$ra, $ra, 0
	fmov.d	$fs2, $fa0
	b	.LBB0_38
.LBB0_64:                               # %call.sqrt505
	fmov.d	$fa0, $fa1
	pcaddu18i	$ra, %call36(sqrt)
	jirl	$ra, $ra, 0
	b	.LBB0_39
.LBB0_65:                               # %call.sqrt506
	move	$s1, $a3
	move	$s2, $a2
	movcf2gr	$a0, $fcc1
	st.d	$a0, $sp, 48
...
.LBB1_8:                                # %for.cond32.for.cond.cleanup34_crit_edge.us.us.us.us.1
	...
	vrepli.b	$vr0, 0
	vldi	$vr4, -912
	vfcmp.clt.d	$vr1, $vr4, $vr6
	fcmp.clt.d	$fcc0, $fa4, $fs2
	fsel	$fa2, $fs2, $fa4, $fcc0
	vldi	$vr5, -944
	fmul.d	$fa2, $fa2, $fa5
	movgr2fr.d	$fa3, $zero
	...
	fld.d	$fa3, $sp, 72                   # 8-byte Folded Reload
	fadd.d	$fa2, $fa2, $fa3
	vbitsel.v	$vr1, $vr6, $vr4, $vr1
	vfmul.d	$vr1, $vr1, $vr5
	vfcmp.cule.d	$vr0, $vr0, $vr6
	vand.v	$vr0, $vr0, $vr1
...
.LBB1_25:                               # %for.cond32.for.cond.cleanup34_crit_edge.us.us.us.us
	...
	fcmp.clt.d	$fcc0, $fa2, $fs3
	fsel	$fa1, $fs3, $fa2, $fcc0
	movgr2fr.d	$fs2, $zero
	fcmp.clt.d	$fcc0, $fs3, $fs2
	vbitsel.v	$vr0, $vr3, $vr2, $vr0
	vldi	$vr4, -944
	vfmul.d	$vr0, $vr0, $vr4
	vfcmp.cule.d	$vr2, $vr6, $vr3
	vand.v	$vr0, $vr2, $vr0
	vld	$vr2, $s8, 0
	fld.d	$fa3, $s3, 0
	fmul.d	$fa1, $fa1, $fa4
