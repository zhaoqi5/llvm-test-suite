...
# %bb.9:                                # %if.end16.i.thread.i
	...
	b	.LBB16_11
	.p2align	4, , 16
.LBB16_10:                              # %if.end16.i.i
                                        #   in Loop: Header=BB16_4 Depth=1
	beqz	$s6, .LBB16_2
	.p2align	4, , 16
.LBB16_11:                              # %land.rhs.i.i.i
                                        #   Parent Loop BB16_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.d	$a0, $s6, -1
	srli.d	$s7, $a0, 1
...
# %bb.30:                               # %if.end16.i.thread.i.i.i
	...
	b	.LBB18_32
	.p2align	4, , 16
.LBB18_31:                              # %if.end16.i.i.i.i
                                        #   in Loop: Header=BB18_25 Depth=1
	beqz	$a3, .LBB18_23
	.p2align	4, , 16
.LBB18_32:                              # %land.rhs.i.i.i.i.i
                                        #   Parent Loop BB18_25 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.d	$a4, $a3, -1
	srli.d	$a4, $a4, 1
...
# %bb.30:                               # %if.end16.i.thread.i.i.i
	...
	b	.LBB21_32
	.p2align	4, , 16
.LBB21_31:                              # %if.end16.i.i.i.i
                                        #   in Loop: Header=BB21_25 Depth=1
	beqz	$a3, .LBB21_23
	.p2align	4, , 16
.LBB21_32:                              # %land.rhs.i.i.i.i.i
                                        #   Parent Loop BB21_25 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.d	$a4, $a3, -1
	srli.d	$a4, $a4, 1
...
# %bb.30:                               # %if.end16.i.thread.i.i.i
	...
	b	.LBB24_32
	.p2align	4, , 16
.LBB24_31:                              # %if.end16.i.i.i.i
                                        #   in Loop: Header=BB24_25 Depth=1
	beqz	$a3, .LBB24_23
	.p2align	4, , 16
.LBB24_32:                              # %land.rhs.i.i.i.i.i
                                        #   Parent Loop BB24_25 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.d	$a4, $a3, -1
	srli.d	$a4, $a4, 1
...
# %bb.30:                               # %if.end16.i.thread.i.i.i
	...
	b	.LBB27_32
	.p2align	4, , 16
.LBB27_31:                              # %if.end16.i.i.i.i
                                        #   in Loop: Header=BB27_25 Depth=1
	beqz	$a3, .LBB27_23
	.p2align	4, , 16
.LBB27_32:                              # %land.rhs.i.i.i.i.i
                                        #   Parent Loop BB27_25 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.d	$a4, $a3, -1
	srli.d	$a4, $a4, 1
