...
.LBB31_21:                              #   in Loop: Header=BB31_16 Depth=1
	...
	ori	$a7, $zero, 2
	beq	$a7, $a1, .LBB31_20
.LBB31_22:                              # %if.end37.i22
                                        #   in Loop: Header=BB31_16 Depth=1
	blez	$a6, .LBB31_15
	.p2align	4, , 16
.LBB31_23:                              # %land.rhs.i27
                                        #   Parent Loop BB31_16 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.d	$a7, $a6, -1
	srli.d	$t0, $a7, 1
...
.LBB33_21:                              #   in Loop: Header=BB33_16 Depth=1
	...
	ori	$a7, $zero, 2
	beq	$a7, $a1, .LBB33_20
.LBB33_22:                              # %if.end37.i22
                                        #   in Loop: Header=BB33_16 Depth=1
	blez	$a6, .LBB33_15
	.p2align	4, , 16
.LBB33_23:                              # %land.rhs.i27
                                        #   Parent Loop BB33_16 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.d	$a7, $a6, -1
	srli.d	$t0, $a7, 1
...
.LBB35_21:                              #   in Loop: Header=BB35_16 Depth=1
	...
	ori	$a7, $zero, 2
	beq	$a7, $a1, .LBB35_20
.LBB35_22:                              # %if.end37.i22
                                        #   in Loop: Header=BB35_16 Depth=1
	blez	$a6, .LBB35_15
	.p2align	4, , 16
.LBB35_23:                              # %land.rhs.i27
                                        #   Parent Loop BB35_16 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.d	$a7, $a6, -1
	srli.d	$t0, $a7, 1
