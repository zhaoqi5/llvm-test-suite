...
# %bb.19:                               # %if.end14.i22.thread
	...
	b	.LBB18_21
	.p2align	4, , 16
.LBB18_20:                              # %if.end14.i22
                                        #   in Loop: Header=BB18_16 Depth=1
	blez	$a5, .LBB18_15
	.p2align	4, , 16
.LBB18_21:                              # %land.rhs.i27
                                        #   Parent Loop BB18_16 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.d	$a6, $a5, -1
	srli.d	$a6, $a6, 1
...
.LBB19_17:                              # %for.body.i42
	...
	fstx.d	$fa1, $a0, $a7
	blt	$a6, $a1, .LBB19_17
.LBB19_18:                              # %for.end.i20
                                        #   in Loop: Header=BB19_16 Depth=1
	bne	$a6, $a1, .LBB19_20
# %bb.19:                               # %if.end37.i24.thread
                                        #   in Loop: Header=BB19_16 Depth=1
	addi.d	$a6, $a4, -2
	slli.d	$a7, $a6, 3
	fldx.d	$fa1, $a0, $a7
	...
	b	.LBB19_21
	.p2align	4, , 16
.LBB19_20:                              # %if.end37.i24
                                        #   in Loop: Header=BB19_16 Depth=1
	blez	$a5, .LBB19_15
	.p2align	4, , 16
.LBB19_21:                              # %land.rhs.i29
                                        #   Parent Loop BB19_16 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.d	$a6, $a5, -1
	srli.d	$a6, $a6, 1
...
.LBB20_17:                              # %for.body.i56
	...
	fst.d	$fa1, $t0, -8
	blt	$a7, $a1, .LBB20_17
.LBB20_18:                              # %for.end.i19
                                        #   in Loop: Header=BB20_16 Depth=1
	bne	$a7, $a1, .LBB20_20
# %bb.19:                               # %if.end19.i23.thread
                                        #   in Loop: Header=BB20_16 Depth=1
	sub.d	$a7, $a4, $a5
	alsl.d	$a7, $a7, $a0, 3
	fld.d	$fa1, $a7, -8
	...
	b	.LBB20_21
	.p2align	4, , 16
.LBB20_20:                              # %if.end19.i23
                                        #   in Loop: Header=BB20_16 Depth=1
	blez	$a6, .LBB20_15
	.p2align	4, , 16
.LBB20_21:                              # %land.rhs.i31
                                        #   Parent Loop BB20_16 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.d	$a7, $a6, -1
	srli.d	$a7, $a7, 1
...
# %bb.19:                               # %if.end19.i23.thread
	...
	b	.LBB21_21
	.p2align	4, , 16
.LBB21_20:                              # %if.end19.i23
                                        #   in Loop: Header=BB21_16 Depth=1
	blez	$a6, .LBB21_15
	.p2align	4, , 16
.LBB21_21:                              # %land.rhs.i31
                                        #   Parent Loop BB21_16 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.d	$a7, $a6, -1
	srli.d	$a7, $a7, 1
...
.LBB22_17:                              # %for.body.i53
	...
	fstx.d	$fa1, $a0, $a7
	blt	$a6, $a1, .LBB22_17
.LBB22_18:                              # %for.end.i27
                                        #   in Loop: Header=BB22_16 Depth=1
	bne	$a6, $a1, .LBB22_20
# %bb.19:                               # %if.end19.i31.thread
                                        #   in Loop: Header=BB22_16 Depth=1
	addi.d	$a6, $a4, -2
	slli.d	$a7, $a6, 3
	fldx.d	$fa1, $a0, $a7
	...
	b	.LBB22_21
	.p2align	4, , 16
.LBB22_20:                              # %if.end19.i31
                                        #   in Loop: Header=BB22_16 Depth=1
	blez	$a5, .LBB22_15
	.p2align	4, , 16
.LBB22_21:                              # %land.rhs.i37
                                        #   Parent Loop BB22_16 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.d	$a6, $a5, -1
	srli.d	$a6, $a6, 1
...
# %bb.19:                               # %if.end19.i31.thread
	...
	b	.LBB23_21
	.p2align	4, , 16
.LBB23_20:                              # %if.end19.i31
                                        #   in Loop: Header=BB23_16 Depth=1
	blez	$a5, .LBB23_15
	.p2align	4, , 16
.LBB23_21:                              # %land.rhs.i37
                                        #   Parent Loop BB23_16 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.d	$a6, $a5, -1
	srli.d	$a6, $a6, 1
