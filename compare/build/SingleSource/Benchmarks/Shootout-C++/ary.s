...
# %bb.19:                               # %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i
	ld.bu	$a0, $s2, 56
	beqz	$a0, .LBB0_21
# %bb.20:                               # %if.then.i2.i.i
	ld.bu	$a0, $s2, 67
	b	.LBB0_23
.LBB0_21:                               # %if.end.i.i.i
.Ltmp5:                                 # EH_LABEL
	move	$a0, $s2
...
.LBB0_27:                               # %_ZNSt6vectorIiSaIiEED2Ev.exit
	beqz	$fp, .LBB0_29
# %bb.28:                               # %if.then.i.i.i37
	sub.d	$a1, $s4, $fp
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB0_29:                               # %_ZNSt6vectorIiSaIiEED2Ev.exit42
	move	$a0, $zero
...
.LBB0_37:                               # %ehcleanup25
	...
	jirl	$ra, $ra, 0
.LBB0_38:                               # %if.then.i.i.i44
	sub.d	$a1, $s5, $s0
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
	beqz	$fp, .LBB0_37
.LBB0_39:                               # %if.then.i.i.i51
	sub.d	$a1, $s4, $fp
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
