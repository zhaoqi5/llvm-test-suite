...
.LBB4_13:                               # %for.cond1.preheader.us.i
	...
	xvextrins.h	$xr13, $xr1, 17
	xvpickve2gr.d	$a3, $xr0, 2
	xvreplgr2vr.h	$xr1, $a3
	xvpermi.q	$xr1, $xr13, 18
	xvextrins.h	$xr13, $xr1, 34
	xvpickve2gr.d	$a3, $xr0, 3
	xvreplgr2vr.h	$xr0, $a3
	xvpermi.q	$xr0, $xr13, 18
	xvextrins.h	$xr13, $xr0, 51
	xvslt.du	$xr0, $xr12, $xr15
	xvpickve2gr.d	$a3, $xr0, 0
	xvreplgr2vr.h	$xr1, $a3
	xvpermi.q	$xr1, $xr13, 18
	xvextrins.h	$xr13, $xr1, 68
	xvpickve2gr.d	$a3, $xr0, 1
	xvreplgr2vr.h	$xr1, $a3
	xvpermi.q	$xr1, $xr13, 18
	xvextrins.h	$xr13, $xr1, 85
	xvpickve2gr.d	$a3, $xr0, 2
	xvreplgr2vr.h	$xr1, $a3
	xvpermi.q	$xr1, $xr13, 18
	xvextrins.h	$xr13, $xr1, 102
	xvpickve2gr.d	$a3, $xr0, 3
	xvreplgr2vr.h	$xr0, $a3
	xvpermi.q	$xr0, $xr13, 18
	xvextrins.h	$xr13, $xr0, 119
	xvslt.du	$xr0, $xr12, $xr11
	xvpickve2gr.d	$a3, $xr0, 0
	xvreplgr2vr.h	$xr1, $a3
	xvpermi.q	$xr1, $xr13, 48
	xvextrins.h	$xr13, $xr1, 0
	xvpickve2gr.d	$a3, $xr0, 1
	xvreplgr2vr.h	$xr1, $a3
	xvpermi.q	$xr1, $xr13, 48
	xvextrins.h	$xr13, $xr1, 17
	...
	xvextrins.h	$xr0, $xr2, 17
	xvpickve2gr.d	$a3, $xr1, 2
	xvreplgr2vr.h	$xr2, $a3
	xvpermi.q	$xr2, $xr0, 18
	xvextrins.h	$xr0, $xr2, 34
	...
	xvreplgr2vr.h	$xr2, $a3
	xvpermi.q	$xr2, $xr0, 18
	xvextrins.h	$xr0, $xr2, 68
	xvpickve2gr.d	$a3, $xr1, 1
	xvreplgr2vr.h	$xr2, $a3
	xvpermi.q	$xr2, $xr0, 18
	xvextrins.h	$xr0, $xr2, 85
	xvpickve2gr.d	$a3, $xr1, 2
	xvreplgr2vr.h	$xr2, $a3
	xvpermi.q	$xr2, $xr0, 18
	xvextrins.h	$xr0, $xr2, 102
	xvpickve2gr.d	$a3, $xr1, 3
	xvreplgr2vr.h	$xr1, $a3
	xvpermi.q	$xr1, $xr0, 18
	...
	vpickve2gr.h	$a3, $vr1, 5
	vinsgr2vr.b	$vr0, $a3, 13
	vpickve2gr.h	$a3, $vr1, 6
	vinsgr2vr.b	$vr0, $a3, 14
	vpickve2gr.h	$a3, $vr1, 7
	vinsgr2vr.b	$vr0, $a3, 15
	xvslt.du	$xr1, $xr12, $xr18
	xvpickve2gr.d	$a3, $xr1, 0
...
# %bb.14:                               # %for.cond1.preheader.us.i
	...
	sltu	$t6, $a4, $t5
	and	$a2, $a2, $t6
	ld.d	$s2, $sp, 848                   # 8-byte Folded Reload
	ld.d	$t8, $sp, 816                   # 8-byte Folded Reload
...
# %bb.21:                               # %vector.body.preheader
	...
	vldrepl.w	$vr16, $a4, 16
	vldrepl.w	$vr17, $a4, 20
	vldrepl.w	$vr18, $a4, 24
	vldrepl.w	$vr19, $a4, 28
	vldrepl.w	$vr20, $a4, 32
	vldrepl.w	$vr21, $a4, 36
	vldrepl.w	$vr22, $a4, 40
	vldrepl.w	$vr23, $a4, 44
	vldrepl.w	$vr24, $a4, 48
	vldrepl.w	$vr25, $a4, 52
	vldrepl.w	$vr26, $a4, 56
	vldrepl.w	$vr27, $a4, 60
	vldrepl.w	$vr28, $a4, 64
	vldrepl.w	$vr29, $a4, 68
	vldrepl.w	$vr30, $a4, 72
	vldrepl.w	$vr31, $a4, 76
	vldrepl.w	$vr0, $a4, 80
	vldrepl.w	$vr1, $a4, 84
	vldrepl.w	$vr2, $a4, 88
	vldrepl.w	$vr3, $a4, 92
	vldrepl.w	$vr4, $a4, 96
	vldrepl.w	$vr5, $a4, 100
	vldrepl.w	$vr6, $a4, 104
	vldrepl.w	$vr7, $a4, 108
	vldrepl.w	$vr8, $a4, 112
	vldrepl.w	$vr9, $a4, 116
	move	$a3, $zero
...
.LBB4_22:                               # %vector.body
	...
	vldx	$vr11, $s5, $a3
	ld.d	$t8, $sp, 704                   # 8-byte Folded Reload
	vldx	$vr12, $t8, $a3
	vldx	$vr13, $a7, $a3
	vldx	$vr14, $a6, $a3
...
.LBB4_25:                               # %for.cond4.preheader.us.us.i
	...
	ldx.w	$t6, $t6, $a3
	ld.w	$t7, $a4, 4
	ld.d	$t8, $sp, 736                   # 8-byte Folded Reload
	ldx.w	$t8, $t8, $a3
	mul.d	$a2, $t6, $a2
	mul.d	$t6, $t8, $t7
	ld.w	$t7, $a4, 8
