...
# %bb.21:                               # %while.body.i.i32
	...
	addi.d	$a0, $sp, 80
	beq	$a1, $a0, .LBB1_30
# %bb.22:                               # %land.rhs.i.i.1
                                        #   in Loop: Header=BB1_20 Depth=1
	ld.w	$a0, $a1, 16
	beqz	$a0, .LBB1_29
# %bb.23:                               # %while.body.i.i32.1
                                        #   in Loop: Header=BB1_20 Depth=1
	ld.d	$a1, $a1, 0
	addi.d	$a0, $sp, 80
	beq	$a1, $a0, .LBB1_30
# %bb.24:                               # %land.rhs.i.i.2
                                        #   in Loop: Header=BB1_20 Depth=1
	ld.w	$a0, $a1, 16
	beqz	$a0, .LBB1_29
# %bb.25:                               # %while.body.i.i32.2
                                        #   in Loop: Header=BB1_20 Depth=1
	ld.d	$a1, $a1, 0
	addi.d	$a0, $sp, 80
	beq	$a1, $a0, .LBB1_30
# %bb.26:                               # %land.rhs.i.i.3
                                        #   in Loop: Header=BB1_20 Depth=1
	ld.w	$a0, $a1, 16
	beqz	$a0, .LBB1_29
# %bb.27:                               # %while.body.i.i32.3
                                        #   in Loop: Header=BB1_20 Depth=1
	ld.d	$a1, $a1, 0
	addi.d	$a0, $sp, 80
	bne	$a1, $a0, .LBB1_20
...
# %bb.41:                               # %while.body.i.i47
	...
	addi.d	$a0, $sp, 80
	beq	$a1, $a0, .LBB1_50
# %bb.42:                               # %land.rhs.i.i43.1
                                        #   in Loop: Header=BB1_40 Depth=1
	ld.w	$a0, $a1, 16
	beq	$a0, $s1, .LBB1_49
# %bb.43:                               # %while.body.i.i47.1
                                        #   in Loop: Header=BB1_40 Depth=1
	ld.d	$a1, $a1, 0
	addi.d	$a0, $sp, 80
	beq	$a1, $a0, .LBB1_50
# %bb.44:                               # %land.rhs.i.i43.2
                                        #   in Loop: Header=BB1_40 Depth=1
	ld.w	$a0, $a1, 16
	beq	$a0, $s1, .LBB1_49
# %bb.45:                               # %while.body.i.i47.2
                                        #   in Loop: Header=BB1_40 Depth=1
	ld.d	$a1, $a1, 0
	addi.d	$a0, $sp, 80
	beq	$a1, $a0, .LBB1_50
# %bb.46:                               # %land.rhs.i.i43.3
                                        #   in Loop: Header=BB1_40 Depth=1
	ld.w	$a0, $a1, 16
	beq	$a0, $s1, .LBB1_49
# %bb.47:                               # %while.body.i.i47.3
                                        #   in Loop: Header=BB1_40 Depth=1
	ld.d	$a1, $a1, 0
	addi.d	$a0, $sp, 80
	bne	$a1, $a0, .LBB1_40
...
.LBB1_49:
	move	$a0, $a1
.LBB1_50:                               # %while.end.loopexit.i.i49
	addi.d	$a1, $sp, 80
	xor	$a0, $a0, $a1
	sltui	$a0, $a0, 1
	masknez	$a1, $s2, $a0
...
# %bb.52:                               # %invoke.cont81
	...
	ld.d	$fp, $a0, 240
	beqz	$fp, .LBB1_104
# %bb.53:                               # %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i157
	ld.bu	$a0, $fp, 56
	beqz	$a0, .LBB1_55
# %bb.54:                               # %if.then.i2.i.i160
	ld.bu	$a0, $fp, 67
	b	.LBB1_57
.LBB1_55:                               # %if.end.i.i.i165
.Ltmp24:                                # EH_LABEL
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_ZNKSt5ctypeIcE13_M_widen_initEv)
	jirl	$ra, $ra, 0
...
.Ltmp26:                                # EH_LABEL
	...
	jirl	$ra, $a2, 0
.Ltmp27:                                # EH_LABEL
.LBB1_57:                               # %_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i162
.Ltmp28:                                # EH_LABEL
	ext.w.b	$a1, $a0
	pcalau12i	$a0, %got_pc_hi20(_ZSt4cout)
	ld.d	$a0, $a0, %got_pc_lo12(_ZSt4cout)
...
.Ltmp35:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp36:                                # EH_LABEL
# %bb.67:                               # %call5.i.i.i.i.i.i.i.noexc.i86
...
# %bb.69:                               # %invoke.cont105
	ld.d	$a0, $sp, 8
	beq	$a0, $s0, .LBB1_72
# %bb.70:                               # %while.body.i.i96.preheader
	addi.d	$fp, $sp, 8
	.p2align	4, , 16
.LBB1_71:                               # %while.body.i.i96
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$s0, $a0, 0
	ori	$a1, $zero, 24
	pcaddu18i	$ra, %call36(_ZdlPvm)
	...
	move	$a0, $s0
	bne	$s0, $fp, .LBB1_71
.LBB1_72:                               # %_ZNSt7__cxx1110_List_baseIiSaIiEED2Ev.exit99
	ld.d	$a0, $sp, 56
	move	$a1, $zero
	addi.d	$a2, $sp, 56
	beq	$a0, $a2, .LBB1_74
...
# %bb.75:                               # %invoke.cont127
	...
	ld.d	$s0, $a0, 240
	beqz	$s0, .LBB1_100
# %bb.76:                               # %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i183
	ld.bu	$a0, $s0, 56
	beqz	$a0, .LBB1_78
# %bb.77:                               # %if.then.i2.i.i186
	ld.bu	$a0, $s0, 67
	b	.LBB1_80
.LBB1_78:                               # %if.end.i.i.i191
.Ltmp43:                                # EH_LABEL
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_ZNKSt5ctypeIcE13_M_widen_initEv)
	jirl	$ra, $ra, 0
...
.Ltmp45:                                # EH_LABEL
	...
	jirl	$ra, $a2, 0
.Ltmp46:                                # EH_LABEL
.LBB1_80:                               # %_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i188
.Ltmp47:                                # EH_LABEL
	ext.w.b	$a1, $a0
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_ZNSo3putEc)
...
# %bb.89:                               # %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i209
	ld.bu	$a0, $s0, 56
	beqz	$a0, .LBB1_91
# %bb.90:                               # %if.then.i2.i.i212
	ld.bu	$a0, $s0, 67
	b	.LBB1_93
.LBB1_91:                               # %if.end.i.i.i217
.Ltmp57:                                # EH_LABEL
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_ZNKSt5ctypeIcE13_M_widen_initEv)
	jirl	$ra, $ra, 0
...
.Ltmp59:                                # EH_LABEL
	...
	jirl	$ra, $a2, 0
.Ltmp60:                                # EH_LABEL
.LBB1_93:                               # %_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i214
.Ltmp61:                                # EH_LABEL
	ext.w.b	$a1, $a0
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_ZNSo3putEc)
...
.LBB1_96:                               # %while.body.i.i127
	...
	move	$a0, $s0
	bne	$s0, $fp, .LBB1_96
.LBB1_97:                               # %_ZNSt7__cxx1110_List_baseIiSaIiEED2Ev.exit130
	ld.d	$a0, $sp, 80
	addi.d	$fp, $sp, 80
	beq	$a0, $fp, .LBB1_99
	.p2align	4, , 16
.LBB1_98:                               # %while.body.i.i132
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$s0, $a0, 0
	ori	$a1, $zero, 24
	pcaddu18i	$ra, %call36(_ZdlPvm)
	...
	move	$a0, $s0
	bne	$s0, $fp, .LBB1_98
.LBB1_99:                               # %_ZNSt7__cxx1110_List_baseIiSaIiEED2Ev.exit135
	move	$a0, $zero
	...
	addi.d	$sp, $sp, 144
	ret
.LBB1_100:                              # %if.then.i.i.i220.invoke
.Ltmp65:                                # EH_LABEL
	pcaddu18i	$ra, %call36(_ZSt16__throw_bad_castv)
	jirl	$ra, $ra, 0
.Ltmp66:                                # EH_LABEL
# %bb.101:                              # %if.then.i.i.i220.cont
...
.Ltmp40:                                # EH_LABEL
	...
	move	$fp, $a0
	beq	$a1, $s0, .LBB1_124
# %bb.107:                              # %while.body.i.i106.preheader
	move	$a0, $a1
	addi.d	$s0, $sp, 8
	.p2align	4, , 16
.LBB1_108:                              # %while.body.i.i106
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$s1, $a0, 0
	ori	$a1, $zero, 24
	pcaddu18i	$ra, %call36(_ZdlPvm)
...
.Ltmp11:                                # EH_LABEL
	...
	move	$fp, $a0
	beq	$a1, $s0, .LBB1_124
# %bb.110:                              # %while.body.i.i70.preheader
	move	$a0, $a1
	addi.d	$s0, $sp, 32
	.p2align	4, , 16
.LBB1_111:                              # %while.body.i.i70
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$s1, $a0, 0
	ori	$a1, $zero, 24
	pcaddu18i	$ra, %call36(_ZdlPvm)
...
.Ltmp37:                                # EH_LABEL
	...
	move	$fp, $a0
	beq	$a1, $s0, .LBB1_124
# %bb.117:                              # %while.body.i.i.i82.preheader
	move	$a0, $a1
	.p2align	4, , 16
.LBB1_118:                              # %while.body.i.i.i82
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$s1, $a0, 0
	ori	$a1, $zero, 24
	pcaddu18i	$ra, %call36(_ZdlPvm)
...
.LBB1_130:                              # %while.body.i.i142
	...
	move	$a0, $s1
	bne	$s1, $s0, .LBB1_130
.LBB1_131:                              # %_ZNSt7__cxx1110_List_baseIiSaIiEED2Ev.exit145
	move	$a0, $fp
