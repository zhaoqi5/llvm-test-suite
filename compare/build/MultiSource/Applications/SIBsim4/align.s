...
# %bb.57:                               # %iter.check551
	...
	move	$a3, $s3
	bltu	$s0, $a1, .LBB0_86
# %bb.58:                               # %vector.main.loop.iter.check553
...
# %bb.71:                               # %if.then60
	bge	$a7, $a5, .LBB0_144
# %bb.72:                               # %land.rhs.preheader.i329
	ld.d	$a0, $sp, 352                   # 8-byte Folded Reload
	add.d	$a0, $a0, $a2
	move	$s0, $a2
	.p2align	4, , 16
.LBB0_73:                               # %land.rhs.i330
                                        # =>This Inner Loop Header: Depth=1
	ld.bu	$a1, $a0, 0
	ld.d	$a3, $sp, 360                   # 8-byte Folded Reload
	ldx.bu	$a3, $a3, $a7
...
.LBB0_80:                               # %vector.body557
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB0_80
# %bb.81:                               # %middle.block560
	beq	$a1, $a2, .LBB0_88
# %bb.82:                               # %vec.epilog.iter.check564
	beqz	$a3, .LBB0_153
.LBB0_83:                               # %vec.epilog.ph566
	...
	sub.d	$a2, $a2, $a4
	.p2align	4, , 16
.LBB0_84:                               # %vec.epilog.vector.body571
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a5, 0
	addi.d	$a2, $a2, 4
	addi.d	$a5, $a5, 16
	bnez	$a2, .LBB0_84
# %bb.85:                               # %vec.epilog.middle.block575
	beq	$a1, $a4, .LBB0_88
.LBB0_86:                               # %for.body274.preheader
	slli.d	$a1, $a3, 2
	sub.d	$a1, $a1, $s5
	add.d	$a1, $s4, $a1
	sub.d	$a2, $s1, $a3
...
.LBB0_100:                              #   in Loop: Header=BB0_102 Depth=2
	move	$a0, $fp
.LBB0_101:                              # %rsnake.exit426
                                        #   in Loop: Header=BB0_102 Depth=2
	slli.d	$a1, $s4, 2
	stx.w	$a0, $t5, $a1
	addi.d	$a0, $s4, 1
	bge	$s4, $s5, .LBB0_118
.LBB0_102:                              # %for.body307
...
# %bb.111:                              # %if.end4.i406
	...
	add.w	$s8, $fp, $s4
	blt	$t1, $s8, .LBB0_117
.LBB0_112:                              # %if.end9.i409
                                        #   in Loop: Header=BB0_102 Depth=2
	move	$a1, $fp
	.p2align	4, , 16
.LBB0_113:                              # %while.cond.i410
                                        #   Parent Loop BB0_98 Depth=1
                                        #     Parent Loop BB0_102 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	move	$a0, $fp
	bge	$a7, $s8, .LBB0_101
# %bb.114:                              # %while.cond.i410
                                        #   in Loop: Header=BB0_113 Depth=3
	bge	$a6, $a1, .LBB0_101
# %bb.115:                              # %land.rhs.i418
                                        #   in Loop: Header=BB0_113 Depth=3
	ldx.bu	$a2, $s7, $a1
	ldx.bu	$a3, $s6, $s8
	addi.d	$a1, $a1, -1
...
.LBB0_117:                              # %if.then6.i424
	...
	b	.LBB0_112
	.p2align	4, , 16
.LBB0_118:                              # %iter.check594
                                        #   in Loop: Header=BB0_98 Depth=1
	ld.d	$a5, $sp, 144                   # 8-byte Folded Reload
	ori	$a0, $zero, 4
	ld.d	$fp, $sp, 248                   # 8-byte Folded Reload
	bltu	$fp, $a0, .LBB0_122
# %bb.119:                              # %iter.check594
                                        #   in Loop: Header=BB0_98 Depth=1
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	ori	$a1, $zero, 64
	bltu	$a0, $a1, .LBB0_122
# %bb.120:                              # %vector.main.loop.iter.check596
                                        #   in Loop: Header=BB0_98 Depth=1
...
.LBB0_122:                              #   in Loop: Header=BB0_98 Depth=1
	...
	ld.d	$t8, $sp, 256                   # 8-byte Folded Reload
	b	.LBB0_130
.LBB0_123:                              # %vector.ph597
                                        #   in Loop: Header=BB0_98 Depth=1
	andi	$a1, $fp, 12
	move	$a0, $fp
	bstrins.d	$a0, $zero, 3, 0
	.p2align	4, , 16
.LBB0_124:                              # %vector.body600
                                        #   Parent Loop BB0_98 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	xvld	$xr0, $s0, -32
	xvld	$xr1, $s0, 0
...
# %bb.125:                              # %middle.block605
	...
	ld.d	$t8, $sp, 256                   # 8-byte Folded Reload
	beq	$fp, $a0, .LBB0_97
# %bb.126:                              # %vec.epilog.iter.check609
                                        #   in Loop: Header=BB0_98 Depth=1
	beqz	$a1, .LBB0_132
.LBB0_127:                              # %vec.epilog.ph611
                                        #   in Loop: Header=BB0_98 Depth=1
	move	$a2, $fp
	...
	alsl.d	$a4, $a4, $t5, 2
	.p2align	4, , 16
.LBB0_128:                              # %vec.epilog.vector.body614
                                        #   Parent Loop BB0_98 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a4, 0
	vst	$vr0, $a0, 0
	...
	addi.d	$a4, $a4, 16
	bnez	$a3, .LBB0_128
# %bb.129:                              # %vec.epilog.middle.block619
                                        #   in Loop: Header=BB0_98 Depth=1
	beq	$fp, $a2, .LBB0_97
.LBB0_130:                              # %for.body387.preheader
                                        #   in Loop: Header=BB0_98 Depth=1
	addi.d	$a0, $a1, -1
	alsl.d	$a2, $a1, $t5, 2
	alsl.d	$a1, $a1, $t2, 2
	.p2align	4, , 16
.LBB0_131:                              # %for.body387
                                        #   Parent Loop BB0_98 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$a3, $a2, 0
	st.w	$a3, $a1, 0
...
.LBB1_24:                               # %snake.exit
	...
	ldx.w	$a1, $a0, $a1
	bge	$a1, $s2, .LBB1_63
# %bb.25:                               # %for.cond41.preheader
	blez	$t8, .LBB1_64
# %bb.26:                               # %for.body44.lr.ph
	move	$a1, $zero
	sub.d	$a2, $s7, $t1
	alsl.d	$a3, $t0, $a0, 2
	nor	$a4, $s8, $zero
...
.LBB1_34:                               # %if.else78
	...
	ld.w	$fp, $a5, 4
	bge	$a7, $fp, .LBB1_36
# %bb.35:                               # %if.else78.if.else98_crit_edge
                                        #   in Loop: Header=BB1_30 Depth=2
	ld.w	$t0, $a5, -4
	b	.LBB1_37
.LBB1_36:                               # %land.lhs.true
                                        #   in Loop: Header=BB1_30 Depth=2
	ld.w	$t0, $a5, -4
	addi.w	$a5, $a7, 1
	bge	$a5, $t0, .LBB1_38
...
# %bb.40:                               # %if.end.i108
	...
	add.w	$a7, $a5, $s6
	bge	$a7, $s1, .LBB1_29
# %bb.41:                               # %land.rhs.preheader.i113
                                        #   in Loop: Header=BB1_30 Depth=2
	bstrpick.d	$a6, $a5, 31, 0
	add.d	$fp, $s4, $a6
	.p2align	4, , 16
.LBB1_42:                               # %land.rhs.i114
                                        #   Parent Loop BB1_27 Depth=1
...
# %bb.46:                               # %iter.check183
	...
	ori	$a6, $zero, 64
	bltu	$a5, $a6, .LBB1_49
# %bb.47:                               # %vector.main.loop.iter.check185
                                        #   in Loop: Header=BB1_27 Depth=1
	ori	$a5, $zero, 16
	bgeu	$t7, $a5, .LBB1_51
...
# %bb.53:                               # %middle.block193
	...
	ld.d	$t8, $sp, 112                   # 8-byte Folded Reload
	beq	$t7, $a5, .LBB1_60
# %bb.54:                               # %vec.epilog.iter.check197
                                        #   in Loop: Header=BB1_27 Depth=1
	beqz	$a7, .LBB1_62
.LBB1_55:                               # %vec.epilog.ph199
                                        #   in Loop: Header=BB1_27 Depth=1
	move	$a7, $t7
	...
	alsl.d	$t3, $t0, $a2, 2
	.p2align	4, , 16
.LBB1_56:                               # %vec.epilog.vector.body202
                                        #   Parent Loop BB1_27 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $t3, 0
	vst	$vr0, $a5, 0
	...
	addi.d	$t3, $t3, 16
	bnez	$t2, .LBB1_56
# %bb.57:                               # %vec.epilog.middle.block207
                                        #   in Loop: Header=BB1_27 Depth=1
	beq	$t7, $a7, .LBB1_60
.LBB1_58:                               # %for.body138.preheader
                                        #   in Loop: Header=BB1_27 Depth=1
	addi.d	$a5, $t1, -1
	alsl.d	$a7, $t1, $a2, 2
	alsl.d	$t1, $t1, $a0, 2
...
.LBB3_10:                               # %for.body
	...
	blt	$a5, $a6, .LBB3_10
	b	.LBB3_5
.LBB3_11:                               # %while.body.us.us.preheader
	ori	$a2, $zero, 2
	ori	$a4, $zero, 3
	move	$a3, $a1
	b	.LBB3_15
	.p2align	4, , 16
.LBB3_12:                               # %if.else13.us.us
                                        #   in Loop: Header=BB3_15 Depth=1
	sub.d	$a5, $zero, $a5
.LBB3_13:                               # %if.end23.us.us.sink.split
                                        #   in Loop: Header=BB3_15 Depth=1
	addi.d	$a6, $a3, 4
	st.w	$a5, $a3, 0
	move	$a3, $a6
.LBB3_14:                               # %if.end23.us.us
                                        #   in Loop: Header=BB3_15 Depth=1
	ld.d	$a0, $a0, 0
	beqz	$a0, .LBB3_20
.LBB3_15:                               # %while.body.us.us
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB3_19 Depth 2
	ld.bu	$a6, $a0, 12
	ld.w	$a5, $a0, 8
	beq	$a6, $a2, .LBB3_13
# %bb.16:                               # %while.body.us.us
                                        #   in Loop: Header=BB3_15 Depth=1
	bne	$a6, $a4, .LBB3_12
# %bb.17:                               # %for.cond.preheader.us.us
                                        #   in Loop: Header=BB3_15 Depth=1
	blez	$a5, .LBB3_14
