...
# %bb.56:                               # %iter.check551
	...
	bltu	$s0, $a1, .LBB0_94
# %bb.57:                               # %vector.main.loop.iter.check553
...
.LBB0_79:                               # %vector.body557
	...
	addi.d	$a3, $a3, 64
	bnez	$a4, .LBB0_79
# %bb.80:                               # %middle.block560
	beq	$a1, $a2, .LBB0_96
# %bb.81:                               # %vec.epilog.iter.check565
	andi	$a3, $a1, 12
	beqz	$a3, .LBB0_93
.LBB0_82:                               # %vec.epilog.ph564
	...
	sub.d	$a2, $a2, $a4
	.p2align	4, , 16
.LBB0_83:                               # %vec.epilog.vector.body572
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a5, 0
	addi.d	$a2, $a2, 4
	addi.d	$a5, $a5, 16
	bnez	$a2, .LBB0_83
# %bb.84:                               # %vec.epilog.middle.block576
	bne	$a1, $a4, .LBB0_94
	b	.LBB0_96
.LBB0_85:
                                        # implicit-def: $r22
...
.LBB0_125:                              # %if.then6.i424
	...
	b	.LBB0_120
	.p2align	4, , 16
.LBB0_126:                              # %iter.check595
                                        #   in Loop: Header=BB0_106 Depth=1
	ld.d	$a5, $sp, 272                   # 8-byte Folded Reload
	ori	$a0, $zero, 4
	ld.d	$fp, $sp, 240                   # 8-byte Folded Reload
	bltu	$fp, $a0, .LBB0_131
# %bb.127:                              # %iter.check595
                                        #   in Loop: Header=BB0_106 Depth=1
	ld.d	$t7, $sp, 144                   # 8-byte Folded Reload
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	ori	$a1, $zero, 63
	bgeu	$a1, $a0, .LBB0_130
# %bb.128:                              # %vector.main.loop.iter.check597
                                        #   in Loop: Header=BB0_106 Depth=1
...
.LBB0_132:                              # %for.body387.preheader
	...
	ld.d	$t8, $sp, 248                   # 8-byte Folded Reload
	b	.LBB0_141
.LBB0_133:                              # %vector.ph598
                                        #   in Loop: Header=BB0_106 Depth=1
	move	$a0, $fp
	bstrins.d	$a0, $zero, 3, 0
	.p2align	4, , 16
.LBB0_134:                              # %vector.body601
                                        #   Parent Loop BB0_106 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	xvld	$xr0, $s0, -32
	xvld	$xr1, $s0, 0
	...
	addi.d	$s3, $s3, 64
	bnez	$s1, .LBB0_134
# %bb.135:                              # %middle.block606
                                        #   in Loop: Header=BB0_106 Depth=1
	move	$s1, $s2
	ld.d	$s0, $sp, 168                   # 8-byte Folded Reload
	ld.d	$s3, $sp, 152                   # 8-byte Folded Reload
	beq	$fp, $a0, .LBB0_105
# %bb.136:                              # %vec.epilog.iter.check611
                                        #   in Loop: Header=BB0_106 Depth=1
	andi	$a1, $fp, 12
	beqz	$a1, .LBB0_140
.LBB0_137:                              # %vec.epilog.ph610
                                        #   in Loop: Header=BB0_106 Depth=1
	move	$a2, $fp
	...
	alsl.d	$a4, $a4, $t5, 2
	.p2align	4, , 16
.LBB0_138:                              # %vec.epilog.vector.body616
                                        #   Parent Loop BB0_106 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a4, 0
	vst	$vr0, $a0, 0
	...
	addi.d	$a4, $a4, 16
	bnez	$a3, .LBB0_138
# %bb.139:                              # %vec.epilog.middle.block621
                                        #   in Loop: Header=BB0_106 Depth=1
	beq	$fp, $a2, .LBB0_105
	b	.LBB0_141
...
.LBB1_51:                               #   in Loop: Header=BB1_28 Depth=1
	...
	ld.d	$s6, $sp, 88                    # 8-byte Folded Reload
	b	.LBB1_60
.LBB1_52:                               # %vector.ph186
                                        #   in Loop: Header=BB1_28 Depth=1
	move	$a5, $t7
	bstrins.d	$a5, $zero, 3, 0
	.p2align	4, , 16
.LBB1_53:                               # %vector.body189
                                        #   Parent Loop BB1_28 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	xvld	$xr0, $t2, -32
	xvld	$xr1, $t2, 0
	...
	addi.d	$t1, $t1, 64
	bnez	$t8, .LBB1_53
# %bb.54:                               # %middle.block193
                                        #   in Loop: Header=BB1_28 Depth=1
	ld.d	$t8, $sp, 112                   # 8-byte Folded Reload
	beq	$t7, $a5, .LBB1_62
# %bb.55:                               # %vec.epilog.iter.check198
                                        #   in Loop: Header=BB1_28 Depth=1
	andi	$a7, $t7, 12
	beqz	$a7, .LBB1_59
.LBB1_56:                               # %vec.epilog.ph197
                                        #   in Loop: Header=BB1_28 Depth=1
	move	$a7, $t7
	...
	alsl.d	$t3, $t0, $a2, 2
	.p2align	4, , 16
.LBB1_57:                               # %vec.epilog.vector.body203
                                        #   Parent Loop BB1_28 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $t3, 0
	vst	$vr0, $a5, 0
	...
	addi.d	$t3, $t3, 16
	bnez	$t2, .LBB1_57
# %bb.58:                               # %vec.epilog.middle.block208
                                        #   in Loop: Header=BB1_28 Depth=1
	bne	$t7, $a7, .LBB1_60
	b	.LBB1_62
