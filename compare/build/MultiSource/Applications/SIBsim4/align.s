...
# %bb.39:                               # %while.body.i384
	...
	b	.LBB0_24
	.p2align	4, , 16
.LBB0_40:                               # %for.body244.preheader
                                        #   in Loop: Header=BB0_22 Depth=1
	bltu	$s3, $t1, .LBB0_45
# %bb.41:                               # %for.body244.preheader
                                        #   in Loop: Header=BB0_22 Depth=1
...
.LBB0_45:                               #   in Loop: Header=BB0_22 Depth=1
	ld.d	$s6, $sp, 192                   # 8-byte Folded Reload
.LBB0_46:                               # %for.body244.preheader590
                                        #   in Loop: Header=BB0_22 Depth=1
	addi.d	$t7, $t6, -1
	alsl.d	$t8, $t6, $a2, 2
	alsl.d	$t6, $t6, $a0, 2
...
.LBB0_51:                               # %vector.body547
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB0_51
# %bb.52:                               # %middle.block551
	beq	$a2, $a7, .LBB0_55
.LBB0_53:                               # %for.body274.preheader
	slli.d	$a2, $a1, 2
	sub.d	$a2, $a2, $s7
	add.d	$a2, $s6, $a2
...
# %bb.78:                               # %if.end4.i406
	...
	add.w	$fp, $s7, $s4
	blt	$t1, $fp, .LBB0_84
.LBB0_79:                               # %if.end9.i409
                                        #   in Loop: Header=BB0_69 Depth=2
	move	$a1, $s7
	.p2align	4, , 16
.LBB0_80:                               # %while.cond.i410
                                        #   Parent Loop BB0_65 Depth=1
                                        #     Parent Loop BB0_69 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	move	$a0, $s7
	bge	$a3, $fp, .LBB0_68
# %bb.81:                               # %while.cond.i410
...
.LBB0_91:                               #   in Loop: Header=BB0_65 Depth=1
	...
	ld.d	$t7, $sp, 248                   # 8-byte Folded Reload
	ld.d	$a2, $sp, 240                   # 8-byte Folded Reload
.LBB0_92:                               # %for.body387.preheader589
                                        #   in Loop: Header=BB0_65 Depth=1
	addi.d	$a0, $a2, -1
	alsl.d	$a1, $a2, $t5, 2
	alsl.d	$a2, $a2, $t2, 2
...
# %bb.114:                              # %if.then60
	bge	$t1, $a5, .LBB0_122
# %bb.115:                              # %land.rhs.preheader.i329
	ld.d	$a0, $sp, 352                   # 8-byte Folded Reload
	add.d	$a0, $a0, $a2
	move	$s0, $a2
	.p2align	4, , 16
.LBB0_116:                              # %land.rhs.i330
                                        # =>This Inner Loop Header: Depth=1
	ld.bu	$a1, $a0, 0
	ld.d	$a3, $sp, 360                   # 8-byte Folded Reload
	ldx.bu	$a3, $a3, $t1
	bne	$a1, $a3, .LBB0_119
# %bb.117:                              # %while.body.i338
                                        #   in Loop: Header=BB0_116 Depth=1
	addi.w	$s0, $s0, 1
	bge	$s0, $a4, .LBB0_119
# %bb.118:                              # %while.body.i338
                                        #   in Loop: Header=BB0_116 Depth=1
	addi.d	$t1, $t1, 1
	addi.d	$a0, $a0, 1
	blt	$t1, $a5, .LBB0_116
.LBB0_119:                              # %snake.exit345
	move	$s1, $t0
	bge	$a2, $s0, .LBB0_126
# %bb.120:                              # %if.then63
	ori	$a0, $zero, 16
...
.LBB1_28:                               # %if.else78
	...
	ld.w	$a7, $fp, 4
	bge	$a5, $a7, .LBB1_30
# %bb.29:                               # %if.else78.if.else98_crit_edge
                                        #   in Loop: Header=BB1_24 Depth=2
	ld.w	$fp, $fp, -4
	b	.LBB1_31
...
# %bb.34:                               # %if.end.i108
	...
	add.w	$a5, $s6, $t1
	bge	$a5, $s1, .LBB1_23
# %bb.35:                               # %land.rhs.preheader.i113
                                        #   in Loop: Header=BB1_24 Depth=2
	bstrpick.d	$a7, $s6, 31, 0
	add.d	$a7, $s4, $a7
	.p2align	4, , 16
.LBB1_36:                               # %land.rhs.i114
                                        #   Parent Loop BB1_21 Depth=1
	...
	ldx.bu	$fp, $s3, $a5
	bne	$t0, $fp, .LBB1_23
# %bb.37:                               # %while.body.i122
                                        #   in Loop: Header=BB1_36 Depth=3
	addi.w	$s6, $s6, 1
	bge	$s6, $s2, .LBB1_23
# %bb.38:                               # %while.body.i122
                                        #   in Loop: Header=BB1_36 Depth=3
	addi.d	$a5, $a5, 1
	addi.d	$a7, $a7, 1
	blt	$a5, $s1, .LBB1_36
	b	.LBB1_23
	.p2align	4, , 16
.LBB1_39:                               # %for.body138.preheader
                                        #   in Loop: Header=BB1_21 Depth=1
	ori	$a5, $zero, 8
	bltu	$t2, $a5, .LBB1_44
# %bb.40:                               # %for.body138.preheader
                                        #   in Loop: Header=BB1_21 Depth=1
...
.LBB1_44:                               #   in Loop: Header=BB1_21 Depth=1
	ld.d	$t7, $sp, 96                    # 8-byte Folded Reload
	ld.d	$t8, $sp, 72                    # 8-byte Folded Reload
.LBB1_45:                               # %for.body138.preheader189
                                        #   in Loop: Header=BB1_21 Depth=1
	addi.d	$a5, $t5, -1
	alsl.d	$a7, $t5, $a2, 2
	alsl.d	$t1, $t5, $a0, 2
...
.LBB3_11:                               #   in Loop: Header=BB3_6 Depth=1
	move	$a5, $a4
	b	.LBB3_5
.LBB3_12:                               # %while.body.us.us.preheader
	ori	$a2, $zero, 2
	ori	$a3, $zero, 3
	move	$a4, $a1
	b	.LBB3_16
	.p2align	4, , 16
.LBB3_13:                               # %if.else13.us.us
                                        #   in Loop: Header=BB3_16 Depth=1
	sub.d	$a6, $zero, $a6
.LBB3_14:                               # %if.end23.us.us.sink.split
                                        #   in Loop: Header=BB3_16 Depth=1
	addi.d	$a5, $a4, 4
	st.w	$a6, $a4, 0
.LBB3_15:                               # %if.end23.us.us
                                        #   in Loop: Header=BB3_16 Depth=1
	ld.d	$a0, $a0, 0
	move	$a4, $a5
	beqz	$a0, .LBB3_22
.LBB3_16:                               # %while.body.us.us
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB3_20 Depth 2
	ld.bu	$a5, $a0, 12
	ld.w	$a6, $a0, 8
	beq	$a5, $a2, .LBB3_14
# %bb.17:                               # %while.body.us.us
                                        #   in Loop: Header=BB3_16 Depth=1
	bne	$a5, $a3, .LBB3_13
# %bb.18:                               # %for.cond.preheader.us.us
                                        #   in Loop: Header=BB3_16 Depth=1
	blez	$a6, .LBB3_21
