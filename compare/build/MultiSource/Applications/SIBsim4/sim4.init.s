...
# %bb.0:                                # %entry
	...
	move	$fp, $a0
	ld.w	$a0, $a0, 36
	pcalau12i	$a4, %pc_hi20(options)
	addi.d	$s4, $a4, %pc_lo12(options)
	ld.w	$a4, $s4, 76
	bltu	$a0, $a4, .LBB4_63
# %bb.1:                                # %if.then
	move	$s0, $a3
...
# %bb.73:                               # %middle.block
	...
	bne	$a6, $a4, .LBB4_28
	b	.LBB4_31
.LBB4_74:                               # %vector.scevcheck33
	addi.w	$t3, $a4, -2
	addi.d	$a3, $a6, -1
	addi.w	$t4, $a3, 0
	move	$t2, $zero
	bltu	$t3, $t4, .LBB4_80
# %bb.75:                               # %vector.scevcheck33
	srli.d	$t4, $a3, 32
	move	$a3, $t2
	bnez	$t4, .LBB4_55
# %bb.76:                               # %vector.ph36
	bstrpick.d	$a3, $a6, 31, 3
	slli.d	$t2, $a3, 3
	vrepli.b	$vr0, 0
	vrepli.b	$vr1, 84
	vrepli.w	$vr2, 1
