...
# %bb.0:                                # %entry
	...
	.cfi_offset 23, -24
	move	$fp, $a0
	pcalau12i	$a0, %got_pc_hi20(clone_lookups)
	ld.d	$a0, $a0, %got_pc_lo12(clone_lookups)
	ld.d	$a0, $a0, 0
	beqz	$a0, .LBB0_3
# %bb.1:                                # %if.end
...
.LBB9_4:                                # %while.body.i
	...
	addi.w	$a1, $a1, 1
	bnez	$a0, .LBB9_4
# %bb.5:                                # %_ZN12HexxagonGame8noBoardsEv.exit.loopexit
	revb.2w	$a0, $a1
	bstrpick.d	$a0, $a0, 31, 0
	b	.LBB9_9
.LBB9_6:
...
.LBB9_8:
	move	$a0, $zero
.LBB9_9:                                # %_ZN12HexxagonGame8noBoardsEv.exit
	st.d	$a0, $sp, 0
	addi.d	$a0, $sp, 0
	ori	$a1, $zero, 8
	ori	$a2, $zero, 1
