...
# %bb.0:                                # %entry
	ld.d	$a0, $a0, 8
	pcalau12i	$a3, %pc_hi20(_ZL17global_filterview)
	pcalau12i	$a2, %pc_hi20(_ZN2kcL27filterrewriteruleinfoonviewEPNS_20impl_rewriteruleinfoE)
	addi.d	$a2, $a2, %pc_lo12(_ZN2kcL27filterrewriteruleinfoonviewEPNS_20impl_rewriteruleinfoE)
	st.d	$a1, $a3, %pc_lo12(_ZL17global_filterview)
	move	$a1, $a2
