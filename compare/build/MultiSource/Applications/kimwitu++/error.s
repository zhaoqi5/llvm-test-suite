...
# %bb.0:                                # %entry
	...
	ld.d	$a0, $a0, 24
	pcalau12i	$a2, %pc_hi20(_ZTV14kc_filePrinter+16)
	addi.d	$a3, $a2, %pc_lo12(_ZTV14kc_filePrinter+16)
	addi.d	$a2, $a1, 40
	st.d	$a3, $a1, 0
	beq	$a0, $a2, .LBB1_2
# %bb.1:                                # %if.then.i.i
...
.LBB4_3:                                # %sw.bb2
	...
	ld.d	$a3, $a0, %got_pc_lo12(g_options)
	ld.w	$a1, $fp, 16
	ld.bu	$a2, $a3, 114
	addi.d	$a0, $a1, 1
	ori	$a4, $zero, 1
...
# %bb.5:                                # %if.then.i.i.i.i
	...
	b	.LBB6_8
.LBB6_6:                                # %if.else
	pcalau12i	$a1, %got_pc_hi20(_ZN2kc10view_errorE)
	ld.d	$a2, $a1, %got_pc_lo12(_ZN2kc10view_errorE)
