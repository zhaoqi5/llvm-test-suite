...
.LBB0_169:                              # %if.end1102
	pcaddu18i	$ra, %call36(_ZN12_GLOBAL__N_15countEb)
	jirl	$ra, $ra, 0
.LBB0_170:                              # %if.else1089
	pcalau12i	$a0, %pc_hi20(yytext)
	addi.d	$a0, $a0, %pc_lo12(yytext)
.LBB0_171:                              # %cleanup1377
	addi.w	$a1, $zero, -1
...
.LBB9_17:                               # %for.body
	...
	move	$t2, $t0
	bgez	$t1, .LBB9_17
.LBB9_18:                               # %for.end.loopexit
	ld.d	$s1, $a6, 0
.LBB9_19:                               # %for.end
	ld.w	$a5, $s1, 56
	bne	$a5, $a4, .LBB9_24
# %bb.20:                               # %if.end86.thread
	st.w	$zero, $s3, %pc_lo12(_ZL10yy_n_chars)
.LBB9_21:                               # %if.then88.sink.split
	st.w	$zero, $s1, 28
.LBB9_22:                               # %if.then88
	beqz	$s4, .LBB9_34
# %bb.23:                               # %if.else91
...
# %bb.25:                               # %while.end
	...
	or	$s0, $a0, $a1
	beqz	$a2, .LBB9_35
# %bb.26:                               # %land.lhs.true.lr.ph
	move	$fp, $zero
	pcalau12i	$s1, %pc_hi20(yyin)
	addi.w	$s7, $zero, -1
	ori	$s8, $zero, 10
	.p2align	4, , 16
.LBB9_27:                               # %land.lhs.true
                                        # =>This Inner Loop Header: Depth=1
