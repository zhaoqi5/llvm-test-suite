...
.Ltmp47:                                # EH_LABEL
	ori	$s4, $zero, 32
	ori	$s6, $zero, 99
.LBB3_43:                               # %if.end48.i.i
                                        #   in Loop: Header=BB3_44 Depth=1
	ld.w	$a0, $s8, 4
.LBB3_44:                               # %for.cond.i.i
...
# %bb.46:                               # %_ZN12StreamBufferdeEv.exit.i.i.i
	...
	ldx.b	$a2, $s2, $a1
	blt	$a2, $s0, .LBB3_52
# %bb.47:                               # %_ZN12StreamBufferdeEv.exit13.i.i.i
                                        #   in Loop: Header=BB3_45 Depth=2
	andi	$a2, $a2, 255
	bltu	$a2, $s7, .LBB3_49
...
.Ltmp6:                                 # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp7:                                 # EH_LABEL
# %bb.51:                               # %call3.i.i.i.noexc.i.i
                                        #   in Loop: Header=BB3_45 Depth=2
	ld.w	$a1, $s8, 0
	st.w	$a0, $s8, 4
	b	.LBB3_45
	.p2align	4, , 16
.LBB3_52:                               # %invoke.cont.i.i
                                        #   in Loop: Header=BB3_44 Depth=1
	addi.w	$a2, $a0, 0
	bge	$a1, $a2, .LBB3_102
...
# %bb.56:                               # %if.else42.i.i
	...
	ld.d	$a0, $sp, 592
	beqz	$a0, .LBB3_58
# %bb.57:                               # %for.cond.preheader.i.i.i.i
                                        #   in Loop: Header=BB3_44 Depth=1
	st.w	$zero, $sp, 600
...
.Ltmp40:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp41:                                # EH_LABEL
# %bb.63:                               # %call3.i.noexc.i.i
                                        #   in Loop: Header=BB3_62 Depth=3
	ld.w	$a0, $sp, 328
	blt	$a0, $s6, .LBB3_62
.LBB3_64:                               # %while.end.i.i.i
                                        #   in Loop: Header=BB3_60 Depth=2
	ld.w	$a1, $sp, 600
	ld.w	$a2, $sp, 604
	ld.d	$a0, $sp, 592
	bne	$a1, $a2, .LBB3_59
# %bb.65:                               # %if.then.i.i.i.i
                                        #   in Loop: Header=BB3_60 Depth=2
	alsl.d	$a1, $a1, $a1, 1
	addi.w	$a1, $a1, 1
	srai.d	$a1, $a1, 1
	...
	b	.LBB3_59
	.p2align	4, , 16
.LBB3_66:                               # %call3.i.i33.i.noexc.i.i
                                        #   in Loop: Header=BB3_68 Depth=2
	ld.w	$a1, $s8, 0
	st.w	$a0, $s8, 4
.LBB3_67:                               # %_ZN12StreamBufferppEv.exit35.i.i.i
                                        #   in Loop: Header=BB3_68 Depth=2
	addi.w	$a2, $a0, 0
	bge	$a1, $a2, .LBB3_43
.LBB3_68:                               # %_ZN12StreamBufferdeEv.exit.i79.i.i
                                        #   Parent Loop BB3_44 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.bu	$a3, $s2, $a1
	beqz	$a3, .LBB3_43
# %bb.69:                               # %_ZN12StreamBufferdeEv.exit.i79.i.i
                                        #   in Loop: Header=BB3_68 Depth=2
	beq	$a3, $fp, .LBB3_43
...
.Ltmp12:                                # EH_LABEL
	b	.LBB3_66
.LBB3_73:                               # %if.then5.i.i.i
                                        #   in Loop: Header=BB3_44 Depth=1
	st.w	$a1, $s8, 0
	blt	$a1, $a2, .LBB3_43
# %bb.74:                               # %if.then.i.i.i84.i.i
                                        #   in Loop: Header=BB3_44 Depth=1
	ld.d	$a0, $s1, 0
	st.w	$zero, $s8, 0
	pcaddu18i	$ra, %call36(fileno)
...
.Ltmp9:                                 # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp10:                                # EH_LABEL
# %bb.75:                               # %call3.i.i.i.noexc89.i.i
                                        #   in Loop: Header=BB3_44 Depth=1
	st.w	$a0, $s8, 4
	ld.w	$a0, $s8, 4
	b	.LBB3_44
.LBB3_76:                               # %for.inc.i.i.i
                                        #   in Loop: Header=BB3_44 Depth=1
	addi.w	$a1, $a1, 1
	st.w	$a1, $s8, 0
	blt	$a1, $a2, .LBB3_79
# %bb.77:                               # %if.then.i.i.i34.i.i
                                        #   in Loop: Header=BB3_44 Depth=1
	ld.d	$a0, $s1, 0
	st.w	$zero, $s8, 0
	pcaddu18i	$ra, %call36(fileno)
...
.Ltmp14:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp15:                                # EH_LABEL
# %bb.78:                               # %call3.i.i.i.noexc39.i.i
                                        #   in Loop: Header=BB3_44 Depth=1
	ld.w	$a1, $s8, 0
	st.w	$a0, $s8, 4
.LBB3_79:                               # %_ZN12StreamBufferppEv.exit.i38.i.i
                                        #   in Loop: Header=BB3_44 Depth=1
	addi.w	$a2, $a0, 0
	bge	$a1, $a2, .LBB3_112
# %bb.80:                               # %_ZN12StreamBufferdeEv.exit.1.i.i.i
	...
	ldx.bu	$a3, $s2, $a1
	bne	$a3, $s4, .LBB3_112
# %bb.81:                               # %for.inc.1.i.i.i
                                        #   in Loop: Header=BB3_44 Depth=1
	addi.w	$a1, $a1, 1
	st.w	$a1, $s8, 0
	blt	$a1, $a2, .LBB3_84
# %bb.82:                               # %if.then.i.i.1.i.i.i
                                        #   in Loop: Header=BB3_44 Depth=1
	ld.d	$a0, $s1, 0
	st.w	$zero, $s8, 0
	pcaddu18i	$ra, %call36(fileno)
...
# %bb.85:                               # %_ZN12StreamBufferdeEv.exit.2.i.i.i
	...
	ldx.bu	$a3, $s2, $a1
	bne	$a3, $s6, .LBB3_112
# %bb.86:                               # %for.inc.2.i.i.i
                                        #   in Loop: Header=BB3_44 Depth=1
	addi.w	$a1, $a1, 1
	st.w	$a1, $s8, 0
	blt	$a1, $a2, .LBB3_89
# %bb.87:                               # %if.then.i.i.2.i.i.i
                                        #   in Loop: Header=BB3_44 Depth=1
	ld.d	$a0, $s1, 0
	st.w	$zero, $s8, 0
	pcaddu18i	$ra, %call36(fileno)
...
# %bb.90:                               # %_ZN12StreamBufferdeEv.exit.3.i.i.i
	...
	ori	$a4, $zero, 110
	bne	$a3, $a4, .LBB3_112
# %bb.91:                               # %for.inc.3.i.i.i
                                        #   in Loop: Header=BB3_44 Depth=1
	addi.w	$a1, $a1, 1
	st.w	$a1, $s8, 0
	blt	$a1, $a2, .LBB3_94
# %bb.92:                               # %if.then.i.i.3.i.i.i
                                        #   in Loop: Header=BB3_44 Depth=1
	ld.d	$a0, $s1, 0
	st.w	$zero, $s8, 0
	pcaddu18i	$ra, %call36(fileno)
...
# %bb.95:                               # %_ZN12StreamBufferdeEv.exit.4.i.i.i
	...
	ori	$a3, $zero, 102
	bne	$a2, $a3, .LBB3_112
# %bb.96:                               # %for.inc.4.i.i.i
                                        #   in Loop: Header=BB3_44 Depth=1
	addi.w	$a1, $a1, 1
	st.w	$a1, $s8, 0
	blt	$a1, $a0, .LBB3_99
# %bb.97:                               # %if.then.i.i.4.i.i.i
                                        #   in Loop: Header=BB3_44 Depth=1
	ld.d	$a0, $s1, 0
	st.w	$zero, $s8, 0
	pcaddu18i	$ra, %call36(fileno)
...
.Ltmp22:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp23:                                # EH_LABEL
# %bb.98:                               # %call3.i.i.4.i.noexc.i.i
                                        #   in Loop: Header=BB3_44 Depth=1
	st.w	$a0, $s8, 4
.LBB3_99:                               # %if.then8.i.i
                                        #   in Loop: Header=BB3_44 Depth=1
.Ltmp24:                                # EH_LABEL
	move	$a0, $s1
	pcaddu18i	$ra, %call36(_ZL8parseIntI12StreamBufferEiRT_)
...
# %bb.101:                              # %invoke.cont13.i.i
	...
	ld.w	$a0, $s8, 4
	b	.LBB3_44
.LBB3_102:                              # %for.end.i.i
	ld.d	$a0, $sp, 592
	beqz	$a0, .LBB3_104
# %bb.103:                              # %for.cond.preheader.i.i103.i.i
	st.w	$zero, $sp, 600
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB3_104:                              # %invoke.cont167
	ori	$a1, $s3, 16
	move	$a0, $s1
...
.LBB3_106:
	move	$fp, $zero
.LBB3_107:                              # %cond.end177
.Ltmp30:                                # EH_LABEL
	addi.d	$a0, $sp, 56
	pcaddu18i	$ra, %call36(_ZN6Solver8simplifyEv)
	jirl	$ra, $ra, 0
.Ltmp31:                                # EH_LABEL
# %bb.108:                              # %invoke.cont179
	bnez	$a0, .LBB3_126
# %bb.109:                              # %if.then181
	ld.d	$a0, $s0, 0
	pcaddu18i	$ra, %call36(fflush)
...
.LBB3_112:                              # %if.else25.i.i
	...
	ld.d	$a0, $fp, 0
	bge	$a1, $a2, .LBB3_114
# %bb.113:                              # %cond.false.i49.i.i
	ldx.b	$a2, $s2, $a1
	b	.LBB3_115
.LBB3_114:
	addi.w	$a2, $zero, -1
.LBB3_115:                              # %_ZN12StreamBufferdeEv.exit54.i.i
...
.LBB3_133:                              # %for.inc238.peel
	ori	$s4, $zero, 2
	blt	$a0, $s4, .LBB3_141
# %bb.134:                              # %for.body219.preheader238
	ori	$s7, $zero, 1
