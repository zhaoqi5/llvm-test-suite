...
.LBB20_56:                              # %cleanup152
	beqz	$s1, .LBB20_58
# %bb.57:                               # %for.cond.preheader.i.i240
	move	$a0, $s1
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB20_58:                              # %_ZN3vecI3LitED2Ev.exit243
	move	$a0, $s0
	fld.d	$fs1, $sp, 56                   # 8-byte Folded Reload
	fld.d	$fs0, $sp, 64                   # 8-byte Folded Reload
	ld.d	$s8, $sp, 72                    # 8-byte Folded Reload
...
.LBB20_72:                              # %invoke.cont37.thread
	...
	fdiv.d	$fa0, $fa1, $fa0
	b	.LBB20_74
.LBB20_73:                              # %invoke.cont37.thread306
	move	$s0, $zero
	fdiv.d	$fa0, $fs1, $fa0
.LBB20_74:                              # %cleanup152
	fst.d	$fa0, $fp, 456
...
.LBB20_75:
	move	$s0, $zero
	b	.LBB20_56
.LBB20_76:                              # %for.cond.cleanup.loopexit.i136
	ld.w	$s4, $s2, 0
.LBB20_77:                              # %for.cond.cleanup.i105
	st.w	$a0, $fp, 376
	ld.w	$a0, $s3, 0
	bge	$a0, $s4, .LBB20_79
# %bb.78:                               # %for.body.lr.ph.i.i113
	st.w	$a0, $s2, 0
.LBB20_79:                              # %_ZN3vecI3LitE6shrinkEi.exit.i110
	ld.w	$a0, $fp, 336
	move	$s0, $zero
	ori	$a1, $zero, 1
	blt	$a0, $a1, .LBB20_56
# %bb.80:                               # %for.body.lr.ph.i16.i112
	st.w	$zero, $fp, 336
	b	.LBB20_56
