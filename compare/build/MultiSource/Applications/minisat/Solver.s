...
.LBB5_27:                               # %cleanup
	...
	stx.d	$s5, $a0, $a1
	b	.LBB5_6
.LBB5_28:                               # %while.body92.preheader148
                                        #   in Loop: Header=BB5_7 Depth=2
	move	$s8, $s1
	.p2align	4, , 16
...
.LBB13_56:                              # %_ZN3vecI3LitE6growToEi.exit.i176
	...
	bge	$s3, $s4, .LBB13_108
	b	.LBB13_133
.LBB13_57:                              # %vector.main.loop.iter.check399
	ori	$a4, $zero, 17
	addi.d	$a3, $s3, -1
	bgeu	$s3, $a4, .LBB13_59
# %bb.58:
...
# %bb.61:                               # %middle.block409
	...
	beq	$a3, $a4, .LBB13_83
# %bb.62:                               # %vec.epilog.iter.check414
	andi	$a5, $a3, 12
	beqz	$a5, .LBB13_80
.LBB13_63:                              # %vec.epilog.ph413
	move	$a6, $a3
	...
	sub.d	$a4, $a4, $a6
	.p2align	4, , 16
.LBB13_64:                              # %vec.epilog.vector.body419
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a7, 0
	vsrai.w	$vr1, $vr1, 1
	...
	addi.d	$a7, $a7, 16
	bnez	$a4, .LBB13_64
# %bb.65:                               # %vec.epilog.middle.block425
	vshuf4i.w	$vr1, $vr0, 14
	vor.v	$vr0, $vr0, $vr1
	vreplvei.w	$vr1, $vr0, 1
	vor.v	$vr0, $vr0, $vr1
...
# %bb.94:
	move	$a4, $a1
	b	.LBB13_120
.LBB13_95:                              # %vector.main.loop.iter.check435
	ori	$a3, $zero, 16
	bgeu	$a2, $a3, .LBB13_97
# %bb.96:
	move	$a3, $zero
	b	.LBB13_101
.LBB13_97:                              # %vector.ph436
	move	$a3, $a2
	bstrins.d	$a3, $zero, 3, 0
	alsl.d	$a4, $a1, $a0, 2
	addi.d	$a4, $a4, 32
...
.LBB13_98:                              # %vector.body439
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB13_98
# %bb.99:                               # %middle.block442
	beq	$a2, $a3, .LBB13_122
# %bb.100:                              # %vec.epilog.iter.check447
	andi	$a4, $a2, 12
	beqz	$a4, .LBB13_119
.LBB13_101:                             # %vec.epilog.ph446
	move	$a5, $a2
	bstrins.d	$a5, $zero, 1, 0
	add.d	$a4, $a5, $a1
	slli.d	$a6, $a3, 2
	...
	vrepli.w	$vr0, -2
	.p2align	4, , 16
.LBB13_102:                             # %vec.epilog.vector.body452
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a1, 0
	addi.d	$a3, $a3, 4
	addi.d	$a1, $a1, 16
	bnez	$a3, .LBB13_102
# %bb.103:                              # %vec.epilog.middle.block456
	bne	$a2, $a5, .LBB13_120
	b	.LBB13_122
.LBB13_104:
	add.d	$a4, $a3, $a1
...
.LBB20_72:                              # %invoke.cont37.thread
	...
	fdiv.d	$fa0, $fa1, $fa0
	b	.LBB20_74
.LBB20_73:                              # %invoke.cont37.thread333
	move	$s0, $zero
	fdiv.d	$fa0, $fs1, $fa0
.LBB20_74:                              # %cleanup152
	fst.d	$fa0, $fp, 456
