...
.LBB0_12:                               # %sw.epilog
	...
	ld.d	$a4, $a4, %got_pc_lo12(std_exps)
	pcalau12i	$a5, %got_pc_hi20(donestkptr)
	ld.d	$a5, $a5, %got_pc_lo12(donestkptr)
	st.w	$s1, $a1, 12
	st.w	$a3, $a1, 16
	addi.d	$a3, $a4, 408
	ld.d	$a4, $a5, 0
...
# %bb.0:                                # %entry
	...
	move	$fp, $a0
	sltu	$a0, $a1, $a2
	pcalau12i	$a3, %got_pc_hi20(ch)
	ld.d	$a3, $a3, %got_pc_lo12(ch)
	masknez	$a2, $a2, $a0
	maskeqz	$a0, $a1, $a0
	or	$s3, $a0, $a2
	ld.w	$s7, $a3, 0
...
# %bb.1:                                # %invoke.cont
	...
	pcalau12i	$a3, %got_pc_hi20(donestkptr)
	ld.d	$a3, $a3, %got_pc_lo12(donestkptr)
	st.w	$s0, $a0, 12
	st.w	$s3, $a0, 16
	addi.d	$a2, $a2, 408
	ld.d	$a4, $a3, 0
