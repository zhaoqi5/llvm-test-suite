...
# %bb.0:                                # %entry
	...
	ld.d	$s6, $a0, %got_pc_lo12(currpc)
	ld.w	$s0, $s6, 0
	addi.d	$a0, $s0, 2
	st.w	$a0, $s6, 0
	pcalau12i	$a0, %got_pc_hi20(bufflength)
	ld.d	$a1, $a0, %got_pc_lo12(bufflength)
	ld.w	$a0, $a1, 0
	addi.d	$a0, $a0, -2
	st.d	$a1, $sp, 80                    # 8-byte Folded Spill
	st.w	$a0, $a1, 0
	pcalau12i	$a0, %got_pc_hi20(inbuff)
	ld.d	$s2, $a0, %got_pc_lo12(inbuff)
	ld.d	$a0, $s2, 0
	addi.d	$a1, $a0, 2
	st.d	$a1, $s2, 0
	ld.bu	$a1, $a0, 0
...
# %bb.9:                                # %for.body.preheader
	...
	ori	$a2, $zero, 4
	ori	$a3, $zero, 10
	pcalau12i	$a4, %got_pc_hi20(std_exps)
	ld.d	$a5, $a4, %got_pc_lo12(std_exps)
	addi.d	$a4, $a5, 48
	addi.d	$a5, $a5, 72
	move	$a6, $s6
...
.Ltmp22:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp23:                                # EH_LABEL
# %bb.27:                               # %_ZN3ExpC2Ejj7Exptype4Type2OpPS_jPS3_.exit215
	ori	$a1, $zero, 0
	lu32i.d	$a1, 6
	st.d	$a1, $a0, 0
	st.w	$s8, $a0, 8
...
.Ltmp13:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp14:                                # EH_LABEL
# %bb.33:                               # %_ZN3ExpC2Ejj7Exptype4Type2OpPS_jPS3_.exit254
	ori	$a1, $zero, 0
	lu32i.d	$a1, 6
	st.d	$a1, $a0, 0
	st.w	$s1, $a0, 8
...
.Ltmp25:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp26:                                # EH_LABEL
# %bb.35:                               # %_ZN3ExpC2Ejj7Exptype4Type2OpPS_jPS3_.exit194
...
.Ltmp16:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp17:                                # EH_LABEL
# %bb.39:                               # %_ZN3ExpC2Ejj7Exptype4Type2OpPS_jPS3_.exit264
	ori	$a1, $zero, 0
	lu32i.d	$a1, 6
	st.d	$a1, $a0, 0
	st.w	$s1, $a0, 8
...
.LBB0_76:                               # %lpad237
.Ltmp9:                                 # EH_LABEL
.LBB0_77:                               # %ehcleanup270
	move	$s0, $a0
	move	$fp, $s2
	b	.LBB0_80
.LBB0_78:                               # %lpad
.Ltmp4:                                 # EH_LABEL
.LBB0_79:                               # %ehcleanup270
	move	$s0, $a0
