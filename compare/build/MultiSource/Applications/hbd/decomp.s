...
# %bb.7:                                # %while.body.preheader
	...
	pcalau12i	$s6, %pc_hi20(lastaction)
	pcalau12i	$a1, %pc_hi20(actions)
	addi.d	$s7, $a1, %pc_lo12(actions)
	pcalau12i	$a1, %pc_hi20(.L.str.7)
	addi.d	$a1, $a1, %pc_lo12(.L.str.7)
	st.d	$a1, $sp, 64                    # 8-byte Folded Spill
	pcalau12i	$a1, %pc_hi20(actiontable)
	addi.d	$s8, $a1, %pc_lo12(actiontable)
	move	$s0, $zero
	b	.LBB1_10
	.p2align	4, , 16
.LBB1_8:                                # %if.else
...
# %bb.54:                               # %if.then175
	...
	jirl	$ra, $ra, 0
	beqz	$s4, .LBB1_56
# %bb.55:                               # %delete.notnull181
                                        #   in Loop: Header=BB1_43 Depth=1
	move	$a0, $s4
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB1_56:                               # %delete.end182
                                        #   in Loop: Header=BB1_43 Depth=1
	ld.d	$a1, $sp, 72                    # 8-byte Folded Reload
	ld.wu	$a0, $a1, %pc_lo12(indentlevel)
	addi.d	$s0, $a0, 1
...
# %bb.59:                               # %if.then.i203
	...
	ld.d	$a0, $sp, 56                    # 8-byte Folded Reload
	st.d	$zero, $a0, 8
.LBB1_60:                               # %_ZN8looplist3popEv.exit205
                                        #   in Loop: Header=BB1_43 Depth=1
	ori	$a0, $zero, 16
	pcaddu18i	$ra, %call36(_Znwm)
	jirl	$ra, $ra, 0
...
# %bb.82:                               # %if.then.i266
	...
	ld.d	$a0, $sp, 64                    # 8-byte Folded Reload
	st.d	$zero, $a0, 8
.LBB1_83:                               # %_ZN7intlist3popEv.exit268
                                        #   in Loop: Header=BB1_43 Depth=1
	move	$a0, $s7
	move	$a1, $zero
	pcaddu18i	$ra, %call36(_ZN3Exp8toStringEj)
...
.LBB1_85:                               # %for.body367
	...
	jirl	$ra, $ra, 0
	bnez	$s3, .LBB1_85
.LBB1_86:                               # %delete.notnull374
                                        #   in Loop: Header=BB1_43 Depth=1
	move	$a0, $s4
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB1_87:                               # %delete.end375
                                        #   in Loop: Header=BB1_43 Depth=1
	ld.d	$a3, $fp, 8
	pcalau12i	$a0, %pc_hi20(.L.str.12)
	addi.d	$a0, $a0, %pc_lo12(.L.str.12)
...
# %bb.96:                               # %if.then.i249
	...
	ld.d	$a0, $sp, 64                    # 8-byte Folded Reload
	st.d	$zero, $a0, 8
.LBB1_97:                               # %_ZN7intlist3popEv.exit251
                                        #   in Loop: Header=BB1_43 Depth=1
	ld.d	$a1, $s3, 0
	ld.d	$a0, $fp, 8
	ld.w	$a2, $a1, 16
...
# %bb.104:                              # %if.then.i229
	...
	ld.d	$a0, $sp, 48                    # 8-byte Folded Reload
	st.d	$zero, $a0, 8
.LBB1_105:                              # %_ZN8looplist3popEv.exit231
                                        #   in Loop: Header=BB1_43 Depth=1
	ld.d	$a1, $sp, 72                    # 8-byte Folded Reload
	ld.w	$a0, $a1, %pc_lo12(indentlevel)
	addi.w	$s5, $a0, -1
...
# %bb.118:                              # %if.then.i277
	...
	ld.d	$a0, $sp, 32                    # 8-byte Folded Reload
	st.d	$zero, $a0, 8
.LBB1_119:                              # %_ZN7intlist3popEv.exit279
                                        #   in Loop: Header=BB1_43 Depth=1
	ld.d	$a3, $fp, 8
	pcalau12i	$a0, %pc_hi20(.L.str.12)
	addi.d	$a0, $a0, %pc_lo12(.L.str.12)
