...
# %bb.17:                               # %while.end
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB1_20
# %bb.18:                               # %while.body176.preheader
	ori	$s1, $zero, 46
	.p2align	4, , 16
.LBB1_19:                               # %while.body176
                                        # =>This Inner Loop Header: Depth=1
	addi.d	$a2, $a0, 1
	st.b	$s1, $a0, 0
	ori	$a1, $zero, 47
...
# %bb.50:                               # %while.cond289.preheader
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB1_54
# %bb.51:                               # %while.cond289.preheader
                                        #   in Loop: Header=BB1_46 Depth=2
	bgeu	$a0, $s5, .LBB1_54
	.p2align	4, , 16
.LBB1_52:                               # %while.body293
                                        #   Parent Loop BB1_27 Depth=1
...
.LBB1_63:                               # %land.lhs.true313
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB1_58
# %bb.64:                               # %land.lhs.true313
                                        #   in Loop: Header=BB1_46 Depth=2
	bgeu	$a0, $s5, .LBB1_58
	.p2align	4, , 16
.LBB1_65:                               # %while.body324
                                        #   Parent Loop BB1_27 Depth=1
                                        #     Parent Loop BB1_46 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	addi.d	$s6, $a0, 1
...
# %bb.70:                               # %for.cond349
	...
	addi.d	$s4, $s4, -8
	bgtz	$s0, .LBB1_69
# %bb.71:                               #   in Loop: Header=BB1_46 Depth=2
	ld.d	$a0, $sp, 24                    # 8-byte Folded Reload
	st.d	$a0, $sp, 56                    # 8-byte Folded Spill
	b	.LBB1_74
.LBB1_72:                               #   in Loop: Header=BB1_46 Depth=2
	st.d	$s2, $sp, 56                    # 8-byte Folded Spill
	addi.d	$s2, $fp, 144
	ld.d	$s1, $sp, 40                    # 8-byte Folded Reload
	ori	$s0, $zero, 76
	b	.LBB1_59
.LBB1_73:                               # %delete.notnull
                                        #   in Loop: Header=BB1_46 Depth=2
	move	$a0, $s5
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
...
# %bb.87:                               # %while.body424.preheader
	...
	b	.LBB1_90
	.p2align	4, , 16
.LBB1_88:                               #   in Loop: Header=BB1_90 Depth=2
	move	$s5, $s6
.LBB1_89:                               # %if.end519
...
# %bb.94:                               # %while.cond438.preheader
	...
	ori	$s5, $zero, 46
	beqz	$a0, .LBB1_98
# %bb.95:                               # %while.cond438.preheader
                                        #   in Loop: Header=BB1_90 Depth=2
	bgeu	$a0, $s7, .LBB1_98
	.p2align	4, , 16
.LBB1_96:                               # %while.body444
                                        #   Parent Loop BB1_84 Depth=1
...
.LBB1_102:                              # %land.lhs.true464
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB1_88
# %bb.103:                              # %land.lhs.true464
                                        #   in Loop: Header=BB1_90 Depth=2
	bgeu	$a0, $s7, .LBB1_88
	.p2align	4, , 16
.LBB1_104:                              # %while.body475
                                        #   Parent Loop BB1_84 Depth=1
                                        #     Parent Loop BB1_90 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	addi.d	$s5, $a0, 1
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB1_106
# %bb.105:                              # %while.body475
                                        #   in Loop: Header=BB1_104 Depth=3
	bltu	$a0, $s7, .LBB1_104
.LBB1_106:                              # %while.end478
                                        #   in Loop: Header=BB1_90 Depth=2
	sub.w	$s0, $s7, $s6
	slli.d	$a0, $s0, 32
...
# %bb.109:                              # %for.cond501
	...
	addi.d	$s2, $s2, -8
	bgtz	$s0, .LBB1_108
# %bb.110:                              #   in Loop: Header=BB1_90 Depth=2
...
.LBB1_111:                              # %if.then455
	...
	beq	$s8, $a0, .LBB1_88
	b	.LBB1_102
.LBB1_112:                              #   in Loop: Header=BB1_90 Depth=2
	st.d	$s1, $sp, 56                    # 8-byte Folded Spill
	ld.d	$s0, $sp, 32                    # 8-byte Folded Reload
	ld.d	$s1, $sp, 40                    # 8-byte Folded Reload
	ori	$s2, $zero, 76
	b	.LBB1_89
.LBB1_113:                              # %delete.notnull512
                                        #   in Loop: Header=BB1_90 Depth=2
	move	$a0, $s7
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
