...
# %bb.7:                                # %if.then
	...
	ld.d	$a0, $a0, %got_pc_lo12(cond_pcend)
	ld.w	$a4, $a0, 0
	addi.w	$a5, $zero, -1
	bne	$a4, $a5, .LBB1_27
# %bb.8:                                # %if.end
	pcalau12i	$a4, %got_pc_hi20(bufflength)
	ld.d	$a4, $a4, %got_pc_lo12(bufflength)
	pcalau12i	$a5, %got_pc_hi20(inbuff)
	ld.d	$a5, $a5, %got_pc_lo12(inbuff)
	ld.w	$a6, $a4, 0
	addi.w	$a3, $a3, 2
	ld.d	$a7, $a5, 0
	st.w	$a3, $a1, 0
	...
	ld.d	$a4, $a1, %got_pc_lo12(donestkptr)
	ld.h	$a1, $a7, 0
	pcalau12i	$a5, %got_pc_hi20(cond_e2)
	ld.d	$a5, $a5, %got_pc_lo12(cond_e2)
	ld.d	$a6, $a4, 0
	revb.2h	$a7, $a1
	st.d	$s1, $a5, 0
	ld.d	$a1, $a6, -8
	ext.w.h	$a5, $a7
	pcalau12i	$a7, %got_pc_hi20(cond_stkptr)
	ld.d	$a7, $a7, %got_pc_lo12(cond_stkptr)
	ld.d	$t0, $a1, 0
	add.d	$a5, $fp, $a5
	st.w	$a5, $a0, 0
	st.d	$s3, $a7, 0
...
# %bb.10:                               # %if.end70
	...
	ld.d	$a3, $a0, %got_pc_lo12(cond_e)
	pcalau12i	$a0, %got_pc_hi20(cond_donestkptr)
	ld.d	$a4, $a0, %got_pc_lo12(cond_donestkptr)
	move	$a0, $zero
	st.d	$a1, $a3, 0
	st.d	$a2, $a4, 0
	b	.LBB1_21
