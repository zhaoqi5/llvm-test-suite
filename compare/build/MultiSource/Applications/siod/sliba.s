...
# %bb.0:                                # %entry
	...
	move	$fp, $a0
	pcalau12i	$a0, %got_pc_hi20(heap)
	ld.d	$s1, $a0, %got_pc_lo12(heap)
	ld.d	$s0, $s1, 0
	pcalau12i	$a0, %got_pc_hi20(heap_end)
	ld.d	$a0, $a0, %got_pc_lo12(heap_end)
	ld.d	$a0, $a0, 0
	bltu	$s0, $a0, .LBB1_2
# %bb.1:                                # %if.then
...
# %bb.5:                                # %for.body34.lr.ph
	...
	ld.d	$s3, $a0, %got_pc_lo12(tkbuffer)
...
# %bb.0:                                # %entry
	...
	move	$s0, $a0
	pcalau12i	$a0, %got_pc_hi20(tkbuffer)
	ld.d	$a0, $a0, %got_pc_lo12(tkbuffer)
...
# %bb.5:
	ori	$s3, $zero, 21
	pcalau12i	$a0, %got_pc_hi20(stack_limit_ptr)
	ld.d	$s4, $a0, %got_pc_lo12(stack_limit_ptr)
	addi.d	$s5, $sp, 16
	ori	$s6, $zero, 6
	b	.LBB88_7
	.p2align	4, , 16
...
# %bb.11:
	...
	ori	$s6, $zero, 21
	pcalau12i	$a0, %got_pc_hi20(stack_limit_ptr)
	ld.d	$s7, $a0, %got_pc_lo12(stack_limit_ptr)
	move	$s0, $s8
	b	.LBB91_14
	.p2align	4, , 16
.LBB91_12:                              # %if.end.i21
...
# %bb.0:                                # %entry
	...
	jirl	$ra, $ra, 0
	move	$fp, $a0
	pcalau12i	$a0, %got_pc_hi20(siod_verbose_level)
	ld.d	$s2, $a0, %got_pc_lo12(siod_verbose_level)
	ld.d	$a0, $s2, 0
	ori	$a1, $zero, 3
	blt	$a0, $a1, .LBB99_2
# %bb.1:                                # %if.then
...
# %bb.0:                                # %entry
	...
	move	$s0, $a0
	pcalau12i	$a0, %got_pc_hi20(siod_verbose_level)
	ld.d	$a0, $a0, %got_pc_lo12(siod_verbose_level)
	st.d	$a0, $sp, 8                     # 8-byte Folded Spill
	ld.d	$a0, $a0, 0
	ori	$a1, $zero, 3
	blt	$a0, $a1, .LBB100_2
...
# %bb.1:                                # %for.body.lr.ph
	...
	b	.LBB114_4
	.p2align	4, , 16
.LBB114_2:                              # %if.then.i17
                                        #   in Loop: Header=BB114_4 Depth=1
	andi	$a0, $s6, 255
	addi.d	$a0, $a0, -48
.LBB114_3:                              # %xdigitvalue.exit29
                                        #   in Loop: Header=BB114_4 Depth=1
	slli.d	$a1, $s4, 4
	add.d	$a0, $a0, $a1
	st.b	$a0, $s3, 0
