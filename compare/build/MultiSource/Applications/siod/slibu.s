...
.LBB30_3:                               # %cond.end
	...
	addi.d	$a5, $a2, %pc_lo12(.L.str.26)
	pcalau12i	$a2, %pc_hi20(.L.str.27)
	addi.d	$a7, $a2, %pc_lo12(.L.str.27)
	lu12i.w	$a4, 4096
	ori	$a2, $zero, 8
	ori	$a6, $zero, 1
	st.d	$a0, $sp, 0
...
# %bb.0:                                # %entry
	...
	pcalau12i	$a3, %pc_hi20(.L.str.59)
	addi.d	$a4, $a3, %pc_lo12(.L.str.59)
	pcalau12i	$a3, %pc_hi20(.L.str.60)
	addi.d	$a6, $a3, %pc_lo12(.L.str.60)
	st.d	$a1, $sp, 0
...
# %bb.0:                                # %entry
	...
	pcalau12i	$a3, %got_pc_hi20(catch_framep)
	ld.d	$s1, $a3, %got_pc_lo12(catch_framep)
	ld.d	$a3, $s1, 0
	move	$s0, $a2
	move	$fp, $a1
	st.d	$a0, $sp, 8
...
# %bb.0:                                # %entry
	...
	addi.d	$a4, $a3, %pc_lo12(.L.str.104)
	pcalau12i	$a3, %pc_hi20(.L.str.105)
	addi.d	$a6, $a3, %pc_lo12(.L.str.105)
	st.d	$a1, $sp, 0
	move	$a1, $fp
	move	$a3, $s0
	move	$a5, $s1
...
# %bb.0:                                # %entry
	...
	pcaddu18i	$ra, %call36(init_subr_1)
	jirl	$ra, $ra, 0
	pcalau12i	$a0, %got_pc_hi20(car)
	ld.d	$a1, $a0, %got_pc_lo12(car)
	pcalau12i	$a0, %pc_hi20(.L.str.150)
	addi.d	$a0, $a0, %pc_lo12(.L.str.150)
	pcaddu18i	$ra, %call36(init_subr_1)
	jirl	$ra, $ra, 0
	pcalau12i	$a0, %got_pc_hi20(cdr)
	ld.d	$a1, $a0, %got_pc_lo12(cdr)
...
.LBB107_3:                              # %if.then.thread
	...
	pcaddu18i	$ra, %call36(strlen)
	jirl	$ra, $ra, 0
	pcalau12i	$a1, %got_pc_hi20(siod_lib)
	ld.d	$a1, $a1, %got_pc_lo12(siod_lib)
	ld.d	$s0, $a1, 0
	pcalau12i	$a1, %pc_hi20(.L.str.115)
	addi.d	$s1, $a1, %pc_lo12(.L.str.115)
	move	$s2, $a0
...
.LBB109_12:                             # %for.end
	...
	pcaddu18i	$ra, %call36(strlen)
	jirl	$ra, $ra, 0
	pcalau12i	$a1, %pc_hi20(.L.str.229)
	addi.d	$a1, $a1, %pc_lo12(.L.str.229)
	ld.h	$a2, $a1, 0
	ld.b	$a1, $a1, 2
	add.d	$a3, $s0, $a0
	stx.h	$a2, $a0, $s0
