...
.LBB11_23:                              # %if.then.i.i
	...
	beqz	$a0, .LBB11_42
# %bb.24:                               # %vector.body88.preheader
                                        #   in Loop: Header=BB11_13 Depth=2
	move	$a1, $a0
	move	$a0, $zero
	.p2align	4, , 16
.LBB11_25:                              # %vector.body88
                                        #   Parent Loop BB11_7 Depth=1
                                        #     Parent Loop BB11_13 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	add.d	$a2, $a1, $a0
...
.LBB11_36:                              # %if.then.i.i48
	...
	st.d	$a0, $s8, %pc_lo12(Action_new.freelist)
	beqz	$a0, .LBB11_41
# %bb.37:                               # %vector.body81.preheader
                                        #   in Loop: Header=BB11_7 Depth=1
	addi.d	$a1, $a0, 40
	ori	$a2, $zero, 98
	.p2align	4, , 16
.LBB11_38:                              # %vector.body81
                                        #   Parent Loop BB11_7 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.d	$a3, $a1, 40
	st.d	$a1, $a1, -16
...
# %bb.29:                               # %if.then.i.i60
	...
	st.d	$a0, $s1, %pc_lo12(Action_new.freelist)
	beqz	$a0, .LBB14_85
# %bb.30:                               # %vector.body143.preheader
	addi.d	$a1, $a0, 40
	ori	$a2, $zero, 98
	.p2align	4, , 16
.LBB14_31:                              # %vector.body143
                                        # =>This Inner Loop Header: Depth=1
	addi.d	$a3, $a1, 40
	st.d	$a1, $a1, -16
	st.d	$a3, $a1, 24
