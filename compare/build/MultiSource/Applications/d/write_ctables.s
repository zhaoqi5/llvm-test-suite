...
.LBB8_188:                              #   in Loop: Header=BB8_102 Depth=1
	...
	b	.LBB8_135
	.p2align	4, , 16
.LBB8_189:                              #   in Loop: Header=BB8_102 Depth=1
	ld.d	$s8, $sp, 176                   # 8-byte Folded Reload
	ld.d	$s6, $sp, 144                   # 8-byte Folded Reload
	ld.d	$s1, $sp, 152                   # 8-byte Folded Reload
	b	.LBB8_135
...
# %bb.281:                              # %for.body.lr.ph.i119
	...
	addi.d	$s4, $a0, %pc_lo12(.L.str.115)
	move	$a2, $zero
...
.LBB8_284:                              # %for.body.i121
                                        ...
                                        #     Child Loop BB8_317 Depth 2
                                        #     Child Loop BB8_322 Depth 2
	ld.d	$a0, $fp, 96
	slli.d	$a1, $a2, 3
	ldx.d	$s6, $a0, $a1
	ld.wu	$a3, $s6, 96
...
.LBB8_310:                              # %while.end163.i
	...
	ld.d	$s7, $sp, 168                   # 8-byte Folded Reload
	beqz	$s1, .LBB8_313
# %bb.311:                              # %for.body168.i.preheader
                                        #   in Loop: Header=BB8_284 Depth=1
	ld.d	$s1, $sp, 120                   # 8-byte Folded Reload
	ld.d	$s2, $sp, 88                    # 8-byte Folded Reload
	ld.d	$s3, $sp, 152                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB8_312:                              # %for.body168.i
                                        #   Parent Loop BB8_284 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.bu	$a2, $s1, 0
	sltui	$a0, $s2, 1
...
.LBB8_313:                              # %for.end178.i
	...
	b	.LBB8_319
	.p2align	4, , 16
.LBB8_314:                              # %if.else180.i
                                        #   in Loop: Header=BB8_284 Depth=1
	ld.d	$a0, $sp, 64                    # 8-byte Folded Reload
	st.w	$a0, $s6, 392
	ld.w	$a0, $s6, 176
	beqz	$a0, .LBB8_319
.LBB8_315:                              # %if.then185.i
                                        #   in Loop: Header=BB8_284 Depth=1
	move	$a0, $s0
	ld.d	$a1, $sp, 96                    # 8-byte Folded Reload
	move	$a3, $s8
	...
	beqz	$a0, .LBB8_318
# %bb.316:                              # %for.body192.lr.ph.i
                                        #   in Loop: Header=BB8_284 Depth=1
	move	$s1, $zero
	move	$s2, $zero
	.p2align	4, , 16
.LBB8_317:                              # %for.body192.i
                                        #   Parent Loop BB8_284 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a1, $s6, 184
	ldx.d	$a1, $a1, $s1
...
# %bb.320:                              # %if.then226.i
	...
	beqz	$a0, .LBB8_282
# %bb.321:                              # %for.body233.lr.ph.i
                                        #   in Loop: Header=BB8_284 Depth=1
	move	$s1, $zero
	move	$s2, $zero
	.p2align	4, , 16
.LBB8_322:                              # %for.body233.i
                                        #   Parent Loop BB8_284 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a1, $s6, 224
	ldx.d	$a1, $a1, $s1
...
# %bb.324:                              # %if.then285.i
	...
	ld.w	$a0, $a0, 0
	beqz	$a0, .LBB8_332
# %bb.325:                              # %for.body292.i.preheader
	pcalau12i	$a0, %pc_hi20(.L.str.30)
	...
	b	.LBB8_327
	.p2align	4, , 16
.LBB8_326:                              # %for.inc310.i
                                        #   in Loop: Header=BB8_327 Depth=1
	lu12i.w	$a0, 1
	ori	$a0, $a0, 736
	add.d	$a0, $sp, $a0
	ld.wu	$a0, $a0, 0
...
.LBB8_334:                              # %for.end.i166
	...
	ld.d	$s8, $sp, 176                   # 8-byte Folded Reload
	ld.d	$s1, $sp, 160                   # 8-byte Folded Reload
.LBB8_335:                              # %for.inc50.i
                                        #   in Loop: Header=BB8_336 Depth=1
	ld.wu	$a0, $fp, 88
	addi.d	$s6, $s6, 1
	bgeu	$s6, $a0, .LBB8_341
.LBB8_336:                              # %for.body.i150
                                        # =>This Loop Header: Depth=1
...
# %bb.338:                              # %if.then8.i
	...
	beqz	$a0, .LBB8_334
# %bb.339:                              # %for.body17.lr.ph.i
                                        #   in Loop: Header=BB8_336 Depth=1
	move	$s1, $zero
	move	$s3, $zero
	.p2align	4, , 16
.LBB8_340:                              # %for.body17.i
                                        #   Parent Loop BB8_336 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a0, $s7, 264
	ldx.d	$a0, $a0, $s1
	ld.d	$a0, $a0, 16
	...
	bltu	$s3, $a0, .LBB8_340
	b	.LBB8_334
.LBB8_341:                              # %write_error_data_as_C.exit
...
# %bb.343:                              # %for.body.lr.ph.i171
	...
	b	.LBB8_346
	.p2align	4, , 16
.LBB8_344:                              # %if.else176.i
                                        #   in Loop: Header=BB8_346 Depth=1
	ori	$a1, $zero, 2
	ori	$a2, $zero, 1
...
.LBB8_360:                              # %if.else37.i
	...
	ld.w	$a0, $s4, 136
	bnez	$a0, .LBB8_353
.LBB8_361:                              # %if.else47.i
                                        #   in Loop: Header=BB8_346 Depth=1
	ld.bu	$a0, $s4, 376
	andi	$a1, $a0, 2
	bnez	$a1, .LBB8_364
# %bb.362:                              # %lor.lhs.false.i210
                                        #   in Loop: Header=BB8_346 Depth=1
	andi	$a0, $a0, 4
	beqz	$a0, .LBB8_366
# %bb.363:                              # %lor.lhs.false.i210
                                        #   in Loop: Header=BB8_346 Depth=1
	ld.d	$a0, $fp, 128
	beqz	$a0, .LBB8_366
.LBB8_364:                              # %if.then55.i
                                        #   in Loop: Header=BB8_346 Depth=1
	ori	$a1, $zero, 15
	ori	$a2, $zero, 1
...
.LBB8_370:                              # %if.end90.i
	...
	ld.w	$a0, $s4, 296
	beqz	$a0, .LBB8_377
.LBB8_371:                              # %if.then95.i
                                        #   in Loop: Header=BB8_346 Depth=1
	ld.d	$a0, $s4, 400
	move	$a2, $s2
	beqz	$a0, .LBB8_373
# %bb.372:                              # %cond.true98.i
                                        #   in Loop: Header=BB8_346 Depth=1
	ld.w	$a2, $a0, 0
.LBB8_373:                              # %cond.end102.i
                                        #   in Loop: Header=BB8_346 Depth=1
	...
	ori	$a1, $zero, 254
	bltu	$a1, $a0, .LBB8_378
.LBB8_374:                              # %land.lhs.true.i.i.i205
                                        #   in Loop: Header=BB8_346 Depth=1
	ld.w	$a0, $s4, 336
	ld.d	$a2, $sp, 88                    # 8-byte Folded Reload
	ori	$a1, $zero, 255
	bltu	$a0, $a1, .LBB8_382
# %bb.375:                              # %land.lhs.true8.i.i.i203
                                        #   in Loop: Header=BB8_346 Depth=1
	bstrpick.d	$a0, $a0, 31, 7
	ori	$a1, $zero, 253
	bltu	$a0, $a1, .LBB8_380
	b	.LBB8_381
.LBB8_376:                              # %if.then85.i
                                        #   in Loop: Header=BB8_346 Depth=1
	move	$a0, $s0
	ld.d	$a1, $sp, 64                    # 8-byte Folded Reload
	move	$a2, $s2
...
.LBB8_377:                              # %if.else105.i
	...
	ori	$a1, $zero, 254
	bgeu	$a1, $a0, .LBB8_374
.LBB8_378:                              # %if.end.i.i.i191
                                        #   in Loop: Header=BB8_346 Depth=1
	bstrpick.d	$a0, $a0, 31, 7
	ori	$a1, $zero, 252
	bltu	$a1, $a0, .LBB8_381
# %bb.379:                              # %if.end.land.lhs.true8_crit_edge.i.i.i201
                                        #   in Loop: Header=BB8_346 Depth=1
	ld.w	$a0, $s4, 336
	bstrpick.d	$a0, $a0, 31, 7
	ori	$a1, $zero, 253
	bgeu	$a0, $a1, .LBB8_381
.LBB8_380:                              #   in Loop: Header=BB8_346 Depth=1
	pcalau12i	$a0, %pc_hi20(.L.str.101)
	addi.d	$a2, $a0, %pc_lo12(.L.str.101)
	b	.LBB8_382
	.p2align	4, , 16
.LBB8_381:                              # %sw.bb2.i.i.i193
                                        #   in Loop: Header=BB8_346 Depth=1
	pcalau12i	$a0, %pc_hi20(.L.str.102)
	addi.d	$a2, $a0, %pc_lo12(.L.str.102)
.LBB8_382:                              # %scanner_type.exit.i194
                                        #   in Loop: Header=BB8_346 Depth=1
	move	$a0, $s0
	ld.d	$a1, $sp, 152                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(fprintf)
...
# %bb.384:                              # %if.then134.i
	...
	move	$a2, $s2
	beqz	$a0, .LBB8_386
# %bb.385:                              # %cond.true137.i
                                        #   in Loop: Header=BB8_346 Depth=1
	ld.w	$a2, $a0, 0
.LBB8_386:                              # %cond.end141.i
                                        #   in Loop: Header=BB8_346 Depth=1
...
# %bb.389:                              # %if.then158.i
	...
	move	$a2, $s2
	beqz	$a0, .LBB8_391
# %bb.390:                              # %cond.true161.i
                                        #   in Loop: Header=BB8_346 Depth=1
	ld.w	$a2, $a0, 0
.LBB8_391:                              # %cond.end165.i
                                        #   in Loop: Header=BB8_346 Depth=1
...
.LBB8_395:                              # %if.else185.i
	...
	pcaddu18i	$ra, %call36(fwrite)
	jirl	$ra, $ra, 0
.LBB8_396:                              # %write_state_data_as_C.exit
...
.LBB8_398:                              # %for.body.i217
	...
	addi.d	$s3, $s3, 8
	bltu	$s4, $a0, .LBB8_398
.LBB8_399:                              # %for.cond13.preheader.i
	ld.w	$a0, $fp, 48
	beqz	$a0, .LBB8_402
# %bb.400:                              # %for.body16.lr.ph.i
...
.LBB8_401:                              # %for.body16.i
	...
	addi.d	$s6, $s6, 8
	bltu	$s7, $a0, .LBB8_401
.LBB8_402:                              # %write_symbol_data_as_C.exit
	pcalau12i	$a0, %pc_hi20(.L.str.49)
	addi.d	$a0, $a0, %pc_lo12(.L.str.49)
	ori	$a1, $zero, 4
	ori	$a2, $zero, 1
...
.LBB8_406:                              # %for.end.i243
	...
	pcaddu18i	$ra, %call36(fwrite)
	jirl	$ra, $ra, 0
.LBB8_407:                              # %write_passes_as_C.exit
