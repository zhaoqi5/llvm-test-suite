...
# %bb.2:                                # %for.body.lr.ph
	...
	addi.d	$s0, $a0, %pc_lo12(assoc_strings)
...
.LBB33_204:                             # %for.body5.lr.ph.i164
	...
	move	$a2, $a0
	b	.LBB33_207
.LBB33_205:                             #   in Loop: Header=BB33_207 Depth=1
	move	$a2, $zero
	.p2align	4, , 16
.LBB33_206:                             # %for.inc18.i
                                        #   in Loop: Header=BB33_207 Depth=1
	addi.d	$fp, $fp, 1
	bgeu	$fp, $a1, .LBB33_243
.LBB33_207:                             # %for.body5.i167
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB33_216 Depth 2
                                        #       Child Loop BB33_218 Depth 3
                                        #     Child Loop BB33_235 Depth 2
	ld.d	$a3, $s0, 168
	slli.d	$a4, $fp, 3
	ldx.d	$s5, $a3, $a4
	ld.w	$a3, $s5, 8
...
# %bb.209:                              # %for.body.i.i173.preheader
	...
	b	.LBB33_211
	.p2align	4, , 16
.LBB33_210:                             # %for.body.ithread-pre-split.i
                                        #   in Loop: Header=BB33_207 Depth=1
	ld.w	$a3, $s5, 8
	move	$s8, $a1
	ld.d	$a0, $s0, 96
	...
	ldx.d	$s7, $a0, $a1
	bnez	$a3, .LBB33_229
.LBB33_211:                             # %if.then.i.i186
                                        #   in Loop: Header=BB33_207 Depth=1
	move	$a1, $s7
	beqz	$s8, .LBB33_230
# %bb.212:                              # %if.else.i.i188
                                        #   in Loop: Header=BB33_207 Depth=1
	ld.w	$a0, $s7, 136
	st.d	$s8, $s7, 400
	beqz	$a0, .LBB33_229
# %bb.213:                              # %for.cond1.preheader.lr.ph.i.i.i
                                        #   in Loop: Header=BB33_207 Depth=1
	move	$s2, $zero
	addi.d	$s0, $s8, 136
	addi.d	$s1, $s8, 152
	b	.LBB33_216
	.p2align	4, , 16
.LBB33_214:                             # %if.end69.i.i.i
                                        #   in Loop: Header=BB33_216 Depth=2
	move	$a0, $s0
	pcaddu18i	$ra, %call36(vec_add_internal)
	jirl	$ra, $ra, 0
.LBB33_215:                             # %for.inc75.i.i.i
                                        #   in Loop: Header=BB33_216 Depth=2
	ld.wu	$a0, $s7, 136
	addi.d	$s2, $s2, 1
	bgeu	$s2, $a0, .LBB33_229
.LBB33_216:                             # %for.cond1.preheader.i.i.i
...
# %bb.217:                              # %for.body5.lr.ph.i.i.i
	...
	slli.d	$a4, $a3, 3
	.p2align	4, , 16
.LBB33_218:                             # %for.body5.i.i.i
                                        #   Parent Loop BB33_207 Depth=1
                                        #     Parent Loop BB33_216 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ldx.d	$a7, $a0, $a6
	ld.d	$a7, $a7, 8
	beq	$a5, $a7, .LBB33_215
# %bb.219:                              # %for.cond1.i.i.i
                                        #   in Loop: Header=BB33_218 Depth=3
	addi.d	$a6, $a6, 8
	bne	$a4, $a6, .LBB33_218
# %bb.220:                              # %if.else.i.i.i
                                        #   in Loop: Header=BB33_216 Depth=2
	beq	$a0, $s1, .LBB33_227
# %bb.221:                              # %if.else51.i.i.i
                                        #   in Loop: Header=BB33_216 Depth=2
	andi	$a3, $a2, 7
	beqz	$a3, .LBB33_214
# %bb.222:                              # %if.then55.i.i.i
                                        #   in Loop: Header=BB33_216 Depth=2
	addi.d	$a2, $a2, 1
	st.w	$a2, $s0, 0
	stx.d	$a1, $a0, $a4
	b	.LBB33_215
	.p2align	4, , 16
.LBB33_223:                             # %do.body.i.i.i
                                        #   in Loop: Header=BB33_216 Depth=2
	beqz	$a0, .LBB33_226
# %bb.224:                              # %if.else.thread.i.i.i
                                        #   in Loop: Header=BB33_216 Depth=2
	ld.d	$a1, $s7, 144
	slli.d	$a3, $s2, 3
	ldx.d	$a1, $a1, $a3
	bne	$a0, $s1, .LBB33_214
# %bb.225:                              #   in Loop: Header=BB33_216 Depth=2
	move	$a3, $zero
	b	.LBB33_228
.LBB33_226:                             # %if.then15.i.i.i
                                        #   in Loop: Header=BB33_216 Depth=2
	ld.d	$a0, $s7, 144
	slli.d	$a1, $s2, 3
	ldx.d	$a0, $a0, $a1
	...
	st.d	$a0, $s8, 152
	b	.LBB33_215
.LBB33_227:                             # %if.then34.i.i.i
                                        #   in Loop: Header=BB33_216 Depth=2
	ori	$a4, $zero, 2
	bltu	$a4, $a2, .LBB33_214
.LBB33_228:                             # %if.then38.i.i.i
                                        #   in Loop: Header=BB33_216 Depth=2
	addi.d	$a2, $a2, 1
	st.w	$a2, $s0, 0
	slli.d	$a2, $a3, 3
	...
	b	.LBB33_215
	.p2align	4, , 16
.LBB33_229:                             #   in Loop: Header=BB33_207 Depth=1
	move	$a1, $s8
.LBB33_230:                             # %for.cond7.preheader.i.i
                                        #   in Loop: Header=BB33_207 Depth=1
	ld.wu	$a0, $s7, 16
	beqz	$a0, .LBB33_241
# %bb.231:                              # %for.body10.lr.ph.i.i
                                        #   in Loop: Header=BB33_207 Depth=1
	ld.d	$a2, $s7, 24
	b	.LBB33_235
.LBB33_232:                             # %sw.bb43.i.i
                                        #   in Loop: Header=BB33_235 Depth=2
	ld.bu	$a3, $s7, 376
	...
	maskeqz	$a4, $a5, $a4
	or	$a3, $a4, $a3
.LBB33_233:                             # %for.inc.sink.split.i.i
                                        #   in Loop: Header=BB33_235 Depth=2
	st.b	$a3, $s7, 376
.LBB33_234:                             # %for.inc.i.i178
                                        #   in Loop: Header=BB33_235 Depth=2
	addi.d	$a0, $a0, -1
	addi.d	$a2, $a2, 8
	beqz	$a0, .LBB33_241
.LBB33_235:                             # %for.body10.i.i
                                        #   Parent Loop BB33_207 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a3, $a2, 0
	ld.w	$a4, $a3, 0
	bne	$a4, $s3, .LBB33_234
# %bb.236:                              # %if.then17.i.i
                                        #   in Loop: Header=BB33_235 Depth=2
	ld.d	$a3, $a3, 16
	ld.bu	$a3, $a3, 36
	andi	$a3, $a3, 7
	beqz	$a3, .LBB33_232
# %bb.237:                              # %if.then17.i.i
                                        #   in Loop: Header=BB33_235 Depth=2
	bne	$a3, $s3, .LBB33_234
# %bb.238:                              # %sw.bb.i.i
                                        #   in Loop: Header=BB33_235 Depth=2
	...
	andi	$a3, $a3, 231
	bne	$a4, $s4, .LBB33_240
# %bb.239:                              # %if.then33.i.i
                                        #   in Loop: Header=BB33_235 Depth=2
	addi.d	$a3, $a3, 8
	b	.LBB33_233
.LBB33_240:                             # %if.else37.i.i
                                        #   in Loop: Header=BB33_235 Depth=2
	addi.d	$a3, $a3, 16
	b	.LBB33_233
	.p2align	4, , 16
.LBB33_241:                             # %for.inc70.i.i
                                        #   in Loop: Header=BB33_207 Depth=1
	ld.d	$s0, $sp, 32                    # 8-byte Folded Reload
	ld.wu	$a0, $s0, 88
	addi.d	$s6, $s6, 1
	bltu	$s6, $a0, .LBB33_210
# %bb.242:                              # %for.inc18.loopexit.i
                                        #   in Loop: Header=BB33_207 Depth=1
	ld.wu	$a1, $s0, 160
	move	$a2, $a0
	b	.LBB33_206
.LBB33_243:                             # %for.cond21.preheader.i
	addi.w	$a1, $a0, 0
	beqz	$a1, .LBB33_248
# %bb.244:                              # %for.body25.lr.ph.i
	move	$a1, $zero
	move	$a2, $zero
	ori	$a3, $zero, 24
	b	.LBB33_246
	.p2align	4, , 16
.LBB33_245:                             # %for.inc40.i
                                        #   in Loop: Header=BB33_246 Depth=1
	addi.d	$a2, $a2, 1
	bstrpick.d	$a4, $a0, 31, 0
	addi.d	$a1, $a1, 8
	bgeu	$a2, $a4, .LBB33_248
.LBB33_246:                             # %for.body25.i
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a4, $s0, 96
	ldx.d	$a4, $a4, $a1
	ld.bu	$a5, $a4, 376
