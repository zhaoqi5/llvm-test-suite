...
# %bb.41:                               # %if.then55
	st.d	$s5, $fp, 8
.LBB23_42:                              # %while.cond59.preheader
	ori	$a0, $zero, 10
	ld.bu	$a1, $s5, 0
	beqz	$a1, .LBB23_2
	.p2align	4, , 16
.LBB23_43:                              # %while.cond59
                                        # =>This Inner Loop Header: Depth=1
	beq	$a1, $a0, .LBB23_2
# %bb.44:                               # %while.body65
...
.LBB30_107:                             # %if.then53.i
	...
	st.w	$a1, $a2, 112
	beqz	$a1, .LBB30_141
.LBB30_108:                             # %do.end.i91
                                        #   in Loop: Header=BB30_110 Depth=2
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	.p2align	4, , 16
.LBB30_109:                             # %for.inc82.i
                                        #   in Loop: Header=BB30_110 Depth=2
	addi.d	$s1, $s2, 8
	ld.d	$s2, $s2, 8
	beqz	$s2, .LBB30_142
.LBB30_110:                             # %land.rhs.i
                                        #   Parent Loop BB30_4 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB30_120 Depth 3
                                        #         Child Loop BB30_130 Depth 4
...
# %bb.117:                              # %if.end.i84
	...
	ld.d	$a5, $s2, 8
	beqz	$a5, .LBB30_109
# %bb.118:                              # %land.rhs10.lr.ph.i
                                        #   in Loop: Header=BB30_110 Depth=2
	addi.d	$a6, $s2, 8
	move	$a0, $a5
	b	.LBB30_120
	.p2align	4, , 16
.LBB30_119:                             # %for.inc.i87
                                        #   in Loop: Header=BB30_120 Depth=3
	addi.d	$a6, $a0, 8
	ld.d	$a0, $a0, 8
	beqz	$a0, .LBB30_109
.LBB30_120:                             # %land.rhs10.i
                                        #   Parent Loop BB30_4 Depth=1
...
# %bb.122:                              # %if.end.i41.i
	...
	ld.w	$t1, $a7, 8
	bne	$t1, $s5, .LBB30_126
# %bb.123:                              # %if.then3.i50.i
                                        #   in Loop: Header=BB30_120 Depth=3
	ld.w	$a7, $t0, 8
	bne	$a7, $s4, .LBB30_119
# %bb.124:                              # %if.end7.i53.i
                                        #   in Loop: Header=BB30_120 Depth=3
	ld.d	$a7, $t0, 16
	ld.d	$a7, $a7, 0
	ld.w	$t0, $a7, 72
	bne	$t0, $s4, .LBB30_119
# %bb.125:                              # %if.end15.i57.i
                                        #   in Loop: Header=BB30_120 Depth=3
	ld.d	$a7, $a7, 80
	ld.d	$t0, $a7, 0
	ld.d	$a7, $t0, 0
...
# %bb.127:                              # %if.end21.i
	...
	ld.w	$t1, $t0, 8
	bne	$t3, $t1, .LBB30_119
# %bb.128:                              # %for.cond.preheader.i.i
                                        #   in Loop: Header=BB30_120 Depth=3
	beqz	$t3, .LBB30_134
# %bb.129:                              # %for.cond4.preheader.lr.ph.split.i.i
                                        #   in Loop: Header=BB30_120 Depth=3
	ld.d	$t1, $a3, 16
	ld.d	$t0, $t0, 16
	move	$t2, $zero
	bstrpick.d	$t3, $t3, 31, 0
.LBB30_130:                             # %for.cond4.preheader.i.i
                                        #   Parent Loop BB30_4 Depth=1
                                        #     Parent Loop BB30_110 Depth=2
...
.LBB30_131:                             # %for.body7.i.i
	...
	ld.d	$t7, $t5, 0
	beq	$t4, $t7, .LBB30_133
# %bb.132:                              # %for.cond4.i.i
                                        #   in Loop: Header=BB30_131 Depth=5
	addi.d	$t6, $t6, -1
	addi.d	$t5, $t5, 8
	bnez	$t6, .LBB30_131
	b	.LBB30_119
.LBB30_133:                             # %for.inc18.i.i
                                        #   in Loop: Header=BB30_130 Depth=4
	addi.d	$t2, $t2, 1
	bne	$t2, $t3, .LBB30_130
.LBB30_134:                             # %if.end26.i
                                        #   in Loop: Header=BB30_120 Depth=3
	ld.d	$t2, $s8, 144
	ld.d	$t0, $a1, 0
	ld.d	$t1, $a2, 0
...
.LBB30_163:                             # %if.end89.i
	...
	jirl	$ra, $ra, 0
.LBB30_164:                             # %for.inc.i119
                                        #   in Loop: Header=BB30_165 Depth=3
	addi.d	$s1, $s1, 1
	beq	$s1, $s5, .LBB30_151
.LBB30_165:                             # %for.body.i109
                                        #   Parent Loop BB30_4 Depth=1
...
# %bb.166:                              # %if.then56.i
	...
	ld.d	$a0, $sp, 456
	beqz	$a0, .LBB30_169
# %bb.167:                              # %lor.lhs.false.i
                                        #   in Loop: Header=BB30_165 Depth=3
	ld.d	$a1, $s7, 8
	bne	$a0, $a1, .LBB30_169
# %bb.168:                              # %lor.lhs.false64.i
                                        #   in Loop: Header=BB30_165 Depth=3
	ld.d	$a0, $s3, 216
	beq	$s6, $a0, .LBB30_176
	.p2align	4, , 16
.LBB30_169:                             # %if.then67.i114
                                        #   in Loop: Header=BB30_165 Depth=3
	xvld	$xr0, $s7, 8
	ld.d	$s6, $s3, 216
	xvst	$xr0, $sp, 456
...
.LBB30_172:                             # %land.rhs.i.i117
	...
	ld.d	$a1, $a1, 192
	bne	$a2, $a1, .LBB30_162
# %bb.173:                              # %while.body.i.i122
                                        #   in Loop: Header=BB30_172 Depth=4
	ld.w	$a1, $a0, 8
	beqz	$a1, .LBB30_161
# %bb.174:                              # %cond.true.i.i
                                        #   in Loop: Header=BB30_172 Depth=4
	ld.d	$a0, $a0, 16
	ld.d	$a0, $a0, 0
	ld.w	$a1, $a0, 72
	beqz	$a1, .LBB30_161
# %bb.175:                              # %cond.end15.i.i
                                        #   in Loop: Header=BB30_172 Depth=4
	ld.d	$a0, $a0, 80
	ld.d	$a0, $a0, 0
	bnez	$a0, .LBB30_172
	b	.LBB30_161
.LBB30_176:                             # %lor.lhs.false64.if.end89_crit_edge.i
                                        #   in Loop: Header=BB30_165 Depth=3
	ld.d	$a3, $s2, 0
	b	.LBB30_163
	.p2align	4, , 16
.LBB30_177:                             # %if.then96.i
                                        #   in Loop: Header=BB30_153 Depth=2
	move	$a0, $s8
	pcaddu18i	$ra, %call36(free_SNode)
	jirl	$ra, $ra, 0
	b	.LBB30_152
.LBB30_178:                             # %for.end104
                                        #   in Loop: Header=BB30_4 Depth=1
	beqz	$fp, .LBB30_4
# %bb.179:                              # %land.lhs.true106
                                        #   in Loop: Header=BB30_4 Depth=1
	ld.d	$a0, $s8, 256
	beqz	$a0, .LBB30_4
# %bb.180:                              # %land.lhs.true109
                                        #   in Loop: Header=BB30_4 Depth=1
	ld.d	$a1, $a0, 40
	bnez	$a1, .LBB30_4
# %bb.181:                              # %if.then113
...
# %bb.49:                               # %do.body.i.us
	...
	stx.d	$a0, $a2, $s4
	b	.LBB31_77
.LBB31_50:                              # %if.then.i.us
                                        #   in Loop: Header=BB31_45 Depth=1
	ld.d	$a0, $sp, 24                    # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(d_fail)
	jirl	$ra, $ra, 0
	bnez	$s2, .LBB31_48
.LBB31_51:                              # %for.cond.preheader.i.us
                                        #   in Loop: Header=BB31_45 Depth=1
	addi.w	$a0, $s8, -1
	bge	$s7, $a0, .LBB31_58
# %bb.52:                               # %for.body.lr.ph.i47.us
                                        #   in Loop: Header=BB31_45 Depth=1
	ld.d	$a1, $s0, 48
	sub.d	$a3, $a0, $s7
	move	$a2, $s7
...
.LBB31_54:                              # %vector.body130
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB31_54
# %bb.55:                               # %middle.block136
                                        #   in Loop: Header=BB31_45 Depth=1
	beq	$a3, $a4, .LBB31_58
.LBB31_56:                              # %for.body.i48.us.preheader
                                        #   in Loop: Header=BB31_45 Depth=1
	alsl.d	$a1, $a2, $a1, 3
	addi.d	$a1, $a1, 8
	sub.d	$a0, $a0, $a2
	.p2align	4, , 16
.LBB31_57:                              # %for.body.i48.us
                                        #   Parent Loop BB31_45 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a2, $a1, 0
	st.d	$a2, $a1, -8
	...
	addi.d	$a1, $a1, 8
	bnez	$a0, .LBB31_57
.LBB31_58:                              # %for.end.i46.us
                                        #   in Loop: Header=BB31_45 Depth=1
	ld.w	$a0, $s1, 0
	addi.d	$a0, $a0, -1
	st.w	$a0, $s1, 0
	b	.LBB31_77
.LBB31_59:                              # %for.cond32.preheader.i.us
                                        #   in Loop: Header=BB31_45 Depth=1
	blt	$s2, $s5, .LBB31_70
# %bb.60:                               # %do.body36.lr.ph.i.us
                                        #   in Loop: Header=BB31_45 Depth=1
	addi.d	$s4, $s2, -1
	b	.LBB31_63
	.p2align	4, , 16
.LBB31_61:                              # %if.then39.i.us
	...
	slli.d	$a0, $a0, 3
	stx.d	$zero, $s6, $a0
.LBB31_62:                              # %for.inc86.i.us
                                        #   in Loop: Header=BB31_63 Depth=2
	addi.w	$s4, $s4, -1
	beqz	$s4, .LBB31_70
.LBB31_63:                              # %do.body36.i.us
                                        #   Parent Loop BB31_45 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a0, $s0, 48
	beqz	$a0, .LBB31_61
# %bb.64:                               # %if.else48.i.us
                                        #   in Loop: Header=BB31_63 Depth=2
	ld.wu	$a1, $s1, 0
	beq	$a0, $s6, .LBB31_67
# %bb.65:                               # %if.else68.i.us
                                        #   in Loop: Header=BB31_63 Depth=2
	andi	$a2, $a1, 7
	beqz	$a2, .LBB31_69
# %bb.66:                               # %if.then72.i.us
                                        #   in Loop: Header=BB31_63 Depth=2
	addi.d	$a2, $a1, 1
	st.w	$a2, $s1, 0
	slli.d	$a1, $a1, 3
	...
	b	.LBB31_62
	.p2align	4, , 16
.LBB31_67:                              # %if.then55.i.us
                                        #   in Loop: Header=BB31_63 Depth=2
	ori	$a2, $zero, 3
	bgeu	$a1, $a2, .LBB31_69
# %bb.68:                               # %if.then59.i.us
                                        #   in Loop: Header=BB31_63 Depth=2
	addi.w	$a2, $a1, 0
	addi.d	$a1, $a1, 1
	st.w	$a1, $s1, 0
...
.LBB31_69:                              # %if.end82.i.us
	...
	jirl	$ra, $ra, 0
	b	.LBB31_62
.LBB31_70:                              # %for.cond90.preheader.i.us
                                        #   in Loop: Header=BB31_45 Depth=1
	addi.w	$a0, $s7, 1
	bge	$a0, $s8, .LBB31_74
# %bb.71:                               # %for.body93.lr.ph.i.us
                                        #   in Loop: Header=BB31_45 Depth=1
	ld.d	$a1, $s0, 48
	sub.d	$a2, $s8, $a0
	ori	$a3, $zero, 16
	bgeu	$a2, $a3, .LBB31_79
.LBB31_72:                              # %for.body93.i.us.preheader
                                        #   in Loop: Header=BB31_45 Depth=1
	add.d	$a2, $s2, $s8
	addi.w	$a2, $a2, -2
	alsl.d	$a3, $s8, $a1, 3
...
.LBB31_73:                              # %for.body93.i.us
	...
	addi.d	$a3, $a3, -8
	blt	$a0, $s8, .LBB31_73
.LBB31_74:                              # %for.cond107.preheader.i.us
                                        #   in Loop: Header=BB31_45 Depth=1
	blez	$s2, .LBB31_77
# %bb.75:                               # %do.body110.lr.ph.i.us
                                        #   in Loop: Header=BB31_45 Depth=1
	ld.d	$a1, $s0, 48
	ld.d	$a0, $s3, 48
	alsl.d	$a1, $s7, $a1, 3
	.p2align	4, , 16
.LBB31_76:                              # %do.body110.i49.us
                                        #   Parent Loop BB31_45 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a2, $a0, 0
	ld.w	$a3, $a2, 32
	...
	addi.d	$a0, $a0, 8
	bnez	$s2, .LBB31_76
.LBB31_77:                              # %do.body133.i.us
                                        #   in Loop: Header=BB31_45 Depth=1
	ld.w	$a0, $s3, 32
	addi.w	$a0, $a0, -1
	st.w	$a0, $s3, 32
	bnez	$a0, .LBB31_43
# %bb.78:                               # %if.then137.i.us
                                        #   in Loop: Header=BB31_45 Depth=1
	move	$a0, $fp
	move	$a1, $s3
	pcaddu18i	$ra, %call36(free_PNode)
...
# %bb.94:                               # %if.then72
	ld.wu	$a0, $s1, 0
	beqz	$a0, .LBB31_99
# %bb.95:                               # %do.body.lr.ph.i
	move	$s2, $zero
	move	$s3, $zero
	b	.LBB31_97
	.p2align	4, , 16
.LBB31_96:                              # %for.inc.i59
                                        #   in Loop: Header=BB31_97 Depth=1
	addi.d	$s3, $s3, 1
	addi.d	$s2, $s2, 8
	bgeu	$s3, $a0, .LBB31_99
.LBB31_97:                              # %do.body.i53
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a1, $s0, 48
	ldx.d	$a1, $a1, $s2
	ld.w	$a2, $a1, 32
...
# %bb.127:                              # %if.then145.i
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB35_128:                             # %do.body148.i
	ld.d	$t6, $sp, 16                    # 8-byte Folded Reload
	beqz	$s5, .LBB35_143
.LBB35_129:                             # %if.end163.i
	ld.w	$a0, $t6, 104
	beqz	$a0, .LBB35_132
.LBB35_130:                             # %if.end170.i
	ld.w	$a0, $t6, 108
	beqz	$a0, .LBB35_141
.LBB35_131:                             # %sw.bb
	ld.d	$a0, $s0, 104
...
# %bb.133:                              # %for.body.lr.ph.i.i76
	...
	.p2align	4, , 16
.LBB35_134:                             # %for.body.i.i78
                                        # =>This Inner Loop Header: Depth=1
	move	$a5, $s1
	beqz	$a3, .LBB35_136
# %bb.135:                              # %cond.false22.i.i79
                                        #   in Loop: Header=BB35_134 Depth=1
	ld.d	$a5, $s1, 48
	ldx.d	$a5, $a5, $a1
.LBB35_136:                             # %cond.end23.i.i
                                        #   in Loop: Header=BB35_134 Depth=1
	beqz	$a4, .LBB35_138
# %bb.137:                              #   in Loop: Header=BB35_134 Depth=1
	...
	b	.LBB35_146
.LBB35_138:                             # %cond.true29.i.i
                                        #   in Loop: Header=BB35_134 Depth=1
	ld.d	$a6, $s0, 200
	ld.d	$a5, $a5, 200
	bltu	$a6, $a5, .LBB35_146
.LBB35_139:                             # %if.end.i60.i
                                        #   in Loop: Header=BB35_134 Depth=1
...
.LBB35_153:                             # %if.end9.i
	ld.w	$a1, $s2, 0
	bne	$a0, $a1, .LBB35_150
# %bb.154:                              # %for.cond.preheader.i
	blez	$a0, .LBB35_148
# %bb.155:                              # %for.body.lr.ph.i
	ld.d	$a1, $s0, 48
	ld.d	$a2, $s2, 8
	addi.w	$a3, $a0, -1
.LBB35_156:                             # %for.body.i38
                                        # =>This Inner Loop Header: Depth=1
	slli.d	$a4, $a3, 3
	ldx.d	$a4, $a2, $a4
	ld.d	$a5, $a1, 0
	...
	bne	$a5, $a4, .LBB35_150
# %bb.157:                              # %for.cond.i
                                        #   in Loop: Header=BB35_156 Depth=1
	addi.d	$a0, $a0, -1
	addi.w	$a3, $a3, -1
	addi.d	$a1, $a1, 8
	bnez	$a0, .LBB35_156
