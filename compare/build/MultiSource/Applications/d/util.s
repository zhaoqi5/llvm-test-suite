...
# %bb.0:                                # %entry
	ld.w	$a3, $a1, 0
	bltz	$a3, .LBB14_10
.LBB14_1:                               # %Lagainc.preheader
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB14_2 Depth 2
                                        #       Child Loop BB14_3 Depth 3
	ld.w	$a4, $a2, 0
	bltz	$a4, .LBB14_13
.LBB14_2:                               # %Lagainb.preheader
...
.LBB14_8:                               # %if.then9
	...
	bgez	$a3, .LBB14_1
	b	.LBB14_11
.LBB14_9:                               # %while.body.backedge.loopexit
                                        #   in Loop: Header=BB14_1 Depth=1
	addi.d	$a4, $a4, -4
	move	$a1, $a4
	move	$a5, $a0
...
.LBB14_10:
	move	$a5, $a0
.LBB14_11:                              # %while.end25
	addi.w	$a0, $zero, -1
	lu32i.d	$a0, 0
	st.w	$a0, $a5, 0
	ret
.LBB14_12:                              # %while.body5.preheader.loopexit
	addi.d	$a1, $a4, -4
.LBB14_13:                              # %while.body5.preheader
	addi.d	$a1, $a1, 4
	move	$a5, $a0
	.p2align	4, , 16
.LBB14_14:                              # %while.body5
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a3, $a5, 0
	ld.w	$a3, $a1, 0
	addi.d	$a5, $a5, 4
...
# %bb.0:                                # %entry
	ld.w	$a3, $a1, 0
	bltz	$a3, .LBB15_8
.LBB15_1:                               # %Lagainc.preheader
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB15_2 Depth 2
                                        #       Child Loop BB15_3 Depth 3
	ld.w	$a4, $a2, 0
	bltz	$a4, .LBB15_8
.LBB15_2:                               # %Lagainb.preheader
