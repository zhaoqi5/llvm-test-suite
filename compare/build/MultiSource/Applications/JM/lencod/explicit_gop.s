...
# %bb.1:                                # %for.cond.preheader
	...
	pcalau12i	$s1, %pc_hi20(gop_structure)
	ori	$a0, $zero, 128
	lu32i.d	$a0, 128
...
# %bb.18:                               # %sw.bb
                                        #   in Loop: Header=BB3_5 Depth=1
	ld.d	$a0, $s1, %pc_lo12(gop_structure)
	slli.d	$a1, $s3, 4
	alsl.d	$a1, $s3, $a1, 3
	stx.w	$zero, $a0, $a1
	b	.LBB3_3
...
# %bb.20:                               # %if.then30
	...
	ld.d	$a0, $s6, 0
	ld.w	$a1, $sp, 96
	ld.d	$a2, $s1, %pc_lo12(gop_structure)
	slli.d	$a3, $s3, 4
	ld.w	$a0, $a0, 20
	alsl.d	$fp, $s3, $a3, 3
	add.d	$a2, $a2, $fp
