...
.LBB4_4:                                # %cond.end
	...
	ld.w	$a5, $a1, 192
	slli.d	$t7, $t1, 2
	pcalau12i	$t5, %pc_hi20(Median_Pred_Thd_MB)
	addi.d	$t5, $t5, %pc_lo12(Median_Pred_Thd_MB)
	alsl.d	$t1, $t1, $a3, 3
...
.LBB4_92:
	move	$t4, $s7
	b	.LBB4_256
.LBB4_93:                               # %if.end377.if.else381_crit_edge
	ld.d	$a0, $s8, 0
.LBB4_94:                               # %if.else381
	move	$s8, $ra
...
.LBB4_131:
	ld.d	$s5, $sp, 88                    # 8-byte Folded Reload
.LBB4_132:                              # %for.inc607.2
	blt	$t0, $s2, .LBB4_138
# %bb.133:                              # %land.lhs.true553.3
	addi.w	$s2, $s7, -1
	sub.w	$a0, $s2, $t1
	srai.d	$a1, $a0, 31
	xor	$a2, $a0, $a1
...
# %bb.142:                              # %if.else617
	...
	ld.d	$s8, $sp, 192                   # 8-byte Folded Reload
	bcnez	$fcc0, .LBB4_199
# %bb.143:                              # %for.cond631.preheader
	st.d	$s5, $sp, 88                    # 8-byte Folded Spill
	ori	$a0, $zero, 2
	blt	$t0, $a0, .LBB4_190
# %bb.144:                              # %for.body634.lr.ph
	sub.w	$a0, $t4, $t1
	srai.d	$a1, $a0, 31
	xor	$a2, $a0, $a1
	sub.w	$a4, $a2, $a1
...
.LBB4_158:
	ld.d	$s8, $sp, 192                   # 8-byte Folded Reload
	b	.LBB4_256
.LBB4_159:                              #   in Loop: Header=BB4_162 Depth=1
	move	$s1, $a0
	move	$s6, $ra
	move	$s2, $s4
	.p2align	4, , 16
.LBB4_160:                              #   in Loop: Header=BB4_162 Depth=1
	ld.d	$a3, $sp, 296                   # 8-byte Folded Reload
.LBB4_161:                              # %for.cond1168
                                        #   in Loop: Header=BB4_162 Depth=1
	addi.w	$s0, $s0, -1
	move	$ra, $s6
	move	$t4, $s2
	beqz	$s0, .LBB4_256
.LBB4_162:                              # %for.cond1172.preheader
                                        # =>This Inner Loop Header: Depth=1
	addi.w	$s2, $ra, -1
	sub.w	$a0, $s2, $a7
	srai.d	$a1, $a0, 31
...
# %bb.166:                              # %if.then1215
	...
	b	.LBB4_168
	.p2align	4, , 16
.LBB4_167:                              #   in Loop: Header=BB4_162 Depth=1
	move	$s6, $ra
.LBB4_168:                              # %for.inc1240
                                        #   in Loop: Header=BB4_162 Depth=1
	sub.w	$s3, $ra, $a7
	srai.d	$a0, $s3, 31
	xor	$a1, $s3, $a0
...
# %bb.170:                              # %if.then1191.1
	...
	beqz	$a0, .LBB4_180
	.p2align	4, , 16
.LBB4_171:                              #   in Loop: Header=BB4_162 Depth=1
	move	$s2, $t4
.LBB4_172:                              # %for.inc1240.1
                                        #   in Loop: Header=BB4_162 Depth=1
	addi.w	$s5, $ra, 1
	sub.w	$a0, $s5, $a7
	srai.d	$a1, $a0, 31
...
# %bb.174:                              # %if.then1191.2
	...
	beqz	$a0, .LBB4_183
	.p2align	4, , 16
.LBB4_175:                              # %for.inc1240.2
                                        #   in Loop: Header=BB4_162 Depth=1
	blt	$t0, $s4, .LBB4_188
.LBB4_176:                              # %land.lhs.true1186.3
                                        #   in Loop: Header=BB4_162 Depth=1
	addi.w	$s4, $t4, -1
	sub.w	$a0, $s4, $t1
	srai.d	$a1, $a0, 31
...
# %bb.181:                              # %if.then1215.1
	...
	ld.d	$s8, $sp, 192                   # 8-byte Folded Reload
	bge	$a0, $s7, .LBB4_172
# %bb.182:                              # %if.then1235.1
                                        #   in Loop: Header=BB4_162 Depth=1
	move	$s2, $fp
	move	$s6, $ra
	move	$s1, $a0
	b	.LBB4_172
.LBB4_183:                              # %if.then1201.2
                                        #   in Loop: Header=BB4_162 Depth=1
	ld.d	$a0, $sp, 328                   # 8-byte Folded Reload
	ld.d	$a2, $a0, 0
	slli.d	$a0, $s5, 2
...
# %bb.184:                              # %if.then1215.2
	...
	bge	$a0, $a1, .LBB4_175
# %bb.185:                              # %if.then1235.2
                                        #   in Loop: Header=BB4_162 Depth=1
	move	$s2, $t4
	move	$s6, $s5
	move	$s1, $a0
	b	.LBB4_175
.LBB4_186:                              #   in Loop: Header=BB4_162 Depth=1
	move	$s2, $t4
	ld.d	$s8, $sp, 192                   # 8-byte Folded Reload
	b	.LBB4_172
.LBB4_187:                              #   in Loop: Header=BB4_162 Depth=1
	ld.d	$s8, $sp, 192                   # 8-byte Folded Reload
	bge	$t0, $s4, .LBB4_176
	.p2align	4, , 16
.LBB4_188:                              # %for.inc1240.3
                                        #   in Loop: Header=BB4_162 Depth=1
	bne	$s6, $ra, .LBB4_160
# %bb.189:                              # %for.inc1240.3
                                        #   in Loop: Header=BB4_162 Depth=1
	ld.d	$a3, $sp, 296                   # 8-byte Folded Reload
	bne	$s2, $t4, .LBB4_161
	b	.LBB4_256
.LBB4_190:
	...
	st.d	$ra, $sp, 120                   # 8-byte Folded Spill
	b	.LBB4_194
.LBB4_191:                              # %for.cond756.preheader
	ori	$a0, $zero, 4
	blt	$t0, $a0, .LBB4_193
# %bb.192:                              # %for.body760.lr.ph
...
.LBB4_198:
	ld.d	$s8, $sp, 192                   # 8-byte Folded Reload
.LBB4_199:                              # %fourth_1_step
	ori	$a0, $zero, 1
	blt	$t0, $a0, .LBB4_255
# %bb.200:                              # %for.cond1087.preheader.preheader
	move	$a1, $zero
	...
	b	.LBB4_202
	.p2align	4, , 16
.LBB4_201:                              # %for.cond1083
                                        #   in Loop: Header=BB4_202 Depth=1
	addi.w	$a1, $a0, 1
	beq	$a1, $t0, .LBB4_139
.LBB4_202:                              # %for.cond1087.preheader
	...
	b	.LBB4_204
	.p2align	4, , 16
.LBB4_203:                              # %for.inc1155
                                        #   in Loop: Header=BB4_204 Depth=2
	addi.d	$s8, $s8, 4
	beq	$s8, $a6, .LBB4_210
.LBB4_204:                              # %for.body1090
...
# %bb.212:
	...
	move	$ra, $s6
	b	.LBB4_139
.LBB4_213:                              # %for.body902.preheader
	...
	b	.LBB4_216
.LBB4_214:                              #   in Loop: Header=BB4_216 Depth=1
	ld.d	$a6, $sp, 88                    # 8-byte Folded Reload
	ld.d	$t5, $sp, 120                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB4_215:                              # %for.inc969
...
# %bb.221:                              # %if.then964
	...
	ld.d	$t1, $sp, 264                   # 8-byte Folded Reload
	b	.LBB4_223
.LBB4_222:                              #   in Loop: Header=BB4_216 Depth=1
	ld.d	$a7, $sp, 256                   # 8-byte Folded Reload
	ld.d	$t0, $sp, 272                   # 8-byte Folded Reload
	ld.d	$t1, $sp, 264                   # 8-byte Folded Reload
	move	$ra, $s2
...
# %bb.226:                              # %if.end988
	...
	ld.d	$s8, $sp, 192                   # 8-byte Folded Reload
	blt	$t0, $a0, .LBB4_199
# %bb.227:                              # %for.cond995.preheader.preheader
...
.LBB4_228:                              # %for.cond995.preheader
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB4_231 Depth 2
	move	$s3, $zero
	st.d	$a0, $sp, 168                   # 8-byte Folded Spill
	b	.LBB4_231
.LBB4_229:                              #   in Loop: Header=BB4_231 Depth=2
	ld.d	$t5, $sp, 120                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB4_230:                              # %for.inc1073
                                        #   in Loop: Header=BB4_231 Depth=2
	addi.d	$s3, $s3, 4
	beq	$s3, $a6, .LBB4_237
.LBB4_231:                              # %for.body998
                                        #   Parent Loop BB4_228 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.w	$a0, $s3, $s4
	ldx.w	$a2, $a5, $s3
	ldx.w	$a1, $s3, $s5
...
.LBB4_239:
	...
	ld.d	$s5, $sp, 88                    # 8-byte Folded Reload
	b	.LBB4_121
.LBB4_240:                              # %for.body760.preheader
...
# %bb.247:                              # %if.then815
	...
	move	$s1, $a0
	b	.LBB4_249
.LBB4_248:                              #   in Loop: Header=BB4_243 Depth=1
	ld.d	$a2, $sp, 200                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB4_249:                              # %land.lhs.true825
                                        #   in Loop: Header=BB4_243 Depth=1
	add.w	$a0, $t4, $s8
	srai.d	$a1, $a0, 31
	xor	$a0, $a0, $a1
...
.LBB4_256:                              # %terminate_step
	...
	ld.d	$s6, $sp, 176                   # 8-byte Folded Reload
	blt	$a0, $a2, .LBB4_273
# %bb.257:                              # %for.cond1258.preheader.lr.ph
	ld.d	$a1, $sp, 288                   # 8-byte Folded Reload
	srai.d	$a1, $a1, 2
	blt	$a1, $a2, .LBB4_273
# %bb.258:                              # %for.cond1258.preheader.us.preheader
	move	$a2, $zero
	...
	b	.LBB4_260
	.p2align	4, , 16
.LBB4_259:                              # %for.cond1258.for.inc1318_crit_edge.us
                                        #   in Loop: Header=BB4_260 Depth=1
	addi.d	$a2, $a2, 1
	beq	$a2, $a0, .LBB4_273
.LBB4_260:                              # %for.cond1258.preheader.us
                                        # =>This Loop Header: Depth=1
	...
	beqz	$t3, .LBB4_263
# %bb.261:                              # %for.body1262.lr.ph.split.us913
                                        #   in Loop: Header=BB4_260 Depth=1
...
.LBB4_262:                              # %for.body1262.us908
	...
	b	.LBB4_259
	.p2align	4, , 16
.LBB4_263:                              # %for.body1262.lr.ph.split.us.us
                                        #   in Loop: Header=BB4_260 Depth=1
	...
	beqz	$t7, .LBB4_266
# %bb.264:                              # %for.body1262.us.us914.preheader
                                        #   in Loop: Header=BB4_260 Depth=1
	bgeu	$a1, $t2, .LBB4_268
# %bb.265:                              #   in Loop: Header=BB4_260 Depth=1
	move	$t5, $zero
	b	.LBB4_271
.LBB4_266:                              # %for.body1262.lr.ph.split.us.split.us.us
                                        #   in Loop: Header=BB4_260 Depth=1
	...
	.p2align	4, , 16
.LBB4_267:                              # %for.body1262.us.us.us
                                        #   Parent Loop BB4_260 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$s0, $t6, 0
	stx.w	$s1, $s0, $t3
	...
	bnez	$t8, .LBB4_267
	b	.LBB4_259
.LBB4_268:                              # %vector.body.preheader
                                        #   in Loop: Header=BB4_260 Depth=1
	add.d	$t4, $t6, $a5
	move	$t5, $s7
	.p2align	4, , 16
...
# %bb.270:                              # %middle.block
	...
	ld.d	$a3, $sp, 296                   # 8-byte Folded Reload
	beq	$s7, $a1, .LBB4_259
.LBB4_271:                              # %for.body1262.us.us914.preheader1029
                                        #   in Loop: Header=BB4_260 Depth=1
	add.d	$t4, $t6, $a4
	alsl.d	$t4, $t5, $t4, 3
	sub.d	$t5, $a1, $t5
	.p2align	4, , 16
.LBB4_272:                              # %for.body1262.us.us914
                                        #   Parent Loop BB4_260 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$t6, $t4, 0
	stx.w	$s1, $t6, $t3
...
.LBB4_273:                              # %for.end1320
	...
	beqz	$a2, .LBB4_275
# %bb.274:                              # %lor.lhs.false1324
	ldx.w	$a2, $a4, $a1
	bge	$a0, $a2, .LBB4_276
.LBB4_275:                              # %if.then1329
	stx.w	$s1, $a4, $a1
.LBB4_276:                              # %if.end1332
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	sub.d	$a1, $ra, $a1
