...
.LBB4_88:                               # %if.end377
	blt	$s8, $a2, .LBB4_217
# %bb.89:                               # %if.end377.if.else381_crit_edge
	ld.d	$a4, $s6, 0
.LBB4_90:                               # %if.else381
	move	$s1, $t4
	move	$s6, $t3
...
.LBB4_133:
	move	$s3, $s7
.LBB4_134:                              # %for.inc607.2
	st.d	$s5, $sp, 216                   # 8-byte Folded Spill
	blt	$t0, $s1, .LBB4_140
# %bb.135:                              # %land.lhs.true553.3
	addi.w	$s1, $t6, -1
	sub.w	$a0, $s1, $t1
	srai.d	$a1, $a0, 31
	xor	$a2, $a0, $a1
...
# %bb.181:                              # %if.then1191.2
	...
	beqz	$a0, .LBB4_187
	.p2align	4, , 16
.LBB4_182:                              # %for.inc1240.2
                                        #   in Loop: Header=BB4_166 Depth=1
	blt	$t0, $s4, .LBB4_191
.LBB4_183:                              # %land.lhs.true1186.3
                                        #   in Loop: Header=BB4_166 Depth=1
	addi.w	$s4, $t4, -1
	sub.w	$a0, $s4, $t1
	srai.d	$a1, $a0, 31
...
.LBB4_190:                              #   in Loop: Header=BB4_166 Depth=1
	...
	bge	$t0, $s4, .LBB4_183
	.p2align	4, , 16
.LBB4_191:                              # %for.inc1240.3
                                        #   in Loop: Header=BB4_166 Depth=1
	bne	$s1, $t3, .LBB4_164
# %bb.192:                              # %for.inc1240.3
                                        #   in Loop: Header=BB4_166 Depth=1
	ld.d	$s6, $sp, 304                   # 8-byte Folded Reload
	ld.d	$s4, $sp, 192                   # 8-byte Folded Reload
	ld.d	$s5, $sp, 216                   # 8-byte Folded Reload
...
.LBB4_193:
	...
	st.d	$t3, $sp, 112                   # 8-byte Folded Spill
	b	.LBB4_197
.LBB4_194:                              # %for.cond756.preheader
	ori	$a0, $zero, 4
	blt	$t0, $a0, .LBB4_196
# %bb.195:                              # %for.body760.lr.ph
...
.LBB4_217:                              # %terminate_step
	...
	blez	$a0, .LBB4_234
# %bb.218:                              # %for.cond1258.preheader.lr.ph
	ld.d	$a1, $sp, 312                   # 8-byte Folded Reload
	srai.d	$a1, $a1, 2
	blez	$a1, .LBB4_234
# %bb.219:                              # %for.cond1258.preheader.us.preheader
	move	$a2, $zero
	...
	b	.LBB4_221
	.p2align	4, , 16
.LBB4_220:                              # %for.cond1258.for.inc1318_crit_edge.us
                                        #   in Loop: Header=BB4_221 Depth=1
	addi.d	$a2, $a2, 1
	beq	$a2, $a0, .LBB4_234
.LBB4_221:                              # %for.cond1258.preheader.us
                                        # =>This Loop Header: Depth=1
	...
	add.d	$t5, $a2, $s4
	beqz	$ra, .LBB4_224
# %bb.222:                              # %for.body1262.lr.ph.split.us913
                                        #   in Loop: Header=BB4_221 Depth=1
...
.LBB4_223:                              # %for.body1262.us908
	...
	b	.LBB4_220
	.p2align	4, , 16
.LBB4_224:                              # %for.body1262.lr.ph.split.us.us
                                        #   in Loop: Header=BB4_221 Depth=1
	...
	slli.d	$t3, $t5, 2
	beqz	$s2, .LBB4_227
# %bb.225:                              # %for.body1262.us.us914.preheader
                                        #   in Loop: Header=BB4_221 Depth=1
	bgeu	$a1, $t2, .LBB4_229
# %bb.226:                              #   in Loop: Header=BB4_221 Depth=1
	move	$t5, $zero
	b	.LBB4_232
.LBB4_227:                              # %for.body1262.lr.ph.split.us.split.us.us
                                        #   in Loop: Header=BB4_221 Depth=1
	...
	move	$fp, $s5
	.p2align	4, , 16
.LBB4_228:                              # %for.body1262.us.us.us
                                        #   Parent Loop BB4_221 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$s0, $t6, 0
	stx.w	$s8, $s0, $t3
...
# %bb.231:                              # %middle.block
	...
	move	$t5, $a3
	beq	$a3, $a1, .LBB4_220
.LBB4_232:                              # %for.body1262.us.us914.preheader1029
                                        #   in Loop: Header=BB4_221 Depth=1
	add.d	$t4, $t6, $a4
	alsl.d	$t4, $t5, $t4, 3
	sub.d	$t5, $a1, $t5
	.p2align	4, , 16
.LBB4_233:                              # %for.body1262.us.us914
                                        #   Parent Loop BB4_221 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$t6, $t4, 0
	stx.w	$s8, $t6, $t3
	...
	bnez	$t5, .LBB4_233
	b	.LBB4_220
.LBB4_234:                              # %for.end1320
	addi.w	$a0, $s8, 0
	ld.d	$a1, $sp, 136                   # 8-byte Folded Reload
	slli.d	$a1, $a1, 2
	ld.d	$a3, $sp, 160                   # 8-byte Folded Reload
	beqz	$s2, .LBB4_236
# %bb.235:                              # %lor.lhs.false1324
	ldx.w	$a2, $a3, $a1
	bge	$a0, $a2, .LBB4_237
.LBB4_236:                              # %if.then1329
	stx.w	$s8, $a3, $a1
.LBB4_237:                              # %if.end1332
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	sub.d	$a1, $s3, $a1
	...
	addi.d	$sp, $sp, 608
	ret
.LBB4_238:                              # %for.body902.preheader
...
# %bb.252:                              # %if.end988
	...
	ld.d	$s5, $sp, 216                   # 8-byte Folded Reload
	blt	$t0, $a0, .LBB4_202
# %bb.253:                              # %for.cond995.preheader.preheader
...
.LBB4_254:                              # %for.cond995.preheader
                                        # =>This Loop Header: Depth=1
...
.LBB4_255:                              #   in Loop: Header=BB4_257 Depth=2
	ld.d	$a6, $sp, 112                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB4_256:                              # %for.inc1073
                                        #   in Loop: Header=BB4_257 Depth=2
	addi.d	$s2, $s2, 4
	beq	$s2, $t6, .LBB4_263
.LBB4_257:                              # %for.body998
                                        #   Parent Loop BB4_254 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.w	$a0, $s2, $s3
	ldx.w	$a2, $a5, $s2
	ldx.w	$a1, $s2, $s4
...
# %bb.262:                              # %if.then1068
	...
	st.d	$a0, $sp, 336                   # 8-byte Folded Spill
	b	.LBB4_256
.LBB4_263:                              # %for.end1075
                                        #   in Loop: Header=BB4_254 Depth=1
	ld.d	$s8, $sp, 336                   # 8-byte Folded Reload
	addi.w	$a0, $s8, 0
...
# %bb.264:                              # %for.cond990
	...
	bne	$a2, $a1, .LBB4_254
	b	.LBB4_202
.LBB4_265:                              # %for.body760.preheader
