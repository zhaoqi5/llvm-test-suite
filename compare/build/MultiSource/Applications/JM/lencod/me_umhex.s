...
.LBB4_4:                                # %cond.end
	...
	ld.w	$a5, $a1, 192
	slli.d	$t5, $t1, 2
	pcalau12i	$t3, %pc_hi20(Median_Pred_Thd_MB)
	addi.d	$t3, $t3, %pc_lo12(Median_Pred_Thd_MB)
	alsl.d	$t1, $t1, $a3, 3
	beqz	$a5, .LBB4_7
...
.LBB4_11:                               # %land.end.thread
	...
	ld.d	$t8, $t0, %got_pc_lo12(ref_pic_sub)
	lu12i.w	$s0, 1
	ori	$t0, $s0, 2296
	ldx.w	$t5, $a5, $t0
...
.LBB4_41:                               # %for.inc.2
	slli.w	$t7, $s4, 16
	slli.w	$t8, $s5, 16
	bstrpick.d	$s4, $s6, 15, 0
	ld.d	$a0, $sp, 312                   # 8-byte Folded Reload
	bstrpick.d	$s5, $a0, 15, 0
	blt	$a6, $s2, .LBB4_43
# %bb.42:                               # %land.lhs.true170.3
	addi.w	$s2, $s8, -1
	sub.w	$a0, $s2, $a7
	srai.d	$a1, $a0, 31
	xor	$a2, $a0, $a1
...
# %bb.70:                               # %if.then351.2
	...
	move	$t3, $s3
	move	$s7, $a0
.LBB4_71:                               # %for.inc356.2
	blt	$a6, $s2, .LBB4_77
# %bb.72:                               # %land.lhs.true302.3
	addi.w	$fp, $t6, -1
	sub.w	$a0, $fp, $a7
	srai.d	$a1, $a0, 31
	xor	$a2, $a0, $a1
...
.LBB4_82:                               # %if.end377
	blt	$s7, $a5, .LBB4_258
# %bb.83:                               # %if.end377.if.else381_crit_edge
	ld.d	$a4, $s8, 0
.LBB4_84:                               # %if.else381
	move	$s8, $t4
	move	$s0, $t3
...
# %bb.143:                              # %if.else617
	...
	bcnez	$fcc0, .LBB4_202
# %bb.144:                              # %for.cond631.preheader
	ori	$a0, $zero, 2
	blt	$t0, $a0, .LBB4_193
# %bb.145:                              # %for.body634.lr.ph
	sub.w	$a0, $t4, $t1
	srai.d	$a1, $a0, 31
	xor	$a2, $a0, $a1
	sub.w	$a4, $a2, $a1
	...
	b	.LBB4_148
.LBB4_146:                              #   in Loop: Header=BB4_148 Depth=1
	move	$s7, $a2
	.p2align	4, , 16
.LBB4_147:                              # %for.inc753
...
.LBB4_161:
	...
	ld.d	$s4, $sp, 224                   # 8-byte Folded Reload
	b	.LBB4_258
.LBB4_162:                              #   in Loop: Header=BB4_165 Depth=1
	move	$s7, $a0
	move	$s3, $t3
	move	$fp, $s2
	.p2align	4, , 16
.LBB4_163:                              #   in Loop: Header=BB4_165 Depth=1
	ld.d	$s5, $sp, 216                   # 8-byte Folded Reload
	ld.d	$s4, $sp, 224                   # 8-byte Folded Reload
.LBB4_164:                              # %for.cond1168
                                        #   in Loop: Header=BB4_165 Depth=1
	addi.w	$s0, $s0, -1
	move	$t3, $s3
	move	$t4, $fp
	beqz	$s0, .LBB4_258
.LBB4_165:                              # %for.cond1172.preheader
                                        # =>This Inner Loop Header: Depth=1
	addi.w	$fp, $t3, -1
	sub.w	$a0, $fp, $a7
	srai.d	$a1, $a0, 31
...
# %bb.173:                              # %if.then1191.1
	...
	beqz	$a0, .LBB4_183
	.p2align	4, , 16
.LBB4_174:                              #   in Loop: Header=BB4_165 Depth=1
	move	$fp, $t4
.LBB4_175:                              # %for.inc1240.1
                                        #   in Loop: Header=BB4_165 Depth=1
	addi.w	$s5, $t3, 1
	sub.w	$a0, $s5, $a7
	srai.d	$a1, $a0, 31
	...
	sub.w	$a1, $a2, $a1
	blt	$t0, $a1, .LBB4_178
# %bb.176:                              # %land.lhs.true1186.2
                                        #   in Loop: Header=BB4_165 Depth=1
	srai.d	$a1, $s2, 31
	xor	$a2, $s2, $a1
	sub.w	$a1, $a2, $a1
	bltu	$t0, $a1, .LBB4_178
# %bb.177:                              # %if.then1191.2
                                        #   in Loop: Header=BB4_165 Depth=1
	ld.d	$a1, $t2, %pc_lo12(McostState)
	add.w	$a2, $s2, $t0
	slli.d	$s6, $a2, 3
	...
	beqz	$a0, .LBB4_186
	.p2align	4, , 16
.LBB4_178:                              # %for.inc1240.2
                                        #   in Loop: Header=BB4_165 Depth=1
	blt	$t0, $s4, .LBB4_191
.LBB4_179:                              # %land.lhs.true1186.3
                                        #   in Loop: Header=BB4_165 Depth=1
	addi.w	$s2, $t4, -1
	sub.w	$a0, $s2, $t1
	srai.d	$a1, $a0, 31
...
# %bb.184:                              # %if.then1215.1
	...
	ld.d	$a1, $sp, 328                   # 8-byte Folded Reload
	bge	$a0, $a1, .LBB4_175
# %bb.185:                              # %if.then1235.1
                                        #   in Loop: Header=BB4_165 Depth=1
	move	$fp, $s5
	move	$s3, $t3
	move	$s7, $a0
	b	.LBB4_175
.LBB4_186:                              # %if.then1201.2
                                        #   in Loop: Header=BB4_165 Depth=1
	ld.d	$a0, $sp, 352                   # 8-byte Folded Reload
	ld.d	$a2, $a0, 0
	slli.d	$a0, $s5, 2
...
.LBB4_189:                              #   in Loop: Header=BB4_165 Depth=1
	...
	ld.d	$s8, $sp, 192                   # 8-byte Folded Reload
	b	.LBB4_175
.LBB4_190:                              #   in Loop: Header=BB4_165 Depth=1
	ld.d	$s8, $sp, 192                   # 8-byte Folded Reload
	bge	$t0, $s4, .LBB4_179
	.p2align	4, , 16
...
# %bb.242:                              # %for.cond990
	...
	bne	$a2, $a1, .LBB4_232
	b	.LBB4_202
.LBB4_243:                              # %for.body760.preheader
	...
	b	.LBB4_246
.LBB4_244:                              #   in Loop: Header=BB4_246 Depth=1
	ld.d	$a2, $sp, 184                   # 8-byte Folded Reload
...
.LBB4_258:                              # %terminate_step
	...
	blt	$a0, $a2, .LBB4_269
# %bb.259:                              # %for.cond1258.preheader.lr.ph
	ld.d	$a1, $sp, 304                   # 8-byte Folded Reload
	srai.d	$a1, $a1, 2
	blt	$a1, $a2, .LBB4_269
# %bb.260:                              # %for.cond1258.preheader.us.preheader
	move	$a2, $zero
	slli.d	$a3, $s4, 3
	...
	b	.LBB4_262
	.p2align	4, , 16
.LBB4_261:                              # %for.cond1258.for.inc1318_crit_edge.us
                                        #   in Loop: Header=BB4_262 Depth=1
	addi.d	$a2, $a2, 1
	beq	$a2, $a0, .LBB4_269
.LBB4_262:                              # %for.cond1258.preheader.us
                                        # =>This Loop Header: Depth=1
	...
	add.d	$t2, $a2, $s5
	beqz	$ra, .LBB4_265
# %bb.263:                              # %for.body1262.lr.ph.split.us913
                                        #   in Loop: Header=BB4_262 Depth=1
	...
	move	$t5, $a1
	.p2align	4, , 16
.LBB4_264:                              # %for.body1262.us908
                                        #   Parent Loop BB4_262 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t6, $t1, 180
	srli.d	$t6, $t6, 2
	ld.w	$t7, $t1, 176
	...
	b	.LBB4_261
	.p2align	4, , 16
.LBB4_265:                              # %for.body1262.lr.ph.split.us.us
                                        #   in Loop: Header=BB4_262 Depth=1
	...
	b	.LBB4_267
	.p2align	4, , 16
.LBB4_266:                              # %for.inc1315.us.us
                                        #   in Loop: Header=BB4_267 Depth=2
	addi.d	$t7, $t7, 1
	addi.d	$t6, $t6, -1
	addi.d	$t4, $t4, 8
	beqz	$t6, .LBB4_261
.LBB4_267:                              # %for.body1262.us.us
                                        #   Parent Loop BB4_262 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$t8, $t4, 0
	stx.w	$s7, $t8, $t5
	bnez	$s2, .LBB4_266
# %bb.268:                              # %if.then1281.us.us
                                        #   in Loop: Header=BB4_267 Depth=2
	ld.w	$t8, $t1, 180
	ld.d	$fp, $t3, 0
	srli.d	$t8, $t8, 2
	...
	stx.w	$s7, $t8, $fp
	b	.LBB4_266
.LBB4_269:                              # %for.end1320
	addi.w	$a0, $s7, 0
	ld.d	$a1, $sp, 136                   # 8-byte Folded Reload
	slli.d	$a1, $a1, 2
	ld.d	$a3, $sp, 160                   # 8-byte Folded Reload
	beqz	$s2, .LBB4_271
# %bb.270:                              # %lor.lhs.false1324
	ldx.w	$a2, $a3, $a1
	bge	$a0, $a2, .LBB4_272
.LBB4_271:                              # %if.then1329
	stx.w	$s7, $a3, $a1
.LBB4_272:                              # %if.end1332
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	sub.d	$a1, $s3, $a1
