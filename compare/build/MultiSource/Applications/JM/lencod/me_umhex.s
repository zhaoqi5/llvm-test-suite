...
.LBB4_11:                               # %land.end.thread
	...
	st.d	$t4, $a3, %pc_lo12(ref_pic_ptr)
	pcalau12i	$a3, %got_pc_hi20(ref_pic_sub)
	ld.d	$fp, $a3, %got_pc_lo12(ref_pic_sub)
	lu12i.w	$a6, 1
	ori	$a3, $a6, 2296
	ldx.w	$a3, $t4, $a3
	st.d	$a2, $fp, 0
...
# %bb.14:                               # %if.then69
	...
	st.w	$t1, $a6, %pc_lo12(width_pad_cr)
	pcalau12i	$a6, %pc_hi20(height_pad_cr)
	st.w	$t0, $a6, %pc_lo12(height_pad_cr)
	beqz	$a1, .LBB4_16
# %bb.15:                               # %if.then74
...
.LBB4_44:                               # %for.inc.2
	...
	bstrpick.d	$s5, $t1, 15, 0
	blt	$a6, $s4, .LBB4_46
# %bb.45:                               # %land.lhs.true170.3
	addi.w	$s4, $s8, -1
	sub.w	$a0, $s4, $a7
	srai.d	$a1, $a0, 31
	xor	$a2, $a0, $a1
...
.LBB4_79:
	ld.d	$s6, $sp, 176                   # 8-byte Folded Reload
.LBB4_80:                               # %for.inc356.2
	blt	$a6, $s3, .LBB4_86
# %bb.81:                               # %land.lhs.true302.3
	addi.w	$s3, $t6, -1
	sub.w	$a0, $s3, $a7
	srai.d	$a1, $a0, 31
	xor	$a2, $a0, $a1
...
.LBB4_87:                               # %if.end359
	...
	blez	$a0, .LBB4_91
# %bb.88:                               # %land.lhs.true363
	ld.d	$a0, $sp, 368                   # 8-byte Folded Reload
	ld.d	$a0, $a0, 0
	ld.w	$a1, $a0, 24
	bnez	$a1, .LBB4_91
# %bb.89:                               # %land.lhs.true363
	bge	$a2, $s1, .LBB4_91
# %bb.90:                               # %land.lhs.true369
	slli.d	$a1, $fp, 2
	ld.d	$a2, $sp, 160                   # 8-byte Folded Reload
	ldx.w	$a1, $a2, $a1
	slli.d	$a2, $s8, 2
	pcalau12i	$a4, %pc_hi20(Multi_Ref_Thd_MB)
	addi.d	$a4, $a4, %pc_lo12(Multi_Ref_Thd_MB)
	ldx.w	$a2, $a4, $a2
	bge	$a1, $a2, .LBB4_93
	b	.LBB4_245
.LBB4_91:                               # %if.end377
	blt	$s1, $a2, .LBB4_245
# %bb.92:                               # %if.end377.if.else381_crit_edge
	ld.d	$a0, $sp, 368                   # 8-byte Folded Reload
	ld.d	$a0, $a0, 0
.LBB4_93:                               # %if.else381
	move	$s5, $t4
	...
	pcalau12i	$s4, %pc_hi20(pred_SAD)
	ld.w	$a2, $s4, %pc_lo12(pred_SAD)
	beqz	$a2, .LBB4_95
# %bb.94:                               # %if.else389
...
.LBB4_135:
	ld.d	$t7, $sp, 56                    # 8-byte Folded Reload
.LBB4_136:                              # %for.inc607.2
	move	$s4, $s7
.LBB4_137:                              # %for.inc607.2
	blt	$t0, $s2, .LBB4_143
# %bb.138:                              # %land.lhs.true553.3
	addi.w	$s2, $t6, -1
	sub.w	$a0, $s2, $t1
	srai.d	$a1, $a0, 31
	xor	$a2, $a0, $a1
...
# %bb.142:                              # %if.then602.3
	...
	ld.d	$ra, $sp, 112                   # 8-byte Folded Reload
	move	$s1, $a0
.LBB4_143:                              # %for.inc607.3
	ld.w	$a0, $s4, %pc_lo12(pred_SAD)
	sub.d	$a1, $s1, $a0
	movgr2fr.w	$fa0, $a1
	ffint.s.w	$fa0, $fa0
	movgr2fr.w	$fa1, $a0
...
# %bb.147:                              # %if.else617
	...
	bcnez	$fcc0, .LBB4_202
# %bb.148:                              # %for.cond631.preheader
	st.d	$s4, $sp, 48                    # 8-byte Folded Spill
	st.d	$t7, $sp, 56                    # 8-byte Folded Spill
	ori	$a0, $zero, 2
	blt	$t0, $a0, .LBB4_194
# %bb.149:                              # %for.body634.lr.ph
	sub.w	$a0, $t4, $t1
	srai.d	$a1, $a0, 31
	xor	$a2, $a0, $a1
	sub.w	$a4, $a2, $a1
...
.LBB4_165:                              # %for.cond1168
                                        #   in Loop: Header=BB4_166 Depth=1
	addi.w	$s0, $s0, -1
	move	$ra, $s6
	move	$t4, $s2
	beqz	$s0, .LBB4_245
.LBB4_166:                              # %for.cond1172.preheader
                                        # =>This Inner Loop Header: Depth=1
	addi.w	$s2, $ra, -1
	sub.w	$a0, $s2, $a7
	srai.d	$a1, $a0, 31
...
# %bb.174:                              # %if.then1191.1
	...
	beqz	$a0, .LBB4_184
	.p2align	4, , 16
.LBB4_175:                              #   in Loop: Header=BB4_166 Depth=1
	move	$s2, $t4
.LBB4_176:                              # %for.inc1240.1
                                        #   in Loop: Header=BB4_166 Depth=1
	addi.w	$s5, $ra, 1
	sub.w	$a0, $s5, $a7
	srai.d	$a1, $a0, 31
...
# %bb.178:                              # %if.then1191.2
	...
	beqz	$a0, .LBB4_187
	.p2align	4, , 16
.LBB4_179:                              # %for.inc1240.2
                                        #   in Loop: Header=BB4_166 Depth=1
	blt	$t0, $s4, .LBB4_192
.LBB4_180:                              # %land.lhs.true1186.3
                                        #   in Loop: Header=BB4_166 Depth=1
	addi.w	$s4, $t4, -1
	sub.w	$a0, $s4, $t1
	srai.d	$a1, $a0, 31
...
# %bb.185:                              # %if.then1215.1
	...
	ld.d	$s8, $sp, 192                   # 8-byte Folded Reload
	bge	$a0, $s7, .LBB4_176
# %bb.186:                              # %if.then1235.1
                                        #   in Loop: Header=BB4_166 Depth=1
	move	$s2, $fp
	move	$s6, $ra
	move	$s1, $a0
	b	.LBB4_176
.LBB4_187:                              # %if.then1201.2
                                        #   in Loop: Header=BB4_166 Depth=1
	ld.d	$a0, $sp, 320                   # 8-byte Folded Reload
	ld.d	$a2, $a0, 0
	slli.d	$a0, $s5, 2
...
.LBB4_191:                              #   in Loop: Header=BB4_166 Depth=1
	...
	bge	$t0, $s4, .LBB4_180
	.p2align	4, , 16
.LBB4_192:                              # %for.inc1240.3
                                        #   in Loop: Header=BB4_166 Depth=1
	bne	$s6, $ra, .LBB4_164
# %bb.193:                              # %for.inc1240.3
                                        #   in Loop: Header=BB4_166 Depth=1
	ld.d	$a3, $sp, 280                   # 8-byte Folded Reload
	bne	$s2, $t4, .LBB4_165
	b	.LBB4_245
.LBB4_194:
	...
	st.d	$ra, $sp, 128                   # 8-byte Folded Spill
	b	.LBB4_198
.LBB4_195:                              # %for.cond756.preheader
	ori	$a0, $zero, 4
	blt	$t0, $a0, .LBB4_197
# %bb.196:                              # %for.body760.lr.ph
...
# %bb.201:
	...
	move	$ra, $a6
	ld.d	$s8, $sp, 192                   # 8-byte Folded Reload
.LBB4_202:                              # %fourth_1_step
	blez	$t0, .LBB4_244
# %bb.203:                              # %for.cond1087.preheader.preheader
	...
	b	.LBB4_205
	.p2align	4, , 16
.LBB4_204:                              # %for.cond1083
                                        #   in Loop: Header=BB4_205 Depth=1
	addi.w	$a0, $a0, 1
	beq	$a0, $t0, .LBB4_144
.LBB4_205:                              # %for.cond1087.preheader
	...
	b	.LBB4_207
	.p2align	4, , 16
.LBB4_206:                              # %for.inc1155
                                        #   in Loop: Header=BB4_207 Depth=2
	addi.d	$s8, $s8, 4
	beq	$s8, $a6, .LBB4_213
.LBB4_207:                              # %for.body1090
...
# %bb.215:
	...
	move	$ra, $s6
	b	.LBB4_144
.LBB4_216:                              # %for.body902.preheader
	...
	b	.LBB4_219
.LBB4_217:                              #   in Loop: Header=BB4_219 Depth=1
	ld.d	$s8, $sp, 192                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB4_218:                              # %for.inc969
...
# %bb.224:                              # %if.then964
	...
	ld.d	$t1, $sp, 264                   # 8-byte Folded Reload
	b	.LBB4_227
.LBB4_225:                              #   in Loop: Header=BB4_219 Depth=1
	ld.d	$s8, $sp, 192                   # 8-byte Folded Reload
	ld.d	$a6, $sp, 128                   # 8-byte Folded Reload
	b	.LBB4_218
.LBB4_226:                              #   in Loop: Header=BB4_219 Depth=1
	ld.d	$s8, $sp, 192                   # 8-byte Folded Reload
	ld.d	$a7, $sp, 256                   # 8-byte Folded Reload
	ld.d	$t0, $sp, 272                   # 8-byte Folded Reload
	ld.d	$t1, $sp, 264                   # 8-byte Folded Reload
...
# %bb.230:                              # %if.end988
	...
	addi.d	$s2, $a0, %pc_lo12(Big_Hexagon_y)
	xvld	$xr0, $s2, 0
	xvld	$xr1, $s2, 32
	xvst	$xr0, $sp, 376
	ori	$a0, $zero, 4
	xvst	$xr1, $sp, 408
	blt	$t0, $a0, .LBB4_202
# %bb.231:                              # %for.cond995.preheader.preheader
	...
	ori	$a0, $zero, 1
	st.d	$a5, $sp, 120                   # 8-byte Folded Spill
.LBB4_232:                              # %for.cond995.preheader
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB4_235 Depth 2
	move	$s3, $zero
	st.d	$a0, $sp, 168                   # 8-byte Folded Spill
	b	.LBB4_235
.LBB4_233:                              #   in Loop: Header=BB4_235 Depth=2
	ld.d	$a6, $sp, 128                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB4_234:                              # %for.inc1073
                                        #   in Loop: Header=BB4_235 Depth=2
	addi.d	$s3, $s3, 4
	beq	$s3, $t6, .LBB4_241
.LBB4_235:                              # %for.body998
...
.LBB4_243:
	ld.d	$s8, $sp, 192                   # 8-byte Folded Reload
.LBB4_244:                              # %terminate_step
	ld.d	$a3, $sp, 280                   # 8-byte Folded Reload
.LBB4_245:                              # %terminate_step
	move	$a5, $t4
	ld.d	$a0, $sp, 304                   # 8-byte Folded Reload
	srai.d	$a0, $a0, 2
	ld.d	$s6, $sp, 176                   # 8-byte Folded Reload
	blez	$a0, .LBB4_262
# %bb.246:                              # %for.cond1258.preheader.lr.ph
	ld.d	$a1, $sp, 288                   # 8-byte Folded Reload
	srai.d	$a1, $a1, 2
	blez	$a1, .LBB4_262
# %bb.247:                              # %for.cond1258.preheader.us.preheader
	move	$a2, $zero
	...
	b	.LBB4_249
	.p2align	4, , 16
.LBB4_248:                              # %for.cond1258.for.inc1318_crit_edge.us
                                        #   in Loop: Header=BB4_249 Depth=1
	addi.d	$a2, $a2, 1
	beq	$a2, $a0, .LBB4_262
.LBB4_249:                              # %for.cond1258.preheader.us
                                        # =>This Loop Header: Depth=1
	...
	beqz	$t3, .LBB4_252
# %bb.250:                              # %for.body1262.lr.ph.split.us913
                                        #   in Loop: Header=BB4_249 Depth=1
	...
	move	$t7, $a1
	.p2align	4, , 16
.LBB4_251:                              # %for.body1262.us908
                                        #   Parent Loop BB4_249 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t8, $t4, 180
	srli.d	$t8, $t8, 2
	ld.w	$fp, $t4, 176
	...
	b	.LBB4_248
	.p2align	4, , 16
.LBB4_252:                              # %for.body1262.lr.ph.split.us.us
                                        #   in Loop: Header=BB4_249 Depth=1
	...
	beqz	$t7, .LBB4_255
# %bb.253:                              # %for.body1262.us.us914.preheader
                                        #   in Loop: Header=BB4_249 Depth=1
	bgeu	$a1, $t2, .LBB4_257
# %bb.254:                              #   in Loop: Header=BB4_249 Depth=1
	move	$t5, $zero
	b	.LBB4_260
.LBB4_255:                              # %for.body1262.lr.ph.split.us.split.us.us
                                        #   in Loop: Header=BB4_249 Depth=1
	...
	.p2align	4, , 16
.LBB4_256:                              # %for.body1262.us.us.us
                                        #   Parent Loop BB4_249 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$s0, $t6, 0
	stx.w	$s1, $s0, $t3
	...
	bnez	$t8, .LBB4_256
	b	.LBB4_248
.LBB4_257:                              # %vector.body.preheader
                                        #   in Loop: Header=BB4_249 Depth=1
	addi.d	$a3, $a4, 32
	add.d	$t4, $t6, $a3
	move	$t5, $s7
	.p2align	4, , 16
.LBB4_258:                              # %vector.body
                                        #   Parent Loop BB4_249 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$t7, $t4, -32
	ld.d	$t8, $t4, -24
...
# %bb.259:                              # %middle.block
	...
	ld.d	$a3, $sp, 280                   # 8-byte Folded Reload
	beq	$s7, $a1, .LBB4_248
.LBB4_260:                              # %for.body1262.us.us914.preheader1029
                                        #   in Loop: Header=BB4_249 Depth=1
	add.d	$t4, $t6, $a4
	alsl.d	$t4, $t5, $t4, 3
	sub.d	$t5, $a1, $t5
	.p2align	4, , 16
.LBB4_261:                              # %for.body1262.us.us914
                                        #   Parent Loop BB4_249 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$t6, $t4, 0
	stx.w	$s1, $t6, $t3
...
.LBB4_262:                              # %for.end1320
	...
	beqz	$a2, .LBB4_264
# %bb.263:                              # %lor.lhs.false1324
	ldx.w	$a2, $a3, $a1
	bge	$a0, $a2, .LBB4_265
.LBB4_264:                              # %if.then1329
	stx.w	$s1, $a3, $a1
.LBB4_265:                              # %if.end1332
	ld.d	$a1, $sp, 232                   # 8-byte Folded Reload
	sub.d	$a1, $ra, $a1
	...
	addi.d	$sp, $sp, 608
	ret
.LBB4_266:                              # %for.body760.preheader
...
.LBB4_267:                              #   in Loop: Header=BB4_269 Depth=1
	...
	.p2align	4, , 16
.LBB4_268:                              # %for.inc879
                                        #   in Loop: Header=BB4_269 Depth=1
	addi.d	$s3, $s3, 2
	addi.d	$s0, $s0, 2
	addi.d	$t7, $t7, 8
	addi.d	$t6, $t6, 8
...
# %bb.273:                              # %if.then815
	...
	move	$s1, $a0
	b	.LBB4_275
.LBB4_274:                              #   in Loop: Header=BB4_269 Depth=1
	ld.d	$a2, $sp, 200                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB4_275:                              # %land.lhs.true825
                                        #   in Loop: Header=BB4_269 Depth=1
	add.w	$a0, $t4, $s8
	srai.d	$a1, $a0, 31
	xor	$a0, $a0, $a1
...
# %bb.73:                               # %if.then741.2
	...
	move	$t7, $fp
	move	$ra, $a0
.LBB9_74:                               # %for.inc746.2
	blt	$t1, $s3, .LBB9_80
# %bb.75:                               # %land.lhs.true669.3
	addi.w	$fp, $fp, -1
	sub.w	$a0, $fp, $t3
	srai.d	$a1, $a0, 31
	xor	$a2, $a0, $a1
...
.LBB9_99:
	move	$t5, $s7
.LBB9_100:                              # %for.inc1047
	sub.w	$fp, $s7, $t2
	srai.d	$a0, $fp, 31
	xor	$a1, $fp, $a0
	sub.w	$s0, $a1, $a0
	blt	$t1, $s0, .LBB9_106
# %bb.101:                              # %land.lhs.true970.1
	addi.w	$s1, $t7, 1
	sub.w	$a0, $s1, $t3
	srai.d	$a1, $a0, 31
	xor	$a2, $a0, $a1
...
# %bb.111:                              # %if.then1016.2
	...
	stx.b	$a2, $a1, $s3
	bge	$a0, $ra, .LBB9_113
# %bb.112:                              # %if.then1042.2
	move	$t5, $s1
	move	$t6, $t7
	move	$ra, $a0
.LBB9_113:                              # %for.inc1047.2
	blt	$t1, $s0, .LBB9_119
# %bb.114:                              # %land.lhs.true970.3
	addi.w	$s0, $t7, -1
	sub.w	$a0, $s0, $t3
	srai.d	$a1, $a0, 31
	xor	$a2, $a0, $a1
...
# %bb.117:                              # %if.then1016.3
	...
	stx.b	$a2, $a1, $fp
	bge	$a0, $s3, .LBB9_119
# %bb.118:                              # %if.then1042.3
	ld.d	$t5, $sp, 96                    # 8-byte Folded Reload
	move	$t6, $s0
	move	$ra, $a0
.LBB9_119:                              # %for.inc1047.3
	...
	fcmp.clt.s	$fcc0, $fa0, $fa2
	bceqz	$fcc0, .LBB9_122
.LBB9_120:                              # %fourth_2_step
	blez	$t1, .LBB9_220
# %bb.121:
	move	$fp, $t1
	ld.d	$s8, $sp, 200                   # 8-byte Folded Reload
	b	.LBB9_157
.LBB9_122:                              # %if.else1057
	fmul.s	$fa1, $fs0, $fa1
	fcmp.clt.s	$fcc0, $fa0, $fa1
	bceqz	$fcc0, .LBB9_138
.LBB9_123:
	ld.d	$s8, $sp, 200                   # 8-byte Folded Reload
.LBB9_124:                              # %fourth_1_step
	blez	$t1, .LBB9_221
# %bb.125:                              # %for.cond1668.preheader.preheader
	pcalau12i	$a0, %pc_hi20(Hexagon_x)
	...
	b	.LBB9_127
	.p2align	4, , 16
.LBB9_126:                              # %for.cond1664
                                        #   in Loop: Header=BB9_127 Depth=1
	addi.w	$a2, $a2, 1
	beq	$a2, $t1, .LBB9_120
.LBB9_127:                              # %for.cond1668.preheader
                                        # =>This Loop Header: Depth=1
	...
	b	.LBB9_129
	.p2align	4, , 16
.LBB9_128:                              # %for.inc1760
                                        #   in Loop: Header=BB9_129 Depth=2
	addi.d	$s8, $s8, 4
	beq	$s8, $t0, .LBB9_135
.LBB9_129:                              # %for.body1671
...
# %bb.137:
	...
	move	$t6, $s5
	b	.LBB9_120
.LBB9_138:                              # %for.cond1067.preheader
	st.d	$s5, $sp, 40                    # 8-byte Folded Spill
	st.d	$t8, $sp, 24                    # 8-byte Folded Spill
	ori	$a0, $zero, 2
	blt	$t1, $a0, .LBB9_184
# %bb.139:                              # %for.body1070.lr.ph
	sub.w	$a0, $t6, $t3
	srai.d	$a1, $a0, 31
	xor	$a2, $a0, $a1
	sub.w	$a6, $a2, $a1
...
.LBB9_155:                              #   in Loop: Header=BB9_157 Depth=1
	...
	move	$s6, $t5
	.p2align	4, , 16
.LBB9_156:                              # %for.cond1773
                                        #   in Loop: Header=BB9_157 Depth=1
	addi.w	$fp, $fp, -1
	move	$t6, $s0
	move	$t5, $s6
	beqz	$fp, .LBB9_221
.LBB9_157:                              # %for.cond1777.preheader
                                        # =>This Inner Loop Header: Depth=1
	addi.d	$s0, $t5, -1
	sub.w	$a0, $s0, $t2
	srai.d	$a1, $a0, 31
...
# %bb.172:                              # %if.then1798.2
	...
	beqz	$a0, .LBB9_178
	.p2align	4, , 16
.LBB9_173:                              # %for.inc1869.2
                                        #   in Loop: Header=BB9_157 Depth=1
	blt	$t1, $s3, .LBB9_182
.LBB9_174:                              # %land.lhs.true1792.3
                                        #   in Loop: Header=BB9_157 Depth=1
	addi.d	$s3, $t6, -1
	sub.w	$a0, $s3, $t3
	srai.d	$a1, $a0, 31
...
.LBB9_181:                              #   in Loop: Header=BB9_157 Depth=1
	...
	bge	$t1, $s3, .LBB9_174
	.p2align	4, , 16
.LBB9_182:                              # %for.inc1869.3
                                        #   in Loop: Header=BB9_157 Depth=1
	addi.w	$a0, $t5, 0
	addi.w	$a1, $s6, 0
	bne	$a1, $a0, .LBB9_156
# %bb.183:                              # %for.inc1869.3
                                        #   in Loop: Header=BB9_157 Depth=1
	addi.w	$a0, $t6, 0
	addi.w	$a1, $s0, 0
	bne	$a1, $a0, .LBB9_156
...
.LBB9_184:
	st.d	$t5, $sp, 88                    # 8-byte Folded Spill
	b	.LBB9_187
.LBB9_185:                              # %for.cond1240.preheader
	ori	$a0, $zero, 4
	blt	$t1, $a0, .LBB9_187
# %bb.186:                              # %for.body1244.lr.ph
...
# %bb.194:                              # %if.then741.1
	...
	move	$ra, $a0
	b	.LBB9_68
.LBB9_195:                              # %for.body1434.preheader
	pcalau12i	$a0, %got_pc_hi20(spiral_search_x)
	ld.d	$a0, $a0, %got_pc_lo12(spiral_search_x)
...
.LBB9_196:                              #   in Loop: Header=BB9_198 Depth=1
	ld.d	$a7, $sp, 88                    # 8-byte Folded Reload
	.p2align	4, , 16
.LBB9_197:                              # %for.inc1525
                                        #   in Loop: Header=BB9_198 Depth=1
	addi.d	$s1, $s1, 2
	beq	$s1, $s3, .LBB9_206
.LBB9_198:                              # %for.body1434
                                        # =>This Inner Loop Header: Depth=1
	ldx.h	$a0, $a1, $s1
	add.d	$s5, $a7, $a0
	sub.w	$a0, $s5, $t2
...
# %bb.208:                              # %if.end1544
	...
	ld.d	$s8, $sp, 200                   # 8-byte Folded Reload
	blt	$a0, $a1, .LBB9_124
# %bb.209:                              # %for.cond1552.preheader.preheader
	addi.d	$s3, $sp, 440
	addi.d	$s4, $sp, 376
	ori	$t0, $zero, 64
	ori	$a0, $zero, 1
.LBB9_210:                              # %for.cond1552.preheader
                                        # =>This Loop Header: Depth=1
	...
	b	.LBB9_212
	.p2align	4, , 16
.LBB9_211:                              # %for.inc1654
                                        #   in Loop: Header=BB9_212 Depth=2
	addi.d	$s8, $s8, 4
	beq	$s8, $t0, .LBB9_218
.LBB9_212:                              # %for.body1555
                                        #   Parent Loop BB9_210 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.w	$a0, $s8, $s3
	ldx.w	$a2, $fp, $s8
	ldx.w	$a1, $s8, $s4
...
# %bb.217:                              # %if.then1649
	...
	move	$ra, $a0
	b	.LBB9_211
.LBB9_218:                              # %for.end1656
                                        #   in Loop: Header=BB9_210 Depth=1
	addi.w	$a0, $ra, 0
	ld.d	$a1, $sp, 24                    # 8-byte Folded Reload
	blt	$a0, $a1, .LBB9_220
# %bb.219:                              # %for.cond1546
...
.LBB9_221:                              # %terminate_step
	...
	blez	$a0, .LBB9_230
# %bb.222:                              # %for.cond1887.preheader.lr.ph
	ld.d	$a1, $sp, 312                   # 8-byte Folded Reload
	srai.d	$a1, $a1, 2
	blez	$a1, .LBB9_230
# %bb.223:                              # %for.cond1887.preheader.us.preheader
	move	$a2, $zero
	...
	b	.LBB9_225
	.p2align	4, , 16
.LBB9_224:                              # %for.cond1887.for.inc1930_crit_edge.us
                                        #   in Loop: Header=BB9_225 Depth=1
	addi.w	$a2, $a2, 1
	beq	$a2, $a0, .LBB9_230
.LBB9_225:                              # %for.cond1887.preheader.us
                                        # =>This Loop Header: Depth=1
	...
	add.d	$a7, $a2, $fp
	beqz	$t7, .LBB9_228
# %bb.226:                              # %for.body1891.lr.ph.split.us1126
                                        #   in Loop: Header=BB9_225 Depth=1
	...
	move	$t2, $a1
	.p2align	4, , 16
.LBB9_227:                              # %for.body1891.us1121
                                        #   Parent Loop BB9_225 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t3, $a6, 180
	srli.d	$t3, $t3, 2
	ld.w	$t4, $a6, 176
	...
	b	.LBB9_224
	.p2align	4, , 16
.LBB9_228:                              # %for.body1891.lr.ph.split.us.us
                                        #   in Loop: Header=BB9_225 Depth=1
...
.LBB9_231:
	...
	ld.d	$s7, $sp, 96                    # 8-byte Folded Reload
	b	.LBB9_68
.LBB9_232:                              # %for.body1244.preheader
...
.LBB9_233:                              #   in Loop: Header=BB9_235 Depth=1
	...
	move	$a4, $t0
	.p2align	4, , 16
.LBB9_234:                              # %for.inc1411
                                        #   in Loop: Header=BB9_235 Depth=1
	addi.d	$s1, $s1, 2
	addi.d	$fp, $fp, 2
	addi.d	$a3, $a3, 8
	addi.d	$t8, $t8, 8
