...
.LBB1_52:                               # %vector.body
	...
	vmaxi.w	$vr22, $vr22, 0
	vmin.w	$vr22, $vr22, $vr2
	vstelm.h	$vr22, $a0, -72, 2
	vstelm.h	$vr22, $a0, -40, 4
	vstelm.h	$vr22, $a0, -8, 6
	xvpickve2gr.w	$a2, $xr23, 0
	xvpickve2gr.w	$a3, $xr23, 1
	xvpickve2gr.w	$a4, $xr23, 2
	xvpickve2gr.w	$a5, $xr23, 3
	xvpickve2gr.w	$a6, $xr23, 4
	vinsgr2vr.w	$vr23, $a2, 0
	vinsgr2vr.w	$vr23, $a3, 1
	vinsgr2vr.w	$vr23, $a4, 2
	vinsgr2vr.w	$vr23, $a5, 3
	xvpickve2gr.w	$a2, $xr24, 0
	vinsgr2vr.w	$vr24, $a6, 0
	vinsgr2vr.w	$vr24, $a2, 1
	...
	vmaxi.w	$vr22, $vr22, 0
	vmin.w	$vr22, $vr22, $vr2
	vstelm.h	$vr22, $a0, -66, 2
	vstelm.h	$vr22, $a0, -34, 4
	vstelm.h	$vr22, $a0, -2, 6
	xvpickve2gr.w	$a2, $xr23, 4
	xvpickve2gr.w	$a3, $xr22, 0
	vinsgr2vr.w	$vr22, $a2, 0
	xvpickve2gr.w	$a2, $xr23, 5
	vinsgr2vr.w	$vr22, $a2, 1
	xvpickve2gr.w	$a2, $xr23, 6
	vinsgr2vr.w	$vr22, $a2, 2
	vinsgr2vr.w	$vr22, $a3, 3
	xvpickve2gr.w	$a2, $xr23, 0
	xvpickve2gr.w	$a3, $xr23, 1
	xvpickve2gr.w	$a4, $xr23, 2
	xvpickve2gr.w	$a5, $xr23, 3
...
# %bb.35:                               #   in Loop: Header=BB4_34 Depth=1
	...
	b	.LBB4_39
	.p2align	4, , 16
.LBB4_36:                               # %vector.body1097.preheader
                                        #   in Loop: Header=BB4_34 Depth=1
	add.d	$a2, $a3, $a4
	move	$t1, $s5
	move	$a5, $t5
...
# %bb.183:                              # %vector.memcheck
	...
	add.d	$a2, $t3, $a2
	bltu	$a2, $t6, .LBB4_178
# %bb.184:                              # %vector.body1127.preheader
                                        #   in Loop: Header=BB4_176 Depth=1
	move	$a2, $t8
	move	$fp, $a6
	move	$s0, $a7
...
# %bb.214:                              # %vector.scevcheck
                                        #   in Loop: Header=BB4_208 Depth=1
	bnez	$t5, .LBB4_211
# %bb.215:                              # %vector.body1112.preheader
                                        #   in Loop: Header=BB4_208 Depth=1
	move	$t7, $a2
	move	$t8, $a5
	move	$fp, $t1
	.p2align	4, , 16
.LBB4_216:                              # %vector.body1112
                                        #   Parent Loop BB4_208 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	xvld	$xr0, $t8, 0
	xvpickve2gr.w	$t3, $xr0, 0
...
.LBB6_6:                                # %cond.end57
	...
	xvstelm.w	$xr0, $sp, 448, 1
	xvstelm.w	$xr0, $sp, 480, 2
	addi.d	$a0, $sp, 512
	...
	bstrpick.d	$a0, $a0, 15, 0
	vinsgr2vr.w	$vr1, $a0, 3
	xvstelm.w	$xr1, $sp, 452, 1
	xvstelm.w	$xr1, $sp, 484, 2
	addi.d	$a0, $sp, 516
	...
	xvstelm.w	$xr2, $sp, 456, 1
	xvstelm.w	$xr2, $sp, 488, 2
	addi.d	$a0, $sp, 520
	...
	bstrpick.d	$a0, $a0, 15, 0
	vinsgr2vr.w	$vr3, $a0, 3
	xvstelm.w	$xr3, $sp, 460, 1
	xvstelm.w	$xr3, $sp, 492, 2
	addi.d	$a0, $sp, 524
	...
	bstrpick.d	$a0, $a0, 15, 0
	vinsgr2vr.w	$vr4, $a0, 3
	xvstelm.w	$xr4, $sp, 464, 1
	xvstelm.w	$xr4, $sp, 496, 2
	addi.d	$a0, $sp, 528
	...
	xvstelm.w	$xr7, $sp, 468, 1
	xvstelm.w	$xr7, $sp, 500, 2
	addi.d	$a0, $sp, 532
	xvstelm.w	$xr7, $a0, 0, 3
	xvpermi.q	$xr7, $xr5, 2
	addi.d	$a0, $sp, 564
	xvstelm.w	$xr7, $a0, 0, 4
	addi.d	$a0, $sp, 596
	xvstelm.w	$xr7, $a0, 0, 5
	ori	$a1, $a2, 1168
	xvldx	$xr5, $t1, $a1
	addi.d	$a0, $sp, 628
	xvstelm.w	$xr7, $a0, 0, 6
	ori	$a0, $a2, 528
	vldx	$vr6, $t1, $a0
	xvadd.w	$xr5, $xr5, $xr7
	st.d	$a1, $sp, 40                    # 8-byte Folded Spill
	...
	bstrpick.d	$a0, $a0, 15, 0
	vinsgr2vr.w	$vr7, $a0, 3
	xvstelm.w	$xr7, $sp, 472, 1
	xvstelm.w	$xr7, $sp, 504, 2
	addi.d	$a0, $sp, 536
	xvstelm.w	$xr7, $a0, 0, 3
	...
	bstrpick.d	$a0, $a0, 15, 0
	vinsgr2vr.w	$vr7, $a0, 3
	xvstelm.w	$xr7, $sp, 476, 1
	xvstelm.w	$xr7, $sp, 508, 2
	addi.d	$a0, $sp, 540
	xvstelm.w	$xr7, $a0, 0, 3
	xvpermi.q	$xr7, $xr5, 2
	...
	addi.d	$a1, $sp, 604
	xvstelm.w	$xr7, $a1, 0, 5
	addi.d	$a1, $sp, 636
	xvstelm.w	$xr7, $a1, 0, 6
	xvadd.w	$xr0, $xr0, $xr7
	st.d	$a0, $sp, 24                    # 8-byte Folded Spill
	xvstx	$xr0, $t1, $a0
	addi.d	$a0, $sp, 668
...
.LBB6_46:                               #   in Loop: Header=BB6_32 Depth=3
	...
	move	$a0, $a4
	b	.LBB6_42
.LBB6_47:                               # %for.cond1198.preheader
	move	$t2, $zero
	lu12i.w	$t3, 3
	ori	$a3, $t3, 852
	add.d	$a3, $a1, $a3
	...
	vrepli.w	$vr2, 32
	.p2align	4, , 16
.LBB6_48:                               # %for.cond1202.preheader
                                        # =>This Inner Loop Header: Depth=1
	slli.d	$t5, $t2, 6
	addi.d	$t4, $t5, 192
	add.d	$t6, $a2, $t4
