...
.LBB11_185:                             # %vector.body1410
	...
	addi.d	$a2, $a2, 64
	bnez	$a3, .LBB11_185
# %bb.186:                              # %middle.block1415
	beq	$a0, $s3, .LBB11_189
.LBB11_187:                             # %for.body517.preheader1518
	slli.d	$a1, $a0, 3
	alsl.d	$a1, $s7, $a1, 3
	slli.d	$a2, $s3, 3
	sub.d	$a1, $a1, $a2
...
# %bb.329:                              # %vector.memcheck1450
	alsl.d	$a3, $fp, $a0, 3
	sub.d	$a3, $a2, $a3
	ori	$a4, $zero, 64
	bltu	$a3, $a4, .LBB11_333
# %bb.330:                              # %vector.ph1454
	move	$a3, $s0
...
# %bb.28:                               # %middle.block151
                                        #   in Loop: Header=BB21_5 Depth=1
	beq	$a3, $t0, .LBB21_31
.LBB21_29:                              # %for.body.i70.preheader158
                                        #   in Loop: Header=BB21_5 Depth=1
	alsl.d	$a3, $a7, $s4, 3
	.p2align	4, , 16
...
# %bb.55:                               # %middle.block
                                        #   in Loop: Header=BB21_5 Depth=1
	beq	$a3, $t0, .LBB21_58
.LBB21_56:                              # %for.body.i.preheader154
                                        #   in Loop: Header=BB21_5 Depth=1
	alsl.d	$a3, $a7, $s4, 3
	.p2align	4, , 16
.LBB21_57:                              # %for.body.i
