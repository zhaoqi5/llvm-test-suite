...
.LBB8_19:                               # %for.inc189
	...
	ext.w.b	$a0, $s0
	pcalau12i	$a1, %got_pc_hi20(enc_picture)
	ld.d	$fp, $a1, %got_pc_lo12(enc_picture)
	ld.d	$a1, $fp, 0
	ldptr.d	$a1, $a1, 6488
	ld.d	$a1, $a1, 0
	slli.d	$s4, $a5, 3
...
# %bb.46:                               # %if.end270
	...
	bcnez	$fcc0, .LBB8_75
# %bb.47:                               # %if.end270.if.then282_crit_edge
                                        #   in Loop: Header=BB8_6 Depth=1
	ld.w	$a1, $s1, 0
.LBB8_48:                               # %if.then282
                                        #   in Loop: Header=BB8_6 Depth=1
