...
# %bb.3:                                # %for.body.us.preheader
	...
	b	.LBB5_5
	.p2align	4, , 16
.LBB5_4:                                # %get_mem3Dpel.exit.loopexit.us
...
.LBB5_13:                               # %for.body.i16.us.us
	...
	addi.d	$a1, $a1, 8
	bnez	$a2, .LBB5_13
# %bb.14:                               # %get_mem2Dpel.exit.loopexit.us.us
                                        #   in Loop: Header=BB5_8 Depth=2
	addi.d	$s5, $s5, 1
	...
	b	.LBB5_4
	.p2align	4, , 16
.LBB5_15:                               # %if.end7.i.us38
                                        #   in Loop: Header=BB5_16 Depth=2
	addi.d	$s5, $s5, 8
	ld.d	$a0, $sp, 72                    # 8-byte Folded Reload
	beq	$a0, $s5, .LBB5_4
.LBB5_16:                               # %for.body.i.us25
                                        #   Parent Loop BB5_5 Depth=1
...
.LBB5_20:                               # %if.then
	...
	jirl	$ra, $ra, 0
	bgtz	$s7, .LBB5_2
.LBB5_21:                               # %if.end.for.end_crit_edge
	mul.d	$s2, $s4, $s3
.LBB5_22:                               # %for.end
	mul.d	$a0, $s2, $s7
	mul.d	$a0, $a0, $s6
...
.LBB10_5:                               # %for.body.us
	...
	ldx.d	$s5, $a1, $a0
	beqz	$s5, .LBB10_21
# %bb.6:                                # %for.cond.preheader.i.us
                                        #   in Loop: Header=BB10_5 Depth=1
	move	$fp, $s5
	move	$s0, $s2
	ld.d	$a0, $sp, 24                    # 8-byte Folded Reload
	blez	$a0, .LBB10_9
# %bb.7:                                # %for.body.i.us.us.preheader
                                        #   in Loop: Header=BB10_5 Depth=1
	move	$fp, $zero
	b	.LBB10_12
	.p2align	4, , 16
.LBB10_8:                               # %for.cond.preheader.i6.us23
	...
	addi.d	$fp, $fp, 8
	beqz	$s0, .LBB10_4
.LBB10_9:                               # %for.body.i.us19
                                        #   Parent Loop BB10_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a0, $fp, 0
	bnez	$a0, .LBB10_8
# %bb.10:                               # %if.else.i16.us24
                                        #   in Loop: Header=BB10_9 Depth=2
	ori	$a1, $zero, 100
	move	$a0, $s3
	pcaddu18i	$ra, %call36(error)
...
.LBB10_12:                              # %for.body.i.us.us
	...
	ldx.d	$s6, $s5, $a0
	beqz	$s6, .LBB10_11
# %bb.13:                               # %for.body.i11.us.us.preheader
                                        #   in Loop: Header=BB10_12 Depth=2
	move	$s0, $zero
	b	.LBB10_15
	.p2align	4, , 16
.LBB10_14:                              # %if.else4.i.i.us.us
	...
	addi.d	$s0, $s0, 8
	beq	$s1, $s0, .LBB10_20
.LBB10_15:                              # %for.body.i11.us.us
                                        #   Parent Loop BB10_5 Depth=1
                                        #     Parent Loop BB10_12 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ldx.d	$s7, $s6, $s0
	beqz	$s7, .LBB10_14
# %bb.16:                               # %if.then.i.i.us.us
                                        #   in Loop: Header=BB10_15 Depth=3
	ld.d	$a0, $s7, 0
	beqz	$a0, .LBB10_18
# %bb.17:                               # %if.then2.i.i.us.us
                                        #   in Loop: Header=BB10_15 Depth=3
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	b	.LBB10_19
	.p2align	4, , 16
.LBB10_18:                              # %if.else.i.i.us.us
                                        #   in Loop: Header=BB10_15 Depth=3
	ori	$a1, $zero, 100
	move	$a0, $s4
	pcaddu18i	$ra, %call36(error)
	jirl	$ra, $ra, 0
.LBB10_19:                              # %if.end.i.i.us.us
                                        #   in Loop: Header=BB10_15 Depth=3
	move	$a0, $s7
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	addi.d	$s0, $s0, 8
	bne	$s1, $s0, .LBB10_15
.LBB10_20:                              # %for.end.i8.loopexit.us.us
                                        #   in Loop: Header=BB10_12 Depth=2
	move	$a0, $s6
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
...
# %bb.3:                                # %for.body.us.preheader
	...
	b	.LBB17_5
	.p2align	4, , 16
.LBB17_4:                               # %get_mem3Dint.exit.loopexit.us
...
# %bb.14:                               # %get_mem2Dint.exit.loopexit.us.us
	...
	b	.LBB17_4
	.p2align	4, , 16
.LBB17_15:                              # %if.end7.i.us38
                                        #   in Loop: Header=BB17_16 Depth=2
	addi.d	$s5, $s5, 8
	ld.d	$a0, $sp, 72                    # 8-byte Folded Reload
	beq	$a0, $s5, .LBB17_4
.LBB17_16:                              # %for.body.i.us25
                                        #   Parent Loop BB17_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$s0, $s7, 0
	ori	$a1, $zero, 8
...
.LBB17_20:                              # %if.then
	...
	jirl	$ra, $ra, 0
	bgtz	$s7, .LBB17_2
.LBB17_21:                              # %if.end.for.end_crit_edge
	mul.d	$s2, $s4, $s3
.LBB17_22:                              # %for.end
	mul.d	$a0, $s2, $s7
	mul.d	$a0, $a0, $s6
...
# %bb.7:                                # %for.body.i.us.us.preheader
	...
	b	.LBB26_12
	.p2align	4, , 16
.LBB26_8:                               # %for.cond.preheader.i6.us23
...
# %bb.17:                               # %if.then2.i.i.us.us
	...
	b	.LBB26_19
	.p2align	4, , 16
.LBB26_18:                              # %if.else.i.i.us.us
                                        #   in Loop: Header=BB26_15 Depth=3
	ori	$a1, $zero, 100
	move	$a0, $s4
	pcaddu18i	$ra, %call36(error)
	jirl	$ra, $ra, 0
.LBB26_19:                              # %if.end.i.i.us.us
                                        #   in Loop: Header=BB26_15 Depth=3
	move	$a0, $s7
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	addi.d	$s0, $s0, 8
	bne	$s1, $s0, .LBB26_15
.LBB26_20:                              # %for.end.i8.loopexit.us.us
                                        #   in Loop: Header=BB26_12 Depth=2
	move	$a0, $s6
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
...
# %bb.3:                                # %for.body.us.preheader
	...
	b	.LBB29_5
	.p2align	4, , 16
.LBB29_4:                               # %get_mem3Dshort.exit.loopexit.us
...
# %bb.14:                               # %get_mem2Dshort.exit.loopexit.us.us
	...
	b	.LBB29_4
	.p2align	4, , 16
.LBB29_15:                              # %if.end7.i.us38
                                        #   in Loop: Header=BB29_16 Depth=2
	addi.d	$s5, $s5, 8
	ld.d	$a0, $sp, 72                    # 8-byte Folded Reload
	beq	$a0, $s5, .LBB29_4
.LBB29_16:                              # %for.body.i.us25
                                        #   Parent Loop BB29_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$s0, $s7, 0
	ori	$a1, $zero, 8
...
.LBB29_20:                              # %if.then
	...
	jirl	$ra, $ra, 0
	bgtz	$s7, .LBB29_2
.LBB29_21:                              # %if.end.for.end_crit_edge
	mul.d	$s2, $s4, $s3
.LBB29_22:                              # %for.end
	mul.d	$a0, $s2, $s7
	mul.d	$a0, $a0, $s6
...
# %bb.7:                                # %for.body.i.us.us.preheader
	...
	b	.LBB35_12
	.p2align	4, , 16
.LBB35_8:                               # %for.cond.preheader.i6.us23
...
# %bb.17:                               # %if.then2.i.i.us.us
	...
	b	.LBB35_19
	.p2align	4, , 16
.LBB35_18:                              # %if.else.i.i.us.us
                                        #   in Loop: Header=BB35_15 Depth=3
	ori	$a1, $zero, 100
	move	$a0, $s4
	pcaddu18i	$ra, %call36(error)
	jirl	$ra, $ra, 0
.LBB35_19:                              # %if.end.i.i.us.us
                                        #   in Loop: Header=BB35_15 Depth=3
	move	$a0, $s7
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	addi.d	$s0, $s0, 8
	bne	$s1, $s0, .LBB35_15
.LBB35_20:                              # %for.end.i8.loopexit.us.us
                                        #   in Loop: Header=BB35_12 Depth=2
	move	$a0, $s6
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
