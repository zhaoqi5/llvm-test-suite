...
# %bb.0:                                # %entry
	...
	ori	$a0, $a0, 3840
	st.h	$a0, $sp, 342
	pcalau12i	$a0, %pc_hi20(.L__const.encode_one_macroblock_highfast.bmcost)
	addi.d	$a0, $a0, %pc_lo12(.L__const.encode_one_macroblock_highfast.bmcost)
	ld.w	$a1, $a0, 16
	vld	$vr0, $a0, 0
	st.w	$a1, $sp, 336
	vst	$vr0, $sp, 320
...
.LBB0_21:                               # %if.end65
	...
	ld.d	$s1, $a0, %got_pc_lo12(lambda_mf_factor)
...
.LBB0_51:                               # %call.sqrt
	...
	jirl	$ra, $ra, 0
	b	.LBB0_31
.LBB0_52:                               # %call.sqrt464
                                        #   in Loop: Header=BB0_29 Depth=2
	fmov.d	$fa0, $fs0
	pcaddu18i	$ra, %call36(sqrt)
	jirl	$ra, $ra, 0
	b	.LBB0_33
.LBB0_53:                               # %call.sqrt465
                                        #   in Loop: Header=BB0_29 Depth=2
	fmov.d	$fa0, $fs0
	pcaddu18i	$ra, %call36(sqrt)
	jirl	$ra, $ra, 0
...
# %bb.77:                               # %if.end410
	...
	st.h	$a0, $a2, 0
	pcalau12i	$a0, %got_pc_hi20(best8x8pdir)
	ld.d	$a2, $a0, %got_pc_lo12(best8x8pdir)
	...
	pcalau12i	$a1, %got_pc_hi20(best8x8fwref)
	ori	$s0, $zero, 1
	ld.d	$s6, $a1, %got_pc_lo12(best8x8fwref)
	ori	$a1, $s1, 2068
	ldx.b	$a1, $s3, $a1
	st.b	$a0, $s6, 32
	pcalau12i	$a0, %got_pc_hi20(best8x8bwref)
	ld.d	$s7, $a0, %got_pc_lo12(best8x8bwref)
...
.LBB0_78:                               # %if.then414
	...
	ld.d	$s4, $a0, %got_pc_lo12(cofAC8x8)
	ld.d	$a0, $s4, 0
	ld.d	$s3, $a0, 0
	addi.d	$a0, $sp, 184
	addi.d	$a1, $sp, 352
	...
	pcalau12i	$a1, %got_pc_hi20(best8x8fwref)
	ld.d	$fp, $a1, %got_pc_lo12(best8x8fwref)
	ori	$a1, $s1, 2068
	ldx.b	$a1, $s2, $a1
	st.b	$a0, $fp, 32
	pcalau12i	$a0, %got_pc_hi20(best8x8bwref)
	ld.d	$s5, $a0, %got_pc_lo12(best8x8bwref)
	ld.d	$a0, $s4, 0
	st.b	$a1, $s5, 32
	ld.d	$s3, $a0, 8
	addi.d	$a0, $sp, 184
...
# %bb.103:                              # %lor.lhs.false
	...
	ldptr.w	$a3, $a2, 4048
	bnez	$a3, .LBB0_107
.LBB0_104:                              # %land.lhs.true501
                                        #   in Loop: Header=BB0_101 Depth=1
	ldptr.w	$a2, $a2, 4072
	bne	$a2, $s0, .LBB0_107
# %bb.105:                              # %land.lhs.true504
                                        #   in Loop: Header=BB0_101 Depth=1
	beqz	$a1, .LBB0_115
# %bb.106:                              #   in Loop: Header=BB0_101 Depth=1
	...
	b	.LBB0_100
	.p2align	4, , 16
.LBB0_107:                              # %lor.lhs.false508
                                        #   in Loop: Header=BB0_101 Depth=1
	ld.w	$a3, $sp, 180
	ori	$a2, $zero, 2
	bne	$a1, $a2, .LBB0_109
# %bb.108:                              # %lor.lhs.false508
                                        #   in Loop: Header=BB0_101 Depth=1
	beqz	$a3, .LBB0_100
.LBB0_109:                              # %lor.lhs.false514
                                        #   in Loop: Header=BB0_101 Depth=1
	ld.w	$a4, $sp, 176
	ori	$a2, $zero, 1
	bne	$a1, $a2, .LBB0_111
# %bb.110:                              # %lor.lhs.false514
                                        #   in Loop: Header=BB0_101 Depth=1
	beqz	$a4, .LBB0_100
.LBB0_111:                              # %lor.lhs.false520
                                        #   in Loop: Header=BB0_101 Depth=1
	ori	$a2, $zero, 3
	bne	$a1, $a2, .LBB0_115
...
# %bb.113:                              # %land.lhs.true524
                                        #   in Loop: Header=BB0_101 Depth=1
	beqz	$a3, .LBB0_100
# %bb.114:                              # %land.lhs.true524
                                        #   in Loop: Header=BB0_101 Depth=1
	ld.w	$a1, $sp, 172
	beqz	$a1, .LBB0_100
	.p2align	4, , 16
.LBB0_115:                              # %for.body535.preheader
                                        #   in Loop: Header=BB0_101 Depth=1
	move	$fp, $zero
	move	$s3, $zero
	b	.LBB0_118
...
# %bb.133:                              # %land.lhs.true608
	...
	ld.w	$a2, $a2, 196
	bne	$a2, $s0, .LBB0_155
# %bb.134:                              # %land.lhs.true608
                                        #   in Loop: Header=BB0_118 Depth=2
	ori	$a2, $zero, 7
	blt	$a2, $s2, .LBB0_155
# %bb.135:                              # %for.cond615.preheader
                                        #   in Loop: Header=BB0_118 Depth=2
...
.LBB0_140:                              # %for.inc684
	...
	ld.bu	$a7, $a6, 1
	bne	$a7, $s1, .LBB0_145
# %bb.141:                              # %for.cond627.preheader.1
                                        #   in Loop: Header=BB0_118 Depth=2
	ld.b	$a7, $a5, 1
	ld.d	$t0, $a3, 0
	ld.d	$t1, $a3, 8
...
# %bb.144:                              # %for.cond627.1
	...
	addi.d	$t0, $t0, 4
	bltu	$t3, $s1, .LBB0_142
.LBB0_145:                              # %for.inc684.1
                                        #   in Loop: Header=BB0_118 Depth=2
	ld.bu	$a7, $a6, 2
	bne	$a7, $s1, .LBB0_150
# %bb.146:                              # %for.cond627.preheader.2
                                        #   in Loop: Header=BB0_118 Depth=2
	ld.b	$a7, $a5, 2
	ld.d	$t0, $a3, 0
	ld.d	$t1, $a3, 8
...
# %bb.149:                              # %for.cond627.2
	...
	addi.d	$t0, $t0, 4
	bltu	$t3, $s1, .LBB0_147
.LBB0_150:                              # %for.inc684.2
                                        #   in Loop: Header=BB0_118 Depth=2
	ld.bu	$a6, $a6, 3
	bne	$a6, $s1, .LBB0_155
# %bb.151:                              # %for.cond627.preheader.3
                                        #   in Loop: Header=BB0_118 Depth=2
	ld.b	$a5, $a5, 3
	ld.d	$a6, $a3, 0
	ld.d	$a3, $a3, 8
...
.LBB0_167:                              # %for.end767
	...
	ori	$a1, $zero, 2
	beq	$a0, $a1, .LBB0_171
# %bb.168:                              # %land.lhs.true771
	ld.d	$a0, $t6, 0
	ldptr.w	$a1, $a0, 5748
	beqz	$a1, .LBB0_171
# %bb.169:                              # %land.lhs.true774
	ld.w	$a0, $a0, 0
	ori	$a1, $zero, 99
	blt	$a1, $a0, .LBB0_171
# %bb.170:                              # %if.then777
...
.LBB0_174:                              # %for.end923
	...
	sltu	$a2, $zero, $a1
	pcalau12i	$a0, %got_pc_hi20(best_mode)
	ld.d	$s0, $a0, %got_pc_lo12(best_mode)
	ld.h	$a0, $s0, 0
...
.LBB0_176:                              # %if.else935
	bnez	$a1, .LBB0_178
# %bb.177:                              # %land.lhs.true938
	ld.d	$a1, $t6, 0
	ldptr.w	$a1, $a1, 5116
	beqz	$a1, .LBB0_179
.LBB0_178:                              # %lor.lhs.false941
	ori	$a1, $zero, 14
	bne	$a0, $a1, .LBB0_181
.LBB0_179:                              # %if.then945
	ld.w	$a0, $s3, 496
...
.LBB0_183:                              # %if.end954
	...
	ldptr.w	$a1, $a0, 15268
	beqz	$a1, .LBB0_186
# %bb.184:                              # %land.lhs.true957
	ld.bu	$a0, $a0, 12
	andi	$a0, $a0, 1
	beqz	$a0, .LBB0_186
# %bb.185:                              # %land.lhs.true960
	ld.w	$a0, $s3, 72
	beqz	$a0, .LBB0_200
.LBB0_186:                              # %if.end989
	ld.d	$a0, $a2, 0
...
# %bb.196:                              # %if.then1024
	...
	and	$a3, $a3, $a4
	bnez	$a3, .LBB0_198
.LBB0_197:                              # %lor.rhs1036
	addi.d	$a1, $a2, -14
	sltui	$a1, $a1, 1
.LBB0_198:                              # %lor.end1040
	ld.w	$a2, $a0, 12
	ldptr.d	$a0, $a0, 14240
	slli.d	$a2, $a2, 2
	stx.w	$a1, $a0, $a2
.LBB0_199:                              # %if.end1045
	...
	addi.d	$sp, $sp, 560
	ret
.LBB0_200:                              # %cond.false964
	ori	$a0, $zero, 1
	bne	$s8, $a0, .LBB0_204
# %bb.201:                              # %cond.true967
	ld.w	$a0, $s3, 364
	bnez	$a0, .LBB0_186
# %bb.202:                              # %land.lhs.true971
...
# %bb.203:                              # %cond.true978
	...
	bnez	$a0, .LBB0_186
	b	.LBB0_205
.LBB0_204:                              # %land.lhs.true971.thread
	ld.d	$a0, $sp, 56                    # 8-byte Folded Reload
	ld.w	$a0, $a0, 72
	bnez	$a0, .LBB0_186
.LBB0_205:                              # %land.lhs.true982
...
.LBB0_212:                              # %for.body803.preheader
	ld.d	$a6, $sp, 112                   # 8-byte Folded Reload
	move	$a7, $s7
.LBB0_213:                              # %for.body803.preheader
	addi.d	$a0, $s8, -2
	ld.w	$s7, $s5, 20
	sltui	$a2, $a0, 1
	st.w	$a1, $s0, 416
...
.LBB0_215:                              # %for.inc894
	...
	st.w	$a1, $a3, 416
	bge	$a2, $fp, .LBB0_171
.LBB0_216:                              # %for.body803
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a2, $sp, 128                   # 8-byte Folded Reload
	ld.d	$a2, $a2, 0
	ldptr.w	$a3, $a2, 15536
	beqz	$a3, .LBB0_231
# %bb.217:                              # %land.lhs.true807
                                        #   in Loop: Header=BB0_216 Depth=1
	beqz	$a6, .LBB0_219
# %bb.218:                              # %lor.lhs.false809
                                        #   in Loop: Header=BB0_216 Depth=1
	ldptr.w	$a2, $a0, 4048
	bnez	$a2, .LBB0_222
.LBB0_219:                              # %land.lhs.true812
                                        #   in Loop: Header=BB0_216 Depth=1
	ldptr.w	$a2, $a0, 4072
	ori	$a4, $zero, 1
	bne	$a2, $a4, .LBB0_222
# %bb.220:                              # %land.lhs.true816
                                        #   in Loop: Header=BB0_216 Depth=1
	beqz	$a1, .LBB0_231
# %bb.221:                              #   in Loop: Header=BB0_216 Depth=1
	...
	b	.LBB0_215
	.p2align	4, , 16
.LBB0_222:                              # %lor.lhs.false820
                                        #   in Loop: Header=BB0_216 Depth=1
	ld.w	$a4, $sp, 180
	ori	$a2, $zero, 2
	bne	$a1, $a2, .LBB0_224
# %bb.223:                              # %lor.lhs.false820
                                        #   in Loop: Header=BB0_216 Depth=1
	beqz	$a4, .LBB0_226
.LBB0_224:                              # %lor.lhs.false826
                                        #   in Loop: Header=BB0_216 Depth=1
	ld.w	$a5, $sp, 176
	ori	$a2, $zero, 1
	bne	$a1, $a2, .LBB0_227
# %bb.225:                              # %lor.lhs.false826
                                        #   in Loop: Header=BB0_216 Depth=1
	bnez	$a5, .LBB0_227
.LBB0_226:                              #   in Loop: Header=BB0_216 Depth=1
	ld.d	$a3, $sp, 144                   # 8-byte Folded Reload
	b	.LBB0_215
.LBB0_227:                              # %lor.lhs.false832
                                        #   in Loop: Header=BB0_216 Depth=1
	bne	$a1, $s3, .LBB0_231
...
# %bb.242:                              # %for.inc891
	...
	ext.w.h	$a3, $a1
	blt	$s3, $a3, .LBB0_244
# %bb.243:                              # %land.lhs.true861.1
                                        #   in Loop: Header=BB0_216 Depth=1
	ld.d	$a3, $sp, 144                   # 8-byte Folded Reload
	ld.w	$a3, $a3, 364
	beqz	$a3, .LBB0_247
.LBB0_244:                              # %if.end866.1
                                        #   in Loop: Header=BB0_216 Depth=1
...
# %bb.250:                              # %for.inc891.1
	...
	ext.w.h	$a3, $a1
	blt	$s3, $a3, .LBB0_252
# %bb.251:                              # %land.lhs.true861.2
                                        #   in Loop: Header=BB0_216 Depth=1
	ld.d	$a3, $sp, 144                   # 8-byte Folded Reload
	ld.w	$a3, $a3, 364
	beqz	$a3, .LBB0_255
.LBB0_252:                              # %if.end866.2
                                        #   in Loop: Header=BB0_216 Depth=1
	ld.d	$a3, $sp, 128                   # 8-byte Folded Reload
	ld.d	$a3, $a3, 0
	ldptr.w	$a3, $a3, 15536
...
# %bb.258:                              # %for.inc891.2
	...
	ext.w.h	$a1, $a1
	blt	$s3, $a1, .LBB0_260
# %bb.259:                              # %land.lhs.true861.3
                                        #   in Loop: Header=BB0_216 Depth=1
	ld.d	$a1, $sp, 144                   # 8-byte Folded Reload
	ld.w	$a1, $a1, 364
	beqz	$a1, .LBB0_214
.LBB0_260:                              # %if.end866.3
                                        #   in Loop: Header=BB0_216 Depth=1
	ld.d	$a1, $sp, 128                   # 8-byte Folded Reload
	ld.d	$a1, $a1, 0
	ldptr.w	$a1, $a1, 15536
