...
# %bb.1:                                # %if.end
	slli.d	$a4, $a1, 2
	pcalau12i	$a5, %pc_hi20(.L__const.levrun_linfo_c2x2.LEVRUN)
	addi.d	$a5, $a5, %pc_lo12(.L__const.levrun_linfo_c2x2.LEVRUN)
	ldx.w	$a5, $a5, $a4
	srai.d	$a4, $a0, 31
	xor	$a6, $a0, $a4
	sub.w	$a4, $a6, $a4
...
# %bb.0:                                # %entry
	beqz	$a0, .LBB11_4
# %bb.1:                                # %if.end
	pcalau12i	$a4, %pc_hi20(.L__const.levrun_linfo_inter.LEVRUN)
	addi.d	$a4, $a4, %pc_lo12(.L__const.levrun_linfo_inter.LEVRUN)
	ldx.bu	$a4, $a4, $a1
	srai.d	$a5, $a0, 31
	xor	$a6, $a0, $a5
	sub.w	$a5, $a6, $a5
...
.LBB14_6:                               # %if.else
	...
	addi.d	$a3, $a2, 1
	bltu	$a5, $a4, .LBB14_10
# %bb.7:                                # %for.body.i.i27.preheader
	move	$a4, $zero
	ori	$a2, $zero, 14
	addi.w	$a5, $zero, -3
	move	$a6, $a3
	.p2align	4, , 16
.LBB14_8:                               # %for.body.i.i27
                                        # =>This Inner Loop Header: Depth=1
	move	$a7, $a4
	addi.w	$a4, $a4, 1
	bltu	$a2, $a7, .LBB14_11
...
# %bb.16:                               # %if.then10.i
	...
	move	$a7, $zero
	b	.LBB14_12
.LBB14_17:                              # %writeUVLC2buffer.exit
	ld.w	$a0, $a0, 0
	beqz	$a0, .LBB14_19
# %bb.18:                               # %if.then11
	ld.d	$a0, $a1, 0
...
# %bb.0:                                # %entry
	...
	slli.d	$a3, $a2, 8
	alsl.d	$a5, $a2, $a3, 4
	pcalau12i	$a3, %pc_hi20(writeSyntaxElement_NumCoeffTrailingOnesChromaDC.lentab)
	ld.w	$a2, $a0, 8
	addi.d	$a3, $a3, %pc_lo12(writeSyntaxElement_NumCoeffTrailingOnesChromaDC.lentab)
	add.d	$a3, $a3, $a5
	ld.w	$a4, $a0, 4
	slli.d	$a6, $a2, 6
	alsl.d	$a6, $a2, $a6, 2
