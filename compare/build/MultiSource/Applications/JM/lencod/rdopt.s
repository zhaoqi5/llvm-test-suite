...
# %bb.20:                               # %for.inc159
	...
	blt	$s3, $a0, .LBB8_18
	b	.LBB8_22
.LBB8_21:                               # %for.cond.preheader.for.end161_crit_edge
	move	$s4, $zero
.LBB8_22:                               # %for.end161
	div.d	$s1, $s4, $a0
	ld.d	$s6, $sp, 56                    # 8-byte Folded Reload
...
.LBB16_111:                             # %for.body215.us
	...
	b	.LBB16_108
	.p2align	4, , 16
.LBB16_112:                             # %vector.memcheck421
                                        #   in Loop: Header=BB16_109 Depth=1
	sub.d	$t4, $s8, $s3
	move	$s7, $a3
	bltu	$t4, $s4, .LBB16_110
# %bb.113:                              # %vector.memcheck421
                                        #   in Loop: Header=BB16_109 Depth=1
	sub.d	$t4, $s3, $s2
	move	$s7, $a3
	bltu	$t4, $s4, .LBB16_110
# %bb.114:                              # %vector.memcheck421
                                        #   in Loop: Header=BB16_109 Depth=1
	sub.d	$t4, $s5, $s3
	move	$s7, $a3
	bltu	$t4, $s4, .LBB16_110
# %bb.115:                              # %vector.memcheck421
                                        #   in Loop: Header=BB16_109 Depth=1
	sub.d	$t4, $s8, $s2
	move	$s7, $a3
	bltu	$t4, $s4, .LBB16_110
# %bb.116:                              # %vector.memcheck421
                                        #   in Loop: Header=BB16_109 Depth=1
	sub.d	$t4, $s8, $s5
	move	$s7, $a3
	bltu	$t4, $s4, .LBB16_110
...
# %bb.121:                              # %vec.epilog.middle.block
	...
	beq	$t3, $t7, .LBB16_108
	b	.LBB16_110
.LBB16_122:                             # %vector.body434.preheader
                                        #   in Loop: Header=BB16_109 Depth=1
	add.d	$s7, $s2, $fp
	add.d	$ra, $s8, $fp
	add.d	$t4, $s3, $fp
