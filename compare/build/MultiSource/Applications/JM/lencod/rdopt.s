...
# %bb.70:                               # %for.cond112.1.1
	...
	ldx.bu	$a3, $a1, $s8
	bge	$a2, $a3, .LBB3_237
# %bb.71:                               # %for.cond112.2.1453
                                        #   in Loop: Header=BB3_2 Depth=2
	ldx.bu	$a3, $a1, $s4
	bge	$a2, $a3, .LBB3_237
# %bb.72:                               # %for.cond112.3.1457
                                        #   in Loop: Header=BB3_2 Depth=2
	ldx.bu	$a3, $a1, $s7
	bge	$a2, $a3, .LBB3_237
# %bb.73:                               # %for.cond112.4.1461
                                        #   in Loop: Header=BB3_2 Depth=2
	ldx.bu	$a3, $a1, $ra
	bge	$a2, $a3, .LBB3_237
...
# %bb.89:                               # %for.cond112.1.2
	...
	ldx.bu	$a3, $a1, $s8
	bge	$a2, $a3, .LBB3_237
# %bb.90:                               # %for.cond112.2.2472
                                        #   in Loop: Header=BB3_2 Depth=2
	ldx.bu	$a3, $a1, $s4
	bge	$a2, $a3, .LBB3_237
# %bb.91:                               # %for.cond112.3.2476
                                        #   in Loop: Header=BB3_2 Depth=2
	ldx.bu	$a3, $a1, $s7
	bge	$a2, $a3, .LBB3_237
# %bb.92:                               # %for.cond112.4.2480
                                        #   in Loop: Header=BB3_2 Depth=2
	ldx.bu	$a3, $a1, $ra
	bge	$a2, $a3, .LBB3_237
# %bb.93:                               # %for.cond112.5.2481
                                        #   in Loop: Header=BB3_2 Depth=2
	ldx.bu	$a3, $a1, $s5
	bge	$a2, $a3, .LBB3_237
...
# %bb.108:                              # %for.cond112.1.3
	...
	ldx.bu	$a1, $a0, $s8
	bge	$a2, $a1, .LBB3_237
# %bb.109:                              # %for.cond112.2.3492
                                        #   in Loop: Header=BB3_2 Depth=2
	ldx.bu	$a1, $a0, $s4
	bge	$a2, $a1, .LBB3_237
# %bb.110:                              # %for.cond112.3.3496
                                        #   in Loop: Header=BB3_2 Depth=2
	ldx.bu	$a1, $a0, $s7
	bge	$a2, $a1, .LBB3_237
# %bb.111:                              # %for.cond112.4.3500
                                        #   in Loop: Header=BB3_2 Depth=2
	ldx.bu	$a1, $a0, $ra
	bge	$a2, $a1, .LBB3_237
# %bb.112:                              # %for.cond112.5.3501
                                        #   in Loop: Header=BB3_2 Depth=2
	ldx.bu	$a1, $a0, $s5
	bge	$a2, $a1, .LBB3_237
...
.LBB16_111:                             # %for.body215.us
	...
	b	.LBB16_108
	.p2align	4, , 16
.LBB16_112:                             # %vector.memcheck405
                                        #   in Loop: Header=BB16_109 Depth=1
	sub.d	$t4, $s8, $s3
	move	$s7, $a3
	bltu	$t4, $s4, .LBB16_110
# %bb.113:                              # %vector.memcheck405
                                        #   in Loop: Header=BB16_109 Depth=1
	sub.d	$t4, $s3, $s2
	move	$s7, $a3
	bltu	$t4, $s4, .LBB16_110
# %bb.114:                              # %vector.memcheck405
                                        #   in Loop: Header=BB16_109 Depth=1
	sub.d	$t4, $s5, $s3
	move	$s7, $a3
	bltu	$t4, $s4, .LBB16_110
# %bb.115:                              # %vector.memcheck405
                                        #   in Loop: Header=BB16_109 Depth=1
	sub.d	$t4, $s8, $s2
	move	$s7, $a3
	bltu	$t4, $s4, .LBB16_110
# %bb.116:                              # %vector.memcheck405
                                        #   in Loop: Header=BB16_109 Depth=1
	sub.d	$t4, $s8, $s5
	move	$s7, $a3
	bltu	$t4, $s4, .LBB16_110
...
# %bb.118:                              #   in Loop: Header=BB16_109 Depth=1
	move	$t6, $zero
	b	.LBB16_123
.LBB16_119:                             # %vector.body418.preheader
                                        #   in Loop: Header=BB16_109 Depth=1
	add.d	$s7, $s2, $fp
	add.d	$ra, $s8, $fp
	add.d	$t4, $s3, $fp
...
# %bb.161:                              #   in Loop: Header=BB16_160 Depth=1
	...
	b	.LBB16_165
	.p2align	4, , 16
.LBB16_162:                             # %vector.body472.preheader
                                        #   in Loop: Header=BB16_160 Depth=1
	move	$t2, $s3
	move	$t3, $t7
	move	$t1, $t0
...
# %bb.179:                              #   in Loop: Header=BB16_178 Depth=1
	...
	b	.LBB16_183
	.p2align	4, , 16
.LBB16_180:                             # %vector.body446.preheader
                                        #   in Loop: Header=BB16_178 Depth=1
	move	$t2, $s3
	move	$t3, $t7
	move	$t1, $t0
...
.LBB16_188:                             # %if.else558
	...
	ld.d	$s0, $sp, 96                    # 8-byte Folded Reload
	b	.LBB16_192
.LBB16_189:                             # %lor.lhs.false542
	ori	$a0, $zero, 1
	ld.d	$a1, $sp, 24                    # 8-byte Folded Reload
	bne	$a1, $a0, .LBB16_191
# %bb.190:                              # %land.lhs.true544
	ld.d	$a0, $sp, 88                    # 8-byte Folded Reload
	ld.w	$a0, $a0, 364
	bnez	$a0, .LBB16_187
.LBB16_191:                             # %if.else552
	ld.d	$s0, $sp, 96                    # 8-byte Folded Reload
	ld.d	$a0, $s0, 0
	ld.w	$a0, $a0, 144
	ld.w	$a1, $sp, 140
...
# %bb.193:                              # %lor.lhs.false567
	ld.w	$a0, $a1, 44
	bnez	$a0, .LBB16_200
# %bb.194:                              # %land.lhs.true570
	ldptr.w	$a0, $a1, 15540
	ori	$a2, $zero, 1
	bne	$a0, $a2, .LBB16_200
# %bb.195:                              # %land.lhs.true570
	beqz	$s8, .LBB16_200
.LBB16_196:                             # %if.then576
...
.LBB16_207:                             # %cleanup632
	...
	addi.d	$sp, $sp, 256
	ret
.LBB16_208:                             # %cond.false612
	ori	$a4, $zero, 1
	bne	$a0, $a4, .LBB16_210
# %bb.209:                              # %cond.true616
	ld.w	$a0, $a3, 364
	bnez	$a0, .LBB16_206
.LBB16_210:                             # %if.then620
	ldptr.d	$a0, $a1, 14224
	ori	$a1, $zero, 536
	mul.d	$a2, $a2, $a1
	add.d	$a2, $a0, $a2
...
# %bb.211:                              # %if.else.i
	...
	ori	$a3, $zero, 440
	beqz	$a4, .LBB16_213
.LBB16_212:                             # %if.end12.sink.split.i
	ldx.w	$a2, $a2, $a3
	mul.d	$a1, $a2, $a1
	add.d	$a0, $a0, $a1
	ld.w	$a0, $a0, 424
...
.LBB21_9:                               # %vector.body
	...
	vpickev.h	$vr2, $vr2, $vr2
	vstelm.d	$vr2, $t3, 0, 0
.LBB21_10:                              # %for.cond72.for.inc127_crit_edge.us
                                        #   in Loop: Header=BB21_11 Depth=1
	addi.d	$a3, $a3, 1
	beq	$a3, $a0, .LBB21_16
.LBB21_11:                              # %for.body69.us
                                        # =>This Loop Header: Depth=1
