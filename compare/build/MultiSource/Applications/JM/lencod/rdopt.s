...
.LBB8_41:                               # %if.then261
	...
	bgeu	$a1, $a0, .LBB8_26
	b	.LBB8_27
.LBB8_42:                               # %for.cond.preheader.for.end161_crit_edge
	move	$s0, $zero
.LBB8_43:                               # %for.end161
	div.d	$s2, $s0, $a0
	ld.d	$s6, $sp, 88                    # 8-byte Folded Reload
...
.LBB16_111:                             # %for.body215.us
	...
	b	.LBB16_108
	.p2align	4, , 16
.LBB16_112:                             # %vector.memcheck412
                                        #   in Loop: Header=BB16_109 Depth=1
	sub.d	$t5, $s8, $s3
	move	$s7, $a3
	bltu	$t5, $s4, .LBB16_110
# %bb.113:                              # %vector.memcheck412
                                        #   in Loop: Header=BB16_109 Depth=1
	sub.d	$t5, $s3, $s2
	move	$s7, $a3
	bltu	$t5, $s4, .LBB16_110
# %bb.114:                              # %vector.memcheck412
                                        #   in Loop: Header=BB16_109 Depth=1
	sub.d	$t5, $s5, $s3
	move	$s7, $a3
	bltu	$t5, $s4, .LBB16_110
# %bb.115:                              # %vector.memcheck412
                                        #   in Loop: Header=BB16_109 Depth=1
	sub.d	$t5, $s8, $s2
	move	$s7, $a3
	bltu	$t5, $s4, .LBB16_110
# %bb.116:                              # %vector.memcheck412
                                        #   in Loop: Header=BB16_109 Depth=1
	sub.d	$t5, $s8, $s5
	move	$s7, $a3
	bltu	$t5, $s4, .LBB16_110
...
# %bb.118:                              #   in Loop: Header=BB16_109 Depth=1
	move	$t5, $zero
	b	.LBB16_123
.LBB16_119:                             # %vector.body425.preheader
                                        #   in Loop: Header=BB16_109 Depth=1
	add.d	$s7, $s2, $fp
	add.d	$ra, $s8, $fp
	add.d	$t6, $s3, $fp
...
# %bb.161:                              #   in Loop: Header=BB16_160 Depth=1
	...
	b	.LBB16_165
	.p2align	4, , 16
.LBB16_162:                             # %vector.body484.preheader
                                        #   in Loop: Header=BB16_160 Depth=1
	move	$t2, $s4
	move	$t3, $t7
	move	$t1, $t0
...
# %bb.179:                              #   in Loop: Header=BB16_178 Depth=1
	...
	b	.LBB16_183
	.p2align	4, , 16
.LBB16_180:                             # %vector.body455.preheader
                                        #   in Loop: Header=BB16_178 Depth=1
	move	$t2, $a7
	move	$t3, $s4
	move	$t1, $t0
...
# %bb.0:                                # %entry
	...
	addi.d	$a2, $a2, -1
	ori	$a4, $zero, 1
	pcalau12i	$a5, %got_pc_hi20(OffsetList8x8)
	ld.d	$a5, $a5, %got_pc_lo12(OffsetList8x8)
	pcalau12i	$a7, %got_pc_hi20(OffsetList4x4)
	ld.d	$a7, $a7, %got_pc_lo12(OffsetList4x4)
	sll.w	$a2, $a4, $a2
	slli.d	$a4, $a1, 2
	ld.d	$t0, $a5, 0
	ld.d	$a5, $a7, 0
...
.LBB21_2:
	pcalau12i	$a1, %pc_hi20(bestInterFAdjust4x4)
	addi.d	$t4, $a1, %pc_lo12(bestInterFAdjust4x4)
	pcalau12i	$a1, %pc_hi20(bestInterFAdjust8x8)
	addi.d	$t5, $a1, %pc_lo12(bestInterFAdjust8x8)
.LBB21_3:                               # %cond.end22
	move	$a1, $zero
	move	$t0, $zero
	masknez	$t5, $t5, $t2
...
# %bb.8:                                # %for.body69.lr.ph.split.us
	...
	pcalau12i	$a5, %pc_hi20(bestIntraFAdjust4x4Cr)
	addi.d	$a5, $a5, %pc_lo12(bestIntraFAdjust4x4Cr)
