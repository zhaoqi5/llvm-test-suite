...
# %bb.0:                                # %entry
	...
	ld.w	$a2, $fp, 4
	ld.d	$s5, $a1, 32
	pcalau12i	$a1, %pc_hi20(last_dquant)
	st.w	$a0, $a1, %pc_lo12(last_dquant)
	slti	$a1, $a2, 1
	srai.d	$a3, $a2, 31
	xor	$a2, $a2, $a3
	sub.d	$a2, $a2, $a3
...
.LBB21_30:                              # %if.then200
	addi.d	$a2, $a2, 4
.LBB21_31:                              # %cond.false221.thread
	sll.d	$a2, $a5, $a2
.LBB21_32:                              # %cond.false221.thread
	sltui	$a5, $fp, 5
	or	$a2, $a2, $a4
	or	$a2, $a2, $a3
	st.d	$a2, $s7, 408
...
.LBB21_45:                              # %if.end290
	ldptr.d	$a0, $a3, 14216
	slli.d	$a1, $s1, 2
	pcalau12i	$a2, %pc_hi20(type2ctx_bcbp)
	addi.d	$a2, $a2, %pc_lo12(type2ctx_bcbp)
	ldx.w	$a1, $a2, $a1
	ld.d	$a0, $a0, 40
	alsl.w	$a2, $a5, $a4, 1
	slli.d	$a1, $a1, 6
...
# %bb.0:                                # %entry
	...
	ldptr.d	$a1, $a6, 14216
	slli.d	$a4, $a2, 2
	pcalau12i	$a3, %pc_hi20(maxpos)
	addi.d	$a5, $a3, %pc_lo12(maxpos)
	ld.d	$a3, $a1, 40
	ld.w	$t0, $a6, 24
	ori	$a1, $zero, 1
	lu12i.w	$a6, 2
...
# %bb.2:                                # %cond.false19
	...
	ori	$a7, $zero, 928
.LBB22_3:                               # %cond.end25
	pcalau12i	$a0, %pc_hi20(type2ctx_last)
	addi.d	$a0, $a0, %pc_lo12(type2ctx_last)
	ldx.w	$t0, $a0, $a4
	ldx.w	$a0, $a5, $a4
	add.d	$a4, $a3, $a7
	ori	$a5, $zero, 240
...
# %bb.1:                                # %if.then
	...
	slli.d	$a0, $a0, 2
	pcalau12i	$a2, %pc_hi20(writeRunLevel_CABAC.coeff_ctr)
	ld.w	$a3, $a2, %pc_lo12(writeRunLevel_CABAC.coeff_ctr)
	pcalau12i	$a4, %pc_hi20(writeRunLevel_CABAC.coeff)
	addi.d	$a4, $a4, %pc_lo12(writeRunLevel_CABAC.coeff)
	stx.w	$a1, $a4, $a0
	addi.d	$a0, $a3, 1
	st.w	$a0, $a2, %pc_lo12(writeRunLevel_CABAC.coeff_ctr)
	b	.LBB25_6
.LBB25_2:                               # %if.else
	pcalau12i	$a0, %got_pc_hi20(img)
	ld.d	$a0, $a0, %got_pc_lo12(img)
