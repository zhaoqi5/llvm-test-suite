...
.LBB9_81:                               # %if.else363
	...
	add.w	$t2, $t1, $t2
	b	.LBB9_93
.LBB9_82:                               # %vector.main.loop.iter.check
	ori	$t3, $zero, 16
	bgeu	$t1, $t3, .LBB9_84
# %bb.83:
	move	$t3, $zero
...
# %bb.86:                               # %middle.block
	...
	beq	$t3, $t1, .LBB9_93
# %bb.87:                               # %vec.epilog.iter.check
	beqz	$t4, .LBB9_91
.LBB9_88:                               # %vec.epilog.ph
	move	$t4, $t3
	...
	alsl.d	$t4, $t4, $a6, 2
	addi.d	$t4, $t4, 92
.LBB9_89:                               # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $t4, 24
	vld	$vr3, $t4, 0
	vmadd.w	$vr1, $vr3, $vr2
	...
	addi.d	$t4, $t4, 16
	bnez	$t2, .LBB9_89
# %bb.90:                               # %vec.epilog.middle.block
	vhaddw.d.w	$vr1, $vr1, $vr1
	vhaddw.q.d	$vr1, $vr1, $vr1
	vpickve2gr.d	$t2, $vr1, 0
	beq	$t3, $t1, .LBB9_93
.LBB9_91:                               # %for.body.preheader
	alsl.d	$t4, $t3, $a6, 2
	addi.d	$t4, $t4, 116
	sub.d	$t1, $t1, $t3
	.p2align	4, , 16
...
.LBB9_103:                              # %if.then523
	...
	st.w	$a6, $a0, 1536
	bnez	$a2, .LBB9_107
.LBB9_104:                              # %lor.lhs.false529
	beqz	$a1, .LBB9_108
# %bb.105:                              # %land.lhs.true531
	ldptr.w	$a1, $a4, 4704
	ori	$a3, $zero, 2
	beq	$a1, $a3, .LBB9_107
# %bb.106:                              # %lor.lhs.false535
	ldptr.w	$a1, $a4, 4708
	beqz	$a1, .LBB9_108
.LBB9_107:                              # %if.then538
	st.w	$a6, $a0, 1540
...
.LBB9_110:                              # %if.end562
	ld.w	$a1, $a5, 20
	beqz	$a1, .LBB9_112
# %bb.111:                              # %lor.lhs.false566
	ldptr.w	$a1, $a4, 5136
	ori	$a3, $zero, 1
	bne	$a1, $a3, .LBB9_119
.LBB9_112:                              # %land.lhs.true570
	ldptr.w	$a1, $a5, 15404
	ldptr.w	$a3, $a5, 15352
	bgeu	$a1, $a3, .LBB9_119
# %bb.113:                              # %land.lhs.true575
	ld.d	$a1, $fp, %pc_lo12(generic_RC)
	ld.w	$a3, $a1, 4
	ori	$a4, $zero, 1
	bne	$a3, $a4, .LBB9_119
# %bb.114:                              # %land.lhs.true579
	ld.w	$a3, $a5, 0
	pcalau12i	$a4, %got_pc_hi20(start_frame_no_in_this_IGOP)
