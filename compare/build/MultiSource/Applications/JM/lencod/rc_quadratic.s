...
# %bb.27:                               # %call.sqrt169
	...
	move	$a1, $s1
	b	.LBB15_43
.LBB15_28:                              # %cond.end208.thread133
...
.LBB15_32:                              # %vector.ph
	...
	b	.LBB15_34
	.p2align	4, , 16
.LBB15_33:                              # %pred.store.continue146
...
# %bb.35:                               # %pred.store.continue
	...
	andi	$a6, $a6, 1
	bnez	$a6, .LBB15_39
.LBB15_36:                              # %pred.store.continue142
                                        #   in Loop: Header=BB15_34 Depth=1
	xvpickve2gr.d	$a6, $xr2, 2
	andi	$a6, $a6, 1
	bnez	$a6, .LBB15_40
.LBB15_37:                              # %pred.store.continue144
                                        #   in Loop: Header=BB15_34 Depth=1
...
.LBB15_38:                              # %pred.store.if
	...
	andi	$a6, $a6, 1
	beqz	$a6, .LBB15_36
.LBB15_39:                              # %pred.store.if141
                                        #   in Loop: Header=BB15_34 Depth=1
	st.w	$a4, $a2, -4
	xvpickve2gr.d	$a6, $xr2, 2
	andi	$a6, $a6, 1
	beqz	$a6, .LBB15_37
.LBB15_40:                              # %pred.store.if143
                                        #   in Loop: Header=BB15_34 Depth=1
	st.w	$a4, $a2, 0
	xvpickve2gr.d	$a6, $xr2, 3
	andi	$a6, $a6, 1
	beqz	$a6, .LBB15_33
.LBB15_41:                              # %pred.store.if145
                                        #   in Loop: Header=BB15_34 Depth=1
	st.w	$a4, $a2, 4
	b	.LBB15_33
...
.LBB15_48:                              # %if.then226
	...
	jr	$t8
.LBB15_49:                              # %for.body213.preheader147
	alsl.d	$a2, $a0, $s0, 2
	pcalau12i	$a3, %pc_hi20(updateRCModel.error)
	addi.d	$a3, $a3, %pc_lo12(updateRCModel.error)
	alsl.d	$a3, $a0, $a3, 3
...
.LBB17_26:                              # %vector.ph
	...
	b	.LBB17_28
	.p2align	4, , 16
.LBB17_27:                              # %pred.store.continue109
...
# %bb.29:                               # %pred.store.continue
	...
	andi	$a5, $a5, 1
	bnez	$a5, .LBB17_33
.LBB17_30:                              # %pred.store.continue105
                                        #   in Loop: Header=BB17_28 Depth=1
	xvpickve2gr.d	$a5, $xr2, 2
	andi	$a5, $a5, 1
	bnez	$a5, .LBB17_34
.LBB17_31:                              # %pred.store.continue107
                                        #   in Loop: Header=BB17_28 Depth=1
...
.LBB17_32:                              # %pred.store.if
	...
	andi	$a5, $a5, 1
	beqz	$a5, .LBB17_30
.LBB17_33:                              # %pred.store.if104
                                        #   in Loop: Header=BB17_28 Depth=1
	st.w	$a3, $a1, -4
	xvpickve2gr.d	$a5, $xr2, 2
	andi	$a5, $a5, 1
	beqz	$a5, .LBB17_31
.LBB17_34:                              # %pred.store.if106
                                        #   in Loop: Header=BB17_28 Depth=1
	st.w	$a3, $a1, 0
	xvpickve2gr.d	$a5, $xr2, 3
	andi	$a5, $a5, 1
	beqz	$a5, .LBB17_27
.LBB17_35:                              # %pred.store.if108
                                        #   in Loop: Header=BB17_28 Depth=1
	st.w	$a3, $a1, 4
	b	.LBB17_27
...
.LBB17_37:                              # %for.end139
	...
	jr	$t8
.LBB17_38:                              # %for.body128.preheader110
	alsl.d	$a1, $a0, $s1, 2
	pcalau12i	$a2, %pc_hi20(updateMADModel.error)
	addi.d	$a2, $a2, %pc_lo12(updateMADModel.error)
	alsl.d	$a2, $a0, $a2, 3
