...
.LBB3_19:                               # %malloc_slice.exit.i
	...
	ld.d	$a2, $a0, %got_pc_lo12(dummy_slice_too_big)
	ld.w	$a0, $s1, 16
	st.d	$a2, $s1, 112
...
# %bb.84:                               # %if.then221.i
	bnez	$a0, .LBB3_91
.LBB3_85:                               # %if.then229.i
	ld.d	$a0, $fp, 0
	ld.w	$a1, $a0, 1576
	beqz	$a1, .LBB3_216
# %bb.86:                               # %land.lhs.true231.i
	ldptr.w	$a0, $a0, 2940
	beqz	$a0, .LBB3_216
# %bb.87:                               # %if.then233.i
...
# %bb.88:                               # %if.else237.i
	ori	$a0, $zero, 1
	b	.LBB3_217
.LBB3_89:                               # %lor.lhs.false214.i
	bne	$a0, $a2, .LBB3_92
# %bb.90:                               # %lor.lhs.false214.i
	ld.w	$a0, $a1, 196
	beqz	$a0, .LBB3_92
.LBB3_91:                               # %if.else241.i
	pcaddu18i	$ra, %call36(estimate_weighting_factor_B_slice)
	jirl	$ra, $ra, 0
.LBB3_92:                               # %if.end243.i
	ld.w	$a0, $s3, 0
	blez	$a0, .LBB3_95
.LBB3_93:                               # %for.body.lr.ph.i.i
...
.LBB3_94:                               # %for.body.i89.i
	...
	addi.d	$a1, $a1, 8
	bnez	$a0, .LBB3_94
.LBB3_95:                               # %for.cond21.preheader.i.i
	ld.w	$a0, $s3, 4
	blez	$a0, .LBB3_98
# %bb.96:                               # %for.body24.lr.ph.i.i
	pcalau12i	$a1, %got_pc_hi20(listX)
	ld.d	$a1, $a1, %got_pc_lo12(listX)
	ld.d	$a1, $a1, 8
	pcalau12i	$a2, %got_pc_hi20(enc_picture)
...
.LBB3_97:                               # %for.body24.i.i
	...
	addi.d	$a1, $a1, 8
	bnez	$a0, .LBB3_97
.LBB3_98:                               # %for.end63.i.i
	ld.d	$a0, $s4, %pc_lo12(active_sps)
	ld.w	$a1, $a0, 1148
	ld.d	$a0, $s8, 0
	bnez	$a1, .LBB3_112
# %bb.99:                               # %land.lhs.true.i.i
	ld.w	$a1, $a0, 24
	bnez	$a1, .LBB3_112
# %bb.100:                              # %for.cond67.preheader.i.i
...
.LBB3_102:                              # %for.body76.i.i
	...
	addi.d	$a4, $a4, 8
	bnez	$a3, .LBB3_102
.LBB3_103:                              # %for.inc122.i.i
	ld.w	$a3, $s3, 12
	blez	$a3, .LBB3_106
# %bb.104:                              # %for.body76.lr.ph.1.i.i
	pcalau12i	$a4, %got_pc_hi20(listX)
	ld.d	$a4, $a4, %got_pc_lo12(listX)
	ld.d	$a4, $a4, 24
	addi.d	$a2, $a2, 1937
	.p2align	4, , 16
.LBB3_105:                              # %for.body76.1.i.i
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a5, $a4, 0
	ld.w	$a6, $a5, 4
	ld.w	$a7, $a5, 0
	...
	addi.d	$a4, $a4, 8
	bnez	$a3, .LBB3_105
.LBB3_106:                              # %for.inc122.1.i.i
	ld.w	$a2, $s3, 16
	blez	$a2, .LBB3_109
# %bb.107:                              # %for.body76.lr.ph.2.i.i
	pcalau12i	$a3, %got_pc_hi20(listX)
	ld.d	$a3, $a3, %got_pc_lo12(listX)
	ld.d	$a3, $a3, 32
	lu12i.w	$a4, 1
...
.LBB3_108:                              # %for.body76.2.i.i
	...
	addi.d	$a3, $a3, 8
	bnez	$a2, .LBB3_108
.LBB3_109:                              # %for.inc122.2.i.i
	ld.w	$a2, $s3, 20
	blez	$a2, .LBB3_112
# %bb.110:                              # %for.body76.lr.ph.3.i.i
	pcalau12i	$a3, %got_pc_hi20(listX)
	ld.d	$a3, $a3, %got_pc_lo12(listX)
	ld.d	$a3, $a3, 40
	lu12i.w	$a4, 1
...
.LBB3_111:                              # %for.body76.3.i.i
	...
	addi.d	$a3, $a3, 8
	bnez	$a2, .LBB3_111
.LBB3_112:                              # %set_ref_pic_num.exit.i
	ld.w	$a1, $a0, 20
	ori	$a0, $zero, 1
	bne	$a1, $a0, .LBB3_114
# %bb.113:                              # %if.then247.i
	...
	ld.d	$a0, $s8, 0
	ld.w	$a1, $a0, 20
.LBB3_114:                              # %if.end248.i
	ld.d	$a0, $fp, 0
	ori	$a2, $zero, 2
	beq	$a1, $a2, .LBB3_117
# %bb.115:                              # %land.lhs.true252.i
	ldptr.w	$a1, $a0, 5244
	ori	$a2, $zero, 3
	bne	$a1, $a2, .LBB3_117
# %bb.116:                              # %if.then255.i
...
# %bb.118:                              # %if.else279.i
	...
	ld.d	$a2, $a0, %got_pc_lo12(writeFieldModeInfo_CABAC)
	pcalau12i	$a0, %got_pc_hi20(writeCIPredMode_CABAC)
	ld.d	$a0, $a0, %got_pc_lo12(writeCIPredMode_CABAC)
	pcalau12i	$a3, %got_pc_hi20(writeDquant_CABAC)
	ld.d	$a6, $a3, %got_pc_lo12(writeDquant_CABAC)
	pcalau12i	$a3, %got_pc_hi20(writeCBP_CABAC)
	ld.d	$a3, $a3, %got_pc_lo12(writeCBP_CABAC)
	pcalau12i	$a5, %got_pc_hi20(writeMVD_CABAC)
	ld.d	$a5, $a5, %got_pc_lo12(writeMVD_CABAC)
	b	.LBB3_133
.LBB3_119:                              # %if.then259.i
	pcalau12i	$a0, %got_pc_hi20(writeMB_typeInfo)
	...
	pcalau12i	$a2, %got_pc_hi20(writeIntraPredMode_CAVLC)
	ld.d	$a2, $a2, %got_pc_lo12(writeIntraPredMode_CAVLC)
	st.d	$a2, $a1, 0
	...
	st.d	$a0, $a1, 0
	ori	$a3, $zero, 2
	pcalau12i	$a1, %pc_hi20(.Lswitch.table.encode_one_slice.5)
	addi.d	$a1, $a1, %pc_lo12(.Lswitch.table.encode_one_slice.5)
	move	$a4, $a0
	bltu	$a3, $a2, .LBB3_121
# %bb.120:                              # %switch.lookup
	slli.d	$a2, $a2, 3
	ldx.d	$a4, $a1, $a2
.LBB3_121:                              # %for.inc276.i
	pcalau12i	$a2, %got_pc_hi20(writeRefFrame)
	ld.d	$a2, $a2, %got_pc_lo12(writeRefFrame)
	ld.w	$a5, $s3, 4
	st.d	$a4, $a2, 0
	move	$a4, $a0
	bltu	$a3, $a5, .LBB3_123
# %bb.122:                              # %switch.lookup129
	slli.d	$a3, $a5, 3
	ldx.d	$a4, $a1, $a3
.LBB3_123:                              # %for.inc276.1.i
	ld.w	$a5, $s3, 8
	ori	$a3, $zero, 2
	st.d	$a4, $a2, 8
	move	$a4, $a0
	bltu	$a3, $a5, .LBB3_125
# %bb.124:                              # %switch.lookup132
	slli.d	$a4, $a5, 3
	ldx.d	$a4, $a1, $a4
.LBB3_125:                              # %for.inc276.2.i
	ld.w	$a5, $s3, 12
	st.d	$a4, $a2, 16
	move	$a4, $a0
	bltu	$a3, $a5, .LBB3_127
# %bb.126:                              # %switch.lookup135
	slli.d	$a3, $a5, 3
	ldx.d	$a4, $a1, $a3
.LBB3_127:                              # %for.inc276.3.i
	ld.w	$a5, $s3, 16
	ori	$a6, $zero, 2
	st.d	$a4, $a2, 24
	move	$a3, $a0
	bltu	$a6, $a5, .LBB3_129
# %bb.128:                              # %switch.lookup138
	slli.d	$a3, $a5, 3
	ldx.d	$a3, $a1, $a3
.LBB3_129:                              # %for.inc276.4.i
	ld.w	$a4, $s3, 20
	st.d	$a3, $a2, 32
	pcalau12i	$a2, %got_pc_hi20(writeSE_Flag)
	ld.d	$a2, $a2, %got_pc_lo12(writeSE_Flag)
	pcalau12i	$a3, %got_pc_hi20(writeCBP_VLC)
	ld.d	$a3, $a3, %got_pc_lo12(writeCBP_VLC)
	pcalau12i	$a5, %got_pc_hi20(writeSE_SVLC)
	ld.d	$a5, $a5, %got_pc_lo12(writeSE_SVLC)
	ori	$a6, $zero, 3
	bgeu	$a4, $a6, .LBB3_131
# %bb.130:                              # %switch.lookup141
	slli.d	$a4, $a4, 3
	ldx.d	$a4, $a1, $a4
	b	.LBB3_132
.LBB3_131:
...
.LBB3_133:                              # %init_slice.exit
	...
	st.d	$a5, $a4, 0
	pcalau12i	$a4, %got_pc_hi20(writeCBP)
	ld.d	$a4, $a4, %got_pc_lo12(writeCBP)
	st.d	$a3, $a4, 0
	pcalau12i	$a3, %got_pc_hi20(writeDquant)
	ld.d	$a3, $a3, %got_pc_lo12(writeDquant)
	st.d	$a6, $a3, 0
	pcalau12i	$a3, %got_pc_hi20(writeCIPredMode)
	ld.d	$a3, $a3, %got_pc_lo12(writeCIPredMode)
	st.d	$a0, $a3, 0
...
# %bb.137:                              # %land.rhs
	...
	or	$a1, $a2, $a1
	b	.LBB3_140
.LBB3_138:                              # %if.end.land.end_crit_edge
	ld.d	$a0, $s8, 0
.LBB3_139:
	move	$a1, $zero
.LBB3_140:                              # %land.end
...
# %bb.144:
	move	$fp, $zero
	b	.LBB3_220
.LBB3_145:                              # %while.body.preheader
	addi.w	$a0, $zero, -1
	st.d	$a0, $sp, 96                    # 8-byte Folded Spill
	lu52i.d	$a0, $a0, 2046
	movgr2fr.d	$fs0, $a0
	pcalau12i	$s7, %pc_hi20(rdopt)
	pcalau12i	$a0, %pc_hi20(rddata_top_frame_mb)
	addi.d	$a0, $a0, %pc_lo12(rddata_top_frame_mb)
	st.d	$a0, $sp, 104                   # 8-byte Folded Spill
	pcalau12i	$s2, %pc_hi20(encode_one_macroblock)
...
.LBB3_149:                              # %while.body
	...
	ldptr.w	$a1, $a0, 15260
	beqz	$a1, .LBB3_154
# %bb.150:                              # %land.lhs.true22
                                        #   in Loop: Header=BB3_149 Depth=1
	ld.d	$a1, $fp, 0
	ldptr.w	$a1, $a1, 5656
	beqz	$a1, .LBB3_154
# %bb.151:                              # %land.lhs.true24
                                        #   in Loop: Header=BB3_149 Depth=1
	ld.w	$a0, $a0, 12
	mod.w	$a0, $a0, $a1
	bnez	$a0, .LBB3_154
...
# %bb.157:                              # %if.then59
                                        #   in Loop: Header=BB3_149 Depth=1
	beqz	$a3, .LBB3_161
# %bb.158:                              # %land.lhs.true67
                                        #   in Loop: Header=BB3_149 Depth=1
	ldptr.w	$a1, $a2, 15388
	blez	$a1, .LBB3_162
# %bb.159:                              # %land.lhs.true70
                                        #   in Loop: Header=BB3_149 Depth=1
	ldptr.w	$a2, $a2, 15404
	mod.wu	$a1, $a1, $a2
	bnez	$a1, .LBB3_162
...
.LBB3_164:                              # %if.end85
	...
	jirl	$ra, $ra, 0
	ld.d	$a0, $s2, %pc_lo12(encode_one_macroblock)
	ld.d	$a1, $sp, 104                   # 8-byte Folded Reload
	st.d	$a1, $s7, %pc_lo12(rdopt)
	jirl	$ra, $a0, 0
	ld.d	$a0, $s7, %pc_lo12(rdopt)
	ld.d	$a1, $s8, 0
	fld.d	$fs0, $a0, 0
	ori	$a0, $zero, 1
	stptr.w	$a0, $a1, 15412
	...
	ldptr.w	$a1, $a0, 5116
	beqz	$a1, .LBB3_171
# %bb.165:                              # %land.lhs.true91
                                        #   in Loop: Header=BB3_149 Depth=1
	ldptr.w	$a1, $a0, 4708
	bne	$a1, $s5, .LBB3_169
# %bb.166:                              # %land.lhs.true95
                                        #   in Loop: Header=BB3_149 Depth=1
	ld.d	$a1, $s8, 0
	ldptr.w	$a2, $a1, 15388
	blez	$a2, .LBB3_169
# %bb.167:                              # %land.lhs.true99
                                        #   in Loop: Header=BB3_149 Depth=1
	ldptr.w	$a1, $a1, 15404
	mod.wu	$a1, $a2, $a1
	bnez	$a1, .LBB3_169
...
.LBB3_172:                              # %if.end117
	...
	move	$s3, $fp
	addi.w	$a3, $a1, -1
	pcalau12i	$s1, %pc_hi20(MBPairIsField)
	ori	$a6, $s6, 2168
	pcalau12i	$a4, %pc_hi20(rddata_top_field_mb)
	move	$a5, $s6
	addi.d	$s6, $a4, %pc_lo12(rddata_top_field_mb)
	bgeu	$a3, $s5, .LBB3_187
# %bb.173:                              # %if.then125
                                        #   in Loop: Header=BB3_149 Depth=1
	ori	$a3, $zero, 1
...
# %bb.174:                              # %if.then125
                                        #   in Loop: Header=BB3_149 Depth=1
	beqz	$a3, .LBB3_178
# %bb.175:                              # %land.lhs.true139
                                        #   in Loop: Header=BB3_149 Depth=1
	ldptr.w	$a1, $a2, 15388
	blez	$a1, .LBB3_179
# %bb.176:                              # %land.lhs.true143
                                        #   in Loop: Header=BB3_149 Depth=1
	ldptr.w	$a2, $a2, 15404
	mod.wu	$a1, $a1, $a2
	bnez	$a1, .LBB3_179
...
.LBB3_181:                              # %if.end165
	...
	addi.d	$a0, $a0, %pc_lo12(rddata_bot_field_mb)
	ld.d	$a1, $s2, %pc_lo12(encode_one_macroblock)
	st.d	$a0, $s7, %pc_lo12(rdopt)
	jirl	$ra, $a1, 0
	ld.d	$a0, $s3, 0
	ld.d	$a3, $s7, %pc_lo12(rdopt)
	ld.d	$a2, $s8, 0
	ldptr.w	$a1, $a0, 4708
	fld.d	$fa0, $a3, 0
...
# %bb.183:                              # %if.then181
	...
	st.w	$zero, $s1, %pc_lo12(MBPairIsField)
	ld.w	$a4, $a0, 32
	srli.d	$a1, $a1, 1
	ldx.w	$a5, $a2, $fp
	stptr.w	$a1, $a2, 15240
...
# %bb.186:                              # %if.then49
	...
	b	.LBB3_148
	.p2align	4, , 16
.LBB3_187:                              # %if.end165.thread
                                        #   in Loop: Header=BB3_149 Depth=1
	move	$fp, $a6
	move	$a3, $zero
	stptr.w	$zero, $a2, 15416
.LBB3_188:                              # %lor.lhs.false172
                                        #   in Loop: Header=BB3_149 Depth=1
	addi.w	$a1, $a1, 0
	ori	$a4, $zero, 3
	bne	$a1, $a4, .LBB3_197
# %bb.189:                              # %if.then176.thread
                                        #   in Loop: Header=BB3_149 Depth=1
	stptr.w	$zero, $a2, 14464
	st.w	$zero, $s1, %pc_lo12(MBPairIsField)
	ldptr.w	$a1, $a0, 5116
	beqz	$a1, .LBB3_196
.LBB3_190:                              # %land.lhs.true191
                                        #   in Loop: Header=BB3_149 Depth=1
	beqz	$a3, .LBB3_194
# %bb.191:                              # %land.lhs.true195
                                        #   in Loop: Header=BB3_149 Depth=1
	ldptr.w	$a1, $a2, 15388
	blez	$a1, .LBB3_194
# %bb.192:                              # %land.lhs.true199
                                        #   in Loop: Header=BB3_149 Depth=1
	ldptr.w	$a2, $a2, 15404
	mod.wu	$a1, $a1, $a2
	bnez	$a1, .LBB3_194
...
.LBB3_196:                              # %if.end218
                                        #   in Loop: Header=BB3_149 Depth=1
	ld.d	$a2, $s8, 0
	ld.w	$a0, $s1, %pc_lo12(MBPairIsField)
	ori	$a1, $zero, 1
	stptr.w	$a1, $a2, 15416
	stptr.w	$a1, $a2, 15408
	sltu	$a0, $zero, $a0
	b	.LBB3_198
	.p2align	4, , 16
.LBB3_197:                              # %if.end218.thread
                                        #   in Loop: Header=BB3_149 Depth=1
	ori	$a0, $zero, 1
	stptr.w	$a0, $a2, 14464
	st.w	$a0, $s1, %pc_lo12(MBPairIsField)
	stptr.w	$a0, $a2, 15408
.LBB3_198:                              # %if.end225
                                        #   in Loop: Header=BB3_149 Depth=1
	ldptr.w	$a1, $a2, 14464
...
.LBB3_202:                              # %if.end278
                                        #   in Loop: Header=BB3_149 Depth=1
	ld.w	$a1, $s1, %pc_lo12(MBPairIsField)
	ld.d	$a0, $s8, 0
	beqz	$a1, .LBB3_204
# %bb.203:                              # %if.then280
                                        #   in Loop: Header=BB3_149 Depth=1
...
# %bb.205:                              # %if.then293
	...
	jirl	$ra, $ra, 0
	beq	$s0, $a0, .LBB3_218
# %bb.206:                              #   in Loop: Header=BB3_149 Depth=1
	move	$fp, $s3
	b	.LBB3_148
	.p2align	4, , 16
.LBB3_207:                              # %if.then232
...
.LBB3_215:                              # %if.then41
	...
	st.w	$a0, $sp, 116
	b	.LBB3_147
.LBB3_216:                              # %if.then236.i
	move	$a0, $zero
.LBB3_217:                              # %if.end243.i
...
# %bb.32:                               # %middle.block193
	...
	sltui	$a4, $a4, 1
	beq	$a0, $ra, .LBB5_35
.LBB5_33:                               # %for.body116.preheader198
	addi.d	$a6, $sp, 568
	alsl.d	$a6, $a0, $a6, 2
	addi.d	$a7, $sp, 440
	alsl.d	$a7, $a0, $a7, 2
...
.LBB6_83:                               # %if.then425
	...
	fld.d	$fa1, $a2, %pc_lo12(.LCPI6_6)
	pcalau12i	$a2, %pc_hi20(.LCPI6_7)
	fld.d	$fa2, $a2, %pc_lo12(.LCPI6_7)
	movgr2fr.w	$fa3, $a1
	ffint.d.w	$fa3, $fa3
	fmul.d	$fa1, $fa3, $fa1
...
.LBB6_128:                              # %for.cond593.preheader
	ori	$fp, $zero, 12
	pcalau12i	$a0, %got_pc_hi20(QP2QUANT)
	ld.d	$s1, $a0, %got_pc_lo12(QP2QUANT)
