...
# %bb.4:                                # %for.cond5.preheader.lr.ph
	...
	b	.LBB8_6
	.p2align	4, , 16
.LBB8_5:                                # %for.cond5.for.inc82_crit_edge.us
                                        #   in Loop: Header=BB8_6 Depth=2
	addi.d	$s4, $s4, 1
	addi.d	$t3, $t3, 4
	addi.d	$ra, $ra, 4
	beq	$s4, $s3, .LBB8_2
.LBB8_6:                                # %for.cond5.preheader.us
	...
	slli.d	$t0, $s4, 3
	bgeu	$a5, $t6, .LBB8_11
# %bb.7:                                # %for.body9.lr.ph.split.us.us
                                        #   in Loop: Header=BB8_6 Depth=2
	ld.d	$t5, $s5, 0
	ldx.d	$a1, $t5, $t0
	ld.w	$t0, $a4, 4
	...
	b	.LBB8_9
	.p2align	4, , 16
.LBB8_8:                                # %for.inc.us.us
                                        #   in Loop: Header=BB8_9 Depth=3
	stx.w	$t4, $ra, $t1
	addi.d	$t1, $t1, 128
	addi.d	$t5, $t5, 8
	beq	$s8, $t1, .LBB8_5
.LBB8_9:                                # %for.body9.us.us
                                        #   Parent Loop BB8_3 Depth=1
                                        #     Parent Loop BB8_6 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ori	$t4, $zero, 256
	beq	$t0, $a6, .LBB8_8
# %bb.10:                               # %if.then60.us.us
                                        #   in Loop: Header=BB8_9 Depth=3
	ld.d	$a2, $t5, 0
	ld.w	$a2, $a2, 4
	ext.w.h	$t4, $t2
	...
	b	.LBB8_8
	.p2align	4, , 16
.LBB8_11:                               # %for.body9.us1001.preheader
                                        #   in Loop: Header=BB8_6 Depth=2
	bgeu	$s3, $a0, .LBB8_13
...
.LBB8_13:                               # %vector.ph
	...
	vpickve2gr.h	$a6, $vr11, 3
	ori	$t1, $a7, 127
	and	$a6, $a6, $t1
	vpickve2gr.h	$t2, $vr9, 3
	ext.w.h	$t2, $t2
	div.d	$a6, $a6, $t2
	vpickve2gr.h	$t2, $vr11, 2
	and	$t2, $t2, $t1
	vpickve2gr.h	$t4, $vr9, 2
	ext.w.h	$t4, $t4
	div.d	$t2, $t2, $t4
	vpickve2gr.h	$t4, $vr11, 1
	and	$t4, $t4, $t1
	vpickve2gr.h	$t5, $vr9, 1
	ext.w.h	$t5, $t5
	div.d	$t4, $t4, $t5
...
.LBB8_14:                               # %vector.body
	...
	vstelm.w	$vr10, $a6, -256, 0
	vstelm.w	$vr10, $a6, -128, 1
	vstelm.w	$vr10, $a6, 0, 2
	vstelm.w	$vr10, $a6, 128, 3
	addi.d	$t1, $t1, -4
	addi.d	$a6, $a6, 512
	addi.d	$a1, $a1, 32
	bnez	$t1, .LBB8_14
# %bb.15:                               # %middle.block
	...
	move	$a1, $s6
	beq	$s6, $s3, .LBB8_5
.LBB8_16:                               # %for.body9.us1001.preheader1291
                                        #   in Loop: Header=BB8_6 Depth=2
	ld.d	$t2, $s5, 0
	ldx.d	$a6, $t2, $t0
	ld.w	$a6, $a6, 4
...
.LBB8_17:                               # %for.inc.us1022
	...
	addi.d	$t2, $t2, 8
	beqz	$a1, .LBB8_5
.LBB8_18:                               # %for.body9.us1001
                                        #   Parent Loop BB8_3 Depth=1
                                        #     Parent Loop BB8_6 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ori	$s1, $zero, 256
	beq	$t0, $a6, .LBB8_17
# %bb.19:                               # %if.then60.us1004
                                        #   in Loop: Header=BB8_18 Depth=3
	ld.d	$s1, $t2, 0
	ld.w	$s1, $s1, 4
	ext.w.h	$a2, $t5
...
.LBB8_23:                               # %if.end103
	...
	bltz	$t0, .LBB8_40
# %bb.24:                               # %for.cond132.preheader.lr.ph
...
.LBB8_50:                               # %if.end898
	...
	or	$a0, $a0, $a1
	beqz	$a0, .LBB8_88
# %bb.51:                               # %for.cond904.preheader
	ldptr.w	$a1, $a4, 6396
	ori	$a0, $zero, 8
	blt	$a1, $a0, .LBB8_88
# %bb.52:                               # %for.cond910.preheader.lr.ph
	ldptr.w	$a5, $a4, 6392
	ori	$a0, $zero, 4
	blt	$a5, $a0, .LBB8_88
# %bb.53:                               # %for.cond910.preheader.us.preheader
	move	$t0, $zero
	...
	b	.LBB8_55
	.p2align	4, , 16
.LBB8_54:                               # %for.cond910.for.inc1522_crit_edge.us
                                        #   in Loop: Header=BB8_55 Depth=1
	ld.d	$t0, $sp, 40                    # 8-byte Folded Reload
	addi.d	$t0, $t0, 1
	ld.d	$a0, $sp, 32                    # 8-byte Folded Reload
	beq	$t0, $a0, .LBB8_88
.LBB8_55:                               # %for.cond910.preheader.us
                                        # =>This Loop Header: Depth=1
	...
	beqz	$a7, .LBB8_66
# %bb.56:                               # %for.body915.lr.ph.split.us.us
                                        #   in Loop: Header=BB8_55 Depth=1
	ldptr.d	$a0, $a4, 6504
	ld.d	$a0, $a0, 0
	ldx.d	$a5, $a0, $t7
...
.LBB8_57:                               # %if.else1059.us.us
	...
	st.h	$a1, $t2, 2
	beq	$t3, $s1, .LBB8_54
.LBB8_58:                               # %for.body915.us.us
                                        #   Parent Loop BB8_55 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB8_61 Depth 3
	slli.d	$fp, $t3, 3
	ldx.d	$a0, $a5, $fp
	...
	ldx.d	$s2, $a0, $fp
	beq	$s2, $ra, .LBB8_57
# %bb.59:                               # %for.cond944.preheader.us.us
                                        #   in Loop: Header=BB8_58 Depth=2
	ld.d	$a0, $sp, 80                    # 8-byte Folded Reload
	ldptr.w	$a0, $a0, 14456
	slt	$a2, $a0, $t2
	...
	ori	$t2, $zero, 256
	blt	$t0, $s8, .LBB8_63
# %bb.60:                               # %for.body949.us.us.preheader
                                        #   in Loop: Header=BB8_58 Depth=2
	move	$s3, $zero
	slli.d	$t4, $t0, 2
	move	$t0, $t8
	.p2align	4, , 16
.LBB8_61:                               # %for.body949.us.us
                                        #   Parent Loop BB8_55 Depth=1
                                        #     Parent Loop BB8_58 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$a0, $t0, 0
	beq	$a0, $s2, .LBB8_64
# %bb.62:                               # %for.cond944.us.us
...
.LBB8_65:                               # %for.end978.us.us
	...
	b	.LBB8_54
	.p2align	4, , 16
.LBB8_66:                               # %for.body915.lr.ph.split.us1061
                                        #   in Loop: Header=BB8_55 Depth=1
	ldptr.d	$a0, $t1, 6504
	ld.w	$t8, $a3, 16
...
.LBB8_67:                               # %if.then1482.us
	...
	srli.d	$a0, $a0, 1
	st.h	$a0, $a5, 2
.LBB8_68:                               # %for.inc1519.us1057
                                        #   in Loop: Header=BB8_69 Depth=2
	addi.d	$s5, $s5, 1
	beq	$s5, $s1, .LBB8_54
.LBB8_69:                               # %for.body915.us1055
                                        #   Parent Loop BB8_55 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB8_72 Depth 3
                                        #       Child Loop BB8_82 Depth 3
	...
	ldx.d	$s6, $a0, $a5
	beq	$s6, $ra, .LBB8_75
# %bb.70:                               # %for.cond1115.preheader.us
                                        #   in Loop: Header=BB8_69 Depth=2
	ld.d	$a0, $sp, 80                    # 8-byte Folded Reload
	ldx.w	$a0, $a0, $t6
	slli.w	$a0, $a0, 1
	...
	ori	$t2, $zero, 256
	blt	$t0, $s8, .LBB8_74
# %bb.71:                               # %for.body1121.us.preheader
                                        #   in Loop: Header=BB8_69 Depth=2
	move	$t3, $zero
	slli.d	$t4, $t0, 2
	ld.d	$t0, $sp, 56                    # 8-byte Folded Reload
	.p2align	4, , 16
.LBB8_72:                               # %for.body1121.us
                                        #   Parent Loop BB8_55 Depth=1
                                        #     Parent Loop BB8_69 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$a0, $t0, 0
	beq	$a0, $s6, .LBB8_76
# %bb.73:                               # %for.cond1115.us
                                        #   in Loop: Header=BB8_72 Depth=3
	addi.d	$t3, $t3, 4
	addi.d	$t0, $t0, 8
	bne	$t4, $t3, .LBB8_72
.LBB8_74:                               #   in Loop: Header=BB8_69 Depth=2
	move	$t5, $zero
	b	.LBB8_77
	.p2align	4, , 16
.LBB8_75:                               # %if.else1230.us
                                        #   in Loop: Header=BB8_69 Depth=2
	ld.d	$a0, $sp, 88                    # 8-byte Folded Reload
	ld.d	$a0, $a0, 32
	ld.d	$a1, $a0, 0
...
.LBB8_79:                               # %if.end1304.us
	...
	ldx.d	$s6, $a0, $a5
	beq	$s6, $ra, .LBB8_85
# %bb.80:                               # %for.cond1330.preheader.us
                                        #   in Loop: Header=BB8_69 Depth=2
	ld.d	$a0, $sp, 80                    # 8-byte Folded Reload
	ldx.w	$a0, $a0, $t6
	slli.w	$a0, $a0, 1
	...
	ori	$t2, $zero, 256
	blt	$t0, $s8, .LBB8_84
# %bb.81:                               # %for.body1336.us.preheader
                                        #   in Loop: Header=BB8_69 Depth=2
	move	$t3, $zero
	slli.d	$t4, $t0, 2
	ld.d	$t0, $sp, 48                    # 8-byte Folded Reload
	.p2align	4, , 16
.LBB8_82:                               # %for.body1336.us
                                        #   Parent Loop BB8_55 Depth=1
                                        #     Parent Loop BB8_69 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$a0, $t0, 0
	beq	$a0, $s6, .LBB8_86
# %bb.83:                               # %for.cond1330.us
                                        #   in Loop: Header=BB8_82 Depth=3
	addi.d	$t3, $t3, 4
	addi.d	$t0, $t0, 8
	bne	$t4, $t3, .LBB8_82
.LBB8_84:                               #   in Loop: Header=BB8_69 Depth=2
	move	$t5, $zero
	b	.LBB8_87
	.p2align	4, , 16
.LBB8_85:                               # %if.else1445.us
                                        #   in Loop: Header=BB8_69 Depth=2
	ld.d	$a0, $sp, 88                    # 8-byte Folded Reload
	ld.d	$a0, $a0, 24
	ld.d	$a1, $a0, 0
...
.LBB8_88:                               # %if.end1525
	...
	beqz	$a0, .LBB8_138
# %bb.89:                               # %for.cond1840.preheader
	ori	$a1, $zero, 1
	blt	$t3, $a1, .LBB8_174
# %bb.90:                               # %for.cond1846.preheader.lr.ph
	ldptr.w	$a0, $a4, 6392
	srai.d	$a5, $a0, 2
	blt	$a5, $a1, .LBB8_174
# %bb.91:                               # %for.cond1846.preheader.lr.ph.split.us
	ldptr.d	$a0, $a4, 6504
	move	$a7, $zero
	ld.d	$t1, $a0, 0
	addi.d	$t2, $sp, 1020
	...
	b	.LBB8_93
	.p2align	4, , 16
.LBB8_92:                               # %for.cond1846.for.inc2025_crit_edge.us
                                        #   in Loop: Header=BB8_93 Depth=1
	addi.d	$a7, $a7, 1
	ld.d	$a0, $sp, 72                    # 8-byte Folded Reload
	beq	$a7, $a0, .LBB8_174
.LBB8_93:                               # %for.cond1846.preheader.us
                                        # =>This Loop Header: Depth=1
...
.LBB8_95:                               # %for.body1851.us
	...
	ldx.d	$s6, $a0, $s3
	beq	$s6, $t5, .LBB8_94
# %bb.96:                               # %for.cond1877.preheader.us
                                        #   in Loop: Header=BB8_95 Depth=2
	ld.d	$a0, $sp, 80                    # 8-byte Folded Reload
	ldptr.w	$a0, $a0, 14456
	slt	$a2, $a0, $s4
	...
	ori	$s4, $zero, 256
	blt	$s8, $t4, .LBB8_100
# %bb.97:                               # %for.body1882.us.preheader
                                        #   in Loop: Header=BB8_95 Depth=2
	move	$s7, $zero
	slli.d	$s8, $s8, 2
	move	$ra, $s2
	.p2align	4, , 16
.LBB8_98:                               # %for.body1882.us
                                        #   Parent Loop BB8_93 Depth=1
                                        #     Parent Loop BB8_95 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$a0, $ra, 0
	beq	$a0, $s6, .LBB8_101
# %bb.99:                               # %for.cond1877.us
                                        #   in Loop: Header=BB8_98 Depth=3
	addi.d	$s7, $s7, 4
	addi.d	$ra, $ra, 8
	bne	$s8, $s7, .LBB8_98
...
.LBB8_102:                              # %for.end1911.us
	...
	bne	$s1, $a5, .LBB8_95
	b	.LBB8_92
.LBB8_103:                              # %for.cond347.preheader
	ldptr.w	$a0, $a4, 6396
	srai.d	$a0, $a0, 2
	ori	$a1, $zero, 1
	st.d	$a0, $sp, 56                    # 8-byte Folded Spill
	blt	$a0, $a1, .LBB8_50
# %bb.104:                              # %for.body349.lr.ph
	ldptr.w	$a0, $a4, 6392
	srai.d	$t4, $a0, 2
	blt	$t4, $a1, .LBB8_50
# %bb.105:                              # %for.body349.us.preheader
	move	$t6, $zero
	lu12i.w	$a0, 262143
	ori	$a0, $a0, 4092
	st.d	$a0, $sp, 48                    # 8-byte Folded Spill
	...
	b	.LBB8_107
	.p2align	4, , 16
.LBB8_106:                              # %for.cond355.for.inc895_crit_edge.us
                                        #   in Loop: Header=BB8_107 Depth=1
	addi.d	$t6, $t6, 1
	ld.d	$a0, $sp, 56                    # 8-byte Folded Reload
	beq	$t6, $a0, .LBB8_50
.LBB8_107:                              # %for.body349.us
                                        # =>This Loop Header: Depth=1
...
.LBB8_109:                              # %for.body358.us
	...
	slli.d	$t8, $s5, 3
	bnez	$a7, .LBB8_118
# %bb.110:                              # %land.lhs.true361.us
                                        #   in Loop: Header=BB8_109 Depth=2
	ldptr.d	$a0, $a4, 6528
	ldx.d	$a0, $a0, $t5
	ldx.bu	$a0, $a0, $s5
	beqz	$a0, .LBB8_118
# %bb.111:                              # %if.then367.us
                                        #   in Loop: Header=BB8_109 Depth=2
	ld.w	$a0, $s7, 4
	ld.w	$a1, $t1, 4
	sub.w	$a1, $a0, $a1
	...
	alsl.d	$a1, $s8, $a1, 3
	bgeu	$a0, $a2, .LBB8_124
# %bb.112:                              # %if.then378.us
                                        #   in Loop: Header=BB8_109 Depth=2
	ld.d	$a0, $a1, 0
	ldx.d	$a5, $a0, $t8
	beq	$a5, $s1, .LBB8_108
# %bb.113:                              # %for.cond403.preheader.us
                                        #   in Loop: Header=BB8_109 Depth=2
	ld.w	$a0, $a3, 0
	...
	ori	$a1, $zero, 256
	blt	$t0, $s0, .LBB8_117
# %bb.114:                              # %for.body407.us.preheader
                                        #   in Loop: Header=BB8_109 Depth=2
	move	$fp, $zero
	slli.d	$t3, $t0, 2
	move	$t7, $s2
	.p2align	4, , 16
.LBB8_115:                              # %for.body407.us
                                        #   Parent Loop BB8_107 Depth=1
                                        #     Parent Loop BB8_109 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$a0, $t7, 0
	beq	$a0, $a5, .LBB8_132
# %bb.116:                              # %for.cond403.us
                                        #   in Loop: Header=BB8_115 Depth=3
	addi.d	$fp, $fp, 4
	addi.d	$t7, $t7, 8
	bne	$t3, $fp, .LBB8_115
.LBB8_117:                              #   in Loop: Header=BB8_109 Depth=2
	move	$a5, $zero
	b	.LBB8_133
	.p2align	4, , 16
.LBB8_118:                              # %if.else720.us
                                        #   in Loop: Header=BB8_109 Depth=2
	ldptr.d	$a0, $a4, 6504
	ld.d	$a0, $a0, 0
	ldx.d	$a0, $a0, $t5
	...
	ldx.d	$fp, $a0, $t8
	beq	$fp, $s1, .LBB8_108
# %bb.119:                              # %for.cond746.preheader.us
                                        #   in Loop: Header=BB8_109 Depth=2
	ld.d	$a0, $sp, 80                    # 8-byte Folded Reload
	ldptr.w	$a0, $a0, 14456
	slt	$a2, $a0, $a5
	...
	ori	$a5, $zero, 256
	blt	$t0, $s0, .LBB8_123
# %bb.120:                              # %for.body751.us.preheader
                                        #   in Loop: Header=BB8_109 Depth=2
	move	$t3, $zero
	slli.d	$t7, $t0, 2
	move	$ra, $s2
	.p2align	4, , 16
.LBB8_121:                              # %for.body751.us
                                        #   Parent Loop BB8_107 Depth=1
                                        #     Parent Loop BB8_109 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$a0, $ra, 0
	beq	$a0, $fp, .LBB8_130
# %bb.122:                              # %for.cond746.us
                                        #   in Loop: Header=BB8_121 Depth=3
	addi.d	$t3, $t3, 4
	addi.d	$ra, $ra, 8
	bne	$t7, $t3, .LBB8_121
.LBB8_123:                              #   in Loop: Header=BB8_109 Depth=2
	move	$a1, $zero
	b	.LBB8_131
.LBB8_124:                              # %if.else545.us
                                        #   in Loop: Header=BB8_109 Depth=2
	ld.d	$a0, $a1, 32
	ldx.d	$a5, $a0, $t8
	beq	$a5, $s1, .LBB8_108
# %bb.125:                              # %for.cond573.preheader.us
                                        #   in Loop: Header=BB8_109 Depth=2
	ld.w	$a0, $a3, 0
	ld.d	$a1, $sp, 80                    # 8-byte Folded Reload
	ldptr.w	$a1, $a1, 14456
	...
	ori	$a1, $zero, 256
	blt	$t0, $s0, .LBB8_129
# %bb.126:                              # %for.body578.us.preheader
                                        #   in Loop: Header=BB8_109 Depth=2
	move	$fp, $zero
	slli.d	$t3, $t0, 2
	move	$t7, $s2
	.p2align	4, , 16
.LBB8_127:                              # %for.body578.us
                                        #   Parent Loop BB8_107 Depth=1
                                        #     Parent Loop BB8_109 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$a0, $t7, 0
	beq	$a0, $a5, .LBB8_134
# %bb.128:                              # %for.cond573.us
                                        #   in Loop: Header=BB8_127 Depth=3
	addi.d	$fp, $fp, 4
	addi.d	$t7, $t7, 8
	bne	$t3, $fp, .LBB8_127
.LBB8_129:                              #   in Loop: Header=BB8_109 Depth=2
	move	$a5, $zero
	b	.LBB8_135
.LBB8_130:                              # %if.then764.us
                                        #   in Loop: Header=BB8_109 Depth=2
	addi.d	$a0, $sp, 96
	masknez	$a0, $a0, $a1
	addi.d	$a2, $sp, 888
...
.LBB8_134:                              # %if.then592.us
	...
	or	$a0, $a2, $a0
	ldx.w	$a5, $a0, $fp
.LBB8_135:                              # %for.end608.us
                                        #   in Loop: Header=BB8_109 Depth=2
	masknez	$a0, $t1, $t2
	maskeqz	$a2, $a6, $t2
.LBB8_136:                              # %for.inc892.us
                                        #   in Loop: Header=BB8_109 Depth=2
	or	$a0, $a2, $a0
	ldptr.d	$a0, $a0, 6512
	ld.d	$a0, $a0, 0
...
.LBB8_137:                              # %for.inc892.us
	...
	bne	$s5, $t4, .LBB8_109
	b	.LBB8_106
.LBB8_138:                              # %if.then1528
	ld.d	$a0, $sp, 8                     # 8-byte Folded Reload
	beqz	$a0, .LBB8_154
.LBB8_139:                              # %for.cond2032.preheader
	ori	$a0, $zero, 1
	ld.d	$t2, $sp, 8                     # 8-byte Folded Reload
	blt	$t3, $a0, .LBB8_174
.LBB8_140:                              # %for.cond2038.preheader.lr.ph
	ldptr.w	$a0, $a4, 6392
	srai.d	$a3, $a0, 2
	ori	$a0, $zero, 1
	blt	$a3, $a0, .LBB8_174
# %bb.141:                              # %for.cond2038.preheader.us.preheader
	ldptr.d	$a1, $a4, 6528
	move	$a2, $zero
	slli.d	$a3, $a3, 3
	b	.LBB8_143
	.p2align	4, , 16
.LBB8_142:                              # %for.cond2038.for.inc2139_crit_edge.us
                                        #   in Loop: Header=BB8_143 Depth=1
	addi.d	$a2, $a2, 1
	beq	$a2, $t3, .LBB8_174
.LBB8_143:                              # %for.cond2038.preheader.us
                                        # =>This Loop Header: Depth=1
	...
	b	.LBB8_148
	.p2align	4, , 16
.LBB8_144:                              # %land.lhs.true2060.us
                                        #   in Loop: Header=BB8_148 Depth=2
	beqz	$t1, .LBB8_151
.LBB8_145:                              # %if.then2068.us
                                        #   in Loop: Header=BB8_148 Depth=2
	ld.d	$a0, $sp, 88                    # 8-byte Folded Reload
	ld.d	$a0, $a0, 16
	ld.d	$t0, $a0, 0
	...
	ld.h	$t0, $a0, 2
	slli.d	$t0, $t0, 1
.LBB8_146:                              # %for.inc2136.us
                                        #   in Loop: Header=BB8_148 Depth=2
	st.h	$t0, $a0, 2
.LBB8_147:                              # %for.inc2136.us
                                        #   in Loop: Header=BB8_148 Depth=2
	addi.d	$a6, $a6, 8
	addi.d	$a5, $a5, 1
	beq	$a3, $a6, .LBB8_142
.LBB8_148:                              # %for.body2043.us
                                        #   Parent Loop BB8_143 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.bu	$t1, $a5, 0
	beqz	$a7, .LBB8_144
# %bb.149:                              # %land.lhs.true2046.us
                                        #   in Loop: Header=BB8_148 Depth=2
	beqz	$t2, .LBB8_153
# %bb.150:                              # %land.lhs.true2092.us
                                        #   in Loop: Header=BB8_148 Depth=2
	bnez	$t1, .LBB8_147
	b	.LBB8_152
.LBB8_151:                              # %if.else2089.us
                                        #   in Loop: Header=BB8_148 Depth=2
	beqz	$t2, .LBB8_147
.LBB8_152:                              # %if.then2099.us
                                        #   in Loop: Header=BB8_148 Depth=2
	ld.d	$a0, $sp, 88                    # 8-byte Folded Reload
	ld.d	$a0, $a0, 16
	ld.d	$t0, $a0, 0
	...
	srli.d	$t0, $t0, 1
	b	.LBB8_146
.LBB8_153:                              # %land.lhs.true2049.us
                                        #   in Loop: Header=BB8_148 Depth=2
	bnez	$t1, .LBB8_145
	b	.LBB8_147
.LBB8_154:                              # %for.cond1532.preheader
	ori	$a1, $zero, 1
	ld.d	$t2, $sp, 8                     # 8-byte Folded Reload
	blt	$t3, $a1, .LBB8_174
# %bb.155:                              # %for.body1537.lr.ph
	ldptr.w	$a0, $a4, 6392
	srai.d	$t1, $a0, 2
	blt	$t1, $a1, .LBB8_140
# %bb.156:                              # %for.body1537.lr.ph.split.us
	move	$a1, $zero
	ldptr.d	$a0, $a4, 6528
	st.d	$a0, $sp, 56                    # 8-byte Folded Spill
	lu12i.w	$a0, 262143
	...
	b	.LBB8_158
	.p2align	4, , 16
.LBB8_157:                              # %for.cond1542.for.inc1832_crit_edge.us
                                        #   in Loop: Header=BB8_158 Depth=1
	ld.d	$a1, $sp, 64                    # 8-byte Folded Reload
	addi.d	$a1, $a1, 1
	ld.d	$t3, $sp, 72                    # 8-byte Folded Reload
	beq	$a1, $t3, .LBB8_139
.LBB8_158:                              # %for.body1537.us
                                        # =>This Loop Header: Depth=1
	...
	b	.LBB8_162
	.p2align	4, , 16
.LBB8_159:                              # %if.else1798.us
                                        #   in Loop: Header=BB8_162 Depth=2
	ld.d	$a0, $sp, 88                    # 8-byte Folded Reload
	ld.d	$a0, $a0, 16
	ld.d	$a1, $a0, 0
	ldx.d	$a1, $a1, $s5
	...
	move	$t2, $zero
	st.h	$zero, $a1, 0
.LBB8_160:                              # %for.inc1829.us.sink.split
                                        #   in Loop: Header=BB8_162 Depth=2
	st.h	$t2, $a1, 2
.LBB8_161:                              # %for.inc1829.us
                                        #   in Loop: Header=BB8_162 Depth=2
	addi.d	$s2, $s2, 1
	beq	$s2, $t1, .LBB8_157
.LBB8_162:                              # %for.body1547.us
                                        #   Parent Loop BB8_158 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB8_166 Depth 3
	ldx.bu	$a0, $s6, $s2
	beqz	$a0, .LBB8_161
# %bb.163:                              # %if.then1554.us
                                        #   in Loop: Header=BB8_162 Depth=2
	ldptr.d	$a0, $a4, 6504
	ld.d	$a0, $a0, 0
	ldx.d	$a0, $a0, $s8
	...
	ldx.d	$t6, $a0, $ra
	beq	$t6, $t8, .LBB8_159
# %bb.164:                              # %for.cond1580.preheader.us
                                        #   in Loop: Header=BB8_162 Depth=2
	ld.d	$a0, $sp, 80                    # 8-byte Folded Reload
	ldptr.w	$a0, $a0, 14456
	slt	$a2, $a0, $t3
	...
	ori	$t5, $zero, 256
	blt	$t4, $t7, .LBB8_168
# %bb.165:                              # %for.body1585.us.preheader
                                        #   in Loop: Header=BB8_162 Depth=2
	move	$t3, $zero
	slli.d	$t4, $t4, 2
	move	$fp, $s7
	.p2align	4, , 16
.LBB8_166:                              # %for.body1585.us
                                        #   Parent Loop BB8_158 Depth=1
                                        #     Parent Loop BB8_162 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$a0, $fp, 0
	beq	$a0, $t6, .LBB8_169
# %bb.167:                              # %for.cond1580.us
                                        #   in Loop: Header=BB8_166 Depth=3
	addi.d	$t3, $t3, 4
	addi.d	$fp, $fp, 8
	bne	$t4, $t3, .LBB8_166
...
.LBB8_170:                              # %for.end1614.us
	...
	slli.d	$t4, $s3, 3
	bgeu	$a0, $a5, .LBB8_172
# %bb.171:                              # %if.then1627.us
                                        #   in Loop: Header=BB8_162 Depth=2
	ldptr.d	$a0, $fp, 6512
	b	.LBB8_173
.LBB8_172:                              # %if.else1712.us
                                        #   in Loop: Header=BB8_162 Depth=2
	ldptr.d	$a0, $t3, 6512
...
.LBB9_84:                               # %if.end303.thread.i
	...
	ld.d	$t6, $sp, 320                   # 8-byte Folded Reload
	b	.LBB9_86
.LBB9_85:                               # %if.end303.if.then305_crit_edge.i
	ld.d	$t2, $sp, 296                   # 8-byte Folded Reload
	add.d	$a5, $t2, $a5
	slli.d	$a5, $a5, 3
	ldx.d	$a5, $t1, $a5
	ld.d	$t5, $sp, 312                   # 8-byte Folded Reload
.LBB9_86:                               # %if.then305.i
	ldx.d	$a5, $a5, $t0
	ld.h	$t0, $a5, 0
	alsl.d	$t1, $a1, $a4, 4
	slli.d	$t2, $a1, 4
...
.LBB9_149:                              # %do.body
	...
	b	.LBB9_153
.LBB9_150:                              # %if.then815
                                        #   in Loop: Header=BB9_153 Depth=3
...
# %bb.163:                              #   in Loop: Header=BB9_153 Depth=3
	...
	b	.LBB9_151
	.p2align	4, , 16
.LBB9_164:                              # %lor.lhs.false835
                                        #   in Loop: Header=BB9_149 Depth=2
	ld.d	$a0, $sp, 256                   # 8-byte Folded Reload
	bne	$a0, $fp, .LBB9_166
# %bb.165:                              # %lor.lhs.false835
                                        #   in Loop: Header=BB9_149 Depth=2
	ld.d	$a0, $sp, 248                   # 8-byte Folded Reload
	beq	$a0, $s2, .LBB9_148
.LBB9_166:                              # %if.else846
...
.LBB9_167:                              # %do.end859
	...
	ld.d	$a0, $sp, 216                   # 8-byte Folded Reload
	blt	$a0, $s7, .LBB9_172
# %bb.168:                              # %land.lhs.true863
                                        #   in Loop: Header=BB9_146 Depth=1
	ld.d	$a0, $sp, 208                   # 8-byte Folded Reload
	ld.d	$a0, $a0, 0
	ld.w	$a0, $a0, 24
	bnez	$a0, .LBB9_172
# %bb.169:                              # %land.lhs.true867
                                        #   in Loop: Header=BB9_146 Depth=1
...
.LBB9_181:
	...
	slli.d	$a0, $s7, 2
	beqz	$s6, .LBB9_183
.LBB9_182:                              # %lor.lhs.false996
	ldx.w	$a1, $a5, $a0
	bge	$t3, $a1, .LBB9_184
.LBB9_183:                              # %if.then1001
	stx.w	$t3, $a5, $a0
.LBB9_184:                              # %if.end1004
	ld.d	$a0, $sp, 200                   # 8-byte Folded Reload
	ld.d	$a0, $a0, 0
