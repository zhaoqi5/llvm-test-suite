...
# %bb.13:                               # %if.then.i110
	...
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 48                    # 8-byte Folded Reload
	ld.wu	$s6, $a0, %pc_lo12(mv_rescale)
	ori	$a0, $zero, 8
	srl.w	$s1, $a0, $s6
	ori	$a0, $zero, 4
	srl.w	$s3, $a0, $s6
...
# %bb.10:                               # %middle.block
	...
	move	$a1, $s5
	beq	$s5, $s1, .LBB8_5
.LBB8_11:                               # %for.body9.us.preheader
                                        #   in Loop: Header=BB8_6 Depth=2
	ld.d	$a2, $s4, 0
	ldx.d	$a3, $a2, $ra
	ld.w	$ra, $a3, 4
...
# %bb.19:                               # %if.then88
	...
	ld.d	$a4, $a2, %got_pc_lo12(listXsize)
	ldx.w	$a0, $a4, $a0
	ori	$a2, $zero, 2
	move	$a6, $a3
	blt	$a0, $a2, .LBB8_21
...
.LBB8_21:                               # %if.end103
	...
	bltz	$t0, .LBB8_38
# %bb.22:                               # %for.cond132.preheader.lr.ph
	slli.w	$t1, $t0, 2
...
.LBB8_48:                               # %if.end898
	...
	or	$a0, $a0, $a1
	beqz	$a0, .LBB8_86
# %bb.49:                               # %for.cond904.preheader
	ldptr.w	$a1, $a3, 6396
	ori	$a0, $zero, 8
	blt	$a1, $a0, .LBB8_86
# %bb.50:                               # %for.cond910.preheader.lr.ph
	ldptr.w	$a5, $a3, 6392
	ori	$a0, $zero, 4
	blt	$a5, $a0, .LBB8_86
# %bb.51:                               # %for.cond910.preheader.us.preheader
	...
	b	.LBB8_53
	.p2align	4, , 16
.LBB8_52:                               # %for.cond910.for.inc1522_crit_edge.us
                                        #   in Loop: Header=BB8_53 Depth=1
	ld.d	$t0, $sp, 40                    # 8-byte Folded Reload
	addi.d	$t0, $t0, 1
	ld.d	$a0, $sp, 32                    # 8-byte Folded Reload
	beq	$t0, $a0, .LBB8_86
.LBB8_53:                               # %for.cond910.preheader.us
                                        # =>This Loop Header: Depth=1
	...
	beqz	$a7, .LBB8_64
# %bb.54:                               # %for.body915.lr.ph.split.us.us
                                        #   in Loop: Header=BB8_53 Depth=1
	ldptr.d	$a0, $a3, 6504
	ld.d	$a0, $a0, 0
	ldx.d	$a5, $a0, $t6
...
.LBB8_56:                               # %for.body915.us.us
	...
	ldx.d	$s2, $a0, $t8
	beq	$s2, $ra, .LBB8_55
# %bb.57:                               # %for.cond944.preheader.us.us
                                        #   in Loop: Header=BB8_56 Depth=2
	ld.d	$a0, $sp, 80                    # 8-byte Folded Reload
	ldptr.w	$a0, $a0, 14456
	slt	$a2, $a0, $t2
	...
	ori	$t2, $zero, 256
	blez	$t0, .LBB8_61
# %bb.58:                               # %for.body949.us.us.preheader
                                        #   in Loop: Header=BB8_56 Depth=2
	move	$s3, $zero
	slli.d	$t4, $t0, 2
	move	$t0, $t7
	.p2align	4, , 16
.LBB8_59:                               # %for.body949.us.us
                                        #   Parent Loop BB8_53 Depth=1
                                        #     Parent Loop BB8_56 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$a0, $t0, 0
	beq	$a0, $s2, .LBB8_62
# %bb.60:                               # %for.cond944.us.us
                                        #   in Loop: Header=BB8_59 Depth=3
	addi.d	$s3, $s3, 4
	addi.d	$t0, $t0, 8
	bne	$t4, $s3, .LBB8_59
...
.LBB8_63:                               # %for.end978.us.us
	...
	b	.LBB8_52
	.p2align	4, , 16
.LBB8_64:                               # %for.body915.lr.ph.split.us1035
                                        #   in Loop: Header=BB8_53 Depth=1
	ldptr.d	$a0, $t1, 6504
	ld.w	$t7, $a4, 16
...
.LBB8_65:                               # %if.then1482.us
	...
	srli.d	$a0, $a0, 1
	st.h	$a0, $a5, 2
.LBB8_66:                               # %for.inc1519.us1031
                                        #   in Loop: Header=BB8_67 Depth=2
	addi.d	$s4, $s4, 1
	beq	$s4, $s0, .LBB8_52
.LBB8_67:                               # %for.body915.us1029
                                        #   Parent Loop BB8_53 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB8_70 Depth 3
                                        #       Child Loop BB8_80 Depth 3
	...
	ldx.d	$s7, $a0, $a5
	beq	$s7, $ra, .LBB8_73
# %bb.68:                               # %for.cond1115.preheader.us
                                        #   in Loop: Header=BB8_67 Depth=2
	ld.d	$a0, $sp, 80                    # 8-byte Folded Reload
	ldx.w	$a0, $a0, $t5
	slli.w	$a0, $a0, 1
	...
	ori	$t2, $zero, 256
	blez	$t0, .LBB8_72
# %bb.69:                               # %for.body1121.us.preheader
                                        #   in Loop: Header=BB8_67 Depth=2
	move	$t3, $zero
	slli.d	$t4, $t0, 2
	ld.d	$t0, $sp, 56                    # 8-byte Folded Reload
	.p2align	4, , 16
.LBB8_70:                               # %for.body1121.us
                                        #   Parent Loop BB8_53 Depth=1
                                        #     Parent Loop BB8_67 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$a0, $t0, 0
	beq	$a0, $s7, .LBB8_74
# %bb.71:                               # %for.cond1115.us
                                        #   in Loop: Header=BB8_70 Depth=3
	addi.d	$t3, $t3, 4
	addi.d	$t0, $t0, 8
	bne	$t4, $t3, .LBB8_70
.LBB8_72:                               #   in Loop: Header=BB8_67 Depth=2
	move	$s7, $zero
	b	.LBB8_75
	.p2align	4, , 16
.LBB8_73:                               # %if.else1230.us
                                        #   in Loop: Header=BB8_67 Depth=2
	ld.d	$a0, $sp, 88                    # 8-byte Folded Reload
	ld.d	$a0, $a0, 32
	ld.d	$a1, $a0, 0
...
.LBB8_77:                               # %if.end1304.us
	...
	ldx.d	$s7, $a0, $a5
	beq	$s7, $ra, .LBB8_83
# %bb.78:                               # %for.cond1330.preheader.us
                                        #   in Loop: Header=BB8_67 Depth=2
	ld.d	$a0, $sp, 80                    # 8-byte Folded Reload
	ldx.w	$a0, $a0, $t5
	slli.w	$a0, $a0, 1
	...
	ori	$t2, $zero, 256
	blez	$t0, .LBB8_82
# %bb.79:                               # %for.body1336.us.preheader
                                        #   in Loop: Header=BB8_67 Depth=2
	move	$t3, $zero
	slli.d	$t4, $t0, 2
	ld.d	$t0, $sp, 48                    # 8-byte Folded Reload
	.p2align	4, , 16
.LBB8_80:                               # %for.body1336.us
                                        #   Parent Loop BB8_53 Depth=1
                                        #     Parent Loop BB8_67 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$a0, $t0, 0
	beq	$a0, $s7, .LBB8_84
# %bb.81:                               # %for.cond1330.us
                                        #   in Loop: Header=BB8_80 Depth=3
	addi.d	$t3, $t3, 4
	addi.d	$t0, $t0, 8
	bne	$t4, $t3, .LBB8_80
.LBB8_82:                               #   in Loop: Header=BB8_67 Depth=2
	move	$s7, $zero
	b	.LBB8_85
	.p2align	4, , 16
.LBB8_83:                               # %if.else1445.us
                                        #   in Loop: Header=BB8_67 Depth=2
	ld.d	$a0, $sp, 88                    # 8-byte Folded Reload
	ld.d	$a0, $a0, 24
	ld.d	$a1, $a0, 0
...
.LBB8_86:                               # %if.end1525
	...
	beqz	$a0, .LBB8_136
# %bb.87:                               # %for.cond1840.preheader
	blez	$t3, .LBB8_172
# %bb.88:                               # %for.cond1846.preheader.lr.ph
	ldptr.w	$a0, $a3, 6392
	srai.d	$a5, $a0, 2
	blez	$a5, .LBB8_172
# %bb.89:                               # %for.cond1846.preheader.lr.ph.split.us
	ldptr.d	$a0, $a3, 6504
	ld.d	$a7, $a0, 0
	addi.d	$t1, $sp, 1020
	pcalau12i	$a0, %got_pc_hi20(enc_picture)
	ld.d	$t2, $a0, %got_pc_lo12(enc_picture)
	move	$t3, $zero
	ori	$t4, $zero, 1
	addi.w	$t5, $zero, -1
	addi.d	$t6, $sp, 96
	...
	b	.LBB8_91
	.p2align	4, , 16
.LBB8_90:                               # %for.cond1846.for.inc2025_crit_edge.us
                                        #   in Loop: Header=BB8_91 Depth=1
	addi.d	$t3, $t3, 1
	ld.d	$a0, $sp, 72                    # 8-byte Folded Reload
	beq	$t3, $a0, .LBB8_172
.LBB8_91:                               # %for.cond1846.preheader.us
                                        # =>This Loop Header: Depth=1
...
.LBB8_93:                               # %for.body1851.us
	...
	ldx.d	$s6, $a0, $s3
	beq	$s6, $t5, .LBB8_92
# %bb.94:                               # %for.cond1877.preheader.us
                                        #   in Loop: Header=BB8_93 Depth=2
	ld.d	$a0, $sp, 80                    # 8-byte Folded Reload
	ldptr.w	$a0, $a0, 14456
	slt	$a2, $a0, $s4
	...
	ori	$s4, $zero, 256
	blez	$s8, .LBB8_98
# %bb.95:                               # %for.body1882.us.preheader
                                        #   in Loop: Header=BB8_93 Depth=2
	move	$s7, $zero
	slli.d	$s8, $s8, 2
	move	$ra, $s2
	.p2align	4, , 16
.LBB8_96:                               # %for.body1882.us
                                        #   Parent Loop BB8_91 Depth=1
                                        #     Parent Loop BB8_93 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$a0, $ra, 0
	beq	$a0, $s6, .LBB8_99
# %bb.97:                               # %for.cond1877.us
                                        #   in Loop: Header=BB8_96 Depth=3
	addi.d	$s7, $s7, 4
	addi.d	$ra, $ra, 8
	bne	$s8, $s7, .LBB8_96
...
.LBB8_100:                              # %for.end1911.us
	...
	bne	$s1, $a5, .LBB8_93
	b	.LBB8_90
.LBB8_101:                              # %for.cond347.preheader
	ldptr.w	$a0, $a3, 6396
	srai.d	$a0, $a0, 2
	st.d	$a0, $sp, 56                    # 8-byte Folded Spill
	blez	$a0, .LBB8_48
# %bb.102:                              # %for.body349.lr.ph
	ldptr.w	$a0, $a3, 6392
	srai.d	$t4, $a0, 2
	blez	$t4, .LBB8_48
# %bb.103:                              # %for.body349.us.preheader
	lu12i.w	$a0, 262143
	ori	$a0, $a0, 4092
	st.d	$a0, $sp, 48                    # 8-byte Folded Spill
	pcalau12i	$a0, %got_pc_hi20(enc_picture)
	...
	b	.LBB8_105
	.p2align	4, , 16
.LBB8_104:                              # %for.cond355.for.inc895_crit_edge.us
                                        #   in Loop: Header=BB8_105 Depth=1
	addi.d	$fp, $fp, 1
	ld.d	$a0, $sp, 56                    # 8-byte Folded Reload
	beq	$fp, $a0, .LBB8_48
.LBB8_105:                              # %for.body349.us
                                        # =>This Loop Header: Depth=1
...
.LBB8_107:                              # %for.body358.us
	...
	slli.d	$t7, $s5, 3
	bnez	$a7, .LBB8_116
# %bb.108:                              # %land.lhs.true361.us
                                        #   in Loop: Header=BB8_107 Depth=2
	ldptr.d	$a0, $a3, 6528
	ldx.d	$a0, $a0, $t5
	ldx.bu	$a0, $a0, $s5
	beqz	$a0, .LBB8_116
# %bb.109:                              # %if.then367.us
                                        #   in Loop: Header=BB8_107 Depth=2
	ld.w	$a0, $s7, 4
	ld.w	$a1, $t1, 4
	sub.w	$a1, $a0, $a1
	...
	alsl.d	$a1, $s8, $a1, 3
	bgeu	$a0, $a2, .LBB8_122
# %bb.110:                              # %if.then378.us
                                        #   in Loop: Header=BB8_107 Depth=2
	ld.d	$a0, $a1, 0
	ldx.d	$a5, $a0, $t7
	beq	$a5, $s1, .LBB8_106
# %bb.111:                              # %for.cond403.preheader.us
                                        #   in Loop: Header=BB8_107 Depth=2
	ld.w	$a0, $a4, 0
	...
	ori	$a1, $zero, 256
	blez	$t0, .LBB8_115
# %bb.112:                              # %for.body407.us.preheader
                                        #   in Loop: Header=BB8_107 Depth=2
	move	$t8, $zero
	slli.d	$t3, $t0, 2
	move	$t6, $s2
	.p2align	4, , 16
.LBB8_113:                              # %for.body407.us
                                        #   Parent Loop BB8_105 Depth=1
                                        #     Parent Loop BB8_107 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$a0, $t6, 0
	beq	$a0, $a5, .LBB8_130
# %bb.114:                              # %for.cond403.us
                                        #   in Loop: Header=BB8_113 Depth=3
	addi.d	$t8, $t8, 4
	addi.d	$t6, $t6, 8
	bne	$t3, $t8, .LBB8_113
.LBB8_115:                              #   in Loop: Header=BB8_107 Depth=2
	move	$a5, $zero
	b	.LBB8_131
	.p2align	4, , 16
.LBB8_116:                              # %if.else720.us
                                        #   in Loop: Header=BB8_107 Depth=2
	ldptr.d	$a0, $a3, 6504
	ld.d	$a0, $a0, 0
	ldx.d	$a0, $a0, $t5
	...
	ldx.d	$t8, $a0, $t7
	beq	$t8, $s1, .LBB8_106
# %bb.117:                              # %for.cond746.preheader.us
                                        #   in Loop: Header=BB8_107 Depth=2
	ld.d	$a0, $sp, 80                    # 8-byte Folded Reload
	ldptr.w	$a0, $a0, 14456
	slt	$a2, $a0, $a5
	...
	ori	$a5, $zero, 256
	blez	$t0, .LBB8_121
# %bb.118:                              # %for.body751.us.preheader
                                        #   in Loop: Header=BB8_107 Depth=2
	move	$t3, $zero
	slli.d	$t6, $t0, 2
	move	$ra, $s2
	.p2align	4, , 16
.LBB8_119:                              # %for.body751.us
                                        #   Parent Loop BB8_105 Depth=1
                                        #     Parent Loop BB8_107 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$a0, $ra, 0
	beq	$a0, $t8, .LBB8_128
# %bb.120:                              # %for.cond746.us
                                        #   in Loop: Header=BB8_119 Depth=3
	addi.d	$t3, $t3, 4
	addi.d	$ra, $ra, 8
	bne	$t6, $t3, .LBB8_119
.LBB8_121:                              #   in Loop: Header=BB8_107 Depth=2
	move	$a1, $zero
	b	.LBB8_129
.LBB8_122:                              # %if.else545.us
                                        #   in Loop: Header=BB8_107 Depth=2
	ld.d	$a0, $a1, 32
	ldx.d	$a5, $a0, $t7
	beq	$a5, $s1, .LBB8_106
# %bb.123:                              # %for.cond573.preheader.us
                                        #   in Loop: Header=BB8_107 Depth=2
	ld.w	$a0, $a4, 0
	ld.d	$a1, $sp, 80                    # 8-byte Folded Reload
	ldptr.w	$a1, $a1, 14456
	...
	ori	$a1, $zero, 256
	blez	$t0, .LBB8_127
# %bb.124:                              # %for.body578.us.preheader
                                        #   in Loop: Header=BB8_107 Depth=2
	move	$t8, $zero
	slli.d	$t3, $t0, 2
	move	$t6, $s2
	.p2align	4, , 16
.LBB8_125:                              # %for.body578.us
                                        #   Parent Loop BB8_105 Depth=1
                                        #     Parent Loop BB8_107 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$a0, $t6, 0
	beq	$a0, $a5, .LBB8_132
# %bb.126:                              # %for.cond573.us
                                        #   in Loop: Header=BB8_125 Depth=3
	addi.d	$t8, $t8, 4
	addi.d	$t6, $t6, 8
	bne	$t3, $t8, .LBB8_125
.LBB8_127:                              #   in Loop: Header=BB8_107 Depth=2
	move	$a5, $zero
	b	.LBB8_133
.LBB8_128:                              # %if.then764.us
                                        #   in Loop: Header=BB8_107 Depth=2
	addi.d	$a0, $sp, 96
	masknez	$a0, $a0, $a1
	addi.d	$a2, $sp, 888
...
.LBB8_132:                              # %if.then592.us
	...
	or	$a0, $a2, $a0
	ldx.w	$a5, $a0, $t8
.LBB8_133:                              # %for.end608.us
                                        #   in Loop: Header=BB8_107 Depth=2
	masknez	$a0, $t1, $t2
	maskeqz	$a2, $a6, $t2
.LBB8_134:                              # %for.inc892.us
                                        #   in Loop: Header=BB8_107 Depth=2
	or	$a0, $a2, $a0
	ldptr.d	$a0, $a0, 6512
	ld.d	$a0, $a0, 0
...
.LBB8_135:                              # %for.inc892.us
	...
	bne	$s5, $t4, .LBB8_107
	b	.LBB8_104
.LBB8_136:                              # %if.then1528
	ld.d	$a0, $sp, 8                     # 8-byte Folded Reload
	beqz	$a0, .LBB8_152
.LBB8_137:                              # %for.cond2032.preheader
	ld.d	$t2, $sp, 8                     # 8-byte Folded Reload
	blez	$t3, .LBB8_172
.LBB8_138:                              # %for.cond2038.preheader.lr.ph
	ldptr.w	$a0, $a3, 6392
	srai.d	$a4, $a0, 2
	blez	$a4, .LBB8_172
# %bb.139:                              # %for.cond2038.preheader.us.preheader
	ldptr.d	$a1, $a3, 6528
	move	$a2, $zero
	slli.d	$a3, $a4, 3
	b	.LBB8_141
	.p2align	4, , 16
.LBB8_140:                              # %for.cond2038.for.inc2139_crit_edge.us
                                        #   in Loop: Header=BB8_141 Depth=1
	addi.d	$a2, $a2, 1
	beq	$a2, $t3, .LBB8_172
.LBB8_141:                              # %for.cond2038.preheader.us
                                        # =>This Loop Header: Depth=1
	...
	b	.LBB8_146
	.p2align	4, , 16
.LBB8_142:                              # %land.lhs.true2060.us
                                        #   in Loop: Header=BB8_146 Depth=2
	beqz	$t1, .LBB8_149
.LBB8_143:                              # %if.then2068.us
                                        #   in Loop: Header=BB8_146 Depth=2
	ld.d	$a0, $sp, 88                    # 8-byte Folded Reload
	ld.d	$a0, $a0, 16
	ld.d	$t0, $a0, 0
	...
	ld.h	$t0, $a0, 2
	slli.d	$t0, $t0, 1
.LBB8_144:                              # %for.inc2136.us
                                        #   in Loop: Header=BB8_146 Depth=2
	st.h	$t0, $a0, 2
.LBB8_145:                              # %for.inc2136.us
                                        #   in Loop: Header=BB8_146 Depth=2
	addi.d	$a6, $a6, 8
	addi.d	$a5, $a5, 1
	beq	$a3, $a6, .LBB8_140
.LBB8_146:                              # %for.body2043.us
                                        #   Parent Loop BB8_141 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.bu	$t1, $a5, 0
	beqz	$a7, .LBB8_142
# %bb.147:                              # %land.lhs.true2046.us
                                        #   in Loop: Header=BB8_146 Depth=2
	beqz	$t2, .LBB8_151
# %bb.148:                              # %land.lhs.true2092.us
                                        #   in Loop: Header=BB8_146 Depth=2
	bnez	$t1, .LBB8_145
	b	.LBB8_150
.LBB8_149:                              # %if.else2089.us
                                        #   in Loop: Header=BB8_146 Depth=2
	beqz	$t2, .LBB8_145
.LBB8_150:                              # %if.then2099.us
                                        #   in Loop: Header=BB8_146 Depth=2
	ld.d	$a0, $sp, 88                    # 8-byte Folded Reload
	ld.d	$a0, $a0, 16
	ld.d	$t0, $a0, 0
	...
	srli.d	$t0, $t0, 1
	b	.LBB8_144
.LBB8_151:                              # %land.lhs.true2049.us
                                        #   in Loop: Header=BB8_146 Depth=2
	bnez	$t1, .LBB8_143
	b	.LBB8_145
.LBB8_152:                              # %for.cond1532.preheader
	ld.d	$t2, $sp, 8                     # 8-byte Folded Reload
	blez	$t3, .LBB8_172
# %bb.153:                              # %for.body1537.lr.ph
	ldptr.w	$a0, $a3, 6392
	srai.d	$a5, $a0, 2
	blez	$a5, .LBB8_138
# %bb.154:                              # %for.body1537.lr.ph.split.us
	ldptr.d	$a0, $a3, 6528
	st.d	$a0, $sp, 64                    # 8-byte Folded Spill
	lu12i.w	$a0, 262143
	ori	$a0, $a0, 4092
	...
	b	.LBB8_156
	.p2align	4, , 16
.LBB8_155:                              # %for.cond1542.for.inc1832_crit_edge.us
                                        #   in Loop: Header=BB8_156 Depth=1
	addi.d	$t6, $t6, 1
	ld.d	$t3, $sp, 72                    # 8-byte Folded Reload
	beq	$t6, $t3, .LBB8_137
.LBB8_156:                              # %for.body1537.us
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB8_160 Depth 2
                                        #       Child Loop BB8_164 Depth 3
	move	$s2, $zero
	...
	b	.LBB8_160
	.p2align	4, , 16
.LBB8_157:                              # %if.else1798.us
                                        #   in Loop: Header=BB8_160 Depth=2
	ld.d	$a0, $sp, 88                    # 8-byte Folded Reload
	ld.d	$a0, $a0, 16
	ld.d	$a1, $a0, 0
	ldx.d	$a1, $a1, $s5
	...
	move	$t1, $zero
	st.h	$zero, $a1, 0
.LBB8_158:                              # %for.inc1829.us.sink.split
                                        #   in Loop: Header=BB8_160 Depth=2
	st.h	$t1, $a1, 2
.LBB8_159:                              # %for.inc1829.us
                                        #   in Loop: Header=BB8_160 Depth=2
	addi.d	$s2, $s2, 1
	beq	$s2, $a5, .LBB8_155
.LBB8_160:                              # %for.body1547.us
                                        #   Parent Loop BB8_156 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB8_164 Depth 3
	ldx.bu	$a0, $s6, $s2
	beqz	$a0, .LBB8_159
# %bb.161:                              # %if.then1554.us
                                        #   in Loop: Header=BB8_160 Depth=2
	ldptr.d	$a0, $a3, 6504
	ld.d	$a0, $a0, 0
	ldx.d	$a0, $a0, $s8
	...
	ldx.d	$t5, $a0, $ra
	beq	$t5, $t8, .LBB8_157
# %bb.162:                              # %for.cond1580.preheader.us
                                        #   in Loop: Header=BB8_160 Depth=2
	ld.d	$a0, $sp, 80                    # 8-byte Folded Reload
	ldptr.w	$a0, $a0, 14456
	slt	$a2, $a0, $t2
	...
	ori	$t3, $zero, 256
	blez	$t4, .LBB8_166
# %bb.163:                              # %for.body1585.us.preheader
                                        #   in Loop: Header=BB8_160 Depth=2
	move	$t2, $zero
	slli.d	$t4, $t4, 2
	addi.d	$fp, $s4, 24
	.p2align	4, , 16
.LBB8_164:                              # %for.body1585.us
                                        #   Parent Loop BB8_156 Depth=1
                                        #     Parent Loop BB8_160 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$a0, $fp, 0
	beq	$a0, $t5, .LBB8_167
# %bb.165:                              # %for.cond1580.us
                                        #   in Loop: Header=BB8_164 Depth=3
	addi.d	$t2, $t2, 4
	addi.d	$fp, $fp, 8
	bne	$t4, $t2, .LBB8_164
.LBB8_166:                              #   in Loop: Header=BB8_160 Depth=2
	move	$t1, $zero
	b	.LBB8_168
.LBB8_167:                              # %if.then1598.us
                                        #   in Loop: Header=BB8_160 Depth=2
	addi.d	$a0, $sp, 96
	masknez	$a0, $a0, $t1
	addi.d	$a2, $sp, 888
...
.LBB8_168:                              # %for.end1614.us
	...
	slli.d	$t4, $s3, 3
	bgeu	$a0, $s7, .LBB8_170
# %bb.169:                              # %if.then1627.us
                                        #   in Loop: Header=BB8_160 Depth=2
	ldptr.d	$a0, $fp, 6512
	b	.LBB8_171
.LBB8_170:                              # %if.else1712.us
                                        #   in Loop: Header=BB8_160 Depth=2
	ldptr.d	$a0, $t2, 6512
.LBB8_171:                              # %for.inc1829.us.sink.split
                                        #   in Loop: Header=BB8_160 Depth=2
	ld.d	$a0, $a0, 0
	ldx.d	$a0, $a0, $t4
	ldx.d	$a0, $a0, $ra
