...
.LBB5_2:                                # %if.else
	...
	addi.d	$a2, $a2, %pc_lo12(Offset_intra_default_chroma)
	vld	$vr0, $a2, 16
	vst	$vr0, $a0, 16
	vld	$vr0, $a2, 0
	vst	$vr0, $a0, 0
	...
	ld.d	$a0, $a1, %pc_lo12(OffsetList4x4)
	ld.d	$a2, $a0, 24
	pcalau12i	$a0, %pc_hi20(Offset_inter_default)
	addi.d	$a0, $a0, %pc_lo12(Offset_inter_default)
	vld	$vr0, $a0, 16
	vst	$vr0, $a2, 16
	vld	$vr0, $a0, 0
	vst	$vr0, $a2, 0
	...
	vld	$vr0, $a0, 16
	vst	$vr0, $a2, 16
	ld.d	$a1, $a1, %pc_lo12(OffsetList4x4)
	ld.d	$a1, $a1, 112
	vld	$vr0, $a0, 0
	vst	$vr0, $a1, 0
	vld	$vr0, $a0, 16
...
.LBB6_4:                                # %cond.end6
	...
	ori	$a5, $a4, 1568
	ldx.w	$a5, $a1, $a5
	pcalau12i	$a6, %pc_hi20(AdaptRndWeight)
	st.w	$a5, $a6, %pc_lo12(AdaptRndWeight)
	ori	$a4, $a4, 1608
	ldx.w	$a4, $a1, $a4
	pcalau12i	$a5, %pc_hi20(AdaptRndCrWeight)
	slt	$a1, $a2, $a3
	masknez	$a2, $a2, $a1
	maskeqz	$a1, $a3, $a1
	or	$a1, $a1, $a2
	st.w	$a4, $a5, %pc_lo12(AdaptRndCrWeight)
	bltz	$a1, .LBB6_17
