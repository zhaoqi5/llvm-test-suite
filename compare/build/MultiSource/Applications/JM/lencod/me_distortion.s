...
# %bb.12:                               # %if.then38.split.us
	...
	sra.w	$s4, $s4, $a1
	blez	$s4, .LBB5_38
# %bb.13:                               # %for.body44.us.us.preheader
	st.d	$s2, $sp, 32                    # 8-byte Folded Spill
	ld.w	$a1, $s6, %pc_lo12(ref_access_method)
	sub.w	$s1, $a0, $s4
	addi.d	$a0, $s3, 512
	...
	ori	$a6, $zero, 1
	.p2align	4, , 16
.LBB5_14:                               # %for.cond56.preheader.us.us.us
                                        # =>This Loop Header: Depth=1
...
# %bb.18:                               # %middle.block
	...
	move	$a7, $a5
	beq	$a5, $s4, .LBB5_21
.LBB5_19:                               # %for.body59.us.us.us.preheader
                                        #   in Loop: Header=BB5_14 Depth=1
	sub.d	$a0, $s4, $a7
	.p2align	4, , 16
.LBB5_20:                               # %for.body59.us.us.us
                                        #   Parent Loop BB5_14 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a7, $a1, 0
	ld.hu	$t0, $a2, 0
	...
	add.w	$fp, $a7, $t0
	bnez	$a0, .LBB5_20
.LBB5_21:                               # %for.cond56.for.end78_crit_edge.us.us.us
                                        #   in Loop: Header=BB5_14 Depth=1
	bge	$fp, $s0, .LBB5_36
# %bb.22:                               # %if.end82.us.us.us
                                        #   in Loop: Header=BB5_14 Depth=1
	addi.w	$a3, $a3, 1
	alsl.d	$a0, $s1, $a2, 1
	move	$t0, $a1
	bne	$a3, $s5, .LBB5_14
# %bb.23:                               # %for.cond52.for.inc88_crit_edge.split.us.us.us
	ld.w	$a1, $s6, %pc_lo12(ref_access_method)
	slli.d	$a1, $a1, 3
	...
	ori	$a7, $zero, 1
	.p2align	4, , 16
.LBB5_24:                               # %for.cond56.preheader.us.us.us.1
                                        # =>This Loop Header: Depth=1
...
.LBB5_27:                               # %vector.body170
	...
	addi.d	$a0, $a0, 8
	bnez	$t2, .LBB5_27
# %bb.28:                               # %middle.block181
                                        #   in Loop: Header=BB5_24 Depth=1
	add.w	$fp, $t0, $fp
	move	$t0, $a6
	beq	$a6, $a5, .LBB5_31
.LBB5_29:                               # %for.body59.us.us.us.1.preheader
                                        #   in Loop: Header=BB5_24 Depth=1
	sub.d	$a0, $s4, $t0
	.p2align	4, , 16
.LBB5_30:                               # %for.body59.us.us.us.1
                                        #   Parent Loop BB5_24 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$t0, $a1, 0
	ld.hu	$t1, $a2, 0
	...
	add.w	$fp, $t0, $t1
	bnez	$a0, .LBB5_30
.LBB5_31:                               # %for.cond56.for.end78_crit_edge.us.us.us.1
                                        #   in Loop: Header=BB5_24 Depth=1
	bge	$fp, $s0, .LBB5_36
# %bb.32:                               # %if.end82.us.us.us.1
                                        #   in Loop: Header=BB5_24 Depth=1
	addi.w	$a3, $a3, 1
	alsl.d	$a0, $s1, $a2, 1
	move	$t1, $a1
	bne	$a3, $s5, .LBB5_24
# %bb.33:                               # %for.cond52.for.inc88_crit_edge.split.us.us.us.1
	ld.d	$a2, $sp, 32                    # 8-byte Folded Reload
	st.d	$a0, $a2, %pc_lo12(ref_line)
	b	.LBB5_37
.LBB5_34:                               # %cleanup95.loopexit29.split.us
	st.d	$a6, $s2, %pc_lo12(ref_line)
	st.d	$a5, $s7, %pc_lo12(src_line)
	b	.LBB5_43
.LBB5_35:                               # %for.body44.preheader
	...
	move	$a2, $s1
	b	.LBB5_41
.LBB5_36:                               # %cleanup95.loopexit.split.us
	ld.d	$a0, $sp, 32                    # 8-byte Folded Reload
	st.d	$a2, $a0, %pc_lo12(ref_line)
.LBB5_37:                               # %cleanup95
	st.d	$a1, $s7, %pc_lo12(src_line)
	b	.LBB5_43
.LBB5_38:                               # %if.then38.split.us.split
	bge	$fp, $s0, .LBB5_40
# %bb.39:                               # %for.body44.us.us98.preheader
	slli.d	$a1, $a0, 1
	slli.d	$a2, $s4, 1
	sub.d	$a1, $a1, $a2
	addi.w	$a3, $s5, -1
...
.LBB6_6:                                # %vector.body
	...
	vpickve2gr.w	$s7, $vr8, 3
	vinsgr2vr.d	$vr9, $s7, 1
	xvpermi.q	$xr9, $xr9, 2
	vpickve2gr.w	$s7, $vr8, 0
	vinsgr2vr.d	$vr10, $s7, 0
...
.LBB6_21:                               # %vector.body198
	...
	xvpermi.q	$xr10, $xr10, 2
	vpickve2gr.w	$t7, $vr9, 0
	vinsgr2vr.d	$vr11, $t7, 0
	vpickve2gr.w	$t7, $vr9, 1
...
.LBB8_6:                                # %vector.body
	...
	vsub.w	$vr9, $vr12, $vr9
	vpickve2gr.w	$s3, $vr10, 2
	vinsgr2vr.d	$vr11, $s3, 0
	vpickve2gr.w	$s3, $vr10, 3
	vinsgr2vr.d	$vr11, $s3, 1
	xvpermi.q	$xr11, $xr11, 2
	vpickve2gr.w	$s3, $vr10, 0
	vinsgr2vr.d	$vr12, $s3, 0
	vpickve2gr.w	$s3, $vr10, 1
	...
	vpickve2gr.w	$s3, $vr9, 2
	vinsgr2vr.d	$vr10, $s3, 0
	vpickve2gr.w	$s3, $vr9, 3
	vinsgr2vr.d	$vr10, $s3, 1
	xvpermi.q	$xr10, $xr10, 2
	vpickve2gr.w	$s3, $vr9, 0
	vinsgr2vr.d	$vr11, $s3, 0
	vpickve2gr.w	$s3, $vr9, 1
	vinsgr2vr.d	$vr11, $s3, 1
	xvpickve2gr.d	$s3, $xr11, 0
	xvpickve2gr.d	$s7, $xr11, 1
	xvpickve2gr.d	$s8, $xr10, 2
	xvpickve2gr.d	$ra, $xr10, 3
	slli.d	$t0, $t0, 2
	slli.d	$t2, $t2, 2
	slli.d	$t4, $t4, 2
...
.LBB8_21:                               # %vector.body272
	...
	vinsgr2vr.d	$vr11, $t8, 1
	xvpermi.q	$xr11, $xr11, 2
	vpickve2gr.w	$t8, $vr10, 0
	vinsgr2vr.d	$vr12, $t8, 0
	vpickve2gr.w	$t8, $vr10, 1
	...
	xvpermi.q	$xr10, $xr10, 2
	vpickve2gr.w	$s8, $vr9, 0
	vinsgr2vr.d	$vr11, $s8, 0
	vpickve2gr.w	$s8, $vr9, 1
	vinsgr2vr.d	$vr11, $s8, 1
	xvpickve2gr.d	$s8, $xr11, 0
...
# %bb.12:                               # %for.cond2.preheader.us.preheader
	...
	st.d	$a0, $sp, 24                    # 8-byte Folded Spill
	st.d	$a4, $sp, 16                    # 8-byte Folded Spill
.LBB10_13:                              # %for.cond2.preheader.us
                                        # =>This Loop Header: Depth=1
...
# %bb.15:                               # %for.cond2.us
	...
	addi.d	$s1, $s1, 8
	blt	$s0, $s2, .LBB10_14
# %bb.16:                               # %for.cond2.for.end65_crit_edge.us
...
# %bb.10:                               # %if.then38.split.us
	...
	sra.w	$s4, $s4, $a1
	blez	$s4, .LBB13_38
# %bb.11:                               # %for.body44.us.us.preheader
	st.d	$s3, $sp, 24                    # 8-byte Folded Spill
	ld.w	$a1, $s1, %pc_lo12(ref_access_method)
	sub.w	$s2, $a0, $s4
	ld.d	$a0, $sp, 32                    # 8-byte Folded Reload
	...
	ori	$a5, $zero, 1
	.p2align	4, , 16
.LBB13_12:                              # %for.cond56.preheader.us.us.us
                                        # =>This Loop Header: Depth=1
...
# %bb.16:                               # %middle.block
	...
	move	$a6, $a4
	beq	$a4, $s4, .LBB13_19
.LBB13_17:                              # %for.body59.us.us.us.preheader
                                        #   in Loop: Header=BB13_12 Depth=1
	sub.d	$a0, $s4, $a6
	.p2align	4, , 16
.LBB13_18:                              # %for.body59.us.us.us
                                        #   Parent Loop BB13_12 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a1, 0
	ld.hu	$a7, $a2, 0
	...
	add.w	$fp, $a6, $a7
	bnez	$a0, .LBB13_18
.LBB13_19:                              # %for.cond56.for.end78_crit_edge.us.us.us
                                        #   in Loop: Header=BB13_12 Depth=1
	bge	$fp, $s0, .LBB13_36
# %bb.20:                               # %if.end82.us.us.us
                                        #   in Loop: Header=BB13_12 Depth=1
	addi.w	$a3, $a3, 1
	alsl.d	$a0, $s2, $a2, 1
	move	$a7, $a1
	bne	$a3, $s5, .LBB13_12
# %bb.21:                               # %for.cond52.for.inc88_crit_edge.split.us.us.us
	ld.w	$a1, $s1, %pc_lo12(ref_access_method)
	slli.d	$a1, $a1, 3
	ld.d	$a2, $sp, 16                    # 8-byte Folded Reload
	ldx.d	$a3, $a2, $a1
	...
	ori	$a6, $zero, 1
	.p2align	4, , 16
.LBB13_22:                              # %for.cond56.preheader.us.us.us.1
                                        # =>This Loop Header: Depth=1
...
# %bb.26:                               # %middle.block186
	...
	move	$a7, $a5
	beq	$a5, $a4, .LBB13_29
.LBB13_27:                              # %for.body59.us.us.us.1.preheader
                                        #   in Loop: Header=BB13_22 Depth=1
	sub.d	$a0, $s4, $a7
	.p2align	4, , 16
.LBB13_28:                              # %for.body59.us.us.us.1
                                        #   Parent Loop BB13_22 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a7, $a1, 0
	ld.hu	$t0, $a2, 0
	...
	add.w	$fp, $a7, $t0
	bnez	$a0, .LBB13_28
.LBB13_29:                              # %for.cond56.for.end78_crit_edge.us.us.us.1
                                        #   in Loop: Header=BB13_22 Depth=1
	bge	$fp, $s0, .LBB13_36
# %bb.30:                               # %if.end82.us.us.us.1
                                        #   in Loop: Header=BB13_22 Depth=1
	addi.w	$a3, $a3, 1
	alsl.d	$a0, $s2, $a2, 1
	move	$t0, $a1
	bne	$a3, $s5, .LBB13_22
# %bb.31:                               # %for.cond52.for.inc88_crit_edge.split.us.us.us.1
	ld.d	$a2, $sp, 24                    # 8-byte Folded Reload
	st.d	$a0, $a2, %pc_lo12(ref_line)
	b	.LBB13_37
.LBB13_32:                              # %for.cond1.preheader.lr.ph.split
	blez	$s0, .LBB13_43
# %bb.33:                               # %for.cond1.preheader.preheader
	slli.d	$a1, $s2, 1
	slli.d	$a2, $s4, 1
	sub.d	$a1, $a1, $a2
	addi.w	$a3, $s5, -1
	...
	bnez	$a0, .LBB13_9
	b	.LBB13_43
.LBB13_34:                              # %cleanup95.loopexit34.split.us
	st.d	$a5, $s3, %pc_lo12(ref_line)
	st.d	$a4, $s7, %pc_lo12(src_line)
	b	.LBB13_43
.LBB13_35:                              # %for.body44.preheader
	...
	move	$a2, $s2
	b	.LBB13_41
.LBB13_36:                              # %cleanup95.loopexit.split.us
	ld.d	$a0, $sp, 24                    # 8-byte Folded Reload
	st.d	$a2, $a0, %pc_lo12(ref_line)
.LBB13_37:                              # %cleanup95
	st.d	$a1, $s7, %pc_lo12(src_line)
	b	.LBB13_43
.LBB13_38:                              # %if.then38.split.us.split
	bge	$fp, $s0, .LBB13_40
# %bb.39:                               # %for.body44.us.us103.preheader
	slli.d	$a1, $a0, 1
	slli.d	$a2, $s4, 1
	sub.d	$a1, $a1, $a2
	addi.w	$a3, $s5, -1
...
.LBB14_6:                               # %vector.body
	...
	xvpickve2gr.d	$s6, $xr10, 2
	xvpickve2gr.d	$ra, $xr10, 3
	vpickve2gr.w	$s8, $vr8, 2
	vinsgr2vr.d	$vr9, $s8, 0
	vpickve2gr.w	$s8, $vr8, 3
	vinsgr2vr.d	$vr9, $s8, 1
	xvpermi.q	$xr9, $xr9, 2
...
# %bb.42:                               # %for.cond110.for.inc183_crit_edge.split.us.us.1
	...
	st.d	$a0, $a2, %pc_lo12(ref1_line)
	b	.LBB16_44
.LBB16_43:                              # %cleanup190.loopexit.split.us
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	st.d	$a3, $a0, %pc_lo12(ref2_line)
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
	st.d	$a2, $a0, %pc_lo12(ref1_line)
.LBB16_44:                              # %cleanup190
	...
	st.d	$a1, $a0, %pc_lo12(src_line)
	b	.LBB16_46
.LBB16_45:                              # %for.cond114.preheader.us148.preheader.1
