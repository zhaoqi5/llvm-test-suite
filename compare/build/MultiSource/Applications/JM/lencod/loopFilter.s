...
.LBB0_7:                                # %pred.store.continue
	...
	andi	$a7, $a7, 1
	bnez	$a7, .LBB0_14
# %bb.8:                                # %pred.store.continue16
                                        #   in Loop: Header=BB0_5 Depth=1
	vpickve2gr.h	$a7, $vr0, 2
	andi	$a7, $a7, 1
	bnez	$a7, .LBB0_15
.LBB0_9:                                # %pred.store.continue18
                                        #   in Loop: Header=BB0_5 Depth=1
	vpickve2gr.h	$a7, $vr0, 3
	andi	$a7, $a7, 1
	bnez	$a7, .LBB0_16
.LBB0_10:                               # %pred.store.continue20
                                        #   in Loop: Header=BB0_5 Depth=1
	vpickve2gr.h	$a7, $vr0, 4
	andi	$a7, $a7, 1
	bnez	$a7, .LBB0_17
.LBB0_11:                               # %pred.store.continue22
                                        #   in Loop: Header=BB0_5 Depth=1
	vpickve2gr.h	$a7, $vr0, 5
	andi	$a7, $a7, 1
	bnez	$a7, .LBB0_18
.LBB0_12:                               # %pred.store.continue24
                                        #   in Loop: Header=BB0_5 Depth=1
	vpickve2gr.h	$a7, $vr0, 6
	andi	$a7, $a7, 1
	bnez	$a7, .LBB0_19
.LBB0_13:                               # %pred.store.continue26
                                        #   in Loop: Header=BB0_5 Depth=1
...
# %bb.0:                                # %entry
	...
	move	$s0, $a0
	pcalau12i	$a0, %pc_hi20(.L__const.DeblockMb.filterNon8x8LumaEdgesFlag)
	addi.d	$a0, $a0, %pc_lo12(.L__const.DeblockMb.filterNon8x8LumaEdgesFlag)
	ld.w	$a1, $a0, 8
	ld.d	$a0, $a0, 0
	st.w	$a1, $sp, 152
	st.d	$a0, $sp, 144
...
# %bb.0:                                # %entry
	...
	beqz	$fp, .LBB3_3
# %bb.1:                                # %cond.end
	pcalau12i	$a0, %pc_hi20(EdgeLoop.pelnum_cr)
	addi.d	$a0, $a0, %pc_lo12(EdgeLoop.pelnum_cr)
	ldptr.w	$a1, $a2, 15536
	alsl.d	$a0, $a6, $a0, 4
	slli.d	$a1, $a1, 2
	ldx.w	$a0, $a0, $a1
...
.LBB3_4:                                # %for.body.lr.ph
	...
	pcalau12i	$s6, %pc_hi20(fieldModeFilteringFlag)
	b	.LBB3_7
	.p2align	4, , 16
...
# %bb.8:                                # %lor.end
                                        #   in Loop: Header=BB3_7 Depth=1
	st.b	$a3, $s6, %pc_lo12(fieldModeFilteringFlag)
	move	$a2, $s5
