...
.LBB0_9:                                # %pred.store.if
	...
	andi	$a5, $a5, 1
	beqz	$a5, .LBB0_7
.LBB0_10:                               # %pred.store.if15
                                        #   in Loop: Header=BB0_5 Depth=1
	st.w	$zero, $a3, -536
	vpickve2gr.w	$a5, $vr0, 2
	andi	$a5, $a5, 1
	beqz	$a5, .LBB0_8
.LBB0_11:                               # %pred.store.if17
                                        #   in Loop: Header=BB0_5 Depth=1
	st.w	$zero, $a3, 0
	vpickve2gr.w	$a5, $vr0, 3
	andi	$a5, $a5, 1
	beqz	$a5, .LBB0_4
.LBB0_12:                               # %pred.store.if19
                                        #   in Loop: Header=BB0_5 Depth=1
	st.w	$zero, $a3, 536
	b	.LBB0_4
.LBB0_13:                               # %middle.block
	bne	$a2, $a0, .LBB0_18
.LBB0_14:                               # %for.body8.preheader
	move	$s2, $zero
	.p2align	4, , 16
.LBB0_15:                               # %for.body8
                                        # =>This Inner Loop Header: Depth=1
