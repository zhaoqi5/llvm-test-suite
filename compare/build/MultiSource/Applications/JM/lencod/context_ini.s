...
# %bb.33:                               # %if.else280.1
	...
	slli.d	$a0, $s3, 4
	alsl.d	$t5, $s3, $a0, 3
	pcalau12i	$a1, %pc_hi20(INIT_TRANSFORM_SIZE_P)
	addi.d	$s8, $a1, %pc_lo12(INIT_TRANSFORM_SIZE_P)
	ld.bu	$a1, $ra, 1458
	ld.hu	$a3, $ra, 1456
	add.d	$s7, $s8, $t5
	ld.d	$t4, $ra, 1464
	...
	fcmp.clt.d	$fcc0, $fa2, $fs0
	fsel	$fs0, $fs0, $fa2, $fcc0
	vshuf4i.w	$vr26, $vr25, 8
	vmul.w	$vr21, $vr26, $vr21
	vsrai.w	$vr21, $vr21, 4
	vshuf4i.w	$vr25, $vr25, 13
	vadd.w	$vr21, $vr21, $vr25
	vmaxi.w	$vr21, $vr21, 0
	vrepli.w	$vr25, 127
	vmin.w	$vr21, $vr21, $vr25
	vpickve2gr.w	$a3, $vr21, 0
	andi	$a3, $a3, 127
	slli.d	$a3, $a3, 3
	fldx.d	$fs1, $t1, $a3
	vpickve2gr.b	$a3, $vr21, 0
	andn	$a3, $s1, $a3
	slli.d	$a3, $a3, 3
	fldx.d	$fs2, $t1, $a3
	slli.d	$a3, $a1, 3
	fldx.d	$fs3, $s0, $a3
	fmadd.d	$ft15, $ft15, $fs1, $ft11
	fmadd.d	$ft14, $ft14, $fs2, $ft15
	fadd.d	$ft12, $ft12, $ft14
	vpickve2gr.b	$a3, $vr21, 4
	andi	$a3, $a3, 127
	slli.d	$a3, $a3, 3
	fldx.d	$ft14, $t1, $a3
	fneg.d	$ft15, $fs3
	...
	slli.d	$a1, $a1, 3
	fldx.d	$ft13, $t1, $a1
	fmadd.d	$ft14, $ft15, $ft14, $ft11
	fneg.d	$ft15, $fs1
	fmul.d	$ft15, $fs0, $ft15
	fmadd.d	$ft13, $ft15, $ft13, $ft14
	fadd.d	$ft12, $ft12, $ft13
	ld.d	$a1, $ra, 1496
	ld.bu	$a3, $ra, 1490
	ld.hu	$a4, $ra, 1488
