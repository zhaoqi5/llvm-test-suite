...
# %bb.0:                                # %entry
	...
	ld.d	$a0, $s0, 0
	pcalau12i	$a1, %pc_hi20(get_mb_block_pos)
	ld.d	$a3, $a1, %pc_lo12(get_mb_block_pos)
	st.w	$fp, $a0, 12
	addi.d	$a1, $a0, 160
	addi.d	$a2, $a0, 164
	move	$a0, $fp
...
# %bb.2:                                # %if.then10
	andi	$a5, $fp, 1
	sltui	$a5, $a5, 1
	pcalau12i	$a6, %pc_hi20(imgY_org_bot)
	addi.d	$a6, $a6, %pc_lo12(imgY_org_bot)
	pcalau12i	$a7, %pc_hi20(imgY_org_top)
	addi.d	$a7, $a7, %pc_lo12(imgY_org_top)
	masknez	$a6, $a6, $a5
	maskeqz	$a7, $a7, $a5
	or	$a6, $a7, $a6
	ld.d	$a6, $a6, 0
	...
	pcalau12i	$a6, %pc_hi20(imgUV_org_bot)
	addi.d	$a6, $a6, %pc_lo12(imgUV_org_bot)
	pcalau12i	$a7, %pc_hi20(imgUV_org_top)
	addi.d	$a7, $a7, %pc_lo12(imgUV_org_top)
	masknez	$a6, $a6, $a5
	maskeqz	$a7, $a7, $a5
	or	$a6, $a7, $a6
	ld.d	$a6, $a6, 0
	pcalau12i	$a7, %pc_hi20(imgUV_org)
	st.d	$a6, $a7, %pc_lo12(imgUV_org)
	slli.d	$a4, $a4, 3
...
.LBB0_4:                                # %if.else
	move	$a5, $zero
	pcalau12i	$a4, %pc_hi20(imgY_org_frm)
	ld.d	$a4, $a4, %pc_lo12(imgY_org_frm)
	pcalau12i	$a6, %pc_hi20(imgUV_org_frm)
	ld.d	$a6, $a6, %pc_lo12(imgUV_org_frm)
	pcalau12i	$a7, %pc_hi20(imgY_org)
	st.d	$a4, $a7, %pc_lo12(imgY_org)
	pcalau12i	$a4, %pc_hi20(imgUV_org)
	st.d	$a6, $a4, %pc_lo12(imgUV_org)
	st.w	$a2, $a0, 196
.LBB0_5:                                # %if.end41
	move	$a4, $a2
	ldptr.w	$a6, $a0, 15536
...
.LBB3_28:                               # %if.end382
	...
	sub.d	$a0, $a0, $a2
	st.w	$a0, $s1, 4
	pcalau12i	$a2, %pc_hi20(delta_qp_mbaff)
	addi.d	$a2, $a2, %pc_lo12(delta_qp_mbaff)
	ldptr.w	$a4, $a1, 15412
	alsl.d	$a2, $a3, $a2, 3
	slli.d	$a3, $a4, 2
	stx.w	$a0, $a2, $a3
...
.LBB3_31:                               # %cond.end.i163
	...
	or	$a0, $a4, $a0
	bltz	$a2, .LBB3_33
# %bb.32:                               # %cond.false.1.i171
	pcalau12i	$a2, %got_pc_hi20(QP_SCALE_CR)
	ld.d	$a2, $a2, %got_pc_lo12(QP_SCALE_CR)
	ldx.bu	$a0, $a2, $a0
.LBB3_33:                               # %set_chroma_qp.exit177
...
.LBB3_77:                               # %if.then107
	...
	st.w	$a0, $s1, 8
	pcalau12i	$a0, %pc_hi20(delta_qp_mbaff)
	addi.d	$a0, $a0, %pc_lo12(delta_qp_mbaff)
	ldptr.w	$a4, $a1, 15412
	alsl.d	$a0, $a3, $a0, 3
	slli.d	$a3, $a4, 2
	stx.w	$zero, $a0, $a3
...
# %bb.44:                               # %land.lhs.true79
	bnez	$a1, .LBB4_56
# %bb.45:                               # %for.cond.preheader.i101
	ld.w	$a1, $s2, 16
	blez	$a1, .LBB4_56
# %bb.46:                               # %for.body.lr.ph.i104
	ld.d	$a2, $s2, 24
	ld.w	$a3, $a3, 268
	.p2align	4, , 16
.LBB4_47:                               # %for.body.i108
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a4, $a2, 0
	ld.w	$a5, $a4, 4
	ld.w	$a4, $a4, 0
...
# %bb.48:                               # %for.cond.i119
	...
	bnez	$a1, .LBB4_47
	b	.LBB4_56
.LBB4_49:                               # %for.cond17.preheader.i85
	ld.w	$a0, $s2, 16
	blez	$a0, .LBB4_56
# %bb.50:                               # %for.body20.i90.preheader
	move	$s4, $zero
	ori	$fp, $zero, 8
	.p2align	4, , 16
.LBB4_51:                               # %for.body20.i90
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $s2, 24
	add.d	$a0, $a0, $fp
	pcaddu18i	$ra, %call36(arienco_bits_written)
...
# %bb.9:                                # %sw.bb
	...
	addi.d	$a2, $a2, %pc_lo12(LumaPrediction4x4.l0_pred)
	b	.LBB6_11
.LBB6_10:                               # %sw.bb55
	ld.d	$a0, $s0, 8
	slli.d	$a1, $s6, 3
	...
	addi.d	$a2, $a2, %pc_lo12(LumaPrediction4x4.l1_pred)
.LBB6_11:                               # %sw.epilog
	pcalau12i	$a3, %pc_hi20(img_padded_size_x)
...
.LBB6_12:                               # %sw.bb65
	...
	ld.w	$a3, $s7, %pc_lo12(img_padded_size_x)
	st.d	$a1, $a2, 0
	slli.d	$a1, $a3, 1
	ldx.d	$a4, $a0, $a1
	alsl.d	$a0, $a3, $a0, 1
...
# %bb.19:                               # %for.cond221.preheader
	...
	slli.d	$a0, $t3, 5
	add.d	$a5, $a2, $a0
	pcalau12i	$a0, %pc_hi20(LumaPrediction4x4.l0_pred)
	addi.d	$a3, $a0, %pc_lo12(LumaPrediction4x4.l0_pred)
	ld.hu	$a0, $a3, 0
...
# %bb.22:                               # %if.else176
	...
	slli.d	$a5, $fp, 5
	add.d	$t1, $a7, $a5
	pcalau12i	$a5, %pc_hi20(LumaPrediction4x4.l1_pred)
	addi.d	$t0, $a5, %pc_lo12(LumaPrediction4x4.l1_pred)
	b	.LBB6_32
.LBB6_23:                               # %if.else248
	ld.d	$a0, $s2, 0
	slli.d	$a1, $t3, 5
...
.LBB6_31:                               # %if.then138
	...
	slli.d	$a5, $fp, 5
	add.d	$t1, $a7, $a5
	pcalau12i	$a5, %pc_hi20(LumaPrediction4x4.l0_pred)
	addi.d	$t0, $a5, %pc_lo12(LumaPrediction4x4.l0_pred)
.LBB6_32:                               # %if.else176
	ld.hu	$a5, $t0, 0
	mul.d	$a5, $a2, $a5
	add.d	$a5, $a5, $a3
...
.LBB7_6:                                # %lor.end
	...
	slli.d	$a2, $a3, 3
	pcalau12i	$a3, %got_pc_hi20(listX)
	ld.d	$s3, $a3, %got_pc_lo12(listX)
	ldx.d	$a2, $s3, $a2
	ldx.d	$a1, $a2, $a1
	lu12i.w	$a2, 1
	ori	$s0, $a2, 2312
	ldx.w	$a3, $a1, $s0
	pcalau12i	$s7, %pc_hi20(width_pad)
	st.w	$a3, $s7, %pc_lo12(width_pad)
	ori	$s8, $a2, 2316
	ldx.w	$a2, $a1, $s8
	...
	jirl	$ra, $ra, 0
	ld.d	$a1, $a0, 0
	pcalau12i	$a2, %pc_hi20(LumaPrediction4x4Bi.l0_pred)
	addi.d	$s6, $a2, %pc_lo12(LumaPrediction4x4Bi.l0_pred)
	...
	jirl	$ra, $ra, 0
	ld.d	$a6, $a0, 0
	pcalau12i	$a1, %pc_hi20(LumaPrediction4x4Bi.l1_pred)
	addi.d	$t0, $a1, %pc_lo12(LumaPrediction4x4Bi.l1_pred)
...
.LBB8_2:                                # %land.end
	...
	vst	$vr2, $sp, 208                  # 16-byte Folded Spill
...
.LBB8_4:                                # %for.body88
	...
	vld	$vr2, $sp, 208                  # 16-byte Folded Reload
	vilvl.h	$vr1, $vr2, $vr1
	vsub.w	$vr0, $vr0, $vr1
...
# %bb.0:                                # %entry
	...
	ld.w	$a3, $a2, %pc_lo12(chroma_shift_x)
	pcalau12i	$a2, %pc_hi20(chroma_shift_y)
	st.d	$a2, $sp, 88                    # 8-byte Folded Spill
	ld.w	$a2, $a2, %pc_lo12(chroma_shift_y)
	ld.w	$t0, $a0, 200
	add.w	$t1, $t1, $a4
	slli.d	$t1, $t1, 3
	...
	move	$s8, $a5
	ldx.d	$a5, $t1, $a5
	pcalau12i	$t1, %pc_hi20(active_sps)
	ld.d	$t1, $t1, %pc_lo12(active_sps)
	ldptr.d	$t2, $a5, 6464
	slli.d	$a7, $a7, 3
	ld.w	$t1, $t1, 32
	ldx.d	$s0, $t2, $a7
...
# %bb.0:                                # %entry
	...
	ldptr.d	$a3, $a3, 6472
	slli.d	$a7, $a7, 3
	pcalau12i	$t8, %pc_hi20(active_sps)
...
# %bb.22:                               # %for.cond199.preheader
	...
	add.d	$a4, $a1, $a0
	pcalau12i	$a0, %pc_hi20(ChromaPrediction4x4.l0_pred)
	addi.d	$a2, $a0, %pc_lo12(ChromaPrediction4x4.l0_pred)
	ld.hu	$a0, $a2, 0
...
# %bb.25:                               # %if.then108
	...
	slli.d	$a5, $s2, 5
	add.d	$t0, $a6, $a5
	pcalau12i	$a5, %pc_hi20(ChromaPrediction4x4.l0_pred)
	addi.d	$a7, $a5, %pc_lo12(ChromaPrediction4x4.l0_pred)
	b	.LBB15_36
.LBB15_26:                              # %if.else226
...
.LBB15_35:                              # %if.else150
	...
	slli.d	$a5, $s2, 5
	add.d	$t0, $a6, $a5
	pcalau12i	$a5, %pc_hi20(ChromaPrediction4x4.l1_pred)
	addi.d	$a7, $a5, %pc_lo12(ChromaPrediction4x4.l1_pred)
.LBB15_36:                              # %if.then108
	ld.hu	$a5, $a7, 0
	mul.d	$a5, $a2, $a5
	add.d	$a5, $a5, $a3
...
.LBB17_24:                              # %if.end89
	...
	and	$a2, $a4, $a2
	st.d	$a2, $sp, 120                   # 8-byte Folded Spill
	bstrpick.d	$a2, $ra, 30, 3
	slli.d	$a2, $a2, 3
	st.d	$a2, $sp, 416                   # 8-byte Folded Spill
	vreplgr2vr.w	$vr10, $t3
	slli.d	$a2, $a1, 6
	pcalau12i	$a3, %pc_hi20(IntraChromaPrediction.block_pos)
	addi.d	$a3, $a3, %pc_lo12(IntraChromaPrediction.block_pos)
	add.d	$a2, $a2, $a3
	addi.d	$a2, $a2, 8
	...
	vst	$vr11, $sp, 272                 # 16-byte Folded Spill
	b	.LBB17_26
	.p2align	4, , 16
.LBB17_25:                              # %for.inc632
...
.LBB17_26:                              # %for.body92
	...
	srai.d	$a0, $a1, 1
	blez	$a0, .LBB17_113
# %bb.27:                               # %for.cond99.preheader.lr.ph
                                        #   in Loop: Header=BB17_26 Depth=1
...
.LBB17_43:                              # %if.then231
	...
	add.d	$t3, $t3, $t5
	b	.LBB17_54
.LBB17_44:                              # %if.else266.3
                                        #   in Loop: Header=BB17_34 Depth=2
	move	$t2, $a1
	bnez	$s4, .LBB17_105
	b	.LBB17_33
.LBB17_45:                              # %if.end320.thread
                                        #   in Loop: Header=BB17_34 Depth=2
	move	$t2, $a1
	bnez	$s3, .LBB17_47
	b	.LBB17_56
.LBB17_46:                              # %if.end139.thread
                                        #   in Loop: Header=BB17_34 Depth=2
	move	$t2, $a1
	beqz	$s5, .LBB17_56
.LBB17_47:                              #   in Loop: Header=BB17_34 Depth=2
	move	$t2, $zero
.LBB17_48:                              # %for.cond143.preheader
                                        #   in Loop: Header=BB17_34 Depth=2
	slli.d	$t3, $t0, 4
	alsl.d	$t3, $t0, $t3, 3
	add.d	$t3, $t8, $t3
...
.LBB17_65:                              # %if.then295.1
	...
	add.d	$t3, $t3, $t5
	b	.LBB17_75
.LBB17_66:                              # %if.end320.thread.1
                                        #   in Loop: Header=BB17_34 Depth=2
	move	$t2, $a1
	bnez	$s3, .LBB17_68
	b	.LBB17_77
.LBB17_67:                              # %if.end139.thread.1
                                        #   in Loop: Header=BB17_34 Depth=2
	move	$t2, $a1
	beqz	$s5, .LBB17_77
.LBB17_68:                              #   in Loop: Header=BB17_34 Depth=2
	move	$t2, $zero
.LBB17_69:                              # %for.cond324.preheader.1
                                        #   in Loop: Header=BB17_34 Depth=2
	slli.d	$t3, $t0, 4
	alsl.d	$t3, $t0, $t3, 3
	add.d	$t3, $t8, $t3
...
# %bb.70:                               # %if.then349.1
	...
	srli.d	$t2, $t2, 3
	b	.LBB17_72
.LBB17_71:                              # %if.then178.1
                                        #   in Loop: Header=BB17_34 Depth=2
	addi.d	$t2, $t3, 2
	srli.d	$t2, $t2, 2
.LBB17_72:                              # %sw.epilog.1
                                        #   in Loop: Header=BB17_34 Depth=2
	addi.d	$t8, $sp, 472
	b	.LBB17_77
...
.LBB17_74:                              # %if.then290.1
	...
	add.d	$t3, $t3, $t5
	add.d	$t3, $t3, $t4
.LBB17_75:                              # %if.then355.1
                                        #   in Loop: Header=BB17_34 Depth=2
	add.d	$t2, $t3, $t2
.LBB17_76:                              # %if.then355.1
                                        #   in Loop: Header=BB17_34 Depth=2
	addi.d	$t2, $t2, 2
	srli.d	$t2, $t2, 2
...
.LBB17_86:                              # %if.then295.2
	...
	add.d	$t3, $t3, $t5
	b	.LBB17_96
.LBB17_87:                              # %if.end320.thread.2
                                        #   in Loop: Header=BB17_34 Depth=2
	move	$t2, $a1
	bnez	$s3, .LBB17_89
	b	.LBB17_98
.LBB17_88:                              # %if.end139.thread.2
                                        #   in Loop: Header=BB17_34 Depth=2
	move	$t2, $a1
	beqz	$s5, .LBB17_98
.LBB17_89:                              #   in Loop: Header=BB17_34 Depth=2
	move	$t2, $zero
.LBB17_90:                              # %for.cond324.preheader.2
                                        #   in Loop: Header=BB17_34 Depth=2
	slli.d	$t3, $t0, 4
	alsl.d	$t3, $t0, $t3, 3
	add.d	$t3, $t8, $t3
...
# %bb.91:                               # %if.then349.2
	...
	srli.d	$t2, $t2, 3
	b	.LBB17_93
.LBB17_92:                              # %if.then178.2
                                        #   in Loop: Header=BB17_34 Depth=2
	addi.d	$t2, $t3, 2
	srli.d	$t2, $t2, 2
.LBB17_93:                              # %sw.epilog.2
                                        #   in Loop: Header=BB17_34 Depth=2
	addi.d	$t8, $sp, 472
	b	.LBB17_98
...
.LBB17_95:                              # %if.then290.2
	...
	add.d	$t3, $t3, $t5
	add.d	$t3, $t3, $t4
.LBB17_96:                              # %if.then355.2
                                        #   in Loop: Header=BB17_34 Depth=2
	add.d	$t2, $t3, $t2
.LBB17_97:                              # %if.then355.2
                                        #   in Loop: Header=BB17_34 Depth=2
	addi.d	$t2, $t2, 2
	srli.d	$t2, $t2, 2
...
.LBB17_100:                             # %sw.bb.3
                                        #   in Loop: Header=BB17_34 Depth=2
	beqz	$s4, .LBB17_107
# %bb.101:                              # %for.cond124.preheader.3
                                        #   in Loop: Header=BB17_34 Depth=2
	ld.d	$a7, $a7, 0
	alsl.d	$t2, $a6, $a7, 1
	slli.d	$t3, $t1, 1
	...
	b	.LBB17_31
	.p2align	4, , 16
.LBB17_102:                             # %sw.bb300.3
                                        #   in Loop: Header=BB17_34 Depth=2
	beqz	$s4, .LBB17_106
# %bb.103:                              # %for.cond303.preheader.3
                                        #   in Loop: Header=BB17_34 Depth=2
	ld.d	$a7, $a7, 0
	alsl.d	$t2, $a6, $a7, 1
	slli.d	$t3, $t1, 1
	...
	bnez	$s3, .LBB17_109
	b	.LBB17_31
.LBB17_104:                             # %sw.bb184.3
                                        #   in Loop: Header=BB17_34 Depth=2
	beqz	$s4, .LBB17_112
.LBB17_105:                             # %if.then295.3
                                        #   in Loop: Header=BB17_34 Depth=2
	ld.d	$a7, $a7, 0
	alsl.d	$t2, $a6, $a7, 1
	slli.d	$t3, $t1, 1
	...
	add.d	$a7, $a7, $t3
	b	.LBB17_30
.LBB17_106:                             # %if.end320.thread.3
                                        #   in Loop: Header=BB17_34 Depth=2
	move	$t2, $a1
	bnez	$s3, .LBB17_108
	b	.LBB17_33
.LBB17_107:                             # %if.end139.thread.3
                                        #   in Loop: Header=BB17_34 Depth=2
	move	$t2, $a1
	beqz	$s5, .LBB17_33
.LBB17_108:                             #   in Loop: Header=BB17_34 Depth=2
	move	$a6, $zero
.LBB17_109:                             # %for.cond324.preheader.3
                                        #   in Loop: Header=BB17_34 Depth=2
	slli.d	$a7, $t0, 4
	alsl.d	$a7, $t0, $a7, 3
	add.d	$a7, $t8, $a7
...
# %bb.110:                              # %if.then349.3
	...
	srli.d	$t2, $a6, 3
	b	.LBB17_33
.LBB17_111:                             # %if.then178.3
                                        #   in Loop: Header=BB17_34 Depth=2
	addi.d	$a6, $a7, 2
	b	.LBB17_32
.LBB17_112:                             # %if.else204.3
                                        #   in Loop: Header=BB17_34 Depth=2
	move	$t2, $a1
	bnez	$s5, .LBB17_29
	b	.LBB17_33
	.p2align	4, , 16
.LBB17_113:                             # %for.end396
                                        #   in Loop: Header=BB17_26 Depth=1
	beqz	$s4, .LBB17_118
# %bb.114:                              # %if.then398
                                        #   in Loop: Header=BB17_26 Depth=1
...
# %bb.117:                              # %if.end423.thread735
	...
	addi.d	$t8, $sp, 472
	vld	$vr11, $sp, 272                 # 16-byte Folded Reload
	beqz	$a0, .LBB17_25
	b	.LBB17_120
	.p2align	4, , 16
.LBB17_118:                             # %if.end423
	...
	ld.d	$a0, $sp, 368                   # 8-byte Folded Reload
	beqz	$a0, .LBB17_25
# %bb.119:                              # %for.cond430.preheader
                                        #   in Loop: Header=BB17_26 Depth=1
	blez	$s6, .LBB17_123
.LBB17_120:                             # %for.body433.preheader
                                        #   in Loop: Header=BB17_26 Depth=1
	ori	$a0, $zero, 2
	bgeu	$s6, $a0, .LBB17_124
# %bb.121:                              #   in Loop: Header=BB17_26 Depth=1
	move	$a2, $zero
	ld.d	$a7, $sp, 424                   # 8-byte Folded Reload
	b	.LBB17_127
	.p2align	4, , 16
.LBB17_122:                             # %if.end423.thread
                                        #   in Loop: Header=BB17_26 Depth=1
	ld.d	$a0, $sp, 368                   # 8-byte Folded Reload
	ld.d	$ra, $sp, 344                   # 8-byte Folded Reload
	vld	$vr10, $sp, 320                 # 16-byte Folded Reload
	...
	vld	$vr11, $sp, 272                 # 16-byte Folded Reload
	beqz	$a0, .LBB17_25
.LBB17_123:                             # %for.cond451.preheader
                                        #   in Loop: Header=BB17_26 Depth=1
	ld.d	$a7, $sp, 424                   # 8-byte Folded Reload
	ld.d	$a0, $sp, 200                   # 8-byte Folded Reload
	beqz	$a0, .LBB17_130
	b	.LBB17_139
.LBB17_124:                             # %vector.body816.preheader
                                        #   in Loop: Header=BB17_26 Depth=1
	addi.d	$a0, $sp, 540
...
.LBB17_125:                             # %vector.body816
	...
	addi.d	$a0, $a0, 48
	bnez	$a1, .LBB17_125
# %bb.126:                              # %middle.block819
                                        #   in Loop: Header=BB17_26 Depth=1
	ld.d	$a0, $sp, 248                   # 8-byte Folded Reload
	move	$a2, $a0
	beq	$a0, $a7, .LBB17_129
.LBB17_127:                             # %for.body433.preheader825
                                        #   in Loop: Header=BB17_26 Depth=1
	alsl.d	$a0, $a2, $s1, 1
	sub.d	$a1, $a7, $a2
	slli.d	$a3, $a2, 4
...
.LBB17_128:                             # %for.body433
	...
	addi.d	$a2, $a2, 24
	bnez	$a1, .LBB17_128
.LBB17_129:                             # %for.cond451.preheader.thread
                                        #   in Loop: Header=BB17_26 Depth=1
	blez	$s2, .LBB17_139
.LBB17_130:                             # %for.cond455.preheader.us.preheader
                                        #   in Loop: Header=BB17_26 Depth=1
	ld.d	$a1, $s7, 0
	move	$a0, $zero
	...
	b	.LBB17_132
	.p2align	4, , 16
.LBB17_131:                             # %for.cond455.for.inc472_crit_edge.us
                                        #   in Loop: Header=BB17_132 Depth=2
	addi.d	$a0, $a0, 1
	addi.d	$a2, $a2, 2
	addi.d	$a1, $a1, 2
	beq	$a0, $ra, .LBB17_139
.LBB17_132:                             # %for.cond455.preheader.us
                                        #   Parent Loop BB17_26 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB17_135 Depth 3
                                        #       Child Loop BB17_138 Depth 3
	ori	$a3, $zero, 8
	bgeu	$s6, $a3, .LBB17_134
# %bb.133:                              #   in Loop: Header=BB17_132 Depth=2
	move	$a5, $zero
	b	.LBB17_137
	.p2align	4, , 16
.LBB17_134:                             # %vector.body804.preheader
                                        #   in Loop: Header=BB17_132 Depth=2
	addi.d	$a3, $sp, 912
	move	$a4, $a2
	ld.d	$a5, $sp, 432                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB17_135:                             # %vector.body804
                                        #   Parent Loop BB17_26 Depth=1
	...
	addi.d	$a3, $a3, 16
	bnez	$a5, .LBB17_135
# %bb.136:                              # %middle.block808
                                        #   in Loop: Header=BB17_132 Depth=2
	ld.d	$a3, $sp, 432                   # 8-byte Folded Reload
	move	$a5, $a3
	ld.d	$a7, $sp, 424                   # 8-byte Folded Reload
	beq	$a3, $a7, .LBB17_131
.LBB17_137:                             # %for.body458.us.preheader
                                        #   in Loop: Header=BB17_132 Depth=2
	alsl.d	$a3, $a5, $s1, 1
	slli.d	$a4, $a5, 5
	add.d	$a4, $a1, $a4
...
# %bb.140:                              # %if.then485
	...
	ori	$a5, $zero, 2
	blt	$a3, $a5, .LBB17_148
# %bb.141:                              # %for.body507.preheader
                                        #   in Loop: Header=BB17_26 Depth=1
	ori	$a5, $zero, 9
	bgeu	$a3, $a5, .LBB17_143
# %bb.142:                              #   in Loop: Header=BB17_26 Depth=1
	move	$a7, $zero
	b	.LBB17_146
.LBB17_143:                             # %vector.ph777
                                        #   in Loop: Header=BB17_26 Depth=1
	pcalau12i	$a3, %pc_hi20(.LCPI17_0)
	vld	$vr0, $a3, %pc_lo12(.LCPI17_0)
	pcalau12i	$a3, %pc_hi20(.LCPI17_1)
	vld	$vr2, $a3, %pc_lo12(.LCPI17_1)
	vori.b	$vr1, $vr11, 0
...
.LBB17_144:                             # %vector.body780
	...
	ld.d	$a7, $a3, 0
	vld	$vr6, $a2, %pc_lo12(.LCPI17_2)
	vinsgr2vr.d	$vr7, $a6, 0
	vilvl.h	$vr4, $vr11, $vr4
	vilvl.h	$vr5, $vr11, $vr5
	vinsgr2vr.d	$vr8, $a7, 0
	vori.b	$vr9, $vr6, 0
	vshuf.h	$vr9, $vr11, $vr7
	vshuf.h	$vr6, $vr11, $vr8
	vsub.w	$vr4, $vr4, $vr9
	vsub.w	$vr5, $vr5, $vr6
	vpickev.w	$vr6, $vr0, $vr2
	vaddi.wu	$vr7, $vr6, 1
	vaddi.wu	$vr6, $vr6, 5
	vmadd.w	$vr1, $vr4, $vr7
	vmadd.w	$vr3, $vr5, $vr6
...
# %bb.145:                              # %middle.block794
	...
	beq	$a5, $a3, .LBB17_148
.LBB17_146:                             # %for.body507.preheader824
                                        #   in Loop: Header=BB17_26 Depth=1
	slli.d	$a5, $a7, 1
	ld.d	$a3, $sp, 112                   # 8-byte Folded Reload
	alsl.d	$a3, $a7, $a3, 1
...
.LBB17_148:                             # %for.end525
	...
	ori	$a5, $zero, 2
	blt	$s8, $a5, .LBB17_151
# %bb.149:                              # %for.body547.preheader
                                        #   in Loop: Header=BB17_26 Depth=1
	ori	$a5, $zero, 9
	bgeu	$s8, $a5, .LBB17_153
# %bb.150:                              #   in Loop: Header=BB17_26 Depth=1
	move	$a7, $zero
	b	.LBB17_156
.LBB17_151:                             # %for.end565
                                        #   in Loop: Header=BB17_26 Depth=1
	blez	$s6, .LBB17_25
# %bb.152:                              #   in Loop: Header=BB17_26 Depth=1
	alsl.d	$a2, $a4, $a4, 2
...
# %bb.155:                              # %middle.block772
	...
	beq	$a5, $a2, .LBB17_158
.LBB17_156:                             # %for.body547.preheader823
                                        #   in Loop: Header=BB17_26 Depth=1
	slli.d	$a5, $a7, 1
...
.LBB17_158:                             # %for.end565.thread
	...
	sra.w	$a2, $a2, $a4
	blez	$s2, .LBB17_25
.LBB17_159:                             # %for.cond600.preheader.lr.ph.split.us
                                        #   in Loop: Header=BB17_26 Depth=1
	move	$a4, $zero
	ld.d	$a5, $sp, 168                   # 8-byte Folded Reload
	mul.d	$a1, $a1, $a5
	...
	b	.LBB17_161
	.p2align	4, , 16
.LBB17_160:                             # %for.cond600.for.inc628_crit_edge.us
                                        #   in Loop: Header=BB17_161 Depth=2
	addi.d	$a4, $a4, 1
	addi.d	$a0, $a0, 32
	add.d	$a6, $a6, $a2
	beq	$a4, $s6, .LBB17_25
.LBB17_161:                             # %for.cond600.preheader.us
                                        #   Parent Loop BB17_26 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB17_164 Depth 3
                                        #       Child Loop BB17_167 Depth 3
	ori	$a7, $zero, 8
	bgeu	$s2, $a7, .LBB17_163
...
.LBB17_163:                             # %vector.ph
	...
	vld	$vr2, $t0, %pc_lo12(.LCPI17_3)
	pcalau12i	$t0, %pc_hi20(.LCPI17_4)
	vld	$vr3, $t0, %pc_lo12(.LCPI17_4)
	mul.d	$a7, $a7, $a2
	add.d	$a7, $a5, $a7
	vreplgr2vr.w	$vr4, $a7
	move	$a7, $a0
...
# %bb.165:                              # %middle.block
	...
	move	$t1, $a7
	beq	$a7, $ra, .LBB17_160
.LBB17_166:                             # %for.body603.us.preheader
                                        #   in Loop: Header=BB17_161 Depth=2
...
.LBB17_167:                             # %for.body603.us
	...
	bnez	$t1, .LBB17_167
	b	.LBB17_160
.LBB17_168:                             # %for.end634
	ld.d	$s2, $sp, 192                   # 8-byte Folded Reload
	ld.d	$a0, $s2, 0
	ldptr.w	$a0, $a0, 4168
	bnez	$a0, .LBB17_196
# %bb.169:                              # %for.cond637.preheader
	ld.d	$s3, $sp, 48                    # 8-byte Folded Reload
	ld.d	$s5, $sp, 32                    # 8-byte Folded Reload
	blez	$s6, .LBB17_172
# %bb.170:                              # %for.body640.preheader
	move	$s0, $zero
	addi.d	$s1, $sp, 472
	move	$fp, $s6
	.p2align	4, , 16
.LBB17_171:                             # %for.body640
                                        # =>This Inner Loop Header: Depth=1
	...
	addi.d	$s1, $s1, 24
	bnez	$fp, .LBB17_171
.LBB17_172:                             # %for.cond646.preheader
	move	$a3, $zero
	move	$a4, $zero
	...
	b	.LBB17_176
.LBB17_173:                             #   in Loop: Header=BB17_176 Depth=1
	move	$s3, $zero
.LBB17_174:                             # %for.end755
...
# %bb.181:                              # %land.lhs.true653
	...
	or	$a0, $a0, $a1
	beqz	$a0, .LBB17_175
.LBB17_182:                             # %lor.lhs.false665
                                        #   in Loop: Header=BB17_176 Depth=1
	ori	$a0, $zero, 3
	beq	$a3, $a0, .LBB17_185
# %bb.183:                              # %lor.lhs.false665
                                        #   in Loop: Header=BB17_176 Depth=1
	ori	$a0, $zero, 1
	bne	$a3, $a0, .LBB17_186
# %bb.184:                              # %land.lhs.true668
                                        #   in Loop: Header=BB17_176 Depth=1
	ld.d	$a0, $sp, 368                   # 8-byte Folded Reload
	beqz	$a0, .LBB17_175
	b	.LBB17_186
.LBB17_185:                             # %land.lhs.true677
                                        #   in Loop: Header=BB17_176 Depth=1
...
# %bb.187:                              # %for.body692.us.us
	...
	.p2align	4, , 16
.LBB17_188:                             # %for.cond699.preheader.us.us.us
	...
	add.d	$s0, $a2, $a0
	.p2align	4, , 16
.LBB17_189:                             # %for.cond703.preheader.us.us.us
                                        #   Parent Loop BB17_176 Depth=1
	...
	ld.d	$a0, $sp, 464                   # 8-byte Folded Reload
	blt	$s4, $a0, .LBB17_189
# %bb.190:                              # %for.cond699.for.inc750_crit_edge.us.us.us
	...
	ld.d	$a0, $sp, 408                   # 8-byte Folded Reload
	blt	$a1, $a0, .LBB17_188
# %bb.191:                              # %for.cond695.for.inc753_crit_edge.split.us.us.us
                                        #   in Loop: Header=BB17_176 Depth=1
	ld.d	$a0, $sp, 344                   # 8-byte Folded Reload
	ld.d	$a0, $a0, %pc_lo12(imgUV_org)
	ld.d	$s8, $a0, 8
	...
	.p2align	4, , 16
.LBB17_192:                             # %for.cond699.preheader.us.us.us.1
                                        #   Parent Loop BB17_176 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB17_193 Depth 3
	st.d	$a1, $sp, 416                   # 8-byte Folded Spill
	...
	add.d	$s7, $a2, $a0
	.p2align	4, , 16
.LBB17_193:                             # %for.cond703.preheader.us.us.us.1
                                        #   Parent Loop BB17_176 Depth=1
	...
	ld.d	$a0, $sp, 464                   # 8-byte Folded Reload
	blt	$s4, $a0, .LBB17_193
# %bb.194:                              # %for.cond699.for.inc750_crit_edge.us.us.us.1
...
.Lfunc_end17:
	...
	.p2align	2, 0x0
.LJTI17_0:
	.word	.LBB17_36-.LJTI17_0
	.word	.LBB17_42-.LJTI17_0
	.word	.LBB17_38-.LJTI17_0
	.word	.LBB17_40-.LJTI17_0
.LJTI17_1:
	.word	.LBB17_58-.LJTI17_1
	.word	.LBB17_64-.LJTI17_1
	.word	.LBB17_60-.LJTI17_1
	.word	.LBB17_62-.LJTI17_1
.LJTI17_2:
	.word	.LBB17_79-.LJTI17_2
	.word	.LBB17_85-.LJTI17_2
	.word	.LBB17_81-.LJTI17_2
	.word	.LBB17_83-.LJTI17_2
.LJTI17_3:
	.word	.LBB17_100-.LJTI17_3
	.word	.LBB17_104-.LJTI17_3
	.word	.LBB17_28-.LJTI17_3
	.word	.LBB17_102-.LJTI17_3
                                        # -- End function
	.text
...
# %bb.30:                               # %middle.block
	beq	$a0, $s6, .LBB18_33
.LBB18_31:                              # %for.body89.preheader194
	slli.d	$a1, $a0, 4
	alsl.d	$a1, $a0, $a1, 3
	addi.d	$a2, $sp, 168
	add.d	$a1, $a1, $a2
...
.LBB18_43:                              # %if.end126
	...
	ld.d	$a0, $sp, 32                    # 8-byte Folded Reload
	beqz	$a0, .LBB18_34
# %bb.44:                               # %for.body129.us.us.preheader
                                        #   in Loop: Header=BB18_37 Depth=1
	move	$a0, $zero
	move	$s1, $zero
	ori	$a2, $zero, 1
...
.LBB18_46:                              # %for.body129.us.us
	...
	add.d	$s6, $a1, $a0
	.p2align	4, , 16
.LBB18_47:                              # %for.cond135.preheader.us.us.us
                                        #   Parent Loop BB18_37 Depth=1
	...
	add.d	$s7, $a2, $a0
	.p2align	4, , 16
.LBB18_48:                              # %for.cond138.preheader.us.us.us
                                        #   Parent Loop BB18_37 Depth=1
                                        #     Parent Loop BB18_46 Depth=2
	...
	ld.d	$a0, $sp, 152                   # 8-byte Folded Reload
	blt	$fp, $a0, .LBB18_48
# %bb.49:                               # %for.cond135.for.end178_crit_edge.us.us.us
                                        #   in Loop: Header=BB18_47 Depth=3
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	ld.d	$a2, $sp, 120                   # 8-byte Folded Reload
	blt	$a0, $s1, .LBB18_45
# %bb.50:                               # %for.cond135.for.end178_crit_edge.us.us.us
                                        #   in Loop: Header=BB18_47 Depth=3
	addi.w	$a2, $a2, 4
	addi.d	$s4, $s4, 4
	addi.d	$s6, $s6, 128
...
# %bb.4:                                # %if.else40
	ori	$a0, $zero, 48
	slli.d	$a2, $a2, 2
	pcalau12i	$a5, %pc_hi20(.LJTI20_1)
	addi.d	$a5, $a5, %pc_lo12(.LJTI20_1)
	ldx.w	$a2, $a5, $a2
	add.d	$a2, $a5, $a2
	jr	$a2
.LBB20_5:                               # %if.then53
...
# %bb.0:                                # %entry
	...
	ld.d	$s2, $a0, %got_pc_lo12(writeIntraPredMode)
	ld.d	$a2, $s2, 0
	addi.d	$a0, $sp, 8
	move	$a1, $fp
	jirl	$ra, $a2, 0
...
.LBB25_4:                               # %cond.end15
	...
	ld.d	$s8, $a4, %got_pc_lo12(assignSE2partition)
	ldptr.w	$a4, $a1, 15268
	beqz	$a4, .LBB25_7
# %bb.5:                                # %if.then
	andi	$t0, $s0, 1
...
.LBB25_33:                              # %if.end172
	...
	ld.d	$s4, $sp, 88                    # 8-byte Folded Reload
	b	.LBB25_47
.LBB25_34:                              # %lor.lhs.false114
	ld.d	$a0, $s0, 0
	ld.w	$a0, $a0, 20
	ori	$a1, $zero, 1
	bne	$a0, $a1, .LBB25_36
# %bb.35:                               # %land.lhs.true117
	ld.w	$a0, $s1, 364
	bnez	$a0, .LBB25_25
.LBB25_36:
	ld.d	$s4, $sp, 88                    # 8-byte Folded Reload
	b	.LBB25_47
.LBB25_37:                              # %lor.lhs.false133
	ori	$a0, $zero, 1
	bne	$a5, $a0, .LBB25_39
# %bb.38:                               # %land.lhs.true136
	ld.w	$a2, $s1, 364
	bnez	$a2, .LBB25_29
.LBB25_39:                              # %if.else180
	ld.w	$a2, $a1, 144
	...
	addi.w	$s0, $zero, -1
	blt	$a0, $a2, .LBB25_42
# %bb.40:                               # %for.cond185.preheader.lr.ph
	ld.d	$a0, $a1, 152
	move	$a2, $zero
	lu12i.w	$a3, 3
	ori	$a3, $a3, 3240
	move	$a4, $s0
	.p2align	4, , 16
.LBB25_41:                              # %for.cond185.preheader
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a5, $a1, 12
	slli.d	$a5, $a5, 3
	ldx.d	$a5, $a0, $a5
...
.LBB25_61:                              # %for.body256
	...
	.p2align	4, , 16
.LBB25_62:                              # %for.body260
                                        #   Parent Loop BB25_61 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a0, $s6, 0
	ld.d	$a1, $fp, 0
	ldx.w	$a2, $a0, $s3
...
# %bb.64:                               # %for.end281
	...
	ldptr.w	$a1, $a0, 15536
	beqz	$a1, .LBB25_253
# %bb.65:                               # %for.cond285.preheader
	ldptr.w	$a1, $a0, 15548
	blez	$a1, .LBB25_253
# %bb.66:                               # %for.body292.lr.ph
	ldptr.w	$a1, $a0, 15544
	ld.d	$s2, $sp, 96                    # 8-byte Folded Reload
	ld.d	$s1, $sp, 88                    # 8-byte Folded Reload
	blez	$a1, .LBB25_190
# %bb.67:                               # %for.body292.preheader
	move	$a2, $zero
	lu12i.w	$a1, 3
	ori	$s4, $a1, 3160
	ori	$s5, $zero, 2
	b	.LBB25_70
	.p2align	4, , 16
.LBB25_68:                              #   in Loop: Header=BB25_70 Depth=1
	ld.d	$s3, $sp, 40                    # 8-byte Folded Reload
.LBB25_69:                              # %for.inc319
	...
	addi.w	$a2, $a2, 1
	bge	$a2, $a1, .LBB25_189
.LBB25_70:                              # %for.body292
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB25_72 Depth 2
	ldptr.w	$a1, $a0, 15544
	st.d	$a2, $sp, 104                   # 8-byte Folded Spill
	blez	$a1, .LBB25_68
# %bb.71:                               # %for.body297.lr.ph
                                        #   in Loop: Header=BB25_70 Depth=1
	ld.w	$a1, $a0, 188
	move	$s6, $zero
	move	$s7, $zero
	...
	ld.d	$s3, $sp, 40                    # 8-byte Folded Reload
	.p2align	4, , 16
.LBB25_72:                              # %for.body297
                                        #   Parent Loop BB25_70 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a1, $fp, 0
	ldx.w	$a2, $a0, $s4
	ldptr.d	$a1, $a1, 6472
...
.LBB25_73:                              # %if.then.i
	addi.d	$a0, $a1, -4
.LBB25_74:                              # %B8Mode2Value.exit
	st.w	$a0, $sp, 124
	st.w	$zero, $sp, 128
	ori	$a0, $zero, 2
	st.w	$a0, $sp, 120
	pcalau12i	$a0, %got_pc_hi20(writeB8_typeInfo)
	ld.d	$fp, $a0, %got_pc_lo12(writeB8_typeInfo)
	ld.d	$a2, $fp, 0
	addi.d	$a0, $sp, 120
	move	$a1, $s2
	jirl	$ra, $a2, 0
...
# %bb.78:                               # %if.else.i.1
	...
	add.d	$a0, $a0, $a2
	b	.LBB25_80
.LBB25_79:                              # %if.then.i.1
	addi.d	$a0, $a0, -4
.LBB25_80:                              # %B8Mode2Value.exit.1
	st.w	$a0, $sp, 124
	ld.d	$a2, $fp, 0
	st.w	$zero, $sp, 128
	ori	$a0, $zero, 2
	...
	add.d	$s0, $a1, $s0
	beqz	$a0, .LBB25_82
.LBB25_81:                              # %lor.rhs360.1
	addi.d	$a0, $a0, -4
	sltui	$a1, $a0, 1
	b	.LBB25_83
.LBB25_82:                              # %land.lhs.true357.1
	pcalau12i	$a1, %pc_hi20(active_sps)
	ld.d	$a1, $a1, %pc_lo12(active_sps)
	ld.w	$a2, $a1, 1156
	ori	$a1, $zero, 1
	beqz	$a2, .LBB25_81
.LBB25_83:                              # %lor.end366.1
	ld.wu	$a0, $s1, 476
	and	$a0, $a0, $a1
	st.w	$a0, $s1, 476
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
...
# %bb.84:                               # %if.else.i.2
	...
	add.d	$a0, $a0, $a2
	b	.LBB25_86
.LBB25_85:                              # %if.then.i.2
	addi.d	$a0, $a0, -4
.LBB25_86:                              # %B8Mode2Value.exit.2
	st.w	$a0, $sp, 124
	ld.d	$a2, $fp, 0
	st.w	$zero, $sp, 128
	ori	$a0, $zero, 2
	...
	add.d	$s0, $a1, $s0
	beqz	$a0, .LBB25_88
.LBB25_87:                              # %lor.rhs360.2
	addi.d	$a0, $a0, -4
	sltui	$a1, $a0, 1
	b	.LBB25_89
.LBB25_88:                              # %land.lhs.true357.2
	pcalau12i	$a1, %pc_hi20(active_sps)
	ld.d	$a1, $a1, %pc_lo12(active_sps)
	ld.w	$a2, $a1, 1156
	ori	$a1, $zero, 1
	beqz	$a2, .LBB25_87
.LBB25_89:                              # %lor.end366.2
	ld.wu	$a0, $s1, 476
	and	$a0, $a0, $a1
	st.w	$a0, $s1, 476
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
...
# %bb.90:                               # %if.else.i.3
	...
	add.d	$a0, $a0, $a2
	b	.LBB25_92
.LBB25_91:                              # %if.then.i.3
	addi.d	$a0, $a0, -4
.LBB25_92:                              # %B8Mode2Value.exit.3
	st.w	$a0, $sp, 124
	ld.d	$a2, $fp, 0
	st.w	$zero, $sp, 128
	ori	$a0, $zero, 2
	...
	add.d	$fp, $a1, $s0
	beqz	$a0, .LBB25_94
.LBB25_93:                              # %lor.rhs360.3
	addi.d	$a0, $a0, -4
	sltui	$a1, $a0, 1
	b	.LBB25_95
.LBB25_94:                              # %land.lhs.true357.3
	pcalau12i	$a1, %pc_hi20(active_sps)
	ld.d	$a1, $a1, %pc_lo12(active_sps)
	ld.w	$a2, $a1, 1156
	ori	$a1, $zero, 1
	beqz	$a2, .LBB25_93
.LBB25_95:                              # %lor.end366.3
	ld.wu	$a0, $s1, 476
	and	$a0, $a0, $a1
	st.w	$a0, $s1, 476
...
# %bb.101:                              # %if.then402
	...
	mul.d	$a1, $a2, $a1
	add.d	$a1, $a0, $a1
	pcalau12i	$a0, %got_pc_hi20(writeCIPredMode)
	ld.d	$a0, $a0, %got_pc_lo12(writeCIPredMode)
	ld.d	$a2, $a0, 0
	addi.d	$a0, $sp, 160
	jirl	$ra, $a2, 0
	ld.w	$a0, $sp, 172
...
# %bb.107:
	move	$s3, $zero
	b	.LBB25_116
.LBB25_108:                             # %lor.lhs.false424
	ld.w	$a1, $a0, 20
	ori	$a2, $zero, 1
	bne	$a1, $a2, .LBB25_253
# %bb.109:                              # %land.lhs.true428
	ld.w	$a1, $s1, 364
	bnez	$a1, .LBB25_106
	b	.LBB25_253
.LBB25_110:                             # %if.then.i156
	st.w	$s6, $sp, 164
	ori	$a0, $zero, 6
	ld.w	$a1, $s8, 24
	ld.d	$a2, $s4, 24
	...
	mul.d	$a0, $a1, $a0
	add.d	$s1, $a2, $a0
	pcalau12i	$a0, %got_pc_hi20(writeCBP)
	ld.d	$a0, $a0, %got_pc_lo12(writeCBP)
	ld.d	$a2, $a0, 0
	addi.d	$a0, $sp, 160
	move	$a1, $s1
	jirl	$ra, $a2, 0
	...
	ori	$a3, $zero, 3
	st.w	$a1, $s2, 40
	bltu	$a2, $a3, .LBB25_115
# %bb.111:                              # %lor.lhs.false.i
	bnez	$a0, .LBB25_114
# %bb.112:                              # %land.lhs.true23.i
	ld.d	$a1, $sp, 112                   # 8-byte Folded Reload
	ld.d	$a1, $a1, 0
	ld.w	$a1, $a1, 20
	ori	$a2, $zero, 1
	bne	$a1, $a2, .LBB25_114
# %bb.113:                              # %land.lhs.true26.i
	pcalau12i	$a1, %pc_hi20(active_sps)
	ld.d	$a1, $a1, %pc_lo12(active_sps)
	ld.w	$a1, $a1, 1156
	bnez	$a1, .LBB25_174
.LBB25_114:                             # %lor.lhs.false27.i
	ld.w	$a1, $s2, 476
	beqz	$a1, .LBB25_116
.LBB25_115:                             # %land.lhs.true29.i
	ori	$a0, $a0, 4
	ori	$a1, $zero, 13
	bne	$a0, $a1, .LBB25_174
.LBB25_116:                             # %if.end48.i
	bnez	$s6, .LBB25_118
# %bb.117:                              # %lor.lhs.false50.i
	ld.w	$a0, $s2, 72
	ori	$a1, $zero, 10
	bne	$a0, $a1, .LBB25_134
.LBB25_118:                             # %if.then53.i
	...
	mul.d	$a1, $a2, $a1
	add.d	$a1, $a0, $a1
	pcalau12i	$a0, %got_pc_hi20(writeDquant)
	ld.d	$a0, $a0, %got_pc_lo12(writeDquant)
	ld.d	$a2, $a0, 0
	addi.d	$a0, $sp, 160
	jirl	$ra, $a2, 0
	ld.w	$a0, $sp, 172
...
.LBB25_122:                             # %for.body109.i
	...
	st.w	$a1, $s2, 44
	add.d	$s3, $a0, $s3
	bltu	$fp, $s1, .LBB25_124
# %bb.123:                              # %for.body109.i
                                        #   in Loop: Header=BB25_122 Depth=1
	addi.d	$s1, $s1, 1
	addi.d	$s5, $s5, 4
	addi.d	$s0, $s0, 4
	bnez	$s6, .LBB25_122
.LBB25_124:                             # %if.end130.i
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
	andi	$a0, $a0, 15
	bnez	$a0, .LBB25_136
	b	.LBB25_160
.LBB25_125:                             # %for.cond80.preheader.i
	andi	$a0, $s6, 1
	bnez	$a0, .LBB25_130
# %bb.126:                              # %for.inc92.i
	andi	$a0, $s6, 2
	bnez	$a0, .LBB25_131
.LBB25_127:                             # %for.inc92.1.i
	andi	$a0, $s6, 4
	bnez	$a0, .LBB25_132
.LBB25_128:                             # %for.inc92.2.i
	andi	$a0, $s6, 8
	bnez	$a0, .LBB25_133
	b	.LBB25_160
.LBB25_129:                             # %if.then407
	st.w	$zero, $s1, 416
	ld.w	$a1, $s1, 72
	move	$a0, $a1
	bstrins.d	$a0, $zero, 3, 3
...
.LBB25_135:                             # %if.then97.i
	...
	andi	$a0, $a0, 15
	beqz	$a0, .LBB25_160
.LBB25_136:                             # %for.cond134.preheader.i
	move	$a2, $zero
	ori	$s6, $zero, 1
	ori	$s0, $zero, 14
	ori	$a1, $zero, 1
	b	.LBB25_138
	.p2align	4, , 16
.LBB25_137:                             # %for.inc219.i
                                        #   in Loop: Header=BB25_138 Depth=1
	ld.d	$a0, $sp, 32                    # 8-byte Folded Reload
	andi	$a0, $a0, 1
	addi.d	$a2, $a2, 2
	move	$a1, $zero
	beqz	$a0, .LBB25_160
.LBB25_138:                             # %for.cond138.preheader.i
                                        # =>This Loop Header: Depth=1
...
.LBB25_140:                             # %for.inc210.1.1.i
	...
	ld.d	$a2, $sp, 64                    # 8-byte Folded Reload
	beqz	$a0, .LBB25_137
.LBB25_141:                             # %for.cond142.preheader.i
                                        #   Parent Loop BB25_138 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB25_143 Depth 3
                                        #       Child Loop BB25_148 Depth 3
                                        #       Child Loop BB25_152 Depth 3
...
# %bb.142:                              # %if.else165.i
	...
	st.w	$s6, $a0, 104
	.p2align	4, , 16
.LBB25_143:                             # %for.body186.i
                                        #   Parent Loop BB25_138 Depth=1
                                        #     Parent Loop BB25_141 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.w	$s5, $fp, 0
	st.w	$s5, $sp, 164
	ld.w	$a0, $s7, 0
...
.LBB25_148:                             # %for.body186.1.i
	...
	st.w	$a1, $s2, 44
	add.d	$s3, $a0, $s3
	bltu	$s0, $s1, .LBB25_150
# %bb.149:                              # %for.body186.1.i
                                        #   in Loop: Header=BB25_148 Depth=3
	addi.d	$s1, $s1, 1
	addi.d	$s7, $s7, 4
	addi.d	$fp, $fp, 4
	bnez	$s5, .LBB25_148
.LBB25_150:                             # %for.inc210.1.i
                                        #   in Loop: Header=BB25_141 Depth=2
	ld.d	$a0, $sp, 104                   # 8-byte Folded Reload
	ld.d	$a0, $a0, 0
	ldptr.w	$a0, $a0, 4008
	beqz	$a0, .LBB25_156
.LBB25_151:                             # %if.else165.1122.i
                                        #   in Loop: Header=BB25_141 Depth=2
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	ld.d	$a0, $a0, 0
	ldptr.d	$a1, $a0, 14160
...
.LBB25_152:                             # %for.body186.1134.i
	...
	st.w	$a1, $s2, 44
	add.d	$s3, $a0, $s3
	bltu	$s0, $s1, .LBB25_154
# %bb.153:                              # %for.body186.1134.i
                                        #   in Loop: Header=BB25_152 Depth=3
	addi.d	$s1, $s1, 1
	addi.d	$s7, $s7, 4
	addi.d	$fp, $fp, 4
	bnez	$s5, .LBB25_152
.LBB25_154:                             # %for.inc210.1141.i
                                        #   in Loop: Header=BB25_141 Depth=2
	ld.d	$a0, $sp, 104                   # 8-byte Folded Reload
	ld.d	$a0, $a0, 0
	ldptr.w	$a0, $a0, 4008
...
.LBB25_158:                             # %for.body186.1.1.i
	...
	st.w	$a1, $s2, 44
	add.d	$s3, $a0, $s3
	bltu	$s0, $s1, .LBB25_140
# %bb.159:                              # %for.body186.1.1.i
	...
	bnez	$s5, .LBB25_158
	b	.LBB25_140
.LBB25_160:                             # %writeCBPandLumaCoeff.exit
...
# %bb.161:                              # %if.then437
	...
	st.d	$a4, $sp, 72                    # 8-byte Folded Spill
	blt	$a5, $a3, .LBB25_173
# %bb.162:                              # %for.cond.preheader.i
	pcalau12i	$a1, %pc_hi20(writeChromaCoeff.chroma_dc_context)
	addi.d	$a1, $a1, %pc_lo12(writeChromaCoeff.chroma_dc_context)
	ldptr.w	$a2, $a2, 4008
	alsl.d	$a3, $a4, $a1, 2
...
.LBB25_168:                             # %lor.end.i
	...
	ori	$a3, $zero, 1
	bnez	$a4, .LBB25_170
.LBB25_169:                             # %lor.rhs42.i
                                        #   in Loop: Header=BB25_165 Depth=1
	addi.d	$a1, $a1, -14
	sltui	$a3, $a1, 1
.LBB25_170:                             # %lor.end45.i
                                        #   in Loop: Header=BB25_165 Depth=1
	st.w	$a3, $a0, 104
	st.w	$zero, $a0, 108
	slli.d	$a0, $a2, 2
...
.LBB25_172:                             # %lor.rhs.i
	...
	or	$a2, $a2, $a3
	st.w	$a2, $sp, 160
	bgeu	$fp, $a1, .LBB25_168
	b	.LBB25_169
.LBB25_173:
	move	$s1, $zero
	b	.LBB25_199
.LBB25_174:                             # %land.lhs.true35.i
	ld.bu	$a0, $s2, 364
	andi	$a0, $a0, 15
	beqz	$a0, .LBB25_116
# %bb.175:                              # %land.rhs.i
...
.LBB25_177:                             # %if.then6.i
	...
	jirl	$ra, $ra, 0
	move	$s1, $a0
.LBB25_178:                             # %for.inc55.i
	ld.d	$a0, $sp, 104                   # 8-byte Folded Reload
	ld.d	$a0, $a0, 0
	ldptr.w	$a0, $a0, 4008
	beqz	$a0, .LBB25_198
.LBB25_179:                             # %if.else.1.i
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	ld.d	$a0, $a0, 0
	ldptr.w	$a1, $a0, 15532
	bltz	$a1, .LBB25_199
# %bb.180:                              # %for.body19.lr.ph.1.i
	ldptr.d	$a1, $a0, 14168
	ld.d	$a1, $a1, 16
	move	$s4, $zero
	ld.d	$s5, $a1, 0
...
.LBB25_181:                             # %for.body19.1.i
	...
	st.w	$s2, $sp, 184
	ld.wu	$a1, $s3, 72
	bltu	$s8, $a1, .LBB25_188
# %bb.182:                              # %for.body19.1.i
                                        #   in Loop: Header=BB25_181 Depth=1
	sll.d	$a2, $fp, $a1
	and	$a3, $a2, $s0
	ori	$a2, $zero, 8
	beqz	$a3, .LBB25_188
# %bb.183:                              # %lor.end.1.i
                                        #   in Loop: Header=BB25_181 Depth=1
	st.w	$a2, $sp, 160
	bltu	$s8, $a1, .LBB25_185
.LBB25_184:                             # %lor.end.1.i
                                        #   in Loop: Header=BB25_181 Depth=1
	sll.d	$a3, $fp, $a1
	and	$a4, $a3, $s0
	ori	$a3, $zero, 1
	bnez	$a4, .LBB25_186
.LBB25_185:                             # %lor.rhs42.1.i
                                        #   in Loop: Header=BB25_181 Depth=1
	addi.d	$a1, $a1, -14
	sltui	$a3, $a1, 1
.LBB25_186:                             # %lor.end45.1.i
                                        #   in Loop: Header=BB25_181 Depth=1
	st.w	$a3, $a0, 104
	st.w	$fp, $a0, 108
	slli.d	$a0, $a2, 2
...
.LBB25_188:                             # %lor.rhs.1.i
	...
	or	$a2, $a2, $a3
	st.w	$a2, $sp, 160
	bgeu	$s8, $a1, .LBB25_184
	b	.LBB25_185
.LBB25_189:                             # %for.inc322
	blez	$a1, .LBB25_253
.LBB25_190:                             # %for.body292.lr.ph.1
	ldptr.w	$a1, $a0, 15544
	blez	$a1, .LBB25_253
# %bb.191:                              # %for.body292.1.preheader
	move	$a2, $zero
	lu12i.w	$a1, 3
	ori	$s0, $a1, 3160
	ori	$s4, $zero, 2
	b	.LBB25_194
	.p2align	4, , 16
.LBB25_192:                             #   in Loop: Header=BB25_194 Depth=1
	ld.d	$s3, $sp, 40                    # 8-byte Folded Reload
.LBB25_193:                             # %for.inc319.1
                                        #   in Loop: Header=BB25_194 Depth=1
	st.d	$s3, $sp, 40                    # 8-byte Folded Spill
	ldptr.w	$a1, $a0, 15548
	ld.d	$a2, $sp, 104                   # 8-byte Folded Reload
	addi.w	$a2, $a2, 1
	bge	$a2, $a1, .LBB25_253
.LBB25_194:                             # %for.body292.1
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB25_196 Depth 2
	ldptr.w	$a1, $a0, 15544
	st.d	$a2, $sp, 104                   # 8-byte Folded Spill
	blez	$a1, .LBB25_192
# %bb.195:                              # %for.body297.lr.ph.1
                                        #   in Loop: Header=BB25_194 Depth=1
	ld.w	$a1, $a0, 188
	move	$s5, $zero
	move	$s6, $zero
	...
	ld.d	$s3, $sp, 40                    # 8-byte Folded Reload
	.p2align	4, , 16
.LBB25_196:                             # %for.body297.1
                                        #   Parent Loop BB25_194 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a1, $fp, 0
	ldx.w	$a2, $a0, $s0
	ldptr.d	$a1, $a1, 6472
...
.LBB25_198:                             # %if.then6.1.i
	...
	jirl	$ra, $ra, 0
	add.d	$s1, $a0, $s1
.LBB25_199:                             # %if.end58.i
	ld.d	$a1, $sp, 80                    # 8-byte Folded Reload
	bstrins.d	$a1, $zero, 3, 0
	ori	$a0, $zero, 32
	bne	$a1, $a0, .LBB25_251
# %bb.200:                              # %for.cond61.preheader.i
	ld.d	$s0, $sp, 112                   # 8-byte Folded Reload
	ld.d	$a0, $s0, 0
	ldptr.w	$a1, $a0, 15528
	blez	$a1, .LBB25_251
# %bb.201:                              # %for.cond65.preheader.lr.ph.i
	ld.d	$a1, $sp, 72                    # 8-byte Folded Reload
	slli.d	$a1, $a1, 5
	pcalau12i	$a2, %pc_hi20(subblk_offset_y)
	addi.d	$a2, $a2, %pc_lo12(subblk_offset_y)
...
.LBB25_202:                             #   in Loop: Header=BB25_204 Depth=1
	ld.d	$s0, $sp, 112                   # 8-byte Folded Reload
	ld.d	$s2, $sp, 72                    # 8-byte Folded Reload
.LBB25_203:                             # %for.inc182.i.3
                                        #   in Loop: Header=BB25_204 Depth=1
	ld.d	$a0, $s0, 0
	ldx.w	$a1, $a0, $s8
	addi.w	$a2, $a1, 3
	addi.d	$a1, $s2, 1
	bge	$s2, $a2, .LBB25_251
.LBB25_204:                             # %for.cond65.preheader.i
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB25_206 Depth 2
...
# %bb.205:                              # %if.else80.i
	...
	st.w	$a1, $a0, 96
	.p2align	4, , 16
.LBB25_206:                             # %for.body118.i
                                        #   Parent Loop BB25_204 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$s2, $s0, 0
	st.w	$s2, $sp, 164
	ld.w	$a0, $s5, 0
	...
	st.w	$a0, $sp, 184
	ld.wu	$a1, $s3, 72
	bltu	$s6, $a1, .LBB25_213
# %bb.207:                              # %for.body118.i
                                        #   in Loop: Header=BB25_206 Depth=2
	ori	$a0, $zero, 1
	sll.d	$a0, $a0, $a1
	and	$a2, $a0, $s4
	ori	$a0, $zero, 10
...
# %bb.208:                              # %lor.end141.i
                                        #   in Loop: Header=BB25_206 Depth=2
	st.w	$a0, $sp, 160
	bltu	$s6, $a1, .LBB25_210
.LBB25_209:                             # %lor.end141.i
                                        #   in Loop: Header=BB25_206 Depth=2
	ori	$a2, $zero, 1
	sll.d	$a2, $a2, $a1
	and	$a3, $a2, $s4
	ori	$a2, $zero, 1
	bnez	$a3, .LBB25_211
.LBB25_210:                             # %lor.rhs156.i
                                        #   in Loop: Header=BB25_206 Depth=2
	addi.d	$a1, $a1, -14
	sltui	$a2, $a1, 1
.LBB25_211:                             # %lor.end160.i
                                        #   in Loop: Header=BB25_206 Depth=2
	ld.d	$a1, $sp, 112                   # 8-byte Folded Reload
	ld.d	$a1, $a1, 0
	ldx.w	$a3, $a1, $s8
...
.LBB25_213:                             # %lor.rhs137.i
	...
	or	$a0, $a0, $a2
	st.w	$a0, $sp, 160
	bgeu	$s6, $a1, .LBB25_209
	b	.LBB25_210
	.p2align	4, , 16
.LBB25_214:                             #   in Loop: Header=BB25_204 Depth=1
	ld.d	$s0, $sp, 112                   # 8-byte Folded Reload
	ld.d	$s2, $sp, 72                    # 8-byte Folded Reload
...
.LBB25_218:                             # %for.body118.i.1
	...
	st.w	$a0, $sp, 184
	ld.wu	$a1, $s3, 72
	bltu	$s6, $a1, .LBB25_225
# %bb.219:                              # %for.body118.i.1
                                        #   in Loop: Header=BB25_218 Depth=2
	ori	$a0, $zero, 1
	sll.d	$a0, $a0, $a1
	and	$a2, $a0, $s4
	ori	$a0, $zero, 10
	beqz	$a2, .LBB25_225
# %bb.220:                              # %lor.end141.i.1
                                        #   in Loop: Header=BB25_218 Depth=2
	st.w	$a0, $sp, 160
	bltu	$s6, $a1, .LBB25_222
.LBB25_221:                             # %lor.end141.i.1
                                        #   in Loop: Header=BB25_218 Depth=2
	ori	$a2, $zero, 1
	sll.d	$a2, $a2, $a1
	and	$a3, $a2, $s4
	ori	$a2, $zero, 1
	bnez	$a3, .LBB25_223
.LBB25_222:                             # %lor.rhs156.i.1
                                        #   in Loop: Header=BB25_218 Depth=2
	addi.d	$a1, $a1, -14
	sltui	$a2, $a1, 1
.LBB25_223:                             # %lor.end160.i.1
                                        #   in Loop: Header=BB25_218 Depth=2
	ld.d	$a1, $sp, 112                   # 8-byte Folded Reload
	ld.d	$a1, $a1, 0
	ldx.w	$a3, $a1, $s8
	...
	add.d	$s1, $a0, $s1
	ori	$a0, $zero, 14
	bltu	$a0, $s7, .LBB25_226
# %bb.224:                              # %lor.end160.i.1
                                        #   in Loop: Header=BB25_218 Depth=2
	addi.d	$s7, $s7, 1
	addi.d	$s5, $s5, 4
	addi.d	$s0, $s0, 4
...
.LBB25_225:                             # %lor.rhs137.i.1
	...
	or	$a0, $a0, $a2
	st.w	$a0, $sp, 160
	bgeu	$s6, $a1, .LBB25_221
	b	.LBB25_222
	.p2align	4, , 16
.LBB25_226:                             #   in Loop: Header=BB25_204 Depth=1
	ld.d	$s0, $sp, 112                   # 8-byte Folded Reload
	ld.d	$s2, $sp, 72                    # 8-byte Folded Reload
	ld.d	$s7, $sp, 64                    # 8-byte Folded Reload
	ld.d	$s5, $sp, 56                    # 8-byte Folded Reload
...
.LBB25_230:                             # %for.body118.i.2
	...
	st.w	$a0, $sp, 184
	ld.wu	$a1, $s3, 72
	bltu	$s6, $a1, .LBB25_237
# %bb.231:                              # %for.body118.i.2
	...
	ori	$a0, $zero, 10
	beqz	$a2, .LBB25_237
# %bb.232:                              # %lor.end141.i.2
                                        #   in Loop: Header=BB25_230 Depth=2
	st.w	$a0, $sp, 160
	bltu	$s6, $a1, .LBB25_234
.LBB25_233:                             # %lor.end141.i.2
                                        #   in Loop: Header=BB25_230 Depth=2
	ori	$a2, $zero, 1
	sll.d	$a2, $a2, $a1
	and	$a3, $a2, $s4
	ori	$a2, $zero, 1
	bnez	$a3, .LBB25_235
.LBB25_234:                             # %lor.rhs156.i.2
                                        #   in Loop: Header=BB25_230 Depth=2
	addi.d	$a1, $a1, -14
	sltui	$a2, $a1, 1
.LBB25_235:                             # %lor.end160.i.2
                                        #   in Loop: Header=BB25_230 Depth=2
	ld.d	$a1, $sp, 112                   # 8-byte Folded Reload
	ld.d	$a1, $a1, 0
	ldx.w	$a3, $a1, $s8
	...
	add.d	$s1, $a0, $s1
	ori	$a0, $zero, 14
	bltu	$a0, $s7, .LBB25_238
# %bb.236:                              # %lor.end160.i.2
                                        #   in Loop: Header=BB25_230 Depth=2
	addi.d	$s7, $s7, 1
	addi.d	$s5, $s5, 4
	addi.d	$s0, $s0, 4
...
.LBB25_237:                             # %lor.rhs137.i.2
	...
	or	$a0, $a0, $a2
	st.w	$a0, $sp, 160
	bgeu	$s6, $a1, .LBB25_233
	b	.LBB25_234
	.p2align	4, , 16
.LBB25_238:                             #   in Loop: Header=BB25_204 Depth=1
	ld.d	$s0, $sp, 112                   # 8-byte Folded Reload
	ld.d	$s2, $sp, 72                    # 8-byte Folded Reload
	ld.d	$s7, $sp, 64                    # 8-byte Folded Reload
	ld.d	$s5, $sp, 56                    # 8-byte Folded Reload
...
.LBB25_242:                             # %for.body118.i.3
	...
	st.w	$a0, $sp, 184
	ld.wu	$a1, $s3, 72
	bltu	$s6, $a1, .LBB25_249
# %bb.243:                              # %for.body118.i.3
                                        #   in Loop: Header=BB25_242 Depth=2
	ori	$a0, $zero, 1
	sll.d	$a0, $a0, $a1
	and	$a2, $a0, $s4
	ori	$a0, $zero, 10
	beqz	$a2, .LBB25_249
# %bb.244:                              # %lor.end141.i.3
                                        #   in Loop: Header=BB25_242 Depth=2
	st.w	$a0, $sp, 160
	bltu	$s6, $a1, .LBB25_246
.LBB25_245:                             # %lor.end141.i.3
                                        #   in Loop: Header=BB25_242 Depth=2
	ori	$a2, $zero, 1
	sll.d	$a2, $a2, $a1
	and	$a3, $a2, $s4
	ori	$a2, $zero, 1
	bnez	$a3, .LBB25_247
.LBB25_246:                             # %lor.rhs156.i.3
                                        #   in Loop: Header=BB25_242 Depth=2
	addi.d	$a1, $a1, -14
	sltui	$a2, $a1, 1
.LBB25_247:                             # %lor.end160.i.3
                                        #   in Loop: Header=BB25_242 Depth=2
	ld.d	$a1, $sp, 112                   # 8-byte Folded Reload
	ld.d	$a1, $a1, 0
	ldx.w	$a3, $a1, $s8
	...
	add.d	$s1, $a0, $s1
	ori	$a0, $zero, 14
	bltu	$a0, $s7, .LBB25_202
# %bb.248:                              # %lor.end160.i.3
                                        #   in Loop: Header=BB25_242 Depth=2
	addi.d	$s7, $s7, 1
	addi.d	$s5, $s5, 4
	addi.d	$s0, $s0, 4
...
.LBB25_249:                             # %lor.rhs137.i.3
	...
	or	$a0, $a0, $a2
	st.w	$a0, $sp, 160
	bgeu	$s6, $a1, .LBB25_245
	b	.LBB25_246
	.p2align	4, , 16
.LBB25_250:                             # %if.then70.i.3
                                        #   in Loop: Header=BB25_204 Depth=1
	ld.d	$a0, $sp, 48                    # 8-byte Folded Reload
	ld.bu	$a3, $a0, -13
	ori	$a0, $zero, 7
	...
	add.d	$s1, $a0, $s1
	b	.LBB25_203
.LBB25_251:                             # %writeChromaCoeff.exit
	ld.d	$a1, $sp, 8                     # 8-byte Folded Reload
	ld.w	$a0, $a1, 0
	add.d	$s3, $a0, $s1
	st.w	$s3, $a1, 0
...
# %bb.0:                                # %entry
	...
	st.w	$a2, $a0, 100
	slli.d	$a0, $a6, 3
	pcalau12i	$a1, %got_pc_hi20(writeRefFrame)
	ld.d	$a1, $a1, %got_pc_lo12(writeRefFrame)
	ldx.d	$a2, $a1, $a0
	addi.d	$a0, $sp, 8
	move	$a1, $a3
	jirl	$ra, $a2, 0
...
# %bb.6:                                # %for.cond26.preheader.lr.ph
	ld.d	$a3, $sp, 32                    # 8-byte Folded Reload
	bge	$a3, $a2, .LBB31_32
# %bb.7:                                # %for.cond26.preheader.lr.ph.split.us
	...
	blez	$s0, .LBB31_34
# %bb.8:                                # %for.cond26.preheader.us.us.preheader
	addi.d	$a2, $a5, 2
	st.d	$a2, $sp, 88                    # 8-byte Folded Spill
	...
	b	.LBB31_10
	.p2align	4, , 16
.LBB31_9:                               # %for.cond26.for.inc94_crit_edge.split.us.us.us
	...
	ld.d	$a0, $sp, 72                    # 8-byte Folded Reload
	bge	$s8, $a0, .LBB31_33
.LBB31_10:                              # %for.cond26.preheader.us.us
                                        # =>This Loop Header: Depth=1
	...
	b	.LBB31_12
	.p2align	4, , 16
.LBB31_11:                              # %for.cond60.for.end79_crit_edge.us.us.us.us.1
	...
	bge	$t6, $a0, .LBB31_9
.LBB31_12:                              # %for.cond30.preheader.us.us.us
	...
	sub.d	$a0, $a0, $a1
	blez	$s5, .LBB31_22
# %bb.13:                               # %for.cond64.preheader.us.us.us.us.us.preheader
                                        #   in Loop: Header=BB31_12 Depth=2
	move	$a1, $zero
	move	$a2, $t1
	move	$a3, $t2
	b	.LBB31_15
	.p2align	4, , 16
.LBB31_14:                              # %for.cond64.for.inc77_crit_edge.us.us.us.us.us
                                        #   in Loop: Header=BB31_15 Depth=3
	addi.d	$a1, $a1, 1
	addi.d	$a3, $a3, 32
	addi.d	$a2, $a2, 32
	beq	$a1, $s0, .LBB31_22
.LBB31_15:                              # %for.cond64.preheader.us.us.us.us.us
                                        #   Parent Loop BB31_10 Depth=1
...
# %bb.16:                               #   in Loop: Header=BB31_15 Depth=3
	...
	b	.LBB31_20
	.p2align	4, , 16
.LBB31_17:                              # %vector.body113.preheader
                                        #   in Loop: Header=BB31_15 Depth=3
	move	$a4, $fp
	move	$a7, $a3
	.p2align	4, , 16
.LBB31_18:                              # %vector.body113
                                        #   Parent Loop BB31_10 Depth=1
                                        #     Parent Loop BB31_12 Depth=2
	...
	addi.d	$a7, $a7, 16
	bnez	$a4, .LBB31_18
# %bb.19:                               # %middle.block116
                                        #   in Loop: Header=BB31_15 Depth=3
	move	$a7, $fp
	beq	$fp, $s1, .LBB31_14
.LBB31_20:                              # %for.body67.us.us.us.us.us.preheader
                                        #   in Loop: Header=BB31_15 Depth=3
	alsl.d	$a4, $a7, $a2, 3
	sub.d	$a7, $s1, $a7
	.p2align	4, , 16
.LBB31_21:                              # %for.body67.us.us.us.us.us
                                        #   Parent Loop BB31_10 Depth=1
                                        #     Parent Loop BB31_12 Depth=2
                                        #       Parent Loop BB31_15 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
	...
	b	.LBB31_14
	.p2align	4, , 16
.LBB31_22:                              # %for.cond60.for.end79_crit_edge.us.us.us.us
                                        #   in Loop: Header=BB31_12 Depth=2
	...
	sub.d	$a0, $a0, $a2
	blez	$s5, .LBB31_11
# %bb.23:                               # %for.cond64.preheader.us.us.us.us.us.preheader.1
                                        #   in Loop: Header=BB31_12 Depth=2
	move	$a2, $zero
	ld.d	$a3, $sp, 200                   # 8-byte Folded Reload
	...
	b	.LBB31_25
	.p2align	4, , 16
.LBB31_24:                              # %for.cond64.for.inc77_crit_edge.us.us.us.us.us.1
                                        #   in Loop: Header=BB31_25 Depth=3
	addi.d	$a2, $a2, 1
	addi.d	$a4, $a4, 32
	addi.d	$a3, $a3, 32
	beq	$a2, $s0, .LBB31_11
.LBB31_25:                              # %for.cond64.preheader.us.us.us.us.us.1
                                        #   Parent Loop BB31_10 Depth=1
                                        #     Parent Loop BB31_12 Depth=2
                                        # =>    This Loop Header: Depth=3
                                        #         Child Loop BB31_28 Depth 4
...
# %bb.29:                               # %middle.block
	...
	move	$a6, $fp
	beq	$fp, $s1, .LBB31_24
.LBB31_30:                              # %for.body67.us.us.us.us.us.1.preheader
                                        #   in Loop: Header=BB31_25 Depth=3
	alsl.d	$a5, $a6, $a3, 3
	sub.d	$a6, $s1, $a6
	.p2align	4, , 16
.LBB31_31:                              # %for.body67.us.us.us.us.us.1
                                        #   Parent Loop BB31_10 Depth=1
                                        #     Parent Loop BB31_12 Depth=2
                                        #       Parent Loop BB31_25 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
...
.LBB31_33:                              # %for.end96
	...
	addi.d	$sp, $sp, 368
	ret
.LBB31_34:                              # %for.cond26.preheader.us.preheader
	addi.d	$a0, $a5, 2
	st.d	$a0, $sp, 160                   # 8-byte Folded Spill
	ld.d	$a0, $sp, 32                    # 8-byte Folded Reload
	slli.d	$a0, $a0, 3
	...
	ori	$a7, $zero, 5
	pcalau12i	$a0, %got_pc_hi20(writeMVD)
	ld.d	$t1, $a0, %got_pc_lo12(writeMVD)
	st.d	$zero, $sp, 224                 # 8-byte Folded Spill
	st.d	$a1, $sp, 152                   # 8-byte Folded Spill
	st.d	$t1, $sp, 200                   # 8-byte Folded Spill
	.p2align	4, , 16
.LBB31_35:                              # %for.cond26.preheader.us
                                        # =>This Loop Header: Depth=1
	...
	.p2align	4, , 16
.LBB31_36:                              # %for.cond30.preheader.us63
	...
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	blt	$s1, $a0, .LBB31_36
# %bb.37:                               # %for.cond26.for.inc94_crit_edge.split.us67
...
# %bb.1:                                # %entry
	...
	ldx.d	$a6, $a7, $a6
	slli.d	$a0, $a0, 2
	pcalau12i	$a7, %pc_hi20(.LJTI35_0)
	addi.d	$a7, $a7, %pc_lo12(.LJTI35_0)
	ldx.w	$a0, $a7, $a0
	add.d	$a0, $a7, $a0
	jr	$a0
.LBB35_2:                               # %sw.bb
...
.LBB35_21:
	...
	move	$s4, $zero
	b	.LBB35_23
.LBB35_22:                              # %for.inc.us.if.then131_crit_edge
	addi.w	$a7, $s4, -1
.LBB35_23:                              # %if.then131
...
.LBB35_38:
	...
	st.d	$s7, $sp, 64                    # 8-byte Folded Spill
	bltz	$s6, .LBB35_46
.LBB35_39:                              # %for.body239.preheader
	ori	$a0, $zero, 10
	slli.d	$a1, $s6, 2
	ldx.w	$fp, $s2, $a1
	slt	$a0, $a0, $s4
...
# %bb.43:                               # %if.else259.peel
	...
	jirl	$ra, $ra, 0
	b	.LBB35_45
.LBB35_44:                              # %if.then257.peel
	ld.d	$a1, $sp, 72                    # 8-byte Folded Reload
	move	$a2, $a3
	pcaddu18i	$ra, %call36(writeSyntaxElement_Level_VLC1)
	jirl	$ra, $ra, 0
.LBB35_45:                              # %if.end262.peel
	slli.d	$a0, $s1, 2
	pcalau12i	$a1, %pc_hi20(writeCoeff4x4_CAVLC.incVlc)
	addi.d	$s2, $a1, %pc_lo12(writeCoeff4x4_CAVLC.incVlc)
	ld.w	$a1, $sp, 92
	ld.w	$a2, $s8, 0
	ldx.w	$a0, $s2, $a0
	add.d	$a2, $a2, $a1
...
.LBB35_49:
	...
	bgez	$fp, .LBB35_57
	b	.LBB35_64
.LBB35_50:                              # %for.body239.peel.next
	srai.d	$a1, $fp, 31
	xor	$a2, $fp, $a1
	sub.w	$a1, $a2, $a1
	ori	$a2, $zero, 3
...
.LBB35_56:                              # %if.end296
	...
	add.w	$s0, $a0, $s0
	bltz	$fp, .LBB35_64
.LBB35_57:                              # %for.body306.lr.ph
	ori	$s1, $zero, 2
	blt	$s4, $s1, .LBB35_63
# %bb.58:                               # %for.body306.preheader
	addi.d	$s2, $fp, 1
	ld.d	$a0, $sp, 32                    # 8-byte Folded Reload
	alsl.d	$s5, $fp, $a0, 2
	ori	$s6, $zero, 7
	...
	.p2align	4, , 16
.LBB35_59:                              # %for.inc335
                                        #   in Loop: Header=BB35_60 Depth=1
	addi.d	$s2, $s2, -1
	addi.d	$s5, $s5, -4
	move	$s4, $a0
	blez	$s2, .LBB35_64
.LBB35_60:                              # %for.body306
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$fp, $s5, 0
	st.w	$fp, $sp, 84
	st.w	$s7, $sp, 80
...
.LBB35_66:                              # %if.else99
	move	$a0, $zero
	b	.LBB35_16
.LBB35_67:                              # %for.inc.if.end179.thread.loopexit_crit_edge
	addi.w	$a1, $s4, -1
.LBB35_68:                              # %if.end179.thread
	st.d	$a1, $sp, 56                    # 8-byte Folded Spill
.LBB35_69:                              # %if.end179.thread
	ldx.w	$a0, $a5, $a0
	st.d	$a0, $sp, 48                    # 8-byte Folded Spill
...
.LBB38_55:                              # %for.cond124.preheader
	...
	vpickve2gr.w	$a4, $vr14, 1
	vpickve2gr.w	$a5, $vr14, 2
	...
	vpickve2gr.w	$a4, $vr17, 1
	vpickve2gr.w	$a5, $vr17, 2
	vpickve2gr.w	$t0, $vr17, 3
	st.w	$a0, $a2, -960
	st.w	$a4, $a2, -896
	st.w	$a5, $a2, -832
	st.w	$t0, $a2, -768
	...
	vpickve2gr.w	$a4, $vr20, 1
	vpickve2gr.w	$a5, $vr20, 2
	vpickve2gr.w	$t0, $vr20, 3
	st.w	$a0, $a2, -720
	st.w	$a4, $a2, -656
	st.w	$a5, $a2, -592
	st.w	$t0, $a2, -528
	...
	vpickve2gr.w	$a4, $vr21, 1
	vpickve2gr.w	$a5, $vr21, 2
	st.w	$a0, $a2, -704
	st.w	$a4, $a2, -640
	st.w	$a5, $a2, -576
