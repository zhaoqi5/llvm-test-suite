...
# %bb.44:                               # %land.lhs.true79
	bnez	$a1, .LBB4_56
# %bb.45:                               # %for.cond.preheader.i99
	ld.w	$a1, $s2, 16
	ori	$a2, $zero, 1
	blt	$a1, $a2, .LBB4_56
# %bb.46:                               # %for.body.lr.ph.i102
	ld.d	$a2, $s2, 24
	ld.w	$a3, $a3, 268
	.p2align	4, , 16
.LBB4_47:                               # %for.body.i106
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a4, $a2, 0
	ld.w	$a5, $a4, 4
	ld.w	$a4, $a4, 0
...
# %bb.48:                               # %for.cond.i117
	...
	bnez	$a1, .LBB4_47
	b	.LBB4_56
.LBB4_49:                               # %for.cond17.preheader.i84
	ld.w	$a0, $s2, 16
	blt	$a0, $a2, .LBB4_56
# %bb.50:                               # %for.body20.i89.preheader
	move	$s4, $zero
	ori	$fp, $zero, 8
	.p2align	4, , 16
.LBB4_51:                               # %for.body20.i89
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $s2, 24
	add.d	$a0, $a0, $fp
	pcaddu18i	$ra, %call36(arienco_bits_written)
...
# %bb.126:                              #   in Loop: Header=BB17_27 Depth=1
	move	$t1, $s8
	b	.LBB17_133
.LBB17_127:                             # %vector.body822.preheader
                                        #   in Loop: Header=BB17_27 Depth=1
	addi.d	$a0, $sp, 540
	addi.d	$a1, $sp, 906
...
.LBB17_128:                             # %vector.body822
	...
	addi.d	$a0, $a0, 48
	bnez	$a2, .LBB17_128
# %bb.129:                              # %middle.block825
                                        #   in Loop: Header=BB17_27 Depth=1
	ld.d	$a0, $sp, 208                   # 8-byte Folded Reload
	move	$a2, $a0
	move	$t1, $s8
	beq	$a0, $t2, .LBB17_132
.LBB17_130:                             # %for.body433.preheader830
                                        #   in Loop: Header=BB17_27 Depth=1
	alsl.d	$a0, $a2, $t3, 1
	sub.d	$a1, $t2, $a2
	slli.d	$a3, $a2, 4
...
# %bb.141:                              # %vec.epilog.middle.block
	...
	b	.LBB17_146
	.p2align	4, , 16
.LBB17_142:                             # %vector.body804.preheader
                                        #   in Loop: Header=BB17_135 Depth=2
	addi.d	$a4, $sp, 904
	move	$a5, $a2
	move	$a6, $t4
	.p2align	4, , 16
.LBB17_143:                             # %vector.body804
                                        #   Parent Loop BB17_27 Depth=1
                                        #     Parent Loop BB17_135 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	xvld	$xr0, $a4, 0
...
# %bb.155:                              # %middle.block792
	...
	beq	$a5, $a3, .LBB17_158
.LBB17_156:                             # %for.body507.preheader829
                                        #   in Loop: Header=BB17_27 Depth=1
	slli.d	$a3, $a7, 1
...
# %bb.165:                              # %middle.block770
	...
	beq	$a5, $a2, .LBB17_168
.LBB17_166:                             # %for.body547.preheader828
                                        #   in Loop: Header=BB17_27 Depth=1
	slli.d	$a2, $a7, 1
	ld.d	$a5, $sp, 64                    # 8-byte Folded Reload
	sub.d	$a2, $a5, $a2
...
# %bb.197:                              # %for.body692.us.us
	...
	.p2align	4, , 16
.LBB17_198:                             # %for.cond699.preheader.us.us.us
	...
	add.d	$s8, $a2, $a0
	.p2align	4, , 16
.LBB17_199:                             # %for.cond703.preheader.us.us.us
                                        #   Parent Loop BB17_186 Depth=1
	...
	ld.d	$a0, $sp, 464                   # 8-byte Folded Reload
	blt	$s4, $a0, .LBB17_199
# %bb.200:                              # %for.cond699.for.inc750_crit_edge.us.us.us
	...
	ld.d	$a0, $sp, 424                   # 8-byte Folded Reload
	blt	$a1, $a0, .LBB17_198
# %bb.201:                              # %for.cond695.for.inc753_crit_edge.split.us.us.us
                                        #   in Loop: Header=BB17_186 Depth=1
	ld.d	$a0, $sp, 344                   # 8-byte Folded Reload
	ld.d	$a0, $a0, %pc_lo12(imgUV_org)
	ld.d	$fp, $a0, 8
	...
	.p2align	4, , 16
.LBB17_202:                             # %for.cond699.preheader.us.us.us.1
                                        #   Parent Loop BB17_186 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB17_203 Depth 3
	st.d	$a1, $sp, 408                   # 8-byte Folded Spill
	...
	add.d	$s8, $a2, $a0
	.p2align	4, , 16
.LBB17_203:                             # %for.cond703.preheader.us.us.us.1
                                        #   Parent Loop BB17_186 Depth=1
	...
	ld.d	$a0, $sp, 464                   # 8-byte Folded Reload
	blt	$s4, $a0, .LBB17_203
# %bb.204:                              # %for.cond699.for.inc750_crit_edge.us.us.us.1
...
# %bb.31:                               # %middle.block
	ld.d	$a1, $sp, 104                   # 8-byte Folded Reload
	beq	$a0, $a1, .LBB18_34
.LBB18_32:                              # %for.body89.preheader194
	slli.d	$a1, $a0, 4
	alsl.d	$a1, $a0, $a1, 3
	addi.d	$a2, $sp, 168
	add.d	$a1, $a1, $a2
...
.LBB18_44:                              # %if.end126
	...
	ld.d	$a0, $sp, 32                    # 8-byte Folded Reload
	beqz	$a0, .LBB18_35
# %bb.45:                               # %for.body129.us.us.preheader
                                        #   in Loop: Header=BB18_38 Depth=1
	move	$a0, $zero
	move	$s1, $zero
	ori	$a2, $zero, 1
...
.LBB18_47:                              # %for.body129.us.us
	...
	add.d	$s6, $a1, $a0
	.p2align	4, , 16
.LBB18_48:                              # %for.cond135.preheader.us.us.us
                                        #   Parent Loop BB18_38 Depth=1
	...
	add.d	$s7, $a2, $a0
	.p2align	4, , 16
.LBB18_49:                              # %for.cond138.preheader.us.us.us
                                        #   Parent Loop BB18_38 Depth=1
                                        #     Parent Loop BB18_47 Depth=2
...
# %bb.50:                               # %for.cond135.for.end178_crit_edge.us.us.us
	...
	blt	$a0, $s1, .LBB18_46
# %bb.51:                               # %for.cond135.for.end178_crit_edge.us.us.us
                                        #   in Loop: Header=BB18_48 Depth=3
	addi.w	$a2, $a2, 4
	addi.d	$s4, $s4, 4
	addi.d	$s6, $s6, 128
...
# %bb.16:                               #   in Loop: Header=BB31_15 Depth=3
	...
	b	.LBB31_20
	.p2align	4, , 16
.LBB31_17:                              # %vector.body106.preheader
                                        #   in Loop: Header=BB31_15 Depth=3
...
.LBB31_22:                              # %for.cond60.for.end79_crit_edge.us.us.us.us
	...
	ori	$a2, $zero, 1
	blt	$s0, $a2, .LBB31_11
# %bb.23:                               # %for.cond64.preheader.us.us.us.us.us.1.preheader
                                        #   in Loop: Header=BB31_12 Depth=2
	move	$a2, $zero
	ld.d	$a3, $sp, 48                    # 8-byte Folded Reload
	b	.LBB31_25
