...
.LBB2_13:                               # %for.cond64.preheader
	...
	addi.w	$s8, $s7, 37
	blt	$s7, $a5, .LBB2_31
# %bb.14:                               # %for.body68.lr.ph.split.us
	st.d	$s3, $sp, 24                    # 8-byte Folded Spill
	ld.d	$a5, $t1, 0
	ldx.w	$t1, $a5, $t2
	ori	$a5, $zero, 3
	...
	b	.LBB2_16
	.p2align	4, , 16
.LBB2_15:                               # %for.cond76.for.cond64.loopexit_crit_edge.us
                                        #   in Loop: Header=BB2_16 Depth=1
	move	$t8, $t7
	beq	$t6, $t2, .LBB2_94
.LBB2_16:                               # %for.body68.us
                                        # =>This Loop Header: Depth=1
...
# %bb.17:                               #   in Loop: Header=BB2_16 Depth=1
	move	$a6, $zero
.LBB2_18:                               # %for.body79.us.preheader
                                        #   in Loop: Header=BB2_16 Depth=1
	alsl.d	$t3, $a6, $t8, 1
	alsl.d	$t8, $a6, $t7, 1
	alsl.d	$fp, $a6, $s0, 1
...
.LBB2_19:                               # %for.body79.us
	...
	b	.LBB2_15
	.p2align	4, , 16
.LBB2_20:                               # %vector.memcheck488
                                        #   in Loop: Header=BB2_16 Depth=1
	sub.d	$t3, $a7, $t8
	move	$a6, $zero
	bltu	$t3, $t5, .LBB2_18
# %bb.21:                               # %vector.memcheck488
                                        #   in Loop: Header=BB2_16 Depth=1
	sub.d	$t3, $a7, $t7
	bltu	$t3, $t5, .LBB2_18
# %bb.22:                               # %vector.memcheck488
                                        #   in Loop: Header=BB2_16 Depth=1
	sub.d	$t3, $a7, $s0
	bltu	$t3, $t5, .LBB2_18
# %bb.23:                               # %vector.memcheck488
                                        #   in Loop: Header=BB2_16 Depth=1
	sub.d	$t3, $a7, $s1
	bltu	$t3, $t5, .LBB2_18
# %bb.24:                               # %vector.memcheck488
                                        #   in Loop: Header=BB2_16 Depth=1
	sub.d	$t3, $a7, $s2
	bltu	$t3, $t5, .LBB2_18
# %bb.25:                               # %vector.memcheck488
                                        #   in Loop: Header=BB2_16 Depth=1
	sub.d	$t3, $a7, $s3
	bltu	$t3, $t5, .LBB2_18
# %bb.26:                               # %vector.body507.preheader
                                        #   in Loop: Header=BB2_16 Depth=1
	move	$s4, $t8
	move	$s5, $t7
	move	$s6, $s0
...
.LBB2_27:                               # %vector.body507
	...
	addi.d	$s4, $s4, 16
	bnez	$t3, .LBB2_27
# %bb.28:                               # %middle.block516
                                        #   in Loop: Header=BB2_16 Depth=1
	move	$a6, $a5
	ld.d	$s7, $sp, 32                    # 8-byte Folded Reload
	beq	$a5, $a4, .LBB2_15
	b	.LBB2_18
.LBB2_29:                               # %for.cond260.preheader.thread
	addi.w	$a5, $s7, 37
	addi.w	$a4, $zero, -40
	blt	$a4, $t0, .LBB2_69
	b	.LBB2_116
.LBB2_30:                               # %for.cond64.preheader.thread
	addi.w	$s8, $s7, 37
.LBB2_31:                               # %for.body134.lr.ph
	addi.w	$a4, $zero, -40
	bge	$a4, $t0, .LBB2_116
.LBB2_32:                               # %for.body148.lr.ph
	pcalau12i	$a4, %got_pc_hi20(img)
	ld.d	$a4, $a4, %got_pc_lo12(img)
	ld.d	$t0, $a4, 0
	ori	$a4, $zero, 1
...
# %bb.38:
	move	$s1, $zero
.LBB2_39:                               # %for.body148.1.preheader
	sub.d	$s2, $a4, $s1
	alsl.d	$t4, $s1, $t4, 1
	alsl.d	$s0, $s1, $s0, 1
	alsl.d	$fp, $s1, $fp, 1
...
# %bb.42:
	move	$a0, $zero
.LBB2_43:                               # %for.body148.2.preheader
	sub.d	$a4, $a4, $a0
	alsl.d	$a2, $a0, $a2, 1
	alsl.d	$a3, $a0, $a3, 1
	alsl.d	$t0, $a0, $t3, 1
...
# %bb.47:                               # %middle.block
	beq	$fp, $a4, .LBB2_50
.LBB2_48:                               # %for.body215.us.preheader
	alsl.d	$s0, $fp, $t4, 2
	alsl.d	$s1, $fp, $t5, 2
	alsl.d	$s2, $fp, $t6, 2
	alsl.d	$s3, $fp, $t7, 2
...
.LBB2_49:                               # %for.body215.us
	...
	addi.d	$a7, $a7, 2
	bnez	$fp, .LBB2_49
.LBB2_50:                               # %for.cond212.for.cond199.loopexit_crit_edge.us
	ld.d	$a7, $a2, 8
	ld.d	$t8, $t8, 32
	ori	$a6, $zero, 4
	bge	$a0, $a6, .LBB2_52
...
.LBB2_53:                               # %vector.body351
	...
	addi.d	$s0, $s0, 16
	bnez	$s5, .LBB2_53
# %bb.54:                               # %middle.block359
	beq	$fp, $a4, .LBB2_57
.LBB2_55:                               # %for.body215.us.1.preheader
	sub.d	$s0, $a4, $fp
	alsl.d	$a7, $fp, $a7, 1
	alsl.d	$t8, $fp, $t8, 2
	alsl.d	$t7, $fp, $t7, 2
...
.LBB2_56:                               # %for.body215.us.1
	...
	addi.d	$t5, $t5, 4
	bnez	$s0, .LBB2_56
.LBB2_57:                               # %for.cond260.preheader
	addi.w	$a6, $zero, -35
	addi.w	$a5, $s7, 37
	bge	$a6, $s7, .LBB2_68
# %bb.58:                               # %for.body264.lr.ph
	ld.d	$a6, $t1, 0
	...
	b	.LBB2_60
	.p2align	4, , 16
.LBB2_59:                               # %for.cond272.for.cond260.loopexit_crit_edge.us
                                        #   in Loop: Header=BB2_60 Depth=1
	move	$t8, $t7
	beq	$t6, $t4, .LBB2_67
.LBB2_60:                               # %for.body264.us
                                        # =>This Loop Header: Depth=1
...
# %bb.61:                               #   in Loop: Header=BB2_60 Depth=1
	...
	b	.LBB2_65
	.p2align	4, , 16
.LBB2_62:                               # %vector.body369.preheader
                                        #   in Loop: Header=BB2_60 Depth=1
	move	$s3, $t8
	move	$s4, $t7
	move	$s5, $a7
...
.LBB2_63:                               # %vector.body369
	...
	addi.d	$s3, $s3, 16
	bnez	$t3, .LBB2_63
# %bb.64:                               # %middle.block378
                                        #   in Loop: Header=BB2_60 Depth=1
	move	$t3, $a6
	beq	$a6, $a4, .LBB2_59
.LBB2_65:                               # %for.body275.us.preheader
                                        #   in Loop: Header=BB2_60 Depth=1
	alsl.d	$t8, $t3, $t8, 2
	alsl.d	$s3, $t3, $t7, 2
	alsl.d	$a7, $t3, $a7, 2
...
.LBB2_67:
	ld.d	$s7, $sp, 32                    # 8-byte Folded Reload
.LBB2_68:                               # %for.body324.lr.ph
	ld.d	$s3, $sp, 24                    # 8-byte Folded Reload
	addi.w	$a4, $zero, -40
	bge	$a4, $t0, .LBB2_116
.LBB2_69:                               # %for.body338.lr.ph
...
.LBB2_72:                               # %vector.body388
	...
	addi.d	$s1, $s1, 16
	bnez	$a6, .LBB2_72
# %bb.73:                               # %middle.block397
	ld.d	$s7, $sp, 32                    # 8-byte Folded Reload
	beq	$a7, $a3, .LBB2_76
.LBB2_74:                               # %for.body338.preheader
	alsl.d	$t4, $a7, $t4, 1
	alsl.d	$s0, $a7, $s0, 2
	alsl.d	$fp, $a7, $fp, 2
	alsl.d	$t8, $a7, $t8, 2
...
.LBB2_84:                               # %vector.body450
	...
	addi.d	$a7, $a7, 16
	bnez	$s3, .LBB2_84
# %bb.85:                               # %middle.block457
	bne	$t8, $a4, .LBB2_7
	b	.LBB2_9
.LBB2_86:                               # %vector.memcheck460
	sub.d	$a7, $t7, $t4
	ori	$a6, $zero, 16
	move	$fp, $zero
	move	$s3, $s5
	bltu	$a7, $a6, .LBB2_11
# %bb.87:                               # %vector.memcheck460
	sub.d	$a7, $t7, $t5
	bltu	$a7, $a6, .LBB2_11
# %bb.88:                               # %vector.memcheck460
	sub.d	$a7, $t7, $t3
	ori	$a6, $zero, 16
	bltu	$a7, $a6, .LBB2_11
# %bb.89:                               # %vector.memcheck460
	sub.d	$a7, $t7, $t6
	bltu	$a7, $a6, .LBB2_11
# %bb.90:                               # %vector.memcheck460
	sub.d	$a6, $t7, $t8
	ori	$a7, $zero, 16
	bltu	$a6, $a7, .LBB2_11
# %bb.91:                               # %vector.ph472
...
# %bb.3:                                # %for.body.us.us.preheader
	...
	b	.LBB3_5
	.p2align	4, , 16
.LBB3_4:                                # %for.cond34.for.inc52_crit_edge.us.us
...
# %bb.6:                                #   in Loop: Header=BB3_5 Depth=1
	move	$ra, $zero
.LBB3_7:                                # %for.body23.us.us.preheader
                                        #   in Loop: Header=BB3_5 Depth=1
	add.d	$fp, $s5, $t6
	alsl.d	$s6, $ra, $fp, 1
	alsl.d	$s7, $ra, $s3, 1
...
.LBB3_8:                                # %for.body23.us.us
	...
	addi.d	$s8, $s8, 2
	bnez	$ra, .LBB3_8
.LBB3_9:                                # %for.cond21.for.cond34.preheader_crit_edge.us.us
                                        #   in Loop: Header=BB3_5 Depth=1
	alsl.d	$s6, $a4, $s5, 1
	move	$ra, $t0
	bgeu	$a7, $s1, .LBB3_17
.LBB3_10:                               # %for.body37.us.us.preheader
                                        #   in Loop: Header=BB3_5 Depth=1
	alsl.d	$s4, $ra, $s4, 1
	alsl.d	$s3, $ra, $s3, 1
	.p2align	4, , 16
.LBB3_11:                               # %for.body37.us.us
                                        #   Parent Loop BB3_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$fp, $s3, 0
	ld.hu	$s5, $s6, 0
	...
	b	.LBB3_4
	.p2align	4, , 16
.LBB3_12:                               # %vector.memcheck142
                                        #   in Loop: Header=BB3_5 Depth=1
	sub.d	$fp, $s4, $s3
	move	$ra, $zero
	bltu	$fp, $s2, .LBB3_7
# %bb.13:                               # %vector.memcheck142
                                        #   in Loop: Header=BB3_5 Depth=1
	add.d	$fp, $t6, $s5
	sub.d	$fp, $s4, $fp
	bltu	$fp, $s2, .LBB3_7
# %bb.14:                               # %vector.body151.preheader
                                        #   in Loop: Header=BB3_5 Depth=1
	alsl.d	$s6, $a7, $s5, 1
	move	$s7, $s3
	move	$s8, $s4
...
.LBB3_15:                               # %vector.body151
	...
	addi.d	$s7, $s7, 16
	bnez	$ra, .LBB3_15
# %bb.16:                               # %middle.block156
                                        #   in Loop: Header=BB3_5 Depth=1
	move	$ra, $t7
	bne	$t7, $t0, .LBB3_7
	b	.LBB3_9
	.p2align	4, , 16
.LBB3_17:                               # %vector.memcheck114
                                        #   in Loop: Header=BB3_5 Depth=1
	add.d	$s7, $s4, $t2
	add.d	$fp, $s4, $t3
	add.d	$s8, $s3, $t2
...
.LBB3_33:                               # %for.body.us.preheader
	...
	b	.LBB3_35
	.p2align	4, , 16
.LBB3_34:                               # %for.cond21.for.cond34.preheader_crit_edge.us
...
# %bb.36:                               #   in Loop: Header=BB3_35 Depth=1
	move	$t7, $zero
.LBB3_37:                               # %for.body23.us.preheader
                                        #   in Loop: Header=BB3_35 Depth=1
	add.d	$t6, $t6, $t0
	alsl.d	$t6, $t7, $t6, 1
	alsl.d	$t4, $t7, $t4, 1
...
.LBB3_38:                               # %for.body23.us
	...
	b	.LBB3_34
	.p2align	4, , 16
.LBB3_39:                               # %vector.memcheck98
                                        #   in Loop: Header=BB3_35 Depth=1
	sub.d	$t8, $t5, $t4
	move	$t7, $zero
	bltu	$t8, $t3, .LBB3_37
# %bb.40:                               # %vector.memcheck98
                                        #   in Loop: Header=BB3_35 Depth=1
	add.d	$t8, $t0, $t6
	sub.d	$t8, $t5, $t8
	bltu	$t8, $t3, .LBB3_37
