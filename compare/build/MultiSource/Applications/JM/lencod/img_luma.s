...
.LBB3_11:                               # %for.body37.us.us
	...
	b	.LBB3_4
	.p2align	4, , 16
.LBB3_12:                               # %vector.memcheck144
                                        #   in Loop: Header=BB3_5 Depth=1
	sub.d	$s7, $s5, $s4
	move	$s0, $zero
	bltu	$s7, $s3, .LBB3_7
# %bb.13:                               # %vector.memcheck144
                                        #   in Loop: Header=BB3_5 Depth=1
	add.d	$s7, $t6, $s6
	sub.d	$s7, $s5, $s7
	bltu	$s7, $s3, .LBB3_7
# %bb.14:                               # %vector.body153.preheader
                                        #   in Loop: Header=BB3_5 Depth=1
	alsl.d	$s7, $a7, $s6, 1
	move	$s8, $s4
	move	$s0, $s5
...
.LBB3_15:                               # %vector.body153
	...
	addi.d	$s8, $s8, 8
	bnez	$ra, .LBB3_15
# %bb.16:                               # %middle.block158
                                        #   in Loop: Header=BB3_5 Depth=1
	move	$s0, $t7
	bne	$t7, $t0, .LBB3_7
	b	.LBB3_9
	.p2align	4, , 16
.LBB3_17:                               # %vector.memcheck115
                                        #   in Loop: Header=BB3_5 Depth=1
	add.d	$s0, $s5, $t2
	add.d	$ra, $s5, $t3
	add.d	$t5, $s4, $t2
...
.LBB3_38:                               # %for.body23.us
	...
	b	.LBB3_34
	.p2align	4, , 16
.LBB3_39:                               # %vector.memcheck99
                                        #   in Loop: Header=BB3_35 Depth=1
	sub.d	$t8, $t5, $t4
	move	$t7, $zero
	bltu	$t8, $t3, .LBB3_37
# %bb.40:                               # %vector.memcheck99
                                        #   in Loop: Header=BB3_35 Depth=1
	add.d	$t8, $t0, $t6
	sub.d	$t8, $t5, $t8
	bltu	$t8, $t3, .LBB3_37
# %bb.41:                               # %vector.body107.preheader
                                        #   in Loop: Header=BB3_35 Depth=1
	alsl.d	$t7, $a7, $t6, 1
	move	$t8, $t4
	move	$fp, $t5
