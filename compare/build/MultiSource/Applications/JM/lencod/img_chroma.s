...
# %bb.6:                                # %if.end6.split.us
	...
	bstrpick.d	$a1, $a7, 31, 5
	st.d	$a1, $sp, 40                    # 8-byte Folded Spill
	slli.d	$a1, $a1, 5
	st.d	$a1, $sp, 224                   # 8-byte Folded Spill
	bstrpick.d	$a1, $a7, 31, 2
...
.LBB0_23:                               # %for.body70.us.us.us
	...
	addi.d	$s1, $s1, 2
	bnez	$s4, .LBB0_23
.LBB0_24:                               # %for.cond99.preheader.us.us.us.loopexit
                                        #   in Loop: Header=BB0_12 Depth=3
	move	$t6, $a3
	ori	$ra, $zero, 2
.LBB0_25:                               # %for.cond99.preheader.us.us.us
                                        #   in Loop: Header=BB0_12 Depth=3
...
.LBB0_27:                               #   in Loop: Header=BB0_12 Depth=3
	move	$t6, $s4
	move	$t7, $t0
.LBB0_28:                               # %for.body103.us.us.us.preheader
                                        #   in Loop: Header=BB0_12 Depth=3
	alsl.d	$t5, $t6, $s8, 1
	ld.d	$a0, $sp, 272                   # 8-byte Folded Reload
	sub.d	$t6, $a0, $t7
	.p2align	4, , 16
.LBB0_29:                               # %for.body103.us.us.us
                                        #   Parent Loop BB0_8 Depth=1
                                        #     Parent Loop BB0_10 Depth=2
                                        #       Parent Loop BB0_12 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
...
# %bb.31:                               # %vector.memcheck177
	...
	and	$a3, $t5, $a3
	bnez	$a3, .LBB0_15
# %bb.32:                               # %vector.main.loop.iter.check193
                                        #   in Loop: Header=BB0_12 Depth=3
	ori	$a0, $zero, 32
	bgeu	$a7, $a0, .LBB0_43
...
.LBB0_43:                               # %vector.ph194
	...
	xvsrli.w	$xr12, $xr11, 6
	vpickve2gr.h	$a3, $vr12, 0
	vinsgr2vr.h	$vr13, $a3, 0
	vpickve2gr.h	$a3, $vr12, 2
	vinsgr2vr.h	$vr13, $a3, 1
	vpickve2gr.h	$a3, $vr12, 4
	vinsgr2vr.h	$vr13, $a3, 2
	vpickve2gr.h	$a3, $vr12, 6
	vinsgr2vr.h	$vr13, $a3, 3
	xvpermi.d	$xr14, $xr12, 14
	vpickve2gr.h	$a3, $vr14, 0
	vinsgr2vr.h	$vr13, $a3, 4
	vpickve2gr.h	$a3, $vr14, 2
	vinsgr2vr.h	$vr13, $a3, 5
	vpickve2gr.h	$a3, $vr14, 4
	vinsgr2vr.h	$vr13, $a3, 6
	vpickve2gr.h	$a3, $vr14, 6
	vinsgr2vr.h	$vr13, $a3, 7
	vpickve2gr.h	$a3, $vr12, 0
...
.LBB0_50:                               # %vector.ph
	...
	xvadd.w	$xr11, $xr11, $xr2
	xvsrli.w	$xr12, $xr11, 6
	vpickve2gr.h	$a0, $vr12, 0
	vinsgr2vr.h	$vr13, $a0, 0
	vpickve2gr.h	$a0, $vr12, 2
	vinsgr2vr.h	$vr13, $a0, 1
	vpickve2gr.h	$a0, $vr12, 4
	vinsgr2vr.h	$vr13, $a0, 2
	vpickve2gr.h	$a0, $vr12, 6
	vinsgr2vr.h	$vr13, $a0, 3
	xvpermi.d	$xr14, $xr12, 14
	vpickve2gr.h	$a0, $vr14, 0
	vinsgr2vr.h	$vr13, $a0, 4
	vpickve2gr.h	$a0, $vr14, 2
	vinsgr2vr.h	$vr13, $a0, 5
	vpickve2gr.h	$a0, $vr14, 4
	vinsgr2vr.h	$vr13, $a0, 6
	vpickve2gr.h	$a0, $vr14, 6
	vinsgr2vr.h	$vr13, $a0, 7
	vpickve2gr.h	$a0, $vr12, 0
...
# %bb.56:                               # %vec.epilog.middle.block
	...
	beq	$a0, $t2, .LBB0_11
	b	.LBB0_28
.LBB0_57:                               #   in Loop: Header=BB0_12 Depth=3
	ld.d	$a0, $sp, 216                   # 8-byte Folded Reload
	add.d	$t6, $a0, $s4
	ld.d	$t7, $sp, 96                    # 8-byte Folded Reload
	b	.LBB0_28
.LBB0_58:                               # %for.inc133.split.us.us
	move	$a1, $zero
	move	$a2, $zero
	...
	b	.LBB0_60
	.p2align	4, , 16
.LBB0_59:                               # %for.end128.split.us.us.us.1
...
.LBB0_60:                               # %for.body16.us.us.1
	...
	b	.LBB0_62
	.p2align	4, , 16
.LBB0_61:                               # %for.cond30.for.inc125_crit_edge.us.us.us.1
...
.LBB0_62:                               # %for.body22.us.us.us.1
	...
	b	.LBB0_64
	.p2align	4, , 16
.LBB0_63:                               # %for.inc121.us.us.us.1
                                        #   in Loop: Header=BB0_64 Depth=3
	addi.d	$s0, $s0, 1
	ld.d	$a0, $sp, 296                   # 8-byte Folded Reload
	beq	$s0, $a0, .LBB0_61
.LBB0_64:                               # %for.body33.us.us.us.1
                                        #   Parent Loop BB0_60 Depth=1
...
# %bb.66:                               #   in Loop: Header=BB0_64 Depth=3
	move	$t5, $zero
.LBB0_67:                               # %for.body55.us.us.us.1.preheader
                                        #   in Loop: Header=BB0_64 Depth=3
	sub.d	$a2, $a7, $t5
	alsl.d	$t5, $t5, $t7, 1
	.p2align	4, , 16
.LBB0_68:                               # %for.body55.us.us.us.1
                                        #   Parent Loop BB0_60 Depth=1
                                        #     Parent Loop BB0_62 Depth=2
	...
	addi.d	$t5, $t5, 2
	bnez	$a2, .LBB0_68
# %bb.69:                               #   in Loop: Header=BB0_64 Depth=3
	move	$t6, $a7
	b	.LBB0_71
	.p2align	4, , 16
.LBB0_70:                               #   in Loop: Header=BB0_64 Depth=3
	move	$t6, $zero
.LBB0_71:                               # %for.cond67.preheader.us.us.us.1
                                        #   in Loop: Header=BB0_64 Depth=3
	blt	$a6, $s7, .LBB0_77
# %bb.72:                               # %for.body70.us.us.us.preheader.1
                                        #   in Loop: Header=BB0_64 Depth=3
	ori	$a0, $zero, 5
	bgeu	$a6, $a0, .LBB0_86
# %bb.73:                               #   in Loop: Header=BB0_64 Depth=3
	move	$t5, $zero
.LBB0_74:                               # %for.body70.us.us.us.1.preheader
                                        #   in Loop: Header=BB0_64 Depth=3
	alsl.d	$s5, $t6, $t7, 1
	sub.d	$s7, $t4, $t5
	alsl.d	$a0, $t5, $a4, 1
...
.LBB0_75:                               # %for.body70.us.us.us.1
	...
	addi.d	$a2, $a2, 2
	bnez	$s7, .LBB0_75
.LBB0_76:                               # %for.cond99.preheader.us.us.us.loopexit.1
                                        #   in Loop: Header=BB0_64 Depth=3
	move	$t6, $s4
	ori	$s7, $zero, 2
.LBB0_77:                               # %for.cond99.preheader.us.us.us.1
                                        #   in Loop: Header=BB0_64 Depth=3
	ld.d	$a0, $sp, 304                   # 8-byte Folded Reload
	blt	$a0, $a6, .LBB0_63
# %bb.78:                               # %iter.check247
	...
	ori	$a0, $zero, 3
	bgeu	$a7, $a0, .LBB0_91
.LBB0_79:                               #   in Loop: Header=BB0_64 Depth=3
	move	$a4, $s4
	move	$a5, $t0
.LBB0_80:                               # %for.body103.us.us.us.1.preheader
                                        #   in Loop: Header=BB0_64 Depth=3
	alsl.d	$a2, $a4, $t7, 1
	ld.d	$a0, $sp, 272                   # 8-byte Folded Reload
	sub.d	$a4, $a0, $a5
	.p2align	4, , 16
.LBB0_81:                               # %for.body103.us.us.us.1
                                        #   Parent Loop BB0_60 Depth=1
                                        #     Parent Loop BB0_62 Depth=2
                                        #       Parent Loop BB0_64 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
...
# %bb.83:                               # %vector.memcheck331
	...
	and	$a0, $a0, $a2
	bnez	$a0, .LBB0_67
# %bb.84:                               # %vector.main.loop.iter.check347
                                        #   in Loop: Header=BB0_64 Depth=3
	ori	$a0, $zero, 32
	bgeu	$a7, $a0, .LBB0_95
# %bb.85:                               #   in Loop: Header=BB0_64 Depth=3
	move	$a2, $zero
	b	.LBB0_99
	.p2align	4, , 16
.LBB0_86:                               # %vector.memcheck293
                                        #   in Loop: Header=BB0_64 Depth=3
	ld.d	$a0, $sp, 256                   # 8-byte Folded Reload
	add.d	$a2, $t7, $a0
	ld.d	$a0, $sp, 248                   # 8-byte Folded Reload
...
# %bb.92:                               # %vector.memcheck231
	...
	and	$a0, $a0, $a2
	bnez	$a0, .LBB0_79
# %bb.93:                               # %vector.main.loop.iter.check249
                                        #   in Loop: Header=BB0_64 Depth=3
	ori	$a0, $zero, 31
	bgeu	$a7, $a0, .LBB0_102
# %bb.94:                               #   in Loop: Header=BB0_64 Depth=3
	move	$a2, $zero
	b	.LBB0_106
.LBB0_95:                               # %vector.ph348
                                        #   in Loop: Header=BB0_64 Depth=3
	ld.hu	$a0, $a5, 0
	ld.hu	$a2, $a4, 0
	xvreplgr2vr.w	$xr11, $a0
...
.LBB0_96:                               # %vector.body359
	...
	addi.d	$a2, $a2, 64
	bnez	$t5, .LBB0_96
# %bb.97:                               # %middle.block362
                                        #   in Loop: Header=BB0_64 Depth=3
	move	$t6, $a7
	ld.d	$a0, $sp, 224                   # 8-byte Folded Reload
	beq	$a0, $a7, .LBB0_71
# %bb.98:                               # %vec.epilog.iter.check366
                                        #   in Loop: Header=BB0_64 Depth=3
	ld.d	$t5, $sp, 224                   # 8-byte Folded Reload
	move	$a2, $t5
	ld.d	$a0, $sp, 176                   # 8-byte Folded Reload
	beqz	$a0, .LBB0_67
.LBB0_99:                               # %vec.epilog.ph368
                                        #   in Loop: Header=BB0_64 Depth=3
	ld.h	$a0, $a4, 0
	vinsgr2vr.h	$vr11, $a0, 0
	ld.h	$t2, $a5, 0
	...
	alsl.d	$a2, $a2, $t7, 1
	.p2align	4, , 16
.LBB0_100:                              # %vec.epilog.vector.body379
                                        #   Parent Loop BB0_60 Depth=1
                                        #     Parent Loop BB0_62 Depth=2
                                        #       Parent Loop BB0_64 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
	...
	addi.d	$a2, $a2, 8
	bnez	$t5, .LBB0_100
# %bb.101:                              # %vec.epilog.middle.block382
                                        #   in Loop: Header=BB0_64 Depth=3
	ld.d	$a0, $sp, 208                   # 8-byte Folded Reload
	move	$t5, $a0
	move	$t6, $a7
...
.LBB0_103:                              # %vector.body261
	...
	addi.d	$a2, $a2, 64
	bnez	$a4, .LBB0_103
# %bb.104:                              # %middle.block264
                                        #   in Loop: Header=BB0_64 Depth=3
	addi.d	$a0, $a7, 1
	ld.d	$a2, $sp, 216                   # 8-byte Folded Reload
	beq	$a0, $a2, .LBB0_63
# %bb.105:                              # %vec.epilog.iter.check268
                                        #   in Loop: Header=BB0_64 Depth=3
	ld.d	$a2, $sp, 216                   # 8-byte Folded Reload
	ld.d	$a0, $sp, 144                   # 8-byte Folded Reload
	beqz	$a0, .LBB0_109
.LBB0_106:                              # %vec.epilog.ph270
                                        #   in Loop: Header=BB0_64 Depth=3
	ld.h	$a0, $s5, 0
	vinsgr2vr.h	$vr11, $a0, 0
	ld.h	$a4, $ra, 0
	...
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB0_107:                              # %vec.epilog.vector.body282
                                        #   Parent Loop BB0_60 Depth=1
                                        #     Parent Loop BB0_62 Depth=2
                                        #       Parent Loop BB0_64 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
	...
	addi.d	$a5, $a5, 8
	bnez	$a2, .LBB0_107
# %bb.108:                              # %vec.epilog.middle.block286
                                        #   in Loop: Header=BB0_64 Depth=3
	...
	beq	$a0, $a2, .LBB0_63
	b	.LBB0_80
.LBB0_109:                              #   in Loop: Header=BB0_64 Depth=3
	ld.d	$a0, $sp, 216                   # 8-byte Folded Reload
	add.d	$a4, $a0, $s4
