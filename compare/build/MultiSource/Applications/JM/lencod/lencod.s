...
# %bb.0:                                # %entry
	...
	pcalau12i	$s3, %pc_hi20(p_dec)
	st.w	$a2, $s3, %pc_lo12(p_dec)
	...
	ori	$a0, $a0, 992
	ldx.w	$a2, $a1, $a0
	pcalau12i	$s6, %pc_hi20(img)
	ld.d	$a0, $s6, %pc_lo12(img)
	ldptr.w	$a3, $a1, 2964
	stptr.w	$a2, $a0, 15272
...
.LBB1_7:                                # %malloc_picture.exit
	...
	pcalau12i	$s4, %pc_hi20(frame_pic_2)
...
.LBB1_10:                               # %malloc_picture.exit34
	st.d	$fp, $s4, %pc_lo12(frame_pic_2)
	ori	$a0, $zero, 1
	ori	$a1, $zero, 824
	pcaddu18i	$ra, %call36(calloc)
	jirl	$ra, $ra, 0
...
.LBB1_13:                               # %if.end
	ldptr.w	$a1, $a0, 2148
	pcalau12i	$s5, %pc_hi20(frame_pic_si)
	beqz	$a1, .LBB1_17
# %bb.14:                               # %if.then4
...
.LBB1_16:                               # %malloc_picture.exit44
	...
	ld.w	$a1, $a0, 68
	ld.w	$a2, $a0, 52
	st.d	$fp, $s5, %pc_lo12(frame_pic_si)
...
.LBB1_17:                               # %if.end10
	ldptr.w	$a0, $a0, 4704
	pcalau12i	$s8, %pc_hi20(top_pic)
	pcalau12i	$s7, %pc_hi20(bottom_pic)
	beqz	$a0, .LBB1_23
# %bb.18:                               # %if.then11
	ori	$a0, $zero, 1
	ori	$a1, $zero, 824
...
.LBB1_28:                               # %if.end27
	...
	ld.d	$a0, $a0, %got_pc_lo12(enc_top_picture)
	st.d	$zero, $a0, 0
	pcalau12i	$a0, %got_pc_hi20(enc_frame_picture)
	ld.d	$a0, $a0, %got_pc_lo12(enc_frame_picture)
	st.d	$zero, $a0, 0
...
# %bb.84:                               # %land.lhs.true.i66
	...
	mod.w	$a2, $a2, $a4
	beqz	$a2, .LBB1_95
.LBB1_85:                               # %SetImgType.exit.thread157
                                        #   in Loop: Header=BB1_53 Depth=1
	ldptr.w	$a2, $a1, 2964
	addi.d	$a2, $a2, -2
	sltui	$a2, $a2, 1
...
# %bb.0:                                # %entry
	...
	pcalau12i	$a0, %pc_hi20(frame_ctr)
	addi.d	$a6, $a0, %pc_lo12(frame_ctr)
...
.LBB14_20:                              # %if.else241
	...
	jirl	$ra, $ra, 0
	b	.LBB14_30
.LBB14_21:                              # %for.body179.preheader
...
# %bb.23:                               # %for.end201
	...
	ld.w	$a0, $s2, 700
	blez	$a0, .LBB14_26
# %bb.24:                               # %for.body179.1.preheader
	move	$s8, $zero
	.p2align	4, , 16
.LBB14_25:                              # %for.body179.1
                                        # =>This Inner Loop Header: Depth=1
	ldptr.w	$a0, $fp, 2964
	sltui	$s6, $a0, 1
	addi.d	$a0, $sp, 672
...
.LBB14_49:                              # %sw.bb306
	...
	b	.LBB14_51
.LBB14_50:                              # %sw.default308
	pcalau12i	$a0, %pc_hi20(.L.str.69)
	addi.d	$a0, $a0, %pc_lo12(.L.str.69)
.LBB14_51:                              # %sw.epilog310
	ori	$a1, $zero, 51
...
# %bb.68:                               # %sw.bb563
	...
	ori	$a1, $zero, 43
	b	.LBB14_70
.LBB14_69:                              # %sw.default565
	pcalau12i	$a0, %pc_hi20(.L.str.35)
	addi.d	$a0, $a0, %pc_lo12(.L.str.35)
	ori	$a1, $zero, 39
.LBB14_70:                              # %sw.epilog567
	ori	$a2, $zero, 1
	pcaddu18i	$ra, %call36(fwrite)
	jirl	$ra, $ra, 0
	move	$s8, $s6
...
# %bb.127:                              # %for.end1363
	...
	ld.d	$a3, $s0, %pc_lo12(p_log)
	ori	$a1, $zero, 3
	bltu	$a1, $a0, .LBB14_129
# %bb.128:                              # %switch.lookup
	slli.d	$a0, $a0, 3
...
.LBB14_130:                             # %if.end1410
	...
	jirl	$ra, $ra, 0
	ld.d	$a0, $s0, %pc_lo12(p_log)
	pcalau12i	$s4, %pc_hi20(tot_time)
	ld.w	$a2, $s4, %pc_lo12(tot_time)
...
# %bb.132:                              # %if.then1495
	...
	div.d	$a6, $a6, $t1
	ld.d	$a1, $a1, 736
	ld.d	$t1, $s4, %pc_lo12(tot_time)
	pcalau12i	$t2, %pc_hi20(.LCPI14_0)
	fld.d	$fa6, $t2, %pc_lo12(.LCPI14_0)
	div.d	$a1, $a1, $a5
	movgr2fr.d	$fa7, $t1
	ffint.d.l	$fa7, $fa7
	fmul.d	$fa6, $fa7, $fa6
...
# %bb.134:                              # %if.then1532
	...
	fcvt.d.s	$fa5, $fa5
	add.d	$a1, $a1, $a6
	ld.d	$a5, $s4, %pc_lo12(tot_time)
	pcalau12i	$a7, %pc_hi20(.LCPI14_0)
	fld.d	$fa6, $a7, %pc_lo12(.LCPI14_0)
	div.d	$a1, $a1, $a2
	movgr2fr.d	$fa7, $a5
	ffint.d.l	$fa7, $fa7
	fmul.d	$fa6, $fa7, $fa6
...
# %bb.1:                                # %for.body.preheader
	pcalau12i	$s0, %pc_hi20(imgY_com)
	pcalau12i	$a0, %got_pc_hi20(enc_top_picture)
	ld.d	$s1, $a0, %got_pc_lo12(enc_top_picture)
	pcalau12i	$a0, %got_pc_hi20(enc_bottom_picture)
	ld.d	$s2, $a0, %got_pc_lo12(enc_bottom_picture)
	move	$s3, $zero
	move	$s4, $zero
	move	$s5, $zero
	.p2align	4, , 16
...
# %bb.5:                                # %for.body19.preheader
	pcalau12i	$s0, %pc_hi20(imgUV_com)
	pcalau12i	$a0, %got_pc_hi20(enc_top_picture)
	ld.d	$s1, $a0, %got_pc_lo12(enc_top_picture)
	pcalau12i	$a0, %got_pc_hi20(enc_bottom_picture)
	ld.d	$s2, $a0, %got_pc_lo12(enc_bottom_picture)
