...
# %bb.101:                              # %middle.block993
	...
	ld.d	$a1, $sp, 440                   # 8-byte Folded Reload
	beq	$t1, $a1, .LBB4_104
.LBB4_102:                              # %for.body914.us.preheader1030
                                        #   in Loop: Header=BB4_90 Depth=3
	move	$s0, $t8
	move	$s2, $s1
	.p2align	4, , 16
...
# %bb.108:                              # %middle.block967
	...
	ld.d	$a1, $sp, 440                   # 8-byte Folded Reload
	beq	$t1, $a1, .LBB4_111
.LBB4_109:                              # %for.body930.us.preheader1029
                                        #   in Loop: Header=BB4_90 Depth=3
	move	$t8, $a0
	move	$s1, $s0
	.p2align	4, , 16
...
# %bb.115:                              # %middle.block941
	...
	ld.d	$a0, $sp, 440                   # 8-byte Folded Reload
	beq	$t1, $a0, .LBB4_89
.LBB4_116:                              # %for.body946.us.preheader1028
                                        #   in Loop: Header=BB4_90 Depth=3
	move	$a0, $s1
	move	$s0, $t8
	.p2align	4, , 16
