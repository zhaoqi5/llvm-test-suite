...
# %bb.39:                               # %middle.block
                                        #   in Loop: Header=BB1_34 Depth=1
	beq	$t0, $t1, .LBB1_33
.LBB1_40:                               # %for.body112.preheader140
                                        #   in Loop: Header=BB1_34 Depth=1
	alsl.d	$t0, $a7, $a1, 2
	.p2align	4, , 16
.LBB1_41:                               # %for.body112
...
# %bb.2:                                # %for.body.us.preheader
	...
	ldx.d	$a6, $a7, $a6
	ldptr.d	$a7, $a7, 14376
	pcalau12i	$t0, %pc_hi20(PartitionMotionSearch.by0)
	addi.d	$t0, $t0, %pc_lo12(PartitionMotionSearch.by0)
	alsl.d	$t0, $t3, $t0, 4
	slli.d	$a1, $a1, 2
	ldx.w	$s0, $t0, $a1
	pcalau12i	$t0, %pc_hi20(mvbits)
	ld.d	$t0, $t0, %pc_lo12(mvbits)
	add.w	$a4, $s0, $t1
	st.d	$a4, $sp, 56                    # 8-byte Folded Spill
	pcalau12i	$t1, %pc_hi20(PartitionMotionSearch.bx0)
	addi.d	$t1, $t1, %pc_lo12(PartitionMotionSearch.bx0)
	alsl.d	$a4, $t3, $t1, 4
	ldx.w	$t2, $a4, $a1
	move	$t3, $zero
	add.w	$t4, $t2, $a0
...
# %bb.31:                               # %for.cond233.preheader.lr.ph
	...
	blez	$a0, .LBB4_51
# %bb.32:                               # %for.cond233.preheader.lr.ph.split.us
	move	$a2, $zero
	beqz	$s7, .LBB4_141
# %bb.33:                               # %for.cond233.preheader.us.preheader
...
.LBB4_35:                               # %for.body237.us420
	...
	addi.d	$a7, $a7, 1
	bnez	$t0, .LBB4_35
# %bb.36:                               # %for.cond233.for.inc272_crit_edge.split.us424
...
# %bb.38:                               # %if.then281
	...
	ld.w	$a2, $sp, 292
	beqz	$a0, .LBB4_47
.LBB4_39:                               # %if.end299.if.end326_crit_edge
	slli.d	$a3, $a3, 1
...
# %bb.56:                               # %if.then459
	ori	$a1, $zero, 3
	bne	$a2, $a1, .LBB4_59
# %bb.57:                               # %lor.lhs.false467
	ld.d	$a1, $a7, 0
	ld.w	$a1, $a1, 24
	beqz	$a1, .LBB4_77
.LBB4_58:                               # %if.then483.thread
...
# %bb.70:                               # %if.end548
	...
	ldx.w	$a0, $a0, $a1
	bnez	$a0, .LBB4_75
# %bb.71:                               # %land.lhs.true554
	ld.d	$a0, $a7, 0
	ld.w	$a0, $a0, 20
	ori	$a1, $zero, 3
	ori	$s4, $zero, 1
	beq	$a0, $a1, .LBB4_73
# %bb.72:                               # %land.lhs.true554
	bnez	$a0, .LBB4_75
.LBB4_73:                               # %if.then561
...
.LBB4_76:
	st.d	$s5, $sp, 184                   # 8-byte Folded Spill
	b	.LBB4_82
.LBB4_77:                               # %lor.lhs.false470
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	blez	$a1, .LBB4_69
# %bb.78:                               # %land.lhs.true474
	move	$a1, $s1
...
.LBB4_84:                               # %if.end588
	...
	blez	$a0, .LBB4_90
# %bb.85:                               # %for.cond595.preheader.lr.ph
	ld.d	$a0, $sp, 200                   # 8-byte Folded Reload
	srai.d	$a0, $a0, 2
	blez	$a0, .LBB4_90
# %bb.86:                               # %for.cond595.preheader.us.preheader
	add.d	$a0, $a0, $fp
	move	$a1, $s0
	.p2align	4, , 16
.LBB4_87:                               # %for.cond595.preheader.us
                                        # =>This Loop Header: Depth=1
...
.LBB4_88:                               # %for.body600.us
	...
	addi.d	$a3, $a3, 8
	blt	$a4, $a0, .LBB4_88
# %bb.89:                               # %for.cond595.for.inc628_crit_edge.us
...
.LBB4_134:                              # %if.end957
	...
	blez	$a0, .LBB4_140
# %bb.135:                              # %for.cond964.preheader.lr.ph
	ld.d	$a0, $sp, 200                   # 8-byte Folded Reload
	srai.d	$a0, $a0, 2
	blez	$a0, .LBB4_140
# %bb.136:                              # %for.cond964.preheader.us.preheader
	ext.w.h	$a1, $s8
	xori	$a2, $s8, 1
	ext.w.h	$a2, $a2
	add.d	$a0, $a0, $fp
	...
	slli.d	$a2, $a2, 3
	.p2align	4, , 16
.LBB4_137:                              # %for.cond964.preheader.us
                                        # =>This Loop Header: Depth=1
...
.LBB4_138:                              # %for.body969.us
	...
	addi.d	$a3, $a3, 8
	blt	$a4, $a0, .LBB4_138
# %bb.139:                              # %for.cond964.for.inc1021_crit_edge.us
...
.LBB4_140:                              # %if.end1024
	...
	addi.d	$sp, $sp, 384
	ret
.LBB4_141:                              # %for.cond233.preheader.us.us.preheader
	pcalau12i	$a3, %pc_hi20(smpUMHEX_l0_cost)
	ld.d	$t3, $sp, 192                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB4_142:                              # %for.cond233.preheader.us.us
                                        # =>This Loop Header: Depth=1
...
.LBB4_143:                              # %for.body237.us.us.us
	...
	addi.d	$a7, $a7, 1
	bnez	$t0, .LBB4_143
# %bb.144:                              # %for.cond233.for.inc272_crit_edge.split.us.us.us
...
# %bb.0:                                # %entry
	...
	pcalau12i	$t2, %pc_hi20(imgY_org)
	vrepli.b	$vr0, 0
	vst	$vr0, $sp, 96                   # 16-byte Folded Spill
	pcalau12i	$a0, %pc_hi20(diff)
	addi.d	$s2, $a0, %pc_lo12(diff)
	move	$s8, $zero
	move	$fp, $zero
...
# %bb.3:                                # %if.end.1
                                        #   in Loop: Header=BB8_1 Depth=1
	ld.d	$a3, $s7, %pc_lo12(direct_ref_idx)
	ld.d	$a4, $a3, 0
	ld.d	$a3, $a3, 8
	ldx.d	$a4, $a4, $s0
	ldx.d	$a3, $a3, $s0
...
# %bb.1:                                # %entry.split.us
	...
	ldx.w	$a5, $a4, $a5
	blez	$a5, .LBB10_29
# %bb.2:                                # %for.cond30.preheader.us.us.preheader
	alsl.d	$a6, $s6, $a4, 3
	slli.d	$a7, $s6, 3
	...
	b	.LBB10_4
	.p2align	4, , 16
.LBB10_3:                               # %for.inc126.us.us
                                        #   in Loop: Header=BB10_4 Depth=1
	addi.d	$a7, $a7, 1
	ld.d	$t1, $sp, 8                     # 8-byte Folded Reload
	beq	$a7, $t1, .LBB10_34
.LBB10_4:                               # %for.cond30.preheader.us.us
                                        # =>This Loop Header: Depth=1
...
# %bb.5:                                # %for.body36.lr.ph.us.us
	...
	b	.LBB10_7
	.p2align	4, , 16
.LBB10_6:                               # %for.cond67.for.inc123_crit_edge.split.us.us.us.us.us
	...
	ext.w.h	$a0, $s4
	bge	$a0, $a1, .LBB10_3
.LBB10_7:                               # %for.body36.us.us.us.us
	...
	ori	$a2, $zero, 2
	beq	$a1, $a2, .LBB10_12
# %bb.8:                                # %for.body36.us.us.us.us
                                        #   in Loop: Header=BB10_7 Depth=2
	ori	$a2, $zero, 1
	bne	$a1, $a2, .LBB10_10
# %bb.9:                                # %if.then51.us.us.us.us
                                        #   in Loop: Header=BB10_7 Depth=2
	slti	$a1, $a0, 1
	ori	$a2, $zero, 1
	masknez	$a2, $a2, $a1
	...
	b	.LBB10_11
	.p2align	4, , 16
.LBB10_10:                              # %if.else55.us.us.us.us
                                        #   in Loop: Header=BB10_7 Depth=2
	slti	$a1, $a0, 1
	ori	$a2, $zero, 1
	masknez	$a2, $a2, $a1
	...
	ld.d	$a1, $sp, 24                    # 8-byte Folded Reload
	mul.w	$a0, $a0, $a1
.LBB10_11:                              # %if.end62.us.us.us.us.sink.split
                                        #   in Loop: Header=BB10_7 Depth=2
	ld.d	$a1, $sp, 224                   # 8-byte Folded Reload
	div.w	$a1, $a1, $a0
	st.d	$a1, $sp, 224                   # 8-byte Folded Spill
.LBB10_12:                              # %if.end62.us.us.us.us
                                        #   in Loop: Header=BB10_7 Depth=2
	ld.d	$a0, $sp, 40                    # 8-byte Folded Reload
	ld.d	$a0, $a0, %pc_lo12(motion_cost)
	...
	b	.LBB10_14
	.p2align	4, , 16
.LBB10_13:                              # %for.cond73.for.inc120_crit_edge.us.us.us.us.us
	...
	ld.d	$a0, $sp, 88                    # 8-byte Folded Reload
	bge	$s3, $a0, .LBB10_6
.LBB10_14:                              # %for.body71.us.us.us.us.us
                                        #   Parent Loop BB10_4 Depth=1
	...
	blez	$a6, .LBB10_23
# %bb.15:                               # %for.body77.us.us.us.us.us.us.preheader
                                        #   in Loop: Header=BB10_14 Depth=3
	ld.d	$a0, $sp, 176                   # 8-byte Folded Reload
	ld.d	$a0, $a0, 0
	ld.w	$a0, $a0, 172
	...
	b	.LBB10_17
	.p2align	4, , 16
.LBB10_16:                              # %for.cond93.for.inc117_crit_edge.us.us.us.us.us.us
	...
	ld.d	$a3, $sp, 232                   # 8-byte Folded Reload
	bge	$a4, $a0, .LBB10_13
.LBB10_17:                              # %for.body77.us.us.us.us.us.us
                                        #   Parent Loop BB10_4 Depth=1
                                        #     Parent Loop BB10_7 Depth=2
	...
	blez	$s2, .LBB10_22
# %bb.18:                               # %for.body97.us.us.us.us.us.us.us.preheader
                                        #   in Loop: Header=BB10_17 Depth=4
	add.w	$s1, $s7, $s2
	ld.d	$a0, $sp, 256                   # 8-byte Folded Reload
	add.w	$a0, $s3, $a0
	...
	ld.d	$s6, $sp, 240                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB10_19:                              # %for.body97.us.us.us.us.us.us.us
                                        #   Parent Loop BB10_4 Depth=1
                                        #     Parent Loop BB10_7 Depth=2
                                        #       Parent Loop BB10_14 Depth=3
	...
	move	$a2, $s7
	.p2align	4, , 16
.LBB10_20:                              # %for.body109.us.us.us.us.us.us.us
                                        #   Parent Loop BB10_4 Depth=1
                                        #     Parent Loop BB10_7 Depth=2
                                        #       Parent Loop BB10_14 Depth=3
                                        #         Parent Loop BB10_17 Depth=4
	...
	addi.d	$a1, $a1, 8
	blt	$a2, $s1, .LBB10_20
# %bb.21:                               # %for.cond105.for.inc114_crit_edge.us.us.us.us.us.us.us
                                        #   in Loop: Header=BB10_19 Depth=5
	addi.d	$s6, $s6, 1
	blt	$s6, $s5, .LBB10_19
	b	.LBB10_16
	.p2align	4, , 16
.LBB10_22:                              # %for.body97.us57.us.us.us.us.us
                                        #   Parent Loop BB10_4 Depth=1
                                        #     Parent Loop BB10_7 Depth=2
                                        #       Parent Loop BB10_14 Depth=3
                                        #         Parent Loop BB10_17 Depth=4
	...
	b	.LBB10_16
	.p2align	4, , 16
.LBB10_23:                              # %for.body77.us68.us.us.us.us
                                        #   Parent Loop BB10_4 Depth=1
                                        #     Parent Loop BB10_7 Depth=2
                                        #       Parent Loop BB10_14 Depth=3
	...
	blt	$s1, $a0, .LBB10_23
	b	.LBB10_13
.LBB10_24:                              # %for.cond30.preheader.preheader
...
.LBB10_25:                              # %for.inc126
	...
	addi.d	$a2, $a2, 1
	beq	$a2, $t1, .LBB10_34
.LBB10_26:                              # %for.cond30.preheader
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB10_28 Depth 2
	slli.d	$a4, $a2, 2
	ldx.w	$a4, $a1, $a4
	blez	$a4, .LBB10_25
# %bb.27:                               # %for.body36.lr.ph
                                        #   in Loop: Header=BB10_26 Depth=1
	ld.d	$a4, $a3, 0
	slli.d	$a5, $a2, 3
	ldx.d	$a4, $a4, $a5
...
.LBB10_28:                              # %for.body36
	...
	blt	$t0, $a7, .LBB10_28
	b	.LBB10_25
.LBB10_29:                              # %for.cond30.preheader.us.preheader
	pcalau12i	$a2, %got_pc_hi20(listXsize)
	ld.d	$a3, $a2, %got_pc_lo12(listXsize)
	pcalau12i	$a2, %pc_hi20(motion_cost)
	ld.d	$a4, $a2, %pc_lo12(motion_cost)
	...
	b	.LBB10_31
	.p2align	4, , 16
.LBB10_30:                              # %for.inc126.us
                                        #   in Loop: Header=BB10_31 Depth=1
	addi.d	$a2, $a2, 1
	beq	$a2, $t1, .LBB10_34
.LBB10_31:                              # %for.cond30.preheader.us
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB10_33 Depth 2
	slli.d	$a4, $a2, 2
	ldx.w	$a4, $a1, $a4
	blez	$a4, .LBB10_30
# %bb.32:                               # %for.body36.lr.ph.us
                                        #   in Loop: Header=BB10_31 Depth=1
	ld.d	$a4, $a3, 0
	slli.d	$a5, $a2, 3
	ldx.d	$a4, $a4, $a5
