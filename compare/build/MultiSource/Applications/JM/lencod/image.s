...
# %bb.0:                                # %entry
	...
	pcalau12i	$a0, %pc_hi20(enc_frame_picture)
	st.d	$a0, $sp, 280                   # 8-byte Folded Spill
	st.d	$zero, $a0, %pc_lo12(enc_frame_picture)
...
# %bb.147:                              # %middle.block555
                                        #   in Loop: Header=BB2_134 Depth=1
	beq	$t0, $a3, .LBB2_133
# %bb.148:                              # %vec.epilog.iter.check559
                                        #   in Loop: Header=BB2_134 Depth=1
	move	$s4, $t0
	move	$s0, $t0
	beqz	$a7, .LBB2_136
.LBB2_149:                              # %vec.epilog.ph561
                                        #   in Loop: Header=BB2_134 Depth=1
	add.d	$s0, $t2, $s4
	alsl.d	$s1, $s4, $fp, 1
	alsl.d	$s2, $s4, $t8, 1
	...
	alsl.d	$s4, $s4, $t6, 1
	.p2align	4, , 16
.LBB2_150:                              # %vec.epilog.vector.body564
                                        #   Parent Loop BB2_134 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $s4, 0
	vst	$vr0, $s3, 0
	...
	addi.d	$s4, $s4, 16
	bnez	$s0, .LBB2_150
# %bb.151:                              # %vec.epilog.middle.block569
                                        #   in Loop: Header=BB2_134 Depth=1
	move	$s0, $t1
	beq	$t1, $a3, .LBB2_133
	b	.LBB2_136
...
# %bb.354:                              # %for.cond244.preheader.lr.ph.split.us
	...
	ld.d	$a5, $a4, %pc_lo12(enc_frame_picture)
...
# %bb.360:                              # %for.cond266.preheader.lr.ph.split.us
	...
	ld.d	$a3, $a3, %pc_lo12(enc_frame_picture)
	ldptr.d	$a6, $a3, 6472
	ld.d	$a3, $a4, 0
	ld.d	$a4, $a4, 8
	ld.d	$a5, $a6, 0
...
# %bb.368:                              # %for.cond307.preheader.lr.ph.split.us
	ld.d	$a3, $sp, 280                   # 8-byte Folded Reload
	ld.d	$a4, $a3, %pc_lo12(enc_frame_picture)
