...
# %bb.0:                                # %entry
	...
	fst.d	$fs2, $sp, 416                  # 8-byte Folded Spill
	fst.d	$fs3, $sp, 408                  # 8-byte Folded Spill
	fst.d	$fs4, $sp, 400                  # 8-byte Folded Spill
	fst.d	$fs5, $sp, 392                  # 8-byte Folded Spill
	fst.d	$fs6, $sp, 384                  # 8-byte Folded Spill
	pcalau12i	$a0, %got_pc_hi20(img)
	ld.d	$fp, $a0, %got_pc_lo12(img)
	ld.d	$a0, $fp, 0
	pcalau12i	$a1, %pc_hi20(me_time)
	st.d	$zero, $a1, %pc_lo12(me_time)
	stptr.w	$zero, $a0, 14260
	pcalau12i	$s4, %pc_hi20(enc_frame_picture)
	st.d	$zero, $s4, %pc_lo12(enc_frame_picture)
...
# %bb.12:                               # %if.else123.i
	...
	ld.d	$a5, $a5, %got_pc_lo12(start_tr_in_this_IGOP)
	ld.w	$a6, $a1, 0
	ld.w	$a3, $a3, 0
	addi.d	$a7, $a2, 1
	stptr.w	$a7, $a1, 14360
...
.LBB2_22:                               # %if.then.i
	...
	ld.d	$a3, $a2, %got_pc_lo12(start_frame_no_in_this_IGOP)
	ld.d	$a2, $s0, 0
	ld.d	$a5, $a0, %got_pc_lo12(start_tr_in_this_IGOP)
	ld.w	$a4, $a1, 0
	ld.w	$a0, $a3, 0
	ld.w	$a3, $a2, 20
	ld.w	$a6, $a5, 0
...
# %bb.70:                               # %if.then.i59
	...
	ld.d	$a3, $a1, %got_pc_lo12(start_frame_no_in_this_IGOP)
	ld.d	$a1, $s0, 0
	pcalau12i	$a4, %got_pc_hi20(start_tr_in_this_IGOP)
	ld.d	$a4, $a4, %got_pc_lo12(start_tr_in_this_IGOP)
	ld.w	$a3, $a3, 0
	ldptr.w	$a5, $a1, 2968
	ld.w	$a6, $a0, 0
	ld.w	$a4, $a4, 0
...
# %bb.109:                              #   in Loop: Header=BB2_106 Depth=1
	...
	b	.LBB2_114
	.p2align	4, , 16
.LBB2_110:                              # %vector.body467.preheader
                                        #   in Loop: Header=BB2_106 Depth=1
	addi.d	$s1, $s0, 32
	addi.d	$s2, $fp, 32
	move	$s3, $t2
	.p2align	4, , 16
.LBB2_111:                              # %vector.body467
...
# %bb.122:                              # %for.cond38.preheader.lr.ph.split.us.i
	ld.d	$t1, $s7, %pc_lo12(imgUV_org_frm)
	move	$a7, $zero
	ld.d	$t0, $t1, 0
	ld.d	$t1, $t1, 8
	slli.d	$t2, $a5, 1
...
.LBB2_137:                              # %for.body74.us.i
	...
	b	.LBB2_133
	.p2align	4, , 16
.LBB2_138:                              # %vector.memcheck480
                                        #   in Loop: Header=BB2_134 Depth=1
	sub.d	$s1, $fp, $t7
	move	$s0, $zero
	bltu	$s1, $t4, .LBB2_136
# %bb.139:                              # %vector.memcheck480
                                        #   in Loop: Header=BB2_134 Depth=1
	sub.d	$s1, $t7, $t6
	bltu	$s1, $t4, .LBB2_136
...
# %bb.141:                              # %vector.memcheck480
	...
	sub.d	$s1, $fp, $t6
	bltu	$s1, $t4, .LBB2_136
# %bb.142:                              # %vector.memcheck480
                                        #   in Loop: Header=BB2_134 Depth=1
	sub.d	$s1, $fp, $t8
	bltu	$s1, $t4, .LBB2_136
# %bb.143:                              # %vector.main.loop.iter.check494
                                        #   in Loop: Header=BB2_134 Depth=1
	bgeu	$a3, $t5, .LBB2_145
# %bb.144:                              #   in Loop: Header=BB2_134 Depth=1
	move	$s4, $zero
	b	.LBB2_149
.LBB2_145:                              # %vector.body498.preheader
                                        #   in Loop: Header=BB2_134 Depth=1
	addi.d	$s0, $t6, 32
	addi.d	$s1, $fp, 32
	addi.d	$s2, $t7, 32
...
.LBB2_146:                              # %vector.body498
	...
	addi.d	$s3, $s3, 64
	bnez	$s4, .LBB2_146
# %bb.147:                              # %middle.block505
                                        #   in Loop: Header=BB2_134 Depth=1
	beq	$a7, $a3, .LBB2_133
# %bb.148:                              # %vec.epilog.iter.check510
                                        #   in Loop: Header=BB2_134 Depth=1
	move	$s4, $a7
	move	$s0, $a7
	beqz	$t0, .LBB2_136
.LBB2_149:                              # %vec.epilog.ph509
                                        #   in Loop: Header=BB2_134 Depth=1
	add.d	$s0, $t2, $s4
	alsl.d	$s1, $s4, $fp, 1
	alsl.d	$s2, $s4, $t8, 1
	...
	alsl.d	$s4, $s4, $t6, 1
	.p2align	4, , 16
.LBB2_150:                              # %vec.epilog.vector.body515
                                        #   Parent Loop BB2_134 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $s4, 0
	vst	$vr0, $s3, 0
	...
	addi.d	$s4, $s4, 16
	bnez	$s0, .LBB2_150
# %bb.151:                              # %vec.epilog.middle.block520
                                        #   in Loop: Header=BB2_134 Depth=1
	move	$s0, $t1
	beq	$t1, $a3, .LBB2_133
	b	.LBB2_136
.LBB2_152:                              # %PaddAutoCropBorders.exit
	...
	pcalau12i	$a4, %got_pc_hi20(snr)
	ld.d	$a4, $a4, %got_pc_lo12(snr)
...
.LBB2_166:                              # %if.else24.i
	pcalau12i	$a1, %got_pc_hi20(start_tr_in_this_IGOP)
	pcalau12i	$a2, %got_pc_hi20(start_frame_no_in_this_IGOP)
	ld.d	$a2, $a2, %got_pc_lo12(start_frame_no_in_this_IGOP)
	ld.d	$a3, $a1, %got_pc_lo12(start_tr_in_this_IGOP)
	ld.d	$a1, $s0, 0
	ld.w	$a4, $a0, 0
	ld.w	$a2, $a2, 0
	ld.w	$a5, $a1, 20
...
# %bb.220:                              # %if.then159.i
	...
	st.d	$a2, $a3, %pc_lo12(enc_picture)
...
# %bb.306:                              #   in Loop: Header=BB2_305 Depth=1
	...
	b	.LBB2_310
	.p2align	4, , 16
.LBB2_307:                              # %vector.body528.preheader
                                        #   in Loop: Header=BB2_305 Depth=1
	move	$t6, $zero
	move	$t7, $t1
	move	$t8, $t3
...
# %bb.320:                              #   in Loop: Header=BB2_319 Depth=1
	...
	b	.LBB2_324
	.p2align	4, , 16
.LBB2_321:                              # %vector.body540.preheader
                                        #   in Loop: Header=BB2_319 Depth=1
	move	$t7, $zero
	move	$t8, $t2
	move	$fp, $t4
...
# %bb.354:                              # %for.cond244.preheader.lr.ph.split.us
	ld.d	$a6, $fp, %pc_lo12(enc_frame_picture)
	pcalau12i	$a5, %pc_hi20(imgY_tmp)
	ld.d	$a5, $a5, %pc_lo12(imgY_tmp)
	ldptr.d	$a6, $a6, 6440
	move	$a7, $zero
	.p2align	4, , 16
...
# %bb.360:                              # %for.cond266.preheader.lr.ph.split.us
	...
	pcalau12i	$a4, %pc_hi20(imgUV_tmp)
	ldptr.d	$a6, $a3, 6472
	addi.d	$a4, $a4, %pc_lo12(imgUV_tmp)
	ld.d	$a3, $a4, 0
	ld.d	$a4, $a4, 8
	ld.d	$a5, $a6, 0
	ld.d	$a6, $a6, 8
...
# %bb.374:                              # %for.cond332.preheader.lr.ph.split.us
	...
	ldptr.d	$a5, $a2, 6472
	addi.d	$a3, $a3, %pc_lo12(imgUV_tmp)
	ld.d	$a2, $a3, 0
	ld.d	$a3, $a3, 8
	ld.d	$a4, $a5, 0
	ld.d	$a5, $a5, 8
...
.LBB2_397:                              # %if.end429
	ld.d	$a0, $s3, 0
	pcalau12i	$a2, %got_pc_hi20(total_frame_buffer)
	ld.d	$a2, $a2, %got_pc_lo12(total_frame_buffer)
	ld.d	$a3, $a0, 16
	ld.d	$a4, $a0, 24
	pcalau12i	$a5, %pc_hi20(Bit_Buffer)
	ld.d	$a6, $a2, 0
	ld.d	$a5, $a5, %pc_lo12(Bit_Buffer)
	sub.w	$a3, $a3, $a4
	slli.d	$a4, $a6, 3
	stx.d	$a3, $a5, $a4
	ld.d	$a3, $a2, 0
...
.LBB2_412:                              # %if.then6.i
	...
	maskeqz	$a2, $a5, $a2
	or	$a2, $a2, $a3
	pcalau12i	$a3, %pc_hi20(intras)
	ld.w	$a3, $a3, %pc_lo12(intras)
	ldptr.w	$a5, $a0, 14456
	ldptr.w	$a6, $a0, 14460
	ldptr.w	$a7, $a0, 14260
	ldptr.w	$a0, $a0, 15360
...
# %bb.426:                              # %if.then.i229
	...
	fcvt.d.s	$fa0, $fa3
	sltui	$a4, $a4, 1
	pcalau12i	$a6, %pc_hi20(.L.str.14)
	addi.d	$a6, $a6, %pc_lo12(.L.str.14)
	masknez	$a6, $a6, $a4
	pcalau12i	$a7, %pc_hi20(.L.str.15)
	ldptr.w	$a0, $a0, 15360
	addi.d	$a7, $a7, %pc_lo12(.L.str.15)
	maskeqz	$a4, $a7, $a4
	or	$a4, $a4, $a6
	bne	$a5, $a2, .LBB2_447
...
.LBB2_440:                              # %if.then6.i243
	...
	maskeqz	$a2, $a6, $a2
	or	$a2, $a2, $a5
	pcalau12i	$a5, %pc_hi20(intras)
	ld.w	$a5, $a5, %pc_lo12(intras)
	ldptr.w	$a6, $a0, 14456
	ldptr.w	$a7, $a0, 14460
	ldptr.w	$t0, $a0, 14260
	ldptr.w	$a0, $a0, 15360
...
.LBB2_460:                              # %if.end537
	...
	fld.d	$fs6, $sp, 384                  # 8-byte Folded Reload
	fld.d	$fs5, $sp, 392                  # 8-byte Folded Reload
	fld.d	$fs4, $sp, 400                  # 8-byte Folded Reload
	fld.d	$fs3, $sp, 408                  # 8-byte Folded Reload
	fld.d	$fs2, $sp, 416                  # 8-byte Folded Reload
...
.LBB2_463:                              # %if.else.i113
	ld.d	$a2, $s6, 0
	pcalau12i	$a0, %got_pc_hi20(PicParSet)
	ld.d	$a3, $a0, %got_pc_lo12(PicParSet)
	ld.d	$a0, $sp, 328                   # 8-byte Folded Reload
	ld.d	$a1, $a0, 0
	ori	$a0, $zero, 2948
	ldx.w	$a0, $a2, $a0
...
# %bb.464:
	...
	b	.LBB2_475
.LBB2_465:                              # %if.else80.i
	ld.d	$a0, $s6, 0
	ldptr.w	$a1, $a0, 2952
	beqz	$a1, .LBB2_467
# %bb.466:                              # %land.lhs.true82.i
	pcalau12i	$a1, %pc_hi20(active_sps)
	ld.d	$a1, $a1, %pc_lo12(active_sps)
	ld.w	$a1, $a1, 4
	ori	$a2, $zero, 66
	bne	$a1, $a2, .LBB2_477
.LBB2_467:                              # %if.else86.i
...
# %bb.468:                              # %if.then90.i
	...
	addi.d	$a2, $a2, 1
	b	.LBB2_216
.LBB2_469:                              # %cond.false.i
	ori	$a7, $t0, 1660
	ldx.w	$a7, $a2, $a7
.LBB2_470:                              # %if.end81.thread.i
	add.d	$a6, $a7, $a6
	ori	$a7, $zero, 3
	st.w	$a6, $a1, 36
	bne	$a5, $a7, .LBB2_29
.LBB2_471:                              # %land.lhs.true87.i
	slli.w	$a5, $a4, 1
	mod.w	$a3, $a3, $a5
	bge	$a3, $a4, .LBB2_473
.LBB2_472:                              # %if.else105.i
	ldptr.d	$a3, $a2, 2140
	st.d	$a3, $a1, 36
	b	.LBB2_29
.LBB2_473:                              # %if.then94.i
	lu12i.w	$a3, 1
	ori	$a3, $a3, 52
	ldx.w	$a3, $a2, $a3
	ld.w	$a4, $a2, 16
...
# %bb.7:                                # %for.body.preheader
	move	$s3, $zero
	move	$s4, $zero
	pcalau12i	$s5, %pc_hi20(lrec)
	.p2align	4, , 16
.LBB3_8:                                # %for.body
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a1, $s5, %pc_lo12(lrec)
	ld.w	$s0, $a0, 52
	ldx.d	$a0, $a1, $s3
	ori	$a1, $zero, 4
	move	$a2, $s0
...
# %bb.0:                                # %entry
	...
	ld.d	$a6, $a2, %got_pc_lo12(get_mb_block_pos_normal)
	pcalau12i	$a4, %got_pc_hi20(getNonAffNeighbour)
	pcalau12i	$a2, %pc_hi20(active_sps)
	st.d	$a2, $sp, 32                    # 8-byte Folded Spill
	ld.d	$a2, $a2, %pc_lo12(active_sps)
	ld.d	$s8, $a4, %got_pc_lo12(getNonAffNeighbour)
	st.d	$a5, $sp, 48                    # 8-byte Folded Spill
	st.d	$a6, $sp, 40                    # 8-byte Folded Spill
	st.d	$a6, $a5, %pc_lo12(get_mb_block_pos)
	pcalau12i	$s3, %pc_hi20(getNeighbour)
	ld.w	$a4, $a2, 1148
	st.d	$s8, $s3, %pc_lo12(getNeighbour)
	stptr.w	$a3, $a1, 15328
	st.w	$s4, $a1, 24
	stptr.w	$a4, $a0, 6564
	ld.w	$a3, $a2, 1160
...
.LBB4_5:                                # %if.end
	...
	pcalau12i	$s2, %pc_hi20(generic_RC)
	beqz	$a2, .LBB4_7
# %bb.6:                                # %if.then15
	ori	$a2, $s5, 1032
	ldx.w	$a2, $a0, $a2
...
.LBB4_10:                               # %copy_params.exit22
	...
	ld.w	$a3, $a1, 0
	stptr.w	$fp, $a1, 14252
	st.d	$a0, $s3, %pc_lo12(imgY_org)
	st.d	$a2, $s5, %pc_lo12(imgUV_org)
	addi.d	$a0, $a3, 1
	st.w	$a0, $a1, 0
	pcaddu18i	$ra, %call36(init_field)
	jirl	$ra, $ra, 0
...
.LBB4_16:                               # %if.end55
	...
	beqz	$a1, .LBB4_18
# %bb.17:                               # %if.then59
	ld.d	$a0, $s2, %pc_lo12(quadratic_RC)
	st.w	$s0, $a0, 1552
	vldi	$vr0, -1168
	move	$a1, $zero
	move	$a2, $zero
...
# %bb.2:                                # %if.then
	...
	ori	$a2, $s2, 3036
	ldx.w	$a2, $a1, $a2
	pcalau12i	$a3, %pc_hi20(enc_frame_picture3)
	st.w	$a2, $a0, 4
	ldptr.d	$a4, $a1, 15316
	stptr.w	$a2, $a1, 15328
	...
	ldx.w	$a4, $a1, $a4
	ld.d	$a5, $a5, 0
	st.d	$a0, $a3, %pc_lo12(enc_frame_picture3)
	b	.LBB5_5
.LBB5_3:                                # %if.then13
	ld.d	$a1, $s1, 0
	ori	$a3, $s2, 3036
	...
	ld.d	$a5, $a5, %got_pc_lo12(input)
	st.d	$a4, $a0, 8
	pcalau12i	$a4, %pc_hi20(enc_frame_picture2)
	ori	$a6, $s2, 3044
	ld.d	$a5, $a5, 0
	ldx.w	$a6, $a1, $a6
	st.d	$a0, $a4, %pc_lo12(enc_frame_picture2)
	st.w	$a3, $a0, 16
	ldptr.w	$a3, $a5, 4708
	stptr.w	$a6, $a0, 6364
	stptr.w	$a6, $a0, 6360
...
.LBB5_4:                                # %if.else45
	...
	ori	$a2, $s2, 3036
	ldx.w	$a2, $a1, $a2
	pcalau12i	$a3, %pc_hi20(enc_frame_picture)
	st.w	$a2, $a0, 4
	ldptr.d	$a4, $a1, 15316
	stptr.w	$a2, $a1, 15328
	pcalau12i	$a5, %got_pc_hi20(input)
	...
	ldx.w	$a4, $a1, $a4
	ld.d	$a5, $a5, 0
	st.d	$a0, $a3, %pc_lo12(enc_frame_picture)
.LBB5_5:                                # %if.then
	st.w	$a2, $a0, 16
	stptr.w	$a4, $a0, 6364
	ldptr.w	$a2, $a5, 4708
...
.LBB5_6:                                # %if.then
	...
	or	$a3, $a4, $a3
	pcalau12i	$a4, %got_pc_hi20(getNonAffNeighbour)
	ld.d	$a4, $a4, %got_pc_lo12(getNonAffNeighbour)
	pcalau12i	$a5, %got_pc_hi20(getAffNeighbour)
	ld.d	$a5, $a5, %got_pc_lo12(getAffNeighbour)
	pcalau12i	$a6, %pc_hi20(get_mb_block_pos)
	st.d	$a3, $a6, %pc_lo12(get_mb_block_pos)
	masknez	$a3, $a4, $a2
	maskeqz	$a2, $a5, $a2
	or	$a3, $a2, $a3
	pcalau12i	$a2, %pc_hi20(active_sps)
...
# %bb.1:                                # %for.body.lr.ph
	...
	ld.d	$a0, $a2, %got_pc_lo12(input)
	st.d	$a0, $sp, 32                    # 8-byte Folded Spill
	pcalau12i	$a2, %got_pc_hi20(stats)
	ld.d	$a0, $a2, %got_pc_lo12(stats)
...
.LBB9_12:                               # %if.else
	pcalau12i	$a0, %got_pc_hi20(input)
	ld.d	$a0, $a0, %got_pc_lo12(input)
	pcalau12i	$a2, %pc_hi20(imgY_org_frm)
	ld.d	$a4, $a2, %pc_lo12(imgY_org_frm)
	ld.d	$a3, $a0, 0
	pcalau12i	$a0, %pc_hi20(imgY_org)
	pcalau12i	$a2, %pc_hi20(imgUV_org_frm)
	ld.d	$a2, $a2, %pc_lo12(imgUV_org_frm)
	ld.w	$a5, $a3, 56
	st.d	$a4, $a0, %pc_lo12(imgY_org)
	pcalau12i	$a6, %pc_hi20(imgUV_org)
	ori	$a0, $zero, 1
	st.d	$a2, $a6, %pc_lo12(imgUV_org)
	blt	$a5, $a0, .LBB9_32
...
# %bb.17:                               #   in Loop: Header=BB9_16 Depth=1
	...
	b	.LBB9_21
	.p2align	4, , 16
.LBB9_18:                               # %vector.body136.preheader
                                        #   in Loop: Header=BB9_16 Depth=1
	move	$t7, $zero
	move	$t8, $t2
	move	$fp, $t4
...
.LBB9_41:
	...
	move	$a2, $zero
.LBB9_42:                               # %if.end163
	pcalau12i	$a3, %got_pc_hi20(snr)
	ld.d	$a3, $a3, %got_pc_lo12(snr)
	ld.d	$a3, $a3, 0
	movgr2fr.d	$fa0, $a0
	ffint.s.l	$fa0, $fa0
	fst.s	$fa0, $a3, 0
...
# %bb.0:                                # %entry
	...
	ld.d	$a3, $a1, %got_pc_lo12(stats)
	pcalau12i	$a4, %pc_hi20(last_P_no)
	ld.d	$a0, $a0, 0
	ld.d	$a1, $a2, 0
	ld.d	$a2, $a3, 0
	st.d	$t0, $a4, %pc_lo12(last_P_no)
	st.d	$zero, $a0, 12
	ld.w	$a6, $a1, 20
	st.w	$zero, $a2, 32
	ori	$a2, $zero, 2096
...
# %bb.49:                               #   in Loop: Header=BB14_42 Depth=1
	move	$t6, $zero
.LBB14_50:                              # %vec.epilog.ph158
                                        #   in Loop: Header=BB14_42 Depth=1
	add.d	$t4, $a7, $t6
	alsl.d	$t5, $t6, $t3, 1
	add.d	$t6, $t2, $t6
	.p2align	4, , 16
.LBB14_51:                              # %vec.epilog.vector.body164
                                        #   Parent Loop BB14_42 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$t7, $t6, 0
	...
	addi.d	$t6, $t6, 8
	bnez	$t4, .LBB14_51
# %bb.52:                               # %vec.epilog.middle.block168
                                        #   in Loop: Header=BB14_42 Depth=1
	move	$t4, $a5
	beq	$a5, $s2, .LBB14_41
	b	.LBB14_46
...
# %bb.55:                               # %middle.block154
                                        #   in Loop: Header=BB14_42 Depth=1
	beq	$a3, $s2, .LBB14_41
# %bb.56:                               # %vec.epilog.iter.check159
                                        #   in Loop: Header=BB14_42 Depth=1
	move	$t6, $a3
	move	$t4, $a3
	bnez	$a4, .LBB14_50
