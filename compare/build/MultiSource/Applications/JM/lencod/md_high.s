...
# %bb.0:                                # %entry
	...
	ori	$a0, $a0, 3840
	st.h	$a0, $sp, 334
	pcalau12i	$a0, %pc_hi20(.L__const.encode_one_macroblock_high.bmcost)
	addi.d	$a0, $a0, %pc_lo12(.L__const.encode_one_macroblock_high.bmcost)
	ld.w	$a1, $a0, 16
	vld	$vr0, $a0, 0
	st.w	$a1, $sp, 328
	vst	$vr0, $sp, 312
...
.LBB0_19:                               # %if.end52
	...
	ld.d	$s2, $a0, %got_pc_lo12(bi_pred_me)
	lu12i.w	$a0, 3
	ori	$a0, $a0, 2120
	st.d	$a0, $sp, 80                    # 8-byte Folded Spill
	pcalau12i	$a0, %got_pc_hi20(lambda_mf_factor)
	ld.d	$fp, $a0, %got_pc_lo12(lambda_mf_factor)
	move	$a0, $s6
	bstrins.d	$a0, $s6, 62, 32
...
.LBB0_48:                               # %call.sqrt
	...
	jirl	$ra, $ra, 0
	b	.LBB0_28
.LBB0_49:                               # %call.sqrt313
                                        #   in Loop: Header=BB0_26 Depth=2
	fmov.d	$fa0, $fs0
	pcaddu18i	$ra, %call36(sqrt)
	jirl	$ra, $ra, 0
	b	.LBB0_30
.LBB0_50:                               # %call.sqrt314
                                        #   in Loop: Header=BB0_26 Depth=2
	fmov.d	$fa0, $fs0
	pcaddu18i	$ra, %call36(sqrt)
	jirl	$ra, $ra, 0
...
.LBB0_165:                              # %if.end726
	...
	addi.d	$sp, $sp, 544
	ret
.LBB0_166:                              # %cond.false645
	ori	$a0, $zero, 1
	bne	$s7, $a0, .LBB0_170
# %bb.167:                              # %cond.true648
	ld.w	$a0, $a2, 364
	bnez	$a0, .LBB0_153
# %bb.168:                              # %land.lhs.true652
...
# %bb.169:                              # %cond.true659
	...
	bnez	$a0, .LBB0_153
	b	.LBB0_171
.LBB0_170:                              # %land.lhs.true652.thread
	ld.d	$a0, $sp, 48                    # 8-byte Folded Reload
	ld.w	$a0, $a0, 72
	bnez	$a0, .LBB0_153
.LBB0_171:                              # %land.lhs.true663
