...
# %bb.31:                               # %for.cond395.preheader
	...
	ld.d	$s1, $a1, %got_pc_lo12(cofAC8x8)
	ld.d	$a1, $s1, 0
	ldx.d	$a1, $a1, $s0
	ld.d	$a1, $a1, 0
	ld.d	$a1, $a1, 0
