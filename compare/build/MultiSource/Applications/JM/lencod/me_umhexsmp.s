...
.LBB5_23:                               # %if.end117
	...
	ld.d	$a3, $a3, 0
	ld.h	$t7, $a4, %pc_lo12(smpUMHEX_pred_MV_uplayer_X)
	pcalau12i	$a4, %pc_hi20(smpUMHEX_pred_MV_uplayer_Y)
	ld.h	$fp, $a4, %pc_lo12(smpUMHEX_pred_MV_uplayer_Y)
	st.b	$zero, $a3, 48
	vrepli.b	$vr0, 0
	vst	$vr0, $a3, 32
	xvrepli.b	$xr0, 0
...
# %bb.40:                               # %if.then305.1
	...
	or	$s2, $a2, $a0
	blt	$t2, $a3, .LBB5_60
# %bb.41:                               # %if.end345.1.for.inc.1_crit_edge
                                        #   in Loop: Header=BB5_33 Depth=1
	ld.h	$a0, $t6, 0
	masknez	$s4, $s4, $a1
...
.LBB5_50:                               # %if.end345.3
	...
	b	.LBB5_61
	.p2align	4, , 16
.LBB5_51:                               #   in Loop: Header=BB5_33 Depth=1
	move	$s6, $s3
.LBB5_52:                               # %for.inc.3
                                        #   in Loop: Header=BB5_33 Depth=1
	bnez	$s4, .LBB5_61
...
.LBB5_54:                               # %if.then305
	...
	or	$s2, $a0, $a4
	blt	$t2, $a1, .LBB5_60
# %bb.55:                               # %if.end345.for.inc_crit_edge
                                        #   in Loop: Header=BB5_33 Depth=1
	ld.h	$a0, $t6, 0
	ld.d	$s0, $sp, 16                    # 8-byte Folded Reload
	ld.d	$a6, $sp, 88                    # 8-byte Folded Reload
