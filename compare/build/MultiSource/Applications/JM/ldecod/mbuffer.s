...
.LBB11_185:                             # %vector.body1412
	...
	addi.d	$a2, $a2, 64
	bnez	$a3, .LBB11_185
# %bb.186:                              # %middle.block1417
	beq	$a0, $s3, .LBB11_189
.LBB11_187:                             # %for.body517.preheader1547
	slli.d	$a1, $a0, 3
	alsl.d	$a1, $s8, $a1, 3
	slli.d	$a2, $s3, 3
	sub.d	$a1, $a1, $a2
...
# %bb.329:                              # %vector.memcheck1452
	alsl.d	$a3, $fp, $a0, 3
	sub.d	$a3, $a2, $a3
	ori	$a4, $zero, 64
	bltu	$a3, $a4, .LBB11_333
# %bb.330:                              # %vector.ph1456
	move	$a3, $s0
...
.LBB11_410:                             # %vector.body1488
	...
	addi.d	$a5, $a5, 64
	bnez	$t1, .LBB11_410
# %bb.411:                              # %middle.block1492
	move	$a5, $t0
	bne	$a6, $a7, .LBB11_400
	b	.LBB11_402
.LBB11_412:                             # %vector.scevcheck1495
	ori	$a5, $zero, 33
	sub.d	$a4, $a5, $a4
	addi.w	$a5, $a4, 0
	addi.d	$a6, $zero, -2
...
# %bb.413:                              # %vector.scevcheck1495
	srli.d	$a4, $a4, 32
	bnez	$a4, .LBB11_404
# %bb.414:                              # %vector.ph1498
	move	$a4, $a3
...
.LBB21_30:                              # %vector.body146
	...
	addi.d	$t2, $t2, -32
	bnez	$a4, .LBB21_30
# %bb.31:                               # %middle.block153
                                        #   in Loop: Header=BB21_8 Depth=1
	beq	$a3, $t1, .LBB21_34
.LBB21_32:                              # %for.body.i68.preheader160
                                        #   in Loop: Header=BB21_8 Depth=1
	alsl.d	$a3, $t0, $s4, 3
	.p2align	4, , 16
...
# %bb.59:                               # %middle.block
                                        #   in Loop: Header=BB21_8 Depth=1
	beq	$a3, $t0, .LBB21_62
.LBB21_60:                              # %for.body.i.preheader156
                                        #   in Loop: Header=BB21_8 Depth=1
	alsl.d	$a3, $a6, $s4, 3
	.p2align	4, , 16
.LBB21_61:                              # %for.body.i
