...
.LBB11_48:                              # %if.end457
	pcalau12i	$a0, %pc_hi20(listXsize)
	addi.d	$s6, $a0, %pc_lo12(listXsize)
	ld.wu	$a0, $s7, 32
	ori	$a1, $zero, 0
	lu32i.d	$a1, 1
	st.d	$a1, $s6, 0
...
# %bb.186:                              # %middle.block1435
	beq	$a0, $s3, .LBB11_189
.LBB11_187:                             # %for.body517.preheader1567
	slli.d	$a1, $a0, 3
	alsl.d	$a1, $s8, $a1, 3
	slli.d	$a2, $s3, 3
	sub.d	$a1, $a1, $a2
...
.LBB11_410:                             # %vector.body1507
	...
	addi.d	$a5, $a5, 32
	bnez	$t1, .LBB11_410
# %bb.411:                              # %middle.block1511
	move	$a5, $t0
	bne	$a6, $a7, .LBB11_400
	b	.LBB11_402
.LBB11_412:                             # %vector.scevcheck1514
	ori	$a5, $zero, 33
	sub.d	$a4, $a5, $a4
	addi.w	$a5, $a4, 0
	addi.d	$a6, $zero, -2
...
# %bb.413:                              # %vector.scevcheck1514
	srli.d	$a4, $a4, 32
	bnez	$a4, .LBB11_404
# %bb.414:                              # %vector.ph1518
	move	$a4, $a3
...
.LBB21_30:                              # %vector.body153
	...
	addi.d	$t2, $t2, -16
	bnez	$a4, .LBB21_30
# %bb.31:                               # %middle.block157
                                        #   in Loop: Header=BB21_8 Depth=1
	beq	$a3, $t1, .LBB21_34
.LBB21_32:                              # %for.body.i68.preheader164
                                        #   in Loop: Header=BB21_8 Depth=1
	alsl.d	$a3, $t0, $s4, 3
	.p2align	4, , 16
...
# %bb.59:                               # %middle.block
                                        #   in Loop: Header=BB21_8 Depth=1
	beq	$a3, $t0, .LBB21_62
.LBB21_60:                              # %for.body.i.preheader160
                                        #   in Loop: Header=BB21_8 Depth=1
	alsl.d	$a3, $a6, $s4, 3
	.p2align	4, , 16
.LBB21_61:                              # %for.body.i
...
.LBB25_170:                             #   in Loop: Header=BB25_26 Depth=1
	...
	bnez	$a0, .LBB25_172
	b	.LBB25_183
.LBB25_171:                             # %if.else65.i.i.i
                                        #   in Loop: Header=BB25_26 Depth=1
	move	$s6, $zero
	ld.wu	$a0, $s5, 32
	beqz	$a0, .LBB25_183
.LBB25_172:                             # %for.body69.lr.ph.i.i.i
                                        #   in Loop: Header=BB25_26 Depth=1
	ld.d	$a1, $s5, 8
	move	$s8, $zero
	slli.d	$a3, $a0, 3
...
.LBB25_185:                             # %mm_assign_long_term_frame_idx.exit.i
                                        #   in Loop: Header=BB25_26 Depth=1
	lu12i.w	$s4, 77
.LBB25_186:                             # %mm_assign_long_term_frame_idx.exit.i
                                        #   in Loop: Header=BB25_26 Depth=1
	pcaddu18i	$ra, %call36(update_ref_list)
	jirl	$ra, $ra, 0
	pcaddu18i	$ra, %call36(update_ltref_list)
...
.LBB25_187:                             # %if.then29.i.i
	...
	st.w	$a5, $a3, 4
	andi	$a1, $a6, 2
.LBB25_188:                             # %if.then29.i.i
                                        #   in Loop: Header=BB25_26 Depth=1
	st.w	$a1, $a3, 8
	bne	$a0, $s2, .LBB25_24
# %bb.189:                              # %cleanup.sink.split.i.i
                                        #   in Loop: Header=BB25_26 Depth=1
	ld.d	$a0, $a3, 48
	stx.d	$zero, $a0, $s6
	b	.LBB25_24
.LBB25_190:                             # %if.then28.i.i
                                        #   in Loop: Header=BB25_26 Depth=1
	ld.w	$a1, $a0, 0
	add.d	$a2, $a6, $t0
	st.w	$zero, $a2, 16
	st.w	$a5, $a0, 4
	bne	$a1, $s2, .LBB25_192
.LBB25_191:                             # %if.then39.i.i
                                        #   in Loop: Header=BB25_26 Depth=1
	ld.d	$a0, $a0, 48
	ld.d	$a1, $sp, 8                     # 8-byte Folded Reload
	stx.w	$zero, $a0, $a1
.LBB25_192:                             # %mm_unmark_short_term_for_reference.exit.i
                                        #   in Loop: Header=BB25_26 Depth=1
	pcaddu18i	$ra, %call36(update_ref_list)
	jirl	$ra, $ra, 0
	b	.LBB25_25
.LBB25_193:                             # %if.then86.i.i.i
                                        #   in Loop: Header=BB25_26 Depth=1
	ld.w	$a1, $a0, 8
	beqz	$a1, .LBB25_196
# %bb.194:                              # %land.lhs.true91.i.i.i
                                        #   in Loop: Header=BB25_26 Depth=1
	ld.w	$a3, $a0, 32
	lu12i.w	$s4, 77
	beq	$a3, $s3, .LBB25_197
# %bb.195:                              # %if.then96.i.i.i
                                        #   in Loop: Header=BB25_26 Depth=1
	pcalau12i	$a0, %pc_hi20(.Lstr.2)
	addi.d	$a0, $a0, %pc_lo12(.Lstr.2)
	pcaddu18i	$ra, %call36(puts)
...
.LBB25_199:                             # %if.end166.i.i.i
	...
	st.w	$a2, $a3, 8
	ori	$a1, $a1, 2
.LBB25_200:                             # %if.end98.i.i.i
                                        #   in Loop: Header=BB25_26 Depth=1
	st.w	$a1, $a0, 8
	ld.d	$s8, $sp, 24                    # 8-byte Folded Reload
	bne	$a1, $s2, .LBB25_186
# %bb.201:                              # %if.then121.i.i.i
                                        #   in Loop: Header=BB25_26 Depth=1
	ld.d	$a0, $a0, 48
...
.LBB25_205:
	move	$a1, $zero
	addi.d	$a0, $zero, -1
.LBB25_206:                             # %idr_memory_management.exit
	st.w	$a0, $s5, 44
	st.w	$a1, $s7, 20
...
# %bb.209:                              # %if.then13
	...
	ld.w	$a2, $s7, 8
	bne	$a1, $a2, .LBB25_216
# %bb.210:                              # %land.lhs.true20
	ld.w	$a1, $a0, 0
	ori	$a2, $zero, 2
	beq	$a1, $a2, .LBB25_215
	b	.LBB25_216
.LBB25_211:                             # %lor.lhs.false
	ori	$a1, $zero, 2
	bne	$a0, $a1, .LBB25_216
# %bb.212:                              # %lor.lhs.false
	ld.d	$a0, $s5, 56
	beqz	$a0, .LBB25_216
# %bb.213:                              # %if.then13.thread
	ld.w	$a1, $a0, 20
	ld.w	$a2, $s7, 8
	bne	$a1, $a2, .LBB25_216
# %bb.214:                              # %land.lhs.true27
	ld.w	$a1, $a0, 0
	ori	$a2, $zero, 1
	bne	$a1, $a2, .LBB25_216
.LBB25_215:                             # %if.then31
...
.LBB25_217:                             # %if.end59
	...
	ldptr.w	$a0, $a0, 6068
	beqz	$a0, .LBB25_235
# %bb.218:                              # %for.cond.preheader
	ld.w	$a0, $s5, 24
	beqz	$a0, .LBB25_223
# %bb.219:                              # %for.body.lr.ph
	ld.d	$a1, $s5, 0
	bstrpick.d	$a2, $a0, 31, 0
	ori	$a3, $zero, 1
	b	.LBB25_221
...
# %bb.224:                              # %if.then77
	...
	ld.w	$a2, $s5, 28
	b	.LBB25_236
.LBB25_225:                             # %land.lhs.true52
	ld.w	$a0, $s7, 24
	beqz	$a0, .LBB25_217
# %bb.226:                              # %land.lhs.true55
	ld.w	$a0, $s7, 216
	bnez	$a0, .LBB25_217
# %bb.227:                              # %if.then58
	ld.w	$a0, $s5, 52
	...
	sub.w	$a0, $a0, $a1
	bne	$a2, $a0, .LBB25_234
# %bb.228:                              # %for.cond.preheader.i45
	ld.wu	$a1, $s5, 28
	beqz	$a1, .LBB25_234
# %bb.229:                              # %for.body.lr.ph.i
	ld.d	$a2, $s5, 0
	b	.LBB25_231
	.p2align	4, , 16
.LBB25_230:                             # %for.inc.i
                                        #   in Loop: Header=BB25_231 Depth=1
	addi.d	$a1, $a1, -1
	addi.d	$a2, $a2, 8
	beqz	$a1, .LBB25_234
.LBB25_231:                             # %for.body.i46
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $a2, 0
	ld.w	$a3, $a0, 4
	beqz	$a3, .LBB25_230
...
# %bb.233:                              # %if.then5.i
	...
	pcaddu18i	$ra, %call36(update_ref_list)
	jirl	$ra, $ra, 0
.LBB25_234:                             # %sliding_window_memory_management.exit
	st.w	$zero, $s7, 20
	b	.LBB25_217
.LBB25_235:                             # %if.end70.thread
	ld.w	$a2, $s5, 28
	ld.w	$a0, $s5, 24
	bne	$a2, $a0, .LBB25_252
.LBB25_236:                             # %if.end78
	beqz	$a2, .LBB25_250
# %bb.237:                              # %for.body.lr.ph.i51
	move	$a0, $zero
	ld.d	$a1, $s5, 0
	...
	ori	$a4, $s4, 1456
	b	.LBB25_240
.LBB25_238:                             # %if.then1.i.i
                                        #   in Loop: Header=BB25_240 Depth=1
	ld.d	$a7, $a5, 48
	ldx.w	$a7, $a7, $a4
	beqz	$a7, .LBB25_244
	.p2align	4, , 16
.LBB25_239:                             # %for.inc.i60
                                        #   in Loop: Header=BB25_240 Depth=1
	addi.w	$a0, $a0, 1
	addi.d	$a2, $a2, -1
	addi.d	$a1, $a1, 8
	beqz	$a2, .LBB25_250
.LBB25_240:                             # %for.body.i53
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a5, $a1, 0
	ld.w	$a6, $a5, 36
	beqz	$a6, .LBB25_239
# %bb.241:                              # %land.lhs.true.i57
                                        #   in Loop: Header=BB25_240 Depth=1
	ld.w	$a6, $a5, 4
	bnez	$a6, .LBB25_239
# %bb.242:                              # %if.end.i.i63
...
# %bb.243:                              # %if.end5.i.i
	...
	andi	$a7, $a6, 1
	beqz	$a7, .LBB25_246
.LBB25_244:                             # %if.then8.i.i
                                        #   in Loop: Header=BB25_240 Depth=1
	ld.d	$a7, $a5, 56
	beqz	$a7, .LBB25_246
# %bb.245:                              # %if.then10.i.i67
                                        #   in Loop: Header=BB25_240 Depth=1
	ldx.w	$a7, $a7, $a4
	bnez	$a7, .LBB25_239
.LBB25_246:                             # %if.end17.i.i
                                        #   in Loop: Header=BB25_240 Depth=1
	andi	$a6, $a6, 2
	beqz	$a6, .LBB25_249
# %bb.247:                              # %if.then21.i.i
                                        #   in Loop: Header=BB25_240 Depth=1
	ld.d	$a5, $a5, 64
	beqz	$a5, .LBB25_249
# %bb.248:                              # %if.then23.i.i71
                                        #   in Loop: Header=BB25_240 Depth=1
	ldx.w	$a5, $a5, $a4
	bnez	$a5, .LBB25_239
.LBB25_249:                             # %if.then.i72
	pcaddu18i	$ra, %call36(remove_frame_from_dpb)
	jirl	$ra, $ra, 0
.LBB25_250:                             # %remove_unused_frame_from_dpb.exit
	ld.d	$a0, $s8, 0
	ldptr.w	$a0, $a0, 6068
	beqz	$a0, .LBB25_252
# %bb.251:                              # %if.then82
...
# %bb.253:                              # %while.body.lr.ph
	...
	.p2align	4, , 16
.LBB25_254:                             # %if.end98
                                        #   in Loop: Header=BB25_255 Depth=1
	pcaddu18i	$ra, %call36(output_one_frame_from_dpb)
	jirl	$ra, $ra, 0
	ld.wu	$a0, $s5, 28
	ld.wu	$a1, $s5, 24
	bne	$a0, $a1, .LBB25_265
.LBB25_255:                             # %while.body
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB25_260 Depth 2
	ld.w	$a1, $s7, 24
	bnez	$a1, .LBB25_254
# %bb.256:                              # %if.then89
                                        #   in Loop: Header=BB25_255 Depth=1
...
.LBB25_258:                             # %for.body.lr.ph.i77
	...
	b	.LBB25_260
	.p2align	4, , 16
.LBB25_259:                             # %for.inc.i81
                                        #   in Loop: Header=BB25_260 Depth=2
	addi.w	$a3, $a3, 1
	addi.d	$a0, $a0, -1
	addi.d	$a1, $a1, 8
	beqz	$a0, .LBB25_262
.LBB25_260:                             # %for.body.i78
                                        #   Parent Loop BB25_255 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a6, $a1, 0
	ld.w	$a5, $a6, 40
	bge	$a5, $a2, .LBB25_259
# %bb.261:                              # %land.lhs.true.i83
                                        #   in Loop: Header=BB25_260 Depth=2
	ld.w	$a6, $a6, 36
	sltui	$a6, $a6, 1
	masknez	$a2, $a2, $a6
	...
	b	.LBB25_259
	.p2align	4, , 16
.LBB25_262:                             # %get_smallest_poc.exit
                                        #   in Loop: Header=BB25_255 Depth=1
	beq	$a4, $s1, .LBB25_264
# %bb.263:                              # %lor.lhs.false92
                                        #   in Loop: Header=BB25_255 Depth=1
	ld.w	$a0, $fp, 4
	bge	$a0, $a2, .LBB25_254
.LBB25_264:                             # %if.then96
...
# %bb.266:                              # %land.lhs.true101
	ld.w	$a1, $s7, 20
	bnez	$a1, .LBB25_273
# %bb.267:                              # %land.lhs.true101
	ld.wu	$a1, $s5, 32
	beqz	$a1, .LBB25_273
# %bb.268:                              # %for.body107.lr.ph
	ld.d	$a0, $s5, 8
	...
	b	.LBB25_270
	.p2align	4, , 16
.LBB25_269:                             # %for.inc116
                                        #   in Loop: Header=BB25_270 Depth=1
	addi.d	$s2, $s2, 1
	addi.d	$s1, $s1, 8
	bgeu	$s2, $a1, .LBB25_272
.LBB25_270:                             # %for.body107
                                        # =>This Inner Loop Header: Depth=1
	ldx.d	$a2, $a0, $s1
	ld.w	$a2, $a2, 20
	ld.w	$a3, $s7, 0
...
.LBB25_278:                             # %if.end133
	...
	beqz	$a2, .LBB25_280
# %bb.279:                              # %if.then138
	pcalau12i	$a1, %pc_hi20(pocs_in_dpb)
	addi.d	$a1, $a1, %pc_lo12(pocs_in_dpb)
	ld.w	$a2, $fp, 4
	slli.d	$a0, $a0, 2
	stx.w	$a2, $a1, $a0
.LBB25_280:                             # %if.end142
...
.LBB25_290:                             # %sw.bb19.i
	...
	stptr.w	$a1, $a0, 5672
	b	.LBB25_292
.LBB25_291:                             # %if.then15.sw.epilog33_crit_edge.i
	ld.w	$a1, $fp, 4
.LBB25_292:                             # %sw.epilog33.i
	stptr.w	$a1, $a0, 5752
	pcaddu18i	$ra, %call36(flush_dpb)
	jirl	$ra, $ra, 0
	b	.LBB25_207
...
.LBB30_15:                              # %for.end133
	...
	st.d	$a1, $sp, 8                     # 8-byte Folded Spill
	bltz	$a5, .LBB30_20
# %bb.16:                               # %for.cond212.preheader.lr.ph
	move	$a3, $zero
	move	$a4, $zero
	addi.d	$a5, $a5, 1
	...
	addi.d	$a7, $a2, 816
	.p2align	4, , 16
.LBB30_17:                              # %for.cond212.preheader
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB30_18 Depth 2
	ori	$t0, $zero, 16
	move	$t1, $a3
	.p2align	4, , 16
.LBB30_18:                              # %for.body215
...
.LBB30_26:                              # %for.inc590.us
	...
	stx.d	$a3, $a1, $t6
	beq	$s3, $t1, .LBB30_23
.LBB30_27:                              # %for.body377.us
                                        #   Parent Loop BB30_24 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	bstrpick.d	$a6, $s3, 31, 2
	slli.d	$t6, $s3, 3
	beqz	$t2, .LBB30_31
...
# %bb.30:                               # %cond.true.us
	...
	b	.LBB30_37
	.p2align	4, , 16
.LBB30_31:                              # %for.body377.us.if.else520.us_crit_edge
                                        #   in Loop: Header=BB30_27 Depth=2
	ld.d	$t7, $a4, 88
.LBB30_32:                              # %if.else520.us
                                        #   in Loop: Header=BB30_27 Depth=2
	ld.d	$a1, $t7, 0
	ldx.d	$a1, $a1, $t4
	ldx.b	$t0, $a1, $s3
...
.LBB30_34:                              # %cond.end554.us
	...
	stx.d	$a3, $a1, $t6
	bgez	$t0, .LBB30_25
# %bb.35:                               #   in Loop: Header=BB30_27 Depth=2
	move	$a3, $t8
	b	.LBB30_26
.LBB30_36:                              #   in Loop: Header=BB30_27 Depth=2
	move	$s0, $zero
.LBB30_37:                              # %cond.end.us
                                        #   in Loop: Header=BB30_27 Depth=2
	ld.d	$a3, $t7, 8
	ld.d	$t7, $a4, 104
	ldx.d	$a3, $a3, $t4
...
.LBB30_47:                              # %if.else1305
	...
	pcaddu18i	$t8, %call36(memset)
	jr	$t8
.LBB30_48:                              # %land.lhs.true599
	ld.w	$a0, $a4, 40
	ld.d	$a3, $sp, 24                    # 8-byte Folded Reload
	beqz	$a0, .LBB30_57
# %bb.49:                               # %for.cond604.preheader
	ori	$a0, $zero, 8
	lu12i.w	$a1, 77
	ori	$s7, $a1, 1472
	blt	$a3, $a0, .LBB30_80
# %bb.50:                               # %for.body610.lr.ph
	move	$a4, $zero
	lu12i.w	$a0, 131071
	ori	$a0, $a0, 4094
...
.LBB30_51:                              # %for.inc906
	...
	srai.d	$a1, $a1, 3
	bge	$a4, $a1, .LBB30_58
.LBB30_52:                              # %for.body610
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB30_55 Depth 2
	ldx.w	$a0, $a2, $s7
	ori	$a1, $zero, 4
	blt	$a0, $a1, .LBB30_51
# %bb.53:                               # %for.body623.lr.ph
                                        #   in Loop: Header=BB30_52 Depth=1
	move	$a3, $zero
	move	$t5, $zero
	move	$t6, $zero
...
.LBB30_58:                              # %if.end909
	...
	ld.w	$a0, $a0, 180
	bnez	$a0, .LBB30_47
.LBB30_59:                              # %for.cond914.preheader
	ori	$a0, $zero, 8
	blt	$a3, $a0, .LBB30_80
# %bb.60:                               # %for.body920.lr.ph
	move	$a1, $zero
	ori	$a4, $t5, 1512
	ori	$a5, $t5, 1600
	ori	$a6, $t5, 1560
...
.LBB30_61:                              # %for.inc1302
	...
	ori	$s7, $t5, 1472
	bge	$a1, $a0, .LBB30_80
.LBB30_62:                              # %for.body920
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB30_66 Depth 2
	ldx.w	$a0, $a2, $s7
	ori	$a3, $zero, 4
	blt	$a0, $a3, .LBB30_61
# %bb.63:                               # %for.body930.lr.ph
                                        #   in Loop: Header=BB30_62 Depth=1
	move	$t8, $zero
	move	$s2, $zero
	move	$s3, $zero
...
.LBB30_65:                              # %for.inc1299
	...
	addi.w	$t8, $t8, 1
	bge	$s3, $a0, .LBB30_61
.LBB30_66:                              # %for.body930
                                        #   Parent Loop BB30_62 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.w	$s0, $a2, $a4
	add.d	$a0, $a2, $a4
	beqz	$s0, .LBB30_68
...
.LBB30_71:                              # %if.then1081
	...
	stx.b	$t1, $a3, $s3
	b	.LBB30_74
.LBB30_72:                              # %cond.end1163.critedge
                                        #   in Loop: Header=BB30_66 Depth=2
	ld.d	$a3, $fp, 56
	ldx.d	$a3, $a3, $a0
	ld.d	$a3, $a3, 0
...
.LBB30_77:                              # %if.then1183
	...
	stx.b	$t1, $a0, $s3
	b	.LBB30_65
.LBB30_78:                              # %cond.end1268.critedge
                                        #   in Loop: Header=BB30_66 Depth=2
	ld.d	$a2, $fp, 56
	ldx.d	$a2, $a2, $a0
	ld.d	$a2, $a2, 8
...
# %bb.156:                              # %for.cond1954.preheader.lr.ph
	...
	pcalau12i	$a2, %got_pc_hi20(dec_picture)
	ld.d	$a5, $a2, %got_pc_lo12(dec_picture)
	move	$t7, $zero
	lu12i.w	$a2, 2
	ori	$a6, $a2, 1807
	lu12i.w	$a2, 1
