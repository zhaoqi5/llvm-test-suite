...
# %bb.27:                               # %middle.block86
                                        #   in Loop: Header=BB6_21 Depth=1
	beq	$t0, $a4, .LBB6_20
# %bb.28:                               # %vec.epilog.iter.check91
                                        #   in Loop: Header=BB6_21 Depth=1
	move	$t8, $t0
	move	$t7, $t0
	beqz	$t1, .LBB6_32
.LBB6_29:                               # %vec.epilog.ph90
                                        #   in Loop: Header=BB6_21 Depth=1
	add.d	$t7, $t3, $t8
	alsl.d	$t8, $t8, $t6, 1
	.p2align	4, , 16
.LBB6_30:                               # %vec.epilog.vector.body98
                                        #   Parent Loop BB6_21 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr1, $t8, 0
	addi.d	$t7, $t7, 8
	addi.d	$t8, $t8, 16
	bnez	$t7, .LBB6_30
# %bb.31:                               # %vec.epilog.middle.block101
                                        #   in Loop: Header=BB6_21 Depth=1
	move	$t7, $t2
	beq	$t2, $a4, .LBB6_20
...
# %bb.40:                               #   in Loop: Header=BB6_37 Depth=1
	...
	b	.LBB6_45
	.p2align	4, , 16
.LBB6_41:                               # %vector.body114.preheader
                                        #   in Loop: Header=BB6_37 Depth=1
	addi.d	$t4, $t3, 32
	move	$t5, $a5
	.p2align	4, , 16
.LBB6_42:                               # %vector.body114
	...
	addi.d	$t4, $t4, 64
	bnez	$t5, .LBB6_42
# %bb.43:                               # %middle.block117
                                        #   in Loop: Header=BB6_37 Depth=1
	beq	$a5, $a4, .LBB6_36
# %bb.44:                               # %vec.epilog.iter.check122
                                        #   in Loop: Header=BB6_37 Depth=1
	move	$t5, $a5
	move	$t4, $a5
	beqz	$a6, .LBB6_48
.LBB6_45:                               # %vec.epilog.ph121
                                        #   in Loop: Header=BB6_37 Depth=1
	add.d	$t4, $t0, $t5
	alsl.d	$t5, $t5, $t3, 1
	.p2align	4, , 16
.LBB6_46:                               # %vec.epilog.vector.body129
                                        #   Parent Loop BB6_37 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr1, $t5, 0
	addi.d	$t4, $t4, 8
	addi.d	$t5, $t5, 16
	bnez	$t4, .LBB6_46
# %bb.47:                               # %vec.epilog.middle.block132
                                        #   in Loop: Header=BB6_37 Depth=1
	move	$t4, $a7
	beq	$a7, $a4, .LBB6_36
...
# %bb.28:                               # %middle.block132
                                        #   in Loop: Header=BB7_22 Depth=1
	beq	$t3, $a1, .LBB7_21
# %bb.29:                               # %vec.epilog.iter.check137
                                        #   in Loop: Header=BB7_22 Depth=1
	move	$s3, $t3
	move	$s2, $t3
	beqz	$a2, .LBB7_33
.LBB7_30:                               # %vec.epilog.ph136
                                        #   in Loop: Header=BB7_22 Depth=1
	add.d	$s1, $t5, $s3
	alsl.d	$s2, $s3, $t8, 1
	.p2align	4, , 16
.LBB7_31:                               # %vec.epilog.vector.body144
                                        #   Parent Loop BB7_22 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr1, $s2, 0
	addi.d	$s1, $s1, 8
	addi.d	$s2, $s2, 16
	bnez	$s1, .LBB7_31
# %bb.32:                               # %vec.epilog.middle.block147
                                        #   in Loop: Header=BB7_22 Depth=1
	move	$s2, $t4
	beq	$t4, $a1, .LBB7_21
...
# %bb.38:                               #   in Loop: Header=BB7_37 Depth=1
	...
	b	.LBB7_48
	.p2align	4, , 16
.LBB7_39:                               # %vector.main.loop.iter.check154
                                        #   in Loop: Header=BB7_37 Depth=1
	bgeu	$a1, $t2, .LBB7_41
# %bb.40:                               #   in Loop: Header=BB7_37 Depth=1
	...
	b	.LBB7_45
	.p2align	4, , 16
.LBB7_41:                               # %vector.body160.preheader
                                        #   in Loop: Header=BB7_37 Depth=1
	addi.d	$t4, $t3, 32
	move	$t5, $a5
	.p2align	4, , 16
.LBB7_42:                               # %vector.body160
	...
	addi.d	$t4, $t4, 64
	bnez	$t5, .LBB7_42
# %bb.43:                               # %middle.block163
                                        #   in Loop: Header=BB7_37 Depth=1
	beq	$a5, $a1, .LBB7_36
# %bb.44:                               # %vec.epilog.iter.check168
                                        #   in Loop: Header=BB7_37 Depth=1
	move	$t6, $a5
	move	$t5, $a5
	beqz	$a2, .LBB7_48
.LBB7_45:                               # %vec.epilog.ph167
                                        #   in Loop: Header=BB7_37 Depth=1
	add.d	$t4, $t0, $t6
	alsl.d	$t5, $t6, $t3, 1
	.p2align	4, , 16
.LBB7_46:                               # %vec.epilog.vector.body175
                                        #   Parent Loop BB7_37 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr1, $t5, 0
	addi.d	$t4, $t4, 8
	addi.d	$t5, $t5, 16
	bnez	$t4, .LBB7_46
# %bb.47:                               # %vec.epilog.middle.block178
                                        #   in Loop: Header=BB7_37 Depth=1
	move	$t5, $a6
	beq	$a6, $a1, .LBB7_36
...
# %bb.57:                               #   in Loop: Header=BB7_56 Depth=1
	...
	b	.LBB7_67
	.p2align	4, , 16
.LBB7_58:                               # %vector.main.loop.iter.check185
                                        #   in Loop: Header=BB7_56 Depth=1
	bgeu	$a0, $t3, .LBB7_60
# %bb.59:                               #   in Loop: Header=BB7_56 Depth=1
	...
	b	.LBB7_64
	.p2align	4, , 16
.LBB7_60:                               # %vector.body191.preheader
                                        #   in Loop: Header=BB7_56 Depth=1
	addi.d	$t5, $t4, 32
	move	$t6, $a6
	.p2align	4, , 16
.LBB7_61:                               # %vector.body191
	...
	addi.d	$t5, $t5, 64
	bnez	$t6, .LBB7_61
# %bb.62:                               # %middle.block194
                                        #   in Loop: Header=BB7_56 Depth=1
	beq	$a6, $a0, .LBB7_55
# %bb.63:                               # %vec.epilog.iter.check199
                                        #   in Loop: Header=BB7_56 Depth=1
	move	$t7, $a6
	move	$t6, $a6
	beqz	$a7, .LBB7_67
.LBB7_64:                               # %vec.epilog.ph198
	...
	alsl.d	$t6, $t7, $t4, 1
	.p2align	4, , 16
.LBB7_65:                               # %vec.epilog.vector.body206
                                        #   Parent Loop BB7_56 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr1, $t6, 0
	addi.d	$t5, $t5, 8
	addi.d	$t6, $t6, 16
	bnez	$t5, .LBB7_65
# %bb.66:                               # %vec.epilog.middle.block209
                                        #   in Loop: Header=BB7_56 Depth=1
	move	$t6, $t0
	beq	$t0, $a0, .LBB7_55
...
# %bb.74:                               #   in Loop: Header=BB7_73 Depth=1
	...
	b	.LBB7_84
	.p2align	4, , 16
.LBB7_75:                               # %vector.main.loop.iter.check216
                                        #   in Loop: Header=BB7_73 Depth=1
	bgeu	$a2, $t8, .LBB7_77
...
.LBB7_78:                               # %vector.body222
	...
	addi.d	$s3, $s3, 64
	bnez	$s4, .LBB7_78
# %bb.79:                               # %middle.block225
                                        #   in Loop: Header=BB7_73 Depth=1
	beq	$t4, $a2, .LBB7_72
# %bb.80:                               # %vec.epilog.iter.check230
                                        #   in Loop: Header=BB7_73 Depth=1
	move	$s5, $t4
	move	$s4, $t4
	beqz	$a3, .LBB7_84
.LBB7_81:                               # %vec.epilog.ph229
                                        #   in Loop: Header=BB7_73 Depth=1
	add.d	$s3, $t6, $s5
	alsl.d	$s4, $s5, $s2, 1
	.p2align	4, , 16
.LBB7_82:                               # %vec.epilog.vector.body237
                                        #   Parent Loop BB7_73 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr1, $s4, 0
	addi.d	$s3, $s3, 8
	addi.d	$s4, $s4, 16
	bnez	$s3, .LBB7_82
# %bb.83:                               # %vec.epilog.middle.block240
                                        #   in Loop: Header=BB7_73 Depth=1
	move	$s4, $t5
	beq	$t5, $a2, .LBB7_72
...
# %bb.89:                               #   in Loop: Header=BB7_88 Depth=1
	...
	b	.LBB7_99
	.p2align	4, , 16
.LBB7_90:                               # %vector.main.loop.iter.check247
                                        #   in Loop: Header=BB7_88 Depth=1
	bgeu	$a2, $t3, .LBB7_92
# %bb.91:                               #   in Loop: Header=BB7_88 Depth=1
	...
	b	.LBB7_96
	.p2align	4, , 16
.LBB7_92:                               # %vector.body253.preheader
                                        #   in Loop: Header=BB7_88 Depth=1
	addi.d	$t5, $t4, 32
	move	$t6, $a6
	.p2align	4, , 16
.LBB7_93:                               # %vector.body253
	...
	addi.d	$t5, $t5, 64
	bnez	$t6, .LBB7_93
# %bb.94:                               # %middle.block256
                                        #   in Loop: Header=BB7_88 Depth=1
	beq	$a6, $a2, .LBB7_87
# %bb.95:                               # %vec.epilog.iter.check261
                                        #   in Loop: Header=BB7_88 Depth=1
	move	$t7, $a6
	move	$t6, $a6
	beqz	$a3, .LBB7_99
.LBB7_96:                               # %vec.epilog.ph260
                                        #   in Loop: Header=BB7_88 Depth=1
	add.d	$t5, $t1, $t7
	alsl.d	$t6, $t7, $t4, 1
	.p2align	4, , 16
.LBB7_97:                               # %vec.epilog.vector.body268
                                        #   Parent Loop BB7_88 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr1, $t6, 0
	addi.d	$t5, $t5, 8
	addi.d	$t6, $t6, 16
	bnez	$t5, .LBB7_97
# %bb.98:                               # %vec.epilog.middle.block271
                                        #   in Loop: Header=BB7_88 Depth=1
	move	$t6, $a7
	beq	$a7, $a2, .LBB7_87
