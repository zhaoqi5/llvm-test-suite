...
# %bb.6:                                # %if.then.i.us.us
	...
	pcaddu18i	$ra, %call36(error)
	jirl	$ra, $ra, 0
.LBB11_7:                               # %for.body.i.us.us.us.preheader
                                        #   in Loop: Header=BB11_5 Depth=1
	move	$fp, $zero
	st.d	$s3, $sp, 24                    # 8-byte Folded Spill
	alsl.d	$s5, $s3, $s5, 3
	.p2align	4, , 16
.LBB11_8:                               # %for.body.i.us.us.us
...
.LBB11_12:                              # %if.end7.i.us.us.us
	...
	.p2align	4, , 16
.LBB11_13:                              # %for.body.i16.us.us.us
                                        #   Parent Loop BB11_5 Depth=1
...
.LBB11_16:                              # %if.then
	...
	jirl	$ra, $ra, 0
	bgtz	$s6, .LBB11_2
.LBB11_17:                              # %if.end.for.end_crit_edge
	mul.d	$s2, $s4, $s3
	b	.LBB11_33
.LBB11_18:                              # %for.body.preheader
...
# %bb.21:                               # %if.then.i
	...
	jirl	$ra, $ra, 0
	b	.LBB11_19
.LBB11_22:                              # %for.body.us.preheader
	slli.d	$fp, $s1, 3
	pcalau12i	$a0, %pc_hi20(errortext)
	addi.d	$s4, $a0, %pc_lo12(errortext)
	pcalau12i	$a0, %pc_hi20(.L.str.17)
	...
	b	.LBB11_24
	.p2align	4, , 16
.LBB11_23:                              # %get_mem3Dint.exit.loopexit.split.us41
...
# %bb.25:                               # %if.then.i.us
	...
	pcaddu18i	$ra, %call36(error)
	jirl	$ra, $ra, 0
.LBB11_26:                              # %for.body.i.us25.preheader
                                        #   in Loop: Header=BB11_24 Depth=1
	move	$s1, $zero
	...
	b	.LBB11_28
	.p2align	4, , 16
.LBB11_27:                              # %if.end7.i.us38
                                        #   in Loop: Header=BB11_28 Depth=2
	addi.d	$s1, $s1, 8
	beq	$fp, $s1, .LBB11_23
.LBB11_28:                              # %for.body.i.us25
...
# %bb.6:                                # %if.then.i.us.us
	...
	pcaddu18i	$ra, %call36(error)
	jirl	$ra, $ra, 0
.LBB21_7:                               # %for.body.i.us.us.us.preheader
                                        #   in Loop: Header=BB21_5 Depth=1
	move	$fp, $zero
	st.d	$s3, $sp, 24                    # 8-byte Folded Spill
	alsl.d	$s5, $s3, $s5, 3
	.p2align	4, , 16
.LBB21_8:                               # %for.body.i.us.us.us
...
.LBB21_12:                              # %if.end7.i.us.us.us
	...
	ld.d	$a2, $sp, 72                    # 8-byte Folded Reload
	.p2align	4, , 16
.LBB21_13:                              # %for.body.i16.us.us.us
                                        #   Parent Loop BB21_5 Depth=1
...
.LBB21_16:                              # %if.then
	...
	jirl	$ra, $ra, 0
	bgtz	$s6, .LBB21_2
.LBB21_17:                              # %if.end.for.end_crit_edge
	mul.d	$s2, $s4, $s3
	b	.LBB21_33
.LBB21_18:                              # %for.body.preheader
	bstrpick.d	$a0, $s6, 31, 0
	slli.d	$fp, $a0, 3
	pcalau12i	$a0, %pc_hi20(errortext)
	addi.d	$s3, $a0, %pc_lo12(errortext)
...
# %bb.21:                               # %if.then.i
	...
	jirl	$ra, $ra, 0
	b	.LBB21_19
.LBB21_22:                              # %for.body.us.preheader
	slli.d	$fp, $s1, 3
	pcalau12i	$a0, %pc_hi20(errortext)
	addi.d	$s4, $a0, %pc_lo12(errortext)
	pcalau12i	$a0, %pc_hi20(.L.str.17)
	...
	b	.LBB21_24
	.p2align	4, , 16
.LBB21_23:                              # %get_mem3Dshort.exit.loopexit.split.us41
...
# %bb.25:                               # %if.then.i.us
	...
	pcaddu18i	$ra, %call36(error)
	jirl	$ra, $ra, 0
.LBB21_26:                              # %for.body.i.us25.preheader
                                        #   in Loop: Header=BB21_24 Depth=1
	move	$s1, $zero
	st.d	$s8, $sp, 80                    # 8-byte Folded Spill
	alsl.d	$s6, $s8, $s6, 3
	b	.LBB21_28
	.p2align	4, , 16
.LBB21_27:                              # %if.end7.i.us38
                                        #   in Loop: Header=BB21_28 Depth=2
	addi.d	$s1, $s1, 8
	beq	$fp, $s1, .LBB21_23
.LBB21_28:                              # %for.body.i.us25
