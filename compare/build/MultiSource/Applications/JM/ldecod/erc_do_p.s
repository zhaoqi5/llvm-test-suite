...
.LBB1_21:                               # %if.end187.peel
	...
	blt	$s6, $a0, .LBB1_23
# %bb.22:                               # %if.end187.peel
                                        #   in Loop: Header=BB1_5 Depth=2
	bnez	$s5, .LBB1_31
.LBB1_23:                               # %for.body209.preheader.peel
                                        #   in Loop: Header=BB1_5 Depth=2
	ld.w	$a1, $sp, 160
	ld.d	$a2, $sp, 152
	ld.bu	$a0, $s3, 0
...
# %bb.27:                               #   in Loop: Header=BB1_5 Depth=2
	...
	bgez	$a0, .LBB1_32
	b	.LBB1_2
.LBB1_28:                               # %cond.false232.peel
                                        #   in Loop: Header=BB1_5 Depth=2
	beqz	$a0, .LBB1_25
.LBB1_29:                               # %cond.false244.peel
                                        #   in Loop: Header=BB1_5 Depth=2
	ori	$a0, $zero, 1
.LBB1_30:                               # %cond.end248.peel
                                        #   in Loop: Header=BB1_5 Depth=2
...
# %bb.37:                               # %cond.false113
                                        #   in Loop: Header=BB1_5 Depth=2
	bne	$a0, $a5, .LBB1_35
.LBB1_38:                               #   in Loop: Header=BB1_5 Depth=2
	move	$a6, $s2
	b	.LBB1_3
.LBB1_39:                               # %if.then121
                                        #   in Loop: Header=BB1_5 Depth=2
...
# %bb.47:                               # %cond.true222
	...
	ori	$a1, $zero, 4
	bne	$a0, $a1, .LBB1_50
.LBB1_48:                               #   in Loop: Header=BB1_5 Depth=2
	move	$a0, $zero
	b	.LBB1_51
.LBB1_49:                               # %cond.false232
                                        #   in Loop: Header=BB1_5 Depth=2
	beqz	$a0, .LBB1_48
.LBB1_50:                               # %cond.false244
                                        #   in Loop: Header=BB1_5 Depth=2
	ori	$a0, $zero, 1
.LBB1_51:                               # %cond.end248
                                        #   in Loop: Header=BB1_5 Depth=2
...
.LBB2_20:                               # %vec.epilog.ph
	...
	alsl.d	$fp, $fp, $a7, 1
	.p2align	4, , 16
.LBB2_21:                               # %vec.epilog.vector.body
                                        #   Parent Loop BB2_6 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $s5, 0
	vst	$vr0, $fp, 0
...
# %bb.0:                                # %entry
	...
	ld.d	$s8, $a4, %got_pc_lo12(dec_picture)
	ldptr.w	$a4, $a2, 6068
	st.w	$a3, $s6, 176
	ori	$a3, $zero, 2
	st.d	$a0, $s8, 0
...
# %bb.9:                                #   in Loop: Header=BB19_6 Depth=1
	...
	b	.LBB19_14
	.p2align	4, , 16
.LBB19_10:                              # %vector.body.preheader
                                        #   in Loop: Header=BB19_6 Depth=1
	addi.d	$fp, $t8, 32
	addi.d	$s0, $t7, 32
	move	$s1, $t0
...
.LBB19_28:                              # %for.body19.us.i
	...
	b	.LBB19_24
	.p2align	4, , 16
.LBB19_29:                              # %vector.memcheck219
                                        #   in Loop: Header=BB19_25 Depth=1
	sub.d	$s1, $fp, $t7
	move	$s0, $zero
	bltu	$s1, $t5, .LBB19_27
# %bb.30:                               # %vector.memcheck219
                                        #   in Loop: Header=BB19_25 Depth=1
	sub.d	$s1, $t7, $t6
	bltu	$s1, $t5, .LBB19_27
...
# %bb.32:                               # %vector.memcheck219
	...
	sub.d	$s1, $fp, $t6
	bltu	$s1, $t5, .LBB19_27
# %bb.33:                               # %vector.memcheck219
                                        #   in Loop: Header=BB19_25 Depth=1
	sub.d	$s1, $fp, $t8
	bltu	$s1, $t5, .LBB19_27
# %bb.34:                               # %vector.main.loop.iter.check232
                                        #   in Loop: Header=BB19_25 Depth=1
	bgeu	$a0, $t5, .LBB19_36
# %bb.35:                               #   in Loop: Header=BB19_25 Depth=1
	move	$s4, $zero
	b	.LBB19_40
.LBB19_36:                              # %vector.body236.preheader
                                        #   in Loop: Header=BB19_25 Depth=1
	addi.d	$s0, $t6, 32
	addi.d	$s1, $fp, 32
	addi.d	$s2, $t7, 32
...
.LBB19_37:                              # %vector.body236
	...
	addi.d	$s3, $s3, 64
	bnez	$s4, .LBB19_37
# %bb.38:                               # %middle.block243
                                        #   in Loop: Header=BB19_25 Depth=1
	beq	$t0, $a3, .LBB19_24
# %bb.39:                               # %vec.epilog.iter.check248
                                        #   in Loop: Header=BB19_25 Depth=1
	move	$s4, $t0
	move	$s0, $t0
	beqz	$t1, .LBB19_27
.LBB19_40:                              # %vec.epilog.ph247
                                        #   in Loop: Header=BB19_25 Depth=1
	add.d	$s0, $t3, $s4
	alsl.d	$s1, $s4, $fp, 1
	alsl.d	$s2, $s4, $t8, 1
	...
	alsl.d	$s4, $s4, $t6, 1
	.p2align	4, , 16
.LBB19_41:                              # %vec.epilog.vector.body253
                                        #   Parent Loop BB19_25 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $s4, 0
	vst	$vr0, $s3, 0
	...
	addi.d	$s4, $s4, 16
	bnez	$s0, .LBB19_41
# %bb.42:                               # %vec.epilog.middle.block258
                                        #   in Loop: Header=BB19_25 Depth=1
	move	$s0, $t2
	beq	$t2, $a3, .LBB19_24
	b	.LBB19_27
...
# %bb.55:                               # %if.then.i.us
	...
	ldptr.w	$a1, $s1, 5936
	slli.d	$a2, $fp, 5
	pcalau12i	$a3, %got_pc_hi20(subblk_offset_y)
	ld.d	$a3, $a3, %got_pc_lo12(subblk_offset_y)
	pcalau12i	$a4, %got_pc_hi20(subblk_offset_x)
	ld.d	$a4, $a4, %got_pc_lo12(subblk_offset_x)
	addi.d	$a2, $a2, -32
	ldx.bu	$a6, $a3, $a2
	ld.w	$a7, $s1, 88
	ldx.bu	$a2, $a4, $a2
...
# %bb.1:                                # %if.then
	pcalau12i	$a2, %got_pc_hi20(img)
	ld.d	$a2, $a2, %got_pc_lo12(img)
	pcalau12i	$a3, %got_pc_hi20(dpb)
	ld.d	$a3, $a3, %got_pc_lo12(dpb)
	ld.d	$a2, $a2, 0
	ld.w	$a3, $a3, 40
	ldptr.w	$a2, $a2, 6064
	sub.w	$a0, $a0, $a3
...
.LBB24_9:                               # %for.body10.preheader
	...
	ld.hu	$t4, $a7, 30
	b	.LBB24_3
.LBB24_10:                              # %for.body129.preheader
                                        #   in Loop: Header=BB24_6 Depth=2
	ld.hu	$a4, $a2, 30
	ld.hu	$t2, $a1, 0
	sub.d	$a4, $a4, $t2
...
# %bb.0:                                # %entry
	...
	ld.w	$a6, $a3, 124
	pcalau12i	$a4, %pc_hi20(uv_div)
	addi.d	$a4, $a4, %pc_lo12(uv_div)
	alsl.d	$a7, $a6, $a4, 2
	slli.d	$t0, $a6, 2
	ldx.w	$a3, $a4, $t0
...
.LBB25_21:                              # %vec.epilog.ph
	...
	alsl.d	$t5, $t5, $a1, 1
	.p2align	4, , 16
.LBB25_22:                              # %vec.epilog.vector.body
                                        #   Parent Loop BB25_8 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $t5, -128
	vld	$vr1, $t5, 0
