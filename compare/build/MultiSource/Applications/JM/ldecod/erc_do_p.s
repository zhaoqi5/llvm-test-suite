...
# %bb.35:                               #   in Loop: Header=BB19_25 Depth=1
	move	$s4, $zero
	b	.LBB19_40
.LBB19_36:                              # %vector.body238.preheader
                                        #   in Loop: Header=BB19_25 Depth=1
	addi.d	$s0, $t6, 32
	addi.d	$s1, $fp, 32
	addi.d	$s2, $t7, 32
...
.LBB19_37:                              # %vector.body238
	...
	addi.d	$s3, $s3, 64
	bnez	$s4, .LBB19_37
# %bb.38:                               # %middle.block245
                                        #   in Loop: Header=BB19_25 Depth=1
	beq	$t0, $a3, .LBB19_24
# %bb.39:                               # %vec.epilog.iter.check250
                                        #   in Loop: Header=BB19_25 Depth=1
	move	$s4, $t0
	move	$s0, $t0
	beqz	$t1, .LBB19_27
.LBB19_40:                              # %vec.epilog.ph249
                                        #   in Loop: Header=BB19_25 Depth=1
	add.d	$s0, $t3, $s4
	alsl.d	$s1, $s4, $fp, 1
	alsl.d	$s2, $s4, $t8, 1
	...
	alsl.d	$s4, $s4, $t6, 1
	.p2align	4, , 16
.LBB19_41:                              # %vec.epilog.vector.body255
                                        #   Parent Loop BB19_25 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $s4, 0
	vst	$vr0, $s3, 0
	...
	addi.d	$s4, $s4, 16
	bnez	$s0, .LBB19_41
# %bb.42:                               # %vec.epilog.middle.block260
                                        #   in Loop: Header=BB19_25 Depth=1
	move	$s0, $t2
	beq	$t2, $a3, .LBB19_24
	b	.LBB19_27
