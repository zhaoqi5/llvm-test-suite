...
.LBB21_8:                               # %if.else11
	...
	slli.d	$a7, $a6, 8
	alsl.d	$a6, $a6, $a7, 4
	pcalau12i	$a7, %pc_hi20(readSyntaxElement_NumCoeffTrailingOnes.lentab)
	addi.d	$a7, $a7, %pc_lo12(readSyntaxElement_NumCoeffTrailingOnes.lentab)
	add.d	$t1, $a7, $a6
	pcalau12i	$a7, %pc_hi20(readSyntaxElement_NumCoeffTrailingOnes.codtab)
	addi.d	$a7, $a7, %pc_lo12(readSyntaxElement_NumCoeffTrailingOnes.codtab)
	add.d	$t2, $a7, $a6
	ori	$a6, $zero, 7
	andn	$a6, $a6, $a2
	srai.d	$a7, $a2, 3
...
# %bb.0:                                # %entry
	...
	slli.d	$a4, $a2, 8
	alsl.d	$a2, $a2, $a4, 4
	pcalau12i	$a4, %pc_hi20(readSyntaxElement_NumCoeffTrailingOnesChromaDC.lentab)
	addi.d	$a4, $a4, %pc_lo12(readSyntaxElement_NumCoeffTrailingOnesChromaDC.lentab)
	add.d	$t1, $a4, $a2
	ld.d	$a1, $a1, 0
	pcalau12i	$a4, %pc_hi20(readSyntaxElement_NumCoeffTrailingOnesChromaDC.codtab)
	addi.d	$a4, $a4, %pc_lo12(readSyntaxElement_NumCoeffTrailingOnesChromaDC.codtab)
	add.d	$t2, $a4, $a2
	ld.w	$a2, $a1, 8
	ld.d	$a4, $a1, 16
	ld.w	$a5, $a1, 12
...
# %bb.0:                                # %entry
	...
	move	$a2, $zero
	slli.d	$a4, $a3, 6
	pcalau12i	$a3, %pc_hi20(readSyntaxElement_TotalZeros.lentab)
	addi.d	$a3, $a3, %pc_lo12(readSyntaxElement_TotalZeros.lentab)
	add.d	$a3, $a3, $a4
	ld.d	$a1, $a1, 0
	pcalau12i	$a5, %pc_hi20(readSyntaxElement_TotalZeros.codtab)
	addi.d	$a5, $a5, %pc_lo12(readSyntaxElement_TotalZeros.codtab)
	add.d	$a5, $a5, $a4
	ld.w	$a4, $a1, 8
	ld.d	$a6, $a1, 16
	ld.w	$a7, $a1, 12
...
# %bb.0:                                # %entry
	...
	ori	$a5, $zero, 960
	mul.d	$a5, $a3, $a5
	pcalau12i	$a3, %pc_hi20(readSyntaxElement_TotalZerosChromaDC.lentab)
	addi.d	$a3, $a3, %pc_lo12(readSyntaxElement_TotalZerosChromaDC.lentab)
	add.d	$a3, $a3, $a5
	slli.d	$a4, $a4, 6
	add.d	$a3, $a3, $a4
	pcalau12i	$a6, %pc_hi20(readSyntaxElement_TotalZerosChromaDC.codtab)
	ld.d	$a1, $a1, 0
	addi.d	$a6, $a6, %pc_lo12(readSyntaxElement_TotalZerosChromaDC.codtab)
	add.d	$a5, $a6, $a5
	add.d	$a5, $a5, $a4
	ld.w	$a4, $a1, 8
	ld.d	$a6, $a1, 16
...
# %bb.0:                                # %entry
	...
	move	$a2, $zero
	slli.d	$a4, $a3, 6
	pcalau12i	$a3, %pc_hi20(readSyntaxElement_Run.lentab)
	addi.d	$a3, $a3, %pc_lo12(readSyntaxElement_Run.lentab)
	add.d	$a3, $a3, $a4
	ld.d	$a1, $a1, 0
	pcalau12i	$a5, %pc_hi20(readSyntaxElement_Run.codtab)
	addi.d	$a5, $a5, %pc_lo12(readSyntaxElement_Run.codtab)
	add.d	$a5, $a5, $a4
	ld.w	$a4, $a1, 8
	ld.d	$a6, $a1, 16
	ld.w	$a7, $a1, 12
