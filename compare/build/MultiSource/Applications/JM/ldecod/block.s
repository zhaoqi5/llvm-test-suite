...
.LBB1_58:
	move	$a0, $zero
	b	.LBB1_94
.LBB1_59:                               # %for.body101.us.preheader
	beqz	$a0, .LBB1_95
# %bb.60:                               # %if.then103.us.15
	ld.d	$a4, $a4, 0
	alsl.d	$a2, $a3, $a4, 1
	slli.d	$a3, $a3, 1
	ldx.hu	$a4, $a4, $a3
...
# %bb.0:                                # %entry
	...
	add.w	$t2, $t2, $t4
	slli.d	$t4, $t1, 6
	pcalau12i	$t1, %pc_hi20(quant_coef)
	addi.d	$s7, $t1, %pc_lo12(quant_coef)
	pcalau12i	$t1, %got_pc_hi20(dequant_coef)
	ldx.w	$s8, $s7, $t4
	ld.d	$ra, $t1, %got_pc_lo12(dequant_coef)
	srai.d	$t1, $t2, 1
	add.d	$t2, $s7, $t4
	mul.d	$s7, $a6, $s8
	add.d	$a6, $ra, $t4
