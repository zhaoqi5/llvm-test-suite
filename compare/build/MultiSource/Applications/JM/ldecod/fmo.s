...
# %bb.28:                               # %iter.check213
	...
	ori	$a4, $zero, 64
	bltu	$a3, $a4, .LBB0_42
# %bb.29:                               # %vector.main.loop.iter.check215
	ori	$a2, $zero, 16
	bgeu	$s4, $a2, .LBB0_35
# %bb.30:
	move	$a2, $zero
...
.LBB0_36:                               # %vector.body219
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB0_36
# %bb.37:                               # %middle.block224
	beq	$a2, $s4, .LBB0_44
# %bb.38:                               # %vec.epilog.iter.check229
	andi	$a3, $s4, 12
	beqz	$a3, .LBB0_42
.LBB0_39:                               # %vec.epilog.ph228
	move	$a5, $a2
	...
	alsl.d	$a5, $a5, $a1, 2
	.p2align	4, , 16
.LBB0_40:                               # %vec.epilog.vector.body234
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 4
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_40
# %bb.41:                               # %vec.epilog.middle.block238
	beq	$a2, $s4, .LBB0_44
...
# %bb.55:                               # %iter.check167
	...
	addi.w	$a2, $a2, 1
	bltu	$a3, $a5, .LBB0_58
# %bb.56:                               # %vector.memcheck163
	ori	$a5, $s3, 1728
	add.d	$a4, $a4, $a5
	bgeu	$a0, $a4, .LBB0_110
# %bb.57:                               # %vector.memcheck163
	alsl.d	$a4, $s4, $a0, 2
	bgeu	$a1, $a4, .LBB0_110
.LBB0_58:
	move	$a3, $zero
...
.LBB0_76:                               # %for.body38.i
	...
	bnez	$s4, .LBB0_76
	b	.LBB0_44
.LBB0_77:                               # %vector.main.loop.iter.check68
	ori	$a6, $zero, 16
...
# %bb.78:
	move	$a4, $zero
	b	.LBB0_87
.LBB0_79:                               # %vector.main.loop.iter.check136
	ori	$a3, $zero, 16
	bgeu	$a1, $a3, .LBB0_92
# %bb.80:
	move	$a1, $zero
	b	.LBB0_96
.LBB0_81:                               # %vector.main.loop.iter.check109
	ori	$a3, $zero, 16
	bgeu	$a1, $a3, .LBB0_112
# %bb.82:
	move	$a3, $zero
...
.LBB0_84:                               # %vector.body76
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB0_84
# %bb.85:                               # %middle.block79
	beq	$a4, $s4, .LBB0_21
# %bb.86:                               # %vec.epilog.iter.check84
	andi	$a6, $s4, 12
	beqz	$a6, .LBB0_90
.LBB0_87:                               # %vec.epilog.ph83
	move	$a6, $a4
	...
	alsl.d	$a6, $a6, $a0, 2
	.p2align	4, , 16
.LBB0_88:                               # %vec.epilog.vector.body97
                                        # =>This Inner Loop Header: Depth=1
	...
	addi.d	$a6, $a6, 16
	bnez	$a5, .LBB0_88
# %bb.89:                               # %vec.epilog.middle.block102
	beq	$a4, $s4, .LBB0_21
...
.LBB0_93:                               # %vector.body142
	...
	addi.d	$a3, $a3, 64
	bnez	$a4, .LBB0_93
# %bb.94:                               # %middle.block145
	beq	$a1, $s4, .LBB0_101
# %bb.95:                               # %vec.epilog.iter.check150
	andi	$a3, $s4, 12
	beqz	$a3, .LBB0_99
.LBB0_96:                               # %vec.epilog.ph149
	move	$a4, $a1
	...
	alsl.d	$a4, $a4, $a0, 2
	.p2align	4, , 16
.LBB0_97:                               # %vec.epilog.vector.body157
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, 16
	bnez	$a3, .LBB0_97
# %bb.98:                               # %vec.epilog.middle.block160
	beq	$a1, $s4, .LBB0_101
...
# %bb.109:                              # %for.cond23.for.inc32_crit_edge.i.i
	...
	bgeu	$a7, $a6, .LBB0_107
	b	.LBB0_103
.LBB0_110:                              # %vector.main.loop.iter.check169
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB0_147
# %bb.111:
	move	$a3, $zero
	b	.LBB0_151
.LBB0_112:                              # %vector.ph110
...
.LBB0_113:                              # %vector.body113
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB0_113
# %bb.114:                              # %middle.block116
	beq	$a3, $s4, .LBB0_121
# %bb.115:                              # %vec.epilog.iter.check121
	andi	$a6, $s4, 12
	beqz	$a6, .LBB0_119
.LBB0_116:                              # %vec.epilog.ph120
	move	$a7, $a3
	...
	vrepli.w	$vr0, 2
	.p2align	4, , 16
.LBB0_117:                              # %vec.epilog.vector.body126
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a7, 0
	addi.d	$a6, $a6, 4
	addi.d	$a7, $a7, 16
	bnez	$a6, .LBB0_117
# %bb.118:                              # %vec.epilog.middle.block129
	beq	$a3, $s4, .LBB0_121
...
.LBB0_148:                              # %vector.body175
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB0_148
# %bb.149:                              # %middle.block183
	beq	$a3, $s4, .LBB0_21
# %bb.150:                              # %vec.epilog.iter.check188
	andi	$a4, $s4, 12
	beqz	$a4, .LBB0_59
.LBB0_151:                              # %vec.epilog.ph187
	move	$a5, $a3
	bstrpick.d	$a3, $s4, 31, 2
	slli.d	$a3, $a3, 2
	...
	alsl.d	$a5, $a5, $a0, 2
	.p2align	4, , 16
.LBB0_152:                              # %vec.epilog.vector.body198
                                        # =>This Inner Loop Header: Depth=1
	vdiv.wu	$vr3, $vr2, $vr1
	vaddi.wu	$vr4, $vr2, 4
	vmsub.w	$vr2, $vr3, $vr1
	...
	vori.b	$vr2, $vr4, 0
	bnez	$a4, .LBB0_152
# %bb.153:                              # %vec.epilog.middle.block205
	beq	$a3, $s4, .LBB0_21
	b	.LBB0_59
