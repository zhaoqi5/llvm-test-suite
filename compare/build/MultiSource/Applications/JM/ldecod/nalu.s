	.file	"nalu.c"
	.text
	.globl	NALUtoRBSP                      # -- Begin function NALUtoRBSP
	.p2align	5
	.type	NALUtoRBSP,@function
NALUtoRBSP:                             # @NALUtoRBSP
# %bb.0:                                # %entry
	addi.d	$sp, $sp, -16
	...
	ld.w	$a1, $fp, 4
	ori	$a2, $zero, 1
	pcaddu18i	$ra, %call36(EBSPtoRBSP)
	jirl	$ra, $ra, 0
	st.w	$a0, $fp, 4
	...
	ret
.Lfunc_end0:
	.size	NALUtoRBSP, .Lfunc_end0-NALUtoRBSP
                                        # -- End function
