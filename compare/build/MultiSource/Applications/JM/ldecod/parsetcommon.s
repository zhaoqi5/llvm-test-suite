...
.LBB5_19:                               # %for.body55
	...
	bnez	$a3, .LBB5_19
	b	.LBB5_42
.LBB5_20:                               # %vector.main.loop.iter.check146
	ori	$a2, $zero, 16
	bgeu	$a4, $a2, .LBB5_24
# %bb.21:
	move	$a4, $zero
...
.LBB5_28:                               # %vec.epilog.ph166
	...
	add.d	$a6, $a0, $a6
	vrepli.b	$vr1, -1
.LBB5_29:                               # %vec.epilog.vector.body174
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $a6, 0
	vld	$vr3, $a5, 0
	vseq.w	$vr2, $vr2, $vr3
	...
	addi.d	$a6, $a6, 16
	bnez	$a2, .LBB5_29
# %bb.30:                               # %vec.epilog.middle.block180
	vslli.w	$vr0, $vr0, 31
	vmskltz.w	$vr0, $vr0
	vpickve2gr.hu	$a2, $vr0, 0
	sltui	$a2, $a2, 1
