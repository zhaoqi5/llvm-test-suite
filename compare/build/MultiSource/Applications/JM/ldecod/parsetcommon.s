...
.LBB4_32:                               # %vector.body
	...
	xvpickve2gr.w	$a7, $xr4, 3
	vinsgr2vr.h	$vr6, $a7, 3
	xvpickve2gr.w	$a7, $xr4, 4
	vinsgr2vr.h	$vr6, $a7, 4
	xvpickve2gr.w	$a7, $xr4, 5
	vinsgr2vr.h	$vr6, $a7, 5
	xvpickve2gr.w	$a7, $xr4, 6
	vinsgr2vr.h	$vr6, $a7, 6
	xvpickve2gr.w	$a7, $xr4, 7
	vinsgr2vr.h	$vr6, $a7, 7
	vor.v	$vr1, $vr1, $vr5
	vor.v	$vr3, $vr3, $vr6
	addi.d	$a6, $a6, -16
	addi.d	$a4, $a4, 64
...
.LBB5_19:                               # %for.body55
	...
	bnez	$a3, .LBB5_19
	b	.LBB5_42
.LBB5_20:                               # %vector.main.loop.iter.check148
	ori	$a2, $zero, 16
	bgeu	$a4, $a2, .LBB5_24
# %bb.21:
	move	$a4, $zero
...
# %bb.26:                               # %middle.block161
	...
	sltui	$a2, $a2, 1
	beq	$a4, $a3, .LBB5_42
# %bb.27:                               # %vec.epilog.iter.check169
	andi	$a5, $a3, 12
	beqz	$a5, .LBB5_31
.LBB5_28:                               # %vec.epilog.ph168
	move	$a5, $a4
	sltui	$a2, $a2, 1
	...
	add.d	$a6, $a0, $a6
	vrepli.b	$vr1, -1
.LBB5_29:                               # %vec.epilog.vector.body176
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $a6, 0
	vld	$vr3, $a5, 0
	vseq.w	$vr2, $vr2, $vr3
	...
	addi.d	$a6, $a6, 16
	bnez	$a2, .LBB5_29
# %bb.30:                               # %vec.epilog.middle.block182
	vslli.w	$vr0, $vr0, 31
	vmskltz.w	$vr0, $vr0
	vpickve2gr.hu	$a2, $vr0, 0
	sltui	$a2, $a2, 1
	beq	$a4, $a3, .LBB5_42
.LBB5_31:                               # %for.body.preheader
	slli.d	$a5, $a4, 2
	addi.d	$a6, $a5, 996
	add.d	$a5, $a0, $a6
	add.d	$a6, $a1, $a6
...
.LBB5_37:                               # %vec.epilog.ph
	...
	alsl.d	$t0, $t0, $a3, 2
	vrepli.b	$vr1, -1
.LBB5_38:                               # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $t0, 0
	vld	$vr3, $a7, 0
	vseq.w	$vr2, $vr2, $vr3
