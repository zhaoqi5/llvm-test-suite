...
# %bb.0:                                # %entry
	...
	ld.d	$s1, $a0, %got_pc_lo12(UsedBits)
	ld.d	$s7, $s0, 0
	move	$s3, $a1
	st.w	$zero, $s1, 0
...
# %bb.0:                                # %entry
	...
	st.d	$s7, $sp, 96                    # 8-byte Folded Spill
	st.d	$s8, $sp, 88                    # 8-byte Folded Spill
	pcalau12i	$a2, %got_pc_hi20(UsedBits)
	ld.d	$s3, $a2, %got_pc_lo12(UsedBits)
	ld.d	$s7, $a0, 0
	move	$s5, $a1
	st.w	$zero, $s3, 0
...
.LBB5_17:                               # %for.body91.lr.ph
	...
	pcalau12i	$a0, %pc_hi20(ZZ_SCAN8)
	addi.d	$s8, $a0, %pc_lo12(ZZ_SCAN8)
...
.LBB15_13:                              # %activate_pps.exit
	...
	masknez	$a1, $a1, $a0
	maskeqz	$a2, $a2, $a0
	pcalau12i	$a4, %got_pc_hi20(readSyntaxElement_CABAC)
	ld.d	$a3, $a3, 0
	ld.d	$a4, $a4, %got_pc_lo12(readSyntaxElement_CABAC)
	pcalau12i	$a5, %got_pc_hi20(readSyntaxElement_UVLC)
	ld.d	$a5, $a5, %got_pc_lo12(readSyntaxElement_UVLC)
	ldptr.d	$a3, $a3, 5592
	or	$a1, $a2, $a1
	masknez	$a2, $a4, $a0
	maskeqz	$a0, $a5, $a0
