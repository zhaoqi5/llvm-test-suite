...
# %bb.44:                               # %do.body31.preheader.i
	...
	addi.d	$s6, $a0, %pc_lo12(.L.str.64)
	ori	$s8, $zero, 2
	ori	$s4, $zero, 3
	pcalau12i	$a0, %pc_hi20(.L.str.65)
	addi.d	$fp, $a0, %pc_lo12(.L.str.65)
	move	$s7, $zero
	b	.LBB2_47
	.p2align	4, , 16
...
# %bb.40:                               # %iter.check245
	...
	add.d	$a7, $a0, $a7
	bltu	$a6, $t0, .LBB4_43
# %bb.41:                               # %vector.memcheck237
	alsl.d	$t0, $a6, $a1, 2
	addi.d	$t0, $t0, 1040
	bgeu	$a7, $t0, .LBB4_84
# %bb.42:                               # %vector.memcheck237
	ori	$a3, $a3, 1632
	add.d	$a3, $a0, $a3
	bgeu	$a5, $a3, .LBB4_84
.LBB4_43:
...
.LBB4_83:
	...
	bgtz	$a4, .LBB4_16
	b	.LBB4_37
.LBB4_84:                               # %vector.main.loop.iter.check247
	ori	$a3, $zero, 15
	addi.d	$a5, $a6, 1
	bgeu	$a6, $a3, .LBB4_93
# %bb.85:
...
# %bb.95:                               # %middle.block258
	...
	st.w	$a4, $a7, 0
	beq	$a5, $a3, .LBB4_47
# %bb.96:                               # %vec.epilog.iter.check264
	beqz	$t0, .LBB4_44
.LBB4_97:                               # %vec.epilog.ph266
	move	$t0, $a3
	...
	addi.d	$a4, $a4, 1036
	.p2align	4, , 16
.LBB4_98:                               # %vec.epilog.vector.body269
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a4, 0
	vadd.w	$vr0, $vr0, $vr1
	addi.d	$t0, $t0, 4
	addi.d	$a4, $a4, 16
	bne	$a3, $t0, .LBB4_98
# %bb.99:                               # %vec.epilog.middle.block274
	vhaddw.d.w	$vr0, $vr0, $vr0
	vhaddw.q.d	$vr0, $vr0, $vr0
