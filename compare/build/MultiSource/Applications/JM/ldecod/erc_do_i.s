...
# %bb.11:                               # %for.cond1.preheader.us.i.preheader
	beqz	$t8, .LBB2_35
# %bb.12:                               # %for.cond1.preheader.us.i.preheader247
...
# %bb.25:                               # %for.cond1.preheader.us.us.i.preheader
	...
	ld.d	$a0, $a0, %got_pc_lo12(img)
	beqz	$t2, .LBB2_54
# %bb.26:                               # %for.cond1.preheader.us.us.i.preheader239
	move	$a5, $zero
	slli.d	$t0, $a4, 1
	b	.LBB2_28
	.p2align	4, , 16
...
# %bb.46:                               # %for.cond1.preheader.us.us.us.i.preheader
	beqz	$t1, .LBB2_90
# %bb.47:                               # %for.cond1.preheader.us.us.us.i.preheader235
	pcalau12i	$a0, %got_pc_hi20(img)
	ld.d	$a0, $a0, %got_pc_lo12(img)
	move	$a5, $zero
	slli.d	$t0, $a4, 1
...
.LBB2_71:                               # %for.body3.us57.i.us.us.us.us71
	...
	b	.LBB2_64
	.p2align	4, , 16
.LBB2_72:                               # %for.body3.us57.i.us.us.us.us57.us.preheader225
                                        #   in Loop: Header=BB2_65 Depth=1
	move	$t8, $zero
	move	$fp, $a2
	.p2align	4, , 16
...
# %bb.83:                               #   in Loop: Header=BB2_77 Depth=1
	move	$fp, $zero
	b	.LBB2_88
.LBB2_84:                               # %vector.body192.preheader
                                        #   in Loop: Header=BB2_77 Depth=1
	move	$t7, $a0
	move	$t8, $t6
	move	$fp, $t2
	.p2align	4, , 16
.LBB2_85:                               # %vector.body192
                                        #   Parent Loop BB2_77 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	xvld	$xr2, $t8, -32
	xvld	$xr3, $t8, 0
	...
	addi.d	$t7, $t7, 64
	bnez	$fp, .LBB2_85
# %bb.86:                               # %middle.block197
                                        #   in Loop: Header=BB2_77 Depth=1
	beq	$t2, $a2, .LBB2_76
# %bb.87:                               # %vec.epilog.iter.check202
                                        #   in Loop: Header=BB2_77 Depth=1
	move	$t8, $t2
	move	$fp, $t2
	beqz	$t3, .LBB2_80
.LBB2_88:                               # %vec.epilog.vector.body207.preheader
                                        #   in Loop: Header=BB2_77 Depth=1
	sub.d	$t7, $a2, $fp
	alsl.d	$t8, $fp, $a1, 1
	alsl.d	$fp, $fp, $t0, 1
	.p2align	4, , 16
.LBB2_89:                               # %vec.epilog.vector.body207
                                        #   Parent Loop BB2_77 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr2, $fp, 0
	vand.v	$vr2, $vr2, $vr0
...
# %bb.109:                              #   in Loop: Header=BB2_103 Depth=1
	move	$t7, $zero
	b	.LBB2_114
.LBB2_110:                              # %vector.body167.preheader
                                        #   in Loop: Header=BB2_103 Depth=1
	move	$t5, $t2
	move	$t6, $a0
	move	$t7, $a7
	.p2align	4, , 16
.LBB2_111:                              # %vector.body167
                                        #   Parent Loop BB2_103 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	xvld	$xr2, $t5, -32
	xvld	$xr3, $t5, 0
