...
.LBB0_14:                               # %iter.check277
	...
	add.d	$a0, $t1, $t0
	bltu	$a1, $s8, .LBB0_17
# %bb.15:                               # %vector.memcheck268
                                        #   in Loop: Header=BB0_14 Depth=2
	add.d	$fp, $t1, $s3
	bgeu	$ra, $fp, .LBB0_20
# %bb.16:                               # %vector.memcheck268
                                        #   in Loop: Header=BB0_14 Depth=2
	alsl.d	$t1, $s6, $t1, 1
	bgeu	$t1, $s7, .LBB0_20
...
.LBB0_19:                               # %for.body72.us
	...
	b	.LBB0_13
	.p2align	4, , 16
.LBB0_20:                               # %vector.main.loop.iter.check279
                                        #   in Loop: Header=BB0_14 Depth=2
	ori	$a2, $zero, 16
	bgeu	$a1, $a2, .LBB0_25
# %bb.21:                               #   in Loop: Header=BB0_14 Depth=2
	move	$s0, $zero
.LBB0_22:                               # %vec.epilog.ph293
                                        #   in Loop: Header=BB0_14 Depth=2
...
# %bb.24:                               # %vec.epilog.middle.block300
	...
	beq	$a2, $a1, .LBB0_13
	b	.LBB0_18
.LBB0_25:                               # %vector.body283.preheader
                                        #   in Loop: Header=BB0_14 Depth=2
	addi.d	$t1, $a0, 16
	move	$fp, $t8
	ld.d	$s0, $sp, 216                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB0_26:                               # %vector.body283
                                        #   Parent Loop BB0_4 Depth=1
                                        #     Parent Loop BB0_14 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.h	$s1, $t1, -16
...
.LBB0_43:                               # %vec.epilog.ph259
	...
	move	$s6, $t7
	.p2align	4, , 16
.LBB0_44:                               # %vec.epilog.vector.body262
                                        #   Parent Loop BB0_4 Depth=1
                                        #     Parent Loop BB0_32 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	add.d	$a2, $s6, $fp
	...
	addi.d	$s3, $s3, 16
	bnez	$a0, .LBB0_44
# %bb.45:                               # %vec.epilog.middle.block265
                                        #   in Loop: Header=BB0_32 Depth=2
...
# %bb.48:                               # %middle.block253
	...
	ld.d	$a5, $sp, 96                    # 8-byte Folded Reload
	beq	$a0, $a1, .LBB0_31
# %bb.49:                               # %vec.epilog.iter.check257
                                        #   in Loop: Header=BB0_32 Depth=2
	...
	beqz	$a0, .LBB0_34
	b	.LBB0_43
.LBB0_50:                               # %for.cond69.preheader.lr.ph.split.us.1
                                        #   in Loop: Header=BB0_4 Depth=1
	ld.d	$a0, $sp, 32                    # 8-byte Folded Reload
	ld.d	$a0, $a0, 8
	move	$a4, $zero
	...
	b	.LBB0_52
	.p2align	4, , 16
.LBB0_51:                               # %for.cond69.for.inc88_crit_edge.us.1
...
.LBB0_52:                               # %iter.check188
	...
	add.d	$a0, $t1, $a5
	bltu	$a1, $s8, .LBB0_55
# %bb.53:                               # %vector.memcheck179
                                        #   in Loop: Header=BB0_52 Depth=2
	add.d	$a2, $t1, $s3
	bgeu	$ra, $a2, .LBB0_58
# %bb.54:                               # %vector.memcheck179
                                        #   in Loop: Header=BB0_52 Depth=2
	alsl.d	$a2, $s6, $t1, 1
	bgeu	$a2, $s5, .LBB0_58
.LBB0_55:                               #   in Loop: Header=BB0_52 Depth=2
	move	$fp, $zero
.LBB0_56:                               # %for.body72.us.1.preheader
                                        #   in Loop: Header=BB0_52 Depth=2
	alsl.d	$a0, $fp, $a0, 1
	sub.d	$t1, $a1, $fp
	slli.d	$a2, $fp, 6
...
.LBB0_57:                               # %for.body72.us.1
	...
	b	.LBB0_51
	.p2align	4, , 16
.LBB0_58:                               # %vector.main.loop.iter.check190
                                        #   in Loop: Header=BB0_52 Depth=2
	ori	$a2, $zero, 16
	bgeu	$a1, $a2, .LBB0_63
# %bb.59:                               #   in Loop: Header=BB0_52 Depth=2
	move	$s1, $zero
.LBB0_60:                               # %vec.epilog.ph203
                                        #   in Loop: Header=BB0_52 Depth=2
	ld.d	$a2, $sp, 176                   # 8-byte Folded Reload
	add.d	$t1, $a2, $s1
	alsl.d	$a2, $s1, $a0, 1
	...
	move	$s3, $s0
	.p2align	4, , 16
.LBB0_61:                               # %vec.epilog.vector.body206
                                        #   Parent Loop BB0_4 Depth=1
                                        #     Parent Loop BB0_52 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.h	$a2, $fp, -8
	...
	addi.d	$s3, $s3, 512
	bnez	$t1, .LBB0_61
# %bb.62:                               # %vec.epilog.middle.block210
                                        #   in Loop: Header=BB0_52 Depth=2
	...
	beq	$a2, $a1, .LBB0_51
	b	.LBB0_56
.LBB0_63:                               # %vector.body194.preheader
                                        #   in Loop: Header=BB0_52 Depth=2
	addi.d	$t1, $a0, 16
	move	$fp, $s4
	ld.d	$s1, $sp, 112                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB0_64:                               # %vector.body194
                                        #   Parent Loop BB0_4 Depth=1
                                        #     Parent Loop BB0_52 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.h	$a2, $t1, -16
...
# %bb.65:                               # %middle.block197
	...
	beq	$a2, $a1, .LBB0_51
# %bb.66:                               # %vec.epilog.iter.check201
                                        #   in Loop: Header=BB0_52 Depth=2
	...
	bnez	$a2, .LBB0_60
	b	.LBB0_56
.LBB0_67:                               # %for.cond95.preheader.lr.ph.split.us.1
                                        #   in Loop: Header=BB0_4 Depth=1
	ld.d	$a0, $sp, 32                    # 8-byte Folded Reload
	ld.d	$s2, $a0, 8
	move	$t7, $zero
	...
	b	.LBB0_69
	.p2align	4, , 16
.LBB0_68:                               # %for.cond95.for.inc131_crit_edge.us.1
...
# %bb.70:                               #   in Loop: Header=BB0_69 Depth=2
	move	$t1, $zero
.LBB0_71:                               # %for.body98.us.1.preheader
                                        #   in Loop: Header=BB0_69 Depth=2
	sub.d	$a0, $a1, $t1
	add.d	$a2, $s6, $t1
	alsl.d	$a4, $a2, $a4, 1
...
# %bb.77:                               # %vector.memcheck
	...
	and	$a2, $a2, $a3
	bnez	$a2, .LBB0_71
# %bb.78:                               # %vector.main.loop.iter.check
                                        #   in Loop: Header=BB0_69 Depth=2
	ori	$a2, $zero, 16
	bgeu	$a1, $a2, .LBB0_83
# %bb.79:                               #   in Loop: Header=BB0_69 Depth=2
	move	$fp, $zero
.LBB0_80:                               # %vec.epilog.ph
                                        #   in Loop: Header=BB0_69 Depth=2
	ld.d	$a0, $sp, 176                   # 8-byte Folded Reload
	add.d	$a0, $a0, $fp
	add.d	$a2, $s6, $fp
	...
	move	$s6, $t8
	.p2align	4, , 16
.LBB0_81:                               # %vec.epilog.vector.body
                                        #   Parent Loop BB0_4 Depth=1
                                        #     Parent Loop BB0_69 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	add.d	$a2, $s6, $fp
...
.LBB0_84:                               # %vector.body
	...
	vinsgr2vr.h	$vr1, $s6, 1
	vinsgr2vr.h	$vr1, $s8, 2
	vinsgr2vr.h	$vr1, $ra, 3
	vinsgr2vr.h	$vr1, $t2, 4
	vinsgr2vr.h	$vr1, $s4, 5
	vinsgr2vr.h	$vr1, $s0, 6
	vinsgr2vr.h	$vr1, $a2, 7
	xvpermi.q	$xr0, $xr1, 2
	xvst	$xr0, $s7, 0
	add.d	$a2, $a7, $t1
...
# %bb.21:                               # %cond.false.1
	...
	ori	$a5, $zero, 6
	beq	$a6, $a7, .LBB14_23
# %bb.22:                               # %cond.false20.1
	ori	$a5, $zero, 5
.LBB14_23:                              # %cond.end30.1
	st.b	$a5, $a4, 24
	ld.bu	$t1, $a3, 329
	ori	$a5, $zero, 11
	beq	$t1, $a5, .LBB14_25
...
# %bb.32:                               # %cond.false.2
	...
	ori	$a5, $zero, 6
	beq	$a6, $a7, .LBB14_34
# %bb.33:                               # %cond.false20.2
	ori	$a5, $zero, 5
.LBB14_34:                              # %cond.end30.2
	st.b	$a5, $a4, 48
	ld.bu	$t0, $a3, 330
	ori	$a5, $zero, 11
	beq	$t0, $a5, .LBB14_36
...
# %bb.43:                               # %cond.false.3
	...
	ori	$a5, $zero, 6
	beq	$a6, $a7, .LBB14_45
# %bb.44:                               # %cond.false20.3
	ori	$a5, $zero, 5
.LBB14_45:                              # %cond.end30.3
	st.b	$a5, $a4, 72
	ld.bu	$a7, $a3, 331
	ori	$a3, $zero, 11
	beq	$a7, $a3, .LBB14_47
