...
# %bb.0:                                # %entry
	...
	ld.d	$t2, $a0, %pc_lo12(dec_picture)
	lu12i.w	$a0, 77
	ori	$a0, $a0, 1520
...
.LBB0_14:                               # %iter.check276
	...
	add.d	$t6, $a5, $s3
	bltu	$a3, $s5, .LBB0_17
# %bb.15:                               # %vector.memcheck267
                                        #   in Loop: Header=BB0_14 Depth=2
	add.d	$t7, $a5, $s8
	alsl.d	$a5, $a6, $a5, 1
	bgeu	$s7, $t7, .LBB0_20
# %bb.16:                               # %vector.memcheck267
                                        #   in Loop: Header=BB0_14 Depth=2
...
.LBB0_19:                               # %for.body72.us
	...
	b	.LBB0_13
	.p2align	4, , 16
.LBB0_20:                               # %vector.main.loop.iter.check278
                                        #   in Loop: Header=BB0_14 Depth=2
	bgeu	$a3, $ra, .LBB0_25
# %bb.21:                               #   in Loop: Header=BB0_14 Depth=2
	move	$t8, $zero
.LBB0_22:                               # %vec.epilog.ph290
                                        #   in Loop: Header=BB0_14 Depth=2
	move	$a0, $s0
	add.d	$a5, $s2, $t8
	alsl.d	$t7, $t8, $t6, 1
	...
	move	$fp, $t4
	.p2align	4, , 16
.LBB0_23:                               # %vec.epilog.vector.body296
                                        #   Parent Loop BB0_4 Depth=1
                                        #     Parent Loop BB0_14 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vld	$vr0, $t7, 0
	...
	st.h	$s1, $s0, -448
	vpickve2gr.h	$s1, $vr0, 1
	st.h	$s1, $s0, -384
	vpickve2gr.h	$s1, $vr0, 2
	st.h	$s1, $s0, -320
	vstelm.h	$vr0, $s0, -256, 3
	vstelm.h	$vr0, $s0, -192, 4
	vstelm.h	$vr0, $s0, -128, 5
	vstelm.h	$vr0, $s0, -64, 6
	vstelm.h	$vr0, $s0, 0, 7
	addi.d	$a5, $a5, 8
	addi.d	$t7, $t7, 16
	addi.d	$fp, $fp, 512
	bnez	$a5, .LBB0_23
# %bb.24:                               # %vec.epilog.middle.block300
                                        #   in Loop: Header=BB0_14 Depth=2
	move	$t7, $t1
	move	$s0, $a0
	beq	$t1, $a3, .LBB0_13
	b	.LBB0_18
.LBB0_25:                               # %vector.body282.preheader
                                        #   in Loop: Header=BB0_14 Depth=2
	move	$t7, $t5
	move	$t8, $a2
	.p2align	4, , 16
.LBB0_26:                               # %vector.body282
                                        #   Parent Loop BB0_4 Depth=1
                                        #     Parent Loop BB0_14 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	xvld	$xr0, $a5, 0
	...
	st.h	$fp, $t7, -320
	xvstelm.h	$xr0, $t7, -256, 4
	xvstelm.h	$xr0, $t7, -192, 5
	xvstelm.h	$xr0, $t7, -128, 6
	xvstelm.h	$xr0, $t7, -64, 7
	xvstelm.h	$xr0, $t7, 0, 8
	xvstelm.h	$xr0, $t7, 64, 9
	xvstelm.h	$xr0, $t7, 128, 10
	xvstelm.h	$xr0, $t7, 192, 11
	...
	addi.d	$t7, $t7, 1024
	bnez	$t8, .LBB0_26
# %bb.27:                               # %middle.block286
                                        #   in Loop: Header=BB0_14 Depth=2
	beq	$a2, $a3, .LBB0_13
# %bb.28:                               # %vec.epilog.iter.check291
                                        #   in Loop: Header=BB0_14 Depth=2
	move	$t8, $a2
	move	$t7, $a2
...
# %bb.37:                               # %vector.memcheck211
	...
	and	$fp, $fp, $s4
	bnez	$fp, .LBB0_50
# %bb.38:                               # %vector.memcheck211
                                        #   in Loop: Header=BB0_32 Depth=2
	sltu	$fp, $t0, $a2
	sltu	$t7, $s7, $t7
	and	$t7, $fp, $t7
	bnez	$t7, .LBB0_50
# %bb.39:                               # %vector.memcheck211
                                        #   in Loop: Header=BB0_32 Depth=2
	sltu	$t7, $a7, $t2
	sltu	$fp, $s1, $t4
	and	$t7, $t7, $fp
...
# %bb.40:                               # %vector.memcheck211
	...
	bnez	$t4, .LBB0_34
# %bb.41:                               # %vector.main.loop.iter.check244
                                        #   in Loop: Header=BB0_32 Depth=2
	bgeu	$a3, $ra, .LBB0_46
# %bb.42:                               #   in Loop: Header=BB0_32 Depth=2
	move	$t4, $zero
.LBB0_43:                               # %vec.epilog.ph255
                                        #   in Loop: Header=BB0_32 Depth=2
	...
	move	$s4, $t8
	.p2align	4, , 16
.LBB0_44:                               # %vec.epilog.vector.body261
                                        #   Parent Loop BB0_4 Depth=1
                                        #     Parent Loop BB0_32 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	add.d	$a0, $s4, $t7
	...
	addi.d	$fp, $fp, 512
	bnez	$a7, .LBB0_44
# %bb.45:                               # %vec.epilog.middle.block264
                                        #   in Loop: Header=BB0_32 Depth=2
	...
	beq	$a0, $a3, .LBB0_31
	b	.LBB0_34
.LBB0_46:                               # %vector.body248.preheader
                                        #   in Loop: Header=BB0_32 Depth=2
	move	$t7, $s3
	ld.d	$fp, $sp, 128                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB0_47:                               # %vector.body248
                                        #   Parent Loop BB0_4 Depth=1
                                        #     Parent Loop BB0_32 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.h	$t5, $t7, -512
...
.LBB0_54:                               # %iter.check185
	...
	add.d	$fp, $a5, $s4
	bltu	$a3, $s5, .LBB0_57
# %bb.55:                               # %vector.memcheck176
                                        #   in Loop: Header=BB0_54 Depth=2
	add.d	$a1, $a5, $s8
	alsl.d	$a5, $a6, $a5, 1
	bgeu	$s7, $a1, .LBB0_60
# %bb.56:                               # %vector.memcheck176
                                        #   in Loop: Header=BB0_54 Depth=2
...
.LBB0_59:                               # %for.body72.us.1
	...
	b	.LBB0_53
	.p2align	4, , 16
.LBB0_60:                               # %vector.main.loop.iter.check187
                                        #   in Loop: Header=BB0_54 Depth=2
	bgeu	$a3, $ra, .LBB0_65
# %bb.61:                               #   in Loop: Header=BB0_54 Depth=2
	move	$s2, $zero
.LBB0_62:                               # %vec.epilog.ph198
                                        #   in Loop: Header=BB0_54 Depth=2
	add.d	$a5, $s3, $s2
	alsl.d	$t4, $s2, $fp, 1
	slli.d	$s0, $s2, 6
	move	$s2, $t7
	.p2align	4, , 16
.LBB0_63:                               # %vec.epilog.vector.body204
                                        #   Parent Loop BB0_4 Depth=1
                                        #     Parent Loop BB0_54 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vld	$vr0, $t4, 0
	...
	st.h	$a2, $a1, -320
	vstelm.h	$vr0, $a1, -256, 3
	vstelm.h	$vr0, $a1, -192, 4
	vstelm.h	$vr0, $a1, -128, 5
	vstelm.h	$vr0, $a1, -64, 6
	vstelm.h	$vr0, $a1, 0, 7
	addi.d	$a5, $a5, 8
	addi.d	$t4, $t4, 16
	addi.d	$s2, $s2, 512
	bnez	$a5, .LBB0_63
# %bb.64:                               # %vec.epilog.middle.block208
                                        #   in Loop: Header=BB0_54 Depth=2
	move	$s0, $t3
	beq	$t3, $a3, .LBB0_53
	b	.LBB0_58
.LBB0_65:                               # %vector.body191.preheader
                                        #   in Loop: Header=BB0_54 Depth=2
	move	$t4, $t8
	move	$s0, $t2
	.p2align	4, , 16
.LBB0_66:                               # %vector.body191
                                        #   Parent Loop BB0_4 Depth=1
                                        #     Parent Loop BB0_54 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	xvld	$xr0, $a5, 0
	...
	st.h	$a1, $t4, -320
	xvstelm.h	$xr0, $t4, -256, 4
	xvstelm.h	$xr0, $t4, -192, 5
	xvstelm.h	$xr0, $t4, -128, 6
	xvstelm.h	$xr0, $t4, -64, 7
	xvstelm.h	$xr0, $t4, 0, 8
	xvstelm.h	$xr0, $t4, 64, 9
	xvstelm.h	$xr0, $t4, 128, 10
	xvstelm.h	$xr0, $t4, 192, 11
	xvpermi.d	$xr0, $xr0, 14
	...
	addi.d	$t4, $t4, 1024
	bnez	$s0, .LBB0_66
# %bb.67:                               # %middle.block194
                                        #   in Loop: Header=BB0_54 Depth=2
	beq	$t0, $a3, .LBB0_53
# %bb.68:                               # %vec.epilog.iter.check199
                                        #   in Loop: Header=BB0_54 Depth=2
	move	$s2, $t0
	move	$s0, $t0
...
# %bb.19:                               # %for.cond139.preheader
	...
	xvinsgr2vr.w	$xr1, $t3, 2
	xvinsgr2vr.w	$xr1, $t1, 3
	xvinsgr2vr.w	$xr1, $t4, 4
...
# %bb.23:                               # %for.cond301.preheader
	...
	xvinsgr2vr.w	$xr1, $t2, 1
	xvinsgr2vr.w	$xr1, $t5, 2
	xvinsgr2vr.w	$xr1, $a2, 3
	xvinsgr2vr.w	$xr1, $t6, 4
	xvinsgr2vr.w	$xr1, $t7, 5
...
.LBB14_2:                               # %if.else262
	...
	srai.d	$s3, $s5, 31
	xor	$s1, $s1, $s3
	pcalau12i	$s4, %got_pc_hi20(erc_mvperMB)
	ld.d	$s4, $s4, %got_pc_lo12(erc_mvperMB)
	sub.d	$s1, $s1, $s3
	srai.d	$s2, $s2, 31
	ldx.d	$t7, $t7, $fp
	ld.w	$fp, $s4, 0
