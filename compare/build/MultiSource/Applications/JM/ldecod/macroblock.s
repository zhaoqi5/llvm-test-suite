...
.LBB25_53:                              # %if.end177
	...
	st.d	$a2, $sp, 256                   # 8-byte Folded Spill
	bne	$a0, $a1, .LBB25_61
# %bb.54:                               # %land.lhs.true180
	ld.w	$a0, $s6, 40
	beqz	$a0, .LBB25_61
# %bb.55:                               # %land.lhs.true182
	ld.w	$a0, $a6, 40
	beqz	$a0, .LBB25_311
# %bb.56:                               # %land.lhs.true182
	ori	$a1, $zero, 8
	bne	$a0, $a1, .LBB25_61
# %bb.57:                               # %land.lhs.true191
	ld.bu	$a0, $a6, 328
	beqz	$a0, .LBB25_311
# %bb.58:                               # %land.lhs.true194
	ld.bu	$a0, $a6, 329
	beqz	$a0, .LBB25_311
# %bb.59:                               # %land.lhs.true199
	ld.bu	$a0, $a6, 330
	beqz	$a0, .LBB25_311
# %bb.60:                               # %land.lhs.true204
	ld.bu	$a0, $a6, 331
	beqz	$a0, .LBB25_311
.LBB25_61:
...
# %bb.64:                               # %if.then1219
	...
	b	.LBB25_217
	.p2align	4, , 16
.LBB25_65:                              #   in Loop: Header=BB25_63 Depth=1
	move	$a5, $s5
	ori	$s5, $zero, 11
	st.d	$s8, $sp, 544                   # 8-byte Folded Spill
	st.d	$s3, $sp, 536                   # 8-byte Folded Spill
	b	.LBB25_69
.LBB25_66:                              #   in Loop: Header=BB25_69 Depth=2
	move	$s7, $s4
	move	$s4, $t8
	move	$fp, $t7
	move	$s0, $t6
...
# %bb.150:                              # %if.then2185
	...
	add.d	$a0, $a0, $a1
	b	.LBB25_169
.LBB25_151:                             #   in Loop: Header=BB25_69 Depth=2
	ld.d	$s6, $sp, 416                   # 8-byte Folded Reload
	ld.d	$a0, $sp, 512                   # 8-byte Folded Reload
	bnez	$a0, .LBB25_79
.LBB25_152:                             # %if.then2305
                                        #   in Loop: Header=BB25_69 Depth=2
	move	$s7, $t8
	move	$s2, $s3
	move	$s3, $t7
...
# %bb.157:                              # %land.lhs.true2629
	...
	ld.w	$a2, $s6, 44
	beqz	$a2, .LBB25_159
# %bb.158:                              # %land.lhs.true2629
                                        #   in Loop: Header=BB25_69 Depth=2
	ori	$a3, $zero, 3
	bne	$a2, $a3, .LBB25_161
.LBB25_159:                             # %land.lhs.true2645
                                        #   in Loop: Header=BB25_69 Depth=2
	ld.d	$a1, $sp, 512                   # 8-byte Folded Reload
	bnez	$a1, .LBB25_163
	b	.LBB25_164
.LBB25_160:                             #   in Loop: Header=BB25_69 Depth=2
	lu12i.w	$s4, 1
	ld.d	$a4, $sp, 352                   # 8-byte Folded Reload
	move	$ra, $s5
	ori	$s5, $zero, 11
	...
	bnez	$a3, .LBB25_178
	b	.LBB25_184
.LBB25_161:                             # %lor.lhs.false2637
                                        #   in Loop: Header=BB25_69 Depth=2
	ori	$a2, $zero, 1
	bne	$a1, $a2, .LBB25_164
# %bb.162:                              # %land.lhs.true2641
                                        #   in Loop: Header=BB25_69 Depth=2
	ld.w	$a1, $s6, 44
	addi.d	$a1, $a1, -1
	sltui	$a1, $a1, 1
...
.LBB25_163:                             # %if.then2647
	...
	srai.d	$ra, $a1, 1
	b	.LBB25_165
.LBB25_164:                             #   in Loop: Header=BB25_69 Depth=2
	move	$fp, $t7
	move	$s1, $t6
	ld.d	$a3, $sp, 488                   # 8-byte Folded Reload
.LBB25_165:                             # %if.end2654
                                        #   in Loop: Header=BB25_69 Depth=2
	ldptr.d	$a1, $s6, 5784
	slli.d	$a0, $a0, 3
	ldx.d	$a2, $a1, $a0
	...
	move	$t7, $fp
	b	.LBB25_207
.LBB25_166:                             #   in Loop: Header=BB25_69 Depth=2
	move	$ra, $s5
	ori	$s5, $zero, 11
	move	$t6, $s0
	move	$t7, $s3
...
# %bb.173:                              # %if.then2252
	...
	add.d	$a0, $a0, $a1
	b	.LBB25_177
.LBB25_174:                             #   in Loop: Header=BB25_69 Depth=2
	move	$s2, $s3
	move	$s3, $t7
	move	$s0, $t6
	ld.d	$s6, $sp, 416                   # 8-byte Folded Reload
...
# %bb.181:                              # %land.lhs.true2403
	...
	ld.w	$a1, $s6, 44
	beqz	$a1, .LBB25_183
# %bb.182:                              # %land.lhs.true2403
                                        #   in Loop: Header=BB25_69 Depth=2
	ori	$a2, $zero, 3
	bne	$a1, $a2, .LBB25_196
.LBB25_183:                             # %land.lhs.true2419
                                        #   in Loop: Header=BB25_69 Depth=2
	ld.d	$a3, $sp, 488                   # 8-byte Folded Reload
	move	$a2, $a3
	ld.d	$a0, $sp, 512                   # 8-byte Folded Reload
...
# %bb.188:                              # %land.lhs.true2513
	...
	ld.w	$a1, $s6, 44
	beqz	$a1, .LBB25_190
# %bb.189:                              # %land.lhs.true2513
                                        #   in Loop: Header=BB25_69 Depth=2
	ori	$a2, $zero, 3
	bne	$a1, $a2, .LBB25_201
.LBB25_190:                             # %land.lhs.true2529
                                        #   in Loop: Header=BB25_69 Depth=2
	ld.d	$a0, $sp, 512                   # 8-byte Folded Reload
	bnez	$a0, .LBB25_203
	b	.LBB25_204
.LBB25_191:                             # %if.else2608
                                        #   in Loop: Header=BB25_69 Depth=2
	move	$s3, $s2
	ld.d	$s4, $sp, 456                   # 8-byte Folded Reload
	beqz	$a0, .LBB25_194
# %bb.192:                              # %if.then2611
	...
	maskeqz	$a0, $a4, $a0
	bnez	$s1, .LBB25_156
# %bb.193:                              # %land.lhs.true2621
                                        #   in Loop: Header=BB25_69 Depth=2
	sltui	$a3, $a3, 1
	masknez	$ra, $ra, $a3
	b	.LBB25_156
.LBB25_194:                             # %for.cond2729.preheader
                                        #   in Loop: Header=BB25_69 Depth=2
	ld.w	$a0, $sp, 696
	ld.w	$a2, $sp, 632
	addi.w	$a1, $s4, 0
	...
	stx.h	$a0, $a1, $a4
	b	.LBB25_205
.LBB25_195:                             # %for.cond2475.preheader.preheader
                                        #   in Loop: Header=BB25_69 Depth=2
	st.d	$zero, $sp, 440                 # 8-byte Folded Spill
	ld.d	$s4, $sp, 456                   # 8-byte Folded Reload
	addi.w	$a0, $s4, 0
...
# %bb.197:                              # %land.lhs.true2415
	...
	move	$a2, $a3
	beqz	$a0, .LBB25_199
.LBB25_198:                             # %if.then2421
                                        #   in Loop: Header=BB25_69 Depth=2
	srai.d	$a2, $a3, 1
.LBB25_199:                             # %if.end2425
                                        #   in Loop: Header=BB25_69 Depth=2
	ldptr.d	$a0, $s6, 5768
	ldptr.d	$a1, $s6, 5776
	ld.d	$a0, $a0, 0
	...
	stx.h	$a0, $a5, $t1
	b	.LBB25_206
.LBB25_200:                             # %for.cond2585.preheader.preheader
                                        #   in Loop: Header=BB25_69 Depth=2
	addi.w	$a0, $s4, 0
	slli.d	$a0, $a0, 5
	ld.h	$a1, $sp, 632
	...
	st.d	$a0, $sp, 440                   # 8-byte Folded Spill
	b	.LBB25_205
.LBB25_201:                             # %lor.lhs.false2521
                                        #   in Loop: Header=BB25_69 Depth=2
	ld.w	$a0, $a0, 1124
	ori	$a1, $zero, 1
	bne	$a0, $a1, .LBB25_204
# %bb.202:                              # %land.lhs.true2525
                                        #   in Loop: Header=BB25_69 Depth=2
	ld.w	$a0, $s6, 44
	addi.d	$a0, $a0, -1
	sltui	$a0, $a0, 1
	...
	and	$a0, $a0, $a1
	beqz	$a0, .LBB25_204
.LBB25_203:                             # %if.then2531
                                        #   in Loop: Header=BB25_69 Depth=2
	ext.w.h	$a0, $ra
	srai.d	$ra, $a0, 1
.LBB25_204:                             # %if.end2535
                                        #   in Loop: Header=BB25_69 Depth=2
	ldptr.d	$a0, $s6, 5768
	ldptr.d	$a1, $s6, 5776
	ld.d	$a0, $a0, 8
...
.LBB25_225:                             # %if.end2912
	...
	ori	$a1, $zero, 2
	blt	$a0, $a1, .LBB25_309
.LBB25_226:                             # %for.cond2919.preheader.lr.ph
                                        #   in Loop: Header=BB25_222 Depth=1
	move	$a1, $zero
...
# %bb.259:                              # %if.then3265
                                        #   in Loop: Header=BB25_245 Depth=5
	bne	$a5, $a3, .LBB25_271
# %bb.260:                              # %if.end3348.if.then3447_crit_edge
                                        #   in Loop: Header=BB25_245 Depth=5
...
# %bb.318:                              # %cond.true444
	...
	sll.d	$a3, $a3, $a4
	b	.LBB25_334
.LBB25_319:                             # %for.body50.1.preheader
	move	$a6, $zero
	ori	$a7, $t6, 1504
	lu12i.w	$t1, 1
	.p2align	4, , 16
.LBB25_320:                             # %for.body50.1
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$t0, $a5, 0
	stx.w	$zero, $t0, $a7
	ld.w	$t0, $a4, 0
...
# %bb.363:                              # %cond.true976
	...
	or	$a6, $a6, $a7
	sra.d	$a4, $a4, $a6
.LBB25_364:                             # %cond.end1019
	beqz	$t0, .LBB25_366
# %bb.365:                              # %cond.true1024
	ld.d	$a6, $sp, 176                   # 8-byte Folded Reload
	ld.d	$a6, $a6, 0
	lu12i.w	$a7, 77
	ori	$a7, $a7, 1560
...
.LBB25_366:
	ori	$a6, $zero, 255
.LBB25_367:                             # %cond.end1067
	beqz	$t1, .LBB25_369
# %bb.368:                              # %cond.true1072
	ld.d	$a6, $sp, 176                   # 8-byte Folded Reload
	ld.d	$a6, $a6, 0
	lu12i.w	$a7, 77
	ori	$a7, $a7, 1560
