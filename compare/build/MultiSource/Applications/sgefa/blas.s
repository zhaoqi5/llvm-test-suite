...
.LBB8_15:                               # %vec.epilog.ph
	...
	sub.d	$a3, $a3, $a4
	.p2align	4, , 16
.LBB8_16:                               # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $a1, 0
	vfmul.s	$vr2, $vr2, $vr1
	vst	$vr2, $a1, 0
...
# %bb.23:                               # %middle.block83
	beq	$t0, $a0, .LBB9_12
# %bb.24:                               # %vec.epilog.iter.check87
	beqz	$a4, .LBB9_35
.LBB9_25:                               # %vec.epilog.ph89
	...
	sub.d	$t0, $t0, $a7
	.p2align	4, , 16
.LBB9_26:                               # %vec.epilog.vector.body92
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a2, 0
	vld	$vr1, $a3, 0
	vfadd.s	$vr0, $vr0, $vr1
	...
	addi.d	$a1, $a1, 16
	bnez	$t0, .LBB9_26
# %bb.27:                               # %vec.epilog.middle.block103
	bne	$a7, $a0, .LBB9_5
	b	.LBB9_12
.LBB9_28:                               # %vector.ph
	andi	$a4, $a0, 12
