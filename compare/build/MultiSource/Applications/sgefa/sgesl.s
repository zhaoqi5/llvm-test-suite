...
.LBB0_39:                               # %for.inc46
	...
	addi.d	$a1, $a1, 1
	beqz	$a7, .LBB0_56
.LBB0_40:                               # %iter.check190
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB0_49 Depth 2
                                        #     Child Loop BB0_53 Depth 2
                                        #     Child Loop BB0_45 Depth 2
	bltu	$a7, $a5, .LBB0_43
# %bb.41:                               # %vector.memcheck183
                                        #   in Loop: Header=BB0_40 Depth=1
	sub.d	$t2, $a3, $a1
	alsl.d	$t2, $t2, $t1, 2
	bgeu	$a2, $t2, .LBB0_46
# %bb.42:                               # %vector.memcheck183
                                        #   in Loop: Header=BB0_40 Depth=1
	bgeu	$t1, $t0, .LBB0_46
...
.LBB0_45:                               # %for.body37
	...
	b	.LBB0_39
	.p2align	4, , 16
.LBB0_46:                               # %vector.main.loop.iter.check192
                                        #   in Loop: Header=BB0_40 Depth=1
	bgeu	$a7, $a6, .LBB0_48
# %bb.47:                               #   in Loop: Header=BB0_40 Depth=1
	move	$t2, $zero
	b	.LBB0_52
.LBB0_48:                               # %vector.ph193
                                        #   in Loop: Header=BB0_40 Depth=1
	move	$t3, $a7
...
.LBB0_49:                               # %vector.body196
	...
	addi.d	$t5, $t5, 64
	bnez	$t3, .LBB0_49
# %bb.50:                               # %middle.block206
                                        #   in Loop: Header=BB0_40 Depth=1
	beq	$a7, $t2, .LBB0_39
# %bb.51:                               # %vec.epilog.iter.check211
                                        #   in Loop: Header=BB0_40 Depth=1
	andi	$t3, $a7, 12
	beqz	$t3, .LBB0_55
.LBB0_52:                               # %vec.epilog.ph210
                                        #   in Loop: Header=BB0_40 Depth=1
	move	$t5, $t2
	move	$t2, $a7
	...
	alsl.d	$t5, $t5, $a2, 2
	.p2align	4, , 16
.LBB0_53:                               # %vec.epilog.vector.body216
                                        #   Parent Loop BB0_40 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fld.s	$fa0, $t0, 0
	vld	$vr1, $t1, 0
	...
	addi.d	$t5, $t5, 16
	bnez	$t4, .LBB0_53
# %bb.54:                               # %vec.epilog.middle.block225
                                        #   in Loop: Header=BB0_40 Depth=1
	beq	$a7, $t2, .LBB0_39
	b	.LBB0_44
