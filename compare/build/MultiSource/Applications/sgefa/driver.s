...
# %bb.234:                              # %middle.block1018
                                        #   in Loop: Header=BB1_225 Depth=1
	beq	$t2, $a3, .LBB1_224
# %bb.235:                              # %vec.epilog.iter.check1023
                                        #   in Loop: Header=BB1_225 Depth=1
	move	$s0, $t2
	beqz	$t3, .LBB1_239
.LBB1_236:                              # %vec.epilog.ph1022
                                        #   in Loop: Header=BB1_225 Depth=1
	add.d	$ra, $t4, $t7
	vldrepl.w	$vr0, $s8, 0
	alsl.d	$fp, $s0, $a4, 2
	...
	add.d	$s0, $s5, $s0
	.p2align	4, , 16
.LBB1_237:                              # %vec.epilog.vector.body1029
                                        #   Parent Loop BB1_225 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr1, $t4, 0
	vld	$vr2, $fp, 0
	...
	addi.d	$t4, $t4, 16
	bnez	$s0, .LBB1_237
# %bb.238:                              # %vec.epilog.middle.block1040
                                        #   in Loop: Header=BB1_225 Depth=1
	move	$t4, $t8
	move	$fp, $t6
	beq	$t6, $a3, .LBB1_224
...
# %bb.30:                               # %middle.block124
                                        #   in Loop: Header=BB3_21 Depth=1
	beq	$t2, $a4, .LBB3_20
# %bb.31:                               # %vec.epilog.iter.check129
                                        #   in Loop: Header=BB3_21 Depth=1
	move	$s7, $t2
	beqz	$t5, .LBB3_35
.LBB3_32:                               # %vec.epilog.ph128
                                        #   in Loop: Header=BB3_21 Depth=1
	add.d	$s5, $s4, $t7
	vldrepl.w	$vr0, $s3, 0
	alsl.d	$s6, $s7, $a2, 2
	...
	add.d	$s7, $s0, $s7
	.p2align	4, , 16
.LBB3_33:                               # %vec.epilog.vector.body134
                                        #   Parent Loop BB3_21 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr1, $s4, 0
	vld	$vr2, $s6, 0
	...
	addi.d	$s4, $s4, 16
	bnez	$s7, .LBB3_33
# %bb.34:                               # %vec.epilog.middle.block145
                                        #   in Loop: Header=BB3_21 Depth=1
	move	$s4, $t8
	move	$s6, $t6
	beq	$t6, $a4, .LBB3_20
...
.LBB4_17:                               # %for.end34
	...
	jr	$t8
.LBB4_18:                               # %if.end.us.peel.preheader
	st.d	$a0, $sp, 24                    # 8-byte Folded Spill
	pcalau12i	$a0, %pc_hi20(.L.str.25)
	addi.d	$s1, $a0, %pc_lo12(.L.str.25)
	pcalau12i	$a0, %pc_hi20(.L.str.27)
	...
	b	.LBB4_20
	.p2align	4, , 16
.LBB4_19:                               # %for.cond3.for.cond16.preheader_crit_edge.us
