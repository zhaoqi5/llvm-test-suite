...
.LBB1_43:                               # %vector.ph861
	...
	b	.LBB1_45
	.p2align	4, , 16
.LBB1_44:                               # %pred.store.continue900
...
.LBB1_45:                               # %vector.body874
	...
	xvbitsel.v	$xr12, $xr3, $xr2, $xr16
	vpickve2gr.h	$t3, $vr11, 0
	andi	$t3, $t3, 1
	xvbitsel.v	$xr10, $xr12, $xr5, $xr10
	bnez	$t3, .LBB1_53
# %bb.46:                               # %pred.store.continue
	...
	andi	$t3, $t3, 1
	bnez	$t3, .LBB1_54
.LBB1_47:                               # %pred.store.continue888
                                        #   in Loop: Header=BB1_45 Depth=2
	vpickve2gr.h	$t3, $vr11, 2
	andi	$t3, $t3, 1
	bnez	$t3, .LBB1_55
.LBB1_48:                               # %pred.store.continue890
                                        #   in Loop: Header=BB1_45 Depth=2
	vpickve2gr.h	$t3, $vr11, 3
	andi	$t3, $t3, 1
	bnez	$t3, .LBB1_56
.LBB1_49:                               # %pred.store.continue892
                                        #   in Loop: Header=BB1_45 Depth=2
	vpickve2gr.h	$t3, $vr11, 4
	andi	$t3, $t3, 1
	bnez	$t3, .LBB1_57
.LBB1_50:                               # %pred.store.continue894
                                        #   in Loop: Header=BB1_45 Depth=2
	vpickve2gr.h	$t3, $vr11, 5
	andi	$t3, $t3, 1
	bnez	$t3, .LBB1_58
.LBB1_51:                               # %pred.store.continue896
                                        #   in Loop: Header=BB1_45 Depth=2
	vpickve2gr.h	$t3, $vr11, 6
	andi	$t3, $t3, 1
	bnez	$t3, .LBB1_59
.LBB1_52:                               # %pred.store.continue898
                                        #   in Loop: Header=BB1_45 Depth=2
	vpickve2gr.h	$t3, $vr11, 7
	andi	$t3, $t3, 1
	beqz	$t3, .LBB1_44
...
.LBB1_53:                               # %pred.store.if
                                        #   in Loop: Header=BB1_45 Depth=2
	xvstelm.w	$xr10, $t1, -16, 0
	vpickve2gr.h	$t3, $vr11, 1
	andi	$t3, $t3, 1
	beqz	$t3, .LBB1_47
.LBB1_54:                               # %pred.store.if887
                                        #   in Loop: Header=BB1_45 Depth=2
	xvstelm.w	$xr10, $t1, -12, 1
	vpickve2gr.h	$t3, $vr11, 2
	andi	$t3, $t3, 1
	beqz	$t3, .LBB1_48
.LBB1_55:                               # %pred.store.if889
                                        #   in Loop: Header=BB1_45 Depth=2
	xvstelm.w	$xr10, $t1, -8, 2
	vpickve2gr.h	$t3, $vr11, 3
	andi	$t3, $t3, 1
	beqz	$t3, .LBB1_49
.LBB1_56:                               # %pred.store.if891
                                        #   in Loop: Header=BB1_45 Depth=2
	xvstelm.w	$xr10, $t1, -4, 3
	vpickve2gr.h	$t3, $vr11, 4
	andi	$t3, $t3, 1
	beqz	$t3, .LBB1_50
.LBB1_57:                               # %pred.store.if893
                                        #   in Loop: Header=BB1_45 Depth=2
	xvstelm.w	$xr10, $t1, 0, 4
	vpickve2gr.h	$t3, $vr11, 5
	andi	$t3, $t3, 1
	beqz	$t3, .LBB1_51
.LBB1_58:                               # %pred.store.if895
                                        #   in Loop: Header=BB1_45 Depth=2
	xvstelm.w	$xr10, $t1, 4, 5
	vpickve2gr.h	$t3, $vr11, 6
	andi	$t3, $t3, 1
	beqz	$t3, .LBB1_52
.LBB1_59:                               # %pred.store.if897
                                        #   in Loop: Header=BB1_45 Depth=2
	xvstelm.w	$xr10, $t1, 8, 6
	vpickve2gr.h	$t3, $vr11, 7
	andi	$t3, $t3, 1
	beqz	$t3, .LBB1_44
.LBB1_60:                               # %pred.store.if899
                                        #   in Loop: Header=BB1_45 Depth=2
	xvstelm.w	$xr10, $t1, 12, 7
	b	.LBB1_44
	.p2align	4, , 16
.LBB1_61:                               # %middle.block903
                                        #   in Loop: Header=BB1_41 Depth=1
	move	$t4, $a4
	beq	$a4, $a3, .LBB1_40
...
.LBB1_229:                              # %for.body36.us.i
	...
	bnez	$fp, .LBB1_229
	b	.LBB1_224
.LBB1_230:                              # %vector.main.loop.iter.check1003
                                        #   in Loop: Header=BB1_225 Depth=1
	bgeu	$a3, $s7, .LBB1_232
# %bb.231:                              #   in Loop: Header=BB1_225 Depth=1
	move	$s0, $zero
	b	.LBB1_236
.LBB1_232:                              # %vector.ph1004
                                        #   in Loop: Header=BB1_225 Depth=1
	xvldrepl.w	$xr0, $s8, 0
	addi.d	$fp, $t5, 32
	move	$s0, $t3
...
.LBB1_233:                              # %vector.body1007
	...
	addi.d	$fp, $fp, 64
	bnez	$s0, .LBB1_233
# %bb.234:                              # %middle.block1018
                                        #   in Loop: Header=BB1_225 Depth=1
	beq	$t3, $a3, .LBB1_224
# %bb.235:                              # %vec.epilog.iter.check1022
                                        #   in Loop: Header=BB1_225 Depth=1
	move	$s0, $t3
	beqz	$t2, .LBB1_239
.LBB1_236:                              # %vec.epilog.ph1024
                                        #   in Loop: Header=BB1_225 Depth=1
	vldrepl.w	$vr0, $s8, 0
	add.d	$ra, $t5, $t7
	alsl.d	$fp, $s0, $a4, 2
	...
	add.d	$s0, $s5, $s0
	.p2align	4, , 16
.LBB1_237:                              # %vec.epilog.vector.body1028
                                        #   Parent Loop BB1_225 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr1, $t5, 0
	vld	$vr2, $fp, 0
	...
	addi.d	$t5, $t5, 16
	bnez	$s0, .LBB1_237
# %bb.238:                              # %vec.epilog.middle.block1039
                                        #   in Loop: Header=BB1_225 Depth=1
	move	$t5, $t8
	move	$fp, $t6
	beq	$t6, $a3, .LBB1_224
...
.LBB3_25:                               # %for.body36.us
	...
	b	.LBB3_20
	.p2align	4, , 16
.LBB3_26:                               # %vector.main.loop.iter.check109
                                        #   in Loop: Header=BB3_21 Depth=1
	bgeu	$a6, $s2, .LBB3_28
# %bb.27:                               #   in Loop: Header=BB3_21 Depth=1
	move	$s7, $zero
	b	.LBB3_32
.LBB3_28:                               # %vector.ph110
                                        #   in Loop: Header=BB3_21 Depth=1
	xvldrepl.w	$xr0, $s3, 0
	addi.d	$s5, $s4, 32
	move	$s6, $t3
