...
.LBB0_79:                               # %if.then256
	...
	move	$a5, $a0
	b	.LBB0_69
.LBB0_80:                               # %while.end284.loopexit.split.loop.exit
	addi.d	$a0, $zero, -1
	add.w	$s8, $a0, $a2
	blt	$s8, $a1, .LBB0_85
.LBB0_81:                               # %if.then292
...
.LBB0_99:                               # %if.end345
	...
	move	$s8, $fp
	bge	$s2, $s4, .LBB0_107
.LBB0_100:                              # %while.body327
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $s3, 0
	ld.bu	$a1, $a0, 0
	bne	$a1, $s6, .LBB0_102
# %bb.101:                              # %while.body327.tail
                                        #   in Loop: Header=BB0_100 Depth=1
	ld.bu	$a1, $a0, 1
	beqz	$a1, .LBB0_98
.LBB0_102:                              # %if.else335
...
# %bb.110:                              # %if.then354
	...
	ldptr.d	$s0, $s5, 8200
	beqz	$s0, .LBB0_113
# %bb.111:                              # %while.body358.preheader
	move	$fp, $zero
	ori	$s1, $zero, 1
	.p2align	4, , 16
.LBB0_112:                              # %while.body358
                                        # =>This Inner Loop Header: Depth=1
	move	$a0, $s0
