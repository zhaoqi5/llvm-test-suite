...
.LBB0_113:                              # %while.body.i160
	...
	ld.w	$a0, $s1, 0
	beq	$a0, $fp, .LBB0_112
# %bb.114:                              # %while.body.i160
                                        #   in Loop: Header=BB0_113 Depth=2
	ori	$a1, $zero, 11
	ori	$s0, $zero, 3
	bne	$a0, $a1, .LBB0_116
# %bb.115:                              # %if.then26.i163
                                        #   in Loop: Header=BB0_113 Depth=2
	move	$a0, $s1
	pcaddu18i	$ra, %call36(TreeCCNextToken)
	jirl	$ra, $ra, 0
...
# %bb.198:                              # %if.then66.i
	...
	ori	$a1, $zero, 9
	.p2align	4, , 16
.LBB0_199:                              # %while.cond.i124
                                        #   Parent Loop BB0_6 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$s4, $s1, 0
	ori	$a0, $s4, 8
	bne	$a0, $a1, .LBB0_233
# %bb.200:                              # %while.body.i125
