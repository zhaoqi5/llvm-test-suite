...
# %bb.8:                                # %if.then7.i
	...
	addi.w	$a1, $a0, 0
	blez	$a1, .LBB17_14
# %bb.9:                                # %land.lhs.true.preheader.i
                                        #   in Loop: Header=BB17_5 Depth=1
	bstrpick.d	$a2, $a0, 30, 0
	addi.d	$a1, $s2, -1
	.p2align	4, , 16
.LBB17_10:                              # %land.lhs.true.i
...
.LBB17_27:                              # %WriteBuffer.exit
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB17_30
# %bb.28:                               # %while.body.lr.ph.i33
                                        #   in Loop: Header=BB17_5 Depth=1
	ld.d	$a1, $fp, 24
	addi.d	$s2, $a1, 1
	.p2align	4, , 16
.LBB17_29:                              # %while.body.i34
                                        #   Parent Loop BB17_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.d	$a0, $a0, 1
	st.d	$s2, $fp, 24
...
.LBB17_46:                              # %if.end23
	...
	addi.d	$sp, $sp, 112
	ret
.LBB17_47:                              # %if.then.i.i42
	ld.d	$a1, $fp, 24
	ld.d	$s0, $fp, 16
	andi	$a0, $a0, 256
	addi.d	$s1, $a1, 1
	beqz	$a0, .LBB17_55
# %bb.48:                               # %if.then7.i.i44
	move	$a0, $s0
	pcaddu18i	$ra, %call36(strlen)
	jirl	$ra, $ra, 0
	addi.w	$a1, $a0, 0
	blez	$a1, .LBB17_54
# %bb.49:                               # %land.lhs.true.preheader.i.i
...
# %bb.51:                               # %land.lhs.true.i.i
	...
	beq	$a5, $a3, .LBB17_54
# %bb.52:                               # %while.body.i.i50
                                        #   in Loop: Header=BB17_50 Depth=1
	addi.d	$a5, $a0, -1
	blt	$a4, $a0, .LBB17_50
# %bb.53:
	move	$a0, $zero
.LBB17_54:                              # %while.end.i.i
	addi.w	$a0, $a0, 0
	add.d	$s0, $s0, $a0
.LBB17_55:                              # %if.end.i.i49
	pcalau12i	$a0, %pc_hi20(.L.str.8)
	addi.d	$a1, $a0, %pc_lo12(.L.str.8)
	move	$a0, $fp
	move	$a2, $s1
