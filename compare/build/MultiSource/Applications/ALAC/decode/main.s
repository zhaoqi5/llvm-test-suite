...
# %bb.3:                                # %for.body.tail.peel
	ld.bu	$a3, $s2, 2
	beqz	$a3, .LBB0_37
# %bb.4:                                # %sub_071.peel.thread
	ld.bu	$a3, $s2, 1
.LBB0_5:                                # %if.else.tail70.peel
...
# %bb.2:                                # %if.else
	...
	fld.d	$fa0, $s4, 0
	ld.w	$a0, $s4, 24
	pcalau12i	$a1, %pc_hi20(.L__const._Z17WriteWAVEfmtChunkP8_IO_FILE22AudioFormatDescription.theBuffer)
	addi.d	$a1, $a1, %pc_lo12(.L__const._Z17WriteWAVEfmtChunkP8_IO_FILE22AudioFormatDescription.theBuffer)
	vld	$vr1, $a1, 0
	ld.d	$a1, $a1, 16
	ld.b	$a2, $s4, 28
	ld.b	$a3, $s4, 32
...
# %bb.0:                                # %entry
	pcalau12i	$a1, %pc_hi20(.L__const._Z18WriteWAVERIFFChunkP8_IO_FILE.theReadBuffer)
	addi.d	$a3, $a1, %pc_lo12(.L__const._Z18WriteWAVERIFFChunkP8_IO_FILE.theReadBuffer)
	ori	$a1, $zero, 1
	ori	$a2, $zero, 12
	move	$a4, $a0
	move	$a0, $a3
...
# %bb.0:                                # %entry
	...
	pcalau12i	$a2, %pc_hi20(.L__const._Z17WriteWAVEfmtChunkP8_IO_FILE22AudioFormatDescription.theBuffer)
	addi.d	$a2, $a2, %pc_lo12(.L__const._Z17WriteWAVEfmtChunkP8_IO_FILE22AudioFormatDescription.theBuffer)
	vld	$vr0, $a2, 0
	ld.d	$a2, $a2, 16
	move	$a3, $a0
	vst	$vr0, $sp, 0
...
# %bb.0:                                # %entry
	pcalau12i	$a1, %pc_hi20(.L__const._Z18WriteWAVEdataChunkP8_IO_FILE.theBuffer)
	addi.d	$a3, $a1, %pc_lo12(.L__const._Z18WriteWAVEdataChunkP8_IO_FILE.theBuffer)
	ori	$a1, $zero, 1
	ori	$a2, $zero, 8
	move	$a4, $a0
	move	$a0, $a3
