...
# %bb.0:                                # %entry
	...
	move	$fp, $a0
	pcalau12i	$a0, %pc_hi20(_ZTV11ALACEncoder+16)
	addi.d	$a1, $a0, %pc_lo12(_ZTV11ALACEncoder+16)
	ld.d	$a0, $fp, 32
	st.d	$a1, $fp, 0
	beqz	$a0, .LBB1_2
# %bb.1:                                # %if.then
...
.LBB7_5:                                # %if.else15
	...
	addi.d	$s8, $a0, %pc_lo12(_ZL12sChannelMaps)
	move	$s4, $zero
	move	$s0, $zero
	move	$s7, $zero
	move	$s6, $zero
