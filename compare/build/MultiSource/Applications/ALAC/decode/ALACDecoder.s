...
.LBB3_101:                              # %sw.epilog515
	...
	move	$s8, $s7
	bltu	$s7, $s0, .LBB3_7
.LBB3_102:                              # %NoMoreChannels
	ld.d	$t5, $sp, 128                   # 8-byte Folded Reload
	bgeu	$s8, $t5, .LBB3_109
.LBB3_103:                              # %for.body529.lr.ph
	ori	$a1, $zero, 1
	alsl.w	$a2, $s5, $s5, 1
	bne	$t5, $a1, .LBB3_110
# %bb.104:                              # %for.body529.us.preheader
	ld.bu	$a4, $s1, 5
	bstrpick.d	$a3, $s5, 31, 0
	ori	$a5, $zero, 16
	bstrpick.d	$a1, $s8, 31, 0
	...
	beq	$a4, $a5, .LBB3_137
# %bb.105:                              # %for.body529.us.preheader
	ori	$a5, $zero, 24
	beq	$a4, $a5, .LBB3_136
# %bb.106:                              # %for.body529.us.preheader
	ori	$a2, $zero, 32
	bne	$a4, $a2, .LBB3_109
# %bb.107:                              # %if.then.i320.us
	slli.d	$a2, $a3, 2
	alsl.d	$a1, $a1, $a6, 2
	b	.LBB3_138
.LBB3_108:
...
.LBB3_109:                              # %cleanup
	...
	addi.d	$sp, $sp, 432
	ret
.LBB3_110:                              # %for.body529.lr.ph.split
	mul.w	$a1, $s5, $t5
	mul.w	$a4, $a2, $t5
	bstrpick.d	$a2, $s8, 31, 0
...
# %bb.115:                              # %for.body529
                                        #   in Loop: Header=BB3_113 Depth=1
	bne	$t1, $t0, .LBB3_112
# %bb.116:                              # %for.cond.preheader.i
                                        #   in Loop: Header=BB3_113 Depth=1
	beqz	$a1, .LBB3_112
# %bb.117:                              # %for.body.i.preheader
                                        #   in Loop: Header=BB3_113 Depth=1
	move	$t1, $zero
	alsl.d	$t2, $a2, $t4, 1
	.p2align	4, , 16
...
.LBB3_120:                              # %for.body.i305
	...
	b	.LBB3_112
	.p2align	4, , 16
.LBB3_121:                              # %for.cond.preheader.i311
                                        #   in Loop: Header=BB3_113 Depth=1
	beqz	$a1, .LBB3_112
# %bb.122:                              # %for.body.i314.preheader
                                        #   in Loop: Header=BB3_113 Depth=1
	move	$t1, $zero
	alsl.d	$t2, $a2, $t4, 2
	.p2align	4, , 16
.LBB3_123:                              # %for.body.i314
                                        #   Parent Loop BB3_113 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	bstrpick.d	$t3, $t1, 31, 0
	slli.d	$t3, $t3, 2
...
.LBB3_125:
	...
	bltu	$s8, $t5, .LBB3_103
	b	.LBB3_109
.LBB3_126:                              # %for.body529.us372.preheader
	ld.bu	$a4, $s1, 5
	ori	$a5, $zero, 16
	ori	$a6, $zero, 32
	b	.LBB3_128
	.p2align	4, , 16
.LBB3_127:                              # %for.inc544.us400
                                        #   in Loop: Header=BB3_128 Depth=1
	addi.d	$a2, $a2, 1
	beq	$a2, $a3, .LBB3_109
.LBB3_128:                              # %for.body529.us372
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB3_132 Depth 2
                                        #     Child Loop BB3_135 Depth 2
	beq	$a4, $a5, .LBB3_133
# %bb.129:                              # %for.body529.us372
                                        #   in Loop: Header=BB3_128 Depth=1
	bne	$a4, $a6, .LBB3_127
# %bb.130:                              # %sw.bb540.us374
                                        #   in Loop: Header=BB3_128 Depth=1
	beqz	$a1, .LBB3_127
# %bb.131:                              # %for.body.i314.us378.preheader
                                        #   in Loop: Header=BB3_128 Depth=1
	move	$a7, $zero
	alsl.d	$t0, $a2, $t4, 2
	.p2align	4, , 16
.LBB3_132:                              # %for.body.i314.us378
	...
	bltu	$a7, $a1, .LBB3_132
	b	.LBB3_127
.LBB3_133:                              # %sw.bb533.us389
                                        #   in Loop: Header=BB3_128 Depth=1
	beqz	$a1, .LBB3_127
# %bb.134:                              # %for.body.i.us393.preheader
                                        #   in Loop: Header=BB3_128 Depth=1
	move	$a7, $zero
	alsl.d	$t0, $a2, $t4, 1
	.p2align	4, , 16
.LBB3_135:                              # %for.body.i.us393
                                        #   Parent Loop BB3_128 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	bstrpick.d	$t1, $a7, 31, 0
	slli.d	$t1, $t1, 1
	...
	bltu	$a7, $a1, .LBB3_135
	b	.LBB3_127
.LBB3_136:                              # %sw.bb536.us
	bstrpick.d	$a2, $a2, 31, 0
	alsl.wu	$a1, $a1, $a1, 1
	add.d	$a1, $a6, $a1
	b	.LBB3_138
.LBB3_137:                              # %if.then.i299.us
	slli.d	$a2, $a3, 1
	alsl.d	$a1, $a1, $a6, 1
.LBB3_138:                              # %cleanup
	move	$fp, $a0
