...
.LBB3_102:                              # %sw.epilog515
	...
	move	$s6, $s7
	bltu	$s7, $s8, .LBB3_7
.LBB3_103:                              # %NoMoreChannels
	bgeu	$s6, $s8, .LBB3_110
.LBB3_104:                              # %for.body529.lr.ph
	ori	$a1, $zero, 1
	alsl.w	$a2, $s2, $s2, 1
	bne	$s8, $a1, .LBB3_111
...
.LBB3_110:                              # %cleanup
	...
	addi.d	$sp, $sp, 432
	ret
.LBB3_111:                              # %for.body529.lr.ph.split
	mul.w	$a1, $s2, $s8
	mul.w	$a4, $a2, $s8
...
# %bb.116:                              # %for.body529
                                        #   in Loop: Header=BB3_114 Depth=1
	bne	$t1, $t0, .LBB3_113
# %bb.117:                              # %for.cond.preheader.i
                                        #   in Loop: Header=BB3_114 Depth=1
	beqz	$a1, .LBB3_113
# %bb.118:                              # %for.body.i.preheader
                                        #   in Loop: Header=BB3_114 Depth=1
	move	$t1, $zero
	alsl.d	$t2, $a2, $t4, 1
	.p2align	4, , 16
...
.LBB3_121:                              # %for.body.i305
	...
	b	.LBB3_113
	.p2align	4, , 16
.LBB3_122:                              # %for.cond.preheader.i311
                                        #   in Loop: Header=BB3_114 Depth=1
	beqz	$a1, .LBB3_113
# %bb.123:                              # %for.body.i314.preheader
                                        #   in Loop: Header=BB3_114 Depth=1
	move	$t1, $zero
	alsl.d	$t2, $a2, $t4, 2
	.p2align	4, , 16
.LBB3_124:                              # %for.body.i314
                                        #   Parent Loop BB3_114 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	bstrpick.d	$t3, $t1, 31, 0
	slli.d	$t3, $t3, 2
...
.LBB3_126:
	...
	bltu	$s6, $s8, .LBB3_104
	b	.LBB3_110
.LBB3_127:                              # %for.body529.us372.preheader
	ld.bu	$a4, $s1, 5
	ori	$a5, $zero, 16
	ori	$a6, $zero, 32
	...
	b	.LBB3_129
	.p2align	4, , 16
.LBB3_128:                              # %for.inc544.us400
                                        #   in Loop: Header=BB3_129 Depth=1
	addi.d	$a2, $a2, 1
	beq	$a2, $a3, .LBB3_110
.LBB3_129:                              # %for.body529.us372
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB3_133 Depth 2
                                        #     Child Loop BB3_136 Depth 2
	beq	$a4, $a5, .LBB3_134
# %bb.130:                              # %for.body529.us372
                                        #   in Loop: Header=BB3_129 Depth=1
	bne	$a4, $a6, .LBB3_128
# %bb.131:                              # %sw.bb540.us374
                                        #   in Loop: Header=BB3_129 Depth=1
	beqz	$a1, .LBB3_128
# %bb.132:                              # %for.body.i314.us378.preheader
                                        #   in Loop: Header=BB3_129 Depth=1
	move	$a7, $zero
	alsl.d	$t0, $a2, $t2, 2
	.p2align	4, , 16
.LBB3_133:                              # %for.body.i314.us378
	...
	bltu	$a7, $a1, .LBB3_133
	b	.LBB3_128
.LBB3_134:                              # %sw.bb533.us389
                                        #   in Loop: Header=BB3_129 Depth=1
	beqz	$a1, .LBB3_128
# %bb.135:                              # %for.body.i.us393.preheader
                                        #   in Loop: Header=BB3_129 Depth=1
	move	$a7, $zero
	alsl.d	$t0, $a2, $t2, 1
	.p2align	4, , 16
.LBB3_136:                              # %for.body.i.us393
                                        #   Parent Loop BB3_129 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	bstrpick.d	$t1, $a7, 31, 0
	slli.d	$t1, $t1, 1
	...
	bltu	$a7, $a1, .LBB3_136
	b	.LBB3_128
.LBB3_137:                              # %sw.bb536.us
	bstrpick.d	$a2, $a2, 31, 0
	alsl.wu	$a1, $a1, $a1, 1
	add.d	$a1, $a6, $a1
	b	.LBB3_139
.LBB3_138:                              # %if.then.i299.us
	slli.d	$a2, $a3, 1
	ld.d	$a3, $sp, 88                    # 8-byte Folded Reload
	alsl.d	$a1, $a1, $a3, 1
.LBB3_139:                              # %cleanup
