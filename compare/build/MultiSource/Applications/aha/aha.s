...
# %bb.0:                                # %entry
	...
	addi.d	$s1, $a1, %pc_lo12(counter)
	alsl.d	$s6, $a0, $s1, 2
	pcalau12i	$a1, %pc_hi20(pgm)
	addi.d	$s5, $a1, %pc_lo12(pgm)
	alsl.d	$a0, $a0, $s5, 4
	addi.d	$s7, $a0, 8
	ori	$s8, $zero, 56
	pcalau12i	$a0, %pc_hi20(isa)
...
# %bb.6:                                # %for.body.preheader
	move	$s6, $zero
	pcalau12i	$s7, %pc_hi20(check.itrialx)
...
.LBB25_7:                               # %for.body
	...
	ld.w	$a0, $s7, %pc_lo12(check.itrialx)
	addi.w	$a2, $a0, 1
	ori	$a3, $zero, 15
	slt	$a0, $a3, $a0
	masknez	$a0, $a2, $a0
	...
	ldx.w	$a2, $a5, $a2
	st.w	$a0, $s7, %pc_lo12(check.itrialx)
	st.w	$a3, $s0, 44
...
.LBB25_15:                              # %if.end22.us
	...
	masknez	$a2, $a3, $a2
	slli.d	$a4, $a2, 2
	pcalau12i	$a3, %pc_hi20(trialx)
	addi.d	$a3, $a3, %pc_lo12(trialx)
	ldx.w	$a5, $a3, $a4
	addi.d	$a0, $a0, 44
	st.w	$a5, $s0, 44
...
.LBB25_32:                              # %cleanup.loopexit.split.us
	...
	st.w	$a4, $t0, %pc_lo12(corr_result)
.LBB25_33:                              # %cleanup
...
# %bb.0:                                # %entry
	...
	pcalau12i	$a0, %pc_hi20(pgm)
	addi.d	$s4, $a0, %pc_lo12(pgm)
	pcalau12i	$a0, %pc_hi20(isa)
	addi.d	$s6, $a0, %pc_lo12(isa)
	addi.w	$s7, $zero, -1
	ori	$s8, $zero, 5
	ori	$s5, $zero, 6
...
# %bb.0:                                # %entry
	...
	ori	$fp, $zero, 1
	st.w	$fp, $s4, %pc_lo12(numi)
	pcalau12i	$a0, %pc_hi20(.L.str.40)
	addi.d	$a0, $a0, %pc_lo12(.L.str.40)
	st.d	$a0, $sp, 32                    # 8-byte Folded Spill
	pcalau12i	$a0, %pc_hi20(trialx)
	addi.d	$s6, $a0, %pc_lo12(trialx)
	pcalau12i	$a0, %pc_hi20(correct_result)
	addi.d	$s7, $a0, %pc_lo12(correct_result)
	pcalau12i	$a0, %pc_hi20(isa)
	addi.d	$s8, $a0, %pc_lo12(isa)
	pcalau12i	$a0, %pc_hi20(pgm)
	addi.d	$a0, $a0, %pc_lo12(pgm)
	st.d	$a0, $sp, 16                    # 8-byte Folded Spill
	addi.d	$a0, $a0, 8
