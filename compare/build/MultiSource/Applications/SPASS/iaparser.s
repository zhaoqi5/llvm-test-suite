...
# %bb.6:                                #   in Loop: Header=BB0_3 Depth=1
	...
	ori	$a1, $a1, 1976
	add.d	$a1, $fp, $a1
	st.d	$s1, $a1, 0                     # 8-byte Folded Spill
	move	$s6, $s2
	move	$s2, $a0
.LBB0_7:                                # %yybackup
                                        #   in Loop: Header=BB0_3 Depth=1
...
.LBB0_35:                               # %sw.bb151
	...
	ori	$a0, $a0, 1904
	add.d	$a0, $fp, $a0
	st.d	$s4, $a0, 0                     # 8-byte Folded Spill
	move	$s4, $s7
	move	$s7, $s6
	ld.w	$s6, $s2, -40
	ld.d	$s1, $s2, -24
...
.LBB0_69:                               # %sw.bb246
	...
	st.d	$zero, $a0, 0
	beqz	$s1, .LBB0_83
# %bb.70:                               # %for.cond.i259.preheader
                                        #   in Loop: Header=BB0_3 Depth=1
	move	$a0, $s1
	move	$a3, $s1
	.p2align	4, , 16
.LBB0_71:                               # %for.cond.i259
                                        #   Parent Loop BB0_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$a2, $a3
	ld.d	$a3, $a3, 0
...
.LBB0_79:                               # %sw.bb202
	...
	st.d	$zero, $a0, 0
	beqz	$s1, .LBB0_83
# %bb.80:                               # %for.cond.i230.preheader
                                        #   in Loop: Header=BB0_3 Depth=1
	move	$a0, $s1
	move	$a3, $s1
	.p2align	4, , 16
.LBB0_81:                               # %for.cond.i230
                                        #   Parent Loop BB0_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$a2, $a3
	ld.d	$a3, $a3, 0
	bnez	$a3, .LBB0_81
.LBB0_82:                               # %for.end.i263
                                        #   in Loop: Header=BB0_3 Depth=1
	st.d	$a1, $a2, 0
	b	.LBB0_84
...
.LBB0_88:                               # %for.end.i219
	...
	move	$s5, $a0
	beqz	$a0, .LBB0_91
# %bb.89:                               # %for.body21.i.preheader
                                        #   in Loop: Header=BB0_3 Depth=1
	move	$s2, $s5
	.p2align	4, , 16
.LBB0_90:                               # %for.body21.i
                                        #   Parent Loop BB0_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$a0, $s2, 8
	move	$a1, $zero
...
.LBB0_91:                               # %for.end27.i
	...
	ori	$a0, $a0, 1904
	add.d	$a0, $fp, $a0
	ld.d	$s4, $a0, 0                     # 8-byte Folded Reload
	lu12i.w	$a0, -1
	ori	$a0, $a0, 1912
	add.d	$a0, $fp, $a0
...
# %bb.93:                               # %if.then34.i
	...
	ld.w	$a1, $a1, 0
	bne	$a0, $a1, .LBB0_110
# %bb.94:                               # %for.body44.i.preheader
                                        #   in Loop: Header=BB0_3 Depth=1
	move	$s3, $s6
	move	$s2, $a3
	.p2align	4, , 16
.LBB0_95:                               # %for.body44.i
                                        #   Parent Loop BB0_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	pcalau12i	$a0, %got_pc_hi20(fol_NOT)
	ld.d	$a0, $a0, %got_pc_lo12(fol_NOT)
...
# %bb.96:                               # %for.end51.i
	...
	beqz	$a0, .LBB0_100
# %bb.97:                               # %for.cond.i90.i.preheader
                                        #   in Loop: Header=BB0_3 Depth=1
	move	$a2, $a3
	.p2align	4, , 16
.LBB0_98:                               # %for.cond.i90.i
                                        #   Parent Loop BB0_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$a1, $a2
	ld.d	$a2, $a2, 0
...
# %bb.104:                              # %if.then80.i
	...
	ld.d	$s2, $a1, 0                     # 8-byte Folded Reload
	beqz	$a0, .LBB0_108
# %bb.105:                              # %for.cond.i111.i.preheader
                                        #   in Loop: Header=BB0_3 Depth=1
	move	$a2, $a3
	.p2align	4, , 16
.LBB0_106:                              # %for.cond.i111.i
                                        #   Parent Loop BB0_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$a1, $a2
	ld.d	$a2, $a2, 0
	bnez	$a2, .LBB0_106
# %bb.107:                              # %for.end.i115.i
                                        #   in Loop: Header=BB0_3 Depth=1
	st.d	$a0, $a1, 0
	lu12i.w	$a0, -1
	ori	$a0, $a0, 1880
...
.LBB0_112:                              # %if.else83.i
	...
	move	$a2, $a1
	.p2align	4, , 16
.LBB0_113:                              # %for.cond.i124.i
                                        #   Parent Loop BB0_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$a3, $a2
	ld.d	$a2, $a2, 0
	bnez	$a2, .LBB0_113
# %bb.114:                              # %for.end.i128.i
                                        #   in Loop: Header=BB0_3 Depth=1
	st.d	$a0, $a3, 0
	ld.w	$a0, $s2, 0
	pcaddu18i	$ra, %call36(term_Create)
...
# %bb.132:                              # %if.then325
	...
	addi.w	$s4, $s4, 1
	b	.LBB0_129
.LBB0_133:                              # %yyoverflowlab
	pcalau12i	$a0, %pc_hi20(.L.str.9)
	addi.d	$a0, $a0, %pc_lo12(.L.str.9)
	pcaddu18i	$ra, %call36(ia_error)
	jirl	$ra, $ra, 0
.LBB0_134:                              # %yyerrlab1.thread
	pcalau12i	$a0, %pc_hi20(.L.str.8)
	addi.d	$a0, $a0, %pc_lo12(.L.str.8)
	b	.LBB0_147
.LBB0_135:                              # %for.end.loopexit
	lu12i.w	$a0, -1
	ori	$a0, $a0, 1992
	add.d	$a0, $fp, $a0
	ld.d	$a0, $a0, 0                     # 8-byte Folded Reload
...
.LBB0_136:                              # %while.cond.i266
	...
	addi.d	$a1, $a1, 1
	bnez	$a2, .LBB0_136
# %bb.137:                              # %yystpcpy.exit272
	ori	$a2, $zero, 4
	blt	$a2, $s4, .LBB0_147
# %bb.138:                              # %for.body359.preheader
	add.d	$a1, $a0, $a1
	addi.d	$a5, $a1, 23
	ori	$a1, $zero, 1
...
.LBB0_143:                              # %while.cond.i273
	...
	st.b	$t2, $a5, 1
	bnez	$t2, .LBB0_143
# %bb.144:                              # %yystpcpy.exit279
                                        #   in Loop: Header=BB0_140 Depth=1
	slli.d	$t0, $a7, 3
	ldx.d	$t0, $s2, $t0
	.p2align	4, , 16
.LBB0_145:                              # %while.cond.i280
                                        #   Parent Loop BB0_140 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.bu	$t1, $t0, 0
	addi.d	$t0, $t0, 1
