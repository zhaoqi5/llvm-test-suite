...
.LBB0_7:                                # %yybackup
	...
	ori	$a1, $a1, 1992
	add.d	$a1, $fp, $a1
	st.d	$a4, $a1, 0                     # 8-byte Folded Spill
	beq	$s0, $a0, .LBB0_21
# %bb.8:                                # %if.end55
                                        #   in Loop: Header=BB0_3 Depth=1
...
.LBB0_26:                               # %sw.bb166
	...
	ori	$a1, $a1, 1912
	add.d	$a1, $fp, $a1
	st.d	$s2, $a1, 0                     # 8-byte Folded Spill
	pcalau12i	$s2, %pc_hi20(ia_VARLIST)
	move	$s6, $s5
	move	$s5, $s8
	move	$s8, $s3
	ld.d	$s3, $s2, %pc_lo12(ia_VARLIST)
	move	$s0, $a0
	ori	$a0, $zero, 16
	pcaddu18i	$ra, %call36(memory_Malloc)
	jirl	$ra, $ra, 0
...
.LBB0_35:                               # %sw.bb151
	...
	ori	$a0, $a0, 1912
	add.d	$a0, $fp, $a0
	st.d	$s2, $a0, 0                     # 8-byte Folded Spill
	ld.w	$s2, $a4, -40
	ld.d	$s0, $a4, -24
	ld.d	$s5, $a4, -8
	ori	$a0, $zero, 16
	...
	ori	$a2, $a2, 1912
	add.d	$a2, $fp, $a2
	ld.d	$s2, $a2, 0                     # 8-byte Folded Reload
	ori	$s6, $zero, 83
	b	.LBB0_70
.LBB0_36:                               # %sw.bb180
                                        #   in Loop: Header=BB0_3 Depth=1
...
.LBB0_38:                               # %sw.epilog
	...
	ori	$a2, $a2, 1904
	add.d	$a2, $fp, $a2
	ld.d	$s8, $a2, 0                     # 8-byte Folded Reload
	b	.LBB0_70
.LBB0_39:                               # %sw.bb158
                                        #   in Loop: Header=BB0_3 Depth=1
	ld.w	$a0, $a4, -24
...
.LBB0_41:                               # %sw.bb168
	...
	ori	$a0, $a0, 1864
	add.d	$a0, $fp, $a0
	st.d	$s3, $a0, 0                     # 8-byte Folded Spill
	lu12i.w	$a0, -1
	ori	$a0, $a0, 1912
	add.d	$a0, $fp, $a0
	st.d	$s2, $a0, 0                     # 8-byte Folded Spill
	pcalau12i	$s0, %pc_hi20(ia_VARLIST)
	ld.d	$a0, $s0, %pc_lo12(ia_VARLIST)
	ld.d	$a0, $a0, 8
	...
	ld.d	$s3, $a2, %got_pc_lo12(memory_ARRAY)
	ld.d	$a2, $s3, 128
	ld.w	$a3, $a2, 32
	pcalau12i	$a4, %got_pc_hi20(memory_FREEDBYTES)
	ld.d	$s2, $a4, %got_pc_lo12(memory_FREEDBYTES)
	ld.d	$a4, $s2, 0
	add.d	$a3, $a4, $a3
	lu12i.w	$a4, -1
	ori	$a4, $a4, 1992
	add.d	$a4, $fp, $a4
	ld.d	$a4, $a4, 0                     # 8-byte Folded Reload
	st.d	$a3, $s2, 0
	ld.d	$a2, $a2, 0
	st.d	$a2, $a0, 0
	ld.d	$a2, $s3, 128
...
# %bb.48:                               # %if.then.i
	...
	st.d	$zero, $a0, 0
	beqz	$s5, .LBB0_43
# %bb.49:                               # %for.cond.i.i.preheader
                                        #   in Loop: Header=BB0_47 Depth=2
	move	$a2, $s5
	.p2align	4, , 16
.LBB0_50:                               # %for.cond.i.i
                                        #   Parent Loop BB0_3 Depth=1
...
.LBB0_52:                               # %if.else.i
	...
	st.d	$zero, $a0, 0
	beqz	$s5, .LBB0_56
# %bb.53:                               # %for.cond.i55.i.preheader
                                        #   in Loop: Header=BB0_47 Depth=2
	move	$a2, $s5
	.p2align	4, , 16
.LBB0_54:                               # %for.cond.i55.i
                                        #   Parent Loop BB0_3 Depth=1
                                        #     Parent Loop BB0_47 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	move	$a1, $a2
...
.LBB0_57:                               # %list_Nconc.exit61.i
	...
	beqz	$a2, .LBB0_61
# %bb.58:                               # %for.cond.i67.i.preheader
                                        #   in Loop: Header=BB0_47 Depth=2
	ori	$s6, $zero, 83
	.p2align	4, , 16
.LBB0_59:                               # %for.cond.i67.i
                                        #   Parent Loop BB0_3 Depth=1
                                        #     Parent Loop BB0_47 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	move	$a1, $a2
...
.LBB0_82:                               # %sw.bb202
	...
	st.d	$zero, $a0, 0
	beqz	$s0, .LBB0_86
# %bb.83:                               # %for.cond.i230.preheader
                                        #   in Loop: Header=BB0_3 Depth=1
	move	$a0, $s0
	move	$a3, $s0
	move	$s2, $s3
	.p2align	4, , 16
.LBB0_84:                               # %for.cond.i230
                                        #   Parent Loop BB0_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$a2, $a3
	ld.d	$a3, $a3, 0
	bnez	$a3, .LBB0_84
.LBB0_85:                               # %for.end.i263
                                        #   in Loop: Header=BB0_3 Depth=1
	st.d	$a1, $a2, 0
	b	.LBB0_87
...
.LBB0_93:                               # %for.end.i219
	...
	move	$s5, $a0
	beqz	$a0, .LBB0_96
# %bb.94:                               # %for.body21.i.preheader
                                        #   in Loop: Header=BB0_3 Depth=1
	move	$s2, $s5
	.p2align	4, , 16
.LBB0_95:                               # %for.body21.i
                                        #   Parent Loop BB0_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$a0, $s2, 8
	move	$a1, $zero
...
# %bb.98:                               # %if.then34.i
	...
	ld.w	$a1, $a1, 0
	bne	$a0, $a1, .LBB0_115
# %bb.99:                               # %for.body44.i.preheader
                                        #   in Loop: Header=BB0_3 Depth=1
	move	$s2, $a3
	.p2align	4, , 16
.LBB0_100:                              # %for.body44.i
                                        #   Parent Loop BB0_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	pcalau12i	$a0, %got_pc_hi20(fol_NOT)
	ld.d	$a0, $a0, %got_pc_lo12(fol_NOT)
...
# %bb.101:                              # %for.end51.i
	...
	beqz	$a0, .LBB0_105
# %bb.102:                              # %for.cond.i90.i.preheader
                                        #   in Loop: Header=BB0_3 Depth=1
	move	$a2, $a3
	.p2align	4, , 16
.LBB0_103:                              # %for.cond.i90.i
                                        #   Parent Loop BB0_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$a1, $a2
	ld.d	$a2, $a2, 0
	bnez	$a2, .LBB0_103
# %bb.104:                              # %for.end.i94.i
                                        #   in Loop: Header=BB0_3 Depth=1
	st.d	$a0, $a1, 0
.LBB0_105:                              # %list_Nconc.exit96.i
                                        #   in Loop: Header=BB0_3 Depth=1
	lu12i.w	$a0, -1
	ori	$a0, $a0, 1872
	add.d	$a0, $fp, $a0
	ld.d	$s0, $a0, 0                     # 8-byte Folded Reload
	st.d	$a3, $s0, 16
	b	.LBB0_122
...
# %bb.108:                              # %if.then75.i
	...
	ori	$a1, $a1, 1872
	add.d	$a1, $fp, $a1
	ld.d	$s0, $a1, 0                     # 8-byte Folded Reload
	ld.w	$a1, $s0, 0
	bne	$a0, $a1, .LBB0_117
# %bb.109:                              # %if.then80.i
                                        #   in Loop: Header=BB0_3 Depth=1
	...
	ld.d	$s2, $a1, 0                     # 8-byte Folded Reload
	beqz	$a0, .LBB0_113
# %bb.110:                              # %for.cond.i111.i.preheader
                                        #   in Loop: Header=BB0_3 Depth=1
	move	$a2, $a3
	.p2align	4, , 16
.LBB0_111:                              # %for.cond.i111.i
                                        #   Parent Loop BB0_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$a1, $a2
	ld.d	$a2, $a2, 0
	bnez	$a2, .LBB0_111
# %bb.112:                              # %for.end.i115.i
                                        #   in Loop: Header=BB0_3 Depth=1
	st.d	$a0, $a1, 0
	lu12i.w	$a0, -1
	ori	$a0, $a0, 1872
...
.LBB0_117:                              # %if.else83.i
	...
	move	$a2, $a1
	.p2align	4, , 16
.LBB0_118:                              # %for.cond.i124.i
                                        #   Parent Loop BB0_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$a3, $a2
	ld.d	$a2, $a2, 0
	bnez	$a2, .LBB0_118
# %bb.119:                              # %for.end.i128.i
                                        #   in Loop: Header=BB0_3 Depth=1
	st.d	$a0, $a3, 0
	ld.w	$a0, $s2, 0
	pcaddu18i	$ra, %call36(term_Create)
...
.LBB0_120:                              # %if.then58.i
	...
	ld.w	$a0, $a0, 0
	move	$a1, $s0
.LBB0_121:                              # %ia_CreateQuantifier.exit
                                        #   in Loop: Header=BB0_3 Depth=1
	pcaddu18i	$ra, %call36(term_Create)
	jirl	$ra, $ra, 0
	move	$s0, $a0
.LBB0_122:                              # %ia_CreateQuantifier.exit
                                        #   in Loop: Header=BB0_3 Depth=1
	ori	$a0, $zero, 16
	pcaddu18i	$ra, %call36(memory_Malloc)
	jirl	$ra, $ra, 0
...
.LBB0_138:                              # %while.cond.i266
	...
	addi.d	$a1, $a1, 1
	bnez	$a2, .LBB0_138
# %bb.139:                              # %yystpcpy.exit272
	ori	$a2, $zero, 4
	blt	$a2, $s4, .LBB0_149
# %bb.140:                              # %for.body359.preheader
	add.d	$a1, $a0, $a1
	addi.d	$a5, $a1, 23
	ori	$a1, $zero, 1
...
.LBB0_145:                              # %while.cond.i273
	...
	st.b	$t2, $a5, 1
	bnez	$t2, .LBB0_145
# %bb.146:                              # %yystpcpy.exit279
                                        #   in Loop: Header=BB0_142 Depth=1
	slli.d	$t0, $a7, 3
	ldx.d	$t0, $s2, $t0
	.p2align	4, , 16
.LBB0_147:                              # %while.cond.i280
                                        #   Parent Loop BB0_142 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.bu	$t1, $t0, 0
	addi.d	$t0, $t0, 1
