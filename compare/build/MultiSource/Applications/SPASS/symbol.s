...
.LBB15_13:                              # %memory_Free.exit
	...
	jirl	$ra, $ra, 0
.LBB15_14:                              # %if.end4
	pcalau12i	$a0, %pc_hi20(symbol_VARSTRING)
	ld.d	$a2, $a0, %pc_lo12(symbol_VARSTRING)
...
# %bb.1:                                # %for.body.preheader
	pcalau12i	$s3, %pc_hi20(symbol_SIGNATURE)
	ld.d	$a1, $s3, %pc_lo12(symbol_SIGNATURE)
	ori	$s5, $zero, 8
	ori	$a4, $zero, 25
	lu12i.w	$a2, 7
	ori	$a2, $a2, 883
...
# %bb.6:                                # %while.body
	...
	bnez	$a1, .LBB21_5
	b	.LBB21_8
.LBB21_7:                               # %for.end.thread
	move	$a0, $zero
	pcaddu18i	$ra, %call36(list_PointerSort)
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB21_10
.LBB21_8:                               # %while.body.i.preheader
	pcalau12i	$a1, %got_pc_hi20(memory_ARRAY)
	ld.d	$a1, $a1, %got_pc_lo12(memory_ARRAY)
	pcalau12i	$a2, %got_pc_hi20(memory_FREEDBYTES)
	ld.d	$a2, $a2, %got_pc_lo12(memory_FREEDBYTES)
	.p2align	4, , 16
.LBB21_9:                               # %while.body.i
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a3, $a1, 128
	ld.w	$a4, $a3, 32
	ld.d	$a5, $a2, 0
