...
# %bb.43:                               # %for.body25.preheader.i.i.i
	...
	ori	$t0, $zero, 8
	bltu	$a7, $t0, .LBB14_46
# %bb.44:                               # %vector.memcheck315
                                        #   in Loop: Header=BB14_34 Depth=2
	alsl.d	$t0, $a5, $s8, 3
	alsl.d	$t1, $a7, $a3, 3
	bgeu	$t0, $t1, .LBB14_55
# %bb.45:                               # %vector.memcheck315
                                        #   in Loop: Header=BB14_34 Depth=2
	add.d	$t0, $a5, $a7
	alsl.d	$t0, $t0, $s8, 3
	bgeu	$a3, $t0, .LBB14_55
...
# %bb.228:                              # %vector.memcheck358
                                        #   in Loop: Header=BB14_218 Depth=1
	alsl.d	$t2, $a7, $s8, 3
	alsl.d	$t3, $t1, $a3, 3
	bgeu	$t2, $t3, .LBB14_239
# %bb.229:                              # %vector.memcheck358
                                        #   in Loop: Header=BB14_218 Depth=1
	add.d	$t2, $a7, $t1
	alsl.d	$t2, $t2, $s8, 3
...
.LBB14_237:                             # %vector.body348
	...
	addi.d	$t4, $t4, 64
	bnez	$t5, .LBB14_237
# %bb.238:                              # %middle.block355
                                        #   in Loop: Header=BB14_218 Depth=1
	beq	$t1, $t2, .LBB14_234
	b	.LBB14_224
.LBB14_239:                             # %vector.ph367
                                        #   in Loop: Header=BB14_218 Depth=1
