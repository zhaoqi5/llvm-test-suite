...
# %bb.0:                                # %entry
	...
	move	$s7, $a0
	pcalau12i	$a0, %pc_hi20(opts_DECLARATIONS)
	addi.d	$a0, $a0, %pc_lo12(opts_DECLARATIONS)
...
.LBB14_27:                              # %if.then8.i.i
                                        #   in Loop: Header=BB14_22 Depth=1
	ld.d	$a0, $sp, 128                   # 8-byte Folded Reload
	st.w	$s1, $a0, %pc_lo12(opts_LastNonOpt)
	move	$a1, $s1
...
.LBB14_72:                              # %if.end.thread.i.i
	...
	st.w	$s1, $s3, %pc_lo12(opts_Ind)
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	st.b	$s1, $a0, %pc_lo12(opts_GetOptInitialized)
	ld.d	$a0, $sp, 128                   # 8-byte Folded Reload
	ld.w	$a1, $a0, %pc_lo12(opts_LastNonOpt)
	blt	$s1, $a1, .LBB14_27
...
.LBB14_74:                              # %if.then12.i.i
                                        #   in Loop: Header=BB14_22 Depth=1
	ld.d	$a0, $sp, 120                   # 8-byte Folded Reload
	st.w	$s1, $a0, %pc_lo12(opts_FirstNonOpt)
	move	$a0, $s1
	ld.d	$a2, $sp, 88                    # 8-byte Folded Reload
	ld.w	$a2, $a2, %pc_lo12(opts_Ordering)
	ori	$a3, $zero, 1
...
.LBB14_77:                              # %while.end.i.i
	...
	st.w	$s1, $a1, %pc_lo12(opts_LastNonOpt)
	move	$a1, $s1
	beq	$s1, $s2, .LBB14_198
...
# %bb.114:                              # %if.end182.i.i
	...
	ld.d	$s3, $sp, 80                    # 8-byte Folded Reload
	beqz	$s7, .LBB14_118
# %bb.115:                              # %if.then185.i.i
                                        #   in Loop: Header=BB14_22 Depth=1
	ld.w	$a1, $s7, 8
	addi.w	$a0, $s1, 1
	st.w	$a0, $s3, %pc_lo12(opts_Ind)
	beqz	$s0, .LBB14_134
.LBB14_116:                             # %if.then188.i.i
                                        #   in Loop: Header=BB14_22 Depth=1
	beqz	$a1, .LBB14_254
# %bb.117:                              # %if.then190.i.i
                                        #   in Loop: Header=BB14_22 Depth=1
	add.d	$a0, $s6, $s4
	addi.d	$s4, $a0, 1
	b	.LBB14_137
	.p2align	4, , 16
.LBB14_118:                             # %lor.lhs.false263.i.i
                                        #   in Loop: Header=BB14_22 Depth=1
	ori	$s0, $zero, 45
	ld.d	$a0, $sp, 64                    # 8-byte Folded Reload
	beq	$a0, $s0, .LBB14_250
# %bb.119:                              # %lor.lhs.false270.i.i
                                        #   in Loop: Header=BB14_22 Depth=1
	ld.b	$a1, $s6, 0
...
.LBB14_120:                             # %if.end304.i.i
	...
	ld.bu	$a1, $s6, 1
	bnez	$a1, .LBB14_122
# %bb.121:                              # %if.then311.i.i
                                        #   in Loop: Header=BB14_22 Depth=1
	addi.w	$s1, $s1, 1
	st.w	$s1, $s3, %pc_lo12(opts_Ind)
.LBB14_122:                             # %if.end313.i.i
                                        #   in Loop: Header=BB14_22 Depth=1
	andi	$a2, $s5, 255
	ori	$a3, $zero, 58
	beq	$a2, $a3, .LBB14_247
# %bb.123:                              # %if.end313.i.i
                                        #   in Loop: Header=BB14_22 Depth=1
	beqz	$a0, .LBB14_247
# %bb.124:                              # %if.end335.i.i
                                        #   in Loop: Header=BB14_22 Depth=1
	ld.bu	$a3, $a0, 0
	ld.bu	$a2, $a0, 1
	ori	$a4, $zero, 87
	bne	$a3, $a4, .LBB14_128
# %bb.125:                              # %if.end335.i.i
                                        #   in Loop: Header=BB14_22 Depth=1
	ori	$a3, $zero, 59
	bne	$a2, $a3, .LBB14_128
# %bb.126:                              # %if.then345.i.i
                                        #   in Loop: Header=BB14_22 Depth=1
	beqz	$a1, .LBB14_142
# %bb.127:                              # %if.then356.i.i
                                        #   in Loop: Header=BB14_22 Depth=1
	ld.d	$a0, $sp, 136                   # 8-byte Folded Reload
	st.d	$s4, $a0, %pc_lo12(opts_Arg)
	addi.w	$a1, $s1, 1
	st.w	$a1, $s3, %pc_lo12(opts_Ind)
	b	.LBB14_144
.LBB14_128:                             # %if.end514.i.i
                                        #   in Loop: Header=BB14_22 Depth=1
	ori	$a3, $zero, 58
	bne	$a2, $a3, .LBB14_141
# %bb.129:                              # %if.then519.i.i
                                        #   in Loop: Header=BB14_22 Depth=1
	ld.bu	$a0, $a0, 2
	bne	$a0, $a3, .LBB14_160
# %bb.130:                              # %if.then524.i.i
                                        #   in Loop: Header=BB14_22 Depth=1
	bnez	$a1, .LBB14_172
# %bb.131:                              #   in Loop: Header=BB14_22 Depth=1
	move	$s4, $zero
	b	.LBB14_173
.LBB14_132:                             # %lor.lhs.false123.i.i
                                        #   in Loop: Header=BB14_22 Depth=1
	move	$a0, $fp
	pcaddu18i	$ra, %call36(strchr)
	jirl	$ra, $ra, 0
	bnez	$a0, .LBB14_120
	b	.LBB14_85
.LBB14_133:                             #   in Loop: Header=BB14_22 Depth=1
	move	$s7, $s8
...
# %bb.186:                              #   in Loop: Header=BB14_22 Depth=1
	...
	bnez	$a1, .LBB14_191
	b	.LBB14_189
.LBB14_187:                             #   in Loop: Header=BB14_22 Depth=1
	move	$a0, $zero
	addi.w	$s4, $zero, -1
	ld.d	$a1, $sp, 136                   # 8-byte Folded Reload
	ld.d	$a1, $a1, %pc_lo12(opts_Arg)
...
# %bb.220:                              # %for.body.lr.ph.i177.i.i
                                        #   in Loop: Header=BB14_218 Depth=1
	bltu	$t1, $a5, .LBB14_223
# %bb.221:                              # %vector.memcheck362
                                        #   in Loop: Header=BB14_218 Depth=1
	alsl.d	$t0, $a6, $s8, 3
	add.d	$t2, $a7, $t1
	alsl.d	$t2, $t2, $s8, 3
	bgeu	$t0, $t2, .LBB14_236
...
# %bb.227:                              # %for.body25.preheader.i165.i.i
                                        #   in Loop: Header=BB14_218 Depth=1
	bltu	$t0, $a5, .LBB14_230
# %bb.228:                              # %vector.memcheck383
                                        #   in Loop: Header=BB14_218 Depth=1
	alsl.d	$t1, $a6, $s8, 3
	alsl.d	$t2, $t0, $a3, 3
	bgeu	$t1, $t2, .LBB14_239
# %bb.229:                              # %vector.memcheck383
                                        #   in Loop: Header=BB14_218 Depth=1
	add.d	$t1, $a6, $t0
	alsl.d	$t1, $t1, $s8, 3
	bgeu	$a3, $t1, .LBB14_239
...
.LBB14_247:                             # %if.then322.i.i
	pcalau12i	$a0, %pc_hi20(opts_PosixlyCorrect)
	ld.d	$fp, $a0, %pc_lo12(opts_PosixlyCorrect)
	pcalau12i	$a0, %got_pc_hi20(stdout)
	ld.d	$a0, $a0, %got_pc_lo12(stdout)
	ld.d	$a0, $a0, 0
	pcaddu18i	$ra, %call36(fflush)
...
.LBB14_262:                             # %if.then232.i.i
	...
	ld.w	$a0, $s3, %pc_lo12(opts_Ind)
	b	.LBB14_264
.LBB14_263:                             # %if.then476.i.i
	pcalau12i	$a0, %got_pc_hi20(stdout)
	ld.d	$a0, $a0, %got_pc_lo12(stdout)
	ld.d	$a0, $a0, 0
	pcaddu18i	$ra, %call36(fflush)
	jirl	$ra, $ra, 0
	ld.w	$a0, $s0, %pc_lo12(opts_Ind)
.LBB14_264:                             # %if.then232.i.i
	ld.d	$a1, $s8, 0
	alsl.d	$a0, $a0, $s8, 3
	ld.d	$a2, $a0, -8
