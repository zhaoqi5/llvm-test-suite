...
# %bb.31:                               # %if.else.i
	bnez	$s1, .LBB5_48
.LBB5_32:                               # %rpos_ContMultisetDifference.exit255
	move	$a0, $s1
	move	$a1, $zero
	pcaddu18i	$ra, %call36(list_PointerDeleteElement)
	jirl	$ra, $ra, 0
...
.LBB5_46:                               # %if.then.i
	...
	st.d	$zero, $s4, 8
.LBB5_47:                               # %for.inc15.i251
                                        #   in Loop: Header=BB5_48 Depth=1
	ld.d	$s2, $s2, 0
	beqz	$s2, .LBB5_32
.LBB5_48:                               # %for.cond4.preheader.i242
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB5_50 Depth 2
	move	$s4, $s1
	b	.LBB5_50
	.p2align	4, , 16
.LBB5_49:                               # %for.inc.i253
                                        #   in Loop: Header=BB5_50 Depth=2
	ld.d	$s4, $s4, 0
	beqz	$s4, .LBB5_47
.LBB5_50:                               # %for.body8.i244
                                        #   Parent Loop BB5_48 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a1, $s4, 8
	beqz	$a1, .LBB5_49
# %bb.51:                               # %land.lhs.true.i248
                                        #   in Loop: Header=BB5_50 Depth=2
	ld.d	$a3, $s2, 8
	move	$a0, $s0
	move	$a2, $fp
