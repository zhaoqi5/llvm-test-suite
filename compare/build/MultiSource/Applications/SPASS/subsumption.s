...
.LBB2_15:                               # %land.lhs.true
	...
	ld.d	$s6, $a2, %got_pc_lo12(fol_NOT)
	ld.w	$a2, $s6, 0
	bne	$a3, $a2, .LBB2_18
# %bb.16:                               # %fol_Atom.exit
                                        #   in Loop: Header=BB2_3 Depth=1
...
.LBB2_43:                               # %if.then15
	...
	vld	$vr0, $sp, 32                   # 16-byte Folded Reload
	blez	$a0, .LBB2_46
# %bb.44:                               # %while.body.i53.preheader
	addi.d	$a0, $a0, 1
	ori	$a1, $zero, 1
	.p2align	4, , 16
.LBB2_45:                               # %while.body.i53
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a2, $s8, 0
	st.d	$a2, $s3, 0
	ld.d	$a3, $a2, 24
	...
	st.w	$a2, $s5, 0
	bltu	$a1, $a0, .LBB2_45
.LBB2_46:                               # %while.end.i47
	ld.d	$a5, $sp, 80                    # 8-byte Folded Reload
.LBB2_47:                               # %while.end.i47
	ld.w	$a0, $a5, 0
	beqz	$a0, .LBB2_49
...
.LBB2_51:                               # %if.then60
	ld.w	$a0, $s5, 0
	blez	$a0, .LBB2_47
# %bb.52:                               # %while.body.i137.preheader
	addi.d	$a0, $a0, 1
	ori	$a1, $zero, 1
.LBB2_53:                               # %while.body.i137
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a2, $s8, 0
	st.d	$a2, $s3, 0
	ld.d	$a3, $a2, 24
...
.LBB2_54:                               # %if.then68
	...
	vld	$vr0, $sp, 32                   # 16-byte Folded Reload
	blez	$a0, .LBB2_47
# %bb.55:                               # %while.body.i152.preheader
	addi.d	$a0, $a0, 1
	ori	$a1, $zero, 1
.LBB2_56:                               # %while.body.i152
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a2, $s8, 0
	st.d	$a2, $s3, 0
	ld.d	$a3, $a2, 24
...
# %bb.10:                               # %while.body5.i.preheader
	...
	pcalau12i	$a0, %got_pc_hi20(cont_STACKPOINTER)
	ld.d	$a6, $a0, %got_pc_lo12(cont_STACKPOINTER)
	pcalau12i	$a0, %got_pc_hi20(cont_STACK)
	ld.d	$a0, $a0, %got_pc_lo12(cont_STACK)
	...
	pcalau12i	$a0, %got_pc_hi20(cont_CURRENTBINDING)
	ld.d	$fp, $a0, %got_pc_lo12(cont_CURRENTBINDING)
	vrepli.b	$vr0, 0
	ori	$s5, $zero, 1
...
# %bb.1:                                # %while.body.lr.ph
	...
	addi.w	$s6, $zero, -1
	pcalau12i	$a0, %pc_hi20(multvec_i)
	addi.d	$s0, $a0, %pc_lo12(multvec_i)
...
# %bb.1:                                # %while.cond.preheader
	move	$s2, $a5
	pcalau12i	$s3, %pc_hi20(stamp)
	ld.w	$a6, $s3, %pc_lo12(stamp)
...
.LBB6_7:                                # %do.body.preheader
	addi.d	$s8, $a1, -1
	pcalau12i	$a0, %pc_hi20(multvec_j)
	addi.d	$a4, $a0, %pc_lo12(multvec_j)
	pcalau12i	$a0, %got_pc_hi20(cont_BINDINGS)
...
# %bb.1:                                # %while.body.lr.ph
	...
	addi.w	$s5, $zero, -1
	pcalau12i	$a0, %pc_hi20(multvec_i)
	addi.d	$s1, $a0, %pc_lo12(multvec_i)
	pcalau12i	$fp, %pc_hi20(stamp)
	pcalau12i	$a0, %got_pc_hi20(fol_NOT)
...
# %bb.12:                               # %if.end14
	...
	ldx.d	$a0, $a0, $a1
	ld.d	$t0, $a0, 24
	ld.w	$a0, $fp, %pc_lo12(stamp)
	pcalau12i	$a1, %pc_hi20(multvec_i)
	addi.d	$a7, $a1, %pc_lo12(multvec_i)
	slli.d	$a1, $s5, 2
	ld.d	$a2, $sp, 96                    # 8-byte Folded Reload
	slt	$a2, $s5, $a2
	ld.d	$a3, $sp, 104                   # 8-byte Folded Reload
...
# %bb.0:                                # %entry
	...
	ld.d	$s4, $a1, %got_pc_lo12(cont_BINDINGS)
	ld.w	$a5, $s4, 0
	pcalau12i	$a1, %got_pc_hi20(cont_STACKPOINTER)
	ld.d	$a3, $a1, %got_pc_lo12(cont_STACKPOINTER)
	ld.w	$a1, $a3, 0
...
# %bb.1:                                # %for.body.preheader
	...
	ld.d	$a4, $a3, %got_pc_lo12(vec_VECTOR)
	move	$a3, $zero
	alsl.d	$a4, $fp, $a4, 3
	.p2align	4, , 16
.LBB17_2:                               # %for.body
...
# %bb.0:                                # %entry
	...
	ld.d	$a0, $a0, %got_pc_lo12(vec_MAX)
	st.d	$a0, $sp, 40                    # 8-byte Folded Spill
	ld.w	$a0, $a0, 0
	vrepli.b	$vr0, 0
	vst	$vr0, $sp, 48                   # 16-byte Folded Spill
...
# %bb.1:                                # %for.body.preheader
	...
	ld.d	$a3, $a1, %got_pc_lo12(vec_VECTOR)
	move	$a1, $zero
	alsl.d	$a3, $s1, $a3, 3
	.p2align	4, , 16
.LBB21_2:                               # %for.body
...
# %bb.2:                                # %for.cond1.preheader.us.preheader.i.i
	...
	st.d	$a0, $sp, 88                    # 8-byte Folded Spill
	pcalau12i	$a0, %got_pc_hi20(cont_STACK)
	ld.d	$s5, $a0, %got_pc_lo12(cont_STACK)
	pcalau12i	$a0, %got_pc_hi20(cont_LEFTCONTEXT)
