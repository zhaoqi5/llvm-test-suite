...
.LBB0_14:                               # %while.cond.preheader
	pcalau12i	$a4, %pc_hi20(yy_more_len)
	pcalau12i	$s5, %pc_hi20(yy_more_flag)
	ori	$s8, $zero, 82
	...
	addi.d	$a7, $a1, %pc_lo12(yy_accept)
	pcalau12i	$t0, %pc_hi20(dfg_leng)
	ori	$t1, $zero, 71
	pcalau12i	$a1, %pc_hi20(.LJTI0_0)
	addi.d	$t2, $a1, %pc_lo12(.LJTI0_0)
.LBB0_15:                               # %while.cond
	...
	ld.bu	$a2, $s5, %pc_lo12(yy_more_flag)
	move	$a1, $zero
	st.w	$zero, $a4, %pc_lo12(yy_more_len)
	beqz	$a2, .LBB0_17
# %bb.16:                               # %if.then14
                                        #   in Loop: Header=BB0_15 Depth=1
	ld.d	$a1, $s1, %pc_lo12(dfg_text)
	sub.w	$a1, $a0, $a1
	st.w	$a1, $a4, %pc_lo12(yy_more_len)
	st.b	$zero, $s5, %pc_lo12(yy_more_flag)
.LBB0_17:                               # %if.end15
                                        #   in Loop: Header=BB0_15 Depth=1
...
# %bb.41:                               # %vec.epilog.middle.block
                                        #   in Loop: Header=BB0_22 Depth=4
	beq	$a6, $a3, .LBB0_44
.LBB0_42:                               # %for.body.i30.preheader
                                        #   in Loop: Header=BB0_22 Depth=4
	add.d	$a0, $a6, $a0
	sub.d	$a0, $a0, $s3
	addi.w	$a0, $a0, 1
	.p2align	4, , 16
.LBB0_43:                               # %for.body.i30
                                        #   Parent Loop BB0_15 Depth=1
                                        #     Parent Loop BB0_18 Depth=2
                                        #       Parent Loop BB0_21 Depth=3
                                        #         Parent Loop BB0_22 Depth=4
...
# %bb.61:                               # %land.lhs.true109.i
	...
	ld.d	$s1, $sp, 48                    # 8-byte Folded Reload
	bnez	$a0, .LBB0_179
# %bb.62:                               # %if.end116.thread62.i
                                        #   in Loop: Header=BB0_22 Depth=4
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	ld.d	$s0, $a0, %pc_lo12(yy_current_buffer)
	ld.d	$fp, $sp, 32                    # 8-byte Folded Reload
.LBB0_63:                               # %if.then119.sink.split.i
                                        #   in Loop: Header=BB0_22 Depth=4
	ld.d	$s5, $sp, 96                    # 8-byte Folded Reload
...
# %bb.66:                               #   in Loop: Header=BB0_22 Depth=4
	...
	ld.w	$a0, $s5, %pc_lo12(yy_more_len)
	bne	$a2, $a0, .LBB0_76
.LBB0_67:                               # %yy_get_next_buffer.exit.thread87
                                        #   in Loop: Header=BB0_22 Depth=4
	ld.d	$a0, $sp, 104                   # 8-byte Folded Reload
	ld.d	$a0, $a0, %pc_lo12(dfg_in)
	move	$s0, $a2
...
.LBB0_70:                               # %if.then150
	...
	ld.w	$a1, $a0, %pc_lo12(yy_more_len)
	ld.d	$s3, $sp, 72                    # 8-byte Folded Reload
...
.LBB0_77:                               # %sw.bb175
	...
	ld.d	$t2, $sp, 80                    # 8-byte Folded Reload
	bgeu	$a0, $s7, .LBB0_21
# %bb.78:                               # %for.body.i60.preheader
                                        #   in Loop: Header=BB0_21 Depth=3
	move	$a2, $a0
	b	.LBB0_81
.LBB0_79:                               # %cond.true.i66
                                        #   in Loop: Header=BB0_81 Depth=4
	slli.d	$a4, $a4, 2
	ldx.w	$a4, $s6, $a4
.LBB0_80:                               # %cond.end.i69
                                        #   in Loop: Header=BB0_81 Depth=4
	ori	$a5, $zero, 82
	mul.d	$a3, $a3, $a5
	add.d	$a3, $s2, $a3
...
.LBB0_84:                               # %yy_get_previous_state.exit
	...
	blez	$a2, .LBB0_21
	b	.LBB0_97
.LBB0_85:                               #   in Loop: Header=BB0_21 Depth=3
	ld.d	$a4, $sp, 96                    # 8-byte Folded Reload
	b	.LBB0_21
...
.LBB0_90:                               # %sw.bb169
	...
	ld.w	$a1, $a6, %pc_lo12(yy_more_len)
	ld.w	$a2, $s3, %pc_lo12(yy_start)
	add.d	$a3, $a4, $a5
	...
	ld.d	$t2, $sp, 80                    # 8-byte Folded Reload
	bge	$a1, $a5, .LBB0_18
# %bb.91:                               # %for.body.i39.preheader
                                        #   in Loop: Header=BB0_18 Depth=2
	move	$a4, $a0
	b	.LBB0_94
.LBB0_92:                               # %cond.true.i45
                                        #   in Loop: Header=BB0_94 Depth=3
	slli.d	$a5, $a5, 2
	ldx.w	$a5, $s6, $a5
.LBB0_93:                               # %cond.end.i48
                                        #   in Loop: Header=BB0_94 Depth=3
	ori	$a6, $zero, 82
	mul.d	$a2, $a2, $a6
	add.d	$a2, $s2, $a2
...
# %bb.95:                               #   in Loop: Header=BB0_94 Depth=3
	ori	$a5, $zero, 1
	b	.LBB0_93
.LBB0_96:                               #   in Loop: Header=BB0_18 Depth=2
	ld.d	$a4, $sp, 96                    # 8-byte Folded Reload
	b	.LBB0_18
.LBB0_97:                               # %if.then158
                                        #   in Loop: Header=BB0_18 Depth=2
...
.LBB0_101:                              # %sw.bb92
                                        #   in Loop: Header=BB0_15 Depth=1
	ori	$a1, $zero, 1
	st.b	$a1, $s5, %pc_lo12(yy_more_flag)
	b	.LBB0_15
.LBB0_102:                              # %sw.bb131
                                        #   in Loop: Header=BB0_15 Depth=1
	ld.d	$a0, $s1, %pc_lo12(dfg_text)
	ld.w	$a1, $t0, %pc_lo12(dfg_leng)
...
.LBB0_134:                              # %sw.bb53
	ori	$a0, $zero, 287
	b	.LBB0_171
.LBB0_135:                              # %cleanup185.loopexit
	ori	$a0, $zero, 258
	b	.LBB0_171
.LBB0_136:                              # %cleanup185.loopexit370
	ori	$a0, $zero, 261
	b	.LBB0_171
.LBB0_137:                              # %sw.bb48
	ori	$a0, $zero, 282
...
.LBB0_138:                              # %sw.bb47
	ori	$a0, $zero, 279
	b	.LBB0_171
.LBB0_139:                              # %cleanup185.loopexit113
	ori	$a0, $zero, 259
	b	.LBB0_171
.LBB0_140:                              # %sw.bb41
	ori	$a0, $zero, 272
...
.LBB0_141:                              # %sw.bb40
	ori	$a0, $zero, 270
	b	.LBB0_171
.LBB0_142:                              # %cleanup185.loopexit1081
	ori	$a0, $zero, 263
	b	.LBB0_171
.LBB0_143:                              # %sw.bb70
	ori	$a0, $zero, 297
	b	.LBB0_171
.LBB0_144:                              # %cleanup185.loopexit183
	ori	$a0, $zero, 260
	b	.LBB0_171
.LBB0_145:                              # %sw.bb42
	ori	$a0, $zero, 274
...
.LBB0_148:                              # %sw.bb38
	ori	$a0, $zero, 267
	b	.LBB0_171
.LBB0_149:                              # %cleanup185.loopexit618
	ori	$a0, $zero, 262
	b	.LBB0_171
.LBB0_150:                              # %sw.bb69
	ori	$a0, $zero, 295
...
.LBB0_169:
	move	$a0, $zero
.LBB0_170:                              # %dfg_CountNewlines.exit
	pcalau12i	$a1, %got_pc_hi20(dfg_LINENUMBER)
	ld.d	$a1, $a1, %got_pc_lo12(dfg_LINENUMBER)
	ld.w	$a2, $a1, 0
	add.d	$a0, $a2, $a0
...
.LBB0_172:
	ori	$a0, $zero, 293
	b	.LBB0_171
.LBB0_173:                              # %if.end47.thread.i
	st.d	$zero, $s0, 8
.LBB0_174:                              # %if.then50.i
