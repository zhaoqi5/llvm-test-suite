...
# %bb.14:                               # %if.then72
	...
	ld.d	$t5, $t3, %got_pc_lo12(stack_STACK)
	addi.d	$t3, $t4, 1
...
# %bb.16:                               # %if.then47
                                        #   in Loop: Header=BB4_6 Depth=1
	beqz	$t7, .LBB4_34
# %bb.17:                               # %for.cond.outer.i115.preheader
                                        #   in Loop: Header=BB4_6 Depth=1
	move	$t7, $t4
	move	$fp, $a1
	move	$t8, $a0
	b	.LBB4_19
	.p2align	4, , 16
.LBB4_18:                               # %if.then8.i131
                                        #   in Loop: Header=BB4_19 Depth=2
	ld.d	$t8, $t5, 16
	ld.w	$t5, $fp, 0
.LBB4_19:                               # %for.cond.outer.i115
                                        #   Parent Loop BB4_6 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB4_27 Depth 3
	blez	$t5, .LBB4_27
.LBB4_20:                               # %if.then.i121
                                        #   in Loop: Header=BB4_19 Depth=2
	bne	$a2, $t8, .LBB4_22
# %bb.21:                               # %if.then.i121
                                        #   in Loop: Header=BB4_19 Depth=2
	beq	$t6, $t5, .LBB4_57
.LBB4_22:                               # %if.else.i127
                                        #   in Loop: Header=BB4_19 Depth=2
	slli.d	$t5, $t5, 5
	add.d	$t5, $t8, $t5
	ld.d	$fp, $t5, 8
	bnez	$fp, .LBB4_18
.LBB4_23:                               # %if.end25.i137
                                        #   in Loop: Header=BB4_19 Depth=2
	beq	$t7, $t4, .LBB4_33
# %bb.24:                               # %if.else29.i140
                                        #   in Loop: Header=BB4_19 Depth=2
	pcalau12i	$t3, %got_pc_hi20(stack_STACK)
	ld.d	$t5, $t3, %got_pc_lo12(stack_STACK)
	addi.d	$t3, $t7, -1
	...
	ld.d	$fp, $t8, 8
	addi.w	$t3, $t7, -2
	bstrpick.d	$s1, $t3, 31, 0
	slli.d	$s2, $s1, 3
	ld.d	$s1, $t8, 0
	ldx.d	$t8, $t5, $s2
	beqz	$s1, .LBB4_30
# %bb.25:                               # %if.else38.i150
                                        #   in Loop: Header=BB4_19 Depth=2
	alsl.d	$t3, $s0, $t5, 3
	st.w	$t7, $a4, 0
	st.d	$s1, $t3, 0
	...
	b	.LBB4_19
	.p2align	4, , 16
.LBB4_26:                               # %if.end22.i171
                                        #   in Loop: Header=BB4_27 Depth=3
	ld.d	$fp, $t5, 8
	ld.w	$t5, $fp, 0
	bge	$t5, $t2, .LBB4_20
.LBB4_27:                               # %if.else12.i154
                                        #   Parent Loop BB4_6 Depth=1
                                        #     Parent Loop BB4_19 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$t5, $fp, 16
	beqz	$t5, .LBB4_23
# %bb.28:                               # %if.then15.i160
                                        #   in Loop: Header=BB4_27 Depth=3
	ld.d	$fp, $t5, 0
	beqz	$fp, .LBB4_26
# %bb.29:                               # %if.then20.i163
                                        #   in Loop: Header=BB4_27 Depth=3
	addi.d	$fp, $t7, 1
	pcalau12i	$t3, %got_pc_hi20(stack_STACK)
	ld.d	$s0, $t3, %got_pc_lo12(stack_STACK)
	st.w	$fp, $a4, 0
...
.LBB4_40:                               # %if.else
                                        #   in Loop: Header=BB4_6 Depth=1
	beqz	$t7, .LBB4_56
# %bb.41:                               # %for.cond.outer.i.preheader
                                        #   in Loop: Header=BB4_6 Depth=1
	move	$t7, $t4
	move	$fp, $a3
	move	$t8, $a2
...
# %bb.48:                               # %if.else29.i
                                        #   in Loop: Header=BB4_43 Depth=2
	pcalau12i	$t3, %got_pc_hi20(stack_STACK)
	ld.d	$t6, $t3, %got_pc_lo12(stack_STACK)
	addi.d	$t3, $t7, -1
	bstrpick.d	$s0, $t3, 31, 0
	slli.d	$t8, $s0, 3
	ldx.d	$t8, $t6, $t8
...
.LBB5_26:                               # %if.else53
                                        #   in Loop: Header=BB5_1 Depth=1
	blt	$a2, $a6, .LBB5_46
# %bb.27:                               # %for.cond.i103.preheader
                                        #   in Loop: Header=BB5_1 Depth=1
	move	$a2, $a7
	move	$t3, $t0
	b	.LBB5_30
	.p2align	4, , 16
.LBB5_28:                               # %if.end23.i137
                                        #   in Loop: Header=BB5_30 Depth=2
	ld.d	$t3, $t1, 8
.LBB5_29:                               # %for.cond.backedge.i113
                                        #   in Loop: Header=BB5_30 Depth=2
	ld.wu	$t1, $t3, 0
.LBB5_30:                               # %for.cond.i103
                                        #   Parent Loop BB5_1 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.w	$t4, $t1, 0
	blt	$t4, $a6, .LBB5_33
...
# %bb.32:                               # %if.else.i109
	...
	b	.LBB5_36
	.p2align	4, , 16
.LBB5_33:                               # %if.else13.i127
                                        #   in Loop: Header=BB5_30 Depth=2
	ld.d	$t1, $t3, 16
	beqz	$t1, .LBB5_36
# %bb.34:                               # %if.then16.i130
                                        #   in Loop: Header=BB5_30 Depth=2
	ld.d	$t3, $t1, 0
	beqz	$t3, .LBB5_28
# %bb.35:                               # %if.then21.i133
                                        #   in Loop: Header=BB5_30 Depth=2
	bstrpick.d	$t4, $a2, 31, 0
	addi.w	$a2, $a2, 1
	st.w	$a2, $a3, 0
	...
	b	.LBB5_28
	.p2align	4, , 16
.LBB5_36:                               # %if.end26.i115
                                        #   in Loop: Header=BB5_30 Depth=2
	beq	$a2, $a7, .LBB5_40
# %bb.37:                               # %if.else30.i117
                                        #   in Loop: Header=BB5_30 Depth=2
	addi.w	$t1, $a2, -1
...
.LBB5_42:                               # %if.end68.sink.split
	...
	ld.d	$a2, $a2, 0
	pcalau12i	$a7, %got_pc_hi20(cont_BINDINGS)
	ld.d	$a7, $a7, %got_pc_lo12(cont_BINDINGS)
	ld.d	$t0, $a1, 0
	ld.w	$t1, $a7, 0
	st.d	$t0, $a2, 24
	st.d	$a2, $a1, 0
...
# %bb.21:                               # %if.else70
                                        #   in Loop: Header=BB6_2 Depth=1
	pcalau12i	$a0, %got_pc_hi20(stack_STACK)
	ld.d	$t5, $a0, %got_pc_lo12(stack_STACK)
	addi.w	$t7, $t3, -1
...
# %bb.15:                               # %if.then63
	...
	b	.LBB7_17
	.p2align	4, , 16
.LBB7_16:                               # %if.then8.i142
                                        #   in Loop: Header=BB7_17 Depth=1
	ld.d	$t1, $a1, 16
	ld.wu	$a1, $t2, 0
.LBB7_17:                               # %for.cond.outer.i126
                                        # =>This Loop Header: Depth=1
...
# %bb.18:                               # %if.then.i132
                                        #   in Loop: Header=BB7_17 Depth=1
	bne	$fp, $t1, .LBB7_20
.LBB7_19:                               # %if.then.i132
                                        #   in Loop: Header=BB7_17 Depth=1
	beq	$a3, $a1, .LBB7_45
.LBB7_20:                               # %if.else.i138
                                        #   in Loop: Header=BB7_17 Depth=1
	slli.d	$a1, $a1, 5
	add.d	$a1, $t1, $a1
	ld.d	$t2, $a1, 8
	bnez	$t2, .LBB7_16
.LBB7_21:                               # %if.end25.i148
                                        #   in Loop: Header=BB7_17 Depth=1
	beq	$t0, $a6, .LBB7_52
# %bb.22:                               # %if.else29.i151
                                        #   in Loop: Header=BB7_17 Depth=1
	addi.d	$t1, $t0, -1
...
# %bb.23:                               # %if.else38.i161
	...
	b	.LBB7_17
	.p2align	4, , 16
.LBB7_24:                               # %if.end22.i182
                                        #   in Loop: Header=BB7_25 Depth=2
	ld.d	$t2, $a1, 8
	ld.w	$a1, $t2, 0
	bge	$a1, $a7, .LBB7_28
.LBB7_25:                               # %if.else12.i165
                                        #   Parent Loop BB7_17 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a1, $t2, 16
	beqz	$a1, .LBB7_21
# %bb.26:                               # %if.then15.i171
                                        #   in Loop: Header=BB7_25 Depth=2
	ld.d	$t2, $a1, 0
	beqz	$t2, .LBB7_24
# %bb.27:                               # %if.then20.i174
                                        #   in Loop: Header=BB7_25 Depth=2
	addi.d	$t2, $t0, 1
	st.w	$t2, $a5, 0
...
# %bb.1:                                # %while.body.lr.ph
	pcalau12i	$a5, %got_pc_hi20(cont_INSTANCECONTEXT)
	ld.d	$a5, $a5, %got_pc_lo12(cont_INSTANCECONTEXT)
	ld.d	$a5, $a5, 0
	addi.w	$a6, $zero, -1001
	.p2align	4, , 16
.LBB11_2:                               # %while.body
