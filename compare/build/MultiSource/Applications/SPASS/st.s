...
# %bb.0:                                # %entry
	...
	ld.d	$a6, $a0, %got_pc_lo12(cont_INDEXVARSCANNER)
	ld.w	$a1, $a6, 0
	pcalau12i	$a0, %got_pc_hi20(symbol_INDEXVARCOUNTER)
	ld.d	$a0, $a0, %got_pc_lo12(symbol_INDEXVARCOUNTER)
	ld.w	$a2, $a0, 0
	beq	$a1, $a2, .LBB1_5
...
.LBB1_6:                                # %cont_NextIndexVariable.exit
	...
	ld.d	$s6, $a1, %got_pc_lo12(cont_LASTBINDING)
	ld.d	$a1, $s6, 0
	st.d	$a1, $a0, 24
	st.d	$a0, $s6, 0
...
# %bb.37:                               # %while.body
	...
	b	.LBB1_39
	.p2align	4, , 16
.LBB1_38:                               # %st_FirstVariant.exit.thread67
                                        #   in Loop: Header=BB1_22 Depth=1
	move	$a0, $s1
...
# %bb.5:                                # %for.body.preheader
	...
	ld.d	$s2, $a2, %got_pc_lo12(cont_LASTBINDING)
...
# %bb.0:                                # %entry
	...
	ld.d	$s5, $a1, %got_pc_lo12(stack_POINTER)
	ld.w	$a1, $s5, 0
	st.d	$a1, $sp, 8                     # 8-byte Folded Spill
	pcalau12i	$a1, %got_pc_hi20(cont_STACKPOINTER)
	ld.d	$s2, $a1, %got_pc_lo12(cont_STACKPOINTER)
	ld.w	$a1, $s2, 0
	addi.d	$a2, $a1, 1
	st.w	$a2, $s2, 0
	slli.d	$a1, $a1, 2
...
.LBB6_18:                               # %for.end.i
	...
	ld.d	$s0, $s0, 0
	blez	$a0, .LBB6_1
.LBB6_19:                               # %while.body.i26.i.preheader
                                        #   in Loop: Header=BB6_1 Depth=1
	addi.d	$a0, $a0, 1
	.p2align	4, , 16
.LBB6_20:                               # %while.body.i26.i
                                        #   Parent Loop BB6_1 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a1, $s1, 0
	st.d	$a1, $s3, 0
...
# %bb.0:                                # %entry
	...
	st.d	$a1, $sp, 8                     # 8-byte Folded Spill
	pcalau12i	$a1, %got_pc_hi20(cont_STACKPOINTER)
	ld.d	$s1, $a1, %got_pc_lo12(cont_STACKPOINTER)
	ld.w	$a1, $s1, 0
	addi.d	$a2, $a1, 1
	st.w	$a2, $s1, 0
	slli.d	$a1, $a1, 2
...
.LBB7_18:                               # %for.end.i
	...
	ld.d	$s0, $s0, 0
	blez	$a0, .LBB7_1
.LBB7_19:                               # %while.body.i24.i.preheader
                                        #   in Loop: Header=BB7_1 Depth=1
	addi.d	$a0, $a0, 1
	.p2align	4, , 16
.LBB7_20:                               # %while.body.i24.i
                                        #   Parent Loop BB7_1 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a1, $s3, 0
	st.d	$a1, $s2, 0
...
# %bb.0:                                # %entry
	...
	ld.d	$s6, $a0, %got_pc_lo12(stack_POINTER)
	ld.w	$a0, $s6, 0
	st.d	$a0, $sp, 16                    # 8-byte Folded Spill
	ld.w	$a0, $s4, 0
	pcalau12i	$a1, %got_pc_hi20(cont_STACKPOINTER)
...
.LBB8_19:                               # %for.end.i
	...
	ld.d	$s0, $s0, 0
	blez	$a0, .LBB8_1
.LBB8_20:                               # %while.body.i26.i.preheader
                                        #   in Loop: Header=BB8_1 Depth=1
	addi.d	$a0, $a0, 1
	.p2align	4, , 16
.LBB8_21:                               # %while.body.i26.i
                                        #   Parent Loop BB8_1 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a1, $s3, 0
	st.d	$a1, $s2, 0
...
.LBB9_18:                               # %for.end.i
	...
	ld.d	$s0, $s0, 0
	blez	$a0, .LBB9_1
.LBB9_19:                               # %while.body.i24.i.preheader
                                        #   in Loop: Header=BB9_1 Depth=1
	addi.d	$a0, $a0, 1
	.p2align	4, , 16
.LBB9_20:                               # %while.body.i24.i
                                        #   Parent Loop BB9_1 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a1, $s3, 0
	st.d	$a1, $s2, 0
...
.LBB10_19:                              # %for.end.i
	...
	ld.d	$s0, $s0, 0
	blez	$a0, .LBB10_1
.LBB10_20:                              # %while.body.i26.i.preheader
                                        #   in Loop: Header=BB10_1 Depth=1
	addi.d	$a0, $a0, 1
	.p2align	4, , 16
.LBB10_21:                              # %while.body.i26.i
                                        #   Parent Loop BB10_1 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a1, $s3, 0
	st.d	$a1, $s2, 0
...
# %bb.4:                                # %if.then5
	...
	beqz	$a0, .LBB13_11
# %bb.5:                                # %if.then.i
	ld.w	$a0, $s3, %pc_lo12(st_STACKSAVE)
...
.LBB14_13:                              #   in Loop: Header=BB14_1 Depth=1
	...
	ld.d	$s8, $s8, 0
	blez	$a0, .LBB14_1
.LBB14_14:                              # %while.body.i28.preheader
                                        #   in Loop: Header=BB14_1 Depth=1
	addi.d	$a0, $a0, 1
	.p2align	4, , 16
.LBB14_15:                              # %while.body.i28
                                        #   Parent Loop BB14_1 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a1, $s4, 0
	st.d	$a1, $s6, 0
...
.LBB16_13:                              #   in Loop: Header=BB16_1 Depth=1
	...
	ld.d	$s8, $s8, 0
	blez	$a0, .LBB16_1
.LBB16_14:                              # %while.body.i28.preheader
                                        #   in Loop: Header=BB16_1 Depth=1
	addi.d	$a0, $a0, 1
	.p2align	4, , 16
.LBB16_15:                              # %while.body.i28
                                        #   Parent Loop BB16_1 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a1, $s4, 0
	st.d	$a1, $s6, 0
...
.LBB17_3:                               # %if.then
	...
	pcalau12i	$s3, %pc_hi20(st_STACKSAVE)
	st.w	$a0, $s3, %pc_lo12(st_STACKSAVE)
	move	$a0, $s1
	pcaddu18i	$ra, %call36(term_ComputeSize)
	jirl	$ra, $ra, 0
	...
	ld.d	$a0, $s0, 8
	addi.d	$a2, $a4, 1
	st.w	$a2, $s4, %pc_lo12(st_STACKPOINTER)
	slli.d	$a2, $a4, 3
...
.LBB17_10:                              # %sw.epilog.i
	...
	ori	$a1, $zero, 1
	st.b	$a1, $a4, %pc_lo12(st_WHICH_CONTEXTS)
	st.d	$zero, $a3, %pc_lo12(st_INDEX_CONTEXT)
	st.h	$zero, $s8, %pc_lo12(st_EXIST_MINMAX)
	b	.LBB17_12
.LBB17_11:
	move	$a0, $zero
.LBB17_12:                              # %cleanup
...
.LBB18_13:                              # %for.end
	...
	ld.d	$s5, $s5, 0
	blez	$a0, .LBB18_1
.LBB18_14:                              # %while.body.i30.preheader
                                        #   in Loop: Header=BB18_1 Depth=1
	addi.d	$a0, $a0, 1
	.p2align	4, , 16
.LBB18_15:                              # %while.body.i30
                                        #   Parent Loop BB18_1 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a1, $s4, 0
	st.d	$a1, $s6, 0
...
.LBB20_13:                              #   in Loop: Header=BB20_1 Depth=1
	...
	ld.d	$s8, $s8, 0
	blez	$a0, .LBB20_1
.LBB20_14:                              # %while.body.i28.preheader
                                        #   in Loop: Header=BB20_1 Depth=1
	addi.d	$a0, $a0, 1
	.p2align	4, , 16
.LBB20_15:                              # %while.body.i28
                                        #   Parent Loop BB20_1 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a1, $s4, 0
	st.d	$a1, $s6, 0
...
.LBB22_13:                              # %for.end
	...
	ld.d	$s5, $s5, 0
	blez	$a0, .LBB22_1
.LBB22_14:                              # %while.body.i30.preheader
                                        #   in Loop: Header=BB22_1 Depth=1
	addi.d	$a0, $a0, 1
	.p2align	4, , 16
.LBB22_15:                              # %while.body.i30
                                        #   Parent Loop BB22_1 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a1, $s4, 0
	st.d	$a1, $s6, 0
