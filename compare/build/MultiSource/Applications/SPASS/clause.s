...
# %bb.0:                                # %entry
	...
	ld.d	$a2, $a0, %got_pc_lo12(stack_POINTER)
	ld.w	$a3, $a2, 0
...
.LBB11_10:                              # %for.end.i
	...
	vld	$vr1, $a6, %pc_lo12(.LCPI11_0)
	pcalau12i	$a6, %pc_hi20(.LCPI11_1)
	vld	$vr2, $a6, %pc_lo12(.LCPI11_1)
	pcalau12i	$a6, %pc_hi20(.LCPI11_2)
	vld	$vr3, $a6, %pc_lo12(.LCPI11_2)
	pcalau12i	$a6, %pc_hi20(.LCPI11_3)
	vld	$vr4, $a6, %pc_lo12(.LCPI11_3)
	pcalau12i	$a6, %pc_hi20(.LCPI11_4)
	vld	$vr5, $a6, %pc_lo12(.LCPI11_4)
	pcalau12i	$a6, %pc_hi20(.LCPI11_5)
	vld	$vr6, $a6, %pc_lo12(.LCPI11_5)
...
# %bb.25:                               # %clause_LiteralIsLiteral.exit
	...
	beq	$a4, $a5, .LBB11_27
	b	.LBB11_6
.LBB11_26:                              # %land.lhs.true8
	beqz	$a2, .LBB11_30
.LBB11_27:                              # %lor.lhs.false11
	ld.w	$a0, $a0, 24
	beqz	$a0, .LBB11_23
# %bb.28:                               # %if.else.i15
	ori	$a1, $zero, 63
...
.LBB22_4:                               # %clause_LiteralIsEquality.exit.thread
	...
	ld.w	$a2, $a2, 0
	bne	$a1, $a2, .LBB22_6
# %bb.5:                                # %clause_LiteralAtom.exit21
	addi.d	$sp, $sp, -16
	st.d	$ra, $sp, 8                     # 8-byte Folded Spill
	ld.d	$a0, $a0, 16
	ld.d	$a1, $a0, 0
...
# %bb.1:                                # %for.body.lr.ph
	...
	ld.d	$a4, $a2, %got_pc_lo12(stack_POINTER)
	ld.w	$a5, $a4, 0
	pcalau12i	$a2, %got_pc_hi20(stack_STACK)
	ld.d	$a6, $a2, %got_pc_lo12(stack_STACK)
	move	$a7, $zero
	move	$a2, $zero
	b	.LBB25_4
	.p2align	4, , 16
...
# %bb.1:                                # %while.body.preheader
	...
	b	.LBB27_4
	.p2align	4, , 16
.LBB27_2:                               # %clause_ComputeTermDepth.exit.loopexit
...
# %bb.1:                                # %for.body.lr.ph
	...
	ld.d	$a6, $a5, %got_pc_lo12(stack_STACK)
	move	$a7, $zero
	move	$a5, $zero
	.p2align	4, , 16
.LBB29_2:                               # %for.body
...
.LBB49_7:                               # %if.end10
	...
	ld.w	$a1, $a0, 0
	pcalau12i	$a2, %got_pc_hi20(fol_NOT)
	ld.d	$s5, $a2, %got_pc_lo12(fol_NOT)
	ld.w	$a2, $s5, 0
	bne	$a1, $a2, .LBB49_9
# %bb.8:                                # %if.then.i
	ld.d	$a0, $a0, 16
...
# %bb.0:                                # %entry
	move	$a2, $a0
	pcalau12i	$a0, %got_pc_hi20(stack_POINTER)
	ld.d	$a3, $a0, %got_pc_lo12(stack_POINTER)
	ld.w	$a4, $a3, 0
	beqz	$a1, .LBB50_9
...
# %bb.0:                                # %entry
	...
	jirl	$ra, $ra, 0
	pcalau12i	$a1, %pc_hi20(clause_STAMPID)
	st.w	$a0, $a1, %pc_lo12(clause_STAMPID)
	pcalau12i	$a0, %pc_hi20(clause_SORT)
	addi.d	$a0, $a0, %pc_lo12(clause_SORT)
	ori	$a2, $zero, 168
	move	$a1, $zero
	ld.d	$ra, $sp, 8                     # 8-byte Folded Reload
	addi.d	$sp, $sp, 16
...
.LBB77_2:                               # %for.body.lr.ph
	...
	ld.w	$a7, $a7, 0
	pcalau12i	$t0, %got_pc_hi20(fol_NOT)
	ld.d	$t0, $t0, %got_pc_lo12(fol_NOT)
	ld.w	$t1, $t0, 0
	beqz	$a1, .LBB77_11
# %bb.3:                                # %for.body.preheader
	slli.d	$t2, $a5, 3
	pcalau12i	$a1, %got_pc_hi20(symbol_SIGNATURE)
	ld.d	$t3, $a1, %got_pc_lo12(symbol_SIGNATURE)
	move	$a1, $zero
	ori	$t4, $zero, 1
	move	$t5, $a5
	move	$t6, $a4
...
.LBB77_11:                              # %for.body.us.preheader
	...
	slli.d	$t3, $a5, 3
	pcalau12i	$a1, %got_pc_hi20(symbol_SIGNATURE)
	ld.d	$t4, $a1, %got_pc_lo12(symbol_SIGNATURE)
	move	$a1, $zero
	ori	$t5, $zero, 1
	move	$t6, $a5
	b	.LBB77_14
...
# %bb.18:                               # %if.end26
	beqz	$s2, .LBB95_21
# %bb.19:                               # %while.body.i33.preheader
	pcalau12i	$a1, %got_pc_hi20(memory_ARRAY)
	ld.d	$a1, $a1, %got_pc_lo12(memory_ARRAY)
	pcalau12i	$a2, %got_pc_hi20(memory_FREEDBYTES)
	ld.d	$a2, $a2, %got_pc_lo12(memory_FREEDBYTES)
	.p2align	4, , 16
.LBB95_20:                              # %while.body.i33
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a3, $a1, 128
	ld.w	$a4, $a3, 32
	ld.d	$a5, $a2, 0
	...
	move	$s2, $a6
	bnez	$a6, .LBB95_20
.LBB95_21:                              # %while.body.i42.preheader
	pcalau12i	$a1, %got_pc_hi20(memory_ARRAY)
	ld.d	$a1, $a1, %got_pc_lo12(memory_ARRAY)
	pcalau12i	$a2, %got_pc_hi20(memory_FREEDBYTES)
	ld.d	$a2, $a2, %got_pc_lo12(memory_FREEDBYTES)
	.p2align	4, , 16
.LBB95_22:                              # %while.body.i42
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a3, $a1, 128
	ld.w	$a4, $a3, 32
	ld.d	$a5, $a2, 0
