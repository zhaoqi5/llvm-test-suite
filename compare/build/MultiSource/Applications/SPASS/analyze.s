...
# %bb.0:                                # %entry
	...
	addi.d	$a1, $a0, %pc_lo12(ana_CONCLAUSES)
...
# %bb.36:                               # %for.end.i
	...
	jirl	$ra, $ra, 0
	beqz	$s8, .LBB3_61
# %bb.37:                               # %for.body17.i80.preheader
	pcalau12i	$a0, %got_pc_hi20(fol_NOT)
...
.LBB3_44:                               # %clause_LiteralIsEquality.exit.thread.i
	...
	ld.w	$a2, $s0, 0
	bne	$a1, $a2, .LBB3_40
# %bb.45:                               # %clause_GetLiteralAtom.exit.i89
                                        #   in Loop: Header=BB3_41 Depth=2
	addi.d	$a1, $sp, 84
	addi.d	$a2, $sp, 80
...
.LBB3_47:                               # %if.end34.i
	...
	ld.w	$a2, $s2, 0
	bne	$a1, $a2, .LBB3_49
# %bb.48:                               # %if.then.i.i137.i
                                        #   in Loop: Header=BB3_41 Depth=2
	ld.d	$a0, $a0, 16
	ld.d	$a0, $a0, 8
.LBB3_49:                               # %clause_GetLiteralAtom.exit140.i
                                        #   in Loop: Header=BB3_41 Depth=2
	ld.d	$a1, $a0, 16
	ld.d	$s4, $a1, 8
	ld.w	$a0, $s4, 0
...
# %bb.63:
	...
	b	.LBB3_65
	.p2align	4, , 16
.LBB3_64:                               # %for.cond67.loopexit.i
                                        #   in Loop: Header=BB3_65 Depth=1
	ld.d	$fp, $fp, 0
	beqz	$fp, .LBB3_78
.LBB3_65:                               # %for.body71.i
                                        # =>This Loop Header: Depth=1
	...
	ld.d	$s4, $s1, 24
	beqz	$s4, .LBB3_64
# %bb.66:                               # %for.body79.lr.ph.i
                                        #   in Loop: Header=BB3_65 Depth=1
	st.d	$fp, $sp, 64                    # 8-byte Folded Spill
	move	$s2, $zero
	b	.LBB3_69
	.p2align	4, , 16
.LBB3_67:                               # %if.then107.i
...
.LBB3_73:                               # %if.end98.i
                                        #   in Loop: Header=BB3_69 Depth=2
	bltu	$s6, $s5, .LBB3_67
# %bb.74:                               # %lor.lhs.false101.i
                                        #   in Loop: Header=BB3_69 Depth=2
	bne	$s6, $s5, .LBB3_68
# %bb.75:                               # %lor.lhs.false101.i
                                        #   in Loop: Header=BB3_69 Depth=2
	bge	$s8, $fp, .LBB3_67
	b	.LBB3_68
	.p2align	4, , 16
.LBB3_76:                               # %for.cond112.preheader.i
                                        #   in Loop: Header=BB3_65 Depth=1
	ld.d	$s5, $sp, 48                    # 8-byte Folded Reload
	ld.d	$s6, $sp, 40                    # 8-byte Folded Reload
	ld.d	$fp, $sp, 64                    # 8-byte Folded Reload
...
.LBB3_77:                               # %for.body116.i
	...
	bnez	$a3, .LBB3_77
	b	.LBB3_64
.LBB3_78:                               # %for.end123.i
	ld.d	$s4, $sp, 8                     # 8-byte Folded Reload
	ld.d	$s0, $sp, 56                    # 8-byte Folded Reload
	ld.d	$s2, $sp, 72                    # 8-byte Folded Reload
	beqz	$s2, .LBB3_88
# %bb.79:                               # %for.body.i.preheader.i
	ld.d	$a3, $s2, 0
	beqz	$a3, .LBB3_86
# %bb.80:
	move	$a0, $s2
	b	.LBB3_82
	.p2align	4, , 16
.LBB3_81:                               # %for.body.i.loopexit.i
                                        #   in Loop: Header=BB3_82 Depth=1
	ld.d	$a3, $a0, 0
	beqz	$a3, .LBB3_86
.LBB3_82:                               # %for.body7.lr.ph.i.i
                                        # =>This Loop Header: Depth=1
...
.LBB3_87:                               # %for.body135.i
	...
	move	$s2, $a3
	bnez	$a3, .LBB3_87
.LBB3_88:                               # %for.end145.i
	move	$a0, $s0
	pcaddu18i	$ra, %call36(graph_StronglyConnectedComponents)
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB3_97
# %bb.89:                               # %for.cond151.preheader.lr.ph.i
	ld.d	$s0, $s0, 8
	ld.d	$s5, $sp, 32                    # 8-byte Folded Reload
	ld.d	$s6, $sp, 24                    # 8-byte Folded Reload
	ld.d	$s7, $sp, 16                    # 8-byte Folded Reload
	beqz	$s0, .LBB3_98
# %bb.90:                               # %for.cond151.preheader.i.preheader
	move	$s3, $a0
	pcalau12i	$a0, %got_pc_hi20(symbol_SIGNATURE)
	...
	addi.w	$s3, $s3, -1
	bnez	$s0, .LBB3_94
.LBB3_91:                               # %while.cond.loopexit.i
                                        # =>This Inner Loop Header: Depth=1
	beqz	$s3, .LBB3_96
# %bb.92:                               # %for.cond151.preheaderthread-pre-split.i
	...
	b	.LBB3_91
	.p2align	4, , 16
.LBB3_93:                               # %for.inc166.i
                                        #   in Loop: Header=BB3_94 Depth=1
	ld.d	$s0, $s0, 0
	beqz	$s0, .LBB3_91
.LBB3_94:                               # %for.body155.i
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $s0, 8
	ld.w	$a1, $a0, 8
	bne	$a1, $s3, .LBB3_93
...
.LBB3_102:                              # %for.body18
	...
	move	$s3, $a3
	bnez	$a3, .LBB3_102
.LBB3_103:                              # %for.cond23.preheader
	beqz	$s8, .LBB3_106
# %bb.104:                              # %for.body27.lr.ph
	move	$s4, $s8
	pcalau12i	$a0, %got_pc_hi20(symbol_TYPESTATBITS)
	ld.d	$a0, $a0, %got_pc_lo12(symbol_TYPESTATBITS)
	ld.w	$fp, $a0, 0
...
.LBB3_105:                              # %for.body27
	...
	move	$s4, $a3
	bnez	$a3, .LBB3_105
.LBB3_106:                              # %for.cond32.preheader
	beqz	$s1, .LBB3_109
# %bb.107:                              # %for.body36.lr.ph
	pcalau12i	$a0, %got_pc_hi20(symbol_TYPESTATBITS)
	ld.d	$a0, $a0, %got_pc_lo12(symbol_TYPESTATBITS)
	ld.w	$fp, $a0, 0
	pcalau12i	$a0, %got_pc_hi20(memory_ARRAY)
