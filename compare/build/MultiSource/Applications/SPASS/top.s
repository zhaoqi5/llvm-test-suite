...
.LBB0_16:                               # %for.body.i252
	...
	bnez	$a0, .LBB0_16
	b	.LBB0_19
.LBB0_17:                               # %vector.body805.preheader
	lu12i.w	$a0, -4
	ori	$a0, $a0, 384
	ld.d	$a2, $sp, 104                   # 8-byte Folded Reload
	ld.d	$a4, $sp, 120                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB0_18:                               # %vector.body805
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a1, $a3, $a0
	xvldx	$xr0, $a1, $a2
	xvldx	$xr1, $a1, $s6
...
.LBB0_496:                              # %for.body.i556
	...
	bnez	$a0, .LBB0_496
	b	.LBB0_499
.LBB0_497:                              # %vector.body814.preheader
	lu12i.w	$a0, -4
	ori	$a0, $a0, 384
	ld.d	$a2, $sp, 112                   # 8-byte Folded Reload
	ld.d	$s3, $sp, 120                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB0_498:                              # %vector.body814
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a1, $a2, $a0
	xvldx	$xr0, $a1, $s1
	xvldx	$xr1, $a1, $s6
