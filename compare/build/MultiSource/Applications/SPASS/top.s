...
.LBB0_382:                              # %if.then67.i.i
	...
	st.d	$s3, $a0, 0
	move	$s3, $a0
.LBB0_383:                              # %if.end87.i.i
                                        #   in Loop: Header=BB0_219 Depth=3
	ld.d	$s6, $sp, 240                   # 8-byte Folded Reload
	ld.d	$s5, $sp, 272                   # 8-byte Folded Reload
	b	.LBB0_396
.LBB0_384:                              # %if.else62.i.i
                                        #   in Loop: Header=BB0_219 Depth=3
	move	$a0, $s8
	move	$a1, $s6
	pcaddu18i	$ra, %call36(prfs_PerformSplitting)
	...
	ld.d	$s7, $sp, 264                   # 8-byte Folded Reload
	bnez	$s0, .LBB0_382
.LBB0_385:                              # %if.else69.i.i
                                        #   in Loop: Header=BB0_219 Depth=3
	ld.w	$a1, $s4, 348
	beqz	$a1, .LBB0_388
# %bb.386:                              # %if.then72.i.i
                                        #   in Loop: Header=BB0_219 Depth=3
	ld.d	$a2, $s8, 32
	ld.d	$a3, $s8, 48
	move	$a0, $s6
...
.LBB0_388:                              # %if.then83.i.i
	...
	jirl	$ra, $ra, 0
	beqz	$s3, .LBB0_393
# %bb.389:                              # %if.end.i130.i.i
                                        #   in Loop: Header=BB0_219 Depth=3
	ld.d	$s6, $sp, 240                   # 8-byte Folded Reload
	beqz	$a0, .LBB0_394
# %bb.390:                              # %for.cond.i.i.i.preheader
                                        #   in Loop: Header=BB0_219 Depth=3
	move	$a2, $s3
	ld.d	$s5, $sp, 272                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB0_391:                              # %for.cond.i.i.i
                                        #   Parent Loop BB0_208 Depth=1
                                        #     Parent Loop BB0_210 Depth=2
                                        #       Parent Loop BB0_219 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
	...
	ld.d	$a2, $a2, 0
	bnez	$a2, .LBB0_391
# %bb.392:                              # %for.end.i.i.i
                                        #   in Loop: Header=BB0_219 Depth=3
	st.d	$a0, $a1, 0
	b	.LBB0_395
.LBB0_393:                              #   in Loop: Header=BB0_219 Depth=3
	move	$s3, $a0
	ld.d	$s6, $sp, 240                   # 8-byte Folded Reload
.LBB0_394:                              #   in Loop: Header=BB0_219 Depth=3
	ld.d	$s5, $sp, 272                   # 8-byte Folded Reload
.LBB0_395:                              # %list_Nconc.exit.i.i
                                        #   in Loop: Header=BB0_219 Depth=3
	ori	$a0, $zero, 5
	pcaddu18i	$ra, %call36(clock_StopAddPassedTime)
	jirl	$ra, $ra, 0
	.p2align	4, , 16
.LBB0_396:                              # %if.end87.i.i
                                        #   in Loop: Header=BB0_219 Depth=3
	move	$a0, $s3
	pcaddu18i	$ra, %call36(list_Length)
	jirl	$ra, $ra, 0
	...
	ld.w	$a0, $s7, 92
	beqz	$a0, .LBB0_400
.LBB0_397:                              # %if.end235.i
                                        #   in Loop: Header=BB0_219 Depth=3
	beqz	$s3, .LBB0_400
# %bb.398:                              # %for.body243.i.preheader
                                        #   in Loop: Header=BB0_219 Depth=3
	move	$fp, $s3
	.p2align	4, , 16
.LBB0_399:                              # %for.body243.i
                                        #   Parent Loop BB0_208 Depth=1
                                        #     Parent Loop BB0_210 Depth=2
                                        #       Parent Loop BB0_219 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
...
# %bb.401:                              # %if.then253.i
	...
	jirl	$ra, $ra, 0
	beqz	$fp, .LBB0_410
# %bb.402:                              # %if.end.i396.i
                                        #   in Loop: Header=BB0_219 Depth=3
	beqz	$a0, .LBB0_411
# %bb.403:                              # %for.cond.i398.i.preheader
                                        #   in Loop: Header=BB0_219 Depth=3
	move	$a2, $fp
	.p2align	4, , 16
.LBB0_404:                              # %for.cond.i398.i
                                        #   Parent Loop BB0_208 Depth=1
                                        #     Parent Loop BB0_210 Depth=2
                                        #       Parent Loop BB0_219 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
...
.LBB0_405:                              # %if.else256.i
	...
	jirl	$ra, $ra, 0
	beqz	$fp, .LBB0_410
# %bb.406:                              # %if.end.i406.i
                                        #   in Loop: Header=BB0_219 Depth=3
	beqz	$a0, .LBB0_411
# %bb.407:                              # %for.cond.i408.i.preheader
                                        #   in Loop: Header=BB0_219 Depth=3
	move	$a2, $fp
	.p2align	4, , 16
.LBB0_408:                              # %for.cond.i408.i
                                        #   Parent Loop BB0_208 Depth=1
                                        #     Parent Loop BB0_210 Depth=2
                                        #       Parent Loop BB0_219 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
	...
	ld.d	$a2, $a2, 0
	bnez	$a2, .LBB0_408
.LBB0_409:                              # %for.end.i412.i
                                        #   in Loop: Header=BB0_219 Depth=3
	st.d	$a0, $a1, 0
	b	.LBB0_411
	.p2align	4, , 16
.LBB0_410:                              #   in Loop: Header=BB0_219 Depth=3
	move	$fp, $a0
.LBB0_411:                              # %if.end259.i
                                        #   in Loop: Header=BB0_219 Depth=3
	st.d	$fp, $sp, 336
	ori	$a0, $zero, 4
	pcaddu18i	$ra, %call36(clock_StopAddPassedTime)
...
# %bb.417:                              # %if.then286.i
	...
	ld.d	$a1, $sp, 128                   # 8-byte Folded Reload
	b	.LBB0_208
.LBB0_418:                              # %lor.lhs.false.i
	pcalau12i	$a0, %got_pc_hi20(ana_USORTRES)
	ld.d	$a0, $a0, %got_pc_lo12(ana_USORTRES)
	ld.w	$a0, $a0, 0
	beqz	$a0, .LBB0_192
# %bb.419:                              # %land.lhs.true66.i
	ld.w	$a0, $s7, 160
	ori	$a1, $zero, 2
	beq	$a0, $a1, .LBB0_189
	b	.LBB0_192
.LBB0_420:                              # %lor.rhs.while.end293_crit_edge.i
	ld.d	$a0, $sp, 336
.LBB0_421:                              # %top_ProofSearch.exit
	st.d	$a0, $s8, 8
...
# %bb.422:                              # %lor.lhs.false257
	...
	ori	$s0, $zero, 2
	bcnez	$fcc0, .LBB0_427
.LBB0_423:                              # %land.lhs.true263
	ld.w	$a0, $s8, 148
	ori	$s0, $zero, 2
	beqz	$a0, .LBB0_428
# %bb.424:                              # %land.lhs.true267
	ld.w	$a1, $sp, 332
	ld.d	$a0, $s8, 8
	beq	$a1, $s6, .LBB0_426
# %bb.425:                              # %land.lhs.true267
	move	$s1, $zero
	move	$s3, $zero
	move	$s4, $zero
	beqz	$a0, .LBB0_427
...
# %bb.455:                              # %for.body393.preheader
	...
	move	$s7, $s0
	b	.LBB0_458
.LBB0_456:                              #   in Loop: Header=BB0_458 Depth=1
	move	$s1, $a0
	.p2align	4, , 16
.LBB0_457:                              # %for.inc405
                                        #   in Loop: Header=BB0_458 Depth=1
	ld.d	$s7, $s7, 0
	beqz	$s7, .LBB0_468
.LBB0_458:                              # %for.body393
                                        # =>This Loop Header: Depth=1
...
# %bb.459:                              # %if.then397
	...
	alsl.d	$a1, $a1, $a2, 3
	.p2align	4, , 16
.LBB0_460:                              # %for.cond.i478
                                        #   Parent Loop BB0_458 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a1, $a1, 0
	beqz	$a1, .LBB0_463
# %bb.461:                              # %for.body.i482
...
# %bb.462:                              # %if.then.i486
	...
	b	.LBB0_456
	.p2align	4, , 16
.LBB0_463:                              #   in Loop: Header=BB0_458 Depth=1
	move	$a0, $zero
	pcaddu18i	$ra, %call36(list_Copy)
	jirl	$ra, $ra, 0
	move	$a1, $s3
	...
	jirl	$ra, $ra, 0
	beqz	$s1, .LBB0_456
.LBB0_464:                              # %if.end.i492
                                        #   in Loop: Header=BB0_458 Depth=1
	beqz	$a0, .LBB0_457
# %bb.465:                              # %for.cond.i494.preheader
                                        #   in Loop: Header=BB0_458 Depth=1
	move	$a2, $s1
	.p2align	4, , 16
.LBB0_466:                              # %for.cond.i494
                                        #   Parent Loop BB0_458 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$a1, $a2
	ld.d	$a2, $a2, 0
...
# %bb.467:                              # %for.end.i498
	...
	st.d	$a0, $a1, 0
	b	.LBB0_457
.LBB0_468:                              # %while.body.i502.preheader
	pcalau12i	$a0, %got_pc_hi20(memory_ARRAY)
	ld.d	$a0, $a0, %got_pc_lo12(memory_ARRAY)
	pcalau12i	$a1, %got_pc_hi20(memory_FREEDBYTES)
	ld.d	$a1, $a1, %got_pc_lo12(memory_FREEDBYTES)
	.p2align	4, , 16
.LBB0_469:                              # %while.body.i502
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a2, $a0, 128
	ld.w	$a3, $a2, 32
	ld.d	$a4, $a1, 0
...
# %bb.472:
	...
	.p2align	4, , 16
.LBB0_473:                              # %for.inc423
                                        #   in Loop: Header=BB0_474 Depth=1
	ld.d	$s2, $s2, 0
	beqz	$s2, .LBB0_476
.LBB0_474:                              # %for.body414
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$s4, $s2, 8
	ori	$a2, $zero, 6
	move	$a0, $s4
...
.LBB0_478:                              # %if.end429
	ld.d	$a4, $sp, 136                   # 8-byte Folded Reload
	beqz	$a4, .LBB0_488
.LBB0_479:                              # %for.body434.preheader
	lu12i.w	$a0, -361578
	ori	$a0, $a0, 283
	lu32i.d	$a0, -289263
	lu52i.d	$fp, $a0, 423
...
.LBB0_480:                              # %list_Delete.exit.i
	...
	st.d	$a0, $s4, 0
	move	$a4, $s2
.LBB0_481:                              # %hsh_DelItem.exit
                                        #   in Loop: Header=BB0_482 Depth=1
	ld.d	$a4, $a4, 0
	beqz	$a4, .LBB0_488
.LBB0_482:                              # %for.body434
                                        # =>This Loop Header: Depth=1
	...
	move	$a2, $s4
	.p2align	4, , 16
.LBB0_483:                              # %for.cond.i529
                                        #   Parent Loop BB0_482 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a2, $a2, 0
	beqz	$a2, .LBB0_481
# %bb.484:                              # %for.body.i533
...
.LBB0_488:                              # %for.end438
	...
	beqz	$a6, .LBB0_491
# %bb.489:                              # %while.body.i547.preheader
	pcalau12i	$a0, %got_pc_hi20(memory_ARRAY)
	ld.d	$a0, $a0, %got_pc_lo12(memory_ARRAY)
	pcalau12i	$a1, %got_pc_hi20(memory_FREEDBYTES)
	ld.d	$a1, $a1, %got_pc_lo12(memory_FREEDBYTES)
	.p2align	4, , 16
.LBB0_490:                              # %while.body.i547
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a2, $a0, 128
	ld.w	$a3, $a2, 32
	ld.d	$a4, $a1, 0
...
.LBB0_491:                              # %list_Delete.exit555
	...
	bgeu	$a1, $a0, .LBB0_494
# %bb.492:                              # %for.body.i556.preheader
	lu12i.w	$a0, -4
	ori	$a0, $a0, 384
	ld.d	$a3, $sp, 104                   # 8-byte Folded Reload
	ld.d	$s2, $sp, 112                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB0_493:                              # %for.body.i556
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a1, $a3, $a0
	ldx.w	$a1, $a1, $s1
	add.d	$a2, $s2, $a0
	...
	bnez	$a0, .LBB0_493
	b	.LBB0_496
.LBB0_494:                              # %vector.body812.preheader
	lu12i.w	$a0, -4
	ori	$a0, $a0, 384
	ld.d	$a2, $sp, 104                   # 8-byte Folded Reload
	ld.d	$s2, $sp, 112                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB0_495:                              # %vector.body812
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a1, $a2, $a0
	xvldx	$xr0, $a1, $s1
	xvldx	$xr1, $a1, $s5
	...
	xvstx	$xr1, $a1, $s5
	bnez	$a0, .LBB0_495
.LBB0_496:                              # %symbol_TransferPrecedence.exit563
	ld.w	$a0, $s6, 108
	beqz	$a0, .LBB0_498
# %bb.497:                              # %if.then444
	ld.d	$a3, $fp, 0
...
# %bb.504:                              # %if.then467
	beqz	$a0, .LBB0_507
# %bb.505:                              # %while.body.i573.preheader
	pcalau12i	$a1, %got_pc_hi20(memory_ARRAY)
	ld.d	$a1, $a1, %got_pc_lo12(memory_ARRAY)
	pcalau12i	$a2, %got_pc_hi20(memory_FREEDBYTES)
	ld.d	$a2, $a2, %got_pc_lo12(memory_FREEDBYTES)
	.p2align	4, , 16
.LBB0_506:                              # %while.body.i573
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a3, $a1, 128
	ld.w	$a4, $a3, 32
	ld.d	$a5, $a2, 0
...
# %bb.515:                              # %for.end492
	ld.d	$a0, $sp, 456
	beqz	$a0, .LBB0_518
# %bb.516:                              # %while.body.i588.preheader
	pcalau12i	$a1, %got_pc_hi20(memory_ARRAY)
	ld.d	$a1, $a1, %got_pc_lo12(memory_ARRAY)
	pcalau12i	$a2, %got_pc_hi20(memory_FREEDBYTES)
	ld.d	$a2, $a2, %got_pc_lo12(memory_FREEDBYTES)
	.p2align	4, , 16
.LBB0_517:                              # %while.body.i588
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a3, $a1, 128
	ld.w	$a4, $a3, 32
	ld.d	$a5, $a2, 0
	...
	move	$a0, $a6
	bnez	$a6, .LBB0_517
.LBB0_518:                              # %list_Delete.exit596
	beqz	$s0, .LBB0_521
# %bb.519:                              # %while.body.i598.preheader
	pcalau12i	$a0, %got_pc_hi20(memory_ARRAY)
	ld.d	$a0, $a0, %got_pc_lo12(memory_ARRAY)
	pcalau12i	$a1, %got_pc_hi20(memory_FREEDBYTES)
	ld.d	$a1, $a1, %got_pc_lo12(memory_FREEDBYTES)
	.p2align	4, , 16
.LBB0_520:                              # %while.body.i598
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a2, $a0, 128
	ld.w	$a3, $a2, 32
	ld.d	$a4, $a1, 0
	...
	move	$s0, $a5
	bnez	$a5, .LBB0_520
.LBB0_521:                              # %list_Delete.exit606
	ld.d	$a0, $sp, 440
	beqz	$a0, .LBB0_524
# %bb.522:                              # %while.body.i608.preheader
	pcalau12i	$a1, %got_pc_hi20(memory_ARRAY)
	ld.d	$a1, $a1, %got_pc_lo12(memory_ARRAY)
	pcalau12i	$a2, %got_pc_hi20(memory_FREEDBYTES)
	ld.d	$a2, $a2, %got_pc_lo12(memory_FREEDBYTES)
	.p2align	4, , 16
.LBB0_523:                              # %while.body.i608
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a3, $a1, 128
	ld.w	$a4, $a3, 32
	ld.d	$a5, $a2, 0
...
.LBB0_524:                              # %list_Delete.exit616
	...
	ld.d	$a3, $a1, -8
	beqz	$a4, .LBB0_533
# %bb.525:                              # %if.then3.i.i630
	st.d	$a3, $a4, 8
	or	$a0, $a2, $a0
	beqz	$a3, .LBB0_527
.LBB0_526:                              # %if.then9.i.i634
	ld.d	$a1, $a1, -16
	st.d	$a1, $a3, 0
.LBB0_527:                              # %if.end13.i.i635
	pcalau12i	$a1, %got_pc_hi20(memory_MARKSIZE)
	ld.d	$a1, $a1, %got_pc_lo12(memory_MARKSIZE)
	ld.w	$a1, $a1, 0
	ld.d	$a2, $s0, 0
	...
	ld.d	$a2, $a1, 0
	bltz	$a2, .LBB0_529
# %bb.528:                              # %if.then18.i.i642
	add.d	$a0, $a2, $a0
	st.d	$a0, $a1, 0
.LBB0_529:                              # %symbol_DeletePrecedence.exit
	addi.d	$a0, $a5, -16
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
...
.LBB6_28:                               # %for.end64
	...
	bnez	$s1, .LBB6_14
	b	.LBB6_15
.LBB6_29:                               # %for.cond76.preheader.loopexit
	ld.w	$a3, $s0, 72
	add.d	$a0, $a4, $a3
	addi.w	$a0, $a0, -1
	bltz	$a0, .LBB6_35
.LBB6_30:                               # %for.body80.preheader
	pcalau12i	$a0, %got_pc_hi20(memory_ARRAY)
	ld.d	$a0, $a0, %got_pc_lo12(memory_ARRAY)
	pcalau12i	$a4, %got_pc_hi20(memory_FREEDBYTES)
...
.LBB6_42:                               # %if.end23.i
	...
	jirl	$ra, $ra, 0
	beqz	$s2, .LBB6_2
.LBB6_43:                               # %while.body.i102.preheader
	pcalau12i	$a0, %got_pc_hi20(memory_ARRAY)
	ld.d	$a0, $a0, %got_pc_lo12(memory_ARRAY)
	pcalau12i	$a1, %got_pc_hi20(memory_FREEDBYTES)
	ld.d	$a1, $a1, %got_pc_lo12(memory_FREEDBYTES)
	.p2align	4, , 16
.LBB6_44:                               # %while.body.i102
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a2, $a0, 128
	ld.w	$a3, $a2, 32
	ld.d	$a4, $a1, 0
