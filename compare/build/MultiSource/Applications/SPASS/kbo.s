...
# %bb.5:                                # %if.else10
	...
	bltu	$a6, $a5, .LBB2_1
# %bb.6:                                # %lor.lhs.false
	pcalau12i	$a5, %got_pc_hi20(ord_PRECEDENCE)
	ld.d	$a5, $a5, %got_pc_lo12(ord_PRECEDENCE)
	ld.d	$a6, $a5, 0
	sub.d	$a5, $zero, $a2
...
# %bb.14:                               # %if.else12
	...
	bltu	$a7, $a4, .LBB5_22
# %bb.15:                               # %lor.lhs.false
	pcalau12i	$a4, %got_pc_hi20(ord_PRECEDENCE)
	ld.d	$a4, $a4, %got_pc_lo12(ord_PRECEDENCE)
	ld.d	$a7, $a4, 0
	sub.d	$a4, $zero, $a5
...
# %bb.28:                               # %land.rhs.i111.preheader
	...
	move	$a0, $s3
	beq	$s3, $a2, .LBB5_46
# %bb.29:                               # %while.body.i115.preheader
	slli.d	$a3, $a3, 5
	add.d	$a3, $a0, $a3
	ld.d	$a4, $a3, 8
	beqz	$a4, .LBB5_46
.LBB5_30:                               # %cleanup.i120
                                        # =>This Inner Loop Header: Depth=1
	move	$s0, $a4
	ld.w	$a4, $a4, 0
	ld.d	$a0, $a3, 16
...
.LBB5_33:                               # %if.then33
	...
	ld.w	$a1, $a0, 0
	blez	$a1, .LBB5_39
# %bb.34:                               # %land.rhs.i69.preheader
	pcalau12i	$a0, %got_pc_hi20(cont_INSTANCECONTEXT)
	ld.d	$a0, $a0, %got_pc_lo12(cont_INSTANCECONTEXT)
	ld.d	$a0, $a0, 0
	beq	$s4, $a0, .LBB5_39
# %bb.35:                               # %while.body.i73.preheader
	slli.d	$a1, $a1, 5
	add.d	$a1, $s4, $a1
	ld.d	$a2, $a1, 8
	beqz	$a2, .LBB5_39
...
# %bb.37:                               # %cleanup.i78
	...
	beq	$s4, $a0, .LBB5_39
# %bb.38:                               # %while.body.i73
                                        #   in Loop: Header=BB5_36 Depth=1
	slli.d	$a1, $a2, 5
	add.d	$a1, $s4, $a1
	ld.d	$a2, $a1, 8
	bnez	$a2, .LBB5_36
.LBB5_39:                               # %cont_Deref.exit83
	move	$a0, $s1
	move	$a1, $s3
	pcaddu18i	$ra, %call36(list_NthElement)
	jirl	$ra, $ra, 0
	...
	ld.w	$a2, $a0, 0
	blez	$a2, .LBB5_52
# %bb.40:                               # %land.rhs.i88.preheader
	pcalau12i	$a0, %got_pc_hi20(cont_INSTANCECONTEXT)
	ld.d	$a0, $a0, %got_pc_lo12(cont_INSTANCECONTEXT)
	ld.d	$a1, $a0, 0
	move	$a0, $s4
	beq	$fp, $a1, .LBB5_53
# %bb.41:                               # %while.body.i92.preheader
	slli.d	$a2, $a2, 5
	add.d	$a2, $fp, $a2
	ld.d	$a3, $a2, 8
	beqz	$a3, .LBB5_53
...
.LBB5_45:
	move	$a1, $fp
	move	$a0, $s3
.LBB5_46:                               # %cont_Deref.exit125
	ld.d	$s1, $s1, 8
	ld.w	$a3, $s1, 0
	blez	$a3, .LBB5_53
# %bb.47:                               # %land.rhs.i130.preheader
	pcalau12i	$a2, %got_pc_hi20(cont_INSTANCECONTEXT)
	ld.d	$a2, $a2, %got_pc_lo12(cont_INSTANCECONTEXT)
	ld.d	$a2, $a2, 0
	beq	$a1, $a2, .LBB5_53
# %bb.48:                               # %while.body.i134.preheader
	slli.d	$a3, $a3, 5
	add.d	$a1, $a1, $a3
	ld.d	$a3, $a1, 8
	beqz	$a3, .LBB5_53
.LBB5_49:                               # %cleanup.i139
                                        # =>This Inner Loop Header: Depth=1
	move	$s1, $a3
	ld.w	$a3, $a3, 0
	ld.d	$fp, $a1, 16
...
# %bb.3:                                # %for.body11.preheader.i
	...
	pcalau12i	$a2, %got_pc_hi20(ord_VARCOUNT)
	ld.d	$a3, $a2, %got_pc_lo12(ord_VARCOUNT)
	move	$a2, $zero
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a1, -1
	ori	$a6, $zero, 1
...
.LBB7_5:                                # %cont_Deref.exit
	ld.w	$a2, $a3, 0
	blez	$a2, .LBB7_10
# %bb.6:                                # %land.rhs.i43.preheader
	pcalau12i	$a0, %got_pc_hi20(cont_INSTANCECONTEXT)
	ld.d	$a0, $a0, %got_pc_lo12(cont_INSTANCECONTEXT)
	ld.d	$a0, $a0, 0
	beq	$fp, $a0, .LBB7_10
	.p2align	4, , 16
.LBB7_7:                                # %while.body.i47
                                        # =>This Inner Loop Header: Depth=1
	slli.d	$a5, $a2, 5
	add.d	$a5, $fp, $a5
	ld.d	$a6, $a5, 8
...
.LBB7_22:                               # %if.else48
	...
	ld.w	$a1, $s1, 0
	blez	$a1, .LBB7_28
# %bb.23:                               # %land.rhs.i112.preheader
	pcalau12i	$a0, %got_pc_hi20(cont_INSTANCECONTEXT)
	ld.d	$a0, $a0, %got_pc_lo12(cont_INSTANCECONTEXT)
	ld.d	$a0, $a0, 0
	beq	$s0, $a0, .LBB7_28
# %bb.24:                               # %while.body.i116.preheader
	slli.d	$a1, $a1, 5
	add.d	$a1, $s0, $a1
	ld.d	$a2, $a1, 8
	beqz	$a2, .LBB7_28
.LBB7_25:                               # %cleanup.i121
                                        # =>This Inner Loop Header: Depth=1
	move	$s1, $a2
	ld.w	$a2, $a2, 0
	ld.d	$s0, $a1, 16
...
# %bb.26:                               # %cleanup.i121
	...
	beq	$s0, $a0, .LBB7_28
# %bb.27:                               # %while.body.i116
                                        #   in Loop: Header=BB7_25 Depth=1
	slli.d	$a1, $a2, 5
	add.d	$a1, $s0, $a1
	ld.d	$a2, $a1, 8
	bnez	$a2, .LBB7_25
.LBB7_28:                               # %cont_Deref.exit126
	ld.d	$s2, $s2, 8
	ld.w	$a1, $s2, 0
	blez	$a1, .LBB7_46
# %bb.29:                               # %land.rhs.i131.preheader
	pcalau12i	$a0, %got_pc_hi20(cont_INSTANCECONTEXT)
	ld.d	$a0, $a0, %got_pc_lo12(cont_INSTANCECONTEXT)
	ld.d	$a0, $a0, 0
	beq	$fp, $a0, .LBB7_46
# %bb.30:                               # %while.body.i135.preheader
	slli.d	$a1, $a1, 5
	add.d	$a1, $fp, $a1
	ld.d	$a2, $a1, 8
	beqz	$a2, .LBB7_46
.LBB7_31:                               # %cleanup.i140
                                        # =>This Inner Loop Header: Depth=1
	move	$s2, $a2
	ld.w	$a2, $a2, 0
	ld.d	$fp, $a1, 16
...
.LBB7_34:                               # %if.then28
	...
	ld.w	$a1, $a0, 0
	blez	$a1, .LBB7_40
# %bb.35:                               # %land.rhs.i70.preheader
	pcalau12i	$a0, %got_pc_hi20(cont_INSTANCECONTEXT)
	ld.d	$a0, $a0, %got_pc_lo12(cont_INSTANCECONTEXT)
	ld.d	$a0, $a0, 0
	beq	$s0, $a0, .LBB7_40
# %bb.36:                               # %while.body.i74.preheader
	slli.d	$a1, $a1, 5
	add.d	$a1, $s0, $a1
	ld.d	$a2, $a1, 8
	beqz	$a2, .LBB7_40
...
# %bb.38:                               # %cleanup.i79
	...
	beq	$s0, $a0, .LBB7_40
# %bb.39:                               # %while.body.i74
                                        #   in Loop: Header=BB7_37 Depth=1
	slli.d	$a1, $a2, 5
	add.d	$a1, $s0, $a1
	ld.d	$a2, $a1, 8
	bnez	$a2, .LBB7_37
.LBB7_40:                               # %cont_Deref.exit84
	move	$a0, $s2
	move	$a1, $s3
	pcaddu18i	$ra, %call36(list_NthElement)
	jirl	$ra, $ra, 0
	...
	ld.w	$a1, $a0, 0
	blez	$a1, .LBB7_46
# %bb.41:                               # %land.rhs.i89.preheader
	pcalau12i	$a0, %got_pc_hi20(cont_INSTANCECONTEXT)
	ld.d	$a0, $a0, %got_pc_lo12(cont_INSTANCECONTEXT)
	ld.d	$a0, $a0, 0
	beq	$fp, $a0, .LBB7_46
# %bb.42:                               # %while.body.i93.preheader
	slli.d	$a1, $a1, 5
	add.d	$a1, $fp, $a1
	ld.d	$a2, $a1, 8
	beqz	$a2, .LBB7_46
