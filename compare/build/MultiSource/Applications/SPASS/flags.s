...
# %bb.0:                                # %entry
	...
	st.d	$a3, $a0, 1128
	st.w	$a2, $a0, 1160
	pcalau12i	$t1, %pc_hi20(.LCPI0_3)
	xvld	$xr0, $t1, %pc_lo12(.LCPI0_3)
...
# %bb.0:                                # %entry
	...
	ori	$s1, $a0, 1792
	pcalau12i	$a0, %pc_hi20(flag_PROPERTIES)
	addi.d	$s3, $a0, %pc_lo12(flag_PROPERTIES)
	addi.w	$s2, $zero, -1
	.p2align	4, , 16
.LBB6_1:                                # %for.body
                                        # =>This Inner Loop Header: Depth=1
...
# %bb.0:                                # %entry
	...
	move	$a1, $zero
	pcalau12i	$a2, %pc_hi20(flag_PROPERTIES+16)
	addi.d	$fp, $a2, %pc_lo12(flag_PROPERTIES+16)
	ori	$a2, $zero, 384
	b	.LBB10_2
	.p2align	4, , 16
.LBB10_1:                               # %for.inc
...
# %bb.0:                                # %entry
	...
	move	$a1, $zero
	pcalau12i	$a2, %pc_hi20(flag_PROPERTIES+16)
	addi.d	$s0, $a2, %pc_lo12(flag_PROPERTIES+16)
	ori	$a2, $zero, 2
	pcalau12i	$a3, %pc_hi20(flag_DEFAULTSTORE)
	addi.d	$a3, $a3, %pc_lo12(flag_DEFAULTSTORE)
	ori	$a4, $zero, 384
	b	.LBB13_2
	.p2align	4, , 16
.LBB13_1:                               # %for.inc
