...
.LBB0_2:                                # %if.then
	...
	beqz	$a2, .LBB0_7
# %bb.3:                                # %if.end
	ld.d	$s0, $s3, %pc_lo12(ia_in)
	beqz	$s0, .LBB0_8
.LBB0_4:                                # %if.end5
	move	$s1, $fp
	ld.d	$a0, $s2, %pc_lo12(ia_out)
	beqz	$a0, .LBB0_9
.LBB0_5:                                # %if.end8
...
.LBB0_13:                               # %if.end11
	...
	st.w	$a1, $s0, %pc_lo12(yy_n_chars)
	st.d	$a2, $s3, %pc_lo12(ia_in)
	ld.b	$a1, $a0, 0
	st.b	$a1, $s7, %pc_lo12(yy_hold_char)
...
.LBB0_15:                               # %while.cond
	...
	ld.b	$a1, $s7, %pc_lo12(yy_hold_char)
	st.b	$a1, $a0, 0
...
.LBB0_19:                               # %yy_find_action
	...
	ldx.h	$a2, $a2, $a1
	st.b	$a0, $s7, %pc_lo12(yy_hold_char)
	st.b	$zero, $s1, 0
	move	$a0, $s1
.LBB0_20:                               # %do_action
                                        #   Parent Loop BB0_15 Depth=1
...
.LBB0_22:                               # %sw.bb74
                                        #   in Loop: Header=BB0_20 Depth=4
	ld.b	$a0, $s7, %pc_lo12(yy_hold_char)
	ld.d	$a5, $fp, %pc_lo12(ia_text)
	st.b	$a0, $s1, 0
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
	ld.d	$s7, $a0, %pc_lo12(yy_current_buffer)
	ld.w	$a2, $s7, 48
	beqz	$a2, .LBB0_24
# %bb.23:                               # %sw.bb74.if.end84_crit_edge
                                        #   in Loop: Header=BB0_20 Depth=4
	ld.w	$a3, $s0, %pc_lo12(yy_n_chars)
	ld.d	$a1, $s7, 8
...
.LBB0_24:                               # %if.then82
	...
	ld.d	$a0, $a0, %pc_lo12(ia_in)
	st.w	$a3, $s0, %pc_lo12(yy_n_chars)
	st.d	$a0, $s7, 0
	ori	$a2, $zero, 1
	st.w	$a2, $s7, 48
	ld.d	$a1, $s7, 8
...
# %bb.40:                               # %vec.epilog.middle.block
	...
	bne	$a5, $a2, .LBB0_42
	b	.LBB0_44
.LBB0_41:                               #   in Loop: Header=BB0_20 Depth=4
	add.d	$a3, $a1, $a6
	add.d	$a4, $a0, $a6
	move	$a5, $a6
.LBB0_42:                               # %for.body.i31.preheader
                                        #   in Loop: Header=BB0_20 Depth=4
	add.d	$a0, $a5, $a0
	sub.d	$a0, $a0, $s0
	addi.w	$a0, $a0, 1
	.p2align	4, , 16
.LBB0_43:                               # %for.body.i31
                                        #   Parent Loop BB0_15 Depth=1
                                        #     Parent Loop BB0_16 Depth=2
                                        #       Parent Loop BB0_19 Depth=3
                                        #         Parent Loop BB0_20 Depth=4
...
.LBB0_45:                               # %for.end.i
	...
	ori	$a0, $zero, 2
	bne	$a2, $a0, .LBB0_47
# %bb.46:                               # %if.end114.thread.i
                                        #   in Loop: Header=BB0_20 Depth=4
	ld.d	$s0, $sp, 72                    # 8-byte Folded Reload
	st.w	$zero, $s0, %pc_lo12(yy_n_chars)
	st.w	$zero, $s7, 28
	beqz	$s6, .LBB0_66
	b	.LBB0_73
.LBB0_47:                               # %while.cond.preheader.i
                                        #   in Loop: Header=BB0_20 Depth=4
...
.LBB0_52:                               # %while.end.i
	...
	or	$s0, $a0, $a3
	beqz	$a1, .LBB0_60
# %bb.53:                               # %for.cond62.preheader.i
                                        #   in Loop: Header=BB0_20 Depth=4
	move	$fp, $zero
	bstrpick.d	$s7, $s0, 31, 0
	move	$s8, $s6
	.p2align	4, , 16
.LBB0_54:                               # %land.lhs.true.i
                                        #   Parent Loop BB0_15 Depth=1
                                        #     Parent Loop BB0_16 Depth=2
                                        #       Parent Loop BB0_19 Depth=3
                                        #         Parent Loop BB0_20 Depth=4
	...
	addi.w	$a1, $zero, -1
	beq	$a0, $a1, .LBB0_58
# %bb.55:                               # %land.lhs.true.i
                                        #   in Loop: Header=BB0_54 Depth=5
	ori	$a2, $zero, 10
	beq	$a0, $a2, .LBB0_58
# %bb.56:                               # %for.body70.i
                                        #   in Loop: Header=BB0_54 Depth=5
...
.LBB0_60:                               # %if.else98.i
	...
	addi.w	$a0, $a0, 0
	ld.d	$s0, $sp, 72                    # 8-byte Folded Reload
	st.w	$fp, $s0, %pc_lo12(yy_n_chars)
	bnez	$a0, .LBB0_84
# %bb.61:                               # %land.lhs.true107.i
                                        #   in Loop: Header=BB0_20 Depth=4
	ld.d	$a0, $s7, %pc_lo12(ia_in)
	pcaddu18i	$ra, %call36(ferror)
	jirl	$ra, $ra, 0
	bnez	$a0, .LBB0_120
# %bb.62:                               # %if.end114.thread61.i
                                        #   in Loop: Header=BB0_20 Depth=4
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
	ld.d	$s7, $a0, %pc_lo12(yy_current_buffer)
...
.LBB0_64:                               # %if.end114.i
	...
	st.w	$fp, $s7, 28
	bnez	$fp, .LBB0_83
# %bb.65:                               #   in Loop: Header=BB0_20 Depth=4
	ld.d	$fp, $sp, 24                    # 8-byte Folded Reload
	bnez	$s6, .LBB0_73
.LBB0_66:                               # %yy_get_next_buffer.exit.thread86
                                        #   in Loop: Header=BB0_20 Depth=4
	ld.d	$a0, $sp, 88                    # 8-byte Folded Reload
	ld.d	$a0, $a0, %pc_lo12(ia_in)
...
.LBB0_74:                               # %sw.bb109
	...
	st.d	$s1, $s4, %pc_lo12(yy_c_buf_p)
	bgeu	$a0, $s1, .LBB0_19
# %bb.75:                               # %for.body.i59.preheader
                                        #   in Loop: Header=BB0_19 Depth=3
	move	$a1, $a0
	b	.LBB0_78
	.p2align	4, , 16
.LBB0_76:                               # %cond.true.i65
                                        #   in Loop: Header=BB0_78 Depth=4
	slli.d	$a3, $a3, 2
	ldx.w	$a3, $s3, $a3
.LBB0_77:                               # %cond.end.i68
                                        #   in Loop: Header=BB0_78 Depth=4
	slli.d	$a4, $a2, 5
	alsl.d	$a2, $a2, $a4, 4
	add.d	$a2, $s5, $a2
...
.LBB0_87:                               # %sw.bb104
	...
	ori	$a5, $zero, 2
	blt	$a3, $a5, .LBB0_16
# %bb.88:                               # %for.body.i39.preheader
                                        #   in Loop: Header=BB0_16 Depth=2
	move	$a3, $zero
	b	.LBB0_91
	.p2align	4, , 16
.LBB0_89:                               # %cond.true.i45
                                        #   in Loop: Header=BB0_91 Depth=3
	slli.d	$a5, $a5, 2
	ldx.w	$a5, $s3, $a5
.LBB0_90:                               # %cond.end.i48
                                        #   in Loop: Header=BB0_91 Depth=3
	slli.d	$a6, $a1, 5
	alsl.d	$a1, $a1, $a6, 4
	add.d	$a1, $s5, $a1
...
.LBB0_97:                               # %sw.bb31
	ori	$a0, $zero, 265
	b	.LBB0_114
.LBB0_98:                               # %cleanup118.loopexit161
	ori	$a0, $zero, 260
	b	.LBB0_114
.LBB0_99:                               # %cleanup118.loopexit458
	ori	$a0, $zero, 262
	b	.LBB0_114
.LBB0_100:                              # %sw.bb35
	ori	$a0, $zero, 268
...
.LBB0_101:                              # %cleanup118.loopexit
	ori	$a0, $zero, 258
	b	.LBB0_114
.LBB0_102:                              # %cleanup118.loopexit311
	ori	$a0, $zero, 261
	b	.LBB0_114
.LBB0_103:                              # %sw.bb36
...
# %bb.105:                              # %if.end46
	...
	ori	$a0, $zero, 270
	b	.LBB0_114
.LBB0_106:                              # %cleanup118.loopexit111
	ori	$a0, $zero, 259
	b	.LBB0_114
.LBB0_107:                              # %cleanup118.loopexit720
	ori	$a0, $zero, 263
	b	.LBB0_114
.LBB0_108:                              # %sw.bb52
	ld.d	$a0, $fp, %pc_lo12(ia_text)
