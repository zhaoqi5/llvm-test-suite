...
.LBB3_13:                               # %if.end
	...
	ret
.LBB3_14:                               # %if.else.i
	pcalau12i	$a6, %got_pc_hi20(memory_BIGBLOCKS)
	ld.d	$a6, $a6, %got_pc_lo12(memory_BIGBLOCKS)
	st.d	$a5, $a6, 0
	bnez	$a5, .LBB3_9
	b	.LBB3_10
.Lfunc_end3:
...
# %bb.1:                                # %if.then
	...
	pcalau12i	$a0, %got_pc_hi20(symbol_Print)
	ld.d	$s5, $a0, %got_pc_lo12(symbol_Print)
