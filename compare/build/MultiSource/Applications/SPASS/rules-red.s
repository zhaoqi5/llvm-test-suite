...
# %bb.0:                                # %entry
	...
	ld.w	$a1, $a0, 0
	pcalau12i	$a2, %got_pc_hi20(fol_NOT)
	ld.d	$s3, $a2, %got_pc_lo12(fol_NOT)
	ld.w	$a2, $s3, 0
	bne	$a1, $a2, .LBB30_2
# %bb.1:                                # %if.then.i.i
	ld.d	$a0, $a0, 16
...
# %bb.115:                              # %if.then58.i
	...
	st.d	$zero, $s3, 32
	beqz	$s0, .LBB30_124
# %bb.116:                              # %for.body.i317.preheader
                                        #   in Loop: Header=BB30_37 Depth=1
	move	$s4, $s0
	b	.LBB30_119
	.p2align	4, , 16
...
.LBB30_130:                             # %for.end22.i
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB30_133
# %bb.131:                              # %for.body29.i330.preheader
                                        #   in Loop: Header=BB30_37 Depth=1
	move	$a1, $a0
	.p2align	4, , 16
.LBB30_132:                             # %for.body29.i330
                                        #   Parent Loop BB30_37 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.d	$zero, $a1, 8
	ld.d	$a1, $a1, 0
	bnez	$a1, .LBB30_132
.LBB30_133:                             # %for.end32.i335
                                        #   in Loop: Header=BB30_37 Depth=1
	ld.d	$a1, $s3, 40
	beqz	$a1, .LBB30_135
	.p2align	4, , 16
.LBB30_134:                             # %while.body.i.i338
                                        #   Parent Loop BB30_37 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a2, $s1, 128
	ld.w	$a3, $a2, 32
...
.LBB30_135:                             # %red_CRwCalculateAdditionalParents.exit
                                        #   in Loop: Header=BB30_37 Depth=1
	st.d	$a0, $s3, 40
.LBB30_136:                             # %red_CRwLitTautologyCheck.exit.thread306
                                        #   in Loop: Header=BB30_37 Depth=1
	move	$a0, $s0
	pcaddu18i	$ra, %call36(clause_DeleteClauseList)
	jirl	$ra, $ra, 0
