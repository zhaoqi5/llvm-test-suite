...
.LBB16_11:                              # %for.cond23.preheader.i
	...
	addi.w	$a3, $a0, -1
	blt	$a3, $a1, .LBB16_14
# %bb.12:                               # %for.body26.lr.ph.i
	addi.d	$fp, $a1, -1
	slli.d	$s2, $a1, 3
	.p2align	4, , 16
.LBB16_13:                              # %for.body26.i
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $s1, 56
	ldx.d	$a0, $a0, $s2
	ld.d	$a0, $a0, 24
...
.LBB16_16:                              # %while.body.i
	...
	ld.d	$s5, $s5, 0
	bnez	$s5, .LBB16_16
.LBB16_17:                              # %sort_TheoryLinkCreate.exit
	move	$a0, $s1
...
.LBB16_18:                              # %if.end
	...
	addi.d	$sp, $sp, 160
	ret
.LBB16_19:                              # %for.body37.lr.ph.i
	add.d	$a0, $a2, $a1
	addi.d	$s2, $a0, -1
	slli.d	$s3, $a0, 3
	b	.LBB16_21
	.p2align	4, , 16
.LBB16_20:                              # %for.inc45.i
...
.LBB33_2:                               # %sort_ComputeSortInternNoResidues.exit
	...
	ld.d	$s2, $a0, %got_pc_lo12(hash_TABLE)
	ldx.d	$s5, $s2, $s1
	ori	$a0, $zero, 16
	pcaddu18i	$ra, %call36(memory_Malloc)
	jirl	$ra, $ra, 0
...
# %bb.1:                                # %for.body.lr.ph
	...
	ld.w	$s2, $a0, 0
	pcalau12i	$a0, %got_pc_hi20(symbol_SIGNATURE)
	ld.d	$a3, $a0, %got_pc_lo12(symbol_SIGNATURE)
	ori	$a4, $zero, 1
	pcalau12i	$a0, %got_pc_hi20(fol_NOT)
	ld.d	$s0, $a0, %got_pc_lo12(fol_NOT)
	move	$a5, $zero
...
# %bb.0:                                # %entry
	...
	st.d	$a0, $sp, 24                    # 8-byte Folded Spill
	pcalau12i	$a0, %got_pc_hi20(symbol_ACTINDEX)
	ld.d	$s0, $a0, %got_pc_lo12(symbol_ACTINDEX)
	ld.w	$a0, $s0, 0
	ori	$s1, $zero, 2
	vrepli.b	$vr0, 0
...
.LBB39_53:                              #   in Loop: Header=BB39_20 Depth=2
	...
	b	.LBB39_40
	.p2align	4, , 16
.LBB39_54:                              #   in Loop: Header=BB39_18 Depth=1
	ori	$s7, $zero, 1
.LBB39_55:                              # %for.inc71
                                        #   in Loop: Header=BB39_18 Depth=1
	ld.d	$a0, $sp, 16                    # 8-byte Folded Reload
