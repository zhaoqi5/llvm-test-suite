...
.LBB20_6:                               # %for.body16.us.us
	...
	jirl	$ra, $ra, 0
	beqz	$s0, .LBB20_41
# %bb.7:                                # %for.body27.us.us.preheader
	...
	b	.LBB20_10
	.p2align	4, , 16
.LBB20_8:                               #   in Loop: Header=BB20_10 Depth=4
	move	$a2, $zero
	ld.d	$s4, $s4, 0
	beqz	$s4, .LBB20_39
.LBB20_9:                               # %cont_BackTrack.exit105.us.us
                                        #   in Loop: Header=BB20_10 Depth=4
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	beqz	$a0, .LBB20_39
.LBB20_10:                              # %for.body27.us.us
                                        #   Parent Loop BB20_3 Depth=1
                                        #     Parent Loop BB20_5 Depth=2
...
# %bb.11:                               # %if.then.us.us
	...
	blt	$a0, $s1, .LBB20_14
# %bb.12:                               # %while.body.i.us.us.preheader
                                        #   in Loop: Header=BB20_10 Depth=4
	addi.d	$a0, $a0, 1
	.p2align	4, , 16
.LBB20_13:                              # %while.body.i.us.us
                                        #   Parent Loop BB20_3 Depth=1
                                        #     Parent Loop BB20_5 Depth=2
                                        #       Parent Loop BB20_6 Depth=3
                                        #         Parent Loop BB20_10 Depth=4
	...
	st.w	$a1, $fp, 0
	bltu	$s1, $a0, .LBB20_13
.LBB20_14:                              # %while.end.i.us.us
                                        #   in Loop: Header=BB20_10 Depth=4
	ld.w	$a0, $s2, 0
	beqz	$a0, .LBB20_16
# %bb.15:                               # %if.then.i.us.us
                                        #   in Loop: Header=BB20_10 Depth=4
	addi.w	$a0, $a0, -1
	slli.d	$a1, $a0, 2
	...
	st.w	$a0, $s2, 0
	st.w	$a1, $fp, 0
.LBB20_16:                              # %cont_BackTrack.exit.us.us
                                        #   in Loop: Header=BB20_10 Depth=4
	ld.d	$a0, $s8, 8
	ld.d	$a0, $a0, 0
	pcaddu18i	$ra, %call36(term_Copy)
...
# %bb.19:                               # %if.then64.us.us
	...
	vld	$vr0, $sp, 96                   # 16-byte Folded Reload
	blt	$a0, $s1, .LBB20_22
# %bb.20:                               # %while.body.i81.us.us.preheader
                                        #   in Loop: Header=BB20_10 Depth=4
	addi.d	$a0, $a0, 1
	.p2align	4, , 16
.LBB20_21:                              # %while.body.i81.us.us
                                        #   Parent Loop BB20_3 Depth=1
                                        #     Parent Loop BB20_5 Depth=2
                                        #       Parent Loop BB20_6 Depth=3
                                        #         Parent Loop BB20_10 Depth=4
	...
	st.w	$a1, $fp, 0
	bltu	$s1, $a0, .LBB20_21
.LBB20_22:                              # %while.end.i75.us.us
                                        #   in Loop: Header=BB20_10 Depth=4
	ld.w	$a1, $s2, 0
	ld.d	$s8, $sp, 56                    # 8-byte Folded Reload
	ld.d	$a0, $sp, 80                    # 8-byte Folded Reload
	beqz	$a1, .LBB20_24
# %bb.23:                               # %if.then.i77.us.us
                                        #   in Loop: Header=BB20_10 Depth=4
	addi.w	$a3, $a1, -1
	slli.d	$a1, $a3, 2
	ld.d	$a2, $sp, 128                   # 8-byte Folded Reload
	...
	st.w	$a3, $s2, 0
	st.w	$a1, $fp, 0
.LBB20_24:                              # %cont_BackTrack.exit87.us.us
                                        #   in Loop: Header=BB20_10 Depth=4
	move	$a1, $s7
...
# %bb.26:                               # %if.then76.us.us
	...
	b	.LBB20_31
	.p2align	4, , 16
.LBB20_27:                              #   in Loop: Header=BB20_10 Depth=4
	move	$s8, $s2
	ld.d	$s2, $sp, 64                    # 8-byte Folded Reload
	b	.LBB20_32
.LBB20_28:                              # %if.then46.us.us
                                        #   in Loop: Header=BB20_10 Depth=4
	ld.w	$a1, $s6, 0
	ld.d	$a0, $s7, 16
	ld.d	$a2, $sp, 112                   # 8-byte Folded Reload
...
# %bb.29:                               # %if.then53.us.us
	...
	jirl	$ra, $ra, 0
	b	.LBB20_32
.LBB20_30:                              #   in Loop: Header=BB20_10 Depth=4
	ld.d	$s8, $sp, 40                    # 8-byte Folded Reload
.LBB20_31:                              # %if.end83.us.us
                                        #   in Loop: Header=BB20_10 Depth=4
	ld.d	$a0, $sp, 72                    # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(term_Delete)
	jirl	$ra, $ra, 0
.LBB20_32:                              # %if.end85.us.us
                                        #   in Loop: Header=BB20_10 Depth=4
	move	$a0, $s6
	pcaddu18i	$ra, %call36(term_Delete)
	jirl	$ra, $ra, 0
.LBB20_33:                              # %if.end86.us.us
                                        #   in Loop: Header=BB20_10 Depth=4
	vld	$vr0, $sp, 96                   # 16-byte Folded Reload
	ld.w	$a1, $fp, 0
	blt	$a1, $s1, .LBB20_37
# %bb.34:                               # %while.body.i99.us.us.preheader
                                        #   in Loop: Header=BB20_10 Depth=4
	addi.d	$a0, $a1, 1
	.p2align	4, , 16
.LBB20_35:                              # %while.body.i99.us.us
                                        #   Parent Loop BB20_3 Depth=1
                                        #     Parent Loop BB20_5 Depth=2
                                        #       Parent Loop BB20_6 Depth=3
                                        #         Parent Loop BB20_10 Depth=4
	...
	st.w	$a1, $fp, 0
	bltu	$s1, $a0, .LBB20_35
# %bb.36:                               #   in Loop: Header=BB20_10 Depth=4
	move	$a1, $zero
.LBB20_37:                              # %while.end.i93.us.us
                                        #   in Loop: Header=BB20_10 Depth=4
	ld.w	$a0, $s2, 0
	beqz	$a0, .LBB20_8
# %bb.38:                               # %if.then.i95.us.us
                                        #   in Loop: Header=BB20_10 Depth=4
	addi.w	$a2, $a0, -1
	slli.d	$a0, $a2, 2
	...
	bnez	$s4, .LBB20_9
	.p2align	4, , 16
.LBB20_39:                              # %while.body.i106.us.us
                                        #   Parent Loop BB20_3 Depth=1
                                        #     Parent Loop BB20_5 Depth=2
                                        #       Parent Loop BB20_6 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
	...
	move	$s0, $a5
	bnez	$a5, .LBB20_39
# %bb.40:                               #   in Loop: Header=BB20_6 Depth=3
	ld.d	$s4, $sp, 24                    # 8-byte Folded Reload
.LBB20_41:                              # %list_Delete.exit.us.us
                                        #   in Loop: Header=BB20_6 Depth=3
	ld.d	$s4, $s4, 0
	beqz	$s4, .LBB20_43
# %bb.42:                               # %list_Delete.exit.us.us
                                        #   in Loop: Header=BB20_6 Depth=3
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	bnez	$a0, .LBB20_6
.LBB20_43:                              # %for.cond10.for.end91_crit_edge.us.us
	...
	ld.d	$s8, $s8, 0
	beqz	$s8, .LBB20_45
# %bb.44:                               # %for.cond10.for.end91_crit_edge.us.us
                                        #   in Loop: Header=BB20_5 Depth=2
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	bnez	$a0, .LBB20_5
.LBB20_45:                              # %for.cond.while.cond.loopexit_crit_edge.us
                                        #   in Loop: Header=BB20_3 Depth=1
	ld.d	$s0, $sp, 8                     # 8-byte Folded Reload
	ld.d	$a0, $sp, 48                    # 8-byte Folded Reload
	beqz	$a0, .LBB20_48
# %bb.46:                               # %for.cond.while.cond.loopexit_crit_edge.us
                                        #   in Loop: Header=BB20_3 Depth=1
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	bnez	$a0, .LBB20_3
	b	.LBB20_48
	.p2align	4, , 16
.LBB20_47:                              # %for.body.us129
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $s0, 8
	ld.d	$a0, $a0, 8
	pcaddu18i	$ra, %call36(term_Copy)
