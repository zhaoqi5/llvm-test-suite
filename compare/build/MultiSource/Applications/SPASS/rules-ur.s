...
.LBB0_15:                               # %cont_Reset.exit
	...
	ld.d	$a2, $a0, %got_pc_lo12(cont_INDEXVARSCANNER)
	ld.d	$a0, $sp, 168
	st.w	$zero, $s8, 0
	ori	$a3, $zero, 1
	st.w	$a3, $a1, 0
...
# %bb.0:                                # %entry
	...
	ld.d	$a4, $a4, %got_pc_lo12(cont_LEFTCONTEXT)
	pcalau12i	$a5, %got_pc_hi20(cont_RIGHTCONTEXT)
	ld.d	$a5, $a5, %got_pc_lo12(cont_RIGHTCONTEXT)
	ld.d	$a4, $a4, 0
	ld.d	$a5, $a5, 0
	move	$s1, $a2
	move	$fp, $a1
...
# %bb.5:                                # %if.then.us
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB2_3
# %bb.6:                                # %for.body15.us15.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	move	$s2, $a0
	ld.w	$a1, $s3, 0
	b	.LBB2_8
...
.LBB2_8:                                # %for.body15.us15
	...
	add.w	$a0, $a3, $a0
	bne	$a6, $a1, .LBB2_10
# %bb.9:                                # %land.lhs.true.i.us31
                                        #   in Loop: Header=BB2_8 Depth=2
	bne	$a2, $a1, .LBB2_11
	b	.LBB2_7
	.p2align	4, , 16
.LBB2_10:                               # %lor.rhs.i.us30
                                        #   in Loop: Header=BB2_8 Depth=2
	bne	$a2, $a1, .LBB2_7
.LBB2_11:                               # %lor.rhs.i.us30
                                        #   in Loop: Header=BB2_8 Depth=2
	bne	$a0, $s6, .LBB2_7
# %bb.12:                               # %if.then26.us34
                                        #   in Loop: Header=BB2_8 Depth=2
	ori	$a0, $zero, 16
	pcaddu18i	$ra, %call36(memory_Malloc)
	jirl	$ra, $ra, 0
...
.LBB2_21:                               # %for.body15.us
	...
	add.w	$a0, $a3, $a0
	bne	$a6, $a1, .LBB2_23
# %bb.22:                               # %land.lhs.true.i.us
                                        #   in Loop: Header=BB2_21 Depth=2
	bne	$a2, $a1, .LBB2_24
	b	.LBB2_20
	.p2align	4, , 16
.LBB2_23:                               # %lor.rhs.i.us
                                        #   in Loop: Header=BB2_21 Depth=2
	bne	$a2, $a1, .LBB2_20
.LBB2_24:                               # %lor.rhs.i.us
                                        #   in Loop: Header=BB2_21 Depth=2
	beq	$a0, $s6, .LBB2_20
# %bb.25:                               # %if.then26.us
                                        #   in Loop: Header=BB2_21 Depth=2
...
# %bb.1:                                # %if.else
	...
	ld.d	$a1, $s5, 128
	pcalau12i	$a2, %got_pc_hi20(memory_FREEDBYTES)
	ld.d	$s8, $a2, %got_pc_lo12(memory_FREEDBYTES)
	ld.w	$a2, $a1, 32
	ld.d	$a3, $s8, 0
	ld.d	$a5, $a0, 8
	ld.d	$a4, $a0, 0
...
# %bb.9:                                # %if.then.i47
	...
	ld.d	$a0, $a0, 16
	ld.d	$a0, $a0, 8
.LBB3_10:                               # %clause_LiteralAtom.exit50
                                        #   in Loop: Header=BB3_8 Depth=2
	pcaddu18i	$ra, %call36(term_Copy)
	jirl	$ra, $ra, 0
	move	$s2, $a0
...
# %bb.27:                               # %if.then.i.i.i
	ld.d	$a0, $a0, 16
	ld.d	$a0, $a0, 8
.LBB3_28:                               # %clause_GetLiteralAtom.exit.i
	pcaddu18i	$ra, %call36(term_Copy)
	jirl	$ra, $ra, 0
	move	$a1, $a0
	move	$a0, $fp
...
.LBB3_39:                               # %while.cond.i.i
	...
	addi.d	$a1, $a1, 8
	bne	$a2, $s6, .LBB3_39
# %bb.40:                               # %clause_LiteralGetIndex.exit.i
...
.LBB3_41:                               # %while.cond.i58.i
	...
	addi.d	$a1, $a1, 8
	bne	$a2, $s6, .LBB3_41
# %bb.42:                               # %clause_LiteralGetIndex.exit63.i
                                        #   in Loop: Header=BB3_38 Depth=1
	ld.d	$s6, $s1, 40
	srai.d	$s7, $a0, 32
	ori	$a0, $zero, 16
...
# %bb.50:                               # %if.else25.i.i.i
	...
	st.d	$a0, $a1, 0
	b	.LBB3_58
.LBB3_51:                               # %if.end29.i.i
	move	$a0, $s2
	bnez	$a1, .LBB3_59
	b	.LBB3_63
.LBB3_52:                               # %if.then.i.i72.i
	...
	add.w	$a1, $a5, $a1
	beqz	$a4, .LBB3_69
# %bb.53:                               # %if.then3.i.i.i
	st.d	$a3, $a4, 8
	beqz	$a3, .LBB3_55
.LBB3_54:                               # %if.then9.i.i.i
	ld.d	$a2, $a2, -16
	st.d	$a2, $a3, 0
.LBB3_55:                               # %if.end13.i.i.i
	...
	st.d	$a4, $s4, 0
	bltz	$a1, .LBB3_57
# %bb.56:                               # %if.then18.i.i.i
	add.d	$a1, $a1, $a3
	st.d	$a1, $a2, 0
.LBB3_57:                               # %if.end23.i.i.i
	addi.d	$a0, $a0, -16
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB3_58:                               # %if.end29.thread.i.i
	slli.w	$a0, $fp, 3
	pcaddu18i	$ra, %call36(memory_Malloc)
	jirl	$ra, $ra, 0
	st.d	$a0, $s1, 16
	st.w	$fp, $s1, 24
.LBB3_59:                               # %for.body.lr.ph.i.i
	move	$a0, $zero
	move	$a1, $zero
	.p2align	4, , 16
...
# %bb.61:
	...
	b	.LBB3_63
	.p2align	4, , 16
.LBB3_62:                               # %while.cond34.loopexit.i.i
                                        #   in Loop: Header=BB3_63 Depth=1
	beqz	$a0, .LBB3_66
.LBB3_63:                               # %while.body38.i.i
                                        # =>This Loop Header: Depth=1
	...
	ld.d	$a0, $a0, 0
	beqz	$a2, .LBB3_62
# %bb.64:                               # %for.body45.lr.ph.i.i
                                        #   in Loop: Header=BB3_63 Depth=1
	move	$a2, $zero
	move	$a3, $zero
	.p2align	4, , 16
.LBB3_65:                               # %for.body45.i.i
...
.LBB3_66:                               # %while.body.i77.i
	...
	move	$s2, $a3
	bnez	$a3, .LBB3_66
# %bb.67:                               # %inf_CreateURUnitResolvent.exit
	ori	$a0, $zero, 16
	pcaddu18i	$ra, %call36(memory_Malloc)
	jirl	$ra, $ra, 0
	move	$s2, $a0
