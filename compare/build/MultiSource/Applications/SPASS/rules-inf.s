...
# %bb.3:                                # %for.body.lr.ph
	...
	ld.d	$a6, $a0, %got_pc_lo12(fol_EQUALITY)
...
# %bb.14:                               # %if.then.i.i62
	...
	ld.d	$a0, $fp, 16
	ld.d	$fp, $a0, 8
.LBB0_15:                               # %clause_GetLiteralAtom.exit
                                        #   in Loop: Header=BB0_6 Depth=1
...
.LBB3_33:                               # %if.end55
	...
	beqz	$a0, .LBB3_36
# %bb.34:                               # %while.body.preheader.i117
                                        #   in Loop: Header=BB3_17 Depth=2
	ld.w	$a1, $s0, 0
	addi.d	$a1, $a1, -1
	.p2align	4, , 16
.LBB3_35:                               # %while.body.i119
                                        #   Parent Loop BB3_8 Depth=1
                                        #     Parent Loop BB3_17 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
...
.LBB6_11:                               # %for.body
                                        ...
                                        #             Child Loop BB6_64 Depth 6
                                        #             Child Loop BB6_78 Depth 6
...
# %bb.27:                               # %if.end.i66
	...
	beqz	$fp, .LBB6_101
# %bb.28:                               # %for.cond.i68.preheader
                                        #   in Loop: Header=BB6_11 Depth=1
	move	$a1, $a4
	ld.d	$a6, $sp, 224                   # 8-byte Folded Reload
	ld.d	$a3, $sp, 144                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB6_29:                               # %for.cond.i68
                                        #   Parent Loop BB6_11 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$a0, $a1
	ld.d	$a1, $a1, 0
...
# %bb.35:                               # %if.then.i.i
	...
	ld.d	$a2, $a0, 8
	ld.w	$a0, $a2, 0
.LBB6_36:                               # %clause_LiteralAtom.exit.i
                                        #   in Loop: Header=BB6_11 Depth=1
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	ld.w	$a1, $a1, 0
	bne	$a0, $a1, .LBB6_44
...
# %bb.45:                               #   in Loop: Header=BB6_11 Depth=1
	...
	ld.d	$a7, $sp, 208                   # 8-byte Folded Reload
	b	.LBB6_10
.LBB6_46:                               # %while.body.i.i.preheader
                                        #   in Loop: Header=BB6_11 Depth=1
...
.LBB6_47:                               #   in Loop: Header=BB6_49 Depth=2
	...
	ld.d	$a7, $sp, 208                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB6_48:                               # %if.end107.i.i
                                        #   in Loop: Header=BB6_49 Depth=2
	ld.d	$fp, $sp, 72                    # 8-byte Folded Reload
	ld.w	$a0, $fp, 0
	ld.d	$a1, $sp, 80                    # 8-byte Folded Reload
	beq	$a0, $a1, .LBB6_96
.LBB6_49:                               # %while.body.i.i
                                        #   Parent Loop BB6_11 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB6_53 Depth 3
                                        #         Child Loop BB6_56 Depth 4
...
.LBB6_53:                               # %for.body.i.i
	...
	bnez	$s4, .LBB6_56
	b	.LBB6_52
.LBB6_54:                               #   in Loop: Header=BB6_56 Depth=4
	ld.d	$a6, $sp, 224                   # 8-byte Folded Reload
	ld.d	$a7, $sp, 208                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB6_55:                               # %for.inc101.i.i
                                        #   in Loop: Header=BB6_56 Depth=4
	ld.d	$s4, $s4, 0
	beqz	$s4, .LBB6_52
.LBB6_56:                               # %for.body20.i.i
                                        #   Parent Loop BB6_11 Depth=1
                                        #     Parent Loop BB6_49 Depth=2
...
# %bb.57:                               # %if.then24.i.i
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB6_54
# %bb.58:                               # %for.body30.lr.ph.i.i
                                        #   in Loop: Header=BB6_56 Depth=4
	move	$s7, $a0
	ld.d	$a6, $sp, 224                   # 8-byte Folded Reload
	ld.d	$a7, $sp, 208                   # 8-byte Folded Reload
	b	.LBB6_63
.LBB6_59:                               #   in Loop: Header=BB6_63 Depth=5
	ld.d	$s2, $sp, 184                   # 8-byte Folded Reload
.LBB6_60:                               # %if.end97.i.i
                                        #   in Loop: Header=BB6_63 Depth=5
	ld.d	$a0, $sp, 240
	pcaddu18i	$ra, %call36(subst_Delete)
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 232
...
.LBB6_62:                               # %for.inc.i.i
	...
	ld.d	$s7, $s7, 0
	beqz	$s7, .LBB6_55
.LBB6_63:                               # %for.body30.i.i
                                        #   Parent Loop BB6_11 Depth=1
                                        #     Parent Loop BB6_49 Depth=2
                                        #       Parent Loop BB6_53 Depth=3
                                        #         Parent Loop BB6_56 Depth=4
	...
	addi.d	$s5, $zero, -1
	.p2align	4, , 16
.LBB6_64:                               # %while.cond.i.i.i
                                        #   Parent Loop BB6_11 Depth=1
                                        #     Parent Loop BB6_49 Depth=2
                                        #       Parent Loop BB6_53 Depth=3
                                        #         Parent Loop BB6_56 Depth=4
                                        #           Parent Loop BB6_63 Depth=5
                                        # =>          This Inner Loop Header: Depth=6
	ld.d	$a1, $a0, 0
	addi.w	$s5, $s5, 1
	addi.d	$a0, $a0, 8
	bne	$a1, $s8, .LBB6_64
# %bb.65:                               # %clause_LiteralGetIndex.exit.i.i
                                        #   in Loop: Header=BB6_63 Depth=5
	ld.bu	$a0, $fp, 48
	andi	$a0, $a0, 2
	bnez	$a0, .LBB6_62
# %bb.66:                               # %land.lhs.true.i.i
                                        #   in Loop: Header=BB6_63 Depth=5
	beqz	$s3, .LBB6_68
# %bb.67:                               # %lor.lhs.false.i.i
	...
	andi	$a0, $a0, 2
	beqz	$a0, .LBB6_62
.LBB6_68:                               # %land.lhs.true39.i.i
                                        #   in Loop: Header=BB6_63 Depth=5
	beqz	$s2, .LBB6_71
# %bb.69:                               # %lor.lhs.false41.i.i
                                        #   in Loop: Header=BB6_63 Depth=5
	ld.d	$a0, $s1, 16
	ld.d	$a0, $a0, 8
	beq	$s0, $a0, .LBB6_71
# %bb.70:                               # %lor.lhs.false43.i.i
                                        #   in Loop: Header=BB6_63 Depth=5
	ld.w	$a0, $s8, 8
	bnez	$a0, .LBB6_62
	.p2align	4, , 16
.LBB6_71:                               # %land.lhs.true46.i.i
                                        #   in Loop: Header=BB6_63 Depth=5
	ld.d	$a0, $s8, 24
	ld.w	$a0, $a0, 0
	ld.w	$a1, $a7, 0
	beq	$a0, $a1, .LBB6_62
# %bb.72:                               # %land.lhs.true49.i.i
                                        #   in Loop: Header=BB6_63 Depth=5
	ld.w	$a0, $fp, 0
	ld.w	$a1, $a6, 0
	beq	$a0, $a1, .LBB6_62
# %bb.73:                               # %land.lhs.true53.i.i
                                        #   in Loop: Header=BB6_63 Depth=5
	beqz	$s6, .LBB6_75
# %bb.74:                               # %lor.lhs.false55.i.i
                                        #   in Loop: Header=BB6_63 Depth=5
	ld.w	$a0, $fp, 64
	ld.w	$a1, $fp, 68
	ld.w	$a2, $fp, 72
...
# %bb.76:                               # %if.then61.i.i
	...
	vld	$vr0, $sp, 112                  # 16-byte Folded Reload
	beqz	$a1, .LBB6_79
# %bb.77:                               # %while.body.preheader.i.i.i
                                        #   in Loop: Header=BB6_63 Depth=5
...
# %bb.81:                               # %land.lhs.true.i.i.i
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB6_59
.LBB6_82:                               # %if.end.i.i.i
                                        #   in Loop: Header=BB6_63 Depth=5
	ld.bu	$a0, $fp, 48
	andi	$a0, $a0, 2
	bnez	$a0, .LBB6_84
# %bb.83:                               # %land.lhs.true6.i.i.i
                                        #   in Loop: Header=BB6_63 Depth=5
	ld.w	$a0, $fp, 64
	ld.w	$a1, $fp, 68
	add.d	$a0, $a0, $a1
...
.LBB6_86:                               # %if.end.i40.i
	...
	ld.d	$s2, $sp, 184                   # 8-byte Folded Reload
	beqz	$s2, .LBB6_90
# %bb.87:                               # %lor.lhs.false85.i.i
                                        #   in Loop: Header=BB6_63 Depth=5
	ld.w	$a0, $s8, 8
	bnez	$a0, .LBB6_90
# %bb.88:                               # %lor.lhs.false88.i.i
                                        #   in Loop: Header=BB6_63 Depth=5
	...
	ori	$a1, $zero, 1
	bne	$a0, $a1, .LBB6_90
# %bb.89:                               #   in Loop: Header=BB6_63 Depth=5
	move	$s8, $s3
	ld.d	$s3, $sp, 104                   # 8-byte Folded Reload
	b	.LBB6_93
.LBB6_90:                               # %if.then92.i.i
                                        #   in Loop: Header=BB6_63 Depth=5
	ld.d	$s2, $sp, 240
...
# %bb.91:                               # %if.then.i.i.i
	...
	jirl	$ra, $ra, 0
	move	$s6, $zero
.LBB6_92:                               # %inf_AllTermsRplac.exit.i.i
                                        #   in Loop: Header=BB6_63 Depth=5
	ld.d	$s2, $sp, 184                   # 8-byte Folded Reload
	ld.d	$s3, $sp, 104                   # 8-byte Folded Reload
	ld.d	$a2, $sp, 232
...
.LBB6_93:                               # %if.end96.i.i
	...
	ld.d	$s6, $sp, 200                   # 8-byte Folded Reload
	b	.LBB6_60
.LBB6_94:                               #   in Loop: Header=BB6_11 Depth=1
	ld.d	$a6, $sp, 224                   # 8-byte Folded Reload
.LBB6_95:                               # %inf_GenSPRightToGiven.exit
                                        #   in Loop: Header=BB6_11 Depth=1
	ld.d	$a7, $sp, 208                   # 8-byte Folded Reload
.LBB6_96:                               # %inf_GenSPRightToGiven.exit
                                        #   in Loop: Header=BB6_11 Depth=1
	ld.d	$a1, $sp, 152                   # 8-byte Folded Reload
	move	$a0, $a1
	ld.d	$a3, $sp, 144                   # 8-byte Folded Reload
...
# %bb.97:                               # %if.end.i82
                                        #   in Loop: Header=BB6_11 Depth=1
	beqz	$a4, .LBB6_10
.LBB6_98:                               # %for.cond.i84.preheader
                                        #   in Loop: Header=BB6_11 Depth=1
	move	$a2, $a0
	.p2align	4, , 16
.LBB6_99:                               # %for.cond.i84
                                        #   Parent Loop BB6_11 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$a1, $a2
	ld.d	$a2, $a2, 0
...
.LBB6_101:                              #   in Loop: Header=BB6_11 Depth=1
	...
	bnez	$a0, .LBB6_9
	b	.LBB6_34
.LBB6_102:                              #   in Loop: Header=BB6_11 Depth=1
	ld.d	$a6, $sp, 224                   # 8-byte Folded Reload
	ld.d	$a3, $sp, 144                   # 8-byte Folded Reload
	ld.d	$a4, $sp, 48                    # 8-byte Folded Reload
	bnez	$a4, .LBB6_98
...
# %bb.0:                                # %entry
	...
	pcalau12i	$t0, %got_pc_hi20(cont_LEFTCONTEXT)
	ld.d	$t1, $t0, %got_pc_lo12(cont_LEFTCONTEXT)
	pcalau12i	$t0, %got_pc_hi20(cont_RIGHTCONTEXT)
	ld.d	$t2, $t0, %got_pc_lo12(cont_RIGHTCONTEXT)
...
# %bb.7:                                # %for.body17.preheader
	...
	b	.LBB7_14
.LBB7_8:                                #   in Loop: Header=BB7_14 Depth=2
...
# %bb.15:                               # %if.then.i
	...
	ld.d	$a2, $fp, 16
	ld.d	$fp, $a2, 8
.LBB7_16:                               # %clause_LiteralAtom.exit
                                        #   in Loop: Header=BB7_14 Depth=2
	ld.d	$s3, $s8, 16
	ld.d	$a2, $s3, 56
	move	$s0, $s2
	.p2align	4, , 16
.LBB7_17:                               # %while.cond.i
                                        #   Parent Loop BB7_3 Depth=1
...
# %bb.22:                               # %lor.lhs.false
	...
	bnez	$a0, .LBB7_25
	b	.LBB7_13
.LBB7_23:                               # %land.lhs.true28
                                        #   in Loop: Header=BB7_14 Depth=2
	beq	$a0, $a1, .LBB7_13
# %bb.24:                               # %land.lhs.true28
                                        #   in Loop: Header=BB7_14 Depth=2
	bnez	$a2, .LBB7_13
.LBB7_25:                               # %land.lhs.true34
                                        #   in Loop: Header=BB7_14 Depth=2
	move	$a0, $s3
	pcaddu18i	$ra, %call36(clause_HasSolvedConstraint)
	jirl	$ra, $ra, 0
...
# %bb.40:                               # %if.then.i.i
	...
	ld.d	$a0, $a0, 8
	ld.w	$a0, $a0, 0
.LBB7_41:                               # %clause_LiteralIsPredicate.exit
                                        #   in Loop: Header=BB7_14 Depth=2
...
# %bb.55:                               # %if.then7.i.i108
	...
	jirl	$ra, $ra, 0
	b	.LBB7_64
.LBB7_56:                               #   in Loop: Header=BB7_14 Depth=2
	ld.d	$s5, $sp, 232                   # 8-byte Folded Reload
	b	.LBB7_38
.LBB7_57:                               #   in Loop: Header=BB7_14 Depth=2
	ld.d	$s5, $sp, 232                   # 8-byte Folded Reload
.LBB7_58:                               # %if.end89.thread
                                        #   in Loop: Header=BB7_14 Depth=2
	move	$a0, $fp
	pcaddu18i	$ra, %call36(term_Delete)
	jirl	$ra, $ra, 0
...
.LBB8_8:                                # %for.body.lr.ph
	...
	ld.d	$s6, $a4, %got_pc_lo12(fol_EQUALITY)
	move	$s4, $zero
	add.d	$s3, $a0, $a1
	add.w	$s7, $a3, $a2
	b	.LBB8_11
...
# %bb.0:                                # %entry
	...
	ld.d	$a1, $a0, %got_pc_lo12(cont_LEFTCONTEXT)
	pcalau12i	$a0, %got_pc_hi20(cont_RIGHTCONTEXT)
	ld.d	$a4, $a0, %got_pc_lo12(cont_RIGHTCONTEXT)
	sltui	$s1, $a2, 1
	st.d	$a1, $sp, 120                   # 8-byte Folded Spill
	ld.d	$a0, $a1, 0
...
# %bb.1:                                # %if.end
	...
	ld.d	$s3, $a3, %got_pc_lo12(stack_POINTER)
	ld.d	$fp, $a0, 8
	ld.d	$s0, $a1, 8
	sltui	$s1, $a2, 1
	ld.w	$s4, $s3, 0
...
.LBB14_6:                               # %for.body.lr.ph
	...
	pcalau12i	$a0, %got_pc_hi20(cont_RIGHTCONTEXT)
	ld.d	$s4, $a0, %got_pc_lo12(cont_RIGHTCONTEXT)
	ori	$s6, $zero, 1
	vrepli.b	$vr0, 0
	move	$a2, $a5
	st.d	$fp, $sp, 128                   # 8-byte Folded Spill
...
# %bb.1:                                # %for.body.lr.ph
	...
	pcalau12i	$a0, %got_pc_hi20(cont_LEFTCONTEXT)
	ld.d	$a4, $a0, %got_pc_lo12(cont_LEFTCONTEXT)
	pcalau12i	$a0, %got_pc_hi20(cont_RIGHTCONTEXT)
...
# %bb.7:                                # %for.body17.preheader
	...
	b	.LBB19_14
.LBB19_8:                               #   in Loop: Header=BB19_14 Depth=2
...
# %bb.15:                               # %if.then.i
	...
	ld.d	$a2, $fp, 16
	ld.d	$fp, $a2, 8
.LBB19_16:                              # %clause_LiteralAtom.exit
                                        #   in Loop: Header=BB19_14 Depth=2
	ld.d	$s3, $s5, 16
	ld.d	$a2, $s3, 56
	move	$s0, $s7
	.p2align	4, , 16
.LBB19_17:                              # %while.cond.i
                                        #   Parent Loop BB19_3 Depth=1
...
# %bb.22:                               # %land.lhs.true34
	...
	b	.LBB19_25
	.p2align	4, , 16
.LBB19_23:                              # %land.lhs.true31
                                        #   in Loop: Header=BB19_14 Depth=2
	bne	$a0, $a1, .LBB19_13
# %bb.24:                               # %land.lhs.true31.land.lhs.true34_crit_edge
                                        #   in Loop: Header=BB19_14 Depth=2
	ld.w	$a2, $s3, 48
	andi	$a0, $a2, 32
	bnez	$a0, .LBB19_13
.LBB19_25:                              # %land.lhs.true37
                                        #   in Loop: Header=BB19_14 Depth=2
	move	$a0, $s3
	pcaddu18i	$ra, %call36(clause_HasSolvedConstraint)
	jirl	$ra, $ra, 0
...
# %bb.35:                               # %land.lhs.true55
	...
	ld.d	$a2, $sp, 248                   # 8-byte Folded Reload
	beqz	$a0, .LBB19_45
# %bb.36:                               #   in Loop: Header=BB19_14 Depth=2
	ld.d	$a0, $sp, 224                   # 8-byte Folded Reload
	st.d	$a0, $sp, 192                   # 8-byte Folded Spill
	ld.d	$s2, $sp, 208                   # 8-byte Folded Reload
	bnez	$s1, .LBB19_38
	b	.LBB19_52
.LBB19_37:                              #   in Loop: Header=BB19_14 Depth=2
	ld.d	$a0, $sp, 224                   # 8-byte Folded Reload
	st.d	$a0, $sp, 192                   # 8-byte Folded Spill
	ld.d	$s2, $sp, 208                   # 8-byte Folded Reload
	ld.d	$a2, $sp, 248                   # 8-byte Folded Reload
	beqz	$s1, .LBB19_52
.LBB19_38:                              # %lor.lhs.false70
                                        #   in Loop: Header=BB19_14 Depth=2
	ld.d	$a1, $s5, 24
	ld.w	$a0, $a1, 0
	ld.w	$a2, $a2, 0
...
# %bb.39:                               # %if.then.i.i
	...
	ld.d	$a0, $a0, 8
	ld.w	$a0, $a0, 0
.LBB19_40:                              # %clause_LiteralIsPredicate.exit
                                        #   in Loop: Header=BB19_14 Depth=2
	pcalau12i	$a1, %got_pc_hi20(fol_EQUALITY)
	ld.d	$a1, $a1, %got_pc_lo12(fol_EQUALITY)
	ld.w	$a1, $a1, 0
...
# %bb.43:                               # %if.end92.thread155
	...
	b	.LBB19_54
.LBB19_44:                              #   in Loop: Header=BB19_14 Depth=2
	ld.d	$s2, $sp, 208                   # 8-byte Folded Reload
	b	.LBB19_11
.LBB19_45:                              # %if.end
                                        #   in Loop: Header=BB19_14 Depth=2
...
# %bb.46:                               # %lor.lhs.false64
	...
	ori	$a1, $zero, 1
	beq	$a0, $a1, .LBB19_8
# %bb.47:                               #   in Loop: Header=BB19_14 Depth=2
...
# %bb.50:                               # %sw.bb
	...
	ld.d	$a0, $a1, 8
	b	.LBB19_59
.LBB19_51:                              #   in Loop: Header=BB19_14 Depth=2
	ld.d	$s2, $sp, 208                   # 8-byte Folded Reload
	ld.d	$s7, $sp, 200                   # 8-byte Folded Reload
	ld.d	$a2, $sp, 248                   # 8-byte Folded Reload
	bnez	$s1, .LBB19_38
...
.LBB19_55:                              # %if.end98
	...
	beqz	$s5, .LBB19_9
	b	.LBB19_10
.LBB19_56:                              #   in Loop: Header=BB19_14 Depth=2
	ld.d	$s1, $sp, 56                    # 8-byte Folded Reload
	ld.d	$s5, $sp, 216                   # 8-byte Folded Reload
.LBB19_57:                              # %if.end92.thread
                                        #   in Loop: Header=BB19_14 Depth=2
	move	$a0, $fp
	pcaddu18i	$ra, %call36(term_Delete)
	jirl	$ra, $ra, 0
...
# %bb.6:                                # %while.body.preheader
	...
	move	$a0, $zero
	pcalau12i	$a1, %got_pc_hi20(stack_STACK)
	ld.d	$s4, $a1, %got_pc_lo12(stack_STACK)
	addi.w	$a1, $a3, 1
	st.w	$a1, $s3, 0
	slli.d	$a4, $a3, 3
	stx.d	$a2, $s4, $a4
...
.LBB26_3:                               # %if.end.i
	...
	or	$a2, $a0, $a1
	bnez	$a2, .LBB26_5
.LBB26_4:                               # %clause_SetSplitDataFromParents.exit
	ld.w	$a0, $s3, 8
	ld.w	$a1, $s1, 8
	pcaddu18i	$ra, %call36(misc_Max)
	jirl	$ra, $ra, 0
...
# %bb.13:                               # %if.then3.i.i
	st.d	$a3, $a4, 8
	beqz	$a3, .LBB26_15
.LBB26_14:                              # %if.then9.i.i
	ld.d	$a2, $a2, -16
	st.d	$a2, $a3, 0
.LBB26_15:                              # %if.end13.i.i
	pcalau12i	$a2, %got_pc_hi20(memory_MARKSIZE)
	ld.d	$a2, $a2, %got_pc_lo12(memory_MARKSIZE)
	ld.w	$a3, $a2, 0
	pcalau12i	$a2, %got_pc_hi20(memory_FREEDBYTES)
...
.LBB26_20:                              # %for.body.i
	...
	addi.d	$a1, $a1, 8
	bltu	$a2, $a0, .LBB26_20
# %bb.21:                               # %for.cond41.preheader.loopexit.i
	ld.w	$a1, $s3, 24
	addi.w	$a2, $a0, 0
	bgeu	$a2, $a1, .LBB26_4
	b	.LBB26_23
.LBB26_22:
	...
	addi.w	$a2, $a0, 0
	bgeu	$a2, $a1, .LBB26_4
.LBB26_23:                              # %for.body45.lr.ph.i
	slli.d	$a1, $a0, 3
	.p2align	4, , 16
.LBB26_24:                              # %for.body45.i
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a2, $s3, 16
	ldx.d	$a2, $a2, $a1
	ld.d	$a3, $s0, 16
...
.LBB26_25:                              # %if.then.i71.i
	...
	add.w	$a1, $a5, $a1
	beqz	$a4, .LBB26_39
# %bb.26:                               # %if.then3.i83.i
	st.d	$a3, $a4, 8
	beqz	$a3, .LBB26_28
.LBB26_27:                              # %if.then9.i87.i
	ld.d	$a2, $a2, -16
	st.d	$a2, $a3, 0
.LBB26_28:                              # %if.end13.i88.i
	pcalau12i	$a2, %got_pc_hi20(memory_MARKSIZE)
	ld.d	$a2, $a2, %got_pc_lo12(memory_MARKSIZE)
	ld.w	$a3, $a2, 0
	pcalau12i	$a2, %got_pc_hi20(memory_FREEDBYTES)
	...
	st.d	$a5, $a4, 0
	bltz	$a1, .LBB26_30
# %bb.29:                               # %if.then18.i96.i
	add.d	$a1, $a1, $a3
	st.d	$a1, $a2, 0
.LBB26_30:                              # %if.end23.i94.i
	addi.d	$a0, $a0, -16
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB26_31:                              # %if.end64.i
	...
	ld.w	$a0, $s3, 24
	beqz	$a0, .LBB26_35
# %bb.32:                               # %for.body77.lr.ph.i
	move	$a1, $zero
	move	$a2, $zero
	.p2align	4, , 16
.LBB26_33:                              # %for.body77.i
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $s3, 16
	ld.d	$a3, $s1, 16
	ldx.d	$a0, $a0, $a1
	...
	addi.d	$a1, $a1, 8
	bltu	$a2, $a0, .LBB26_33
# %bb.34:                               # %for.cond92.preheader.loopexit.i
	ld.w	$a1, $s1, 24
	addi.w	$a2, $a0, 0
	bgeu	$a2, $a1, .LBB26_4
	b	.LBB26_36
.LBB26_35:
	...
	addi.w	$a2, $a0, 0
	bgeu	$a2, $a1, .LBB26_4
.LBB26_36:                              # %for.body96.lr.ph.i
	slli.d	$a1, $a0, 3
	.p2align	4, , 16
.LBB26_37:                              # %for.body96.i
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a2, $s1, 16
	ldx.d	$a2, $a2, $a1
	ld.d	$a3, $s0, 16
	...
	bltu	$a0, $a2, .LBB26_37
	b	.LBB26_4
.LBB26_38:                              # %if.else.i.i
	pcalau12i	$a4, %got_pc_hi20(memory_BIGBLOCKS)
	ld.d	$a4, $a4, %got_pc_lo12(memory_BIGBLOCKS)
	st.d	$a3, $a4, 0
	bnez	$a3, .LBB26_14
	b	.LBB26_15
.LBB26_39:                              # %if.else.i98.i
	pcalau12i	$a4, %got_pc_hi20(memory_BIGBLOCKS)
	ld.d	$a4, $a4, %got_pc_lo12(memory_BIGBLOCKS)
	st.d	$a3, $a4, 0
	bnez	$a3, .LBB26_27
