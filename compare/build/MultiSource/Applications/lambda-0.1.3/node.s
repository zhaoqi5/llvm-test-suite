...
# %bb.20:                               # %if.then20.i92
	...
	move	$a1, $fp
	jirl	$ra, $a2, 0
.LBB57_21:                              # %_ZN8app_node8set_leftEP8exp_nodes.exit95
	beqz	$s0, .LBB57_25
...
# %bb.28:                               # %delete.notnull.i99
	...
	jirl	$ra, $a2, 0
	move	$a0, $s4
.LBB57_29:                              # %if.end5.i102
	st.d	$a0, $fp, 24
	beqz	$a0, .LBB57_31
# %bb.30:                               # %if.then20.i104
	ld.d	$a1, $a0, 0
	ld.d	$a2, $a1, 96
	move	$a1, $fp
	jirl	$ra, $a2, 0
...
# %bb.42:                               # %delete.notnull.i125
	...
	jirl	$ra, $a2, 0
	move	$a0, $s3
.LBB57_43:                              # %if.end5.i128
	st.d	$a0, $fp, 24
	beqz	$a0, .LBB57_45
# %bb.44:                               # %if.then20.i130
	ld.d	$a1, $a0, 0
	ld.d	$a2, $a1, 96
	move	$a1, $fp
	jirl	$ra, $a2, 0
.LBB57_45:                              # %_ZN8app_node9set_rightEP8exp_nodes.exit133
	beqz	$s0, .LBB57_47
...
.LBB57_47:                              # %if.end212
	...
	ld.d	$a0, $a0, 24
	beqz	$a0, .LBB57_49
# %bb.48:                               # %delete.notnull.i135
	ld.d	$a1, $a0, 0
	ld.d	$a1, $a1, 16
	jirl	$ra, $a1, 0
.LBB57_49:                              # %if.end.i138
	ld.d	$a0, $fp, 24
	st.d	$a0, $s3, 24
	st.d	$zero, $fp, 24
	ld.d	$a0, $s3, 24
...
# %bb.60:                               # %if.end.i141
	beqz	$a0, .LBB57_62
# %bb.61:                               # %delete.notnull.i143
	ld.d	$a1, $a0, 0
	ld.d	$a1, $a1, 16
	jirl	$ra, $a1, 0
.LBB57_62:                              # %if.end5.i146
	ld.d	$a0, $s3, 0
	st.d	$s3, $fp, 24
	ld.d	$a2, $a0, 96
	move	$a0, $s3
	...
	jirl	$ra, $a2, 0
	ld.d	$a0, $fp, 24
.LBB57_63:                              # %_ZN8app_node9set_rightEP8exp_nodes.exit151
	ld.d	$a1, $a0, 0
	ld.d	$a4, $a1, 104
	move	$a1, $s2
	move	$a2, $s1
...
# %bb.65:                               # %delete.notnull.i156
	...
	jirl	$ra, $a2, 0
	move	$a0, $s0
.LBB57_66:                              # %if.end5.i159
	st.d	$a0, $fp, 24
	beqz	$a0, .LBB57_68
# %bb.67:                               # %if.then20.i161
	ld.d	$a1, $a0, 0
	ld.d	$a2, $a1, 96
	move	$a1, $fp
	jirl	$ra, $a2, 0
...
# %bb.75:                               # %delete.notnull.i112
	...
	jirl	$ra, $a2, 0
	move	$a0, $s3
.LBB57_76:                              # %if.end5.i115
	st.d	$a0, $fp, 24
	beqz	$a0, .LBB57_78
# %bb.77:                               # %if.then20.i117
	ld.d	$a1, $a0, 0
	ld.d	$a2, $a1, 96
	move	$a1, $fp
	jirl	$ra, $a2, 0
.LBB57_78:                              # %_ZN8app_node9set_rightEP8exp_nodes.exit120
	beqz	$s0, .LBB57_47
