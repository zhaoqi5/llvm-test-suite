...
# %bb.0:                                # %entry
	...
	st.d	$zero, $a0, 8
	pcalau12i	$a0, %pc_hi20(_ZTV8arg_node+16)
	addi.d	$a1, $a0, %pc_lo12(_ZTV8arg_node+16)
	ld.d	$a0, $s0, 16
	st.d	$a1, $fp, 0
	beqz	$a0, .LBB4_4
# %bb.1:                                # %if.then
...
# %bb.0:                                # %entry
	...
	st.d	$zero, $a0, 8
	pcalau12i	$a0, %pc_hi20(_ZTV8var_node+16)
	addi.d	$a1, $a0, %pc_lo12(_ZTV8var_node+16)
	ld.d	$a0, $s0, 16
	st.d	$a1, $fp, 0
	beqz	$a0, .LBB16_2
# %bb.1:                                # %if.then
...
# %bb.0:                                # %entry
	...
	st.d	$zero, $a0, 8
	pcalau12i	$a0, %pc_hi20(_ZTV8lam_node+16)
	addi.d	$a1, $a0, %pc_lo12(_ZTV8lam_node+16)
	ld.d	$a0, $s0, 16
	st.d	$a1, $fp, 0
	beqz	$a0, .LBB31_6
# %bb.1:                                # %if.end
...
# %bb.0:                                # %entry
	...
	ld.d	$a4, $a0, 16
	st.d	$zero, $sp, 16
	pcalau12i	$a0, %pc_hi20(_ZTV11stack_frame+16)
	addi.d	$a5, $a0, %pc_lo12(_ZTV11stack_frame+16)
	ld.d	$a0, $fp, 24
	st.d	$a5, $sp, 8
	ld.d	$a5, $a0, 0
	ld.d	$a5, $a5, 136
...
# %bb.0:                                # %entry
	...
	st.d	$zero, $a0, 8
	pcalau12i	$a0, %pc_hi20(_ZTV8app_node+16)
	addi.d	$a1, $a0, %pc_lo12(_ZTV8app_node+16)
	ld.d	$a0, $s0, 16
	st.d	$a1, $fp, 0
	beqz	$a0, .LBB49_6
# %bb.1:                                # %if.end
...
# %bb.4:                                # %invoke.cont
	...
	addi.d	$s6, $a0, %pc_lo12(_ZTV11arglst_node+16)
	ld.d	$a0, $s1, 0
	ld.d	$a3, $a0, 120
	st.d	$s6, $sp, 16
	st.d	$s2, $sp, 32
...
# %bb.0:                                # %entry
	...
	st.d	$zero, $a0, 8
	pcalau12i	$a0, %pc_hi20(_ZTV11arglst_node+16)
	addi.d	$a1, $a0, %pc_lo12(_ZTV11arglst_node+16)
	ld.d	$a0, $s0, 16
	st.d	$a1, $fp, 0
	beqz	$a0, .LBB63_3
# %bb.1:                                # %if.then
...
# %bb.0:                                # %entry
	move	$a1, $a0
	pcalau12i	$a0, %pc_hi20(_ZTV8var_node+16)
	addi.d	$a2, $a0, %pc_lo12(_ZTV8var_node+16)
	ld.d	$a0, $a1, 16
	st.d	$a2, $a1, 0
	beqz	$a0, .LBB99_2
# %bb.1:                                # %delete.notnull
...
# %bb.0:                                # %entry
	...
	addi.d	$a2, $a1, %pc_lo12(_ZTV8var_node+16)
	ld.d	$a1, $a0, 16
	st.d	$a2, $a0, 0
	beqz	$a1, .LBB100_2
# %bb.1:                                # %delete.notnull.i
