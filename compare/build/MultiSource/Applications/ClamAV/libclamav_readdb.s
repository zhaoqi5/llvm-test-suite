...
.LBB0_26:                               # %for.body25
	...
	beq	$s1, $s0, .LBB0_70
# %bb.27:                               # %for.cond29.preheader
                                        #   in Loop: Header=BB0_26 Depth=1
	move	$a0, $s7
	pcaddu18i	$ra, %call36(strlen)
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB0_34
# %bb.28:                               # %for.body34.preheader
                                        #   in Loop: Header=BB0_26 Depth=1
	move	$a1, $zero
	ori	$a2, $zero, 1
	.p2align	4, , 16
...
# %bb.31:                               # %for.inc51
	...
	b	.LBB0_34
	.p2align	4, , 16
.LBB0_32:                               # %if.end54.loopexit.split.loop.exit
                                        #   in Loop: Header=BB0_26 Depth=1
	st.d	$zero, $sp, 88                  # 8-byte Folded Spill
	add.d	$s6, $s7, $a1
	b	.LBB0_34
	.p2align	4, , 16
.LBB0_33:                               # %if.end54.loopexit.split.loop.exit250
                                        #   in Loop: Header=BB0_26 Depth=1
	add.d	$s6, $s7, $a1
	ori	$a0, $zero, 1
...
.LBB0_46:                               # %vector.body287
	...
	addi.d	$a2, $a2, 8
	bnez	$a3, .LBB0_46
# %bb.47:                               # %middle.block294
	vadd.w	$vr0, $vr3, $vr0
	vhaddw.d.w	$vr0, $vr0, $vr0
	vhaddw.q.d	$vr0, $vr0, $vr0
	vpickve2gr.d	$a2, $vr0, 0
	beq	$a1, $a0, .LBB0_50
.LBB0_48:                               # %for.body122.preheader304
	add.d	$a3, $s5, $a0
	sub.d	$a0, $a1, $a0
	.p2align	4, , 16
.LBB0_49:                               # %for.body122
