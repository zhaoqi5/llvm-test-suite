...
# %bb.30:                               # %if.then20.i
	...
	st.d	$a0, $s1, 32
	b	.LBB19_1
.LBB19_31:                              # %if.end88.split.loop.exit203
                                        #   in Loop: Header=BB19_2 Depth=1
	addi.d	$a3, $a6, 3
	b	.LBB19_38
.LBB19_32:                              # %if.end88.split.loop.exit201
                                        #   in Loop: Header=BB19_2 Depth=1
	addi.d	$a3, $a6, 4
	b	.LBB19_38
.LBB19_33:                              # %if.end88.split.loop.exit199
                                        #   in Loop: Header=BB19_2 Depth=1
	addi.d	$a3, $a6, 5
	b	.LBB19_38
.LBB19_34:                              # %if.end88.split.loop.exit197
                                        #   in Loop: Header=BB19_2 Depth=1
	addi.d	$a3, $a6, 6
	b	.LBB19_38
.LBB19_35:                              # %if.end88.split.loop.exit195
                                        #   in Loop: Header=BB19_2 Depth=1
	addi.d	$a3, $a6, 7
	b	.LBB19_38
.LBB19_36:                              # %if.end88.split.loop.exit193
                                        #   in Loop: Header=BB19_2 Depth=1
	addi.d	$a3, $a6, 8
	b	.LBB19_38
.LBB19_37:                              # %if.end88.split.loop.exit191
                                        #   in Loop: Header=BB19_2 Depth=1
	addi.d	$a3, $a6, 9
.LBB19_38:                              # %if.end88
                                        #   in Loop: Header=BB19_2 Depth=1
...
# %bb.32:                               # %if.end6.i136
	...
	st.d	$a0, $s0, 40
	bne	$a2, $s1, .LBB21_34
# %bb.33:                               # %if.then20.i147
	ld.d	$a0, $s0, 16
	st.d	$a0, $s0, 32
.LBB21_34:                              # %flush_pending.exit149
	ld.d	$a0, $fp, 0
	ld.w	$a0, $a0, 32
	sltui	$a0, $a0, 1
	xori	$a0, $a0, 3
...
# %bb.37:                               # %if.end6.i156
	...
	st.d	$a0, $s0, 40
	bne	$a2, $s1, .LBB21_39
# %bb.38:                               # %if.then20.i167
	ld.d	$a0, $s0, 16
	st.d	$a0, $s0, 32
.LBB21_39:                              # %flush_pending.exit169
	ld.d	$a0, $fp, 0
	ld.w	$a0, $a0, 32
	beqz	$a0, .LBB21_41
.LBB21_40:                              # %if.end276
...
# %bb.20:                               # %if.then70
	...
	addi.d	$a6, $a4, 1
	stptr.w	$a6, $fp, 5900
	pcalau12i	$a6, %got_pc_hi20(_length_code)
	ld.d	$a6, $a6, %got_pc_lo12(_length_code)
	addi.d	$a2, $a2, -3
	stx.b	$a2, $a5, $a4
	andi	$a2, $a2, 255
	ldx.bu	$a2, $a6, $a2
	...
	st.h	$a4, $a2, 1028
	sltui	$a2, $a5, 256
	bstrpick.d	$a4, $a1, 15, 7
	addi.d	$a4, $a4, 256
	masknez	$a4, $a4, $a2
	pcalau12i	$a5, %got_pc_hi20(_dist_code)
	ld.d	$a5, $a5, %got_pc_lo12(_dist_code)
	maskeqz	$a1, $a1, $a2
	or	$a1, $a1, $a4
...
# %bb.51:                               # %if.end6.i187
	...
	st.d	$a0, $s0, 40
	bne	$a2, $s1, .LBB22_53
# %bb.52:                               # %if.then20.i198
	ld.d	$a0, $s0, 16
	st.d	$a0, $s0, 32
.LBB22_53:                              # %flush_pending.exit200
	ld.d	$a0, $fp, 0
	ld.w	$a0, $a0, 32
	sltui	$a0, $a0, 1
	xori	$a0, $a0, 3
...
# %bb.56:                               # %if.end6.i207
	...
	st.d	$a0, $s0, 40
	bne	$a2, $s1, .LBB22_58
# %bb.57:                               # %if.then20.i218
	ld.d	$a0, $s0, 16
	st.d	$a0, $s0, 32
.LBB22_58:                              # %flush_pending.exit220
	ld.d	$a0, $fp, 0
	ld.w	$a0, $a0, 32
	beqz	$a0, .LBB22_60
.LBB22_59:                              # %if.end354
