...
# %bb.46:                               # %iter.check
	...
	ori	$a5, $zero, 8
	bgeu	$a2, $a5, .LBB1_65
.LBB1_47:                               # %while.body274.preheader
                                        #   in Loop: Header=BB1_6 Depth=1
	ori	$a5, $zero, 19
...
.LBB1_128:                              # %if.end638
	...
	ld.w	$a0, $s0, 8
	b	.LBB1_6
.LBB1_129:                              # %for.cond650.preheader
                                        #   in Loop: Header=BB1_6 Depth=1
	ld.wu	$a1, $s0, 120
	ld.d	$a0, $s0, 104
	addi.d	$a5, $zero, -1
...
# %bb.131:                              # %for.cond697.preheader
	...
	addi.w	$s4, $s3, 0
	bgeu	$s4, $a4, .LBB1_141
# %bb.132:                              # %do.body726.preheader
                                        #   in Loop: Header=BB1_6 Depth=1
	nor	$s6, $a3, $zero
	b	.LBB1_139
	.p2align	4, , 16
.LBB1_133:                              # %if.then669.do.end677_crit_edge
...
# %bb.136:                              # %if.then669
	...
	b	.LBB1_202
	.p2align	4, , 16
.LBB1_137:                              # %if.then729.do.end737_crit_edge
...
# %bb.145:                              # %if.end811
	...
	st.w	$a0, $s0, 100
	beqz	$a0, .LBB1_159
# %bb.146:                              # %while.cond820.preheader
                                        #   in Loop: Header=BB1_6 Depth=1
	bltu	$s3, $a0, .LBB1_148
	b	.LBB1_158
	.p2align	4, , 16
...
# %bb.149:                              # %if.then829
	...
	jirl	$ra, $a2, 0
	beqz	$a0, .LBB1_202
# %bb.150:                              # %if.then829.do.end837_crit_edge
                                        #   in Loop: Header=BB1_148 Depth=2
	move	$s5, $a0
	ld.w	$a0, $s0, 100
	addi.d	$a5, $zero, -1
...
# %bb.152:                              # %if.then780
	...
	jirl	$ra, $a3, 0
	bnez	$a0, .LBB1_203
# %bb.153:                              # %if.then780.do.end790_crit_edge
                                        #   in Loop: Header=BB1_6 Depth=1
	ld.w	$s7, $s0, 92
.LBB1_154:                              # %do.end790
                                        #   in Loop: Header=BB1_6 Depth=1
...
# %bb.163:                              # %if.then885
	...
	jirl	$ra, $a2, 0
	beqz	$a0, .LBB1_202
# %bb.164:                              # %if.then885.do.end893_crit_edge
                                        #   in Loop: Header=BB1_162 Depth=2
	move	$s5, $a0
	ld.d	$a0, $s0, 112
	ld.w	$a1, $s0, 124
...
# %bb.167:                              # %for.cond910.preheader
	...
	add.d	$a4, $s1, $a1
	bgeu	$s3, $a4, .LBB1_173
# %bb.168:                              # %do.body939.preheader
                                        #   in Loop: Header=BB1_6 Depth=1
	nor	$s4, $a3, $zero
	move	$s6, $s3
	b	.LBB1_171
.LBB1_169:                              # %if.then942.do.end950_crit_edge
...
# %bb.175:                              # %if.end989
	...
	st.w	$a0, $s0, 100
	beqz	$a0, .LBB1_184
# %bb.176:                              # %while.cond1001.preheader
                                        #   in Loop: Header=BB1_6 Depth=1
	bltu	$s3, $a0, .LBB1_178
	b	.LBB1_183
.LBB1_177:                              # %do.end1018
...
# %bb.179:                              # %if.then1010
	...
	jirl	$ra, $a2, 0
	beqz	$a0, .LBB1_202
# %bb.180:                              # %if.then1010.do.end1018_crit_edge
                                        #   in Loop: Header=BB1_178 Depth=2
	move	$s5, $a0
	ld.w	$a0, $s0, 100
	addi.d	$a5, $zero, -1
...
.LBB1_187:                              # %sw.epilog1128
	...
	ld.w	$a0, $s0, 8
	b	.LBB1_6
.LBB1_188:                              # %do.cond1109
                                        #   in Loop: Header=BB1_189 Depth=2
	ld.w	$a1, $s0, 92
	sub.w	$s8, $s1, $a0
	beqz	$a1, .LBB1_200
.LBB1_189:                              # %do.body1064
                                        #   Parent Loop BB1_6 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB1_196 Depth 3
                                        #       Child Loop BB1_199 Depth 3
...
.LBB1_191:                              # %if.then1068
	...
	jirl	$ra, $a3, 0
	bnez	$a0, .LBB1_203
# %bb.192:                              # %if.then1068.do.end1078_crit_edge
                                        #   in Loop: Header=BB1_189 Depth=2
	ld.w	$a0, $s0, 60
.LBB1_193:                              # %do.end1078
                                        #   in Loop: Header=BB1_189 Depth=2
...
.LBB1_206:                              # %if.then453
	...
	ld.d	$s6, $sp, 32                    # 8-byte Folded Reload
	b	.LBB1_204
.LBB1_207:                              # %inf_leave.loopexit1188
	addi.w	$s4, $zero, -3
	b	.LBB1_204
.LBB1_208:                              # %sw.bb1114
	ld.w	$a0, $s0, 60
...
.LJTI1_0:
	...
	.word	.LBB1_204-.LJTI1_0
	.word	.LBB1_204-.LJTI1_0
	.word	.LBB1_208-.LJTI1_0
	.word	.LBB1_207-.LJTI1_0
.LJTI1_1:
