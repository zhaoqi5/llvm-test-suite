...
# %bb.22:                               # %if.end.i
	...
	ori	$a0, $zero, 7
	bgeu	$s6, $a0, .LBB0_29
.LBB0_23:                               # %cli_pmemstr.exit
	bgeu	$s8, $s5, .LBB0_37
# %bb.24:                               # %for.body60.preheader
	addi.d	$a0, $s0, 6
	lu12i.w	$a1, 419415
	ori	$a1, $a1, 632
	ori	$a2, $zero, 10
...
.LBB0_109:                              # %if.then379
	...
	jirl	$ra, $ra, 0
.LBB0_110:                              #   in Loop: Header=BB0_44 Depth=1
	move	$s7, $zero
.LBB0_111:                              # %cleanup467
                                        #   in Loop: Header=BB0_44 Depth=1
	ld.d	$s6, $sp, 168                   # 8-byte Folded Reload
...
# %bb.115:                              # %if.then436
	...
	move	$s7, $a0
	b	.LBB0_120
.LBB0_116:                              #   in Loop: Header=BB0_44 Depth=1
	move	$s4, $s8
	b	.LBB0_119
.LBB0_117:                              # %if.else438
                                        #   in Loop: Header=BB0_44 Depth=1
...
.LBB0_139:                              # %while.end486.sink.split
	pcaddu18i	$ra, %call36(cli_warnmsg)
	jirl	$ra, $ra, 0
	addi.w	$s7, $zero, -124
	b	.LBB0_127
...
.LBB4_47:                               # %vector.ph170
	...
	move	$a5, $s0
	move	$a6, $a3
.LBB4_48:                               # %vector.body173
                                        # =>This Inner Loop Header: Depth=1
	xvslli.w	$xr7, $xr2, 3
	xvslli.w	$xr8, $xr3, 3
	xvslli.w	$xr9, $xr4, 3
	xvslli.w	$xr10, $xr5, 3
	xvsub.w	$xr10, $xr1, $xr10
	xvsub.w	$xr11, $xr1, $xr9
	xvsub.w	$xr9, $xr1, $xr8
	xvsub.w	$xr7, $xr1, $xr7
	xvsrl.w	$xr8, $xr0, $xr7
	xvsrl.w	$xr9, $xr0, $xr9
	xvsrl.w	$xr7, $xr0, $xr11
	xvsrl.w	$xr11, $xr0, $xr10
	...
	vpickve2gr.h	$a7, $vr7, 0
	vinsgr2vr.h	$vr11, $a7, 0
	vpickve2gr.h	$a7, $vr7, 2
	vinsgr2vr.h	$vr11, $a7, 1
	vpickve2gr.h	$a7, $vr7, 4
	vinsgr2vr.h	$vr11, $a7, 2
	vpickve2gr.h	$a7, $vr7, 6
	...
	vpickve2gr.h	$a7, $vr9, 0
	vinsgr2vr.h	$vr10, $a7, 0
	vpickve2gr.h	$a7, $vr9, 2
	vinsgr2vr.h	$vr10, $a7, 1
	vpickve2gr.h	$a7, $vr9, 4
	vinsgr2vr.h	$vr10, $a7, 2
	vpickve2gr.h	$a7, $vr9, 6
	vinsgr2vr.h	$vr10, $a7, 3
	...
	vpickve2gr.h	$a7, $vr9, 6
	vinsgr2vr.h	$vr10, $a7, 7
	vpickve2gr.h	$a7, $vr8, 0
	vinsgr2vr.h	$vr9, $a7, 0
	vpickve2gr.h	$a7, $vr8, 2
	vinsgr2vr.h	$vr9, $a7, 1
	vpickve2gr.h	$a7, $vr8, 4
	vinsgr2vr.h	$vr9, $a7, 2
	vpickve2gr.h	$a7, $vr8, 6
	vinsgr2vr.h	$vr9, $a7, 3
	xvpermi.d	$xr8, $xr8, 14
	vpickve2gr.h	$a7, $vr8, 0
	vinsgr2vr.h	$vr9, $a7, 4
	vpickve2gr.h	$a7, $vr8, 2
	vinsgr2vr.h	$vr9, $a7, 5
	vpickve2gr.h	$a7, $vr8, 4
	vinsgr2vr.h	$vr9, $a7, 6
	vpickve2gr.h	$a7, $vr8, 6
