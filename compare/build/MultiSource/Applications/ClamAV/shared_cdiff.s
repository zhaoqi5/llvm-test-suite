...
# %bb.23:                               # %if.end38
	...
	ld.d	$s8, $s8, 24
	bnez	$s8, .LBB8_7
.LBB8_24:                               # %while.cond.outer77.us.preheader
	addi.w	$s1, $zero, -1
.LBB8_25:                               # %while.cond.outer77.us
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB8_27 Depth 2
	addi.w	$s4, $s4, 1
	b	.LBB8_27
	.p2align	4, , 16
.LBB8_26:                               # %if.end70.us.us
...
.LBB8_27:                               # %while.cond.us.us
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB8_40
# %bb.28:                               # %while.body.us.us
                                        #   in Loop: Header=BB8_27 Depth=2
	beqz	$s7, .LBB8_26
# %bb.29:                               # %land.lhs.true41.us.us
                                        #   in Loop: Header=BB8_27 Depth=2
	ld.w	$a0, $s7, 0
	bne	$s4, $a0, .LBB8_26
# %bb.30:                               # %if.then44.split.us.us
