...
# %bb.0:                                # %entry
	...
	pcalau12i	$a2, %pc_hi20(cfg_options)
	addi.d	$s5, $a2, %pc_lo12(cfg_options)
	ld.d	$fp, $s5, 0
	move	$s2, $a1
	move	$s3, $a0
	st.d	$zero, $sp, 64
...
# %bb.38:                               # %sub_0
	...
	ori	$a0, $zero, 49
	bne	$fp, $a0, .LBB0_40
# %bb.39:                               # %lor.lhs.false231.tail
                                        #   in Loop: Header=BB0_21 Depth=2
	ld.bu	$a0, $s1, 1
	ori	$s3, $zero, 1
	beqz	$a0, .LBB0_46
.LBB0_40:                               # %lor.lhs.false234
                                        #   in Loop: Header=BB0_21 Depth=2
...
# %bb.42:                               # %sub_0174
	...
	ori	$a0, $zero, 48
	bne	$fp, $a0, .LBB0_44
# %bb.43:                               # %lor.lhs.false241.tail
                                        #   in Loop: Header=BB0_21 Depth=2
	ld.bu	$a0, $s1, 1
	beqz	$a0, .LBB0_45
.LBB0_44:                               # %lor.lhs.false244
                                        #   in Loop: Header=BB0_21 Depth=2
