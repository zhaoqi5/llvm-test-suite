...
# %bb.70:                               # %if.end5.i.i
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB0_83
# %bb.71:                               # %lor.lhs.false2.i.i77.i
                                        #   in Loop: Header=BB0_65 Depth=1
	st.d	$a0, $sp, 136                   # 8-byte Folded Spill
	st.d	$s8, $a0, 36
	beqz	$s7, .LBB0_91
# %bb.72:                               # %if.else.i.i86.i
                                        #   in Loop: Header=BB0_65 Depth=1
	move	$a0, $s4
	move	$a1, $s5
	move	$a2, $zero
...
# %bb.108:                              # %if.then39.i
	...
	pcaddu18i	$ra, %call36(cli_dbgmsg)
	jirl	$ra, $ra, 0
.LBB0_109:                              # %if.then113.sink.split.i
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
.LBB0_110:                              # %if.then113.sink.split.i
	pcaddu18i	$ra, %call36(close)
	jirl	$ra, $ra, 0
.LBB0_111:                              # %if.then113.sink.split.i
	ld.d	$s5, $sp, 144                   # 8-byte Folded Reload
	ld.d	$s6, $sp, 136                   # 8-byte Folded Reload
	b	.LBB0_118
...
.LBB0_117:                              # %sw.default.i
	...
	pcaddu18i	$ra, %call36(close)
	jirl	$ra, $ra, 0
.LBB0_118:                              # %if.then113.sink.split.i
	move	$a0, $s5
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	move	$a0, $s6
	...
	jirl	$ra, $ra, 0
	move	$s8, $s7
.LBB0_119:                              # %if.then113.i
	move	$a0, $s8
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB0_120:                              # %chm_decompress_stream.exit
	ori	$s3, $zero, 1
	b	.LBB0_122
	.p2align	4, , 16
.LBB0_121:                              # %if.end.i92
...
# %bb.126:                              # %if.then.i99
	...
	jirl	$ra, $ra, 0
	b	.LBB0_124
.LBB0_127:                              # %free_file_list.exit103
	beqz	$s2, .LBB0_129
# %bb.128:                              # %if.then56
	move	$a0, $s2
	move	$a1, $s1
...
# %bb.132:                              # %if.end60.i
	...
	jirl	$ra, $ra, 0
	beqz	$s6, .LBB0_153
# %bb.133:                              # %while.body65.lr.ph.i.preheader
	...
	b	.LBB0_136
.LBB0_134:                              # %if.then76.i
                                        #   in Loop: Header=BB0_136 Depth=1
	ld.d	$a0, $sp, 128                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(cli_dbgmsg)
	jirl	$ra, $ra, 0
.LBB0_135:                              # %while.cond63.backedge.i
                                        #   in Loop: Header=BB0_136 Depth=1
	ld.d	$s6, $s6, 32
	beqz	$s6, .LBB0_150
.LBB0_136:                              # %while.body65.i
...
# %bb.139:                              # %if.end88.i
	...
	st.d	$a0, $sp, 104                   # 8-byte Folded Spill
	beqz	$a0, .LBB0_144
# %bb.140:                              # %while.body.i.i.preheader
                                        #   in Loop: Header=BB0_136 Depth=1
	ld.d	$s4, $sp, 104                   # 8-byte Folded Reload
.LBB0_141:                              # %while.body.i.i
...
.LBB0_144:                              #   in Loop: Header=BB0_136 Depth=1
	...
	b	.LBB0_147
.LBB0_145:                              # %if.then.i.i85
                                        #   in Loop: Header=BB0_136 Depth=1
	ld.d	$a0, $sp, 104                   # 8-byte Folded Reload
	sub.d	$a0, $a0, $s4
	st.d	$a0, $sp, 104                   # 8-byte Folded Spill
	b	.LBB0_147
.LBB0_146:                              # %if.then12.i.i
                                        #   in Loop: Header=BB0_136 Depth=1
	ld.d	$a0, $sp, 120                   # 8-byte Folded Reload
	add.d	$a0, $s4, $a0
	ld.d	$a1, $sp, 104                   # 8-byte Folded Reload
...
.LBB0_147:                              # %chm_copy_file_data.exit.i
                                        #   in Loop: Header=BB0_136 Depth=1
	ld.d	$a1, $s6, 24
	ld.d	$a0, $sp, 104                   # 8-byte Folded Reload
	beq	$a0, $a1, .LBB0_149
...
.LBB0_150:                              # %if.end105.i
	...
	ld.d	$s6, $sp, 136                   # 8-byte Folded Reload
	b	.LBB0_113
.LBB0_151:                              # %if.then49.i
	pcalau12i	$a0, %pc_hi20(.L.str.44)
	addi.d	$a0, $a0, %pc_lo12(.L.str.44)
	pcaddu18i	$ra, %call36(cli_dbgmsg)
	jirl	$ra, $ra, 0
	b	.LBB0_109
.LBB0_152:                              # %if.end105.thread.i
	pcalau12i	$a0, %pc_hi20(.L.str.45)
	addi.d	$a0, $a0, %pc_lo12(.L.str.45)
	pcaddu18i	$ra, %call36(cli_dbgmsg)
	jirl	$ra, $ra, 0
	b	.LBB0_111
.LBB0_153:                              # %if.end105.thread161.i
	ld.d	$a0, $sp, 168                   # 8-byte Folded Reload
	b	.LBB0_110
.Lfunc_end0:
