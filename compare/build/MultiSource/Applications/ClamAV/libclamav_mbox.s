...
# %bb.73:                               # %cleanup285
	...
	move	$s3, $s4
	bnez	$a0, .LBB3_71
# %bb.74:                               #   in Loop: Header=BB3_65 Depth=2
	move	$s3, $s4
	b	.LBB3_63
.LBB3_75:                               # %if.else295
                                        #   in Loop: Header=BB3_65 Depth=2
...
# %bb.83:                               # %if.else303
	...
	move	$s4, $zero
	bltz	$a0, .LBB3_99
# %bb.84:                               #   in Loop: Header=BB3_65 Depth=2
	addi.w	$s6, $s6, 1
	b	.LBB3_64
.LBB3_85:                               # %if.then200
                                        #   in Loop: Header=BB3_65 Depth=2
...
.LBB3_96:                               # %if.then228
	...
	ori	$s4, $zero, 1
	b	.LBB3_64
.LBB3_97:                               #   in Loop: Header=BB3_53 Depth=1
	move	$s7, $zero
	b	.LBB3_99
.LBB3_98:                               #   in Loop: Header=BB3_53 Depth=1
	ori	$s4, $zero, 1
.LBB3_99:                               # %do.end321
                                        #   in Loop: Header=BB3_53 Depth=1
...
# %bb.119:                              # %if.end651
	beqz	$s7, .LBB3_161
# %bb.120:                              # %for.cond657.preheader
	ori	$s1, $zero, 3
	bne	$s3, $s1, .LBB3_122
.LBB3_121:                              # %for.end817.loopexit
	st.w	$s1, $sp, 104
	b	.LBB3_160
.LBB3_122:                              # %for.body664.preheader
	...
	b	.LBB3_125
	.p2align	4, , 16
.LBB3_123:                              #   in Loop: Header=BB3_125 Depth=1
	move	$s4, $s6
	ld.d	$s6, $s4, 8
	beqz	$s6, .LBB3_121
.LBB3_124:                              # %for.inc815
...
# %bb.154:                              # %if.then790
	...
	ori	$fp, $zero, 1
	b	.LBB3_157
.LBB3_155:                              #   in Loop: Header=BB3_125 Depth=1
	move	$fp, $zero
	b	.LBB3_158
.LBB3_156:                              #   in Loop: Header=BB3_125 Depth=1
	move	$fp, $zero
.LBB3_157:                              # %do.end797
                                        #   in Loop: Header=BB3_125 Depth=1
	move	$s6, $s4
...
# %bb.165:                              # %if.then832
	...
	b	.LBB3_169
.LBB3_166:                              # %sw.bb.i
                                        #   in Loop: Header=BB3_169 Depth=1
	move	$a0, $s6
	move	$a1, $s2
	pcaddu18i	$ra, %call36(strstr)
	jirl	$ra, $ra, 0
...
# %bb.187:                              # %if.then33.i
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB3_192
# %bb.188:                              # %exportBounceMessage.exit
	move	$a0, $s0
	pcaddu18i	$ra, %call36(fileblobScanAndDestroy)
	jirl	$ra, $ra, 0
	ld.w	$a1, $s1, 8
	...
	or	$s3, $a0, $a1
	b	.LBB3_190
.LBB3_189:                              # %exportBounceMessage.exit.thread
...
.LBB3_191:                              # %cleanup898
	...
	addi.d	$sp, $sp, 1200
	ret
.LBB3_192:                              # %exportBounceMessage.exit.thread506
...
.LBB3_211:                              # %sw.bb352
	...
	pcaddu18i	$ra, %call36(cli_dbgmsg)
	jirl	$ra, $ra, 0
.LBB3_212:                              # %sw.epilog353
	pcalau12i	$a0, %pc_hi20(.L.str.21)
	addi.d	$a0, $a0, %pc_lo12(.L.str.21)
	st.d	$a0, $sp, 72                    # 8-byte Folded Spill
.LBB3_213:                              # %sw.epilog353
	ld.d	$a0, $sp, 56                    # 8-byte Folded Reload
	beqz	$a0, .LBB3_216
# %bb.214:                              # %land.lhs.true355
	beq	$a0, $s0, .LBB3_217
# %bb.215:                              # %if.then358
	pcaddu18i	$ra, %call36(messageDestroy)
	jirl	$ra, $ra, 0
...
# %bb.218:                              # %if.then368
	...
	beqz	$s2, .LBB3_228
# %bb.219:                              # %for.cond371.preheader
	move	$s0, $fp
	blez	$fp, .LBB3_227
# %bb.220:                              # %for.body374.preheader
	move	$fp, $s2
	b	.LBB3_222
.LBB3_221:                              # %for.inc382
...
# %bb.223:                              # %if.then378
	...
	jirl	$ra, $ra, 0
	b	.LBB3_221
.LBB3_224:                              # %lor.lhs.false362
	ld.d	$s4, $sp, 96
	bnez	$fp, .LBB3_232
# %bb.225:                              # %lor.lhs.false362
	bnez	$s4, .LBB3_232
# %bb.226:                              # %if.then368.thread
	ld.d	$s2, $sp, 64                    # 8-byte Folded Reload
	beqz	$s2, .LBB3_228
.LBB3_227:                              # %for.end384
	move	$a0, $s2
...
.LBB3_247:                              # %sw.bb478
	...
	move	$fp, $zero
	b	.LBB3_267
.LBB3_248:                              # %sw.epilog502.loopexit
	ori	$fp, $zero, 1
	b	.LBB3_268
.LBB3_249:                              # %sw.bb397
...
.LBB3_255:
	move	$fp, $zero
	b	.LBB3_266
.LBB3_256:                              # %for.cond413.preheader
	ld.d	$a0, $sp, 48                    # 8-byte Folded Reload
	blez	$a0, .LBB3_260
# %bb.257:                              # %for.body416.preheader
	move	$fp, $zero
	ori	$s7, $zero, 5
	ld.d	$s6, $sp, 48                    # 8-byte Folded Reload
	ld.d	$s8, $sp, 64                    # 8-byte Folded Reload
.LBB3_258:                              # %for.body416
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $s8, 0
	pcaddu18i	$ra, %call36(messageGetMimeType)
	jirl	$ra, $ra, 0
	beq	$a0, $s7, .LBB3_284
# %bb.259:                              # %for.inc426
                                        #   in Loop: Header=BB3_258 Depth=1
	addi.w	$fp, $fp, 1
	addi.d	$s6, $s6, -1
	addi.d	$s8, $s8, 8
	bnez	$s6, .LBB3_258
...
.LBB3_264:                              # %if.end498
	...
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB3_265:                              # %sw.epilog502
	move	$fp, $zero
	ld.d	$s7, $sp, 88                    # 8-byte Folded Reload
.LBB3_266:                              # %sw.epilog502
	ld.d	$s3, $sp, 48                    # 8-byte Folded Reload
.LBB3_267:                              # %sw.epilog502
	ld.d	$a0, $sp, 56                    # 8-byte Folded Reload
.LBB3_268:                              # %sw.epilog502
	beqz	$a0, .LBB3_271
# %bb.269:                              # %sw.epilog502
	beq	$a0, $s0, .LBB3_271
# %bb.270:                              # %if.then507
...
.LBB3_277:                              # %if.end525
	blez	$s3, .LBB3_282
# %bb.278:                              # %for.body529.preheader
	move	$fp, $s8
	b	.LBB3_280
.LBB3_279:                              # %for.inc537
                                        #   in Loop: Header=BB3_280 Depth=1
	addi.d	$s3, $s3, -1
	addi.d	$fp, $fp, 8
	beqz	$s3, .LBB3_283
.LBB3_280:                              # %for.body529
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $fp, 0
	beqz	$a0, .LBB3_279
# %bb.281:                              # %if.then533
...
.LJTI3_0:
	...
	.word	.LBB3_118-.LJTI3_0
.LJTI3_1:
	.word	.LBB3_235-.LJTI3_1
	.word	.LBB3_234-.LJTI3_1
	.word	.LBB3_234-.LJTI3_1
	.word	.LBB3_247-.LJTI3_1
	.word	.LBB3_247-.LJTI3_1
	.word	.LBB3_249-.LJTI3_1
	.word	.LBB3_235-.LJTI3_1
	.word	.LBB3_235-.LJTI3_1
...
# %bb.41:                               # %switch.early.test.i.i
                                        #   in Loop: Header=BB7_37 Depth=1
	beq	$a1, $s5, .LBB7_43
# %bb.42:                               # %switch.early.test.i.i
                                        #   in Loop: Header=BB7_37 Depth=1
	addi.d	$s0, $s0, -1
	addi.d	$s4, $s4, -1
	bne	$a1, $s6, .LBB7_37
.LBB7_43:                               # %strstrip.exit
	move	$s6, $a0
	pcalau12i	$a0, %pc_hi20(.L.str.39)
	addi.d	$a1, $a0, %pc_lo12(.L.str.39)
	move	$a0, $zero
...
.LBB7_62:                               # %if.then12.i
	...
	move	$s2, $zero
	b	.LBB7_97
.LBB7_63:                               # %while.cond.preheader.i24
	ld.d	$a1, $s6, 0
	addi.d	$a0, $s3, -1
	.p2align	4, , 16
.LBB7_64:                               # %while.cond.i
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a2, $a0, 1
	slli.d	$a3, $a2, 1
	ldx.hu	$a3, $a1, $a3
...
# %bb.73:                               # %if.end5.i.i.i
	...
	ldx.bu	$a4, $s8, $a1
	add.d	$a1, $s8, $a1
.LBB7_74:                               # %do.body.i.i.i
                                        #   Parent Loop BB7_70 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	andi	$a4, $a4, 255
	move	$a3, $a0
	beqz	$a4, .LBB7_76
# %bb.75:                               # %if.then6.i.i.i
                                        #   in Loop: Header=BB7_74 Depth=2
	st.b	$zero, $a1, 0
.LBB7_76:                               # %do.cond.i.i.i
                                        #   in Loop: Header=BB7_74 Depth=2
	addi.w	$a0, $a3, 0
	blez	$a0, .LBB7_80
# %bb.77:                               # %land.lhs.true.i.i.i
                                        #   in Loop: Header=BB7_74 Depth=2
	ld.b	$a0, $a1, -1
	ld.d	$a4, $a2, 0
	slli.d	$a5, $a0, 1
...
.LBB7_80:                               #   in Loop: Header=BB7_70 Depth=1
	move	$a3, $zero
.LBB7_81:                               # %do.end.i.i.i
                                        #   in Loop: Header=BB7_70 Depth=1
	addi.w	$a0, $a3, 0
	addi.d	$a1, $a0, -1
.LBB7_82:                               # %strstrip.exit.i
                                        #   in Loop: Header=BB7_70 Depth=1
	ldx.bu	$a0, $s8, $a1
	ori	$a3, $zero, 34
	bne	$a0, $a3, .LBB7_84
...
.LBB7_94:                               # %if.end116.i
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB7_97
# %bb.95:                               # %while.body121.i.preheader
	ori	$s4, $zero, 2
...
.LBB7_99:                               # %if.end154.i
	move	$s3, $zero
	beqz	$s2, .LBB7_101
.LBB7_100:                              # %cleanup158.sink.split.i
	move	$a0, $s2
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB7_101:                              # %if.end25
...
.LBB7_102:                              # %cleanup
	...
	addi.d	$sp, $sp, 144
	ret
.LBB7_103:                              # %if.then46.i
	pcalau12i	$a0, %pc_hi20(.L.str.57)
	addi.d	$a0, $a0, %pc_lo12(.L.str.57)
	move	$a1, $s7
	pcaddu18i	$ra, %call36(cli_warnmsg)
	jirl	$ra, $ra, 0
.LBB7_104:                              # %if.then10.sink.split
	move	$a0, $fp
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	ld.d	$s7, $sp, 16                    # 8-byte Folded Reload
	b	.LBB7_9
.LBB7_105:                              # %if.then51.i
	addi.w	$s3, $zero, -1
	beqz	$s1, .LBB7_100
# %bb.106:                              # %if.then53.i
	move	$a0, $s1
...
# %bb.21:                               # %for.body.lr.ph
	...
	ld.d	$fp, $a0, %got_pc_lo12(cli_leavetemps_flag)
	ori	$s6, $zero, 10
	lu12i.w	$a0, 147
	ori	$a0, $a0, 2689
	st.d	$a0, $sp, 64                    # 8-byte Folded Spill
...
.LBB13_27:                              # %while.end
	...
	ld.bu	$a0, $fp, 0
	beqz	$a0, .LBB13_51
.LBB13_28:                              # %cleanup156.thread
                                        #   in Loop: Header=BB13_30 Depth=1
	ld.d	$s1, $sp, 32                    # 8-byte Folded Reload
.LBB13_29:                              # %while.end162
                                        #   in Loop: Header=BB13_30 Depth=1
	move	$a0, $s2
...
# %bb.48:                               # %if.end146.loopexit
	...
	ori	$s6, $zero, 10
	b	.LBB13_50
.LBB13_49:                              #   in Loop: Header=BB13_44 Depth=2
	move	$s1, $zero
.LBB13_50:                              # %if.end146
                                        #   in Loop: Header=BB13_44 Depth=2
	addi.d	$a0, $sp, 464
...
# %bb.70:                               # %if.end206
	...
	addi.d	$s5, $a0, %pc_lo12(.L.str.181)
...
.LBB15_84:                              #   in Loop: Header=BB15_72 Depth=1
	move	$s6, $zero
	b	.LBB15_72
.LBB15_85:                              #   in Loop: Header=BB15_72 Depth=1
	lu12i.w	$a0, 2
	ori	$a0, $a0, 488
	add.d	$a0, $sp, $a0
.LBB15_86:                              # %land.lhs.true349
                                        #   in Loop: Header=BB15_72 Depth=1
	addi.w	$s6, $s8, 0
	ori	$a2, $zero, 1
	move	$a1, $s6
	...
	ori	$a1, $zero, 1
	bne	$a0, $a1, .LBB15_89
# %bb.87:                               #   in Loop: Header=BB15_72 Depth=1
	move	$s6, $zero
	b	.LBB15_72
.LBB15_88:                              # %if.then47.peel.i
	ld.d	$a0, $sp, 56                    # 8-byte Folded Reload
	ld.w	$a0, $a0, 0
	pcaddu18i	$ra, %call36(strerror)
	jirl	$ra, $ra, 0
...
.LBB15_99:                              # %if.then47.i
	...
	jirl	$ra, $ra, 0
	blez	$s8, .LBB15_95
# %bb.100:                              #   in Loop: Header=BB15_102 Depth=1
	addi.w	$s8, $s8, -1
...
# %bb.106:                              # %if.end59.i
	...
	ori	$a1, $zero, 10
	beq	$a0, $a1, .LBB15_109
# %bb.107:                              #   in Loop: Header=BB15_102 Depth=1
	addi.w	$a0, $a0, 1
	st.d	$a0, $sp, 72                    # 8-byte Folded Spill
	b	.LBB15_101
.LBB15_108:
...
.LBB15_112:                             # %if.end283
	...
	ld.bu	$a2, $a0, 0
	beqz	$a2, .LBB15_115
.LBB15_113:                             # %while.cond288
                                        # =>This Inner Loop Header: Depth=1
	beq	$a2, $a1, .LBB15_115
# %bb.114:                              # %while.body297
                                        #   in Loop: Header=BB15_113 Depth=1
	addi.d	$a0, $a0, 1
	ld.bu	$a2, $a0, 0
	bnez	$a2, .LBB15_113
.LBB15_115:                             # %while.end299
	st.b	$zero, $a0, 0
	move	$a0, $fp
	pcaddu18i	$ra, %call36(cli_strdup)
	jirl	$ra, $ra, 0
