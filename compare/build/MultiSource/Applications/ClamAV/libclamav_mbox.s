...
# %bb.71:                               # %land.lhs.true.i.i
	...
	and	$a1, $a1, $a2
	bnez	$a1, .LBB0_86
# %bb.72:                               # %if.end54.thread.i.i
                                        #   in Loop: Header=BB0_66 Depth=1
	bnez	$s8, .LBB0_103
	b	.LBB0_119
	.p2align	4, , 16
.LBB0_73:                               # %if.else169.i.i
                                        #   in Loop: Header=BB0_66 Depth=1
	beqz	$s4, .LBB0_79
# %bb.74:                               # %land.lhs.true171.i.i
                                        #   in Loop: Header=BB0_66 Depth=1
	ori	$a0, $zero, 3119
	add.d	$a0, $sp, $a0
	pcaddu18i	$ra, %call36(isuuencodebegin)
...
.LBB0_78:                               #   in Loop: Header=BB0_66 Depth=1
	...
	b	.LBB0_65
	.p2align	4, , 16
.LBB0_79:                               # %if.then188.i.i
                                        #   in Loop: Header=BB0_66 Depth=1
	andi	$a0, $s6, 1
	beqz	$a0, .LBB0_81
# %bb.80:                               # %land.lhs.true191.i.i
                                        #   in Loop: Header=BB0_66 Depth=1
	move	$a0, $s2
...
.LBB0_81:                               #   in Loop: Header=BB0_66 Depth=1
	move	$s3, $s7
	b	.LBB0_106
.LBB0_82:                               # %if.else197.i.i
                                        #   in Loop: Header=BB0_66 Depth=1
	andi	$a0, $s7, 1
	beqz	$a0, .LBB0_105
# %bb.83:                               # %if.then199.i.i
                                        #   in Loop: Header=BB0_66 Depth=1
...
# %bb.87:                               # %if.end5.i.i.i.i
	...
	add.d	$a1, $a3, $a1
	.p2align	4, , 16
.LBB0_88:                               # %do.body.i.i.i.i
                                        #   Parent Loop BB0_66 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	andi	$a2, $a2, 255
	beqz	$a2, .LBB0_90
# %bb.89:                               # %if.then6.i.i.i.i
                                        #   in Loop: Header=BB0_88 Depth=2
	st.b	$zero, $a1, 0
.LBB0_90:                               # %do.cond.i.i.i.i
                                        #   in Loop: Header=BB0_88 Depth=2
	addi.w	$a2, $a0, 0
	blt	$a2, $a5, .LBB0_94
# %bb.91:                               # %land.lhs.true.i.i.i.i
                                        #   in Loop: Header=BB0_88 Depth=2
	ld.b	$a2, $a1, -1
	ld.d	$a3, $s3, 0
	slli.d	$a4, $a2, 1
...
# %bb.100:                              # %if.end63.i.i
	...
	st.d	$a0, $sp, 56                    # 8-byte Folded Spill
	b	.LBB0_65
.LBB0_101:                              # %if.else64.i.i
                                        #   in Loop: Header=BB0_66 Depth=1
	beqz	$s8, .LBB0_118
# %bb.102:                              # %if.else114.i.i
                                        #   in Loop: Header=BB0_66 Depth=1
	beqz	$s4, .LBB0_124
.LBB0_103:                              # %if.then117.i.i
                                        #   in Loop: Header=BB0_66 Depth=1
	ori	$a0, $zero, 3119
	add.d	$a0, $sp, $a0
	pcaddu18i	$ra, %call36(strlen)
...
# %bb.107:                              #   in Loop: Header=BB0_66 Depth=1
	move	$fp, $zero
	move	$s7, $s3
.LBB0_108:                              # %do.cond.i.i
                                        #   in Loop: Header=BB0_66 Depth=1
	move	$s3, $zero
	b	.LBB0_65
.LBB0_109:                              # %if.then195.i.i
                                        #   in Loop: Header=BB0_66 Depth=1
...
.LBB0_110:                              #   in Loop: Header=BB0_66 Depth=1
	...
	st.d	$zero, $sp, 56                  # 8-byte Folded Spill
	b	.LBB0_64
.LBB0_111:                              # %if.then38.i.i
                                        #   in Loop: Header=BB0_66 Depth=1
	beqz	$s8, .LBB0_114
# %bb.112:                              # %if.then40.i.i
                                        #   in Loop: Header=BB0_66 Depth=1
	move	$a0, $s2
	move	$a1, $s8
...
# %bb.113:                              # %if.end45.i.i
	...
	jirl	$ra, $ra, 0
.LBB0_114:                              # %if.end46.i.i
                                        #   in Loop: Header=BB0_66 Depth=1
	ori	$s3, $zero, 1
	bnez	$s5, .LBB0_64
# %bb.115:                              # %lor.lhs.false.i.i
                                        #   in Loop: Header=BB0_66 Depth=1
...
.LBB0_117:                              #   in Loop: Header=BB0_66 Depth=1
	...
	b	.LBB0_137
.LBB0_118:                              # %if.else64.if.then67_crit_edge.i.i
                                        #   in Loop: Header=BB0_66 Depth=1
	ori	$a0, $zero, 3119
	add.d	$a0, $sp, $a0
	ld.bu	$fp, $a0, 0
...
.LBB0_127:                              # %if.end141.i.i
	...
	ori	$a1, $zero, 59
	beq	$a0, $a1, .LBB0_108
# %bb.128:                              # %if.end147.i.i
                                        #   in Loop: Header=BB0_66 Depth=1
	beqz	$s4, .LBB0_133
# %bb.129:                              # %land.lhs.true149.i.i
                                        #   in Loop: Header=BB0_66 Depth=1
	ld.bu	$a0, $s8, 0
	beqz	$a0, .LBB0_133
# %bb.130:                              # %while.body.i.i.i.preheader
                                        #   in Loop: Header=BB0_66 Depth=1
	move	$a1, $zero
	ori	$a2, $zero, 1
	.p2align	4, , 16
.LBB0_131:                              # %while.body.i.i.i
                                        #   Parent Loop BB0_66 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.d	$a3, $a0, -34
	ldx.bu	$a0, $s8, $a2
...
.LBB0_137:                              #   in Loop: Header=BB0_66 Depth=1
	...
	ori	$fp, $zero, 1
	b	.LBB0_65
.LBB0_138:                              # %sw.default.i.i
                                        #   in Loop: Header=BB0_66 Depth=1
	ld.d	$a0, $sp, 56                    # 8-byte Folded Reload
	andi	$a0, $a0, 1
	bnez	$a0, .LBB0_142
# %bb.139:                              # %sw.default.i.i.i
                                        #   in Loop: Header=BB0_66 Depth=1
...
.LBB0_142:                              #   in Loop: Header=BB0_66 Depth=1
	ori	$a0, $zero, 1
.LBB0_143:                              # %cleanup110.thread.i.i
                                        #   in Loop: Header=BB0_66 Depth=1
	st.d	$a0, $sp, 56                    # 8-byte Folded Spill
	b	.LBB0_63
.LBB0_144:                              # %do.end.i.i
	beqz	$s5, .LBB0_146
# %bb.145:                              # %if.then220.i.i
	move	$a0, $s5
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB0_146:                              # %if.end221.i.i
	ld.d	$s1, $sp, 32                    # 8-byte Folded Reload
	beqz	$s8, .LBB0_151
# %bb.147:                              # %if.then223.i.i
	ld.bu	$a0, $s8, 0
	beqz	$a0, .LBB0_150
# %bb.148:                              # %if.then223.i.i
...
# %bb.149:                              # %sw.bb226.i.i
	...
	pcaddu18i	$ra, %call36(cli_dbgmsg)
	jirl	$ra, $ra, 0
.LBB0_150:                              # %if.end228.i.i
	move	$a0, $s8
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB0_151:                              # %if.end229.i.i
	ld.d	$a0, $sp, 56                    # 8-byte Folded Reload
	andi	$a0, $a0, 1
	beqz	$a0, .LBB0_153
# %bb.152:
...
.LBB0_157:                              # %sw.bb138.i
	ori	$fp, $zero, 1
	b	.LBB0_168
.LBB0_158:                              # %if.end140.i
	move	$a0, $s2
	pcaddu18i	$ra, %call36(messageDestroy)
	jirl	$ra, $ra, 0
.LBB0_159:                              # %land.lhs.true143.i
	ld.w	$a0, $s1, 52
	beqz	$a0, .LBB0_161
# %bb.160:                              # %land.lhs.true145.i
	ld.d	$a0, $s1, 0
	ld.d	$a1, $a0, 0
	beqz	$a1, .LBB0_162
.LBB0_161:
...
.LBB0_162:                              # %if.then148.i
	...
	ori	$fp, $zero, 1
	b	.LBB0_169
.LBB0_163:                              # %if.then12.i.i
	pcalau12i	$a0, %pc_hi20(cli_parse_mbox.rfc821)
	ld.d	$a0, $a0, %pc_lo12(cli_parse_mbox.rfc821)
	pcaddu18i	$ra, %call36(tableDestroy)
	jirl	$ra, $ra, 0
.LBB0_164:                              # %if.then12.i
	ld.d	$a0, $s2, 0
	pcaddu18i	$ra, %call36(tableDestroy)
	jirl	$ra, $ra, 0
	st.d	$zero, $s2, 0
...
.LBB0_167:                              # %sw.bb137.i
	addi.w	$fp, $zero, -102
.LBB0_168:                              # %if.end140.thread123.i
	move	$a0, $s2
	pcaddu18i	$ra, %call36(messageDestroy)
	jirl	$ra, $ra, 0
.LBB0_169:                              # %if.end151.i
