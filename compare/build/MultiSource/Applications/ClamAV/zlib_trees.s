...
# %bb.49:                               # %for.body.i27.i
                                        #   in Loop: Header=BB5_48 Depth=1
	beq	$t1, $a1, .LBB5_46
.LBB5_50:                               # %if.else.i42.i
                                        #   in Loop: Header=BB5_48 Depth=1
	bge	$t5, $t2, .LBB5_53
# %bb.51:                               # %if.then18.i71.i
                                        #   in Loop: Header=BB5_48 Depth=1
	slli.d	$t2, $t1, 2
	ldx.h	$t3, $a2, $t2
	add.d	$t3, $t3, $t5
...
.LBB5_52:                               # %if.else61.i56.i
	...
	b	.LBB5_47
	.p2align	4, , 16
.LBB5_53:                               # %if.else24.i44.i
                                        #   in Loop: Header=BB5_48 Depth=1
	beqz	$t1, .LBB5_58
# %bb.54:                               # %if.then27.i46.i
                                        #   in Loop: Header=BB5_48 Depth=1
	beq	$t1, $t6, .LBB5_56
# %bb.55:                               # %if.then30.i48.i
                                        #   in Loop: Header=BB5_48 Depth=1
	slli.d	$t2, $t1, 2
	ldx.h	$t3, $a2, $t2
	addi.d	$t3, $t3, 1
	stx.h	$t3, $a2, $t2
.LBB5_56:                               # %if.end36.i52.i
                                        #   in Loop: Header=BB5_48 Depth=1
	ldx.h	$t2, $fp, $t0
	addi.d	$t2, $t2, 1
	stx.h	$t2, $fp, $t0
...
.LBB5_57:                               #   in Loop: Header=BB5_48 Depth=1
	...
	ori	$t3, $zero, 138
	b	.LBB5_47
.LBB5_58:                               # %if.else41.i65.i
                                        #   in Loop: Header=BB5_48 Depth=1
	blt	$a5, $t4, .LBB5_60
# %bb.59:                               # %if.then44.i69.i
                                        #   in Loop: Header=BB5_48 Depth=1
	ldx.h	$t2, $fp, $a6
	addi.d	$t2, $t2, 1
	stx.h	$t2, $fp, $a6
...
.LBB5_97:                               # %for.body.lr.ph.i
	stptr.w	$t2, $fp, 5940
	pcalau12i	$a4, %pc_hi20(bl_order)
	addi.d	$a4, $a4, %pc_lo12(bl_order)
	ori	$a5, $zero, 2750
	ori	$a6, $a1, 1840
	ori	$a7, $zero, 14
	add.d	$t0, $fp, $a6
...
# %bb.1:                                # %do.body.preheader
	...
	add.d	$a7, $a0, $a6
	ori	$t0, $a3, 1804
	pcalau12i	$t1, %pc_hi20(_length_code)
	addi.d	$t1, $t1, %pc_lo12(_length_code)
	move	$t2, $zero
	move	$t3, $zero
	ori	$t4, $zero, 256
	ori	$t5, $zero, 4
...
.LBB7_8:                                # %if.end188
                                        #   in Loop: Header=BB7_5 Depth=1
	addi.d	$fp, $t6, -1
	pcalau12i	$s0, %pc_hi20(_dist_code)
	addi.d	$s0, $s0, %pc_lo12(_dist_code)
	bltu	$t4, $t6, .LBB7_17
.LBB7_9:                                # %cond.true
                                        #   in Loop: Header=BB7_5 Depth=1
	add.d	$t6, $s0, $fp
...
.LBB7_13:                               # %if.then131
	...
	ldx.w	$s0, $s0, $s1
	pcalau12i	$s2, %pc_hi20(base_length)
	addi.d	$s2, $s2, %pc_lo12(base_length)
	ldx.w	$s1, $s2, $s1
	sub.w	$fp, $fp, $s1
	sub.w	$s2, $a5, $s0
	sll.w	$s1, $fp, $t8
...
.LBB7_21:                               # %if.then266
                                        #   in Loop: Header=BB7_5 Depth=1
	pcalau12i	$t8, %pc_hi20(extra_dbits)
	addi.d	$t8, $t8, %pc_lo12(extra_dbits)
	ldx.w	$t8, $t8, $s0
	pcalau12i	$s1, %pc_hi20(base_dist)
	addi.d	$s1, $s1, %pc_lo12(base_dist)
	ldx.w	$s0, $s1, $s0
	sub.w	$fp, $fp, $s0
	sub.w	$s1, $a5, $t8
	sll.w	$s0, $fp, $t6
...
.LBB7_23:                               # %if.else311
	...
	add.w	$t6, $t8, $t6
	b	.LBB7_3
.LBB7_24:                               # %entry.if.end328_crit_edge
	ori	$a2, $a3, 1844
	ldx.w	$t6, $a0, $a2
.LBB7_25:                               # %if.end328
	ld.hu	$a2, $a1, 1026
...
# %bb.1:                                # %if.else
	...
	pcalau12i	$a5, %pc_hi20(_length_code)
	addi.d	$a5, $a5, %pc_lo12(_length_code)
	ldx.bu	$a2, $a5, $a2
	alsl.d	$a2, $a2, $a0, 2
	ld.h	$a5, $a2, 1240
	addi.d	$a5, $a5, 1
	...
	bltu	$a5, $a1, .LBB8_4
# %bb.2:                                # %cond.true
	pcalau12i	$a1, %pc_hi20(_dist_code)
	addi.d	$a1, $a1, %pc_lo12(_dist_code)
	add.d	$a1, $a1, $a4
	b	.LBB8_5
.LBB8_3:                                # %if.then
	...
	b	.LBB8_6
.LBB8_4:                                # %cond.false
	bstrpick.d	$a1, $a4, 31, 7
	pcalau12i	$a4, %pc_hi20(_dist_code)
	addi.d	$a4, $a4, %pc_lo12(_dist_code)
	add.d	$a1, $a4, $a1
	addi.d	$a1, $a1, 256
.LBB8_5:                                # %cond.end
	ld.bu	$a1, $a1, 0
