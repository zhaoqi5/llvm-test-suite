...
# %bb.578:                              # %cleanup4171
	...
	bgeu	$a1, $a0, .LBB0_523
	b	.LBB0_529
.LBB0_579:                              # %vector.main.loop.iter.check2850
	ori	$a0, $zero, 16
	ld.d	$a1, $sp, 136                   # 8-byte Folded Reload
	bgeu	$a1, $a0, .LBB0_611
# %bb.580:
...
# %bb.613:                              # %middle.block2859
	...
	ld.d	$a1, $sp, 136                   # 8-byte Folded Reload
	beq	$a0, $a1, .LBB0_620
# %bb.614:                              # %vec.epilog.iter.check2866
	ld.d	$a1, $sp, 136                   # 8-byte Folded Reload
	andi	$a1, $a1, 12
	beqz	$a1, .LBB0_618
.LBB0_615:                              # %vec.epilog.ph2865
	move	$a2, $a0
	ld.d	$a0, $sp, 136                   # 8-byte Folded Reload
	andi	$a0, $a0, 124
	vreplgr2vr.w	$vr0, $s5
	...
	add.d	$a2, $a2, $a3
	addi.d	$a2, $a2, 72
.LBB0_616:                              # %vec.epilog.vector.body2873
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a3, $a2, -72
	ld.w	$a4, $a2, -36
	ld.w	$a5, $a2, 0
	...
	addi.d	$a2, $a2, 144
	bnez	$a1, .LBB0_616
# %bb.617:                              # %vec.epilog.middle.block2877
...
# %bb.852:                              # %middle.block
	beq	$a2, $a3, .LBB0_855
.LBB0_853:                              # %for.body2932.preheader2889
	slli.d	$a2, $a1, 2
	slli.d	$a3, $a1, 5
	alsl.d	$a3, $a1, $a3, 2
	add.d	$a3, $s4, $a3
