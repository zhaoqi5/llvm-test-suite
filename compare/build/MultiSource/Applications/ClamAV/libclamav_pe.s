...
# %bb.567:                              # %lor.lhs.false3885
	...
	ld.w	$a1, $s3, 32
	beq	$a0, $a1, .LBB0_564
.LBB0_568:                              # %if.then3903
	ld.d	$a0, $sp, 144                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	move	$a0, $s2
	b	.LBB0_670
.LBB0_569:                              # %if.then3996
	ld.d	$a0, $fp, 32
	beqz	$a0, .LBB0_582
# %bb.570:                              # %land.lhs.true3999
	ld.d	$a2, $a0, 24
	beqz	$a2, .LBB0_582
# %bb.571:                              # %land.lhs.true3999
	ld.d	$a0, $sp, 208                   # 8-byte Folded Reload
	bgeu	$a2, $a0, .LBB0_582
# %bb.572:                              # %if.then4008
...
# %bb.579:                              # %cleanup4171
	...
	bgeu	$a1, $a0, .LBB0_523
	b	.LBB0_529
.LBB0_580:                              # %vector.main.loop.iter.check2766
	ori	$a0, $zero, 16
	ld.d	$a1, $sp, 184                   # 8-byte Folded Reload
	bgeu	$a1, $a0, .LBB0_615
# %bb.581:
...
# %bb.594:                              # %sw.default3952
	...
	bgeu	$a0, $s0, .LBB0_513
	b	.LBB0_517
.LBB0_595:                              # %if.then2644
	ld.d	$a0, $sp, 144                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	move	$a0, $s4
	b	.LBB0_137
.LBB0_596:                              # %if.then3869
	ld.w	$a1, $sp, 264
	...
	jirl	$ra, $ra, 0
	b	.LBB0_866
.LBB0_597:                              # %if.end2787.if.end2816_crit_edge
	bstrpick.d	$a0, $s3, 31, 0
.LBB0_598:                              # %if.end2816
	pcaddu18i	$ra, %call36(cli_malloc)
	jirl	$ra, $ra, 0
...
# %bb.602:                              # %if.end2855
	...
	bne	$a0, $a2, .LBB0_754
# %bb.603:                              # %for.cond2866.preheader
	addi.w	$a1, $s3, -4
	ori	$a0, $zero, 13
	st.d	$a1, $sp, 168                   # 8-byte Folded Spill
	bltu	$a1, $a0, .LBB0_664
# %bb.604:                              # %for.body2870.preheader
...
.LBB0_605:                              # %for.body2870
	...
	beqz	$s3, .LBB0_842
# %bb.606:                              # %if.end2877
                                        #   in Loop: Header=BB0_605 Depth=1
	move	$s2, $a2
	lu12i.w	$a1, 2
	ori	$a1, $a1, 444
	add.d	$a1, $sp, $a1
...
# %bb.617:                              # %middle.block2775
	...
	ld.d	$a1, $sp, 184                   # 8-byte Folded Reload
	beq	$a0, $a1, .LBB0_624
# %bb.618:                              # %vec.epilog.iter.check2782
	ld.d	$a1, $sp, 184                   # 8-byte Folded Reload
	andi	$a1, $a1, 12
	beqz	$a1, .LBB0_622
.LBB0_619:                              # %vec.epilog.ph2781
	move	$a2, $a0
	ld.d	$a0, $sp, 184                   # 8-byte Folded Reload
	andi	$a0, $a0, 124
	vreplgr2vr.w	$vr0, $s5
	...
	add.d	$a2, $a2, $a3
	addi.d	$a2, $a2, 72
.LBB0_620:                              # %vec.epilog.vector.body2789
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a3, $a2, -72
	ld.w	$a4, $a2, -36
	ld.w	$a5, $a2, 0
	...
	addi.d	$a2, $a2, 144
	bnez	$a1, .LBB0_620
# %bb.621:                              # %vec.epilog.middle.block2793
	...
	ld.d	$a1, $sp, 184                   # 8-byte Folded Reload
	beq	$a0, $a1, .LBB0_624
.LBB0_622:                              # %for.body4472.preheader
	slli.d	$a1, $a0, 5
	alsl.d	$a1, $a0, $a1, 2
	ld.d	$a2, $sp, 144                   # 8-byte Folded Reload
	add.d	$a1, $a1, $a2
...
.LBB0_623:                              # %for.body4472
	...
	addi.d	$a1, $a1, 36
	bnez	$a0, .LBB0_623
.LBB0_624:                              # %for.end4493
	beqz	$s5, .LBB0_641
# %bb.625:                              # %if.end4496
	ld.d	$a0, $fp, 32
	bstrpick.d	$s3, $s5, 31, 0
	beqz	$a0, .LBB0_630
# %bb.626:                              # %land.lhs.true4499
	ld.d	$a2, $a0, 24
	beqz	$a2, .LBB0_630
# %bb.627:                              # %land.lhs.true4499
	bgeu	$a2, $s3, .LBB0_630
# %bb.628:                              # %if.then4509
...
# %bb.631:
	...
	ld.d	$s7, $sp, 144                   # 8-byte Folded Reload
	b	.LBB0_633
.LBB0_632:                              # %for.inc4609
                                        #   in Loop: Header=BB0_633 Depth=1
	addi.w	$s4, $s4, -1
	addi.d	$s0, $s0, -1
	addi.d	$s7, $s7, 36
	beqz	$s0, .LBB0_671
.LBB0_633:                              # %for.body4528
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a0, $s7, 12
	beqz	$a0, .LBB0_632
# %bb.634:                              # %if.end4534
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB0_638
# %bb.635:                              # %land.lhs.true4543
                                        #   in Loop: Header=BB0_633 Depth=1
	ld.wu	$a0, $s7, 12
	addi.w	$a1, $a0, -1
	bgeu	$a1, $s5, .LBB0_638
# %bb.636:                              # %land.lhs.true4555
                                        #   in Loop: Header=BB0_633 Depth=1
	ld.wu	$a1, $s7, 0
	add.d	$a2, $a1, $a0
	bltu	$s3, $a2, .LBB0_638
...
# %bb.639:                              # %if.then4615
	...
	pcaddu18i	$ra, %call36(cli_dbgmsg)
	jirl	$ra, $ra, 0
.LBB0_640:                              # %while.cond4656.sink.split
	move	$a0, $s6
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB0_641:                              # %while.cond4656
	ld.d	$a0, $fp, 56
	ld.bu	$a0, $a0, 1
	andi	$a0, $a0, 16
	beqz	$a0, .LBB0_648
# %bb.642:                              # %while.body4661
	ld.bu	$a0, $sp, 272
	ori	$a1, $zero, 233
	addi.d	$s3, $sp, 272
	bne	$a0, $a1, .LBB0_647
...
.LBB0_647:                              # %if.end4696
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB0_650
.LBB0_648:                              # %while.end4879
	ld.d	$a0, $sp, 144                   # 8-byte Folded Reload
.LBB0_649:                              # %cleanup4880
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	b	.LBB0_16
.LBB0_650:                              # %if.end4700
...
# %bb.654:                              # %if.end4731
	...
	or	$s5, $a3, $a2
	beqz	$a1, .LBB0_677
# %bb.655:                              # %land.lhs.true4747
	ld.d	$a2, $a1, 24
	beqz	$a2, .LBB0_677
# %bb.656:                              # %land.lhs.true4751
	sltu	$a1, $s5, $s3
	masknez	$a3, $s5, $a1
	maskeqz	$a1, $s3, $a1
	or	$a1, $a1, $a3
...
# %bb.658:                              # %if.then4775
	...
	b	.LBB0_204
.LBB0_659:                              # %if.then2826
	pcalau12i	$a0, %pc_hi20(.L.str.170)
	addi.d	$a0, $a0, %pc_lo12(.L.str.170)
	move	$a1, $s3
.LBB0_660:                              # %cleanup4880
	pcaddu18i	$ra, %call36(cli_dbgmsg)
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 144                   # 8-byte Folded Reload
.LBB0_661:                              # %cleanup4880
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 216                   # 8-byte Folded Reload
	b	.LBB0_670
.LBB0_662:                              # %if.then4130
	pcalau12i	$a0, %pc_hi20(.L.str.219)
	addi.d	$a0, $a0, %pc_lo12(.L.str.219)
	b	.LBB0_667
.LBB0_663:                              # %if.then2854
	pcalau12i	$a0, %pc_hi20(.L.str.161)
	addi.d	$a0, $a0, %pc_lo12(.L.str.161)
	pcaddu18i	$ra, %call36(cli_dbgmsg)
	jirl	$ra, $ra, 0
.LBB0_664:                              # %land.lhs.true3043
	ld.d	$a0, $sp, 216                   # 8-byte Folded Reload
.LBB0_665:                              # %land.lhs.true3043
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	b	.LBB0_452
.LBB0_666:                              # %if.then4029
...
.LBB0_667:                              # %cleanup4880
	...
	jirl	$ra, $ra, 0
	move	$a0, $s6
.LBB0_668:                              # %if.then1400
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB0_669:                              # %if.then1400
	ld.d	$a0, $sp, 144                   # 8-byte Folded Reload
.LBB0_670:                              # %cleanup4880
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	addi.w	$a0, $zero, -123
	b	.LBB0_133
...
# %bb.675:                              # %if.then4631
	...
	jirl	$ra, $ra, 0
	b	.LBB0_821
.LBB0_676:                              # %if.then4033
	move	$a0, $s6
	b	.LBB0_922
.LBB0_677:                              # %if.end4778
	beqz	$s5, .LBB0_648
# %bb.678:                              # %lor.lhs.false4782
	ld.d	$a1, $sp, 144                   # 8-byte Folded Reload
	ld.w	$a1, $a1, 4
	bne	$s5, $a1, .LBB0_648
# %bb.679:                              # %if.end4788
...
.LBB0_691:                              # %cleanup4880
	...
	move	$a0, $s5
	b	.LBB0_670
.LBB0_692:                              # %for.cond4231.preheader
	beqz	$s0, .LBB0_780
# %bb.693:                              # %iter.check
	ori	$a0, $zero, 5
	ld.d	$a1, $sp, 184                   # 8-byte Folded Reload
...
.LBB0_695:                              # %if.then3591
	...
	addi.w	$a1, $zero, -1
	bge	$a1, $a0, .LBB0_551
.LBB0_696:                              # %if.end3637.thread
	pcalau12i	$a0, %pc_hi20(.L.str.186)
	addi.d	$a0, $a0, %pc_lo12(.L.str.186)
.LBB0_697:                              # %if.then3742
	pcaddu18i	$ra, %call36(cli_dbgmsg)
	jirl	$ra, $ra, 0
.LBB0_698:                              # %if.then3742
	move	$a0, $s4
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 144                   # 8-byte Folded Reload
...
.LBB0_707:                              # %if.then3916
	...
	jirl	$ra, $ra, 0
	move	$a0, $s6
.LBB0_708:                              # %cleanup4880
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	move	$a0, $s2
	b	.LBB0_749
.LBB0_709:                              # %if.then2466
	pcalau12i	$a0, %pc_hi20(.L.str.157)
	addi.d	$a0, $a0, %pc_lo12(.L.str.157)
.LBB0_710:                              # %land.lhs.true2707
	pcaddu18i	$ra, %call36(cli_dbgmsg)
	jirl	$ra, $ra, 0
	b	.LBB0_717
.LBB0_711:                              # %if.then3745
	ld.d	$a0, $sp, 216                   # 8-byte Folded Reload
	move	$a1, $zero
	pcaddu18i	$ra, %call36(cli_multifree)
	jirl	$ra, $ra, 0
...
# %bb.721:                              # %if.end3202
	...
	bstrpick.d	$a0, $a0, 31, 0
	beqz	$a1, .LBB0_800
# %bb.722:                              # %land.lhs.true3212
	ld.d	$a2, $a1, 24
	beqz	$a2, .LBB0_800
# %bb.723:                              # %land.lhs.true3212
	bgeu	$a2, $a0, .LBB0_800
# %bb.724:                              # %if.then3222
	pcalau12i	$a0, %pc_hi20(.L.str.152)
	addi.d	$a0, $a0, %pc_lo12(.L.str.152)
	ld.d	$a1, $sp, 192                   # 8-byte Folded Reload
	b	.LBB0_445
.LBB0_725:                              # %if.then4139
	pcalau12i	$a0, %pc_hi20(.L.str.220)
	addi.d	$a0, $a0, %pc_lo12(.L.str.220)
	b	.LBB0_743
.LBB0_726:                              # %if.then2253
	move	$a0, $s5
	b	.LBB0_922
.LBB0_727:                              # %if.then3750
	...
	addi.w	$a0, $zero, -123
	b	.LBB0_133
.LBB0_728:                              # %vector.main.loop.iter.check
	ori	$a0, $zero, 17
	ld.d	$a1, $sp, 184                   # 8-byte Folded Reload
	bgeu	$a1, $a0, .LBB0_771
# %bb.729:
	move	$a0, $zero
	b	.LBB0_775
.LBB0_730:                              # %if.end1695.if.end1788_crit_edge
	ld.w	$a0, $sp, 264
.LBB0_731:                              # %if.end1788
	add.d	$a0, $a0, $s5
	bstrpick.d	$a0, $a0, 31, 0
...
# %bb.757:                              # %land.lhs.true3686
	...
	jirl	$ra, $ra, 0
	beq	$a0, $s3, .LBB0_888
.LBB0_758:                              # %if.else3701
	pcalau12i	$a0, %pc_hi20(.L.str.191)
	addi.d	$a0, $a0, %pc_lo12(.L.str.191)
	b	.LBB0_697
.LBB0_759:                              # %if.then3201
	addi.w	$a1, $s6, 0
	b	.LBB0_462
.LBB0_760:                              # %sw.default2287
...
.LBB0_815:                              # %if.end4149
	...
	ori	$a1, $zero, 1
	bne	$fp, $a1, .LBB0_837
.LBB0_816:                              # %if.then4155
	bnez	$a0, .LBB0_818
.LBB0_817:                              # %if.then4057
	move	$a0, $s5
	pcaddu18i	$ra, %call36(unlink)
	jirl	$ra, $ra, 0
.LBB0_818:                              # %if.end4059
...
.LBB0_832:                              # %if.end2286
	move	$a0, $s3
	b	.LBB0_649
.LBB0_833:                              # %if.then2541
	pcalau12i	$a0, %pc_hi20(.L.str.159)
	addi.d	$a0, $a0, %pc_lo12(.L.str.159)
	b	.LBB0_710
.LBB0_834:                              # %if.then4811
	move	$a0, $s6
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	b	.LBB0_868
.LBB0_835:                              # %if.else4047
...
.LBB0_850:                              # %vector.body
	...
	xvadd.w	$xr1, $xr2, $xr1
	xvstelm.w	$xr1, $a5, -108, 0
	xvstelm.w	$xr1, $a5, -72, 1
	xvstelm.w	$xr1, $a5, -36, 2
	xvstelm.w	$xr1, $a5, 0, 3
	xvstelm.w	$xr1, $a5, 36, 4
	xvstelm.w	$xr1, $a5, 72, 5
	xvstelm.w	$xr1, $a5, 108, 6
	xvstelm.w	$xr1, $a5, 144, 7
	addi.d	$a4, $a4, 32
	addi.d	$a5, $a5, 288
	bne	$a6, $a4, .LBB0_850
# %bb.851:                              # %middle.block
	beq	$a2, $a3, .LBB0_854
.LBB0_852:                              # %for.body2932.preheader2805
	slli.d	$a2, $a1, 2
	slli.d	$a3, $a1, 5
	alsl.d	$a3, $a1, $a3, 2
	add.d	$a3, $s3, $a3
	sub.d	$a0, $a0, $a1
.LBB0_853:                              # %for.body2932
                                        # =>This Inner Loop Header: Depth=1
...
# %bb.863:                              # %if.then3004
	...
	jirl	$ra, $ra, 0
	b	.LBB0_972
.LBB0_864:                              # %if.then4344
	ld.w	$a1, $s5, 12
	pcalau12i	$a0, %pc_hi20(.L.str.228)
	addi.d	$a0, $a0, %pc_lo12(.L.str.228)
	pcaddu18i	$ra, %call36(cli_dbgmsg)
	jirl	$ra, $ra, 0
.LBB0_865:                              # %if.then1481
	move	$a0, $s2
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB0_866:                              # %if.then1391
	ld.d	$a0, $sp, 144                   # 8-byte Folded Reload
	b	.LBB0_137
.LBB0_867:
	move	$s5, $s6
.LBB0_868:                              # %cleanup4869.thread.sink.split
	move	$a0, $s5
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	b	.LBB0_648
...
# %bb.874:                              # %if.then1912
	...
	jirl	$ra, $ra, 0
	b	.LBB0_930
.LBB0_875:                              # %if.then3241
	pcalau12i	$a0, %pc_hi20(.L.str.170)
	addi.d	$a0, $a0, %pc_lo12(.L.str.170)
	ld.d	$a1, $sp, 192                   # 8-byte Folded Reload
	b	.LBB0_660
.LBB0_876:                              # %if.then1885
	pcalau12i	$a0, %pc_hi20(.L.str.134)
	addi.d	$a0, $a0, %pc_lo12(.L.str.134)
	pcaddu18i	$ra, %call36(cli_dbgmsg)
	jirl	$ra, $ra, 0
	b	.LBB0_767
.LBB0_877:                              # %if.then2561
...
# %bb.883:                              # %land.lhs.true3719
	...
	jirl	$ra, $ra, 0
	beq	$a0, $s3, .LBB0_924
.LBB0_884:                              # %if.else3734
	pcalau12i	$a0, %pc_hi20(.L.str.193)
	addi.d	$a0, $a0, %pc_lo12(.L.str.193)
	b	.LBB0_697
.LBB0_885:                              # %if.then1899
	move	$a0, $s4
	b	.LBB0_922
.LBB0_886:                              # %if.then2584
	pcalau12i	$a0, %pc_hi20(.L.str.161)
	addi.d	$a0, $a0, %pc_lo12(.L.str.161)
	b	.LBB0_710
.LBB0_887:
...
.LBB0_888:                              # %if.then3700
	...
	bnez	$s2, .LBB0_882
	b	.LBB0_925
.LBB0_889:                              # %if.then3283
	pcalau12i	$a0, %pc_hi20(.L.str.173)
	addi.d	$a0, $a0, %pc_lo12(.L.str.173)
	ld.d	$a1, $sp, 200                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(cli_dbgmsg)
	jirl	$ra, $ra, 0
.LBB0_890:                              # %for.end3290
	ld.d	$a0, $sp, 192                   # 8-byte Folded Reload
	addi.w	$a0, $a0, -10
	bgeu	$s7, $a0, .LBB0_905
# %bb.891:                              # %lor.lhs.false3294
	bstrpick.d	$a0, $s7, 31, 0
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	add.d	$a0, $a1, $a0
	ld.w	$a0, $a0, 6
...
# %bb.904:                              # %if.then3406
	...
	jirl	$ra, $ra, 0
	b	.LBB0_982
.LBB0_905:                              # %if.then3301
	ld.d	$a0, $sp, 216                   # 8-byte Folded Reload
.LBB0_906:                              # %land.lhs.true3444
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	b	.LBB0_494
.LBB0_907:                              # %if.then2925
	ld.d	$a0, $sp, 144                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 216                   # 8-byte Folded Reload
	b	.LBB0_137
.LBB0_908:                              # %if.then2627
	pcalau12i	$a0, %pc_hi20(.L.str.162)
	addi.d	$a0, $a0, %pc_lo12(.L.str.162)
	b	.LBB0_710
.LBB0_909:                              # %if.then2962
	addi.w	$a1, $s8, 0
	pcalau12i	$a0, %pc_hi20(.L.str.156)
	addi.d	$a0, $a0, %pc_lo12(.L.str.156)
	pcaddu18i	$ra, %call36(cli_dbgmsg)
...
# %bb.911:
	move	$s2, $zero
.LBB0_912:                              # %if.then3570
	ori	$a0, $zero, 1
	st.d	$a0, $sp, 192                   # 8-byte Folded Spill
	b	.LBB0_547
.LBB0_913:                              # %if.then1904
	...
	move	$a0, $s4
	b	.LBB0_749
.LBB0_914:                              # %if.then2951
	ld.d	$a0, $sp, 144                   # 8-byte Folded Reload
.LBB0_915:                              # %cleanup4880
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	move	$a0, $s3
	b	.LBB0_137
.LBB0_916:                              # %if.then4395
	move	$a0, $zero
	pcaddu18i	$ra, %call36(cli_gentemp)
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB0_921
...
# %bb.920:                              # %if.then4414
	...
	jirl	$ra, $ra, 0
	b	.LBB0_950
.LBB0_921:                              # %if.then3911
	move	$a0, $s2
.LBB0_922:                              # %cleanup4880
	ld.d	$a1, $sp, 144                   # 8-byte Folded Reload
	move	$a2, $zero
	pcaddu18i	$ra, %call36(cli_multifree)
	jirl	$ra, $ra, 0
...
.LBB0_925:                              # %if.then3738
	...
	jirl	$ra, $ra, 0
	b	.LBB0_495
.LBB0_926:                              # %if.then4832
	move	$a0, $s5
	move	$a1, $s6
.LBB0_927:                              # %cleanup4880
	ld.d	$a2, $sp, 144                   # 8-byte Folded Reload
	move	$a3, $zero
	pcaddu18i	$ra, %call36(cli_multifree)
	jirl	$ra, $ra, 0
...
.LBB0_936:                              # %if.then3355
	...
	move	$a0, $s7
	b	.LBB0_613
.LBB0_937:                              # %if.then3344
	ld.d	$a0, $sp, 144                   # 8-byte Folded Reload
.LBB0_938:                              # %cleanup4880
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	move	$a0, $s7
	b	.LBB0_137
.LBB0_939:                              # %if.then4403
...
.LBB0_945:                              # %cleanup4880
	...
	addi.w	$a0, $zero, -114
	b	.LBB0_133
.LBB0_946:                              # %if.then2648
	move	$a0, $s4
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	b	.LBB0_927
.LBB0_947:                              # %if.then2983
...
.LBB0_968:                              # %sw.default2695
	...
	move	$a0, $s6
	b	.LBB0_718
.LBB0_969:                              # %if.then3380
	move	$a0, $s4
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	move	$a2, $s7
	b	.LBB0_945
.LBB0_970:                              # %if.then3385
	pcalau12i	$a0, %pc_hi20(.L.str.164)
	addi.d	$a0, $a0, %pc_lo12(.L.str.164)
	move	$a1, $s2
	pcaddu18i	$ra, %call36(cli_dbgmsg)
...
.LBB0_978:                              # %sw.bb3426
	...
	jirl	$ra, $ra, 0
	move	$a0, $s7
.LBB0_979:                              # %if.then3742
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	b	.LBB0_698
.LBB0_980:                              # %sw.default3429
	pcalau12i	$a0, %pc_hi20(.L.str.168)
	addi.d	$a0, $a0, %pc_lo12(.L.str.168)
	pcaddu18i	$ra, %call36(cli_dbgmsg)
	jirl	$ra, $ra, 0
