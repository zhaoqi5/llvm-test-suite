...
.LBB0_49:                               #   in Loop: Header=BB0_12 Depth=2
	ld.d	$s3, $sp, 88                    # 8-byte Folded Reload
	ld.d	$s0, $sp, 64                    # 8-byte Folded Reload
.LBB0_50:                               # %while.body129.i.i.preheader210
                                        #   in Loop: Header=BB0_12 Depth=2
	move	$a1, $s2
	.p2align	4, , 16
...
.LBB0_82:                               # %if.then195
	...
	jirl	$ra, $ra, 0
	b	.LBB0_92
.LBB0_83:                               # %vector.ph200
	bstrpick.d	$a0, $s2, 15, 1
	slli.d	$a0, $a0, 1
	addi.d	$a1, $fp, 36
	move	$a2, $a0
.LBB0_84:                               # %vector.body203
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a3, $a1, -36
	ld.d	$a4, $a1, 0
	st.d	$a3, $a1, -28
	...
	addi.d	$a1, $a1, 72
	bnez	$a2, .LBB0_84
# %bb.85:                               # %middle.block206
	beq	$a0, $s2, .LBB0_88
.LBB0_86:                               # %for.body204.preheader209
	slli.d	$a1, $a0, 5
	alsl.d	$a1, $a0, $a1, 2
	add.d	$a1, $a1, $fp
	addi.d	$a1, $a1, 8
