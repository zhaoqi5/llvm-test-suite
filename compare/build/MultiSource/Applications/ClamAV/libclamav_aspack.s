...
.LBB0_24:                               # %if.end11.i.if.end48.i_crit_edge.i
	...
	ld.w	$s4, $sp, 192
	b	.LBB0_27
.LBB0_25:                               # %if.end26.cleanup_crit_edge.i.i
                                        #   in Loop: Header=BB0_12 Depth=2
	ld.w	$a3, $sp, 196
.LBB0_26:                               # %cleanup.i.i
                                        #   in Loop: Header=BB0_12 Depth=2
...
.LBB0_49:                               #   in Loop: Header=BB0_12 Depth=2
	ld.d	$s3, $sp, 104                   # 8-byte Folded Reload
.LBB0_50:                               # %while.body129.i.i.preheader206
                                        #   in Loop: Header=BB0_12 Depth=2
	move	$a1, $s2
	.p2align	4, , 16
...
.LBB0_81:                               # %if.then195
	...
	jirl	$ra, $ra, 0
	b	.LBB0_91
.LBB0_82:                               # %vector.ph196
	bstrpick.d	$a0, $s2, 15, 1
	slli.d	$a0, $a0, 1
	addi.d	$a1, $fp, 36
	move	$a2, $a0
.LBB0_83:                               # %vector.body199
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a5, $a1, -36
	ld.d	$a4, $a1, 0
	st.d	$a5, $a1, -28
	...
	addi.d	$a1, $a1, 72
	bnez	$a2, .LBB0_83
# %bb.84:                               # %middle.block202
	beq	$a0, $s2, .LBB0_87
.LBB0_85:                               # %for.body204.preheader205
	slli.d	$a1, $a0, 5
	alsl.d	$a1, $a0, $a1, 2
	add.d	$a1, $a1, $fp
	addi.d	$a1, $a1, 8
