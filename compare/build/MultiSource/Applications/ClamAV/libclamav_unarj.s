...
.LBB7_55:                               # %vector.body41
	...
	addi.d	$s3, $s3, 64
	bnez	$s5, .LBB7_55
# %bb.56:                               # %middle.block44
                                        #   in Loop: Header=BB7_41 Depth=1
	beq	$s2, $s4, .LBB7_39
# %bb.57:                               # %vec.epilog.iter.check49
                                        #   in Loop: Header=BB7_41 Depth=1
	andi	$s3, $s2, 24
	beqz	$s3, .LBB7_61
.LBB7_58:                               # %vec.epilog.ph48
                                        #   in Loop: Header=BB7_41 Depth=1
	move	$s5, $s2
	...
	sub.d	$s4, $s4, $s5
	.p2align	4, , 16
.LBB7_59:                               # %vec.epilog.vector.body56
                                        #   Parent Loop BB7_41 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr0, $s1, 0
	addi.d	$s4, $s4, 8
	addi.d	$s1, $s1, 16
	bnez	$s4, .LBB7_59
# %bb.60:                               # %vec.epilog.middle.block60
                                        #   in Loop: Header=BB7_41 Depth=1
	beq	$s2, $s5, .LBB7_39
	b	.LBB7_62
