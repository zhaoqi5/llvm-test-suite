...
.LBB2_24:                               # %while.body.i.i.i
	...
	ori	$a1, $zero, 19
	blt	$s2, $a1, .LBB2_28
# %bb.25:                               # %do.body.preheader.i.i.i
                                        #   in Loop: Header=BB2_24 Depth=2
	ori	$a1, $zero, 128
	.p2align	4, , 16
.LBB2_26:                               # %do.body.i.i.i
                                        #   Parent Loop BB2_21 Depth=1
...
.LBB2_28:                               # %if.end47.i.i.i
	...
	ori	$a0, $zero, 2
	blt	$a0, $s2, .LBB2_32
# %bb.29:                               # %if.then55.i.i.i
                                        #   in Loop: Header=BB2_24 Depth=2
	xvld	$xr0, $sp, 48                   # 32-byte Folded Reload
	beqz	$s2, .LBB2_34
# %bb.30:                               # %if.then55.i.i.i
                                        #   in Loop: Header=BB2_24 Depth=2
...
# %bb.31:                               #   in Loop: Header=BB2_24 Depth=2
	...
	ori	$a0, $zero, 12
	b	.LBB2_36
.LBB2_32:                               # %if.else89.i.i.i
                                        #   in Loop: Header=BB2_24 Depth=2
	ext.w.h	$a0, $s3
	ori	$a1, $zero, 510
	ori	$a4, $zero, 509
	bge	$a0, $a1, .LBB2_79
# %bb.33:                               # %if.end94.i.i.i
                                        #   in Loop: Header=BB2_24 Depth=2
	addi.d	$a1, $s2, -2
	addi.d	$s3, $s3, 1
	...
	stx.b	$a1, $a2, $a0
	b	.LBB2_44
.LBB2_34:                               #   in Loop: Header=BB2_24 Depth=2
	ori	$a0, $zero, 1
	b	.LBB2_37
.LBB2_35:                               # %if.else68.i.i.i
                                        #   in Loop: Header=BB2_24 Depth=2
	ori	$a0, $zero, 20
	st.d	$a0, $sp, 40                    # 8-byte Folded Spill
	ori	$a1, $zero, 9
	ori	$a0, $zero, 7
.LBB2_36:                               # %while.body79.preheader.sink.split.i.i.i
                                        #   in Loop: Header=BB2_24 Depth=2
	ld.hu	$a2, $sp, 1186
	srl.d	$s2, $a2, $a0
	addi.d	$a0, $sp, 1168
	...
	add.d	$a0, $s2, $a0
	xvld	$xr0, $sp, 48                   # 32-byte Folded Reload
.LBB2_37:                               # %while.body79.preheader.i.i.i
                                        #   in Loop: Header=BB2_24 Depth=2
	ext.w.h	$a1, $s3
	addi.d	$a2, $a0, -1
...
.LBB2_39:                               # %vector.body44
	...
	addi.d	$a1, $a1, 64
	bnez	$a3, .LBB2_39
# %bb.40:                               #   in Loop: Header=BB2_24 Depth=2
	move	$a1, $a2
.LBB2_41:                               # %while.body79.i.i.i.preheader
                                        #   in Loop: Header=BB2_24 Depth=2
	ori	$a4, $zero, 509
	.p2align	4, , 16
.LBB2_42:                               # %while.body79.i.i.i
                                        #   Parent Loop BB2_21 Depth=1
                                        #     Parent Loop BB2_24 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ori	$a2, $zero, 510
	beq	$a1, $a2, .LBB2_52
# %bb.43:                               # %if.end84.i.i.i
	...
	ori	$a3, $zero, 1
	blt	$a3, $a2, .LBB2_42
.LBB2_44:                               # %if.end101.i.i.i
                                        #   in Loop: Header=BB2_24 Depth=2
	ext.w.h	$a0, $s3
	ld.d	$a1, $sp, 96                    # 8-byte Folded Reload
	blt	$a0, $a1, .LBB2_24
# %bb.45:                               # %while.cond103.preheader.i.i.i
                                        #   in Loop: Header=BB2_21 Depth=1
	ld.d	$s2, $sp, 120                   # 8-byte Folded Reload
	blt	$a4, $a0, .LBB2_47
# %bb.46:                               # %while.body107.lr.ph.i.i.i
                                        #   in Loop: Header=BB2_21 Depth=1
...
# %bb.59:                               # %if.else.i
	...
	ori	$a1, $zero, 17
	bltu	$s2, $a1, .LBB2_63
# %bb.60:                               # %do.body.preheader.i44.i
                                        #   in Loop: Header=BB2_21 Depth=1
	ori	$a1, $zero, 128
	.p2align	4, , 16
.LBB2_61:                               # %do.body.i45.i
                                        #   Parent Loop BB2_21 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	bstrpick.d	$a2, $s2, 15, 0
	bgeu	$a2, $s5, .LBB2_65
...
# %bb.68:                               # %if.end44.i
	...
	ori	$a5, $zero, 509
	bgeu	$a0, $s6, .LBB2_75
# %bb.69:                               # %while.body61.preheader.i
                                        #   in Loop: Header=BB2_21 Depth=1
	move	$a1, $s6
	ld.d	$s2, $sp, 120                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB2_70:                               # %while.body61.i
                                        #   Parent Loop BB2_21 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a2, $sp, 1176
	ldx.b	$a3, $a2, $a0
	...
	addi.w	$s6, $s6, 1
	bltu	$a2, $a1, .LBB2_78
# %bb.71:                               # %while.body61.i
                                        #   in Loop: Header=BB2_70 Depth=2
	ext.w.h	$a3, $a0
	blt	$a2, $a3, .LBB2_78
# %bb.72:                               # %while.body61.i
                                        #   in Loop: Header=BB2_70 Depth=2
	addi.d	$a0, $a0, 1
	addi.d	$a2, $s3, -1
	ext.w.h	$s3, $a2
	...
	bgez	$s3, .LBB2_70
	b	.LBB2_78
.LBB2_73:                               #   in Loop: Header=BB2_21 Depth=1
	ori	$a5, $zero, 509
	b	.LBB2_75
	.p2align	4, , 16
.LBB2_74:                               # %if.end90.i
...
# %bb.76:                               # %if.then86.i
	...
	move	$s6, $zero
	b	.LBB2_74
.LBB2_77:                               #   in Loop: Header=BB2_21 Depth=1
	ld.d	$s2, $sp, 120                   # 8-byte Folded Reload
.LBB2_78:                               # %if.end99.i
                                        #   in Loop: Header=BB2_21 Depth=1
	ld.d	$s3, $sp, 136                   # 8-byte Folded Reload
...
.LBB4_31:                               #   in Loop: Header=BB4_7 Depth=1
	...
	move	$a1, $a0
	b	.LBB4_41
.LBB4_32:                               # %if.end26.i42
                                        #   in Loop: Header=BB4_7 Depth=1
	bne	$a2, $s7, .LBB4_46
# %bb.33:                               # %if.end.1.thread.i80
                                        #   in Loop: Header=BB4_7 Depth=1
	st.d	$a5, $sp, 24                    # 8-byte Folded Spill
	ld.h	$a1, $sp, 66
	or	$a0, $a1, $a0
...
# %bb.34:                               #   in Loop: Header=BB4_7 Depth=1
	...
	ori	$s6, $zero, 512
	b	.LBB4_40
.LBB4_35:                               # %if.end26.2.i
                                        #   in Loop: Header=BB4_7 Depth=1
	bstrpick.d	$a3, $s6, 15, 0
	ori	$a2, $zero, 2
	bgeu	$a3, $a2, .LBB4_48
# %bb.36:                               # %if.end.3.thread.i
                                        #   in Loop: Header=BB4_7 Depth=1
	ld.h	$a0, $sp, 66
	or	$a0, $a0, $a1
	st.h	$a0, $sp, 82
...
# %bb.63:                               #   in Loop: Header=BB4_7 Depth=1
	...
	ori	$s8, $zero, 4
	b	.LBB4_21
.LBB4_64:                               # %if.end26.4.i
                                        #   in Loop: Header=BB4_7 Depth=1
	bstrpick.d	$a3, $s6, 15, 0
	ori	$a2, $zero, 2
	bgeu	$a3, $a2, .LBB4_67
# %bb.65:                               # %if.end.5.thread.i
                                        #   in Loop: Header=BB4_7 Depth=1
	ld.h	$a0, $sp, 66
	or	$a0, $a0, $a1
	st.h	$a0, $sp, 82
...
# %bb.13:                               # %middle.block
	addi.w	$a2, $a2, 0
	beq	$a2, $a0, .LBB5_16
.LBB5_14:                               # %while.body.us.preheader40
	ori	$a0, $zero, 16
	.p2align	4, , 16
...
# %bb.13:                               # %while.body55
	...
	blt	$a2, $s6, .LBB6_12
	b	.LBB6_2
.LBB6_14:                               # %while.cond63.preheader
	ori	$a0, $zero, 18
	blt	$a0, $a1, .LBB6_16
# %bb.15:                               # %while.body70.lr.ph
	add.d	$a0, $s1, $a1
	ori	$a2, $zero, 19
	sub.d	$a1, $a2, $a1
...
# %bb.50:                               #   in Loop: Header=BB7_40 Depth=1
	move	$s2, $s0
	b	.LBB7_60
.LBB7_51:                               # %vector.main.loop.iter.check30
                                        #   in Loop: Header=BB7_40 Depth=1
	bgeu	$s1, $t6, .LBB7_53
...
.LBB7_54:                               # %vector.body36
	...
	addi.d	$s4, $s4, 64
	bnez	$s5, .LBB7_54
# %bb.55:                               # %middle.block39
                                        #   in Loop: Header=BB7_40 Depth=1
	beq	$s1, $s3, .LBB7_38
# %bb.56:                               # %vec.epilog.iter.check43
                                        #   in Loop: Header=BB7_40 Depth=1
	beqz	$s2, .LBB7_62
.LBB7_57:                               # %vec.epilog.ph45
                                        #   in Loop: Header=BB7_40 Depth=1
	move	$s4, $s1
	...
	sub.d	$s3, $s3, $s4
	.p2align	4, , 16
.LBB7_58:                               # %vec.epilog.vector.body50
                                        #   Parent Loop BB7_40 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr0, $s0, 0
	addi.d	$s3, $s3, 8
	addi.d	$s0, $s0, 16
	bnez	$s3, .LBB7_58
# %bb.59:                               # %vec.epilog.middle.block54
                                        #   in Loop: Header=BB7_40 Depth=1
	beq	$s1, $s4, .LBB7_38
.LBB7_60:                               # %for.body108.preheader
                                        #   in Loop: Header=BB7_40 Depth=1
	alsl.d	$s0, $s2, $a4, 1
	.p2align	4, , 16
.LBB7_61:                               # %for.body108
