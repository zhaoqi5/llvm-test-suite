...
# %bb.60:                               # %if.else.i
	...
	ori	$a1, $zero, 17
	bltu	$s1, $a1, .LBB2_64
# %bb.61:                               # %do.body.preheader.i44.i
                                        #   in Loop: Header=BB2_20 Depth=1
	ori	$a1, $zero, 128
	ori	$a5, $zero, 16
	.p2align	4, , 16
.LBB2_62:                               # %do.body.i45.i
                                        #   Parent Loop BB2_20 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	bstrpick.d	$a2, $s1, 15, 0
	bgeu	$a2, $s5, .LBB2_66
...
# %bb.69:                               # %if.end44.i
	...
	ori	$a5, $zero, 509
	bgeu	$a0, $s6, .LBB2_76
# %bb.70:                               # %while.body61.preheader.i
                                        #   in Loop: Header=BB2_20 Depth=1
	move	$a1, $s6
	lu12i.w	$s3, 1
	.p2align	4, , 16
.LBB2_71:                               # %while.body61.i
                                        #   Parent Loop BB2_20 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a2, $sp, 1160
	ldx.b	$a3, $a2, $a0
...
.LBB7_53:                               # %vec.epilog.ph45
	...
	sub.d	$s3, $s3, $s4
	.p2align	4, , 16
.LBB7_54:                               # %vec.epilog.vector.body50
                                        #   Parent Loop BB7_40 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr0, $s0, 0
	addi.d	$s3, $s3, 8
	addi.d	$s0, $s0, 16
	bnez	$s3, .LBB7_54
# %bb.55:                               # %vec.epilog.middle.block54
                                        #   in Loop: Header=BB7_40 Depth=1
	beq	$s1, $s4, .LBB7_38
	b	.LBB7_61
.LBB7_56:                               # %vector.ph31
...
.LBB7_57:                               # %vector.body36
	...
	addi.d	$s4, $s4, 32
	bnez	$s5, .LBB7_57
# %bb.58:                               # %middle.block39
                                        #   in Loop: Header=BB7_40 Depth=1
	beq	$s1, $s3, .LBB7_38
# %bb.59:                               # %vec.epilog.iter.check43
                                        #   in Loop: Header=BB7_40 Depth=1
	bnez	$s2, .LBB7_53
# %bb.60:                               #   in Loop: Header=BB7_40 Depth=1
	add.d	$s2, $s3, $s0
.LBB7_61:                               # %for.body108.preheader
                                        #   in Loop: Header=BB7_40 Depth=1
	alsl.d	$s0, $s2, $a4, 1
	.p2align	4, , 16
.LBB7_62:                               # %for.body108
