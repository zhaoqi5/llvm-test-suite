...
.LBB4_32:                               #   in Loop: Header=BB4_6 Depth=1
	move	$s5, $s8
	move	$a1, $a0
.LBB4_33:                               # %decode_ptr.exit
                                        #   in Loop: Header=BB4_6 Depth=1
	ld.d	$s8, $sp, 48                    # 8-byte Folded Reload
	b	.LBB4_43
.LBB4_34:                               # %if.end26.i42
                                        #   in Loop: Header=BB4_6 Depth=1
	bne	$a2, $s4, .LBB4_48
# %bb.35:                               # %if.end.1.thread.i80
                                        #   in Loop: Header=BB4_6 Depth=1
	st.d	$a6, $sp, 24                    # 8-byte Folded Spill
	st.d	$a5, $sp, 32                    # 8-byte Folded Spill
	ld.h	$a1, $sp, 82
...
# %bb.36:                               #   in Loop: Header=BB4_6 Depth=1
	...
	ori	$a3, $zero, 512
	b	.LBB4_42
.LBB4_37:                               # %if.end26.2.i
                                        #   in Loop: Header=BB4_6 Depth=1
	bstrpick.d	$a3, $s6, 15, 0
	ori	$a2, $zero, 2
	bgeu	$a3, $a2, .LBB4_50
# %bb.38:                               # %if.end.3.thread.i
                                        #   in Loop: Header=BB4_6 Depth=1
	ld.h	$a0, $sp, 82
	or	$a0, $a0, $a1
	st.h	$a0, $sp, 98
...
# %bb.41:                               #   in Loop: Header=BB4_6 Depth=1
	...
	ori	$a3, $zero, 512
	move	$a1, $a0
.LBB4_42:                               # %decode_ptr.exit
                                        #   in Loop: Header=BB4_6 Depth=1
	ld.d	$a5, $sp, 32                    # 8-byte Folded Reload
	ld.d	$a6, $sp, 24                    # 8-byte Folded Reload
.LBB4_43:                               # %decode_ptr.exit
                                        #   in Loop: Header=BB4_6 Depth=1
	ori	$a4, $zero, 16
	sub.d	$a0, $a4, $s3
	bstrpick.d	$a2, $a1, 15, 0
...
# %bb.65:                               #   in Loop: Header=BB4_6 Depth=1
	...
	ori	$a5, $zero, 4
	b	.LBB4_22
.LBB4_66:                               # %if.end26.4.i
                                        #   in Loop: Header=BB4_6 Depth=1
	bstrpick.d	$a3, $s6, 15, 0
	ori	$a2, $zero, 2
	bgeu	$a3, $a2, .LBB4_69
# %bb.67:                               # %if.end.5.thread.i
                                        #   in Loop: Header=BB4_6 Depth=1
	ld.h	$a0, $sp, 82
	or	$a0, $a0, $a1
	st.h	$a0, $sp, 98
