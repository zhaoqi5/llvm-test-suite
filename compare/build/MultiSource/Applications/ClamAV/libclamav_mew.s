...
.LBB0_166:                              # %if.else89.us
	...
	ori	$a7, $zero, 13
	bgeu	$a7, $a6, .LBB0_192
# %bb.167:                              # %do.body.i336.preheader.us
                                        #   in Loop: Header=BB0_20 Depth=2
	move	$a6, $zero
	addi.d	$a7, $t0, -5
	st.w	$a7, $sp, 352
...
# %bb.213:                              # %do.body384.us.preheader
	...
	ori	$a7, $zero, 16
	bgeu	$a3, $a7, .LBB0_218
.LBB0_214:                              # %do.body384.us.preheader1293
                                        #   in Loop: Header=BB0_20 Depth=2
	addi.w	$a2, $a2, -1
	move	$a1, $s4
