...
# %bb.87:                               # %if.then49.i604.us
	...
	or	$a4, $t0, $a4
	bltu	$a7, $t4, .LBB0_80
.LBB0_88:                               #   in Loop: Header=BB0_11 Depth=2
	st.d	$t5, $sp, 256                   # 8-byte Folded Spill
.LBB0_89:                               # %if.end489.us.sink.split
                                        #   in Loop: Header=BB0_11 Depth=2
	st.d	$a5, $sp, 296
.LBB0_90:                               # %if.end489.us
                                        #   in Loop: Header=BB0_11 Depth=2
...
# %bb.99:                               # %if.then26.i478.us
	...
	move	$a7, $a1
	b	.LBB0_165
.LBB0_100:                              #   in Loop: Header=BB0_11 Depth=2
	move	$a2, $a7
	st.w	$t1, $sp, 308
	bgeu	$t0, $t2, .LBB0_95
...
# %bb.108:                              # %if.then49.i.i.us
	...
	st.d	$a6, $sp, 312
	b	.LBB0_110
.LBB0_109:                              #   in Loop: Header=BB0_11 Depth=2
	move	$a6, $a5
.LBB0_110:                              # %if.end.i329.us
                                        #   in Loop: Header=BB0_11 Depth=2
	add.d	$a5, $a4, $a7
	bltu	$s3, $a5, .LBB0_245
...
# %bb.117:                              # %if.then49.i.i.us.1
	...
	st.d	$a5, $sp, 312
	b	.LBB0_119
.LBB0_118:                              #   in Loop: Header=BB0_11 Depth=2
	move	$a5, $a6
.LBB0_119:                              # %if.end.i329.us.1
                                        #   in Loop: Header=BB0_11 Depth=2
	or	$a7, $t1, $a7
	alsl.d	$a6, $a7, $a4, 1
	bltu	$s3, $a6, .LBB0_245
...
# %bb.126:                              # %if.then49.i.i.us.2
	...
	st.d	$a6, $sp, 312
	b	.LBB0_128
.LBB0_127:                              #   in Loop: Header=BB0_11 Depth=2
	move	$a6, $a5
.LBB0_128:                              # %if.end.i329.us.2
                                        #   in Loop: Header=BB0_11 Depth=2
	or	$t0, $t0, $t1
	alsl.d	$a5, $t0, $a4, 1
	bltu	$s3, $a5, .LBB0_245
...
# %bb.135:                              # %if.then49.i.i.us.3
	...
	st.d	$a5, $sp, 312
	b	.LBB0_137
.LBB0_136:                              #   in Loop: Header=BB0_11 Depth=2
	move	$a5, $a6
.LBB0_137:                              # %if.end.i329.us.3
                                        #   in Loop: Header=BB0_11 Depth=2
	or	$a7, $a7, $t1
	alsl.d	$a6, $a7, $a4, 1
	bltu	$s3, $a6, .LBB0_245
...
# %bb.144:                              # %if.then49.i.i.us.4
	...
	st.d	$a6, $sp, 312
	b	.LBB0_146
.LBB0_145:                              #   in Loop: Header=BB0_11 Depth=2
	move	$a6, $a5
.LBB0_146:                              # %if.end.i329.us.4
                                        #   in Loop: Header=BB0_11 Depth=2
	or	$a5, $t0, $t1
	alsl.d	$a4, $a5, $a4, 1
	bltu	$s3, $a4, .LBB0_245
...
# %bb.153:                              # %if.then49.i.i.us.5
	...
	move	$t0, $a4
	b	.LBB0_155
.LBB0_154:                              #   in Loop: Header=BB0_11 Depth=2
	move	$a4, $a6
.LBB0_155:                              # %if.end.i329.us.5
                                        #   in Loop: Header=BB0_11 Depth=2
	slli.d	$a5, $a5, 1
	or	$a5, $a7, $a5
	st.d	$t0, $sp, 296
...
.LBB0_157:                              # %if.else89.us
	...
	ori	$a7, $zero, 13
	bgeu	$a7, $a6, .LBB0_182
# %bb.158:                              # %do.body.i336.preheader.us
                                        #   in Loop: Header=BB0_11 Depth=2
	move	$a6, $zero
	addi.d	$a7, $t0, -5
	st.w	$a7, $sp, 304
...
.LBB0_180:                              #   in Loop: Header=BB0_11 Depth=2
	...
	b	.LBB0_188
.LBB0_181:                              #   in Loop: Header=BB0_11 Depth=2
	st.d	$s6, $sp, 8                     # 8-byte Folded Spill
	move	$fp, $t5
...
.LBB0_182:                              # %if.end110.us
	...
	alsl.d	$a6, $a6, $a7, 1
	b	.LBB0_217
.LBB0_183:                              # %while.cond33.preheader.i.us
                                        #   in Loop: Header=BB0_11 Depth=2
	st.d	$a5, $sp, 296
	bgeu	$t8, $t3, .LBB0_54
	b	.LBB0_90
.LBB0_184:                              # %if.else.i503.us
                                        #   in Loop: Header=BB0_11 Depth=2
	sub.d	$t1, $a7, $a4
	sub.w	$a4, $t0, $a4
	st.w	$t1, $sp, 324
...
# %bb.186:                              # %if.then49.i516.us
	...
	st.w	$a4, $sp, 320
	st.d	$a1, $sp, 312
.LBB0_187:                              # %lzma_486248.exit526.us
                                        #   in Loop: Header=BB0_11 Depth=2
	sltu	$a2, $a7, $a2
	...
	or	$a2, $a2, $a3
	st.d	$a2, $sp, 152                   # 8-byte Folded Spill
.LBB0_188:                              # %if.end152.us
                                        #   in Loop: Header=BB0_11 Depth=2
	move	$fp, $t5
	st.w	$a1, $sp, 308
	ld.d	$s6, $sp, 288                   # 8-byte Folded Reload
	st.d	$a1, $sp, 288                   # 8-byte Folded Spill
.LBB0_189:                              # %if.end229.us
                                        #   in Loop: Header=BB0_11 Depth=2
	ld.d	$a6, $sp, 240                   # 8-byte Folded Reload
...
.LBB0_191:                              # %if.end239.us
                                        #   in Loop: Header=BB0_11 Depth=2
	beqz	$t3, .LBB0_234
# %bb.192:                              # %if.else242.us
                                        #   in Loop: Header=BB0_11 Depth=2
	addi.w	$a2, $a1, 2
	st.d	$s8, $sp, 296
	st.w	$s1, $sp, 308
...
# %bb.196:                              # %land.lhs.true291.us
	...
	bltu	$a6, $a5, .LBB0_244
# %bb.197:                              # %land.lhs.true291.us
                                        #   in Loop: Header=BB0_11 Depth=2
	or	$a5, $a5, $ra
	beqz	$a5, .LBB0_244
.LBB0_198:                              # %land.lhs.true310.us
                                        #   in Loop: Header=BB0_11 Depth=2
	beq	$s0, $s1, .LBB0_244
# %bb.199:                              # %land.lhs.true310.us
                                        #   in Loop: Header=BB0_11 Depth=2
	bltu	$t0, $a4, .LBB0_244
...
# %bb.201:                              # %land.lhs.true323.us
	...
	bge	$a6, $a5, .LBB0_244
# %bb.202:                              # %land.lhs.true323.us
                                        #   in Loop: Header=BB0_11 Depth=2
	ld.d	$a5, $sp, 168                   # 8-byte Folded Reload
	bltu	$s3, $a5, .LBB0_244
# %bb.203:                              # %do.body384.us.preheader
                                        #   in Loop: Header=BB0_11 Depth=2
	addi.w	$a5, $s1, 1
	sltu	$a6, $a5, $s0
	masknez	$a5, $a5, $a6
	...
	ori	$a7, $zero, 64
	bgeu	$a3, $a7, .LBB0_207
.LBB0_204:                              # %do.body384.us.preheader1108
                                        #   in Loop: Header=BB0_11 Depth=2
	addi.w	$a2, $a2, -1
	move	$a1, $s1
	.p2align	4, , 16
.LBB0_205:                              # %do.body384.us
                                        #   Parent Loop BB0_3 Depth=1
                                        #     Parent Loop BB0_11 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	...
	addi.w	$a1, $a1, 1
	beqz	$a3, .LBB0_214
# %bb.206:                              # %do.body384.us
                                        #   in Loop: Header=BB0_205 Depth=3
	addi.w	$a0, $a0, 1
	bltu	$a1, $s0, .LBB0_205
	b	.LBB0_214
.LBB0_207:                              # %vector.scevcheck
                                        #   in Loop: Header=BB0_11 Depth=2
	addi.w	$a5, $a5, 0
	bltu	$a5, $a6, .LBB0_204
...
# %bb.212:                              # %middle.block
                                        #   in Loop: Header=BB0_11 Depth=2
	bne	$a3, $a4, .LBB0_215
# %bb.213:                              #   in Loop: Header=BB0_11 Depth=2
	xvpermi.d	$xr0, $xr0, 14
	vpickve2gr.b	$a4, $vr0, 15
.LBB0_214:                              # %do.cond520.loopexit.us
                                        #   in Loop: Header=BB0_11 Depth=2
	st.w	$a1, $sp, 304
	ori	$a3, $zero, 1
	move	$s1, $a1
	...
	bltu	$s1, $s0, .LBB0_11
	b	.LBB0_234
.LBB0_215:                              #   in Loop: Header=BB0_11 Depth=2
	move	$s1, $a1
	b	.LBB0_204
.LBB0_216:                              # %if.end110.thread.us
                                        #   in Loop: Header=BB0_11 Depth=2
	st.w	$a2, $sp, 324
	st.w	$a6, $sp, 308
	alsl.w	$a5, $a6, $a5, 4
...
.LBB0_217:                              # %do.body.preheader.i343.us
                                        #   in Loop: Header=BB0_11 Depth=2
	st.d	$a6, $sp, 296
	addi.d	$t3, $a6, 2
	ori	$a7, $zero, 1
	st.w	$a7, $sp, 304
	bltu	$t3, $s2, .LBB0_245
# %bb.218:                              # %do.body.preheader.i343.us
                                        #   in Loop: Header=BB0_11 Depth=2
	addi.d	$a7, $a6, 6
	bltu	$s7, $a7, .LBB0_245
# %bb.219:                              # %land.lhs.true13.i.i357.lr.ph.us
                                        #   in Loop: Header=BB0_11 Depth=2
	bltu	$a4, $s2, .LBB0_245
# %bb.220:                              # %land.lhs.true13.i.i357.lr.ph.us
                                        #   in Loop: Header=BB0_11 Depth=2
	addi.d	$t2, $a4, 1
	bltu	$s7, $t2, .LBB0_245
# %bb.221:                              # %if.end.i.i363.us.preheader
                                        #   in Loop: Header=BB0_11 Depth=2
	move	$a7, $zero
	move	$t0, $zero
	addi.w	$t1, $t1, -1
...
# %bb.226:                              # %if.then49.i.i385.us
	...
	b	.LBB0_228
	.p2align	4, , 16
.LBB0_227:                              #   in Loop: Header=BB0_222 Depth=3
	move	$a3, $t6
	move	$t2, $t3
.LBB0_228:                              # %if.end4.i.us
                                        #   in Loop: Header=BB0_222 Depth=3
	or	$t3, $t5, $t4
	sll.w	$t4, $t5, $t0
	or	$a7, $t4, $a7
...
# %bb.231:                              # %land.lhs.true13.i.i357.us
                                        #   in Loop: Header=BB0_222 Depth=3
	bltu	$a4, $s2, .LBB0_245
# %bb.232:                              # %land.lhs.true13.i.i357.us
                                        #   in Loop: Header=BB0_222 Depth=3
	addi.d	$t2, $a4, 1
	addi.w	$t0, $t0, 1
	bgeu	$s7, $t2, .LBB0_222
...
.LBB0_241:                              # %if.then525
	...
	addi.w	$a0, $fp, -1
	bgeu	$a0, $s0, .LBB0_244
# %bb.242:                              # %land.lhs.true538
	bstrpick.d	$a0, $fp, 31, 0
	ld.d	$a1, $sp, 264                   # 8-byte Folded Reload
	add.d	$a1, $a1, $a0
	ld.d	$a0, $sp, 224                   # 8-byte Folded Reload
	bltu	$s3, $a1, .LBB0_245
# %bb.243:                              # %do.body552.preheader
	move	$a1, $zero
	ori	$a2, $zero, 232
	b	.LBB0_247
.LBB0_244:
...
.LBB5_14:                               # %if.then149
	...
	b	.LBB5_3
.LBB5_15:                               # %while.cond.outer.us272.preheader
	move	$s4, $a4
	sub.d	$a0, $a0, $s0
...
# %bb.35:                               # %if.end115.us.peel
	...
	ld.w	$a1, $a2, 0
	beqz	$a1, .LBB5_46
# %bb.36:                               # %while.cond.outer.us272.preheader305
	move	$a3, $zero
	sub.d	$a1, $s2, $s7
	add.w	$a1, $s1, $a1
	...
	move	$a1, $a0
.LBB5_37:                               # %while.cond.outer.us272
                                        # =>This Inner Loop Header: Depth=1
	move	$s2, $a3
