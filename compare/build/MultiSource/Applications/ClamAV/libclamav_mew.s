...
.LBB0_13:                               # %vector.body1269
	...
	xvstx	$xr0, $a5, $fp
	bnez	$a4, .LBB0_13
# %bb.14:                               # %vec.epilog.vector.body1278
...
.LBB0_62:                               #   in Loop: Header=BB0_20 Depth=2
	move	$a0, $a3
	b	.LBB0_186
.LBB0_63:                               #   in Loop: Header=BB0_20 Depth=2
	move	$a4, $a3
	addi.d	$a3, $a6, 2
	bne	$a6, $a5, .LBB0_62
...
# %bb.75:                               # %while.body.i.us
	...
	ori	$t1, $zero, 127
	bgeu	$t1, $t3, .LBB0_65
.LBB0_76:                               # %if.end489.us.sink.split
                                        #   in Loop: Header=BB0_20 Depth=2
	st.d	$a5, $sp, 296
.LBB0_77:                               # %if.end489.us
                                        #   in Loop: Header=BB0_20 Depth=2
...
# %bb.78:                               # %if.end516.us
	...
	stx.b	$a0, $s7, $a2
	b	.LBB0_179
.LBB0_79:                               # %if.else416.us
                                        #   in Loop: Header=BB0_20 Depth=2
	addi.w	$t5, $t5, -3
	bnez	$a5, .LBB0_38
.LBB0_80:                               # %if.then423.us
                                        #   in Loop: Header=BB0_20 Depth=2
	...
	st.w	$a5, $sp, 308
	bltu	$ra, $a4, .LBB0_249
# %bb.81:                               # %land.lhs.true13.i577.us.preheader
                                        #   in Loop: Header=BB0_20 Depth=2
	addi.d	$a7, $a2, 2
	ld.d	$a4, $sp, 288                   # 8-byte Folded Reload
	add.d	$a4, $a0, $a4
	ori	$a0, $zero, 2
	.p2align	4, , 16
.LBB0_82:                               # %land.lhs.true13.i577.us
                                        #   Parent Loop BB0_10 Depth=1
                                        #     Parent Loop BB0_20 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	bltu	$a3, $s2, .LBB0_249
# %bb.83:                               # %land.lhs.true13.i577.us
                                        #   in Loop: Header=BB0_82 Depth=3
	addi.d	$a5, $a3, 1
	bltu	$t6, $a5, .LBB0_249
# %bb.84:                               # %if.end.i583.us
                                        #   in Loop: Header=BB0_82 Depth=3
	ld.wu	$t1, $a7, 0
	bstrpick.d	$t0, $a6, 31, 11
	bstrpick.d	$t2, $t1, 15, 0
...
# %bb.88:                               # %if.then49.i604.us
	...
	b	.LBB0_90
	.p2align	4, , 16
.LBB0_89:                               #   in Loop: Header=BB0_82 Depth=3
	move	$a6, $t0
	move	$a5, $a7
.LBB0_90:                               # %if.end432.us
                                        #   in Loop: Header=BB0_82 Depth=3
	addi.w	$a7, $a0, 0
	bgeu	$a7, $t7, .LBB0_76
# %bb.91:                               # %do.body424.us
...
# %bb.96:                               # %land.lhs.true13.i445.us
                                        #   in Loop: Header=BB0_20 Depth=2
	bltu	$a3, $s2, .LBB0_249
# %bb.97:                               # %land.lhs.true13.i445.us
                                        #   in Loop: Header=BB0_20 Depth=2
	addi.d	$a4, $a3, 1
	bltu	$t6, $a4, .LBB0_249
# %bb.98:                               # %if.end.i451.us
                                        #   in Loop: Header=BB0_20 Depth=2
	ld.wu	$t2, $a2, 432
...
# %bb.102:                              # %land.lhs.true13.i533.us
                                        #   in Loop: Header=BB0_20 Depth=2
	bltu	$a3, $s2, .LBB0_249
# %bb.103:                              # %land.lhs.true13.i533.us
                                        #   in Loop: Header=BB0_20 Depth=2
	addi.d	$a2, $a3, 1
	bltu	$t6, $a2, .LBB0_249
# %bb.104:                              # %if.end.i539.us
                                        #   in Loop: Header=BB0_20 Depth=2
	ld.wu	$t0, $a4, 0
...
# %bb.111:                              # %land.lhs.true13.i.i.us.1
                                        #   in Loop: Header=BB0_20 Depth=2
	bltu	$a5, $s2, .LBB0_251
# %bb.112:                              # %land.lhs.true13.i.i.us.1
                                        #   in Loop: Header=BB0_20 Depth=2
	addi.d	$a6, $a5, 1
	bltu	$t6, $a6, .LBB0_251
# %bb.113:                              # %if.end.i.i.us.1
                                        #   in Loop: Header=BB0_20 Depth=2
	ldx.wu	$t2, $a3, $a7
...
# %bb.120:                              # %land.lhs.true13.i.i.us.2
                                        #   in Loop: Header=BB0_20 Depth=2
	bltu	$a6, $s2, .LBB0_251
# %bb.121:                              # %land.lhs.true13.i.i.us.2
                                        #   in Loop: Header=BB0_20 Depth=2
	addi.d	$a5, $a6, 1
	bltu	$t6, $a5, .LBB0_251
# %bb.122:                              # %if.end.i.i.us.2
                                        #   in Loop: Header=BB0_20 Depth=2
	slli.d	$t2, $t0, 1
	ldx.wu	$t3, $a3, $t2
	bstrpick.d	$a7, $t1, 31, 11
	bstrpick.d	$t0, $t3, 15, 0
	mul.d	$a7, $t0, $a7
	addi.w	$t4, $a7, 0
	bgeu	$a2, $t4, .LBB0_124
# %bb.123:                              # %if.then26.i.i.us.2
                                        #   in Loop: Header=BB0_20 Depth=2
	sub.d	$t0, $t8, $t0
	bstrpick.d	$t0, $t0, 31, 5
	add.w	$t1, $t0, $t3
...
.LBB0_124:                              # %if.else.i.i.us.2
	...
	sub.w	$t1, $t3, $t0
	ori	$t0, $t2, 1
.LBB0_125:                              # %if.end46.i.i.us.2
                                        #   in Loop: Header=BB0_20 Depth=2
	srli.d	$t3, $t3, 16
	bstrins.d	$t1, $t3, 63, 16
	st.w	$a7, $sp, 320
	bstrpick.d	$t3, $a7, 31, 24
	stx.w	$t1, $a3, $t2
	bnez	$t3, .LBB0_127
# %bb.126:                              # %if.then49.i.i.us.2
                                        #   in Loop: Header=BB0_20 Depth=2
	ld.bu	$a6, $a6, 0
	slli.w	$a2, $a2, 8
	or	$a2, $a2, $a6
...
# %bb.129:                              # %land.lhs.true13.i.i.us.3
                                        #   in Loop: Header=BB0_20 Depth=2
	bltu	$a5, $s2, .LBB0_251
# %bb.130:                              # %land.lhs.true13.i.i.us.3
                                        #   in Loop: Header=BB0_20 Depth=2
	addi.d	$a6, $a5, 1
	bltu	$t6, $a6, .LBB0_251
# %bb.131:                              # %if.end.i.i.us.3
                                        #   in Loop: Header=BB0_20 Depth=2
	slli.d	$t1, $t0, 1
	ldx.wu	$t2, $a3, $t1
	bstrpick.d	$t0, $a7, 31, 11
...
# %bb.138:                              # %land.lhs.true13.i.i.us.4
                                        #   in Loop: Header=BB0_20 Depth=2
	bltu	$a6, $s2, .LBB0_251
# %bb.139:                              # %land.lhs.true13.i.i.us.4
                                        #   in Loop: Header=BB0_20 Depth=2
	addi.d	$a5, $a6, 1
	bltu	$t6, $a5, .LBB0_251
# %bb.140:                              # %if.end.i.i.us.4
                                        #   in Loop: Header=BB0_20 Depth=2
	slli.d	$t2, $a7, 1
	ldx.wu	$t3, $a3, $t2
...
# %bb.141:                              # %if.then26.i.i.us.4
	...
	move	$t1, $t2
	b	.LBB0_143
.LBB0_142:                              # %if.else.i.i.us.4
                                        #   in Loop: Header=BB0_20 Depth=2
	sub.w	$a2, $a2, $a7
	sub.w	$a7, $t0, $a7
	st.w	$a2, $sp, 324
	bstrpick.d	$t0, $t1, 31, 5
	sub.w	$t0, $t3, $t0
	ori	$t1, $t2, 1
.LBB0_143:                              # %if.end46.i.i.us.4
                                        #   in Loop: Header=BB0_20 Depth=2
	srli.d	$t3, $t3, 16
...
# %bb.147:                              # %land.lhs.true13.i.i.us.5
                                        #   in Loop: Header=BB0_20 Depth=2
	bltu	$a5, $s2, .LBB0_251
# %bb.148:                              # %land.lhs.true13.i.i.us.5
                                        #   in Loop: Header=BB0_20 Depth=2
	addi.d	$a4, $a5, 1
	bltu	$t6, $a4, .LBB0_251
# %bb.149:                              # %if.end.i.i.us.5
                                        #   in Loop: Header=BB0_20 Depth=2
	alsl.d	$t0, $t1, $a3, 1
	ld.wu	$t2, $t0, 0
	...
	slli.d	$a6, $t1, 1
	bgeu	$a2, $t4, .LBB0_151
# %bb.150:                              # %if.then26.i.i.us.5
                                        #   in Loop: Header=BB0_20 Depth=2
	sub.d	$a7, $t8, $t3
	bstrpick.d	$a7, $a7, 31, 5
	add.w	$a7, $a7, $t2
	b	.LBB0_152
.LBB0_151:                              # %if.else.i.i.us.5
                                        #   in Loop: Header=BB0_20 Depth=2
	sub.w	$a2, $a2, $a3
	sub.w	$a3, $a7, $a3
	st.w	$a2, $sp, 324
	...
	sub.w	$a7, $t2, $a7
	ori	$a6, $a6, 1
.LBB0_152:                              # %if.end46.i.i.us.5
                                        #   in Loop: Header=BB0_20 Depth=2
	srli.d	$t1, $t2, 16
	bstrins.d	$a7, $t1, 63, 16
	st.w	$a3, $sp, 320
	bstrpick.d	$t1, $a3, 31, 24
	st.w	$a7, $t0, 0
	bnez	$t1, .LBB0_154
# %bb.153:                              # %if.then49.i.i.us.5
                                        #   in Loop: Header=BB0_20 Depth=2
	ld.bu	$a5, $a5, 0
	slli.w	$a2, $a2, 8
	or	$a2, $a2, $a5
...
.LBB0_155:                              # %if.end.i327.us.5
	...
	ori	$a5, $zero, 4
	bgeu	$a7, $a5, .LBB0_157
.LBB0_156:                              # %if.end116.us
                                        #   in Loop: Header=BB0_20 Depth=2
	addi.w	$t1, $a7, 1
	b	.LBB0_200
.LBB0_157:                              # %if.else89.us
                                        #   in Loop: Header=BB0_20 Depth=2
	...
	ori	$a6, $zero, 13
	bgeu	$a6, $a7, .LBB0_183
# %bb.158:                              # %do.body.i335.preheader.us
                                        #   in Loop: Header=BB0_20 Depth=2
	move	$a6, $zero
	addi.d	$a7, $t0, -5
	st.w	$a7, $sp, 304
	b	.LBB0_161
.LBB0_159:                              # %if.end20.i.us
	...
	st.d	$t1, $sp, 312
	move	$a4, $t1
.LBB0_160:                              # %if.end27.i.us
                                        #   in Loop: Header=BB0_161 Depth=3
	slli.d	$a6, $a6, 1
	addi.w	$a7, $a7, -1
	or	$a6, $a6, $t0
	beqz	$a7, .LBB0_226
.LBB0_161:                              # %do.body.i335.us
                                        #   Parent Loop BB0_10 Depth=1
                                        #     Parent Loop BB0_20 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	...
	sub.w	$a2, $a2, $t2
	bnez	$t1, .LBB0_160
# %bb.162:                              # %land.lhs.true9.i.us
                                        #   in Loop: Header=BB0_161 Depth=3
	bltu	$a4, $s2, .LBB0_251
# %bb.163:                              # %land.lhs.true11.i.us
                                        #   in Loop: Header=BB0_161 Depth=3
	addi.d	$t1, $a4, 1
	bgeu	$t6, $t1, .LBB0_159
	b	.LBB0_251
.LBB0_164:                              # %if.else.i459.us
                                        #   in Loop: Header=BB0_20 Depth=2
	sub.w	$a7, $a1, $t0
	sub.w	$t0, $a6, $t0
	st.w	$a7, $sp, 324
...
# %bb.168:                              # %land.lhs.true13.i489.us
                                        #   in Loop: Header=BB0_20 Depth=2
	bltu	$a4, $s2, .LBB0_249
# %bb.169:                              # %land.lhs.true13.i489.us
                                        #   in Loop: Header=BB0_20 Depth=2
	addi.d	$a1, $a4, 1
	bltu	$t6, $a1, .LBB0_249
# %bb.170:                              # %if.end.i495.us
                                        #   in Loop: Header=BB0_20 Depth=2
	ld.wu	$a6, $a2, 456
	bstrpick.d	$a3, $t0, 31, 11
	bstrpick.d	$t2, $a6, 15, 0
	mul.d	$a5, $t2, $a3
	addi.w	$a3, $a5, 0
	bgeu	$a7, $a3, .LBB0_193
# %bb.171:                              # %if.then26.i522.us
                                        #   in Loop: Header=BB0_20 Depth=2
	sub.d	$t0, $t8, $t2
	bstrpick.d	$t0, $t0, 31, 5
	add.w	$t0, $t0, $a6
...
# %bb.174:                              # %if.then49.i560.us
	...
	st.w	$a4, $sp, 320
	st.d	$a2, $sp, 312
.LBB0_175:                              # %lzma_486248.exit570.us
                                        #   in Loop: Header=BB0_20 Depth=2
	st.w	$a6, $sp, 308
	bgeu	$a1, $a5, .LBB0_182
# %bb.176:                              # %if.then165.us
                                        #   in Loop: Header=BB0_20 Depth=2
...
.LBB0_183:                              # %if.end110.us
	...
	addi.d	$a6, $a6, 1374
	b	.LBB0_227
.LBB0_184:                              # %while.cond33.preheader.i.us
                                        #   in Loop: Header=BB0_20 Depth=2
	st.d	$a5, $sp, 296
	ori	$a3, $zero, 127
	bgeu	$a3, $t3, .LBB0_186
	b	.LBB0_77
	.p2align	4, , 16
.LBB0_185:                              # %if.end44.i.us
                                        #   in Loop: Header=BB0_186 Depth=3
	addi.w	$a3, $a0, 0
	move	$t0, $a6
	bgeu	$a3, $t7, .LBB0_76
.LBB0_186:                              # %while.body36.i.us
                                        #   Parent Loop BB0_10 Depth=1
                                        #     Parent Loop BB0_20 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	bltu	$a4, $s2, .LBB0_249
# %bb.187:                              # %while.body36.i.us
                                        #   in Loop: Header=BB0_186 Depth=3
	addi.d	$a3, $a4, 1
	bltu	$t6, $a3, .LBB0_249
# %bb.188:                              # %if.end.i98.i.us
                                        #   in Loop: Header=BB0_186 Depth=3
	slli.d	$a0, $a0, 1
	addi.w	$a5, $a0, 0
	add.d	$a5, $a2, $a5
	ld.wu	$a7, $a5, 0
	bstrpick.d	$a6, $t0, 31, 11
	bstrpick.d	$t1, $a7, 15, 0
	mul.d	$a6, $t1, $a6
	addi.w	$t2, $a6, 0
	bgeu	$a1, $t2, .LBB0_190
# %bb.189:                              # %if.then26.i125.i.us
                                        #   in Loop: Header=BB0_186 Depth=3
	sub.d	$t0, $t8, $t1
	bstrpick.d	$t0, $t0, 31, 5
	add.w	$t0, $t0, $a7
...
.LBB0_190:                              # %if.else.i106.i.us
	...
	sub.w	$t0, $a7, $t0
	ori	$a0, $a0, 1
.LBB0_191:                              # %if.end46.i111.i.us
                                        #   in Loop: Header=BB0_186 Depth=3
	srli.d	$a7, $a7, 16
	bstrins.d	$t0, $a7, 63, 16
	st.w	$a6, $sp, 320
	bstrpick.d	$a7, $a6, 31, 24
	st.w	$t0, $a5, 0
	bnez	$a7, .LBB0_185
# %bb.192:                              # %if.then49.i119.i.us
                                        #   in Loop: Header=BB0_186 Depth=3
	ld.bu	$a4, $a4, 0
	slli.w	$a1, $a1, 8
	or	$a1, $a1, $a4
...
# %bb.195:                              # %if.then49.i516.us
	...
	st.w	$a4, $sp, 320
	st.d	$a1, $sp, 312
.LBB0_196:                              # %lzma_486248.exit526.us
                                        #   in Loop: Header=BB0_20 Depth=2
	sltu	$a1, $a7, $a3
	masknez	$a2, $t3, $a1
	maskeqz	$a3, $t2, $a1
...
.LBB0_200:                              # %if.end239.us
                                        #   in Loop: Header=BB0_20 Depth=2
	beqz	$t1, .LBB0_245
# %bb.201:                              # %if.else242.us
                                        #   in Loop: Header=BB0_20 Depth=2
	addi.w	$a0, $a1, 2
	st.d	$s7, $sp, 296
	st.w	$s3, $sp, 308
	...
	bgeu	$a0, $a4, .LBB0_207
# %bb.202:                              # %land.lhs.true248.us
                                        #   in Loop: Header=BB0_20 Depth=2
	bgeu	$a3, $t0, .LBB0_249
# %bb.203:                              # %land.lhs.true262.us
                                        #   in Loop: Header=BB0_20 Depth=2
...
# %bb.206:                              # %land.lhs.true291.us
	...
	or	$a5, $a5, $s0
	beqz	$a5, .LBB0_249
.LBB0_207:                              # %land.lhs.true310.us
                                        #   in Loop: Header=BB0_20 Depth=2
	beq	$s5, $s3, .LBB0_249
# %bb.208:                              # %land.lhs.true310.us
                                        #   in Loop: Header=BB0_20 Depth=2
	bltu	$t0, $a4, .LBB0_249
# %bb.209:                              # %land.lhs.true323.us
                                        #   in Loop: Header=BB0_20 Depth=2
...
# %bb.211:                              # %land.lhs.true323.us
	...
	bltu	$ra, $a5, .LBB0_249
# %bb.212:                              # %do.body384.us.preheader
                                        #   in Loop: Header=BB0_20 Depth=2
	addi.w	$a5, $s3, 1
	sltu	$a6, $a5, $s5
	masknez	$a5, $a5, $a6
	...
	ori	$a7, $zero, 16
	bgeu	$a3, $a7, .LBB0_217
.LBB0_213:                              # %do.body384.us.preheader1294
                                        #   in Loop: Header=BB0_20 Depth=2
	addi.w	$a3, $a0, -1
	move	$a1, $s3
	.p2align	4, , 16
.LBB0_214:                              # %do.body384.us
                                        #   Parent Loop BB0_10 Depth=1
                                        #     Parent Loop BB0_20 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	...
	ori	$a5, $zero, 1
	bgez	$a4, .LBB0_216
# %bb.215:                              # %do.body384.us
                                        #   in Loop: Header=BB0_214 Depth=3
	addi.w	$a2, $a2, 1
	bltu	$a1, $s5, .LBB0_214
.LBB0_216:                              #   in Loop: Header=BB0_20 Depth=2
	...
	bltu	$a1, $s5, .LBB0_20
	b	.LBB0_245
.LBB0_217:                              # %vector.scevcheck
                                        #   in Loop: Header=BB0_20 Depth=2
	addi.w	$a6, $a6, 0
	bltu	$a6, $a5, .LBB0_213
# %bb.218:                              # %vector.scevcheck
                                        #   in Loop: Header=BB0_20 Depth=2
	nor	$a6, $a2, $zero
	bltu	$a6, $a5, .LBB0_213
...
# %bb.224:                              # %middle.block
	...
	st.w	$s3, $sp, 304
	bne	$a3, $a4, .LBB0_244
# %bb.225:                              #   in Loop: Header=BB0_20 Depth=2
	vinsgr2vr.d	$vr0, $a7, 0
	vpickve2gr.b	$a0, $vr0, 7
	ori	$a5, $zero, 1
	b	.LBB0_216
.LBB0_226:                              # %if.end110.thread.us
                                        #   in Loop: Header=BB0_20 Depth=2
	st.w	$a2, $sp, 324
	st.w	$a6, $sp, 308
	alsl.w	$a5, $a6, $a5, 4
	ori	$t1, $zero, 4
	addi.d	$a6, $s6, 1604
.LBB0_227:                              # %do.body.preheader.i343.us
                                        #   in Loop: Header=BB0_20 Depth=2
	st.d	$a6, $sp, 296
	addi.d	$t3, $a6, 2
	ori	$a7, $zero, 1
	st.w	$a7, $sp, 304
	bltu	$t3, $s2, .LBB0_251
# %bb.228:                              # %do.body.preheader.i343.us
                                        #   in Loop: Header=BB0_20 Depth=2
	addi.d	$a7, $a6, 6
	bltu	$t6, $a7, .LBB0_251
# %bb.229:                              # %land.lhs.true13.i.i357.lr.ph.us
                                        #   in Loop: Header=BB0_20 Depth=2
	bltu	$a4, $s2, .LBB0_251
# %bb.230:                              # %land.lhs.true13.i.i357.lr.ph.us
	...
	addi.d	$t2, $a4, 1
	bltu	$t6, $t2, .LBB0_251
# %bb.231:                              # %if.end.i.i363.us.preheader
                                        #   in Loop: Header=BB0_20 Depth=2
	move	$a7, $zero
	move	$t0, $zero
	addi.w	$t1, $t1, -1
...
.LBB0_232:                              # %if.end.i.i363.us
	...
	addi.w	$t5, $t6, 0
	bgeu	$a2, $t5, .LBB0_234
# %bb.233:                              # %if.then26.i.i391.us
                                        #   in Loop: Header=BB0_232 Depth=3
	move	$t5, $zero
	ori	$a3, $zero, 2048
	sub.d	$a3, $a3, $t8
	ori	$t8, $zero, 2048
...
# %bb.236:                              # %if.then49.i.i385.us
	...
	move	$a4, $t2
	b	.LBB0_238
.LBB0_237:                              #   in Loop: Header=BB0_232 Depth=3
	move	$a3, $t6
	move	$t2, $t3
.LBB0_238:                              # %if.end4.i.us
                                        #   in Loop: Header=BB0_232 Depth=3
	or	$t3, $t5, $t4
	sll.w	$t4, $t5, $t0
	or	$a7, $t4, $a7
...
# %bb.240:                              # %do.body.i348.us
	...
	addi.d	$t2, $t3, 4
	bltu	$t6, $t2, .LBB0_251
# %bb.241:                              # %land.lhs.true13.i.i357.us
                                        #   in Loop: Header=BB0_232 Depth=3
	bltu	$a4, $s2, .LBB0_251
...
# %bb.246:                              # %if.then525
	...
	addi.w	$a0, $fp, -1
	bgeu	$a0, $s1, .LBB0_249
# %bb.247:                              # %land.lhs.true538
	bstrpick.d	$a0, $fp, 31, 0
	add.d	$a1, $s0, $a0
	ld.d	$a0, $sp, 224                   # 8-byte Folded Reload
	ld.d	$a2, $sp, 256                   # 8-byte Folded Reload
	bltu	$a2, $a1, .LBB0_251
# %bb.248:                              # %do.body552.preheader
	move	$a1, $zero
	ori	$a2, $zero, 232
	b	.LBB0_253
.LBB0_249:
...
.LBB0_251:                              # %cleanup594
	...
	ret
.LBB0_252:                              # %do.cond585
                                        #   in Loop: Header=BB0_253 Depth=1
	add.w	$a1, $a1, $a3
	move	$a0, $zero
...
# %bb.11:                               # %do.body.preheader.i144
	...
	st.d	$t1, $a2, 0
	bltu	$t1, $a5, .LBB1_2
# %bb.12:                               # %do.body.preheader.i144
	addi.d	$t0, $a7, 6
	bltu	$a6, $t0, .LBB1_2
# %bb.13:                               # %land.lhs.true13.i.i159
	ld.d	$t0, $a1, 0
	bltu	$t0, $a5, .LBB1_2
# %bb.14:                               # %land.lhs.true13.i.i159
	addi.d	$t0, $t0, 1
	bltu	$a6, $t0, .LBB1_2
# %bb.15:                               # %if.end.i.i165
	ld.wu	$t0, $a1, 8
...
# %bb.47:                               # %if.end.i184
	addi.d	$t3, $t1, 4
	bltu	$a6, $t3, .LBB1_2
# %bb.48:                               # %land.lhs.true13.i.i159.1
	ld.d	$t3, $a1, 0
	bltu	$t3, $a5, .LBB1_2
# %bb.49:                               # %land.lhs.true13.i.i159.1
	addi.d	$t3, $t3, 1
	bltu	$a6, $t3, .LBB1_2
# %bb.50:                               # %if.end.i.i165.1
	ld.wu	$t3, $t1, 0
	ld.w	$t6, $a1, 12
...
.LBB1_53:                               # %if.else.i.i171.1
	...
	sub.w	$t2, $t3, $t2
	ori	$t0, $t0, 1
.LBB1_54:                               # %if.end46.i.i176.1
	srli.d	$t3, $t3, 16
	bstrins.d	$t2, $t3, 63, 16
	st.w	$t4, $a1, 8
	st.w	$t2, $t1, 0
	ld.wu	$t1, $a1, 8
	srli.d	$t2, $t1, 24
	bnez	$t2, .LBB1_56
# %bb.55:                               # %if.then49.i.i192.1
	ld.d	$t2, $a1, 0
	st.d	$t2, $a2, 0
	ld.w	$t3, $a1, 12
	ld.bu	$t4, $t2, 0
...
# %bb.57:                               # %if.end.i184.1
	addi.d	$t2, $a7, 4
	bltu	$a6, $t2, .LBB1_2
# %bb.58:                               # %land.lhs.true13.i.i159.2
	ld.d	$t2, $a1, 0
	bltu	$t2, $a5, .LBB1_2
# %bb.59:                               # %land.lhs.true13.i.i159.2
	addi.d	$a5, $t2, 1
	bltu	$a6, $a5, .LBB1_2
# %bb.60:                               # %if.end.i.i165.2
	ld.wu	$a5, $a7, 0
	ld.w	$t3, $a1, 12
	bstrpick.d	$a0, $t1, 31, 11
	bstrpick.d	$t2, $a5, 15, 0
	mul.w	$a6, $t2, $a0
	slli.d	$a0, $t0, 1
	bgeu	$t3, $a6, .LBB1_71
# %bb.61:                               # %if.then26.i.i198.2
	ori	$t0, $zero, 2048
	sub.d	$t0, $t0, $t2
	bstrpick.d	$t0, $t0, 31, 5
	add.w	$t0, $t0, $a5
...
# %bb.69:                               # %if.end.i.i105.1
	...
	mul.w	$t4, $t5, $t4
	bgeu	$t6, $t4, .LBB1_75
# %bb.70:                               # %if.then26.i.i138.1
	ori	$t2, $zero, 2048
	sub.d	$t2, $t2, $t5
	bstrpick.d	$t2, $t2, 31, 5
	add.w	$t2, $t2, $t3
	b	.LBB1_76
.LBB1_71:                               # %if.else.i.i171.2
	sub.d	$t0, $t3, $a6
	sub.d	$a6, $t1, $a6
	st.w	$t0, $a1, 12
	bstrpick.d	$t0, $t2, 31, 5
	sub.w	$t0, $a5, $t0
	ori	$a0, $a0, 1
.LBB1_72:                               # %if.end46.i.i176.2
	srli.d	$a5, $a5, 16
	bstrins.d	$t0, $a5, 63, 16
	st.w	$a6, $a1, 8
	st.w	$t0, $a7, 0
	ld.wu	$a5, $a1, 8
	srli.d	$a6, $a5, 24
	bnez	$a6, .LBB1_74
# %bb.73:                               # %if.then49.i.i192.2
	ld.d	$a6, $a1, 0
	st.d	$a6, $a2, 0
	ld.w	$a7, $a1, 12
	ld.bu	$t0, $a6, 0
...
.LBB1_85:                               # %if.end46.i.i116.2
	srli.d	$a0, $a0, 16
	bstrins.d	$a7, $a0, 63, 16
	st.w	$a6, $a1, 8
	st.w	$a7, $t0, 0
	ld.wu	$a0, $a1, 8
	srli.d	$a6, $a0, 24
	bnez	$a6, .LBB1_87
# %bb.86:                               # %if.then49.i.i132.2
	ld.d	$a6, $a1, 0
	st.d	$a6, $a2, 0
	ld.w	$a7, $a1, 12
	ld.bu	$t0, $a6, 0
