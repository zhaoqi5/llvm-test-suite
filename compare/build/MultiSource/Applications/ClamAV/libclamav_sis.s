...
# %bb.26:                               # %for.body.lr.ph
	...
	addi.d	$s6, $a0, %pc_lo12(langcodes)
	move	$s8, $zero
	b	.LBB0_28
.LBB0_27:                               # %for.inc
...
# %bb.40:                               # %iter.check30
	...
	bstrpick.d	$a1, $a1, 31, 1
	bltu	$fp, $a2, .LBB1_43
# %bb.41:                               # %vector.memcheck22
	alsl.d	$a2, $a1, $s2, 1
	add.d	$a2, $a2, $a0
	addi.d	$a2, $a2, 2
	addi.d	$a3, $a1, 1
	bgeu	$s6, $a2, .LBB1_138
# %bb.42:                               # %vector.memcheck22
	add.d	$a2, $s2, $a0
	add.d	$a4, $s6, $a3
	bgeu	$a2, $a4, .LBB1_138
.LBB1_43:
	move	$a4, $zero
	move	$a2, $zero
.LBB1_44:                               # %for.body.i151.preheader
	add.d	$a0, $a4, $a0
	add.d	$a0, $a0, $s2
	addi.d	$a0, $a0, 1
	sub.d	$a1, $a1, $a2
...
# %bb.74:                               # %for.body.lr.ph
	...
	addi.d	$s2, $a0, %pc_lo12(.L.str.176)
	ori	$fp, $zero, 1
...
.LBB1_118:                              # %vec.epilog.ph
	...
	addi.d	$a7, $a7, 15
	vrepli.b	$vr0, 37
.LBB1_119:                              # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$t0, $a7, -14
	ld.b	$t1, $a7, -12
	ld.b	$t2, $a7, -10
	...
	addi.d	$a7, $a7, 32
	bnez	$a6, .LBB1_119
# %bb.120:                              # %vec.epilog.middle.block
...
.LBB1_137:                              # %cleanup
	...
	addi.w	$a0, $zero, -123
	b	.LBB1_110
.LBB1_138:                              # %vector.main.loop.iter.check32
	ori	$a2, $zero, 63
	bgeu	$fp, $a2, .LBB1_143
# %bb.139:
	st.d	$a1, $sp, 112                   # 8-byte Folded Spill
	move	$a2, $zero
.LBB1_140:                              # %vec.epilog.ph45
	move	$a7, $a2
	st.d	$a3, $sp, 88                    # 8-byte Folded Spill
	bstrpick.d	$a4, $a3, 30, 4
	slli.d	$a2, $a4, 4
	...
	addi.d	$a7, $a7, 15
	vrepli.b	$vr0, 37
.LBB1_141:                              # %vec.epilog.vector.body48
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$t0, $a7, -14
	ld.b	$t1, $a7, -12
	ld.b	$t2, $a7, -10
	...
	addi.d	$a7, $a7, 32
	bnez	$a6, .LBB1_141
# %bb.142:                              # %vec.epilog.middle.block52
	ld.d	$s2, $sp, 72                    # 8-byte Folded Reload
	ld.d	$a1, $sp, 112                   # 8-byte Folded Reload
	ld.d	$a3, $sp, 88                    # 8-byte Folded Reload
	bne	$a2, $a3, .LBB1_44
	b	.LBB1_46
.LBB1_143:                              # %vector.ph33
	andi	$a4, $a3, 16
	bstrpick.d	$a2, $a3, 30, 5
	slli.d	$a2, $a2, 5
	add.d	$a5, $a0, $s2
...
.LBB1_144:                              # %vector.body36
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB1_144
# %bb.145:                              # %middle.block39
	beq	$a2, $a3, .LBB1_46
# %bb.146:                              # %vec.epilog.iter.check43
	bnez	$a4, .LBB1_150
# %bb.147:
	slli.d	$a4, $a2, 1
	b	.LBB1_44
