...
.LBB1_3:                                # %sw.bb
	...
	addi.d	$s5, $a0, %pc_lo12(.L.str.151)
.LBB1_4:
	move	$s7, $zero
	move	$fp, $zero
	ld.w	$s6, $s8, 8
...
.LBB1_21:                               # %sw.bb4
	...
	addi.d	$s5, $a0, %pc_lo12(.L.str.155)
	b	.LBB1_27
.LBB1_22:                               # %sw.bb5
	st.d	$a5, $sp, 88                    # 8-byte Folded Spill
	move	$s4, $a4
...
.LBB1_26:                               # %sw.bb3
	...
	addi.d	$s5, $a0, %pc_lo12(.L.str.153)
.LBB1_27:                               # %sw.epilog29
	move	$fp, $zero
	ori	$s7, $zero, 1
	ld.w	$s6, $s8, 8
...
.LBB1_51:                               # %sw.epilog
	...
	addi.d	$s5, $a1, %pc_lo12(.L.str.157)
	beqz	$a0, .LBB1_4
# %bb.52:                               # %sw.epilog
	ori	$a1, $zero, 512
	beq	$a0, $a1, .LBB1_55
...
# %bb.73:                               # %for.body.lr.ph
	...
	addi.d	$s8, $a0, %pc_lo12(.L.str.176)
	ori	$fp, $zero, 1
...
.LBB1_89:                               # %if.end206
	...
	alsl.d	$a1, $s3, $s3, 1
	bgeu	$a1, $a0, .LBB1_93
# %bb.90:                               # %lor.lhs.false210
                                        #   in Loop: Header=BB1_76 Depth=1
	ld.d	$a2, $a3, 32
	beqz	$a2, .LBB1_94
# %bb.91:                               # %land.lhs.true213
                                        #   in Loop: Header=BB1_76 Depth=1
	ld.d	$a2, $a2, 24
	beqz	$a2, .LBB1_94
...
.LBB1_114:                              # %if.then168
	...
	addi.w	$a0, $zero, -114
	b	.LBB1_109
.LBB1_115:                              # %vector.main.loop.iter.check
	ori	$a3, $zero, 31
	vrepli.b	$vr0, 37
	bgeu	$s6, $a3, .LBB1_124
# %bb.116:
...
.LBB1_134:                              # %cleanup
	...
	addi.w	$a0, $zero, -123
	b	.LBB1_109
.LBB1_135:                              # %vector.main.loop.iter.check32
	ori	$a2, $zero, 31
	bgeu	$s7, $a2, .LBB1_137
# %bb.136:
	move	$a2, $zero
...
.LBB1_138:                              # %vector.body36
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB1_138
# %bb.139:                              # %middle.block39
	move	$s4, $s1
	ld.d	$s2, $sp, 64                    # 8-byte Folded Reload
	ld.d	$t2, $sp, 80                    # 8-byte Folded Reload
	ld.d	$t3, $sp, 72                    # 8-byte Folded Reload
	beq	$a2, $t3, .LBB1_46
# %bb.140:                              # %vec.epilog.iter.check43
	ld.d	$a1, $sp, 56                    # 8-byte Folded Reload
	beqz	$a1, .LBB1_146
.LBB1_141:                              # %vec.epilog.ph45
	move	$a1, $a2
	...
	addi.d	$a7, $a1, 3
	vrepli.b	$vr0, 37
.LBB1_142:                              # %vec.epilog.vector.body48
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a1, $a7, -2
	ld.b	$a3, $a7, 0
	ld.b	$t0, $a7, 2
	...
	addi.d	$a7, $a7, 8
	bnez	$a6, .LBB1_142
# %bb.143:                              # %vec.epilog.middle.block52
	bne	$a2, $t3, .LBB1_44
	b	.LBB1_46
.LBB1_144:                              # %if.then204
	ld.d	$a0, $a3, 0
