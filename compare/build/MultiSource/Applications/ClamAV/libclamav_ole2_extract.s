...
# %bb.38:                               # %if.end91
	...
	beqz	$a0, .LBB3_41
# %bb.39:                               # %while.body.i96.preheader
                                        #   in Loop: Header=BB3_14 Depth=1
	addi.d	$s6, $a0, 1
	.p2align	4, , 16
.LBB3_40:                               # %while.body.i96
                                        #   Parent Loop BB3_14 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$a0, $s0
	move	$a1, $fp
...
# %bb.42:                               # %if.end.i.i102
	...
	addi.w	$s6, $a2, 512
	beqz	$a0, .LBB3_46
# %bb.43:                               # %if.else.i.i110
                                        #   in Loop: Header=BB3_14 Depth=1
	sll.w	$a2, $s1, $a1
	add.d	$a3, $s6, $a2
	ld.d	$a1, $sp, 16                    # 8-byte Folded Reload
	blez	$a3, .LBB3_49
# %bb.44:                               # %lor.lhs.false.i.i115
                                        #   in Loop: Header=BB3_14 Depth=1
	ld.d	$a4, $fp, 528
	ld.d	$a1, $sp, 16                    # 8-byte Folded Reload
	blt	$a4, $a3, .LBB3_49
# %bb.45:                               # %if.end30.i.i118
                                        #   in Loop: Header=BB3_14 Depth=1
	add.d	$a1, $a0, $s6
	addi.d	$a0, $sp, 24
	pcaddu18i	$ra, %call36(memcpy)
