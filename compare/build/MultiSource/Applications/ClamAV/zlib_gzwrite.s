...
# %bb.26:                               # %if.end62.us
	...
	st.d	$a1, $fp, 8
	bltu	$a1, $a2, .LBB8_25
# %bb.27:                               # %while.end67.us
                                        #   in Loop: Header=BB8_23 Depth=1
	ld.w	$s4, $fp, 152
	bnez	$s4, .LBB8_29
.LBB8_28:                               # %if.then71.us
                                        #   in Loop: Header=BB8_23 Depth=1
	ld.w	$s4, $fp, 40
	ld.d	$a0, $fp, 56
	st.w	$s4, $fp, 152
...
# %bb.34:                               # %if.end62.us74
	...
	st.d	$a1, $fp, 8
	bltu	$a1, $a2, .LBB8_33
.LBB8_35:                               # %while.end67.us59
                                        #   in Loop: Header=BB8_32 Depth=1
	ld.w	$s4, $fp, 152
	bnez	$s4, .LBB8_37
# %bb.36:                               # %if.then71.us61
                                        #   in Loop: Header=BB8_32 Depth=1
	ld.w	$s4, $fp, 40
	ld.d	$a0, $fp, 56
	st.w	$s4, $fp, 152
