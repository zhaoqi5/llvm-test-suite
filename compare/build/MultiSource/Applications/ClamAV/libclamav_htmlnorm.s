...
# %bb.308:                              # %if.then.i1398
	...
	ldx.w	$s0, $a1, $a2
	bne	$a0, $a5, .LBB3_310
# %bb.309:                              # %html_output_flush.exit.i1407
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $a4, 0
	ld.d	$a1, $sp, 360                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_311:                              # %if.end617
	...
	or	$s7, $a0, $a1
	b	.LBB3_640
.LBB3_312:                              # %land.lhs.true1153
                                        #   in Loop: Header=BB3_47 Depth=2
	ori	$a0, $zero, 59
	beq	$s5, $a0, .LBB3_317
# %bb.313:                              # %land.lhs.true1153
                                        #   in Loop: Header=BB3_47 Depth=2
	ori	$a0, $zero, 120
	beq	$s5, $a0, .LBB3_315
# %bb.314:                              # %land.lhs.true1153
                                        #   in Loop: Header=BB3_47 Depth=2
	ori	$a0, $zero, 88
	bne	$s5, $a0, .LBB3_325
.LBB3_315:                              # %if.then1161
                                        #   in Loop: Header=BB3_47 Depth=2
	st.d	$zero, $sp, 248                 # 8-byte Folded Spill
	addi.d	$s8, $s8, 1
	ori	$a0, $zero, 1
	st.d	$a0, $sp, 136                   # 8-byte Folded Spill
.LBB3_316:                              # %while.cond114.backedge
                                        #   in Loop: Header=BB3_47 Depth=2
	move	$s6, $s7
	ori	$s7, $zero, 12
	b	.LBB3_46
.LBB3_317:                              # %if.then1167
                                        #   in Loop: Header=BB3_47 Depth=2
	ori	$a0, $zero, 9
	bne	$s7, $a0, .LBB3_572
# %bb.318:                              # %if.then1167
...
.LBB3_325:                              # %if.else1238
	...
	addi.w	$s0, $a2, 0
	bltz	$a0, .LBB3_328
# %bb.326:                              # %lor.lhs.false1246
                                        #   in Loop: Header=BB3_47 Depth=2
	beqz	$s0, .LBB3_563
# %bb.327:                              # %lor.lhs.false1246
                                        #   in Loop: Header=BB3_47 Depth=2
	lu12i.w	$a2, 1
	and	$a1, $a1, $a2
	beqz	$a1, .LBB3_563
.LBB3_328:                              # %if.then1256
                                        #   in Loop: Header=BB3_47 Depth=2
	bltz	$a0, .LBB3_504
# %bb.329:                              # %if.else1273
                                        #   in Loop: Header=BB3_47 Depth=2
...
# %bb.341:                              # %if.then1510
	...
	ori	$a0, $zero, 19
	b	.LBB3_501
.LBB3_342:                              # %if.then1664
                                        #   in Loop: Header=BB3_47 Depth=2
	ori	$a0, $zero, 1
	st.d	$a0, $sp, 264                   # 8-byte Folded Spill
	beqz	$s2, .LBB3_352
# %bb.343:                              # %if.then.i2429
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s2, 8196
	bne	$a0, $a5, .LBB3_345
# %bb.344:                              # %html_output_flush.exit.i2438
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s2, 0
	addi.d	$a1, $s2, 4
	move	$a2, $a5
...
.LBB3_345:                              # %if.then.i2443
	...
	ldptr.w	$a0, $s2, 8196
	bne	$a0, $a5, .LBB3_347
# %bb.346:                              # %html_output_flush.exit.i2452
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s2, 0
	move	$a1, $s4
	move	$a2, $a5
...
.LBB3_347:                              # %if.end.i2446
	...
	stx.b	$a1, $s4, $a0
	b	.LBB3_353
.LBB3_348:                              # %if.else1667
                                        #   in Loop: Header=BB3_47 Depth=2
	beqz	$s2, .LBB3_352
# %bb.349:                              # %if.then.i2457
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s2, 8196
	bne	$a0, $a5, .LBB3_351
# %bb.350:                              # %html_output_flush.exit.i2466
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s2, 0
	addi.d	$a1, $s2, 4
	move	$a2, $a5
...
.LBB3_352:                              #   in Loop: Header=BB3_47 Depth=2
	move	$s2, $zero
.LBB3_353:                              # %while.cond114.backedge
                                        #   in Loop: Header=BB3_47 Depth=2
	move	$s6, $s7
	ori	$s7, $zero, 20
	b	.LBB3_46
...
# %bb.377:                              # %if.then.i954
	...
	ldptr.w	$a0, $s5, 8196
	bne	$a0, $a5, .LBB3_379
# %bb.378:                              # %html_output_flush.exit.i975
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s5, 0
	ld.d	$a1, $sp, 320                   # 8-byte Folded Reload
	move	$a2, $a5
	...
	lu12i.w	$a5, 2
	move	$a0, $zero
.LBB3_379:                              # %if.end.i957
                                        #   in Loop: Header=BB3_47 Depth=2
	addi.d	$a1, $a0, 1
	stptr.w	$a1, $s5, 8196
	ld.d	$a1, $sp, 320                   # 8-byte Folded Reload
	stx.b	$s2, $a1, $a0
.LBB3_380:                              # %if.end3.i962
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.d	$a4, $sp, 368                   # 8-byte Folded Reload
	beqz	$s6, .LBB3_384
# %bb.381:                              # %if.then5.i964
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s6, 8196
	bne	$a0, $a5, .LBB3_383
# %bb.382:                              # %html_output_flush.exit15.i972
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s6, 0
	ld.d	$a1, $sp, 312                   # 8-byte Folded Reload
	move	$a2, $a5
	...
	ld.d	$a4, $sp, 368                   # 8-byte Folded Reload
	move	$a0, $zero
.LBB3_383:                              # %if.end9.i967
                                        #   in Loop: Header=BB3_47 Depth=2
	addi.d	$a1, $a0, 1
	stptr.w	$a1, $s6, 8196
	ld.d	$a1, $sp, 312                   # 8-byte Folded Reload
	stx.b	$s2, $a1, $a0
.LBB3_384:                              # %html_output_c.exit978
                                        #   in Loop: Header=BB3_47 Depth=2
	move	$s2, $s1
	ld.d	$s1, $sp, 240                   # 8-byte Folded Reload
	ld.d	$a0, $sp, 224                   # 8-byte Folded Reload
...
# %bb.386:                              # %if.then.i980
	...
	ldx.w	$s1, $a1, $a2
	bne	$a0, $a5, .LBB3_388
# %bb.387:                              # %html_output_flush.exit.i989
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $a4, 0
	ld.d	$a1, $sp, 360                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_392:                              #   in Loop: Header=BB3_47 Depth=2
	...
	beq	$a2, $a5, .LBB3_368
	b	.LBB3_369
.LBB3_393:                              # %if.else1398
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.d	$s0, $sp, 336                   # 8-byte Folded Reload
	beqz	$s0, .LBB3_397
# %bb.394:                              # %if.then.i2183
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s0, 8196
	bne	$a0, $a5, .LBB3_396
# %bb.395:                              # %html_output_flush.exit.i2204
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s0, 0
	ld.d	$a1, $sp, 320                   # 8-byte Folded Reload
	move	$a2, $a5
	...
	ld.d	$a4, $sp, 368                   # 8-byte Folded Reload
	move	$a0, $zero
.LBB3_396:                              # %if.end.i2186
                                        #   in Loop: Header=BB3_47 Depth=2
	addi.d	$a1, $a0, 1
	stptr.w	$a1, $s0, 8196
	ld.d	$a1, $sp, 320                   # 8-byte Folded Reload
	stx.b	$s4, $a1, $a0
.LBB3_397:                              # %if.end3.i2191
                                        #   in Loop: Header=BB3_47 Depth=2
	beqz	$s6, .LBB3_401
# %bb.398:                              # %if.then5.i2193
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s6, 8196
	bne	$a0, $a5, .LBB3_400
# %bb.399:                              # %html_output_flush.exit15.i2201
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s6, 0
	ld.d	$a1, $sp, 312                   # 8-byte Folded Reload
	move	$a2, $a5
	...
	ld.d	$a4, $sp, 368                   # 8-byte Folded Reload
	move	$a0, $zero
.LBB3_400:                              # %if.end9.i2196
                                        #   in Loop: Header=BB3_47 Depth=2
	addi.d	$a1, $a0, 1
	stptr.w	$a1, $s6, 8196
	ld.d	$a1, $sp, 312                   # 8-byte Folded Reload
	stx.b	$s4, $a1, $a0
.LBB3_401:                              # %if.else1415
                                        #   in Loop: Header=BB3_47 Depth=2
	addi.w	$a0, $s4, 128
	move	$s0, $s4
	ori	$a1, $zero, 383
	bltu	$a1, $a0, .LBB3_403
# %bb.402:                              # %if.end1417.sink.split
                                        #   in Loop: Header=BB3_47 Depth=2
	pcaddu18i	$ra, %call36(__ctype_tolower_loc)
	jirl	$ra, $ra, 0
	lu12i.w	$a5, 2
...
.LBB3_403:                              # %if.end1417
	...
	st.d	$s4, $sp, 248                   # 8-byte Folded Spill
	beqz	$a4, .LBB3_407
# %bb.404:                              # %if.then.i2216
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $a4, 8196
	bne	$a0, $a5, .LBB3_406
# %bb.405:                              # %html_output_flush.exit.i2225
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $a4, 0
	ld.d	$a1, $sp, 360                   # 8-byte Folded Reload
	move	$a2, $a5
...
# %bb.412:                              # %if.else1600
	...
	ori	$s0, $zero, 20
	beqz	$s2, .LBB3_417
# %bb.413:                              # %if.then.i2353
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s2, 8196
	bne	$a0, $a5, .LBB3_415
# %bb.414:                              # %html_output_flush.exit.i2362
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s2, 0
	addi.d	$a1, $s2, 4
	move	$a2, $a5
...
# %bb.420:                              # %if.else1637
	...
	ori	$s0, $zero, 20
	beqz	$s2, .LBB3_586
# %bb.421:                              # %if.then.i2395
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s2, 8196
	bne	$a0, $a5, .LBB3_423
# %bb.422:                              # %html_output_flush.exit.i2404
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s2, 0
	addi.d	$a1, $s2, 4
	move	$a2, $a5
...
.LBB3_426:                              # %for.body.i
	...
	beqz	$a0, .LBB3_668
# %bb.427:                              # %for.cond.i
                                        #   in Loop: Header=BB3_426 Depth=3
	addi.d	$s1, $s1, 8
	bne	$s2, $s1, .LBB3_426
	b	.LBB3_674
.LBB3_428:                              # %if.else1034
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.d	$s5, $sp, 336                   # 8-byte Folded Reload
	lu12i.w	$a5, 2
	beqz	$s5, .LBB3_432
# %bb.429:                              # %if.then.i1668
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s5, 8196
	bne	$a0, $a5, .LBB3_431
# %bb.430:                              # %html_output_flush.exit.i1689
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s5, 0
	ld.d	$a1, $sp, 320                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_431:                              # %if.end.i1671
	...
	ori	$a2, $zero, 38
	stx.b	$a2, $a1, $a0
.LBB3_432:                              # %if.end3.i1676
                                        #   in Loop: Header=BB3_47 Depth=2
	beqz	$s6, .LBB3_436
# %bb.433:                              # %if.then5.i1678
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s6, 8196
	bne	$a0, $a5, .LBB3_435
# %bb.434:                              # %html_output_flush.exit15.i1686
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s6, 0
	ld.d	$a1, $sp, 312                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_435:                              # %if.end9.i1681
	...
	ori	$a2, $zero, 38
	stx.b	$a2, $a1, $a0
.LBB3_436:                              # %html_output_c.exit1692
                                        #   in Loop: Header=BB3_47 Depth=2
	ori	$a0, $zero, 9
	bne	$s7, $a0, .LBB3_439
# %bb.437:                              # %html_output_c.exit1692
                                        #   in Loop: Header=BB3_47 Depth=2
	ori	$a0, $zero, 1023
...
.LBB3_442:                              # %for.body1048
	...
	ldx.w	$s2, $a1, $a0
	beqz	$s5, .LBB3_446
# %bb.443:                              # %if.then.i1694
                                        #   in Loop: Header=BB3_442 Depth=3
	ldptr.w	$a0, $s5, 8196
	bne	$a0, $a5, .LBB3_445
# %bb.444:                              # %html_output_flush.exit.i1715
                                        #   in Loop: Header=BB3_442 Depth=3
	ld.w	$a0, $s5, 0
	ld.d	$a1, $sp, 320                   # 8-byte Folded Reload
	move	$a2, $a5
	...
	ld.d	$a4, $sp, 368                   # 8-byte Folded Reload
	move	$a0, $zero
.LBB3_445:                              # %if.end.i1697
                                        #   in Loop: Header=BB3_442 Depth=3
	addi.d	$a1, $a0, 1
	stptr.w	$a1, $s5, 8196
	ld.d	$a1, $sp, 320                   # 8-byte Folded Reload
	stx.b	$s2, $a1, $a0
.LBB3_446:                              # %if.end3.i1702
                                        #   in Loop: Header=BB3_442 Depth=3
	beqz	$s6, .LBB3_450
# %bb.447:                              # %if.then5.i1704
                                        #   in Loop: Header=BB3_442 Depth=3
	ldptr.w	$a0, $s6, 8196
	bne	$a0, $a5, .LBB3_449
# %bb.448:                              # %html_output_flush.exit15.i1712
                                        #   in Loop: Header=BB3_442 Depth=3
	ld.w	$a0, $s6, 0
	ld.d	$a1, $sp, 312                   # 8-byte Folded Reload
	move	$a2, $a5
	...
	ld.d	$a4, $sp, 368                   # 8-byte Folded Reload
	move	$a0, $zero
.LBB3_449:                              # %if.end9.i1707
                                        #   in Loop: Header=BB3_442 Depth=3
	addi.d	$a1, $a0, 1
	stptr.w	$a1, $s6, 8196
	ld.d	$a1, $sp, 312                   # 8-byte Folded Reload
	stx.b	$s2, $a1, $a0
.LBB3_450:                              # %html_output_c.exit1718
                                        #   in Loop: Header=BB3_442 Depth=3
	ori	$a0, $zero, 9
	bne	$s7, $a0, .LBB3_441
# %bb.451:                              # %html_output_c.exit1718
                                        #   in Loop: Header=BB3_442 Depth=3
	ori	$a0, $zero, 1023
	ld.d	$a2, $sp, 328                   # 8-byte Folded Reload
	blt	$a0, $a2, .LBB3_441
...
# %bb.455:                              # %if.then461
	...
	addi.d	$s4, $sp, 1624
	beqz	$s0, .LBB3_459
# %bb.456:                              # %if.then.i1202
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s0, 8196
	bne	$a0, $a5, .LBB3_458
# %bb.457:                              # %html_output_flush.exit.i1223
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s0, 0
	ld.d	$a1, $sp, 320                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_458:                              # %if.end.i1205
	...
	ori	$a2, $zero, 34
	stx.b	$a2, $a1, $a0
.LBB3_459:                              # %if.end3.i1210
                                        #   in Loop: Header=BB3_47 Depth=2
	ori	$s0, $zero, 10
	beqz	$s6, .LBB3_463
# %bb.460:                              # %if.then5.i1212
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s6, 8196
	bne	$a0, $a5, .LBB3_462
# %bb.461:                              # %html_output_flush.exit15.i1220
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s6, 0
	ld.d	$a1, $sp, 312                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_462:                              # %if.end9.i1215
	...
	ori	$a2, $zero, 34
	stx.b	$a2, $a1, $a0
.LBB3_463:                              # %html_output_c.exit1226
                                        #   in Loop: Header=BB3_47 Depth=2
	ori	$a0, $zero, 1023
	blt	$a0, $s5, .LBB3_465
# %bb.464:                              # %if.then464
...
# %bb.469:                              # %if.then506
	...
	addi.d	$s4, $sp, 1624
	beqz	$s0, .LBB3_473
# %bb.470:                              # %if.then.i1280
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s0, 8196
	bne	$a0, $a5, .LBB3_472
# %bb.471:                              # %html_output_flush.exit.i1301
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s0, 0
	ld.d	$a1, $sp, 320                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_472:                              # %if.end.i1283
	...
	ori	$a2, $zero, 34
	stx.b	$a2, $a1, $a0
.LBB3_473:                              # %if.end3.i1288
                                        #   in Loop: Header=BB3_47 Depth=2
	ori	$s0, $zero, 10
	beqz	$s6, .LBB3_477
# %bb.474:                              # %if.then5.i1290
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s6, 8196
	bne	$a0, $a5, .LBB3_476
# %bb.475:                              # %html_output_flush.exit15.i1298
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s6, 0
	ld.d	$a1, $sp, 312                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_476:                              # %if.end9.i1293
	...
	ori	$a2, $zero, 34
	stx.b	$a2, $a1, $a0
.LBB3_477:                              # %html_output_c.exit1304
                                        #   in Loop: Header=BB3_47 Depth=2
	ori	$a0, $zero, 1023
	blt	$a0, $s5, .LBB3_479
# %bb.478:                              # %if.then509
...
# %bb.483:                              # %if.else572
	...
	ld.d	$s5, $sp, 328                   # 8-byte Folded Reload
	beqz	$s3, .LBB3_487
# %bb.484:                              # %if.then.i1358
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s3, 8196
	bne	$a0, $a5, .LBB3_486
# %bb.485:                              # %html_output_flush.exit.i1379
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s3, 0
	ld.d	$a1, $sp, 320                   # 8-byte Folded Reload
	move	$a2, $a5
	...
	ld.d	$a4, $sp, 368                   # 8-byte Folded Reload
	move	$a0, $zero
.LBB3_486:                              # %if.end.i1361
                                        #   in Loop: Header=BB3_47 Depth=2
	addi.d	$a1, $a0, 1
	stptr.w	$a1, $s3, 8196
	ld.d	$a1, $sp, 320                   # 8-byte Folded Reload
	stx.b	$s0, $a1, $a0
.LBB3_487:                              # %if.end3.i1366
                                        #   in Loop: Header=BB3_47 Depth=2
	move	$s3, $s4
	beqz	$s6, .LBB3_491
# %bb.488:                              # %if.then5.i1368
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s6, 8196
	bne	$a0, $a5, .LBB3_490
# %bb.489:                              # %html_output_flush.exit15.i1376
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s6, 0
	ld.d	$a1, $sp, 312                   # 8-byte Folded Reload
	move	$a2, $a5
	...
	ld.d	$a4, $sp, 368                   # 8-byte Folded Reload
	move	$a0, $zero
.LBB3_490:                              # %if.end9.i1371
                                        #   in Loop: Header=BB3_47 Depth=2
	addi.d	$a1, $a0, 1
	stptr.w	$a1, $s6, 8196
	ld.d	$a1, $sp, 312                   # 8-byte Folded Reload
	stx.b	$s0, $a1, $a0
.LBB3_491:                              # %html_output_c.exit1382
                                        #   in Loop: Header=BB3_47 Depth=2
	ori	$a0, $zero, 1023
	blt	$a0, $s5, .LBB3_493
# %bb.492:                              # %if.then582
...
# %bb.507:                              # %if.then330
                                        #   in Loop: Header=BB3_47 Depth=2
	beqz	$s5, .LBB3_511
# %bb.508:                              # %if.then.i1046
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s5, 8196
	bne	$a0, $a5, .LBB3_510
# %bb.509:                              # %html_output_flush.exit.i1067
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s5, 0
	ld.d	$a1, $sp, 320                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_510:                              # %if.end.i1049
	...
	ori	$a2, $zero, 32
	stx.b	$a2, $a1, $a0
.LBB3_511:                              # %if.end3.i1054
                                        #   in Loop: Header=BB3_47 Depth=2
	beqz	$s6, .LBB3_515
# %bb.512:                              # %if.then5.i1056
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s6, 8196
	bne	$a0, $a5, .LBB3_514
# %bb.513:                              # %html_output_flush.exit15.i1064
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s6, 0
	ld.d	$a1, $sp, 312                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_515:                              # %if.end331
	...
	ld.d	$a4, $sp, 368                   # 8-byte Folded Reload
	beqz	$s5, .LBB3_519
# %bb.516:                              # %if.then.i1072
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s5, 8196
	bne	$a0, $a5, .LBB3_518
# %bb.517:                              # %html_output_flush.exit.i1093
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s5, 0
	ld.d	$a1, $sp, 320                   # 8-byte Folded Reload
	move	$a2, $a5
	...
	ld.d	$a4, $sp, 368                   # 8-byte Folded Reload
	move	$a0, $zero
.LBB3_518:                              # %if.end.i1075
                                        #   in Loop: Header=BB3_47 Depth=2
	addi.d	$a1, $a0, 1
	stptr.w	$a1, $s5, 8196
	ld.d	$a1, $sp, 320                   # 8-byte Folded Reload
	stx.b	$s2, $a1, $a0
.LBB3_519:                              # %if.end3.i1080
                                        #   in Loop: Header=BB3_47 Depth=2
	beqz	$s6, .LBB3_523
# %bb.520:                              # %if.then5.i1082
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s6, 8196
	bne	$a0, $a5, .LBB3_522
# %bb.521:                              # %html_output_flush.exit15.i1090
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s6, 0
	ld.d	$a1, $sp, 312                   # 8-byte Folded Reload
	move	$a2, $a5
	...
	ld.d	$a4, $sp, 368                   # 8-byte Folded Reload
	move	$a0, $zero
.LBB3_522:                              # %if.end9.i1085
                                        #   in Loop: Header=BB3_47 Depth=2
	addi.d	$a1, $a0, 1
	stptr.w	$a1, $s6, 8196
	ld.d	$a1, $sp, 312                   # 8-byte Folded Reload
	stx.b	$s2, $a1, $a0
.LBB3_523:                              # %html_output_c.exit1096
                                        #   in Loop: Header=BB3_47 Depth=2
	ori	$a0, $zero, 1023
	blt	$a0, $s0, .LBB3_525
# %bb.524:                              # %if.then341
...
# %bb.527:                              # %if.then.i846
	...
	ldptr.w	$a0, $s3, 8196
	bne	$a0, $a5, .LBB3_529
# %bb.528:                              # %html_output_flush.exit.i867
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s3, 0
	ld.d	$a1, $sp, 320                   # 8-byte Folded Reload
	move	$a2, $a5
	...
	lu12i.w	$a5, 2
	move	$a0, $zero
.LBB3_529:                              # %if.end.i849
                                        #   in Loop: Header=BB3_47 Depth=2
	addi.d	$a1, $a0, 1
	stptr.w	$a1, $s3, 8196
	ld.d	$a1, $sp, 320                   # 8-byte Folded Reload
	stx.b	$s0, $a1, $a0
.LBB3_530:                              # %if.end3.i854
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.d	$a4, $sp, 368                   # 8-byte Folded Reload
	move	$s3, $s6
	beqz	$s5, .LBB3_534
# %bb.531:                              # %if.then5.i856
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s5, 8196
	bne	$a0, $a5, .LBB3_533
# %bb.532:                              # %html_output_flush.exit15.i864
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s5, 0
	ld.d	$a1, $sp, 312                   # 8-byte Folded Reload
	move	$a2, $a5
	...
	ld.d	$a4, $sp, 368                   # 8-byte Folded Reload
	move	$a0, $zero
.LBB3_533:                              # %if.end9.i859
                                        #   in Loop: Header=BB3_47 Depth=2
	addi.d	$a1, $a0, 1
	stptr.w	$a1, $s5, 8196
	ld.d	$a1, $sp, 312                   # 8-byte Folded Reload
	stx.b	$s0, $a1, $a0
.LBB3_534:                              # %html_output_c.exit870
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.d	$a0, $sp, 224                   # 8-byte Folded Reload
	beqz	$a0, .LBB3_539
# %bb.535:                              # %if.then203
...
# %bb.536:                              # %if.then.i872
	...
	ldx.w	$s0, $a1, $a2
	bne	$a0, $a5, .LBB3_538
# %bb.537:                              # %html_output_flush.exit.i881
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $a4, 0
	ld.d	$a1, $sp, 360                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_550:                              # %if.else519
                                        #   in Loop: Header=BB3_47 Depth=2
	beqz	$s0, .LBB3_554
# %bb.551:                              # %if.then.i1228
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s0, 8196
	bne	$a0, $a5, .LBB3_553
# %bb.552:                              # %html_output_flush.exit.i1249
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s0, 0
	ld.d	$a1, $sp, 320                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_553:                              # %if.end.i1231
	...
	ori	$a2, $zero, 34
	stx.b	$a2, $a1, $a0
.LBB3_554:                              # %if.end3.i1236
                                        #   in Loop: Header=BB3_47 Depth=2
	ori	$s0, $zero, 10
	beqz	$s6, .LBB3_558
# %bb.555:                              # %if.then5.i1238
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s6, 8196
	bne	$a0, $a5, .LBB3_557
# %bb.556:                              # %html_output_flush.exit15.i1246
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s6, 0
	ld.d	$a1, $sp, 312                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_557:                              # %if.end9.i1241
	...
	ori	$a2, $zero, 34
	stx.b	$a2, $a1, $a0
.LBB3_558:                              # %html_output_c.exit1252
                                        #   in Loop: Header=BB3_47 Depth=2
	ori	$a0, $zero, 1023
	blt	$a0, $s5, .LBB3_560
# %bb.559:                              # %if.then477
...
.LBB3_562:                              # %if.else.i1973
	...
	ori	$s0, $zero, 10
	b	.LBB3_46
.LBB3_563:                              # %if.else1285
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.d	$a4, $sp, 368                   # 8-byte Folded Reload
	ld.d	$s0, $sp, 336                   # 8-byte Folded Reload
	lu12i.w	$a5, 2
	beqz	$s0, .LBB3_567
# %bb.564:                              # %if.then.i1900
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s0, 8196
	bne	$a0, $a5, .LBB3_566
# %bb.565:                              # %html_output_flush.exit.i1921
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s0, 0
	ld.d	$a1, $sp, 320                   # 8-byte Folded Reload
	move	$a2, $a5
	...
	ld.d	$a4, $sp, 368                   # 8-byte Folded Reload
	move	$a0, $zero
.LBB3_566:                              # %if.end.i1903
                                        #   in Loop: Header=BB3_47 Depth=2
	addi.d	$a1, $a0, 1
	stptr.w	$a1, $s0, 8196
	ld.d	$a1, $sp, 320                   # 8-byte Folded Reload
	stx.b	$s4, $a1, $a0
.LBB3_567:                              # %if.end3.i1908
                                        #   in Loop: Header=BB3_47 Depth=2
	beqz	$s6, .LBB3_571
# %bb.568:                              # %if.then5.i1910
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s6, 8196
	ori	$s0, $zero, 10
	bne	$a0, $a5, .LBB3_570
# %bb.569:                              # %html_output_flush.exit15.i1918
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s6, 0
	ld.d	$a1, $sp, 312                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_573:                              # %if.else1212
	...
	ldx.w	$s0, $a0, $a1
	beqz	$s4, .LBB3_577
.LBB3_574:                              # %if.then.i1874
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s4, 8196
	bne	$a0, $a5, .LBB3_576
# %bb.575:                              # %html_output_flush.exit.i1895
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s4, 0
	ld.d	$a1, $sp, 320                   # 8-byte Folded Reload
	move	$a2, $a5
	...
	ld.d	$a4, $sp, 368                   # 8-byte Folded Reload
	move	$a0, $zero
.LBB3_576:                              # %if.end.i1877
                                        #   in Loop: Header=BB3_47 Depth=2
	addi.d	$a1, $a0, 1
	stptr.w	$a1, $s4, 8196
	ld.d	$a1, $sp, 320                   # 8-byte Folded Reload
	stx.b	$s0, $a1, $a0
.LBB3_577:                              # %if.end3.i1882
                                        #   in Loop: Header=BB3_47 Depth=2
	beqz	$s6, .LBB3_816
# %bb.578:                              # %if.then5.i1884
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s6, 8196
	bne	$a0, $a5, .LBB3_580
# %bb.579:                              # %html_output_flush.exit15.i1892
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s6, 0
	ld.d	$a1, $sp, 312                   # 8-byte Folded Reload
	move	$a2, $a5
...
# %bb.582:                              # %if.then.i1827
	...
	blez	$a2, .LBB3_705
# %bb.583:                              # %if.then.i1827
                                        #   in Loop: Header=BB3_47 Depth=2
	add.w	$a0, $a2, $s5
	bge	$s1, $a0, .LBB3_705
# %bb.584:                              # %if.end.thread.i
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.d	$s0, $sp, 336                   # 8-byte Folded Reload
	ld.w	$a0, $s0, 0
	ld.d	$a1, $sp, 320                   # 8-byte Folded Reload
...
.LBB3_592:                              # %if.end1503
	...
	ori	$s7, $zero, 18
	b	.LBB3_501
.LBB3_593:                              # %lor.lhs.false1099
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.d	$a4, $sp, 368                   # 8-byte Folded Reload
	lu12i.w	$a5, 2
	ori	$a0, $zero, 45
	bne	$s5, $a0, .LBB3_595
# %bb.594:                              # %lor.lhs.false1099
                                        #   in Loop: Header=BB3_47 Depth=2
	ori	$a0, $zero, 1024
	bltu	$s3, $a0, .LBB3_268
.LBB3_595:                              # %if.else1110
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.d	$s5, $sp, 336                   # 8-byte Folded Reload
	ori	$a0, $zero, 9
	bne	$s7, $a0, .LBB3_598
...
.LBB3_598:                              # %if.end1121
                                        #   in Loop: Header=BB3_47 Depth=2
	beqz	$s5, .LBB3_602
# %bb.599:                              # %if.then.i1746
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s5, 8196
	bne	$a0, $a5, .LBB3_601
# %bb.600:                              # %html_output_flush.exit.i1767
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s5, 0
	ld.d	$a1, $sp, 320                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_601:                              # %if.end.i1749
	...
	ori	$a2, $zero, 38
	stx.b	$a2, $a1, $a0
.LBB3_602:                              # %if.end3.i1754
                                        #   in Loop: Header=BB3_47 Depth=2
	beqz	$s6, .LBB3_606
# %bb.603:                              # %if.then5.i1756
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s6, 8196
	bne	$a0, $a5, .LBB3_605
# %bb.604:                              # %html_output_flush.exit15.i1764
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s6, 0
	ld.d	$a1, $sp, 312                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_605:                              # %if.end9.i1759
	...
	ori	$a2, $zero, 38
	stx.b	$a2, $a1, $a0
.LBB3_606:                              # %html_output_c.exit1770
                                        #   in Loop: Header=BB3_47 Depth=2
	beqz	$s3, .LBB3_621
# %bb.607:                              # %for.body1125.lr.ph
                                        #   in Loop: Header=BB3_47 Depth=2
	st.d	$s2, $sp, 64                    # 8-byte Folded Spill
	addi.d	$s0, $sp, 391
	pcaddu18i	$ra, %call36(__ctype_tolower_loc)
...
.LBB3_609:                              # %for.body1125
	...
	ldx.w	$s2, $a1, $a0
	beqz	$s5, .LBB3_613
# %bb.610:                              # %if.then.i1772
                                        #   in Loop: Header=BB3_609 Depth=3
	ldptr.w	$a0, $s5, 8196
	bne	$a0, $a5, .LBB3_612
# %bb.611:                              # %html_output_flush.exit.i1793
                                        #   in Loop: Header=BB3_609 Depth=3
	ld.w	$a0, $s5, 0
	ld.d	$a1, $sp, 320                   # 8-byte Folded Reload
	move	$a2, $a5
	...
	ld.d	$a4, $sp, 368                   # 8-byte Folded Reload
	move	$a0, $zero
.LBB3_612:                              # %if.end.i1775
                                        #   in Loop: Header=BB3_609 Depth=3
	addi.d	$a1, $a0, 1
	stptr.w	$a1, $s5, 8196
	ld.d	$a1, $sp, 320                   # 8-byte Folded Reload
	stx.b	$s2, $a1, $a0
.LBB3_613:                              # %if.end3.i1780
                                        #   in Loop: Header=BB3_609 Depth=3
	beqz	$s6, .LBB3_617
# %bb.614:                              # %if.then5.i1782
                                        #   in Loop: Header=BB3_609 Depth=3
	ldptr.w	$a0, $s6, 8196
	bne	$a0, $a5, .LBB3_616
# %bb.615:                              # %html_output_flush.exit15.i1790
                                        #   in Loop: Header=BB3_609 Depth=3
	ld.w	$a0, $s6, 0
	ld.d	$a1, $sp, 312                   # 8-byte Folded Reload
	move	$a2, $a5
	...
	ld.d	$a4, $sp, 368                   # 8-byte Folded Reload
	move	$a0, $zero
.LBB3_616:                              # %if.end9.i1785
                                        #   in Loop: Header=BB3_609 Depth=3
	addi.d	$a1, $a0, 1
	stptr.w	$a1, $s6, 8196
	ld.d	$a1, $sp, 312                   # 8-byte Folded Reload
	stx.b	$s2, $a1, $a0
.LBB3_617:                              # %html_output_c.exit1796
                                        #   in Loop: Header=BB3_609 Depth=3
	ori	$a0, $zero, 9
	bne	$s7, $a0, .LBB3_608
# %bb.618:                              # %html_output_c.exit1796
                                        #   in Loop: Header=BB3_609 Depth=3
	ori	$a0, $zero, 1023
	ld.d	$a2, $sp, 328                   # 8-byte Folded Reload
	blt	$a0, $a2, .LBB3_608
...
.LBB3_631:                              # %if.end1080
	...
	ld.d	$s1, $sp, 240                   # 8-byte Folded Reload
	beqz	$s5, .LBB3_635
.LBB3_632:                              # %if.then.i1720
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s5, 8196
	bne	$a0, $a5, .LBB3_634
# %bb.633:                              # %html_output_flush.exit.i1741
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s5, 0
	ld.d	$a1, $sp, 320                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_634:                              # %if.end.i1723
	...
	ori	$a2, $zero, 59
	stx.b	$a2, $a1, $a0
.LBB3_635:                              # %if.end3.i1728
                                        #   in Loop: Header=BB3_47 Depth=2
	beqz	$s6, .LBB3_639
# %bb.636:                              # %if.then5.i1730
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s6, 8196
	bne	$a0, $a5, .LBB3_638
# %bb.637:                              # %html_output_flush.exit15.i1738
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s6, 0
	ld.d	$a1, $sp, 312                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_639:                              # %if.end1081
	...
	move	$s3, $zero
	move	$s6, $zero
.LBB3_640:                              # %while.cond114.backedge
                                        #   in Loop: Header=BB3_47 Depth=2
	addi.d	$s8, $s8, 1
	b	.LBB3_46
.LBB3_641:                              # %if.then447
	...
	ld.d	$s0, $sp, 336                   # 8-byte Folded Reload
	beqz	$s0, .LBB3_645
# %bb.642:                              # %if.then.i1176
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s0, 8196
	bne	$a0, $a5, .LBB3_644
# %bb.643:                              # %html_output_flush.exit.i1197
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s0, 0
	ld.d	$a1, $sp, 320                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_644:                              # %if.end.i1179
	...
	ori	$a2, $zero, 34
	stx.b	$a2, $a1, $a0
.LBB3_645:                              # %if.end3.i1184
                                        #   in Loop: Header=BB3_47 Depth=2
	ori	$s0, $zero, 10
	beqz	$s6, .LBB3_649
# %bb.646:                              # %if.then5.i1186
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s6, 8196
	bne	$a0, $a5, .LBB3_648
# %bb.647:                              # %html_output_flush.exit15.i1194
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s6, 0
	ld.d	$a1, $sp, 312                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_648:                              # %if.end9.i1189
	...
	ori	$a2, $zero, 34
	stx.b	$a2, $a1, $a0
.LBB3_649:                              # %html_output_c.exit1200
                                        #   in Loop: Header=BB3_47 Depth=2
	st.d	$zero, $sp, 232                 # 8-byte Folded Spill
	ori	$a0, $zero, 34
	st.b	$a0, $sp, 1624
...
.LBB3_652:                              # %if.then492
	...
	ld.d	$s0, $sp, 336                   # 8-byte Folded Reload
	beqz	$s0, .LBB3_656
# %bb.653:                              # %if.then.i1254
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s0, 8196
	bne	$a0, $a5, .LBB3_655
# %bb.654:                              # %html_output_flush.exit.i1275
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s0, 0
	ld.d	$a1, $sp, 320                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_655:                              # %if.end.i1257
	...
	ori	$a2, $zero, 34
	stx.b	$a2, $a1, $a0
.LBB3_656:                              # %if.end3.i1262
                                        #   in Loop: Header=BB3_47 Depth=2
	ori	$s0, $zero, 10
	beqz	$s6, .LBB3_660
# %bb.657:                              # %if.then5.i1264
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s6, 8196
	bne	$a0, $a5, .LBB3_659
# %bb.658:                              # %html_output_flush.exit15.i1272
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s6, 0
	ld.d	$a1, $sp, 312                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_659:                              # %if.end9.i1267
	...
	ori	$a2, $zero, 34
	stx.b	$a2, $a1, $a0
.LBB3_660:                              # %html_output_c.exit1278
                                        #   in Loop: Header=BB3_47 Depth=2
	ori	$a0, $zero, 34
	st.b	$a0, $sp, 1624
	addi.d	$s8, $s8, 1
...
.LBB3_661:                              # %if.then432
                                        #   in Loop: Header=BB3_47 Depth=2
	beqz	$s0, .LBB3_665
# %bb.662:                              # %if.then.i1150
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s0, 8196
	bne	$a0, $a5, .LBB3_664
# %bb.663:                              # %html_output_flush.exit.i1171
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s0, 0
	ld.d	$a1, $sp, 320                   # 8-byte Folded Reload
	move	$a2, $a5
...
# %bb.670:                              # %land.lhs.true674
	...
	ld.d	$a4, $sp, 368                   # 8-byte Folded Reload
	bnez	$a0, .LBB3_858
# %bb.671:                              # %for.body.i1450.preheader
                                        #   in Loop: Header=BB3_47 Depth=2
	move	$s5, $zero
.LBB3_672:                              # %for.body.i1450
                                        #   Parent Loop BB3_28 Depth=1
                                        #     Parent Loop BB3_47 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$a0, $s3, 0
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB3_853
# %bb.673:                              # %for.cond.i1455
                                        #   in Loop: Header=BB3_672 Depth=3
	addi.d	$s5, $s5, 1
	addi.d	$s3, $s3, 8
	ori	$s6, $zero, 14
	bne	$s0, $s5, .LBB3_672
...
.LBB3_677:                              # %for.body.i1518
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB3_773
# %bb.678:                              # %for.cond.i1523
                                        #   in Loop: Header=BB3_677 Depth=3
	addi.d	$s1, $s1, 8
	bne	$s3, $s1, .LBB3_677
	b	.LBB3_779
.LBB3_679:                              # %if.then690
...
# %bb.683:                              #   in Loop: Header=BB3_47 Depth=2
	move	$s4, $zero
	b	.LBB3_782
.LBB3_684:                              # %if.else1634
                                        #   in Loop: Header=BB3_47 Depth=2
	ori	$s0, $zero, 20
	ld.d	$a4, $sp, 368                   # 8-byte Folded Reload
	beqz	$s2, .LBB3_417
# %bb.685:                              # %if.then.i2381
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s2, 8196
	bne	$a0, $a5, .LBB3_687
# %bb.686:                              # %html_output_flush.exit.i2390
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s2, 0
	addi.d	$a1, $s2, 4
	move	$a2, $a5
...
.LBB3_689:                              # %if.else549
	...
	addi.d	$s4, $sp, 1624
	beqz	$s3, .LBB3_693
# %bb.690:                              # %if.then.i1332
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a1, $s3, 8196
	bne	$a1, $a5, .LBB3_692
# %bb.691:                              # %html_output_flush.exit.i1353
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a1, $s3, 0
	move	$s0, $a0
	move	$a0, $a1
	...
	ori	$s0, $zero, 10
	move	$a1, $zero
.LBB3_692:                              # %if.end.i1335
                                        #   in Loop: Header=BB3_47 Depth=2
	addi.d	$a2, $a1, 1
	stptr.w	$a2, $s3, 8196
	ld.d	$a2, $sp, 320                   # 8-byte Folded Reload
	stx.b	$s5, $a2, $a1
.LBB3_693:                              # %if.end3.i1340
                                        #   in Loop: Header=BB3_47 Depth=2
	move	$s3, $s2
	move	$s2, $s1
	move	$s1, $s7
	beqz	$s6, .LBB3_697
# %bb.694:                              # %if.then5.i1342
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a1, $s6, 8196
	bne	$a1, $a5, .LBB3_696
# %bb.695:                              # %html_output_flush.exit15.i1350
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a1, $s6, 0
	move	$s0, $a0
	move	$a0, $a1
	...
	ori	$s0, $zero, 10
	move	$a1, $zero
.LBB3_696:                              # %if.end9.i1345
                                        #   in Loop: Header=BB3_47 Depth=2
	addi.d	$a2, $a1, 1
	stptr.w	$a2, $s6, 8196
	ld.d	$a2, $sp, 312                   # 8-byte Folded Reload
	stx.b	$s5, $a2, $a1
.LBB3_697:                              # %html_output_c.exit1356
                                        #   in Loop: Header=BB3_47 Depth=2
	ori	$a1, $zero, 1023
...
# %bb.701:                              # %if.then827
	...
	ld.w	$a0, $sp, 1592
	blez	$a0, .LBB3_918
# %bb.702:                              # %for.body.lr.ph.i1549
                                        #   in Loop: Header=BB3_47 Depth=2
	move	$s5, $s2
	ld.d	$s0, $sp, 1600
	move	$s1, $zero
	slli.d	$s2, $a0, 3
.LBB3_703:                              # %for.body.i1552
                                        #   Parent Loop BB3_28 Depth=1
                                        #     Parent Loop BB3_47 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ldx.d	$a0, $s0, $s1
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB3_833
# %bb.704:                              # %for.cond.i1557
                                        #   in Loop: Header=BB3_703 Depth=3
	addi.d	$s1, $s1, 8
	bne	$s2, $s1, .LBB3_703
	b	.LBB3_842
.LBB3_705:                              # %if.end.i1832
                                        #   in Loop: Header=BB3_47 Depth=2
	bge	$s1, $s4, .LBB3_803
# %bb.706:                              # %if.then3.i
                                        #   in Loop: Header=BB3_47 Depth=2
...
# %bb.707:                              # %if.then.i15.i
	...
	jirl	$ra, $ra, 0
	stptr.w	$zero, $s0, 8196
.LBB3_708:                              # %html_output_flush.exit18.i
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s0, 0
	addi.d	$a1, $sp, 376
	move	$a2, $s4
...
.LBB3_709:                              # %sw.bb1394
	...
	ld.d	$s3, $sp, 336                   # 8-byte Folded Reload
	beqz	$s3, .LBB3_713
# %bb.710:                              # %if.then.i2023
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s3, 8196
	bne	$a0, $a5, .LBB3_712
# %bb.711:                              # %html_output_flush.exit.i2044
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s3, 0
	ld.d	$a1, $sp, 320                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_712:                              # %if.end.i2026
	...
	ori	$a2, $zero, 13
	stx.b	$a2, $a1, $a0
.LBB3_713:                              # %if.end3.i2031
                                        #   in Loop: Header=BB3_47 Depth=2
	move	$s3, $s2
	move	$s2, $s1
	move	$s1, $s5
	beqz	$s0, .LBB3_717
# %bb.714:                              # %if.then5.i2033
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s0, 8196
	bne	$a0, $a5, .LBB3_716
# %bb.715:                              # %html_output_flush.exit15.i2041
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s0, 0
	ld.d	$a1, $sp, 312                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_716:                              # %if.end9.i2036
	...
	ori	$a2, $zero, 13
	stx.b	$a2, $a1, $a0
.LBB3_717:                              # %html_output_c.exit2047
                                        #   in Loop: Header=BB3_47 Depth=2
	beqz	$a4, .LBB3_408
# %bb.718:                              # %if.then.i2049
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $a4, 8196
	ori	$s0, $zero, 10
	bne	$a0, $a5, .LBB3_720
# %bb.719:                              # %html_output_flush.exit.i2058
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $a4, 0
	ld.d	$a1, $sp, 360                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_721:                              # %sw.bb1397
	...
	ld.d	$s3, $sp, 336                   # 8-byte Folded Reload
	beqz	$s3, .LBB3_725
# %bb.722:                              # %if.then.i2143
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s3, 8196
	bne	$a0, $a5, .LBB3_724
# %bb.723:                              # %html_output_flush.exit.i2164
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s3, 0
	ld.d	$a1, $sp, 320                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_724:                              # %if.end.i2146
	...
	ori	$a2, $zero, 62
	stx.b	$a2, $a1, $a0
.LBB3_725:                              # %if.end3.i2151
                                        #   in Loop: Header=BB3_47 Depth=2
	move	$s3, $s2
	move	$s2, $s1
	move	$s1, $s5
	beqz	$s0, .LBB3_729
# %bb.726:                              # %if.then5.i2153
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s0, 8196
	bne	$a0, $a5, .LBB3_728
# %bb.727:                              # %html_output_flush.exit15.i2161
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s0, 0
	ld.d	$a1, $sp, 312                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_728:                              # %if.end9.i2156
	...
	ori	$a2, $zero, 62
	stx.b	$a2, $a1, $a0
.LBB3_729:                              # %html_output_c.exit2167
                                        #   in Loop: Header=BB3_47 Depth=2
	beqz	$a4, .LBB3_408
# %bb.730:                              # %if.then.i2169
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $a4, 8196
	ori	$s0, $zero, 10
	bne	$a0, $a5, .LBB3_732
# %bb.731:                              # %html_output_flush.exit.i2178
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $a4, 0
	ld.d	$a1, $sp, 360                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_733:                              # %sw.bb1393
	...
	ld.d	$s3, $sp, 336                   # 8-byte Folded Reload
	beqz	$s3, .LBB3_737
# %bb.734:                              # %if.then.i1983
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s3, 8196
	bne	$a0, $a5, .LBB3_736
# %bb.735:                              # %html_output_flush.exit.i2004
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s3, 0
	ld.d	$a1, $sp, 320                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_736:                              # %if.end.i1986
	...
	ori	$a2, $zero, 60
	stx.b	$a2, $a1, $a0
.LBB3_737:                              # %if.end3.i1991
                                        #   in Loop: Header=BB3_47 Depth=2
	move	$s3, $s2
	move	$s2, $s1
	move	$s1, $s5
	beqz	$s0, .LBB3_741
# %bb.738:                              # %if.then5.i1993
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s0, 8196
	bne	$a0, $a5, .LBB3_740
# %bb.739:                              # %html_output_flush.exit15.i2001
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s0, 0
	ld.d	$a1, $sp, 312                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_740:                              # %if.end9.i1996
	...
	ori	$a2, $zero, 60
	stx.b	$a2, $a1, $a0
.LBB3_741:                              # %html_output_c.exit2007
                                        #   in Loop: Header=BB3_47 Depth=2
	beqz	$a4, .LBB3_408
# %bb.742:                              # %if.then.i2009
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $a4, 8196
	ori	$s0, $zero, 10
	bne	$a0, $a5, .LBB3_744
# %bb.743:                              # %html_output_flush.exit.i2018
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $a4, 0
	ld.d	$a1, $sp, 360                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_745:                              # %sw.bb1395
	...
	ld.d	$s3, $sp, 336                   # 8-byte Folded Reload
	beqz	$s3, .LBB3_749
# %bb.746:                              # %if.then.i2063
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s3, 8196
	bne	$a0, $a5, .LBB3_748
# %bb.747:                              # %html_output_flush.exit.i2084
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s3, 0
	ld.d	$a1, $sp, 320                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_748:                              # %if.end.i2066
	...
	ori	$a2, $zero, 64
	stx.b	$a2, $a1, $a0
.LBB3_749:                              # %if.end3.i2071
                                        #   in Loop: Header=BB3_47 Depth=2
	move	$s3, $s2
	move	$s2, $s1
	move	$s1, $s5
	beqz	$s0, .LBB3_753
# %bb.750:                              # %if.then5.i2073
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s0, 8196
	bne	$a0, $a5, .LBB3_752
# %bb.751:                              # %html_output_flush.exit15.i2081
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s0, 0
	ld.d	$a1, $sp, 312                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_752:                              # %if.end9.i2076
	...
	ori	$a2, $zero, 64
	stx.b	$a2, $a1, $a0
.LBB3_753:                              # %html_output_c.exit2087
                                        #   in Loop: Header=BB3_47 Depth=2
	beqz	$a4, .LBB3_408
# %bb.754:                              # %if.then.i2089
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $a4, 8196
	ori	$s0, $zero, 10
	bne	$a0, $a5, .LBB3_756
# %bb.755:                              # %html_output_flush.exit.i2098
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $a4, 0
	ld.d	$a1, $sp, 360                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_757:                              # %sw.bb1396
	...
	ld.d	$s3, $sp, 336                   # 8-byte Folded Reload
	beqz	$s3, .LBB3_761
# %bb.758:                              # %if.then.i2103
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s3, 8196
	bne	$a0, $a5, .LBB3_760
# %bb.759:                              # %html_output_flush.exit.i2124
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s3, 0
	ld.d	$a1, $sp, 320                   # 8-byte Folded Reload
	move	$a2, $a5
	...
	ld.d	$a4, $sp, 368                   # 8-byte Folded Reload
	move	$a0, $zero
.LBB3_760:                              # %if.end.i2106
                                        #   in Loop: Header=BB3_47 Depth=2
	addi.d	$a1, $a0, 1
	stptr.w	$a1, $s3, 8196
	ld.d	$a1, $sp, 320                   # 8-byte Folded Reload
	stx.b	$s5, $a1, $a0
.LBB3_761:                              # %if.end3.i2111
                                        #   in Loop: Header=BB3_47 Depth=2
	move	$s3, $s2
	move	$s2, $s1
	move	$s1, $s6
	beqz	$s0, .LBB3_765
# %bb.762:                              # %if.then5.i2113
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s0, 8196
	bne	$a0, $a5, .LBB3_764
# %bb.763:                              # %html_output_flush.exit15.i2121
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s0, 0
	ld.d	$a1, $sp, 312                   # 8-byte Folded Reload
	move	$a2, $a5
	...
	ld.d	$a4, $sp, 368                   # 8-byte Folded Reload
	move	$a0, $zero
.LBB3_764:                              # %if.end9.i2116
                                        #   in Loop: Header=BB3_47 Depth=2
	addi.d	$a1, $a0, 1
	stptr.w	$a1, $s0, 8196
	ld.d	$a1, $sp, 312                   # 8-byte Folded Reload
	stx.b	$s5, $a1, $a0
.LBB3_765:                              # %html_output_c.exit2127
                                        #   in Loop: Header=BB3_47 Depth=2
	beqz	$a4, .LBB3_408
# %bb.766:                              # %if.then.i2129
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $a4, 8196
	ori	$s0, $zero, 10
	bne	$a0, $a5, .LBB3_768
# %bb.767:                              # %html_output_flush.exit.i2138
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $a4, 0
	ld.d	$a1, $sp, 360                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_771:                              # %for.body.i1569
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB3_820
# %bb.772:                              # %for.cond.i1574
                                        #   in Loop: Header=BB3_771 Depth=3
	addi.d	$s2, $s2, 8
	bne	$s3, $s2, .LBB3_771
	b	.LBB3_827
.LBB3_773:                              # %html_tag_arg_value.exit1529
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.d	$s3, $sp, 1608
	ldx.d	$s4, $s3, $s1
	beqz	$s4, .LBB3_779
# %bb.774:                              # %land.lhs.true767
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.bu	$a0, $s4, 0
	ld.d	$s1, $sp, 240                   # 8-byte Folded Reload
	beqz	$a0, .LBB3_900
...
.LBB3_776:                              # %for.body.i1535
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB3_905
# %bb.777:                              # %for.cond.i1540
                                        #   in Loop: Header=BB3_776 Depth=3
	addi.d	$s3, $s3, 8
	addi.d	$s0, $s0, -1
	addi.d	$s2, $s2, 8
	bnez	$s0, .LBB3_776
...
.LBB3_780:                              # %if.end974
	...
	move	$s2, $s5
	b	.LBB3_919
.LBB3_781:                              # %if.then.i1492
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.d	$a0, $sp, 1608
	ldx.d	$s4, $a0, $s1
.LBB3_782:                              # %for.body.lr.ph.i1498
                                        #   in Loop: Header=BB3_47 Depth=2
	move	$s1, $zero
	move	$s3, $s5
.LBB3_783:                              # %for.body.i1501
                                        #   Parent Loop BB3_28 Depth=1
                                        #     Parent Loop BB3_47 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ldx.d	$a0, $s2, $s1
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB3_785
# %bb.784:                              # %for.cond.i1506
                                        #   in Loop: Header=BB3_783 Depth=3
	addi.d	$s0, $s0, -1
	addi.d	$s1, $s1, 8
	bnez	$s0, .LBB3_783
	b	.LBB3_852
.LBB3_785:                              # %html_tag_arg_value.exit1512
                                        #   in Loop: Header=BB3_47 Depth=2
	ori	$s0, $zero, 10
	move	$s2, $s7
	beqz	$s4, .LBB3_837
# %bb.786:                              # %html_tag_arg_value.exit1512
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.d	$a0, $sp, 1608
	ldx.d	$s5, $a0, $s1
	beqz	$s5, .LBB3_837
# %bb.787:                              # %land.lhs.true696
                                        #   in Loop: Header=BB3_47 Depth=2
...
# %bb.788:                              # %if.then700
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB3_993
# %bb.789:                              # %for.cond.preheader
                                        #   in Loop: Header=BB3_47 Depth=2
	move	$s7, $a0
	beqz	$s4, .LBB3_792
# %bb.790:                              # %for.body.lr.ph
                                        #   in Loop: Header=BB3_47 Depth=2
	pcaddu18i	$ra, %call36(__ctype_tolower_loc)
	jirl	$ra, $ra, 0
	move	$a1, $s7
...
.LBB3_792:                              # %for.end
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB3_917
# %bb.793:                              # %while.cond722
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.bu	$a1, $a0, 0
	beqz	$a1, .LBB3_796
.LBB3_794:                              # %while.cond722
                                        #   Parent Loop BB3_28 Depth=1
                                        #     Parent Loop BB3_47 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ori	$a2, $zero, 61
	beq	$a1, $a2, .LBB3_796
# %bb.795:                              # %while.body731
                                        #   in Loop: Header=BB3_794 Depth=3
	addi.d	$a0, $a0, 1
	ld.bu	$a1, $a0, 0
	bnez	$a1, .LBB3_794
.LBB3_796:                              # %while.end733
                                        #   in Loop: Header=BB3_47 Depth=2
	sltu	$s0, $zero, $a1
	add.d	$s4, $a0, $s0
...
.LBB3_799:                              # %if.then903
	...
	ld.w	$a0, $sp, 1592
	blez	$a0, .LBB3_902
# %bb.800:                              # %for.body.lr.ph.i1600
                                        #   in Loop: Header=BB3_47 Depth=2
	move	$s5, $s2
	ld.d	$s0, $sp, 1600
	move	$s1, $zero
	slli.d	$s2, $a0, 3
.LBB3_801:                              # %for.body.i1603
                                        #   Parent Loop BB3_28 Depth=1
                                        #     Parent Loop BB3_47 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ldx.d	$a0, $s0, $s1
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB3_839
# %bb.802:                              # %for.cond.i1608
                                        #   in Loop: Header=BB3_801 Depth=3
	addi.d	$s1, $s1, 8
	bne	$s2, $s1, .LBB3_801
	b	.LBB3_842
...
.LBB3_816:                              # %if.end1236
	...
	ori	$s0, $zero, 10
	b	.LBB3_46
.LBB3_817:                              # %for.body.i1437.preheader
                                        #   in Loop: Header=BB3_47 Depth=2
	move	$s5, $zero
.LBB3_818:                              # %for.body.i1437
                                        #   Parent Loop BB3_28 Depth=1
                                        #     Parent Loop BB3_47 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$a0, $s3, 0
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB3_838
# %bb.819:                              # %for.cond.i1442
                                        #   in Loop: Header=BB3_818 Depth=3
	addi.d	$s5, $s5, 1
	addi.d	$s3, $s3, 8
	bne	$s0, $s5, .LBB3_818
	b	.LBB3_855
.LBB3_820:                              # %html_tag_arg_value.exit1580
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.d	$a0, $sp, 1608
	ldx.d	$s4, $a0, $s2
	beqz	$s4, .LBB3_827
# %bb.821:                              # %land.lhs.true844
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.bu	$a0, $s4, 0
	move	$s3, $s5
	move	$s2, $s7
...
.LBB3_828:                              # %if.end869
	...
	addi.w	$a0, $s0, 0
	blez	$a0, .LBB3_832
# %bb.829:                              # %for.body.lr.ph.i1583
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.d	$s1, $sp, 1600
	move	$s2, $zero
	slli.d	$s0, $s0, 3
.LBB3_830:                              # %for.body.i1586
                                        #   Parent Loop BB3_28 Depth=1
                                        #     Parent Loop BB3_47 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ldx.d	$a0, $s1, $s2
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB3_843
# %bb.831:                              # %for.cond.i1591
                                        #   in Loop: Header=BB3_830 Depth=3
	addi.d	$s2, $s2, 8
	bne	$s0, $s2, .LBB3_830
	b	.LBB3_852
.LBB3_832:                              #   in Loop: Header=BB3_47 Depth=2
	...
	ld.d	$s1, $sp, 240                   # 8-byte Folded Reload
	b	.LBB3_903
.LBB3_833:                              # %html_tag_arg_value.exit1563
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.d	$a0, $sp, 1608
	ldx.d	$s4, $a0, $s1
	ori	$s0, $zero, 10
...
.LBB3_838:                              #   in Loop: Header=BB3_47 Depth=2
	...
	b	.LBB3_854
.LBB3_839:                              # %html_tag_arg_value.exit1614
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.d	$a0, $sp, 1608
	ldx.d	$s4, $a0, $s1
	beqz	$s4, .LBB3_842
# %bb.840:                              # %land.lhs.true906
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.bu	$a0, $s4, 0
	ld.d	$s1, $sp, 240                   # 8-byte Folded Reload
	ori	$s0, $zero, 10
...
.LBB3_919:                              # %if.end974
	...
	st.d	$a0, $sp, 224                   # 8-byte Folded Spill
.LBB3_920:                              # %while.cond114.backedge
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.d	$a4, $sp, 368                   # 8-byte Folded Reload
	lu12i.w	$a5, 2
	b	.LBB3_46
...
# %bb.924:                              # %if.then1730
	...
	beqz	$a0, .LBB3_947
# %bb.925:                              # %for.cond1738.preheader
	move	$s0, $a0
	ld.bu	$a0, $a0, 0
	beqz	$a0, .LBB3_974
# %bb.926:                              # %for.body1742.lr.ph
	pcaddu18i	$ra, %call36(__ctype_tolower_loc)
	jirl	$ra, $ra, 0
	move	$s4, $a0
	...
	beqz	$a1, .LBB3_961
# %bb.927:                              # %for.body1742.lr.ph.split
	addi.d	$s6, $a1, 4
	move	$s2, $zero
	beqz	$a0, .LBB3_970
# %bb.928:                              # %for.body1742.preheader
	lu12i.w	$s7, 2
	b	.LBB3_930
	.p2align	4, , 16
.LBB3_929:                              # %if.end9.i2501
...
.LBB3_930:                              # %for.body1742
	...
	ldx.w	$s3, $a1, $a2
	bne	$a0, $s7, .LBB3_932
# %bb.931:                              # %html_output_flush.exit.i2509
                                        #   in Loop: Header=BB3_930 Depth=1
	ld.w	$a0, $s8, 0
	move	$a1, $s6
	move	$a2, $s7
...
.LBB3_932:                              # %if.end.i2491
	...
	ldptr.w	$a0, $s8, 8196
	bne	$a0, $s7, .LBB3_929
# %bb.933:                              # %html_output_flush.exit15.i2506
                                        #   in Loop: Header=BB3_930 Depth=1
	ld.w	$a0, $s8, 0
	move	$a1, $s5
	move	$a2, $s7
...
.LBB3_941:                              # %if.end1793
	beqz	$s6, .LBB3_986
.LBB3_942:                              # %if.then1795
	ldptr.w	$a2, $s6, 8196
	blez	$a2, .LBB3_944
# %bb.943:                              # %if.then.i2555
	ld.w	$a0, $s6, 0
	addi.d	$a1, $s6, 4
	pcaddu18i	$ra, %call36(cli_writen)
	jirl	$ra, $ra, 0
	stptr.w	$zero, $s6, 8196
.LBB3_944:                              # %html_output_flush.exit2558
	ld.w	$a0, $s6, 0
	pcaddu18i	$ra, %call36(close)
	jirl	$ra, $ra, 0
	move	$a0, $s6
...
# %bb.948:                              # %if.then1756
	...
	b	.LBB3_951
	.p2align	4, , 16
.LBB3_949:                              # %if.end9.i2527
                                        #   in Loop: Header=BB3_951 Depth=1
	addi.d	$a1, $a0, 1
	stptr.w	$a1, $s7, 8196
	stx.b	$s3, $s5, $a0
.LBB3_950:                              # %html_output_c.exit2538
                                        #   in Loop: Header=BB3_951 Depth=1
	addi.d	$s3, $s8, -1
	addi.d	$s2, $s2, 1
	beqz	$s3, .LBB3_959
.LBB3_951:                              # %for.body1760
                                        # =>This Inner Loop Header: Depth=1
	move	$s8, $s3
	ld.bu	$a0, $s2, 0
	ld.d	$a1, $s0, 0
	...
	beqz	$s7, .LBB3_955
# %bb.952:                              # %if.then.i2514
                                        #   in Loop: Header=BB3_951 Depth=1
	ldptr.w	$a0, $s7, 8196
	bne	$a0, $s6, .LBB3_954
# %bb.953:                              # %html_output_flush.exit.i2535
                                        #   in Loop: Header=BB3_951 Depth=1
	ld.w	$a0, $s7, 0
	move	$a1, $s4
	move	$a2, $s6
	...
	jirl	$ra, $ra, 0
	move	$a0, $zero
.LBB3_954:                              # %if.end.i2517
                                        #   in Loop: Header=BB3_951 Depth=1
	addi.d	$a1, $a0, 1
	stptr.w	$a1, $s7, 8196
	stx.b	$s3, $s4, $a0
.LBB3_955:                              # %if.end3.i2522
                                        #   in Loop: Header=BB3_951 Depth=1
	ld.d	$s7, $sp, 344                   # 8-byte Folded Reload
	beqz	$s7, .LBB3_950
# %bb.956:                              # %if.then5.i2524
                                        #   in Loop: Header=BB3_951 Depth=1
	ldptr.w	$a0, $s7, 8196
	bne	$a0, $s6, .LBB3_949
# %bb.957:                              # %html_output_flush.exit15.i2532
                                        #   in Loop: Header=BB3_951 Depth=1
	ld.w	$a0, $s7, 0
	move	$a1, $s5
	move	$a2, $s6
...
.LBB3_960:                              # %if.then59
	...
	jirl	$ra, $ra, 0
	b	.LBB3_978
.LBB3_961:                              # %for.body1742.lr.ph.split.us
	beqz	$a0, .LBB3_974
# %bb.962:                              # %for.body1742.us.preheader
	move	$s2, $zero
	lu12i.w	$s6, 2
	b	.LBB3_964
	.p2align	4, , 16
.LBB3_963:                              # %if.end9.i2501.us
...
.LBB3_964:                              # %for.body1742.us
	...
	ldx.w	$s1, $a1, $a2
	bne	$a0, $s6, .LBB3_963
# %bb.965:                              # %html_output_flush.exit15.i2506.us
                                        #   in Loop: Header=BB3_964 Depth=1
	ld.w	$a0, $s7, 0
	move	$a1, $s5
	move	$a2, $s6
...
.LBB3_969:
	...
	ld.d	$s5, $sp, 336                   # 8-byte Folded Reload
	b	.LBB3_992
.LBB3_970:                              # %for.body1742.us2819.preheader
	lu12i.w	$s5, 2
	b	.LBB3_972
	.p2align	4, , 16
.LBB3_971:                              # %if.end.i2491.us
...
.LBB3_972:                              # %for.body1742.us2819
	...
	ldx.w	$s1, $a1, $a2
	bne	$a0, $s5, .LBB3_971
# %bb.973:                              # %html_output_flush.exit.i2509.us
                                        #   in Loop: Header=BB3_972 Depth=1
	ld.w	$a0, $s3, 0
	move	$a1, $s6
	move	$a2, $s5
...
.LBB3_982:                              # %if.end1788
	ld.d	$s0, $sp, 368                   # 8-byte Folded Reload
	beqz	$s5, .LBB3_941
.LBB3_983:                              # %if.then1790
	ldptr.w	$a2, $s5, 8196
	blez	$a2, .LBB3_985
# %bb.984:                              # %if.then.i2548
	ld.w	$a0, $s5, 0
	addi.d	$a1, $s5, 4
	pcaddu18i	$ra, %call36(cli_writen)
	jirl	$ra, $ra, 0
	stptr.w	$zero, $s5, 8196
.LBB3_985:                              # %html_output_flush.exit2551
	ld.w	$a0, $s5, 0
	pcaddu18i	$ra, %call36(close)
	jirl	$ra, $ra, 0
	move	$a0, $s5
...
.LBB3_986:                              # %if.end1798
	beqz	$s0, .LBB3_990
.LBB3_987:                              # %if.then1800
	ldptr.w	$a2, $s0, 8196
	blez	$a2, .LBB3_989
# %bb.988:                              # %if.then.i2562
	ld.w	$a0, $s0, 0
	addi.d	$a1, $s0, 4
	pcaddu18i	$ra, %call36(cli_writen)
	jirl	$ra, $ra, 0
	ld.d	$s0, $sp, 368                   # 8-byte Folded Reload
	stptr.w	$zero, $s0, 8196
.LBB3_989:                              # %html_output_flush.exit2565
	ld.w	$a0, $s0, 0
	pcaddu18i	$ra, %call36(close)
	jirl	$ra, $ra, 0
	move	$a0, $s0
...
.LBB5_37:                               # %if.end132
	...
	slli.d	$a2, $a2, 6
	sub.w	$s8, $a1, $a2
.LBB5_38:                               # %sw.epilog136
                                        #   in Loop: Header=BB5_39 Depth=1
	beqz	$s4, .LBB5_62
	.p2align	4, , 16
.LBB5_39:                               # %land.rhs88.preheader
                                        # =>This Inner Loop Header: Depth=1
	addi.d	$a0, $a0, 1
	ld.bu	$a1, $a0, -1
	beq	$a1, $s7, .LBB5_39
...
.LBB5_54:                               # %sw.bb111
	...
	ori	$s2, $zero, 64
	bne	$a1, $s0, .LBB5_56
.LBB5_55:                               # %sw.epilog.sink.split.sink.split
                                        #   in Loop: Header=BB5_39 Depth=1
	ld.w	$a1, $sp, 16
	move	$s3, $a0
	move	$a0, $a1
