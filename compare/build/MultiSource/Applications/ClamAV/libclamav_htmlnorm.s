...
.LBB3_139:                              # %for.body1012
	...
	lu12i.w	$a2, 2
	beqz	$s3, .LBB3_143
# %bb.140:                              # %if.then.i1642
                                        #   in Loop: Header=BB3_139 Depth=3
	ldptr.w	$a0, $s3, 8196
	bne	$a0, $a2, .LBB3_142
# %bb.141:                              # %html_output_flush.exit.i1663
                                        #   in Loop: Header=BB3_139 Depth=3
	ld.w	$a0, $s3, 0
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(cli_writen)
	...
	lu12i.w	$a2, 2
	move	$a0, $zero
.LBB3_142:                              # %if.end.i1645
                                        #   in Loop: Header=BB3_139 Depth=3
	addi.d	$a1, $a0, 1
	stptr.w	$a1, $s3, 8196
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	stx.b	$s0, $a1, $a0
.LBB3_143:                              # %if.end3.i1650
                                        #   in Loop: Header=BB3_139 Depth=3
	ld.d	$s3, $sp, 176                   # 8-byte Folded Reload
	beqz	$s6, .LBB3_147
# %bb.144:                              # %if.then5.i1652
                                        #   in Loop: Header=BB3_139 Depth=3
	ldptr.w	$a0, $s6, 8196
	bne	$a0, $a2, .LBB3_146
# %bb.145:                              # %html_output_flush.exit15.i1660
                                        #   in Loop: Header=BB3_139 Depth=3
	ld.w	$a0, $s6, 0
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(cli_writen)
	jirl	$ra, $ra, 0
	move	$a0, $zero
.LBB3_146:                              # %if.end9.i1655
                                        #   in Loop: Header=BB3_139 Depth=3
	addi.d	$a1, $a0, 1
	stptr.w	$a1, $s6, 8196
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	stx.b	$s0, $a1, $a0
.LBB3_147:                              # %html_output_c.exit1666
                                        #   in Loop: Header=BB3_139 Depth=3
	ori	$a0, $zero, 9
	bne	$s7, $a0, .LBB3_138
# %bb.148:                              # %html_output_c.exit1666
                                        #   in Loop: Header=BB3_139 Depth=3
	ori	$a0, $zero, 1023
...
# %bb.156:                              # %if.then.i994
	...
	ldptr.w	$a0, $fp, 8196
	bne	$a0, $a5, .LBB3_158
# %bb.157:                              # %html_output_flush.exit.i1015
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $fp, 0
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_158:                              # %if.end.i997
	...
	ori	$a2, $zero, 61
	stx.b	$a2, $a1, $a0
.LBB3_159:                              # %if.end3.i1002
                                        #   in Loop: Header=BB3_47 Depth=2
	beqz	$s6, .LBB3_163
# %bb.160:                              # %if.then5.i1004
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s6, 8196
	bne	$a0, $a5, .LBB3_162
# %bb.161:                              # %html_output_flush.exit15.i1012
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s6, 0
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_162:                              # %if.end9.i1007
	...
	ori	$a2, $zero, 61
	stx.b	$a2, $a1, $a0
.LBB3_163:                              # %html_output_c.exit1018
                                        #   in Loop: Header=BB3_47 Depth=2
	st.d	$zero, $sp, 232                 # 8-byte Folded Spill
	st.d	$zero, $sp, 152                 # 8-byte Folded Spill
	...
	add.d	$a1, $sp, $a1
	stx.b	$zero, $a0, $a1
.LBB3_164:                              # %while.cond114.backedge
                                        #   in Loop: Header=BB3_47 Depth=2
	addi.d	$s8, $s8, 1
	ori	$s7, $zero, 5
	ori	$s6, $zero, 9
...
# %bb.166:                              # %if.then.i1384
	...
	lu12i.w	$a5, 2
	bne	$a1, $a5, .LBB3_168
# %bb.167:                              # %html_output_flush.exit.i1393
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a1, $s3, 0
	move	$s0, $a0
	move	$a0, $a1
...
# %bb.175:                              # %if.then5.i
	...
	ldptr.w	$a0, $s6, 8196
	bne	$a0, $a5, .LBB3_177
# %bb.176:                              # %html_output_flush.exit15.i
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s6, 0
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	move	$a2, $a5
...
# %bb.181:                              # %if.then.i886
	...
	ldptr.w	$a0, $fp, 8196
	bne	$a0, $a5, .LBB3_183
# %bb.182:                              # %html_output_flush.exit.i895
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $fp, 0
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_183:                              # %if.end.i889
	...
	ori	$a2, $zero, 33
	stx.b	$a2, $a1, $a0
.LBB3_184:                              # %html_output_c.exit898
                                        #   in Loop: Header=BB3_47 Depth=2
	beqz	$a4, .LBB3_189
# %bb.185:                              # %html_output_c.exit898
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.d	$a0, $sp, 120                   # 8-byte Folded Reload
	beqz	$a0, .LBB3_189
# %bb.186:                              # %if.then.i900
	...
	ldptr.w	$a0, $a4, 8196
	bne	$a0, $a5, .LBB3_188
# %bb.187:                              # %html_output_flush.exit.i909
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $a4, 0
	ld.d	$a1, $sp, 248                   # 8-byte Folded Reload
	move	$a2, $a5
...
# %bb.203:                              # %if.then401
                                        #   in Loop: Header=BB3_47 Depth=2
	beqz	$s0, .LBB3_207
# %bb.204:                              # %if.then.i1124
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s0, 8196
	bne	$a0, $a5, .LBB3_206
# %bb.205:                              # %html_output_flush.exit.i1145
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s0, 0
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_206:                              # %if.end.i1127
	...
	ori	$a2, $zero, 34
	stx.b	$a2, $a1, $a0
.LBB3_207:                              # %if.end3.i1132
                                        #   in Loop: Header=BB3_47 Depth=2
	beqz	$s6, .LBB3_676
.LBB3_208:                              # %if.then5.i1134
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s6, 8196
	ori	$s0, $zero, 10
	bne	$a0, $a5, .LBB3_210
# %bb.209:                              # %html_output_flush.exit15.i1142
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s6, 0
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	move	$a2, $a5
...
# %bb.214:                              # %if.then1607
	...
	ori	$a1, $zero, 1
	beq	$a0, $a1, .LBB3_428
.LBB3_215:                              # %if.else1614
                                        #   in Loop: Header=BB3_47 Depth=2
	ori	$fp, $zero, 20
	ld.d	$s4, $sp, 144                   # 8-byte Folded Reload
	beqz	$s4, .LBB3_428
# %bb.216:                              # %if.then.i2367
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s4, 8196
	bne	$a0, $a5, .LBB3_218
# %bb.217:                              # %html_output_flush.exit.i2376
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s4, 0
	addi.d	$a1, $s4, 4
	move	$a2, $a5
...
.LBB3_226:                              # %sw.bb1393
	...
	ld.d	$s3, $sp, 256                   # 8-byte Folded Reload
	beqz	$s3, .LBB3_230
# %bb.227:                              # %if.then.i1983
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s3, 8196
	bne	$a0, $a5, .LBB3_229
# %bb.228:                              # %html_output_flush.exit.i2004
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s3, 0
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_229:                              # %if.end.i1986
	...
	ori	$a2, $zero, 60
	stx.b	$a2, $a1, $a0
.LBB3_230:                              # %if.end3.i1991
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.d	$s3, $sp, 176                   # 8-byte Folded Reload
	beqz	$s0, .LBB3_234
# %bb.231:                              # %if.then5.i1993
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s0, 8196
	bne	$a0, $a5, .LBB3_233
# %bb.232:                              # %html_output_flush.exit15.i2001
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s0, 0
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_233:                              # %if.end9.i1996
	...
	ori	$a2, $zero, 60
	stx.b	$a2, $a1, $a0
.LBB3_234:                              # %html_output_c.exit2007
                                        #   in Loop: Header=BB3_47 Depth=2
	beqz	$a4, .LBB3_755
# %bb.235:                              # %if.then.i2009
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $a4, 8196
	ori	$s0, $zero, 10
	bne	$a0, $a5, .LBB3_237
# %bb.236:                              # %html_output_flush.exit.i2018
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $a4, 0
	ld.d	$a1, $sp, 248                   # 8-byte Folded Reload
	move	$a2, $a5
...
# %bb.243:                              # %if.then1659
	...
	ld.d	$s4, $sp, 144                   # 8-byte Folded Reload
	beqz	$s4, .LBB3_364
# %bb.244:                              # %if.then.i2415
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s4, 8196
	bne	$a0, $a5, .LBB3_246
# %bb.245:                              # %html_output_flush.exit.i2424
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s4, 0
	addi.d	$a1, $s4, 4
	move	$a2, $a5
...
.LBB3_269:                              # %if.end994
                                        #   in Loop: Header=BB3_47 Depth=2
	beqz	$fp, .LBB3_273
# %bb.270:                              # %if.then.i1616
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $fp, 8196
	bne	$a0, $a5, .LBB3_272
# %bb.271:                              # %html_output_flush.exit.i1637
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $fp, 0
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_272:                              # %if.end.i1619
	...
	ori	$a2, $zero, 38
	stx.b	$a2, $a1, $a0
.LBB3_273:                              # %if.end3.i1624
                                        #   in Loop: Header=BB3_47 Depth=2
	beqz	$s6, .LBB3_580
# %bb.274:                              # %if.then5.i1626
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s6, 8196
	bne	$a0, $a5, .LBB3_276
# %bb.275:                              # %html_output_flush.exit15.i1634
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s6, 0
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	move	$a2, $a5
...
# %bb.285:                              # %if.then318
	...
	ld.d	$fp, $sp, 256                   # 8-byte Folded Reload
	beqz	$fp, .LBB3_289
# %bb.286:                              # %if.then.i1020
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $fp, 8196
	bne	$a0, $a5, .LBB3_288
# %bb.287:                              # %html_output_flush.exit.i1041
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $fp, 0
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_288:                              # %if.end.i1023
	...
	ori	$a2, $zero, 62
	stx.b	$a2, $a1, $a0
.LBB3_289:                              # %if.end3.i1028
                                        #   in Loop: Header=BB3_47 Depth=2
	beqz	$s6, .LBB3_293
# %bb.290:                              # %if.then5.i1030
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s6, 8196
	bne	$a0, $a5, .LBB3_292
# %bb.291:                              # %html_output_flush.exit15.i1038
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s6, 0
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_292:                              # %if.end9.i1033
	...
	ori	$a2, $zero, 62
	stx.b	$a2, $a1, $a0
.LBB3_293:                              # %html_output_c.exit1044
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.d	$a0, $sp, 88                    # 8-byte Folded Reload
	addi.w	$a0, $a0, 0
	ori	$a1, $zero, 1
...
# %bb.301:                              # %if.then.i914
	...
	ldptr.w	$a0, $fp, 8196
	bne	$a0, $a5, .LBB3_303
# %bb.302:                              # %html_output_flush.exit.i935
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $fp, 0
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_303:                              # %if.end.i917
	...
	ori	$a2, $zero, 62
	stx.b	$a2, $a1, $a0
.LBB3_304:                              # %if.end3.i922
                                        #   in Loop: Header=BB3_47 Depth=2
	beqz	$s6, .LBB3_308
# %bb.305:                              # %if.then5.i924
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s6, 8196
	bne	$a0, $a5, .LBB3_307
# %bb.306:                              # %html_output_flush.exit15.i932
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s6, 0
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_307:                              # %if.end9.i927
	...
	ori	$a2, $zero, 62
	stx.b	$a2, $a1, $a0
.LBB3_308:                              # %html_output_c.exit938
                                        #   in Loop: Header=BB3_47 Depth=2
	beqz	$a4, .LBB3_313
# %bb.309:                              # %html_output_c.exit938
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.d	$a0, $sp, 120                   # 8-byte Folded Reload
	beqz	$a0, .LBB3_313
# %bb.310:                              # %if.then.i940
	...
	ldptr.w	$a0, $a4, 8196
	bne	$a0, $a5, .LBB3_312
# %bb.311:                              # %html_output_flush.exit.i949
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $a4, 0
	ld.d	$a1, $sp, 248                   # 8-byte Folded Reload
	move	$a2, $a5
...
# %bb.321:                              # %if.then.i1398
	...
	ldx.w	$fp, $a1, $a2
	bne	$a0, $a5, .LBB3_323
# %bb.322:                              # %html_output_flush.exit.i1407
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $a4, 0
	ld.d	$a1, $sp, 248                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_324:                              # %if.end617
	...
	or	$s7, $a0, $a1
	b	.LBB3_45
.LBB3_325:                              # %land.lhs.true1153
                                        #   in Loop: Header=BB3_47 Depth=2
	ori	$a0, $zero, 59
	beq	$s4, $a0, .LBB3_329
# %bb.326:                              # %land.lhs.true1153
                                        #   in Loop: Header=BB3_47 Depth=2
	ori	$a0, $zero, 120
	beq	$s4, $a0, .LBB3_328
...
# %bb.353:                              # %if.then1510
	...
	ori	$a0, $zero, 19
	b	.LBB3_634
.LBB3_354:                              # %if.then1664
                                        #   in Loop: Header=BB3_47 Depth=2
	ori	$a0, $zero, 1
	st.d	$a0, $sp, 168                   # 8-byte Folded Spill
	ld.d	$s4, $sp, 144                   # 8-byte Folded Reload
	beqz	$s4, .LBB3_364
# %bb.355:                              # %if.then.i2429
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s4, 8196
	bne	$a0, $a5, .LBB3_357
# %bb.356:                              # %html_output_flush.exit.i2438
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s4, 0
	addi.d	$a1, $s4, 4
	move	$a2, $a5
...
.LBB3_357:                              # %if.then.i2443
	...
	ldptr.w	$a0, $s4, 8196
	bne	$a0, $a5, .LBB3_359
# %bb.358:                              # %html_output_flush.exit.i2452
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s4, 0
	move	$a1, $fp
	move	$a2, $a5
...
.LBB3_359:                              # %if.end.i2446
	...
	stx.b	$a1, $fp, $a0
	b	.LBB3_365
.LBB3_360:                              # %if.else1667
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.d	$fp, $sp, 144                   # 8-byte Folded Reload
	beqz	$fp, .LBB3_364
# %bb.361:                              # %if.then.i2457
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $fp, 8196
	bne	$a0, $a5, .LBB3_363
# %bb.362:                              # %html_output_flush.exit.i2466
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $fp, 0
	addi.d	$a1, $fp, 4
	move	$a2, $a5
...
.LBB3_364:                              #   in Loop: Header=BB3_47 Depth=2
	st.d	$zero, $sp, 144                 # 8-byte Folded Spill
.LBB3_365:                              # %while.cond114.backedge
                                        #   in Loop: Header=BB3_47 Depth=2
	move	$s6, $s7
	ori	$s7, $zero, 20
	b	.LBB3_46
.LBB3_366:                              # %if.then1373
                                        #   in Loop: Header=BB3_47 Depth=2
	ori	$s7, $zero, 13
	ori	$s6, $zero, 1
	beqz	$a4, .LBB3_558
# %bb.367:                              # %if.then.i1966
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a2, $a4, 8196
	lu12i.w	$a0, 1
	ori	$a0, $a0, 4086
	blt	$a2, $a0, .LBB3_570
# %bb.368:                              # %if.end.thread.i1978
                                        #   in Loop: Header=BB3_47 Depth=2
	ori	$a0, $zero, 12
	st.d	$a0, $sp, 168                   # 8-byte Folded Spill
	ld.w	$a0, $a4, 0
...
# %bb.371:                              # %if.end.thread.i2302
	...
	stptr.w	$zero, $fp, 8196
	beqz	$a0, .LBB3_373
# %bb.372:                              # %html_output_flush.exit18.i2297
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $fp, 0
	addi.d	$a1, $sp, 1528
	move	$a2, $s6
...
.LBB3_373:                              # %if.else.i2289
	...
	add.w	$a0, $a0, $s6
	stptr.w	$a0, $fp, 8196
.LBB3_374:                              # %if.then.i2308
                                        #   in Loop: Header=BB3_47 Depth=2
	bne	$a0, $a1, .LBB3_376
# %bb.375:                              # %html_output_flush.exit.i2317
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $fp, 0
	move	$a1, $s4
	lu12i.w	$a2, 2
	...
	jirl	$ra, $ra, 0
	move	$a0, $zero
.LBB3_376:                              # %html_output_c.exit2320
                                        #   in Loop: Header=BB3_47 Depth=2
	addi.d	$a1, $a0, 1
	stptr.w	$a1, $fp, 8196
	stx.b	$s0, $s4, $a0
	...
	ldptr.w	$a2, $fp, 8196
	beqz	$a0, .LBB3_404
# %bb.377:                              # %if.then.i2322
                                        #   in Loop: Header=BB3_47 Depth=2
	lu12i.w	$a0, 1
	ori	$a0, $a0, 4062
	blt	$a2, $a0, .LBB3_379
# %bb.378:                              # %if.end.thread.i2334
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $fp, 0
	move	$a1, $s4
	pcaddu18i	$ra, %call36(cli_writen)
	...
	move	$a2, $zero
	stptr.w	$zero, $fp, 8196
.LBB3_379:                              # %html_output_str.exit2337
                                        #   in Loop: Header=BB3_47 Depth=2
	lu12i.w	$a5, 2
	...
	stptr.w	$a2, $fp, 8196
	bne	$a2, $a5, .LBB3_381
.LBB3_380:                              # %html_output_flush.exit.i2348
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $fp, 0
	move	$a1, $s4
	move	$a2, $a5
	...
	lu12i.w	$a5, 2
	move	$a2, $zero
.LBB3_381:                              # %html_output_c.exit2351
                                        #   in Loop: Header=BB3_47 Depth=2
	addi.d	$a0, $a2, 1
	stptr.w	$a0, $fp, 8196
	stx.b	$s0, $s4, $a2
...
# %bb.389:                              # %if.then.i954
	...
	ldptr.w	$a0, $s4, 8196
	bne	$a0, $a5, .LBB3_391
# %bb.390:                              # %html_output_flush.exit.i975
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s4, 0
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	move	$a2, $a5
	...
	lu12i.w	$a5, 2
	move	$a0, $zero
.LBB3_391:                              # %if.end.i957
                                        #   in Loop: Header=BB3_47 Depth=2
	addi.d	$a1, $a0, 1
	stptr.w	$a1, $s4, 8196
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	stx.b	$s0, $a1, $a0
.LBB3_392:                              # %if.end3.i962
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.d	$a4, $sp, 272                   # 8-byte Folded Reload
	beqz	$s6, .LBB3_396
# %bb.393:                              # %if.then5.i964
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s6, 8196
	bne	$a0, $a5, .LBB3_395
# %bb.394:                              # %html_output_flush.exit15.i972
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s6, 0
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	move	$a2, $a5
	...
	ld.d	$a4, $sp, 272                   # 8-byte Folded Reload
	move	$a0, $zero
.LBB3_395:                              # %if.end9.i967
                                        #   in Loop: Header=BB3_47 Depth=2
	addi.d	$a1, $a0, 1
	stptr.w	$a1, $s6, 8196
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	stx.b	$s0, $a1, $a0
.LBB3_396:                              # %html_output_c.exit978
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.d	$a0, $sp, 120                   # 8-byte Folded Reload
	beqz	$a0, .LBB3_401
# %bb.397:                              # %if.then265
...
# %bb.398:                              # %if.then.i980
	...
	ldx.w	$s0, $a1, $a2
	bne	$a0, $a5, .LBB3_400
# %bb.399:                              # %html_output_flush.exit.i989
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $a4, 0
	ld.d	$a1, $sp, 248                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_404:                              #   in Loop: Header=BB3_47 Depth=2
	...
	beq	$a2, $a5, .LBB3_380
	b	.LBB3_381
.LBB3_405:                              # %if.else1398
                                        #   in Loop: Header=BB3_47 Depth=2
	st.d	$a1, $sp, 160                   # 8-byte Folded Spill
	ld.d	$fp, $sp, 256                   # 8-byte Folded Reload
	ld.d	$s4, $sp, 168                   # 8-byte Folded Reload
	beqz	$fp, .LBB3_409
# %bb.406:                              # %if.then.i2183
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $fp, 8196
	bne	$a0, $a5, .LBB3_408
# %bb.407:                              # %html_output_flush.exit.i2204
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $fp, 0
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_408:                              # %if.end.i2186
	...
	stx.b	$a2, $a1, $a0
.LBB3_409:                              # %if.end3.i2191
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.d	$fp, $sp, 160                   # 8-byte Folded Reload
	beqz	$s6, .LBB3_413
# %bb.410:                              # %if.then5.i2193
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s6, 8196
	bne	$a0, $a5, .LBB3_412
# %bb.411:                              # %html_output_flush.exit15.i2201
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s6, 0
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	move	$a2, $a5
	...
	ld.d	$a4, $sp, 272                   # 8-byte Folded Reload
	move	$a0, $zero
.LBB3_412:                              # %if.end9.i2196
                                        #   in Loop: Header=BB3_47 Depth=2
	addi.d	$a1, $a0, 1
	stptr.w	$a1, $s6, 8196
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	stx.b	$fp, $a1, $a0
.LBB3_413:                              # %if.else1415
                                        #   in Loop: Header=BB3_47 Depth=2
	addi.w	$a0, $fp, 128
	ori	$a1, $zero, 383
	bltu	$a1, $a0, .LBB3_415
# %bb.414:                              # %if.end1417.sink.split
                                        #   in Loop: Header=BB3_47 Depth=2
	pcaddu18i	$ra, %call36(__ctype_tolower_loc)
	jirl	$ra, $ra, 0
	lu12i.w	$a5, 2
...
.LBB3_415:                              # %if.end1417
                                        #   in Loop: Header=BB3_47 Depth=2
	beqz	$a4, .LBB3_419
# %bb.416:                              # %if.then.i2216
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $a4, 8196
	bne	$a0, $a5, .LBB3_418
# %bb.417:                              # %html_output_flush.exit.i2225
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $a4, 0
	ld.d	$a1, $sp, 248                   # 8-byte Folded Reload
	move	$a2, $a5
...
# %bb.423:                              # %if.else1600
	...
	ld.d	$s4, $sp, 144                   # 8-byte Folded Reload
	beqz	$s4, .LBB3_428
# %bb.424:                              # %if.then.i2353
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s4, 8196
	bne	$a0, $a5, .LBB3_426
# %bb.425:                              # %html_output_flush.exit.i2362
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s4, 0
	addi.d	$a1, $s4, 4
	move	$a2, $a5
...
# %bb.431:                              # %if.else1637
	...
	beqz	$s6, .LBB3_595
# %bb.432:                              # %if.then.i2395
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s6, 8196
	bne	$a0, $a5, .LBB3_434
# %bb.433:                              # %html_output_flush.exit.i2404
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s6, 0
	addi.d	$a1, $s6, 4
	move	$a2, $a5
...
.LBB3_437:                              # %for.body.i
	...
	beqz	$a0, .LBB3_678
# %bb.438:                              # %for.cond.i
                                        #   in Loop: Header=BB3_437 Depth=3
	addi.d	$fp, $fp, 8
	bne	$s0, $fp, .LBB3_437
	b	.LBB3_684
.LBB3_439:                              # %if.else1034
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.d	$s4, $sp, 256                   # 8-byte Folded Reload
	lu12i.w	$a5, 2
	ld.d	$s1, $sp, 232                   # 8-byte Folded Reload
	beqz	$s4, .LBB3_443
# %bb.440:                              # %if.then.i1668
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s4, 8196
	bne	$a0, $a5, .LBB3_442
# %bb.441:                              # %html_output_flush.exit.i1689
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s4, 0
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_442:                              # %if.end.i1671
	...
	ori	$a2, $zero, 38
	stx.b	$a2, $a1, $a0
.LBB3_443:                              # %if.end3.i1676
                                        #   in Loop: Header=BB3_47 Depth=2
	beqz	$s6, .LBB3_447
# %bb.444:                              # %if.then5.i1678
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s6, 8196
	bne	$a0, $a5, .LBB3_446
# %bb.445:                              # %html_output_flush.exit15.i1686
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s6, 0
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_446:                              # %if.end9.i1681
	...
	ori	$a2, $zero, 38
	stx.b	$a2, $a1, $a0
.LBB3_447:                              # %html_output_c.exit1692
                                        #   in Loop: Header=BB3_47 Depth=2
	ori	$a0, $zero, 9
	bne	$s7, $a0, .LBB3_450
# %bb.448:                              # %html_output_c.exit1692
                                        #   in Loop: Header=BB3_47 Depth=2
	ori	$a0, $zero, 1023
	blt	$a0, $s1, .LBB3_450
# %bb.449:                              # %if.then1040
...
.LBB3_453:                              # %for.body1048
	...
	ldx.w	$s0, $a1, $a0
	beqz	$s4, .LBB3_457
# %bb.454:                              # %if.then.i1694
                                        #   in Loop: Header=BB3_453 Depth=3
	ldptr.w	$a0, $s4, 8196
	bne	$a0, $a5, .LBB3_456
# %bb.455:                              # %html_output_flush.exit.i1715
                                        #   in Loop: Header=BB3_453 Depth=3
	ld.w	$a0, $s4, 0
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	move	$a2, $a5
	...
	ld.d	$a4, $sp, 272                   # 8-byte Folded Reload
	move	$a0, $zero
.LBB3_456:                              # %if.end.i1697
                                        #   in Loop: Header=BB3_453 Depth=3
	addi.d	$a1, $a0, 1
	stptr.w	$a1, $s4, 8196
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	stx.b	$s0, $a1, $a0
.LBB3_457:                              # %if.end3.i1702
                                        #   in Loop: Header=BB3_453 Depth=3
	beqz	$s6, .LBB3_461
# %bb.458:                              # %if.then5.i1704
                                        #   in Loop: Header=BB3_453 Depth=3
	ldptr.w	$a0, $s6, 8196
	bne	$a0, $a5, .LBB3_460
# %bb.459:                              # %html_output_flush.exit15.i1712
                                        #   in Loop: Header=BB3_453 Depth=3
	ld.w	$a0, $s6, 0
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	move	$a2, $a5
	...
	ld.d	$a4, $sp, 272                   # 8-byte Folded Reload
	move	$a0, $zero
.LBB3_460:                              # %if.end9.i1707
                                        #   in Loop: Header=BB3_453 Depth=3
	addi.d	$a1, $a0, 1
	stptr.w	$a1, $s6, 8196
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	stx.b	$s0, $a1, $a0
.LBB3_461:                              # %html_output_c.exit1718
                                        #   in Loop: Header=BB3_453 Depth=3
	ori	$a0, $zero, 9
	bne	$s7, $a0, .LBB3_452
# %bb.462:                              # %html_output_c.exit1718
                                        #   in Loop: Header=BB3_453 Depth=3
	ori	$a0, $zero, 1023
	blt	$a0, $s1, .LBB3_452
# %bb.463:                              # %if.then1063
...
# %bb.466:                              # %if.then461
	...
	addi.d	$s4, $sp, 1528
	beqz	$fp, .LBB3_470
# %bb.467:                              # %if.then.i1202
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $fp, 8196
	bne	$a0, $a5, .LBB3_469
# %bb.468:                              # %html_output_flush.exit.i1223
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $fp, 0
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_469:                              # %if.end.i1205
	...
	ori	$a2, $zero, 34
	stx.b	$a2, $a1, $a0
.LBB3_470:                              # %if.end3.i1210
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.d	$fp, $sp, 232                   # 8-byte Folded Reload
	beqz	$s6, .LBB3_474
# %bb.471:                              # %if.then5.i1212
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s6, 8196
	bne	$a0, $a5, .LBB3_473
# %bb.472:                              # %html_output_flush.exit15.i1220
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s6, 0
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_473:                              # %if.end9.i1215
	...
	ori	$a2, $zero, 34
	stx.b	$a2, $a1, $a0
.LBB3_474:                              # %html_output_c.exit1226
                                        #   in Loop: Header=BB3_47 Depth=2
	ori	$a0, $zero, 1023
	blt	$a0, $fp, .LBB3_476
# %bb.475:                              # %if.then464
...
# %bb.480:                              # %if.then506
	...
	addi.d	$s4, $sp, 1528
	beqz	$fp, .LBB3_484
# %bb.481:                              # %if.then.i1280
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $fp, 8196
	bne	$a0, $a5, .LBB3_483
# %bb.482:                              # %html_output_flush.exit.i1301
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $fp, 0
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_483:                              # %if.end.i1283
	...
	ori	$a2, $zero, 34
	stx.b	$a2, $a1, $a0
.LBB3_484:                              # %if.end3.i1288
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.d	$fp, $sp, 232                   # 8-byte Folded Reload
	beqz	$s6, .LBB3_488
# %bb.485:                              # %if.then5.i1290
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s6, 8196
	bne	$a0, $a5, .LBB3_487
# %bb.486:                              # %html_output_flush.exit15.i1298
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s6, 0
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_487:                              # %if.end9.i1293
	...
	ori	$a2, $zero, 34
	stx.b	$a2, $a1, $a0
.LBB3_488:                              # %html_output_c.exit1304
                                        #   in Loop: Header=BB3_47 Depth=2
	ori	$a0, $zero, 1023
	blt	$a0, $fp, .LBB3_490
# %bb.489:                              # %if.then509
...
# %bb.494:                              # %if.else572
	...
	ld.d	$s0, $sp, 256                   # 8-byte Folded Reload
	beqz	$s0, .LBB3_498
# %bb.495:                              # %if.then.i1358
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s0, 8196
	bne	$a0, $a5, .LBB3_497
# %bb.496:                              # %html_output_flush.exit.i1379
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s0, 0
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	move	$a2, $a5
	...
	ld.d	$a4, $sp, 272                   # 8-byte Folded Reload
	move	$a0, $zero
.LBB3_497:                              # %if.end.i1361
                                        #   in Loop: Header=BB3_47 Depth=2
	addi.d	$a1, $a0, 1
	stptr.w	$a1, $s0, 8196
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	stx.b	$fp, $a1, $a0
.LBB3_498:                              # %if.end3.i1366
                                        #   in Loop: Header=BB3_47 Depth=2
	ori	$s0, $zero, 10
	beqz	$s6, .LBB3_502
# %bb.499:                              # %if.then5.i1368
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s6, 8196
	bne	$a0, $a5, .LBB3_501
# %bb.500:                              # %html_output_flush.exit15.i1376
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s6, 0
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	move	$a2, $a5
	...
	ld.d	$a4, $sp, 272                   # 8-byte Folded Reload
	move	$a0, $zero
.LBB3_501:                              # %if.end9.i1371
                                        #   in Loop: Header=BB3_47 Depth=2
	addi.d	$a1, $a0, 1
	stptr.w	$a1, $s6, 8196
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	stx.b	$fp, $a1, $a0
.LBB3_502:                              # %html_output_c.exit1382
                                        #   in Loop: Header=BB3_47 Depth=2
	ori	$a0, $zero, 1023
	ld.d	$a3, $sp, 232                   # 8-byte Folded Reload
	blt	$a0, $a3, .LBB3_569
...
.LBB3_512:                              # %if.end1283
	...
	add.w	$a0, $a0, $a1
	st.d	$a0, $sp, 160                   # 8-byte Folded Spill
.LBB3_513:                              # %while.cond114.backedge
                                        #   in Loop: Header=BB3_47 Depth=2
	addi.d	$s8, $s8, 1
.LBB3_514:                              # %while.cond114.backedge
                                        #   in Loop: Header=BB3_47 Depth=2
	move	$s6, $s7
	ori	$s7, $zero, 12
	b	.LBB3_46
...
# %bb.516:                              # %if.then330
                                        #   in Loop: Header=BB3_47 Depth=2
	beqz	$s4, .LBB3_520
# %bb.517:                              # %if.then.i1046
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s4, 8196
	bne	$a0, $a5, .LBB3_519
# %bb.518:                              # %html_output_flush.exit.i1067
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s4, 0
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_519:                              # %if.end.i1049
	...
	ori	$a2, $zero, 32
	stx.b	$a2, $a1, $a0
.LBB3_520:                              # %if.end3.i1054
                                        #   in Loop: Header=BB3_47 Depth=2
	beqz	$s6, .LBB3_524
# %bb.521:                              # %if.then5.i1056
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s6, 8196
	bne	$a0, $a5, .LBB3_523
# %bb.522:                              # %html_output_flush.exit15.i1064
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s6, 0
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_524:                              # %if.end331
	...
	ld.d	$a4, $sp, 272                   # 8-byte Folded Reload
	beqz	$s4, .LBB3_528
# %bb.525:                              # %if.then.i1072
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s4, 8196
	bne	$a0, $a5, .LBB3_527
# %bb.526:                              # %html_output_flush.exit.i1093
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s4, 0
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	move	$a2, $a5
	...
	ld.d	$a4, $sp, 272                   # 8-byte Folded Reload
	move	$a0, $zero
.LBB3_527:                              # %if.end.i1075
                                        #   in Loop: Header=BB3_47 Depth=2
	addi.d	$a1, $a0, 1
	stptr.w	$a1, $s4, 8196
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	stx.b	$s0, $a1, $a0
.LBB3_528:                              # %if.end3.i1080
                                        #   in Loop: Header=BB3_47 Depth=2
	beqz	$s6, .LBB3_532
# %bb.529:                              # %if.then5.i1082
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s6, 8196
	bne	$a0, $a5, .LBB3_531
# %bb.530:                              # %html_output_flush.exit15.i1090
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s6, 0
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	move	$a2, $a5
	...
	ld.d	$a4, $sp, 272                   # 8-byte Folded Reload
	move	$a0, $zero
.LBB3_531:                              # %if.end9.i1085
                                        #   in Loop: Header=BB3_47 Depth=2
	addi.d	$a1, $a0, 1
	stptr.w	$a1, $s6, 8196
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	stx.b	$s0, $a1, $a0
.LBB3_532:                              # %html_output_c.exit1096
                                        #   in Loop: Header=BB3_47 Depth=2
	ori	$a0, $zero, 1023
	blt	$a0, $s2, .LBB3_534
# %bb.533:                              # %if.then341
...
# %bb.536:                              # %if.then.i846
	...
	ldptr.w	$a0, $s3, 8196
	bne	$a0, $a5, .LBB3_538
# %bb.537:                              # %html_output_flush.exit.i867
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s3, 0
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	move	$a2, $a5
	...
	lu12i.w	$a5, 2
	move	$a0, $zero
.LBB3_538:                              # %if.end.i849
                                        #   in Loop: Header=BB3_47 Depth=2
	addi.d	$a1, $a0, 1
	stptr.w	$a1, $s3, 8196
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	stx.b	$s0, $a1, $a0
.LBB3_539:                              # %if.end3.i854
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.d	$a4, $sp, 272                   # 8-byte Folded Reload
	ld.d	$s3, $sp, 176                   # 8-byte Folded Reload
	beqz	$s4, .LBB3_543
# %bb.540:                              # %if.then5.i856
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s4, 8196
	bne	$a0, $a5, .LBB3_542
# %bb.541:                              # %html_output_flush.exit15.i864
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s4, 0
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	move	$a2, $a5
	...
	ld.d	$a4, $sp, 272                   # 8-byte Folded Reload
	move	$a0, $zero
.LBB3_542:                              # %if.end9.i859
                                        #   in Loop: Header=BB3_47 Depth=2
	addi.d	$a1, $a0, 1
	stptr.w	$a1, $s4, 8196
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	stx.b	$s0, $a1, $a0
.LBB3_543:                              # %html_output_c.exit870
                                        #   in Loop: Header=BB3_47 Depth=2
	ori	$s0, $zero, 10
	ld.d	$a0, $sp, 120                   # 8-byte Folded Reload
	beqz	$a0, .LBB3_548
...
# %bb.545:                              # %if.then.i872
	...
	ldx.w	$fp, $a1, $a2
	bne	$a0, $a5, .LBB3_547
# %bb.546:                              # %html_output_flush.exit.i881
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $a4, 0
	ld.d	$a1, $sp, 248                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_559:                              # %if.else519
                                        #   in Loop: Header=BB3_47 Depth=2
	beqz	$fp, .LBB3_563
# %bb.560:                              # %if.then.i1228
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $fp, 8196
	bne	$a0, $a5, .LBB3_562
# %bb.561:                              # %html_output_flush.exit.i1249
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $fp, 0
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_562:                              # %if.end.i1231
	...
	ori	$a2, $zero, 34
	stx.b	$a2, $a1, $a0
.LBB3_563:                              # %if.end3.i1236
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.d	$fp, $sp, 232                   # 8-byte Folded Reload
	beqz	$s6, .LBB3_567
# %bb.564:                              # %if.then5.i1238
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s6, 8196
	bne	$a0, $a5, .LBB3_566
# %bb.565:                              # %html_output_flush.exit15.i1246
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s6, 0
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_566:                              # %if.end9.i1241
	...
	ori	$a2, $zero, 34
	stx.b	$a2, $a1, $a0
.LBB3_567:                              # %html_output_c.exit1252
                                        #   in Loop: Header=BB3_47 Depth=2
	ori	$a0, $zero, 1023
	blt	$a0, $fp, .LBB3_569
# %bb.568:                              # %if.then477
...
.LBB3_571:                              # %if.else.i1973
	...
	stptr.w	$a0, $a4, 8196
	b	.LBB3_46
.LBB3_572:                              # %if.else1285
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.d	$a4, $sp, 272                   # 8-byte Folded Reload
	ld.d	$fp, $sp, 256                   # 8-byte Folded Reload
	lu12i.w	$a5, 2
	beqz	$fp, .LBB3_576
# %bb.573:                              # %if.then.i1900
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $fp, 8196
	bne	$a0, $a5, .LBB3_575
# %bb.574:                              # %html_output_flush.exit.i1921
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $fp, 0
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_575:                              # %if.end.i1903
	...
	ld.d	$a2, $sp, 160                   # 8-byte Folded Reload
	stx.b	$a2, $a1, $a0
.LBB3_576:                              # %if.end3.i1908
                                        #   in Loop: Header=BB3_47 Depth=2
	beqz	$s6, .LBB3_580
# %bb.577:                              # %if.then5.i1910
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s6, 8196
	ld.d	$fp, $sp, 160                   # 8-byte Folded Reload
	bne	$a0, $a5, .LBB3_579
# %bb.578:                              # %html_output_flush.exit15.i1918
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s6, 0
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_582:                              # %if.else1212
	...
	ldx.w	$fp, $a0, $a1
	beqz	$s0, .LBB3_586
.LBB3_583:                              # %if.then.i1874
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s0, 8196
	bne	$a0, $a5, .LBB3_585
# %bb.584:                              # %html_output_flush.exit.i1895
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s0, 0
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	move	$a2, $a5
	...
	ld.d	$a4, $sp, 272                   # 8-byte Folded Reload
	move	$a0, $zero
.LBB3_585:                              # %if.end.i1877
                                        #   in Loop: Header=BB3_47 Depth=2
	addi.d	$a1, $a0, 1
	stptr.w	$a1, $s0, 8196
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	stx.b	$fp, $a1, $a0
.LBB3_586:                              # %if.end3.i1882
                                        #   in Loop: Header=BB3_47 Depth=2
	ori	$s0, $zero, 10
	beqz	$s6, .LBB3_817
# %bb.587:                              # %if.then5.i1884
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s6, 8196
	bne	$a0, $a5, .LBB3_589
# %bb.588:                              # %html_output_flush.exit15.i1892
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s6, 0
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	move	$a2, $a5
...
# %bb.591:                              # %if.then.i1827
	...
	blt	$a2, $a0, .LBB3_715
# %bb.592:                              # %if.then.i1827
                                        #   in Loop: Header=BB3_47 Depth=2
	add.w	$a0, $a2, $s4
	bge	$s2, $a0, .LBB3_715
# %bb.593:                              # %if.end.thread.i
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.d	$s0, $sp, 256                   # 8-byte Folded Reload
	ld.w	$a0, $s0, 0
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
...
.LBB3_602:                              # %lor.lhs.false1099
	...
	ld.d	$a1, $sp, 224                   # 8-byte Folded Reload
	bne	$s4, $a0, .LBB3_604
# %bb.603:                              # %lor.lhs.false1099
                                        #   in Loop: Header=BB3_47 Depth=2
	ori	$a0, $zero, 1024
	bltu	$a1, $a0, .LBB3_281
.LBB3_604:                              # %if.else1110
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.d	$s4, $sp, 256                   # 8-byte Folded Reload
	ori	$a0, $zero, 9
	ld.d	$fp, $sp, 232                   # 8-byte Folded Reload
...
.LBB3_607:                              # %if.end1121
                                        #   in Loop: Header=BB3_47 Depth=2
	beqz	$s4, .LBB3_611
# %bb.608:                              # %if.then.i1746
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s4, 8196
	bne	$a0, $a5, .LBB3_610
# %bb.609:                              # %html_output_flush.exit.i1767
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s4, 0
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_610:                              # %if.end.i1749
	...
	ori	$a2, $zero, 38
	stx.b	$a2, $a1, $a0
.LBB3_611:                              # %if.end3.i1754
                                        #   in Loop: Header=BB3_47 Depth=2
	st.d	$fp, $sp, 232                   # 8-byte Folded Spill
	st.d	$s2, $sp, 136                   # 8-byte Folded Spill
	beqz	$s6, .LBB3_615
# %bb.612:                              # %if.then5.i1756
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s6, 8196
	bne	$a0, $a5, .LBB3_614
# %bb.613:                              # %html_output_flush.exit15.i1764
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s6, 0
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_614:                              # %if.end9.i1759
	...
	ori	$a2, $zero, 38
	stx.b	$a2, $a1, $a0
.LBB3_615:                              # %html_output_c.exit1770
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.d	$a0, $sp, 224                   # 8-byte Folded Reload
	beqz	$a0, .LBB3_630
# %bb.616:                              # %for.body1125.lr.ph
                                        #   in Loop: Header=BB3_47 Depth=2
	addi.d	$s2, $sp, 295
	pcaddu18i	$ra, %call36(__ctype_tolower_loc)
	jirl	$ra, $ra, 0
...
.LBB3_618:                              # %for.body1125
	...
	ldx.w	$s0, $a1, $a0
	beqz	$s4, .LBB3_622
# %bb.619:                              # %if.then.i1772
                                        #   in Loop: Header=BB3_618 Depth=3
	ldptr.w	$a0, $s4, 8196
	bne	$a0, $a5, .LBB3_621
# %bb.620:                              # %html_output_flush.exit.i1793
                                        #   in Loop: Header=BB3_618 Depth=3
	ld.w	$a0, $s4, 0
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	move	$a2, $a5
	...
	ld.d	$a4, $sp, 272                   # 8-byte Folded Reload
	move	$a0, $zero
.LBB3_621:                              # %if.end.i1775
                                        #   in Loop: Header=BB3_618 Depth=3
	addi.d	$a1, $a0, 1
	stptr.w	$a1, $s4, 8196
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	stx.b	$s0, $a1, $a0
.LBB3_622:                              # %if.end3.i1780
                                        #   in Loop: Header=BB3_618 Depth=3
	beqz	$s6, .LBB3_626
# %bb.623:                              # %if.then5.i1782
                                        #   in Loop: Header=BB3_618 Depth=3
	ldptr.w	$a0, $s6, 8196
	bne	$a0, $a5, .LBB3_625
# %bb.624:                              # %html_output_flush.exit15.i1790
                                        #   in Loop: Header=BB3_618 Depth=3
	ld.w	$a0, $s6, 0
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	move	$a2, $a5
	...
	ld.d	$a4, $sp, 272                   # 8-byte Folded Reload
	move	$a0, $zero
.LBB3_625:                              # %if.end9.i1785
                                        #   in Loop: Header=BB3_618 Depth=3
	addi.d	$a1, $a0, 1
	stptr.w	$a1, $s6, 8196
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	stx.b	$s0, $a1, $a0
.LBB3_626:                              # %html_output_c.exit1796
                                        #   in Loop: Header=BB3_618 Depth=3
	ori	$a0, $zero, 9
	bne	$s7, $a0, .LBB3_617
# %bb.627:                              # %html_output_c.exit1796
                                        #   in Loop: Header=BB3_618 Depth=3
	ori	$a0, $zero, 1023
	ld.d	$a2, $sp, 232                   # 8-byte Folded Reload
	blt	$a0, $a2, .LBB3_617
...
.LBB3_642:                              # %if.end1080
	...
	beqz	$s4, .LBB3_646
.LBB3_643:                              # %if.then.i1720
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s4, 8196
	bne	$a0, $a5, .LBB3_645
# %bb.644:                              # %html_output_flush.exit.i1741
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s4, 0
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_645:                              # %if.end.i1723
	...
	ori	$a2, $zero, 59
	stx.b	$a2, $a1, $a0
.LBB3_646:                              # %if.end3.i1728
                                        #   in Loop: Header=BB3_47 Depth=2
	st.d	$s1, $sp, 232                   # 8-byte Folded Spill
	beqz	$s6, .LBB3_650
# %bb.647:                              # %if.then5.i1730
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s6, 8196
	bne	$a0, $a5, .LBB3_649
# %bb.648:                              # %html_output_flush.exit15.i1738
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s6, 0
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_699:                              # %if.else549
	...
	addi.d	$s7, $sp, 1528
	beqz	$s0, .LBB3_703
# %bb.700:                              # %if.then.i1332
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a1, $s0, 8196
	bne	$a1, $a5, .LBB3_702
# %bb.701:                              # %html_output_flush.exit.i1353
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a1, $s0, 0
	move	$fp, $a0
	move	$a0, $a1
	...
	ld.d	$fp, $sp, 232                   # 8-byte Folded Reload
	move	$a1, $zero
.LBB3_702:                              # %if.end.i1335
                                        #   in Loop: Header=BB3_47 Depth=2
	addi.d	$a2, $a1, 1
	stptr.w	$a2, $s0, 8196
	ld.d	$a2, $sp, 240                   # 8-byte Folded Reload
	stx.b	$s4, $a2, $a1
.LBB3_703:                              # %if.end3.i1340
                                        #   in Loop: Header=BB3_47 Depth=2
	ori	$s0, $zero, 10
	beqz	$s6, .LBB3_707
# %bb.704:                              # %if.then5.i1342
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a1, $s6, 8196
	bne	$a1, $a5, .LBB3_706
# %bb.705:                              # %html_output_flush.exit15.i1350
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a1, $s6, 0
	move	$fp, $a0
	move	$a0, $a1
	...
	ld.d	$fp, $sp, 232                   # 8-byte Folded Reload
	move	$a1, $zero
.LBB3_706:                              # %if.end9.i1345
                                        #   in Loop: Header=BB3_47 Depth=2
	addi.d	$a2, $a1, 1
	stptr.w	$a2, $s6, 8196
	ld.d	$a2, $sp, 216                   # 8-byte Folded Reload
	stx.b	$s4, $a2, $a1
.LBB3_707:                              # %html_output_c.exit1356
                                        #   in Loop: Header=BB3_47 Depth=2
	ori	$a1, $zero, 1023
	blt	$a1, $fp, .LBB3_709
# %bb.708:                              # %if.then552
...
# %bb.711:                              # %if.then827
	...
	ori	$s6, $zero, 1
	blt	$a0, $s6, .LBB3_917
# %bb.712:                              # %for.body.lr.ph.i1549
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.d	$fp, $sp, 1504
	move	$s0, $zero
	slli.d	$s1, $a0, 3
.LBB3_713:                              # %for.body.i1552
                                        #   Parent Loop BB3_28 Depth=1
                                        #     Parent Loop BB3_47 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ldx.d	$a0, $fp, $s0
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB3_834
# %bb.714:                              # %for.cond.i1557
                                        #   in Loop: Header=BB3_713 Depth=3
	addi.d	$s0, $s0, 8
	bne	$s1, $s0, .LBB3_713
	b	.LBB3_802
.LBB3_715:                              # %if.end.i1832
                                        #   in Loop: Header=BB3_47 Depth=2
	bge	$s2, $fp, .LBB3_803
# %bb.716:                              # %if.then3.i
                                        #   in Loop: Header=BB3_47 Depth=2
...
# %bb.717:                              # %if.then.i15.i
	...
	jirl	$ra, $ra, 0
	stptr.w	$zero, $s0, 8196
.LBB3_718:                              # %html_output_flush.exit18.i
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s0, 0
	addi.d	$a1, $sp, 280
	move	$a2, $fp
...
.LBB3_719:                              # %sw.bb1394
	...
	ld.d	$s3, $sp, 256                   # 8-byte Folded Reload
	beqz	$s3, .LBB3_723
# %bb.720:                              # %if.then.i2023
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s3, 8196
	bne	$a0, $a5, .LBB3_722
# %bb.721:                              # %html_output_flush.exit.i2044
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s3, 0
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_722:                              # %if.end.i2026
	...
	ori	$a2, $zero, 13
	stx.b	$a2, $a1, $a0
.LBB3_723:                              # %if.end3.i2031
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.d	$s3, $sp, 176                   # 8-byte Folded Reload
	beqz	$s0, .LBB3_727
# %bb.724:                              # %if.then5.i2033
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s0, 8196
	bne	$a0, $a5, .LBB3_726
# %bb.725:                              # %html_output_flush.exit15.i2041
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s0, 0
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_726:                              # %if.end9.i2036
	...
	ori	$a2, $zero, 13
	stx.b	$a2, $a1, $a0
.LBB3_727:                              # %html_output_c.exit2047
                                        #   in Loop: Header=BB3_47 Depth=2
	beqz	$a4, .LBB3_755
# %bb.728:                              # %if.then.i2049
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $a4, 8196
	ori	$s0, $zero, 10
	bne	$a0, $a5, .LBB3_730
# %bb.729:                              # %html_output_flush.exit.i2058
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $a4, 0
	ld.d	$a1, $sp, 248                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_731:                              # %sw.bb1397
	...
	ld.d	$s3, $sp, 256                   # 8-byte Folded Reload
	beqz	$s3, .LBB3_735
# %bb.732:                              # %if.then.i2143
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s3, 8196
	bne	$a0, $a5, .LBB3_734
# %bb.733:                              # %html_output_flush.exit.i2164
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s3, 0
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_734:                              # %if.end.i2146
	...
	ori	$a2, $zero, 62
	stx.b	$a2, $a1, $a0
.LBB3_735:                              # %if.end3.i2151
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.d	$s3, $sp, 176                   # 8-byte Folded Reload
	beqz	$s0, .LBB3_739
# %bb.736:                              # %if.then5.i2153
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s0, 8196
	bne	$a0, $a5, .LBB3_738
# %bb.737:                              # %html_output_flush.exit15.i2161
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s0, 0
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_738:                              # %if.end9.i2156
	...
	ori	$a2, $zero, 62
	stx.b	$a2, $a1, $a0
.LBB3_739:                              # %html_output_c.exit2167
                                        #   in Loop: Header=BB3_47 Depth=2
	beqz	$a4, .LBB3_755
# %bb.740:                              # %if.then.i2169
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $a4, 8196
	ori	$s0, $zero, 10
	bne	$a0, $a5, .LBB3_742
# %bb.741:                              # %html_output_flush.exit.i2178
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $a4, 0
	ld.d	$a1, $sp, 248                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_743:                              # %sw.bb1395
	...
	ld.d	$s3, $sp, 256                   # 8-byte Folded Reload
	beqz	$s3, .LBB3_747
# %bb.744:                              # %if.then.i2063
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s3, 8196
	bne	$a0, $a5, .LBB3_746
# %bb.745:                              # %html_output_flush.exit.i2084
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s3, 0
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_746:                              # %if.end.i2066
	...
	ori	$a2, $zero, 64
	stx.b	$a2, $a1, $a0
.LBB3_747:                              # %if.end3.i2071
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.d	$s3, $sp, 176                   # 8-byte Folded Reload
	beqz	$s0, .LBB3_751
# %bb.748:                              # %if.then5.i2073
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s0, 8196
	bne	$a0, $a5, .LBB3_750
# %bb.749:                              # %html_output_flush.exit15.i2081
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s0, 0
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_750:                              # %if.end9.i2076
	...
	ori	$a2, $zero, 64
	stx.b	$a2, $a1, $a0
.LBB3_751:                              # %html_output_c.exit2087
                                        #   in Loop: Header=BB3_47 Depth=2
	beqz	$a4, .LBB3_755
# %bb.752:                              # %if.then.i2089
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $a4, 8196
	ori	$s0, $zero, 10
	bne	$a0, $a5, .LBB3_754
# %bb.753:                              # %html_output_flush.exit.i2098
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $a4, 0
	ld.d	$a1, $sp, 248                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_756:                              # %sw.bb1396
	...
	ld.d	$s3, $sp, 256                   # 8-byte Folded Reload
	beqz	$s3, .LBB3_760
# %bb.757:                              # %if.then.i2103
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s3, 8196
	bne	$a0, $a5, .LBB3_759
# %bb.758:                              # %html_output_flush.exit.i2124
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s3, 0
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	move	$a2, $a5
	...
	ld.d	$a4, $sp, 272                   # 8-byte Folded Reload
	move	$a0, $zero
.LBB3_759:                              # %if.end.i2106
                                        #   in Loop: Header=BB3_47 Depth=2
	addi.d	$a1, $a0, 1
	stptr.w	$a1, $s3, 8196
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	stx.b	$s4, $a1, $a0
.LBB3_760:                              # %if.end3.i2111
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.d	$s3, $sp, 176                   # 8-byte Folded Reload
	beqz	$s0, .LBB3_764
# %bb.761:                              # %if.then5.i2113
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $s0, 8196
	bne	$a0, $a5, .LBB3_763
# %bb.762:                              # %html_output_flush.exit15.i2121
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s0, 0
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	move	$a2, $a5
	...
	ld.d	$a4, $sp, 272                   # 8-byte Folded Reload
	move	$a0, $zero
.LBB3_763:                              # %if.end9.i2116
                                        #   in Loop: Header=BB3_47 Depth=2
	addi.d	$a1, $a0, 1
	stptr.w	$a1, $s0, 8196
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	stx.b	$s4, $a1, $a0
.LBB3_764:                              # %html_output_c.exit2127
                                        #   in Loop: Header=BB3_47 Depth=2
	beqz	$a4, .LBB3_821
# %bb.765:                              # %if.then.i2129
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $a4, 8196
	ori	$s0, $zero, 10
	move	$s4, $s6
	bne	$a0, $a5, .LBB3_767
# %bb.766:                              # %html_output_flush.exit.i2138
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $a4, 0
	ld.d	$a1, $sp, 248                   # 8-byte Folded Reload
	move	$a2, $a5
...
.LBB3_770:                              # %for.body.i1569
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB3_822
# %bb.771:                              # %for.cond.i1574
                                        #   in Loop: Header=BB3_770 Depth=3
	addi.d	$s0, $s0, 8
	bne	$s1, $s0, .LBB3_770
	b	.LBB3_829
.LBB3_772:                              # %html_tag_arg_value.exit1529
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.d	$s2, $sp, 1512
	ldx.d	$s4, $s2, $s1
	beqz	$s4, .LBB3_778
# %bb.773:                              # %land.lhs.true767
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.bu	$a0, $s4, 0
	ld.d	$s1, $sp, 112                   # 8-byte Folded Reload
	beqz	$a0, .LBB3_900
...
.LBB3_775:                              # %for.body.i1535
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB3_905
# %bb.776:                              # %for.cond.i1540
                                        #   in Loop: Header=BB3_775 Depth=3
	addi.d	$s2, $s2, 8
	addi.d	$fp, $fp, -1
	addi.d	$s0, $s0, 8
	bnez	$fp, .LBB3_775
...
.LBB3_779:                              # %if.end974
	...
	move	$s2, $s7
	b	.LBB3_918
.LBB3_780:                              # %if.then.i1492
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.d	$a0, $sp, 1512
	ldx.d	$s4, $a0, $s1
.LBB3_781:                              # %for.body.lr.ph.i1498
                                        #   in Loop: Header=BB3_47 Depth=2
	move	$s1, $zero
	move	$s2, $s7
.LBB3_782:                              # %for.body.i1501
                                        #   Parent Loop BB3_28 Depth=1
                                        #     Parent Loop BB3_47 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ldx.d	$a0, $s0, $s1
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB3_784
# %bb.783:                              # %for.cond.i1506
                                        #   in Loop: Header=BB3_782 Depth=3
	addi.d	$fp, $fp, -1
	addi.d	$s1, $s1, 8
	bnez	$fp, .LBB3_782
	b	.LBB3_802
.LBB3_784:                              # %html_tag_arg_value.exit1512
                                        #   in Loop: Header=BB3_47 Depth=2
	beqz	$s4, .LBB3_802
# %bb.785:                              # %html_tag_arg_value.exit1512
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.d	$a0, $sp, 1512
	ldx.d	$fp, $a0, $s1
	ori	$s0, $zero, 10
	beqz	$fp, .LBB3_852
# %bb.786:                              # %land.lhs.true696
                                        #   in Loop: Header=BB3_47 Depth=2
...
# %bb.787:                              # %if.then700
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB3_990
# %bb.788:                              # %for.cond.preheader
                                        #   in Loop: Header=BB3_47 Depth=2
	move	$s7, $a0
	beqz	$s4, .LBB3_791
# %bb.789:                              # %for.body.lr.ph
                                        #   in Loop: Header=BB3_47 Depth=2
	pcaddu18i	$ra, %call36(__ctype_tolower_loc)
	jirl	$ra, $ra, 0
	move	$a1, $s7
...
.LBB3_791:                              # %for.end
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB3_916
# %bb.792:                              # %while.cond722
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.bu	$a1, $a0, 0
	beqz	$a1, .LBB3_795
.LBB3_793:                              # %while.cond722
                                        #   Parent Loop BB3_28 Depth=1
                                        #     Parent Loop BB3_47 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ori	$a2, $zero, 61
	beq	$a1, $a2, .LBB3_795
# %bb.794:                              # %while.body731
                                        #   in Loop: Header=BB3_793 Depth=3
	addi.d	$a0, $a0, 1
	ld.bu	$a1, $a0, 0
	bnez	$a1, .LBB3_793
.LBB3_795:                              # %while.end733
                                        #   in Loop: Header=BB3_47 Depth=2
	sltu	$s0, $zero, $a1
	add.d	$fp, $a0, $s0
...
.LBB3_798:                              # %if.then903
	...
	ori	$s6, $zero, 1
	blt	$a0, $s6, .LBB3_902
# %bb.799:                              # %for.body.lr.ph.i1600
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.d	$fp, $sp, 1504
	move	$s0, $zero
	slli.d	$s1, $a0, 3
.LBB3_800:                              # %for.body.i1603
                                        #   Parent Loop BB3_28 Depth=1
                                        #     Parent Loop BB3_47 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ldx.d	$a0, $fp, $s0
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB3_840
# %bb.801:                              # %for.cond.i1608
                                        #   in Loop: Header=BB3_800 Depth=3
	addi.d	$s0, $s0, 8
	bne	$s1, $s0, .LBB3_800
...
# %bb.807:                              # %if.then.i1840
	...
	ld.d	$s2, $sp, 96                    # 8-byte Folded Reload
	blt	$a2, $a0, .LBB3_810
# %bb.808:                              # %if.then.i1840
                                        #   in Loop: Header=BB3_47 Depth=2
	add.w	$a0, $a2, $s4
	bge	$s2, $a0, .LBB3_810
# %bb.809:                              # %if.end.thread.i1861
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s6, 0
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(cli_writen)
	...
	blt	$s2, $fp, .LBB3_813
	b	.LBB3_814
.LBB3_810:                              # %if.end.i1846
                                        #   in Loop: Header=BB3_47 Depth=2
	bge	$s2, $fp, .LBB3_814
# %bb.811:                              # %if.then3.i1854
                                        #   in Loop: Header=BB3_47 Depth=2
	ori	$a0, $zero, 1
	blt	$a2, $a0, .LBB3_813
# %bb.812:                              # %if.then.i15.i1858
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s6, 0
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(cli_writen)
	jirl	$ra, $ra, 0
	stptr.w	$zero, $s6, 8196
.LBB3_813:                              # %html_output_flush.exit18.i1856
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $s6, 0
	addi.d	$a1, $sp, 280
	move	$a2, $fp
...
.LBB3_816:                              # %html_output_str.exit1865
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.d	$a4, $sp, 272                   # 8-byte Folded Reload
.LBB3_817:                              # %while.cond114.backedge
                                        #   in Loop: Header=BB3_47 Depth=2
	move	$s6, $zero
	b	.LBB3_45
...
# %bb.833:                              # %for.cond.i1591
	...
	bne	$s1, $s0, .LBB3_832
	b	.LBB3_851
.LBB3_834:                              # %html_tag_arg_value.exit1563
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.d	$a0, $sp, 1512
	ldx.d	$fp, $a0, $s0
	ld.d	$s1, $sp, 112                   # 8-byte Folded Reload
...
.LBB3_839:                              #   in Loop: Header=BB3_47 Depth=2
	...
	move	$s2, $s4
	b	.LBB3_918
.LBB3_840:                              # %html_tag_arg_value.exit1614
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.d	$a0, $sp, 1512
	ldx.d	$fp, $a0, $s0
	ld.d	$s1, $sp, 112                   # 8-byte Folded Reload
	beqz	$fp, .LBB3_902
# %bb.841:                              # %land.lhs.true906
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.bu	$a0, $fp, 0
	ori	$s0, $zero, 10
	beqz	$a0, .LBB3_917
# %bb.842:                              # %if.then910
	...
	addi.d	$a1, $a0, %pc_lo12(.L.str.42)
	b	.LBB3_846
.LBB3_843:                              # %html_tag_arg_value.exit1597
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.d	$a0, $sp, 1512
	ldx.d	$fp, $a0, $s0
	beqz	$fp, .LBB3_851
# %bb.844:                              # %land.lhs.true872
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.bu	$a0, $fp, 0
	ld.d	$s1, $sp, 112                   # 8-byte Folded Reload
	ori	$s0, $zero, 10
...
.LBB3_861:                              # %if.then.i23.i
	...
	blt	$a2, $a0, .LBB3_864
# %bb.862:                              # %if.then.i23.i
                                        #   in Loop: Header=BB3_47 Depth=2
	add.w	$a0, $a2, $s4
	bge	$s3, $a0, .LBB3_864
# %bb.863:                              # %if.end.thread.i.i
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $a1, 0
	ld.d	$a1, $sp, 248                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(cli_writen)
...
# %bb.866:                              # %if.then.i15.i.i
	...
	ld.d	$a1, $sp, 272                   # 8-byte Folded Reload
	stptr.w	$zero, $a1, 8196
.LBB3_867:                              # %html_output_flush.exit18.i.i
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $a1, 0
	ori	$a1, $zero, 3584
	add.d	$a1, $sp, $a1
...
# %bb.870:                              # %for.body.lr.ph.i1466
	...
	move	$s3, $zero
	b	.LBB3_874
.LBB3_871:                              # %html_output_flush.exit.i109.i
	...
	ld.d	$a3, $sp, 272                   # 8-byte Folded Reload
	move	$fp, $zero
.LBB3_872:                              # %if.end.i104.i
                                        #   in Loop: Header=BB3_874 Depth=3
	addi.d	$a0, $fp, 1
	stptr.w	$a0, $a3, 8196
	ori	$a0, $zero, 34
	stx.b	$a0, $a1, $fp
.LBB3_873:                              # %for.inc29.i
                                        #   in Loop: Header=BB3_874 Depth=3
	ld.w	$a0, $sp, 1496
	addi.d	$s3, $s3, 1
	bge	$s3, $a0, .LBB3_895
.LBB3_874:                              # %for.body.i1468
                                        #   Parent Loop BB3_28 Depth=1
                                        #     Parent Loop BB3_47 Depth=2
                                        # =>    This Loop Header: Depth=3
                                        #         Child Loop BB3_891 Depth 4
	beqz	$a3, .LBB3_873
# %bb.875:                              # %if.then.i31.i
                                        #   in Loop: Header=BB3_874 Depth=3
	ldptr.w	$a0, $a3, 8196
	bne	$a0, $a5, .LBB3_877
# %bb.876:                              # %html_output_flush.exit.i39.i
                                        #   in Loop: Header=BB3_874 Depth=3
	ld.w	$a0, $a3, 0
	lu12i.w	$a2, 2
	pcaddu18i	$ra, %call36(cli_writen)
...
# %bb.879:                              # %if.end.thread.i65.i
	...
	b	.LBB3_884
	.p2align	4, , 16
.LBB3_880:                              # %if.end.i50.i
                                        #   in Loop: Header=BB3_874 Depth=3
	bge	$s2, $s4, .LBB3_884
# %bb.881:                              # %if.then3.i58.i
                                        #   in Loop: Header=BB3_874 Depth=3
	ori	$a0, $zero, 1
	blt	$a2, $a0, .LBB3_883
# %bb.882:                              # %if.then.i15.i62.i
                                        #   in Loop: Header=BB3_874 Depth=3
	ld.w	$a0, $a1, 0
	ld.d	$a1, $sp, 248                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(cli_writen)
	...
	ld.d	$a1, $sp, 272                   # 8-byte Folded Reload
	stptr.w	$zero, $a1, 8196
.LBB3_883:                              # %html_output_flush.exit18.i60.i
                                        #   in Loop: Header=BB3_874 Depth=3
	ld.w	$a0, $a1, 0
	move	$a1, $fp
	move	$a2, $s4
...
.LBB3_884:                              # %if.else.i52.i
	...
	add.d	$a0, $a0, $s7
	stptr.w	$a0, $a3, 8196
.LBB3_885:                              # %html_output_str.exit69.i
                                        #   in Loop: Header=BB3_874 Depth=3
	ld.d	$a0, $sp, 120                   # 8-byte Folded Reload
	ldx.d	$a0, $a0, $s0
	ld.d	$a1, $sp, 248                   # 8-byte Folded Reload
	...
	ld.d	$s2, $sp, 136                   # 8-byte Folded Reload
	beqz	$a0, .LBB3_873
# %bb.886:                              # %if.then.i71.i
                                        #   in Loop: Header=BB3_874 Depth=3
	ldptr.w	$a2, $a3, 8196
	lu12i.w	$a0, 1
	ori	$a0, $a0, 4094
	blt	$a2, $a0, .LBB3_888
# %bb.887:                              # %if.end.thread.i83.i
                                        #   in Loop: Header=BB3_874 Depth=3
	ld.w	$a0, $a3, 0
	pcaddu18i	$ra, %call36(cli_writen)
	jirl	$ra, $ra, 0
...
.LBB3_888:                              # %html_output_str.exit86.thread.i
                                        #   in Loop: Header=BB3_874 Depth=3
	ori	$a0, $a5, 573
	stx.h	$a0, $a1, $a2
	ori	$s0, $a5, 4
...
.LBB3_891:                              # %for.body18.i
	...
	ldx.w	$s2, $a4, $a2
	bne	$a0, $a5, .LBB3_890
# %bb.892:                              # %html_output_flush.exit.i96.i
                                        #   in Loop: Header=BB3_891 Depth=4
	ld.w	$a0, $a3, 0
	move	$a2, $a5
	pcaddu18i	$ra, %call36(cli_writen)
	...
	b	.LBB3_890
	.p2align	4, , 16
.LBB3_893:                              # %if.then.i101.ithread-pre-split
                                        #   in Loop: Header=BB3_874 Depth=3
	ldx.w	$fp, $a3, $s0
	ld.d	$s1, $sp, 112                   # 8-byte Folded Reload
	ori	$s0, $zero, 10
...
.LBB3_894:                              #   in Loop: Header=BB3_874 Depth=3
	...
	bne	$fp, $a5, .LBB3_872
	b	.LBB3_871
.LBB3_895:                              # %for.end31.i
                                        #   in Loop: Header=BB3_47 Depth=2
	beqz	$a3, .LBB3_899
# %bb.896:                              # %if.then.i114.i
                                        #   in Loop: Header=BB3_47 Depth=2
	ldptr.w	$a0, $a3, 8196
	ld.d	$s3, $sp, 176                   # 8-byte Folded Reload
	bne	$a0, $a5, .LBB3_898
# %bb.897:                              # %html_output_flush.exit.i122.i
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.w	$a0, $a3, 0
	lu12i.w	$a2, 2
	pcaddu18i	$ra, %call36(cli_writen)
...
.LBB3_904:                              #   in Loop: Header=BB3_47 Depth=2
	...
	move	$s2, $s7
	b	.LBB3_914
.LBB3_905:                              # %if.then.i1543
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.d	$fp, $s2, 0
.LBB3_906:                              # %html_tag_arg_value.exit1546
                                        #   in Loop: Header=BB3_47 Depth=2
	move	$s2, $s7
	ld.d	$a0, $sp, 184                   # 8-byte Folded Reload
	beqz	$a0, .LBB3_909
# %bb.907:                              # %html_tag_arg_value.exit1546
                                        #   in Loop: Header=BB3_47 Depth=2
	beqz	$s2, .LBB3_909
# %bb.908:                              # %if.then779
                                        #   in Loop: Header=BB3_47 Depth=2
...
.LBB3_918:                              # %if.end974
	...
	st.d	$a0, $sp, 120                   # 8-byte Folded Spill
.LBB3_919:                              # %while.cond114.backedge
                                        #   in Loop: Header=BB3_47 Depth=2
	ld.d	$a4, $sp, 272                   # 8-byte Folded Reload
	lu12i.w	$a5, 2
	b	.LBB3_46
...
# %bb.923:                              # %if.then1730
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB3_935
# %bb.924:                              # %for.cond1738.preheader
	move	$s0, $a0
	ld.bu	$a0, $a0, 0
	beqz	$a0, .LBB3_971
# %bb.925:                              # %for.body1742.lr.ph
	pcaddu18i	$ra, %call36(__ctype_tolower_loc)
	jirl	$ra, $ra, 0
	move	$s4, $a0
	...
	beqz	$a1, .LBB3_960
# %bb.926:                              # %for.body1742.lr.ph.split
	addi.d	$s6, $a1, 4
	move	$s2, $zero
	beqz	$a0, .LBB3_967
# %bb.927:                              # %for.body1742.preheader
	lu12i.w	$s7, 2
	b	.LBB3_929
	.p2align	4, , 16
.LBB3_928:                              # %if.end9.i2501
...
.LBB3_929:                              # %for.body1742
	...
	ldx.w	$s3, $a1, $a2
	bne	$a0, $s7, .LBB3_931
# %bb.930:                              # %html_output_flush.exit.i2509
                                        #   in Loop: Header=BB3_929 Depth=1
	ld.w	$a0, $s8, 0
	move	$a1, $s6
	move	$a2, $s7
...
.LBB3_931:                              # %if.end.i2491
	...
	ldptr.w	$a0, $s8, 8196
	bne	$a0, $s7, .LBB3_928
# %bb.932:                              # %html_output_flush.exit15.i2506
                                        #   in Loop: Header=BB3_929 Depth=1
	ld.w	$a0, $s8, 0
	move	$a1, $s5
	move	$a2, $s7
...
# %bb.936:                              # %if.then1756
	...
	b	.LBB3_939
	.p2align	4, , 16
.LBB3_937:                              # %if.end9.i2527
                                        #   in Loop: Header=BB3_939 Depth=1
	addi.d	$a1, $a0, 1
	stptr.w	$a1, $s7, 8196
	stx.b	$s3, $s5, $a0
.LBB3_938:                              # %html_output_c.exit2538
                                        #   in Loop: Header=BB3_939 Depth=1
	addi.d	$s8, $s8, -1
	addi.d	$s2, $s2, 1
	beqz	$s8, .LBB3_958
.LBB3_939:                              # %for.body1760
                                        # =>This Inner Loop Header: Depth=1
	ld.bu	$a0, $s2, 0
	ld.d	$a1, $s0, 0
	slli.d	$a0, $a0, 2
	...
	beqz	$s7, .LBB3_943
# %bb.940:                              # %if.then.i2514
                                        #   in Loop: Header=BB3_939 Depth=1
	ldptr.w	$a0, $s7, 8196
	bne	$a0, $s6, .LBB3_942
# %bb.941:                              # %html_output_flush.exit.i2535
                                        #   in Loop: Header=BB3_939 Depth=1
	ld.w	$a0, $s7, 0
	move	$a1, $s4
	move	$a2, $s6
	...
	jirl	$ra, $ra, 0
	move	$a0, $zero
.LBB3_942:                              # %if.end.i2517
                                        #   in Loop: Header=BB3_939 Depth=1
	addi.d	$a1, $a0, 1
	stptr.w	$a1, $s7, 8196
	stx.b	$s3, $s4, $a0
.LBB3_943:                              # %if.end3.i2522
                                        #   in Loop: Header=BB3_939 Depth=1
	ld.d	$s7, $sp, 264                   # 8-byte Folded Reload
	beqz	$s7, .LBB3_938
# %bb.944:                              # %if.then5.i2524
                                        #   in Loop: Header=BB3_939 Depth=1
	ldptr.w	$a0, $s7, 8196
	bne	$a0, $s6, .LBB3_937
# %bb.945:                              # %html_output_flush.exit15.i2532
                                        #   in Loop: Header=BB3_939 Depth=1
	ld.w	$a0, $s7, 0
	move	$a1, $s5
	move	$a2, $s6
...
.LBB3_953:                              # %if.end1793
	beqz	$s6, .LBB3_983
.LBB3_954:                              # %if.then1795
	ldptr.w	$a2, $s6, 8196
	ori	$a0, $zero, 1
	blt	$a2, $a0, .LBB3_956
# %bb.955:                              # %if.then.i2555
	ld.w	$a0, $s6, 0
	addi.d	$a1, $s6, 4
	pcaddu18i	$ra, %call36(cli_writen)
	jirl	$ra, $ra, 0
	stptr.w	$zero, $s6, 8196
.LBB3_956:                              # %html_output_flush.exit2558
	ld.w	$a0, $s6, 0
	pcaddu18i	$ra, %call36(close)
	jirl	$ra, $ra, 0
	move	$a0, $s6
...
.LBB3_959:                              # %if.then59
	...
	jirl	$ra, $ra, 0
	b	.LBB3_975
.LBB3_960:                              # %for.body1742.lr.ph.split.us
	beqz	$a0, .LBB3_971
# %bb.961:                              # %for.body1742.us.preheader
	move	$s2, $zero
	lu12i.w	$s6, 2
	b	.LBB3_963
	.p2align	4, , 16
.LBB3_962:                              # %if.end9.i2501.us
...
.LBB3_963:                              # %for.body1742.us
	...
	ldx.w	$s1, $a1, $a2
	bne	$a0, $s6, .LBB3_962
# %bb.964:                              # %html_output_flush.exit15.i2506.us
                                        #   in Loop: Header=BB3_963 Depth=1
	ld.w	$a0, $s7, 0
	move	$a1, $s5
	move	$a2, $s6
...
.LBB3_966:                              # %sw.bb132
	...
	jirl	$ra, $ra, 0
	b	.LBB3_989
.LBB3_967:                              # %for.body1742.us2820.preheader
	lu12i.w	$s5, 2
	b	.LBB3_969
	.p2align	4, , 16
.LBB3_968:                              # %if.end.i2491.us
...
.LBB3_969:                              # %for.body1742.us2820
	...
	ldx.w	$s1, $a1, $a2
	bne	$a0, $s5, .LBB3_968
# %bb.970:                              # %html_output_flush.exit.i2509.us
                                        #   in Loop: Header=BB3_969 Depth=1
	ld.w	$a0, $s3, 0
	move	$a1, $s6
	move	$a2, $s5
...
.LBB3_979:                              # %if.end1788
	ld.d	$s0, $sp, 272                   # 8-byte Folded Reload
	beqz	$s4, .LBB3_953
.LBB3_980:                              # %if.then1790
	ldptr.w	$a2, $s4, 8196
	ori	$a0, $zero, 1
	blt	$a2, $a0, .LBB3_982
# %bb.981:                              # %if.then.i2548
	ld.w	$a0, $s4, 0
	addi.d	$a1, $s4, 4
	pcaddu18i	$ra, %call36(cli_writen)
	jirl	$ra, $ra, 0
	stptr.w	$zero, $s4, 8196
.LBB3_982:                              # %html_output_flush.exit2551
	ld.w	$a0, $s4, 0
	pcaddu18i	$ra, %call36(close)
	jirl	$ra, $ra, 0
	move	$a0, $s4
...
.LBB3_983:                              # %if.end1798
	beqz	$s0, .LBB3_987
.LBB3_984:                              # %if.then1800
	ldptr.w	$a2, $s0, 8196
	ori	$a0, $zero, 1
	blt	$a2, $a0, .LBB3_986
# %bb.985:                              # %if.then.i2562
	ld.w	$a0, $s0, 0
	addi.d	$a1, $s0, 4
	pcaddu18i	$ra, %call36(cli_writen)
	jirl	$ra, $ra, 0
	ld.d	$s0, $sp, 272                   # 8-byte Folded Reload
	stptr.w	$zero, $s0, 8196
.LBB3_986:                              # %html_output_flush.exit2565
	ld.w	$a0, $s0, 0
	pcaddu18i	$ra, %call36(close)
	jirl	$ra, $ra, 0
	move	$a0, $s0
