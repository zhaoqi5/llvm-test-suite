...
.LBB6_80:                               # %do.end868
	...
	addi.d	$a2, $a5, 257
	st.w	$a2, $s4, 132
	bstrpick.d	$a4, $s5, 9, 5
	addi.d	$a2, $a4, 1
	st.w	$a2, $s4, 136
	bstrpick.d	$a2, $s5, 13, 10
	addi.d	$a2, $a2, 4
	st.w	$a2, $s4, 128
	srli.d	$s5, $s5, 14
	ori	$a6, $zero, 29
...
.LBB6_148:                              # %sw.bb759
	...
	st.d	$a2, $a0, 48
	ori	$a2, $s3, 3921
.LBB6_149:                              # %do.body762.sink.split
                                        #   in Loop: Header=BB6_16 Depth=1
	st.w	$a2, $s4, 8
.LBB6_150:                              # %do.body762
                                        #   in Loop: Header=BB6_16 Depth=1
...
# %bb.160:                              # %if.then1782
	...
	sub.d	$a1, $ra, $a6
	beqz	$a3, .LBB6_272
# %bb.161:                              # %cond.true1785
                                        #   in Loop: Header=BB6_16 Depth=1
	pcaddu18i	$ra, %call36(crc32)
	jirl	$ra, $ra, 0
	b	.LBB6_273
.LBB6_162:                              # %if.then1228
                                        #   in Loop: Header=BB6_16 Depth=1
	pcalau12i	$a2, %pc_hi20(.L.str.11)
	addi.d	$a2, $a2, %pc_lo12(.L.str.11)
	b	.LBB6_350
.LBB6_163:                              # %vector.scevcheck3113
                                        #   in Loop: Header=BB6_16 Depth=1
	ori	$a4, $zero, 19
	sub.d	$a3, $a4, $a3
	addi.w	$a4, $a3, 0
	...
	sub.w	$a5, $a6, $a5
	bltu	$a5, $a4, .LBB6_91
# %bb.164:                              # %vector.scevcheck3113
                                        #   in Loop: Header=BB6_16 Depth=1
	srli.d	$a3, $a3, 32
	bnez	$a3, .LBB6_91
# %bb.165:                              # %vector.main.loop.iter.check
                                        #   in Loop: Header=BB6_16 Depth=1
	ori	$a3, $zero, 16
	bgeu	$a1, $a3, .LBB6_288
# %bb.166:                              #   in Loop: Header=BB6_16 Depth=1
	move	$a6, $zero
...
.LBB6_271:                              # %if.then609
	...
	b	.LBB6_286
.LBB6_272:                              # %cond.false1791
                                        #   in Loop: Header=BB6_16 Depth=1
	pcaddu18i	$ra, %call36(adler32)
	jirl	$ra, $ra, 0
.LBB6_273:                              # %cond.end1797
                                        #   in Loop: Header=BB6_16 Depth=1
	move	$a1, $a0
	ld.w	$a4, $s4, 16
	st.d	$a0, $s4, 32
...
.LBB6_278:                              # %sw.bb1835
                                        #   in Loop: Header=BB6_16 Depth=1
	beqz	$a4, .LBB6_413
# %bb.279:                              # %land.lhs.true1838
                                        #   in Loop: Header=BB6_16 Depth=1
	ld.w	$a2, $s4, 24
	beqz	$a2, .LBB6_413
# %bb.280:                              # %while.cond1843.preheader
                                        #   in Loop: Header=BB6_16 Depth=1
	addi.w	$a2, $s1, 0
	ori	$a4, $zero, 31
	bltu	$a4, $a2, .LBB6_283
.LBB6_281:                              # %do.body1847
                                        #   Parent Loop BB6_16 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	beqz	$fp, .LBB6_382
# %bb.282:                              # %if.end1851
...
.LBB6_286:                              # %sw.epilog1881
                                        #   in Loop: Header=BB6_16 Depth=1
	st.d	$a2, $a0, 48
	ori	$a2, $s3, 3921
	st.w	$a2, $s4, 8
	b	.LBB6_15
.LBB6_287:                              # %if.then1826
                                        #   in Loop: Header=BB6_16 Depth=1
...
# %bb.298:                              # %if.then1303
	...
	lu32i.d	$a1, 0
	stptr.w	$a1, $s4, 7148
.LBB6_299:                              #   in Loop: Header=BB6_16 Depth=1
	ld.d	$a1, $sp, 112                   # 8-byte Folded Reload
	ld.d	$a3, $sp, 96                    # 8-byte Folded Reload
.LBB6_300:                              # %sw.epilog1881
                                        #   in Loop: Header=BB6_16 Depth=1
	ori	$t8, $zero, 30
	ld.d	$t7, $sp, 104                   # 8-byte Folded Reload
	b	.LBB6_15
.LBB6_301:                              # %if.end1305
	...
	addi.w	$t0, $s1, 0
	bgeu	$t0, $a6, .LBB6_305
# %bb.302:                              # %do.body1322.preheader
                                        #   in Loop: Header=BB6_16 Depth=1
	nor	$t2, $a2, $zero
	move	$a5, $s1
	move	$a2, $fp
	move	$t3, $s8
.LBB6_303:                              # %do.body1322
                                        #   Parent Loop BB6_16 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	beqz	$a2, .LBB6_384
# %bb.304:                              # %if.end1326
                                        #   in Loop: Header=BB6_303 Depth=2
	ld.bu	$a6, $t3, 0
	sll.d	$a6, $a6, $t0
	add.d	$s5, $a6, $s5
	and	$a6, $t2, $s5
...
# %bb.307:                              # %for.cond1346.preheader
	...
	addi.w	$t4, $a5, 0
	bgeu	$t4, $t3, .LBB6_312
# %bb.308:                              # %do.body1374.preheader
                                        #   in Loop: Header=BB6_16 Depth=1
	nor	$t6, $t2, $zero
	move	$t3, $a5
	move	$t2, $a2
	move	$fp, $s0
.LBB6_309:                              # %do.body1374
                                        #   Parent Loop BB6_16 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	beqz	$t2, .LBB6_414
# %bb.310:                              # %if.end1378
...
# %bb.317:                              # %if.end1443
	...
	move	$fp, $a2
	bnez	$a4, .LBB6_25
.LBB6_318:                              # %sw.bb1449.if.end1494_crit_edge
                                        #   in Loop: Header=BB6_16 Depth=1
	ld.w	$a7, $s4, 92
.LBB6_319:                              # %if.end1494
                                        #   in Loop: Header=BB6_16 Depth=1
...
.LBB6_320:                              # %sw.bb1497
	...
	addi.w	$t1, $s1, 0
	bgeu	$t1, $a5, .LBB6_324
# %bb.321:                              # %do.body1513.preheader
                                        #   in Loop: Header=BB6_16 Depth=1
	nor	$t2, $a2, $zero
	move	$a4, $s1
	move	$a2, $fp
	move	$t3, $s8
.LBB6_322:                              # %do.body1513
                                        #   Parent Loop BB6_16 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	beqz	$a2, .LBB6_384
# %bb.323:                              # %if.end1517
                                        #   in Loop: Header=BB6_322 Depth=2
	ld.bu	$a5, $t3, 0
	sll.d	$a5, $a5, $t1
	add.d	$s5, $a5, $s5
	and	$a5, $t2, $s5
...
.LBB6_324:                              #   in Loop: Header=BB6_16 Depth=1
	...
	move	$a2, $fp
	move	$a4, $s1
.LBB6_325:                              # %for.end1527
                                        #   in Loop: Header=BB6_16 Depth=1
	ld.bu	$t3, $a7, 0
	ld.hu	$a7, $a7, 2
	ori	$t1, $zero, 16
	bgeu	$t3, $t1, .LBB6_330
# %bb.326:                              # %for.cond1534.preheader
                                        #   in Loop: Header=BB6_16 Depth=1
	move	$s7, $s2
	move	$s2, $t6
	add.d	$t1, $a5, $t3
	...
	addi.w	$t3, $a4, 0
	bgeu	$t3, $t1, .LBB6_331
# %bb.327:                              # %do.body1562.preheader
                                        #   in Loop: Header=BB6_16 Depth=1
	nor	$t5, $t0, $zero
	move	$t1, $a4
	move	$t0, $a2
	move	$t7, $s0
.LBB6_328:                              # %do.body1562
                                        #   Parent Loop BB6_16 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	beqz	$t0, .LBB6_389
# %bb.329:                              # %if.end1566
                                        #   in Loop: Header=BB6_328 Depth=2
	ld.bu	$t2, $t7, 0
	sll.d	$t2, $t2, $t3
	add.d	$s5, $t2, $s5
	and	$t2, $s5, $t5
	...
	bltu	$t3, $t8, .LBB6_328
	b	.LBB6_332
.LBB6_330:                              # %for.end1527.do.body1592_crit_edge
                                        #   in Loop: Header=BB6_16 Depth=1
	lu12i.w	$a6, 1
	ori	$a6, $a6, 3052
	ldx.w	$a6, $s4, $a6
	b	.LBB6_333
.LBB6_331:                              #   in Loop: Header=BB6_16 Depth=1
	move	$t6, $s0
	move	$t0, $a2
	move	$t1, $a4
.LBB6_332:                              # %do.body1577
                                        #   in Loop: Header=BB6_16 Depth=1
	ld.hu	$a7, $t4, 2
	lu12i.w	$a2, 1
	ori	$a2, $a2, 3052
...
.LBB6_335:                              # %sw.bb1621
                                        #   in Loop: Header=BB6_16 Depth=1
	beqz	$a4, .LBB6_344
# %bb.336:                              # %while.cond1626.preheader
                                        #   in Loop: Header=BB6_16 Depth=1
	addi.w	$a2, $s1, 0
	bgeu	$a2, $a4, .LBB6_342
# %bb.337:                              # %do.body1631.preheader
                                        #   in Loop: Header=BB6_16 Depth=1
	move	$a5, $s1
	move	$a2, $fp
	move	$a7, $s8
.LBB6_338:                              # %do.body1631
                                        #   Parent Loop BB6_16 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	beqz	$a2, .LBB6_387
# %bb.339:                              # %if.end1635
...
.LBB6_350:                              # %sw.epilog1881
                                        #   in Loop: Header=BB6_16 Depth=1
	st.d	$a2, $a0, 48
	ori	$a2, $s3, 3921
	b	.LBB6_13
.LBB6_351:                              # %if.else1710
                                        #   in Loop: Header=BB6_16 Depth=1
	ld.w	$a4, $s4, 92
...
.LBB6_365:                              #   in Loop: Header=BB6_16 Depth=1
	...
	move	$ra, $a4
	b	.LBB6_15
.LBB6_366:                              # %if.then1425
                                        #   in Loop: Header=BB6_16 Depth=1
	ori	$a4, $s3, 3917
.LBB6_367:                              # %sw.epilog1881
                                        #   in Loop: Header=BB6_16 Depth=1
	st.w	$a4, $s4, 8
	move	$fp, $a2
	b	.LBB6_15
.LBB6_368:                              # %if.then1432
                                        #   in Loop: Header=BB6_16 Depth=1
	lu32i.d	$a4, 0
	stptr.w	$a4, $s4, 7148
	st.w	$s7, $s4, 8
...
.LBB6_383:
	...
	move	$s8, $a2
	b	.LBB6_393
.LBB6_384:                              # %do.body1882.loopexit2428
	bstrpick.d	$a2, $fp, 31, 0
	alsl.w	$s1, $fp, $s1, 3
	b	.LBB6_388
.LBB6_385:
	...
	move	$s8, $a4
	b	.LBB6_393
.LBB6_386:                              # %do.body1882.loopexit2425
	move	$fp, $zero
	...
	move	$s7, $a4
	b	.LBB6_395
.LBB6_387:                              # %do.body1882.loopexit2426
	alsl.w	$s1, $fp, $s1, 3
	bstrpick.d	$a2, $fp, 31, 0
.LBB6_388:                              # %do.body1882
	add.d	$s8, $s8, $a2
	ld.d	$a2, $sp, 64                    # 8-byte Folded Reload
	st.d	$a2, $sp, 72                    # 8-byte Folded Spill
	move	$fp, $zero
	b	.LBB6_395
.LBB6_389:                              # %do.body1882.loopexit2427
	move	$fp, $zero
...
.LBB6_390:
	...
	move	$s1, $t0
	b	.LBB6_393
.LBB6_391:                              # %if.end486.do.body1882.loopexit3801_crit_edge
	add.d	$s8, $s8, $s0
	ld.d	$a2, $sp, 64                    # 8-byte Folded Reload
	st.d	$a2, $sp, 72                    # 8-byte Folded Spill
	move	$s3, $s2
...
.LBB6_398:
	addi.w	$a3, $zero, -4
	b	.LBB6_411
.LBB6_399:                              # %lor.lhs.false1893
	beq	$s0, $t6, .LBB6_404
# %bb.400:                              # %land.lhs.true1897
	ld.w	$a2, $s4, 8
	ori	$a3, $s3, 3920
	bltu	$a3, $a2, .LBB6_404
...
.LBB6_413:
	move	$s0, $s8
	b	.LBB6_419
.LBB6_414:                              # %do.body1882.loopexit2430
	move	$fp, $zero
	bstrpick.d	$a3, $a2, 31, 0
	alsl.w	$s1, $a2, $a5, 3
.LBB6_415:                              # %do.body1882
	add.d	$s8, $s0, $a3
	ld.d	$a2, $sp, 64                    # 8-byte Folded Reload
	st.d	$a2, $sp, 72                    # 8-byte Folded Spill
	move	$t6, $s2
...
.LBB6_419:                              # %if.end1875
	...
	move	$s8, $s0
	b	.LBB6_395
.LBB6_420:                              # %do.body1882.loopexit3140
	ori	$a2, $zero, 1
	b	.LBB6_394
.LBB6_421:
	move	$s1, $s5
...
.LJTI6_0:
	...
	.word	.LBB6_294-.LJTI6_0
	.word	.LBB6_295-.LJTI6_0
	.word	.LBB6_24-.LJTI6_0
	.word	.LBB6_320-.LJTI6_0
	.word	.LBB6_30-.LJTI6_0
	.word	.LBB6_345-.LJTI6_0
	.word	.LBB6_22-.LJTI6_0
	.word	.LBB6_52-.LJTI6_0
	.word	.LBB6_57-.LJTI6_0
	.word	.LBB6_420-.LJTI6_0
	.word	.LBB6_395-.LJTI6_0
	.word	.LBB6_398-.LJTI6_0
.LJTI6_1:
