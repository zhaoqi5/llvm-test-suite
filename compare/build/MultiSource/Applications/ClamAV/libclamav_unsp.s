...
.LBB1_216:                              # %if.then.i.i676
	...
	ori	$a6, $zero, 255
	b	.LBB1_246
.LBB1_217:                              # %vector.main.loop.iter.check927
                                        #   in Loop: Header=BB1_15 Depth=1
	ori	$a3, $zero, 16
	bgeu	$a2, $a3, .LBB1_219
...
# %bb.221:                              # %middle.block938
	...
	beq	$a2, $a6, .LBB1_227
# %bb.222:                              # %vec.epilog.iter.check943
                                        #   in Loop: Header=BB1_15 Depth=1
	andi	$a6, $a5, 12
	beqz	$a6, .LBB1_226
.LBB1_223:                              # %vec.epilog.ph942
                                        #   in Loop: Header=BB1_15 Depth=1
	...
	vor.v	$vr1, $vr2, $vr1
	sub.d	$a3, $a4, $a5
.LBB1_224:                              # %vec.epilog.vector.body951
                                        #   Parent Loop BB1_15 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vsll.w	$vr2, $vr5, $vr1
	vor.v	$vr0, $vr2, $vr0
	...
	vaddi.wu	$vr1, $vr1, 4
	bnez	$a3, .LBB1_224
# %bb.225:                              # %vec.epilog.middle.block957
                                        #   in Loop: Header=BB1_15 Depth=1
