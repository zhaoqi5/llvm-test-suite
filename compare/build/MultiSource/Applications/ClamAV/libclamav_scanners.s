...
# %bb.52:                               # %if.then169
	...
	move	$s3, $a0
	addi.d	$a0, $a1, -1
.LBB2_53:                               # %cond.false193
	st.w	$a0, $s0, 44
	move	$s2, $s3
	b	.LBB2_62
.LBB2_54:                               # %cond.end.thread.thread167
	ld.w	$a0, $s0, 44
.LBB2_55:                               # %cond.false193
	ori	$s2, $zero, 1
	st.w	$a0, $s0, 44
	b	.LBB2_62
.LBB2_56:
...
.LBB2_59:
	ori	$s3, $zero, 1
.LBB2_60:                               # %cond.true191
	st.w	$a0, $s0, 48
	move	$s2, $s3
	b	.LBB2_62
	.p2align	4, , 16
.LBB2_61:                               # %while.body201
                                        #   in Loop: Header=BB2_62 Depth=1
	ld.d	$a1, $a0, 24
	st.d	$a1, $sp, 112
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB2_62:                               # %while.body201
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $sp, 112
	bnez	$a0, .LBB2_61
# %bb.63:                               # %while.end203
...
.LBB23_67:                              # %if.then95
	...
	jirl	$ra, $ra, 0
	addi.w	$fp, $zero, -115
.LBB23_68:                              # %for.end153thread-pre-split.sink.split
	move	$a0, $s7
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	move	$s7, $fp
...
.LBB23_70:                              # %for.end153
	blez	$a0, .LBB23_73
# %bb.71:                               # %for.body158.lr.ph
	move	$fp, $zero
	move	$s1, $zero
	.p2align	4, , 16
.LBB23_72:                              # %for.body158
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $s2, 8
	ldx.d	$a0, $a0, $fp
	pcaddu18i	$ra, %call36(free)
