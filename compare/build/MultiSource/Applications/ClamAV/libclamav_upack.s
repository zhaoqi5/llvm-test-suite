...
.LBB0_107:                              # %if.end312
	...
	addi.d	$s3, $a5, 1
	bltu	$s3, $a1, .LBB0_64
# %bb.108:                              # %land.lhs.true331
	add.d	$a5, $s3, $s5
	addi.d	$a6, $a5, 5
	bltu	$t0, $a6, .LBB0_64
# %bb.109:                              # %land.lhs.true331
	bgeu	$a1, $a6, .LBB0_64
# %bb.110:                              # %lor.lhs.false345
...
# %bb.111:                              # %if.end352
	...
	addi.d	$a0, $a0, 3
	bltu	$s6, $a0, .LBB0_148
# %bb.112:                              # %lor.lhs.false398
	add.d	$a0, $a2, $a4
	ld.bu	$a1, $a0, 0
	ori	$a2, $zero, 193
	bne	$a1, $a2, .LBB0_148
# %bb.113:                              # %lor.lhs.false406
	ld.bu	$a1, $a0, 1
	ori	$a2, $zero, 237
	bne	$a1, $a2, .LBB0_148
# %bb.114:                              # %if.end416
...
.LBB0_117:                              # %vector.body840
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB0_117
# %bb.118:                              # %middle.block848
	bne	$a5, $s4, .LBB0_39
	b	.LBB0_40
.LBB0_119:                              # %land.lhs.true1054
	addi.d	$a0, $s1, 48
	bltu	$s2, $a0, .LBB0_48
# %bb.120:                              # %land.lhs.true1054
	addi.d	$a1, $s1, 76
	move	$a0, $fp
	ld.d	$s6, $sp, 48                    # 8-byte Folded Reload
	bltu	$s2, $a1, .LBB0_64
# %bb.121:                              # %for.cond1094.preheader
...
# %bb.124:                              # %land.lhs.true439
	...
	ld.d	$a2, $sp, 88                    # 8-byte Folded Reload
	bltu	$a2, $a1, .LBB0_148
# %bb.125:                              # %lor.lhs.false455
	ld.bu	$a0, $a0, 0
	ori	$a1, $zero, 190
	bne	$a0, $a1, .LBB0_148
# %bb.126:                              # %lor.lhs.false460
	ld.bu	$a0, $s0, 23
	ori	$a1, $zero, 191
	bne	$a0, $a1, .LBB0_148
# %bb.127:                              # %if.end466
...
# %bb.128:                              # %if.end466
	bltu	$s4, $a0, .LBB0_148
# %bb.129:                              # %land.lhs.true528
	slli.d	$a1, $fp, 10
	addi.d	$a2, $a1, 112
	bltu	$s1, $a2, .LBB0_148
# %bb.130:                              # %land.lhs.true541
	ld.w	$a1, $s0, 24
	sub.d	$a1, $a1, $s4
	bstrpick.d	$a1, $a1, 31, 0
	add.d	$a2, $a1, $a2
	bltu	$s6, $a2, .LBB0_148
# %bb.131:                              # %land.lhs.true550
	ori	$a2, $zero, 192
	bltu	$s1, $a2, .LBB0_148
...
# %bb.133:                              # %for.body.preheader
	...
	addi.d	$a1, $a1, 88
	b	.LBB0_143
.LBB0_134:                              # %land.lhs.true494
	addi.d	$a0, $s0, 19
	bltu	$a0, $s8, .LBB0_148
# %bb.135:                              # %land.lhs.true494
	addi.d	$a1, $s0, 24
	ld.d	$a2, $sp, 88                    # 8-byte Folded Reload
	bltu	$a2, $a1, .LBB0_148
# %bb.136:                              # %lor.lhs.false510
	ld.bu	$a0, $a0, 0
	ori	$a1, $zero, 190
	bne	$a0, $a1, .LBB0_148
# %bb.137:                              # %land.lhs.true586
	slli.d	$a0, $fp, 10
	addi.d	$a0, $a0, 180
	bltu	$s1, $a0, .LBB0_148
...
# %bb.60:                               # %land.lhs.true234
                                        #   in Loop: Header=BB1_1 Depth=1
	bgeu	$s4, $a1, .LBB1_75
# %bb.61:                               # %land.lhs.true234
                                        #   in Loop: Header=BB1_1 Depth=1
	bgeu	$s1, $s3, .LBB1_75
# %bb.62:                               # %land.lhs.true257
                                        #   in Loop: Header=BB1_1 Depth=1
