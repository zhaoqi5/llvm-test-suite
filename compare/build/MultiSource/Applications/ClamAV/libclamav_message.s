...
.LBB10_31:
	move	$a0, $s1
	move	$s2, $s3
.LBB10_32:                              # %while.body.i.preheader67
	move	$a1, $a0
	move	$a2, $s2
	.p2align	4, , 16
...
.LBB28_35:                              # %if.end407.i
	...
	jirl	$ra, $ra, 0
	bnez	$a0, .LBB28_37
# %bb.36:                               # %messageGetFilename.exit.i
                                        #   in Loop: Header=BB28_24 Depth=1
	move	$a0, $s1
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB28_90
.LBB28_37:                              #   in Loop: Header=BB28_24 Depth=1
	move	$s0, $a0
	bnez	$s7, .LBB28_39
# %bb.38:                               # %if.then415.i
                                        #   in Loop: Header=BB28_24 Depth=1
...
.LBB28_50:                              # %if.end476.thread.i
	...
	ori	$a2, $zero, 2
	bltu	$a1, $a2, .LBB28_54
# %bb.51:                               # %if.end476.thread.i
                                        #   in Loop: Header=BB28_46 Depth=2
	ori	$a1, $zero, 2
	beq	$s7, $a1, .LBB28_54
# %bb.52:                               # %if.end476.thread.i
                                        #   in Loop: Header=BB28_46 Depth=2
	ori	$a0, $zero, 1
	bne	$s7, $a0, .LBB28_64
# %bb.53:                               # %sw.bb2.i
	...
	st.b	$a0, $sp, 120
	addi.d	$a0, $sp, 121
.LBB28_54:                              # %decodeLine.exit.thread
                                        #   in Loop: Header=BB28_46 Depth=2
	move	$s1, $zero
	st.b	$zero, $a0, 0
	bne	$a0, $s5, .LBB28_57
...
.LBB28_55:                              # %if.end476.i.thread
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB28_92
.LBB28_56:                              #   in Loop: Header=BB28_46 Depth=2
	move	$s1, $zero
	beq	$a0, $s5, .LBB28_58
.LBB28_57:                              # %if.then488.i
                                        #   in Loop: Header=BB28_46 Depth=2
	sub.d	$s0, $a0, $s5
...
.LBB28_64:                              # %decodeLine.exit
	...
	b	.LBB28_92
	.p2align	4, , 16
.LBB28_65:                              #   in Loop: Header=BB28_67 Depth=2
	ld.d	$s1, $sp, 112                   # 8-byte Folded Reload
.LBB28_66:                              # %do.cond.us.i
                                        #   in Loop: Header=BB28_67 Depth=2
	ld.d	$s3, $s3, 8
	beqz	$s3, .LBB28_92
.LBB28_67:                              # %do.body.us.i
                                        #   Parent Loop BB28_24 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB28_75 Depth 3
	ld.d	$a0, $s3, 0
...
# %bb.69:                               # %cond.end469.us.i
	...
	ori	$a0, $zero, 1024
	bltu	$s5, $a0, .LBB28_71
# %bb.70:                               # %if.then473.us.i
                                        #   in Loop: Header=BB28_67 Depth=2
	move	$a0, $s5
	pcaddu18i	$ra, %call36(cli_malloc)
	jirl	$ra, $ra, 0
	move	$s1, $a0
.LBB28_71:                              # %lor.lhs.false138.i
                                        #   in Loop: Header=BB28_67 Depth=2
	ld.bu	$s2, $s8, 0
	beqz	$s2, .LBB28_80
# %bb.72:                               # %if.end143.i
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB28_80
# %bb.73:                               # %while.cond149.i.preheader
                                        #   in Loop: Header=BB28_67 Depth=2
	move	$s0, $zero
	b	.LBB28_75
	.p2align	4, , 16
.LBB28_74:                              # %if.end174.i12
                                        #   in Loop: Header=BB28_75 Depth=3
	stx.b	$a0, $s1, $s0
	ld.bu	$s2, $s8, 0
	addi.d	$s0, $s0, 1
.LBB28_75:                              # %while.cond149.i
                                        #   Parent Loop BB28_24 Depth=1
                                        #     Parent Loop BB28_67 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	andi	$a0, $s2, 255
	beq	$a0, $fp, .LBB28_78
# %bb.76:                               # %while.cond149.i
                                        #   in Loop: Header=BB28_75 Depth=3
	beqz	$a0, .LBB28_81
# %bb.77:                               # %if.else167.i
                                        #   in Loop: Header=BB28_75 Depth=3
...
# %bb.79:                               # %if.end161.i
	...
	b	.LBB28_74
	.p2align	4, , 16
.LBB28_80:                              # %if.end485.us.i.thread
                                        #   in Loop: Header=BB28_67 Depth=2
	st.b	$zero, $s1, 0
	b	.LBB28_83
	.p2align	4, , 16
.LBB28_81:                              # %if.end485.us.i
                                        #   in Loop: Header=BB28_67 Depth=2
	stx.b	$zero, $s1, $s0
	beqz	$s0, .LBB28_83
# %bb.82:                               # %if.then488.us.i
                                        #   in Loop: Header=BB28_67 Depth=2
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
	move	$a1, $s1
	move	$a2, $s0
	...
	jirl	$ra, $ra, 0
	add.d	$s4, $s4, $s0
.LBB28_83:                              # %if.end493.us.i
                                        #   in Loop: Header=BB28_67 Depth=2
	ld.d	$s0, $sp, 104                   # 8-byte Folded Reload
	ori	$a0, $zero, 1024
	bltu	$s5, $a0, .LBB28_85
# %bb.84:                               # %if.then496.us.i
                                        #   in Loop: Header=BB28_67 Depth=2
	move	$a0, $s1
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB28_85:                              # %if.end497.us.i
                                        #   in Loop: Header=BB28_67 Depth=2
	beqz	$s0, .LBB28_65
# %bb.86:                               # %land.lhs.true501.us.i
                                        #   in Loop: Header=BB28_67 Depth=2
	ld.d	$s1, $sp, 112                   # 8-byte Folded Reload
	ld.w	$a0, $s1, 16
	addi.d	$a0, $a0, -1
...
.LBB28_96:
	...
	jirl	$ra, $ra, 0
	bnez	$a0, .LBB28_8
.LBB28_97:                              # %if.then16.i
	pcalau12i	$a0, %pc_hi20(.L.str.73)
	addi.d	$a0, $a0, %pc_lo12(.L.str.73)
	pcaddu18i	$ra, %call36(cli_warnmsg)
	jirl	$ra, $ra, 0
	b	.LBB28_100
.LBB28_98:                              # %if.then20.i
	pcalau12i	$a0, %pc_hi20(.L.str.74)
	addi.d	$a0, $a0, %pc_lo12(.L.str.74)
	pcaddu18i	$ra, %call36(cli_warnmsg)
	jirl	$ra, $ra, 0
.LBB28_99:                              # %cleanup103.thread.i
	move	$a0, $s4
...
.LBB28_104:                             # %cleanup360.thread.i
	...
	b	.LBB28_151
.LBB28_105:                             # %sw.bb80.i
                                        #   in Loop: Header=BB28_107 Depth=1
	ldx.b	$t2, $s3, $s5
...
# %bb.110:                              # %if.end47.i
	...
	ext.w.b	$t4, $t3
	blt	$t4, $a5, .LBB28_121
# %bb.111:                              # %lor.lhs.false55.i
                                        #   in Loop: Header=BB28_107 Depth=1
	ldx.bu	$t3, $a6, $t3
	beq	$t3, $a7, .LBB28_121
# %bb.112:                              # %if.end63.i
                                        #   in Loop: Header=BB28_107 Depth=1
	bltu	$t0, $t2, .LBB28_106
# %bb.113:                              # %if.end63.i
                                        #   in Loop: Header=BB28_107 Depth=1
	slli.d	$t2, $t2, 2
	ldx.w	$t2, $t1, $t2
...
.LBB28_118:                             # %for.end543.i
	...
	bnez	$a0, .LBB28_149
	b	.LBB28_151
.LBB28_119:                             # %if.end328.critedge.i
...
# %bb.124:                              # %if.then108.i
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB28_146
# %bb.125:                              # %for.cond114.preheader.i
	move	$s6, $a0
	st.d	$s8, $sp, 80                    # 8-byte Folded Spill
	beqz	$s5, .LBB28_135
# %bb.126:                              # %for.body117.lr.ph.i
	move	$fp, $zero
	addi.d	$s1, $s5, -1
	ori	$s2, $zero, 1
	ori	$s8, $zero, 144
...
.LBB28_127:                             # %if.then134.i
	...
	jirl	$ra, $ra, 0
	.p2align	4, , 16
.LBB28_128:                             # %if.end146.i
                                        #   in Loop: Header=BB28_129 Depth=1
	addi.d	$fp, $fp, 1
	bgeu	$fp, $s5, .LBB28_135
.LBB28_129:                             # %for.body117.i
                                        # =>This Loop Header: Depth=1
	...
	pcaddu18i	$ra, %call36(blobAddData)
	jirl	$ra, $ra, 0
	bgeu	$fp, $s1, .LBB28_128
# %bb.130:                              # %land.lhs.true123.i
                                        #   in Loop: Header=BB28_129 Depth=1
	add.d	$a0, $s3, $fp
	ld.bu	$a0, $a0, 1
	bne	$a0, $s8, .LBB28_128
...
# %bb.132:                              # %if.else136.i
	...
	jirl	$ra, $ra, 0
	beq	$s0, $s2, .LBB28_128
# %bb.133:                              # %while.body142.preheader.i
                                        #   in Loop: Header=BB28_129 Depth=1
	addi.d	$s0, $s0, 1
	.p2align	4, , 16
.LBB28_134:                             # %while.body142.i
	...
	jirl	$ra, $ra, 0
	addi.w	$s0, $s0, -1
	bltu	$s7, $s0, .LBB28_134
	b	.LBB28_128
.LBB28_135:                             # %cleanup152.i
	move	$a0, $s4
	pcaddu18i	$ra, %call36(blobDestroy)
	jirl	$ra, $ra, 0
	move	$a0, $s6
	...
	ld.d	$fp, $sp, 96                    # 8-byte Folded Reload
	beqz	$s5, .LBB28_143
.LBB28_136:                             # %if.end160.i
	ld.bu	$s1, $s3, 0
	bgeu	$s1, $s5, .LBB28_144
# %bb.137:                              # %if.end166.i
	addi.d	$a0, $s1, 1
	pcaddu18i	$ra, %call36(cli_malloc)
	jirl	$ra, $ra, 0
...
.LBB28_142:                             # %if.else155.i
	...
	ld.d	$fp, $sp, 96                    # 8-byte Folded Reload
	bnez	$s5, .LBB28_136
.LBB28_143:                             # %if.then159.i
	pcalau12i	$a0, %pc_hi20(.L.str.81)
	addi.d	$a0, $a0, %pc_lo12(.L.str.81)
	pcaddu18i	$ra, %call36(cli_warnmsg)
	jirl	$ra, $ra, 0
.LBB28_144:                             # %if.then165.i
	move	$a0, $fp
.LBB28_145:                             # %messageExport.specialized.2.exit
	...
	move	$a0, $s6
	b	.LBB28_147
.LBB28_146:                             # %cleanup152.thread.i
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(fileblobDestroy)
	jirl	$ra, $ra, 0
	move	$a0, $s4
.LBB28_147:                             # %messageExport.specialized.2.exit
	pcaddu18i	$ra, %call36(blobDestroy)
	jirl	$ra, $ra, 0
	move	$s4, $zero
...
.LBB28_151:                             # %if.end
	...
	addi.d	$sp, $sp, 1232
	ret
.LBB28_152:                             # %if.then173.i
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
	b	.LBB28_145
.LBB28_153:
	move	$s1, $s0
.LBB28_154:                             # %land.lhs.true265.i
	ld.d	$s4, $sp, 96                    # 8-byte Folded Reload
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	ld.d	$a1, $a0, 72
	beqz	$a1, .LBB28_156
...
# %bb.157:                              # %if.then273.i
	st.d	$zero, $s1, 104
.LBB28_158:                             # %if.end274.i
	ld.w	$a0, $s1, 16
	beqz	$a0, .LBB28_161
# %bb.159:                              # %if.end274.i
	ori	$a1, $zero, 1
	bne	$a0, $a1, .LBB28_19
# %bb.160:                              # %land.lhs.true282.i
	ld.d	$a0, $s1, 8
	ld.w	$a1, $a0, 0
	ori	$a2, $zero, 8
	ori	$a0, $zero, 1
	bne	$a1, $a2, .LBB28_19
.LBB28_161:                             # %if.then287.i
...
.Lfunc_end28:
	...
	.p2align	2, 0x0
.LJTI28_0:
	.word	.LBB28_114-.LJTI28_0
	.word	.LBB28_116-.LJTI28_0
	.word	.LBB28_105-.LJTI28_0
