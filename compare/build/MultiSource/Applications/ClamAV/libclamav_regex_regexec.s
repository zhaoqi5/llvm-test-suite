...
# %bb.21:                               # %for.body.lr.ph.i99
	...
	b	.LBB0_23
	.p2align	4, , 16
.LBB0_22:                               # %for.inc.i105
                                        #   in Loop: Header=BB0_23 Depth=1
	addi.d	$s2, $s2, 1
	addi.d	$s1, $s1, -1
	addi.d	$s7, $s7, -1
	beqz	$s1, .LBB0_105
.LBB0_23:                               # %for.body.i103
                                        # =>This Inner Loop Header: Depth=1
	ld.bu	$a0, $s2, 0
	bne	$a0, $s3, .LBB0_22
# %bb.24:                               # %land.lhs.true.i108
                                        #   in Loop: Header=BB0_23 Depth=1
	ld.w	$a2, $s4, 104
	blt	$s7, $a2, .LBB0_22
# %bb.25:                               # %land.lhs.true21.i113
                                        #   in Loop: Header=BB0_23 Depth=1
	move	$a0, $s2
	move	$a1, $fp
	pcaddu18i	$ra, %call36(bcmp)
...
.LBB0_125:                              # %if.then44.i.i
	...
	add.w	$a0, $a1, $a0
	blez	$a0, .LBB0_128
.LBB0_126:                              # %for.body.i.i89.preheader
                                        #   in Loop: Header=BB0_110 Depth=1
	addi.d	$s8, $a0, 1
	.p2align	4, , 16
.LBB0_127:                              # %for.body.i.i89
...
.LBB0_135:                              # %land.lhs.true76.i.i
	...
	maskeqz	$a0, $a3, $a0
	or	$s8, $a0, $a1
.LBB0_136:                              # %if.end87.i.i
                                        #   in Loop: Header=BB0_110 Depth=1
	ori	$a0, $zero, 128
	beq	$s4, $a0, .LBB0_140
# %bb.137:                              # %if.end87.land.lhs.true90_crit_edge.i.i
                                        #   in Loop: Header=BB0_110 Depth=1
	pcaddu18i	$ra, %call36(__ctype_b_loc)
	jirl	$ra, $ra, 0
	ld.d	$a0, $a0, 0
...
.LBB0_138:                              #   in Loop: Header=BB0_110 Depth=1
	move	$s8, $fp
	bnez	$a1, .LBB0_141
.LBB0_139:                              # %land.lhs.true90.i.i
                                        #   in Loop: Header=BB0_110 Depth=1
	ori	$a1, $zero, 95
	beq	$s4, $a1, .LBB0_141
.LBB0_140:                              # %if.end117.i.i
                                        #   in Loop: Header=BB0_110 Depth=1
	ori	$a4, $zero, 133
	beq	$s8, $a4, .LBB0_142
	b	.LBB0_143
	.p2align	4, , 16
.LBB0_141:                              # %land.lhs.true100.i.i
                                        #   in Loop: Header=BB0_110 Depth=1
	ori	$a4, $zero, 134
	ori	$a1, $zero, 130
	bne	$s8, $a1, .LBB0_146
.LBB0_142:                              # %if.then123.i.i
                                        #   in Loop: Header=BB0_110 Depth=1
	ld.d	$a0, $sp, 104
	move	$a1, $s2
	move	$a2, $s0
...
.LBB0_143:                              # %if.end126.i.i
	...
	ld.d	$fp, $sp, 88                    # 8-byte Folded Reload
	beq	$s5, $fp, .LBB0_149
# %bb.144:                              # %if.end126.i.i
                                        #   in Loop: Header=BB0_110 Depth=1
	ldx.bu	$a0, $s3, $s0
	bnez	$a0, .LBB0_149
# %bb.145:                              # %if.end134.i.i
                                        #   in Loop: Header=BB0_110 Depth=1
	ld.d	$a0, $sp, 104
	ld.d	$a2, $a0, 48
	...
	bne	$s5, $a0, .LBB0_113
	b	.LBB0_114
.LBB0_146:                              # %lor.lhs.false103.i.i
                                        #   in Loop: Header=BB0_110 Depth=1
	ori	$a1, $zero, 128
	beq	$s7, $a1, .LBB0_140
# %bb.147:                              # %land.lhs.true106.i.i
                                        #   in Loop: Header=BB0_110 Depth=1
	slli.d	$a1, $s7, 1
	ldx.hu	$a0, $a0, $a1
	andi	$a0, $a0, 8
	bnez	$a0, .LBB0_140
# %bb.148:                              # %land.lhs.true106.i.i
                                        #   in Loop: Header=BB0_110 Depth=1
	ori	$a0, $zero, 95
	bne	$s7, $a0, .LBB0_142
	b	.LBB0_140
.LBB0_149:                              # %lfast.exit.i
                                        #   in Loop: Header=BB0_110 Depth=1
	st.d	$s6, $sp, 152
	ldx.bu	$a0, $s3, $s0
	beqz	$a0, .LBB0_191
...
.LBB0_155:                              #   in Loop: Header=BB0_110 Depth=1
	move	$s3, $a0
	bne	$s4, $s1, .LBB0_157
# %bb.156:                              # %land.lhs.true102.i
                                        #   in Loop: Header=BB0_110 Depth=1
	ld.w	$a0, $s7, 120
	beqz	$a0, .LBB0_177
.LBB0_157:                              # %if.end106.i
                                        #   in Loop: Header=BB0_110 Depth=1
	ld.d	$a0, $sp, 120
	bnez	$a0, .LBB0_159
# %bb.158:                              # %if.end116.i
	...
	st.d	$a0, $sp, 120
	beqz	$a0, .LBB0_200
.LBB0_159:                              # %for.cond123.preheader.i
                                        #   in Loop: Header=BB0_110 Depth=1
	ld.d	$a1, $sp, 104
	ld.d	$a1, $a1, 112
	beqz	$a1, .LBB0_161
# %bb.160:                              # %for.body128.preheader.i
                                        #   in Loop: Header=BB0_110 Depth=1
	addi.d	$a0, $a0, 16
	addi.d	$a1, $a1, 1
	ori	$a3, $zero, 2
	...
	pcaddu18i	$ra, %call36(memset)
	jirl	$ra, $ra, 0
.LBB0_161:                              # %for.end137.i
                                        #   in Loop: Header=BB0_110 Depth=1
	ld.w	$a0, $s7, 120
	bnez	$a0, .LBB0_164
# %bb.162:                              # %land.lhs.true140.i
                                        #   in Loop: Header=BB0_110 Depth=1
	ld.bu	$a0, $sp, 113
	andi	$a0, $a0, 4
	bnez	$a0, .LBB0_164
...
# %bb.166:                              # %if.then154.i
	...
	ld.d	$a1, $s7, 128
	st.d	$a0, $sp, 160
.LBB0_167:                              # %if.end160.i
                                        #   in Loop: Header=BB0_110 Depth=1
	blez	$a1, .LBB0_169
# %bb.168:                              # %if.end160.i
                                        #   in Loop: Header=BB0_110 Depth=1
	beqz	$a0, .LBB0_199
.LBB0_169:                              # %if.end171.i
                                        #   in Loop: Header=BB0_110 Depth=1
	ld.d	$a1, $sp, 152
	addi.d	$a0, $sp, 104
	move	$a2, $s3
	...
	jirl	$ra, $ra, 0
.LBB0_170:                              # %if.end174.i
                                        #   in Loop: Header=BB0_110 Depth=1
	bnez	$a0, .LBB0_176
	.p2align	4, , 16
.LBB0_171:                              # %lor.lhs.false.i81
                                        #   Parent Loop BB0_110 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a1, $sp, 152
	bgeu	$a1, $s3, .LBB0_175
...
# %bb.173:                              # %if.end193.i
	...
	beqz	$a0, .LBB0_171
	b	.LBB0_176
.LBB0_174:                              #   in Loop: Header=BB0_110 Depth=1
	move	$s3, $zero
.LBB0_175:                              # %if.end200.i
                                        #   in Loop: Header=BB0_110 Depth=1
	addi.d	$s5, $a1, 1
	bne	$a1, $fp, .LBB0_110
.LBB0_176:                              # %for.end208.i
	beqz	$s4, .LBB0_182
.LBB0_177:                              # %if.end225.i
	ld.d	$a0, $sp, 152
	ld.d	$a1, $sp, 128
	sub.d	$a0, $a0, $a1
	ld.d	$a2, $sp, 24                    # 8-byte Folded Reload
	...
	st.d	$a0, $a2, 8
	bltu	$s4, $a1, .LBB0_182
# %bb.178:                              # %for.cond229.preheader.i
	ld.d	$a1, $sp, 120
	ld.d	$a0, $sp, 104
	addi.d	$a1, $a1, 16
	ld.d	$a2, $sp, 24                    # 8-byte Folded Reload
...
# %bb.181:                              # %if.then237.i
	...
	addi.d	$a2, $a2, 16
	bne	$s4, $a3, .LBB0_180
.LBB0_182:                              # %if.end250.i
	ld.d	$a0, $sp, 120
	beqz	$a0, .LBB0_184
# %bb.183:                              # %if.then254.i
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB0_184:                              # %if.end256.i
	ld.d	$a0, $sp, 160
	move	$fp, $zero
	move	$a1, $zero
	beqz	$a0, .LBB0_186
.LBB0_185:                              # %cleanup.sink.split.sink.split.i
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	move	$a1, $fp
.LBB0_186:                              # %cleanup.sink.split.i78
	ld.d	$a0, $sp, 176
	move	$fp, $a1
	b	.LBB0_197
.LBB0_187:
...
.LBB0_189:                              # %if.then44.i
	...
	ori	$fp, $zero, 1
	b	.LBB0_197
.LBB0_190:                              # %if.then128.i
	ld.d	$a0, $sp, 120
	ori	$fp, $zero, 12
	b	.LBB0_197
.LBB0_191:                              # %if.then80.i
	ld.d	$a0, $sp, 120
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 160
...
.LBB0_192:                              # %if.end184.thread.i
	...
	sub.d	$a0, $s6, $a0
	st.d	$a0, $a2, 8
.LBB0_193:                              # %if.end209.i
	ld.d	$a0, $sp, 120
	beqz	$a0, .LBB0_195
# %bb.194:                              # %if.then213.i
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB0_195:                              # %if.end215.i
	ld.d	$a1, $sp, 160
	move	$fp, $zero
	move	$a0, $zero
	beqz	$a1, .LBB0_198
# %bb.196:                              # %cleanup.sink.split.i
	move	$a0, $a1
.LBB0_197:                              # %cleanup
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
...
.LBB5_27:                               # %if.end78
	ori	$a0, $zero, 128
	beq	$s5, $a0, .LBB5_32
# %bb.28:                               # %if.end78.land.lhs.true81_crit_edge
	pcaddu18i	$ra, %call36(__ctype_b_loc)
	jirl	$ra, $ra, 0
	b	.LBB5_30
.LBB5_29:
	move	$s7, $s3
.LBB5_30:                               # %land.lhs.true81
	ld.d	$a0, $a0, 0
	slli.d	$a1, $s5, 1
	ldx.hu	$a1, $a0, $a1
	andi	$a1, $a1, 8
	bnez	$a1, .LBB5_33
# %bb.31:                               # %land.lhs.true81
	ori	$a1, $zero, 95
	beq	$s5, $a1, .LBB5_33
.LBB5_32:                               # %if.end108
	ori	$a4, $zero, 133
