...
# %bb.11:                               # %while.body.lr.ph
	addi.w	$a0, $s5, 0
	beqz	$a0, .LBB6_28
# %bb.12:                               # %while.body.lr.ph.split.us
	addi.w	$s4, $s4, 0
...
# %bb.13:
	...
	addi.d	$s2, $a0, %pc_lo12(.L.str.143)
	b	.LBB6_16
.LBB6_14:                               # %if.then85.us
...
.LBB6_27:                               # %sw.default105
	...
	addi.w	$s1, $zero, -3
	b	.LBB6_25
.LBB6_28:                               # %while.body.lr.ph.split
	vrepli.b	$vr0, 0
	addi.w	$s3, $s4, 0
	beqz	$s3, .LBB6_39
# %bb.29:
...
# %bb.33:                               # %if.then85
	...
	jirl	$ra, $ra, 0
	b	.LBB6_30
.LBB6_34:                               # %while.body.us.us.preheader
	vst	$vr0, $sp, 16                   # 16-byte Folded Spill
	pcalau12i	$a0, %pc_hi20(.L.str.143)
	addi.d	$s2, $a0, %pc_lo12(.L.str.143)
	b	.LBB6_36
	.p2align	4, , 16
.LBB6_35:                               # %if.end91.us.us
...
.LBB6_36:                               # %while.body.us.us
	...
	jirl	$ra, $ra, 0
	bnez	$a0, .LBB6_35
# %bb.37:                               # %if.then74.us.us
                                        #   in Loop: Header=BB6_36 Depth=1
	ld.d	$a2, $sp, 40
	bgeu	$s3, $a2, .LBB6_35
# %bb.38:                               # %if.then85.us.us
                                        #   in Loop: Header=BB6_36 Depth=1
	ld.w	$a1, $sp, 32
	move	$a0, $s2
	pcaddu18i	$ra, %call36(logg)
	...
	jirl	$ra, $ra, 0
	b	.LBB6_35
.LBB6_39:                               # %while.body.us38.preheader
	vst	$vr0, $sp, 16                   # 16-byte Folded Spill
	.p2align	4, , 16
.LBB6_40:                               # %while.body.us38
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $sp, 16                   # 16-byte Folded Reload
	vst	$vr0, $sp, 32
	addi.d	$a1, $sp, 32
...
.LBB6_47:                               # %if.end47
	pcalau12i	$a0, %got_pc_hi20(printinfected)
	ld.d	$s1, $a0, %got_pc_lo12(printinfected)
	ld.hu	$a0, $s1, 0
	beqz	$a0, .LBB6_53
# %bb.48:                               # %if.then49
