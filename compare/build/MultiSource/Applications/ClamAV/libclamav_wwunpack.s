...
# %bb.12:                               # %if.end53
	...
	b	.LBB0_14
	.p2align	4, , 16
.LBB0_13:                               # %while.condthread-pre-split.i
                                        #   in Loop: Header=BB0_14 Depth=2
	ld.w	$a2, $sp, 140
	ld.bu	$a3, $sp, 135
	move	$s4, $a1
.LBB0_14:                               # %while.cond.i
...
# %bb.61:                               # %if.then233.i
	...
	andi	$a4, $a1, 255
	beqz	$a4, .LBB0_93
# %bb.62:                               #   in Loop: Header=BB0_14 Depth=2
	slli.d	$a4, $a2, 1
	b	.LBB0_96
...
# %bb.72:                               # %if.end.i260.i
	...
	sub.d	$a1, $t1, $a1
	b	.LBB0_81
.LBB0_73:                               #   in Loop: Header=BB0_14 Depth=2
	move	$a4, $zero
	b	.LBB0_92
...
.LBB0_162:                              # %while.cond341.preheader.i
	...
	andi	$a2, $a1, 255
	beqz	$a2, .LBB0_164
# %bb.163:                              #   in Loop: Header=BB0_14 Depth=2
	slli.w	$a2, $a3, 1
	b	.LBB0_167
...
# %bb.168:                              # %while.cond341.1.i
	...
	andi	$a3, $a1, 255
	beqz	$a3, .LBB0_171
# %bb.169:                              #   in Loop: Header=BB0_14 Depth=2
	slli.w	$a4, $a2, 1
	b	.LBB0_174
.LBB0_170:                              #   in Loop: Header=BB0_14 Depth=2
	ori	$a3, $zero, 29
	ori	$a5, $zero, 5
	b	.LBB0_185
...
# %bb.175:                              # %while.cond341.2.i
	...
	andi	$a2, $a1, 255
	beqz	$a2, .LBB0_178
# %bb.176:                              #   in Loop: Header=BB0_14 Depth=2
	slli.d	$a2, $a4, 1
	b	.LBB0_181
.LBB0_177:                              #   in Loop: Header=BB0_14 Depth=2
	ori	$a3, $zero, 61
	ori	$a5, $zero, 6
	move	$a2, $a4
	b	.LBB0_185
...
# %bb.183:                              # %if.else380.if.end392_crit_edge.i
	...
	ld.w	$a0, $sp, 136
	b	.LBB0_196
.LBB0_184:                              #   in Loop: Header=BB0_14 Depth=2
	ori	$a3, $zero, 125
	ori	$a5, $zero, 7
...
# %bb.208:                              # %middle.block
	...
	bne	$a4, $a3, .LBB0_211
	b	.LBB0_13
.LBB0_209:                              #   in Loop: Header=BB0_14 Depth=2
	move	$a1, $s4
	b	.LBB0_211
.LBB0_210:                              #   in Loop: Header=BB0_14 Depth=2
	move	$a1, $s4
	.p2align	4, , 16
