...
.LBB10_26:                              # %numusearray.exit
	...
	b	.LBB10_30
	.p2align	4, , 16
.LBB10_27:                              #   in Loop: Header=BB10_30 Depth=2
	move	$a0, $zero
.LBB10_28:                              # %countint.exit.i
...
# %bb.32:                               # %if.then.i.i.i
	...
	fcmp.cune.d	$fcc0, $fa0, $fa1
	bcnez	$fcc0, .LBB10_27
# %bb.33:                               # %arrayindex.exit.i.i
                                        #   in Loop: Header=BB10_30 Depth=2
	addi.w	$a0, $a0, -1
	bstrpick.d	$a1, $a0, 31, 26
	bnez	$a1, .LBB10_27
# %bb.34:                               # %if.then.i.i130
                                        #   in Loop: Header=BB10_30 Depth=2
	pcaddu18i	$ra, %call36(luaO_log2)
	jirl	$ra, $ra, 0
	alsl.d	$a0, $a0, $s6, 2
	...
	b	.LBB10_28
	.p2align	4, , 16
.LBB10_35:                              # %numusehash.exit
                                        #   in Loop: Header=BB10_1 Depth=1
	ld.w	$a0, $s1, 8
	bne	$a0, $s3, .LBB10_39
# %bb.36:                               # %if.then.i.i112
                                        #   in Loop: Header=BB10_1 Depth=1
	fld.d	$fa0, $s1, 0
	ftintrz.w.d	$fa1, $fa0
	movfr2gr.s	$a0, $fa1
...
.LBB10_39:                              #   in Loop: Header=BB10_1 Depth=1
	...
	add.w	$a1, $a1, $a0
	blez	$a1, .LBB10_44
.LBB10_40:                              # %for.body.i106.preheader
                                        #   in Loop: Header=BB10_1 Depth=1
	move	$a6, $zero
	move	$a0, $zero
	move	$a2, $zero
...
.LBB10_50:                              #   in Loop: Header=BB10_1 Depth=1
	...
	ori	$s0, $zero, 1
	ld.d	$s2, $sp, 16                    # 8-byte Folded Reload
.LBB10_51:                              # %if.end9.i.sink.split
                                        #   in Loop: Header=BB10_1 Depth=1
	move	$a0, $s5
	pcaddu18i	$ra, %call36(luaG_runerror)
	jirl	$ra, $ra, 0
	b	.LBB10_1
.LBB10_52:                              # %for.body.i.i
                                        #   in Loop: Header=BB10_1 Depth=1
	movfr2gr.d	$a0, $fa0
	ld.bu	$a2, $fp, 11
	srli.d	$a1, $a0, 32
...
.LBB10_55:                              # %sw.bb3.i58
	...
	andn	$a3, $a4, $a3
	b	.LBB10_61
.LBB10_56:                              # %sw.default.i94
	ld.bu	$a3, $fp, 11
	ld.w	$a4, $a0, 16
.LBB10_57:                              # %mainposition.exit105
	sll.w	$a3, $s8, $a3
	ori	$a5, $zero, 1
	orn	$a3, $a5, $a3
	mod.wu	$a3, $a4, $a3
...
.LJTI10_1:
	.word	.LBB10_55-.LJTI10_1
	.word	.LBB10_56-.LJTI10_1
	.word	.LBB10_58-.LJTI10_1
	.word	.LBB10_60-.LJTI10_1
                                        # -- End function
	.text
...
# %bb.26:
	ori	$a6, $zero, 1
	ori	$a7, $zero, 3
	pcalau12i	$t0, %pc_hi20(luaO_nilobject_)
	addi.d	$t0, $t0, %pc_lo12(luaO_nilobject_)
	b	.LBB13_29
	.p2align	4, , 16
