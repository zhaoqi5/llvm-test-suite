...
# %bb.13:                               # %if.then.i.i.i118
	...
	pcaddu18i	$ra, %call36(luaX_syntaxerror)
	jirl	$ra, $ra, 0
.LBB2_14:                               # %str_checkname.exit.i122
                                        #   in Loop: Header=BB2_4 Depth=1
	ld.d	$s0, $fp, 24
	move	$a0, $fp
	pcaddu18i	$ra, %call36(luaX_next)
	...
	ld.w	$a0, $fp, 16
	beq	$a0, $s2, .LBB2_67
# %bb.15:                               # %str_checkname.exit.i122
                                        #   in Loop: Header=BB2_4 Depth=1
	ori	$a1, $zero, 267
	beq	$a0, $a1, .LBB2_67
# %bb.16:                               # %str_checkname.exit.i122
                                        #   in Loop: Header=BB2_4 Depth=1
	ori	$a1, $zero, 61
	bne	$a0, $a1, .LBB2_115
# %bb.17:                               # %sw.bb.i154
...
# %bb.25:                               # %if.then.i.i.i56
	...
	pcaddu18i	$ra, %call36(luaX_syntaxerror)
	jirl	$ra, $ra, 0
.LBB2_26:                               # %str_checkname.exit.i60
                                        #   in Loop: Header=BB2_4 Depth=1
	ld.d	$s0, $fp, 24
	move	$a0, $fp
	pcaddu18i	$ra, %call36(luaX_next)
...
# %bb.35:                               # %if.else.i99
	...
	ld.d	$s1, $s0, 40
	beqz	$s1, .LBB2_136
# %bb.36:                               # %land.rhs.i.i.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	move	$s3, $zero
	.p2align	4, , 16
.LBB2_37:                               # %land.rhs.i.i
                                        #   Parent Loop BB2_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.bu	$a0, $s1, 14
	bnez	$a0, .LBB2_138
# %bb.38:                               # %while.body.i.i102
...
# %bb.52:                               # %while.body.i218
	...
	jirl	$ra, $ra, 0
	b	.LBB2_48
.LBB2_53:                               # %while.cond.i.sink.split
                                        #   in Loop: Header=BB2_48 Depth=2
	ld.d	$s2, $fp, 56
	ori	$a1, $zero, 274
	move	$a0, $fp
...
.LBB2_58:                               # %sw.bb1.i
	...
	ld.w	$a0, $sp, 120
	bne	$a0, $s1, .LBB2_60
# %bb.59:                               # %if.then.i.i210
                                        #   in Loop: Header=BB2_4 Depth=1
	ori	$a0, $zero, 3
	st.w	$a0, $sp, 120
.LBB2_60:                               # %cond.exit.i167
                                        #   in Loop: Header=BB2_4 Depth=1
	ld.d	$a0, $fp, 48
	addi.d	$a1, $sp, 120
	pcaddu18i	$ra, %call36(luaK_goiftrue)
...
.LBB2_67:                               # %sw.bb2.i125
	...
	ld.w	$a0, $fp, 16
	bne	$a0, $s2, .LBB2_101
# %bb.68:                               # %while.body.i.i127.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	ori	$s0, $zero, 4
	b	.LBB2_70
	.p2align	4, , 16
...
.LBB2_72:                               # %if.else.i
	...
	b	.LBB2_74
	.p2align	4, , 16
.LBB2_73:                               # %do.body.ithread-pre-split
...
# %bb.77:                               # %if.then.i41
	...
	ori	$s1, $zero, 1
	bne	$a0, $s2, .LBB2_80
# %bb.78:                               # %while.body.i.i46.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	ori	$s1, $zero, 1
	.p2align	4, , 16
.LBB2_79:                               # %while.body.i.i46
                                        #   Parent Loop BB2_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$a0, $fp
	pcaddu18i	$ra, %call36(luaX_next)
...
.LBB2_103:                              # %checknext.exit263
	...
	ori	$s1, $zero, 1
	bne	$a0, $s2, .LBB2_106
# %bb.104:                              # %while.body.i253.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	ori	$s1, $zero, 1
	.p2align	4, , 16
.LBB2_105:                              # %while.body.i253
                                        #   Parent Loop BB2_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$a0, $fp
	pcaddu18i	$ra, %call36(luaX_next)
...
.LBB2_117:                              # %vector.body518
	...
	addi.d	$a7, $a7, -4
	bnez	$t0, .LBB2_117
# %bb.118:                              # %middle.block522
                                        #   in Loop: Header=BB2_4 Depth=1
	beq	$a5, $a6, .LBB2_121
.LBB2_119:                              # %while.body.i.i317.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_120:                              # %while.body.i.i317
                                        #   Parent Loop BB2_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
	...
	addi.d	$a5, $a5, -2
	bltu	$a2, $a4, .LBB2_120
.LBB2_121:                              # %while.cond.while.end_crit_edge.i.i
                                        #   in Loop: Header=BB2_4 Depth=1
	st.b	$a4, $a0, 74
...
.LBB2_124:                              # %leaveblock.exit
	...
	ori	$s2, $zero, 44
	bgeu	$a2, $a7, .LBB2_133
# %bb.125:                              # %while.body.lr.ph.i.i.i198
                                        #   in Loop: Header=BB2_4 Depth=1
	ld.d	$a3, $a0, 0
	ld.w	$a1, $a0, 48
	ld.d	$a3, $a3, 48
...
.LBB2_128:                              # %vector.body506
	...
	addi.d	$a7, $a7, -4
	bnez	$t0, .LBB2_128
# %bb.129:                              # %middle.block510
                                        #   in Loop: Header=BB2_4 Depth=1
	beq	$a5, $a6, .LBB2_132
.LBB2_130:                              # %while.body.i.i.i202.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_131:                              # %while.body.i.i.i202
                                        #   Parent Loop BB2_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
	...
	addi.d	$a5, $a5, -2
	bltu	$a2, $a4, .LBB2_131
.LBB2_132:                              # %while.cond.while.end_crit_edge.i.i.i209
                                        #   in Loop: Header=BB2_4 Depth=1
	st.b	$a4, $a0, 74
.LBB2_133:                              # %removevars.exit.i.i190
                                        #   in Loop: Header=BB2_4 Depth=1
	ld.bu	$a0, $s0, 13
	beqz	$a0, .LBB2_135
# %bb.134:                              # %if.then.i13.i192
                                        #   in Loop: Header=BB2_4 Depth=1
	ori	$a1, $zero, 35
	move	$a0, $s5
	move	$a3, $zero
...
.LBB2_140:                              # %breakstat.exit.i
	...
	ori	$s1, $zero, 1
	bgeu	$a2, $a7, .LBB2_149
# %bb.141:                              # %while.body.lr.ph.i.i51.i
                                        #   in Loop: Header=BB2_4 Depth=1
	ld.d	$a3, $a0, 0
	ld.w	$a1, $a0, 48
	ld.d	$a3, $a3, 48
...
.LBB2_144:                              # %vector.body566
	...
	addi.d	$a7, $a7, -4
	bnez	$t0, .LBB2_144
# %bb.145:                              # %middle.block570
                                        #   in Loop: Header=BB2_4 Depth=1
	beq	$a5, $a6, .LBB2_148
.LBB2_146:                              # %while.body.i.i55.i.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_147:                              # %while.body.i.i55.i
                                        #   Parent Loop BB2_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
	...
	addi.d	$a5, $a5, -2
	bltu	$a2, $a4, .LBB2_147
.LBB2_148:                              # %while.cond.while.end_crit_edge.i.i62.i
                                        #   in Loop: Header=BB2_4 Depth=1
	st.b	$a4, $a0, 74
.LBB2_149:                              # %removevars.exit.i41.i
                                        #   in Loop: Header=BB2_4 Depth=1
	ld.bu	$a0, $s0, 13
	beqz	$a0, .LBB2_151
# %bb.150:                              # %if.then.i44.i
                                        #   in Loop: Header=BB2_4 Depth=1
	ori	$a1, $zero, 35
	move	$a0, $s5
	move	$a3, $zero
...
.LBB2_152:                              # %if.end.i50
	...
	ori	$s1, $zero, 1
	beqz	$a0, .LBB2_154
# %bb.153:                              # %if.then12.i.i
                                        #   in Loop: Header=BB2_4 Depth=1
	addi.d	$a1, $sp, 120
	move	$a0, $s0
	pcaddu18i	$ra, %call36(luaK_exp2nextreg)
	jirl	$ra, $ra, 0
.LBB2_154:                              # %if.end13.i.i
                                        #   in Loop: Header=BB2_4 Depth=1
	blez	$s5, .LBB2_156
.LBB2_155:                              # %if.then15.i.i
                                        #   in Loop: Header=BB2_4 Depth=1
	ld.w	$s1, $s0, 60
	move	$a0, $s0
	move	$a1, $s5
...
.LBB2_159:                              # %vector.body578
	...
	addi.d	$a7, $a7, 8
	bnez	$t0, .LBB2_159
# %bb.160:                              # %middle.block582
                                        #   in Loop: Header=BB2_4 Depth=1
	beq	$a6, $a5, .LBB2_163
.LBB2_161:                              # %for.body.i.i.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	slli.d	$a5, $a2, 1
	sub.d	$a3, $a3, $a5
	andi	$a4, $a4, 255
...
.LBB2_166:                              # %sw.epilog.i
	...
	ld.bu	$a7, $a0, 74
	bgeu	$a2, $a7, .LBB2_202
# %bb.167:                              # %while.body.lr.ph.i.i.i142
                                        #   in Loop: Header=BB2_4 Depth=1
	ld.d	$a3, $a0, 0
	ld.w	$a1, $a0, 48
	ld.d	$a3, $a3, 48
...
.LBB2_170:                              # %vector.body530
	...
	addi.d	$a7, $a7, -4
	bnez	$t0, .LBB2_170
# %bb.171:                              # %middle.block534
                                        #   in Loop: Header=BB2_4 Depth=1
	beq	$a5, $a6, .LBB2_201
.LBB2_172:                              # %while.body.i.i.i146.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_173:                              # %while.body.i.i.i146
                                        #   Parent Loop BB2_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
...
# %bb.176:                              # %middle.block
                                        #   in Loop: Header=BB2_4 Depth=1
	beq	$a5, $a6, .LBB2_179
.LBB2_177:                              # %while.body.i.i345.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_178:                              # %while.body.i.i345
                                        #   Parent Loop BB2_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
	...
	addi.d	$a5, $a5, -2
	bltu	$a2, $a4, .LBB2_178
.LBB2_179:                              # %while.cond.while.end_crit_edge.i.i352
                                        #   in Loop: Header=BB2_4 Depth=1
	st.b	$a4, $a0, 74
.LBB2_180:                              # %removevars.exit.i331
                                        #   in Loop: Header=BB2_4 Depth=1
	ld.bu	$a0, $s1, 13
	beqz	$a0, .LBB2_182
# %bb.181:                              # %if.then.i334
...
.LBB2_185:                              # %vector.body554
	...
	addi.d	$a7, $a7, -4
	bnez	$t0, .LBB2_185
# %bb.186:                              # %middle.block558
                                        #   in Loop: Header=BB2_4 Depth=1
	beq	$a5, $a6, .LBB2_189
.LBB2_187:                              # %while.body.i.i.i.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_188:                              # %while.body.i.i.i
                                        #   Parent Loop BB2_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
	...
	addi.d	$a5, $a5, -2
	bltu	$a2, $a4, .LBB2_188
.LBB2_189:                              # %while.cond.while.end_crit_edge.i.i.i
                                        #   in Loop: Header=BB2_4 Depth=1
	st.b	$a4, $a0, 74
...
.LBB2_193:                              # %if.end.i101
	...
	ori	$s2, $zero, 44
	bgeu	$a2, $a7, .LBB2_202
# %bb.194:                              # %while.body.lr.ph.i.i82.i
                                        #   in Loop: Header=BB2_4 Depth=1
	ld.d	$a3, $a0, 0
	ld.w	$a1, $a0, 48
	ld.d	$a3, $a3, 48
...
.LBB2_197:                              # %vector.body542
	...
	addi.d	$a7, $a7, -4
	bnez	$t0, .LBB2_197
# %bb.198:                              # %middle.block546
                                        #   in Loop: Header=BB2_4 Depth=1
	beq	$a5, $a6, .LBB2_201
.LBB2_199:                              # %while.body.i.i86.i.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_200:                              # %while.body.i.i86.i
                                        #   Parent Loop BB2_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
	...
	addi.d	$a5, $a5, -2
	bltu	$a2, $a4, .LBB2_200
.LBB2_201:                              # %while.cond.while.end_crit_edge.i.i.i153
                                        #   in Loop: Header=BB2_4 Depth=1
	st.b	$a4, $a0, 74
.LBB2_202:                              # %removevars.exit.i.i138
                                        #   in Loop: Header=BB2_4 Depth=1
	ld.bu	$a0, $s0, 13
	beqz	$a0, .LBB2_204
# %bb.203:                              # %if.then.i22.i
                                        #   in Loop: Header=BB2_4 Depth=1
	ori	$a1, $zero, 35
	move	$a0, $s5
	move	$a3, $zero
...
# %bb.208:                              # %if.then.i13
	...
	jirl	$ra, $ra, 0
	b	.LBB2_3
.LBB2_209:                              # %while.body.i.i.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	ori	$s4, $zero, 1
	ori	$s2, $zero, 44
	.p2align	4, , 16
.LBB2_210:                              # %while.body.i.i
                                        #   Parent Loop BB2_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$a0, $fp
	pcaddu18i	$ra, %call36(luaX_next)
...
.LBB18_12:                              # %for.body.i29
	...
	addi.d	$a1, $a1, 2
	bnez	$a3, .LBB18_12
.LBB18_13:                              # %adjustlocalvars.exit37
	move	$a0, $fp
	move	$a1, $s2
	pcaddu18i	$ra, %call36(luaK_reserveregs)
	jirl	$ra, $ra, 0
...
.LBB18_17:                              # %vector.body92
	...
	addi.d	$a7, $a7, -4
	bnez	$t0, .LBB18_17
# %bb.18:                               # %middle.block96
	beq	$a5, $a6, .LBB18_21
.LBB18_19:                              # %while.body.i.i64.preheader
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB18_20:                              # %while.body.i.i64
                                        # =>This Inner Loop Header: Depth=1
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
	alsl.d	$a6, $a6, $a3, 4
	...
	addi.d	$a5, $a5, -2
	bltu	$a2, $a4, .LBB18_20
.LBB18_21:                              # %while.cond.while.end_crit_edge.i.i71
	st.b	$a4, $a0, 74
.LBB18_22:                              # %removevars.exit.i51
	ld.bu	$a0, $s5, 13
	beqz	$a0, .LBB18_24
# %bb.23:                               # %if.then.i54
	ori	$a1, $zero, 35
