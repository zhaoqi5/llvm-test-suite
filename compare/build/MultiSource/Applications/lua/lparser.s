...
# %bb.14:                               # %if.then.i.i.i118
	...
	pcaddu18i	$ra, %call36(luaX_syntaxerror)
	jirl	$ra, $ra, 0
.LBB2_15:                               # %str_checkname.exit.i122
                                        #   in Loop: Header=BB2_5 Depth=1
	ld.d	$s0, $fp, 24
	move	$a0, $fp
	pcaddu18i	$ra, %call36(luaX_next)
...
.LBB2_59:                               # %sw.bb1.i
	...
	ld.w	$a0, $sp, 104
	bne	$a0, $s2, .LBB2_61
# %bb.60:                               # %if.then.i.i210
                                        #   in Loop: Header=BB2_5 Depth=1
	st.w	$s1, $sp, 104
.LBB2_61:                               # %cond.exit.i167
                                        #   in Loop: Header=BB2_5 Depth=1
	ld.d	$a0, $fp, 48
	addi.d	$a1, $sp, 104
	pcaddu18i	$ra, %call36(luaK_goiftrue)
...
.LBB2_68:                               # %sw.bb2.i125
	...
	ori	$s2, $zero, 44
	bne	$a0, $s2, .LBB2_101
# %bb.69:                               # %while.body.i.i127.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	ori	$s0, $zero, 4
	b	.LBB2_71
	.p2align	4, , 16
...
.LBB2_118:                              # %vector.body518
	...
	addi.d	$a7, $a7, -4
	bnez	$t0, .LBB2_118
# %bb.119:                              # %middle.block522
                                        #   in Loop: Header=BB2_5 Depth=1
	beq	$a5, $a6, .LBB2_122
.LBB2_120:                              # %while.body.i.i317.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_121:                              # %while.body.i.i317
                                        #   Parent Loop BB2_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
...
.LBB2_125:                              # %leaveblock.exit
	...
	ori	$s1, $zero, 3
	bgeu	$a2, $a7, .LBB2_134
# %bb.126:                              # %while.body.lr.ph.i.i.i198
                                        #   in Loop: Header=BB2_5 Depth=1
	ld.d	$a3, $a0, 0
	ld.w	$a1, $a0, 48
	ld.d	$a3, $a3, 48
...
.LBB2_129:                              # %vector.body506
	...
	addi.d	$a7, $a7, -4
	bnez	$t0, .LBB2_129
# %bb.130:                              # %middle.block510
                                        #   in Loop: Header=BB2_5 Depth=1
	beq	$a5, $a6, .LBB2_133
.LBB2_131:                              # %while.body.i.i.i202.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_132:                              # %while.body.i.i.i202
                                        #   Parent Loop BB2_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
	...
	addi.d	$a5, $a5, -2
	bltu	$a2, $a4, .LBB2_132
.LBB2_133:                              # %while.cond.while.end_crit_edge.i.i.i209
                                        #   in Loop: Header=BB2_5 Depth=1
	st.b	$a4, $a0, 74
.LBB2_134:                              # %removevars.exit.i.i190
                                        #   in Loop: Header=BB2_5 Depth=1
	ld.bu	$a0, $s0, 13
	beqz	$a0, .LBB2_136
# %bb.135:                              # %if.then.i13.i192
                                        #   in Loop: Header=BB2_5 Depth=1
	ori	$a1, $zero, 35
	move	$a0, $s5
	move	$a3, $zero
...
.LBB2_148:                              # %while.body.i.i55.i
	...
	addi.d	$a5, $a5, -2
	bltu	$a2, $a4, .LBB2_148
.LBB2_149:                              # %while.cond.while.end_crit_edge.i.i62.i
                                        #   in Loop: Header=BB2_5 Depth=1
	st.b	$a4, $a0, 74
...
.LBB2_167:                              # %sw.epilog.i
	...
	ld.bu	$a7, $a0, 74
	bgeu	$a2, $a7, .LBB2_203
# %bb.168:                              # %while.body.lr.ph.i.i.i142
                                        #   in Loop: Header=BB2_5 Depth=1
	ld.d	$a3, $a0, 0
	ld.w	$a1, $a0, 48
	ld.d	$a3, $a3, 48
...
.LBB2_171:                              # %vector.body530
	...
	addi.d	$a7, $a7, -4
	bnez	$t0, .LBB2_171
# %bb.172:                              # %middle.block534
                                        #   in Loop: Header=BB2_5 Depth=1
	beq	$a5, $a6, .LBB2_202
.LBB2_173:                              # %while.body.i.i.i146.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_174:                              # %while.body.i.i.i146
                                        #   Parent Loop BB2_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
...
# %bb.177:                              # %middle.block
                                        #   in Loop: Header=BB2_5 Depth=1
	beq	$a5, $a6, .LBB2_180
.LBB2_178:                              # %while.body.i.i345.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_179:                              # %while.body.i.i345
                                        #   Parent Loop BB2_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
	...
	addi.d	$a5, $a5, -2
	bltu	$a2, $a4, .LBB2_179
.LBB2_180:                              # %while.cond.while.end_crit_edge.i.i352
                                        #   in Loop: Header=BB2_5 Depth=1
	st.b	$a4, $a0, 74
.LBB2_181:                              # %removevars.exit.i331
                                        #   in Loop: Header=BB2_5 Depth=1
	ld.bu	$a0, $s1, 13
	beqz	$a0, .LBB2_183
# %bb.182:                              # %if.then.i334
...
.LBB2_194:                              # %if.end.i101
	...
	ori	$s6, $zero, 19
	bgeu	$a2, $a7, .LBB2_203
# %bb.195:                              # %while.body.lr.ph.i.i82.i
                                        #   in Loop: Header=BB2_5 Depth=1
	ld.d	$a3, $a0, 0
	ld.w	$a1, $a0, 48
	ld.d	$a3, $a3, 48
...
.LBB2_198:                              # %vector.body542
	...
	addi.d	$a7, $a7, -4
	bnez	$t0, .LBB2_198
# %bb.199:                              # %middle.block546
                                        #   in Loop: Header=BB2_5 Depth=1
	beq	$a5, $a6, .LBB2_202
.LBB2_200:                              # %while.body.i.i86.i.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	alsl.d	$a5, $a4, $a0, 1
	addi.d	$a5, $a5, 194
	.p2align	4, , 16
.LBB2_201:                              # %while.body.i.i86.i
                                        #   Parent Loop BB2_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.hu	$a6, $a5, 0
	addi.d	$a4, $a4, -1
	...
	addi.d	$a5, $a5, -2
	bltu	$a2, $a4, .LBB2_201
.LBB2_202:                              # %while.cond.while.end_crit_edge.i.i.i153
                                        #   in Loop: Header=BB2_5 Depth=1
	st.b	$a4, $a0, 74
.LBB2_203:                              # %removevars.exit.i.i138
                                        #   in Loop: Header=BB2_5 Depth=1
	ld.bu	$a0, $s0, 13
	beqz	$a0, .LBB2_205
