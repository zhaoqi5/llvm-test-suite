...
# %bb.39:                               # %middle.block
	beq	$a1, $s1, .LBB1_42
.LBB1_40:                               # %for.body.i.preheader188
	alsl.d	$a0, $a1, $a0, 4
	addi.d	$a0, $a0, 8
	sub.d	$a1, $s1, $a1
	.p2align	4, , 16
...
# %bb.46:                               # %if.then.i.i127
	...
	pcaddu18i	$ra, %call36(luaD_throw)
	jirl	$ra, $ra, 0
.LBB1_47:                               # %LoadChar.exit132
                                        #   in Loop: Header=BB1_45 Depth=1
	ld.bu	$a0, $sp, 39
	bltu	$s7, $a0, .LBB1_56
# %bb.48:                               # %LoadChar.exit132
                                        #   in Loop: Header=BB1_45 Depth=1
	slli.d	$a0, $a0, 2
	ldx.w	$a0, $s6, $a0
	add.d	$a0, $s6, $a0
...
.LBB1_56:                               # %sw.default.i
	...
	jirl	$ra, $ra, 0
	b	.LBB1_44
.LBB1_57:                               # %vector.ph179
	bstrpick.d	$a1, $s1, 30, 1
	slli.d	$a1, $a1, 1
	addi.d	$a2, $a0, 16
	move	$a3, $a1
	.p2align	4, , 16
.LBB1_58:                               # %vector.body182
                                        # =>This Inner Loop Header: Depth=1
	st.d	$zero, $a2, -16
	st.d	$zero, $a2, 0
	addi.d	$a3, $a3, -2
