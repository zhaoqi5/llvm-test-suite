...
.LBB9_95:                               # %sw.bb109
	...
	st.w	$a2, $a0, 8
	blt	$a2, $a3, .LBB9_6
# %bb.96:                               # %land.lhs.true125
                                        #   in Loop: Header=BB9_6 Depth=2
	ld.d	$a2, $s3, 0
	ld.bu	$a0, $a2, 9
	andi	$a0, $a0, 3
	beqz	$a0, .LBB9_6
# %bb.97:                               # %land.lhs.true130
                                        #   in Loop: Header=BB9_6 Depth=2
	ld.bu	$a0, $a1, 9
	andi	$a0, $a0, 4
	beqz	$a0, .LBB9_6
...
.LBB9_99:                               # %sw.bb1047
	...
	ori	$s0, $zero, 3
	beq	$a0, $s0, .LBB9_103
# %bb.100:                              # %lor.lhs.false1054
                                        #   in Loop: Header=BB9_6 Depth=2
	ori	$a1, $zero, 4
	bne	$a0, $a1, .LBB9_2
# %bb.101:                              # %land.lhs.true.i599
                                        #   in Loop: Header=BB9_6 Depth=2
	ld.d	$a0, $s3, 0
	addi.d	$a0, $a0, 24
	addi.d	$a1, $sp, 56
...
# %bb.102:                              # %luaV_tonumber.exit.thread
	...
	ori	$a0, $zero, 3
	st.w	$a0, $s3, 8
.LBB9_103:                              # %if.else1059
                                        #   in Loop: Header=BB9_6 Depth=2
	ld.w	$a0, $s3, 24
	beq	$a0, $s0, .LBB9_107
# %bb.104:                              # %lor.lhs.false1063
                                        #   in Loop: Header=BB9_6 Depth=2
	ori	$a1, $zero, 4
	bne	$a0, $a1, .LBB9_181
# %bb.105:                              # %land.lhs.true.i606
                                        #   in Loop: Header=BB9_6 Depth=2
	ld.d	$a0, $s3, 16
	addi.d	$a0, $a0, 24
	addi.d	$a1, $sp, 56
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB9_181
# %bb.106:                              # %luaV_tonumber.exit614.thread
                                        #   in Loop: Header=BB9_6 Depth=2
	fld.d	$fa0, $sp, 56
	fst.d	$fa0, $s3, 16
	ori	$a0, $zero, 3
	st.w	$a0, $s3, 24
.LBB9_107:                              # %if.else1069
                                        #   in Loop: Header=BB9_6 Depth=2
	ld.w	$a0, $s3, 40
	ori	$a1, $zero, 3
	beq	$a0, $a1, .LBB9_4
# %bb.108:                              # %lor.lhs.false1073
                                        #   in Loop: Header=BB9_6 Depth=2
	ori	$a1, $zero, 4
	bne	$a0, $a1, .LBB9_212
# %bb.109:                              # %land.lhs.true.i617
                                        #   in Loop: Header=BB9_6 Depth=2
	ld.d	$a0, $s3, 32
	addi.d	$a0, $a0, 24
	addi.d	$a1, $sp, 56
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB9_212
# %bb.110:                              # %luaV_tonumber.exit625.thread
                                        #   in Loop: Header=BB9_6 Depth=2
	fld.d	$fa0, $sp, 56
	fst.d	$fa0, $s3, 32
	ori	$a0, $zero, 3
...
.LBB9_142:                              # %lessequal.exit
	...
	beq	$a0, $s5, .LBB9_55
	b	.LBB9_56
.LBB9_143:                              # %cond.false1027
                                        #   in Loop: Header=BB9_6 Depth=2
	fcmp.cult.d	$fcc0, $fa0, $fa1
	bcnez	$fcc0, .LBB9_6
.LBB9_144:                              # %if.then1030
                                        #   in Loop: Header=BB9_6 Depth=2
	lu12i.w	$a0, -4
	lu32i.d	$a0, 0
	and	$a0, $s4, $a0
