...
.LBB13_138:                             # %vec.epilog.ph252
	...
	b	.LBB13_140
	.p2align	4, , 16
.LBB13_139:                             # %pred.store.continue293
                                        #   in Loop: Header=BB13_140 Depth=1
	addi.d	$a7, $a7, 16
	addi.d	$a4, $a4, -16
	beqz	$a7, .LBB13_178
.LBB13_140:                             # %vec.epilog.vector.body257
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a4, -8
	vshuf4i.w	$vr1, $vr1, 27
	vshuf4i.b	$vr1, $vr1, 27
	...
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_156
# %bb.141:                              # %pred.store.continue263
                                        #   in Loop: Header=BB13_140 Depth=1
	vpickve2gr.b	$t0, $vr1, 1
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_157
.LBB13_142:                             # %pred.store.continue265
                                        #   in Loop: Header=BB13_140 Depth=1
	vpickve2gr.b	$t0, $vr1, 2
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_158
.LBB13_143:                             # %pred.store.continue267
                                        #   in Loop: Header=BB13_140 Depth=1
	vpickve2gr.b	$t0, $vr1, 3
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_159
.LBB13_144:                             # %pred.store.continue269
                                        #   in Loop: Header=BB13_140 Depth=1
	vpickve2gr.b	$t0, $vr1, 4
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_160
.LBB13_145:                             # %pred.store.continue271
                                        #   in Loop: Header=BB13_140 Depth=1
	vpickve2gr.b	$t0, $vr1, 5
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_161
.LBB13_146:                             # %pred.store.continue273
                                        #   in Loop: Header=BB13_140 Depth=1
	vpickve2gr.b	$t0, $vr1, 6
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_162
.LBB13_147:                             # %pred.store.continue275
                                        #   in Loop: Header=BB13_140 Depth=1
	vpickve2gr.b	$t0, $vr1, 7
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_163
.LBB13_148:                             # %pred.store.continue277
                                        #   in Loop: Header=BB13_140 Depth=1
	vpickve2gr.b	$t0, $vr1, 8
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_164
.LBB13_149:                             # %pred.store.continue279
                                        #   in Loop: Header=BB13_140 Depth=1
	vpickve2gr.b	$t0, $vr1, 9
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_165
.LBB13_150:                             # %pred.store.continue281
                                        #   in Loop: Header=BB13_140 Depth=1
	vpickve2gr.b	$t0, $vr1, 10
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_166
.LBB13_151:                             # %pred.store.continue283
                                        #   in Loop: Header=BB13_140 Depth=1
	vpickve2gr.b	$t0, $vr1, 11
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_167
.LBB13_152:                             # %pred.store.continue285
                                        #   in Loop: Header=BB13_140 Depth=1
	vpickve2gr.b	$t0, $vr1, 12
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_168
.LBB13_153:                             # %pred.store.continue287
                                        #   in Loop: Header=BB13_140 Depth=1
	vpickve2gr.b	$t0, $vr1, 13
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_169
.LBB13_154:                             # %pred.store.continue289
                                        #   in Loop: Header=BB13_140 Depth=1
	vpickve2gr.b	$t0, $vr1, 14
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_170
.LBB13_155:                             # %pred.store.continue291
                                        #   in Loop: Header=BB13_140 Depth=1
	...
	b	.LBB13_171
	.p2align	4, , 16
.LBB13_156:                             # %pred.store.if262
                                        #   in Loop: Header=BB13_140 Depth=1
	st.b	$a1, $a4, 7
	vpickve2gr.b	$t0, $vr1, 1
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_142
.LBB13_157:                             # %pred.store.if264
                                        #   in Loop: Header=BB13_140 Depth=1
	st.b	$a1, $a4, 6
	vpickve2gr.b	$t0, $vr1, 2
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_143
.LBB13_158:                             # %pred.store.if266
                                        #   in Loop: Header=BB13_140 Depth=1
	st.b	$a1, $a4, 5
	vpickve2gr.b	$t0, $vr1, 3
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_144
.LBB13_159:                             # %pred.store.if268
                                        #   in Loop: Header=BB13_140 Depth=1
	st.b	$a1, $a4, 4
	vpickve2gr.b	$t0, $vr1, 4
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_145
.LBB13_160:                             # %pred.store.if270
                                        #   in Loop: Header=BB13_140 Depth=1
	st.b	$a1, $a4, 3
	vpickve2gr.b	$t0, $vr1, 5
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_146
.LBB13_161:                             # %pred.store.if272
                                        #   in Loop: Header=BB13_140 Depth=1
	st.b	$a1, $a4, 2
	vpickve2gr.b	$t0, $vr1, 6
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_147
.LBB13_162:                             # %pred.store.if274
                                        #   in Loop: Header=BB13_140 Depth=1
	st.b	$a1, $a4, 1
	vpickve2gr.b	$t0, $vr1, 7
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_148
.LBB13_163:                             # %pred.store.if276
                                        #   in Loop: Header=BB13_140 Depth=1
	st.b	$a1, $a4, 0
	vpickve2gr.b	$t0, $vr1, 8
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_149
.LBB13_164:                             # %pred.store.if278
                                        #   in Loop: Header=BB13_140 Depth=1
	st.b	$a1, $a4, -1
	vpickve2gr.b	$t0, $vr1, 9
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_150
.LBB13_165:                             # %pred.store.if280
                                        #   in Loop: Header=BB13_140 Depth=1
	st.b	$a1, $a4, -2
	vpickve2gr.b	$t0, $vr1, 10
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_151
.LBB13_166:                             # %pred.store.if282
                                        #   in Loop: Header=BB13_140 Depth=1
	st.b	$a1, $a4, -3
	vpickve2gr.b	$t0, $vr1, 11
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_152
.LBB13_167:                             # %pred.store.if284
                                        #   in Loop: Header=BB13_140 Depth=1
	st.b	$a1, $a4, -4
	vpickve2gr.b	$t0, $vr1, 12
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_153
.LBB13_168:                             # %pred.store.if286
                                        #   in Loop: Header=BB13_140 Depth=1
	st.b	$a1, $a4, -5
	vpickve2gr.b	$t0, $vr1, 13
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_154
.LBB13_169:                             # %pred.store.if288
                                        #   in Loop: Header=BB13_140 Depth=1
	st.b	$a1, $a4, -6
	vpickve2gr.b	$t0, $vr1, 14
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_155
.LBB13_170:                             # %pred.store.if290
                                        #   in Loop: Header=BB13_140 Depth=1
	st.b	$a1, $a4, -7
	vpickve2gr.b	$t0, $vr1, 15
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_139
.LBB13_171:                             # %pred.store.if292
                                        #   in Loop: Header=BB13_140 Depth=1
	st.b	$a1, $a4, -8
	b	.LBB13_139
...
# %bb.177:                              # %if.then.i
	...
	stx.b	$a1, $a0, $a4
	b	.LBB13_175
.LBB13_178:                             # %vec.epilog.middle.block295
	beq	$a3, $a6, .LBB13_246
	b	.LBB13_289
...
# %bb.250:
	move	$a4, $a2
	b	.LBB13_365
.LBB13_251:                             # %vector.main.loop.iter.check303
	ori	$a3, $zero, 32
	bgeu	$a2, $a3, .LBB13_294
# %bb.252:
	move	$a3, $zero
.LBB13_253:                             # %vec.epilog.ph384
	move	$a5, $a2
	bstrins.d	$a5, $zero, 3, 0
	andi	$a4, $a2, 15
	vreplgr2vr.b	$vr0, $a0
	...
	b	.LBB13_255
	.p2align	4, , 16
.LBB13_254:                             # %pred.store.continue425
                                        #   in Loop: Header=BB13_255 Depth=1
	addi.d	$a6, $a6, 16
	addi.d	$a3, $a3, -16
	beqz	$a6, .LBB13_293
.LBB13_255:                             # %vec.epilog.vector.body389
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a3, -8
	vshuf4i.w	$vr1, $vr1, 27
	vshuf4i.b	$vr1, $vr1, 27
	...
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_271
# %bb.256:                              # %pred.store.continue395
                                        #   in Loop: Header=BB13_255 Depth=1
	vpickve2gr.b	$t0, $vr1, 1
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_272
.LBB13_257:                             # %pred.store.continue397
                                        #   in Loop: Header=BB13_255 Depth=1
	vpickve2gr.b	$t0, $vr1, 2
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_273
.LBB13_258:                             # %pred.store.continue399
                                        #   in Loop: Header=BB13_255 Depth=1
	vpickve2gr.b	$t0, $vr1, 3
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_274
.LBB13_259:                             # %pred.store.continue401
                                        #   in Loop: Header=BB13_255 Depth=1
	vpickve2gr.b	$t0, $vr1, 4
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_275
.LBB13_260:                             # %pred.store.continue403
                                        #   in Loop: Header=BB13_255 Depth=1
	vpickve2gr.b	$t0, $vr1, 5
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_276
.LBB13_261:                             # %pred.store.continue405
                                        #   in Loop: Header=BB13_255 Depth=1
	vpickve2gr.b	$t0, $vr1, 6
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_277
.LBB13_262:                             # %pred.store.continue407
                                        #   in Loop: Header=BB13_255 Depth=1
	vpickve2gr.b	$t0, $vr1, 7
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_278
.LBB13_263:                             # %pred.store.continue409
                                        #   in Loop: Header=BB13_255 Depth=1
	vpickve2gr.b	$t0, $vr1, 8
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_279
.LBB13_264:                             # %pred.store.continue411
                                        #   in Loop: Header=BB13_255 Depth=1
	vpickve2gr.b	$t0, $vr1, 9
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_280
.LBB13_265:                             # %pred.store.continue413
                                        #   in Loop: Header=BB13_255 Depth=1
	vpickve2gr.b	$t0, $vr1, 10
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_281
.LBB13_266:                             # %pred.store.continue415
                                        #   in Loop: Header=BB13_255 Depth=1
	vpickve2gr.b	$t0, $vr1, 11
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_282
.LBB13_267:                             # %pred.store.continue417
                                        #   in Loop: Header=BB13_255 Depth=1
	vpickve2gr.b	$t0, $vr1, 12
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_283
.LBB13_268:                             # %pred.store.continue419
                                        #   in Loop: Header=BB13_255 Depth=1
	vpickve2gr.b	$t0, $vr1, 13
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_284
.LBB13_269:                             # %pred.store.continue421
                                        #   in Loop: Header=BB13_255 Depth=1
	vpickve2gr.b	$t0, $vr1, 14
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_285
.LBB13_270:                             # %pred.store.continue423
                                        #   in Loop: Header=BB13_255 Depth=1
	vpickve2gr.b	$t0, $vr1, 15
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_254
	b	.LBB13_286
	.p2align	4, , 16
.LBB13_271:                             # %pred.store.if394
                                        #   in Loop: Header=BB13_255 Depth=1
	st.b	$a7, $a3, 7
	vpickve2gr.b	$t0, $vr1, 1
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_257
.LBB13_272:                             # %pred.store.if396
                                        #   in Loop: Header=BB13_255 Depth=1
	st.b	$a7, $a3, 6
	vpickve2gr.b	$t0, $vr1, 2
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_258
.LBB13_273:                             # %pred.store.if398
                                        #   in Loop: Header=BB13_255 Depth=1
	st.b	$a7, $a3, 5
	vpickve2gr.b	$t0, $vr1, 3
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_259
.LBB13_274:                             # %pred.store.if400
                                        #   in Loop: Header=BB13_255 Depth=1
	st.b	$a7, $a3, 4
	vpickve2gr.b	$t0, $vr1, 4
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_260
.LBB13_275:                             # %pred.store.if402
                                        #   in Loop: Header=BB13_255 Depth=1
	st.b	$a7, $a3, 3
	vpickve2gr.b	$t0, $vr1, 5
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_261
.LBB13_276:                             # %pred.store.if404
                                        #   in Loop: Header=BB13_255 Depth=1
	st.b	$a7, $a3, 2
	vpickve2gr.b	$t0, $vr1, 6
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_262
.LBB13_277:                             # %pred.store.if406
                                        #   in Loop: Header=BB13_255 Depth=1
	st.b	$a7, $a3, 1
	vpickve2gr.b	$t0, $vr1, 7
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_263
.LBB13_278:                             # %pred.store.if408
                                        #   in Loop: Header=BB13_255 Depth=1
	st.b	$a7, $a3, 0
	vpickve2gr.b	$t0, $vr1, 8
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_264
.LBB13_279:                             # %pred.store.if410
                                        #   in Loop: Header=BB13_255 Depth=1
	st.b	$a7, $a3, -1
	vpickve2gr.b	$t0, $vr1, 9
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_265
.LBB13_280:                             # %pred.store.if412
                                        #   in Loop: Header=BB13_255 Depth=1
	st.b	$a7, $a3, -2
	vpickve2gr.b	$t0, $vr1, 10
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_266
.LBB13_281:                             # %pred.store.if414
                                        #   in Loop: Header=BB13_255 Depth=1
	st.b	$a7, $a3, -3
	vpickve2gr.b	$t0, $vr1, 11
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_267
.LBB13_282:                             # %pred.store.if416
                                        #   in Loop: Header=BB13_255 Depth=1
	st.b	$a7, $a3, -4
	vpickve2gr.b	$t0, $vr1, 12
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_268
.LBB13_283:                             # %pred.store.if418
                                        #   in Loop: Header=BB13_255 Depth=1
	st.b	$a7, $a3, -5
	vpickve2gr.b	$t0, $vr1, 13
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_269
.LBB13_284:                             # %pred.store.if420
                                        #   in Loop: Header=BB13_255 Depth=1
	st.b	$a7, $a3, -6
	vpickve2gr.b	$t0, $vr1, 14
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_270
.LBB13_285:                             # %pred.store.if422
                                        #   in Loop: Header=BB13_255 Depth=1
	st.b	$a7, $a3, -7
	vpickve2gr.b	$t0, $vr1, 15
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_254
.LBB13_286:                             # %pred.store.if424
                                        #   in Loop: Header=BB13_255 Depth=1
	st.b	$a7, $a3, -8
	b	.LBB13_254
.LBB13_287:                             # %vec.epilog.iter.check250
	bnez	$a5, .LBB13_138
# %bb.288:
	andi	$a5, $a3, 31
...
# %bb.292:                              # %if.then.i.i
	...
	stx.b	$a1, $a0, $a5
	b	.LBB13_290
.LBB13_293:                             # %vec.epilog.middle.block427
	beq	$a2, $a5, .LBB13_361
	b	.LBB13_365
.LBB13_294:                             # %vector.ph304
	andi	$a4, $a2, 16
	move	$a3, $a2
	bstrins.d	$a3, $zero, 4, 0
	...
	b	.LBB13_296
	.p2align	4, , 16
.LBB13_295:                             # %pred.store.continue376
                                        #   in Loop: Header=BB13_296 Depth=1
	addi.d	$a7, $a7, -32
	addi.d	$a5, $a5, -32
	beqz	$a7, .LBB13_360
.LBB13_296:                             # %vector.body309
                                        # =>This Inner Loop Header: Depth=1
	xvld	$xr1, $a5, -16
	xvpermi.d	$xr1, $xr1, 78
	xvshuf4i.w	$xr1, $xr1, 27
	...
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_328
# %bb.297:                              # %pred.store.continue314
                                        #   in Loop: Header=BB13_296 Depth=1
	vpickve2gr.b	$t0, $vr1, 1
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_329
.LBB13_298:                             # %pred.store.continue316
                                        #   in Loop: Header=BB13_296 Depth=1
	vpickve2gr.b	$t0, $vr1, 2
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_330
.LBB13_299:                             # %pred.store.continue318
                                        #   in Loop: Header=BB13_296 Depth=1
	vpickve2gr.b	$t0, $vr1, 3
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_331
.LBB13_300:                             # %pred.store.continue320
                                        #   in Loop: Header=BB13_296 Depth=1
	vpickve2gr.b	$t0, $vr1, 4
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_332
.LBB13_301:                             # %pred.store.continue322
                                        #   in Loop: Header=BB13_296 Depth=1
	vpickve2gr.b	$t0, $vr1, 5
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_333
.LBB13_302:                             # %pred.store.continue324
                                        #   in Loop: Header=BB13_296 Depth=1
	vpickve2gr.b	$t0, $vr1, 6
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_334
.LBB13_303:                             # %pred.store.continue326
                                        #   in Loop: Header=BB13_296 Depth=1
	vpickve2gr.b	$t0, $vr1, 7
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_335
.LBB13_304:                             # %pred.store.continue328
                                        #   in Loop: Header=BB13_296 Depth=1
	vpickve2gr.b	$t0, $vr1, 8
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_336
.LBB13_305:                             # %pred.store.continue330
                                        #   in Loop: Header=BB13_296 Depth=1
	vpickve2gr.b	$t0, $vr1, 9
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_337
.LBB13_306:                             # %pred.store.continue332
                                        #   in Loop: Header=BB13_296 Depth=1
	vpickve2gr.b	$t0, $vr1, 10
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_338
.LBB13_307:                             # %pred.store.continue334
                                        #   in Loop: Header=BB13_296 Depth=1
	vpickve2gr.b	$t0, $vr1, 11
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_339
.LBB13_308:                             # %pred.store.continue336
                                        #   in Loop: Header=BB13_296 Depth=1
	vpickve2gr.b	$t0, $vr1, 12
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_340
.LBB13_309:                             # %pred.store.continue338
                                        #   in Loop: Header=BB13_296 Depth=1
	vpickve2gr.b	$t0, $vr1, 13
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_341
.LBB13_310:                             # %pred.store.continue340
                                        #   in Loop: Header=BB13_296 Depth=1
	vpickve2gr.b	$t0, $vr1, 14
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_342
.LBB13_311:                             # %pred.store.continue342
                                        #   in Loop: Header=BB13_296 Depth=1
	vpickve2gr.b	$t0, $vr1, 15
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_343
.LBB13_312:                             # %pred.store.continue344
                                        #   in Loop: Header=BB13_296 Depth=1
	xvpermi.d	$xr1, $xr1, 14
	vpickve2gr.b	$t0, $vr1, 0
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_344
.LBB13_313:                             # %pred.store.continue346
                                        #   in Loop: Header=BB13_296 Depth=1
	vpickve2gr.b	$t0, $vr1, 1
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_345
.LBB13_314:                             # %pred.store.continue348
                                        #   in Loop: Header=BB13_296 Depth=1
	vpickve2gr.b	$t0, $vr1, 2
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_346
.LBB13_315:                             # %pred.store.continue350
                                        #   in Loop: Header=BB13_296 Depth=1
	vpickve2gr.b	$t0, $vr1, 3
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_347
.LBB13_316:                             # %pred.store.continue352
                                        #   in Loop: Header=BB13_296 Depth=1
	vpickve2gr.b	$t0, $vr1, 4
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_348
.LBB13_317:                             # %pred.store.continue354
                                        #   in Loop: Header=BB13_296 Depth=1
	vpickve2gr.b	$t0, $vr1, 5
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_349
.LBB13_318:                             # %pred.store.continue356
                                        #   in Loop: Header=BB13_296 Depth=1
	vpickve2gr.b	$t0, $vr1, 6
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_350
.LBB13_319:                             # %pred.store.continue358
                                        #   in Loop: Header=BB13_296 Depth=1
	vpickve2gr.b	$t0, $vr1, 7
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_351
.LBB13_320:                             # %pred.store.continue360
                                        #   in Loop: Header=BB13_296 Depth=1
	vpickve2gr.b	$t0, $vr1, 8
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_352
.LBB13_321:                             # %pred.store.continue362
                                        #   in Loop: Header=BB13_296 Depth=1
	vpickve2gr.b	$t0, $vr1, 9
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_353
.LBB13_322:                             # %pred.store.continue364
                                        #   in Loop: Header=BB13_296 Depth=1
	vpickve2gr.b	$t0, $vr1, 10
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_354
.LBB13_323:                             # %pred.store.continue366
                                        #   in Loop: Header=BB13_296 Depth=1
	vpickve2gr.b	$t0, $vr1, 11
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_355
.LBB13_324:                             # %pred.store.continue368
                                        #   in Loop: Header=BB13_296 Depth=1
	vpickve2gr.b	$t0, $vr1, 12
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_356
.LBB13_325:                             # %pred.store.continue370
                                        #   in Loop: Header=BB13_296 Depth=1
	vpickve2gr.b	$t0, $vr1, 13
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_357
.LBB13_326:                             # %pred.store.continue372
                                        #   in Loop: Header=BB13_296 Depth=1
	vpickve2gr.b	$t0, $vr1, 14
	andi	$t0, $t0, 1
	bnez	$t0, .LBB13_358
.LBB13_327:                             # %pred.store.continue374
                                        #   in Loop: Header=BB13_296 Depth=1
	vpickve2gr.b	$t0, $vr1, 15
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_295
	b	.LBB13_359
	.p2align	4, , 16
.LBB13_328:                             # %pred.store.if313
                                        #   in Loop: Header=BB13_296 Depth=1
	st.b	$a6, $a5, 15
	vpickve2gr.b	$t0, $vr1, 1
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_298
.LBB13_329:                             # %pred.store.if315
                                        #   in Loop: Header=BB13_296 Depth=1
	st.b	$a6, $a5, 14
	vpickve2gr.b	$t0, $vr1, 2
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_299
.LBB13_330:                             # %pred.store.if317
                                        #   in Loop: Header=BB13_296 Depth=1
	st.b	$a6, $a5, 13
	vpickve2gr.b	$t0, $vr1, 3
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_300
.LBB13_331:                             # %pred.store.if319
                                        #   in Loop: Header=BB13_296 Depth=1
	st.b	$a6, $a5, 12
	vpickve2gr.b	$t0, $vr1, 4
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_301
.LBB13_332:                             # %pred.store.if321
                                        #   in Loop: Header=BB13_296 Depth=1
	st.b	$a6, $a5, 11
	vpickve2gr.b	$t0, $vr1, 5
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_302
.LBB13_333:                             # %pred.store.if323
                                        #   in Loop: Header=BB13_296 Depth=1
	st.b	$a6, $a5, 10
	vpickve2gr.b	$t0, $vr1, 6
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_303
.LBB13_334:                             # %pred.store.if325
                                        #   in Loop: Header=BB13_296 Depth=1
	st.b	$a6, $a5, 9
	vpickve2gr.b	$t0, $vr1, 7
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_304
.LBB13_335:                             # %pred.store.if327
                                        #   in Loop: Header=BB13_296 Depth=1
	st.b	$a6, $a5, 8
	vpickve2gr.b	$t0, $vr1, 8
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_305
.LBB13_336:                             # %pred.store.if329
                                        #   in Loop: Header=BB13_296 Depth=1
	st.b	$a6, $a5, 7
	vpickve2gr.b	$t0, $vr1, 9
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_306
.LBB13_337:                             # %pred.store.if331
                                        #   in Loop: Header=BB13_296 Depth=1
	st.b	$a6, $a5, 6
	vpickve2gr.b	$t0, $vr1, 10
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_307
.LBB13_338:                             # %pred.store.if333
                                        #   in Loop: Header=BB13_296 Depth=1
	st.b	$a6, $a5, 5
	vpickve2gr.b	$t0, $vr1, 11
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_308
.LBB13_339:                             # %pred.store.if335
                                        #   in Loop: Header=BB13_296 Depth=1
	st.b	$a6, $a5, 4
	vpickve2gr.b	$t0, $vr1, 12
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_309
.LBB13_340:                             # %pred.store.if337
                                        #   in Loop: Header=BB13_296 Depth=1
	st.b	$a6, $a5, 3
	vpickve2gr.b	$t0, $vr1, 13
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_310
.LBB13_341:                             # %pred.store.if339
                                        #   in Loop: Header=BB13_296 Depth=1
	st.b	$a6, $a5, 2
	vpickve2gr.b	$t0, $vr1, 14
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_311
.LBB13_342:                             # %pred.store.if341
                                        #   in Loop: Header=BB13_296 Depth=1
	st.b	$a6, $a5, 1
	vpickve2gr.b	$t0, $vr1, 15
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_312
.LBB13_343:                             # %pred.store.if343
                                        #   in Loop: Header=BB13_296 Depth=1
	st.b	$a6, $a5, 0
	xvpermi.d	$xr1, $xr1, 14
	vpickve2gr.b	$t0, $vr1, 0
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_313
.LBB13_344:                             # %pred.store.if345
                                        #   in Loop: Header=BB13_296 Depth=1
	st.b	$a6, $a5, -1
	vpickve2gr.b	$t0, $vr1, 1
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_314
.LBB13_345:                             # %pred.store.if347
                                        #   in Loop: Header=BB13_296 Depth=1
	st.b	$a6, $a5, -2
	vpickve2gr.b	$t0, $vr1, 2
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_315
.LBB13_346:                             # %pred.store.if349
                                        #   in Loop: Header=BB13_296 Depth=1
	st.b	$a6, $a5, -3
	vpickve2gr.b	$t0, $vr1, 3
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_316
.LBB13_347:                             # %pred.store.if351
                                        #   in Loop: Header=BB13_296 Depth=1
	st.b	$a6, $a5, -4
	vpickve2gr.b	$t0, $vr1, 4
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_317
.LBB13_348:                             # %pred.store.if353
                                        #   in Loop: Header=BB13_296 Depth=1
	st.b	$a6, $a5, -5
	vpickve2gr.b	$t0, $vr1, 5
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_318
.LBB13_349:                             # %pred.store.if355
                                        #   in Loop: Header=BB13_296 Depth=1
	st.b	$a6, $a5, -6
	vpickve2gr.b	$t0, $vr1, 6
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_319
.LBB13_350:                             # %pred.store.if357
                                        #   in Loop: Header=BB13_296 Depth=1
	st.b	$a6, $a5, -7
	vpickve2gr.b	$t0, $vr1, 7
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_320
.LBB13_351:                             # %pred.store.if359
                                        #   in Loop: Header=BB13_296 Depth=1
	st.b	$a6, $a5, -8
	vpickve2gr.b	$t0, $vr1, 8
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_321
.LBB13_352:                             # %pred.store.if361
                                        #   in Loop: Header=BB13_296 Depth=1
	st.b	$a6, $a5, -9
	vpickve2gr.b	$t0, $vr1, 9
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_322
.LBB13_353:                             # %pred.store.if363
                                        #   in Loop: Header=BB13_296 Depth=1
	st.b	$a6, $a5, -10
	vpickve2gr.b	$t0, $vr1, 10
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_323
.LBB13_354:                             # %pred.store.if365
                                        #   in Loop: Header=BB13_296 Depth=1
	st.b	$a6, $a5, -11
	vpickve2gr.b	$t0, $vr1, 11
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_324
.LBB13_355:                             # %pred.store.if367
                                        #   in Loop: Header=BB13_296 Depth=1
	st.b	$a6, $a5, -12
	vpickve2gr.b	$t0, $vr1, 12
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_325
.LBB13_356:                             # %pred.store.if369
                                        #   in Loop: Header=BB13_296 Depth=1
	st.b	$a6, $a5, -13
	vpickve2gr.b	$t0, $vr1, 13
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_326
.LBB13_357:                             # %pred.store.if371
                                        #   in Loop: Header=BB13_296 Depth=1
	st.b	$a6, $a5, -14
	vpickve2gr.b	$t0, $vr1, 14
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_327
.LBB13_358:                             # %pred.store.if373
                                        #   in Loop: Header=BB13_296 Depth=1
	st.b	$a6, $a5, -15
	vpickve2gr.b	$t0, $vr1, 15
	andi	$t0, $t0, 1
	beqz	$t0, .LBB13_295
.LBB13_359:                             # %pred.store.if375
                                        #   in Loop: Header=BB13_296 Depth=1
	st.b	$a6, $a5, -16
	b	.LBB13_295
.LBB13_360:                             # %middle.block378
	bne	$a2, $a3, .LBB13_363
...
.LBB13_362:                             # %if.end45
	...
	addi.d	$sp, $sp, 144
	ret
.LBB13_363:                             # %vec.epilog.iter.check382
	bnez	$a4, .LBB13_253
# %bb.364:
	andi	$a4, $a2, 31
