...
.LBB2_60:                               # %if.end.i47
	...
	move	$a0, $fp
	beqz	$s2, .LBB2_62
# %bb.61:                               # %if.end13.thread.i
	move	$a1, $s1
	pcaddu18i	$ra, %call36(lua_settop)
	jirl	$ra, $ra, 0
	b	.LBB2_63
.LBB2_62:                               # %if.end13.i51
	move	$a1, $s0
	move	$a2, $zero
	pcaddu18i	$ra, %call36(docall)
	jirl	$ra, $ra, 0
