...
.LBB14_41:                              # %if.end.i62
	ld.w	$a0, $fp, 76
	blez	$a0, .LBB14_47
# %bb.42:                               # %for.body.lr.ph.i66
	move	$s1, $zero
	move	$s2, $zero
	ori	$s3, $zero, 4
	b	.LBB14_44
	.p2align	4, , 16
.LBB14_43:                              # %for.inc.i71
                                        #   in Loop: Header=BB14_44 Depth=1
	addi.d	$s2, $s2, 1
	addi.d	$s1, $s1, 16
	bge	$s2, $a0, .LBB14_47
.LBB14_44:                              # %for.body.i67
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a1, $fp, 16
	add.d	$a1, $a1, $s1
	ld.w	$a2, $a1, 8
	blt	$a2, $s3, .LBB14_43
# %bb.45:                               # %land.lhs.true.i74
                                        #   in Loop: Header=BB14_44 Depth=1
	ld.d	$a1, $a1, 0
	ld.bu	$a2, $a1, 9
	andi	$a2, $a2, 3
...
# %bb.46:                               # %if.then13.i
	...
	ld.w	$a0, $fp, 76
	b	.LBB14_43
.LBB14_47:                              # %for.cond19.preheader.i
	ld.w	$a0, $fp, 72
	blez	$a0, .LBB14_52
# %bb.48:                               # %for.body22.lr.ph.i
	move	$a1, $zero
	move	$a2, $zero
	b	.LBB14_50
	.p2align	4, , 16
.LBB14_49:                              # %for.inc35.i
                                        #   in Loop: Header=BB14_50 Depth=1
	addi.d	$a2, $a2, 1
	addi.d	$a1, $a1, 8
	bge	$a2, $a0, .LBB14_52
.LBB14_50:                              # %for.body22.i
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a3, $fp, 56
	ldx.d	$a3, $a3, $a1
	beqz	$a3, .LBB14_49
# %bb.51:                               # %if.then26.i65
	...
	ld.w	$a0, $fp, 72
	b	.LBB14_49
.LBB14_52:                              # %for.cond38.preheader.i
	ld.w	$a0, $fp, 88
	blez	$a0, .LBB14_58
# %bb.53:                               # %for.body41.lr.ph.i
	move	$s1, $zero
	move	$s2, $zero
	b	.LBB14_55
	.p2align	4, , 16
.LBB14_54:                              # %for.inc59.i
                                        #   in Loop: Header=BB14_55 Depth=1
	addi.d	$s2, $s2, 1
	addi.d	$s1, $s1, 8
	bge	$s2, $a0, .LBB14_58
.LBB14_55:                              # %for.body41.i
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a1, $fp, 32
	ldx.d	$a1, $a1, $s1
	beqz	$a1, .LBB14_54
...
# %bb.57:                               # %if.then53.i
	...
	ld.w	$a0, $fp, 88
	b	.LBB14_54
.LBB14_58:                              # %for.cond62.preheader.i
	ld.w	$a1, $fp, 92
	blez	$a1, .LBB14_70
# %bb.59:                               # %for.body65.lr.ph.i
	move	$a0, $zero
	move	$a2, $zero
	b	.LBB14_61
	.p2align	4, , 16
.LBB14_60:                              # %for.inc79.i
                                        #   in Loop: Header=BB14_61 Depth=1
	addi.d	$a2, $a2, 1
	addi.d	$a0, $a0, 16
	bge	$a2, $a1, .LBB14_69
.LBB14_61:                              # %for.body65.i
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a3, $fp, 48
	ldx.d	$a3, $a3, $a0
	beqz	$a3, .LBB14_60
...
.LBB14_65:                              # %if.end72.i
	...
	addi.d	$s3, $s3, -16
	beqz	$s2, .LBB14_99
.LBB14_66:                              # %while.body.i
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $fp, 24
	add.d	$a0, $a0, $s3
	ld.w	$a1, $a0, -8
	blt	$a1, $s4, .LBB14_65
# %bb.67:                               # %land.lhs.true58.i
                                        #   in Loop: Header=BB14_66 Depth=1
	ld.d	$a1, $a0, -16
	ld.bu	$a0, $a1, 9
	andi	$a0, $a0, 3
...
.LBB14_73:                              # %if.end28.i
	ld.bu	$a0, $fp, 11
	beqz	$a0, .LBB14_78
# %bb.74:                               # %for.body34.lr.ph.i
	move	$s1, $zero
	addi.d	$s2, $fp, 40
	b	.LBB14_76
	.p2align	4, , 16
.LBB14_75:                              # %for.inc46.i
                                        #   in Loop: Header=BB14_76 Depth=1
	addi.d	$s1, $s1, 1
	addi.d	$s2, $s2, 8
	bgeu	$s1, $a0, .LBB14_79
.LBB14_76:                              # %for.body34.i
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a1, $s2, 0
	ld.bu	$a2, $a1, 9
	andi	$a2, $a2, 3
...
# %bb.92:                               # %if.end73.thread.i
	...
	slli.d	$a1, $a0, 5
	beqz	$s1, .LBB14_119
# %bb.93:                               # %while.body79.us.us.i.preheader
	alsl.d	$a1, $a0, $a1, 3
	ori	$a2, $zero, 4
	ori	$a3, $zero, 11
	b	.LBB14_95
.LBB14_94:                              # %if.end121.us.us.i
                                        #   in Loop: Header=BB14_95 Depth=1
	addi.d	$a0, $a4, -1
	addi.d	$a1, $a1, -40
	beqz	$a4, .LBB14_11
.LBB14_95:                              # %while.body79.us.us.i
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a4, $fp, 32
	add.d	$a5, $a4, $a1
	ld.w	$a6, $a5, 8
	move	$a4, $a0
	bnez	$a6, .LBB14_94
# %bb.96:                               # %if.then85.us.us.i
                                        #   in Loop: Header=BB14_95 Depth=1
	ld.w	$a0, $a5, 24
	blt	$a0, $a2, .LBB14_94
# %bb.97:                               # %if.then.i.us.us.i
                                        #   in Loop: Header=BB14_95 Depth=1
	st.w	$a3, $a5, 24
	b	.LBB14_94
.LBB14_98:
...
.LBB14_99:                              # %if.end73.i
	...
	slli.d	$a1, $a0, 5
	beqz	$s1, .LBB14_108
# %bb.100:                              # %while.body79.us.i.preheader
	alsl.d	$s1, $a0, $a1, 3
	ori	$s2, $zero, 4
	ori	$s3, $zero, 11
	b	.LBB14_102
	.p2align	4, , 16
.LBB14_101:                             # %if.end121.us.i
                                        #   in Loop: Header=BB14_102 Depth=1
	addi.d	$a0, $s4, -1
	addi.d	$s1, $s1, -40
	beqz	$s4, .LBB14_11
.LBB14_102:                             # %while.body79.us.i
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a1, $fp, 32
	add.d	$a1, $a1, $s1
	ld.w	$a2, $a1, 8
...
# %bb.103:                              # %if.else.us.i
                                        #   in Loop: Header=BB14_102 Depth=1
	blt	$a2, $s2, .LBB14_101
# %bb.104:                              # %land.lhs.true109.us.i
                                        #   in Loop: Header=BB14_102 Depth=1
	ld.d	$a1, $a1, 0
	ld.bu	$a0, $a1, 9
	andi	$a0, $a0, 3
	beqz	$a0, .LBB14_101
# %bb.105:                              # %if.then116.us.i
                                        #   in Loop: Header=BB14_102 Depth=1
	move	$a0, $s0
	pcaddu18i	$ra, %call36(reallymarkobject)
	jirl	$ra, $ra, 0
	b	.LBB14_101
	.p2align	4, , 16
.LBB14_106:                             # %if.then85.us.i
                                        #   in Loop: Header=BB14_102 Depth=1
	ld.w	$a0, $a1, 24
	blt	$a0, $s2, .LBB14_101
# %bb.107:                              # %if.then.i.us.i
                                        #   in Loop: Header=BB14_102 Depth=1
	st.w	$s3, $a1, 24
	b	.LBB14_101
.LBB14_108:                             # %while.body79.i.preheader
	alsl.d	$s1, $a0, $a1, 3
	ori	$s2, $zero, 4
	ori	$s3, $zero, 11
	b	.LBB14_110
	.p2align	4, , 16
.LBB14_109:                             # %if.end121.i
                                        #   in Loop: Header=BB14_110 Depth=1
	addi.d	$a0, $s4, -1
	addi.d	$s1, $s1, -40
	beqz	$s4, .LBB14_12
.LBB14_110:                             # %while.body79.i
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a1, $fp, 32
	add.d	$s5, $a1, $s1
	ld.w	$a2, $s5, 8
...
# %bb.113:                              # %if.then98.i
	...
	jirl	$ra, $ra, 0
	ld.w	$a2, $s5, 8
.LBB14_114:                             # %if.end102.i
                                        #   in Loop: Header=BB14_110 Depth=1
	blt	$a2, $s2, .LBB14_109
# %bb.115:                              # %land.lhs.true109.i
                                        #   in Loop: Header=BB14_110 Depth=1
	ld.d	$a1, $s5, 0
	ld.bu	$a0, $a1, 9
	andi	$a0, $a0, 3
...
# %bb.118:                              # %if.then.i.i
	...
	st.w	$s3, $s5, 24
	b	.LBB14_109
.LBB14_119:                             # %while.body79.us67.i.preheader
	alsl.d	$s1, $a0, $a1, 3
	ori	$s2, $zero, 4
	ori	$s3, $zero, 11
	b	.LBB14_121
.LBB14_120:                             # %if.end121.us79.i
                                        #   in Loop: Header=BB14_121 Depth=1
	addi.d	$a0, $s4, -1
	addi.d	$s1, $s1, -40
	beqz	$s4, .LBB14_11
.LBB14_121:                             # %while.body79.us67.i
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a1, $fp, 32
	add.d	$a1, $a1, $s1
	ld.w	$a3, $a1, 8
	...
	move	$s4, $a0
	beqz	$a3, .LBB14_125
# %bb.122:                              # %if.else.us73.i
                                        #   in Loop: Header=BB14_121 Depth=1
	blt	$a2, $s2, .LBB14_120
# %bb.123:                              # %land.lhs.true91.us.i
                                        #   in Loop: Header=BB14_121 Depth=1
	ld.d	$a1, $a1, 16
	ld.bu	$a0, $a1, 9
	andi	$a0, $a0, 3
	beqz	$a0, .LBB14_120
# %bb.124:                              # %if.then98.us.i
                                        #   in Loop: Header=BB14_121 Depth=1
	move	$a0, $s0
	pcaddu18i	$ra, %call36(reallymarkobject)
	jirl	$ra, $ra, 0
	b	.LBB14_120
.LBB14_125:                             # %if.then85.us75.i
                                        #   in Loop: Header=BB14_121 Depth=1
	blt	$a2, $s2, .LBB14_120
# %bb.126:                              # %if.then.i.us78.i
                                        #   in Loop: Header=BB14_121 Depth=1
	st.w	$s3, $a1, 24
	b	.LBB14_120
.Lfunc_end14:
