...
.LBB14_16:                              # %if.end.i51
	...
	move	$s1, $a0
	bltu	$a2, $a1, .LBB14_19
# %bb.17:                               # %for.body.i52.preheader
	move	$s1, $a0
	.p2align	4, , 16
.LBB14_18:                              # %for.body.i52
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a3, $a1, 16
	sltu	$a4, $s1, $a3
	masknez	$a5, $s1, $a4
...
# %bb.20:
	...
	b	.LBB14_22
	.p2align	4, , 16
.LBB14_21:                              # %for.inc30.i
                                        #   in Loop: Header=BB14_22 Depth=1
	addi.d	$s2, $s2, 16
	bgeu	$s2, $a0, .LBB14_25
.LBB14_22:                              # %for.body17.i
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a1, $s2, 8
	blt	$a1, $s3, .LBB14_21
# %bb.23:                               # %land.lhs.true21.i
                                        #   in Loop: Header=BB14_22 Depth=1
	ld.d	$a1, $s2, 0
	ld.bu	$a2, $a1, 9
	andi	$a2, $a2, 3
...
# %bb.24:                               # %if.then27.i
	...
	ld.d	$a0, $fp, 16
	b	.LBB14_21
.LBB14_25:                              # %for.cond33.preheader.i
	bltu	$s1, $s2, .LBB14_82
# %bb.26:                               # %for.body36.i.preheader
	addi.d	$a0, $s2, 16
	addi.d	$a1, $s1, 1
	sltu	$a2, $a1, $a0
	masknez	$a1, $a1, $a2
...
.LBB14_39:                              # %if.end.i62
	...
	ori	$s1, $zero, 1
	blt	$a0, $s1, .LBB14_45
# %bb.40:                               # %for.body.lr.ph.i66
	move	$s2, $zero
	move	$s3, $zero
	ori	$s4, $zero, 4
	b	.LBB14_42
	.p2align	4, , 16
.LBB14_41:                              # %for.inc.i71
                                        #   in Loop: Header=BB14_42 Depth=1
	addi.d	$s3, $s3, 1
	addi.d	$s2, $s2, 16
	bge	$s3, $a0, .LBB14_45
.LBB14_42:                              # %for.body.i67
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a1, $fp, 16
	add.d	$a1, $a1, $s2
	ld.w	$a2, $a1, 8
	blt	$a2, $s4, .LBB14_41
# %bb.43:                               # %land.lhs.true.i74
                                        #   in Loop: Header=BB14_42 Depth=1
	ld.d	$a1, $a1, 0
	ld.bu	$a2, $a1, 9
	andi	$a2, $a2, 3
...
# %bb.44:                               # %if.then13.i
	...
	ld.w	$a0, $fp, 76
	b	.LBB14_41
.LBB14_45:                              # %for.cond19.preheader.i
	ld.w	$a0, $fp, 72
	blt	$a0, $s1, .LBB14_50
# %bb.46:                               # %for.body22.lr.ph.i
	move	$a1, $zero
	move	$a2, $zero
	b	.LBB14_48
	.p2align	4, , 16
.LBB14_47:                              # %for.inc35.i
                                        #   in Loop: Header=BB14_48 Depth=1
	addi.d	$a2, $a2, 1
	addi.d	$a1, $a1, 8
	bge	$a2, $a0, .LBB14_50
.LBB14_48:                              # %for.body22.i
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a3, $fp, 56
	ldx.d	$a3, $a3, $a1
	beqz	$a3, .LBB14_47
# %bb.49:                               # %if.then26.i65
	...
	ld.w	$a0, $fp, 72
	b	.LBB14_47
.LBB14_50:                              # %for.cond38.preheader.i
	ld.w	$a0, $fp, 88
	ori	$a1, $zero, 1
	blt	$a0, $a1, .LBB14_56
# %bb.51:                               # %for.body41.lr.ph.i
	move	$s1, $zero
	move	$s2, $zero
	b	.LBB14_53
	.p2align	4, , 16
.LBB14_52:                              # %for.inc59.i
                                        #   in Loop: Header=BB14_53 Depth=1
	addi.d	$s2, $s2, 1
	addi.d	$s1, $s1, 8
	bge	$s2, $a0, .LBB14_56
.LBB14_53:                              # %for.body41.i
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a1, $fp, 32
	ldx.d	$a1, $a1, $s1
	beqz	$a1, .LBB14_52
...
# %bb.55:                               # %if.then53.i
	...
	ld.w	$a0, $fp, 88
	b	.LBB14_52
.LBB14_56:                              # %for.cond62.preheader.i
	ld.w	$a1, $fp, 92
	blez	$a1, .LBB14_68
# %bb.57:                               # %for.body65.lr.ph.i
	move	$a0, $zero
	move	$a2, $zero
	b	.LBB14_59
	.p2align	4, , 16
.LBB14_58:                              # %for.inc79.i
                                        #   in Loop: Header=BB14_59 Depth=1
	addi.d	$a2, $a2, 1
	addi.d	$a0, $a0, 16
	bge	$a2, $a1, .LBB14_67
.LBB14_59:                              # %for.body65.i
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a3, $fp, 48
	ldx.d	$a3, $a3, $a0
	beqz	$a3, .LBB14_58
...
.LBB14_63:                              # %if.end72.i
	...
	addi.d	$s3, $s3, -16
	beqz	$s2, .LBB14_102
.LBB14_64:                              # %while.body.i
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $fp, 24
	add.d	$a0, $a0, $s3
	ld.w	$a1, $a0, -8
	blt	$a1, $s4, .LBB14_63
# %bb.65:                               # %land.lhs.true58.i
                                        #   in Loop: Header=BB14_64 Depth=1
	ld.d	$a1, $a0, -16
	ld.bu	$a0, $a1, 9
	andi	$a0, $a0, 3
...
# %bb.66:                               # %if.then67.i
	...
	jirl	$ra, $ra, 0
	b	.LBB14_63
.LBB14_67:                              # %traverseproto.exit.loopexit
	ld.w	$a0, $fp, 88
.LBB14_68:                              # %traverseproto.exit
	ld.w	$a2, $fp, 80
	ld.w	$a3, $fp, 76
	ld.w	$a4, $fp, 72
	ld.w	$a5, $fp, 84
...
.LBB14_71:                              # %if.end28.i
	ld.bu	$a0, $fp, 11
	beqz	$a0, .LBB14_76
# %bb.72:                               # %for.body34.lr.ph.i
	move	$s1, $zero
	addi.d	$s2, $fp, 40
	b	.LBB14_74
	.p2align	4, , 16
.LBB14_73:                              # %for.inc46.i
                                        #   in Loop: Header=BB14_74 Depth=1
	addi.d	$s1, $s1, 1
	addi.d	$s2, $s2, 8
	bgeu	$s1, $a0, .LBB14_77
.LBB14_74:                              # %for.body34.i
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a1, $s2, 0
	ld.bu	$a2, $a1, 9
	andi	$a2, $a2, 3
...
# %bb.80:                               # %middle.block
	beq	$a1, $a2, .LBB14_82
	.p2align	4, , 16
.LBB14_81:                              # %for.body36.i
                                        # =>This Inner Loop Header: Depth=1
	st.w	$zero, $a0, 8
	addi.d	$a0, $a0, 16
	bgeu	$s1, $a0, .LBB14_81
.LBB14_82:                              # %for.end40.i
	ld.w	$a0, $fp, 92
	lu12i.w	$a1, 4
	ori	$a1, $a1, 3616
	blt	$a1, $a0, .LBB14_89
...
# %bb.92:                               # %if.end73.thread.i
	...
	ori	$s3, $zero, 1
	bnez	$s1, .LBB14_104
# %bb.93:                               # %while.body79.us67.preheader.i
	...
	ori	$s4, $zero, 11
	b	.LBB14_95
.LBB14_94:                              # %if.end121.us79.i
                                        #   in Loop: Header=BB14_95 Depth=1
	addi.d	$a0, $s5, -1
	addi.d	$s1, $s1, -40
	beqz	$s5, .LBB14_11
.LBB14_95:                              # %while.body79.us67.i
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a1, $s2, 0
	add.d	$a1, $a1, $s1
	ld.w	$a3, $a1, 8
	...
	move	$s5, $a0
	beqz	$a3, .LBB14_99
# %bb.96:                               # %if.else.us73.i
                                        #   in Loop: Header=BB14_95 Depth=1
	blt	$a2, $s3, .LBB14_94
# %bb.97:                               # %land.lhs.true91.us.i
                                        #   in Loop: Header=BB14_95 Depth=1
	ld.d	$a1, $a1, 16
	ld.bu	$a0, $a1, 9
	andi	$a0, $a0, 3
	beqz	$a0, .LBB14_94
# %bb.98:                               # %if.then98.us.i
                                        #   in Loop: Header=BB14_95 Depth=1
	move	$a0, $s0
	pcaddu18i	$ra, %call36(reallymarkobject)
	jirl	$ra, $ra, 0
	b	.LBB14_94
.LBB14_99:                              # %if.then85.us75.i
                                        #   in Loop: Header=BB14_95 Depth=1
	blt	$a2, $s3, .LBB14_94
# %bb.100:                              # %if.then.i.us78.i
                                        #   in Loop: Header=BB14_95 Depth=1
	st.w	$s4, $a1, 24
	b	.LBB14_94
.LBB14_101:
...
# %bb.103:
	move	$s3, $zero
.LBB14_104:                             # %while.body79.us.preheader.i
	bstrpick.d	$a0, $a0, 31, 0
	slli.d	$a1, $a0, 5
	alsl.d	$s1, $a0, $a1, 3
	ori	$s4, $zero, 4
	...
	b	.LBB14_106
	.p2align	4, , 16
.LBB14_105:                             # %if.end121.us.i
                                        #   in Loop: Header=BB14_106 Depth=1
	addi.d	$s1, $s1, -40
	beq	$s1, $s6, .LBB14_11
.LBB14_106:                             # %while.body79.us.i
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $s2, 0
	add.d	$a0, $a0, $s1
	ld.w	$a1, $a0, 8
...
# %bb.107:                              # %if.else.us.i
	...
	or	$a1, $s3, $a1
	bnez	$a1, .LBB14_105
# %bb.108:                              # %land.lhs.true109.us.i
                                        #   in Loop: Header=BB14_106 Depth=1
	ld.d	$a1, $a0, 0
	ld.bu	$a0, $a1, 9
	andi	$a0, $a0, 3
	beqz	$a0, .LBB14_105
# %bb.109:                              # %if.then116.us.i
                                        #   in Loop: Header=BB14_106 Depth=1
	move	$a0, $s0
	pcaddu18i	$ra, %call36(reallymarkobject)
	jirl	$ra, $ra, 0
	b	.LBB14_105
	.p2align	4, , 16
.LBB14_110:                             # %if.then85.us.i
                                        #   in Loop: Header=BB14_106 Depth=1
	ld.w	$a1, $a0, 24
	blt	$a1, $s4, .LBB14_105
# %bb.111:                              # %if.then.i.us.i
                                        #   in Loop: Header=BB14_106 Depth=1
	st.w	$s5, $a0, 24
	b	.LBB14_105
.LBB14_112:                             # %while.body79.preheader.i
	bstrpick.d	$a0, $a0, 31, 0
	slli.d	$a1, $a0, 5
	alsl.d	$s1, $a0, $a1, 3
	ori	$s3, $zero, 4
	...
	b	.LBB14_114
	.p2align	4, , 16
.LBB14_113:                             # %if.end121.i
                                        #   in Loop: Header=BB14_114 Depth=1
	addi.d	$a0, $s5, -1
	addi.d	$s1, $s1, -40
	beqz	$s5, .LBB14_12
.LBB14_114:                             # %while.body79.i
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a1, $s2, 0
	add.d	$s6, $a1, $s1
	ld.w	$a2, $s6, 8
...
# %bb.117:                              # %if.then98.i
	...
	jirl	$ra, $ra, 0
	ld.w	$a2, $s6, 8
.LBB14_118:                             # %if.end102.i
                                        #   in Loop: Header=BB14_114 Depth=1
	blt	$a2, $s3, .LBB14_113
# %bb.119:                              # %land.lhs.true109.i
                                        #   in Loop: Header=BB14_114 Depth=1
	ld.d	$a1, $s6, 0
	ld.bu	$a0, $a1, 9
	andi	$a0, $a0, 3
...
.LJTI14_0:
	...
	.word	.LBB14_28-.LJTI14_0
	.word	.LBB14_90-.LJTI14_0
	.word	.LBB14_13-.LJTI14_0
	.word	.LBB14_37-.LJTI14_0
                                        # -- End function
	.text
