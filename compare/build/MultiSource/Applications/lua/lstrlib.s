...
.Lfunc_end4:
	.size	str_find, .Lfunc_end4-str_find
                                        # -- End function
	.p2align	5                               # -- Begin function str_format
...
.LBB17_36:                              # %cleanup59
	...
	addi.d	$sp, $sp, 656
	ret
.LBB17_37:                              # %for.body.i.preheader93
	addi.d	$s5, $sp, 64
	addi.w	$s6, $zero, -2
...
.LBB18_2:                               #   in Loop: Header=BB18_5 Depth=2
	move	$s2, $s5
.LBB18_3:                               # %matchbracketclass.exit154
...
# %bb.26:                               #   in Loop: Header=BB18_24 Depth=3
	...
	b	.LBB18_23
	.p2align	4, , 16
.LBB18_27:                              # %if.else.i113
                                        #   in Loop: Header=BB18_24 Depth=3
	ori	$a3, $zero, 45
	bne	$a1, $a3, .LBB18_22
# %bb.28:                               # %land.lhs.true.i116
                                        #   in Loop: Header=BB18_24 Depth=3
	addi.d	$a1, $s6, 3
	bgeu	$a1, $s0, .LBB18_22
# %bb.29:                               # %if.then20.i
...
.LBB18_34:                              # %lor.lhs.false
	...
	b	.LBB18_37
	.p2align	4, , 16
.LBB18_35:                              # %if.else32.i135
                                        #   in Loop: Header=BB18_37 Depth=3
	beq	$s4, $a0, .LBB18_3
.LBB18_36:                              # %if.end39.i138
                                        #   in Loop: Header=BB18_37 Depth=3
	move	$fp, $s8
	addi.d	$s8, $s8, 1
	bgeu	$s8, $s0, .LBB18_2
.LBB18_37:                              # %while.body.i128
                                        #   Parent Loop BB18_1 Depth=1
                                        #     Parent Loop BB18_5 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.bu	$a0, $fp, 1
...
# %bb.39:                               #   in Loop: Header=BB18_37 Depth=3
	...
	b	.LBB18_36
	.p2align	4, , 16
.LBB18_40:                              # %if.else.i133
                                        #   in Loop: Header=BB18_37 Depth=3
	ori	$a2, $zero, 45
	bne	$a1, $a2, .LBB18_35
# %bb.41:                               # %land.lhs.true.i142
                                        #   in Loop: Header=BB18_37 Depth=3
	addi.d	$a1, $fp, 3
	bgeu	$a1, $s0, .LBB18_35
# %bb.42:                               # %if.then20.i145
                                        #   in Loop: Header=BB18_37 Depth=3
	bgeu	$s4, $a0, .LBB18_44
# %bb.43:                               #   in Loop: Header=BB18_37 Depth=3
	move	$s8, $a1
	b	.LBB18_36
.LBB18_44:                              # %land.lhs.true26.i148
                                        #   in Loop: Header=BB18_37 Depth=3
	ld.bu	$a0, $a1, 0
	move	$s8, $a1
	bltu	$a0, $s4, .LBB18_36
...
.LBB18_93:                              # %sw.bb12
	...
	ld.bu	$a0, $s5, 2
	beqz	$a0, .LBB18_95
# %bb.94:                               # %lor.lhs.false.i
                                        #   in Loop: Header=BB18_1 Depth=1
	ld.bu	$a1, $s5, 3
	bnez	$a1, .LBB18_96
.LBB18_95:                              # %if.then.i94
                                        #   in Loop: Header=BB18_1 Depth=1
	ld.d	$a0, $s8, 16
...
# %bb.97:                               # %if.else.i
	...
	ld.d	$a2, $s8, 8
	addi.d	$a1, $s6, 1
	bgeu	$a1, $a2, .LBB18_182
# %bb.98:                               # %while.body.i.preheader
                                        #   in Loop: Header=BB18_1 Depth=1
	ld.bu	$a3, $s5, 3
	ori	$a4, $zero, 1
	b	.LBB18_101
	.p2align	4, , 16
.LBB18_99:                              # %if.else24.i
                                        #   in Loop: Header=BB18_101 Depth=2
	xor	$a5, $a5, $a0
	sltui	$a5, $a5, 1
	add.d	$a4, $a4, $a5
.LBB18_100:                             # %if.end30.i
                                        #   in Loop: Header=BB18_101 Depth=2
	addi.d	$a1, $a1, 1
	beq	$a1, $a2, .LBB18_182
.LBB18_101:                             # %while.body.i
                                        #   Parent Loop BB18_1 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.bu	$a5, $a1, 0
	bne	$a5, $a3, .LBB18_99
...
.LBB18_109:                             # %if.then48
                                        #   in Loop: Header=BB18_1 Depth=1
	ori	$a0, $zero, 49
	bltu	$fp, $a0, .LBB18_112
# %bb.110:                              # %lor.lhs.false.i.i
                                        #   in Loop: Header=BB18_1 Depth=1
	ld.w	$a1, $s8, 24
	addi.d	$a0, $fp, -49
	bge	$a0, $a1, .LBB18_112
# %bb.111:                              # %lor.lhs.false2.i.i
                                        #   in Loop: Header=BB18_1 Depth=1
	alsl.d	$a1, $a0, $s8, 4
	ld.d	$a1, $a1, 40
	addi.w	$a2, $zero, -1
	bne	$a1, $a2, .LBB18_113
.LBB18_112:                             # %if.then.i.i
                                        #   in Loop: Header=BB18_1 Depth=1
	ld.d	$a0, $s8, 16
	...
	pcaddu18i	$ra, %call36(luaL_error)
	jirl	$ra, $ra, 0
.LBB18_113:                             # %check_capture.exit.i
                                        #   in Loop: Header=BB18_1 Depth=1
	...
	ld.d	$s2, $a0, 8
	sub.d	$a1, $a1, $s6
	bltu	$a1, $s2, .LBB18_182
# %bb.114:                              # %land.lhs.true.i162
                                        #   in Loop: Header=BB18_1 Depth=1
	ld.d	$a0, $a0, 0
	move	$a1, $s6
	move	$a2, $s2
...
.LBB18_125:                             # %for.end.i
	...
	pcaddu18i	$ra, %call36(luaL_error)
	jirl	$ra, $ra, 0
.LBB18_126:                             # %capture_to_close.exit
	slli.d	$a1, $a0, 4
	ld.d	$a2, $sp, 56                    # 8-byte Folded Reload
	ldx.d	$a1, $a2, $a1
	alsl.d	$s0, $a0, $a2, 4
...
# %bb.134:                              # %cond.true97
	move	$s3, $zero
	addi.d	$s1, $s6, 1
	bgeu	$s1, $a4, .LBB18_215
# %bb.135:                              # %land.rhs.i240.lr.ph
	ld.bu	$s7, $s5, 0
	move	$fp, $s2
	addi.d	$s4, $s2, -1
	nor	$a0, $s6, $zero
	...
	st.d	$fp, $sp, 16                    # 8-byte Folded Spill
	b	.LBB18_138
.LBB18_136:                             # %sw.bb1.i354
                                        #   in Loop: Header=BB18_138 Depth=1
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB18_217
.LBB18_137:                             # %while.body.i244
                                        #   in Loop: Header=BB18_138 Depth=1
	addi.d	$s3, $s3, 1
	beq	$s3, $s2, .LBB18_216
.LBB18_138:                             # %land.rhs.i240
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB18_146 Depth 2
	ldx.bu	$s0, $s1, $s3
	beq	$s7, $s6, .LBB18_142
# %bb.139:                              # %land.rhs.i240
                                        #   in Loop: Header=BB18_138 Depth=1
	ori	$a0, $zero, 46
	beq	$s7, $a0, .LBB18_137
# %bb.140:                              # %land.rhs.i240
                                        #   in Loop: Header=BB18_138 Depth=1
	beq	$s7, $s8, .LBB18_136
# %bb.141:                              # %sw.default.i358
                                        #   in Loop: Header=BB18_138 Depth=1
	beq	$s0, $s7, .LBB18_137
	b	.LBB18_217
.LBB18_142:                             # %sw.bb3.i315
                                        #   in Loop: Header=BB18_138 Depth=1
	ld.bu	$a1, $s5, 1
	addi.d	$a2, $a1, -94
	sltui	$s6, $a2, 1
	...
	or	$fp, $a3, $a0
	addi.d	$a0, $fp, 1
	bgeu	$a0, $s4, .LBB18_155
# %bb.143:                              # %while.body.i.i328.preheader
                                        #   in Loop: Header=BB18_138 Depth=1
	sltu	$a1, $zero, $a2
	st.d	$a1, $sp, 80                    # 8-byte Folded Spill
	b	.LBB18_146
.LBB18_144:                             # %if.else32.i.i335
                                        #   in Loop: Header=BB18_146 Depth=2
	beq	$s0, $a2, .LBB18_154
.LBB18_145:                             # %if.end39.i.i338
                                        #   in Loop: Header=BB18_146 Depth=2
	move	$fp, $a0
	addi.d	$a0, $a0, 1
	bgeu	$a0, $s4, .LBB18_156
.LBB18_146:                             # %while.body.i.i328
                                        #   Parent Loop BB18_138 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.bu	$a2, $fp, 1
	ld.bu	$a1, $fp, 2
	bne	$a2, $s8, .LBB18_149
# %bb.147:                              # %if.then8.i.i350
                                        #   in Loop: Header=BB18_146 Depth=2
	move	$a0, $s0
	pcaddu18i	$ra, %call36(match_class)
	jirl	$ra, $ra, 0
	bnez	$a0, .LBB18_154
# %bb.148:                              #   in Loop: Header=BB18_146 Depth=2
	addi.d	$a0, $fp, 2
	b	.LBB18_145
.LBB18_149:                             # %if.else.i.i333
                                        #   in Loop: Header=BB18_146 Depth=2
	ori	$a3, $zero, 45
	bne	$a1, $a3, .LBB18_144
# %bb.150:                              # %land.lhs.true.i.i342
                                        #   in Loop: Header=BB18_146 Depth=2
	addi.d	$a1, $fp, 3
	bgeu	$a1, $s4, .LBB18_144
# %bb.151:                              # %if.then20.i.i345
                                        #   in Loop: Header=BB18_146 Depth=2
	bgeu	$s0, $a2, .LBB18_153
# %bb.152:                              #   in Loop: Header=BB18_146 Depth=2
	move	$a0, $a1
	b	.LBB18_145
.LBB18_153:                             # %land.lhs.true26.i.i348
                                        #   in Loop: Header=BB18_146 Depth=2
	ld.bu	$a2, $a1, 0
	move	$a0, $a1
	bltu	$a2, $s0, .LBB18_145
.LBB18_154:                             #   in Loop: Header=BB18_138 Depth=1
	ld.d	$a0, $sp, 80                    # 8-byte Folded Reload
	b	.LBB18_157
.LBB18_155:                             # %singlematch.exit362
                                        #   in Loop: Header=BB18_138 Depth=1
	ld.d	$fp, $sp, 16                    # 8-byte Folded Reload
	ori	$s6, $zero, 91
	ori	$a0, $zero, 94
	beq	$a1, $a0, .LBB18_137
	b	.LBB18_217
.LBB18_156:                             #   in Loop: Header=BB18_138 Depth=1
	move	$a0, $s6
.LBB18_157:                             # %matchbracketclass.exit.i323.loopexit
                                        #   in Loop: Header=BB18_138 Depth=1
	ld.d	$fp, $sp, 16                    # 8-byte Folded Reload
	ori	$s6, $zero, 91
	bnez	$a0, .LBB18_137
	b	.LBB18_217
.LBB18_158:                             # %for.cond.i.preheader
	addi.d	$s1, $s2, 1
	move	$a0, $s8
	move	$a1, $s6
	move	$a2, $s1
...
.LBB18_161:                             # %cleanup.i
	...
	jirl	$ra, $ra, 0
	bnez	$a0, .LBB18_183
.LBB18_162:                             # %if.else.i252
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB18_171 Depth 2
	ld.d	$a0, $s8, 8
	ld.d	$a1, $sp, 80                    # 8-byte Folded Reload
	bgeu	$a1, $a0, .LBB18_182
# %bb.163:                              # %land.lhs.true.i254
                                        #   in Loop: Header=BB18_162 Depth=1
	ld.bu	$a0, $s5, 0
	ld.bu	$s2, $a1, 0
	beq	$a0, $fp, .LBB18_167
# %bb.164:                              # %land.lhs.true.i254
                                        #   in Loop: Header=BB18_162 Depth=1
	beq	$a0, $s0, .LBB18_161
# %bb.165:                              # %land.lhs.true.i254
                                        #   in Loop: Header=BB18_162 Depth=1
	beq	$a0, $s6, .LBB18_160
# %bb.166:                              # %sw.default.i406
                                        #   in Loop: Header=BB18_162 Depth=1
	beq	$s2, $a0, .LBB18_161
	b	.LBB18_182
.LBB18_167:                             # %sw.bb3.i363
                                        #   in Loop: Header=BB18_162 Depth=1
	ld.bu	$a1, $s5, 1
	addi.d	$a2, $a1, -94
	sltui	$fp, $a2, 1
	...
	or	$s0, $a3, $a0
	addi.d	$a0, $s0, 1
	bgeu	$a0, $s3, .LBB18_179
# %bb.168:                              # %while.body.i.i376.preheader
                                        #   in Loop: Header=BB18_162 Depth=1
	sltu	$s8, $zero, $a2
	b	.LBB18_171
.LBB18_169:                             # %if.else32.i.i383
                                        #   in Loop: Header=BB18_171 Depth=2
	beq	$s2, $a2, .LBB18_181
.LBB18_170:                             # %if.end39.i.i386
                                        #   in Loop: Header=BB18_171 Depth=2
	move	$s0, $a0
	addi.d	$a0, $a0, 1
	bgeu	$a0, $s3, .LBB18_180
.LBB18_171:                             # %while.body.i.i376
                                        #   Parent Loop BB18_162 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.bu	$a2, $s0, 1
	ld.bu	$a1, $s0, 2
	bne	$a2, $s6, .LBB18_174
# %bb.172:                              # %if.then8.i.i398
                                        #   in Loop: Header=BB18_171 Depth=2
	move	$a0, $s2
	pcaddu18i	$ra, %call36(match_class)
	jirl	$ra, $ra, 0
...
# %bb.173:                              #   in Loop: Header=BB18_171 Depth=2
	addi.d	$a0, $s0, 2
	b	.LBB18_170
.LBB18_174:                             # %if.else.i.i381
                                        #   in Loop: Header=BB18_171 Depth=2
	bne	$a1, $s7, .LBB18_169
# %bb.175:                              # %land.lhs.true.i.i390
                                        #   in Loop: Header=BB18_171 Depth=2
	addi.d	$a1, $s0, 3
	bgeu	$a1, $s3, .LBB18_169
# %bb.176:                              # %if.then20.i.i393
                                        #   in Loop: Header=BB18_171 Depth=2
	bgeu	$s2, $a2, .LBB18_178
# %bb.177:                              #   in Loop: Header=BB18_171 Depth=2
	move	$a0, $a1
	b	.LBB18_170
.LBB18_178:                             # %land.lhs.true26.i.i396
                                        #   in Loop: Header=BB18_171 Depth=2
	ld.bu	$a2, $a1, 0
	move	$a0, $a1
	bltu	$a2, $s2, .LBB18_170
	b	.LBB18_181
.LBB18_179:                             # %singlematch.exit410
                                        #   in Loop: Header=BB18_162 Depth=1
	ori	$fp, $zero, 91
	ori	$a0, $zero, 94
	ori	$s0, $zero, 46
	beq	$a1, $a0, .LBB18_161
	b	.LBB18_182
.LBB18_180:                             #   in Loop: Header=BB18_162 Depth=1
	move	$s8, $fp
.LBB18_181:                             # %matchbracketclass.exit.i371.loopexit
                                        #   in Loop: Header=BB18_162 Depth=1
	ori	$fp, $zero, 91
	ori	$s0, $zero, 46
	bnez	$s8, .LBB18_161
...
.LBB18_183:                             # %return
	...
	addi.d	$sp, $sp, 176
	ret
.LBB18_184:                             # %while.cond.i.preheader
	move	$s3, $zero
	bgeu	$s6, $a4, .LBB18_208
# %bb.185:                              # %land.rhs.i.lr.ph
	ld.bu	$s0, $s5, 0
	move	$s7, $s2
	addi.d	$s4, $s2, -1
	sub.d	$s2, $a4, $s6
	...
	b	.LBB18_188
.LBB18_186:                             # %sw.default.i310
                                        #   in Loop: Header=BB18_188 Depth=1
	bne	$s1, $s0, .LBB18_211
.LBB18_187:                             # %while.body.i219
                                        #   in Loop: Header=BB18_188 Depth=1
	addi.d	$s3, $s3, 1
	beq	$s3, $s2, .LBB18_210
.LBB18_188:                             # %land.rhs.i
                                        # =>This Loop Header: Depth=1
...
.LBB18_192:                             # %sw.bb3.i267
	...
	or	$fp, $a3, $a0
	addi.d	$a0, $fp, 1
	bgeu	$a0, $s4, .LBB18_205
# %bb.193:                              # %while.body.i.i280.preheader
                                        #   in Loop: Header=BB18_188 Depth=1
	sltu	$a1, $zero, $a2
	st.d	$a1, $sp, 64                    # 8-byte Folded Spill
	b	.LBB18_196
.LBB18_194:                             # %if.else32.i.i287
                                        #   in Loop: Header=BB18_196 Depth=2
	beq	$s1, $a2, .LBB18_204
.LBB18_195:                             # %if.end39.i.i290
                                        #   in Loop: Header=BB18_196 Depth=2
	move	$fp, $a0
	addi.d	$a0, $a0, 1
	bgeu	$a0, $s4, .LBB18_206
.LBB18_196:                             # %while.body.i.i280
                                        #   Parent Loop BB18_188 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.bu	$a2, $fp, 1
	ld.bu	$a1, $fp, 2
	bne	$a2, $s8, .LBB18_199
# %bb.197:                              # %if.then8.i.i302
                                        #   in Loop: Header=BB18_196 Depth=2
	move	$a0, $s1
	pcaddu18i	$ra, %call36(match_class)
	jirl	$ra, $ra, 0
	bnez	$a0, .LBB18_204
# %bb.198:                              #   in Loop: Header=BB18_196 Depth=2
	addi.d	$a0, $fp, 2
	b	.LBB18_195
.LBB18_199:                             # %if.else.i.i285
                                        #   in Loop: Header=BB18_196 Depth=2
	ori	$a3, $zero, 45
	bne	$a1, $a3, .LBB18_194
# %bb.200:                              # %land.lhs.true.i.i294
                                        #   in Loop: Header=BB18_196 Depth=2
	addi.d	$a1, $fp, 3
	bgeu	$a1, $s4, .LBB18_194
# %bb.201:                              # %if.then20.i.i297
                                        #   in Loop: Header=BB18_196 Depth=2
	bgeu	$s1, $a2, .LBB18_203
# %bb.202:                              #   in Loop: Header=BB18_196 Depth=2
	move	$a0, $a1
	b	.LBB18_195
.LBB18_203:                             # %land.lhs.true26.i.i300
                                        #   in Loop: Header=BB18_196 Depth=2
	ld.bu	$a2, $a1, 0
	move	$a0, $a1
	bltu	$a2, $s1, .LBB18_195
.LBB18_204:                             #   in Loop: Header=BB18_188 Depth=1
	ld.d	$a0, $sp, 64                    # 8-byte Folded Reload
	b	.LBB18_207
.LBB18_205:                             # %singlematch.exit314
                                        #   in Loop: Header=BB18_188 Depth=1
	ld.d	$s6, $sp, 80                    # 8-byte Folded Reload
	ld.d	$fp, $sp, 40                    # 8-byte Folded Reload
	ori	$a2, $zero, 91
	...
	beq	$a1, $a0, .LBB18_187
	b	.LBB18_211
.LBB18_206:                             #   in Loop: Header=BB18_188 Depth=1
	move	$a0, $s6
.LBB18_207:                             # %matchbracketclass.exit.i275.loopexit
                                        #   in Loop: Header=BB18_188 Depth=1
	ld.d	$s6, $sp, 80                    # 8-byte Folded Reload
	ld.d	$fp, $sp, 40                    # 8-byte Folded Reload
	ori	$a2, $zero, 91
...
.LBB18_210:
	move	$s3, $s2
.LBB18_211:                             # %while.end.i
	ld.d	$s8, $sp, 72                    # 8-byte Folded Reload
.LBB18_212:                             # %while.end.i
	addi.d	$s1, $s7, 1
	.p2align	4, , 16
.LBB18_213:                             # %while.cond2.i
                                        # =>This Inner Loop Header: Depth=1
	bltz	$s3, .LBB18_182
# %bb.214:                              # %while.body5.i
                                        #   in Loop: Header=BB18_213 Depth=1
	ld.d	$a0, $sp, 80                    # 8-byte Folded Reload
	add.d	$a1, $a0, $s3
	move	$a0, $s8
	move	$a2, $s1
...
.LBB18_216:
	move	$s3, $s2
.LBB18_217:                             # %while.end.i226
	ld.d	$s8, $sp, 72                    # 8-byte Folded Reload
.LBB18_218:                             # %while.end.i226
	addi.d	$s0, $fp, 1
.LBB18_219:                             # %while.cond2.i227
                                        # =>This Inner Loop Header: Depth=1
	bltz	$s3, .LBB18_182
# %bb.220:                              # %while.body5.i232
