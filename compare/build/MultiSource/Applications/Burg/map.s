...
# %bb.0:                                # %entry
	...
	pcalau12i	$a3, %got_pc_hi20(grammarNts)
	ld.d	$a3, $a3, %got_pc_lo12(grammarNts)
	move	$fp, $a1
	ld.d	$a3, $a3, 0
	ld.d	$a1, $a1, 48
	move	$s1, $a2
	...
	beqz	$a3, .LBB1_6
# %bb.1:                                # %entry
	pcalau12i	$a0, %got_pc_hi20(errorState)
	ld.d	$a0, $a0, %got_pc_lo12(errorState)
	ld.d	$a0, $a0, 0
	beqz	$a0, .LBB1_6
# %bb.2:                                # %entry
	pcalau12i	$a2, %pc_hi20(globalMap)
	ld.d	$a2, $a2, %pc_lo12(globalMap)
	bne	$s0, $a2, .LBB1_6
	.p2align	4, , 16
.LBB1_3:                                # %for.body
