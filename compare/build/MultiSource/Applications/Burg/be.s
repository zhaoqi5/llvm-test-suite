...
# %bb.0:                                # %entry
	...
	ld.d	$a1, $a1, %got_pc_lo12(operators)
	ld.d	$s2, $a1, 0
	beqz	$s2, .LBB0_5
...
# %bb.0:                                # %entry
	...
	ld.d	$a3, $a1, %got_pc_lo12(last_user_nonterminal)
	ld.d	$a1, $fp, 0
	pcalau12i	$a2, %pc_hi20(prefix)
	ld.d	$a2, $a2, %pc_lo12(prefix)
...
.LBB6_2:                                # %if.end
	...
	ld.d	$s4, $a0, %got_pc_lo12(last_user_nonterminal)
	ld.d	$a0, $s3, %pc_lo12(outfile)
...
# %bb.1:                                # %for.body.preheader
	...
	pcalau12i	$a1, %got_pc_hi20(sortedStates)
	ld.d	$s5, $a1, %got_pc_lo12(sortedStates)
...
# %bb.0:                                # %entry
	...
	pcalau12i	$s1, %pc_hi20(outfile)
	pcalau12i	$a0, %got_pc_hi20(last_user_nonterminal)
	ld.d	$a3, $a0, %got_pc_lo12(last_user_nonterminal)
	ld.d	$a0, $s1, %pc_lo12(outfile)
	pcalau12i	$a1, %pc_hi20(prefix)
	ld.d	$a2, $a1, %pc_lo12(prefix)
...
# %bb.1:                                # %for.body.preheader
	...
	ld.d	$fp, $a0, %got_pc_lo12(sortedStates)
...
# %bb.3:                                # %for.body.preheader
	...
	addi.d	$s3, $a0, %pc_lo12(.L.str.170)
	pcalau12i	$a0, %pc_hi20(cumBuf)
	addi.d	$s1, $a0, %pc_lo12(cumBuf)
	lu12i.w	$a0, 2002
	ori	$s4, $a0, 48
...
# %bb.0:                                # %entry
	...
	ld.d	$a1, $a0, %got_pc_lo12(max_nonterminal)
	ld.d	$a0, $fp, %pc_lo12(outfile)
	ld.d	$a2, $s0, %pc_lo12(prefix)
	ld.w	$a3, $a1, 0
...
# %bb.0:                                # %entry
	...
	ld.d	$a0, $fp, 0
	pcalau12i	$a1, %pc_hi20(maxOperator)
	st.w	$zero, $a1, %pc_lo12(maxOperator)
	beqz	$a0, .LBB22_6
# %bb.1:                                # %for.body.preheader
	move	$a2, $zero
	b	.LBB22_3
...
# %bb.4:                                # %if.then
                                        #   in Loop: Header=BB22_3 Depth=1
	st.w	$a3, $a1, %pc_lo12(maxOperator)
	move	$a2, $a3
	b	.LBB22_2
...
.LBB23_13:                              # %if.end4.preheader
	...
	addi.d	$s0, $a0, %pc_lo12(.L.str.114)
	pcalau12i	$a0, %pc_hi20(.L.str.116)
	addi.d	$s1, $a0, %pc_lo12(.L.str.116)
	pcalau12i	$a0, %pc_hi20(.L.str.115)
	addi.d	$s2, $a0, %pc_lo12(.L.str.115)
	b	.LBB23_16
	.p2align	4, , 16
.LBB23_14:                              # %if.else
...
# %bb.23:                               # %if.end21.preheader
	...
	addi.d	$s1, $a0, %pc_lo12(.L.str.119)
	b	.LBB23_25
	.p2align	4, , 16
.LBB23_24:                              # %cond.end
...
# %bb.0:                                # %entry
	...
	pcalau12i	$a1, %got_pc_hi20(last_user_nonterminal)
	ld.d	$s2, $a1, %got_pc_lo12(last_user_nonterminal)
	ld.d	$s3, $a0, 0
	ld.w	$a1, $s2, 0
	pcalau12i	$s0, %pc_hi20(outfile)
	pcalau12i	$s1, %pc_hi20(prefix)
...
.LBB31_4:                               # %if.end20
	...
	pcaddu18i	$ra, %call36(fprintf)
	jirl	$ra, $ra, 0
	pcalau12i	$a0, %got_pc_hi20(max_rule)
	ld.d	$a1, $a0, %got_pc_lo12(max_rule)
	ld.d	$a0, $fp, 0
	ld.w	$a2, $a1, 0
	...
	ld.d	$a1, $a0, %got_pc_lo12(max_ruleAST)
	ld.d	$a0, $fp, 0
	ld.w	$a2, $a1, 0
