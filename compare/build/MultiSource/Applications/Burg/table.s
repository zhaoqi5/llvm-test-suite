...
# %bb.60:                               # %for.body.i43.i.preheader
	...
	b	.LBB2_63
	.p2align	4, , 16
.LBB2_61:                               # %if.else.i79.i
                                        #   in Loop: Header=BB2_63 Depth=2
	pcaddu18i	$ra, %call36(freeItem_Set)
	jirl	$ra, $ra, 0
.LBB2_62:                               # %for.inc104.i74.i
                                        #   in Loop: Header=BB2_63 Depth=2
	ld.d	$a0, $s4, 0
	ld.d	$a0, $a0, 24
	ld.w	$a0, $a0, 16
...
.LBB2_66:                               # %if.then77.i123.i
	...
	st.d	$a0, $s2, 8
	.p2align	4, , 16
.LBB2_67:                               # %if.end94.i61.i
                                        #   in Loop: Header=BB2_68 Depth=3
	ld.d	$s7, $s7, 8
	beqz	$s7, .LBB2_64
.LBB2_68:                               # %for.body10.i56.i
                                        #   Parent Loop BB2_5 Depth=1
...
# %bb.71:                               # %if.then.i97.i
	...
	ld.d	$a3, $a1, 8
	beqz	$a3, .LBB2_66
# %bb.72:                               # %lor.lhs.false.i114.i
                                        #   in Loop: Header=BB2_68 Depth=3
	addi.d	$a0, $sp, 28
	pcaddu18i	$ra, %call36(LESSCOST)
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB2_67
# %bb.73:                               # %lor.lhs.false.if.then77_crit_edge.i117.i
                                        #   in Loop: Header=BB2_68 Depth=3
	ld.d	$a1, $s3, 24
	ld.d	$a0, $s2, 48
	ld.w	$a2, $a1, 8
