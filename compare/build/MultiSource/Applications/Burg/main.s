...
.LBB0_6:                                # %for.body.preheader
	...
	pcalau12i	$a1, %got_pc_hi20(prevent_divergence)
	ld.d	$a1, $a1, %got_pc_lo12(prevent_divergence)
	st.d	$a1, $sp, 40                    # 8-byte Folded Spill
	pcalau12i	$a1, %got_pc_hi20(exceptionTolerance)
	ld.d	$a1, $a1, %got_pc_lo12(exceptionTolerance)
	st.d	$a1, $sp, 32                    # 8-byte Folded Spill
	addi.d	$a0, $a0, %pc_lo12(version)
	st.d	$a0, $sp, 8                     # 8-byte Folded Spill
	pcalau12i	$s3, %pc_hi20(diagnostics)
	ori	$s1, $zero, 1
	b	.LBB0_9
.LBB0_7:                                # %if.then54
...
.LBB0_18:                               # %sw.bb17
                                        #   in Loop: Header=BB0_9 Depth=1
	st.b	$s4, $s3, %pc_lo12(diagnostics)
	b	.LBB0_8
.LBB0_19:                               # %sw.bb15
                                        #   in Loop: Header=BB0_9 Depth=1
	move	$a3, $zero
