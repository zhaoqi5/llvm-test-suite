...
# %bb.0:                                # %entry
	...
	slli.d	$a0, $a0, 3
	alsl.d	$a0, $fp, $a0, 2
	pcalau12i	$a1, %pc_hi20(g_info_totals)
	addi.d	$a1, $a1, %pc_lo12(g_info_totals)
	stx.w	$zero, $a1, $a0
...
# %bb.16:                               # %if.then32.us
	...
	b	.LBB3_14
.LBB3_17:                               # %for.end49
	pcalau12i	$a0, %pc_hi20(g_info_totals)
	addi.d	$s6, $a0, %pc_lo12(g_info_totals)
	ld.w	$a1, $s3, 4
	st.w	$zero, $s6, 16
	pcalau12i	$a0, %pc_hi20(g_info)
	addi.d	$s5, $a0, %pc_lo12(g_info)
	blez	$a1, .LBB3_20
...
.LBB3_22:                               # %for.body.i75
	...
	addi.d	$s8, $s8, 12
	blt	$s7, $a0, .LBB3_22
# %bb.23:                               # %init__real_count.exit81.loopexit
	ld.w	$a1, $s3, 4
.LBB3_24:                               # %init__real_count.exit81
	st.w	$zero, $s6, 12
	blez	$a1, .LBB3_28
# %bb.25:                               # %for.body.i84.preheader
	move	$s7, $zero
	addi.d	$s8, $s5, 396
	ori	$s2, $zero, 1
	.p2align	4, , 16
.LBB3_26:                               # %for.body.i84
                                        # =>This Inner Loop Header: Depth=1
	addi.d	$s7, $s7, 1
	st.w	$zero, $s8, 0
	ori	$a0, $zero, 1
...
.LBB3_28:                               # %init__safe_count.exit
	st.w	$zero, $s6, 0
	blez	$a0, .LBB3_31
# %bb.29:                               # %for.body.i91.preheader
	move	$s6, $zero
	addi.d	$s5, $s5, 12
	ori	$s2, $zero, 1
	.p2align	4, , 16
.LBB3_30:                               # %for.body.i91
                                        # =>This Inner Loop Header: Depth=1
	addi.d	$s6, $s6, 1
	st.w	$zero, $s5, 0
	move	$a0, $zero
	...
	addi.d	$s5, $s5, 12
	blt	$s6, $a0, .LBB3_30
.LBB3_31:                               # %init__safe_count.exit96
	pcalau12i	$a1, %got_pc_hi20(g_norm_hashkey)
	ld.d	$a7, $a1, %got_pc_lo12(g_norm_hashkey)
	vrepli.b	$vr0, 0
	vst	$vr0, $a7, 0
...
# %bb.41:                               # %for.cond1.preheader.us.preheader.i
	...
	addi.d	$a6, $a5, %pc_lo12(g_zobrist)
	move	$t0, $zero
	move	$t1, $zero
	move	$t2, $zero
	move	$t3, $zero
...
.LBB3_49:                               # %init_hashkey_code.exit
	...
	b	.LBB3_51
	.p2align	4, , 16
.LBB3_50:                               # %for.cond1.for.inc12_crit_edge.us.i121
	...
	add.d	$a7, $a7, $a3
	beq	$t2, $a0, .LBB3_55
.LBB3_51:                               # %for.cond1.preheader.us.i104
                                        # =>This Loop Header: Depth=1
...
# %bb.54:                               # %if.then.us.i115
	...
	st.w	$t1, $a4, 16
	b	.LBB3_52
.LBB3_55:                               # %init_hashkey_code.exit124
	move	$a4, $zero
	move	$a7, $zero
	move	$t0, $zero
	move	$t1, $zero
...
.LBB3_56:                               # %for.cond1.for.inc12_crit_edge.us.i147
	...
	add.d	$a4, $a4, $a3
	beq	$t1, $a0, .LBB3_61
.LBB3_57:                               # %for.cond1.preheader.us.i130
                                        # =>This Loop Header: Depth=1
...
.LBB3_59:                               # %for.body3.us.i132
	...
	andi	$t7, $t7, 1
	beqz	$t7, .LBB3_58
# %bb.60:                               # %if.then.us.i141
                                        #   in Loop: Header=BB3_59 Depth=2
	ld.w	$t7, $t5, 0
	xor	$t0, $t7, $t0
	st.w	$t0, $a2, 16
	b	.LBB3_58
.LBB3_61:                               # %init_hashkey_code.exit150
	move	$a2, $zero
	move	$a4, $zero
	move	$a7, $zero
	move	$t0, $zero
	...
	b	.LBB3_63
	.p2align	4, , 16
.LBB3_62:                               # %for.cond1.for.inc12_crit_edge.us.i173
	...
	add.d	$a2, $a2, $a3
	beq	$t0, $a0, .LBB3_48
.LBB3_63:                               # %for.cond1.preheader.us.i156
                                        # =>This Loop Header: Depth=1
