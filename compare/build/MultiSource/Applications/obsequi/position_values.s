...
.LBB0_3:                                # %for.cond25.preheader.preheader
	...
	ori	$t1, $zero, 2
	ori	$t2, $zero, 260
	pcalau12i	$t3, %got_pc_hi20(g_first_move)
	ld.d	$t3, $t3, %got_pc_lo12(g_first_move)
	.p2align	4, , 16
...
# %bb.9:                                # %for.cond25.preheader.preheader.1
	...
	ori	$t2, $t3, 260
	ori	$t3, $t3, 4
	pcalau12i	$t4, %got_pc_hi20(g_first_move)
	ld.d	$t4, $t4, %got_pc_lo12(g_first_move)
	.p2align	4, , 16
...
# %bb.25:                               # %for.cond86.preheader.preheader
	...
	ori	$t0, $zero, 70
	ori	$t1, $zero, 3
	pcalau12i	$t2, %got_pc_hi20(g_first_move)
	ld.d	$t2, $t2, %got_pc_lo12(g_first_move)
	move	$t3, $t2
	b	.LBB0_27
	.p2align	4, , 16
