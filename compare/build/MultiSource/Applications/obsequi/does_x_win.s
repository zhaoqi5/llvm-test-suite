...
# %bb.0:                                # %entry
	...
	ld.d	$a2, $a2, %got_pc_lo12(g_empty_squares)
	slli.d	$a3, $s2, 2
	pcalau12i	$a4, %got_pc_hi20(g_board_size)
	ld.d	$a4, $a4, %got_pc_lo12(g_board_size)
	ldx.w	$a3, $a4, $a3
	blez	$a3, .LBB0_7
...
# %bb.0:                                # %entry
	...
	ld.d	$a6, $a6, %got_pc_lo12(g_board_size)
	slli.d	$a7, $a1, 2
	ldx.w	$a7, $a6, $a7
	blez	$a7, .LBB1_39
# %bb.1:                                # %for.body.lr.ph
	...
	ld.d	$t5, $a1, %got_pc_lo12(g_board)
	move	$t4, $zero
	move	$s7, $zero
	move	$a1, $zero
	move	$t0, $zero
...
# %bb.13:                               # %if.then77
	...
	ori	$s8, $zero, 1
	slli.d	$a6, $s7, 2
	pcalau12i	$s2, %pc_hi20(.LJTI1_0)
	addi.d	$s2, $s2, %pc_lo12(.LJTI1_0)
	ldx.w	$a6, $s2, $a6
	add.d	$a6, $s2, $a6
	move	$s7, $s6
	jr	$a6
...
# %bb.19:                               # %if.else97
	...
	ori	$s8, $zero, 2
	slli.d	$a6, $s7, 2
	pcalau12i	$s2, %pc_hi20(.LJTI1_1)
	addi.d	$s2, $s2, %pc_lo12(.LJTI1_1)
	ldx.w	$a6, $s2, $a6
	add.d	$a6, $s2, $a6
	move	$s7, $s1
	jr	$a6
...
# %bb.0:                                # %entry
	...
	ld.d	$a5, $a5, %got_pc_lo12(g_board_size)
	slli.d	$a6, $a1, 2
	ldx.w	$t6, $a5, $a6
	blez	$t6, .LBB2_21
# %bb.1:                                # %for.body.lr.ph
	...
	ld.d	$a6, $a6, %got_pc_lo12(g_board)
	add.d	$a6, $a6, $a1
	ld.w	$t2, $a6, 4
	move	$t1, $zero
	move	$a1, $zero
