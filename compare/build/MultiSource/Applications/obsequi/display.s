...
# %bb.53:                               # %for.cond2.preheader.us.preheader.i248
	...
	b	.LBB0_55
	.p2align	4, , 16
.LBB0_54:                               # %for.cond2.for.inc12_crit_edge.us.i272
...
# %bb.60:                               # %if.then16.i247
	...
	ld.w	$t4, $s6, 0
	ld.w	$s8, $s6, 4
.LBB0_61:                               # %check_hashkey_code.exit274
	pcalau12i	$a0, %got_pc_hi20(g_flipH_hashkey)
	...
	vst	$vr0, $sp, 112
	blt	$t4, $a1, .LBB0_69
# %bb.62:                               # %check_hashkey_code.exit274
	blt	$s8, $a1, .LBB0_69
# %bb.63:                               # %for.cond2.preheader.us.preheader.i283
	pcalau12i	$a1, %got_pc_hi20(g_zobrist)
	ld.d	$a4, $a1, %got_pc_lo12(g_zobrist)
	move	$a1, $zero
	move	$a2, $zero
	...
	b	.LBB0_65
	.p2align	4, , 16
.LBB0_64:                               # %for.cond2.for.inc12_crit_edge.us.i307
                                        #   in Loop: Header=BB0_65 Depth=1
	addi.d	$a4, $a4, 128
	add.d	$a2, $a2, $s8
	add.d	$a1, $a1, $s8
	beq	$a3, $t4, .LBB0_69
.LBB0_65:                               # %for.cond2.preheader.us.i285
                                        # =>This Loop Header: Depth=1
...
.LBB0_67:                               # %for.body4.us.i290
	...
	andi	$t3, $t3, 1
	beqz	$t3, .LBB0_66
# %bb.68:                               # %if.then.us.i301
                                        #   in Loop: Header=BB0_67 Depth=2
	ld.w	$t3, $t1, 0
	xor	$a0, $t3, $a0
	b	.LBB0_66
.LBB0_69:                               # %for.end14.i279
	beqz	$a0, .LBB0_71
# %bb.70:                               # %if.then16.i282
	pcalau12i	$a0, %pc_hi20(.L.str.1)
	addi.d	$a0, $a0, %pc_lo12(.L.str.1)
	pcalau12i	$a1, %pc_hi20(.L.str.29)
	addi.d	$a3, $a1, %pc_lo12(.L.str.29)
	...
	ld.w	$t4, $s6, 0
	ld.w	$s8, $s6, 4
.LBB0_71:                               # %check_hashkey_code.exit309
	pcalau12i	$a0, %got_pc_hi20(g_flipVH_hashkey)
	...
	vst	$vr0, $sp, 112
	blt	$t4, $a1, .LBB0_79
# %bb.72:                               # %check_hashkey_code.exit309
	blt	$s8, $a1, .LBB0_79
# %bb.73:                               # %for.cond2.preheader.us.preheader.i318
	pcalau12i	$a1, %got_pc_hi20(g_zobrist)
	ld.d	$a4, $a1, %got_pc_lo12(g_zobrist)
	move	$a1, $zero
	move	$a2, $zero
	...
	b	.LBB0_75
	.p2align	4, , 16
.LBB0_74:                               # %for.cond2.for.inc12_crit_edge.us.i342
                                        #   in Loop: Header=BB0_75 Depth=1
	addi.d	$a4, $a4, 128
	add.d	$a2, $a2, $s8
	add.d	$a1, $a1, $s8
	beq	$a3, $t4, .LBB0_79
.LBB0_75:                               # %for.cond2.preheader.us.i320
                                        # =>This Loop Header: Depth=1
...
.LBB0_77:                               # %for.body4.us.i325
	...
	andi	$t3, $t3, 1
	beqz	$t3, .LBB0_76
# %bb.78:                               # %if.then.us.i336
                                        #   in Loop: Header=BB0_77 Depth=2
	ld.w	$t3, $t1, 0
	xor	$a0, $t3, $a0
	b	.LBB0_76
.LBB0_79:                               # %for.end14.i314
	beqz	$a0, .LBB0_89
# %bb.80:                               # %if.then16.i317
	pcalau12i	$a0, %pc_hi20(.L.str.1)
	addi.d	$a0, $a0, %pc_lo12(.L.str.1)
	pcalau12i	$a1, %pc_hi20(.L.str.29)
	addi.d	$a3, $a1, %pc_lo12(.L.str.29)
...
# %bb.88:                               # %if.then.us.i
	...
	xor	$a0, $t3, $a0
	b	.LBB0_86
.LBB0_89:                               # %check_hashkey_code.exit344
	ld.d	$s8, $sp, 136                   # 8-byte Folded Reload
	ld.d	$s7, $sp, 144                   # 8-byte Folded Reload
	ld.d	$s6, $sp, 152                   # 8-byte Folded Reload
	ld.d	$s5, $sp, 160                   # 8-byte Folded Reload
...
.LBB1_22:                               # %for.body5.us.i26
	...
	move	$a0, $s1
	bne	$fp, $s1, .LBB1_22
# %bb.23:                               # %for.cond3.for.end_crit_edge.us.i35
