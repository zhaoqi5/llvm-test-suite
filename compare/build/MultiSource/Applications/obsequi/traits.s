...
.LBB0_7:                                # %vector.body
	...
	xvpickve.w	$xr8, $xr7, 1
	xvinsve0.w	$xr6, $xr8, 2
	xvpickve.w	$xr8, $xr7, 2
	xvinsve0.w	$xr6, $xr8, 3
	xvpickve.w	$xr8, $xr7, 3
	xvinsve0.w	$xr6, $xr8, 4
	xvpickve.w	$xr9, $xr7, 4
	xvinsve0.w	$xr6, $xr9, 5
	xvpickve.w	$xr10, $xr7, 5
	xvinsve0.w	$xr6, $xr10, 6
	xvpickve.w	$xr11, $xr7, 6
	xvinsve0.w	$xr6, $xr11, 7
	xvpickve.w	$xr11, $xr7, 7
	xvpickve.w	$xr12, $xr5, 7
	xvinsve0.w	$xr5, $xr11, 0
	xvinsve0.w	$xr5, $xr0, 1
	xvpickve.w	$xr11, $xr0, 1
	xvinsve0.w	$xr5, $xr11, 2
	xvpickve.w	$xr11, $xr0, 2
	xvinsve0.w	$xr5, $xr11, 3
	xvpickve.w	$xr11, $xr0, 3
	xvinsve0.w	$xr5, $xr11, 4
	xvpickve.w	$xr11, $xr0, 4
	xvinsve0.w	$xr5, $xr11, 5
	xvpickve.w	$xr11, $xr0, 5
	xvinsve0.w	$xr5, $xr11, 6
	xvpickve.w	$xr11, $xr0, 6
	xvinsve0.w	$xr5, $xr11, 7
	xvinsve0.w	$xr11, $xr12, 0
	xvinsve0.w	$xr11, $xr6, 1
	xvpickve.w	$xr12, $xr6, 1
	xvinsve0.w	$xr11, $xr12, 2
	xvpickve.w	$xr12, $xr6, 2
	xvinsve0.w	$xr11, $xr12, 3
	xvpickve.w	$xr12, $xr6, 3
	xvinsve0.w	$xr11, $xr12, 4
	xvinsve0.w	$xr11, $xr8, 5
	xvinsve0.w	$xr11, $xr9, 6
	xvinsve0.w	$xr11, $xr10, 7
	xvpickve.d	$xr8, $xr7, 3
	xvinsve0.d	$xr8, $xr8, 0
	xvinsve0.d	$xr8, $xr0, 1
	xvpickve.d	$xr9, $xr0, 1
	xvinsve0.d	$xr8, $xr9, 2
	xvpickve.d	$xr9, $xr0, 2
	...
	vpickve2gr.w	$s7, $vr7, 1
	bstrpick.d	$s7, $s7, 15, 0
	vpickve2gr.w	$s8, $vr7, 0
	...
	xvinsgr2vr.w	$xr9, $t2, 4
	xvinsgr2vr.w	$xr9, $t3, 5
	xvinsgr2vr.w	$xr9, $t4, 6
...
.LBB0_20:                               # %for.body.i27.preheader
	sub.d	$a0, $a0, $a4
	alsl.d	$a3, $a4, $a3, 2
	add.d	$a3, $a3, $a1
	pcalau12i	$a1, %got_pc_hi20(countbits16)
...
.LBB0_42:                               # %vector.body153
	...
	xvinsve0.w	$xr7, $xr6, 0
	xvinsve0.w	$xr7, $xr0, 1
	xvpickve.w	$xr6, $xr0, 1
	xvinsve0.w	$xr7, $xr6, 2
	xvpickve.w	$xr6, $xr0, 2
	xvinsve0.w	$xr7, $xr6, 3
	xvpickve.w	$xr6, $xr0, 3
	xvinsve0.w	$xr7, $xr6, 4
	xvpickve.w	$xr6, $xr0, 4
	xvinsve0.w	$xr7, $xr6, 5
	xvpickve.w	$xr6, $xr0, 5
	xvinsve0.w	$xr7, $xr6, 6
	xvpickve.w	$xr6, $xr0, 6
	xvinsve0.w	$xr7, $xr6, 7
	xvxor.v	$xr6, $xr4, $xr5
	xvxor.v	$xr7, $xr0, $xr7
	xvand.v	$xr4, $xr6, $xr2
	xvand.v	$xr5, $xr7, $xr2
...
.LBB0_50:
	move	$a2, $zero
	b	.LBB0_62
.LBB0_51:                               # %vector.main.loop.iter.check174
	ori	$a2, $zero, 15
	bgeu	$a1, $a2, .LBB0_53
# %bb.52:
	move	$a1, $zero
...
# %bb.55:                               # %middle.block185
	...
	xvpickve2gr.w	$a2, $xr0, 0
	beq	$a1, $a0, .LBB0_62
# %bb.56:                               # %vec.epilog.iter.check192
	andi	$a3, $a0, 12
	beqz	$a3, .LBB0_60
.LBB0_57:                               # %vec.epilog.ph191
	...
	sub.d	$a4, $a4, $a1
	.p2align	4, , 16
.LBB0_58:                               # %vec.epilog.vector.body197
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a3, 0
	vsrli.w	$vr2, $vr1, 1
	...
	addi.d	$a3, $a3, 16
	bnez	$a4, .LBB0_58
# %bb.59:                               # %vec.epilog.middle.block202
	vshuf4i.w	$vr1, $vr0, 14
	vadd.w	$vr0, $vr0, $vr1
	vreplvei.w	$vr1, $vr0, 1
	vadd.w	$vr0, $vr0, $vr1
	vpickve2gr.w	$a2, $vr0, 0
	beq	$a1, $a0, .LBB0_62
.LBB0_60:                               # %for.body.i78.preheader
	pcalau12i	$a3, %got_pc_hi20(g_board)
	ld.d	$a3, $a3, %got_pc_lo12(g_board)
	sub.d	$a0, $a0, $a1
	alsl.d	$a1, $a1, $s3, 2
...
.LBB1_5:                                # %vector.body
	...
	xvpickve.w	$xr7, $xr6, 1
	xvinsve0.w	$xr5, $xr7, 2
	xvpickve.w	$xr7, $xr6, 2
	xvinsve0.w	$xr5, $xr7, 3
	xvpickve.w	$xr7, $xr6, 3
	xvinsve0.w	$xr5, $xr7, 4
	xvpickve.w	$xr8, $xr6, 4
	xvinsve0.w	$xr5, $xr8, 5
	xvpickve.w	$xr9, $xr6, 5
	xvinsve0.w	$xr5, $xr9, 6
	xvpickve.w	$xr10, $xr6, 6
	xvinsve0.w	$xr5, $xr10, 7
	xvpickve.w	$xr10, $xr6, 7
	xvpickve.w	$xr11, $xr4, 7
	xvinsve0.w	$xr4, $xr10, 0
	xvinsve0.w	$xr4, $xr0, 1
	xvpickve.w	$xr10, $xr0, 1
	xvinsve0.w	$xr4, $xr10, 2
	xvpickve.w	$xr10, $xr0, 2
	xvinsve0.w	$xr4, $xr10, 3
	xvpickve.w	$xr10, $xr0, 3
	xvinsve0.w	$xr4, $xr10, 4
	xvpickve.w	$xr10, $xr0, 4
	xvinsve0.w	$xr4, $xr10, 5
	xvpickve.w	$xr10, $xr0, 5
	xvinsve0.w	$xr4, $xr10, 6
	xvpickve.w	$xr10, $xr0, 6
	xvinsve0.w	$xr4, $xr10, 7
	xvinsve0.w	$xr10, $xr11, 0
	xvinsve0.w	$xr10, $xr5, 1
	xvpickve.w	$xr11, $xr5, 1
	xvinsve0.w	$xr10, $xr11, 2
	xvpickve.w	$xr11, $xr5, 2
	xvinsve0.w	$xr10, $xr11, 3
	xvpickve.w	$xr11, $xr5, 3
	xvinsve0.w	$xr10, $xr11, 4
	xvinsve0.w	$xr10, $xr7, 5
	xvinsve0.w	$xr10, $xr8, 6
	xvinsve0.w	$xr10, $xr9, 7
	xvpickve.d	$xr7, $xr6, 3
	xvinsve0.d	$xr7, $xr7, 0
	xvinsve0.d	$xr7, $xr0, 1
	xvpickve.d	$xr8, $xr0, 1
	xvinsve0.d	$xr7, $xr8, 2
	xvpickve.d	$xr8, $xr0, 2
	...
	ldx.w	$t1, $a6, $t1
	ldx.w	$t0, $a6, $t0
	xvinsgr2vr.w	$xr5, $t7, 0
	xvinsgr2vr.w	$xr5, $t6, 1
	xvinsgr2vr.w	$xr5, $t5, 2
	xvinsgr2vr.w	$xr5, $t4, 3
	xvinsgr2vr.w	$xr5, $t3, 4
	xvinsgr2vr.w	$xr5, $t2, 5
	...
	xvinsgr2vr.w	$xr6, $t2, 2
	xvinsgr2vr.w	$xr6, $t3, 3
	xvinsgr2vr.w	$xr6, $t4, 4
	xvinsgr2vr.w	$xr6, $t5, 5
	xvinsgr2vr.w	$xr6, $t6, 6
	...
	bstrpick.d	$t8, $t8, 15, 0
	vpickve2gr.w	$fp, $vr7, 2
	bstrpick.d	$fp, $fp, 15, 0
	vpickve2gr.w	$s0, $vr7, 1
	bstrpick.d	$s0, $s0, 15, 0
	vpickve2gr.w	$s1, $vr7, 0
	bstrpick.d	$s1, $s1, 15, 0
	vpickve2gr.w	$s2, $vr8, 3
	bstrpick.d	$s2, $s2, 15, 0
	vpickve2gr.w	$s3, $vr8, 2
	bstrpick.d	$s3, $s3, 15, 0
	...
	xvinsgr2vr.w	$xr8, $t3, 3
	xvinsgr2vr.w	$xr8, $t4, 4
	xvinsgr2vr.w	$xr8, $t5, 5
	xvinsgr2vr.w	$xr8, $t6, 6
	xvinsgr2vr.w	$xr8, $t7, 7
	xvadd.w	$xr1, $xr5, $xr1
	xvadd.w	$xr3, $xr6, $xr3
	xvadd.w	$xr1, $xr1, $xr7
	xvadd.w	$xr3, $xr3, $xr8
