...
.LBB3_27:                               # %for.body12.i86
	...
	or	$t4, $t4, $t8
	bnez	$t6, .LBB3_27
.LBB3_28:                               # %StickyShiftRightMant.exit99
	st.b	$a4, $a3, 0
	xor	$t8, $a1, $a0
	move	$t6, $t7
	st.b	$t8, $a3, 1
...
.LBB3_39:                               # %if.else.i.i
	...
	st.h	$a1, $a3, 2
	beqz	$a0, .LBB3_45
# %bb.40:                               # %denormalize.exit.thread.i
	ld.h	$a0, $a3, 6
	ld.hu	$a1, $a3, 4
	ld.h	$a2, $a3, 8
	ld.hu	$a4, $a3, 10
...
.LBB3_42:                               # %denormalize.exit.i
	beqz	$a0, .LBB3_45
# %bb.43:                               # %denormalize.exit.i.if.then10.i_crit_edge
	ld.hu	$a0, $a3, 10
.LBB3_44:                               # %if.then10.i
	bstrpick.d	$a0, $a0, 15, 3
	slli.d	$a0, $a0, 3
