...
# %bb.123:                              # %if.then.i.i146
	...
	pcaddu18i	$ra, %call36(fputs)
	jirl	$ra, $ra, 0
.LBB0_124:                              # %output_string.exit.i
                                        #   in Loop: Header=BB0_111 Depth=1
	ld.d	$a0, $sp, 136                   # 8-byte Folded Reload
	b	.LBB0_139
.LBB0_125:                              # %sw.bb27.i142
                                        #   in Loop: Header=BB0_111 Depth=1
...
# %bb.128:                              # %if.then.i18.i
	...
	pcaddu18i	$ra, %call36(fputs)
	jirl	$ra, $ra, 0
.LBB0_129:                              # %output_string.exit20.i
                                        #   in Loop: Header=BB0_111 Depth=1
	ld.d	$a0, $sp, 120                   # 8-byte Folded Reload
	ld.d	$a2, $a0, 32
	addi.d	$a0, $sp, 200
...
# %bb.131:                              # %if.then.i28.i
	...
	pcaddu18i	$ra, %call36(fputs)
	jirl	$ra, $ra, 0
.LBB0_132:                              # %output_string.exit30.i
                                        #   in Loop: Header=BB0_111 Depth=1
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	ld.d	$a2, $a0, 16
...
# %bb.134:                              # %if.then.i58.i
	...
	pcaddu18i	$ra, %call36(fputs)
	jirl	$ra, $ra, 0
.LBB0_135:                              # %output_string.exit60.i
                                        #   in Loop: Header=BB0_111 Depth=1
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
	ld.d	$a2, $a0, 24
	b	.LBB0_146
...
# %bb.137:                              # %if.then.i8.i
	...
	pcaddu18i	$ra, %call36(fputs)
	jirl	$ra, $ra, 0
.LBB0_138:                              # %output_string.exit10.i
                                        #   in Loop: Header=BB0_111 Depth=1
	ld.d	$a0, $sp, 128                   # 8-byte Folded Reload
.LBB0_139:                              # %output_string.exit.i
                                        #   in Loop: Header=BB0_111 Depth=1
	ld.d	$a2, $a0, 32
	addi.d	$a0, $sp, 200
	ld.d	$a1, $sp, 48                    # 8-byte Folded Reload
...
# %bb.143:                              # %if.then.i48.i
	...
	pcaddu18i	$ra, %call36(fputs)
	jirl	$ra, $ra, 0
.LBB0_144:                              # %output_string.exit50.i
                                        #   in Loop: Header=BB0_111 Depth=1
	ld.d	$a0, $sp, 104                   # 8-byte Folded Reload
	ld.d	$a2, $a0, 24
...
.LBB0_145:                              # %sw.bb49.i
	...
	ld.d	$a2, $a0, 16
.LBB0_146:                              # %output_string.exit60.i
                                        #   in Loop: Header=BB0_111 Depth=1
	pcalau12i	$a0, %pc_hi20(.L.str.93)
	addi.d	$a1, $a0, %pc_lo12(.L.str.93)
.LBB0_147:                              # %sw.bb53.i
