...
# %bb.0:                                # %entry
	...
	move	$fp, $a1
	pcalau12i	$a1, %got_pc_hi20(global_align)
	ld.d	$s0, $a1, %got_pc_lo12(global_align)
	ld.w	$a1, $s0, 0
	alsl.d	$a0, $a1, $a0, 1
...
# %bb.0:                                # %entry
	...
	ld.d	$a3, $a0, %got_pc_lo12(mem_array_ents)
	ld.w	$a7, $a3, 0
	addi.w	$a0, $zero, -1
	blez	$a7, .LBB3_4
# %bb.1:                                # %for.body.preheader
	addi.d	$a4, $a7, -1
	pcalau12i	$a5, %got_pc_hi20(mem_array)
	ld.d	$a5, $a5, %got_pc_lo12(mem_array)
	addi.d	$a5, $a5, 168
