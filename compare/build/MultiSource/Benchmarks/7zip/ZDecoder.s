...
.LBB6_29:                               #   in Loop: Header=BB6_18 Depth=3
	move	$fp, $zero
.LBB6_30:                               # %for.cond.cleanup.i
                                        #   in Loop: Header=BB6_18 Depth=3
	add.d	$a0, $s3, $fp
	st.d	$a0, $sp, 184
.LBB6_31:                               #   in Loop: Header=BB6_18 Depth=3
	move	$fp, $s5
.LBB6_32:                               # %invoke.cont64
                                        #   in Loop: Header=BB6_18 Depth=3
.Ltmp57:                                # EH_LABEL
	addi.d	$a0, $sp, 128
...
# %bb.41:                               # %if.end114
	...
	or	$s3, $a1, $a0
	beqz	$s3, .LBB6_56
# %bb.42:                               # %while.cond.preheader
                                        #   in Loop: Header=BB6_18 Depth=3
	ori	$a0, $zero, 256
	bltu	$fp, $a0, .LBB6_46
# %bb.43:                               # %while.body.preheader
                                        #   in Loop: Header=BB6_18 Depth=3
	move	$a0, $zero
	move	$a2, $zero
	move	$a1, $fp
...
# %bb.45:                               # %while.end
	...
	b	.LBB6_49
	.p2align	4, , 16
.LBB6_46:                               #   in Loop: Header=BB6_18 Depth=3
	move	$a0, $zero
	move	$a1, $fp
	ld.d	$a2, $s0, 40
	andi	$a3, $s6, 1
...
# %bb.55:                               # %if.then168
	...
	addi.w	$s5, $s5, 1
	b	.LBB6_15
.LBB6_56:                               #   in Loop: Header=BB6_15 Depth=1
	ori	$a1, $zero, 257
	ori	$s5, $zero, 9
	b	.LBB6_15
.LBB6_57:                               # %if.then27
...
.Ltmp72:                                # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp73:                                # EH_LABEL
.LBB6_71:                               # %_ZN10COutBufferD2Ev.exit
.Ltmp75:                                # EH_LABEL
	addi.d	$a0, $sp, 184
	pcaddu18i	$ra, %call36(_ZN9CInBuffer4FreeEv)
	jirl	$ra, $ra, 0
.Ltmp76:                                # EH_LABEL
# %bb.72:                               # %invoke.cont.i75
	ld.d	$a0, $sp, 208
	beqz	$a0, .LBB6_74
# %bb.73:                               # %if.then.i.i78
	ld.d	$a1, $a0, 0
...
.Ltmp78:                                # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp79:                                # EH_LABEL
.LBB6_74:                               # %_ZN9CInBufferD2Ev.exit
	move	$a0, $s3
...
.LBB6_77:
	ori	$s3, $zero, 1
	b	.LBB6_68
.LBB6_78:                               # %lpad63.loopexit.split-lp
.Ltmp68:                                # EH_LABEL
	b	.LBB6_89
.LBB6_79:                               # %lpad76
.Ltmp62:                                # EH_LABEL
...
.Ltmp59:                                # EH_LABEL
	b	.LBB6_89
.LBB6_82:                               # %terminate.lpad.i.i82
.Ltmp80:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB6_83:                               # %terminate.lpad.i.i
.Ltmp74:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB6_84:                               # %terminate.lpad.i74
.Ltmp77:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB6_85:                               # %terminate.lpad.i
.Ltmp71:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB6_86:                               # %lpad3
.Ltmp40:                                # EH_LABEL
	b	.LBB6_89
.LBB6_87:                               # %lpad63.loopexit
.Ltmp56:                                # EH_LABEL
	b	.LBB6_89
.LBB6_88:                               # %lpad154
.Ltmp65:                                # EH_LABEL
.LBB6_89:                               # %ehcleanup204
	move	$fp, $a0
	addi.d	$a0, $sp, 128
