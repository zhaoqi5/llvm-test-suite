...
# %bb.0:                                # %entry
	...
	.cfi_offset 22, -16
	move	$fp, $a0
	pcalau12i	$a0, %pc_hi20(_ZTVN9NCompress5NBcj28CEncoderE+16)
	addi.d	$a1, $a0, %pc_lo12(_ZTVN9NCompress5NBcj28CEncoderE+16)
	ld.d	$a0, $fp, 16
	st.d	$a1, $fp, 0
.Ltmp0:                                 # EH_LABEL
...
.Ltmp18:                                # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp19:                                # EH_LABEL
.LBB1_10:                               # %_ZN10COutBufferD2Ev.exit11
	addi.d	$a0, $fp, 24
.Ltmp21:                                # EH_LABEL
	pcaddu18i	$ra, %call36(_ZN10COutBuffer4FreeEv)
	jirl	$ra, $ra, 0
.Ltmp22:                                # EH_LABEL
# %bb.11:                               # %invoke.cont.i13
	ld.d	$a0, $fp, 48
	beqz	$a0, .LBB1_13
# %bb.12:                               # %if.then.i.i16
	ld.d	$a1, $a0, 0
...
.Ltmp24:                                # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp25:                                # EH_LABEL
.LBB1_13:                               # %_ZN10COutBufferD2Ev.exit21
	ld.d	$fp, $sp, 0                     # 8-byte Folded Reload
	ld.d	$ra, $sp, 8                     # 8-byte Folded Reload
	addi.d	$sp, $sp, 16
	ret
.LBB1_14:                               # %terminate.lpad.i.i20
.Ltmp26:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB1_15:                               # %terminate.lpad.i.i10
.Ltmp20:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB1_16:                               # %terminate.lpad.i.i1
.Ltmp14:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB1_17:                               # %terminate.lpad.i.i.i
.Ltmp8:                                 # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB1_18:                               # %terminate.lpad.i12
.Ltmp23:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB1_19:                               # %terminate.lpad.i2
.Ltmp17:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB1_20:                               # %terminate.lpad.i
.Ltmp11:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB1_21:                               # %terminate.lpad.i.i
.Ltmp5:                                 # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
...
# %bb.38:                               # %_ZN9NCompress5NBcj23IsJEhh.exit
	...
	ori	$a0, $zero, 15
	bne	$s4, $a0, .LBB5_33
# %bb.39:                               # %_ZN9NCompress5NBcj23IsJEhh.exit
                                        #   in Loop: Header=BB5_35 Depth=2
	ext.w.b	$a0, $s7
	addi.w	$a1, $zero, -112
	bge	$a0, $a1, .LBB5_33
...
# %bb.41:                               # %if.then154
	...
	add.d	$s1, $a0, $s1
	bgeu	$s3, $s1, .LBB5_56
# %bb.42:                               # %while.body159.preheader
                                        #   in Loop: Header=BB5_35 Depth=2
	st.d	$a5, $sp, 72                    # 8-byte Folded Spill
	st.d	$a4, $sp, 80                    # 8-byte Folded Spill
	.p2align	4, , 16
.LBB5_43:                               # %while.body159
                                        #   Parent Loop BB5_24 Depth=1
...
.LBB5_47:                               # %if.end231
	...
	bltu	$a1, $a2, .LBB5_60
	b	.LBB5_75
.LBB5_48:                               # %invoke.cont165
                                        #   in Loop: Header=BB5_35 Depth=2
	ld.d	$a1, $sp, 64                    # 8-byte Folded Reload
	beq	$a0, $a1, .LBB5_50
# %bb.49:                               # %invoke.cont165
                                        #   in Loop: Header=BB5_35 Depth=2
	ori	$a1, $zero, 1
	bne	$a0, $a1, .LBB5_98
.LBB5_50:                               # %if.then175
...
.Ltmp56:                                # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp57:                                # EH_LABEL
# %bb.52:                               # %call.i143.noexc
                                        #   in Loop: Header=BB5_35 Depth=2
	st.d	$zero, $sp, 136
.LBB5_53:                               # %cleanup181.thread
                                        #   in Loop: Header=BB5_35 Depth=2
	move	$s5, $zero
...
.LBB5_54:                               # %while.end
	...
	ld.d	$a0, $sp, 136
	beqz	$a0, .LBB5_73
# %bb.55:                               #   in Loop: Header=BB5_35 Depth=2
...
.Ltmp64:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp65:                                # EH_LABEL
# %bb.64:                               # %if.then.i164.for.inc256_crit_edge
                                        #   in Loop: Header=BB5_35 Depth=2
	ld.w	$a0, $s7, 8
.LBB5_65:                               # %for.inc256
                                        #   in Loop: Header=BB5_35 Depth=2
...
.Ltmp66:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp67:                                # EH_LABEL
# %bb.67:                               # %if.then.i164.1.for.inc256.1_crit_edge
                                        #   in Loop: Header=BB5_35 Depth=2
	ld.w	$a0, $s7, 8
.LBB5_68:                               # %for.inc256.1
                                        #   in Loop: Header=BB5_35 Depth=2
	srli.d	$a1, $s0, 8
	ld.d	$a2, $s7, 0
	addi.d	$a3, $a0, 1
...
.Ltmp68:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp69:                                # EH_LABEL
# %bb.70:                               # %if.then.i164.2.for.inc256.2_crit_edge
                                        #   in Loop: Header=BB5_35 Depth=2
	ld.w	$a0, $s7, 8
.LBB5_71:                               # %for.inc256.2
                                        #   in Loop: Header=BB5_35 Depth=2
	ld.d	$a1, $s7, 0
	addi.d	$a2, $a0, 1
	st.w	$a2, $s7, 8
...
.Ltmp60:                                # EH_LABEL
	move	$s4, $s7
	b	.LBB5_34
.LBB5_77:                               #   in Loop: Header=BB5_35 Depth=2
	move	$s4, $s7
	move	$s8, $a5
	b	.LBB5_34
.LBB5_78:                               # %while.end283
                                        #   in Loop: Header=BB5_24 Depth=1
	ld.d	$a0, $sp, 128
...
.LBB5_81:                               # %if.end302
	...
	bgeu	$s8, $a0, .LBB5_24
# %bb.82:                               # %while.body306.preheader
                                        #   in Loop: Header=BB5_24 Depth=1
	move	$a1, $zero
	sub.d	$a0, $a0, $s8
	bstrpick.d	$a2, $a0, 31, 0
.LBB5_83:                               # %while.body306
                                        #   Parent Loop BB5_24 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a3, $fp, 16
	add.d	$a4, $a3, $a1
	...
	addi.d	$a1, $a1, 1
	bne	$a2, $a1, .LBB5_83
# %bb.84:                               # %for.cond42.loopexit.loopexit
                                        #   in Loop: Header=BB5_24 Depth=1
	addi.w	$s1, $a0, 0
	lu12i.w	$a1, 32
	b	.LBB5_24
.LBB5_85:                               # %for.cond69.preheader
	beqz	$a1, .LBB5_97
# %bb.86:                               # %for.body71.lr.ph
	move	$s0, $zero
...
.Ltmp88:                                # EH_LABEL
	...
	move	$a0, $s0
.Ltmp89:                                # EH_LABEL
.LBB5_100:                              # %_ZN9CMyComPtrI25ICompressGetSubStreamSizeED2Ev.exit
	ld.d	$a1, $fp, 48
	beqz	$a1, .LBB5_103
...
# %bb.102:                              # %call.i.i.i.noexc.i
	st.d	$zero, $fp, 48
	move	$a0, $s0
.LBB5_103:                              # %_ZN10COutBuffer13ReleaseStreamEv.exit.i.i
	ld.d	$a1, $fp, 104
	beqz	$a1, .LBB5_106
# %bb.104:                              # %if.then.i.i3.i.i
	ld.d	$a0, $a1, 0
	ld.d	$a2, $a0, 16
.Ltmp93:                                # EH_LABEL
	move	$a0, $a1
	jirl	$ra, $a2, 0
.Ltmp94:                                # EH_LABEL
# %bb.105:                              # %call.i.i6.i.noexc.i
	st.d	$zero, $fp, 104
	move	$a0, $s0
.LBB5_106:                              # %_ZN10COutBuffer13ReleaseStreamEv.exit7.i.i
	ld.d	$a1, $fp, 160
	beqz	$a1, .LBB5_109
# %bb.107:                              # %if.then.i.i10.i.i
	ld.d	$a0, $a1, 0
	ld.d	$a2, $a0, 16
.Ltmp95:                                # EH_LABEL
	move	$a0, $a1
	jirl	$ra, $a2, 0
.Ltmp96:                                # EH_LABEL
# %bb.108:                              # %call.i.i13.i.noexc.i
	st.d	$zero, $fp, 160
	move	$a0, $s0
.LBB5_109:                              # %_ZN10COutBuffer13ReleaseStreamEv.exit14.i.i
	ld.d	$a1, $fp, 240
	beqz	$a1, .LBB5_12
...
.Ltmp78:                                # EH_LABEL
	b	.LBB5_126
.LBB5_116:                              # %terminate.lpad.i
.Ltmp90:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB5_117:                              # %lpad160.loopexit.split-lp
.Ltmp58:                                # EH_LABEL
	b	.LBB5_126
.LBB5_118:                              # %lpad37
.Ltmp46:                                # EH_LABEL
	b	.LBB5_126
.LBB5_119:                              # %terminate.lpad.i186
.Ltmp99:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB5_120:                              # %lpad233
...
.Ltmp72:                                # EH_LABEL
	b	.LBB5_126
.LBB5_125:                              # %lpad160.loopexit
.Ltmp55:                                # EH_LABEL
.LBB5_126:                              # %ehcleanup339
	move	$fp, $a0
	ld.d	$a0, $sp, 136
	beqz	$a0, .LBB5_128
# %bb.127:                              # %if.then.i188
...
.Ltmp102:                               # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp103:                               # EH_LABEL
# %bb.5:                                # %call.i.i6.i.noexc
	st.d	$zero, $fp, 104
.LBB6_6:                                # %_ZN10COutBuffer13ReleaseStreamEv.exit7.i
	ld.d	$a0, $fp, 160
	beqz	$a0, .LBB6_9
# %bb.7:                                # %if.then.i.i10.i
	ld.d	$a1, $a0, 0
	ld.d	$a1, $a1, 16
.Ltmp104:                               # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp105:                               # EH_LABEL
# %bb.8:                                # %call.i.i13.i.noexc
	st.d	$zero, $fp, 160
.LBB6_9:                                # %_ZN10COutBuffer13ReleaseStreamEv.exit14.i
	ld.d	$a0, $fp, 240
	beqz	$a0, .LBB6_12
...
.LBB13_3:                               # %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit
	...
	addi.d	$sp, $sp, 16
	ret
.LBB13_4:                               # %terminate.lpad.i
.Ltmp127:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB13_5:                               # %terminate.lpad
.Ltmp124:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.Lfunc_end13:
...
.Ltmp155:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp156:                               # EH_LABEL
# %bb.31:                               # %call.i39.noexc
                                        #   in Loop: Header=BB14_29 Depth=2
	beqz	$a0, .LBB14_81
# %bb.32:                               # %if.then.if.end3_crit_edge.i
                                        #   in Loop: Header=BB14_29 Depth=2
	ld.d	$a0, $s1, 0
.LBB14_33:                              # %if.end81
                                        #   in Loop: Header=BB14_29 Depth=2
...
.Ltmp185:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp186:                               # EH_LABEL
# %bb.47:                               # %call.i.i.noexc
                                        #   in Loop: Header=BB14_21 Depth=1
	ld.w	$a1, $s0, 216
.LBB14_48:                              # %invoke.cont101.thread
                                        #   in Loop: Header=BB14_21 Depth=1
	slli.d	$a2, $s7, 8
	or	$a0, $a2, $a0
	st.w	$a0, $s0, 220
...
.Ltmp163:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp164:                               # EH_LABEL
# %bb.50:                               # %call.i21.i.noexc
                                        #   in Loop: Header=BB14_21 Depth=1
	ld.w	$a2, $s0, 216
.LBB14_51:                              # %invoke.cont101
                                        #   in Loop: Header=BB14_21 Depth=1
	slli.d	$a1, $s3, 8
	or	$a0, $a1, $a0
	st.w	$a0, $s0, 220
...
.Ltmp165:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp166:                               # EH_LABEL
# %bb.54:                               # %call.i55.noexc
                                        #   in Loop: Header=BB14_21 Depth=1
	beqz	$a0, .LBB14_83
# %bb.55:                               # %if.then.if.end3_crit_edge.i57
                                        #   in Loop: Header=BB14_21 Depth=1
	ld.d	$a1, $s6, 0
	ld.d	$a0, $s6, 8
.LBB14_56:                              # %for.inc123
...
.Ltmp167:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp168:                               # EH_LABEL
# %bb.58:                               # %call.i55.noexc.1
                                        #   in Loop: Header=BB14_21 Depth=1
	beqz	$a0, .LBB14_83
# %bb.59:                               # %if.then.if.end3_crit_edge.i57.1
                                        #   in Loop: Header=BB14_21 Depth=1
	ld.d	$a2, $s6, 0
	ld.d	$a0, $s6, 8
.LBB14_60:                              # %for.inc123.1
                                        #   in Loop: Header=BB14_21 Depth=1
	addi.d	$a1, $a2, 1
	st.d	$a1, $s6, 0
	ld.bu	$s2, $a2, 0
...
.Ltmp169:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp170:                               # EH_LABEL
# %bb.62:                               # %call.i55.noexc.2
                                        #   in Loop: Header=BB14_21 Depth=1
	beqz	$a0, .LBB14_83
# %bb.63:                               # %if.then.if.end3_crit_edge.i57.2
                                        #   in Loop: Header=BB14_21 Depth=1
	ld.d	$a1, $s6, 0
	ld.d	$a0, $s6, 8
.LBB14_64:                              # %for.inc123.2
                                        #   in Loop: Header=BB14_21 Depth=1
	addi.d	$a2, $a1, 1
	st.d	$a2, $s6, 0
	ld.bu	$s4, $a1, 0
...
.Ltmp171:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp172:                               # EH_LABEL
# %bb.66:                               # %call.i55.noexc.3
                                        #   in Loop: Header=BB14_21 Depth=1
	beqz	$a0, .LBB14_83
# %bb.67:                               # %if.then.if.end3_crit_edge.i57.3
                                        #   in Loop: Header=BB14_21 Depth=1
	ld.d	$a2, $s6, 0
.LBB14_68:                              # %for.inc123.3
                                        #   in Loop: Header=BB14_21 Depth=1
	addi.d	$a0, $a2, 1
	st.d	$a0, $s6, 0
	ld.bu	$s6, $a2, 0
...
.Ltmp176:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp177:                               # EH_LABEL
# %bb.71:                               # %if.then.i69.invoke.cont137_crit_edge
                                        #   in Loop: Header=BB14_21 Depth=1
	ld.w	$a0, $s0, 1264
.LBB14_72:                              # %invoke.cont137
                                        #   in Loop: Header=BB14_21 Depth=1
	srli.d	$a1, $s2, 8
	ld.d	$a2, $s0, 1256
	addi.d	$a3, $a0, 1
...
.Ltmp178:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp179:                               # EH_LABEL
# %bb.74:                               # %if.then.i78.invoke.cont140_crit_edge
                                        #   in Loop: Header=BB14_21 Depth=1
	ld.w	$a0, $s0, 1264
.LBB14_75:                              # %invoke.cont140
                                        #   in Loop: Header=BB14_21 Depth=1
	srli.d	$a1, $s2, 16
	ld.d	$a2, $s0, 1256
	addi.d	$a3, $a0, 1
...
.Ltmp180:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp181:                               # EH_LABEL
# %bb.77:                               # %if.then.i87.invoke.cont144_crit_edge
                                        #   in Loop: Header=BB14_21 Depth=1
	ld.w	$a0, $s0, 1264
.LBB14_78:                              # %invoke.cont144
                                        #   in Loop: Header=BB14_21 Depth=1
...
.Ltmp187:                               # EH_LABEL
	b	.LBB14_92
.LBB14_85:                              # %lpad75.loopexit.split-lp
.Ltmp159:                               # EH_LABEL
	b	.LBB14_92
.LBB14_86:                              # %lpad60
.Ltmp154:                               # EH_LABEL
...
.Ltmp148:                               # EH_LABEL
	b	.LBB14_92
.LBB14_91:                              # %lpad75.loopexit
.Ltmp162:                               # EH_LABEL
.LBB14_92:                              # %ehcleanup175
	move	$fp, $a0
	addi.d	$a0, $sp, 16
	pcaddu18i	$ra, %call36(_ZN9NCompress5NBcj28CDecoder14CCoderReleaserD2Ev)
	jirl	$ra, $ra, 0
...
# %bb.5:                                # %call.i.i6.i.noexc
	st.d	$zero, $fp, 96
.LBB16_6:                               # %_ZN9CInBuffer13ReleaseStreamEv.exit7.i
	ld.d	$a0, $fp, 144
	beqz	$a0, .LBB16_9
# %bb.7:                                # %if.then.i.i10.i
	ld.d	$a1, $a0, 0
...
# %bb.8:                                # %call.i.i13.i.noexc
	st.d	$zero, $fp, 144
.LBB16_9:                               # %_ZN9CInBuffer13ReleaseStreamEv.exit14.i
	ld.d	$a0, $fp, 192
	beqz	$a0, .LBB16_12
# %bb.10:                               # %if.then.i.i.i.i
	ld.d	$a1, $a0, 0
...
.LBB16_12:                              # %_ZN9NCompress11NRangeCoder8CDecoder13ReleaseStreamEv.exit.i
	ld.d	$a0, $fp, 1280
	beqz	$a0, .LBB16_15
# %bb.13:                               # %if.then.i.i17.i
	ld.d	$a1, $a0, 0
	ld.d	$a1, $a1, 16
.Ltmp196:                               # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp197:                               # EH_LABEL
# %bb.14:                               # %call.i.i20.i.noexc
	st.d	$zero, $fp, 1280
...
# %bb.3:                                # %catch5
	...
	jirl	$ra, $ra, 0
	b	.LBB17_5
.LBB17_4:                               # %catch.fallthrough
	pcaddu18i	$ra, %call36(__cxa_begin_catch)
	jirl	$ra, $ra, 0
	ori	$a1, $zero, 2
	ori	$s0, $zero, 1
	bne	$fp, $a1, .LBB17_6
.LBB17_5:                               # %return.sink.split.sink.split
	ld.w	$s0, $a0, 0
.LBB17_6:                               # %return.sink.split
	pcaddu18i	$ra, %call36(__cxa_end_catch)
	jirl	$ra, $ra, 0
	move	$a0, $s0
	b	.LBB17_1
...
.Ltmp225:                               # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp226:                               # EH_LABEL
.LBB24_12:                              # %_ZN9CInBufferD2Ev.exit20
	addi.d	$a0, $fp, 24
.Ltmp228:                               # EH_LABEL
	pcaddu18i	$ra, %call36(_ZN9CInBuffer4FreeEv)
	jirl	$ra, $ra, 0
.Ltmp229:                               # EH_LABEL
# %bb.13:                               # %invoke.cont.i22
	ld.d	$a0, $fp, 48
	beqz	$a0, .LBB24_15
# %bb.14:                               # %if.then.i.i25
	ld.d	$a1, $a0, 0
...
.Ltmp231:                               # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp232:                               # EH_LABEL
.LBB24_15:                              # %_ZN9CInBufferD2Ev.exit30
	ld.d	$fp, $sp, 0                     # 8-byte Folded Reload
	ld.d	$ra, $sp, 8                     # 8-byte Folded Reload
	addi.d	$sp, $sp, 16
	ret
.LBB24_16:                              # %terminate.lpad.i.i29
.Ltmp233:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB24_17:                              # %terminate.lpad.i.i19
.Ltmp227:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB24_18:                              # %terminate.lpad.i.i10
.Ltmp221:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB24_19:                              # %terminate.lpad.i.i.i
.Ltmp215:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB24_20:                              # %terminate.lpad.i.i
.Ltmp209:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB24_21:                              # %terminate.lpad.i21
.Ltmp230:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB24_22:                              # %terminate.lpad.i11
.Ltmp224:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB24_23:                              # %terminate.lpad.i2
.Ltmp218:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB24_24:                              # %terminate.lpad.i.i1
.Ltmp212:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB24_25:                              # %terminate.lpad.i
.Ltmp206:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.Lfunc_end24:
