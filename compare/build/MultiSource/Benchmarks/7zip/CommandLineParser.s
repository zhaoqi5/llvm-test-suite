...
.Ltmp29:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp30:                                # EH_LABEL
# %bb.9:                                # %_ZN11CStringBaseIwED2Ev.exit103
                                        #   in Loop: Header=BB4_11 Depth=2
	sltui	$a0, $a0, 1
	masknez	$a1, $s1, $a0
	maskeqz	$a2, $s2, $a0
...
.Ltmp23:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp24:                                # EH_LABEL
# %bb.26:                               # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i187
                                        #   in Loop: Header=BB4_11 Depth=2
	move	$s4, $a0
	move	$a0, $s6
	pcaddu18i	$ra, %call36(_ZdaPv)
...
# %bb.32:                               # %delete.notnull.i.i
	...
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB4_33:                               # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i92.sink.split
                                        #   in Loop: Header=BB4_11 Depth=2
...
.LBB4_35:                               #   in Loop: Header=BB4_11 Depth=2
	move	$s4, $zero
.LBB4_36:                               # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i194
                                        #   in Loop: Header=BB4_11 Depth=2
	move	$a0, $zero
	.p2align	4, , 16
.LBB4_37:                               # %while.cond.i.i.i195
                                        #   Parent Loop BB4_6 Depth=1
                                        #     Parent Loop BB4_11 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ldx.w	$a1, $s3, $a0
...
# %bb.38:                               #   in Loop: Header=BB4_11 Depth=2
	move	$s5, $s3
.LBB4_39:                               # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i92.sink.split
                                        #   in Loop: Header=BB4_11 Depth=2
	st.w	$zero, $s5, 0
	move	$s3, $s5
.LBB4_40:                               # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i92
                                        #   in Loop: Header=BB4_11 Depth=2
	move	$a0, $zero
	ld.d	$s5, $sp, 56                    # 8-byte Folded Reload
	.p2align	4, , 16
.LBB4_41:                               # %while.cond.i.i93
                                        #   Parent Loop BB4_6 Depth=1
                                        #     Parent Loop BB4_11 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ldx.w	$a1, $s4, $a0
...
.Ltmp37:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp38:                                # EH_LABEL
# %bb.70:                               # %call.i.i.noexc.i154
                                        #   in Loop: Header=BB4_6 Depth=1
	st.d	$a0, $s3, 0
	st.w	$zero, $a0, 0
	st.w	$s0, $s3, 12
.LBB4_71:                               # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i156
                                        #   in Loop: Header=BB4_6 Depth=1
	ld.d	$a2, $sp, 104
	addi.d	$a1, $s4, 8
	.p2align	4, , 16
.LBB4_72:                               # %while.cond.i.i.i157
                                        #   Parent Loop BB4_6 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$a3, $a2, 0
	addi.d	$a2, $a2, 4
...
# %bb.74:                               # %invoke.cont141
	...
	ld.d	$a0, $sp, 104
	beqz	$a0, .LBB4_4
# %bb.75:                               # %delete.notnull.i175
                                        #   in Loop: Header=BB4_6 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	b	.LBB4_4
.LBB4_76:                               # %if.end9.i.i113
                                        #   in Loop: Header=BB4_6 Depth=1
	addi.w	$a0, $a0, 0
	addi.w	$a1, $a1, 0
	slti	$a0, $a0, -1
	...
	jirl	$ra, $ra, 0
	st.w	$zero, $a0, 0
.LBB4_77:                               # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i117
                                        #   in Loop: Header=BB4_6 Depth=1
	move	$a1, $zero
	.p2align	4, , 16
.LBB4_78:                               # %while.cond.i.i118
                                        #   Parent Loop BB4_6 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.w	$a2, $s3, $a1
	stx.w	$a2, $a0, $a1
	addi.d	$a1, $a1, 4
	bnez	$a2, .LBB4_78
# %bb.79:                               # %_ZN11CStringBaseIwEC2EPKw.exit125
                                        #   in Loop: Header=BB4_6 Depth=1
	ld.d	$s3, $sp, 80                    # 8-byte Folded Reload
	bne	$s3, $s2, .LBB4_81
# %bb.80:                               # %if.then72
...
.LBB4_81:                               # %if.else73
	...
	move	$a4, $a0
	beq	$a2, $a1, .LBB4_85
# %bb.82:                               # %if.end.i.i126.preheader
                                        #   in Loop: Header=BB4_6 Depth=1
	move	$a3, $a0
	.p2align	4, , 16
.LBB4_83:                               # %if.end.i.i126
                                        #   Parent Loop BB4_6 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	beqz	$a2, .LBB4_87
# %bb.84:                               # %if.end5.i.i
...
.Ltmp31:                                # EH_LABEL
	move	$fp, $a0
.LBB4_119:                              # %delete.notnull.i178
	move	$a0, $s3
.LBB4_120:                              # %delete.notnull.i178
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
...
# %bb.43:                               # %ehcleanup18
	bnez	$s3, .LBB8_49
.LBB8_44:                               # %_ZN11CStringBaseIwED2Ev.exit42
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB8_45:                               # %delete.notnull.i31
	move	$a0, $a1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	beqz	$s3, .LBB8_44
