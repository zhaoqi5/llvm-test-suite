...
# %bb.21:                               # %for.body8
	...
	move	$a4, $a6
	bltu	$a7, $a5, .LBB1_20
.LBB1_22:                               # %for.cond20.preheader.loopexit.loopexit
	add.d	$a1, $a0, $a6
.LBB1_23:                               # %for.cond20.preheader
	addi.w	$a0, $a1, 0
	ori	$a2, $zero, 31
	bltu	$a2, $a0, .LBB1_26
.LBB1_24:                               # %for.body22.lr.ph
	add.d	$a0, $fp, $a0
	addi.d	$a0, $a0, 48
	ori	$a2, $zero, 32
	sub.w	$a2, $a2, $a1
...
# %bb.16:                               # %lor.lhs.false.i.us
	...
	ld.w	$a6, $s2, 0
	bne	$a3, $a6, .LBB2_14
# %bb.17:                               # %for.cond.preheader.i.us
                                        #   in Loop: Header=BB2_15 Depth=1
	ld.d	$a6, $s2, 32
	bne	$a4, $a6, .LBB2_14
# %bb.18:                               # %for.cond.preheader.i.i.us
                                        #   in Loop: Header=BB2_15 Depth=1
	beqz	$a4, .LBB2_22
# %bb.19:                               # %for.body.lr.ph.i.i.us
                                        #   in Loop: Header=BB2_15 Depth=1
	ld.d	$a6, $s2, 40
	move	$a7, $a5
	move	$t0, $a4
	.p2align	4, , 16
.LBB2_20:                               # %for.body.i.i.us
                                        #   Parent Loop BB2_15 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.bu	$t1, $a7, 0
	ld.bu	$t2, $a6, 0
	bne	$t1, $t2, .LBB2_14
# %bb.21:                               # %for.cond.i.i.us
                                        #   in Loop: Header=BB2_20 Depth=2
	addi.d	$t0, $t0, -1
	addi.d	$a6, $a6, 1
	addi.d	$a7, $a7, 1
	bnez	$t0, .LBB2_20
.LBB2_22:                               # %_ZNK7NCrypto7NSevenZ8CKeyInfo9IsEqualToERKS1_.exit
	ld.b	$a0, $s2, 48
	st.b	$a0, $a1, 48
	ld.b	$a0, $s2, 49
	st.b	$a0, $a1, 49
...
# %bb.23:                               # %if.then13
	...
	st.d	$s6, $s0, 24
	beqz	$s1, .LBB2_26
# %bb.24:                               # %_ZN7CBufferIhE11SetCapacityEm.exit.i.i.i.i
.Ltmp0:                                 # EH_LABEL
	move	$a0, $s1
	pcaddu18i	$ra, %call36(_Znam)
	jirl	$ra, $ra, 0
.Ltmp1:                                 # EH_LABEL
# %bb.25:                               # %call.i.i.i.i.noexc.i
	st.d	$a0, $s0, 40
	ld.d	$a1, $s2, 40
	st.d	$s1, $s0, 32
	move	$a2, $s1
	...
	jirl	$ra, $ra, 0
.LBB2_26:                               # %_ZN13CObjectVectorIN7NCrypto7NSevenZ8CKeyInfoEE6InsertEiRKS2_.exit
	addi.d	$a0, $s2, 48
	xvld	$xr0, $a0, 0
	addi.d	$s1, $fp, 8
	xvst	$xr0, $s0, 48
	...
	st.d	$s0, $a1, 0
	blt	$s4, $s2, .LBB2_34
# %bb.27:                               # %for.body.lr.ph.i17
	slli.d	$a0, $s5, 3
	addi.d	$s5, $a0, 8
	move	$s7, $s4
	b	.LBB2_30
	.p2align	4, , 16
.LBB2_28:                               # %_ZN7NCrypto7NSevenZ8CKeyInfoD2Ev.exit.i
...
.LBB2_33:
	move	$s2, $zero
	b	.LBB2_36
.LBB2_34:                               # %_ZN13CObjectVectorIN7NCrypto7NSevenZ8CKeyInfoEE6DeleteEii.exit
	move	$a0, $s1
	move	$a1, $s3
	move	$a2, $s4
...
# %bb.49:                               # %for.cond.i107
	...
	ld.bu	$a6, $a5, 1
	bne	$a4, $a6, .LBB21_65
# %bb.50:                               # %for.cond.1.i110
	ld.bu	$a4, $a1, 2
	ld.bu	$a6, $a5, 2
	bne	$a4, $a6, .LBB21_65
# %bb.51:                               # %for.cond.2.i113
	ld.bu	$a4, $a1, 3
	ld.bu	$a6, $a5, 3
	bne	$a4, $a6, .LBB21_65
# %bb.52:                               # %for.cond.3.i116
	ld.bu	$a4, $a1, 4
	ld.bu	$a6, $a5, 4
	bne	$a4, $a6, .LBB21_65
# %bb.53:                               # %for.cond.4.i119
	ld.bu	$a4, $a1, 5
	ld.bu	$a6, $a5, 5
	bne	$a4, $a6, .LBB21_65
# %bb.54:                               # %for.cond.5.i122
	ld.bu	$a4, $a1, 6
	ld.bu	$a6, $a5, 6
	bne	$a4, $a6, .LBB21_65
# %bb.55:                               # %for.cond.6.i125
	ld.bu	$a4, $a1, 7
	ld.bu	$a6, $a5, 7
	bne	$a4, $a6, .LBB21_65
# %bb.56:                               # %for.cond.7.i128
	ld.bu	$a4, $a1, 8
	ld.bu	$a6, $a5, 8
	bne	$a4, $a6, .LBB21_65
# %bb.57:                               # %for.cond.8.i131
	ld.bu	$a4, $a1, 9
	ld.bu	$a6, $a5, 9
	bne	$a4, $a6, .LBB21_65
# %bb.58:                               # %for.cond.9.i134
	ld.bu	$a4, $a1, 10
	ld.bu	$a6, $a5, 10
	bne	$a4, $a6, .LBB21_65
# %bb.59:                               # %for.cond.10.i137
	ld.bu	$a4, $a1, 11
	ld.bu	$a6, $a5, 11
	bne	$a4, $a6, .LBB21_65
# %bb.60:                               # %for.cond.11.i140
	ld.bu	$a4, $a1, 12
	ld.bu	$a6, $a5, 12
	bne	$a4, $a6, .LBB21_65
# %bb.61:                               # %for.cond.12.i143
	ld.bu	$a4, $a1, 13
	ld.bu	$a6, $a5, 13
	bne	$a4, $a6, .LBB21_65
# %bb.62:                               # %for.cond.13.i146
	ld.bu	$a4, $a1, 14
	ld.bu	$a6, $a5, 14
	bne	$a4, $a6, .LBB21_65
# %bb.63:                               # %_ZeqRK4GUIDS1_.exit153
	ld.bu	$a1, $a1, 15
	ld.bu	$a4, $a5, 15
	ori	$a5, $zero, 184
	bne	$a1, $a4, .LBB21_65
