...
# %bb.52:                               # %pred.store.continue
	...
	andi	$a0, $a0, 1
	bnez	$a0, .LBB21_122
.LBB21_53:                              # %pred.store.continue390
	xvpickve2gr.d	$a0, $xr1, 2
	andi	$a0, $a0, 1
	bnez	$a0, .LBB21_123
.LBB21_54:                              # %pred.store.continue392
	xvpickve2gr.d	$a0, $xr1, 3
	andi	$a0, $a0, 1
	beqz	$a0, .LBB21_56
.LBB21_55:                              # %pred.store.if393
	ori	$a0, $zero, 3
	st.b	$a0, $sp, 137
.LBB21_56:                              # %pred.store.continue394
	...
	andi	$a0, $a0, 1
	bnez	$a0, .LBB21_124
# %bb.57:                               # %pred.store.continue396
	xvpickve2gr.d	$a0, $xr0, 1
	andi	$a0, $a0, 1
	bnez	$a0, .LBB21_125
.LBB21_58:                              # %pred.store.continue398
	xvpickve2gr.d	$a0, $xr0, 2
	andi	$a0, $a0, 1
	bnez	$a0, .LBB21_126
.LBB21_59:                              # %pred.store.continue400
	xvpickve2gr.d	$a0, $xr0, 3
	andi	$a0, $a0, 1
	beqz	$a0, .LBB21_61
.LBB21_60:                              # %pred.store.if401
	ori	$a0, $zero, 7
	st.b	$a0, $sp, 141
...
# %bb.106:                              # %if.then163
	...
	stx.w	$a3, $a4, $a2
	ori	$a2, $zero, 16
	bltu	$s5, $a2, .LBB21_112
# %bb.107:                              # %vector.scevcheck
                                        #   in Loop: Header=BB21_99 Depth=1
	addi.w	$a2, $s5, -1
	addi.d	$a3, $zero, -257
	sub.w	$a3, $a3, $s8
	bltu	$a3, $a2, .LBB21_112
# %bb.108:                              # %vector.ph404
                                        #   in Loop: Header=BB21_99 Depth=1
	move	$a3, $s5
...
.LBB21_109:                             # %vector.body407
	...
	addi.w	$a4, $a4, 16
	bnez	$a5, .LBB21_109
# %bb.110:                              # %middle.block410
                                        #   in Loop: Header=BB21_99 Depth=1
	addi.w	$a3, $a3, 0
	beq	$s5, $a3, .LBB21_114
# %bb.111:                              #   in Loop: Header=BB21_99 Depth=1
	move	$s8, $s3
	move	$s5, $a2
.LBB21_112:                             # %do.body169.preheader
                                        #   in Loop: Header=BB21_99 Depth=1
	move	$s3, $s8
	ld.d	$a3, $sp, 80                    # 8-byte Folded Reload
.LBB21_113:                             # %do.body169
                                        #   Parent Loop BB21_99 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.d	$a2, $s3, 256
	addi.w	$s3, $s3, 1
	...
	stx.w	$a1, $a3, $a2
	bnez	$s5, .LBB21_113
.LBB21_114:                             #   in Loop: Header=BB21_99 Depth=1
	move	$fp, $zero
	b	.LBB21_116
...
.LBB21_120:                             # %return
	...
	addi.d	$sp, $sp, 736
	ret
.LBB21_121:                             # %pred.store.if
	st.b	$zero, $sp, 134
	xvpickve2gr.d	$a0, $xr1, 1
	andi	$a0, $a0, 1
	beqz	$a0, .LBB21_53
.LBB21_122:                             # %pred.store.if389
	ori	$a0, $zero, 1
	st.b	$a0, $sp, 135
	xvpickve2gr.d	$a0, $xr1, 2
	andi	$a0, $a0, 1
