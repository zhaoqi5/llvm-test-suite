...
.LBB7_9:                                # %do.end54
	...
	ld.d	$a4, $a0, 0
	beqz	$a3, .LBB7_11
# %bb.10:                               # %do.end54.if.end173_crit_edge
	ld.bu	$t2, $a4, 1
	ld.d	$a2, $a0, 56
	ld.wu	$a1, $a4, 4
	b	.LBB7_31
...
.LBB7_15:                               # %if.end117
	...
	srli.d	$a3, $a3, 1
	bne	$a2, $a3, .LBB7_17
# %bb.16:                               # %if.end117.if.end132_crit_edge
	ld.d	$a2, $a0, 56
	ld.w	$a1, $a4, 4
	b	.LBB7_18
.LBB7_17:                               # %if.then127
...
.LBB7_22:                               # %vector.body
	...
	ld.b	$t7, $t2, -24
	vinsgr2vr.b	$vr3, $t5, 9
	ld.b	$t5, $t2, -18
	vinsgr2vr.b	$vr3, $t6, 10
	ld.b	$t6, $t2, -12
	...
	ld.b	$t6, $t2, 144
	vinsgr2vr.b	$vr5, $t7, 5
	ld.b	$t7, $t2, 150
	vinsgr2vr.b	$vr5, $t5, 6
	ld.b	$t5, $t2, 156
	vinsgr2vr.b	$vr5, $t6, 7
	ld.b	$t6, $t2, 162
	...
	ld.b	$t6, $t2, 180
	vinsgr2vr.b	$vr5, $t7, 11
	ld.b	$t7, $t2, 186
	vinsgr2vr.b	$vr5, $t5, 12
	ld.b	$t5, $t2, 192
	vinsgr2vr.b	$vr5, $t6, 13
	ld.b	$t6, $t2, 12
	vinsgr2vr.b	$vr5, $t7, 14
	ld.b	$t7, $t2, 18
	...
	ld.b	$t6, $t2, 84
	vinsgr2vr.b	$vr6, $t7, 10
	ld.b	$t7, $t2, 90
	vinsgr2vr.b	$vr6, $t5, 11
	ld.b	$t5, $t2, 96
	vinsgr2vr.b	$vr6, $t4, 12
	vinsgr2vr.b	$vr6, $t6, 13
	vinsgr2vr.b	$vr6, $t7, 14
...
.LBB7_25:                               # %vec.epilog.ph
	...
	vrepli.b	$vr1, 63
	.p2align	4, , 16
.LBB7_26:                               # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$t3, $t0, -18
	ld.b	$t4, $t0, -12
	ld.b	$t5, $t0, -6
...
.LBB11_54:                              # %if.else234
	...
	ld.wu	$a0, $t3, 0
	beqz	$a0, .LBB11_56
# %bb.55:                               # %AllocUnits.exit216.thread
                                        #   in Loop: Header=BB11_49 Depth=1
	ld.d	$a1, $fp, 56
	add.d	$a0, $a1, $a0
	ld.w	$a1, $a0, 4
...
# %bb.57:                               # %if.end9.i214
	...
	move	$t0, $s2
	b	.LBB11_59
.LBB11_58:                              # %if.then6.i211
                                        #   in Loop: Header=BB11_49 Depth=1
	add.d	$a1, $a0, $a1
	st.d	$a1, $fp, 64
.LBB11_59:                              # %AllocUnits.exit216
                                        #   in Loop: Header=BB11_49 Depth=1
	beqz	$a0, .LBB11_20
.LBB11_60:                              # %cleanup267
                                        #   in Loop: Header=BB11_49 Depth=1
...
.LBB11_64:                              # %AllocUnits.exit
                                        #   in Loop: Header=BB11_49 Depth=1
	beqz	$a0, .LBB11_20
# %bb.65:                               # %AllocUnits.exit.if.end190_crit_edge
                                        #   in Loop: Header=BB11_49 Depth=1
	ld.d	$a2, $fp, 56
.LBB11_66:                              # %if.end190
                                        #   in Loop: Header=BB11_49 Depth=1
...
.LBB11_72:                              # %if.then142
	...
	move	$t0, $s3
	bne	$s0, $a0, .LBB11_46
.LBB11_73:                              # %if.end150.for.end_crit_edge
	ld.d	$a2, $fp, 56
.LBB11_74:                              # %for.end
...
.LBB14_21:                              # %vector.body
	...
	vpickve2gr.b	$a5, $vr7, 0
	vpickve2gr.b	$a6, $vr7, 1
	vpickve2gr.b	$a7, $vr7, 2
	vpickve2gr.b	$t0, $vr7, 3
	vpickve2gr.b	$t1, $vr7, 4
	vpickve2gr.b	$t2, $vr7, 5
	vpickve2gr.b	$t3, $vr7, 6
	vpickve2gr.b	$t4, $vr7, 7
	...
	xvpermi.q	$xr9, $xr8, 48
	xvextrins.b	$xr8, $xr9, 204
	vpickve2gr.b	$a5, $vr6, 0
	xvreplgr2vr.b	$xr9, $a5
	xvpermi.q	$xr9, $xr12, 18
	xvori.b	$xr10, $xr12, 0
	xvextrins.b	$xr10, $xr9, 0
	vpickve2gr.b	$a5, $vr6, 1
	xvreplgr2vr.b	$xr9, $a5
	xvpermi.q	$xr9, $xr10, 18
	xvextrins.b	$xr10, $xr9, 68
	vpickve2gr.b	$a5, $vr6, 2
	xvreplgr2vr.b	$xr9, $a5
	xvpermi.q	$xr9, $xr10, 18
	xvextrins.b	$xr10, $xr9, 136
	vpickve2gr.b	$a5, $vr6, 3
	xvreplgr2vr.b	$xr9, $a5
	xvpermi.q	$xr9, $xr10, 18
	xvextrins.b	$xr10, $xr9, 204
	vpickve2gr.b	$a5, $vr6, 4
	xvreplgr2vr.b	$xr9, $a5
	xvpermi.q	$xr9, $xr10, 48
	xvextrins.b	$xr10, $xr9, 0
	vpickve2gr.b	$a5, $vr6, 5
	xvreplgr2vr.b	$xr9, $a5
	xvpermi.q	$xr9, $xr10, 48
	xvextrins.b	$xr10, $xr9, 68
	vpickve2gr.b	$a5, $vr6, 6
	xvreplgr2vr.b	$xr9, $a5
	xvpermi.q	$xr9, $xr10, 48
	xvextrins.b	$xr10, $xr9, 136
	vpickve2gr.b	$a5, $vr6, 7
	xvreplgr2vr.b	$xr9, $a5
	xvpermi.q	$xr9, $xr10, 48
	xvextrins.b	$xr10, $xr9, 204
	xvsub.w	$xr2, $xr2, $xr8
	...
	vsrli.b	$vr8, $vr7, 1
	vsub.b	$vr8, $vr7, $vr8
	vpickve2gr.b	$a5, $vr8, 0
	xvreplgr2vr.b	$xr9, $a5
	xvpermi.q	$xr9, $xr12, 18
	xvori.b	$xr7, $xr12, 0
	xvextrins.b	$xr7, $xr9, 0
	vpickve2gr.b	$a5, $vr8, 1
	xvreplgr2vr.b	$xr9, $a5
	xvpermi.q	$xr9, $xr7, 18
	xvextrins.b	$xr7, $xr9, 68
	vpickve2gr.b	$a5, $vr8, 2
	xvreplgr2vr.b	$xr9, $a5
	xvpermi.q	$xr9, $xr7, 18
	xvextrins.b	$xr7, $xr9, 136
	vpickve2gr.b	$a5, $vr8, 3
	xvreplgr2vr.b	$xr9, $a5
	xvpermi.q	$xr9, $xr7, 18
	xvextrins.b	$xr7, $xr9, 204
	vpickve2gr.b	$a5, $vr8, 4
	xvreplgr2vr.b	$xr9, $a5
	xvpermi.q	$xr9, $xr7, 48
	xvextrins.b	$xr7, $xr9, 0
	vpickve2gr.b	$a5, $vr8, 5
	xvreplgr2vr.b	$xr9, $a5
	xvpermi.q	$xr9, $xr7, 48
	xvextrins.b	$xr7, $xr9, 68
	vpickve2gr.b	$a5, $vr8, 6
	xvreplgr2vr.b	$xr9, $a5
	xvpermi.q	$xr9, $xr7, 48
	xvextrins.b	$xr7, $xr9, 136
	vpickve2gr.b	$a5, $vr8, 7
	xvreplgr2vr.b	$xr9, $a5
	xvpermi.q	$xr9, $xr7, 48
	xvextrins.b	$xr7, $xr9, 204
	vsrli.b	$vr9, $vr6, 1
	...
	xvpermi.q	$xr9, $xr10, 48
	xvextrins.b	$xr10, $xr9, 204
	vstelm.b	$vr8, $a3, -41, 0
	vstelm.b	$vr8, $a3, -35, 1
	vstelm.b	$vr8, $a3, -29, 2
	vstelm.b	$vr8, $a3, -23, 3
	vstelm.b	$vr8, $a3, -17, 4
	vstelm.b	$vr8, $a3, -11, 5
	vstelm.b	$vr8, $a3, -5, 6
	vstelm.b	$vr8, $a3, 1, 7
	vstelm.b	$vr6, $a3, 7, 0
	vstelm.b	$vr6, $a3, 13, 1
	vstelm.b	$vr6, $a3, 19, 2
	vstelm.b	$vr6, $a3, 25, 3
	vstelm.b	$vr6, $a3, 31, 4
	vstelm.b	$vr6, $a3, 37, 5
	vstelm.b	$vr6, $a3, 43, 6
	vstelm.b	$vr6, $a3, 49, 7
	xvadd.w	$xr1, $xr7, $xr1
...
# %bb.26:                               # %vec.epilog.middle.block
	...
	vpickve2gr.w	$a5, $vr0, 0
	beq	$a7, $s6, .LBB14_29
.LBB14_27:                              # %do.body.i73.preheader
                                        #   in Loop: Header=BB14_14 Depth=1
	addi.d	$a0, $a6, 7
	.p2align	4, , 16
.LBB14_28:                              # %do.body.i73
                                        #   Parent Loop BB14_14 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.bu	$a1, $a0, 0
	sub.d	$a3, $a3, $a1
...
.LBB14_43:                              # %for.end.i
	...
	b	.LBB14_45
	.p2align	4, , 16
.LBB14_44:                              # %while.end36.i
                                        #   in Loop: Header=BB14_45 Depth=2
	addi.d	$a0, $a0, 1
	beq	$a0, $s5, .LBB14_38
.LBB14_45:                              # %for.body11.i
                                        #   Parent Loop BB14_39 Depth=1
...
# %bb.46:                               # %while.body.lr.ph.i
	...
	b	.LBB14_48
	.p2align	4, , 16
.LBB14_47:                              #   in Loop: Header=BB14_48 Depth=3
	move	$a5, $a6
.LBB14_48:                              # %while.body.i
                                        #   Parent Loop BB14_39 Depth=1
	...
	ld.wu	$a6, $a5, 0
	.p2align	4, , 16
.LBB14_49:                              # %while.cond20.i
                                        #   Parent Loop BB14_39 Depth=1
                                        #     Parent Loop BB14_45 Depth=2
                                        #       Parent Loop BB14_48 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
	ldx.w	$a7, $a2, $a6
	add.d	$a6, $a2, $a6
	addi.d	$a6, $a6, 4
	bnez	$a7, .LBB14_47
# %bb.50:                               # %while.body23.i
                                        #   in Loop: Header=BB14_49 Depth=4
	ld.wu	$a6, $a6, 0
	st.w	$a6, $a5, 0
	ld.w	$a7, $a4, 0
	addi.d	$a7, $a7, -1
...
.LBB17_38:                              # %vector.ph
	...
	pcalau12i	$a6, %pc_hi20(.LCPI17_0)
	xvld	$xr6, $a6, %pc_lo12(.LCPI17_0)
...
.LBB17_39:                              # %vector.body
	...
	ld.b	$t6, $a6, -5
	ld.b	$t7, $a6, 1
	vinsgr2vr.b	$vr15, $t0, 0
	vinsgr2vr.b	$vr15, $t1, 1
	vinsgr2vr.b	$vr15, $t2, 2
	vinsgr2vr.b	$vr15, $t3, 3
	vinsgr2vr.b	$vr15, $t4, 4
	vinsgr2vr.b	$vr15, $t5, 5
	vinsgr2vr.b	$vr15, $t6, 6
	vinsgr2vr.b	$vr15, $t7, 7
	ld.b	$t0, $a6, 7
	ld.b	$t1, $a6, 13
	ld.b	$t2, $a6, 19
	ld.b	$t3, $a6, 25
	...
	ld.b	$t6, $a6, 43
	ld.b	$t7, $a6, 49
	vinsgr2vr.b	$vr13, $t0, 0
	vinsgr2vr.b	$vr13, $t1, 1
	vinsgr2vr.b	$vr13, $t2, 2
	vinsgr2vr.b	$vr13, $t3, 3
	vinsgr2vr.b	$vr13, $t4, 4
	vinsgr2vr.b	$vr13, $t5, 5
	vinsgr2vr.b	$vr13, $t6, 6
	vinsgr2vr.b	$vr13, $t7, 7
	vpickve2gr.b	$t0, $vr15, 0
	xvreplgr2vr.b	$xr16, $t0
	xvpermi.q	$xr16, $xr3, 18
	xvori.b	$xr14, $xr3, 0
	xvextrins.b	$xr14, $xr16, 0
	vpickve2gr.b	$t0, $vr15, 1
	xvreplgr2vr.b	$xr16, $t0
	xvpermi.q	$xr16, $xr14, 18
	xvextrins.b	$xr14, $xr16, 68
	vpickve2gr.b	$t0, $vr15, 2
	xvreplgr2vr.b	$xr16, $t0
	xvpermi.q	$xr16, $xr14, 18
	xvextrins.b	$xr14, $xr16, 136
	vpickve2gr.b	$t0, $vr15, 3
	xvreplgr2vr.b	$xr16, $t0
	xvpermi.q	$xr16, $xr14, 18
	xvextrins.b	$xr14, $xr16, 204
	vpickve2gr.b	$t0, $vr15, 4
	xvreplgr2vr.b	$xr16, $t0
	xvpermi.q	$xr16, $xr14, 48
	xvextrins.b	$xr14, $xr16, 0
	vpickve2gr.b	$t0, $vr15, 5
	xvreplgr2vr.b	$xr16, $t0
	xvpermi.q	$xr16, $xr14, 48
	xvextrins.b	$xr14, $xr16, 68
	vpickve2gr.b	$t0, $vr15, 6
	xvreplgr2vr.b	$xr16, $t0
	xvpermi.q	$xr16, $xr14, 48
	xvextrins.b	$xr14, $xr16, 136
	vpickve2gr.b	$t0, $vr15, 7
	xvreplgr2vr.b	$xr15, $t0
	xvpermi.q	$xr15, $xr14, 48
	xvextrins.b	$xr14, $xr15, 204
	vpickve2gr.b	$t0, $vr13, 0
	xvreplgr2vr.b	$xr15, $t0
	xvpermi.q	$xr15, $xr3, 18
	xvori.b	$xr16, $xr3, 0
	xvextrins.b	$xr16, $xr15, 0
	vpickve2gr.b	$t0, $vr13, 1
	xvreplgr2vr.b	$xr15, $t0
	xvpermi.q	$xr15, $xr16, 18
	xvextrins.b	$xr16, $xr15, 68
	vpickve2gr.b	$t0, $vr13, 2
	xvreplgr2vr.b	$xr15, $t0
	xvpermi.q	$xr15, $xr16, 18
	xvextrins.b	$xr16, $xr15, 136
	vpickve2gr.b	$t0, $vr13, 3
	xvreplgr2vr.b	$xr15, $t0
	xvpermi.q	$xr15, $xr16, 18
	xvextrins.b	$xr16, $xr15, 204
	vpickve2gr.b	$t0, $vr13, 4
	xvreplgr2vr.b	$xr15, $t0
	xvpermi.q	$xr15, $xr16, 48
	xvextrins.b	$xr16, $xr15, 0
	vpickve2gr.b	$t0, $vr13, 5
	xvreplgr2vr.b	$xr15, $t0
	xvpermi.q	$xr15, $xr16, 48
	xvextrins.b	$xr16, $xr15, 68
	vpickve2gr.b	$t0, $vr13, 6
	xvreplgr2vr.b	$xr15, $t0
	xvpermi.q	$xr15, $xr16, 48
	xvextrins.b	$xr16, $xr15, 136
	vpickve2gr.b	$t0, $vr13, 7
	xvreplgr2vr.b	$xr13, $t0
	xvpermi.q	$xr13, $xr16, 48
	xvextrins.b	$xr16, $xr13, 204
	xvsub.w	$xr4, $xr4, $xr14
	xvsub.w	$xr12, $xr12, $xr16
	xvadd.w	$xr13, $xr5, $xr14
	xvadd.w	$xr14, $xr5, $xr16
	xvsrl.w	$xr13, $xr13, $xr5
	xvsrl.w	$xr14, $xr14, $xr5
	xvpermi.d	$xr15, $xr13, 78
	xvshuf.b	$xr15, $xr15, $xr13, $xr6
	xvpermi.d	$xr16, $xr14, 78
	xvshuf.b	$xr16, $xr16, $xr14, $xr6
	vstelm.b	$vr15, $a6, -41, 0
	vstelm.b	$vr15, $a6, -35, 1
	vstelm.b	$vr15, $a6, -29, 2
	vstelm.b	$vr15, $a6, -23, 3
	vstelm.b	$vr15, $a6, -17, 4
	vstelm.b	$vr15, $a6, -11, 5
	vstelm.b	$vr15, $a6, -5, 6
	vstelm.b	$vr15, $a6, 1, 7
	vstelm.b	$vr16, $a6, 7, 0
	vstelm.b	$vr16, $a6, 13, 1
	vstelm.b	$vr16, $a6, 19, 2
	vstelm.b	$vr16, $a6, 25, 3
	vstelm.b	$vr16, $a6, 31, 4
	vstelm.b	$vr16, $a6, 37, 5
	vstelm.b	$vr16, $a6, 43, 6
	vstelm.b	$vr16, $a6, 49, 7
	xvand.v	$xr13, $xr13, $xr10
	xvand.v	$xr14, $xr14, $xr10
	xvadd.w	$xr2, $xr13, $xr2
	xvadd.w	$xr9, $xr14, $xr9
	ld.b	$t0, $a6, -42
	ld.b	$t1, $a6, -36
	ld.b	$t2, $a6, -30
	ld.b	$t3, $a6, -24
	...
	ld.b	$t6, $a6, 42
	ld.b	$t7, $a6, 48
	vinsgr2vr.b	$vr14, $t0, 0
	vinsgr2vr.b	$vr14, $t1, 1
	vinsgr2vr.b	$vr14, $t2, 2
	vinsgr2vr.b	$vr14, $t3, 3
	vinsgr2vr.b	$vr14, $t4, 4
	vinsgr2vr.b	$vr14, $t5, 5
	vinsgr2vr.b	$vr14, $t6, 6
	vinsgr2vr.b	$vr14, $t7, 7
	vslt.bu	$vr13, $vr0, $vr13
	xvpermi.d	$xr13, $xr13, 68
	xvshuf.b	$xr13, $xr0, $xr13, $xr8
	xvand.v	$xr13, $xr13, $xr11
	xvslli.w	$xr13, $xr13, 3
	vslt.bu	$vr14, $vr0, $vr14
	xvpermi.d	$xr14, $xr14, 68
	xvshuf.b	$xr14, $xr0, $xr14, $xr8
	xvand.v	$xr14, $xr14, $xr11
	xvslli.w	$xr14, $xr14, 3
	xvor.v	$xr1, $xr13, $xr1
	xvor.v	$xr7, $xr14, $xr7
	addi.d	$a7, $a7, -16
	addi.d	$a6, $a6, 96
...
# %bb.44:                               # %vec.epilog.middle.block
	...
	beq	$a2, $t1, .LBB17_47
.LBB17_45:                              # %do.body.i161.preheader
	addi.d	$a0, $a5, 7
	.p2align	4, , 16
.LBB17_46:                              # %do.body.i161
                                        # =>This Inner Loop Header: Depth=1
	ld.bu	$a2, $a0, 0
	sub.d	$a6, $a6, $a2
	add.d	$a2, $a2, $s1
