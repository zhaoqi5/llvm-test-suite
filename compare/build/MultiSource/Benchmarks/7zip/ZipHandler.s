...
# %bb.1:                                # %invoke.cont3
	...
	ori	$a0, $zero, 24
	slli.d	$a1, $a2, 2
	pcalau12i	$a2, %pc_hi20(.LJTI9_0)
	addi.d	$a2, $a2, %pc_lo12(.LJTI9_0)
	ldx.w	$a1, $a2, $a1
	add.d	$a1, $a2, $a1
	jr	$a1
.LBB9_2:                                # %sw.bb
...
.LBB9_27:                               # %sw.bb45
	ld.w	$a1, $s0, 132
	blez	$a1, .LBB9_132
# %bb.28:                               # %for.body.lr.ph.i85
	ld.d	$a2, $s0, 136
	ori	$a3, $zero, 10
	.p2align	4, , 16
.LBB9_29:                               # %for.body.i88
...
.LBB9_34:                               # %sw.bb56
	ld.w	$a1, $s0, 132
	blez	$a1, .LBB9_132
# %bb.35:                               # %for.body.lr.ph.i101
	ld.d	$a2, $s0, 136
	ori	$a3, $zero, 10
	.p2align	4, , 16
.LBB9_36:                               # %for.body.i104
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $a2, 0
	ld.hu	$a4, $a0, 0
	beq	$a4, $a3, .LBB9_70
...
.LBB9_38:                               # %sw.bb67
	ld.w	$a1, $s0, 132
	blez	$a1, .LBB9_98
# %bb.39:                               # %for.body.lr.ph.i117
	ld.d	$a2, $s0, 136
	ori	$a3, $zero, 10
	move	$a4, $a1
	.p2align	4, , 16
.LBB9_40:                               # %for.body.i120
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $a2, 0
	ld.hu	$a5, $a0, 0
	beq	$a5, $a3, .LBB9_73
...
.LBB9_76:                               # %if.then72
	blez	$a1, .LBB9_98
# %bb.77:                               # %for.body.lr.ph.i133
	ld.d	$a2, $s0, 136
	lu12i.w	$a0, 5
	ori	$a3, $a0, 1109
	.p2align	4, , 16
.LBB9_78:                               # %for.body.i136
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $a2, 0
	ld.hu	$a4, $a0, 0
	beq	$a4, $a3, .LBB9_95
...
# %bb.88:                               # %for.cond.preheader
	pcalau12i	$a0, %pc_hi20(_ZN8NArchive4NZipL19g_StrongCryptoPairsE)
	addi.d	$a0, $a0, %pc_lo12(_ZN8NArchive4NZipL19g_StrongCryptoPairsE)
	slli.d	$a1, $a1, 2
	pcalau12i	$a2, %pc_hi20(.LJTI9_1)
	addi.d	$a2, $a2, %pc_lo12(.LJTI9_1)
	ldx.w	$a1, $a2, $a1
	add.d	$a1, $a2, $a1
	jr	$a1
...
.LBB9_91:                               # %if.else
	blez	$a1, .LBB9_106
# %bb.92:                               # %for.body.lr.ph.i70
	ld.d	$a2, $s0, 136
	lu12i.w	$a0, 5
	ori	$a3, $a0, 1109
	.p2align	4, , 16
.LBB9_93:                               # %for.body.i73
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $a2, 0
	ld.hu	$a4, $a0, 0
	beq	$a4, $a3, .LBB9_104
...
# %bb.111:                              # %for.cond.preheader
	bne	$a0, $a2, .LBB9_116
# %bb.112:                              # %if.then172.fold.split247
...
# %bb.114:                              # %for.cond.preheader
	ori	$a1, $a1, 2049
	bne	$a0, $a1, .LBB9_116
# %bb.115:                              # %if.then172.fold.split249
...
.Ltmp63:                                # EH_LABEL
	b	.LBB9_125
.LBB9_117:                              # %if.then172.fold.split244
	...
	b	.LBB9_124
.LBB9_118:                              # %if.then172.fold.split243
	...
	b	.LBB9_124
.LBB9_119:                              # %if.then172.fold.split241
	...
	b	.LBB9_124
.LBB9_120:                              # %if.then172.fold.split242
	...
	b	.LBB9_124
.LBB9_121:                              # %if.then172.fold.split245
	...
	b	.LBB9_124
.LBB9_122:                              # %if.then172.fold.split246
	...
	b	.LBB9_124
.LBB9_123:                              # %if.then172.fold.split248
...
.Ltmp161:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp162:                               # EH_LABEL
# %bb.180:                              # %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit177
	addi.w	$s1, $fp, 0
	move	$a0, $s0
	pcaddu18i	$ra, %call36(__cxa_begin_catch)
	jirl	$ra, $ra, 0
...
.LBB13_8:                               # %vec.epilog.ph
	...
	add.d	$a4, $a0, $a4
	.p2align	4, , 16
.LBB13_9:                               # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	vst	$vr0, $a3, 0
	addi.d	$a2, $a2, 16
...
# %bb.105:                              # %invoke.cont289
	ori	$a0, $a1, 514
	slli.d	$a2, $s4, 2
	pcalau12i	$a3, %pc_hi20(.LJTI23_0)
	addi.d	$a3, $a3, %pc_lo12(.LJTI23_0)
	ldx.w	$a2, $a3, $a2
	add.d	$a2, $a3, $a2
	jr	$a2
...
.LBB23_192:                             # %cleanup.cont373
	bnez	$s4, .LBB23_141
.LBB23_193:                             # %_ZN8NArchive4NZip11CMethodItemD2Ev.exit.thread876
	move	$s6, $zero
	move	$s8, $zero
	ori	$a0, $zero, 1
...
.LBB25_9:                               # %vec.epilog.ph
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB25_10:                              # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
...
# %bb.9:                                # %middle.block
	add.d	$a1, $a4, $a1
	beq	$a3, $a2, .LBB26_16
.LBB26_10:                              # %for.body.preheader183
	alsl.d	$a4, $a3, $s2, 2
	sub.d	$a2, $a2, $a3
	.p2align	4, , 16
.LBB26_11:                              # %for.body
...
# %bb.0:                                # %entry
	...
	move	$a1, $a0
	pcalau12i	$a0, %pc_hi20(_ZTVN8NArchive4NZip12CLzmaDecoderE+16)
	addi.d	$a2, $a0, %pc_lo12(_ZTVN8NArchive4NZip12CLzmaDecoderE+16)
	ld.d	$a0, $a1, 24
	st.d	$a2, $a1, 0
	beqz	$a0, .LBB47_2
# %bb.1:                                # %if.then.i
...
# %bb.0:                                # %entry
	...
	.cfi_offset 1, -8
	.cfi_offset 22, -16
	pcalau12i	$a1, %pc_hi20(_ZTVN8NArchive4NZip12CLzmaDecoderE+16)
	addi.d	$a2, $a1, %pc_lo12(_ZTVN8NArchive4NZip12CLzmaDecoderE+16)
	ld.d	$a1, $a0, 24
	st.d	$a2, $a0, 0
	beqz	$a1, .LBB48_2
# %bb.1:                                # %if.then.i.i
...
# %bb.0:                                # %entry
	move	$a1, $a0
	pcalau12i	$a0, %got_pc_hi20(_ZTVN7NCrypto10NZipStrong10CBaseCoderE)
	ld.d	$a0, $a0, %got_pc_lo12(_ZTVN7NCrypto10NZipStrong10CBaseCoderE)
	addi.d	$a2, $a0, 16
	st.d	$a2, $a1, 0
	addi.d	$a2, $a0, 112
	st.d	$a2, $a1, 8
