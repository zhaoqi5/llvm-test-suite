...
# %bb.0:                                # %entry
	...
	ld.d	$s6, $a0, %got_pc_lo12(_ZN5NBitl12kInvertTableE)
	move	$s7, $zero
	ori	$s8, $zero, 7
	addi.d	$s1, $sp, 14
	ori	$s2, $zero, 10
...
.LBB27_9:                               # %vec.epilog.ph
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB27_10:                              # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
...
.LBB52_8:                               # %vec.epilog.ph
	...
	add.d	$a4, $a0, $a4
	.p2align	4, , 16
.LBB52_9:                               # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	vst	$vr0, $a3, 0
	addi.d	$a2, $a2, 16
...
# %bb.20:                               # %middle.block
	beq	$a2, $s4, .LBB86_12
	b	.LBB86_10
.LBB86_21:                              # %_ZN11CStringBaseIwED2Ev.exit
.Ltmp406:                               # EH_LABEL
	move	$fp, $a0
	move	$a0, $s2
	pcaddu18i	$ra, %call36(_ZdaPv)
