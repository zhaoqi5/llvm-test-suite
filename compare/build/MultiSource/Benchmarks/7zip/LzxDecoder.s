...
.LBB15_59:                              # %while.cond56.preheader
	...
	b	.LBB15_46
	.p2align	4, , 16
.LBB15_60:                              # %_ZN12CLzOutWindow7PutByteEh.exit161
...
.LBB15_61:                              # %while.body58
	...
	sub.d	$a3, $s7, $a0
	srl.w	$a1, $a1, $a3
	bstrpick.d	$s4, $a1, 16, 1
	bgeu	$s4, $a2, .LBB15_63
# %bb.62:                               # %if.then.i150
                                        #   in Loop: Header=BB15_61 Depth=2
	bstrpick.d	$a1, $s4, 31, 7
...
# %bb.89:                               #   in Loop: Header=BB15_61 Depth=2
	...
	b	.LBB15_98
	.p2align	4, , 16
.LBB15_90:                              # %if.end.i6.i.i.i192
                                        #   in Loop: Header=BB15_92 Depth=3
	addi.d	$a0, $a1, 1
	st.d	$a0, $s0, 0
	ld.bu	$a0, $a1, 0
.LBB15_91:                              # %_ZN9CInBuffer8ReadByteEv.exit8.i.i.i184
                                        #   in Loop: Header=BB15_92 Depth=3
	ld.w	$a1, $fp, 64
	slli.d	$a1, $a1, 16
	slli.d	$a0, $a0, 8
...
.LBB15_97:                              # %_ZN9NCompress4NLzx10NBitStream8CDecoder8ReadBitsEj.exit231
                                        #   in Loop: Header=BB15_61 Depth=2
...
# %bb.108:                              #   in Loop: Header=BB15_61 Depth=2
	...
	b	.LBB15_125
	.p2align	4, , 16
.LBB15_109:                             # %if.end.i6.i.i.i227
                                        #   in Loop: Header=BB15_111 Depth=3
	addi.d	$a0, $a1, 1
	st.d	$a0, $s0, 0
	ld.bu	$a0, $a1, 0
.LBB15_110:                             # %_ZN9CInBuffer8ReadByteEv.exit8.i.i.i219
                                        #   in Loop: Header=BB15_111 Depth=3
	ld.w	$a1, $fp, 64
	slli.d	$a1, $a1, 16
	slli.d	$a0, $a0, 8
...
# %bb.0:                                # %entry
	...
	move	$fp, $a0
	pcalau12i	$a0, %pc_hi20(_ZTVN9NCompress4NLzx8CDecoderE+16)
	addi.d	$a1, $a0, %pc_lo12(_ZTVN9NCompress4NLzx8CDecoderE+16)
	ldptr.d	$a0, $fp, 7392
	st.d	$a1, $fp, 0
	beqz	$a0, .LBB28_2
# %bb.1:                                # %if.then.i
