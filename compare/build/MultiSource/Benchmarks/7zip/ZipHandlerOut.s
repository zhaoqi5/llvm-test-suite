...
# %bb.149:                              #   in Loop: Header=BB10_2 Depth=1
	...
	b	.LBB10_172
.LBB10_150:                             # %vector.main.loop.iter.check821
                                        #   in Loop: Header=BB10_2 Depth=1
	ori	$a2, $zero, 16
...
.LBB10_177:                             # %vector.body825
	...
	addi.d	$a3, $a3, 64
	bnez	$a4, .LBB10_177
# %bb.178:                              # %middle.block830
                                        #   in Loop: Header=BB10_2 Depth=1
	beq	$a2, $a0, .LBB10_185
# %bb.179:                              # %vec.epilog.iter.check835
                                        #   in Loop: Header=BB10_2 Depth=1
	andi	$a3, $a0, 12
	beqz	$a3, .LBB10_183
.LBB10_180:                             # %vec.epilog.ph834
                                        #   in Loop: Header=BB10_2 Depth=1
	move	$a4, $a2
	bstrpick.d	$a2, $a0, 30, 2
	slli.d	$a2, $a2, 2
	...
	slli.d	$a4, $a4, 2
	.p2align	4, , 16
.LBB10_181:                             # %vec.epilog.vector.body840
                                        #   Parent Loop BB10_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vldx	$vr0, $a1, $a4
	vstx	$vr0, $s7, $a4
	...
	addi.d	$a4, $a4, 16
	bnez	$a3, .LBB10_181
# %bb.182:                              # %vec.epilog.middle.block844
                                        #   in Loop: Header=BB10_2 Depth=1
	beq	$a2, $a0, .LBB10_185
...
.LBB10_206:                             # %for.body.i619
	...
	bnez	$a4, .LBB10_206
	b	.LBB10_296
.LBB10_207:                             # %vector.main.loop.iter.check853
                                        #   in Loop: Header=BB10_2 Depth=1
	ori	$a3, $zero, 16
...
# %bb.208:                              #   in Loop: Header=BB10_2 Depth=1
	move	$a3, $zero
	b	.LBB10_247
.LBB10_209:                             # %vector.main.loop.iter.check885
                                        #   in Loop: Header=BB10_2 Depth=1
	ori	$a2, $zero, 16
...
.LBB10_225:                             # %for.body.i651
	...
	bnez	$a4, .LBB10_225
	b	.LBB10_310
.LBB10_226:                             # %vector.main.loop.iter.check789
                                        #   in Loop: Header=BB10_2 Depth=1
	ori	$a1, $zero, 16
...
.LBB10_244:                             # %vector.body857
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB10_244
# %bb.245:                              # %middle.block862
                                        #   in Loop: Header=BB10_2 Depth=1
	beq	$a3, $a1, .LBB10_192
# %bb.246:                              # %vec.epilog.iter.check867
                                        #   in Loop: Header=BB10_2 Depth=1
	andi	$a4, $a1, 12
	beqz	$a4, .LBB10_80
.LBB10_247:                             # %vec.epilog.ph866
                                        #   in Loop: Header=BB10_2 Depth=1
	move	$a5, $a3
	...
	slli.d	$a5, $a5, 2
	.p2align	4, , 16
.LBB10_248:                             # %vec.epilog.vector.body872
                                        #   Parent Loop BB10_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vldx	$vr0, $a2, $a5
	vstx	$vr0, $a0, $a5
	...
	addi.d	$a5, $a5, 16
	bnez	$a4, .LBB10_248
# %bb.249:                              # %vec.epilog.middle.block876
                                        #   in Loop: Header=BB10_2 Depth=1
	bne	$a3, $a1, .LBB10_80
	b	.LBB10_192
.LBB10_250:                             # %vector.ph886
                                        #   in Loop: Header=BB10_2 Depth=1
	bstrpick.d	$a2, $a0, 30, 4
	slli.d	$a2, $a2, 4
	move	$a3, $zero
...
.LBB10_251:                             # %vector.body889
	...
	addi.d	$a3, $a3, 64
	bnez	$a4, .LBB10_251
# %bb.252:                              # %middle.block894
                                        #   in Loop: Header=BB10_2 Depth=1
	beq	$a2, $a0, .LBB10_259
# %bb.253:                              # %vec.epilog.iter.check899
                                        #   in Loop: Header=BB10_2 Depth=1
	andi	$a3, $a0, 12
	beqz	$a3, .LBB10_257
.LBB10_254:                             # %vec.epilog.ph898
                                        #   in Loop: Header=BB10_2 Depth=1
	move	$a4, $a2
	bstrpick.d	$a2, $a0, 30, 2
	slli.d	$a2, $a2, 2
	...
	slli.d	$a4, $a4, 2
	.p2align	4, , 16
.LBB10_255:                             # %vec.epilog.vector.body904
                                        #   Parent Loop BB10_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vldx	$vr0, $a1, $a4
	vstx	$vr0, $s7, $a4
	...
	addi.d	$a4, $a4, 16
	bnez	$a3, .LBB10_255
# %bb.256:                              # %vec.epilog.middle.block908
                                        #   in Loop: Header=BB10_2 Depth=1
	beq	$a2, $a0, .LBB10_259
...
# %bb.285:                              # %for.inc
	...
	bne	$s3, $s4, .LBB10_2
	b	.LBB10_349
.LBB10_286:                             # %vector.main.loop.iter.check917
                                        #   in Loop: Header=BB10_2 Depth=1
	ori	$a3, $zero, 16
...
.LBB10_289:                             # %vector.body793
	...
	addi.d	$a2, $a2, 64
	bnez	$a3, .LBB10_289
# %bb.290:                              # %middle.block798
                                        #   in Loop: Header=BB10_2 Depth=1
	beq	$a1, $a0, .LBB10_175
# %bb.291:                              # %vec.epilog.iter.check803
                                        #   in Loop: Header=BB10_2 Depth=1
	andi	$a2, $a0, 12
	beqz	$a2, .LBB10_173
.LBB10_292:                             # %vec.epilog.ph802
                                        #   in Loop: Header=BB10_2 Depth=1
	move	$a3, $a1
	...
	slli.d	$a3, $a3, 2
	.p2align	4, , 16
.LBB10_293:                             # %vec.epilog.vector.body808
                                        #   Parent Loop BB10_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	add.d	$a4, $s8, $a3
	vld	$vr0, $a4, 12
	...
	addi.d	$a3, $a3, 16
	bnez	$a2, .LBB10_293
# %bb.294:                              # %vec.epilog.middle.block812
                                        #   in Loop: Header=BB10_2 Depth=1
	bne	$a1, $a0, .LBB10_173
	b	.LBB10_175
...
# %bb.306:                              # %cleanup.cont381
	...
	st.w	$a0, $a1, 220
	b	.LBB10_281
.LBB10_307:                             # %vector.main.loop.iter.check949
                                        #   in Loop: Header=BB10_2 Depth=1
	ori	$a3, $zero, 16
...
.LBB10_318:                             # %vector.body921
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB10_318
# %bb.319:                              # %middle.block926
                                        #   in Loop: Header=BB10_2 Depth=1
	beq	$a3, $a1, .LBB10_265
# %bb.320:                              # %vec.epilog.iter.check931
                                        #   in Loop: Header=BB10_2 Depth=1
	andi	$a4, $a1, 12
	beqz	$a4, .LBB10_166
.LBB10_321:                             # %vec.epilog.ph930
                                        #   in Loop: Header=BB10_2 Depth=1
	move	$a5, $a3
	bstrpick.d	$a3, $a1, 30, 2
	slli.d	$a3, $a3, 2
	...
	slli.d	$a5, $a5, 2
	.p2align	4, , 16
.LBB10_322:                             # %vec.epilog.vector.body936
                                        #   Parent Loop BB10_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vldx	$vr0, $a2, $a5
	vstx	$vr0, $a0, $a5
	...
	addi.d	$a5, $a5, 16
	bnez	$a4, .LBB10_322
# %bb.323:                              # %vec.epilog.middle.block940
                                        #   in Loop: Header=BB10_2 Depth=1
	bne	$a3, $a1, .LBB10_166
	b	.LBB10_265
.LBB10_324:                             # %vector.main.loop.iter.check981
                                        #   in Loop: Header=BB10_2 Depth=1
	ori	$a3, $zero, 16
...
# %bb.329:                              # %if.then420
	...
	b	.LBB10_341
.LBB10_330:                             # %vector.ph950
                                        #   in Loop: Header=BB10_2 Depth=1
	bstrpick.d	$a3, $a1, 30, 4
	slli.d	$a3, $a3, 4
	move	$a5, $zero
	move	$a6, $a3
.LBB10_331:                             # %vector.body953
                                        #   Parent Loop BB10_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	add.d	$a7, $a4, $a5
	xvld	$xr0, $a7, 8
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB10_331
# %bb.332:                              # %middle.block958
                                        #   in Loop: Header=BB10_2 Depth=1
	beq	$a3, $a1, .LBB10_296
# %bb.333:                              # %vec.epilog.iter.check963
                                        #   in Loop: Header=BB10_2 Depth=1
	andi	$a4, $a1, 12
	beqz	$a4, .LBB10_205
.LBB10_334:                             # %vec.epilog.ph962
                                        #   in Loop: Header=BB10_2 Depth=1
	move	$a5, $a3
	bstrpick.d	$a3, $a1, 30, 2
	slli.d	$a3, $a3, 2
	...
	slli.d	$a5, $a5, 2
	.p2align	4, , 16
.LBB10_335:                             # %vec.epilog.vector.body968
                                        #   Parent Loop BB10_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vldx	$vr0, $a2, $a5
	vstx	$vr0, $a0, $a5
	...
	addi.d	$a5, $a5, 16
	bnez	$a4, .LBB10_335
# %bb.336:                              # %vec.epilog.middle.block972
                                        #   in Loop: Header=BB10_2 Depth=1
	bne	$a3, $a1, .LBB10_205
	b	.LBB10_296
...
.LBB10_341:                             # %if.end458
	...
	st.b	$zero, $a0, 0
	b	.LBB10_281
.LBB10_342:                             # %vector.ph982
                                        #   in Loop: Header=BB10_2 Depth=1
	bstrpick.d	$a3, $a1, 30, 4
	slli.d	$a3, $a3, 4
	move	$a5, $zero
	move	$a6, $a3
.LBB10_343:                             # %vector.body985
                                        #   Parent Loop BB10_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	add.d	$a7, $a4, $a5
	xvld	$xr0, $a7, 8
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB10_343
# %bb.344:                              # %middle.block990
                                        #   in Loop: Header=BB10_2 Depth=1
	beq	$a3, $a1, .LBB10_310
# %bb.345:                              # %vec.epilog.iter.check995
                                        #   in Loop: Header=BB10_2 Depth=1
	andi	$a4, $a1, 12
	beqz	$a4, .LBB10_224
.LBB10_346:                             # %vec.epilog.ph994
                                        #   in Loop: Header=BB10_2 Depth=1
	move	$a5, $a3
	bstrpick.d	$a3, $a1, 30, 2
	slli.d	$a3, $a3, 2
	sub.d	$a4, $a5, $a3
	slli.d	$a5, $a5, 2
.LBB10_347:                             # %vec.epilog.vector.body1000
                                        #   Parent Loop BB10_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vldx	$vr0, $a2, $a5
	vstx	$vr0, $a0, $a5
	...
	addi.d	$a5, $a5, 16
	bnez	$a4, .LBB10_347
# %bb.348:                              # %vec.epilog.middle.block1004
                                        #   in Loop: Header=BB10_2 Depth=1
	bne	$a3, $a1, .LBB10_224
	b	.LBB10_310
.LBB10_349:
