...
# %bb.44:                               # %vec.epilog.iter.check
                                        #   in Loop: Header=BB6_6 Depth=1
	bnez	$a3, .LBB6_35
.LBB6_45:                               # %for.body.i.i.preheader
                                        #   in Loop: Header=BB6_6 Depth=1
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s5, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB6_46:                               # %for.body.i.i
                                        #   Parent Loop BB6_6 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
...
.LBB6_53:                               # %_ZN11CStringBaseIcED2Ev.exit.i
	...
	ld.d	$a0, $sp, 208
	beqz	$a0, .LBB6_55
# %bb.54:                               # %delete.notnull.i2.i
                                        #   in Loop: Header=BB6_6 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_55:                               # %_ZN11CStringBaseIcED2Ev.exit3.i
                                        #   in Loop: Header=BB6_6 Depth=1
	ld.d	$a0, $sp, 192
	beqz	$a0, .LBB6_57
# %bb.56:                               # %delete.notnull.i5.i
                                        #   in Loop: Header=BB6_6 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_57:                               # %_ZN11CStringBaseIcED2Ev.exit6.i
                                        #   in Loop: Header=BB6_6 Depth=1
	ld.d	$a0, $sp, 144
	beqz	$a0, .LBB6_5
# %bb.58:                               # %delete.notnull.i8.i
                                        #   in Loop: Header=BB6_6 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	b	.LBB6_5
...
.Ltmp56:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp57:                                # EH_LABEL
# %bb.72:                               # %invoke.cont138
	ld.d	$a0, $sp, 104
	beqz	$a0, .LBB6_74
# %bb.73:                               # %delete.notnull.i
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
...
# %bb.75:                               # %invoke.cont143
	...
	maskeqz	$s1, $s5, $fp
	beqz	$a0, .LBB6_77
# %bb.76:                               # %delete.notnull.i52
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_77:                               # %_ZN11CStringBaseIwED2Ev.exit53
	or	$s2, $s1, $s0
.LBB6_78:                               # %cleanup152
.Ltmp68:                                # EH_LABEL
	addi.d	$a0, $sp, 144
...
.LBB6_86:                               # %lpad135
.Ltmp55:                                # EH_LABEL
.LBB6_87:                               # %ehcleanup149
	move	$fp, $a0
.LBB6_88:                               # %ehcleanup149
	ld.d	$a0, $sp, 120
	beqz	$a0, .LBB6_95
# %bb.89:                               # %delete.notnull.i61
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	b	.LBB6_95
.LBB6_90:                               # %lpad133
.Ltmp52:                                # EH_LABEL
	b	.LBB6_94
.LBB6_91:                               # %terminate.lpad.i59
.Ltmp73:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB6_92:                               # %terminate.lpad.i
.Ltmp70:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB6_93:                               # %lpad119
.Ltmp49:                                # EH_LABEL
.LBB6_94:                               # %ehcleanup153
	move	$fp, $a0
...
.LBB6_107:                              # %ehcleanup93
	...
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB6_108:                              # %ehcleanup.thread.i
.Ltmp18:                                # EH_LABEL
	move	$fp, $a0
	b	.LBB6_110
.LBB6_109:                              # %ehcleanup.i
.Ltmp21:                                # EH_LABEL
	move	$fp, $a0
	move	$a0, $s6
	pcaddu18i	$ra, %call36(_ZdaPv)
...
.Ltmp15:                                # EH_LABEL
	move	$fp, $a0
.LBB6_112:                              # %ehcleanup6.i
	ld.d	$a0, $sp, 144
	beqz	$a0, .LBB6_114
# %bb.113:                              # %delete.notnull.i18.i
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
...
# %bb.12:                               # %middle.block
	add.d	$a1, $a4, $a1
	beq	$a3, $a2, .LBB19_19
.LBB19_13:                              # %for.body.preheader284
