...
.LBB12_61:                              # %_ZN11CStringBaseIwED2Ev.exit86
	...
	b	.LBB12_100
.LBB12_62:                              # %if.then.fold.split132
	ori	$a0, $zero, 2
	b	.LBB12_80
.LBB12_63:                              # %if.then.fold.split131
	ori	$a0, $zero, 3
	b	.LBB12_80
.LBB12_64:                              # %if.then.fold.split129
	ori	$a0, $zero, 5
	b	.LBB12_80
.LBB12_65:                              # %if.then.fold.split130
	ori	$a0, $zero, 4
	b	.LBB12_80
.LBB12_66:                              # %if.then.fold.split133
	ori	$a0, $zero, 1
	b	.LBB12_80
.LBB12_67:                              # %if.then.fold.split128
	ori	$a0, $zero, 6
	b	.LBB12_80
.LBB12_68:                              # %if.then.fold.split119
	ori	$a0, $zero, 15
	b	.LBB12_80
.LBB12_69:                              # %if.then.fold.split127
	ori	$a0, $zero, 7
	b	.LBB12_80
.LBB12_70:                              # %if.then.fold.split111
	ori	$a0, $zero, 23
	b	.LBB12_80
.LBB12_71:                              # %if.then.fold.split115
	ori	$a0, $zero, 19
	b	.LBB12_80
.LBB12_72:                              # %if.then.fold.split123
	ori	$a0, $zero, 11
	b	.LBB12_80
.LBB12_73:                              # %if.then.fold.split107
	ori	$a0, $zero, 27
	b	.LBB12_80
.LBB12_74:                              # %if.then.fold.split117
	ori	$a0, $zero, 17
	b	.LBB12_80
.LBB12_75:                              # %if.then.fold.split125
	ori	$a0, $zero, 9
	b	.LBB12_80
.LBB12_76:                              # %if.then.fold.split109
	ori	$a0, $zero, 25
	b	.LBB12_80
.LBB12_77:                              # %if.then.fold.split113
	ori	$a0, $zero, 21
	b	.LBB12_80
.LBB12_78:                              # %if.then.fold.split121
	ori	$a0, $zero, 13
	b	.LBB12_80
.LBB12_79:                              # %if.then.fold.split105
	ori	$a0, $zero, 29
.LBB12_80:                              # %if.then
	addi.d	$a1, $sp, 24
	addi.d	$s1, $sp, 24
