...
# %bb.9:                                # %invoke.cont3
	...
	st.d	$a0, $sp, 72
	pcalau12i	$a0, %pc_hi20(_ZTV13CRecordVectorIyE+16)
	addi.d	$a1, $a0, %pc_lo12(_ZTV13CRecordVectorIyE+16)
	ld.w	$a0, $s0, 252
	st.d	$a1, $sp, 48
	blez	$a0, .LBB4_45
...
.LBB10_62:                              # %invoke.cont127
	...
	ld.d	$a0, $sp, 152
	beqz	$a0, .LBB10_64
.LBB10_63:                              # %if.end326thread-pre-split
                                        #   in Loop: Header=BB10_45 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
...
.Ltmp138:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp139:                               # EH_LABEL
# %bb.70:                               # %for.cond342.preheader
                                        #   in Loop: Header=BB10_45 Depth=1
	ld.d	$a0, $s6, 16
	beqz	$a0, .LBB10_165
# %bb.71:                               # %if.else360.peel
                                        #   in Loop: Header=BB10_45 Depth=1
	ld.d	$a0, $s6, 24
	ld.bu	$s0, $a0, 0
	sltui	$a0, $s0, 160
...
# %bb.73:                               # %for.inc.peel
	...
	ld.d	$a0, $s6, 16
	ori	$a1, $zero, 2
	bltu	$a0, $a1, .LBB10_165
# %bb.74:                               # %if.else360.peel436
                                        #   in Loop: Header=BB10_45 Depth=1
	ld.d	$a0, $s6, 24
	ld.bu	$s0, $a0, 1
	sltui	$a0, $s0, 160
...
.Ltmp144:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp145:                               # EH_LABEL
# %bb.75:                               # %call2.i.noexc371.peel445
                                        #   in Loop: Header=BB10_45 Depth=1
	andi	$a0, $s0, 15
	sltui	$a1, $a0, 10
	ori	$a2, $zero, 3
...
.Ltmp146:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp147:                               # EH_LABEL
# %bb.76:                               # %for.inc.peel452
                                        #   in Loop: Header=BB10_45 Depth=1
	ld.d	$a0, $s6, 16
	ori	$a1, $zero, 3
	bltu	$a0, $a1, .LBB10_165
# %bb.77:                               # %if.else360.peel461
                                        #   in Loop: Header=BB10_45 Depth=1
	ld.d	$a0, $s6, 24
	ld.bu	$s0, $a0, 2
	sltui	$a0, $s0, 160
...
.Ltmp148:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp149:                               # EH_LABEL
# %bb.78:                               # %call2.i.noexc371.peel470
                                        #   in Loop: Header=BB10_45 Depth=1
	andi	$a0, $s0, 15
	sltui	$a1, $a0, 10
	ori	$a2, $zero, 3
...
.Ltmp150:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp151:                               # EH_LABEL
# %bb.79:                               # %for.inc.peel477
                                        #   in Loop: Header=BB10_45 Depth=1
	ld.d	$a0, $s6, 16
	bltu	$a0, $s5, .LBB10_165
# %bb.80:                               # %if.else360.peel486
                                        #   in Loop: Header=BB10_45 Depth=1
	ld.d	$a0, $s6, 24
	ld.bu	$s0, $a0, 3
	sltui	$a0, $s0, 160
...
.Ltmp152:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp153:                               # EH_LABEL
# %bb.81:                               # %call2.i.noexc371.peel495
                                        #   in Loop: Header=BB10_45 Depth=1
	andi	$a0, $s0, 15
	sltui	$a1, $a0, 10
	ori	$a2, $zero, 3
...
.Ltmp154:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp155:                               # EH_LABEL
# %bb.82:                               # %for.inc.peel502
                                        #   in Loop: Header=BB10_45 Depth=1
	ld.d	$a0, $s6, 16
	ori	$a1, $zero, 5
	bltu	$a0, $a1, .LBB10_165
# %bb.83:                               # %if.else360.peel511
                                        #   in Loop: Header=BB10_45 Depth=1
	ld.d	$a0, $s6, 24
	ld.bu	$s0, $a0, 4
	sltui	$a0, $s0, 160
...
.Ltmp156:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp157:                               # EH_LABEL
# %bb.84:                               # %call2.i.noexc371.peel520
                                        #   in Loop: Header=BB10_45 Depth=1
	andi	$a0, $s0, 15
	sltui	$a1, $a0, 10
	ori	$a2, $zero, 3
...
.Ltmp158:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp159:                               # EH_LABEL
# %bb.85:                               # %for.inc.peel527
                                        #   in Loop: Header=BB10_45 Depth=1
	ld.d	$a0, $s6, 16
	ori	$a1, $zero, 6
	bltu	$a0, $a1, .LBB10_165
# %bb.86:                               # %if.else360.peel536
                                        #   in Loop: Header=BB10_45 Depth=1
	ld.d	$a0, $s6, 24
	ld.bu	$s0, $a0, 5
	sltui	$a0, $s0, 160
...
.Ltmp160:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp161:                               # EH_LABEL
# %bb.87:                               # %call2.i.noexc371.peel545
                                        #   in Loop: Header=BB10_45 Depth=1
	andi	$a0, $s0, 15
	sltui	$a1, $a0, 10
	ori	$a2, $zero, 3
...
.Ltmp162:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp163:                               # EH_LABEL
# %bb.88:                               # %for.inc.peel552
                                        #   in Loop: Header=BB10_45 Depth=1
	ld.d	$a0, $s6, 16
	ori	$a1, $zero, 7
	bltu	$a0, $a1, .LBB10_165
# %bb.89:                               # %for.body349.preheader
                                        #   in Loop: Header=BB10_45 Depth=1
	ori	$a1, $zero, 6
.LBB10_90:                              # %for.body349
                                        #   Parent Loop BB10_45 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.d	$s0, $a1, 1
	bltu	$s0, $a0, .LBB10_164
# %bb.91:                               # %if.else360
...
# %bb.93:                               # %for.inc
	...
	bltu	$s0, $a0, .LBB10_90
	b	.LBB10_165
.LBB10_94:                              # %invoke.cont132
                                        #   in Loop: Header=BB10_45 Depth=1
	ori	$a1, $zero, 3
	beq	$a0, $a1, .LBB10_113
# %bb.95:                               # %invoke.cont132
                                        #   in Loop: Header=BB10_45 Depth=1
	ori	$a1, $zero, 33
	bne	$a0, $a1, .LBB10_64
# %bb.96:                               # %land.lhs.true200
                                        #   in Loop: Header=BB10_45 Depth=1
	ld.d	$a0, $s6, 16
	bne	$a0, $s3, .LBB10_64
# %bb.97:                               # %if.then205
...
.Ltmp117:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp118:                               # EH_LABEL
# %bb.100:                              # %call.i.i.noexc250
                                        #   in Loop: Header=BB10_45 Depth=1
	move	$s1, $a0
	blez	$s3, .LBB10_153
# %bb.101:                              # %delete.notnull.i.i248
                                        #   in Loop: Header=BB10_45 Depth=1
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
...
.Ltmp123:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp124:                               # EH_LABEL
# %bb.106:                              # %call.i.i.noexc218
                                        #   in Loop: Header=BB10_45 Depth=1
	move	$s1, $a0
	blez	$s3, .LBB10_149
# %bb.107:                              # %delete.notnull.i.i216
                                        #   in Loop: Header=BB10_45 Depth=1
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
...
.Ltmp95:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp96:                                # EH_LABEL
# %bb.111:                              # %call.i.i.noexc272
                                        #   in Loop: Header=BB10_45 Depth=1
	move	$s2, $a0
	blez	$s3, .LBB10_137
# %bb.112:                              # %delete.notnull.i.i270
                                        #   in Loop: Header=BB10_45 Depth=1
	move	$a0, $s1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
...
# %bb.115:                              # %.noexc
	...
	addi.w	$s3, $s5, 0
	bgez	$a0, .LBB10_125
# %bb.116:                              #   in Loop: Header=BB10_45 Depth=1
	move	$s1, $zero
	b	.LBB10_127
.LBB10_117:                             # %if.end9.i.i.i317
                                        #   in Loop: Header=BB10_45 Depth=1
	addi.w	$a0, $s0, 0
	slti	$a0, $a0, -1
	slli.d	$a1, $s3, 2
...
.Ltmp89:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp90:                                # EH_LABEL
# %bb.118:                              # %call.i.i.i.noexc329
                                        #   in Loop: Header=BB10_45 Depth=1
	move	$s1, $a0
	st.w	$zero, $a0, 0
.LBB10_119:                             # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i320
                                        #   in Loop: Header=BB10_45 Depth=1
	move	$a0, $zero
	.p2align	4, , 16
.LBB10_120:                             # %while.cond.i.i.i321
                                        #   Parent Loop BB10_45 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.w	$a1, $a0, $s2
	stx.w	$a1, $s1, $a0
...
.Ltmp92:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp93:                                # EH_LABEL
# %bb.123:                              # %call.i.i.noexc353
                                        #   in Loop: Header=BB10_45 Depth=1
	move	$s3, $a0
	blez	$s4, .LBB10_133
# %bb.124:                              # %delete.notnull.i.i351
                                        #   in Loop: Header=BB10_45 Depth=1
	move	$a0, $s2
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
...
.Ltmp128:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp129:                               # EH_LABEL
# %bb.126:                              # %call.i.i.i.noexc
                                        #   in Loop: Header=BB10_45 Depth=1
	move	$s1, $a0
	st.w	$zero, $a0, 0
.LBB10_127:                             # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i
                                        #   in Loop: Header=BB10_45 Depth=1
	move	$a0, $zero
	.p2align	4, , 16
.LBB10_128:                             # %while.cond.i.i.i
                                        #   Parent Loop BB10_45 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.w	$a1, $a0, $s2
	stx.w	$a1, $s1, $a0
...
.Ltmp131:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp132:                               # EH_LABEL
# %bb.131:                              # %call.i.i.noexc
                                        #   in Loop: Header=BB10_45 Depth=1
	move	$s3, $a0
	blez	$s4, .LBB10_158
# %bb.132:                              # %delete.notnull.i.i
                                        #   in Loop: Header=BB10_45 Depth=1
	move	$a0, $s2
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
...
.LBB10_134:                             # %if.end9.i.i341
	...
	st.w	$s5, $sp, 100
	move	$s2, $s3
.LBB10_135:                             # %while.cond.i.i345.preheader
                                        #   in Loop: Header=BB10_45 Depth=1
	ld.d	$s4, $sp, 40                    # 8-byte Folded Reload
	move	$a0, $zero
	ori	$s5, $zero, 4
...
.Ltmp102:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp103:                               # EH_LABEL
# %bb.144:                              # %invoke.cont247
                                        #   in Loop: Header=BB10_45 Depth=1
	ld.d	$a0, $sp, 72
	beqz	$a0, .LBB10_146
# %bb.145:                              # %delete.notnull.i295
                                        #   in Loop: Header=BB10_45 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB10_146:                             # %_ZN11CStringBaseIwED2Ev.exit296
                                        #   in Loop: Header=BB10_45 Depth=1
.Ltmp105:                               # EH_LABEL
...
.Ltmp112:                               # EH_LABEL
	ori	$s3, $zero, 1
	b	.LBB10_62
.LBB10_149:                             #   in Loop: Header=BB10_45 Depth=1
	move	$a0, $zero
.LBB10_150:                             # %if.end9.i.i206
                                        #   in Loop: Header=BB10_45 Depth=1
	st.d	$s1, $sp, 88
	slli.d	$a0, $a0, 2
	stx.w	$zero, $s1, $a0
	st.w	$s2, $sp, 100
	move	$s0, $s1
.LBB10_151:                             # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i209
                                        #   in Loop: Header=BB10_45 Depth=1
	ori	$s3, $zero, 1
	ld.d	$a0, $sp, 152
	move	$a1, $zero
	.p2align	4, , 16
.LBB10_152:                             # %while.cond.i.i210
                                        #   Parent Loop BB10_45 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.w	$a2, $a0, $a1
	stx.w	$a2, $s0, $a1
	...
	bnez	$a2, .LBB10_152
	b	.LBB10_157
.LBB10_153:                             #   in Loop: Header=BB10_45 Depth=1
	move	$a0, $zero
.LBB10_154:                             # %if.end9.i.i238
                                        #   in Loop: Header=BB10_45 Depth=1
	st.d	$s1, $sp, 88
	slli.d	$a0, $a0, 2
	stx.w	$zero, $s1, $a0
	st.w	$s2, $sp, 100
	move	$s0, $s1
.LBB10_155:                             # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i241
                                        #   in Loop: Header=BB10_45 Depth=1
	ori	$s3, $zero, 1
	ld.d	$a0, $sp, 152
	move	$a1, $zero
	.p2align	4, , 16
.LBB10_156:                             # %while.cond.i.i242
                                        #   Parent Loop BB10_45 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.w	$a2, $a0, $a1
	stx.w	$a2, $s0, $a1
...
.LBB10_159:                             # %if.end9.i.i
	...
	st.w	$s5, $sp, 100
	move	$s2, $s3
.LBB10_160:                             # %while.cond.i.i.preheader
                                        #   in Loop: Header=BB10_45 Depth=1
	ld.d	$s4, $sp, 40                    # 8-byte Folded Reload
	move	$a0, $zero
	ori	$s5, $zero, 4
...
.LBB10_161:                             # %while.cond.i.i
	...
	addi.d	$a0, $a0, 4
	bnez	$a1, .LBB10_161
.LBB10_162:                             # %invoke.cont147
                                        #   in Loop: Header=BB10_45 Depth=1
	st.w	$s0, $sp, 96
	beqz	$s1, .LBB10_65
# %bb.163:                              # %delete.notnull.i187
                                        #   in Loop: Header=BB10_45 Depth=1
	move	$a0, $s1
	b	.LBB10_63
.LBB10_164:                             # %if.then357
                                        #   in Loop: Header=BB10_45 Depth=1
.Ltmp170:                               # EH_LABEL
...
.LBB10_166:                             # %if.end371
	...
	ld.d	$a0, $sp, 88
	beqz	$a0, .LBB10_168
# %bb.167:                              # %delete.notnull.i375
                                        #   in Loop: Header=BB10_45 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB10_168:                             # %_ZN11CStringBaseIwED2Ev.exit376
                                        #   in Loop: Header=BB10_45 Depth=1
	ld.d	$a0, $sp, 104
	beqz	$a0, .LBB10_44
# %bb.169:                              # %delete.notnull.i378
                                        #   in Loop: Header=BB10_45 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	b	.LBB10_44
...
.LBB10_172:
	move	$a0, $zero
.LBB10_173:                             # %_ZNK8NArchive3N7z16CArchiveDatabase10IsItemAntiEi.exit.invoke
.Ltmp197:                               # EH_LABEL
	andi	$a1, $a0, 1
	addi.d	$a0, $sp, 136
	pcaddu18i	$ra, %call36(_ZN8NWindows4NCOM12CPropVariantaSEb)
...
.Ltmp198:                               # EH_LABEL
	b	.LBB10_180
.LBB10_174:                             # %for.cond.cleanup.loopexit
	ld.d	$a1, $sp, 120
.LBB10_175:                             # %for.cond.cleanup
.Ltmp176:                               # EH_LABEL
	addi.d	$a0, $sp, 136
	pcaddu18i	$ra, %call36(_ZN8NWindows4NCOM12CPropVariantaSEPKw)
	jirl	$ra, $ra, 0
.Ltmp177:                               # EH_LABEL
# %bb.176:                              # %invoke.cont385
	ld.d	$a0, $sp, 120
	beqz	$a0, .LBB10_180
.LBB10_177:                             # %delete.notnull.i
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	b	.LBB10_180
.LBB10_178:
	move	$a1, $zero
.LBB10_179:                             # %if.else.invoke
.Ltmp192:                               # EH_LABEL
	addi.d	$a0, $sp, 136
	pcaddu18i	$ra, %call36(_ZN8NWindows4NCOM12CPropVariantaSEy)
	jirl	$ra, $ra, 0
...
.Ltmp205:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp206:                               # EH_LABEL
# %bb.181:                              # %invoke.cont447
.Ltmp214:                               # EH_LABEL
	addi.d	$a0, $sp, 136
	pcaddu18i	$ra, %call36(_ZN8NWindows4NCOM12CPropVariant5ClearEv)
	jirl	$ra, $ra, 0
.Ltmp215:                               # EH_LABEL
# %bb.182:                              # %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit
	move	$a0, $zero
.LBB10_183:                             # %return
	...
	addi.d	$sp, $sp, 368
	ret
.LBB10_184:                             # %lpad344.loopexit.split-lp
.Ltmp172:                               # EH_LABEL
	b	.LBB10_226
.LBB10_185:                             # %lpad44
.Ltmp189:                               # EH_LABEL
...
.Ltmp107:                               # EH_LABEL
	b	.LBB10_226
.LBB10_205:                             # %lpad344.loopexit.loopexit
.Ltmp169:                               # EH_LABEL
	b	.LBB10_226
.LBB10_206:                             # %lpad311
.Ltmp91:                                # EH_LABEL
...
.LBB10_213:                             # %lpad126
	...
	move	$s0, $a0
	beqz	$a2, .LBB10_227
# %bb.214:                              # %delete.notnull.i175
	move	$a0, $a2
.LBB10_215:                             # %ehcleanup372
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	b	.LBB10_227
.LBB10_216:                             # %lpad124
.Ltmp81:                                # EH_LABEL
	b	.LBB10_226
.LBB10_217:                             # %lpad344.loopexit.loopexit.split-lp
.Ltmp164:                               # EH_LABEL
	b	.LBB10_226
.LBB10_218:                             # %lpad104
.Ltmp70:                                # EH_LABEL
...
.Ltmp76:                                # EH_LABEL
	...
	move	$s0, $a0
	b	.LBB10_229
.LBB10_222:                             # %terminate.lpad.i
.Ltmp216:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB10_223:                             # %lpad4
.Ltmp207:                               # EH_LABEL
.LBB10_224:                             # %ehcleanup450
	move	$fp, $a1
	move	$s0, $a0
	b	.LBB10_233
.LBB10_225:                             # %lpad117
.Ltmp175:                               # EH_LABEL
.LBB10_226:                             # %ehcleanup372
	move	$fp, $a1
	move	$s0, $a0
.LBB10_227:                             # %ehcleanup372
	ld.d	$a0, $sp, 88
	beqz	$a0, .LBB10_229
# %bb.228:                              # %delete.notnull.i381
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB10_229:                             # %ehcleanup374
	ld.d	$a0, $sp, 104
	beqz	$a0, .LBB10_231
# %bb.230:                              # %delete.notnull.i384
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB10_231:                             # %ehcleanup387
	ld.d	$a0, $sp, 120
	beqz	$a0, .LBB10_233
.LBB10_232:                             # %delete.notnull.i390
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB10_233:                             # %ehcleanup450
.Ltmp208:                               # EH_LABEL
	addi.d	$a0, $sp, 136
	pcaddu18i	$ra, %call36(_ZN8NWindows4NCOM12CPropVariant5ClearEv)
	jirl	$ra, $ra, 0
.Ltmp209:                               # EH_LABEL
# %bb.234:                              # %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit410
	addi.w	$s1, $fp, 0
	move	$a0, $s0
	pcaddu18i	$ra, %call36(__cxa_begin_catch)
	jirl	$ra, $ra, 0
...
.Lcst_begin3:
	...
	.uleb128 .Ltmp175-.Lfunc_begin3         #     jumps to .Ltmp175
	.byte	3                               #   On action: 2
	.uleb128 .Ltmp140-.Lfunc_begin3         # >> Call Site 23 <<
...
.Ltmp220:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp221:                               # EH_LABEL
# %bb.8:                                # %call.i.i.i72.noexc
	st.d	$a0, $sp, 8
	st.w	$zero, $a0, 0
	st.w	$s2, $sp, 20
	.p2align	4, , 16
.LBB12_9:                               # %while.cond.i.i.i74
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a1, $s1, 0
	addi.d	$s1, $s1, 4
	addi.d	$a2, $a0, 4
...
# %bb.11:                               # %invoke.cont28
	ld.d	$a0, $sp, 8
	beqz	$a0, .LBB12_13
# %bb.12:                               # %delete.notnull.i85
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB12_13:                              # %_ZN11CStringBaseIwED2Ev.exit86
...
.Ltmp236:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp237:                               # EH_LABEL
# %bb.16:                               # %call.i.i.i24.noexc
	st.d	$a0, $sp, 8
	st.w	$zero, $a0, 0
	st.w	$s2, $sp, 20
	.p2align	4, , 16
.LBB12_17:                              # %while.cond.i.i.i26
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a1, $s1, 0
	addi.d	$s1, $s1, 4
	addi.d	$a2, $a0, 4
...
.Ltmp228:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp229:                               # EH_LABEL
# %bb.24:                               # %call.i.i.i46.noexc
	st.d	$a0, $sp, 8
	st.w	$zero, $a0, 0
	st.w	$s2, $sp, 20
	.p2align	4, , 16
.LBB12_25:                              # %while.cond.i.i.i48
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a1, $s1, 0
	addi.d	$s1, $s1, 4
	addi.d	$a2, $a0, 4
...
# %bb.27:                               # %invoke.cont17
	ld.d	$a0, $sp, 8
	beqz	$a0, .LBB12_29
# %bb.28:                               # %delete.notnull.i59
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB12_29:                              # %_ZN11CStringBaseIwED2Ev.exit60
	pcalau12i	$a0, %pc_hi20(.L.str.4)
	addi.d	$a1, $a0, %pc_lo12(.L.str.4)
.LBB12_30:                              # %_ZN11CStringBaseIwED2Ev.exit86.invoke
.Ltmp242:                               # EH_LABEL
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_ZN11CStringBaseIwEpLEPKw)
	jirl	$ra, $ra, 0
...
# %bb.36:                               # %ehcleanup37
	ld.d	$a0, $fp, 0
	bnez	$a0, .LBB12_43
.LBB12_37:                              # %_ZN11CStringBaseIwED2Ev.exit92
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB12_38:                              # %delete.notnull.i88
	move	$a0, $a1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	ld.d	$a0, $fp, 0
...
# %bb.8:                                # %middle.block
	beq	$a1, $s3, .LBB13_12
.LBB13_9:                               # %for.body.i.i.preheader
	sub.d	$a2, $s3, $a1
	alsl.d	$a3, $a1, $s2, 2
	alsl.d	$a1, $a1, $a0, 2
	.p2align	4, , 16
.LBB13_10:                              # %for.body.i.i
	...
	bnez	$a2, .LBB13_10
	b	.LBB13_12
.LBB13_11:                              # %for.cond.cleanup.i.i
	beqz	$a0, .LBB13_13
.LBB13_12:                              # %delete.notnull.i.i
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	ld.w	$s3, $fp, 8
.LBB13_13:                              # %if.end9.i.i
	st.d	$s2, $fp, 0
	slli.d	$a0, $s3, 2
	stx.w	$zero, $s2, $a0
	st.w	$s4, $fp, 12
...
# %bb.50:                               # %for.cond.i104
	...
	ld.bu	$a6, $a5, 1
	bne	$a4, $a6, .LBB18_67
# %bb.51:                               # %for.cond.1.i107
	ld.bu	$a4, $a1, 2
	ld.bu	$a6, $a5, 2
	bne	$a4, $a6, .LBB18_67
# %bb.52:                               # %for.cond.2.i110
	ld.bu	$a4, $a1, 3
	ld.bu	$a6, $a5, 3
	bne	$a4, $a6, .LBB18_67
# %bb.53:                               # %for.cond.3.i113
	ld.bu	$a4, $a1, 4
	ld.bu	$a6, $a5, 4
	bne	$a4, $a6, .LBB18_67
# %bb.54:                               # %for.cond.4.i116
	ld.bu	$a4, $a1, 5
	ld.bu	$a6, $a5, 5
	bne	$a4, $a6, .LBB18_67
# %bb.55:                               # %for.cond.5.i119
	ld.bu	$a4, $a1, 6
	ld.bu	$a6, $a5, 6
	bne	$a4, $a6, .LBB18_67
# %bb.56:                               # %for.cond.6.i122
	ld.bu	$a4, $a1, 7
	ld.bu	$a6, $a5, 7
	bne	$a4, $a6, .LBB18_67
# %bb.57:                               # %for.cond.7.i125
	ld.bu	$a4, $a1, 8
	ld.bu	$a6, $a5, 8
	bne	$a4, $a6, .LBB18_67
# %bb.58:                               # %for.cond.8.i128
	ld.bu	$a4, $a1, 9
	ld.bu	$a6, $a5, 9
	bne	$a4, $a6, .LBB18_67
# %bb.59:                               # %for.cond.9.i131
	ld.bu	$a4, $a1, 10
	ld.bu	$a6, $a5, 10
	bne	$a4, $a6, .LBB18_67
# %bb.60:                               # %for.cond.10.i134
	ld.bu	$a4, $a1, 11
	ld.bu	$a6, $a5, 11
	bne	$a4, $a6, .LBB18_67
# %bb.61:                               # %for.cond.11.i137
	ld.bu	$a4, $a1, 12
	ld.bu	$a6, $a5, 12
	bne	$a4, $a6, .LBB18_67
# %bb.62:                               # %for.cond.12.i140
	ld.bu	$a4, $a1, 13
	ld.bu	$a6, $a5, 13
	bne	$a4, $a6, .LBB18_67
# %bb.63:                               # %for.cond.13.i143
	ld.bu	$a4, $a1, 14
	ld.bu	$a6, $a5, 14
	bne	$a4, $a6, .LBB18_67
# %bb.64:                               # %_ZeqRK4GUIDS1_.exit150
	ld.bu	$a1, $a1, 15
	ld.bu	$a4, $a5, 15
	bne	$a1, $a4, .LBB18_67
# %bb.65:                               # %if.then19
