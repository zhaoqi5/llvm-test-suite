...
.LBB2_101:                              # %for.body.i269
	...
	bnez	$a4, .LBB2_101
	b	.LBB2_128
.LBB2_102:                              # %vector.main.loop.iter.check347
                                        #   in Loop: Header=BB2_2 Depth=1
	ori	$a3, $zero, 16
	bgeu	$s2, $a3, .LBB2_118
...
# %bb.109:                              # %cleanup.cont79
	...
	bnez	$a0, .LBB2_34
	b	.LBB2_35
.LBB2_110:                              # %vector.main.loop.iter.check379
                                        #   in Loop: Header=BB2_2 Depth=1
	ori	$a3, $zero, 16
	bgeu	$s2, $a3, .LBB2_134
...
.LBB2_119:                              # %vector.body351
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB2_119
# %bb.120:                              # %middle.block356
                                        #   in Loop: Header=BB2_2 Depth=1
	beq	$a3, $a1, .LBB2_87
# %bb.121:                              # %vec.epilog.iter.check361
                                        #   in Loop: Header=BB2_2 Depth=1
	andi	$a4, $a1, 12
	beqz	$a4, .LBB2_51
.LBB2_122:                              # %vec.epilog.ph360
                                        #   in Loop: Header=BB2_2 Depth=1
	move	$a5, $a3
	...
	slli.d	$a5, $a5, 2
	.p2align	4, , 16
.LBB2_123:                              # %vec.epilog.vector.body366
                                        #   Parent Loop BB2_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vldx	$vr0, $a2, $a5
	vstx	$vr0, $a0, $a5
	...
	addi.d	$a5, $a5, 16
	bnez	$a4, .LBB2_123
# %bb.124:                              # %vec.epilog.middle.block370
                                        #   in Loop: Header=BB2_2 Depth=1
	bne	$a3, $a1, .LBB2_51
	b	.LBB2_87
.LBB2_125:                              # %vector.main.loop.iter.check411
                                        #   in Loop: Header=BB2_2 Depth=1
	ori	$a3, $zero, 16
	bgeu	$s2, $a3, .LBB2_143
...
.LBB2_135:                              # %vector.body383
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB2_135
# %bb.136:                              # %middle.block388
                                        #   in Loop: Header=BB2_2 Depth=1
	beq	$a3, $a1, .LBB2_105
# %bb.137:                              # %vec.epilog.iter.check393
                                        #   in Loop: Header=BB2_2 Depth=1
	andi	$a4, $a1, 12
	beqz	$a4, .LBB2_66
.LBB2_138:                              # %vec.epilog.ph392
                                        #   in Loop: Header=BB2_2 Depth=1
	move	$a5, $a3
	bstrpick.d	$a3, $a1, 30, 2
	slli.d	$a3, $a3, 2
	...
	slli.d	$a5, $a5, 2
	.p2align	4, , 16
.LBB2_139:                              # %vec.epilog.vector.body398
                                        #   Parent Loop BB2_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vldx	$vr0, $a2, $a5
	vstx	$vr0, $a0, $a5
	...
	addi.d	$a5, $a5, 16
	bnez	$a4, .LBB2_139
# %bb.140:                              # %vec.epilog.middle.block402
                                        #   in Loop: Header=BB2_2 Depth=1
	bne	$a3, $a1, .LBB2_66
	b	.LBB2_105
.LBB2_141:                              # %vector.main.loop.iter.check443
                                        #   in Loop: Header=BB2_2 Depth=1
	ori	$a3, $zero, 16
	bgeu	$t0, $a3, .LBB2_150
...
.LBB2_144:                              # %vector.body415
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB2_144
# %bb.145:                              # %middle.block420
                                        #   in Loop: Header=BB2_2 Depth=1
	beq	$a3, $a1, .LBB2_113
# %bb.146:                              # %vec.epilog.iter.check425
                                        #   in Loop: Header=BB2_2 Depth=1
	andi	$a4, $a1, 12
	beqz	$a4, .LBB2_77
.LBB2_147:                              # %vec.epilog.ph424
                                        #   in Loop: Header=BB2_2 Depth=1
	move	$a5, $a3
	bstrpick.d	$a3, $a1, 30, 2
	slli.d	$a3, $a3, 2
	...
	slli.d	$a5, $a5, 2
	.p2align	4, , 16
.LBB2_148:                              # %vec.epilog.vector.body430
                                        #   Parent Loop BB2_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vldx	$vr0, $a2, $a5
	vstx	$vr0, $a0, $a5
	...
	addi.d	$a5, $a5, 16
	bnez	$a4, .LBB2_148
# %bb.149:                              # %vec.epilog.middle.block434
                                        #   in Loop: Header=BB2_2 Depth=1
	bne	$a3, $a1, .LBB2_77
	b	.LBB2_113
.LBB2_150:                              # %vector.ph444
                                        #   in Loop: Header=BB2_2 Depth=1
	bstrpick.d	$a3, $a1, 30, 4
	slli.d	$a3, $a3, 4
	move	$a5, $zero
...
.LBB2_151:                              # %vector.body447
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB2_151
# %bb.152:                              # %middle.block452
                                        #   in Loop: Header=BB2_2 Depth=1
	beq	$a3, $a1, .LBB2_128
# %bb.153:                              # %vec.epilog.iter.check457
                                        #   in Loop: Header=BB2_2 Depth=1
	andi	$a4, $a1, 12
	beqz	$a4, .LBB2_100
.LBB2_154:                              # %vec.epilog.ph456
                                        #   in Loop: Header=BB2_2 Depth=1
	move	$a5, $a3
	bstrpick.d	$a3, $a1, 30, 2
	slli.d	$a3, $a3, 2
	...
	slli.d	$a5, $a5, 2
	.p2align	4, , 16
.LBB2_155:                              # %vec.epilog.vector.body462
                                        #   Parent Loop BB2_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vldx	$vr0, $a2, $a5
	vstx	$vr0, $a0, $a5
	...
	addi.d	$a5, $a5, 16
	bnez	$a4, .LBB2_155
# %bb.156:                              # %vec.epilog.middle.block466
                                        #   in Loop: Header=BB2_2 Depth=1
	bne	$a3, $a1, .LBB2_100
	b	.LBB2_128
.LBB2_157:
