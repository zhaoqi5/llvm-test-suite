...
# %bb.47:                               # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i167
	...
	ori	$a1, $zero, 1
	bge	$a1, $s0, .LBB2_80
.LBB2_48:                               # %for.body.lr.ph.i174
                                        #   in Loop: Header=BB2_2 Depth=1
	ld.d	$a2, $sp, 88
	bstrpick.d	$a1, $s2, 31, 0
	ori	$a3, $zero, 8
	bltu	$s2, $a3, .LBB2_50
# %bb.49:                               # %vector.memcheck336
                                        #   in Loop: Header=BB2_2 Depth=1
	sub.d	$a3, $a0, $a2
	addi.d	$a3, $a3, -4
	ori	$a4, $zero, 32
...
.Ltmp60:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp61:                                # EH_LABEL
# %bb.74:                               # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i229
                                        #   in Loop: Header=BB2_2 Depth=1
	move	$s5, $a0
	move	$a0, $s4
	pcaddu18i	$ra, %call36(_ZdaPv)
...
.LBB2_77:                               #   in Loop: Header=BB2_2 Depth=1
	move	$a3, $zero
.LBB2_78:                               # %for.body.i238.preheader
                                        #   in Loop: Header=BB2_2 Depth=1
	addi.d	$a2, $a2, 8
	sub.d	$a4, $a1, $a3
	slli.d	$a3, $a3, 2
	.p2align	4, , 16
.LBB2_79:                               # %for.body.i238
                                        #   Parent Loop BB2_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.w	$a5, $a2, $a3
	stx.w	$a5, $a0, $a3
	...
	bnez	$a4, .LBB2_79
	b	.LBB2_112
.LBB2_80:                               # %_ZN11CStringBaseIwE11SetCapacityEi.exit.for.cond.cleanup_crit_edge.i169
                                        #   in Loop: Header=BB2_2 Depth=1
	move	$a1, $s2
	b	.LBB2_94
.LBB2_81:                               # %if.then125
...
.Ltmp51:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp52:                                # EH_LABEL
# %bb.84:                               # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i260
                                        #   in Loop: Header=BB2_2 Depth=1
	move	$s5, $a0
	move	$a0, $s4
	pcaddu18i	$ra, %call36(_ZdaPv)
...
# %bb.85:                               #   in Loop: Header=BB2_2 Depth=1
	move	$a7, $s8
	ld.d	$s8, $sp, 16                    # 8-byte Folded Reload
.LBB2_86:                               # %for.body.lr.ph.i267
                                        #   in Loop: Header=BB2_2 Depth=1
	ld.d	$a2, $sp, 88
	bstrpick.d	$a1, $a7, 31, 0
	ori	$a3, $zero, 8
	bltu	$a7, $a3, .LBB2_88
# %bb.87:                               # %vector.memcheck381
                                        #   in Loop: Header=BB2_2 Depth=1
	sub.d	$a3, $a0, $a2
	addi.d	$a3, $a3, -8
	ori	$a4, $zero, 32
...
.LBB2_88:                               #   in Loop: Header=BB2_2 Depth=1
	move	$a3, $zero
.LBB2_89:                               # %for.body.i269.preheader
                                        #   in Loop: Header=BB2_2 Depth=1
	addi.d	$a2, $a2, 8
	sub.d	$a4, $a1, $a3
	slli.d	$a3, $a3, 2
	.p2align	4, , 16
.LBB2_90:                               # %for.body.i269
                                        #   Parent Loop BB2_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.w	$a5, $a2, $a3
	stx.w	$a5, $a0, $a3
...
.LBB2_92:                               # %vector.body343
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB2_92
# %bb.93:                               # %middle.block348
                                        #   in Loop: Header=BB2_2 Depth=1
	bne	$a3, $a1, .LBB2_51
.LBB2_94:                               # %invoke.cont37
                                        #   in Loop: Header=BB2_2 Depth=1
	slli.d	$a1, $a1, 2
	stx.w	$zero, $a0, $a1
	st.w	$s2, $sp, 72
...
# %bb.95:                               # %invoke.cont39
	...
	ld.d	$a0, $sp, 64
	beqz	$a0, .LBB2_97
# %bb.96:                               # %delete.notnull.i73
                                        #   in Loop: Header=BB2_2 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB2_97:                               # %_ZN11CStringBaseIwED2Ev.exit74
                                        #   in Loop: Header=BB2_2 Depth=1
	bnez	$s3, .LBB2_125
# %bb.98:                               # %cleanup.cont48
                                        #   in Loop: Header=BB2_2 Depth=1
	ld.w	$a0, $sp, 84
	ld.d	$a1, $sp, 24                    # 8-byte Folded Reload
	st.w	$a0, $a1, 12
...
.LBB2_101:                              # %vector.body358
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB2_101
# %bb.102:                              # %middle.block363
                                        #   in Loop: Header=BB2_2 Depth=1
	bne	$a3, $a1, .LBB2_61
.LBB2_103:                              # %invoke.cont68
                                        #   in Loop: Header=BB2_2 Depth=1
	slli.d	$a1, $a1, 2
	stx.w	$zero, $a0, $a1
	st.w	$s2, $sp, 72
.Ltmp72:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp73:                                # EH_LABEL
# %bb.104:                              # %invoke.cont70
                                        #   in Loop: Header=BB2_2 Depth=1
	move	$s3, $a0
	ld.d	$a0, $sp, 64
	beqz	$a0, .LBB2_106
# %bb.105:                              # %delete.notnull.i93
                                        #   in Loop: Header=BB2_2 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB2_106:                              # %_ZN11CStringBaseIwED2Ev.exit94
                                        #   in Loop: Header=BB2_2 Depth=1
	bnez	$s3, .LBB2_125
# %bb.107:                              # %cleanup.cont79
                                        #   in Loop: Header=BB2_2 Depth=1
	ld.w	$a0, $sp, 84
	ld.d	$a1, $sp, 24                    # 8-byte Folded Reload
	st.w	$a0, $a1, 4
	...
	bnez	$a0, .LBB2_34
	b	.LBB2_35
.LBB2_108:                              # %_ZN11CStringBaseIwE11SetCapacityEi.exit.for.cond.cleanup_crit_edge.i231
                                        #   in Loop: Header=BB2_2 Depth=1
	move	$a1, $s2
	ld.d	$s8, $sp, 16                    # 8-byte Folded Reload
	b	.LBB2_112
.LBB2_109:                              # %vector.ph370
                                        #   in Loop: Header=BB2_2 Depth=1
	bstrpick.d	$a3, $a1, 30, 3
	slli.d	$a3, $a3, 3
	move	$a4, $zero
...
.LBB2_110:                              # %vector.body373
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB2_110
# %bb.111:                              # %middle.block378
                                        #   in Loop: Header=BB2_2 Depth=1
	bne	$a3, $a1, .LBB2_78
.LBB2_112:                              # %invoke.cont99
                                        #   in Loop: Header=BB2_2 Depth=1
	slli.d	$a1, $a1, 2
	stx.w	$zero, $a0, $a1
	st.w	$s2, $sp, 72
.Ltmp63:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp64:                                # EH_LABEL
# %bb.113:                              # %invoke.cont101
                                        #   in Loop: Header=BB2_2 Depth=1
	move	$s3, $a0
	ld.d	$a0, $sp, 64
	beqz	$a0, .LBB2_115
# %bb.114:                              # %delete.notnull.i113
                                        #   in Loop: Header=BB2_2 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB2_115:                              # %_ZN11CStringBaseIwED2Ev.exit114
                                        #   in Loop: Header=BB2_2 Depth=1
	bnez	$s3, .LBB2_125
# %bb.116:                              # %cleanup.cont110
                                        #   in Loop: Header=BB2_2 Depth=1
	ld.w	$a0, $sp, 84
	ld.d	$a1, $sp, 24                    # 8-byte Folded Reload
	st.w	$a0, $a1, 8
...
.LBB2_119:                              # %vector.body388
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB2_119
# %bb.120:                              # %middle.block393
                                        #   in Loop: Header=BB2_2 Depth=1
	bne	$a3, $a1, .LBB2_89
.LBB2_121:                              # %invoke.cont130
                                        #   in Loop: Header=BB2_2 Depth=1
	slli.d	$a1, $a1, 2
	stx.w	$zero, $a0, $a1
	st.w	$a7, $sp, 72
.Ltmp54:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp55:                                # EH_LABEL
# %bb.122:                              # %invoke.cont132
                                        #   in Loop: Header=BB2_2 Depth=1
	move	$s3, $a0
	ld.d	$a0, $sp, 64
	beqz	$a0, .LBB2_124
# %bb.123:                              # %delete.notnull.i133
                                        #   in Loop: Header=BB2_2 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB2_124:                              # %_ZN11CStringBaseIwED2Ev.exit134
                                        #   in Loop: Header=BB2_2 Depth=1
	beqz	$s3, .LBB2_126
	.p2align	4, , 16
.LBB2_125:                              # %cleanup153.critedge56
                                        #   in Loop: Header=BB2_2 Depth=1
	move	$s0, $zero
...
.LBB2_129:                              # %cleanup161
	...
	addi.d	$sp, $sp, 192
	ret
.LBB2_130:                              # %_ZN11CStringBaseIwED2Ev.exit.i259
.Ltmp53:                                # EH_LABEL
	move	$fp, $a0
	move	$a0, $s4
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	b	.LBB2_157
.LBB2_131:                              # %_ZN11CStringBaseIwED2Ev.exit.i228
.Ltmp62:                                # EH_LABEL
	move	$fp, $a0
	move	$a0, $s4
	pcaddu18i	$ra, %call36(_ZdaPv)
...
.Ltmp50:                                # EH_LABEL
	b	.LBB2_156
.LBB2_134:                              # %_ZN11CStringBaseIwED2Ev.exit.i197
.Ltmp71:                                # EH_LABEL
	move	$fp, $a0
	move	$a0, $s4
	pcaddu18i	$ra, %call36(_ZdaPv)
...
.Ltmp59:                                # EH_LABEL
	b	.LBB2_156
.LBB2_137:                              # %_ZN11CStringBaseIwED2Ev.exit.i166
.Ltmp80:                                # EH_LABEL
	move	$fp, $a0
	move	$a0, $s4
	pcaddu18i	$ra, %call36(_ZdaPv)
...
.LBB2_155:                              # %lpad
.Ltmp23:                                # EH_LABEL
.LBB2_156:                              # %ehcleanup156
	move	$fp, $a0
.LBB2_157:                              # %ehcleanup156
	ld.d	$a0, $sp, 88
	beqz	$a0, .LBB2_159
# %bb.158:                              # %delete.notnull.i145
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB2_159:                              # %_ZN11CStringBaseIwED2Ev.exit146
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.Lfunc_end2:
