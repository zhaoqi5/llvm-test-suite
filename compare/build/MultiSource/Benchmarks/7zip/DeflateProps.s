...
# %bb.47:                               # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i167
	...
	ori	$a1, $zero, 1
	bge	$a1, $s8, .LBB2_86
.LBB2_48:                               # %iter.check347
                                        #   in Loop: Header=BB2_2 Depth=1
	ld.d	$a4, $sp, 88
	bstrpick.d	$a1, $s0, 31, 0
	addi.d	$a2, $a4, 4
	bltu	$s0, $fp, .LBB2_50
# %bb.49:                               # %vector.memcheck343
                                        #   in Loop: Header=BB2_2 Depth=1
	sub.d	$a3, $a0, $a4
	addi.d	$a3, $a3, -4
	ori	$a5, $zero, 64
...
.Ltmp69:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp70:                                # EH_LABEL
# %bb.57:                               # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i198
                                        #   in Loop: Header=BB2_2 Depth=1
	move	$s5, $a0
	move	$a0, $s4
	pcaddu18i	$ra, %call36(_ZdaPv)
...
.LBB2_61:                               # %for.body.i207.preheader
                                        #   in Loop: Header=BB2_2 Depth=1
	sub.d	$a4, $a1, $a3
	slli.d	$a3, $a3, 2
	.p2align	4, , 16
.LBB2_62:                               # %for.body.i207
                                        #   Parent Loop BB2_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.w	$a5, $a2, $a3
	stx.w	$a5, $a0, $a3
	...
	bnez	$a4, .LBB2_62
	b	.LBB2_125
.LBB2_63:                               # %vector.main.loop.iter.check
                                        #   in Loop: Header=BB2_2 Depth=1
	ori	$a2, $zero, 17
	bgeu	$s8, $a2, .LBB2_74
...
.Ltmp60:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp61:                                # EH_LABEL
# %bb.68:                               # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i229
                                        #   in Loop: Header=BB2_2 Depth=1
	move	$s5, $a0
	move	$a0, $s4
	pcaddu18i	$ra, %call36(_ZdaPv)
...
.LBB2_71:                               #   in Loop: Header=BB2_2 Depth=1
	move	$a3, $zero
	ld.d	$s1, $sp, 8                     # 8-byte Folded Reload
.LBB2_72:                               # %for.body.i238.preheader
                                        #   in Loop: Header=BB2_2 Depth=1
	sub.d	$a4, $a1, $a3
	slli.d	$a3, $a3, 2
	.p2align	4, , 16
.LBB2_73:                               # %for.body.i238
                                        #   Parent Loop BB2_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.w	$a5, $a2, $a3
	stx.w	$a5, $a0, $a3
...
.LBB2_78:                               # %vec.epilog.ph
	...
	slli.d	$a4, $a4, 2
	.p2align	4, , 16
.LBB2_79:                               # %vec.epilog.vector.body
                                        #   Parent Loop BB2_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vldx	$vr0, $a1, $a4
	vstx	$vr0, $s4, $a4
...
# %bb.83:                               # %delete.notnull.i
	...
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB2_84:                               # %_ZN11CStringBaseIwED2Ev.exit
                                        #   in Loop: Header=BB2_2 Depth=1
	bnez	$s3, .LBB2_155
# %bb.85:                               # %cleanup.cont
                                        #   in Loop: Header=BB2_2 Depth=1
...
.Ltmp51:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp52:                                # EH_LABEL
# %bb.90:                               # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i260
                                        #   in Loop: Header=BB2_2 Depth=1
	move	$s5, $a0
	move	$a0, $s4
	pcaddu18i	$ra, %call36(_ZdaPv)
	...
	ori	$a1, $zero, 2
	bge	$a1, $s8, .LBB2_117
# %bb.91:                               #   in Loop: Header=BB2_2 Depth=1
	move	$t1, $s1
.LBB2_92:                               # %iter.check440
                                        #   in Loop: Header=BB2_2 Depth=1
	ld.d	$a4, $sp, 88
...
.LBB2_94:                               #   in Loop: Header=BB2_2 Depth=1
	move	$a3, $zero
	ld.d	$s1, $sp, 8                     # 8-byte Folded Reload
.LBB2_95:                               # %for.body.i269.preheader
                                        #   in Loop: Header=BB2_2 Depth=1
	sub.d	$a4, $a1, $a3
	slli.d	$a3, $a3, 2
	.p2align	4, , 16
.LBB2_96:                               # %for.body.i269
                                        #   Parent Loop BB2_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.w	$a5, $a2, $a3
	stx.w	$a5, $a0, $a3
	...
	bnez	$a4, .LBB2_96
	b	.LBB2_151
.LBB2_97:                               # %vector.main.loop.iter.check349
                                        #   in Loop: Header=BB2_2 Depth=1
	ori	$a3, $zero, 16
	ld.d	$fp, $sp, 16                    # 8-byte Folded Reload
	bgeu	$s0, $a3, .LBB2_103
# %bb.98:                               #   in Loop: Header=BB2_2 Depth=1
	move	$a3, $zero
	b	.LBB2_107
.LBB2_99:                               # %_ZN11CStringBaseIwE11SetCapacityEi.exit.for.cond.cleanup_crit_edge.i200
                                        #   in Loop: Header=BB2_2 Depth=1
	move	$a1, $s0
	ld.d	$s1, $sp, 8                     # 8-byte Folded Reload
	move	$s2, $fp
	ld.d	$fp, $sp, 16                    # 8-byte Folded Reload
	b	.LBB2_125
.LBB2_100:                              # %vector.main.loop.iter.check380
                                        #   in Loop: Header=BB2_2 Depth=1
	ori	$a3, $zero, 16
	ld.d	$s1, $sp, 8                     # 8-byte Folded Reload
	bgeu	$s0, $a3, .LBB2_118
# %bb.101:                              #   in Loop: Header=BB2_2 Depth=1
	move	$a3, $zero
	b	.LBB2_122
.LBB2_102:                              # %_ZN11CStringBaseIwE11SetCapacityEi.exit.for.cond.cleanup_crit_edge.i231
                                        #   in Loop: Header=BB2_2 Depth=1
	move	$a1, $s0
	ld.d	$s1, $sp, 8                     # 8-byte Folded Reload
	move	$s2, $fp
...
.LBB2_104:                              # %vector.body353
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB2_104
# %bb.105:                              # %middle.block358
                                        #   in Loop: Header=BB2_2 Depth=1
	beq	$a3, $a1, .LBB2_110
# %bb.106:                              # %vec.epilog.iter.check362
                                        #   in Loop: Header=BB2_2 Depth=1
	beqz	$a5, .LBB2_51
.LBB2_107:                              # %vec.epilog.ph364
                                        #   in Loop: Header=BB2_2 Depth=1
	move	$a5, $a3
	...
	slli.d	$a5, $a5, 2
	.p2align	4, , 16
.LBB2_108:                              # %vec.epilog.vector.body367
                                        #   Parent Loop BB2_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vldx	$vr0, $a2, $a5
	vstx	$vr0, $a0, $a5
	...
	addi.d	$a5, $a5, 16
	bnez	$a4, .LBB2_108
# %bb.109:                              # %vec.epilog.middle.block371
                                        #   in Loop: Header=BB2_2 Depth=1
	bne	$a3, $a1, .LBB2_51
.LBB2_110:                              # %invoke.cont37
                                        #   in Loop: Header=BB2_2 Depth=1
	slli.d	$a1, $a1, 2
	stx.w	$zero, $a0, $a1
	st.w	$s0, $sp, 72
.Ltmp81:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp82:                                # EH_LABEL
# %bb.111:                              # %invoke.cont39
                                        #   in Loop: Header=BB2_2 Depth=1
	move	$s3, $a0
	ld.d	$a0, $sp, 64
	beqz	$a0, .LBB2_113
# %bb.112:                              # %delete.notnull.i73
                                        #   in Loop: Header=BB2_2 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB2_113:                              # %_ZN11CStringBaseIwED2Ev.exit74
                                        #   in Loop: Header=BB2_2 Depth=1
	bnez	$s3, .LBB2_155
# %bb.114:                              # %cleanup.cont48
                                        #   in Loop: Header=BB2_2 Depth=1
	ld.w	$a0, $sp, 84
	ld.d	$a1, $sp, 24                    # 8-byte Folded Reload
	st.w	$a0, $a1, 12
	...
	bnez	$a0, .LBB2_34
	b	.LBB2_35
.LBB2_115:                              # %vector.main.loop.iter.check411
                                        #   in Loop: Header=BB2_2 Depth=1
	ori	$a3, $zero, 16
	ld.d	$s1, $sp, 8                     # 8-byte Folded Reload
	bgeu	$s0, $a3, .LBB2_132
# %bb.116:                              #   in Loop: Header=BB2_2 Depth=1
	move	$a3, $zero
	b	.LBB2_136
.LBB2_117:                              # %_ZN11CStringBaseIwE11SetCapacityEi.exit.for.cond.cleanup_crit_edge.i262
                                        #   in Loop: Header=BB2_2 Depth=1
	move	$t1, $s1
	move	$a1, $s1
	ld.d	$s1, $sp, 8                     # 8-byte Folded Reload
	b	.LBB2_151
.LBB2_118:                              # %vector.ph381
                                        #   in Loop: Header=BB2_2 Depth=1
	move	$a6, $zero
	bstrpick.d	$a3, $a1, 30, 4
	slli.d	$a3, $a3, 4
...
.LBB2_119:                              # %vector.body384
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB2_119
# %bb.120:                              # %middle.block389
                                        #   in Loop: Header=BB2_2 Depth=1
	beq	$a3, $a1, .LBB2_125
# %bb.121:                              # %vec.epilog.iter.check393
                                        #   in Loop: Header=BB2_2 Depth=1
	beqz	$a5, .LBB2_61
.LBB2_122:                              # %vec.epilog.ph395
                                        #   in Loop: Header=BB2_2 Depth=1
	move	$a5, $a3
	bstrpick.d	$a3, $a1, 30, 2
	slli.d	$a3, $a3, 2
	...
	slli.d	$a5, $a5, 2
	.p2align	4, , 16
.LBB2_123:                              # %vec.epilog.vector.body398
                                        #   Parent Loop BB2_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vldx	$vr0, $a2, $a5
	vstx	$vr0, $a0, $a5
	...
	addi.d	$a5, $a5, 16
	bnez	$a4, .LBB2_123
# %bb.124:                              # %vec.epilog.middle.block402
                                        #   in Loop: Header=BB2_2 Depth=1
	bne	$a3, $a1, .LBB2_61
.LBB2_125:                              # %invoke.cont68
                                        #   in Loop: Header=BB2_2 Depth=1
	slli.d	$a1, $a1, 2
	stx.w	$zero, $a0, $a1
	st.w	$s0, $sp, 72
.Ltmp72:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp73:                                # EH_LABEL
# %bb.126:                              # %invoke.cont70
                                        #   in Loop: Header=BB2_2 Depth=1
	move	$s3, $a0
	ld.d	$a0, $sp, 64
	beqz	$a0, .LBB2_128
# %bb.127:                              # %delete.notnull.i93
                                        #   in Loop: Header=BB2_2 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB2_128:                              # %_ZN11CStringBaseIwED2Ev.exit94
                                        #   in Loop: Header=BB2_2 Depth=1
	bnez	$s3, .LBB2_155
# %bb.129:                              # %cleanup.cont79
                                        #   in Loop: Header=BB2_2 Depth=1
	ld.w	$a0, $sp, 84
	ld.d	$a1, $sp, 24                    # 8-byte Folded Reload
	st.w	$a0, $a1, 4
	...
	bnez	$a0, .LBB2_34
	b	.LBB2_35
.LBB2_130:                              # %vector.main.loop.iter.check442
                                        #   in Loop: Header=BB2_2 Depth=1
	ori	$a3, $zero, 16
	ld.d	$s1, $sp, 8                     # 8-byte Folded Reload
	bgeu	$t1, $a3, .LBB2_144
...
.LBB2_133:                              # %vector.body415
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB2_133
# %bb.134:                              # %middle.block420
                                        #   in Loop: Header=BB2_2 Depth=1
	beq	$a3, $a1, .LBB2_139
# %bb.135:                              # %vec.epilog.iter.check424
                                        #   in Loop: Header=BB2_2 Depth=1
	beqz	$a5, .LBB2_72
.LBB2_136:                              # %vec.epilog.ph426
                                        #   in Loop: Header=BB2_2 Depth=1
	move	$a5, $a3
	bstrpick.d	$a3, $a1, 30, 2
	slli.d	$a3, $a3, 2
	...
	slli.d	$a5, $a5, 2
	.p2align	4, , 16
.LBB2_137:                              # %vec.epilog.vector.body429
                                        #   Parent Loop BB2_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vldx	$vr0, $a2, $a5
	vstx	$vr0, $a0, $a5
	...
	addi.d	$a5, $a5, 16
	bnez	$a4, .LBB2_137
# %bb.138:                              # %vec.epilog.middle.block433
                                        #   in Loop: Header=BB2_2 Depth=1
	bne	$a3, $a1, .LBB2_72
.LBB2_139:                              # %invoke.cont99
                                        #   in Loop: Header=BB2_2 Depth=1
	slli.d	$a1, $a1, 2
	stx.w	$zero, $a0, $a1
	st.w	$s0, $sp, 72
.Ltmp63:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp64:                                # EH_LABEL
# %bb.140:                              # %invoke.cont101
                                        #   in Loop: Header=BB2_2 Depth=1
	move	$s3, $a0
	ld.d	$a0, $sp, 64
	beqz	$a0, .LBB2_142
# %bb.141:                              # %delete.notnull.i113
                                        #   in Loop: Header=BB2_2 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB2_142:                              # %_ZN11CStringBaseIwED2Ev.exit114
                                        #   in Loop: Header=BB2_2 Depth=1
	bnez	$s3, .LBB2_155
# %bb.143:                              # %cleanup.cont110
                                        #   in Loop: Header=BB2_2 Depth=1
	ld.w	$a0, $sp, 84
	ld.d	$a1, $sp, 24                    # 8-byte Folded Reload
	st.w	$a0, $a1, 8
...
.LBB2_145:                              # %vector.body446
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB2_145
# %bb.146:                              # %middle.block451
                                        #   in Loop: Header=BB2_2 Depth=1
	beq	$a3, $a1, .LBB2_151
# %bb.147:                              # %vec.epilog.iter.check455
                                        #   in Loop: Header=BB2_2 Depth=1
	beqz	$a5, .LBB2_95
.LBB2_148:                              # %vec.epilog.ph457
                                        #   in Loop: Header=BB2_2 Depth=1
	move	$a5, $a3
	bstrpick.d	$a3, $a1, 30, 2
	slli.d	$a3, $a3, 2
	...
	slli.d	$a5, $a5, 2
	.p2align	4, , 16
.LBB2_149:                              # %vec.epilog.vector.body460
                                        #   Parent Loop BB2_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vldx	$vr0, $a2, $a5
	vstx	$vr0, $a0, $a5
	...
	addi.d	$a5, $a5, 16
	bnez	$a4, .LBB2_149
# %bb.150:                              # %vec.epilog.middle.block464
                                        #   in Loop: Header=BB2_2 Depth=1
	bne	$a3, $a1, .LBB2_95
.LBB2_151:                              # %invoke.cont130
                                        #   in Loop: Header=BB2_2 Depth=1
	slli.d	$a1, $a1, 2
	stx.w	$zero, $a0, $a1
	st.w	$t1, $sp, 72
.Ltmp54:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp55:                                # EH_LABEL
# %bb.152:                              # %invoke.cont132
                                        #   in Loop: Header=BB2_2 Depth=1
	move	$s3, $a0
	ld.d	$a0, $sp, 64
	beqz	$a0, .LBB2_154
# %bb.153:                              # %delete.notnull.i133
                                        #   in Loop: Header=BB2_2 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB2_154:                              # %_ZN11CStringBaseIwED2Ev.exit134
                                        #   in Loop: Header=BB2_2 Depth=1
	beqz	$s3, .LBB2_156
	.p2align	4, , 16
.LBB2_155:                              # %cleanup153.critedge56
                                        #   in Loop: Header=BB2_2 Depth=1
	move	$s0, $zero
	move	$s2, $s3
	ld.d	$a0, $sp, 88
...
.LBB2_158:                              # %cleanup161
	...
	addi.d	$sp, $sp, 192
	ret
.LBB2_159:                              # %_ZN11CStringBaseIwED2Ev.exit.i259
.Ltmp53:                                # EH_LABEL
	move	$fp, $a0
	move	$a0, $s4
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	b	.LBB2_186
.LBB2_160:                              # %_ZN11CStringBaseIwED2Ev.exit.i228
.Ltmp62:                                # EH_LABEL
	move	$fp, $a0
	move	$a0, $s4
	pcaddu18i	$ra, %call36(_ZdaPv)
...
.Ltmp50:                                # EH_LABEL
	b	.LBB2_185
.LBB2_163:                              # %_ZN11CStringBaseIwED2Ev.exit.i197
.Ltmp71:                                # EH_LABEL
	move	$fp, $a0
	move	$a0, $s4
	pcaddu18i	$ra, %call36(_ZdaPv)
...
.Ltmp59:                                # EH_LABEL
	b	.LBB2_185
.LBB2_166:                              # %_ZN11CStringBaseIwED2Ev.exit.i166
.Ltmp80:                                # EH_LABEL
	move	$fp, $a0
	move	$a0, $s4
	pcaddu18i	$ra, %call36(_ZdaPv)
...
.Ltmp38:                                # EH_LABEL
	b	.LBB2_185
.LBB2_175:                              # %_ZN11CStringBaseIwED2Ev.exit.i
.Ltmp89:                                # EH_LABEL
	move	$fp, $a0
	move	$a0, $s5
	pcaddu18i	$ra, %call36(_ZdaPv)
...
.LBB2_184:                              # %lpad
.Ltmp23:                                # EH_LABEL
.LBB2_185:                              # %ehcleanup156
	move	$fp, $a0
.LBB2_186:                              # %ehcleanup156
	ld.d	$a0, $sp, 88
	beqz	$a0, .LBB2_188
# %bb.187:                              # %delete.notnull.i145
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB2_188:                              # %_ZN11CStringBaseIwED2Ev.exit146
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.Lfunc_end2:
...
.Lcst_begin1:
	...
	.byte	0                               #     has no landing pad
	.byte	0                               #   On action: cleanup
	.uleb128 .Ltmp57-.Lfunc_begin1          # >> Call Site 24 <<
	.uleb128 .Ltmp58-.Ltmp57                #   Call between .Ltmp57 and .Ltmp58
	.uleb128 .Ltmp59-.Lfunc_begin1          #     jumps to .Ltmp59
	.byte	0                               #   On action: cleanup
	.uleb128 .Ltmp60-.Lfunc_begin1          # >> Call Site 25 <<
	.uleb128 .Ltmp61-.Ltmp60                #   Call between .Ltmp60 and .Ltmp61
	.uleb128 .Ltmp62-.Lfunc_begin1          #     jumps to .Ltmp62
	.byte	0                               #   On action: cleanup
	.uleb128 .Ltmp61-.Lfunc_begin1          # >> Call Site 26 <<
	.uleb128 .Ltmp90-.Ltmp61                #   Call between .Ltmp61 and .Ltmp90
	.byte	0                               #     has no landing pad
	.byte	0                               #   On action: cleanup
	.uleb128 .Ltmp90-.Lfunc_begin1          # >> Call Site 27 <<
	.uleb128 .Ltmp91-.Ltmp90                #   Call between .Ltmp90 and .Ltmp91
	.uleb128 .Ltmp92-.Lfunc_begin1          #     jumps to .Ltmp92
	.byte	0                               #   On action: cleanup
	.uleb128 .Ltmp91-.Lfunc_begin1          # >> Call Site 28 <<
	.uleb128 .Ltmp48-.Ltmp91                #   Call between .Ltmp91 and .Ltmp48
	.byte	0                               #     has no landing pad
	.byte	0                               #   On action: cleanup
