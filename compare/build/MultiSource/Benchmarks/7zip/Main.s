...
# %bb.62:                               # %iter.check693
	...
	ori	$a2, $zero, 64
	bltu	$a1, $a2, .LBB0_73
# %bb.63:                               # %vector.main.loop.iter.check695
                                        #   in Loop: Header=BB0_55 Depth=2
	ori	$a0, $zero, 16
	bgeu	$s4, $a0, .LBB0_66
...
.LBB0_67:                               # %vector.body699
	...
	addi.d	$a2, $a2, 64
	bnez	$a3, .LBB0_67
# %bb.68:                               # %middle.block704
                                        #   in Loop: Header=BB0_55 Depth=2
	beq	$a0, $s4, .LBB0_75
# %bb.69:                               # %vec.epilog.iter.check709
                                        #   in Loop: Header=BB0_55 Depth=2
	andi	$a1, $s4, 12
	beqz	$a1, .LBB0_73
.LBB0_70:                               # %vec.epilog.ph708
                                        #   in Loop: Header=BB0_55 Depth=2
	move	$a3, $a0
	...
	alsl.d	$a3, $a3, $s2, 2
	.p2align	4, , 16
.LBB0_71:                               # %vec.epilog.vector.body714
                                        #   Parent Loop BB0_39 Depth=1
                                        #     Parent Loop BB0_55 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vld	$vr0, $a3, 0
	...
	addi.d	$a3, $a3, 16
	bnez	$a1, .LBB0_71
# %bb.72:                               # %vec.epilog.middle.block718
                                        #   in Loop: Header=BB0_55 Depth=2
	beq	$a0, $s4, .LBB0_75
...
# %bb.155:                              # %cleanup495
	ori	$s2, $zero, 2
	b	.LBB0_345
.LBB0_156:                              # %if.end.i.i660
.Ltmp119:                               # EH_LABEL
	ori	$a0, $zero, 40
	pcaddu18i	$ra, %call36(_Znam)
	jirl	$ra, $ra, 0
.Ltmp120:                               # EH_LABEL
# %bb.157:                              # %call.i.i662.noexc
	move	$s1, $a0
	ori	$a0, $zero, 1
	blt	$s3, $a0, .LBB0_164
# %bb.158:                              # %delete.notnull.i.i674
	move	$a0, $s2
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	ld.w	$a0, $sp, 976
...
.LBB0_164:
	move	$a0, $zero
.LBB0_165:                              # %if.end9.i.i664
	st.d	$s1, $sp, 968
	slli.d	$a0, $a0, 2
	stx.w	$zero, $s1, $a0
	ori	$a0, $zero, 10
	st.w	$a0, $sp, 980
.LBB0_166:                              # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i667
...
.Ltmp320:                               # EH_LABEL
	b	.LBB0_429
.LBB0_395:                              # %ehcleanup449.thread643
.Ltmp305:                               # EH_LABEL
...
.Ltmp140:                               # EH_LABEL
	move	$s0, $a0
	b	.LBB0_454
.LBB0_407:                              # %ehcleanup832.thread650
.Ltmp130:                               # EH_LABEL
