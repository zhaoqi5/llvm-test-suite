...
# %bb.1:                                # %for.body.lr.ph
	...
	addi.d	$s4, $a0, %pc_lo12(_ZTVN8NWindows16NSynchronization21CManualResetEventWFMOE+16)
...
.Ltmp71:                                # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp72:                                # EH_LABEL
.LBB18_12:                              # %_ZN9CMyComPtrI19ICompressSetBufSizeED2Ev.exit132
                                        #   in Loop: Header=BB18_13 Depth=1
	ld.w	$a0, $fp, 68
	addi.d	$s6, $s6, 1
	bge	$s6, $a0, .LBB18_29
...
# %bb.35:                               # %for.inc.i160
	...
	b	.LBB18_52
	.p2align	4, , 16
.LBB18_36:                              # %_ZNK11NCoderMixer9CBindInfo12FindInStreamEjRjS1_.exit166
                                        #   in Loop: Header=BB18_32 Depth=1
	ld.d	$a1, $fp, 208
	ldx.d	$a1, $a1, $a4
	ld.d	$a1, $a1, 416
...
# %bb.46:                               # %for.inc.i192
	...
	b	.LBB18_52
	.p2align	4, , 16
.LBB18_47:                              # %_ZNK11NCoderMixer9CBindInfo13FindOutStreamEjRjS1_.exit198
                                        #   in Loop: Header=BB18_43 Depth=1
	ld.d	$a1, $fp, 208
	slli.d	$a2, $a2, 3
	ldx.d	$a1, $a1, $a2
...
.LBB18_52:                              # %for.end.i
	...
	jirl	$ra, $ra, 0
.LBB18_53:                              # %terminate.lpad.i125
.Ltmp70:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB18_54:                              # %terminate.lpad.i131
.Ltmp73:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB18_55:                              # %lpad70
...
.Ltmp62:                                # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp63:                                # EH_LABEL
.LBB18_59:                              # %_ZN9CMyComPtrI19ICompressSetBufSizeED2Ev.exit139
	ld.d	$a0, $sp, 16
	beqz	$a0, .LBB18_61
# %bb.60:                               # %if.then.i141
	ld.d	$a1, $a0, 0
...
.Ltmp65:                                # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp66:                                # EH_LABEL
.LBB18_61:                              # %_ZN9CMyComPtrI19ICompressSetBufSizeED2Ev.exit146
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB18_62:                              # %terminate.lpad.i145
.Ltmp67:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB18_63:                              # %terminate.lpad.i138
.Ltmp64:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.Lfunc_end18:
...
.LBB20_33:                              # %return
	...
	addi.d	$sp, $sp, 48
	ret
.LBB20_34:                              # %for.body.lr.ph.i71
	ld.d	$a2, $fp, 208
	move	$a3, $a1
	.p2align	4, , 16
.LBB20_35:                              # %for.body.i74
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $a2, 0
	ld.w	$a4, $a0, 392
	ori	$a0, $zero, 1
