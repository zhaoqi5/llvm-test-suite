...
# %bb.53:                               # %iter.check471
	...
	ori	$a4, $zero, 63
	bgeu	$a4, $a3, .LBB0_77
# %bb.54:                               # %vector.main.loop.iter.check473
                                        #   in Loop: Header=BB0_23 Depth=1
	ori	$a2, $zero, 64
	bgeu	$a1, $a2, .LBB0_70
...
.LBB0_71:                               # %vector.body477
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB0_71
# %bb.72:                               # %middle.block482
                                        #   in Loop: Header=BB0_23 Depth=1
	beq	$a2, $a1, .LBB0_79
# %bb.73:                               # %vec.epilog.iter.check487
                                        #   in Loop: Header=BB0_23 Depth=1
	andi	$a3, $a1, 48
	beqz	$a3, .LBB0_77
.LBB0_74:                               # %vec.epilog.ph486
                                        #   in Loop: Header=BB0_23 Depth=1
	move	$a5, $a2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB0_75:                               # %vec.epilog.vector.body492
                                        #   Parent Loop BB0_23 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_75
# %bb.76:                               # %vec.epilog.middle.block496
                                        #   in Loop: Header=BB0_23 Depth=1
	beq	$a2, $a1, .LBB0_79
...
# %bb.29:                               # %iter.check153
	...
	ori	$a4, $zero, 63
	bgeu	$a4, $a3, .LBB1_40
# %bb.30:                               # %vector.main.loop.iter.check155
	ori	$a2, $zero, 64
	bgeu	$a1, $a2, .LBB1_33
# %bb.31:
	move	$a2, $zero
...
.LBB1_34:                               # %vector.body159
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB1_34
# %bb.35:                               # %middle.block164
	beq	$a2, $a1, .LBB1_42
# %bb.36:                               # %vec.epilog.iter.check169
	andi	$a3, $a1, 48
	beqz	$a3, .LBB1_40
.LBB1_37:                               # %vec.epilog.ph168
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB1_38:                               # %vec.epilog.vector.body174
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB1_38
# %bb.39:                               # %vec.epilog.middle.block178
	beq	$a2, $a1, .LBB1_42
...
# %bb.51:                               # %iter.check187
	...
	ori	$a4, $zero, 63
	bgeu	$a4, $a3, .LBB1_62
# %bb.52:                               # %vector.main.loop.iter.check189
	ori	$a2, $zero, 64
	bgeu	$a1, $a2, .LBB1_55
# %bb.53:
	move	$a2, $zero
...
.LBB1_56:                               # %vector.body193
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB1_56
# %bb.57:                               # %middle.block198
	beq	$a2, $a1, .LBB1_64
# %bb.58:                               # %vec.epilog.iter.check203
	andi	$a3, $a1, 48
	beqz	$a3, .LBB1_62
.LBB1_59:                               # %vec.epilog.ph202
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB1_60:                               # %vec.epilog.vector.body208
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB1_60
# %bb.61:                               # %vec.epilog.middle.block212
	beq	$a2, $a1, .LBB1_64
...
# %bb.73:                               # %iter.check221
	...
	ori	$a4, $zero, 63
	bgeu	$a4, $a3, .LBB1_84
# %bb.74:                               # %vector.main.loop.iter.check223
	ori	$a2, $zero, 64
	bgeu	$a1, $a2, .LBB1_77
# %bb.75:
	move	$a2, $zero
...
.LBB1_78:                               # %vector.body227
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB1_78
# %bb.79:                               # %middle.block232
	beq	$a2, $a1, .LBB1_86
# %bb.80:                               # %vec.epilog.iter.check237
	andi	$a3, $a1, 48
	beqz	$a3, .LBB1_84
.LBB1_81:                               # %vec.epilog.ph236
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB1_82:                               # %vec.epilog.vector.body242
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB1_82
# %bb.83:                               # %vec.epilog.middle.block246
	beq	$a2, $a1, .LBB1_86
