...
.LBB0_56:                               # %vec.epilog.ph501
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB0_57:                               # %vec.epilog.vector.body504
                                        #   Parent Loop BB0_23 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_57
# %bb.58:                               # %vec.epilog.middle.block508
                                        #   in Loop: Header=BB0_23 Depth=1
	bne	$a2, $a1, .LBB0_77
	b	.LBB0_79
.LBB0_59:                               # %cleanup.cont127
                                        #   in Loop: Header=BB0_23 Depth=1
.Ltmp76:                                # EH_LABEL
	addi.d	$a0, $sp, 240
	addi.d	$a1, $sp, 128
...
.Ltmp79:                                # EH_LABEL
	...
	jirl	$ra, $a6, 0
.Ltmp80:                                # EH_LABEL
# %bb.68:                               # %invoke.cont151
                                        #   in Loop: Header=BB0_23 Depth=1
	move	$s7, $a0
	bnez	$a0, .LBB0_61
# %bb.69:                               # %cleanup.cont158
                                        #   in Loop: Header=BB0_23 Depth=1
	ld.d	$a0, $sp, 56                    # 8-byte Folded Reload
	ld.d	$a1, $a0, 32
	ld.d	$a0, $sp, 144
...
.Ltmp82:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp83:                                # EH_LABEL
# %bb.71:                               # %invoke.cont166
                                        #   in Loop: Header=BB0_23 Depth=1
	move	$s7, $a0
	bnez	$a0, .LBB0_61
	b	.LBB0_46
.LBB0_72:                               # %for.cond.cleanup.i.i167
                                        #   in Loop: Header=BB0_23 Depth=1
	bnez	$a0, .LBB0_79
	b	.LBB0_80
.LBB0_73:                               # %vector.ph487
                                        #   in Loop: Header=BB0_23 Depth=1
	andi	$a3, $a1, 16
...
.LBB0_74:                               # %vector.body490
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB0_74
# %bb.75:                               # %middle.block495
                                        #   in Loop: Header=BB0_23 Depth=1
	beq	$a2, $a1, .LBB0_79
# %bb.76:                               # %vec.epilog.iter.check499
                                        #   in Loop: Header=BB0_23 Depth=1
	bnez	$a3, .LBB0_56
...
# %bb.96:                               # %vec.epilog.middle.block
	...
	bne	$a2, $a1, .LBB0_102
	b	.LBB0_104
.LBB0_97:                               # %for.cond.cleanup.i.i209
                                        #   in Loop: Header=BB0_23 Depth=1
	bnez	$a0, .LBB0_104
	b	.LBB0_105
.LBB0_98:                               # %vector.ph
...
# %bb.101:                              # %vec.epilog.iter.check
                                        #   in Loop: Header=BB0_23 Depth=1
	bnez	$a3, .LBB0_94
.LBB0_102:                              # %for.body.i.i215.preheader
                                        #   in Loop: Header=BB0_23 Depth=1
	sub.d	$a1, $a1, $a2
	add.d	$a3, $s7, $a2
	add.d	$a2, $a0, $a2
	.p2align	4, , 16
.LBB0_103:                              # %for.body.i.i215
                                        #   Parent Loop BB0_23 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.b	$a4, $a2, 0
	st.b	$a4, $a3, 0
	...
	addi.d	$a2, $a2, 1
	bnez	$a1, .LBB0_103
.LBB0_104:                              # %delete.notnull.i.i211
                                        #   in Loop: Header=BB0_23 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	ld.w	$a1, $sp, 216
.LBB0_105:                              # %if.end9.i.i195
                                        #   in Loop: Header=BB0_23 Depth=1
	st.d	$s7, $sp, 208
	stx.b	$zero, $s7, $a1
	st.w	$s8, $sp, 220
.LBB0_106:                              # %_ZN11CStringBaseIcE11SetCapacityEi.exit.i198
                                        #   in Loop: Header=BB0_23 Depth=1
	ld.d	$a0, $s5, 0
	.p2align	4, , 16
.LBB0_107:                              # %while.cond.i.i199
                                        #   Parent Loop BB0_23 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.bu	$a1, $a0, 0
	addi.d	$a0, $a0, 1
	...
	move	$s7, $a2
	bnez	$a1, .LBB0_107
# %bb.108:                              # %_Z12MyStringCopyIcEPT_S1_PKS0_.exit.i205
                                        #   in Loop: Header=BB0_23 Depth=1
	ld.w	$a0, $s1, 64
	st.w	$a0, $sp, 216
.LBB0_109:                              # %invoke.cont74
                                        #   in Loop: Header=BB0_23 Depth=1
	ld.bu	$a0, $s1, 74
	beqz	$a0, .LBB0_111
# %bb.110:                              # %if.then77
...
.Ltmp61:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp62:                                # EH_LABEL
# %bb.115:                              # %invoke.cont207
                                        #   in Loop: Header=BB0_23 Depth=1
	bnez	$a0, .LBB0_124
# %bb.116:                              # %cleanup.cont214
                                        #   in Loop: Header=BB0_23 Depth=1
...
.Ltmp64:                                # EH_LABEL
	...
	jirl	$ra, $a4, 0
.Ltmp65:                                # EH_LABEL
# %bb.117:                              # %invoke.cont222
                                        #   in Loop: Header=BB0_23 Depth=1
	bnez	$a0, .LBB0_124
# %bb.118:                              # %cleanup.cont229
                                        #   in Loop: Header=BB0_23 Depth=1
	ld.d	$s1, $s5, 16
	b	.LBB0_122
	.p2align	4, , 16
...
.Ltmp58:                                # EH_LABEL
	...
	jirl	$ra, $a4, 0
.Ltmp59:                                # EH_LABEL
# %bb.120:                              # %invoke.cont237
                                        #   in Loop: Header=BB0_23 Depth=1
	bnez	$a0, .LBB0_124
# %bb.121:                              # %cleanup.cont244
                                        #   in Loop: Header=BB0_23 Depth=1
	ld.wu	$a0, $s5, 120
	ld.d	$a1, $s5, 16
	add.d	$s1, $a1, $a0
...
.LBB0_124:                              #   in Loop: Header=BB0_23 Depth=1
	...
	ld.d	$a0, $sp, 208
	beqz	$a0, .LBB0_126
.LBB0_125:                              # %delete.notnull.i.i256
                                        #   in Loop: Header=BB0_23 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB0_126:                              # %_ZN11CStringBaseIcED2Ev.exit.i
                                        #   in Loop: Header=BB0_23 Depth=1
	ld.d	$a0, $sp, 192
	beqz	$a0, .LBB0_128
# %bb.127:                              # %delete.notnull.i2.i
                                        #   in Loop: Header=BB0_23 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB0_128:                              # %_ZN11CStringBaseIcED2Ev.exit3.i
                                        #   in Loop: Header=BB0_23 Depth=1
	ld.d	$a0, $sp, 176
	beqz	$a0, .LBB0_130
# %bb.129:                              # %delete.notnull.i5.i
                                        #   in Loop: Header=BB0_23 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB0_130:                              # %_ZN11CStringBaseIcED2Ev.exit6.i
                                        #   in Loop: Header=BB0_23 Depth=1
	ld.d	$a0, $sp, 128
	beqz	$a0, .LBB0_132
# %bb.131:                              # %delete.notnull.i8.i
                                        #   in Loop: Header=BB0_23 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB0_132:                              # %_ZN8NArchive4NTar5CItemD2Ev.exit
                                        #   in Loop: Header=BB0_23 Depth=1
	beqz	$s1, .LBB0_141
# %bb.133:                              # %for.cond42
                                        #   in Loop: Header=BB0_23 Depth=1
...
# %bb.137:                              #   in Loop: Header=BB0_23 Depth=1
	...
	bnez	$a0, .LBB0_125
	b	.LBB0_126
.LBB0_138:                              #   in Loop: Header=BB0_23 Depth=1
	move	$s1, $zero
	lu12i.w	$a0, -524284
	ori	$a0, $a0, 5
	st.d	$a0, $sp, 80                    # 8-byte Folded Spill
...
.Ltmp118:                               # EH_LABEL
	...
	move	$a0, $fp
.Ltmp119:                               # EH_LABEL
.LBB0_147:                              # %_ZN8NArchive4NTar11COutArchiveD2Ev.exit
	addi.w	$a0, $a0, 0
...
.Ltmp69:                                # EH_LABEL
	b	.LBB0_181
.LBB0_155:                              # %terminate.lpad.i278
.Ltmp117:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB0_156:                              # %terminate.lpad.i271
.Ltmp114:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB0_157:                              # %terminate.lpad.i264
.Ltmp111:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB0_158:                              # %lpad38
...
.LBB0_178:                              # %lpad
.Ltmp2:                                 # EH_LABEL
.LBB0_179:                              # %ehcleanup330
	move	$s2, $a0
	b	.LBB0_195
.LBB0_180:                              # %lpad67
.Ltmp57:                                # EH_LABEL
.LBB0_181:                              # %ehcleanup295
	move	$s2, $a0
...
.Ltmp48:                                # EH_LABEL
	...
	bnez	$s8, .LBB0_185
	b	.LBB0_187
.LBB0_184:                              # %ehcleanup.thread.i
.Ltmp45:                                # EH_LABEL
	move	$s2, $a0
.LBB0_185:                              # %delete.notnull.i15.i
	move	$a0, $s8
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	b	.LBB0_187
...
.Ltmp42:                                # EH_LABEL
	move	$s2, $a0
.LBB0_187:                              # %ehcleanup6.i
	ld.d	$a0, $sp, 128
	beqz	$a0, .LBB0_192
# %bb.188:                              # %delete.notnull.i18.i
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	b	.LBB0_192
.LBB0_189:                              # %lpad61
...
.Ltmp103:                               # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp104:                               # EH_LABEL
.LBB0_195:                              # %ehcleanup330
	ld.d	$a0, $sp, 240
	beqz	$a0, .LBB0_197
# %bb.196:                              # %if.then.i.i309
	ld.d	$a1, $a0, 0
	ld.d	$a1, $a1, 16
.Ltmp106:                               # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp107:                               # EH_LABEL
.LBB0_197:                              # %_ZN8NArchive4NTar11COutArchiveD2Ev.exit314
	move	$a0, $s2
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB0_198:                              # %terminate.lpad.i.i313
.Ltmp108:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB0_199:                              # %terminate.lpad.i301
.Ltmp105:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB0_200:                              # %terminate.lpad.i293
.Ltmp102:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB0_201:                              # %terminate.lpad.i285
.Ltmp99:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.Lfunc_end0:
...
.LBB1_32:                               # %vec.epilog.ph174
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB1_33:                               # %vec.epilog.vector.body177
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB1_33
# %bb.34:                               # %vec.epilog.middle.block181
	bne	$a2, $a1, .LBB1_40
	b	.LBB1_42
.LBB1_35:                               # %for.cond.cleanup.i.i32
	bnez	$a0, .LBB1_42
	b	.LBB1_43
.LBB1_36:                               # %vector.ph160
	andi	$a3, $a1, 16
	bstrpick.d	$a2, $a1, 30, 5
	slli.d	$a2, $a2, 5
	addi.d	$a4, $s1, 16
...
.LBB1_37:                               # %vector.body163
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB1_37
# %bb.38:                               # %middle.block168
	beq	$a2, $a1, .LBB1_42
# %bb.39:                               # %vec.epilog.iter.check172
	bnez	$a3, .LBB1_32
...
# %bb.51:                               # %iter.check190
	...
	ori	$a3, $zero, 32
	bltu	$a4, $a3, .LBB1_62
# %bb.52:                               # %vector.main.loop.iter.check192
	bgeu	$a1, $a3, .LBB1_58
# %bb.53:
	move	$a2, $zero
.LBB1_54:                               # %vec.epilog.ph207
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB1_55:                               # %vec.epilog.vector.body210
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB1_55
# %bb.56:                               # %vec.epilog.middle.block214
	bne	$a2, $a1, .LBB1_62
	b	.LBB1_64
.LBB1_57:                               # %for.cond.cleanup.i.i73
	bnez	$a0, .LBB1_64
	b	.LBB1_65
.LBB1_58:                               # %vector.ph193
	andi	$a3, $a1, 16
	bstrpick.d	$a2, $a1, 30, 5
	slli.d	$a2, $a2, 5
	addi.d	$a4, $s1, 16
...
.LBB1_59:                               # %vector.body196
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB1_59
# %bb.60:                               # %middle.block201
	beq	$a2, $a1, .LBB1_64
# %bb.61:                               # %vec.epilog.iter.check205
	bnez	$a3, .LBB1_54
...
# %bb.73:                               # %iter.check223
	...
	ori	$a3, $zero, 32
	bltu	$a4, $a3, .LBB1_84
# %bb.74:                               # %vector.main.loop.iter.check225
	bgeu	$a1, $a3, .LBB1_80
# %bb.75:
	move	$a2, $zero
.LBB1_76:                               # %vec.epilog.ph240
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB1_77:                               # %vec.epilog.vector.body243
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB1_77
# %bb.78:                               # %vec.epilog.middle.block247
	bne	$a2, $a1, .LBB1_84
	b	.LBB1_86
.LBB1_79:                               # %for.cond.cleanup.i.i114
	bnez	$a0, .LBB1_86
	b	.LBB1_87
.LBB1_80:                               # %vector.ph226
	andi	$a3, $a1, 16
	bstrpick.d	$a2, $a1, 30, 5
	slli.d	$a2, $a2, 5
	addi.d	$a4, $s1, 16
...
.LBB1_81:                               # %vector.body229
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB1_81
# %bb.82:                               # %middle.block234
	beq	$a2, $a1, .LBB1_86
# %bb.83:                               # %vec.epilog.iter.check238
	bnez	$a3, .LBB1_76
