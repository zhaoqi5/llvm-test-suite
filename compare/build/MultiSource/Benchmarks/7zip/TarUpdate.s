...
# %bb.72:                               # %middle.block495
                                        #   in Loop: Header=BB0_23 Depth=1
	beq	$a2, $a1, .LBB0_79
# %bb.73:                               # %vec.epilog.iter.check499
                                        #   in Loop: Header=BB0_23 Depth=1
	beqz	$a3, .LBB0_77
.LBB0_74:                               # %vec.epilog.ph501
                                        #   in Loop: Header=BB0_23 Depth=1
	move	$a5, $a2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB0_75:                               # %vec.epilog.vector.body504
                                        #   Parent Loop BB0_23 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_75
# %bb.76:                               # %vec.epilog.middle.block508
                                        #   in Loop: Header=BB0_23 Depth=1
	beq	$a2, $a1, .LBB0_79
...
# %bb.93:                               #   in Loop: Header=BB0_23 Depth=1
	move	$a2, $zero
	b	.LBB0_99
.LBB0_94:                               # %for.cond.cleanup.i.i209
                                        #   in Loop: Header=BB0_23 Depth=1
	bnez	$a0, .LBB0_104
	b	.LBB0_105
.LBB0_95:                               # %vector.ph
...
# %bb.35:                               # %middle.block168
	beq	$a2, $a1, .LBB1_42
# %bb.36:                               # %vec.epilog.iter.check172
	beqz	$a3, .LBB1_40
.LBB1_37:                               # %vec.epilog.ph174
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB1_38:                               # %vec.epilog.vector.body177
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB1_38
# %bb.39:                               # %vec.epilog.middle.block181
	beq	$a2, $a1, .LBB1_42
...
.LBB1_56:                               # %vector.body196
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB1_56
# %bb.57:                               # %middle.block201
	beq	$a2, $a1, .LBB1_64
# %bb.58:                               # %vec.epilog.iter.check205
	beqz	$a3, .LBB1_62
.LBB1_59:                               # %vec.epilog.ph207
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB1_60:                               # %vec.epilog.vector.body210
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB1_60
# %bb.61:                               # %vec.epilog.middle.block214
	beq	$a2, $a1, .LBB1_64
...
.LBB1_78:                               # %vector.body229
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB1_78
# %bb.79:                               # %middle.block234
	beq	$a2, $a1, .LBB1_86
# %bb.80:                               # %vec.epilog.iter.check238
	beqz	$a3, .LBB1_84
.LBB1_81:                               # %vec.epilog.ph240
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB1_82:                               # %vec.epilog.vector.body243
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB1_82
# %bb.83:                               # %vec.epilog.middle.block247
	beq	$a2, $a1, .LBB1_86
