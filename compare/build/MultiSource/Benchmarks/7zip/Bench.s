...
# %bb.14:                               # %vector.body202
	...
	xvadd.w	$xr3, $xr3, $xr1
	bne	$t1, $t0, .LBB7_13
.LBB7_15:                               # %middle.split207
	beqz	$t2, .LBB7_17
# %bb.16:
	addi.w	$t0, $zero, -1792
	b	.LBB7_104
.LBB7_17:                               # %vector.ph212
	xvld	$xr3, $a4, %pc_lo12(.LCPI7_0)
	xvld	$xr4, $a5, %pc_lo12(.LCPI7_1)
	xvld	$xr5, $a6, %pc_lo12(.LCPI7_2)
	xvld	$xr6, $a7, %pc_lo12(.LCPI7_3)
...
# %bb.19:                               # %vector.body215
	...
	xvadd.w	$xr3, $xr3, $xr1
	bne	$t1, $t0, .LBB7_18
.LBB7_20:                               # %middle.split220
	beqz	$t2, .LBB7_22
# %bb.21:
	addi.w	$t0, $zero, -1536
	b	.LBB7_104
.LBB7_22:                               # %vector.ph225
	xvld	$xr3, $a4, %pc_lo12(.LCPI7_0)
	xvld	$xr4, $a5, %pc_lo12(.LCPI7_1)
	xvld	$xr5, $a6, %pc_lo12(.LCPI7_2)
	xvld	$xr6, $a7, %pc_lo12(.LCPI7_3)
...
# %bb.24:                               # %vector.body228
	...
	xvadd.w	$xr3, $xr3, $xr1
	bne	$t1, $t0, .LBB7_23
.LBB7_25:                               # %middle.split233
	beqz	$t2, .LBB7_27
# %bb.26:
	addi.w	$t0, $zero, -1280
	b	.LBB7_104
.LBB7_27:                               # %vector.ph238
	xvld	$xr3, $a4, %pc_lo12(.LCPI7_0)
	xvld	$xr4, $a5, %pc_lo12(.LCPI7_1)
	xvld	$xr5, $a6, %pc_lo12(.LCPI7_2)
	xvld	$xr6, $a7, %pc_lo12(.LCPI7_3)
...
# %bb.29:                               # %vector.body241
	...
	xvadd.w	$xr3, $xr3, $xr1
	bne	$t1, $t0, .LBB7_28
.LBB7_30:                               # %middle.split246
	beqz	$t2, .LBB7_32
# %bb.31:
	addi.w	$t0, $zero, -1024
	b	.LBB7_104
.LBB7_32:                               # %vector.ph251
	xvld	$xr3, $a4, %pc_lo12(.LCPI7_0)
	xvld	$xr4, $a5, %pc_lo12(.LCPI7_1)
	xvld	$xr5, $a6, %pc_lo12(.LCPI7_2)
	xvld	$xr6, $a7, %pc_lo12(.LCPI7_3)
...
# %bb.34:                               # %vector.body254
	...
	xvadd.w	$xr3, $xr3, $xr1
	bne	$t1, $t0, .LBB7_33
.LBB7_35:                               # %middle.split259
	beqz	$t2, .LBB7_37
# %bb.36:
	addi.w	$t0, $zero, -768
	b	.LBB7_104
.LBB7_37:                               # %vector.ph264
	xvld	$xr3, $a4, %pc_lo12(.LCPI7_0)
	xvld	$xr4, $a5, %pc_lo12(.LCPI7_1)
	xvld	$xr5, $a6, %pc_lo12(.LCPI7_2)
	xvld	$xr6, $a7, %pc_lo12(.LCPI7_3)
...
# %bb.39:                               # %vector.body267
	...
	xvadd.w	$xr3, $xr3, $xr1
	bne	$t1, $t0, .LBB7_38
.LBB7_40:                               # %middle.split272
	beqz	$t2, .LBB7_42
# %bb.41:
	addi.w	$t0, $zero, -512
	b	.LBB7_104
.LBB7_42:                               # %vector.ph277
	xvld	$xr3, $a4, %pc_lo12(.LCPI7_0)
	xvld	$xr4, $a5, %pc_lo12(.LCPI7_1)
	xvld	$xr5, $a6, %pc_lo12(.LCPI7_2)
	xvld	$xr6, $a7, %pc_lo12(.LCPI7_3)
...
# %bb.44:                               # %vector.body280
	...
	xvadd.w	$xr3, $xr3, $xr1
	bne	$t1, $t0, .LBB7_43
.LBB7_45:                               # %middle.split285
	beqz	$t2, .LBB7_47
# %bb.46:
	addi.w	$t0, $zero, -256
	b	.LBB7_104
.LBB7_47:                               # %vector.ph290
	xvld	$xr3, $a4, %pc_lo12(.LCPI7_0)
	xvld	$xr4, $a5, %pc_lo12(.LCPI7_1)
	xvld	$xr5, $a6, %pc_lo12(.LCPI7_2)
	xvld	$xr6, $a7, %pc_lo12(.LCPI7_3)
	...
	xvreplgr2vr.w	$xr7, $t0
	ori	$t0, $zero, 192
.LBB7_48:                               # %vector.body293
                                        # =>This Inner Loop Header: Depth=1
	move	$t1, $a0
	xvslli.w	$xr2, $xr6, 10
	xvslli.w	$xr10, $xr5, 10
	xvslli.w	$xr9, $xr4, 10
	xvslli.w	$xr8, $xr3, 10
	xvadd.w	$xr8, $xr8, $xr7
	xvadd.w	$xr9, $xr9, $xr7
...
# %bb.49:                               # %vector.body293
	...
	xvadd.w	$xr3, $xr3, $xr1
	bne	$t1, $t0, .LBB7_48
.LBB7_50:                               # %middle.split298
	beqz	$t2, .LBB7_52
# %bb.51:
	move	$t0, $zero
	b	.LBB7_104
.LBB7_52:                               # %vector.ph303
	xvld	$xr3, $a4, %pc_lo12(.LCPI7_0)
	xvld	$xr4, $a5, %pc_lo12(.LCPI7_1)
	xvld	$xr5, $a6, %pc_lo12(.LCPI7_2)
	xvld	$xr6, $a7, %pc_lo12(.LCPI7_3)
	...
	xvreplgr2vr.w	$xr7, $t0
	ori	$t0, $zero, 192
.LBB7_53:                               # %vector.body306
                                        # =>This Inner Loop Header: Depth=1
	move	$t1, $a0
	xvslli.w	$xr2, $xr6, 11
	xvslli.w	$xr10, $xr5, 11
	xvslli.w	$xr9, $xr4, 11
	xvslli.w	$xr8, $xr3, 11
	xvadd.w	$xr8, $xr8, $xr7
	xvadd.w	$xr9, $xr9, $xr7
...
# %bb.56:                               # %vector.ph316
	...
	xvreplgr2vr.w	$xr7, $t0
	ori	$t0, $zero, 192
.LBB7_57:                               # %vector.body319
                                        # =>This Inner Loop Header: Depth=1
	move	$t1, $a0
	xvslli.w	$xr2, $xr6, 12
	xvslli.w	$xr10, $xr5, 12
	xvslli.w	$xr9, $xr4, 12
	xvslli.w	$xr8, $xr3, 12
	xvadd.w	$xr8, $xr8, $xr7
	xvadd.w	$xr9, $xr9, $xr7
...
# %bb.60:                               # %vector.ph329
	...
	xvreplgr2vr.w	$xr7, $t0
	ori	$t0, $zero, 192
.LBB7_61:                               # %vector.body332
                                        # =>This Inner Loop Header: Depth=1
	move	$t1, $a0
	xvslli.w	$xr2, $xr6, 13
	xvslli.w	$xr10, $xr5, 13
	xvslli.w	$xr9, $xr4, 13
	xvslli.w	$xr8, $xr3, 13
	xvadd.w	$xr8, $xr8, $xr7
	xvadd.w	$xr9, $xr9, $xr7
...
# %bb.64:                               # %vector.ph342
	...
	xvreplgr2vr.w	$xr7, $t0
	ori	$t0, $zero, 192
.LBB7_65:                               # %vector.body345
                                        # =>This Inner Loop Header: Depth=1
	move	$t1, $a0
	xvslli.w	$xr2, $xr6, 14
	xvslli.w	$xr10, $xr5, 14
	xvslli.w	$xr9, $xr4, 14
	xvslli.w	$xr8, $xr3, 14
	xvadd.w	$xr8, $xr8, $xr7
	xvadd.w	$xr9, $xr9, $xr7
...
# %bb.68:                               # %vector.ph355
	...
	xvreplgr2vr.w	$xr7, $t0
	ori	$t0, $zero, 192
.LBB7_69:                               # %vector.body358
                                        # =>This Inner Loop Header: Depth=1
	move	$t1, $a0
	xvslli.w	$xr2, $xr6, 15
	xvslli.w	$xr10, $xr5, 15
	xvslli.w	$xr9, $xr4, 15
	xvslli.w	$xr8, $xr3, 15
	xvadd.w	$xr8, $xr8, $xr7
	xvadd.w	$xr9, $xr9, $xr7
...
# %bb.72:                               # %vector.ph368
	...
	xvreplgr2vr.w	$xr7, $t0
	ori	$t0, $zero, 192
.LBB7_73:                               # %vector.body371
                                        # =>This Inner Loop Header: Depth=1
	move	$t1, $a0
	xvslli.w	$xr2, $xr6, 16
	xvslli.w	$xr10, $xr5, 16
	xvslli.w	$xr9, $xr4, 16
	xvslli.w	$xr8, $xr3, 16
	xvadd.w	$xr8, $xr8, $xr7
	xvadd.w	$xr9, $xr9, $xr7
...
# %bb.76:                               # %vector.ph381
	...
	xvreplgr2vr.w	$xr7, $t0
	ori	$t0, $zero, 192
.LBB7_77:                               # %vector.body384
                                        # =>This Inner Loop Header: Depth=1
	move	$t1, $a0
	xvslli.w	$xr2, $xr6, 17
	xvslli.w	$xr10, $xr5, 17
	xvslli.w	$xr9, $xr4, 17
	xvslli.w	$xr8, $xr3, 17
	xvadd.w	$xr8, $xr8, $xr7
	xvadd.w	$xr9, $xr9, $xr7
...
# %bb.80:                               # %vector.ph394
	...
	xvreplgr2vr.w	$xr7, $t0
	ori	$t0, $zero, 192
.LBB7_81:                               # %vector.body397
                                        # =>This Inner Loop Header: Depth=1
	move	$t1, $a0
	xvslli.w	$xr2, $xr6, 18
	xvslli.w	$xr10, $xr5, 18
	xvslli.w	$xr9, $xr4, 18
	xvslli.w	$xr8, $xr3, 18
	xvadd.w	$xr8, $xr8, $xr7
	xvadd.w	$xr9, $xr9, $xr7
...
# %bb.84:                               # %vector.ph407
	...
	xvreplgr2vr.w	$xr7, $t0
	ori	$t0, $zero, 192
.LBB7_85:                               # %vector.body410
                                        # =>This Inner Loop Header: Depth=1
	move	$t1, $a0
	xvslli.w	$xr2, $xr6, 19
	xvslli.w	$xr10, $xr5, 19
	xvslli.w	$xr9, $xr4, 19
	xvslli.w	$xr8, $xr3, 19
	xvadd.w	$xr8, $xr8, $xr7
	xvadd.w	$xr9, $xr9, $xr7
...
# %bb.88:                               # %vector.ph420
	...
	xvreplgr2vr.w	$xr7, $t0
	ori	$t0, $zero, 192
.LBB7_89:                               # %vector.body423
                                        # =>This Inner Loop Header: Depth=1
	move	$t1, $a0
	xvslli.w	$xr2, $xr6, 20
	xvslli.w	$xr10, $xr5, 20
	xvslli.w	$xr9, $xr4, 20
	xvslli.w	$xr8, $xr3, 20
	xvadd.w	$xr8, $xr8, $xr7
	xvadd.w	$xr9, $xr9, $xr7
...
# %bb.92:                               # %vector.ph433
	...
	xvreplgr2vr.w	$xr7, $t0
	ori	$t0, $zero, 192
.LBB7_93:                               # %vector.body436
                                        # =>This Inner Loop Header: Depth=1
	move	$t1, $a0
	xvslli.w	$xr2, $xr6, 21
	xvslli.w	$xr10, $xr5, 21
	xvslli.w	$xr9, $xr4, 21
	xvslli.w	$xr8, $xr3, 21
	xvadd.w	$xr8, $xr8, $xr7
	xvadd.w	$xr9, $xr9, $xr7
...
# %bb.96:                               # %vector.ph446
	...
	xvreplgr2vr.w	$xr7, $t0
	ori	$t0, $zero, 192
.LBB7_97:                               # %vector.body449
                                        # =>This Inner Loop Header: Depth=1
	move	$t1, $a0
	xvslli.w	$xr2, $xr6, 22
	xvslli.w	$xr10, $xr5, 22
	xvslli.w	$xr9, $xr4, 22
	xvslli.w	$xr8, $xr3, 22
	xvadd.w	$xr8, $xr8, $xr7
	xvadd.w	$xr9, $xr9, $xr7
...
# %bb.64:                               # %middle.block
	...
	beq	$a0, $a3, .LBB13_67
.LBB13_65:                              # %for.body192.preheader403
	ori	$a3, $zero, 224
	mul.d	$a3, $a0, $a3
	add.d	$a3, $a3, $fp
	addi.d	$a3, $a3, 176
...
.LBB13_99:                              # %vector.body380
	...
	addi.d	$a5, $a5, 448
	bnez	$a6, .LBB13_99
# %bb.100:                              # %middle.block387
	add.d	$a1, $a2, $a1
	add.d	$a2, $a4, $a3
	ld.d	$a3, $sp, 56                    # 8-byte Folded Reload
	beq	$a0, $a3, .LBB13_103
.LBB13_101:                             # %for.body357.preheader394
	ori	$a3, $zero, 224
	mul.d	$a3, $a0, $a3
	add.d	$a3, $a3, $fp
	addi.d	$a3, $a3, 176
