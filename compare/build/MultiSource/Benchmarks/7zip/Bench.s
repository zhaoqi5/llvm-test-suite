...
.LBB7_3:                                # %vector.body
	...
	xvslli.w	$xr7, $xr2, 1
	xvadd.w	$xr7, $xr7, $xr6
	xvadd.w	$xr10, $xr10, $xr6
	xvadd.w	$xr9, $xr9, $xr6
	xvadd.w	$xr8, $xr8, $xr6
	xvsle.wu	$xr8, $xr0, $xr8
	xvpickve2gr.w	$a1, $xr8, 0
	...
	xvpickve2gr.w	$s0, $xr8, 0
	andi	$a1, $s0, 1
	slli.d	$a1, $a1, 8
	or	$a0, $a0, $a1
	xvpickve2gr.w	$s1, $xr8, 1
	andi	$a1, $s1, 1
	slli.d	$a1, $a1, 9
	or	$a0, $a0, $a1
	xvpickve2gr.w	$s2, $xr8, 2
	andi	$a1, $s2, 1
	slli.d	$a1, $a1, 10
	or	$a0, $a0, $a1
	xvpickve2gr.w	$s3, $xr8, 3
	andi	$a1, $s3, 1
	slli.d	$a1, $a1, 11
	or	$a0, $a0, $a1
	...
	slli.d	$a1, $a1, 14
	or	$a0, $a0, $a1
	xvpickve2gr.w	$s7, $xr8, 7
	andi	$a1, $s7, 1
	slli.d	$a1, $a1, 15
	or	$a0, $a0, $a1
	xvsle.wu	$xr8, $xr0, $xr10
	xvpickve2gr.w	$s8, $xr8, 0
	andi	$a1, $s8, 1
	slli.d	$a1, $a1, 16
	or	$a0, $a0, $a1
	xvpickve2gr.w	$ra, $xr8, 1
	andi	$a1, $ra, 1
	slli.d	$a1, $a1, 17
	or	$a0, $a0, $a1
	xvpickve2gr.w	$a4, $xr8, 2
	andi	$a1, $a4, 1
	slli.d	$a1, $a1, 18
	or	$a0, $a0, $a1
	xvpickve2gr.w	$a3, $xr8, 3
	andi	$a1, $a3, 1
	slli.d	$a1, $a1, 19
	or	$a0, $a0, $a1
...
# %bb.6:                                # %cleanup11.i.loopexit160
	...
	vld	$vr1, $t6, %pc_lo12(.LCPI7_4)
	vinsgr2vr.b	$vr2, $s8, 0
	vinsgr2vr.b	$vr2, $ra, 1
	...
	vinsgr2vr.b	$vr2, $a2, 9
	vinsgr2vr.b	$vr2, $a1, 10
	vinsgr2vr.b	$vr2, $a0, 11
	vinsgr2vr.b	$vr2, $t4, 12
	vinsgr2vr.b	$vr2, $t5, 13
	pcalau12i	$a0, %pc_hi20(.LCPI7_5)
	vld	$vr3, $a0, %pc_lo12(.LCPI7_5)
	vand.v	$vr0, $vr0, $vr1
...
.LBB7_8:                                # %vector.body187
	...
	slli.d	$a1, $a1, 8
	or	$a0, $a0, $a1
	xvpickve2gr.w	$s0, $xr8, 1
	andi	$a1, $s0, 1
	slli.d	$a1, $a1, 9
	or	$a0, $a0, $a1
	xvpickve2gr.w	$s1, $xr8, 2
	andi	$a1, $s1, 1
	slli.d	$a1, $a1, 10
	or	$a0, $a0, $a1
	xvpickve2gr.w	$s2, $xr8, 3
	andi	$a1, $s2, 1
	slli.d	$a1, $a1, 11
	or	$a0, $a0, $a1
	xvpickve2gr.w	$s3, $xr8, 4
	andi	$a1, $s3, 1
	slli.d	$a1, $a1, 12
	or	$a0, $a0, $a1
	...
	or	$a0, $a0, $a1
	xvsle.wu	$xr8, $xr0, $xr10
	xvpickve2gr.w	$s7, $xr8, 0
	andi	$a1, $s7, 1
	slli.d	$a1, $a1, 16
	or	$a0, $a0, $a1
	xvpickve2gr.w	$s8, $xr8, 1
	andi	$a1, $s8, 1
	slli.d	$a1, $a1, 17
	or	$a0, $a0, $a1
	xvpickve2gr.w	$a4, $xr8, 2
...
# %bb.11:                               # %cleanup11.i.loopexit159
	...
	pcalau12i	$t5, %pc_hi20(.LCPI7_4)
	vld	$vr1, $t5, %pc_lo12(.LCPI7_4)
	vinsgr2vr.b	$vr2, $s7, 0
	vinsgr2vr.b	$vr2, $s8, 1
	vinsgr2vr.b	$vr2, $a4, 2
	vinsgr2vr.b	$vr2, $a3, 3
	vinsgr2vr.b	$vr2, $a5, 4
	vinsgr2vr.b	$vr2, $a6, 5
	vinsgr2vr.b	$vr2, $a7, 6
	vinsgr2vr.b	$vr2, $ra, 7
	vinsgr2vr.b	$vr2, $a2, 8
...
.LBB7_48:                               # %vector.body275
	...
	slli.d	$a1, $a1, 8
	or	$a0, $a0, $a1
	xvpickve2gr.w	$a1, $xr8, 1
	st.d	$a1, $sp, 80                    # 8-byte Folded Spill
	andi	$a1, $a1, 1
	slli.d	$a1, $a1, 9
	or	$a0, $a0, $a1
	xvpickve2gr.w	$a1, $xr8, 2
	st.d	$a1, $sp, 72                    # 8-byte Folded Spill
	andi	$a1, $a1, 1
	slli.d	$a1, $a1, 10
	or	$a0, $a0, $a1
	xvpickve2gr.w	$s1, $xr8, 3
	andi	$a1, $s1, 1
	slli.d	$a1, $a1, 11
	or	$a0, $a0, $a1
	xvpickve2gr.w	$s2, $xr8, 4
	andi	$a1, $s2, 1
	slli.d	$a1, $a1, 12
	or	$a0, $a0, $a1
	xvpickve2gr.w	$s3, $xr8, 5
	andi	$a1, $s3, 1
	slli.d	$a1, $a1, 13
	or	$a0, $a0, $a1
	...
	slli.d	$a1, $a1, 16
	or	$a0, $a0, $a1
	xvpickve2gr.w	$s7, $xr8, 1
	andi	$a1, $s7, 1
	slli.d	$a1, $a1, 17
	or	$a0, $a0, $a1
	xvpickve2gr.w	$s8, $xr8, 2
	andi	$a1, $s8, 1
	slli.d	$a1, $a1, 18
	or	$a0, $a0, $a1
	xvpickve2gr.w	$ra, $xr8, 3
	andi	$a1, $ra, 1
	slli.d	$a1, $a1, 19
	or	$a1, $a0, $a1
	xvpickve2gr.w	$a0, $xr8, 4
	...
	slli.d	$a2, $a2, 26
	or	$a1, $a1, $a2
	xvpickve2gr.w	$t6, $xr7, 3
	andi	$a2, $t6, 1
	slli.d	$a2, $a2, 27
	or	$a1, $a1, $a2
	xvpickve2gr.w	$t7, $xr7, 4
	andi	$a2, $t7, 1
	slli.d	$a2, $a2, 28
	or	$a1, $a1, $a2
	xvpickve2gr.w	$t8, $xr7, 5
	andi	$a2, $t8, 1
	slli.d	$a2, $a2, 29
	or	$a1, $a1, $a2
...
# %bb.51:                               # %cleanup11.i.loopexit151
	...
	vinsgr2vr.b	$vr2, $s6, 0
	vinsgr2vr.b	$vr2, $s7, 1
	vinsgr2vr.b	$vr2, $s8, 2
	vinsgr2vr.b	$vr2, $ra, 3
	...
	vinsgr2vr.b	$vr2, $t7, 12
	vinsgr2vr.b	$vr2, $t8, 13
	pcalau12i	$a0, %pc_hi20(.LCPI7_5)
	vld	$vr3, $a0, %pc_lo12(.LCPI7_5)
	vand.v	$vr0, $vr0, $vr1
	vinsgr2vr.b	$vr2, $fp, 14
...
.LBB7_113:                              # %vector.body418
	...
	slli.d	$a1, $a1, 7
	or	$a0, $a0, $a1
	xvsle.wu	$xr7, $xr0, $xr8
	xvpickve2gr.w	$t5, $xr7, 0
	andi	$a1, $t5, 1
	slli.d	$a1, $a1, 8
	or	$a0, $a0, $a1
	xvpickve2gr.w	$t6, $xr7, 1
	andi	$a1, $t6, 1
	slli.d	$a1, $a1, 9
	or	$a0, $a0, $a1
	xvpickve2gr.w	$t7, $xr7, 2
	andi	$a1, $t7, 1
	slli.d	$a1, $a1, 10
	or	$a0, $a0, $a1
	xvpickve2gr.w	$t8, $xr7, 3
	andi	$a1, $t8, 1
	slli.d	$a1, $a1, 11
	or	$a0, $a0, $a1
	...
	slli.d	$a1, $a1, 12
	or	$a0, $a0, $a1
	xvpickve2gr.w	$s0, $xr7, 5
	andi	$a1, $s0, 1
	slli.d	$a1, $a1, 13
	or	$a0, $a0, $a1
	xvpickve2gr.w	$s1, $xr7, 6
	andi	$a1, $s1, 1
	slli.d	$a1, $a1, 14
	or	$a0, $a0, $a1
	xvpickve2gr.w	$s2, $xr7, 7
	andi	$a1, $s2, 1
	slli.d	$a1, $a1, 15
	or	$a0, $a0, $a1
	xvsle.wu	$xr7, $xr0, $xr9
	...
	slli.d	$a1, $a1, 20
	or	$a0, $a0, $a1
	xvpickve2gr.w	$s7, $xr7, 5
	andi	$a1, $s7, 1
	slli.d	$a1, $a1, 21
	or	$a0, $a0, $a1
	xvpickve2gr.w	$s8, $xr7, 6
	andi	$a1, $s8, 1
	slli.d	$a1, $a1, 22
	or	$a0, $a0, $a1
	...
	slli.d	$a4, $a4, 25
	or	$a0, $a0, $a4
	xvpickve2gr.w	$a4, $xr6, 2
	andi	$a5, $a4, 1
	slli.d	$a5, $a5, 26
	or	$a5, $a0, $a5
	xvpickve2gr.w	$a0, $xr6, 3
	andi	$a6, $a0, 1
	slli.d	$a6, $a6, 27
	or	$a5, $a5, $a6
	...
	slli.d	$a6, $a6, 29
	or	$a6, $a5, $a6
	xvpickve2gr.w	$a5, $xr6, 6
	andi	$t1, $a5, 1
	slli.d	$t1, $t1, 30
	or	$t1, $a6, $t1
	xvpickve2gr.w	$a6, $xr6, 7
	slli.d	$t2, $a6, 31
	or	$t1, $t1, $t2
	st.w	$t1, $sp, 140
	ld.w	$t1, $sp, 140
...
# %bb.116:                              # %cleanup11.i.loopexit
	...
	pcalau12i	$t1, %pc_hi20(.LCPI7_4)
	vld	$vr1, $t1, %pc_lo12(.LCPI7_4)
	vinsgr2vr.b	$vr2, $s3, 0
	vinsgr2vr.b	$vr2, $s4, 1
	vinsgr2vr.b	$vr2, $a3, 2
	vinsgr2vr.b	$vr2, $s5, 3
	vinsgr2vr.b	$vr2, $s6, 4
	vinsgr2vr.b	$vr2, $s7, 5
	vinsgr2vr.b	$vr2, $s8, 6
	vinsgr2vr.b	$vr2, $ra, 7
	vinsgr2vr.b	$vr2, $a2, 8
	vinsgr2vr.b	$vr2, $a1, 9
...
.LBB7_118:                              # %cleanup11.i
	...
	ori	$a4, $a4, 577
	bltu	$a2, $a4, .LBB7_121
.LBB7_119:                              # %while.body.i.i.preheader
	lu12i.w	$a4, 488
	ori	$a4, $a4, 1153
	.p2align	4, , 16
.LBB7_120:                              # %while.body.i.i
                                        # =>This Inner Loop Header: Depth=1
	move	$a5, $a2
	srli.d	$a2, $a2, 1
	srli.d	$a1, $a1, 1
	bltu	$a4, $a5, .LBB7_120
.LBB7_121:                              # %_ZL11MyMultDiv64yyy.exit
	mul.d	$a0, $a0, $a3
	ori	$a4, $zero, 1
	sltu	$a3, $a4, $a1
	masknez	$a4, $a4, $a3
