...
# %bb.15:                               # %iter.check514
	...
	ori	$a4, $zero, 63
	bgeu	$a4, $a3, .LBB0_46
# %bb.16:                               # %vector.main.loop.iter.check516
	ori	$a2, $zero, 64
	bgeu	$a1, $a2, .LBB0_39
# %bb.17:
	move	$a2, $zero
...
# %bb.30:                               # %iter.check412
	...
	ori	$a4, $zero, 63
	bgeu	$a4, $a3, .LBB0_105
# %bb.31:                               # %vector.main.loop.iter.check414
	ori	$a2, $zero, 64
	bgeu	$a1, $a2, .LBB0_98
# %bb.32:
	move	$a2, $zero
...
.LBB0_40:                               # %vector.body520
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB0_40
# %bb.41:                               # %middle.block525
	beq	$a2, $a1, .LBB0_48
# %bb.42:                               # %vec.epilog.iter.check530
	andi	$a3, $a1, 48
	beqz	$a3, .LBB0_46
.LBB0_43:                               # %vec.epilog.ph529
	move	$a5, $a2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB0_44:                               # %vec.epilog.vector.body535
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_44
# %bb.45:                               # %vec.epilog.middle.block539
	beq	$a2, $a1, .LBB0_48
...
# %bb.59:                               # %iter.check548
	...
	ori	$a4, $zero, 63
	bgeu	$a4, $a3, .LBB0_77
# %bb.60:                               # %vector.main.loop.iter.check550
	ori	$a2, $zero, 64
	bgeu	$a1, $a2, .LBB0_70
# %bb.61:
	move	$a2, $zero
...
# %bb.65:                               # %iter.check582
	...
	ori	$a4, $zero, 63
	bgeu	$a4, $a3, .LBB0_91
# %bb.66:                               # %vector.main.loop.iter.check584
	ori	$a2, $zero, 64
	bgeu	$a1, $a2, .LBB0_84
# %bb.67:
	move	$a2, $zero
...
.LBB0_71:                               # %vector.body554
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB0_71
# %bb.72:                               # %middle.block559
	beq	$a2, $a1, .LBB0_79
# %bb.73:                               # %vec.epilog.iter.check564
	andi	$a3, $a1, 48
	beqz	$a3, .LBB0_77
.LBB0_74:                               # %vec.epilog.ph563
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB0_75:                               # %vec.epilog.vector.body569
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_75
# %bb.76:                               # %vec.epilog.middle.block573
	beq	$a2, $a1, .LBB0_79
...
.LBB0_85:                               # %vector.body588
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB0_85
# %bb.86:                               # %middle.block593
	beq	$a2, $a1, .LBB0_93
# %bb.87:                               # %vec.epilog.iter.check598
	andi	$a3, $a1, 48
	beqz	$a3, .LBB0_91
.LBB0_88:                               # %vec.epilog.ph597
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB0_89:                               # %vec.epilog.vector.body603
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_89
# %bb.90:                               # %vec.epilog.middle.block607
	beq	$a2, $a1, .LBB0_93
...
.LBB0_97:                               # %for.cond.cleanup.i.i267
	bnez	$a0, .LBB0_146
	b	.LBB0_147
.LBB0_98:                               # %vector.ph415
	bstrpick.d	$a2, $a1, 30, 6
	slli.d	$a2, $a2, 6
	addi.d	$a3, $s3, 32
	addi.d	$a4, $a0, 32
	move	$a5, $a2
.LBB0_99:                               # %vector.body418
                                        # =>This Inner Loop Header: Depth=1
	xvld	$xr0, $a4, -32
	xvld	$xr1, $a4, 0
	xvst	$xr0, $a3, -32
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB0_99
# %bb.100:                              # %middle.block423
	beq	$a2, $a1, .LBB0_107
# %bb.101:                              # %vec.epilog.iter.check428
	andi	$a3, $a1, 48
	beqz	$a3, .LBB0_105
.LBB0_102:                              # %vec.epilog.ph427
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
...
.LBB0_103:                              # %vec.epilog.vector.body433
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_103
# %bb.104:                              # %vec.epilog.middle.block437
	beq	$a2, $a1, .LBB0_107
...
# %bb.124:                              # %for.cond.preheader.i.i177
	ld.d	$a0, $fp, 0
	blt	$a1, $a2, .LBB0_156
# %bb.125:                              # %iter.check480
	ori	$a3, $zero, 16
	move	$a2, $zero
	bltu	$a1, $a3, .LBB0_173
# %bb.126:                              # %iter.check480
	sub.d	$a3, $s0, $a0
	ori	$a4, $zero, 63
	bgeu	$a4, $a3, .LBB0_173
# %bb.127:                              # %vector.main.loop.iter.check482
	ori	$a2, $zero, 64
	bgeu	$a1, $a2, .LBB0_166
# %bb.128:
	move	$a2, $zero
...
# %bb.131:                              # %for.cond.preheader.i.i218
	ld.d	$a0, $fp, 0
	blt	$a1, $a2, .LBB0_136
# %bb.132:                              # %iter.check446
	ori	$a3, $zero, 16
	move	$a2, $zero
	bltu	$a1, $a3, .LBB0_185
# %bb.133:                              # %iter.check446
	sub.d	$a3, $s0, $a0
	ori	$a4, $zero, 63
	bgeu	$a4, $a3, .LBB0_185
# %bb.134:                              # %vector.main.loop.iter.check448
	ori	$a2, $zero, 64
	bgeu	$a1, $a2, .LBB0_178
# %bb.135:
	move	$a2, $zero
...
# %bb.159:                              # %middle.block389
	beq	$a2, $a1, .LBB0_175
# %bb.160:                              # %vec.epilog.iter.check394
	andi	$a3, $a1, 48
	beqz	$a3, .LBB0_164
.LBB0_161:                              # %vec.epilog.ph393
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	add.d	$a4, $s0, $a5
	add.d	$a5, $a0, $a5
.LBB0_162:                              # %vec.epilog.vector.body399
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_162
# %bb.163:                              # %vec.epilog.middle.block403
	beq	$a2, $a1, .LBB0_175
...
.LBB0_165:                              # %for.body.i.i312
	...
	bnez	$a1, .LBB0_165
	b	.LBB0_175
.LBB0_166:                              # %vector.ph483
	bstrpick.d	$a2, $a1, 30, 6
	slli.d	$a2, $a2, 6
	addi.d	$a3, $s0, 32
	addi.d	$a4, $a0, 32
	move	$a5, $a2
.LBB0_167:                              # %vector.body486
                                        # =>This Inner Loop Header: Depth=1
	xvld	$xr0, $a4, -32
	xvld	$xr1, $a4, 0
	xvst	$xr0, $a3, -32
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB0_167
# %bb.168:                              # %middle.block491
	beq	$a2, $a1, .LBB0_175
# %bb.169:                              # %vec.epilog.iter.check496
	andi	$a3, $a1, 48
	beqz	$a3, .LBB0_173
.LBB0_170:                              # %vec.epilog.ph495
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	add.d	$a4, $s0, $a5
	add.d	$a5, $a0, $a5
.LBB0_171:                              # %vec.epilog.vector.body501
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_171
# %bb.172:                              # %vec.epilog.middle.block505
	beq	$a2, $a1, .LBB0_175
...
.LBB0_177:                              # %_ZN11CStringBaseIcE11SetCapacityEi.exit.i169
	...
	st.w	$a0, $fp, 8
	b	.LBB0_194
.LBB0_178:                              # %vector.ph449
	bstrpick.d	$a2, $a1, 30, 6
	slli.d	$a2, $a2, 6
	addi.d	$a3, $s0, 32
	addi.d	$a4, $a0, 32
	move	$a5, $a2
.LBB0_179:                              # %vector.body452
                                        # =>This Inner Loop Header: Depth=1
	xvld	$xr0, $a4, -32
	xvld	$xr1, $a4, 0
	xvst	$xr0, $a3, -32
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB0_179
# %bb.180:                              # %middle.block457
	beq	$a2, $a1, .LBB0_187
# %bb.181:                              # %vec.epilog.iter.check462
	andi	$a3, $a1, 48
	beqz	$a3, .LBB0_185
.LBB0_182:                              # %vec.epilog.ph461
	...
	add.d	$a4, $s0, $a5
	add.d	$a5, $a0, $a5
.LBB0_183:                              # %vec.epilog.vector.body467
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_183
# %bb.184:                              # %vec.epilog.middle.block471
	beq	$a2, $a1, .LBB0_187
