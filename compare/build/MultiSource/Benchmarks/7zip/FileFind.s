...
# %bb.30:                               # %iter.check411
	...
	ori	$a3, $zero, 64
	bltu	$a4, $a3, .LBB0_105
# %bb.31:                               # %vector.main.loop.iter.check413
	bgeu	$a1, $a3, .LBB0_98
# %bb.32:
	move	$a2, $zero
	b	.LBB0_102
...
.LBB0_40:                               # %vector.body516
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB0_40
# %bb.41:                               # %middle.block521
	beq	$a2, $a1, .LBB0_48
# %bb.42:                               # %vec.epilog.iter.check525
	beqz	$a3, .LBB0_46
.LBB0_43:                               # %vec.epilog.ph527
	move	$a5, $a2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB0_44:                               # %vec.epilog.vector.body530
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_44
# %bb.45:                               # %vec.epilog.middle.block534
	beq	$a2, $a1, .LBB0_48
...
# %bb.59:                               # %iter.check543
	...
	ori	$a3, $zero, 64
	bltu	$a4, $a3, .LBB0_77
# %bb.60:                               # %vector.main.loop.iter.check545
	bgeu	$a1, $a3, .LBB0_70
# %bb.61:
	move	$a2, $zero
	b	.LBB0_74
...
# %bb.65:                               # %iter.check576
	...
	ori	$a3, $zero, 64
	bltu	$a4, $a3, .LBB0_91
# %bb.66:                               # %vector.main.loop.iter.check578
	bgeu	$a1, $a3, .LBB0_84
# %bb.67:
	move	$a2, $zero
	b	.LBB0_88
...
.LBB0_71:                               # %vector.body549
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB0_71
# %bb.72:                               # %middle.block554
	beq	$a2, $a1, .LBB0_79
# %bb.73:                               # %vec.epilog.iter.check558
	beqz	$a3, .LBB0_77
.LBB0_74:                               # %vec.epilog.ph560
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB0_75:                               # %vec.epilog.vector.body563
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_75
# %bb.76:                               # %vec.epilog.middle.block567
	beq	$a2, $a1, .LBB0_79
...
.LBB0_85:                               # %vector.body582
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB0_85
# %bb.86:                               # %middle.block587
	beq	$a2, $a1, .LBB0_93
# %bb.87:                               # %vec.epilog.iter.check591
	beqz	$a3, .LBB0_91
.LBB0_88:                               # %vec.epilog.ph593
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB0_89:                               # %vec.epilog.vector.body596
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_89
# %bb.90:                               # %vec.epilog.middle.block600
	beq	$a2, $a1, .LBB0_93
...
.LBB0_99:                               # %vector.body417
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB0_99
# %bb.100:                              # %middle.block422
	beq	$a2, $a1, .LBB0_107
# %bb.101:                              # %vec.epilog.iter.check426
	beqz	$a3, .LBB0_105
.LBB0_102:                              # %vec.epilog.ph428
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	add.d	$a4, $s3, $a5
	add.d	$a5, $a0, $a5
.LBB0_103:                              # %vec.epilog.vector.body431
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_103
# %bb.104:                              # %vec.epilog.middle.block435
	beq	$a2, $a1, .LBB0_107
...
# %bb.124:                              # %for.cond.preheader.i.i177
	ld.d	$a0, $fp, 0
	blez	$a1, .LBB0_156
# %bb.125:                              # %iter.check477
	ori	$a3, $zero, 16
	move	$a2, $zero
	bltu	$a1, $a3, .LBB0_173
# %bb.126:                              # %iter.check477
	sub.d	$a4, $s0, $a0
	ori	$a3, $zero, 64
	bltu	$a4, $a3, .LBB0_173
# %bb.127:                              # %vector.main.loop.iter.check479
	bgeu	$a1, $a3, .LBB0_166
# %bb.128:
	move	$a2, $zero
	b	.LBB0_170
...
# %bb.131:                              # %for.cond.preheader.i.i218
	ld.d	$a0, $fp, 0
	blez	$a1, .LBB0_136
# %bb.132:                              # %iter.check444
	ori	$a3, $zero, 16
	move	$a2, $zero
	bltu	$a1, $a3, .LBB0_185
# %bb.133:                              # %iter.check444
	sub.d	$a4, $s0, $a0
	ori	$a3, $zero, 64
	bltu	$a4, $a3, .LBB0_185
# %bb.134:                              # %vector.main.loop.iter.check446
	bgeu	$a1, $a3, .LBB0_178
# %bb.135:
	move	$a2, $zero
	b	.LBB0_182
...
# %bb.151:                              # %for.cond.preheader.i.i303
	ld.d	$a0, $fp, 0
	blez	$a1, .LBB0_156
# %bb.152:                              # %iter.check378
	ori	$a3, $zero, 16
	move	$a2, $zero
	bltu	$a1, $a3, .LBB0_164
# %bb.153:                              # %iter.check378
	sub.d	$a4, $s0, $a0
	ori	$a3, $zero, 64
	bltu	$a4, $a3, .LBB0_164
# %bb.154:                              # %vector.main.loop.iter.check380
	bgeu	$a1, $a3, .LBB0_157
# %bb.155:
	move	$a2, $zero
	b	.LBB0_161
...
.LBB0_158:                              # %vector.body384
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB0_158
# %bb.159:                              # %middle.block389
	beq	$a2, $a1, .LBB0_175
# %bb.160:                              # %vec.epilog.iter.check393
	beqz	$a3, .LBB0_164
.LBB0_161:                              # %vec.epilog.ph395
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	add.d	$a4, $s0, $a5
	add.d	$a5, $a0, $a5
.LBB0_162:                              # %vec.epilog.vector.body398
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_162
# %bb.163:                              # %vec.epilog.middle.block402
	beq	$a2, $a1, .LBB0_175
...
.LBB0_167:                              # %vector.body483
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB0_167
# %bb.168:                              # %middle.block488
	beq	$a2, $a1, .LBB0_175
# %bb.169:                              # %vec.epilog.iter.check492
	beqz	$a3, .LBB0_173
.LBB0_170:                              # %vec.epilog.ph494
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	add.d	$a4, $s0, $a5
	add.d	$a5, $a0, $a5
.LBB0_171:                              # %vec.epilog.vector.body497
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_171
# %bb.172:                              # %vec.epilog.middle.block501
	beq	$a2, $a1, .LBB0_175
...
.LBB0_179:                              # %vector.body450
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB0_179
# %bb.180:                              # %middle.block455
	beq	$a2, $a1, .LBB0_187
# %bb.181:                              # %vec.epilog.iter.check459
	beqz	$a3, .LBB0_185
.LBB0_182:                              # %vec.epilog.ph461
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	add.d	$a4, $s0, $a5
	add.d	$a5, $a0, $a5
.LBB0_183:                              # %vec.epilog.vector.body464
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB0_183
# %bb.184:                              # %vec.epilog.middle.block468
	beq	$a2, $a1, .LBB0_187
