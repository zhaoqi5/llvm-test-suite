...
# %bb.17:                               # %for.cond.i38
	...
	ld.bu	$a3, $a0, 1
	bne	$a2, $a3, .LBB50_32
# %bb.18:                               # %for.cond.1.i41
	ld.bu	$a2, $s1, 2
	ld.bu	$a3, $a0, 2
	bne	$a2, $a3, .LBB50_32
# %bb.19:                               # %for.cond.2.i44
	ld.bu	$a2, $s1, 3
	ld.bu	$a3, $a0, 3
	bne	$a2, $a3, .LBB50_32
# %bb.20:                               # %for.cond.3.i47
	ld.bu	$a2, $s1, 4
	ld.bu	$a3, $a0, 4
	bne	$a2, $a3, .LBB50_32
# %bb.21:                               # %for.cond.4.i50
	ld.bu	$a2, $s1, 5
	ld.bu	$a3, $a0, 5
	bne	$a2, $a3, .LBB50_32
# %bb.22:                               # %for.cond.5.i53
	ld.bu	$a2, $s1, 6
	ld.bu	$a3, $a0, 6
	bne	$a2, $a3, .LBB50_32
# %bb.23:                               # %for.cond.6.i56
	ld.bu	$a2, $s1, 7
	ld.bu	$a3, $a0, 7
	bne	$a2, $a3, .LBB50_32
# %bb.24:                               # %for.cond.7.i59
	ld.bu	$a2, $s1, 8
	ld.bu	$a3, $a0, 8
	bne	$a2, $a3, .LBB50_32
# %bb.25:                               # %for.cond.8.i62
	ld.bu	$a2, $s1, 9
	ld.bu	$a3, $a0, 9
	bne	$a2, $a3, .LBB50_32
# %bb.26:                               # %for.cond.9.i65
	ld.bu	$a2, $s1, 10
	ld.bu	$a3, $a0, 10
	bne	$a2, $a3, .LBB50_32
# %bb.27:                               # %for.cond.10.i68
	ld.bu	$a2, $s1, 11
	ld.bu	$a3, $a0, 11
	bne	$a2, $a3, .LBB50_32
# %bb.28:                               # %for.cond.11.i71
	ld.bu	$a2, $s1, 12
	ld.bu	$a3, $a0, 12
	bne	$a2, $a3, .LBB50_32
# %bb.29:                               # %for.cond.12.i74
	ld.bu	$a2, $s1, 13
	ld.bu	$a3, $a0, 13
	bne	$a2, $a3, .LBB50_32
# %bb.30:                               # %for.cond.13.i77
	ld.bu	$a2, $s1, 14
	ld.bu	$a3, $a0, 14
	bne	$a2, $a3, .LBB50_32
# %bb.31:                               # %_ZeqRK4GUIDS1_.exit84
	ld.bu	$a2, $s1, 15
	ld.bu	$a3, $a0, 15
	move	$a0, $fp
	beq	$a2, $a3, .LBB50_90
...
# %bb.33:                               # %for.cond.i87
	...
	ld.bu	$a3, $a0, 1
	bne	$a2, $a3, .LBB50_49
# %bb.34:                               # %for.cond.1.i90
	ld.bu	$a2, $s1, 2
	ld.bu	$a3, $a0, 2
	bne	$a2, $a3, .LBB50_49
# %bb.35:                               # %for.cond.2.i93
	ld.bu	$a2, $s1, 3
	ld.bu	$a3, $a0, 3
	bne	$a2, $a3, .LBB50_49
# %bb.36:                               # %for.cond.3.i96
	ld.bu	$a2, $s1, 4
	ld.bu	$a3, $a0, 4
	bne	$a2, $a3, .LBB50_49
# %bb.37:                               # %for.cond.4.i99
	ld.bu	$a2, $s1, 5
	ld.bu	$a3, $a0, 5
	bne	$a2, $a3, .LBB50_49
# %bb.38:                               # %for.cond.5.i102
	ld.bu	$a2, $s1, 6
	ld.bu	$a3, $a0, 6
	bne	$a2, $a3, .LBB50_49
# %bb.39:                               # %for.cond.6.i105
	ld.bu	$a2, $s1, 7
	ld.bu	$a3, $a0, 7
	bne	$a2, $a3, .LBB50_49
# %bb.40:                               # %for.cond.7.i108
	ld.bu	$a2, $s1, 8
	ld.bu	$a3, $a0, 8
	bne	$a2, $a3, .LBB50_49
# %bb.41:                               # %for.cond.8.i111
	ld.bu	$a2, $s1, 9
	ld.bu	$a3, $a0, 9
	bne	$a2, $a3, .LBB50_49
# %bb.42:                               # %for.cond.9.i114
	ld.bu	$a2, $s1, 10
	ld.bu	$a3, $a0, 10
	bne	$a2, $a3, .LBB50_49
# %bb.43:                               # %for.cond.10.i117
	ld.bu	$a2, $s1, 11
	ld.bu	$a3, $a0, 11
	bne	$a2, $a3, .LBB50_49
# %bb.44:                               # %for.cond.11.i120
	ld.bu	$a2, $s1, 12
	ld.bu	$a3, $a0, 12
	bne	$a2, $a3, .LBB50_49
# %bb.45:                               # %for.cond.12.i123
	ld.bu	$a2, $s1, 13
	ld.bu	$a3, $a0, 13
	bne	$a2, $a3, .LBB50_49
# %bb.46:                               # %for.cond.13.i126
	ld.bu	$a2, $s1, 14
	ld.bu	$a3, $a0, 14
	bne	$a2, $a3, .LBB50_49
# %bb.47:                               # %_ZeqRK4GUIDS1_.exit133
	ld.bu	$a2, $s1, 15
	ld.bu	$a0, $a0, 15
	bne	$a2, $a0, .LBB50_49
# %bb.48:                               # %if.then12
...
# %bb.50:                               # %for.cond.i136
	...
	ld.bu	$a2, $a0, 1
	bne	$a1, $a2, .LBB50_66
# %bb.51:                               # %for.cond.1.i139
	ld.bu	$a1, $s1, 2
	ld.bu	$a2, $a0, 2
	bne	$a1, $a2, .LBB50_66
# %bb.52:                               # %for.cond.2.i142
	ld.bu	$a1, $s1, 3
	ld.bu	$a2, $a0, 3
	bne	$a1, $a2, .LBB50_66
# %bb.53:                               # %for.cond.3.i145
	ld.bu	$a1, $s1, 4
	ld.bu	$a2, $a0, 4
	bne	$a1, $a2, .LBB50_66
# %bb.54:                               # %for.cond.4.i148
	ld.bu	$a1, $s1, 5
	ld.bu	$a2, $a0, 5
	bne	$a1, $a2, .LBB50_66
# %bb.55:                               # %for.cond.5.i151
	ld.bu	$a1, $s1, 6
	ld.bu	$a2, $a0, 6
	bne	$a1, $a2, .LBB50_66
# %bb.56:                               # %for.cond.6.i154
	ld.bu	$a1, $s1, 7
	ld.bu	$a2, $a0, 7
	bne	$a1, $a2, .LBB50_66
# %bb.57:                               # %for.cond.7.i157
	ld.bu	$a1, $s1, 8
	ld.bu	$a2, $a0, 8
	bne	$a1, $a2, .LBB50_66
# %bb.58:                               # %for.cond.8.i160
	ld.bu	$a1, $s1, 9
	ld.bu	$a2, $a0, 9
	bne	$a1, $a2, .LBB50_66
# %bb.59:                               # %for.cond.9.i163
	ld.bu	$a1, $s1, 10
	ld.bu	$a2, $a0, 10
	bne	$a1, $a2, .LBB50_66
# %bb.60:                               # %for.cond.10.i166
	ld.bu	$a1, $s1, 11
	ld.bu	$a2, $a0, 11
	bne	$a1, $a2, .LBB50_66
# %bb.61:                               # %for.cond.11.i169
	ld.bu	$a1, $s1, 12
	ld.bu	$a2, $a0, 12
	bne	$a1, $a2, .LBB50_66
# %bb.62:                               # %for.cond.12.i172
	ld.bu	$a1, $s1, 13
	ld.bu	$a2, $a0, 13
	bne	$a1, $a2, .LBB50_66
# %bb.63:                               # %for.cond.13.i175
	ld.bu	$a1, $s1, 14
	ld.bu	$a2, $a0, 14
	bne	$a1, $a2, .LBB50_66
# %bb.64:                               # %_ZeqRK4GUIDS1_.exit182
	ld.bu	$a1, $s1, 15
	ld.bu	$a0, $a0, 15
	bne	$a1, $a0, .LBB50_66
# %bb.65:                               # %if.then19
