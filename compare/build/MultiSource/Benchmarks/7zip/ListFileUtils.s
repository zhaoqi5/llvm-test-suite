...
# %bb.19:
	move	$s1, $s0
	b	.LBB1_25
.LBB1_20:                               # %if.end.i.i14
	slli.d	$a0, $s4, 2
.Ltmp65:                                # EH_LABEL
	pcaddu18i	$ra, %call36(_Znam)
	jirl	$ra, $ra, 0
.Ltmp66:                                # EH_LABEL
# %bb.21:                               # %call.i.i.noexc
	move	$s1, $a0
	blez	$s5, .LBB1_23
...
.LBB1_24:                               # %if.end9.i.i
	...
	stx.w	$zero, $s1, $a1
	st.w	$s4, $a0, 12
.LBB1_25:                               # %while.cond.i.i.preheader
	move	$a1, $zero
	.p2align	4, , 16
.LBB1_26:                               # %while.cond.i.i
                                        # =>This Inner Loop Header: Depth=1
	ldx.w	$a2, $fp, $a1
	stx.w	$a2, $s1, $a1
	addi.d	$a1, $a1, 4
...
# %bb.27:                               # %_ZN11CStringBaseIwED2Ev.exit
	...
	jr	$t8
.LBB1_28:                               # %_ZN11CStringBaseIwED2Ev.exit21
.Ltmp67:                                # EH_LABEL
	move	$s0, $a0
	move	$s1, $fp
	move	$a0, $s1
...
.LBB2_11:
	...
	move	$a1, $s2
	b	.LBB2_14
.LBB2_12:                               # %for.cond.cleanup.i.i
	move	$a2, $s3
	move	$a1, $s2
	beqz	$a0, .LBB2_14
.LBB2_13:                               # %delete.notnull.i.i
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	move	$a1, $s2
	move	$a2, $s3
