...
# %bb.0:                                # %entry
	...
	move	$a1, $a0
	ld.d	$a0, $a0, 40
	pcalau12i	$a2, %pc_hi20(_ZTV12CBufInStream+16)
	addi.d	$a2, $a2, %pc_lo12(_ZTV12CBufInStream+16)
	st.d	$a2, $a1, 0
	beqz	$a0, .LBB17_2
# %bb.1:                                # %if.then.i
	ld.d	$a1, $a0, 0
...
# %bb.0:                                # %entry
	...
	move	$fp, $a0
	ld.d	$a0, $a0, 24
	pcalau12i	$a1, %pc_hi20(_ZTV19CDynBufSeqOutStream+16)
	addi.d	$a1, $a1, %pc_lo12(_ZTV19CDynBufSeqOutStream+16)
	st.d	$a1, $fp, 0
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	vrepli.b	$vr0, 0
...
# %bb.0:                                # %entry
	...
	move	$a1, $a0
	ld.d	$a0, $a0, 16
	pcalau12i	$a2, %pc_hi20(_ZTV29CSequentialOutStreamSizeCount+16)
	addi.d	$a2, $a2, %pc_lo12(_ZTV29CSequentialOutStreamSizeCount+16)
	st.d	$a2, $a1, 0
	beqz	$a0, .LBB32_2
# %bb.1:                                # %if.then.i
	ld.d	$a1, $a0, 0
...
# %bb.0:                                # %entry
	...
	move	$fp, $a0
	ld.d	$a0, $a0, 16
	pcalau12i	$a1, %pc_hi20(_ZTV15CCachedInStream+16)
	addi.d	$a1, $a1, %pc_lo12(_ZTV15CCachedInStream+16)
	st.d	$a1, $fp, 0
.Ltmp12:                                # EH_LABEL
	pcaddu18i	$ra, %call36(MyFree)
	jirl	$ra, $ra, 0
