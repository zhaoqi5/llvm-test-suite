...
.LBB3_65:                               # %vector.body112
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB3_65
# %bb.66:                               # %middle.block117
	beq	$a2, $a1, .LBB3_73
# %bb.67:                               # %vec.epilog.iter.check122
	andi	$a3, $a1, 48
	beqz	$a3, .LBB3_71
.LBB3_68:                               # %vec.epilog.ph121
	move	$a5, $a2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB3_69:                               # %vec.epilog.vector.body127
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB3_69
# %bb.70:                               # %vec.epilog.middle.block131
	beq	$a2, $a1, .LBB3_73
