...
# %bb.70:                               # %middle.block221
                                        #   in Loop: Header=BB4_23 Depth=1
	beq	$a0, $s6, .LBB4_77
# %bb.71:                               # %vec.epilog.iter.check226
                                        #   in Loop: Header=BB4_23 Depth=1
	andi	$a1, $s6, 48
	beqz	$a1, .LBB4_75
.LBB4_72:                               # %vec.epilog.ph225
                                        #   in Loop: Header=BB4_23 Depth=1
	move	$a3, $a0
	bstrpick.d	$a0, $s6, 30, 4
	slli.d	$a0, $a0, 4
	...
	add.d	$a3, $s0, $a3
	.p2align	4, , 16
.LBB4_73:                               # %vec.epilog.vector.body231
                                        #   Parent Loop BB4_23 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a3, 0
	vst	$vr0, $a2, 0
	...
	addi.d	$a3, $a3, 16
	bnez	$a1, .LBB4_73
# %bb.74:                               # %vec.epilog.middle.block235
                                        #   in Loop: Header=BB4_23 Depth=1
	beq	$a0, $s6, .LBB4_77
...
.Ltmp187:                               # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp188:                               # EH_LABEL
.LBB14_50:                              # %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit59
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB14_51:                              # %terminate.lpad.i58
.Ltmp189:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.Lfunc_end14:
...
.LBB20_183:                             # %sw.bb538
	...
	ld.d	$a0, $sp, 72                    # 8-byte Folded Reload
	b	.LBB20_187
.LBB20_184:                             # %cleanup601.thread1201
                                        #   in Loop: Header=BB20_165 Depth=2
	ori	$s0, $zero, 1
	b	.LBB20_164
.LBB20_185:                             # %sw.bb564
...
# %bb.188:                              # %sw.epilog577
                                        #   in Loop: Header=BB20_165 Depth=2
	bnez	$a0, .LBB20_192
.LBB20_189:                             # %cleanup601.thread1216
                                        #   in Loop: Header=BB20_165 Depth=2
	move	$s0, $zero
	ori	$a0, $zero, 1
...
# %bb.197:                              # %call5.i.noexc
                                        #   in Loop: Header=BB20_195 Depth=2
	beqz	$a0, .LBB20_195
.LBB20_198:                             # %cleanup601.thread1194
                                        #   in Loop: Header=BB20_32 Depth=1
	ori	$fp, $zero, 1
