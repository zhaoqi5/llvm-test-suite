...
# %bb.50:                               # %iter.check206
	...
	ori	$a2, $zero, 64
	bltu	$a1, $a2, .LBB4_75
# %bb.51:                               # %vector.main.loop.iter.check208
                                        #   in Loop: Header=BB4_23 Depth=1
	ori	$a0, $zero, 64
	bgeu	$s6, $a0, .LBB4_68
...
.LBB4_69:                               # %vector.body212
	...
	addi.d	$a2, $a2, 64
	bnez	$a3, .LBB4_69
# %bb.70:                               # %middle.block217
                                        #   in Loop: Header=BB4_23 Depth=1
	beq	$a0, $s6, .LBB4_77
# %bb.71:                               # %vec.epilog.iter.check222
                                        #   in Loop: Header=BB4_23 Depth=1
	andi	$a1, $s6, 48
	beqz	$a1, .LBB4_75
.LBB4_72:                               # %vec.epilog.ph221
                                        #   in Loop: Header=BB4_23 Depth=1
	move	$a3, $a0
	bstrpick.d	$a0, $s6, 30, 4
	slli.d	$a0, $a0, 4
	...
	add.d	$a3, $s0, $a3
	.p2align	4, , 16
.LBB4_73:                               # %vec.epilog.vector.body227
                                        #   Parent Loop BB4_23 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a3, 0
	vst	$vr0, $a2, 0
	...
	addi.d	$a3, $a3, 16
	bnez	$a1, .LBB4_73
# %bb.74:                               # %vec.epilog.middle.block231
                                        #   in Loop: Header=BB4_23 Depth=1
	beq	$a0, $s6, .LBB4_77
...
.LBB20_183:                             # %sw.bb538
	...
	ld.d	$a0, $sp, 72                    # 8-byte Folded Reload
	b	.LBB20_187
.LBB20_184:                             # %cleanup601.thread1181
                                        #   in Loop: Header=BB20_165 Depth=2
	ori	$s0, $zero, 1
	b	.LBB20_164
.LBB20_185:                             # %sw.bb564
...
# %bb.188:                              # %sw.epilog577
                                        #   in Loop: Header=BB20_165 Depth=2
	bnez	$a0, .LBB20_192
.LBB20_189:                             # %cleanup601.thread1196
                                        #   in Loop: Header=BB20_165 Depth=2
	move	$s0, $zero
	ori	$a0, $zero, 1
...
# %bb.197:                              # %call5.i.noexc
                                        #   in Loop: Header=BB20_195 Depth=2
	beqz	$a0, .LBB20_195
.LBB20_198:                             # %cleanup601.thread1174
                                        #   in Loop: Header=BB20_32 Depth=1
	ori	$fp, $zero, 1
