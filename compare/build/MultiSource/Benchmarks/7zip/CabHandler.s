...
.Ltmp14:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp15:                                # EH_LABEL
# %bb.47:                               # %call.i.i.i.noexc
                                        #   in Loop: Header=BB4_23 Depth=1
	move	$s5, $a0
	blez	$s3, .LBB4_78
# %bb.48:                               # %for.cond.preheader.i.i.i
                                        #   in Loop: Header=BB4_23 Depth=1
	blez	$s8, .LBB4_77
# %bb.49:                               # %iter.check210
                                        #   in Loop: Header=BB4_23 Depth=1
...
# %bb.50:                               # %iter.check210
	...
	ori	$a2, $zero, 64
	bltu	$a1, $a2, .LBB4_75
# %bb.51:                               # %vector.main.loop.iter.check212
                                        #   in Loop: Header=BB4_23 Depth=1
	ori	$a0, $zero, 64
	bgeu	$s8, $a0, .LBB4_68
...
# %bb.59:                               # %vec.epilog.middle.block
                                        #   in Loop: Header=BB4_23 Depth=1
	beq	$a0, $s8, .LBB4_62
.LBB4_60:                               # %for.body.i.i.i80.preheader
                                        #   in Loop: Header=BB4_23 Depth=1
	sub.d	$a1, $s8, $a0
	add.d	$a2, $s5, $a0
	add.d	$a0, $s0, $a0
	.p2align	4, , 16
.LBB4_61:                               # %for.body.i.i.i80
                                        #   Parent Loop BB4_23 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.b	$a3, $a0, 0
	st.b	$a3, $a2, 0
	...
	addi.d	$a0, $a0, 1
	bnez	$a1, .LBB4_61
.LBB4_62:                               # %delete.notnull.i.i.i76
                                        #   in Loop: Header=BB4_23 Depth=1
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB4_63:                               # %if.end9.i.i.i68
                                        #   in Loop: Header=BB4_23 Depth=1
	stx.b	$zero, $s5, $s8
	move	$s0, $s5
...
# %bb.66:                               # %invoke.cont47
                                        #   in Loop: Header=BB4_23 Depth=1
	beqz	$s2, .LBB4_22
# %bb.67:                               # %delete.notnull.i89
                                        #   in Loop: Header=BB4_23 Depth=1
	move	$a0, $s2
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	b	.LBB4_22
.LBB4_68:                               # %vector.ph213
                                        #   in Loop: Header=BB4_23 Depth=1
	andi	$a1, $s8, 48
	bstrpick.d	$a0, $s8, 30, 6
	slli.d	$a0, $a0, 6
...
.LBB4_69:                               # %vector.body216
	...
	addi.d	$a3, $a3, 64
	bnez	$a4, .LBB4_69
# %bb.70:                               # %middle.block221
                                        #   in Loop: Header=BB4_23 Depth=1
	beq	$a0, $s8, .LBB4_77
# %bb.71:                               # %vec.epilog.iter.check225
                                        #   in Loop: Header=BB4_23 Depth=1
	beqz	$a1, .LBB4_75
.LBB4_72:                               # %vec.epilog.ph227
                                        #   in Loop: Header=BB4_23 Depth=1
	move	$a3, $a0
	bstrpick.d	$a0, $s8, 30, 4
	slli.d	$a0, $a0, 4
	...
	add.d	$a3, $s0, $a3
	.p2align	4, , 16
.LBB4_73:                               # %vec.epilog.vector.body230
                                        #   Parent Loop BB4_23 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a3, 0
	vst	$vr0, $a2, 0
	...
	addi.d	$a3, $a3, 16
	bnez	$a1, .LBB4_73
# %bb.74:                               # %vec.epilog.middle.block234
                                        #   in Loop: Header=BB4_23 Depth=1
	beq	$a0, $s8, .LBB4_77
...
# %bb.6:                                # %while.body.lr.ph
	...
	addi.d	$s2, $a0, %pc_lo12(_ZTV13CObjectVectorIN8NArchive4NCab7CFolderEE+16)
	pcalau12i	$a0, %pc_hi20(_ZTV13CObjectVectorIN8NArchive4NCab5CItemEE+16)
	addi.d	$s3, $a0, %pc_lo12(_ZTV13CObjectVectorIN8NArchive4NCab5CItemEE+16)
	move	$s8, $zero
                                        # implicit-def: $r30
	.p2align	4, , 16
.LBB7_7:                                # %while.body
...
.Ltmp154:                               # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp155:                               # EH_LABEL
.LBB7_84:                               # %_ZN9CMyComPtrI9IInStreamED2Ev.exit92
	ld.d	$a0, $sp, 240
	beqz	$a0, .LBB7_86
# %bb.85:                               # %if.then.i94
	ld.d	$a1, $a0, 0
...
.Ltmp157:                               # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp158:                               # EH_LABEL
.LBB7_86:                               # %_ZN9CMyComPtrI26IArchiveOpenVolumeCallbackED2Ev.exit
.Ltmp160:                               # EH_LABEL
	addi.d	$a0, $sp, 248
	pcaddu18i	$ra, %call36(_ZN9CInBuffer4FreeEv)
	jirl	$ra, $ra, 0
.Ltmp161:                               # EH_LABEL
# %bb.87:                               # %invoke.cont.i.i
	ld.d	$a0, $sp, 272
	beqz	$a0, .LBB7_89
# %bb.88:                               # %if.then.i.i.i
	ld.d	$a1, $a0, 0
...
.LBB7_89:                               # %return
	...
	addi.d	$sp, $sp, 384
	ret
.LBB7_90:                               # %terminate.lpad.i.i.i
.Ltmp165:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB7_91:                               # %terminate.lpad.i98
.Ltmp159:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB7_92:                               # %terminate.lpad.i91
.Ltmp156:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB7_93:                               # %lpad176
...
.Ltmp148:                               # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp149:                               # EH_LABEL
.LBB7_97:                               # %_ZN9CMyComPtrI26IArchiveOpenVolumeCallbackED2Ev.exit106
	addi.d	$a0, $sp, 248
	pcaddu18i	$ra, %call36(_ZN8NArchive4NCab10CInArchiveD2Ev)
	jirl	$ra, $ra, 0
.LBB7_98:                               # %catch.dispatch
	addi.w	$s1, $fp, 0
	move	$a0, $s0
	pcaddu18i	$ra, %call36(__cxa_begin_catch)
	jirl	$ra, $ra, 0
...
.Ltmp152:                               # EH_LABEL
# %bb.101:                              # %unreachable
.LBB7_102:                              # %terminate.lpad.i
.Ltmp147:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB7_103:                              # %terminate.lpad.i105
.Ltmp150:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB7_104:                              # %lpad210
