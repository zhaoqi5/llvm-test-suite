	.file	"ExtractingFilePath.cpp"
	.text
	.globl	_Z15MakeCorrectPathR13CObjectVectorI11CStringBaseIwEE # -- Begin function _Z15MakeCorrectPathR13CObjectVectorI11CStringBaseIwEE
	.p2align	5
...
.LBB0_8:                                # %if.end9.i.i.i.i
	...
	jirl	$ra, $ra, 0
	st.w	$zero, $a0, 0
.LBB0_9:                                # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i.i
                                        #   in Loop: Header=BB0_3 Depth=1
	move	$a1, $zero
	.p2align	4, , 16
...
.LBB0_16:                               # %if.end9.i.i
	...
	st.w	$s2, $s6, 12
	move	$s3, $s5
.LBB0_17:                               # %while.cond.i.i.preheader
                                        #   in Loop: Header=BB0_3 Depth=1
	move	$a1, $zero
	.p2align	4, , 16
.LBB0_18:                               # %while.cond.i.i
                                        #   Parent Loop BB0_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.w	$a2, $a0, $a1
	stx.w	$a2, $s3, $a1
...
.Ltmp2:                                 # EH_LABEL
	move	$fp, $a0
	beqz	$s4, .LBB0_26
# %bb.25:                               # %delete.notnull.i15
	move	$a0, $s4
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB0_26:                               # %_ZN11CStringBaseIwED2Ev.exit16
	move	$a0, $fp
...
.Lcst_end0:
	.p2align	2, 0x0
                                        # -- End function
	.text
	.globl	_Z21MakePathNameFromPartsRK13CObjectVectorI11CStringBaseIwEE # -- Begin function _Z21MakePathNameFromPartsRK13CObjectVectorI11CStringBaseIwEE
	.p2align	5
...
.LBB1_7:                                # %nrvo.skipdtor
	...
	addi.d	$sp, $sp, 48
	ret
.LBB1_8:                                # %lpad.loopexit.split-lp
.Ltmp5:                                 # EH_LABEL
	b	.LBB1_10
.LBB1_9:                                # %lpad.loopexit
.Ltmp10:                                # EH_LABEL
.LBB1_10:                               # %lpad
	move	$s0, $a0
	ld.d	$a0, $fp, 0
...
# %bb.11:                               # %delete.notnull.i
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB1_12:                               # %_ZN11CStringBaseIwED2Ev.exit
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.Lfunc_end1:
	.size	_Z21MakePathNameFromPartsRK13CObjectVectorI11CStringBaseIwEE, .Lfunc_end1-_Z21MakePathNameFromPartsRK13CObjectVectorI11CStringBaseIwEE
	.cfi_endproc
	.section	.gcc_except_table,"a",@progbits
	.p2align	2, 0x0
GCC_except_table1:
...
.Lfunc_end3:
	...
	.cfi_endproc
                                        # -- End function
	.text
	.globl	_Z16GetCorrectFsPathRK11CStringBaseIwE # -- Begin function _Z16GetCorrectFsPathRK11CStringBaseIwE
	.p2align	5
...
.LBB4_3:                                # %while.cond.i.i.i.i
	...
	move	$a0, $a2
	bnez	$a1, .LBB4_3
# %bb.4:                                # %_ZL21ReplaceIncorrectCharsRK11CStringBaseIwE.exit.i
	st.w	$s1, $fp, 8
	b	.LBB4_6
.LBB4_5:                                # %if.then.i
	ori	$a0, $zero, 0
	...
	st.d	$a0, $fp, 0
	st.w	$zero, $a0, 0
.LBB4_6:                                # %_ZL18GetCorrectFileNameRK11CStringBaseIwE.exit
	ld.d	$s2, $sp, 8                     # 8-byte Folded Reload
	ld.d	$s1, $sp, 16                    # 8-byte Folded Reload
	ld.d	$s0, $sp, 24                    # 8-byte Folded Reload
	ld.d	$fp, $sp, 32                    # 8-byte Folded Reload
	...
	ret
.Lfunc_end4:
	.size	_Z16GetCorrectFsPathRK11CStringBaseIwE, .Lfunc_end4-_Z16GetCorrectFsPathRK11CStringBaseIwE
	.cfi_endproc
                                        # -- End function
	.globl	_Z20GetCorrectFullFsPathRK11CStringBaseIwE # -- Begin function _Z20GetCorrectFullFsPathRK11CStringBaseIwE
	.p2align	5
...
# %bb.0:                                # %entry
	...
	addi.d	$s0, $a0, %pc_lo12(_ZTV13CObjectVectorI11CStringBaseIwEE+16)
	st.d	$s0, $sp, 8
.Ltmp11:                                # EH_LABEL
	addi.d	$a1, $sp, 8
	move	$a0, $a2
...
.Ltmp15:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Lfunc_end5:
	.size	_Z20GetCorrectFullFsPathRK11CStringBaseIwE, .Lfunc_end5-_Z20GetCorrectFullFsPathRK11CStringBaseIwE
	.cfi_endproc
	.section	.gcc_except_table,"a",@progbits
	.p2align	2, 0x0
GCC_except_table5:
...
.Lcst_begin3:
	...
	.uleb128 .Lfunc_end6-.Ltmp20            #   Call between .Ltmp20 and .Lfunc_end6
	.byte	0                               #     has no landing pad
	.byte	0                               #   On action: cleanup
.Lcst_end3:
	.byte	1                               # >> Action Record 1 <<
