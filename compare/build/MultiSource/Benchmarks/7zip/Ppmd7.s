...
.LBB13_15:                              # %if.end.i
	beq	$a7, $a3, .LBB13_26
# %bb.16:                               # %while.body30.lr.ph.i
	addi.d	$t0, $a5, 4
	addi.d	$t1, $a5, 8
	b	.LBB13_18
	.p2align	4, , 16
.LBB13_17:                              # %for.end69.i
                                        #   in Loop: Header=BB13_18 Depth=1
	ld.w	$a7, $a7, 4
	beq	$a7, $a3, .LBB13_25
.LBB13_18:                              # %while.body30.i
                                        # =>This Loop Header: Depth=1
...
# %bb.27:                               # %if.then2
	...
	st.w	$a4, $a1, 0
	ret
.LBB13_28:                              # %for.body79.lr.ph.i
	addi.d	$a6, $a0, 146
	ori	$a7, $zero, 129
	ori	$t0, $zero, 128
	b	.LBB13_30
	.p2align	4, , 16
.LBB13_29:                              # %if.end115.i
...
.LBB13_30:                              # %for.body79.i
	...
	ld.w	$t1, $t2, 4
	bltu	$t3, $a7, .LBB13_33
# %bb.31:                               # %for.body92.preheader.i
                                        #   in Loop: Header=BB13_30 Depth=1
	ld.w	$t5, $a0, 424
	.p2align	4, , 16
.LBB13_32:                              # %for.body92.i
