...
.LBB16_51:                              # %_ZN11CStringBaseIwE11SetCapacityEi.exit.for.cond.cleanup_crit_edge.i
	...
	move	$a0, $s0
	b	.LBB16_73
.LBB16_52:                              # %_ZN11CStringBaseIwE11SetCapacityEi.exit.for.cond.cleanup_crit_edge.i126
                                        #   in Loop: Header=BB16_2 Depth=1
	move	$a0, $s0
	b	.LBB16_85
.LBB16_53:                              # %if.then89
...
.Ltmp272:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp273:                               # EH_LABEL
# %bb.56:                               # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i186
                                        #   in Loop: Header=BB16_2 Depth=1
	move	$s7, $a0
	move	$a0, $s6
	pcaddu18i	$ra, %call36(_ZdaPv)
...
.LBB16_59:                              #   in Loop: Header=BB16_2 Depth=1
	move	$a3, $zero
	ld.d	$s1, $sp, 32                    # 8-byte Folded Reload
.LBB16_60:                              # %for.body.i195.preheader
                                        #   in Loop: Header=BB16_2 Depth=1
	sub.d	$a4, $a1, $a3
	slli.d	$a3, $a3, 2
	.p2align	4, , 16
.LBB16_61:                              # %for.body.i195
                                        #   Parent Loop BB16_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.w	$a5, $a2, $a3
	stx.w	$a5, $a0, $a3
	...
	bnez	$a4, .LBB16_61
	b	.LBB16_120
.LBB16_62:                              # %vector.main.loop.iter.check292
                                        #   in Loop: Header=BB16_2 Depth=1
	ori	$a2, $zero, 17
	bgeu	$s2, $a2, .LBB16_66
# %bb.63:                               #   in Loop: Header=BB16_2 Depth=1
	move	$a2, $zero
	b	.LBB16_70
.LBB16_64:                              # %vector.main.loop.iter.check323
                                        #   in Loop: Header=BB16_2 Depth=1
	ori	$a2, $zero, 17
	bgeu	$s2, $a2, .LBB16_78
...
.LBB16_67:                              # %vector.body296
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB16_67
# %bb.68:                               # %middle.block301
                                        #   in Loop: Header=BB16_2 Depth=1
	beq	$a2, $a0, .LBB16_73
# %bb.69:                               # %vec.epilog.iter.check305
                                        #   in Loop: Header=BB16_2 Depth=1
	beqz	$a3, .LBB16_33
.LBB16_70:                              # %vec.epilog.ph307
                                        #   in Loop: Header=BB16_2 Depth=1
	move	$a4, $a2
	...
	slli.d	$a4, $a4, 2
	.p2align	4, , 16
.LBB16_71:                              # %vec.epilog.vector.body310
                                        #   Parent Loop BB16_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vldx	$vr0, $a1, $a4
	vstx	$vr0, $s6, $a4
	...
	addi.d	$a4, $a4, 16
	bnez	$a3, .LBB16_71
# %bb.72:                               # %vec.epilog.middle.block314
                                        #   in Loop: Header=BB16_2 Depth=1
	bne	$a2, $a0, .LBB16_33
	.p2align	4, , 16
.LBB16_73:                              # %invoke.cont13
                                        #   in Loop: Header=BB16_2 Depth=1
	slli.d	$a0, $a0, 2
	stx.w	$zero, $s6, $a0
	st.w	$s0, $sp, 104
...
# %bb.74:                               # %invoke.cont15
	...
	ld.d	$a0, $sp, 96
	beqz	$a0, .LBB16_76
# %bb.75:                               # %delete.notnull.i
                                        #   in Loop: Header=BB16_2 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB16_76:                              # %_ZN11CStringBaseIwED2Ev.exit
                                        #   in Loop: Header=BB16_2 Depth=1
	bnez	$s5, .LBB16_107
# %bb.77:                               # %cleanup.cont
                                        #   in Loop: Header=BB16_2 Depth=1
...
.LBB16_79:                              # %vector.body327
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB16_79
# %bb.80:                               # %middle.block332
                                        #   in Loop: Header=BB16_2 Depth=1
	beq	$a2, $a0, .LBB16_85
# %bb.81:                               # %vec.epilog.iter.check336
                                        #   in Loop: Header=BB16_2 Depth=1
	beqz	$a3, .LBB16_40
.LBB16_82:                              # %vec.epilog.ph338
                                        #   in Loop: Header=BB16_2 Depth=1
	move	$a4, $a2
	bstrpick.d	$a2, $a0, 30, 2
	slli.d	$a2, $a2, 2
	...
	slli.d	$a4, $a4, 2
	.p2align	4, , 16
.LBB16_83:                              # %vec.epilog.vector.body341
                                        #   Parent Loop BB16_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vldx	$vr0, $a1, $a4
	vstx	$vr0, $s6, $a4
	...
	addi.d	$a4, $a4, 16
	bnez	$a3, .LBB16_83
# %bb.84:                               # %vec.epilog.middle.block345
                                        #   in Loop: Header=BB16_2 Depth=1
	bne	$a2, $a0, .LBB16_40
	.p2align	4, , 16
.LBB16_85:                              # %invoke.cont33
                                        #   in Loop: Header=BB16_2 Depth=1
	slli.d	$a0, $a0, 2
	stx.w	$zero, $s6, $a0
	st.w	$s0, $sp, 104
...
# %bb.86:                               # %invoke.cont35
	...
	ld.d	$a0, $sp, 96
	beqz	$a0, .LBB16_88
# %bb.87:                               # %delete.notnull.i55
                                        #   in Loop: Header=BB16_2 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB16_88:                              # %_ZN11CStringBaseIwED2Ev.exit56
                                        #   in Loop: Header=BB16_2 Depth=1
	bnez	$s5, .LBB16_107
# %bb.89:                               # %cleanup.cont44
                                        #   in Loop: Header=BB16_2 Depth=1
	ld.w	$a0, $sp, 116
	ld.d	$a1, $sp, 48                    # 8-byte Folded Reload
	st.w	$a0, $a1, 80
...
# %bb.92:                               #   in Loop: Header=BB16_2 Depth=1
	move	$a3, $zero
	b	.LBB16_100
.LBB16_93:                              # %_ZN11CStringBaseIwE11SetCapacityEi.exit.for.cond.cleanup_crit_edge.i188
                                        #   in Loop: Header=BB16_2 Depth=1
	move	$a1, $s0
	ld.d	$s4, $sp, 40                    # 8-byte Folded Reload
	ld.d	$s1, $sp, 32                    # 8-byte Folded Reload
	b	.LBB16_120
.LBB16_94:                              # %vector.main.loop.iter.check261
                                        #   in Loop: Header=BB16_2 Depth=1
	ori	$a3, $zero, 16
	ld.d	$s1, $sp, 32                    # 8-byte Folded Reload
	bgeu	$s0, $a3, .LBB16_113
...
.LBB16_100:                             # %vec.epilog.ph
	...
	slli.d	$a5, $a5, 2
	.p2align	4, , 16
.LBB16_101:                             # %vec.epilog.vector.body
                                        #   Parent Loop BB16_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vldx	$vr0, $a2, $a5
	vstx	$vr0, $a0, $a5
...
.Ltmp284:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp285:                               # EH_LABEL
# %bb.104:                              # %invoke.cont65
                                        #   in Loop: Header=BB16_2 Depth=1
	move	$s5, $a0
	ld.d	$a0, $sp, 96
	beqz	$a0, .LBB16_106
# %bb.105:                              # %delete.notnull.i70
                                        #   in Loop: Header=BB16_2 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB16_106:                             # %_ZN11CStringBaseIwED2Ev.exit71
                                        #   in Loop: Header=BB16_2 Depth=1
	beqz	$s5, .LBB16_112
	.p2align	4, , 16
.LBB16_107:                             # %cleanup112.critedge42
                                        #   in Loop: Header=BB16_2 Depth=1
	move	$s0, $zero
	move	$s3, $s5
.LBB16_108:                             # %cleanup114
                                        #   in Loop: Header=BB16_2 Depth=1
	ld.d	$a0, $sp, 120
	beqz	$a0, .LBB16_110
# %bb.109:                              # %delete.notnull.i99
                                        #   in Loop: Header=BB16_2 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB16_110:                             # %_ZN11CStringBaseIwED2Ev.exit100
                                        #   in Loop: Header=BB16_2 Depth=1
	beqz	$s0, .LBB16_125
# %bb.111:                              # %for.cond
                                        #   in Loop: Header=BB16_2 Depth=1
...
.LBB16_114:                             # %vector.body265
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB16_114
# %bb.115:                              # %middle.block270
                                        #   in Loop: Header=BB16_2 Depth=1
	beq	$a3, $a1, .LBB16_120
# %bb.116:                              # %vec.epilog.iter.check274
                                        #   in Loop: Header=BB16_2 Depth=1
	beqz	$a5, .LBB16_60
.LBB16_117:                             # %vec.epilog.ph276
                                        #   in Loop: Header=BB16_2 Depth=1
	move	$a5, $a3
	bstrpick.d	$a3, $a1, 30, 2
	slli.d	$a3, $a3, 2
	...
	slli.d	$a5, $a5, 2
	.p2align	4, , 16
.LBB16_118:                             # %vec.epilog.vector.body279
                                        #   Parent Loop BB16_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vldx	$vr0, $a2, $a5
	vstx	$vr0, $a0, $a5
	...
	addi.d	$a5, $a5, 16
	bnez	$a4, .LBB16_118
# %bb.119:                              # %vec.epilog.middle.block283
                                        #   in Loop: Header=BB16_2 Depth=1
	bne	$a3, $a1, .LBB16_60
.LBB16_120:                             # %invoke.cont93
                                        #   in Loop: Header=BB16_2 Depth=1
	slli.d	$a1, $a1, 2
	stx.w	$zero, $a0, $a1
	st.w	$s0, $sp, 104
.Ltmp275:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp276:                               # EH_LABEL
# %bb.121:                              # %invoke.cont96
                                        #   in Loop: Header=BB16_2 Depth=1
	move	$s5, $a0
	ld.d	$a0, $sp, 96
	beqz	$a0, .LBB16_123
# %bb.122:                              # %delete.notnull.i90
                                        #   in Loop: Header=BB16_2 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB16_123:                             # %_ZN11CStringBaseIwED2Ev.exit91
                                        #   in Loop: Header=BB16_2 Depth=1
	sltui	$s0, $s5, 1
	masknez	$a0, $s5, $s0
	maskeqz	$a1, $s3, $s0
...
.LBB16_125:                             # %cleanup120
	...
	addi.d	$sp, $sp, 224
	ret
.LBB16_126:                             # %_ZN11CStringBaseIwED2Ev.exit.i185
.Ltmp274:                               # EH_LABEL
	move	$fp, $a0
	move	$a0, $s6
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	b	.LBB16_146
.LBB16_127:                             # %_ZN11CStringBaseIwED2Ev.exit.i154
.Ltmp283:                               # EH_LABEL
	move	$fp, $a0
	move	$a0, $s6
	pcaddu18i	$ra, %call36(_ZdaPv)
...
.Ltmp280:                               # EH_LABEL
	b	.LBB16_145
.LBB16_132:                             # %_ZN11CStringBaseIwED2Ev.exit.i123
.Ltmp244:                               # EH_LABEL
	move	$fp, $a0
	move	$a0, $s7
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	b	.LBB16_146
.LBB16_133:                             # %_ZN11CStringBaseIwED2Ev.exit.i
.Ltmp253:                               # EH_LABEL
	move	$fp, $a0
	move	$a0, $s7
	pcaddu18i	$ra, %call36(_ZdaPv)
...
.LBB16_144:                             # %lpad
.Ltmp238:                               # EH_LABEL
.LBB16_145:                             # %ehcleanup115
	move	$fp, $a0
.LBB16_146:                             # %ehcleanup115
	ld.d	$a0, $sp, 120
	beqz	$a0, .LBB16_148
# %bb.147:                              # %delete.notnull.i102
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB16_148:                             # %_ZN11CStringBaseIwED2Ev.exit103
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.Lfunc_end16:
