...
.LBB16_63:                              # %vector.body270
	...
	addi.d	$a2, $a2, 32
	bnez	$a3, .LBB16_63
# %bb.64:                               # %middle.block275
                                        #   in Loop: Header=BB16_2 Depth=1
	bne	$a1, $a0, .LBB16_33
	.p2align	4, , 16
.LBB16_65:                              # %invoke.cont13
                                        #   in Loop: Header=BB16_2 Depth=1
	slli.d	$a0, $a0, 2
	stx.w	$zero, $s6, $a0
	st.w	$s2, $sp, 88
...
.LBB16_71:                              # %vector.body285
	...
	addi.d	$a2, $a2, 32
	bnez	$a3, .LBB16_71
# %bb.72:                               # %middle.block290
                                        #   in Loop: Header=BB16_2 Depth=1
	bne	$a1, $a0, .LBB16_40
	.p2align	4, , 16
.LBB16_73:                              # %invoke.cont33
                                        #   in Loop: Header=BB16_2 Depth=1
	slli.d	$a0, $a0, 2
	stx.w	$zero, $s6, $a0
	st.w	$s2, $sp, 88
...
# %bb.74:                               # %invoke.cont35
	...
	ld.d	$a0, $sp, 80
	beqz	$a0, .LBB16_76
# %bb.75:                               # %delete.notnull.i55
                                        #   in Loop: Header=BB16_2 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB16_76:                              # %_ZN11CStringBaseIwED2Ev.exit56
                                        #   in Loop: Header=BB16_2 Depth=1
	bnez	$s5, .LBB16_86
# %bb.77:                               # %cleanup.cont44
                                        #   in Loop: Header=BB16_2 Depth=1
	ld.w	$a0, $sp, 100
	ld.d	$a1, $sp, 32                    # 8-byte Folded Reload
	st.w	$a0, $a1, 80
	...
	bnez	$a0, .LBB16_96
	b	.LBB16_97
.LBB16_78:                              # %_ZN11CStringBaseIwE11SetCapacityEi.exit.for.cond.cleanup_crit_edge.i157
                                        #   in Loop: Header=BB16_2 Depth=1
	move	$a1, $s0
	ld.d	$s8, $sp, 24                    # 8-byte Folded Reload
	b	.LBB16_82
...
# %bb.83:                               # %invoke.cont65
	...
	ld.d	$a0, $sp, 80
	beqz	$a0, .LBB16_85
# %bb.84:                               # %delete.notnull.i70
                                        #   in Loop: Header=BB16_2 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB16_85:                              # %_ZN11CStringBaseIwED2Ev.exit71
                                        #   in Loop: Header=BB16_2 Depth=1
	beqz	$s5, .LBB16_87
	.p2align	4, , 16
.LBB16_86:                              # %cleanup112.critedge42
                                        #   in Loop: Header=BB16_2 Depth=1
	move	$s0, $zero
	move	$s3, $s5
	ld.d	$a0, $sp, 104
...
.LBB16_87:                              # %cleanup.cont74
	...
	bnez	$a0, .LBB16_96
	b	.LBB16_97
.LBB16_88:                              # %_ZN11CStringBaseIwE11SetCapacityEi.exit.for.cond.cleanup_crit_edge.i188
                                        #   in Loop: Header=BB16_2 Depth=1
	move	$a1, $s0
	ld.d	$s8, $sp, 24                    # 8-byte Folded Reload
	b	.LBB16_92
.LBB16_89:                              # %vector.ph252
                                        #   in Loop: Header=BB16_2 Depth=1
	bstrpick.d	$a3, $a1, 30, 3
	slli.d	$a3, $a3, 3
	move	$a4, $zero
...
.LBB16_90:                              # %vector.body255
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB16_90
# %bb.91:                               # %middle.block260
                                        #   in Loop: Header=BB16_2 Depth=1
	bne	$a3, $a1, .LBB16_60
.LBB16_92:                              # %invoke.cont93
                                        #   in Loop: Header=BB16_2 Depth=1
	slli.d	$a1, $a1, 2
	stx.w	$zero, $a0, $a1
	st.w	$s0, $sp, 88
...
# %bb.93:                               # %invoke.cont96
	...
	ld.d	$a0, $sp, 80
	beqz	$a0, .LBB16_95
# %bb.94:                               # %delete.notnull.i90
                                        #   in Loop: Header=BB16_2 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB16_95:                              # %_ZN11CStringBaseIwED2Ev.exit91
                                        #   in Loop: Header=BB16_2 Depth=1
	sltui	$s0, $s5, 1
	masknez	$a0, $s5, $s0
	maskeqz	$a1, $s3, $s0
	...
	beqz	$a0, .LBB16_97
	.p2align	4, , 16
.LBB16_96:                              # %delete.notnull.i99
                                        #   in Loop: Header=BB16_2 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB16_97:                              # %_ZN11CStringBaseIwED2Ev.exit100
                                        #   in Loop: Header=BB16_2 Depth=1
	beqz	$s0, .LBB16_100
# %bb.98:                               # %for.cond
                                        #   in Loop: Header=BB16_2 Depth=1
...
.LBB16_100:                             # %cleanup120
	...
	addi.d	$sp, $sp, 208
	ret
.LBB16_101:                             # %_ZN11CStringBaseIwED2Ev.exit.i185
.Ltmp274:                               # EH_LABEL
	move	$fp, $a0
	move	$a0, $s6
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	b	.LBB16_121
.LBB16_102:                             # %_ZN11CStringBaseIwED2Ev.exit.i154
.Ltmp283:                               # EH_LABEL
	move	$fp, $a0
	move	$a0, $s6
	pcaddu18i	$ra, %call36(_ZdaPv)
...
.Ltmp280:                               # EH_LABEL
	b	.LBB16_120
.LBB16_107:                             # %_ZN11CStringBaseIwED2Ev.exit.i123
.Ltmp244:                               # EH_LABEL
	move	$fp, $a0
	move	$a0, $s7
	pcaddu18i	$ra, %call36(_ZdaPv)
...
.LBB16_119:                             # %lpad
.Ltmp238:                               # EH_LABEL
.LBB16_120:                             # %ehcleanup115
	move	$fp, $a0
.LBB16_121:                             # %ehcleanup115
	ld.d	$a0, $sp, 104
	beqz	$a0, .LBB16_123
# %bb.122:                              # %delete.notnull.i102
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB16_123:                             # %_ZN11CStringBaseIwED2Ev.exit103
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.Lfunc_end16:
