...
.LBB16_71:                              # %for.body.i195
	...
	bnez	$a4, .LBB16_71
	b	.LBB16_104
.LBB16_72:                              # %vector.main.loop.iter.check293
                                        #   in Loop: Header=BB16_2 Depth=1
	ori	$a2, $zero, 17
	bgeu	$s8, $a2, .LBB16_76
# %bb.73:                               #   in Loop: Header=BB16_2 Depth=1
	move	$a2, $zero
	b	.LBB16_80
.LBB16_74:                              # %vector.main.loop.iter.check325
                                        #   in Loop: Header=BB16_2 Depth=1
	ori	$a2, $zero, 17
	bgeu	$s8, $a2, .LBB16_83
...
.LBB16_77:                              # %vector.body297
	...
	addi.d	$a3, $a3, 64
	bnez	$a4, .LBB16_77
# %bb.78:                               # %middle.block302
                                        #   in Loop: Header=BB16_2 Depth=1
	beq	$a2, $a0, .LBB16_52
# %bb.79:                               # %vec.epilog.iter.check307
                                        #   in Loop: Header=BB16_2 Depth=1
	andi	$a3, $a0, 12
	beqz	$a3, .LBB16_33
.LBB16_80:                              # %vec.epilog.ph306
                                        #   in Loop: Header=BB16_2 Depth=1
	move	$a4, $a2
	...
	slli.d	$a4, $a4, 2
	.p2align	4, , 16
.LBB16_81:                              # %vec.epilog.vector.body312
                                        #   Parent Loop BB16_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vldx	$vr0, $a1, $a4
	vstx	$vr0, $s6, $a4
	...
	addi.d	$a4, $a4, 16
	bnez	$a3, .LBB16_81
# %bb.82:                               # %vec.epilog.middle.block316
                                        #   in Loop: Header=BB16_2 Depth=1
	bne	$a2, $a0, .LBB16_33
	b	.LBB16_52
.LBB16_83:                              # %vector.ph326
                                        #   in Loop: Header=BB16_2 Depth=1
	bstrpick.d	$a2, $a0, 30, 4
	slli.d	$a2, $a2, 4
	move	$a3, $zero
...
.LBB16_84:                              # %vector.body329
	...
	addi.d	$a3, $a3, 64
	bnez	$a4, .LBB16_84
# %bb.85:                               # %middle.block334
                                        #   in Loop: Header=BB16_2 Depth=1
	beq	$a2, $a0, .LBB16_58
# %bb.86:                               # %vec.epilog.iter.check339
                                        #   in Loop: Header=BB16_2 Depth=1
	andi	$a3, $a0, 12
	beqz	$a3, .LBB16_40
.LBB16_87:                              # %vec.epilog.ph338
                                        #   in Loop: Header=BB16_2 Depth=1
	move	$a4, $a2
	bstrpick.d	$a2, $a0, 30, 2
	slli.d	$a2, $a2, 2
	...
	slli.d	$a4, $a4, 2
	.p2align	4, , 16
.LBB16_88:                              # %vec.epilog.vector.body344
                                        #   Parent Loop BB16_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vldx	$vr0, $a1, $a4
	vstx	$vr0, $s6, $a4
	...
	addi.d	$a4, $a4, 16
	bnez	$a3, .LBB16_88
# %bb.89:                               # %vec.epilog.middle.block348
                                        #   in Loop: Header=BB16_2 Depth=1
	bne	$a2, $a0, .LBB16_40
	b	.LBB16_58
...
.LBB16_107:                             # %_ZN11CStringBaseIwED2Ev.exit91
	...
	st.d	$a0, $sp, 72                    # 8-byte Folded Spill
	b	.LBB16_96
.LBB16_108:                             # %vector.main.loop.iter.check261
                                        #   in Loop: Header=BB16_2 Depth=1
	ori	$a3, $zero, 16
...
.LBB16_118:                             # %vector.body265
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB16_118
# %bb.119:                              # %middle.block270
                                        #   in Loop: Header=BB16_2 Depth=1
	beq	$a3, $a1, .LBB16_104
# %bb.120:                              # %vec.epilog.iter.check275
                                        #   in Loop: Header=BB16_2 Depth=1
	andi	$a4, $a1, 12
	beqz	$a4, .LBB16_70
.LBB16_121:                             # %vec.epilog.ph274
                                        #   in Loop: Header=BB16_2 Depth=1
	move	$a5, $a3
	bstrpick.d	$a3, $a1, 30, 2
	slli.d	$a3, $a3, 2
	...
	slli.d	$a5, $a5, 2
	.p2align	4, , 16
.LBB16_122:                             # %vec.epilog.vector.body280
                                        #   Parent Loop BB16_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vldx	$vr0, $a2, $a5
	vstx	$vr0, $a0, $a5
	...
	addi.d	$a5, $a5, 16
	bnez	$a4, .LBB16_122
# %bb.123:                              # %vec.epilog.middle.block284
                                        #   in Loop: Header=BB16_2 Depth=1
	bne	$a3, $a1, .LBB16_70
	b	.LBB16_104
.LBB16_124:
