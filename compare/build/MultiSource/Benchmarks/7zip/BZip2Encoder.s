...
# %bb.48:                               #   in Loop: Header=BB29_41 Depth=2
	...
	b	.LBB29_59
	.p2align	4, , 16
.LBB29_49:                              # %vector.main.loop.iter.check633
                                        #   in Loop: Header=BB29_41 Depth=2
...
# %bb.50:                               #   in Loop: Header=BB29_41 Depth=2
	move	$t7, $zero
.LBB29_51:                              # %vec.epilog.ph648
                                        #   in Loop: Header=BB29_41 Depth=2
	bstrpick.d	$a6, $ra, 32, 4
	slli.d	$t6, $a6, 4
	sub.d	$s4, $s8, $t6
	sub.d	$a6, $t7, $t6
	sub.d	$t7, $s8, $t7
	add.d	$t7, $a7, $t7
	.p2align	4, , 16
.LBB29_52:                              # %vec.epilog.vector.body651
                                        #   Parent Loop BB29_40 Depth=1
                                        #     Parent Loop BB29_41 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vld	$vr0, $t7, 0
	...
	addi.d	$t7, $t7, -16
	bnez	$a6, .LBB29_52
# %bb.53:                               # %vec.epilog.middle.block657
                                        #   in Loop: Header=BB29_41 Depth=2
	bne	$ra, $t6, .LBB29_59
	b	.LBB29_61
.LBB29_54:                              # %vector.ph634
                                        #   in Loop: Header=BB29_41 Depth=2
	andi	$s4, $ra, 16
	bstrpick.d	$a6, $ra, 32, 5
	slli.d	$t7, $a6, 5
	addi.d	$a6, $sp, 1480
	add.d	$a6, $a6, $s8
	move	$t6, $t7
	.p2align	4, , 16
.LBB29_55:                              # %vector.body637
                                        #   Parent Loop BB29_40 Depth=1
                                        #     Parent Loop BB29_41 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	xvld	$xr0, $a6, 0
	...
	addi.d	$a6, $a6, -32
	bnez	$t6, .LBB29_55
# %bb.56:                               # %middle.block642
                                        #   in Loop: Header=BB29_41 Depth=2
	beq	$ra, $t7, .LBB29_61
# %bb.57:                               # %vec.epilog.iter.check646
                                        #   in Loop: Header=BB29_41 Depth=2
	bnez	$s4, .LBB29_51
...
.LBB29_67:                              # %if.end109.thread
	...
	bne	$a1, $a5, .LBB29_40
	b	.LBB29_70
.LBB29_68:                              # %while.cond112.preheader
	beqz	$s5, .LBB29_70
	.p2align	4, , 16
.LBB29_69:                              # %while.body114
                                        # =>This Inner Loop Header: Depth=1
	addi.w	$a1, $s5, -1
	andi	$a2, $a1, 1
	...
	addi.w	$a0, $a0, 1
	addi.d	$a3, $a3, 1
	bstrpick.d	$s5, $a1, 31, 1
	st.w	$a3, $a2, 0
	bnez	$s5, .LBB29_69
.LBB29_70:                              # %while.end126
	addi.w	$t6, $s3, 2
	ori	$s4, $zero, 1
	ori	$a4, $zero, 254
	ori	$a3, $zero, 1
...
.LBB29_72:                              # %iter.check661
	...
	xvst	$xr16, $sp, 48                  # 32-byte Folded Spill
	xvst	$xr17, $sp, 16                  # 32-byte Folded Spill
	b	.LBB29_74
	.p2align	4, , 16
.LBB29_73:                              # %for.inc493
...
.LBB29_76:                              # %if.end192
	...
	b	.LBB29_78
	.p2align	4, , 16
.LBB29_77:                              # %if.end.i.i245
                                        #   in Loop: Header=BB29_78 Depth=2
	sll.w	$a2, $a5, $a4
	sub.d	$a3, $a3, $a2
	move	$a2, $a6
	blez	$a4, .LBB29_80
.LBB29_78:                              # %while.body.i.i227
...
# %bb.79:                               # %if.then.i.i241
	...
	b	.LBB29_77
	.p2align	4, , 16
.LBB29_80:                              # %_ZN9NCompress6NBZip211CThreadInfo10WriteBits2Ejj.exit247
                                        #   in Loop: Header=BB29_74 Depth=1
	ld.d	$a1, $fp, 32
	ld.w	$a4, $a1, 4
	ori	$a3, $zero, 15
	...
	b	.LBB29_82
	.p2align	4, , 16
.LBB29_81:                              # %if.end.i.i271
                                        #   in Loop: Header=BB29_82 Depth=2
	sll.w	$a4, $a5, $a3
	sub.d	$a2, $a2, $a4
	move	$a4, $a6
	blez	$a3, .LBB29_84
.LBB29_82:                              # %while.body.i.i253
                                        #   Parent Loop BB29_74 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$t0, $a3
	slt	$a3, $a3, $a4
...
# %bb.87:                               #   in Loop: Header=BB29_86 Depth=2
	...
	b	.LBB29_90
	.p2align	4, , 16
.LBB29_88:                              # %while.body199.preheader
                                        #   in Loop: Header=BB29_86 Depth=2
	div.wu	$a6, $t0, $a7
	alsl.d	$t0, $a4, $t7, 2
	move	$a7, $a4
	.p2align	4, , 16
.LBB29_89:                              # %while.body199
                                        #   Parent Loop BB29_74 Depth=1
...
.LBB29_96:                              # %if.then214
	...
	blt	$t6, $s3, .LBB29_95
	.p2align	4, , 16
.LBB29_97:                              # %vector.main.loop.iter.check792
                                        #   in Loop: Header=BB29_86 Depth=2
...
.LBB29_99:                              # %vector.ph793
	...
	move	$t1, $s0
	.p2align	4, , 16
.LBB29_100:                             # %vector.body800
                                        #   Parent Loop BB29_74 Depth=1
                                        #     Parent Loop BB29_86 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	xvslt.d	$xr10, $xr9, $xr0
	...
	vpickve2gr.h	$t2, $vr10, 2
	vinsgr2vr.h	$vr11, $t2, 5
	vpickve2gr.h	$t2, $vr10, 4
	vinsgr2vr.h	$vr11, $t2, 6
	vpickve2gr.h	$t2, $vr10, 6
	vinsgr2vr.h	$vr11, $t2, 7
	xvslt.d	$xr10, $xr7, $xr0
	xvpermi.q	$xr12, $xr10, 1
	vpickev.w	$vr10, $vr12, $vr10
	xvslt.d	$xr12, $xr6, $xr0
	...
	vpickve2gr.b	$t2, $vr11, 0
	vinsgr2vr.b	$vr10, $t2, 0
	vpickve2gr.b	$t2, $vr11, 2
	vinsgr2vr.b	$vr10, $t2, 1
	vpickve2gr.b	$t2, $vr11, 4
	vinsgr2vr.b	$vr10, $t2, 2
	vpickve2gr.b	$t2, $vr11, 6
	vinsgr2vr.b	$vr10, $t2, 3
	vpickve2gr.b	$t2, $vr11, 8
	vinsgr2vr.b	$vr10, $t2, 4
	vpickve2gr.b	$t2, $vr11, 10
	vinsgr2vr.b	$vr10, $t2, 5
	vpickve2gr.b	$t2, $vr11, 12
	vinsgr2vr.b	$vr10, $t2, 6
	vpickve2gr.b	$t2, $vr11, 14
	...
	xvpermi.d	$xr12, $xr12, 14
	vpickve2gr.h	$t2, $vr12, 0
	vinsgr2vr.h	$vr13, $t2, 4
	vpickve2gr.h	$t2, $vr12, 2
	vinsgr2vr.h	$vr13, $t2, 5
	vpickve2gr.h	$t2, $vr12, 4
	vinsgr2vr.h	$vr13, $t2, 6
	vpickve2gr.h	$t2, $vr12, 6
	vinsgr2vr.h	$vr13, $t2, 7
	...
	vpickve2gr.h	$t2, $vr11, 6
	vinsgr2vr.h	$vr12, $t2, 7
	xvsle.d	$xr11, $xr1, $xr7
	xvpermi.q	$xr13, $xr11, 1
	vpickev.w	$vr11, $vr13, $vr11
	xvsle.d	$xr13, $xr1, $xr6
	xvpermi.q	$xr14, $xr13, 1
	vpickev.w	$vr13, $vr14, $vr13
	xvpermi.q	$xr11, $xr13, 2
	vpickve2gr.h	$t2, $vr11, 0
	...
	vpickve2gr.h	$t2, $vr13, 6
	vinsgr2vr.h	$vr12, $t2, 7
	xvsle.d	$xr13, $xr1, $xr3
	xvpermi.q	$xr14, $xr13, 1
	vpickev.w	$vr13, $vr14, $vr13
	xvsle.d	$xr14, $xr1, $xr2
...
# %bb.102:                              # %vec.epilog.iter.check809
	...
	move	$t1, $s0
	beqz	$ra, .LBB29_106
.LBB29_103:                             # %vec.epilog.ph811
                                        #   in Loop: Header=BB29_86 Depth=2
	xvld	$xr2, $a7, %pc_lo12(.LCPI29_7)
	xvreplgr2vr.d	$xr3, $t0
	xvor.v	$xr2, $xr3, $xr2
	.p2align	4, , 16
.LBB29_104:                             # %vec.epilog.vector.body821
                                        #   Parent Loop BB29_74 Depth=1
                                        #     Parent Loop BB29_86 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	xvslt.d	$xr3, $xr2, $xr0
	...
	xvaddi.du	$xr2, $xr2, 4
	bne	$t3, $t0, .LBB29_104
# %bb.105:                              # %vec.epilog.middle.block826
                                        #   in Loop: Header=BB29_86 Depth=2
	move	$t1, $t3
	beq	$t3, $t8, .LBB29_85
	.p2align	4, , 16
.LBB29_106:                             # %do.body224
                                        #   Parent Loop BB29_74 Depth=1
                                        #     Parent Loop BB29_86 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	slt	$a7, $t1, $a4
	...
	b	.LBB29_85
	.p2align	4, , 16
.LBB29_107:                             # %do.body244.preheader.preheader
                                        #   in Loop: Header=BB29_74 Depth=1
	move	$a2, $zero
	slt	$a0, $s4, $t4
	masknez	$a1, $s4, $a0
...
.LBB29_108:                             # %do.end357
	...
	ori	$s3, $zero, 4
	beq	$a2, $s3, .LBB29_156
.LBB29_109:                             # %do.body244.preheader
                                        #   Parent Loop BB29_74 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB29_110 Depth 3
                                        #         Child Loop BB29_113 Depth 4
...
.LBB29_110:                             # %do.body252
	...
	b	.LBB29_113
	.p2align	4, , 16
.LBB29_111:                             # %if.then260
                                        #   in Loop: Header=BB29_113 Depth=4
...
.LBB29_112:                             # %if.end266
	...
	addi.d	$a7, $a2, 1
	move	$a6, $a4
	bgeu	$a1, $s6, .LBB29_115
.LBB29_113:                             # %do.body254
                                        #   Parent Loop BB29_74 Depth=1
                                        #     Parent Loop BB29_109 Depth=2
...
.LBB29_115:                             # %do.body278.preheader
...
.LBB29_117:                             # %do.body278
	...
	alsl.d	$t2, $a6, $t2, 1
	add.d	$t2, $s7, $t2
	bgeu	$a3, $s8, .LBB29_119
# %bb.118:                              #   in Loop: Header=BB29_117 Depth=4
	move	$t4, $zero
	move	$t3, $zero
	b	.LBB29_122
	.p2align	4, , 16
.LBB29_119:                             # %vector.body775.preheader
                                        #   in Loop: Header=BB29_117 Depth=4
	addi.d	$t3, $sp, 296
	move	$t4, $t0
	vori.b	$vr0, $vr6, 0
...
# %bb.121:                              # %middle.block782
	...
	addi.d	$t7, $sp, 280
	beq	$a4, $a7, .LBB29_124
.LBB29_122:                             # %do.body284.preheader
                                        #   in Loop: Header=BB29_117 Depth=4
	alsl.d	$t5, $t4, $t7, 2
	.p2align	4, , 16
.LBB29_123:                             # %do.body284
                                        #   Parent Loop BB29_74 Depth=1
                                        #     Parent Loop BB29_109 Depth=2
                                        #       Parent Loop BB29_110 Depth=3
                                        #         Parent Loop BB29_117 Depth=4
...
# %bb.128:                              # %do.end323
	...
	ori	$t0, $zero, 255
	ori	$t1, $zero, 48
	bltu	$a1, $s6, .LBB29_110
# %bb.129:                              # %do.body328.preheader
                                        #   in Loop: Header=BB29_109 Depth=2
	move	$s3, $zero
	addi.d	$s1, $fp, 1588
	b	.LBB29_131
...
# %bb.132:                              #   in Loop: Header=BB29_131 Depth=3
	...
	b	.LBB29_152
	.p2align	4, , 16
.LBB29_133:                             # %vector.body749.preheader
                                        #   in Loop: Header=BB29_131 Depth=3
	...
	b	.LBB29_135
	.p2align	4, , 16
.LBB29_134:                             # %pred.store.continue765
                                        #   in Loop: Header=BB29_135 Depth=4
	addi.d	$a0, $a0, -8
	addi.d	$a1, $a1, 32
	beqz	$a0, .LBB29_151
.LBB29_135:                             # %vector.body749
                                        #   Parent Loop BB29_74 Depth=1
                                        #     Parent Loop BB29_109 Depth=2
...
.LBB29_137:                             # %pred.store.continue
	...
	andi	$a2, $a2, 1
	beqz	$a2, .LBB29_144
# %bb.138:                              # %pred.store.if752
                                        #   in Loop: Header=BB29_135 Depth=4
	st.w	$s4, $a1, 4
	vpickve2gr.h	$a2, $vr0, 2
	andi	$a2, $a2, 1
	bnez	$a2, .LBB29_145
.LBB29_139:                             # %pred.store.continue755
                                        #   in Loop: Header=BB29_135 Depth=4
	vpickve2gr.h	$a2, $vr0, 3
	andi	$a2, $a2, 1
	beqz	$a2, .LBB29_146
.LBB29_140:                             # %pred.store.if756
                                        #   in Loop: Header=BB29_135 Depth=4
	st.w	$s4, $a1, 12
	vpickve2gr.h	$a2, $vr0, 4
	andi	$a2, $a2, 1
	bnez	$a2, .LBB29_147
.LBB29_141:                             # %pred.store.continue759
                                        #   in Loop: Header=BB29_135 Depth=4
	vpickve2gr.h	$a2, $vr0, 5
	andi	$a2, $a2, 1
	beqz	$a2, .LBB29_148
.LBB29_142:                             # %pred.store.if760
                                        #   in Loop: Header=BB29_135 Depth=4
	st.w	$s4, $a1, 20
	vpickve2gr.h	$a2, $vr0, 6
	andi	$a2, $a2, 1
	bnez	$a2, .LBB29_149
.LBB29_143:                             # %pred.store.continue763
                                        #   in Loop: Header=BB29_135 Depth=4
	...
	b	.LBB29_150
	.p2align	4, , 16
.LBB29_144:                             # %pred.store.continue753
                                        #   in Loop: Header=BB29_135 Depth=4
	vpickve2gr.h	$a2, $vr0, 2
	andi	$a2, $a2, 1
	beqz	$a2, .LBB29_139
.LBB29_145:                             # %pred.store.if754
                                        #   in Loop: Header=BB29_135 Depth=4
	st.w	$s4, $a1, 8
	vpickve2gr.h	$a2, $vr0, 3
	andi	$a2, $a2, 1
	bnez	$a2, .LBB29_140
.LBB29_146:                             # %pred.store.continue757
                                        #   in Loop: Header=BB29_135 Depth=4
	vpickve2gr.h	$a2, $vr0, 4
	andi	$a2, $a2, 1
	beqz	$a2, .LBB29_141
.LBB29_147:                             # %pred.store.if758
                                        #   in Loop: Header=BB29_135 Depth=4
	st.w	$s4, $a1, 16
	vpickve2gr.h	$a2, $vr0, 5
	andi	$a2, $a2, 1
	bnez	$a2, .LBB29_142
.LBB29_148:                             # %pred.store.continue761
                                        #   in Loop: Header=BB29_135 Depth=4
	vpickve2gr.h	$a2, $vr0, 6
	andi	$a2, $a2, 1
	beqz	$a2, .LBB29_143
.LBB29_149:                             # %pred.store.if762
                                        #   in Loop: Header=BB29_135 Depth=4
	st.w	$s4, $a1, 24
	vpickve2gr.h	$a2, $vr0, 7
	andi	$a2, $a2, 1
	beqz	$a2, .LBB29_134
.LBB29_150:                             # %pred.store.if764
                                        #   in Loop: Header=BB29_135 Depth=4
	st.w	$s4, $a1, 28
	b	.LBB29_134
	.p2align	4, , 16
.LBB29_151:                             # %middle.block767
                                        #   in Loop: Header=BB29_131 Depth=3
	ld.d	$a0, $sp, 248                   # 8-byte Folded Reload
	move	$a1, $a0
	beq	$a0, $a3, .LBB29_130
.LBB29_152:                             # %do.body335.preheader
                                        #   in Loop: Header=BB29_131 Depth=3
	slli.d	$a0, $a1, 2
	sub.d	$a1, $a3, $a1
	b	.LBB29_154
	.p2align	4, , 16
.LBB29_153:                             # %do.cond343
                                        #   in Loop: Header=BB29_154 Depth=4
	addi.d	$a1, $a1, -1
	addi.d	$a0, $a0, 4
	beqz	$a1, .LBB29_130
.LBB29_154:                             # %do.body335
                                        #   Parent Loop BB29_74 Depth=1
                                        #     Parent Loop BB29_109 Depth=2
                                        #       Parent Loop BB29_131 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
...
# %bb.157:                              #   in Loop: Header=BB29_74 Depth=1
	...
	b	.LBB29_167
	.p2align	4, , 16
.LBB29_158:                             # %vector.main.loop.iter.check721
                                        #   in Loop: Header=BB29_74 Depth=1
	addi.d	$t7, $sp, 480
	ld.d	$s1, $sp, 144                   # 8-byte Folded Reload
	ld.d	$ra, $sp, 128                   # 8-byte Folded Reload
	xvld	$xr16, $sp, 48                  # 32-byte Folded Reload
	xvld	$xr17, $sp, 16                  # 32-byte Folded Reload
	ori	$a0, $zero, 64
	bge	$a1, $a0, .LBB29_160
...
.LBB29_160:                             # %vector.ph722
	...
	move	$a3, $a0
	.p2align	4, , 16
.LBB29_161:                             # %vector.body725
                                        #   Parent Loop BB29_74 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	xvadd.b	$xr1, $xr0, $xr16
	xvst	$xr0, $a2, -32
	xvst	$xr1, $a2, 0
	xvadd.b	$xr0, $xr0, $xr17
	addi.d	$a3, $a3, -64
	addi.d	$a2, $a2, 64
	bnez	$a3, .LBB29_161
# %bb.162:                              # %middle.block728
                                        #   in Loop: Header=BB29_74 Depth=1
	ld.d	$t8, $sp, 256                   # 8-byte Folded Reload
	addi.d	$a3, $sp, 280
	beq	$a0, $s0, .LBB29_168
# %bb.163:                              # %vec.epilog.iter.check732
                                        #   in Loop: Header=BB29_74 Depth=1
	beqz	$a1, .LBB29_167
.LBB29_164:                             # %vec.epilog.ph734
                                        #   in Loop: Header=BB29_74 Depth=1
	move	$a2, $a0
	...
	add.d	$a2, $a3, $a2
	.p2align	4, , 16
.LBB29_165:                             # %vec.epilog.vector.body737
                                        #   Parent Loop BB29_74 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr0, $a2, 0
	vaddi.bu	$vr0, $vr0, 16
	...
	addi.d	$a2, $a2, 16
	bnez	$a1, .LBB29_165
# %bb.166:                              # %vec.epilog.middle.block742
                                        #   in Loop: Header=BB29_74 Depth=1
	addi.d	$a3, $sp, 280
	beq	$a0, $s0, .LBB29_168
	.p2align	4, , 16
.LBB29_167:                             # %do.body362
                                        #   Parent Loop BB29_74 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	stx.b	$a0, $a0, $a3
	addi.d	$a0, $a0, 1
	bne	$s0, $a0, .LBB29_167
.LBB29_168:                             # %do.body371.preheader
                                        #   in Loop: Header=BB29_74 Depth=1
	addi.d	$t6, $sp, 280
	ld.bu	$a0, $sp, 280
	move	$a1, $zero
	b	.LBB29_170
	.p2align	4, , 16
.LBB29_169:                             # %for.end396
                                        #   in Loop: Header=BB29_170 Depth=2
	addi.d	$t6, $sp, 280
	addi.d	$a1, $a1, 1
	st.b	$a0, $sp, 280
	beq	$a1, $s1, .LBB29_197
.LBB29_170:                             # %do.body371
                                        #   Parent Loop BB29_74 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB29_182 Depth 3
                                        #         Child Loop BB29_184 Depth 4
...
.LBB29_172:                             # %for.end385
	...
	b	.LBB29_174
	.p2align	4, , 16
.LBB29_173:                             # %if.end.i.i.i323
                                        #   in Loop: Header=BB29_174 Depth=3
	sll.w	$a6, $a7, $a5
	sub.d	$a4, $a4, $a6
	move	$a6, $t0
	blez	$a5, .LBB29_176
.LBB29_174:                             # %while.body.i.i.i305
                                        #   Parent Loop BB29_74 Depth=1
...
# %bb.175:                              # %if.then.i.i.i319
	...
	b	.LBB29_173
	.p2align	4, , 16
.LBB29_176:                             # %for.cond386.preheader
                                        #   in Loop: Header=BB29_170 Depth=2
	addi.w	$a3, $a2, 0
	blez	$a3, .LBB29_169
# %bb.177:                              # %iter.check685
                                        #   in Loop: Header=BB29_170 Depth=2
	ori	$a3, $zero, 16
	bgeu	$a2, $a3, .LBB29_186
# %bb.178:                              #   in Loop: Header=BB29_170 Depth=2
	move	$a3, $a2
.LBB29_179:                             # %for.body388
                                        #   in Loop: Header=BB29_170 Depth=2
	addi.d	$a4, $sp, 280
	b	.LBB29_191
	.p2align	4, , 16
.LBB29_180:                             # %for.body382.preheader
                                        #   in Loop: Header=BB29_170 Depth=2
	move	$a2, $zero
	b	.LBB29_182
	.p2align	4, , 16
.LBB29_181:                             # %_ZN9NCompress6NBZip211CThreadInfo9WriteBit2Eb.exit299
                                        #   in Loop: Header=BB29_182 Depth=3
	addi.d	$a2, $a2, 1
	ldx.bu	$a3, $a2, $t6
	beq	$a3, $a0, .LBB29_172
.LBB29_182:                             # %for.body382
                                        #   Parent Loop BB29_74 Depth=1
                                        #     Parent Loop BB29_170 Depth=2
                                        # =>    This Loop Header: Depth=3
                                        #         Child Loop BB29_184 Depth 4
	...
	b	.LBB29_184
	.p2align	4, , 16
.LBB29_183:                             # %if.end.i.i.i297
                                        #   in Loop: Header=BB29_184 Depth=4
	sll.w	$a6, $a7, $a5
	sub.d	$a4, $a4, $a6
	move	$a6, $t0
	blez	$a5, .LBB29_181
.LBB29_184:                             # %while.body.i.i.i279
                                        #   Parent Loop BB29_74 Depth=1
                                        #     Parent Loop BB29_170 Depth=2
...
# %bb.185:                              # %if.then.i.i.i293
	...
	b	.LBB29_183
	.p2align	4, , 16
.LBB29_186:                             # %vector.main.loop.iter.check687
                                        #   in Loop: Header=BB29_170 Depth=2
	ori	$a3, $zero, 32
	bgeu	$a2, $a3, .LBB29_192
# %bb.187:                              #   in Loop: Header=BB29_170 Depth=2
	move	$a4, $zero
.LBB29_188:                             # %vec.epilog.ph703
                                        #   in Loop: Header=BB29_170 Depth=2
	...
	add.d	$a4, $t5, $a4
	.p2align	4, , 16
.LBB29_189:                             # %vec.epilog.vector.body706
                                        #   Parent Loop BB29_74 Depth=1
                                        #     Parent Loop BB29_170 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vld	$vr0, $a4, 0
	...
	addi.d	$a4, $a4, -16
	bnez	$a6, .LBB29_189
# %bb.190:                              # %vec.epilog.middle.block713
                                        #   in Loop: Header=BB29_170 Depth=2
	addi.d	$a4, $sp, 280
	beq	$a5, $a2, .LBB29_169
	.p2align	4, , 16
.LBB29_191:                             # %for.body388
                                        #   Parent Loop BB29_74 Depth=1
                                        #     Parent Loop BB29_170 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	move	$a2, $a3
	...
	stx.b	$a3, $a2, $a4
	addi.d	$a3, $a2, -1
	bltu	$s4, $a2, .LBB29_191
	b	.LBB29_169
.LBB29_192:                             # %vector.ph688
                                        #   in Loop: Header=BB29_170 Depth=2
	andi	$a3, $a2, 16
...
.LBB29_193:                             # %vector.body691
	...
	addi.d	$a5, $a5, -32
	bnez	$a6, .LBB29_193
# %bb.194:                              # %middle.block697
                                        #   in Loop: Header=BB29_170 Depth=2
	beq	$a4, $a2, .LBB29_169
# %bb.195:                              # %vec.epilog.iter.check701
                                        #   in Loop: Header=BB29_170 Depth=2
	bnez	$a3, .LBB29_188
...
.LBB29_199:                             # %do.body403
	...
	b	.LBB29_201
	.p2align	4, , 16
.LBB29_200:                             # %if.end.i.i349
                                        #   in Loop: Header=BB29_201 Depth=3
	sll.w	$a6, $a7, $a5
	sub.d	$a4, $a4, $a6
	move	$a6, $t0
	blez	$a5, .LBB29_203
.LBB29_201:                             # %while.body.i.i331
                                        #   Parent Loop BB29_74 Depth=1
...
# %bb.202:                              # %if.then.i.i345
	...
	b	.LBB29_200
	.p2align	4, , 16
.LBB29_203:                             # %do.body412.preheader
                                        #   in Loop: Header=BB29_199 Depth=2
	move	$a3, $zero
	b	.LBB29_205
	.p2align	4, , 16
.LBB29_204:                             # %_ZN9NCompress6NBZip211CThreadInfo9WriteBit2Eb.exit455
                                        #   in Loop: Header=BB29_205 Depth=3
	addi.d	$a3, $a3, 1
	beq	$a3, $t8, .LBB29_198
.LBB29_205:                             # %do.body412
                                        #   Parent Loop BB29_74 Depth=1
                                        #     Parent Loop BB29_199 Depth=2
                                        # =>    This Loop Header: Depth=3
                                        #         Child Loop BB29_207 Depth 4
...
.LBB29_207:                             # %while.body418
	...
	b	.LBB29_209
	.p2align	4, , 16
.LBB29_208:                             # %if.end.i.i.i375
                                        #   in Loop: Header=BB29_209 Depth=5
	sll.w	$t0, $t1, $a7
	sub.d	$a6, $a6, $t0
	move	$t0, $t2
	blez	$a7, .LBB29_211
.LBB29_209:                             # %while.body.i.i.i357
                                        #   Parent Loop BB29_74 Depth=1
                                        #     Parent Loop BB29_199 Depth=2
                                        #       Parent Loop BB29_205 Depth=3
...
# %bb.210:                              # %if.then.i.i.i371
	...
	b	.LBB29_208
	.p2align	4, , 16
.LBB29_211:                             # %_ZN9NCompress6NBZip211CThreadInfo9WriteBit2Eb.exit377
                                        #   in Loop: Header=BB29_207 Depth=4
	ld.d	$a5, $fp, 32
	ld.w	$a6, $a5, 4
	bgeu	$a1, $a4, .LBB29_216
# %bb.212:                              # %while.body.i.i.i383.preheader
                                        #   in Loop: Header=BB29_207 Depth=4
	move	$a7, $zero
	ori	$t0, $zero, 1
	b	.LBB29_214
	.p2align	4, , 16
.LBB29_213:                             # %if.end.i.i.i401
                                        #   in Loop: Header=BB29_214 Depth=5
	sll.w	$a6, $t1, $t0
	sub.d	$a7, $a7, $a6
	move	$a6, $t2
	blez	$t0, .LBB29_206
.LBB29_214:                             # %while.body.i.i.i383
                                        #   Parent Loop BB29_74 Depth=1
                                        #     Parent Loop BB29_199 Depth=2
                                        #       Parent Loop BB29_205 Depth=3
                                        #         Parent Loop BB29_207 Depth=4
...
# %bb.215:                              # %if.then.i.i.i397
	...
	b	.LBB29_213
	.p2align	4, , 16
.LBB29_216:                             # %while.body.i.i.i409.preheader
                                        #   in Loop: Header=BB29_207 Depth=4
	ori	$t0, $zero, 1
	ori	$a7, $zero, 1
	b	.LBB29_218
	.p2align	4, , 16
.LBB29_217:                             # %if.end.i.i.i427
                                        #   in Loop: Header=BB29_218 Depth=5
	sll.w	$a6, $t1, $t0
	sub.d	$a7, $a7, $a6
	move	$a6, $t2
	blez	$t0, .LBB29_220
.LBB29_218:                             # %while.body.i.i.i409
                                        #   Parent Loop BB29_74 Depth=1
                                        #     Parent Loop BB29_199 Depth=2
                                        #       Parent Loop BB29_205 Depth=3
                                        #         Parent Loop BB29_207 Depth=4
...
.LBB29_222:                             # %while.end425
	...
	b	.LBB29_224
	.p2align	4, , 16
.LBB29_223:                             # %if.end.i.i.i453
                                        #   in Loop: Header=BB29_224 Depth=4
	sll.w	$a7, $t0, $a6
	sub.d	$a5, $a5, $a7
	move	$a7, $t1
	blez	$a6, .LBB29_204
.LBB29_224:                             # %while.body.i.i.i435
                                        #   Parent Loop BB29_74 Depth=1
                                        #     Parent Loop BB29_199 Depth=2
                                        #       Parent Loop BB29_205 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
...
# %bb.225:                              # %if.then.i.i.i449
	...
	b	.LBB29_223
	.p2align	4, , 16
.LBB29_226:                             # %do.body436.preheader
                                        #   in Loop: Header=BB29_74 Depth=1
	move	$a3, $zero
	move	$a2, $zero
	move	$a1, $zero
...
.LBB29_227:                             # %_ZN9NCompress6NBZip216CMsbfEncoderTemp9WriteBitsEji.exit
	...
	bgeu	$a0, $s6, .LBB29_237
.LBB29_228:                             # %do.body436
                                        #   Parent Loop BB29_74 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB29_234 Depth 3
	bstrpick.d	$a5, $a0, 31, 0
...
# %bb.1:                                # %for.body.lr.ph
	...
	ori	$s5, $zero, 8
	b	.LBB32_5
.LBB32_2:                               # %_ZN12CBitmEncoderI10COutBufferE9WriteBitsEjj.exit.loopexit.loopexit
                                        #   in Loop: Header=BB32_5 Depth=1
	move	$a0, $zero
	ori	$s6, $zero, 8
	st.w	$s6, $s1, 408
	.p2align	4, , 16
.LBB32_3:                               # %_ZN12CBitmEncoderI10COutBufferE9WriteBitsEjj.exit.sink.split
                                        #   in Loop: Header=BB32_5 Depth=1
	st.b	$a0, $s1, 412
.LBB32_4:                               # %_ZN12CBitmEncoderI10COutBufferE9WriteBitsEjj.exit
                                        #   in Loop: Header=BB32_5 Depth=1
	addi.d	$s4, $s4, -1
	addi.d	$s2, $s2, 1
	beqz	$s4, .LBB32_15
...
.LBB32_7:                               # %if.end.i.peel
	...
	ld.w	$a1, $s1, 364
	bne	$a0, $a1, .LBB32_9
# %bb.8:                                # %if.then.i.i.peel
                                        #   in Loop: Header=BB32_5 Depth=1
	move	$a0, $s3
	pcaddu18i	$ra, %call36(_ZN10COutBuffer14FlushWithCheckEv)
	jirl	$ra, $ra, 0
.LBB32_9:                               # %_ZN10COutBuffer9WriteByteEh.exit.i.peel
                                        #   in Loop: Header=BB32_5 Depth=1
	ori	$a1, $zero, 8
	st.w	$a1, $s1, 408
	st.b	$zero, $s1, 412
	beqz	$s6, .LBB32_13
# %bb.10:                               # %_ZN10COutBuffer9WriteByteEh.exit.i.peel
                                        #   in Loop: Header=BB32_5 Depth=1
	move	$a0, $zero
	beq	$s6, $s5, .LBB32_4
