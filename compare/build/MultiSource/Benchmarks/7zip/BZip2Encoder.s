...
# %bb.48:                               #   in Loop: Header=BB29_41 Depth=2
	...
	b	.LBB29_59
	.p2align	4, , 16
.LBB29_49:                              # %vector.main.loop.iter.check627
                                        #   in Loop: Header=BB29_41 Depth=2
...
.LBB29_51:                              # %vec.epilog.ph640
	...
	add.d	$s7, $a7, $s7
	.p2align	4, , 16
.LBB29_52:                              # %vec.epilog.vector.body646
                                        #   Parent Loop BB29_40 Depth=1
                                        #     Parent Loop BB29_41 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vld	$vr0, $s7, 0
	...
	addi.d	$s7, $s7, -16
	bnez	$s4, .LBB29_52
# %bb.53:                               # %vec.epilog.middle.block652
                                        #   in Loop: Header=BB29_41 Depth=2
	bne	$s8, $t5, .LBB29_59
	b	.LBB29_61
.LBB29_54:                              # %vector.ph628
                                        #   in Loop: Header=BB29_41 Depth=2
...
.LBB29_55:                              # %vector.body631
	...
	addi.d	$t5, $t5, -32
	bnez	$t6, .LBB29_55
# %bb.56:                               # %middle.block636
                                        #   in Loop: Header=BB29_41 Depth=2
	beq	$s8, $ra, .LBB29_61
# %bb.57:                               # %vec.epilog.iter.check641
                                        #   in Loop: Header=BB29_41 Depth=2
	andi	$t5, $s8, 16
	bnez	$t5, .LBB29_51
...
.LBB29_98:                              # %if.then214
	...
	blt	$t6, $s8, .LBB29_97
	.p2align	4, , 16
.LBB29_99:                              # %vector.main.loop.iter.check789
                                        #   in Loop: Header=BB29_88 Depth=2
...
.LBB29_102:                             # %vector.body797
	...
	addi.d	$t0, $t0, 32
	bnez	$t1, .LBB29_102
# %bb.103:                              # %middle.block802
                                        #   in Loop: Header=BB29_88 Depth=2
	beq	$ra, $t8, .LBB29_87
# %bb.104:                              # %vec.epilog.iter.check807
                                        #   in Loop: Header=BB29_88 Depth=2
	move	$t0, $ra
	move	$t1, $ra
	beqz	$s1, .LBB29_108
.LBB29_105:                             # %vec.epilog.ph806
                                        #   in Loop: Header=BB29_88 Depth=2
	xvld	$xr2, $a7, %pc_lo12(.LCPI29_7)
	xvreplgr2vr.d	$xr3, $t0
	xvor.v	$xr2, $xr3, $xr2
	.p2align	4, , 16
.LBB29_106:                             # %vec.epilog.vector.body819
                                        #   Parent Loop BB29_76 Depth=1
                                        #     Parent Loop BB29_88 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	xvslt.d	$xr3, $xr2, $xr0
	...
	xvaddi.du	$xr2, $xr2, 4
	bne	$t3, $t0, .LBB29_106
# %bb.107:                              # %vec.epilog.middle.block824
                                        #   in Loop: Header=BB29_88 Depth=2
	move	$t1, $t3
	beq	$t3, $t8, .LBB29_87
	.p2align	4, , 16
...
# %bb.120:                              #   in Loop: Header=BB29_119 Depth=4
	...
	b	.LBB29_124
	.p2align	4, , 16
.LBB29_121:                             # %vector.body772.preheader
                                        #   in Loop: Header=BB29_119 Depth=4
	addi.d	$t3, $sp, 328
	move	$t4, $t0
	vori.b	$vr0, $vr4, 0
...
# %bb.134:                              #   in Loop: Header=BB29_133 Depth=3
	...
	b	.LBB29_154
	.p2align	4, , 16
.LBB29_135:                             # %vector.body746.preheader
                                        #   in Loop: Header=BB29_133 Depth=3
	...
	b	.LBB29_137
	.p2align	4, , 16
.LBB29_136:                             # %pred.store.continue762
                                        #   in Loop: Header=BB29_137 Depth=4
	addi.d	$a0, $a0, -8
	addi.d	$a1, $a1, 32
	beqz	$a0, .LBB29_153
.LBB29_137:                             # %vector.body746
                                        #   Parent Loop BB29_76 Depth=1
                                        #     Parent Loop BB29_111 Depth=2
...
# %bb.138:                              # %pred.store.if
	...
	andi	$a2, $a2, 1
	bnez	$a2, .LBB29_146
.LBB29_139:                             # %pred.store.continue750
                                        #   in Loop: Header=BB29_137 Depth=4
	xvpickve2gr.w	$a2, $xr0, 2
	andi	$a2, $a2, 1
	beqz	$a2, .LBB29_147
.LBB29_140:                             # %pred.store.if751
                                        #   in Loop: Header=BB29_137 Depth=4
	st.w	$s4, $a1, 8
	xvpickve2gr.w	$a2, $xr0, 3
	andi	$a2, $a2, 1
	bnez	$a2, .LBB29_148
.LBB29_141:                             # %pred.store.continue754
                                        #   in Loop: Header=BB29_137 Depth=4
...
.LBB29_145:                             # %pred.store.continue
	...
	andi	$a2, $a2, 1
	beqz	$a2, .LBB29_139
.LBB29_146:                             # %pred.store.if749
                                        #   in Loop: Header=BB29_137 Depth=4
	st.w	$s4, $a1, 4
	xvpickve2gr.w	$a2, $xr0, 2
	andi	$a2, $a2, 1
	bnez	$a2, .LBB29_140
.LBB29_147:                             # %pred.store.continue752
                                        #   in Loop: Header=BB29_137 Depth=4
	xvpickve2gr.w	$a2, $xr0, 3
	andi	$a2, $a2, 1
	beqz	$a2, .LBB29_141
.LBB29_148:                             # %pred.store.if753
                                        #   in Loop: Header=BB29_137 Depth=4
	st.w	$s4, $a1, 12
	xvpickve2gr.w	$a2, $xr0, 4
	andi	$a2, $a2, 1
	bnez	$a2, .LBB29_142
.LBB29_149:                             # %pred.store.continue756
                                        #   in Loop: Header=BB29_137 Depth=4
	xvpickve2gr.w	$a2, $xr0, 5
	andi	$a2, $a2, 1
	beqz	$a2, .LBB29_143
.LBB29_150:                             # %pred.store.if757
                                        #   in Loop: Header=BB29_137 Depth=4
	st.w	$s4, $a1, 20
	xvpickve2gr.w	$a2, $xr0, 6
	andi	$a2, $a2, 1
	bnez	$a2, .LBB29_144
.LBB29_151:                             # %pred.store.continue760
                                        #   in Loop: Header=BB29_137 Depth=4
	xvpickve2gr.w	$a2, $xr0, 7
	andi	$a2, $a2, 1
	beqz	$a2, .LBB29_136
.LBB29_152:                             # %pred.store.if761
                                        #   in Loop: Header=BB29_137 Depth=4
	st.w	$s4, $a1, 28
	b	.LBB29_136
	.p2align	4, , 16
.LBB29_153:                             # %middle.block764
                                        #   in Loop: Header=BB29_133 Depth=3
	ld.d	$a0, $sp, 272                   # 8-byte Folded Reload
	move	$a1, $a0
	beq	$a0, $a3, .LBB29_132
...
# %bb.159:                              #   in Loop: Header=BB29_76 Depth=1
	...
	b	.LBB29_169
	.p2align	4, , 16
.LBB29_160:                             # %vector.main.loop.iter.check717
                                        #   in Loop: Header=BB29_76 Depth=1
	addi.d	$t7, $sp, 512
	ld.d	$s3, $sp, 176                   # 8-byte Folded Reload
	ld.d	$ra, $sp, 160                   # 8-byte Folded Reload
...
.LBB29_163:                             # %vector.body721
	...
	addi.d	$a1, $a1, 64
	bnez	$a2, .LBB29_163
# %bb.164:                              # %middle.block724
                                        #   in Loop: Header=BB29_76 Depth=1
	ld.d	$t8, $sp, 280                   # 8-byte Folded Reload
	addi.d	$a3, $sp, 312
	beq	$a0, $s1, .LBB29_170
# %bb.165:                              # %vec.epilog.iter.check729
                                        #   in Loop: Header=BB29_76 Depth=1
	andi	$a1, $s1, 48
	beqz	$a1, .LBB29_169
.LBB29_166:                             # %vec.epilog.ph728
                                        #   in Loop: Header=BB29_76 Depth=1
	move	$a2, $a0
	...
	add.d	$a2, $a3, $a2
	.p2align	4, , 16
.LBB29_167:                             # %vec.epilog.vector.body734
                                        #   Parent Loop BB29_76 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr0, $a2, 0
	vaddi.bu	$vr0, $vr0, 16
	...
	addi.d	$a2, $a2, 16
	bnez	$a1, .LBB29_167
# %bb.168:                              # %vec.epilog.middle.block739
                                        #   in Loop: Header=BB29_76 Depth=1
	addi.d	$a3, $sp, 312
	beq	$a0, $s1, .LBB29_170
	.p2align	4, , 16
...
.LBB29_190:                             # %vec.epilog.ph696
	...
	add.d	$a4, $t5, $a4
	.p2align	4, , 16
.LBB29_191:                             # %vec.epilog.vector.body702
                                        #   Parent Loop BB29_76 Depth=1
                                        #     Parent Loop BB29_172 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vld	$vr0, $a4, 0
	...
	addi.d	$a4, $a4, -16
	bnez	$a6, .LBB29_191
# %bb.192:                              # %vec.epilog.middle.block709
                                        #   in Loop: Header=BB29_172 Depth=2
	addi.d	$a6, $sp, 312
	beq	$a5, $a2, .LBB29_171
	.p2align	4, , 16
...
.LBB29_195:                             # %vector.body686
	...
	addi.d	$a3, $a3, -32
	bnez	$a5, .LBB29_195
# %bb.196:                              # %middle.block692
                                        #   in Loop: Header=BB29_172 Depth=2
	beq	$a4, $a2, .LBB29_171
# %bb.197:                              # %vec.epilog.iter.check697
                                        #   in Loop: Header=BB29_172 Depth=2
	andi	$a3, $a2, 16
	bnez	$a3, .LBB29_190
