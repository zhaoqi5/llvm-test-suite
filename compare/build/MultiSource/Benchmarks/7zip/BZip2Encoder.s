...
.LBB29_32:                              # %for.body47.preheader
	vst	$vr17, $sp, 240                 # 16-byte Folded Spill
	move	$a0, $zero
	addi.d	$a1, $sp, 312
	addi.d	$a2, $sp, 512
	ori	$a3, $zero, 256
...
.LBB29_109:                             # %do.body244.preheader
	...
	move	$a1, $zero
	move	$a0, $zero
	vld	$vr6, $sp, 240                  # 16-byte Folded Reload
	ori	$t0, $zero, 255
	ori	$t1, $zero, 48
	addi.d	$t7, $sp, 312
	.p2align	4, , 16
...
.LBB29_120:                             # %vector.body775
	...
	vpickve2gr.w	$s3, $vr3, 1
	bstrpick.d	$s3, $s3, 31, 0
	vinsgr2vr.d	$vr4, $s3, 1
...
# %bb.136:                              # %pred.store.if
	...
	andi	$a2, $a2, 1
	bnez	$a2, .LBB29_144
.LBB29_137:                             # %pred.store.continue753
                                        #   in Loop: Header=BB29_135 Depth=4
	xvpickve2gr.w	$a2, $xr0, 2
	andi	$a2, $a2, 1
	beqz	$a2, .LBB29_145
.LBB29_138:                             # %pred.store.if754
                                        #   in Loop: Header=BB29_135 Depth=4
	st.w	$s4, $a1, 8
	xvpickve2gr.w	$a2, $xr0, 3
	andi	$a2, $a2, 1
	bnez	$a2, .LBB29_146
.LBB29_139:                             # %pred.store.continue757
                                        #   in Loop: Header=BB29_135 Depth=4
	xvpickve2gr.w	$a2, $xr0, 4
	andi	$a2, $a2, 1
	beqz	$a2, .LBB29_147
.LBB29_140:                             # %pred.store.if758
                                        #   in Loop: Header=BB29_135 Depth=4
	st.w	$s4, $a1, 16
	xvpickve2gr.w	$a2, $xr0, 5
	andi	$a2, $a2, 1
	bnez	$a2, .LBB29_148
.LBB29_141:                             # %pred.store.continue761
                                        #   in Loop: Header=BB29_135 Depth=4
	xvpickve2gr.w	$a2, $xr0, 6
	andi	$a2, $a2, 1
	beqz	$a2, .LBB29_149
.LBB29_142:                             # %pred.store.if762
                                        #   in Loop: Header=BB29_135 Depth=4
	st.w	$s4, $a1, 24
...
.LBB29_143:                             # %pred.store.continue
	...
	andi	$a2, $a2, 1
	beqz	$a2, .LBB29_137
.LBB29_144:                             # %pred.store.if752
                                        #   in Loop: Header=BB29_135 Depth=4
	st.w	$s4, $a1, 4
	xvpickve2gr.w	$a2, $xr0, 2
	andi	$a2, $a2, 1
	bnez	$a2, .LBB29_138
.LBB29_145:                             # %pred.store.continue755
                                        #   in Loop: Header=BB29_135 Depth=4
	xvpickve2gr.w	$a2, $xr0, 3
	andi	$a2, $a2, 1
	beqz	$a2, .LBB29_139
.LBB29_146:                             # %pred.store.if756
                                        #   in Loop: Header=BB29_135 Depth=4
	st.w	$s4, $a1, 12
	xvpickve2gr.w	$a2, $xr0, 4
	andi	$a2, $a2, 1
	bnez	$a2, .LBB29_140
.LBB29_147:                             # %pred.store.continue759
                                        #   in Loop: Header=BB29_135 Depth=4
	xvpickve2gr.w	$a2, $xr0, 5
	andi	$a2, $a2, 1
	beqz	$a2, .LBB29_141
.LBB29_148:                             # %pred.store.if760
                                        #   in Loop: Header=BB29_135 Depth=4
	st.w	$s4, $a1, 20
	xvpickve2gr.w	$a2, $xr0, 6
	andi	$a2, $a2, 1
	bnez	$a2, .LBB29_142
.LBB29_149:                             # %pred.store.continue763
                                        #   in Loop: Header=BB29_135 Depth=4
	xvpickve2gr.w	$a2, $xr0, 7
	andi	$a2, $a2, 1
	beqz	$a2, .LBB29_134
