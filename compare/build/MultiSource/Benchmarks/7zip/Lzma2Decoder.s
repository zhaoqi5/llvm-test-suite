...
# %bb.15:                               # %if.end37
	...
	ori	$a0, $zero, 1
	beq	$a1, $a0, .LBB25_19
# %bb.16:                               # %cleanup50.thread.loopexit25
	lu12i.w	$a0, -524284
	ori	$a0, $a0, 5
	b	.LBB25_19
.LBB25_17:                              # %cleanup50.thread.loopexit26
	lu12i.w	$a0, -524176
	ori	$a0, $a0, 87
	b	.LBB25_19
...
# %bb.17:                               # %for.cond.i13
	...
	ld.bu	$a3, $a0, 1
	bne	$a2, $a3, .LBB27_32
# %bb.18:                               # %for.cond.1.i16
	ld.bu	$a2, $s1, 2
	ld.bu	$a3, $a0, 2
	bne	$a2, $a3, .LBB27_32
# %bb.19:                               # %for.cond.2.i19
	ld.bu	$a2, $s1, 3
	ld.bu	$a3, $a0, 3
	bne	$a2, $a3, .LBB27_32
# %bb.20:                               # %for.cond.3.i22
	ld.bu	$a2, $s1, 4
	ld.bu	$a3, $a0, 4
	bne	$a2, $a3, .LBB27_32
# %bb.21:                               # %for.cond.4.i25
	ld.bu	$a2, $s1, 5
	ld.bu	$a3, $a0, 5
	bne	$a2, $a3, .LBB27_32
# %bb.22:                               # %for.cond.5.i28
	ld.bu	$a2, $s1, 6
	ld.bu	$a3, $a0, 6
	bne	$a2, $a3, .LBB27_32
# %bb.23:                               # %for.cond.6.i31
	ld.bu	$a2, $s1, 7
	ld.bu	$a3, $a0, 7
	bne	$a2, $a3, .LBB27_32
# %bb.24:                               # %for.cond.7.i34
	ld.bu	$a2, $s1, 8
	ld.bu	$a3, $a0, 8
	bne	$a2, $a3, .LBB27_32
# %bb.25:                               # %for.cond.8.i37
	ld.bu	$a2, $s1, 9
	ld.bu	$a3, $a0, 9
	bne	$a2, $a3, .LBB27_32
# %bb.26:                               # %for.cond.9.i40
	ld.bu	$a2, $s1, 10
	ld.bu	$a3, $a0, 10
	bne	$a2, $a3, .LBB27_32
# %bb.27:                               # %for.cond.10.i43
	ld.bu	$a2, $s1, 11
	ld.bu	$a3, $a0, 11
	bne	$a2, $a3, .LBB27_32
# %bb.28:                               # %for.cond.11.i46
	ld.bu	$a2, $s1, 12
	ld.bu	$a3, $a0, 12
	bne	$a2, $a3, .LBB27_32
# %bb.29:                               # %for.cond.12.i49
	ld.bu	$a2, $s1, 13
	ld.bu	$a3, $a0, 13
	bne	$a2, $a3, .LBB27_32
# %bb.30:                               # %for.cond.13.i52
	ld.bu	$a2, $s1, 14
	ld.bu	$a3, $a0, 14
	bne	$a2, $a3, .LBB27_32
# %bb.31:                               # %_ZeqRK4GUIDS1_.exit59
	ld.bu	$a3, $s1, 15
	ld.bu	$a0, $a0, 15
	ori	$a2, $zero, 8
	beq	$a3, $a0, .LBB27_66
...
# %bb.49:                               # %for.cond.i111
	...
	ld.bu	$a2, $a0, 1
	bne	$a1, $a2, .LBB27_64
# %bb.50:                               # %for.cond.1.i114
	ld.bu	$a1, $s1, 2
	ld.bu	$a2, $a0, 2
	bne	$a1, $a2, .LBB27_64
# %bb.51:                               # %for.cond.2.i117
	ld.bu	$a1, $s1, 3
	ld.bu	$a2, $a0, 3
	bne	$a1, $a2, .LBB27_64
# %bb.52:                               # %for.cond.3.i120
	ld.bu	$a1, $s1, 4
	ld.bu	$a2, $a0, 4
	bne	$a1, $a2, .LBB27_64
# %bb.53:                               # %for.cond.4.i123
	ld.bu	$a1, $s1, 5
	ld.bu	$a2, $a0, 5
	bne	$a1, $a2, .LBB27_64
# %bb.54:                               # %for.cond.5.i126
	ld.bu	$a1, $s1, 6
	ld.bu	$a2, $a0, 6
	bne	$a1, $a2, .LBB27_64
# %bb.55:                               # %for.cond.6.i129
	ld.bu	$a1, $s1, 7
	ld.bu	$a2, $a0, 7
	bne	$a1, $a2, .LBB27_64
# %bb.56:                               # %for.cond.7.i132
	ld.bu	$a1, $s1, 8
	ld.bu	$a2, $a0, 8
	bne	$a1, $a2, .LBB27_64
# %bb.57:                               # %for.cond.8.i135
	ld.bu	$a1, $s1, 9
	ld.bu	$a2, $a0, 9
	bne	$a1, $a2, .LBB27_64
# %bb.58:                               # %for.cond.9.i138
	ld.bu	$a1, $s1, 10
	ld.bu	$a2, $a0, 10
	bne	$a1, $a2, .LBB27_64
# %bb.59:                               # %for.cond.10.i141
	ld.bu	$a1, $s1, 11
	ld.bu	$a2, $a0, 11
	bne	$a1, $a2, .LBB27_64
# %bb.60:                               # %for.cond.11.i144
	ld.bu	$a1, $s1, 12
	ld.bu	$a2, $a0, 12
	bne	$a1, $a2, .LBB27_64
# %bb.61:                               # %for.cond.12.i147
	ld.bu	$a1, $s1, 13
	ld.bu	$a2, $a0, 13
	bne	$a1, $a2, .LBB27_64
# %bb.62:                               # %for.cond.13.i150
	ld.bu	$a1, $s1, 14
	ld.bu	$a2, $a0, 14
	bne	$a1, $a2, .LBB27_64
# %bb.63:                               # %_ZeqRK4GUIDS1_.exit157
	ld.bu	$a1, $s1, 15
	ld.bu	$a0, $a0, 15
	ori	$a2, $zero, 24
	beq	$a1, $a0, .LBB27_66
