...
.LBB15_9:                               # %if.then
	...
	ori	$s2, $zero, 1
	blt	$a1, $s2, .LBB15_11
# %bb.10:                               # %if.then._ZN11CStringBaseIcE9GetBufferEi.exit37_crit_edge
	ld.d	$s1, $fp, 0
	b	.LBB15_12
.LBB15_11:                              # %if.end9.i.i18
	move	$s3, $a0
	ori	$a0, $zero, 1
	pcaddu18i	$ra, %call36(_Znam)
	jirl	$ra, $ra, 0
	...
	stx.b	$zero, $s1, $a1
	st.w	$s2, $fp, 12
.LBB15_12:                              # %_ZN11CStringBaseIcE9GetBufferEi.exit37
	addi.d	$a3, $sp, 20
	move	$a1, $s1
	move	$a2, $zero
	pcaddu18i	$ra, %call36(_ZN8NArchive4NZip10CInArchive9ReadBytesEPvjPj)
	jirl	$ra, $ra, 0
	bnez	$a0, .LBB15_30
# %bb.13:                               # %_ZN8NArchive4NZip10CInArchive20ReadBytesAndTestSizeEPvj.exit.i43
	ld.w	$a0, $sp, 20
	beqz	$a0, .LBB15_29
.LBB15_14:                              # %if.then.i10
	ori	$a0, $zero, 4
	pcaddu18i	$ra, %call36(__cxa_allocate_exception)
	jirl	$ra, $ra, 0
	st.w	$zero, $a0, 0
...
# %bb.34:                               # %if.then15.if.end18_crit_edge.i.i.peel
                                        #   in Loop: Header=BB16_5 Depth=1
	ld.d	$a0, $s6, 0
.LBB16_35:                              # %call.i.i.i.noexc58.peel.thread148.thread
                                        #   in Loop: Header=BB16_5 Depth=1
	ld.d	$a1, $fp, 24
	addi.d	$a0, $a0, 1
	st.d	$a0, $fp, 40
...
.LBB16_49:                              # %if.then15.if.end18_crit_edge.i.i
	...
	ld.d	$a0, $s6, 0
.LBB16_50:                              # %call.i.i.i.noexc58.thread153.thread
                                        #   in Loop: Header=BB16_52 Depth=2
	ld.d	$a1, $fp, 24
	addi.d	$a0, $a0, 1
	st.d	$a0, $fp, 40
...
.LBB16_74:                              # %_ZN8NArchive4NZip10CInArchive4SkipEy.exit
	...
	addi.d	$sp, $sp, 224
	ret
.LBB16_75:                              # %if.then.i.i.i52.invoke.loopexit218.split.loop.exit228
	sltu	$a0, $zero, $a0
	ori	$a1, $zero, 6
	maskeqz	$fp, $a1, $a0
	b	.LBB16_79
...
.Ltmp54:                                # EH_LABEL
.LBB16_97:                              # %ehcleanup60
	st.d	$a0, $sp, 16                    # 8-byte Folded Spill
.LBB16_98:                              # %ehcleanup60
	ld.d	$a0, $sp, 112
	beqz	$a0, .LBB16_100
# %bb.99:                               # %delete.notnull.i.i69
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB16_100:                             # %_ZN8NArchive4NZip14CExtraSubBlockD2Ev.exit70
	ld.d	$a0, $sp, 16                    # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.Lfunc_end16:
...
.LBB20_5:                               # %cleanup.cont.preheader
	...
	ld.d	$s5, $a0, %got_pc_lo12(_ZN8NArchive4NZip10NSignature15kDataDescriptorE)
	addi.d	$s6, $sp, 31
	ori	$s7, $zero, 16
	ori	$s8, $zero, 1
...
# %bb.2:                                # %_ZN8NArchive4NZip10CInArchive20ReadBytesAndTestSizeEPvj.exit
	...
	bne	$a1, $s1, .LBB23_5
# %bb.3:                                # %if.end4
	pcalau12i	$a1, %got_pc_hi20(_ZN8NArchive4NZip10NSignature21kZip64EndOfCentralDirE)
	ld.d	$a1, $a1, %got_pc_lo12(_ZN8NArchive4NZip10NSignature21kZip64EndOfCentralDirE)
	ld.w	$a2, $sp, 20
	ld.w	$a1, $a1, 0
	bne	$a2, $a1, .LBB23_5
# %bb.4:                                # %if.end21
...
# %bb.11:                               # %for.body.lr.ph
	...
	and	$a1, $a1, $a0
	pcalau12i	$a2, %got_pc_hi20(_ZN8NArchive4NZip10NSignature16kEndOfCentralDirE)
	ld.d	$s6, $a2, %got_pc_lo12(_ZN8NArchive4NZip10NSignature16kEndOfCentralDirE)
	pcalau12i	$a2, %got_pc_hi20(_ZN8NArchive4NZip10NSignature28kZip64EndOfCentralDirLocatorE)
	ld.d	$s4, $a2, %got_pc_lo12(_ZN8NArchive4NZip10NSignature28kZip64EndOfCentralDirLocatorE)
	addi.w	$a1, $a1, -1
...
.LBB28_57:                              #   in Loop: Header=BB28_27 Depth=1
	...
	st.d	$a1, $sp, 248
	beqz	$a0, .LBB28_59
.LBB28_58:                              # %delete.notnull.i.i155
                                        #   in Loop: Header=BB28_27 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB28_59:                              # %_ZN7CBufferIhED2Ev.exit.i156
                                        #   in Loop: Header=BB28_27 Depth=1
	st.d	$s7, $sp, 216
.Ltmp181:                               # EH_LABEL
	move	$a0, $s8
	...
	jirl	$ra, $ra, 0
.Ltmp182:                               # EH_LABEL
# %bb.60:                               # %_ZN8NArchive4NZip11CExtraBlockD2Ev.exit.i159
                                        #   in Loop: Header=BB28_27 Depth=1
	move	$a0, $s8
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVectorD2Ev)
	jirl	$ra, $ra, 0
...
.Ltmp184:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp185:                               # EH_LABEL
# %bb.61:                               # %_ZN8NArchive4NZip11CExtraBlockD2Ev.exit.i.i162
                                        #   in Loop: Header=BB28_27 Depth=1
	move	$a0, $s5
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVectorD2Ev)
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 128
	beqz	$a0, .LBB28_63
# %bb.62:                               # %delete.notnull.i.i.i165
                                        #   in Loop: Header=BB28_27 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB28_63:                              # %_ZN8NArchive4NZip5CItemD2Ev.exit166
                                        #   in Loop: Header=BB28_27 Depth=1
	beqz	$s2, .LBB28_104
# %bb.64:                               # %for.inc197
                                        #   in Loop: Header=BB28_27 Depth=1
...
.LBB28_81:                              # %for.body.i.i
	...
	addi.d	$a2, $a2, 1
	bnez	$a1, .LBB28_81
.LBB28_82:                              # %delete.notnull.i.i114
                                        #   in Loop: Header=BB28_27 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	ld.w	$a1, $s6, 40
...
.Ltmp175:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp176:                               # EH_LABEL
# %bb.93:                               # %call.i.i.noexc148
                                        #   in Loop: Header=BB28_27 Depth=1
	bnez	$a0, .LBB28_108
# %bb.94:                               # %_ZN8NArchive4NZip10CInArchive20ReadBytesAndTestSizeEPvj.exit.i132
                                        #   in Loop: Header=BB28_27 Depth=1
	ld.w	$a0, $sp, 292
	ori	$a1, $zero, 1
	addi.d	$s5, $sp, 144
...
.Ltmp177:                               # EH_LABEL
	b	.LBB28_123
.LBB28_112:                             # %terminate.lpad.i.i.i158
.Ltmp183:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB28_113:                             # %lpad67
.Ltmp163:                               # EH_LABEL
	b	.LBB28_123
.LBB28_114:                             # %terminate.lpad.i.i.i.i161
.Ltmp186:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB28_115:                             # %lpad14
