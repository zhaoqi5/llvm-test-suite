...
.LBB4_17:                               # %cleanup
	...
	addi.d	$sp, $sp, 96
	ret
.LBB4_18:                               # %cleanup.split.loop.exit.i
	move	$a0, $zero
	sltu	$a1, $s5, $s3
	masknez	$a2, $s3, $a1
	maskeqz	$a1, $s5, $a1
...
# %bb.34:                               # %if.then15.if.end18_crit_edge.i.i.peel
                                        #   in Loop: Header=BB16_5 Depth=1
	ld.d	$a0, $s6, 0
.LBB16_35:                              # %call.i.i.i.noexc58.peel.thread152.thread
                                        #   in Loop: Header=BB16_5 Depth=1
	ld.d	$a1, $fp, 24
	addi.d	$a0, $a0, 1
	st.d	$a0, $fp, 40
...
.LBB16_49:                              # %if.then15.if.end18_crit_edge.i.i
	...
	ld.d	$a0, $s6, 0
.LBB16_50:                              # %call.i.i.i.noexc58.thread157.thread
                                        #   in Loop: Header=BB16_52 Depth=2
	ld.d	$a1, $fp, 24
	addi.d	$a0, $a0, 1
	st.d	$a0, $fp, 40
...
.LBB16_74:                              # %_ZN8NArchive4NZip10CInArchive4SkipEy.exit
	...
	addi.d	$sp, $sp, 224
	ret
.LBB16_75:                              # %if.then.i.i.i52.invoke.loopexit222.split.loop.exit232
	sltu	$a0, $zero, $a0
	ori	$a1, $zero, 6
	maskeqz	$fp, $a1, $a0
	b	.LBB16_79
