...
# %bb.0:                                # %entry
	...
	st.d	$a2, $a1, 16
	ld.d	$a2, $a0, 1488
	pcalau12i	$a3, %pc_hi20(MatchFinderMt_GetPointerToCurrentPos)
	addi.d	$a3, $a3, %pc_lo12(MatchFinderMt_GetPointerToCurrentPos)
	st.d	$a3, $a1, 24
	ld.w	$a3, $a2, 96
	pcalau12i	$a4, %pc_hi20(MatchFinderMt_GetMatches)
	addi.d	$a4, $a4, %pc_lo12(MatchFinderMt_GetMatches)
	ori	$a5, $zero, 3
	st.d	$a4, $a1, 32
	beq	$a3, $a5, .LBB31_3
# %bb.1:                                # %entry
