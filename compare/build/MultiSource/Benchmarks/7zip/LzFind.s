...
# %bb.7:                                # %middle.block
	beq	$a4, $a3, .LBB14_10
.LBB14_8:                               # %for.body.i.i.preheader
	sub.d	$a3, $a3, $a4
	alsl.d	$a2, $a4, $a2, 2
	.p2align	4, , 16
.LBB14_9:                               # %for.body.i.i
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a4, $a2, 0
	sub.d	$a5, $a4, $a1
	sltu	$a4, $a4, $a5
...
# %bb.21:                               # %if.then2.i.i
	...
	st.w	$a1, $a0, 16
	bltu	$a3, $a2, .LBB14_17
.LBB14_22:                              # %if.then16.i.i
	ori	$a1, $zero, 1
	st.w	$a1, $a0, 80
	b	.LBB14_17
.LBB14_23:                              # %for.cond.preheader.i.i
	ld.w	$a2, $a0, 16
	ld.w	$a1, $a0, 8
.LBB14_24:                              # %for.cond.i.i
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a3, $a0, 0
	ld.d	$a4, $a0, 64
	ld.wu	$a5, $a0, 84
...
# %bb.23:                               # %while.body.i
	...
	addi.d	$s0, $s0, -1
	beq	$s2, $s3, .LBB19_22
# %bb.24:                               # %while.end.thread.i
                                        #   in Loop: Header=BB19_19 Depth=1
	bgeu	$a7, $t8, .LBB19_27
# %bb.25:                               # %cleanup.thread.i
                                        #   in Loop: Header=BB19_19 Depth=1
	st.w	$t8, $a6, 0
	addi.d	$a7, $t6, -1
	addi.d	$t6, $a6, 8
	...
	move	$a7, $t8
	b	.LBB19_27
.LBB19_26:                              # %while.end.i
                                        #   in Loop: Header=BB19_19 Depth=1
	bltu	$a7, $a2, .LBB19_29
	.p2align	4, , 16
.LBB19_27:                              # %cleanup44.i
                                        #   in Loop: Header=BB19_19 Depth=1
	addi.w	$t4, $t4, -1
	beqz	$t4, .LBB19_30
# %bb.28:                               # %cleanup44.i
...
# %bb.34:                               # %land.lhs.true.i
	...
	move	$s3, $s4
	bne	$s5, $s6, .LBB25_39
# %bb.35:                               # %while.cond.i132.preheader
                                        #   in Loop: Header=BB25_32 Depth=1
	addi.w	$s2, $s2, 2
	.p2align	4, , 16
.LBB25_36:                              # %while.cond.i132
                                        #   Parent Loop BB25_32 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	beq	$a5, $s2, .LBB25_47
# %bb.37:                               # %while.body.i134
	...
	addi.w	$s2, $s2, 1
	beq	$s4, $s3, .LBB25_36
# %bb.38:                               # %while.body.i134.if.end48.i.loopexit_crit_edge
                                        #   in Loop: Header=BB25_32 Depth=1
	addi.w	$s3, $s2, -1
	.p2align	4, , 16
.LBB25_39:                              # %if.end48.i
