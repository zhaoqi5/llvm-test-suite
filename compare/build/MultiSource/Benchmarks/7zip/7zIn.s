...
# %bb.30:                               # %for.body22.preheader
	ori	$a2, $zero, 16
	bltu	$s2, $a2, .LBB13_33
# %bb.31:                               # %vector.memcheck39
	add.d	$a2, $s5, $s4
	add.d	$a2, $a2, $s2
	bgeu	$a1, $a2, .LBB13_37
# %bb.32:                               # %vector.memcheck39
	alsl.d	$a2, $s2, $a1, 1
	bgeu	$s1, $a2, .LBB13_37
.LBB13_33:
	move	$a2, $zero
.LBB13_34:                              # %for.body22.preheader56
	alsl.d	$a3, $a2, $a1, 2
	sub.d	$a2, $s3, $a2
	.p2align	4, , 16
.LBB13_35:                              # %for.body22
...
.Ltmp125:                               # EH_LABEL
	...
	jirl	$ra, $a1, 0
.Ltmp126:                               # EH_LABEL
# %bb.48:                               # %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit90
                                        #   in Loop: Header=BB31_4 Depth=1
	bnez	$s4, .LBB31_51
# %bb.49:                               # %for.cond
                                        #   in Loop: Header=BB31_4 Depth=1
...
.Ltmp128:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp129:                               # EH_LABEL
# %bb.52:                               # %_ZN13CObjectVectorIN8NArchive3N7z7CFolderEED2Ev.exit
	addi.d	$a0, $sp, 520
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVectorD2Ev)
	jirl	$ra, $ra, 0
	addi.d	$a0, $sp, 552
...
.LBB31_59:                              # %lpad14
.Ltmp93:                                # EH_LABEL
.LBB31_60:                              # %ehcleanup121
	move	$fp, $a0
	b	.LBB31_73
.LBB31_61:                              # %if.then.i.loopexit.split-lp
.Ltmp121:                               # EH_LABEL
	b	.LBB31_68
.LBB31_62:                              # %lpad35
.Ltmp104:                               # EH_LABEL
...
.Ltmp123:                               # EH_LABEL
	b	.LBB31_72
.LBB31_69:                              # %terminate.lpad.i
.Ltmp124:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB31_70:                              # %_ZN7CBufferIhED2Ev.exit61
.Ltmp101:                               # EH_LABEL
.LBB31_71:                              # %ehcleanup105
	move	$fp, $a0
.LBB31_72:                              # %ehcleanup105
	addi.d	$a0, $sp, 160
	pcaddu18i	$ra, %call36(_ZN8NArchive3N7z8CDecoderD2Ev)
	jirl	$ra, $ra, 0
.LBB31_73:                              # %ehcleanup121
	addi.d	$a0, $sp, 392
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVectorD2Ev)
	jirl	$ra, $ra, 0
	addi.d	$a0, $sp, 424
