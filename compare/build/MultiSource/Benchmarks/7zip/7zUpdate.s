...
# %bb.111:                              # %cleanup.cont.i1814
	...
	ld.w	$a6, $a4, 12
	bne	$a5, $a6, .LBB12_131
# %bb.112:                              # %for.cond.preheader.i.i1829
                                        #   in Loop: Header=BB12_107 Depth=2
	ori	$a6, $zero, 1
	blt	$a5, $a6, .LBB12_126
# %bb.113:                              # %for.body.lr.ph.i.i1858
                                        #   in Loop: Header=BB12_107 Depth=2
	ld.d	$a6, $a3, 16
	ld.d	$a7, $a4, 16
	move	$t0, $zero
	.p2align	4, , 16
.LBB12_114:                             # %for.body.i.i1862
                                        #   Parent Loop BB12_105 Depth=1
	...
	ld.w	$t4, $t3, 32
	bne	$t1, $t4, .LBB12_122
# %bb.115:                              # %cleanup.cont.i.i.i1876
                                        #   in Loop: Header=BB12_114 Depth=3
	ld.w	$t1, $t2, 36
	ld.w	$t4, $t3, 36
	bne	$t1, $t4, .LBB12_122
# %bb.116:                              # %cleanup.cont10.i.i.i1881
                                        #   in Loop: Header=BB12_114 Depth=3
	ld.d	$t1, $t2, 0
	ld.d	$t4, $t3, 0
	bne	$t1, $t4, .LBB12_122
# %bb.117:                              # %cleanup.cont19.i.i.i1884
                                        #   in Loop: Header=BB12_114 Depth=3
	ld.d	$t1, $t2, 16
	ld.d	$t4, $t3, 16
	bne	$t1, $t4, .LBB12_122
# %bb.118:                              # %for.cond.preheader.i.i.i.i1891
                                        #   in Loop: Header=BB12_114 Depth=3
	beqz	$t1, .LBB12_123
# %bb.119:                              #   in Loop: Header=BB12_114 Depth=3
	...
	ld.d	$t3, $t3, 24
	.p2align	4, , 16
.LBB12_120:                             # %for.body.i.i.i.i1893
                                        #   Parent Loop BB12_105 Depth=1
                                        #     Parent Loop BB12_107 Depth=2
...
.LBB12_122:                             #   in Loop: Header=BB12_114 Depth=3
	...
	sub.d	$t1, $t1, $t2
	bnez	$t1, .LBB12_132
.LBB12_123:                             # %for.inc.i.i1873
                                        #   in Loop: Header=BB12_114 Depth=3
	addi.d	$t0, $t0, 1
	bne	$t0, $a5, .LBB12_114
	b	.LBB12_126
.LBB12_124:                             # %cleanup17.loopexit.split.loop.exit1.i.i.i.i1898
                                        #   in Loop: Header=BB12_114 Depth=3
	sltu	$t1, $t4, $t5
	sltu	$t2, $t5, $t4
	sub.d	$t1, $t2, $t1
...
.LBB12_125:                             #   in Loop: Header=BB12_107 Depth=2
	...
	slt	$a2, $a2, $s6
	b	.LBB12_134
.LBB12_126:                             # %for.end.i.i1831
                                        #   in Loop: Header=BB12_107 Depth=2
	ld.w	$a5, $a3, 44
	ld.w	$a6, $a4, 44
	bne	$a5, $a6, .LBB12_131
# %bb.127:                              # %for.cond28.preheader.i.i1836
                                        #   in Loop: Header=BB12_107 Depth=2
	ori	$a6, $zero, 1
	blt	$a5, $a6, .LBB12_133
# %bb.128:                              # %for.body30.lr.ph.i.i1838
                                        #   in Loop: Header=BB12_107 Depth=2
	ld.d	$a4, $a4, 48
	ld.d	$a6, $a3, 48
	addi.d	$a3, $a4, 4
...
.LBB12_131:                             #   in Loop: Header=BB12_107 Depth=2
	...
	slt	$a4, $a6, $a5
	sub.d	$t1, $a4, $a3
.LBB12_132:                             # %_ZN8NArchive3N7zL14CompareFoldersERKNS0_7CFolderES3_.exit.i1824
                                        #   in Loop: Header=BB12_107 Depth=2
	bnez	$t1, .LBB12_135
.LBB12_133:                             # %cleanup.cont13.i1827
                                        #   in Loop: Header=BB12_107 Depth=2
	slt	$a3, $s8, $a2
	slt	$a2, $a2, $s8
.LBB12_134:                             # %_ZN8NArchive3N7zL20CompareFolderRepacksEPKNS0_13CFolderRepackES3_Pv.exit1903
                                        #   in Loop: Header=BB12_107 Depth=2
	sub.d	$t1, $a2, $a3
.LBB12_135:                             # %_ZN8NArchive3N7zL20CompareFolderRepacksEPKNS0_13CFolderRepackES3_Pv.exit1903
                                        #   in Loop: Header=BB12_107 Depth=2
	addi.w	$a2, $fp, 0
	blt	$s0, $t1, .LBB12_103
# %bb.136:                              # %cleanup.i.i
...
# %bb.264:                              # %for.cond.cleanup495.loopexit
	...
	ori	$s1, $zero, 1
	b	.LBB12_271
.LBB12_265:                             # %vector.scevcheck2499
                                        #   in Loop: Header=BB12_234 Depth=2
	addi.d	$a4, $a2, -1
	add.w	$a5, $a0, $a4
	move	$a3, $zero
	blt	$a5, $a0, .LBB12_328
# %bb.266:                              # %vector.scevcheck2499
                                        #   in Loop: Header=BB12_234 Depth=2
	srli.d	$a4, $a4, 32
	move	$s4, $a3
	bnez	$a4, .LBB12_239
# %bb.267:                              # %vector.ph2502
                                        #   in Loop: Header=BB12_234 Depth=2
...
# %bb.331:                              # %vector.memcheck2517
                                        #   in Loop: Header=BB12_234 Depth=2
	alsl.d	$a4, $a0, $a1, 3
	alsl.d	$a5, $fp, $a1, 3
	bgeu	$a6, $a4, .LBB12_333
# %bb.332:                              # %vector.memcheck2517
                                        #   in Loop: Header=BB12_234 Depth=2
	ld.d	$a4, $sp, 32                    # 8-byte Folded Reload
	bltu	$a5, $a4, .LBB12_337
.LBB12_333:                             # %vector.ph2525
                                        #   in Loop: Header=BB12_234 Depth=2
	move	$a4, $a2
...
# %bb.418:                              #   in Loop: Header=BB12_386 Depth=3
	...
	b	.LBB12_406
	.p2align	4, , 16
.LBB12_419:                             # %for.end844.split.loop.exit1801
                                        #   in Loop: Header=BB12_383 Depth=2
	move	$s5, $s8
	b	.LBB12_421
.LBB12_420:                             # %for.end844.split.loop.exit1804
                                        #   in Loop: Header=BB12_383 Depth=2
	move	$s5, $s8
	ori	$s1, $zero, 1
	.p2align	4, , 16
