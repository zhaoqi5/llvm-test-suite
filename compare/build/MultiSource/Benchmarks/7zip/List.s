...
# %bb.0:                                # %entry
	...
	bltu	$a4, $a3, .LBB2_3
# %bb.1:                                # %entry
	pcalau12i	$a0, %pc_hi20(_ZL13kPropIdToName)
	addi.d	$a0, $a0, %pc_lo12(_ZL13kPropIdToName)
	slli.d	$a3, $a3, 2
...
.LBB3_11:                               #   in Loop: Header=BB3_3 Depth=1
	move	$s7, $zero
.LBB3_12:                               # %_ZL11PrintSpacesi.exit.i
                                        #   in Loop: Header=BB3_3 Depth=1
	ld.d	$a1, $s4, 8
	move	$a0, $s0
	...
	sub.w	$a0, $s3, $s7
	blez	$a0, .LBB3_2
# %bb.13:                               # %for.body.i6.i.preheader
                                        #   in Loop: Header=BB3_3 Depth=1
	add.d	$a0, $s7, $s5
	sub.w	$s4, $a0, $s6
	.p2align	4, , 16
.LBB3_14:                               # %for.body.i6.i
                                        #   Parent Loop BB3_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ori	$a1, $zero, 32
	move	$a0, $s0
...
.Ltmp91:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp92:                                # EH_LABEL
# %bb.76:                               # %call.i.i.noexc
                                        #   in Loop: Header=BB5_2 Depth=1
	move	$s7, $a0
	st.w	$zero, $a0, 0
.LBB5_77:                               # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i
                                        #   in Loop: Header=BB5_2 Depth=1
	move	$a0, $zero
	.p2align	4, , 16
.LBB5_78:                               # %while.cond.i.i
                                        #   Parent Loop BB5_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.w	$a1, $s3, $a0
	stx.w	$a1, $s7, $a0
...
.LBB5_82:                               # %sw.epilog.i
                                        #   in Loop: Header=BB5_2 Depth=1
	blez	$s3, .LBB5_87
# %bb.83:                               # %for.body.i.i.preheader
                                        #   in Loop: Header=BB5_2 Depth=1
	move	$s1, $s3
	.p2align	4, , 16
.LBB5_84:                               # %for.body.i.i
                                        #   Parent Loop BB5_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
.Ltmp94:                                # EH_LABEL
	ori	$a1, $zero, 32
	...
	jirl	$ra, $ra, 0
.Ltmp95:                                # EH_LABEL
# %bb.85:                               # %call.i.i.noexc70
                                        #   in Loop: Header=BB5_84 Depth=2
	addi.w	$s1, $s1, -1
	bnez	$s1, .LBB5_84
	b	.LBB5_87
.LBB5_86:                               #   in Loop: Header=BB5_2 Depth=1
	move	$s3, $zero
.LBB5_87:                               # %_ZL11PrintSpacesi.exit.i
                                        #   in Loop: Header=BB5_2 Depth=1
.Ltmp97:                                # EH_LABEL
	move	$a0, $s4
	move	$a1, $s7
...
# %bb.88:                               # %call4.i.noexc
	...
	ori	$s2, $zero, 32
	blez	$a0, .LBB5_92
# %bb.89:                               # %for.body.i6.i.preheader
                                        #   in Loop: Header=BB5_2 Depth=1
	add.d	$a0, $s3, $s8
	sub.w	$s1, $a0, $s5
	.p2align	4, , 16
.LBB5_90:                               # %for.body.i6.i
                                        #   Parent Loop BB5_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
.Ltmp100:                               # EH_LABEL
	ori	$a1, $zero, 32
	...
	jirl	$ra, $ra, 0
.Ltmp101:                               # EH_LABEL
# %bb.91:                               # %call.i8.i.noexc
                                        #   in Loop: Header=BB5_90 Depth=2
	bstrpick.d	$a0, $s1, 31, 0
	addi.d	$s1, $a0, 1
	slli.d	$a0, $s1, 31
	bgez	$a0, .LBB5_90
.LBB5_92:                               # %invoke.cont119
                                        #   in Loop: Header=BB5_2 Depth=1
	ld.d	$s8, $sp, 8                     # 8-byte Folded Reload
	ori	$s3, $zero, 3
	beqz	$s7, .LBB5_103
# %bb.93:                               # %delete.notnull.i75
                                        #   in Loop: Header=BB5_2 Depth=1
	move	$a0, $s7
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
...
.LBB5_94:                               #   in Loop: Header=BB5_2 Depth=1
	move	$s7, $zero
.LBB5_95:                               # %_ZL11PrintSpacesi.exit.i126
                                        #   in Loop: Header=BB5_2 Depth=1
	ld.d	$a1, $sp, 64
.Ltmp83:                                # EH_LABEL
	move	$a0, $s4
	...
	jirl	$ra, $ra, 0
.Ltmp84:                                # EH_LABEL
# %bb.96:                               # %call4.i.noexc140
                                        #   in Loop: Header=BB5_2 Depth=1
	sub.w	$a0, $s1, $s7
	blez	$a0, .LBB5_100
# %bb.97:                               # %for.body.i6.i130.preheader
                                        #   in Loop: Header=BB5_2 Depth=1
	add.d	$a0, $s7, $s3
	sub.w	$s1, $a0, $s5
	.p2align	4, , 16
.LBB5_98:                               # %for.body.i6.i130
                                        #   Parent Loop BB5_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
.Ltmp85:                                # EH_LABEL
	ori	$a1, $zero, 32
...
.LBB5_100:                              # %if.end142
	...
	ld.d	$a0, $sp, 64
	beqz	$a0, .LBB5_102
# %bb.101:                              # %delete.notnull.i146
                                        #   in Loop: Header=BB5_2 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB5_102:                              # %_ZN11CStringBaseIwED2Ev.exit147
                                        #   in Loop: Header=BB5_2 Depth=1
	ori	$s3, $zero, 3
.LBB5_103:                              # %if.then95.thread
                                        #   in Loop: Header=BB5_2 Depth=1
	ori	$s1, $zero, 1
	beqz	$s0, .LBB5_105
.LBB5_104:                              # %if.then150
...
.Ltmp111:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp112:                               # EH_LABEL
# %bb.106:                              # %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit
                                        #   in Loop: Header=BB5_2 Depth=1
	beqz	$s1, .LBB5_111
# %bb.107:                              # %for.cond
                                        #   in Loop: Header=BB5_2 Depth=1
...
.Ltmp76:                                # EH_LABEL
	b	.LBB5_130
.LBB5_119:                              # %lpad98.loopexit.split-lp.loopexit.split-lp
.Ltmp67:                                # EH_LABEL
	b	.LBB5_130
.LBB5_120:                              # %lpad118.loopexit.split-lp.loopexit.split-lp
.Ltmp99:                                # EH_LABEL
	b	.LBB5_135
.LBB5_121:                              # %lpad65
.Ltmp73:                                # EH_LABEL
	b	.LBB5_130
.LBB5_122:                              # %lpad128.loopexit.split-lp.loopexit.split-lp
.Ltmp90:                                # EH_LABEL
	b	.LBB5_138
.LBB5_123:                              # %lpad126
.Ltmp79:                                # EH_LABEL
...
.Ltmp51:                                # EH_LABEL
	b	.LBB5_138
.LBB5_125:                              # %lpad98.loopexit.split-lp.loopexit
.Ltmp107:                               # EH_LABEL
	b	.LBB5_130
.LBB5_126:                              # %lpad98.loopexit
.Ltmp70:                                # EH_LABEL
	b	.LBB5_130
.LBB5_127:                              # %lpad39
.Ltmp56:                                # EH_LABEL
...
.LBB5_129:                              # %lpad23
.Ltmp42:                                # EH_LABEL
.LBB5_130:                              # %ehcleanup157
	move	$fp, $a0
	b	.LBB5_140
.LBB5_131:                              # %lpad6
.Ltmp48:                                # EH_LABEL
	b	.LBB5_138
.LBB5_132:                              # %lpad118.loopexit.split-lp.loopexit
.Ltmp96:                                # EH_LABEL
	b	.LBB5_135
.LBB5_133:                              # %lpad128.loopexit.split-lp.loopexit
.Ltmp82:                                # EH_LABEL
	b	.LBB5_138
.LBB5_134:                              # %lpad118.loopexit
.Ltmp102:                               # EH_LABEL
.LBB5_135:                              # %lpad118
	move	$fp, $a0
	beqz	$s7, .LBB5_140
# %bb.136:                              # %delete.notnull.i78
	move	$a0, $s7
	b	.LBB5_139
.LBB5_137:                              # %lpad128.loopexit
.Ltmp87:                                # EH_LABEL
.LBB5_138:                              # %lpad128
	move	$fp, $a0
	ld.d	$a0, $sp, 64
	beqz	$a0, .LBB5_140
.LBB5_139:                              # %delete.notnull.i117
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB5_140:                              # %ehcleanup157
.Ltmp108:                               # EH_LABEL
	addi.d	$a0, $sp, 48
	pcaddu18i	$ra, %call36(_ZN8NWindows4NCOM12CPropVariant5ClearEv)
	jirl	$ra, $ra, 0
.Ltmp109:                               # EH_LABEL
# %bb.141:                              # %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit154
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB5_142:                              # %terminate.lpad.i
.Ltmp113:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB5_143:                              # %terminate.lpad.i153
.Ltmp110:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.Lfunc_end5:
...
.Lcst_begin2:
	...
	.uleb128 .Ltmp105-.Ltmp86               #   Call between .Ltmp86 and .Ltmp105
	.byte	0                               #     has no landing pad
	.byte	0                               #   On action: cleanup
	.uleb128 .Ltmp105-.Lfunc_begin2         # >> Call Site 25 <<
	...
	.byte	1                               #   On action: 1
	.uleb128 .Ltmp57-.Lfunc_begin2          # >> Call Site 27 <<
	.uleb128 .Ltmp58-.Ltmp57                #   Call between .Ltmp57 and .Ltmp58
	.uleb128 .Ltmp107-.Lfunc_begin2         #     jumps to .Ltmp107
	.byte	0                               #   On action: cleanup
	.uleb128 .Ltmp58-.Lfunc_begin2          # >> Call Site 28 <<
	.uleb128 .Ltmp65-.Ltmp58                #   Call between .Ltmp58 and .Ltmp65
	.byte	0                               #     has no landing pad
	.byte	0                               #   On action: cleanup
	.uleb128 .Ltmp65-.Lfunc_begin2          # >> Call Site 29 <<
	.uleb128 .Ltmp66-.Ltmp65                #   Call between .Ltmp65 and .Ltmp66
	.uleb128 .Ltmp67-.Lfunc_begin2          #     jumps to .Ltmp67
	.byte	0                               #   On action: cleanup
	.uleb128 .Ltmp66-.Lfunc_begin2          # >> Call Site 30 <<
	.uleb128 .Ltmp108-.Ltmp66               #   Call between .Ltmp66 and .Ltmp108
	.byte	0                               #     has no landing pad
	.byte	0                               #   On action: cleanup
	.uleb128 .Ltmp108-.Lfunc_begin2         # >> Call Site 31 <<
	.uleb128 .Ltmp109-.Ltmp108              #   Call between .Ltmp108 and .Ltmp109
	.uleb128 .Ltmp110-.Lfunc_begin2         #     jumps to .Ltmp110
	.byte	1                               #   On action: 1
	.uleb128 .Ltmp109-.Lfunc_begin2         # >> Call Site 32 <<
...
# %bb.17:                               # %for.body.i6.i.preheader
	...
	sub.w	$s1, $a0, $fp
	pcalau12i	$a0, %got_pc_hi20(g_StdOut)
	ld.d	$fp, $a0, %got_pc_lo12(g_StdOut)
	.p2align	4, , 16
...
# %bb.8:                                # %middle.block
	beq	$a1, $s3, .LBB8_12
.LBB8_9:                                # %for.body.i.i.preheader
	sub.d	$a2, $s3, $a1
	alsl.d	$a3, $a1, $s2, 2
	alsl.d	$a1, $a1, $a0, 2
	.p2align	4, , 16
.LBB8_10:                               # %for.body.i.i
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a4, $a1, 0
	st.w	$a4, $a3, 0
	addi.d	$a2, $a2, -1
	...
	bnez	$a2, .LBB8_10
	b	.LBB8_12
.LBB8_11:                               # %for.cond.cleanup.i.i
	beqz	$a0, .LBB8_13
.LBB8_12:                               # %delete.notnull.i.i
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	ld.w	$s3, $fp, 8
.LBB8_13:                               # %if.end9.i.i
