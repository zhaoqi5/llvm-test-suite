...
# %bb.2:                                # %if.end
	...
	addi.d	$s4, $a0, %pc_lo12(_ZN8NArchiveL14g_NameToPropIDE)
	slli.d	$a0, $s2, 4
	ldx.w	$a0, $s4, $a0
	ori	$a1, $zero, 2
	st.w	$a0, $sp, 24
...
.LBB3_28:
	move	$s2, $zero
.LBB3_29:                               # %invoke.cont68
.Ltmp165:                               # EH_LABEL
	addi.d	$a0, $sp, 8
	pcaddu18i	$ra, %call36(_ZN8NWindows4NCOM12CPropVariant5ClearEv)
	jirl	$ra, $ra, 0
.Ltmp166:                               # EH_LABEL
# %bb.30:                               # %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit
	beqz	$s2, .LBB3_35
.LBB3_31:                               # %if.end78
.Ltmp174:                               # EH_LABEL
	ori	$a0, $zero, 24
...
.Ltmp179:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp180:                               # EH_LABEL
# %bb.34:                               # %_ZN13CObjectVectorI5CPropE3AddERKS0_.exit
	ld.w	$a0, $s0, 12
	ld.d	$a1, $s0, 16
	move	$s1, $zero
	slli.d	$a2, $a0, 3
...
.Ltmp182:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp183:                               # EH_LABEL
# %bb.52:                               # %_ZN5CPropD2Ev.exit43
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB3_53:                               # %terminate.lpad.i.i42
.Ltmp184:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.Lfunc_end3:
...
.Lcst_begin2:
	...
	.byte	0                               #   On action: cleanup
	.uleb128 .Ltmp136-.Lfunc_begin2         # >> Call Site 5 <<
	.uleb128 .Ltmp142-.Ltmp136              #   Call between .Ltmp136 and .Ltmp142
	.uleb128 .Ltmp143-.Lfunc_begin2         #     jumps to .Ltmp143
	.byte	0                               #   On action: cleanup
	.uleb128 .Ltmp146-.Lfunc_begin2         # >> Call Site 6 <<
	.uleb128 .Ltmp151-.Ltmp146              #   Call between .Ltmp146 and .Ltmp151
	.uleb128 .Ltmp152-.Lfunc_begin2         #     jumps to .Ltmp152
	.byte	0                               #   On action: cleanup
	.uleb128 .Ltmp138-.Lfunc_begin2         # >> Call Site 7 <<
	.uleb128 .Ltmp139-.Ltmp138              #   Call between .Ltmp138 and .Ltmp139
	.uleb128 .Ltmp140-.Lfunc_begin2         #     jumps to .Ltmp140
	.byte	1                               #   On action: 1
	.uleb128 .Ltmp148-.Lfunc_begin2         # >> Call Site 8 <<
	.uleb128 .Ltmp149-.Ltmp148              #   Call between .Ltmp148 and .Ltmp149
	.uleb128 .Ltmp152-.Lfunc_begin2         #     jumps to .Ltmp152
	.byte	0                               #   On action: cleanup
	.uleb128 .Ltmp159-.Lfunc_begin2         # >> Call Site 9 <<
	.uleb128 .Ltmp156-.Ltmp159              #   Call between .Ltmp159 and .Ltmp156
	.uleb128 .Ltmp161-.Lfunc_begin2         #     jumps to .Ltmp161
	.byte	0                               #   On action: cleanup
	.uleb128 .Ltmp165-.Lfunc_begin2         # >> Call Site 10 <<
	...
	.uleb128 .Ltmp162-.Ltmp186              #   Call between .Ltmp186 and .Ltmp162
	.byte	0                               #     has no landing pad
	.byte	0                               #   On action: cleanup
	.uleb128 .Ltmp162-.Lfunc_begin2         # >> Call Site 16 <<
	.uleb128 .Ltmp163-.Ltmp162              #   Call between .Ltmp162 and .Ltmp163
	.uleb128 .Ltmp164-.Lfunc_begin2         #     jumps to .Ltmp164
	.byte	1                               #   On action: 1
	.uleb128 .Ltmp163-.Lfunc_begin2         # >> Call Site 17 <<
	.uleb128 .Ltmp182-.Ltmp163              #   Call between .Ltmp163 and .Ltmp182
	.byte	0                               #     has no landing pad
	.byte	0                               #   On action: cleanup
...
.Ltmp325:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp326:                               # EH_LABEL
# %bb.67:                               # %invoke.cont230
	move	$s1, $a0
	ld.d	$a0, $sp, 40
	beqz	$a0, .LBB14_69
# %bb.68:                               # %delete.notnull.i152
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB14_69:                              # %_ZN11CStringBaseIwED2Ev.exit153
	bnez	$s1, .LBB14_99
# %bb.70:                               # %cleanup.cont239
	ld.w	$a1, $sp, 60
.Ltmp328:                               # EH_LABEL
	move	$a0, $s2
	pcaddu18i	$ra, %call36(_ZN8NWindows4NCOM12CPropVariantaSEj)
...
.Ltmp343:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp344:                               # EH_LABEL
# %bb.82:                               # %invoke.cont194
	move	$s1, $a0
	ld.d	$a0, $sp, 64
	beqz	$a0, .LBB14_84
# %bb.83:                               # %delete.notnull.i143
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB14_84:                              # %_ZN11CStringBaseIwED2Ev.exit144
	bnez	$s1, .LBB14_89
	b	.LBB14_108
.LBB14_85:
	ori	$a0, $zero, 72
...
.LBB14_89:                              # %cleanup293
	ld.d	$a0, $sp, 112
	beqz	$a0, .LBB14_91
# %bb.90:                               # %delete.notnull.i165
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB14_91:                              # %cleanup301
	ld.d	$a0, $sp, 136
	beqz	$a0, .LBB14_93
# %bb.92:                               # %delete.notnull.i171
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB14_93:                              # %_ZN11CStringBaseIwED2Ev.exit172
	move	$a0, $s1
...
.Ltmp346:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp347:                               # EH_LABEL
# %bb.103:                              # %invoke.cont115
	move	$s1, $a0
	bnez	$a0, .LBB14_89
# %bb.104:                              # %cleanup.cont122
	move	$s1, $zero
	ori	$a0, $zero, 1
	st.b	$a0, $s0, 67
	b	.LBB14_89
...
.Ltmp335:                               # EH_LABEL
	b	.LBB14_142
.LBB14_126:                             # %terminate.lpad.i.i159
.Ltmp339:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB14_127:                             # %terminate.lpad.i.i162
.Ltmp336:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB14_128:                             # %lpad206
...
.Ltmp309:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.LBB14_142:                             # %ehcleanup294
	ld.d	$a0, $sp, 112
	bnez	$a0, .LBB14_145
# %bb.143:                              # %ehcleanup302
	ld.d	$a0, $sp, 136
	bnez	$a0, .LBB14_148
.LBB14_144:                             # %_ZN11CStringBaseIwED2Ev.exit175
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB14_145:                             # %delete.notnull.i168
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 136
	beqz	$a0, .LBB14_144
...
.LBB14_146:                             # %lpad
.Ltmp363:                               # EH_LABEL
.LBB14_147:                             # %ehcleanup302
	move	$fp, $a0
	ld.d	$a0, $sp, 136
	beqz	$a0, .LBB14_144
.LBB14_148:                             # %delete.notnull.i174
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
...
# %bb.13:                               # %for.inc
	...
	bne	$s5, $s6, .LBB17_1
	b	.LBB17_15
.LBB17_14:                              # %cleanup9.split.loop.exit31
	move	$s3, $s5
.LBB17_15:                              # %cleanup9
	addi.w	$a0, $s3, 0
	ld.d	$s6, $sp, 24                    # 8-byte Folded Reload
...
# %bb.8:                                # %middle.block
	beq	$a1, $s0, .LBB19_13
.LBB19_9:                               # %for.body.i.i.preheader
	sub.d	$a2, $s0, $a1
	alsl.d	$a3, $a1, $fp, 2
	alsl.d	$a1, $a1, $a0, 2
	.p2align	4, , 16
.LBB19_10:                              # %for.body.i.i
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a4, $a1, 0
	st.w	$a4, $a3, 0
	addi.d	$a2, $a2, -1
...
.LBB19_11:
	...
	move	$a1, $s2
	b	.LBB19_14
.LBB19_12:                              # %for.cond.cleanup.i.i
	move	$a2, $s3
	move	$a1, $s2
	beqz	$a0, .LBB19_14
.LBB19_13:                              # %delete.notnull.i.i
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	move	$a1, $s2
	move	$a2, $s3
