...
.Ltmp131:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp132:                               # EH_LABEL
# %bb.5:                                # %if.then9.invoke.cont13_crit_edge
	ld.d	$a0, $sp, 200
	st.d	$fp, $sp, 8                     # 8-byte Folded Spill
	ld.d	$a0, $a0, 0
	ld.w	$a1, $a0, 8
	beqz	$a1, .LBB31_8
.LBB31_6:                               # %invoke.cont13
	ori	$a2, $zero, 2
	bne	$a1, $a2, .LBB31_9
# %bb.7:                                # %land.lhs.true
	ld.d	$a0, $a0, 0
...
# %bb.52:                               # %invoke.cont90
	...
	ld.d	$a0, $sp, 32
	beqz	$a0, .LBB31_54
# %bb.53:                               # %delete.notnull.i.i67
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB31_54:                              # %invoke.cont96
	vld	$vr0, $sp, 16                   # 16-byte Folded Reload
	vst	$vr0, $sp, 40
	ori	$a0, $zero, 8
	st.d	$a0, $sp, 56
...
# %bb.8:                                # %middle.block
	beq	$a0, $s1, .LBB32_13
.LBB32_9:                               # %for.body.i.i.preheader
	sub.d	$a2, $s1, $a0
	alsl.d	$a3, $a0, $s0, 2
	alsl.d	$a0, $a0, $a1, 2
	.p2align	4, , 16
.LBB32_10:                              # %for.body.i.i
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a4, $a0, 0
	st.w	$a4, $a3, 0
	addi.d	$a2, $a2, -1
...
.LBB32_12:                              # %for.cond.cleanup.i.i
	move	$a0, $s3
	beqz	$a1, .LBB32_14
.LBB32_13:                              # %delete.notnull.i.i
	move	$a0, $a1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	move	$a0, $s3
	ld.w	$s1, $s3, 8
.LBB32_14:                              # %if.end9.i.i
	st.d	$s0, $a0, 0
	slli.d	$a1, $s1, 2
	stx.w	$zero, $s0, $a1
	st.w	$s2, $a0, 12
