...
.LBB2_160:                              # %vector.body
	...
	xvld	$xr3, $a4, %pc_lo12(.LCPI2_2)
	xvpermi.d	$xr4, $xr2, 78
	xvshuf.b	$xr4, $xr4, $xr2, $xr3
	xvslli.d	$xr5, $xr0, 1
	xvslli.d	$xr6, $xr1, 1
...
# %bb.161:                              # %middle.block
                                        #   in Loop: Header=BB2_126 Depth=1
	beq	$a0, $a1, .LBB2_164
.LBB2_162:                              # %for.body323.preheader908
                                        #   in Loop: Header=BB2_126 Depth=1
	alsl.d	$a2, $a1, $s0, 2
	alsl.d	$a3, $a1, $s5, 1
	addi.d	$a3, $a3, 1
...
.Ltmp190:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp191:                               # EH_LABEL
# %bb.177:                              # %for.cond397.preheader
                                        #   in Loop: Header=BB2_126 Depth=1
	beqz	$s3, .LBB2_182
# %bb.178:                              # %for.body399.preheader
                                        #   in Loop: Header=BB2_126 Depth=1
	add.w	$s2, $fp, $s3
	.p2align	4, , 16
.LBB2_179:                              # %for.body399
                                        #   Parent Loop BB2_126 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$s6, $s4, 112
.Ltmp193:                               # EH_LABEL
...
# %bb.181:                              #   in Loop: Header=BB2_126 Depth=1
	move	$fp, $s2
.LBB2_182:                              # %for.cond409.preheader
                                        #   in Loop: Header=BB2_126 Depth=1
	beqz	$s5, .LBB2_198
# %bb.183:                              # %for.body411.preheader
                                        #   in Loop: Header=BB2_126 Depth=1
	move	$s3, $zero
	add.w	$a0, $s7, $s5
	st.d	$a0, $sp, 32                    # 8-byte Folded Spill
.LBB2_184:                              # %for.body411
                                        #   Parent Loop BB2_126 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB2_186 Depth 3
                                        #       Child Loop BB2_190 Depth 3
	ld.w	$a0, $s4, 44
	blez	$a0, .LBB2_188
# %bb.185:                              # %for.body.lr.ph.i450
                                        #   in Loop: Header=BB2_184 Depth=2
	ld.d	$a1, $s4, 48
	addi.d	$a1, $a1, 4
	.p2align	4, , 16
.LBB2_186:                              # %for.body.i453
                                        #   Parent Loop BB2_126 Depth=1
	...
	beq	$a2, $s7, .LBB2_193
# %bb.187:                              # %for.inc.i
                                        #   in Loop: Header=BB2_186 Depth=3
	addi.d	$a0, $a0, -1
	addi.d	$a1, $a1, 8
	bnez	$a0, .LBB2_186
.LBB2_188:                              # %if.else424
	...
	ori	$s6, $zero, 1
	blez	$a0, .LBB2_197
# %bb.189:                              # %for.body.lr.ph.i473
                                        #   in Loop: Header=BB2_184 Depth=2
	ld.d	$a1, $s4, 80
	ld.d	$s2, $sp, 136                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB2_190:                              # %for.body.i476
                                        #   Parent Loop BB2_126 Depth=1
                                        #     Parent Loop BB2_184 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.w	$a2, $a1, 0
...
.Ltmp199:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp200:                               # EH_LABEL
# %bb.194:                              # %_ZN13CRecordVectorIPKyE3AddES1_.exit470
                                        #   in Loop: Header=BB2_184 Depth=2
	alsl.d	$s2, $s2, $s6, 3
.LBB2_195:                              # %for.inc444
                                        #   in Loop: Header=BB2_184 Depth=2
...
.LBB2_197:                              #   in Loop: Header=BB2_126 Depth=1
	...
	b	.LBB2_201
	.p2align	4, , 16
.LBB2_198:                              # %for.cond409.preheader.invoke.cont451_crit_edge
                                        #   in Loop: Header=BB2_126 Depth=1
	ld.d	$a2, $sp, 216
.LBB2_199:                              # %invoke.cont451
                                        #   in Loop: Header=BB2_126 Depth=1
	ld.d	$a0, $sp, 144                   # 8-byte Folded Reload
	ld.d	$a0, $a0, 184
	ld.d	$a1, $a0, 0
...
.LBB2_203:                              # %for.end478
	...
	ld.d	$s2, $sp, 144                   # 8-byte Folded Reload
	beqz	$a0, .LBB2_207
# %bb.204:                              # %for.body.lr.ph.i496
	ld.d	$a1, $sp, 344
	ld.w	$a2, $a1, 0
	ld.d	$a3, $sp, 248
	move	$a1, $zero
	.p2align	4, , 16
.LBB2_205:                              # %for.body.i498
                                        # =>This Inner Loop Header: Depth=1
	alsl.d	$a4, $a1, $a3, 3
	ld.w	$a4, $a4, 4
	bltu	$a2, $a4, .LBB2_209
...
.Ltmp205:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp206:                               # EH_LABEL
# %bb.213:                              # %for.cond498.preheader
	ld.w	$a3, $sp, 452
	blez	$a3, .LBB2_220
# %bb.214:                              # %for.body502.lr.ph
	move	$fp, $zero
	move	$s0, $zero
	.p2align	4, , 16
.LBB2_215:                              # %for.body502
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $sp, 456
	ldx.d	$a0, $a0, $fp
	ld.d	$s1, $a0, 0
...
.LBB2_219:
	move	$s0, $s5
	b	.LBB2_82
.LBB2_220:                              # %for.cond498.preheader.invoke.cont516_crit_edge
	ld.d	$a1, $sp, 216
.LBB2_221:                              # %invoke.cont516
	ld.d	$a0, $s2, 192
...
.Ltmp213:                               # EH_LABEL
	b	.LBB2_274
.LBB2_224:                              # %lpad494.loopexit.split-lp
.Ltmp207:                               # EH_LABEL
	b	.LBB2_274
.LBB2_225:                              # %ehcleanup370.thread
.Ltmp169:                               # EH_LABEL
	b	.LBB2_240
.LBB2_226:                              # %lpad311
.Ltmp172:                               # EH_LABEL
...
.Ltmp175:                               # EH_LABEL
	move	$fp, $a0
.LBB2_228:                              # %ehcleanup366
	beqz	$s0, .LBB2_230
# %bb.229:                              # %delete.notnull.i415
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB2_230:                              # %ehcleanup370
	beqz	$s5, .LBB2_241
# %bb.231:                              # %delete.notnull.i420
	move	$a0, $s5
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	b	.LBB2_241
...
.Ltmp142:                               # EH_LABEL
	b	.LBB2_269
.LBB2_236:                              # %lpad400.loopexit.split-lp
.Ltmp204:                               # EH_LABEL
	b	.LBB2_301
.LBB2_237:                              # %terminate.lpad.i.i534
.Ltmp219:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB2_238:                              # %terminate.lpad.i412
.Ltmp184:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB2_239:                              # %lpad291
.Ltmp166:                               # EH_LABEL
.LBB2_240:                              # %ehcleanup376
	move	$fp, $a0
...
.Ltmp177:                               # EH_LABEL
	b	.LBB2_265
.LBB2_242:                              # %terminate.lpad.i423
.Ltmp178:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB2_243:                              # %lpad242
.Ltmp151:                               # EH_LABEL
.LBB2_244:                              # %ehcleanup268
	move	$fp, $a0
	ld.d	$a0, $sp, 200
	beqz	$a0, .LBB2_311
# %bb.245:                              # %if.then.i378
...
.Ltmp156:                               # EH_LABEL
	b	.LBB2_311
.LBB2_246:                              # %terminate.lpad.i382
.Ltmp157:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB2_247:                              # %terminate.lpad.i357
.Ltmp148:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB2_248:                              # %lpad412
...
.Ltmp198:                               # EH_LABEL
	b	.LBB2_301
.LBB2_250:                              # %terminate.lpad.i431
.Ltmp187:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB2_251:                              # %terminate.lpad.i304
.Ltmp117:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB2_252:                              # %lpad102.body
.Ltmp105:                               # EH_LABEL
	b	.LBB2_262
.LBB2_253:                              # %lpad102.body.thread
.Ltmp102:                               # EH_LABEL
	move	$fp, $a0
	ori	$a1, $zero, 8
	move	$a0, $s3
	...
	jirl	$ra, $ra, 0
	b	.LBB2_263
.LBB2_254:                              # %lpad102.body.thread564
.Ltmp94:                                # EH_LABEL
	b	.LBB2_280
.LBB2_255:                              # %lpad71
.Ltmp84:                                # EH_LABEL
	b	.LBB2_310
.LBB2_256:                              # %terminate.lpad.i536
.Ltmp222:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB2_257:                              # %lpad.i
...
.Ltmp10:                                # EH_LABEL
	move	$fp, $a0
	b	.LBB2_312
.LBB2_261:                              # %lpad102.body.thread572
.Ltmp99:                                # EH_LABEL
.LBB2_262:                              # %if.then.i252
	move	$fp, $a0
.LBB2_263:                              # %if.then.i252
	ld.d	$a0, $s0, 0
	ld.d	$a1, $a0, 16
.Ltmp106:                               # EH_LABEL
	move	$a0, $s0
...
.Ltmp180:                               # EH_LABEL
	b	.LBB2_311
.LBB2_267:                              # %terminate.lpad.i446
.Ltmp181:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB2_268:                              # %lpad194
.Ltmp139:                               # EH_LABEL
.LBB2_269:                              # %ehcleanup233
	move	$fp, $a0
	ld.d	$a0, $sp, 200
	beqz	$a0, .LBB2_311
# %bb.270:                              # %if.then.i363
...
.Ltmp144:                               # EH_LABEL
	b	.LBB2_311
.LBB2_271:                              # %terminate.lpad.i367
.Ltmp145:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB2_272:                              # %terminate.lpad.i256
.Ltmp108:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB2_273:                              # %lpad494.loopexit
.Ltmp210:                               # EH_LABEL
.LBB2_274:                              # %ehcleanup527
	move	$fp, $a0
	b	.LBB2_302
.LBB2_275:                              # %terminate.lpad.i312
.Ltmp120:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB2_276:                              # %terminate.lpad.i319
.Ltmp123:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB2_277:                              # %lpad393
.Ltmp192:                               # EH_LABEL
	b	.LBB2_301
.LBB2_278:                              # %lpad53.loopexit.split-lp
.Ltmp130:                               # EH_LABEL
	b	.LBB2_310
.LBB2_279:                              # %lpad90
.Ltmp87:                                # EH_LABEL
.LBB2_280:                              # %ehcleanup150
	move	$fp, $a0
...
.Ltmp109:                               # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp110:                               # EH_LABEL
.LBB2_283:                              # %_ZN9CMyComPtrI15ICompressCoder2ED2Ev.exit328
	ld.d	$a0, $sp, 200
	beqz	$a0, .LBB2_311
# %bb.284:                              # %if.then.i330
	ld.d	$a1, $a0, 0
...
.Ltmp113:                               # EH_LABEL
	b	.LBB2_311
.LBB2_285:                              # %terminate.lpad.i334
.Ltmp114:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB2_286:                              # %terminate.lpad.i326
.Ltmp111:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB2_287:                              # %lpad479
.Ltmp216:                               # EH_LABEL
	b	.LBB2_310
.LBB2_288:                              # %lpad43.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp
.Ltmp57:                                # EH_LABEL
	b	.LBB2_310
.LBB2_289:                              # %lpad53.loopexit
.Ltmp133:                               # EH_LABEL
	b	.LBB2_310
.LBB2_290:                              # %lpad43.loopexit
.Ltmp71:                                # EH_LABEL
	b	.LBB2_310
.LBB2_291:                              # %lpad7
.Ltmp13:                                # EH_LABEL
...
.Ltmp31:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
	b	.LBB2_305
.LBB2_297:                              # %terminate.lpad.i
.Ltmp43:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB2_298:                              # %terminate.lpad.i177
.Ltmp46:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB2_299:                              # %lpad43.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit
.Ltmp60:                                # EH_LABEL
	b	.LBB2_310
.LBB2_300:                              # %lpad400.loopexit
.Ltmp195:                               # EH_LABEL
.LBB2_301:                              # %ehcleanup459
	move	$fp, $a0
	addi.d	$a0, $sp, 168
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVectorD2Ev)
	jirl	$ra, $ra, 0
.LBB2_302:                              # %ehcleanup527
	addi.d	$a0, $sp, 200
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVectorD2Ev)
	jirl	$ra, $ra, 0
	b	.LBB2_311
.LBB2_303:                              # %lpad43.loopexit.split-lp.loopexit.split-lp.loopexit
.Ltmp65:                                # EH_LABEL
	b	.LBB2_310
.LBB2_304:                              # %lpad24
.Ltmp34:                                # EH_LABEL
	move	$fp, $a0
.LBB2_305:                              # %if.then.i180
	ld.d	$a0, $s1, 0
	ld.d	$a1, $a0, 16
.Ltmp35:                                # EH_LABEL
	move	$a0, $s1
...
.Ltmp39:                                # EH_LABEL
	b	.LBB2_312
.LBB2_307:                              # %terminate.lpad.i191
.Ltmp40:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB2_308:                              # %terminate.lpad.i184
.Ltmp37:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB2_309:                              # %lpad43.loopexit.split-lp.loopexit
.Ltmp68:                                # EH_LABEL
.LBB2_310:                              # %ehcleanup545
	move	$fp, $a0
.LBB2_311:                              # %ehcleanup545
	addi.d	$a0, $sp, 232
	pcaddu18i	$ra, %call36(_ZN8NArchive3N7z11CBindInfoExD2Ev)
	jirl	$ra, $ra, 0
.LBB2_312:                              # %ehcleanup551
	addi.d	$a0, $sp, 392
	pcaddu18i	$ra, %call36(_ZN15CLockedInStreamD2Ev)
	jirl	$ra, $ra, 0
.LBB2_313:                              # %ehcleanup553
	addi.d	$a0, $sp, 440
