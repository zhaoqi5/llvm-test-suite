...
# %bb.1:                                # %for.body.lr.ph
	...
	b	.LBB11_3
	.p2align	4, , 16
.LBB11_2:                               # %_ZN11CStringBaseIwED2Ev.exit21
...
.Ltmp88:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp89:                                # EH_LABEL
# %bb.21:                               # %cleanup17.critedge
	ld.d	$a0, $sp, 8
	beqz	$a0, .LBB11_23
# %bb.22:                               # %delete.notnull.i23
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB11_23:                              # %_ZN11CStringBaseIwED2Ev.exit24
	move	$a0, $zero
.LBB11_24:                              # %cleanup17
	...
	addi.d	$sp, $sp, 112
	ret
.LBB11_25:                              # %lpad.loopexit.split-lp.loopexit.split-lp
.Ltmp90:                                # EH_LABEL
	b	.LBB11_28
.LBB11_26:                              # %lpad.loopexit.split-lp.loopexit
.Ltmp93:                                # EH_LABEL
	b	.LBB11_28
.LBB11_27:                              # %lpad.loopexit
.Ltmp85:                                # EH_LABEL
.LBB11_28:                              # %lpad
	ld.d	$a1, $sp, 8
	beqz	$a1, .LBB11_30
# %bb.29:                               # %delete.notnull.i
	move	$fp, $a0
	move	$a0, $a1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	move	$a0, $fp
.LBB11_30:                              # %_ZN11CStringBaseIwED2Ev.exit
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.Lfunc_end11:
