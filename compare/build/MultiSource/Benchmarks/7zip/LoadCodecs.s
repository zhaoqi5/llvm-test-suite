...
.Ltmp5:                                 # EH_LABEL
	move	$fp, $a0
	beqz	$s2, .LBB1_66
# %bb.58:                               # %delete.notnull.i18
	move	$a0, $s2
	b	.LBB1_64
.LBB1_59:                               # %terminate.lpad.i43
.Ltmp32:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB1_60:                               # %terminate.lpad.i
.Ltmp29:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB1_61:                               # %lpad19
...
# %bb.1:                                # %for.body.lr.ph
	...
	b	.LBB11_3
	.p2align	4, , 16
.LBB11_2:                               # %_ZN11CStringBaseIwED2Ev.exit22
...
.Ltmp88:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp89:                                # EH_LABEL
# %bb.20:                               # %cleanup17.critedge
	ld.d	$a0, $sp, 8
	beqz	$a0, .LBB11_22
# %bb.21:                               # %delete.notnull.i24
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB11_22:                              # %_ZN11CStringBaseIwED2Ev.exit25
	move	$s0, $zero
.LBB11_23:                              # %cleanup17
	move	$a0, $s0
	...
	addi.d	$sp, $sp, 112
	ret
.LBB11_24:                              # %lpad.loopexit.split-lp.loopexit.split-lp
.Ltmp90:                                # EH_LABEL
	b	.LBB11_27
.LBB11_25:                              # %lpad.loopexit.split-lp.loopexit
.Ltmp93:                                # EH_LABEL
	b	.LBB11_27
.LBB11_26:                              # %lpad.loopexit
.Ltmp85:                                # EH_LABEL
.LBB11_27:                              # %lpad
	ld.d	$a1, $sp, 8
	beqz	$a1, .LBB11_29
# %bb.28:                               # %delete.notnull.i
	move	$fp, $a0
	move	$a0, $a1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	move	$a0, $fp
.LBB11_29:                              # %_ZN11CStringBaseIwED2Ev.exit
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.Lfunc_end11:
...
.Lcst_begin7:
	...
	.uleb128 .Ltmp92-.Ltmp86                #   Call between .Ltmp86 and .Ltmp92
	.uleb128 .Ltmp93-.Lfunc_begin7          #     jumps to .Ltmp93
	.byte	0                               #   On action: cleanup
	.uleb128 .Ltmp92-.Lfunc_begin7          # >> Call Site 4 <<
	...
	.byte	0                               #   On action: cleanup
	.uleb128 .Ltmp89-.Lfunc_begin7          # >> Call Site 6 <<
...
.Lcst_begin9:
	...
	.byte	1                               #   On action: 1
	.uleb128 .Ltmp98-.Lfunc_begin9          # >> Call Site 2 <<
...
.Lcst_begin10:
	.uleb128 .Ltmp100-.Lfunc_begin10        # >> Call Site 1 <<
	.uleb128 .Ltmp101-.Ltmp100              #   Call between .Ltmp100 and .Ltmp101
	.uleb128 .Ltmp102-.Lfunc_begin10        #     jumps to .Ltmp102
	.byte	1                               #   On action: 1
	.uleb128 .Ltmp101-.Lfunc_begin10        # >> Call Site 2 <<
	.uleb128 .Lfunc_end15-.Ltmp101          #   Call between .Ltmp101 and .Lfunc_end15
	.byte	0                               #     has no landing pad
	.byte	0                               #   On action: cleanup
.Lcst_end10:
	.byte	1                               # >> Action Record 1 <<
...
.Lcst_begin11:
	.uleb128 .Ltmp103-.Lfunc_begin11        # >> Call Site 1 <<
	.uleb128 .Ltmp104-.Ltmp103              #   Call between .Ltmp103 and .Ltmp104
	.uleb128 .Ltmp105-.Lfunc_begin11        #     jumps to .Ltmp105
	.byte	1                               #   On action: 1
	.uleb128 .Ltmp104-.Lfunc_begin11        # >> Call Site 2 <<
	.uleb128 .Lfunc_end20-.Ltmp104          #   Call between .Ltmp104 and .Lfunc_end20
	.byte	0                               #     has no landing pad
	.byte	0                               #   On action: cleanup
.Lcst_end11:
	.byte	1                               # >> Action Record 1 <<
...
.Lcst_begin12:
	...
	.uleb128 .Ltmp106-.Lfunc_begin12        #   Call between .Lfunc_begin12 and .Ltmp106
	.byte	0                               #     has no landing pad
	.byte	0                               #   On action: cleanup
	...
	.byte	0                               #   On action: cleanup
	.uleb128 .Ltmp114-.Lfunc_begin12        # >> Call Site 4 <<
	.uleb128 .Ltmp115-.Ltmp114              #   Call between .Ltmp114 and .Ltmp115
	.uleb128 .Ltmp116-.Lfunc_begin12        #     jumps to .Ltmp116
	.byte	0                               #   On action: cleanup
	.uleb128 .Ltmp115-.Lfunc_begin12        # >> Call Site 5 <<
	.uleb128 .Lfunc_end22-.Ltmp115          #   Call between .Ltmp115 and .Lfunc_end22
	.byte	0                               #     has no landing pad
	.byte	0                               #   On action: cleanup
.Lcst_end12:
	.p2align	2, 0x0
