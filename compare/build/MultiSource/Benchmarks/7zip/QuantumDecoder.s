...
# %bb.9:                                # %iter.check
	...
	bltu	$a3, $a6, .LBB0_12
# %bb.10:                               # %vector.memcheck103
	addi.d	$a7, $a0, 1416
	add.d	$a6, $a0, $a4
	addi.d	$a6, $a6, 1546
	addi.d	$t0, $a0, 1546
	bgeu	$a7, $a6, .LBB0_28
# %bb.11:                               # %vector.memcheck103
	alsl.d	$a6, $a4, $a0, 1
	addi.d	$a6, $a6, 1416
	bgeu	$t0, $a6, .LBB0_28
.LBB0_12:
...
# %bb.17:                               # %iter.check154
	bstrpick.d	$a4, $a5, 31, 0
	bltu	$a3, $a6, .LBB0_20
# %bb.18:                               # %vector.memcheck145
	addi.d	$a6, $a0, 1620
	add.d	$a7, $a0, $a4
	addi.d	$t0, $a7, 1750
	addi.d	$a7, $a0, 1750
	bgeu	$a6, $t0, .LBB0_30
# %bb.19:                               # %vector.memcheck145
	alsl.d	$t0, $a4, $a0, 1
	addi.d	$t0, $t0, 1620
	bgeu	$a7, $t0, .LBB0_30
.LBB0_20:
...
# %bb.29:
	move	$a6, $zero
	b	.LBB0_36
.LBB0_30:                               # %vector.main.loop.iter.check156
	ori	$t0, $zero, 16
	bgeu	$a3, $t0, .LBB0_39
# %bb.31:
	move	$a3, $zero
	b	.LBB0_43
.LBB0_32:                               # %vector.ph113
...
.LBB0_40:                               # %vector.body162
	...
	addi.d	$a6, $a6, 32
	bnez	$t1, .LBB0_40
# %bb.41:                               # %middle.block169
	beq	$a3, $a4, .LBB0_24
# %bb.42:                               # %vec.epilog.iter.check173
	beqz	$t0, .LBB0_21
.LBB0_43:                               # %vec.epilog.ph175
	move	$a7, $a3
	...
	addi.d	$a7, $a7, 1620
	.p2align	4, , 16
.LBB0_44:                               # %vec.epilog.vector.body186
                                        # =>This Inner Loop Header: Depth=1
	vsub.w	$vr3, $vr0, $vr1
	vpickev.h	$vr3, $vr3, $vr3
	vstelm.d	$vr3, $a7, 0, 0
	...
	addi.d	$a7, $a7, 8
	bnez	$a2, .LBB0_44
# %bb.45:                               # %vec.epilog.middle.block193
	beq	$a3, $a4, .LBB0_24
	b	.LBB0_21
.Lfunc_end0:
...
.LBB2_28:                               # %for.body36.preheader133
	alsl.d	$a5, $a4, $fp, 1
	addi.d	$a5, $a5, 10
	sub.d	$a4, $a2, $a4
	.p2align	4, , 16
...
.LBB2_48:                               # %vec.epilog.ph117
	...
	addi.d	$a2, $a2, -6
	.p2align	4, , 16
.LBB2_49:                               # %vec.epilog.vector.body120
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a2, 0
	...
	addi.d	$a2, $a2, -16
	bnez	$a7, .LBB2_49
# %bb.50:                               # %vec.epilog.middle.block129
	bne	$a1, $a6, .LBB2_43
	b	.LBB2_45
...
# %bb.53:                               # %middle.block111
	beq	$a1, $a4, .LBB2_45
# %bb.54:                               # %vec.epilog.iter.check115
	bnez	$a5, .LBB2_48
# %bb.55:
	sub.d	$a5, $a3, $a4
	b	.LBB2_43
