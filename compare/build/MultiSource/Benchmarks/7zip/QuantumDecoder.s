...
# %bb.9:                                # %iter.check
	...
	bltu	$a3, $a6, .LBB0_12
# %bb.10:                               # %vector.memcheck109
	addi.d	$a7, $a0, 1416
	add.d	$a6, $a0, $a4
	addi.d	$a6, $a6, 1546
	addi.d	$t0, $a0, 1546
	bgeu	$a7, $a6, .LBB0_28
# %bb.11:                               # %vector.memcheck109
	alsl.d	$a6, $a4, $a0, 1
	addi.d	$a6, $a6, 1416
	bgeu	$t0, $a6, .LBB0_28
.LBB0_12:
...
# %bb.17:                               # %iter.check160
	bstrpick.d	$a4, $a5, 31, 0
	bltu	$a3, $a6, .LBB0_20
# %bb.18:                               # %vector.memcheck151
	addi.d	$a6, $a0, 1620
	add.d	$a7, $a0, $a4
	addi.d	$t0, $a7, 1750
	addi.d	$a7, $a0, 1750
	bgeu	$a6, $t0, .LBB0_30
# %bb.19:                               # %vector.memcheck151
	alsl.d	$t0, $a4, $a0, 1
	addi.d	$t0, $t0, 1620
	bgeu	$a7, $t0, .LBB0_30
.LBB0_20:
...
# %bb.29:
	move	$a6, $zero
	b	.LBB0_36
.LBB0_30:                               # %vector.main.loop.iter.check162
	ori	$t0, $zero, 16
	bgeu	$a3, $t0, .LBB0_39
# %bb.31:
	move	$a3, $zero
	b	.LBB0_43
.LBB0_32:                               # %vector.ph119
...
.LBB0_40:                               # %vector.body168
	...
	addi.d	$a6, $a6, 32
	bnez	$t0, .LBB0_40
# %bb.41:                               # %middle.block175
	beq	$a3, $a4, .LBB0_24
# %bb.42:                               # %vec.epilog.iter.check180
	andi	$a6, $a4, 12
	beqz	$a6, .LBB0_21
.LBB0_43:                               # %vec.epilog.ph179
	...
	addi.d	$a7, $a7, 1620
	.p2align	4, , 16
.LBB0_44:                               # %vec.epilog.vector.body193
                                        # =>This Inner Loop Header: Depth=1
	vsub.w	$vr3, $vr0, $vr1
	vpickev.h	$vr3, $vr3, $vr3
	vstelm.d	$vr3, $a7, 0, 0
	...
	addi.d	$a7, $a7, 8
	bnez	$a2, .LBB0_44
# %bb.45:                               # %vec.epilog.middle.block200
	beq	$a3, $a4, .LBB0_24
	b	.LBB0_21
.Lfunc_end0:
...
.LBB2_25:                               # %vector.body80
	...
	addi.d	$a5, $a5, 8
	bnez	$a3, .LBB2_25
# %bb.26:                               # %middle.block84
	beq	$a4, $a2, .LBB2_30
# %bb.27:
	vpickve2gr.h	$a3, $vr0, 3
.LBB2_28:                               # %for.body36.preheader129
	alsl.d	$a5, $a4, $fp, 1
	addi.d	$a5, $a5, 10
	sub.d	$a4, $a2, $a4
	.p2align	4, , 16
...
# %bb.45:                               # %vector.memcheck
	...
	addi.d	$a1, $a1, 8
	bltu	$a1, $a4, .LBB2_40
.LBB2_46:                               # %vector.main.loop.iter.check94
	ori	$a4, $zero, 15
	addi.d	$a1, $a3, 1
	bgeu	$a3, $a4, .LBB2_51
# %bb.47:
	move	$a4, $zero
.LBB2_48:                               # %vec.epilog.ph110
	...
	addi.d	$a2, $a2, -6
	.p2align	4, , 16
.LBB2_49:                               # %vec.epilog.vector.body116
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a2, 0
	...
	addi.d	$a2, $a2, -16
	bnez	$a7, .LBB2_49
# %bb.50:                               # %vec.epilog.middle.block125
	bne	$a1, $a6, .LBB2_41
	b	.LBB2_43
.LBB2_51:                               # %vector.ph95
