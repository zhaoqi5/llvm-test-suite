...
.LBB0_8:                                # %_ZN9NCompress8NQuantum11NRangeCoder13CModelDecoder4InitEj.exit34
	...
	st.w	$a3, $a0, 1412
	beqz	$a2, .LBB0_15
# %bb.9:                                # %for.body.lr.ph.i.1
	ori	$a5, $zero, 16
	bstrpick.d	$a3, $a4, 31, 0
	bltu	$a2, $a5, .LBB0_12
# %bb.10:                               # %vector.memcheck101
	addi.d	$a6, $a0, 1416
	add.d	$a5, $a0, $a3
	addi.d	$a5, $a5, 1546
	addi.d	$a7, $a0, 1546
...
.LBB0_16:                               # %_ZN9NCompress8NQuantum11NRangeCoder13CModelDecoder4InitEj.exit34.1
	...
	st.w	$a3, $a0, 1616
	beqz	$a2, .LBB0_23
# %bb.17:                               # %for.body.lr.ph.i.2
	ori	$a5, $zero, 16
	bstrpick.d	$a3, $a4, 31, 0
	bltu	$a2, $a5, .LBB0_20
# %bb.18:                               # %vector.memcheck124
	addi.d	$a5, $a0, 1620
	add.d	$a2, $a0, $a3
	addi.d	$a2, $a2, 1750
	addi.d	$a6, $a0, 1750
	bgeu	$a5, $a2, .LBB0_31
# %bb.19:                               # %vector.memcheck124
	alsl.d	$a2, $a3, $a0, 1
	addi.d	$a2, $a2, 1620
	bgeu	$a6, $a2, .LBB0_31
.LBB0_20:
...
.LBB2_18:                               # %vector.body77
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB2_18
# %bb.19:                               # %middle.block81
	beq	$a4, $a2, .LBB2_23
# %bb.20:
	vpickve2gr.h	$a3, $vr1, 7
.LBB2_21:                               # %for.body36.preheader104
	alsl.d	$a5, $a4, $fp, 1
	addi.d	$a5, $a5, 10
	sub.d	$a4, $a2, $a4
	.p2align	4, , 16
.LBB2_22:                               # %for.body36
	...
	addi.d	$a5, $a5, 2
	bnez	$a4, .LBB2_22
.LBB2_23:                               # %for.cond55.preheader
	addi.w	$a4, $a2, -1
	beqz	$a4, .LBB2_31
.LBB2_24:                               # %for.body59.preheader
	move	$a7, $zero
	bstrpick.d	$a3, $a4, 31, 0
	addi.d	$a5, $fp, 10
	addi.d	$a6, $fp, 139
...
.LBB2_31:
	move	$a3, $zero
.LBB2_32:                               # %do.body105.preheader
	ori	$a1, $zero, 15
	bltu	$a3, $a1, .LBB2_39
# %bb.33:                               # %do.body105.preheader
	addi.w	$a1, $zero, -1
	lu32i.d	$a1, 0
	beq	$a3, $a1, .LBB2_39
...
.LBB2_37:                               # %vector.body91
	...
	addi.d	$a4, $a4, -16
	bnez	$a6, .LBB2_37
# %bb.38:                               # %middle.block100
	beq	$a1, $a2, .LBB2_41
.LBB2_39:                               # %do.body105.preheader103
	addi.d	$a1, $a3, 1
	alsl.d	$a2, $a3, $fp, 1
	addi.d	$a2, $a2, 8
	.p2align	4, , 16
