...
# %bb.0:                                # %entry
	...
	vld	$vr0, $a1, %pc_lo12(.LCPI0_3)
	pcalau12i	$a4, %pc_hi20(.LCPI0_4)
	vld	$vr3, $a4, %pc_lo12(.LCPI0_4)
	xvst	$xr1, $a0, 396
	xvst	$xr2, $a0, 428
	vst	$vr0, $a0, 526
	vst	$vr3, $a0, 542
	...
	vld	$vr6, $a4, %pc_lo12(.LCPI0_7)
	pcalau12i	$a4, %pc_hi20(.LCPI0_8)
	vld	$vr7, $a4, %pc_lo12(.LCPI0_8)
	xvst	$xr4, $a0, 460
	xvst	$xr5, $a0, 492
	vst	$vr6, $a0, 558
	vst	$vr7, $a0, 574
...
.LBB0_7:
	move	$a5, $zero
.LBB0_8:                                # %_ZN9NCompress8NQuantum11NRangeCoder13CModelDecoder4InitEj.exit34
	alsl.d	$a5, $a5, $a0, 1
	st.h	$zero, $a5, 1212
	sltui	$a5, $a3, 36
	ori	$a6, $zero, 36
...
# %bb.9:                                # %iter.check
	...
	bltu	$a3, $a6, .LBB0_12
# %bb.10:                               # %vector.memcheck107
	addi.d	$a7, $a0, 1416
	add.d	$a6, $a0, $a4
	addi.d	$a6, $a6, 1546
	addi.d	$t0, $a0, 1546
	bgeu	$a7, $a6, .LBB0_28
# %bb.11:                               # %vector.memcheck107
	alsl.d	$a6, $a4, $a0, 1
	addi.d	$a6, $a6, 1416
	bgeu	$t0, $a6, .LBB0_28
.LBB0_12:
	move	$a6, $zero
.LBB0_13:                               # %for.body.i24.1.preheader
	slli.d	$a7, $a6, 1
	addi.d	$a7, $a7, 1416
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB0_14:                               # %for.body.i24.1
                                        # =>This Inner Loop Header: Depth=1
	stx.h	$a5, $a0, $a7
	add.d	$t0, $a0, $a6
	st.b	$a6, $t0, 1546
...
.LBB0_15:
	move	$a4, $zero
.LBB0_16:                               # %_ZN9NCompress8NQuantum11NRangeCoder13CModelDecoder4InitEj.exit34.1
	alsl.d	$a4, $a4, $a0, 1
	st.h	$zero, $a4, 1416
	sltui	$a4, $a3, 42
	ori	$a5, $zero, 42
...
# %bb.17:                               # %iter.check158
	bstrpick.d	$a4, $a5, 31, 0
	bltu	$a3, $a6, .LBB0_20
# %bb.18:                               # %vector.memcheck149
	addi.d	$a6, $a0, 1620
	add.d	$a7, $a0, $a4
	addi.d	$t0, $a7, 1750
	addi.d	$a7, $a0, 1750
	bgeu	$a6, $t0, .LBB0_30
# %bb.19:                               # %vector.memcheck149
	alsl.d	$t0, $a4, $a0, 1
	addi.d	$t0, $t0, 1620
	bgeu	$a7, $t0, .LBB0_30
.LBB0_20:
	move	$a3, $zero
.LBB0_21:                               # %for.body.i24.2.preheader
	slli.d	$a2, $a3, 1
	addi.d	$a2, $a2, 1620
	sub.d	$a5, $a5, $a3
	.p2align	4, , 16
.LBB0_22:                               # %for.body.i24.2
                                        # =>This Inner Loop Header: Depth=1
	stx.h	$a5, $a0, $a2
	add.d	$a6, $a0, $a3
	st.b	$a3, $a6, 1750
...
.LBB0_23:
	move	$a4, $zero
.LBB0_24:                               # %_ZN9NCompress8NQuantum11NRangeCoder13CModelDecoder4InitEj.exit34.2
...
.LBB0_25:                               # %vector.ph96
	andi	$a7, $a5, 24
	vreplgr2vr.w	$vr1, $a6
	pcalau12i	$t0, %pc_hi20(.LCPI0_9)
	vld	$vr2, $t0, %pc_lo12(.LCPI0_9)
	addi.d	$t0, $a0, 1346
	addi.d	$t1, $a0, 1220
	vreplgr2vr.w	$vr3, $a2
	move	$t2, $a7
	.p2align	4, , 16
.LBB0_26:                               # %vector.body97
                                        # =>This Inner Loop Header: Depth=1
	vaddi.bu	$vr4, $vr3, 4
	vsub.w	$vr5, $vr1, $vr2
	vsubi.wu	$vr6, $vr5, 4
...
# %bb.29:
	move	$a6, $zero
	b	.LBB0_36
.LBB0_30:                               # %vector.main.loop.iter.check160
	ori	$t0, $zero, 16
	bgeu	$a3, $t0, .LBB0_39
# %bb.31:
	move	$a3, $zero
	b	.LBB0_43
.LBB0_32:                               # %vector.ph117
	pcalau12i	$a6, %pc_hi20(.LCPI0_10)
	xvld	$xr1, $a6, %pc_lo12(.LCPI0_10)
	pcalau12i	$a6, %pc_hi20(.LCPI0_11)
	xvld	$xr2, $a6, %pc_lo12(.LCPI0_11)
	andi	$a6, $a4, 48
	xvreplgr2vr.w	$xr3, $a5
	move	$t1, $a6
	.p2align	4, , 16
.LBB0_33:                               # %vector.body122
                                        # =>This Inner Loop Header: Depth=1
	xvsub.w	$xr5, $xr3, $xr1
	xvsub.w	$xr6, $xr3, $xr2
	...
	xvpickve2gr.w	$t2, $xr6, 5
	xvreplgr2vr.h	$xr7, $t2
	xvpermi.q	$xr7, $xr4, 18
	xvextrins.h	$xr4, $xr7, 85
	xvpickve2gr.w	$t2, $xr6, 6
	xvreplgr2vr.h	$xr7, $t2
	xvpermi.q	$xr7, $xr4, 18
	xvextrins.h	$xr4, $xr7, 102
	xvpickve2gr.w	$t2, $xr6, 7
	xvreplgr2vr.h	$xr6, $t2
...
# %bb.38:                               # %vec.epilog.middle.block
	beq	$a6, $a4, .LBB0_16
	b	.LBB0_13
.LBB0_39:                               # %vector.ph161
	pcalau12i	$a3, %pc_hi20(.LCPI0_10)
	xvld	$xr0, $a3, %pc_lo12(.LCPI0_10)
	pcalau12i	$a3, %pc_hi20(.LCPI0_11)
	xvld	$xr1, $a3, %pc_lo12(.LCPI0_11)
	vld	$vr2, $a1, %pc_lo12(.LCPI0_3)
	andi	$a3, $a4, 48
	xvreplgr2vr.w	$xr3, $a5
	move	$t0, $a3
	.p2align	4, , 16
.LBB0_40:                               # %vector.body166
                                        # =>This Inner Loop Header: Depth=1
	xvsub.w	$xr5, $xr3, $xr0
	xvsub.w	$xr6, $xr3, $xr1
...
# %bb.41:                               # %middle.block173
	beq	$a3, $a4, .LBB0_24
# %bb.42:                               # %vec.epilog.iter.check178
	andi	$a6, $a4, 12
	beqz	$a6, .LBB0_21
.LBB0_43:                               # %vec.epilog.ph177
	move	$a7, $a3
	pcalau12i	$a3, %pc_hi20(.LCPI0_9)
	vld	$vr1, $a3, %pc_lo12(.LCPI0_9)
	andi	$a3, $a4, 60
	vreplgr2vr.w	$vr0, $a5
	vreplgr2vr.w	$vr2, $a7
	vor.v	$vr1, $vr2, $vr1
	...
	addi.d	$a7, $a7, 1620
	.p2align	4, , 16
.LBB0_44:                               # %vec.epilog.vector.body191
                                        # =>This Inner Loop Header: Depth=1
	vsub.w	$vr3, $vr0, $vr1
	vpickev.h	$vr3, $vr3, $vr3
	vstelm.d	$vr3, $a7, 0, 0
	...
	addi.d	$a7, $a7, 8
	bnez	$a2, .LBB0_44
# %bb.45:                               # %vec.epilog.middle.block198
	beq	$a3, $a4, .LBB0_24
	b	.LBB0_21
.Lfunc_end0:
...
# %bb.18:                               # %_ZN12CLzOutWindow7PutByteEh.exit
                                        #   in Loop: Header=BB1_15 Depth=1
	bne	$s3, $s2, .LBB1_15
.LBB1_19:                               # %while.cond22.preheader
	bnez	$s0, .LBB1_22
	b	.LBB1_79
.LBB1_20:
	ori	$a0, $s2, 14
	b	.LBB1_80
.LBB1_21:                               # %if.end10.thread
	st.w	$s3, $fp, 96
	st.w	$zero, $fp, 168
	beqz	$s0, .LBB1_76
.LBB1_22:                               # %while.body24.lr.ph
	addi.d	$s1, $fp, 88
	addi.d	$s3, $fp, 184
	addi.d	$a0, $fp, 1816
	...
	b	.LBB1_24
	.p2align	4, , 16
.LBB1_23:                               # %_ZN12CLzOutWindow7PutByteEh.exit48
                                        #   in Loop: Header=BB1_24 Depth=1
	addi.w	$s0, $s0, -1
	beqz	$s0, .LBB1_79
.LBB1_24:                               # %while.body24
...
# %bb.41:                               # %if.then66
	...
	b	.LBB1_45
	.p2align	4, , 16
.LBB1_42:                               # %if.end.i.i.i77
                                        #   in Loop: Header=BB1_45 Depth=2
	addi.d	$a1, $a0, 1
	st.d	$a1, $s4, 0
	ld.bu	$a0, $a0, 0
.LBB1_43:                               # %_ZN9CInBuffer8ReadByteEv.exit.i.i73
                                        #   in Loop: Header=BB1_45 Depth=2
	addi.d	$a0, $a0, 256
.LBB1_44:                               # %_ZN9NCompress8NQuantum17CStreamBitDecoder7ReadBitEv.exit.i62
                                        #   in Loop: Header=BB1_45 Depth=2
	slli.d	$a1, $s2, 1
	bstrpick.d	$a2, $a0, 7, 7
	slli.d	$a0, $a0, 1
...
# %bb.47:                               # %if.then.i.i.i71
	...
	b	.LBB1_43
	.p2align	4, , 16
.LBB1_48:                               # %_ZN9NCompress8NQuantum17CStreamBitDecoder8ReadBitsEi.exit79
                                        #   in Loop: Header=BB1_24 Depth=1
	ori	$a0, $zero, 1
...
.LBB2_25:                               # %vector.body85
	...
	addi.d	$a5, $a5, 8
	bnez	$a3, .LBB2_25
# %bb.26:                               # %middle.block89
	beq	$a4, $a2, .LBB2_30
# %bb.27:
	vpickve2gr.h	$a3, $vr0, 3
.LBB2_28:                               # %for.body36.preheader134
	alsl.d	$a5, $a4, $fp, 1
	addi.d	$a5, $a5, 10
	sub.d	$a4, $a2, $a4
	.p2align	4, , 16
.LBB2_29:                               # %for.body36
	...
	addi.d	$a5, $a5, 2
	bnez	$a4, .LBB2_29
.LBB2_30:                               # %for.cond55.preheader
	addi.w	$a4, $a2, -1
	beqz	$a4, .LBB2_38
.LBB2_31:                               # %for.body59.preheader
	move	$a7, $zero
...
# %bb.45:                               # %vector.memcheck
	...
	addi.d	$a1, $a1, 8
	bltu	$a1, $a4, .LBB2_40
.LBB2_46:                               # %vector.main.loop.iter.check99
	ori	$a4, $zero, 15
	addi.d	$a1, $a3, 1
	bgeu	$a3, $a4, .LBB2_51
# %bb.47:
	move	$a4, $zero
.LBB2_48:                               # %vec.epilog.ph115
	bstrpick.d	$a5, $a1, 32, 3
	slli.d	$a6, $a5, 3
	sub.d	$a5, $a3, $a6
	sub.d	$a7, $a4, $a6
	sub.d	$a3, $a3, $a4
	...
	addi.d	$a2, $a2, -6
	.p2align	4, , 16
.LBB2_49:                               # %vec.epilog.vector.body121
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a2, 0
	...
	addi.d	$a2, $a2, -16
	bnez	$a7, .LBB2_49
# %bb.50:                               # %vec.epilog.middle.block130
	bne	$a1, $a6, .LBB2_41
	b	.LBB2_43
.LBB2_51:                               # %vector.ph100
	bstrpick.d	$a4, $a1, 32, 4
	slli.d	$a4, $a4, 4
	addi.d	$a5, $a5, -22
	move	$a6, $a1
	move	$a7, $a4
.LBB2_52:                               # %vector.body103
                                        # =>This Inner Loop Header: Depth=1
	xvld	$xr0, $a5, 0
	...
	addi.d	$a5, $a5, -32
	bnez	$a7, .LBB2_52
# %bb.53:                               # %middle.block111
	beq	$a1, $a4, .LBB2_43
# %bb.54:                               # %vec.epilog.iter.check116
	andi	$a5, $a1, 8
	bnez	$a5, .LBB2_48
# %bb.55:
	sub.d	$a5, $a3, $a4
...
# %bb.20:
	...
	ld.d	$a0, $fp, 56
	beqz	$a0, .LBB3_23
.LBB3_21:                               # %if.then.i.i.i.i
	ld.d	$a1, $a0, 0
	ld.d	$a1, $a1, 16
.Ltmp25:                                # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp26:                                # EH_LABEL
# %bb.22:                               # %call.i.i.i.noexc.i
	st.d	$zero, $fp, 56
...
.Ltmp24:                                # EH_LABEL
	b	.LBB3_33
.LBB3_26:                               # %terminate.lpad.i
.Ltmp29:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB3_27:                               # %lpad19.split.us
.Ltmp19:                                # EH_LABEL
	b	.LBB3_33
.LBB3_28:                               # %lpad8.split.us
.Ltmp16:                                # EH_LABEL
	b	.LBB3_33
.LBB3_29:                               # %lpad38
.Ltmp13:                                # EH_LABEL
...
# %bb.3:                                # %catch5
	...
	jirl	$ra, $ra, 0
	b	.LBB5_5
.LBB5_4:                                # %catch.fallthrough
	pcaddu18i	$ra, %call36(__cxa_begin_catch)
	jirl	$ra, $ra, 0
	ori	$a1, $zero, 2
	ori	$s0, $zero, 1
	bne	$fp, $a1, .LBB5_6
.LBB5_5:                                # %return.sink.split.sink.split
	ld.w	$s0, $a0, 0
...
.LBB15_6:                               # %_ZN10COutBufferD2Ev.exit
	...
	addi.d	$sp, $sp, 16
	ret
.LBB15_7:                               # %terminate.lpad.i.i
.Ltmp53:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB15_8:                               # %terminate.lpad.i.i.i.i
.Ltmp47:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB15_9:                               # %terminate.lpad.i
.Ltmp50:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB15_10:                              # %terminate.lpad.i.i.i
.Ltmp44:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.Lfunc_end15:
