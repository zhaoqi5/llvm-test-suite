...
# %bb.203:
	...
	addi.d	$a6, $zero, -1
	b	.LBB6_213
.LBB6_204:                              # %vector.main.loop.iter.check
	ori	$a2, $zero, 16
	lu12i.w	$a3, -524288
	bgeu	$a0, $a2, .LBB6_206
# %bb.205:
...
.LBB6_210:                              # %vec.epilog.ph
	...
	alsl.d	$a5, $a5, $a1, 2
	.p2align	4, , 16
.LBB6_211:                              # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr5, $a5, 0
	vseq.w	$vr6, $vr5, $vr2
	...
	addi.d	$a5, $a5, 16
	bnez	$a4, .LBB6_211
# %bb.212:                              # %vec.epilog.middle.block
	vbsrl.v	$vr2, $vr1, 8
	vmax.w	$vr1, $vr2, $vr1
	vbsrl.v	$vr2, $vr1, 4
	vmax.w	$vr1, $vr2, $vr1
	...
	or	$a6, $a3, $a5
	beq	$a2, $a0, .LBB6_215
.LBB6_213:                              # %for.body408.preheader
	alsl.d	$a1, $a2, $a1, 2
	sub.d	$a0, $a0, $a2
	.p2align	4, , 16
.LBB6_214:                              # %for.body408
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a3, $a1, 0
	xor	$a5, $a3, $s5
	sltui	$a5, $a5, 1
	...
	addi.d	$a1, $a1, 4
	bnez	$a0, .LBB6_214
.LBB6_215:                              # %for.cond.cleanup407
	addi.w	$a0, $a6, 0
	bltz	$a0, .LBB6_19
# %bb.216:                              # %for.cond.cleanup407
	addi.w	$a1, $a4, 0
	bge	$a0, $a1, .LBB6_19
# %bb.217:                              # %if.then427
	ld.d	$a2, $sp, 440
...
.Ltmp93:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp94:                                # EH_LABEL
# %bb.220:                              # %cleanup354.thread
	ld.d	$a0, $sp, 440
	st.w	$s1, $a0, 0
.LBB6_221:                              # %_ZN7CBufferIhED2Ev.exit315
	move	$a0, $s5
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	ld.d	$s2, $sp, 88                    # 8-byte Folded Reload
...
# %bb.222:
	...
	blt	$a0, $a1, .LBB6_19
	b	.LBB6_193
.LBB6_223:                              # %lpad344.loopexit.split-lp
.Ltmp95:                                # EH_LABEL
	b	.LBB6_242
.LBB6_224:                              # %lpad344.loopexit
.Ltmp90:                                # EH_LABEL
	b	.LBB6_242
.LBB6_225:                              # %lpad95
.Ltmp116:                               # EH_LABEL
...
.LBB6_236:                              # %lpad54
.Ltmp101:                               # EH_LABEL
.LBB6_237:                              # %delete.notnull.i261
	st.d	$s8, $sp, 40                    # 8-byte Folded Spill
	move	$s1, $a0
	b	.LBB6_252
.LBB6_238:                              # %ehcleanup264
.Ltmp98:                                # EH_LABEL
	move	$s1, $a0
	b	.LBB6_253
.LBB6_239:                              # %lpad6
...
.LBB6_241:                              # %lpad294
.Ltmp84:                                # EH_LABEL
.LBB6_242:                              # %delete.notnull.i318
	move	$s1, $a0
	move	$a0, $s5
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	b	.LBB6_283
.LBB6_243:                              # %ehcleanup372
.Ltmp81:                                # EH_LABEL
	b	.LBB6_282
.LBB6_244:                              # %lpad577
.Ltmp189:                               # EH_LABEL
...
# %bb.245:                              # %ehcleanup581
	ld.d	$a0, $sp, 360
	bnez	$a0, .LBB6_258
.LBB6_246:                              # %ehcleanup582
	ld.d	$a0, $sp, 392
	bnez	$a0, .LBB6_260
	b	.LBB6_278
.LBB6_247:                              # %delete.notnull.i530
	move	$a0, $a1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 360
...
.LBB6_249:                              # %lpad187
.Ltmp110:                               # EH_LABEL
.LBB6_250:                              # %ehcleanup254
	move	$s1, $a0
	ld.d	$a0, $sp, 376
	ld.d	$a1, $sp, 24                    # 8-byte Folded Reload
	st.d	$a1, $sp, 360
	beqz	$a0, .LBB6_252
# %bb.251:                              # %delete.notnull.i256
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_252:                              # %delete.notnull.i261
	ld.d	$a0, $sp, 40                    # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_253:                              # %_ZN7CBufferIhED2Ev.exit263
	addi.d	$a0, $sp, 392
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVectorD2Ev)
	jirl	$ra, $ra, 0
	b	.LBB6_283
...
.Ltmp177:                               # EH_LABEL
	...
	move	$s1, $a0
	beqz	$a1, .LBB6_278
# %bb.255:                              # %delete.notnull.i589
	move	$a0, $a1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	b	.LBB6_278
.LBB6_256:                              # %lpad17.loopexit.split-lp.loopexit.split-lp
.Ltmp78:                                # EH_LABEL
	b	.LBB6_282
.LBB6_257:                              # %lpad575
.Ltmp186:                               # EH_LABEL
...
.Ltmp148:                               # EH_LABEL
	b	.LBB6_278
.LBB6_271:                              # %terminate.lpad.i
.Ltmp149:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB6_272:                              # %terminate.lpad.i597
.Ltmp195:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB6_273:                              # %lpad459
...
.Ltmp168:                               # EH_LABEL
	b	.LBB6_277
.LBB6_275:                              # %lpad17.loopexit.split-lp.loopexit
.Ltmp69:                                # EH_LABEL
	b	.LBB6_282
.LBB6_276:                              # %lpad587
.Ltmp171:                               # EH_LABEL
.LBB6_277:                              # %if.then.i600
	move	$s1, $a0
.LBB6_278:                              # %if.then.i600
	ld.d	$a0, $s5, 0
	ld.d	$a1, $a0, 16
.Ltmp190:                               # EH_LABEL
	move	$a0, $s5
...
.Ltmp191:                               # EH_LABEL
	b	.LBB6_283
.LBB6_279:                              # %terminate.lpad.i604
.Ltmp192:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB6_280:                              # %ehcleanup614.thread720
.Ltmp139:                               # EH_LABEL
	b	.LBB6_282
.LBB6_281:                              # %lpad17.loopexit
.Ltmp64:                                # EH_LABEL
.LBB6_282:                              # %ehcleanup625
	move	$s1, $a0
.LBB6_283:                              # %ehcleanup625
	addi.d	$a0, $sp, 424
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVectorD2Ev)
	jirl	$ra, $ra, 0
.LBB6_284:                              # %delete.notnull.i616
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_285:                              # %ehcleanup631
	ld.d	$a0, $sp, 456
	beqz	$a0, .LBB6_287
# %bb.286:                              # %delete.notnull.i620
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_287:                              # %_ZN11CStringBaseIwED2Ev.exit622
	move	$a0, $s1
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.Lfunc_end6:
