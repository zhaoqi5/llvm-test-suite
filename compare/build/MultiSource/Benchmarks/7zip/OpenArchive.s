...
# %bb.71:                               #   in Loop: Header=BB6_22 Depth=1
	ld.d	$s3, $sp, 88                    # 8-byte Folded Reload
	b	.LBB6_82
.LBB6_72:                               # %invoke.cont599.invoke.cont602_crit_edge
                                        #   in Loop: Header=BB6_22 Depth=1
	ld.d	$a0, $sp, 104
	bnez	$a0, .LBB6_85
	b	.LBB6_86
.LBB6_73:                               # %if.end.i.i565
                                        #   in Loop: Header=BB6_22 Depth=1
	slti	$a0, $a0, -1
	slli.d	$a1, $s3, 2
	masknez	$a1, $a1, $a0
...
# %bb.75:                               # %delete.notnull.i.i579
	...
	ld.w	$a0, $a1, 32
	b	.LBB6_81
.LBB6_76:                               # %invoke.cont576.invoke.cont578_crit_edge
                                        #   in Loop: Header=BB6_22 Depth=1
	ld.d	$a0, $sp, 104
	bnez	$a0, .LBB6_94
	b	.LBB6_95
.LBB6_77:                               # %if.end.i.i498
                                        #   in Loop: Header=BB6_22 Depth=1
	slti	$a0, $a0, -1
	slli.d	$a1, $s3, 2
	masknez	$a1, $a1, $a0
...
.Ltmp187:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp188:                               # EH_LABEL
# %bb.78:                               # %call.i.i.noexc513
                                        #   in Loop: Header=BB6_22 Depth=1
	move	$s1, $a0
	ori	$a0, $zero, 1
	blt	$s0, $a0, .LBB6_89
# %bb.79:                               # %delete.notnull.i.i511
                                        #   in Loop: Header=BB6_22 Depth=1
	move	$a0, $s2
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
...
.LBB6_81:                               # %if.end9.i.i568
	...
	move	$s2, $s1
	move	$s3, $a1
.LBB6_82:                               # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i571
                                        #   in Loop: Header=BB6_22 Depth=1
	ld.d	$a0, $sp, 104
	move	$a1, $zero
	.p2align	4, , 16
.LBB6_83:                               # %while.cond.i.i572
                                        #   Parent Loop BB6_22 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.w	$a2, $a0, $a1
	stx.w	$a2, $s2, $a1
	addi.d	$a1, $a1, 4
	bnez	$a2, .LBB6_83
# %bb.84:                               # %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i578
                                        #   in Loop: Header=BB6_22 Depth=1
	ld.w	$a1, $sp, 112
	st.w	$a1, $s3, 32
	beqz	$a0, .LBB6_86
.LBB6_85:                               # %delete.notnull.i525
                                        #   in Loop: Header=BB6_22 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_86:                               # %_ZN11CStringBaseIwED2Ev.exit527
                                        #   in Loop: Header=BB6_22 Depth=1
	move	$s6, $zero
	move	$s1, $zero
.LBB6_87:                               # %if.then.i593
                                        #   in Loop: Header=BB6_22 Depth=1
	ld.d	$a0, $s5, 0
	ld.d	$a1, $a0, 16
.Ltmp193:                               # EH_LABEL
...
.LBB6_90:                               # %if.end9.i.i501
	...
	move	$s2, $s1
	move	$s3, $a1
.LBB6_91:                               # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i504
                                        #   in Loop: Header=BB6_22 Depth=1
	ld.d	$a0, $sp, 104
	move	$a1, $zero
	.p2align	4, , 16
.LBB6_92:                               # %while.cond.i.i505
                                        #   Parent Loop BB6_22 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.w	$a2, $a0, $a1
	stx.w	$a2, $s2, $a1
...
# %bb.93:                               # %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i
	...
	st.w	$a1, $s3, 32
	beqz	$a0, .LBB6_95
.LBB6_94:                               # %delete.notnull.i517
                                        #   in Loop: Header=BB6_22 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_95:                               # %_ZN11CStringBaseIwED2Ev.exit519
                                        #   in Loop: Header=BB6_22 Depth=1
	ld.d	$a0, $sp, 360
	beqz	$a0, .LBB6_97
# %bb.96:                               # %delete.notnull.i521
                                        #   in Loop: Header=BB6_22 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_97:                               # %_ZN11CStringBaseIwED2Ev.exit523
                                        #   in Loop: Header=BB6_22 Depth=1
	ld.d	$a0, $sp, 392
	bnez	$a0, .LBB6_85
	b	.LBB6_86
.LBB6_98:                               # %for.cond.preheader
	vst	$vr0, $sp, 64                   # 16-byte Folded Spill
	st.d	$a0, $sp, 48                    # 8-byte Folded Spill
	ld.w	$a0, $s4, 28
	ori	$s6, $zero, 1
	blt	$a0, $s6, .LBB6_113
# %bb.99:                               # %invoke.cont22.lr.ph
	move	$s7, $zero
	move	$s5, $zero
	.p2align	4, , 16
.LBB6_100:                              # %invoke.cont22
                                        # =>This Loop Header: Depth=1
...
.Ltmp65:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp66:                                # EH_LABEL
# %bb.106:                              # %_ZN13CRecordVectorIiE3AddEi.exit180
                                        #   in Loop: Header=BB6_100 Depth=1
	ld.w	$a0, $sp, 436
	ld.d	$a1, $sp, 440
	slli.d	$a0, $a0, 2
...
.LBB6_112:
	ori	$s8, $zero, 1
	b	.LBB6_148
.LBB6_113:                              # %for.end.thread
	beqz	$s0, .LBB6_147
# %bb.114:                              # %if.end39.thread840
	ld.w	$a0, $sp, 436
	ori	$a1, $zero, 1
	bge	$a1, $a0, .LBB6_120
	b	.LBB6_128
...
.Ltmp70:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp71:                                # EH_LABEL
# %bb.117:                              # %if.end39.thread
	ld.w	$a0, $sp, 436
	bge	$s0, $a0, .LBB6_120
.LBB6_118:                              # %lor.lhs.false
.Ltmp72:                                # EH_LABEL
...
.Ltmp74:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp75:                                # EH_LABEL
# %bb.121:                              # %invoke.cont276
	beqz	$a0, .LBB6_124
# %bb.122:                              # %lor.lhs.false278
.Ltmp76:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp77:                                # EH_LABEL
# %bb.123:                              # %invoke.cont279
                                        # implicit-def: $r29
	bnez	$a0, .LBB6_135
.LBB6_124:                              # %if.end.i273
.Ltmp79:                                # EH_LABEL
	ori	$a0, $zero, 1024
	pcaddu18i	$ra, %call36(_Znam)
	jirl	$ra, $ra, 0
.Ltmp80:                                # EH_LABEL
# %bb.125:                              # %invoke.cont287
	move	$s5, $a0
...
.Ltmp82:                                # EH_LABEL
	...
	jirl	$ra, $a4, 0
.Ltmp83:                                # EH_LABEL
# %bb.126:                              # %invoke.cont295
	move	$s8, $a0
	beqz	$a0, .LBB6_151
# %bb.127:                              # %_ZN7CBufferIhED2Ev.exit314.thread
	move	$a0, $s5
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	b	.LBB6_148
.LBB6_128:                              # %if.end.i189
...
.Ltmp102:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp103:                               # EH_LABEL
# %bb.132:                              # %invoke.cont65
	move	$s6, $a0
	beqz	$a0, .LBB6_171
.LBB6_133:
	move	$s1, $zero
.LBB6_134:                              # %_ZN7CBufferIhED2Ev.exit252
	move	$a0, $s8
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	addi.d	$a0, $sp, 392
...
.Ltmp120:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp121:                               # EH_LABEL
# %bb.138:                              # %invoke.cont389
	move	$s5, $a0
	ld.d	$a0, $sp, 104
	beqz	$a0, .LBB6_140
# %bb.139:                              # %delete.notnull.i337
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_140:                              # %_ZN11CStringBaseIwED2Ev.exit339
.Ltmp123:                               # EH_LABEL
	ori	$a0, $zero, 16
	pcaddu18i	$ra, %call36(_Znam)
	jirl	$ra, $ra, 0
.Ltmp124:                               # EH_LABEL
# %bb.141:                              # %call.i.i.noexc354
...
.Ltmp126:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp127:                               # EH_LABEL
# %bb.142:                              # %invoke.cont397
	move	$s7, $a0
	ld.d	$a0, $sp, 104
	beqz	$a0, .LBB6_144
# %bb.143:                              # %delete.notnull.i358
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_144:                              # %_ZN11CStringBaseIwED2Ev.exit360
	ld.w	$a0, $sp, 436
	ori	$a1, $zero, 1
	blt	$a0, $a1, .LBB6_19
# %bb.145:                              # %iter.check
...
.LBB6_147:
	lu12i.w	$a0, -524284
	ori	$s8, $a0, 1
.LBB6_148:                              # %_ZN11CStringBaseIwED2Ev.exit610
	addi.d	$a0, $sp, 424
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVectorD2Ev)
	jirl	$ra, $ra, 0
	move	$a0, $fp
	...
	ld.d	$a0, $sp, 456
	beqz	$a0, .LBB6_150
# %bb.149:                              # %delete.notnull.i612
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_150:                              # %_ZN11CStringBaseIwED2Ev.exit614
	addi.w	$a0, $s8, 0
...
# %bb.153:                              # %invoke.cont307
	...
	ori	$a1, $zero, 16
	bltu	$a0, $a1, .LBB6_222
# %bb.154:                              # %for.body.i287.preheader
	ld.bu	$a0, $s5, 0
	ori	$a1, $zero, 82
	bne	$a0, $a1, .LBB6_170
# %bb.155:                              # %for.cond.i293
	ld.bu	$a0, $s5, 1
	ori	$a1, $zero, 97
	bne	$a0, $a1, .LBB6_170
# %bb.156:                              # %for.cond.i293.1
	ld.bu	$a0, $s5, 2
	ori	$a1, $zero, 114
	bne	$a0, $a1, .LBB6_170
# %bb.157:                              # %for.cond.i293.2
	ld.bu	$a0, $s5, 3
	ori	$a1, $zero, 33
	bne	$a0, $a1, .LBB6_170
# %bb.158:                              # %for.cond.i293.3
	ld.bu	$a0, $s5, 4
	ori	$a1, $zero, 26
	bne	$a0, $a1, .LBB6_170
# %bb.159:                              # %for.cond.i293.4
	ld.bu	$a0, $s5, 5
	ori	$a1, $zero, 7
	bne	$a0, $a1, .LBB6_170
# %bb.160:                              # %for.cond.i293.5
	ld.bu	$a0, $s5, 6
	bnez	$a0, .LBB6_170
# %bb.161:                              # %for.cond.i293.6
	ld.bu	$a0, $s5, 9
	ori	$a1, $zero, 115
	bne	$a0, $a1, .LBB6_170
# %bb.162:                              # %land.lhs.true325
	ld.bu	$a0, $s5, 10
	andi	$a0, $a0, 1
	beqz	$a0, .LBB6_170
# %bb.163:                              # %for.cond331.preheader
	ld.w	$a0, $sp, 436
	ori	$a1, $zero, 1
	blt	$a0, $a1, .LBB6_170
# %bb.164:                              # %invoke.cont345.lr.ph
	move	$s3, $zero
	move	$s2, $zero
	move	$s7, $zero
	pcalau12i	$a0, %pc_hi20(.L.str.3)
	addi.d	$s6, $a0, %pc_lo12(.L.str.3)
.LBB6_165:                              # %invoke.cont345
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $sp, 440
	ldx.w	$s1, $a0, $s3
	ld.d	$a0, $s4, 32
...
# %bb.169:
	...
	move	$a4, $a7
	b	.LBB6_183
.LBB6_170:                              # %_ZN7CBufferIhED2Ev.exit314.thread849
	move	$a0, $s5
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	move	$s6, $zero
...
# %bb.173:                              # %invoke.cont83
	...
	ld.w	$s6, $sp, 436
	blt	$s0, $s6, .LBB6_192
# %bb.174:                              # %for.cond94.preheader
	ori	$a1, $zero, 1
	move	$a0, $s6
	blt	$s6, $a1, .LBB6_193
# %bb.175:                              # %invoke.cont104.lr.ph
	move	$a1, $zero
	move	$a2, $zero
	ori	$a3, $zero, 2
	addi.d	$a4, $sp, 104
...
# %bb.185:                              # %vec.epilog.middle.block
	...
	or	$a4, $a3, $a4
	beq	$a2, $a0, .LBB6_188
.LBB6_186:                              # %for.body408.preheader
	alsl.d	$a1, $a2, $a1, 2
	sub.d	$a0, $a0, $a2
	.p2align	4, , 16
.LBB6_187:                              # %for.body408
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a3, $a1, 0
	xor	$a5, $a3, $s5
	sltui	$a5, $a5, 1
	...
	addi.d	$a1, $a1, 4
	bnez	$a0, .LBB6_187
.LBB6_188:                              # %for.cond.cleanup407
	addi.w	$a0, $a4, 0
	bltz	$a0, .LBB6_19
# %bb.189:                              # %for.cond.cleanup407
	addi.w	$a1, $a7, 0
	bge	$a0, $a1, .LBB6_19
# %bb.190:                              # %if.then427
	ld.d	$a2, $sp, 440
...
.LBB6_193:                              # %for.end134
	...
	st.d	$a1, $sp, 384
	beqz	$a1, .LBB6_209
# %bb.194:                              # %for.cond139.preheader.lr.ph
...
.LBB6_201:                              # %invoke.cont183
	...
	ld.d	$a0, $a1, 80
	beqz	$a0, .LBB6_200
# %bb.202:                              # %land.lhs.true191
                                        #   in Loop: Header=BB6_201 Depth=2
	ld.d	$a2, $sp, 384
	add.d	$a3, $a0, $s7
	addi.d	$a2, $a2, 1
	bltu	$a2, $a3, .LBB6_200
# %bb.203:                              # %land.lhs.true198
                                        #   in Loop: Header=BB6_201 Depth=2
	ld.d	$a1, $a1, 88
	ld.d	$a2, $sp, 64                    # 8-byte Folded Reload
	.p2align	4, , 16
.LBB6_204:                              # %for.body.i221
                                        #   Parent Loop BB6_196 Depth=1
	...
	ld.bu	$a4, $a1, 0
	bne	$a3, $a4, .LBB6_200
# %bb.205:                              # %for.cond.i223
                                        #   in Loop: Header=BB6_204 Depth=3
	addi.d	$a0, $a0, -1
	addi.d	$a1, $a1, 1
	addi.d	$a2, $a2, 1
	bnez	$a0, .LBB6_204
...
.Ltmp111:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp112:                               # EH_LABEL
# %bb.214:                              # %_ZN13CRecordVectorIiE3AddEi.exit243
                                        #   in Loop: Header=BB6_212 Depth=1
	ld.w	$a0, $sp, 404
	ld.d	$a1, $sp, 408
	slli.d	$a0, $a0, 2
...
.Ltmp93:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp94:                                # EH_LABEL
# %bb.221:                              # %cleanup354.thread
	ld.d	$a0, $sp, 440
	st.w	$s1, $a0, 0
.LBB6_222:                              # %_ZN7CBufferIhED2Ev.exit314
	move	$a0, $s5
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	ld.d	$s3, $sp, 88                    # 8-byte Folded Reload
...
# %bb.223:
	...
	blt	$a0, $a1, .LBB6_19
	b	.LBB6_136
.LBB6_224:                              # %lpad344.loopexit.split-lp
.Ltmp95:                                # EH_LABEL
	b	.LBB6_244
.LBB6_225:                              # %lpad344.loopexit
.Ltmp90:                                # EH_LABEL
	b	.LBB6_244
.LBB6_226:                              # %lpad95
.Ltmp116:                               # EH_LABEL
...
.LBB6_238:                              # %lpad54
.Ltmp101:                               # EH_LABEL
.LBB6_239:                              # %delete.notnull.i260
	st.d	$s8, $sp, 32                    # 8-byte Folded Spill
	move	$s1, $a0
	b	.LBB6_254
.LBB6_240:                              # %ehcleanup264
.Ltmp98:                                # EH_LABEL
	move	$s1, $a0
	b	.LBB6_255
.LBB6_241:                              # %lpad6
...
.LBB6_243:                              # %lpad294
.Ltmp84:                                # EH_LABEL
.LBB6_244:                              # %delete.notnull.i317
	move	$s1, $a0
	move	$a0, $s5
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	b	.LBB6_285
.LBB6_245:                              # %ehcleanup372
.Ltmp81:                                # EH_LABEL
	b	.LBB6_284
.LBB6_246:                              # %lpad577
.Ltmp189:                               # EH_LABEL
...
# %bb.247:                              # %ehcleanup581
	ld.d	$a0, $sp, 360
	bnez	$a0, .LBB6_260
.LBB6_248:                              # %ehcleanup582
	ld.d	$a0, $sp, 392
	bnez	$a0, .LBB6_262
	b	.LBB6_280
.LBB6_249:                              # %delete.notnull.i529
	move	$a0, $a1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 360
...
.LBB6_251:                              # %lpad187
.Ltmp110:                               # EH_LABEL
.LBB6_252:                              # %ehcleanup254
	move	$s1, $a0
	ld.d	$a0, $sp, 376
	ld.d	$a1, $sp, 16                    # 8-byte Folded Reload
	st.d	$a1, $sp, 360
	beqz	$a0, .LBB6_254
# %bb.253:                              # %delete.notnull.i255
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_254:                              # %delete.notnull.i260
	ld.d	$a0, $sp, 32                    # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_255:                              # %_ZN7CBufferIhED2Ev.exit262
	addi.d	$a0, $sp, 392
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVectorD2Ev)
	jirl	$ra, $ra, 0
	b	.LBB6_285
...
.Ltmp177:                               # EH_LABEL
	...
	move	$s1, $a0
	beqz	$a1, .LBB6_280
# %bb.257:                              # %delete.notnull.i589
	move	$a0, $a1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	b	.LBB6_280
.LBB6_258:                              # %lpad17.loopexit.split-lp.loopexit.split-lp
.Ltmp78:                                # EH_LABEL
	b	.LBB6_284
.LBB6_259:                              # %lpad575
.Ltmp186:                               # EH_LABEL
...
.Ltmp148:                               # EH_LABEL
	b	.LBB6_280
.LBB6_273:                              # %terminate.lpad.i
.Ltmp149:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB6_274:                              # %terminate.lpad.i597
.Ltmp195:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB6_275:                              # %lpad459
...
.Ltmp168:                               # EH_LABEL
	b	.LBB6_279
.LBB6_277:                              # %lpad17.loopexit.split-lp.loopexit
.Ltmp69:                                # EH_LABEL
	b	.LBB6_284
.LBB6_278:                              # %lpad587
.Ltmp171:                               # EH_LABEL
.LBB6_279:                              # %if.then.i600
	move	$s1, $a0
...
.Ltmp191:                               # EH_LABEL
	b	.LBB6_285
.LBB6_281:                              # %terminate.lpad.i604
.Ltmp192:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB6_282:                              # %ehcleanup614.thread721
.Ltmp139:                               # EH_LABEL
	b	.LBB6_284
.LBB6_283:                              # %lpad17.loopexit
.Ltmp64:                                # EH_LABEL
.LBB6_284:                              # %ehcleanup625
	move	$s1, $a0
.LBB6_285:                              # %ehcleanup625
	addi.d	$a0, $sp, 424
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVectorD2Ev)
	jirl	$ra, $ra, 0
.LBB6_286:                              # %delete.notnull.i616
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_287:                              # %ehcleanup631
	ld.d	$a0, $sp, 456
	beqz	$a0, .LBB6_289
# %bb.288:                              # %delete.notnull.i620
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_289:                              # %_ZN11CStringBaseIwED2Ev.exit622
	move	$a0, $s1
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.Lfunc_end6:
