...
# %bb.1:                                # %entry
	...
	ori	$a0, $a2, 14
	slli.d	$a1, $a1, 2
	pcalau12i	$a3, %pc_hi20(.LJTI19_0)
	addi.d	$a3, $a3, %pc_lo12(.LJTI19_0)
	ldx.w	$a1, $a3, $a1
	add.d	$a1, $a3, $a1
	jr	$a1
...
# %bb.14:                               # %if.end37
	...
	add.d	$a0, $a1, $a0
	jr	$a0
.LBB30_15:                              # %cleanup50.thread.loopexit24
	ori	$a0, $zero, 1
	b	.LBB30_20
.LBB30_16:                              # %cleanup50.thread.loopexit
	...
	ori	$a0, $a0, 14
	b	.LBB30_20
.LBB30_17:                              # %cleanup50.thread.loopexit23
	lu12i.w	$a0, -524284
	ori	$a0, $a0, 1
	b	.LBB30_20
.LBB30_18:                              # %cleanup50.thread.loopexit20
	lu12i.w	$a0, -524176
	ori	$a0, $a0, 87
	b	.LBB30_20
.LBB30_19:                              # %cleanup50.thread.loopexit25
	lu12i.w	$a0, -524284
	ori	$a0, $a0, 5
.LBB30_20:                              # %return
...
# %bb.17:                               # %for.cond.i14
	...
	ld.bu	$a3, $a0, 1
	bne	$a2, $a3, .LBB34_32
# %bb.18:                               # %for.cond.1.i17
	ld.bu	$a2, $s1, 2
	ld.bu	$a3, $a0, 2
	bne	$a2, $a3, .LBB34_32
# %bb.19:                               # %for.cond.2.i20
	ld.bu	$a2, $s1, 3
	ld.bu	$a3, $a0, 3
	bne	$a2, $a3, .LBB34_32
# %bb.20:                               # %for.cond.3.i23
	ld.bu	$a2, $s1, 4
	ld.bu	$a3, $a0, 4
	bne	$a2, $a3, .LBB34_32
# %bb.21:                               # %for.cond.4.i26
	ld.bu	$a2, $s1, 5
	ld.bu	$a3, $a0, 5
	bne	$a2, $a3, .LBB34_32
# %bb.22:                               # %for.cond.5.i29
	ld.bu	$a2, $s1, 6
	ld.bu	$a3, $a0, 6
	bne	$a2, $a3, .LBB34_32
# %bb.23:                               # %for.cond.6.i32
	ld.bu	$a2, $s1, 7
	ld.bu	$a3, $a0, 7
	bne	$a2, $a3, .LBB34_32
# %bb.24:                               # %for.cond.7.i35
	ld.bu	$a2, $s1, 8
	ld.bu	$a3, $a0, 8
	bne	$a2, $a3, .LBB34_32
# %bb.25:                               # %for.cond.8.i38
	ld.bu	$a2, $s1, 9
	ld.bu	$a3, $a0, 9
	bne	$a2, $a3, .LBB34_32
# %bb.26:                               # %for.cond.9.i41
	ld.bu	$a2, $s1, 10
	ld.bu	$a3, $a0, 10
	bne	$a2, $a3, .LBB34_32
# %bb.27:                               # %for.cond.10.i44
	ld.bu	$a2, $s1, 11
	ld.bu	$a3, $a0, 11
	bne	$a2, $a3, .LBB34_32
# %bb.28:                               # %for.cond.11.i47
	ld.bu	$a2, $s1, 12
	ld.bu	$a3, $a0, 12
	bne	$a2, $a3, .LBB34_32
# %bb.29:                               # %for.cond.12.i50
	ld.bu	$a2, $s1, 13
	ld.bu	$a3, $a0, 13
	bne	$a2, $a3, .LBB34_32
# %bb.30:                               # %for.cond.13.i53
	ld.bu	$a2, $s1, 14
	ld.bu	$a3, $a0, 14
	bne	$a2, $a3, .LBB34_32
# %bb.31:                               # %_ZeqRK4GUIDS1_.exit60
	ld.bu	$a2, $s1, 15
	ld.bu	$a3, $a0, 15
	move	$a0, $fp
	beq	$a2, $a3, .LBB34_72
...
# %bb.33:                               # %for.cond.i62
	...
	ld.bu	$a3, $a0, 1
	bne	$a2, $a3, .LBB34_49
# %bb.34:                               # %for.cond.1.i65
	ld.bu	$a2, $s1, 2
	ld.bu	$a3, $a0, 2
	bne	$a2, $a3, .LBB34_49
# %bb.35:                               # %for.cond.2.i68
	ld.bu	$a2, $s1, 3
	ld.bu	$a3, $a0, 3
	bne	$a2, $a3, .LBB34_49
# %bb.36:                               # %for.cond.3.i71
	ld.bu	$a2, $s1, 4
	ld.bu	$a3, $a0, 4
	bne	$a2, $a3, .LBB34_49
# %bb.37:                               # %for.cond.4.i74
	ld.bu	$a2, $s1, 5
	ld.bu	$a3, $a0, 5
	bne	$a2, $a3, .LBB34_49
# %bb.38:                               # %for.cond.5.i77
	ld.bu	$a2, $s1, 6
	ld.bu	$a3, $a0, 6
	bne	$a2, $a3, .LBB34_49
# %bb.39:                               # %for.cond.6.i80
	ld.bu	$a2, $s1, 7
	ld.bu	$a3, $a0, 7
	bne	$a2, $a3, .LBB34_49
# %bb.40:                               # %for.cond.7.i83
	ld.bu	$a2, $s1, 8
	ld.bu	$a3, $a0, 8
	bne	$a2, $a3, .LBB34_49
# %bb.41:                               # %for.cond.8.i86
	ld.bu	$a2, $s1, 9
	ld.bu	$a3, $a0, 9
	bne	$a2, $a3, .LBB34_49
# %bb.42:                               # %for.cond.9.i89
	ld.bu	$a2, $s1, 10
	ld.bu	$a3, $a0, 10
	bne	$a2, $a3, .LBB34_49
# %bb.43:                               # %for.cond.10.i92
	ld.bu	$a2, $s1, 11
	ld.bu	$a3, $a0, 11
	bne	$a2, $a3, .LBB34_49
# %bb.44:                               # %for.cond.11.i95
	ld.bu	$a2, $s1, 12
	ld.bu	$a3, $a0, 12
	bne	$a2, $a3, .LBB34_49
# %bb.45:                               # %for.cond.12.i98
	ld.bu	$a2, $s1, 13
	ld.bu	$a3, $a0, 13
	bne	$a2, $a3, .LBB34_49
# %bb.46:                               # %for.cond.13.i101
	ld.bu	$a2, $s1, 14
	ld.bu	$a3, $a0, 14
	bne	$a2, $a3, .LBB34_49
# %bb.47:                               # %_ZeqRK4GUIDS1_.exit108
	ld.bu	$a2, $s1, 15
	ld.bu	$a0, $a0, 15
	bne	$a2, $a0, .LBB34_49
# %bb.48:                               # %if.then12
...
# %bb.50:                               # %for.cond.i110
	...
	ld.bu	$a2, $a0, 1
	bne	$a1, $a2, .LBB34_66
# %bb.51:                               # %for.cond.1.i113
	ld.bu	$a1, $s1, 2
	ld.bu	$a2, $a0, 2
	bne	$a1, $a2, .LBB34_66
# %bb.52:                               # %for.cond.2.i116
	ld.bu	$a1, $s1, 3
	ld.bu	$a2, $a0, 3
	bne	$a1, $a2, .LBB34_66
# %bb.53:                               # %for.cond.3.i119
	ld.bu	$a1, $s1, 4
	ld.bu	$a2, $a0, 4
	bne	$a1, $a2, .LBB34_66
# %bb.54:                               # %for.cond.4.i122
	ld.bu	$a1, $s1, 5
	ld.bu	$a2, $a0, 5
	bne	$a1, $a2, .LBB34_66
# %bb.55:                               # %for.cond.5.i125
	ld.bu	$a1, $s1, 6
	ld.bu	$a2, $a0, 6
	bne	$a1, $a2, .LBB34_66
# %bb.56:                               # %for.cond.6.i128
	ld.bu	$a1, $s1, 7
	ld.bu	$a2, $a0, 7
	bne	$a1, $a2, .LBB34_66
# %bb.57:                               # %for.cond.7.i131
	ld.bu	$a1, $s1, 8
	ld.bu	$a2, $a0, 8
	bne	$a1, $a2, .LBB34_66
# %bb.58:                               # %for.cond.8.i134
	ld.bu	$a1, $s1, 9
	ld.bu	$a2, $a0, 9
	bne	$a1, $a2, .LBB34_66
# %bb.59:                               # %for.cond.9.i137
	ld.bu	$a1, $s1, 10
	ld.bu	$a2, $a0, 10
	bne	$a1, $a2, .LBB34_66
# %bb.60:                               # %for.cond.10.i140
	ld.bu	$a1, $s1, 11
	ld.bu	$a2, $a0, 11
	bne	$a1, $a2, .LBB34_66
# %bb.61:                               # %for.cond.11.i143
	ld.bu	$a1, $s1, 12
	ld.bu	$a2, $a0, 12
	bne	$a1, $a2, .LBB34_66
# %bb.62:                               # %for.cond.12.i146
	ld.bu	$a1, $s1, 13
	ld.bu	$a2, $a0, 13
	bne	$a1, $a2, .LBB34_66
# %bb.63:                               # %for.cond.13.i149
	ld.bu	$a1, $s1, 14
	ld.bu	$a2, $a0, 14
	bne	$a1, $a2, .LBB34_66
# %bb.64:                               # %_ZeqRK4GUIDS1_.exit156
	ld.bu	$a1, $s1, 15
	ld.bu	$a0, $a0, 15
	bne	$a1, $a0, .LBB34_66
# %bb.65:                               # %if.then19
