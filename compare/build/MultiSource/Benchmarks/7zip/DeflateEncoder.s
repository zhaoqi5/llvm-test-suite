...
# %bb.0:                                # %invoke.cont
	...
	masknez	$a0, $a0, $a1
	pcalau12i	$a2, %pc_hi20(_ZN9NCompress8NDeflateL11kLenStart64E)
	addi.d	$a2, $a2, %pc_lo12(_ZN9NCompress8NDeflateL11kLenStart64E)
	maskeqz	$a2, $a2, $a1
	or	$a0, $a2, $a0
	st.d	$a0, $s0, 1320
	...
	masknez	$a0, $a0, $a1
	pcalau12i	$a2, %pc_hi20(_ZN9NCompress8NDeflateL16kLenDirectBits64E)
	addi.d	$a2, $a2, %pc_lo12(_ZN9NCompress8NDeflateL16kLenDirectBits64E)
	maskeqz	$a1, $a2, $a1
	or	$a0, $a1, $a0
	st.d	$a0, $s0, 1328
.Ltmp0:                                 # EH_LABEL
...
.LBB10_60:                              # %do.body.i86
	...
	move	$a3, $t1
	bnez	$a5, .LBB10_60
# %bb.61:                               # %_ZN9NCompress8NDeflate8NEncoder6CCoder8BackwardERjj.exit100
...
# %bb.64:                               # %if.then3.i112
	...
	jirl	$ra, $ra, 0
	b	.LBB10_66
.LBB10_65:                              # %if.else.i108
	move	$a0, $t4
	move	$a1, $s0
	move	$fp, $t4
	pcaddu18i	$ra, %call36(Hc3Zip_MatchFinder_Skip)
	jirl	$ra, $ra, 0
.LBB10_66:                              # %if.end.i109
	ld.w	$a0, $fp, 1380
	add.d	$a0, $a0, $s0
	st.w	$a0, $fp, 1380
	move	$t5, $s1
