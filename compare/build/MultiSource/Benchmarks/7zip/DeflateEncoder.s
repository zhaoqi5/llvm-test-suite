...
# %bb.24:                               # %middle.block
                                        #   in Loop: Header=BB10_13 Depth=1
	beq	$t0, $a7, .LBB10_27
.LBB10_25:                              # %while.body.preheader194
                                        #   in Loop: Header=BB10_13 Depth=1
...
.Lfunc_end18:
	.size	_ZN9NCompress8NDeflate8NEncoder21Huffman_GetPrice_SpecEPKjPKhjS5_j, .Lfunc_end18-_ZN9NCompress8NDeflate8NEncoder21Huffman_GetPrice_SpecEPKjPKhjS5_j
                                        # -- End function
	.globl	_ZNK9NCompress8NDeflate8NEncoder6CCoder15GetLzBlockPriceEv # -- Begin function _ZNK9NCompress8NDeflate8NEncoder6CCoder15GetLzBlockPriceEv
	.p2align	2
...
.LBB21_5:                               # %vector.body
	...
	xvseqi.b	$xr2, $xr0, 0
	xvseqi.b	$xr3, $xr1, 0
	xvbitseli.b	$xr2, $xr0, 11
	xvbitseli.b	$xr3, $xr1, 11
	xvst	$xr2, $a0, 1392
	xvst	$xr3, $a0, 1424
	xvld	$xr0, $a1, 64
	xvld	$xr1, $a1, 96
...
# %bb.10:                               # %if.end.i73.peel
	...
	ld.w	$a1, $fp, 1180
	bne	$a0, $a1, .LBB23_12
# %bb.11:                               # %if.then.i.i85.peel
                                        #   in Loop: Header=BB23_7 Depth=1
	ld.d	$a0, $sp, 40                    # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(_ZN10COutBuffer14FlushWithCheckEv)
	jirl	$ra, $ra, 0
.LBB23_12:                              # %_ZN10COutBuffer9WriteByteEh.exit.i82.peel
                                        #   in Loop: Header=BB23_7 Depth=1
	ld.w	$a0, $fp, 1224
	sub.w	$s1, $s1, $s0
	st.w	$s7, $fp, 1224
	...
	ld.d	$s0, $sp, 40                    # 8-byte Folded Reload
	beqz	$s1, .LBB23_30
# %bb.13:                               # %while.body.i69.peel.next
                                        #   in Loop: Header=BB23_7 Depth=1
	srl.w	$s6, $s6, $a0
	b	.LBB23_15
	.p2align	4, , 16
.LBB23_14:                              # %_ZN10COutBuffer9WriteByteEh.exit.i82
...
# %bb.20:                               # %if.end.i40.peel
	...
	ld.w	$a1, $fp, 1180
	bne	$a0, $a1, .LBB23_22
# %bb.21:                               # %if.then.i.i52.peel
                                        #   in Loop: Header=BB23_7 Depth=1
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_ZN10COutBuffer14FlushWithCheckEv)
	jirl	$ra, $ra, 0
.LBB23_22:                              # %_ZN10COutBuffer9WriteByteEh.exit.i49.peel
                                        #   in Loop: Header=BB23_7 Depth=1
	ld.w	$a0, $fp, 1224
	sub.w	$s1, $s1, $s3
	st.w	$s7, $fp, 1224
	st.b	$zero, $fp, 1228
	beqz	$s1, .LBB23_6
# %bb.23:                               # %while.body.i36.peel.next
                                        #   in Loop: Header=BB23_7 Depth=1
	srl.w	$s2, $s2, $a0
	b	.LBB23_25
	.p2align	4, , 16
.LBB23_24:                              # %_ZN10COutBuffer9WriteByteEh.exit.i49
...
.LBB23_29:                              # %if.then.i86
	...
	st.w	$a0, $fp, 1224
	ld.d	$s0, $sp, 40                    # 8-byte Folded Reload
.LBB23_30:                              # %_ZN12CBitlEncoder9WriteBitsEjj.exit94
                                        #   in Loop: Header=BB23_7 Depth=1
	ld.d	$a0, $fp, 1328
	ldx.bu	$s1, $a0, $s3
	beqz	$s1, .LBB23_42
# %bb.31:                               # %while.body.lr.ph.i96
                                        #   in Loop: Header=BB23_7 Depth=1
	ld.d	$a0, $fp, 1320
	ldx.bu	$a1, $a0, $s3
	ld.w	$s3, $fp, 1224
...
# %bb.32:                               # %if.end.i106.peel
	...
	ld.w	$a1, $fp, 1180
	bne	$a0, $a1, .LBB23_34
# %bb.33:                               # %if.then.i.i118.peel
                                        #   in Loop: Header=BB23_7 Depth=1
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_ZN10COutBuffer14FlushWithCheckEv)
	jirl	$ra, $ra, 0
.LBB23_34:                              # %_ZN10COutBuffer9WriteByteEh.exit.i115.peel
                                        #   in Loop: Header=BB23_7 Depth=1
	ld.w	$a0, $fp, 1224
	sub.w	$s1, $s1, $s3
	st.w	$s7, $fp, 1224
	st.b	$zero, $fp, 1228
	beqz	$s1, .LBB23_42
# %bb.35:                               # %while.body.i102.peel.next
                                        #   in Loop: Header=BB23_7 Depth=1
	srl.w	$s2, $s2, $a0
	b	.LBB23_37
	.p2align	4, , 16
.LBB23_36:                              # %_ZN10COutBuffer9WriteByteEh.exit.i115
...
.LBB23_41:                              # %if.then.i119
	...
	sub.d	$a0, $s3, $s1
	st.w	$a0, $fp, 1224
.LBB23_42:                              # %_ZN12CBitlEncoder9WriteBitsEjj.exit127
                                        #   in Loop: Header=BB23_7 Depth=1
	ld.hu	$s5, $s5, 2
...
.LBB23_44:                              # %if.end.i129
	...
	slli.d	$s3, $s2, 2
	beqz	$s1, .LBB23_56
.LBB23_45:                              # %while.body.lr.ph.i135
                                        #   in Loop: Header=BB23_7 Depth=1
...
# %bb.46:                               # %if.end.i145.peel
	...
	ld.w	$a1, $fp, 1180
	bne	$a0, $a1, .LBB23_48
# %bb.47:                               # %if.then.i.i157.peel
                                        #   in Loop: Header=BB23_7 Depth=1
	ld.d	$a0, $sp, 40                    # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(_ZN10COutBuffer14FlushWithCheckEv)
	jirl	$ra, $ra, 0
.LBB23_48:                              # %_ZN10COutBuffer9WriteByteEh.exit.i154.peel
                                        #   in Loop: Header=BB23_7 Depth=1
	ld.w	$a0, $fp, 1224
	sub.w	$s1, $s1, $s0
	st.w	$s7, $fp, 1224
	...
	ld.d	$s0, $sp, 40                    # 8-byte Folded Reload
	beqz	$s1, .LBB23_56
# %bb.49:                               # %while.body.i141.peel.next
                                        #   in Loop: Header=BB23_7 Depth=1
	srl.w	$s6, $s6, $a0
	b	.LBB23_51
	.p2align	4, , 16
.LBB23_50:                              # %_ZN10COutBuffer9WriteByteEh.exit.i154
...
# %bb.52:                               # %if.end.i145
	...
	ld.w	$a1, $fp, 1180
	bne	$a0, $a1, .LBB23_50
# %bb.53:                               # %if.then.i.i157
                                        #   in Loop: Header=BB23_51 Depth=2
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_ZN10COutBuffer14FlushWithCheckEv)
	jirl	$ra, $ra, 0
	b	.LBB23_50
.LBB23_54:                              #   in Loop: Header=BB23_7 Depth=1
	move	$a0, $zero
	ori	$s0, $zero, 8
.LBB23_55:                              # %if.then.i158
                                        #   in Loop: Header=BB23_7 Depth=1
	ld.d	$a1, $sp, 48                    # 8-byte Folded Reload
	sll.w	$a1, $a1, $s1
	andn	$a1, $s6, $a1
	...
	st.w	$a0, $fp, 1224
	ld.d	$s0, $sp, 40                    # 8-byte Folded Reload
.LBB23_56:                              # %_ZN12CBitlEncoder9WriteBitsEjj.exit166
                                        #   in Loop: Header=BB23_7 Depth=1
	ori	$a0, $zero, 4
	bltu	$s2, $a0, .LBB23_6
# %bb.57:                               # %while.body.lr.ph.i168
                                        #   in Loop: Header=BB23_7 Depth=1
...
# %bb.58:                               # %if.end.i178.peel
	...
	ld.w	$a1, $fp, 1180
	bne	$a0, $a1, .LBB23_60
# %bb.59:                               # %if.then.i.i190.peel
                                        #   in Loop: Header=BB23_7 Depth=1
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_ZN10COutBuffer14FlushWithCheckEv)
	jirl	$ra, $ra, 0
.LBB23_60:                              # %_ZN10COutBuffer9WriteByteEh.exit.i187.peel
                                        #   in Loop: Header=BB23_7 Depth=1
	ld.w	$a0, $fp, 1224
	sub.w	$s1, $s1, $s3
	st.w	$s7, $fp, 1224
	st.b	$zero, $fp, 1228
	beqz	$s1, .LBB23_6
# %bb.61:                               # %while.body.i174.peel.next
                                        #   in Loop: Header=BB23_7 Depth=1
	srl.w	$s2, $s2, $a0
	b	.LBB23_63
	.p2align	4, , 16
.LBB23_62:                              # %_ZN10COutBuffer9WriteByteEh.exit.i187
...
# %bb.64:                               # %if.end.i178
	...
	ld.w	$a1, $fp, 1180
	bne	$a0, $a1, .LBB23_62
# %bb.65:                               # %if.then.i.i190
                                        #   in Loop: Header=BB23_63 Depth=2
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_ZN10COutBuffer14FlushWithCheckEv)
	jirl	$ra, $ra, 0
	b	.LBB23_62
.LBB23_66:                              # %for.cond.cleanup
	ori	$a0, $zero, 2192
	ldx.bu	$s1, $fp, $a0
	beqz	$s1, .LBB23_78
...
# %bb.68:                               # %if.end.i.peel
	...
	sub.w	$s1, $s1, $s3
	bne	$a0, $a1, .LBB23_70
# %bb.69:                               # %if.then.i.i.peel
	ld.d	$a0, $sp, 40                    # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(_ZN10COutBuffer14FlushWithCheckEv)
	jirl	$ra, $ra, 0
.LBB23_70:                              # %_ZN10COutBuffer9WriteByteEh.exit.i.peel
	ld.w	$a0, $fp, 1224
	st.w	$s0, $fp, 1224
	st.b	$zero, $fp, 1228
	beqz	$s1, .LBB23_78
# %bb.71:                               # %while.body.i.peel.next
	srl.w	$s2, $s2, $a0
	ori	$s0, $zero, 7
	ori	$s3, $zero, 8
	b	.LBB23_73
	.p2align	4, , 16
.LBB23_72:                              # %_ZN10COutBuffer9WriteByteEh.exit.i
...
.LBB23_77:                              # %if.then.i
	...
	sub.d	$a0, $s3, $s1
	st.w	$a0, $fp, 1224
.LBB23_78:                              # %_ZN12CBitlEncoder9WriteBitsEjj.exit
...
.LBB25_35:                              # %while.end
	...
	st.w	$s3, $s8, 1364
	bnez	$a1, .LBB25_66
# %bb.36:                               # %while.cond23.1
	ld.bu	$a1, $a2, 61
	ori	$s3, $zero, 31
	st.w	$s3, $s8, 1364
	bnez	$a1, .LBB25_66
# %bb.37:                               # %while.cond23.2
	ld.bu	$a1, $a2, 60
	ori	$s3, $zero, 30
	st.w	$s3, $s8, 1364
	bnez	$a1, .LBB25_66
# %bb.38:                               # %while.cond23.3
	ori	$a1, $zero, 2252
	ldx.bu	$a1, $s8, $a1
	ori	$s3, $zero, 29
	st.w	$s3, $s8, 1364
	bnez	$a1, .LBB25_66
# %bb.39:                               # %while.cond23.4
	ld.bu	$a1, $a2, 58
	ori	$s3, $zero, 28
	st.w	$s3, $s8, 1364
	bnez	$a1, .LBB25_66
# %bb.40:                               # %while.cond23.5
	ld.bu	$a1, $a2, 57
	ori	$s3, $zero, 27
	st.w	$s3, $s8, 1364
	bnez	$a1, .LBB25_66
# %bb.41:                               # %while.cond23.6
	ld.bu	$a1, $a2, 56
	ori	$s3, $zero, 26
	st.w	$s3, $s8, 1364
	bnez	$a1, .LBB25_66
# %bb.42:                               # %while.cond23.7
	ori	$a1, $zero, 2248
	ldx.bu	$a1, $s8, $a1
	ori	$s3, $zero, 25
	st.w	$s3, $s8, 1364
	bnez	$a1, .LBB25_66
# %bb.43:                               # %while.cond23.8
	ld.bu	$a1, $a2, 54
	ori	$s3, $zero, 24
	st.w	$s3, $s8, 1364
	bnez	$a1, .LBB25_66
# %bb.44:                               # %while.cond23.9
	ld.bu	$a1, $a2, 53
	ori	$s3, $zero, 23
	st.w	$s3, $s8, 1364
	bnez	$a1, .LBB25_66
# %bb.45:                               # %while.cond23.10
	ld.bu	$a1, $a2, 52
	ori	$s3, $zero, 22
	st.w	$s3, $s8, 1364
	bnez	$a1, .LBB25_66
# %bb.46:                               # %while.cond23.11
	ori	$a1, $zero, 2244
	ldx.bu	$a1, $s8, $a1
	ori	$s3, $zero, 21
	st.w	$s3, $s8, 1364
	bnez	$a1, .LBB25_66
# %bb.47:                               # %while.cond23.12
	ld.bu	$a1, $a2, 50
	ori	$s3, $zero, 20
	st.w	$s3, $s8, 1364
	bnez	$a1, .LBB25_66
# %bb.48:                               # %while.cond23.13
	ld.bu	$a1, $a2, 49
	ori	$s3, $zero, 19
	st.w	$s3, $s8, 1364
	bnez	$a1, .LBB25_66
# %bb.49:                               # %while.cond23.14
	ld.bu	$a1, $a2, 48
	ori	$s3, $zero, 18
	st.w	$s3, $s8, 1364
	bnez	$a1, .LBB25_66
# %bb.50:                               # %while.cond23.15
	ori	$a1, $zero, 2240
	ldx.bu	$a1, $s8, $a1
	ori	$s3, $zero, 17
	st.w	$s3, $s8, 1364
	bnez	$a1, .LBB25_66
# %bb.51:                               # %while.cond23.16
	ld.bu	$a1, $a2, 46
	ori	$s3, $zero, 16
	st.w	$s3, $s8, 1364
	bnez	$a1, .LBB25_66
# %bb.52:                               # %while.cond23.17
	ld.bu	$a1, $a2, 45
	ori	$s3, $zero, 15
	st.w	$s3, $s8, 1364
	bnez	$a1, .LBB25_66
# %bb.53:                               # %while.cond23.18
	ld.bu	$a1, $a2, 44
	ori	$s3, $zero, 14
	st.w	$s3, $s8, 1364
	bnez	$a1, .LBB25_66
# %bb.54:                               # %while.cond23.19
	ori	$a1, $zero, 2236
	ldx.bu	$a1, $s8, $a1
	ori	$s3, $zero, 13
	st.w	$s3, $s8, 1364
	bnez	$a1, .LBB25_66
# %bb.55:                               # %while.cond23.20
	ld.bu	$a1, $a2, 42
	ori	$s3, $zero, 12
	st.w	$s3, $s8, 1364
	bnez	$a1, .LBB25_66
# %bb.56:                               # %while.cond23.21
	ld.bu	$a1, $a2, 41
	ori	$s3, $zero, 11
	st.w	$s3, $s8, 1364
	bnez	$a1, .LBB25_66
# %bb.57:                               # %while.cond23.22
	ld.bu	$a1, $a2, 40
	ori	$s3, $zero, 10
	st.w	$s3, $s8, 1364
	bnez	$a1, .LBB25_66
# %bb.58:                               # %while.cond23.23
	ori	$a1, $zero, 2232
	ldx.bu	$a1, $s8, $a1
	ori	$s3, $zero, 9
	st.w	$s3, $s8, 1364
	bnez	$a1, .LBB25_66
# %bb.59:                               # %while.cond23.24
	ld.bu	$a1, $a2, 38
	ori	$s3, $zero, 8
	st.w	$s3, $s8, 1364
	bnez	$a1, .LBB25_66
# %bb.60:                               # %while.cond23.25
	ld.bu	$a1, $a2, 37
	ori	$s3, $zero, 7
	st.w	$s3, $s8, 1364
	bnez	$a1, .LBB25_66
# %bb.61:                               # %while.cond23.26
	ld.bu	$a1, $a2, 36
	ori	$s3, $zero, 6
	st.w	$s3, $s8, 1364
	bnez	$a1, .LBB25_66
# %bb.62:                               # %while.cond23.27
	ori	$a1, $zero, 2228
	ldx.bu	$a1, $s8, $a1
	ori	$s3, $zero, 5
	st.w	$s3, $s8, 1364
	bnez	$a1, .LBB25_66
# %bb.63:                               # %while.cond23.28
	ld.bu	$a1, $a2, 34
	ori	$s3, $zero, 4
	st.w	$s3, $s8, 1364
	bnez	$a1, .LBB25_66
# %bb.64:                               # %while.cond23.29
	ld.bu	$a1, $a2, 33
	ori	$s3, $zero, 3
	st.w	$s3, $s8, 1364
	bnez	$a1, .LBB25_66
# %bb.65:                               # %while.cond23.30
	ld.bu	$a1, $a2, 32
	sltui	$a1, $a1, 1
	ori	$a2, $zero, 2
	sub.d	$s3, $a2, $a1
...
.LBB25_82:                              # %for.body.lr.ph.i16
	...
	b	.LBB25_86
	.p2align	4, , 16
.LBB25_83:                              # %if.then11.i70
                                        #   in Loop: Header=BB25_86 Depth=1
	slli.d	$t1, $a2, 2
	ldx.w	$t2, $t1, $a6
	add.d	$t2, $t2, $t5
	stx.w	$t2, $t1, $a6
.LBB25_84:                              # %if.end35.i52
                                        #   in Loop: Header=BB25_86 Depth=1
	move	$t5, $zero
	xor	$t1, $a2, $t0
	sltui	$t1, $t1, 1
	...
	sub.w	$t1, $a3, $t1
	move	$t2, $a2
.LBB25_85:                              # %cleanup.i57
                                        #   in Loop: Header=BB25_86 Depth=1
	addi.d	$a0, $a0, 1
	move	$t4, $t5
	move	$a2, $t0
	beq	$s3, $a0, .LBB25_98
.LBB25_86:                              # %for.body.i26
                                        # =>This Inner Loop Header: Depth=1
	ori	$t0, $zero, 255
	bgeu	$a0, $a5, .LBB25_88
# %bb.87:                               # %cond.true.i74
...
# %bb.93:                               # %if.then18.i46
	...
	addi.d	$t2, $t2, 1
	stx.w	$t2, $t1, $a6
.LBB25_94:                              # %if.end22.i50
                                        #   in Loop: Header=BB25_86 Depth=1
	ld.w	$t1, $sp, 152
	addi.d	$t1, $t1, 1
	st.w	$t1, $sp, 152
	b	.LBB25_84
.LBB25_95:                              # %if.else25.i64
                                        #   in Loop: Header=BB25_86 Depth=1
	blt	$a7, $t4, .LBB25_97
# %bb.96:                               # %if.then27.i68
                                        #   in Loop: Header=BB25_86 Depth=1
...
# %bb.7:                                # %for.cond16.preheader
	...
	vpickve2gr.b	$a1, $vr1, 1
	vinsgr2vr.b	$vr2, $a1, 4
	vpickve2gr.b	$a1, $vr1, 2
	vinsgr2vr.b	$vr2, $a1, 8
	vpickve2gr.b	$a1, $vr1, 3
	vinsgr2vr.b	$vr2, $a1, 12
	vpickve2gr.b	$a1, $vr1, 4
	xvpermi.d	$xr3, $xr2, 14
	vinsgr2vr.b	$vr3, $a1, 0
	xvpermi.q	$xr2, $xr3, 2
	vpickve2gr.b	$a1, $vr1, 5
	xvpermi.d	$xr3, $xr2, 14
	vinsgr2vr.b	$vr3, $a1, 4
	xvpermi.q	$xr2, $xr3, 2
	vpickve2gr.b	$a1, $vr1, 6
	xvpermi.d	$xr3, $xr2, 14
	vinsgr2vr.b	$vr3, $a1, 8
	xvpermi.q	$xr2, $xr3, 2
	vpickve2gr.b	$a1, $vr1, 7
