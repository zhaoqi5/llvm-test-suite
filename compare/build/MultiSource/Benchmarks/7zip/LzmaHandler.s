...
# %bb.60:                               # %if.end22
	lu12i.w	$a2, 262144
	bne	$a0, $a2, .LBB11_69
# %bb.61:                               # %cleanup.fold.split49.i
	ori	$a0, $zero, 30
	b	.LBB11_83
.LBB11_62:                              # %if.end22
	lu12i.w	$a2, -524288
	bne	$a0, $a2, .LBB11_69
# %bb.63:                               # %cleanup.fold.split50.i
	ori	$a0, $zero, 31
	b	.LBB11_83
.LBB11_64:                              # %cleanup.fold.split21.i
	ori	$a0, $zero, 2
	b	.LBB11_83
.LBB11_65:                              # %cleanup.fold.split22.i
	ori	$a0, $zero, 3
	b	.LBB11_83
.LBB11_66:                              # %cleanup.fold.split24.i
	ori	$a0, $zero, 5
	b	.LBB11_83
.LBB11_67:                              # %cleanup.fold.split23.i
	ori	$a0, $zero, 4
	b	.LBB11_83
.LBB11_68:                              # %cleanup.fold.split25.i
	ori	$a0, $zero, 6
	b	.LBB11_83
.LBB11_69:                              # %for.inc.31.i
...
# %bb.70:                               # %if.else.i
	...
	or	$a0, $a0, $a3
	b	.LBB11_89
.LBB11_71:                              # %cleanup.fold.split34.i
	ori	$a0, $zero, 15
	b	.LBB11_83
.LBB11_72:                              # %cleanup.fold.split26.i
	ori	$a0, $zero, 7
	b	.LBB11_83
.LBB11_73:                              # %cleanup.fold.split42.i
	ori	$a0, $zero, 23
	b	.LBB11_83
.LBB11_74:                              # %cleanup.fold.split38.i
	ori	$a0, $zero, 19
	b	.LBB11_83
.LBB11_75:                              # %cleanup.fold.split30.i
	ori	$a0, $zero, 11
	b	.LBB11_83
.LBB11_76:                              # %cleanup.fold.split46.i
	ori	$a0, $zero, 27
	b	.LBB11_83
.LBB11_77:                              # %cleanup.fold.split36.i
	ori	$a0, $zero, 17
	b	.LBB11_83
.LBB11_78:                              # %cleanup.fold.split28.i
	ori	$a0, $zero, 9
	b	.LBB11_83
.LBB11_79:                              # %cleanup.fold.split44.i
	ori	$a0, $zero, 25
	b	.LBB11_83
.LBB11_80:                              # %cleanup.fold.split40.i
	ori	$a0, $zero, 21
	b	.LBB11_83
.LBB11_81:                              # %cleanup.fold.split32.i
	ori	$a0, $zero, 13
	b	.LBB11_83
.LBB11_82:                              # %cleanup.fold.split48.i
	ori	$a0, $zero, 29
.LBB11_83:                              # %cleanup.i
.Ltmp77:                                # EH_LABEL
...
.Ltmp89:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp90:                                # EH_LABEL
# %bb.95:                               # %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit19
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB11_96:                              # %terminate.lpad.i18
.Ltmp91:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.Lfunc_end11:
