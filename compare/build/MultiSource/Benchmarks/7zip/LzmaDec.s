...
.LBB2_43:                               #   in Loop: Header=BB2_17 Depth=1
	move	$s7, $zero
.LBB2_44:                               # %while.body86.preheader251
                                        #   in Loop: Header=BB2_17 Depth=1
	move	$a0, $fp
	.p2align	4, , 16
...
.LBB4_6:                                # %if.end.i
	...
	and	$t5, $s4, $a1
	slli.d	$a1, $s0, 4
	bstrpick.d	$a6, $a1, 31, 4
	slli.d	$a1, $a6, 5
	add.d	$a1, $t0, $a1
	addi.w	$s1, $t5, 0
	slli.d	$t8, $s1, 1
	ldx.hu	$s2, $a1, $t8
	bstrpick.d	$t6, $t2, 31, 11
	mul.d	$t7, $t6, $s2
	addi.w	$t6, $t7, 0
	alsl.d	$a1, $s1, $a1, 1
	bgeu	$s3, $t6, .LBB4_18
...
# %bb.90:                               # %if.then684.i
                                        #   in Loop: Header=BB4_4 Depth=2
	bstrpick.d	$a1, $t5, 31, 1
	ori	$a2, $zero, 1
	bstrins.d	$t2, $a2, 63, 1
	ori	$a2, $zero, 13
	bltu	$a2, $t5, .LBB4_118
# %bb.91:                               # %if.then691.i
                                        #   in Loop: Header=BB4_4 Depth=2
...
.LBB4_106:                              # %do.body989.i
	...
	masknez	$a1, $a1, $a2
	bnez	$a6, .LBB4_106
# %bb.107:                              # %do.cond1011.i
                                        #   in Loop: Header=BB4_4 Depth=2
	add.w	$s4, $t5, $s4
	bgeu	$t4, $ra, .LBB4_157
.LBB4_108:                              # %do.cond1011.i
                                        #   in Loop: Header=BB4_4 Depth=2
...
# %bb.110:                              # %iter.check
	...
	ori	$a2, $zero, 64
	bltu	$a1, $a2, .LBB4_154
# %bb.111:                              # %vector.main.loop.iter.check
                                        #   in Loop: Header=BB4_4 Depth=2
	ori	$a1, $zero, 64
	bgeu	$t5, $a1, .LBB4_127
# %bb.112:                              #   in Loop: Header=BB4_4 Depth=2
	move	$s1, $zero
	b	.LBB4_131
.LBB4_113:                              # %if.end275.i
                                        #   in Loop: Header=BB4_4 Depth=2
	sub.w	$t7, $t7, $t2
	sub.w	$s3, $s3, $t2
	srli.d	$a2, $a1, 5
...
# %bb.115:                              # %if.then321.i
	...
	addi.d	$t1, $t1, 1
	or	$s3, $a2, $a1
.LBB4_116:                              # %if.end327.i
                                        #   in Loop: Header=BB4_4 Depth=2
	ld.d	$a1, $sp, 48                    # 8-byte Folded Reload
	ldx.hu	$a1, $a1, $s2
	bstrpick.d	$a2, $a3, 31, 11
	mul.d	$t7, $a2, $a1
	addi.w	$a2, $t7, 0
	bgeu	$s3, $a2, .LBB4_134
# %bb.117:                              # %if.then332.i
	...
	b	.LBB4_135
.LBB4_118:                              # %if.else741.i
                                        #   in Loop: Header=BB4_4 Depth=2
	addi.d	$a6, $a1, -5
	b	.LBB4_121
	.p2align	4, , 16
.LBB4_119:                              # %if.then746.i
...
# %bb.122:                              #   in Loop: Header=BB4_121 Depth=3
	move	$t5, $t7
	b	.LBB4_120
.LBB4_123:                              # %do.end766.i
                                        #   in Loop: Header=BB4_4 Depth=2
	bstrpick.d	$a1, $t5, 31, 25
	bnez	$a1, .LBB4_125
# %bb.124:                              # %if.then775.i
                                        #   in Loop: Header=BB4_4 Depth=2
	ld.bu	$a1, $t1, 0
...
# %bb.126:                              # %if.then786.i
	...
	add.d	$a1, $a1, $a2
	ori	$t2, $zero, 2
	bstrpick.d	$a2, $t8, 31, 24
	st.h	$a1, $t0, 1606
	beqz	$a2, .LBB4_138
	b	.LBB4_139
.LBB4_127:                              # %vector.ph
                                        #   in Loop: Header=BB4_4 Depth=2
	bstrpick.d	$a1, $t5, 31, 6
	slli.d	$s1, $a1, 6
	ld.d	$a1, $sp, 16                    # 8-byte Folded Reload
	add.d	$a1, $a1, $t4
	move	$t8, $s1
	.p2align	4, , 16
.LBB4_128:                              # %vector.body
                                        #   Parent Loop BB4_1 Depth=1
                                        #     Parent Loop BB4_4 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	add.d	$a2, $a1, $a6
...
.LBB4_131:                              # %vec.epilog.ph
	...
	add.d	$t6, $fp, $a2
	.p2align	4, , 16
.LBB4_132:                              # %vec.epilog.vector.body
                                        #   Parent Loop BB4_1 Depth=1
                                        #     Parent Loop BB4_4 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vldx	$vr0, $t6, $a6
	...
	addi.d	$t6, $t6, 16
	bnez	$s2, .LBB4_132
# %bb.133:                              # %vec.epilog.middle.block
                                        #   in Loop: Header=BB4_4 Depth=2
	bne	$t5, $a1, .LBB4_154
	b	.LBB4_156
.LBB4_134:                              # %if.else337.i
                                        #   in Loop: Header=BB4_4 Depth=2
	sub.w	$s3, $s3, $t7
	sub.w	$t7, $a3, $t7
	srli.d	$a2, $a1, 5
...
.LBB4_138:                              # %if.then811.i
	...
	addi.d	$t1, $t1, 1
	or	$s3, $a2, $a1
.LBB4_139:                              # %if.end817.i
                                        #   in Loop: Header=BB4_4 Depth=2
	slli.d	$a6, $t2, 1
	ld.d	$a1, $sp, 72                    # 8-byte Folded Reload
	ldx.hu	$a1, $a1, $a6
	bstrpick.d	$a2, $t8, 31, 11
	mul.d	$s1, $a2, $a1
	addi.w	$a2, $s1, 0
	bgeu	$s3, $a2, .LBB4_141
# %bb.140:                              # %if.then822.i
...
.LBB4_153:                              #   in Loop: Header=BB4_4 Depth=2
	add.d	$t8, $t7, $s1
.LBB4_154:                              # %do.body981.i.preheader
                                        #   in Loop: Header=BB4_4 Depth=2
	add.d	$a1, $t7, $t5
	.p2align	4, , 16
.LBB4_155:                              # %do.body981.i
                                        #   Parent Loop BB4_1 Depth=1
                                        #     Parent Loop BB4_4 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ldx.b	$a2, $t8, $a6
	...
	addi.d	$t8, $t8, 1
	bne	$t8, $a1, .LBB4_155
.LBB4_156:                              # %do.cond1011.loopexit832.i
                                        #   in Loop: Header=BB4_4 Depth=2
	add.d	$t4, $t5, $t4
	add.w	$s4, $t5, $s4
	bltu	$t4, $ra, .LBB4_108
	.p2align	4, , 16
.LBB4_157:                              # %do.end1016.i
                                        #   in Loop: Header=BB4_1 Depth=1
	bstrpick.d	$a1, $t2, 31, 24
	bnez	$a1, .LBB4_159
.LBB4_158:                              # %if.then1019.i
                                        #   in Loop: Header=BB4_1 Depth=1
	ld.bu	$a1, $t1, 0
	slli.d	$t2, $t2, 8
	slli.d	$a2, $s3, 8
...
.LBB4_164:                              # %if.end22.i
	...
	st.w	$a2, $a0, 92
	beqz	$a1, .LBB4_167
# %bb.165:                              # %while.body.lr.ph.i
                                        #   in Loop: Header=BB4_1 Depth=1
	bstrpick.d	$a3, $s5, 31, 0
	sub.d	$t0, $a4, $a3
	.p2align	4, , 16
.LBB4_166:                              # %while.body.i
                                        #   Parent Loop BB4_1 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	sltu	$a2, $t4, $a3
	maskeqz	$a2, $a6, $a2
...
.LBB4_169:                              # %do.cond
                                        #   in Loop: Header=BB4_1 Depth=1
	bgeu	$t4, $t1, .LBB4_175
.LBB4_170:                              # %land.lhs.true
                                        #   in Loop: Header=BB4_1 Depth=1
	ld.d	$a2, $a0, 32
	ld.w	$a1, $a0, 92
	ld.d	$a3, $sp, 168                   # 8-byte Folded Reload
	bgeu	$a2, $a3, .LBB4_176
# %bb.171:                              # %land.lhs.true
                                        #   in Loop: Header=BB4_1 Depth=1
	ori	$a2, $zero, 274
	bltu	$a1, $a2, .LBB4_1
	b	.LBB4_176
.LBB4_172:                              # %cleanup1005.i
                                        #   in Loop: Header=BB4_1 Depth=1
	addi.w	$a3, $a3, 274
	addi.d	$s0, $s0, -12
	move	$t2, $a1
...
.LBB4_174:                              # %return
	...
	addi.d	$sp, $sp, 272
	ret
.LBB4_175:                              # %do.cond.do.end_crit_edge
	ld.w	$a1, $a0, 92
.LBB4_176:                              # %do.end
	ori	$a2, $zero, 275
	bltu	$a1, $a2, .LBB4_178
