...
# %bb.115:                              # %if.then332.i
	...
	b	.LBB4_139
.LBB4_116:                              # %if.else741.i
                                        #   in Loop: Header=BB4_4 Depth=2
	addi.d	$a1, $a1, -5
	b	.LBB4_119
	.p2align	4, , 16
.LBB4_117:                              # %if.then746.i
                                        #   in Loop: Header=BB4_119 Depth=3
	ld.bu	$t5, $t1, 0
	slli.d	$a3, $a6, 8
	slli.d	$a6, $s3, 8
	addi.d	$t1, $t1, 1
	or	$s3, $a6, $t5
.LBB4_118:                              # %if.end752.i
                                        #   in Loop: Header=BB4_119 Depth=3
...
.LBB4_125:                              # %vector.ph
                                        #   in Loop: Header=BB4_4 Depth=2
	andi	$a6, $s1, 48
	bstrpick.d	$t5, $s1, 31, 6
	slli.d	$t5, $t5, 6
	addi.d	$a2, $fp, 32
	add.d	$t7, $a2, $t4
	move	$t8, $t5
	.p2align	4, , 16
.LBB4_126:                              # %vector.body
                                        #   Parent Loop BB4_1 Depth=1
                                        #     Parent Loop BB4_4 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	add.d	$t6, $t7, $a1
...
.LBB4_129:                              # %vec.epilog.ph
	...
	add.d	$t5, $fp, $t5
	.p2align	4, , 16
.LBB4_130:                              # %vec.epilog.vector.body
                                        #   Parent Loop BB4_1 Depth=1
                                        #     Parent Loop BB4_4 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vldx	$vr0, $t5, $a1
...
# %bb.131:                              # %vec.epilog.middle.block
                                        #   in Loop: Header=BB4_4 Depth=2
	beq	$s1, $t7, .LBB4_134
.LBB4_132:                              # %do.body981.i.preheader
                                        #   in Loop: Header=BB4_4 Depth=2
	add.d	$a3, $a3, $s1
	.p2align	4, , 16
.LBB4_133:                              # %do.body981.i
                                        #   Parent Loop BB4_1 Depth=1
                                        #     Parent Loop BB4_4 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ldx.b	$t5, $a6, $a1
	...
	addi.d	$a6, $a6, 1
	bne	$a6, $a3, .LBB4_133
.LBB4_134:                              # %do.cond1011.loopexit832.i
                                        #   in Loop: Header=BB4_4 Depth=2
	add.d	$t4, $s1, $t4
.LBB4_135:                              # %do.cond1011.i
                                        #   in Loop: Header=BB4_4 Depth=2
	ld.d	$a2, $sp, 96                    # 8-byte Folded Reload
.LBB4_136:                              # %do.cond1011.i
	...
	add.w	$s4, $s1, $s4
	bgeu	$t4, $ra, .LBB4_159
# %bb.137:                              # %do.cond1011.i
                                        #   in Loop: Header=BB4_4 Depth=2
	bltu	$t1, $s8, .LBB4_4
	b	.LBB4_159
.LBB4_138:                              # %if.else337.i
                                        #   in Loop: Header=BB4_4 Depth=2
	sub.w	$s3, $s3, $a6
	sub.w	$a6, $a1, $a6
	srli.d	$a1, $a3, 5
...
# %bb.156:                              #   in Loop: Header=BB4_4 Depth=2
	move	$a4, $a3
	b	.LBB4_99
.LBB4_157:                              #   in Loop: Header=BB4_4 Depth=2
	add.d	$a6, $a3, $t5
	b	.LBB4_132
