...
# %bb.35:                               # %middle.block
                                        #   in Loop: Header=BB3_3 Depth=1
	beq	$a0, $a1, .LBB3_39
.LBB3_36:                               # %for.body31.preheader122
                                        #   in Loop: Header=BB3_3 Depth=1
	move	$a0, $s0
	addi.d	$a1, $s0, 1
	slt	$a2, $fp, $a1
...
.LBB9_35:                               # %if.then2.i42
	...
	b	.LBB9_31
	.p2align	4, , 16
.LBB9_36:                               # %_ZN12CLzOutWindow7PutByteEh.exit59
                                        #   in Loop: Header=BB9_37 Depth=2
	addi.w	$a0, $s0, -1
	move	$s0, $a0
	beqz	$a0, .LBB9_94
.LBB9_37:                               # %while.body64
                                        #   Parent Loop BB9_18 Depth=1
...
# %bb.43:                               # %if.then80
	...
	ori	$a1, $zero, 8
	bgeu	$a0, $a1, .LBB9_53
# %bb.44:                               # %entry._ZN5NBitl8CDecoderI9CInBufferE9NormalizeEv.exit_crit_edge.i
                                        #   in Loop: Header=BB9_37 Depth=2
	ld.w	$s8, $fp, 164
...
# %bb.46:                               # %if.end106
	...
	ori	$a0, $zero, 8
	bgeu	$a1, $a0, .LBB9_59
# %bb.47:                               # %entry._ZN5NBitl8CDecoderI9CInBufferE9NormalizeEv.exit_crit_edge.i68
                                        #   in Loop: Header=BB9_37 Depth=2
	ld.w	$a0, $fp, 164
.LBB9_48:                               # %_ZN5NBitl8CDecoderI9CInBufferE8ReadBitsEj.exit106
                                        #   in Loop: Header=BB9_37 Depth=2
...
# %bb.49:                               #   in Loop: Header=BB9_37 Depth=2
	...
	b	.LBB9_65
	.p2align	4, , 16
.LBB9_50:                               # %if.then.if.end3_crit_edge.i.i.i
...
# %bb.55:                               # %if.then.i.i65
	...
	b	.LBB9_52
	.p2align	4, , 16
.LBB9_56:                               # %if.then.if.end3_crit_edge.i.i.i102
                                        #   in Loop: Header=BB9_59 Depth=3
	ld.d	$a0, $s3, 0
.LBB9_57:                               # %_ZN9CInBuffer8ReadByteERh.exit.thread.i.i104
                                        #   in Loop: Header=BB9_59 Depth=3
	addi.d	$a1, $a0, 1
	st.d	$a1, $s3, 0
	ld.bu	$a1, $a0, 0
.LBB9_58:                               # %if.end.i.i89
                                        #   in Loop: Header=BB9_59 Depth=3
	ld.w	$a2, $fp, 104
	sub.d	$a0, $s2, $a2
	ld.w	$a3, $fp, 164
...
# %bb.16:                               # %invoke.cont45
	...
	beqz	$a0, .LBB12_8
	b	.LBB12_32
.LBB12_17:                              # %for.cond.us.preheader
	lu12i.w	$s1, 64
	addi.w	$s5, $zero, -1
	.p2align	4, , 16
.LBB12_18:                              # %for.cond.us
                                        # =>This Inner Loop Header: Depth=1
	move	$a0, $s1
	beqz	$s3, .LBB12_22
# %bb.19:                               # %if.then.us
...
.Ltmp44:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp45:                                # EH_LABEL
# %bb.38:                               # %call.i.i.noexc
	beqz	$a0, .LBB12_47
# %bb.39:                               # %if.then.if.end3_crit_edge.i.i
	ld.d	$a0, $s1, 0
.LBB12_40:                              # %_ZN9CInBuffer8ReadByteERh.exit.thread.i
	addi.d	$a1, $a0, 1
	st.d	$a1, $s1, 0
	ld.bu	$a0, $a0, 0
	b	.LBB12_48
...
.Ltmp46:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp47:                                # EH_LABEL
# %bb.44:                               # %call.i.i.noexc.1
	beqz	$a0, .LBB12_55
# %bb.45:                               # %if.then.if.end3_crit_edge.i.i.1
	ld.d	$a0, $s1, 0
.LBB12_46:                              # %_ZN9CInBuffer8ReadByteERh.exit.thread.i.1
	addi.d	$a1, $a0, 1
	st.d	$a1, $s1, 0
	ld.bu	$a0, $a0, 0
	b	.LBB12_56
.LBB12_47:                              # %if.then2.i
	...
	st.w	$a0, $fp, 160
	ori	$a0, $zero, 255
.LBB12_48:                              # %invoke.cont73thread-pre-split
	ld.w	$a1, $fp, 104
	ori	$a2, $zero, 32
	st.b	$a0, $s2, 11
	beq	$a1, $a2, .LBB12_42
.LBB12_49:                              # %if.end3.i.1
	ld.wu	$a0, $fp, 164
	addi.w	$a1, $a1, 8
	st.w	$a1, $fp, 104
	srli.d	$a2, $a0, 8
...
.Ltmp48:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp49:                                # EH_LABEL
# %bb.52:                               # %call.i.i.noexc.2
	beqz	$a0, .LBB12_63
# %bb.53:                               # %if.then.if.end3_crit_edge.i.i.2
	ld.d	$a0, $s1, 0
.LBB12_54:                              # %_ZN9CInBuffer8ReadByteERh.exit.thread.i.2
	addi.d	$a1, $a0, 1
	st.d	$a1, $s1, 0
	ld.bu	$a0, $a0, 0
	b	.LBB12_64
.LBB12_55:                              # %if.then2.i.1
	ld.w	$a0, $fp, 160
	addi.d	$a0, $a0, 1
	st.w	$a0, $fp, 160
	ori	$a0, $zero, 255
.LBB12_56:                              # %invoke.cont73.1thread-pre-split
	ld.w	$a1, $fp, 104
	ori	$a2, $zero, 32
	st.b	$a0, $s2, 12
	beq	$a1, $a2, .LBB12_50
.LBB12_57:                              # %if.end3.i.2
	ld.wu	$a0, $fp, 164
	addi.w	$a1, $a1, 8
	st.w	$a1, $fp, 104
	srli.d	$a2, $a0, 8
...
.Ltmp50:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp51:                                # EH_LABEL
# %bb.60:                               # %call.i.i.noexc.3
	beqz	$a0, .LBB12_76
# %bb.61:                               # %if.then.if.end3_crit_edge.i.i.3
	ld.d	$a0, $s1, 0
.LBB12_62:                              # %_ZN9CInBuffer8ReadByteERh.exit.thread.i.3
	addi.d	$a1, $a0, 1
	st.d	$a1, $s1, 0
	ld.bu	$a0, $a0, 0
	b	.LBB12_66
.LBB12_63:                              # %if.then2.i.2
	ld.w	$a0, $fp, 160
	addi.d	$a0, $a0, 1
	st.w	$a0, $fp, 160
	ori	$a0, $zero, 255
.LBB12_64:                              # %invoke.cont73.2thread-pre-split
	ld.w	$a1, $fp, 104
	ori	$a2, $zero, 3472
	ori	$a3, $zero, 32
	stx.b	$a0, $fp, $a2
	beq	$a1, $a3, .LBB12_58
.LBB12_65:                              # %if.end3.i.3
	ld.wu	$a0, $fp, 164
	addi.d	$a1, $a1, 8
	st.w	$a1, $fp, 104
	srli.d	$a1, $a0, 8
...
.LBB12_70:                              # %if.end.i
	ld.d	$a0, $fp, 72
	beqz	$a0, .LBB12_73
# %bb.71:                               # %if.then.i.i.i.i
	ld.d	$a1, $a0, 0
	ld.d	$a1, $a1, 16
.Ltmp56:                                # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp57:                                # EH_LABEL
# %bb.72:                               # %call.i.i.i.noexc.i
	st.d	$zero, $fp, 72
.LBB12_73:                              # %return
	addi.w	$a0, $s4, 0
...
.Ltmp11:                                # EH_LABEL
	...
	move	$s0, $a0
	b	.LBB12_92
.LBB12_81:                              # %terminate.lpad.i
.Ltmp58:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB12_82:                              # %lpad44.split.us
.Ltmp35:                                # EH_LABEL
	b	.LBB12_91
.LBB12_83:                              # %lpad39.split.us
.Ltmp32:                                # EH_LABEL
	b	.LBB12_91
.LBB12_84:                              # %lpad22.split.split.us
.Ltmp29:                                # EH_LABEL
	b	.LBB12_91
.LBB12_85:                              # %lpad11.split.us
.Ltmp38:                                # EH_LABEL
	b	.LBB12_91
.LBB12_86:                              # %lpad44.split
.Ltmp26:                                # EH_LABEL
	b	.LBB12_91
.LBB12_87:                              # %lpad39.split
.Ltmp23:                                # EH_LABEL
	b	.LBB12_91
.LBB12_88:                              # %lpad22.split.split
.Ltmp20:                                # EH_LABEL
	b	.LBB12_91
.LBB12_89:                              # %lpad11.split
.Ltmp17:                                # EH_LABEL
	b	.LBB12_91
.LBB12_90:                              # %lpad22.split.us
.Ltmp41:                                # EH_LABEL
.LBB12_91:                              # %ehcleanup93
	move	$fp, $a1
	move	$s0, $a0
	addi.d	$a0, $sp, 40
	pcaddu18i	$ra, %call36(_ZN9NCompress8NDeflate8NDecoder6CCoder14CCoderReleaserD2Ev)
	jirl	$ra, $ra, 0
.LBB12_92:                              # %catch.dispatch
	addi.w	$fp, $fp, 0
	ori	$a0, $zero, 3
	bne	$fp, $a0, .LBB12_94
# %bb.93:                               # %catch104
...
.Lcst_begin2:
	...
	.byte	1                               #   On action: 1
	.uleb128 .Ltmp44-.Lfunc_begin2          # >> Call Site 13 <<
	...
	.uleb128 .Ltmp58-.Lfunc_begin2          #     jumps to .Ltmp58
	.byte	1                               #   On action: 1
	.uleb128 .Ltmp57-.Lfunc_begin2          # >> Call Site 16 <<
...
.Lcst_end2:
	...
	.p2align	2, 0x0
                                        # >> Catch TypeInfos <<
.Ltmp59:                                # TypeInfo 3
	.word	.L_ZTI18CInBufferException.DW.stub-.Ltmp59
.Ltmp60:                                # TypeInfo 2
	.word	.L_ZTI19COutBufferException.DW.stub-.Ltmp60
	.word	0                               # TypeInfo 1
.Lttbase1:
	.p2align	2, 0x0
                                        # -- End function
...
.Lcst_begin3:
	...
	.uleb128 .Lfunc_end13-.Ltmp64           #   Call between .Ltmp64 and .Lfunc_end13
	.byte	0                               #     has no landing pad
	.byte	0                               #   On action: cleanup
.Lcst_end3:
	.byte	1                               # >> Action Record 1 <<
...
.Lcst_begin4:
	...
	.uleb128 .Ltmp75-.Lfunc_begin4          #     jumps to .Ltmp75
	.byte	5                               #   On action: 3
	.uleb128 .Ltmp74-.Lfunc_begin4          # >> Call Site 4 <<
	.uleb128 .Lfunc_end23-.Ltmp74           #   Call between .Ltmp74 and .Lfunc_end23
	.byte	0                               #     has no landing pad
	.byte	0                               #   On action: cleanup
.Lcst_end4:
	.byte	1                               # >> Action Record 1 <<
	...
	.p2align	2, 0x0
                                        # >> Catch TypeInfos <<
.Ltmp76:                                # TypeInfo 3
	.word	.L_ZTI18CInBufferException.DW.stub-.Ltmp76
.Ltmp77:                                # TypeInfo 2
	.word	.L_ZTI19COutBufferException.DW.stub-.Ltmp77
	.word	0                               # TypeInfo 1
.Lttbase3:
	.p2align	2, 0x0
                                        # -- End function
...
.Lcst_begin5:
	...
	.byte	1                               #   On action: 1
	.uleb128 .Ltmp87-.Lfunc_begin5          # >> Call Site 4 <<
	.uleb128 .Ltmp88-.Ltmp87                #   Call between .Ltmp87 and .Ltmp88
	.uleb128 .Ltmp89-.Lfunc_begin5          #     jumps to .Ltmp89
	.byte	1                               #   On action: 1
	.uleb128 .Ltmp88-.Lfunc_begin5          # >> Call Site 5 <<
	.uleb128 .Lfunc_end29-.Ltmp88           #   Call between .Ltmp88 and .Lfunc_end29
	.byte	0                               #     has no landing pad
	.byte	0                               #   On action: cleanup
.Lcst_end5:
	.byte	1                               # >> Action Record 1 <<
