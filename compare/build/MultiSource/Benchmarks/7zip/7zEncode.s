...
# %bb.4:                                # %for.body.lr.ph
	...
	ld.d	$s4, $a0, %got_pc_lo12(IID_ICompressSetCoderMt)
...
.Ltmp5:                                 # EH_LABEL
	b	.LBB0_79
.LBB0_74:                               # %terminate.lpad.i109
.Ltmp51:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB0_75:                               # %terminate.lpad.i138
.Ltmp39:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB0_76:                               # %terminate.lpad.i123
.Ltmp57:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB0_77:                               # %terminate.lpad.i116
.Ltmp54:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB0_78:                               # %lpad20
...
.Ltmp40:                                # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp41:                                # EH_LABEL
.LBB0_82:                               # %_ZN9CMyComPtrI15ICompressCoder2ED2Ev.exit148
	ld.d	$a0, $sp, 144
	beqz	$a0, .LBB0_84
# %bb.83:                               # %if.then.i150
	ld.d	$a1, $a0, 0
...
.Ltmp43:                                # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp44:                                # EH_LABEL
.LBB0_84:                               # %_ZN9CMyComPtrI14ICompressCoderED2Ev.exit156
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB0_85:                               # %terminate.lpad.i154
.Ltmp45:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB0_86:                               # %terminate.lpad.i146
.Ltmp42:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.Lfunc_end0:
