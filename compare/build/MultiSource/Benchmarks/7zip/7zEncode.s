...
.LBB3_28:                               #   in Loop: Header=BB3_25 Depth=1
	...
	b	.LBB3_40
	.p2align	4, , 16
.LBB3_29:                               # %vector.main.loop.iter.check313
                                        #   in Loop: Header=BB3_25 Depth=1
	ori	$a0, $zero, 16
	bgeu	$a2, $a0, .LBB3_31
...
# %bb.34:                               #   in Loop: Header=BB3_25 Depth=1
	...
	b	.LBB3_40
.LBB3_35:                               # %vec.epilog.iter.check332
                                        #   in Loop: Header=BB3_25 Depth=1
	andi	$a5, $a2, 12
	ld.d	$s1, $sp, 72                    # 8-byte Folded Reload
	ld.d	$s3, $sp, 64                    # 8-byte Folded Reload
	beqz	$a5, .LBB3_39
.LBB3_36:                               # %vec.epilog.ph331
                                        #   in Loop: Header=BB3_25 Depth=1
	move	$a5, $a4
	move	$a4, $a2
	...
	sub.d	$a0, $a5, $a4
	.p2align	4, , 16
.LBB3_37:                               # %vec.epilog.vector.body340
                                        #   Parent Loop BB3_25 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	...
	vaddi.wu	$vr1, $vr1, 4
	bnez	$a0, .LBB3_37
# %bb.38:                               # %vec.epilog.middle.block346
                                        #   in Loop: Header=BB3_25 Depth=1
...
.LBB3_46:                               # %vector.body
	...
	xvinsgr2vr.w	$xr4, $t3, 4
	xvinsgr2vr.w	$xr4, $t4, 5
	xvinsgr2vr.w	$xr4, $t5, 6
...
.LBB3_79:                               #   in Loop: Header=BB3_73 Depth=1
	move	$s4, $zero
	b	.LBB3_91
.LBB3_80:                               # %vector.main.loop.iter.check355
                                        #   in Loop: Header=BB3_73 Depth=1
	bgeu	$t1, $t7, .LBB3_82
...
.LBB3_83:                               # %vector.body359
	...
	ld.w	$t5, $t5, 4
	ld.w	$t4, $t4, 4
	xvinsgr2vr.w	$xr6, $s3, 0
	xvinsgr2vr.w	$xr6, $s1, 1
	xvinsgr2vr.w	$xr6, $s0, 2
	xvinsgr2vr.w	$xr6, $t8, 3
...
# %bb.85:                               #   in Loop: Header=BB3_73 Depth=1
	...
	ori	$t7, $zero, 16
	b	.LBB3_91
.LBB3_86:                               # %vec.epilog.iter.check374
                                        #   in Loop: Header=BB3_73 Depth=1
	andi	$a5, $t1, 12
	ld.d	$s7, $sp, 128                   # 8-byte Folded Reload
	ori	$t4, $zero, 1
...
.LBB3_87:                               # %vec.epilog.ph373
	...
	sub.d	$t3, $a5, $t2
	.p2align	4, , 16
.LBB3_88:                               # %vec.epilog.vector.body382
                                        #   Parent Loop BB3_73 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vpickve2gr.w	$a5, $vr4, 3
	vpickve2gr.w	$a6, $vr4, 2
	...
	vaddi.wu	$vr4, $vr4, 4
	bnez	$t3, .LBB3_88
# %bb.89:                               # %vec.epilog.middle.block388
                                        #   in Loop: Header=BB3_73 Depth=1
