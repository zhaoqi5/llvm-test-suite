...
.Ltmp26:                                # EH_LABEL
	...
	jirl	$ra, $a3, 0
.Ltmp27:                                # EH_LABEL
# %bb.36:                               # %invoke.cont145
                                        #   in Loop: Header=BB0_5 Depth=1
	move	$s7, $a0
	beqz	$s6, .LBB0_38
# %bb.37:                               # %delete.notnull.i90
                                        #   in Loop: Header=BB0_5 Depth=1
	move	$a0, $s6
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB0_38:                               # %_ZN7CBufferIhED2Ev.exit
                                        #   in Loop: Header=BB0_5 Depth=1
	beqz	$s7, .LBB0_40
...
.Ltmp52:                                # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp53:                                # EH_LABEL
.LBB0_48:                               # %_ZN9CMyComPtrI15ICompressCoder2ED2Ev.exit
                                        #   in Loop: Header=BB0_5 Depth=1
	ld.d	$a0, $sp, 64
	beqz	$a0, .LBB0_50
# %bb.49:                               # %if.then.i119
...
.Ltmp55:                                # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp56:                                # EH_LABEL
.LBB0_50:                               # %_ZN9CMyComPtrI14ICompressCoderED2Ev.exit
                                        #   in Loop: Header=BB0_5 Depth=1
	beqz	$fp, .LBB0_56
# %bb.51:                               # %for.cond
                                        #   in Loop: Header=BB0_5 Depth=1
...
.LBB0_56:                               # %return
	...
	addi.d	$sp, $sp, 160
	ret
.LBB0_57:                               # %_ZN9CMyComPtrI14ICompressCoderED2Ev.exit.thread
	lu12i.w	$a0, -524284
	ori	$s4, $a0, 5
	b	.LBB0_56
.LBB0_58:                               # %ehcleanup155.thread
.Ltmp25:                                # EH_LABEL
	b	.LBB0_63
.LBB0_59:                               # %terminate.lpad.i102
.Ltmp48:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB0_60:                               # %ehcleanup155
.Ltmp28:                                # EH_LABEL
	move	$fp, $a0
	beqz	$s6, .LBB0_64
# %bb.61:                               # %delete.notnull.i94
	move	$a0, $s6
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	b	.LBB0_64
.LBB0_62:                               # %lpad91
.Ltmp33:                                # EH_LABEL
.LBB0_63:                               # %ehcleanup177
	move	$fp, $a0
.LBB0_64:                               # %ehcleanup177
	ld.d	$a0, $sp, 48
	beqz	$a0, .LBB0_73
# %bb.65:                               # %if.then.i126
	ld.d	$a1, $a0, 0
...
.Ltmp35:                                # EH_LABEL
	b	.LBB0_73
.LBB0_66:                               # %terminate.lpad.i130
.Ltmp36:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB0_67:                               # %terminate.lpad.i
.Ltmp17:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB0_68:                               # %lpad77
...
.Ltmp5:                                 # EH_LABEL
	b	.LBB0_81
.LBB0_76:                               # %terminate.lpad.i109
.Ltmp51:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB0_77:                               # %terminate.lpad.i138
.Ltmp39:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB0_78:                               # %terminate.lpad.i123
.Ltmp57:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB0_79:                               # %terminate.lpad.i116
.Ltmp54:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB0_80:                               # %lpad20
.Ltmp2:                                 # EH_LABEL
.LBB0_81:                               # %ehcleanup185
	move	$fp, $a0
.LBB0_82:                               # %ehcleanup185
	ld.d	$a0, $sp, 56
	beqz	$a0, .LBB0_84
# %bb.83:                               # %if.then.i142
	ld.d	$a1, $a0, 0
...
.Ltmp40:                                # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp41:                                # EH_LABEL
.LBB0_84:                               # %_ZN9CMyComPtrI15ICompressCoder2ED2Ev.exit148
	ld.d	$a0, $sp, 64
	beqz	$a0, .LBB0_86
# %bb.85:                               # %if.then.i150
	ld.d	$a1, $a0, 0
...
.Ltmp43:                                # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp44:                                # EH_LABEL
.LBB0_86:                               # %_ZN9CMyComPtrI14ICompressCoderED2Ev.exit156
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB0_87:                               # %terminate.lpad.i154
.Ltmp45:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB0_88:                               # %terminate.lpad.i146
.Ltmp42:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.Lfunc_end0:
...
.LBB3_28:                               #   in Loop: Header=BB3_25 Depth=1
	...
	b	.LBB3_40
	.p2align	4, , 16
.LBB3_29:                               # %vector.main.loop.iter.check322
                                        #   in Loop: Header=BB3_25 Depth=1
	ori	$a0, $zero, 16
	bgeu	$a2, $a0, .LBB3_31
...
# %bb.34:                               #   in Loop: Header=BB3_25 Depth=1
	...
	b	.LBB3_40
.LBB3_35:                               # %vec.epilog.iter.check340
                                        #   in Loop: Header=BB3_25 Depth=1
	ld.d	$s3, $sp, 120                   # 8-byte Folded Reload
	ld.d	$s8, $sp, 112                   # 8-byte Folded Reload
	beqz	$a5, .LBB3_39
.LBB3_36:                               # %vec.epilog.ph342
	...
	sub.d	$a0, $a5, $a4
	.p2align	4, , 16
.LBB3_37:                               # %vec.epilog.vector.body348
                                        #   Parent Loop BB3_25 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	...
	vaddi.wu	$vr1, $vr1, 4
	bnez	$a0, .LBB3_37
# %bb.38:                               # %vec.epilog.middle.block354
                                        #   in Loop: Header=BB3_25 Depth=1
...
.LBB3_58:                               # %for.body104
	...
	ld.w	$a0, $fp, 180
	blez	$a0, .LBB3_56
# %bb.59:                               # %for.body.lr.ph.i111
                                        #   in Loop: Header=BB3_58 Depth=1
	ld.d	$a1, $fp, 184
	addi.d	$a1, $a1, 4
	.p2align	4, , 16
.LBB3_60:                               # %for.body.i113
...
.LBB3_66:                               # %for.body119
	...
	ld.w	$a0, $fp, 180
	blez	$a0, .LBB3_64
# %bb.67:                               # %for.body.lr.ph.i123
                                        #   in Loop: Header=BB3_66 Depth=1
	ld.d	$a1, $fp, 184
	.p2align	4, , 16
.LBB3_68:                               # %for.body.i126
...
# %bb.71:                               # %if.end136
	ld.w	$a0, $fp, 148
	beqz	$a0, .LBB3_117
# %bb.72:                               # %for.body.lr.ph.i144.lr.ph
	ld.wu	$a1, $fp, 180
	ld.d	$t1, $fp, 216
	ld.d	$a2, $fp, 152
	addi.w	$a3, $a1, 0
	...
	xvld	$xr1, $s1, %pc_lo12(.LCPI3_0)
	lu12i.w	$a5, -524288
	ori	$t5, $a5, 3
	ori	$t6, $zero, 16
	xvrepli.b	$xr2, 0
.LBB3_73:                               # %for.body.lr.ph.i144
                                        # =>This Loop Header: Depth=1
...
.LBB3_79:                               #   in Loop: Header=BB3_73 Depth=1
	move	$s1, $zero
	b	.LBB3_91
.LBB3_80:                               # %vector.main.loop.iter.check363
                                        #   in Loop: Header=BB3_73 Depth=1
	bgeu	$t0, $t6, .LBB3_82
...
# %bb.85:                               #   in Loop: Header=BB3_73 Depth=1
	...
	ori	$t6, $zero, 16
	b	.LBB3_91
.LBB3_86:                               # %vec.epilog.iter.check381
                                        #   in Loop: Header=BB3_73 Depth=1
	ld.d	$t4, $sp, 128                   # 8-byte Folded Reload
	ld.d	$t5, $sp, 120                   # 8-byte Folded Reload
	ori	$t6, $zero, 16
...
.LBB3_87:                               # %vec.epilog.ph383
	...
	sub.d	$t2, $a5, $t1
	.p2align	4, , 16
.LBB3_88:                               # %vec.epilog.vector.body389
                                        #   Parent Loop BB3_73 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	...
	vaddi.wu	$vr4, $vr4, 4
	bnez	$t2, .LBB3_88
# %bb.89:                               # %vec.epilog.middle.block395
                                        #   in Loop: Header=BB3_73 Depth=1
...
.LBB3_90:                               # %for.body.i156
	...
	add.d	$s1, $a5, $s1
	bne	$t0, $t1, .LBB3_90
.LBB3_91:                               # %_ZNK11NCoderMixer9CBindInfo22GetCoderOutStreamIndexEj.exit166
                                        #   in Loop: Header=BB3_73 Depth=1
	addi.w	$t0, $s1, 0
	blez	$a3, .LBB3_95
# %bb.92:                               # %for.body.i172.preheader
                                        #   in Loop: Header=BB3_73 Depth=1
	move	$t2, $a1
	move	$t1, $a4
	.p2align	4, , 16
.LBB3_93:                               # %for.body.i172
                                        #   Parent Loop BB3_73 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$a5, $t1, 4
	beq	$a5, $t0, .LBB3_73
...
# %bb.104:                              # %for.body204.lr.ph
	...
	ori	$s6, $zero, 8
	pcalau12i	$a0, %pc_hi20(_ZTV13CObjectVectorI5CPropE+16)
	addi.d	$s7, $a0, %pc_lo12(_ZTV13CObjectVectorI5CPropE+16)
	ori	$s8, $zero, 1
	lu32i.d	$s8, 1
	lu12i.w	$a0, 28432
	ori	$s0, $a0, 1793
...
.Ltmp252:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp253:                               # EH_LABEL
# %bb.109:                              # %_ZN7CMethodD2Ev.exit217
                                        #   in Loop: Header=BB3_105 Depth=1
	move	$a0, $s3
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVectorD2Ev)
	jirl	$ra, $ra, 0
...
.Ltmp263:                               # EH_LABEL
	b	.LBB3_123
.LBB3_121:                              # %terminate.lpad.i.i216
.Ltmp254:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB3_122:                              # %lpad216
