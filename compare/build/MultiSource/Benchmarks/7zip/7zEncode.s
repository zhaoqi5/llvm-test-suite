...
.Ltmp26:                                # EH_LABEL
	...
	jirl	$ra, $a3, 0
.Ltmp27:                                # EH_LABEL
# %bb.37:                               # %invoke.cont145
                                        #   in Loop: Header=BB0_5 Depth=1
	move	$s7, $a0
	beqz	$s6, .LBB0_39
# %bb.38:                               # %delete.notnull.i90
                                        #   in Loop: Header=BB0_5 Depth=1
	move	$a0, $s6
...
.LBB0_59:                               # %_ZN9CMyComPtrI14ICompressCoderED2Ev.exit.thread
	...
	ori	$s4, $a0, 5
	b	.LBB0_58
.LBB0_60:                               # %ehcleanup155.thread
.Ltmp25:                                # EH_LABEL
	b	.LBB0_65
.LBB0_61:                               # %terminate.lpad.i102
.Ltmp48:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB0_62:                               # %ehcleanup155
.Ltmp28:                                # EH_LABEL
	move	$fp, $a0
	beqz	$s6, .LBB0_66
# %bb.63:                               # %delete.notnull.i94
	move	$a0, $s6
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	b	.LBB0_66
.LBB0_64:                               # %lpad91
.Ltmp33:                                # EH_LABEL
.LBB0_65:                               # %ehcleanup177
	move	$fp, $a0
.LBB0_66:                               # %ehcleanup177
	ld.d	$a0, $sp, 48
	beqz	$a0, .LBB0_75
# %bb.67:                               # %if.then.i126
	ld.d	$a1, $a0, 0
...
.Ltmp35:                                # EH_LABEL
	b	.LBB0_75
.LBB0_68:                               # %terminate.lpad.i130
.Ltmp36:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB0_69:                               # %terminate.lpad.i
.Ltmp17:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB0_70:                               # %lpad77
...
.Ltmp5:                                 # EH_LABEL
	b	.LBB0_83
.LBB0_78:                               # %terminate.lpad.i109
.Ltmp51:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB0_79:                               # %terminate.lpad.i138
.Ltmp39:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB0_80:                               # %terminate.lpad.i123
.Ltmp57:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB0_81:                               # %terminate.lpad.i116
.Ltmp54:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB0_82:                               # %lpad20
.Ltmp2:                                 # EH_LABEL
.LBB0_83:                               # %ehcleanup185
	move	$fp, $a0
.LBB0_84:                               # %ehcleanup185
	ld.d	$a0, $sp, 56
	beqz	$a0, .LBB0_86
# %bb.85:                               # %if.then.i142
	ld.d	$a1, $a0, 0
...
.Ltmp40:                                # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp41:                                # EH_LABEL
.LBB0_86:                               # %_ZN9CMyComPtrI15ICompressCoder2ED2Ev.exit148
	ld.d	$a0, $sp, 64
	beqz	$a0, .LBB0_88
# %bb.87:                               # %if.then.i150
	ld.d	$a1, $a0, 0
...
.Ltmp43:                                # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp44:                                # EH_LABEL
.LBB0_88:                               # %_ZN9CMyComPtrI14ICompressCoderED2Ev.exit156
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB0_89:                               # %terminate.lpad.i154
.Ltmp45:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB0_90:                               # %terminate.lpad.i146
.Ltmp42:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.Lfunc_end0:
...
.LBB3_39:                               # %for.body.i97
	...
	bne	$a2, $a4, .LBB3_39
	b	.LBB3_24
.LBB3_40:                               # %for.cond102.preheader
	lu12i.w	$s7, -524288
	lu12i.w	$s8, 524287
	blez	$s5, .LBB3_48
# %bb.41:                               # %for.body104.lr.ph
	move	$s0, $zero
	b	.LBB3_44
	.p2align	4, , 16
.LBB3_42:                               # %if.then108
...
.LBB3_44:                               # %for.body104
	...
	ld.w	$a0, $fp, 180
	blez	$a0, .LBB3_42
# %bb.45:                               # %for.body.lr.ph.i111
                                        #   in Loop: Header=BB3_44 Depth=1
	ld.d	$a1, $fp, 184
	addi.d	$a1, $a1, 4
	.p2align	4, , 16
.LBB3_46:                               # %for.body.i113
...
.LBB3_52:                               # %for.body119
	...
	ld.w	$a0, $fp, 180
	blez	$a0, .LBB3_50
# %bb.53:                               # %for.body.lr.ph.i123
                                        #   in Loop: Header=BB3_52 Depth=1
	ld.d	$a1, $fp, 184
	.p2align	4, , 16
.LBB3_54:                               # %for.body.i126
...
# %bb.57:                               # %if.end136
	ld.w	$a0, $fp, 148
	beqz	$a0, .LBB3_96
# %bb.58:                               # %for.body.lr.ph.i144.lr.ph
	ld.wu	$a1, $fp, 180
	ld.d	$t0, $fp, 216
	ld.d	$a2, $fp, 152
	addi.w	$a3, $a1, 0
...
.LBB3_69:                               # %for.body.i156
	...
	add.d	$s4, $t1, $s4
	bne	$a7, $t0, .LBB3_69
.LBB3_70:                               # %_ZNK11NCoderMixer9CBindInfo22GetCoderOutStreamIndexEj.exit166
                                        #   in Loop: Header=BB3_59 Depth=1
	addi.w	$a7, $s4, 0
	blez	$a3, .LBB3_74
# %bb.71:                               # %for.body.i172.preheader
                                        #   in Loop: Header=BB3_59 Depth=1
	move	$t1, $a1
	move	$t0, $a4
	.p2align	4, , 16
.LBB3_72:                               # %for.body.i172
                                        #   Parent Loop BB3_59 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t2, $t0, 4
	beq	$t2, $a7, .LBB3_59
# %bb.73:                               # %for.inc.i177
	...
	addi.d	$t0, $t0, 8
	bnez	$t1, .LBB3_72
.LBB3_74:                               # %for.cond153.preheader
	ld.w	$a0, $fp, 244
	blez	$a0, .LBB3_78
# %bb.75:                               # %for.body158.lr.ph
	ld.d	$a2, $fp, 248
	move	$a1, $zero
	.p2align	4, , 16
.LBB3_76:                               # %for.body158
...
.Ltmp263:                               # EH_LABEL
	b	.LBB3_102
.LBB3_100:                              # %terminate.lpad.i.i216
.Ltmp254:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB3_101:                              # %lpad216
