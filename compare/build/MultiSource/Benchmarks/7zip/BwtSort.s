...
# %bb.10:                               # %if.end125
	...
	b	.LBB0_12
	.p2align	4, , 16
.LBB0_11:                               # %do.body.do.cond_crit_edge
...
# %bb.45:                               # %vector.memcheck
	sub.d	$a0, $s1, $t1
	bstrpick.d	$a0, $a0, 61, 4
	slli.d	$a0, $a0, 4
	beqz	$a0, .LBB0_48
# %bb.46:                               # %vector.main.loop.iter.check
	ori	$a0, $zero, 16
	bgeu	$s5, $a0, .LBB0_52
# %bb.47:
	move	$a0, $zero
