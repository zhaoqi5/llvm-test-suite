...
# %bb.0:                                # %entry
	...
	.cfi_offset 1, -8
	move	$a1, $a0
	pcalau12i	$a0, %pc_hi20(_ZTV17COutStreamWithCRC+16)
	addi.d	$a2, $a0, %pc_lo12(_ZTV17COutStreamWithCRC+16)
	ld.d	$a0, $a1, 16
	st.d	$a2, $a1, 0
	beqz	$a0, .LBB4_2
# %bb.1:                                # %if.then.i
...
# %bb.0:                                # %entry
	...
	.cfi_offset 1, -8
	.cfi_offset 22, -16
	pcalau12i	$a1, %pc_hi20(_ZTV17COutStreamWithCRC+16)
	addi.d	$a2, $a1, %pc_lo12(_ZTV17COutStreamWithCRC+16)
	ld.d	$a1, $a0, 16
	st.d	$a2, $a0, 0
	beqz	$a1, .LBB5_2
# %bb.1:                                # %if.then.i.i
