...
# %bb.0:                                # %entry
	...
	move	$a1, $a0
	ld.d	$a0, $a0, 16
	pcalau12i	$a2, %pc_hi20(_ZTV26CLimitedSequentialInStream+16)
	addi.d	$a2, $a2, %pc_lo12(_ZTV26CLimitedSequentialInStream+16)
	st.d	$a2, $a1, 0
	beqz	$a0, .LBB10_2
# %bb.1:                                # %if.then.i
	ld.d	$a1, $a0, 0
...
# %bb.0:                                # %entry
	...
	move	$a1, $a0
	ld.d	$a0, $a0, 16
	pcalau12i	$a2, %pc_hi20(_ZTV16CLimitedInStream+16)
	addi.d	$a2, $a2, %pc_lo12(_ZTV16CLimitedInStream+16)
	st.d	$a2, $a1, 0
	beqz	$a0, .LBB15_2
# %bb.1:                                # %if.then.i
	ld.d	$a1, $a0, 0
...
# %bb.0:                                # %entry
	...
	move	$a1, $a0
	ld.d	$a0, $a0, 16
	pcalau12i	$a2, %pc_hi20(_ZTV27CLimitedSequentialOutStream+16)
	addi.d	$a2, $a2, %pc_lo12(_ZTV27CLimitedSequentialOutStream+16)
	st.d	$a2, $a1, 0
	beqz	$a0, .LBB25_2
# %bb.1:                                # %if.then.i
	ld.d	$a1, $a0, 0
