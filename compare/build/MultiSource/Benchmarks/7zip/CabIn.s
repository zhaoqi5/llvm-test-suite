...
# %bb.34:                               # %iter.check76
	...
	ori	$a3, $zero, 32
	bltu	$a4, $a3, .LBB5_45
# %bb.35:                               # %vector.main.loop.iter.check78
	bgeu	$a1, $a3, .LBB5_41
# %bb.36:
	move	$a2, $zero
.LBB5_37:                               # %vec.epilog.ph93
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB5_38:                               # %vec.epilog.vector.body96
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB5_38
# %bb.39:                               # %vec.epilog.middle.block100
	bne	$a2, $a1, .LBB5_45
	b	.LBB5_47
.LBB5_40:                               # %for.cond.cleanup.i.i29
	bnez	$a0, .LBB5_47
	b	.LBB5_48
.LBB5_41:                               # %vector.ph79
	andi	$a3, $a1, 16
...
.LBB5_42:                               # %vector.body82
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB5_42
# %bb.43:                               # %middle.block87
	beq	$a2, $a1, .LBB5_47
# %bb.44:                               # %vec.epilog.iter.check91
	bnez	$a3, .LBB5_37
...
# %bb.17:                               # %if.end.i
	...
	b	.LBB11_20
	.p2align	4, , 16
.LBB11_18:                              # %if.end7.for.end.loopexit_crit_edge.i.i
...
# %bb.32:                               #   in Loop: Header=BB11_24 Depth=2
	move	$s5, $zero
	b	.LBB11_35
.LBB11_33:                              # %if.end.i.i.i227
                                        #   in Loop: Header=BB11_24 Depth=2
	ori	$s4, $ra, 4094
	bltu	$s5, $s4, .LBB11_35
# %bb.34:                               # %if.then3.i.i.i264
                                        #   in Loop: Header=BB11_24 Depth=2
	ld.w	$s4, $s6, 108
	addi.d	$s5, $s4, -1
.LBB11_35:                              # %_ZNK8NArchive4NCab13CMvDatabaseEx14GetFolderIndexEPKNS0_7CMvItemE.exit.i231
                                        #   in Loop: Header=BB11_24 Depth=2
	ld.hu	$s4, $s3, 28
	and	$s6, $s4, $a3
	bne	$s6, $a3, .LBB11_37
# %bb.36:                               #   in Loop: Header=BB11_24 Depth=2
	move	$s4, $zero
	b	.LBB11_39
.LBB11_37:                              # %if.end.i.i54.i238
                                        #   in Loop: Header=BB11_24 Depth=2
	ori	$s6, $ra, 4094
	bltu	$s4, $s6, .LBB11_39
# %bb.38:                               # %if.then3.i.i60.i262
                                        #   in Loop: Header=BB11_24 Depth=2
	ld.w	$s0, $s0, 108
	addi.d	$s4, $s0, -1
.LBB11_39:                              # %_ZNK8NArchive4NCab13CMvDatabaseEx14GetFolderIndexEPKNS0_7CMvItemE.exit62.i242
                                        #   in Loop: Header=BB11_24 Depth=2
	ld.d	$s0, $fp, 80
	slli.d	$s6, $t2, 2
	ldx.w	$s6, $s0, $s6
	...
	add.w	$s4, $s4, $s7
	bne	$s0, $s4, .LBB11_43
# %bb.40:                               # %cleanup.cont.i247
                                        #   in Loop: Header=BB11_24 Depth=2
	ld.w	$s0, $t8, 16
	ld.w	$s4, $s3, 16
	bne	$s0, $s4, .LBB11_44
# %bb.41:                               # %cleanup.cont30.i252
                                        #   in Loop: Header=BB11_24 Depth=2
	ld.w	$t8, $t8, 20
	ld.w	$s0, $s3, 20
	bne	$t8, $s0, .LBB11_45
# %bb.42:                               # %cleanup.cont39.i257
                                        #   in Loop: Header=BB11_24 Depth=2
	xor	$t8, $t2, $t5
	sltui	$t8, $t8, 1
	slt	$t2, $t5, $t2
...
.LBB11_45:                              #   in Loop: Header=BB11_24 Depth=2
	sltu	$s4, $s0, $t8
	.p2align	4, , 16
.LBB11_46:                              # %_ZN8NArchive4NCabL14CompareMvItemsEPKNS0_7CMvItemES3_Pv.exit266
                                        #   in Loop: Header=BB11_24 Depth=2
	or	$t2, $t3, $s4
.LBB11_47:                              # %if.end7.i.i
                                        #   in Loop: Header=BB11_24 Depth=2
	slli.d	$t3, $t2, 3
	ldx.w	$t5, $a2, $t3
	slli.d	$t3, $a6, 3
...
# %bb.48:                               # %if.end7.i.i
                                        #   in Loop: Header=BB11_24 Depth=2
	beqz	$s0, .LBB11_23
.LBB11_49:                              # %if.end.i151
                                        #   in Loop: Header=BB11_24 Depth=2
	bnez	$s4, .LBB11_51
# %bb.50:                               # %if.end.i151
                                        #   in Loop: Header=BB11_24 Depth=2
	bnez	$s0, .LBB11_18
.LBB11_51:                              # %if.end16.i154
                                        #   in Loop: Header=BB11_24 Depth=2
	ld.hu	$s0, $t6, 28
	and	$s4, $s0, $a3
	ori	$s5, $ra, 4094
...
# %bb.52:                               #   in Loop: Header=BB11_24 Depth=2
	...
	b	.LBB11_55
	.p2align	4, , 16
.LBB11_53:                              # %if.end.i.i.i160
                                        #   in Loop: Header=BB11_24 Depth=2
	bltu	$s0, $s5, .LBB11_55
# %bb.54:                               # %if.then3.i.i.i197
                                        #   in Loop: Header=BB11_24 Depth=2
	ld.w	$s0, $s3, 108
	addi.d	$s0, $s0, -1
.LBB11_55:                              # %_ZNK8NArchive4NCab13CMvDatabaseEx14GetFolderIndexEPKNS0_7CMvItemE.exit.i164
                                        #   in Loop: Header=BB11_24 Depth=2
	ld.hu	$s3, $t7, 28
	and	$s4, $s3, $a3
	bne	$s4, $a3, .LBB11_57
# %bb.56:                               #   in Loop: Header=BB11_24 Depth=2
	...
	b	.LBB11_59
	.p2align	4, , 16
.LBB11_57:                              # %if.end.i.i54.i171
                                        #   in Loop: Header=BB11_24 Depth=2
	bltu	$s3, $s5, .LBB11_59
# %bb.58:                               # %if.then3.i.i60.i195
                                        #   in Loop: Header=BB11_24 Depth=2
	ld.w	$t8, $t8, 108
	addi.d	$s3, $t8, -1
.LBB11_59:                              # %_ZNK8NArchive4NCab13CMvDatabaseEx14GetFolderIndexEPKNS0_7CMvItemE.exit62.i175
                                        #   in Loop: Header=BB11_24 Depth=2
	ld.d	$t8, $fp, 80
	slli.d	$s4, $a6, 2
	ldx.w	$s4, $t8, $s4
	...
	add.w	$s0, $s3, $s5
	bne	$t8, $s0, .LBB11_22
# %bb.60:                               # %cleanup.cont.i180
                                        #   in Loop: Header=BB11_24 Depth=2
	ld.w	$t8, $t6, 16
	ld.w	$s0, $t7, 16
	bne	$t8, $s0, .LBB11_63
# %bb.61:                               # %cleanup.cont30.i185
                                        #   in Loop: Header=BB11_24 Depth=2
	ld.w	$t6, $t6, 20
	ld.w	$t7, $t7, 20
	bne	$t6, $t7, .LBB11_64
# %bb.62:                               # %cleanup.cont39.i190
                                        #   in Loop: Header=BB11_24 Depth=2
	xor	$t6, $t5, $a6
	sltui	$t6, $t6, 1
	slt	$t5, $a6, $t5
...
.LBB11_80:                              # %for.end55
	...
	addi.d	$sp, $sp, 96
	ret
.LBB11_81:                              # %if.end.i19.preheader.i.preheader
	ori	$a6, $zero, 3
	b	.LBB11_84
	.p2align	4, , 16
.LBB11_82:                              # %if.end7.for.end.loopexit_crit_edge.i39.i
                                        #   in Loop: Header=BB11_84 Depth=1
	move	$t4, $t3
.LBB11_83:                              # %_ZN13CRecordVectorIN8NArchive4NCab7CMvItemEE11SortRefDownEPS2_iiPFiPKS2_S6_PvES7_.exit49.i
                                        #   in Loop: Header=BB11_84 Depth=1
	slli.d	$t0, $t4, 3
	stx.d	$a5, $a2, $t0
	slli.d	$t0, $a1, 3
	...
	st.d	$a5, $a0, 0
	bge	$a6, $a7, .LBB11_66
.LBB11_84:                              # %if.end.i19.preheader.i
                                        # =>This Loop Header: Depth=1
...
# %bb.95:                               #   in Loop: Header=BB11_87 Depth=2
	move	$s7, $zero
	b	.LBB11_98
.LBB11_96:                              # %if.end.i.i.i93
                                        #   in Loop: Header=BB11_87 Depth=2
	ori	$s4, $ra, 4094
	bltu	$s7, $s4, .LBB11_98
# %bb.97:                               # %if.then3.i.i.i130
                                        #   in Loop: Header=BB11_87 Depth=2
	ld.w	$s4, $s8, 108
	addi.d	$s7, $s4, -1
.LBB11_98:                              # %_ZNK8NArchive4NCab13CMvDatabaseEx14GetFolderIndexEPKNS0_7CMvItemE.exit.i97
                                        #   in Loop: Header=BB11_87 Depth=2
	ld.hu	$s4, $s6, 28
	and	$s8, $s4, $a3
	bne	$s8, $a3, .LBB11_100
# %bb.99:                               #   in Loop: Header=BB11_87 Depth=2
	move	$s4, $zero
	b	.LBB11_102
.LBB11_100:                             # %if.end.i.i54.i104
                                        #   in Loop: Header=BB11_87 Depth=2
	ori	$s8, $ra, 4094
	bltu	$s4, $s8, .LBB11_102
# %bb.101:                              # %if.then3.i.i60.i128
                                        #   in Loop: Header=BB11_87 Depth=2
	ld.w	$s0, $s0, 108
	addi.d	$s4, $s0, -1
.LBB11_102:                             # %_ZNK8NArchive4NCab13CMvDatabaseEx14GetFolderIndexEPKNS0_7CMvItemE.exit62.i108
                                        #   in Loop: Header=BB11_87 Depth=2
	ld.d	$s0, $fp, 80
	slli.d	$s8, $t4, 2
	ldx.w	$s8, $s0, $s8
	...
	add.w	$s4, $s4, $ra
	bne	$s0, $s4, .LBB11_106
# %bb.103:                              # %cleanup.cont.i113
                                        #   in Loop: Header=BB11_87 Depth=2
	ld.w	$s0, $s5, 16
	ld.w	$s4, $s6, 16
	lu12i.w	$ra, 15
	bne	$s0, $s4, .LBB11_107
# %bb.104:                              # %cleanup.cont30.i118
                                        #   in Loop: Header=BB11_87 Depth=2
	ld.w	$s0, $s5, 20
	ld.w	$s4, $s6, 20
	bne	$s0, $s4, .LBB11_107
# %bb.105:                              # %cleanup.cont39.i123
                                        #   in Loop: Header=BB11_87 Depth=2
	xor	$s0, $t4, $t7
	sltui	$s0, $s0, 1
	slt	$t4, $t7, $t4
...
.LBB11_107:                             #   in Loop: Header=BB11_87 Depth=2
	sltu	$s4, $s4, $s0
	.p2align	4, , 16
.LBB11_108:                             # %_ZN8NArchive4NCabL14CompareMvItemsEPKNS0_7CMvItemES3_Pv.exit132
                                        #   in Loop: Header=BB11_87 Depth=2
	or	$t4, $t6, $s4
.LBB11_109:                             # %if.end7.i23.i
                                        #   in Loop: Header=BB11_87 Depth=2
	slli.d	$t6, $t4, 3
	ldx.w	$t6, $a2, $t6
	slli.d	$t7, $t0, 3
	...
	andi	$s4, $s7, 16
	beqz	$s5, .LBB11_111
# %bb.110:                              # %if.end7.i23.i
                                        #   in Loop: Header=BB11_87 Depth=2
	beqz	$s4, .LBB11_86
.LBB11_111:                             # %if.end.i64
                                        #   in Loop: Header=BB11_87 Depth=2
	bnez	$s5, .LBB11_113
# %bb.112:                              # %if.end.i64
                                        #   in Loop: Header=BB11_87 Depth=2
	bnez	$s4, .LBB11_82
.LBB11_113:                             # %if.end16.i
                                        #   in Loop: Header=BB11_87 Depth=2
	ld.hu	$s5, $t8, 28
	and	$s4, $s5, $a3
	ori	$s7, $ra, 4094
...
# %bb.114:                              #   in Loop: Header=BB11_87 Depth=2
	...
	b	.LBB11_117
	.p2align	4, , 16
.LBB11_115:                             # %if.end.i.i.i
                                        #   in Loop: Header=BB11_87 Depth=2
	bltu	$s5, $s7, .LBB11_117
# %bb.116:                              # %if.then3.i.i.i
                                        #   in Loop: Header=BB11_87 Depth=2
	ld.w	$s4, $s6, 108
	addi.d	$s5, $s4, -1
...
# %bb.118:                              #   in Loop: Header=BB11_87 Depth=2
	...
	b	.LBB11_121
	.p2align	4, , 16
.LBB11_119:                             # %if.end.i.i54.i
                                        #   in Loop: Header=BB11_87 Depth=2
	bltu	$s4, $s7, .LBB11_121
# %bb.120:                              # %if.then3.i.i60.i
                                        #   in Loop: Header=BB11_87 Depth=2
	ld.w	$s0, $s0, 108
	addi.d	$s4, $s0, -1
.LBB11_121:                             # %_ZNK8NArchive4NCab13CMvDatabaseEx14GetFolderIndexEPKNS0_7CMvItemE.exit62.i
                                        #   in Loop: Header=BB11_87 Depth=2
	ld.d	$s0, $fp, 80
	slli.d	$s6, $t0, 2
	ldx.w	$s6, $s0, $s6
	...
	add.w	$s4, $s4, $s7
	bne	$s0, $s4, .LBB11_85
# %bb.122:                              # %cleanup.cont.i
                                        #   in Loop: Header=BB11_87 Depth=2
	ld.w	$s0, $t8, 16
	ld.w	$s4, $s3, 16
	bne	$s0, $s4, .LBB11_125
# %bb.123:                              # %cleanup.cont30.i
                                        #   in Loop: Header=BB11_87 Depth=2
	ld.w	$t8, $t8, 20
	ld.w	$s0, $s3, 20
	bne	$t8, $s0, .LBB11_126
# %bb.124:                              # %cleanup.cont39.i
                                        #   in Loop: Header=BB11_87 Depth=2
	xor	$t8, $t6, $t0
	sltui	$t8, $t8, 1
	slt	$t6, $t0, $t6
