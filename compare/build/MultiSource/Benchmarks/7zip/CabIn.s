...
.LBB5_39:                               # %vector.body82
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB5_39
# %bb.40:                               # %middle.block87
	beq	$a2, $a1, .LBB5_47
# %bb.41:                               # %vec.epilog.iter.check91
	beqz	$a3, .LBB5_45
.LBB5_42:                               # %vec.epilog.ph93
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB5_43:                               # %vec.epilog.vector.body96
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB5_43
# %bb.44:                               # %vec.epilog.middle.block100
	beq	$a2, $a1, .LBB5_47
