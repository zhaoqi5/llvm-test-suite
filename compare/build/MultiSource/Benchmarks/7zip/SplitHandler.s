...
# %bb.196:                              # %delete.notnull.i453
	...
	jirl	$ra, $ra, 0
	b	.LBB5_170
.LBB5_197:                              # %_ZN11CStringBaseIwED2Ev.exit454
	ori	$a0, $zero, 6
	bne	$s7, $a0, .LBB5_199
# %bb.198:                              # %cleanup343.loopexit623
	move	$s5, $zero
	b	.LBB5_200
.LBB5_199:                              # %cleanup343.loopexit
	move	$s5, $s4
.LBB5_200:                              # %cleanup343
	ld.d	$a0, $sp, 88
	beqz	$a0, .LBB5_202
# %bb.201:                              # %delete.notnull.i.i468
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB5_202:                              # %_ZN11CStringBaseIwED2Ev.exit.i469
	ld.d	$a0, $sp, 72
	beqz	$a0, .LBB5_204
# %bb.203:                              # %delete.notnull.i2.i
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB5_204:                              # %_ZN8NArchive6NSplit8CSeqNameD2Ev.exit
	ld.d	$a0, $sp, 112
	beqz	$a0, .LBB5_206
# %bb.205:                              # %delete.notnull.i471
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB5_206:                              # %_ZN11CStringBaseIwED2Ev.exit472
	ld.d	$a0, $sp, 128
	beqz	$a0, .LBB5_208
# %bb.207:                              # %delete.notnull.i474
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB5_208:                              # %_ZN11CStringBaseIwED2Ev.exit475
	ld.d	$a0, $sp, 144
	beqz	$a0, .LBB5_210
# %bb.209:                              # %delete.notnull.i477
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB5_210:                              # %cleanup365
	ld.d	$a0, $sp, 160
	beqz	$a0, .LBB5_212
# %bb.211:                              # %delete.notnull.i480
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB5_212:                              # %if.then.i483
	ld.d	$a0, $fp, 0
	ld.d	$a1, $a0, 16
.Ltmp181:                               # EH_LABEL
	move	$a0, $fp
...
.Ltmp117:                               # EH_LABEL
	b	.LBB5_268
.LBB5_228:                              # %terminate.lpad.i252
.Ltmp96:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB5_229:                              # %lpad134.body.thread
.Ltmp87:                                # EH_LABEL
	move	$s1, $a1
	move	$s2, $a0
	ori	$a1, $zero, 8
...
.LBB5_233:                              # %lpad50
	...
	move	$s2, $a0
	beqz	$a2, .LBB5_278
# %bb.234:                              # %delete.notnull.i158
	move	$a0, $a2
	b	.LBB5_277
.LBB5_235:                              # %terminate.lpad.i418
.Ltmp152:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB5_236:                              # %lpad269
...
.Ltmp148:                               # EH_LABEL
	b	.LBB5_271
.LBB5_237:                              # %terminate.lpad.i414
.Ltmp149:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB5_238:                              # %terminate.lpad.i408
.Ltmp132:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB5_239:                              # %lpad187
...
.LBB5_243:                              # %lpad148
	...
	move	$s2, $a0
	beqz	$a2, .LBB5_245
# %bb.244:                              # %delete.notnull.i361
	move	$a0, $a2
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB5_245:                              # %ehcleanup152
	ld.d	$a0, $sp, 40
	bnez	$a0, .LBB5_274
	b	.LBB5_275
.LBB5_246:                              # %lpad141
...
.LBB5_251:                              # %lpad48
.Ltmp46:                                # EH_LABEL
.LBB5_252:                              # %ehcleanup356
	move	$s1, $a1
	move	$s2, $a0
	b	.LBB5_278
.LBB5_253:                              # %terminate.lpad.i449
.Ltmp180:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB5_254:                              # %lpad134.body
.Ltmp90:                                # EH_LABEL
	move	$s1, $a1
	move	$s2, $a0
	beqz	$s0, .LBB5_275
.LBB5_255:                              # %if.then.i353
	ld.d	$a0, $s0, 0
	ld.d	$a1, $a0, 16
.Ltmp91:                                # EH_LABEL
	move	$a0, $s0
...
.LBB5_267:                              # %lpad242
.Ltmp141:                               # EH_LABEL
.LBB5_268:                              # %ehcleanup344
	move	$s1, $a1
	move	$s2, $a0
	b	.LBB5_275
.LBB5_269:                              # %lpad246
.Ltmp162:                               # EH_LABEL
.LBB5_270:                              # %ehcleanup330
	move	$s1, $a1
	move	$s2, $a0
...
.Ltmp166:                               # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp167:                               # EH_LABEL
.LBB5_273:                              # %_ZN9CMyComPtrI9IInStreamED2Ev.exit462
	ld.d	$a0, $sp, 56
	beqz	$a0, .LBB5_275
.LBB5_274:                              # %delete.notnull.i464
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB5_275:                              # %ehcleanup344
	addi.d	$a0, $sp, 72
	pcaddu18i	$ra, %call36(_ZN8NArchive6NSplit8CSeqNameD2Ev)
	jirl	$ra, $ra, 0
.LBB5_276:                              # %ehcleanup352
	ld.d	$a0, $sp, 112
	beqz	$a0, .LBB5_278
.LBB5_277:                              # %delete.notnull.i497
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB5_278:                              # %ehcleanup356
	ld.d	$a0, $sp, 128
	beqz	$a0, .LBB5_280
# %bb.279:                              # %delete.notnull.i500
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB5_280:                              # %ehcleanup358
	ld.d	$a0, $sp, 144
	beqz	$a0, .LBB5_282
# %bb.281:                              # %delete.notnull.i503
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB5_282:                              # %ehcleanup366
	ld.d	$a0, $sp, 160
	beqz	$a0, .LBB5_294
# %bb.283:                              # %delete.notnull.i506
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	b	.LBB5_294
.LBB5_284:                              # %terminate.lpad.i460
.Ltmp168:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB5_285:                              # %terminate.lpad.i
.Ltmp34:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB5_286:                              # %lpad18
...
.Ltmp22:                                # EH_LABEL
	b	.LBB5_293
.LBB5_290:                              # %terminate.lpad.i494
.Ltmp186:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB5_291:                              # %terminate.lpad.i487
.Ltmp183:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB5_292:                              # %lpad6
.Ltmp19:                                # EH_LABEL
.LBB5_293:                              # %if.then.i509
	move	$s1, $a1
	move	$s2, $a0
...
.Ltmp173:                               # EH_LABEL
	b	.LBB5_301
.LBB5_297:                              # %terminate.lpad.i521
.Ltmp174:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB5_298:                              # %terminate.lpad.i513
.Ltmp171:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB5_299:                              # %lpad4
...
.Ltmp242:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp243:                               # EH_LABEL
# %bb.10:                               # %call.i.i57.noexc
                                        #   in Loop: Header=BB6_4 Depth=1
	move	$s2, $a0
	blez	$s7, .LBB6_22
# %bb.11:                               # %delete.notnull.i.i58
                                        #   in Loop: Header=BB6_4 Depth=1
	move	$a0, $s1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
...
.Ltmp233:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp234:                               # EH_LABEL
# %bb.16:                               # %call.i.i82.noexc
                                        #   in Loop: Header=BB6_4 Depth=1
	move	$s2, $a0
	blez	$s7, .LBB6_18
# %bb.17:                               # %delete.notnull.i.i94
                                        #   in Loop: Header=BB6_4 Depth=1
	move	$a0, $s1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
...
.LBB6_19:                               # %if.end9.i.i84
	...
	move	$s1, $s2
	ori	$s2, $zero, 90
.LBB6_20:                               # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i87
                                        #   in Loop: Header=BB6_4 Depth=1
	ld.d	$a0, $sp, 40
	move	$a1, $zero
	.p2align	4, , 16
.LBB6_21:                               # %while.cond.i.i88
...
.Ltmp194:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp195:                               # EH_LABEL
# %bb.35:                               # %call.i.i207.noexc
                                        #   in Loop: Header=BB6_31 Depth=1
	move	$s2, $a0
	blez	$fp, .LBB6_37
# %bb.36:                               # %delete.notnull.i.i219
                                        #   in Loop: Header=BB6_31 Depth=1
	move	$a0, $s1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
...
.LBB6_38:                               # %if.end9.i.i209
	...
	st.w	$s8, $sp, 68
	move	$s1, $s2
.LBB6_39:                               # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i212
                                        #   in Loop: Header=BB6_31 Depth=1
	ld.d	$a0, $sp, 40
	move	$a1, $zero
	.p2align	4, , 16
.LBB6_40:                               # %while.cond.i.i213
...
# %bb.41:                               # %invoke.cont101
	...
	st.w	$a1, $sp, 64
	beqz	$a0, .LBB6_43
# %bb.42:                               # %delete.notnull.i224
                                        #   in Loop: Header=BB6_31 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_43:                               # %_ZN11CStringBaseIwED2Ev.exit225
                                        #   in Loop: Header=BB6_31 Depth=1
	beqz	$s3, .LBB6_58
# %bb.44:                               # %cleanup151
                                        #   in Loop: Header=BB6_31 Depth=1
...
.Ltmp203:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp204:                               # EH_LABEL
# %bb.50:                               # %call.i.i298.noexc
	move	$s1, $a0
	blez	$s5, .LBB6_69
# %bb.51:                               # %delete.notnull.i.i310
	move	$a0, $s2
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	ld.w	$a0, $sp, 64
...
.LBB6_69:
	move	$a0, $zero
.LBB6_70:                               # %if.end9.i.i300
	st.d	$s1, $sp, 56
	slli.d	$a0, $a0, 2
	stx.w	$zero, $s1, $a0
	st.w	$fp, $sp, 68
.LBB6_71:                               # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i303
	ld.d	$a0, $sp, 40
	move	$a1, $zero
	.p2align	4, , 16
.LBB6_72:                               # %while.cond.i.i304
                                        # =>This Inner Loop Header: Depth=1
	ldx.w	$a2, $a0, $a1
	stx.w	$a2, $s1, $a1
	addi.d	$a1, $a1, 4
...
# %bb.73:                               # %invoke.cont127
	...
	st.w	$a1, $sp, 64
	beqz	$a0, .LBB6_75
# %bb.74:                               # %delete.notnull.i315
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_75:                               # %_ZN11CStringBaseIwED2Ev.exit316
	ori	$a0, $zero, 2
	bltu	$s3, $a0, .LBB6_124
# %bb.76:                               # %for.body134.lr.ph
	...
	b	.LBB6_78
	.p2align	4, , 16
.LBB6_77:                               # %_ZN11CStringBaseIwED2Ev.exit354
...
.Ltmp212:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp213:                               # EH_LABEL
# %bb.82:                               # %call.i.i336.noexc
                                        #   in Loop: Header=BB6_78 Depth=1
	move	$s2, $a0
	blez	$s6, .LBB6_84
# %bb.83:                               # %delete.notnull.i.i348
                                        #   in Loop: Header=BB6_78 Depth=1
	move	$a0, $s1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
...
.LBB6_85:                               # %if.end9.i.i338
	...
	st.w	$s5, $sp, 68
	move	$s1, $s2
.LBB6_86:                               # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i341
                                        #   in Loop: Header=BB6_78 Depth=1
	ld.d	$a0, $sp, 40
	move	$a1, $zero
	.p2align	4, , 16
.LBB6_87:                               # %while.cond.i.i342
...
# %bb.88:                               # %invoke.cont144
	...
	st.w	$a1, $sp, 64
	beqz	$a0, .LBB6_77
# %bb.89:                               # %delete.notnull.i353
                                        #   in Loop: Header=BB6_78 Depth=1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	b	.LBB6_77
.LBB6_90:                               # %if.end.i.i246
	slti	$a0, $a0, -1
	slli.d	$a1, $s4, 2
	masknez	$a1, $a1, $a0
	ld.d	$a2, $sp, 32                    # 8-byte Folded Reload
...
.Ltmp224:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp225:                               # EH_LABEL
# %bb.91:                               # %call.i.i248.noexc
	move	$s2, $a0
	blez	$s5, .LBB6_96
# %bb.92:                               # %delete.notnull.i.i260
	move	$a0, $s3
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	ld.w	$a0, $sp, 64
	b	.LBB6_97
.LBB6_93:                               # %if.end.i.i122
	slti	$a0, $a0, -1
	slli.d	$a1, $s3, 2
	masknez	$a1, $a1, $a0
	ld.d	$a2, $sp, 32                    # 8-byte Folded Reload
...
.Ltmp251:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp252:                               # EH_LABEL
# %bb.94:                               # %call.i.i124.noexc
	move	$s1, $a0
	blez	$s4, .LBB6_103
# %bb.95:                               # %delete.notnull.i.i136
	move	$a0, $s2
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	ld.w	$a0, $sp, 64
...
.LBB6_96:
	move	$a0, $zero
.LBB6_97:                               # %if.end9.i.i250
	st.d	$s2, $sp, 56
	slli.d	$a0, $a0, 2
	stx.w	$zero, $s2, $a0
	st.w	$s4, $sp, 68
.LBB6_98:                               # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i253
	ld.d	$a0, $sp, 40
	move	$a1, $zero
	.p2align	4, , 16
.LBB6_99:                               # %while.cond.i.i254
                                        # =>This Inner Loop Header: Depth=1
	ldx.w	$a2, $a0, $a1
	stx.w	$a2, $s2, $a1
	addi.d	$a1, $a1, 4
...
# %bb.100:                              # %invoke.cont114
	...
	st.w	$a1, $sp, 64
	beqz	$a0, .LBB6_102
# %bb.101:                              # %delete.notnull.i265
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_102:                              # %if.end159.loopexit484
	move	$a0, $s1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	b	.LBB6_124
.LBB6_103:
	move	$a0, $zero
.LBB6_104:                              # %if.end9.i.i126
	st.d	$s1, $sp, 56
	slli.d	$a0, $a0, 2
	stx.w	$zero, $s1, $a0
	st.w	$s3, $sp, 68
.LBB6_105:                              # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i129
	ld.d	$a0, $sp, 40
	move	$a1, $zero
	.p2align	4, , 16
.LBB6_106:                              # %while.cond.i.i130
                                        # =>This Inner Loop Header: Depth=1
	ldx.w	$a2, $a0, $a1
	stx.w	$a2, $s1, $a1
	addi.d	$a1, $a1, 4
...
# %bb.107:                              # %invoke.cont48
	...
	st.w	$a1, $sp, 64
	beqz	$a0, .LBB6_109
# %bb.108:                              # %delete.notnull.i141
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_109:                              # %_ZN11CStringBaseIwED2Ev.exit142
	ori	$a0, $zero, 2
	bltu	$fp, $a0, .LBB6_124
# %bb.110:                              # %for.body54.lr.ph
	...
	b	.LBB6_112
	.p2align	4, , 16
.LBB6_111:                              # %_ZN11CStringBaseIwED2Ev.exit180
...
.Ltmp260:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp261:                               # EH_LABEL
# %bb.116:                              # %call.i.i162.noexc
                                        #   in Loop: Header=BB6_112 Depth=1
	move	$s2, $a0
	blez	$s5, .LBB6_118
# %bb.117:                              # %delete.notnull.i.i174
                                        #   in Loop: Header=BB6_112 Depth=1
	move	$a0, $s1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
...
.LBB6_119:                              # %if.end9.i.i164
	...
	st.w	$s4, $sp, 68
	move	$s1, $s2
.LBB6_120:                              # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i167
                                        #   in Loop: Header=BB6_112 Depth=1
	ld.d	$a0, $sp, 40
	move	$a1, $zero
	.p2align	4, , 16
.LBB6_121:                              # %while.cond.i.i168
...
.Ltmp269:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp270:                               # EH_LABEL
# %bb.128:                              # %call.i.i368.noexc
	move	$s2, $a0
	blez	$s4, .LBB6_130
# %bb.129:                              # %delete.notnull.i.i380
	move	$a0, $s3
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	ld.w	$a0, $s0, 24
...
.LBB6_130:
	move	$a0, $zero
.LBB6_131:                              # %if.end9.i.i370
	st.d	$s2, $s0, 16
	slli.d	$a0, $a0, 2
	stx.w	$zero, $s2, $a0
	st.w	$fp, $s0, 28
.LBB6_132:                              # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i373
	ld.d	$a0, $sp, 56
	.p2align	4, , 16
.LBB6_133:                              # %while.cond.i.i374
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a1, $a0, 0
	addi.d	$a0, $a0, 4
	addi.d	$a2, $s2, 4
...
.Ltmp271:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp272:                               # EH_LABEL
# %bb.138:                              # %call.i.i.i.noexc404
	st.d	$a0, $s5, 0
	st.w	$zero, $a0, 0
	st.w	$s2, $s5, 12
.LBB6_139:                              # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i390
	ld.d	$a1, $s0, 0
	.p2align	4, , 16
.LBB6_140:                              # %while.cond.i.i.i391
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a2, $a1, 0
	addi.d	$a1, $a1, 4
	addi.d	$a3, $a0, 4
	...
	move	$a0, $a3
	bnez	$a2, .LBB6_140
# %bb.141:                              # %_ZN11CStringBaseIwEC2ERKS0_.exit.i397
	st.w	$fp, $s5, 8
.Ltmp274:                               # EH_LABEL
	move	$a0, $s5
	move	$a1, $s1
...
# %bb.142:                              # %invoke.cont166
	ld.d	$a0, $sp, 56
	beqz	$a0, .LBB6_144
# %bb.143:                              # %delete.notnull.i409
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB6_144:                              # %_ZN11CStringBaseIwED2Ev.exit410
...
.Ltmp220:                               # EH_LABEL
	move	$fp, $a0
.LBB6_154:                              # %_ZN11CStringBaseIwED2Ev.exit278
	move	$a0, $s1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 56
...
# %bb.180:                              # %ehcleanup168
	ld.d	$a0, $sp, 56
	bnez	$a0, .LBB6_183
.LBB6_181:                              # %_ZN11CStringBaseIwED2Ev.exit413
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB6_182:                              # %delete.notnull.i61
	move	$a0, $a1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 56
	beqz	$a0, .LBB6_181
.LBB6_183:                              # %delete.notnull.i412
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
