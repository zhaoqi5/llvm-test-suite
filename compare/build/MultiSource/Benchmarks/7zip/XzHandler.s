...
# %bb.51:                               # %iter.check460
	...
	ori	$a4, $zero, 63
	bgeu	$a4, $a3, .LBB11_62
# %bb.52:                               # %vector.main.loop.iter.check462
                                        #   in Loop: Header=BB11_44 Depth=2
	ori	$a2, $zero, 64
	bgeu	$a1, $a2, .LBB11_55
...
.LBB11_56:                              # %vector.body466
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB11_56
# %bb.57:                               # %middle.block471
                                        #   in Loop: Header=BB11_44 Depth=2
	beq	$a2, $a1, .LBB11_64
# %bb.58:                               # %vec.epilog.iter.check476
                                        #   in Loop: Header=BB11_44 Depth=2
	andi	$a3, $a1, 48
	beqz	$a3, .LBB11_62
.LBB11_59:                              # %vec.epilog.ph475
                                        #   in Loop: Header=BB11_44 Depth=2
	move	$a5, $a2
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB11_60:                              # %vec.epilog.vector.body481
                                        #   Parent Loop BB11_41 Depth=1
                                        #     Parent Loop BB11_44 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vld	$vr0, $a5, 0
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB11_60
# %bb.61:                               # %vec.epilog.middle.block485
                                        #   in Loop: Header=BB11_44 Depth=2
	beq	$a2, $a1, .LBB11_64
...
# %bb.76:                               # %iter.check426
	...
	ori	$a4, $zero, 63
	bgeu	$a4, $a3, .LBB11_87
# %bb.77:                               # %vector.main.loop.iter.check428
                                        #   in Loop: Header=BB11_41 Depth=1
	ori	$a2, $zero, 64
	bgeu	$a1, $a2, .LBB11_80
...
.LBB11_81:                              # %vector.body432
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB11_81
# %bb.82:                               # %middle.block437
                                        #   in Loop: Header=BB11_41 Depth=1
	beq	$a2, $a1, .LBB11_89
# %bb.83:                               # %vec.epilog.iter.check442
                                        #   in Loop: Header=BB11_41 Depth=1
	andi	$a3, $a1, 48
	beqz	$a3, .LBB11_87
.LBB11_84:                              # %vec.epilog.ph441
                                        #   in Loop: Header=BB11_41 Depth=1
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	...
	add.d	$a4, $s5, $a5
	add.d	$a5, $a0, $a5
.LBB11_85:                              # %vec.epilog.vector.body447
                                        #   Parent Loop BB11_41 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB11_85
# %bb.86:                               # %vec.epilog.middle.block451
                                        #   in Loop: Header=BB11_41 Depth=1
	beq	$a2, $a1, .LBB11_89
...
# %bb.99:                               # %for.cond.preheader.i.i.i221
	...
	addi.w	$a1, $s4, 0
	blt	$a1, $s8, .LBB11_104
# %bb.100:                              # %iter.check392
                                        #   in Loop: Header=BB11_41 Depth=1
	move	$a2, $zero
	ori	$a3, $zero, 16
	bltu	$a1, $a3, .LBB11_112
# %bb.101:                              # %iter.check392
                                        #   in Loop: Header=BB11_41 Depth=1
	sub.d	$a3, $s6, $a0
	ori	$a4, $zero, 63
	bgeu	$a4, $a3, .LBB11_112
# %bb.102:                              # %vector.main.loop.iter.check394
                                        #   in Loop: Header=BB11_41 Depth=1
	ori	$a2, $zero, 64
...
.LBB11_106:                             # %vector.body398
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB11_106
# %bb.107:                              # %middle.block403
                                        #   in Loop: Header=BB11_41 Depth=1
	beq	$a2, $a1, .LBB11_114
# %bb.108:                              # %vec.epilog.iter.check408
                                        #   in Loop: Header=BB11_41 Depth=1
	andi	$a3, $a1, 48
	beqz	$a3, .LBB11_112
.LBB11_109:                             # %vec.epilog.ph407
	...
	add.d	$a4, $s6, $a5
	add.d	$a5, $a0, $a5
.LBB11_110:                             # %vec.epilog.vector.body413
                                        #   Parent Loop BB11_41 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB11_110
# %bb.111:                              # %vec.epilog.middle.block417
                                        #   in Loop: Header=BB11_41 Depth=1
	beq	$a2, $a1, .LBB11_114
...
# %bb.146:                              # %for.cond.preheader.i.i.i133
	...
	ld.d	$a0, $sp, 96
	blt	$s7, $a1, .LBB11_151
# %bb.147:                              # %iter.check358
                                        #   in Loop: Header=BB11_142 Depth=2
	move	$a1, $zero
	ori	$a2, $zero, 16
	bltu	$s7, $a2, .LBB11_159
# %bb.148:                              # %iter.check358
                                        #   in Loop: Header=BB11_142 Depth=2
	sub.d	$a2, $s5, $a0
	ori	$a3, $zero, 63
	bgeu	$a3, $a2, .LBB11_159
# %bb.149:                              # %vector.main.loop.iter.check360
                                        #   in Loop: Header=BB11_142 Depth=2
	ori	$a1, $zero, 64
...
.LBB11_153:                             # %vector.body364
	...
	addi.d	$a3, $a3, 64
	bnez	$a4, .LBB11_153
# %bb.154:                              # %middle.block369
                                        #   in Loop: Header=BB11_142 Depth=2
	beq	$a1, $s7, .LBB11_161
# %bb.155:                              # %vec.epilog.iter.check374
                                        #   in Loop: Header=BB11_142 Depth=2
	andi	$a2, $s7, 48
	beqz	$a2, .LBB11_159
.LBB11_156:                             # %vec.epilog.ph373
                                        #   in Loop: Header=BB11_142 Depth=2
	move	$a4, $a1
	...
	add.d	$a4, $a0, $a4
	.p2align	4, , 16
.LBB11_157:                             # %vec.epilog.vector.body379
                                        #   Parent Loop BB11_41 Depth=1
                                        #     Parent Loop BB11_142 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vld	$vr0, $a4, 0
	...
	addi.d	$a4, $a4, 16
	bnez	$a2, .LBB11_157
# %bb.158:                              # %vec.epilog.middle.block383
                                        #   in Loop: Header=BB11_142 Depth=2
	beq	$a1, $s7, .LBB11_161
...
# %bb.174:                              # %middle.block335
                                        #   in Loop: Header=BB11_142 Depth=2
	beq	$a1, $s7, .LBB11_139
# %bb.175:                              # %vec.epilog.iter.check340
                                        #   in Loop: Header=BB11_142 Depth=2
	andi	$a2, $s7, 48
	beqz	$a2, .LBB11_179
.LBB11_176:                             # %vec.epilog.ph339
                                        #   in Loop: Header=BB11_142 Depth=2
	move	$a4, $a1
	bstrpick.d	$a1, $s7, 30, 4
	slli.d	$a1, $a1, 4
	...
	add.d	$a4, $a0, $a4
	.p2align	4, , 16
.LBB11_177:                             # %vec.epilog.vector.body345
                                        #   Parent Loop BB11_41 Depth=1
                                        #     Parent Loop BB11_142 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vld	$vr0, $a4, 0
	...
	addi.d	$a4, $a4, 16
	bnez	$a2, .LBB11_177
# %bb.178:                              # %vec.epilog.middle.block349
                                        #   in Loop: Header=BB11_142 Depth=2
	beq	$a1, $s7, .LBB11_139
