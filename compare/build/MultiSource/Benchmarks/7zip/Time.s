...
# %bb.1:                                # %if.end
	...
	ori	$t2, $zero, 2622
	mul.d	$t1, $t1, $t2
	pcalau12i	$t2, %pc_hi20(.L__const._ZN8NWindows5NTime19GetSecondsSince1601EjjjjjjRy.ms)
	addi.d	$t2, $t2, %pc_lo12(.L__const._ZN8NWindows5NTime19GetSecondsSince1601EjjjjjjRy.ms)
	ld.w	$t3, $t2, 8
	srli.d	$t1, $t1, 16
	ld.d	$t2, $t2, 0
	add.w	$a2, $a2, $t1
