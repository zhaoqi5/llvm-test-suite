...
.LBB4_42:                               # %vec.epilog.ph111
	...
	add.d	$a4, $s0, $a5
	add.d	$a5, $a0, $a5
.LBB4_43:                               # %vec.epilog.vector.body114
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB4_43
# %bb.44:                               # %vec.epilog.middle.block118
	bne	$a2, $a1, .LBB4_50
	b	.LBB4_52
.LBB4_45:                               # %for.cond.cleanup.i.i48
	bnez	$a0, .LBB4_52
	b	.LBB4_53
.LBB4_46:                               # %vector.ph97
	andi	$a3, $a1, 16
...
.LBB4_47:                               # %vector.body100
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB4_47
# %bb.48:                               # %middle.block105
	beq	$a2, $a1, .LBB4_52
# %bb.49:                               # %vec.epilog.iter.check109
	bnez	$a3, .LBB4_42
...
.LBB7_32:                               # %vec.epilog.ph174
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB7_33:                               # %vec.epilog.vector.body177
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
...
# %bb.34:                               # %vec.epilog.middle.block181
	bne	$a2, $a1, .LBB7_40
	b	.LBB7_42
.LBB7_35:                               # %for.cond.cleanup.i.i32
	bnez	$a0, .LBB7_42
	b	.LBB7_43
.LBB7_36:                               # %vector.ph160
	andi	$a3, $a1, 16
	bstrpick.d	$a2, $a1, 30, 5
	slli.d	$a2, $a2, 5
	addi.d	$a4, $s1, 16
...
.LBB7_54:                               # %vec.epilog.ph207
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB7_55:                               # %vec.epilog.vector.body210
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
...
# %bb.56:                               # %vec.epilog.middle.block214
	bne	$a2, $a1, .LBB7_62
	b	.LBB7_64
.LBB7_57:                               # %for.cond.cleanup.i.i73
	bnez	$a0, .LBB7_64
	b	.LBB7_65
.LBB7_58:                               # %vector.ph193
	andi	$a3, $a1, 16
	bstrpick.d	$a2, $a1, 30, 5
	slli.d	$a2, $a2, 5
	addi.d	$a4, $s1, 16
...
.LBB7_76:                               # %vec.epilog.ph240
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB7_77:                               # %vec.epilog.vector.body243
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
...
# %bb.78:                               # %vec.epilog.middle.block247
	bne	$a2, $a1, .LBB7_84
	b	.LBB7_86
.LBB7_79:                               # %for.cond.cleanup.i.i114
	bnez	$a0, .LBB7_86
	b	.LBB7_87
.LBB7_80:                               # %vector.ph226
	andi	$a3, $a1, 16
	bstrpick.d	$a2, $a1, 30, 5
	slli.d	$a2, $a2, 5
	addi.d	$a4, $s1, 16
