...
# %bb.39:                               # %iter.check86
	...
	ori	$a4, $zero, 63
	bgeu	$a4, $a3, .LBB4_50
# %bb.40:                               # %vector.main.loop.iter.check88
	ori	$a2, $zero, 64
	bgeu	$a1, $a2, .LBB4_43
# %bb.41:
	move	$a2, $zero
...
# %bb.45:                               # %middle.block97
	beq	$a2, $a1, .LBB4_52
# %bb.46:                               # %vec.epilog.iter.check102
	andi	$a3, $a1, 48
	beqz	$a3, .LBB4_50
.LBB4_47:                               # %vec.epilog.ph101
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	add.d	$a4, $s0, $a5
	add.d	$a5, $a0, $a5
.LBB4_48:                               # %vec.epilog.vector.body107
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB4_48
# %bb.49:                               # %vec.epilog.middle.block111
	beq	$a2, $a1, .LBB4_52
...
.LBB7_37:                               # %vec.epilog.ph168
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB7_38:                               # %vec.epilog.vector.body174
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
...
.LBB7_59:                               # %vec.epilog.ph202
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB7_60:                               # %vec.epilog.vector.body208
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
...
.LBB7_81:                               # %vec.epilog.ph236
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB7_82:                               # %vec.epilog.vector.body242
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
