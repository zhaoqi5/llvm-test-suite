...
# %bb.45:                               # %middle.block105
	beq	$a2, $a1, .LBB4_52
# %bb.46:                               # %vec.epilog.iter.check109
	beqz	$a3, .LBB4_50
.LBB4_47:                               # %vec.epilog.ph111
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	sub.d	$a3, $a5, $a2
	add.d	$a4, $s0, $a5
	add.d	$a5, $a0, $a5
.LBB4_48:                               # %vec.epilog.vector.body114
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB4_48
# %bb.49:                               # %vec.epilog.middle.block118
	beq	$a2, $a1, .LBB4_52
...
.LBB7_37:                               # %vec.epilog.ph174
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB7_38:                               # %vec.epilog.vector.body177
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
...
.LBB7_59:                               # %vec.epilog.ph207
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB7_60:                               # %vec.epilog.vector.body210
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
...
.LBB7_81:                               # %vec.epilog.ph240
	...
	add.d	$a5, $a0, $a5
	.p2align	4, , 16
.LBB7_82:                               # %vec.epilog.vector.body243
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 16
