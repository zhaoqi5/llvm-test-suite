...
.Ltmp269:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp270:                               # EH_LABEL
# %bb.174:                              # %invoke.cont509
	move	$s4, $a0
	bnez	$a0, .LBB9_178
# %bb.175:                              # %cleanup.cont517
.Ltmp271:                               # EH_LABEL
	addi.d	$a0, $sp, 936
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVector12ClearAndFreeEv)
	jirl	$ra, $ra, 0
.Ltmp272:                               # EH_LABEL
# %bb.176:                              # %invoke.cont518
	ld.d	$a2, $sp, 712
	addi.d	$a3, $sp, 722
.Ltmp273:                               # EH_LABEL
	addi.d	$a0, $sp, 576
...
.LBB9_180:                              # %_ZN9CMyComPtrI22ICryptoGetTextPasswordED2Ev.exit
	...
	ld.d	$a0, $sp, 696
	beqz	$a0, .LBB9_182
# %bb.181:                              # %if.then.i.i379
	ld.d	$a1, $a0, 0
	ld.d	$a1, $a1, 16
.Ltmp288:                               # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp289:                               # EH_LABEL
.LBB9_182:                              # %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit.i384
	ld.d	$a0, $sp, 688
	beqz	$a0, .LBB9_184
# %bb.183:                              # %if.then.i2.i387
	ld.d	$a1, $a0, 0
	ld.d	$a1, $a1, 16
.Ltmp291:                               # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp292:                               # EH_LABEL
.LBB9_184:                              # %_ZN9CMyComPtrI10IOutStreamED2Ev.exit.i392
.Ltmp294:                               # EH_LABEL
	move	$a0, $s2
	pcaddu18i	$ra, %call36(_ZN10COutBuffer4FreeEv)
	jirl	$ra, $ra, 0
.Ltmp295:                               # EH_LABEL
# %bb.185:                              # %invoke.cont.i.i
	ld.d	$a0, $sp, 632
	beqz	$a0, .LBB9_187
...
# %bb.192:                              # %_ZN8NArchive3N7z22CCompressionMethodModeD2Ev.exit
	...
	ld.d	$a0, $sp, 920
	beqz	$a0, .LBB9_194
# %bb.193:                              # %delete.notnull.i.i428
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
.LBB9_194:                              # %_ZN11CStringBaseIwED2Ev.exit.i429
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVectorD2Ev)
	jirl	$ra, $ra, 0
	st.d	$s0, $sp, 848
.Ltmp306:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp307:                               # EH_LABEL
# %bb.195:                              # %_ZN8NArchive3N7z22CCompressionMethodModeD2Ev.exit432
	addi.d	$a0, $sp, 848
	pcaddu18i	$ra, %call36(_ZN17CBaseRecordVectorD2Ev)
	jirl	$ra, $ra, 0
.LBB9_196:                              # %cleanup555
...
.Ltmp254:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp255:                               # EH_LABEL
# %bb.201:                              # %call.i.i344.noexc
	move	$s5, $a0
	blez	$s2, .LBB9_203
# %bb.202:                              # %delete.notnull.i.i357
	move	$a0, $s6
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	ld.w	$a0, $sp, 840
...
.LBB9_203:
	move	$a0, $zero
.LBB9_204:                              # %if.end9.i.i346
	st.d	$s5, $sp, 832
	slli.d	$a0, $a0, 2
	stx.w	$zero, $s5, $a0
	st.w	$s4, $sp, 844
.LBB9_205:                              # %_ZN11CStringBaseIwE11SetCapacityEi.exit.i349
	ld.d	$s1, $sp, 64                    # 8-byte Folded Reload
	ld.d	$a0, $sp, 920
	.p2align	4, , 16
.LBB9_206:                              # %while.cond.i.i350
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a1, $a0, 0
	addi.d	$a0, $a0, 4
	addi.d	$a2, $s5, 4
	...
	move	$s5, $a2
	bnez	$a1, .LBB9_206
# %bb.207:                              # %_ZN11CStringBaseIwEaSERKS0_.exit360
	ld.w	$a0, $sp, 928
	st.w	$a0, $sp, 840
	ori	$a0, $zero, 1
	ori	$a1, $zero, 1
...
.Ltmp182:                               # EH_LABEL
	move	$fp, $a1
	move	$s0, $a0
.LBB9_213:                              # %ehcleanup173
	ld.d	$a0, $sp, 760
	beqz	$a0, .LBB9_244
# %bb.214:                              # %delete.notnull.i237
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	b	.LBB9_244
.LBB9_215:                              # %lpad164
...
.Ltmp205:                               # EH_LABEL
	b	.LBB9_283
.LBB9_218:                              # %terminate.lpad.i258
.Ltmp206:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB9_219:                              # %terminate.lpad.i330
.Ltmp253:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB9_220:                              # %terminate.lpad.i.i.i
.Ltmp299:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB9_221:                              # %terminate.lpad.i6.i391
.Ltmp293:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB9_222:                              # %terminate.lpad.i.i383
.Ltmp290:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB9_223:                              # %terminate.lpad.i375
.Ltmp287:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB9_224:                              # %terminate.lpad.i253
.Ltmp200:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB9_225:                              # %lpad190
...
.Ltmp196:                               # EH_LABEL
	b	.LBB9_283
.LBB9_226:                              # %terminate.lpad.i249
.Ltmp197:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB9_227:                              # %terminate.lpad.i403
.Ltmp244:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB9_228:                              # %terminate.lpad.i7.i
.Ltmp296:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB9_229:                              # %lpad496
...
.LBB9_234:                              # %_ZN9CMyComPtrI10IOutStreamED2Ev.exit.i
	...
	jirl	$ra, $ra, 0
	b	.LBB9_252
.LBB9_235:                              # %terminate.lpad.i6.i
.Ltmp265:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB9_236:                              # %terminate.lpad.i.i364
.Ltmp262:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB9_237:                              # %terminate.lpad.i411
.Ltmp302:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB9_238:                              # %lpad373
...
.Ltmp249:                               # EH_LABEL
	b	.LBB9_252
.LBB9_240:                              # %terminate.lpad.i332
.Ltmp250:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB9_241:                              # %terminate.lpad.i240
.Ltmp191:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB9_242:                              # %lpad143
.Ltmp176:                               # EH_LABEL
.LBB9_243:                              # %ehcleanup179
	move	$fp, $a1
	move	$s0, $a0
...
.Ltmp187:                               # EH_LABEL
	b	.LBB9_283
.LBB9_245:                              # %terminate.lpad.i245
.Ltmp188:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB9_246:                              # %lpad359
.Ltmp238:                               # EH_LABEL
.LBB9_247:                              # %ehcleanup544
	move	$fp, $a1
	move	$s0, $a0
	b	.LBB9_252
.LBB9_248:                              # %lpad504
.Ltmp275:                               # EH_LABEL
.LBB9_249:                              # %ehcleanup526
	move	$fp, $a1
	move	$s0, $a0
	ld.d	$a0, $sp, 88
	beqz	$a0, .LBB9_251
...
.Ltmp276:                               # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp277:                               # EH_LABEL
.LBB9_251:                              # %_ZN9CMyComPtrI22ICryptoGetTextPasswordED2Ev.exit402
	addi.d	$a0, $sp, 96
	pcaddu18i	$ra, %call36(_ZN8NArchive3N7z16CArchiveDatabaseD2Ev)
	jirl	$ra, $ra, 0
	addi.d	$a0, $sp, 576
...
.Ltmp280:                               # EH_LABEL
	b	.LBB9_270
.LBB9_254:                              # %terminate.lpad.i400
.Ltmp278:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB9_255:                              # %terminate.lpad.i418
.Ltmp281:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB9_256:                              # %terminate.lpad.i5.i199
.Ltmp164:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB9_257:                              # %lpad.i190
...
.Ltmp160:                               # EH_LABEL
	b	.LBB9_283
.LBB9_258:                              # %terminate.lpad.i.i192
.Ltmp161:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB9_259:                              # %terminate.lpad.i5.i221
.Ltmp173:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB9_260:                              # %lpad.i212
...
.Ltmp169:                               # EH_LABEL
	b	.LBB9_283
.LBB9_261:                              # %terminate.lpad.i.i214
.Ltmp170:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB9_262:                              # %terminate.lpad.i5.i
.Ltmp155:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB9_263:                              # %lpad.i
...
.Ltmp223:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
	b	.LBB9_283
.LBB9_267:                              # %terminate.lpad.i.i431
.Ltmp308:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB9_268:                              # %terminate.lpad.i.i425
.Ltmp305:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB9_269:                              # %lpad345
...
.Ltmp214:                               # EH_LABEL
	b	.LBB9_283
.LBB9_276:                              # %terminate.lpad.i267
.Ltmp215:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB9_277:                              # %terminate.lpad.i433
.Ltmp311:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB9_278:                              # %terminate.lpad.i179
.Ltmp146:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB9_279:                              # %lpad72
...
.Ltmp142:                               # EH_LABEL
	b	.LBB9_283
.LBB9_280:                              # %terminate.lpad.i
.Ltmp143:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB9_281:                              # %lpad15
.Ltmp226:                               # EH_LABEL
.LBB9_282:                              # %ehcleanup326
	move	$fp, $a1
	move	$s0, $a0
.LBB9_283:                              # %ehcleanup326
	ld.d	$a0, $sp, 136
	beqz	$a0, .LBB9_288
# %bb.284:                              # %delete.notnull.i.i288
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	b	.LBB9_288
.LBB9_285:                              # %lpad13
