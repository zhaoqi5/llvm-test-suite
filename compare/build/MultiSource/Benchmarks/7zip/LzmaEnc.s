...
# %bb.95:                               # %land.rhs.preheader.i.i320
                                        #   in Loop: Header=BB24_27 Depth=1
	addi.d	$a2, $s5, -1
	bstrpick.d	$a2, $a2, 31, 0
	slli.d	$a2, $a2, 2
	...
	addi.d	$a0, $a0, -1
	ori	$t6, $zero, 1
.LBB24_96:                              # %land.rhs.i.i321
                                        #   Parent Loop BB24_27 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.bu	$a3, $a0, 0
	ldx.bu	$a4, $a0, $a2
	bne	$a3, $a4, .LBB24_123
# %bb.97:                               # %for.inc.i.i327
...
.LBB24_122:                             #   in Loop: Header=BB24_27 Depth=1
	ori	$t6, $zero, 1
.LBB24_123:                             # %ReadMatchDistances.exit.i304
                                        #   in Loop: Header=BB24_27 Depth=1
	ld.w	$a0, $s6, 4
	addi.d	$a0, $a0, 1
	st.w	$a0, $s6, 4
...
# %bb.126:                              # %lor.lhs.false.i281
	...
	slli.d	$s8, $a6, 1
	beq	$s0, $fp, .LBB24_132
# %bb.127:                              # %lor.lhs.false.i281
                                        #   in Loop: Header=BB24_27 Depth=1
	bne	$a4, $a5, .LBB24_132
# %bb.128:                              # %land.rhs.preheader.i282
                                        #   in Loop: Header=BB24_27 Depth=1
...
# %bb.134:                              # %for.cond44.preheader.1.i
	...
	ori	$s5, $zero, 2
	beq	$s0, $s5, .LBB24_139
# %bb.135:                              # %land.rhs.preheader.1.i272
                                        #   in Loop: Header=BB24_27 Depth=1
	bstrpick.d	$a4, $a2, 31, 0
	addi.d	$a4, $a4, -2
	addi.d	$a5, $a0, 1
	ori	$s5, $zero, 2
.LBB24_136:                             # %land.rhs.1.i274
                                        #   Parent Loop BB24_27 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.bu	$a6, $a5, 0
	ldx.bu	$a7, $a5, $a3
	bne	$a6, $a7, .LBB24_139
# %bb.137:                              # %for.inc.1.i278
...
# %bb.143:                              # %for.cond44.preheader.2.i
	...
	ori	$fp, $zero, 2
	beq	$s0, $fp, .LBB24_148
# %bb.144:                              # %land.rhs.preheader.2.i262
                                        #   in Loop: Header=BB24_27 Depth=1
	bstrpick.d	$a4, $a2, 31, 0
	addi.d	$a4, $a4, -2
	addi.d	$a5, $a0, 1
	ori	$fp, $zero, 2
.LBB24_145:                             # %land.rhs.2.i264
                                        #   Parent Loop BB24_27 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.bu	$a6, $a5, 0
	ldx.bu	$a7, $a5, $a3
	bne	$a6, $a7, .LBB24_148
# %bb.146:                              # %for.inc.2.i268
...
# %bb.152:                              # %for.cond44.preheader.3.i
	...
	ori	$s0, $zero, 2
	beq	$a4, $s0, .LBB24_157
# %bb.153:                              # %land.rhs.preheader.3.i252
                                        #   in Loop: Header=BB24_27 Depth=1
	bstrpick.d	$a4, $a2, 31, 0
	addi.d	$a4, $a4, -2
	addi.d	$a5, $a0, 1
	ori	$s0, $zero, 2
.LBB24_154:                             # %land.rhs.3.i254
                                        #   Parent Loop BB24_27 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.bu	$a6, $a5, 0
	ldx.bu	$a7, $a5, $a3
	bne	$a6, $a7, .LBB24_157
# %bb.155:                              # %for.inc.3.i258
...
# %bb.172:                              # %if.then14.i341
	...
	pcaddu18i	$ra, %call36(RangeEnc_ShiftLow)
	jirl	$ra, $ra, 0
.LBB24_173:                             # %RangeEnc_EncodeBit.exit343
                                        #   in Loop: Header=BB24_27 Depth=1
	ld.d	$a1, $s3, 24
	ld.d	$a0, $s3, 48
	jirl	$ra, $a1, 0
...
# %bb.174:                              # %if.then76
	...
	b	.LBB24_176
	.p2align	4, , 16
.LBB24_175:                             # %RangeEnc_EncodeBit.exit.i366
                                        #   in Loop: Header=BB24_176 Depth=2
	bstrpick.d	$a0, $s0, 31, 15
	slli.d	$s0, $s0, 1
	bnez	$a0, .LBB24_203
.LBB24_176:                             # %do.body.i346
                                        #   Parent Loop BB24_27 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
...
# %bb.182:                              # %if.then14.i417
	...
	move	$t4, $s2
	ori	$t6, $zero, 1
.LBB24_183:                             # %RangeEnc_EncodeBit.exit419
                                        #   in Loop: Header=BB24_27 Depth=1
	ld.wu	$a0, $s6, 24
	slli.d	$a1, $a0, 1
	ld.wu	$a4, $s7, 0
...
# %bb.185:                              # %if.then14.i433
	...
	move	$t4, $s2
	ori	$t6, $zero, 1
.LBB24_186:                             # %RangeEnc_EncodeBit.exit435
                                        #   in Loop: Header=BB24_27 Depth=1
	beqz	$t4, .LBB24_239
# %bb.187:                              # %if.else123
                                        #   in Loop: Header=BB24_27 Depth=1
...
# %bb.188:                              # %if.then14.i485
	...
	move	$t4, $s2
	ori	$t6, $zero, 1
.LBB24_189:                             # %RangeEnc_EncodeBit.exit487
                                        #   in Loop: Header=BB24_27 Depth=1
	ld.wu	$a0, $s6, 24
	slli.d	$a1, $a0, 1
	ld.wu	$a4, $s7, 0
...
# %bb.193:                              # %if.then14.i556
	...
	jirl	$ra, $ra, 0
	ld.wu	$a0, $s6, 24
.LBB24_194:                             # %RangeEnc_EncodeBit.exit558
                                        #   in Loop: Header=BB24_27 Depth=1
	slli.d	$a0, $a0, 2
...
.LBB24_196:                             # %if.else79
	...
	b	.LBB24_198
	.p2align	4, , 16
.LBB24_197:                             # %RangeEnc_EncodeBit.exit.i402
...
.LBB24_208:                             # %if.then14.i.i585
	...
	jirl	$ra, $ra, 0
	ld.w	$a1, $s7, 0
.LBB24_209:                             # %RangeEnc_EncodeBit.exit.i580
                                        #   in Loop: Header=BB24_27 Depth=1
	ori	$s5, $s5, 2
	slli.d	$a0, $s5, 1
	ldx.hu	$a2, $s0, $a0
...
.LBB24_212:                             # %if.then14.i.i585.1
	...
	jirl	$ra, $ra, 0
	ld.w	$a0, $s7, 0
.LBB24_213:                             # %RangeEnc_EncodeBit.exit.i580.1
                                        #   in Loop: Header=BB24_27 Depth=1
	slli.w	$a1, $s5, 1
	or	$s5, $s8, $a1
	slli.d	$a1, $s5, 1
...
.LBB24_216:                             # %if.then14.i.i585.2
	...
	jirl	$ra, $ra, 0
	ld.w	$a1, $s7, 0
.LBB24_217:                             # %RangeEnc_EncodeBit.exit.i580.2
                                        #   in Loop: Header=BB24_27 Depth=1
	slli.w	$a0, $s5, 1
	or	$s5, $s8, $a0
	slli.d	$a0, $s5, 1
...
.LBB24_220:                             # %if.then14.i.i585.3
	...
	jirl	$ra, $ra, 0
	ld.w	$a0, $s7, 0
.LBB24_221:                             # %RangeEnc_EncodeBit.exit.i580.3
                                        #   in Loop: Header=BB24_27 Depth=1
	slli.w	$a1, $s5, 1
	or	$s5, $s8, $a1
	slli.d	$a1, $s5, 1
...
.LBB24_224:                             # %if.then14.i.i585.4
	...
	jirl	$ra, $ra, 0
	ld.w	$a1, $s7, 0
.LBB24_225:                             # %RangeEnc_EncodeBit.exit.i580.4
                                        #   in Loop: Header=BB24_27 Depth=1
	ori	$t6, $zero, 1
	slli.w	$a0, $s5, 1
	or	$a2, $s8, $a0
...
# %bb.229:                              # %if.then14.i.i585.5
	...
	jirl	$ra, $ra, 0
	ori	$t6, $zero, 1
.LBB24_230:                             # %RangeEnc_EncodeBit.exit.i580.5
                                        #   in Loop: Header=BB24_27 Depth=1
	ori	$a0, $zero, 4
...
# %bb.232:                              # %if.then244
	...
	b	.LBB24_234
	.p2align	4, , 16
.LBB24_233:                             # %RangeEnc_EncodeBit.exit.i611
...
# %bb.240:                              # %if.then14.i446
	...
	ld.wu	$a1, $s6, 24
	ld.w	$a0, $s7, 0
.LBB24_241:                             # %RangeEnc_EncodeBit.exit448
                                        #   in Loop: Header=BB24_27 Depth=1
	ld.d	$s2, $sp, 568                   # 8-byte Folded Reload
	slli.d	$a1, $a1, 5
...
# %bb.244:                              # %if.then14.i518
	...
	ld.wu	$a0, $s6, 24
	ld.w	$a2, $s7, 0
.LBB24_245:                             # %RangeEnc_EncodeBit.exit520
                                        #   in Loop: Header=BB24_27 Depth=1
	slli.d	$a1, $a0, 1
...
# %bb.260:                              # %if.then14.i537
	...
	jirl	$ra, $ra, 0
	move	$t4, $s2
.LBB24_261:                             # %RangeEnc_EncodeBit.exit543
                                        #   in Loop: Header=BB24_27 Depth=1
	ori	$a0, $zero, 3
	ori	$t6, $zero, 1
	bne	$t4, $a0, .LBB24_263
...
.LBB24_266:                             # %if.else.i.i645
	...
	srli.d	$a2, $a0, 5
	sub.d	$a0, $a0, $a2
.LBB24_267:                             # %if.end.i.i651
                                        #   in Loop: Header=BB24_27 Depth=1
	bstrpick.d	$a2, $a1, 31, 24
	ld.d	$a3, $sp, 216                   # 8-byte Folded Reload
	st.h	$a0, $a3, 0
	bnez	$a2, .LBB24_269
# %bb.268:                              # %if.then14.i.i663
                                        #   in Loop: Header=BB24_27 Depth=1
	slli.d	$a0, $a1, 8
	st.w	$a0, $s7, 0
	move	$a0, $s7
	...
	jirl	$ra, $ra, 0
	ld.w	$a1, $s7, 0
.LBB24_269:                             # %RangeEnc_EncodeBit.exit.i656
                                        #   in Loop: Header=BB24_27 Depth=1
	addi.d	$a2, $fp, 2
	slli.d	$fp, $a2, 1
	ldx.hu	$a3, $s8, $fp
...
.LBB24_271:                             # %if.else.i.i645.1
	...
	srli.d	$a1, $a3, 5
	sub.d	$a1, $a3, $a1
.LBB24_272:                             # %if.end.i.i651.1
                                        #   in Loop: Header=BB24_27 Depth=1
	alsl.d	$a2, $a2, $s8, 1
	bstrpick.d	$a3, $a0, 31, 24
	st.h	$a1, $a2, 0
	bnez	$a3, .LBB24_274
# %bb.273:                              # %if.then14.i.i663.1
                                        #   in Loop: Header=BB24_27 Depth=1
	slli.d	$a0, $a0, 8
	st.w	$a0, $s7, 0
	move	$a0, $s7
	...
	jirl	$ra, $ra, 0
	ld.w	$a0, $s7, 0
.LBB24_274:                             # %RangeEnc_EncodeBit.exit.i656.1
                                        #   in Loop: Header=BB24_27 Depth=1
	or	$fp, $fp, $s5
	addi.w	$a2, $fp, 0
	slli.d	$a1, $a2, 1
...
.LBB24_276:                             # %if.else.i.i645.2
	...
	srli.d	$a0, $a3, 5
	sub.d	$a0, $a3, $a0
.LBB24_277:                             # %if.end.i.i651.2
                                        #   in Loop: Header=BB24_27 Depth=1
	alsl.d	$a2, $a2, $s8, 1
	bstrpick.d	$a3, $a1, 31, 24
	st.h	$a0, $a2, 0
	bnez	$a3, .LBB24_279
# %bb.278:                              # %if.then14.i.i663.2
                                        #   in Loop: Header=BB24_27 Depth=1
	slli.d	$a0, $a1, 8
	st.w	$a0, $s7, 0
	move	$a0, $s7
	...
	jirl	$ra, $ra, 0
	ld.w	$a1, $s7, 0
.LBB24_279:                             # %RangeEnc_EncodeBit.exit.i656.2
                                        #   in Loop: Header=BB24_27 Depth=1
	ori	$t6, $zero, 1
	slli.w	$a0, $fp, 1
	or	$a2, $a0, $s5
...
# %bb.283:                              # %if.then14.i.i663.3
	...
	jirl	$ra, $ra, 0
	ori	$t6, $zero, 1
.LBB24_284:                             # %RangeEnc_EncodeBit.exit.i656.3
                                        #   in Loop: Header=BB24_27 Depth=1
	ori	$a0, $zero, 3164
	ldx.w	$a0, $s6, $a0
	addi.d	$a0, $a0, 1
...
# %bb.364:                              # %while.cond.i245.preheader
                                        #   in Loop: Header=BB24_27 Depth=1
	ld.d	$a3, $sp, 560                   # 8-byte Folded Reload
	ldx.w	$a1, $a3, $t8
	add.d	$a0, $a1, $a0
	addi.d	$a1, $zero, -2
.LBB24_365:                             # %while.cond.i245
                                        #   Parent Loop BB24_27 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.w	$a1, $a1, 2
	bstrpick.d	$a3, $a1, 31, 0
