...
# %bb.8:                                # %middle.block
	beq	$a1, $s0, .LBB7_13
.LBB7_9:                                # %for.body.i.i.preheader
	sub.d	$a2, $s0, $a1
	alsl.d	$a3, $a1, $fp, 2
	alsl.d	$a1, $a1, $a0, 2
	.p2align	4, , 16
.LBB7_10:                               # %for.body.i.i
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a4, $a1, 0
	st.w	$a4, $a3, 0
	addi.d	$a2, $a2, -1
...
.LBB7_11:
	...
	move	$a1, $s2
	b	.LBB7_14
.LBB7_12:                               # %for.cond.cleanup.i.i
	move	$a2, $s3
	move	$a1, $s2
	beqz	$a0, .LBB7_14
.LBB7_13:                               # %delete.notnull.i.i
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	move	$a1, $s2
	move	$a2, $s3
...
.LBB8_11:
	move	$a0, $s3
	b	.LBB8_14
.LBB8_12:                               # %for.cond.cleanup.i.i
	move	$a0, $s3
	beqz	$a1, .LBB8_14
.LBB8_13:                               # %delete.notnull.i.i
	move	$a0, $a1
	pcaddu18i	$ra, %call36(_ZdaPv)
	jirl	$ra, $ra, 0
	move	$a0, $s3
...
.Ltmp272:                               # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp273:                               # EH_LABEL
# %bb.3:                                # %_ZN9CMyComPtrI20ISequentialOutStreamE7ReleaseEv.exit18
	st.d	$zero, $fp, 224
.LBB20_4:                               # %if.end
	ld.d	$a0, $fp, 208
	beqz	$a0, .LBB20_18
