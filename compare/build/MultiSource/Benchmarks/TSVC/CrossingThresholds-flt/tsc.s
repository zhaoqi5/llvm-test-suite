...
.LBB7_3:                                # %vector.body
	...
	xvfmadd.s	$xr0, $xr0, $xr3, $xr1
	xvfadd.s	$xr0, $xr4, $xr0
	xvfadd.s	$xr1, $xr0, $xr5
	xvst	$xr1, $a0, 0
	xvstx	$xr0, $a0, $s8
	addi.d	$a1, $a1, -8
	addi.d	$a0, $a0, 32
...
# %bb.16:                               # %for.cond2.preheader.i58.preheader
	...
	ori	$a4, $zero, 256
	.p2align	4, , 16
.LBB15_17:                              # %for.cond2.preheader.i58
                                        # =>This Inner Loop Header: Depth=1
	bstrpick.d	$a5, $a3, 31, 0
	movgr2fr.d	$fa0, $a5
	ffint.d.l	$fa0, $fa0
