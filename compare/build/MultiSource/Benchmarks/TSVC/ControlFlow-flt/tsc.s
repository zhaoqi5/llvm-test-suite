...
# %bb.5:                                # %vec.epilog.vector.body
	...
	vldx	$vr8, $fp, $a0
	vfmadd.s	$vr0, $vr1, $vr2, $vr0
	vfmadd.s	$vr1, $vr4, $vr5, $vr3
	vfmadd.s	$vr2, $vr7, $vr8, $vr6
...
# %bb.1:                                # %for.cond1.preheader.preheader
	...
	addi.d	$s2, $a1, %pc_lo12(.Lswitch.table.s442)
	ori	$s3, $a0, 1024
	lu12i.w	$a0, 62
	ori	$a0, $a0, 2096
	add.d	$a0, $fp, $a0
...
# %bb.16:                               # %for.cond2.preheader.i58.preheader
	...
	ori	$a4, $zero, 256
	.p2align	4, , 16
.LBB29_17:                              # %for.cond2.preheader.i58
                                        # =>This Inner Loop Header: Depth=1
	bstrpick.d	$a5, $a3, 31, 0
	movgr2fr.d	$fa0, $a5
	ffint.d.l	$fa0, $fa0
