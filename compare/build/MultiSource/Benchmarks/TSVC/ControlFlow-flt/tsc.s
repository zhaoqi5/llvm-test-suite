...
.LBB8_4:                                # %vector.body
	...
	vld	$vr4, $a2, -16
	vldx	$vr5, $a1, $s8
	vfmadd.s	$vr0, $vr2, $vr4, $vr0
	vfmadd.s	$vr1, $vr3, $vr5, $vr1
	vstx	$vr0, $fp, $a0
	addi.d	$a0, $a0, 32
	vst	$vr1, $a1, 16
	bne	$a0, $s6, .LBB8_4
# %bb.5:                                # %for.body5.us
	...
	fmadd.s	$fa2, $fa5, $fa6, $fa4
	fmadd.s	$fa3, $ft0, $ft1, $fa7
	fmadd.s	$fa4, $ft3, $ft4, $ft2
	ld.d	$a0, $sp, 32                    # 8-byte Folded Reload
	fld.s	$fa5, $a0, 0
	ori	$a0, $s7, 2052
	fldx.s	$fa6, $fp, $a0
