...
# %bb.0:                                # %entry
	...
	pcaddu18i	$ra, %call36(init)
	jirl	$ra, $ra, 0
	pcalau12i	$s5, %pc_hi20(ntimes)
	ld.w	$a0, $s5, %pc_lo12(ntimes)
	pcalau12i	$a1, %pc_hi20(global_data)
	addi.d	$fp, $a1, %pc_lo12(global_data)
	lu12i.w	$s4, 156
	blez	$a0, .LBB7_3
# %bb.1:                                # %iter.check.preheader
	move	$s6, $zero
	lu12i.w	$a0, 62
	ori	$a0, $a0, 2100
...
.LBB7_2:                                # %iter.check
	...
	xvldx	$xr5, $fp, $a0
	xvreplve0.w	$xr1, $xr0
	xvfmadd.s	$xr2, $xr4, $xr1, $xr2
	xvfmadd.s	$xr3, $xr5, $xr1, $xr3
	ori	$a0, $s4, 2304
	xvldx	$xr4, $fp, $a0
	ori	$a0, $s4, 2336
	xvldx	$xr5, $fp, $a0
	...
	ori	$a0, $s4, 1252
	xvstx	$xr3, $fp, $a0
	xvfmadd.s	$xr2, $xr6, $xr1, $xr4
	xvfmadd.s	$xr3, $xr7, $xr1, $xr5
	ori	$a0, $s4, 2368
	xvldx	$xr4, $fp, $a0
	ori	$a0, $s4, 2400
	xvldx	$xr5, $fp, $a0
	...
	ori	$a0, $s4, 1508
	xvstx	$xr3, $fp, $a0
	xvfmadd.s	$xr2, $xr5, $xr1, $xr2
	xvfmadd.s	$xr3, $xr6, $xr1, $xr4
	ori	$a0, $s4, 1540
	xvstx	$xr2, $fp, $a0
	ori	$a0, $s4, 2624
	xvldx	$xr2, $fp, $a0
	...
	ori	$a0, $s8, 2020
	vldx	$vr5, $fp, $a0
	vfmadd.s	$vr2, $vr3, $vr1, $vr2
	ori	$a0, $s4, 2180
	vstx	$vr2, $fp, $a0
	vfmadd.s	$vr2, $vr5, $vr1, $vr4
	ori	$a0, $s4, 2196
	vstx	$vr2, $fp, $a0
	ori	$a0, $s4, 3232
	vldx	$vr2, $fp, $a0
	...
	ori	$a0, $s8, 2052
	fldx.s	$fa5, $fp, $a0
	vfmadd.s	$vr1, $vr3, $vr1, $vr2
	ori	$a0, $s4, 2212
	vstx	$vr1, $fp, $a0
	fmadd.s	$fa1, $fa5, $fa0, $fa4
	ori	$a0, $s4, 2228
	fstx.s	$fa1, $fp, $a0
	ori	$a0, $s4, 3252
	fldx.s	$fa1, $fp, $a0
...
.LBB7_5:                                # %for.body21.i
	...
	fadd.s	$fa0, $fa0, $fa1
	bne	$a4, $a2, .LBB7_5
# %bb.6:                                # %for.cond.cleanup20.i
                                        #   in Loop: Header=BB7_4 Depth=1
	addi.d	$a0, $a0, 1
	addi.d	$a1, $a1, 1024
	bne	$a0, $a3, .LBB7_4
# %bb.7:                                # %for.body47.i.preheader
	pcalau12i	$a0, %pc_hi20(digits)
	ld.w	$a1, $a0, %pc_lo12(digits)
	fcvt.d.s	$fa0, $fa0
	movfr2gr.d	$a2, $fa0
...
.Lfunc_end14:
	.size	s451, .Lfunc_end14-s451
                                        # -- End function
	.section	.rodata.cst32,"aM",@progbits,32
	.p2align	5, 0x0                          # -- Begin function s452
.LCPI15_0:
	.dword	4                               # 0x4
	.dword	5                               # 0x5
	.dword	6                               # 0x6
...
# %bb.1:                                # %vector.ph.preheader
	...
	xvld	$xr0, $a0, %pc_lo12(.LCPI15_0)
	xvst	$xr0, $sp, 64                   # 32-byte Folded Spill
	pcalau12i	$a0, %pc_hi20(.LCPI15_1)
	xvld	$xr0, $a0, %pc_lo12(.LCPI15_1)
