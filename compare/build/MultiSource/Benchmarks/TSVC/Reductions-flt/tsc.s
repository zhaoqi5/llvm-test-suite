...
.LBB8_2:                                # %for.body
	...
	xvpickve.w	$xr5, $xr0, 6
	vreplvei.w	$vr6, $vr0, 3
	...
	vreplvei.w	$vr7, $vr3, 3
	xvpickve.w	$xr8, $xr3, 7
...
.Lfunc_end11:
	.size	s314, .Lfunc_end11-s314
                                        # -- End function
	.section	.rodata.cst32,"aM",@progbits,32
	.p2align	5, 0x0                          # -- Begin function s315
.LCPI12_0:
	.word	0                               # 0x0
	.word	1                               # 0x1
	.word	2                               # 0x2
...
.LBB12_1:                               # %vector.body
                                        # =>This Inner Loop Header: Depth=1
	xvmul.w	$xr4, $xr0, $xr1
	xvmuh.wu	$xr5, $xr4, $xr2
	xvsrli.w	$xr5, $xr5, 11
	xvmsub.w	$xr4, $xr5, $xr3
...
# %bb.16:                               # %for.cond2.preheader.i58.preheader
	...
	ori	$a3, $zero, 256
	.p2align	4, , 16
.LBB23_17:                              # %for.cond2.preheader.i58
                                        # =>This Inner Loop Header: Depth=1
	bstrpick.d	$a4, $a2, 31, 0
	movgr2fr.d	$fa0, $a4
	ffint.d.l	$fa0, $fa0
