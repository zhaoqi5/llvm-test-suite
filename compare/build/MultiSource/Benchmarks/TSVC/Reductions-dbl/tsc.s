...
# %bb.6:                                # %for.cond.cleanup10
	...
	addi.w	$s8, $s8, 1
	blt	$s8, $a0, .LBB12_4
# %bb.7:                                # %for.cond.cleanup4.loopexit
	movgr2fr.w	$fa0, $s7
	ffint.d.w	$fa0, $fa0
	fadd.d	$fa0, $fs0, $fa0
	vldi	$vr1, -912
...
.LBB12_8:
	...
	fld.d	$fs0, $a0, %pc_lo12(.LCPI12_1)
.LBB12_9:                               # %for.cond.cleanup4
...
.Lfunc_end14:
	.size	s317, .Lfunc_end14-s317
                                        # -- End function
	.section	.rodata.cst8,"aM",@progbits,8
	.p2align	3, 0x0                          # -- Begin function s318
.LCPI15_0:
	.dword	0x7ff8000000000000              # double NaN
	.text
	.globl	s318
...
.Lfunc_end16:
	.size	s319, .Lfunc_end16-s319
                                        # -- End function
	.section	.rodata.cst8,"aM",@progbits,8
	.p2align	3, 0x0                          # -- Begin function s3110
.LCPI17_0:
	.dword	0x7ff8000000000000              # double NaN
	.text
	.globl	s3110
...
# %bb.6:                                # %for.cond.cleanup3
	...
	mul.d	$a0, $a0, $a1
	blt	$s7, $a0, .LBB17_2
# %bb.7:                                # %for.cond.cleanup.loopexit
	vldi	$vr0, -912
	fadd.d	$fa1, $fs0, $fa0
	fadd.d	$fa1, $fa1, $fs1
	fadd.d	$fs0, $fa1, $fa0
...
.LBB17_8:
	...
	fld.d	$fs0, $a0, %pc_lo12(.LCPI17_0)
.LBB17_9:                               # %for.cond.cleanup
...
# %bb.14:                               # %for.cond2.preheader.i43.preheader
	...
	ori	$a4, $zero, 256
	.p2align	4, , 16
.LBB23_15:                              # %for.cond2.preheader.i43
                                        # =>This Inner Loop Header: Depth=1
	bstrpick.d	$a5, $a3, 31, 0
	movgr2fr.d	$fa0, $a5
	ffint.d.l	$fa0, $fa0
...
# %bb.16:                               # %for.cond2.preheader.i57.preheader
	...
	ori	$a3, $zero, 256
	.p2align	4, , 16
.LBB23_17:                              # %for.cond2.preheader.i57
                                        # =>This Inner Loop Header: Depth=1
	bstrpick.d	$a4, $a2, 31, 0
	movgr2fr.d	$fa0, $a4
	ffint.d.l	$fa0, $fa0
...
.LBB24_10:                              # %s312.exit
	...
	ld.w	$a0, $a0, %pc_lo12(ntimes)
	blez	$a0, .LBB24_15
# %bb.11:                               # %for.cond1.preheader.i9.preheader
	move	$s8, $zero
	...
	add.d	$s6, $fp, $a0
	.p2align	4, , 16
.LBB24_12:                              # %for.cond1.preheader.i9
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB24_13 Depth 2
	vldi	$vr0, -912
	move	$a0, $s7
	.p2align	4, , 16
.LBB24_13:                              # %for.body4.i10
                                        #   Parent Loop BB24_12 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.w	$a0, $a0, -1
	fmul.d	$fa0, $fa0, $fs0
	bnez	$a0, .LBB24_13
# %bb.14:                               # %for.cond.cleanup3.i13
