...
# %bb.11:                               # %vec.epilog.iter.check
	...
	beqz	$a0, .LBB9_6
# %bb.12:                               # %vec.epilog.vector.body.preheader
                                        #   in Loop: Header=BB9_4 Depth=1
...
# %bb.14:                               # %vec.epilog.middle.block
	...
	beq	$a0, $s3, .LBB9_3
	b	.LBB9_6
.LBB9_15:                               # %for.cond1.preheader.preheader
	move	$s7, $zero
	pcalau12i	$a0, %pc_hi20(global_data)
	addi.d	$fp, $a0, %pc_lo12(global_data)
	lu12i.w	$a0, 31
...
.LBB9_18:                               # %for.body.i
	...
	addi.d	$fp, $fp, 4
	bnez	$a0, .LBB9_18
# %bb.19:                               # %for.cond18.preheader.i.preheader
	pcalau12i	$a0, %pc_hi20(digits)
	ld.w	$a1, $a0, %pc_lo12(digits)
	fcvt.d.s	$fa0, $fa0
	movfr2gr.d	$a2, $fa0
...
# %bb.16:                               # %for.cond2.preheader.i58.preheader
	...
	ori	$a4, $zero, 256
	.p2align	4, , 16
.LBB13_17:                              # %for.cond2.preheader.i58
                                        # =>This Inner Loop Header: Depth=1
	bstrpick.d	$a5, $a3, 31, 0
	movgr2fr.d	$fa0, $a5
	ffint.d.l	$fa0, $fa0
