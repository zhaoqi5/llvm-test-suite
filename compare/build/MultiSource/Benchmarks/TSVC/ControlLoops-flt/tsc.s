...
.LBB10_7:                               # %pred.store.continue
	...
	andi	$a2, $a2, 1
	bnez	$a2, .LBB10_14
# %bb.8:                                # %pred.store.continue10
                                        #   in Loop: Header=BB10_5 Depth=2
	vpickve2gr.h	$a2, $vr1, 2
	andi	$a2, $a2, 1
	bnez	$a2, .LBB10_15
.LBB10_9:                               # %pred.store.continue12
                                        #   in Loop: Header=BB10_5 Depth=2
	vpickve2gr.h	$a2, $vr1, 3
	andi	$a2, $a2, 1
	bnez	$a2, .LBB10_16
.LBB10_10:                              # %pred.store.continue14
                                        #   in Loop: Header=BB10_5 Depth=2
	vpickve2gr.h	$a2, $vr1, 4
	andi	$a2, $a2, 1
	bnez	$a2, .LBB10_17
.LBB10_11:                              # %pred.store.continue16
                                        #   in Loop: Header=BB10_5 Depth=2
	vpickve2gr.h	$a2, $vr1, 5
	andi	$a2, $a2, 1
	bnez	$a2, .LBB10_18
.LBB10_12:                              # %pred.store.continue18
                                        #   in Loop: Header=BB10_5 Depth=2
	vpickve2gr.h	$a2, $vr1, 6
	andi	$a2, $a2, 1
	bnez	$a2, .LBB10_19
.LBB10_13:                              # %pred.store.continue20
                                        #   in Loop: Header=BB10_5 Depth=2
	...
	b	.LBB10_20
	.p2align	4, , 16
.LBB10_14:                              # %pred.store.if9
                                        #   in Loop: Header=BB10_5 Depth=2
	xvstelm.w	$xr0, $a1, 4, 1
	vpickve2gr.h	$a2, $vr1, 2
	andi	$a2, $a2, 1
	beqz	$a2, .LBB10_9
.LBB10_15:                              # %pred.store.if11
                                        #   in Loop: Header=BB10_5 Depth=2
	xvstelm.w	$xr0, $a1, 8, 2
	vpickve2gr.h	$a2, $vr1, 3
	andi	$a2, $a2, 1
	beqz	$a2, .LBB10_10
.LBB10_16:                              # %pred.store.if13
                                        #   in Loop: Header=BB10_5 Depth=2
	xvstelm.w	$xr0, $a1, 12, 3
	vpickve2gr.h	$a2, $vr1, 4
	andi	$a2, $a2, 1
	beqz	$a2, .LBB10_11
.LBB10_17:                              # %pred.store.if15
                                        #   in Loop: Header=BB10_5 Depth=2
	xvstelm.w	$xr0, $a1, 16, 4
	vpickve2gr.h	$a2, $vr1, 5
	andi	$a2, $a2, 1
	beqz	$a2, .LBB10_12
.LBB10_18:                              # %pred.store.if17
                                        #   in Loop: Header=BB10_5 Depth=2
	xvstelm.w	$xr0, $a1, 20, 5
	vpickve2gr.h	$a2, $vr1, 6
	andi	$a2, $a2, 1
	beqz	$a2, .LBB10_13
.LBB10_19:                              # %pred.store.if19
                                        #   in Loop: Header=BB10_5 Depth=2
	xvstelm.w	$xr0, $a1, 24, 6
	vpickve2gr.h	$a2, $vr1, 7
	andi	$a2, $a2, 1
	beqz	$a2, .LBB10_4
.LBB10_20:                              # %pred.store.if21
                                        #   in Loop: Header=BB10_5 Depth=2
	xvstelm.w	$xr0, $a1, 28, 7
	b	.LBB10_4
...
.LBB13_3:                               # %vector.body
	...
	xvldx	$xr4, $fp, $a0
	xvld	$xr5, $a1, 32
	xvfmadd.s	$xr0, $xr0, $xr2, $xr4
	xvfmadd.s	$xr1, $xr1, $xr3, $xr5
	xvstx	$xr0, $fp, $a0
	addi.d	$a0, $a0, 64
	xvst	$xr1, $a1, 32
	bne	$a0, $s7, .LBB13_3
...
.LBB14_3:                               # %vector.body
	...
	xvldx	$xr2, $fp, $a0
	xvld	$xr3, $a1, 32
	xvfmadd.s	$xr0, $xr0, $xr4, $xr2
	xvfmadd.s	$xr1, $xr1, $xr4, $xr3
	xvstx	$xr0, $fp, $a0
	addi.d	$a0, $a0, 64
	xvst	$xr1, $a1, 32
	bne	$a0, $s1, .LBB14_3
...
.LBB15_3:                               # %vector.body
	...
	xvfadd.s	$xr0, $xr0, $xr2
	xvfadd.s	$xr1, $xr1, $xr3
	xvfadd.s	$xr0, $xr4, $xr0
	xvfadd.s	$xr1, $xr5, $xr1
	xvstx	$xr0, $fp, $a0
	addi.d	$a0, $a0, 64
	xvst	$xr1, $a1, 32
	bne	$a0, $s7, .LBB15_3
...
.LBB19_3:                               # %vector.body
	...
	xvldx	$xr4, $a0, $s2
	xvldx	$xr5, $a0, $s3
	xvfmul.s	$xr6, $xr0, $xr1
	xvfmul.s	$xr7, $xr6, $xr3
	xvfmadd.s	$xr7, $xr6, $xr2, $xr7
	xvfmadd.s	$xr7, $xr6, $xr4, $xr7
	xvfmadd.s	$xr6, $xr6, $xr5, $xr7
	xvfmul.s	$xr7, $xr0, $xr2
	xvfmadd.s	$xr6, $xr7, $xr3, $xr6
	xvfmadd.s	$xr6, $xr7, $xr4, $xr6
	xvfmadd.s	$xr6, $xr7, $xr5, $xr6
	xvfmul.s	$xr7, $xr0, $xr3
	xvfmadd.s	$xr6, $xr7, $xr4, $xr6
	xvfmadd.s	$xr6, $xr7, $xr5, $xr6
	xvfmul.s	$xr0, $xr0, $xr4
	xvfmadd.s	$xr0, $xr0, $xr5, $xr6
	xvfmul.s	$xr6, $xr1, $xr2
	xvfmul.s	$xr7, $xr6, $xr4
	xvfmadd.s	$xr7, $xr6, $xr3, $xr7
	xvfmadd.s	$xr6, $xr6, $xr5, $xr7
	xvfmul.s	$xr7, $xr1, $xr3
	xvfmadd.s	$xr6, $xr7, $xr4, $xr6
	xvfmadd.s	$xr6, $xr7, $xr5, $xr6
	xvfmul.s	$xr1, $xr1, $xr4
	xvfmadd.s	$xr1, $xr1, $xr5, $xr6
	xvfmul.s	$xr6, $xr2, $xr3
	xvfmul.s	$xr7, $xr6, $xr5
	xvfmadd.s	$xr6, $xr6, $xr4, $xr7
	xvfmul.s	$xr2, $xr2, $xr4
	xvfmadd.s	$xr2, $xr2, $xr5, $xr6
	xvfmul.s	$xr3, $xr3, $xr4
	xvfmul.s	$xr3, $xr3, $xr5
	xvfmul.s	$xr0, $xr1, $xr0
...
# %bb.16:                               # %for.cond2.preheader.i58.preheader
	...
	ori	$a3, $zero, 256
	.p2align	4, , 16
.LBB20_17:                              # %for.cond2.preheader.i58
                                        # =>This Inner Loop Header: Depth=1
	bstrpick.d	$a4, $a2, 31, 0
	movgr2fr.d	$fa0, $a4
	ffint.d.l	$fa0, $fa0
