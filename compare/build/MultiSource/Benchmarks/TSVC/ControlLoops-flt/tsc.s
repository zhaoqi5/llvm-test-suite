...
.LBB10_18:                              # %pred.store.if18
                                        #   in Loop: Header=BB10_5 Depth=2
	vstelm.w	$vr0, $a1, 20, 1
	vpickve2gr.w	$a2, $vr1, 2
	andi	$a2, $a2, 1
	beqz	$a2, .LBB10_13
.LBB10_19:                              # %pred.store.if20
                                        #   in Loop: Header=BB10_5 Depth=2
	vstelm.w	$vr0, $a1, 24, 2
	vpickve2gr.w	$a2, $vr1, 3
	andi	$a2, $a2, 1
	beqz	$a2, .LBB10_4
.LBB10_20:                              # %pred.store.if22
                                        #   in Loop: Header=BB10_5 Depth=2
	vstelm.w	$vr0, $a1, 28, 3
	b	.LBB10_4
...
.LBB13_3:                               # %vector.body
	...
	vldx	$vr4, $fp, $a0
	vld	$vr5, $a1, 16
	vfmadd.s	$vr0, $vr0, $vr2, $vr4
	vfmadd.s	$vr1, $vr1, $vr3, $vr5
	vstx	$vr0, $fp, $a0
	addi.d	$a0, $a0, 32
	vst	$vr1, $a1, 16
	bne	$a0, $s7, .LBB13_3
...
.LBB14_3:                               # %vector.body
	...
	vldx	$vr2, $fp, $a0
	vld	$vr3, $a1, 16
	vfmadd.s	$vr0, $vr0, $vr4, $vr2
	vfmadd.s	$vr1, $vr1, $vr4, $vr3
	vstx	$vr0, $fp, $a0
	addi.d	$a0, $a0, 32
	vst	$vr1, $a1, 16
	bne	$a0, $s1, .LBB14_3
...
.LBB19_3:                               # %vector.body
	...
	vfmul.s	$vr6, $vr0, $vr1
	vfmul.s	$vr7, $vr6, $vr3
	vfmadd.s	$vr7, $vr6, $vr2, $vr7
	vfmadd.s	$vr7, $vr6, $vr4, $vr7
	vfmadd.s	$vr6, $vr6, $vr5, $vr7
	vfmul.s	$vr7, $vr0, $vr2
	vfmadd.s	$vr6, $vr7, $vr3, $vr6
	vfmadd.s	$vr6, $vr7, $vr4, $vr6
	vfmadd.s	$vr6, $vr7, $vr5, $vr6
	vfmul.s	$vr7, $vr0, $vr3
	vfmadd.s	$vr6, $vr7, $vr4, $vr6
	vfmadd.s	$vr6, $vr7, $vr5, $vr6
	vfmul.s	$vr0, $vr0, $vr4
	vfmadd.s	$vr0, $vr0, $vr5, $vr6
	vfmul.s	$vr6, $vr1, $vr2
	vfmul.s	$vr7, $vr6, $vr4
	vfmadd.s	$vr7, $vr6, $vr3, $vr7
	vfmadd.s	$vr6, $vr6, $vr5, $vr7
	vfmul.s	$vr7, $vr1, $vr3
	vfmadd.s	$vr6, $vr7, $vr4, $vr6
	vfmadd.s	$vr6, $vr7, $vr5, $vr6
	vfmul.s	$vr1, $vr1, $vr4
	vfmadd.s	$vr1, $vr1, $vr5, $vr6
	vfmul.s	$vr6, $vr2, $vr3
	vfmul.s	$vr7, $vr6, $vr5
	vfmadd.s	$vr6, $vr6, $vr4, $vr7
	vfmul.s	$vr2, $vr2, $vr4
	vfmadd.s	$vr2, $vr2, $vr5, $vr6
	vfmul.s	$vr3, $vr3, $vr4
	vfmul.s	$vr3, $vr3, $vr5
	vfmul.s	$vr0, $vr1, $vr0
	vfmul.s	$vr0, $vr2, $vr0
