...
.LBB13_3:                               # %vector.body
	...
	vextrins.w	$vr3, $vr2, 48
	xvpermi.q	$xr3, $xr4, 2
	xvfadd.s	$xr2, $xr1, $xr0
	xvfadd.s	$xr2, $xr3, $xr2
	xvfmul.s	$xr2, $xr2, $xr6
	xvstx	$xr2, $fp, $a0
	addi.d	$a0, $a0, 32
	bne	$a0, $s0, .LBB13_3
# %bb.4:                                # %for.cond.cleanup3
