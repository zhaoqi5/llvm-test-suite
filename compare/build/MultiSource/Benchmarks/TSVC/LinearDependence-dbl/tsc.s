...
.Lfunc_end7:
	...
	.p2align	5, 0x0                          # -- Begin function s1111
.LCPI8_0:
	.dword	0                               # 0x0
	.dword	1                               # 0x1
	.dword	2                               # 0x2
...
.LBB8_3:                                # %vector.body
	...
	xvld	$xr2, $a2, 0
	xvld	$xr3, $a0, 0
	xvfmul.d	$xr4, $xr1, $xr2
	xvfmadd.d	$xr4, $xr3, $xr1, $xr4
	xvfmadd.d	$xr4, $xr3, $xr3, $xr4
	xvfmadd.d	$xr1, $xr2, $xr1, $xr4
	xvfmadd.d	$xr1, $xr2, $xr3, $xr1
	xvslli.d	$xr2, $xr0, 4
...
.LBB11_3:                               # %vector.body
	...
	xvld	$xr2, $a2, -32
	xvld	$xr3, $a2, 0
	xvfadd.d	$xr2, $xr1, $xr2
	xvfadd.d	$xr3, $xr1, $xr3
	xvst	$xr2, $a1, 8
	xvst	$xr3, $a1, 40
	addi.d	$a2, $a2, 64
	addi.d	$a0, $a0, -8
...
.LBB13_7:                               # %for.cond.cleanup
	...
	ori	$a3, $zero, 2048
	.p2align	4, , 16
.LBB13_8:                               # %for.cond18.preheader.i
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB13_9 Depth 2
	move	$a4, $a2
	.p2align	4, , 16
.LBB13_9:                               # %for.body21.i
...
.LBB14_8:                               # %vector.body
	...
	xvfmadd.d	$xr1, $xr1, $xr0, $xr3
	xvfmadd.d	$xr0, $xr2, $xr0, $xr4
	xvst	$xr1, $t4, -32
	xvst	$xr0, $t4, 0
	addi.d	$t2, $t2, -8
	addi.d	$t4, $t4, 64
...
.LBB15_7:                               # %for.cond.cleanup
	...
	ori	$a3, $zero, 2048
	.p2align	4, , 16
.LBB15_8:                               # %for.cond18.preheader.i
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB15_9 Depth 2
	move	$a4, $a2
	.p2align	4, , 16
.LBB15_9:                               # %for.body21.i
...
.Lfunc_end15:
	.size	s1115, .Lfunc_end15-s1115
                                        # -- End function
	.globl	s116                            # -- Begin function s116
	.p2align	5
	.type	s116,@function
s116:                                   # @s116
# %bb.0:                                # %entry
...
.LBB18_7:                               # %for.cond.cleanup
	...
	ori	$a3, $zero, 2048
	.p2align	4, , 16
.LBB18_8:                               # %for.cond18.preheader.i
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB18_9 Depth 2
	move	$a4, $a2
	.p2align	4, , 16
.LBB18_9:                               # %for.body21.i
...
.LBB19_7:                               # %for.cond.cleanup
	...
	ori	$a3, $zero, 2048
	.p2align	4, , 16
.LBB19_8:                               # %for.cond18.preheader.i
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB19_9 Depth 2
	move	$a4, $a2
	.p2align	4, , 16
.LBB19_9:                               # %for.body21.i
...
# %bb.12:                               # %for.cond2.preheader.i.preheader
	...
	ori	$a4, $zero, 256
	.p2align	4, , 16
.LBB21_13:                              # %for.cond2.preheader.i
                                        # =>This Inner Loop Header: Depth=1
...
# %bb.14:                               # %for.cond2.preheader.i43.preheader
	...
	ori	$a4, $zero, 256
	.p2align	4, , 16
.LBB21_15:                              # %for.cond2.preheader.i43
                                        # =>This Inner Loop Header: Depth=1
	bstrpick.d	$a5, $a3, 31, 0
	movgr2fr.d	$fa0, $a5
	ffint.d.l	$fa0, $fa0
...
# %bb.16:                               # %for.cond2.preheader.i57.preheader
	...
	ori	$a3, $zero, 256
	.p2align	4, , 16
.LBB21_17:                              # %for.cond2.preheader.i57
                                        # =>This Inner Loop Header: Depth=1
	bstrpick.d	$a4, $a2, 31, 0
	movgr2fr.d	$fa0, $a4
	ffint.d.l	$fa0, $fa0
...
# %bb.18:                               # %vector.body130.preheader
	...
	xvld	$xr0, $a1, %pc_lo12(.LCPI21_0)
	pcalau12i	$a1, %pc_hi20(.LCPI21_1)
	xvld	$xr1, $a1, %pc_lo12(.LCPI21_1)
	pcalau12i	$a1, %pc_hi20(indx)
	addi.d	$a1, $a1, %pc_lo12(indx)
	ori	$a0, $a0, 3328
	xvrepli.w	$xr2, 3
	.p2align	4, , 16
.LBB21_19:                              # %vector.body130
                                        # =>This Inner Loop Header: Depth=1
	xvpermi.q	$xr3, $xr1, 1
