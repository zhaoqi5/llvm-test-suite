...
.LBB16_3:                               # %for.body4
	...
	xvinsve0.d	$xr0, $xr3, 1
	xvpickve.d	$xr3, $xr1, 1
	xvinsve0.d	$xr0, $xr3, 2
...
# %bb.18:                               # %vector.body147.preheader
	...
	xvld	$xr0, $a2, %pc_lo12(.LCPI21_0)
	pcalau12i	$a2, %pc_hi20(.LCPI21_1)
	xvld	$xr1, $a2, %pc_lo12(.LCPI21_1)
	pcalau12i	$a2, %pc_hi20(indx)
	addi.d	$a2, $a2, %pc_lo12(indx)
	ori	$a1, $a1, 3328
	xvrepli.w	$xr2, 3
	.p2align	4, , 16
.LBB21_19:                              # %vector.body147
                                        # =>This Inner Loop Header: Depth=1
