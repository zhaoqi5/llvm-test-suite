...
.LBB8_3:                                # %vector.body
	...
	xvld	$xr3, $a2, 0
	xvld	$xr4, $a0, 0
	xvfmul.s	$xr5, $xr2, $xr3
	xvfmadd.s	$xr5, $xr4, $xr2, $xr5
	xvfmadd.s	$xr5, $xr4, $xr4, $xr5
	xvfmadd.s	$xr2, $xr3, $xr2, $xr5
...
# %bb.7:                                # %vector.main.loop.iter.check
                                        #   in Loop: Header=BB14_5 Depth=2
	bgeu	$a7, $s6, .LBB14_9
# %bb.8:                                #   in Loop: Header=BB14_5 Depth=2
	move	$t0, $zero
	b	.LBB14_13
.LBB14_9:                               # %vector.ph
                                        #   in Loop: Header=BB14_5 Depth=2
...
.LBB14_17:                              # %for.body8
	...
	bnez	$t0, .LBB14_17
	b	.LBB14_4
.LBB14_18:                              #   in Loop: Header=BB14_5 Depth=2
	add.d	$t1, $a1, $t0
	b	.LBB14_16
...
.LBB14_20:                              # %for.body.i
	...
	addi.d	$fp, $fp, 4
	bnez	$a0, .LBB14_20
# %bb.21:                               # %for.cond18.preheader.i.preheader
	pcalau12i	$a0, %pc_hi20(digits)
	ld.w	$a1, $a0, %pc_lo12(digits)
	fcvt.d.s	$fa0, $fa0
	movfr2gr.d	$a2, $fa0
...
.LBB18_5:                               # %for.cond.cleanup
	...
	ori	$a4, $zero, 256
	.p2align	4, , 16
.LBB18_6:                               # %for.cond18.preheader.i
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB18_7 Depth 2
	move	$a3, $zero
	.p2align	4, , 16
.LBB18_7:                               # %for.body21.i
...
.LBB19_5:                               # %for.cond.cleanup
	...
	ori	$a4, $zero, 256
	.p2align	4, , 16
.LBB19_6:                               # %for.cond18.preheader.i
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB19_7 Depth 2
	move	$a3, $zero
	.p2align	4, , 16
.LBB19_7:                               # %for.body21.i
...
# %bb.16:                               # %for.cond2.preheader.i58.preheader
	...
	ori	$a3, $zero, 256
	.p2align	4, , 16
.LBB21_17:                              # %for.cond2.preheader.i58
                                        # =>This Inner Loop Header: Depth=1
	bstrpick.d	$a4, $a2, 31, 0
	movgr2fr.d	$fa0, $a4
	ffint.d.l	$fa0, $fa0
