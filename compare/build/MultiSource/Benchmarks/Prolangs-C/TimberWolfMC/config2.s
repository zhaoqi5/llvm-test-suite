...
.LBB0_11:                               # %if.end47
	...
	ld.wu	$a1, $a1, 0
	pcalau12i	$a2, %got_pc_hi20(totNetLen)
	ld.d	$a2, $a2, %got_pc_lo12(totNetLen)
	srli.d	$a3, $a1, 31
	add.w	$a1, $a1, $a3
	ld.w	$a2, $a2, 0
	srli.d	$a1, $a1, 1
	...
	sub.d	$a1, $a1, $a0
	movgr2fr.w	$fa0, $a2
	pcalau12i	$a0, %got_pc_hi20(layersFactor)
	ld.d	$a0, $a0, %got_pc_lo12(layersFactor)
	ffint.d.w	$fa0, $fa0
	movgr2fr.w	$fa1, $a1
	ffint.d.w	$fa1, $fa1
	ld.w	$a0, $a0, 0
	...
	ld.w	$a0, $a2, 0
	fdiv.d	$fa0, $fa0, $fa1
	pcalau12i	$a2, %got_pc_hi20(totChanLen)
	ld.d	$a2, $a2, %got_pc_lo12(totChanLen)
	movgr2fr.w	$fa1, $a0
	ffint.d.w	$fa1, $fa1
	pcalau12i	$a0, %got_pc_hi20(wire_est_factor)
	ld.d	$a0, $a0, %got_pc_lo12(wire_est_factor)
	fadd.d	$fa0, $fa0, $fa1
	pcalau12i	$a3, %got_pc_hi20(trackspacing)
	ld.d	$a3, $a3, %got_pc_lo12(trackspacing)
	ld.w	$a0, $a0, 0
	ftintrz.w.d	$fa0, $fa0
	movfr2gr.s	$a4, $fa0
	ld.w	$a3, $a3, 0
	...
	pcalau12i	$a2, %got_pc_hi20(fpo)
	ld.d	$s1, $a2, %got_pc_lo12(fpo)
	ld.d	$s3, $a0, %got_pc_lo12(aveChanWid)
	movfr2gr.s	$a0, $fa0
	addi.d	$a2, $a0, 2
	ld.d	$a0, $s1, 0
	st.w	$a2, $s3, 0
...
.LBB0_41:                               # %if.end200
	...
	ld.d	$a6, $a2, %got_pc_lo12(blockmx)
	ld.w	$a2, $fp, 0
	ld.w	$a0, $a0, 0
	add.w	$a4, $a4, $a5
	srli.d	$a4, $a4, 1
...
.LBB0_42:                               # %call.sqrt
	...
	bnez	$fp, .LBB0_11
	b	.LBB0_10
.LBB0_43:                               # %call.sqrt108
	fmov.d	$fa0, $fs0
	pcaddu18i	$ra, %call36(sqrt)
	jirl	$ra, $ra, 0
	b	.LBB0_30
.LBB0_44:                               # %call.sqrt109
	fmov.d	$fa0, $fa1
	pcaddu18i	$ra, %call36(sqrt)
	jirl	$ra, $ra, 0
	b	.LBB0_31
.LBB0_45:                               # %call.sqrt112
	fmov.d	$fa0, $fs1
	movcf2gr	$a0, $fcc0
	st.d	$a0, $sp, 16
	pcaddu18i	$ra, %call36(sqrt)
	...
	movgr2cf	$fcc0, $a0
	b	.LBB0_39
.LBB0_46:                               # %call.sqrt113
	fmov.d	$fa0, $fs1
	pcaddu18i	$ra, %call36(sqrt)
	jirl	$ra, $ra, 0
	fmov.d	$fs0, $fa0
	b	.LBB0_40
.LBB0_47:                               # %call.sqrt111
	fmov.d	$fa0, $fs0
	pcaddu18i	$ra, %call36(sqrt)
	jirl	$ra, $ra, 0
	b	.LBB0_37
.LBB0_48:                               # %call.sqrt110
	fmov.d	$fa0, $fs0
	pcaddu18i	$ra, %call36(sqrt)
	jirl	$ra, $ra, 0
	b	.LBB0_34
