...
# %bb.47:                               # %vector.memcheck730
	...
	addi.d	$a7, $a0, 2
	bgeu	$a6, $t1, .LBB0_49
# %bb.48:                               # %vector.memcheck730
                                        #   in Loop: Header=BB0_30 Depth=1
	addi.d	$a6, $t0, 2
	bltu	$a7, $a6, .LBB0_59
.LBB0_49:                               # %vector.main.loop.iter.check745
                                        #   in Loop: Header=BB0_30 Depth=1
	ori	$a6, $zero, 16
	bgeu	$s2, $a6, .LBB0_51
...
.LBB0_52:                               # %vector.body749
	...
	addi.d	$t0, $t0, -32
	bnez	$t1, .LBB0_52
# %bb.53:                               # %middle.block754
                                        #   in Loop: Header=BB0_30 Depth=1
	beq	$a6, $a5, .LBB0_61
# %bb.54:                               # %vec.epilog.iter.check759
                                        #   in Loop: Header=BB0_30 Depth=1
	andi	$a7, $a5, 8
	bnez	$a7, .LBB0_56
...
.LBB0_56:                               # %vec.epilog.ph758
	...
	sub.d	$a6, $a6, $a7
	.p2align	4, , 16
.LBB0_57:                               # %vec.epilog.vector.body764
                                        #   Parent Loop BB0_30 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $t0, 0
	...
	addi.d	$t1, $t1, -16
	bnez	$a6, .LBB0_57
# %bb.58:                               # %vec.epilog.middle.block770
                                        #   in Loop: Header=BB0_30 Depth=1
	beq	$a7, $a5, .LBB0_61
...
.LBB0_128:                              #   in Loop: Header=BB0_86 Depth=3
	move	$a4, $s7
.LBB0_129:                              # %for.body490.preheader789
                                        #   in Loop: Header=BB0_86 Depth=3
	alsl.d	$a0, $a1, $a0, 1
	addi.d	$a0, $a0, 2
	alsl.d	$a2, $a2, $s3, 1
...
.LBB0_141:                              # %vec.epilog.ph685
	...
	.p2align	4, , 16
.LBB0_142:                              # %vec.epilog.vector.body691
                                        #   Parent Loop BB0_30 Depth=1
                                        #     Parent Loop BB0_65 Depth=2
                                        #       Parent Loop BB0_86 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
	...
	addi.d	$t2, $t2, -16
	bnez	$a7, .LBB0_142
# %bb.143:                              # %vec.epilog.middle.block697
                                        #   in Loop: Header=BB0_86 Depth=3
	bne	$t0, $a5, .LBB0_152
	b	.LBB0_154
.LBB0_144:                              # %vector.ph714
                                        #   in Loop: Header=BB0_86 Depth=3
...
# %bb.149:                              # %middle.block681
                                        #   in Loop: Header=BB0_86 Depth=3
	beq	$a7, $a5, .LBB0_154
# %bb.150:                              # %vec.epilog.iter.check686
                                        #   in Loop: Header=BB0_86 Depth=3
	andi	$a6, $a5, 8
	bnez	$a6, .LBB0_141
...
.LBB0_181:                              #   in Loop: Header=BB0_65 Depth=2
	move	$a3, $a7
	move	$a4, $s7
.LBB0_182:                              # %for.body337.preheader790
                                        #   in Loop: Header=BB0_65 Depth=2
	alsl.d	$a0, $a1, $a0, 1
	addi.d	$a0, $a0, 2
	alsl.d	$a2, $a3, $s3, 1
...
.LBB0_228:                              # %vector.body779
	...
	addi.d	$a7, $a7, 32
	bnez	$t0, .LBB0_228
# %bb.229:                              # %middle.block784
                                        #   in Loop: Header=BB0_224 Depth=1
	beq	$a4, $a5, .LBB0_223
.LBB0_230:                              # %for.body636.preheader787
                                        #   in Loop: Header=BB0_224 Depth=1
	alsl.d	$a1, $a3, $a1, 2
	alsl.d	$a0, $a3, $a0, 1
	sub.d	$a2, $a2, $a3
