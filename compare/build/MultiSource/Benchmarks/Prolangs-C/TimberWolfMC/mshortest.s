...
# %bb.47:                               # %vector.memcheck729
	...
	addi.d	$a7, $a0, 2
	bgeu	$a6, $t0, .LBB0_49
# %bb.48:                               # %vector.memcheck729
                                        #   in Loop: Header=BB0_30 Depth=1
	addi.d	$a6, $t1, 2
	bltu	$a7, $a6, .LBB0_59
.LBB0_49:                               # %vector.main.loop.iter.check744
                                        #   in Loop: Header=BB0_30 Depth=1
	ori	$a6, $zero, 16
	bgeu	$s0, $a6, .LBB0_51
...
.LBB0_52:                               # %vector.body748
	...
	addi.d	$t1, $t1, -32
	bnez	$t2, .LBB0_52
# %bb.53:                               # %middle.block753
                                        #   in Loop: Header=BB0_30 Depth=1
	beq	$a6, $a5, .LBB0_61
# %bb.54:                               # %vec.epilog.iter.check757
                                        #   in Loop: Header=BB0_30 Depth=1
	bnez	$t0, .LBB0_56
# %bb.55:                               #   in Loop: Header=BB0_30 Depth=1
	addi.d	$fp, $a6, 1
	b	.LBB0_59
.LBB0_56:                               # %vec.epilog.ph759
                                        #   in Loop: Header=BB0_30 Depth=1
	...
	sub.d	$a6, $a6, $a7
	.p2align	4, , 16
.LBB0_57:                               # %vec.epilog.vector.body762
                                        #   Parent Loop BB0_30 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $t0, 0
	vshuf4i.d	$vr0, $vr0, 1
	...
	addi.d	$t1, $t1, -16
	bnez	$a6, .LBB0_57
# %bb.58:                               # %vec.epilog.middle.block768
                                        #   in Loop: Header=BB0_30 Depth=1
	beq	$a7, $a5, .LBB0_61
...
.LBB0_128:                              #   in Loop: Header=BB0_86 Depth=3
	move	$a4, $s7
.LBB0_129:                              # %for.body490.preheader787
                                        #   in Loop: Header=BB0_86 Depth=3
	alsl.d	$a0, $a1, $a0, 1
	addi.d	$a0, $a0, 2
	alsl.d	$a2, $a2, $s3, 1
...
.LBB0_137:                              # %vector.memcheck657
	...
	ld.d	$s7, $sp, 200                   # 8-byte Folded Reload
	bgeu	$t2, $t3, .LBB0_139
# %bb.138:                              # %vector.memcheck657
                                        #   in Loop: Header=BB0_86 Depth=3
	addi.d	$t2, $t1, 2
	bltu	$t0, $t2, .LBB0_152
.LBB0_139:                              # %vector.main.loop.iter.check672
                                        #   in Loop: Header=BB0_86 Depth=3
	ori	$a6, $zero, 16
	bgeu	$a7, $a6, .LBB0_147
# %bb.140:                              #   in Loop: Header=BB0_86 Depth=3
	move	$a7, $zero
.LBB0_141:                              # %vec.epilog.ph687
                                        #   in Loop: Header=BB0_86 Depth=3
	...
	sub.d	$a7, $a7, $t0
	.p2align	4, , 16
.LBB0_142:                              # %vec.epilog.vector.body690
                                        #   Parent Loop BB0_30 Depth=1
                                        #     Parent Loop BB0_65 Depth=2
                                        #       Parent Loop BB0_86 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
	...
	addi.d	$t2, $t2, -16
	bnez	$a7, .LBB0_142
# %bb.143:                              # %vec.epilog.middle.block696
                                        #   in Loop: Header=BB0_86 Depth=3
	bne	$t0, $a5, .LBB0_152
	b	.LBB0_154
.LBB0_144:                              # %vector.ph713
                                        #   in Loop: Header=BB0_86 Depth=3
...
.LBB0_145:                              # %vector.body717
	...
	addi.d	$t0, $t0, -32
	bnez	$a7, .LBB0_145
# %bb.146:                              # %middle.block724
                                        #   in Loop: Header=BB0_86 Depth=3
	beq	$a5, $a6, .LBB0_131
	b	.LBB0_129
.LBB0_147:                              # %vector.ph673
                                        #   in Loop: Header=BB0_86 Depth=3
	andi	$a6, $a5, 8
...
.LBB0_148:                              # %vector.body676
	...
	addi.d	$t1, $t1, -32
	bnez	$t2, .LBB0_148
# %bb.149:                              # %middle.block681
                                        #   in Loop: Header=BB0_86 Depth=3
	beq	$a7, $a5, .LBB0_154
# %bb.150:                              # %vec.epilog.iter.check685
                                        #   in Loop: Header=BB0_86 Depth=3
	bnez	$a6, .LBB0_141
...
.LBB0_178:                              # %for.body337.preheader
	...
	ori	$a2, $zero, 17
	bltu	$a7, $a2, .LBB0_181
# %bb.179:                              # %vector.memcheck630
                                        #   in Loop: Header=BB0_65 Depth=2
	alsl.d	$a3, $a1, $a0, 1
	addi.d	$a2, $a3, 2
	bgeu	$a2, $s6, .LBB0_196
# %bb.180:                              # %vector.memcheck630
                                        #   in Loop: Header=BB0_65 Depth=2
	addi.d	$a4, $a7, -2
	bstrpick.d	$a4, $a4, 31, 0
	slli.d	$a5, $a4, 1
...
.LBB0_181:                              #   in Loop: Header=BB0_65 Depth=2
	move	$a3, $a7
	move	$a4, $s7
.LBB0_182:                              # %for.body337.preheader788
                                        #   in Loop: Header=BB0_65 Depth=2
	alsl.d	$a0, $a1, $a0, 1
	addi.d	$a0, $a0, 2
	alsl.d	$a2, $a3, $s3, 1
...
.LBB0_228:                              # %vector.body777
	...
	addi.d	$a7, $a7, 32
	bnez	$t0, .LBB0_228
# %bb.229:                              # %middle.block782
                                        #   in Loop: Header=BB0_224 Depth=1
	beq	$a4, $a5, .LBB0_223
.LBB0_230:                              # %for.body636.preheader785
                                        #   in Loop: Header=BB0_224 Depth=1
	alsl.d	$a1, $a3, $a1, 2
	alsl.d	$a0, $a3, $a0, 1
	sub.d	$a2, $a2, $a3
...
.LBB0_231:                              # %for.body636
	...
	bnez	$a2, .LBB0_231
	b	.LBB0_223
.LBB0_232:                              # %for.end651.split.loop.exit599
	move	$fp, $s2
.LBB0_233:                              # %for.end651
	ld.d	$a0, $sp, 304
	beqz	$a0, .LBB0_235
