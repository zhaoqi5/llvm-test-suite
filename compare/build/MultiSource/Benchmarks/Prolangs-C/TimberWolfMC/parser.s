...
# %bb.47:                               # %if.end411
	...
	jirl	$ra, $ra, 0
	bne	$a0, $s7, .LBB0_153
# %bb.48:                               # %for.cond418.preheader
                                        #   in Loop: Header=BB0_4 Depth=1
	ld.w	$a0, $sp, 1296
	blez	$a0, .LBB0_58
# %bb.49:                               # %for.body420.preheader
                                        #   in Loop: Header=BB0_4 Depth=1
	move	$s4, $zero
	.p2align	4, , 16
.LBB0_50:                               # %for.body420
...
# %bb.66:                               # %if.end272
	...
	ld.d	$a1, $sp, 152                   # 8-byte Folded Reload
	bne	$a0, $a1, .LBB0_137
# %bb.67:                               # %for.cond283.preheader
                                        #   in Loop: Header=BB0_4 Depth=1
	ld.w	$a0, $sp, 1280
	blez	$a0, .LBB0_73
# %bb.68:                               # %for.body285.preheader
                                        #   in Loop: Header=BB0_4 Depth=1
	pcalau12i	$a0, %pc_hi20(.L.str.17)
	addi.d	$a1, $a0, %pc_lo12(.L.str.17)
	addi.d	$a2, $sp, 1276
	...
	jirl	$ra, $ra, 0
	bne	$a0, $s1, .LBB0_117
# %bb.69:                               # %for.inc309.peel
                                        #   in Loop: Header=BB0_4 Depth=1
	ld.w	$a0, $sp, 1280
	blt	$a0, $s1, .LBB0_73
# %bb.70:                               # %for.body285.preheader1104
                                        #   in Loop: Header=BB0_4 Depth=1
	ori	$s4, $zero, 1
	.p2align	4, , 16
.LBB0_71:                               # %for.body285
...
# %bb.81:                               # %if.end374
	...
	or	$a0, $a0, $a1
	bnez	$a0, .LBB0_136
# %bb.82:                               # %for.cond385.preheader
                                        #   in Loop: Header=BB0_4 Depth=1
	ld.w	$a0, $sp, 1312
	ori	$s4, $zero, 2
	blez	$a0, .LBB0_3
# %bb.83:                               # %for.body387.preheader
                                        #   in Loop: Header=BB0_4 Depth=1
	move	$fp, $zero
	.p2align	4, , 16
.LBB0_84:                               # %for.body387
...
# %bb.92:                               # %if.end546
	...
	ld.d	$a1, $sp, 152                   # 8-byte Folded Reload
	bne	$a0, $a1, .LBB0_137
# %bb.93:                               # %for.cond557.preheader
                                        #   in Loop: Header=BB0_4 Depth=1
	ld.w	$a0, $sp, 1280
	blez	$a0, .LBB0_99
# %bb.94:                               # %for.body559.preheader
                                        #   in Loop: Header=BB0_4 Depth=1
	pcalau12i	$a0, %pc_hi20(.L.str.17)
	addi.d	$a1, $a0, %pc_lo12(.L.str.17)
	addi.d	$a2, $sp, 1276
	...
	jirl	$ra, $ra, 0
	bne	$a0, $s1, .LBB0_117
# %bb.95:                               # %for.inc583.peel
                                        #   in Loop: Header=BB0_4 Depth=1
	ld.w	$a0, $sp, 1280
	blt	$a0, $s1, .LBB0_99
# %bb.96:                               # %for.body559.preheader1106
                                        #   in Loop: Header=BB0_4 Depth=1
	ori	$s4, $zero, 1
	.p2align	4, , 16
.LBB0_97:                               # %for.body559
...
# %bb.105:                              # %if.end633
	...
	or	$a0, $a0, $a1
	bnez	$a0, .LBB0_136
# %bb.106:                              # %for.cond644.preheader
                                        #   in Loop: Header=BB0_4 Depth=1
	ld.w	$a0, $sp, 1312
	ori	$s4, $zero, 4
	blez	$a0, .LBB0_3
# %bb.107:                              # %for.body646.preheader
                                        #   in Loop: Header=BB0_4 Depth=1
	move	$fp, $zero
	.p2align	4, , 16
.LBB0_108:                              # %for.body646
                                        #   Parent Loop BB0_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	pcalau12i	$a0, %pc_hi20(.L.str.11)
	addi.d	$a1, $a0, %pc_lo12(.L.str.11)
