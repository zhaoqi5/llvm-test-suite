...
.LBB0_13:                               # %if.end807
	...
	bge	$a1, $a0, .LBB0_5
.LBB0_14:                               # %do.body.preheader.lr.ph
...
# %bb.25:                               # %if.end237
	...
	ld.d	$t7, $a2, %got_pc_lo12(gridGiven)
	ld.w	$t6, $s5, 56
	ld.w	$a2, $t7, 0
	ld.w	$t5, $s4, 56
...
# %bb.75:                               # %if.then529
	...
	ld.w	$a6, $a6, 0
	pcalau12i	$t0, %got_pc_hi20(gridY)
	ld.d	$t0, $t0, %got_pc_lo12(gridY)
	ld.w	$a3, $a3, 0
...
.LBB3_15:                               #   in Loop: Header=BB3_4 Depth=1
	...
	move	$s2, $t0
	.p2align	4, , 16
.LBB3_16:                               # %for.body23.us.preheader
                                        #   in Loop: Header=BB3_4 Depth=1
	sub.d	$s2, $a0, $s2
	addi.d	$s1, $s1, 1
	.p2align	4, , 16
.LBB3_17:                               # %for.body23.us
                                        #   Parent Loop BB3_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.b	$s3, $s1, 0
	addi.d	$s3, $s3, -1
...
# %bb.28:                               # %middle.block126
                                        #   in Loop: Header=BB3_22 Depth=1
	beq	$a6, $a7, .LBB3_21
# %bb.29:                               # %vec.epilog.iter.check131
                                        #   in Loop: Header=BB3_22 Depth=1
	move	$s3, $a7
	beqz	$t1, .LBB3_33
.LBB3_30:                               # %vec.epilog.ph130
                                        #   in Loop: Header=BB3_22 Depth=1
	add.d	$s0, $s0, $t2
	add.d	$s2, $t5, $s3
	add.d	$s1, $s1, $t7
	add.d	$s1, $s1, $s3
	.p2align	4, , 16
.LBB3_31:                               # %vec.epilog.vector.body137
                                        #   Parent Loop BB3_22 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $s1, 0
	vaddi.bu	$vr0, $vr0, 1
	...
	addi.d	$s1, $s1, 16
	bnez	$s2, .LBB3_31
# %bb.32:                               # %vec.epilog.middle.block142
                                        #   in Loop: Header=BB3_22 Depth=1
	move	$s1, $t3
	beq	$a6, $t2, .LBB3_21
	b	.LBB3_34
.LBB3_33:                               #   in Loop: Header=BB3_22 Depth=1
	...
	move	$s1, $t0
	.p2align	4, , 16
.LBB3_34:                               # %for.body69.us.preheader
                                        #   in Loop: Header=BB3_22 Depth=1
	sub.d	$s1, $a0, $s1
	addi.d	$s0, $s0, 1
	.p2align	4, , 16
.LBB3_35:                               # %for.body69.us
                                        #   Parent Loop BB3_22 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.b	$s2, $s0, 0
	addi.d	$s2, $s2, 1
...
.LBB4_15:                               #   in Loop: Header=BB4_4 Depth=1
	...
	move	$s2, $t0
	.p2align	4, , 16
.LBB4_16:                               # %for.body17.us.preheader
                                        #   in Loop: Header=BB4_4 Depth=1
	sub.d	$s2, $a0, $s2
	addi.d	$s1, $s1, 1
	.p2align	4, , 16
.LBB4_17:                               # %for.body17.us
                                        #   Parent Loop BB4_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.b	$s3, $s1, 0
	addi.d	$s3, $s3, -1
...
# %bb.28:                               # %middle.block118
                                        #   in Loop: Header=BB4_22 Depth=1
	beq	$a6, $a7, .LBB4_21
# %bb.29:                               # %vec.epilog.iter.check123
                                        #   in Loop: Header=BB4_22 Depth=1
	move	$s3, $a7
	beqz	$t1, .LBB4_33
.LBB4_30:                               # %vec.epilog.ph122
                                        #   in Loop: Header=BB4_22 Depth=1
	add.d	$s0, $s0, $t2
	add.d	$s2, $t5, $s3
	add.d	$s1, $s1, $t7
	add.d	$s1, $s1, $s3
	.p2align	4, , 16
.LBB4_31:                               # %vec.epilog.vector.body129
                                        #   Parent Loop BB4_22 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $s1, 0
	vaddi.bu	$vr0, $vr0, 1
	...
	addi.d	$s1, $s1, 16
	bnez	$s2, .LBB4_31
# %bb.32:                               # %vec.epilog.middle.block134
                                        #   in Loop: Header=BB4_22 Depth=1
	move	$s1, $t3
	beq	$a6, $t2, .LBB4_21
	b	.LBB4_34
.LBB4_33:                               #   in Loop: Header=BB4_22 Depth=1
	...
	move	$s1, $t0
	.p2align	4, , 16
.LBB4_34:                               # %for.body59.us.preheader
                                        #   in Loop: Header=BB4_22 Depth=1
	sub.d	$s1, $a0, $s1
	addi.d	$s0, $s0, 1
	.p2align	4, , 16
.LBB4_35:                               # %for.body59.us
                                        #   Parent Loop BB4_22 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.b	$s2, $s0, 0
	addi.d	$s2, $s2, 1
