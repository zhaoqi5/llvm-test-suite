	.file	"ygraph.c"
	.text
	.globl	ygraph                          # -- Begin function ygraph
	.p2align	5
	.type	ygraph,@function
ygraph:                                 # @ygraph
# %bb.0:                                # %entry
	addi.d	$sp, $sp, -192
...
.LBB0_3:                                # %for.end
	...
	alsl.d	$a1, $a2, $a1, 3
	add.d	$a0, $a0, $a1
	pcalau12i	$a1, %got_pc_hi20(hChanBeginRoot)
	ld.d	$fp, $a1, %got_pc_lo12(hChanBeginRoot)
	ld.w	$a1, $a0, 12
	ld.w	$s3, $a0, 8
	ld.w	$s4, $a0, 4
	ld.d	$a0, $fp, 0
...
.LBB0_9:                                # %for.end50
	...
	add.d	$a0, $a0, $a1
	ld.w	$a1, $a0, 12
	pcalau12i	$a2, %got_pc_hi20(hChanEndRoot)
	ld.d	$s4, $a2, %got_pc_lo12(hChanEndRoot)
	st.w	$a1, $sp, 100
	ld.w	$s8, $a0, 8
	ld.w	$s5, $a0, 4
	ld.d	$a0, $s4, 0
...
.LBB0_67:                               # %for.end423
	...
	st.d	$a0, $a1, 0
	blt	$s2, $s3, .LBB0_69
# %bb.68:                               # %for.body431.preheader
	addi.d	$a0, $s0, 8
	move	$a1, $zero
	move	$a2, $s1
	pcaddu18i	$ra, %call36(memset)
	jirl	$ra, $ra, 0
.LBB0_69:                               # %for.cond437.preheader
	ld.d	$a0, $sp, 32                    # 8-byte Folded Reload
	ld.w	$a0, $a0, 0
	st.d	$s0, $sp, 80                    # 8-byte Folded Spill
	st.d	$a0, $sp, 8                     # 8-byte Folded Spill
	blt	$a0, $s3, .LBB0_77
# %bb.70:                               # %for.body440.lr.ph
	ld.d	$a0, $sp, 40                    # 8-byte Folded Reload
	ld.d	$a0, $a0, 0
...
.LBB0_75:                               # %for.body458
	...
	st.w	$a1, $a0, 16
	bnez	$s1, .LBB0_75
# %bb.76:                               # %for.cond455.for.inc489_crit_edge
...
.LBB0_78:                               # %for.end570
	ld.d	$a0, $fp, 0
	beqz	$a0, .LBB0_81
# %bb.79:                               # %for.cond574.preheader
	pcalau12i	$a0, %got_pc_hi20(hChanBeginRoot)
	ld.d	$fp, $a0, %got_pc_lo12(hChanBeginRoot)
	.p2align	4, , 16
.LBB0_80:                               # %for.cond574
                                        # =>This Inner Loop Header: Depth=1
	addi.d	$a1, $sp, 88
...
.LBB0_81:                               # %if.end580
	ld.d	$a0, $s4, 0
	beqz	$a0, .LBB0_84
# %bb.82:                               # %for.cond584.preheader
	pcalau12i	$a0, %got_pc_hi20(hChanEndRoot)
	ld.d	$fp, $a0, %got_pc_lo12(hChanEndRoot)
	.p2align	4, , 16
.LBB0_83:                               # %for.cond584
                                        # =>This Inner Loop Header: Depth=1
	addi.d	$a1, $sp, 88
