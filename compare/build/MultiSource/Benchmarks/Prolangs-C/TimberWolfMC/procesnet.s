...
# %bb.26:                               # %vec.epilog.middle.block
	bne	$a6, $t3, .LBB2_7
	b	.LBB2_46
.LBB2_27:                               # %vector.memcheck122
	addi.d	$t3, $a0, 2
	alsl.d	$a3, $a6, $a5, 1
	addi.d	$a3, $a3, 2
	bgeu	$t3, $a3, .LBB2_29
# %bb.28:                               # %vector.memcheck122
	alsl.d	$a3, $a6, $a0, 1
	addi.d	$t0, $a5, 4
	move	$t1, $a6
	bltu	$t0, $a3, .LBB2_44
.LBB2_29:                               # %vector.main.loop.iter.check134
	addi.d	$a3, $a6, -1
	ori	$a7, $zero, 17
	slli.d	$t0, $a6, 1
	bgeu	$a6, $a7, .LBB2_39
...
.LBB2_31:                               # %vec.epilog.ph149
	...
	addi.d	$t0, $t0, -14
	.p2align	4, , 16
.LBB2_32:                               # %vec.epilog.vector.body152
                                        # =>This Inner Loop Header: Depth=1
	vldx	$vr0, $a5, $t0
	vshuf4i.d	$vr0, $vr0, 1
	vshuf4i.h	$vr0, $vr0, 27
	...
	addi.d	$t0, $t0, -16
	bnez	$t2, .LBB2_32
# %bb.33:                               # %vec.epilog.middle.block159
	bne	$a3, $t3, .LBB2_44
	b	.LBB2_46
.LBB2_34:                               # %vector.ph
	andi	$t3, $a6, 8
...
.LBB2_40:                               # %vector.body138
	...
	addi.d	$t1, $t1, -32
	bnez	$t4, .LBB2_40
# %bb.41:                               # %middle.block143
	beq	$a3, $t2, .LBB2_46
# %bb.42:                               # %vec.epilog.iter.check147
	bnez	$a7, .LBB2_31
# %bb.43:
	addi.d	$a7, $t2, 1
	sub.d	$t1, $a6, $t2
...
.LBB2_51:                               # %for.body141
	...
	addi.d	$a6, $a6, 2
	blt	$a7, $t0, .LBB2_51
# %bb.52:                               # %for.cond127.loopexit.loopexit
                                        #   in Loop: Header=BB2_49 Depth=1
	ld.hu	$a4, $a0, 0
	b	.LBB2_48
.LBB2_53:                               # %for.end156
