...
# %bb.0:                                # %entry
	...
	ld.d	$s0, $a0, %got_pc_lo12(bbt)
	st.w	$zero, $s0, 0
	pcalau12i	$a0, %got_pc_hi20(bbl)
	ld.d	$s4, $a0, %got_pc_lo12(bbl)
	lu12i.w	$a0, 2441
	ori	$a0, $a0, 1664
	st.w	$a0, $s4, 0
	pcalau12i	$a1, %got_pc_hi20(bbb)
	ld.d	$s1, $a1, %got_pc_lo12(bbb)
	st.w	$a0, $s1, 0
	pcalau12i	$a0, %got_pc_hi20(edgeCount)
	ld.d	$s8, $a0, %got_pc_lo12(edgeCount)
	st.w	$zero, $s8, 0
...
.LBB0_30:                               # %while.end
	...
	st.w	$a3, $a7, 32
	stx.w	$t1, $a0, $a5
	pcalau12i	$a0, %got_pc_hi20(numProbes)
	ld.d	$a0, $a0, %got_pc_lo12(numProbes)
	st.w	$zero, $a0, 0
