...
.LBB0_125:                              #   in Loop: Header=BB0_121 Depth=2
	move	$s0, $zero
	b	.LBB0_140
.LBB0_126:                              # %vector.main.loop.iter.check383
                                        #   in Loop: Header=BB0_121 Depth=2
	bgeu	$t8, $t0, .LBB0_128
...
# %bb.131:                              #   in Loop: Header=BB0_121 Depth=2
	...
	ori	$t0, $zero, 16
	b	.LBB0_140
.LBB0_132:                              # %vec.epilog.iter.check401
                                        #   in Loop: Header=BB0_121 Depth=2
	andi	$a0, $t8, 12
	ori	$a5, $zero, 4
	beqz	$a0, .LBB0_137
...
.LBB0_134:                              # %vec.epilog.ph400
	...
	sub.d	$fp, $fp, $s2
	.p2align	4, , 16
.LBB0_135:                              # %vec.epilog.vector.body406
                                        #   Parent Loop BB0_117 Depth=1
                                        #     Parent Loop BB0_121 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vld	$vr3, $s0, 0
	...
	addi.d	$s0, $s0, 16
	bnez	$fp, .LBB0_135
# %bb.136:                              # %vec.epilog.middle.block412
                                        #   in Loop: Header=BB0_121 Depth=2
	vshuf4i.w	$vr3, $vr2, 14
	vadd.w	$vr2, $vr2, $vr3
	vreplvei.w	$vr3, $vr2, 1
