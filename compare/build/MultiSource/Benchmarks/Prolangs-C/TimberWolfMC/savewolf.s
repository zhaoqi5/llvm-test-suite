...
# %bb.138:                              # %for.body830.lr.ph
                                        #   in Loop: Header=BB1_125 Depth=2
	bnez	$fp, .LBB1_142
# %bb.139:                              # %for.body830.lr.ph.split.us
                                        #   in Loop: Header=BB1_125 Depth=2
	bnez	$s7, .LBB1_154
# %bb.140:                              # %for.inc885.us.us.preheader
                                        #   in Loop: Header=BB1_125 Depth=2
	ori	$s4, $zero, 1
	.p2align	4, , 16
.LBB1_141:                              # %for.inc885.us.us
                                        #   Parent Loop BB1_3 Depth=1
	...
	blt	$s4, $a0, .LBB1_141
	b	.LBB1_124
.LBB1_142:                              # %for.body830.preheader
                                        #   in Loop: Header=BB1_125 Depth=2
	ld.w	$a0, $sp, 88
	ori	$s4, $zero, 1
	b	.LBB1_145
...
# %bb.146:                              # %lor.lhs.false871
	...
	b	.LBB1_152
	.p2align	4, , 16
.LBB1_147:                              # %lor.lhs.false848
                                        #   in Loop: Header=BB1_145 Depth=3
	bnez	$s7, .LBB1_149
# %bb.148:                              # %if.end861.thread436
                                        #   in Loop: Header=BB1_145 Depth=3
	beq	$a1, $s8, .LBB1_143
	b	.LBB1_144
	.p2align	4, , 16
.LBB1_149:                              # %land.lhs.true852
                                        #   in Loop: Header=BB1_145 Depth=3
	move	$a2, $a0
...
# %bb.150:                              # %if.end861
	...
	addi.d	$a2, $a2, 1
	st.w	$a2, $s1, 0
.LBB1_151:                              # %if.end861.thread
                                        #   in Loop: Header=BB1_145 Depth=3
	beq	$a1, $s8, .LBB1_143
.LBB1_152:                              # %land.lhs.true875
                                        #   in Loop: Header=BB1_145 Depth=3
	ori	$a1, $zero, 7
	beq	$a0, $a1, .LBB1_143
# %bb.153:                              # %land.lhs.true875
                                        #   in Loop: Header=BB1_145 Depth=3
	beq	$a0, $s6, .LBB1_143
	b	.LBB1_144
.LBB1_154:                              # %for.body830.us.preheader
                                        #   in Loop: Header=BB1_125 Depth=2
	ld.w	$a0, $sp, 88
	ori	$s4, $zero, 1
	b	.LBB1_157
	.p2align	4, , 16
.LBB1_155:                              # %if.then881.us
                                        #   in Loop: Header=BB1_157 Depth=3
	ld.w	$a1, $s0, 0
	addi.d	$a1, $a1, 1
	st.w	$a1, $s0, 0
.LBB1_156:                              # %for.inc885.us
                                        #   in Loop: Header=BB1_157 Depth=3
	ld.w	$a1, $s5, 68
	addi.w	$s4, $s4, 1
	bge	$s4, $a1, .LBB1_124
.LBB1_157:                              # %for.body830.us
                                        #   Parent Loop BB1_3 Depth=1
                                        #     Parent Loop BB1_125 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$s2, $s2, 0
	...
	ori	$a2, $zero, 2
	bne	$a1, $a2, .LBB1_159
# %bb.158:                              # %if.then858.us
                                        #   in Loop: Header=BB1_157 Depth=3
	ld.w	$a1, $s1, 0
	addi.d	$a1, $a1, 1
	st.w	$a1, $s1, 0
.LBB1_159:                              # %land.lhs.true875.us
                                        #   in Loop: Header=BB1_157 Depth=3
	addi.w	$a1, $a0, 0
	ori	$a2, $zero, 7
	beq	$a1, $a2, .LBB1_155
# %bb.160:                              # %land.lhs.true875.us
                                        #   in Loop: Header=BB1_157 Depth=3
	beq	$a1, $s6, .LBB1_155
	b	.LBB1_156
	.p2align	4, , 16
...
# %bb.171:                              # %land.lhs.true937
	...
	addi.w	$a0, $a0, 0
	beq	$a0, $s6, .LBB1_174
.LBB1_172:                              # %lor.lhs.false943
                                        #   in Loop: Header=BB1_170 Depth=3
	beqz	$s7, .LBB1_175
# %bb.173:                              # %land.lhs.true947
                                        #   in Loop: Header=BB1_170 Depth=3
	ld.wu	$a0, $sp, 88
	bstrpick.d	$a0, $a0, 31, 1
	slli.w	$a0, $a0, 1
...
# %bb.176:                              # %land.lhs.true962
	...
	addi.w	$a0, $a0, 0
	beq	$a0, $s8, .LBB1_168
.LBB1_177:                              # %lor.lhs.false968
                                        #   in Loop: Header=BB1_170 Depth=3
	beqz	$s7, .LBB1_169
# %bb.178:                              # %land.lhs.true972
                                        #   in Loop: Header=BB1_170 Depth=3
	ld.w	$a0, $sp, 88
	ori	$a1, $zero, 7
	beq	$a0, $a1, .LBB1_168
# %bb.179:                              # %land.lhs.true972
                                        #   in Loop: Header=BB1_170 Depth=3
	beq	$a0, $s6, .LBB1_168
	b	.LBB1_169
	.p2align	4, , 16
.LBB1_180:                              # %for.inc987.loopexit
                                        #   in Loop: Header=BB1_165 Depth=2
	ld.w	$a1, $sp, 88
	ld.d	$a4, $sp, 56                    # 8-byte Folded Reload
	b	.LBB1_164
...
.LBB1_183:                              # %for.body999
	...
	st.w	$a6, $a5, 12
	bnez	$a0, .LBB1_183
.LBB1_184:                              # %for.cond1014.preheader
                                        #   in Loop: Header=BB1_3 Depth=1
	ld.w	$a0, $s5, 132
	blt	$a0, $s8, .LBB1_2
...
# %bb.191:                              # %land.lhs.true459
	...
	ori	$a1, $zero, 4
	beq	$a0, $a1, .LBB1_194
.LBB1_192:                              # %lor.lhs.false465
                                        #   in Loop: Header=BB1_190 Depth=2
	beqz	$s8, .LBB1_195
# %bb.193:                              # %land.lhs.true469
                                        #   in Loop: Header=BB1_190 Depth=2
	ld.wu	$a0, $sp, 88
	bstrpick.d	$a0, $a0, 31, 1
	slli.w	$a0, $a0, 1
