...
# %bb.30:                               # %for.body179.lr.ph
	...
	slli.d	$a0, $a2, 3
	blt	$a2, $a3, .LBB1_37
# %bb.31:                               # %for.body179.lr.ph
                                        #   in Loop: Header=BB1_29 Depth=1
	blt	$a4, $a2, .LBB1_37
# %bb.32:                               # %for.body179.preheader
                                        #   in Loop: Header=BB1_29 Depth=1
	move	$a7, $zero
	b	.LBB1_35
	.p2align	4, , 16
...
# %bb.36:                               # %for.body179
	...
	b	.LBB1_33
	.p2align	4, , 16
.LBB1_37:                               # %for.body179.us.preheader
                                        #   in Loop: Header=BB1_29 Depth=1
	move	$a7, $zero
	.p2align	4, , 16
.LBB1_38:                               # %for.body179.us
                                        #   Parent Loop BB1_29 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a1, $s6, %pc_lo12(spots)
	ldx.d	$a1, $a1, $a0
...
.LBB1_41:                               # %for.end200
	...
	st.w	$zero, $fp, 0
	blez	$a0, .LBB1_40
# %bb.42:                               # %for.cond205.preheader.lr.ph
	ld.w	$a1, $s8, %pc_lo12(numYspots)
	blez	$a1, .LBB1_40
# %bb.43:                               # %for.cond205.preheader.us.preheader
	ld.d	$a2, $sp, 80                    # 8-byte Folded Reload
	...
	b	.LBB1_45
	.p2align	4, , 16
.LBB1_44:                               # %for.cond205.for.inc243_crit_edge.us
                                        #   in Loop: Header=BB1_45 Depth=1
	addi.d	$a2, $a2, 1
	beq	$a2, $a0, .LBB1_40
.LBB1_45:                               # %for.cond205.preheader.us
                                        # =>This Loop Header: Depth=1
...
.LBB1_48:                               #   in Loop: Header=BB1_45 Depth=1
	move	$t2, $zero
.LBB1_49:                               # %for.body208.us.preheader
                                        #   in Loop: Header=BB1_45 Depth=1
	add.d	$t0, $t0, $t2
	sub.d	$t2, $a1, $t2
	.p2align	4, , 16
.LBB1_50:                               # %for.body208.us
