...
# %bb.0:                                # %entry
	...
	pcalau12i	$a2, %got_pc_hi20(cktName)
	ld.d	$a2, $a2, %got_pc_lo12(cktName)
	ld.w	$fp, $a0, 0
	ld.w	$s0, $a1, 0
	ld.d	$a2, $a2, 0
...
# %bb.1:                                # %if.end
	...
	pcalau12i	$a1, %got_pc_hi20(redoFlag)
	ld.d	$a1, $a1, %got_pc_lo12(redoFlag)
	movgr2fr.w	$fa1, $a0
	ffint.d.w	$fa1, $fa1
	fdiv.d	$fa0, $fa1, $fa0
	ld.w	$a0, $a1, 0
	...
	pcalau12i	$fp, %pc_hi20(fpNodes)
	beqz	$a0, .LBB0_3
# %bb.2:                                # %if.then8
	ld.d	$a0, $fp, %pc_lo12(fpNodes)
