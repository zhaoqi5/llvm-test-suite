...
# %bb.24:                               # %middle.block
	beq	$a2, $a0, .LBB0_27
.LBB0_25:                               # %for.body320.preheader748
	addi.d	$a0, $a0, 1
...
.LBB0_101:                              # %if.then953
	...
	b	.LBB0_105
	.p2align	4, , 16
.LBB0_102:                              # %lor.lhs.false943
                                        #   in Loop: Header=BB0_95 Depth=1
	beqz	$a4, .LBB0_105
# %bb.103:                              # %land.lhs.true947
                                        #   in Loop: Header=BB0_95 Depth=1
	beq	$s0, $s5, .LBB0_101
# %bb.104:                              # %land.lhs.true947
                                        #   in Loop: Header=BB0_95 Depth=1
	beq	$s0, $s7, .LBB0_101
	.p2align	4, , 16
.LBB0_105:                              # %if.end956
...
# %bb.106:                              # %for.body961.lr.ph
	...
	ori	$s6, $zero, 1
	bnez	$a2, .LBB0_109
# %bb.107:                              # %for.body961.lr.ph.split
                                        #   in Loop: Header=BB0_95 Depth=1
	beqz	$a3, .LBB0_112
	b	.LBB0_116
	.p2align	4, , 16
.LBB0_108:                              # %if.end992.us
...
# %bb.110:                              # %if.then989.us
	...
	b	.LBB0_108
	.p2align	4, , 16
.LBB0_111:                              # %if.end992.us633
                                        #   in Loop: Header=BB0_112 Depth=2
	ld.w	$a0, $fp, 68
	addi.w	$s6, $s6, 1
	bge	$s6, $a0, .LBB0_94
.LBB0_112:                              # %for.body961.us622
                                        #   Parent Loop BB0_95 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$s8, $s8, 0
	ld.d	$s4, $s4, 0
...
# %bb.113:                              # %if.then989.us631
	...
	b	.LBB0_111
	.p2align	4, , 16
.LBB0_114:                              # %if.then1012
                                        #   in Loop: Header=BB0_116 Depth=2
	ld.w	$a0, $s1, 0
	addi.d	$a0, $a0, 1
	st.w	$a0, $s1, 0
.LBB0_115:                              # %for.inc1016
                                        #   in Loop: Header=BB0_116 Depth=2
	ld.w	$a0, $fp, 68
	addi.w	$s6, $s6, 1
	bge	$s6, $a0, .LBB0_94
.LBB0_116:                              # %for.body961
                                        #   Parent Loop BB0_95 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$s8, $s8, 0
	ld.d	$s4, $s4, 0
...
# %bb.121:                              # %if.then1026
	...
	b	.LBB0_123
	.p2align	4, , 16
.LBB0_122:                              # %for.inc1118
                                        #   in Loop: Header=BB0_123 Depth=1
	addi.d	$s0, $s0, 1
	beq	$s0, $s5, .LBB0_143
.LBB0_123:                              # %for.body1033
                                        # =>This Loop Header: Depth=1
...
# %bb.125:                              # %for.body1046.lr.ph
	...
	or	$s4, $a2, $a3
	beqz	$a4, .LBB0_131
# %bb.126:                              # %for.body1046.lr.ph
                                        #   in Loop: Header=BB0_123 Depth=1
	ori	$a2, $zero, 1
	bne	$a1, $a2, .LBB0_131
# %bb.127:                              # %for.body1046.us.preheader
                                        #   in Loop: Header=BB0_123 Depth=1
	move	$s3, $zero
	addi.d	$s1, $a0, 20
...
.LBB0_129:                              # %for.body1046.us
	...
	jirl	$ra, $ra, 0
	beqz	$s4, .LBB0_128
# %bb.130:                              # %if.then1084.us
                                        #   in Loop: Header=BB0_129 Depth=2
	ld.w	$a0, $s2, 0
	addi.d	$a0, $a0, 1
	st.w	$a0, $s2, 0
	b	.LBB0_128
.LBB0_131:                              # %for.body1046.lr.ph.split
                                        #   in Loop: Header=BB0_123 Depth=1
	bnez	$a5, .LBB0_136
# %bb.132:                              # %for.body1046.us643.preheader
                                        #   in Loop: Header=BB0_123 Depth=1
	move	$s3, $zero
	addi.d	$s1, $a0, 16
	ld.d	$s6, $sp, 80                    # 8-byte Folded Reload
...
.LBB0_134:                              # %for.body1046.us643
	...
	jirl	$ra, $ra, 0
	beqz	$s4, .LBB0_133
# %bb.135:                              # %if.then1084.us651
                                        #   in Loop: Header=BB0_134 Depth=2
	ld.w	$a0, $s1, 0
	addi.d	$a0, $a0, 1
	st.w	$a0, $s1, 0
	b	.LBB0_133
.LBB0_136:                              # %for.body1046.preheader
                                        #   in Loop: Header=BB0_123 Depth=1
	move	$s6, $zero
	addi.d	$s1, $a0, 20
	...
	b	.LBB0_139
	.p2align	4, , 16
.LBB0_137:                              # %if.then1109
                                        #   in Loop: Header=BB0_139 Depth=2
	ld.w	$a0, $s1, 0
	addi.d	$a0, $a0, 1
	st.w	$a0, $s1, 0
.LBB0_138:                              # %for.inc1115
                                        #   in Loop: Header=BB0_139 Depth=2
	ld.w	$a0, $fp, 128
	addi.d	$s6, $s6, 1
	addi.d	$s1, $s1, 16
