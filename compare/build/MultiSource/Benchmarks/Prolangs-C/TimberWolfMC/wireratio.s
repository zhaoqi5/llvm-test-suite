...
# %bb.5:                                # %if.end.us
	...
	fmul.d	$ft5, $fa5, $ft4
	fmadd.d	$ft4, $ft4, $ft11, $ft5
	fmadd.d	$ft4, $fa6, $ft11, $ft4
	fadd.d	$ft4, $ft0, $ft4
	fmul.d	$ft3, $ft3, $ft4
...
.LBB2_14:                               # %if.then34
	...
	fabs.d	$fa4, $fa4
	fadd.d	$fa3, $ft11, $fa3
	fcmp.cult.d	$fcc0, $fa4, $fa7
	b	.LBB2_28
.LBB2_15:
	move	$a2, $zero
	move	$a4, $a7
.LBB2_16:                               # %for.body66.lr.ph
	frecip.d	$fa4, $fa4
	vldi	$vr5, -896
	vldi	$vr6, -992
...
.LBB2_32:                               # %if.end275
	...
	fmul.d	$fs0, $fa3, $fa0
	vst	$vr19, $sp, 1504                # 16-byte Folded Spill
...
# %bb.33:                               # %if.then355
	fadd.d	$fa0, $ft12, $fa0
	fneg.d	$fs2, $fa0
	fst.d	$fs2, $sp, 1296                 # 8-byte Folded Spill
	fmul.d	$fs3, $fa2, $fs2
	fmov.d	$fa0, $fs3
	vst	$vr20, $sp, 1376                # 16-byte Folded Spill
	...
	jirl	$ra, $ra, 0
	fld.d	$fa1, $s0, %pc_lo12(N)
	vst	$vr1, $sp, 1344                 # 16-byte Folded Spill
                                        # kill: def $f0_64 killed $f0_64 def $vr0
	...
	vori.b	$vr0, $vr7, 0
	vori.b	$vr3, $vr7, 0
	vst	$vr7, $sp, 1296                 # 16-byte Folded Spill
	...
	vld	$vr3, $sp, 1280                 # 16-byte Folded Reload
	...
	vld	$vr20, $sp, 1296                # 16-byte Folded Reload
	...
	vld	$vr2, $sp, 1328                 # 16-byte Folded Reload
	...
	vld	$vr12, $sp, 1296                # 16-byte Folded Reload
	...
	vfsub.d	$vr4, $vr4, $vr5
	vld	$vr5, $sp, 1392                 # 16-byte Folded Reload
	vreplvei.d	$vr5, $vr5, 0
	vld	$vr7, $sp, 1264                 # 16-byte Folded Reload
	vfmul.d	$vr7, $vr5, $vr7
	vfadd.d	$vr4, $vr4, $vr7
	vld	$vr7, $sp, 1280                 # 16-byte Folded Reload
	vfsub.d	$vr4, $vr4, $vr7
	vld	$vr7, $sp, 1376                 # 16-byte Folded Reload
...
# %bb.16:
	move	$a0, $zero
	b	.LBB21_31
.LBB21_17:                              # %iter.check106
	ori	$a0, $zero, 5
	ori	$a5, $zero, 1
	bltu	$a1, $a0, .LBB21_28
# %bb.18:                               # %vector.main.loop.iter.check108
	addi.w	$a0, $a1, -1
	ori	$a2, $zero, 17
	ori	$a4, $zero, 1
	bgeu	$a1, $a2, .LBB21_20
...
# %bb.22:                               # %middle.block119
	...
	xvpickve2gr.w	$a2, $xr0, 0
	beq	$a0, $a3, .LBB21_30
# %bb.23:                               # %vec.epilog.iter.check126
	andi	$a5, $a0, 12
	beqz	$a5, .LBB21_27
.LBB21_24:                              # %vec.epilog.ph125
	move	$a6, $a0
	...
	sub.d	$a2, $a3, $a6
	.p2align	4, , 16
.LBB21_25:                              # %vec.epilog.vector.body133
                                        # =>This Inner Loop Header: Depth=1
	addi.w	$a2, $a2, 4
	vmul.w	$vr0, $vr0, $vr1
	bnez	$a2, .LBB21_25
# %bb.26:                               # %vec.epilog.middle.block137
	vshuf4i.w	$vr1, $vr0, 14
	vmul.w	$vr0, $vr0, $vr1
	vreplvei.w	$vr1, $vr0, 1
	vmul.w	$vr0, $vr0, $vr1
...
.LBB21_31:                              # %for.end8
	...
	st.d	$a1, $a0, 24
	blt	$s3, $a2, .LBB21_65
# %bb.32:                               # %for.body19.lr.ph
	bltz	$s0, .LBB21_65
# %bb.33:                               # %for.body19.preheader
	addi.d	$a1, $s3, 1
	...
	b	.LBB21_35
	.p2align	4, , 16
.LBB21_34:                              # %for.cond24.for.inc49_crit_edge
...
.LBB21_35:                              # %for.body19
	...
	move	$t1, $s0
	b	.LBB21_40
.LBB21_36:                              #   in Loop: Header=BB21_40 Depth=2
	vldi	$vr4, -912
.LBB21_37:                              # %factorial.exit26.i13.i
                                        #   in Loop: Header=BB21_40 Depth=2
	fdiv.d	$fa3, $fa3, $fa4
.LBB21_38:                              # %combination.exit53.i
                                        #   in Loop: Header=BB21_40 Depth=2
	fmul.d	$fa2, $fa2, $fa3
.LBB21_39:                              # %probability.exit
                                        #   in Loop: Header=BB21_40 Depth=2
	alsl.d	$t3, $a4, $a0, 4
	fmul.d	$fa1, $fa1, $fa2
	fst.d	$fa1, $t3, 8
...
# %bb.41:                               # %if.else.i
	...
	sub.w	$t4, $t0, $t3
	bge	$t3, $t4, .LBB21_47
# %bb.42:                               # %for.cond.preheader.i.i
                                        #   in Loop: Header=BB21_40 Depth=2
	blt	$t3, $a2, .LBB21_53
# %bb.43:                               # %for.body.i.i.preheader
                                        #   in Loop: Header=BB21_40 Depth=2
	move	$t4, $t0
	move	$t5, $t1
	.p2align	4, , 16
.LBB21_44:                              # %for.body.i.i
	...
	addi.w	$t4, $t4, -1
	bnez	$t5, .LBB21_44
# %bb.45:                               # %for.body.i.i.i.preheader
                                        #   in Loop: Header=BB21_40 Depth=2
	vldi	$vr3, -912
	.p2align	4, , 16
.LBB21_46:                              # %for.body.i.i.i
                                        #   Parent Loop BB21_35 Depth=1
                                        #     Parent Loop BB21_40 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	move	$t4, $t3
	...
	b	.LBB21_52
	.p2align	4, , 16
.LBB21_47:                              # %for.cond4.preheader.i.i
                                        #   in Loop: Header=BB21_40 Depth=2
	bge	$t3, $t0, .LBB21_50
# %bb.48:                               # %for.body7.i.i.preheader
                                        #   in Loop: Header=BB21_40 Depth=2
	move	$t5, $t0
	.p2align	4, , 16
.LBB21_49:                              # %for.body7.i.i
                                        #   Parent Loop BB21_35 Depth=1
                                        #     Parent Loop BB21_40 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	movgr2fr.w	$fa3, $t5
	...
	fmul.d	$fa2, $fa2, $fa3
	blt	$t3, $t5, .LBB21_49
.LBB21_50:                              # %for.end11.i.i
                                        #   in Loop: Header=BB21_40 Depth=2
	vldi	$vr3, -912
	blt	$t4, $a2, .LBB21_52
	.p2align	4, , 16
.LBB21_51:                              # %for.body.i19.i.i
                                        #   Parent Loop BB21_35 Depth=1
                                        #     Parent Loop BB21_40 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	move	$t3, $t4
	...
	addi.w	$t4, $t3, -1
	bltu	$a2, $t3, .LBB21_51
.LBB21_52:                              # %factorial.exit26.i.i
                                        #   in Loop: Header=BB21_40 Depth=2
	fdiv.d	$fa2, $fa2, $fa3
.LBB21_53:                              # %combination.exit.i
                                        #   in Loop: Header=BB21_40 Depth=2
	sub.w	$t3, $fp, $t0
	sub.w	$t4, $t3, $t2
	bge	$t2, $t4, .LBB21_59
# %bb.54:                               # %for.cond.preheader.i31.i
                                        #   in Loop: Header=BB21_40 Depth=2
	beqz	$t2, .LBB21_64
# %bb.55:                               # %for.body.i37.i.preheader
                                        #   in Loop: Header=BB21_40 Depth=2
	move	$t4, $zero
	vldi	$vr3, -912
	.p2align	4, , 16
.LBB21_56:                              # %for.body.i37.i
                                        #   Parent Loop BB21_35 Depth=1
                                        #     Parent Loop BB21_40 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	add.d	$t5, $t3, $t4
	...
	fmul.d	$fa3, $fa3, $fa4
	bnez	$t5, .LBB21_56
# %bb.57:                               # %for.body.i.i46.i.preheader
                                        #   in Loop: Header=BB21_40 Depth=2
	vldi	$vr4, -912
	move	$t3, $a6
	.p2align	4, , 16
.LBB21_58:                              # %for.body.i.i46.i
                                        #   Parent Loop BB21_35 Depth=1
                                        #     Parent Loop BB21_40 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	addi.w	$t3, $t3, -1
	...
	b	.LBB21_37
	.p2align	4, , 16
.LBB21_59:                              # %for.cond4.preheader.i8.i
                                        #   in Loop: Header=BB21_40 Depth=2
	vldi	$vr3, -912
	bge	$t2, $t3, .LBB21_61
	.p2align	4, , 16
.LBB21_60:                              # %for.body7.i24.i
                                        #   Parent Loop BB21_35 Depth=1
                                        #     Parent Loop BB21_40 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	movgr2fr.w	$fa4, $t3
	...
	fmul.d	$fa3, $fa3, $fa4
	blt	$t2, $t3, .LBB21_60
.LBB21_61:                              # %for.end11.i10.i
                                        #   in Loop: Header=BB21_40 Depth=2
	blt	$t4, $a2, .LBB21_36
# %bb.62:                               # %for.body.i19.i17.i.preheader
                                        #   in Loop: Header=BB21_40 Depth=2
	sub.w	$t3, $zero, $t0
	vldi	$vr4, -912
	.p2align	4, , 16
.LBB21_63:                              # %for.body.i19.i17.i
                                        #   Parent Loop BB21_35 Depth=1
                                        #     Parent Loop BB21_40 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	add.d	$t4, $a7, $t3
	...
	bltu	$a2, $t4, .LBB21_63
	b	.LBB21_37
.LBB21_64:                              #   in Loop: Header=BB21_40 Depth=2
	vldi	$vr3, -912
	b	.LBB21_38
.LBB21_65:                              # %for.cond52.preheader
	movgr2fr.d	$fs0, $zero
	fmov.d	$fs1, $fs0
	fmov.d	$fs2, $fs0
	bge	$s3, $s2, .LBB21_70
# %bb.66:                               # %for.body55.preheader
	alsl.d	$a2, $s3, $a0, 4
	addi.d	$a3, $a2, 24
	sub.d	$a1, $s2, $s3
	movgr2fr.d	$fs1, $zero
...
.LBB22_14:                              # %combination.exit
	...
	sub.w	$a1, $a0, $a2
	bge	$a2, $a1, .LBB22_20
# %bb.15:                               # %for.cond.preheader.i31
	ori	$a1, $zero, 1
	blt	$a2, $a1, .LBB22_25
# %bb.16:                               # %for.body.i37.preheader
	move	$a1, $a2
	.p2align	4, , 16
.LBB22_17:                              # %for.body.i37
                                        # =>This Inner Loop Header: Depth=1
	movgr2fr.w	$fa2, $a0
	ffint.d.w	$fa2, $fa2
	fmul.d	$fa1, $fa1, $fa2
	...
	addi.w	$a0, $a0, -1
	bnez	$a1, .LBB22_17
# %bb.18:                               # %for.body.i.i46.preheader
	vldi	$vr2, -912
	ori	$a0, $zero, 1
	.p2align	4, , 16
.LBB22_19:                              # %for.body.i.i46
                                        # =>This Inner Loop Header: Depth=1
	move	$a1, $a2
	...
	bltu	$a0, $a1, .LBB22_19
	b	.LBB22_24
.LBB22_20:                              # %for.cond4.preheader.i8
	bge	$a2, $a0, .LBB22_22
	.p2align	4, , 16
.LBB22_21:                              # %for.body7.i24
                                        # =>This Inner Loop Header: Depth=1
	movgr2fr.w	$fa2, $a0
	ffint.d.w	$fa2, $fa2
	addi.w	$a0, $a0, -1
	fmul.d	$fa1, $fa1, $fa2
	blt	$a2, $a0, .LBB22_21
.LBB22_22:                              # %for.end11.i10
	vldi	$vr2, -912
	ori	$a0, $zero, 1
	blt	$a1, $a0, .LBB22_24
	.p2align	4, , 16
.LBB22_23:                              # %for.body.i19.i17
                                        # =>This Inner Loop Header: Depth=1
	move	$a2, $a1
	bstrpick.d	$a1, $a1, 31, 0
	movgr2fr.d	$fa3, $a1
	...
	addi.w	$a1, $a2, -1
	bltu	$a0, $a2, .LBB22_23
.LBB22_24:                              # %factorial.exit26.i13
	fdiv.d	$fa1, $fa1, $fa2
.LBB22_25:                              # %combination.exit53
	fmul.d	$fa0, $fa0, $fa1
	ret
.Lfunc_end22:
