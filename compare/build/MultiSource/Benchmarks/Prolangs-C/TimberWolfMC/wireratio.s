...
.LBB2_1:                                # %entry.split
	...
	vldi	$vr2, -896
	fadd.d	$ft0, $fa1, $fa2
	pcalau12i	$a2, %pc_hi20(CC)
	fld.d	$fa2, $a2, %pc_lo12(CC)
	pcalau12i	$a3, %pc_hi20(.LCPI2_0)
	fld.d	$fa5, $a3, %pc_lo12(.LCPI2_0)
	pcalau12i	$a2, %pc_hi20(.LCPI2_2)
	fld.d	$ft1, $a2, %pc_lo12(.LCPI2_2)
	pcalau12i	$a2, %pc_hi20(.LCPI2_1)
	fld.d	$fa3, $a2, %pc_lo12(.LCPI2_1)
	movgr2fr.d	$fa1, $zero
	ori	$a6, $zero, 100
	lu12i.w	$a5, 244
	ori	$a7, $a5, 576
