...
# %bb.36:                               # %if.then355
	...
	vld	$vr10, $sp, 816                 # 16-byte Folded Reload
	fdiv.d	$fa0, $ft2, $ft9
	vld	$vr16, $sp, 880                 # 16-byte Folded Reload
	fdiv.d	$fa1, $ft8, $ft10
	fsub.d	$fa0, $fa0, $fa1
	fdiv.d	$fa1, $ft2, $ft5
	fdiv.d	$fs3, $ft8, $ft6
	...
	vfmul.d	$vr30, $vr0, $vr30
	vld	$vr19, $sp, 832                 # 16-byte Folded Reload
	fdiv.d	$fa0, $ft11, $ft9
...
# %bb.15:
	move	$a0, $zero
	b	.LBB21_29
.LBB21_16:                              # %iter.check106
	ori	$a0, $zero, 5
	ori	$a5, $zero, 1
	bltu	$a1, $a0, .LBB21_26
# %bb.17:                               # %vector.main.loop.iter.check108
	addi.w	$a0, $a1, -1
	ori	$a2, $zero, 17
	ori	$a3, $zero, 1
	bgeu	$a1, $a2, .LBB21_19
...
.LBB21_19:                              # %vector.ph109
	...
	xvori.b	$xr2, $xr0, 0
	.p2align	4, , 16
.LBB21_20:                              # %vector.body114
                                        # =>This Inner Loop Header: Depth=1
	xvmul.w	$xr0, $xr0, $xr1
	addi.w	$a2, $a2, -16
	xvmul.w	$xr2, $xr2, $xr1
	bnez	$a2, .LBB21_20
# %bb.21:                               # %middle.block119
	xvmul.w	$xr0, $xr2, $xr0
	xvpermi.d	$xr1, $xr0, 14
	xvmul.w	$xr0, $xr0, $xr1
	xvshuf4i.w	$xr1, $xr0, 14
	...
	xvpickve2gr.w	$a2, $xr0, 0
	beq	$a0, $a4, .LBB21_28
# %bb.22:                               # %vec.epilog.iter.check125
	beqz	$a5, .LBB21_70
.LBB21_23:                              # %vec.epilog.ph127
	move	$a6, $a0
	...
	sub.d	$a2, $a4, $a6
	.p2align	4, , 16
.LBB21_24:                              # %vec.epilog.vector.body132
                                        # =>This Inner Loop Header: Depth=1
	addi.w	$a2, $a2, 4
	vmul.w	$vr0, $vr0, $vr1
	bnez	$a2, .LBB21_24
# %bb.25:                               # %vec.epilog.middle.block136
	vshuf4i.w	$vr1, $vr0, 14
	vmul.w	$vr0, $vr0, $vr1
	vreplvei.w	$vr1, $vr0, 1
	vmul.w	$vr0, $vr0, $vr1
...
.LBB21_29:                              # %for.end8
	...
	st.d	$a1, $a0, 24
	blez	$s3, .LBB21_63
# %bb.30:                               # %for.body19.lr.ph
	bltz	$s0, .LBB21_63
# %bb.31:                               # %for.body19.preheader
	addi.d	$a1, $s3, 1
	...
	b	.LBB21_33
	.p2align	4, , 16
.LBB21_32:                              # %for.cond24.for.inc49_crit_edge
...
.LBB21_34:                              #   in Loop: Header=BB21_38 Depth=2
	vldi	$vr4, -912
.LBB21_35:                              # %factorial.exit26.i13.i
                                        #   in Loop: Header=BB21_38 Depth=2
	fdiv.d	$fa3, $fa3, $fa4
.LBB21_36:                              # %combination.exit53.i
                                        #   in Loop: Header=BB21_38 Depth=2
	fmul.d	$fa2, $fa2, $fa3
...
.LBB21_42:                              # %for.body.i.i
	...
	addi.w	$t4, $t4, -1
	bnez	$t5, .LBB21_42
# %bb.43:                               # %for.body.i.i.i.preheader
                                        #   in Loop: Header=BB21_38 Depth=2
	vldi	$vr3, -912
	.p2align	4, , 16
.LBB21_44:                              # %for.body.i.i.i
                                        #   Parent Loop BB21_33 Depth=1
                                        #     Parent Loop BB21_38 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	move	$t4, $t3
	...
	b	.LBB21_50
	.p2align	4, , 16
.LBB21_45:                              # %for.cond4.preheader.i.i
                                        #   in Loop: Header=BB21_38 Depth=2
	bge	$t3, $t0, .LBB21_48
# %bb.46:                               # %for.body7.i.i.preheader
                                        #   in Loop: Header=BB21_38 Depth=2
	move	$t5, $t0
	.p2align	4, , 16
.LBB21_47:                              # %for.body7.i.i
                                        #   Parent Loop BB21_33 Depth=1
                                        #     Parent Loop BB21_38 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	movgr2fr.w	$fa3, $t5
	...
	fmul.d	$fa2, $fa2, $fa3
	blt	$t3, $t5, .LBB21_47
.LBB21_48:                              # %for.end11.i.i
                                        #   in Loop: Header=BB21_38 Depth=2
	vldi	$vr3, -912
	blez	$t4, .LBB21_50
	.p2align	4, , 16
.LBB21_49:                              # %for.body.i19.i.i
                                        #   Parent Loop BB21_33 Depth=1
                                        #     Parent Loop BB21_38 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	move	$t3, $t4
...
.LBB21_51:                              # %combination.exit.i
	...
	sub.w	$t4, $t3, $t2
	bge	$t2, $t4, .LBB21_57
# %bb.52:                               # %for.cond.preheader.i31.i
                                        #   in Loop: Header=BB21_38 Depth=2
	beqz	$t2, .LBB21_62
# %bb.53:                               # %for.body.i37.i.preheader
                                        #   in Loop: Header=BB21_38 Depth=2
	move	$t4, $zero
	vldi	$vr3, -912
	.p2align	4, , 16
.LBB21_54:                              # %for.body.i37.i
                                        #   Parent Loop BB21_33 Depth=1
                                        #     Parent Loop BB21_38 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	add.d	$t5, $t3, $t4
	...
	fmul.d	$fa3, $fa3, $fa4
	bnez	$t5, .LBB21_54
# %bb.55:                               # %for.body.i.i46.i.preheader
                                        #   in Loop: Header=BB21_38 Depth=2
	vldi	$vr4, -912
	move	$t3, $a6
	.p2align	4, , 16
.LBB21_56:                              # %for.body.i.i46.i
                                        #   Parent Loop BB21_33 Depth=1
                                        #     Parent Loop BB21_38 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	addi.w	$t3, $t3, -1
	...
	b	.LBB21_35
	.p2align	4, , 16
.LBB21_57:                              # %for.cond4.preheader.i8.i
                                        #   in Loop: Header=BB21_38 Depth=2
	vldi	$vr3, -912
	bge	$t2, $t3, .LBB21_59
	.p2align	4, , 16
.LBB21_58:                              # %for.body7.i24.i
                                        #   Parent Loop BB21_33 Depth=1
                                        #     Parent Loop BB21_38 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	movgr2fr.w	$fa4, $t3
	...
	fmul.d	$fa3, $fa3, $fa4
	blt	$t2, $t3, .LBB21_58
.LBB21_59:                              # %for.end11.i10.i
                                        #   in Loop: Header=BB21_38 Depth=2
	blez	$t4, .LBB21_34
# %bb.60:                               # %for.body.i19.i17.i.preheader
                                        #   in Loop: Header=BB21_38 Depth=2
	sub.w	$t3, $zero, $t0
	vldi	$vr4, -912
	.p2align	4, , 16
.LBB21_61:                              # %for.body.i19.i17.i
                                        #   Parent Loop BB21_33 Depth=1
                                        #     Parent Loop BB21_38 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	add.d	$t4, $a7, $t3
...
.LBB21_62:                              #   in Loop: Header=BB21_38 Depth=2
	vldi	$vr3, -912
	b	.LBB21_36
.LBB21_63:                              # %for.cond52.preheader
	movgr2fr.d	$fs0, $zero
	fmov.d	$fs1, $fs0
	fmov.d	$fs2, $fs0
	bge	$s3, $s2, .LBB21_68
# %bb.64:                               # %for.body55.preheader
	alsl.d	$a2, $s3, $a0, 4
	addi.d	$a3, $a2, 24
	sub.d	$a1, $s2, $s3
	movgr2fr.d	$fs1, $zero
