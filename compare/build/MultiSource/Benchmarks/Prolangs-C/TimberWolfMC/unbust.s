...
# %bb.12:                               # %middle.block
	...
	beq	$a4, $a0, .LBB0_15
.LBB0_13:                               # %for.body.i77.preheader
	sub.d	$a4, $a0, $a3
	addi.d	$a4, $a4, 1
	alsl.d	$a3, $a3, $s1, 3
	addi.d	$a3, $a3, 4
	.p2align	4, , 16
.LBB0_14:                               # %for.body.i77
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a5, $a3, 0
	slt	$a6, $a5, $a2
	masknez	$a2, $a2, $a6
	...
	addi.d	$a3, $a3, 8
	bnez	$a4, .LBB0_14
.LBB0_15:                               # %for.body10.i.preheader
	move	$a3, $zero
	slli.d	$a0, $a0, 3
	ori	$a4, $zero, 1
	ori	$a5, $a1, 256
