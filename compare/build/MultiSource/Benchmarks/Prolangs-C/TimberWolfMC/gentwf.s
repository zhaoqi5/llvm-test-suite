...
# %bb.15:                               # %for.body73.lr.ph
	...
	ld.w	$a5, $sp, 152
	ld.w	$a6, $sp, 148
	pcalau12i	$a7, %got_pc_hi20(rectArray)
	ld.d	$a7, $a7, %got_pc_lo12(rectArray)
	ld.d	$a7, $a7, 0
	b	.LBB0_17
	.p2align	4, , 16
.LBB0_16:                               # %for.inc120
...
# %bb.22:                               # %for.body128.lr.ph
	...
	ld.w	$a6, $sp, 148
	ld.w	$a7, $sp, 152
	pcalau12i	$t0, %got_pc_hi20(rectArray)
	ld.d	$t0, $t0, %got_pc_lo12(rectArray)
	ld.d	$t0, $t0, 0
	b	.LBB0_24
	.p2align	4, , 16
.LBB0_23:                               # %for.inc174
...
# %bb.29:                               # %for.body182.lr.ph
	...
	ld.d	$a6, $a6, %got_pc_lo12(rectArray)
	ld.d	$a6, $a6, 0
	b	.LBB0_31
	.p2align	4, , 16
.LBB0_30:                               # %for.inc229
