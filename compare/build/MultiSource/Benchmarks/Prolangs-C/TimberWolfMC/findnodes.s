...
# %bb.85:                               #   in Loop: Header=BB0_40 Depth=3
	...
	sltui	$t0, $a2, 1
	blt	$a6, $s2, .LBB0_90
.LBB0_86:                               # %lor.lhs.false312
                                        #   in Loop: Header=BB0_40 Depth=3
	bne	$a6, $s2, .LBB0_38
# %bb.87:                               # %land.lhs.true314
                                        #   in Loop: Header=BB0_40 Depth=3
	ld.w	$a2, $a3, 24
	beqz	$a2, .LBB0_90
# %bb.88:                               # %lor.lhs.false319
                                        #   in Loop: Header=BB0_40 Depth=3
	addi.w	$a2, $zero, -1
	blt	$a2, $a4, .LBB0_38
# %bb.89:                               # %land.lhs.true324
                                        #   in Loop: Header=BB0_40 Depth=3
	ld.w	$a4, $a3, 32
	slli.d	$a6, $a4, 5
	alsl.d	$a4, $a4, $a6, 3
...
# %bb.91:                               # %if.then341
	...
	beqz	$t0, .LBB0_39
	b	.LBB0_97
.LBB0_92:                               # %lor.lhs.false334
                                        #   in Loop: Header=BB0_40 Depth=3
	bne	$a5, $s2, .LBB0_38
# %bb.93:                               # %land.lhs.true336
                                        #   in Loop: Header=BB0_40 Depth=3
	ld.w	$a2, $a3, 24
	sltui	$a2, $a2, 1
	and	$a3, $a2, $t0
...
.LBB0_150:                              # %if.end.i
	...
	move	$a1, $s1
	move	$a2, $s0
.LBB0_151:                              # %for.inc.i238
                                        #   in Loop: Header=BB0_152 Depth=1
	ld.d	$s4, $s4, 16
	beqz	$s4, .LBB0_155
.LBB0_152:                              # %for.body.i237
...
.LBB0_155:                              # %makeRLEtree.exit
	...
	ld.d	$s8, $sp, 88                    # 8-byte Folded Reload
	beqz	$s4, .LBB0_162
# %bb.156:                              # %for.body.preheader.i246
	move	$a1, $zero
	ld.d	$a0, $s8, 0
	ori	$a2, $s2, 3520
	ori	$s2, $zero, 52
...
.LBB0_157:                              # %if.end.i264
	...
	move	$a1, $s1
	move	$a2, $s0
.LBB0_158:                              # %for.inc.i253
                                        #   in Loop: Header=BB0_159 Depth=1
	ld.d	$s4, $s4, 16
	beqz	$s4, .LBB0_162
.LBB0_159:                              # %for.body.i248
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a3, $s4, 0
	mul.d	$a3, $a3, $s2
	add.d	$a3, $a0, $a3
