...
# %bb.0:                                # %entry
	...
	ld.d	$s4, $a0, %got_pc_lo12(numnets)
	ld.w	$s7, $s4, 0
	addi.w	$s8, $s7, 1
	slli.d	$a0, $s8, 3
	pcaddu18i	$ra, %call36(malloc)
...
# %bb.25:                               # %middle.block
	...
	beq	$a2, $a5, .LBB0_28
.LBB0_26:                               # %for.body77.preheader209
	addi.d	$a2, $a5, 1
...
# %bb.58:                               # %middle.block195
	...
	beq	$a3, $a1, .LBB0_61
.LBB0_59:                               # %for.body199.preheader202
	addi.d	$a3, $a1, 1
...
.LBB3_48:                               # %vec.epilog.ph146
	...
	add.d	$a1, $s0, $a1
	.p2align	4, , 16
.LBB3_49:                               # %vec.epilog.vector.body150
                                        #   Parent Loop BB3_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a2, 0
	vld	$vr1, $a1, 0
	...
	addi.d	$a1, $a1, 16
	bnez	$t0, .LBB3_49
# %bb.50:                               # %vec.epilog.middle.block157
                                        #   in Loop: Header=BB3_3 Depth=1
	bne	$a7, $a3, .LBB3_11
	b	.LBB3_12
.LBB3_51:                               # %vector.ph128
                                        #   in Loop: Header=BB3_3 Depth=1
	andi	$a4, $a3, 16
...
.LBB3_52:                               # %vector.body131
	...
	addi.d	$a7, $a7, 32
	bnez	$t0, .LBB3_52
# %bb.53:                               # %middle.block140
                                        #   in Loop: Header=BB3_3 Depth=1
	beq	$a6, $a3, .LBB3_12
# %bb.54:                               # %vec.epilog.iter.check144
                                        #   in Loop: Header=BB3_3 Depth=1
	bnez	$a4, .LBB3_48
