...
.LBB0_23:                               # %vector.body
	...
	mul.d	$t8, $t8, $s4
	add.d	$t8, $a0, $t8
	xvpickve2gr.d	$ra, $xr9, 0
	mul.d	$ra, $ra, $s4
	add.d	$ra, $a0, $ra
	xvpickve2gr.d	$s8, $xr9, 1
	mul.d	$s8, $s8, $s4
	add.d	$s8, $a0, $s8
...
# %bb.52:                               #   in Loop: Header=BB0_41 Depth=2
	...
	b	.LBB0_39
.LBB0_53:                               # %vec.epilog.iter.check847
                                        #   in Loop: Header=BB0_41 Depth=2
	andi	$a3, $s2, 12
	ld.d	$s3, $sp, 88                    # 8-byte Folded Reload
	ld.d	$s5, $sp, 80                    # 8-byte Folded Reload
...
.LBB0_54:                               #   in Loop: Header=BB0_41 Depth=2
	...
	sub.d	$a2, $a2, $a5
	.p2align	4, , 16
.LBB0_55:                               # %vec.epilog.vector.body852
                                        #   Parent Loop BB0_37 Depth=1
                                        #     Parent Loop BB0_41 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vld	$vr1, $a4, 0
	...
	addi.d	$a4, $a4, 16
	bnez	$a2, .LBB0_55
# %bb.56:                               # %vec.epilog.middle.block858
                                        #   in Loop: Header=BB0_41 Depth=2
	vshuf4i.w	$vr1, $vr0, 14
	vadd.w	$vr0, $vr0, $vr1
	vreplvei.w	$vr1, $vr0, 1
...
.LBB0_84:                               # %for.inc544.peel
	...
	addi.w	$a2, $t3, 1
	beq	$t2, $a2, .LBB0_64
# %bb.85:                               # %for.body419.preheader891
                                        #   in Loop: Header=BB0_66 Depth=2
	alsl.d	$t5, $t1, $a0, 2
	addi.d	$t6, $t0, -1
