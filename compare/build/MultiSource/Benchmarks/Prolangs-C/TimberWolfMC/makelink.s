...
# %bb.0:                                # %entry
	...
	pcalau12i	$a2, %got_pc_hi20(hFixedList)
	ld.d	$s3, $a2, %got_pc_lo12(hFixedList)
	ld.w	$s2, $a1, 0
	move	$s0, $a0
	st.d	$a0, $s3, 0
	st.w	$s2, $a0, 0
	...
	pcaddu18i	$ra, %call36(malloc)
	jirl	$ra, $ra, 0
	pcalau12i	$a1, %got_pc_hi20(vFixedList)
	ld.d	$s4, $a1, %got_pc_lo12(vFixedList)
	move	$s1, $a0
	st.d	$a0, $s4, 0
	addi.d	$a0, $s2, -3
	st.w	$a0, $s1, 0
...
# %bb.0:                                # %entry
	...
	jirl	$ra, $ra, 0
	pcalau12i	$a1, %got_pc_hi20(vFixedList)
	ld.d	$a1, $a1, %got_pc_lo12(vFixedList)
...
# %bb.0:                                # %entry
	...
	pcaddu18i	$ra, %call36(malloc)
	jirl	$ra, $ra, 0
	pcalau12i	$a1, %got_pc_hi20(hFixedList)
	ld.d	$a1, $a1, %got_pc_lo12(hFixedList)
