...
# %bb.153:                              # %for.body933.lr.ph
	...
	bne	$a1, $s5, .LBB0_158
# %bb.154:                              # %for.cond930.preheader1237
                                        #   in Loop: Header=BB0_16 Depth=2
	move	$a1, $zero
...
.LBB0_240:                              # %vector.body1097
	...
	addi.d	$a6, $a6, -128
	bnez	$a7, .LBB0_240
# %bb.241:                              # %middle.block1103
                                        #   in Loop: Header=BB0_16 Depth=2
	beq	$a4, $a5, .LBB0_84
.LBB0_242:                              # %for.body600.preheader1177
                                        #   in Loop: Header=BB0_16 Depth=2
	alsl.d	$a0, $a3, $a0, 4
	addi.d	$a0, $a0, -16
	sub.d	$a1, $a1, $a2
