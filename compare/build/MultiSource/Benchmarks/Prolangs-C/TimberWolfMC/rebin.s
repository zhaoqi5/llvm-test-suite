...
.LBB0_15:                               # %for.body21.lr.ph
	...
	ld.d	$a6, $a5, %got_pc_lo12(cellarray)
	pcalau12i	$a5, %got_pc_hi20(blockarray)
	ld.d	$a7, $a5, %got_pc_lo12(blockarray)
	move	$a5, $zero
	ld.d	$t2, $a6, 0
	ld.d	$a6, $a7, 0
	pcalau12i	$a7, %got_pc_hi20(binOffsetX)
	ld.d	$a7, $a7, %got_pc_lo12(binOffsetX)
	pcalau12i	$t0, %got_pc_hi20(binWidthX)
	ld.d	$t0, $t0, %got_pc_lo12(binWidthX)
	pcalau12i	$t1, %got_pc_hi20(bucket)
	ld.d	$t1, $t1, %got_pc_lo12(bucket)
	addi.d	$t2, $t2, 8
	ori	$t3, $zero, 1
	ori	$t4, $zero, 1
	b	.LBB0_18
