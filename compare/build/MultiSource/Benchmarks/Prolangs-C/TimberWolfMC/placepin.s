...
.LBB0_24:                               #   in Loop: Header=BB0_9 Depth=2
	...
	bnez	$a0, .LBB0_96
	b	.LBB0_88
.LBB0_25:                               # %vector.main.loop.iter.check309
                                        #   in Loop: Header=BB0_9 Depth=2
...
# %bb.43:                               #   in Loop: Header=BB0_9 Depth=2
	...
	ld.d	$t6, $sp, 56                    # 8-byte Folded Reload
	b	.LBB0_92
.LBB0_44:                               # %vec.epilog.iter.check325
                                        #   in Loop: Header=BB0_9 Depth=2
	andi	$a2, $s8, 12
	ori	$s0, $zero, 3
	ld.d	$fp, $sp, 40                    # 8-byte Folded Reload
...
.LBB0_45:                               # %vec.epilog.ph324
	...
	add.d	$t1, $t1, $a7
	.p2align	4, , 16
.LBB0_46:                               # %vec.epilog.vector.body330
                                        #   Parent Loop BB0_4 Depth=1
                                        #     Parent Loop BB0_9 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.w	$a7, $t1, -40
	...
	addi.d	$t1, $t1, 80
	bnez	$a0, .LBB0_46
# %bb.47:                               # %vec.epilog.middle.block335
                                        #   in Loop: Header=BB0_9 Depth=2
	...
	bne	$s8, $t0, .LBB0_57
	b	.LBB0_59
.LBB0_48:                               # %vec.epilog.iter.check397
                                        #   in Loop: Header=BB0_9 Depth=2
	andi	$a2, $ra, 12
	ori	$s0, $zero, 3
	ld.d	$fp, $sp, 40                    # 8-byte Folded Reload
...
.LBB0_49:                               # %vec.epilog.ph396
	...
	add.d	$t0, $t0, $a7
	.p2align	4, , 16
.LBB0_50:                               # %vec.epilog.vector.body402
                                        #   Parent Loop BB0_4 Depth=1
                                        #     Parent Loop BB0_9 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.w	$a7, $t0, -40
	...
	addi.d	$t0, $t0, 80
	bnez	$a0, .LBB0_50
# %bb.51:                               # %vec.epilog.middle.block407
                                        #   in Loop: Header=BB0_9 Depth=2
	vshuf4i.w	$vr3, $vr2, 14
	vadd.w	$vr2, $vr2, $vr3
	vreplvei.w	$vr3, $vr2, 1
...
# %bb.68:                               #   in Loop: Header=BB0_9 Depth=2
	...
	move	$a2, $t2
	b	.LBB0_80
.LBB0_69:                               # %vector.main.loop.iter.check345
                                        #   in Loop: Header=BB0_9 Depth=2
	bstrpick.d	$a2, $a0, 31, 0
	addi.d	$s8, $a2, 1
	ori	$a2, $zero, 15
...
# %bb.74:                               #   in Loop: Header=BB0_9 Depth=2
	...
	ld.d	$t6, $sp, 56                    # 8-byte Folded Reload
	b	.LBB0_82
.LBB0_75:                               # %vec.epilog.iter.check361
                                        #   in Loop: Header=BB0_9 Depth=2
	andi	$a2, $s8, 12
	ori	$s0, $zero, 3
	ld.d	$fp, $sp, 40                    # 8-byte Folded Reload
...
.LBB0_76:                               # %vec.epilog.ph360
	...
	add.d	$t1, $t1, $a7
	.p2align	4, , 16
.LBB0_77:                               # %vec.epilog.vector.body366
                                        #   Parent Loop BB0_4 Depth=1
                                        #     Parent Loop BB0_9 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.w	$a7, $t1, -40
	...
	addi.d	$t1, $t1, 80
	bnez	$a0, .LBB0_77
# %bb.78:                               # %vec.epilog.middle.block371
                                        #   in Loop: Header=BB0_9 Depth=2
	vshuf4i.w	$vr3, $vr2, 14
	vadd.w	$vr2, $vr2, $vr3
	vreplvei.w	$vr3, $vr2, 1
...
.LBB0_111:                              # %vector.body275
	...
	addi.d	$t7, $t7, 88
	bnez	$t8, .LBB0_111
# %bb.112:                              # %middle.block279
                                        #   in Loop: Header=BB0_107 Depth=3
	beq	$t0, $a7, .LBB0_106
.LBB0_113:                              # %for.body279.preheader412
                                        #   in Loop: Header=BB0_107 Depth=3
	mul.d	$a7, $a2, $a3
	add.d	$a7, $s2, $a7
	.p2align	4, , 16
...
# %bb.117:                              # %middle.block
                                        #   in Loop: Header=BB0_9 Depth=2
	beq	$t0, $a7, .LBB0_8
.LBB0_118:                              # %for.body302.preheader413
                                        #   in Loop: Header=BB0_9 Depth=2
	mul.d	$a7, $a2, $a3
	add.d	$a7, $s2, $a7
	.p2align	4, , 16
