...
# %bb.29:                               # %iter.check191
	...
	ori	$a6, $zero, 64
	bltu	$a5, $a6, .LBB0_40
# %bb.30:                               # %vector.main.loop.iter.check193
	ori	$a4, $zero, 32
	bgeu	$a1, $a4, .LBB0_32
# %bb.31:
	move	$a5, $zero
	b	.LBB0_36
.LBB0_32:                               # %vector.ph194
...
# %bb.34:                               # %middle.block200
	beq	$a5, $a1, .LBB0_42
# %bb.35:                               # %vec.epilog.iter.check205
	andi	$a4, $a1, 24
	beqz	$a4, .LBB0_39
.LBB0_36:                               # %vec.epilog.ph204
	...
	vrepli.b	$vr0, 0
	.p2align	4, , 16
.LBB0_37:                               # %vec.epilog.vector.body210
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a7, 0
	vst	$vr0, $t0, 0
	addi.d	$a7, $a7, 16
	...
	addi.d	$t0, $t0, 16
	bnez	$a5, .LBB0_37
# %bb.38:                               # %vec.epilog.middle.block214
	bne	$a6, $a1, .LBB0_40
	b	.LBB0_42
.LBB0_39:
	addi.d	$a4, $a5, 1
