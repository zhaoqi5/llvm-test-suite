...
.LBB0_48:                               #   in Loop: Header=BB0_4 Depth=1
	ori	$s7, $zero, 1
	b	.LBB0_3
.LBB0_49:                               # %if.then180.for.cond222.preheader_crit_edge
                                        #   in Loop: Header=BB0_4 Depth=1
	ld.d	$a0, $s8, %pc_lo12(C)
	ld.w	$a2, $a0, 0
	blt	$a2, $s3, .LBB0_56
.LBB0_50:                               # %for.body226.preheader
                                        #   in Loop: Header=BB0_4 Depth=1
	move	$a1, $zero
	addi.d	$a3, $a2, 1
	bstrpick.d	$a3, $a3, 31, 0
...
.LBB0_61:                               # %for.body350
	...
	addi.w	$s2, $s2, 1
	blt	$s2, $a1, .LBB0_61
# %bb.62:                               # %for.cond366.preheader
                                        #   in Loop: Header=BB0_4 Depth=1
	bge	$a2, $s3, .LBB0_64
	b	.LBB0_70
.LBB0_63:                               # %if.then324.for.cond366.preheader_crit_edge
                                        #   in Loop: Header=BB0_4 Depth=1
	ld.d	$a0, $s8, %pc_lo12(C)
	ld.w	$a2, $a0, 0
	blt	$a2, $s3, .LBB0_70
.LBB0_64:                               # %for.body370.preheader
                                        #   in Loop: Header=BB0_4 Depth=1
	move	$a1, $zero
	addi.d	$a3, $a2, 1
	bstrpick.d	$a3, $a3, 31, 0
