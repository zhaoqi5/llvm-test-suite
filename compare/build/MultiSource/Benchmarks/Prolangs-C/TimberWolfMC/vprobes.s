...
.LBB0_2:                                # %if.then445.critedge
	...
	addi.d	$a1, $a1, 1
	st.w	$a1, $s4, 0
	pcalau12i	$a2, %got_pc_hi20(edgeCount)
	ld.d	$s2, $a2, %got_pc_lo12(edgeCount)
	ld.w	$a2, $s2, 0
	add.w	$a1, $a2, $a1
	mul.d	$a1, $a1, $s1
	add.d	$a1, $a0, $a1
...
.LBB0_22:                               # %if.then120.critedge
	...
	st.w	$a1, $s2, 0
	pcalau12i	$a2, %got_pc_hi20(edgeCount)
	ld.d	$s0, $a2, %got_pc_lo12(edgeCount)
	ld.w	$a2, $s0, 0
	add.w	$a1, $a2, $a1
	mul.d	$a1, $a1, $s1
	add.d	$a1, $a0, $a1
...
# %bb.0:                                # %entry
	...
	move	$fp, $a0
	pcalau12i	$a0, %got_pc_hi20(edgeList)
	ld.d	$a1, $a0, %got_pc_lo12(edgeList)
	ld.w	$a0, $fp, 0
