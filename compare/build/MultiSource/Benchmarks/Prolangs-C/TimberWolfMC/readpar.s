...
# %bb.0:                                # %entry
	...
	addi.d	$sp, $sp, -384
	pcalau12i	$a0, %pc_hi20(wireEstimateOnly)
	st.d	$a0, $sp, 40                    # 8-byte Folded Spill
	st.w	$zero, $a0, %pc_lo12(wireEstimateOnly)
	pcalau12i	$a0, %got_pc_hi20(attpercell)
	addi.w	$s8, $zero, -1
	ld.d	$a3, $a0, %got_pc_lo12(attpercell)
	move	$a0, $s8
	lu32i.d	$a0, 0
	pcalau12i	$a1, %got_pc_hi20(lapFactor)
	ld.d	$a1, $a1, %got_pc_lo12(lapFactor)
	pcalau12i	$a2, %got_pc_hi20(cost_only)
	ld.d	$a4, $a2, %got_pc_lo12(cost_only)
	...
	ld.d	$a4, $a1, %got_pc_lo12(chipaspect)
	lu52i.d	$a1, $zero, -1025
	pcalau12i	$a2, %got_pc_hi20(pinSpacing)
	ld.d	$a5, $a2, %got_pc_lo12(pinSpacing)
	pcalau12i	$a2, %got_pc_hi20(trackspacing)
	ld.d	$a3, $a2, %got_pc_lo12(trackspacing)
	...
	ld.d	$a5, $a2, %got_pc_lo12(doChannelGraph)
	pcalau12i	$a2, %got_pc_hi20(doGlobalRoute)
	ld.d	$a4, $a2, %got_pc_lo12(doGlobalRoute)
	pcalau12i	$a2, %got_pc_hi20(doCompaction)
	ld.d	$a3, $a2, %got_pc_lo12(doCompaction)
	...
	ld.d	$a4, $a2, %got_pc_lo12(gOffsetX)
	lu12i.w	$a2, -245
	ori	$a2, $a2, 3520
	lu32i.d	$a2, 0
	pcalau12i	$a3, %got_pc_hi20(gOffsetY)
	ld.d	$a5, $a3, %got_pc_lo12(gOffsetY)
	pcalau12i	$a3, %got_pc_hi20(gridX)
	ld.d	$a6, $a3, %got_pc_lo12(gridX)
	...
	pcalau12i	$a2, %got_pc_hi20(spot_control)
	pcalau12i	$a3, %got_pc_hi20(cktName)
	ld.d	$a3, $a3, %got_pc_lo12(cktName)
	ld.d	$a4, $a2, %got_pc_lo12(spot_control)
...
# %bb.31:                               # %if.end38
	...
	st.w	$s6, $a0, %pc_lo12(core_expansion_given)
	b	.LBB0_4
.LBB0_32:                               # %if.then43
                                        #   in Loop: Header=BB0_5 Depth=1
	move	$a0, $s0
...
.LBB0_43:                               # %if.then147
	...
	st.w	$s6, $a0, %pc_lo12(wireEstimateOnly)
	b	.LBB0_4
.LBB0_44:                               # %if.then152
                                        #   in Loop: Header=BB0_5 Depth=1
...
.LBB0_75:                               # %if.then322
	pcalau12i	$a0, %got_pc_hi20(fpo)
	ld.d	$fp, $a0, %got_pc_lo12(fpo)
	ld.w	$a2, $s6, %pc_lo12(routerMaxPaths)
	ld.d	$a3, $fp, 0
	bge	$s8, $a2, .LBB0_104
# %bb.76:                               # %if.else326
	...
	pcaddu18i	$ra, %call36(fprintf)
	jirl	$ra, $ra, 0
	ld.w	$a0, $s6, %pc_lo12(routerMaxPaths)
	beqz	$a0, .LBB0_79
# %bb.77:
	move	$s0, $zero
	b	.LBB0_80
...
.LBB0_79:                               # %if.then330
	...
	pcaddu18i	$ra, %call36(fwrite)
	jirl	$ra, $ra, 0
	st.w	$s0, $s6, %pc_lo12(routerMaxPaths)
.LBB0_80:                               # %if.end333
