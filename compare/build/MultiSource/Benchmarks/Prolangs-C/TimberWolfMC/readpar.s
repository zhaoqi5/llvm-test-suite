...
# %bb.0:                                # %entry
	...
	addi.d	$sp, $sp, -640
	pcalau12i	$s2, %pc_hi20(wireEstimateOnly)
	st.w	$zero, $s2, %pc_lo12(wireEstimateOnly)
	...
	ld.d	$s8, $a1, %got_pc_lo12(cost_only)
	st.w	$zero, $s8, 0
	...
	ld.d	$s4, $a2, %got_pc_lo12(coreGiven)
	st.w	$zero, $s4, 0
...
# %bb.2:
	...
	pcalau12i	$a1, %pc_hi20(core_expansion)
	addi.d	$a1, $a1, %pc_lo12(core_expansion)
...
# %bb.31:                               # %if.end38
	...
	st.w	$s5, $a0, %pc_lo12(core_expansion_given)
	b	.LBB0_4
.LBB0_32:                               # %if.then43
                                        #   in Loop: Header=BB0_5 Depth=1
	move	$a0, $s0
...
# %bb.37:                               # %if.end87
                                        #   in Loop: Header=BB0_5 Depth=1
	ld.w	$a0, $s2, 0
	pcalau12i	$a1, %got_pc_hi20(pitch)
	ld.d	$a1, $a1, %got_pc_lo12(pitch)
	st.w	$a0, $a1, 0
	move	$s2, $s8
	move	$s8, $s4
	move	$s4, $fp
...
.LBB0_43:                               # %if.then147
                                        #   in Loop: Header=BB0_5 Depth=1
	st.w	$s5, $s2, %pc_lo12(wireEstimateOnly)
	b	.LBB0_4
.LBB0_44:                               # %if.then152
                                        #   in Loop: Header=BB0_5 Depth=1
