...
.LBB4_51:                               # %if.then106
	...
	move	$a3, $s3
	blt	$a1, $a0, .LBB4_54
# %bb.52:                               # %for.body.i155.preheader
	addi.d	$a2, $sp, 43
	move	$a4, $s3
	.p2align	4, , 16
.LBB4_53:                               # %for.body.i155
                                        # =>This Inner Loop Header: Depth=1
	...
	move	$a4, $a3
	bltu	$a0, $a5, .LBB4_53
.LBB4_54:                               # %for.end.i149
	beqz	$a3, .LBB4_56
# %bb.55:                               # %if.end17.sink.split.i152
	pcalau12i	$a0, %pc_hi20(.Lstr)
	addi.d	$a0, $a0, %pc_lo12(.Lstr)
	pcaddu18i	$ra, %call36(puts)
	jirl	$ra, $ra, 0
.LBB4_56:                               # %SET_BITS_TO.exit167
	ld.w	$a0, $s5, 24
	beqz	$a0, .LBB4_63
# %bb.57:                               # %if.else119
	ld.d	$a0, $sp, 72
...
# %bb.59:                               # %sw.bb
	...
	ori	$a1, $zero, 1
	blt	$a0, $a1, .LBB4_79
# %bb.60:                               # %for.body.i262.peel
	ori	$a2, $zero, 49
	st.b	$a2, $sp, 38
	beq	$a0, $a1, .LBB4_80
# %bb.61:                               # %for.body.i262.preheader
	addi.d	$a1, $sp, 37
	ori	$a2, $zero, 48
	ori	$a3, $zero, 4
	.p2align	4, , 16
.LBB4_62:                               # %for.body.i262
                                        # =>This Inner Loop Header: Depth=1
	addi.w	$a4, $a0, 0
...
.LBB4_63:                               # %if.then111
	...
	movfr2gr.s	$a0, $fa0
	blt	$a0, $s2, .LBB4_67
# %bb.64:                               # %for.body.i177.preheader
	ori	$a2, $zero, 3
	addi.d	$a1, $sp, 39
	.p2align	4, , 16
.LBB4_65:                               # %for.body.i177
                                        # =>This Inner Loop Header: Depth=1
	move	$a3, $a2
	bstrpick.d	$a2, $a2, 31, 1
	srli.d	$a4, $a3, 1
...
# %bb.66:                               # %for.end.i171
	...
	ori	$a1, $zero, 2
	bltu	$a0, $a1, .LBB4_68
.LBB4_67:                               # %if.end17.sink.split.i174
	pcalau12i	$a0, %pc_hi20(.Lstr)
	addi.d	$a0, $a0, %pc_lo12(.Lstr)
	pcaddu18i	$ra, %call36(puts)
	jirl	$ra, $ra, 0
.LBB4_68:                               # %SET_BITS_TO.exit189
	beqz	$s3, .LBB4_89
# %bb.69:                               # %if.then114
	ld.b	$a0, $sp, 32
	ori	$a1, $zero, 2
...
.LBB4_70:                               # %sw.bb123
	...
	ori	$a1, $zero, 1
	blt	$a0, $a1, .LBB4_79
# %bb.71:                               # %for.body.i284.peel
	ori	$a2, $zero, 49
	st.b	$a2, $sp, 39
	beq	$a0, $a1, .LBB4_80
# %bb.72:                               # %for.body.i284.preheader
	addi.d	$a1, $sp, 38
	ori	$a2, $zero, 48
	ori	$a3, $zero, 4
	.p2align	4, , 16
.LBB4_73:                               # %for.body.i284
                                        # =>This Inner Loop Header: Depth=1
	addi.w	$a4, $a0, 0
	bstrpick.d	$a0, $a0, 31, 1
	st.b	$a2, $a1, 0
...
# %bb.77:                               # %for.end.i300
	...
	ori	$a1, $zero, 2
	bltu	$a0, $a1, .LBB4_81
.LBB4_78:                               # %if.end17.sink.split.i303
	pcalau12i	$a0, %pc_hi20(.Lstr)
	addi.d	$a0, $a0, %pc_lo12(.Lstr)
	pcaddu18i	$ra, %call36(puts)
	jirl	$ra, $ra, 0
	b	.LBB4_81
.LBB4_79:                               # %if.end17.sink.split.i259
	pcalau12i	$a0, %pc_hi20(.Lstr)
	addi.d	$a0, $a0, %pc_lo12(.Lstr)
	pcaddu18i	$ra, %call36(puts)
	jirl	$ra, $ra, 0
.LBB4_80:                               # %SET_BITS_TO.exit274
	ld.d	$a0, $sp, 72
	addi.d	$a0, $a0, 1
	st.d	$a0, $sp, 72
.LBB4_81:                               # %sw.epilog
...
# %bb.85:                               # %if.then140
	...
	ori	$a2, $zero, 1
	blt	$a1, $a2, .LBB4_90
# %bb.86:                               # %for.body.i328.peel
	ori	$a0, $zero, 49
	st.b	$a0, $sp, 40
	move	$a0, $s4
	beq	$a1, $a2, .LBB4_91
# %bb.87:                               # %for.body.i328.preheader
	addi.d	$a2, $sp, 39
	ori	$a3, $zero, 48
	ori	$a4, $zero, 4
	.p2align	4, , 16
.LBB4_88:                               # %for.body.i328
                                        # =>This Inner Loop Header: Depth=1
	addi.w	$a5, $a1, 0
	bstrpick.d	$a1, $a1, 31, 1
	st.b	$a3, $a2, 0
...
.LBB4_89:                               # %if.else116
	...
	jirl	$ra, $ra, 0
	b	.LBB4_130
.LBB4_90:                               # %if.end17.sink.split.i325
	pcalau12i	$a0, %pc_hi20(.Lstr)
	addi.d	$a0, $a0, %pc_lo12(.Lstr)
	pcaddu18i	$ra, %call36(puts)
	jirl	$ra, $ra, 0
...
.LBB4_94:                               # %if.end159
	...
	ori	$a0, $zero, 1
	blt	$a2, $a0, .LBB4_105
# %bb.95:                               # %for.body.i350.preheader
	addi.d	$a1, $sp, 63
	.p2align	4, , 16
.LBB4_96:                               # %for.body.i350
                                        # =>This Inner Loop Header: Depth=1
...
# %bb.97:                               # %for.end.i344
	beqz	$a3, .LBB4_99
.LBB4_98:                               # %if.end17.sink.split.i347
	pcalau12i	$a0, %pc_hi20(.Lstr)
	addi.d	$a0, $a0, %pc_lo12(.Lstr)
	pcaddu18i	$ra, %call36(puts)
	jirl	$ra, $ra, 0
.LBB4_99:                               # %SET_BITS_TO.exit362
	ld.b	$a0, $sp, 32
	ori	$a1, $zero, 2
	pcaddu18i	$ra, %call36(CHAR_TO_DIGIT)
	jirl	$ra, $ra, 0
...
.LBB4_110:                              # %if.end207
	...
	ori	$a0, $zero, 1
	blt	$a2, $a0, .LBB4_120
# %bb.111:                              # %for.body.i401.preheader
	addi.d	$a1, $sp, 55
	.p2align	4, , 16
.LBB4_112:                              # %for.body.i401
                                        # =>This Inner Loop Header: Depth=1
	bstrpick.d	$a3, $s3, 31, 31
	add.w	$a3, $s3, $a3
	srai.d	$a3, $a3, 1
...
# %bb.113:                              # %for.end.i395
	beqz	$a3, .LBB4_115
.LBB4_114:                              # %if.end17.sink.split.i398
	pcalau12i	$a0, %pc_hi20(.Lstr)
	addi.d	$a0, $a0, %pc_lo12(.Lstr)
	pcaddu18i	$ra, %call36(puts)
	jirl	$ra, $ra, 0
.LBB4_115:                              # %SET_BITS_TO.exit413
	ld.w	$a0, $sp, 28
	ori	$a1, $zero, 2
	bne	$a0, $a1, .LBB4_127
# %bb.116:                              # %if.then211
	...
	ori	$a1, $zero, 1
	blt	$a0, $a1, .LBB4_126
# %bb.117:                              # %for.body.i423.peel
	ori	$a2, $zero, 49
	st.b	$a2, $sp, 42
	beq	$a0, $a1, .LBB4_127
# %bb.118:                              # %for.body.i423.preheader
	addi.d	$a1, $sp, 41
	ori	$a2, $zero, 48
	ori	$a3, $zero, 4
	.p2align	4, , 16
.LBB4_119:                              # %for.body.i423
                                        # =>This Inner Loop Header: Depth=1
	addi.w	$a4, $a0, 0
	bstrpick.d	$a0, $a0, 31, 1
	st.b	$a2, $a1, 0
...
# %bb.125:                              # %if.else85
	move	$a2, $a0
	b	.LBB4_135
.LBB4_126:                              # %if.end17.sink.split.i420
	pcalau12i	$a0, %pc_hi20(.Lstr)
	addi.d	$a0, $a0, %pc_lo12(.Lstr)
	pcaddu18i	$ra, %call36(puts)
	jirl	$ra, $ra, 0
