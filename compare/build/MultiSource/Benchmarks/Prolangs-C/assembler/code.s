...
# %bb.11:                               # %if.then23
	...
	movfr2gr.s	$a0, $fa0
	blez	$a0, .LBB4_14
# %bb.12:                               # %for.body.i77.preheader
	addi.d	$a1, $sp, 43
	.p2align	4, , 16
.LBB4_13:                               # %for.body.i77
                                        # =>This Inner Loop Header: Depth=1
	srli.d	$a2, $s6, 1
	slli.d	$a3, $s6, 24
...
.LBB4_28:                               # %if.else33
	...
	movfr2gr.s	$a0, $fa0
	blez	$a0, .LBB4_31
# %bb.29:                               # %for.body.i99.preheader
	addi.d	$a1, $sp, 43
	.p2align	4, , 16
.LBB4_30:                               # %for.body.i99
                                        # =>This Inner Loop Header: Depth=1
	srli.d	$a2, $s6, 1
	slli.d	$a3, $s6, 24
	bstrpick.d	$s6, $s6, 31, 1
...
.LBB4_31:                               # %for.end.i93
	addi.w	$a0, $s6, 0
	beqz	$a0, .LBB4_33
# %bb.32:                               # %if.end17.sink.split.i96
	pcalau12i	$a0, %pc_hi20(.Lstr)
	addi.d	$a0, $a0, %pc_lo12(.Lstr)
	pcaddu18i	$ra, %call36(puts)
	jirl	$ra, $ra, 0
.LBB4_33:                               # %SET_BITS_TO.exit111
	ld.w	$a0, $s5, 24
	ori	$a1, $zero, 1
	beq	$a0, $a1, .LBB4_44
# %bb.34:                               # %if.then38
...
.LBB4_48:                               # %if.then106
	...
	move	$a2, $s3
	blez	$a0, .LBB4_51
# %bb.49:                               # %for.body.i155.preheader
	addi.d	$a1, $sp, 43
	move	$a2, $s3
	.p2align	4, , 16
.LBB4_50:                               # %for.body.i155
                                        # =>This Inner Loop Header: Depth=1
	...
	addi.d	$a1, $a1, -1
	bnez	$a0, .LBB4_50
.LBB4_51:                               # %for.end.i149
	beqz	$a2, .LBB4_53
# %bb.52:                               # %if.end17.sink.split.i152
	pcalau12i	$a0, %pc_hi20(.Lstr)
	addi.d	$a0, $a0, %pc_lo12(.Lstr)
	pcaddu18i	$ra, %call36(puts)
	jirl	$ra, $ra, 0
.LBB4_53:                               # %SET_BITS_TO.exit167
	ld.w	$a0, $s5, 24
	beqz	$a0, .LBB4_60
# %bb.54:                               # %if.else119
	ld.d	$s5, $sp, 72
...
# %bb.56:                               # %sw.bb
	...
	movfr2gr.s	$a0, $fa0
	blez	$a0, .LBB4_76
# %bb.57:                               # %for.body.i262.peel
	ori	$a1, $zero, 49
	bstrpick.d	$a0, $a0, 31, 1
	st.b	$a1, $sp, 38
	beqz	$a0, .LBB4_77
# %bb.58:                               # %for.body.i262.preheader
	addi.d	$a1, $sp, 37
	ori	$a2, $zero, 48
	.p2align	4, , 16
.LBB4_59:                               # %for.body.i262
                                        # =>This Inner Loop Header: Depth=1
	st.b	$a2, $a1, 0
	bstrpick.d	$a0, $a0, 31, 1
	addi.d	$a1, $a1, -1
...
.LBB4_60:                               # %if.then111
	...
	movfr2gr.s	$a0, $fa0
	blez	$a0, .LBB4_64
# %bb.61:                               # %for.body.i177.preheader
	ori	$a2, $zero, 3
	addi.d	$a1, $sp, 39
	.p2align	4, , 16
.LBB4_62:                               # %for.body.i177
                                        # =>This Inner Loop Header: Depth=1
	move	$a3, $a2
...
# %bb.63:                               # %for.end.i171
	...
	ori	$a1, $zero, 2
	bltu	$a0, $a1, .LBB4_65
.LBB4_64:                               # %if.end17.sink.split.i174
	pcalau12i	$a0, %pc_hi20(.Lstr)
	addi.d	$a0, $a0, %pc_lo12(.Lstr)
	pcaddu18i	$ra, %call36(puts)
	jirl	$ra, $ra, 0
.LBB4_65:                               # %SET_BITS_TO.exit189
	beqz	$s3, .LBB4_95
# %bb.66:                               # %if.then114
	ld.b	$a0, $sp, 32
	ori	$a1, $zero, 2
...
.LBB4_67:                               # %sw.bb123
	...
	movfr2gr.s	$a0, $fa0
	blez	$a0, .LBB4_76
# %bb.68:                               # %for.body.i284.peel
	ori	$a1, $zero, 49
	bstrpick.d	$a0, $a0, 31, 1
	st.b	$a1, $sp, 39
	beqz	$a0, .LBB4_77
# %bb.69:                               # %for.body.i284.preheader
	addi.d	$a1, $sp, 38
	ori	$a2, $zero, 48
	.p2align	4, , 16
.LBB4_70:                               # %for.body.i284
                                        # =>This Inner Loop Header: Depth=1
	st.b	$a2, $a1, 0
	bstrpick.d	$a0, $a0, 31, 1
	addi.d	$a1, $a1, -1
...
.LBB4_71:                               # %sw.default
	...
	movfr2gr.s	$a0, $fa0
	blez	$a0, .LBB4_75
# %bb.72:                               # %for.body.i306.preheader
	ori	$a2, $zero, 3
	addi.d	$a1, $sp, 39
	.p2align	4, , 16
.LBB4_73:                               # %for.body.i306
                                        # =>This Inner Loop Header: Depth=1
	move	$a3, $a2
	bstrpick.d	$a2, $a2, 31, 1
	srli.d	$a4, $a3, 1
...
# %bb.74:                               # %for.end.i300
	...
	ori	$a1, $zero, 2
	bltu	$a0, $a1, .LBB4_78
.LBB4_75:                               # %if.end17.sink.split.i303
	pcalau12i	$a0, %pc_hi20(.Lstr)
	addi.d	$a0, $a0, %pc_lo12(.Lstr)
	pcaddu18i	$ra, %call36(puts)
	jirl	$ra, $ra, 0
	b	.LBB4_78
.LBB4_76:                               # %if.end17.sink.split.i259
	pcalau12i	$a0, %pc_hi20(.Lstr)
	addi.d	$a0, $a0, %pc_lo12(.Lstr)
	pcaddu18i	$ra, %call36(puts)
	jirl	$ra, $ra, 0
	ld.d	$s5, $sp, 72
.LBB4_77:                               # %SET_BITS_TO.exit274
	addi.d	$a0, $s5, 1
	st.d	$a0, $sp, 72
.LBB4_78:                               # %sw.epilog
	addi.w	$s5, $s1, 1
...
# %bb.82:                               # %if.then140
	...
	movfr2gr.s	$a0, $fa0
	blez	$a0, .LBB4_96
# %bb.83:                               # %for.body.i328.peel
	ori	$a2, $zero, 49
	bstrpick.d	$a1, $a0, 31, 1
	st.b	$a2, $sp, 40
	move	$a0, $s4
	beqz	$a1, .LBB4_86
# %bb.84:                               # %for.body.i328.preheader
	addi.d	$a2, $sp, 39
	ori	$a3, $zero, 48
	.p2align	4, , 16
.LBB4_85:                               # %for.body.i328
                                        # =>This Inner Loop Header: Depth=1
	st.b	$a3, $a2, 0
...
.LBB4_89:                               # %if.end159
	...
	movfr2gr.s	$a0, $fa0
	blez	$a0, .LBB4_92
# %bb.90:                               # %for.body.i350.preheader
	addi.d	$a1, $sp, 63
	.p2align	4, , 16
.LBB4_91:                               # %for.body.i350
                                        # =>This Inner Loop Header: Depth=1
	...
	addi.d	$a1, $a1, -1
	bnez	$a0, .LBB4_91
.LBB4_92:                               # %for.end.i344
	beqz	$s3, .LBB4_94
# %bb.93:                               # %if.end17.sink.split.i347
	pcalau12i	$a0, %pc_hi20(.Lstr)
	addi.d	$a0, $a0, %pc_lo12(.Lstr)
	pcaddu18i	$ra, %call36(puts)
	jirl	$ra, $ra, 0
.LBB4_94:                               # %SET_BITS_TO.exit362
	ld.b	$a0, $sp, 32
	ori	$a1, $zero, 2
	pcaddu18i	$ra, %call36(CHAR_TO_DIGIT)
	jirl	$ra, $ra, 0
...
.LBB4_95:                               # %if.else116
	...
	jirl	$ra, $ra, 0
	b	.LBB4_125
.LBB4_96:                               # %if.end17.sink.split.i325
	pcalau12i	$a0, %pc_hi20(.Lstr)
	addi.d	$a0, $a0, %pc_lo12(.Lstr)
	pcaddu18i	$ra, %call36(puts)
	jirl	$ra, $ra, 0
...
# %bb.101:
	...
	b	.LBB4_105
.LBB4_102:                              # %lor.lhs.false178
	beq	$a2, $a3, .LBB4_116
# %bb.103:                              # %lor.lhs.false178
	ori	$a0, $zero, 4095
	bge	$a0, $s3, .LBB4_116
# %bb.104:
	pcalau12i	$a0, %pc_hi20(.L.str.19)
	addi.d	$a1, $a0, %pc_lo12(.L.str.19)
.LBB4_105:                              # %if.end207.sink.split
	pcalau12i	$a0, %got_pc_hi20(ERROR_REC_BUF)
	ld.d	$a0, $a0, %got_pc_lo12(ERROR_REC_BUF)
	pcaddu18i	$ra, %call36(ADD_TO_END_OF_BUFFER)
	jirl	$ra, $ra, 0
...
.LBB4_106:                              # %if.end207
	...
	movfr2gr.s	$a0, $fa0
	blez	$a0, .LBB4_109
# %bb.107:                              # %for.body.i401.preheader
	addi.d	$a1, $sp, 55
	.p2align	4, , 16
.LBB4_108:                              # %for.body.i401
                                        # =>This Inner Loop Header: Depth=1
	bstrpick.d	$a2, $s3, 31, 31
	add.w	$a2, $s3, $a2
	slli.d	$a3, $s3, 24
	...
	addi.d	$a1, $a1, -1
	bnez	$a0, .LBB4_108
.LBB4_109:                              # %for.end.i395
	beqz	$s3, .LBB4_111
# %bb.110:                              # %if.end17.sink.split.i398
	pcalau12i	$a0, %pc_hi20(.Lstr)
	addi.d	$a0, $a0, %pc_lo12(.Lstr)
	pcaddu18i	$ra, %call36(puts)
	jirl	$ra, $ra, 0
.LBB4_111:                              # %SET_BITS_TO.exit413
	ld.w	$a0, $sp, 28
	ori	$a1, $zero, 2
	bne	$a0, $a1, .LBB4_122
# %bb.112:                              # %if.then211
	...
	movfr2gr.s	$a0, $fa0
	blez	$a0, .LBB4_121
# %bb.113:                              # %for.body.i423.peel
	ori	$a1, $zero, 49
	bstrpick.d	$a0, $a0, 31, 1
	st.b	$a1, $sp, 42
	beqz	$a0, .LBB4_122
# %bb.114:                              # %for.body.i423.preheader
	addi.d	$a1, $sp, 41
	ori	$a2, $zero, 48
	.p2align	4, , 16
.LBB4_115:                              # %for.body.i423
                                        # =>This Inner Loop Header: Depth=1
	st.b	$a2, $a1, 0
	bstrpick.d	$a0, $a0, 31, 1
	addi.d	$a1, $a1, -1
...
# %bb.120:                              # %if.else85
	move	$a2, $a0
	b	.LBB4_130
.LBB4_121:                              # %if.end17.sink.split.i420
	pcalau12i	$a0, %pc_hi20(.Lstr)
	addi.d	$a0, $a0, %pc_lo12(.Lstr)
	pcaddu18i	$ra, %call36(puts)
	jirl	$ra, $ra, 0
