...
.LBB1_129:                              # %vector.ph
	...
	b	.LBB1_131
	.p2align	4, , 16
.LBB1_130:                              # %pred.store.continue242
...
# %bb.132:                              # %pred.store.if
	...
	andi	$a6, $a6, 1
	bnez	$a6, .LBB1_140
.LBB1_133:                              # %pred.store.continue230
                                        #   in Loop: Header=BB1_131 Depth=1
	xvpickve2gr.w	$a6, $xr2, 2
	andi	$a6, $a6, 1
	beqz	$a6, .LBB1_141
.LBB1_134:                              # %pred.store.if231
                                        #   in Loop: Header=BB1_131 Depth=1
	...
	andi	$a6, $a6, 1
	bnez	$a6, .LBB1_142
.LBB1_135:                              # %pred.store.continue234
                                        #   in Loop: Header=BB1_131 Depth=1
	xvpickve2gr.w	$a6, $xr2, 4
	andi	$a6, $a6, 1
	xvaddi.du	$xr3, $xr0, 1
	beqz	$a6, .LBB1_143
.LBB1_136:                              # %pred.store.if235
                                        #   in Loop: Header=BB1_131 Depth=1
	xvpickve2gr.d	$a6, $xr3, 0
	sltu	$a6, $a6, $a0
	masknez	$a7, $a3, $a6
	...
	andi	$a6, $a6, 1
	bnez	$a6, .LBB1_144
.LBB1_137:                              # %pred.store.continue238
                                        #   in Loop: Header=BB1_131 Depth=1
	xvpickve2gr.w	$a6, $xr2, 6
	andi	$a6, $a6, 1
	beqz	$a6, .LBB1_145
.LBB1_138:                              # %pred.store.if239
                                        #   in Loop: Header=BB1_131 Depth=1
	xvpickve2gr.d	$a6, $xr3, 2
	sltu	$a6, $a6, $a0
	masknez	$a7, $a3, $a6
...
.LBB1_140:                              # %pred.store.if229
	...
	andi	$a6, $a6, 1
	bnez	$a6, .LBB1_134
.LBB1_141:                              # %pred.store.continue232
                                        #   in Loop: Header=BB1_131 Depth=1
	xvpickve2gr.w	$a6, $xr2, 3
	andi	$a6, $a6, 1
	beqz	$a6, .LBB1_135
.LBB1_142:                              # %pred.store.if233
                                        #   in Loop: Header=BB1_131 Depth=1
	...
	xvaddi.du	$xr3, $xr0, 1
	bnez	$a6, .LBB1_136
.LBB1_143:                              # %pred.store.continue236
                                        #   in Loop: Header=BB1_131 Depth=1
	xvpickve2gr.w	$a6, $xr2, 5
	andi	$a6, $a6, 1
	beqz	$a6, .LBB1_137
.LBB1_144:                              # %pred.store.if237
                                        #   in Loop: Header=BB1_131 Depth=1
	xvpickve2gr.d	$a6, $xr3, 1
	sltu	$a6, $a6, $a0
	masknez	$a7, $a3, $a6
	...
	andi	$a6, $a6, 1
	bnez	$a6, .LBB1_138
.LBB1_145:                              # %pred.store.continue240
                                        #   in Loop: Header=BB1_131 Depth=1
	xvpickve2gr.w	$a6, $xr2, 7
	andi	$a6, $a6, 1
	beqz	$a6, .LBB1_130
.LBB1_146:                              # %pred.store.if241
                                        #   in Loop: Header=BB1_131 Depth=1
	xvpickve2gr.d	$a6, $xr3, 3
	sltu	$a6, $a6, $a0
	masknez	$a7, $a3, $a6
...
.LBB1_151:                              # %cleanup
	...
	jirl	$ra, $ra, 0
	b	.LBB1_157
.LBB1_152:                              # %for.body.preheader243
	pcalau12i	$a2, %got_pc_hi20(sep)
	ld.d	$a2, $a2, %got_pc_lo12(sep)
	alsl.d	$a2, $a1, $a2, 2
	addi.w	$a3, $zero, -1
