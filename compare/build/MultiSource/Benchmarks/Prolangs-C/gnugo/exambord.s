...
# %bb.4:                                # %land.lhs.true.us.us
	...
	ldx.bu	$t4, $t0, $t1
	beqz	$t4, .LBB0_8
.LBB0_5:                                # %for.inc.us.us
                                        #   in Loop: Header=BB0_3 Depth=1
	add.d	$t4, $a7, $t1
	ld.bu	$t6, $t4, 1
	add.d	$t5, $t0, $t1
	bne	$fp, $t6, .LBB0_9
.LBB0_6:                                # %land.lhs.true.us.us.1
                                        #   in Loop: Header=BB0_3 Depth=1
	ld.bu	$t6, $t5, 1
	bnez	$t6, .LBB0_9
# %bb.7:                                # %if.then16.us.us.1
                                        #   in Loop: Header=BB0_3 Depth=1
	st.b	$zero, $t4, 1
	st.w	$a1, $a3, 0
	ori	$t6, $zero, 1
...
.LBB0_8:                                # %if.then16.us.us
	...
	beq	$fp, $t6, .LBB0_6
	.p2align	4, , 16
.LBB0_9:                                # %for.inc.us.us.1
                                        #   in Loop: Header=BB0_3 Depth=1
	ld.bu	$t6, $t4, 2
	bne	$fp, $t6, .LBB0_11
# %bb.10:                               # %land.lhs.true.us.us.2
                                        #   in Loop: Header=BB0_3 Depth=1
	ld.bu	$t6, $t5, 2
	beqz	$t6, .LBB0_14
.LBB0_11:                               # %for.inc.us.us.2
                                        #   in Loop: Header=BB0_3 Depth=1
	ld.bu	$t6, $t4, 3
	bne	$fp, $t6, .LBB0_15
.LBB0_12:                               # %land.lhs.true.us.us.3
                                        #   in Loop: Header=BB0_3 Depth=1
	ld.bu	$t6, $t5, 3
	bnez	$t6, .LBB0_15
# %bb.13:                               # %if.then16.us.us.3
                                        #   in Loop: Header=BB0_3 Depth=1
	st.b	$zero, $t4, 3
	st.w	$a1, $a3, 0
	ori	$t6, $zero, 3
...
.LBB0_14:                               # %if.then16.us.us.2
	...
	beq	$fp, $t6, .LBB0_12
	.p2align	4, , 16
.LBB0_15:                               # %for.inc.us.us.3
                                        #   in Loop: Header=BB0_3 Depth=1
	ld.bu	$t6, $t4, 4
	bne	$fp, $t6, .LBB0_17
# %bb.16:                               # %land.lhs.true.us.us.4
                                        #   in Loop: Header=BB0_3 Depth=1
	ld.bu	$t6, $t5, 4
	beqz	$t6, .LBB0_20
.LBB0_17:                               # %for.inc.us.us.4
                                        #   in Loop: Header=BB0_3 Depth=1
	ld.bu	$t6, $t4, 5
	bne	$fp, $t6, .LBB0_21
.LBB0_18:                               # %land.lhs.true.us.us.5
                                        #   in Loop: Header=BB0_3 Depth=1
	ld.bu	$t6, $t5, 5
	bnez	$t6, .LBB0_21
# %bb.19:                               # %if.then16.us.us.5
                                        #   in Loop: Header=BB0_3 Depth=1
	st.b	$zero, $t4, 5
	st.w	$a1, $a3, 0
	ori	$t6, $zero, 5
...
.LBB0_20:                               # %if.then16.us.us.4
	...
	beq	$fp, $t6, .LBB0_18
	.p2align	4, , 16
.LBB0_21:                               # %for.inc.us.us.5
                                        #   in Loop: Header=BB0_3 Depth=1
	ld.bu	$t6, $t4, 6
	bne	$fp, $t6, .LBB0_23
# %bb.22:                               # %land.lhs.true.us.us.6
                                        #   in Loop: Header=BB0_3 Depth=1
	ld.bu	$t6, $t5, 6
	beqz	$t6, .LBB0_26
.LBB0_23:                               # %for.inc.us.us.6
                                        #   in Loop: Header=BB0_3 Depth=1
	ld.bu	$t6, $t4, 7
	bne	$fp, $t6, .LBB0_27
.LBB0_24:                               # %land.lhs.true.us.us.7
                                        #   in Loop: Header=BB0_3 Depth=1
	ld.bu	$t6, $t5, 7
	bnez	$t6, .LBB0_27
# %bb.25:                               # %if.then16.us.us.7
                                        #   in Loop: Header=BB0_3 Depth=1
	st.b	$zero, $t4, 7
	st.w	$a1, $a3, 0
	st.w	$t8, $a4, 0
...
.LBB0_26:                               # %if.then16.us.us.6
	...
	beq	$fp, $t6, .LBB0_24
	.p2align	4, , 16
.LBB0_27:                               # %for.inc.us.us.7
                                        #   in Loop: Header=BB0_3 Depth=1
	ld.bu	$t6, $t4, 8
	bne	$fp, $t6, .LBB0_29
# %bb.28:                               # %land.lhs.true.us.us.8
                                        #   in Loop: Header=BB0_3 Depth=1
	ld.bu	$t6, $t5, 8
	beqz	$t6, .LBB0_32
.LBB0_29:                               # %for.inc.us.us.8
                                        #   in Loop: Header=BB0_3 Depth=1
	ld.bu	$t6, $t4, 9
	bne	$fp, $t6, .LBB0_33
.LBB0_30:                               # %land.lhs.true.us.us.9
                                        #   in Loop: Header=BB0_3 Depth=1
	ld.bu	$t6, $t5, 9
	bnez	$t6, .LBB0_33
# %bb.31:                               # %if.then16.us.us.9
                                        #   in Loop: Header=BB0_3 Depth=1
	st.b	$zero, $t4, 9
	st.w	$a1, $a3, 0
	st.w	$s1, $a4, 0
...
.LBB0_32:                               # %if.then16.us.us.8
	...
	beq	$fp, $t6, .LBB0_30
	.p2align	4, , 16
.LBB0_33:                               # %for.inc.us.us.9
                                        #   in Loop: Header=BB0_3 Depth=1
	ld.bu	$t6, $t4, 10
	bne	$fp, $t6, .LBB0_35
# %bb.34:                               # %land.lhs.true.us.us.10
                                        #   in Loop: Header=BB0_3 Depth=1
	ld.bu	$t6, $t5, 10
	beqz	$t6, .LBB0_38
.LBB0_35:                               # %for.inc.us.us.10
                                        #   in Loop: Header=BB0_3 Depth=1
	ld.bu	$t6, $t4, 11
	bne	$fp, $t6, .LBB0_39
.LBB0_36:                               # %land.lhs.true.us.us.11
                                        #   in Loop: Header=BB0_3 Depth=1
	ld.bu	$t6, $t5, 11
	bnez	$t6, .LBB0_39
# %bb.37:                               # %if.then16.us.us.11
                                        #   in Loop: Header=BB0_3 Depth=1
	st.b	$zero, $t4, 11
	st.w	$a1, $a3, 0
	st.w	$s3, $a4, 0
...
.LBB0_38:                               # %if.then16.us.us.10
	...
	beq	$fp, $t6, .LBB0_36
	.p2align	4, , 16
.LBB0_39:                               # %for.inc.us.us.11
                                        #   in Loop: Header=BB0_3 Depth=1
	ld.bu	$t6, $t4, 12
	bne	$fp, $t6, .LBB0_41
# %bb.40:                               # %land.lhs.true.us.us.12
                                        #   in Loop: Header=BB0_3 Depth=1
	ld.bu	$t6, $t5, 12
	beqz	$t6, .LBB0_44
.LBB0_41:                               # %for.inc.us.us.12
                                        #   in Loop: Header=BB0_3 Depth=1
	ld.bu	$t6, $t4, 13
	bne	$fp, $t6, .LBB0_45
.LBB0_42:                               # %land.lhs.true.us.us.13
                                        #   in Loop: Header=BB0_3 Depth=1
	ld.bu	$t6, $t5, 13
	bnez	$t6, .LBB0_45
# %bb.43:                               # %if.then16.us.us.13
                                        #   in Loop: Header=BB0_3 Depth=1
	st.b	$zero, $t4, 13
	st.w	$a1, $a3, 0
	st.w	$s5, $a4, 0
...
.LBB0_44:                               # %if.then16.us.us.12
	...
	beq	$fp, $t6, .LBB0_42
	.p2align	4, , 16
.LBB0_45:                               # %for.inc.us.us.13
                                        #   in Loop: Header=BB0_3 Depth=1
	ld.bu	$t6, $t4, 14
	bne	$fp, $t6, .LBB0_47
# %bb.46:                               # %land.lhs.true.us.us.14
                                        #   in Loop: Header=BB0_3 Depth=1
	ld.bu	$t6, $t5, 14
	beqz	$t6, .LBB0_50
.LBB0_47:                               # %for.inc.us.us.14
                                        #   in Loop: Header=BB0_3 Depth=1
	ld.bu	$t6, $t4, 15
	bne	$fp, $t6, .LBB0_51
.LBB0_48:                               # %land.lhs.true.us.us.15
                                        #   in Loop: Header=BB0_3 Depth=1
	ld.bu	$t6, $t5, 15
	bnez	$t6, .LBB0_51
# %bb.49:                               # %if.then16.us.us.15
                                        #   in Loop: Header=BB0_3 Depth=1
	st.b	$zero, $t4, 15
	st.w	$a1, $a3, 0
	st.w	$s7, $a4, 0
...
.LBB0_50:                               # %if.then16.us.us.14
	...
	beq	$fp, $t6, .LBB0_48
	.p2align	4, , 16
.LBB0_51:                               # %for.inc.us.us.15
                                        #   in Loop: Header=BB0_3 Depth=1
	ld.bu	$t6, $t4, 16
	bne	$fp, $t6, .LBB0_53
# %bb.52:                               # %land.lhs.true.us.us.16
                                        #   in Loop: Header=BB0_3 Depth=1
	ld.bu	$t6, $t5, 16
	beqz	$t6, .LBB0_56
.LBB0_53:                               # %for.inc.us.us.16
                                        #   in Loop: Header=BB0_3 Depth=1
	ld.bu	$t6, $t4, 17
	bne	$fp, $t6, .LBB0_57
.LBB0_54:                               # %land.lhs.true.us.us.17
                                        #   in Loop: Header=BB0_3 Depth=1
	ld.bu	$t6, $t5, 17
	bnez	$t6, .LBB0_57
# %bb.55:                               # %if.then16.us.us.17
                                        #   in Loop: Header=BB0_3 Depth=1
	st.b	$zero, $t4, 17
	st.w	$a1, $a3, 0
	st.w	$ra, $a4, 0
...
.LBB0_56:                               # %if.then16.us.us.16
	...
	beq	$fp, $t6, .LBB0_54
	.p2align	4, , 16
.LBB0_57:                               # %for.inc.us.us.17
                                        #   in Loop: Header=BB0_3 Depth=1
	ld.bu	$t6, $t4, 18
	bne	$fp, $t6, .LBB0_2
# %bb.58:                               # %land.lhs.true.us.us.18
                                        #   in Loop: Header=BB0_3 Depth=1
	ld.bu	$t5, $t5, 18
	bnez	$t5, .LBB0_2
# %bb.59:                               # %if.then16.us.us.18
                                        #   in Loop: Header=BB0_3 Depth=1
	st.b	$zero, $t4, 18
	st.w	$a1, $a3, 0
	st.w	$t2, $a4, 0
