...
# %bb.1:                                # %for.cond2.preheader.us.preheader
	...
	ld.d	$a5, $a1, %got_pc_lo12(mik)
	move	$a1, $a0
	pcalau12i	$a6, %got_pc_hi20(mjk)
	ld.d	$a6, $a6, %got_pc_lo12(mjk)
	pcalau12i	$a7, %got_pc_hi20(mk)
	ld.d	$a7, $a7, %got_pc_lo12(mk)
	lu32i.d	$a1, 0
	st.w	$a1, $a5, 0
	st.w	$a1, $a6, 0
	ld.w	$t0, $a7, 0
	pcalau12i	$a1, %got_pc_hi20(p)
	ld.d	$t1, $a1, %got_pc_lo12(p)
	pcalau12i	$a1, %got_pc_hi20(l)
	ld.d	$a1, $a1, %got_pc_lo12(l)
	ori	$t8, $zero, 7
	ori	$s0, $zero, 8
	ori	$s1, $zero, 9
	ori	$s2, $zero, 10
...
.LBB0_60:                               # %for.cond2.preheader.preheader
	...
	ld.d	$a5, $a1, %got_pc_lo12(uik)
	move	$a1, $a0
	pcalau12i	$a6, %got_pc_hi20(ujk)
	ld.d	$a6, $a6, %got_pc_lo12(ujk)
	pcalau12i	$a7, %got_pc_hi20(uk)
	ld.d	$a7, $a7, %got_pc_lo12(uk)
	lu32i.d	$a1, 0
	st.w	$a1, $a5, 0
	st.w	$a1, $a6, 0
	ld.w	$t0, $a7, 0
...
# %bb.120:                              # %if.end44.sink.split
	...
	pcalau12i	$a4, %got_pc_hi20(uik)
	ld.d	$a4, $a4, %got_pc_lo12(uik)
	pcalau12i	$a5, %got_pc_hi20(mik)
	ld.d	$a5, $a5, %got_pc_lo12(mik)
	maskeqz	$a3, $a3, $a2
	or	$a1, $a3, $a1
	masknez	$a3, $a4, $a2
	maskeqz	$a2, $a5, $a2
