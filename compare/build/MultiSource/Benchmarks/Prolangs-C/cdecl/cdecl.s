...
.LBB17_27:                              # %if.then55
	...
	bne	$a0, $a7, .LBB17_29
# %bb.28:                               # %for.end.sink.split.sink.split
                                        #   in Loop: Header=BB17_4 Depth=1
	ld.w	$a1, $s4, %pc_lo12(yylineno)
	addi.d	$a1, $a1, -1
	st.w	$a1, $s4, %pc_lo12(yylineno)
.LBB17_29:                              # %for.end.sink.split
                                        #   in Loop: Header=BB17_4 Depth=1
...
.LBB17_40:                              # %cond.false242
	...
	st.w	$a0, $s1, %pc_lo12(yytchar)
	bne	$a0, $a7, .LBB17_42
.LBB17_41:                              # %cond.true248
                                        #   in Loop: Header=BB17_4 Depth=1
	ld.w	$a1, $s4, %pc_lo12(yylineno)
	addi.d	$a1, $a1, 1
	st.w	$a1, $s4, %pc_lo12(yylineno)
.LBB17_42:                              # %cond.end251
                                        #   in Loop: Header=BB17_4 Depth=1
	move	$a1, $zero
	move	$t3, $zero
	addi.d	$a2, $a0, 1
...
.LBB17_44:                              # %if.then192
	...
	ldx.bu	$a0, $a0, $a4
	pcalau12i	$a5, %pc_hi20(yyolsp)
	st.d	$a1, $a5, %pc_lo12(yyolsp)
	beqz	$a0, .LBB17_54
# %bb.45:                               # %while.cond197.preheader
	ori	$a0, $zero, 10
	move	$a5, $a3
...
.LBB17_46:                              # %if.end212
	...
	ld.w	$a4, $a3, 0
	addi.d	$s6, $s6, -1
.LBB17_47:                              # %while.cond197
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB17_49 Depth 2
	beqz	$a5, .LBB17_51
# %bb.48:                               # %while.cond.i.preheader
                                        #   in Loop: Header=BB17_47 Depth=1
	sub.w	$a4, $zero, $a4
	.p2align	4, , 16
.LBB17_49:                              # %while.cond.i
                                        #   Parent Loop BB17_47 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$a6, $a5, 0
	beqz	$a6, .LBB17_51
# %bb.50:                               # %while.body.i
                                        #   in Loop: Header=BB17_49 Depth=2
	addi.d	$a5, $a5, 4
	bne	$a6, $a4, .LBB17_49
	b	.LBB17_55
	.p2align	4, , 16
.LBB17_51:                              # %yyback.exit
                                        #   in Loop: Header=BB17_47 Depth=1
	bgeu	$s3, $a1, .LBB17_55
# %bb.52:                               # %while.body204
                                        #   in Loop: Header=BB17_47 Depth=1
