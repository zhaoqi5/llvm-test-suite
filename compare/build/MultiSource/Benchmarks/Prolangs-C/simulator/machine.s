...
# %bb.0:                                # %entry
	...
	ld.w	$a2, $s4, %pc_lo12(REGISTER+32)
	st.d	$a1, $sp, 32                    # 8-byte Folded Spill
	move	$s0, $a0
	pcalau12i	$s5, %pc_hi20(MEMORY)
	addi.w	$s6, $zero, -16
	pcalau12i	$a0, %pc_hi20(INSTR)
	addi.d	$s7, $a0, %pc_lo12(INSTR)
	...
	lu12i.w	$a0, 4095
	ori	$s2, $a0, 4095
	pcalau12i	$a0, %got_pc_hi20(RETURN_STATUS)
	ld.d	$s8, $a0, %got_pc_lo12(RETURN_STATUS)
...
.LBB14_9:                               # %if.else25
                                        #   in Loop: Header=BB14_3 Depth=1
	ld.w	$a0, $s1, %pc_lo12(INTERVAL_TIMER)
	blez	$a0, .LBB14_2
# %bb.10:                               # %if.then27
                                        #   in Loop: Header=BB14_3 Depth=1
	addi.w	$a0, $a0, -1
	st.w	$a0, $s1, %pc_lo12(INTERVAL_TIMER)
	bnez	$a0, .LBB14_2
# %bb.11:                               # %if.then29
                                        #   in Loop: Header=BB14_3 Depth=1
	ori	$a0, $zero, 3
