...
# %bb.6:                                # %if.then
	pcalau12i	$a0, %pc_hi20(NUM_BREAK_POINTS)
	ld.w	$a2, $a0, %pc_lo12(NUM_BREAK_POINTS)
	bge	$a3, $a2, .LBB6_10
# %bb.7:                                # %if.else
	beqz	$a4, .LBB6_11
# %bb.8:                                # %if.then5
...
.LBB6_11:                               # %if.else7
	pcalau12i	$a1, %pc_hi20(BREAK_POINTS)
	addi.d	$a1, $a1, %pc_lo12(BREAK_POINTS)
	slli.d	$a4, $a3, 2
	ldx.w	$a4, $a1, $a4
	addi.w	$a6, $zero, -1
	beq	$a4, $a6, .LBB6_23
# %bb.12:                               # %for.cond.preheader
	alsl.d	$t1, $a3, $a1, 2
	addi.d	$a7, $a2, 1
	pcalau12i	$a1, %pc_hi20(SORTED_BREAK_POINTS)
	addi.d	$a1, $a1, %pc_lo12(SORTED_BREAK_POINTS)
	move	$t2, $zero
	move	$a4, $zero
	addi.d	$a5, $a1, 20
...
# %bb.19:                               # %middle.block
	beq	$a7, $t1, .LBB6_22
.LBB6_20:                               # %for.body23.preheader23
	alsl.d	$a1, $a4, $a1, 2
	addi.d	$a1, $a1, 4
	sub.d	$a4, $a6, $a4
	.p2align	4, , 16
...
.LBB6_22:                               # %for.end30
	addi.d	$a1, $a2, -1
	st.w	$a1, $a0, %pc_lo12(NUM_BREAK_POINTS)
...
# %bb.4:                                # %while.cond.i
	bnez	$a3, .LBB13_7
# %bb.5:                                # %if.else
	pcalau12i	$a0, %pc_hi20(TRACE)
	ld.w	$a1, $a0, %pc_lo12(TRACE)
	beqz	$a1, .LBB13_8
# %bb.6:                                # %if.then2
