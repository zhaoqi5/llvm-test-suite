...
# %bb.0:                                # %entry
	...
	pcalau12i	$a2, %pc_hi20(definesflag)
	pcalau12i	$a1, %got_pc_hi20(fixed_outfiles)
	ld.d	$a1, $a1, %got_pc_lo12(fixed_outfiles)
	st.d	$a2, $sp, 24                    # 8-byte Folded Spill
	st.w	$zero, $a2, %pc_lo12(definesflag)
	pcalau12i	$a2, %pc_hi20(debugflag)
	st.d	$a2, $sp, 16                    # 8-byte Folded Spill
	st.w	$zero, $a2, %pc_lo12(debugflag)
	move	$s5, $a1
	st.w	$zero, $a1, 0
	addi.d	$a1, $a0, 1
	ori	$a2, $zero, 47
...
.LBB0_7:                                # %while.cond5.preheader
	...
	pcalau12i	$a1, %got_pc_hi20(spec_outfile)
	ld.d	$s7, $a1, %got_pc_lo12(spec_outfile)
	addi.d	$s2, $a0, %pc_lo12(.LJTI0_0)
	ori	$s3, $zero, 1
	pcalau12i	$s4, %pc_hi20(nolinesflag)
	b	.LBB0_9
.LBB0_8:                                # %sw.bb10
                                        #   in Loop: Header=BB0_9 Depth=1
	ld.d	$a0, $sp, 32                    # 8-byte Folded Reload
	st.w	$s3, $a0, %pc_lo12(verboseflag)
	.p2align	4, , 16
.LBB0_9:                                # %while.cond5
                                        # =>This Inner Loop Header: Depth=1
	move	$a0, $fp
...
.LBB0_11:                               # %sw.bb11
	...
	st.w	$s3, $a0, %pc_lo12(definesflag)
	b	.LBB0_9
.LBB0_12:                               # %sw.bb14
                                        #   in Loop: Header=BB0_9 Depth=1
	ld.d	$a0, $s8, 0
...
.LBB0_13:                               # %sw.bb13
	...
	st.w	$s3, $a0, %pc_lo12(debugflag)
	b	.LBB0_9
.LBB0_14:                               # %sw.bb12
                                        #   in Loop: Header=BB0_9 Depth=1
	st.w	$s3, $s4, %pc_lo12(nolinesflag)
	b	.LBB0_9
.LBB0_15:                               # %sw.bb
                                        #   in Loop: Header=BB0_9 Depth=1
	st.w	$s3, $s5, 0
