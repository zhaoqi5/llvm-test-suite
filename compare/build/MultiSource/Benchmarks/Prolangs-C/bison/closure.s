...
# %bb.32:                               # %middle.block105
	beq	$a2, $a5, .LBB3_39
# %bb.33:                               # %vec.epilog.iter.check110
	andi	$a4, $a2, 12
	beqz	$a4, .LBB3_37
.LBB3_34:                               # %vec.epilog.ph109
	...
	sub.d	$a3, $a5, $a6
	.p2align	4, , 16
.LBB3_35:                               # %vec.epilog.vector.body115
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a1, 0
	vst	$vr0, $a7, 0
	addi.d	$a7, $a7, 16
	...
	addi.d	$a1, $a1, 16
	bnez	$a3, .LBB3_35
# %bb.36:                               # %vec.epilog.middle.block123
	bne	$a2, $a6, .LBB3_38
	b	.LBB3_39
.LBB3_37:
	alsl.d	$a0, $a5, $a0, 2
...
.LBB3_56:                               # %vector.body140
	...
	addi.d	$a0, $a0, 64
	bnez	$a6, .LBB3_56
# %bb.57:                               # %middle.block149
	bne	$a4, $a5, .LBB3_59
	b	.LBB3_61
.LBB3_58:
	move	$a1, $a0
	move	$a2, $a3
.LBB3_59:                               # %while.body66.preheader153
	move	$a0, $a2
	.p2align	4, , 16
