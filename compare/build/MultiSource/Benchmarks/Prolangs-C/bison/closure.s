...
# %bb.3:                                # %while.body14.us.preheader
	...
	bstrpick.d	$a7, $a5, 62, 2
	slli.d	$t2, $a7, 2
	slli.d	$t3, $a7, 4
	alsl.d	$t4, $a7, $s1, 4
	sub.d	$t7, $zero, $t2
	pcalau12i	$a7, %got_pc_hi20(ntokens)
	ld.d	$t8, $a7, %got_pc_lo12(ntokens)
	ori	$s2, $zero, 12
	ori	$s6, $zero, 60
	move	$s7, $fp
	b	.LBB3_5
...
# %bb.27:
	move	$a4, $s1
	b	.LBB3_37
.LBB3_28:                               # %vector.main.loop.iter.check94
	srli.d	$a2, $a4, 2
	ori	$a5, $zero, 60
	addi.d	$a2, $a2, 1
	bgeu	$a4, $a5, .LBB3_30
...
.LBB3_31:                               # %vector.body98
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB3_31
# %bb.32:                               # %middle.block105
	beq	$a2, $a5, .LBB3_38
# %bb.33:                               # %vec.epilog.iter.check109
	beqz	$a4, .LBB3_61
.LBB3_34:                               # %vec.epilog.ph111
...
.LBB3_37:                               # %while.body
	...
	move	$a4, $a2
	bltu	$a2, $s4, .LBB3_37
.LBB3_38:                               # %while.body34.preheader
	pcalau12i	$a0, %pc_hi20(itemset)
	...
	b	.LBB3_40
	.p2align	4, , 16
.LBB3_39:                               # %if.end61.loopexit
                                        #   in Loop: Header=BB3_40 Depth=1
	bgeu	$s1, $s4, .LBB3_51
.LBB3_40:                               # %while.body34
                                        # =>This Loop Header: Depth=1
...
.LBB3_50:                               # %if.then38
	...
	addi.d	$a3, $a3, 32
	bltu	$s1, $s4, .LBB3_40
.LBB3_51:                               # %while.cond63.preheader.loopexit
	ld.d	$a3, $a1, %pc_lo12(itemsetend)
	bgeu	$a0, $s3, .LBB3_60
.LBB3_52:                               # %while.body66.preheader
	slli.d	$a1, $s0, 1
	add.d	$a1, $a1, $fp
	addi.d	$a2, $a0, 2
	sltu	$a4, $a2, $a1
...
.LBB3_58:                               # %while.body66
	...
	move	$a2, $a3
	bltu	$a3, $s3, .LBB3_58
.LBB3_59:                               # %while.cond63.while.end69_crit_edge
	pcalau12i	$a0, %pc_hi20(itemsetend)
