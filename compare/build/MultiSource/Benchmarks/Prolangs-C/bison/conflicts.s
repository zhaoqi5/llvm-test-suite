...
.LBB6_42:                               # %cleanup
	...
	addi.d	$sp, $sp, 128
	ret
.LBB6_43:                               # %vector.main.loop.iter.check89
	srli.d	$a4, $a5, 2
	ori	$a6, $zero, 60
	addi.d	$a4, $a4, 1
	bgeu	$a5, $a6, .LBB6_45
...
.LBB6_46:                               # %vector.body93
	...
	addi.d	$a6, $a6, 64
	bnez	$t0, .LBB6_46
# %bb.47:                               # %middle.block102
	beq	$a4, $a7, .LBB6_37
# %bb.48:                               # %vec.epilog.iter.check107
	andi	$a5, $a4, 12
	beqz	$a5, .LBB6_52
.LBB6_49:                               # %vec.epilog.ph106
	...
	sub.d	$a7, $a7, $t0
	.p2align	4, , 16
.LBB6_50:                               # %vec.epilog.vector.body112
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a3, 0
	vld	$vr1, $t1, 0
	vand.v	$vr0, $vr1, $vr0
	...
	addi.d	$t1, $t1, 16
	bnez	$a7, .LBB6_50
# %bb.51:                               # %vec.epilog.middle.block121
	bne	$a4, $t0, .LBB6_36
	b	.LBB6_37
.LBB6_52:
	alsl.d	$a5, $a7, $a0, 2
...
# %bb.46:                               # %iter.check243
	...
	move	$s0, $t1
	bnez	$s1, .LBB10_61
# %bb.47:                               # %vector.main.loop.iter.check245
                                        #   in Loop: Header=BB10_36 Depth=1
	ori	$fp, $zero, 60
	bgeu	$t3, $fp, .LBB10_54
...
.LBB10_50:                              # %vector.memcheck283
	...
	ori	$s2, $zero, 64
	bltu	$s1, $s2, .LBB10_38
# %bb.51:                               # %vector.memcheck283
                                        #   in Loop: Header=BB10_36 Depth=1
	ld.d	$s1, $sp, 96                    # 8-byte Folded Reload
	bltu	$s1, $s2, .LBB10_38
# %bb.52:                               # %vector.main.loop.iter.check291
                                        #   in Loop: Header=BB10_36 Depth=1
	mul.d	$s0, $s7, $s0
	ori	$s1, $zero, 60
	bgeu	$t3, $s1, .LBB10_62
# %bb.53:                               #   in Loop: Header=BB10_36 Depth=1
	move	$s4, $zero
	b	.LBB10_66
.LBB10_54:                              # %vector.body249.preheader
                                        #   in Loop: Header=BB10_36 Depth=1
	move	$fp, $t6
	ld.d	$s0, $sp, 72                    # 8-byte Folded Reload
	ld.d	$s1, $sp, 80                    # 8-byte Folded Reload
	.p2align	4, , 16
.LBB10_55:                              # %vector.body249
                                        #   Parent Loop BB10_36 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	xvld	$xr2, $s0, -32
	xvld	$xr3, $s0, 0
	...
	addi.d	$s0, $s0, 64
	bnez	$fp, .LBB10_55
# %bb.56:                               # %middle.block258
                                        #   in Loop: Header=BB10_36 Depth=1
	beq	$t4, $t6, .LBB10_35
# %bb.57:                               # %vec.epilog.iter.check263
                                        #   in Loop: Header=BB10_36 Depth=1
	move	$s1, $t6
	...
	beqz	$s2, .LBB10_61
.LBB10_58:                              # %vec.epilog.ph262
                                        #   in Loop: Header=BB10_36 Depth=1
	alsl.d	$fp, $s1, $t1, 2
	alsl.d	$s0, $s1, $a5, 2
	add.d	$s1, $s5, $s1
	.p2align	4, , 16
.LBB10_59:                              # %vec.epilog.vector.body268
                                        #   Parent Loop BB10_36 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr2, $s0, 0
	vld	$vr3, $fp, 0
	...
	addi.d	$s0, $s0, 16
	bnez	$s1, .LBB10_59
# %bb.60:                               # %vec.epilog.middle.block277
                                        #   in Loop: Header=BB10_36 Depth=1
...
.LBB10_61:                              # %while.body159
	...
	bltu	$s4, $a7, .LBB10_61
	b	.LBB10_35
.LBB10_62:                              # %vector.body295.preheader
                                        #   in Loop: Header=BB10_36 Depth=1
...
.LBB10_63:                              # %vector.body295
	...
	addi.d	$s1, $s1, 64
	bnez	$s2, .LBB10_63
# %bb.64:                               # %middle.block305
                                        #   in Loop: Header=BB10_36 Depth=1
	beq	$t4, $t6, .LBB10_40
# %bb.65:                               # %vec.epilog.iter.check310
                                        #   in Loop: Header=BB10_36 Depth=1
	move	$s4, $t6
	ld.d	$s1, $sp, 64                    # 8-byte Folded Reload
	beqz	$s1, .LBB10_69
.LBB10_66:                              # %vec.epilog.ph309
                                        #   in Loop: Header=BB10_36 Depth=1
	...
	add.d	$s4, $s5, $s4
	.p2align	4, , 16
.LBB10_67:                              # %vec.epilog.vector.body315
                                        #   Parent Loop BB10_36 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr2, $s1, 0
	vld	$vr3, $s0, 0
	...
	addi.d	$s0, $s0, 16
	bnez	$s4, .LBB10_67
# %bb.68:                               # %vec.epilog.middle.block326
                                        #   in Loop: Header=BB10_36 Depth=1
