...
# %bb.22:                               # %for.body61.us.preheader
	...
	addi.d	$a5, $a5, 1
	andi	$a6, $a5, 12
	bstrpick.d	$t0, $a5, 62, 4
	slli.d	$a7, $t0, 4
	slli.d	$t0, $t0, 6
	add.d	$t1, $a1, $t0
	st.d	$t1, $sp, 16                    # 8-byte Folded Spill
	bstrpick.d	$t1, $a5, 62, 2
	slli.d	$t2, $t1, 2
	slli.d	$t3, $t1, 4
	alsl.d	$t4, $t1, $a1, 4
	addi.d	$t1, $a1, 32
...
# %bb.2:                                # %for.body.lr.ph
	...
	ld.d	$t0, $a2, %pc_lo12(lookaheadset)
	move	$t1, $zero
	.p2align	4, , 16
.LBB6_3:                                # %for.body
                                        # =>This Inner Loop Header: Depth=1
...
# %bb.47:                               # %middle.block106
	beq	$a4, $a7, .LBB6_37
# %bb.48:                               # %vec.epilog.iter.check110
	beqz	$a5, .LBB6_52
.LBB6_49:                               # %vec.epilog.ph112
	...
	sub.d	$a7, $a7, $t0
	.p2align	4, , 16
.LBB6_50:                               # %vec.epilog.vector.body115
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a3, 0
	vld	$vr1, $t1, 0
	vand.v	$vr0, $vr1, $vr0
	...
	addi.d	$t1, $t1, 16
	bnez	$a7, .LBB6_50
# %bb.51:                               # %vec.epilog.middle.block124
	bne	$a4, $t0, .LBB6_36
	b	.LBB6_37
.LBB6_52:
	alsl.d	$a5, $a7, $a0, 2
...
.LBB10_34:                              # %for.body118.lr.ph
	...
	addi.d	$t6, $zero, -1
	pcalau12i	$a0, %got_pc_hi20(ntokens)
	ld.d	$t4, $a0, %got_pc_lo12(ntokens)
	move	$t3, $zero
	move	$s3, $zero
	ori	$s5, $zero, 1
	move	$a0, $fp
...
.LBB10_50:                              # %vector.memcheck290
	...
	ori	$s2, $zero, 64
	bltu	$s0, $s2, .LBB10_38
# %bb.51:                               # %vector.memcheck290
                                        #   in Loop: Header=BB10_36 Depth=1
	ld.d	$s0, $sp, 64                    # 8-byte Folded Reload
	bltu	$s0, $s2, .LBB10_38
# %bb.52:                               # %vector.main.loop.iter.check298
                                        #   in Loop: Header=BB10_36 Depth=1
	mul.d	$fp, $t7, $fp
	ori	$s0, $zero, 60
	bgeu	$t1, $s0, .LBB10_62
...
# %bb.56:                               # %middle.block266
                                        #   in Loop: Header=BB10_36 Depth=1
	beq	$t2, $t5, .LBB10_35
# %bb.57:                               # %vec.epilog.iter.check270
                                        #   in Loop: Header=BB10_36 Depth=1
	move	$s1, $t5
	ld.d	$fp, $sp, 32                    # 8-byte Folded Reload
	...
	beqz	$s2, .LBB10_61
.LBB10_58:                              # %vec.epilog.ph272
                                        #   in Loop: Header=BB10_36 Depth=1
	alsl.d	$fp, $s1, $a7, 2
	alsl.d	$s0, $s1, $a4, 2
	add.d	$s1, $t8, $s1
	.p2align	4, , 16
.LBB10_59:                              # %vec.epilog.vector.body275
                                        #   Parent Loop BB10_36 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $s0, 0
	vld	$vr1, $fp, 0
	...
	addi.d	$s0, $s0, 16
	bnez	$s1, .LBB10_59
# %bb.60:                               # %vec.epilog.middle.block284
                                        #   in Loop: Header=BB10_36 Depth=1
...
.LBB10_61:                              # %while.body159
	...
	bltu	$s6, $a5, .LBB10_61
	b	.LBB10_35
.LBB10_62:                              # %vector.body302.preheader
                                        #   in Loop: Header=BB10_36 Depth=1
	addi.d	$s0, $a6, 32
	add.d	$s0, $s0, $fp
	move	$s2, $t5
...
.LBB10_63:                              # %vector.body302
	...
	addi.d	$s0, $s0, 64
	bnez	$s2, .LBB10_63
# %bb.64:                               # %middle.block312
                                        #   in Loop: Header=BB10_36 Depth=1
	beq	$t2, $t5, .LBB10_40
# %bb.65:                               # %vec.epilog.iter.check316
                                        #   in Loop: Header=BB10_36 Depth=1
	move	$s6, $t5
	ld.d	$s0, $sp, 48                    # 8-byte Folded Reload
	beqz	$s0, .LBB10_69
.LBB10_66:                              # %vec.epilog.ph318
                                        #   in Loop: Header=BB10_36 Depth=1
	...
	add.d	$s6, $t8, $s6
	.p2align	4, , 16
.LBB10_67:                              # %vec.epilog.vector.body321
                                        #   Parent Loop BB10_36 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $fp, 0
	vld	$vr1, $s0, 0
	...
	addi.d	$fp, $fp, 16
	bnez	$s6, .LBB10_67
# %bb.68:                               # %vec.epilog.middle.block332
                                        #   in Loop: Header=BB10_36 Depth=1
	ld.d	$fp, $sp, 88                    # 8-byte Folded Reload
	move	$s0, $s7
	bne	$t2, $s4, .LBB10_39
...
# %bb.87:                               # %for.body217.lr.ph
	...
	pcalau12i	$a1, %got_pc_hi20(LAruleno)
	ld.d	$s1, $a1, %got_pc_lo12(LAruleno)
	move	$s6, $zero
	ori	$s7, $zero, 1
	b	.LBB10_90
	.p2align	4, , 16
