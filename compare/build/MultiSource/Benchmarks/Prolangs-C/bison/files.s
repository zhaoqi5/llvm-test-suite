...
.LBB1_22:
	move	$a1, $s1
	move	$a0, $s0
.LBB1_23:                               # %for.body.i.preheader349
	sub.d	$a2, $fp, $a2
	move	$a3, $a0
	.p2align	4, , 16
.LBB1_24:                               # %for.body.i
...
.LBB1_32:                               # %vector.body247
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB1_32
# %bb.33:                               # %middle.block254
	bne	$a3, $s2, .LBB1_35
	b	.LBB1_37
.LBB1_34:
	move	$a2, $s0
	move	$a1, $a0
.LBB1_35:                               # %for.body.i56.preheader348
	sub.d	$a3, $fp, $a3
	move	$a4, $a1
	.p2align	4, , 16
...
.LBB1_43:                               # %vector.body267
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB1_43
# %bb.44:                               # %middle.block274
	bne	$a3, $s5, .LBB1_46
	b	.LBB1_48
.LBB1_45:
	move	$a2, $s0
	move	$a1, $a0
.LBB1_46:                               # %for.body.i78.preheader347
	sub.d	$a3, $s1, $a3
	move	$a4, $a1
	.p2align	4, , 16
...
.LBB1_54:                               # %vector.body287
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB1_54
# %bb.55:                               # %middle.block294
	bne	$a3, $s3, .LBB1_57
	b	.LBB1_59
.LBB1_56:
	move	$a2, $s0
	move	$a1, $a0
.LBB1_57:                               # %for.body.i160.preheader346
	sub.d	$a3, $s1, $a3
	move	$a4, $a1
	.p2align	4, , 16
...
.LBB1_64:                               # %vector.body307
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB1_64
# %bb.65:                               # %middle.block314
	bne	$a3, $s2, .LBB1_67
	b	.LBB1_69
.LBB1_66:
	move	$a2, $s0
	move	$a1, $a0
.LBB1_67:                               # %for.body.i182.preheader345
	sub.d	$a3, $fp, $a3
	move	$a4, $a1
	.p2align	4, , 16
...
.LBB1_73:                               # %vector.body327
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB1_73
# %bb.74:                               # %middle.block334
	bne	$a3, $s2, .LBB1_76
	b	.LBB1_78
.LBB1_75:
	move	$a2, $s0
	move	$a1, $a0
.LBB1_76:                               # %for.body.i204.preheader344
	sub.d	$a3, $fp, $a3
	move	$a4, $a1
	.p2align	4, , 16
