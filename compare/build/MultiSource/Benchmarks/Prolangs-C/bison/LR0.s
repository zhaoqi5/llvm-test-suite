...
.LBB3_43:                               # %save_shifts.exit
	...
	b	.LBB3_3
.LBB3_44:                               # %vector.main.loop.iter.check76
                                        #   in Loop: Header=BB3_4 Depth=1
	srli.d	$a3, $a4, 1
	addi.d	$a3, $a3, 1
	ori	$a5, $zero, 62
...
.LBB3_49:                               # %vector.body80
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB3_49
# %bb.50:                               # %middle.block87
                                        #   in Loop: Header=BB3_4 Depth=1
	beq	$a3, $a5, .LBB3_16
# %bb.51:                               # %vec.epilog.iter.check91
                                        #   in Loop: Header=BB3_4 Depth=1
	beqz	$a4, .LBB3_62
.LBB3_52:                               # %vec.epilog.ph93
                                        #   in Loop: Header=BB3_4 Depth=1
	move	$a6, $a3
	...
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB3_53:                               # %vec.epilog.vector.body96
                                        #   Parent Loop BB3_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $t0, 0
	vst	$vr0, $a7, 0
	...
	addi.d	$t0, $t0, 16
	bnez	$a5, .LBB3_53
# %bb.54:                               # %vec.epilog.middle.block104
                                        #   in Loop: Header=BB3_4 Depth=1
	beq	$a3, $a6, .LBB3_16
	b	.LBB3_14
.LBB3_55:                               # %vector.ph
...
.LBB9_42:                               # %if.then123
	...
	st.d	$a0, $a1, 0
	b	.LBB9_5
.LBB9_43:                               # %vector.main.loop.iter.check153
	ori	$a2, $zero, 16
	bgeu	$a1, $a2, .LBB9_48
# %bb.44:
	move	$a3, $zero
.LBB9_45:                               # %vec.epilog.ph168
	...
	add.d	$a6, $a6, $fp
	addi.d	$a6, $a6, -4
.LBB9_46:                               # %vec.epilog.vector.body171
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a6, 0
	vst	$vr0, $a3, 0
	addi.d	$a5, $a5, 8
	...
	addi.d	$a6, $a6, -16
	bnez	$a5, .LBB9_46
# %bb.47:                               # %vec.epilog.middle.block177
	bne	$a4, $a1, .LBB9_18
	b	.LBB9_20
.LBB9_48:                               # %vector.ph154
	andi	$a2, $a1, 8
...
.LBB9_49:                               # %vector.body157
	...
	addi.d	$a5, $a5, -32
	bnez	$a6, .LBB9_49
# %bb.50:                               # %middle.block162
	beq	$a3, $a1, .LBB9_20
# %bb.51:                               # %vec.epilog.iter.check166
	bnez	$a2, .LBB9_45
# %bb.52:
	andi	$a2, $a1, 15
	b	.LBB9_18
...
# %bb.20:                               # %if.then13
	...
	ld.d	$a3, $a0, 0
	bgeu	$a3, $s0, .LBB10_29
# %bb.21:                               # %while.body20.preheader
                                        #   in Loop: Header=BB10_19 Depth=1
	addi.d	$a2, $s1, 22
	addi.d	$a6, $a3, 2
	.p2align	4, , 16
.LBB10_22:                              # %while.body20
...
# %bb.38:
	move	$a4, $s3
	b	.LBB10_59
.LBB10_39:                              # %vector.main.loop.iter.check145
	srli.d	$a3, $a4, 1
	ori	$a5, $zero, 62
	addi.d	$a3, $a3, 1
	bgeu	$a4, $a5, .LBB10_43
# %bb.40:
	move	$a5, $zero
	b	.LBB10_47
.LBB10_41:                              # %vector.main.loop.iter.check103
	srli.d	$a3, $a4, 1
	ori	$a5, $zero, 62
	addi.d	$a3, $a3, 1
	bgeu	$a4, $a5, .LBB10_52
...
.LBB10_44:                              # %vector.body149
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB10_44
# %bb.45:                               # %middle.block156
	beq	$a3, $a5, .LBB10_51
# %bb.46:                               # %vec.epilog.iter.check160
	beqz	$a4, .LBB10_63
.LBB10_47:                              # %vec.epilog.ph162
	move	$a6, $a3
	bstrins.d	$a6, $zero, 2, 0
	alsl.d	$a4, $a6, $s1, 1
	alsl.d	$a2, $a6, $a2, 1
	...
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB10_48:                              # %vec.epilog.vector.body165
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $t0, 0
	vst	$vr0, $a7, 0
	addi.d	$a7, $a7, 16
	...
	addi.d	$t0, $t0, 16
	bnez	$a5, .LBB10_48
# %bb.49:                               # %vec.epilog.middle.block173
	beq	$a3, $a6, .LBB10_51
	.p2align	4, , 16
.LBB10_50:                              # %while.body.i45
                                        # =>This Inner Loop Header: Depth=1
	ld.h	$a3, $a4, 0
	addi.d	$a5, $a4, 2
	addi.d	$a6, $a2, 2
...
.LBB10_53:                              # %vector.body107
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB10_53
# %bb.54:                               # %middle.block114
	beq	$a3, $a5, .LBB10_60
# %bb.55:                               # %vec.epilog.iter.check118
	beqz	$a4, .LBB10_64
.LBB10_56:                              # %vec.epilog.ph120
	move	$a6, $a3
	bstrins.d	$a6, $zero, 2, 0
	alsl.d	$a4, $a6, $s3, 1
	alsl.d	$a2, $a6, $a2, 1
	...
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB10_57:                              # %vec.epilog.vector.body123
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $t0, 0
	vst	$vr0, $a7, 0
	addi.d	$a7, $a7, 16
	...
	addi.d	$t0, $t0, 16
	bnez	$a5, .LBB10_57
# %bb.58:                               # %vec.epilog.middle.block131
	beq	$a3, $a6, .LBB10_60
	.p2align	4, , 16
.LBB10_59:                              # %while.body.i
                                        # =>This Inner Loop Header: Depth=1
	ld.h	$a3, $a4, 0
	addi.d	$a5, $a4, 2
	addi.d	$a6, $a2, 2
