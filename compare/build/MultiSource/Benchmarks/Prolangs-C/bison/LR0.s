...
.LBB3_46:                               # %vec.epilog.ph93
	...
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB3_47:                               # %vec.epilog.vector.body96
                                        #   Parent Loop BB3_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $t0, 0
	vst	$vr0, $a7, 0
	...
	addi.d	$t0, $t0, 16
	bnez	$a5, .LBB3_47
# %bb.48:                               # %vec.epilog.middle.block104
                                        #   in Loop: Header=BB3_4 Depth=1
	bne	$a3, $a6, .LBB3_14
	b	.LBB3_16
...
.LBB3_55:                               # %vector.body80
	...
	addi.d	$a7, $a7, 32
	bnez	$t0, .LBB3_55
# %bb.56:                               # %middle.block87
                                        #   in Loop: Header=BB3_4 Depth=1
	beq	$a3, $a5, .LBB3_16
# %bb.57:                               # %vec.epilog.iter.check91
                                        #   in Loop: Header=BB3_4 Depth=1
	bnez	$a4, .LBB3_46
...
# %bb.14:                               # %if.then13
	...
	ld.d	$a3, $a0, 0
	bgeu	$a3, $s0, .LBB10_23
# %bb.15:                               # %while.body20.preheader
                                        #   in Loop: Header=BB10_13 Depth=1
	addi.d	$a2, $s1, 22
	addi.d	$a6, $a3, 2
	.p2align	4, , 16
.LBB10_16:                              # %while.body20
