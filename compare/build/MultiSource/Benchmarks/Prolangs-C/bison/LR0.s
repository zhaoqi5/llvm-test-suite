...
# %bb.50:                               # %middle.block87
                                        #   in Loop: Header=BB3_4 Depth=1
	beq	$a3, $a5, .LBB3_16
# %bb.51:                               # %vec.epilog.iter.check92
                                        #   in Loop: Header=BB3_4 Depth=1
	andi	$a4, $a3, 24
	beqz	$a4, .LBB3_62
.LBB3_52:                               # %vec.epilog.ph91
                                        #   in Loop: Header=BB3_4 Depth=1
	move	$a6, $a3
	...
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB3_53:                               # %vec.epilog.vector.body97
                                        #   Parent Loop BB3_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $t0, 0
	vst	$vr0, $a7, 0
	...
	addi.d	$t0, $t0, 16
	bnez	$a5, .LBB3_53
# %bb.54:                               # %vec.epilog.middle.block105
                                        #   in Loop: Header=BB3_4 Depth=1
	bne	$a3, $a6, .LBB3_14
	b	.LBB3_16
.LBB3_55:                               # %vector.ph
...
.LBB9_45:                               # %vec.epilog.ph166
	...
	add.d	$a6, $a6, $fp
	addi.d	$a6, $a6, -4
.LBB9_46:                               # %vec.epilog.vector.body172
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a6, 0
	vst	$vr0, $a3, 0
	addi.d	$a5, $a5, 8
...
# %bb.50:                               # %middle.block162
	beq	$a3, $a1, .LBB9_20
# %bb.51:                               # %vec.epilog.iter.check167
	andi	$a2, $a1, 8
	bnez	$a2, .LBB9_45
# %bb.52:
	andi	$a2, $a1, 15
...
# %bb.39:
	move	$a4, $s3
	b	.LBB10_62
.LBB10_40:                              # %vector.main.loop.iter.check146
	srli.d	$a3, $a4, 1
	ori	$a5, $zero, 62
	addi.d	$a3, $a3, 1
	bgeu	$a4, $a5, .LBB10_44
# %bb.41:
	move	$a5, $zero
	b	.LBB10_48
.LBB10_42:                              # %vector.main.loop.iter.check103
	srli.d	$a3, $a4, 1
	ori	$a5, $zero, 62
	addi.d	$a3, $a3, 1
	bgeu	$a4, $a5, .LBB10_51
...
.LBB10_45:                              # %vector.body150
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB10_45
# %bb.46:                               # %middle.block157
	beq	$a3, $a5, .LBB10_60
# %bb.47:                               # %vec.epilog.iter.check162
	andi	$a4, $a3, 24
	beqz	$a4, .LBB10_58
.LBB10_48:                              # %vec.epilog.ph161
	move	$a6, $a3
	bstrins.d	$a6, $zero, 2, 0
	alsl.d	$a4, $a6, $s1, 1
	alsl.d	$a2, $a6, $a2, 1
	...
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB10_49:                              # %vec.epilog.vector.body167
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $t0, 0
	vst	$vr0, $a7, 0
	addi.d	$a7, $a7, 16
	...
	addi.d	$t0, $t0, 16
	bnez	$a5, .LBB10_49
# %bb.50:                               # %vec.epilog.middle.block175
	bne	$a3, $a6, .LBB10_59
	b	.LBB10_60
.LBB10_51:                              # %vector.ph104
	move	$a5, $a3
	bstrins.d	$a5, $zero, 4, 0
	addi.d	$a4, $a0, 54
	addi.d	$a6, $s3, 32
...
.LBB10_52:                              # %vector.body107
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB10_52
# %bb.53:                               # %middle.block114
	beq	$a3, $a5, .LBB10_63
# %bb.54:                               # %vec.epilog.iter.check119
	andi	$a4, $a3, 24
	beqz	$a4, .LBB10_61
.LBB10_55:                              # %vec.epilog.ph118
	move	$a6, $a3
	bstrins.d	$a6, $zero, 2, 0
	alsl.d	$a4, $a6, $s3, 1
	alsl.d	$a2, $a6, $a2, 1
	...
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB10_56:                              # %vec.epilog.vector.body124
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $t0, 0
	vst	$vr0, $a7, 0
	addi.d	$a7, $a7, 16
	...
	addi.d	$t0, $t0, 16
	bnez	$a5, .LBB10_56
# %bb.57:                               # %vec.epilog.middle.block132
	bne	$a3, $a6, .LBB10_62
	b	.LBB10_63
.LBB10_58:
	alsl.d	$a4, $a5, $s1, 1
