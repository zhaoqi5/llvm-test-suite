...
# %bb.0:                                # %entry
	...
	st.w	$zero, $a0, %pc_lo12(gensym_count)
	...
	jirl	$ra, $ra, 0
	ld.bu	$a0, $s1, %pc_lo12(yylsp_needed)
	beqz	$a0, .LBB0_2
# %bb.1:                                # %if.then
	ld.d	$a3, $s2, 0
...
# %bb.40:                               # %if.then57
	...
	ld.w	$a3, $a4, %pc_lo12(rline_allocated)
...
# %bb.41:                               # %if.then.i88
                                        #   in Loop: Header=BB3_37 Depth=2
	slli.w	$a1, $a1, 1
	st.w	$a1, $a4, %pc_lo12(rline_allocated)
	slli.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(realloc)
	jirl	$ra, $ra, 0
	st.d	$a0, $s6, 0
...
# %bb.77:                               # %for.body.preheader
	...
	pcalau12i	$a0, %got_pc_hi20(failure)
	ld.d	$s2, $a0, %got_pc_lo12(failure)
	ori	$s3, $zero, 1
	ori	$s4, $zero, 2
	pcalau12i	$a0, %got_pc_hi20(nvars)
	ld.d	$s5, $a0, %got_pc_lo12(nvars)
	b	.LBB3_79
	.p2align	4, , 16
.LBB3_78:                               # %for.inc
...
# %bb.0:                                # %entry
	...
	ld.d	$fp, $a1, %got_pc_lo12(firstsymbol)
	ld.d	$a1, $fp, 0
	beqz	$a1, .LBB4_11
# %bb.1:                                # %for.body.lr.ph
...
.LBB4_35:                               # %for.end92
	...
	ld.d	$a1, $a1, %got_pc_lo12(error_token_number)
	st.w	$a0, $a1, 0
	pcalau12i	$a0, %got_pc_hi20(ftable)
...
# %bb.0:                                # %entry
	...
	st.d	$s7, $sp, 32                    # 8-byte Folded Spill
	st.d	$s8, $sp, 24                    # 8-byte Folded Spill
	pcalau12i	$fp, %pc_hi20(typed)
	ld.bu	$a0, $fp, %pc_lo12(typed)
	beqz	$a0, .LBB10_2
# %bb.1:                                # %if.then
...
.LBB12_2:                               # %if.end.lr.ph
	...
	addi.d	$s4, $a0, %pc_lo12(.LJTI12_0)
	pcalau12i	$a0, %got_pc_hi20(symval)
	ld.d	$s0, $a0, %got_pc_lo12(symval)
	pcalau12i	$a0, %pc_hi20(.L.str.11)
	addi.d	$a0, $a0, %pc_lo12(.L.str.11)
	st.d	$a0, $sp, 48                    # 8-byte Folded Spill
	pcalau12i	$a0, %pc_hi20(.L.str.12)
...
.LBB14_35:                              # %while.cond106.preheader
	...
	ld.d	$s7, $a1, %got_pc_lo12(token_buffer)
	move	$s4, $s7
	ori	$a1, $zero, 62
	beq	$a0, $a1, .LBB14_40
...
.LBB14_70:                              # %if.end.i86
	...
	slli.d	$a1, $a1, 52
	bltz	$a1, .LBB14_72
# %bb.71:                               #   in Loop: Header=BB14_5 Depth=1
	st.d	$zero, $sp, 40                  # 8-byte Folded Spill
	b	.LBB14_75
.LBB14_72:                              # %while.body.i93.preheader
                                        #   in Loop: Header=BB14_5 Depth=1
	st.d	$a3, $sp, 40                    # 8-byte Folded Spill
	move	$s7, $zero
	.p2align	4, , 16
.LBB14_73:                              # %while.body.i93
                                        #   Parent Loop BB14_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	slli.d	$a1, $s7, 3
	alsl.d	$a1, $s7, $a1, 1
	...
	slli.d	$a1, $a1, 52
	bltz	$a1, .LBB14_73
# %bb.74:                               # %while.end.loopexit.i103
                                        #   in Loop: Header=BB14_5 Depth=1
	ld.d	$a1, $sp, 40                    # 8-byte Folded Reload
	mul.d	$a1, $s7, $a1
	st.d	$a1, $sp, 40                    # 8-byte Folded Spill
.LBB14_75:                              # %read_signed_integer.exit109
                                        #   in Loop: Header=BB14_5 Depth=1
	move	$a1, $s5
	pcaddu18i	$ra, %call36(ungetc)
	jirl	$ra, $ra, 0
...
# %bb.80:                               # %if.then.i
	...
	addi.d	$a3, $zero, -1
	b	.LBB14_82
.LBB14_81:                              #   in Loop: Header=BB14_5 Depth=1
	ori	$a3, $zero, 1
.LBB14_82:                              # %if.end.i
                                        #   in Loop: Header=BB14_5 Depth=1
	ld.d	$a1, $s7, 0
	...
	slli.d	$a1, $a1, 52
	bltz	$a1, .LBB14_84
# %bb.83:                               #   in Loop: Header=BB14_5 Depth=1
	st.d	$zero, $sp, 40                  # 8-byte Folded Spill
	b	.LBB14_87
.LBB14_84:                              # %while.body.i.preheader
                                        #   in Loop: Header=BB14_5 Depth=1
	st.d	$a3, $sp, 40                    # 8-byte Folded Spill
	st.d	$s4, $sp, 24                    # 8-byte Folded Spill
	move	$s4, $zero
.LBB14_85:                              # %while.body.i
                                        #   Parent Loop BB14_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	slli.d	$a1, $s4, 3
	alsl.d	$a1, $s4, $a1, 1
	...
	slli.d	$a1, $a1, 52
	bltz	$a1, .LBB14_85
# %bb.86:                               # %while.end.loopexit.i
                                        #   in Loop: Header=BB14_5 Depth=1
	ld.d	$a1, $sp, 40                    # 8-byte Folded Reload
	mul.w	$a1, $s4, $a1
	st.d	$a1, $sp, 40                    # 8-byte Folded Spill
	ld.d	$s4, $sp, 24                    # 8-byte Folded Reload
.LBB14_87:                              # %read_signed_integer.exit
                                        #   in Loop: Header=BB14_5 Depth=1
	move	$a1, $s4
	pcaddu18i	$ra, %call36(ungetc)
	jirl	$ra, $ra, 0
	...
	ori	$a0, $zero, 60
	beq	$s5, $a0, .LBB14_95
# %bb.88:                               # %read_signed_integer.exit
                                        #   in Loop: Header=BB14_5 Depth=1
	ld.d	$s7, $sp, 40                    # 8-byte Folded Reload
	blez	$s7, .LBB14_96
# %bb.89:                               # %while.body.i83.preheader
                                        #   in Loop: Header=BB14_5 Depth=1
	ld.d	$s5, $sp, 48                    # 8-byte Folded Reload
	b	.LBB14_92
.LBB14_90:                              # %if.then4.i
...
# %bb.102:                              # %if.else213
	...
	pcaddu18i	$t8, %call36(ungetc)
	jr	$t8
.LBB14_103:                             # %if.then207
	ld.d	$a0, $s3, 0
	pcaddu18i	$ra, %call36(getc)
	jirl	$ra, $ra, 0
	ori	$a1, $zero, 123
	bne	$a0, $a1, .LBB14_105
.LBB14_104:                             # %if.then203
	ld.d	$a0, $sp, 48                    # 8-byte Folded Reload
	ld.d	$a1, $sp, 80                    # 8-byte Folded Reload
	ld.d	$s8, $sp, 104                   # 8-byte Folded Reload
	ld.d	$s7, $sp, 112                   # 8-byte Folded Reload
...
# %bb.0:                                # %entry
	...
	ld.d	$s7, $a0, %got_pc_lo12(faction)
	ld.d	$a0, $s7, 0
	pcalau12i	$a1, %got_pc_hi20(nrules)
	ld.d	$a1, $a1, %got_pc_lo12(nrules)
	ld.w	$a2, $a1, 0
...
.LBB16_70:                              # %if.end.i73
	...
	slli.d	$a1, $a1, 52
	bltz	$a1, .LBB16_72
# %bb.71:                               #   in Loop: Header=BB16_5 Depth=1
	move	$s0, $zero
	b	.LBB16_75
.LBB16_72:                              # %while.body.i80.preheader
                                        #   in Loop: Header=BB16_5 Depth=1
	move	$s6, $zero
	.p2align	4, , 16
.LBB16_73:                              # %while.body.i80
                                        #   Parent Loop BB16_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	slli.d	$a1, $s6, 3
	alsl.d	$a1, $s6, $a1, 1
	...
	slli.d	$a1, $a1, 52
	bltz	$a1, .LBB16_73
# %bb.74:                               # %while.end.loopexit.i90
                                        #   in Loop: Header=BB16_5 Depth=1
	mul.d	$s0, $s6, $s5
	ld.d	$s6, $sp, 48                    # 8-byte Folded Reload
.LBB16_75:                              # %read_signed_integer.exit96
                                        #   in Loop: Header=BB16_5 Depth=1
	move	$a1, $s3
	pcaddu18i	$ra, %call36(ungetc)
	jirl	$ra, $ra, 0
...
# %bb.77:                               # %if.then.i
	...
	addi.d	$a3, $zero, -1
	b	.LBB16_79
.LBB16_78:                              #   in Loop: Header=BB16_5 Depth=1
	ori	$a3, $zero, 1
.LBB16_79:                              # %if.end.i
                                        #   in Loop: Header=BB16_5 Depth=1
	ld.d	$s6, $sp, 48                    # 8-byte Folded Reload
	...
	slli.d	$a1, $a1, 52
	bltz	$a1, .LBB16_81
# %bb.80:                               #   in Loop: Header=BB16_5 Depth=1
	move	$a1, $s0
	move	$s0, $zero
	b	.LBB16_84
.LBB16_81:                              # %while.body.i.preheader
                                        #   in Loop: Header=BB16_5 Depth=1
	st.d	$a3, $sp, 56                    # 8-byte Folded Spill
	move	$s6, $zero
	.p2align	4, , 16
.LBB16_82:                              # %while.body.i
                                        #   Parent Loop BB16_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	slli.d	$a1, $s6, 3
	alsl.d	$a1, $s6, $a1, 1
...
.LBB16_84:                              # %read_signed_integer.exit
	...
	ori	$a0, $zero, 60
	beq	$s5, $a0, .LBB16_92
# %bb.85:                               # %read_signed_integer.exit
                                        #   in Loop: Header=BB16_5 Depth=1
	blez	$s0, .LBB16_92
# %bb.86:                               # %while.body.i68.preheader
                                        #   in Loop: Header=BB16_5 Depth=1
	move	$s5, $s0
...
# %bb.1:                                # %for.body.preheader
	...
	pcalau12i	$a0, %got_pc_hi20(semantic_parser)
	ld.d	$s1, $a0, %got_pc_lo12(semantic_parser)
