...
.LBB16_13:                              # %while.end42
	...
	addi.w	$t3, $a4, -1
	bge	$t2, $t3, .LBB16_2
# %bb.14:                               # %for.body47.preheader
                                        #   in Loop: Header=BB16_4 Depth=1
	sub.d	$t5, $t3, $t2
	bgeu	$t5, $t1, .LBB16_18
.LBB16_15:                              #   in Loop: Header=BB16_4 Depth=1
	move	$t4, $a4
.LBB16_16:                              # %for.body47.preheader48
                                        #   in Loop: Header=BB16_4 Depth=1
	alsl.d	$t5, $t3, $a0, 1
	move	$t6, $t3
	.p2align	4, , 16
...
.LBB21_35:                              # %vector.ph171
	...
	b	.LBB21_37
	.p2align	4, , 16
.LBB21_36:                              # %pred.store.continue192
                                        #   in Loop: Header=BB21_37 Depth=1
	addi.d	$a4, $a4, -8
	addi.d	$a3, $a3, 16
	beqz	$a4, .LBB21_53
.LBB21_37:                              # %vector.body174
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a3, -8
	vseq.h	$vr1, $vr1, $vr0
	...
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_45
# %bb.38:                               # %pred.store.if177
                                        #   in Loop: Header=BB21_37 Depth=1
	st.h	$zero, $a3, -8
	vpickve2gr.h	$a5, $vr1, 1
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_46
.LBB21_39:                              # %pred.store.continue180
                                        #   in Loop: Header=BB21_37 Depth=1
	vpickve2gr.h	$a5, $vr1, 2
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_47
.LBB21_40:                              # %pred.store.if181
                                        #   in Loop: Header=BB21_37 Depth=1
	st.h	$zero, $a3, -4
	vpickve2gr.h	$a5, $vr1, 3
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_48
.LBB21_41:                              # %pred.store.continue184
                                        #   in Loop: Header=BB21_37 Depth=1
	vpickve2gr.h	$a5, $vr1, 4
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_49
.LBB21_42:                              # %pred.store.if185
                                        #   in Loop: Header=BB21_37 Depth=1
	st.h	$zero, $a3, 0
	vpickve2gr.h	$a5, $vr1, 5
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_50
.LBB21_43:                              # %pred.store.continue188
                                        #   in Loop: Header=BB21_37 Depth=1
	vpickve2gr.h	$a5, $vr1, 6
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_51
.LBB21_44:                              # %pred.store.if189
                                        #   in Loop: Header=BB21_37 Depth=1
	st.h	$zero, $a3, 4
	...
	b	.LBB21_52
	.p2align	4, , 16
.LBB21_45:                              # %pred.store.continue178
                                        #   in Loop: Header=BB21_37 Depth=1
	vpickve2gr.h	$a5, $vr1, 1
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_39
.LBB21_46:                              # %pred.store.if179
                                        #   in Loop: Header=BB21_37 Depth=1
	st.h	$zero, $a3, -6
	vpickve2gr.h	$a5, $vr1, 2
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_40
.LBB21_47:                              # %pred.store.continue182
                                        #   in Loop: Header=BB21_37 Depth=1
	vpickve2gr.h	$a5, $vr1, 3
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_41
.LBB21_48:                              # %pred.store.if183
                                        #   in Loop: Header=BB21_37 Depth=1
	st.h	$zero, $a3, -2
	vpickve2gr.h	$a5, $vr1, 4
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_42
.LBB21_49:                              # %pred.store.continue186
                                        #   in Loop: Header=BB21_37 Depth=1
	vpickve2gr.h	$a5, $vr1, 5
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_43
.LBB21_50:                              # %pred.store.if187
                                        #   in Loop: Header=BB21_37 Depth=1
	st.h	$zero, $a3, 2
	vpickve2gr.h	$a5, $vr1, 6
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_44
.LBB21_51:                              # %pred.store.continue190
                                        #   in Loop: Header=BB21_37 Depth=1
	vpickve2gr.h	$a5, $vr1, 7
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_36
.LBB21_52:                              # %pred.store.if191
                                        #   in Loop: Header=BB21_37 Depth=1
	st.h	$zero, $a3, 6
	b	.LBB21_36
.LBB21_53:                              # %middle.block194
	beq	$a2, $s0, .LBB21_73
.LBB21_54:                              # %for.body161.preheader
	alsl.d	$a1, $a2, $a1, 1
	sub.d	$a2, $s0, $a2
	lu12i.w	$a3, 8
	b	.LBB21_56
	.p2align	4, , 16
.LBB21_55:                              # %for.inc171
                                        #   in Loop: Header=BB21_56 Depth=1
	addi.d	$a2, $a2, -1
	addi.d	$a1, $a1, 2
	beqz	$a2, .LBB21_73
.LBB21_56:                              # %for.body161
                                        # =>This Inner Loop Header: Depth=1
	ld.hu	$a4, $a1, 0
	bne	$a4, $a3, .LBB21_55
# %bb.57:                               # %if.then167
	...
	st.h	$zero, $a1, 0
	b	.LBB21_55
.LBB21_58:                              # %for.cond102.preheader
	addi.w	$a1, $a1, 0
	addi.w	$a2, $a3, 0
	bge	$a2, $a1, .LBB21_28
# %bb.59:                               # %for.body105.lr.ph
	blez	$s0, .LBB21_72
# %bb.60:                               # %for.body105.us.preheader
	pcalau12i	$a0, %got_pc_hi20(LAruleno)
	...
	b	.LBB21_62
	.p2align	4, , 16
.LBB21_61:                              # %for.cond110.for.end124_crit_edge.us
...
# %bb.66:                               # %middle.block
	...
	move	$t6, $t0
	beq	$t0, $s0, .LBB21_61
.LBB21_67:                              # %for.body113.us.preheader
                                        #   in Loop: Header=BB21_62 Depth=1
	alsl.d	$t5, $t6, $a6, 1
	sub.d	$t6, $s0, $t6
	.p2align	4, , 16
.LBB21_68:                              # %for.body113.us
                                        #   Parent Loop BB21_62 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.h	$t7, $t5, 0
	xor	$t7, $t7, $t3
...
.LBB21_74:                              # %vector.ph143
	...
	b	.LBB21_76
	.p2align	4, , 16
.LBB21_75:                              # %pred.store.continue164
                                        #   in Loop: Header=BB21_76 Depth=1
	addi.d	$a4, $a4, -8
	addi.d	$a3, $a3, 16
	beqz	$a4, .LBB21_92
.LBB21_76:                              # %vector.body148
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a3, -8
	vilvl.h	$vr2, $vr1, $vr1
	vslli.w	$vr2, $vr2, 16
...
# %bb.77:                               # %pred.store.if
	...
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_81
.LBB21_78:                              # %pred.store.continue152
                                        #   in Loop: Header=BB21_76 Depth=1
	vpickve2gr.h	$a5, $vr2, 4
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_82
.LBB21_79:                              # %pred.store.if153
                                        #   in Loop: Header=BB21_76 Depth=1
	st.h	$zero, $a3, -4
...
.LBB21_80:                              # %pred.store.continue
	...
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_78
.LBB21_81:                              # %pred.store.if151
                                        #   in Loop: Header=BB21_76 Depth=1
	st.h	$zero, $a3, -6
	vpickve2gr.h	$a5, $vr2, 4
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_79
.LBB21_82:                              # %pred.store.continue154
                                        #   in Loop: Header=BB21_76 Depth=1
	vpickve2gr.h	$a5, $vr2, 6
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_84
.LBB21_83:                              # %pred.store.if155
                                        #   in Loop: Header=BB21_76 Depth=1
	st.h	$zero, $a3, -2
.LBB21_84:                              # %pred.store.continue156
                                        #   in Loop: Header=BB21_76 Depth=1
	vilvh.h	$vr1, $vr1, $vr1
	vslli.w	$vr1, $vr1, 16
	vsrai.w	$vr1, $vr1, 16
	...
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_88
# %bb.85:                               # %pred.store.if157
                                        #   in Loop: Header=BB21_76 Depth=1
	st.h	$zero, $a3, 0
	vpickve2gr.h	$a5, $vr1, 2
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_89
.LBB21_86:                              # %pred.store.continue160
                                        #   in Loop: Header=BB21_76 Depth=1
	vpickve2gr.h	$a5, $vr1, 4
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_90
.LBB21_87:                              # %pred.store.if161
                                        #   in Loop: Header=BB21_76 Depth=1
	st.h	$zero, $a3, 4
	vpickve2gr.h	$a5, $vr1, 6
	andi	$a5, $a5, 1
	...
	b	.LBB21_91
	.p2align	4, , 16
.LBB21_88:                              # %pred.store.continue158
                                        #   in Loop: Header=BB21_76 Depth=1
	vpickve2gr.h	$a5, $vr1, 2
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_86
.LBB21_89:                              # %pred.store.if159
                                        #   in Loop: Header=BB21_76 Depth=1
	st.h	$zero, $a3, 2
	vpickve2gr.h	$a5, $vr1, 4
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_87
.LBB21_90:                              # %pred.store.continue162
                                        #   in Loop: Header=BB21_76 Depth=1
	vpickve2gr.h	$a5, $vr1, 6
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_75
.LBB21_91:                              # %pred.store.if163
                                        #   in Loop: Header=BB21_76 Depth=1
	st.h	$zero, $a3, 6
	b	.LBB21_75
.LBB21_92:                              # %middle.block166
	bne	$a2, $s0, .LBB21_94
.LBB21_93:                              # %for.end150
	sub.d	$a0, $zero, $a0
	b	.LBB21_31
.LBB21_94:                              # %for.body138.preheader
	alsl.d	$a1, $a2, $a1, 1
	sub.d	$a2, $s0, $a2
	addi.w	$a3, $a0, 0
	b	.LBB21_96
	.p2align	4, , 16
.LBB21_95:                              # %for.inc148
                                        #   in Loop: Header=BB21_96 Depth=1
	addi.d	$a2, $a2, -1
	addi.d	$a1, $a1, 2
	beqz	$a2, .LBB21_93
.LBB21_96:                              # %for.body138
                                        # =>This Inner Loop Header: Depth=1
	ld.h	$a4, $a1, 0
	bne	$a3, $a4, .LBB21_95
# %bb.97:                               # %if.then144
