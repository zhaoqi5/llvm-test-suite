...
# %bb.1:                                # %for.body.lr.ph
	move	$a4, $zero
	move	$a5, $zero
	pcalau12i	$a6, %pc_hi20(tally)
	ld.d	$a6, $a6, %pc_lo12(tally)
	pcalau12i	$a7, %pc_hi20(width)
	ld.d	$a7, $a7, %pc_lo12(width)
	addi.d	$t0, $a0, -30
	addi.d	$t1, $a0, -14
	addi.w	$t2, $zero, -1
	ori	$t3, $zero, 8
...
.LBB21_37:                              # %vec.epilog.ph252
	...
	b	.LBB21_39
	.p2align	4, , 16
.LBB21_38:                              # %pred.store.continue276
                                        #   in Loop: Header=BB21_39 Depth=1
	addi.d	$a3, $a3, 8
	addi.d	$a4, $a4, 16
	beqz	$a3, .LBB21_66
.LBB21_39:                              # %vec.epilog.vector.body258
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a4, -8
	vseq.h	$vr1, $vr1, $vr0
	...
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_47
# %bb.40:                               # %pred.store.if261
                                        #   in Loop: Header=BB21_39 Depth=1
	st.h	$zero, $a4, -8
	vpickve2gr.h	$a5, $vr1, 1
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_48
.LBB21_41:                              # %pred.store.continue264
                                        #   in Loop: Header=BB21_39 Depth=1
	vpickve2gr.h	$a5, $vr1, 2
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_49
.LBB21_42:                              # %pred.store.if265
                                        #   in Loop: Header=BB21_39 Depth=1
	st.h	$zero, $a4, -4
	vpickve2gr.h	$a5, $vr1, 3
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_50
.LBB21_43:                              # %pred.store.continue268
                                        #   in Loop: Header=BB21_39 Depth=1
	vpickve2gr.h	$a5, $vr1, 4
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_51
.LBB21_44:                              # %pred.store.if269
                                        #   in Loop: Header=BB21_39 Depth=1
	st.h	$zero, $a4, 0
	vpickve2gr.h	$a5, $vr1, 5
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_52
.LBB21_45:                              # %pred.store.continue272
                                        #   in Loop: Header=BB21_39 Depth=1
	vpickve2gr.h	$a5, $vr1, 6
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_53
.LBB21_46:                              # %pred.store.if273
                                        #   in Loop: Header=BB21_39 Depth=1
	st.h	$zero, $a4, 4
	...
	b	.LBB21_54
	.p2align	4, , 16
.LBB21_47:                              # %pred.store.continue262
                                        #   in Loop: Header=BB21_39 Depth=1
	vpickve2gr.h	$a5, $vr1, 1
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_41
.LBB21_48:                              # %pred.store.if263
                                        #   in Loop: Header=BB21_39 Depth=1
	st.h	$zero, $a4, -6
	vpickve2gr.h	$a5, $vr1, 2
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_42
.LBB21_49:                              # %pred.store.continue266
                                        #   in Loop: Header=BB21_39 Depth=1
	vpickve2gr.h	$a5, $vr1, 3
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_43
.LBB21_50:                              # %pred.store.if267
                                        #   in Loop: Header=BB21_39 Depth=1
	st.h	$zero, $a4, -2
	vpickve2gr.h	$a5, $vr1, 4
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_44
.LBB21_51:                              # %pred.store.continue270
                                        #   in Loop: Header=BB21_39 Depth=1
	vpickve2gr.h	$a5, $vr1, 5
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_45
.LBB21_52:                              # %pred.store.if271
                                        #   in Loop: Header=BB21_39 Depth=1
	st.h	$zero, $a4, 2
	vpickve2gr.h	$a5, $vr1, 6
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_46
.LBB21_53:                              # %pred.store.continue274
                                        #   in Loop: Header=BB21_39 Depth=1
	vpickve2gr.h	$a5, $vr1, 7
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_38
.LBB21_54:                              # %pred.store.if275
                                        #   in Loop: Header=BB21_39 Depth=1
	st.h	$zero, $a4, 6
	b	.LBB21_38
...
.LBB21_65:                              # %for.body113.us
	...
	bnez	$t5, .LBB21_65
	b	.LBB21_58
.LBB21_66:                              # %vec.epilog.middle.block278
	beq	$a2, $s0, .LBB21_111
	b	.LBB21_103
...
# %bb.70:                               # %pred.store.if215
	...
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_86
.LBB21_71:                              # %pred.store.continue218
                                        #   in Loop: Header=BB21_69 Depth=1
	vpickve2gr.h	$a5, $vr1, 2
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_87
.LBB21_72:                              # %pred.store.if219
                                        #   in Loop: Header=BB21_69 Depth=1
	st.h	$zero, $a3, -12
	vpickve2gr.h	$a5, $vr1, 3
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_88
.LBB21_73:                              # %pred.store.continue222
                                        #   in Loop: Header=BB21_69 Depth=1
	vpickve2gr.h	$a5, $vr1, 4
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_89
.LBB21_74:                              # %pred.store.if223
                                        #   in Loop: Header=BB21_69 Depth=1
	st.h	$zero, $a3, -8
	vpickve2gr.h	$a5, $vr1, 5
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_90
.LBB21_75:                              # %pred.store.continue226
                                        #   in Loop: Header=BB21_69 Depth=1
	vpickve2gr.h	$a5, $vr1, 6
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_91
.LBB21_76:                              # %pred.store.if227
                                        #   in Loop: Header=BB21_69 Depth=1
	st.h	$zero, $a3, -4
	vpickve2gr.h	$a5, $vr1, 7
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_92
.LBB21_77:                              # %pred.store.continue230
                                        #   in Loop: Header=BB21_69 Depth=1
	xvpermi.d	$xr1, $xr1, 14
	vpickve2gr.h	$a5, $vr1, 0
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_93
.LBB21_78:                              # %pred.store.if231
                                        #   in Loop: Header=BB21_69 Depth=1
	st.h	$zero, $a3, 0
	vpickve2gr.h	$a5, $vr1, 1
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_94
.LBB21_79:                              # %pred.store.continue234
                                        #   in Loop: Header=BB21_69 Depth=1
	vpickve2gr.h	$a5, $vr1, 2
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_95
.LBB21_80:                              # %pred.store.if235
                                        #   in Loop: Header=BB21_69 Depth=1
	st.h	$zero, $a3, 4
	vpickve2gr.h	$a5, $vr1, 3
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_96
.LBB21_81:                              # %pred.store.continue238
                                        #   in Loop: Header=BB21_69 Depth=1
	vpickve2gr.h	$a5, $vr1, 4
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_97
.LBB21_82:                              # %pred.store.if239
                                        #   in Loop: Header=BB21_69 Depth=1
	st.h	$zero, $a3, 8
	vpickve2gr.h	$a5, $vr1, 5
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_98
.LBB21_83:                              # %pred.store.continue242
                                        #   in Loop: Header=BB21_69 Depth=1
	vpickve2gr.h	$a5, $vr1, 6
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_99
.LBB21_84:                              # %pred.store.if243
                                        #   in Loop: Header=BB21_69 Depth=1
	st.h	$zero, $a3, 12
	vpickve2gr.h	$a5, $vr1, 7
	andi	$a5, $a5, 1
	...
	b	.LBB21_100
	.p2align	4, , 16
.LBB21_85:                              # %pred.store.continue216
                                        #   in Loop: Header=BB21_69 Depth=1
	vpickve2gr.h	$a5, $vr1, 1
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_71
.LBB21_86:                              # %pred.store.if217
                                        #   in Loop: Header=BB21_69 Depth=1
	st.h	$zero, $a3, -14
	vpickve2gr.h	$a5, $vr1, 2
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_72
.LBB21_87:                              # %pred.store.continue220
                                        #   in Loop: Header=BB21_69 Depth=1
	vpickve2gr.h	$a5, $vr1, 3
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_73
.LBB21_88:                              # %pred.store.if221
                                        #   in Loop: Header=BB21_69 Depth=1
	st.h	$zero, $a3, -10
	vpickve2gr.h	$a5, $vr1, 4
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_74
.LBB21_89:                              # %pred.store.continue224
                                        #   in Loop: Header=BB21_69 Depth=1
	vpickve2gr.h	$a5, $vr1, 5
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_75
.LBB21_90:                              # %pred.store.if225
                                        #   in Loop: Header=BB21_69 Depth=1
	st.h	$zero, $a3, -6
	vpickve2gr.h	$a5, $vr1, 6
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_76
.LBB21_91:                              # %pred.store.continue228
                                        #   in Loop: Header=BB21_69 Depth=1
	vpickve2gr.h	$a5, $vr1, 7
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_77
.LBB21_92:                              # %pred.store.if229
                                        #   in Loop: Header=BB21_69 Depth=1
	st.h	$zero, $a3, -2
	xvpermi.d	$xr1, $xr1, 14
	vpickve2gr.h	$a5, $vr1, 0
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_78
.LBB21_93:                              # %pred.store.continue232
                                        #   in Loop: Header=BB21_69 Depth=1
	vpickve2gr.h	$a5, $vr1, 1
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_79
.LBB21_94:                              # %pred.store.if233
                                        #   in Loop: Header=BB21_69 Depth=1
	st.h	$zero, $a3, 2
	vpickve2gr.h	$a5, $vr1, 2
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_80
.LBB21_95:                              # %pred.store.continue236
                                        #   in Loop: Header=BB21_69 Depth=1
	vpickve2gr.h	$a5, $vr1, 3
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_81
.LBB21_96:                              # %pred.store.if237
                                        #   in Loop: Header=BB21_69 Depth=1
	st.h	$zero, $a3, 6
	vpickve2gr.h	$a5, $vr1, 4
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_82
.LBB21_97:                              # %pred.store.continue240
                                        #   in Loop: Header=BB21_69 Depth=1
	vpickve2gr.h	$a5, $vr1, 5
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_83
.LBB21_98:                              # %pred.store.if241
                                        #   in Loop: Header=BB21_69 Depth=1
	st.h	$zero, $a3, 10
	vpickve2gr.h	$a5, $vr1, 6
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_84
.LBB21_99:                              # %pred.store.continue244
                                        #   in Loop: Header=BB21_69 Depth=1
	vpickve2gr.h	$a5, $vr1, 7
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_68
...
.LBB21_101:                             # %middle.block248
	beq	$a2, $s0, .LBB21_111
# %bb.102:                              # %vec.epilog.iter.check253
	andi	$a3, $s0, 8
	bnez	$a3, .LBB21_37
...
# %bb.117:                              # %pred.store.if
	...
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_125
.LBB21_118:                             # %pred.store.continue154
                                        #   in Loop: Header=BB21_116 Depth=1
	xvpickve2gr.w	$a5, $xr2, 2
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_126
.LBB21_119:                             # %pred.store.if155
                                        #   in Loop: Header=BB21_116 Depth=1
	st.h	$zero, $a3, -12
	xvpickve2gr.w	$a5, $xr2, 3
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_127
.LBB21_120:                             # %pred.store.continue158
                                        #   in Loop: Header=BB21_116 Depth=1
	xvpickve2gr.w	$a5, $xr2, 4
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_128
.LBB21_121:                             # %pred.store.if159
                                        #   in Loop: Header=BB21_116 Depth=1
	st.h	$zero, $a3, -8
	xvpickve2gr.w	$a5, $xr2, 5
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_129
.LBB21_122:                             # %pred.store.continue162
                                        #   in Loop: Header=BB21_116 Depth=1
	xvpickve2gr.w	$a5, $xr2, 6
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_130
.LBB21_123:                             # %pred.store.if163
                                        #   in Loop: Header=BB21_116 Depth=1
	st.h	$zero, $a3, -4
...
.LBB21_124:                             # %pred.store.continue
	...
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_118
.LBB21_125:                             # %pred.store.if153
                                        #   in Loop: Header=BB21_116 Depth=1
	st.h	$zero, $a3, -14
	xvpickve2gr.w	$a5, $xr2, 2
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_119
.LBB21_126:                             # %pred.store.continue156
                                        #   in Loop: Header=BB21_116 Depth=1
	xvpickve2gr.w	$a5, $xr2, 3
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_120
.LBB21_127:                             # %pred.store.if157
                                        #   in Loop: Header=BB21_116 Depth=1
	st.h	$zero, $a3, -10
	xvpickve2gr.w	$a5, $xr2, 4
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_121
.LBB21_128:                             # %pred.store.continue160
                                        #   in Loop: Header=BB21_116 Depth=1
	xvpickve2gr.w	$a5, $xr2, 5
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_122
.LBB21_129:                             # %pred.store.if161
                                        #   in Loop: Header=BB21_116 Depth=1
	st.h	$zero, $a3, -6
	xvpickve2gr.w	$a5, $xr2, 6
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_123
.LBB21_130:                             # %pred.store.continue164
                                        #   in Loop: Header=BB21_116 Depth=1
	xvpickve2gr.w	$a5, $xr2, 7
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_132
.LBB21_131:                             # %pred.store.if165
                                        #   in Loop: Header=BB21_116 Depth=1
	st.h	$zero, $a3, -2
.LBB21_132:                             # %pred.store.continue166
	...
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_140
# %bb.133:                              # %pred.store.if167
                                        #   in Loop: Header=BB21_116 Depth=1
	st.h	$zero, $a3, 0
	xvpickve2gr.w	$a5, $xr1, 1
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_141
.LBB21_134:                             # %pred.store.continue170
                                        #   in Loop: Header=BB21_116 Depth=1
	xvpickve2gr.w	$a5, $xr1, 2
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_142
.LBB21_135:                             # %pred.store.if171
                                        #   in Loop: Header=BB21_116 Depth=1
	st.h	$zero, $a3, 4
	xvpickve2gr.w	$a5, $xr1, 3
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_143
.LBB21_136:                             # %pred.store.continue174
                                        #   in Loop: Header=BB21_116 Depth=1
	xvpickve2gr.w	$a5, $xr1, 4
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_144
.LBB21_137:                             # %pred.store.if175
                                        #   in Loop: Header=BB21_116 Depth=1
	st.h	$zero, $a3, 8
	xvpickve2gr.w	$a5, $xr1, 5
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_145
.LBB21_138:                             # %pred.store.continue178
                                        #   in Loop: Header=BB21_116 Depth=1
	xvpickve2gr.w	$a5, $xr1, 6
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_146
.LBB21_139:                             # %pred.store.if179
                                        #   in Loop: Header=BB21_116 Depth=1
	st.h	$zero, $a3, 12
	...
	b	.LBB21_147
	.p2align	4, , 16
.LBB21_140:                             # %pred.store.continue168
                                        #   in Loop: Header=BB21_116 Depth=1
	xvpickve2gr.w	$a5, $xr1, 1
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_134
.LBB21_141:                             # %pred.store.if169
                                        #   in Loop: Header=BB21_116 Depth=1
	st.h	$zero, $a3, 2
	xvpickve2gr.w	$a5, $xr1, 2
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_135
.LBB21_142:                             # %pred.store.continue172
                                        #   in Loop: Header=BB21_116 Depth=1
	xvpickve2gr.w	$a5, $xr1, 3
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_136
.LBB21_143:                             # %pred.store.if173
                                        #   in Loop: Header=BB21_116 Depth=1
	st.h	$zero, $a3, 6
	xvpickve2gr.w	$a5, $xr1, 4
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_137
.LBB21_144:                             # %pred.store.continue176
                                        #   in Loop: Header=BB21_116 Depth=1
	xvpickve2gr.w	$a5, $xr1, 5
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_138
.LBB21_145:                             # %pred.store.if177
                                        #   in Loop: Header=BB21_116 Depth=1
	st.h	$zero, $a3, 10
	xvpickve2gr.w	$a5, $xr1, 6
	andi	$a5, $a5, 1
	bnez	$a5, .LBB21_139
.LBB21_146:                             # %pred.store.continue180
                                        #   in Loop: Header=BB21_116 Depth=1
	xvpickve2gr.w	$a5, $xr1, 7
	andi	$a5, $a5, 1
	beqz	$a5, .LBB21_115
