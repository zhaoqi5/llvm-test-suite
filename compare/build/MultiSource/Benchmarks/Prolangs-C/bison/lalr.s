...
# %bb.20:                               # %if.then75
	...
	ldx.d	$a5, $a2, $a5
	beqz	$a5, .LBB6_18
# %bb.21:                               # %for.cond80.preheader
                                        #   in Loop: Header=BB6_19 Depth=1
	ld.h	$a6, $a5, 10
	blez	$a6, .LBB6_18
# %bb.22:                               # %for.body85.lr.ph
                                        #   in Loop: Header=BB6_19 Depth=1
	move	$a6, $zero
	addi.d	$a7, $a5, 12
	.p2align	4, , 16
...
.LBB11_3:                               # %for.body
	...
	ld.w	$a4, $a6, %pc_lo12(tokensetsize)
	slli.d	$a7, $a0, 3
	ldx.d	$t2, $a2, $a7
	move	$t3, $a3
	alsl.d	$a3, $a4, $a3, 2
...
# %bb.5:                                # %for.body5.us.preheader
	...
	addi.d	$t7, $a4, 1
	andi	$t8, $t7, 12
	bstrpick.d	$a4, $t7, 62, 4
	slli.d	$s1, $a4, 4
	slli.d	$s3, $a4, 6
	add.d	$a4, $t3, $s3
	st.d	$a4, $sp, 32                    # 8-byte Folded Spill
	bstrpick.d	$a4, $t7, 62, 2
	slli.d	$s5, $a4, 2
	slli.d	$s6, $a4, 4
	alsl.d	$s7, $a4, $t3, 4
	addi.d	$s4, $t3, 32
...
.LBB16_33:                              # %vector.memcheck83
	...
	slli.d	$fp, $fp, 4
	beqz	$fp, .LBB16_36
# %bb.34:                               # %vector.main.loop.iter.check89
                                        #   in Loop: Header=BB16_31 Depth=1
	bgeu	$a1, $t6, .LBB16_37
...
.LBB16_36:                              #   in Loop: Header=BB16_31 Depth=1
	move	$s0, $s7
	b	.LBB16_44
.LBB16_37:                              # %vector.body93.preheader
                                        #   in Loop: Header=BB16_31 Depth=1
	alsl.d	$s1, $s0, $t2, 2
	move	$s3, $a4
	move	$s6, $t3
	.p2align	4, , 16
.LBB16_38:                              # %vector.body93
	...
	addi.d	$s6, $s6, 64
	bnez	$s3, .LBB16_38
# %bb.39:                               # %middle.block100
                                        #   in Loop: Header=BB16_31 Depth=1
	ld.d	$s6, $sp, 96                    # 8-byte Folded Reload
	beq	$a2, $a4, .LBB16_30
# %bb.40:                               # %vec.epilog.iter.check104
                                        #   in Loop: Header=BB16_31 Depth=1
	move	$s3, $a4
	beqz	$a3, .LBB16_45
.LBB16_41:                              # %vec.epilog.ph106
                                        #   in Loop: Header=BB16_31 Depth=1
	add.d	$t8, $t8, $t0
	slli.d	$fp, $s3, 2
	alsl.d	$fp, $s0, $fp, 2
	...
	add.d	$s3, $t4, $s3
	.p2align	4, , 16
.LBB16_42:                              # %vec.epilog.vector.body109
                                        #   Parent Loop BB16_31 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $s1, 0
	vst	$vr0, $s0, 0
	...
	addi.d	$s1, $s1, 16
	bnez	$s3, .LBB16_42
# %bb.43:                               # %vec.epilog.middle.block117
                                        #   in Loop: Header=BB16_31 Depth=1
	move	$s0, $t1
	beq	$a2, $a7, .LBB16_30
	.p2align	4, , 16
.LBB16_44:                              # %while.body63.us
                                        #   Parent Loop BB16_31 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$fp, $s0, 0
	addi.d	$s1, $s0, 4
