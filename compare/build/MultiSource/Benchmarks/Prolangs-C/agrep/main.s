...
# %bb.0:                                # %entry
	...
	xvld	$xr2, $a1, %pc_lo12(.LCPI1_2)
	pcalau12i	$a1, %pc_hi20(.LCPI1_3)
	xvld	$xr3, $a1, %pc_lo12(.LCPI1_3)
	xvst	$xr0, $a0, 100
	xvst	$xr1, $a0, 68
	xvst	$xr2, $a0, 36
	xvst	$xr3, $a0, 4
...
.LBB3_35:
	move	$a0, $zero
.LBB3_36:                               # %for.body80.preheader104
	add.d	$a3, $fp, $a0
	sub.d	$a0, $a1, $a0
	ori	$a1, $zero, 19
	ori	$a4, $zero, 1
...
.LBB7_24:                               # %for.end35
	...
	st.d	$a1, $sp, 48                    # 8-byte Folded Spill
	beqz	$s1, .LBB7_120
# %bb.25:                               # %while.cond223.preheader
	ld.d	$a4, $sp, 224                   # 8-byte Folded Reload
	blez	$a0, .LBB7_171
# %bb.26:                               # %while.body230.lr.ph
	move	$a0, $zero
	lu12i.w	$a1, 141
	ori	$a1, $a1, 936
	add.d	$a1, $sp, $a1
...
# %bb.32:                               # %if.then246
	...
	st.b	$t4, $sp, 1318
	ori	$fp, $zero, 1023
.LBB7_33:                               # %while.body255.preheader
                                        #   in Loop: Header=BB7_28 Depth=1
	addi.w	$a0, $fp, 1
...
.LBB7_45:                               # %while.cond.i472
	...
	addi.w	$s8, $s8, -1
	blt	$a1, $a2, .LBB7_47
# %bb.46:                               # %while.cond.i472
                                        #   in Loop: Header=BB7_45 Depth=3
	bne	$a0, $a4, .LBB7_45
.LBB7_47:                               # %while.end.i478
                                        #   in Loop: Header=BB7_36 Depth=2
	ld.d	$a1, $sp, 48                    # 8-byte Folded Reload
	ld.w	$a1, $a1, %pc_lo12(LINENUM)
	beqz	$a1, .LBB7_49
# %bb.48:                               # %if.then11.i480
                                        #   in Loop: Header=BB7_36 Depth=2
...
.LBB7_49:                               # %if.end13.i484
	...
	move	$s8, $s1
	blt	$fp, $s4, .LBB7_52
# %bb.50:                               # %while.body25.preheader.i488
                                        #   in Loop: Header=BB7_36 Depth=2
	addi.d	$a0, $sp, 295
	add.d	$s1, $a0, $s4
	.p2align	4, , 16
.LBB7_51:                               # %while.body25.i489
                                        #   Parent Loop BB7_28 Depth=1
                                        #     Parent Loop BB7_36 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.bu	$a0, $s1, 0
...
.LBB7_52:                               # %iter.check667
	...
	ori	$a2, $zero, 4
	bgeu	$a1, $a2, .LBB7_59
# %bb.53:                               #   in Loop: Header=BB7_36 Depth=2
	move	$a2, $zero
	ld.d	$t3, $sp, 200                   # 8-byte Folded Reload
	ori	$t4, $zero, 10
...
# %bb.58:                               # %if.end362
	...
	b	.LBB7_65
	.p2align	4, , 16
.LBB7_59:                               # %vector.main.loop.iter.check669
                                        #   in Loop: Header=BB7_36 Depth=2
	ori	$t4, $zero, 10
	ori	$a2, $zero, 16
	bgeu	$a1, $a2, .LBB7_66
# %bb.60:                               #   in Loop: Header=BB7_36 Depth=2
	move	$a3, $zero
	ld.d	$t3, $sp, 200                   # 8-byte Folded Reload
	ld.d	$t5, $sp, 208                   # 8-byte Folded Reload
	b	.LBB7_70
...
# %bb.68:                               # %middle.block678
	...
	ld.d	$t5, $sp, 208                   # 8-byte Folded Reload
	beq	$a2, $a1, .LBB7_75
# %bb.69:                               # %vec.epilog.iter.check682
                                        #   in Loop: Header=BB7_36 Depth=2
	ld.d	$a2, $sp, 152                   # 8-byte Folded Reload
	move	$a3, $a2
	ld.d	$a1, $sp, 32                    # 8-byte Folded Reload
	beqz	$a1, .LBB7_73
.LBB7_70:                               # %vec.epilog.ph684
                                        #   in Loop: Header=BB7_36 Depth=2
	vreplgr2vr.w	$vr0, $a0
	ld.d	$a1, $sp, 120                   # 8-byte Folded Reload
	add.d	$a1, $a1, $a3
	...
	alsl.d	$a2, $a3, $a2, 2
	.p2align	4, , 16
.LBB7_71:                               # %vec.epilog.vector.body689
                                        #   Parent Loop BB7_28 Depth=1
                                        #     Parent Loop BB7_36 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vst	$vr0, $a2, 0
	...
	addi.d	$a2, $a2, 16
	bnez	$a1, .LBB7_71
# %bb.72:                               # %vec.epilog.middle.block692
                                        #   in Loop: Header=BB7_36 Depth=2
	ld.d	$a3, $sp, 128                   # 8-byte Folded Reload
	move	$a2, $a3
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	beq	$a3, $a1, .LBB7_75
.LBB7_73:                               # %for.body527.preheader
                                        #   in Loop: Header=BB7_36 Depth=2
	lu12i.w	$a1, 141
	ori	$a1, $a1, 936
	add.d	$a1, $sp, $a1
...
.LBB7_76:                               # %for.body550
	...
	move	$a2, $a7
	bnez	$a3, .LBB7_76
# %bb.77:                               #   in Loop: Header=BB7_36 Depth=2
	addi.d	$t2, $sp, 295
.LBB7_78:                               # %Nextchar
                                        #   in Loop: Header=BB7_36 Depth=2
	addi.w	$s1, $fp, 1
...
# %bb.86:                               # %if.then4.i504
	...
	ori	$t4, $zero, 10
	addi.d	$t2, $sp, 295
.LBB7_87:                               # %if.end5.i506
                                        #   in Loop: Header=BB7_36 Depth=2
	move	$s4, $t5
	move	$s8, $s1
	ori	$a2, $zero, 2
	.p2align	4, , 16
.LBB7_88:                               # %while.cond.i507
                                        #   Parent Loop BB7_28 Depth=1
                                        #     Parent Loop BB7_36 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	move	$a1, $s8
	...
	addi.w	$s4, $s4, -1
	blt	$a1, $a2, .LBB7_90
# %bb.89:                               # %while.cond.i507
                                        #   in Loop: Header=BB7_88 Depth=3
	bne	$a0, $t4, .LBB7_88
.LBB7_90:                               # %while.end.i513
                                        #   in Loop: Header=BB7_36 Depth=2
	ld.d	$a1, $sp, 48                    # 8-byte Folded Reload
	ld.w	$a1, $a1, %pc_lo12(LINENUM)
	beqz	$a1, .LBB7_92
# %bb.91:                               # %if.then11.i515
                                        #   in Loop: Header=BB7_36 Depth=2
	pcalau12i	$a0, %pc_hi20(.L.str.26)
	addi.d	$a0, $a0, %pc_lo12(.L.str.26)
...
.LBB7_92:                               # %if.end13.i519
	...
	blt	$s1, $s4, .LBB7_95
# %bb.93:                               # %while.body25.preheader.i523
                                        #   in Loop: Header=BB7_36 Depth=2
	add.d	$s1, $t2, $s4
	.p2align	4, , 16
.LBB7_94:                               # %while.body25.i524
                                        #   Parent Loop BB7_28 Depth=1
                                        #     Parent Loop BB7_36 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.bu	$a0, $s1, 0
	...
	bne	$t5, $s4, .LBB7_94
	.p2align	4, , 16
.LBB7_95:                               # %iter.check639
                                        #   in Loop: Header=BB7_36 Depth=2
	ld.d	$a3, $sp, 224                   # 8-byte Folded Reload
	ld.d	$a0, $sp, 192                   # 8-byte Folded Reload
	ori	$a1, $zero, 4
	bgeu	$a0, $a1, .LBB7_102
# %bb.96:                               #   in Loop: Header=BB7_36 Depth=2
	move	$a1, $zero
	ld.d	$s1, $sp, 216                   # 8-byte Folded Reload
	b	.LBB7_115
	.p2align	4, , 16
...
# %bb.101:                              # %if.end696
	...
	b	.LBB7_34
	.p2align	4, , 16
.LBB7_102:                              # %vector.main.loop.iter.check641
                                        #   in Loop: Header=BB7_36 Depth=2
	ld.d	$s1, $sp, 216                   # 8-byte Folded Reload
	xvld	$xr0, $sp, 80                   # 32-byte Folded Reload
	ori	$a1, $zero, 16
	bgeu	$a0, $a1, .LBB7_108
# %bb.103:                              #   in Loop: Header=BB7_36 Depth=2
	move	$a2, $zero
...
# %bb.107:                              # %if.end785
	...
	or	$a0, $a1, $a0
	b	.LBB7_34
.LBB7_108:                              # %vector.body645.preheader
                                        #   in Loop: Header=BB7_36 Depth=2
	lu12i.w	$a0, 141
	ori	$a0, $a0, 992
	add.d	$a0, $sp, $a0
...
.LBB7_109:                              # %vector.body645
	...
	addi.d	$a0, $a0, 64
	bnez	$a1, .LBB7_109
# %bb.110:                              # %middle.block648
                                        #   in Loop: Header=BB7_36 Depth=2
	ld.d	$a0, $sp, 240                   # 8-byte Folded Reload
	ld.d	$a1, $sp, 152                   # 8-byte Folded Reload
	vld	$vr0, $sp, 64                   # 16-byte Folded Reload
	beq	$a1, $a0, .LBB7_117
# %bb.111:                              # %vec.epilog.iter.check652
                                        #   in Loop: Header=BB7_36 Depth=2
	ld.d	$a1, $sp, 152                   # 8-byte Folded Reload
	move	$a2, $a1
	ld.d	$a0, $sp, 32                    # 8-byte Folded Reload
	beqz	$a0, .LBB7_115
.LBB7_112:                              # %vec.epilog.ph654
                                        #   in Loop: Header=BB7_36 Depth=2
	ld.d	$a0, $sp, 120                   # 8-byte Folded Reload
	add.d	$a0, $a0, $a2
	lu12i.w	$a1, 141
	...
	alsl.d	$a1, $a2, $a1, 2
	.p2align	4, , 16
.LBB7_113:                              # %vec.epilog.vector.body659
                                        #   Parent Loop BB7_28 Depth=1
                                        #     Parent Loop BB7_36 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vst	$vr0, $a1, 0
	...
	addi.d	$a1, $a1, 16
	bnez	$a0, .LBB7_113
# %bb.114:                              # %vec.epilog.middle.block662
                                        #   in Loop: Header=BB7_36 Depth=2
	ld.d	$a2, $sp, 128                   # 8-byte Folded Reload
	move	$a1, $a2
	ld.d	$a0, $sp, 240                   # 8-byte Folded Reload
	beq	$a2, $a0, .LBB7_117
.LBB7_115:                              # %for.body861.preheader
                                        #   in Loop: Header=BB7_36 Depth=2
	lu12i.w	$a0, 141
	ori	$a0, $a0, 960
	add.d	$a0, $sp, $a0
...
.LBB7_116:                              # %for.body861
	...
	addi.d	$a0, $a0, 4
	bnez	$a1, .LBB7_116
.LBB7_117:                              # %for.body884.preheader
                                        #   in Loop: Header=BB7_36 Depth=2
	lu12i.w	$a0, 141
	ori	$a0, $a0, 960
	add.d	$a0, $sp, $a0
...
.LBB7_118:                              # %for.body884
	...
	move	$a2, $a6
	bnez	$a1, .LBB7_118
# %bb.119:                              #   in Loop: Header=BB7_36 Depth=2
	ld.d	$t3, $sp, 200                   # 8-byte Folded Reload
	b	.LBB7_35
.LBB7_120:                              # %while.cond.preheader
	ld.d	$s8, $sp, 224                   # 8-byte Folded Reload
	blez	$a0, .LBB7_171
# %bb.121:                              # %while.body.lr.ph
	move	$a0, $zero
	srl.w	$a1, $s8, $s6
	bstrpick.d	$a1, $a1, 31, 0
	lu12i.w	$a2, 76
...
.LBB7_123:                              # %while.body
                                        ...
                                        #       Child Loop BB7_140 Depth 3
                                        #       Child Loop BB7_146 Depth 3
                                        #       Child Loop BB7_160 Depth 3
                                        #       Child Loop BB7_166 Depth 3
	bstrpick.d	$a2, $a1, 31, 14
	addi.w	$a1, $a1, 1024
	st.d	$a1, $sp, 280                   # 8-byte Folded Spill
	bltu	$a3, $a2, .LBB7_126
# %bb.124:                              # %land.lhs.true
                                        #   in Loop: Header=BB7_123 Depth=1
	addi.d	$a1, $a5, 1023
	bstrpick.d	$a1, $a1, 16, 0
	ldx.bu	$a1, $a1, $s5
...
# %bb.127:                              # %if.then69
	...
	st.b	$t0, $sp, 1318
	ori	$s2, $zero, 1023
.LBB7_128:                              # %while.body78.preheader
                                        #   in Loop: Header=BB7_123 Depth=1
	addi.w	$fp, $s2, 1
	addi.w	$s1, $s2, 2
	b	.LBB7_131
...
.LBB7_139:                              # %if.end5.i
	...
	ori	$a3, $zero, 10
	.p2align	4, , 16
.LBB7_140:                              # %while.cond.i
                                        #   Parent Loop BB7_123 Depth=1
                                        #     Parent Loop BB7_131 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	move	$a1, $s4
	add.d	$a0, $s5, $s4
	ld.bu	$a0, $a0, -1
	...
	blt	$a1, $a2, .LBB7_142
# %bb.141:                              # %while.cond.i
                                        #   in Loop: Header=BB7_140 Depth=3
	bne	$a0, $a3, .LBB7_140
.LBB7_142:                              # %while.end.i
                                        #   in Loop: Header=BB7_131 Depth=2
	ld.d	$a1, $sp, 48                    # 8-byte Folded Reload
	ld.w	$a1, $a1, %pc_lo12(LINENUM)
	beqz	$a1, .LBB7_144
...
.LBB7_144:                              # %if.end13.i
	...
	or	$s3, $a0, $a1
	blt	$s2, $s3, .LBB7_147
# %bb.145:                              # %while.body25.preheader.i
                                        #   in Loop: Header=BB7_131 Depth=2
	add.d	$s4, $s5, $s3
	.p2align	4, , 16
.LBB7_146:                              # %while.body25.i
                                        #   Parent Loop BB7_123 Depth=1
                                        #     Parent Loop BB7_131 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.bu	$a0, $s4, 0
...
# %bb.158:                              # %if.then4.i434
	...
	ori	$a0, $a0, 3176
	add.d	$a6, $sp, $a0
.LBB7_159:                              # %if.end5.i436
                                        #   in Loop: Header=BB7_131 Depth=2
	move	$s8, $s1
	move	$s4, $s3
	ori	$a2, $zero, 2
	.p2align	4, , 16
.LBB7_160:                              # %while.cond.i437
                                        #   Parent Loop BB7_123 Depth=1
                                        #     Parent Loop BB7_131 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	move	$a1, $s4
	...
	addi.w	$s8, $s8, -1
	blt	$a1, $a2, .LBB7_162
# %bb.161:                              # %while.cond.i437
                                        #   in Loop: Header=BB7_160 Depth=3
	bne	$a0, $t0, .LBB7_160
.LBB7_162:                              # %while.end.i443
                                        #   in Loop: Header=BB7_131 Depth=2
	ld.d	$a1, $sp, 48                    # 8-byte Folded Reload
	ld.w	$a1, $a1, %pc_lo12(LINENUM)
	beqz	$a1, .LBB7_164
# %bb.163:                              # %if.then11.i445
                                        #   in Loop: Header=BB7_131 Depth=2
	pcalau12i	$a0, %pc_hi20(.L.str.26)
	addi.d	$a0, $a0, %pc_lo12(.L.str.26)
	ld.d	$a1, $sp, 40                    # 8-byte Folded Reload
...
.LBB7_164:                              # %if.end13.i449
	...
	ld.d	$s8, $sp, 40                    # 8-byte Folded Reload
	blt	$s3, $s4, .LBB7_129
# %bb.165:                              # %while.body25.preheader.i453
                                        #   in Loop: Header=BB7_131 Depth=2
	add.d	$s3, $s5, $s4
	.p2align	4, , 16
.LBB7_166:                              # %while.body25.i454
                                        #   Parent Loop BB7_123 Depth=1
                                        #     Parent Loop BB7_131 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.bu	$a0, $s3, 0
