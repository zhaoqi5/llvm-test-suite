...
# %bb.59:                               # %if.end362
	...
	b	.LBB7_66
	.p2align	4, , 16
.LBB7_60:                               # %vector.main.loop.iter.check667
                                        #   in Loop: Header=BB7_37 Depth=2
	ori	$t4, $zero, 10
	ori	$a2, $zero, 16
	bgeu	$a1, $a2, .LBB7_67
...
# %bb.69:                               # %middle.block676
	...
	ld.d	$t5, $sp, 208                   # 8-byte Folded Reload
	beq	$a2, $a1, .LBB7_76
# %bb.70:                               # %vec.epilog.iter.check681
                                        #   in Loop: Header=BB7_37 Depth=2
	ld.d	$a2, $sp, 152                   # 8-byte Folded Reload
	move	$a3, $a2
	ld.d	$a1, $sp, 32                    # 8-byte Folded Reload
	beqz	$a1, .LBB7_74
.LBB7_71:                               # %vec.epilog.ph680
                                        #   in Loop: Header=BB7_37 Depth=2
	vreplgr2vr.w	$vr0, $a0
	ld.d	$a1, $sp, 120                   # 8-byte Folded Reload
	add.d	$a1, $a1, $a3
	...
	alsl.d	$a2, $a3, $a2, 2
	.p2align	4, , 16
.LBB7_72:                               # %vec.epilog.vector.body688
                                        #   Parent Loop BB7_29 Depth=1
                                        #     Parent Loop BB7_37 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vst	$vr0, $a2, 0
	...
	addi.d	$a2, $a2, 16
	bnez	$a1, .LBB7_72
# %bb.73:                               # %vec.epilog.middle.block691
                                        #   in Loop: Header=BB7_37 Depth=2
...
# %bb.102:                              # %if.end696
	...
	b	.LBB7_35
	.p2align	4, , 16
.LBB7_103:                              # %vector.main.loop.iter.check638
                                        #   in Loop: Header=BB7_37 Depth=2
	ld.d	$s1, $sp, 216                   # 8-byte Folded Reload
...
# %bb.108:                              # %if.end785
	...
	or	$a0, $a1, $a0
	b	.LBB7_35
.LBB7_109:                              # %vector.body642.preheader
                                        #   in Loop: Header=BB7_37 Depth=2
	lu12i.w	$a0, 141
	ori	$a0, $a0, 992
	add.d	$a0, $sp, $a0
...
.LBB7_110:                              # %vector.body642
	...
	addi.d	$a0, $a0, 64
	bnez	$a1, .LBB7_110
# %bb.111:                              # %middle.block645
                                        #   in Loop: Header=BB7_37 Depth=2
	ld.d	$a0, $sp, 232                   # 8-byte Folded Reload
	ld.d	$a1, $sp, 152                   # 8-byte Folded Reload
	vld	$vr0, $sp, 64                   # 16-byte Folded Reload
	beq	$a1, $a0, .LBB7_118
# %bb.112:                              # %vec.epilog.iter.check650
                                        #   in Loop: Header=BB7_37 Depth=2
	ld.d	$a1, $sp, 152                   # 8-byte Folded Reload
	move	$a2, $a1
	ld.d	$a0, $sp, 32                    # 8-byte Folded Reload
	beqz	$a0, .LBB7_116
.LBB7_113:                              # %vec.epilog.ph649
                                        #   in Loop: Header=BB7_37 Depth=2
	ld.d	$a0, $sp, 120                   # 8-byte Folded Reload
	add.d	$a0, $a0, $a2
	lu12i.w	$a1, 141
	...
	alsl.d	$a1, $a2, $a1, 2
	.p2align	4, , 16
.LBB7_114:                              # %vec.epilog.vector.body657
                                        #   Parent Loop BB7_29 Depth=1
                                        #     Parent Loop BB7_37 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vst	$vr0, $a1, 0
	...
	addi.d	$a1, $a1, 16
	bnez	$a0, .LBB7_114
# %bb.115:                              # %vec.epilog.middle.block660
                                        #   in Loop: Header=BB7_37 Depth=2
