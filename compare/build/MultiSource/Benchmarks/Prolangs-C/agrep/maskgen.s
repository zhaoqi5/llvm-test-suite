...
# %bb.11:                               # %for.body50
                                        #   in Loop: Header=BB0_10 Depth=1
	slli.d	$a4, $a4, 2
	pcalau12i	$s7, %pc_hi20(.LJTI0_0)
	addi.d	$s7, $s7, %pc_lo12(.LJTI0_0)
	ldx.w	$a4, $s7, $a4
	add.d	$a4, $s7, $a4
	jr	$a4
.LBB0_12:                               # %sw.bb253
...
.LBB0_55:                               # %vec.epilog.ph
	...
	sub.d	$t0, $t0, $t2
	.p2align	4, , 16
.LBB0_56:                               # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a7, 0
	vor.v	$vr0, $vr1, $vr0
	addi.d	$t0, $t0, 4
...
.LBB0_61:                               # %for.end334
	...
	st.w	$a3, $s3, 0
	blt	$a0, $a4, .LBB0_85
# %bb.62:                               # %for.cond347.preheader.us.preheader
	...
	b	.LBB0_64
	.p2align	4, , 16
.LBB0_63:                               # %for.cond347.for.inc435_crit_edge.us
                                        #   in Loop: Header=BB0_64 Depth=1
	addi.d	$a3, $a3, 1
	beq	$a3, $t3, .LBB0_85
.LBB0_64:                               # %for.cond347.preheader.us
                                        # =>This Loop Header: Depth=1
	...
	alsl.d	$t4, $a3, $a7, 2
	beqz	$t5, .LBB0_76
# %bb.65:                               # %while.cond351.preheader.us.us.preheader
                                        #   in Loop: Header=BB0_64 Depth=1
	ori	$t5, $zero, 1
	move	$t6, $a5
	b	.LBB0_67
	.p2align	4, , 16
.LBB0_66:                               # %for.inc432.us.us
                                        #   in Loop: Header=BB0_67 Depth=2
	addi.d	$t5, $t5, 1
	addi.d	$t6, $t6, 36
	beq	$t5, $a0, .LBB0_63
.LBB0_67:                               # %while.cond351.preheader.us.us
	...
	b	.LBB0_69
	.p2align	4, , 16
.LBB0_68:                               # %if.end414.us.us.us
                                        #   in Loop: Header=BB0_69 Depth=3
	addi.d	$t8, $t8, 2
.LBB0_69:                               # %while.cond351.us.us.us
                                        #   Parent Loop BB0_64 Depth=1
                                        #     Parent Loop BB0_67 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.bu	$s0, $t8, -1
	beqz	$s0, .LBB0_74
# %bb.70:                               # %while.cond351.us.us.us
                                        #   in Loop: Header=BB0_69 Depth=3
	beq	$s0, $t2, .LBB0_73
# %bb.71:                               # %if.end384.us.us.us
                                        #   in Loop: Header=BB0_69 Depth=3
	bltu	$a3, $s0, .LBB0_68
# %bb.72:                               # %land.lhs.true394.us.us.us
                                        #   in Loop: Header=BB0_69 Depth=3
	ld.bu	$s0, $t8, 0
	bltu	$s0, $a3, .LBB0_68
.LBB0_73:                               # %while.end416.us.us.sink.split
                                        #   in Loop: Header=BB0_67 Depth=2
	ld.w	$t8, $t4, 0
	add.d	$s0, $t5, $a2
	slli.d	$s0, $s0, 2
	...
	or	$t8, $s0, $t8
	st.w	$t8, $t4, 0
.LBB0_74:                               # %while.end416.us.us
                                        #   in Loop: Header=BB0_67 Depth=2
	ld.w	$t7, $t7, 0
	bne	$t7, $t1, .LBB0_66
# %bb.75:                               # %if.then422.us.us
                                        #   in Loop: Header=BB0_67 Depth=2
	ld.w	$t7, $t4, 0
	add.d	$t8, $t5, $a2
	slli.d	$t8, $t8, 2
	...
	b	.LBB0_66
	.p2align	4, , 16
.LBB0_76:                               # %while.cond351.preheader.us225.preheader
                                        #   in Loop: Header=BB0_64 Depth=1
	ori	$t5, $zero, 1
	move	$t6, $a4
	b	.LBB0_78
	.p2align	4, , 16
.LBB0_77:                               # %for.inc432.us222
                                        #   in Loop: Header=BB0_78 Depth=2
	addi.d	$t5, $t5, 1
	addi.d	$t6, $t6, 36
	beq	$t5, $a0, .LBB0_63
.LBB0_78:                               # %while.cond351.preheader.us225
                                        #   Parent Loop BB0_64 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB0_82 Depth 3
	slli.d	$t7, $t5, 5
	...
	move	$t8, $t6
	bnez	$s0, .LBB0_82
.LBB0_79:                               # %while.end416.us215
                                        #   in Loop: Header=BB0_78 Depth=2
	ld.w	$t7, $t7, 0
	bne	$t7, $t1, .LBB0_77
.LBB0_80:                               # %if.then422.us217
                                        #   in Loop: Header=BB0_78 Depth=2
	ld.w	$t7, $t4, 0
	add.d	$t8, $t5, $a2
	slli.d	$t8, $t8, 2
	...
	b	.LBB0_77
	.p2align	4, , 16
.LBB0_81:                               # %if.end414.us
                                        #   in Loop: Header=BB0_82 Depth=3
	ld.bu	$s0, $t8, 0
	addi.d	$t8, $t8, 2
	beqz	$s0, .LBB0_79
.LBB0_82:                               # %if.end384.us
                                        #   Parent Loop BB0_64 Depth=1
                                        #     Parent Loop BB0_78 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	bltu	$a3, $s0, .LBB0_81
# %bb.83:                               # %land.lhs.true394.us
                                        #   in Loop: Header=BB0_82 Depth=3
	ld.bu	$s0, $t8, -1
	bltu	$s0, $a3, .LBB0_81
# %bb.84:                               # %if.then405.split.us
                                        #   in Loop: Header=BB0_78 Depth=2
	ld.w	$t8, $t4, 0
	add.d	$s0, $t5, $a2
	slli.d	$s0, $s0, 2
