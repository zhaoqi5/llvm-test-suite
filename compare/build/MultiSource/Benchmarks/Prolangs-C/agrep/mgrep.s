...
# %bb.20:                               # %if.end35
                                        #   in Loop: Header=BB1_13 Depth=2
	beqz	$a2, .LBB1_23
# %bb.21:                               # %while.cond38.preheader
                                        #   in Loop: Header=BB1_13 Depth=2
	addi.d	$s3, $s3, -1
	.p2align	4, , 16
.LBB1_22:                               # %while.cond38
                                        #   Parent Loop BB1_10 Depth=1
                                        #     Parent Loop BB1_13 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.bu	$a5, $s3, 1
...
# %bb.28:                               # %while.end74
                                        #   in Loop: Header=BB1_10 Depth=1
	bgeu	$s1, $s3, .LBB1_32
# %bb.29:                               # %while.body82.preheader
                                        #   in Loop: Header=BB1_10 Depth=1
	st.d	$t3, $sp, 24                    # 8-byte Folded Spill
	st.d	$s5, $sp, 8                     # 8-byte Folded Spill
	.p2align	4, , 16
.LBB1_30:                               # %while.body82
                                        #   Parent Loop BB1_10 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.bu	$a0, $s1, 0
	addi.d	$s4, $s1, 1
...
# %bb.33:                               # %while.end97
	...
	b	.LBB1_9
.LBB1_34:                               # %while.cond50.preheader
                                        #   in Loop: Header=BB1_10 Depth=1
	addi.d	$s3, $s3, 1
	ld.d	$s4, $sp, 32                    # 8-byte Folded Reload
	.p2align	4, , 16
.LBB1_35:                               # %while.cond50
                                        #   Parent Loop BB1_10 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.bu	$a0, $s3, -2
	addi.d	$s3, $s3, -1
	bne	$a0, $s8, .LBB1_35
# %bb.36:                               # %while.cond57.preheader
                                        #   in Loop: Header=BB1_10 Depth=1
	ld.bu	$a0, $s3, 0
	st.d	$t3, $sp, 24                    # 8-byte Folded Spill
	move	$s0, $t4
...
.LBB4_7:                                # %while.body.lr.ph
	...
	pcalau12i	$a0, %pc_hi20(SHIFT1)
	addi.d	$t4, $a0, %pc_lo12(SHIFT1)
	pcalau12i	$a0, %pc_hi20(HASH)
	addi.d	$t5, $a0, %pc_lo12(HASH)
	pcalau12i	$a0, %pc_hi20(tr)
...
# %bb.46:                               # %while.cond96.preheader
	...
	ld.bu	$a0, $s2, 0
	beq	$a0, $a1, .LBB4_8
# %bb.47:                               # %while.body101.preheader
                                        #   in Loop: Header=BB4_11 Depth=1
	ori	$s1, $zero, 10
	.p2align	4, , 16
.LBB4_48:                               # %while.body101
                                        #   Parent Loop BB4_11 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	pcalau12i	$a1, %got_pc_hi20(stdout)
	ld.d	$a1, $a1, %got_pc_lo12(stdout)
