...
# %bb.2:                                # %for.body.preheader
	pcalau12i	$a5, %pc_hi20(SHIFT1)
	addi.d	$a5, $a5, %pc_lo12(SHIFT1)
	move	$a6, $a3
	b	.LBB2_4
	.p2align	4, , 16
.LBB2_3:                                # %for.inc
...
.LBB2_6:                                # %for.body.us.preheader
	pcalau12i	$a4, %pc_hi20(SHIFT1)
	addi.d	$a4, $a4, %pc_lo12(SHIFT1)
	ori	$a5, $zero, 2
	move	$a6, $a3
	b	.LBB2_8
	.p2align	4, , 16
...
# %bb.11:                               # %for.body35.preheader
	...
	maskeqz	$a3, $a5, $a3
	or	$a3, $a3, $a4
	pcalau12i	$a4, %pc_hi20(tr)
	addi.d	$a4, $a4, %pc_lo12(tr)
	addi.w	$a5, $zero, -1
	.p2align	4, , 16
.LBB2_12:                               # %for.body35
                                        # =>This Inner Loop Header: Depth=1
...
.LBB2_15:                               # %for.end46
	...
	slli.d	$a2, $s0, 3
	pcalau12i	$a3, %pc_hi20(HASH)
	addi.d	$a3, $a3, %pc_lo12(HASH)
	ldx.d	$a4, $a3, $a2
	st.d	$a0, $a1, %pc_lo12(qt)
	st.w	$fp, $a0, 0
	pcalau12i	$a1, %pc_hi20(pt)
	st.d	$a4, $a1, %pc_lo12(pt)
	st.d	$a4, $a0, 8
	stx.d	$a0, $a3, $a2
...
# %bb.5:                                # %while.body8.preheader
	...
	addi.d	$a1, $a1, %pc_lo12(pat_spool)
	ori	$s0, $zero, 1
	pcalau12i	$a2, %got_pc_hi20(WORDBOUND)
	ld.d	$a2, $a2, %got_pc_lo12(WORDBOUND)
	pcalau12i	$a4, %got_pc_hi20(WHOLELINE)
	ld.d	$a4, $a4, %got_pc_lo12(WHOLELINE)
	pcalau12i	$a5, %pc_hi20(patt)
	addi.d	$a5, $a5, %pc_lo12(patt)
	ori	$a6, $zero, 128
	b	.LBB3_7
	.p2align	4, , 16
.LBB3_6:                                # %if.end33
...
.LBB3_19:
	...
	addi.d	$a1, $a0, %pc_lo12(pat_spool)
.LBB3_20:                               # %for.cond.preheader
	...
	xvld	$xr1, $a0, %pc_lo12(.LCPI3_3)
	pcalau12i	$a0, %pc_hi20(.LCPI3_4)
	xvld	$xr2, $a0, %pc_lo12(.LCPI3_4)
	pcalau12i	$a0, %pc_hi20(.LCPI3_5)
	xvld	$xr3, $a0, %pc_lo12(.LCPI3_5)
	xvst	$xr0, $s1, 64
	xvst	$xr1, $s1, 96
	xvst	$xr2, $s1, 128
	xvst	$xr3, $s1, 160
	pcalau12i	$a0, %pc_hi20(.LCPI3_6)
	pcalau12i	$a2, %got_pc_hi20(NOUPPER)
	ld.d	$a2, $a2, %got_pc_lo12(NOUPPER)
	xvld	$xr0, $a0, %pc_lo12(.LCPI3_6)
	pcalau12i	$a0, %pc_hi20(.LCPI3_7)
	xvld	$xr1, $a0, %pc_lo12(.LCPI3_7)
	ld.w	$a0, $a2, 0
	xvst	$xr0, $s1, 192
	ori	$a2, $zero, 19
	st.b	$a2, $a1, 0
...
# %bb.28:                               # %for.body107.preheader
	...
	addi.d	$s3, $a0, %pc_lo12(pat_len+1)
	pcalau12i	$a0, %pc_hi20(patt+8)
	addi.d	$s4, $a0, %pc_lo12(patt+8)
	addi.d	$s5, $s0, -1
	ori	$s1, $zero, 256
	b	.LBB3_30
	.p2align	4, , 16
