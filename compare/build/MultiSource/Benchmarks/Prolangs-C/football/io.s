...
# %bb.8:                                # %for.body.us13.preheader
	...
	b	.LBB12_11
	.p2align	4, , 16
.LBB12_9:                               # %if.else.us26
                                        #   in Loop: Header=BB12_11 Depth=1
	addi.w	$a5, $a5, 1
.LBB12_10:                              # %for.inc.us28
                                        #   in Loop: Header=BB12_11 Depth=1
	addi.d	$a6, $a6, 4
	beq	$a6, $a7, .LBB12_20
.LBB12_11:                              # %for.body.us13
                                        # =>This Inner Loop Header: Depth=1
	ldx.w	$a4, $a0, $a6
	slli.d	$t0, $a4, 3
	ldx.w	$t0, $a2, $t0
	bne	$t0, $a1, .LBB12_10
# %bb.12:                               # %land.lhs.true.us20
                                        #   in Loop: Header=BB12_11 Depth=1
	bne	$a5, $a3, .LBB12_9
.LBB12_13:                              # %cleanup
	move	$a0, $a4
	ret
.LBB12_14:                              # %for.body.preheader
...
.LBB13_9:                               # %land.lhs.true.preheader
	...
	ori	$a1, $zero, 1
	bne	$a4, $fp, .LBB13_12
.LBB13_10:                              # %for.end.split.loop.exit249
                                        #   in Loop: Header=BB13_4 Depth=1
	move	$a4, $a1
	addi.w	$a4, $a4, 0
	ori	$a5, $zero, 15
...
.LBB13_23:                              # %sw.bb108
	...
	addi.w	$a0, $s2, -2
	bne	$a2, $s5, .LBB13_30
# %bb.24:                               # %for.body.us.i.preheader
                                        #   in Loop: Header=BB13_4 Depth=1
	ori	$a2, $zero, 1
	ori	$a3, $zero, 4
	b	.LBB13_26
	.p2align	4, , 16
.LBB13_25:                              # %for.inc.us.i
                                        #   in Loop: Header=BB13_26 Depth=2
	addi.d	$a3, $a3, 4
	beq	$a3, $s6, .LBB13_3
.LBB13_26:                              # %for.body.us.i
                                        #   Parent Loop BB13_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.w	$s4, $s7, $a3
	beq	$a1, $s5, .LBB13_28
...
# %bb.29:                               # %if.else.us.i
	...
	addi.w	$a2, $a2, 1
	b	.LBB13_25
.LBB13_30:                              # %entry.split.i
                                        #   in Loop: Header=BB13_4 Depth=1
	bne	$a1, $s5, .LBB13_36
# %bb.31:                               # %for.body.us13.i.preheader
                                        #   in Loop: Header=BB13_4 Depth=1
	ori	$a1, $zero, 1
	ori	$a3, $zero, 4
	b	.LBB13_34
	.p2align	4, , 16
.LBB13_32:                              # %if.else.us26.i
                                        #   in Loop: Header=BB13_34 Depth=2
	addi.w	$a1, $a1, 1
.LBB13_33:                              # %for.inc.us28.i
                                        #   in Loop: Header=BB13_34 Depth=2
	addi.d	$a3, $a3, 4
	beq	$a3, $s6, .LBB13_3
.LBB13_34:                              # %for.body.us13.i
                                        #   Parent Loop BB13_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.w	$s4, $s7, $a3
	slli.d	$a4, $s4, 3
	ldx.w	$a4, $s1, $a4
	bne	$a4, $a2, .LBB13_33
# %bb.35:                               # %land.lhs.true.us20.i
                                        #   in Loop: Header=BB13_34 Depth=2
	bne	$a1, $a0, .LBB13_32
	b	.LBB13_42
.LBB13_36:                              # %for.body.i.preheader
                                        #   in Loop: Header=BB13_4 Depth=1
	ori	$a3, $zero, 1
	ori	$a4, $zero, 4
	b	.LBB13_39
...
# %bb.41:                               # %if.then.i
                                        #   in Loop: Header=BB13_39 Depth=2
	bne	$a3, $a0, .LBB13_37
.LBB13_42:                              # %find_nth_place_team.exit
                                        #   in Loop: Header=BB13_4 Depth=1
	beqz	$s4, .LBB13_3
# %bb.43:                               # %if.then116
                                        #   in Loop: Header=BB13_4 Depth=1
...
.LJTI13_0:
	...
	.word	.LBB13_67-.LJTI13_0
	.word	.LBB13_58-.LJTI13_0
	.word	.LBB13_45-.LJTI13_0
	.word	.LBB13_46-.LJTI13_0
	.word	.LBB13_55-.LJTI13_0
	.word	.LBB13_51-.LJTI13_0
	.word	.LBB13_70-.LJTI13_0
                                        # -- End function
	.text
...
.LBB25_35:
	...
	pcalau12i	$a1, %pc_hi20(.L.str.22)
	addi.d	$a7, $a1, %pc_lo12(.L.str.22)
.LBB25_36:                              # %cond.end1074
	vldi	$vr1, -928
	fmadd.d	$fa0, $fa0, $fs0, $fa1
	ftintrz.w.d	$fa0, $fa0
	movfr2gr.s	$t0, $fa0
.LBB25_37:                              # %cond.end1077
	ld.w	$a1, $a0, 12
	ld.w	$a0, $a0, 16
	st.d	$a0, $sp, 16
	st.d	$a1, $sp, 8
...
.LBB25_43:
	...
	pcalau12i	$a1, %pc_hi20(.L.str.22)
	addi.d	$a7, $a1, %pc_lo12(.L.str.22)
.LBB25_44:                              # %cond.end1230
	vldi	$vr1, -928
	fmadd.d	$fa0, $fa0, $fs0, $fa1
	ftintrz.w.d	$fa0, $fa0
	movfr2gr.s	$t1, $fa0
.LBB25_45:                              # %cond.end1233
	ld.w	$t0, $a0, 12
	ld.w	$a0, $a0, 16
	st.d	$a0, $sp, 16
	st.d	$t0, $sp, 8
	...
	b	.LBB25_48
	.p2align	4, , 16
.LBB25_46:                              # %cond.end1696
                                        #   in Loop: Header=BB25_48 Depth=1
	vldi	$vr1, -928
	fmadd.d	$fa0, $fa0, $fs0, $fa1
	ftintrz.w.d	$fa0, $fa0
	movfr2gr.s	$t0, $fa0
.LBB25_47:                              # %cond.end1699
                                        #   in Loop: Header=BB25_48 Depth=1
	ld.w	$a1, $a0, 12
	ld.w	$a0, $a0, 16
	ori	$a2, $zero, 30
