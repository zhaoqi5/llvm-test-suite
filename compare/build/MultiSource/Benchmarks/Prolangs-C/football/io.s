...
# %bb.184:                              # %middle.block
	...
	sltui	$a2, $a2, 1
	beq	$a1, $s8, .LBB27_187
.LBB27_185:                             # %for.body.preheader598
                                        #   in Loop: Header=BB27_162 Depth=2
	addi.d	$a3, $sp, 136
	alsl.d	$a3, $a1, $a3, 2
	sub.d	$a1, $s8, $a1
...
.LBB27_189:                             # %if.end93
	...
	ori	$a0, $zero, 1
	bne	$a1, $a2, .LBB27_191
.LBB27_190:                             # %for.end.sink.split.i248
                                        #   in Loop: Header=BB27_162 Depth=2
	st.b	$a0, $s1, %pc_lo12(white_space.commentP)
	move	$a1, $a2
	b	.LBB27_198
	.p2align	4, , 16
.LBB27_191:                             # %if.end.i.lr.ph.i228
                                        #   in Loop: Header=BB27_162 Depth=2
	ld.bu	$a2, $s1, %pc_lo12(white_space.commentP)
	beqz	$a2, .LBB27_195
# %bb.192:                              # %if.then2.i.i252
                                        #   in Loop: Header=BB27_162 Depth=2
	ori	$a2, $zero, 10
	ori	$a0, $zero, 1
	bne	$a1, $a2, .LBB27_198
...
.LBB27_194:                             # %for.inc.i245
	...
	move	$s6, $a3
	beq	$a1, $a2, .LBB27_218
.LBB27_195:                             # %if.end.i.i230
                                        #   Parent Loop BB27_9 Depth=1
                                        #     Parent Loop BB27_162 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	bltu	$s2, $a1, .LBB27_194
# %bb.196:                              # %if.end.i.i230
                                        #   in Loop: Header=BB27_195 Depth=3
	sll.d	$a2, $s5, $a1
	ld.d	$a3, $sp, 112                   # 8-byte Folded Reload
	and	$a2, $a2, $a3
	beqz	$a2, .LBB27_194
# %bb.197:                              # %for.cond2.i235.preheader.loopexit
                                        #   in Loop: Header=BB27_162 Depth=2
	move	$a0, $zero
.LBB27_198:                             # %for.cond2.i235.preheader
                                        #   in Loop: Header=BB27_162 Depth=2
	move	$a2, $a0
	b	.LBB27_201
	.p2align	4, , 16
.LBB27_199:                             # %for.inc11.sink.split.i244
	...
	st.b	$a1, $s1, %pc_lo12(white_space.commentP)
	move	$a2, $a0
.LBB27_200:                             # %for.inc11.i240
                                        #   in Loop: Header=BB27_201 Depth=3
	ld.bu	$a1, $s6, 1
	addi.d	$s6, $s6, 1
.LBB27_201:                             # %for.cond2.i235
                                        #   Parent Loop BB27_9 Depth=1
                                        #     Parent Loop BB27_162 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	beq	$a1, $s4, .LBB27_199
# %bb.202:                              # %if.end.i8.i238
                                        #   in Loop: Header=BB27_201 Depth=3
	andi	$a2, $a2, 1
	beqz	$a2, .LBB27_205
# %bb.203:                              # %if.then2.i13.i243
                                        #   in Loop: Header=BB27_201 Depth=3
	beq	$a1, $s7, .LBB27_199
# %bb.204:                              # %if.then2.i13.i243
                                        #   in Loop: Header=BB27_201 Depth=3
	ori	$a2, $zero, 1
	bnez	$a1, .LBB27_200
	b	.LBB27_208
	.p2align	4, , 16
.LBB27_205:                             # %if.end8.i10.i239
                                        #   in Loop: Header=BB27_201 Depth=3
	bltu	$s2, $a1, .LBB27_208
# %bb.206:                              # %if.end8.i10.i239
                                        #   in Loop: Header=BB27_201 Depth=3
	sll.d	$a1, $s5, $a1
	and	$a1, $a1, $s3
	beqz	$a1, .LBB27_208
...
.LBB27_209:                             # %for.inc.i261
	...
	b	.LBB27_213
	.p2align	4, , 16
.LBB27_210:                             # %if.end8.i.i260
                                        #   in Loop: Header=BB27_214 Depth=3
	bltu	$s2, $s0, .LBB27_161
# %bb.211:                              # %if.end8.i.i260
                                        #   in Loop: Header=BB27_214 Depth=3
	sll.d	$a1, $s5, $s0
	and	$a1, $a1, $s3
	beqz	$a1, .LBB27_161
# %bb.212:                              #   in Loop: Header=BB27_214 Depth=3
	...
	bne	$s0, $s4, .LBB27_214
	.p2align	4, , 16
.LBB27_213:                             # %for.inc.sink.split.i265
                                        #   Parent Loop BB27_9 Depth=1
                                        #     Parent Loop BB27_162 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	addi.d	$a1, $s0, -37
	...
	ld.bu	$s0, $s6, 0
	beq	$s0, $s4, .LBB27_213
.LBB27_214:                             # %if.end.i.i259
                                        #   Parent Loop BB27_9 Depth=1
                                        #     Parent Loop BB27_162 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	andi	$a1, $a1, 1
	beqz	$a1, .LBB27_210
# %bb.215:                              # %if.then2.i.i264
                                        #   in Loop: Header=BB27_214 Depth=3
	beq	$s0, $s7, .LBB27_213
# %bb.216:                              # %if.then2.i.i264
                                        #   in Loop: Header=BB27_214 Depth=3
	ori	$a1, $zero, 1
	bnez	$s0, .LBB27_209
# %bb.217:                              # %if.end102.loopexit
                                        #   in Loop: Header=BB27_162 Depth=2
	ori	$a1, $zero, 1
	st.d	$a1, $sp, 128                   # 8-byte Folded Spill
	bnez	$s0, .LBB27_162
...
.LBB27_218:                             #   in Loop: Header=BB27_162 Depth=2
	move	$s6, $a3
	b	.LBB27_190
.LBB27_219:                             # %if.end.i.lr.ph.i340
                                        #   in Loop: Header=BB27_9 Depth=1
	ld.bu	$a3, $s1, %pc_lo12(white_space.commentP)
	beqz	$a3, .LBB27_223
# %bb.220:                              # %if.then2.i.i364
                                        #   in Loop: Header=BB27_9 Depth=1
	ori	$a3, $zero, 10
	ori	$a0, $zero, 1
	bne	$a1, $a3, .LBB27_228
...
.LBB27_222:                             # %for.inc.i357
	...
	move	$s6, $a4
	beq	$a1, $a3, .LBB27_260
.LBB27_223:                             # %if.end.i.i342
                                        #   Parent Loop BB27_9 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	bltu	$s2, $a1, .LBB27_222
# %bb.224:                              # %if.end.i.i342
                                        #   in Loop: Header=BB27_223 Depth=2
	sll.d	$a3, $s5, $a1
	ld.d	$a4, $sp, 112                   # 8-byte Folded Reload
	and	$a3, $a3, $a4
	beqz	$a3, .LBB27_222
# %bb.225:                              # %for.cond2.i347.preheader.loopexit
                                        #   in Loop: Header=BB27_9 Depth=1
	move	$a0, $zero
	b	.LBB27_228
	.p2align	4, , 16
.LBB27_226:                             # %for.inc11.sink.split.i356
                                        #   in Loop: Header=BB27_228 Depth=2
	addi.d	$a1, $a1, -37
	sltui	$a0, $a1, 1
	sltui	$a1, $a1, 1
	st.b	$a1, $s1, %pc_lo12(white_space.commentP)
.LBB27_227:                             # %for.inc11.i352
                                        #   in Loop: Header=BB27_228 Depth=2
	ld.bu	$a1, $s6, 1
	addi.d	$s6, $s6, 1
.LBB27_228:                             # %for.cond2.i347
                                        #   Parent Loop BB27_9 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	beq	$a1, $s4, .LBB27_226
# %bb.229:                              # %if.end.i8.i350
                                        #   in Loop: Header=BB27_228 Depth=2
	andi	$a0, $a0, 1
	beqz	$a0, .LBB27_232
# %bb.230:                              # %if.then2.i13.i355
                                        #   in Loop: Header=BB27_228 Depth=2
	beq	$a1, $s7, .LBB27_226
# %bb.231:                              # %if.then2.i13.i355
                                        #   in Loop: Header=BB27_228 Depth=2
	ori	$a0, $zero, 1
	bnez	$a1, .LBB27_227
	b	.LBB27_235
	.p2align	4, , 16
.LBB27_232:                             # %if.end8.i10.i351
                                        #   in Loop: Header=BB27_228 Depth=2
	bltu	$s2, $a1, .LBB27_235
# %bb.233:                              # %if.end8.i10.i351
                                        #   in Loop: Header=BB27_228 Depth=2
	sll.d	$a0, $s5, $a1
	and	$a0, $a0, $s3
	beqz	$a0, .LBB27_235
...
.LBB27_240:                             # %if.then189
	...
	ld.bu	$a0, $a0, 0
	beqz	$a0, .LBB27_5
# %bb.241:                              # %if.end192.sink.split
                                        #   in Loop: Header=BB27_9 Depth=1
	ori	$s6, $zero, 1
	st.w	$s6, $s8, %pc_lo12(got_unused_responce)
	b	.LBB27_5
.LBB27_242:                             # %if.else146
                                        #   in Loop: Header=BB27_9 Depth=1
	...
	beqz	$a0, .LBB27_249
	b	.LBB27_275
.LBB27_243:                             # %if.end102.thread
                                        #   in Loop: Header=BB27_9 Depth=1
	st.b	$zero, $s6, 0
	ld.d	$fp, $sp, 80                    # 8-byte Folded Reload
.LBB27_244:                             # %while.end.thread
                                        #   in Loop: Header=BB27_9 Depth=1
	move	$s8, $zero
	move	$a0, $zero
	ld.d	$s6, $sp, 128                   # 8-byte Folded Reload
	beqz	$s6, .LBB27_248
.LBB27_245:                             # %if.then110
                                        #   in Loop: Header=BB27_9 Depth=1
	addi.d	$a1, $sp, 136
	ld.d	$s0, $sp, 120                   # 8-byte Folded Reload
	move	$a0, $s0
...
.LBB27_262:                             # %if.then44
	...
	ori	$a3, $zero, 1
	move	$a2, $zero
.LBB27_263:                             # %while.end206
	pcaddu18i	$ra, %call36(break_ties)
	jirl	$ra, $ra, 0
.LBB27_264:                             # %while.end206
