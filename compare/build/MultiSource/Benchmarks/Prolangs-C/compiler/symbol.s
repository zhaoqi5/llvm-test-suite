...
.LBB6_7:                                # %pred.store.continue
	...
	andi	$a7, $a7, 1
	bnez	$a7, .LBB6_14
# %bb.8:                                # %pred.store.continue7
                                        #   in Loop: Header=BB6_5 Depth=1
	vpickve2gr.h	$a7, $vr1, 2
	andi	$a7, $a7, 1
	bnez	$a7, .LBB6_15
.LBB6_9:                                # %pred.store.continue9
                                        #   in Loop: Header=BB6_5 Depth=1
	vpickve2gr.h	$a7, $vr1, 3
	andi	$a7, $a7, 1
	bnez	$a7, .LBB6_16
.LBB6_10:                               # %pred.store.continue11
                                        #   in Loop: Header=BB6_5 Depth=1
	vpickve2gr.h	$a7, $vr1, 4
	andi	$a7, $a7, 1
	bnez	$a7, .LBB6_17
.LBB6_11:                               # %pred.store.continue13
                                        #   in Loop: Header=BB6_5 Depth=1
	vpickve2gr.h	$a7, $vr1, 5
	andi	$a7, $a7, 1
	bnez	$a7, .LBB6_18
.LBB6_12:                               # %pred.store.continue15
                                        #   in Loop: Header=BB6_5 Depth=1
	vpickve2gr.h	$a7, $vr1, 6
	andi	$a7, $a7, 1
	bnez	$a7, .LBB6_19
.LBB6_13:                               # %pred.store.continue17
                                        #   in Loop: Header=BB6_5 Depth=1
