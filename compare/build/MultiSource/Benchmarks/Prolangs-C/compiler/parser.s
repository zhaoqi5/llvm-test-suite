...
.LBB1_88:                               # %cleanup
	...
	addi.w	$a0, $zero, -99
	b	.LBB1_138
.LBB1_89:                               # %if.else.i169
	move	$s0, $a0
	addi.w	$a0, $a3, -2007
	ori	$a1, $zero, 1
	bltu	$a1, $a0, .LBB1_91
# %bb.90:                               # %sw.epilog.i172
	pcalau12i	$a0, %pc_hi20(.L.str)
	addi.d	$a0, $a0, %pc_lo12(.L.str)
	pcaddu18i	$ra, %call36(error)
	jirl	$ra, $ra, 0
...
# %bb.97:                               # %if.end202
	...
	vldi	$vr0, -1168
	b	.LBB1_116
.LBB1_98:                               # %if.else.i141
	move	$s0, $a0
	addi.w	$a0, $a3, -2007
	ori	$a1, $zero, 1
	bltu	$a1, $a0, .LBB1_100
# %bb.99:                               # %sw.epilog.i144
	pcalau12i	$a0, %pc_hi20(.L.str)
	addi.d	$a0, $a0, %pc_lo12(.L.str)
	pcaddu18i	$ra, %call36(error)
	jirl	$ra, $ra, 0
...
# %bb.103:                              # %if.end186
	...
	move	$a1, $zero
	b	.LBB1_130
.LBB1_104:                              # %if.else.i225
	move	$s0, $a0
	addi.w	$a0, $a3, -2007
	ori	$a1, $zero, 1
	bltu	$a1, $a0, .LBB1_106
# %bb.105:                              # %sw.epilog.i228
	pcalau12i	$a0, %pc_hi20(.L.str)
	addi.d	$a0, $a0, %pc_lo12(.L.str)
	pcaddu18i	$ra, %call36(error)
	jirl	$ra, $ra, 0
...
# %bb.109:                              # %if.end228
	...
	ori	$a0, $zero, 2011
	b	.LBB1_129
.LBB1_110:                              # %if.else.i113
	move	$s0, $a0
	addi.w	$a0, $a3, -2007
	ori	$a1, $zero, 1
	bltu	$a1, $a0, .LBB1_112
# %bb.111:                              # %sw.epilog.i116
	pcalau12i	$a0, %pc_hi20(.L.str)
	addi.d	$a0, $a0, %pc_lo12(.L.str)
	pcaddu18i	$ra, %call36(error)
	jirl	$ra, $ra, 0
...
.LBB1_116:                              # %cleanup
	...
	ori	$a0, $zero, 1
	b	.LBB1_138
.LBB1_117:                              # %if.else.i71
	move	$s3, $a0
	addi.w	$a0, $a1, -2007
	ori	$a1, $zero, 1
	bltu	$a1, $a0, .LBB1_139
# %bb.118:                              # %sw.epilog.i74
	pcalau12i	$a0, %pc_hi20(.L.str)
	addi.d	$a0, $a0, %pc_lo12(.L.str)
	pcaddu18i	$ra, %call36(error)
	jirl	$ra, $ra, 0
...
.LBB1_119:
	move	$a0, $s3
	b	.LBB1_138
.LBB1_120:                              # %if.else.i197
	move	$s0, $a0
	addi.w	$a0, $a3, -2007
	ori	$a1, $zero, 1
	bltu	$a1, $a0, .LBB1_122
# %bb.121:                              # %sw.epilog.i200
	pcalau12i	$a0, %pc_hi20(.L.str)
	addi.d	$a0, $a0, %pc_lo12(.L.str)
	pcaddu18i	$ra, %call36(error)
	jirl	$ra, $ra, 0
