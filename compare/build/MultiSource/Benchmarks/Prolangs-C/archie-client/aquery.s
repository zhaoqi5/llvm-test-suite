...
# %bb.0:                                # %entry
	...
	pcalau12i	$a1, %got_pc_hi20(pwarn)
	ld.d	$a1, $a1, %got_pc_lo12(pwarn)
	pcalau12i	$a2, %got_pc_hi20(p_warn_string)
	ld.d	$a2, $a2, %got_pc_lo12(p_warn_string)
	st.w	$zero, $s6, 0
	st.b	$zero, $a0, 0
	st.w	$zero, $a1, 0
	st.b	$zero, $a2, 0
