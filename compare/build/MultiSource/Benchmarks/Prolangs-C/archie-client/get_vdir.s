...
# %bb.50:                               # %while.end
	...
	st.d	$a0, $a2, 40
	b	.LBB0_16
.LBB0_51:                               #   in Loop: Header=BB0_17 Depth=4
	ori	$a0, $zero, 1
	st.d	$a0, $sp, 160                   # 8-byte Folded Spill
	b	.LBB0_16
.LBB0_52:                               # %if.then83
...
.LBB0_60:                               # %if.else93
	...
	st.d	$zero, $a0, 32
	b	.LBB0_16
.LBB0_61:                               # %land.lhs.true154
                                        #   in Loop: Header=BB0_17 Depth=4
	ld.bu	$a0, $s6, 16
	ori	$a1, $zero, 76
	bne	$a0, $a1, .LBB0_63
# %bb.62:                               # %land.lhs.true159
                                        #   in Loop: Header=BB0_17 Depth=4
	ld.d	$a0, $s6, 8
...
# %bb.64:                               # %land.lhs.true174
	...
	ori	$a1, $zero, 26
	beq	$a0, $a1, .LBB0_66
# %bb.65:                               # %land.lhs.true174
                                        #   in Loop: Header=BB0_17 Depth=4
	bnez	$a0, .LBB0_16
.LBB0_66:                               #   in Loop: Header=BB0_17 Depth=4
	st.d	$s6, $sp, 120                   # 8-byte Folded Spill
	b	.LBB0_16
.LBB0_67:                               #   in Loop: Header=BB0_17 Depth=4
	st.d	$zero, $sp, 120                 # 8-byte Folded Spill
	b	.LBB0_16
.LBB0_68:                               # %startover.loopexit
                                        #   in Loop: Header=BB0_8 Depth=2
	...
	b	.LBB0_8
.LBB0_69:                               # %while.cond.while.end291_crit_edge
...
# %bb.74:                               # %expand_ulinks
	...
	bnez	$a0, .LBB0_77
	b	.LBB0_96
.LBB0_75:                               # %land.lhs.true313
                                        #   in Loop: Header=BB0_7 Depth=1
	ld.d	$a0, $sp, 48                    # 8-byte Folded Reload
	bnez	$a0, .LBB0_77
# %bb.76:                               # %land.lhs.true313
                                        #   in Loop: Header=BB0_7 Depth=1
	ld.d	$a0, $sp, 168                   # 8-byte Folded Reload
	ld.d	$a0, $a0, 32
	bnez	$a0, .LBB0_108
...
.LBB0_100:                              # %if.else396
	...
	move	$s1, $s0
	beqz	$s0, .LBB0_93
.LBB0_101:                              # %while.body367
                                        # =>This Inner Loop Header: Depth=1
	ld.bu	$a0, $s1, 16
	bne	$a0, $fp, .LBB0_100
# %bb.102:                              # %land.lhs.true372
                                        #   in Loop: Header=BB0_101 Depth=1
	ld.d	$a0, $s1, 8
	move	$a1, $s3
	pcaddu18i	$ra, %call36(wcmatch)
