...
# %bb.0:                                # %entry
	...
	pcalau12i	$a3, %pc_hi20(posed)
	ld.d	$a5, $a3, %pc_lo12(posed)
	ori	$a6, $zero, 31
	ld.w	$a7, $a2, 4
	ld.w	$t0, $a2, 8
	addi.d	$a5, $a5, 1
	st.d	$a5, $a3, %pc_lo12(posed)
	slli.w	$a3, $a7, 14
	slli.w	$a5, $t0, 7
	ld.w	$a7, $a2, 12
	or	$a3, $a5, $a3
	...
	pcalau12i	$t1, %pc_hi20(stride)
	st.w	$a5, $t1, %pc_lo12(stride)
	slli.d	$t1, $a2, 2
	ldx.w	$t1, $a3, $t1
	masknez	$a6, $a6, $a4
	maskeqz	$a1, $a1, $a4
