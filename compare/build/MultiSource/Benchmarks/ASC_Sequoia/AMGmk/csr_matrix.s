...
# %bb.30:                               # %middle.block378
	beq	$a1, $s2, .LBB9_37
# %bb.31:                               # %vec.epilog.iter.check383
	andi	$a2, $s2, 12
	beqz	$a2, .LBB9_35
.LBB9_32:                               # %vec.epilog.ph382
	move	$a4, $a1
	...
	alsl.d	$a4, $a4, $s0, 2
	.p2align	4, , 16
.LBB9_33:                               # %vec.epilog.vector.body388
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	vst	$vr0, $a3, 0
	addi.d	$a2, $a2, 4
	...
	addi.d	$a4, $a4, 16
	bnez	$a2, .LBB9_33
# %bb.34:                               # %vec.epilog.middle.block392
	beq	$a1, $s2, .LBB9_37
...
# %bb.42:                               #   in Loop: Header=BB9_41 Depth=1
	...
	b	.LBB9_52
	.p2align	4, , 16
.LBB9_43:                               # %vector.main.loop.iter.check400
                                        #   in Loop: Header=BB9_41 Depth=1
	bgeu	$s2, $t1, .LBB9_45
...
# %bb.47:                               # %middle.block413
	...
	sltu	$t4, $zero, $t4
	beq	$a2, $s2, .LBB9_54
# %bb.48:                               # %vec.epilog.iter.check421
                                        #   in Loop: Header=BB9_41 Depth=1
	move	$t6, $a2
	move	$t5, $a2
	beqz	$a3, .LBB9_52
.LBB9_49:                               # %vec.epilog.ph420
                                        #   in Loop: Header=BB9_41 Depth=1
	vreplgr2vr.w	$vr2, $t2
	vreplgr2vr.w	$vr1, $t4
	add.d	$t4, $a6, $t5
	alsl.d	$t5, $t5, $s0, 2
	.p2align	4, , 16
.LBB9_50:                               # %vec.epilog.vector.body430
                                        #   Parent Loop BB9_41 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr3, $t5, 0
	vseq.w	$vr3, $vr3, $vr2
	...
	addi.d	$t5, $t5, 16
	bnez	$t4, .LBB9_50
# %bb.51:                               # %vec.epilog.middle.block435
                                        #   in Loop: Header=BB9_41 Depth=1
	vslli.w	$vr1, $vr1, 31
	vmskltz.w	$vr1, $vr1
	vpickve2gr.hu	$t4, $vr1, 0
...
.LBB9_104:                              #   in Loop: Header=BB9_101 Depth=1
	move	$t4, $t1
.LBB9_105:                              # %for.body139.preheader464
                                        #   in Loop: Header=BB9_101 Depth=1
	alsl.d	$t5, $t4, $s8, 2
	sub.d	$t6, $t2, $t4
	alsl.d	$t7, $a4, $a0, 2
