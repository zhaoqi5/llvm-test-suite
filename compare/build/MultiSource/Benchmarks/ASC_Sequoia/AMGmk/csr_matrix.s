...
# %bb.28:                               # %middle.block64
	beq	$a2, $s1, .LBB8_35
# %bb.29:                               # %vec.epilog.iter.check68
	beqz	$a3, .LBB8_33
.LBB8_30:                               # %vec.epilog.ph70
	move	$a5, $a2
	...
	alsl.d	$a5, $a5, $a1, 2
	.p2align	4, , 16
.LBB8_31:                               # %vec.epilog.vector.body73
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 4
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB8_31
# %bb.32:                               # %vec.epilog.middle.block77
	beq	$a2, $s1, .LBB8_35
...
# %bb.22:                               # %iter.check367
	...
	ori	$a3, $zero, 64
	bltu	$a2, $a3, .LBB9_35
# %bb.23:                               # %vector.main.loop.iter.check369
	ori	$a1, $zero, 16
	bgeu	$s2, $a1, .LBB9_28
# %bb.24:
	move	$a1, $zero
...
.LBB9_29:                               # %vector.body373
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB9_29
# %bb.30:                               # %middle.block378
	beq	$a1, $s2, .LBB9_37
# %bb.31:                               # %vec.epilog.iter.check382
	beqz	$a2, .LBB9_35
.LBB9_32:                               # %vec.epilog.ph384
	move	$a4, $a1
	...
	alsl.d	$a4, $a4, $s0, 2
	.p2align	4, , 16
.LBB9_33:                               # %vec.epilog.vector.body387
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	vst	$vr0, $a3, 0
	addi.d	$a2, $a2, 4
	...
	addi.d	$a4, $a4, 16
	bnez	$a2, .LBB9_33
# %bb.34:                               # %vec.epilog.middle.block391
	beq	$a1, $s2, .LBB9_37
...
# %bb.42:                               #   in Loop: Header=BB9_41 Depth=1
	...
	b	.LBB9_52
	.p2align	4, , 16
.LBB9_43:                               # %vector.main.loop.iter.check399
                                        #   in Loop: Header=BB9_41 Depth=1
	bgeu	$s2, $t1, .LBB9_45
...
# %bb.47:                               # %middle.block412
	...
	sltu	$t4, $zero, $t4
	beq	$a3, $s2, .LBB9_54
# %bb.48:                               # %vec.epilog.iter.check419
                                        #   in Loop: Header=BB9_41 Depth=1
	move	$t5, $a3
	move	$t6, $a3
	beqz	$a2, .LBB9_52
.LBB9_49:                               # %vec.epilog.ph421
                                        #   in Loop: Header=BB9_41 Depth=1
	vreplgr2vr.w	$vr2, $t2
	vreplgr2vr.w	$vr1, $t4
	add.d	$t4, $a6, $t5
	alsl.d	$t5, $t5, $s0, 2
	.p2align	4, , 16
.LBB9_50:                               # %vec.epilog.vector.body428
                                        #   Parent Loop BB9_41 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr3, $t5, 0
	vseq.w	$vr3, $vr3, $vr2
	...
	addi.d	$t5, $t5, 16
	bnez	$t4, .LBB9_50
# %bb.51:                               # %vec.epilog.middle.block433
                                        #   in Loop: Header=BB9_41 Depth=1
	vslli.w	$vr1, $vr1, 31
	vmskltz.w	$vr1, $vr1
	vpickve2gr.hu	$t4, $vr1, 0
...
.LBB9_104:                              #   in Loop: Header=BB9_101 Depth=1
	move	$t4, $t1
.LBB9_105:                              # %for.body139.preheader466
                                        #   in Loop: Header=BB9_101 Depth=1
	alsl.d	$t5, $t4, $s8, 2
	sub.d	$t6, $t2, $t4
	alsl.d	$t7, $a4, $a0, 2
