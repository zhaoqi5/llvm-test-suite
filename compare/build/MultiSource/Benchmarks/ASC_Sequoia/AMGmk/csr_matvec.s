...
.LBB0_9:                                # %vector.body312
	...
	addi.d	$a1, $a1, 64
	bnez	$a2, .LBB0_9
# %bb.10:                               # %middle.block317
	beq	$a0, $t7, .LBB0_61
.LBB0_11:                               # %for.body.preheader320
	alsl.d	$a1, $a0, $fp, 3
	sub.d	$a0, $t7, $a0
	.p2align	4, , 16
.LBB0_12:                               # %for.body
...
# %bb.18:                               # %middle.block
	beq	$a0, $t7, .LBB0_21
.LBB0_19:                               # %for.body40.preheader329
	alsl.d	$a1, $a0, $fp, 3
	sub.d	$a0, $t7, $a0
	.p2align	4, , 16
.LBB0_20:                               # %for.body40
...
.LBB0_57:                               # %vector.body297
	...
	addi.d	$a1, $a1, 64
	bnez	$a2, .LBB0_57
# %bb.58:                               # %middle.block302
	beq	$a0, $t7, .LBB0_61
.LBB0_59:                               # %for.body212.preheader321
	alsl.d	$a1, $a0, $fp, 3
	sub.d	$a0, $t7, $a0
	.p2align	4, , 16
.LBB0_60:                               # %for.body212
...
.LBB1_9:                                # %vector.body243
	...
	addi.d	$a1, $a1, 64
	bnez	$a2, .LBB1_9
# %bb.10:                               # %middle.block248
	beq	$a0, $t7, .LBB1_45
.LBB1_11:                               # %for.body.preheader251
	alsl.d	$a1, $a0, $fp, 3
	sub.d	$a0, $t7, $a0
	.p2align	4, , 16
.LBB1_12:                               # %for.body
...
# %bb.18:                               # %middle.block
	beq	$a0, $t7, .LBB1_21
.LBB1_19:                               # %for.body40.preheader255
	alsl.d	$a1, $a0, $fp, 3
	sub.d	$a0, $t7, $a0
	.p2align	4, , 16
.LBB1_20:                               # %for.body40
...
.LBB1_41:                               # %vector.body228
	...
	addi.d	$a1, $a1, 64
	bnez	$a2, .LBB1_41
# %bb.42:                               # %middle.block233
	beq	$a0, $t7, .LBB1_45
.LBB1_43:                               # %for.body222.preheader252
	alsl.d	$a1, $a0, $fp, 3
	sub.d	$a0, $t7, $a0
	.p2align	4, , 16
.LBB1_44:                               # %for.body222
...
.LBB2_12:
	move	$t5, $zero
.LBB2_13:                               # %for.body29.preheader131
	alsl.d	$t6, $t5, $t0, 3
	alsl.d	$t7, $t5, $a3, 2
	sub.d	$t5, $t1, $t5
	b	.LBB2_15
...
.LBB2_23:                               # %vector.ph
	...
	b	.LBB2_25
	.p2align	4, , 16
.LBB2_24:                               # %pred.store.continue129
...
# %bb.26:                               # %pred.store.if
	...
	andi	$fp, $fp, 1
	bnez	$fp, .LBB2_34
.LBB2_27:                               # %pred.store.continue117
                                        #   in Loop: Header=BB2_25 Depth=1
	vpickve2gr.w	$fp, $vr3, 2
	andi	$fp, $fp, 1
	beqz	$fp, .LBB2_35
.LBB2_28:                               # %pred.store.if118
                                        #   in Loop: Header=BB2_25 Depth=1
	st.d	$zero, $t6, -16
	vpickve2gr.w	$fp, $vr3, 3
	andi	$fp, $fp, 1
	bnez	$fp, .LBB2_36
.LBB2_29:                               # %pred.store.continue121
                                        #   in Loop: Header=BB2_25 Depth=1
	vseq.w	$vr2, $vr2, $vr1
	vpickve2gr.w	$fp, $vr2, 0
	andi	$fp, $fp, 1
	beqz	$fp, .LBB2_37
.LBB2_30:                               # %pred.store.if122
                                        #   in Loop: Header=BB2_25 Depth=1
	st.d	$zero, $t6, 0
	vpickve2gr.w	$fp, $vr2, 1
	andi	$fp, $fp, 1
	bnez	$fp, .LBB2_38
.LBB2_31:                               # %pred.store.continue125
                                        #   in Loop: Header=BB2_25 Depth=1
	vpickve2gr.w	$fp, $vr2, 2
	andi	$fp, $fp, 1
	beqz	$fp, .LBB2_39
.LBB2_32:                               # %pred.store.if126
                                        #   in Loop: Header=BB2_25 Depth=1
	st.d	$zero, $t6, 16
...
.LBB2_34:                               # %pred.store.if116
	...
	andi	$fp, $fp, 1
	bnez	$fp, .LBB2_28
.LBB2_35:                               # %pred.store.continue119
                                        #   in Loop: Header=BB2_25 Depth=1
	vpickve2gr.w	$fp, $vr3, 3
	andi	$fp, $fp, 1
	beqz	$fp, .LBB2_29
.LBB2_36:                               # %pred.store.if120
                                        #   in Loop: Header=BB2_25 Depth=1
	st.d	$zero, $t6, -8
	vseq.w	$vr2, $vr2, $vr1
	vpickve2gr.w	$fp, $vr2, 0
	andi	$fp, $fp, 1
	bnez	$fp, .LBB2_30
.LBB2_37:                               # %pred.store.continue123
                                        #   in Loop: Header=BB2_25 Depth=1
	vpickve2gr.w	$fp, $vr2, 1
	andi	$fp, $fp, 1
	beqz	$fp, .LBB2_31
.LBB2_38:                               # %pred.store.if124
                                        #   in Loop: Header=BB2_25 Depth=1
	st.d	$zero, $t6, 8
	vpickve2gr.w	$fp, $vr2, 2
	andi	$fp, $fp, 1
	bnez	$fp, .LBB2_32
.LBB2_39:                               # %pred.store.continue127
                                        #   in Loop: Header=BB2_25 Depth=1
	vpickve2gr.w	$fp, $vr2, 3
	andi	$fp, $fp, 1
	beqz	$fp, .LBB2_24
.LBB2_40:                               # %pred.store.if128
                                        #   in Loop: Header=BB2_25 Depth=1
	st.d	$zero, $t6, 24
	b	.LBB2_24
