...
# %bb.25:                               # %vector.body747.preheader
	...
	b	.LBB0_27
	.p2align	4, , 16
.LBB0_26:                               # %pred.store.continue770
...
# %bb.28:                               # %pred.store.if
                                        #   in Loop: Header=BB0_27 Depth=3
	add.d	$a0, $s8, $a0
	xvstelm.w	$xr13, $a0, 0, 0
.LBB0_29:                               # %pred.store.continue
                                        #   in Loop: Header=BB0_27 Depth=3
	vinsgr2vr.h	$vr14, $a5, 0
	xvpickve2gr.w	$a0, $xr15, 1
	vinsgr2vr.h	$vr14, $a0, 1
	xvpickve2gr.w	$a0, $xr15, 2
	vinsgr2vr.h	$vr14, $a0, 2
	xvpickve2gr.w	$a0, $xr15, 3
	vinsgr2vr.h	$vr14, $a0, 3
	xvpickve2gr.w	$a0, $xr15, 4
	vinsgr2vr.h	$vr14, $a0, 4
	xvpickve2gr.w	$a0, $xr15, 5
	vinsgr2vr.h	$vr14, $a0, 5
	xvpickve2gr.w	$a0, $xr15, 6
	vinsgr2vr.h	$vr14, $a0, 6
	xvpickve2gr.w	$a0, $xr15, 7
	vinsgr2vr.h	$vr14, $a0, 7
	vpickve2gr.h	$a0, $vr14, 1
	andi	$a0, $a0, 1
	bnez	$a0, .LBB0_36
# %bb.30:                               # %pred.store.continue758
                                        #   in Loop: Header=BB0_27 Depth=3
	vpickve2gr.h	$a0, $vr14, 2
	andi	$a0, $a0, 1
	bnez	$a0, .LBB0_37
.LBB0_31:                               # %pred.store.continue760
                                        #   in Loop: Header=BB0_27 Depth=3
	vpickve2gr.h	$a0, $vr14, 3
	andi	$a0, $a0, 1
	bnez	$a0, .LBB0_38
.LBB0_32:                               # %pred.store.continue762
                                        #   in Loop: Header=BB0_27 Depth=3
	vpickve2gr.h	$a0, $vr14, 4
	andi	$a0, $a0, 1
	bnez	$a0, .LBB0_39
.LBB0_33:                               # %pred.store.continue764
                                        #   in Loop: Header=BB0_27 Depth=3
	vpickve2gr.h	$a0, $vr14, 5
	andi	$a0, $a0, 1
	bnez	$a0, .LBB0_40
.LBB0_34:                               # %pred.store.continue766
                                        #   in Loop: Header=BB0_27 Depth=3
	vpickve2gr.h	$a0, $vr14, 6
	andi	$a0, $a0, 1
	bnez	$a0, .LBB0_41
.LBB0_35:                               # %pred.store.continue768
                                        #   in Loop: Header=BB0_27 Depth=3
	vpickve2gr.h	$a0, $vr14, 7
	andi	$a0, $a0, 1
	beqz	$a0, .LBB0_26
	b	.LBB0_42
	.p2align	4, , 16
.LBB0_36:                               # %pred.store.if757
                                        #   in Loop: Header=BB0_27 Depth=3
	ori	$a0, $t0, 4072
	add.d	$a0, $s8, $a0
	xvstelm.w	$xr13, $a0, 0, 1
	vpickve2gr.h	$a0, $vr14, 2
	andi	$a0, $a0, 1
	beqz	$a0, .LBB0_31
.LBB0_37:                               # %pred.store.if759
                                        #   in Loop: Header=BB0_27 Depth=3
	ori	$a0, $t0, 4076
	add.d	$a0, $s8, $a0
	xvstelm.w	$xr13, $a0, 0, 2
	vpickve2gr.h	$a0, $vr14, 3
	andi	$a0, $a0, 1
	beqz	$a0, .LBB0_32
.LBB0_38:                               # %pred.store.if761
                                        #   in Loop: Header=BB0_27 Depth=3
	ori	$a0, $t0, 4080
	add.d	$a0, $s8, $a0
	xvstelm.w	$xr13, $a0, 0, 3
	vpickve2gr.h	$a0, $vr14, 4
	andi	$a0, $a0, 1
	beqz	$a0, .LBB0_33
.LBB0_39:                               # %pred.store.if763
                                        #   in Loop: Header=BB0_27 Depth=3
	ori	$a0, $t0, 4084
	add.d	$a0, $s8, $a0
	xvstelm.w	$xr13, $a0, 0, 4
	vpickve2gr.h	$a0, $vr14, 5
	andi	$a0, $a0, 1
	beqz	$a0, .LBB0_34
.LBB0_40:                               # %pred.store.if765
                                        #   in Loop: Header=BB0_27 Depth=3
	add.d	$a0, $s8, $a2
	xvstelm.w	$xr13, $a0, 0, 5
	vpickve2gr.h	$a0, $vr14, 6
	andi	$a0, $a0, 1
	beqz	$a0, .LBB0_35
.LBB0_41:                               # %pred.store.if767
                                        #   in Loop: Header=BB0_27 Depth=3
	ori	$a0, $t0, 4092
	add.d	$a0, $s8, $a0
	xvstelm.w	$xr13, $a0, 0, 6
	vpickve2gr.h	$a0, $vr14, 7
	andi	$a0, $a0, 1
	beqz	$a0, .LBB0_26
.LBB0_42:                               # %pred.store.if769
                                        #   in Loop: Header=BB0_27 Depth=3
	lu12i.w	$a0, 2
	add.d	$a0, $s8, $a0
	xvstelm.w	$xr13, $a0, 0, 7
	b	.LBB0_26
	.p2align	4, , 16
...
# %bb.52:                               #   in Loop: Header=BB0_1 Depth=1
	...
	b	.LBB0_56
	.p2align	4, , 16
.LBB0_53:                               # %vector.body659.preheader
                                        #   in Loop: Header=BB0_1 Depth=1
	ori	$a3, $t3, 32
	ld.d	$a6, $sp, 152                   # 8-byte Folded Reload
	ld.d	$a5, $sp, 144                   # 8-byte Folded Reload
...
.LBB0_54:                               # %vector.body659
	...
	vreplvei.w	$vr14, $vr10, 3
	fcvt.d.s	$ft6, $ft6
	vreplvei.w	$vr15, $vr10, 2
	fcvt.d.s	$ft7, $ft7
	vextrins.d	$vr15, $vr14, 16
	vreplvei.w	$vr14, $vr10, 1
	fcvt.d.s	$ft6, $ft6
	vreplvei.w	$vr10, $vr10, 0
	fcvt.d.s	$ft2, $ft2
	vextrins.d	$vr10, $vr14, 16
	xvpermi.q	$xr10, $xr15, 2
	xvfmul.d	$xr10, $xr10, $xr9
	xvfmul.d	$xr13, $xr13, $xr9
	xvfadd.d	$xr12, $xr13, $xr12
	xvfadd.d	$xr10, $xr10, $xr11
	...
	xvpickve.d	$xr10, $xr12, 1
	fcvt.s.d	$ft2, $ft2
	xvpickve.d	$xr11, $xr12, 0
	fcvt.s.d	$ft3, $ft3
	vextrins.w	$vr11, $vr10, 16
	xvpickve.d	$xr10, $xr12, 2
	fcvt.s.d	$ft2, $ft2
	vextrins.w	$vr11, $vr10, 32
	xvpickve.d	$xr10, $xr12, 3
	fcvt.s.d	$ft2, $ft2
	vextrins.w	$vr11, $vr10, 48
