...
# %bb.32:                               # %for.body104.preheader
	...
	addi.w	$a0, $a0, 0
	bgeu	$t6, $t1, .LBB14_35
.LBB14_33:                              # %for.body104.preheader590
                                        #   in Loop: Header=BB14_31 Depth=1
	alsl.d	$t6, $a0, $s1, 2
	alsl.d	$t7, $a0, $s3, 3
	alsl.d	$t8, $t4, $a4, 2
...
# %bb.67:
	move	$a1, $zero
	b	.LBB14_77
.LBB14_68:                              # %vector.memcheck542
	alsl.d	$a1, $s6, $a2, 2
	sub.d	$a7, $a1, $s1
	ori	$t0, $zero, 32
	move	$a1, $s6
	bltu	$a7, $t0, .LBB14_56
# %bb.69:                               # %vector.memcheck542
	alsl.d	$a1, $s6, $a6, 3
	sub.d	$a7, $a1, $s3
	ori	$t0, $zero, 64
	move	$a1, $s6
...
.LBB14_71:                              # %vector.body552
	...
	addi.d	$t3, $t3, 64
	bnez	$t4, .LBB14_71
# %bb.72:                               # %middle.block560
	bne	$a3, $a7, .LBB14_56
	b	.LBB14_58
.LBB14_73:                              # %vector.ph570
...
# %bb.83:                               #   in Loop: Header=BB15_69 Depth=1
	move	$a2, $zero
	b	.LBB15_94
.LBB15_84:                              # %vector.body685.preheader
                                        #   in Loop: Header=BB15_69 Depth=1
	ld.d	$a0, $sp, 128                   # 8-byte Folded Reload
...
.LBB15_85:                              # %vector.body685
	...
	addi.d	$a0, $a0, 64
	bnez	$a2, .LBB15_85
# %bb.86:                               # %middle.block690
                                        #   in Loop: Header=BB15_69 Depth=1
	move	$a2, $s2
	beq	$s6, $s2, .LBB15_89
.LBB15_87:                              # %for.body.i210.preheader712
                                        #   in Loop: Header=BB15_69 Depth=1
	sub.d	$a0, $s6, $a2
	alsl.d	$a1, $a2, $s0, 3
...
.LBB15_92:                              # %vector.body700
	...
	addi.d	$a0, $a0, 64
	bnez	$a2, .LBB15_92
# %bb.93:                               # %middle.block707
                                        #   in Loop: Header=BB15_69 Depth=1
	move	$a2, $s2
	beq	$s6, $s2, .LBB15_96
.LBB15_94:                              # %for.body.i257.preheader713
                                        #   in Loop: Header=BB15_69 Depth=1
	sub.d	$a0, $s6, $a2
	alsl.d	$a1, $a2, $s0, 3
	ld.d	$a3, $sp, 192                   # 8-byte Folded Reload
...
# %bb.140:                              # %vector.memcheck661
                                        #   in Loop: Header=BB15_69 Depth=1
	alsl.d	$a3, $a1, $s0, 3
	bgeu	$a0, $a3, .LBB15_155
# %bb.141:                              # %vector.memcheck661
                                        #   in Loop: Header=BB15_69 Depth=1
	alsl.d	$a3, $a1, $a0, 3
...
.LBB15_149:                             # %vector.body651
	...
	addi.d	$a0, $a0, 64
	bnez	$a2, .LBB15_149
# %bb.150:                              # %middle.block658
                                        #   in Loop: Header=BB15_69 Depth=1
	move	$a2, $s2
	beq	$s6, $s2, .LBB15_153
.LBB15_151:                             # %for.body.i394.preheader711
                                        #   in Loop: Header=BB15_69 Depth=1
	sub.d	$a0, $s6, $a2
	alsl.d	$a1, $a2, $s1, 3
	ld.d	$a3, $sp, 192                   # 8-byte Folded Reload
...
# %bb.162:
	ld.d	$fp, $sp, 192                   # 8-byte Folded Reload
	b	.LBB15_177
.LBB15_163:                             # %vector.memcheck626
	sub.d	$a5, $s5, $a0
	ori	$a4, $zero, 64
	move	$a2, $zero
	bltu	$a5, $a4, .LBB15_49
# %bb.164:                              # %vector.memcheck626
	sub.d	$a5, $s5, $s1
	bltu	$a5, $a4, .LBB15_49
# %bb.165:                              # %vector.ph633
	bstrpick.d	$a2, $a3, 30, 3
...
# %bb.83:                               #   in Loop: Header=BB16_69 Depth=1
	move	$a2, $zero
	b	.LBB16_94
.LBB16_84:                              # %vector.body685.preheader
                                        #   in Loop: Header=BB16_69 Depth=1
	ld.d	$a0, $sp, 128                   # 8-byte Folded Reload
	ld.d	$a1, $sp, 104                   # 8-byte Folded Reload
	move	$a2, $s2
...
# %bb.86:                               # %middle.block690
	...
	move	$a2, $s2
	beq	$s6, $s2, .LBB16_89
.LBB16_87:                              # %for.body.i210.preheader712
                                        #   in Loop: Header=BB16_69 Depth=1
	sub.d	$a0, $s6, $a2
	alsl.d	$a1, $a2, $s0, 3
	ld.d	$a3, $sp, 192                   # 8-byte Folded Reload
...
# %bb.93:                               # %middle.block707
	...
	move	$a2, $s2
	beq	$s6, $s2, .LBB16_96
.LBB16_94:                              # %for.body.i257.preheader713
                                        #   in Loop: Header=BB16_69 Depth=1
	sub.d	$a0, $s6, $a2
	alsl.d	$a1, $a2, $s0, 3
	ld.d	$a3, $sp, 192                   # 8-byte Folded Reload
...
# %bb.150:                              # %middle.block658
	...
	move	$a2, $s2
	beq	$s6, $s2, .LBB16_153
.LBB16_151:                             # %for.body.i394.preheader711
                                        #   in Loop: Header=BB16_69 Depth=1
	sub.d	$a0, $s6, $a2
	alsl.d	$a1, $a2, $s1, 3
	ld.d	$a3, $sp, 192                   # 8-byte Folded Reload
