...
# %bb.13:
	...
	move	$a0, $a2
	ret
.LBB2_14:                               # %if.end55.if.end71_crit_edge
	slti	$a2, $a3, 3
.LBB2_15:                               # %if.end71
	ld.w	$a0, $a0, 0
	slt	$a0, $a0, $a1
...
# %bb.30:                               # %if.end16.i.thread.i.i.i
	...
	b	.LBB33_32
	.p2align	4, , 16
.LBB33_31:                              # %if.end16.i.i.i.i
                                        #   in Loop: Header=BB33_25 Depth=1
	beqz	$a4, .LBB33_23
	.p2align	4, , 16
.LBB33_32:                              # %land.rhs.i.i.i.i.i
                                        #   Parent Loop BB33_25 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.d	$a5, $a4, -1
	srli.d	$a5, $a5, 1
...
# %bb.33:                               # %while.body.i.i.i.i.i
                                        #   in Loop: Header=BB33_32 Depth=2
	slli.d	$a4, $a4, 2
	stx.w	$a6, $fp, $a4
	move	$a4, $a5
	bnez	$a5, .LBB33_32
...
.LBB39_6:                               # %for.body10
	...
	vextrins.d	$vr7, $vr8, 16
	xvpickve.d	$xr8, $xr12, 3
	vextrins.d	$vr12, $vr8, 16
	xvpermi.q	$xr7, $xr12, 2
	xvpermi.d	$xr4, $xr4, 0
	xvfmul.d	$xr8, $xr7, $xr4
	xvfmul.d	$xr4, $xr10, $xr4
	...
	xvst	$xr5, $sp, 384
	xvst	$xr4, $sp, 352
	xvpermi.d	$xr4, $xr6, 17
	xvpermi.d	$xr5, $xr8, 17
	xvfmul.d	$xr9, $xr13, $xr5
	xvpermi.q	$xr8, $xr8, 2
	xvfmul.d	$xr11, $xr17, $xr8
	xvfadd.d	$xr9, $xr9, $xr11
	xvreplve0.d	$xr3, $xr3
	xvfmul.d	$xr11, $xr10, $xr3
	xvfadd.d	$xr9, $xr9, $xr11
	xvst	$xr9, $sp, 224
	xvfmul.d	$xr9, $xr13, $xr4
	xvfmul.d	$xr4, $xr2, $xr4
	xvpermi.q	$xr6, $xr6, 2
	xvfmul.d	$xr11, $xr17, $xr6
	xvfmul.d	$xr6, $xr16, $xr6
	xvfadd.d	$xr4, $xr4, $xr6
	xvfadd.d	$xr6, $xr9, $xr11
	xvpermi.d	$xr1, $xr1, 0
	xvfmul.d	$xr9, $xr7, $xr1
