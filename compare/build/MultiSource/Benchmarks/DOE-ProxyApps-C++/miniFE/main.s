...
# %bb.32:                               # %for.body104.preheader
	...
	addi.w	$a1, $a1, 0
	bgeu	$t5, $t0, .LBB14_35
.LBB14_33:                              # %for.body104.preheader596
                                        #   in Loop: Header=BB14_31 Depth=1
	alsl.d	$t5, $a1, $s1, 2
	alsl.d	$t6, $a1, $s3, 3
	alsl.d	$t7, $t3, $a3, 2
...
# %bb.67:
	move	$a1, $zero
	b	.LBB14_77
.LBB14_68:                              # %vector.memcheck548
	alsl.d	$a1, $s6, $a2, 2
	sub.d	$a7, $a1, $s1
	ori	$t0, $zero, 32
	move	$a1, $s6
	bltu	$a7, $t0, .LBB14_56
# %bb.69:                               # %vector.memcheck548
	alsl.d	$a1, $s6, $a6, 3
	sub.d	$a7, $a1, $s3
	ori	$t0, $zero, 64
	move	$a1, $s6
...
.LBB14_71:                              # %vector.body558
	...
	addi.d	$t3, $t3, 64
	bnez	$t4, .LBB14_71
# %bb.72:                               # %middle.block566
	bne	$a3, $a7, .LBB14_56
	b	.LBB14_58
.LBB14_73:                              # %vector.ph576
...
.LBB23_18:                              # %for.cond40.preheader.us.us.us
	...
	beqz	$a1, .LBB23_28
# %bb.19:                               # %for.body43.us64.us.us.preheader
                                        #   in Loop: Header=BB23_18 Depth=2
	ld.d	$a1, $sp, 64                    # 8-byte Folded Reload
	or	$a4, $a3, $a1
	move	$s7, $s3
	...
	b	.LBB23_21
	.p2align	4, , 16
.LBB23_20:                              # %if.then.i.i57.us70.us.us
	...
	addi.w	$s1, $s1, 1
	beq	$a7, $s1, .LBB23_17
.LBB23_21:                              # %for.body43.us64.us.us
                                        #   Parent Loop BB23_16 Depth=1
	...
	or	$s0, $a2, $a1
	bne	$s4, $a0, .LBB23_20
# %bb.22:                               # %if.else.i.i.us72.us.us
                                        #   in Loop: Header=BB23_21 Depth=3
	sub.d	$s5, $a0, $s7
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	beq	$s5, $a0, .LBB23_38
# %bb.23:                               # %_ZNKSt6vectorIiSaIiEE12_M_check_lenEmPKc.exit.i.i.i.us79.us.us
                                        #   in Loop: Header=BB23_21 Depth=3
	move	$s2, $s6
	srai.d	$a0, $s5, 2
	ori	$s4, $zero, 1
	...
	stx.w	$s0, $a0, $s5
	blt	$s5, $s4, .LBB23_25
# %bb.24:                               # %if.then.i.i.i.i.i.i.us87.us.us
                                        #   in Loop: Header=BB23_21 Depth=3
	move	$a0, $s3
	move	$a1, $s7
	move	$a2, $s5
	pcaddu18i	$ra, %call36(memcpy)
	jirl	$ra, $ra, 0
.LBB23_25:                              # %_ZNSt6vectorIiSaIiEE11_S_relocateEPiS2_S2_RS0_.exit.i.i.i.us88.us.us
                                        #   in Loop: Header=BB23_21 Depth=3
	beqz	$s7, .LBB23_27
# %bb.26:                               # %_ZNSt12_Vector_baseIiSaIiEE13_M_deallocateEPim.exit.i.i.i.i.us90.us.us
                                        #   in Loop: Header=BB23_21 Depth=3
	move	$a0, $s7
	move	$a1, $s5
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB23_27:                              # %_ZNSt6vectorIiSaIiEE17_M_realloc_appendIJiEEEvDpOT_.exit.i.i.us91.us.us
                                        #   in Loop: Header=BB23_21 Depth=3
	add.d	$a0, $s3, $s5
	addi.d	$s4, $a0, 4
	st.d	$s3, $fp, 0
...
.LBB23_28:                              #   in Loop: Header=BB23_18 Depth=2
	...
	b	.LBB23_30
	.p2align	4, , 16
.LBB23_29:                              # %if.then.i.i57.us.us.us.us
	...
	addi.w	$s2, $s2, -1
	beqz	$s2, .LBB23_17
.LBB23_30:                              # %for.body43.us.us.us.us
                                        #   Parent Loop BB23_16 Depth=1
                                        #     Parent Loop BB23_18 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	bne	$s4, $a0, .LBB23_29
# %bb.31:                               # %if.else.i.i.us.us.us.us
                                        #   in Loop: Header=BB23_30 Depth=3
	sub.d	$s5, $a0, $s7
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	beq	$s5, $a0, .LBB23_38
# %bb.32:                               # %_ZNKSt6vectorIiSaIiEE12_M_check_lenEmPKc.exit.i.i.i.us.us.us.us
	...
	stx.w	$a0, $s3, $s5
	blt	$s5, $s0, .LBB23_34
# %bb.33:                               # %if.then.i.i.i.i.i.i.us.us.us.us
                                        #   in Loop: Header=BB23_30 Depth=3
	move	$a0, $s3
	move	$a1, $s7
	move	$a2, $s5
...
.LBB39_6:                               # %for.body10
	...
	ld.d	$a3, $sp, 112                   # 8-byte Folded Reload
	xvldx	$xr11, $a2, $a3
	xvpermi.d	$xr2, $xr8, 68
	xvld	$xr12, $s2, 128
	xvrepl128vei.d	$xr2, $xr2, 1
	xvpickve.d	$xr6, $xr8, 3
	xvinsve0.d	$xr2, $xr6, 1
	xvpickve.d	$xr6, $xr12, 3
	xvinsve0.d	$xr2, $xr6, 2
	xvpickve.d	$xr6, $xr2, 1
	xvld	$xr13, $s2, 160
	xvpermi.d	$xr14, $xr2, 78
                                        # kill: def $vr2 killed $vr2 killed $xr2 def $xr2
	vextrins.d	$vr2, $vr6, 16
	xvrepl128vei.d	$xr6, $xr14, 0
	xvpickve.d	$xr14, $xr13, 1
	vextrins.d	$vr6, $vr14, 16
	xvpermi.q	$xr2, $xr6, 2
	xvpermi.d	$xr6, $xr11, 68
	xvrepl128vei.d	$xr6, $xr6, 1
	xvpickve.d	$xr14, $xr11, 3
	xvinsve0.d	$xr6, $xr14, 1
	xvpickve.d	$xr14, $xr10, 3
	xvinsve0.d	$xr6, $xr14, 2
	xvpickve.d	$xr14, $xr6, 1
	xvpermi.d	$xr15, $xr6, 78
                                        # kill: def $vr6 killed $vr6 killed $xr6 def $xr6
	vextrins.d	$vr6, $vr14, 16
	xvrepl128vei.d	$xr14, $xr15, 0
	xvpickve.d	$xr15, $xr9, 1
	vextrins.d	$vr14, $vr15, 16
	xvpermi.q	$xr6, $xr14, 2
	xvfmul.d	$xr14, $xr6, $xr5
	xvfmul.d	$xr15, $xr2, $xr5
	xvld	$xr17, $sp, 64                  # 32-byte Folded Reload
	xvori.b	$xr16, $xr17, 0
	xvshuf.d	$xr16, $xr12, $xr8
	xvld	$xr18, $sp, 32                  # 32-byte Folded Reload
	xvori.b	$xr5, $xr18, 0
	xvshuf.d	$xr5, $xr13, $xr16
	xvori.b	$xr16, $xr17, 0
	xvshuf.d	$xr16, $xr10, $xr11
	xvori.b	$xr17, $xr18, 0
	xvshuf.d	$xr17, $xr9, $xr16
	xvpermi.q	$xr7, $xr7, 2
	xvfmul.d	$xr16, $xr17, $xr7
	xvfmul.d	$xr7, $xr5, $xr7
	xvfadd.d	$xr7, $xr15, $xr7
	xvfadd.d	$xr14, $xr14, $xr16
	xvpickve.d	$xr10, $xr10, 1
	xvpermi.d	$xr11, $xr11, 78
	xvrepl128vei.d	$xr11, $xr11, 0
	...
	xvrepl128vei.d	$xr8, $xr8, 0
	vextrins.d	$vr8, $vr9, 16
	xvpickve.d	$xr9, $xr8, 1
	vextrins.d	$vr8, $vr9, 16
	xvpickve.d	$xr9, $xr13, 3
	vextrins.d	$vr13, $vr9, 16
	xvpermi.q	$xr8, $xr13, 2
	xvpermi.d	$xr4, $xr4, 68
	xvrepl128vei.d	$xr4, $xr4, 0
	xvfmul.d	$xr9, $xr8, $xr4
	xvfmul.d	$xr4, $xr11, $xr4
	xvfadd.d	$xr4, $xr14, $xr4
	vld	$vr10, $sp, 168
	xvfadd.d	$xr7, $xr7, $xr9
	xvst	$xr7, $sp, 384
	xvst	$xr4, $sp, 352
	xvpermi.d	$xr4, $xr10, 68
	vld	$vr7, $sp, 192
	xvbsrl.v	$xr9, $xr4, 8
	xvbsll.v	$xr4, $xr4, 8
	xvor.v	$xr4, $xr4, $xr9
	xvpermi.d	$xr9, $xr7, 68
	xvbsrl.v	$xr12, $xr9, 8
	xvbsll.v	$xr9, $xr9, 8
	xvor.v	$xr9, $xr9, $xr12
	xvfmul.d	$xr12, $xr6, $xr9
	xvpermi.q	$xr7, $xr7, 2
	xvfmul.d	$xr13, $xr17, $xr7
	xvfadd.d	$xr12, $xr12, $xr13
	xvreplve0.d	$xr3, $xr3
	xvfmul.d	$xr13, $xr11, $xr3
	xvfadd.d	$xr12, $xr12, $xr13
	xvst	$xr12, $sp, 224
	...
	xvfadd.d	$xr6, $xr6, $xr12
	xvpermi.d	$xr1, $xr1, 68
	xvrepl128vei.d	$xr1, $xr1, 0
	xvfmul.d	$xr10, $xr8, $xr1
	xvfmul.d	$xr1, $xr11, $xr1
	xvfadd.d	$xr1, $xr6, $xr1
	xvfadd.d	$xr4, $xr4, $xr10
	xvst	$xr4, $sp, 320
	xvst	$xr1, $sp, 288
	xvfmul.d	$xr1, $xr2, $xr9
	xvfmul.d	$xr2, $xr5, $xr7
	xvfadd.d	$xr1, $xr1, $xr2
	xvfmul.d	$xr2, $xr8, $xr3
	xvfadd.d	$xr1, $xr1, $xr2
	xvst	$xr1, $sp, 256
	xvreplve0.d	$xr1, $xr0
	ori	$a2, $zero, 7
