...
.LBB0_43:                               # %if.end18.i
	...
	stx.b	$zero, $a1, $a0
	ld.d	$a0, $sp, 80
.LBB0_44:                               # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit
	st.d	$zero, $sp, 88
	st.b	$zero, $a0, 0
	ld.d	$a0, $sp, 80
	addi.d	$s0, $sp, 96
	beq	$a0, $s0, .LBB0_46
# %bb.45:                               # %if.then.i.i241
	ld.d	$a1, $sp, 96
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB0_46:                               # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit247
	ld.d	$a0, $sp, 16
	beq	$a0, $s5, .LBB0_48
# %bb.47:                               # %if.then.i.i249
	ld.d	$a1, $sp, 32
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB0_48:                               # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit255
	ld.d	$a0, $sp, 48
	beq	$a0, $s4, .LBB0_50
# %bb.49:                               # %if.then.i.i257
	ld.d	$a1, $sp, 64
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB0_50:                               # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit263
...
.Ltmp36:                                # EH_LABEL
	...
	move	$a1, $a0
.Ltmp37:                                # EH_LABEL
# %bb.51:                               # %invoke.cont129
	ld.d	$a0, $sp, 80
	st.w	$a1, $fp, 64
	beq	$a0, $s0, .LBB0_53
# %bb.52:                               # %if.then.i.i277
	ld.d	$a1, $sp, 96
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB0_53:                               # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit283
	st.d	$s0, $sp, 80
	ori	$a0, $zero, 19
	st.d	$a0, $sp, 48
.Ltmp39:                                # EH_LABEL
...
.Ltmp42:                                # EH_LABEL
	...
	move	$a1, $a0
.Ltmp43:                                # EH_LABEL
# %bb.55:                               # %invoke.cont142
	ld.d	$a0, $sp, 80
	st.w	$a1, $fp, 68
	beq	$a0, $s0, .LBB0_57
# %bb.56:                               # %if.then.i.i297
	ld.d	$a1, $sp, 96
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB0_57:                               # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit303
...
.Ltmp45:                                # EH_LABEL
	...
	move	$a1, $a0
.Ltmp46:                                # EH_LABEL
# %bb.58:                               # %invoke.cont155
	ld.d	$a0, $sp, 80
	st.w	$a1, $fp, 72
	beq	$a0, $s0, .LBB0_60
# %bb.59:                               # %if.then.i.i317
	ld.d	$a1, $sp, 96
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB0_60:                               # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit323
...
.Ltmp48:                                # EH_LABEL
	...
	move	$a1, $a0
.Ltmp49:                                # EH_LABEL
# %bb.61:                               # %invoke.cont168
	ld.d	$a0, $sp, 80
	st.w	$a1, $fp, 76
	beq	$a0, $s0, .LBB0_63
# %bb.62:                               # %if.then.i.i337
	ld.d	$a1, $sp, 96
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB0_63:                               # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit343
...
.Ltmp51:                                # EH_LABEL
	...
	move	$a1, $a0
.Ltmp52:                                # EH_LABEL
# %bb.64:                               # %invoke.cont181
	ld.d	$a0, $sp, 80
	st.w	$a1, $fp, 80
	beq	$a0, $s0, .LBB0_66
# %bb.65:                               # %if.then.i.i357
	ld.d	$a1, $sp, 96
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB0_66:                               # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit363
...
.Ltmp54:                                # EH_LABEL
	...
	move	$a1, $a0
.Ltmp55:                                # EH_LABEL
# %bb.67:                               # %invoke.cont194
	ld.d	$a0, $sp, 80
	st.w	$a1, $fp, 84
	beq	$a0, $s0, .LBB0_69
# %bb.68:                               # %if.then.i.i377
	ld.d	$a1, $sp, 96
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB0_69:                               # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit383
	st.d	$s0, $sp, 80
	lu12i.w	$a0, 399063
	ori	$a0, $a0, 1390
	st.w	$a0, $sp, 96
...
.Ltmp57:                                # EH_LABEL
	...
	move	$a1, $a0
.Ltmp58:                                # EH_LABEL
# %bb.70:                               # %invoke.cont207
	ld.d	$a0, $sp, 80
	st.w	$a1, $fp, 88
	beq	$a0, $s0, .LBB0_72
# %bb.71:                               # %if.then.i.i397
	ld.d	$a1, $sp, 96
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB0_72:                               # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit403
	ld.d	$a0, $sp, 112
	addi.d	$a1, $sp, 128
	beq	$a0, $a1, .LBB0_74
# %bb.73:                               # %if.then.i.i405
	ld.d	$a1, $sp, 128
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB0_74:                               # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit411
	ld.d	$a0, $sp, 144
	beq	$a0, $s2, .LBB0_76
# %bb.75:                               # %if.then.i.i413
	ld.d	$a1, $sp, 160
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB0_76:                               # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit419
	ld.d	$a0, $sp, 176
	beq	$a0, $s1, .LBB0_78
# %bb.77:                               # %if.then.i.i421
	ld.d	$a1, $sp, 192
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB0_78:                               # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit427
...
.Ltmp35:                                # EH_LABEL
	...
	move	$fp, $a0
	beq	$a2, $s5, .LBB0_92
# %bb.91:                               # %if.then.i.i485
	ld.d	$a0, $sp, 32
	addi.d	$a1, $a0, 1
	move	$a0, $a2
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB0_92:                               # %ehcleanup115
	ld.d	$a0, $sp, 48
	beq	$a0, $s4, .LBB0_105
# %bb.93:                               # %if.then.i.i493
	ld.d	$a1, $sp, 64
	addi.d	$a1, $a1, 1
	b	.LBB0_104
.LBB0_94:                               # %lpad94
...
.LBB0_104:                              # %ehcleanup214
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB0_105:                              # %ehcleanup214
	ld.d	$a0, $sp, 112
	addi.d	$a1, $sp, 128
	beq	$a0, $a1, .LBB0_108
# %bb.106:                              # %if.then.i.i557
	ld.d	$a1, $sp, 128
	addi.d	$a1, $a1, 1
.LBB0_107:                              # %ehcleanup215
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB0_108:                              # %ehcleanup215
	ld.d	$a0, $sp, 144
	bne	$a0, $s2, .LBB0_111
# %bb.109:                              # %ehcleanup218
	ld.d	$a0, $sp, 176
	bne	$a0, $s1, .LBB0_112
.LBB0_110:                              # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit579
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB0_111:                              # %if.then.i.i565
	ld.d	$a1, $sp, 160
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
