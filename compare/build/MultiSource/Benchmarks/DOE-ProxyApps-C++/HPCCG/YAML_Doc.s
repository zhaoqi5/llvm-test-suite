...
.Ltmp104:                               # EH_LABEL
	...
	move	$s2, $a0
	beq	$a2, $s8, .LBB3_281
.LBB3_259:                              # %ehcleanup67.sink.split
	ld.d	$a0, $sp, 40
	b	.LBB3_279
.LBB3_260:                              # %lpad82
.Ltmp95:                                # EH_LABEL
...
.LBB3_271:                              # %ehcleanup
	...
	bne	$a2, $s6, .LBB3_286
	b	.LBB3_294
.LBB3_272:                              # %lpad.i.i637
.Ltmp89:                                # EH_LABEL
.LBB3_273:                              # %lpad110
	ld.d	$a2, $sp, 24
	move	$s2, $a0
	beq	$a2, $s6, .LBB3_275
# %bb.274:                              # %ehcleanup114.sink.split
	ld.d	$a0, $sp, 40
	addi.d	$a1, $a0, 1
	move	$a0, $a2
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB3_275:                              # %ehcleanup114
	ld.d	$a2, $sp, 160
	bne	$a2, $s5, .LBB3_278
	b	.LBB3_281
.LBB3_276:                              # %lpad.i.i609
.Ltmp92:                                # EH_LABEL
	ld.d	$a2, $sp, 160
	move	$s2, $a0
	bne	$a2, $s5, .LBB3_278
	b	.LBB3_281
.LBB3_277:                              # %lpad.i.i776
.Ltmp69:                                # EH_LABEL
	ld.d	$a2, $sp, 160
	move	$s2, $a0
	beq	$a2, $s3, .LBB3_281
.LBB3_278:                              # %ehcleanup117.sink.split
	ld.d	$a0, $sp, 176
.LBB3_279:                              # %ehcleanup125
	addi.d	$a1, $a0, 1
	move	$a0, $a2
.LBB3_280:                              # %ehcleanup125
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
...
.LBB3_285:                              # %lpad.i.i
	...
	move	$s2, $a0
	beq	$a2, $s6, .LBB3_294
.LBB3_286:                              # %ehcleanup8.sink.split
	ld.d	$a0, $sp, 144
	addi.d	$a1, $a0, 1
	move	$a0, $a2
	b	.LBB3_293
...
.Ltmp39:                                # EH_LABEL
	...
	move	$s2, $a0
	beq	$a2, $s3, .LBB3_290
# %bb.289:                              # %if.then.i.i320
	ld.d	$a0, $sp, 176
	addi.d	$a1, $a0, 1
	move	$a0, $a2
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB3_290:                              # %ehcleanup40
	ld.d	$a0, $sp, 96
	beq	$a0, $s6, .LBB3_294
# %bb.291:                              # %if.then.i.i328
	ld.d	$a1, $sp, 112
.LBB3_292:                              # %ehcleanup130
	addi.d	$a1, $a1, 1
.LBB3_293:                              # %ehcleanup130
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB3_294:                              # %ehcleanup130
	...
	beq	$a0, $a1, .LBB3_296
# %bb.295:                              # %if.then.i.i856
	ld.d	$a1, $sp, 8                     # 8-byte Folded Reload
	ld.d	$a1, $a1, 0
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB3_296:                              # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit862
	move	$a0, $s2
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.Lfunc_end3:
