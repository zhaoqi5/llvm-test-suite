...
# %bb.24:                               # %middle.block
	bne	$a0, $a4, .LBB12_3
	b	.LBB12_5
.LBB12_25:                              # %vector.ph117
	bstrpick.d	$a2, $a1, 30, 2
	slli.d	$a2, $a2, 2
	move	$a3, $s1
	move	$a4, $a2
	.p2align	4, , 16
.LBB12_26:                              # %vector.body120
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a3, 0
...
# %bb.13:                               # %for.body.i.preheader.i.i.i
	...
	pcaddu18i	$ra, %call36(memset)
	jirl	$ra, $ra, 0
.LBB43_14:                              # %_ZSt27__uninitialized_default_n_aIPimiET_S1_T0_RSaIT1_E.exit
	st.d	$s0, $fp, 8
.LBB43_15:                              # %if.end45
	ld.d	$s7, $sp, 16                    # 8-byte Folded Reload
	ld.d	$s6, $sp, 24                    # 8-byte Folded Reload
...
# %bb.13:                               # %for.body.i.preheader.i.i.i
	...
	pcaddu18i	$ra, %call36(memset)
	jirl	$ra, $ra, 0
.LBB44_14:                              # %_ZSt27__uninitialized_default_n_aIPdmdET_S1_T0_RSaIT1_E.exit
	st.d	$s0, $fp, 8
.LBB44_15:                              # %if.end45
	ld.d	$s7, $sp, 16                    # 8-byte Folded Reload
	ld.d	$s6, $sp, 24                    # 8-byte Folded Reload
