...
.LBB6_79:                               # %for.cond.cleanup458
	...
	st.w	$s0, $a2, %pc_lo12(save_ncells)
...
# %bb.24:                               # %middle.block
	bne	$a0, $a4, .LBB12_3
	b	.LBB12_5
.LBB12_25:                              # %vector.ph121
	bstrpick.d	$a2, $a1, 30, 2
	slli.d	$a2, $a2, 2
	move	$a3, $s1
	move	$a4, $a2
	.p2align	4, , 16
.LBB12_26:                              # %vector.body124
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a3, 0
...
.LBB17_81:                              # %if.end1006.split
                                        #   in Loop: Header=BB17_55 Depth=1
	alsl.d	$s7, $s0, $s3, 2
	fst.d	$fs5, $sp, 304                  # 8-byte Folded Spill
	fadd.d	$fa1, $fs6, $fs5
	fmul.d	$fa1, $fa1, $ft5
	movgr2cf	$fcc0, $s8
...
# %bb.107:                              # %if.then1199
	...
	slli.d	$a0, $a0, 2
	ldx.w	$a4, $s3, $a0
	fld.d	$fs5, $sp, 552                  # 8-byte Folded Reload
	bge	$a3, $a4, .LBB17_110
# %bb.108:                              # %if.then1205
                                        #   in Loop: Header=BB17_55 Depth=1
	ldx.w	$a0, $t7, $a0
...
.LBB17_109:                             #   in Loop: Header=BB17_55 Depth=1
	...
	b	.LBB17_113
	.p2align	4, , 16
.LBB17_110:                             #   in Loop: Header=BB17_55 Depth=1
	fld.d	$fa3, $sp, 328                  # 8-byte Folded Reload
.LBB17_111:                             # %if.end1213
                                        #   in Loop: Header=BB17_55 Depth=1
	fld.d	$fa0, $sp, 792                  # 8-byte Folded Reload
	fmul.d	$fa1, $ft2, $fa0
	fsqrt.d	$fa0, $fa1
...
.LBB17_112:                             # %if.end1213.split
	...
	fmul.d	$fa0, $fa0, $ft5
	fmul.d	$fs6, $fa0, $ft5
.LBB17_113:                             # %if.end1229
                                        #   in Loop: Header=BB17_55 Depth=1
	fld.d	$fa4, $sp, 536                  # 8-byte Folded Reload
...
.LBB17_115:                             # %if.end1250
	...
	fmov.d	$fa3, $fs4
	fmov.d	$fa0, $fs0
	fst.d	$fs0, $sp, 776                  # 8-byte Folded Spill
	bltz	$a4, .LBB17_117
# %bb.116:                              # %if.then1267
                                        #   in Loop: Header=BB17_55 Depth=1
	slli.d	$a4, $a4, 3
	...
	fldx.d	$fa1, $t0, $a4
	fldx.d	$fa3, $a6, $a4
	fst.d	$fa1, $sp, 776                  # 8-byte Folded Spill
	fmul.d	$fa0, $fa0, $fa1
.LBB17_117:                             # %if.end1286
                                        #   in Loop: Header=BB17_55 Depth=1
...
# %bb.118:                              # %if.then1299
	...
	fldx.d	$fa2, $t0, $a3
	fldx.d	$fa1, $a6, $a3
	fst.d	$fa1, $sp, 672                  # 8-byte Folded Spill
	fst.d	$fa2, $sp, 624                  # 8-byte Folded Spill
	fmul.d	$fa0, $fa0, $fa2
	fst.d	$fa0, $sp, 384                  # 8-byte Folded Spill
	b	.LBB17_120
	.p2align	4, , 16
.LBB17_119:                             #   in Loop: Header=BB17_55 Depth=1
	slt	$a3, $s5, $a3
	movgr2cf	$fcc0, $a3
...
.LBB17_120:                             # %if.end1318
                                        #   in Loop: Header=BB17_55 Depth=1
	ldx.w	$a3, $t2, $s1
	fmov.d	$fa2, $fs4
	fmov.d	$fa0, $fs0
	fst.d	$fs0, $sp, 768                  # 8-byte Folded Spill
	bltz	$a3, .LBB17_122
# %bb.121:                              # %if.then1326
                                        #   in Loop: Header=BB17_55 Depth=1
	slli.d	$a3, $a3, 3
...
# %bb.123:                              # %if.then1358
	...
	fldx.d	$fs0, $t0, $a0
	fldx.d	$fa1, $a6, $a0
	fst.d	$fa1, $sp, 656                  # 8-byte Folded Spill
	fst.d	$fs0, $sp, 616                  # 8-byte Folded Spill
	fmul.d	$fs0, $fa0, $fs0
	b	.LBB17_125
	.p2align	4, , 16
.LBB17_124:                             #   in Loop: Header=BB17_55 Depth=1
	movgr2cf	$fcc0, $s2
	fsel	$fa0, $fs0, $fs4, $fcc0
	fst.d	$fa0, $sp, 656                  # 8-byte Folded Spill
	fst.d	$fs0, $sp, 616                  # 8-byte Folded Spill
.LBB17_125:                             # %if.end1377
                                        #   in Loop: Header=BB17_55 Depth=1
	...
	fsqrt.d	$fa0, $fa0
	fcmp.cor.d	$fcc0, $fa0, $fa0
	fst.d	$fa3, $sp, 504                  # 8-byte Folded Spill
	bceqz	$fcc0, .LBB17_168
.LBB17_126:                             # %if.end1377.split
                                        #   in Loop: Header=BB17_55 Depth=1
...
# %bb.128:                              # %if.then1399
	...
	b	.LBB17_130
	.p2align	4, , 16
.LBB17_129:                             #   in Loop: Header=BB17_55 Depth=1
	fld.d	$fa2, $sp, 336                  # 8-byte Folded Reload
.LBB17_130:                             # %if.end1407
                                        #   in Loop: Header=BB17_55 Depth=1
	fld.d	$fa3, $sp, 672                  # 8-byte Folded Reload
	fld.d	$fa0, $sp, 792                  # 8-byte Folded Reload
	fmul.d	$fa1, $fa3, $fa0
...
# %bb.137:                              # %if.then1475
	...
	b	.LBB17_139
	.p2align	4, , 16
.LBB17_138:                             #   in Loop: Header=BB17_55 Depth=1
	fld.d	$fa3, $sp, 344                  # 8-byte Folded Reload
.LBB17_139:                             # %if.end1483
                                        #   in Loop: Header=BB17_55 Depth=1
	fld.d	$fa2, $sp, 656                  # 8-byte Folded Reload
	fld.d	$fa0, $sp, 792                  # 8-byte Folded Reload
	fmul.d	$fa1, $fa2, $fa0
...
.LBB17_145:                             #   in Loop: Header=BB17_55 Depth=1
	fst.d	$fs2, $sp, 696                  # 8-byte Folded Spill
	b	.LBB17_149
	.p2align	4, , 16
.LBB17_146:                             #   in Loop: Header=BB17_55 Depth=1
	fld.d	$fa3, $sp, 352                  # 8-byte Folded Reload
.LBB17_147:                             # %if.end1529
                                        #   in Loop: Header=BB17_55 Depth=1
	...
	fsqrt.d	$fa0, $fa1
	fcmp.cor.d	$fcc0, $fa0, $fa0
	bceqz	$fcc0, .LBB17_178
.LBB17_148:                             # %if.end1529.split
                                        #   in Loop: Header=BB17_55 Depth=1
	fld.d	$fa1, $sp, 624                  # 8-byte Folded Reload
	fdiv.d	$fa1, $fa1, $fa2
	fabs.d	$fa1, $fa1
	...
	fmul.d	$fa0, $fa0, $ft5
	fst.d	$fa0, $sp, 696                  # 8-byte Folded Spill
.LBB17_149:                             # %if.end1545
                                        #   in Loop: Header=BB17_55 Depth=1
	fsqrt.d	$fa0, $fs1
	fcmp.cor.d	$fcc0, $fa0, $fa0
	bceqz	$fcc0, .LBB17_171
.LBB17_150:                             # %if.end1545.split
                                        #   in Loop: Header=BB17_55 Depth=1
...
# %bb.152:                              # %if.then1567
	...
	b	.LBB17_154
	.p2align	4, , 16
.LBB17_153:                             #   in Loop: Header=BB17_55 Depth=1
	fld.d	$fa3, $sp, 360                  # 8-byte Folded Reload
.LBB17_154:                             # %if.end1575
                                        #   in Loop: Header=BB17_55 Depth=1
	fld.d	$fa2, $sp, 656                  # 8-byte Folded Reload
	fld.d	$fa0, $sp, 792                  # 8-byte Folded Reload
	fmul.d	$fa1, $fa2, $fa0
	fsqrt.d	$fa0, $fa1
	fcmp.cor.d	$fcc0, $fa0, $fa0
	bceqz	$fcc0, .LBB17_179
.LBB17_155:                             # %if.end1575.split
                                        #   in Loop: Header=BB17_55 Depth=1
	fld.d	$fa1, $sp, 616                  # 8-byte Folded Reload
	fdiv.d	$fa1, $fa1, $fa2
	fabs.d	$fa1, $fa1
...
# %bb.159:                              # %if.then1641
	...
	fadd.d	$fa3, $fa3, $fa5
	fmul.d	$fa3, $fa3, $ft5
.LBB17_160:                             # %if.end1655
                                        #   in Loop: Header=BB17_55 Depth=1
	fld.d	$ft13, $sp, 768                 # 8-byte Folded Reload
...
# %bb.163:                              # %if.then1677
                                        #   in Loop: Header=BB17_55 Depth=1
	fld.d	$ft14, $sp, 616                 # 8-byte Folded Reload
	fadd.d	$ft1, $ft13, $ft14
	fmul.d	$ft13, $ft1, $ft5
	fld.d	$ft2, $sp, 656                  # 8-byte Folded Reload
	fdiv.d	$ft1, $fs0, $ft2
	fadd.d	$fa7, $fa7, $ft1
	fmul.d	$fa7, $fa7, $ft5
	fmul.d	$ft1, $ft14, $ft14
	fdiv.d	$ft1, $ft1, $ft2
	fmul.d	$ft2, $ft2, $ft2
	fmul.d	$fa2, $ft2, $fa2
	fadd.d	$fa2, $fa2, $ft1
...
.LBB17_179:                             # %call.sqrt1481
	...
	move	$a1, $s0
	b	.LBB17_155
.LBB17_180:                             # %for.cond.cleanup349.for.cond.cleanup673_crit_edge
