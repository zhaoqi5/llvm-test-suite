...
# %bb.22:                               # %if.end183
	...
	move	$a7, $a2
	bge	$a5, $a1, .LBB2_18
.LBB2_23:                               # %while.body196.preheader
                                        #   in Loop: Header=BB2_19 Depth=1
	move	$a6, $a2
	.p2align	4, , 16
.LBB2_24:                               # %while.body196
                                        #   Parent Loop BB2_19 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.w	$t0, $t0, 2
	bge	$t0, $a1, .LBB2_27
# %bb.25:                               # %land.lhs.true199
...
# %bb.26:                               # %if.then210
	...
	b	.LBB2_28
	.p2align	4, , 16
.LBB2_27:                               # %while.body196.if.end212_crit_edge
                                        #   in Loop: Header=BB2_24 Depth=2
	move	$a7, $a5
.LBB2_28:                               # %if.end212
                                        #   in Loop: Header=BB2_24 Depth=2
...
# %bb.35:                               # %if.end243
	...
	move	$a7, $a2
	bge	$a5, $a1, .LBB2_31
.LBB2_36:                               # %while.body256.preheader
                                        #   in Loop: Header=BB2_32 Depth=1
	move	$a6, $a2
	.p2align	4, , 16
.LBB2_37:                               # %while.body256
                                        #   Parent Loop BB2_32 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.w	$t0, $t0, 2
	bge	$t0, $a1, .LBB2_40
# %bb.38:                               # %land.lhs.true259
...
# %bb.39:                               # %if.then270
	...
	b	.LBB2_41
	.p2align	4, , 16
.LBB2_40:                               # %while.body256.if.end272_crit_edge
                                        #   in Loop: Header=BB2_37 Depth=2
	move	$a7, $a5
.LBB2_41:                               # %if.end272
                                        #   in Loop: Header=BB2_37 Depth=2
...
# %bb.48:                               # %if.end123
	...
	move	$t0, $a2
	bge	$a7, $a1, .LBB2_44
.LBB2_49:                               # %while.body136.preheader
                                        #   in Loop: Header=BB2_45 Depth=1
	move	$a6, $a2
	.p2align	4, , 16
.LBB2_50:                               # %while.body136
                                        #   Parent Loop BB2_45 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.w	$t0, $t1, 2
	bge	$t0, $a1, .LBB2_52
# %bb.51:                               # %land.lhs.true139
...
# %bb.72:                               # %if.end63
	...
	move	$t0, $a2
	bge	$a7, $a1, .LBB2_68
.LBB2_73:                               # %while.body76.preheader
                                        #   in Loop: Header=BB2_69 Depth=1
	move	$a6, $a2
	.p2align	4, , 16
.LBB2_74:                               # %while.body76
                                        #   Parent Loop BB2_69 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.w	$t0, $t1, 2
	bge	$t0, $a1, .LBB2_76
# %bb.75:                               # %land.lhs.true79
