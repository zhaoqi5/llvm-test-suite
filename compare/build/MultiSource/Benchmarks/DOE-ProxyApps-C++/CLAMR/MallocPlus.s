...
.LBB6_18:                               # %if.else
	...
	ld.d	$a0, $s7, 64
	beqz	$a0, .LBB6_23
.LBB6_19:                               # %while.body.i.i.i.i.preheader
                                        #   in Loop: Header=BB6_10 Depth=1
	ld.d	$a6, $sp, 24                    # 8-byte Folded Reload
	move	$a1, $a6
	.p2align	4, , 16
.LBB6_20:                               # %while.body.i.i.i.i
                                        #   Parent Loop BB6_10 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a2, $a0, 32
	sltu	$a2, $a2, $s5
...
.LBB8_14:                               # %invoke.cont16
	...
	move	$s8, $s4
	beqz	$a1, .LBB8_19
# %bb.15:                               # %while.body.i.i.i.i.preheader
                                        #   in Loop: Header=BB8_9 Depth=1
	move	$a0, $s4
	.p2align	4, , 16
.LBB8_16:                               # %while.body.i.i.i.i
                                        #   Parent Loop BB8_9 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a2, $a1, 32
	sltu	$a2, $a2, $s6
...
.Ltmp87:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp88:                                # EH_LABEL
# %bb.25:                               # %call5.i.i.i.i.i.noexc191
                                        #   in Loop: Header=BB15_9 Depth=1
	move	$s7, $a0
	addi.d	$s8, $a0, 32
	st.d	$s6, $a0, 32
...
# %bb.31:                               # %if.end.i.i.i.i26.i
	...
	jirl	$ra, $ra, 0
.LBB15_32:                              # %invoke.cont.i
                                        #   in Loop: Header=BB15_9 Depth=1
	blez	$s7, .LBB15_34
# %bb.33:                               # %if.then.i.i.i33.i
                                        #   in Loop: Header=BB15_9 Depth=1
	move	$a0, $s6
	move	$a1, $s1
	move	$a2, $s7
...
.LBB15_37:                              # %if.else111
	...
	move	$s6, $a0
	beqz	$s5, .LBB15_40
# %bb.38:                               # %for.body128.preheader
                                        #   in Loop: Header=BB15_9 Depth=1
	ori	$a0, $zero, 1
	ld.d	$a1, $sp, 40                    # 8-byte Folded Reload
	move	$a2, $s6
	.p2align	4, , 16
.LBB15_39:                              # %for.body128
                                        #   Parent Loop BB15_9 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$a3, $a1, 0
	slli.d	$a3, $a3, 2
...
# %bb.41:                               # %invoke.cont139
	...
	ld.d	$s5, $sp, 56                    # 8-byte Folded Reload
	beqz	$a0, .LBB15_46
# %bb.42:                               # %while.body.i.i.i.i98.preheader
                                        #   in Loop: Header=BB15_9 Depth=1
	ld.d	$a6, $sp, 56                    # 8-byte Folded Reload
	move	$a1, $a6
	.p2align	4, , 16
.LBB15_43:                              # %while.body.i.i.i.i98
                                        #   Parent Loop BB15_9 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a2, $a0, 32
	sltu	$a2, $a2, $s6
	...
	or	$a1, $a1, $a3
	bnez	$a0, .LBB15_43
# %bb.44:                               # %_ZNSt3mapIPvP24malloc_plus_memory_entrySt4lessIS0_ESaISt4pairIKS0_S2_EEE11lower_boundERS6_.exit.i108
                                        #   in Loop: Header=BB15_9 Depth=1
	move	$s5, $a6
	beq	$a1, $a6, .LBB15_46
# %bb.45:                               # %lor.rhs.i111
...
.Ltmp81:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp82:                                # EH_LABEL
# %bb.47:                               # %call5.i.i.i.i.i.noexc218
                                        #   in Loop: Header=BB15_9 Depth=1
	move	$s7, $a0
	addi.d	$s8, $a0, 32
	st.d	$s6, $a0, 32
...
.Ltmp85:                                # EH_LABEL
	b	.LBB15_65
.LBB15_48:                              # %if.then.i.i.i.i
                                        #   in Loop: Header=BB15_9 Depth=1
	st.w	$zero, $a2, 0
	addi.d	$a0, $a2, 4
	ori	$a1, $zero, 1
	beq	$s8, $a1, .LBB15_50
# %bb.49:                               # %for.body.i.preheader.i.i.i.i
                                        #   in Loop: Header=BB15_9 Depth=1
	slli.d	$a1, $s8, 2
	move	$s6, $a3
	alsl.d	$s0, $s8, $a2, 2
	...
	move	$a0, $s0
	move	$a3, $s6
.LBB15_50:                              # %for.body.i.preheader.i.i.i.i
                                        #   in Loop: Header=BB15_9 Depth=1
	move	$s6, $s1
	ld.d	$s8, $sp, 48                    # 8-byte Folded Reload
	st.d	$a3, $sp, 24                    # 8-byte Folded Spill
...
# %bb.58:                               # %invoke.cont58
	...
	ld.d	$s5, $sp, 56                    # 8-byte Folded Reload
	beqz	$a0, .LBB15_63
# %bb.59:                               # %while.body.i.i.i.i.preheader
                                        #   in Loop: Header=BB15_9 Depth=1
	ld.d	$a6, $sp, 56                    # 8-byte Folded Reload
	move	$a1, $a6
	.p2align	4, , 16
.LBB15_60:                              # %while.body.i.i.i.i
                                        #   Parent Loop BB15_9 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a2, $a0, 32
	sltu	$a2, $a2, $s6
...
.LBB15_71:                              # %_ZNSt6vectorIiSaIiEE5clearEv.exit
	beqz	$s1, .LBB15_73
# %bb.72:                               # %if.then.i.i.i133
	ld.d	$a0, $sp, 24                    # 8-byte Folded Reload
	sub.d	$a1, $a0, $s1
	move	$a0, $s1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB15_73:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit138
	ld.d	$a1, $sp, 80
.Ltmp93:                                # EH_LABEL
	addi.d	$a0, $sp, 64
	pcaddu18i	$ra, %call36(_ZNSt8_Rb_treeIPvSt4pairIKS0_P24malloc_plus_memory_entryESt10_Select1stIS5_ESt4lessIS0_ESaIS5_EE8_M_eraseEPSt13_Rb_tree_nodeIS5_E)
...
.Ltmp76:                                # EH_LABEL
# %bb.76:                               # %.noexc157
.LBB15_77:                              # %terminate.lpad.i.i
.Ltmp95:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.LBB15_78:                              # %lpad16.loopexit
.Ltmp65:                                # EH_LABEL
	b	.LBB15_90
.LBB15_79:                              # %lpad16.loopexit.split-lp
.Ltmp77:                                # EH_LABEL
	b	.LBB15_90
.LBB15_80:                              # %_ZNSt8_Rb_treeIPvSt4pairIKS0_P24malloc_plus_memory_entryESt10_Select1stIS5_ESt4lessIS0_ESaIS5_EE10_Auto_nodeD2Ev.exit.i173
.Ltmp92:                                # EH_LABEL
	b	.LBB15_87
.LBB15_81:                              # %lpad102
.Ltmp89:                                # EH_LABEL
	b	.LBB15_89
.LBB15_82:                              # %_ZNSt8_Rb_treeIPvSt4pairIKS0_P24malloc_plus_memory_entryESt10_Select1stIS5_ESt4lessIS0_ESaIS5_EE10_Auto_nodeD2Ev.exit.i200
.Ltmp86:                                # EH_LABEL
	b	.LBB15_87
.LBB15_83:                              # %lpad144
.Ltmp83:                                # EH_LABEL
...
.LBB15_88:                              # %lpad57
.Ltmp68:                                # EH_LABEL
.LBB15_89:                              # %ehcleanup156
	ld.d	$s5, $sp, 24                    # 8-byte Folded Reload
.LBB15_90:                              # %ehcleanup156
	move	$fp, $a0
.LBB15_91:                              # %ehcleanup156
	beqz	$s1, .LBB15_93
# %bb.92:                               # %if.then.i.i.i
	sub.d	$a1, $s5, $s1
	move	$a0, $s1
