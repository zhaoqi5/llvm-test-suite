...
.Ltmp178:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp179:                               # EH_LABEL
# %bb.7:                                # %if.then10.if.end14_crit_edge
	ld.d	$a3, $s1, 8
	ld.d	$a0, $sp, 504
	b	.LBB39_11
.LBB39_8:                               # %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit17.thread159
	addi.d	$fp, $sp, 512
	st.d	$fp, $sp, 496
	st.d	$zero, $sp, 504
	st.b	$zero, $sp, 512
...
# %bb.14:                               # %if.then20
	ld.d	$a0, $sp, 504
	beq	$a0, $s2, .LBB39_61
# %bb.15:                               # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKc.exit.i
.Ltmp182:                               # EH_LABEL
	pcalau12i	$a0, %pc_hi20(.L.str.57)
...
.Ltmp192:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp193:                               # EH_LABEL
.LBB39_25:                              # %invoke.cont44
	ld.d	$a0, $sp, 16
	addi.w	$a1, $zero, -2
	lu52i.d	$s3, $a1, 2047
	beq	$a0, $s3, .LBB39_63
# %bb.26:                               # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKc.exit.i59
.Ltmp195:                               # EH_LABEL
	pcalau12i	$a0, %pc_hi20(.L.str.14)
	addi.d	$a1, $a0, %pc_lo12(.L.str.14)
	addi.d	$a0, $sp, 8
...
# %bb.28:                               # %if.else.i.i60
	...
	st.d	$a1, $sp, 40
	b	.LBB39_32
.LBB39_29:                              # %_ZNSt11char_traitsIcE4copyEPcPKcm.exit.i
	ld.d	$s1, $sp, 504
	addi.d	$a2, $s1, 1
	move	$a1, $fp
	pcaddu18i	$ra, %call36(memcpy)
	jirl	$ra, $ra, 0
.LBB39_30:                              # %cleanup.thread
	st.d	$s1, $s0, 8
	st.d	$zero, $sp, 504
	st.b	$zero, $sp, 512
	b	.LBB39_50
.LBB39_31:                              # %_ZNSt11char_traitsIcE4copyEPcPKcm.exit.i.i
	ld.d	$s4, $a0, 8
	addi.d	$a2, $s4, 1
	move	$s7, $a0
	move	$a0, $s1
...
.LBB39_32:                              # %invoke.cont46
	...
	st.b	$zero, $a0, 16
	bltu	$a1, $a2, .LBB39_65
# %bb.33:                               # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendERKS4_.exit.i71
.Ltmp197:                               # EH_LABEL
	ld.d	$a1, $sp, 496
	addi.d	$a0, $sp, 40
	pcaddu18i	$ra, %call36(_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_appendEPKcm)
...
# %bb.35:                               # %if.else.i.i74
	...
	st.d	$a0, $sp, 72
	b	.LBB39_37
.LBB39_36:                              # %_ZNSt11char_traitsIcE4copyEPcPKcm.exit.i.i80
	ld.d	$s7, $s3, 8
	addi.d	$a2, $s7, 1
	move	$a0, $s2
	move	$a1, $s4
...
.LBB39_40:                              # %if.then29.i
	...
	ld.d	$a0, $sp, 72
	beq	$a0, $s2, .LBB39_42
.LBB39_41:                              # %if.then.i.i94
	ld.d	$a1, $sp, 88
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB39_42:                              # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit
	ld.d	$a0, $sp, 40
	beq	$a0, $s1, .LBB39_44
# %bb.43:                               # %if.then.i.i99
	ld.d	$a1, $sp, 56
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB39_44:                              # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit105
	ld.d	$a0, $sp, 8
	beq	$a0, $s5, .LBB39_46
# %bb.45:                               # %if.then.i.i107
	ld.d	$a1, $sp, 24
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB39_46:                              # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit113
	pcalau12i	$a0, %got_pc_hi20(_ZTTNSt7__cxx1118basic_stringstreamIcSt11char_traitsIcESaIcEEE)
	ld.d	$s0, $a0, %got_pc_lo12(_ZTTNSt7__cxx1118basic_stringstreamIcSt11char_traitsIcESaIcEEE)
	ld.d	$a0, $s0, 0
	st.d	$a0, $sp, 104
...
.LBB39_48:                              # %cleanup
	...
	ld.d	$a0, $sp, 496
	beq	$a0, $fp, .LBB39_50
# %bb.49:                               # %if.then.i.i139
	ld.d	$a1, $sp, 512
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB39_50:                              # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit145
...
.Ltmp205:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp206:                               # EH_LABEL
# %bb.62:                               # %if.then.i.i.i.cont
.LBB39_63:                              # %if.then.i.i.i62
.Ltmp202:                               # EH_LABEL
	pcalau12i	$a0, %pc_hi20(.L.str.66)
	addi.d	$a0, $a0, %pc_lo12(.L.str.66)
	pcaddu18i	$ra, %call36(_ZSt20__throw_length_errorPKc)
...
.LBB39_73:                              # %ehcleanup
	ld.d	$a2, $sp, 8
	beq	$a2, $s5, .LBB39_75
.LBB39_74:                              # %ehcleanup50.sink.split
	ld.d	$a0, $sp, 24
	addi.d	$a1, $a0, 1
	move	$a0, $a2
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB39_75:                              # %ehcleanup50
	ld.d	$a0, $s0, 0
	beq	$a0, $s6, .LBB39_77
# %bb.76:                               # %if.then.i.i131
	ld.d	$a1, $s6, 0
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB39_77:                              # %ehcleanup54
	addi.d	$a0, $sp, 104
	pcaddu18i	$ra, %call36(_ZNSt7__cxx1118basic_stringstreamIcSt11char_traitsIcESaIcEED1Ev)
	jirl	$ra, $ra, 0
	b	.LBB39_80
.LBB39_78:                              # %lpad11
.Ltmp207:                               # EH_LABEL
.LBB39_79:                              # %ehcleanup56
	move	$s2, $a0
.LBB39_80:                              # %ehcleanup56
	ld.d	$a0, $sp, 496
	beq	$a0, $fp, .LBB39_82
# %bb.81:                               # %if.then.i.i147
	ld.d	$a1, $sp, 512
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB39_82:                              # %ehcleanup58
	move	$a0, $s2
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.Lfunc_end39:
