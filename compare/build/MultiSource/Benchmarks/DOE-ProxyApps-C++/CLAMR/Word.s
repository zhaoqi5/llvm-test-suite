...
.LBB13_68:                              # %if.then311.critedge
	ori	$a0, $zero, 2
	b	.LBB13_19
.LBB13_69:                              # %for.cond315.preheader
	ori	$a3, $zero, 1
	blt	$a2, $a3, .LBB13_75
# %bb.70:                               # %for.body321.preheader
...
# %bb.80:                               # %if.end408
	...
	jirl	$ra, $ra, 0
	b	.LBB13_20
.LBB13_81:                              # %for.cond413.preheader
	ori	$a4, $zero, 1
	blt	$a2, $a4, .LBB13_90
# %bb.82:                               # %for.body419.preheader
	move	$a2, $zero
	move	$a5, $zero
...
# %bb.92:                               # %if.then.i.i97
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB13_93:                              # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit102
	bnez	$s0, .LBB13_20
.LBB13_94:                              # %if.then504
	ori	$a0, $zero, 1
	b	.LBB13_19
...
.LBB39_75:                              # %ehcleanup
	ld.d	$a0, $sp, 8
	beq	$a0, $s5, .LBB39_78
# %bb.76:                               # %if.then.i.i123
	ld.d	$a1, $sp, 24
	addi.d	$a1, $a1, 1
.LBB39_77:                              # %ehcleanup50
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB39_78:                              # %ehcleanup50
	ld.d	$a0, $s0, 0
	beq	$a0, $s6, .LBB39_80
# %bb.79:                               # %if.then.i.i131
	ld.d	$a1, $s6, 0
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB39_80:                              # %ehcleanup54
	addi.d	$a0, $sp, 104
	pcaddu18i	$ra, %call36(_ZNSt7__cxx1118basic_stringstreamIcSt11char_traitsIcESaIcEED1Ev)
	jirl	$ra, $ra, 0
	b	.LBB39_83
.LBB39_81:                              # %lpad11
.Ltmp207:                               # EH_LABEL
.LBB39_82:                              # %ehcleanup56
	move	$s2, $a0
.LBB39_83:                              # %ehcleanup56
	ld.d	$a0, $sp, 496
	beq	$a0, $fp, .LBB39_85
# %bb.84:                               # %if.then.i.i147
	ld.d	$a1, $sp, 512
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB39_85:                              # %ehcleanup58
	move	$a0, $s2
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.Lfunc_end39:
