...
# %bb.50:
	move	$a2, $zero
	b	.LBB3_60
.LBB3_51:                               # %for.body38.preheader695
...
.LBB3_70:
	move	$a1, $zero
	b	.LBB3_82
.LBB3_71:                               # %vector.main.loop.iter.check653
	ori	$a0, $zero, 16
	bgeu	$s8, $a0, .LBB3_73
# %bb.72:
	move	$a0, $zero
...
# %bb.75:                               # %middle.block665
	...
	beq	$s8, $a0, .LBB3_82
# %bb.76:                               # %vec.epilog.iter.check670
	ld.d	$a2, $sp, 16                    # 8-byte Folded Reload
	andi	$a2, $a2, 384
	beqz	$a2, .LBB3_80
.LBB3_77:                               # %vec.epilog.ph669
	move	$a3, $a0
	...
	alsl.d	$a3, $a3, $a4, 2
	.p2align	4, , 16
.LBB3_78:                               # %vec.epilog.vector.body675
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a3, 0
	vld	$vr2, $a2, 0
	vadd.w	$vr0, $vr1, $vr0
	...
	addi.d	$a3, $a3, 16
	bnez	$a1, .LBB3_78
# %bb.79:                               # %vec.epilog.middle.block681
