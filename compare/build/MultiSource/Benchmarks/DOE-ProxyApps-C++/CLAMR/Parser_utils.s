...
.LBB3_27:                               # %vector.ph
	...
	b	.LBB3_29
	.p2align	4, , 16
.LBB3_28:                               # %pred.store.continue597
...
# %bb.30:                               # %pred.store.continue
	...
	andi	$a4, $a4, 1
	bnez	$a4, .LBB3_38
.LBB3_31:                               # %pred.store.continue585
                                        #   in Loop: Header=BB3_29 Depth=1
	xvpickve2gr.w	$a4, $xr1, 2
	andi	$a4, $a4, 1
	bnez	$a4, .LBB3_39
.LBB3_32:                               # %pred.store.continue587
                                        #   in Loop: Header=BB3_29 Depth=1
	xvpickve2gr.w	$a4, $xr1, 3
	andi	$a4, $a4, 1
	bnez	$a4, .LBB3_40
.LBB3_33:                               # %pred.store.continue589
                                        #   in Loop: Header=BB3_29 Depth=1
	xvpickve2gr.w	$a4, $xr1, 4
	andi	$a4, $a4, 1
	bnez	$a4, .LBB3_41
.LBB3_34:                               # %pred.store.continue591
                                        #   in Loop: Header=BB3_29 Depth=1
	xvpickve2gr.w	$a4, $xr1, 5
	andi	$a4, $a4, 1
	bnez	$a4, .LBB3_42
.LBB3_35:                               # %pred.store.continue593
                                        #   in Loop: Header=BB3_29 Depth=1
	xvpickve2gr.w	$a4, $xr1, 6
	andi	$a4, $a4, 1
	bnez	$a4, .LBB3_43
.LBB3_36:                               # %pred.store.continue595
                                        #   in Loop: Header=BB3_29 Depth=1
...
.LBB3_37:                               # %pred.store.if
	...
	andi	$a4, $a4, 1
	beqz	$a4, .LBB3_31
.LBB3_38:                               # %pred.store.if584
                                        #   in Loop: Header=BB3_29 Depth=1
	xvstelm.w	$xr0, $a1, -12, 1
	xvpickve2gr.w	$a4, $xr1, 2
	andi	$a4, $a4, 1
	beqz	$a4, .LBB3_32
.LBB3_39:                               # %pred.store.if586
                                        #   in Loop: Header=BB3_29 Depth=1
	xvstelm.w	$xr0, $a1, -8, 2
	xvpickve2gr.w	$a4, $xr1, 3
	andi	$a4, $a4, 1
	beqz	$a4, .LBB3_33
.LBB3_40:                               # %pred.store.if588
                                        #   in Loop: Header=BB3_29 Depth=1
	xvstelm.w	$xr0, $a1, -4, 3
	xvpickve2gr.w	$a4, $xr1, 4
	andi	$a4, $a4, 1
	beqz	$a4, .LBB3_34
.LBB3_41:                               # %pred.store.if590
                                        #   in Loop: Header=BB3_29 Depth=1
	xvstelm.w	$xr0, $a1, 0, 4
	xvpickve2gr.w	$a4, $xr1, 5
	andi	$a4, $a4, 1
	beqz	$a4, .LBB3_35
.LBB3_42:                               # %pred.store.if592
                                        #   in Loop: Header=BB3_29 Depth=1
	xvstelm.w	$xr0, $a1, 4, 5
	xvpickve2gr.w	$a4, $xr1, 6
	andi	$a4, $a4, 1
	beqz	$a4, .LBB3_36
.LBB3_43:                               # %pred.store.if594
                                        #   in Loop: Header=BB3_29 Depth=1
	xvstelm.w	$xr0, $a1, 8, 6
	xvpickve2gr.w	$a4, $xr1, 7
	andi	$a4, $a4, 1
	beqz	$a4, .LBB3_28
.LBB3_44:                               # %pred.store.if596
                                        #   in Loop: Header=BB3_29 Depth=1
...
# %bb.50:
	move	$a2, $zero
	b	.LBB3_60
.LBB3_51:                               # %for.body38.preheader668
...
.LBB3_70:
	move	$a1, $zero
	b	.LBB3_82
.LBB3_71:                               # %vector.main.loop.iter.check626
	ori	$a0, $zero, 16
	bgeu	$s8, $a0, .LBB3_73
# %bb.72:
	move	$a0, $zero
...
# %bb.75:                               # %middle.block638
	...
	beq	$s8, $a0, .LBB3_82
# %bb.76:                               # %vec.epilog.iter.check643
	ld.d	$a2, $sp, 16                    # 8-byte Folded Reload
	andi	$a2, $a2, 384
	beqz	$a2, .LBB3_80
.LBB3_77:                               # %vec.epilog.ph642
	move	$a3, $a0
	...
	alsl.d	$a3, $a3, $a4, 2
	.p2align	4, , 16
.LBB3_78:                               # %vec.epilog.vector.body648
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a3, 0
	vld	$vr2, $a2, 0
	vadd.w	$vr0, $vr1, $vr0
	...
	addi.d	$a3, $a3, 16
	bnez	$a1, .LBB3_78
# %bb.79:                               # %vec.epilog.middle.block654
...
# %bb.138:                              # %if.then.i.i258
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB3_139:                              # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit264
                                        #   in Loop: Header=BB3_87 Depth=1
	ld.d	$a0, $sp, 160                   # 8-byte Folded Reload
	ld.d	$s7, $a0, 0
	b	.LBB3_86
...
.LBB3_143:                              # %for.body183
	...
	ld.d	$a0, $sp, 80                    # 8-byte Folded Reload
	bne	$a2, $a0, .LBB3_162
# %bb.144:                              # %for.cond187.preheader
                                        #   in Loop: Header=BB3_143 Depth=1
	ori	$a0, $zero, 1
	blt	$s3, $a0, .LBB3_155
# %bb.145:                              # %for.cond191.preheader.preheader
                                        #   in Loop: Header=BB3_143 Depth=1
	move	$s0, $zero
	b	.LBB3_147
	.p2align	4, , 16
.LBB3_146:                              # %for.cond.cleanup210
                                        #   in Loop: Header=BB3_147 Depth=2
	addi.d	$s0, $s0, 1
	ld.d	$a0, $sp, 128                   # 8-byte Folded Reload
	beq	$s0, $a0, .LBB3_155
.LBB3_147:                              # %for.cond191.preheader
	...
	ori	$a1, $zero, 1
	blt	$a0, $a1, .LBB3_151
# %bb.148:                              # %for.body196.preheader
                                        #   in Loop: Header=BB3_147 Depth=2
	move	$s2, $zero
	ld.d	$a0, $sp, 152                   # 8-byte Folded Reload
	alsl.d	$fp, $s0, $a0, 2
	.p2align	4, , 16
.LBB3_149:                              # %for.body196
                                        #   Parent Loop BB3_143 Depth=1
...
# %bb.150:                              # %for.inc200
	...
	addi.w	$s2, $s2, 1
	blt	$s2, $a0, .LBB3_149
.LBB3_151:                              # %for.cond206.preheader
                                        #   in Loop: Header=BB3_147 Depth=2
	ld.d	$a0, $sp, 120                   # 8-byte Folded Reload
	ldx.w	$a0, $a0, $s1
	ori	$a1, $zero, 1
	blt	$a0, $a1, .LBB3_146
# %bb.152:                              # %for.body211.preheader
                                        #   in Loop: Header=BB3_147 Depth=2
	move	$s1, $zero
	ld.d	$a0, $sp, 120                   # 8-byte Folded Reload
	alsl.d	$fp, $s0, $a0, 2
	.p2align	4, , 16
.LBB3_153:                              # %for.body211
                                        #   Parent Loop BB3_143 Depth=1
                                        #     Parent Loop BB3_147 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
.Ltmp28:                                # EH_LABEL
...
# %bb.156:                              # %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i
	...
	ld.bu	$a0, $s7, 56
	beqz	$a0, .LBB3_158
# %bb.157:                              # %if.then.i2.i.i
                                        #   in Loop: Header=BB3_143 Depth=1
	ld.bu	$a0, $s7, 67
	b	.LBB3_160
.LBB3_158:                              # %if.end.i.i.i367
                                        #   in Loop: Header=BB3_143 Depth=1
.Ltmp31:                                # EH_LABEL
	move	$a0, $s7
...
# %bb.163:                              # %for.body235.lr.ph
	...
	b	.LBB3_165
	.p2align	4, , 16
.LBB3_164:                              # %for.cond.cleanup332
                                        #   in Loop: Header=BB3_165 Depth=2
	addi.d	$s7, $s7, 1
	ld.d	$a0, $sp, 128                   # 8-byte Folded Reload
	beq	$s7, $a0, .LBB3_184
.LBB3_165:                              # %for.body235
                                        #   Parent Loop BB3_143 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB3_170 Depth 3
                                        #       Child Loop BB3_173 Depth 3
...
.LBB3_168:                              # %if.end247
	...
	ori	$a0, $zero, 1
	blt	$a1, $a0, .LBB3_172
# %bb.169:                              # %for.body264.preheader
                                        #   in Loop: Header=BB3_165 Depth=2
	move	$s2, $zero
	ld.d	$a0, $sp, 152                   # 8-byte Folded Reload
	alsl.d	$s8, $s7, $a0, 2
	.p2align	4, , 16
.LBB3_170:                              # %for.body264
                                        #   Parent Loop BB3_143 Depth=1
...
# %bb.171:                              # %for.inc269
	...
	addi.w	$s2, $s2, 1
	blt	$s2, $a0, .LBB3_170
.LBB3_172:                              # %for.cond275.preheader
                                        #   in Loop: Header=BB3_165 Depth=2
	sub.w	$s8, $s0, $s3
...
.LBB3_196:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit293
	...
	addi.d	$sp, $sp, 320
	ret
.LBB3_197:                              # %if.then.i.i.i368.invoke
.Ltmp62:                                # EH_LABEL
	pcaddu18i	$ra, %call36(_ZSt16__throw_bad_castv)
	jirl	$ra, $ra, 0
.Ltmp63:                                # EH_LABEL
# %bb.198:                              # %if.then.i.i.i368.cont
.LBB3_199:                              # %if.then.i.i10.invoke.i.i
.Ltmp65:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp66:                                # EH_LABEL
# %bb.200:                              # %if.then.i.i10.cont.i.i
.LBB3_201:                              # %if.then.i.i237
.Ltmp68:                                # EH_LABEL
...
.Ltmp5:                                 # EH_LABEL
	...
	beqz	$a0, .LBB3_230
	b	.LBB3_232
.LBB3_206:                              # %lpad151.loopexit
.Ltmp17:                                # EH_LABEL
	b	.LBB3_209
.LBB3_207:                              # %lpad131
.Ltmp14:                                # EH_LABEL
	b	.LBB3_226
.LBB3_208:                              # %lpad151.loopexit.split-lp
.Ltmp70:                                # EH_LABEL
.LBB3_209:                              # %ehcleanup
	move	$s0, $a0
	b	.LBB3_214
.LBB3_210:                              # %lpad.i.i.loopexit.split-lp
.Ltmp67:                                # EH_LABEL
	b	.LBB3_212
.LBB3_211:                              # %lpad.i.i.loopexit
.Ltmp24:                                # EH_LABEL
.LBB3_212:                              # %lpad.i.i
	move	$s0, $a0
	ld.d	$a0, $sp, 168
...
.LBB3_214:                              # %ehcleanup
	...
	addi.d	$a1, $sp, 216
	beq	$a0, $a1, .LBB3_227
# %bb.215:                              # %if.then.i.i266
	ld.d	$a1, $sp, 216
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
	b	.LBB3_227
.LBB3_216:                              # %lpad227.loopexit.split-lp
.Ltmp64:                                # EH_LABEL
	b	.LBB3_226
.LBB3_217:                              # %lpad96
.Ltmp11:                                # EH_LABEL
	b	.LBB3_226
.LBB3_218:                              # %lpad227.loopexit
.Ltmp61:                                # EH_LABEL
	b	.LBB3_226
.LBB3_219:                              # %lpad15.split.us
.Ltmp2:                                 # EH_LABEL
	move	$s0, $a0
	ld.d	$a0, $sp, 104                   # 8-byte Folded Reload
	beqz	$a0, .LBB3_230
...
.Ltmp27:                                # EH_LABEL
	b	.LBB3_226
.LBB3_223:                              # %lpad335.split
.Ltmp52:                                # EH_LABEL
	b	.LBB3_226
.LBB3_224:                              # %lpad280.split
.Ltmp44:                                # EH_LABEL
	b	.LBB3_226
.LBB3_225:                              # %lpad266
.Ltmp41:                                # EH_LABEL
.LBB3_226:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit346
	move	$s0, $a0
.LBB3_227:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit346
	...
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB3_228:                              # %ehcleanup361
	ld.d	$a0, $sp, 120                   # 8-byte Folded Reload
	bnez	$a0, .LBB3_231
# %bb.229:                              # %ehcleanup364
	ld.d	$a0, $sp, 104                   # 8-byte Folded Reload
	bnez	$a0, .LBB3_232
.LBB3_230:                              # %ehcleanup365
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB3_231:                              # %if.then.i.i.i348
	ld.d	$a1, $sp, 24                    # 8-byte Folded Reload
	sub.d	$a1, $a1, $a0
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
