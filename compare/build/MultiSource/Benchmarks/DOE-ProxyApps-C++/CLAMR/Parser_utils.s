...
# %bb.26:                               # %middle.block162
	...
	beq	$t2, $t7, .LBB2_19
# %bb.27:                               # %vec.epilog.iter.check166
                                        #   in Loop: Header=BB2_20 Depth=1
	beqz	$fp, .LBB2_31
.LBB2_28:                               # %vec.epilog.ph168
                                        #   in Loop: Header=BB2_20 Depth=1
	move	$fp, $t2
	...
	.p2align	4, , 16
.LBB2_29:                               # %vec.epilog.vector.body171
                                        #   Parent Loop BB2_20 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr3, $s0, 0
	vmul.w	$vr2, $vr3, $vr2
	...
	addi.d	$s0, $s0, 16
	bnez	$fp, .LBB2_29
# %bb.30:                               # %vec.epilog.middle.block176
                                        #   in Loop: Header=BB2_20 Depth=1
	vshuf4i.w	$vr3, $vr2, 14
	vmul.w	$vr2, $vr2, $vr3
	vreplvei.w	$vr3, $vr2, 1
...
# %bb.43:                               # %_ZN2PP12Parser_utils9start_dexERSt6vectorIiSaIiEERKS3_.exit61.us
	...
	b	.LBB2_59
	.p2align	4, , 16
.LBB2_44:                               # %iter.check182.preheader
                                        #   in Loop: Header=BB2_36 Depth=1
	ori	$fp, $zero, 1
	b	.LBB2_46
	.p2align	4, , 16
...
# %bb.47:                               #   in Loop: Header=BB2_46 Depth=2
	...
	b	.LBB2_57
	.p2align	4, , 16
.LBB2_48:                               # %vector.main.loop.iter.check184
                                        #   in Loop: Header=BB2_46 Depth=2
	bgeu	$fp, $t7, .LBB2_50
...
# %bb.52:                               # %middle.block195
	...
	beq	$fp, $s0, .LBB2_45
# %bb.53:                               # %vec.epilog.iter.check201
                                        #   in Loop: Header=BB2_46 Depth=2
	beqz	$s2, .LBB2_57
.LBB2_54:                               # %vec.epilog.ph203
                                        #   in Loop: Header=BB2_46 Depth=2
	move	$s2, $fp
	...
	.p2align	4, , 16
.LBB2_55:                               # %vec.epilog.vector.body206
                                        #   Parent Loop BB2_36 Depth=1
                                        #     Parent Loop BB2_46 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vld	$vr3, $s3, 0
	...
	addi.d	$s3, $s3, 16
	bnez	$s2, .LBB2_55
# %bb.56:                               # %vec.epilog.middle.block211
                                        #   in Loop: Header=BB2_46 Depth=2
	vshuf4i.w	$vr3, $vr2, 14
	vmul.w	$vr2, $vr2, $vr3
	vreplvei.w	$vr3, $vr2, 1
...
.LBB3_27:                               # %vector.ph
	...
	b	.LBB3_29
	.p2align	4, , 16
.LBB3_28:                               # %pred.store.continue624
...
.LBB3_31:                               # %pred.store.continue
	...
	andi	$a4, $a4, 1
	bnez	$a4, .LBB3_38
# %bb.32:                               # %pred.store.continue612
                                        #   in Loop: Header=BB3_29 Depth=1
	vpickve2gr.h	$a4, $vr1, 2
	andi	$a4, $a4, 1
	bnez	$a4, .LBB3_39
.LBB3_33:                               # %pred.store.continue614
                                        #   in Loop: Header=BB3_29 Depth=1
	vpickve2gr.h	$a4, $vr1, 3
	andi	$a4, $a4, 1
	bnez	$a4, .LBB3_40
.LBB3_34:                               # %pred.store.continue616
                                        #   in Loop: Header=BB3_29 Depth=1
	vpickve2gr.h	$a4, $vr1, 4
	andi	$a4, $a4, 1
	bnez	$a4, .LBB3_41
.LBB3_35:                               # %pred.store.continue618
                                        #   in Loop: Header=BB3_29 Depth=1
	vpickve2gr.h	$a4, $vr1, 5
	andi	$a4, $a4, 1
	bnez	$a4, .LBB3_42
.LBB3_36:                               # %pred.store.continue620
                                        #   in Loop: Header=BB3_29 Depth=1
	vpickve2gr.h	$a4, $vr1, 6
	andi	$a4, $a4, 1
	bnez	$a4, .LBB3_43
.LBB3_37:                               # %pred.store.continue622
                                        #   in Loop: Header=BB3_29 Depth=1
...
.LBB3_40:                               # %pred.store.if615
	...
	andi	$a4, $a4, 1
	beqz	$a4, .LBB3_35
.LBB3_41:                               # %pred.store.if617
                                        #   in Loop: Header=BB3_29 Depth=1
	xvstelm.w	$xr0, $a1, 0, 4
	vpickve2gr.h	$a4, $vr1, 5
	andi	$a4, $a4, 1
	beqz	$a4, .LBB3_36
.LBB3_42:                               # %pred.store.if619
                                        #   in Loop: Header=BB3_29 Depth=1
	xvstelm.w	$xr0, $a1, 4, 5
	vpickve2gr.h	$a4, $vr1, 6
	andi	$a4, $a4, 1
	beqz	$a4, .LBB3_37
.LBB3_43:                               # %pred.store.if621
                                        #   in Loop: Header=BB3_29 Depth=1
	xvstelm.w	$xr0, $a1, 8, 6
	vpickve2gr.h	$a4, $vr1, 7
	andi	$a4, $a4, 1
	beqz	$a4, .LBB3_28
.LBB3_44:                               # %pred.store.if623
                                        #   in Loop: Header=BB3_29 Depth=1
...
# %bb.50:
	move	$a2, $zero
	b	.LBB3_60
.LBB3_51:                               # %for.body38.preheader694
...
.LBB3_55:
	...
	b	.LBB3_65
.LBB3_56:                               # %vector.ph629
	bstrpick.d	$a0, $s4, 60, 4
	slli.d	$a2, $a0, 4
	xvreplgr2vr.w	$xr0, $s5
	addi.d	$a0, $a5, 32
	move	$a1, $a2
	.p2align	4, , 16
.LBB3_57:                               # %vector.body632
                                        # =>This Inner Loop Header: Depth=1
	xvst	$xr0, $a0, -32
	xvst	$xr0, $a0, 0
	addi.d	$a1, $a1, -16
...
# %bb.62:                               # %vec.epilog.middle.block
	beq	$s4, $a3, .LBB3_64
	.p2align	4, , 16
.LBB3_63:                               # %for.body.i.i.i.i.i158
                                        # =>This Inner Loop Header: Depth=1
	addi.d	$a0, $a0, -1
	st.w	$s5, $a1, 0
	addi.d	$a1, $a1, 4
	bnez	$a0, .LBB3_63
.LBB3_64:                               # %invoke.cont56.loopexit
	alsl.d	$a0, $s4, $a5, 2
	st.d	$a0, $sp, 48                    # 8-byte Folded Spill
.LBB3_65:                               # %invoke.cont56
...
.LBB3_69:
	move	$a1, $zero
	b	.LBB3_81
.LBB3_70:                               # %vector.main.loop.iter.check653
	ori	$a0, $zero, 16
	bgeu	$s3, $a0, .LBB3_72
# %bb.71:
	move	$a0, $zero
...
# %bb.74:                               # %middle.block665
	...
	beq	$s3, $a0, .LBB3_81
# %bb.75:                               # %vec.epilog.iter.check669
	ld.d	$a2, $sp, 16                    # 8-byte Folded Reload
	andi	$a2, $a2, 384
	beqz	$a2, .LBB3_79
.LBB3_76:                               # %vec.epilog.ph671
	move	$a3, $a0
	...
	alsl.d	$a3, $a3, $a4, 2
	.p2align	4, , 16
.LBB3_77:                               # %vec.epilog.vector.body674
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a3, 0
	vld	$vr2, $a2, 0
	vadd.w	$vr0, $vr1, $vr0
	...
	addi.d	$a3, $a3, 16
	bnez	$a1, .LBB3_77
# %bb.78:                               # %vec.epilog.middle.block680
	vhaddw.d.w	$vr0, $vr0, $vr0
	vhaddw.q.d	$vr0, $vr0, $vr0
	vpickve2gr.d	$a1, $vr0, 0
	beq	$s3, $a0, .LBB3_81
.LBB3_79:                               # %for.body64.preheader
	ld.d	$a2, $sp, 152                   # 8-byte Folded Reload
	alsl.d	$a2, $a0, $a2, 2
...
# %bb.82:                               # %if.then74
	...
	stx.w	$a0, $a3, $a1
	blez	$a2, .LBB3_140
# %bb.83:                               # %for.cond87.preheader.lr.ph
	move	$s2, $zero
	addi.d	$s4, $sp, 216
	...
	b	.LBB3_86
	.p2align	4, , 16
.LBB3_84:                               # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit264
...
.LBB3_85:                               # %cleanup
	...
	mul.w	$a0, $a0, $a1
	bge	$s2, $a0, .LBB3_140
.LBB3_86:                               # %for.cond87.preheader
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB3_89 Depth 2
	slli.d	$a1, $s2, 4
	ld.d	$a0, $sp, 88                    # 8-byte Folded Reload
	blez	$a0, .LBB3_103
# %bb.87:                               # %for.body90.preheader
                                        #   in Loop: Header=BB3_86 Depth=1
	move	$s1, $zero
	move	$s3, $zero
	move	$fp, $zero
	...
	b	.LBB3_89
	.p2align	4, , 16
.LBB3_88:                               # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit212
...
.Ltmp9:                                 # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp10:                                # EH_LABEL
# %bb.91:                               # %call.i4.i.noexc198
                                        #   in Loop: Header=BB3_89 Depth=2
	ld.d	$a1, $sp, 168
	st.d	$a0, $sp, 200
	st.d	$a1, $sp, 216
.LBB3_92:                               # %if.end.i.i192
                                        #   in Loop: Header=BB3_89 Depth=2
	addi.w	$a2, $zero, -1
	beq	$a1, $a2, .LBB3_95
# %bb.93:                               # %if.end.i.i192
                                        #   in Loop: Header=BB3_89 Depth=2
	bnez	$a1, .LBB3_98
# %bb.94:                               # %if.then.i.i.i194
                                        #   in Loop: Header=BB3_89 Depth=2
	ld.b	$a1, $s6, 0
	st.b	$a1, $a0, 0
.LBB3_95:                               # %invoke.cont97
                                        #   in Loop: Header=BB3_89 Depth=2
	ld.d	$a0, $sp, 168
	st.d	$a0, $sp, 208
...
.LBB3_101:                              # %if.then.i.i207
	...
	b	.LBB3_88
	.p2align	4, , 16
.LBB3_102:                              # %for.cond.cleanup89.loopexit
                                        #   in Loop: Header=BB3_86 Depth=1
	ld.d	$s8, $sp, 160                   # 8-byte Folded Reload
	ld.d	$s7, $s8, 0
	ld.d	$s3, $sp, 120                   # 8-byte Folded Reload
...
.Ltmp12:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp13:                                # EH_LABEL
# %bb.106:                              # %call.i4.i.noexc225
                                        #   in Loop: Header=BB3_86 Depth=1
	ld.d	$a1, $sp, 168
	st.d	$a0, $sp, 200
	st.d	$a1, $sp, 216
.LBB3_107:                              # %if.end.i.i219
                                        #   in Loop: Header=BB3_86 Depth=1
	addi.w	$s0, $zero, -1
	beq	$a1, $s0, .LBB3_111
# %bb.108:                              # %if.end.i.i219
                                        #   in Loop: Header=BB3_86 Depth=1
	bnez	$a1, .LBB3_110
# %bb.109:                              # %if.then.i.i.i221
                                        #   in Loop: Header=BB3_86 Depth=1
	ld.b	$a1, $s6, 0
	st.b	$a1, $a0, 0
	b	.LBB3_111
.LBB3_110:                              # %if.end.i.i.i.i222
                                        #   in Loop: Header=BB3_86 Depth=1
	addi.d	$a2, $a1, 1
	move	$a1, $s6
	pcaddu18i	$ra, %call36(memcpy)
	jirl	$ra, $ra, 0
.LBB3_111:                              # %invoke.cont132
                                        #   in Loop: Header=BB3_86 Depth=1
	ld.d	$a3, $sp, 168
	sub.d	$a0, $fp, $s1
	sub.w	$a1, $a3, $a0
...
.Ltmp20:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp21:                                # EH_LABEL
# %bb.119:                              # %invoke.cont1.i.i
                                        #   in Loop: Header=BB3_86 Depth=1
	ld.d	$a0, $sp, 176
	addi.w	$a1, $zero, -5
	lu52i.d	$a1, $a1, 2047
	bgeu	$a0, $a1, .LBB3_200
# %bb.120:                              # %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE15_M_check_lengthEmmPKc.exit.i9.i.i
                                        #   in Loop: Header=BB3_86 Depth=1
.Ltmp22:                                # EH_LABEL
...
# %bb.123:                              # %if.then22.i
	...
	ld.d	$a2, $a2, 0
	b	.LBB3_126
.LBB3_124:                              # %invoke.cont.i
                                        #   in Loop: Header=BB3_86 Depth=1
	ld.d	$s8, $sp, 160                   # 8-byte Folded Reload
	addi.d	$a2, $sp, 184
	ld.d	$s2, $sp, 96                    # 8-byte Folded Reload
	beq	$a1, $a2, .LBB3_128
# %bb.125:                              #   in Loop: Header=BB3_86 Depth=1
	move	$a0, $zero
                                        # implicit-def: $r6
.LBB3_126:                              # %if.end24.i
                                        #   in Loop: Header=BB3_86 Depth=1
...
# %bb.130:                              # %if.then9.i
	...
	ori	$a3, $zero, 1
	bne	$a2, $a3, .LBB3_133
# %bb.131:                              # %if.then.i25.i
                                        #   in Loop: Header=BB3_86 Depth=1
	ld.b	$a1, $a1, 0
	st.b	$a1, $a0, 0
	b	.LBB3_134
.LBB3_132:                              # %if.else29.i
                                        #   in Loop: Header=BB3_86 Depth=1
	addi.d	$a0, $sp, 184
	st.d	$a0, $sp, 168
	b	.LBB3_135
.LBB3_133:                              # %if.end.i.i.i
                                        #   in Loop: Header=BB3_86 Depth=1
	pcaddu18i	$ra, %call36(memcpy)
	jirl	$ra, $ra, 0
.LBB3_134:                              # %if.end17.i
	...
	stx.b	$zero, $a1, $a0
	ld.d	$a0, $sp, 168
.LBB3_135:                              # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit
                                        #   in Loop: Header=BB3_86 Depth=1
	st.d	$zero, $sp, 176
	st.b	$zero, $a0, 0
	ld.d	$a0, $sp, 168
	addi.d	$a1, $sp, 184
	beq	$a0, $a1, .LBB3_137
# %bb.136:                              # %if.then.i.i250
                                        #   in Loop: Header=BB3_86 Depth=1
	ld.d	$a1, $sp, 184
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB3_137:                              # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit256
                                        #   in Loop: Header=BB3_86 Depth=1
	ld.d	$a0, $sp, 200
	addi.d	$a1, $sp, 216
	beq	$a0, $a1, .LBB3_84
# %bb.138:                              # %if.then.i.i258
                                        #   in Loop: Header=BB3_86 Depth=1
	ld.d	$a1, $sp, 216
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
	b	.LBB3_84
.LBB3_139:                              #   in Loop: Header=BB3_86 Depth=1
	move	$a0, $a1
	b	.LBB3_135
.LBB3_140:                              # %if.end176
	sub.d	$a0, $s6, $s7
...
.LBB3_142:                              # %for.body183
	...
	bne	$s8, $a0, .LBB3_161
# %bb.143:                              # %for.cond187.preheader
                                        #   in Loop: Header=BB3_142 Depth=1
	ld.d	$a0, $sp, 88                    # 8-byte Folded Reload
	blez	$a0, .LBB3_154
# %bb.144:                              # %for.cond191.preheader.preheader
                                        #   in Loop: Header=BB3_142 Depth=1
	move	$fp, $zero
	b	.LBB3_146
	.p2align	4, , 16
.LBB3_145:                              # %for.cond.cleanup210
                                        #   in Loop: Header=BB3_146 Depth=2
	addi.d	$fp, $fp, 1
	beq	$fp, $s3, .LBB3_154
.LBB3_146:                              # %for.cond191.preheader
                                        #   Parent Loop BB3_142 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB3_148 Depth 3
                                        #       Child Loop BB3_152 Depth 3
	slli.d	$s0, $fp, 2
	...
	ldx.w	$a0, $a0, $s0
	blez	$a0, .LBB3_150
# %bb.147:                              # %for.body196.preheader
                                        #   in Loop: Header=BB3_146 Depth=2
	move	$s1, $zero
	ld.d	$a0, $sp, 152                   # 8-byte Folded Reload
	alsl.d	$s2, $fp, $a0, 2
	.p2align	4, , 16
.LBB3_148:                              # %for.body196
                                        #   Parent Loop BB3_142 Depth=1
...
# %bb.149:                              # %for.inc200
	...
	addi.w	$s1, $s1, 1
	blt	$s1, $a0, .LBB3_148
.LBB3_150:                              # %for.cond206.preheader
                                        #   in Loop: Header=BB3_146 Depth=2
	ld.d	$a0, $sp, 136                   # 8-byte Folded Reload
	ldx.w	$a0, $a0, $s0
	blez	$a0, .LBB3_145
# %bb.151:                              # %for.body211.preheader
                                        #   in Loop: Header=BB3_146 Depth=2
	move	$s0, $zero
	ld.d	$a0, $sp, 136                   # 8-byte Folded Reload
	alsl.d	$s1, $fp, $a0, 2
	.p2align	4, , 16
.LBB3_152:                              # %for.body211
                                        #   Parent Loop BB3_142 Depth=1
                                        #     Parent Loop BB3_146 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
.Ltmp28:                                # EH_LABEL
...
.Ltmp29:                                # EH_LABEL
# %bb.153:                              # %for.inc216
                                        #   in Loop: Header=BB3_152 Depth=3
	ld.w	$a0, $s1, 0
	addi.w	$s0, $s0, 1
	blt	$s0, $a0, .LBB3_152
	b	.LBB3_145
	.p2align	4, , 16
.LBB3_154:                              # %for.cond.cleanup189
                                        #   in Loop: Header=BB3_142 Depth=1
	ld.d	$a0, $s4, 0
	ld.d	$a0, $a0, -24
	add.d	$a0, $s4, $a0
	ld.d	$s7, $a0, 240
	beqz	$s7, .LBB3_198
# %bb.155:                              # %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i
                                        #   in Loop: Header=BB3_142 Depth=1
	ld.bu	$a0, $s7, 56
	beqz	$a0, .LBB3_157
# %bb.156:                              # %if.then.i2.i.i
                                        #   in Loop: Header=BB3_142 Depth=1
	ld.bu	$a0, $s7, 67
	b	.LBB3_159
.LBB3_157:                              # %if.end.i.i.i367
                                        #   in Loop: Header=BB3_142 Depth=1
.Ltmp31:                                # EH_LABEL
	move	$a0, $s7
...
.Ltmp33:                                # EH_LABEL
	...
	jirl	$ra, $a2, 0
.Ltmp34:                                # EH_LABEL
.LBB3_159:                              # %_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i
                                        #   in Loop: Header=BB3_142 Depth=1
.Ltmp35:                                # EH_LABEL
	ext.w.b	$a1, $a0
	move	$a0, $s4
...
# %bb.162:                              # %for.body235.lr.ph
	...
	b	.LBB3_164
	.p2align	4, , 16
.LBB3_163:                              # %for.cond.cleanup332
                                        #   in Loop: Header=BB3_164 Depth=2
	addi.d	$s7, $s7, 1
	ld.d	$s3, $sp, 120                   # 8-byte Folded Reload
	beq	$s7, $s3, .LBB3_184
.LBB3_164:                              # %for.body235
                                        #   Parent Loop BB3_142 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB3_169 Depth 3
                                        #       Child Loop BB3_173 Depth 3
...
.LBB3_167:                              # %if.end247
	...
	ldx.w	$s3, $a2, $a0
	blez	$a1, .LBB3_171
# %bb.168:                              # %for.body264.preheader
                                        #   in Loop: Header=BB3_164 Depth=2
	move	$fp, $zero
	ld.d	$a0, $sp, 152                   # 8-byte Folded Reload
	alsl.d	$s0, $s7, $a0, 2
	.p2align	4, , 16
.LBB3_169:                              # %for.body264
                                        #   Parent Loop BB3_142 Depth=1
                                        #     Parent Loop BB3_164 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
.Ltmp39:                                # EH_LABEL
	pcalau12i	$a0, %pc_hi20(.L.str.1)
...
.Ltmp40:                                # EH_LABEL
# %bb.170:                              # %for.inc269
                                        #   in Loop: Header=BB3_169 Depth=3
	ld.w	$a0, $s0, 0
	addi.w	$fp, $fp, 1
	blt	$fp, $a0, .LBB3_169
.LBB3_171:                              # %for.cond275.preheader
                                        #   in Loop: Header=BB3_164 Depth=2
	sub.w	$fp, $s3, $s1
	bstrpick.d	$s2, $fp, 31, 1
	blez	$fp, .LBB3_175
# %bb.172:                              # %for.cond275.preheader
                                        #   in Loop: Header=BB3_164 Depth=2
	addi.w	$a0, $s2, 0
	move	$s0, $s2
	beqz	$a0, .LBB3_175
	.p2align	4, , 16
.LBB3_173:                              # %for.body278
                                        #   Parent Loop BB3_142 Depth=1
                                        #     Parent Loop BB3_164 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
.Ltmp42:                                # EH_LABEL
...
.LBB3_184:                              # %for.cond.cleanup234
	...
	beqz	$s7, .LBB3_198
# %bb.185:                              # %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i380
                                        #   in Loop: Header=BB3_142 Depth=1
	ld.bu	$a0, $s7, 56
	beqz	$a0, .LBB3_187
# %bb.186:                              # %if.then.i2.i.i383
                                        #   in Loop: Header=BB3_142 Depth=1
	ld.bu	$a0, $s7, 67
	b	.LBB3_189
	.p2align	4, , 16
.LBB3_187:                              # %if.end.i.i.i388
                                        #   in Loop: Header=BB3_142 Depth=1
.Ltmp53:                                # EH_LABEL
	move	$a0, $s7
	pcaddu18i	$ra, %call36(_ZNKSt5ctypeIcE13_M_widen_initEv)
...
.Ltmp55:                                # EH_LABEL
	...
	jirl	$ra, $a2, 0
.Ltmp56:                                # EH_LABEL
.LBB3_189:                              # %_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i385
                                        #   in Loop: Header=BB3_142 Depth=1
.Ltmp57:                                # EH_LABEL
	ext.w.b	$a1, $a0
	move	$a0, $s4
...
.LBB3_192:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit
	...
	ld.d	$a0, $sp, 136                   # 8-byte Folded Reload
	beqz	$a0, .LBB3_194
# %bb.193:                              # %if.then.i.i.i281
	ld.d	$a1, $sp, 24                    # 8-byte Folded Reload
	sub.d	$a1, $a1, $a0
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB3_194:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit286
	ld.d	$a0, $sp, 104                   # 8-byte Folded Reload
	beqz	$a0, .LBB3_196
# %bb.195:                              # %if.then.i.i.i288
	ld.d	$a1, $sp, 32                    # 8-byte Folded Reload
	sub.d	$a1, $a1, $a0
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB3_196:                              # %_ZNSt6vectorIiSaIiEED2Ev.exit293
