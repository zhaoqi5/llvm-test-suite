...
# %bb.68:                               # %if.then378
	addi.w	$a2, $zero, -1
	beq	$a3, $a2, .LBB33_77
# %bb.69:                               # %for.body399.preheader
	move	$a0, $zero
	move	$a3, $s6
	.p2align	4, , 16
.LBB33_70:                              # %for.body399
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a4, $s1, $a3
	bstrpick.d	$a4, $a4, 31, 0
	mod.du	$s1, $a4, $s0
