...
# %bb.0:                                # %entry
	...
	ld.w	$a4, $a3, 0
	pcalau12i	$a3, %got_pc_hi20(verbose)
	ld.d	$a3, $a3, %got_pc_lo12(verbose)
	...
	ld.d	$a2, $a1, %got_pc_lo12(localStencil)
	pcalau12i	$a1, %got_pc_hi20(outline)
	ld.d	$a4, $a1, %got_pc_lo12(outline)
	...
	ld.d	$a2, $a1, %got_pc_lo12(face_based)
	pcalau12i	$a1, %got_pc_hi20(restart)
	ld.d	$a4, $a1, %got_pc_lo12(restart)
	...
	ld.d	$a4, $a1, %got_pc_lo12(outputInterval)
	ori	$a1, $zero, 100
	pcalau12i	$a2, %got_pc_hi20(nx)
	ld.d	$a5, $a2, %got_pc_lo12(nx)
	...
	ld.d	$a4, $a1, %got_pc_lo12(niter)
	ori	$a1, $zero, 3000
	pcalau12i	$a2, %got_pc_hi20(neighbor_remap)
	ld.d	$a2, $a2, %got_pc_lo12(neighbor_remap)
	st.d	$a4, $sp, 104                   # 8-byte Folded Spill
	st.w	$a1, $a4, 0
	pcalau12i	$a1, %got_pc_hi20(measure_type)
	ld.d	$a4, $a1, %got_pc_lo12(measure_type)
	st.d	$a2, $sp, 96                    # 8-byte Folded Spill
	st.b	$a3, $a2, 0
	pcalau12i	$a1, %got_pc_hi20(calc_neighbor_type)
	ld.d	$a2, $a1, %got_pc_lo12(calc_neighbor_type)
	st.d	$a4, $sp, 40                    # 8-byte Folded Spill
	st.w	$zero, $a4, 0
	pcalau12i	$a1, %got_pc_hi20(choose_hash_method)
	ld.d	$a4, $a1, %got_pc_lo12(choose_hash_method)
	st.d	$a2, $sp, 8                     # 8-byte Folded Spill
	st.w	$zero, $a2, 0
	pcalau12i	$a1, %got_pc_hi20(initial_order)
	ld.d	$a2, $a1, %got_pc_lo12(initial_order)
	st.d	$a4, $sp, 32                    # 8-byte Folded Spill
	st.w	$zero, $a4, 0
	pcalau12i	$a1, %got_pc_hi20(cycle_reorder)
	ld.d	$a4, $a1, %got_pc_lo12(cycle_reorder)
	st.d	$a2, $sp, 24                    # 8-byte Folded Spill
	st.w	$a3, $a2, 0
	pcalau12i	$a1, %got_pc_hi20(graphic_outputInterval)
	ld.d	$s8, $a1, %got_pc_lo12(graphic_outputInterval)
	...
	pcalau12i	$a1, %got_pc_hi20(levmx)
	ld.d	$a2, $a1, %got_pc_lo12(levmx)
	pcalau12i	$a1, %got_pc_hi20(mem_opt_factor)
	ld.d	$a4, $a1, %got_pc_lo12(mem_opt_factor)
	pcalau12i	$a1, %got_pc_hi20(upper_mass_diff_percentage)
	ld.d	$a5, $a1, %got_pc_lo12(upper_mass_diff_percentage)
	lu12i.w	$a1, 260096
	...
	st.d	$a1, $a5, 0
	pcalau12i	$a1, %got_pc_hi20(enhanced_precision_sum)
	ld.d	$a4, $a1, %got_pc_lo12(enhanced_precision_sum)
	pcalau12i	$a1, %got_pc_hi20(checkpoint_outputInterval)
	ld.d	$s3, $a1, %got_pc_lo12(checkpoint_outputInterval)
