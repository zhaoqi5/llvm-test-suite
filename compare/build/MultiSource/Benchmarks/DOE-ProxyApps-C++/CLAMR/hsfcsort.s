	...
	.p2align	5, 0x0                          # -- Begin function hsfc2sort
.LCPI0_0:
	.word	2                               # 0x2
	.word	5                               # 0x5
	.word	8                               # 0x8
...
# %bb.10:
	move	$a2, $zero
	move	$a1, $zero
.LBB0_11:                               # %for.body49.preheader94
	sub.d	$a2, $s3, $a2
	.p2align	4, , 16
.LBB0_12:                               # %for.body49
                                        # =>This Inner Loop Header: Depth=1
...
# %bb.16:
	move	$a1, $zero
.LBB0_17:                               # %for.body64.preheader93
	sub.d	$a2, $s3, $a1
	.p2align	4, , 16
.LBB0_18:                               # %for.body64
                                        # =>This Inner Loop Header: Depth=1
...
.Lfunc_end1:
	.size	ui2comp, .Lfunc_end1-ui2comp
                                        # -- End function
	.section	.rodata.cst32,"aM",@progbits,32
	.p2align	5, 0x0                          # -- Begin function hsfc3sort
.LCPI2_0:
	.word	3                               # 0x3
	.word	7                               # 0x7
	.word	11                              # 0xb
...
.LBB2_18:
	move	$a1, $zero
.LBB2_19:                               # %for.body103.preheader126
	sub.d	$a2, $s3, $a1
	.p2align	4, , 16
.LBB2_20:                               # %for.body103
                                        # =>This Inner Loop Header: Depth=1
...
.LBB2_22:
	...
	move	$a0, $zero
	ori	$a1, $zero, 1
.LBB2_23:                               # %for.body87.preheader127
	sub.d	$a2, $s3, $a2
	.p2align	4, , 16
.LBB2_24:                               # %for.body87
                                        # =>This Inner Loop Header: Depth=1
