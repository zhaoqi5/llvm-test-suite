...
.Ltmp411:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp412:                               # EH_LABEL
# %bb.632:                              # %invoke.cont197
	ori	$a0, $zero, 2
	st.w	$a0, $s1, 0
	b	.LBB4_129
.LBB4_633:                              # %if.end.i.i.i2531
.Ltmp124:                               # EH_LABEL
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_ZNKSt5ctypeIcE13_M_widen_initEv)
	jirl	$ra, $ra, 0
...
.Ltmp126:                               # EH_LABEL
	...
	jirl	$ra, $a2, 0
.Ltmp127:                               # EH_LABEL
.LBB4_635:                              # %_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i2528
.Ltmp128:                               # EH_LABEL
	ext.w.b	$a1, $a0
	move	$a0, $s3
	pcaddu18i	$ra, %call36(_ZNSo3putEc)
	jirl	$ra, $ra, 0
.Ltmp129:                               # EH_LABEL
# %bb.636:                              # %call1.i.noexc2539
.Ltmp130:                               # EH_LABEL
	pcaddu18i	$ra, %call36(_ZNSo5flushEv)
	jirl	$ra, $ra, 0
.Ltmp131:                               # EH_LABEL
# %bb.637:                              # %invoke.cont209
.Ltmp132:                               # EH_LABEL
...
# %bb.639:                              # %invoke.cont214
	...
	ld.d	$s4, $a0, 240
	beqz	$s4, .LBB4_760
# %bb.640:                              # %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i2549
	ld.bu	$a0, $s4, 56
	beqz	$a0, .LBB4_642
# %bb.641:                              # %if.then.i2.i.i2552
	ld.bu	$a0, $s4, 67
	b	.LBB4_644
.LBB4_642:                              # %if.end.i.i.i2557
.Ltmp136:                               # EH_LABEL
	move	$a0, $s4
	pcaddu18i	$ra, %call36(_ZNKSt5ctypeIcE13_M_widen_initEv)
	jirl	$ra, $ra, 0
...
.Ltmp138:                               # EH_LABEL
	...
	jirl	$ra, $a2, 0
.Ltmp139:                               # EH_LABEL
.LBB4_644:                              # %_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i2554
.Ltmp140:                               # EH_LABEL
	ext.w.b	$a1, $a0
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_ZNSo3putEc)
	jirl	$ra, $ra, 0
.Ltmp141:                               # EH_LABEL
# %bb.645:                              # %call1.i.noexc2565
.Ltmp142:                               # EH_LABEL
	pcaddu18i	$ra, %call36(_ZNSo5flushEv)
	jirl	$ra, $ra, 0
.Ltmp143:                               # EH_LABEL
# %bb.646:                              # %invoke.cont216
.Ltmp144:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp145:                               # EH_LABEL
# %bb.647:                              # %invoke.cont219
	ld.d	$a0, $s3, 0
	ld.d	$a0, $a0, -24
	add.d	$a0, $s3, $a0
	ld.d	$s0, $a0, 240
	beqz	$s0, .LBB4_760
# %bb.648:                              # %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i2575
	ld.bu	$a0, $s0, 56
	beqz	$a0, .LBB4_650
# %bb.649:                              # %if.then.i2.i.i2578
	ld.bu	$a0, $s0, 67
	b	.LBB4_652
.LBB4_650:                              # %if.end.i.i.i2583
.Ltmp146:                               # EH_LABEL
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_ZNKSt5ctypeIcE13_M_widen_initEv)
	jirl	$ra, $ra, 0
...
.Ltmp148:                               # EH_LABEL
	...
	jirl	$ra, $a2, 0
.Ltmp149:                               # EH_LABEL
.LBB4_652:                              # %_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i2580
.Ltmp150:                               # EH_LABEL
	ext.w.b	$a1, $a0
	move	$a0, $s3
	pcaddu18i	$ra, %call36(_ZNSo3putEc)
	jirl	$ra, $ra, 0
.Ltmp151:                               # EH_LABEL
# %bb.653:                              # %call1.i.noexc2591
.Ltmp152:                               # EH_LABEL
	pcaddu18i	$ra, %call36(_ZNSo5flushEv)
	jirl	$ra, $ra, 0
.Ltmp153:                               # EH_LABEL
# %bb.654:                              # %invoke.cont221
.Ltmp154:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp155:                               # EH_LABEL
# %bb.655:                              # %invoke.cont224
	ld.d	$a0, $s3, 0
	ld.d	$a0, $a0, -24
	add.d	$a0, $s3, $a0
	ld.d	$s0, $a0, 240
	beqz	$s0, .LBB4_760
# %bb.656:                              # %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i2601
	ld.bu	$a0, $s0, 56
	beqz	$a0, .LBB4_658
# %bb.657:                              # %if.then.i2.i.i2604
	ld.bu	$a0, $s0, 67
	b	.LBB4_660
.LBB4_658:                              # %if.end.i.i.i2609
.Ltmp156:                               # EH_LABEL
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_ZNKSt5ctypeIcE13_M_widen_initEv)
	jirl	$ra, $ra, 0
...
.Ltmp158:                               # EH_LABEL
	...
	jirl	$ra, $a2, 0
.Ltmp159:                               # EH_LABEL
.LBB4_660:                              # %_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i2606
.Ltmp160:                               # EH_LABEL
	ext.w.b	$a1, $a0
	move	$a0, $s3
	pcaddu18i	$ra, %call36(_ZNSo3putEc)
	jirl	$ra, $ra, 0
.Ltmp161:                               # EH_LABEL
# %bb.661:                              # %call1.i.noexc2617
.Ltmp162:                               # EH_LABEL
	pcaddu18i	$ra, %call36(_ZNSo5flushEv)
	jirl	$ra, $ra, 0
.Ltmp163:                               # EH_LABEL
# %bb.662:                              # %invoke.cont226
.Ltmp164:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp165:                               # EH_LABEL
# %bb.663:                              # %invoke.cont229
	ld.d	$a0, $s3, 0
	ld.d	$a0, $a0, -24
	add.d	$a0, $s3, $a0
	ld.d	$s0, $a0, 240
	beqz	$s0, .LBB4_760
# %bb.664:                              # %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i2627
	ld.bu	$a0, $s0, 56
	beqz	$a0, .LBB4_666
# %bb.665:                              # %if.then.i2.i.i2630
	ld.bu	$a0, $s0, 67
	b	.LBB4_668
.LBB4_666:                              # %if.end.i.i.i2635
.Ltmp166:                               # EH_LABEL
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_ZNKSt5ctypeIcE13_M_widen_initEv)
	jirl	$ra, $ra, 0
...
.Ltmp168:                               # EH_LABEL
	...
	jirl	$ra, $a2, 0
.Ltmp169:                               # EH_LABEL
.LBB4_668:                              # %_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i2632
.Ltmp170:                               # EH_LABEL
	ext.w.b	$a1, $a0
	move	$a0, $s3
	pcaddu18i	$ra, %call36(_ZNSo3putEc)
	jirl	$ra, $ra, 0
.Ltmp171:                               # EH_LABEL
# %bb.669:                              # %call1.i.noexc2643
.Ltmp172:                               # EH_LABEL
	pcaddu18i	$ra, %call36(_ZNSo5flushEv)
	jirl	$ra, $ra, 0
.Ltmp173:                               # EH_LABEL
# %bb.670:                              # %invoke.cont231
.Ltmp174:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp175:                               # EH_LABEL
# %bb.671:                              # %invoke.cont234
	ld.d	$a0, $s3, 0
	ld.d	$a0, $a0, -24
	add.d	$a0, $s3, $a0
	ld.d	$s0, $a0, 240
	beqz	$s0, .LBB4_760
# %bb.672:                              # %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i2653
	ld.bu	$a0, $s0, 56
	beqz	$a0, .LBB4_674
# %bb.673:                              # %if.then.i2.i.i2656
	ld.bu	$a0, $s0, 67
	b	.LBB4_676
.LBB4_674:                              # %if.end.i.i.i2661
.Ltmp176:                               # EH_LABEL
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_ZNKSt5ctypeIcE13_M_widen_initEv)
	jirl	$ra, $ra, 0
...
.Ltmp178:                               # EH_LABEL
	...
	jirl	$ra, $a2, 0
.Ltmp179:                               # EH_LABEL
.LBB4_676:                              # %_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i2658
.Ltmp180:                               # EH_LABEL
	ext.w.b	$a1, $a0
	move	$a0, $s3
	pcaddu18i	$ra, %call36(_ZNSo3putEc)
	jirl	$ra, $ra, 0
.Ltmp181:                               # EH_LABEL
# %bb.677:                              # %call1.i.noexc2669
.Ltmp182:                               # EH_LABEL
	pcaddu18i	$ra, %call36(_ZNSo5flushEv)
	jirl	$ra, $ra, 0
.Ltmp183:                               # EH_LABEL
# %bb.678:                              # %invoke.cont236
.Ltmp184:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp185:                               # EH_LABEL
# %bb.679:                              # %invoke.cont239
	ld.d	$a0, $s3, 0
	ld.d	$a0, $a0, -24
	add.d	$a0, $s3, $a0
	ld.d	$s0, $a0, 240
	beqz	$s0, .LBB4_760
# %bb.680:                              # %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i2679
	ld.bu	$a0, $s0, 56
	beqz	$a0, .LBB4_682
# %bb.681:                              # %if.then.i2.i.i2682
	ld.bu	$a0, $s0, 67
	b	.LBB4_684
.LBB4_682:                              # %if.end.i.i.i2687
.Ltmp186:                               # EH_LABEL
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_ZNKSt5ctypeIcE13_M_widen_initEv)
	jirl	$ra, $ra, 0
...
.Ltmp188:                               # EH_LABEL
	...
	jirl	$ra, $a2, 0
.Ltmp189:                               # EH_LABEL
.LBB4_684:                              # %_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i2684
.Ltmp190:                               # EH_LABEL
	ext.w.b	$a1, $a0
	move	$a0, $s3
	pcaddu18i	$ra, %call36(_ZNSo3putEc)
	jirl	$ra, $ra, 0
.Ltmp191:                               # EH_LABEL
# %bb.685:                              # %call1.i.noexc2695
.Ltmp192:                               # EH_LABEL
	pcaddu18i	$ra, %call36(_ZNSo5flushEv)
	jirl	$ra, $ra, 0
.Ltmp193:                               # EH_LABEL
# %bb.686:                              # %invoke.cont241
.Ltmp194:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp195:                               # EH_LABEL
# %bb.687:                              # %invoke.cont244
	ld.d	$a0, $s3, 0
	ld.d	$a0, $a0, -24
	add.d	$a0, $s3, $a0
	ld.d	$s0, $a0, 240
	beqz	$s0, .LBB4_760
# %bb.688:                              # %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i2705
	ld.bu	$a0, $s0, 56
	beqz	$a0, .LBB4_690
# %bb.689:                              # %if.then.i2.i.i2708
	ld.bu	$a0, $s0, 67
	b	.LBB4_692
.LBB4_690:                              # %if.end.i.i.i2713
.Ltmp196:                               # EH_LABEL
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_ZNKSt5ctypeIcE13_M_widen_initEv)
	jirl	$ra, $ra, 0
...
.Ltmp198:                               # EH_LABEL
	...
	jirl	$ra, $a2, 0
.Ltmp199:                               # EH_LABEL
.LBB4_692:                              # %_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i2710
.Ltmp200:                               # EH_LABEL
	ext.w.b	$a1, $a0
	move	$a0, $s3
	pcaddu18i	$ra, %call36(_ZNSo3putEc)
	jirl	$ra, $ra, 0
.Ltmp201:                               # EH_LABEL
# %bb.693:                              # %call1.i.noexc2721
.Ltmp202:                               # EH_LABEL
	pcaddu18i	$ra, %call36(_ZNSo5flushEv)
	jirl	$ra, $ra, 0
.Ltmp203:                               # EH_LABEL
# %bb.694:                              # %invoke.cont246
.Ltmp204:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp205:                               # EH_LABEL
# %bb.695:                              # %invoke.cont249
	ld.d	$a0, $s3, 0
	ld.d	$a0, $a0, -24
	add.d	$a0, $s3, $a0
	ld.d	$s0, $a0, 240
	beqz	$s0, .LBB4_760
# %bb.696:                              # %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i2731
	ld.bu	$a0, $s0, 56
	beqz	$a0, .LBB4_698
# %bb.697:                              # %if.then.i2.i.i2734
	ld.bu	$a0, $s0, 67
	b	.LBB4_700
.LBB4_698:                              # %if.end.i.i.i2739
.Ltmp206:                               # EH_LABEL
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_ZNKSt5ctypeIcE13_M_widen_initEv)
	jirl	$ra, $ra, 0
...
.Ltmp208:                               # EH_LABEL
	...
	jirl	$ra, $a2, 0
.Ltmp209:                               # EH_LABEL
.LBB4_700:                              # %_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i2736
.Ltmp210:                               # EH_LABEL
	ext.w.b	$a1, $a0
	move	$a0, $s3
	pcaddu18i	$ra, %call36(_ZNSo3putEc)
	jirl	$ra, $ra, 0
.Ltmp211:                               # EH_LABEL
# %bb.701:                              # %call1.i.noexc2747
.Ltmp212:                               # EH_LABEL
	pcaddu18i	$ra, %call36(_ZNSo5flushEv)
	jirl	$ra, $ra, 0
.Ltmp213:                               # EH_LABEL
	b	.LBB4_128
.LBB4_702:                              # %cond.false.i.i.i.i1212
	srai.d	$a2, $a3, 2
	ld.d	$s2, $sp, 72                    # 8-byte Folded Reload
	ld.d	$s0, $sp, 64                    # 8-byte Folded Reload
	b	.LBB4_704
.LBB4_703:                              # %cond.true.i.i.i.i1223
	srli.d	$a2, $a3, 2
.LBB4_704:                              # %cond.end.i.i.i.i1214
	slli.d	$a3, $a2, 3
	ldx.d	$a0, $a0, $a3
	slli.d	$a2, $a2, 2
	sub.d	$a1, $a1, $a2
	...
	slli.d	$a1, $a1, 7
	add.d	$a0, $a0, $a1
.LBB4_705:                              # %_ZNSt5dequeIN2PP4WordESaIS1_EEixEm.exit1227
.Ltmp298:                               # EH_LABEL
	move	$a1, $s0
	move	$a2, $s2
...
.Ltmp300:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp301:                               # EH_LABEL
# %bb.707:                              # %invoke.cont470
	ld.d	$a0, $s3, 0
	ld.d	$a0, $a0, -24
	add.d	$a0, $s3, $a0
	ld.d	$s0, $a0, 240
	beqz	$s0, .LBB4_764
# %bb.708:                              # %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i2757
	ld.bu	$a0, $s0, 56
	beqz	$a0, .LBB4_710
# %bb.709:                              # %if.then.i2.i.i2760
	ld.bu	$a0, $s0, 67
	b	.LBB4_712
.LBB4_710:                              # %if.end.i.i.i2765
.Ltmp302:                               # EH_LABEL
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_ZNKSt5ctypeIcE13_M_widen_initEv)
	jirl	$ra, $ra, 0
...
.Ltmp304:                               # EH_LABEL
	...
	jirl	$ra, $a2, 0
.Ltmp305:                               # EH_LABEL
.LBB4_712:                              # %_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i2762
.Ltmp306:                               # EH_LABEL
	ext.w.b	$a1, $a0
	move	$a0, $s3
	pcaddu18i	$ra, %call36(_ZNSo3putEc)
	jirl	$ra, $ra, 0
.Ltmp307:                               # EH_LABEL
# %bb.713:                              # %call1.i.noexc2773
.Ltmp308:                               # EH_LABEL
	pcaddu18i	$ra, %call36(_ZNSo5flushEv)
	jirl	$ra, $ra, 0
.Ltmp309:                               # EH_LABEL
# %bb.714:                              # %invoke.cont472
.Ltmp310:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp311:                               # EH_LABEL
# %bb.715:                              # %invoke.cont475
	ld.d	$a0, $s3, 0
	ld.d	$a0, $a0, -24
	add.d	$a0, $s3, $a0
	ld.d	$s0, $a0, 240
	beqz	$s0, .LBB4_764
# %bb.716:                              # %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i2783
	ld.bu	$a0, $s0, 56
	beqz	$a0, .LBB4_718
# %bb.717:                              # %if.then.i2.i.i2786
	ld.bu	$a0, $s0, 67
	b	.LBB4_720
.LBB4_718:                              # %if.end.i.i.i2791
.Ltmp312:                               # EH_LABEL
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_ZNKSt5ctypeIcE13_M_widen_initEv)
	jirl	$ra, $ra, 0
...
.Ltmp314:                               # EH_LABEL
	...
	jirl	$ra, $a2, 0
.Ltmp315:                               # EH_LABEL
.LBB4_720:                              # %_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i2788
.Ltmp316:                               # EH_LABEL
	ext.w.b	$a1, $a0
	move	$a0, $s3
	pcaddu18i	$ra, %call36(_ZNSo3putEc)
	jirl	$ra, $ra, 0
.Ltmp317:                               # EH_LABEL
# %bb.721:                              # %call1.i.noexc2799
.Ltmp318:                               # EH_LABEL
	pcaddu18i	$ra, %call36(_ZNSo5flushEv)
	jirl	$ra, $ra, 0
.Ltmp319:                               # EH_LABEL
# %bb.722:                              # %invoke.cont477
.Ltmp320:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp321:                               # EH_LABEL
# %bb.723:                              # %invoke.cont480
	ld.d	$a0, $s3, 0
	ld.d	$a0, $a0, -24
	add.d	$a0, $s3, $a0
	ld.d	$s0, $a0, 240
	beqz	$s0, .LBB4_764
# %bb.724:                              # %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i2809
	ld.bu	$a0, $s0, 56
	beqz	$a0, .LBB4_726
# %bb.725:                              # %if.then.i2.i.i2812
	ld.bu	$a0, $s0, 67
	b	.LBB4_728
.LBB4_726:                              # %if.end.i.i.i2817
.Ltmp322:                               # EH_LABEL
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_ZNKSt5ctypeIcE13_M_widen_initEv)
	jirl	$ra, $ra, 0
...
.Ltmp324:                               # EH_LABEL
	...
	jirl	$ra, $a2, 0
.Ltmp325:                               # EH_LABEL
.LBB4_728:                              # %_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i2814
.Ltmp326:                               # EH_LABEL
	ext.w.b	$a1, $a0
	move	$a0, $s3
	pcaddu18i	$ra, %call36(_ZNSo3putEc)
	jirl	$ra, $ra, 0
.Ltmp327:                               # EH_LABEL
# %bb.729:                              # %call1.i.noexc2825
.Ltmp328:                               # EH_LABEL
	pcaddu18i	$ra, %call36(_ZNSo5flushEv)
	jirl	$ra, $ra, 0
.Ltmp329:                               # EH_LABEL
# %bb.730:                              # %invoke.cont482
.Ltmp330:                               # EH_LABEL
...
# %bb.731:                              # %invoke.cont485
	...
	add.d	$a3, $a1, $s1
	bltz	$a3, .LBB4_734
# %bb.732:                              # %land.lhs.true.i.i.i.i1264
	ori	$a4, $zero, 3
	bltu	$a4, $a3, .LBB4_735
# %bb.733:                              # %if.then.i.i.i.i1268
	add.d	$a0, $a2, $s4
	addi.d	$a0, $a0, -128
	b	.LBB4_737
.LBB4_734:                              # %cond.false.i.i.i.i1255
	srai.d	$a2, $a3, 2
	b	.LBB4_736
.LBB4_735:                              # %cond.true.i.i.i.i1266
	srli.d	$a2, $a3, 2
.LBB4_736:                              # %cond.end.i.i.i.i1257
	slli.d	$a3, $a2, 3
	ldx.d	$a0, $a0, $a3
	slli.d	$a2, $a2, 2
	sub.d	$a1, $a1, $a2
	...
	slli.d	$a1, $a1, 7
	add.d	$a0, $a0, $a1
.LBB4_737:                              # %_ZNSt5dequeIN2PP4WordESaIS1_EEixEm.exit1270
	addi.d	$s1, $sp, 192
	st.d	$s1, $sp, 176
	ld.d	$a1, $a0, 8
	ld.d	$s0, $a0, 0
...
.Ltmp332:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp333:                               # EH_LABEL
# %bb.739:                              # %call.i4.i.i.noexc1281
	ld.d	$a1, $sp, 240
	st.d	$a0, $sp, 176
	st.d	$a1, $sp, 192
.LBB4_740:                              # %if.end.i.i.i1275
	beq	$a1, $s8, .LBB4_744
# %bb.741:                              # %if.end.i.i.i1275
	bnez	$a1, .LBB4_743
# %bb.742:                              # %if.then.i.i.i.i1277
	ld.b	$a1, $s0, 0
	st.b	$a1, $a0, 0
	b	.LBB4_744
.LBB4_743:                              # %if.end.i.i.i.i.i1278
	addi.d	$a2, $a1, 1
	move	$a1, $s0
	pcaddu18i	$ra, %call36(memcpy)
	jirl	$ra, $ra, 0
.LBB4_744:                              # %invoke.cont492
	ld.d	$a2, $sp, 240
	ld.d	$a1, $sp, 176
	st.d	$a2, $sp, 184
.Ltmp335:                               # EH_LABEL
...
# %bb.745:                              # %invoke.cont494
	...
	ld.d	$s3, $a0, 240
	beqz	$s3, .LBB4_766
# %bb.746:                              # %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i2835
	ld.bu	$a0, $s3, 56
	beqz	$a0, .LBB4_748
# %bb.747:                              # %if.then.i2.i.i2838
	ld.bu	$a0, $s3, 67
	b	.LBB4_750
.LBB4_748:                              # %if.end.i.i.i2843
.Ltmp337:                               # EH_LABEL
	move	$a0, $s3
	pcaddu18i	$ra, %call36(_ZNKSt5ctypeIcE13_M_widen_initEv)
	jirl	$ra, $ra, 0
...
.Ltmp339:                               # EH_LABEL
	...
	jirl	$ra, $a2, 0
.Ltmp340:                               # EH_LABEL
.LBB4_750:                              # %_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i2840
.Ltmp341:                               # EH_LABEL
	ext.w.b	$a1, $a0
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_ZNSo3putEc)
	jirl	$ra, $ra, 0
.Ltmp342:                               # EH_LABEL
# %bb.751:                              # %call1.i.noexc2851
.Ltmp343:                               # EH_LABEL
	pcaddu18i	$ra, %call36(_ZNSo5flushEv)
	jirl	$ra, $ra, 0
.Ltmp344:                               # EH_LABEL
# %bb.752:                              # %invoke.cont496
	ld.d	$a0, $sp, 176
	beq	$a0, $s1, .LBB4_128
# %bb.753:                              # %if.then.i.i1291
	ld.d	$a1, $sp, 192
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
...
.LBB4_813:                              # %lpad13
.Ltmp559:                               # EH_LABEL
.LBB4_814:                              # %ehcleanup659
	move	$s0, $a0
.LBB4_815:                              # %ehcleanup659
	addi.d	$a0, $fp, 480
	pcaddu18i	$ra, %call36(_ZNSt5dequeIN2PP3CmdESaIS1_EED2Ev)
	jirl	$ra, $ra, 0
.LBB4_816:                              # %ehcleanup661
	addi.d	$a0, $fp, 400
	pcaddu18i	$ra, %call36(_ZNSt5dequeIbSaIbEED2Ev)
	jirl	$ra, $ra, 0
.LBB4_817:                              # %ehcleanup662
	addi.d	$a0, $fp, 320
	pcaddu18i	$ra, %call36(_ZNSt5dequeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EED2Ev)
	jirl	$ra, $ra, 0
.LBB4_818:                              # %ehcleanup663
	addi.d	$a0, $fp, 240
	pcaddu18i	$ra, %call36(_ZNSt5dequeIN2PP4WordESaIS1_EED2Ev)
	jirl	$ra, $ra, 0
.LBB4_819:                              # %ehcleanup664
	addi.d	$a0, $fp, 160
	pcaddu18i	$ra, %call36(_ZNSt5dequeIN2PP4WordESaIS1_EED2Ev)
	jirl	$ra, $ra, 0
.LBB4_820:                              # %ehcleanup665
	addi.d	$a0, $fp, 80
	pcaddu18i	$ra, %call36(_ZNSt5dequeIN2PP4WordESaIS1_EED2Ev)
	jirl	$ra, $ra, 0
	move	$a0, $fp
...
# %bb.15:                               # %if.then.i.i.i.i226
	...
	b	.LBB11_19
	.p2align	4, , 16
.LBB11_16:                              # %cond.false.i.i.i.i213
                                        #   in Loop: Header=BB11_5 Depth=1
	srai.d	$a2, $a3, 2
	b	.LBB11_18
	.p2align	4, , 16
.LBB11_17:                              # %cond.true.i.i.i.i224
                                        #   in Loop: Header=BB11_5 Depth=1
	srli.d	$a2, $a3, 2
.LBB11_18:                              # %cond.end.i.i.i.i215
                                        #   in Loop: Header=BB11_5 Depth=1
	slli.d	$a3, $a2, 3
	ldx.d	$a0, $a0, $a3
	slli.d	$a2, $a2, 2
	...
	slli.d	$a1, $a1, 7
	add.d	$a0, $a1, $a0
.LBB11_19:                              # %_ZNSt5dequeIN2PP4WordESaIS1_EEixEm.exit228
                                        #   in Loop: Header=BB11_5 Depth=1
	addi.d	$a1, $a0, 128
	ld.d	$a2, $sp, 392
	ld.d	$a0, $sp, 376
...
.LBB11_23:                              # %invoke.cont52
	...
	addi.d	$a3, $a3, 1
	bltz	$a3, .LBB11_26
# %bb.24:                               # %land.lhs.true.i.i.i.i257
                                        #   in Loop: Header=BB11_5 Depth=1
	bltu	$s0, $a3, .LBB11_27
# %bb.25:                               # %if.then.i.i.i.i261
                                        #   in Loop: Header=BB11_5 Depth=1
	add.d	$a0, $a2, $s2
	b	.LBB11_29
	.p2align	4, , 16
...
.LBB11_28:                              # %cond.end.i.i.i.i250
	...
	slli.d	$a1, $a1, 7
	add.d	$a0, $a1, $a0
.LBB11_29:                              # %_ZNSt5dequeIN2PP4WordESaIS1_EEixEm.exit263
                                        #   in Loop: Header=BB11_5 Depth=1
	addi.d	$a1, $a0, 128
	ld.d	$a2, $sp, 392
	ld.d	$a0, $sp, 376
...
.LBB11_33:                              # %invoke.cont55
	...
	addi.d	$a3, $a3, 1
	bltz	$a3, .LBB11_36
# %bb.34:                               # %land.lhs.true.i.i.i.i292
                                        #   in Loop: Header=BB11_5 Depth=1
	bltu	$s0, $a3, .LBB11_37
# %bb.35:                               # %if.then.i.i.i.i296
                                        #   in Loop: Header=BB11_5 Depth=1
	add.d	$a0, $a2, $s2
	b	.LBB11_39
	.p2align	4, , 16
.LBB11_36:                              # %cond.false.i.i.i.i283
                                        #   in Loop: Header=BB11_5 Depth=1
	srai.d	$a2, $a3, 2
	b	.LBB11_38
	.p2align	4, , 16
.LBB11_37:                              # %cond.true.i.i.i.i294
                                        #   in Loop: Header=BB11_5 Depth=1
	srli.d	$a2, $a3, 2
.LBB11_38:                              # %cond.end.i.i.i.i285
                                        #   in Loop: Header=BB11_5 Depth=1
	slli.d	$a3, $a2, 3
	ldx.d	$a0, $a0, $a3
	slli.d	$a2, $a2, 2
	...
	slli.d	$a1, $a1, 7
	add.d	$a0, $a1, $a0
.LBB11_39:                              # %_ZNSt5dequeIN2PP4WordESaIS1_EEixEm.exit298
                                        #   in Loop: Header=BB11_5 Depth=1
	addi.d	$a1, $a0, 128
	ld.d	$a2, $sp, 392
	ld.d	$a0, $sp, 376
...
# %bb.44:                               # %invoke.cont59
	...
	addi.d	$a3, $a3, 1
	bltz	$a3, .LBB11_47
# %bb.45:                               # %land.lhs.true.i.i.i.i326
                                        #   in Loop: Header=BB11_5 Depth=1
	ori	$a4, $zero, 511
	bltu	$a4, $a3, .LBB11_48
# %bb.46:                               # %if.then.i.i.i.i330
                                        #   in Loop: Header=BB11_5 Depth=1
	add.d	$a0, $a2, $s4
	ld.bu	$a0, $a0, 0
	bnez	$a0, .LBB11_50
	b	.LBB11_116
	.p2align	4, , 16
.LBB11_47:                              # %cond.false.i.i.i.i317
                                        #   in Loop: Header=BB11_5 Depth=1
	srai.d	$a2, $a3, 9
	b	.LBB11_49
	.p2align	4, , 16
.LBB11_48:                              # %cond.true.i.i.i.i328
                                        #   in Loop: Header=BB11_5 Depth=1
	srli.d	$a2, $a3, 9
.LBB11_49:                              # %cond.end.i.i.i.i319
                                        #   in Loop: Header=BB11_5 Depth=1
	slli.d	$a3, $a2, 3
	ldx.d	$a1, $a1, $a3
	slli.d	$a2, $a2, 9
...
.LBB11_50:                              # %if.then63
	...
	srai.d	$a2, $a3, 7
	bltz	$a3, .LBB11_56
# %bb.51:                               # %land.lhs.true.i.i.i.i350
                                        #   in Loop: Header=BB11_5 Depth=1
	ori	$a3, $zero, 4
	bltu	$a2, $a3, .LBB11_58
# %bb.52:                               # %cond.true.i.i.i.i352
                                        #   in Loop: Header=BB11_5 Depth=1
	srli.d	$a0, $a2, 2
	b	.LBB11_57
.LBB11_53:                              # %if.then7
	...
	addi.d	$a2, $a2, 1
	bltz	$a2, .LBB11_64
# %bb.54:                               # %land.lhs.true.i.i.i.i65
                                        #   in Loop: Header=BB11_5 Depth=1
	bltu	$s0, $a2, .LBB11_65
# %bb.55:                               # %if.then.i.i.i.i118
                                        #   in Loop: Header=BB11_5 Depth=1
	add.d	$a0, $a3, $s2
	ld.w	$s7, $a0, 208
	ld.w	$s6, $a0, 212
	b	.LBB11_67
.LBB11_56:                              # %cond.false.i.i.i.i341
                                        #   in Loop: Header=BB11_5 Depth=1
	srai.d	$a0, $a3, 9
.LBB11_57:                              # %cond.end.i.i.i.i343
                                        #   in Loop: Header=BB11_5 Depth=1
	slli.d	$a3, $a0, 3
	ldx.d	$a1, $a1, $a3
	slli.d	$a0, $a0, 2
	...
	slli.d	$a0, $a0, 7
	add.d	$a0, $a1, $a0
.LBB11_58:                              # %_ZNSt5dequeIN2PP4WordESaIS1_EEixEm.exit356
                                        #   in Loop: Header=BB11_5 Depth=1
.Ltmp605:                               # EH_LABEL
...
# %bb.61:                               # %if.then69
	...
	add.d	$a3, $s1, $a1
	bltz	$a3, .LBB11_98
# %bb.62:                               # %land.lhs.true.i.i.i.i375
                                        #   in Loop: Header=BB11_5 Depth=1
	bltu	$s0, $a3, .LBB11_99
# %bb.63:                               # %if.then.i.i.i.i379
                                        #   in Loop: Header=BB11_5 Depth=1
	add.d	$a0, $a2, $s2
	b	.LBB11_101
.LBB11_64:                              # %cond.false.i.i.i.i105
                                        #   in Loop: Header=BB11_5 Depth=1
	srai.d	$a3, $a2, 2
	b	.LBB11_66
.LBB11_65:                              # %cond.true.i.i.i.i116
                                        #   in Loop: Header=BB11_5 Depth=1
	srli.d	$a3, $a2, 2
.LBB11_66:                              # %cond.end.i.i.i.i107
                                        #   in Loop: Header=BB11_5 Depth=1
	slli.d	$a4, $a3, 3
	ldx.d	$a1, $a1, $a4
	andi	$a2, $a2, 3
	...
	slli.d	$a0, $a0, 7
	add.d	$a0, $a0, $a1
.LBB11_67:                              # %_ZNSt5dequeIN2PP4WordESaIS1_EEixEm.exit120
                                        #   in Loop: Header=BB11_5 Depth=1
	addi.d	$a0, $a0, 128
	ld.d	$a1, $a0, 96
	ld.d	$s8, $a0, 88
...
.Ltmp613:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp614:                               # EH_LABEL
# %bb.69:                               # %call.i4.i.i.noexc
                                        #   in Loop: Header=BB11_5 Depth=1
	ld.d	$a1, $sp, 168
	st.d	$a0, $sp, 296
	st.d	$a1, $sp, 312
.LBB11_70:                              # %if.end.i.i.i
                                        #   in Loop: Header=BB11_5 Depth=1
...
# %bb.71:                               # %if.end.i.i.i
                                        #   in Loop: Header=BB11_5 Depth=1
	bnez	$a1, .LBB11_73
# %bb.72:                               # %if.then.i.i.i.i122
                                        #   in Loop: Header=BB11_5 Depth=1
	ld.b	$a1, $s8, 0
	st.b	$a1, $a0, 0
	b	.LBB11_74
.LBB11_73:                              # %if.end.i.i.i.i.i
                                        #   in Loop: Header=BB11_5 Depth=1
	addi.d	$a2, $a1, 1
	move	$a1, $s8
	pcaddu18i	$ra, %call36(memcpy)
	jirl	$ra, $ra, 0
.LBB11_74:                              # %invoke.cont24
                                        #   in Loop: Header=BB11_5 Depth=1
	ld.d	$a3, $fp, 16
	ld.d	$a2, $fp, 24
	ld.d	$a1, $sp, 168
	...
	st.d	$a1, $sp, 304
	bltz	$a4, .LBB11_77
# %bb.75:                               # %land.lhs.true.i.i.i.i142
                                        #   in Loop: Header=BB11_5 Depth=1
	bltu	$s0, $a4, .LBB11_78
# %bb.76:                               # %if.then.i.i.i.i146
                                        #   in Loop: Header=BB11_5 Depth=1
	add.d	$a0, $a3, $s2
	b	.LBB11_80
.LBB11_77:                              # %cond.false.i.i.i.i133
                                        #   in Loop: Header=BB11_5 Depth=1
	srai.d	$a3, $a4, 2
	b	.LBB11_79
.LBB11_78:                              # %cond.true.i.i.i.i144
                                        #   in Loop: Header=BB11_5 Depth=1
	srli.d	$a3, $a4, 2
.LBB11_79:                              # %cond.end.i.i.i.i135
                                        #   in Loop: Header=BB11_5 Depth=1
	slli.d	$a4, $a3, 3
	ldx.d	$a0, $a0, $a4
	slli.d	$a3, $a3, 2
	...
	slli.d	$a2, $a2, 7
	add.d	$a0, $a2, $a0
.LBB11_80:                              # %_ZNSt5dequeIN2PP4WordESaIS1_EEixEm.exit148
                                        #   in Loop: Header=BB11_5 Depth=1
	addi.d	$a0, $a0, 128
	ld.d	$s8, $a0, 120
	addi.d	$a0, $sp, 152
...
.Ltmp616:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp617:                               # EH_LABEL
# %bb.82:                               # %call.i4.i.noexc
                                        #   in Loop: Header=BB11_5 Depth=1
	ld.d	$a1, $sp, 496
	st.d	$a0, $sp, 104
	st.d	$a1, $sp, 120
.LBB11_83:                              # %if.end.i.i158
                                        #   in Loop: Header=BB11_5 Depth=1
	beq	$a1, $s6, .LBB11_87
# %bb.84:                               # %if.end.i.i158
                                        #   in Loop: Header=BB11_5 Depth=1
	bnez	$a1, .LBB11_86
# %bb.85:                               # %if.then.i.i.i159
                                        #   in Loop: Header=BB11_5 Depth=1
	ld.b	$a1, $s0, 0
	st.b	$a1, $a0, 0
	b	.LBB11_87
.LBB11_86:                              # %if.end.i.i.i.i
                                        #   in Loop: Header=BB11_5 Depth=1
	addi.d	$a2, $a1, 1
	move	$a1, $s0
	pcaddu18i	$ra, %call36(memcpy)
	jirl	$ra, $ra, 0
.LBB11_87:                              # %invoke.cont35
                                        #   in Loop: Header=BB11_5 Depth=1
	ld.d	$a0, $sp, 496
	st.d	$a0, $sp, 112
.Ltmp619:                               # EH_LABEL
...
# %bb.88:                               # %invoke.cont37
	...
	ori	$s0, $zero, 3
	beq	$a0, $a1, .LBB11_90
# %bb.89:                               # %if.then.i.i164
                                        #   in Loop: Header=BB11_5 Depth=1
	ld.d	$a1, $sp, 120
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB11_90:                              # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit
                                        #   in Loop: Header=BB11_5 Depth=1
	ld.d	$a0, $sp, 136
	addi.d	$a1, $sp, 152
	beq	$a0, $a1, .LBB11_92
# %bb.91:                               # %if.then.i.i168
                                        #   in Loop: Header=BB11_5 Depth=1
	ld.d	$a1, $sp, 152
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB11_92:                              # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit173
                                        #   in Loop: Header=BB11_5 Depth=1
	ld.d	$a1, $sp, 392
	ld.d	$a0, $sp, 376
	addi.d	$a1, $a1, -128
...
# %bb.97:                               # %if.then.i.i177
	...
	jirl	$ra, $ra, 0
	b	.LBB11_116
.LBB11_98:                              # %cond.false.i.i.i.i366
                                        #   in Loop: Header=BB11_5 Depth=1
	srai.d	$a2, $a3, 2
	b	.LBB11_100
.LBB11_99:                              # %cond.true.i.i.i.i377
                                        #   in Loop: Header=BB11_5 Depth=1
	srli.d	$a2, $a3, 2
.LBB11_100:                             # %cond.end.i.i.i.i368
                                        #   in Loop: Header=BB11_5 Depth=1
	slli.d	$a3, $a2, 3
	ldx.d	$a0, $a0, $a3
	slli.d	$a2, $a2, 2
	...
	slli.d	$a1, $a1, 7
	add.d	$a0, $a0, $a1
.LBB11_101:                             # %_ZNSt5dequeIN2PP4WordESaIS1_EEixEm.exit381
                                        #   in Loop: Header=BB11_5 Depth=1
	addi.d	$a2, $sp, 184
	st.d	$a2, $sp, 168
	ld.d	$a1, $a0, 8
	...
	move	$a0, $a2
	ori	$a2, $zero, 16
	bltu	$a1, $a2, .LBB11_104
# %bb.102:                              # %if.then.i.i.i391
                                        #   in Loop: Header=BB11_5 Depth=1
.Ltmp607:                               # EH_LABEL
	addi.d	$a0, $sp, 168
	addi.d	$a1, $sp, 296
	...
	jirl	$ra, $ra, 0
.Ltmp608:                               # EH_LABEL
# %bb.103:                              # %call.i4.i.i.noexc392
                                        #   in Loop: Header=BB11_5 Depth=1
	ld.d	$a1, $sp, 296
	st.d	$a0, $sp, 168
	st.d	$a1, $sp, 184
.LBB11_104:                             # %if.end.i.i.i386
                                        #   in Loop: Header=BB11_5 Depth=1
	beq	$a1, $s6, .LBB11_108
# %bb.105:                              # %if.end.i.i.i386
                                        #   in Loop: Header=BB11_5 Depth=1
	bnez	$a1, .LBB11_107
# %bb.106:                              # %if.then.i.i.i.i388
                                        #   in Loop: Header=BB11_5 Depth=1
	ld.b	$a1, $s0, 0
	st.b	$a1, $a0, 0
	b	.LBB11_108
.LBB11_107:                             # %if.end.i.i.i.i.i389
                                        #   in Loop: Header=BB11_5 Depth=1
	addi.d	$a2, $a1, 1
	move	$a1, $s0
	pcaddu18i	$ra, %call36(memcpy)
	jirl	$ra, $ra, 0
.LBB11_108:                             # %invoke.cont74
                                        #   in Loop: Header=BB11_5 Depth=1
	ld.d	$a1, $sp, 296
	ld.d	$a0, $sp, 168
	st.d	$a1, $sp, 176
...
# %bb.109:                              # %if.end.i.i400
	...
	xori	$a2, $s5, 1
	or	$s0, $a1, $a2
.LBB11_110:                             # %invoke.cont76
                                        #   in Loop: Header=BB11_5 Depth=1
	addi.d	$a1, $sp, 184
	beq	$a0, $a1, .LBB11_112
# %bb.111:                              # %if.then.i.i404
                                        #   in Loop: Header=BB11_5 Depth=1
	ld.d	$a1, $sp, 184
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB11_112:                             # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit409
                                        #   in Loop: Header=BB11_5 Depth=1
	andi	$a0, $s0, 1
	ori	$s0, $zero, 3
	beqz	$a0, .LBB11_116
.LBB11_113:                             # %if.then85
	...
	addi.d	$a3, $a3, 1
	bltz	$a3, .LBB11_153
# %bb.114:                              # %land.lhs.true.i.i.i.i435
                                        #   in Loop: Header=BB11_5 Depth=1
	ori	$a4, $zero, 15
	bltu	$a4, $a3, .LBB11_154
# %bb.115:                              # %if.then.i.i.i.i439
                                        #   in Loop: Header=BB11_5 Depth=1
	add.d	$a0, $a2, $s3
	b	.LBB11_156
	.p2align	4, , 16
.LBB11_116:                             # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit182
                                        #   in Loop: Header=BB11_5 Depth=1
	move	$s6, $s5
.LBB11_117:                             # %if.end97
                                        #   in Loop: Header=BB11_5 Depth=1
	...
	srai.d	$a2, $a3, 7
	bltz	$a3, .LBB11_120
# %bb.118:                              # %land.lhs.true.i.i.i.i463
                                        #   in Loop: Header=BB11_5 Depth=1
	ori	$a3, $zero, 4
	bltu	$a2, $a3, .LBB11_122
# %bb.119:                              # %cond.true.i.i.i.i465
                                        #   in Loop: Header=BB11_5 Depth=1
	srli.d	$a1, $a2, 2
	b	.LBB11_121
	.p2align	4, , 16
.LBB11_120:                             # %cond.false.i.i.i.i454
                                        #   in Loop: Header=BB11_5 Depth=1
	srai.d	$a1, $a3, 9
.LBB11_121:                             # %cond.end.i.i.i.i456
                                        #   in Loop: Header=BB11_5 Depth=1
	slli.d	$a3, $a1, 3
	ldx.d	$a0, $a0, $a3
	slli.d	$a1, $a1, 2
	...
	slli.d	$a1, $a1, 7
	add.d	$a1, $a0, $a1
.LBB11_122:                             # %_ZNSt5dequeIN2PP4WordESaIS1_EEixEm.exit469
                                        #   in Loop: Header=BB11_5 Depth=1
	ld.d	$a2, $sp, 472
	ld.d	$a0, $sp, 456
	addi.d	$a2, $a2, -128
...
.LBB11_126:                             # %invoke.cont99
	...
	addi.d	$a3, $a3, 1
	bltz	$a3, .LBB11_129
# %bb.127:                              # %land.lhs.true.i.i.i.i498
                                        #   in Loop: Header=BB11_5 Depth=1
	bltu	$s0, $a3, .LBB11_130
# %bb.128:                              # %if.then.i.i.i.i502
                                        #   in Loop: Header=BB11_5 Depth=1
	add.d	$a0, $a2, $s2
	b	.LBB11_132
	.p2align	4, , 16
.LBB11_129:                             # %cond.false.i.i.i.i489
                                        #   in Loop: Header=BB11_5 Depth=1
	srai.d	$a2, $a3, 2
	b	.LBB11_131
	.p2align	4, , 16
.LBB11_130:                             # %cond.true.i.i.i.i500
                                        #   in Loop: Header=BB11_5 Depth=1
	srli.d	$a2, $a3, 2
.LBB11_131:                             # %cond.end.i.i.i.i491
                                        #   in Loop: Header=BB11_5 Depth=1
	slli.d	$a3, $a2, 3
	ldx.d	$a0, $a0, $a3
	slli.d	$a2, $a2, 2
	...
	slli.d	$a1, $a1, 7
	add.d	$a0, $a1, $a0
.LBB11_132:                             # %_ZNSt5dequeIN2PP4WordESaIS1_EEixEm.exit504
                                        #   in Loop: Header=BB11_5 Depth=1
	addi.d	$a0, $a0, 128
	addi.d	$a2, $sp, 184
	st.d	$a2, $sp, 168
	...
	move	$a0, $a2
	ori	$a2, $zero, 16
	bltu	$a1, $a2, .LBB11_135
# %bb.133:                              # %if.then.i.i.i514
                                        #   in Loop: Header=BB11_5 Depth=1
.Ltmp631:                               # EH_LABEL
	addi.d	$a0, $sp, 168
	addi.d	$a1, $sp, 296
	...
	jirl	$ra, $ra, 0
.Ltmp632:                               # EH_LABEL
# %bb.134:                              # %call.i4.i.i.noexc515
                                        #   in Loop: Header=BB11_5 Depth=1
	ld.d	$a1, $sp, 296
	st.d	$a0, $sp, 168
	st.d	$a1, $sp, 184
.LBB11_135:                             # %if.end.i.i.i509
                                        #   in Loop: Header=BB11_5 Depth=1
	addi.w	$s7, $zero, -1
	beq	$a1, $s7, .LBB11_139
# %bb.136:                              # %if.end.i.i.i509
                                        #   in Loop: Header=BB11_5 Depth=1
	bnez	$a1, .LBB11_138
# %bb.137:                              # %if.then.i.i.i.i511
                                        #   in Loop: Header=BB11_5 Depth=1
	ld.b	$a1, $s0, 0
	st.b	$a1, $a0, 0
	b	.LBB11_139
	.p2align	4, , 16
.LBB11_138:                             # %if.end.i.i.i.i.i512
                                        #   in Loop: Header=BB11_5 Depth=1
	addi.d	$a2, $a1, 1
	move	$a1, $s0
	pcaddu18i	$ra, %call36(memcpy)
	jirl	$ra, $ra, 0
.LBB11_139:                             # %invoke.cont105
                                        #   in Loop: Header=BB11_5 Depth=1
	ld.d	$a1, $sp, 296
	ld.d	$a0, $sp, 168
	st.d	$a1, $sp, 176
...
# %bb.140:                              # %if.end.i.i524
	...
	b	.LBB11_143
	.p2align	4, , 16
.LBB11_141:                             #   in Loop: Header=BB11_5 Depth=1
	move	$s0, $zero
	addi.d	$a1, $sp, 184
	beq	$a0, $a1, .LBB11_143
.LBB11_142:                             # %if.then.i.i528
                                        #   in Loop: Header=BB11_5 Depth=1
	ld.d	$a1, $sp, 184
	addi.d	$a1, $a1, 1
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB11_143:                             # %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit533
                                        #   in Loop: Header=BB11_5 Depth=1
	bnez	$s0, .LBB11_157
# %bb.144:                              # %if.else112
                                        #   in Loop: Header=BB11_5 Depth=1
	...
	addi.d	$a3, $a3, 1
	bltz	$a3, .LBB11_147
# %bb.145:                              # %land.lhs.true.i.i.i.i559
                                        #   in Loop: Header=BB11_5 Depth=1
	ori	$s0, $zero, 3
	bltu	$s0, $a3, .LBB11_148
# %bb.146:                              # %if.then.i.i.i.i563
                                        #   in Loop: Header=BB11_5 Depth=1
	add.d	$a0, $a2, $s2
	b	.LBB11_150
	.p2align	4, , 16
.LBB11_147:                             # %cond.false.i.i.i.i550
                                        #   in Loop: Header=BB11_5 Depth=1
	srai.d	$a2, $a3, 2
	ori	$s0, $zero, 3
	b	.LBB11_149
	.p2align	4, , 16
.LBB11_148:                             # %cond.true.i.i.i.i561
                                        #   in Loop: Header=BB11_5 Depth=1
	srli.d	$a2, $a3, 2
.LBB11_149:                             # %cond.end.i.i.i.i552
                                        #   in Loop: Header=BB11_5 Depth=1
	slli.d	$a3, $a2, 3
	ldx.d	$a0, $a0, $a3
	slli.d	$a2, $a2, 2
	...
	slli.d	$a1, $a1, 7
	add.d	$a0, $a1, $a0
.LBB11_150:                             # %_ZNSt5dequeIN2PP4WordESaIS1_EEixEm.exit565
                                        #   in Loop: Header=BB11_5 Depth=1
	addi.d	$a1, $a0, 128
	ld.d	$a2, $sp, 472
	ld.d	$a0, $sp, 456
...
# %bb.152:                              # %.noexc573
	...
	st.d	$a0, $sp, 456
	b	.LBB11_4
.LBB11_153:                             # %cond.false.i.i.i.i426
                                        #   in Loop: Header=BB11_5 Depth=1
	srai.d	$a2, $a3, 4
	b	.LBB11_155
.LBB11_154:                             # %cond.true.i.i.i.i437
                                        #   in Loop: Header=BB11_5 Depth=1
	srli.d	$a2, $a3, 4
.LBB11_155:                             # %cond.end.i.i.i.i428
                                        #   in Loop: Header=BB11_5 Depth=1
	slli.d	$a3, $a2, 3
	ldx.d	$a0, $a0, $a3
	slli.d	$a2, $a2, 4
	...
	add.d	$a0, $a1, $a0
	addi.d	$a0, $a0, 32
.LBB11_156:                             # %_ZNSt5dequeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EEixEm.exit441
                                        #   in Loop: Header=BB11_5 Depth=1
	ld.d	$a2, $a0, 8
.Ltmp610:                               # EH_LABEL
...
.Ltmp611:                               # EH_LABEL
	move	$s6, $s5
	b	.LBB11_117
.LBB11_157:                             # %cleanup121.critedge
	addi.d	$a0, $sp, 328
	pcaddu18i	$ra, %call36(_ZNSt5dequeIN2PP4WordESaIS1_EED2Ev)
	jirl	$ra, $ra, 0
.LBB11_158:                             # %cleanup121
.Ltmp639:                               # EH_LABEL
	addi.d	$a1, $sp, 408
	ld.d	$a2, $sp, 72                    # 8-byte Folded Reload
	ld.d	$a3, $sp, 80                    # 8-byte Folded Reload
...
# %bb.159:                              # %invoke.cont124
	...
	srai.d	$a2, $a3, 7
	bltz	$a3, .LBB11_162
# %bb.160:                              # %land.lhs.true.i.i.i.i594
	ori	$a3, $zero, 4
	bltu	$a2, $a3, .LBB11_164
# %bb.161:                              # %cond.true.i.i.i.i596
	srli.d	$a0, $a2, 2
	b	.LBB11_163
.LBB11_162:                             # %cond.false.i.i.i.i585
	srai.d	$a0, $a3, 9
.LBB11_163:                             # %cond.end.i.i.i.i587
	slli.d	$a3, $a0, 3
	ldx.d	$a1, $a1, $a3
	slli.d	$a0, $a0, 2
	sub.d	$a0, $a2, $a0
	slli.d	$a0, $a0, 7
	add.d	$a0, $a1, $a0
.LBB11_164:                             # %_ZNSt5dequeIN2PP4WordESaIS1_EEixEm.exit600
.Ltmp641:                               # EH_LABEL
	ld.d	$a1, $sp, 96                    # 8-byte Folded Reload
	move	$a2, $s8
	pcaddu18i	$ra, %call36(_ZN2PP4Word8get_boolERNSt7__cxx1118basic_stringstreamIcSt11char_traitsIcESaIcEEERi)
...
# %bb.167:                              # %if.then130
	st.b	$a0, $fp, 560
.LBB11_168:                             # %cleanup134
	addi.d	$a0, $sp, 408
	pcaddu18i	$ra, %call36(_ZNSt5dequeIN2PP4WordESaIS1_EED2Ev)
	jirl	$ra, $ra, 0
.LBB11_169:                             # %cleanup.cont144
...
# %bb.176:                              # %ehcleanup
	...
	addi.d	$a1, $sp, 152
	bne	$a0, $a1, .LBB11_179
.LBB11_177:                             # %ehcleanup43
	ld.d	$a0, $sp, 296
	addi.d	$a1, $sp, 312
	bne	$a0, $a1, .LBB11_180
	b	.LBB11_187
.LBB11_178:                             # %if.then.i.i184
	ld.d	$a0, $sp, 120
	addi.d	$a1, $a0, 1
	move	$a0, $a2
	pcaddu18i	$ra, %call36(_ZdlPvm)
...
.LBB11_185:                             # %lpad4
.Ltmp638:                               # EH_LABEL
.LBB11_186:                             # %ehcleanup118
	move	$fp, $a0
.LBB11_187:                             # %ehcleanup118
	addi.d	$a0, $sp, 328
	pcaddu18i	$ra, %call36(_ZNSt5dequeIN2PP4WordESaIS1_EED2Ev)
	jirl	$ra, $ra, 0
	addi.d	$a0, $sp, 408
...
.Lcst_begin6:
	...
	.byte	0                               #   On action: cleanup
	.uleb128 .Ltmp591-.Lfunc_begin6         # >> Call Site 5 <<
	.uleb128 .Ltmp606-.Ltmp591              #   Call between .Ltmp591 and .Ltmp606
	.uleb128 .Ltmp638-.Lfunc_begin6         #     jumps to .Ltmp638
	.byte	0                               #   On action: cleanup
...
.Lcst_begin7:
	...
	.byte	0                               #   On action: cleanup
	.uleb128 .Ltmp697-.Lfunc_begin7         # >> Call Site 22 <<
	.uleb128 .Ltmp708-.Ltmp697              #   Call between .Ltmp697 and .Ltmp708
	.byte	0                               #     has no landing pad
	.byte	0                               #   On action: cleanup
	.uleb128 .Ltmp708-.Lfunc_begin7         # >> Call Site 23 <<
	.uleb128 .Ltmp709-.Ltmp708              #   Call between .Ltmp708 and .Ltmp709
	.uleb128 .Ltmp714-.Lfunc_begin7         #     jumps to .Ltmp714
	.byte	0                               #   On action: cleanup
	.uleb128 .Ltmp709-.Lfunc_begin7         # >> Call Site 24 <<
