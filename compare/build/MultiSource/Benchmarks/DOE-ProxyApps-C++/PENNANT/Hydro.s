...
.LBB1_6:                                # %vector.body206
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB1_6
# %bb.7:                                # %middle.block211
                                        #   in Loop: Header=BB1_3 Depth=1
	beq	$a0, $a5, .LBB1_10
.LBB1_8:                                # %for.body.i.preheader217
                                        #   in Loop: Header=BB1_3 Depth=1
	alsl.d	$a5, $s7, $s2, 3
	.p2align	4, , 16
.LBB1_9:                                # %for.body.i
...
.LBB1_12:                               # %vector.body192
	...
	addi.d	$a1, $a1, 64
	bnez	$a5, .LBB1_12
# %bb.13:                               # %middle.block196
                                        #   in Loop: Header=BB1_3 Depth=1
	beq	$a0, $a4, .LBB1_16
.LBB1_14:                               # %for.body.i114.preheader216
                                        #   in Loop: Header=BB1_3 Depth=1
	alsl.d	$a0, $s7, $s3, 3
	.p2align	4, , 16
...
# %bb.31:                               # %middle.block
                                        #   in Loop: Header=BB1_3 Depth=1
	beq	$a1, $a2, .LBB1_2
.LBB1_32:                               # %for.body95.preheader215
                                        #   in Loop: Header=BB1_3 Depth=1
	alsl.d	$a1, $a0, $s2, 3
...
.Lfunc_end4:
	...
	.p2align	5, 0x0                          # -- Begin function _ZN5Hydro7doCycleEd
.LCPI5_0:
	.dword	1                               # 0x1
	.dword	3                               # 0x3
	.dword	0                               # 0x0
...
.LBB5_18:                               #   in Loop: Header=BB5_14 Depth=1
	move	$a1, $s6
.LBB5_19:                               # %for.body.i.preheader390
                                        #   in Loop: Header=BB5_14 Depth=1
	sub.d	$a2, $t1, $a1
	alsl.d	$a3, $a1, $a0, 3
...
.LBB5_44:                               #   in Loop: Header=BB5_38 Depth=1
	move	$t0, $s6
.LBB5_45:                               # %for.body.i154.preheader
                                        #   in Loop: Header=BB5_38 Depth=1
	sub.d	$a7, $s7, $t0
	alsl.d	$a6, $t0, $a6, 4
	addi.d	$a6, $a6, 8
...
.LBB5_46:                               # %for.body.i154
	...
	addi.d	$a4, $a4, 16
	bnez	$a7, .LBB5_46
.LBB5_47:                               # %invoke.cont27.preheader.i
                                        #   in Loop: Header=BB5_38 Depth=1
	ld.d	$a6, $fp, 248
	ld.d	$a7, $fp, 256
...
.LBB5_52:                               # %vector.body313
	...
	addi.d	$a7, $a7, 32
	bnez	$t4, .LBB5_52
# %bb.53:                               # %middle.block318
                                        #   in Loop: Header=BB5_38 Depth=1
	bne	$a2, $t1, .LBB5_45
	b	.LBB5_47
.LBB5_54:                               # %for.cond.cleanup111
...
# %bb.58:                               # %for.body.i189.preheader
	...
	pcaddu18i	$ra, %call36(memset)
	jirl	$ra, $ra, 0
.LBB5_59:                               # %_ZSt9__fill_a1IPddEvT_S1_RKT0_.exit
                                        #   in Loop: Header=BB5_57 Depth=1
	bge	$s0, $s1, .LBB5_56
# %bb.60:                               # %invoke.cont27.lr.ph.i
                                        #   in Loop: Header=BB5_57 Depth=1
	ld.d	$a7, $fp, 376
	ld.d	$a5, $fp, 384
	ld.d	$a3, $fp, 0
...
# %bb.63:                               # %for.body200.lr.ph
	...
	b	.LBB5_65
	.p2align	4, , 16
.LBB5_64:                               # %_ZN5Hydro7calcRhoEPKdS1_Pdii.exit246
...
# %bb.66:                               # %for.body.preheader.i211
	...
	bgeu	$a0, $s5, .LBB5_75
.LBB5_67:                               # %for.body.i213.preheader
                                        #   in Loop: Header=BB5_65 Depth=1
	sub.d	$a7, $a5, $a6
	alsl.d	$a3, $a6, $a3, 3
	alsl.d	$a2, $a6, $a2, 3
...
.LBB5_68:                               # %for.body.i213
	...
	addi.d	$a6, $a6, 8
	bnez	$a7, .LBB5_68
.LBB5_69:                               # %for.body.preheader.i224
                                        #   in Loop: Header=BB5_65 Depth=1
	ld.d	$a2, $fp, 328
	ld.d	$a1, $fp, 296
	ld.d	$a3, $fp, 320
	move	$a6, $a4
	bgeu	$a0, $s5, .LBB5_82
.LBB5_70:                               # %for.body.i226.preheader
                                        #   in Loop: Header=BB5_65 Depth=1
	sub.d	$a7, $a5, $a6
	alsl.d	$a3, $a6, $a3, 3
	alsl.d	$t0, $a6, $a1, 3
	alsl.d	$a2, $a6, $a2, 3
	.p2align	4, , 16
.LBB5_71:                               # %for.body.i226
                                        #   Parent Loop BB5_65 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fld.d	$fa0, $t0, 0
	fld.d	$fa1, $s2, %pc_lo12(.LCPI5_1)
	fld.d	$fa2, $a2, 0
	fadd.d	$fa0, $fa0, $fa1
	fdiv.d	$fa0, $fa2, $fa0
	fst.d	$fa0, $a3, 0
	...
	addi.d	$a2, $a2, 8
	bnez	$a7, .LBB5_71
.LBB5_72:                               # %for.body.preheader.i236
                                        #   in Loop: Header=BB5_65 Depth=1
	ld.d	$a2, $fp, 304
	move	$a3, $a4
	bgeu	$a0, $s5, .LBB5_87
.LBB5_73:                               # %for.body.i238.preheader
                                        #   in Loop: Header=BB5_65 Depth=1
	sub.d	$a0, $a5, $a3
	alsl.d	$a2, $a3, $a2, 3
	alsl.d	$a6, $a3, $s8, 3
...
.LBB5_74:                               # %for.body.i238
	...
	b	.LBB5_64
	.p2align	4, , 16
.LBB5_75:                               # %vector.memcheck361
                                        #   in Loop: Header=BB5_65 Depth=1
	sub.d	$a7, $a3, $s8
	move	$a6, $a4
	bltu	$a7, $s6, .LBB5_67
# %bb.76:                               # %vector.memcheck361
                                        #   in Loop: Header=BB5_65 Depth=1
	ld.d	$a6, $sp, 344                   # 8-byte Folded Reload
	sub.d	$a7, $a3, $a6
	move	$a6, $a4
	bltu	$a7, $s6, .LBB5_67
# %bb.77:                               # %vector.memcheck361
                                        #   in Loop: Header=BB5_65 Depth=1
	sub.d	$a7, $a3, $a1
	move	$a6, $a4
	bltu	$a7, $s6, .LBB5_67
# %bb.78:                               # %vector.memcheck361
                                        #   in Loop: Header=BB5_65 Depth=1
	sub.d	$a7, $a3, $a2
	move	$a6, $a4
	bltu	$a7, $s6, .LBB5_67
...
.LBB5_80:                               # %vector.body374
	...
	xvfmadd.d	$xr0, $xr6, $xr0, $xr4
	xvfmadd.d	$xr1, $xr7, $xr1, $xr5
	xvfmul.d	$xr0, $xr9, $xr0
	...
	addi.d	$t4, $t4, 64
	bnez	$t5, .LBB5_80
# %bb.81:                               # %middle.block386
                                        #   in Loop: Header=BB5_65 Depth=1
	bne	$a0, $a7, .LBB5_67
	b	.LBB5_69
	.p2align	4, , 16
.LBB5_82:                               # %vector.memcheck341
                                        #   in Loop: Header=BB5_65 Depth=1
	sub.d	$a7, $a3, $a2
	move	$a6, $a4
	bltu	$a7, $s6, .LBB5_70
# %bb.83:                               # %vector.memcheck341
                                        #   in Loop: Header=BB5_65 Depth=1
	sub.d	$a7, $a3, $a1
	move	$a6, $a4
	bltu	$a7, $s6, .LBB5_70
...
.LBB5_85:                               # %vector.body350
	...
	addi.d	$t2, $t2, 64
	bnez	$t3, .LBB5_85
# %bb.86:                               # %middle.block358
                                        #   in Loop: Header=BB5_65 Depth=1
	bne	$a0, $a7, .LBB5_70
	b	.LBB5_72
	.p2align	4, , 16
.LBB5_87:                               # %vector.memcheck321
                                        #   in Loop: Header=BB5_65 Depth=1
	sub.d	$a6, $a2, $a1
	move	$a3, $a4
	bltu	$a6, $s6, .LBB5_73
# %bb.88:                               # %vector.memcheck321
                                        #   in Loop: Header=BB5_65 Depth=1
	sub.d	$a6, $a2, $s8
	move	$a3, $a4
	bltu	$a6, $s6, .LBB5_73
...
.LBB5_90:                               # %vector.body330
	...
	addi.d	$t1, $t1, 64
	bnez	$t2, .LBB5_90
# %bb.91:                               # %middle.block338
                                        #   in Loop: Header=BB5_65 Depth=1
	beq	$a0, $a6, .LBB5_64
	b	.LBB5_73
.LBB5_92:                               # %for.cond.cleanup199
...
.Lfunc_end9:
	...
	.cfi_endproc
                                        # -- End function
	.section	.rodata.cst32,"aM",@progbits,32
	.p2align	5, 0x0                          # -- Begin function _ZN5Hydro9calcAccelEPK7double2PKdPS0_ii
.LCPI10_0:
	.dword	1                               # 0x1
	.dword	3                               # 0x3
	.dword	0                               # 0x0
...
# %bb.7:                                # %vector.ph
	...
	add.d	$a4, $a3, $t1
	add.d	$t1, $a1, $t1
	pcalau12i	$t2, %pc_hi20(.LCPI10_0)
	xvld	$xr0, $t2, %pc_lo12(.LCPI10_0)
	lu12i.w	$t2, 322956
	ori	$t2, $t2, 830
	lu32i.d	$t2, 98173
	lu52i.d	$t2, $t2, 694
...
.LBB13_10:                              # %vector.body
	...
	xvfsub.d	$xr3, $xr3, $xr5
	xvfmadd.d	$xr2, $xr8, $xr2, $xr6
	xvfmadd.d	$xr3, $xr9, $xr3, $xr7
