...
.LBB5_188:
	move	$a4, $zero
	b	.LBB5_200
.LBB5_189:                              # %vector.main.loop.iter.check2114
	srli.d	$a1, $a3, 2
	ori	$a4, $zero, 60
	addi.d	$a1, $a1, 1
	bgeu	$a3, $a4, .LBB5_191
...
# %bb.193:                              # %middle.block2126
	...
	beq	$a1, $a3, .LBB5_200
# %bb.194:                              # %vec.epilog.iter.check2133
	andi	$a5, $a1, 12
	beqz	$a5, .LBB5_198
.LBB5_195:                              # %vec.epilog.ph2132
	...
	sub.d	$a3, $a3, $a6
	.p2align	4, , 16
.LBB5_196:                              # %vec.epilog.vector.body2138
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a2, 0
	vadd.w	$vr0, $vr1, $vr0
	addi.d	$a3, $a3, 4
	addi.d	$a2, $a2, 16
	bnez	$a3, .LBB5_196
# %bb.197:                              # %vec.epilog.middle.block2145
	vshuf4i.w	$vr1, $vr0, 14
	vadd.w	$vr0, $vr0, $vr1
	vreplvei.w	$vr1, $vr0, 1
	vadd.w	$vr0, $vr0, $vr1
...
.LBB5_203:
	move	$a3, $zero
	b	.LBB5_215
.LBB5_204:                              # %vector.main.loop.iter.check2154
	srli.d	$a1, $a3, 2
	ori	$a4, $zero, 60
	addi.d	$a1, $a1, 1
	bgeu	$a3, $a4, .LBB5_206
...
# %bb.208:                              # %middle.block2166
	...
	beq	$a1, $a4, .LBB5_215
# %bb.209:                              # %vec.epilog.iter.check2173
	andi	$a5, $a1, 12
	beqz	$a5, .LBB5_213
.LBB5_210:                              # %vec.epilog.ph2172
	bstrpick.d	$a5, $a1, 62, 2
	slli.d	$a6, $a5, 2
	alsl.d	$a5, $a5, $a2, 4
	vrepli.b	$vr0, 0
	...
	sub.d	$a3, $a4, $a6
	.p2align	4, , 16
.LBB5_211:                              # %vec.epilog.vector.body2178
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a2, 0
	vadd.w	$vr0, $vr1, $vr0
	addi.d	$a3, $a3, 4
	addi.d	$a2, $a2, 16
	bnez	$a3, .LBB5_211
# %bb.212:                              # %vec.epilog.middle.block2185
	vshuf4i.w	$vr1, $vr0, 14
	vadd.w	$vr0, $vr0, $vr1
	vreplvei.w	$vr1, $vr0, 1
	vadd.w	$vr0, $vr0, $vr1
...
# %bb.237:                              # %for.cond356.preheader
	...
	ori	$a1, $zero, 1
	blt	$a6, $a1, .LBB5_251
# %bb.238:                              # %iter.check2193
	ld.d	$a1, $s8, 104
	ori	$a3, $zero, 4
	move	$a2, $zero
	bltu	$a6, $a3, .LBB5_249
# %bb.239:                              # %iter.check2193
	ld.d	$a3, $sp, 208                   # 8-byte Folded Reload
	sub.d	$a3, $a3, $a1
	ori	$a4, $zero, 63
	bgeu	$a4, $a3, .LBB5_249
# %bb.240:                              # %vector.main.loop.iter.check2195
	ori	$a2, $zero, 16
	bgeu	$a6, $a2, .LBB5_242
# %bb.241:
	move	$a2, $zero
	b	.LBB5_246
.LBB5_242:                              # %vector.ph2196
...
.LBB5_243:                              # %vector.body2199
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB5_243
# %bb.244:                              # %middle.block2204
	beq	$a2, $a6, .LBB5_251
# %bb.245:                              # %vec.epilog.iter.check2209
	andi	$a3, $a6, 12
	beqz	$a3, .LBB5_249
.LBB5_246:                              # %vec.epilog.ph2208
	move	$a5, $a2
	...
	vrepli.w	$vr0, 3
	.p2align	4, , 16
.LBB5_247:                              # %vec.epilog.vector.body2214
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a5, 0
	vmul.w	$vr1, $vr1, $vr0
	vst	$vr1, $a4, 0
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB5_247
# %bb.248:                              # %vec.epilog.middle.block2218
	beq	$a2, $a6, .LBB5_251
...
# %bb.313:                              # %for.cond522.preheader
	...
	ori	$a1, $zero, 1
	blt	$a6, $a1, .LBB5_327
# %bb.314:                              # %iter.check2225
	ld.d	$a1, $s8, 128
	ori	$a3, $zero, 4
	move	$a2, $zero
	bltu	$a6, $a3, .LBB5_325
# %bb.315:                              # %iter.check2225
	ld.d	$a3, $sp, 208                   # 8-byte Folded Reload
	sub.d	$a3, $a3, $a1
	ori	$a4, $zero, 63
	bgeu	$a4, $a3, .LBB5_325
# %bb.316:                              # %vector.main.loop.iter.check2227
	ori	$a2, $zero, 16
	bgeu	$a6, $a2, .LBB5_318
# %bb.317:
	move	$a2, $zero
	b	.LBB5_322
.LBB5_318:                              # %vector.ph2228
	bstrpick.d	$a2, $a6, 30, 4
	slli.d	$a2, $a2, 4
	ld.d	$a3, $sp, 208                   # 8-byte Folded Reload
	addi.d	$a3, $a3, 32
...
.LBB5_319:                              # %vector.body2231
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB5_319
# %bb.320:                              # %middle.block2236
	beq	$a2, $a6, .LBB5_327
# %bb.321:                              # %vec.epilog.iter.check2241
	andi	$a3, $a6, 12
	beqz	$a3, .LBB5_325
.LBB5_322:                              # %vec.epilog.ph2240
	move	$a5, $a2
	bstrpick.d	$a2, $a6, 30, 2
	slli.d	$a2, $a2, 2
	sub.d	$a3, $a5, $a2
	...
	alsl.d	$a5, $a5, $a1, 2
	.p2align	4, , 16
.LBB5_323:                              # %vec.epilog.vector.body2246
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vslli.w	$vr0, $vr0, 2
	vst	$vr0, $a4, 0
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB5_323
# %bb.324:                              # %vec.epilog.middle.block2250
	beq	$a2, $a6, .LBB5_327
...
# %bb.412:
	move	$fp, $zero
	b	.LBB5_423
.LBB5_413:                              # %vector.main.loop.iter.check2258
	srli.d	$a0, $a1, 2
	ori	$a2, $zero, 60
	addi.d	$a0, $a0, 1
	bgeu	$a1, $a2, .LBB5_415
...
# %bb.417:                              # %middle.block2270
	...
	xvpickve2gr.w	$fp, $xr0, 0
	beq	$a0, $a1, .LBB5_424
# %bb.418:                              # %vec.epilog.iter.check2277
	andi	$a2, $a0, 12
	beqz	$a2, .LBB5_422
.LBB5_419:                              # %vec.epilog.ph2276
	...
	sub.d	$a1, $a1, $a3
	.p2align	4, , 16
.LBB5_420:                              # %vec.epilog.vector.body2282
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a4, 0
	vadd.w	$vr0, $vr1, $vr0
	addi.d	$a1, $a1, 4
	addi.d	$a4, $a4, 16
	bnez	$a1, .LBB5_420
# %bb.421:                              # %vec.epilog.middle.block2289
	vshuf4i.w	$vr1, $vr0, 14
	vadd.w	$vr0, $vr0, $vr1
	vreplvei.w	$vr1, $vr0, 1
	vadd.w	$vr0, $vr0, $vr1
