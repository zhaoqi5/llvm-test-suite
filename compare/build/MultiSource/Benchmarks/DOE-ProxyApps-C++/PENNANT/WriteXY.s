...
.Ltmp111:                               # EH_LABEL
	b	.LBB2_122
.LBB2_116:                              # %lpad131.loopexit.split-lp
.Ltmp76:                                # EH_LABEL
	b	.LBB2_122
.LBB2_117:                              # %lpad91.loopexit.split-lp
.Ltmp92:                                # EH_LABEL
	b	.LBB2_122
.LBB2_118:                              # %lpad55.loopexit.split-lp
.Ltmp108:                               # EH_LABEL
	b	.LBB2_122
.LBB2_119:                              # %lpad131.loopexit
.Ltmp73:                                # EH_LABEL
	b	.LBB2_122
.LBB2_120:                              # %lpad91.loopexit
.Ltmp89:                                # EH_LABEL
	b	.LBB2_122
.LBB2_121:                              # %lpad55.loopexit
.Ltmp105:                               # EH_LABEL
.LBB2_122:                              # %ehcleanup
	move	$s1, $a0
	ld.d	$s8, $sp, 16                    # 8-byte Folded Reload
...
.LBB2_123:                              # %ehcleanup162
	...
	addi.d	$a1, $sp, 592
	beq	$a0, $a1, .LBB2_126
# %bb.124:                              # %if.then.i.i162
	ld.d	$a1, $sp, 592
	addi.d	$a1, $a1, 1
.LBB2_125:                              # %ehcleanup165
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB2_126:                              # %ehcleanup165
	bnez	$s2, .LBB2_131
# %bb.127:                              # %ehcleanup166
	ld.d	$a0, $sp, 56                    # 8-byte Folded Reload
	bnez	$a0, .LBB2_132
.LBB2_128:                              # %ehcleanup168
	ld.d	$s0, $sp, 48                    # 8-byte Folded Reload
	beqz	$s8, .LBB2_130
.LBB2_129:                              # %if.then.i.i.i203
	ld.d	$a0, $sp, 40                    # 8-byte Folded Reload
	sub.d	$a1, $a0, $s8
	move	$a0, $s8
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
.LBB2_130:                              # %if.then.i.i.i210
	sub.d	$a1, $s0, $fp
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_ZdlPvm)
	jirl	$ra, $ra, 0
