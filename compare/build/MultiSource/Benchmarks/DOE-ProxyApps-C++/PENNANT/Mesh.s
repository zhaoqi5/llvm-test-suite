...
.Ltmp66:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp67:                                # EH_LABEL
# %bb.13:                               # %.noexc23._ZSt4sortIN9__gnu_cxx17__normal_iteratorIPSt4pairIiiESt6vectorIS3_SaIS3_EEEEEvT_S9_.exit_crit_edge
	ld.w	$a0, $fp, 76
...
# %bb.15:                               # %if.end43.peel
	...
	ld.w	$a5, $fp, 76
	beq	$a5, $a3, .LBB6_27
# %bb.16:                               # %if.then49.peel
	ld.w	$a3, $s0, 8
	bne	$a4, $a3, .LBB6_18
# %bb.17:                               # %if.then59.peel
	ld.w	$a3, $s0, 12
	alsl.d	$a2, $a2, $a1, 2
	st.w	$a3, $a2, 0
	ld.w	$a5, $fp, 76
.LBB6_18:                               # %if.end64.peel
	ori	$a2, $zero, 2
	blt	$a5, $a2, .LBB6_27
# %bb.19:                               # %if.else.preheader
	addi.d	$a2, $s0, 12
	ori	$a3, $zero, 1
	b	.LBB6_21
	.p2align	4, , 16
...
# %bb.25:                               # %if.then59
	...
	ld.w	$a6, $fp, 76
	b	.LBB6_20
.LBB6_26:                               # %for.cond.cleanup24
	beqz	$s0, .LBB6_31
.LBB6_27:                               # %if.then.i.i.i
	sub.d	$a1, $s3, $s0
	move	$a0, $s0
...
.LBB6_29:                               # %vector.body
	...
	addi.d	$t4, $a4, -2
	addi.d	$t5, $a4, -1
	xvstelm.w	$xr0, $a3, -32, 0
	xvstelm.w	$xr0, $a3, -24, 1
	xvstelm.w	$xr0, $a3, -16, 2
	xvstelm.w	$xr0, $a3, -8, 3
	xvstelm.w	$xr0, $a3, 0, 4
	xvstelm.w	$xr0, $a3, 8, 5
	xvstelm.w	$xr0, $a3, 16, 6
	xvstelm.w	$xr0, $a3, 24, 7
	st.w	$a7, $a3, -28
	st.w	$t0, $a3, -20
	st.w	$t1, $a3, -12
	st.w	$t2, $a3, -4
...
# %bb.0:                                # %entry
	...
	pcalau12i	$a7, %got_pc_hi20(_ZN8Parallel5numpeE)
	ld.d	$a7, $a7, %got_pc_lo12(_ZN8Parallel5numpeE)
	ld.w	$a7, $a7, 0
	ori	$t0, $zero, 1
	bne	$a7, $t0, .LBB7_2
.LBB7_1:                                # %return
