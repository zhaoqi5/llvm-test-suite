...
# %bb.13:                               # %while.body.i.i
	...
	addi.d	$a3, $a4, -4
	beq	$a3, $a1, .LBB4_20
# %bb.14:                               # %land.rhs.i.i.1
                                        #   in Loop: Header=BB4_12 Depth=2
	ld.w	$a5, $a3, 0
	beq	$a5, $s7, .LBB4_23
# %bb.15:                               # %while.body.i.i.1
                                        #   in Loop: Header=BB4_12 Depth=2
	beq	$a4, $a1, .LBB4_20
# %bb.16:                               # %land.rhs.i.i.2
                                        #   in Loop: Header=BB4_12 Depth=2
	ld.w	$a3, $a4, 0
	beq	$a3, $s7, .LBB4_22
# %bb.17:                               # %while.body.i.i.2
                                        #   in Loop: Header=BB4_12 Depth=2
	addi.d	$a3, $a4, 4
	beq	$a3, $a1, .LBB4_20
# %bb.18:                               # %land.rhs.i.i.3
                                        #   in Loop: Header=BB4_12 Depth=2
	ld.w	$a5, $a3, 0
	beq	$a5, $s7, .LBB4_23
# %bb.19:                               # %while.body.i.i.3
                                        #   in Loop: Header=BB4_12 Depth=2
	addi.d	$a3, $a4, 8
	addi.d	$a4, $a4, 16
	bne	$a3, $a1, .LBB4_12
.LBB4_20:                               #   in Loop: Header=BB4_10 Depth=1
	move	$a3, $a1
	b	.LBB4_23
.LBB4_21:                               # %land.rhs.i.i.land.rhs.i.i.while.end.loopexit.i.i_crit_edge_crit_edge
                                        #   in Loop: Header=BB4_10 Depth=1
	addi.d	$a3, $a4, -8
	b	.LBB4_23
