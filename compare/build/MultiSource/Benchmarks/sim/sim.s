...
.LBB3_91:                               # %if.end508
	...
	sub.w	$fp, $fp, $t7
	bge	$fp, $t5, .LBB3_93
.LBB3_92:                               #   in Loop: Header=BB3_85 Depth=4
	move	$ra, $t0
	move	$s5, $a3
	b	.LBB3_104
	.p2align	4, , 16
...
.LBB3_105:                              # %for.body549
	...
	beq	$fp, $t3, .LBB3_108
# %bb.106:                              # %for.cond546
                                        #   in Loop: Header=BB3_105 Depth=5
	ld.d	$t6, $t6, 8
	st.d	$t6, $t8, %pc_lo12(z)
	bnez	$t6, .LBB3_105
.LBB3_107:                              # %if.then559
	...
	b	.LBB3_109
	.p2align	4, , 16
.LBB3_108:                              #   in Loop: Header=BB3_85 Depth=4
	move	$a0, $zero
.LBB3_109:                              # %if.end565
                                        #   in Loop: Header=BB3_85 Depth=4
	slti	$s3, $a0, 1
...
# %bb.112:                              # %if.else581
	...
	b	.LBB3_114
	.p2align	4, , 16
.LBB3_113:                              #   in Loop: Header=BB3_85 Depth=4
	move	$s1, $t6
	move	$fp, $a0
	move	$s0, $a1
.LBB3_114:                              # %if.end591
...
# %bb.117:                              # %if.else602
	...
	b	.LBB3_119
	.p2align	4, , 16
.LBB3_118:                              #   in Loop: Header=BB3_85 Depth=4
	move	$a0, $s1
	move	$t6, $fp
	move	$s3, $s0
.LBB3_119:                              # %if.end612
...
.LBB3_121:                              #   in Loop: Header=BB3_19 Depth=3
	...
	bge	$t5, $a5, .LBB3_81
.LBB3_122:                              # %if.end481.for.end658_crit_edge
                                        #   in Loop: Header=BB3_19 Depth=3
	move	$t7, $zero
	move	$s3, $t3
	move	$t1, $t6
	...
	b	.LBB3_124
	.p2align	4, , 16
.LBB3_123:                              #   in Loop: Header=BB3_19 Depth=3
...
# %bb.5:                                # %iter.check
	...
	sub.d	$a2, $zero, $s3
	ld.w	$a3, $t7, %pc_lo12(r)
	ld.d	$a6, $s1, %pc_lo12(DD)
	addi.d	$a7, $s0, 1
	bstrpick.d	$a1, $a7, 31, 0
	ori	$a4, $zero, 1
	move	$t1, $a2
...
.LBB8_12:                               # %vec.epilog.ph
                                        #   in Loop: Header=BB8_4 Depth=1
	bstrpick.d	$a4, $t0, 30, 2
	slli.d	$t4, $a4, 2
	srli.d	$a5, $t0, 2
	ori	$a4, $zero, 1
	bstrins.d	$a4, $a5, 30, 2
	mul.d	$a5, $t4, $t2
	vreplgr2vr.w	$vr0, $t1
	sub.d	$t1, $a5, $s3
...
.LBB8_18:                               # %for.body188.lr.ph
	...
	bstrpick.d	$t3, $t8, 31, 1
	st.d	$s4, $sp, 88                    # 8-byte Folded Spill
	sub.d	$a4, $zero, $s4
	ld.w	$t0, $t7, %pc_lo12(r)
	pcalau12i	$a3, %pc_hi20(v)
	st.d	$a3, $sp, 160                   # 8-byte Folded Spill
	ld.d	$t1, $a3, %pc_lo12(v)
...
# %bb.64:                               # %for.body.lr.ph
	...
	ld.d	$a2, $sp, 176                   # 8-byte Folded Reload
	ld.b	$a3, $a2, 1
	ld.d	$a4, $a1, %pc_lo12(v)
	ld.w	$a1, $t7, %pc_lo12(r)
	ld.d	$a2, $sp, 72                    # 8-byte Folded Reload
	ld.w	$a2, $a2, %pc_lo12(q)
	slli.d	$a3, $a3, 10
	add.d	$a3, $a4, $a3
