...
.LBB8_7:                                # %vector.body383
	...
	addi.d	$t4, $t4, 32
	bnez	$t5, .LBB8_7
# %bb.8:                                # %middle.block389
                                        #   in Loop: Header=BB8_4 Depth=1
	beq	$t2, $t1, .LBB8_11
.LBB8_9:                                # %for.body174.preheader
                                        #   in Loop: Header=BB8_4 Depth=1
	alsl.d	$a3, $t8, $a3, 2
	alsl.d	$t1, $t8, $a0, 2
	sub.d	$t2, $a1, $t8
...
.LBB8_23:                               # %vector.ph
	...
	addi.d	$s1, $a4, 1
	sub.d	$a5, $zero, $t6
	bstrpick.d	$a4, $s1, 32, 2
	slli.d	$t2, $a4, 2
	sub.d	$a4, $s0, $t2
	mul.d	$t3, $t2, $a5
	sub.d	$t7, $t3, $s3
	pcalau12i	$t3, %pc_hi20(.LCPI8_0)
	vld	$vr2, $t3, %pc_lo12(.LCPI8_0)
	vreplgr2vr.w	$vr0, $t6
	vreplgr2vr.w	$vr1, $a6
	vreplgr2vr.w	$vr3, $a5
	vmadd.w	$vr1, $vr3, $vr2
...
.LBB8_28:                               # %for.body285.lr.ph
	...
	b	.LBB8_30
	.p2align	4, , 16
.LBB8_29:                               # %for.cond282.loopexit
                                        #   in Loop: Header=BB8_30 Depth=2
	move	$s3, $t5
	ld.d	$a5, $sp, 168                   # 8-byte Folded Reload
	bge	$a5, $s8, .LBB8_38
.LBB8_30:                               # %for.body302.lr.ph
                                        #   Parent Loop BB8_4 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB8_33 Depth 3
                                        #         Child Loop BB8_35 Depth 4
...
# %bb.77:                               # %if.else108
	...
	st.w	$a1, $a0, 4
	b	.LBB8_80
.LBB8_78:                               # %if.else111.if.end127_crit_edge
	ld.d	$a2, $sp, 32                    # 8-byte Folded Reload
