...
# %bb.11:
	...
	pcalau12i	$s1, %pc_hi20(al_len)
	pcalau12i	$s2, %pc_hi20(no_mat)
	pcalau12i	$s3, %pc_hi20(no_mis)
	b	.LBB1_13
	.p2align	4, , 16
.LBB1_12:                               # %for.inc116
...
.LBB1_20:                               # %findmax.exit
	...
	st.d	$s7, $a0, %pc_lo12(sapp)
	pcalau12i	$a0, %pc_hi20(last)
	st.w	$zero, $a0, %pc_lo12(last)
	st.w	$zero, $s1, %pc_lo12(al_len)
	st.w	$zero, $s2, %pc_lo12(no_mat)
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	ld.w	$a4, $a0, %pc_lo12(q)
	st.w	$zero, $s3, %pc_lo12(no_mis)
	...
	pcaddu18i	$ra, %call36(printf)
	jirl	$ra, $ra, 0
	ld.w	$a0, $s2, %pc_lo12(no_mat)
	ld.w	$a1, $s1, %pc_lo12(al_len)
	ori	$a2, $zero, 100
	mul.w	$a0, $a0, $a2
	div.w	$a1, $a0, $a1
	...
	pcaddu18i	$ra, %call36(printf)
	jirl	$ra, $ra, 0
	ld.w	$a1, $s2, %pc_lo12(no_mat)
	pcalau12i	$a0, %pc_hi20(.L.str.24)
	addi.d	$a0, $a0, %pc_lo12(.L.str.24)
	pcaddu18i	$ra, %call36(printf)
	jirl	$ra, $ra, 0
	ld.w	$a1, $s3, %pc_lo12(no_mis)
...
# %bb.5:                                # %iter.check
	...
	st.w	$zero, $a0, 0
	ld.d	$a1, $sp, 80                    # 8-byte Folded Reload
	ld.w	$ra, $a1, %pc_lo12(q)
	sub.d	$a2, $zero, $ra
	ld.w	$a3, $s3, %pc_lo12(r)
	ld.d	$a6, $t7, %pc_lo12(DD)
	addi.d	$a7, $s0, 1
	bstrpick.d	$a1, $a7, 31, 0
	ori	$t5, $zero, 1
	move	$t1, $a2
...
.LBB8_18:                               # %for.body188.lr.ph
	...
	bstrpick.d	$t3, $s4, 31, 1
	st.d	$a4, $sp, 96                    # 8-byte Folded Spill
	sub.d	$a4, $zero, $a4
	ld.w	$t0, $s3, %pc_lo12(r)
	pcalau12i	$a3, %pc_hi20(v)
	st.d	$a3, $sp, 176                   # 8-byte Folded Spill
	ld.d	$t2, $a3, %pc_lo12(v)
	pcalau12i	$a3, %pc_hi20(qr)
	st.d	$a3, $sp, 168                   # 8-byte Folded Spill
	ld.w	$t6, $a3, %pc_lo12(qr)
	ld.d	$a3, $t7, %pc_lo12(DD)
...
.LBB8_28:                               # %for.body271.lr.ph
	...
	ld.w	$t6, $s3, %pc_lo12(r)
	pcalau12i	$s2, %pc_hi20(SS)
	ld.d	$a4, $s2, %pc_lo12(SS)
	srai.d	$a5, $t1, 63
	and	$a5, $a5, $t1
	nor	$a5, $a5, $zero
	add.w	$t0, $t4, $a5
	st.d	$t1, $sp, 184                   # 8-byte Folded Spill
	bstrpick.d	$a5, $t1, 31, 0
	ori	$t1, $zero, 7
...
.LBB8_35:                               # %for.body285.lr.ph
                                        #   in Loop: Header=BB8_4 Depth=1
	alsl.d	$t6, $t4, $a7, 2
	ld.w	$t7, $s3, %pc_lo12(r)
	ld.d	$a2, $s1, %pc_lo12(v)
	st.d	$a2, $sp, 176                   # 8-byte Folded Spill
	addi.d	$t8, $fp, 1
	ld.w	$t4, $s4, %pc_lo12(qr)
	ld.w	$a4, $t5, %pc_lo12(J)
	ld.d	$a2, $s2, %pc_lo12(SS)
	ld.d	$a5, $s0, %pc_lo12(row)
