...
# %bb.0:                                # %entry
	...
	pcalau12i	$s2, %pc_hi20(CC)
	pcalau12i	$s3, %pc_hi20(RR)
	pcalau12i	$s6, %pc_hi20(EE)
	pcalau12i	$s7, %pc_hi20(DD)
	pcalau12i	$s4, %pc_hi20(SS)
	pcalau12i	$fp, %pc_hi20(FF)
	addi.d	$s1, $a3, 1
	pcalau12i	$a0, %pc_hi20(q)
	...
	blez	$a3, .LBB2_13
# %bb.1:                                # %iter.check
	ld.d	$a0, $s2, %pc_lo12(CC)
	ld.d	$a1, $s3, %pc_lo12(RR)
	st.d	$a1, $sp, 200                   # 8-byte Folded Spill
	ld.d	$a1, $s6, %pc_lo12(EE)
	st.d	$a1, $sp, 224                   # 8-byte Folded Spill
	ld.d	$a1, $sp, 48                    # 8-byte Folded Reload
	ld.w	$a1, $a1, %pc_lo12(q)
	ld.d	$a2, $s7, %pc_lo12(DD)
	st.d	$a2, $sp, 216                   # 8-byte Folded Spill
	ld.d	$a2, $s4, %pc_lo12(SS)
	st.d	$a2, $sp, 192                   # 8-byte Folded Spill
	ld.d	$a2, $fp, %pc_lo12(FF)
...
.LBB2_12:                               # %for.body
	...
	addi.d	$a3, $a3, 4
	bnez	$a4, .LBB2_12
.LBB2_13:                               # %for.cond11.preheader
	blez	$s0, .LBB2_81
# %bb.14:                               # %for.body13.lr.ph
	pcalau12i	$a0, %pc_hi20(v)
	ld.d	$a0, $a0, %pc_lo12(v)
	st.d	$a0, $sp, 32                    # 8-byte Folded Spill
	ld.d	$a0, $s2, %pc_lo12(CC)
	st.d	$a0, $sp, 224                   # 8-byte Folded Spill
	ld.d	$a0, $s3, %pc_lo12(RR)
	st.d	$a0, $sp, 216                   # 8-byte Folded Spill
	ld.d	$a3, $s6, %pc_lo12(EE)
	ld.d	$a0, $s7, %pc_lo12(DD)
	st.d	$a0, $sp, 208                   # 8-byte Folded Spill
	ld.d	$a0, $s4, %pc_lo12(SS)
	st.d	$a0, $sp, 200                   # 8-byte Folded Spill
	ld.d	$a0, $fp, %pc_lo12(FF)
...
# %bb.20:                               # %for.body30.lr.ph
	...
	ld.d	$a7, $a2, 0
	ld.d	$a2, $sp, 120                   # 8-byte Folded Reload
	ld.w	$t5, $a2, %pc_lo12(numnode)
	ld.d	$t4, $t8, %pc_lo12(most)
	ld.d	$a2, $sp, 128                   # 8-byte Folded Reload
	ld.w	$t3, $a2, %pc_lo12(min)
...
.LBB2_21:                               # %if.end72.i
	...
	ld.w	$t3, $a7, 0
.LBB2_22:                               # %addnode.exit
                                        #   in Loop: Header=BB2_24 Depth=2
	ld.d	$a1, $sp, 128                   # 8-byte Folded Reload
	st.w	$t3, $a1, %pc_lo12(min)
.LBB2_23:                               # %for.inc152
                                        #   in Loop: Header=BB2_24 Depth=2
	addi.d	$s6, $s6, 1
	move	$s2, $a4
...
# %bb.34:                               # %if.else69
	...
	b	.LBB2_36
	.p2align	4, , 16
.LBB2_35:                               #   in Loop: Header=BB2_24 Depth=2
	move	$a1, $a5
.LBB2_36:                               # %if.end77
                                        #   in Loop: Header=BB2_24 Depth=2
...
# %bb.49:                               # %if.else122
	...
	b	.LBB2_51
	.p2align	4, , 16
.LBB2_50:                               #   in Loop: Header=BB2_24 Depth=2
	move	$a0, $a5
	move	$ra, $t7
	move	$s8, $s0
.LBB2_51:                               # %if.end130
...
# %bb.52:                               # %if.then150
	...
	beqz	$t4, .LBB2_55
# %bb.53:                               # %land.lhs.true.i
                                        #   in Loop: Header=BB2_24 Depth=2
	ld.w	$a1, $t4, 4
	bne	$a1, $a5, .LBB2_55
# %bb.54:                               # %land.lhs.true2.i
                                        #   in Loop: Header=BB2_24 Depth=2
	ld.w	$a1, $t4, 8
	beq	$a1, $t1, .LBB2_60
	.p2align	4, , 16
...
.LBB2_58:                               # %for.body.i
	...
	ld.d	$t4, $a1, 0
	ld.w	$a2, $t4, 4
	st.d	$t4, $t8, %pc_lo12(most)
	bne	$a2, $a5, .LBB2_57
# %bb.59:                               # %land.lhs.true7.i
                                        #   in Loop: Header=BB2_58 Depth=3
	ld.w	$a2, $t4, 8
	bne	$a2, $t1, .LBB2_57
.LBB2_60:                               # %if.then12.i
...
# %bb.77:                               # %for.body59.i.preheader
	...
	.p2align	4, , 16
.LBB2_78:                               # %for.inc69.i
                                        #   in Loop: Header=BB2_79 Depth=3
	addi.d	$a5, $a5, -1
	addi.d	$a1, $a1, 8
	beqz	$a5, .LBB2_21
.LBB2_79:                               # %for.body59.i
                                        #   Parent Loop BB2_16 Depth=1
                                        #     Parent Loop BB2_24 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$t1, $a1, 0
...
.LBB3_4:                                # %vector.body635
	...
	addi.d	$a7, $a7, -8
	bnez	$t0, .LBB3_4
# %bb.5:                                # %middle.block640
	beq	$a1, $a2, .LBB3_14
.LBB3_6:                                # %for.body.us.preheader653
	addi.d	$a1, $a0, 1
...
.LBB3_30:                               # %for.body222.lr.ph
	...
	.p2align	4, , 16
.LBB3_31:                               # %if.end371
                                        #   in Loop: Header=BB3_34 Depth=5
	ori	$a0, $zero, 1
	move	$s7, $s8
	beqz	$t0, .LBB3_45
# %bb.32:                               #   in Loop: Header=BB3_34 Depth=5
...
.LBB3_34:                               # %for.body222
	...
	move	$s3, $s4
	bge	$a7, $a0, .LBB3_37
# %bb.35:                               #   in Loop: Header=BB3_34 Depth=5
	move	$a7, $a0
.LBB3_36:                               #   in Loop: Header=BB3_34 Depth=5
	move	$t4, $t1
	move	$s0, $t2
	b	.LBB3_40
	.p2align	4, , 16
...
.LBB3_40:                               # %if.end245
	...
	sub.w	$t1, $t1, $a3
	bge	$t1, $s1, .LBB3_42
.LBB3_41:                               #   in Loop: Header=BB3_34 Depth=5
	move	$ra, $t5
	move	$s5, $t6
	ld.d	$a0, $a6, 0
...
# %bb.44:                               # %if.else270
	...
	b	.LBB3_55
	.p2align	4, , 16
.LBB3_45:                               # %land.lhs.true373
                                        #   in Loop: Header=BB3_34 Depth=5
	ld.d	$s6, $sp, 232                   # 8-byte Folded Reload
	ld.d	$a0, $sp, 216                   # 8-byte Folded Reload
	bge	$a0, $t1, .LBB3_47
# %bb.46:                               # %land.lhs.true373
                                        #   in Loop: Header=BB3_34 Depth=5
	addi.w	$a0, $t2, 0
	ld.d	$a2, $sp, 200                   # 8-byte Folded Reload
	blt	$a2, $a0, .LBB3_51
.LBB3_47:                               # %lor.lhs.false379
                                        #   in Loop: Header=BB3_34 Depth=5
	ld.d	$a0, $sp, 216                   # 8-byte Folded Reload
	bge	$a0, $ra, .LBB3_49
# %bb.48:                               # %lor.lhs.false379
                                        #   in Loop: Header=BB3_34 Depth=5
	ld.d	$a0, $sp, 200                   # 8-byte Folded Reload
	blt	$a0, $s5, .LBB3_51
.LBB3_49:                               # %lor.lhs.false385
                                        #   in Loop: Header=BB3_34 Depth=5
	move	$a0, $zero
	ld.d	$a2, $sp, 216                   # 8-byte Folded Reload
	bge	$a2, $t4, .LBB3_33
# %bb.50:                               # %lor.lhs.false385
                                        #   in Loop: Header=BB3_34 Depth=5
	addi.w	$a2, $s0, 0
...
.LBB3_51:                               # %if.then391
	...
	b	.LBB3_33
	.p2align	4, , 16
.LBB3_52:                               #   in Loop: Header=BB3_34 Depth=5
	move	$s1, $t1
	ld.d	$a0, $a6, 0
	st.d	$a0, $t8, %pc_lo12(z)
	beqz	$a0, .LBB3_55
...
.LBB3_53:                               # %for.body286
                                        ...
                                        #       Parent Loop BB3_19 Depth=3
                                        #         Parent Loop BB3_20 Depth=4
                                        #           Parent Loop BB3_34 Depth=5
                                        # =>          This Inner Loop Header: Depth=6
	ld.w	$t1, $a0, 0
	addi.w	$t2, $s3, 0
	beq	$t1, $t2, .LBB3_56
# %bb.54:                               # %for.cond283
                                        #   in Loop: Header=BB3_53 Depth=6
	ld.d	$a0, $a0, 8
	st.d	$a0, $t8, %pc_lo12(z)
	bnez	$a0, .LBB3_53
.LBB3_55:                               # %if.then296
	...
	b	.LBB3_57
	.p2align	4, , 16
.LBB3_56:                               #   in Loop: Header=BB3_34 Depth=5
	move	$a0, $zero
.LBB3_57:                               # %if.end302
                                        #   in Loop: Header=BB3_34 Depth=5
	slti	$t1, $a0, 1
...
# %bb.60:                               # %if.else318
	...
	b	.LBB3_62
	.p2align	4, , 16
.LBB3_61:                               #   in Loop: Header=BB3_34 Depth=5
	move	$a0, $t2
	move	$a2, $a1
	move	$s4, $t1
.LBB3_62:                               # %if.end328
...
# %bb.65:                               # %if.else339
	...
	b	.LBB3_67
	.p2align	4, , 16
.LBB3_66:                               #   in Loop: Header=BB3_34 Depth=5
	move	$a1, $a0
	move	$t1, $a2
	move	$t2, $s4
.LBB3_67:                               # %if.end349
...
# %bb.68:                               # %if.then370
	...
	ori	$a2, $zero, 1
	st.b	$a2, $a0, %pc_lo12(flag)
	b	.LBB3_31
.LBB3_69:                               # %land.lhs.true421
                                        #   in Loop: Header=BB3_20 Depth=4
	ld.d	$s4, $sp, 128                   # 8-byte Folded Reload
	ld.d	$a5, $sp, 200                   # 8-byte Folded Reload
	ld.d	$a2, $sp, 216                   # 8-byte Folded Reload
	bge	$a2, $t1, .LBB3_71
# %bb.70:                               # %land.lhs.true421
                                        #   in Loop: Header=BB3_20 Depth=4
	addi.w	$a2, $t2, 0
	blt	$a5, $a2, .LBB3_76
.LBB3_71:                               # %lor.lhs.false427
                                        #   in Loop: Header=BB3_20 Depth=4
	addi.w	$a2, $ra, 0
	ld.d	$a6, $sp, 216                   # 8-byte Folded Reload
	bge	$a6, $a2, .LBB3_73
# %bb.72:                               # %lor.lhs.false427
                                        #   in Loop: Header=BB3_20 Depth=4
	addi.w	$a2, $s5, 0
	blt	$a5, $a2, .LBB3_76
.LBB3_73:                               # %lor.lhs.false433
                                        #   in Loop: Header=BB3_20 Depth=4
	ld.d	$a2, $sp, 216                   # 8-byte Folded Reload
	bge	$a2, $t4, .LBB3_75
# %bb.74:                               # %lor.lhs.false433
                                        #   in Loop: Header=BB3_20 Depth=4
	addi.w	$a2, $s0, 0
	blt	$a5, $a2, .LBB3_76
.LBB3_75:                               #   in Loop: Header=BB3_20 Depth=4
	move	$a1, $zero
.LBB3_76:                               # %if.then439
                                        #   in Loop: Header=BB3_20 Depth=4
	move	$t5, $a7
	...
	beq	$a2, $a5, .LBB3_29
	.p2align	4, , 16
.LBB3_77:                               #   in Loop: Header=BB3_20 Depth=4
	move	$s2, $a1
	beqz	$s2, .LBB3_20
.LBB3_78:                               # %if.end451
                                        #   in Loop: Header=BB3_20 Depth=4
...
# %bb.84:                               #   in Loop: Header=BB3_83 Depth=4
	move	$a7, $s0
.LBB3_85:                               #   in Loop: Header=BB3_83 Depth=4
	move	$t1, $t6
	move	$t3, $s3
	b	.LBB3_89
	.p2align	4, , 16
.LBB3_86:                               # %if.else491
                                        #   in Loop: Header=BB3_83 Depth=4
	bne	$a7, $s0, .LBB3_89
# %bb.87:                               # %if.then494
                                        #   in Loop: Header=BB3_83 Depth=4
	blt	$t1, $t6, .LBB3_85
...
.LBB3_89:                               # %if.end508
	...
	sub.w	$fp, $fp, $a3
	bge	$fp, $s0, .LBB3_91
.LBB3_90:                               #   in Loop: Header=BB3_83 Depth=4
	move	$ra, $t0
	move	$s5, $t7
	b	.LBB3_95
	.p2align	4, , 16
...
# %bb.93:                               # %if.else533
	...
	b	.LBB3_95
	.p2align	4, , 16
.LBB3_94:                               #   in Loop: Header=BB3_83 Depth=4
	move	$s0, $fp
.LBB3_95:                               # %if.end543
                                        #   in Loop: Header=BB3_83 Depth=4
	slli.d	$t6, $a2, 3
...
.LBB3_98:                               # %if.then559
	...
	b	.LBB3_100
	.p2align	4, , 16
.LBB3_99:                               #   in Loop: Header=BB3_83 Depth=4
	move	$a5, $zero
.LBB3_100:                              # %if.end565
                                        #   in Loop: Header=BB3_83 Depth=4
	slti	$s3, $a5, 1
...
# %bb.103:                              # %if.else581
	...
	b	.LBB3_105
	.p2align	4, , 16
.LBB3_104:                              #   in Loop: Header=BB3_83 Depth=4
	move	$s1, $t6
	move	$a5, $t4
	move	$fp, $a1
.LBB3_105:                              # %if.end591
...
# %bb.108:                              # %if.else602
	...
	b	.LBB3_110
	.p2align	4, , 16
.LBB3_109:                              #   in Loop: Header=BB3_83 Depth=4
	move	$a1, $s1
	move	$t6, $a5
	move	$s3, $fp
.LBB3_110:                              # %if.end612
...
# %bb.111:                              # %if.then633
	...
	ori	$t4, $zero, 1
	st.b	$t4, $a5, %pc_lo12(flag)
.LBB3_112:                              # %if.end634
                                        #   in Loop: Header=BB3_83 Depth=4
	slli.d	$a5, $s2, 48
	ld.d	$s6, $sp, 232                   # 8-byte Folded Reload
	bnez	$a5, .LBB3_119
# %bb.113:                              # %land.lhs.true636
                                        #   in Loop: Header=BB3_83 Depth=4
	ld.d	$a5, $sp, 216                   # 8-byte Folded Reload
	bge	$a5, $t6, .LBB3_115
# %bb.114:                              # %land.lhs.true636
                                        #   in Loop: Header=BB3_83 Depth=4
	ld.d	$a5, $sp, 200                   # 8-byte Folded Reload
	blt	$a5, $s3, .LBB3_119
.LBB3_115:                              # %lor.lhs.false642
                                        #   in Loop: Header=BB3_83 Depth=4
	ld.d	$a5, $sp, 216                   # 8-byte Folded Reload
	bge	$a5, $ra, .LBB3_117
# %bb.116:                              # %lor.lhs.false642
                                        #   in Loop: Header=BB3_83 Depth=4
	ld.d	$a5, $sp, 200                   # 8-byte Folded Reload
	blt	$a5, $s5, .LBB3_119
.LBB3_117:                              # %lor.lhs.false648
                                        #   in Loop: Header=BB3_83 Depth=4
	move	$s2, $zero
	ld.d	$a5, $sp, 216                   # 8-byte Folded Reload
	bge	$a5, $t1, .LBB3_120
# %bb.118:                              # %lor.lhs.false648
                                        #   in Loop: Header=BB3_83 Depth=4
	ld.d	$a5, $sp, 200                   # 8-byte Folded Reload
	bge	$a5, $t3, .LBB3_120
	.p2align	4, , 16
...
.LBB3_120:                              # %for.inc656
	...
	addi.d	$fp, $a2, -1
	blt	$t5, $a2, .LBB3_83
# %bb.121:                              #   in Loop: Header=BB3_19 Depth=3
	move	$a7, $s8
	b	.LBB3_124
	.p2align	4, , 16
...
# %bb.126:                              # %land.lhs.true684
	...
	ld.d	$a0, $sp, 200                   # 8-byte Folded Reload
	blt	$a0, $s3, .LBB3_131
.LBB3_127:                              # %lor.lhs.false690
                                        #   in Loop: Header=BB3_19 Depth=3
	addi.w	$a0, $ra, 0
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	bge	$a1, $a0, .LBB3_129
# %bb.128:                              # %lor.lhs.false690
                                        #   in Loop: Header=BB3_19 Depth=3
	addi.w	$a0, $s5, 0
	ld.d	$a1, $sp, 200                   # 8-byte Folded Reload
	blt	$a1, $a0, .LBB3_131
.LBB3_129:                              # %lor.lhs.false696
                                        #   in Loop: Header=BB3_19 Depth=3
	move	$a1, $zero
	move	$t7, $t2
	ld.d	$a0, $sp, 216                   # 8-byte Folded Reload
	bge	$a0, $t1, .LBB3_19
# %bb.130:                              # %lor.lhs.false696
                                        #   in Loop: Header=BB3_19 Depth=3
	move	$t7, $t2
	ld.d	$a0, $sp, 200                   # 8-byte Folded Reload
	bge	$a0, $t3, .LBB3_19
...
.LBB3_137:                              # %for.body.i
	...
	blt	$a7, $t0, .LBB3_136
# %bb.138:                              # %land.lhs.true.i
                                        #   in Loop: Header=BB3_137 Depth=2
	ld.w	$a7, $t1, 8
	blt	$s4, $a7, .LBB3_136
# %bb.139:                              # %land.lhs.true3.i
                                        #   in Loop: Header=BB3_137 Depth=2
	ld.w	$t2, $t1, 24
	blt	$t2, $a1, .LBB3_136
# %bb.140:                              # %land.lhs.true5.i
                                        #   in Loop: Header=BB3_137 Depth=2
	ld.w	$t1, $t1, 32
	blt	$t1, $a2, .LBB3_136
# %bb.141:                              # %land.lhs.true8.i
                                        #   in Loop: Header=BB3_137 Depth=2
...
.LBB3_148:                              #   in Loop: Header=BB3_17 Depth=1
	...
	ld.d	$a5, $sp, 64                    # 8-byte Folded Reload
	bne	$a0, $a5, .LBB3_17
.LBB3_149:                              # %for.end715.loopexit528
	addi.d	$a1, $a1, -1
	addi.d	$a2, $a2, -1
.LBB3_150:                              # %for.end715
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
...
# %bb.159:                              #   in Loop: Header=BB3_158 Depth=2
	move	$t0, $a0
.LBB3_160:                              #   in Loop: Header=BB3_158 Depth=2
	move	$t6, $s0
	move	$t7, $a5
	b	.LBB3_164
	.p2align	4, , 16
...
.LBB3_164:                              # %if.end53
	...
	sub.w	$a5, $a5, $a3
	bge	$a5, $a1, .LBB3_166
.LBB3_165:                              #   in Loop: Header=BB3_158 Depth=2
	move	$ra, $t3
	move	$s5, $fp
	ld.d	$a0, $s3, 0
	st.d	$a0, $t8, %pc_lo12(z)
...
# %bb.168:                              # %if.else75
	...
	b	.LBB3_172
	.p2align	4, , 16
.LBB3_169:                              #   in Loop: Header=BB3_158 Depth=2
	move	$a1, $a5
	ld.d	$a0, $s3, 0
	st.d	$a0, $t8, %pc_lo12(z)
	beqz	$a0, .LBB3_172
...
.LBB3_172:                              # %if.then94
	...
	b	.LBB3_174
	.p2align	4, , 16
.LBB3_173:                              #   in Loop: Header=BB3_158 Depth=2
	move	$a0, $zero
.LBB3_174:                              # %if.end100
                                        #   in Loop: Header=BB3_158 Depth=2
	slti	$a5, $a0, 1
...
# %bb.177:                              # %if.else112
	...
	b	.LBB3_179
	.p2align	4, , 16
.LBB3_178:                              #   in Loop: Header=BB3_158 Depth=2
	move	$a6, $s0
	move	$t5, $a0
	move	$s4, $a5
.LBB3_179:                              # %if.end120
...
# %bb.182:                              # %if.else128
	...
	b	.LBB3_184
	.p2align	4, , 16
.LBB3_183:                              #   in Loop: Header=BB3_158 Depth=2
	move	$a0, $a6
	move	$s0, $t5
	move	$a5, $s4
.LBB3_184:                              # %if.end136
...
.LBB4_15:                               # %for.body33.lr.ph
	...
	ld.d	$a0, $sp, 104                   # 8-byte Folded Reload
	ld.w	$a5, $a0, %pc_lo12(numnode)
	ld.d	$t3, $ra, %pc_lo12(most)
	pcalau12i	$a0, %pc_hi20(min)
	st.d	$a0, $sp, 112                   # 8-byte Folded Spill
	ld.w	$t4, $a0, %pc_lo12(min)
	pcalau12i	$a0, %pc_hi20(r)
...
# %bb.75:                               # %if.then65.i
	...
	b	.LBB4_73
	.p2align	4, , 16
.LBB4_76:                               #   in Loop: Header=BB4_11 Depth=1
	move	$t7, $t1
	move	$s1, $a7
	move	$t8, $a5
	blt	$t0, $t8, .LBB4_10
...
# %bb.5:                                # %iter.check
	...
	st.w	$zero, $a0, 0
	ld.d	$a1, $sp, 72                    # 8-byte Folded Reload
	ld.w	$s3, $a1, %pc_lo12(q)
	sub.d	$a3, $zero, $s3
	ld.d	$a1, $sp, 40                    # 8-byte Folded Reload
	ld.d	$a1, $a1, %pc_lo12(DD)
	ld.w	$a6, $t8, %pc_lo12(r)
	addi.d	$a7, $s0, 1
...
.LBB8_16:                               # %for.body174
	...
	sub.d	$t1, $t1, $a6
	bnez	$t3, .LBB8_16
.LBB8_17:                               # %for.body188.lr.ph
                                        #   in Loop: Header=BB8_4 Depth=1
	move	$a6, $zero
	st.d	$s1, $sp, 128                   # 8-byte Folded Spill
	bstrpick.d	$t3, $s1, 31, 1
	st.d	$a4, $sp, 88                    # 8-byte Folded Spill
	sub.d	$a4, $zero, $a4
	ld.w	$t0, $t8, %pc_lo12(r)
	pcalau12i	$a5, %pc_hi20(v)
	st.d	$a5, $sp, 160                   # 8-byte Folded Spill
	ld.d	$t1, $a5, %pc_lo12(v)
...
.LBB8_24:                               # %for.body224
	...
	beq	$a5, $t3, .LBB8_26
# %bb.25:                               # %for.cond221
                                        #   in Loop: Header=BB8_24 Depth=4
	ld.d	$s0, $s0, 8
	st.d	$s0, $s5, %pc_lo12(z)
	bnez	$s0, .LBB8_24
	b	.LBB8_20
	.p2align	4, , 16
.LBB8_26:                               #   in Loop: Header=BB8_22 Depth=3
	move	$s0, $t2
	b	.LBB8_21
	.p2align	4, , 16
.LBB8_27:                               # %for.body271.lr.ph
                                        #   in Loop: Header=BB8_4 Depth=1
	...
	ld.w	$t6, $s6, %pc_lo12(r)
	pcalau12i	$t8, %pc_hi20(SS)
	ld.d	$t1, $t8, %pc_lo12(SS)
	srai.d	$a4, $t0, 63
	and	$a4, $a4, $t0
	nor	$a4, $a4, $zero
	add.w	$a4, $s4, $a4
...
.LBB8_33:                               # %for.body271
	...
	sub.d	$t7, $t7, $t6
	bgtz	$t2, .LBB8_33
.LBB8_34:                               # %for.body285.lr.ph
                                        #   in Loop: Header=BB8_4 Depth=1
	alsl.d	$t6, $s4, $a7, 2
	ld.w	$t7, $s6, %pc_lo12(r)
	ld.d	$a3, $s0, %pc_lo12(v)
	st.d	$a3, $sp, 160                   # 8-byte Folded Spill
	ld.w	$t4, $t4, %pc_lo12(qr)
	ld.w	$a4, $s7, %pc_lo12(J)
	ld.d	$t1, $t3, %pc_lo12(row)
	ld.d	$a3, $sp, 120                   # 8-byte Folded Reload
	ld.w	$t3, $a3, %pc_lo12(I)
	ld.d	$a3, $t8, %pc_lo12(SS)
	addi.d	$t2, $a4, 1
	...
	b	.LBB8_36
	.p2align	4, , 16
.LBB8_35:                               # %for.cond282.loopexit
                                        #   in Loop: Header=BB8_36 Depth=2
	move	$s3, $t5
	ld.d	$a5, $sp, 168                   # 8-byte Folded Reload
	bge	$a5, $s8, .LBB8_44
.LBB8_36:                               # %for.body302.lr.ph
                                        #   Parent Loop BB8_4 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB8_39 Depth 3
                                        #         Child Loop BB8_41 Depth 4
...
# %bb.42:                               # %for.cond323
	...
	b	.LBB8_37
	.p2align	4, , 16
.LBB8_43:                               #   in Loop: Header=BB8_39 Depth=3
	move	$s4, $s0
	b	.LBB8_38
	.p2align	4, , 16
.LBB8_44:                               # %for.body376.preheader
                                        #   in Loop: Header=BB8_4 Depth=1
	ld.w	$a4, $t6, 0
...
.LBB8_70:                               # %if.then5
	...
	sub.d	$a0, $a0, $s1
	st.w	$a0, $a1, -4
.LBB8_71:                               # %if.end7.sink.split
	st.w	$a0, $t4, %pc_lo12(last)
.LBB8_72:                               # %if.end7
	ld.w	$a0, $t8, %pc_lo12(r)
	ld.d	$a1, $sp, 72                    # 8-byte Folded Reload
	ld.w	$a1, $a1, %pc_lo12(q)
	slt	$t7, $zero, $a6
	slt	$a2, $zero, $s1
...
# %bb.84:                               # %if.else108
	...
	st.w	$a1, $a0, 4
	b	.LBB8_87
.LBB8_85:                               # %if.else111.if.end127_crit_edge
	ld.d	$a2, $sp, 32                    # 8-byte Folded Reload
