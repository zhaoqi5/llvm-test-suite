...
.LBB3_148:                              # %iter.check1057
	...
	ori	$a5, $zero, 1
	bltu	$a3, $a4, .LBB3_184
# %bb.149:                              # %vector.memcheck1053
	sub.d	$a4, $a0, $t3
	addi.d	$a4, $a4, 4
	ori	$a6, $zero, 64
	bltu	$a4, $a6, .LBB3_184
# %bb.150:                              # %vector.main.loop.iter.check1059
	ori	$a5, $zero, 16
	lu12i.w	$a4, 287172
	bgeu	$a3, $a5, .LBB3_169
# %bb.151:
...
.LBB3_159:                              # %vector.body1000
	...
	addi.d	$t0, $t0, 32
	bnez	$t2, .LBB3_159
# %bb.160:                              # %middle.block1012
	bne	$a6, $t1, .LBB3_125
	b	.LBB3_127
.LBB3_161:                              # %vector.memcheck1015
	addi.d	$a6, $t3, 4
	alsl.d	$t0, $a3, $t3, 2
	addi.d	$a7, $a0, 8
	sltu	$a7, $a6, $a7
	...
	and	$a7, $a7, $t1
	bnez	$a7, .LBB3_129
# %bb.162:                              # %vector.memcheck1015
	addi.d	$a7, $a1, 4
	sltu	$a7, $a6, $a7
	sltu	$t1, $a1, $t0
	and	$a7, $a7, $t1
	bnez	$a7, .LBB3_129
# %bb.163:                              # %vector.memcheck1015
	addi.d	$a7, $a2, 4
	alsl.d	$t1, $a3, $a2, 2
	sltu	$t1, $a6, $t1
	sltu	$t0, $a7, $t0
...
.LBB3_170:                              # %vector.body1065
	...
	addi.d	$a5, $a5, 64
	bnez	$t0, .LBB3_170
# %bb.171:                              # %middle.block1070
	beq	$a3, $a6, .LBB3_186
# %bb.172:                              # %vec.epilog.iter.check1075
	andi	$a5, $a3, 12
	beqz	$a5, .LBB3_183
.LBB3_173:                              # %vec.epilog.ph1074
	move	$a7, $a3
	...
	vreplgr2vr.w	$vr2, $a4
	.p2align	4, , 16
.LBB3_174:                              # %vec.epilog.vector.body1082
                                        # =>This Inner Loop Header: Depth=1
	vldx	$vr3, $t3, $t0
	vstx	$vr1, $t1, $t0
	...
	addi.d	$t0, $t0, 16
	bnez	$a6, .LBB3_174
# %bb.175:                              # %vec.epilog.middle.block1087
	bne	$a3, $a7, .LBB3_184
	b	.LBB3_186
.LBB3_176:                              # %vector.ph916
...
.LBB3_195:                              # %iter.check1100
	...
	ori	$a1, $zero, 3
	bltu	$a0, $a1, .LBB3_198
# %bb.196:                              # %vector.memcheck1091
                                        #   in Loop: Header=BB3_191 Depth=1
	ld.d	$a1, $sp, 128                   # 8-byte Folded Reload
	add.d	$a0, $a2, $a1
	bgeu	$t2, $a0, .LBB3_209
# %bb.197:                              # %vector.memcheck1091
                                        #   in Loop: Header=BB3_191 Depth=1
	add.d	$a0, $t2, $a1
	bgeu	$a2, $a0, .LBB3_209
...
# %bb.208:                              # %if.then570
	...
	stx.w	$t6, $s2, $a3
	b	.LBB3_202
.LBB3_209:                              # %vector.main.loop.iter.check1102
                                        #   in Loop: Header=BB3_191 Depth=1
	ld.d	$a0, $sp, 240                   # 8-byte Folded Reload
	ori	$a1, $zero, 15
	bgeu	$a0, $a1, .LBB3_211
# %bb.210:                              #   in Loop: Header=BB3_191 Depth=1
	move	$a4, $zero
	b	.LBB3_215
.LBB3_211:                              # %vector.body1106.preheader
                                        #   in Loop: Header=BB3_191 Depth=1
	addi.d	$a0, $t2, 32
	addi.d	$a1, $a2, 32
	ld.d	$a3, $sp, 104                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB3_212:                              # %vector.body1106
                                        #   Parent Loop BB3_191 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	xvld	$xr0, $a1, -32
	xvld	$xr1, $a1, 0
	...
	addi.d	$a1, $a1, 64
	bnez	$a3, .LBB3_212
# %bb.213:                              # %middle.block1115
                                        #   in Loop: Header=BB3_191 Depth=1
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
	ld.d	$a1, $sp, 104                   # 8-byte Folded Reload
	beq	$a0, $a1, .LBB3_200
# %bb.214:                              # %vec.epilog.iter.check1120
                                        #   in Loop: Header=BB3_191 Depth=1
	ld.d	$a4, $sp, 104                   # 8-byte Folded Reload
	ld.d	$a0, $sp, 32                    # 8-byte Folded Reload
	beqz	$a0, .LBB3_218
.LBB3_215:                              # %vec.epilog.ph1119
                                        #   in Loop: Header=BB3_191 Depth=1
	...
	add.d	$a4, $a5, $a4
	.p2align	4, , 16
.LBB3_216:                              # %vec.epilog.vector.body1126
                                        #   Parent Loop BB3_191 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a2, 0
	vld	$vr1, $a3, 0
	...
	addi.d	$a2, $a2, 16
	bnez	$a4, .LBB3_216
# %bb.217:                              # %vec.epilog.middle.block1135
                                        #   in Loop: Header=BB3_191 Depth=1
...
# %bb.258:
	move	$a5, $zero
	b	.LBB3_268
.LBB3_259:                              # %vector.main.loop.iter.check1202
	ori	$a5, $zero, 16
	bgeu	$a4, $a5, .LBB3_261
# %bb.260:
	move	$a5, $zero
	b	.LBB3_265
.LBB3_261:                              # %vector.ph1203
...
.LBB3_262:                              # %vector.body1206
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB3_262
# %bb.263:                              # %middle.block1212
	beq	$a4, $a5, .LBB3_270
# %bb.264:                              # %vec.epilog.iter.check1217
	andi	$a7, $a6, 12
	beqz	$a7, .LBB3_268
.LBB3_265:                              # %vec.epilog.ph1216
	move	$a7, $a5
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB3_266:                              # %vec.epilog.vector.body1224
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a7, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a7, $a7, 16
	bnez	$a6, .LBB3_266
# %bb.267:                              # %vec.epilog.middle.block1229
	beq	$a4, $a5, .LBB3_270
...
.LBB3_287:                              #   in Loop: Header=BB3_272 Depth=1
	move	$fp, $s5
	move	$s0, $s3
.LBB3_288:                              # %while.body.i439.preheader1280
                                        #   in Loop: Header=BB3_272 Depth=1
	move	$s1, $fp
	move	$s2, $s0
	.p2align	4, , 16
...
# %bb.120:                              # %vector.memcheck763
	...
	and	$fp, $fp, $s3
	bnez	$fp, .LBB6_296
# %bb.121:                              # %vector.memcheck763
	alsl.d	$fp, $t1, $a7, 2
	sltu	$s3, $a2, $fp
	sltu	$s2, $a7, $s2
	and	$s2, $s3, $s2
	bnez	$s2, .LBB6_296
# %bb.122:                              # %vector.memcheck763
	sltu	$s2, $a4, $s0
	sltu	$s3, $a5, $s1
	and	$s2, $s2, $s3
	bnez	$s2, .LBB6_296
# %bb.123:                              # %vector.memcheck763
	sltu	$s2, $a4, $t5
	sltu	$s3, $a6, $s1
	and	$s2, $s2, $s3
	bnez	$s2, .LBB6_296
# %bb.124:                              # %vector.memcheck763
	sltu	$s2, $a4, $t4
	sltu	$s3, $t0, $s1
	and	$s2, $s2, $s3
	bnez	$s2, .LBB6_296
# %bb.125:                              # %vector.memcheck763
	sltu	$s2, $a4, $t6
	sltu	$s3, $a0, $s1
	and	$s2, $s2, $s3
	bnez	$s2, .LBB6_296
# %bb.126:                              # %vector.memcheck763
	sltu	$s2, $a4, $t7
	sltu	$s3, $a1, $s1
	and	$s2, $s2, $s3
	bnez	$s2, .LBB6_296
# %bb.127:                              # %vector.memcheck763
	sltu	$s2, $a4, $t8
	sltu	$s3, $a3, $s1
	and	$s2, $s2, $s3
	bnez	$s2, .LBB6_296
# %bb.128:                              # %vector.memcheck763
	sltu	$s2, $a4, $fp
	sltu	$s1, $a7, $s1
	and	$s1, $s2, $s1
	bnez	$s1, .LBB6_296
# %bb.129:                              # %vector.memcheck763
	sltu	$s1, $a5, $t5
	sltu	$s2, $a6, $s0
	and	$s1, $s1, $s2
	bnez	$s1, .LBB6_296
# %bb.130:                              # %vector.memcheck763
	sltu	$s1, $a5, $t4
	sltu	$s2, $t0, $s0
	and	$s1, $s1, $s2
	bnez	$s1, .LBB6_296
# %bb.131:                              # %vector.memcheck763
	sltu	$s1, $a5, $t6
	sltu	$s2, $a0, $s0
	and	$s1, $s1, $s2
	bnez	$s1, .LBB6_296
# %bb.132:                              # %vector.memcheck763
	sltu	$s1, $a5, $t7
	sltu	$s2, $a1, $s0
	and	$s1, $s1, $s2
	bnez	$s1, .LBB6_296
# %bb.133:                              # %vector.memcheck763
	sltu	$s1, $a5, $t8
	sltu	$s2, $a3, $s0
	and	$s1, $s1, $s2
	bnez	$s1, .LBB6_296
# %bb.134:                              # %vector.memcheck763
	sltu	$s1, $a5, $fp
	sltu	$s0, $a7, $s0
	and	$s0, $s1, $s0
	ld.d	$s2, $sp, 72                    # 8-byte Folded Reload
	bnez	$s0, .LBB6_33
# %bb.135:                              # %vector.memcheck763
	sltu	$s0, $a6, $t4
	sltu	$s1, $t0, $t5
	and	$s0, $s0, $s1
	bnez	$s0, .LBB6_33
# %bb.136:                              # %vector.memcheck763
	sltu	$s0, $a6, $t6
	sltu	$s1, $a0, $t5
	and	$s0, $s0, $s1
	bnez	$s0, .LBB6_33
# %bb.137:                              # %vector.memcheck763
	sltu	$s0, $a6, $t7
	sltu	$s1, $a1, $t5
	and	$s0, $s0, $s1
	bnez	$s0, .LBB6_33
# %bb.138:                              # %vector.memcheck763
	sltu	$s0, $a6, $t8
	sltu	$s1, $a3, $t5
	and	$s0, $s0, $s1
	bnez	$s0, .LBB6_33
# %bb.139:                              # %vector.memcheck763
	sltu	$s0, $a6, $fp
	sltu	$t5, $a7, $t5
	and	$t5, $s0, $t5
	bnez	$t5, .LBB6_33
# %bb.140:                              # %vector.memcheck763
	sltu	$t5, $t0, $t6
	sltu	$t6, $a0, $t4
	and	$t5, $t5, $t6
	bnez	$t5, .LBB6_33
# %bb.141:                              # %vector.memcheck763
	sltu	$t5, $t0, $t7
	sltu	$t6, $a1, $t4
	and	$t5, $t5, $t6
	bnez	$t5, .LBB6_33
...
.LBB6_155:                              # %vector.body970
	...
	addi.d	$t1, $t1, 32
	bnez	$t3, .LBB6_155
# %bb.156:                              # %middle.block982
	bne	$a7, $t2, .LBB6_55
	b	.LBB6_57
.LBB6_157:                              # %vector.memcheck985
	addi.d	$a7, $t5, 4
	alsl.d	$t1, $a4, $t5, 2
	addi.d	$t0, $a1, 8
	sltu	$t0, $a7, $t0
	...
	and	$t0, $t0, $t2
	bnez	$t0, .LBB6_59
# %bb.158:                              # %vector.memcheck985
	addi.d	$t0, $a2, 4
	sltu	$t0, $a7, $t0
	sltu	$t2, $a2, $t1
	and	$t0, $t0, $t2
	bnez	$t0, .LBB6_59
# %bb.159:                              # %vector.memcheck985
	addi.d	$t0, $a3, 4
	alsl.d	$t2, $a4, $a3, 2
	sltu	$t2, $a7, $t2
	sltu	$t1, $t0, $t1
...
.LBB6_161:                              # %vector.body1008
	...
	addi.d	$t0, $t0, 32
	bnez	$t2, .LBB6_161
# %bb.162:                              # %middle.block1020
	bne	$a6, $t1, .LBB6_59
	b	.LBB6_61
.LBB6_163:                              # %vector.ph1028
	move	$a6, $zero
	move	$a7, $a4
...
# %bb.232:
	move	$a4, $zero
	b	.LBB6_242
.LBB6_233:                              # %vector.main.loop.iter.check1108
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB6_235
# %bb.234:
	move	$a4, $zero
	b	.LBB6_239
.LBB6_235:                              # %vector.ph1109
	bstrpick.d	$a4, $a5, 31, 4
	slli.d	$a4, $a4, 4
...
.LBB6_236:                              # %vector.body1112
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB6_236
# %bb.237:                              # %middle.block1118
	beq	$a3, $a4, .LBB6_244
# %bb.238:                              # %vec.epilog.iter.check1123
	andi	$a6, $a5, 12
	beqz	$a6, .LBB6_242
.LBB6_239:                              # %vec.epilog.ph1122
	move	$a6, $a4
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB6_240:                              # %vec.epilog.vector.body1130
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a6, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a6, $a6, 16
	bnez	$a5, .LBB6_240
# %bb.241:                              # %vec.epilog.middle.block1135
	beq	$a3, $a4, .LBB6_244
