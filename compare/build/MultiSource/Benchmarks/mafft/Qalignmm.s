...
.LBB3_148:                              # %iter.check1053
	...
	ori	$a5, $zero, 1
	bltu	$a3, $a4, .LBB3_176
# %bb.149:                              # %vector.memcheck1049
	sub.d	$a4, $a0, $t3
	addi.d	$a4, $a4, 4
	ori	$a6, $zero, 64
	bltu	$a4, $a6, .LBB3_176
# %bb.150:                              # %vector.main.loop.iter.check1055
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB3_169
# %bb.151:
	move	$a4, $zero
...
.LBB3_155:                              # %vector.memcheck977
	...
	and	$t0, $t0, $t2
	bnez	$t0, .LBB3_125
# %bb.156:                              # %vector.memcheck977
	addi.d	$t0, $a1, 4
	sltu	$t0, $a7, $t0
	sltu	$t2, $a1, $t1
	and	$t0, $t0, $t2
	bnez	$t0, .LBB3_125
# %bb.157:                              # %vector.memcheck977
	addi.d	$t0, $a3, 4
	alsl.d	$t2, $a4, $a3, 2
	sltu	$t2, $a7, $t2
	sltu	$t1, $t0, $t1
...
.LBB3_159:                              # %vector.body1000
	...
	addi.d	$t0, $t0, 32
	bnez	$t2, .LBB3_159
# %bb.160:                              # %middle.block1010
	bne	$a6, $t1, .LBB3_125
	b	.LBB3_127
.LBB3_161:                              # %vector.memcheck1013
	addi.d	$a6, $t3, 4
	alsl.d	$t0, $a3, $t3, 2
	addi.d	$a7, $a0, 8
	sltu	$a7, $a6, $a7
	...
	and	$a7, $a7, $t1
	bnez	$a7, .LBB3_129
# %bb.162:                              # %vector.memcheck1013
	addi.d	$a7, $a1, 4
	sltu	$a7, $a6, $a7
	sltu	$t1, $a1, $t0
	and	$a7, $a7, $t1
	bnez	$a7, .LBB3_129
# %bb.163:                              # %vector.memcheck1013
	addi.d	$a7, $a2, 4
	alsl.d	$t1, $a3, $a2, 2
	sltu	$t1, $a6, $t1
	sltu	$t0, $a7, $t0
...
.LBB3_170:                              # %vector.body1061
	...
	addi.d	$a6, $a6, 64
	bnez	$t0, .LBB3_170
# %bb.171:                              # %middle.block1066
	beq	$a3, $a4, .LBB3_178
# %bb.172:                              # %vec.epilog.iter.check1070
	beqz	$a5, .LBB3_318
.LBB3_173:                              # %vec.epilog.ph1072
	move	$a6, $a3
...
# %bb.175:                              # %vec.epilog.middle.block1082
	beq	$a3, $a6, .LBB3_178
.LBB3_176:                              # %for.body452.preheader
	slli.d	$a3, $a5, 2
	addi.d	$a4, $t3, -4
	sub.d	$a2, $a2, $a5
	movgr2fr.w	$fa0, $s3
	.p2align	4, , 16
.LBB3_177:                              # %for.body452
                                        # =>This Inner Loop Header: Depth=1
	fldx.s	$fa1, $a4, $a3
	stx.w	$zero, $a1, $a3
...
# %bb.181:                              # %for.body482.lr.ph
	...
	ld.d	$a1, $a1, %pc_lo12(Q__align.ijp)
	...
	.p2align	4, , 16
.LBB3_182:                              # %for.end588
                                        #   in Loop: Header=BB3_183 Depth=1
...
.LBB3_187:                              # %iter.check1095
	...
	ori	$a1, $zero, 3
	bltu	$a0, $a1, .LBB3_190
# %bb.188:                              # %vector.memcheck1086
                                        #   in Loop: Header=BB3_183 Depth=1
	ld.d	$a1, $sp, 152                   # 8-byte Folded Reload
	add.d	$a0, $a2, $a1
	bgeu	$t2, $a0, .LBB3_201
# %bb.189:                              # %vector.memcheck1086
                                        #   in Loop: Header=BB3_183 Depth=1
	add.d	$a0, $t2, $a1
	bgeu	$a2, $a0, .LBB3_201
.LBB3_190:                              #   in Loop: Header=BB3_183 Depth=1
	move	$a0, $a2
	ld.d	$a2, $sp, 240                   # 8-byte Folded Reload
	move	$a1, $t2
	.p2align	4, , 16
.LBB3_191:                              # %while.body.i428
...
# %bb.193:                              # %for.body535.preheader
	...
	.p2align	4, , 16
.LBB3_194:                              # %if.end572
                                        #   in Loop: Header=BB3_195 Depth=2
	fmul.s	$ft2, $fa4, $ft2
	fadd.s	$ft1, $ft1, $ft2
...
# %bb.200:                              # %if.then570
	...
	stx.w	$t7, $s2, $a3
	b	.LBB3_194
.LBB3_201:                              # %vector.main.loop.iter.check1097
                                        #   in Loop: Header=BB3_183 Depth=1
	ld.d	$a0, $sp, 248                   # 8-byte Folded Reload
	ori	$a1, $zero, 15
	bgeu	$a0, $a1, .LBB3_203
# %bb.202:                              #   in Loop: Header=BB3_183 Depth=1
	move	$a4, $zero
	b	.LBB3_207
.LBB3_203:                              # %vector.body1101.preheader
                                        #   in Loop: Header=BB3_183 Depth=1
	addi.d	$a0, $t2, 32
	addi.d	$a1, $a2, 32
	ld.d	$a3, $sp, 128                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB3_204:                              # %vector.body1101
                                        #   Parent Loop BB3_183 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	xvld	$xr0, $a1, -32
	xvld	$xr1, $a1, 0
	...
	addi.d	$a1, $a1, 64
	bnez	$a3, .LBB3_204
# %bb.205:                              # %middle.block1110
                                        #   in Loop: Header=BB3_183 Depth=1
	ld.d	$a0, $sp, 120                   # 8-byte Folded Reload
	ld.d	$a1, $sp, 128                   # 8-byte Folded Reload
	beq	$a0, $a1, .LBB3_192
# %bb.206:                              # %vec.epilog.iter.check1114
                                        #   in Loop: Header=BB3_183 Depth=1
	ld.d	$a4, $sp, 128                   # 8-byte Folded Reload
	ld.d	$a0, $sp, 40                    # 8-byte Folded Reload
	beqz	$a0, .LBB3_210
.LBB3_207:                              # %vec.epilog.ph1116
                                        #   in Loop: Header=BB3_183 Depth=1
	...
	add.d	$a4, $a5, $a4
	.p2align	4, , 16
.LBB3_208:                              # %vec.epilog.vector.body1120
                                        #   Parent Loop BB3_183 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a2, 0
	vld	$vr1, $a3, 0
	...
	addi.d	$a2, $a2, 16
	bnez	$a4, .LBB3_208
# %bb.209:                              # %vec.epilog.middle.block1129
                                        #   in Loop: Header=BB3_183 Depth=1
	...
	bne	$a3, $a4, .LBB3_191
	b	.LBB3_192
.LBB3_210:                              #   in Loop: Header=BB3_183 Depth=1
...
.LBB3_212:                              # %for.end596.loopexit
	...
	ld.d	$s6, $sp, 240                   # 8-byte Folded Reload
	bnez	$a1, .LBB3_227
.LBB3_213:                              # %for.cond599.preheader
	ld.d	$a0, $sp, 448                   # 8-byte Folded Reload
	bnez	$a0, .LBB3_220
# %bb.214:                              # %for.body603.lr.ph
	pcalau12i	$a0, %got_pc_hi20(offset)
	ld.d	$a0, $a0, %got_pc_lo12(offset)
	ld.w	$a0, $a0, 0
	addi.d	$a1, $s6, 1
...
# %bb.215:                              # %vector.ph1140
	...
	xvreplgr2vr.d	$xr3, $s6
	addi.d	$a5, $t3, 4
	xvldi	$xr4, -800
	move	$a6, $a4
	.p2align	4, , 16
.LBB3_216:                              # %vector.body1147
                                        # =>This Inner Loop Header: Depth=1
	xvsub.d	$xr5, $xr3, $xr1
	xvsub.d	$xr6, $xr3, $xr2
	xvpermi.q	$xr7, $xr6, 1
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB3_216
# %bb.217:                              # %middle.block1154
	beq	$a2, $a4, .LBB3_220
.LBB3_218:                              # %for.body603.preheader
	sub.w	$a2, $s6, $a3
	mul.d	$a2, $a0, $a2
	alsl.d	$a4, $a3, $t3, 2
	sub.d	$a1, $a1, $a3
...
.LBB3_219:                              # %for.body603
	...
	addi.d	$a4, $a4, 4
	bnez	$a1, .LBB3_219
.LBB3_220:                              # %for.cond616.preheader
	blez	$s2, .LBB3_227
# %bb.221:                              # %for.body620.lr.ph
...
.LBB3_223:                              # %vector.body1166
	...
	addi.d	$a5, $a5, 16
	bnez	$a6, .LBB3_223
# %bb.224:                              # %middle.block1173
	beq	$a3, $a4, .LBB3_227
.LBB3_225:                              # %for.body620.preheader
	alsl.d	$a1, $a0, $a1, 2
	sub.d	$a2, $a2, $a0
	vldi	$vr2, -800
	.p2align	4, , 16
.LBB3_226:                              # %for.body620
                                        # =>This Inner Loop Header: Depth=1
...
# %bb.231:                              # %for.body.lr.ph.i443
	...
	.p2align	4, , 16
.LBB3_232:                              # %for.inc.i
                                        #   in Loop: Header=BB3_233 Depth=1
	addi.d	$a4, $a4, -1
	addi.d	$a5, $a5, -1
	addi.d	$s3, $s3, 4
	beqz	$a4, .LBB3_235
.LBB3_233:                              # %for.body.i445
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa1, $s3, 0
...
# %bb.234:                              # %if.then16.i
	...
	fmov.s	$fa0, $fa1
	b	.LBB3_232
.LBB3_235:                              # %for.cond24.preheader.i
	blez	$a2, .LBB3_240
# %bb.236:                              # %for.body27.lr.ph.i
	slli.d	$a1, $s7, 32
	srai.d	$a1, $a1, 29
	...
	b	.LBB3_238
	.p2align	4, , 16
.LBB3_237:                              # %for.inc43.i
                                        #   in Loop: Header=BB3_238 Depth=1
	addi.d	$a4, $a4, -1
	addi.d	$a5, $a5, 1
	addi.d	$a7, $a7, 4
	beqz	$a4, .LBB3_240
.LBB3_238:                              # %for.body27.i
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa1, $a7, 0
	fcmp.cult.s	$fcc0, $fa1, $fa0
	bcnez	$fcc0, .LBB3_237
...
.LBB3_244:                              # %vector.body1181
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB3_244
# %bb.245:                              # %middle.block1188
	beq	$a1, $a3, .LBB3_248
.LBB3_246:                              # %for.body51.i.preheader
	alsl.d	$a4, $a3, $s2, 3
	sub.d	$a1, $a1, $a3
	addi.d	$a3, $a3, 1
	.p2align	4, , 16
.LBB3_247:                              # %for.body51.i
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a5, $a4, 0
	st.w	$a3, $a5, 0
	addi.d	$a4, $a4, 8
	...
	addi.d	$a3, $a3, 1
	bnez	$a1, .LBB3_247
.LBB3_248:                              # %for.cond59.preheader.i
	ld.d	$a1, $sp, 576
	bltz	$a2, .LBB3_262
# %bb.249:                              # %iter.check1194
	ld.d	$a3, $s2, 0
...
# %bb.250:
	move	$a5, $zero
	b	.LBB3_260
.LBB3_251:                              # %vector.main.loop.iter.check1196
	ori	$a5, $zero, 16
	bgeu	$a4, $a5, .LBB3_253
# %bb.252:
	move	$a5, $zero
	b	.LBB3_257
.LBB3_253:                              # %vector.ph1197
	andi	$a7, $a6, 12
...
.LBB3_254:                              # %vector.body1200
	...
	addi.d	$t0, $t0, 64
	bnez	$t1, .LBB3_254
# %bb.255:                              # %middle.block1206
	beq	$a4, $a5, .LBB3_262
# %bb.256:                              # %vec.epilog.iter.check1210
	beqz	$a7, .LBB3_260
.LBB3_257:                              # %vec.epilog.ph1212
	move	$a7, $a5
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB3_258:                              # %vec.epilog.vector.body1217
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a7, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a7, $a7, 16
	bnez	$a6, .LBB3_258
# %bb.259:                              # %vec.epilog.middle.block1222
	beq	$a4, $a5, .LBB3_262
.LBB3_260:                              # %for.body63.i.preheader
	alsl.d	$a3, $a5, $a3, 2
	nor	$a6, $a5, $zero
	sub.d	$a4, $a4, $a5
	.p2align	4, , 16
.LBB3_261:                              # %for.body63.i
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a6, $a3, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, -1
...
# %bb.266:                              # %if.then103.i
	...
	add.w	$t7, $s7, $t6
	beqz	$t7, .LBB3_273
.LBB3_267:                              # %while.body.i439.preheader
                                        #   in Loop: Header=BB3_264 Depth=1
	bltu	$t7, $a5, .LBB3_279
# %bb.268:                              # %while.body.i439.preheader
                                        #   in Loop: Header=BB3_264 Depth=1
	sub.d	$t8, $s3, $s5
	bltu	$t8, $a5, .LBB3_279
# %bb.269:                              # %vector.ph1254
                                        #   in Loop: Header=BB3_264 Depth=1
	...
	move	$s5, $s1
	.p2align	4, , 16
.LBB3_270:                              # %vector.body1258
                                        #   Parent Loop BB3_264 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	xvst	$xr3, $s2, 0
	xvst	$xr4, $s3, 0
	addi.d	$s5, $s5, -32
	...
	addi.d	$s3, $s3, -32
	bnez	$s5, .LBB3_270
# %bb.271:                              # %middle.block1265
                                        #   in Loop: Header=BB3_264 Depth=1
	move	$s2, $a0
	bne	$s1, $s0, .LBB3_280
	b	.LBB3_281
	.p2align	4, , 16
.LBB3_272:                              # %if.then89.i
                                        #   in Loop: Header=BB3_264 Depth=1
	addi.d	$t0, $s7, -1
	nor	$t6, $t0, $zero
	add.w	$t7, $s7, $t6
	bnez	$t7, .LBB3_267
	.p2align	4, , 16
.LBB3_273:                              # %while.end.i
                                        #   in Loop: Header=BB3_264 Depth=1
	beq	$t3, $s8, .LBB3_282
.LBB3_274:                              # %while.body122.preheader.i
                                        #   in Loop: Header=BB3_264 Depth=1
	addi.w	$t6, $zero, -17
	nor	$fp, $t3, $zero
	bltu	$t6, $t3, .LBB3_283
# %bb.275:                              # %while.body122.preheader.i
                                        #   in Loop: Header=BB3_264 Depth=1
	sub.d	$t6, $s3, $s5
	bltu	$t6, $a4, .LBB3_283
# %bb.276:                              # %vector.ph1231
                                        #   in Loop: Header=BB3_264 Depth=1
...
# %bb.278:                              # %middle.block1243
	...
	b	.LBB3_286
	.p2align	4, , 16
.LBB3_279:                              #   in Loop: Header=BB3_264 Depth=1
	move	$t8, $s5
	move	$fp, $s3
	.p2align	4, , 16
.LBB3_280:                              # %while.body.i439
                                        #   Parent Loop BB3_264 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.b	$a2, $fp, -1
	addi.d	$fp, $fp, -1
...
.LBB3_281:                              # %while.end.loopexit.i
	...
	move	$s5, $t8
	bne	$t3, $s8, .LBB3_274
.LBB3_282:                              #   in Loop: Header=BB3_264 Depth=1
	move	$t7, $s3
	move	$t6, $s5
	bne	$t1, $ra, .LBB3_287
	b	.LBB3_289
	.p2align	4, , 16
.LBB3_283:                              #   in Loop: Header=BB3_264 Depth=1
	move	$t8, $fp
	move	$t6, $s5
	move	$t7, $s3
.LBB3_284:                              # %while.body122.i.preheader
                                        #   in Loop: Header=BB3_264 Depth=1
	add.d	$a7, $a7, $t8
	.p2align	4, , 16
.LBB3_285:                              # %while.body122.i
                                        #   Parent Loop BB3_264 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.b	$a3, $t7, -1
	addi.d	$t7, $t7, -1
	...
	addi.d	$t6, $t6, -1
	bnez	$t8, .LBB3_285
.LBB3_286:                              # %while.end126.i
                                        #   in Loop: Header=BB3_264 Depth=1
	beq	$t1, $ra, .LBB3_289
.LBB3_287:                              # %while.end126.i
                                        #   in Loop: Header=BB3_264 Depth=1
...
.LBB3_294:
	...
	ld.d	$a0, $sp, 216                   # 8-byte Folded Reload
	blez	$a0, .LBB3_297
.LBB3_295:                              # %for.body152.preheader.i
	ld.d	$fp, $sp, 200                   # 8-byte Folded Reload
	ld.d	$s0, $sp, 216                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB3_296:                              # %for.body152.i
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $s6, 0
	ld.d	$a1, $fp, 0
	move	$a2, $s3
	...
	addi.d	$s6, $s6, 8
	bnez	$s0, .LBB3_296
.LBB3_297:                              # %for.cond160.preheader.i
	ld.d	$s7, $sp, 96                    # 8-byte Folded Reload
	blez	$s7, .LBB3_300
# %bb.298:                              # %for.body163.preheader.i
	ld.d	$fp, $sp, 208                   # 8-byte Folded Reload
	move	$s0, $s7
	.p2align	4, , 16
.LBB3_299:                              # %for.body163.i
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $s4, 0
	ld.d	$a1, $fp, 0
	move	$a2, $s5
	...
	addi.d	$s4, $s4, 8
	bnez	$s0, .LBB3_299
.LBB3_300:                              # %Atracking_localhom.exit
	ld.d	$a0, $sp, 448                   # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 440                   # 8-byte Folded Reload
...
# %bb.303:                              # %if.end650
	ld.d	$s1, $sp, 200                   # 8-byte Folded Reload
	blez	$s0, .LBB3_306
.LBB3_304:                              # %for.body654.lr.ph
	ld.d	$a0, $sp, 184                   # 8-byte Folded Reload
	ld.d	$fp, $a0, %pc_lo12(Q__align.mseq1)
	.p2align	4, , 16
.LBB3_305:                              # %for.body654
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $s1, 0
	ld.d	$a1, $fp, 0
	...
	addi.d	$s1, $s1, 8
	bnez	$s0, .LBB3_305
.LBB3_306:                              # %for.cond663.preheader
	blez	$s7, .LBB3_309
# %bb.307:                              # %for.body666.lr.ph
	ld.d	$a0, $sp, 160                   # 8-byte Folded Reload
	ld.d	$fp, $a0, %pc_lo12(Q__align.mseq2)
	.p2align	4, , 16
.LBB3_308:                              # %for.body666
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $s5, 0
	ld.d	$a1, $fp, 0
	pcaddu18i	$ra, %call36(strcpy)
...
.LBB3_310:                              # %if.then648
	...
	bgtz	$s0, .LBB3_304
	b	.LBB3_306
.LBB3_311:                              # %vector.ph916
	andi	$a2, $s6, 12
	bstrpick.d	$a3, $s6, 31, 4
	slli.d	$a5, $a3, 4
	addi.d	$a3, $t3, 32
	addi.d	$a4, $a1, 32
	move	$a6, $a5
	.p2align	4, , 16
.LBB3_312:                              # %vector.body919
                                        # =>This Inner Loop Header: Depth=1
	xvld	$xr0, $a4, -32
	xvld	$xr1, $a4, 0
	xvld	$xr2, $a3, -32
	...
	addi.d	$a4, $a4, 64
	bnez	$a6, .LBB3_312
# %bb.313:                              # %middle.block927
	beq	$a0, $a5, .LBB3_122
# %bb.314:                              # %vec.epilog.iter.check
	beqz	$a2, .LBB3_319
.LBB3_315:                              # %vec.epilog.ph
	...
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB3_316:                              # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a1, 0
	vld	$vr1, $a7, 0
	vfadd.s	$vr0, $vr0, $vr1
	...
	addi.d	$a1, $a1, 16
	bnez	$a5, .LBB3_316
# %bb.317:                              # %vec.epilog.middle.block
	bne	$a0, $a6, .LBB3_121
	b	.LBB3_122
.LBB3_318:
	addi.d	$a5, $a4, 1
...
.LBB6_24:                               # %if.end176
	...
	addi.w	$a0, $zero, -1
	xvld	$xr19, $sp, 304                 # 32-byte Folded Reload
	fcvt.d.s	$fa0, $ft11
...
.LBB6_151:                              # %vector.memcheck947
	...
	and	$t2, $t2, $t4
	bnez	$t2, .LBB6_295
# %bb.152:                              # %vector.memcheck947
	addi.d	$t2, $a3, 4
	sltu	$t2, $t1, $t2
	sltu	$t4, $a3, $t3
	and	$t2, $t2, $t4
	bnez	$t2, .LBB6_295
# %bb.153:                              # %vector.memcheck947
	addi.d	$t2, $a5, 4
	alsl.d	$t4, $a6, $a5, 2
	sltu	$t4, $t1, $t4
	sltu	$t3, $t2, $t3
...
.LBB6_155:                              # %vector.body970
	...
	addi.d	$t2, $t2, 32
	bnez	$t4, .LBB6_155
# %bb.156:                              # %middle.block980
	ld.d	$t4, $sp, 368                   # 8-byte Folded Reload
	bne	$t0, $t3, .LBB6_122
	b	.LBB6_124
.LBB6_157:                              # %vector.memcheck983
	addi.d	$t0, $t5, 4
	alsl.d	$t2, $a5, $t5, 2
	addi.d	$t1, $a2, 8
	sltu	$t1, $t0, $t1
	...
	and	$t1, $t1, $t3
	bnez	$t1, .LBB6_126
# %bb.158:                              # %vector.memcheck983
	addi.d	$t1, $a3, 4
	sltu	$t1, $t0, $t1
	sltu	$t3, $a3, $t2
	and	$t1, $t1, $t3
	bnez	$t1, .LBB6_126
# %bb.159:                              # %vector.memcheck983
	addi.d	$t1, $a4, 4
	alsl.d	$t3, $a5, $a4, 2
	sltu	$t3, $t0, $t3
	sltu	$t2, $t1, $t2
...
.LBB6_161:                              # %vector.body1006
	...
	addi.d	$t1, $t1, 32
	bnez	$t3, .LBB6_161
# %bb.162:                              # %middle.block1016
	bne	$a7, $t2, .LBB6_126
	b	.LBB6_128
.LBB6_163:                              # %vector.ph1024
	move	$t0, $zero
	andi	$a7, $a5, 12
	move	$a6, $a5
...
.LBB6_164:                              # %vector.body1029
	...
	addi.d	$t0, $t0, 64
	bnez	$t2, .LBB6_164
# %bb.165:                              # %middle.block1034
	bne	$a5, $a6, .LBB6_167
# %bb.166:
	move	$t3, $zero
	ld.d	$t4, $sp, 368                   # 8-byte Folded Reload
	b	.LBB6_174
.LBB6_167:                              # %vec.epilog.iter.check
	ld.d	$t4, $sp, 368                   # 8-byte Folded Reload
	beqz	$a7, .LBB6_296
...
# %bb.232:
	move	$a4, $zero
	b	.LBB6_242
.LBB6_233:                              # %vector.main.loop.iter.check1104
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB6_235
# %bb.234:
	move	$a4, $zero
	b	.LBB6_239
.LBB6_235:                              # %vector.ph1105
	andi	$a6, $a5, 12
	bstrpick.d	$a4, $a5, 31, 4
	slli.d	$a4, $a4, 4
...
.LBB6_236:                              # %vector.body1108
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB6_236
# %bb.237:                              # %middle.block1114
	beq	$a3, $a4, .LBB6_244
# %bb.238:                              # %vec.epilog.iter.check1118
	beqz	$a6, .LBB6_242
.LBB6_239:                              # %vec.epilog.ph1120
	move	$a6, $a4
	pcalau12i	$a4, %pc_hi20(.LCPI6_7)
	vld	$vr0, $a4, %pc_lo12(.LCPI6_7)
	bstrpick.d	$a4, $a5, 31, 2
	slli.d	$a4, $a4, 2
	vreplgr2vr.w	$vr1, $a6
	vor.v	$vr0, $vr1, $vr0
