...
# %bb.28:                               # %middle.block
	beq	$a1, $s0, .LBB37_31
.LBB37_29:                              # %for.body205.preheader291
	addi.d	$a2, $sp, 16
	alsl.d	$a2, $a1, $a2, 3
	sub.d	$a1, $s0, $a1
	lu52i.d	$a3, $zero, 1023
...
.LBB37_63:                              # %vector.body282
	...
	addi.d	$a1, $a1, 64
	bnez	$a2, .LBB37_63
# %bb.64:                               # %middle.block286
	beq	$a0, $s0, .LBB37_67
.LBB37_65:                              # %for.body268.preheader290
...
# %bb.22:                               # %iter.check257
	...
	ori	$a3, $zero, 4
	bltu	$a6, $a3, .LBB66_34
# %bb.23:                               # %vector.main.loop.iter.check259
                                        #   in Loop: Header=BB66_19 Depth=4
...
.LBB66_26:                              # %vector.body267
	...
	addi.d	$t0, $t0, 64
	bnez	$t1, .LBB66_26
# %bb.27:                               # %middle.block274
                                        #   in Loop: Header=BB66_19 Depth=4
	beq	$a6, $a3, .LBB66_18
# %bb.28:                               # %vec.epilog.iter.check280
                                        #   in Loop: Header=BB66_19 Depth=4
	andi	$t0, $a3, 12
	beqz	$t0, .LBB66_33
.LBB66_29:                              # %vec.epilog.ph279
                                        #   in Loop: Header=BB66_19 Depth=4
	...
	sub.d	$a5, $a6, $t0
	.p2align	4, , 16
.LBB66_30:                              # %vec.epilog.vector.body290
                                        #   Parent Loop BB66_5 Depth=1
                                        #     Parent Loop BB66_7 Depth=2
                                        #       Parent Loop BB66_9 Depth=3
                                        #         Parent Loop BB66_19 Depth=4
	...
	addi.d	$a4, $a4, 16
	bnez	$a5, .LBB66_30
# %bb.31:                               # %vec.epilog.middle.block297
                                        #   in Loop: Header=BB66_19 Depth=4
	bne	$t0, $a3, .LBB66_34
	b	.LBB66_18
