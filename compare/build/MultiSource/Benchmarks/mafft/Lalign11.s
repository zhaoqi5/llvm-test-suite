...
.LBB0_35:                               # %for.body113
	...
	fst.s	$fa3, $t0, 0
	beqz	$s2, .LBB0_38
# %bb.36:                               # %while.body.i130.preheader
                                        #   in Loop: Header=BB0_35 Depth=1
...
.LBB0_37:                               # %while.body.i130
	...
	move	$t4, $t8
	bnez	$t6, .LBB0_37
.LBB0_38:                               # %match_calc.exit141
                                        #   in Loop: Header=BB0_35 Depth=1
	slli.d	$s5, $t2, 2
	fldx.s	$fa3, $a1, $s5
	fst.s	$fa3, $a2, 0
	bnez	$a4, .LBB0_34
# %bb.39:                               # %for.body131.preheader
                                        #   in Loop: Header=BB0_35 Depth=1
	slli.d	$t0, $t2, 3
...
# %bb.52:
	move	$a2, $zero
	b	.LBB0_56
.LBB0_53:                               # %vector.ph214
	bstrpick.d	$a2, $a2, 31, 2
	slli.d	$a2, $a2, 2
	addi.d	$a3, $t3, 16
	move	$a4, $a2
	.p2align	4, , 16
.LBB0_54:                               # %vector.body217
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a5, $a3, -16
	ld.d	$a6, $a3, -8
	ld.d	$a7, $a3, 0
	...
	addi.d	$a3, $a3, 32
	bnez	$a4, .LBB0_54
# %bb.55:                               # %middle.block222
	beq	$a1, $a2, .LBB0_58
.LBB0_56:                               # %for.body.i.preheader
	sub.d	$a1, $a1, $a2
	alsl.d	$a2, $a2, $t3, 3
	.p2align	4, , 16
.LBB0_57:                               # %for.body.i
	...
	addi.d	$a2, $a2, 8
	bnez	$a1, .LBB0_57
.LBB0_58:                               # %for.cond7.preheader.i
	addi.w	$a1, $a0, 0
	ld.d	$s4, $sp, 16                    # 8-byte Folded Reload
	bltz	$a1, .LBB0_66
# %bb.59:                               # %for.body11.lr.ph.i
	ld.d	$a1, $t3, 0
	addi.d	$a3, $a0, 1
...
.LBB0_62:                               # %vector.body230
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB0_62
# %bb.63:                               # %middle.block233
	beq	$a2, $a3, .LBB0_66
.LBB0_64:                               # %for.body11.i.preheader
	sub.d	$a2, $a2, $a3
	alsl.d	$a1, $a3, $a1, 2
	.p2align	4, , 16
.LBB0_65:                               # %for.body11.i
                                        # =>This Inner Loop Header: Depth=1
	st.w	$s7, $a1, 0
	addi.d	$a2, $a2, -1
	addi.d	$a1, $a1, 4
...
.LBB0_76:                               # %while.end.i
	...
	add.w	$a6, $a5, $s3
	beq	$a5, $a1, .LBB0_79
# %bb.77:                               # %while.body72.preheader.i
                                        #   in Loop: Header=BB0_68 Depth=1
	nor	$a5, $a5, $zero
	.p2align	4, , 16
.LBB0_78:                               # %while.body72.i
                                        #   Parent Loop BB0_68 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a7, $s2, 0
	addi.d	$t0, $a7, -1
