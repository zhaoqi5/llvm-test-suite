...
# %bb.59:
	move	$a2, $zero
	b	.LBB0_63
.LBB0_60:                               # %vector.ph213
	bstrpick.d	$a2, $a2, 31, 3
	slli.d	$a2, $a2, 3
	addi.d	$a3, $t4, 32
	move	$a4, $a2
	.p2align	4, , 16
.LBB0_61:                               # %vector.body216
                                        # =>This Inner Loop Header: Depth=1
	xvld	$xr0, $a3, -32
	xvld	$xr1, $a3, 0
...
# %bb.67:
	move	$a3, $zero
	b	.LBB0_77
.LBB0_68:                               # %vector.main.loop.iter.check229
	ori	$a3, $zero, 16
	bgeu	$a2, $a3, .LBB0_70
# %bb.69:
	move	$a3, $zero
	b	.LBB0_74
.LBB0_70:                               # %vector.ph230
...
.LBB0_71:                               # %vector.body233
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB0_71
# %bb.72:                               # %middle.block236
	beq	$a2, $a3, .LBB0_79
# %bb.73:                               # %vec.epilog.iter.check241
	andi	$a5, $a4, 12
	beqz	$a5, .LBB0_77
.LBB0_74:                               # %vec.epilog.ph240
	move	$a5, $a3
	...
	alsl.d	$a5, $a5, $a1, 2
	.p2align	4, , 16
.LBB0_75:                               # %vec.epilog.vector.body248
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a5, 0
	addi.d	$a4, $a4, 4
	addi.d	$a5, $a5, 16
	bnez	$a4, .LBB0_75
# %bb.76:                               # %vec.epilog.middle.block251
	beq	$a2, $a3, .LBB0_79
