...
# %bb.56:                               # %iter.check298
	...
	ori	$a7, $zero, 63
	bgeu	$a7, $a6, .LBB0_72
# %bb.57:                               # %vector.main.loop.iter.check300
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB0_65
# %bb.58:
	move	$a4, $zero
...
.LBB0_66:                               # %vector.body304
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB0_66
# %bb.67:                               # %middle.block307
	beq	$a3, $a4, .LBB0_74
# %bb.68:                               # %vec.epilog.iter.check312
	andi	$a6, $a5, 12
	beqz	$a6, .LBB0_72
.LBB0_69:                               # %vec.epilog.ph311
	move	$a7, $a4
	...
	alsl.d	$a7, $a7, $a1, 2
	.p2align	4, , 16
.LBB0_70:                               # %vec.epilog.vector.body319
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a7, 0
	vst	$vr0, $a6, 0
	addi.d	$a5, $a5, 4
	...
	addi.d	$a7, $a7, 16
	bnez	$a5, .LBB0_70
# %bb.71:                               # %vec.epilog.middle.block322
	beq	$a3, $a4, .LBB0_74
