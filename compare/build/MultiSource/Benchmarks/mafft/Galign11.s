...
# %bb.41:                               # %iter.check237
	...
	ori	$t1, $zero, 3
	bgeu	$t1, $t0, .LBB0_54
# %bb.42:                               # %vector.main.loop.iter.check239
	ori	$t1, $zero, 16
	bgeu	$t0, $t1, .LBB0_46
# %bb.43:
	move	$t1, $zero
...
# %bb.48:                               # %middle.block250
	beq	$t0, $t1, .LBB0_56
# %bb.49:                               # %vec.epilog.iter.check255
	andi	$t2, $t0, 12
	beqz	$t2, .LBB0_53
.LBB0_50:                               # %vec.epilog.ph254
	move	$t3, $t0
	bstrins.d	$t3, $zero, 1, 0
	ori	$t4, $zero, 1
	move	$t2, $t0
	...
	sub.d	$t1, $t1, $t3
	.p2align	4, , 16
.LBB0_51:                               # %vec.epilog.vector.body262
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $t4, 0
	vfadd.s	$vr2, $vr2, $vr1
	vst	$vr2, $t4, 0
	...
	addi.d	$t4, $t4, 16
	bnez	$t1, .LBB0_51
# %bb.52:                               # %vec.epilog.middle.block267
	bne	$t0, $t3, .LBB0_54
	b	.LBB0_56
.LBB0_53:
	addi.d	$t2, $t1, 1
...
.LBB0_55:                               # %for.body126
	...
	addi.d	$t0, $t0, 4
	bnez	$a2, .LBB0_55
.LBB0_56:                               # %iter.check273
	ld.d	$t1, $s6, %pc_lo12(G__align11.m)
	ld.d	$a2, $sp, 104                   # 8-byte Folded Reload
	ld.d	$t2, $a2, %pc_lo12(G__align11.mp)
...
# %bb.57:                               # %vector.memcheck
	...
	ori	$t5, $zero, 64
	bltu	$t4, $t5, .LBB0_68
# %bb.58:                               # %vector.main.loop.iter.check275
	ori	$a2, $zero, 16
	bgeu	$t3, $a2, .LBB0_60
# %bb.59:
	move	$t4, $zero
	b	.LBB0_64
.LBB0_60:                               # %vector.ph276
	move	$t4, $t3
...
.LBB0_61:                               # %vector.body279
	...
	addi.d	$t6, $t6, 64
	bnez	$t7, .LBB0_61
# %bb.62:                               # %middle.block284
	beq	$t3, $t4, .LBB0_70
# %bb.63:                               # %vec.epilog.iter.check289
	andi	$a2, $t3, 12
	beqz	$a2, .LBB0_67
.LBB0_64:                               # %vec.epilog.ph288
	move	$t5, $t3
	...
	vrepli.b	$vr1, 0
	.p2align	4, , 16
.LBB0_65:                               # %vec.epilog.vector.body294
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $t6, 0
	vst	$vr2, $t7, 0
	vst	$vr1, $t8, 0
	...
	addi.d	$t8, $t8, 16
	bnez	$t4, .LBB0_65
# %bb.66:                               # %vec.epilog.middle.block299
	bne	$t3, $t5, .LBB0_68
	b	.LBB0_70
.LBB0_67:
	addi.d	$a2, $t4, 1
...
# %bb.96:
	move	$a3, $zero
	b	.LBB0_106
.LBB0_97:                               # %vector.main.loop.iter.check320
	ori	$a3, $zero, 16
	bgeu	$a2, $a3, .LBB0_99
# %bb.98:
	move	$a3, $zero
	b	.LBB0_103
.LBB0_99:                               # %vector.ph321
...
.LBB0_100:                              # %vector.body324
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB0_100
# %bb.101:                              # %middle.block330
	beq	$a2, $a3, .LBB0_108
# %bb.102:                              # %vec.epilog.iter.check335
	andi	$a5, $a4, 12
	beqz	$a5, .LBB0_106
.LBB0_103:                              # %vec.epilog.ph334
	move	$a5, $a3
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB0_104:                              # %vec.epilog.vector.body342
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a5, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a5, $a5, 16
	bnez	$a4, .LBB0_104
# %bb.105:                              # %vec.epilog.middle.block347
	beq	$a2, $a3, .LBB0_108
...
# %bb.32:                               # %iter.check186
	...
	ori	$t2, $zero, 3
	bgeu	$t2, $t1, .LBB1_45
# %bb.33:                               # %vector.main.loop.iter.check188
	ori	$t2, $zero, 16
	bgeu	$t1, $t2, .LBB1_37
# %bb.34:
	move	$t2, $zero
...
.LBB1_38:                               # %vector.body194
	...
	addi.d	$t3, $t3, 64
	bnez	$t4, .LBB1_38
# %bb.39:                               # %middle.block199
	beq	$t1, $t2, .LBB1_47
# %bb.40:                               # %vec.epilog.iter.check204
	andi	$t3, $t1, 12
	beqz	$t3, .LBB1_44
.LBB1_41:                               # %vec.epilog.ph203
	move	$t4, $t1
	bstrins.d	$t4, $zero, 1, 0
	ori	$t5, $zero, 1
	move	$t3, $t1
	...
	sub.d	$t2, $t2, $t4
	.p2align	4, , 16
.LBB1_42:                               # %vec.epilog.vector.body211
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $t5, 0
	vfadd.s	$vr2, $vr2, $vr0
	vst	$vr2, $t5, 0
	...
	addi.d	$t5, $t5, 16
	bnez	$t2, .LBB1_42
# %bb.43:                               # %vec.epilog.middle.block216
	bne	$t1, $t4, .LBB1_45
	b	.LBB1_47
.LBB1_44:
	addi.d	$t3, $t2, 1
...
# %bb.48:                               # %vector.memcheck
	...
	ori	$t5, $zero, 64
	bltu	$t4, $t5, .LBB1_59
# %bb.49:                               # %vector.main.loop.iter.check224
	ori	$t3, $zero, 16
	bgeu	$t2, $t3, .LBB1_51
# %bb.50:
	move	$t4, $zero
	b	.LBB1_55
.LBB1_51:                               # %vector.ph225
	move	$t4, $t2
	bstrins.d	$t4, $zero, 3, 0
	addi.d	$t3, $t1, 36
	addi.d	$t5, $a0, 32
