...
.LBB0_31:                               # %for.body
	...
	addi.d	$t0, $t0, 4
	bnez	$a2, .LBB0_31
.LBB0_32:                               # %for.cond122.preheader
	blez	$s4, .LBB0_47
# %bb.33:                               # %for.body126.preheader
...
.LBB0_35:                               # %vector.body234
	...
	addi.d	$t3, $t3, 32
	bnez	$t4, .LBB0_35
# %bb.36:                               # %middle.block240
	beq	$t0, $t2, .LBB0_40
.LBB0_37:                               # %for.body126.preheader284
	alsl.d	$t0, $t1, $a4, 2
	sub.d	$a2, $a2, $t1
	.p2align	4, , 16
.LBB0_38:                               # %for.body126
...
# %bb.50:                               # %for.body166.lr.ph
	...
	b	.LBB0_53
	.p2align	4, , 16
.LBB0_51:                               # %match_calc.exit153.thread
...
.LBB0_53:                               # %for.body166
	...
	slli.d	$a4, $t3, 2
	beqz	$s4, .LBB0_51
# %bb.54:                               # %while.body.i142.preheader
                                        #   in Loop: Header=BB0_53 Depth=1
	ldx.b	$a2, $a0, $t3
	slli.d	$a2, $a2, 9
...
.LBB0_55:                               # %while.body.i142
	...
	move	$t6, $s1
	bnez	$t7, .LBB0_55
# %bb.56:                               # %match_calc.exit153
                                        #   in Loop: Header=BB0_53 Depth=1
	fldx.s	$fa2, $a1, $a4
	fst.s	$fa2, $t4, 0
	blez	$s4, .LBB0_52
# %bb.57:                               # %for.body184.preheader
                                        #   in Loop: Header=BB0_53 Depth=1
	slli.d	$a2, $t3, 3
	ldx.d	$a2, $s6, $a2
	move	$t6, $zero
...
.LBB0_68:                               # %vector.body262
	...
	addi.d	$a3, $a3, 32
	bnez	$a4, .LBB0_68
# %bb.69:                               # %middle.block267
	beq	$a1, $a2, .LBB0_72
.LBB0_70:                               # %for.body.i.preheader
	alsl.d	$a3, $a2, $s6, 3
	sub.d	$a1, $a1, $a2
	addi.d	$a2, $a2, 1
	.p2align	4, , 16
.LBB0_71:                               # %for.body.i
	...
	addi.d	$a2, $a2, 1
	bnez	$a1, .LBB0_71
.LBB0_72:                               # %for.cond8.preheader.i
	addi.w	$a1, $a0, 0
	bltz	$a1, .LBB0_80
# %bb.73:                               # %for.body12.lr.ph.i
	ld.d	$a1, $s6, 0
	addi.d	$a3, $a0, 1
...
.LBB0_76:                               # %vector.body275
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB0_76
# %bb.77:                               # %middle.block281
	beq	$a2, $a3, .LBB0_80
.LBB0_78:                               # %for.body12.i.preheader
	alsl.d	$a1, $a3, $a1, 2
	nor	$a4, $a3, $zero
	sub.d	$a2, $a2, $a3
	.p2align	4, , 16
.LBB0_79:                               # %for.body12.i
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a4, $a1, 0
	addi.d	$a1, $a1, 4
	addi.d	$a2, $a2, -1
...
.LBB0_80:                               # %for.end19.i
	...
	stx.b	$zero, $a2, $a1
	bltz	$a1, .LBB0_96
# %bb.81:                               # %for.body33.i.preheader
	move	$a3, $zero
	addi.w	$a2, $zero, -1
	ori	$a4, $zero, 45
	.p2align	4, , 16
.LBB0_82:                               # %for.body33.i
                                        # =>This Loop Header: Depth=1
...
.LBB0_90:                               # %while.end.i
	...
	add.w	$a0, $t0, $a0
	beq	$t0, $a2, .LBB0_93
# %bb.91:                               # %while.body76.preheader.i
                                        #   in Loop: Header=BB0_82 Depth=1
	nor	$t0, $t0, $zero
	.p2align	4, , 16
.LBB0_92:                               # %while.body76.i
                                        #   Parent Loop BB0_82 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$t1, $s4, 0
	addi.d	$t2, $t1, -1
...
.LBB1_21:                               # %for.body
	...
	addi.d	$t1, $t1, 4
	bnez	$t0, .LBB1_21
.LBB1_22:                               # %for.cond80.preheader
	blez	$s1, .LBB1_37
# %bb.23:                               # %for.body84.preheader
...
.LBB1_25:                               # %vector.body179
	...
	addi.d	$t4, $t4, 32
	bnez	$t5, .LBB1_25
# %bb.26:                               # %middle.block185
	beq	$t1, $t3, .LBB1_30
.LBB1_27:                               # %for.body84.preheader202
	alsl.d	$t1, $t2, $a0, 2
	sub.d	$t0, $t0, $t2
	.p2align	4, , 16
.LBB1_28:                               # %for.body84
...
.LBB1_33:                               # %vector.body193
	...
	addi.d	$t6, $t6, 32
	bnez	$t7, .LBB1_33
# %bb.34:                               # %middle.block199
	beq	$t3, $t4, .LBB1_38
.LBB1_35:                               # %for.body96.preheader
	alsl.d	$t3, $t2, $a0, 2
	addi.d	$t3, $t3, -4
	alsl.d	$t0, $t2, $t0, 2
	sub.d	$t1, $t1, $t2
...
# %bb.40:                               # %for.body121.lr.ph
	...
	b	.LBB1_43
	.p2align	4, , 16
.LBB1_41:                               # %match_calc_mtx.exit127.thread
...
.LBB1_43:                               # %for.body121
	...
	fst.s	$fa3, $t3, 0
	beqz	$s1, .LBB1_41
# %bb.44:                               # %while.body.i116.preheader
                                        #   in Loop: Header=BB1_43 Depth=1
	ldx.b	$a4, $a3, $t2
	slli.d	$a4, $a4, 9
	add.d	$a4, $fp, $a4
...
.LBB1_45:                               # %while.body.i116
	...
	move	$t5, $t8
	bnez	$t6, .LBB1_45
# %bb.46:                               # %match_calc_mtx.exit127
                                        #   in Loop: Header=BB1_43 Depth=1
	fld.s	$fa3, $t4, 0
	fst.s	$fa3, $a0, 0
	blez	$s1, .LBB1_42
# %bb.47:                               # %for.body135.preheader
                                        #   in Loop: Header=BB1_43 Depth=1
	fld.s	$fa3, $t3, 0
	addi.d	$a4, $a0, 4
	move	$t4, $t1
