...
# %bb.41:                               # %iter.check234
	...
	ori	$t1, $zero, 3
	bgeu	$t1, $t0, .LBB0_54
# %bb.42:                               # %vector.main.loop.iter.check236
	ori	$t1, $zero, 16
	bgeu	$t0, $t1, .LBB0_46
# %bb.43:
	move	$t1, $zero
...
.LBB0_47:                               # %vector.body242
	...
	addi.d	$t2, $t2, 64
	bnez	$t3, .LBB0_47
# %bb.48:                               # %middle.block247
	beq	$t0, $t1, .LBB0_56
# %bb.49:                               # %vec.epilog.iter.check252
	andi	$t2, $t0, 12
	beqz	$t2, .LBB0_53
.LBB0_50:                               # %vec.epilog.ph251
	move	$t3, $t0
	bstrins.d	$t3, $zero, 1, 0
	ori	$t4, $zero, 1
	move	$t2, $t0
	...
	sub.d	$t1, $t1, $t3
	.p2align	4, , 16
.LBB0_51:                               # %vec.epilog.vector.body259
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $t4, 0
	vfadd.s	$vr2, $vr2, $vr1
	vst	$vr2, $t4, 0
	...
	addi.d	$t4, $t4, 16
	bnez	$t1, .LBB0_51
# %bb.52:                               # %vec.epilog.middle.block264
	bne	$t0, $t3, .LBB0_54
	b	.LBB0_56
.LBB0_53:
	addi.d	$t2, $t1, 1
...
# %bb.57:                               # %vector.memcheck
	...
	ori	$t5, $zero, 64
	bltu	$t4, $t5, .LBB0_68
# %bb.58:                               # %vector.main.loop.iter.check272
	ori	$a2, $zero, 16
	bgeu	$t3, $a2, .LBB0_60
# %bb.59:
	move	$t4, $zero
	b	.LBB0_64
.LBB0_60:                               # %vector.ph273
	move	$t4, $t3
...
.LBB0_61:                               # %vector.body276
	...
	addi.d	$t6, $t6, 64
	bnez	$t7, .LBB0_61
# %bb.62:                               # %middle.block281
	beq	$t3, $t4, .LBB0_70
# %bb.63:                               # %vec.epilog.iter.check286
	andi	$a2, $t3, 12
	beqz	$a2, .LBB0_67
.LBB0_64:                               # %vec.epilog.ph285
	move	$t5, $t3
	...
	vrepli.b	$vr1, 0
	.p2align	4, , 16
.LBB0_65:                               # %vec.epilog.vector.body291
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $t6, 0
	vst	$vr2, $t7, 0
	vst	$vr1, $t8, 0
	...
	addi.d	$t8, $t8, 16
	bnez	$t4, .LBB0_65
# %bb.66:                               # %vec.epilog.middle.block296
	bne	$t3, $t5, .LBB0_68
	b	.LBB0_70
.LBB0_67:
	addi.d	$a2, $t4, 1
...
# %bb.96:
	move	$a3, $zero
	b	.LBB0_106
.LBB0_97:                               # %vector.main.loop.iter.check317
	ori	$a3, $zero, 16
	bgeu	$a2, $a3, .LBB0_99
# %bb.98:
	move	$a3, $zero
	b	.LBB0_103
.LBB0_99:                               # %vector.ph318
...
.LBB0_100:                              # %vector.body321
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB0_100
# %bb.101:                              # %middle.block327
	beq	$a2, $a3, .LBB0_108
# %bb.102:                              # %vec.epilog.iter.check332
	andi	$a5, $a4, 12
	beqz	$a5, .LBB0_106
.LBB0_103:                              # %vec.epilog.ph331
	move	$a5, $a3
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB0_104:                              # %vec.epilog.vector.body339
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a5, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a5, $a5, 16
	bnez	$a4, .LBB0_104
# %bb.105:                              # %vec.epilog.middle.block344
	beq	$a2, $a3, .LBB0_108
