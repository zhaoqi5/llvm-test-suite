...
.LBB0_17:                               # %if.end113
	...
	st.d	$s2, $a2, %pc_lo12(G__align11.ijp)
...
# %bb.39:                               # %iter.check238
	...
	ori	$t2, $zero, 1
	bltu	$a2, $t1, .LBB0_51
# %bb.40:                               # %vector.main.loop.iter.check240
	ori	$t1, $zero, 16
	bgeu	$a2, $t1, .LBB0_44
# %bb.41:
	move	$t1, $zero
...
.LBB0_45:                               # %vector.body246
	...
	addi.d	$t3, $t3, 64
	bnez	$t4, .LBB0_45
# %bb.46:                               # %middle.block251
	beq	$a2, $t1, .LBB0_53
# %bb.47:                               # %vec.epilog.iter.check255
	beqz	$t2, .LBB0_126
.LBB0_48:                               # %vec.epilog.ph257
	move	$t3, $a2
	bstrins.d	$t3, $zero, 1, 0
	ori	$t4, $zero, 1
	move	$t2, $a2
	...
	sub.d	$t1, $t1, $t3
	.p2align	4, , 16
.LBB0_49:                               # %vec.epilog.vector.body262
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $t4, 0
	vfadd.s	$vr2, $vr2, $vr1
	vst	$vr2, $t4, 0
	...
	addi.d	$t4, $t4, 16
	bnez	$t1, .LBB0_49
# %bb.50:                               # %vec.epilog.middle.block267
	beq	$a2, $t3, .LBB0_53
.LBB0_51:                               # %for.body126.preheader
	alsl.d	$a2, $t2, $a4, 2
	sub.d	$t0, $t0, $t2
	.p2align	4, , 16
.LBB0_52:                               # %for.body126
...
# %bb.54:                               # %vector.memcheck
	...
	ori	$t5, $zero, 64
	bltu	$t4, $t5, .LBB0_64
# %bb.55:                               # %vector.main.loop.iter.check275
	ori	$a2, $zero, 16
	bgeu	$t3, $a2, .LBB0_57
# %bb.56:
	move	$t4, $zero
	b	.LBB0_61
.LBB0_57:                               # %vector.ph276
	andi	$a2, $t3, 12
	move	$t4, $t3
...
.LBB0_58:                               # %vector.body279
	...
	addi.d	$t7, $t7, 64
	bnez	$t8, .LBB0_58
# %bb.59:                               # %middle.block284
	beq	$t3, $t4, .LBB0_66
# %bb.60:                               # %vec.epilog.iter.check288
	beqz	$a2, .LBB0_127
.LBB0_61:                               # %vec.epilog.ph290
	move	$t5, $t3
	...
	vrepli.b	$vr1, 0
	.p2align	4, , 16
.LBB0_62:                               # %vec.epilog.vector.body293
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $t6, 0
	vst	$vr2, $t7, 0
	vst	$vr1, $t8, 0
	...
	addi.d	$t8, $t8, 16
	bnez	$t4, .LBB0_62
# %bb.63:                               # %vec.epilog.middle.block298
	beq	$t3, $t5, .LBB0_66
.LBB0_64:                               # %for.body138.preheader
	alsl.d	$t3, $a2, $a4, 2
	addi.d	$t3, $t3, -4
	alsl.d	$t0, $a2, $t0, 2
	alsl.d	$t1, $a2, $t1, 2
...
.LBB0_67:                               # %if.end157
	...
	ld.d	$a7, $a3, %pc_lo12(G__align11.lastverticalw)
	sltu	$a2, $zero, $a2
	add.w	$t0, $a2, $s1
	ori	$a2, $zero, 2
	fst.s	$fa1, $a7, 0
	blt	$t0, $a2, .LBB0_81
# %bb.68:                               # %for.body166.lr.ph
	movgr2fr.w	$fa1, $s8
	ffint.s.w	$fa1, $fa1
	...
	b	.LBB0_71
	.p2align	4, , 16
.LBB0_69:                               # %match_calc.exit153.thread
...
.LBB0_71:                               # %for.body166
	...
	slli.d	$a4, $t3, 2
	beqz	$s4, .LBB0_69
# %bb.72:                               # %while.body.i142.preheader
                                        #   in Loop: Header=BB0_71 Depth=1
	ldx.b	$a2, $a0, $t3
	slli.d	$a2, $a2, 9
	ld.d	$a3, $sp, 136                   # 8-byte Folded Reload
...
.LBB0_73:                               # %while.body.i142
	...
	move	$t6, $s1
	bnez	$t7, .LBB0_73
# %bb.74:                               # %match_calc.exit153
                                        #   in Loop: Header=BB0_71 Depth=1
	fldx.s	$fa2, $a1, $a4
	fst.s	$fa2, $t4, 0
	blez	$s4, .LBB0_70
# %bb.75:                               # %for.body184.preheader
                                        #   in Loop: Header=BB0_71 Depth=1
	slli.d	$a2, $t3, 3
	ldx.d	$a2, $s2, $a2
	move	$t6, $zero
...
.LBB0_86:                               # %vector.body306
	...
	addi.d	$a3, $a3, 32
	bnez	$a4, .LBB0_86
# %bb.87:                               # %middle.block311
	beq	$a1, $a2, .LBB0_90
.LBB0_88:                               # %for.body.i.preheader
	alsl.d	$a3, $a2, $s2, 3
	sub.d	$a1, $a1, $a2
	addi.d	$a2, $a2, 1
	.p2align	4, , 16
...
# %bb.92:
	move	$a3, $zero
	b	.LBB0_102
.LBB0_93:                               # %vector.main.loop.iter.check319
	ori	$a3, $zero, 16
	bgeu	$a2, $a3, .LBB0_95
# %bb.94:
	move	$a3, $zero
	b	.LBB0_99
.LBB0_95:                               # %vector.ph320
	andi	$a5, $a4, 12
...
.LBB0_96:                               # %vector.body323
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB0_96
# %bb.97:                               # %middle.block329
	beq	$a2, $a3, .LBB0_104
# %bb.98:                               # %vec.epilog.iter.check333
	beqz	$a5, .LBB0_102
.LBB0_99:                               # %vec.epilog.ph335
	move	$a5, $a3
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB0_100:                              # %vec.epilog.vector.body340
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a5, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a5, $a5, 16
	bnez	$a4, .LBB0_100
# %bb.101:                              # %vec.epilog.middle.block345
	beq	$a2, $a3, .LBB0_104
.LBB0_102:                              # %for.body12.i.preheader
	alsl.d	$a1, $a3, $a1, 2
	nor	$a4, $a3, $zero
	sub.d	$a2, $a2, $a3
	.p2align	4, , 16
.LBB0_103:                              # %for.body12.i
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a4, $a1, 0
	addi.d	$a1, $a1, 4
	addi.d	$a2, $a2, -1
...
.LBB0_104:                              # %for.end19.i
	...
	stx.b	$zero, $a2, $a1
	bltz	$a1, .LBB0_120
# %bb.105:                              # %for.body33.i.preheader
	move	$a3, $zero
	addi.w	$a2, $zero, -1
	ori	$a4, $zero, 45
	.p2align	4, , 16
.LBB0_106:                              # %for.body33.i
                                        # =>This Loop Header: Depth=1
...
.LBB0_112:                              # %while.body.i154
	...
	st.b	$a4, $t3, -1
	bnez	$t2, .LBB0_112
# %bb.113:                              # %while.end.loopexit.i
                                        #   in Loop: Header=BB0_106 Depth=1
	add.d	$a3, $s3, $a3
	add.d	$a3, $t1, $a3
.LBB0_114:                              # %while.end.i
                                        #   in Loop: Header=BB0_106 Depth=1
	add.w	$a0, $t0, $a0
	beq	$t0, $a2, .LBB0_117
# %bb.115:                              # %while.body76.preheader.i
                                        #   in Loop: Header=BB0_106 Depth=1
	nor	$t0, $t0, $zero
	.p2align	4, , 16
.LBB0_116:                              # %while.body76.i
                                        #   Parent Loop BB0_106 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$t1, $s4, 0
	addi.d	$t2, $t1, -1
	...
	addi.d	$a3, $a3, 1
	bnez	$t0, .LBB0_116
.LBB0_117:                              # %while.end87.i
                                        #   in Loop: Header=BB0_106 Depth=1
	blez	$a6, .LBB0_120
# %bb.118:                              # %while.end87.i
                                        #   in Loop: Header=BB0_106 Depth=1
	blez	$a7, .LBB0_120
# %bb.119:                              # %if.end93.i
                                        #   in Loop: Header=BB0_106 Depth=1
...
# %bb.30:                               # %iter.check183
	...
	ori	$t3, $zero, 1
	bltu	$t1, $t2, .LBB1_42
# %bb.31:                               # %vector.main.loop.iter.check185
	ori	$t2, $zero, 16
	bgeu	$t1, $t2, .LBB1_35
# %bb.32:
	move	$t2, $zero
...
.LBB1_39:                               # %vec.epilog.ph202
	...
	sub.d	$t2, $t2, $t4
	.p2align	4, , 16
.LBB1_40:                               # %vec.epilog.vector.body207
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $t5, 0
	vfadd.s	$vr2, $vr2, $vr0
	vst	$vr2, $t5, 0
...
# %bb.45:                               # %vector.memcheck
	...
	ori	$t5, $zero, 64
	bltu	$t4, $t5, .LBB1_55
# %bb.46:                               # %vector.main.loop.iter.check220
	ori	$t3, $zero, 16
	bgeu	$t2, $t3, .LBB1_48
# %bb.47:
	move	$t4, $zero
	b	.LBB1_52
.LBB1_48:                               # %vector.ph221
	andi	$t3, $t2, 12
	move	$t4, $t2
	bstrins.d	$t4, $zero, 3, 0
	addi.d	$t5, $a0, 32
...
.LBB1_49:                               # %vector.body224
	...
	addi.d	$t6, $t6, 64
	bnez	$t7, .LBB1_49
# %bb.50:                               # %middle.block229
	beq	$t2, $t4, .LBB1_57
# %bb.51:                               # %vec.epilog.iter.check233
	beqz	$t3, .LBB1_75
.LBB1_52:                               # %vec.epilog.ph235
	move	$t5, $t2
	bstrins.d	$t5, $zero, 1, 0
	ori	$t6, $zero, 1
	move	$t3, $t2
	...
	sub.d	$t4, $t4, $t5
	.p2align	4, , 16
.LBB1_53:                               # %vec.epilog.vector.body238
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $t6, 0
	vst	$vr0, $t7, 0
	addi.d	$t6, $t6, 16
	...
	addi.d	$t7, $t7, 16
	bnez	$t4, .LBB1_53
# %bb.54:                               # %vec.epilog.middle.block243
	beq	$t2, $t5, .LBB1_57
.LBB1_55:                               # %for.body96.preheader
	alsl.d	$t2, $t3, $a0, 2
	addi.d	$t2, $t2, -4
	alsl.d	$t0, $t3, $t0, 2
	sub.d	$t1, $t1, $t3
...
# %bb.59:                               # %for.body121.lr.ph
	...
	b	.LBB1_62
	.p2align	4, , 16
.LBB1_60:                               # %match_calc_mtx.exit127.thread
...
.LBB1_62:                               # %for.body121
	...
	fst.s	$fa3, $t3, 0
	beqz	$s1, .LBB1_60
# %bb.63:                               # %while.body.i116.preheader
                                        #   in Loop: Header=BB1_62 Depth=1
	ldx.b	$a4, $a3, $t2
	slli.d	$a4, $a4, 9
	add.d	$a4, $fp, $a4
...
.LBB1_64:                               # %while.body.i116
	...
	move	$t5, $t8
	bnez	$t6, .LBB1_64
# %bb.65:                               # %match_calc_mtx.exit127
                                        #   in Loop: Header=BB1_62 Depth=1
	fld.s	$fa3, $t4, 0
	fst.s	$fa3, $a0, 0
	blez	$s1, .LBB1_61
# %bb.66:                               # %for.body135.preheader
                                        #   in Loop: Header=BB1_62 Depth=1
	fld.s	$fa3, $t3, 0
	addi.d	$a4, $a0, 4
	move	$t4, $t1
