...
# %bb.33:                               # %for.body136.lr.ph
	...
	ori	$a4, $zero, 8
	bltu	$a2, $a4, .LBB4_36
# %bb.34:                               # %vector.memcheck553
	alsl.d	$a4, $a2, $a3, 2
	bgeu	$a1, $a4, .LBB4_157
# %bb.35:                               # %vector.memcheck553
	alsl.d	$a4, $a2, $a1, 2
	bgeu	$a3, $a4, .LBB4_157
.LBB4_36:
	move	$a4, $zero
...
# %bb.40:                               # %for.body163.lr.ph
	...
	ori	$a3, $zero, 8
	bltu	$a1, $a3, .LBB4_43
# %bb.41:                               # %vector.memcheck568
	alsl.d	$a3, $a1, $a2, 2
	bgeu	$a0, $a3, .LBB4_160
# %bb.42:                               # %vector.memcheck568
	alsl.d	$a3, $a1, $a0, 2
	bgeu	$a2, $a3, .LBB4_160
.LBB4_43:
	move	$a3, $zero
...
.LBB4_46:                               # %for.end186
	...
	ld.d	$a0, $sp, 248                   # 8-byte Folded Reload
	ld.d	$a0, $a0, %pc_lo12(partA__align.initverticalw)
	ld.d	$s0, $s4, %pc_lo12(partA__align.cpmx2)
	ld.d	$a1, $sp, 280                   # 8-byte Folded Reload
...
.LBB4_82:                               # %vector.memcheck712
	...
	and	$t1, $t1, $t2
	bnez	$t1, .LBB4_79
# %bb.83:                               # %vector.memcheck712
	addi.d	$a6, $a6, 8
	sltu	$a6, $a7, $a6
	sltu	$a7, $a0, $t0
	and	$a6, $a6, $a7
	bnez	$a6, .LBB4_79
# %bb.84:                               # %vector.main.loop.iter.check729
	ori	$a5, $zero, 16
	bgeu	$a4, $a5, .LBB4_232
# %bb.85:
	move	$a6, $zero
...
# %bb.146:
	move	$a5, $zero
	b	.LBB4_191
.LBB4_147:                              # %vector.main.loop.iter.check870
	ori	$a2, $zero, 16
	bgeu	$a4, $a2, .LBB4_184
# %bb.148:
	move	$a5, $zero
...
.LBB4_158:                              # %vector.body560
	...
	addi.d	$a5, $a5, 32
	bnez	$a7, .LBB4_158
# %bb.159:                              # %middle.block565
	beq	$a2, $a4, .LBB4_39
	b	.LBB4_37
.LBB4_160:                              # %vector.ph576
...
.LBB4_161:                              # %vector.body581
	...
	addi.d	$a4, $a4, 32
	bnez	$a6, .LBB4_161
# %bb.162:                              # %middle.block586
	beq	$a1, $a3, .LBB4_46
	b	.LBB4_44
.LBB4_163:                              # %vector.ph542
	slli.d	$a4, $s1, 3
...
.LBB4_164:                              # %vector.body545
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB4_164
# %bb.165:                              # %middle.block550
	beq	$a2, $fp, .LBB4_22
	b	.LBB4_20
.LBB4_166:                              # %vector.memcheck620
...
# %bb.171:                              # %vector.memcheck660
	...
	and	$a5, $a5, $a6
	bnez	$a5, .LBB4_61
# %bb.172:                              # %vector.main.loop.iter.check677
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB4_301
# %bb.173:
	move	$a5, $zero
	b	.LBB4_305
.LBB4_174:                              # %vector.ph801
	pcalau12i	$a5, %pc_hi20(.LCPI4_5)
	vld	$vr0, $a5, %pc_lo12(.LCPI4_5)
...
# %bb.181:
	move	$a4, $zero
	b	.LBB4_246
.LBB4_182:                              # %vector.main.loop.iter.check819
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB4_239
# %bb.183:
	move	$a4, $zero
	b	.LBB4_243
.LBB4_184:                              # %vector.ph871
...
.LBB4_185:                              # %vector.body874
	...
	addi.d	$a2, $a2, 64
	bnez	$a7, .LBB4_185
# %bb.186:                              # %middle.block880
	beq	$a4, $a5, .LBB4_193
# %bb.187:                              # %vec.epilog.iter.check885
	andi	$a2, $a6, 12
	beqz	$a2, .LBB4_191
.LBB4_188:                              # %vec.epilog.ph884
	move	$a7, $a5
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB4_189:                              # %vec.epilog.vector.body893
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a6, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a6, $a6, 16
	bnez	$a2, .LBB4_189
# %bb.190:                              # %vec.epilog.middle.block898
	beq	$a4, $a5, .LBB4_193
...
.LBB4_233:                              # %vector.body733
	...
	addi.d	$t0, $t0, 64
	bnez	$t1, .LBB4_233
# %bb.234:                              # %middle.block740
	beq	$a4, $a6, .LBB4_81
# %bb.235:                              # %vec.epilog.iter.check745
	andi	$a5, $a4, 12
	beqz	$a5, .LBB4_308
.LBB4_236:                              # %vec.epilog.ph744
	move	$a7, $a4
	...
	vrepli.b	$vr1, 0
	.p2align	4, , 16
.LBB4_237:                              # %vec.epilog.vector.body750
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $t0, 0
	vfadd.s	$vr2, $vr2, $vr0
	vst	$vr2, $t1, 0
	...
	addi.d	$t2, $t2, 16
	bnez	$a6, .LBB4_237
# %bb.238:                              # %vec.epilog.middle.block757
	bne	$a4, $a7, .LBB4_79
	b	.LBB4_81
.LBB4_239:                              # %vector.ph820
...
.LBB4_240:                              # %vector.body823
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB4_240
# %bb.241:                              # %middle.block829
	beq	$a3, $a4, .LBB4_248
# %bb.242:                              # %vec.epilog.iter.check834
	andi	$a6, $a5, 12
	beqz	$a6, .LBB4_246
.LBB4_243:                              # %vec.epilog.ph833
	move	$a6, $a4
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB4_244:                              # %vec.epilog.vector.body841
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a6, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a6, $a6, 16
	bnez	$a5, .LBB4_244
# %bb.245:                              # %vec.epilog.middle.block846
	beq	$a3, $a4, .LBB4_248
...
.LBB4_302:                              # %vector.body681
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB4_302
# %bb.303:                              # %middle.block690
	beq	$a3, $a5, .LBB4_78
# %bb.304:                              # %vec.epilog.iter.check695
	andi	$a4, $a3, 12
	beqz	$a4, .LBB4_310
.LBB4_305:                              # %vec.epilog.ph694
	move	$a6, $a3
	bstrins.d	$a6, $zero, 1, 0
	ori	$a7, $zero, 1
	move	$a4, $a3
	...
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB4_306:                              # %vec.epilog.vector.body700
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a7, 0
	vld	$vr2, $t0, 0
	vfadd.s	$vr1, $vr0, $vr1
	...
	addi.d	$t0, $t0, 16
	bnez	$a5, .LBB4_306
# %bb.307:                              # %vec.epilog.middle.block708
	bne	$a3, $a6, .LBB4_61
	b	.LBB4_78
.LBB4_308:
	addi.d	$a5, $a6, 1
