...
.LBB1_4:                                # %for.end
	...
	ld.w	$fp, $a0, %pc_lo12(Calignm1.orlgth)
...
.LBB1_27:                               # %for.end101
	...
	ld.d	$a0, $sp, 264                   # 8-byte Folded Reload
	st.w	$fp, $a0, %pc_lo12(Calignm1.orlgth)
...
# %bb.33:                               # %if.then117
	...
	ld.w	$fp, $a1, %pc_lo12(Calignm1.orlgth)
	ld.w	$a1, $s3, 0
	ld.w	$s1, $s5, %pc_lo12(Calignm1.orlgth1)
.LBB1_34:                               # %if.end118
	slt	$a2, $fp, $a0
...
.LBB1_62:                               # %for.cond344.preheader
	ld.d	$a0, $sp, 72                    # 8-byte Folded Reload
	ld.d	$ra, $a0, %pc_lo12(Calignm1.gs)
	addi.w	$a1, $zero, -1
	ld.d	$a0, $sp, 152                   # 8-byte Folded Reload
	addi.w	$a4, $a0, 2
...
# %bb.68:                               #   in Loop: Header=BB1_65 Depth=1
	...
	b	.LBB1_73
	.p2align	4, , 16
.LBB1_69:                               # %vector.ph535
                                        #   in Loop: Header=BB1_65 Depth=1
	move	$t4, $a3
	bstrins.d	$t4, $zero, 3, 0
	andi	$t3, $a3, 12
	bstrpick.d	$t2, $a3, 62, 4
	slli.d	$t2, $t2, 4
	addi.d	$t5, $t1, 32
	addi.d	$t6, $t0, 32
	.p2align	4, , 16
.LBB1_70:                               # %vector.body538
...
# %bb.104:
	move	$a3, $zero
	b	.LBB1_114
.LBB1_105:                              # %vector.main.loop.iter.check554
	ori	$a3, $zero, 16
	bgeu	$a1, $a3, .LBB1_107
# %bb.106:
	move	$a3, $zero
	b	.LBB1_111
.LBB1_107:                              # %vector.ph555
	andi	$a4, $a6, 12
...
.LBB1_108:                              # %vector.body558
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB1_108
# %bb.109:                              # %middle.block561
	beq	$a1, $a3, .LBB1_116
# %bb.110:                              # %vec.epilog.iter.check565
	beqz	$a4, .LBB1_114
.LBB1_111:                              # %vec.epilog.ph567
	...
	vrepli.b	$vr0, 0
	.p2align	4, , 16
.LBB1_112:                              # %vec.epilog.vector.body570
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a7, 0
	vst	$vr0, $a5, 0
	addi.d	$a4, $a4, 4
	...
	addi.d	$a7, $a7, 16
	bnez	$a4, .LBB1_112
# %bb.113:                              # %vec.epilog.middle.block573
	beq	$a1, $a3, .LBB1_116
...
# %bb.152:
	move	$a2, $zero
	b	.LBB1_162
.LBB1_153:                              # %vector.main.loop.iter.check594
	ori	$a2, $zero, 16
	bgeu	$a7, $a2, .LBB1_155
# %bb.154:
	move	$a2, $zero
	b	.LBB1_159
.LBB1_155:                              # %vector.ph595
	andi	$a4, $t3, 12
	bstrpick.d	$a2, $t3, 31, 4
	slli.d	$a2, $a2, 4
	pcalau12i	$a5, %pc_hi20(.LCPI1_2)
	xvld	$xr0, $a5, %pc_lo12(.LCPI1_2)
	addi.d	$a5, $a0, 32
	xvrepli.b	$xr1, -1
	xvrepli.w	$xr2, -9
	move	$a6, $a2
	.p2align	4, , 16
.LBB1_156:                              # %vector.body598
                                        # =>This Inner Loop Header: Depth=1
	xvxor.v	$xr3, $xr0, $xr1
	xvsub.w	$xr4, $xr2, $xr0
	xvst	$xr3, $a5, -32
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB1_156
# %bb.157:                              # %middle.block604
	beq	$a7, $a2, .LBB1_164
# %bb.158:                              # %vec.epilog.iter.check608
	beqz	$a4, .LBB1_162
.LBB1_159:                              # %vec.epilog.ph610
	move	$a5, $a2
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB1_160:                              # %vec.epilog.vector.body613
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a5, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a5, $a5, 16
	bnez	$a4, .LBB1_160
# %bb.161:                              # %vec.epilog.middle.block618
	beq	$a7, $a2, .LBB1_164
