...
# %bb.45:
	move	$a3, $zero
	b	.LBB1_49
.LBB1_46:                               # %vector.ph512
	bstrpick.d	$a3, $s5, 31, 3
	slli.d	$a3, $a3, 3
	addi.d	$a4, $a1, 32
	move	$a5, $a3
	.p2align	4, , 16
.LBB1_47:                               # %vector.body515
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a6, $a4, -32
	ld.d	$a7, $a4, -24
	ld.d	$t0, $a4, -16
...
# %bb.104:
	move	$a3, $zero
	b	.LBB1_114
.LBB1_105:                              # %vector.main.loop.iter.check548
	ori	$a3, $zero, 16
	bgeu	$a1, $a3, .LBB1_107
# %bb.106:
	move	$a3, $zero
	b	.LBB1_111
.LBB1_107:                              # %vector.ph549
...
.LBB1_108:                              # %vector.body552
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB1_108
# %bb.109:                              # %middle.block555
	beq	$a1, $a3, .LBB1_116
# %bb.110:                              # %vec.epilog.iter.check560
	andi	$a4, $a5, 12
	beqz	$a4, .LBB1_114
.LBB1_111:                              # %vec.epilog.ph559
	move	$a7, $a3
	...
	vrepli.b	$vr0, 0
	.p2align	4, , 16
.LBB1_112:                              # %vec.epilog.vector.body565
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a7, 0
	vst	$vr0, $a6, 0
	addi.d	$a4, $a4, 4
	...
	addi.d	$a7, $a7, 16
	bnez	$a4, .LBB1_112
# %bb.113:                              # %vec.epilog.middle.block568
	beq	$a1, $a3, .LBB1_116
...
# %bb.118:                              # %for.body565.preheader
	...
	ld.d	$a0, $sp, 80                    # 8-byte Folded Reload
	ld.d	$t3, $a0, %pc_lo12(Calignm1.mp)
...
# %bb.152:
	move	$a2, $zero
	b	.LBB1_162
.LBB1_153:                              # %vector.main.loop.iter.check589
	ori	$a2, $zero, 16
	bgeu	$a6, $a2, .LBB1_155
# %bb.154:
	move	$a2, $zero
	b	.LBB1_159
.LBB1_155:                              # %vector.ph590
...
.LBB1_156:                              # %vector.body593
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB1_156
# %bb.157:                              # %middle.block599
	beq	$a6, $a2, .LBB1_164
# %bb.158:                              # %vec.epilog.iter.check604
	andi	$a4, $t0, 12
	beqz	$a4, .LBB1_162
.LBB1_159:                              # %vec.epilog.ph603
	move	$a5, $a2
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB1_160:                              # %vec.epilog.vector.body609
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a5, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a5, $a5, 16
	bnez	$a4, .LBB1_160
# %bb.161:                              # %vec.epilog.middle.block614
	beq	$a6, $a2, .LBB1_164
