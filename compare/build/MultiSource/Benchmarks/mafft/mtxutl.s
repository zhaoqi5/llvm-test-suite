...
# %bb.1:                                # %for.cond2.preheader.lr.ph
	...
	movgr2fr.d	$fs0, $zero
	.p2align	4, , 16
.LBB1_2:                                # %for.cond10.preheader.us
	...
	move	$a0, $zero
	.p2align	4, , 16
.LBB1_3:                                # %for.cond14.preheader.us.us
...
.LBB1_4:                                # %for.body17.us.us
	...
	addi.d	$a3, $a3, 8
	bnez	$a2, .LBB1_4
# %bb.5:                                # %for.cond14.for.end26_crit_edge.us.us
                                        #   in Loop: Header=BB1_3 Depth=2
	addi.d	$a0, $a0, 1
	fstx.d	$fa0, $s4, $a1
	bne	$a0, $fp, .LBB1_3
# %bb.6:                                # %for.cond10.for.inc34_crit_edge.split.us.us
...
# %bb.4:                                # %for.body.us.preheader
	...
	b	.LBB21_6
	.p2align	4, , 16
.LBB21_5:                               # %AllocateCharCub.exit.loopexit.us
...
# %bb.7:                                # %if.end.i.us
	...
	beqz	$a0, .LBB21_14
# %bb.8:                                # %for.body.i.us.us.preheader
                                        #   in Loop: Header=BB21_6 Depth=1
	move	$s1, $zero
	.p2align	4, , 16
.LBB21_9:                               # %for.body.i.us.us
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB21_21
# %bb.10:                               # %for.body.i15.us.us.preheader
                                        #   in Loop: Header=BB21_9 Depth=2
	move	$s7, $a0
	move	$s4, $zero
	.p2align	4, , 16
.LBB21_11:                              # %for.body.i15.us.us
                                        #   Parent Loop BB21_6 Depth=1
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB21_20
# %bb.12:                               # %AllocateCharVec.exit.i.us.us
                                        #   in Loop: Header=BB21_11 Depth=3
	stx.d	$a0, $s7, $s4
	addi.d	$s4, $s4, 8
	bne	$s2, $s4, .LBB21_11
# %bb.13:                               # %AllocateCharMtx.exit.loopexit.us.us
                                        #   in Loop: Header=BB21_9 Depth=2
	stx.d	$zero, $s7, $s3
	slli.d	$a0, $s1, 3
	addi.d	$s1, $s1, 1
