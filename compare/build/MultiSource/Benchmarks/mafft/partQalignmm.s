...
.LBB4_155:                              # %vector.body1098
	...
	addi.d	$t0, $t0, 32
	bnez	$t2, .LBB4_155
# %bb.156:                              # %middle.block1110
	bne	$a6, $t1, .LBB4_53
	b	.LBB4_55
.LBB4_157:                              # %vector.memcheck1113
	addi.d	$a7, $t5, 4
	alsl.d	$t1, $a4, $t5, 2
	addi.d	$t0, $a1, 8
	sltu	$t0, $a7, $t0
	...
	and	$t0, $t0, $t2
	bnez	$t0, .LBB4_57
# %bb.158:                              # %vector.memcheck1113
	addi.d	$t0, $a2, 4
	sltu	$t0, $a7, $t0
	sltu	$t2, $a2, $t1
	and	$t0, $t0, $t2
	bnez	$t0, .LBB4_57
# %bb.159:                              # %vector.memcheck1113
	addi.d	$t0, $a3, 4
	alsl.d	$t2, $a4, $a3, 2
	sltu	$t2, $a7, $t2
	sltu	$t1, $t0, $t1
...
.LBB4_161:                              # %vector.body1136
	...
	addi.d	$t0, $t0, 32
	bnez	$t2, .LBB4_161
# %bb.162:                              # %middle.block1148
	bne	$a6, $t1, .LBB4_57
	b	.LBB4_59
.LBB4_163:                              # %vector.ph1157
	move	$a6, $zero
	move	$a7, $a4
...
# %bb.234:
	move	$a5, $zero
	b	.LBB4_262
.LBB4_235:                              # %vector.main.loop.iter.check1288
	ori	$a5, $zero, 16
	bgeu	$a4, $a5, .LBB4_255
# %bb.236:
	move	$a5, $zero
...
# %bb.252:
	move	$a4, $zero
	b	.LBB4_310
.LBB4_253:                              # %vector.main.loop.iter.check1237
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB4_303
# %bb.254:
	move	$a4, $zero
	b	.LBB4_307
.LBB4_255:                              # %vector.ph1289
...
.LBB4_256:                              # %vector.body1292
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB4_256
# %bb.257:                              # %middle.block1298
	beq	$a4, $a5, .LBB4_264
# %bb.258:                              # %vec.epilog.iter.check1303
	andi	$a7, $a6, 12
	beqz	$a7, .LBB4_262
.LBB4_259:                              # %vec.epilog.ph1302
	move	$a7, $a5
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB4_260:                              # %vec.epilog.vector.body1311
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a7, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a7, $a7, 16
	bnez	$a6, .LBB4_260
# %bb.261:                              # %vec.epilog.middle.block1316
	beq	$a4, $a5, .LBB4_264
...
.LBB4_304:                              # %vector.body1241
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB4_304
# %bb.305:                              # %middle.block1247
	beq	$a3, $a4, .LBB4_312
# %bb.306:                              # %vec.epilog.iter.check1252
	andi	$a6, $a5, 12
	beqz	$a6, .LBB4_310
.LBB4_307:                              # %vec.epilog.ph1251
	move	$a6, $a4
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB4_308:                              # %vec.epilog.vector.body1259
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a6, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a6, $a6, 16
	bnez	$a5, .LBB4_308
# %bb.309:                              # %vec.epilog.middle.block1264
	beq	$a3, $a4, .LBB4_312
