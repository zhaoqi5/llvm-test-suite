...
.LBB4_79:                               # %vector.memcheck736
	...
	move	$t2, $zero
	bnez	$t4, .LBB4_358
# %bb.80:                               # %vector.memcheck736
	alsl.d	$s0, $t1, $a5, 2
	sltu	$t4, $a2, $s0
	sltu	$t5, $a5, $s2
	and	$t4, $t4, $t5
	bnez	$t4, .LBB4_358
# %bb.81:                               # %vector.memcheck736
	alsl.d	$t5, $t1, $a6, 2
	sltu	$t4, $a2, $t5
	sltu	$t6, $a6, $s2
	and	$t4, $t4, $t6
	bnez	$t4, .LBB4_358
# %bb.82:                               # %vector.memcheck736
	alsl.d	$t4, $t1, $t0, 2
	sltu	$t6, $a2, $t4
	sltu	$t7, $t0, $s2
	and	$t6, $t6, $t7
	bnez	$t6, .LBB4_358
# %bb.83:                               # %vector.memcheck736
	alsl.d	$t6, $t1, $a0, 2
	sltu	$t7, $a2, $t6
	sltu	$t8, $a0, $s2
	and	$t7, $t7, $t8
	bnez	$t7, .LBB4_358
# %bb.84:                               # %vector.memcheck736
	alsl.d	$t7, $t1, $a1, 2
	sltu	$t8, $a2, $t7
	sltu	$fp, $a1, $s2
	and	$t8, $t8, $fp
	bnez	$t8, .LBB4_358
# %bb.85:                               # %vector.memcheck736
	alsl.d	$t8, $t1, $a3, 2
	sltu	$fp, $a2, $t8
	sltu	$s3, $a3, $s2
	and	$fp, $fp, $s3
	bnez	$fp, .LBB4_358
# %bb.86:                               # %vector.memcheck736
	alsl.d	$fp, $t1, $a7, 2
	sltu	$s3, $a2, $fp
	sltu	$s2, $a7, $s2
	and	$s2, $s3, $s2
	bnez	$s2, .LBB4_358
# %bb.87:                               # %vector.memcheck736
	sltu	$s2, $a4, $s0
	sltu	$s3, $a5, $s1
	and	$s2, $s2, $s3
	bnez	$s2, .LBB4_358
...
# %bb.89:                               # %vector.memcheck736
	...
	and	$s2, $s2, $s3
	bnez	$s2, .LBB4_358
# %bb.90:                               # %vector.memcheck736
	sltu	$s2, $a4, $t6
	sltu	$s3, $a0, $s1
	and	$s2, $s2, $s3
	bnez	$s2, .LBB4_358
# %bb.91:                               # %vector.memcheck736
	sltu	$s2, $a4, $t7
	sltu	$s3, $a1, $s1
	and	$s2, $s2, $s3
	bnez	$s2, .LBB4_358
# %bb.92:                               # %vector.memcheck736
	sltu	$s2, $a4, $t8
	sltu	$s3, $a3, $s1
	and	$s2, $s2, $s3
	bnez	$s2, .LBB4_358
# %bb.93:                               # %vector.memcheck736
	sltu	$s2, $a4, $fp
	sltu	$s1, $a7, $s1
	and	$s1, $s2, $s1
	bnez	$s1, .LBB4_358
# %bb.94:                               # %vector.memcheck736
	sltu	$s1, $a5, $t5
	sltu	$s2, $a6, $s0
	and	$s1, $s1, $s2
	bnez	$s1, .LBB4_358
# %bb.95:                               # %vector.memcheck736
	sltu	$s1, $a5, $t4
	sltu	$s2, $t0, $s0
	and	$s1, $s1, $s2
	bnez	$s1, .LBB4_358
# %bb.96:                               # %vector.memcheck736
	sltu	$s1, $a5, $t6
	sltu	$s2, $a0, $s0
	and	$s1, $s1, $s2
	bnez	$s1, .LBB4_358
# %bb.97:                               # %vector.memcheck736
	sltu	$s1, $a5, $t7
	sltu	$s2, $a1, $s0
	and	$s1, $s1, $s2
	bnez	$s1, .LBB4_358
# %bb.98:                               # %vector.memcheck736
	sltu	$s1, $a5, $t8
	sltu	$s2, $a3, $s0
	and	$s1, $s1, $s2
	bnez	$s1, .LBB4_358
# %bb.99:                               # %vector.memcheck736
	sltu	$s1, $a5, $fp
	sltu	$s0, $a7, $s0
	and	$s0, $s1, $s0
	ld.d	$s2, $sp, 440                   # 8-byte Folded Reload
	bnez	$s0, .LBB4_359
# %bb.100:                              # %vector.memcheck736
	sltu	$s0, $a6, $t4
	sltu	$s1, $t0, $t5
	and	$s0, $s0, $s1
	bnez	$s0, .LBB4_359
# %bb.101:                              # %vector.memcheck736
	sltu	$s0, $a6, $t6
	sltu	$s1, $a0, $t5
	and	$s0, $s0, $s1
	bnez	$s0, .LBB4_359
# %bb.102:                              # %vector.memcheck736
	sltu	$s0, $a6, $t7
	sltu	$s1, $a1, $t5
	and	$s0, $s0, $s1
	bnez	$s0, .LBB4_359
# %bb.103:                              # %vector.memcheck736
	sltu	$s0, $a6, $t8
	sltu	$s1, $a3, $t5
	and	$s0, $s0, $s1
	bnez	$s0, .LBB4_359
# %bb.104:                              # %vector.memcheck736
	sltu	$s0, $a6, $fp
	sltu	$t5, $a7, $t5
	and	$t5, $s0, $t5
	bnez	$t5, .LBB4_359
# %bb.105:                              # %vector.memcheck736
	sltu	$t5, $t0, $t6
	sltu	$t6, $a0, $t4
	and	$t5, $t5, $t6
	ld.d	$s6, $sp, 160                   # 8-byte Folded Reload
	bnez	$t5, .LBB4_35
# %bb.106:                              # %vector.memcheck736
	sltu	$t5, $t0, $t7
	sltu	$t6, $a1, $t4
	and	$t5, $t5, $t6
	bnez	$t5, .LBB4_35
# %bb.107:                              # %vector.memcheck736
	sltu	$t5, $t0, $t8
	sltu	$t6, $a3, $t4
	and	$t5, $t5, $t6
	bnez	$t5, .LBB4_35
# %bb.108:                              # %vector.memcheck736
	sltu	$t5, $t0, $fp
	sltu	$t4, $a7, $t4
	and	$t4, $t5, $t4
	bnez	$t4, .LBB4_35
...
.LBB4_110:                              # %vector.body865
	...
	addi.d	$t3, $t3, 32
	bnez	$s5, .LBB4_110
# %bb.111:                              # %middle.block879
	ld.d	$s6, $sp, 160                   # 8-byte Folded Reload
	bne	$t1, $t2, .LBB4_35
	b	.LBB4_37
.LBB4_112:                              # %vector.memcheck882
	alsl.d	$s2, $t1, $a2, 2
	alsl.d	$s1, $t1, $a4, 2
	sltu	$t2, $a2, $s1
	sltu	$t4, $a4, $s2
	...
	move	$t2, $zero
	bnez	$t4, .LBB4_360
# %bb.113:                              # %vector.memcheck882
	alsl.d	$s0, $t1, $a5, 2
	sltu	$t4, $a2, $s0
	sltu	$t5, $a5, $s2
	and	$t4, $t4, $t5
	bnez	$t4, .LBB4_360
# %bb.114:                              # %vector.memcheck882
	alsl.d	$t5, $t1, $a6, 2
	sltu	$t4, $a2, $t5
	sltu	$t6, $a6, $s2
	and	$t4, $t4, $t6
	bnez	$t4, .LBB4_360
# %bb.115:                              # %vector.memcheck882
	alsl.d	$t4, $t1, $t0, 2
	sltu	$t6, $a2, $t4
	sltu	$t7, $t0, $s2
	and	$t6, $t6, $t7
	bnez	$t6, .LBB4_360
# %bb.116:                              # %vector.memcheck882
	alsl.d	$t6, $t1, $a0, 2
	sltu	$t7, $a2, $t6
	sltu	$t8, $a0, $s2
	and	$t7, $t7, $t8
	bnez	$t7, .LBB4_360
# %bb.117:                              # %vector.memcheck882
	alsl.d	$t7, $t1, $a1, 2
	sltu	$t8, $a2, $t7
	sltu	$fp, $a1, $s2
	and	$t8, $t8, $fp
	bnez	$t8, .LBB4_360
# %bb.118:                              # %vector.memcheck882
	alsl.d	$t8, $t1, $a3, 2
	sltu	$fp, $a2, $t8
	sltu	$s3, $a3, $s2
	and	$fp, $fp, $s3
	bnez	$fp, .LBB4_360
# %bb.119:                              # %vector.memcheck882
	alsl.d	$fp, $t1, $a7, 2
	sltu	$s3, $a2, $fp
	sltu	$s2, $a7, $s2
	and	$s2, $s3, $s2
	bnez	$s2, .LBB4_360
# %bb.120:                              # %vector.memcheck882
	sltu	$s2, $a4, $s0
	sltu	$s3, $a5, $s1
	and	$s2, $s2, $s3
	bnez	$s2, .LBB4_360
# %bb.121:                              # %vector.memcheck882
	sltu	$s2, $a4, $t5
	sltu	$s3, $a6, $s1
	and	$s2, $s2, $s3
	bnez	$s2, .LBB4_360
# %bb.122:                              # %vector.memcheck882
	sltu	$s2, $a4, $t4
	sltu	$s3, $t0, $s1
	and	$s2, $s2, $s3
	bnez	$s2, .LBB4_360
# %bb.123:                              # %vector.memcheck882
	sltu	$s2, $a4, $t6
	sltu	$s3, $a0, $s1
	and	$s2, $s2, $s3
	bnez	$s2, .LBB4_360
# %bb.124:                              # %vector.memcheck882
	sltu	$s2, $a4, $t7
	sltu	$s3, $a1, $s1
	and	$s2, $s2, $s3
	bnez	$s2, .LBB4_360
# %bb.125:                              # %vector.memcheck882
	sltu	$s2, $a4, $t8
	sltu	$s3, $a3, $s1
	and	$s2, $s2, $s3
	bnez	$s2, .LBB4_360
# %bb.126:                              # %vector.memcheck882
	sltu	$s2, $a4, $fp
	sltu	$s1, $a7, $s1
	and	$s1, $s2, $s1
	bnez	$s1, .LBB4_360
# %bb.127:                              # %vector.memcheck882
	sltu	$s1, $a5, $t5
	sltu	$s2, $a6, $s0
	and	$s1, $s1, $s2
	bnez	$s1, .LBB4_360
# %bb.128:                              # %vector.memcheck882
	sltu	$s1, $a5, $t4
	sltu	$s2, $t0, $s0
	and	$s1, $s1, $s2
	bnez	$s1, .LBB4_360
# %bb.129:                              # %vector.memcheck882
	sltu	$s1, $a5, $t6
	sltu	$s2, $a0, $s0
	and	$s1, $s1, $s2
	bnez	$s1, .LBB4_360
# %bb.130:                              # %vector.memcheck882
	sltu	$s1, $a5, $t7
	sltu	$s2, $a1, $s0
	and	$s1, $s1, $s2
	bnez	$s1, .LBB4_360
# %bb.131:                              # %vector.memcheck882
	sltu	$s1, $a5, $t8
	sltu	$s2, $a3, $s0
	and	$s1, $s1, $s2
	bnez	$s1, .LBB4_360
# %bb.132:                              # %vector.memcheck882
	sltu	$s1, $a5, $fp
	sltu	$s0, $a7, $s0
	and	$s0, $s1, $s0
	ld.d	$s2, $sp, 440                   # 8-byte Folded Reload
	bnez	$s0, .LBB4_40
# %bb.133:                              # %vector.memcheck882
	sltu	$s0, $a6, $t4
	sltu	$s1, $t0, $t5
	and	$s0, $s0, $s1
	bnez	$s0, .LBB4_40
# %bb.134:                              # %vector.memcheck882
	sltu	$s0, $a6, $t6
	sltu	$s1, $a0, $t5
	and	$s0, $s0, $s1
	bnez	$s0, .LBB4_40
# %bb.135:                              # %vector.memcheck882
	sltu	$s0, $a6, $t7
	sltu	$s1, $a1, $t5
	and	$s0, $s0, $s1
	bnez	$s0, .LBB4_40
# %bb.136:                              # %vector.memcheck882
	sltu	$s0, $a6, $t8
	sltu	$s1, $a3, $t5
	and	$s0, $s0, $s1
	bnez	$s0, .LBB4_40
# %bb.137:                              # %vector.memcheck882
	sltu	$s0, $a6, $fp
	sltu	$t5, $a7, $t5
	and	$t5, $s0, $t5
	bnez	$t5, .LBB4_40
# %bb.138:                              # %vector.memcheck882
	sltu	$t5, $t0, $t6
	sltu	$t6, $a0, $t4
	and	$t5, $t5, $t6
	bnez	$t5, .LBB4_40
# %bb.139:                              # %vector.memcheck882
	sltu	$t5, $t0, $t7
	sltu	$t6, $a1, $t4
	and	$t5, $t5, $t6
	bnez	$t5, .LBB4_40
# %bb.140:                              # %vector.memcheck882
	sltu	$t5, $t0, $t8
	sltu	$t6, $a3, $t4
	and	$t5, $t5, $t6
	bnez	$t5, .LBB4_40
# %bb.141:                              # %vector.memcheck882
	sltu	$t5, $t0, $fp
	sltu	$t4, $a7, $t4
	and	$t4, $t5, $t4
	bnez	$t4, .LBB4_40
# %bb.142:                              # %vector.ph1013
	bstrpick.d	$t2, $t3, 31, 3
	slli.d	$t2, $t2, 3
	xvreplve0.d	$xr1, $xr0
	lu52i.d	$t3, $zero, 1023
...
.LBB4_149:                              # %vector.body728
	...
	addi.d	$a6, $a6, 64
	bnez	$a5, .LBB4_149
# %bb.150:                              # %middle.block733
	beq	$a2, $s8, .LBB4_22
	b	.LBB4_20
.LBB4_151:                              # %vector.memcheck1066
	...
	and	$t0, $t0, $t2
	bnez	$t0, .LBB4_53
# %bb.152:                              # %vector.memcheck1066
	addi.d	$t0, $a2, 4
	sltu	$t0, $a7, $t0
	sltu	$t2, $a2, $t1
	and	$t0, $t0, $t2
	bnez	$t0, .LBB4_53
# %bb.153:                              # %vector.memcheck1066
	addi.d	$t0, $a3, 4
	alsl.d	$t2, $a4, $a3, 2
	sltu	$t2, $a7, $t2
	sltu	$t1, $t0, $t1
...
.LBB4_155:                              # %vector.body1089
	...
	addi.d	$t0, $t0, 32
	bnez	$t2, .LBB4_155
# %bb.156:                              # %middle.block1101
	bne	$a6, $t1, .LBB4_53
	b	.LBB4_55
.LBB4_157:                              # %vector.memcheck1104
	addi.d	$a7, $t5, 4
	alsl.d	$t1, $a4, $t5, 2
	addi.d	$t0, $a1, 8
	sltu	$t0, $a7, $t0
	...
	and	$t0, $t0, $t2
	bnez	$t0, .LBB4_57
# %bb.158:                              # %vector.memcheck1104
	addi.d	$t0, $a2, 4
	sltu	$t0, $a7, $t0
	sltu	$t2, $a2, $t1
	and	$t0, $t0, $t2
	bnez	$t0, .LBB4_57
# %bb.159:                              # %vector.memcheck1104
	addi.d	$t0, $a3, 4
	alsl.d	$t2, $a4, $a3, 2
	sltu	$t2, $a7, $t2
	sltu	$t1, $t0, $t1
...
.LBB4_161:                              # %vector.body1127
	...
	addi.d	$t0, $t0, 32
	bnez	$t2, .LBB4_161
# %bb.162:                              # %middle.block1139
	bne	$a6, $t1, .LBB4_57
	b	.LBB4_59
.LBB4_163:                              # %vector.ph1148
	move	$a6, $zero
	move	$a7, $a4
...
# %bb.234:
	move	$a5, $zero
	b	.LBB4_262
.LBB4_235:                              # %vector.main.loop.iter.check1279
	ori	$a5, $zero, 16
	bgeu	$a4, $a5, .LBB4_255
# %bb.236:
	move	$a5, $zero
...
# %bb.252:
	move	$a4, $zero
	b	.LBB4_310
.LBB4_253:                              # %vector.main.loop.iter.check1228
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB4_303
# %bb.254:
	move	$a4, $zero
	b	.LBB4_307
.LBB4_255:                              # %vector.ph1280
...
.LBB4_256:                              # %vector.body1283
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB4_256
# %bb.257:                              # %middle.block1289
	beq	$a4, $a5, .LBB4_264
# %bb.258:                              # %vec.epilog.iter.check1294
	andi	$a7, $a6, 12
	beqz	$a7, .LBB4_262
.LBB4_259:                              # %vec.epilog.ph1293
	move	$a7, $a5
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB4_260:                              # %vec.epilog.vector.body1302
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a7, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a7, $a7, 16
	bnez	$a6, .LBB4_260
# %bb.261:                              # %vec.epilog.middle.block1307
	beq	$a4, $a5, .LBB4_264
...
.LBB4_304:                              # %vector.body1232
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB4_304
# %bb.305:                              # %middle.block1238
	beq	$a3, $a4, .LBB4_312
# %bb.306:                              # %vec.epilog.iter.check1243
	andi	$a6, $a5, 12
	beqz	$a6, .LBB4_310
.LBB4_307:                              # %vec.epilog.ph1242
	move	$a6, $a4
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB4_308:                              # %vec.epilog.vector.body1250
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a6, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a6, $a6, 16
	bnez	$a5, .LBB4_308
# %bb.309:                              # %vec.epilog.middle.block1255
	beq	$a3, $a4, .LBB4_312
