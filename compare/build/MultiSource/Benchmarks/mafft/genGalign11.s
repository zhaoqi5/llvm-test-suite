...
# %bb.41:                               # %iter.check296
	...
	ori	$t0, $zero, 3
	bgeu	$t0, $a3, .LBB0_54
# %bb.42:                               # %vector.main.loop.iter.check298
	ori	$t0, $zero, 16
	bgeu	$a3, $t0, .LBB0_46
# %bb.43:
	move	$t0, $zero
...
# %bb.48:                               # %middle.block309
	beq	$a3, $t0, .LBB0_56
# %bb.49:                               # %vec.epilog.iter.check314
	andi	$t1, $a3, 12
	beqz	$t1, .LBB0_53
.LBB0_50:                               # %vec.epilog.ph313
	move	$t2, $a3
	bstrins.d	$t2, $zero, 1, 0
	ori	$t3, $zero, 1
	move	$t1, $a3
	...
	sub.d	$t0, $t0, $t2
	.p2align	4, , 16
.LBB0_51:                               # %vec.epilog.vector.body321
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $t3, 0
	vfadd.s	$vr2, $vr2, $vr1
	vst	$vr2, $t3, 0
	...
	addi.d	$t3, $t3, 16
	bnez	$t0, .LBB0_51
# %bb.52:                               # %vec.epilog.middle.block326
	bne	$a3, $t2, .LBB0_54
	b	.LBB0_56
.LBB0_53:
	addi.d	$t1, $t0, 1
...
# %bb.86:                               # %iter.check371
	...
	ori	$a7, $zero, 63
	bgeu	$a7, $a6, .LBB0_102
# %bb.87:                               # %vector.main.loop.iter.check373
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB0_95
# %bb.88:
	move	$a4, $zero
...
# %bb.92:                               # %vector.memcheck
	sub.d	$t6, $t1, $a3
	bltu	$t6, $t5, .LBB0_57
# %bb.93:                               # %vector.main.loop.iter.check339
	ori	$t4, $zero, 16
	bgeu	$t3, $t4, .LBB0_117
# %bb.94:
	move	$s6, $s4
...
.LBB0_96:                               # %vector.body377
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB0_96
# %bb.97:                               # %middle.block380
	beq	$a3, $a4, .LBB0_104
# %bb.98:                               # %vec.epilog.iter.check385
	andi	$a6, $a5, 12
	beqz	$a6, .LBB0_102
.LBB0_99:                               # %vec.epilog.ph384
	move	$a7, $a4
	...
	vrepli.b	$vr0, -1
	.p2align	4, , 16
.LBB0_100:                              # %vec.epilog.vector.body390
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a7, 0
	vst	$vr0, $a6, 0
	addi.d	$a5, $a5, 4
	...
	addi.d	$a7, $a7, 16
	bnez	$a5, .LBB0_100
# %bb.101:                              # %vec.epilog.middle.block393
	beq	$a3, $a4, .LBB0_104
...
.LBB0_118:                              # %vector.body343
	...
	addi.d	$s1, $s1, 64
	bnez	$s2, .LBB0_118
# %bb.119:                              # %middle.block348
	beq	$t3, $t5, .LBB0_59
# %bb.120:                              # %vec.epilog.iter.check353
	andi	$t4, $t3, 12
	beqz	$t4, .LBB0_126
# %bb.121:
	move	$s6, $s4
.LBB0_122:                              # %vec.epilog.ph352
	move	$t6, $t3
	...
	vrepli.b	$vr1, 0
	.p2align	4, , 16
.LBB0_123:                              # %vec.epilog.vector.body358
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $t7, 0
	vst	$vr2, $t8, 0
	vst	$vr1, $s1, 0
	...
	addi.d	$s4, $s4, 16
	bnez	$t5, .LBB0_123
# %bb.124:                              # %vec.epilog.middle.block363
	move	$s4, $s6
	bne	$t3, $t6, .LBB0_57
	b	.LBB0_59
.LBB0_125:                              # %if.then290
