...
# %bb.2:                                # %while.end
	...
	pcalau12i	$s5, %pc_hi20(Fgetlag.sortedseg1)
...
# %bb.3:                                # %if.then
	...
	jirl	$ra, $ra, 0
	move	$s3, $a0
	st.d	$a0, $s5, %pc_lo12(Fgetlag.sortedseg1)
	ori	$a1, $zero, 8
	move	$a0, $s4
	pcaddu18i	$ra, %call36(calloc)
	jirl	$ra, $ra, 0
...
# %bb.117:                              # %if.end418.thread
	...
	ld.d	$a2, $s5, %pc_lo12(Fgetlag.sortedseg1)
	move	$s0, $zero
...
# %bb.136:                              # %for.body439.lr.ph
	ld.d	$a3, $s5, %pc_lo12(Fgetlag.sortedseg1)
...
# %bb.185:                              # %for.body629.lr.ph
	ld.d	$a0, $t3, %pc_lo12(Falign_noudp.result1)
	move	$a1, $s3
	.p2align	4, , 16
...
.LBB4_142:
	move	$a5, $zero
.LBB4_143:                              # %for.body279.preheader
	slli.d	$a6, $a5, 4
	sub.d	$a4, $a4, $a6
	add.d	$a3, $a3, $a4
	alsl.d	$a4, $a5, $a2, 3
...
.LBB4_144:                              # %for.body279
	...
	addi.d	$a4, $a4, 8
	bnez	$a1, .LBB4_144
.LBB4_145:                              # %for.cond290.preheader
	bge	$a0, $s3, .LBB4_149
# %bb.146:                              # %for.body293.lr.ph
	...
	addi.d	$a5, $s4, 1
	bgeu	$a1, $a3, .LBB4_258
.LBB4_147:                              # %for.body293.preheader
	sub.d	$a1, $s4, $a5
	ld.d	$a3, $sp, 112                   # 8-byte Folded Reload
	add.w	$a1, $a1, $a3
	alsl.d	$a3, $a5, $a2, 3
...
.LBB4_157:                              # %vector.body721
	...
	xvaddi.du	$xr0, $xr0, 8
	bne	$a6, $a5, .LBB4_157
# %bb.158:                              # %middle.block727
	ori	$s6, $zero, 1
	beq	$a4, $s3, .LBB4_163
.LBB4_159:                              # %for.body469.preheader
	slli.d	$a5, $a4, 3
	slli.d	$a6, $a4, 5
	alsl.d	$a6, $a4, $a6, 4
	add.d	$a3, $a3, $a6
...
# %bb.165:
	...
	b	.LBB4_171
.LBB4_166:                              # %for.end501.thread
	ld.d	$a0, $sp, 152                   # 8-byte Folded Reload
	ld.w	$a0, $a0, 0
	ld.d	$s4, $sp, 240                   # 8-byte Folded Reload
	beqz	$a0, .LBB4_184
# %bb.167:                              # %for.cond504.preheader.thread
	ld.d	$s2, $sp, 120                   # 8-byte Folded Reload
	ld.d	$a1, $s2, %pc_lo12(Falign_udpari_long.cut1)
	ld.d	$a0, $sp, 128                   # 8-byte Folded Reload
	ld.d	$a0, $a0, %pc_lo12(Falign_udpari_long.cut2)
	b	.LBB4_183
.LBB4_168:                              # %vector.ph732
	move	$a4, $zero
	slli.d	$a2, $a1, 3
	addi.d	$a5, $a3, 32
	move	$a6, $a2
	.p2align	4, , 16
.LBB4_169:                              # %vector.body735
                                        # =>This Inner Loop Header: Depth=1
	addi.d	$a7, $a4, 1
	addi.d	$t0, $a4, 2
	addi.d	$t1, $a4, 3
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB4_169
# %bb.170:                              # %middle.block739
	ld.d	$s5, $sp, 232                   # 8-byte Folded Reload
	ld.d	$s4, $sp, 240                   # 8-byte Folded Reload
	beq	$a2, $a0, .LBB4_173
.LBB4_171:                              # %for.body486.preheader
	alsl.d	$a3, $a2, $a3, 3
	sub.d	$a4, $a0, $a2
	.p2align	4, , 16
.LBB4_172:                              # %for.body486
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a5, $a3, 0
	st.w	$a2, $a5, 40
	addi.d	$a2, $a2, 1
...
# %bb.174:
	move	$a1, $zero
	b	.LBB4_178
.LBB4_175:                              # %vector.ph744
	move	$a3, $zero
	slli.d	$a1, $a1, 3
	addi.d	$a4, $a2, 32
	move	$a5, $a1
	.p2align	4, , 16
.LBB4_176:                              # %vector.body747
                                        # =>This Inner Loop Header: Depth=1
	addi.d	$a6, $a3, 1
	addi.d	$a7, $a3, 2
	addi.d	$t0, $a3, 3
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB4_176
# %bb.177:                              # %middle.block752
	ld.d	$s4, $sp, 240                   # 8-byte Folded Reload
	beq	$a1, $a0, .LBB4_180
.LBB4_178:                              # %for.body495.preheader
	alsl.d	$a2, $a1, $a2, 3
	sub.d	$a0, $a0, $a1
	.p2align	4, , 16
.LBB4_179:                              # %for.body495
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a3, $a2, 0
	st.w	$a1, $a3, 40
	addi.d	$a1, $a1, 1
...
.LBB4_191:                              # %for.inc564
	...
	addi.d	$s1, $s1, 8
	bnez	$fp, .LBB4_191
.LBB4_192:                              # %for.cond567.preheader
	ld.d	$s2, $sp, 120                   # 8-byte Folded Reload
...
.LBB4_203:                              # %for.body640
	...
	addi.d	$a0, $a0, 8
	bnez	$a1, .LBB4_203
.LBB4_204:                              # %for.cond647.preheader
	blez	$s5, .LBB4_207
# %bb.205:                              # %for.body650.lr.ph
	ld.d	$a0, $sp, 80                    # 8-byte Folded Reload
	ld.d	$a0, $a0, %pc_lo12(Falign_udpari_long.result2)
	move	$a1, $s5
	.p2align	4, , 16
.LBB4_206:                              # %for.body650
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a2, $a0, 0
	st.b	$zero, $a2, 0
	addi.d	$a1, $a1, -1
...
.LBB4_209:                              # %for.body661
	...
	bnez	$a0, .LBB4_214
# %bb.210:                              # %for.cond670.preheader
                                        #   in Loop: Header=BB4_209 Depth=1
	blez	$s4, .LBB4_212
# %bb.211:                              # %for.body673.lr.ph
                                        #   in Loop: Header=BB4_209 Depth=1
	...
	pcaddu18i	$ra, %call36(memset)
	jirl	$ra, $ra, 0
.LBB4_212:                              # %for.cond679.preheader
                                        #   in Loop: Header=BB4_209 Depth=1
	blez	$s5, .LBB4_215
# %bb.213:                              # %for.body682.lr.ph
                                        #   in Loop: Header=BB4_209 Depth=1
	ld.d	$a0, $sp, 248                   # 8-byte Folded Reload
...
.LBB4_215:                              # %if.end688
	...
	ld.d	$a0, $sp, 48                    # 8-byte Folded Reload
	bne	$a2, $a0, .LBB4_220
# %bb.216:                              # %for.cond702.preheader
                                        #   in Loop: Header=BB4_209 Depth=1
	ld.d	$fp, $sp, 240                   # 8-byte Folded Reload
	blez	$fp, .LBB4_218
# %bb.217:                              # %for.body705.lr.ph
                                        #   in Loop: Header=BB4_209 Depth=1
	ld.d	$a0, $sp, 200                   # 8-byte Folded Reload
	...
	pcaddu18i	$ra, %call36(memset)
	jirl	$ra, $ra, 0
.LBB4_218:                              # %for.cond711.preheader
                                        #   in Loop: Header=BB4_209 Depth=1
	blez	$s5, .LBB4_221
# %bb.219:                              # %for.body714.lr.ph
                                        #   in Loop: Header=BB4_209 Depth=1
	ld.d	$a0, $sp, 192                   # 8-byte Folded Reload
...
# %bb.228:                              # %for.body765.preheader
	...
	.p2align	4, , 16
.LBB4_229:                              # %if.end781
                                        #   in Loop: Header=BB4_230 Depth=2
	ld.d	$a0, $sp, 272                   # 8-byte Folded Reload
...
.LBB4_241:                              # %for.body837
	...
	addi.d	$fp, $fp, 8
	bnez	$s3, .LBB4_241
.LBB4_242:                              # %for.cond846.preheader
                                        #   in Loop: Header=BB4_209 Depth=1
	blez	$s5, .LBB4_245
# %bb.243:                              # %for.body849.lr.ph
                                        #   in Loop: Header=BB4_209 Depth=1
	ld.d	$a0, $sp, 80                    # 8-byte Folded Reload
...
.LBB4_248:
	movgr2fr.w	$fs0, $zero
.LBB4_249:                              # %for.cond862.preheader
	ld.d	$s1, $sp, 224                   # 8-byte Folded Reload
	blez	$s4, .LBB4_252
# %bb.250:                              # %for.body865.lr.ph
	ld.d	$a0, $sp, 72                    # 8-byte Folded Reload
	ld.d	$fp, $a0, %pc_lo12(Falign_udpari_long.result1)
	.p2align	4, , 16
.LBB4_251:                              # %for.body865
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $s1, 0
	ld.d	$a1, $fp, 0
	pcaddu18i	$ra, %call36(strcpy)
	...
	addi.d	$s1, $s1, 8
	bnez	$s4, .LBB4_251
.LBB4_252:                              # %for.cond874.preheader
	blez	$s5, .LBB4_255
# %bb.253:                              # %for.body877.lr.ph
	ld.d	$a0, $sp, 80                    # 8-byte Folded Reload
	ld.d	$fp, $a0, %pc_lo12(Falign_udpari_long.result2)
	.p2align	4, , 16
.LBB4_254:                              # %for.body877
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $s0, 0
	ld.d	$a1, $fp, 0
	pcaddu18i	$ra, %call36(strcpy)
...
.LBB4_258:                              # %vector.scevcheck
	...
	sub.w	$a6, $a3, $a4
	blt	$a3, $a6, .LBB4_147
# %bb.259:                              # %vector.scevcheck
	srli.d	$a4, $a4, 32
	bnez	$a4, .LBB4_147
# %bb.260:                              # %vector.memcheck686
	alsl.d	$a4, $s4, $a2, 3
	addi.d	$a4, $a4, 8
	alsl.d	$a6, $a3, $a0, 4
	addi.d	$a6, $a6, 8
	bgeu	$a4, $a6, .LBB4_262
# %bb.261:                              # %vector.memcheck686
	alsl.d	$a4, $s3, $a2, 3
	add.d	$a3, $s4, $a3
	sub.d	$a3, $a3, $s3
	alsl.d	$a3, $a3, $a0, 4
