...
# %bb.128:                              # %vector.scevcheck
	srli.d	$a4, $a4, 32
	bnez	$a4, .LBB0_104
# %bb.129:                              # %vector.memcheck568
	alsl.d	$a4, $s3, $a2, 3
	addi.d	$a4, $a4, 8
	alsl.d	$a6, $a3, $a0, 4
	addi.d	$a6, $a6, 8
	bgeu	$a4, $a6, .LBB0_131
# %bb.130:                              # %vector.memcheck568
	alsl.d	$a4, $s8, $a2, 3
	add.d	$a3, $s3, $a3
	sub.d	$a3, $a3, $s8
	alsl.d	$a3, $a3, $a0, 4
...
# %bb.137:
	move	$a2, $zero
	b	.LBB0_141
.LBB0_138:                              # %vector.ph615
	move	$a4, $zero
	slli.d	$a2, $a1, 3
	addi.d	$a5, $a3, 32
	move	$a6, $a2
	.p2align	4, , 16
.LBB0_139:                              # %vector.body618
                                        # =>This Inner Loop Header: Depth=1
	addi.d	$a7, $a4, 1
	addi.d	$t0, $a4, 2
	addi.d	$t1, $a4, 3
...
# %bb.144:
	move	$a1, $zero
	b	.LBB0_148
.LBB0_145:                              # %vector.ph627
	move	$a3, $zero
	slli.d	$a1, $a1, 3
	addi.d	$a4, $a2, 32
	move	$a5, $a1
	.p2align	4, , 16
.LBB0_146:                              # %vector.body630
                                        # =>This Inner Loop Header: Depth=1
	addi.d	$a6, $a3, 1
	addi.d	$a7, $a3, 2
	addi.d	$t0, $a3, 3
...
# %bb.4:                                # %if.then10
	...
	jirl	$ra, $ra, 0
	ld.d	$a0, $sp, 264                   # 8-byte Folded Reload
	ld.d	$a0, $a0, %pc_lo12(Falign.tmpres1)
	pcaddu18i	$ra, %call36(FreeCharMtx)
	jirl	$ra, $ra, 0
...
.LBB2_15:                               # %if.then17
	...
	move	$s1, $a0
	ld.d	$a0, $sp, 144                   # 8-byte Folded Reload
	st.d	$s1, $a0, %pc_lo12(Falign.segment1)
	ori	$a1, $zero, 48
	move	$a0, $s5
	pcaddu18i	$ra, %call36(calloc)
	jirl	$ra, $ra, 0
...
.LBB2_170:                              # %if.end609
	ori	$a0, $zero, 1
	blt	$s2, $a0, .LBB2_173
# %bb.171:                              # %for.body613.lr.ph
	ld.d	$a1, $sp, 96                    # 8-byte Folded Reload
	ld.d	$a1, $a1, %pc_lo12(Falign.result1)
	move	$a2, $s2
	.p2align	4, , 16
.LBB2_172:                              # %for.body613
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a3, $a1, 0
	st.b	$zero, $a3, 0
	addi.d	$a2, $a2, -1
	addi.d	$a1, $a1, 8
	bnez	$a2, .LBB2_172
.LBB2_173:                              # %for.cond620.preheader
	blt	$fp, $a0, .LBB2_176
# %bb.174:                              # %for.body623.lr.ph
	ld.d	$a0, $s3, %pc_lo12(Falign.result2)
	move	$a1, $fp
	.p2align	4, , 16
.LBB2_175:                              # %for.body623
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a2, $a0, 0
	st.b	$zero, $a2, 0
	addi.d	$a1, $a1, -1
...
# %bb.177:                              # %for.body634.lr.ph
	...
	b	.LBB2_179
	.p2align	4, , 16
.LBB2_178:                              # %for.cond630.loopexit
                                        #   in Loop: Header=BB2_179 Depth=1
	ld.w	$a0, $sp, 284
	addi.w	$a0, $a0, -1
	ld.d	$s6, $sp, 200                   # 8-byte Folded Reload
	bge	$s3, $a0, .LBB2_226
.LBB2_179:                              # %for.body634
                                        # =>This Loop Header: Depth=1
...
# %bb.180:                              # %if.then639
	...
	b	.LBB2_185
	.p2align	4, , 16
.LBB2_181:                              # %for.cond643.preheader
                                        #   in Loop: Header=BB2_179 Depth=1
	blt	$s2, $s4, .LBB2_183
# %bb.182:                              # %for.body646.lr.ph
                                        #   in Loop: Header=BB2_179 Depth=1
	ld.d	$a0, $sp, 168                   # 8-byte Folded Reload
	ld.d	$a0, $a0, %pc_lo12(Falign.sgap1)
	ori	$a1, $zero, 111
	...
	pcaddu18i	$ra, %call36(memset)
	jirl	$ra, $ra, 0
.LBB2_183:                              # %for.cond652.preheader
                                        #   in Loop: Header=BB2_179 Depth=1
	blt	$fp, $s4, .LBB2_185
# %bb.184:                              # %for.body655.lr.ph
                                        #   in Loop: Header=BB2_179 Depth=1
	ld.d	$a0, $sp, 160                   # 8-byte Folded Reload
	ld.d	$a0, $a0, %pc_lo12(Falign.sgap2)
	ori	$a1, $zero, 111
...
.LBB2_185:                              # %if.end661
	...
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	bne	$a2, $a0, .LBB2_190
# %bb.186:                              # %for.cond675.preheader
                                        #   in Loop: Header=BB2_179 Depth=1
	blt	$s2, $s4, .LBB2_188
# %bb.187:                              # %for.body678.lr.ph
                                        #   in Loop: Header=BB2_179 Depth=1
	ld.d	$a0, $sp, 152                   # 8-byte Folded Reload
	...
	pcaddu18i	$ra, %call36(memset)
	jirl	$ra, $ra, 0
.LBB2_188:                              # %for.cond684.preheader
                                        #   in Loop: Header=BB2_179 Depth=1
	blt	$fp, $s4, .LBB2_191
# %bb.189:                              # %for.body687.lr.ph
                                        #   in Loop: Header=BB2_179 Depth=1
	ld.d	$a0, $sp, 144                   # 8-byte Folded Reload
...
.LBB2_219:                              # %for.body833
	...
	addi.d	$s0, $s0, 8
	bnez	$s6, .LBB2_219
.LBB2_220:                              # %for.cond842.preheader
                                        #   in Loop: Header=BB2_179 Depth=1
	blt	$fp, $s4, .LBB2_178
# %bb.221:                              # %for.body845.lr.ph
                                        #   in Loop: Header=BB2_179 Depth=1
...
.LBB2_225:
	movgr2fr.w	$fs0, $zero
.LBB2_226:                              # %for.cond858.preheader
	ori	$s0, $zero, 1
	ld.d	$s3, $sp, 240                   # 8-byte Folded Reload
	ld.d	$s4, $sp, 88                    # 8-byte Folded Reload
	ld.d	$a0, $sp, 96                    # 8-byte Folded Reload
	blt	$s2, $s0, .LBB2_229
# %bb.227:                              # %for.body861.lr.ph
	ld.d	$s1, $a0, %pc_lo12(Falign.result1)
	.p2align	4, , 16
.LBB2_228:                              # %for.body861
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $s3, 0
	ld.d	$a1, $s1, 0
	pcaddu18i	$ra, %call36(strcpy)
	...
	addi.d	$s3, $s3, 8
	bnez	$s2, .LBB2_228
.LBB2_229:                              # %for.cond870.preheader
	blt	$fp, $s0, .LBB2_232
# %bb.230:                              # %for.body873.lr.ph
	ld.d	$s0, $s4, %pc_lo12(Falign.result2)
	.p2align	4, , 16
.LBB2_231:                              # %for.body873
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $s7, 0
	ld.d	$a1, $s0, 0
	pcaddu18i	$ra, %call36(strcpy)
...
# %bb.234:                              # %vector.scevcheck
	srli.d	$a4, $a4, 32
	bnez	$a4, .LBB2_105
# %bb.235:                              # %vector.memcheck627
	alsl.d	$a4, $s3, $a2, 3
	addi.d	$a4, $a4, 8
	alsl.d	$a6, $a3, $a0, 4
	addi.d	$a6, $a6, 8
	bgeu	$a4, $a6, .LBB2_237
# %bb.236:                              # %vector.memcheck627
	alsl.d	$a4, $s8, $a2, 3
	add.d	$a3, $s3, $a3
	sub.d	$a3, $a3, $s8
	alsl.d	$a3, $a3, $a0, 4
...
# %bb.172:                              # %for.cond504.preheader.thread
	ld.d	$a1, $sp, 168                   # 8-byte Folded Reload
	ld.d	$a3, $a1, %pc_lo12(Falign_noudp.cut2)
	ld.d	$t2, $sp, 296                   # 8-byte Folded Reload
	b	.LBB3_183
.LBB3_173:                              # %if.else532.thread
	...
	b	.LBB3_184
.LBB3_174:                              # %vector.ph780
	move	$a3, $zero
	slli.d	$a0, $a0, 3
	addi.d	$a4, $a2, 32
	move	$a5, $a0
	.p2align	4, , 16
.LBB3_175:                              # %vector.body783
                                        # =>This Inner Loop Header: Depth=1
	addi.d	$a6, $a3, 1
	addi.d	$a7, $a3, 2
	addi.d	$t0, $a3, 3
...
# %bb.186:                              # %for.body629.lr.ph
	ld.d	$a1, $fp, %pc_lo12(Falign_noudp.result1)
	move	$a3, $t2
	.p2align	4, , 16
...
.LBB3_240:                              # %if.else532
	...
	ld.d	$a2, $sp, 168                   # 8-byte Folded Reload
	ld.d	$a3, $a2, %pc_lo12(Falign_noudp.cut2)
	ld.d	$a2, $a4, 0
	st.w	$zero, $a0, 0
	st.w	$zero, $a3, 0
	ld.w	$a5, $a2, 8
...
# %bb.257:                              # %vector.scevcheck
	srli.d	$a4, $a4, 32
	bnez	$a4, .LBB3_148
# %bb.258:                              # %vector.memcheck721
	alsl.d	$a4, $s3, $a2, 3
	addi.d	$a4, $a4, 8
	alsl.d	$a6, $a3, $a0, 4
	addi.d	$a6, $a6, 8
	bgeu	$a4, $a6, .LBB3_260
# %bb.259:                              # %vector.memcheck721
	alsl.d	$a4, $s8, $a2, 3
	add.d	$a3, $s3, $a3
	sub.d	$a3, $a3, $s8
	alsl.d	$a3, $a3, $a0, 4
...
# %bb.168:                              # %for.cond504.preheader.thread
	...
	b	.LBB4_184
.LBB4_169:                              # %vector.ph704
	move	$a4, $zero
	slli.d	$a2, $a1, 3
	addi.d	$a5, $a3, 32
	move	$a6, $a2
	.p2align	4, , 16
.LBB4_170:                              # %vector.body707
                                        # =>This Inner Loop Header: Depth=1
	addi.d	$a7, $a4, 1
	addi.d	$t0, $a4, 2
	addi.d	$t1, $a4, 3
...
# %bb.175:
	move	$a1, $zero
	b	.LBB4_179
.LBB4_176:                              # %vector.ph716
	move	$a3, $zero
	slli.d	$a1, $a1, 3
	addi.d	$a4, $a2, 32
	move	$a5, $a1
	.p2align	4, , 16
.LBB4_177:                              # %vector.body719
                                        # =>This Inner Loop Header: Depth=1
	addi.d	$a6, $a3, 1
	addi.d	$a7, $a3, 2
	addi.d	$t0, $a3, 3
...
# %bb.261:                              # %vector.scevcheck
	srli.d	$a4, $a4, 32
	bnez	$a4, .LBB4_148
# %bb.262:                              # %vector.memcheck657
	alsl.d	$a4, $s4, $a2, 3
	addi.d	$a4, $a4, 8
	alsl.d	$a6, $a3, $a0, 4
	addi.d	$a6, $a6, 8
	bgeu	$a4, $a6, .LBB4_264
# %bb.263:                              # %vector.memcheck657
	alsl.d	$a4, $s3, $a2, 3
	add.d	$a3, $s4, $a3
	sub.d	$a3, $a3, $s3
	alsl.d	$a3, $a3, $a0, 4
