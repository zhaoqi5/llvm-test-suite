...
# %bb.68:                               # %iter.check485
	...
	ori	$a6, $zero, 63
	bgeu	$a6, $a5, .LBB0_87
# %bb.69:                               # %vector.main.loop.iter.check487
	ori	$a4, $zero, 16
	bgeu	$a2, $a4, .LBB0_80
# %bb.70:
	move	$a4, $zero
...
.LBB0_81:                               # %vector.body491
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB0_81
# %bb.82:                               # %middle.block494
	beq	$a2, $a4, .LBB0_89
# %bb.83:                               # %vec.epilog.iter.check499
	andi	$a5, $t2, 12
	beqz	$a5, .LBB0_87
.LBB0_84:                               # %vec.epilog.ph498
	move	$a7, $a4
	...
	alsl.d	$a7, $a7, $a1, 2
	.p2align	4, , 16
.LBB0_85:                               # %vec.epilog.vector.body506
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a7, 0
	vst	$vr0, $a6, 0
	addi.d	$a5, $a5, 4
	...
	addi.d	$a7, $a7, 16
	bnez	$a5, .LBB0_85
# %bb.86:                               # %vec.epilog.middle.block509
	beq	$a2, $a4, .LBB0_89
