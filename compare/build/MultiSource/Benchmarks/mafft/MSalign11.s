...
.LBB2_69:                               # %for.body297
	...
	addi.w	$a0, $a0, 1
	bnez	$a1, .LBB2_69
.LBB2_70:                               # %for.cond308.preheader
	blez	$t5, .LBB2_73
# %bb.71:                               # %for.body311.preheader
	ld.d	$a0, $sp, 168                   # 8-byte Folded Reload
...
.LBB2_72:                               # %for.body311
	...
	addi.d	$s2, $s2, 4
	bnez	$s7, .LBB2_72
.LBB2_73:                               # %for.cond319.preheader
	blez	$s3, .LBB2_76
# %bb.74:                               # %for.body322.preheader
	ld.d	$a0, $sp, 216                   # 8-byte Folded Reload
	bstrpick.d	$s7, $a0, 30, 0
	pcalau12i	$a0, %got_pc_hi20(stderr)
	ld.d	$s5, $a0, %got_pc_lo12(stderr)
...
.LBB2_80:                               # %vector.body391
	...
	addi.d	$a3, $a3, 32
	bnez	$a4, .LBB2_80
# %bb.81:                               # %middle.block396
	beq	$a1, $a2, .LBB2_84
.LBB2_82:                               # %for.body.i.preheader
	alsl.d	$a3, $a2, $s5, 3
	sub.d	$a1, $a1, $a2
	addi.d	$a2, $a2, 1
	.p2align	4, , 16
...
# %bb.86:
	move	$a3, $zero
	b	.LBB2_96
.LBB2_87:                               # %vector.main.loop.iter.check404
	ori	$a3, $zero, 16
	bgeu	$a2, $a3, .LBB2_89
# %bb.88:
	move	$a3, $zero
	b	.LBB2_93
.LBB2_89:                               # %vector.ph405
	andi	$a5, $a4, 12
	bstrpick.d	$a3, $a4, 31, 4
	slli.d	$a3, $a3, 4
	pcalau12i	$a6, %pc_hi20(.LCPI2_2)
	xvld	$xr0, $a6, %pc_lo12(.LCPI2_2)
	addi.d	$a6, $a1, 32
	xvrepli.b	$xr1, -1
	xvrepli.w	$xr2, -9
	move	$a7, $a3
	.p2align	4, , 16
.LBB2_90:                               # %vector.body408
                                        # =>This Inner Loop Header: Depth=1
	xvxor.v	$xr3, $xr0, $xr1
	xvsub.w	$xr4, $xr2, $xr0
	xvst	$xr3, $a6, -32
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB2_90
# %bb.91:                               # %middle.block414
	beq	$a2, $a3, .LBB2_98
# %bb.92:                               # %vec.epilog.iter.check418
	beqz	$a5, .LBB2_96
.LBB2_93:                               # %vec.epilog.ph420
	move	$a5, $a3
	pcalau12i	$a3, %pc_hi20(.LCPI2_3)
	vld	$vr0, $a3, %pc_lo12(.LCPI2_3)
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB2_94:                               # %vec.epilog.vector.body423
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a5, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a5, $a5, 16
	bnez	$a4, .LBB2_94
# %bb.95:                               # %vec.epilog.middle.block428
	beq	$a2, $a3, .LBB2_98
.LBB2_96:                               # %for.body12.i.preheader
	alsl.d	$a1, $a3, $a1, 2
	nor	$a4, $a3, $zero
	sub.d	$a2, $a2, $a3
	.p2align	4, , 16
.LBB2_97:                               # %for.body12.i
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a4, $a1, 0
	addi.d	$a1, $a1, 4
	addi.d	$a2, $a2, -1
...
.LBB2_98:                               # %for.end19.i
	...
	stx.b	$zero, $a2, $a1
	bltz	$a1, .LBB2_114
# %bb.99:                               # %for.body33.i.preheader
	move	$a3, $zero
	addi.w	$a2, $zero, -1
	ori	$a4, $zero, 45
	.p2align	4, , 16
.LBB2_100:                              # %for.body33.i
                                        # =>This Loop Header: Depth=1
...
.LBB2_106:                              # %while.body.i263
	...
	st.b	$a4, $t3, -1
	bnez	$t2, .LBB2_106
# %bb.107:                              # %while.end.loopexit.i
                                        #   in Loop: Header=BB2_100 Depth=1
	add.d	$a3, $s2, $a3
	add.d	$a3, $t1, $a3
.LBB2_108:                              # %while.end.i
                                        #   in Loop: Header=BB2_100 Depth=1
	add.w	$a0, $t0, $a0
	beq	$t0, $a2, .LBB2_111
# %bb.109:                              # %while.body76.preheader.i
                                        #   in Loop: Header=BB2_100 Depth=1
	nor	$t0, $t0, $zero
	.p2align	4, , 16
.LBB2_110:                              # %while.body76.i
                                        #   Parent Loop BB2_100 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$t1, $s1, 0
	addi.d	$t2, $t1, -1
	...
	addi.d	$a3, $a3, 1
	bnez	$t0, .LBB2_110
.LBB2_111:                              # %while.end87.i
                                        #   in Loop: Header=BB2_100 Depth=1
	blez	$a6, .LBB2_114
# %bb.112:                              # %while.end87.i
                                        #   in Loop: Header=BB2_100 Depth=1
	blez	$a7, .LBB2_114
# %bb.113:                              # %if.end93.i
                                        #   in Loop: Header=BB2_100 Depth=1
