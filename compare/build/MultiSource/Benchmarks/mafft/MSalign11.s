...
.LBB0_40:
	move	$a2, $a0
.LBB0_41:                               # %for.body32.preheader240
	addi.d	$a0, $a2, 1
	alsl.d	$a1, $a2, $fp, 2
	alsl.d	$a3, $a2, $s7, 2
	alsl.d	$a2, $a2, $s0, 2
...
# %bb.87:
	move	$a3, $zero
	b	.LBB2_97
.LBB2_88:                               # %vector.main.loop.iter.check394
	ori	$a3, $zero, 16
	bgeu	$a2, $a3, .LBB2_93
# %bb.89:
	move	$a3, $zero
.LBB2_90:                               # %vec.epilog.ph408
	move	$a5, $a3
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB2_91:                               # %vec.epilog.vector.body414
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a5, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a5, $a5, 16
	bnez	$a4, .LBB2_91
# %bb.92:                               # %vec.epilog.middle.block419
	bne	$a2, $a3, .LBB2_97
	b	.LBB2_99
.LBB2_93:                               # %vector.ph395
...
.LBB2_94:                               # %vector.body398
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB2_94
# %bb.95:                               # %middle.block404
	beq	$a2, $a3, .LBB2_99
# %bb.96:                               # %vec.epilog.iter.check409
	andi	$a5, $a4, 12
	bnez	$a5, .LBB2_90
