...
.LBB7_46:                               # %for.cond84.preheader.us
	...
	move	$t6, $fp
	bltu	$a4, $t2, .LBB7_52
# %bb.47:                               # %vector.memcheck215
                                        #   in Loop: Header=BB7_46 Depth=1
	add.d	$t6, $t5, $a0
	bgeu	$t6, $a5, .LBB7_49
# %bb.48:                               # %vector.memcheck215
                                        #   in Loop: Header=BB7_46 Depth=1
	add.d	$t7, $t5, $a3
	move	$t6, $fp
	bltu	$s0, $t7, .LBB7_52
.LBB7_49:                               # %vector.ph228
                                        #   in Loop: Header=BB7_46 Depth=1
	vldrepl.d	$vr0, $t4, 0
	add.d	$t6, $t5, $t0
	move	$t7, $a6
...
.LBB22_9:                               # %for.body
	...
	addi.d	$a2, $a2, 4
	bnez	$a3, .LBB22_9
.LBB22_10:                              # %for.cond11.preheader
	ld.w	$a3, $a0, 0
	bltz	$a3, .LBB22_13
# %bb.11:                               # %for.body15.lr.ph
	ld.d	$a2, $s6, %pc_lo12(nodeFromABranch.table)
...
.LBB22_12:                              # %for.body15
	...
	addi.d	$a3, $a3, 4
	bgez	$a5, .LBB22_12
.LBB22_13:                              # %for.cond21.preheader
	ld.w	$a3, $a1, 0
	bltz	$a3, .LBB22_16
# %bb.14:                               # %for.body25.lr.ph
	ld.d	$a2, $s6, %pc_lo12(nodeFromABranch.table)
	bstrpick.d	$a4, $a3, 31, 0
	addi.d	$a3, $a1, 4
	.p2align	4, , 16
.LBB22_15:                              # %for.body25
	...
	addi.d	$a3, $a3, 4
	bgez	$a5, .LBB22_15
.LBB22_16:                              # %for.cond31.preheader
	ld.d	$a2, $s5, %pc_lo12(nodeFromABranch.outergroup2)
	blez	$s1, .LBB22_21
# %bb.17:                               # %for.body33.lr.ph
...
.LBB22_24:                              # %for.body51
	...
	addi.d	$a3, $a3, 4
	bgez	$a5, .LBB22_24
.LBB22_25:                              # %for.cond76.preheader
	ld.w	$a4, $a1, 0
	bltz	$a4, .LBB22_28
# %bb.26:                               # %for.body80.preheader
	addi.d	$a3, $a1, 4
	bstrpick.d	$a4, $a4, 31, 0
	.p2align	4, , 16
.LBB22_27:                              # %for.body80
	...
	addi.d	$a3, $a3, 4
	bgez	$a5, .LBB22_27
.LBB22_28:                              # %for.cond108.preheader
	ld.w	$a3, $a2, 0
	bltz	$a3, .LBB22_31
# %bb.29:                               # %for.body112.preheader
	bstrpick.d	$a3, $a3, 31, 0
	addi.d	$a2, $a2, 4
	.p2align	4, , 16
.LBB22_30:                              # %for.body112
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a4, $a1, 0
	ld.w	$a5, $a0, 0
	slli.d	$a6, $a3, 3
