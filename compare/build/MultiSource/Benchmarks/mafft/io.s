...
.LBB47_2:                               # %while.cond2.preheader.lr.ph
	...
	pcalau12i	$a1, %pc_hi20(ReadBlastm7_avscore.al)
	addi.d	$s5, $a1, %pc_lo12(ReadBlastm7_avscore.al)
	lu12i.w	$a1, 1220
	ori	$s6, $a1, 2780
	pcalau12i	$a1, %pc_hi20(ReadBlastm7_avscore.qal)
	addi.d	$a1, $a1, %pc_lo12(ReadBlastm7_avscore.qal)
	st.d	$a1, $sp, 96                    # 8-byte Folded Spill
	addi.d	$a1, $a1, 1
	st.d	$a1, $sp, 88                    # 8-byte Folded Spill
	ori	$fp, $zero, 60
	pcalau12i	$a1, %pc_hi20(ReadBlastm7_avscore.tal)
	addi.d	$a1, $a1, %pc_lo12(ReadBlastm7_avscore.tal)
...
# %bb.13:                               # %while.body39
	...
	or	$a0, $a0, $a1
	bnez	$a0, .LBB47_12
.LBB47_14:                              # %while.cond49.preheader
                                        #   in Loop: Header=BB47_4 Depth=1
	ld.d	$s4, $sp, 48                    # 8-byte Folded Reload
	.p2align	4, , 16
.LBB47_15:                              # %while.cond49
                                        #   Parent Loop BB47_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.d	$a0, $sp, 184
	ori	$a1, $zero, 255
	...
	beqz	$a0, .LBB47_17
# %bb.16:                               # %while.body53
                                        #   in Loop: Header=BB47_15 Depth=2
	ld.d	$a0, $sp, 192
	ld.d	$a1, $sp, 184
	lu52i.d	$a2, $s8, 1155
	xor	$a0, $a0, $a2
...
# %bb.39:                               #   in Loop: Header=BB47_4 Depth=1
	...
	fmov.d	$fs3, $fs0
	b	.LBB47_3
.LBB47_40:                              # %while.end180.loopexit
	ftintrz.w.d	$fa0, $fs2
	movfr2gr.s	$s0, $fa0
.LBB47_41:                              # %while.end180
	ld.d	$a0, $sp, 40                    # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	move	$a0, $s0
...
.LBB48_3:                               # %while.cond2.preheader.lr.ph
	...
	lu52i.d	$a1, $a1, 998
	st.d	$a1, $sp, 128                   # 8-byte Folded Spill
	pcalau12i	$a1, %pc_hi20(ReadBlastm7_scoreonly.al)
	addi.d	$s4, $a1, %pc_lo12(ReadBlastm7_scoreonly.al)
	lu12i.w	$a1, 1220
	ori	$s5, $a1, 2780
	pcalau12i	$a1, %pc_hi20(ReadBlastm7_scoreonly.qal)
	addi.d	$a1, $a1, %pc_lo12(ReadBlastm7_scoreonly.qal)
	st.d	$a1, $sp, 96                    # 8-byte Folded Spill
	addi.d	$a1, $a1, 1
	st.d	$a1, $sp, 88                    # 8-byte Folded Spill
	ori	$s6, $zero, 60
	pcalau12i	$a1, %pc_hi20(ReadBlastm7_scoreonly.tal)
	addi.d	$a1, $a1, %pc_lo12(ReadBlastm7_scoreonly.tal)
	st.d	$zero, $sp, 104                 # 8-byte Folded Spill
	st.d	$a1, $sp, 80                    # 8-byte Folded Spill
	addi.d	$a1, $a1, 1
	st.d	$a1, $sp, 72                    # 8-byte Folded Spill
...
# %bb.14:                               # %while.body39
	...
	or	$a0, $a0, $a1
	bnez	$a0, .LBB48_13
.LBB48_15:                              # %while.cond49.preheader
                                        #   in Loop: Header=BB48_5 Depth=1
	ld.d	$fp, $sp, 48                    # 8-byte Folded Reload
	.p2align	4, , 16
.LBB48_16:                              # %while.cond49
                                        #   Parent Loop BB48_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.d	$a0, $sp, 184
	ori	$a1, $zero, 255
...
.LBB49_2:                               # %while.cond1.preheader.lr.ph
	...
	addi.d	$s7, $a0, %pc_lo12(ReadBlastm7.al)
	lu12i.w	$a0, 1220
	ori	$s8, $a0, 2780
...
.LBB51_3:                               # %while.body.lr.ph
	...
	addi.d	$s6, $a0, %pc_lo12(ReadFasta34noalign.junban)
	pcalau12i	$a0, %pc_hi20(.L.str.46)
	addi.d	$s2, $a0, %pc_lo12(.L.str.46)
	move	$s3, $zero
	b	.LBB51_5
	.p2align	4, , 16
.LBB51_4:                               # %if.end
...
# %bb.8:                                # %while.cond28.preheader
	...
	addi.d	$a0, $a0, %pc_lo12(ReadFasta34m10_nuc.qal)
	st.d	$a0, $sp, 112                   # 8-byte Folded Spill
	pcalau12i	$a0, %pc_hi20(ReadFasta34m10_nuc.tal)
	addi.d	$a0, $a0, %pc_lo12(ReadFasta34m10_nuc.tal)
...
.LBB52_34:                              # %if.then137
	...
	pcaddu18i	$ra, %call36(ungetc)
	jirl	$ra, $ra, 0
.LBB52_35:                              # %while.end151
                                        #   in Loop: Header=BB52_9 Depth=1
	st.b	$zero, $s4, 0
	.p2align	4, , 16
.LBB52_36:                              # %while.cond152
                                        #   Parent Loop BB52_9 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.d	$a0, $sp, 168
	ori	$a1, $zero, 255
...
.LBB52_44:                              # %while.end197
	...
	addi.w	$s8, $a0, -1
	ld.d	$a0, $sp, 104                   # 8-byte Folded Reload
.LBB52_45:                              # %while.cond203.outer
                                        #   Parent Loop BB52_9 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB52_46 Depth 3
	st.d	$a0, $sp, 88                    # 8-byte Folded Spill
	.p2align	4, , 16
.LBB52_46:                              # %while.cond203
                                        #   Parent Loop BB52_9 Depth=1
                                        #     Parent Loop BB52_45 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	move	$a0, $s0
	pcaddu18i	$ra, %call36(fgetc)
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB52_52
# %bb.47:                               # %while.cond203
                                        #   in Loop: Header=BB52_46 Depth=3
	move	$s4, $a0
	ori	$a0, $zero, 62
	beq	$s4, $a0, .LBB52_51
# %bb.48:                               # %if.end211
...
.LBB52_53:                              # %do.body.i
	...
	beq	$s7, $s1, .LBB52_55
# %bb.54:                               # %if.end3.i
                                        #   in Loop: Header=BB52_53 Depth=2
	ld.bu	$a1, $a2, 0
	addi.d	$a3, $a1, -45
	sltu	$a3, $zero, $a3
	add.w	$s1, $s1, $a3
...
.LBB53_2:                               # %while.body.lr.ph
	...
	lu12i.w	$a1, 177107
	ori	$s5, $a1, 3389
	pcalau12i	$a1, %pc_hi20(ReadFasta34m10.junban)
	addi.d	$a1, $a1, %pc_lo12(ReadFasta34m10.junban)
	st.d	$a1, $sp, 120                   # 8-byte Folded Spill
	pcalau12i	$a1, %pc_hi20(.L.str.46)
	addi.d	$s3, $a1, %pc_lo12(.L.str.46)
	move	$s8, $zero
...
# %bb.8:                                # %while.cond23.preheader
	...
	addi.d	$a0, $a0, %pc_lo12(ReadFasta34m10.qal)
	st.d	$a0, $sp, 96                    # 8-byte Folded Spill
	pcalau12i	$a0, %pc_hi20(ReadFasta34m10.tal)
	addi.d	$a0, $a0, %pc_lo12(ReadFasta34m10.tal)
	st.d	$a0, $sp, 88                    # 8-byte Folded Spill
	move	$s4, $zero
	lu12i.w	$a0, 472726
	ori	$a0, $a0, 1119
...
.LBB53_43:                              # %while.end192
	...
	addi.w	$s2, $a0, -1
	ld.d	$a0, $sp, 88                    # 8-byte Folded Reload
.LBB53_44:                              # %while.cond198.outer
                                        #   Parent Loop BB53_9 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB53_45 Depth 3
	st.d	$a0, $sp, 64                    # 8-byte Folded Spill
	.p2align	4, , 16
.LBB53_45:                              # %while.cond198
                                        #   Parent Loop BB53_9 Depth=1
                                        #     Parent Loop BB53_44 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	move	$a0, $s0
	pcaddu18i	$ra, %call36(fgetc)
	jirl	$ra, $ra, 0
...
.LBB53_52:                              # %do.body.i
	...
	beq	$s1, $s8, .LBB53_54
# %bb.53:                               # %if.end3.i
                                        #   in Loop: Header=BB53_52 Depth=2
	ld.bu	$a1, $a2, 0
	addi.d	$a3, $a1, -45
	sltu	$a3, $zero, $a3
	add.w	$s8, $s8, $a3
...
# %bb.1:                                # %while.body.lr.ph
	...
	lu12i.w	$a1, 177107
	ori	$fp, $a1, 3389
	pcalau12i	$a1, %pc_hi20(ReadFasta34.junban)
	addi.d	$s5, $a1, %pc_lo12(ReadFasta34.junban)
	pcalau12i	$a1, %pc_hi20(.L.str.46)
	addi.d	$s4, $a1, %pc_lo12(.L.str.46)
	move	$s1, $zero
	lu12i.w	$a1, 250547
	ori	$a1, $a1, 3646
	lu32i.d	$a1, -180931
...
# %bb.8:
	move	$s7, $zero
	b	.LBB79_15
.LBB79_9:                               # %while.body39.preheader
...
# %bb.16:                               # %while.body61
	...
	or	$a0, $a0, $a1
	bnez	$a0, .LBB79_15
.LBB79_17:                              # %while.end69
	move	$a0, $s6
	pcaddu18i	$ra, %call36(feof)
	jirl	$ra, $ra, 0
	bnez	$a0, .LBB79_23
# %bb.18:                               # %while.body74.preheader
	st.d	$s4, $sp, 16                    # 8-byte Folded Spill
	addi.d	$a0, $sp, 1264
	ori	$a1, $zero, 999
	move	$a2, $s6
...
# %bb.21:                               # %while.body74
	...
	or	$a0, $a0, $a1
	bnez	$a0, .LBB79_20
.LBB79_22:                              # %while.end95
	addi.w	$a0, $s4, 0
	addi.w	$a1, $s7, 0
	ld.d	$s4, $sp, 16                    # 8-byte Folded Reload
	bne	$a1, $a0, .LBB79_39
.LBB79_23:                              # %for.cond.preheader
	addi.w	$a0, $s7, 0
	blez	$a0, .LBB79_36
# %bb.24:                               # %for.body.preheader
	move	$a1, $a0
