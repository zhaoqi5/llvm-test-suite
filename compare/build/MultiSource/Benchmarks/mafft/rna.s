...
.LBB1_96:                               #   in Loop: Header=BB1_93 Depth=5
	...
	b	.LBB1_100
	.p2align	4, , 16
.LBB1_97:                               # %for.body3.us.if.then54.us_crit_edge.i.us422
                                        #   in Loop: Header=BB1_100 Depth=6
	fld.d	$fa5, $a7, 0
	ori	$t3, $zero, 36
.LBB1_98:                               # %if.then54.us.i.us424
                                        #   in Loop: Header=BB1_100 Depth=6
	mul.d	$a5, $t3, $ra
	pcalau12i	$t3, %got_pc_hi20(n_dis)
	ld.d	$t3, $t3, %got_pc_lo12(n_dis)
...
.LBB1_99:                               # %for.inc.us.i257.us
	...
	addi.d	$t2, $t2, 8
	beqz	$t4, .LBB1_92
.LBB1_100:                              # %for.body3.us.i255.us412
                                        #   Parent Loop BB1_76 Depth=1
                                        #     Parent Loop BB1_80 Depth=2
                                        #       Parent Loop BB1_82 Depth=3
                                        #         Parent Loop BB1_86 Depth=4
...
.LBB1_113:                              #   in Loop: Header=BB1_110 Depth=5
	...
	b	.LBB1_117
	.p2align	4, , 16
.LBB1_114:                              # %for.body3.us.if.then54.us_crit_edge.i333.us394
                                        #   in Loop: Header=BB1_117 Depth=6
	fld.d	$fa5, $a7, 0
	ori	$a0, $zero, 36
.LBB1_115:                              # %if.then54.us.i329.us396
                                        #   in Loop: Header=BB1_117 Depth=6
	mul.d	$a0, $a0, $ra
	pcalau12i	$a5, %got_pc_hi20(n_dis)
	ld.d	$a5, $a5, %got_pc_lo12(n_dis)
	add.d	$a0, $a5, $a0
.LBB1_116:                              # %for.inc.us.i312.us
                                        #   in Loop: Header=BB1_117 Depth=6
	slli.d	$a2, $a2, 2
	ldx.w	$a0, $a0, $a2
	movgr2fr.w	$fa6, $a0
	...
	addi.d	$t2, $t2, 8
	beqz	$t4, .LBB1_109
.LBB1_117:                              # %for.body3.us.i293.us384
                                        #   Parent Loop BB1_76 Depth=1
                                        #     Parent Loop BB1_80 Depth=2
                                        #       Parent Loop BB1_82 Depth=3
                                        #         Parent Loop BB1_86 Depth=4
	...
	ldx.w	$a2, $a3, $a2
	blt	$t6, $a2, .LBB1_114
# %bb.118:                              # %if.else40.us.i304.us392
                                        #   in Loop: Header=BB1_117 Depth=6
	ldx.b	$a0, $a0, $s5
	slli.d	$a0, $a0, 2
	ldx.w	$a0, $a3, $a0
...
.LBB1_122:                              #   in Loop: Header=BB1_76 Depth=1
	move	$a0, $a7
	.p2align	4, , 16
.LBB1_123:                              # %for.cond198.preheader
                                        #   Parent Loop BB1_76 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$a2, $a0, 40
	addi.d	$a0, $a0, 24
	bne	$a2, $t5, .LBB1_123
	b	.LBB1_75
.LBB1_124:                              # %for.cond268.preheader
	pcalau12i	$a1, %pc_hi20(foldrna.pairpt1)
	st.d	$a0, $a1, %pc_lo12(foldrna.pairpt1)
	blez	$s3, .LBB1_166
# %bb.125:                              # %for.cond272.preheader.us.preheader
	move	$a2, $zero
	ld.d	$a0, $sp, 192                   # 8-byte Folded Reload
	...
	b	.LBB1_127
	.p2align	4, , 16
.LBB1_126:                              # %for.cond272.for.inc290_crit_edge.us
	...
	ld.d	$a0, $sp, 272                   # 8-byte Folded Reload
	beq	$a2, $a0, .LBB1_165
.LBB1_127:                              # %for.cond272.preheader.us
                                        # =>This Loop Header: Depth=1
	...
	ldx.d	$s2, $t0, $a0
	blez	$s8, .LBB1_135
# %bb.128:                              # %for.body275.lr.ph.split.us.us
                                        #   in Loop: Header=BB1_127 Depth=1
	ld.d	$a0, $sp, 296                   # 8-byte Folded Reload
	blez	$a0, .LBB1_137
# %bb.129:                              # %for.body275.us.us.us.preheader
                                        #   in Loop: Header=BB1_127 Depth=1
	move	$s1, $zero
	.p2align	4, , 16
.LBB1_130:                              # %for.body275.us.us.us
	...
	fmov.s	$fa3, $fa1
	.p2align	4, , 16
.LBB1_131:                              # %for.cond1.preheader.us.i340.us.us.us
                                        #   Parent Loop BB1_127 Depth=1
	...
	move	$ra, $a7
	.p2align	4, , 16
.LBB1_132:                              # %for.body3.us.i345.us.us.us
                                        #   Parent Loop BB1_127 Depth=1
                                        #     Parent Loop BB1_130 Depth=2
	...
	addi.d	$s5, $s5, 8
	bnez	$ra, .LBB1_132
# %bb.133:                              # %for.cond1.for.inc34_crit_edge.us.i.us.us.us
...
# %bb.136:                              #   in Loop: Header=BB1_127 Depth=1
	...
	b	.LBB1_156
	.p2align	4, , 16
.LBB1_137:                              # %iter.check776
                                        #   in Loop: Header=BB1_127 Depth=1
	ld.d	$a0, $sp, 288                   # 8-byte Folded Reload
	bgeu	$a0, $t8, .LBB1_145
# %bb.138:                              #   in Loop: Header=BB1_127 Depth=1
	move	$a1, $zero
.LBB1_139:                              # %for.body275.us.us460.preheader
                                        #   in Loop: Header=BB1_127 Depth=1
	alsl.d	$a0, $a1, $s3, 2
	alsl.d	$s1, $a1, $s2, 2
...
# %bb.142:                              # %vector.memcheck807
	...
	and	$s1, $s4, $s1
	bnez	$s1, .LBB1_156
# %bb.143:                              # %vector.main.loop.iter.check821
                                        #   in Loop: Header=BB1_127 Depth=1
...
# %bb.146:                              # %vector.memcheck769
	...
	and	$s1, $s4, $s1
	bnez	$s1, .LBB1_139
# %bb.147:                              # %vector.main.loop.iter.check778
                                        #   in Loop: Header=BB1_127 Depth=1
	ld.d	$a1, $sp, 288                   # 8-byte Folded Reload
	ori	$t4, $zero, 16
	bgeu	$a1, $t4, .LBB1_158
...
.LBB1_150:                              # %vector.body825
	...
	addi.d	$s1, $s1, 64
	bnez	$s4, .LBB1_150
# %bb.151:                              # %middle.block834
                                        #   in Loop: Header=BB1_127 Depth=1
	ld.d	$a1, $sp, 288                   # 8-byte Folded Reload
	beq	$a1, $t2, .LBB1_126
# %bb.152:                              # %vec.epilog.iter.check838
                                        #   in Loop: Header=BB1_127 Depth=1
	move	$s1, $t2
	move	$a1, $t2
	ld.d	$t4, $sp, 56                    # 8-byte Folded Reload
	beqz	$t4, .LBB1_156
.LBB1_153:                              # %vec.epilog.ph840
                                        #   in Loop: Header=BB1_127 Depth=1
	vldrepl.w	$vr2, $a0, 0
	...
	alsl.d	$s1, $s1, $s3, 2
	.p2align	4, , 16
.LBB1_154:                              # %vec.epilog.vector.body843
                                        #   Parent Loop BB1_127 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr3, $s1, 0
	vld	$vr4, $a1, 0
	...
	addi.d	$s1, $s1, 16
	bnez	$a0, .LBB1_154
# %bb.155:                              # %vec.epilog.middle.block850
                                        #   in Loop: Header=BB1_127 Depth=1
	move	$a1, $t3
	ld.d	$a0, $sp, 288                   # 8-byte Folded Reload
	beq	$a0, $t3, .LBB1_126
	.p2align	4, , 16
.LBB1_156:                              # %for.body275.us450.preheader
                                        #   in Loop: Header=BB1_127 Depth=1
	alsl.d	$a0, $a1, $s3, 2
	alsl.d	$s1, $a1, $s2, 2
	ld.d	$t4, $sp, 288                   # 8-byte Folded Reload
...
.LBB1_159:                              # %vector.body782
	...
	addi.d	$s1, $s1, 64
	bnez	$s4, .LBB1_159
# %bb.160:                              # %middle.block788
                                        #   in Loop: Header=BB1_127 Depth=1
	ld.d	$a1, $sp, 288                   # 8-byte Folded Reload
	beq	$a1, $t2, .LBB1_126
# %bb.161:                              # %vec.epilog.iter.check792
                                        #   in Loop: Header=BB1_127 Depth=1
	move	$s1, $t2
	move	$a1, $t2
	ld.d	$t4, $sp, 56                    # 8-byte Folded Reload
	beqz	$t4, .LBB1_139
.LBB1_162:                              # %vec.epilog.ph794
                                        #   in Loop: Header=BB1_127 Depth=1
	vldrepl.w	$vr2, $a0, 0
	ld.d	$a0, $sp, 320                   # 8-byte Folded Reload
	add.d	$a0, $a0, $s1
	...
	alsl.d	$s1, $s1, $s3, 2
	.p2align	4, , 16
.LBB1_163:                              # %vec.epilog.vector.body797
                                        #   Parent Loop BB1_127 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr3, $s1, 0
	vld	$vr4, $a1, 0
	...
	addi.d	$s1, $s1, 16
	bnez	$a0, .LBB1_163
# %bb.164:                              # %vec.epilog.middle.block804
                                        #   in Loop: Header=BB1_127 Depth=1
	move	$a1, $t3
	ld.d	$a0, $sp, 288                   # 8-byte Folded Reload
	beq	$a0, $t3, .LBB1_126
...
.LBB1_166:                              # %for.body298.lr.ph
	...
	b	.LBB1_169
	.p2align	4, , 16
.LBB1_167:                              # %for.cond301.for.inc370_crit_edge.split.us
...
.LBB1_169:                              # %for.body298
	...
	ld.w	$t3, $t2, 16
	beq	$t3, $a6, .LBB1_168
# %bb.170:                              # %for.cond306.preheader.lr.ph
                                        #   in Loop: Header=BB1_169 Depth=1
	blez	$s3, .LBB1_193
# %bb.171:                              # %for.cond306.preheader.us.preheader
                                        #   in Loop: Header=BB1_169 Depth=1
	alsl.d	$t1, $t0, $a5, 3
	b	.LBB1_173
	.p2align	4, , 16
.LBB1_172:                              # %for.cond306.for.inc367_crit_edge.us
                                        #   in Loop: Header=BB1_173 Depth=2
	ld.w	$t3, $t2, 40
	addi.d	$t2, $t2, 24
	beq	$t3, $a6, .LBB1_167
.LBB1_173:                              # %for.cond306.preheader.us
	...
	alsl.d	$t5, $t3, $a4, 3
	bge	$t3, $t0, .LBB1_181
# %bb.174:                              # %for.body309.us.us573.preheader
                                        #   in Loop: Header=BB1_173 Depth=2
	move	$t6, $zero
	b	.LBB1_176
	.p2align	4, , 16
.LBB1_175:                              # %for.inc364.us.us579
                                        #   in Loop: Header=BB1_176 Depth=3
	addi.d	$t6, $t6, 1
	beq	$t6, $a1, .LBB1_172
.LBB1_176:                              # %for.body309.us.us573
                                        #   Parent Loop BB1_169 Depth=1
	...
	b	.LBB1_175
	.p2align	4, , 16
.LBB1_177:                              # %for.inc361.us498.us.us
                                        #   in Loop: Header=BB1_178 Depth=4
	ld.w	$t7, $t4, 40
	addi.d	$t4, $t4, 24
	beq	$t7, $a6, .LBB1_175
.LBB1_178:                              # %for.body316.us483.us.us
                                        #   Parent Loop BB1_169 Depth=1
                                        #     Parent Loop BB1_173 Depth=2
	...
	or	$t8, $t7, $t3
	bltz	$t8, .LBB1_177
# %bb.179:                              # %for.body316.us483.us.us
                                        #   in Loop: Header=BB1_178 Depth=4
	bge	$t7, $t6, .LBB1_177
# %bb.180:                              # %if.then338.us490.us.us
                                        #   in Loop: Header=BB1_178 Depth=4
	ld.d	$t8, $t5, 0
	fld.s	$fa2, $t2, 20
	fld.s	$fa3, $t4, 20
	...
	b	.LBB1_177
	.p2align	4, , 16
.LBB1_181:                              # %for.body309.lr.ph.split.us572
                                        #   in Loop: Header=BB1_173 Depth=2
	bge	$t0, $t3, .LBB1_189
# %bb.182:                              # %for.body309.us507.us.preheader
                                        #   in Loop: Header=BB1_173 Depth=2
	move	$t6, $zero
	b	.LBB1_184
	.p2align	4, , 16
.LBB1_183:                              # %for.inc364.us513.us
                                        #   in Loop: Header=BB1_184 Depth=3
	addi.d	$t6, $t6, 1
	beq	$t6, $a1, .LBB1_172
.LBB1_184:                              # %for.body309.us507.us
                                        #   Parent Loop BB1_169 Depth=1
                                        #     Parent Loop BB1_173 Depth=2
                                        # =>    This Loop Header: Depth=3
                                        #         Child Loop BB1_186 Depth 4
	...
	b	.LBB1_183
	.p2align	4, , 16
.LBB1_185:                              # %for.inc361.us.us522.us
                                        #   in Loop: Header=BB1_186 Depth=4
	ld.w	$t7, $t4, 40
	addi.d	$t4, $t4, 24
	beq	$t7, $a6, .LBB1_183
.LBB1_186:                              # %for.body316.us.us518.us
                                        #   Parent Loop BB1_169 Depth=1
                                        #     Parent Loop BB1_173 Depth=2
	...
	or	$t8, $t7, $t3
	bltz	$t8, .LBB1_185
# %bb.187:                              # %for.body316.us.us518.us
                                        #   in Loop: Header=BB1_186 Depth=4
	bge	$t6, $t7, .LBB1_185
# %bb.188:                              # %if.then338.us.us.us
                                        #   in Loop: Header=BB1_186 Depth=4
	ld.d	$t8, $t5, 0
	fld.s	$fa2, $t2, 20
	fld.s	$fa3, $t4, 20
	...
	b	.LBB1_185
	.p2align	4, , 16
.LBB1_189:                              # %for.body309.us559.preheader
                                        #   in Loop: Header=BB1_173 Depth=2
	move	$t3, $zero
	b	.LBB1_191
	.p2align	4, , 16
.LBB1_190:                              # %for.inc364.us565
                                        #   in Loop: Header=BB1_191 Depth=3
	addi.d	$t3, $t3, 1
	beq	$t3, $a1, .LBB1_172
.LBB1_191:                              # %for.body309.us559
                                        #   Parent Loop BB1_169 Depth=1
                                        #     Parent Loop BB1_173 Depth=2
                                        # =>    This Loop Header: Depth=3
                                        #         Child Loop BB1_192 Depth 4
...
.LBB1_192:                              # %for.body316.us.us.us
	...
	b	.LBB1_190
	.p2align	4, , 16
.LBB1_193:                              # %for.cond306.preheader
                                        #   Parent Loop BB1_169 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t1, $t2, 40
	addi.d	$t2, $t2, 24
	bne	$t1, $a6, .LBB1_193
	b	.LBB1_168
.LBB1_194:                              # %for.cond373.preheader
	pcalau12i	$a2, %pc_hi20(foldrna.pairpt1)
	st.d	$t2, $a2, %pc_lo12(foldrna.pairpt1)
	ld.d	$a2, $sp, 224                   # 8-byte Folded Reload
	blez	$a2, .LBB1_213
# %bb.195:                              # %for.cond377.preheader.lr.ph
	blez	$s3, .LBB1_213
# %bb.196:                              # %for.cond377.preheader.us.preheader
	move	$a2, $zero
	...
	b	.LBB1_198
	.p2align	4, , 16
.LBB1_197:                              # %for.cond377.for.inc393_crit_edge.us
                                        #   in Loop: Header=BB1_198 Depth=1
	addi.d	$a2, $a2, 1
	beq	$a2, $a0, .LBB1_213
.LBB1_198:                              # %iter.check861
                                        # =>This Loop Header: Depth=1
	...
	ldx.d	$t4, $t5, $t4
	bltu	$a1, $t1, .LBB1_201
# %bb.199:                              # %vector.memcheck853
                                        #   in Loop: Header=BB1_198 Depth=1
	add.d	$t5, $t3, $a4
	bgeu	$t4, $t5, .LBB1_204
# %bb.200:                              # %vector.memcheck853
                                        #   in Loop: Header=BB1_198 Depth=1
	add.d	$t5, $t4, $a4
	bgeu	$t3, $t5, .LBB1_204
.LBB1_201:                              #   in Loop: Header=BB1_198 Depth=1
	move	$t5, $zero
.LBB1_202:                              # %for.body380.us.preheader
                                        #   in Loop: Header=BB1_198 Depth=1
	alsl.d	$t3, $t5, $t3, 2
	alsl.d	$t4, $t5, $t4, 2
	sub.d	$t5, $a1, $t5
	.p2align	4, , 16
.LBB1_203:                              # %for.body380.us
	...
	b	.LBB1_197
	.p2align	4, , 16
.LBB1_204:                              # %vector.main.loop.iter.check863
                                        #   in Loop: Header=BB1_198 Depth=1
	bgeu	$a1, $t2, .LBB1_206
# %bb.205:                              #   in Loop: Header=BB1_198 Depth=1
	move	$t7, $zero
	b	.LBB1_210
.LBB1_206:                              # %vector.body867.preheader
                                        #   in Loop: Header=BB1_198 Depth=1
	addi.d	$t5, $t4, 32
	addi.d	$t6, $t3, 32
	move	$t7, $a6
	.p2align	4, , 16
.LBB1_207:                              # %vector.body867
                                        #   Parent Loop BB1_198 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	xvld	$xr0, $t6, -32
	xvld	$xr1, $t6, 0
	...
	addi.d	$t6, $t6, 64
	bnez	$t7, .LBB1_207
# %bb.208:                              # %middle.block874
                                        #   in Loop: Header=BB1_198 Depth=1
	beq	$a1, $a6, .LBB1_197
# %bb.209:                              # %vec.epilog.iter.check878
                                        #   in Loop: Header=BB1_198 Depth=1
	move	$t7, $a6
	move	$t5, $a6
	beqz	$a5, .LBB1_202
.LBB1_210:                              # %vec.epilog.ph880
                                        #   in Loop: Header=BB1_198 Depth=1
	add.d	$t5, $t0, $t7
	alsl.d	$t6, $t7, $t4, 2
	alsl.d	$t7, $t7, $t3, 2
	.p2align	4, , 16
.LBB1_211:                              # %vec.epilog.vector.body883
                                        #   Parent Loop BB1_198 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $t7, 0
	vld	$vr1, $t6, 0
	...
	addi.d	$t7, $t7, 16
	bnez	$t5, .LBB1_211
# %bb.212:                              # %vec.epilog.middle.block888
                                        #   in Loop: Header=BB1_198 Depth=1
	move	$t5, $a7
	beq	$a1, $a7, .LBB1_197
	b	.LBB1_202
.LBB1_213:                              # %for.end395
	...
	ld.d	$a0, $sp, 224                   # 8-byte Folded Reload
	blez	$a0, .LBB1_216
# %bb.214:                              # %for.body399.lr.ph
	ld.d	$a0, $sp, 208                   # 8-byte Folded Reload
	ld.d	$fp, $a0, %pc_lo12(foldrna.pairprob1)
	ld.d	$a0, $sp, 152                   # 8-byte Folded Reload
	bstrpick.d	$s0, $a0, 30, 0
	.p2align	4, , 16
.LBB1_215:                              # %for.body399
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $fp, 0
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	...
	addi.d	$fp, $fp, 8
	bnez	$s0, .LBB1_215
.LBB1_216:                              # %for.cond405.preheader
	ld.d	$a0, $sp, 176                   # 8-byte Folded Reload
	ld.d	$fp, $a0, %pc_lo12(foldrna.pairprob2)
	blez	$s3, .LBB1_219
# %bb.217:                              # %for.body408.lr.ph
	ld.d	$a0, $sp, 160                   # 8-byte Folded Reload
	bstrpick.d	$s0, $a0, 30, 0
	move	$s1, $fp
	.p2align	4, , 16
.LBB1_218:                              # %for.body408
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $s1, 0
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
