...
.LBB1_126:                              # %for.cond272.preheader.us
	...
	ldx.d	$s3, $t1, $a0
	blez	$s8, .LBB1_134
# %bb.127:                              # %for.body275.lr.ph.split.us.us
                                        #   in Loop: Header=BB1_126 Depth=1
	ld.d	$a0, $sp, 296                   # 8-byte Folded Reload
	blt	$a0, $a2, .LBB1_136
# %bb.128:                              # %for.body275.us.us.us.preheader
                                        #   in Loop: Header=BB1_126 Depth=1
	move	$a0, $zero
	.p2align	4, , 16
.LBB1_129:                              # %for.body275.us.us.us
	...
	fmov.s	$fa3, $fa1
	.p2align	4, , 16
.LBB1_130:                              # %for.cond1.preheader.us.i342.us.us.us
                                        #   Parent Loop BB1_126 Depth=1
	...
	move	$t0, $s2
	.p2align	4, , 16
.LBB1_131:                              # %for.body3.us.i347.us.us.us
                                        #   Parent Loop BB1_126 Depth=1
                                        #     Parent Loop BB1_129 Depth=2
	...
	addi.d	$s7, $s7, 8
	bnez	$t0, .LBB1_131
# %bb.132:                              # %for.cond1.for.inc34_crit_edge.us.i.us.us.us
...
# %bb.135:                              #   in Loop: Header=BB1_126 Depth=1
	...
	b	.LBB1_155
	.p2align	4, , 16
.LBB1_136:                              # %iter.check774
                                        #   in Loop: Header=BB1_126 Depth=1
	ld.d	$a0, $sp, 288                   # 8-byte Folded Reload
	bgeu	$a0, $fp, .LBB1_144
# %bb.137:                              #   in Loop: Header=BB1_126 Depth=1
	move	$t0, $zero
.LBB1_138:                              # %for.body275.us.us464.preheader
                                        #   in Loop: Header=BB1_126 Depth=1
	alsl.d	$a0, $t0, $s4, 2
	alsl.d	$a1, $t0, $s3, 2
	ld.d	$t3, $sp, 288                   # 8-byte Folded Reload
...
# %bb.141:                              # %vector.memcheck806
	...
	and	$a1, $s1, $a1
	bnez	$a1, .LBB1_155
# %bb.142:                              # %vector.main.loop.iter.check820
                                        #   in Loop: Header=BB1_126 Depth=1
	ld.d	$a1, $sp, 288                   # 8-byte Folded Reload
	ori	$t0, $zero, 16
	bgeu	$a1, $t0, .LBB1_148
...
# %bb.145:                              # %vector.memcheck767
	...
	and	$a1, $s1, $a1
	bnez	$a1, .LBB1_138
# %bb.146:                              # %vector.main.loop.iter.check776
                                        #   in Loop: Header=BB1_126 Depth=1
	ld.d	$a1, $sp, 288                   # 8-byte Folded Reload
	ori	$t0, $zero, 16
	bgeu	$a1, $t0, .LBB1_157
...
.LBB1_149:                              # %vector.body824
	...
	addi.d	$t0, $t0, 64
	bnez	$s1, .LBB1_149
# %bb.150:                              # %middle.block833
                                        #   in Loop: Header=BB1_126 Depth=1
	ld.d	$a1, $sp, 288                   # 8-byte Folded Reload
	ld.d	$t0, $sp, 320                   # 8-byte Folded Reload
	beq	$a1, $t0, .LBB1_125
# %bb.151:                              # %vec.epilog.iter.check838
                                        #   in Loop: Header=BB1_126 Depth=1
	ld.d	$t0, $sp, 320                   # 8-byte Folded Reload
	move	$s1, $t0
	ld.d	$a1, $sp, 56                    # 8-byte Folded Reload
	beqz	$a1, .LBB1_155
.LBB1_152:                              # %vec.epilog.ph837
                                        #   in Loop: Header=BB1_126 Depth=1
	vldrepl.w	$vr2, $a0, 0
	...
	alsl.d	$t0, $s1, $s4, 2
	.p2align	4, , 16
.LBB1_153:                              # %vec.epilog.vector.body843
                                        #   Parent Loop BB1_126 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr3, $t0, 0
	vld	$vr4, $a1, 0
	...
	addi.d	$t0, $t0, 16
	bnez	$a0, .LBB1_153
# %bb.154:                              # %vec.epilog.middle.block850
                                        #   in Loop: Header=BB1_126 Depth=1
	move	$t0, $t4
	ld.d	$a0, $sp, 288                   # 8-byte Folded Reload
	beq	$a0, $t4, .LBB1_125
	.p2align	4, , 16
.LBB1_155:                              # %for.body275.us454.preheader
                                        #   in Loop: Header=BB1_126 Depth=1
	alsl.d	$a0, $t0, $s4, 2
	alsl.d	$a1, $t0, $s3, 2
	ld.d	$t3, $sp, 288                   # 8-byte Folded Reload
...
.LBB1_158:                              # %vector.body780
	...
	addi.d	$t0, $t0, 64
	bnez	$s1, .LBB1_158
# %bb.159:                              # %middle.block786
                                        #   in Loop: Header=BB1_126 Depth=1
	ld.d	$a1, $sp, 288                   # 8-byte Folded Reload
	ld.d	$t0, $sp, 320                   # 8-byte Folded Reload
	beq	$a1, $t0, .LBB1_125
# %bb.160:                              # %vec.epilog.iter.check791
                                        #   in Loop: Header=BB1_126 Depth=1
	ld.d	$t0, $sp, 320                   # 8-byte Folded Reload
	move	$s1, $t0
	ld.d	$a1, $sp, 56                    # 8-byte Folded Reload
	beqz	$a1, .LBB1_138
.LBB1_161:                              # %vec.epilog.ph790
                                        #   in Loop: Header=BB1_126 Depth=1
	vldrepl.w	$vr2, $a0, 0
	ld.d	$a0, $sp, 312                   # 8-byte Folded Reload
	add.d	$a0, $a0, $s1
	...
	alsl.d	$t0, $s1, $s4, 2
	.p2align	4, , 16
.LBB1_162:                              # %vec.epilog.vector.body796
                                        #   Parent Loop BB1_126 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr3, $t0, 0
	vld	$vr4, $a1, 0
	...
	addi.d	$t0, $t0, 16
	bnez	$a0, .LBB1_162
# %bb.163:                              # %vec.epilog.middle.block803
                                        #   in Loop: Header=BB1_126 Depth=1
	move	$t0, $t4
	ld.d	$a0, $sp, 288                   # 8-byte Folded Reload
	beq	$a0, $t4, .LBB1_125
...
.LBB1_165:                              # %for.body298.lr.ph
	...
	b	.LBB1_168
	.p2align	4, , 16
.LBB1_166:                              # %for.cond301.for.inc370_crit_edge.split.us
...
.LBB1_168:                              # %for.body298
	...
	ld.w	$t3, $t2, 16
	beq	$t3, $t0, .LBB1_167
# %bb.169:                              # %for.cond306.preheader.lr.ph
                                        #   in Loop: Header=BB1_168 Depth=1
	blez	$s3, .LBB1_200
# %bb.170:                              # %for.cond306.preheader.us.preheader
                                        #   in Loop: Header=BB1_168 Depth=1
	alsl.d	$t1, $a2, $a6, 3
	b	.LBB1_172
	.p2align	4, , 16
.LBB1_171:                              # %for.cond306.for.inc367_crit_edge.us
                                        #   in Loop: Header=BB1_172 Depth=2
	ld.w	$t3, $t2, 40
	addi.d	$t2, $t2, 24
	beq	$t3, $t0, .LBB1_166
.LBB1_172:                              # %for.cond306.preheader.us
	...
	alsl.d	$t4, $t3, $a5, 3
	bge	$t3, $a2, .LBB1_188
# %bb.173:                              # %for.body309.lr.ph.split.us.us
                                        #   in Loop: Header=BB1_172 Depth=2
	move	$t6, $zero
	bnez	$t5, .LBB1_182
	b	.LBB1_175
	.p2align	4, , 16
.LBB1_174:                              # %for.inc364.us.us583
                                        #   in Loop: Header=BB1_175 Depth=3
	addi.d	$t6, $t6, 1
	beq	$t6, $a1, .LBB1_171
.LBB1_175:                              # %for.body309.us.us577
                                        #   Parent Loop BB1_168 Depth=1
	...
	b	.LBB1_174
	.p2align	4, , 16
.LBB1_176:                              # %for.inc361.us502.us.us
                                        #   in Loop: Header=BB1_177 Depth=4
	ld.w	$t7, $t5, 40
	addi.d	$t5, $t5, 24
	beq	$t7, $t0, .LBB1_174
.LBB1_177:                              # %for.body316.us487.us.us
                                        #   Parent Loop BB1_168 Depth=1
                                        #     Parent Loop BB1_172 Depth=2
	...
	or	$t8, $t7, $t3
	bltz	$t8, .LBB1_176
# %bb.178:                              # %for.body316.us487.us.us
                                        #   in Loop: Header=BB1_177 Depth=4
	bge	$t7, $t6, .LBB1_176
# %bb.179:                              # %if.then338.us494.us.us
                                        #   in Loop: Header=BB1_177 Depth=4
	ld.d	$t8, $t4, 0
	fld.s	$fa2, $t2, 20
	fld.s	$fa3, $t5, 20
	...
	b	.LBB1_176
	.p2align	4, , 16
.LBB1_180:                              #   in Loop: Header=BB1_182 Depth=3
	move	$t5, $t7
.LBB1_181:                              # %for.inc364.us.us.us
                                        #   in Loop: Header=BB1_182 Depth=3
	addi.d	$t6, $t6, 1
	beq	$t6, $a1, .LBB1_171
.LBB1_182:                              # %for.body309.us.us.us
                                        #   Parent Loop BB1_168 Depth=1
                                        #     Parent Loop BB1_172 Depth=2
                                        # =>    This Loop Header: Depth=3
                                        #         Child Loop BB1_185 Depth 4
	...
	ld.w	$fp, $t7, 16
	beq	$fp, $t0, .LBB1_180
# %bb.183:                              # %for.body316.us487.us536.us.preheader
                                        #   in Loop: Header=BB1_182 Depth=3
	slli.d	$t8, $t6, 2
	b	.LBB1_185
	.p2align	4, , 16
.LBB1_184:                              # %for.inc361.us502.us552.us
                                        #   in Loop: Header=BB1_185 Depth=4
	ld.w	$fp, $t7, 40
	addi.d	$t5, $t7, 24
	move	$t7, $t5
	beq	$fp, $t0, .LBB1_181
.LBB1_185:                              # %for.body316.us487.us536.us
                                        #   Parent Loop BB1_168 Depth=1
                                        #     Parent Loop BB1_172 Depth=2
	...
	or	$t5, $fp, $t3
	bltz	$t5, .LBB1_184
# %bb.186:                              # %land.lhs.true327.us492.us541.us
                                        #   in Loop: Header=BB1_185 Depth=4
	bstrpick.d	$t5, $fp, 31, 0
	beq	$t6, $t5, .LBB1_184
# %bb.187:                              # %if.then338.us494.us544.us
                                        #   in Loop: Header=BB1_185 Depth=4
	ld.d	$fp, $t4, 0
	fld.s	$fa2, $t2, 20
	fld.s	$fa3, $t7, 20
	...
	b	.LBB1_184
	.p2align	4, , 16
.LBB1_188:                              # %for.body309.lr.ph.split.us576
                                        #   in Loop: Header=BB1_172 Depth=2
	beqz	$t5, .LBB1_196
# %bb.189:                              # %for.body309.us511.us.preheader
                                        #   in Loop: Header=BB1_172 Depth=2
	move	$t6, $zero
	b	.LBB1_191
	.p2align	4, , 16
.LBB1_190:                              # %for.inc364.us517.us
                                        #   in Loop: Header=BB1_191 Depth=3
	addi.d	$t6, $t6, 1
	beq	$t6, $a1, .LBB1_171
.LBB1_191:                              # %for.body309.us511.us
                                        #   Parent Loop BB1_168 Depth=1
                                        #     Parent Loop BB1_172 Depth=2
                                        # =>    This Loop Header: Depth=3
                                        #         Child Loop BB1_193 Depth 4
	...
	b	.LBB1_190
	.p2align	4, , 16
.LBB1_192:                              # %for.inc361.us.us526.us
                                        #   in Loop: Header=BB1_193 Depth=4
	ld.w	$t7, $t5, 40
	addi.d	$t5, $t5, 24
	beq	$t7, $t0, .LBB1_190
.LBB1_193:                              # %for.body316.us.us522.us
                                        #   Parent Loop BB1_168 Depth=1
                                        #     Parent Loop BB1_172 Depth=2
	...
	or	$t8, $t7, $t3
	bltz	$t8, .LBB1_192
# %bb.194:                              # %for.body316.us.us522.us
                                        #   in Loop: Header=BB1_193 Depth=4
	bge	$t6, $t7, .LBB1_192
# %bb.195:                              # %if.then338.us.us.us
                                        #   in Loop: Header=BB1_193 Depth=4
	ld.d	$t8, $t4, 0
	fld.s	$fa2, $t2, 20
	fld.s	$fa3, $t5, 20
	...
	b	.LBB1_192
	.p2align	4, , 16
.LBB1_196:                              # %for.body309.us563.preheader
                                        #   in Loop: Header=BB1_172 Depth=2
	move	$t3, $zero
	b	.LBB1_198
	.p2align	4, , 16
.LBB1_197:                              # %for.inc364.us569
                                        #   in Loop: Header=BB1_198 Depth=3
	addi.d	$t3, $t3, 1
	beq	$t3, $a1, .LBB1_171
.LBB1_198:                              # %for.body309.us563
                                        #   Parent Loop BB1_168 Depth=1
                                        #     Parent Loop BB1_172 Depth=2
                                        # =>    This Loop Header: Depth=3
                                        #         Child Loop BB1_199 Depth 4
	...
	beq	$t4, $t0, .LBB1_197
	.p2align	4, , 16
.LBB1_199:                              # %for.body316.us.us.us
                                        #   Parent Loop BB1_168 Depth=1
                                        #     Parent Loop BB1_172 Depth=2
                                        #       Parent Loop BB1_198 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
	ld.w	$t4, $t5, 40
	addi.d	$t5, $t5, 24
	bne	$t4, $t0, .LBB1_199
	b	.LBB1_197
	.p2align	4, , 16
.LBB1_200:                              #   in Loop: Header=BB1_168 Depth=1
	move	$t1, $t2
	.p2align	4, , 16
.LBB1_201:                              # %for.cond306.preheader
                                        #   Parent Loop BB1_168 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t3, $t1, 40
	addi.d	$t2, $t1, 24
	...
	bne	$t3, $t0, .LBB1_201
	b	.LBB1_167
.LBB1_202:                              # %for.cond373.preheader
	pcalau12i	$a3, %pc_hi20(foldrna.pairpt1)
	ori	$a2, $zero, 1
	st.d	$t2, $a3, %pc_lo12(foldrna.pairpt1)
	ld.d	$a3, $sp, 248                   # 8-byte Folded Reload
	blt	$a3, $a2, .LBB1_221
# %bb.203:                              # %for.cond377.preheader.lr.ph
	blt	$s3, $a2, .LBB1_221
# %bb.204:                              # %for.cond377.preheader.us.preheader
	move	$a2, $zero
	...
	b	.LBB1_206
	.p2align	4, , 16
.LBB1_205:                              # %for.cond377.for.inc393_crit_edge.us
                                        #   in Loop: Header=BB1_206 Depth=1
	addi.d	$a2, $a2, 1
	beq	$a2, $a0, .LBB1_221
.LBB1_206:                              # %iter.check861
                                        # =>This Loop Header: Depth=1
	...
	ldx.d	$t4, $t5, $t4
	bltu	$a1, $t1, .LBB1_209
# %bb.207:                              # %vector.memcheck853
                                        #   in Loop: Header=BB1_206 Depth=1
	add.d	$t5, $t3, $a4
	bgeu	$t4, $t5, .LBB1_212
# %bb.208:                              # %vector.memcheck853
                                        #   in Loop: Header=BB1_206 Depth=1
	add.d	$t5, $t4, $a4
	bgeu	$t3, $t5, .LBB1_212
.LBB1_209:                              #   in Loop: Header=BB1_206 Depth=1
	move	$t5, $zero
.LBB1_210:                              # %for.body380.us.preheader
                                        #   in Loop: Header=BB1_206 Depth=1
	alsl.d	$t3, $t5, $t3, 2
	alsl.d	$t4, $t5, $t4, 2
	sub.d	$t5, $a1, $t5
	.p2align	4, , 16
.LBB1_211:                              # %for.body380.us
	...
	b	.LBB1_205
	.p2align	4, , 16
.LBB1_212:                              # %vector.main.loop.iter.check863
                                        #   in Loop: Header=BB1_206 Depth=1
	bgeu	$a1, $t2, .LBB1_214
# %bb.213:                              #   in Loop: Header=BB1_206 Depth=1
	move	$t7, $zero
	b	.LBB1_218
.LBB1_214:                              # %vector.body867.preheader
                                        #   in Loop: Header=BB1_206 Depth=1
	addi.d	$t5, $t4, 32
	addi.d	$t6, $t3, 32
	move	$t7, $a5
	.p2align	4, , 16
.LBB1_215:                              # %vector.body867
                                        #   Parent Loop BB1_206 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	xvld	$xr0, $t6, -32
	xvld	$xr1, $t6, 0
	...
	addi.d	$t6, $t6, 64
	bnez	$t7, .LBB1_215
# %bb.216:                              # %middle.block874
                                        #   in Loop: Header=BB1_206 Depth=1
	beq	$a1, $a5, .LBB1_205
# %bb.217:                              # %vec.epilog.iter.check879
                                        #   in Loop: Header=BB1_206 Depth=1
	move	$t7, $a5
	move	$t5, $a5
	beqz	$a6, .LBB1_210
.LBB1_218:                              # %vec.epilog.ph878
                                        #   in Loop: Header=BB1_206 Depth=1
	add.d	$t5, $t0, $t7
	alsl.d	$t6, $t7, $t4, 2
	alsl.d	$t7, $t7, $t3, 2
	.p2align	4, , 16
.LBB1_219:                              # %vec.epilog.vector.body884
                                        #   Parent Loop BB1_206 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $t7, 0
	vld	$vr1, $t6, 0
	...
	addi.d	$t7, $t7, 16
	bnez	$t5, .LBB1_219
# %bb.220:                              # %vec.epilog.middle.block889
                                        #   in Loop: Header=BB1_206 Depth=1
	move	$t5, $a7
	beq	$a1, $a7, .LBB1_205
	b	.LBB1_210
.LBB1_221:                              # %for.end395
	...
	ld.d	$a0, $sp, 248                   # 8-byte Folded Reload
	blt	$a0, $s0, .LBB1_224
# %bb.222:                              # %for.body399.lr.ph
	ld.d	$a0, $sp, 224                   # 8-byte Folded Reload
	ld.d	$fp, $a0, %pc_lo12(foldrna.pairprob1)
	ld.d	$a0, $sp, 152                   # 8-byte Folded Reload
	bstrpick.d	$s1, $a0, 30, 0
	.p2align	4, , 16
.LBB1_223:                              # %for.body399
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $fp, 0
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	...
	addi.d	$fp, $fp, 8
	bnez	$s1, .LBB1_223
.LBB1_224:                              # %for.cond405.preheader
	ld.d	$a0, $sp, 184                   # 8-byte Folded Reload
	ld.d	$fp, $a0, %pc_lo12(foldrna.pairprob2)
	blt	$s3, $s0, .LBB1_227
# %bb.225:                              # %for.body408.lr.ph
	ld.d	$a0, $sp, 160                   # 8-byte Folded Reload
	bstrpick.d	$s0, $a0, 30, 0
	move	$s1, $fp
	.p2align	4, , 16
.LBB1_226:                              # %for.body408
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $s1, 0
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
