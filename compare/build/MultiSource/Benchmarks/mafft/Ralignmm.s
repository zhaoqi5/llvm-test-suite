...
.LBB2_71:                               # %for.body310
	...
	addi.d	$a6, $a6, 4
	bnez	$a5, .LBB2_71
# %bb.72:                               # %if.end425.thread715
	ld.d	$a0, $sp, 408                   # 8-byte Folded Reload
	ld.d	$a7, $a0, %pc_lo12(R__align.m)
	st.w	$zero, $a7, 0
	move	$a4, $t1
.LBB2_73:                               # %iter.check785
	move	$t2, $a4
	ld.d	$a0, $sp, 264                   # 8-byte Folded Reload
	ld.d	$a0, $a0, %pc_lo12(R__align.mp)
	addi.d	$a1, $s6, 1
	...
	ori	$a4, $zero, 1
	bltu	$a2, $a3, .LBB2_86
# %bb.74:                               # %vector.memcheck781
	sub.d	$a3, $a7, $t3
	addi.d	$a3, $a3, 4
	ori	$a5, $zero, 64
	bltu	$a3, $a5, .LBB2_86
# %bb.75:                               # %vector.main.loop.iter.check787
	ori	$a4, $zero, 16
	lu12i.w	$a3, 287172
	move	$t6, $a7
	bgeu	$a2, $a4, .LBB2_80
...
.LBB2_77:                               # %vec.epilog.ph802
	...
	vreplgr2vr.w	$vr2, $a3
	.p2align	4, , 16
.LBB2_78:                               # %vec.epilog.vector.body810
                                        # =>This Inner Loop Header: Depth=1
	vldx	$vr3, $t3, $a7
	vstx	$vr1, $t0, $a7
	...
	addi.d	$a7, $a7, 16
	bnez	$a5, .LBB2_78
# %bb.79:                               # %vec.epilog.middle.block815
	move	$a7, $t6
	bne	$a2, $a6, .LBB2_86
	b	.LBB2_88
.LBB2_80:                               # %vector.ph788
	move	$a4, $zero
	move	$a5, $a2
...
# %bb.83:
	...
	move	$a7, $t6
	b	.LBB2_90
.LBB2_84:                               # %vec.epilog.iter.check803
	andi	$a4, $a2, 12
	bnez	$a4, .LBB2_77
# %bb.85:
	move	$a7, $t6
...
# %bb.95:                               # %iter.check828
	...
	ori	$a1, $zero, 3
	bltu	$a0, $a1, .LBB2_98
# %bb.96:                               # %vector.memcheck819
                                        #   in Loop: Header=BB2_94 Depth=1
	ld.d	$a1, $sp, 208                   # 8-byte Folded Reload
	add.d	$a0, $a2, $a1
	bgeu	$s3, $a0, .LBB2_122
# %bb.97:                               # %vector.memcheck819
                                        #   in Loop: Header=BB2_94 Depth=1
	add.d	$a0, $s3, $a1
	bgeu	$a2, $a0, .LBB2_122
...
# %bb.121:                              # %if.then705
	...
	fstx.s	$fa1, $fp, $a4
	b	.LBB2_112
.LBB2_122:                              # %vector.main.loop.iter.check830
                                        #   in Loop: Header=BB2_94 Depth=1
	ld.d	$a0, $sp, 336                   # 8-byte Folded Reload
	ori	$a1, $zero, 15
	bgeu	$a0, $a1, .LBB2_124
# %bb.123:                              #   in Loop: Header=BB2_94 Depth=1
	move	$a4, $zero
	b	.LBB2_128
.LBB2_124:                              # %vector.body834.preheader
                                        #   in Loop: Header=BB2_94 Depth=1
	addi.d	$a0, $s3, 32
	addi.d	$a1, $a2, 32
	ld.d	$a3, $sp, 192                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB2_125:                              # %vector.body834
                                        #   Parent Loop BB2_94 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	xvld	$xr0, $a1, -32
	xvld	$xr1, $a1, 0
	...
	addi.d	$a1, $a1, 64
	bnez	$a3, .LBB2_125
# %bb.126:                              # %middle.block843
                                        #   in Loop: Header=BB2_94 Depth=1
	ld.d	$a0, $sp, 184                   # 8-byte Folded Reload
	ld.d	$a1, $sp, 192                   # 8-byte Folded Reload
	beq	$a0, $a1, .LBB2_100
# %bb.127:                              # %vec.epilog.iter.check848
                                        #   in Loop: Header=BB2_94 Depth=1
	ld.d	$a4, $sp, 192                   # 8-byte Folded Reload
	ld.d	$a0, $sp, 136                   # 8-byte Folded Reload
	beqz	$a0, .LBB2_131
.LBB2_128:                              # %vec.epilog.ph847
                                        #   in Loop: Header=BB2_94 Depth=1
	...
	add.d	$a4, $a5, $a4
	.p2align	4, , 16
.LBB2_129:                              # %vec.epilog.vector.body854
                                        #   Parent Loop BB2_94 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a2, 0
	vld	$vr1, $a3, 0
	...
	addi.d	$a2, $a2, 16
	bnez	$a4, .LBB2_129
# %bb.130:                              # %vec.epilog.middle.block863
                                        #   in Loop: Header=BB2_94 Depth=1
...
# %bb.192:
	move	$a5, $zero
	b	.LBB2_250
.LBB2_193:                              # %vector.main.loop.iter.check1026
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB2_203
# %bb.194:
	move	$a4, $zero
.LBB2_195:                              # %vec.epilog.ph1040
	move	$a6, $a4
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB2_196:                              # %vec.epilog.vector.body1049
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a6, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a6, $a6, 16
	bnez	$a5, .LBB2_196
# %bb.197:                              # %vec.epilog.middle.block1054
	bne	$a3, $a4, .LBB2_207
	b	.LBB2_209
.LBB2_198:                              # %vector.main.loop.iter.check930
	ori	$a5, $zero, 16
	bgeu	$a4, $a5, .LBB2_246
# %bb.199:
	move	$a5, $zero
.LBB2_200:                              # %vec.epilog.ph944
	move	$a7, $a5
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB2_201:                              # %vec.epilog.vector.body952
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a7, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a7, $a7, 16
	bnez	$a6, .LBB2_201
# %bb.202:                              # %vec.epilog.middle.block957
	bne	$a4, $a5, .LBB2_250
	b	.LBB2_252
.LBB2_203:                              # %vector.ph1027
...
.LBB2_204:                              # %vector.body1030
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB2_204
# %bb.205:                              # %middle.block1036
	beq	$a3, $a4, .LBB2_209
# %bb.206:                              # %vec.epilog.iter.check1041
	andi	$a6, $a5, 12
	bnez	$a6, .LBB2_195
...
.LBB2_232:                              #   in Loop: Header=BB2_211 Depth=1
	move	$t5, $s5
	move	$t6, $s8
.LBB2_233:                              # %while.body.i506.preheader1110
                                        #   in Loop: Header=BB2_211 Depth=1
	move	$t7, $t5
	move	$t8, $t6
	.p2align	4, , 16
...
.LBB2_247:                              # %vector.body934
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB2_247
# %bb.248:                              # %middle.block940
	beq	$a4, $a5, .LBB2_252
# %bb.249:                              # %vec.epilog.iter.check945
	andi	$a7, $a6, 12
	bnez	$a7, .LBB2_200
...
.LBB2_275:                              #   in Loop: Header=BB2_254 Depth=1
	move	$s0, $s5
	move	$s1, $s8
.LBB2_276:                              # %while.body.i434.preheader1115
                                        #   in Loop: Header=BB2_254 Depth=1
	move	$s2, $s0
	move	$a6, $s1
	.p2align	4, , 16
