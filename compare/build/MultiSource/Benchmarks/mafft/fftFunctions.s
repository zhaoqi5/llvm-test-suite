...
.LBB8_7:
	...
	move	$a0, $a1
	ret
.LBB8_8:                                # %for.cond1.preheader.lr.ph.split
	lu12i.w	$a3, 209715
	ori	$a3, $a3, 819
	lu32i.d	$a3, 231411
	lu52i.d	$a3, $a3, -1012
...
# %bb.12:                               # %middle.block
	beq	$a3, $a2, .LBB8_6
.LBB8_13:                               # %for.cond1.preheader.preheader
	alsl.d	$a0, $a3, $a0, 2
	sub.d	$a2, $a2, $a3
	.p2align	4, , 16
.LBB8_14:                               # %for.cond1.preheader
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a4, $a0, 0
	addi.d	$a2, $a2, -1
	addi.d	$a0, $a0, 4
...
# %bb.0:                                # %entry
	...
	ld.d	$s2, $a0, %got_pc_lo12(fftWinSize)
	ld.w	$a0, $s2, 0
...
# %bb.12:                               # %for.cond48.preheader.lr.ph
	...
	addi.d	$fp, $a0, %pc_lo12(alignableReagion.hat1)
	pcalau12i	$a0, %pc_hi20(alignableReagion.hat2)
	addi.d	$s0, $a0, %pc_lo12(alignableReagion.hat2)
	move	$s3, $zero
	addi.w	$s1, $zero, -8
	ori	$s2, $zero, 104
	b	.LBB11_14
...
.LBB11_27:                              # %for.cond127.preheader
                                        ...
                                        #       Child Loop BB11_28 Depth 3
	mul.d	$a3, $a1, $s2
	pcalau12i	$a4, %got_pc_hi20(n_disFFT)
	ld.d	$a4, $a4, %got_pc_lo12(n_disFFT)
	slli.d	$a5, $a1, 3
	fldx.d	$fa1, $s6, $a5
	add.d	$a3, $a4, $a3
	move	$a4, $a2
...
# %bb.1:                                # %if.end
	...
	st.d	$s1, $sp, 16                    # 8-byte Folded Spill
	blez	$s6, .LBB12_24
.LBB12_2:                               # %for.cond3.preheader.lr.ph
	move	$a0, $zero
	...
	b	.LBB12_4
	.p2align	4, , 16
.LBB12_3:                               # %for.cond3.for.inc12_crit_edge.us
                                        #   in Loop: Header=BB12_4 Depth=1
	addi.d	$a0, $a0, 1
	beq	$a0, $s6, .LBB12_11
.LBB12_4:                               # %for.cond3.preheader.us
                                        # =>This Loop Header: Depth=1
...
# %bb.8:                                # %middle.block
	...
	move	$a7, $a2
	beq	$a2, $s6, .LBB12_3
.LBB12_9:                               # %for.body5.us.preheader
                                        #   in Loop: Header=BB12_4 Depth=1
	alsl.d	$a5, $a7, $a5, 3
	alsl.d	$a6, $a7, $a6, 3
	sub.d	$a7, $s6, $a7
	.p2align	4, , 16
.LBB12_10:                              # %for.body5.us
                                        #   Parent Loop BB12_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fld.d	$fa0, $a5, 0
	fst.d	$fa0, $a6, 0
...
# %bb.12:                               # %for.body41.preheader
	...
	ld.d	$a7, $a7, %got_pc_lo12(penalty)
	move	$t8, $s6
	ori	$t0, $zero, 1
	b	.LBB12_14
	.p2align	4, , 16
...
.LBB12_45:                              # %for.body223.preheader
	...
	add.d	$a2, $a2, $a3
	movgr2fr.d	$fa0, $zero
	pcalau12i	$a3, %pc_hi20(blockAlign.ocut1)
	addi.d	$a3, $a3, %pc_lo12(blockAlign.ocut1)
	pcalau12i	$a4, %pc_hi20(blockAlign.ocut2)
	addi.d	$a5, $a4, %pc_lo12(blockAlign.ocut2)
	move	$a4, $zero
	b	.LBB12_48
	.p2align	4, , 16
.LBB12_46:                              # %if.end275
...
.LBB13_34:                              # %for.body223.preheader
	...
	add.d	$a2, $a3, $a2
	movgr2fr.d	$fa0, $zero
	pcalau12i	$a3, %pc_hi20(blockAlign2.ocut1)
	addi.d	$a3, $a3, %pc_lo12(blockAlign2.ocut1)
	pcalau12i	$a4, %pc_hi20(blockAlign2.ocut2)
	addi.d	$a5, $a4, %pc_lo12(blockAlign2.ocut2)
	move	$a4, $zero
	b	.LBB13_37
	.p2align	4, , 16
.LBB13_35:                              # %if.end275
...
.LBB14_34:                              # %for.end155
	...
	add.d	$a4, $a0, $a2
	ld.d	$a2, $sp, 64                    # 8-byte Folded Reload
	ld.d	$a6, $a2, %pc_lo12(blockAlign3.track)
	lu12i.w	$a5, 24
	ori	$a2, $a5, 1695
	ori	$a7, $zero, 1
...
.LBB14_48:                              # %for.body218.preheader
	...
	add.d	$a2, $a2, $a3
	movgr2fr.d	$fa0, $zero
	pcalau12i	$a3, %pc_hi20(blockAlign3.ocut1)
	addi.d	$a3, $a3, %pc_lo12(blockAlign3.ocut1)
	pcalau12i	$a4, %pc_hi20(blockAlign3.ocut2)
	addi.d	$a5, $a4, %pc_lo12(blockAlign3.ocut2)
	move	$a4, $zero
	b	.LBB14_51
	.p2align	4, , 16
.LBB14_49:                              # %if.end270
