...
# %bb.32:                               # %for.body171.lr.ph
	...
	ori	$a3, $zero, 8
	bltu	$a1, $a3, .LBB3_35
# %bb.33:                               # %vector.memcheck420
	alsl.d	$a3, $a1, $a2, 2
	bgeu	$a0, $a3, .LBB3_157
# %bb.34:                               # %vector.memcheck420
	alsl.d	$a3, $a1, $a0, 2
	bgeu	$a2, $a3, .LBB3_157
.LBB3_35:
	move	$a3, $zero
...
# %bb.84:                               # %iter.check673
	...
	ori	$a2, $zero, 3
	bltu	$a1, $a2, .LBB3_87
# %bb.85:                               # %vector.memcheck664
                                        #   in Loop: Header=BB3_83 Depth=1
	ld.d	$a2, $sp, 168                   # 8-byte Folded Reload
	add.d	$a1, $a3, $a2
	bgeu	$s3, $a1, .LBB3_98
# %bb.86:                               # %vector.memcheck664
                                        #   in Loop: Header=BB3_83 Depth=1
	add.d	$a1, $s3, $a2
	bgeu	$a3, $a1, .LBB3_98
...
# %bb.97:                               # %if.then356
	...
	st.w	$s6, $a7, 0
	b	.LBB3_91
.LBB3_98:                               # %vector.main.loop.iter.check675
                                        #   in Loop: Header=BB3_83 Depth=1
	ld.d	$a1, $sp, 288                   # 8-byte Folded Reload
	ori	$a2, $zero, 15
	bgeu	$a1, $a2, .LBB3_100
# %bb.99:                               #   in Loop: Header=BB3_83 Depth=1
	move	$a5, $zero
	b	.LBB3_104
.LBB3_100:                              # %vector.body679.preheader
                                        #   in Loop: Header=BB3_83 Depth=1
	addi.d	$a1, $s3, 32
	addi.d	$a2, $a3, 32
	ld.d	$a4, $sp, 112                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB3_101:                              # %vector.body679
                                        #   Parent Loop BB3_83 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	xvld	$xr0, $a2, -32
	xvld	$xr1, $a2, 0
	...
	addi.d	$a2, $a2, 64
	bnez	$a4, .LBB3_101
# %bb.102:                              # %middle.block688
                                        #   in Loop: Header=BB3_83 Depth=1
	ld.d	$a1, $sp, 104                   # 8-byte Folded Reload
	ld.d	$a2, $sp, 112                   # 8-byte Folded Reload
	beq	$a1, $a2, .LBB3_89
# %bb.103:                              # %vec.epilog.iter.check693
                                        #   in Loop: Header=BB3_83 Depth=1
	ld.d	$a5, $sp, 112                   # 8-byte Folded Reload
	ld.d	$a1, $sp, 32                    # 8-byte Folded Reload
	beqz	$a1, .LBB3_107
.LBB3_104:                              # %vec.epilog.ph692
                                        #   in Loop: Header=BB3_83 Depth=1
	...
	add.d	$a5, $a6, $a5
	.p2align	4, , 16
.LBB3_105:                              # %vec.epilog.vector.body699
                                        #   Parent Loop BB3_83 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a3, 0
	vld	$vr1, $a4, 0
	...
	addi.d	$a3, $a3, 16
	bnez	$a5, .LBB3_105
# %bb.106:                              # %vec.epilog.middle.block708
                                        #   in Loop: Header=BB3_83 Depth=1
...
.LBB3_132:                              # %vector.memcheck615
	...
	and	$t1, $t1, $t2
	bnez	$t1, .LBB3_75
# %bb.133:                              # %vector.memcheck615
	addi.d	$a6, $a6, 8
	sltu	$a6, $a7, $a6
	sltu	$a7, $a0, $t0
	and	$a6, $a6, $a7
	bnez	$a6, .LBB3_75
# %bb.134:                              # %vector.main.loop.iter.check632
	ori	$a5, $zero, 16
	bgeu	$a4, $a5, .LBB3_229
# %bb.135:
	move	$a6, $zero
...
# %bb.151:
	move	$a5, $zero
	b	.LBB3_178
.LBB3_152:                              # %vector.main.loop.iter.check775
	ori	$a5, $zero, 16
	bgeu	$a4, $a5, .LBB3_171
# %bb.153:
	move	$a5, $zero
...
.LBB3_158:                              # %vector.body433
	...
	addi.d	$a4, $a4, 32
	bnez	$a6, .LBB3_158
# %bb.159:                              # %middle.block438
	beq	$a1, $a3, .LBB3_38
	b	.LBB3_36
.LBB3_160:                              # %vector.memcheck512
...
# %bb.161:                              # %vector.memcheck512
	...
	and	$a5, $a5, $a6
	bnez	$a5, .LBB3_60
# %bb.162:                              # %vector.main.loop.iter.check528
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB3_244
# %bb.163:
	move	$a5, $zero
	b	.LBB3_248
.LBB3_164:                              # %vector.memcheck563
	addi.d	$a5, $s5, 4
	alsl.d	$a6, $a2, $s5, 2
	addi.d	$a7, $a0, 4
	sltu	$a7, $a5, $a7
...
# %bb.165:                              # %vector.memcheck563
	...
	and	$a5, $a5, $a6
	bnez	$a5, .LBB3_64
# %bb.166:                              # %vector.main.loop.iter.check580
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB3_251
# %bb.167:
	move	$a5, $zero
...
.LBB3_172:                              # %vector.body779
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB3_172
# %bb.173:                              # %middle.block785
	beq	$a4, $a5, .LBB3_180
# %bb.174:                              # %vec.epilog.iter.check790
	andi	$a7, $a6, 12
	beqz	$a7, .LBB3_178
.LBB3_175:                              # %vec.epilog.ph789
	move	$a7, $a5
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB3_176:                              # %vec.epilog.vector.body797
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a7, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a7, $a7, 16
	bnez	$a6, .LBB3_176
# %bb.177:                              # %vec.epilog.middle.block802
	beq	$a4, $a5, .LBB3_180
...
.LBB3_197:                              #   in Loop: Header=BB3_182 Depth=1
	move	$s0, $s5
	move	$s1, $s3
.LBB3_198:                              # %while.body.i255.preheader851
                                        #   in Loop: Header=BB3_182 Depth=1
	move	$s2, $s0
	move	$s3, $s1
	.p2align	4, , 16
...
.LBB3_230:                              # %vector.body636
	...
	addi.d	$t0, $t0, 64
	bnez	$t1, .LBB3_230
# %bb.231:                              # %middle.block643
	beq	$a4, $a6, .LBB3_77
# %bb.232:                              # %vec.epilog.iter.check648
	andi	$a5, $a4, 12
	beqz	$a5, .LBB3_258
.LBB3_233:                              # %vec.epilog.ph647
	move	$a7, $a4
	...
	vrepli.b	$vr1, 0
	.p2align	4, , 16
.LBB3_234:                              # %vec.epilog.vector.body653
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $t0, 0
	vfadd.s	$vr2, $vr2, $vr0
	vst	$vr2, $t1, 0
	...
	addi.d	$t2, $t2, 16
	bnez	$a6, .LBB3_234
# %bb.235:                              # %vec.epilog.middle.block660
	bne	$a4, $a7, .LBB3_75
	b	.LBB3_77
.LBB3_236:                              # %if.then428
...
.LBB3_245:                              # %vector.body532
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB3_245
# %bb.246:                              # %middle.block541
	beq	$a3, $a5, .LBB3_62
# %bb.247:                              # %vec.epilog.iter.check546
	andi	$a4, $a3, 12
	beqz	$a4, .LBB3_260
.LBB3_248:                              # %vec.epilog.ph545
	move	$a6, $a3
	...
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB3_249:                              # %vec.epilog.vector.body551
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $t0, 0
	vld	$vr2, $a7, 0
	vfadd.s	$vr1, $vr0, $vr1
	...
	addi.d	$t0, $t0, 16
	bnez	$a5, .LBB3_249
# %bb.250:                              # %vec.epilog.middle.block559
	bne	$a3, $a6, .LBB3_60
	b	.LBB3_62
.LBB3_251:                              # %vector.ph581
	move	$a5, $a3
	xvldrepl.w	$xr0, $a0, 0
	bstrins.d	$a5, $zero, 3, 0
	addi.d	$a4, $s5, 36
...
.LBB3_252:                              # %vector.body584
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB3_252
# %bb.253:                              # %middle.block593
	beq	$a3, $a5, .LBB3_74
# %bb.254:                              # %vec.epilog.iter.check598
	andi	$a4, $a3, 12
	beqz	$a4, .LBB3_261
.LBB3_255:                              # %vec.epilog.ph597
	move	$a6, $a3
	bstrins.d	$a6, $zero, 1, 0
	ori	$a7, $zero, 1
	move	$a4, $a3
	...
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB3_256:                              # %vec.epilog.vector.body603
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $t0, 0
	vld	$vr2, $a7, 0
	vfadd.s	$vr1, $vr0, $vr1
	...
	addi.d	$t0, $t0, 16
	bnez	$a5, .LBB3_256
# %bb.257:                              # %vec.epilog.middle.block611
	bne	$a3, $a6, .LBB3_64
	b	.LBB3_74
.LBB3_258:
	addi.d	$a5, $a6, 1
...
.LBB6_116:                              # %vector.memcheck557
	...
	and	$t1, $t1, $t2
	bnez	$t1, .LBB6_71
# %bb.117:                              # %vector.memcheck557
	addi.d	$a6, $a6, 8
	sltu	$a6, $a7, $a6
	sltu	$a7, $a0, $t0
	and	$a6, $a6, $a7
	bnez	$a6, .LBB6_71
# %bb.118:                              # %vector.main.loop.iter.check574
	ori	$a5, $zero, 16
	bgeu	$a4, $a5, .LBB6_211
# %bb.119:
	move	$a6, $zero
...
# %bb.135:
	move	$a5, $zero
	b	.LBB6_160
.LBB6_136:                              # %vector.main.loop.iter.check664
	ori	$a5, $zero, 16
	bgeu	$a4, $a5, .LBB6_153
# %bb.137:
	move	$a5, $zero
...
.LBB6_142:                              # %vector.body428
	...
	addi.d	$a4, $a4, 32
	bnez	$a6, .LBB6_142
# %bb.143:                              # %middle.block433
	beq	$a1, $a3, .LBB6_37
	b	.LBB6_35
.LBB6_144:                              # %vector.memcheck465
...
# %bb.149:                              # %vector.memcheck505
	...
	and	$a5, $a5, $a6
	bnez	$a5, .LBB6_60
# %bb.150:                              # %vector.main.loop.iter.check522
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB6_226
# %bb.151:
	move	$a5, $zero
...
.LBB6_154:                              # %vector.body668
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB6_154
# %bb.155:                              # %middle.block674
	beq	$a4, $a5, .LBB6_162
# %bb.156:                              # %vec.epilog.iter.check679
	andi	$a7, $a6, 12
	beqz	$a7, .LBB6_160
.LBB6_157:                              # %vec.epilog.ph678
	move	$a7, $a5
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB6_158:                              # %vec.epilog.vector.body686
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a7, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a7, $a7, 16
	bnez	$a6, .LBB6_158
# %bb.159:                              # %vec.epilog.middle.block691
	beq	$a4, $a5, .LBB6_162
...
.LBB6_179:                              #   in Loop: Header=BB6_164 Depth=1
	move	$fp, $s3
	move	$s0, $s5
.LBB6_180:                              # %while.body.i257.preheader738
                                        #   in Loop: Header=BB6_164 Depth=1
	move	$s1, $fp
	move	$s2, $s0
	.p2align	4, , 16
...
.LBB6_212:                              # %vector.body578
	...
	addi.d	$t0, $t0, 64
	bnez	$t1, .LBB6_212
# %bb.213:                              # %middle.block585
	beq	$a4, $a6, .LBB6_73
# %bb.214:                              # %vec.epilog.iter.check590
	andi	$a5, $a4, 12
	beqz	$a5, .LBB6_233
.LBB6_215:                              # %vec.epilog.ph589
	move	$a7, $a4
	bstrins.d	$a7, $zero, 1, 0
	ori	$t0, $zero, 1
	move	$a5, $a4
	...
	vrepli.b	$vr1, 0
	.p2align	4, , 16
.LBB6_216:                              # %vec.epilog.vector.body595
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $t0, 0
	vfadd.s	$vr2, $vr2, $vr0
	vst	$vr2, $t1, 0
	...
	addi.d	$t2, $t2, 16
	bnez	$a6, .LBB6_216
# %bb.217:                              # %vec.epilog.middle.block602
	bne	$a4, $a7, .LBB6_71
	b	.LBB6_73
.LBB6_218:                              # %if.then424
	pcalau12i	$a0, %got_pc_hi20(stderr)
...
.LBB6_227:                              # %vector.body526
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB6_227
# %bb.228:                              # %middle.block535
	beq	$a3, $a5, .LBB6_70
# %bb.229:                              # %vec.epilog.iter.check540
	andi	$a4, $a3, 12
	beqz	$a4, .LBB6_235
.LBB6_230:                              # %vec.epilog.ph539
	move	$a6, $a3
	bstrins.d	$a6, $zero, 1, 0
	ori	$a7, $zero, 1
	move	$a4, $a3
	...
	sub.d	$a5, $a5, $a6
	.p2align	4, , 16
.LBB6_231:                              # %vec.epilog.vector.body545
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $t0, 0
	vld	$vr2, $a7, 0
	vfadd.s	$vr1, $vr0, $vr1
	...
	addi.d	$t0, $t0, 16
	bnez	$a5, .LBB6_231
# %bb.232:                              # %vec.epilog.middle.block553
	bne	$a3, $a6, .LBB6_60
	b	.LBB6_70
.LBB6_233:
	addi.d	$a5, $a6, 1
