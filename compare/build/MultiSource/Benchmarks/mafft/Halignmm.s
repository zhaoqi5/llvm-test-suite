...
.LBB2_108:                              # %vector.body911
	...
	addi.d	$a4, $a4, 64
	bnez	$a7, .LBB2_108
# %bb.109:                              # %middle.block916
	beq	$a2, $a5, .LBB2_114
# %bb.110:                              # %vec.epilog.iter.check921
	andi	$a4, $a2, 12
	bnez	$a4, .LBB2_72
# %bb.111:
	addi.d	$a4, $a5, 1
...
# %bb.164:                              # %if.then551
	...
	st.w	$s8, $t3, 0
	b	.LBB2_127
.LBB2_165:                              # %vector.main.loop.iter.check948
                                        #   in Loop: Header=BB2_119 Depth=1
	ld.d	$a0, $sp, 288                   # 8-byte Folded Reload
	ori	$a1, $zero, 15
	bgeu	$a0, $a1, .LBB2_167
# %bb.166:                              #   in Loop: Header=BB2_119 Depth=1
	move	$a5, $zero
	b	.LBB2_171
.LBB2_167:                              # %vector.body952.preheader
                                        #   in Loop: Header=BB2_119 Depth=1
	addi.d	$a0, $s5, 32
	addi.d	$a1, $a2, 32
	ld.d	$a4, $sp, 208                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB2_168:                              # %vector.body952
                                        #   Parent Loop BB2_119 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	xvld	$xr0, $a1, -32
	xvld	$xr1, $a1, 0
	...
	addi.d	$a1, $a1, 64
	bnez	$a4, .LBB2_168
# %bb.169:                              # %middle.block961
                                        #   in Loop: Header=BB2_119 Depth=1
	ld.d	$a0, $sp, 200                   # 8-byte Folded Reload
	ld.d	$a1, $sp, 208                   # 8-byte Folded Reload
	beq	$a0, $a1, .LBB2_125
# %bb.170:                              # %vec.epilog.iter.check966
                                        #   in Loop: Header=BB2_119 Depth=1
	ld.d	$a5, $sp, 208                   # 8-byte Folded Reload
	ld.d	$a0, $sp, 152                   # 8-byte Folded Reload
	beqz	$a0, .LBB2_174
.LBB2_171:                              # %vec.epilog.ph965
                                        #   in Loop: Header=BB2_119 Depth=1
	...
	add.d	$a5, $a6, $a5
	.p2align	4, , 16
.LBB2_172:                              # %vec.epilog.vector.body972
                                        #   Parent Loop BB2_119 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a2, 0
	vld	$vr1, $a4, 0
	...
	addi.d	$a2, $a2, 16
	bnez	$a5, .LBB2_172
# %bb.173:                              # %vec.epilog.middle.block981
                                        #   in Loop: Header=BB2_119 Depth=1
...
# %bb.235:
	move	$a5, $zero
	b	.LBB2_293
.LBB2_236:                              # %vector.main.loop.iter.check1144
	ori	$a4, $zero, 16
	bgeu	$a3, $a4, .LBB2_246
# %bb.237:
	move	$a4, $zero
.LBB2_238:                              # %vec.epilog.ph1158
	move	$a6, $a4
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB2_239:                              # %vec.epilog.vector.body1167
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a6, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a6, $a6, 16
	bnez	$a5, .LBB2_239
# %bb.240:                              # %vec.epilog.middle.block1172
	bne	$a3, $a4, .LBB2_250
	b	.LBB2_252
.LBB2_241:                              # %vector.main.loop.iter.check1048
	ori	$a5, $zero, 16
	bgeu	$a4, $a5, .LBB2_289
# %bb.242:
	move	$a5, $zero
.LBB2_243:                              # %vec.epilog.ph1062
	move	$a7, $a5
	...
	vrepli.b	$vr1, -1
	.p2align	4, , 16
.LBB2_244:                              # %vec.epilog.vector.body1070
                                        # =>This Inner Loop Header: Depth=1
	vxor.v	$vr2, $vr0, $vr1
	vst	$vr2, $a7, 0
	vaddi.wu	$vr0, $vr0, 4
	...
	addi.d	$a7, $a7, 16
	bnez	$a6, .LBB2_244
# %bb.245:                              # %vec.epilog.middle.block1075
	bne	$a4, $a5, .LBB2_293
	b	.LBB2_295
.LBB2_246:                              # %vector.ph1145
...
.LBB2_247:                              # %vector.body1148
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB2_247
# %bb.248:                              # %middle.block1154
	beq	$a3, $a4, .LBB2_252
# %bb.249:                              # %vec.epilog.iter.check1159
	andi	$a6, $a5, 12
	bnez	$a6, .LBB2_238
...
.LBB2_275:                              #   in Loop: Header=BB2_254 Depth=1
	move	$t5, $s1
	move	$t6, $s8
.LBB2_276:                              # %while.body.i621.preheader1228
                                        #   in Loop: Header=BB2_254 Depth=1
	move	$t7, $t5
	move	$t8, $t6
	.p2align	4, , 16
...
.LBB2_318:                              #   in Loop: Header=BB2_297 Depth=1
	move	$s0, $s1
	move	$s4, $s8
.LBB2_319:                              # %while.body.i547.preheader1233
                                        #   in Loop: Header=BB2_297 Depth=1
	move	$s1, $s0
	move	$a6, $s4
	.p2align	4, , 16
