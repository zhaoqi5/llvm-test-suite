...
# %bb.21:                               # %cond.true98
	...
	addi.d	$s1, $s3, 14
	b	.LBB3_25
.LBB3_22:                               # %cond.end63.thread127
                                        #   in Loop: Header=BB3_15 Depth=1
	alsl.d	$s0, $t3, $a3, 1
	ld.hu	$s0, $s0, 2
.LBB3_23:                               # %cond.end93.thread134
                                        #   in Loop: Header=BB3_15 Depth=1
	alsl.d	$s2, $t3, $t2, 1
	ld.h	$s2, $s2, 8
.LBB3_24:                               # %cond.end111
...
# %bb.37:                               # %middle.block105
                                        #   in Loop: Header=BB5_31 Depth=2
	beq	$a6, $a0, .LBB5_30
# %bb.38:                               # %vec.epilog.iter.check110
                                        #   in Loop: Header=BB5_31 Depth=2
	move	$t5, $a6
	move	$t4, $a6
	beqz	$a7, .LBB5_42
.LBB5_39:                               # %vec.epilog.ph109
                                        #   in Loop: Header=BB5_31 Depth=2
	add.d	$t2, $t1, $t5
	alsl.d	$t3, $t5, $s4, 1
	add.d	$t4, $a2, $t5
	slli.d	$t4, $t4, 1
	.p2align	4, , 16
.LBB5_40:                               # %vec.epilog.vector.body115
                                        #   Parent Loop BB5_18 Depth=1
                                        #     Parent Loop BB5_31 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vldx	$vr0, $s4, $t4
	...
	addi.d	$t4, $t4, 16
	bnez	$t2, .LBB5_40
# %bb.41:                               # %vec.epilog.middle.block119
                                        #   in Loop: Header=BB5_31 Depth=2
	move	$t4, $t0
	beq	$t0, $a0, .LBB5_30
...
.LBB6_49:                               # %vec.epilog.ph151
	...
	alsl.d	$a5, $a1, $t7, 1
	.p2align	4, , 16
.LBB6_50:                               # %vec.epilog.vector.body157
                                        #   Parent Loop BB6_21 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	xvslli.d	$xr2, $xr0, 2
	xvslli.d	$xr3, $xr1, 2
...
.LBB6_57:                               # %cleanup141
	move	$a0, $a1
	b	.LBB6_70
.LBB6_58:                               # %vector.main.loop.iter.check169
	ori	$a1, $zero, 16
	bgeu	$s2, $a1, .LBB6_63
# %bb.59:
	move	$a1, $zero
.LBB6_60:                               # %vec.epilog.ph182
	move	$a4, $a1
	...
	alsl.d	$a4, $a4, $s4, 1
	.p2align	4, , 16
.LBB6_61:                               # %vec.epilog.vector.body191
                                        # =>This Inner Loop Header: Depth=1
	xvslli.d	$xr2, $xr0, 2
	xvslli.d	$xr3, $xr1, 2
