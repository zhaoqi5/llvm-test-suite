...
# %bb.37:                               #   in Loop: Header=BB2_36 Depth=1
	...
	b	.LBB2_41
	.p2align	4, , 16
.LBB2_38:                               # %vector.body192.preheader
                                        #   in Loop: Header=BB2_36 Depth=1
	move	$t0, $a4
	move	$t1, $a5
	.p2align	4, , 16
.LBB2_39:                               # %vector.body192
...
# %bb.49:                               #   in Loop: Header=BB2_48 Depth=1
	...
	b	.LBB2_53
	.p2align	4, , 16
.LBB2_50:                               # %vector.body181.preheader
                                        #   in Loop: Header=BB2_48 Depth=1
	move	$t3, $a4
	move	$t4, $a7
	move	$t5, $a2
	.p2align	4, , 16
.LBB2_51:                               # %vector.body181
...
# %bb.5:                                # %for.body.us.preheader
	...
	b	.LBB3_9
	.p2align	4, , 16
.LBB3_6:                                # %cond.end.thread.us
                                        #   in Loop: Header=BB3_9 Depth=1
	slli.d	$t6, $t3, 1
	ldx.hu	$t6, $a3, $t6
	move	$t7, $t3
.LBB3_7:                                # %cond.false58.us
                                        #   in Loop: Header=BB3_9 Depth=1
	alsl.d	$t7, $t7, $a3, 1
	addi.d	$t7, $t7, 2
...
.LBB3_13:                               #   in Loop: Header=BB3_9 Depth=1
	move	$t7, $t4
	b	.LBB3_7
.LBB3_14:                               # %if.end12.for.end_crit_edge
	fldx.d	$fa1, $a7, $t1
	move	$a0, $zero
	move	$t3, $zero
	b	.LBB3_29
.LBB3_15:                               # %for.body.preheader
	vldi	$vr3, -912
	vldi	$vr4, -896
	addi.w	$t5, $zero, -2
	vldi	$vr5, -1000
...
# %bb.22:                               # %cond.true98
	...
	addi.d	$s1, $s3, 14
	b	.LBB3_26
.LBB3_23:                               # %cond.end63.thread129
                                        #   in Loop: Header=BB3_16 Depth=1
	alsl.d	$fp, $t3, $a3, 1
	ld.hu	$fp, $fp, 2
	fadd.d	$ft0, $fa7, $fa3
	fadd.d	$ft1, $fa7, $fa4
.LBB3_24:                               # %cond.end93.thread137
                                        #   in Loop: Header=BB3_16 Depth=1
	alsl.d	$s2, $t3, $t2, 1
	ld.h	$s2, $s2, 8
.LBB3_25:                               # %cond.end111
...
# %bb.32:                               #   in Loop: Header=BB5_31 Depth=2
	...
	b	.LBB5_42
	.p2align	4, , 16
.LBB5_33:                               # %vector.main.loop.iter.check96
                                        #   in Loop: Header=BB5_31 Depth=2
	bgeu	$a0, $t5, .LBB5_35
# %bb.34:                               #   in Loop: Header=BB5_31 Depth=2
	...
	b	.LBB5_39
	.p2align	4, , 16
.LBB5_35:                               # %vector.body100.preheader
                                        #   in Loop: Header=BB5_31 Depth=2
	move	$t2, $s4
	move	$t3, $a6
	.p2align	4, , 16
.LBB5_36:                               # %vector.body100
                                        #   Parent Loop BB5_18 Depth=1
	...
	addi.d	$t2, $t2, 64
	bnez	$t3, .LBB5_36
# %bb.37:                               # %middle.block105
                                        #   in Loop: Header=BB5_31 Depth=2
	beq	$a6, $a0, .LBB5_30
# %bb.38:                               # %vec.epilog.iter.check109
                                        #   in Loop: Header=BB5_31 Depth=2
	move	$t4, $a6
	move	$t3, $a6
	beqz	$a5, .LBB5_42
.LBB5_39:                               # %vec.epilog.ph111
	...
	alsl.d	$t4, $t4, $a3, 1
	.p2align	4, , 16
.LBB5_40:                               # %vec.epilog.vector.body114
                                        #   Parent Loop BB5_18 Depth=1
                                        #     Parent Loop BB5_31 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vldx	$vr0, $s4, $t4
	...
	addi.d	$t4, $t4, 16
	bnez	$t2, .LBB5_40
# %bb.41:                               # %vec.epilog.middle.block118
                                        #   in Loop: Header=BB5_31 Depth=2
	move	$t3, $a7
	beq	$a7, $a0, .LBB5_30
...
.LBB5_50:                               # %vector.body
	...
	xvadd.w	$xr2, $xr5, $xr2
	xvsrli.w	$xr3, $xr1, 31
	xvavg.wu	$xr1, $xr1, $xr3
	xvsrli.w	$xr3, $xr2, 31
	xvavg.wu	$xr2, $xr2, $xr3
...
.LBB6_8:                                # %if.end26
	...
	pcalau12i	$s1, %pc_hi20(mf_size)
	pcalau12i	$s4, %pc_hi20(mf_samples_to_encode)
	bnez	$a0, .LBB6_11
# %bb.9:                                # %if.end26
...
# %bb.10:                               # %if.then29
	...
	ori	$a1, $zero, 1088
	ld.d	$a0, $s8, 168
	st.w	$a1, $s4, %pc_lo12(mf_samples_to_encode)
	ori	$a1, $zero, 752
	st.w	$a1, $s1, %pc_lo12(mf_size)
.LBB6_11:                               # %if.end30
	ori	$a1, $zero, 1
	bne	$a0, $a1, .LBB6_13
# %bb.12:                               # %if.then34
...
.LBB6_19:                               # %while.body.lr.ph
	addi.w	$s5, $fp, 752
	pcalau12i	$a0, %pc_hi20(mfbuf)
	addi.d	$ra, $a0, %pc_lo12(mfbuf)
	move	$t7, $zero
	ld.w	$a2, $s8, 188
	ld.w	$a0, $s1, %pc_lo12(mf_size)
	lu12i.w	$a1, 1
...
# %bb.22:                               # %iter.check138
	...
	ori	$a1, $zero, 8
	blt	$s0, $a1, .LBB6_25
# %bb.23:                               # %vector.memcheck133
                                        #   in Loop: Header=BB6_21 Depth=1
	alsl.d	$a3, $a0, $ra, 1
	alsl.d	$a4, $a6, $s3, 2
	bgeu	$a3, $a4, .LBB6_47
# %bb.24:                               # %vector.memcheck133
                                        #   in Loop: Header=BB6_21 Depth=1
	add.d	$a3, $a0, $a6
	alsl.d	$a3, $a3, $ra, 1
	add.d	$a3, $a3, $fp
...
.LBB6_28:                               # %for.end94
                                        #   in Loop: Header=BB6_21 Depth=1
	ld.w	$a1, $s4, %pc_lo12(mf_samples_to_encode)
	add.w	$a0, $a0, $s0
	st.w	$a0, $s1, %pc_lo12(mf_size)
	add.d	$a1, $a1, $s0
	st.w	$a1, $s4, %pc_lo12(mf_samples_to_encode)
	blt	$a0, $s5, .LBB6_20
# %bb.29:                               # %if.then101
...
# %bb.30:                               # %if.end106
	...
	add.d	$s7, $s7, $a0
	ld.w	$a2, $s8, 188
	ld.w	$a3, $s1, %pc_lo12(mf_size)
	add.w	$t7, $a0, $t7
	ld.w	$a4, $s4, %pc_lo12(mf_samples_to_encode)
	ld.w	$a1, $s8, 204
	sub.w	$a0, $a3, $a2
	st.w	$a0, $s1, %pc_lo12(mf_size)
	sub.d	$a3, $a4, $a2
	st.w	$a3, $s4, %pc_lo12(mf_samples_to_encode)
	blez	$a1, .LBB6_20
# %bb.31:                               # %if.end106
                                        #   in Loop: Header=BB6_21 Depth=1
	blez	$a0, .LBB6_20
...
.LBB6_49:                               # %vec.epilog.ph153
	...
	alsl.d	$a5, $a1, $ra, 1
	.p2align	4, , 16
.LBB6_50:                               # %vec.epilog.vector.body156
                                        #   Parent Loop BB6_21 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	xvslli.d	$xr2, $xr0, 2
	xvslli.d	$xr3, $xr1, 2
	...
	addi.d	$a5, $a5, 16
	bnez	$a4, .LBB6_50
# %bb.51:                               # %vec.epilog.middle.block161
                                        #   in Loop: Header=BB6_21 Depth=1
...
# %bb.54:                               # %middle.block147
	...
	ld.d	$a3, $sp, 160                   # 8-byte Folded Reload
	beq	$a3, $a6, .LBB6_28
# %bb.55:                               # %vec.epilog.iter.check151
                                        #   in Loop: Header=BB6_21 Depth=1
...
.LBB6_57:                               # %cleanup141
	move	$a0, $a1
	b	.LBB6_70
.LBB6_58:                               # %vector.main.loop.iter.check168
	ori	$a1, $zero, 16
	bgeu	$s2, $a1, .LBB6_63
# %bb.59:
	move	$a1, $zero
.LBB6_60:                               # %vec.epilog.ph183
	move	$a4, $a1
	...
	alsl.d	$a4, $a4, $s4, 1
	.p2align	4, , 16
.LBB6_61:                               # %vec.epilog.vector.body189
                                        # =>This Inner Loop Header: Depth=1
	xvslli.d	$xr2, $xr0, 2
	xvslli.d	$xr3, $xr1, 2
	...
	addi.d	$a4, $a4, 16
	bnez	$a2, .LBB6_61
# %bb.62:                               # %vec.epilog.middle.block194
	bne	$a1, $s2, .LBB6_67
	b	.LBB6_69
.LBB6_63:                               # %vector.ph169
	st.d	$s8, $sp, 24                    # 8-byte Folded Spill
	st.d	$s7, $sp, 40                    # 8-byte Folded Spill
	st.d	$s6, $sp, 32                    # 8-byte Folded Spill
...
.LBB6_64:                               # %vector.body172
	...
	ldx.h	$ra, $s3, $s5
	ldx.h	$a2, $s3, $s6
	vinsgr2vr.h	$vr4, $s7, 0
	ldx.h	$s7, $s3, $t6
	vinsgr2vr.h	$vr4, $s8, 1
	ldx.h	$s8, $s3, $t7
	vinsgr2vr.h	$vr4, $ra, 2
	ldx.h	$ra, $s3, $t8
	vinsgr2vr.h	$vr4, $a2, 3
	ldx.h	$a2, $s3, $fp
	vinsgr2vr.h	$vr4, $s7, 4
	ldx.h	$s7, $s3, $t2
	vinsgr2vr.h	$vr4, $s8, 5
	ldx.h	$s8, $s3, $t3
	...
	addi.d	$a3, $a3, 32
	bnez	$a5, .LBB6_64
# %bb.65:                               # %middle.block177
	ld.d	$s6, $sp, 32                    # 8-byte Folded Reload
	ld.d	$s7, $sp, 40                    # 8-byte Folded Reload
	ld.d	$s8, $sp, 24                    # 8-byte Folded Reload
	beq	$a1, $s2, .LBB6_69
# %bb.66:                               # %vec.epilog.iter.check181
