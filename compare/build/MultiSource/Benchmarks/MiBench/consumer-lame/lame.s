...
# %bb.37:                               #   in Loop: Header=BB2_36 Depth=1
	...
	b	.LBB2_41
	.p2align	4, , 16
.LBB2_38:                               # %vector.body193.preheader
                                        #   in Loop: Header=BB2_36 Depth=1
	move	$t0, $a4
	move	$t1, $a5
	.p2align	4, , 16
.LBB2_39:                               # %vector.body193
...
# %bb.49:                               #   in Loop: Header=BB2_48 Depth=1
	...
	b	.LBB2_53
	.p2align	4, , 16
.LBB2_50:                               # %vector.body182.preheader
                                        #   in Loop: Header=BB2_48 Depth=1
	move	$t3, $a7
	move	$t4, $a4
	move	$t5, $a2
	.p2align	4, , 16
.LBB2_51:                               # %vector.body182
...
# %bb.37:                               # %vec.epilog.middle.block
	...
	b	.LBB5_42
	.p2align	4, , 16
.LBB5_38:                               # %vector.body91.preheader
                                        #   in Loop: Header=BB5_31 Depth=2
	move	$t2, $s4
	move	$t3, $a6
	.p2align	4, , 16
.LBB5_39:                               # %vector.body91
                                        #   Parent Loop BB5_18 Depth=1
                                        #     Parent Loop BB5_31 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	add.d	$t4, $t2, $a3
...
# %bb.32:                               # %if.end106
	...
	ld.d	$s0, $sp, 120                   # 8-byte Folded Reload
	blez	$a0, .LBB6_21
# %bb.33:                               # %for.cond119.preheader.us.preheader
                                        #   in Loop: Header=BB6_22 Depth=1
	move	$a3, $zero
	slli.d	$a4, $a2, 1
	sub.d	$a5, $zero, $a4
	...
	b	.LBB6_35
	.p2align	4, , 16
.LBB6_34:                               # %for.cond119.for.inc136_crit_edge.us
...
# %bb.45:                               # %vec.epilog.iter.check
	...
	bnez	$a6, .LBB6_39
	.p2align	4, , 16
.LBB6_46:                               # %for.body122.us.preheader
                                        #   in Loop: Header=BB6_35 Depth=2
	slli.d	$t4, $t5, 1
	sub.d	$t5, $a0, $t5
	.p2align	4, , 16
.LBB6_47:                               # %for.body122.us
                                        #   Parent Loop BB6_22 Depth=1
                                        #     Parent Loop BB6_35 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ldx.h	$t6, $t2, $t4
