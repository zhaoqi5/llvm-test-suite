...
.LBB1_22:                               # %while.body.us
	...
	b	.LBB1_24
	.p2align	4, , 16
.LBB1_23:                               # %for.inc.i74.us
                                        #   in Loop: Header=BB1_24 Depth=2
	fmadd.d	$fa1, $fa2, $fa2, $fa1
	add.d	$a1, $a1, $fp
	add.d	$a0, $a0, $s3
	bge	$a1, $s2, .LBB1_28
.LBB1_24:                               # %for.body.i55.us
...
# %bb.26:                               # %if.then10.i68.us
	...
	fcmp.cule.d	$fcc0, $fa5, $fa4
	bcnez	$fcc0, .LBB1_23
# %bb.27:                               # %if.then19.i78.us
                                        #   in Loop: Header=BB1_24 Depth=2
	fmov.d	$fa2, $fa3
	b	.LBB1_23
	.p2align	4, , 16
.LBB1_28:                               # %calc_sfb_ave_noise.exit79.loopexit.us
                                        #   in Loop: Header=BB1_22 Depth=1
	fdiv.d	$fa0, $fa1, $fs4
	fcmp.cule.d	$fcc0, $fa0, $fs0
	bcnez	$fcc0, .LBB1_21
# %bb.29:                               # %calc_sfb_ave_noise.exit79.loopexit.us
                                        #   in Loop: Header=BB1_22 Depth=1
...
# %bb.30:
	fmov.d	$fs1, $fs2
	b	.LBB1_35
.LBB1_31:                               # %while.body.lr.ph.split
	movgr2fr.d	$fa2, $zero
	fdiv.d	$fa1, $fa2, $fs4
	fcmp.cule.d	$fcc0, $fa1, $fa2
	bcnez	$fcc0, .LBB1_34
# %bb.32:                               # %while.body.lr.ph.split
