...
# %bb.21:                               #   in Loop: Header=BB3_17 Depth=1
	...
	b	.LBB3_42
	.p2align	4, , 16
.LBB3_22:                               # %vector.main.loop.iter.check72
                                        #   in Loop: Header=BB3_17 Depth=1
	bgeu	$a1, $t7, .LBB3_26
...
# %bb.25:                               #   in Loop: Header=BB3_17 Depth=1
	move	$s4, $zero
	b	.LBB3_39
.LBB3_26:                               # %vector.body76.preheader
                                        #   in Loop: Header=BB3_17 Depth=1
	move	$s0, $t6
	move	$s2, $t3
	move	$s3, $a7
	.p2align	4, , 16
.LBB3_27:                               # %vector.body76
	...
	addi.d	$s0, $s0, 64
	bnez	$s3, .LBB3_27
# %bb.28:                               # %middle.block81
                                        #   in Loop: Header=BB3_17 Depth=1
	beq	$a7, $a5, .LBB3_16
# %bb.29:                               # %vec.epilog.iter.check86
                                        #   in Loop: Header=BB3_17 Depth=1
	move	$s4, $a7
	move	$s3, $a7
	beqz	$t0, .LBB3_33
.LBB3_30:                               # %vec.epilog.ph85
                                        #   in Loop: Header=BB3_17 Depth=1
	add.d	$s0, $t4, $s4
	alsl.d	$s2, $s4, $fp, 1
	alsl.d	$s3, $s4, $t8, 1
	.p2align	4, , 16
.LBB3_31:                               # %vec.epilog.vector.body91
                                        #   Parent Loop BB3_17 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $s3, 0
	vst	$vr0, $s2, 0
	...
	addi.d	$s3, $s3, 16
	bnez	$s0, .LBB3_31
# %bb.32:                               # %vec.epilog.middle.block95
                                        #   in Loop: Header=BB3_17 Depth=1
	move	$s3, $t1
	beq	$t1, $a5, .LBB3_16
