...
# %bb.28:                               # %middle.block83
                                        #   in Loop: Header=BB3_17 Depth=1
	beq	$t0, $a5, .LBB3_16
# %bb.29:                               # %vec.epilog.iter.check87
                                        #   in Loop: Header=BB3_17 Depth=1
	move	$s4, $t0
	move	$s3, $t0
	beqz	$a7, .LBB3_33
.LBB3_30:                               # %vec.epilog.ph89
                                        #   in Loop: Header=BB3_17 Depth=1
	add.d	$s0, $t4, $s4
	alsl.d	$s2, $s4, $fp, 1
	alsl.d	$s3, $s4, $t8, 1
	.p2align	4, , 16
.LBB3_31:                               # %vec.epilog.vector.body92
                                        #   Parent Loop BB3_17 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $s3, 0
	vst	$vr0, $s2, 0
	...
	addi.d	$s3, $s3, 16
	bnez	$s0, .LBB3_31
# %bb.32:                               # %vec.epilog.middle.block96
                                        #   in Loop: Header=BB3_17 Depth=1
	move	$s3, $t1
	beq	$t1, $a5, .LBB3_16
...
# %bb.19:                               # %middle.block66
                                        #   in Loop: Header=BB4_8 Depth=1
	beq	$a7, $a1, .LBB4_7
# %bb.20:                               # %vec.epilog.iter.check70
                                        #   in Loop: Header=BB4_8 Depth=1
	move	$s4, $a7
	move	$s3, $a7
	beqz	$a6, .LBB4_24
.LBB4_21:                               # %vec.epilog.ph72
                                        #   in Loop: Header=BB4_8 Depth=1
	add.d	$t8, $t3, $s4
	alsl.d	$s2, $s4, $fp, 1
	alsl.d	$s3, $s4, $t7, 1
	.p2align	4, , 16
.LBB4_22:                               # %vec.epilog.vector.body75
                                        #   Parent Loop BB4_8 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $s3, 0
	vst	$vr0, $s2, 0
	...
	addi.d	$s3, $s3, 16
	bnez	$t8, .LBB4_22
# %bb.23:                               # %vec.epilog.middle.block79
                                        #   in Loop: Header=BB4_8 Depth=1
	move	$s3, $t0
	beq	$t0, $a1, .LBB4_7
