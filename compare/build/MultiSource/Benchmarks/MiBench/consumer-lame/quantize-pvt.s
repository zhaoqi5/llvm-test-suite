...
.LBB0_18:                               # %vector.body
	...
	xvpermi.q	$xr3, $xr2, 2
	xvseqi.w	$xr2, $xr3, 2
	xvandn.v	$xr3, $xr2, $xr0
	xvandn.v	$xr2, $xr2, $xr1
	xvstelm.w	$xr3, $t2, -360, 0
	xvstelm.w	$xr3, $t2, -240, 1
	xvstelm.w	$xr3, $t2, -120, 2
	xvstelm.w	$xr3, $t2, 0, 3
	xvstelm.w	$xr3, $t2, 120, 4
	xvstelm.w	$xr3, $t2, 240, 5
	xvstelm.w	$xr3, $t2, 360, 6
	xvstelm.w	$xr3, $t2, 480, 7
	xvstelm.w	$xr2, $t2, -356, 0
	xvstelm.w	$xr2, $t2, -236, 1
	xvstelm.w	$xr2, $t2, -116, 2
	xvstelm.w	$xr2, $t2, 4, 3
	xvstelm.w	$xr2, $t2, 124, 4
	xvstelm.w	$xr2, $t2, 244, 5
	xvstelm.w	$xr2, $t2, 364, 6
	xvstelm.w	$xr2, $t2, 484, 7
	addi.d	$t3, $t3, -8
	addi.d	$t2, $t2, 960
	bnez	$t3, .LBB0_18
# %bb.19:                               # %middle.block
...
# %bb.10:
	...
	move	$a5, $zero
	b	.LBB8_17
.LBB8_11:                               # %vector.main.loop.iter.check275
...
.LBB8_27:
	move	$t5, $zero
	b	.LBB8_67
.LBB8_28:                               # %vector.main.loop.iter.check153
	ori	$t0, $zero, 16
	bgeu	$t1, $t0, .LBB8_30
# %bb.29:
	move	$t3, $zero
	move	$t0, $zero
	b	.LBB8_34
.LBB8_30:                               # %vector.ph154
	andi	$t4, $t1, 12
	bstrpick.d	$t0, $t1, 30, 4
	slli.d	$t3, $t0, 4
	alsl.d	$t0, $t2, $a0, 2
	xvrepli.b	$xr0, 0
	addi.d	$t0, $t0, 32
...
# %bb.32:                               # %middle.block164
	...
	beq	$t3, $t1, .LBB8_39
# %bb.33:                               # %vec.epilog.iter.check170
	beqz	$t4, .LBB8_128
.LBB8_34:                               # %vec.epilog.ph172
	bstrpick.d	$t4, $t1, 30, 2
	slli.d	$t5, $t4, 2
	alsl.d	$t4, $t4, $t2, 2
	vreplgr2vr.w	$vr0, $t0
	slli.d	$t0, $t3, 2
	...
	sub.d	$t2, $t3, $t5
	.p2align	4, , 16
.LBB8_35:                               # %vec.epilog.vector.body177
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $t0, 0
	vmax.w	$vr0, $vr1, $vr0
	addi.d	$t2, $t2, 4
	addi.d	$t0, $t0, 16
	bnez	$t2, .LBB8_35
# %bb.36:                               # %vec.epilog.middle.block182
	vbsrl.v	$vr1, $vr0, 8
	vmax.w	$vr0, $vr1, $vr0
	vbsrl.v	$vr1, $vr0, 4
	vmax.w	$vr0, $vr1, $vr0
	vpickve2gr.w	$t0, $vr0, 0
	beq	$t5, $t1, .LBB8_39
.LBB8_37:                               # %for.body58.1.preheader
	alsl.d	$t2, $t4, $a0, 2
	sub.d	$t3, $t1, $t5
	.p2align	4, , 16
.LBB8_38:                               # %for.body58.1
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t4, $t2, 0
	slt	$t5, $t0, $t4
	masknez	$t0, $t0, $t5
	...
	addi.d	$t2, $t2, 4
	bnez	$t3, .LBB8_38
.LBB8_39:                               # %for.cond56.for.inc75_crit_edge.1
	add.w	$a7, $a7, $t1
	ld.w	$t1, $a6, 8
	blez	$t1, .LBB8_26
.LBB8_40:                               # %iter.check191
	ori	$t2, $zero, 4
	bgeu	$t1, $t2, .LBB8_42
# %bb.41:
	move	$t2, $zero
	...
	move	$t4, $a7
	b	.LBB8_51
.LBB8_42:                               # %vector.main.loop.iter.check193
	ori	$t2, $zero, 16
	bgeu	$t1, $t2, .LBB8_44
# %bb.43:
	move	$t3, $zero
	move	$t2, $zero
	b	.LBB8_48
.LBB8_44:                               # %vector.ph194
	andi	$t4, $t1, 12
	bstrpick.d	$t2, $t1, 30, 4
	slli.d	$t3, $t2, 4
	alsl.d	$t2, $a7, $a0, 2
	xvrepli.b	$xr0, 0
	addi.d	$t2, $t2, 32
...
# %bb.46:                               # %middle.block204
	...
	beq	$t3, $t1, .LBB8_53
# %bb.47:                               # %vec.epilog.iter.check210
	beqz	$t4, .LBB8_129
.LBB8_48:                               # %vec.epilog.ph212
	bstrpick.d	$t4, $t1, 30, 2
	slli.d	$t5, $t4, 2
	alsl.d	$t4, $t4, $a7, 2
	vreplgr2vr.w	$vr0, $t2
	...
	sub.d	$t3, $t3, $t5
	.p2align	4, , 16
.LBB8_49:                               # %vec.epilog.vector.body217
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $t2, 0
	vmax.w	$vr0, $vr1, $vr0
	addi.d	$t3, $t3, 4
	addi.d	$t2, $t2, 16
	bnez	$t3, .LBB8_49
# %bb.50:                               # %vec.epilog.middle.block223
	vbsrl.v	$vr1, $vr0, 8
	vmax.w	$vr0, $vr1, $vr0
	vbsrl.v	$vr1, $vr0, 4
	vmax.w	$vr0, $vr1, $vr0
	vpickve2gr.w	$t2, $vr0, 0
	beq	$t5, $t1, .LBB8_53
.LBB8_51:                               # %for.body58.2.preheader
	alsl.d	$t3, $t4, $a0, 2
	sub.d	$t4, $t1, $t5
	.p2align	4, , 16
.LBB8_52:                               # %for.body58.2
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t5, $t3, 0
	slt	$t6, $t2, $t5
	masknez	$t2, $t2, $t6
	...
	addi.d	$t3, $t3, 4
	bnez	$t4, .LBB8_52
.LBB8_53:                               # %for.cond56.for.inc75_crit_edge.2
	add.w	$a7, $a7, $t1
	ld.w	$a6, $a6, 12
	blez	$a6, .LBB8_27
.LBB8_54:                               # %iter.check232
	ori	$t1, $zero, 4
	bgeu	$a6, $t1, .LBB8_56
# %bb.55:
	move	$t5, $zero
	...
	move	$t3, $a7
	b	.LBB8_65
.LBB8_56:                               # %vector.main.loop.iter.check234
	ori	$t1, $zero, 16
	bgeu	$a6, $t1, .LBB8_58
# %bb.57:
	move	$t1, $zero
	move	$t5, $zero
	b	.LBB8_62
.LBB8_58:                               # %vector.ph235
	andi	$t3, $a6, 12
	bstrpick.d	$t1, $a6, 30, 4
	slli.d	$t1, $t1, 4
	alsl.d	$t4, $a7, $a0, 2
	xvrepli.b	$xr0, 0
	addi.d	$t4, $t4, 32
...
# %bb.60:                               # %middle.block245
	...
	beq	$t1, $a6, .LBB8_67
# %bb.61:                               # %vec.epilog.iter.check251
	beqz	$t3, .LBB8_130
.LBB8_62:                               # %vec.epilog.ph253
	bstrpick.d	$t3, $a6, 30, 2
	slli.d	$t4, $t3, 2
	alsl.d	$t3, $t3, $a7, 2
	vreplgr2vr.w	$vr0, $t5
	slli.d	$t5, $t1, 2
	...
	sub.d	$t1, $t1, $t4
	.p2align	4, , 16
.LBB8_63:                               # %vec.epilog.vector.body258
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a7, 0
	vmax.w	$vr0, $vr1, $vr0
	addi.d	$t1, $t1, 4
	addi.d	$a7, $a7, 16
	bnez	$t1, .LBB8_63
# %bb.64:                               # %vec.epilog.middle.block264
	vbsrl.v	$vr1, $vr0, 8
	vmax.w	$vr0, $vr1, $vr0
	vbsrl.v	$vr1, $vr0, 4
	vmax.w	$vr0, $vr1, $vr0
	vpickve2gr.w	$t5, $vr0, 0
	beq	$t4, $a6, .LBB8_67
.LBB8_65:                               # %for.body58.3.preheader
	alsl.d	$a0, $t3, $a0, 2
	sub.d	$a6, $a6, $t4
	.p2align	4, , 16
.LBB8_66:                               # %for.body58.3
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a7, $a0, 0
	slt	$t1, $t5, $a7
	masknez	$t3, $t5, $t1
...
.LBB8_67:
	move	$a6, $zero
	b	.LBB8_122
.LBB8_68:                               # %vector.ph276
	andi	$t4, $t3, 12
	bstrpick.d	$a5, $t3, 32, 4
	slli.d	$t2, $a5, 4
	xvrepli.b	$xr0, 0
	addi.d	$a5, $a0, 140
	move	$t5, $t2
...
# %bb.70:                               # %middle.block284
	...
	vpickve2gr.w	$a5, $vr0, 0
	beq	$t3, $t2, .LBB8_77
# %bb.71:                               # %vec.epilog.iter.check290
	beqz	$t4, .LBB8_75
.LBB8_72:                               # %vec.epilog.ph292
	move	$t4, $t2
	...
	addi.d	$t4, $t4, 132
	.p2align	4, , 16
.LBB8_73:                               # %vec.epilog.vector.body297
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t5, $t4, -44
	ld.w	$t6, $t4, -32
	ld.w	$t7, $t4, -20
	...
	addi.d	$t4, $t4, 48
	bnez	$a5, .LBB8_73
# %bb.74:                               # %vec.epilog.middle.block301
	vbsrl.v	$vr1, $vr0, 8
	vmax.w	$vr0, $vr1, $vr0
	vbsrl.v	$vr1, $vr0, 4
	vmax.w	$vr0, $vr1, $vr0
	vpickve2gr.w	$a5, $vr0, 0
	beq	$t3, $t2, .LBB8_77
.LBB8_75:                               # %for.cond16.preheader.preheader
	slli.d	$t3, $t2, 3
	alsl.d	$t3, $t2, $t3, 2
	add.d	$t3, $t3, $a0
	addi.d	$t3, $t3, 96
...
# %bb.82:
	...
	move	$t6, $a7
	b	.LBB8_108
.LBB8_83:                               # %vector.main.loop.iter.check349
...
# %bb.84:
	...
	move	$t2, $zero
	b	.LBB8_91
.LBB8_85:                               # %vector.main.loop.iter.check311
...
# %bb.86:
	...
	move	$t0, $zero
	b	.LBB8_105
.LBB8_87:                               # %vector.ph350
	andi	$t7, $t5, 12
	bstrpick.d	$t2, $t5, 32, 4
	slli.d	$t6, $t2, 4
	ori	$t2, $zero, 12
	mul.d	$t2, $a7, $t2
	add.d	$t2, $t2, $a0
...
# %bb.89:                               # %middle.block358
	...
	vpickve2gr.w	$t2, $vr0, 0
	beq	$t5, $t6, .LBB8_96
# %bb.90:                               # %vec.epilog.iter.check364
	beqz	$t7, .LBB8_131
.LBB8_91:                               # %vec.epilog.ph366
	bstrpick.d	$t8, $t5, 32, 2
	slli.d	$t7, $t8, 2
	alsl.d	$t8, $t8, $a7, 2
	vreplgr2vr.w	$vr0, $t2
	sub.d	$t2, $t6, $t7
	...
	addi.d	$t6, $t6, 132
	.p2align	4, , 16
.LBB8_92:                               # %vec.epilog.vector.body371
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$fp, $t6, -44
	ld.w	$s0, $t6, -32
	ld.w	$s1, $t6, -20
	...
	addi.d	$t6, $t6, 48
	bnez	$t2, .LBB8_92
# %bb.93:                               # %vec.epilog.middle.block376
	vbsrl.v	$vr1, $vr0, 8
	vmax.w	$vr0, $vr1, $vr0
	vbsrl.v	$vr1, $vr0, 4
	vmax.w	$vr0, $vr1, $vr0
	vpickve2gr.w	$t2, $vr0, 0
	beq	$t5, $t7, .LBB8_96
.LBB8_94:                               # %for.cond16.preheader.2.preheader
	slli.d	$t5, $t8, 3
	alsl.d	$t5, $t8, $t5, 2
	add.d	$t5, $t5, $a0
	addi.d	$t5, $t5, 96
	sub.d	$t6, $t4, $t7
	.p2align	4, , 16
.LBB8_95:                               # %for.cond16.preheader.2
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t7, $t5, -8
	slt	$t8, $t2, $t7
	ld.w	$fp, $t5, -4
	...
	addi.d	$t5, $t5, 12
	bnez	$t6, .LBB8_95
.LBB8_96:                               # %for.cond13.for.inc42_crit_edge.2
	add.w	$a7, $a7, $t4
	ld.wu	$t4, $a6, 28
	ori	$a6, $zero, 1
	bltu	$t4, $t3, .LBB8_112
.LBB8_97:                               # %iter.check385
	mul.d	$t1, $t4, $t1
	srli.d	$t1, $t1, 33
	addi.d	$t4, $t1, -1
	ori	$t3, $zero, 3
...
# %bb.98:
	...
	move	$t7, $a7
	b	.LBB8_120
.LBB8_99:                               # %vector.main.loop.iter.check387
...
# %bb.100:
	...
	move	$t5, $zero
	b	.LBB8_117
.LBB8_101:                              # %vector.ph312
	andi	$t5, $t3, 12
	bstrpick.d	$t0, $t3, 32, 4
	slli.d	$t4, $t0, 4
	ori	$t0, $zero, 12
	mul.d	$t0, $a7, $t0
	add.d	$t0, $t0, $a0
...
# %bb.103:                              # %middle.block320
	...
	vpickve2gr.w	$t0, $vr0, 0
	beq	$t3, $t4, .LBB8_110
# %bb.104:                              # %vec.epilog.iter.check326
	beqz	$t5, .LBB8_132
.LBB8_105:                              # %vec.epilog.ph328
	bstrpick.d	$t6, $t3, 32, 2
	slli.d	$t5, $t6, 2
	alsl.d	$t6, $t6, $a7, 2
	vreplgr2vr.w	$vr0, $t0
	sub.d	$t0, $t4, $t5
	...
	addi.d	$t4, $t4, 132
	.p2align	4, , 16
.LBB8_106:                              # %vec.epilog.vector.body333
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t7, $t4, -44
	ld.w	$t8, $t4, -32
	ld.w	$fp, $t4, -20
	...
	addi.d	$t4, $t4, 48
	bnez	$t0, .LBB8_106
# %bb.107:                              # %vec.epilog.middle.block338
	vbsrl.v	$vr1, $vr0, 8
	vmax.w	$vr0, $vr1, $vr0
	vbsrl.v	$vr1, $vr0, 4
	vmax.w	$vr0, $vr1, $vr0
	vpickve2gr.w	$t0, $vr0, 0
	beq	$t3, $t5, .LBB8_110
.LBB8_108:                              # %for.cond16.preheader.1.preheader
	slli.d	$t3, $t6, 3
	alsl.d	$t3, $t6, $t3, 2
	add.d	$t3, $t3, $a0
	addi.d	$t3, $t3, 96
	sub.d	$t4, $t2, $t5
	.p2align	4, , 16
.LBB8_109:                              # %for.cond16.preheader.1
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t5, $t3, -8
	slt	$t6, $t0, $t5
	ld.w	$t7, $t3, -4
	...
	addi.d	$t3, $t3, 12
	bnez	$t4, .LBB8_109
.LBB8_110:                              # %for.cond13.for.inc42_crit_edge.1
	add.w	$a7, $a7, $t2
	ld.wu	$t2, $a6, 24
	ori	$t3, $zero, 3
	bgeu	$t2, $t3, .LBB8_79
...
.LBB8_112:
	move	$t5, $zero
	b	.LBB8_122
.LBB8_113:                              # %vector.ph388
	andi	$t6, $t3, 12
	bstrpick.d	$t4, $t3, 32, 4
	slli.d	$t4, $t4, 4
	ori	$t5, $zero, 12
	mul.d	$t5, $a7, $t5
	add.d	$t5, $t5, $a0
...
# %bb.115:                              # %middle.block396
	...
	vpickve2gr.w	$t5, $vr0, 0
	beq	$t3, $t4, .LBB8_122
# %bb.116:                              # %vec.epilog.iter.check402
	beqz	$t6, .LBB8_133
.LBB8_117:                              # %vec.epilog.ph404
	bstrpick.d	$t7, $t3, 32, 2
	slli.d	$t6, $t7, 2
	alsl.d	$t7, $t7, $a7, 2
	vreplgr2vr.w	$vr0, $t5
	sub.d	$t5, $t4, $t6
	...
	addi.d	$a7, $a7, 132
	.p2align	4, , 16
.LBB8_118:                              # %vec.epilog.vector.body409
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t4, $a7, -44
	ld.w	$t8, $a7, -32
	ld.w	$fp, $a7, -20
	...
	addi.d	$a7, $a7, 48
	bnez	$t5, .LBB8_118
# %bb.119:                              # %vec.epilog.middle.block414
	vbsrl.v	$vr1, $vr0, 8
	vmax.w	$vr0, $vr1, $vr0
	vbsrl.v	$vr1, $vr0, 4
	vmax.w	$vr0, $vr1, $vr0
	vpickve2gr.w	$t5, $vr0, 0
	beq	$t3, $t6, .LBB8_122
.LBB8_120:                              # %for.cond16.preheader.3.preheader
	slli.d	$a7, $t7, 3
	alsl.d	$a7, $t7, $a7, 2
	add.d	$a0, $a7, $a0
	addi.d	$a0, $a0, 96
	sub.d	$a7, $t1, $t6
	.p2align	4, , 16
.LBB8_121:                              # %for.cond16.preheader.3
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t1, $a0, -8
	slt	$t3, $t5, $t1
	ld.w	$t4, $a0, -4
...
# %bb.123:                              # %if.then96
	...
	addi.d	$t1, $a5, %pc_lo12(scale_bitcount_lsf.log2tab)
	ldx.w	$a6, $t1, $a4
	st.w	$a6, $a1, 104
	slli.d	$a4, $t0, 2
	ldx.w	$a7, $t1, $a4
