...
# %bb.10:
	...
	move	$a4, $zero
	b	.LBB8_17
.LBB8_11:                               # %vector.main.loop.iter.check278
...
# %bb.32:                               # %middle.block164
	...
	beq	$t2, $t0, .LBB8_73
# %bb.33:                               # %vec.epilog.iter.check171
	andi	$t3, $t0, 12
	beqz	$t3, .LBB8_70
.LBB8_34:                               # %vec.epilog.ph170
	...
	alsl.d	$t1, $t1, $a0, 2
	.p2align	4, , 16
.LBB8_35:                               # %vec.epilog.vector.body178
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $t1, 0
	vmax.w	$vr0, $vr1, $vr0
	addi.d	$a6, $a6, 4
	addi.d	$t1, $t1, 16
	bnez	$a6, .LBB8_35
# %bb.36:                               # %vec.epilog.middle.block183
	vshuf4i.w	$vr1, $vr0, 14
	vmax.w	$vr0, $vr0, $vr1
	vreplvei.w	$vr1, $vr0, 1
	vmax.w	$vr0, $vr0, $vr1
...
# %bb.39:                               # %middle.block287
	...
	xvpickve2gr.w	$a4, $xr0, 0
	beq	$t2, $t1, .LBB8_46
# %bb.40:                               # %vec.epilog.iter.check294
	andi	$t3, $t2, 12
	beqz	$t3, .LBB8_44
.LBB8_41:                               # %vec.epilog.ph293
	move	$t3, $t1
	...
	addi.d	$t3, $t3, 132
	.p2align	4, , 16
.LBB8_42:                               # %vec.epilog.vector.body301
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t4, $t3, -44
	ld.w	$t5, $t3, -32
	ld.w	$t6, $t3, -20
	...
	addi.d	$t3, $t3, 48
	bnez	$a4, .LBB8_42
# %bb.43:                               # %vec.epilog.middle.block305
	vshuf4i.w	$vr1, $vr0, 14
	vmax.w	$vr0, $vr0, $vr1
	vreplvei.w	$vr1, $vr0, 1
	vmax.w	$vr0, $vr0, $vr1
...
# %bb.51:
	...
	move	$t5, $a5
	b	.LBB8_120
.LBB8_52:                               # %vector.main.loop.iter.check354
...
# %bb.53:
	...
	move	$t1, $zero
	b	.LBB8_60
.LBB8_54:                               # %vector.main.loop.iter.check315
...
# %bb.58:                               # %middle.block363
	...
	beq	$t4, $t5, .LBB8_107
# %bb.59:                               # %vec.epilog.iter.check370
	andi	$t6, $t4, 12
	beqz	$t6, .LBB8_104
.LBB8_60:                               # %vec.epilog.ph369
	...
	addi.d	$t5, $t5, 132
	.p2align	4, , 16
.LBB8_61:                               # %vec.epilog.vector.body377
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t8, $t5, -44
	ld.w	$fp, $t5, -32
	ld.w	$s0, $t5, -20
	...
	addi.d	$t5, $t5, 48
	bnez	$t1, .LBB8_61
# %bb.62:                               # %vec.epilog.middle.block382
	vshuf4i.w	$vr1, $vr0, 14
	vmax.w	$vr0, $vr0, $vr1
	vreplvei.w	$vr1, $vr0, 1
	vmax.w	$vr0, $vr0, $vr1
...
# %bb.65:                               # %middle.block324
	...
	xvpickve2gr.w	$a6, $xr0, 0
	beq	$t2, $t3, .LBB8_122
# %bb.66:                               # %vec.epilog.iter.check331
	andi	$t4, $t2, 12
	beqz	$t4, .LBB8_119
.LBB8_67:                               # %vec.epilog.ph330
	...
	addi.d	$t3, $t3, 132
	.p2align	4, , 16
.LBB8_68:                               # %vec.epilog.vector.body338
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t6, $t3, -44
	ld.w	$t7, $t3, -32
	ld.w	$t8, $t3, -20
	...
	addi.d	$t3, $t3, 48
	bnez	$a6, .LBB8_68
# %bb.69:                               # %vec.epilog.middle.block343
	vshuf4i.w	$vr1, $vr0, 14
	vmax.w	$vr0, $vr0, $vr1
	vreplvei.w	$vr1, $vr0, 1
	vmax.w	$vr0, $vr0, $vr1
...
# %bb.75:
	...
	move	$t4, $a5
	b	.LBB8_86
.LBB8_76:                               # %vector.main.loop.iter.check194
	ori	$t1, $zero, 16
	bgeu	$t2, $t1, .LBB8_78
# %bb.77:
	move	$t3, $zero
...
# %bb.80:                               # %middle.block205
	...
	xvpickve2gr.w	$t1, $xr0, 0
	beq	$t3, $t2, .LBB8_88
# %bb.81:                               # %vec.epilog.iter.check212
	andi	$t4, $t2, 12
	beqz	$t4, .LBB8_85
.LBB8_82:                               # %vec.epilog.ph211
	...
	alsl.d	$t3, $t3, $a0, 2
	.p2align	4, , 16
.LBB8_83:                               # %vec.epilog.vector.body219
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $t3, 0
	vmax.w	$vr0, $vr1, $vr0
	addi.d	$t1, $t1, 4
	addi.d	$t3, $t3, 16
	bnez	$t1, .LBB8_83
# %bb.84:                               # %vec.epilog.middle.block225
	vshuf4i.w	$vr1, $vr0, 14
	vmax.w	$vr0, $vr0, $vr1
	vreplvei.w	$vr1, $vr0, 1
	vmax.w	$vr0, $vr0, $vr1
...
# %bb.90:
	...
	move	$t2, $a5
	b	.LBB8_101
.LBB8_91:                               # %vector.main.loop.iter.check236
	ori	$t0, $zero, 16
	bgeu	$a7, $t0, .LBB8_93
# %bb.92:
	move	$t0, $zero
...
# %bb.95:                               # %middle.block247
	...
	beq	$t0, $a7, .LBB8_103
# %bb.96:                               # %vec.epilog.iter.check254
	andi	$t2, $a7, 12
	beqz	$t2, .LBB8_100
.LBB8_97:                               # %vec.epilog.ph253
	...
	alsl.d	$a5, $a5, $a0, 2
	.p2align	4, , 16
.LBB8_98:                               # %vec.epilog.vector.body261
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a5, 0
	vmax.w	$vr0, $vr1, $vr0
	addi.d	$t3, $t3, 4
	addi.d	$a5, $a5, 16
	bnez	$t3, .LBB8_98
# %bb.99:                               # %vec.epilog.middle.block267
	vshuf4i.w	$vr1, $vr0, 14
	vmax.w	$vr0, $vr0, $vr1
	vreplvei.w	$vr1, $vr0, 1
	vmax.w	$vr0, $vr0, $vr1
...
# %bb.109:
	...
	move	$t6, $a5
	b	.LBB8_126
.LBB8_110:                              # %vector.main.loop.iter.check393
...
# %bb.114:                              # %middle.block402
	...
	xvpickve2gr.w	$t3, $xr0, 0
	beq	$t2, $t4, .LBB8_128
# %bb.115:                              # %vec.epilog.iter.check409
	andi	$t5, $t2, 12
	beqz	$t5, .LBB8_125
.LBB8_116:                              # %vec.epilog.ph408
	...
	addi.d	$a5, $a5, 132
	.p2align	4, , 16
.LBB8_117:                              # %vec.epilog.vector.body416
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$t4, $a5, -44
	ld.w	$t7, $a5, -32
	ld.w	$t8, $a5, -20
	...
	addi.d	$a5, $a5, 48
	bnez	$t3, .LBB8_117
# %bb.118:                              # %vec.epilog.middle.block421
	vshuf4i.w	$vr1, $vr0, 14
	vmax.w	$vr0, $vr0, $vr1
	vreplvei.w	$vr1, $vr0, 1
	vmax.w	$vr0, $vr0, $vr1
...
# %bb.9:                                # %middle.block
	beq	$a1, $a0, .LBB9_12
.LBB9_10:                               # %for.body13.preheader139
	alsl.d	$a2, $a1, $a2, 3
	alsl.d	$a3, $a1, $a4, 3
	sub.d	$a0, $a0, $a1
	.p2align	4, , 16
