...
# %bb.18:                               #   in Loop: Header=BB1_17 Depth=1
	...
	b	.LBB1_22
	.p2align	4, , 16
.LBB1_19:                               # %vector.body119.preheader
                                        #   in Loop: Header=BB1_17 Depth=1
	move	$t0, $a6
	move	$t1, $a2
	.p2align	4, , 16
.LBB1_20:                               # %vector.body119
...
# %bb.56:                               #   in Loop: Header=BB1_55 Depth=1
	...
	b	.LBB1_60
	.p2align	4, , 16
.LBB1_57:                               # %vector.body131.preheader
                                        #   in Loop: Header=BB1_55 Depth=1
	move	$t1, $a6
	move	$t2, $a7
	.p2align	4, , 16
.LBB1_58:                               # %vector.body131
...
# %bb.65:                               #   in Loop: Header=BB1_64 Depth=1
	...
	b	.LBB1_69
	.p2align	4, , 16
.LBB1_66:                               # %vector.body143.preheader
                                        #   in Loop: Header=BB1_64 Depth=1
	move	$t0, $a6
	move	$t1, $a3
	.p2align	4, , 16
.LBB1_67:                               # %vector.body143
...
# %bb.11:                               # %for.cond14.preheader.us.preheader
	...
	b	.LBB6_13
	.p2align	4, , 16
.LBB6_12:                               # %for.cond14.for.inc30_crit_edge.us
	...
	beq	$a2, $a0, .LBB6_9
.LBB6_13:                               # %for.cond14.preheader.us
	...
	bnez	$s8, .LBB6_20
# %bb.14:                               # %for.body16.us.us.preheader
                                        #   in Loop: Header=BB6_13 Depth=2
	ld.d	$a0, $fp, 0
	.p2align	4, , 16
.LBB6_15:                               # %for.body16.us.us
                                        #   Parent Loop BB6_10 Depth=1
	...
	st.d	$a0, $fp, 0
	blt	$s7, $s6, .LBB6_15
# %bb.16:                               # %for.cond14.for.inc30_crit_edge.split.us.us
                                        #   in Loop: Header=BB6_13 Depth=2
	st.w	$zero, $sp, 100
	st.w	$zero, $sp, 96
	st.w	$zero, $sp, 92
...
.LBB6_17:                               # %if.end33.thread.i.us
	...
	addi.d	$a3, $sp, 96
	addi.d	$a4, $sp, 88
.LBB6_18:                               # %if.end66.sink.split.i.us
                                        #   in Loop: Header=BB6_20 Depth=3
	slti	$a0, $a0, 1
	slli.d	$a1, $a1, 1
	or	$a0, $a1, $a0
...
.LBB6_27:                               # %if.end20.i.us
	...
	ori	$t0, $zero, 1
	beqz	$a5, .LBB6_29
.LBB6_28:                               # %if.then23.i.us
                                        #   in Loop: Header=BB6_20 Depth=3
	or	$s3, $a7, $a3
	st.w	$s3, $sp, 88
	st.w	$t0, $sp, 96
	move	$s2, $t0
.LBB6_29:                               # %if.end26.i.us
                                        #   in Loop: Header=BB6_20 Depth=3
	ori	$a3, $zero, 14
	bltu	$a3, $a4, .LBB6_17
# %bb.30:                               # %if.end33.i.us
...
# %bb.31:                               #   in Loop: Header=BB6_20 Depth=3
	...
	move	$a1, $s3
	b	.LBB6_18
.LBB6_32:                               #   in Loop: Header=BB6_20 Depth=3
	move	$s3, $zero
	move	$s2, $zero
	b	.LBB6_19
.LBB6_33:                               # %if.else39
