...
# %bb.1:                                # %for.body.us.preheader
	move	$a0, $zero
	alsl.d	$s2, $a1, $s0, 3
	pcalau12i	$a1, %pc_hi20(rv_tbl)
	addi.d	$s0, $a1, %pc_lo12(rv_tbl)
	addi.d	$a1, $s0, 248
	ld.d	$a2, $s2, 0
	pcalau12i	$a3, %pc_hi20(window_s)
	addi.d	$s1, $a3, %pc_lo12(window_s)
	ori	$a3, $zero, 127
	ori	$a4, $zero, 63
	ori	$a5, $zero, 126
	ori	$a6, $zero, 62
...
# %bb.9:                                # %for.body.us270.preheader
	...
	addi.d	$s2, $a0, %pc_lo12(rv_tbl)
	pcalau12i	$a0, %pc_hi20(window_s)
	addi.d	$s3, $a0, %pc_lo12(window_s)
...
# %bb.0:                                # %entry
	...
	fld.d	$fs1, $a0, %pc_lo12(.LCPI3_2)
	pcalau12i	$a0, %pc_hi20(window)
	addi.d	$s1, $a0, %pc_lo12(window)
	ori	$s2, $zero, 2048
	.p2align	4, , 16
.LBB3_1:                                # %for.body14
                                        # =>This Inner Loop Header: Depth=1
...
# %bb.2:                                # %for.body29.preheader
	...
	fld.d	$fs1, $a0, %pc_lo12(.LCPI3_3)
	pcalau12i	$a0, %pc_hi20(window_s)
	addi.d	$s1, $a0, %pc_lo12(window_s)
	ori	$s2, $zero, 512
	.p2align	4, , 16
.LBB3_3:                                # %for.body29
                                        # =>This Inner Loop Header: Depth=1
