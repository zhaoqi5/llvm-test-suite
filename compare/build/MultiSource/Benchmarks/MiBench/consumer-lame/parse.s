...
.LBB3_138:                              # %if.then132
	...
	pcaddu18i	$ra, %call36(strtol)
	jirl	$ra, $ra, 0
	pcalau12i	$a1, %got_pc_hi20(genre_last)
	ld.d	$a1, $a1, %got_pc_lo12(genre_last)
	ld.d	$a2, $sp, 128
	ld.w	$s1, $a1, 0
	beq	$s6, $a2, .LBB3_144
# %bb.139:                              #   in Loop: Header=BB3_2 Depth=1
	move	$s7, $a0
.LBB3_140:                              # %if.end147
                                        #   in Loop: Header=BB3_2 Depth=1
	addi.w	$a0, $s7, 0
...
.LBB3_143:                              # %if.then249
	...
	st.w	$a0, $fp, 16
	b	.LBB3_157
.LBB3_144:                              # %for.cond.preheader
                                        #   in Loop: Header=BB3_2 Depth=1
	bltz	$s1, .LBB3_151
# %bb.145:                              # %for.body.preheader
                                        #   in Loop: Header=BB3_2 Depth=1
...
# %bb.147:                              # %for.inc
	...
	addi.d	$s3, $s3, 8
	bnez	$s8, .LBB3_146
# %bb.148:                              #   in Loop: Header=BB3_2 Depth=1
...
.LBB3_150:                              # %if.then299
	...
	st.w	$a0, $fp, 28
	b	.LBB3_119
.LBB3_151:                              #   in Loop: Header=BB3_2 Depth=1
	move	$s7, $zero
	b	.LBB3_140
.LBB3_152:                              # %if.else354
                                        #   in Loop: Header=BB3_2 Depth=1
...
.LBB3_160:
	...
	ori	$s0, $zero, 1
	b	.LBB3_163
.LBB3_161:                              # %while.end598.loopexit.loopexit
	sltu	$a0, $zero, $s1
.LBB3_162:                              # %while.end598.loopexit
	ld.d	$a1, $sp, 96                    # 8-byte Folded Reload
	sltui	$s0, $a1, 1
	ld.d	$s1, $sp, 72                    # 8-byte Folded Reload
	ld.d	$s2, $sp, 88                    # 8-byte Folded Reload
	ld.d	$s3, $sp, 104                   # 8-byte Folded Reload
.LBB3_163:                              # %while.end598
	bnez	$a0, .LBB3_184
# %bb.164:                              # %while.end598
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	ld.bu	$a0, $a0, 0
...
# %bb.166:                              # %if.end611
	...
	st.w	$a1, $fp, 32
	bnez	$a0, .LBB3_169
# %bb.167:                              # %if.end625.thread
	ori	$a0, $zero, 45
	st.h	$a0, $s2, 0
	b	.LBB3_170
.LBB3_168:                              # %if.end611.thread
	ld.bu	$a0, $s2, 0
	beqz	$a0, .LBB3_176
.LBB3_169:                              # %if.end625
	ori	$a1, $zero, 45
