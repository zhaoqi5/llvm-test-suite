...
# %bb.90:                               # %if.then385
	...
	jirl	$ra, $ra, 0
	b	.LBB4_86
.LBB4_91:                               # %for.cond443.preheader
	lu12i.w	$a2, 1
	blez	$a1, .LBB4_113
.LBB4_92:                               # %for.cond448.preheader.lr.ph
	ld.w	$a0, $s4, 204
	blez	$a0, .LBB4_102
# %bb.93:                               # %for.cond448.preheader.preheader
	move	$s2, $zero
	ori	$a3, $a2, 512
...
.LBB4_95:                               # %for.inc473
	...
	add.d	$s0, $s0, $a3
	bge	$s2, $a1, .LBB4_101
.LBB4_96:                               # %for.cond448.preheader
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB4_99 Depth 2
	blez	$a0, .LBB4_95
# %bb.97:                               # %for.body452.lr.ph
                                        #   in Loop: Header=BB4_96 Depth=1
	move	$s8, $s4
	move	$s4, $zero
	move	$s1, $zero
...
# %bb.100:                              # %if.then463
	...
	jirl	$ra, $ra, 0
	b	.LBB4_98
.LBB4_101:                              # %for.cond476.preheader
	blez	$a1, .LBB4_113
.LBB4_102:                              # %for.cond481.preheader.lr.ph
	ld.w	$a5, $s4, 204
	blez	$a5, .LBB4_113
# %bb.103:                              # %for.cond481.preheader.preheader
	move	$a0, $zero
	move	$a3, $a2
	lu12i.w	$a2, -2
	ori	$a2, $a2, 3584
...
.LBB4_105:                              # %for.inc513
	...
	add.d	$s7, $s7, $a3
	bge	$a0, $a1, .LBB4_113
.LBB4_106:                              # %for.cond481.preheader
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB4_109 Depth 2
                                        #       Child Loop BB4_111 Depth 3
	blez	$a5, .LBB4_105
# %bb.107:                              # %for.cond486.preheader.lr.ph
                                        #   in Loop: Header=BB4_106 Depth=1
	move	$a1, $zero
	move	$a6, $s7
...
.LBB4_108:                              # %for.inc510
	...
	addi.d	$a6, $a6, 257
	bge	$a1, $a5, .LBB4_104
.LBB4_109:                              # %for.cond486.preheader
	...
	.p2align	4, , 16
.LBB4_110:                              # %for.inc507
                                        #   in Loop: Header=BB4_111 Depth=3
	addi.d	$t0, $t0, 8
	addi.d	$a5, $a5, 4
	beqz	$t0, .LBB4_108
.LBB4_111:                              # %for.body489
                                        #   Parent Loop BB4_106 Depth=1
...
# %bb.16:                               # %middle.block
                                        #   in Loop: Header=BB8_10 Depth=1
	beq	$t2, $t3, .LBB8_9
.LBB8_17:                               # %for.body59.preheader180
                                        #   in Loop: Header=BB8_10 Depth=1
	alsl.d	$t2, $t1, $a0, 3
	sub.d	$t0, $t0, $t1
	.p2align	4, , 16
...
.LBB8_28:                               # %vector.body129
	...
	xvaddi.du	$xr5, $xr5, 4
	bnez	$t6, .LBB8_28
# %bb.29:                               # %middle.block132
                                        #   in Loop: Header=BB8_23 Depth=1
	beq	$t4, $t5, .LBB8_22
.LBB8_30:                               # %for.body96.preheader179
                                        #   in Loop: Header=BB8_23 Depth=1
	slli.d	$t4, $t3, 4
	alsl.d	$t4, $t3, $t4, 3
	add.d	$t4, $a0, $t4
...
.LBB8_38:                               #   in Loop: Header=BB8_35 Depth=1
	move	$t6, $t8
.LBB8_39:                               # %for.body96.1.preheader
                                        #   in Loop: Header=BB8_35 Depth=1
	slli.d	$t5, $t6, 4
	alsl.d	$t5, $t6, $t5, 3
	add.d	$t5, $t0, $t5
...
.LBB8_44:                               # %vector.body147
	...
	xvaddi.du	$xr5, $xr5, 4
	bnez	$t8, .LBB8_44
# %bb.45:                               # %middle.block152
                                        #   in Loop: Header=BB8_35 Depth=1
	beq	$t5, $t7, .LBB8_34
	b	.LBB8_39
.LBB8_46:                               # %for.inc109.1
	ld.w	$a1, $a1, 84
	ori	$a5, $zero, 11
	bltu	$a5, $a1, .LBB8_60
# %bb.47:                               # %for.body76.lr.ph.2
	addi.d	$a3, $a3, 504
	addi.d	$a2, $a2, 96
	addi.d	$a5, $a0, 16
	xvreplve0.d	$xr4, $xr0
...
# %bb.50:                               # %if.then83.2
	...
	ld.w	$t1, $t1, 96
	bge	$t5, $t1, .LBB8_48
# %bb.51:                               # %for.body96.preheader.2
                                        #   in Loop: Header=BB8_49 Depth=1
	sub.d	$t2, $t1, $t5
	bgeu	$t2, $a6, .LBB8_55
.LBB8_52:                               #   in Loop: Header=BB8_49 Depth=1
	move	$t3, $t5
.LBB8_53:                               # %for.body96.2.preheader
                                        #   in Loop: Header=BB8_49 Depth=1
	slli.d	$t2, $t3, 4
	alsl.d	$t2, $t3, $t2, 3
	add.d	$t2, $a5, $t2
