...
.LBB1_3:                                # %cond.end
	...
	alsl.d	$a0, $a0, $a0, 1
	slli.d	$a0, $a0, 6
	pcalau12i	$a1, %pc_hi20(tabsel_123)
	ld.w	$a2, $fp, 24
	addi.d	$a1, $a1, %pc_lo12(tabsel_123)
	add.d	$a0, $a1, $a0
	ld.w	$a1, $fp, 32
	slli.d	$a2, $a2, 6
	add.d	$a2, $a2, $a0
...
# %bb.0:                                # %entry
	...
	masknez	$a1, $a3, $a1
	slli.d	$a3, $a4, 3
	pcalau12i	$a5, %pc_hi20(print_header_compact.layers)
	addi.d	$a5, $a5, %pc_lo12(print_header_compact.layers)
	ldx.d	$a3, $a5, $a3
	alsl.d	$a2, $a2, $a2, 1
	slli.d	$a2, $a2, 6
	pcalau12i	$a5, %pc_hi20(tabsel_123)
	addi.d	$a5, $a5, %pc_lo12(tabsel_123)
	add.d	$a2, $a5, $a2
	slli.d	$a4, $a4, 6
	add.d	$a2, $a4, $a2
	ld.w	$a4, $a0, 32
	ld.w	$a5, $a0, 36
	pcalau12i	$a6, %got_pc_hi20(stderr)
	ld.d	$t0, $a6, %got_pc_lo12(stderr)
	alsl.d	$a2, $a4, $a2, 2
	slli.d	$a4, $a5, 3
	ld.w	$a0, $a0, 48
	...
	ldx.d	$a5, $a5, $a4
	slli.d	$a0, $a0, 3
	pcalau12i	$a4, %pc_hi20(print_header_compact.modes)
	addi.d	$a4, $a4, %pc_lo12(print_header_compact.modes)
	ldx.d	$a6, $a4, $a0
	ld.d	$a0, $t0, 0
	ld.w	$a4, $a2, -64
	or	$a2, $a7, $a1
