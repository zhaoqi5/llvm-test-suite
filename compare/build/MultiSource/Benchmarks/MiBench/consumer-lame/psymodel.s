...
.LBB0_71:                               # %if.else328
	...
	ori	$a6, $zero, 4064
	bne	$fp, $a0, .LBB0_80
# %bb.72:                               # %vector.body1213.preheader
                                        #   in Loop: Header=BB0_69 Depth=1
	lu12i.w	$a5, 1
	move	$a0, $a5
...
.LBB0_73:                               # %vector.body1213
	...
	xvstx	$xr1, $a1, $a6
	bnez	$a0, .LBB0_73
# %bb.74:                               # %vector.body1200.preheader
                                        #   in Loop: Header=BB0_69 Depth=1
	move	$a1, $zero
	.p2align	4, , 16
.LBB0_75:                               # %vector.body1200
                                        #   Parent Loop BB0_69 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	add.d	$a2, $a4, $a1
	xvldx	$xr1, $a2, $a7
	...
	xvstx	$xr1, $a2, $a3
	bne	$a1, $a0, .LBB0_75
# %bb.76:                               # %vector.body1187.preheader
                                        #   in Loop: Header=BB0_69 Depth=1
	move	$a1, $zero
	.p2align	4, , 16
.LBB0_77:                               # %vector.body1187
                                        #   Parent Loop BB0_69 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	add.d	$a2, $a4, $a1
	xvld	$xr1, $a2, 2016
	...
	xvstx	$xr1, $a2, $a3
	bne	$a1, $a0, .LBB0_77
# %bb.78:                               # %vector.body1174.preheader
                                        #   in Loop: Header=BB0_69 Depth=1
	move	$a1, $zero
	.p2align	4, , 16
.LBB0_79:                               # %vector.body1174
                                        #   Parent Loop BB0_69 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	add.d	$a2, $a4, $a1
	xvld	$xr1, $a2, 992
