...
.LBB1_19:                               # %do.body.i
	...
	add.d	$t2, $t2, $t4
	bltu	$t1, $a1, .LBB1_19
# %bb.20:                               # %count_bit_short_noESC.exit
...
.LBB1_32:                               # %do.body.i59
	...
	move	$a0, $t1
	bltu	$t1, $a4, .LBB1_32
.LBB1_33:                               # %count_bit_noESC2.exit68
	addi.w	$a0, $a6, 0
	slt	$a1, $a0, $a3
	masknez	$a4, $a5, $a1
	maskeqz	$a1, $t0, $a1
...
# %bb.48:
	ori	$a4, $zero, 24
	b	.LBB1_50
.LBB1_49:                               # %for.end43.loopexit.split.loop.exit
	sub.w	$a4, $a3, $a5
.LBB1_50:                               # %for.end43
	ori	$a7, $zero, 24
	mul.d	$a5, $a4, $a7
...
# %bb.59:                               # %if.then.2.i
	...
	b	.LBB1_51
	.p2align	4, , 16
.LBB1_60:                               #   in Loop: Header=BB1_52 Depth=1
	move	$t6, $zero
	ld.w	$t7, $a0, 12
	bnez	$t7, .LBB1_54
	b	.LBB1_55
	.p2align	4, , 16
.LBB1_61:                               #   in Loop: Header=BB1_52 Depth=1
	move	$t6, $zero
	ld.w	$t7, $a0, 16
	bnez	$t7, .LBB1_57
	b	.LBB1_58
...
.LBB1_63:                               # %if.then10.2.i
	...
	add.w	$t6, $t6, $t7
	b	.LBB1_51
.LBB1_64:                               # %count_bit_short_ESC.exit
	slt	$a0, $t5, $t4
	masknez	$a1, $a4, $a0
	maskeqz	$a0, $a3, $a0
	or	$a5, $a0, $a1
...
.LBB1_74:                               # %do.body.i69
	...
	move	$a0, $a7
	bltu	$a7, $a4, .LBB1_74
.LBB1_75:                               # %count_bit_noESC2.exit78
	addi.w	$a0, $a6, 0
	slt	$a1, $a0, $a3
	ori	$a4, $zero, 13
	masknez	$a4, $a4, $a1
...
.LBB3_31:                               # %vector.body282
	...
	addi.d	$a5, $a5, 32
	bnez	$t2, .LBB3_31
# %bb.32:                               # %middle.block291
	vadd.w	$vr0, $vr2, $vr1
	vhaddw.d.w	$vr0, $vr0, $vr0
	vhaddw.q.d	$vr0, $vr0, $vr0
	vpickve2gr.d	$a5, $vr0, 0
	beq	$a4, $t1, .LBB3_35
.LBB3_33:                               # %do.body.i60.preheader
	addi.d	$a4, $t0, -4
	.p2align	4, , 16
.LBB3_34:                               # %do.body.i60
                                        # =>This Inner Loop Header: Depth=1
	...
	move	$a4, $t1
	bltu	$t1, $a1, .LBB3_34
.LBB3_35:                               # %count_bit_noESC2.exit69
	addi.w	$a1, $a5, 0
	slt	$a4, $a1, $a0
	masknez	$a3, $a3, $a4
	maskeqz	$a4, $a7, $a4
...
# %bb.50:
	ori	$s1, $zero, 24
	b	.LBB3_52
.LBB3_51:                               # %for.end43.loopexit.split.loop.exit
	sub.w	$s1, $fp, $a6
.LBB3_52:                               # %iter.check144
	ori	$t3, $zero, 24
	mul.d	$a6, $s1, $t3
	ldx.w	$s3, $t1, $a6
	mul.d	$a7, $fp, $t3
...
# %bb.53:
	...
	move	$t3, $a0
	b	.LBB3_78
.LBB3_54:                               # %vector.main.loop.iter.check146
	ori	$t3, $zero, 120
	bgeu	$t2, $t3, .LBB3_57
# %bb.55:
	move	$t8, $a2
...
.LBB3_58:                               # %vector.body154
	...
	ld.w	$s0, $t4, -16
	ld.w	$s1, $t4, -8
	vinsgr2vr.w	$vr12, $t8, 0
	vinsgr2vr.w	$vr12, $fp, 1
	vinsgr2vr.w	$vr12, $s0, 2
	...
	vinsgr2vr.w	$vr13, $s0, 2
	vinsgr2vr.w	$vr13, $s1, 3
	vinsgr2vr.w	$vr12, $t2, 0
	vinsgr2vr.w	$vr12, $t3, 1
	vinsgr2vr.w	$vr12, $t6, 2
	...
	xvseqi.w	$xr11, $xr15, 0
	xvadd.w	$xr5, $xr5, $xr11
	xvand.v	$xr11, $xr13, $xr0
	xvadd.w	$xr9, $xr9, $xr11
	xvand.v	$xr11, $xr16, $xr0
	xvadd.w	$xr10, $xr10, $xr11
	xvand.v	$xr11, $xr13, $xr1
	xvadd.w	$xr7, $xr7, $xr11
	xvand.v	$xr11, $xr16, $xr1
	xvadd.w	$xr8, $xr8, $xr11
	xvslt.w	$xr12, $xr3, $xr14
	xvslt.w	$xr13, $xr3, $xr15
	xvbitsel.v	$xr11, $xr14, $xr4, $xr12
	xvbitsel.v	$xr14, $xr15, $xr4, $xr13
	xvadd.w	$xr15, $xr17, $xr11
	xvadd.w	$xr11, $xr18, $xr14
	xvaddi.wu	$xr6, $xr6, 2
	xvaddi.wu	$xr5, $xr5, 2
	xvand.v	$xr14, $xr12, $xr0
	xvadd.w	$xr9, $xr9, $xr14
	xvand.v	$xr14, $xr13, $xr0
	xvadd.w	$xr10, $xr10, $xr14
	xvand.v	$xr12, $xr12, $xr1
	xvadd.w	$xr7, $xr7, $xr12
	xvand.v	$xr12, $xr13, $xr1
	xvadd.w	$xr8, $xr8, $xr12
	xvpermi.q	$xr12, $xr15, 1
	...
	vpickve2gr.w	$t2, $vr15, 2
	vinsgr2vr.d	$vr12, $t2, 0
	vpickve2gr.w	$t2, $vr15, 3
	vinsgr2vr.d	$vr12, $t2, 1
	xvpermi.q	$xr12, $xr12, 2
	vpickve2gr.w	$t2, $vr15, 0
	vinsgr2vr.d	$vr16, $t2, 0
	vpickve2gr.w	$t2, $vr15, 1
...
.LBB3_61:
	alsl.d	$a6, $a5, $a0, 3
	b	.LBB3_13
.LBB3_62:                               # %vec.epilog.iter.check203
	ld.d	$t8, $sp, 64                    # 8-byte Folded Reload
	ld.d	$fp, $sp, 48                    # 8-byte Folded Reload
	ld.d	$s1, $sp, 40                    # 8-byte Folded Reload
...
.LBB3_64:                               # %vec.epilog.ph205
	...
	vrepli.w	$vr5, 15
	.p2align	4, , 16
.LBB3_65:                               # %vec.epilog.vector.body212
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a2, $a0, -16
	ld.w	$a3, $a0, -8
	ld.w	$a4, $a0, 0
	...
	addi.d	$a0, $a0, 32
	bnez	$t2, .LBB3_65
# %bb.66:                               # %vec.epilog.middle.block231
...
.LBB3_72:                               # %vector.body243
	...
	addi.d	$a5, $a5, 32
	bnez	$t0, .LBB3_72
# %bb.73:                               # %middle.block251
	vadd.w	$vr0, $vr2, $vr1
	vhaddw.d.w	$vr0, $vr0, $vr0
	vhaddw.q.d	$vr0, $vr0, $vr0
	vpickve2gr.d	$a5, $vr0, 0
	beq	$a4, $a7, .LBB3_76
.LBB3_74:                               # %do.body.i70.preheader
	addi.d	$a4, $a6, -4
	.p2align	4, , 16
.LBB3_75:                               # %do.body.i70
                                        # =>This Inner Loop Header: Depth=1
	...
	move	$a4, $a7
	bltu	$a7, $a1, .LBB3_75
.LBB3_76:                               # %count_bit_noESC2.exit79
	addi.w	$a1, $a5, 0
	slt	$a3, $a1, $a0
	ori	$a4, $zero, 13
	masknez	$a4, $a4, $a3
...
.LBB3_77:
	...
	ld.d	$s3, $sp, 24                    # 8-byte Folded Reload
	ld.d	$s4, $sp, 16                    # 8-byte Folded Reload
.LBB3_78:                               # %while.body.i85.preheader
	ori	$a0, $zero, 14
	ori	$a3, $zero, 15
	b	.LBB3_80
	.p2align	4, , 16
...
.LBB4_45:
	move	$t0, $zero
	b	.LBB4_57
.LBB4_46:                               # %vector.main.loop.iter.check
	ori	$t0, $zero, 16
	bgeu	$a3, $t0, .LBB4_48
# %bb.47:
	move	$t1, $zero
...
# %bb.50:                               # %middle.block
	...
	beq	$t1, $a7, .LBB4_57
# %bb.51:                               # %vec.epilog.iter.check
	beqz	$t2, .LBB4_55
.LBB4_52:                               # %vec.epilog.ph
	move	$t2, $t1
	...
	add.d	$t2, $a5, $t2
	.p2align	4, , 16
.LBB4_53:                               # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $t2, 0
	vor.v	$vr0, $vr1, $vr0
	addi.d	$t0, $t0, 4
...
.LBB4_57:                               # %for.end115
	...
	ori	$t1, $zero, 11
	bltu	$t1, $a7, .LBB4_60
# %bb.58:                               # %for.cond120.preheader.lr.ph
	addi.d	$t1, $a7, 1
	ori	$t2, $zero, 488
	mul.d	$t2, $a1, $t2
	ori	$t3, $zero, 244
...
# %bb.61:                               # %for.end138
	andi	$t0, $t0, 1
	bnez	$t0, .LBB4_73
# %bb.62:                               # %for.cond143.preheader
	beqz	$a3, .LBB4_66
# %bb.63:                               # %for.body146.preheader
	move	$a3, $zero
	move	$a7, $a6
	.p2align	4, , 16
.LBB4_64:                               # %for.body146
	...
	addi.d	$a7, $a7, 4
	bltu	$a3, $t0, .LBB4_64
# %bb.65:                               # %for.end156.loopexit
	ld.w	$a7, $fp, 84
.LBB4_66:                               # %for.end156
	ori	$a3, $zero, 11
	bltu	$a3, $a7, .LBB4_69
# %bb.67:                               # %for.cond161.preheader.lr.ph
	addi.d	$a3, $a7, 1
	ori	$t0, $zero, 488
	mul.d	$t0, $a1, $t0
	ori	$t1, $zero, 244
...
# %bb.74:                               # %if.end195
	...
	ori	$a0, $zero, 2
	bne	$a1, $a0, .LBB4_110
# %bb.75:                               # %land.lhs.true200
	ori	$a1, $zero, 120
	mul.d	$a3, $a2, $a1
	add.d	$a1, $s0, $a3
	ld.w	$a6, $a1, 24
	beq	$a6, $a0, .LBB4_110
# %bb.76:                               # %land.lhs.true208
	add.d	$a0, $a4, $a3
	ld.w	$a3, $a0, 312
	ori	$a6, $zero, 2
	beq	$a3, $a6, .LBB4_110
# %bb.77:                               # %land.lhs.true217
	ld.w	$a3, $a1, 68
	ld.w	$a6, $a0, 356
	bne	$a3, $a6, .LBB4_110
# %bb.78:                               # %land.lhs.true233
	ld.w	$a1, $a1, 64
	ld.w	$a3, $a0, 352
	bne	$a1, $a3, .LBB4_110
# %bb.79:                               # %if.then249
...
# %bb.80:                               # %for.inc29.i
	...
	ld.w	$a4, $a1, 492
	bne	$a2, $a4, .LBB4_86
# %bb.81:                               # %for.inc29.196.i
	ld.w	$a2, $a1, 8
	ld.w	$a4, $a1, 496
	bne	$a2, $a4, .LBB4_86
# %bb.82:                               # %for.inc29.2101.i
	ld.w	$a2, $a1, 12
	ld.w	$a4, $a1, 500
	bne	$a2, $a4, .LBB4_86
# %bb.83:                               # %for.inc29.3106.i
	ld.w	$a2, $a1, 16
	ld.w	$a4, $a1, 504
	bne	$a2, $a4, .LBB4_86
# %bb.84:                               # %for.inc29.4.i
...
# %bb.85:                               # %for.end53.i
	...
	ori	$a2, $zero, 1
	st.w	$a2, $a3, 12
.LBB4_86:                               # %for.body16.preheader.1.i
	ld.w	$a2, $a1, 24
	ld.w	$a4, $a1, 512
	bne	$a2, $a4, .LBB4_92
# %bb.87:                               # %for.inc29.1.i
	...
	ld.w	$a4, $a1, 516
	bne	$a2, $a4, .LBB4_92
# %bb.88:                               # %for.inc29.1.1.i
	ld.w	$a2, $a1, 32
	ld.w	$a4, $a1, 520
	bne	$a2, $a4, .LBB4_92
# %bb.89:                               # %for.inc29.1.2.i
	ld.w	$a2, $a1, 36
	ld.w	$a4, $a1, 524
	bne	$a2, $a4, .LBB4_92
# %bb.90:                               # %for.inc29.1.3.i
	ld.w	$a2, $a1, 40
	ld.w	$a4, $a1, 528
	bne	$a2, $a4, .LBB4_92
# %bb.91:                               # %for.end53.1.i
	...
	ori	$a2, $zero, 1
	st.w	$a2, $a3, 16
.LBB4_92:                               # %for.body16.preheader.2.i
	ld.w	$a2, $a1, 44
	ld.w	$a4, $a1, 532
	bne	$a2, $a4, .LBB4_98
# %bb.93:                               # %for.inc29.2.i
	...
	ld.w	$a4, $a1, 536
	bne	$a2, $a4, .LBB4_98
# %bb.94:                               # %for.inc29.2.1.i
	ld.w	$a2, $a1, 52
	ld.w	$a4, $a1, 540
	bne	$a2, $a4, .LBB4_98
# %bb.95:                               # %for.inc29.2.2.i
	ld.w	$a2, $a1, 56
	ld.w	$a4, $a1, 544
	bne	$a2, $a4, .LBB4_98
# %bb.96:                               # %for.inc29.2.3.i
	ld.w	$a2, $a1, 60
	ld.w	$a4, $a1, 548
	bne	$a2, $a4, .LBB4_98
# %bb.97:                               # %for.end53.2.i
	...
	ori	$a2, $zero, 1
	st.w	$a2, $a3, 20
.LBB4_98:                               # %for.body16.preheader.3.i
	ld.w	$a2, $a1, 64
	ld.w	$a4, $a1, 552
	bne	$a2, $a4, .LBB4_104
# %bb.99:                               # %for.inc29.3.i
	...
	ld.w	$a4, $a1, 556
	bne	$a2, $a4, .LBB4_104
# %bb.100:                              # %for.inc29.3.1.i
	ld.w	$a2, $a1, 72
	ld.w	$a4, $a1, 560
	bne	$a2, $a4, .LBB4_104
# %bb.101:                              # %for.inc29.3.2.i
	ld.w	$a2, $a1, 76
	ld.w	$a4, $a1, 564
	bne	$a2, $a4, .LBB4_104
# %bb.102:                              # %for.inc29.3.3.i
	ld.w	$a2, $a1, 80
	ld.w	$a4, $a1, 568
	bne	$a2, $a4, .LBB4_104
# %bb.103:                              # %for.end53.3.i
	addi.w	$a2, $zero, -1
	st.w	$a2, $a1, 568
	st.d	$a2, $a1, 560
	st.d	$a2, $a1, 552
	ori	$a2, $zero, 1
	st.w	$a2, $a3, 24
.LBB4_104:                              # %for.cond125.preheader.i
	ld.w	$a4, $a1, 488
	move	$a2, $zero
	move	$a3, $zero
	srai.d	$a5, $a4, 63
	...
	b	.LBB4_106
	.p2align	4, , 16
.LBB4_105:                              # %for.inc146.i
                                        #   in Loop: Header=BB4_106 Depth=1
	addi.d	$a2, $a2, 4
	addi.d	$a3, $a3, 1
	beq	$a2, $a7, .LBB4_110
.LBB4_106:                              # %for.body127.i
                                        # =>This Inner Loop Header: Depth=1
