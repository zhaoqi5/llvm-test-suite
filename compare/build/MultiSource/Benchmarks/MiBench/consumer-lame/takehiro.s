...
# %bb.26:                               # %middle.block
	beq	$a2, $a4, .LBB2_29
.LBB2_27:                               # %for.body12.preheader59
	slli.d	$a0, $a3, 2
	ori	$a1, $a1, 1696
	addi.d	$a2, $sp, 240
	ori	$a3, $zero, 100
...
# %bb.54:
	...
	move	$t3, $a0
	b	.LBB3_78
.LBB3_55:                               # %vector.main.loop.iter.check142
	ori	$t3, $zero, 120
	bgeu	$t2, $t3, .LBB3_58
# %bb.56:
	move	$t8, $a2
...
# %bb.61:
	...
	b	.LBB3_67
.LBB3_62:                               # %vec.epilog.iter.check200
	andi	$a2, $fp, 12
	ld.d	$t8, $sp, 72                    # 8-byte Folded Reload
	ld.d	$s0, $sp, 56                    # 8-byte Folded Reload
	ld.d	$s1, $sp, 48                    # 8-byte Folded Reload
...
.LBB3_64:                               # %vec.epilog.ph199
	...
	vrepli.w	$vr5, 15
	.p2align	4, , 16
.LBB3_65:                               # %vec.epilog.vector.body209
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a2, $a0, -16
	ld.w	$a3, $a0, -8
	ld.w	$a4, $a0, 0
	...
	addi.d	$a0, $a0, 32
	bnez	$t2, .LBB3_65
# %bb.66:                               # %vec.epilog.middle.block228
