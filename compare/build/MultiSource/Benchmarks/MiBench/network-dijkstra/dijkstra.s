...
# %bb.3:                                # %if.end.i
	move	$s1, $a0
	pcalau12i	$a1, %pc_hi20(qHead)
	ld.d	$a0, $a1, %pc_lo12(qHead)
	st.w	$s2, $s1, 0
	st.d	$fp, $s1, 4
	st.d	$zero, $s1, 16
...
# %bb.12:                               # %if.then.i11
	...
	ld.w	$a0, $a1, %pc_lo12(g_qCount)
	ld.d	$s1, $fp, %pc_lo12(qHead)
	addi.w	$s6, $a0, -1
	st.w	$s6, $a1, %pc_lo12(g_qCount)
.LBB4_13:                               # %dequeue.exit
                                        #   in Loop: Header=BB4_11 Depth=1
	ld.w	$fp, $s2, %pc_lo12(iNode)
	ld.w	$s8, $s4, %pc_lo12(iDist)
	move	$s7, $zero
	ori	$a0, $zero, 400
	mul.d	$a0, $fp, $a0
...
.LBB5_2:                                # %if.end
	...
	move	$s1, $zero
	pcalau12i	$a0, %pc_hi20(AdjMatrix)
	addi.d	$s2, $a0, %pc_lo12(AdjMatrix)
