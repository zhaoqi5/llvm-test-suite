...
.LBB1_15:                               # %vector.body93
	...
	bstrpick.d	$a1, $a1, 15, 0
	vinsgr2vr.w	$vr2, $a1, 0
	vpickve2gr.h	$a1, $vr5, 5
	bstrpick.d	$a1, $a1, 15, 0
	vinsgr2vr.w	$vr2, $a1, 1
	vpickve2gr.h	$a1, $vr5, 6
	bstrpick.d	$a1, $a1, 15, 0
	vinsgr2vr.w	$vr2, $a1, 2
	vpickve2gr.h	$a1, $vr5, 7
	bstrpick.d	$a1, $a1, 15, 0
	vinsgr2vr.w	$vr2, $a1, 3
...
.LBB2_2:                                # %for.cond4.preheader
	...
	xvsle.w	$xr3, $xr1, $xr0
	xvand.v	$xr6, $xr2, $xr3
	xvbitsel.v	$xr1, $xr8, $xr1, $xr6
	xvdiv.w	$xr0, $xr0, $xr1
	xvand.v	$xr0, $xr3, $xr0
	xvneg.w	$xr0, $xr0
	xvld	$xr1, $sp, 88
	xvld	$xr3, $s1, 32
	xvandn.v	$xr4, $xr5, $xr4
	xvbitsel.v	$xr0, $xr4, $xr0, $xr2
	xvslti.w	$xr2, $xr1, 0
	xvsrai.w	$xr4, $xr3, 1
	xvadd.w	$xr5, $xr1, $xr4
	xvslt.w	$xr6, $xr5, $xr3
	xvor.v	$xr6, $xr2, $xr6
	xvbitsel.v	$xr7, $xr3, $xr8, $xr6
	xvdiv.w	$xr5, $xr5, $xr7
	xvsub.w	$xr1, $xr4, $xr1
	xvsle.w	$xr4, $xr3, $xr1
	xvand.v	$xr7, $xr2, $xr4
	xvbitsel.v	$xr3, $xr8, $xr3, $xr7
	xvdiv.w	$xr1, $xr1, $xr3
	xvand.v	$xr1, $xr4, $xr1
	xvneg.w	$xr1, $xr1
	xvandn.v	$xr3, $xr6, $xr5
	xvbitsel.v	$xr1, $xr3, $xr1, $xr2
