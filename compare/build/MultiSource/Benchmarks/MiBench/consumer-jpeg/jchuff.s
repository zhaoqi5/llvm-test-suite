...
# %bb.8:                                # %for.body10.lr.ph
	...
	ld.d	$t0, $a7, %got_pc_lo12(jpeg_natural_order)
	move	$a7, $zero
	addi.d	$t0, $t0, 4
	ori	$t1, $zero, 16
	b	.LBB4_10
...
# %bb.18:                               # %while.body19.lr.ph.i
	...
	masknez	$s2, $s2, $s3
	addi.d	$s2, $s2, 15
	bstrpick.d	$s3, $s2, 31, 4
	add.d	$s1, $s3, $s1
	addi.d	$s1, $s1, 1
	bstrpick.d	$s2, $s2, 30, 4
	slli.d	$s2, $s2, 4
	sub.d	$fp, $fp, $s2
	addi.d	$fp, $fp, -16
	st.d	$s1, $t5, 1920
.LBB4_19:                               # %for.inc.thread.i
                                        #   in Loop: Header=BB4_16 Depth=2
	ext.w.h	$s1, $s0
	srai.d	$s1, $s1, 15
	xor	$s0, $s0, $s1
	sub.d	$s0, $s0, $s1
	bstrpick.d	$s0, $s0, 15, 1
	clz.w	$s0, $s0
	slli.d	$fp, $fp, 4
	sub.d	$fp, $fp, $s0
	addi.w	$fp, $fp, 33
...
.LBB6_38:                               # %if.end65.i
	...
	ori	$a1, $zero, 8
	blt	$s1, $a1, .LBB6_69
# %bb.39:                               # %while.body.i230.i.preheader
                                        #   in Loop: Header=BB6_31 Depth=2
...
# %bb.67:                               # %if.then31.i247.i
	...
	bnez	$a0, .LBB6_60
	b	.LBB6_108
.LBB6_68:                               # %for.inc.thread.i.loopexit
                                        #   in Loop: Header=BB6_31 Depth=2
	addi.d	$s1, $fp, -8
.LBB6_69:                               # %for.inc.thread.i
                                        #   in Loop: Header=BB6_31 Depth=2
	st.d	$s3, $sp, 144
	st.w	$s1, $sp, 152
	ori	$a0, $zero, 64
