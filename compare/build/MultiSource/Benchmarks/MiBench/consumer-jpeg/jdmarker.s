...
.LBB4_52:                               # %if.end195.i
	...
	ori	$s6, $zero, 255
	blez	$s3, .LBB4_75
.LBB4_53:                               # %do.body24.i202
                                        #   Parent Loop BB4_3 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB4_63 Depth 3
                                        #       Child Loop BB4_71 Depth 3
	bnez	$s5, .LBB4_56
# %bb.54:                               # %if.then27.i229
                                        #   in Loop: Header=BB4_53 Depth=2
	ld.d	$a1, $s1, 24
	move	$a0, $fp
	jirl	$ra, $a1, 0
...
.LBB4_60:                               # %if.end64.i
	...
	b	.LBB4_71
	.p2align	4, , 16
.LBB4_61:                               #   in Loop: Header=BB4_63 Depth=3
	addi.d	$a0, $s4, 1
.LBB4_62:                               # %if.end98.i
...
# %bb.68:                               # %if.end95.i
	...
	b	.LBB4_62
	.p2align	4, , 16
.LBB4_69:                               # %if.end113.us.i
                                        #   in Loop: Header=BB4_71 Depth=3
	ld.d	$s4, $s1, 0
	ld.d	$s5, $s1, 8
.LBB4_70:                               # %if.end116.us.i
                                        #   in Loop: Header=BB4_71 Depth=3
	ld.bu	$a0, $s4, 0
	...
	ori	$a0, $zero, 256
	beq	$s2, $a0, .LBB4_73
.LBB4_71:                               # %for.body.us.i
                                        #   Parent Loop BB4_3 Depth=1
                                        #     Parent Loop BB4_53 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	bnez	$s5, .LBB4_70
# %bb.72:                               # %if.then108.us.i
                                        #   in Loop: Header=BB4_71 Depth=3
	ld.d	$a1, $s1, 24
	move	$a0, $fp
	jirl	$ra, $a1, 0
	...
	b	.LBB4_232
	.p2align	4, , 16
.LBB4_73:                               # %for.end.i224
                                        #   in Loop: Header=BB4_53 Depth=2
	ld.d	$a0, $fp, 0
	ld.w	$a1, $a0, 124
	ori	$a2, $zero, 2
	blt	$a1, $a2, .LBB4_52
# %bb.74:                               # %do.body136.preheader.i
                                        #   in Loop: Header=BB4_53 Depth=2
	ld.d	$a1, $s0, 0
	ld.d	$a2, $s0, 8
...
.LBB4_92:                               # %if.end199.i
	...
	ori	$s6, $zero, 255
	blez	$s1, .LBB4_158
.LBB4_93:                               # %do.body24.i130
                                        #   Parent Loop BB4_3 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB4_151 Depth 3
	bnez	$s7, .LBB4_96
# %bb.94:                               # %if.then27.i163
                                        #   in Loop: Header=BB4_93 Depth=2
	ld.d	$a1, $s0, 24
	move	$a0, $fp
	jirl	$ra, $a1, 0
...
.LBB4_151:                              # %do.body150.i
                                        ...
                                        # =>    This Inner Loop Header: Depth=3
	bnez	$s7, .LBB4_150
# %bb.152:                              # %if.then153.i159
                                        #   in Loop: Header=BB4_151 Depth=3
	ld.d	$a1, $s0, 24
	move	$a0, $fp
	jirl	$ra, $a1, 0
	beqz	$a0, .LBB4_232
# %bb.153:                              # %if.end158.i162
                                        #   in Loop: Header=BB4_151 Depth=3
	ld.d	$a0, $s0, 0
	ld.d	$s7, $s0, 8
	b	.LBB4_150
...
# %bb.160:                              # %if.end.i314
	...
	addi.d	$a0, $a0, -1
	bnez	$a0, .LBB4_35
.LBB4_161:                              # %if.then10.i305
                                        #   in Loop: Header=BB4_3 Depth=1
	ld.d	$a1, $s0, 24
	move	$a0, $fp
	jirl	$ra, $a1, 0
	beqz	$a0, .LBB4_232
# %bb.162:                              # %if.end15.i309
                                        #   in Loop: Header=BB4_3 Depth=1
	ld.d	$a1, $s0, 0
	ld.d	$a0, $s0, 8
...
# %bb.165:                              # %if.end.i105
	...
	addi.d	$a1, $a0, -1
	bnez	$a1, .LBB4_45
.LBB4_166:                              # %if.then10.i96
                                        #   in Loop: Header=BB4_3 Depth=1
	ld.d	$a1, $s0, 24
	move	$a0, $fp
	jirl	$ra, $a1, 0
	beqz	$a0, .LBB4_232
# %bb.167:                              # %if.end15.i100
                                        #   in Loop: Header=BB4_3 Depth=1
	ld.d	$a0, $s0, 0
	ld.d	$a1, $s0, 8
...
.Lfunc_end7:
	...
	.p2align	4, 0x0                          # -- Begin function get_app14
.LCPI8_0:
	.word	0                               # 0x0
	.word	8                               # 0x8
	.word	8                               # 0x8
