	...
	.p2align	5, 0x0                          # -- Begin function jinit_merged_upsampler
.LCPI0_0:
...
.LBB0_2:                                # %if.else
	move	$a0, $zero
	pcalau12i	$a1, %pc_hi20(merged_1v_upsample)
	addi.d	$a1, $a1, %pc_lo12(merged_1v_upsample)
	st.d	$a1, $s0, 8
	pcalau12i	$a1, %pc_hi20(h2v1_merged_upsample)
	addi.d	$a1, $a1, %pc_lo12(h2v1_merged_upsample)
	st.d	$a1, $s0, 24
	move	$s1, $s0
.LBB0_3:                                # %if.end
	ld.d	$a1, $fp, 8
