...
# %bb.0:                                # %entry
	...
	move	$fp, $a0
	st.d	$a0, $s0, 552
	pcalau12i	$a0, %pc_hi20(start_pass_dpost)
	addi.d	$a0, $a0, %pc_lo12(start_pass_dpost)
	vrepli.b	$vr0, 0
	vst	$vr0, $fp, 16
	ld.w	$a1, $s0, 100
	st.d	$a0, $fp, 0
...
# %bb.3:                                # %sw.bb
	...
	beqz	$a1, .LBB1_13
# %bb.4:                                # %if.then
	pcalau12i	$a1, %pc_hi20(post_process_1pass)
	addi.d	$a1, $a1, %pc_lo12(post_process_1pass)
	ld.d	$a2, $fp, 24
	st.d	$a1, $fp, 8
	bnez	$a2, .LBB1_15
# %bb.5:                                # %if.then2
