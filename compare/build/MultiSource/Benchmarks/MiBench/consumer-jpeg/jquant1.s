...
# %bb.2:                                # %for.body.us.preheader
	...
	b	.LBB8_4
	.p2align	4, , 16
.LBB8_3:                                # %for.cond3.for.end34_crit_edge.us
...
.LBB8_7:                                # %for.body20.us
	...
	add.d	$a5, $a5, $s4
	bnez	$t2, .LBB8_7
# %bb.8:                                # %for.cond17.for.inc33_crit_edge.us
...
# %bb.2:                                # %for.body.us.preheader
	...
	b	.LBB9_4
	.p2align	4, , 16
.LBB9_3:                                # %for.cond2.for.end71_crit_edge.us
...
.LBB9_10:                               # %for.body31.us
	...
	move	$t5, $t7
	bnez	$t4, .LBB9_10
# %bb.11:                               # %for.cond28.for.end_crit_edge.us
                                        #   in Loop: Header=BB9_6 Depth=2
	addi.d	$a0, $a0, 1
	st.h	$t2, $a7, 0
	bne	$a0, $s4, .LBB9_6
# %bb.12:                               # %for.cond2.for.end71_crit_edge.us.loopexit81
                                        #   in Loop: Header=BB9_4 Depth=1
	ld.w	$a0, $s3, 144
	ld.d	$a3, $sp, 40                    # 8-byte Folded Reload
	...
	b	.LBB9_3
	.p2align	4, , 16
.LBB9_13:                               # %for.body5.lr.ph.split.us.us
                                        #   in Loop: Header=BB9_4 Depth=1
	ld.w	$a0, $s3, 144
	move	$a2, $s5
	ori	$a1, $zero, 8
...
# %bb.17:                               # %middle.block
	...
	ld.d	$a3, $sp, 40                    # 8-byte Folded Reload
	beq	$a1, $s4, .LBB9_3
.LBB9_18:                               # %for.body5.us.us.preheader
                                        #   in Loop: Header=BB9_4 Depth=1
	sltui	$a1, $a0, 1
	masknez	$a4, $s0, $a1
	alsl.d	$a1, $a5, $fp, 3
