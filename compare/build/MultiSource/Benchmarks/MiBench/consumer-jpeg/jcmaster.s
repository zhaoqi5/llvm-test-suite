...
# %bb.0:                                # %entry
	...
	st.d	$a0, $s5, 8
	ld.w	$a0, $fp, 44
	pcalau12i	$a1, %pc_hi20(finish_pass_master)
	addi.d	$a1, $a1, %pc_lo12(finish_pass_master)
	st.d	$a1, $s5, 16
	st.w	$zero, $s5, 28
	beqz	$a0, .LBB0_5
...
# %bb.78:                               # %for.body159.i.preheader
                                        #   in Loop: Header=BB0_74 Depth=2
	beqz	$s5, .LBB0_90
# %bb.79:                               # %for.body159.i.preheader69
                                        #   in Loop: Header=BB0_74 Depth=2
	...
	b	.LBB0_82
	.p2align	4, , 16
.LBB0_80:                               # %if.end190.sink.split.i
...
.LBB0_84:                               # %if.then148.i
	...
	blt	$a0, $s6, .LBB0_73
	b	.LBB0_77
.LBB0_85:                               # %for.body159.us.i.preheader
                                        #   in Loop: Header=BB0_74 Depth=2
	ld.d	$a0, $sp, 48                    # 8-byte Folded Reload
	add.d	$s0, $a0, $s0
	ld.d	$s2, $sp, 56                    # 8-byte Folded Reload
	b	.LBB0_87
	.p2align	4, , 16
.LBB0_86:                               # %if.end190.us.i
                                        #   in Loop: Header=BB0_87 Depth=3
	st.w	$s3, $s0, 0
	addi.w	$s2, $s2, -1
	addi.d	$s0, $s0, 4
	beqz	$s2, .LBB0_73
.LBB0_87:                               # %for.body159.us.i
                                        #   Parent Loop BB0_38 Depth=1
                                        #     Parent Loop BB0_74 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.w	$a0, $s0, 0
	bltz	$a0, .LBB0_86
# %bb.88:                               # %for.body159.us.i
                                        #   in Loop: Header=BB0_87 Depth=3
	sltui	$a0, $a0, 1
	and	$a0, $a0, $s5
	bnez	$a0, .LBB0_86
# %bb.89:                               # %if.then181.us.i
	...
	jirl	$ra, $a1, 0
	b	.LBB0_86
.LBB0_90:                               # %for.body159.i.us.preheader
                                        #   in Loop: Header=BB0_74 Depth=2
	ld.d	$a0, $sp, 48                    # 8-byte Folded Reload
	add.d	$s0, $a0, $s0
	ld.d	$s2, $sp, 56                    # 8-byte Folded Reload
	.p2align	4, , 16
.LBB0_91:                               # %for.body159.i.us
                                        #   Parent Loop BB0_38 Depth=1
                                        #     Parent Loop BB0_74 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$a0, $fp, 0
	...
	b	.LBB0_73
	.p2align	4, , 16
.LBB0_92:                               # %if.then112.i
                                        #   in Loop: Header=BB0_38 Depth=1
	ld.d	$a0, $sp, 80                    # 8-byte Folded Reload
	bnez	$a0, .LBB0_70
	b	.LBB0_71
.LBB0_93:                               # %for.end243.loopexit.i
	ld.w	$s1, $fp, 300
	ld.w	$s0, $fp, 68
	ld.d	$s5, $sp, 24                    # 8-byte Folded Reload
	ld.d	$s6, $sp, 16                    # 8-byte Folded Reload
.LBB0_94:                               # %for.end243.i
	ori	$a0, $zero, 1
	beqz	$s1, .LBB0_100
# %bb.95:                               # %for.cond247.preheader.i
	blt	$s0, $a0, .LBB0_105
# %bb.96:                               # %for.body250.i.preheader
	move	$s1, $zero
	addi.d	$s2, $sp, 96
	addi.w	$s3, $zero, -1
	ori	$s4, $zero, 44
	b	.LBB0_98
	.p2align	4, , 16
.LBB0_97:                               # %for.inc261.i
                                        #   in Loop: Header=BB0_98 Depth=1
	addi.d	$s1, $s1, 1
	addi.d	$s2, $s2, 256
	bge	$s1, $s0, .LBB0_105
.LBB0_98:                               # %for.body250.i
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a0, $s2, 0
	blt	$s3, $a0, .LBB0_97
# %bb.99:                               # %if.then255.i
	...
	ld.w	$s0, $fp, 68
	b	.LBB0_97
.LBB0_100:                              # %for.cond265.preheader.i
	blt	$s0, $a0, .LBB0_105
# %bb.101:                              # %for.body268.i.preheader
	move	$s1, $zero
	ori	$a0, $zero, 2656
	add.d	$s2, $sp, $a0
	ori	$s3, $zero, 44
	b	.LBB0_103
	.p2align	4, , 16
.LBB0_102:                              # %for.inc278.i
                                        #   in Loop: Header=BB0_103 Depth=1
	addi.d	$s1, $s1, 1
	addi.d	$s2, $s2, 4
	bge	$s1, $s0, .LBB0_105
.LBB0_103:                              # %for.body268.i
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a0, $s2, 0
	bnez	$a0, .LBB0_102
# %bb.104:                              # %if.then272.i
...
.Lfunc_end0:
	...
	.p2align	5, 0x0                          # -- Begin function prepare_for_pass
.LCPI1_0:
	.dword	0                               # 0x0
	.dword	1                               # 0x1
	.dword	2                               # 0x2
