...
# %bb.22:                               # %iter.check41
	...
	ori	$a1, $zero, 15
	bltu	$a0, $a1, .LBB3_64
# %bb.23:                               # %vector.main.loop.iter.check43
                                        #   in Loop: Header=BB3_5 Depth=1
	ori	$a1, $zero, 31
...
.LBB3_25:                               # %vec.epilog.ph56
	...
	add.d	$a1, $a1, $a5
	.p2align	4, , 16
.LBB3_26:                               # %vec.epilog.vector.body62
                                        #   Parent Loop BB3_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a1, 0
...
# %bb.39:                               # %iter.check73
	...
	ori	$a1, $zero, 16
	bltu	$a3, $a1, .LBB3_57
# %bb.40:                               # %vector.main.loop.iter.check75
                                        #   in Loop: Header=BB3_5 Depth=1
	addi.d	$a2, $s8, 526
	ori	$a1, $zero, 32
	bgeu	$a3, $a1, .LBB3_52
...
.LBB3_42:                               # %vec.epilog.ph88
	...
	add.d	$a3, $a7, $a3
	.p2align	4, , 16
.LBB3_43:                               # %vec.epilog.vector.body94
                                        #   Parent Loop BB3_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a3, 0
	...
	addi.d	$a3, $a3, 16
	bnez	$a6, .LBB3_43
# %bb.44:                               # %vec.epilog.middle.block99
                                        #   in Loop: Header=BB3_5 Depth=1
	move	$s1, $ra
	move	$s2, $a1
	ld.d	$s5, $sp, 216                   # 8-byte Folded Reload
...
.LBB3_53:                               # %vector.body79
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB3_53
# %bb.54:                               # %middle.block84
                                        #   in Loop: Header=BB3_5 Depth=1
	beq	$a3, $a0, .LBB3_66
# %bb.55:                               # %vec.epilog.iter.check89
                                        #   in Loop: Header=BB3_5 Depth=1
	andi	$a4, $a0, 16
	bnez	$a4, .LBB3_72
