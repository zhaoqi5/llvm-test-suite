...
# %bb.0:                                # %entry
	...
	pcalau12i	$s7, %pc_hi20(orig_word)
	ld.d	$s6, $s7, %pc_lo12(orig_word)
	move	$s4, $a5
	move	$fp, $a4
	move	$s2, $a3
	move	$s5, $a2
...
# %bb.31:                               # %if.then121
	...
	jirl	$ra, $ra, 0
	b	.LBB2_35
.LBB2_32:                               # %while.cond125.preheader
	ld.bu	$a0, $s1, 0
	beqz	$a0, .LBB2_35
# %bb.33:                               # %while.body127.preheader
	addi.d	$fp, $s1, 1
	.p2align	4, , 16
.LBB2_34:                               # %while.body127
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a0, $s8, $a0
	ld.bu	$a0, $a0, 526
	pcaddu18i	$ra, %call36(printichar)
