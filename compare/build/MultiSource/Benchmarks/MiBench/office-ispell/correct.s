...
# %bb.28:
	move	$a1, $zero
	b	.LBB10_49
.LBB10_29:                              # %vector.main.loop.iter.check256
	ori	$a0, $zero, 32
	bgeu	$s8, $a0, .LBB10_39
# %bb.30:
	move	$a2, $zero
.LBB10_31:                              # %vec.epilog.ph268
	...
	add.d	$a1, $a1, $a2
	.p2align	4, , 16
.LBB10_32:                              # %vec.epilog.vector.body274
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $a1, 0
	...
	addi.d	$a1, $a1, 16
	bnez	$a0, .LBB10_32
# %bb.33:                               # %vec.epilog.middle.block278
	...
	bne	$a2, $a0, .LBB10_43
	b	.LBB10_51
.LBB10_34:                              # %vector.main.loop.iter.check227
	ori	$a0, $zero, 32
	bgeu	$s8, $a0, .LBB10_45
# %bb.35:
	move	$a2, $zero
.LBB10_36:                              # %vec.epilog.ph239
	ld.d	$a0, $sp, 80                    # 8-byte Folded Reload
	add.d	$a0, $a0, $a2
	addi.d	$a1, $sp, 320
	add.d	$a1, $a1, $a2
	.p2align	4, , 16
.LBB10_37:                              # %vec.epilog.vector.body245
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $a1, 0
	vpickve2gr.b	$a2, $vr2, 14
	andi	$a2, $a2, 255
	...
	addi.d	$a1, $a1, 16
	bnez	$a0, .LBB10_37
# %bb.38:                               # %vec.epilog.middle.block249
	ld.d	$a2, $sp, 88                    # 8-byte Folded Reload
	move	$a1, $a2
	ld.d	$fp, $sp, 184                   # 8-byte Folded Reload
	ld.d	$s0, $sp, 176                   # 8-byte Folded Reload
	...
	bne	$a2, $a0, .LBB10_49
	b	.LBB10_51
.LBB10_39:                              # %vector.body260.preheader
	st.d	$s4, $sp, 40                    # 8-byte Folded Spill
	st.d	$s7, $sp, 168                   # 8-byte Folded Spill
	addi.d	$a0, $sp, 320
	ld.d	$a1, $sp, 160                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB10_40:                              # %vector.body260
                                        # =>This Inner Loop Header: Depth=1
...
# %bb.41:                               # %middle.block264
	...
	ld.d	$s4, $sp, 40                    # 8-byte Folded Reload
	beq	$a1, $a0, .LBB10_51
# %bb.42:                               # %vec.epilog.iter.check269
...
.LBB10_44:                              # %for.body237
	...
	bnez	$a1, .LBB10_44
	b	.LBB10_51
.LBB10_45:                              # %vector.body231.preheader
	st.d	$s4, $sp, 40                    # 8-byte Folded Spill
	st.d	$s7, $sp, 168                   # 8-byte Folded Spill
	addi.d	$a0, $sp, 320
	ld.d	$a1, $sp, 160                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB10_46:                              # %vector.body231
                                        # =>This Inner Loop Header: Depth=1
	st.d	$a1, $sp, 296                   # 8-byte Folded Spill
	st.d	$a0, $sp, 304                   # 8-byte Folded Spill
	xvld	$xr3, $a0, 0
...
# %bb.47:                               # %middle.block235
	...
	ld.d	$s4, $sp, 40                    # 8-byte Folded Reload
	beq	$a1, $a0, .LBB10_51
# %bb.48:                               # %vec.epilog.iter.check240
	ld.d	$a2, $sp, 160                   # 8-byte Folded Reload
	move	$a1, $a2
	ld.d	$a0, $sp, 32                    # 8-byte Folded Reload
	bnez	$a0, .LBB10_36
...
# %bb.55:
	move	$a2, $zero
.LBB10_56:                              # %vec.epilog.ph204
	ld.d	$a0, $sp, 48                    # 8-byte Folded Reload
	add.d	$a0, $a0, $a2
	ld.d	$a1, $sp, 200                   # 8-byte Folded Reload
	add.d	$a1, $a1, $a2
	.p2align	4, , 16
.LBB10_57:                              # %vec.epilog.vector.body211
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $a1, 0
	vpickve2gr.b	$a2, $vr2, 14
	andi	$a2, $a2, 255
	...
	addi.d	$a1, $a1, 16
	bnez	$a0, .LBB10_57
# %bb.58:                               # %vec.epilog.middle.block216
...
# %bb.68:                               # %middle.block200
	...
	ld.d	$a1, $sp, 144                   # 8-byte Folded Reload
	beq	$a0, $a1, .LBB10_78
# %bb.69:                               # %vec.epilog.iter.check205
	ld.d	$a2, $sp, 144                   # 8-byte Folded Reload
