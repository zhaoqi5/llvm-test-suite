...
.LBB2_118:                              #   in Loop: Header=BB2_4 Depth=1
	move	$a1, $s6
	move	$a2, $s5
.LBB2_119:                              # %while.body.i.preheader254
                                        #   in Loop: Header=BB2_4 Depth=1
	move	$a3, $a2
...
.LBB2_142:
	move	$a1, $s6
	move	$a2, $s2
.LBB2_143:                              # %while.body.i194.preheader252
	move	$a3, $a2
	.p2align	4, , 16
...
# %bb.29:
	move	$a1, $zero
	b	.LBB10_50
.LBB10_30:                              # %vector.main.loop.iter.check254
	ori	$a0, $zero, 32
	bgeu	$s7, $a0, .LBB10_40
# %bb.31:
	move	$a2, $zero
.LBB10_32:                              # %vec.epilog.ph266
	ld.d	$a0, $sp, 88                    # 8-byte Folded Reload
	add.d	$a0, $a0, $a2
	addi.d	$a1, $sp, 352
	add.d	$a1, $a1, $a2
	.p2align	4, , 16
.LBB10_33:                              # %vec.epilog.vector.body272
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a1, 0
	...
	addi.d	$a1, $a1, 16
	bnez	$a0, .LBB10_33
# %bb.34:                               # %vec.epilog.middle.block276
	...
	bne	$a2, $a0, .LBB10_44
	b	.LBB10_52
.LBB10_35:                              # %vector.main.loop.iter.check225
	ori	$a0, $zero, 32
	bgeu	$s7, $a0, .LBB10_46
# %bb.36:
	move	$a2, $zero
.LBB10_37:                              # %vec.epilog.ph237
	ld.d	$a0, $sp, 88                    # 8-byte Folded Reload
	add.d	$a0, $a0, $a2
	addi.d	$a1, $sp, 352
	add.d	$a1, $a1, $a2
	.p2align	4, , 16
.LBB10_38:                              # %vec.epilog.vector.body243
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a1, 0
	vpickve2gr.b	$a2, $vr0, 15
	andi	$a2, $a2, 255
	...
	addi.d	$a1, $a1, 16
	bnez	$a0, .LBB10_38
# %bb.39:                               # %vec.epilog.middle.block247
	ld.d	$a2, $sp, 96                    # 8-byte Folded Reload
	move	$a1, $a2
	ld.d	$fp, $sp, 192                   # 8-byte Folded Reload
	ld.d	$s0, $sp, 184                   # 8-byte Folded Reload
...
.LBB10_41:                              # %vector.body258
	...
	andi	$t2, $t2, 255
	bstrpick.d	$a1, $t2, 15, 0
	st.d	$a1, $sp, 272                   # 8-byte Folded Spill
	vpickve2gr.b	$t3, $vr1, 6
	andi	$t3, $t3, 255
	bstrpick.d	$a1, $t3, 15, 0
	...
	andi	$fp, $fp, 255
	bstrpick.d	$t3, $fp, 15, 0
	vpickve2gr.b	$fp, $vr0, 14
	andi	$fp, $fp, 255
	bstrpick.d	$s6, $fp, 15, 0
	...
	andi	$fp, $fp, 255
	bstrpick.d	$fp, $fp, 15, 0
	vpickve2gr.b	$s5, $vr0, 9
	andi	$s5, $s5, 255
	bstrpick.d	$s5, $s5, 15, 0
	vpickve2gr.b	$s7, $vr0, 8
	andi	$s7, $s7, 255
...
# %bb.42:                               # %middle.block262
	...
	beq	$a1, $a0, .LBB10_52
# %bb.43:                               # %vec.epilog.iter.check267
...
.LBB10_45:                              # %for.body237
	...
	bnez	$a1, .LBB10_45
	b	.LBB10_52
.LBB10_46:                              # %vector.body229.preheader
	st.d	$ra, $sp, 48                    # 8-byte Folded Spill
	st.d	$s6, $sp, 176                   # 8-byte Folded Spill
	addi.d	$a1, $sp, 352
	ld.d	$ra, $sp, 168                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB10_47:                              # %vector.body229
                                        # =>This Inner Loop Header: Depth=1
	st.d	$a1, $sp, 336                   # 8-byte Folded Spill
	xvld	$xr0, $a1, 0
	xvpermi.q	$xr1, $xr0, 1
	...
	vpickve2gr.b	$s3, $vr0, 10
	andi	$s3, $s3, 255
	bstrpick.d	$s3, $s3, 15, 0
	vpickve2gr.b	$s5, $vr0, 9
	andi	$s5, $s5, 255
	bstrpick.d	$s5, $s5, 15, 0
	vpickve2gr.b	$s6, $vr0, 8
	andi	$s6, $s6, 255
	bstrpick.d	$s6, $s6, 15, 0
	vpickve2gr.b	$s7, $vr0, 7
	andi	$s7, $s7, 255
	bstrpick.d	$s7, $s7, 15, 0
	vpickve2gr.b	$s8, $vr0, 6
	andi	$s8, $s8, 255
	...
	vinsgr2vr.b	$vr0, $t0, 7
	vinsgr2vr.b	$vr0, $t1, 8
	vinsgr2vr.b	$vr0, $s6, 9
	vinsgr2vr.b	$vr0, $s5, 10
	vinsgr2vr.b	$vr0, $s1, 11
	vinsgr2vr.b	$vr0, $s2, 12
	vinsgr2vr.b	$vr0, $s3, 13
	vinsgr2vr.b	$vr0, $s7, 14
...
# %bb.48:                               # %middle.block233
	...
	ld.d	$ra, $sp, 48                    # 8-byte Folded Reload
	beq	$a1, $a0, .LBB10_52
# %bb.49:                               # %vec.epilog.iter.check238
	ld.d	$a2, $sp, 168                   # 8-byte Folded Reload
	move	$a1, $a2
	ld.d	$a0, $sp, 40                    # 8-byte Folded Reload
	bnez	$a0, .LBB10_37
...
# %bb.54:                               # %iter.check187
	...
	ori	$a3, $zero, 15
	bltu	$a2, $a3, .LBB10_71
# %bb.55:                               # %vector.main.loop.iter.check189
	ld.d	$a0, $sp, 200                   # 8-byte Folded Reload
	ori	$a1, $zero, 31
	bgeu	$a0, $a1, .LBB10_67
# %bb.56:
	move	$a2, $zero
.LBB10_57:                              # %vec.epilog.ph202
	ld.d	$a0, $sp, 56                    # 8-byte Folded Reload
	add.d	$a0, $a0, $a2
	ld.d	$a1, $sp, 208                   # 8-byte Folded Reload
	add.d	$a1, $a1, $a2
	.p2align	4, , 16
.LBB10_58:                              # %vec.epilog.vector.body209
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a1, 0
	vpickve2gr.b	$a2, $vr0, 15
	andi	$a2, $a2, 255
	...
	addi.d	$a1, $a1, 16
	bnez	$a0, .LBB10_58
# %bb.59:                               # %vec.epilog.middle.block214
	ld.d	$a1, $sp, 72                    # 8-byte Folded Reload
	ld.d	$a0, $sp, 64                    # 8-byte Folded Reload
	ld.d	$fp, $sp, 192                   # 8-byte Folded Reload
	ld.d	$s0, $sp, 184                   # 8-byte Folded Reload
...
# %bb.66:                               # %vec.epilog.middle.block
	...
	bne	$a2, $a3, .LBB10_77
	b	.LBB10_79
.LBB10_67:                              # %vector.body193.preheader
	st.d	$s6, $sp, 176                   # 8-byte Folded Spill
	ld.d	$a1, $sp, 208                   # 8-byte Folded Reload
	ld.d	$s5, $sp, 152                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB10_68:                              # %vector.body193
                                        # =>This Inner Loop Header: Depth=1
	st.d	$a1, $sp, 336                   # 8-byte Folded Spill
	xvld	$xr0, $a1, 0
	xvpermi.q	$xr1, $xr0, 1
...
# %bb.69:                               # %middle.block198
	...
	ld.d	$a1, $sp, 152                   # 8-byte Folded Reload
	beq	$a0, $a1, .LBB10_79
# %bb.70:                               # %vec.epilog.iter.check203
