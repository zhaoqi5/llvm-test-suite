...
.LBB2_119:                              # %while.body.i
	...
	move	$a2, $a4
	bne	$a4, $a0, .LBB2_119
.LBB2_120:                              # %while.end.i.loopexit
                                        #   in Loop: Header=BB2_4 Depth=1
	move	$s5, $a1
	move	$a2, $a0
.LBB2_121:                              # %while.end.i
                                        #   in Loop: Header=BB2_4 Depth=1
	st.d	$s5, $s6, 0
	ld.bu	$a1, $a2, 0
	beqz	$a1, .LBB2_125
# %bb.122:                              # %if.then.i
	...
	addi.d	$s5, $s5, 1
	beqz	$a1, .LBB2_125
# %bb.123:                              # %while.body11.i.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	sltu	$a2, $s4, $a0
	masknez	$a3, $s4, $a2
	maskeqz	$a0, $a0, $a2
...
.LBB2_124:                              # %while.body11.i
	...
	addi.d	$a0, $a0, 1
	bnez	$a1, .LBB2_124
.LBB2_125:                              # %while.cond15.i.preheader
                                        #   in Loop: Header=BB2_4 Depth=1
	sub.d	$a0, $s0, $s2
	add.d	$a0, $fp, $a0
	.p2align	4, , 16
.LBB2_126:                              # %while.cond15.i
                                        #   Parent Loop BB2_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.bu	$a1, $a0, 0
	addi.d	$a0, $a0, 1
...
.LBB2_132:                              # %if.then210
	...
	jirl	$ra, $ra, 0
	beq	$s1, $s2, .LBB2_134
# %bb.133:                              # %for.body.preheader.i155
	pcalau12i	$a0, %got_pc_hi20(contextbufs)
	ld.d	$a0, $a0, %got_pc_lo12(contextbufs)
	addi.d	$a1, $sp, 320
	addi.d	$fp, $sp, 320
	...
	add.d	$fp, $fp, $s0
	move	$s2, $s1
.LBB2_134:                              # %for.end.i158
	ld.d	$s0, $s6, 0
	move	$a0, $s4
	pcaddu18i	$ra, %call36(skipoverword)
	jirl	$ra, $ra, 0
	bgeu	$s4, $a0, .LBB2_140
# %bb.135:                              # %while.body.i191.preheader
	sub.d	$a3, $a0, $s4
	ori	$a1, $zero, 64
	bltu	$a3, $a1, .LBB2_141
...
.LBB2_142:                              # %while.body.i191
	...
	move	$a2, $a4
	bne	$a4, $a0, .LBB2_142
.LBB2_143:                              # %while.end.i166.loopexit
	move	$s2, $a1
	move	$a3, $a0
.LBB2_144:                              # %while.end.i166
	st.d	$s2, $s6, 0
	ld.bu	$a2, $a3, 0
	sub.d	$a1, $s0, $s1
	beqz	$a2, .LBB2_148
# %bb.145:                              # %if.then.i170
	...
	addi.d	$s2, $s2, 1
	beqz	$a2, .LBB2_148
# %bb.146:                              # %while.body11.i174.preheader
	sltu	$a3, $s4, $a0
	masknez	$a4, $s4, $a3
	maskeqz	$a0, $a0, $a3
	or	$a0, $a0, $a4
...
.LBB2_147:                              # %while.body11.i174
	...
	addi.d	$a0, $a0, 1
	bnez	$a2, .LBB2_147
.LBB2_148:                              # %while.cond15.i182.preheader
	add.d	$a0, $fp, $a1
	.p2align	4, , 16
.LBB2_149:                              # %while.cond15.i182
                                        # =>This Inner Loop Header: Depth=1
	ld.bu	$a1, $a0, 0
	addi.d	$a0, $a0, 1
	addi.d	$a2, $s2, 1
