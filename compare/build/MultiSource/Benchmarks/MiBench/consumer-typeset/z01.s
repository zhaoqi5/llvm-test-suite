...
.LBB0_2:                                # %if.end5
	...
	pcalau12i	$a0, %got_pc_hi20(PS_BackEnd)
	ld.d	$a0, $a0, %got_pc_lo12(PS_BackEnd)
	ld.d	$a0, $a0, 0
	pcalau12i	$a1, %pc_hi20(BackEnd)
	st.d	$a1, $sp, 208                   # 8-byte Folded Spill
	st.d	$a0, $a1, %pc_lo12(BackEnd)
	pcalau12i	$a0, %got_pc_hi20(PlainCharWidth)
	ld.d	$a1, $a0, %got_pc_lo12(PlainCharWidth)
	ori	$a0, $zero, 144
	st.d	$a1, $sp, 64                    # 8-byte Folded Spill
	st.w	$a0, $a1, 0
	pcalau12i	$a0, %got_pc_hi20(PlainCharHeight)
	ld.d	$a1, $a0, %got_pc_lo12(PlainCharHeight)
	ori	$a0, $zero, 240
	st.d	$a1, $sp, 56                    # 8-byte Folded Spill
	st.w	$a0, $a1, 0
	pcalau12i	$a0, %got_pc_hi20(PlainFormFeed)
	ld.d	$a0, $a0, %got_pc_lo12(PlainFormFeed)
	...
	pcalau12i	$a1, %pc_hi20(AllowCrossDb)
	st.d	$a1, $sp, 184                   # 8-byte Folded Spill
	st.w	$a0, $a1, %pc_lo12(AllowCrossDb)
	pcalau12i	$a1, %pc_hi20(InMemoryDbIndexes)
	st.d	$a1, $sp, 104                   # 8-byte Folded Spill
	st.w	$a0, $a1, %pc_lo12(InMemoryDbIndexes)
	...
	pcaddu18i	$ra, %call36(AddToPath)
	jirl	$ra, $ra, 0
	pcalau12i	$a0, %pc_hi20(AltErrorFormat)
	st.d	$a0, $sp, 80                    # 8-byte Folded Spill
	st.w	$zero, $a0, %pc_lo12(AltErrorFormat)
...
# %bb.147:                              # %if.then58
	...
	jirl	$ra, $ra, 0
	b	.LBB0_166
.LBB0_148:                              # %if.else.i193
                                        #   in Loop: Header=BB0_10 Depth=1
	move	$fp, $a4
	ld.d	$a0, $sp, 216                   # 8-byte Folded Reload
	bge	$s5, $a0, .LBB0_150
# %bb.149:                              # %land.lhs.true.i196
                                        #   in Loop: Header=BB0_10 Depth=1
	addi.w	$s0, $s5, 1
	slli.d	$a0, $s0, 3
	ldx.d	$a1, $s1, $a0
...
.LBB0_152:                              # %if.end106
	...
	jirl	$ra, $ra, 0
	b	.LBB0_166
.LBB0_153:                              # %if.else.i177
                                        #   in Loop: Header=BB0_10 Depth=1
	move	$fp, $a4
	ld.d	$a0, $sp, 216                   # 8-byte Folded Reload
	bge	$s5, $a0, .LBB0_155
# %bb.154:                              # %land.lhs.true.i180
                                        #   in Loop: Header=BB0_10 Depth=1
	addi.w	$s0, $s5, 1
	slli.d	$a0, $s0, 3
	ldx.d	$s6, $s1, $a0
...
.LBB0_157:                              # %if.end97
	...
	jirl	$ra, $ra, 0
	b	.LBB0_166
.LBB0_158:                              # %if.else.i145
                                        #   in Loop: Header=BB0_10 Depth=1
	ld.d	$a0, $sp, 216                   # 8-byte Folded Reload
	bge	$s5, $a0, .LBB0_160
# %bb.159:                              # %land.lhs.true.i148
                                        #   in Loop: Header=BB0_10 Depth=1
	addi.w	$a0, $s5, 1
	slli.d	$a1, $a0, 3
	ldx.d	$a3, $s1, $a1
...
.LBB0_160:                              # %if.then70
	...
	b	.LBB0_8
.LBB0_161:                              # %if.else.i241
                                        #   in Loop: Header=BB0_10 Depth=1
	move	$fp, $a4
	ld.d	$a0, $sp, 216                   # 8-byte Folded Reload
	bge	$s5, $a0, .LBB0_163
# %bb.162:                              # %land.lhs.true.i244
                                        #   in Loop: Header=BB0_10 Depth=1
	addi.w	$s0, $s5, 1
	slli.d	$a0, $s0, 3
	ldx.d	$s6, $s1, $a0
...
.LJTI0_1:
	...
	.word	.LBB0_187-.LJTI0_1
	.word	.LBB0_187-.LJTI0_1
	.word	.LBB0_175-.LJTI0_1
	.word	.LBB0_187-.LJTI0_1
	.word	.LBB0_187-.LJTI0_1
	.word	.LBB0_178-.LJTI0_1
.LJTI0_2:
	.word	.LBB0_181-.LJTI0_2
	.word	.LBB0_188-.LJTI0_2
	.word	.LBB0_188-.LJTI0_2
	.word	.LBB0_188-.LJTI0_2
	.word	.LBB0_188-.LJTI0_2
	.word	.LBB0_188-.LJTI0_2
