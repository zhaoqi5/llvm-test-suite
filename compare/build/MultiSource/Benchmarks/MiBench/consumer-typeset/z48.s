...
# %bb.28:                               # %if.else.i
	...
	fld.s	$fa1, $a2, %pc_lo12(g_page_h_scale_factor)
	ffint.s.w	$fa0, $fa0
	...
	addi.d	$a6, $a3, %pc_lo12(g_graphics_vars)
	ld.w	$a4, $a6, 0
	fmul.s	$fa0, $fa2, $fa0
	ftintrz.w.s	$fa0, $fa0
	movfr2gr.s	$a3, $fa0
...
# %bb.40:                               # %if.then69.i
	bnez	$s2, .LBB19_42
# %bb.41:                               # %for.body.i46.preheader.i
	move	$s3, $a0
...
# %bb.1:                                # %while.body.preheader
	pcalau12i	$a0, %pc_hi20(g_target_annot_list)
	pcalau12i	$a1, %got_pc_hi20(no_fpos)
	ld.d	$s3, $a1, %got_pc_lo12(no_fpos)
	addi.d	$s4, $a0, %pc_lo12(g_target_annot_list)
	pcalau12i	$a0, %pc_hi20(.L.str.75)
	addi.d	$s1, $a0, %pc_lo12(.L.str.75)
	b	.LBB26_4
	.p2align	4, , 16
...
# %bb.6:                                # %while.end14
	...
	bne	$a1, $a0, .LBB27_8
	b	.LBB27_12
.LBB27_7:                               # %while.end14.loopexit129
	move	$s0, $a0
	ori	$a0, $zero, 46
	beq	$a1, $a0, .LBB27_12
.LBB27_8:                               # %while.end14
...
.LBB27_86:                              # %if.then133
	...
	jirl	$ra, $ra, 0
	slli.d	$a1, $s1, 2
	pcalau12i	$a2, %pc_hi20(g_units)
	addi.d	$a2, $a2, %pc_lo12(g_units)
	b	.LBB27_79
.Lfunc_end27:
