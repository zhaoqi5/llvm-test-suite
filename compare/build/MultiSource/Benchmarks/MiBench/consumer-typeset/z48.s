...
.LBB17_44:                              #   in Loop: Header=BB17_10 Depth=1
	ori	$s5, $zero, 4
.LBB17_45:                              # %PDFKeyword_Find.exit65
                                        #   in Loop: Header=BB17_10 Depth=1
	slli.d	$a0, $s5, 3
...
# %bb.52:                               # %for.inc.i.6.i
	...
	or	$a0, $a0, $a1
	beqz	$a0, .LBB19_67
# %bb.53:                               # %while.cond53.preheader.i
	move	$a0, $s1
	move	$s0, $a7
	move	$s2, $t0
	pcaddu18i	$ra, %call36(strlen)
...
# %bb.4:                                # %while.body.i.preheader
	...
	b	.LBB23_6
	.p2align	4, , 16
.LBB23_5:                               # %Assert.exit13.i
                                        #   in Loop: Header=BB23_6 Depth=1
	ld.d	$s2, $s2, 0
	addi.w	$s4, $s4, -1
	beqz	$s4, .LBB23_8
.LBB23_6:                               # %while.body.i
                                        # =>This Inner Loop Header: Depth=1
	bnez	$s2, .LBB23_5
# %bb.7:                                # %if.then2.i11.i
                                        #   in Loop: Header=BB23_6 Depth=1
...
# %bb.15:                               # %while.end.i
	ori	$a2, $zero, 45
	beq	$a1, $a2, .LBB27_17
# %bb.16:                               # %while.end.i.while.cond11.i.preheader_crit_edge
	addi.d	$s0, $s0, -1
.LBB27_17:                              # %while.cond11.i.preheader
	addi.d	$s0, $s0, -1
	ori	$a1, $zero, 46
	.p2align	4, , 16
.LBB27_18:                              # %while.cond11.i
                                        # =>This Inner Loop Header: Depth=1
	ld.bu	$a2, $s0, 1
	addi.d	$s0, $s0, 1
	beq	$a2, $a1, .LBB27_18
# %bb.19:                               # %while.cond11.i
