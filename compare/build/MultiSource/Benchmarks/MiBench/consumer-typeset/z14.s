...
.LBB0_437:                              # %cond.end5481
	...
	ld.d	$a1, $a0, 24
	bne	$a1, $a0, .LBB0_439
.LBB0_438:                              # %if.end5521.sink.split
	pcaddu18i	$ra, %call36(DisposeObject)
	jirl	$ra, $ra, 0
.LBB0_439:                              # %if.end5521
	ld.w	$a0, $s0, 76
	...
	addi.w	$a1, $zero, -1
	blt	$a1, $a0, .LBB0_446
# %bb.440:                              # %land.lhs.true5527
	ld.d	$a1, $s4, 8
	beq	$a1, $s1, .LBB0_446
# %bb.441:                              # %if.then5536
	ld.d	$fp, $a1, 8
	.p2align	4, , 16
.LBB0_442:                              # %for.cond5546
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$fp, $fp, 16
	ld.bu	$a0, $fp, 32
	beqz	$a0, .LBB0_442
...
.LBB0_446:                              # %if.end5570
	...
	and	$a0, $a0, $a1
	beqz	$a0, .LBB0_453
# %bb.447:                              # %land.lhs.true5577
	ld.d	$a0, $s4, 8
	beq	$a0, $s1, .LBB0_453
# %bb.448:                              # %if.then5586
	ld.d	$fp, $s1, 0
	.p2align	4, , 16
.LBB0_449:                              # %for.cond5596
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$fp, $fp, 16
	ld.bu	$a0, $fp, 32
	beqz	$a0, .LBB0_449
...
# %bb.454:                              # %if.then5626
	...
	ld.d	$s1, $s4, 0
	.p2align	4, , 16
.LBB0_455:                              # %for.cond5635
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$s1, $s1, 16
	ld.bu	$a0, $s1, 32
	beqz	$a0, .LBB0_455
# %bb.456:                              # %for.cond5650.preheader
	ld.d	$fp, $s1, 8
	beq	$fp, $s1, .LBB0_477
# %bb.457:                              # %for.cond5657.preheader.preheader
	ori	$s0, $zero, 1
	ori	$s3, $zero, 9
	ori	$s4, $zero, 91
	b	.LBB0_460
	.p2align	4, , 16
.LBB0_458:                              # %cond.false5694
                                        #   in Loop: Header=BB0_460 Depth=1
	addi.d	$a0, $a0, -9
	bltu	$a0, $s4, .LBB0_465
.LBB0_459:                              # %for.inc5711
                                        #   in Loop: Header=BB0_460 Depth=1
	ld.d	$fp, $fp, 8
	beq	$fp, $s1, .LBB0_477
.LBB0_460:                              # %for.cond5657.preheader
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB0_461 Depth 2
	move	$s2, $fp
	.p2align	4, , 16
.LBB0_461:                              # %for.cond5657
...
.LBB0_465:                              # %if.end5720
	...
	move	$s4, $zero
	beq	$s8, $s1, .LBB0_478
.LBB0_466:                              # %for.cond5734.preheader.preheader
	ori	$fp, $zero, 1
	ori	$s3, $zero, 9
	ori	$s5, $zero, 90
	ori	$s6, $zero, 1
	b	.LBB0_469
	.p2align	4, , 16
.LBB0_467:                              # %cond.true5768
                                        #   in Loop: Header=BB0_469 Depth=1
	move	$a0, $s0
	pcaddu18i	$ra, %call36(SplitIsDefinite)
	jirl	$ra, $ra, 0
	bnez	$a0, .LBB0_483
.LBB0_468:                              # %for.inc5793
                                        #   in Loop: Header=BB0_469 Depth=1
	ld.d	$s8, $s8, 8
	beq	$s8, $s1, .LBB0_484
.LBB0_469:                              # %for.cond5734.preheader
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB0_470 Depth 2
	move	$s0, $s8
	.p2align	4, , 16
.LBB0_470:                              # %for.cond5734
                                        #   Parent Loop BB0_469 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$s0, $s0, 16
	ld.bu	$a0, $s0, 32
	beqz	$a0, .LBB0_470
...
.LBB0_482:                              # %if.end5923
	...
	b	.LBB0_526
.LBB0_483:                              # %if.then5785
	beqz	$s4, .LBB0_565
.LBB0_484:                              # %for.end5797
	beq	$s8, $s1, .LBB0_479
.LBB0_485:                              # %while.body5801.preheader
	ori	$s5, $zero, 9
	pcalau12i	$a0, %pc_hi20(.L.str)
	addi.d	$a0, $a0, %pc_lo12(.L.str)
	st.d	$a0, $sp, 304                   # 8-byte Folded Spill
...
.LBB0_486:                              #   in Loop: Header=BB0_488 Depth=1
	move	$s0, $s3
.LBB0_487:                              # %for.end5887
                                        #   in Loop: Header=BB0_488 Depth=1
	add.d	$s7, $fp, $s7
	move	$s2, $s3
	beq	$s8, $s1, .LBB0_480
.LBB0_488:                              # %while.body5801
                                        # =>This Loop Header: Depth=1
	...
	move	$s4, $zero
	beq	$s8, $s1, .LBB0_486
# %bb.489:                              # %for.cond5824.preheader.preheader
                                        #   in Loop: Header=BB0_488 Depth=1
	ori	$s2, $zero, 1
	b	.LBB0_492
	.p2align	4, , 16
.LBB0_490:                              # %cond.true5858
                                        #   in Loop: Header=BB0_492 Depth=2
	move	$a0, $s0
	pcaddu18i	$ra, %call36(SplitIsDefinite)
	jirl	$ra, $ra, 0
	bnez	$a0, .LBB0_500
.LBB0_491:                              # %for.inc5883
                                        #   in Loop: Header=BB0_492 Depth=2
	ld.d	$s8, $s8, 8
	beq	$s8, $s1, .LBB0_487
.LBB0_492:                              # %for.cond5824.preheader
                                        #   Parent Loop BB0_488 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB0_493 Depth 3
	move	$s0, $s8
	.p2align	4, , 16
.LBB0_493:                              # %for.cond5824
                                        #   Parent Loop BB0_488 Depth=1
...
.LBB0_502:
	...
	bne	$a2, $a0, .LBB0_436
	b	.LBB0_437
.LBB0_503:                              # %if.then2807
	st.w	$zero, $s0, 48
	ld.d	$a0, $sp, 176                   # 8-byte Folded Reload
	st.w	$a0, $s0, 56
	b	.LBB0_526
.LBB0_504:                              # %if.then2826
	pcalau12i	$a1, %got_pc_hi20(no_fpos)
	ld.d	$a1, $a1, %got_pc_lo12(no_fpos)
	ld.d	$a1, $a1, 0
	pcaddu18i	$ra, %call36(GetMemory)
...
.LBB0_515:                              # %cond.end5220
	...
	bne	$a1, $a0, .LBB0_439
	b	.LBB0_438
.LBB0_516:                              # %cond.end2884.thread
	pcalau12i	$a0, %got_pc_hi20(xx_tmp)
	ld.d	$a0, $a0, %got_pc_lo12(xx_tmp)
	st.d	$zero, $a0, 0
	st.d	$s1, $s2, 0
	st.d	$zero, $a5, 0
.LBB0_517:                              # %cond.end2917
	ld.bu	$a2, $s6, 0
	slli.d	$a0, $a2, 3
	ldx.d	$a0, $s8, $a0
	st.w	$a2, $fp, 0
...
.LBB0_526:                              # %if.end5923
	...
	ld.w	$a0, $a0, 0
	beqz	$a0, .LBB0_561
# %bb.527:                              # %land.lhs.true5925
	ld.bu	$a0, $s0, 32
	ori	$a1, $zero, 19
	bne	$a0, $a1, .LBB0_561
# %bb.528:                              # %for.cond5935.preheader
	ld.d	$s1, $s0, 8
	beq	$s1, $s0, .LBB0_561
# %bb.529:                              # %for.cond5942.preheader.preheader
	ori	$fp, $zero, 17
	ori	$s3, $zero, 1
	ori	$s4, $zero, 7
	pcalau12i	$a0, %got_pc_hi20(xx_tmp)
	...
	b	.LBB0_531
	.p2align	4, , 16
.LBB0_530:                              # %for.inc6461
                                        #   in Loop: Header=BB0_531 Depth=1
	ld.d	$s1, $s1, 8
	beq	$s1, $s0, .LBB0_561
.LBB0_531:                              # %for.cond5942.preheader
                                        # =>This Loop Header: Depth=1
...
# %bb.533:                              # %for.cond5942
                                        #   in Loop: Header=BB0_531 Depth=1
	bne	$a0, $fp, .LBB0_530
# %bb.534:                              # %for.cond5963.preheader
                                        #   in Loop: Header=BB0_531 Depth=1
	ld.d	$s8, $s7, 8
	bne	$s8, $s7, .LBB0_536
	b	.LBB0_530
	.p2align	4, , 16
.LBB0_535:                              # %for.inc6455
                                        #   in Loop: Header=BB0_536 Depth=2
	ld.d	$s8, $s8, 8
	beq	$s8, $s7, .LBB0_530
.LBB0_536:                              # %for.cond5970.preheader
                                        #   Parent Loop BB0_531 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB0_537 Depth 3
                                        #       Child Loop BB0_542 Depth 3
...
# %bb.538:                              # %for.cond5970
                                        #   in Loop: Header=BB0_536 Depth=2
	bne	$a1, $s3, .LBB0_535
# %bb.539:                              # %land.lhs.true5987
                                        #   in Loop: Header=BB0_536 Depth=2
	ld.hu	$a1, $a0, 46
	bnez	$a1, .LBB0_535
# %bb.540:                              # %land.lhs.true5993
                                        #   in Loop: Header=BB0_536 Depth=2
	ld.hu	$a0, $a0, 44
	srli.d	$a0, $a0, 13
	bltu	$a0, $s4, .LBB0_535
