...
.LBB3_8:                                # %cond.end
	...
	ld.d	$s6, $a3, %got_pc_lo12(zz_hold)
	ld.d	$a3, $a0, 8
	st.d	$a2, $a1, 0
	st.d	$a0, $s6, 0
	beq	$a3, $a0, .LBB3_10
...
.LBB3_10:                               # %cond.end78
	...
	ld.d	$a5, $a3, %got_pc_lo12(zz_lengths)
	addi.d	$a3, $a2, -11
	sltui	$a3, $a3, 2
	addi.d	$a4, $a0, 33
	...
	ld.d	$s8, $a3, %got_pc_lo12(zz_free)
...
.LBB3_23:                               # %if.end193
	...
	ld.d	$s0, $a0, %got_pc_lo12(OptGallSym)
	ori	$a0, $zero, 2
	st.b	$a0, $fp, 32
	st.d	$fp, $fp, 0
	ld.d	$a0, $s0, 0
...
# %bb.77:                               # %if.then974
	...
	ld.w	$a1, $sp, 112
	st.d	$zero, $sp, 8
	pcalau12i	$a3, %pc_hi20(.L.str.33)
	addi.d	$a5, $a3, %pc_lo12(.L.str.33)
	addi.d	$a3, $sp, 120
	st.d	$a1, $sp, 0
	move	$a1, $zero
	move	$a4, $s0
