...
.LBB1_23:                               #   in Loop: Header=BB1_13 Depth=1
	move	$a7, $t1
	move	$t0, $a6
.LBB1_24:                               # %for.body182.preheader663
                                        #   in Loop: Header=BB1_13 Depth=1
	alsl.d	$a6, $a7, $a1, 3
	.p2align	4, , 16
.LBB1_25:                               # %for.body182
...
.LBB1_429:                              # %vector.body612
	...
	addi.d	$a6, $a6, 16
	bnez	$a7, .LBB1_429
# %bb.430:                              # %middle.block618
	beq	$a3, $a4, .LBB1_434
.LBB1_431:                              # %for.body1257.preheader624
	alsl.d	$a3, $a2, $s2, 1
	alsl.d	$a4, $a2, $fp, 1
	sub.d	$a2, $s3, $a2
.LBB1_432:                              # %for.body1257
                                        # =>This Inner Loop Header: Depth=1
	ld.h	$a5, $a4, 0
	mul.w	$a5, $a0, $a5
	div.w	$a5, $a5, $a1
