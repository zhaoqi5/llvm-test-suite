...
.LBB0_3:                                # %if.end14
	...
	st.d	$a1, $a1, 8
	st.d	$a1, $a1, 0
	pcalau12i	$a0, %pc_hi20(file_type)
	addi.d	$fp, $a0, %pc_lo12(file_type)
	ld.bu	$a2, $s2, 17
	slli.d	$a0, $a2, 3
	ldx.d	$a0, $s0, $a0
	st.d	$a1, $fp, 0
...
.LBB0_36:                               # %if.end54
	...
	st.d	$a2, $a2, 8
	st.d	$a2, $a2, 0
	pcalau12i	$a0, %pc_hi20(file_path)
	addi.d	$fp, $a0, %pc_lo12(file_path)
	ld.bu	$a3, $s2, 17
	slli.d	$a0, $a3, 3
	ldx.d	$a0, $s0, $a0
	st.d	$a2, $fp, 0
...
.LBB12_3:                               # %if.else.i
	beq	$a0, $s4, .LBB12_6
# %bb.4:                                # %for.cond39.i.preheader
	move	$s4, $a0
	.p2align	4, , 16
.LBB12_5:                               # %for.cond39.i
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$s4, $s4, 16
	ld.bu	$a0, $s4, 32
	beqz	$a0, .LBB12_5
...
.LBB13_3:                               # %if.end
	...
	lu12i.w	$a1, 1023
	and	$a0, $a0, $a1
	pcalau12i	$a1, %got_pc_hi20(MsgCat)
	ld.d	$a1, $a1, %got_pc_lo12(MsgCat)
