...
.LBB5_2:                                # %PDF_SaveGraphicState.exit
	pcalau12i	$s5, %pc_hi20(currentfont)
	ld.w	$a1, $s5, %pc_lo12(currentfont)
	slli.d	$a2, $a0, 4
	alsl.d	$a0, $a0, $a2, 2
	pcalau12i	$a2, %pc_hi20(gs_stack)
	addi.d	$s6, $a2, %pc_lo12(gs_stack)
	...
	ld.w	$a0, $s8, %pc_lo12(cpexists)
	pcalau12i	$fp, %pc_hi20(currenty)
	ld.w	$a1, $fp, %pc_lo12(currenty)
	pcalau12i	$s1, %pc_hi20(currentxheight2)
	ld.h	$a2, $s1, %pc_lo12(currentxheight2)
	st.w	$a0, $a3, 8
	st.w	$a1, $a3, 12
	ld.d	$a1, $sp, 16                    # 8-byte Folded Reload
	or	$a0, $a1, $s2
...
.LBB5_6:                                # %PDF_SaveGraphicState.exit16
	...
	add.d	$a2, $s6, $a0
	stx.w	$a1, $s6, $a0
	ld.w	$a0, $s7, %pc_lo12(currentcolour)
	ld.w	$a1, $s8, %pc_lo12(cpexists)
	ld.w	$a3, $fp, %pc_lo12(currenty)
	ld.h	$a4, $s1, %pc_lo12(currentxheight2)
	st.w	$a0, $a2, 4
	st.w	$a1, $a2, 8
	st.w	$a3, $a2, 12
	st.h	$a4, $a2, 16
...
# %bb.0:                                # %entry
	...
	ld.w	$a3, $s3, %pc_lo12(currentfont)
	st.w	$a2, $a0, 0
	andi	$a0, $a1, 4095
...
.LBB15_30:                              # %sw.epilog
	...
	ld.d	$a0, $s4, %pc_lo12(out_fp)
	slli.d	$a1, $a1, 3
	pcalau12i	$a2, %got_pc_hi20(EightBitToPrintForm)
	ld.d	$s0, $a2, %got_pc_lo12(EightBitToPrintForm)
	ldx.d	$a1, $s0, $a1
	pcaddu18i	$ra, %call36(PDFPage_Write)
	jirl	$ra, $ra, 0
	ld.bu	$a1, $fp, 65
