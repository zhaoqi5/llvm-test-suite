...
.LBB4_31:                               # %if.end581
	...
	ld.d	$s8, $a1, %got_pc_lo12(StartSym)
	ld.d	$a1, $s8, 0
...
.LBB4_83:                               # %if.then170
	...
	ld.d	$s4, $a0, %got_pc_lo12(OldCrossDb)
	ld.d	$a0, $s4, 0
	beq	$s6, $a0, .LBB4_85
# %bb.84:                               # %if.then173
	addi.d	$a1, $sp, 616
...
.LBB6_15:                               # %cond.end129
	...
	ld.d	$s7, $a4, %got_pc_lo12(zz_lengths)
	add.d	$a1, $s7, $a1
	masknez	$a1, $a1, $a2
	maskeqz	$a2, $a3, $a2
	or	$a1, $a2, $a1
...
# %bb.46:                               # %while.body.preheader
	...
	pcalau12i	$a0, %got_pc_hi20(NewCrossDb)
	ld.d	$s3, $a0, %got_pc_lo12(NewCrossDb)
	pcalau12i	$a0, %got_pc_hi20(no_fpos)
