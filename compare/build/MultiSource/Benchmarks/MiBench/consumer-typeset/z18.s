...
# %bb.0:                                # %entry
	...
	st.d	$a1, $a0, 0
	pcalau12i	$a0, %pc_hi20(InitialEnvironment)
	st.d	$fp, $a0, %pc_lo12(InitialEnvironment)
	pcalau12i	$a0, %pc_hi20(InitialStyle)
	addi.d	$a0, $a0, %pc_lo12(InitialStyle)
	ld.hu	$a1, $a0, 0
	ori	$a2, $zero, 200
...
.LBB0_46:                               # %if.end666
	...
	slli.d	$a1, $a0, 3
	ldx.d	$a1, $s2, $a1
	pcalau12i	$s1, %pc_hi20(itop)
	st.w	$zero, $s1, %pc_lo12(itop)
	st.w	$a0, $s3, 0
	beqz	$a1, .LBB0_48
# %bb.47:                               # %if.else685
	st.d	$a1, $s8, 0
...
.LBB0_49:                               # %if.end694
	...
	st.d	$a1, $a1, 0
	slli.d	$a4, $a3, 3
	pcalau12i	$a0, %pc_hi20(targets)
	addi.d	$fp, $a0, %pc_lo12(targets)
	ld.bu	$a2, $s4, 0
	slli.d	$a0, $a2, 3
	ldx.d	$a0, $s2, $a0
	stx.d	$a1, $fp, $a4
...
.LBB2_13:                               # %cond.end189
	...
	ld.hu	$a2, $s3, 42
	ld.d	$a1, $sp, 72                    # 8-byte Folded Reload
	ld.w	$a4, $a1, %pc_lo12(itop)
	move	$a1, $a0
	bstrpick.d	$a3, $a2, 2, 2
	addi.d	$a6, $s3, 64
	pcalau12i	$a0, %pc_hi20(constraints)
	addi.d	$a0, $a0, %pc_lo12(constraints)
	alsl.d	$a7, $a4, $a0, 4
	st.d	$zero, $sp, 32
	addi.d	$a0, $sp, 88
	st.d	$a0, $sp, 24
