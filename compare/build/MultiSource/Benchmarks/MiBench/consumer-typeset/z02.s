...
# %bb.9:                                # %if.then14
	...
	ld.h	$a0, $a0, %pc_lo12(this_file)
	ld.d	$a1, $sp, 56                    # 8-byte Folded Reload
	ld.d	$a1, $a1, %pc_lo12(fp)
	ld.d	$a2, $sp, 40                    # 8-byte Folded Reload
	ld.h	$a2, $a2, %pc_lo12(ftype)
	...
	st.h	$a2, $a4, 72
	st.d	$a3, $a4, 80
	ld.w	$a0, $s3, %pc_lo12(offset)
	ld.w	$a1, $s5, %pc_lo12(first_line_num)
	ld.w	$a2, $s6, %pc_lo12(same_file)
	ld.d	$a3, $fp, %pc_lo12(mem_block)
	st.w	$a0, $a4, 88
	st.w	$a1, $a4, 92
	st.w	$a2, $a4, 96
	st.d	$a3, $a4, 112
...
.LBB2_12:                               # %if.end68
	...
	st.w	$a2, $s5, %pc_lo12(first_line_num)
...
.LBB5_129:                              # %if.end341
	...
	st.w	$a2, $a0, 36
	blez	$s2, .LBB5_135
# %bb.130:                              # %iter.check469
	ori	$a1, $zero, 16
	bltu	$s2, $a1, .LBB5_132
# %bb.131:                              # %vector.memcheck465
	sub.d	$a1, $a0, $s0
	addi.d	$a2, $a1, 64
	ori	$a1, $zero, 64
	bgeu	$a2, $a1, .LBB5_144
.LBB5_132:
	...
	move	$s4, $s8
	ld.d	$s8, $sp, 72                    # 8-byte Folded Reload
.LBB5_133:                              # %for.body385.preheader
	add.d	$a2, $a1, $a0
	addi.d	$a2, $a2, 64
	add.d	$a1, $s0, $a1
	sub.d	$a3, $a1, $s5
	.p2align	4, , 16
.LBB5_134:                              # %for.body385
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a4, $a1, 0
	st.b	$a4, $a2, 0
	addi.d	$a2, $a2, 1
...
.LBB5_138:                              # %vector.body506
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB5_138
# %bb.139:                              # %middle.block511
	beq	$s1, $a1, .LBB5_117
# %bb.140:                              # %vec.epilog.iter.check515
	beqz	$a2, .LBB5_114
.LBB5_141:                              # %vec.epilog.ph517
	move	$a4, $a1
	...
	addi.d	$a3, $a3, 64
	add.d	$a4, $s0, $a4
.LBB5_142:                              # %vec.epilog.vector.body520
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	vst	$vr0, $a3, 0
	addi.d	$a2, $a2, 16
	...
	addi.d	$a4, $a4, 16
	bnez	$a2, .LBB5_142
# %bb.143:                              # %vec.epilog.middle.block524
	beq	$s1, $a1, .LBB5_117
	b	.LBB5_114
...
# %bb.156:
	move	$a1, $zero
	b	.LBB5_189
.LBB5_157:                              # %vector.main.loop.iter.check440
	bgeu	$s3, $a1, .LBB5_182
# %bb.158:
	move	$a1, $zero
	b	.LBB5_186
.LBB5_159:                              # %vector.ph472
	andi	$a2, $s2, 48
...
.LBB5_160:                              # %vector.body475
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB5_160
# %bb.161:                              # %middle.block480
	ld.d	$s8, $sp, 72                    # 8-byte Folded Reload
	beq	$s2, $a1, .LBB5_136
# %bb.162:                              # %vec.epilog.iter.check484
	beqz	$a2, .LBB5_133
.LBB5_163:                              # %vec.epilog.ph486
	move	$a4, $a1
	...
	addi.d	$a3, $a3, 64
	add.d	$a4, $s0, $a4
.LBB5_164:                              # %vec.epilog.vector.body489
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	vst	$vr0, $a3, 0
	addi.d	$a2, $a2, 16
	...
	addi.d	$a4, $a4, 16
	bnez	$a2, .LBB5_164
# %bb.165:                              # %vec.epilog.middle.block493
	bne	$s2, $a1, .LBB5_133
	b	.LBB5_136
.LBB5_166:                              # %if.then849
	pcalau12i	$a0, %pc_hi20(file_pos)
...
# %bb.179:
	move	$a1, $zero
	b	.LBB5_211
.LBB5_180:                              # %vector.main.loop.iter.check409
	bgeu	$s1, $a1, .LBB5_194
# %bb.181:
	move	$a1, $zero
	b	.LBB5_198
.LBB5_182:                              # %vector.ph441
	andi	$a2, $s3, 48
...
.LBB5_183:                              # %vector.body444
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB5_183
# %bb.184:                              # %middle.block449
	beq	$s3, $a1, .LBB5_191
# %bb.185:                              # %vec.epilog.iter.check453
	beqz	$a2, .LBB5_189
.LBB5_186:                              # %vec.epilog.ph455
	move	$a4, $a1
	...
	add.d	$a4, $a4, $s0
	addi.d	$a4, $a4, 1
.LBB5_187:                              # %vec.epilog.vector.body458
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	vst	$vr0, $a3, 0
	addi.d	$a2, $a2, 16
	...
	addi.d	$a4, $a4, 16
	bnez	$a2, .LBB5_187
# %bb.188:                              # %vec.epilog.middle.block462
	beq	$s3, $a1, .LBB5_191
.LBB5_189:                              # %for.body813.preheader
	add.d	$a2, $a1, $a0
	addi.d	$a2, $a2, 64
	add.d	$a1, $a1, $s0
	addi.d	$a1, $a1, 1
...
.LBB5_195:                              # %vector.body413
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB5_195
# %bb.196:                              # %middle.block418
	beq	$s1, $a1, .LBB5_203
# %bb.197:                              # %vec.epilog.iter.check422
	beqz	$a2, .LBB5_201
.LBB5_198:                              # %vec.epilog.ph424
	move	$a4, $a1
	bstrpick.d	$a1, $s1, 62, 4
	slli.d	$a1, $a1, 4
	sub.d	$a2, $a4, $a1
	...
	add.d	$a4, $a4, $s0
	addi.d	$a4, $a4, 1
.LBB5_199:                              # %vec.epilog.vector.body427
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	vst	$vr0, $a3, 0
	addi.d	$a2, $a2, 16
	...
	addi.d	$a4, $a4, 16
	bnez	$a2, .LBB5_199
# %bb.200:                              # %vec.epilog.middle.block431
	beq	$s1, $a1, .LBB5_203
.LBB5_201:                              # %for.body905.preheader
	add.d	$a2, $a1, $a0
	addi.d	$a2, $a2, 64
	add.d	$a1, $a1, $s0
	addi.d	$a1, $a1, 1
	sub.d	$a3, $a1, $s2
.LBB5_202:                              # %for.body905
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a4, $a1, 0
	st.b	$a4, $a2, 0
	addi.d	$a2, $a2, 1
