...
.LBB5_118:                              # %cond.end430
	...
	st.d	$a1, $a2, %pc_lo12(next_token)
	b	.LBB5_189
.LBB5_119:                              # %vector.main.loop.iter.check522
	bgeu	$s1, $a1, .LBB5_136
# %bb.120:
	move	$a1, $zero
	b	.LBB5_140
...
.LBB5_128:                              # %if.end341
	...
	st.w	$a2, $a0, 36
	blt	$s2, $a1, .LBB5_134
# %bb.129:                              # %iter.check488
	ori	$a1, $zero, 16
	bltu	$s2, $a1, .LBB5_131
# %bb.130:                              # %vector.memcheck484
	sub.d	$a1, $a0, $s0
	addi.d	$a2, $a1, 64
	ori	$a1, $zero, 64
	bgeu	$a2, $a1, .LBB5_146
...
.LBB5_135:                              # %for.end393
	...
	st.b	$zero, $a1, 64
	b	.LBB5_189
.LBB5_136:                              # %vector.ph523
	bstrpick.d	$a1, $s1, 62, 6
	slli.d	$a1, $a1, 6
	addi.d	$a2, $a0, 96
	addi.d	$a3, $s0, 32
	move	$a4, $a1
.LBB5_137:                              # %vector.body526
                                        # =>This Inner Loop Header: Depth=1
	xvld	$xr0, $a3, -32
	xvld	$xr1, $a3, 0
	xvst	$xr0, $a2, -32
	...
	addi.d	$a3, $a3, 64
	bnez	$a4, .LBB5_137
# %bb.138:                              # %middle.block531
	beq	$s1, $a1, .LBB5_145
# %bb.139:                              # %vec.epilog.iter.check536
	andi	$a2, $s1, 48
	beqz	$a2, .LBB5_143
.LBB5_140:                              # %vec.epilog.ph535
	move	$a4, $a1
	...
	addi.d	$a3, $a3, 64
	add.d	$a4, $s0, $a4
.LBB5_141:                              # %vec.epilog.vector.body541
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	vst	$vr0, $a3, 0
	addi.d	$a2, $a2, 16
	...
	addi.d	$a4, $a4, 16
	bnez	$a2, .LBB5_141
# %bb.142:                              # %vec.epilog.middle.block545
	beq	$s1, $a1, .LBB5_145
...
.LBB5_145:                              # %for.end
	...
	st.b	$zero, $a1, 64
	b	.LBB5_189
.LBB5_146:                              # %vector.main.loop.iter.check490
	bgeu	$s2, $a1, .LBB5_163
# %bb.147:
	move	$a1, $zero
	b	.LBB5_167
...
.LBB5_153:                              # %if.end768
	...
	st.w	$a2, $a0, 36
	blt	$s3, $a1, .LBB5_159
# %bb.154:                              # %iter.check456
	ori	$a1, $zero, 16
	bltu	$s3, $a1, .LBB5_156
# %bb.155:                              # %vector.memcheck446
	sub.d	$a1, $a0, $s0
	addi.d	$a2, $a1, 63
	ori	$a1, $zero, 64
	bgeu	$a2, $a1, .LBB5_161
...
.LBB5_160:                              # %for.end821
	...
	ld.d	$s7, $sp, 56                    # 8-byte Folded Reload
	b	.LBB5_188
.LBB5_161:                              # %vector.main.loop.iter.check458
	bgeu	$s3, $a1, .LBB5_194
# %bb.162:
	move	$a1, $zero
	b	.LBB5_198
.LBB5_163:                              # %vector.ph491
	bstrpick.d	$a1, $s2, 62, 6
	slli.d	$a1, $a1, 6
	addi.d	$a2, $a0, 96
	addi.d	$a3, $s0, 32
	move	$a4, $a1
.LBB5_164:                              # %vector.body494
                                        # =>This Inner Loop Header: Depth=1
	xvld	$xr0, $a3, -32
	xvld	$xr1, $a3, 0
	xvst	$xr0, $a2, -32
	...
	addi.d	$a3, $a3, 64
	bnez	$a4, .LBB5_164
# %bb.165:                              # %middle.block499
	beq	$s2, $a1, .LBB5_135
# %bb.166:                              # %vec.epilog.iter.check504
	andi	$a2, $s2, 48
	beqz	$a2, .LBB5_132
.LBB5_167:                              # %vec.epilog.ph503
	move	$a4, $a1
	...
	addi.d	$a3, $a3, 64
	add.d	$a4, $s0, $a4
.LBB5_168:                              # %vec.epilog.vector.body509
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	vst	$vr0, $a3, 0
	addi.d	$a2, $a2, 16
	...
	addi.d	$a4, $a4, 16
	bnez	$a2, .LBB5_168
# %bb.169:                              # %vec.epilog.middle.block513
	beq	$s2, $a1, .LBB5_135
	b	.LBB5_132
.LBB5_170:                              # %if.then849
	pcalau12i	$a0, %pc_hi20(file_pos)
...
.LBB5_171:                              # %if.end860
	...
	ld.d	$s7, $sp, 56                    # 8-byte Folded Reload
	blt	$s1, $a1, .LBB5_177
# %bb.172:                              # %iter.check418
	ori	$a1, $zero, 16
	bltu	$s1, $a1, .LBB5_174
# %bb.173:                              # %vector.memcheck408
	sub.d	$a1, $a0, $s0
	addi.d	$a2, $a1, 63
	ori	$a1, $zero, 64
	bgeu	$a2, $a1, .LBB5_192
...
.LBB5_191:                              # %if.end1088
	...
	addi.d	$sp, $sp, 192
	ret
.LBB5_192:                              # %vector.main.loop.iter.check420
	bgeu	$s1, $a1, .LBB5_203
# %bb.193:
	move	$a1, $zero
	b	.LBB5_207
.LBB5_194:                              # %vector.ph459
	bstrpick.d	$a1, $s3, 62, 6
	slli.d	$a1, $a1, 6
	addi.d	$a2, $a0, 96
	addi.d	$a3, $s0, 33
	move	$a4, $a1
.LBB5_195:                              # %vector.body462
                                        # =>This Inner Loop Header: Depth=1
	xvld	$xr0, $a3, -32
	xvld	$xr1, $a3, 0
	xvst	$xr0, $a2, -32
	...
	addi.d	$a3, $a3, 64
	bnez	$a4, .LBB5_195
# %bb.196:                              # %middle.block467
	beq	$s3, $a1, .LBB5_160
# %bb.197:                              # %vec.epilog.iter.check472
	andi	$a2, $s3, 48
	beqz	$a2, .LBB5_157
.LBB5_198:                              # %vec.epilog.ph471
	move	$a4, $a1
	...
	add.d	$a4, $a4, $s0
	addi.d	$a4, $a4, 1
.LBB5_199:                              # %vec.epilog.vector.body477
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	vst	$vr0, $a3, 0
	addi.d	$a2, $a2, 16
	...
	addi.d	$a4, $a4, 16
	bnez	$a2, .LBB5_199
# %bb.200:                              # %vec.epilog.middle.block481
	beq	$s3, $a1, .LBB5_160
	b	.LBB5_157
...
# %bb.202:
	move	$a1, $zero
	b	.LBB5_214
.LBB5_203:                              # %vector.ph421
	bstrpick.d	$a1, $s1, 62, 6
	slli.d	$a1, $a1, 6
	addi.d	$a2, $a0, 96
	addi.d	$a3, $s0, 33
	move	$a4, $a1
.LBB5_204:                              # %vector.body424
                                        # =>This Inner Loop Header: Depth=1
	xvld	$xr0, $a3, -32
	xvld	$xr1, $a3, 0
	xvst	$xr0, $a2, -32
	...
	addi.d	$a3, $a3, 64
	bnez	$a4, .LBB5_204
# %bb.205:                              # %middle.block429
	beq	$s1, $a1, .LBB5_178
# %bb.206:                              # %vec.epilog.iter.check434
	andi	$a2, $s1, 48
	beqz	$a2, .LBB5_175
.LBB5_207:                              # %vec.epilog.ph433
	move	$a4, $a1
	bstrpick.d	$a1, $s1, 62, 4
	slli.d	$a1, $a1, 4
	sub.d	$a2, $a4, $a1
	...
	add.d	$a4, $a4, $s0
	addi.d	$a4, $a4, 1
.LBB5_208:                              # %vec.epilog.vector.body439
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	vst	$vr0, $a3, 0
	addi.d	$a2, $a2, 16
	...
	addi.d	$a4, $a4, 16
	bnez	$a2, .LBB5_208
# %bb.209:                              # %vec.epilog.middle.block443
	beq	$s1, $a1, .LBB5_178
	b	.LBB5_175
.LBB5_210:                              # %vector.ph
	bstrpick.d	$a1, $s3, 62, 6
