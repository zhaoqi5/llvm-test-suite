...
# %bb.125:                              # %cond.false1799
	...
	st.d	$a1, $a1, 24
	st.d	$a1, $a1, 16
.LBB2_126:                              # %cond.end1821
                                        #   in Loop: Header=BB2_124 Depth=3
	ld.d	$a2, $a1, 8
	st.d	$a1, $s6, 0
	beq	$a2, $a1, .LBB2_123
# %bb.127:                              # %cond.false1829
                                        #   in Loop: Header=BB2_124 Depth=3
	st.d	$a2, $s1, 0
	ld.d	$a1, $a1, 0
	st.d	$a1, $a2, 0
...
.LBB2_128:                              # %cond.end1952
	...
	slli.d	$a1, $a1, 3
	stx.d	$a2, $s2, $a1
.LBB2_129:                              # %while.cond1884.preheader
                                        #   Parent Loop BB2_7 Depth=1
                                        #     Parent Loop BB2_99 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$a1, $s4, 8
	beq	$a1, $s4, .LBB2_134
# %bb.130:                              # %while.body1890
                                        #   in Loop: Header=BB2_129 Depth=3
	ld.d	$a2, $a1, 24
	st.d	$a1, $a5, 0
	beq	$a2, $a1, .LBB2_132
# %bb.131:                              # %cond.false1900
                                        #   in Loop: Header=BB2_129 Depth=3
	ld.d	$a3, $a1, 16
	st.d	$a2, $s1, 0
	st.d	$a3, $a2, 16
	...
	st.d	$a1, $a1, 24
	st.d	$a1, $a1, 16
.LBB2_132:                              # %cond.end1922
                                        #   in Loop: Header=BB2_129 Depth=3
	ld.d	$a2, $a1, 8
	st.d	$a1, $s6, 0
	beq	$a2, $a1, .LBB2_128
# %bb.133:                              # %cond.false1930
                                        #   in Loop: Header=BB2_129 Depth=3
	st.d	$a2, $s1, 0
	ld.d	$a1, $a1, 0
	st.d	$a1, $a2, 0
