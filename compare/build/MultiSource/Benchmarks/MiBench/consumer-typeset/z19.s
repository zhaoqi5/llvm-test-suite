...
# %bb.4:
	...
	ld.d	$s7, $a0, %got_pc_lo12(InputSym)
	ori	$s8, $zero, 121
	b	.LBB1_7
	.p2align	4, , 16
.LBB1_5:                                # %sw.epilog
...
# %bb.39:                               # %sw.bb80.us
	...
	ld.d	$a0, $sp, 16                    # 8-byte Folded Reload
	beqz	$a0, .LBB1_31
# %bb.40:                               # %land.lhs.true82.us
                                        #   in Loop: Header=BB1_34 Depth=1
	ld.d	$a0, $s2, 80
	ld.bu	$a1, $a0, 32
	bne	$a1, $a2, .LBB1_31
# %bb.41:                               # %land.lhs.true89.us
                                        #   in Loop: Header=BB1_34 Depth=1
	ld.d	$a0, $a0, 80
	move	$a1, $s1
	pcaddu18i	$ra, %call36(SearchUses)
	...
	ori	$a2, $zero, 2
	bnez	$a0, .LBB1_43
# %bb.42:                               # %land.lhs.true89.us
                                        #   in Loop: Header=BB1_34 Depth=1
	bnez	$fp, .LBB1_32
.LBB1_43:                               # %sw.epilog.us
                                        #   in Loop: Header=BB1_34 Depth=1
	sltu	$a0, $zero, $a0
	maskeqz	$s2, $s2, $a0
	beqz	$s2, .LBB1_33
