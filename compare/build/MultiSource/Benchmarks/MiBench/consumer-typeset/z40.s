...
# %bb.0:                                # %entry
	...
	slli.d	$a0, $a2, 3
	ldx.d	$a0, $a1, $a0
	pcalau12i	$a4, %pc_hi20(filter_count)
	st.w	$zero, $a4, %pc_lo12(filter_count)
	st.w	$a2, $a3, 0
	beqz	$a0, .LBB0_2
# %bb.1:                                # %if.else7
...
# %bb.0:                                # %entry
	...
	ld.d	$s5, $a4, %got_pc_lo12(zz_free)
	pcalau12i	$a4, %got_pc_hi20(zz_size)
	ld.d	$a5, $a4, %got_pc_lo12(zz_size)
	slli.d	$a4, $a3, 3
	ldx.d	$fp, $s5, $a4
	move	$s1, $a2
	move	$s2, $a0
...
.LBB3_4:                                # %if.end9
	pcalau12i	$a0, %got_pc_hi20(FilterInSym)
	ld.d	$a0, $a0, %got_pc_lo12(FilterInSym)
	pcalau12i	$a1, %got_pc_hi20(SafeExecution)
	ld.d	$a1, $a1, %got_pc_lo12(SafeExecution)
	pcalau12i	$a2, %pc_hi20(filter_in_filename)
	ld.d	$a2, $a2, %pc_lo12(filter_in_filename)
	ld.d	$a0, $a0, 0
	ld.w	$a1, $a1, 0
	st.d	$a2, $a0, 56
	beqz	$a1, .LBB3_6
