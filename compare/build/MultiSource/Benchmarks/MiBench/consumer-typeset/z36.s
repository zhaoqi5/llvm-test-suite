...
# %bb.13:                               # %while.body.preheader
	...
	addi.d	$s1, $a0, %pc_lo12(tex_codes)
...
# %bb.3:                                # %for.cond6.preheader.lr.ph
	...
	st.d	$a0, $sp, 64                    # 8-byte Folded Spill
	pcalau12i	$a0, %pc_hi20(TriedFile)
	addi.d	$a0, $a0, %pc_lo12(TriedFile)
...
# %bb.54:                               # %do.cond
	...
	beq	$a3, $a2, .LBB2_53
	b	.LBB2_35
.LBB2_55:                               # %for.cond711.preheader
                                        #   in Loop: Header=BB2_36 Depth=2
	add.d	$a0, $a1, $a0
	ld.bu	$s0, $a0, 1
	beqz	$s0, .LBB2_60
# %bb.56:                               # %for.body715.preheader
                                        #   in Loop: Header=BB2_36 Depth=2
	addi.d	$s5, $sp, 96
	b	.LBB2_58
	.p2align	4, , 16
...
# %bb.71:                               # %if.then791
	...
	ld.bu	$a1, $a0, 256
	bne	$a1, $fp, .LBB2_69
# %bb.72:                               # %while.body804.preheader
                                        #   in Loop: Header=BB2_70 Depth=2
	addi.d	$a0, $a0, 256
	.p2align	4, , 16
.LBB2_73:                               # %while.body804
                                        #   Parent Loop BB2_7 Depth=1
...
# %bb.76:                               # %land.lhs.true811
	...
	move	$a1, $a2
	bnez	$a2, .LBB2_74
.LBB2_77:                               # %while.end822
                                        #   in Loop: Header=BB2_73 Depth=3
	beqz	$a2, .LBB2_68
# %bb.78:                               # %while.cond831.preheader
                                        #   in Loop: Header=BB2_73 Depth=3
	addi.d	$a0, $s0, -1
	pcaddu18i	$ra, %call36(strlen)
	jirl	$ra, $ra, 0
...
# %bb.87:                               # %cond.end993
	...
	bnez	$a0, .LBB2_89
	b	.LBB2_90
.LBB2_88:                               # %cond.end993.thread
                                        #   in Loop: Header=BB2_80 Depth=2
	st.d	$s4, $s5, 0
.LBB2_89:                               # %cond.false1002
                                        #   in Loop: Header=BB2_80 Depth=2
	ld.d	$a1, $s4, 16
...
# %bb.97:                               # %cond.end1172
	...
	st.d	$s4, $s5, 0
	beqz	$a1, .LBB2_101
# %bb.98:                               # %cond.end1172.cond.false1181_crit_edge
                                        #   in Loop: Header=BB2_80 Depth=2
	ld.d	$a0, $a1, 16
	b	.LBB2_100
.LBB2_99:                               # %cond.end1172.thread
                                        #   in Loop: Header=BB2_80 Depth=2
	st.d	$s4, $s5, 0
	move	$a1, $a0
.LBB2_100:                              # %cond.false1181
                                        #   in Loop: Header=BB2_80 Depth=2
	ld.d	$a2, $s4, 16
	pcalau12i	$a3, %got_pc_hi20(zz_tmp)
	ld.d	$a3, $a3, %got_pc_lo12(zz_tmp)
...
.LBB2_107:                              # %for.inc1317.thread
	...
	blt	$s3, $s7, .LBB2_80
	b	.LBB2_109
.LBB2_108:                              # %for.end1318
                                        #   in Loop: Header=BB2_7 Depth=1
	andi	$a0, $a0, 1
	bnez	$a0, .LBB2_6
.LBB2_109:                              # %if.then1320
                                        #   in Loop: Header=BB2_7 Depth=1
	move	$a0, $s2
	pcaddu18i	$ra, %call36(FontWordSize)
	jirl	$ra, $ra, 0
...
.LBB2_111:                              # %if.end201
	...
	st.d	$a0, $s6, 0
	pcalau12i	$a2, %got_pc_hi20(zz_hold)
	ld.d	$s7, $a2, %got_pc_lo12(zz_hold)
	st.d	$a1, $s7, 0
	beqz	$a1, .LBB2_113
# %bb.112:                              # %cond.end246
                                        #   in Loop: Header=BB2_7 Depth=1
	...
	bnez	$a0, .LBB2_114
	b	.LBB2_115
.LBB2_113:                              # %cond.end246.thread
                                        #   in Loop: Header=BB2_7 Depth=1
	st.d	$s4, $s7, 0
.LBB2_114:                              # %cond.false255
                                        #   in Loop: Header=BB2_7 Depth=1
	ld.d	$a1, $s4, 16
	pcalau12i	$a2, %got_pc_hi20(zz_tmp)
	ld.d	$a2, $a2, %got_pc_lo12(zz_tmp)
...
# %bb.122:                              # %cond.end422
	...
	st.d	$s4, $s7, 0
	beqz	$a1, .LBB2_126
# %bb.123:                              # %cond.end422.cond.false431_crit_edge
                                        #   in Loop: Header=BB2_7 Depth=1
	ld.d	$a0, $a1, 16
	b	.LBB2_125
.LBB2_124:                              # %cond.end422.thread
                                        #   in Loop: Header=BB2_7 Depth=1
	st.d	$s4, $s7, 0
	move	$a1, $a0
.LBB2_125:                              # %cond.false431
                                        #   in Loop: Header=BB2_7 Depth=1
	ld.d	$a2, $s4, 16
	pcalau12i	$a3, %got_pc_hi20(zz_tmp)
	ld.d	$a3, $a3, %got_pc_lo12(zz_tmp)
...
.LBB2_132:                              # %cond.end560
	...
	ld.d	$s1, $s1, 8
	ld.d	$s4, $sp, 40                    # 8-byte Folded Reload
.LBB2_133:                              # %for.inc1325
                                        #   in Loop: Header=BB2_7 Depth=1
	ori	$s6, $zero, 2
.LBB2_134:                              # %for.inc1325
                                        #   in Loop: Header=BB2_7 Depth=1
	lu12i.w	$fp, 14
	b	.LBB2_6
.LBB2_135:                              # %for.end1329
	move	$a0, $s4
	lu12i.w	$a1, 1
	ori	$a1, $a1, 208
	add.d	$sp, $sp, $a1
...
.LBB3_32:
	...
	ld.bu	$a1, $sp, 536
	bnez	$a1, .LBB3_19
.LBB3_33:                               # %for.end50.if.then59_crit_edge
	ld.d	$s4, $fp, 264
	move	$a0, $zero
	slli.d	$s0, $a0, 1
	ldx.hu	$a0, $s4, $s0
