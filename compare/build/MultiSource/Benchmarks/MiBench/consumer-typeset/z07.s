...
.LBB5_37:                               # %if.end763
	...
	ld.d	$s8, $a0, 8
	beq	$s8, $a0, .LBB5_50
# %bb.38:                               # %for.cond788.preheader.preheader
	pcalau12i	$a0, %got_pc_hi20(no_fpos)
	ld.d	$a0, $a0, %got_pc_lo12(no_fpos)
...
.LBB5_52:                               # %if.end423
	...
	ld.d	$s0, $a1, 8
	beq	$s0, $a1, .LBB5_62
# %bb.53:                               # %for.cond450.preheader.preheader
	pcalau12i	$a0, %got_pc_hi20(no_fpos)
	ld.d	$a0, $a0, %got_pc_lo12(no_fpos)
	st.d	$a0, $sp, 40                    # 8-byte Folded Spill
	pcalau12i	$a0, %got_pc_hi20(xx_link)
...
# %bb.92:                               # %middle.block
	...
	move	$a6, $t0
	beq	$a2, $a3, .LBB7_95
.LBB7_93:                               # %for.body316.preheader657
	slli.d	$a3, $a1, 5
	ori	$a2, $zero, 2104
	add.d	$a2, $sp, $a2
	add.d	$a2, $a2, $a3
...
# %bb.99:                               # %for.body346.us.us.preheader
	...
	b	.LBB7_109
	.p2align	4, , 16
.LBB7_100:                              # %if.then404.us441
                                        #   in Loop: Header=BB7_103 Depth=2
	ld.b	$a5, $a1, -33
	addi.d	$a5, $a5, 1
	st.b	$a5, $a1, 0
	ori	$a5, $zero, 3
.LBB7_101:                              # %for.inc465.us445
                                        #   in Loop: Header=BB7_103 Depth=2
	st.b	$a5, $a2, 0
.LBB7_102:                              # %for.inc465.us445
                                        #   in Loop: Header=BB7_103 Depth=2
	addi.d	$a4, $a4, -1
	addi.d	$a3, $a3, 8
	addi.d	$a2, $a2, 1
...
# %bb.104:                              # %if.else420.us432
	...
	ld.b	$a6, $a1, -1
	bge	$a6, $a5, .LBB7_106
# %bb.105:                              # %if.then435.us439
                                        #   in Loop: Header=BB7_103 Depth=2
	st.b	$a5, $a1, 0
	st.b	$s3, $a2, 0
	b	.LBB7_102
	.p2align	4, , 16
.LBB7_106:                              # %if.else449.us437
                                        #   in Loop: Header=BB7_103 Depth=2
	st.b	$a6, $a1, 0
	ori	$a5, $zero, 2
	b	.LBB7_101
