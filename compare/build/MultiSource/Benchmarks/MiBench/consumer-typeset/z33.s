...
.LBB5_81:                               # %while.end471
	...
	ori	$a0, $zero, 1
	bne	$s0, $a0, .LBB5_84
# %bb.82:                               #   in Loop: Header=BB5_68 Depth=1
...
# %bb.99:                               # %while.body403
	...
	ori	$a2, $zero, 48
	bne	$a0, $a2, .LBB5_101
# %bb.100:                              # %while.body403
                                        #   in Loop: Header=BB5_68 Depth=1
	ld.bu	$a0, $sp, 637
	beq	$a0, $a2, .LBB5_68
.LBB5_101:                              # %while.end670.thread
	ld.bu	$a0, $s3, 43
	beqz	$a0, .LBB5_107
# %bb.102:                              # %if.else679
	move	$a0, $s7
...
.LBB6_51:                               # %while.body.lr.ph.i
	addi.d	$s1, $a0, -2
	pcalau12i	$a0, %got_pc_hi20(UseCollate)
	ld.d	$s2, $a0, %got_pc_lo12(UseCollate)
	ld.w	$a0, $s2, 0
	beqz	$a0, .LBB6_58
...
.LBB6_57:                               # %if.else.i
	...
	bge	$a1, $a0, .LBB6_54
	b	.LBB6_60
.LBB6_58:                               # %while.body.us.i.preheader
	move	$fp, $zero
	.p2align	4, , 16
.LBB6_59:                               # %while.body.us.i
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a0, $fp, $s1
	bstrpick.d	$a1, $a0, 31, 31
	add.w	$a0, $a0, $a1
...
.LBB6_60:                               # %while.end.i
	...
	ld.d	$a1, $sp, 80                    # 8-byte Folded Reload
	beqz	$a0, .LBB6_63
.LBB6_61:                               # %SearchLines.exit.thread
	move	$a0, $zero
.LBB6_62:
