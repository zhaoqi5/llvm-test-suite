...
# %bb.0:                                # %entry
	...
	ld.wu	$a1, $s2, 40
	st.w	$a0, $a3, 0
	pcalau12i	$fp, %pc_hi20(currentfont)
	ld.w	$a2, $fp, %pc_lo12(currentfont)
	andi	$a0, $a1, 4095
...
# %bb.1:                                # %if.then
	...
	ld.w	$a2, $fp, %pc_lo12(currentfont)
	st.h	$a0, $s4, %pc_lo12(currentxheight2)
	move	$a0, $a2
	pcaddu18i	$ra, %call36(FontSize)
	jirl	$ra, $ra, 0
	ld.w	$a1, $fp, %pc_lo12(currentfont)
	move	$s3, $a0
	move	$a0, $a1
	pcaddu18i	$ra, %call36(FontName)
	jirl	$ra, $ra, 0
	...
	pcaddu18i	$ra, %call36(fprintf)
	jirl	$ra, $ra, 0
	ld.w	$a0, $s1, %pc_lo12(wordcount)
	ld.d	$a1, $s5, %pc_lo12(out_fp)
	addi.d	$a2, $a0, 1
	ori	$a3, $zero, 4
	st.w	$a2, $s1, %pc_lo12(wordcount)
	blt	$a0, $a3, .LBB17_3
# %bb.2:                                # %if.then11
	ori	$a0, $zero, 10
	pcaddu18i	$ra, %call36(putc)
	jirl	$ra, $ra, 0
	st.w	$zero, $s1, %pc_lo12(wordcount)
	b	.LBB17_4
.LBB17_3:                               # %if.else
	ori	$a0, $zero, 32
	pcaddu18i	$ra, %call36(putc)
...
.LBB17_23:                              #   in Loop: Header=BB17_16 Depth=2
	...
	ld.bu	$a2, $fp, 1
	beqz	$a2, .LBB17_25
.LBB17_24:                              # %while.cond88.preheader
                                        #   in Loop: Header=BB17_16 Depth=2
	addi.d	$a0, $fp, 1
	pcaddu18i	$ra, %call36(strlen)
	jirl	$ra, $ra, 0
...
.LBB17_48:                              # %while.body.i
	...
	addi.d	$fp, $fp, 6
	bnez	$a0, .LBB17_48
# %bb.49:                               # %PrintComposite.exit.loopexit
	ld.bu	$a1, $s3, 0
	ld.d	$s2, $sp, 56                    # 8-byte Folded Reload
.LBB17_50:                              # %PrintComposite.exit
	ld.wu	$a0, $s2, 40
...
.LBB17_68:                              # %while.body.i115
	...
	addi.d	$fp, $fp, 6
	bnez	$a0, .LBB17_68
# %bb.69:                               # %PrintComposite.exit125.loopexit
                                        #   in Loop: Header=BB17_59 Depth=1
	ld.bu	$a1, $s6, 0
	ld.d	$s2, $sp, 56                    # 8-byte Folded Reload
.LBB17_70:                              # %PrintComposite.exit125
                                        #   in Loop: Header=BB17_59 Depth=1
	ld.wu	$a0, $s2, 40
	ld.d	$a2, $sp, 104                   # 8-byte Folded Reload
	ld.d	$a2, $a2, 0
