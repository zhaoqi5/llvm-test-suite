...
# %bb.1:                                # %lor.lhs.false
	...
	bne	$a0, $a2, .LBB3_5
# %bb.2:                                # %lor.lhs.false2
	ld.w	$a2, $s7, %pc_lo12(currentcolour)
...
# %bb.3:                                # %if.else
	...
	pcalau12i	$a6, %pc_hi20(cpexists)
	ld.w	$a7, $a6, %pc_lo12(cpexists)
	add.d	$a4, $a5, $a4
	st.w	$a7, $a4, 28
	pcalau12i	$a7, %pc_hi20(currenty)
	ld.w	$a7, $a7, %pc_lo12(currenty)
	pcalau12i	$t0, %pc_hi20(currentxheight2)
	ld.h	$t0, $t0, %pc_lo12(currentxheight2)
	st.w	$a0, $a4, 20
	st.w	$a1, $a4, 24
	st.w	$a7, $a4, 32
	st.h	$t0, $a4, 36
	st.w	$zero, $a6, %pc_lo12(cpexists)
	addi.w	$a3, $a3, 2
	mul.d	$a2, $a3, $a2
	add.d	$a4, $a5, $a2
	stx.w	$a0, $a5, $a2
	...
	st.w	$a3, $s5, %pc_lo12(gs_stack_top)
	add.w	$s5, $a2, $s2
	add.w	$s6, $s3, $a4
	beqz	$a0, .LBB3_11
# %bb.4:                                # %cond.false
	...
	b	.LBB3_12
.LBB3_5:                                # %if.then
	pcalau12i	$s6, %pc_hi20(out_fp)
	ld.d	$a3, $s6, %pc_lo12(out_fp)
...
.LBB3_7:                                # %PS_SaveGraphicState.exit
	...
	ld.w	$a2, $s1, %pc_lo12(currenty)
	pcalau12i	$s7, %pc_hi20(currentxheight2)
	ld.h	$a4, $s7, %pc_lo12(currentxheight2)
	ld.d	$a0, $s6, %pc_lo12(out_fp)
	st.w	$a1, $a3, 8
	st.w	$a2, $a3, 12
	st.h	$a4, $a3, 16
...
.LBB3_9:                                # %PS_SaveGraphicState.exit29
	...
	ld.w	$a0, $a0, %pc_lo12(currentcolour)
	ld.w	$a1, $s0, %pc_lo12(cpexists)
	ld.w	$a3, $s1, %pc_lo12(currenty)
	ld.h	$a4, $s7, %pc_lo12(currentxheight2)
	st.w	$a0, $a2, 4
	st.w	$a1, $a2, 8
	st.w	$a3, $a2, 12
...
.LBB4_2:                                # %if.end
	...
	ld.w	$a1, $a1, %pc_lo12(cpexists)
	pcalau12i	$a2, %pc_hi20(currenty)
	ld.w	$a2, $a2, %pc_lo12(currenty)
	pcalau12i	$a4, %pc_hi20(currentxheight2)
	ld.h	$a4, $a4, %pc_lo12(currentxheight2)
	st.w	$a0, $a3, 4
	st.w	$a1, $a3, 8
	st.w	$a2, $a3, 12
	st.h	$a4, $a3, 16
...
# %bb.0:                                # %entry
	...
	pcalau12i	$a0, %pc_hi20(cpexists)
	st.w	$zero, $a0, %pc_lo12(cpexists)
	pcalau12i	$a0, %pc_hi20(pagecount)
	st.w	$zero, $a0, %pc_lo12(pagecount)
	pcalau12i	$a0, %pc_hi20(wordcount)
	st.w	$zero, $a0, %pc_lo12(wordcount)
...
# %bb.62:                               # %if.then374
	...
	addi.d	$a3, $a0, %pc_lo12(.L.str.185)
	ld.bu	$a0, $s6, 0
	maskeqz	$a1, $a3, $a1
	or	$s1, $a1, $a2
	.p2align	4, , 16
...
# %bb.0:                                # %entry
	...
	pcalau12i	$a5, %pc_hi20(out_fp)
	ld.d	$s2, $a5, %pc_lo12(out_fp)
	move	$s0, $a4
	move	$s1, $a3
	move	$s3, $a2
	move	$s4, $a1
...
.LBB21_10:                              # %if.end15
	...
	pcalau12i	$a1, %got_pc_hi20(zz_res)
	ld.d	$a1, $a1, %got_pc_lo12(zz_res)
	pcalau12i	$a3, %pc_hi20(link_source_list)
	ld.d	$a4, $a3, %pc_lo12(link_source_list)
	st.d	$a0, $a1, 0
