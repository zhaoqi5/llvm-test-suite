...
.LBB0_2:                                # %for.cond.preheader
	pcalau12i	$s6, %pc_hi20(maptop)
	ld.w	$s5, $s6, %pc_lo12(maptop)
	addi.d	$s4, $s2, 64
	ori	$a0, $zero, 2
	pcalau12i	$a1, %pc_hi20(MapTable)
	addi.d	$s1, $a1, %pc_lo12(MapTable)
	bltu	$s5, $a0, .LBB0_6
...
# %bb.5:                                # %for.inc
	...
	bnez	$s0, .LBB0_4
.LBB0_6:                                # %for.end
	pcalau12i	$s0, %pc_hi20(notdef_word)
	ld.d	$a0, $s0, %pc_lo12(notdef_word)
	bnez	$a0, .LBB0_8
# %bb.7:                                # %if.then38
	...
	jirl	$ra, $ra, 0
	ld.w	$s5, $s6, %pc_lo12(maptop)
	st.d	$a0, $s0, %pc_lo12(notdef_word)
.LBB0_8:                                # %if.end40
	ori	$a0, $zero, 20
	addi.d	$a1, $s2, 32
...
.LBB0_15:                               # %while.end
	...
	jirl	$ra, $ra, 0
	beq	$a0, $fp, .LBB0_18
.LBB0_16:                               # %while.end347
	ld.d	$a0, $sp, 56                    # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(fclose)
	jirl	$ra, $ra, 0
	ld.d	$s7, $sp, 24                    # 8-byte Folded Reload
	b	.LBB0_44
.LBB0_17:                               # %while.body.lr.ph.preheader
	move	$s5, $zero
	addi.w	$a0, $zero, -1
	...
	b	.LBB0_48
.LBB0_18:                               # %while.body245.lr.ph.preheader
	move	$s5, $zero
	ori	$s1, $zero, 4
	ori	$s0, $zero, 35
	...
	b	.LBB0_20
	.p2align	4, , 16
.LBB0_19:                               # %while.cond239.loopexit
...
# %bb.72:                               # %if.end.i
	...
	ldx.bu	$a0, $s4, $s1
	bnez	$a0, .LBB0_71
.LBB0_73:                               # %for.cond.i80.preheader
                                        #   in Loop: Header=BB0_48 Depth=1
	ori	$a1, $zero, 1
	.p2align	4, , 16
.LBB0_74:                               # %for.cond.i80
                                        #   Parent Loop BB0_48 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.bu	$a2, $a1, $s0
	move	$a0, $fp
...
# %bb.75:                               # %for.end.i88
	...
	move	$s1, $s8
	beqz	$a0, .LBB0_78
# %bb.76:                               # %while.body.i91.preheader
                                        #   in Loop: Header=BB0_48 Depth=1
	ld.d	$s8, $sp, 56                    # 8-byte Folded Reload
	.p2align	4, , 16
.LBB0_77:                               # %while.body.i91
                                        #   Parent Loop BB0_48 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.w	$a0, $fp, 1
	addi.d	$a1, $a0, -353
...
.Lfunc_end0:
	.size	MapLoad, .Lfunc_end0-MapLoad
                                        # -- End function
	.globl	MapCharEncoding                 # -- Begin function MapCharEncoding
	.p2align	5
...
.LBB1_7:                                # %NameRetrieve.exit
	...
	ret
.Lfunc_end1:
	.size	MapCharEncoding, .Lfunc_end1-MapCharEncoding
                                        # -- End function
	.globl	MapEncodingName                 # -- Begin function MapEncodingName
	.p2align	5
...
# %bb.0:                                # %entry
	...
	pcalau12i	$a1, %pc_hi20(maptop)
	ld.w	$a1, $a1, %pc_lo12(maptop)
	move	$fp, $a0
	bltu	$a0, $a1, .LBB2_2
# %bb.1:                                # %if.then
	pcalau12i	$a0, %got_pc_hi20(no_fpos)
...
.LBB2_2:                                # %if.end
	...
	ret
.Lfunc_end2:
	.size	MapEncodingName, .Lfunc_end2-MapEncodingName
                                        # -- End function
	.globl	MapEnsurePrinted                # -- Begin function MapEnsurePrinted
	.p2align	5
...
# %bb.0:                                # %entry
	...
	slli.d	$a2, $a2, 3
	pcalau12i	$a3, %pc_hi20(MapTable)
	addi.d	$a3, $a3, %pc_lo12(MapTable)
	ldx.d	$s0, $a3, $a2
	ld.w	$a2, $s0, 12
	move	$fp, $a1
	beqz	$a2, .LBB3_2
...
.LBB3_5:                                # %if.end5
	...
	ret
.Lfunc_end3:
	.size	MapEnsurePrinted, .Lfunc_end3-MapEnsurePrinted
                                        # -- End function
	.globl	MapPrintEncodings               # -- Begin function MapPrintEncodings
	.p2align	5
...
# %bb.0:                                # %entry
	...
	pcalau12i	$s0, %pc_hi20(maptop)
	ld.wu	$a0, $s0, %pc_lo12(maptop)
	ori	$a1, $zero, 2
	bltu	$a0, $a1, .LBB4_5
# %bb.1:                                # %for.body.preheader
	pcalau12i	$a1, %pc_hi20(MapTable+8)
	addi.d	$s1, $a1, %pc_lo12(MapTable+8)
	pcalau12i	$a1, %got_pc_hi20(BackEnd)
	ld.d	$s2, $a1, %got_pc_lo12(BackEnd)
	ori	$s3, $zero, 1
	ori	$fp, $zero, 1
	ori	$s4, $zero, 1
	b	.LBB4_3
...
.LBB4_5:                                # %for.end
	...
	ret
.Lfunc_end4:
	.size	MapPrintEncodings, .Lfunc_end4-MapPrintEncodings
                                        # -- End function
	.globl	MapPrintPSResources             # -- Begin function MapPrintPSResources
	.p2align	5
...
# %bb.0:                                # %entry
	...
	st.d	$s2, $sp, 8                     # 8-byte Folded Spill
	st.d	$s3, $sp, 0                     # 8-byte Folded Spill
	pcalau12i	$s1, %pc_hi20(maptop)
	ld.wu	$a1, $s1, %pc_lo12(maptop)
	ori	$a2, $zero, 2
	bltu	$a1, $a2, .LBB5_5
# %bb.1:                                # %for.body.preheader
	move	$fp, $a0
	pcalau12i	$a0, %pc_hi20(MapTable+8)
	addi.d	$s2, $a0, %pc_lo12(MapTable+8)
	ori	$s3, $zero, 1
...
.LBB5_5:                                # %for.end
	...
	ret
.Lfunc_end5:
	.size	MapPrintPSResources, .Lfunc_end5-MapPrintPSResources
                                        # -- End function
	.globl	MapSmallCaps                    # -- Begin function MapSmallCaps
	.p2align	5
...
.LBB6_5:                                # %if.end19
	...
	slli.d	$a0, $a0, 3
	ld.d	$a1, $a1, 0
	pcalau12i	$a2, %pc_hi20(MapTable)
	addi.d	$a2, $a2, %pc_lo12(MapTable)
	ldx.d	$a0, $a2, $a0
	ld.w	$a1, $a1, 16
	addi.d	$a0, $a0, 2047
	addi.d	$s8, $a0, 386
	beqz	$a1, .LBB6_82
# %bb.6:                                # %if.end45
	pcalau12i	$a0, %pc_hi20(MapSmallCaps.font_change_word)
	st.d	$a0, $sp, 64                    # 8-byte Folded Spill
	ld.d	$a0, $a0, %pc_lo12(MapSmallCaps.font_change_word)
	bnez	$a0, .LBB6_8
# %bb.7:                                # %if.then48
	pcalau12i	$a0, %got_pc_hi20(no_fpos)
	ld.d	$a0, $a0, %got_pc_lo12(no_fpos)
	...
	jirl	$ra, $ra, 0
	ld.d	$a1, $sp, 64                    # 8-byte Folded Reload
	st.d	$a0, $a1, %pc_lo12(MapSmallCaps.font_change_word)
.LBB6_8:                                # %if.end50
	ld.bu	$a1, $s0, 64
	beqz	$a1, .LBB6_113
# %bb.9:                                # %for.body58.lr.ph
	move	$a0, $zero
	addi.d	$s4, $s0, 64
	addi.d	$s7, $sp, 120
	pcalau12i	$a2, %pc_hi20(.LJTI6_0)
	addi.d	$fp, $a2, %pc_lo12(.LJTI6_0)
	lu12i.w	$s6, -524288
	lu32i.d	$s6, 0
	lu12i.w	$s2, 131072
                                        # implicit-def: $r6
	...
	b	.LBB6_13
.LBB6_10:                               # %cond.end1551
                                        #   in Loop: Header=BB6_13 Depth=1
	move	$a0, $s3
	pcaddu18i	$ra, %call36(DoAddGap)
	jirl	$ra, $ra, 0
	ld.b	$a0, $s4, 0
	st.b	$a0, $sp, 120
	ori	$a0, $zero, 3
...
# %bb.15:                               # %if.then64
	...
	ld.h	$a2, $a4, 10
	ld.d	$a1, $sp, 64                    # 8-byte Folded Reload
	ld.d	$a1, $a1, %pc_lo12(MapSmallCaps.font_change_word)
	st.w	$a3, $sp, 116
	st.b	$a0, $sp, 104
	st.h	$a2, $sp, 114
	addi.d	$a0, $sp, 104
...
# %bb.36:                               # %cond.end1394
	...
	bnez	$a0, .LBB6_38
	b	.LBB6_39
.LBB6_37:                               # %cond.end1394.thread
                                        #   in Loop: Header=BB6_13 Depth=1
	st.d	$s5, $a3, 0
.LBB6_38:                               # %cond.false1403
                                        #   in Loop: Header=BB6_13 Depth=1
	ld.d	$a1, $s5, 16
...
# %bb.80:                               # %sw.bb1858
	...
	ld.w	$a0, $a0, 40
	srli.d	$a0, $a0, 12
	bstrins.d	$fp, $a0, 63, 12
	st.w	$fp, $a2, 40
	ld.wu	$a0, $s0, 40
	bstrpick.d	$a0, $a0, 21, 12
	bstrins.d	$fp, $a0, 21, 12
	st.w	$fp, $a2, 40
	ld.wu	$a0, $s0, 40
	bstrpick.d	$a0, $a0, 22, 22
	bstrins.d	$fp, $a0, 22, 22
	st.w	$fp, $a2, 40
	ld.wu	$a0, $s0, 40
	bstrpick.d	$a0, $a0, 28, 23
	bstrins.d	$fp, $a0, 28, 23
	st.w	$fp, $a2, 40
	ld.wu	$a0, $s0, 40
	and	$a0, $a0, $s6
	srli.d	$a0, $a0, 29
	bstrins.d	$fp, $a0, 63, 29
	or	$a0, $fp, $s2
	st.w	$a0, $a2, 40
	ld.d	$a0, $sp, 80                    # 8-byte Folded Reload
	addi.w	$a1, $a0, 0
...
# %bb.81:                               # %if.else1875
	...
	st.d	$a0, $a2, 0
	b	.LBB6_103
.LBB6_82:                               # %for.cond.preheader
	ld.bu	$a1, $s0, 64
	beqz	$a1, .LBB6_113
# %bb.83:                               # %for.body.preheader
	addi.d	$a0, $s0, 65
	b	.LBB6_85
	.p2align	4, , 16
.LBB6_84:                               # %for.inc
...
# %bb.94:                               # %cond.end1730
	...
	bnez	$a0, .LBB6_96
	b	.LBB6_97
.LBB6_95:                               # %cond.end1730.thread
	st.d	$s1, $a3, 0
.LBB6_96:                               # %cond.false1739
	ld.d	$a2, $s1, 16
...
# %bb.104:                              # %cond.false1906
	...
	ld.d	$a1, $a3, 0
	st.d	$a4, $a5, 8
.LBB6_105:                              # %cond.end1930
	st.d	$s1, $a2, 0
	beqz	$s1, .LBB6_108
# %bb.106:                              # %cond.end1930
	beqz	$a1, .LBB6_108
# %bb.107:                              # %cond.false1939
	ld.d	$a2, $s1, 16
	pcalau12i	$a3, %got_pc_hi20(zz_tmp)
	ld.d	$a3, $a3, %got_pc_lo12(zz_tmp)
	ld.d	$a4, $a1, 16
...
.LBB6_113:                              # %cleanup
	...
	ret
.Lfunc_end6:
	.size	MapSmallCaps, .Lfunc_end6-MapSmallCaps
...
.LJTI6_0:
	...
	.word	.LBB6_16-.LJTI6_0
                                        # -- End function
	.text
	.p2align	5                               # -- Begin function DoAddGap
...
.LBB7_8:                                # %cond.end163
	...
	ret
.Lfunc_end7:
	.size	DoAddGap, .Lfunc_end7-DoAddGap
                                        # -- End function
	.p2align	5                               # -- Begin function DoVShift
...
.LBB8_9:                                # %cond.end154
	...
	ret
.Lfunc_end8:
	.size	DoVShift, .Lfunc_end8-DoVShift
                                        # -- End function
	.globl	MapIsLowerCase                  # -- Begin function MapIsLowerCase
	.p2align	5
...
# %bb.0:                                # %entry
	...
	ret
.Lfunc_end9:
	.size	MapIsLowerCase, .Lfunc_end9-MapIsLowerCase
                                        # -- End function
