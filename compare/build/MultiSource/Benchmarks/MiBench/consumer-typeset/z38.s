...
.LBB0_2:                                # %for.cond.preheader
	...
	ld.w	$s1, $s5, %pc_lo12(maptop)
	addi.d	$s4, $s2, 64
	ori	$a0, $zero, 2
	pcalau12i	$a1, %pc_hi20(MapTable)
	addi.d	$s0, $a1, %pc_lo12(MapTable)
	bltu	$s1, $a0, .LBB0_6
...
# %bb.20:                               # %if.then282
	...
	add.d	$a1, $sp, $a1
	st.w	$a0, $a1, 0
.LBB0_21:                               # %while.cond239.loopexit
                                        #   in Loop: Header=BB0_22 Depth=1
	addi.d	$a0, $sp, 1640
	ori	$a1, $zero, 512
...
# %bb.95:                               # %cond.end1730
	...
	bnez	$a0, .LBB6_97
	b	.LBB6_98
.LBB6_96:                               # %cond.end1730.thread
	st.d	$s1, $a3, 0
.LBB6_97:                               # %cond.false1739
	ld.d	$a2, $s1, 16
...
# %bb.109:                              # %cond.end1993
	...
	ld.d	$a2, $a2, %got_pc_lo12(xx_tmp)
	st.d	$a0, $a2, 0
.LBB6_110:                              # %cond.end1993
	st.d	$a5, $a1, 0
	beqz	$a5, .LBB6_114
# %bb.111:                              # %cond.false2002
	ld.d	$a1, $a0, 16
	pcalau12i	$a2, %got_pc_hi20(zz_tmp)
	ld.d	$a2, $a2, %got_pc_lo12(zz_tmp)
	ld.d	$a3, $a5, 16
	...
	st.d	$a5, $a1, 24
	b	.LBB6_114
.LBB6_112:                              # %cond.end1993.thread
	pcalau12i	$a0, %got_pc_hi20(xx_tmp)
	ld.d	$a0, $a0, %got_pc_lo12(xx_tmp)
	st.d	$zero, $a0, 0
.LBB6_113:                              # %cleanup.sink.split
	st.d	$a5, $a1, 0
.LBB6_114:                              # %cleanup.sink.split
	pcalau12i	$a0, %got_pc_hi20(zz_hold)
	ld.d	$a0, $a0, %got_pc_lo12(zz_hold)
	ld.bu	$a1, $s0, 32
	st.d	$s0, $a0, 0
