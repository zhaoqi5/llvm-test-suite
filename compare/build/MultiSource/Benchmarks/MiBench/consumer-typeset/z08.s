...
.LBB1_643:                              # %if.end1076.i
                                        #   in Loop: Header=BB1_596 Depth=1
	beqz	$s1, .LBB1_646
# %bb.644:                              # %if.then1080.i
                                        #   in Loop: Header=BB1_596 Depth=1
	ld.d	$a0, $s1, 8
	beq	$a0, $s1, .LBB1_647
# %bb.645:                              # %if.end1092.i
...
# %bb.649:                              # %if.end1103.i
	...
	beqz	$a2, .LBB1_658
.LBB1_650:                              # %if.then1107.i
                                        #   in Loop: Header=BB1_596 Depth=1
	ld.d	$a0, $a2, 8
	bne	$a0, $a2, .LBB1_652
# %bb.651:                              # %if.then1117.i
                                        #   in Loop: Header=BB1_596 Depth=1
	ld.d	$a0, $sp, 264                   # 8-byte Folded Reload
	ld.d	$a4, $a0, 0
	pcalau12i	$a0, %pc_hi20(.L.str)
	...
	jirl	$ra, $ra, 0
	ld.d	$a2, $sp, 208                   # 8-byte Folded Reload
.LBB1_652:                              # %if.end1119.i
                                        #   in Loop: Header=BB1_596 Depth=1
	ld.d	$a0, $s1, 0
	.p2align	4, , 16
.LBB1_653:                              # %for.cond1128.i
                                        #   Parent Loop BB1_596 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a0, $a0, 16
	ld.bu	$a1, $a0, 32
	beqz	$a1, .LBB1_653
# %bb.654:                              # %for.end1139.i
                                        #   in Loop: Header=BB1_596 Depth=1
	ld.d	$a1, $a2, 0
	.p2align	4, , 16
.LBB1_655:                              # %for.cond1148.i
                                        #   Parent Loop BB1_596 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a1, $a1, 16
	ld.bu	$a2, $a1, 32
	beqz	$a2, .LBB1_655
# %bb.656:                              # %for.end1159.i
                                        #   in Loop: Header=BB1_596 Depth=1
	xor	$a0, $a0, $a1
	sltui	$a0, $a0, 1
	st.d	$a0, $sp, 152                   # 8-byte Folded Spill
...
# %bb.660:                              # %if.end1162.i
	...
	beq	$s6, $s1, .LBB1_676
	.p2align	4, , 16
.LBB1_661:                              # %for.cond1182.i.preheader
                                        #   Parent Loop BB1_596 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB1_662 Depth 3
                                        #       Child Loop BB1_664 Depth 3
...
.LBB1_662:                              # %for.cond1182.i
	...
	ld.bu	$a0, $s3, 32
	beqz	$a0, .LBB1_662
# %bb.663:                              # %for.cond1197.i.preheader
                                        #   in Loop: Header=BB1_661 Depth=2
	move	$fp, $s6
	.p2align	4, , 16
.LBB1_664:                              # %for.cond1197.i
                                        #   Parent Loop BB1_596 Depth=1
                                        #     Parent Loop BB1_661 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$fp, $fp, 16
	ld.bu	$a0, $fp, 32
	beqz	$a0, .LBB1_664
# %bb.665:                              # %for.end1208.i
                                        #   in Loop: Header=BB1_661 Depth=2
	bne	$s3, $fp, .LBB1_667
# %bb.666:                              # %if.then1211.i
                                        #   in Loop: Header=BB1_661 Depth=2
	ld.d	$a0, $sp, 264                   # 8-byte Folded Reload
	ld.d	$a4, $a0, 0
	pcalau12i	$a0, %pc_hi20(.L.str)
...
.LBB1_669:                              # %cond.end1305.i
	...
	st.d	$a3, $s7, 0
	beqz	$a3, .LBB1_674
# %bb.670:                              # %cond.end1305.i
                                        #   in Loop: Header=BB1_661 Depth=2
	beqz	$a1, .LBB1_674
# %bb.671:                              # %cond.false1314.i
                                        #   in Loop: Header=BB1_661 Depth=2
	ld.d	$a4, $a3, 0
	pcalau12i	$a5, %got_pc_hi20(zz_tmp)
	ld.d	$a5, $a5, %got_pc_lo12(zz_tmp)
	...
	b	.LBB1_674
	.p2align	4, , 16
.LBB1_672:                              # %cond.end1242.i.thread
                                        #   in Loop: Header=BB1_661 Depth=2
	pcalau12i	$a2, %got_pc_hi20(xx_tmp)
	ld.d	$a2, $a2, %got_pc_lo12(xx_tmp)
	st.d	$zero, $a2, 0
	...
	st.d	$fp, $s7, 0
	bne	$a3, $fp, .LBB1_669
.LBB1_673:                              # %cond.end1305.i.thread
                                        #   in Loop: Header=BB1_661 Depth=2
	pcalau12i	$a1, %got_pc_hi20(xx_tmp)
	ld.d	$a1, $a1, %got_pc_lo12(xx_tmp)
	st.d	$zero, $a1, 0
...
.LBB1_674:                              # %cond.end1338.i
	...
	sltu	$s3, $zero, $a0
	beq	$s2, $s5, .LBB1_676
# %bb.675:                              # %cond.end1338.i
                                        #   in Loop: Header=BB1_661 Depth=2
	bne	$s6, $s1, .LBB1_661
.LBB1_676:                              # %while.end.i
                                        #   in Loop: Header=BB1_596 Depth=1
	beq	$s6, $s1, .LBB1_682
# %bb.677:                              # %while.end.i
                                        #   in Loop: Header=BB1_596 Depth=1
	ld.d	$a0, $sp, 192                   # 8-byte Folded Reload
	beqz	$a0, .LBB1_682
# %bb.678:                              # %if.then1388.i
                                        #   in Loop: Header=BB1_596 Depth=1
	ld.bu	$a0, $s6, 32
	beqz	$a0, .LBB1_680
# %bb.679:                              # %if.then1394.i
                                        #   in Loop: Header=BB1_596 Depth=1
	ld.d	$a0, $sp, 264                   # 8-byte Folded Reload
	ld.d	$a4, $a0, 0
	pcalau12i	$a0, %pc_hi20(.L.str)
...
.LBB1_682:                              # %if.end1465.i
	...
	ld.d	$a2, $sp, 208                   # 8-byte Folded Reload
	beqz	$a0, .LBB1_595
# %bb.683:                              # %if.then1473.i
                                        #   in Loop: Header=BB1_596 Depth=1
	ld.bu	$a0, $s2, 32
	beqz	$a0, .LBB1_685
# %bb.684:                              # %if.then1487.i
                                        #   in Loop: Header=BB1_596 Depth=1
	ld.d	$a0, $sp, 264                   # 8-byte Folded Reload
	ld.d	$a4, $a0, 0
	pcalau12i	$a0, %pc_hi20(.L.str)
...
# %bb.686:                              # %cond.false1497.i
	...
	st.d	$a1, $a2, 8
	ld.d	$a2, $sp, 208                   # 8-byte Folded Reload
.LBB1_687:                              # %cond.end1521.i
                                        #   in Loop: Header=BB1_596 Depth=1
	st.d	$s2, $a0, 0
	st.d	$a2, $s7, 0
	beqz	$a2, .LBB1_595
# %bb.688:                              # %cond.false1530.i
                                        #   in Loop: Header=BB1_596 Depth=1
	ld.d	$a1, $a2, 0
	move	$a3, $a2
	pcalau12i	$a2, %got_pc_hi20(zz_tmp)
...
# %bb.691:                              # %cond.false1611.i
	...
	st.d	$a2, $a6, 24
	b	.LBB1_693
.LBB1_692:                              # %cond.end1602.i.thread
	pcalau12i	$a4, %got_pc_hi20(xx_tmp)
	ld.d	$a4, $a4, %got_pc_lo12(xx_tmp)
	st.d	$zero, $a4, 0
.LBB1_693:                              # %cond.end1635.i
	ld.d	$a4, $a3, 8
	st.d	$a3, $s7, 0
	beq	$a4, $a3, .LBB1_697
# %bb.694:                              # %cond.end1665.i
	...
	st.d	$a3, $s7, 0
	beqz	$a3, .LBB1_698
# %bb.695:                              # %cond.end1665.i
	beqz	$a1, .LBB1_698
# %bb.696:                              # %cond.false1674.i
	ld.d	$a4, $a3, 0
	pcalau12i	$a5, %got_pc_hi20(zz_tmp)
	ld.d	$a5, $a5, %got_pc_lo12(zz_tmp)
	st.d	$a4, $a5, 0
	...
	st.d	$a1, $a5, 8
	b	.LBB1_698
.LBB1_697:                              # %cond.end1665.i.thread
	pcalau12i	$a1, %got_pc_hi20(xx_tmp)
	ld.d	$a1, $a1, %got_pc_lo12(xx_tmp)
	st.d	$zero, $a1, 0
	pcalau12i	$a1, %got_pc_hi20(zz_res)
...
.LBB1_698:                              # %cond.end1698.i
	...
	slli.d	$a0, $a0, 3
	stx.d	$a1, $s0, $a0
.LBB1_699:                              # %if.end1730.i
	ld.d	$a0, $sp, 32                    # 8-byte Folded Reload
	ld.d	$a2, $a0, 0
	beqz	$a2, .LBB1_709
# %bb.700:                              # %if.then1734.i
	pcalau12i	$a0, %got_pc_hi20(xx_res)
	ld.d	$a1, $a0, %got_pc_lo12(xx_res)
	st.d	$a2, $a1, 0
	pcalau12i	$a0, %got_pc_hi20(xx_hold)
...
# %bb.701:                              # %cond.false1774.i
	...
	st.d	$a2, $a5, 24
	b	.LBB1_703
.LBB1_702:                              # %cond.end1765.i.thread
	pcalau12i	$a3, %got_pc_hi20(xx_tmp)
	ld.d	$a3, $a3, %got_pc_lo12(xx_tmp)
	st.d	$zero, $a3, 0
.LBB1_703:                              # %cond.end1798.i
	ld.d	$a3, $t0, 8
	st.d	$t0, $s7, 0
	beq	$a3, $t0, .LBB1_707
# %bb.704:                              # %cond.end1828.i
	...
	st.d	$a3, $s7, 0
	beqz	$a3, .LBB1_708
# %bb.705:                              # %cond.end1828.i
	beqz	$a1, .LBB1_708
# %bb.706:                              # %cond.false1837.i
	ld.d	$a4, $a3, 0
	pcalau12i	$a5, %got_pc_hi20(zz_tmp)
	ld.d	$a5, $a5, %got_pc_lo12(zz_tmp)
	st.d	$a4, $a5, 0
	...
	st.d	$a1, $a5, 8
	b	.LBB1_708
.LBB1_707:                              # %cond.end1828.i.thread
	pcalau12i	$a1, %got_pc_hi20(xx_tmp)
	ld.d	$a1, $a1, %got_pc_lo12(xx_tmp)
	st.d	$zero, $a1, 0
	pcalau12i	$a1, %got_pc_hi20(zz_res)
...
.LBB1_708:                              # %cond.end1861.i
	...
	slli.d	$a0, $a0, 3
	stx.d	$a1, $s0, $a0
.LBB1_709:                              # %sw.epilog11449
	move	$a0, $s6
	b	.LBB1_784
.LBB1_710:
                                        # implicit-def: $r4
.LBB1_711:                              # %for.end8842
	ld.d	$a2, $a0, 24
	pcalau12i	$a1, %got_pc_hi20(xx_link)
	ld.d	$a3, $a1, %got_pc_lo12(xx_link)
	ld.d	$a1, $a2, 24
...
# %bb.730:                              # %cond.end10249
	...
	st.d	$a1, $fp, 0
	beqz	$a1, .LBB1_734
# %bb.731:                              # %cond.end10249
	beqz	$a0, .LBB1_734
# %bb.732:                              # %cond.false10258
	ld.d	$a2, $a1, 16
	pcalau12i	$a3, %got_pc_hi20(zz_tmp)
	ld.d	$a3, $a3, %got_pc_lo12(zz_tmp)
	ld.d	$a4, $a0, 16
...
.LBB1_762:                              # %cond.end8018
	...
	ld.d	$a3, $a1, 0
	st.d	$a3, $a4, 8
.LBB1_763:                              # %cond.end8018
	st.d	$s1, $a1, 0
	ld.d	$a5, $sp, 272                   # 8-byte Folded Reload
	st.d	$a5, $a2, 0
	beqz	$a5, .LBB1_765
# %bb.764:                              # %cond.false8027
	ld.d	$a3, $a5, 0
	pcalau12i	$a4, %got_pc_hi20(zz_tmp)
	ld.d	$a4, $a4, %got_pc_lo12(zz_tmp)
	st.d	$a3, $a4, 0
...
.LBB1_770:                              # %cond.end8120
	...
	ld.d	$a0, $s3, 8
	bnez	$a0, .LBB1_774
# %bb.771:                              # %lor.lhs.false8125
	ld.d	$a0, $s3, 0
	bnez	$a0, .LBB1_774
# %bb.772:                              # %lor.lhs.false8128
	ld.d	$a0, $s5, 8
	bnez	$a0, .LBB1_774
# %bb.773:                              # %lor.lhs.false8131
	ld.d	$a0, $s5, 0
	beqz	$a0, .LBB1_786
.LBB1_774:                              # %if.then8134
	move	$a0, $s0
	b	.LBB1_169
.LBB1_775:                              # %if.then4660
	ori	$a0, $zero, 12
	st.b	$a0, $fp, 32
	move	$a0, $fp
...
.LBB2_95:                               # %if.else1301
	ld.d	$a1, $a5, 0
	beq	$a1, $s0, .LBB2_109
# %bb.96:                               # %cond.false1305
	bnez	$t0, .LBB2_110
# %bb.97:                               # %cond.false1308
	andi	$a2, $a0, 1536
	beqz	$a2, .LBB2_110
# %bb.98:                               # %cond.false1308
	ld.bu	$a2, $s0, 43
...
# %bb.99:                               # %cond.false1339
	andi	$a0, $a0, 512
	beqz	$a0, .LBB2_102
# %bb.100:                              # %cond.false1339
	beqz	$a1, .LBB2_102
# %bb.101:                              # %cond.true1350
	move	$a0, $s0
	pcaddu18i	$ra, %call36(SearchUses)
	jirl	$ra, $ra, 0
	bnez	$a0, .LBB2_110
.LBB2_102:                              # %if.else1669
	move	$a0, $s7
	move	$a1, $s6
	pcaddu18i	$ra, %call36(AttachEnv)
	jirl	$ra, $ra, 0
...
.LBB2_104:                              # %lor.end1677
	...
	ld.d	$a0, $s4, 8
	bnez	$a0, .LBB2_108
# %bb.105:                              # %lor.lhs.false1689
	ld.d	$a0, $s4, 0
	bnez	$a0, .LBB2_108
# %bb.106:                              # %lor.lhs.false1692
	ld.d	$a0, $a2, 8
	bnez	$a0, .LBB2_108
# %bb.107:                              # %lor.lhs.false1695
	ld.d	$a0, $a2, 0
	beqz	$a0, .LBB2_142
.LBB2_108:                              # %if.then1698
	move	$a0, $s6
	b	.LBB2_64
.LBB2_109:                              # %cond.true1304
	st.d	$zero, $a5, 0
.LBB2_110:                              # %if.then1354
	ori	$a2, $zero, 1
	addi.d	$a4, $sp, 224
	move	$a0, $s6
	move	$a1, $s7
