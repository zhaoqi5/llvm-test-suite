...
# %bb.171:                              # %for.end3706
	...
	ori	$a1, $zero, 158
	bne	$a0, $a1, .LBB1_280
# %bb.172:                              # %lor.lhs.false3711
	ld.hu	$a0, $sp, 796
	bstrpick.d	$a0, $a0, 15, 10
	slli.d	$a0, $a0, 10
	lu12i.w	$a1, 3
	bne	$a0, $a1, .LBB1_280
# %bb.173:                              # %lor.lhs.false3711.if.end3735_crit_edge
	ld.h	$a1, $sp, 798
	b	.LBB1_281
.LBB1_174:                              # %sw.bb4595
	ld.d	$a0, $s6, 8
	.p2align	4, , 16
.LBB1_175:                              # %for.cond4602
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $a0, 16
	ld.bu	$a1, $a0, 32
	beqz	$a1, .LBB1_175
...
# %bb.194:                              # %if.then10042
	ld.d	$a0, $s2, 8
.LBB1_195:                              # %for.cond10049
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $a0, 16
	ld.bu	$a1, $a0, 32
	beqz	$a1, .LBB1_195
# %bb.196:                              # %for.cond10049
	ori	$a2, $zero, 2
	bne	$a1, $a2, .LBB1_589
# %bb.197:                              # %if.then10066
	st.d	$a0, $sp, 816
...
# %bb.203:                              # %cond.false8166
	...
	st.d	$a1, $a1, 24
	st.d	$a1, $a1, 16
.LBB1_204:                              # %cond.end8188
	pcalau12i	$a0, %got_pc_hi20(zz_hold)
	ld.d	$fp, $a0, %got_pc_lo12(zz_hold)
	ld.d	$a0, $a1, 8
	st.d	$a1, $fp, 0
	beq	$a0, $a1, .LBB1_206
# %bb.205:                              # %cond.false8196
	pcalau12i	$a2, %got_pc_hi20(zz_res)
	ld.d	$a2, $a2, %got_pc_lo12(zz_res)
	st.d	$a0, $a2, 0
	ld.d	$a1, $a1, 0
...
# %bb.208:                              # %for.end8267
	...
	st.d	$a1, $s3, 0
	beq	$a2, $a1, .LBB1_210
# %bb.209:                              # %cond.false8278
	ld.d	$a3, $a1, 16
	st.d	$a3, $a2, 16
	st.d	$a2, $a3, 24
	st.d	$a1, $a1, 24
	st.d	$a1, $a1, 16
.LBB1_210:                              # %cond.end8300
	ld.d	$a2, $a1, 8
	st.d	$a1, $fp, 0
	beq	$a2, $a1, .LBB1_212
# %bb.211:                              # %cond.false8308
	pcalau12i	$a3, %got_pc_hi20(zz_res)
	ld.d	$a3, $a3, %got_pc_lo12(zz_res)
	st.d	$a2, $a3, 0
	ld.d	$a1, $a1, 0
...
.LBB1_239:                              # %cond.end99
	move	$fp, $a0
	move	$a0, $s6
.LBB1_240:                              # %sw.epilog11449
	pcaddu18i	$ra, %call36(DisposeObject)
	jirl	$ra, $ra, 0
	move	$a0, $fp
	b	.LBB1_783
.LBB1_241:                              # %sw.default11443
...
# %bb.257:                              # %for.end5466
	...
	st.d	$a1, $s4, 0
	beq	$a2, $a1, .LBB1_259
# %bb.258:                              # %cond.false5477
	ld.d	$a3, $a1, 16
	st.d	$a3, $a2, 16
	st.d	$a2, $a3, 24
	st.d	$a1, $a1, 24
	st.d	$a1, $a1, 16
.LBB1_259:                              # %cond.end5499
	ld.d	$a2, $a1, 8
	st.d	$a1, $fp, 0
	beq	$a2, $a1, .LBB1_261
# %bb.260:                              # %cond.false5507
	pcalau12i	$a3, %got_pc_hi20(zz_res)
	ld.d	$a3, $a3, %got_pc_lo12(zz_res)
	st.d	$a2, $a3, 0
	ld.d	$a1, $a1, 0
...
# %bb.264:                              # %cond.false5598
	...
	st.d	$a0, $a4, 24
	b	.LBB1_266
.LBB1_265:                              # %cond.end5589.thread
	st.d	$zero, $s0, 0
.LBB1_266:                              # %cond.end5622
	ld.d	$a4, $s6, 8
	st.d	$s6, $fp, 0
	beq	$a4, $s6, .LBB1_270
# %bb.267:                              # %cond.end5652
...
# %bb.269:                              # %cond.false5661
	...
	st.d	$a2, $a6, 8
	b	.LBB1_271
.LBB1_270:                              # %cond.end5652.thread
	pcalau12i	$a2, %got_pc_hi20(zz_res)
	ld.d	$a2, $a2, %got_pc_lo12(zz_res)
	st.d	$zero, $s0, 0
	st.d	$a0, $a2, 0
.LBB1_271:                              # %cond.end5685
	ld.d	$a1, $a1, 0
	ld.bu	$a2, $a1, 32
	addi.d	$a3, $a2, -11
	sltui	$a3, $a3, 2
...
.LBB1_313:                              # %if.then7165
	...
	ld.d	$a0, $sp, 272                   # 8-byte Folded Reload
	b	.LBB1_297
.LBB1_314:                              # %while.end7173
	ld.d	$s3, $sp, 152                   # 8-byte Folded Reload
	ld.d	$a0, $s3, 8
	ld.d	$s1, $a0, 8
	.p2align	4, , 16
.LBB1_315:                              # %for.cond7183
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$s1, $s1, 16
	ld.bu	$a0, $s1, 32
	beqz	$a0, .LBB1_315
# %bb.316:                              # %for.cond7183
	ori	$a1, $zero, 17
	bne	$a0, $a1, .LBB1_318
# %bb.317:                              # %if.end7427.loopexit
	move	$a0, $s1
	ld.d	$a5, $sp, 160                   # 8-byte Folded Reload
	ld.d	$a7, $sp, 224                   # 8-byte Folded Reload
	b	.LBB1_329
.LBB1_318:                              # %if.then7200
	pcalau12i	$a0, %got_pc_hi20(zz_lengths)
	ld.d	$s2, $a0, %got_pc_lo12(zz_lengths)
	ld.bu	$a2, $s2, 17
	pcalau12i	$a0, %got_pc_hi20(zz_free)
...
.LBB1_321:                              # %if.end7223
	...
	st.d	$a3, $s3, 0
	beq	$a1, $a3, .LBB1_323
# %bb.322:                              # %cond.false7267
	ld.d	$a2, $a3, 16
	st.d	$a2, $a1, 16
	st.d	$a1, $a2, 24
	st.d	$a3, $a3, 24
	st.d	$a3, $a3, 16
.LBB1_323:                              # %cond.end7322
	pcalau12i	$a1, %got_pc_hi20(zz_res)
	ld.d	$s4, $a1, %got_pc_lo12(zz_res)
	pcalau12i	$a1, %got_pc_hi20(zz_hold)
	ld.d	$s5, $a1, %got_pc_lo12(zz_hold)
...
.LBB1_329:                              # %if.end7427
	...
	beq	$s0, $a0, .LBB1_347
# %bb.330:                              # %for.cond7442.preheader.preheader
	pcalau12i	$a1, %got_pc_hi20(xx_link)
	ld.d	$s1, $a1, %got_pc_lo12(xx_link)
	pcalau12i	$a1, %got_pc_hi20(xx_tmp)
	ld.d	$s2, $a1, %got_pc_lo12(xx_tmp)
...
.LBB1_332:                              # %if.end7652
	...
	ld.d	$s0, $s4, 8
	beq	$s0, $a0, .LBB1_347
.LBB1_333:                              # %for.cond7442.preheader
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB1_334 Depth 2
	move	$fp, $s0
	.p2align	4, , 16
.LBB1_334:                              # %for.cond7442
...
# %bb.350:                              # %if.else7661
	beq	$s1, $a0, .LBB1_361
# %bb.351:                              # %for.cond7677.preheader.preheader
	ori	$s3, $zero, 1
	move	$s0, $s1
.LBB1_352:                              # %for.cond7677.preheader
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB1_353 Depth 2
                                        #     Child Loop BB1_355 Depth 2
	move	$a1, $fp
	.p2align	4, , 16
.LBB1_353:                              # %for.cond7677
                                        #   Parent Loop BB1_352 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a1, $a1, 16
	ld.bu	$a2, $a1, 32
	beqz	$a2, .LBB1_353
# %bb.354:                              # %for.cond7692.preheader
                                        #   in Loop: Header=BB1_352 Depth=1
	move	$a3, $s0
	.p2align	4, , 16
.LBB1_355:                              # %for.cond7692
                                        #   Parent Loop BB1_352 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a3, $a3, 16
	ld.bu	$a4, $a3, 32
...
.LBB1_361:
	move	$s0, $s1
.LBB1_362:                              # %while.end7755
	ori	$a1, $zero, 74
	beq	$s2, $a1, .LBB1_399
# %bb.363:                              # %while.end7755
	ori	$a1, $zero, 73
	bne	$s2, $a1, .LBB1_764
# %bb.364:                              # %if.then7761
	beq	$s0, $a0, .LBB1_764
...
.LBB1_375:                              # %for.end4274
	...
	st.d	$a5, $a2, 0
	beq	$a1, $a5, .LBB1_377
# %bb.376:                              # %cond.false4285
	ld.d	$a3, $a5, 16
	st.d	$a3, $a1, 16
	st.d	$a1, $a3, 24
	st.d	$a5, $a5, 24
	st.d	$a5, $a5, 16
.LBB1_377:                              # %cond.end4307
	pcalau12i	$a1, %got_pc_hi20(zz_hold)
	ld.d	$a1, $a1, %got_pc_lo12(zz_hold)
	ld.d	$a3, $a5, 8
	st.d	$a5, $a1, 0
	beq	$a3, $a5, .LBB1_379
# %bb.378:                              # %cond.false4315
	pcalau12i	$a4, %got_pc_hi20(zz_res)
	ld.d	$a4, $a4, %got_pc_lo12(zz_res)
	st.d	$a3, $a4, 0
	ld.d	$a5, $a5, 0
...
# %bb.382:                              # %cond.false4406
	...
	st.d	$t0, $a0, 16
	st.d	$a0, $t0, 24
.LBB1_383:                              # %cond.end4430
	ld.d	$t0, $s6, 8
	st.d	$s6, $a1, 0
	beq	$t0, $s6, .LBB1_388
.LBB1_384:                              # %cond.end8738
...
.LBB1_389:                              # %cond.end4493
	...
	stx.d	$a1, $a2, $a3
	b	.LBB1_783
.LBB1_390:                              # %if.else4003
	ori	$a2, $zero, 17
	bne	$a1, $a2, .LBB1_396
# %bb.391:                              # %if.else4017
	move	$fp, $a0
	ld.d	$a0, $a0, 8
.LBB1_392:                              # %for.cond4024
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $a0, 16
	ld.bu	$a1, $a0, 32
	beqz	$a1, .LBB1_392
...
.LBB1_441:                              # %if.end3839
	ld.d	$a0, $s6, 8
	.p2align	4, , 16
.LBB1_442:                              # %for.cond3846
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $a0, 16
	ld.bu	$a1, $a0, 32
	beqz	$a1, .LBB1_442
	b	.LBB1_6
.LBB1_443:                              # %cond.end11391.thread
	pcalau12i	$a0, %got_pc_hi20(xx_tmp)
	ld.d	$a0, $a0, %got_pc_lo12(xx_tmp)
	pcalau12i	$a1, %got_pc_hi20(zz_res)
	ld.d	$a1, $a1, %got_pc_lo12(zz_res)
...
# %bb.617:                              # %for.end802.i
	...
	ld.d	$a1, $s3, 8
	beq	$a1, $s6, .LBB1_623
# %bb.618:                              # %for.cond813.i.preheader
                                        #   in Loop: Header=BB1_596 Depth=1
	move	$s8, $a1
	.p2align	4, , 16
.LBB1_619:                              # %for.cond813.i
                                        #   Parent Loop BB1_596 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$s8, $s8, 16
	ld.bu	$a0, $s8, 32
...
.LBB1_624:                              #   in Loop: Header=BB1_596 Depth=1
	...
	st.d	$s2, $a0, 0
	bnez	$s8, .LBB1_630
.LBB1_625:                              # %if.else928.i
                                        #   in Loop: Header=BB1_596 Depth=1
	ld.d	$a0, $sp, 80                    # 8-byte Folded Reload
	ld.d	$a0, $a0, 0
	beqz	$a0, .LBB1_631
.LBB1_626:                              # %if.then884.i
                                        #   in Loop: Header=BB1_596 Depth=1
	ld.d	$a0, $sp, 272                   # 8-byte Folded Reload
	ld.bu	$a0, $a0, 139
	slli.d	$a1, $a0, 3
...
.LBB2_34:                               # %if.else1301
	...
	beq	$a1, $s0, .LBB2_60
# %bb.35:                               # %cond.false1305
	bnez	$s3, .LBB2_61
# %bb.36:                               # %cond.false1308
	andi	$a2, $a0, 1536
	beqz	$a2, .LBB2_61
# %bb.37:                               # %cond.false1308
	ld.bu	$a2, $s0, 43
	...
	and	$a2, $a3, $a2
	bnez	$a2, .LBB2_61
# %bb.38:                               # %cond.false1339
	andi	$a0, $a0, 512
	beqz	$a0, .LBB2_41
# %bb.39:                               # %cond.false1339
	beqz	$a1, .LBB2_41
# %bb.40:                               # %cond.true1350
	move	$a0, $s0
...
.LBB2_43:                               # %lor.end1677
	...
	ld.d	$a0, $s2, 8
	bnez	$a0, .LBB2_47
# %bb.44:                               # %lor.lhs.false1689
	ld.d	$a0, $s2, 0
	bnez	$a0, .LBB2_47
# %bb.45:                               # %lor.lhs.false1692
	ld.d	$a0, $a2, 8
	bnez	$a0, .LBB2_47
# %bb.46:                               # %lor.lhs.false1695
	ld.d	$a0, $a2, 0
	beqz	$a0, .LBB2_143
.LBB2_47:                               # %if.then1698
	move	$a0, $s6
...
# %bb.73:
	move	$a0, $zero
	b	.LBB2_75
.LBB2_74:                               # %cond.true1269
	move	$a0, $s1
	pcaddu18i	$ra, %call36(BuildEnclose)
	jirl	$ra, $ra, 0
.LBB2_75:                               # %cond.end1272
	ld.d	$a2, $sp, 112                   # 8-byte Folded Reload
	st.d	$a0, $s1, 136
...
.LBB2_77:                               # %lor.end
	...
	ld.d	$a0, $s0, 8
	bnez	$a0, .LBB2_81
# %bb.78:                               # %lor.lhs.false1289
	ld.d	$a0, $s0, 0
	bnez	$a0, .LBB2_81
# %bb.79:                               # %lor.lhs.false1292
	ld.d	$a0, $a2, 8
	bnez	$a0, .LBB2_81
# %bb.80:                               # %lor.lhs.false1295
	ld.d	$a0, $a2, 0
	beqz	$a0, .LBB2_128
.LBB2_81:                               # %if.then1298
	move	$a0, $s1
...
.LBB2_108:
	move	$a2, $zero
.LBB2_109:                              # %cond.end405
	ld.d	$a3, $a1, 8
	st.d	$a2, $a0, 0
	st.d	$a1, $fp, 0
	move	$s8, $s4
	beq	$a3, $a1, .LBB2_111
# %bb.110:                              # %cond.false413
	st.d	$a3, $s0, 0
	ld.d	$a1, $a1, 0
	st.d	$a1, $a3, 0
	ld.d	$a2, $fp, 0
