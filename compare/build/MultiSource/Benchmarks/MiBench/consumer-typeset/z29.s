...
# %bb.0:                                # %entry
	...
	ld.w	$a2, $a1, %pc_lo12(scope_top)
	pcalau12i	$a4, %pc_hi20(scope)
	addi.d	$a4, $a4, %pc_lo12(scope)
	alsl.d	$a4, $a2, $a4, 3
	ld.d	$a5, $a4, -8
	beq	$a5, $a3, .LBB14_3
...
# %bb.61:                               # %middle.block
	...
	beq	$a4, $a3, .LBB15_64
.LBB15_62:                              # %while.body.preheader280
	addi.d	$a2, $a2, 1
	.p2align	4, , 16
.LBB15_63:                              # %while.body
                                        # =>This Inner Loop Header: Depth=1
...
# %bb.5:                                # %middle.block
	...
	vpickve2gr.d	$a1, $vr0, 0
	beq	$a4, $a3, .LBB16_8
.LBB16_6:                               # %while.body.preheader60
	addi.d	$a2, $a2, 1
	.p2align	4, , 16
.LBB16_7:                               # %while.body
                                        # =>This Inner Loop Header: Depth=1
...
# %bb.5:                                # %middle.block
	...
	beq	$a4, $a3, .LBB17_8
.LBB17_6:                               # %while.body.preheader93
	addi.d	$a1, $a1, 1
	.p2align	4, , 16
.LBB17_7:                               # %while.body
                                        # =>This Inner Loop Header: Depth=1
