...
.LBB18_182:                             # %vec.epilog.ph402
	...
	b	.LBB18_184
	.p2align	4, , 16
.LBB18_183:                             # %pred.store.continue430
...
# %bb.185:                              # %pred.store.if415
	...
	andi	$a4, $a4, 1
	bnez	$a4, .LBB18_189
.LBB18_186:                             # %pred.store.continue418
                                        #   in Loop: Header=BB18_184 Depth=1
	vpickve2gr.h	$a4, $vr3, 2
	andi	$a4, $a4, 1
	beqz	$a4, .LBB18_190
.LBB18_187:                             # %pred.store.if419
                                        #   in Loop: Header=BB18_184 Depth=1
	...
	b	.LBB18_192
	.p2align	4, , 16
.LBB18_188:                             # %pred.store.continue416
                                        #   in Loop: Header=BB18_184 Depth=1
	vilvl.b	$vr3, $vr3, $vr3
	vpickve2gr.h	$a4, $vr3, 1
	andi	$a4, $a4, 1
	beqz	$a4, .LBB18_186
.LBB18_189:                             # %pred.store.if417
                                        #   in Loop: Header=BB18_184 Depth=1
	...
	andi	$a4, $a4, 1
	bnez	$a4, .LBB18_187
.LBB18_190:                             # %pred.store.continue420
                                        #   in Loop: Header=BB18_184 Depth=1
	vpickve2gr.h	$a4, $vr3, 3
	andi	$a4, $a4, 1
	beqz	$a4, .LBB18_192
.LBB18_191:                             # %pred.store.if421
                                        #   in Loop: Header=BB18_184 Depth=1
	xvpickve2gr.d	$a4, $xr5, 3
	stx.b	$zero, $s2, $a4
.LBB18_192:                             # %pred.store.continue422
                                        #   in Loop: Header=BB18_184 Depth=1
	xvsub.d	$xr4, $xr4, $xr0
...
# %bb.193:                              # %pred.store.if423
	...
	andi	$a4, $a4, 1
	bnez	$a4, .LBB18_197
.LBB18_194:                             # %pred.store.continue426
                                        #   in Loop: Header=BB18_184 Depth=1
	vpickve2gr.h	$a4, $vr3, 6
	andi	$a4, $a4, 1
	beqz	$a4, .LBB18_198
.LBB18_195:                             # %pred.store.if427
                                        #   in Loop: Header=BB18_184 Depth=1
	...
	b	.LBB18_199
	.p2align	4, , 16
.LBB18_196:                             # %pred.store.continue424
                                        #   in Loop: Header=BB18_184 Depth=1
	vpickve2gr.h	$a4, $vr3, 5
	andi	$a4, $a4, 1
	beqz	$a4, .LBB18_194
.LBB18_197:                             # %pred.store.if425
                                        #   in Loop: Header=BB18_184 Depth=1
	...
	andi	$a4, $a4, 1
	bnez	$a4, .LBB18_195
.LBB18_198:                             # %pred.store.continue428
                                        #   in Loop: Header=BB18_184 Depth=1
	vpickve2gr.h	$a4, $vr3, 7
	andi	$a4, $a4, 1
	beqz	$a4, .LBB18_183
.LBB18_199:                             # %pred.store.if429
                                        #   in Loop: Header=BB18_184 Depth=1
