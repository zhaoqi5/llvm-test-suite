...
.Lfunc_end3:
	...
	.p2align	5, 0x0                          # -- Begin function int_to_uchar
.LCPI4_0:
	.byte	0                               # 0x0
	.byte	4                               # 0x4
	.byte	8                               # 0x8
...
.LBB4_24:                               # %vector.body72
	...
	xvshuf.b	$xr4, $xr6, $xr4, $xr2
	xvpermi.d	$xr6, $xr5, 78
	xvshuf.b	$xr5, $xr6, $xr5, $xr2
...
# %bb.25:                               # %middle.block77
	beq	$a5, $a2, .LBB4_20
# %bb.26:                               # %vec.epilog.iter.check81
	beqz	$a6, .LBB4_18
.LBB4_27:                               # %vec.epilog.ph83
	move	$t0, $a5
	...
	vld	$vr2, $a7, %pc_lo12(.LCPI4_1)
	add.d	$a7, $a1, $t0
	alsl.d	$t0, $t0, $a0, 2
	vrepli.w	$vr3, 255
	.p2align	4, , 16
.LBB4_28:                               # %vec.epilog.vector.body90
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr4, $t0, 0
	vsub.w	$vr4, $vr4, $vr0
	vmul.w	$vr4, $vr4, $vr3
	...
	addi.d	$t0, $t0, 16
	bnez	$a6, .LBB4_28
# %bb.29:                               # %vec.epilog.middle.block94
	beq	$a5, $a2, .LBB4_20
	b	.LBB4_18
.Lfunc_end4:
...
.LBB11_80:                              # %vec.epilog.ph
	...
	b	.LBB11_82
	.p2align	4, , 16
.LBB11_81:                              # %pred.store.continue124
...
.LBB11_82:                              # %vec.epilog.vector.body
	...
	xvsub.d	$xr5, $xr5, $xr0
	bnez	$a7, .LBB11_91
# %bb.83:                               # %pred.store.continue110
                                        #   in Loop: Header=BB11_82 Depth=1
	vilvl.b	$vr3, $vr3, $vr3
	vpickve2gr.h	$a7, $vr3, 1
	andi	$a7, $a7, 1
	bnez	$a7, .LBB11_92
.LBB11_84:                              # %pred.store.continue112
                                        #   in Loop: Header=BB11_82 Depth=1
	vpickve2gr.h	$a7, $vr3, 2
	andi	$a7, $a7, 1
	bnez	$a7, .LBB11_93
.LBB11_85:                              # %pred.store.continue114
                                        #   in Loop: Header=BB11_82 Depth=1
	vpickve2gr.h	$a7, $vr3, 3
	andi	$a7, $a7, 1
	beqz	$a7, .LBB11_87
.LBB11_86:                              # %pred.store.if115
                                        #   in Loop: Header=BB11_82 Depth=1
	xvpickve2gr.d	$a7, $xr5, 3
	stx.b	$zero, $a0, $a7
.LBB11_87:                              # %pred.store.continue116
                                        #   in Loop: Header=BB11_82 Depth=1
	xvsub.d	$xr4, $xr4, $xr0
	...
	xvadd.d	$xr4, $xr4, $xr2
	bnez	$a7, .LBB11_94
# %bb.88:                               # %pred.store.continue118
                                        #   in Loop: Header=BB11_82 Depth=1
	vpickve2gr.h	$a7, $vr3, 5
	andi	$a7, $a7, 1
	bnez	$a7, .LBB11_95
.LBB11_89:                              # %pred.store.continue120
                                        #   in Loop: Header=BB11_82 Depth=1
	vpickve2gr.h	$a7, $vr3, 6
	andi	$a7, $a7, 1
	bnez	$a7, .LBB11_96
.LBB11_90:                              # %pred.store.continue122
                                        #   in Loop: Header=BB11_82 Depth=1
...
# %bb.55:
	...
	move	$a2, $a0
	b	.LBB18_72
.LBB18_56:                              # %vector.main.loop.iter.check237
	ori	$a1, $zero, 16
	bgeu	$s1, $a1, .LBB18_65
# %bb.57:
	move	$a1, $zero
...
# %bb.67:                               # %middle.block252
	...
	beq	$a1, $s1, .LBB18_74
# %bb.68:                               # %vec.epilog.iter.check260
	beqz	$a3, .LBB18_72
.LBB18_69:                              # %vec.epilog.ph262
	move	$a3, $a1
	...
	alsl.d	$a2, $a3, $s3, 2
	.p2align	4, , 16
.LBB18_70:                              # %vec.epilog.vector.body269
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr2, $a2, 0
	vmax.w	$vr0, $vr2, $vr0
	vmin.w	$vr1, $vr2, $vr1
	...
	addi.d	$a2, $a2, 16
	bnez	$a0, .LBB18_70
# %bb.71:                               # %vec.epilog.middle.block275
	vbsrl.v	$vr2, $vr1, 8
	vmin.w	$vr1, $vr2, $vr1
	vbsrl.v	$vr2, $vr1, 4
	vmin.w	$vr1, $vr2, $vr1
...
# %bb.75:
	move	$a2, $zero
	b	.LBB18_85
.LBB18_76:                              # %vector.main.loop.iter.check284
	ori	$a2, $zero, 16
	bgeu	$s1, $a2, .LBB18_78
# %bb.77:
	move	$a2, $zero
	b	.LBB18_82
.LBB18_78:                              # %vector.ph285
	move	$a4, $zero
	andi	$a3, $s1, 12
	bstrpick.d	$a2, $s1, 30, 4
	slli.d	$a2, $a2, 4
	xvreplgr2vr.w	$xr0, $a0
	pcalau12i	$a5, %pc_hi20(.LCPI18_1)
	xvld	$xr1, $a5, %pc_lo12(.LCPI18_1)
	xvreplgr2vr.w	$xr2, $a1
	addi.d	$a5, $s3, 32
	xvrepli.w	$xr3, 255
	.p2align	4, , 16
.LBB18_79:                              # %vector.body292
                                        # =>This Inner Loop Header: Depth=1
	xvld	$xr4, $a5, -32
	xvld	$xr5, $a5, 0
	xvsub.w	$xr4, $xr4, $xr0
	...
	xvdiv.w	$xr5, $xr5, $xr2
	xvpermi.d	$xr6, $xr4, 78
	xvshuf.b	$xr4, $xr6, $xr4, $xr1
	xvpermi.d	$xr6, $xr5, 78
	xvshuf.b	$xr5, $xr6, $xr5, $xr1
	vpackev.d	$vr4, $vr5, $vr4
	vstx	$vr4, $s2, $a4
	addi.d	$a4, $a4, 16
	addi.d	$a5, $a5, 64
	bne	$a2, $a4, .LBB18_79
# %bb.80:                               # %middle.block297
	beq	$a2, $s1, .LBB18_201
# %bb.81:                               # %vec.epilog.iter.check301
	beqz	$a3, .LBB18_85
.LBB18_82:                              # %vec.epilog.ph303
	...
	vrepli.w	$vr3, 255
	.p2align	4, , 16
.LBB18_83:                              # %vec.epilog.vector.body310
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr4, $a4, 0
	vsub.w	$vr4, $vr4, $vr0
	vmul.w	$vr4, $vr4, $vr3
	...
	addi.d	$a4, $a4, 16
	bne	$a2, $a3, .LBB18_83
# %bb.84:                               # %vec.epilog.middle.block314
	beq	$a2, $s1, .LBB18_201
...
# %bb.109:                              # %middle.block213
	beq	$a2, $s5, .LBB18_201
# %bb.110:                              # %vec.epilog.iter.check217
	beqz	$a3, .LBB18_100
.LBB18_111:                             # %vec.epilog.ph219
	move	$a3, $a2
	...
	vrepli.w	$vr3, 255
	.p2align	4, , 16
.LBB18_112:                             # %vec.epilog.vector.body226
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr4, $a4, 0
	vsub.w	$vr4, $vr4, $vr0
	vmul.w	$vr4, $vr4, $vr3
	...
	addi.d	$a4, $a4, 16
	bne	$a2, $a3, .LBB18_112
# %bb.113:                              # %vec.epilog.middle.block230
	beq	$a2, $s5, .LBB18_201
	b	.LBB18_100
.LBB18_114:                             # %vector.ph323
	andi	$a4, $s1, 24
	...
	b	.LBB18_116
	.p2align	4, , 16
.LBB18_115:                             # %pred.store.continue392
                                        #   in Loop: Header=BB18_116 Depth=1
	addi.d	$a5, $a5, -32
	addi.d	$a6, $a6, 32
	beqz	$a5, .LBB18_180
.LBB18_116:                             # %vector.body328
                                        # =>This Inner Loop Header: Depth=1
	xvreplgr2vr.d	$xr9, $a6
	xvadd.d	$xr11, $xr9, $xr1
...
# %bb.117:                              # %pred.store.if
	...
	andi	$a7, $a7, 1
	bnez	$a7, .LBB18_121
.LBB18_118:                             # %pred.store.continue332
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a7, $vr10, 2
	andi	$a7, $a7, 1
	beqz	$a7, .LBB18_122
.LBB18_119:                             # %pred.store.if333
                                        #   in Loop: Header=BB18_116 Depth=1
...
.LBB18_121:                             # %pred.store.if331
	...
	andi	$a7, $a7, 1
	bnez	$a7, .LBB18_119
.LBB18_122:                             # %pred.store.continue334
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a7, $vr10, 3
	andi	$a7, $a7, 1
	beqz	$a7, .LBB18_124
.LBB18_123:                             # %pred.store.if335
                                        #   in Loop: Header=BB18_116 Depth=1
	xvpickve2gr.d	$a7, $xr11, 3
	stx.b	$zero, $s2, $a7
.LBB18_124:                             # %pred.store.continue336
                                        #   in Loop: Header=BB18_116 Depth=1
	xvsub.d	$xr9, $xr9, $xr0
...
# %bb.125:                              # %pred.store.if337
	...
	andi	$a7, $a7, 1
	bnez	$a7, .LBB18_137
.LBB18_126:                             # %pred.store.continue340
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a7, $vr10, 6
	andi	$a7, $a7, 1
	beqz	$a7, .LBB18_138
.LBB18_127:                             # %pred.store.if341
                                        #   in Loop: Header=BB18_116 Depth=1
	xvpickve2gr.d	$a7, $xr11, 2
	stx.b	$zero, $s2, $a7
	...
	andi	$a7, $a7, 1
	bnez	$a7, .LBB18_139
.LBB18_128:                             # %pred.store.continue344
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a7, $vr10, 8
	andi	$a7, $a7, 1
	xvadd.d	$xr11, $xr9, $xr7
	beqz	$a7, .LBB18_140
.LBB18_129:                             # %pred.store.if345
                                        #   in Loop: Header=BB18_116 Depth=1
	xvpickve2gr.d	$a7, $xr11, 0
	stx.b	$zero, $s2, $a7
	...
	andi	$a7, $a7, 1
	bnez	$a7, .LBB18_141
.LBB18_130:                             # %pred.store.continue348
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a7, $vr10, 10
	andi	$a7, $a7, 1
	beqz	$a7, .LBB18_142
.LBB18_131:                             # %pred.store.if349
                                        #   in Loop: Header=BB18_116 Depth=1
	xvpickve2gr.d	$a7, $xr11, 2
	stx.b	$zero, $s2, $a7
	...
	andi	$a7, $a7, 1
	bnez	$a7, .LBB18_143
.LBB18_132:                             # %pred.store.continue352
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a7, $vr10, 12
	andi	$a7, $a7, 1
	xvadd.d	$xr11, $xr9, $xr6
	beqz	$a7, .LBB18_144
.LBB18_133:                             # %pred.store.if353
                                        #   in Loop: Header=BB18_116 Depth=1
	xvpickve2gr.d	$a7, $xr11, 0
	stx.b	$zero, $s2, $a7
	...
	andi	$a7, $a7, 1
	bnez	$a7, .LBB18_145
.LBB18_134:                             # %pred.store.continue356
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a7, $vr10, 14
	andi	$a7, $a7, 1
	beqz	$a7, .LBB18_146
.LBB18_135:                             # %pred.store.if357
                                        #   in Loop: Header=BB18_116 Depth=1
	xvpickve2gr.d	$a7, $xr11, 2
	stx.b	$zero, $s2, $a7
	...
	b	.LBB18_148
	.p2align	4, , 16
.LBB18_136:                             # %pred.store.continue338
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a7, $vr10, 5
	andi	$a7, $a7, 1
	beqz	$a7, .LBB18_126
.LBB18_137:                             # %pred.store.if339
                                        #   in Loop: Header=BB18_116 Depth=1
	xvpickve2gr.d	$a7, $xr11, 1
	stx.b	$zero, $s2, $a7
	vpickve2gr.b	$a7, $vr10, 6
	andi	$a7, $a7, 1
	bnez	$a7, .LBB18_127
.LBB18_138:                             # %pred.store.continue342
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a7, $vr10, 7
	andi	$a7, $a7, 1
	beqz	$a7, .LBB18_128
.LBB18_139:                             # %pred.store.if343
                                        #   in Loop: Header=BB18_116 Depth=1
	xvpickve2gr.d	$a7, $xr11, 3
	stx.b	$zero, $s2, $a7
	vpickve2gr.b	$a7, $vr10, 8
	...
	xvadd.d	$xr11, $xr9, $xr7
	bnez	$a7, .LBB18_129
.LBB18_140:                             # %pred.store.continue346
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a7, $vr10, 9
	andi	$a7, $a7, 1
	beqz	$a7, .LBB18_130
.LBB18_141:                             # %pred.store.if347
                                        #   in Loop: Header=BB18_116 Depth=1
	xvpickve2gr.d	$a7, $xr11, 1
	stx.b	$zero, $s2, $a7
	vpickve2gr.b	$a7, $vr10, 10
	andi	$a7, $a7, 1
	bnez	$a7, .LBB18_131
.LBB18_142:                             # %pred.store.continue350
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a7, $vr10, 11
	andi	$a7, $a7, 1
	beqz	$a7, .LBB18_132
.LBB18_143:                             # %pred.store.if351
                                        #   in Loop: Header=BB18_116 Depth=1
	xvpickve2gr.d	$a7, $xr11, 3
	stx.b	$zero, $s2, $a7
	vpickve2gr.b	$a7, $vr10, 12
	...
	xvadd.d	$xr11, $xr9, $xr6
	bnez	$a7, .LBB18_133
.LBB18_144:                             # %pred.store.continue354
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a7, $vr10, 13
	andi	$a7, $a7, 1
	beqz	$a7, .LBB18_134
.LBB18_145:                             # %pred.store.if355
                                        #   in Loop: Header=BB18_116 Depth=1
	xvpickve2gr.d	$a7, $xr11, 1
	stx.b	$zero, $s2, $a7
	vpickve2gr.b	$a7, $vr10, 14
	andi	$a7, $a7, 1
	bnez	$a7, .LBB18_135
.LBB18_146:                             # %pred.store.continue358
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a7, $vr10, 15
	andi	$a7, $a7, 1
	beqz	$a7, .LBB18_148
.LBB18_147:                             # %pred.store.if359
                                        #   in Loop: Header=BB18_116 Depth=1
	xvpickve2gr.d	$a7, $xr11, 3
	stx.b	$zero, $s2, $a7
.LBB18_148:                             # %pred.store.continue360
                                        #   in Loop: Header=BB18_116 Depth=1
	xvpermi.d	$xr10, $xr10, 14
	vpickve2gr.b	$a7, $vr10, 0
	andi	$a7, $a7, 1
...
# %bb.149:                              # %pred.store.if361
	...
	andi	$a7, $a7, 1
	bnez	$a7, .LBB18_165
.LBB18_150:                             # %pred.store.continue364
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a7, $vr10, 2
	andi	$a7, $a7, 1
	beqz	$a7, .LBB18_166
.LBB18_151:                             # %pred.store.if365
                                        #   in Loop: Header=BB18_116 Depth=1
	xvpickve2gr.d	$a7, $xr11, 2
	stx.b	$zero, $s2, $a7
	vpickve2gr.b	$a7, $vr10, 3
	andi	$a7, $a7, 1
	bnez	$a7, .LBB18_167
.LBB18_152:                             # %pred.store.continue368
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a7, $vr10, 4
	andi	$a7, $a7, 1
	xvadd.d	$xr11, $xr9, $xr4
	beqz	$a7, .LBB18_168
.LBB18_153:                             # %pred.store.if369
                                        #   in Loop: Header=BB18_116 Depth=1
	xvpickve2gr.d	$a7, $xr11, 0
	stx.b	$zero, $s2, $a7
	vpickve2gr.b	$a7, $vr10, 5
	andi	$a7, $a7, 1
	bnez	$a7, .LBB18_169
.LBB18_154:                             # %pred.store.continue372
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a7, $vr10, 6
	andi	$a7, $a7, 1
	beqz	$a7, .LBB18_170
.LBB18_155:                             # %pred.store.if373
                                        #   in Loop: Header=BB18_116 Depth=1
	xvpickve2gr.d	$a7, $xr11, 2
	stx.b	$zero, $s2, $a7
	vpickve2gr.b	$a7, $vr10, 7
	andi	$a7, $a7, 1
	bnez	$a7, .LBB18_171
.LBB18_156:                             # %pred.store.continue376
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a7, $vr10, 8
	andi	$a7, $a7, 1
	xvadd.d	$xr11, $xr9, $xr3
	beqz	$a7, .LBB18_172
.LBB18_157:                             # %pred.store.if377
                                        #   in Loop: Header=BB18_116 Depth=1
	xvpickve2gr.d	$a7, $xr11, 0
	stx.b	$zero, $s2, $a7
	vpickve2gr.b	$a7, $vr10, 9
	andi	$a7, $a7, 1
	bnez	$a7, .LBB18_173
.LBB18_158:                             # %pred.store.continue380
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a7, $vr10, 10
	andi	$a7, $a7, 1
	beqz	$a7, .LBB18_174
.LBB18_159:                             # %pred.store.if381
                                        #   in Loop: Header=BB18_116 Depth=1
	xvpickve2gr.d	$a7, $xr11, 2
	stx.b	$zero, $s2, $a7
	vpickve2gr.b	$a7, $vr10, 11
...
.LBB18_163:                             # %pred.store.if389
	...
	b	.LBB18_179
	.p2align	4, , 16
.LBB18_164:                             # %pred.store.continue362
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a7, $vr10, 1
	andi	$a7, $a7, 1
	beqz	$a7, .LBB18_150
.LBB18_165:                             # %pred.store.if363
                                        #   in Loop: Header=BB18_116 Depth=1
	xvpickve2gr.d	$a7, $xr11, 1
	stx.b	$zero, $s2, $a7
	vpickve2gr.b	$a7, $vr10, 2
	andi	$a7, $a7, 1
	bnez	$a7, .LBB18_151
.LBB18_166:                             # %pred.store.continue366
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a7, $vr10, 3
	andi	$a7, $a7, 1
	beqz	$a7, .LBB18_152
.LBB18_167:                             # %pred.store.if367
                                        #   in Loop: Header=BB18_116 Depth=1
	xvpickve2gr.d	$a7, $xr11, 3
	stx.b	$zero, $s2, $a7
	vpickve2gr.b	$a7, $vr10, 4
	...
	xvadd.d	$xr11, $xr9, $xr4
	bnez	$a7, .LBB18_153
.LBB18_168:                             # %pred.store.continue370
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a7, $vr10, 5
	andi	$a7, $a7, 1
	beqz	$a7, .LBB18_154
.LBB18_169:                             # %pred.store.if371
                                        #   in Loop: Header=BB18_116 Depth=1
	xvpickve2gr.d	$a7, $xr11, 1
	stx.b	$zero, $s2, $a7
	vpickve2gr.b	$a7, $vr10, 6
	andi	$a7, $a7, 1
	bnez	$a7, .LBB18_155
.LBB18_170:                             # %pred.store.continue374
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a7, $vr10, 7
	andi	$a7, $a7, 1
	beqz	$a7, .LBB18_156
.LBB18_171:                             # %pred.store.if375
                                        #   in Loop: Header=BB18_116 Depth=1
	xvpickve2gr.d	$a7, $xr11, 3
	stx.b	$zero, $s2, $a7
	vpickve2gr.b	$a7, $vr10, 8
	...
	xvadd.d	$xr11, $xr9, $xr3
	bnez	$a7, .LBB18_157
.LBB18_172:                             # %pred.store.continue378
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a7, $vr10, 9
	andi	$a7, $a7, 1
	beqz	$a7, .LBB18_158
.LBB18_173:                             # %pred.store.if379
                                        #   in Loop: Header=BB18_116 Depth=1
	xvpickve2gr.d	$a7, $xr11, 1
	stx.b	$zero, $s2, $a7
	vpickve2gr.b	$a7, $vr10, 10
	andi	$a7, $a7, 1
	bnez	$a7, .LBB18_159
.LBB18_174:                             # %pred.store.continue382
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a7, $vr10, 11
	andi	$a7, $a7, 1
	beqz	$a7, .LBB18_160
.LBB18_175:                             # %pred.store.if383
                                        #   in Loop: Header=BB18_116 Depth=1
	xvpickve2gr.d	$a7, $xr11, 3
	stx.b	$zero, $s2, $a7
	vpickve2gr.b	$a7, $vr10, 12
	...
	xvadd.d	$xr9, $xr9, $xr2
	bnez	$a7, .LBB18_161
.LBB18_176:                             # %pred.store.continue386
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a7, $vr10, 13
	andi	$a7, $a7, 1
	beqz	$a7, .LBB18_162
.LBB18_177:                             # %pred.store.if387
                                        #   in Loop: Header=BB18_116 Depth=1
	...
	andi	$a7, $a7, 1
	bnez	$a7, .LBB18_163
.LBB18_178:                             # %pred.store.continue390
                                        #   in Loop: Header=BB18_116 Depth=1
	vpickve2gr.b	$a7, $vr10, 15
	andi	$a7, $a7, 1
	beqz	$a7, .LBB18_115
.LBB18_179:                             # %pred.store.if391
                                        #   in Loop: Header=BB18_116 Depth=1
	xvpickve2gr.d	$a7, $xr9, 3
	stx.b	$zero, $s2, $a7
	b	.LBB18_115
.LBB18_180:                             # %middle.block394
	beq	$a3, $s1, .LBB18_201
# %bb.181:                              # %vec.epilog.iter.check399
	beqz	$a4, .LBB18_202
.LBB18_182:                             # %vec.epilog.ph401
	...
	b	.LBB18_184
	.p2align	4, , 16
.LBB18_183:                             # %pred.store.continue426
                                        #   in Loop: Header=BB18_184 Depth=1
	addi.d	$a3, $a3, 8
	addi.d	$a0, $a0, 8
	beqz	$a3, .LBB18_200
.LBB18_184:                             # %vec.epilog.vector.body406
                                        # =>This Inner Loop Header: Depth=1
...
# %bb.185:                              # %pred.store.if411
	...
	andi	$a4, $a4, 1
	bnez	$a4, .LBB18_189
.LBB18_186:                             # %pred.store.continue414
                                        #   in Loop: Header=BB18_184 Depth=1
	vpickve2gr.h	$a4, $vr3, 2
	andi	$a4, $a4, 1
	beqz	$a4, .LBB18_190
.LBB18_187:                             # %pred.store.if415
                                        #   in Loop: Header=BB18_184 Depth=1
	...
	b	.LBB18_192
	.p2align	4, , 16
.LBB18_188:                             # %pred.store.continue412
                                        #   in Loop: Header=BB18_184 Depth=1
	vilvl.b	$vr3, $vr3, $vr3
	vpickve2gr.h	$a4, $vr3, 1
	andi	$a4, $a4, 1
	beqz	$a4, .LBB18_186
.LBB18_189:                             # %pred.store.if413
                                        #   in Loop: Header=BB18_184 Depth=1
	...
	andi	$a4, $a4, 1
	bnez	$a4, .LBB18_187
.LBB18_190:                             # %pred.store.continue416
                                        #   in Loop: Header=BB18_184 Depth=1
	vpickve2gr.h	$a4, $vr3, 3
	andi	$a4, $a4, 1
	beqz	$a4, .LBB18_192
.LBB18_191:                             # %pred.store.if417
                                        #   in Loop: Header=BB18_184 Depth=1
	xvpickve2gr.d	$a4, $xr5, 3
	stx.b	$zero, $s2, $a4
.LBB18_192:                             # %pred.store.continue418
                                        #   in Loop: Header=BB18_184 Depth=1
	xvsub.d	$xr4, $xr4, $xr0
...
# %bb.193:                              # %pred.store.if419
	...
	andi	$a4, $a4, 1
	bnez	$a4, .LBB18_197
.LBB18_194:                             # %pred.store.continue422
                                        #   in Loop: Header=BB18_184 Depth=1
	vpickve2gr.h	$a4, $vr3, 6
	andi	$a4, $a4, 1
	beqz	$a4, .LBB18_198
.LBB18_195:                             # %pred.store.if423
                                        #   in Loop: Header=BB18_184 Depth=1
	...
	b	.LBB18_199
	.p2align	4, , 16
.LBB18_196:                             # %pred.store.continue420
                                        #   in Loop: Header=BB18_184 Depth=1
	vpickve2gr.h	$a4, $vr3, 5
	andi	$a4, $a4, 1
	beqz	$a4, .LBB18_194
.LBB18_197:                             # %pred.store.if421
                                        #   in Loop: Header=BB18_184 Depth=1
	...
	andi	$a4, $a4, 1
	bnez	$a4, .LBB18_195
.LBB18_198:                             # %pred.store.continue424
                                        #   in Loop: Header=BB18_184 Depth=1
	vpickve2gr.h	$a4, $vr3, 7
	andi	$a4, $a4, 1
	beqz	$a4, .LBB18_183
.LBB18_199:                             # %pred.store.if425
                                        #   in Loop: Header=BB18_184 Depth=1
	xvpickve2gr.d	$a4, $xr4, 3
	stx.b	$zero, $s2, $a4
	b	.LBB18_183
.LBB18_200:                             # %vec.epilog.middle.block429
	bne	$a2, $s1, .LBB18_203
