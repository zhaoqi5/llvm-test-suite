...
.LBB0_7:
	move	$a2, $zero
	b	.LBB0_14
.LBB0_8:                                # %vector.body91.preheader
	move	$a0, $zero
	lu12i.w	$a3, 4
	vreplgr2vr.w	$vr0, $a3
	ori	$a3, $zero, 320
	.p2align	4, , 16
.LBB0_9:                                # %vector.body91
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a4, $s0, $a0
	ldx.d	$a5, $s0, $a0
	ld.d	$a4, $a4, 8
	...
	bne	$a0, $a3, .LBB0_9
	b	.LBB0_14
.LBB0_10:                               # %vector.body99.preheader
	move	$a0, $zero
	lu12i.w	$a3, 4
	vreplgr2vr.w	$vr0, $a3
	ori	$a3, $zero, 320
	.p2align	4, , 16
.LBB0_11:                               # %vector.body99
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a4, $s0, $a0
	ldx.d	$a5, $s0, $a0
	ld.d	$a4, $a4, 8
	...
	bne	$a0, $a3, .LBB0_11
	b	.LBB0_14
.LBB0_12:                               # %vector.body83.preheader
	move	$a0, $zero
	lu12i.w	$a3, 4
	vreplgr2vr.w	$vr0, $a3
	ori	$a3, $zero, 320
	.p2align	4, , 16
.LBB0_13:                               # %vector.body83
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a4, $s0, $a0
	ldx.d	$a5, $s0, $a0
	ld.d	$a4, $a4, 8
