...
.LBB0_2:                                # %sw.bb87.i
	...
	st.w	$s2, $a0, %pc_lo12(User_Data_Flag)
.LBB0_3:                                # %sw.bb88.i
                                        #   in Loop: Header=BB0_6 Depth=1
...
.LBB0_11:                               # %sw.bb.i
	...
	st.w	$s2, $a0, %pc_lo12(Main_Bitstream_Flag)
	beqz	$s5, .LBB0_30
# %bb.12:                               # %if.then26.i
                                        #   in Loop: Header=BB0_6 Depth=1
...
.LBB0_13:                               # %sw.bb84.i
	...
	st.w	$s2, $a0, %pc_lo12(Reference_IDCT_Flag)
	b	.LBB0_5
.LBB0_14:                               # %sw.bb85.i
                                        #   in Loop: Header=BB0_6 Depth=1
...
.LBB0_15:                               # %sw.bb83.i
	...
	st.w	$s2, $a0, %pc_lo12(Quiet_Flag)
	b	.LBB0_5
.LBB0_16:                               # %sw.bb90.i
                                        #   in Loop: Header=BB0_6 Depth=1
	ld.d	$a0, $sp, 144                   # 8-byte Folded Reload
	st.w	$s2, $a0, %pc_lo12(Ersatz_Flag)
	bnez	$s5, .LBB0_141
# %bb.17:                               # %if.else96.i
                                        #   in Loop: Header=BB0_6 Depth=1
	addi.w	$s3, $s3, 1
...
.LBB0_18:                               # %sw.bb46.i
	...
	st.w	$s2, $a0, %pc_lo12(Big_Picture_Flag)
	b	.LBB0_5
.LBB0_19:                               # %sw.bb32.i
                                        #   in Loop: Header=BB0_6 Depth=1
...
.LBB0_21:                               # %sw.bb34.i
                                        #   in Loop: Header=BB0_6 Depth=1
	st.w	$s2, $s4, %pc_lo12(Two_Streams)
	bnez	$s5, .LBB0_143
# %bb.22:                               # %if.else40.i
                                        #   in Loop: Header=BB0_6 Depth=1
	addi.w	$s3, $s3, 1
...
.LBB0_25:                               # %sw.bb45.i
	...
	st.w	$s2, $a0, %pc_lo12(Frame_Store_Flag)
	b	.LBB0_5
.LBB0_26:                               # %sw.bb49.i
                                        #   in Loop: Header=BB0_6 Depth=1
	ld.d	$a0, $sp, 136                   # 8-byte Folded Reload
	st.w	$s2, $a0, %pc_lo12(Spatial_Flag)
	bnez	$s5, .LBB0_142
# %bb.27:                               # %if.else55.i
                                        #   in Loop: Header=BB0_6 Depth=1
	addi.w	$s3, $s3, 1
