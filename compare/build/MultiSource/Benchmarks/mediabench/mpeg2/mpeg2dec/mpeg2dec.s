...
# %bb.35:                               # %if.then124.i
	...
	ld.d	$a1, $sp, 72                    # 8-byte Folded Reload
	st.d	$a1, $a0, %pc_lo12(Output_Picture_Filename)
.LBB0_36:                               # %Process_Options.exit
	pcalau12i	$s2, %pc_hi20(ld)
	ld.d	$a0, $s1, %pc_lo12(Main_Bitstream_Filename)
	pcalau12i	$a1, %pc_hi20(base)
	addi.d	$s3, $a1, %pc_lo12(base)
...
.LBB0_54:                               # %for.cond.i.preheader
	...
	addi.d	$s1, $a0, %pc_lo12(backward_reference_frame)
...
.LBB0_68:                               # %cond.end.i.i.i
	...
	ld.w	$s8, $a0, %pc_lo12(Ersatz_Flag)
	...
	ori	$a1, $zero, 2
	bne	$s5, $a1, .LBB0_91
# %bb.69:                               # %for.body.us.preheader.i.i.i
                                        #   in Loop: Header=BB0_55 Depth=1
	ld.d	$s5, $sp, 184                   # 8-byte Folded Reload
	beqz	$a0, .LBB0_134
# %bb.70:                               # %if.end36.us.i.i.i
                                        #   in Loop: Header=BB0_55 Depth=1
	move	$a0, $s1
	pcaddu18i	$ra, %call36(malloc)
	jirl	$ra, $ra, 0
...
# %bb.71:                               # %if.end43.us.i.i.i
	...
	st.d	$a0, $s6, 0
	beqz	$a0, .LBB0_136
# %bb.72:                               # %if.end50.us.i.i.i
                                        #   in Loop: Header=BB0_55 Depth=1
	beqz	$s8, .LBB0_74
# %bb.73:                               # %if.then52.us.i.i.i
                                        #   in Loop: Header=BB0_55 Depth=1
	move	$a0, $s1
	pcaddu18i	$ra, %call36(malloc)
	jirl	$ra, $ra, 0
...
# %bb.78:                               # %if.end43.us.1.i.i.i
	...
	st.d	$a0, $s6, 8
	beqz	$a0, .LBB0_136
# %bb.79:                               # %if.end50.us.1.i.i.i
                                        #   in Loop: Header=BB0_55 Depth=1
	beqz	$s8, .LBB0_81
# %bb.80:                               # %if.then52.us.1.i.i.i
                                        #   in Loop: Header=BB0_55 Depth=1
	move	$a0, $s0
	pcaddu18i	$ra, %call36(malloc)
	jirl	$ra, $ra, 0
...
# %bb.85:                               # %if.end43.us.2.i.i.i
	...
	st.d	$a0, $s6, 16
	beqz	$a0, .LBB0_136
# %bb.86:                               # %if.end50.us.2.i.i.i
                                        #   in Loop: Header=BB0_55 Depth=1
	beqz	$s8, .LBB0_88
# %bb.87:                               # %if.then52.us.2.i.i.i
                                        #   in Loop: Header=BB0_55 Depth=1
	move	$a0, $s0
	pcaddu18i	$ra, %call36(malloc)
	jirl	$ra, $ra, 0
...
# %bb.90:                               # %if.then89.i.i.i
	...
	b	.LBB0_141
	.p2align	4, , 16
.LBB0_91:                               # %cond.end.split.i.i.i
                                        #   in Loop: Header=BB0_55 Depth=1
	beqz	$s8, .LBB0_104
# %bb.92:                               # %for.body.preheader.i.i.i
                                        #   in Loop: Header=BB0_55 Depth=1
	ld.d	$s5, $sp, 184                   # 8-byte Folded Reload
	beqz	$a0, .LBB0_134
# %bb.93:                               # %if.end36.i.i.i
                                        #   in Loop: Header=BB0_55 Depth=1
	move	$a0, $s1
	pcaddu18i	$ra, %call36(malloc)
	jirl	$ra, $ra, 0
...
# %bb.103:                              # %if.end50.2.i.i.i
	...
	bnez	$a0, .LBB0_113
	b	.LBB0_137
.LBB0_104:                              # %for.body.us17.preheader.i.i.i
                                        #   in Loop: Header=BB0_55 Depth=1
	ld.d	$s5, $sp, 184                   # 8-byte Folded Reload
	beqz	$a0, .LBB0_134
# %bb.105:                              # %if.end36.us29.i.i.i
                                        #   in Loop: Header=BB0_55 Depth=1
	move	$a0, $s1
	pcaddu18i	$ra, %call36(malloc)
	jirl	$ra, $ra, 0
...
# %bb.112:                              # %if.end43.us33.2.i.i.i
	...
	beqz	$a0, .LBB0_136
	.p2align	4, , 16
.LBB0_113:                              # %Initialize_Sequence.exit.i.i
                                        #   in Loop: Header=BB0_55 Depth=1
	move	$a0, $fp
	move	$a1, $zero
...
# %bb.115:                              # %if.then.i12.i.i
	...
	jirl	$ra, $ra, 0
	beq	$a0, $s1, .LBB0_117
# %bb.116:                              # %if.then.i12.i.i
                                        #   in Loop: Header=BB0_114 Depth=2
	ld.w	$a0, $s8, %pc_lo12(Quiet_Flag)
	beqz	$a0, .LBB0_120
.LBB0_117:                              # %if.end.i15.i.i
                                        #   in Loop: Header=BB0_114 Depth=2
	st.d	$s3, $s2, %pc_lo12(ld)
.LBB0_118:                              # %Headers.exit.i.i
                                        #   in Loop: Header=BB0_114 Depth=2
	beqz	$s1, .LBB0_121
# %bb.119:                              # %while.body.i.i
                                        #   in Loop: Header=BB0_114 Depth=2
	move	$a0, $fp
	move	$a1, $s0
	pcaddu18i	$ra, %call36(Decode_Picture)
...
.LBB0_130:                              # %if.then3.i.i
	...
	jirl	$ra, $ra, 0
	b	.LBB0_58
.LBB0_131:                              # %Decode_Bitstream.exit
	ld.w	$a0, $s3, 0
...
.LBB0_133:                              # %if.end30
	...
	addi.d	$sp, $sp, 304
	ret
.LBB0_134:                              # %if.then35.i.i.i
	pcalau12i	$a0, %pc_hi20(.L.str.22)
	addi.d	$a0, $a0, %pc_lo12(.L.str.22)
	pcaddu18i	$ra, %call36(Error)
	jirl	$ra, $ra, 0
.LBB0_135:                              # %if.then42.i.i.i
	pcalau12i	$a0, %pc_hi20(.L.str.23)
	addi.d	$a0, $a0, %pc_lo12(.L.str.23)
	pcaddu18i	$ra, %call36(Error)
	jirl	$ra, $ra, 0
.LBB0_136:                              # %if.then49.i.i.i
	pcalau12i	$a0, %pc_hi20(.L.str.24)
	addi.d	$a0, $a0, %pc_lo12(.L.str.24)
	pcaddu18i	$ra, %call36(Error)
	jirl	$ra, $ra, 0
.LBB0_137:                              # %if.then58.i.i.i
	pcalau12i	$a0, %pc_hi20(.L.str.25)
	addi.d	$a0, $a0, %pc_lo12(.L.str.25)
	pcaddu18i	$ra, %call36(Error)
	jirl	$ra, $ra, 0
.LBB0_138:                              # %if.then73.i.i.i
	pcalau12i	$a0, %pc_hi20(.L.str.26)
	addi.d	$a0, $a0, %pc_lo12(.L.str.26)
	pcaddu18i	$ra, %call36(Error)
	jirl	$ra, $ra, 0
.LBB0_139:                              # %if.then84.i.i.i
	pcalau12i	$a0, %pc_hi20(.L.str.27)
	addi.d	$a0, $a0, %pc_lo12(.L.str.27)
	pcaddu18i	$ra, %call36(Error)
	jirl	$ra, $ra, 0
.LBB0_140:                              # %if.then.i.i.i
	pcalau12i	$a0, %pc_hi20(.L.str.21)
	addi.d	$a0, $a0, %pc_lo12(.L.str.21)
	pcaddu18i	$ra, %call36(Error)
	jirl	$ra, $ra, 0
.LBB0_141:                              # %if.then97.i.i.i
	pcalau12i	$a0, %pc_hi20(.L.str.28)
	addi.d	$a0, $a0, %pc_lo12(.L.str.28)
	pcaddu18i	$ra, %call36(Error)
	jirl	$ra, $ra, 0
.LBB0_142:                              # %if.then94.i
...
.LBB0_147:                              # %if.then
	...
	ld.d	$a0, $a0, %got_pc_lo12(stderr)
	ld.d	$a0, $a0, 0
	ld.d	$a2, $s1, %pc_lo12(Main_Bitstream_Filename)
...
.LBB0_149:                              # %if.then6
	...
	ld.w	$a1, $a0, 48
	pcalau12i	$a2, %pc_hi20(Error_Text)
	vld	$vr0, $a0, 32
	xvld	$xr1, $a0, 0
	addi.d	$a0, $a2, %pc_lo12(Error_Text)
	st.w	$a1, $a0, 48
	vst	$vr0, $a0, 32
	xvst	$xr1, $a0, 0
	pcaddu18i	$ra, %call36(Error)
