...
# %bb.129:                              # %if.end54.i.i
	...
	ldx.w	$a0, $a1, $a0
	bne	$a0, $t0, .LBB0_171
# %bb.130:                              # %if.then58.i.i
                                        #   in Loop: Header=BB0_43 Depth=2
	st.d	$a1, $fp, 0
	beqz	$s3, .LBB0_137
# %bb.131:                              # %if.end23.i.i.i
                                        #   in Loop: Header=BB0_43 Depth=2
	ld.d	$a0, $sp, 152                   # 8-byte Folded Reload
	bne	$a0, $s0, .LBB0_168
.LBB0_132:                              # %if.end30.i.i.i
                                        #   in Loop: Header=BB0_43 Depth=2
	bne	$s3, $s8, .LBB0_141
.LBB0_133:                              # %if.then32.i.i.i
                                        #   in Loop: Header=BB0_43 Depth=2
	addi.d	$a0, $sp, 340
	addi.d	$a1, $sp, 332
	addi.d	$a2, $sp, 332
	...
	andi	$s0, $a0, 2
	bnez	$s0, .LBB0_150
# %bb.134:                              # %if.end36.i36.i.i
                                        #   in Loop: Header=BB0_43 Depth=2
	andi	$a0, $a0, 16
	bnez	$a0, .LBB0_151
.LBB0_135:                              # %if.end43.i.i.i
                                        #   in Loop: Header=BB0_43 Depth=2
...
.LBB0_136:                              #   in Loop: Header=BB0_43 Depth=2
	move	$s4, $zero
	b	.LBB0_157
.LBB0_137:                              # %if.then.i53.i.i
                                        #   in Loop: Header=BB0_43 Depth=2
	ori	$a0, $zero, 23
	pcaddu18i	$ra, %call36(Show_Bits)
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB0_144
# %bb.138:                              # %if.else.i56.i.i
                                        #   in Loop: Header=BB0_43 Depth=2
	ld.d	$a0, $sp, 120                   # 8-byte Folded Reload
	ld.d	$a1, $sp, 152                   # 8-byte Folded Reload
	bge	$a1, $a0, .LBB0_147
# %bb.139:                              # %if.end20.i.i.i
                                        #   in Loop: Header=BB0_43 Depth=2
	pcaddu18i	$ra, %call36(Get_macroblock_address_increment)
	jirl	$ra, $ra, 0
	move	$s3, $a0
...
.LBB0_140:                              # %if.else196.i.i.i
	...
	beq	$a0, $a1, .LBB0_126
	b	.LBB0_127
.LBB0_141:                              # %for.cond74.preheader.i.i.i
                                        #   in Loop: Header=BB0_43 Depth=2
	pcalau12i	$a0, %got_pc_hi20(block_count)
	ld.d	$a0, $a0, %got_pc_lo12(block_count)
	ld.w	$a1, $a0, 0
	blez	$a1, .LBB0_166
# %bb.142:                              # %for.body77.lr.ph.i.i.i
                                        #   in Loop: Header=BB0_43 Depth=2
	ld.d	$a0, $fp, 0
	addi.d	$a0, $a0, 2047
	addi.d	$a0, $a0, 1129
...
.LBB0_153:                              # %if.then46.i.i.i
	...
	ori	$a1, $zero, 2
	beq	$a0, $a1, .LBB0_156
# %bb.154:                              # %if.then46.i.i.i
                                        #   in Loop: Header=BB0_43 Depth=2
	ori	$t0, $zero, 3
	bne	$a0, $t0, .LBB0_158
# %bb.155:                              # %if.then56.i.i.i
                                        #   in Loop: Header=BB0_43 Depth=2
	ori	$a0, $zero, 6
.LBB0_156:                              # %if.end63.sink.split.i.i.i
                                        #   in Loop: Header=BB0_43 Depth=2
	sll.w	$s0, $s4, $a0
	pcaddu18i	$ra, %call36(Get_Bits)
	jirl	$ra, $ra, 0
	or	$s4, $a0, $s0
.LBB0_157:                              # %if.end63.i.i.i
                                        #   in Loop: Header=BB0_43 Depth=2
	ori	$t0, $zero, 3
.LBB0_158:                              # %if.end63.i.i.i
                                        #   in Loop: Header=BB0_43 Depth=2
	pcalau12i	$a0, %got_pc_hi20(block_count)
	...
	ori	$s3, $zero, 1
	blez	$s2, .LBB0_164
# %bb.159:                              # %for.body.preheader.i.i.i
                                        #   in Loop: Header=BB0_43 Depth=2
	ld.d	$s0, $fp, 0
	move	$s5, $zero
	move	$s3, $zero
...
.LBB0_164:                              #   in Loop: Header=BB0_43 Depth=2
	...
	ori	$s8, $zero, 1
	ld.d	$s0, $sp, 144                   # 8-byte Folded Reload
.LBB0_165:                              # %if.end81.i.i.i
                                        #   in Loop: Header=BB0_43 Depth=2
	ld.d	$s1, $sp, 136                   # 8-byte Folded Reload
.LBB0_166:                              # %if.end81.i.i.i
                                        #   in Loop: Header=BB0_43 Depth=2
	st.d	$s7, $fp, 0
	st.d	$s0, $sp, 152                   # 8-byte Folded Spill
	b	.LBB0_170
.LBB0_167:                              # %if.end23.thread.i.i.i
                                        #   in Loop: Header=BB0_43 Depth=2
	pcaddu18i	$ra, %call36(Flush_Buffer32)
	jirl	$ra, $ra, 0
	pcaddu18i	$ra, %call36(slice_header)
	...
	beq	$a0, $s0, .LBB0_133
.LBB0_168:                              # %if.then25.i35.i.i
                                        #   in Loop: Header=BB0_43 Depth=2
	pcalau12i	$a0, %got_pc_hi20(Quiet_Flag)
	ld.d	$a0, $a0, %got_pc_lo12(Quiet_Flag)
	ld.w	$a0, $a0, 0
	bnez	$a0, .LBB0_170
# %bb.169:                              # %if.then27.i.i.i
                                        #   in Loop: Header=BB0_43 Depth=2
...
# %bb.172:                              # %if.then.i92.i.i
	...
	jirl	$ra, $ra, 0
	ori	$t0, $zero, 3
.LBB0_173:                              # %if.end.i70.i.i
                                        #   in Loop: Header=BB0_43 Depth=2
	ldptr.w	$a0, $s7, 3148
	bne	$a0, $s8, .LBB0_175
# %bb.174:                              # %if.then2.i91.i.i
                                        #   in Loop: Header=BB0_43 Depth=2
	st.d	$s7, $fp, 0
.LBB0_175:                              # %if.end3.i72.i.i
                                        #   in Loop: Header=BB0_43 Depth=2
	pcalau12i	$a0, %got_pc_hi20(block_count)
...
# %bb.194:                              # %if.then56.i.i.i.i
	...
	add.d	$a3, $a5, $a3
	add.d	$a1, $a3, $a1
.LBB0_195:                              # %if.end104.i.i.i.i
                                        #   in Loop: Header=BB0_179 Depth=3
	add.d	$a4, $a1, $a2
	slli.w	$a0, $a0, 1
	b	.LBB0_201
	.p2align	4, , 16
.LBB0_196:                              # %if.else26.i.i.i.i
                                        #   in Loop: Header=BB0_179 Depth=3
	slli.w	$a0, $a0, 1
	andi	$a3, $s2, 8
	or	$a3, $a3, $s5
...
.LBB0_197:                              # %if.else86.i.i.i.i
	...
	add.d	$a3, $a4, $a3
	b	.LBB0_199
.LBB0_198:                              # %if.else70.i.i.i.i
                                        #   in Loop: Header=BB0_179 Depth=3
	andi	$a4, $s2, 8
	add.d	$a3, $a3, $a4
	mul.w	$a3, $a0, $a3
	add.d	$a3, $a5, $a3
.LBB0_199:                              # %if.end104.i.i.i.i
                                        #   in Loop: Header=BB0_179 Depth=3
	add.d	$a1, $a3, $a1
...
.LBB0_201:                              # %if.end104.i.i.i.i
	...
	add.d	$a3, $a4, $a2
	bnez	$s6, .LBB0_177
# %bb.202:                              # %for.cond110.preheader.i.preheader.i.i.i
                                        #   in Loop: Header=BB0_179 Depth=3
	ld.bu	$a6, $a4, 0
	ldx.b	$a5, $a5, $a6
	st.b	$a5, $a4, 0
...
.LBB0_208:                              # %if.else.i
	...
	ori	$a1, $zero, 3
	beq	$a0, $a1, .LBB0_211
.LBB0_209:                              # %frame_reorder.exit.if.then10_crit_edge
	ld.w	$a0, $fp, 0
	sltui	$a1, $a0, 1
.LBB0_210:                              # %if.then10
	st.w	$a1, $fp, 0
