...
# %bb.7:                                # %for.cond7.for.end_crit_edge.us
	...
	ld.w	$a0, $s3, 0
	bnez	$a0, .LBB1_4
# %bb.8:                                # %for.body20.lr.ph.us
                                        #   in Loop: Header=BB1_5 Depth=1
	addi.d	$s4, $s4, 1
	mul.w	$s6, $s4, $s0
	move	$s7, $s0
	.p2align	4, , 16
.LBB1_9:                                # %for.body20.us
                                        #   Parent Loop BB1_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$a0, $s1
	pcaddu18i	$ra, %call36(getc)
