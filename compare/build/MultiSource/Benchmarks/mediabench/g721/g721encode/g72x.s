...
# %bb.1:                                # %if.else
	...
	srli.d	$t2, $t0, 10
	ori	$t4, $zero, 1
	bstrins.d	$t2, $t4, 63, 5
	bstrpick.d	$t0, $t0, 30, 15
	sll.w	$t0, $t2, $t0
	ext.w.h	$t0, $t0
	masknez	$t0, $t0, $t1
	lu12i.w	$t2, 7
...
# %bb.67:                               # %for.inc.i158
	addi.w	$a0, $zero, -1
	beq	$a5, $a0, .LBB7_77
# %bb.68:                               # %for.inc.i158.1
	addi.w	$a0, $zero, -4
	bge	$a0, $a5, .LBB7_78
# %bb.69:
	lu12i.w	$a0, 32
	b	.LBB7_121
.LBB7_70:                               # %for.inc.i147.1
	ori	$a0, $zero, 4
	bge	$a5, $a0, .LBB7_73
# %bb.71:
	lu12i.w	$a0, 32
...
.LBB7_72:
	...
	ori	$a0, $a0, 3104
	b	.LBB7_122
.LBB7_73:                               # %for.inc.i147.2
	ori	$a0, $zero, 8
	bge	$a5, $a0, .LBB7_75
# %bb.74:
	lu12i.w	$a0, 48
	b	.LBB7_117
.LBB7_75:                               # %for.inc.i147.3
	ori	$a0, $zero, 16
	bge	$a5, $a0, .LBB7_80
# %bb.76:
	lu12i.w	$a0, 64
...
.LBB7_77:
	lu12i.w	$a0, 16
	b	.LBB7_121
.LBB7_78:                               # %for.inc.i158.2
	addi.w	$a0, $zero, -8
	bge	$a0, $a5, .LBB7_82
# %bb.79:
	lu12i.w	$a0, 48
	b	.LBB7_121
.LBB7_80:                               # %for.inc.i147.4
	ori	$a0, $zero, 32
	bge	$a5, $a0, .LBB7_84
# %bb.81:
	lu12i.w	$a0, 80
	b	.LBB7_117
.LBB7_82:                               # %for.inc.i158.3
	addi.w	$a0, $zero, -16
	bge	$a0, $a5, .LBB7_86
# %bb.83:
	lu12i.w	$a0, 64
	b	.LBB7_121
.LBB7_84:                               # %for.inc.i147.5
	ori	$a0, $zero, 64
	bge	$a5, $a0, .LBB7_88
# %bb.85:
	lu12i.w	$a0, 96
	b	.LBB7_117
.LBB7_86:                               # %for.inc.i158.4
	addi.w	$a0, $zero, -32
	bge	$a0, $a5, .LBB7_90
# %bb.87:
	lu12i.w	$a0, 80
	b	.LBB7_121
.LBB7_88:                               # %for.inc.i147.6
	ori	$a0, $zero, 128
	bge	$a5, $a0, .LBB7_92
# %bb.89:
	lu12i.w	$a0, 112
	b	.LBB7_117
.LBB7_90:                               # %for.inc.i158.5
	addi.w	$a0, $zero, -64
	bge	$a0, $a5, .LBB7_94
# %bb.91:
	lu12i.w	$a0, 96
	b	.LBB7_121
.LBB7_92:                               # %for.inc.i147.7
	ori	$a0, $zero, 256
	bge	$a5, $a0, .LBB7_96
# %bb.93:
	lu12i.w	$a0, 128
	b	.LBB7_117
.LBB7_94:                               # %for.inc.i158.6
	addi.w	$a0, $zero, -128
	bge	$a0, $a5, .LBB7_98
# %bb.95:
	lu12i.w	$a0, 112
	b	.LBB7_121
.LBB7_96:                               # %for.inc.i147.8
	ori	$a0, $zero, 512
	bge	$a5, $a0, .LBB7_100
# %bb.97:
	lu12i.w	$a0, 144
	b	.LBB7_117
.LBB7_98:                               # %for.inc.i158.7
	addi.w	$a0, $zero, -256
	bge	$a0, $a5, .LBB7_102
# %bb.99:
	lu12i.w	$a0, 128
	b	.LBB7_121
.LBB7_100:                              # %for.inc.i147.9
	ori	$a0, $zero, 1024
	bge	$a5, $a0, .LBB7_104
# %bb.101:
	lu12i.w	$a0, 160
	b	.LBB7_117
.LBB7_102:                              # %for.inc.i158.8
	addi.w	$a0, $zero, -512
	bge	$a0, $a5, .LBB7_106
# %bb.103:
	lu12i.w	$a0, 144
	b	.LBB7_121
.LBB7_104:                              # %for.inc.i147.10
	ori	$a0, $zero, 2048
	bge	$a5, $a0, .LBB7_108
# %bb.105:
	lu12i.w	$a0, 176
	b	.LBB7_117
.LBB7_106:                              # %for.inc.i158.9
	addi.w	$a0, $zero, -1024
	bge	$a0, $a5, .LBB7_110
# %bb.107:
	lu12i.w	$a0, 160
	b	.LBB7_121
.LBB7_108:                              # %for.inc.i147.11
	lu12i.w	$a0, 1
	bge	$a5, $a0, .LBB7_112
# %bb.109:
	lu12i.w	$a0, 192
	b	.LBB7_117
.LBB7_110:                              # %for.inc.i158.10
	addi.w	$a0, $zero, -2048
	bge	$a0, $a5, .LBB7_114
# %bb.111:
	lu12i.w	$a0, 176
	b	.LBB7_121
.LBB7_112:                              # %for.inc.i147.12
	lu12i.w	$a0, 2
	bge	$a5, $a0, .LBB7_116
# %bb.113:
	lu12i.w	$a0, 208
	b	.LBB7_117
.LBB7_114:                              # %for.inc.i158.11
	lu12i.w	$a0, -1
	bge	$a0, $a5, .LBB7_118
# %bb.115:
	lu12i.w	$a0, 192
	b	.LBB7_121
.LBB7_116:                              # %for.inc.i147.13
	lu12i.w	$a0, 4
	slt	$a0, $a5, $a0
	lu12i.w	$a4, 240
	masknez	$a4, $a4, $a0
...
.LBB7_117:                              # %quan.exit152
	...
	add.d	$a0, $a4, $a0
	b	.LBB7_122
.LBB7_118:                              # %for.inc.i158.12
	lu12i.w	$a0, -2
	bge	$a0, $a5, .LBB7_120
# %bb.119:
	lu12i.w	$a0, 208
	b	.LBB7_121
.LBB7_120:                              # %for.inc.i158.13
	lu12i.w	$a0, -4
	slt	$a0, $a0, $a5
	lu12i.w	$a4, 240
	masknez	$a4, $a4, $a0
