	.file	"g721.c"
	.text
	.globl	g721_encoder                    # -- Begin function g721_encoder
	.p2align	5
	.type	g721_encoder,@function
...
.LBB0_5:                                # %sw.epilog
	...
	ext.w.h	$a1, $s0
	ext.w.h	$s1, $a0
	pcalau12i	$a0, %pc_hi20(qtab_721)
	addi.d	$a2, $a0, %pc_lo12(qtab_721)
	ori	$a3, $zero, 7
	move	$a0, $a1
	move	$a1, $s1
	...
	ldx.h	$a1, $a1, $s4
	pcalau12i	$a2, %pc_hi20(_fitab)
	addi.d	$a2, $a2, %pc_lo12(_fitab)
	ldx.h	$a3, $a2, $s4
	add.d	$a0, $a0, $s2
	slli.d	$a2, $a1, 5
	ext.w.h	$a6, $a0
...
.LBB0_7:                                # %cleanup
	...
	ret
.Lfunc_end0:
	.size	g721_encoder, .Lfunc_end0-g721_encoder
                                        # -- End function
	.globl	g721_decoder                    # -- Begin function g721_decoder
	.p2align	5
	.type	g721_decoder,@function
...
.LBB1_7:                                # %cleanup
	...
	ret
.Lfunc_end1:
	.size	g721_decoder, .Lfunc_end1-g721_decoder
                                        # -- End function
	.type	qtab_721,@object                # @qtab_721
	.data
	.p2align	1, 0x0
qtab_721:
	.half	65412                           # 0xff84
