...
# %bb.3:                                # %if.then35.i
	...
	add.d	$a0, $a3, $a0
	jr	$a0
.LBB0_4:                                # %vector.body74.preheader
	move	$a0, $zero
	vldi	$vr0, -3776
	ori	$a3, $zero, 320
	.p2align	4, , 16
.LBB0_5:                                # %vector.body74
...
.LBB0_7:
	move	$a2, $zero
	b	.LBB0_14
.LBB0_8:                                # %vector.body88.preheader
	move	$a0, $zero
	vldi	$vr0, -3776
	ori	$a3, $zero, 320
	.p2align	4, , 16
.LBB0_9:                                # %vector.body88
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a4, $s0, $a0
	ldx.d	$a5, $s0, $a0
	ld.d	$a4, $a4, 8
	...
	bne	$a0, $a3, .LBB0_9
	b	.LBB0_14
.LBB0_10:                               # %vector.body95.preheader
	move	$a0, $zero
	vldi	$vr0, -3776
	ori	$a3, $zero, 320
	.p2align	4, , 16
.LBB0_11:                               # %vector.body95
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a4, $s0, $a0
	ldx.d	$a5, $s0, $a0
	ld.d	$a4, $a4, 8
	...
	bne	$a0, $a3, .LBB0_11
	b	.LBB0_14
.LBB0_12:                               # %vector.body81.preheader
	move	$a0, $zero
	vldi	$vr0, -3776
	ori	$a3, $zero, 320
	.p2align	4, , 16
.LBB0_13:                               # %vector.body81
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a4, $s0, $a0
	ldx.d	$a5, $s0, $a0
	ld.d	$a4, $a4, 8
