...
# %bb.9:                                # %if.then34
	...
	addi.d	$a1, $a0, %pc_lo12(grayscale_convert)
	ld.w	$a0, $fp, 48
	ori	$a3, $zero, 2
	st.d	$a1, $s0, 8
	blt	$a0, $a3, .LBB0_34
...
# %bb.21:                               # %if.then47
	...
	ori	$a5, $zero, 16
	bltu	$a4, $a5, .LBB0_38
# %bb.22:                               # %vector.body119.preheader
	move	$a4, $zero
...
# %bb.2:                                # %for.cond.preheader.lr.ph
	ld.w	$a0, $a0, 128
	beqz	$a0, .LBB4_9
# %bb.3:                                # %for.cond.preheader.us.preheader
	ori	$a6, $zero, 1
	.p2align	4, , 16
...
.LBB4_6:                                # %for.body8.us
	...
	add.d	$t2, $t2, $a5
	bnez	$t3, .LBB4_6
# %bb.7:                                # %for.cond6.for.inc12_crit_edge.us
                                        #   in Loop: Header=BB4_5 Depth=2
	addi.d	$t0, $t0, 1
	bne	$t0, $a5, .LBB4_5
# %bb.8:                                # %for.cond.for.end13_crit_edge.split.us25
