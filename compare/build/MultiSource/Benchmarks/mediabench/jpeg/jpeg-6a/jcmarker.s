...
.LBB7_26:                               # %if.then3.i
	...
	jirl	$ra, $a1, 0
	bnez	$s2, .LBB7_18
.LBB7_27:                               # %for.body16.us.preheader
	pcalau12i	$a0, %got_pc_hi20(jpeg_natural_order)
	ld.d	$s0, $a0, %got_pc_lo12(jpeg_natural_order)
	move	$s3, $zero
	ori	$s4, $zero, 22
	...
	b	.LBB7_29
	.p2align	4, , 16
.LBB7_28:                               # %emit_byte.exit62.us
                                        #   in Loop: Header=BB7_29 Depth=1
	addi.d	$s3, $s3, 4
	beq	$s3, $s5, .LBB7_32
.LBB7_29:                               # %for.body16.us
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $fp, 32
	ldx.w	$a1, $s0, $s3
	ld.d	$a2, $a0, 0
	...
	st.d	$a1, $a0, 8
	bnez	$a1, .LBB7_28
# %bb.30:                               # %if.then.i56.us
                                        #   in Loop: Header=BB7_29 Depth=1
	ld.d	$a1, $a0, 24
	move	$a0, $fp
	jirl	$ra, $a1, 0
	bnez	$a0, .LBB7_28
# %bb.31:                               # %if.then3.i60.us
                                        #   in Loop: Header=BB7_29 Depth=1
	ld.d	$a0, $fp, 0
	ld.d	$a1, $a0, 0
	st.w	$s4, $a0, 40
