...
.LBB3_10:                               # %for.body19.us
	...
	ld.d	$a3, $sp, 64                    # 8-byte Folded Reload
	beq	$a3, $a1, .LBB3_14
# %bb.11:                               # %vector.body132.preheader
                                        #   in Loop: Header=BB3_10 Depth=2
	addi.d	$a1, $s5, 128
	move	$a2, $fp
	.p2align	4, , 16
.LBB3_12:                               # %vector.body132
                                        #   Parent Loop BB3_3 Depth=1
...
.LBB3_22:                               # %for.body49
	...
	blt	$s8, $a0, .LBB3_22
	b	.LBB3_2
.LBB3_23:                               # %for.body49.lr.ph.split.us
                                        #   in Loop: Header=BB3_3 Depth=1
	blez	$s6, .LBB3_35
# %bb.24:                               # %for.body49.us.us.preheader
                                        #   in Loop: Header=BB3_3 Depth=1
	div.wu	$s2, $a0, $s6
	...
	b	.LBB3_26
	.p2align	4, , 16
.LBB3_25:                               # %for.cond57.for.inc82_crit_edge.split.us.us.us
                                        #   in Loop: Header=BB3_26 Depth=2
	ld.w	$a0, $s1, 12
	addi.d	$s8, $s8, 1
	bge	$s8, $a0, .LBB3_2
.LBB3_26:                               # %for.body49.us.us
                                        #   Parent Loop BB3_3 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB3_28 Depth 3
                                        #         Child Loop BB3_31 Depth 4
	...
	b	.LBB3_28
	.p2align	4, , 16
.LBB3_27:                               # %for.cond65.for.end74_crit_edge.us.us.us
                                        #   in Loop: Header=BB3_28 Depth=3
	addi.w	$a0, $a0, 1
	add.d	$a1, $a1, $s7
	add.d	$s4, $s4, $s7
	bgeu	$a0, $s2, .LBB3_25
.LBB3_28:                               # %for.body60.us.us.us
                                        #   Parent Loop BB3_3 Depth=1
...
# %bb.32:                               # %middle.block
	...
	move	$a4, $s5
	beq	$s5, $s6, .LBB3_27
.LBB3_33:                               # %for.body68.us.us.us.preheader
                                        #   in Loop: Header=BB3_28 Depth=3
	slli.d	$a3, $a4, 7
	sub.d	$a4, $s6, $a4
	.p2align	4, , 16
.LBB3_34:                               # %for.body68.us.us.us
                                        #   Parent Loop BB3_3 Depth=1
                                        #     Parent Loop BB3_26 Depth=2
                                        #       Parent Loop BB3_28 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
	...
	bnez	$a4, .LBB3_34
	b	.LBB3_27
.LBB3_35:                               # %for.body49.us.preheader
                                        #   in Loop: Header=BB3_3 Depth=1
	ld.d	$a0, $sp, 72                    # 8-byte Folded Reload
	alsl.d	$fp, $s8, $a0, 3
	.p2align	4, , 16
.LBB3_36:                               # %for.body49.us
                                        #   Parent Loop BB3_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a0, $fp, 0
	move	$a1, $s3
