...
.LBB0_2:                                # %if.end
	...
	move	$s3, $a0
	st.d	$a0, $fp, 440
	pcalau12i	$a0, %pc_hi20(start_pass_prep)
	addi.d	$a0, $a0, %pc_lo12(start_pass_prep)
	ld.d	$a1, $fp, 472
	ld.w	$a1, $a1, 16
	st.d	$a0, $s3, 0
	beqz	$a1, .LBB0_19
...
.LBB0_9:                                # %for.body21.us.i.preheader
                                        #   in Loop: Header=BB0_7 Depth=1
	sub.d	$a1, $a4, $a0
	slli.d	$a0, $a0, 3
...
.LBB0_19:                               # %if.else
	...
	addi.d	$a0, $a0, %pc_lo12(pre_process_data)
	ld.w	$a1, $fp, 68
	st.d	$a0, $s3, 8
	blez	$a1, .LBB0_24
