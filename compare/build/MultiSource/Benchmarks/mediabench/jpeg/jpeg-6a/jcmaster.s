...
.LBB0_47:                               # %if.then102.i
	...
	b	.LBB0_68
	.p2align	4, , 16
.LBB0_48:                               # %for.body48.i.preheader
                                        #   in Loop: Header=BB0_38 Depth=1
	addi.d	$s0, $s2, -1
	b	.LBB0_50
	.p2align	4, , 16
.LBB0_49:                               # %for.inc78.i
	...
	addi.d	$s4, $s4, 4
	beqz	$s0, .LBB0_44
.LBB0_50:                               # %for.body48.i
                                        #   Parent Loop BB0_38 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$s5, $s4, 0
	bltz	$s5, .LBB0_53
# %bb.51:                               # %lor.lhs.false52.i
                                        #   in Loop: Header=BB0_50 Depth=2
	ld.w	$a0, $fp, 68
	bge	$s5, $a0, .LBB0_53
...
.LBB0_82:                               # %if.then148.i
	...
	blt	$a0, $s4, .LBB0_73
	b	.LBB0_77
.LBB0_83:                               # %for.body159.lr.ph.split.us.i
                                        #   in Loop: Header=BB0_74 Depth=2
	beqz	$s3, .LBB0_88
# %bb.84:                               # %for.body159.us.i.preheader
                                        #   in Loop: Header=BB0_74 Depth=2
	ld.d	$a0, $sp, 48                    # 8-byte Folded Reload
	add.d	$s0, $a0, $s0
	ld.d	$s5, $sp, 56                    # 8-byte Folded Reload
	b	.LBB0_86
	.p2align	4, , 16
.LBB0_85:                               # %if.end190.us.i
                                        #   in Loop: Header=BB0_86 Depth=3
	st.w	$s6, $s0, 0
	addi.w	$s5, $s5, -1
	addi.d	$s0, $s0, 4
	beqz	$s5, .LBB0_73
.LBB0_86:                               # %for.body159.us.i
                                        #   Parent Loop BB0_38 Depth=1
                                        #     Parent Loop BB0_74 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.w	$a0, $s0, 0
...
# %bb.87:                               # %if.then181.us.i
	...
	jirl	$ra, $a1, 0
	b	.LBB0_85
.LBB0_88:                               # %for.body159.us.us.i.preheader
                                        #   in Loop: Header=BB0_74 Depth=2
	ld.d	$a0, $sp, 48                    # 8-byte Folded Reload
	add.d	$s0, $a0, $s0
	ld.d	$s5, $sp, 56                    # 8-byte Folded Reload
	b	.LBB0_90
	.p2align	4, , 16
.LBB0_89:                               # %if.end190.us.us.i
                                        #   in Loop: Header=BB0_90 Depth=3
	st.w	$s6, $s0, 0
	addi.w	$s5, $s5, -1
	addi.d	$s0, $s0, 4
	beqz	$s5, .LBB0_73
.LBB0_90:                               # %for.body159.us.us.i
                                        #   Parent Loop BB0_38 Depth=1
                                        #     Parent Loop BB0_74 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.w	$a0, $s0, 0
	bltz	$a0, .LBB0_89
# %bb.91:                               # %if.else174.us.us.i
                                        #   in Loop: Header=BB0_90 Depth=3
	ld.d	$a0, $fp, 0
	st.w	$s7, $a0, 44
	ld.d	$a1, $fp, 0
...
.LBB0_93:                               #   in Loop: Header=BB0_38 Depth=1
	...
	move	$s3, $zero
	b	.LBB0_45
.LBB0_94:                               # %for.end243.loopexit.i
	ld.w	$s1, $fp, 300
	ld.w	$s0, $fp, 68
	ld.d	$s5, $sp, 24                    # 8-byte Folded Reload
	ld.d	$s6, $sp, 16                    # 8-byte Folded Reload
.LBB0_95:                               # %for.end243.i
	ori	$a0, $zero, 1
	beqz	$s1, .LBB0_101
# %bb.96:                               # %for.cond247.preheader.i
	blt	$s0, $a0, .LBB0_106
# %bb.97:                               # %for.body250.i.preheader
	move	$s1, $zero
	addi.d	$s2, $sp, 96
	addi.w	$s3, $zero, -1
	ori	$s4, $zero, 44
	b	.LBB0_99
	.p2align	4, , 16
.LBB0_98:                               # %for.inc261.i
                                        #   in Loop: Header=BB0_99 Depth=1
	addi.d	$s1, $s1, 1
	addi.d	$s2, $s2, 256
	bge	$s1, $s0, .LBB0_106
.LBB0_99:                               # %for.body250.i
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a0, $s2, 0
	blt	$s3, $a0, .LBB0_98
# %bb.100:                              # %if.then255.i
	...
	ld.w	$s0, $fp, 68
	b	.LBB0_98
.LBB0_101:                              # %for.cond265.preheader.i
	blt	$s0, $a0, .LBB0_106
# %bb.102:                              # %for.body268.i.preheader
	move	$s1, $zero
	ori	$a0, $zero, 2656
	add.d	$s2, $sp, $a0
	ori	$s3, $zero, 44
	b	.LBB0_104
	.p2align	4, , 16
.LBB0_103:                              # %for.inc278.i
                                        #   in Loop: Header=BB0_104 Depth=1
	addi.d	$s1, $s1, 1
	addi.d	$s2, $s2, 4
	bge	$s1, $s0, .LBB0_106
.LBB0_104:                              # %for.body268.i
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a0, $s2, 0
	bnez	$a0, .LBB0_103
# %bb.105:                              # %if.then272.i
