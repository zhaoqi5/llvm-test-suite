...
.LBB1_21:                               # %if.then109
	...
	b	.LBB1_24
.LBB1_22:                               # %for.body.lr.ph.split.us
	ld.w	$a2, $fp, 508
	ld.w	$a1, $fp, 512
	bge	$a1, $a2, .LBB1_40
# %bb.23:                               # %for.end105.thread
	ld.w	$a1, $fp, 516
	sltui	$a1, $a1, 1
...
.LBB1_25:                               # %if.end125
	...
	st.d	$a1, $a3, 8
	blt	$a0, $a2, .LBB1_39
# %bb.26:                               # %for.body130.lr.ph
	ld.d	$a0, $sp, 16                    # 8-byte Folded Reload
	addi.d	$s0, $a0, 56
	addi.d	$s3, $a0, 36
	move	$s2, $zero
	beqz	$s1, .LBB1_32
# %bb.27:                               # %for.body130.preheader
	addi.d	$s4, $fp, 256
	ori	$s5, $zero, 424
	ori	$s6, $zero, 3
	ori	$s7, $zero, 49
...
.LBB1_30:                               # %for.body130
	...
	ld.w	$s8, $a0, 24
	bltu	$s6, $s8, .LBB1_28
# %bb.31:                               # %lor.lhs.false171
                                        #   in Loop: Header=BB1_30 Depth=1
	slli.d	$a0, $s8, 3
	ldx.d	$a1, $s4, $a0
	bnez	$a1, .LBB1_29
	b	.LBB1_28
.LBB1_32:                               # %for.body130.us.preheader
	addi.d	$s4, $fp, 224
	ori	$s5, $zero, 424
	ori	$s6, $zero, 3
	ori	$s7, $zero, 49
...
.LBB1_33:                               # %if.then150.us
	...
	slli.d	$a0, $s1, 3
	ldx.d	$a1, $s4, $a0
.LBB1_34:                               # %if.end158.us
                                        #   in Loop: Header=BB1_36 Depth=1
	alsl.d	$a2, $s1, $s0, 3
	move	$a0, $fp
	pcaddu18i	$ra, %call36(jpeg_make_d_derived_tbl)
	jirl	$ra, $ra, 0
.LBB1_35:                               # %if.end194.us
                                        #   in Loop: Header=BB1_36 Depth=1
	st.w	$zero, $s3, 0
	ld.w	$a0, $fp, 416
	addi.d	$s2, $s2, 1
...
# %bb.60:                               # %middle.block
	beq	$a1, $fp, .LBB5_63
.LBB5_61:                               # %while.body.preheader255
	addi.d	$a1, $a0, 1
	addi.d	$a2, $sp, 80
	alsl.d	$a0, $a0, $a2, 2
	addi.d	$a0, $a0, -4
