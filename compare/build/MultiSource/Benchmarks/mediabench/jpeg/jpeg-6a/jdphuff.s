...
# %bb.0:                                # %entry
	...
	xvst	$xr0, $a0, 56
	ld.d	$a1, $fp, 8
	pcalau12i	$a2, %pc_hi20(start_pass_phuff_decoder)
	ld.w	$a3, $fp, 48
	addi.d	$a2, $a2, %pc_lo12(start_pass_phuff_decoder)
	ld.d	$a4, $a1, 0
	st.d	$a2, $a0, 0
	slli.w	$a0, $a3, 6
	slli.d	$a2, $a0, 2
...
.LBB1_26:                               # %for.end105
	...
	sltui	$a2, $a6, 1
	sltui	$a1, $a1, 1
	pcalau12i	$a3, %pc_hi20(decode_mcu_AC_first)
	addi.d	$a3, $a3, %pc_lo12(decode_mcu_AC_first)
	masknez	$a3, $a3, $a2
	pcalau12i	$a4, %pc_hi20(decode_mcu_DC_first)
	addi.d	$a4, $a4, %pc_lo12(decode_mcu_DC_first)
	maskeqz	$a4, $a4, $a2
	or	$a3, $a4, $a3
	pcalau12i	$a4, %pc_hi20(decode_mcu_AC_refine)
	addi.d	$a4, $a4, %pc_lo12(decode_mcu_AC_refine)
	masknez	$a4, $a4, $a2
	pcalau12i	$a5, %pc_hi20(decode_mcu_DC_refine)
	addi.d	$a5, $a5, %pc_lo12(decode_mcu_DC_refine)
	maskeqz	$a2, $a5, $a2
	or	$a2, $a2, $a4
	masknez	$a2, $a2, $a1
	maskeqz	$a1, $a3, $a1
	...
	ori	$a1, $zero, 1
	blt	$a0, $a1, .LBB1_40
# %bb.27:                               # %for.body130.lr.ph
	ld.d	$a0, $sp, 16                    # 8-byte Folded Reload
	addi.d	$s0, $a0, 56
	addi.d	$s3, $a0, 36
	move	$s2, $zero
	beqz	$a6, .LBB1_33
# %bb.28:                               # %for.body130.preheader
	addi.d	$s4, $fp, 256
	ori	$s5, $zero, 424
	ori	$s6, $zero, 3
	ori	$s7, $zero, 49
...
.LBB1_31:                               # %for.body130
	...
	ld.w	$s8, $a0, 24
	bltu	$s6, $s8, .LBB1_29
# %bb.32:                               # %lor.lhs.false171
                                        #   in Loop: Header=BB1_31 Depth=1
	slli.d	$a0, $s8, 3
	ldx.d	$a1, $s4, $a0
	bnez	$a1, .LBB1_30
	b	.LBB1_29
.LBB1_33:                               # %for.body130.us.preheader
	addi.d	$s4, $fp, 224
	ori	$s5, $zero, 424
	ori	$s6, $zero, 3
	ori	$s7, $zero, 49
...
.LBB1_34:                               # %if.then150.us
	...
	slli.d	$a0, $s1, 3
	ldx.d	$a1, $s4, $a0
.LBB1_35:                               # %if.end158.us
                                        #   in Loop: Header=BB1_37 Depth=1
	alsl.d	$a2, $s1, $s0, 3
	move	$a0, $fp
	pcaddu18i	$ra, %call36(jpeg_make_d_derived_tbl)
	jirl	$ra, $ra, 0
.LBB1_36:                               # %if.end194.us
                                        #   in Loop: Header=BB1_37 Depth=1
	st.w	$zero, $s3, 0
	ld.w	$a0, $fp, 416
	addi.d	$s2, $s2, 1
...
.LBB2_22:                               # %if.end65
	...
	addi.d	$a4, $zero, -1
	slli.d	$a3, $s2, 2
	pcalau12i	$a5, %pc_hi20(extend_test)
	addi.d	$a5, $a5, %pc_lo12(extend_test)
	ldx.w	$a5, $a5, $a3
	sll.w	$a4, $a4, $s2
	andn	$a0, $a0, $a4
	addi.w	$a0, $a0, 0
...
.LBB3_15:                               # %cond.end
	...
	ld.d	$a4, $a0, %got_pc_lo12(jpeg_natural_order)
	add.w	$a0, $s7, $s8
	slli.d	$a5, $a0, 2
	ldx.w	$a4, $a4, $a5
	sll.w	$a3, $a3, $s4
...
# %bb.60:                               # %middle.block
	beq	$a1, $fp, .LBB5_63
.LBB5_61:                               # %while.body.preheader247
	addi.d	$a1, $a0, 1
	addi.d	$a2, $sp, 80
	alsl.d	$a0, $a0, $a2, 2
	addi.d	$a0, $a0, -4
