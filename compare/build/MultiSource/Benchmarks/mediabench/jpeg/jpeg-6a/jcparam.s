...
# %bb.23:                               # %middle.block
	beq	$a1, $s0, .LBB7_26
# %bb.24:                               # %for.body.i.i.preheader503
	ori	$a0, $zero, 1
	.p2align	4, , 16
...
.LBB7_30:
	move	$a5, $zero
	move	$a4, $a3
.LBB7_31:                               # %for.body.i57.preheader495
	vld	$vr0, $a6, %pc_lo12(.LCPI7_2)
	ori	$a3, $zero, 1
	.p2align	4, , 16
...
.LBB7_35:                               # %vector.body372
	...
	addi.d	$a7, $a7, 2
	bnez	$t1, .LBB7_35
# %bb.36:                               # %middle.block379
	bne	$a0, $a5, .LBB7_38
	b	.LBB7_40
.LBB7_37:
	move	$a5, $zero
	move	$a3, $a4
.LBB7_38:                               # %for.body.i64.preheader493
	vld	$vr0, $a6, %pc_lo12(.LCPI7_3)
	ori	$a4, $zero, 1
	.p2align	4, , 16
...
.LBB7_42:                               # %vector.body388
	...
	addi.d	$a7, $a7, 2
	bnez	$t1, .LBB7_42
# %bb.43:                               # %middle.block395
	bne	$a0, $a5, .LBB7_45
	b	.LBB7_47
.LBB7_44:
	move	$a5, $zero
	move	$a4, $a3
.LBB7_45:                               # %for.body.i79.preheader490
	vld	$vr0, $a6, %pc_lo12(.LCPI7_4)
	ori	$a3, $zero, 1
	.p2align	4, , 16
...
.LBB7_51:                               # %vector.body403
	...
	addi.d	$a6, $a6, 2
	bnez	$t0, .LBB7_51
# %bb.52:                               # %middle.block410
	beq	$a5, $s0, .LBB7_55
# %bb.53:                               # %for.body.i.i92.preheader502
	ori	$a4, $zero, 1
	.p2align	4, , 16
...
.LBB7_75:
	move	$a2, $zero
	move	$a1, $a3
.LBB7_76:                               # %for.body.i124.preheader488
	vld	$vr0, $a4, %pc_lo12(.LCPI7_8)
	ori	$a0, $zero, 1
	.p2align	4, , 16
