...
.LBB0_3:                                # %vector.body
	...
	xvpickev.h	$xr6, $xr5, $xr6
	xvpermi.q	$xr5, $xr8, 1
	vpickev.w	$vr5, $vr5, $vr8
	xvpermi.q	$xr8, $xr7, 1
	vpickev.w	$vr7, $vr8, $vr7
	xvpermi.q	$xr7, $xr5, 2
	xvpermi.d	$xr5, $xr7, 78
	xvpickev.h	$xr7, $xr5, $xr7
	xvld	$xr8, $fp, 32
	vrepli.h	$vr5, 255
	vbitsel.v	$vr6, $vr7, $vr5, $vr6
	vst	$vr6, $a0, 0
	xvpermi.q	$xr6, $xr8, 1
	...
	xvmul.d	$xr8, $xr0, $xr7
	xvori.b	$xr10, $xr1, 0
	xvmadd.d	$xr10, $xr0, $xr9
	xvori.b	$xr9, $xr1, 0
	xvmadd.d	$xr9, $xr0, $xr7
	xvmuh.d	$xr7, $xr10, $xr2
	xvadd.d	$xr7, $xr7, $xr10
	xvsrli.d	$xr10, $xr7, 63
	xvsrai.d	$xr7, $xr7, 6
	xvadd.d	$xr7, $xr7, $xr10
	xvmuh.d	$xr10, $xr9, $xr2
	xvadd.d	$xr9, $xr10, $xr9
	xvsrli.d	$xr10, $xr9, 63
	xvsrai.d	$xr9, $xr9, 6
	...
	xvori.b	$xr10, $xr1, 0
	xvmadd.d	$xr10, $xr0, $xr8
	xvmadd.d	$xr1, $xr0, $xr7
	xvmuh.d	$xr0, $xr10, $xr2
...
.LBB0_6:                                # %vector.body30
	...
	xvpermi.q	$xr7, $xr5, 2
	xvori.b	$xr5, $xr1, 0
	xvmadd.d	$xr5, $xr0, $xr8
	xvori.b	$xr6, $xr1, 0
	xvmadd.d	$xr6, $xr0, $xr7
	xvmuh.d	$xr7, $xr5, $xr2
	xvadd.d	$xr5, $xr7, $xr5
	xvsrli.d	$xr7, $xr5, 63
	xvsrai.d	$xr5, $xr5, 6
...
# %bb.5:                                # %vector.body
	...
	xvpermi.q	$xr6, $xr5, 2
	xvpermi.d	$xr5, $xr6, 78
	xvpickev.h	$xr5, $xr5, $xr6
	pcalau12i	$a1, %pc_hi20(.LCPI1_2)
	xvld	$xr6, $a1, %pc_lo12(.LCPI1_2)
	pcalau12i	$a1, %pc_hi20(.LCPI1_3)
	xvld	$xr7, $a1, %pc_lo12(.LCPI1_3)
	vbitsel.v	$vr4, $vr5, $vr12, $vr4
	vst	$vr4, $a0, 0
	xvmul.d	$xr4, $xr0, $xr6
	xvmul.d	$xr5, $xr0, $xr7
	xvori.b	$xr8, $xr11, 0
	...
	xvld	$xr6, $a1, %pc_lo12(.LCPI1_4)
	pcalau12i	$a1, %pc_hi20(.LCPI1_5)
	xvld	$xr7, $a1, %pc_lo12(.LCPI1_5)
	vbitsel.v	$vr4, $vr5, $vr12, $vr4
	vst	$vr4, $a0, 16
	xvmul.d	$xr4, $xr0, $xr6
	xvmul.d	$xr5, $xr0, $xr7
	...
	xvld	$xr6, $a1, %pc_lo12(.LCPI1_6)
	pcalau12i	$a1, %pc_hi20(.LCPI1_7)
	xvld	$xr7, $a1, %pc_lo12(.LCPI1_7)
	vbitsel.v	$vr4, $vr5, $vr12, $vr4
	vst	$vr4, $a0, 32
	xvmul.d	$xr4, $xr0, $xr6
	xvmul.d	$xr5, $xr0, $xr7
	...
	xvld	$xr6, $a1, %pc_lo12(.LCPI1_8)
	pcalau12i	$a1, %pc_hi20(.LCPI1_9)
	xvld	$xr7, $a1, %pc_lo12(.LCPI1_9)
	vbitsel.v	$vr4, $vr5, $vr12, $vr4
	vst	$vr4, $a0, 48
	xvmul.d	$xr4, $xr0, $xr6
	xvmul.d	$xr5, $xr0, $xr7
	...
	xvld	$xr6, $a1, %pc_lo12(.LCPI1_10)
	pcalau12i	$a1, %pc_hi20(.LCPI1_11)
	xvld	$xr7, $a1, %pc_lo12(.LCPI1_11)
	vbitsel.v	$vr4, $vr5, $vr12, $vr4
	vst	$vr4, $a0, 64
	xvmul.d	$xr4, $xr0, $xr6
	xvmul.d	$xr5, $xr0, $xr7
	...
	xvld	$xr6, $a1, %pc_lo12(.LCPI1_12)
	pcalau12i	$a1, %pc_hi20(.LCPI1_13)
	xvld	$xr7, $a1, %pc_lo12(.LCPI1_13)
	vbitsel.v	$vr4, $vr5, $vr12, $vr4
	vst	$vr4, $a0, 80
	xvmul.d	$xr4, $xr0, $xr6
	xvmul.d	$xr5, $xr0, $xr7
	...
	xvld	$xr6, $a1, %pc_lo12(.LCPI1_14)
	pcalau12i	$a1, %pc_hi20(.LCPI1_15)
	xvld	$xr7, $a1, %pc_lo12(.LCPI1_15)
	vbitsel.v	$vr4, $vr5, $vr12, $vr4
	vst	$vr4, $a0, 96
	xvmul.d	$xr4, $xr0, $xr6
	xvmul.d	$xr5, $xr0, $xr7
...
.LBB1_6:                                # %if.then.i7
	...
	st.w	$a2, $a0, 40
	move	$a0, $s0
	xvst	$xr11, $sp, 32                  # 32-byte Folded Spill
	vst	$vr12, $sp, 16                  # 16-byte Folded Spill
	jirl	$ra, $a1, 0
	vld	$vr12, $sp, 16                  # 16-byte Folded Reload
	xvld	$xr11, $sp, 32                  # 32-byte Folded Reload
.LBB1_7:                                # %if.end.i10
	ld.d	$a0, $s0, 96
	beqz	$a0, .LBB1_11
# %bb.8:                                # %if.end7.i12
...
.LBB1_9:                                # %vector.body67
	...
	xvslt.d	$xr2, $xr6, $xr2
	xvpermi.q	$xr8, $xr2, 1
	vpickev.w	$vr2, $vr8, $vr2
	xvpermi.q	$xr2, $xr5, 2
	xvpermi.d	$xr8, $xr2, 78
	xvpickev.h	$xr8, $xr8, $xr2
	xvpermi.q	$xr2, $xr1, 1
	...
	xvld	$xr10, $a1, %pc_lo12(.LCPI1_17)
	xvpickev.h	$xr7, $xr9, $xr7
	vbitsel.v	$vr7, $vr7, $vr12, $vr8
	vst	$vr7, $a0, 0
	xvmul.d	$xr7, $xr0, $xr10
	xvori.b	$xr8, $xr11, 0
	xvmadd.d	$xr8, $xr0, $xr10
	xvmuh.d	$xr9, $xr8, $xr3
	xvadd.d	$xr8, $xr9, $xr8
	xvsrli.d	$xr9, $xr8, 63
	xvsrai.d	$xr8, $xr8, 6
	...
	xvld	$xr10, $a1, %pc_lo12(.LCPI1_18)
	xvpickev.h	$xr8, $xr9, $xr8
	vbitsel.v	$vr7, $vr8, $vr12, $vr7
	vst	$vr7, $a0, 16
	xvmul.d	$xr7, $xr0, $xr10
	xvori.b	$xr8, $xr11, 0
	xvmadd.d	$xr8, $xr0, $xr10
	...
	xvld	$xr10, $a1, %pc_lo12(.LCPI1_19)
	xvpickev.h	$xr8, $xr9, $xr8
	vbitsel.v	$vr7, $vr8, $vr12, $vr7
	vst	$vr7, $a0, 32
	xvmul.d	$xr7, $xr0, $xr10
	xvmadd.d	$xr11, $xr0, $xr10
	xvmuh.d	$xr3, $xr11, $xr3
	...
	xvpickev.h	$xr0, $xr0, $xr3
	xvpermi.q	$xr3, $xr1, 1
	vpickev.w	$vr1, $vr3, $vr1
	xvpermi.q	$xr1, $xr2, 2
	xvpermi.d	$xr2, $xr1, 78
	xvpickev.h	$xr1, $xr2, $xr1
	vbitsel.v	$vr0, $vr1, $vr12, $vr0
	vst	$vr0, $a0, 64
	vst	$vr0, $a0, 80
	vst	$vr0, $a0, 96
	vst	$vr0, $a0, 112
	b	.LBB1_13
.LBB1_10:                               # %vector.body59
	pcalau12i	$a1, %pc_hi20(.LCPI1_1)
	...
	xvmin.d	$xr3, $xr3, $xr2
	xvpermi.q	$xr5, $xr3, 1
	vpickev.w	$vr5, $vr5, $vr3
	xvpermi.q	$xr3, $xr4, 1
	pcalau12i	$a1, %pc_hi20(.LCPI1_3)
	xvld	$xr6, $a1, %pc_lo12(.LCPI1_3)
	pcalau12i	$a1, %pc_hi20(.LCPI1_2)
	xvld	$xr7, $a1, %pc_lo12(.LCPI1_2)
	vpickev.w	$vr3, $vr3, $vr4
	xvpermi.q	$xr3, $xr5, 2
	xvori.b	$xr4, $xr11, 0
	xvmadd.d	$xr4, $xr0, $xr6
	xvori.b	$xr5, $xr11, 0
	xvmadd.d	$xr5, $xr0, $xr7
	xvmuh.d	$xr6, $xr5, $xr1
	xvadd.d	$xr5, $xr6, $xr5
	xvsrli.d	$xr6, $xr5, 63
	xvsrai.d	$xr5, $xr5, 6
	...
	vpickve2gr.h	$a1, $vr5, 4
	vinsgr2vr.h	$vr4, $a1, 2
	vpickve2gr.h	$a1, $vr5, 6
...
.LBB1_12:                               # %vector.body75
	...
	xvmin.d	$xr5, $xr5, $xr4
	pcalau12i	$a1, %pc_hi20(.LCPI1_19)
	xvld	$xr6, $a1, %pc_lo12(.LCPI1_19)
	xvpermi.q	$xr7, $xr5, 1
	vpickev.w	$vr5, $vr7, $vr5
	xvpermi.q	$xr5, $xr2, 2
	xvmadd.d	$xr11, $xr0, $xr6
	xvmuh.d	$xr0, $xr11, $xr3
	...
	xvld	$xr3, $a1, %pc_lo12(.LCPI1_20)
	vpickev.w	$vr0, $vr0, $vr1
	xvpermi.q	$xr0, $xr2, 2
	xvpermi.d	$xr1, $xr0, 78
	xvshuf.h	$xr3, $xr1, $xr0
	xvst	$xr3, $a0, 64
	xvst	$xr3, $a0, 96
...
# %bb.13:                               # %pred.store.continue
	...
	andi	$a1, $a1, 1
	bnez	$a1, .LBB7_63
.LBB7_14:                               # %pred.store.continue345
	xvpermi.q	$xr1, $xr0, 1
	vpickve2gr.w	$a1, $vr1, 0
	andi	$a1, $a1, 1
	bnez	$a1, .LBB7_64
.LBB7_15:                               # %pred.store.continue347
	xvpermi.q	$xr0, $xr0, 1
	vpickve2gr.w	$a1, $vr0, 2
	andi	$a1, $a1, 1
	beqz	$a1, .LBB7_17
.LBB7_16:                               # %pred.store.if348
	ori	$a1, $zero, 3
	st.w	$a1, $a0, 16
.LBB7_17:                               # %pred.store.continue349
	pcalau12i	$a1, %pc_hi20(.LCPI7_0)
...
# %bb.23:                               # %middle.block
	beq	$a1, $s0, .LBB7_26
# %bb.24:                               # %for.body.i.i.preheader500
	ori	$a0, $zero, 1
	.p2align	4, , 16
...
.LBB7_28:                               # %vector.body356
	...
	addi.d	$a7, $a7, 2
	bnez	$t1, .LBB7_28
# %bb.29:                               # %middle.block363
	bne	$a0, $a5, .LBB7_31
	b	.LBB7_33
.LBB7_30:
	move	$a5, $zero
	move	$a4, $a3
.LBB7_31:                               # %for.body.i57.preheader492
	vld	$vr0, $a6, %pc_lo12(.LCPI7_2)
	ori	$a3, $zero, 1
	.p2align	4, , 16
...
.LBB7_37:
	move	$a5, $zero
	move	$a3, $a4
.LBB7_38:                               # %for.body.i64.preheader490
	vld	$vr0, $a6, %pc_lo12(.LCPI7_3)
	ori	$a4, $zero, 1
	.p2align	4, , 16
...
.LBB7_42:                               # %vector.body387
	...
	addi.d	$a7, $a7, 2
	bnez	$t1, .LBB7_42
# %bb.43:                               # %middle.block394
	bne	$a0, $a5, .LBB7_45
	b	.LBB7_47
.LBB7_44:
	move	$a5, $zero
	move	$a4, $a3
.LBB7_45:                               # %for.body.i79.preheader487
	vld	$vr0, $a6, %pc_lo12(.LCPI7_4)
	ori	$a3, $zero, 1
	.p2align	4, , 16
...
.LBB7_51:                               # %vector.body402
	...
	addi.d	$a6, $a6, 2
	bnez	$t0, .LBB7_51
# %bb.52:                               # %middle.block409
	beq	$a5, $s0, .LBB7_55
# %bb.53:                               # %for.body.i.i92.preheader499
	ori	$a4, $zero, 1
	.p2align	4, , 16
...
.LBB7_75:
	move	$a2, $zero
	move	$a1, $a3
.LBB7_76:                               # %for.body.i124.preheader485
	vld	$vr0, $a4, %pc_lo12(.LCPI7_8)
	ori	$a0, $zero, 1
	.p2align	4, , 16
