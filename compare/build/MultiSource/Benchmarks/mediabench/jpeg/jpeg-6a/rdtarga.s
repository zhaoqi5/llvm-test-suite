...
.LBB9_6:                                # %if.then11
	...
	move	$a2, $a0
.LBB9_7:                                # %if.end13
	pcalau12i	$a0, %pc_hi20(get_memory_row)
	addi.d	$a0, $a0, %pc_lo12(get_memory_row)
	ld.d	$a1, $s0, 8
	ld.d	$a5, $a1, 56
	ld.d	$a1, $fp, 64
	st.d	$a0, $fp, 8
