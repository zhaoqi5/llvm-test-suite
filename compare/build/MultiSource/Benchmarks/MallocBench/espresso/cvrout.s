...
# %bb.42:                               # %for.body169.preheader
	...
	.p2align	4, , 16
.LBB17_43:                              # %for.inc191
                                        #   in Loop: Header=BB17_44 Depth=3
	addi.w	$s2, $s2, 1
	addi.d	$fp, $fp, 1
	bge	$s2, $a0, .LBB17_38
.LBB17_44:                              # %for.body169
                                        #   Parent Loop BB17_4 Depth=1
...
# %bb.57:                               # %if.then140
	...
	ld.w	$a0, $s3, 4
	b	.LBB17_55
.LBB17_58:                              # %vector.main.loop.iter.check
                                        #   in Loop: Header=BB17_4 Depth=1
	ori	$a1, $zero, 16
	bgeu	$s3, $a1, .LBB17_60
...
.LBB17_64:                              # %vec.epilog.ph
	...
	alsl.d	$a3, $a3, $s4, 2
	.p2align	4, , 16
.LBB17_65:                              # %vec.epilog.vector.body
                                        #   Parent Loop BB17_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vadd.w	$vr2, $vr0, $vr1
	vst	$vr2, $a3, 0
