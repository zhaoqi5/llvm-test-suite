...
.LBB1_41:                               # %for.body103.i
	...
	addi.d	$a7, $a7, 1
	bltu	$a7, $a5, .LBB1_47
# %bb.42:                               # %vector.memcheck69
                                        #   in Loop: Header=BB1_41 Depth=1
	alsl.d	$t2, $t1, $a1, 2
	alsl.d	$t4, $t0, $a3, 2
	alsl.d	$t3, $t0, $a1, 2
	bgeu	$t2, $t4, .LBB1_44
# %bb.43:                               # %vector.memcheck69
                                        #   in Loop: Header=BB1_41 Depth=1
	addi.d	$t2, $t3, 4
	alsl.d	$t1, $t1, $s2, 2
	bltu	$t1, $t2, .LBB1_47
...
.LBB2_41:                               # %for.body100.i
	...
	addi.d	$a6, $a6, 1
	bltu	$a6, $a4, .LBB2_47
# %bb.42:                               # %vector.memcheck59
                                        #   in Loop: Header=BB2_41 Depth=1
	alsl.d	$t1, $t0, $a0, 2
	alsl.d	$t3, $a7, $a2, 2
	alsl.d	$t2, $a7, $a0, 2
	bgeu	$t1, $t3, .LBB2_44
# %bb.43:                               # %vector.memcheck59
                                        #   in Loop: Header=BB2_41 Depth=1
	addi.d	$t1, $t2, 4
	alsl.d	$t0, $t0, $s0, 2
	bltu	$t0, $t1, .LBB2_47
...
# %bb.31:                               # %vector.memcheck232
	...
	alsl.d	$a4, $a0, $s7, 2
	bgeu	$a5, $a6, .LBB4_33
# %bb.32:                               # %vector.memcheck232
                                        #   in Loop: Header=BB4_27 Depth=1
	addi.d	$a5, $a4, 4
	alsl.d	$a2, $a2, $s5, 2
	bltu	$a2, $a5, .LBB4_36
.LBB4_33:                               # %vector.ph246
                                        #   in Loop: Header=BB4_27 Depth=1
	move	$a2, $a1
	bstrins.d	$a2, $zero, 2, 0
	sub.d	$a0, $a0, $a2
...
# %bb.56:                               # %vector.memcheck261
	...
	alsl.d	$a4, $a1, $s4, 2
	bgeu	$a3, $a5, .LBB4_58
# %bb.57:                               # %vector.memcheck261
                                        #   in Loop: Header=BB4_47 Depth=1
	addi.d	$a3, $a4, 4
	alsl.d	$a2, $a2, $s7, 2
	bltu	$a2, $a3, .LBB4_61
.LBB4_58:                               # %vector.ph275
                                        #   in Loop: Header=BB4_47 Depth=1
	move	$a2, $a0
	bstrins.d	$a2, $zero, 2, 0
	sub.d	$a3, $a1, $a2
...
# %bb.75:                               # %vector.memcheck290
	...
	alsl.d	$a4, $a1, $s4, 2
	bgeu	$a3, $a5, .LBB4_77
# %bb.76:                               # %vector.memcheck290
                                        #   in Loop: Header=BB4_66 Depth=1
	addi.d	$a3, $a4, 4
	alsl.d	$a2, $a2, $s5, 2
	bltu	$a2, $a3, .LBB4_80
.LBB4_77:                               # %vector.ph304
                                        #   in Loop: Header=BB4_66 Depth=1
	move	$a2, $a0
	bstrins.d	$a2, $zero, 2, 0
	sub.d	$a3, $a1, $a2
...
.LBB5_12:                               # %do.end
	...
	ori	$a3, $zero, 8
	bltu	$a0, $a3, .LBB5_18
# %bb.13:                               # %vector.memcheck42
                                        #   in Loop: Header=BB5_4 Depth=1
	alsl.d	$a3, $a2, $s2, 2
	alsl.d	$a4, $a1, $s4, 2
	addi.d	$a5, $a4, 4
	bgeu	$a3, $a5, .LBB5_15
# %bb.14:                               # %vector.memcheck42
                                        #   in Loop: Header=BB5_4 Depth=1
	addi.d	$a3, $s2, 4
	alsl.d	$a3, $a1, $a3, 2
	alsl.d	$a2, $a2, $s4, 2
