...
# %bb.25:                               # %middle.block
	beq	$a2, $a4, .LBB3_28
.LBB3_26:                               # %for.body90.preheader157
	slli.d	$a2, $a3, 2
	sub.d	$a0, $a2, $a0
...
# %bb.29:                               # %for.body114.preheader
	...
	b	.LBB3_31
	.p2align	4, , 16
.LBB3_30:                               # %map_symbolic_cover.exit116
...
.LBB3_35:                               # %map_symbolic_cover.exit
	...
	st.d	$s8, $fp, 0
	blez	$a0, .LBB3_39
# %bb.36:                               # %for.body.i96.preheader
                                        #   in Loop: Header=BB3_31 Depth=1
	ld.d	$s6, $s2, 24
	alsl.d	$s8, $a0, $s6, 2
	.p2align	4, , 16
.LBB3_37:                               # %for.body.i96
                                        #   Parent Loop BB3_31 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$a0, $s6
	move	$a1, $s4
	...
	alsl.d	$s6, $a0, $s6, 2
	bltu	$s6, $s8, .LBB3_37
# %bb.38:                               # %map_symbolic_cover.exit102.loopexit
                                        #   in Loop: Header=BB3_31 Depth=1
	ld.d	$s5, $s3, 0
.LBB3_39:                               # %map_symbolic_cover.exit102
                                        #   in Loop: Header=BB3_31 Depth=1
	ld.d	$s8, $fp, 16
	ld.w	$a0, $s8, 12
	ld.w	$a1, $s8, 0
	...
	st.d	$s2, $fp, 8
	blez	$a0, .LBB3_30
# %bb.40:                               # %for.body.i110.preheader
                                        #   in Loop: Header=BB3_31 Depth=1
	ld.d	$s6, $s8, 24
	alsl.d	$s2, $a0, $s6, 2
	.p2align	4, , 16
.LBB3_41:                               # %for.body.i110
                                        #   Parent Loop BB3_31 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$a0, $s6
	move	$a1, $s4
