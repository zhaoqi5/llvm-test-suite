...
# %bb.35:                               # %for.body114.preheader
	...
	b	.LBB3_37
	.p2align	4, , 16
.LBB3_36:                               # %map_symbolic_cover.exit116
...
.LBB3_41:                               # %map_symbolic_cover.exit
	...
	st.d	$s2, $fp, 0
	blez	$a0, .LBB3_45
# %bb.42:                               # %for.body.i96.preheader
                                        #   in Loop: Header=BB3_37 Depth=1
	ld.d	$s6, $s8, 24
	alsl.d	$s2, $a0, $s6, 2
	.p2align	4, , 16
.LBB3_43:                               # %for.body.i96
                                        #   Parent Loop BB3_37 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$a0, $s6
	move	$a1, $s4
	...
	alsl.d	$s6, $a0, $s6, 2
	bltu	$s6, $s2, .LBB3_43
# %bb.44:                               # %map_symbolic_cover.exit102.loopexit
                                        #   in Loop: Header=BB3_37 Depth=1
	ld.d	$s5, $s3, 0
.LBB3_45:                               # %map_symbolic_cover.exit102
                                        #   in Loop: Header=BB3_37 Depth=1
	ld.d	$s2, $fp, 16
	ld.w	$a0, $s2, 12
	ld.w	$a1, $s2, 0
	...
	st.d	$s8, $fp, 8
	blez	$a0, .LBB3_36
# %bb.46:                               # %for.body.i110.preheader
                                        #   in Loop: Header=BB3_37 Depth=1
	ld.d	$s6, $s2, 24
	alsl.d	$s8, $a0, $s6, 2
	.p2align	4, , 16
.LBB3_47:                               # %for.body.i110
                                        #   Parent Loop BB3_37 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$a0, $s6
	move	$a1, $s4
