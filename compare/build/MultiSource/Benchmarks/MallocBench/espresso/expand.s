...
# %bb.0:                                # %entry
	...
	pcalau12i	$a3, %got_pc_hi20(use_random_order)
	ld.d	$a3, $a3, %got_pc_lo12(use_random_order)
	ld.w	$a3, $a3, 0
	move	$s6, $a2
...
# %bb.0:                                # %entry
	...
	pcalau12i	$t0, %got_pc_hi20(debug)
	ld.d	$t0, $t0, %got_pc_lo12(debug)
	ld.bu	$t0, $t0, 0
	ld.d	$s7, $sp, 96
	andi	$t0, $t0, 8
	move	$s3, $a7
...
.LBB1_16:                               # %while.body
	...
	ld.w	$a0, $s2, 16
	bgtz	$a0, .LBB1_16
.LBB1_17:                               # %while.cond26.preheader
	ld.w	$a0, $s1, 16
	blt	$a0, $s5, .LBB1_19
	.p2align	4, , 16
...
# %bb.8:                                # %if.then10
	...
	ld.d	$a1, $a1, %got_pc_lo12(bit_count)
	and	$a3, $a0, $fp
	andi	$a4, $a0, 255
	slli.d	$a4, $a4, 2
	ldx.w	$a4, $a1, $a4
...
.Lfunc_end6:
	...
	.p2align	5, 0x0                          # -- Begin function select_feasible
.LCPI7_0:
	.dword	0                               # 0x0
	.dword	1                               # 0x1
	.dword	2                               # 0x2
...
.LBB7_20:                               # %if.end63
	...
	beqz	$a1, .LBB7_38
# %bb.21:                               # %for.cond74.preheader
                                        #   in Loop: Header=BB7_16 Depth=1
	ori	$a0, $zero, 1
	blt	$a1, $a0, .LBB7_29
# %bb.22:                               # %for.body77.us.preheader
                                        #   in Loop: Header=BB7_16 Depth=1
	move	$s7, $a1
	move	$s1, $zero
	move	$s6, $zero
...
.LBB7_26:                               # %for.body84.us
	...
	addi.d	$s5, $s5, 8
	bnez	$s7, .LBB7_26
# %bb.27:                               # %for.cond81.for.end96_crit_edge.us
                                        #   in Loop: Header=BB7_25 Depth=2
	bge	$s6, $fp, .LBB7_23
...
.LBB9_35:                               # %most_frequent.exit
	...
	move	$s3, $a0
	blt	$s7, $s5, .LBB9_40
# %bb.36:                               # %for.body21.preheader.i63
	slli.d	$a2, $s7, 2
	move	$a0, $s3
	move	$a1, $zero
	pcaddu18i	$ra, %call36(memset)
	...
	b	.LBB9_38
	.p2align	4, , 16
.LBB9_37:                               # %for.inc35.i80
                                        #   in Loop: Header=BB9_38 Depth=1
	addi.d	$a1, $a1, 1
	addi.d	$a3, $a3, 4
	addi.w	$a0, $a0, 1
	beq	$s7, $a1, .LBB9_41
.LBB9_38:                               # %for.body21.i65
                                        # =>This Inner Loop Header: Depth=1
	srli.d	$a5, $a1, 3
	and	$a5, $a5, $a2
	ldx.w	$a5, $s6, $a5
...
.LBB9_40:
	addi.w	$s4, $zero, -1
.LBB9_41:                               # %for.end37.i53
	beqz	$s3, .LBB9_43
# %bb.42:                               # %if.then39.i56
	move	$a0, $s3
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
.LBB9_43:                               # %if.end40.i57
	ld.bu	$a0, $s8, 0
	andi	$a0, $a0, 8
	sll.w	$fp, $s5, $s2
	beqz	$a0, .LBB9_45
...
.LBB10_9:                               # %for.body36
	...
	st.w	$t4, $a0, 0
	bltu	$t1, $a6, .LBB10_15
# %bb.10:                               # %vector.memcheck64
                                        #   in Loop: Header=BB10_9 Depth=1
	alsl.d	$t4, $t3, $a0, 2
	alsl.d	$t6, $t2, $a3, 2
	alsl.d	$t5, $t2, $a0, 2
	bgeu	$t4, $t6, .LBB10_12
# %bb.11:                               # %vector.memcheck64
                                        #   in Loop: Header=BB10_9 Depth=1
	addi.d	$t4, $t5, 4
	alsl.d	$t3, $t3, $s0, 2
	bltu	$t3, $t4, .LBB10_15
.LBB10_12:                              # %vector.ph78
                                        #   in Loop: Header=BB10_9 Depth=1
	move	$t3, $t1
...
.LBB10_13:                              # %vector.body81
	...
	addi.d	$t2, $t2, -32
	bnez	$t6, .LBB10_13
# %bb.14:                               # %middle.block90
                                        #   in Loop: Header=BB10_9 Depth=1
	move	$t2, $t4
	beq	$t1, $t3, .LBB10_17
	.p2align	4, , 16
.LBB10_15:                              # %do.body.preheader
                                        #   in Loop: Header=BB10_9 Depth=1
	addi.d	$t1, $t2, 1
	alsl.d	$t3, $t2, $a0, 2
	alsl.d	$t2, $t2, $s0, 2
