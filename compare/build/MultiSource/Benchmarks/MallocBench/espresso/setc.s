...
# %bb.11:                               # %vector.ph
	...
	b	.LBB5_13
	.p2align	4, , 16
.LBB5_12:                               # %pred.store.continue118
...
# %bb.14:                               # %pred.store.if
	...
	andi	$t0, $t0, 1
	bnez	$t0, .LBB5_22
.LBB5_15:                               # %pred.store.continue106
                                        #   in Loop: Header=BB5_13 Depth=1
	xvpickve2gr.w	$t0, $xr3, 2
	andi	$t0, $t0, 1
	beqz	$t0, .LBB5_23
.LBB5_16:                               # %pred.store.if107
                                        #   in Loop: Header=BB5_13 Depth=1
	xvstelm.w	$xr4, $a6, -4, 2
	xvpickve2gr.w	$t0, $xr3, 3
	andi	$t0, $t0, 1
	bnez	$t0, .LBB5_24
.LBB5_17:                               # %pred.store.continue110
                                        #   in Loop: Header=BB5_13 Depth=1
	xvpickve2gr.w	$t0, $xr3, 4
	andi	$t0, $t0, 1
	beqz	$t0, .LBB5_25
.LBB5_18:                               # %pred.store.if111
                                        #   in Loop: Header=BB5_13 Depth=1
	xvstelm.w	$xr4, $a6, 4, 4
	xvpickve2gr.w	$t0, $xr3, 5
	andi	$t0, $t0, 1
	bnez	$t0, .LBB5_26
.LBB5_19:                               # %pred.store.continue114
                                        #   in Loop: Header=BB5_13 Depth=1
	xvpickve2gr.w	$t0, $xr3, 6
	andi	$t0, $t0, 1
	beqz	$t0, .LBB5_27
.LBB5_20:                               # %pred.store.if115
                                        #   in Loop: Header=BB5_13 Depth=1
...
.LBB5_21:                               # %pred.store.continue
	...
	andi	$t0, $t0, 1
	beqz	$t0, .LBB5_15
.LBB5_22:                               # %pred.store.if105
                                        #   in Loop: Header=BB5_13 Depth=1
	xvstelm.w	$xr4, $a6, -8, 1
	xvpickve2gr.w	$t0, $xr3, 2
	andi	$t0, $t0, 1
	bnez	$t0, .LBB5_16
.LBB5_23:                               # %pred.store.continue108
                                        #   in Loop: Header=BB5_13 Depth=1
	xvpickve2gr.w	$t0, $xr3, 3
	andi	$t0, $t0, 1
	beqz	$t0, .LBB5_17
.LBB5_24:                               # %pred.store.if109
                                        #   in Loop: Header=BB5_13 Depth=1
	xvstelm.w	$xr4, $a6, 0, 3
	xvpickve2gr.w	$t0, $xr3, 4
	andi	$t0, $t0, 1
	bnez	$t0, .LBB5_18
.LBB5_25:                               # %pred.store.continue112
                                        #   in Loop: Header=BB5_13 Depth=1
	xvpickve2gr.w	$t0, $xr3, 5
	andi	$t0, $t0, 1
	beqz	$t0, .LBB5_19
.LBB5_26:                               # %pred.store.if113
                                        #   in Loop: Header=BB5_13 Depth=1
	xvstelm.w	$xr4, $a6, 8, 5
	xvpickve2gr.w	$t0, $xr3, 6
	andi	$t0, $t0, 1
	bnez	$t0, .LBB5_20
.LBB5_27:                               # %pred.store.continue116
                                        #   in Loop: Header=BB5_13 Depth=1
	xvpickve2gr.w	$t0, $xr3, 7
	andi	$t0, $t0, 1
	beqz	$t0, .LBB5_12
.LBB5_28:                               # %pred.store.if117
                                        #   in Loop: Header=BB5_13 Depth=1
