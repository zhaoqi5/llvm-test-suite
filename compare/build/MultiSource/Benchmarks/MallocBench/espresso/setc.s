...
# %bb.15:                               # %for.cond45
	...
	addi.d	$s2, $s2, 4
	bnez	$s3, .LBB4_14
# %bb.16:                               # %for.body66.preheader
                                        #   in Loop: Header=BB4_12 Depth=1
	addi.w	$t8, $fp, 0
	bgeu	$t8, $t4, .LBB4_19
.LBB4_17:                               # %for.body66.preheader86
                                        #   in Loop: Header=BB4_12 Depth=1
	alsl.d	$t8, $t6, $a1, 2
	alsl.d	$t7, $t6, $t7, 2
	alsl.d	$fp, $t6, $a0, 2
...
# %bb.11:                               # %vector.ph
	...
	b	.LBB5_13
	.p2align	4, , 16
.LBB5_12:                               # %pred.store.continue114
...
.LBB5_16:                               # %pred.store.if111
	...
	b	.LBB5_20
	.p2align	4, , 16
.LBB5_17:                               # %pred.store.continue
                                        #   in Loop: Header=BB5_13 Depth=1
	vpickve2gr.w	$t0, $vr3, 1
	andi	$t0, $t0, 1
	beqz	$t0, .LBB5_15
.LBB5_18:                               # %pred.store.if109
                                        #   in Loop: Header=BB5_13 Depth=1
	vstelm.w	$vr4, $a6, 0, 1
	vpickve2gr.w	$t0, $vr3, 2
	andi	$t0, $t0, 1
	bnez	$t0, .LBB5_16
.LBB5_19:                               # %pred.store.continue112
                                        #   in Loop: Header=BB5_13 Depth=1
	vpickve2gr.w	$t0, $vr3, 3
	andi	$t0, $t0, 1
	beqz	$t0, .LBB5_12
.LBB5_20:                               # %pred.store.if113
                                        #   in Loop: Header=BB5_13 Depth=1
	vstelm.w	$vr4, $a6, 8, 3
	b	.LBB5_12
...
.LBB5_25:                               # %for.body54
	...
	ldx.d	$t5, $a1, $t5
	blt	$t4, $t6, .LBB5_32
# %bb.26:                               # %for.body63.preheader
                                        #   in Loop: Header=BB5_25 Depth=1
	move	$t8, $zero
	sub.d	$t7, $zero, $t4
.LBB5_27:                               # %for.body63.outer
...
.LBB5_32:                               # %if.then82
	...
	ld.w	$s4, $a7, 0
	blt	$t4, $s4, .LBB5_24
# %bb.33:                               # %for.body87.preheader
                                        #   in Loop: Header=BB5_25 Depth=1
	sub.d	$t8, $t4, $s4
	addi.w	$t6, $t8, 0
	bgeu	$t6, $t2, .LBB5_37
.LBB5_34:                               #   in Loop: Header=BB5_25 Depth=1
	move	$t6, $s4
.LBB5_35:                               # %for.body87.preheader159
                                        #   in Loop: Header=BB5_25 Depth=1
	alsl.d	$t5, $t6, $t5, 2
	alsl.d	$t7, $t6, $s0, 2
	alsl.d	$t8, $t6, $fp, 2
