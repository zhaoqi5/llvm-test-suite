...
.LBB22_6:
	move	$a1, $a6
	move	$a4, $a5
.LBB22_7:                               # %for.body.i.preheader19
	sub.d	$a2, $a2, $a3
	.p2align	4, , 16
.LBB22_8:                               # %for.body.i
                                        # =>This Inner Loop Header: Depth=1
...
.LBB23_11:
	move	$a1, $a0
	move	$a3, $a4
.LBB23_12:                              # %for.body.i.preheader61
	sub.d	$a2, $s3, $a2
	.p2align	4, , 16
.LBB23_13:                              # %for.body.i
                                        # =>This Inner Loop Header: Depth=1
...
.LBB23_14:                              # %intcpy.exit
	blez	$s2, .LBB23_20
# %bb.15:                               # %for.body.i20.preheader
	ld.d	$a4, $s0, 24
	ori	$a2, $zero, 8
	alsl.d	$a1, $s3, $a0, 2
	bltu	$s2, $a2, .LBB23_17
# %bb.16:                               # %vector.memcheck38
	alsl.d	$a2, $s3, $a0, 2
	sub.d	$a2, $a2, $a4
	ori	$a3, $zero, 32
	bgeu	$a2, $a3, .LBB23_21
.LBB23_17:
	move	$a3, $zero
	move	$a2, $a4
.LBB23_18:                              # %for.body.i20.preheader60
	sub.d	$a0, $s2, $a3
	.p2align	4, , 16
.LBB23_19:                              # %for.body.i20
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a3, $a2, 0
	addi.d	$a2, $a2, 4
	addi.d	$a4, $a1, 4
...
.LBB24_8:
	move	$a5, $zero
	move	$a4, $a0
.LBB24_9:                               # %for.body.i.preheader31
	sub.d	$a1, $a3, $a5
	.p2align	4, , 16
.LBB24_10:                              # %for.body.i
                                        # =>This Inner Loop Header: Depth=1
...
.LBB26_3:                               # %sf_new.exit
	...
	st.w	$a4, $fp, 16
	blez	$a1, .LBB26_12
# %bb.4:                                # %for.body.i.preheader.i
	ld.d	$a5, $s0, 24
	ori	$a2, $zero, 8
	move	$a3, $zero
	bltu	$a1, $a2, .LBB26_9
# %bb.5:                                # %for.body.i.preheader.i
	sub.d	$a2, $a0, $a5
	ori	$a4, $zero, 32
	bltu	$a2, $a4, .LBB26_9
# %bb.6:                                # %vector.ph
...
.LBB26_9:
	move	$a2, $a0
	move	$a4, $a5
.LBB26_10:                              # %for.body.i.i.preheader
	sub.d	$a0, $a1, $a3
	.p2align	4, , 16
.LBB26_11:                              # %for.body.i.i
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a1, $a4, 0
	addi.d	$a4, $a4, 4
	addi.d	$a3, $a2, 4
