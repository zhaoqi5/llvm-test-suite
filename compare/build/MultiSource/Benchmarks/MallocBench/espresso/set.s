...
.LBB23_27:                              # %intcpy.exit28
	...
	addi.d	$sp, $sp, 80
	ret
.LBB23_28:                              # %vector.main.loop.iter.check54
	ori	$a2, $zero, 16
	bgeu	$s2, $a2, .LBB23_30
# %bb.29:
	move	$a2, $zero
	b	.LBB23_34
.LBB23_30:                              # %vector.ph55
	slli.d	$a5, $s3, 2
...
.LBB23_31:                              # %vector.body58
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB23_31
# %bb.32:                               # %middle.block65
	beq	$a2, $s2, .LBB23_27
# %bb.33:                               # %vec.epilog.iter.check70
	andi	$a4, $s2, 12
	beqz	$a4, .LBB23_37
.LBB23_34:                              # %vec.epilog.ph69
	move	$a5, $a2
	...
	sub.d	$a5, $a5, $a2
	.p2align	4, , 16
.LBB23_35:                              # %vec.epilog.vector.body75
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a3, 0
	vst	$vr0, $a0, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a0, $a0, 16
	bnez	$a5, .LBB23_35
# %bb.36:                               # %vec.epilog.middle.block83
	bne	$a2, $s2, .LBB23_25
	b	.LBB23_27
.LBB23_37:
	alsl.d	$a1, $a2, $a1, 2
