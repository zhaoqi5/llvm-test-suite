...
.LBB23_23:
	move	$a2, $zero
	move	$a4, $a3
.LBB23_24:                              # %for.body.i20.preheader
	sub.d	$a0, $s2, $a2
	.p2align	4, , 16
.LBB23_25:                              # %for.body.i20
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a2, $a4, 0
	addi.d	$a4, $a4, 4
	addi.d	$a3, $a1, 4
...
.LBB23_26:                              # %intcpy.exit28
	...
	addi.d	$sp, $sp, 80
	ret
.LBB23_27:                              # %vector.main.loop.iter.check54
	ori	$a2, $zero, 16
	bgeu	$s2, $a2, .LBB23_29
# %bb.28:
	move	$a2, $zero
	b	.LBB23_33
.LBB23_29:                              # %vector.ph55
	slli.d	$a5, $s3, 2
...
.LBB23_30:                              # %vector.body58
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB23_30
# %bb.31:                               # %middle.block65
	beq	$a2, $s2, .LBB23_26
# %bb.32:                               # %vec.epilog.iter.check69
	andi	$a4, $s2, 12
	beqz	$a4, .LBB23_37
.LBB23_33:                              # %vec.epilog.ph71
	move	$a5, $a2
	...
	sub.d	$a5, $a5, $a2
	.p2align	4, , 16
.LBB23_34:                              # %vec.epilog.vector.body74
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a3, 0
	vst	$vr0, $a0, 0
	addi.d	$a3, $a3, 16
	...
	addi.d	$a0, $a0, 16
	bnez	$a5, .LBB23_34
# %bb.35:                               # %vec.epilog.middle.block82
	bne	$a2, $s2, .LBB23_24
	b	.LBB23_26
.LBB23_36:
	alsl.d	$a3, $a1, $a0, 2
...
# %bb.15:                               # %vec.epilog.middle.block
	beq	$a1, $a2, .LBB26_18
.LBB26_16:                              # %for.body.i.i.preheader
	sub.d	$a0, $a1, $a2
	.p2align	4, , 16
.LBB26_17:                              # %for.body.i.i
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a1, $a5, 0
	addi.d	$a5, $a5, 4
	addi.d	$a2, $a4, 4
...
# %bb.6:                                # %for.body.us.us.preheader
	...
	b	.LBB44_8
	.p2align	4, , 16
.LBB44_7:                               # %for.cond34.for.inc60_crit_edge.us.us
                                        #   in Loop: Header=BB44_8 Depth=1
	ld.d	$a0, $sp, 72                    # 8-byte Folded Reload
	alsl.d	$s8, $a0, $s8, 2
	ld.d	$a0, $sp, 88                    # 8-byte Folded Reload
	bgeu	$s8, $a0, .LBB44_31
.LBB44_8:                               # %for.body.us.us
                                        # =>This Loop Header: Depth=1
	...
	b	.LBB44_10
	.p2align	4, , 16
.LBB44_9:                               # %for.inc.us.us
                                        #   in Loop: Header=BB44_10 Depth=2
	addi.w	$a0, $a0, 1
	beq	$s4, $a0, .LBB44_12
.LBB44_10:                              # %for.body15.us.us
...
.LBB44_12:                              #   in Loop: Header=BB44_8 Depth=1
	...
	b	.LBB44_14
	.p2align	4, , 16
.LBB44_13:                              # %for.inc57.us.us
                                        #   in Loop: Header=BB44_14 Depth=2
	addi.w	$a0, $a0, 1
	bge	$a0, $s7, .LBB44_7
.LBB44_14:                              # %for.body37.us.us
                                        #   Parent Loop BB44_8 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	bstrpick.d	$a1, $a0, 31, 5
	slli.d	$a1, $a1, 2
...
.LBB44_16:                              # %for.body.lr.ph.split
	blez	$s4, .LBB44_29
# %bb.17:                               # %for.body.us48.preheader
	move	$s2, $zero
	ori	$fp, $zero, 1
	b	.LBB44_19
	.p2align	4, , 16
.LBB44_18:                              # %for.cond13.for.end_crit_edge.us86
                                        #   in Loop: Header=BB44_19 Depth=1
	ld.d	$a0, $sp, 72                    # 8-byte Folded Reload
	alsl.d	$s8, $a0, $s8, 2
	ld.d	$a0, $sp, 88                    # 8-byte Folded Reload
	bgeu	$s8, $a0, .LBB44_31
.LBB44_19:                              # %for.body.us48
                                        # =>This Loop Header: Depth=1
	...
	b	.LBB44_21
	.p2align	4, , 16
.LBB44_20:                              # %for.inc.us81
                                        #   in Loop: Header=BB44_21 Depth=2
	addi.w	$a0, $a0, 1
	beq	$s4, $a0, .LBB44_18
.LBB44_21:                              # %for.body15.us68
...
# %bb.22:                               # %if.then.us78
	...
	stx.w	$a2, $s5, $a1
	b	.LBB44_20
.LBB44_23:                              # %for.body.us.preheader
	move	$s4, $zero
	sub.d	$fp, $zero, $a3
	ori	$s0, $zero, 1
	b	.LBB44_25
	.p2align	4, , 16
.LBB44_24:                              # %for.cond34.for.inc60_crit_edge.us
                                        #   in Loop: Header=BB44_25 Depth=1
	ld.d	$a0, $sp, 72                    # 8-byte Folded Reload
	alsl.d	$s8, $a0, $s8, 2
	ld.d	$a0, $sp, 88                    # 8-byte Folded Reload
	bgeu	$s8, $a0, .LBB44_31
.LBB44_25:                              # %for.body.us
                                        # =>This Loop Header: Depth=1
	...
	b	.LBB44_27
	.p2align	4, , 16
.LBB44_26:                              # %for.inc57.us
                                        #   in Loop: Header=BB44_27 Depth=2
	addi.w	$a0, $a0, 1
	bge	$a0, $s7, .LBB44_24
.LBB44_27:                              # %for.body37.us
...
.LBB46_11:                              # %for.body
	...
	add.d	$s2, $s2, $s8
	blt	$s4, $a1, .LBB46_11
.LBB46_12:                              # %for.cond8.preheader
	ld.w	$a0, $fp, 4
	blez	$a0, .LBB46_22
# %bb.13:                               # %for.body11.lr.ph
	move	$a2, $zero
	move	$a3, $zero
	move	$t0, $zero
