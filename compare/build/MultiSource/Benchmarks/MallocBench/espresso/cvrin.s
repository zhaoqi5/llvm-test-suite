...
# %bb.0:                                # %entry
	...
	pcalau12i	$s8, %pc_hi20(line_length_error)
	blez	$s4, .LBB2_15
...
.LBB2_27:                               # %if.end151
	...
	ld.w	$a0, $a1, %pc_lo12(lineno)
	ori	$a2, $zero, 1
	st.b	$a2, $s8, %pc_lo12(line_length_error)
	addi.d	$a0, $a0, 1
	st.w	$a0, $a1, %pc_lo12(lineno)
	b	.LBB2_22
.LBB2_28:                               # %sw.bb156
...
# %bb.30:                               # %if.else464
	...
	ld.d	$s2, $a0, %got_pc_lo12(echo_unknown_commands)
	ld.w	$a0, $s2, 0
	beqz	$a0, .LBB3_78
# %bb.31:                               # %if.then466
                                        #   in Loop: Header=BB3_3 Depth=1
...
.LBB3_100:                              # %if.then197
	...
	st.d	$a0, $a1, 56
	blez	$fp, .LBB3_102
# %bb.101:                              # %for.body.preheader.i152
                                        #   in Loop: Header=BB3_3 Depth=1
	move	$a1, $zero
	move	$a2, $s8
	pcaddu18i	$ra, %call36(memset)
...
.LBB3_102:                              # %if.end199
	...
	ldx.w	$a1, $a2, $a3
	blt	$a1, $a0, .LBB3_3
# %bb.103:                              # %for.body208.preheader
                                        #   in Loop: Header=BB3_3 Depth=1
	addi.d	$s8, $a0, -1
	slli.d	$s2, $a0, 3
	.p2align	4, , 16
.LBB3_104:                              # %for.body208
                                        #   Parent Loop BB3_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.d	$a1, $sp, 208
	move	$a0, $s0
...
.LBB3_110:                              # %if.then232
	...
	st.d	$a0, $a1, 56
	blez	$fp, .LBB3_112
# %bb.111:                              # %for.body.preheader.i159
                                        #   in Loop: Header=BB3_3 Depth=1
	move	$a1, $zero
	move	$a2, $s8
	pcaddu18i	$ra, %call36(memset)
...
.LBB3_114:                              # %if.end239
	...
	ldx.w	$a1, $a2, $a3
	blt	$a1, $a0, .LBB3_3
# %bb.115:                              # %for.body247.preheader
                                        #   in Loop: Header=BB3_3 Depth=1
	addi.d	$s8, $a0, -1
	slli.d	$s2, $a0, 3
	.p2align	4, , 16
.LBB3_116:                              # %for.body247
                                        #   Parent Loop BB3_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.d	$a1, $sp, 208
	move	$a0, $s0
...
.LBB3_140:                              # %if.end424
	...
	beqz	$a1, .LBB3_144
# %bb.141:                              # %lor.lhs.false.i
                                        #   in Loop: Header=BB3_138 Depth=2
	ld.d	$a0, $a1, 0
	beqz	$a0, .LBB3_144
# %bb.142:                              # %for.cond.preheader.i
                                        #   in Loop: Header=BB3_138 Depth=2
	st.d	$a1, $sp, 24                    # 8-byte Folded Spill
	ld.w	$a0, $s4, 4
	st.d	$a0, $sp, 32                    # 8-byte Folded Spill
	blez	$a0, .LBB3_151
# %bb.143:                              # %for.cond6.preheader.lr.ph.i
                                        #   in Loop: Header=BB3_138 Depth=2
	ld.d	$a0, $s4, 32
...
.LBB3_144:                              # %if.then.i
	...
	ori	$a1, $zero, 1
	bne	$a0, $a1, .LBB3_151
# %bb.145:                              # %if.then.i.if.then428_crit_edge
                                        #   in Loop: Header=BB3_138 Depth=2
	ld.w	$a1, $sp, 468
	b	.LBB3_153
	.p2align	4, , 16
.LBB3_146:                              # %for.inc19.i
	...
	ld.d	$a1, $sp, 32                    # 8-byte Folded Reload
	beq	$a0, $a1, .LBB3_151
.LBB3_147:                              # %for.cond6.preheader.i
                                        #   Parent Loop BB3_3 Depth=1
                                        #     Parent Loop BB3_138 Depth=2
...
.LBB3_156:                              # %if.end449
	...
	ld.d	$a1, $fp, 56
	beqz	$a1, .LBB3_160
# %bb.157:                              # %lor.lhs.false.i169
                                        #   in Loop: Header=BB3_138 Depth=2
	ld.d	$a0, $a1, 0
	beqz	$a0, .LBB3_160
# %bb.158:                              # %for.cond.preheader.i171
                                        #   in Loop: Header=BB3_138 Depth=2
	...
	st.d	$a0, $sp, 24                    # 8-byte Folded Spill
	blez	$a0, .LBB3_137
# %bb.159:                              # %for.cond6.preheader.lr.ph.i174
                                        #   in Loop: Header=BB3_138 Depth=2
	ld.d	$a0, $s4, 32
	st.d	$a0, $sp, 32                    # 8-byte Folded Spill
	ld.d	$a0, $s4, 16
...
.LBB3_160:                              # %if.then.i198
	...
	ld.d	$fp, $sp, 48                    # 8-byte Folded Reload
	bne	$a0, $a1, .LBB3_137
# %bb.161:                              # %if.then.i198.if.then453_crit_edge
                                        #   in Loop: Header=BB3_138 Depth=2
	ld.w	$a1, $sp, 468
	b	.LBB3_168
	.p2align	4, , 16
.LBB3_162:                              # %for.inc19.i180
                                        #   in Loop: Header=BB3_163 Depth=3
	ld.d	$a0, $sp, 40                    # 8-byte Folded Reload
	addi.d	$a0, $a0, 1
	ld.d	$s2, $sp, 64                    # 8-byte Folded Reload
	ld.d	$a1, $sp, 24                    # 8-byte Folded Reload
	beq	$a0, $a1, .LBB3_137
.LBB3_163:                              # %for.cond6.preheader.i176
                                        #   Parent Loop BB3_3 Depth=1
                                        #     Parent Loop BB3_138 Depth=2
                                        # =>    This Loop Header: Depth=3
                                        #         Child Loop BB3_165 Depth 4
...
.LBB3_165:                              # %for.body9.i187
	...
	beqz	$a0, .LBB3_167
# %bb.166:                              # %for.inc.i192
                                        #   in Loop: Header=BB3_165 Depth=4
	addi.d	$s2, $s2, -1
	addi.d	$s8, $s8, 8
	bnez	$s2, .LBB3_165
	b	.LBB3_162
.LBB3_167:                              # %if.then17.i195
                                        #   in Loop: Header=BB3_138 Depth=2
	ld.d	$a1, $sp, 40                    # 8-byte Folded Reload
	st.w	$a1, $sp, 468
	ld.d	$s2, $sp, 64                    # 8-byte Folded Reload
