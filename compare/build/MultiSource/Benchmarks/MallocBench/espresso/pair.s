...
# %bb.60:                               # %middle.block
	...
	beq	$a0, $s0, .LBB1_63
.LBB1_61:                               # %for.body60.preheader370
	alsl.d	$a3, $a0, $a5, 2
	sub.d	$a0, $s0, $a0
	.p2align	4, , 16
.LBB1_62:                               # %for.body60
...
.LBB1_87:                               # %for.body115
	...
	blt	$s8, $a2, .LBB1_87
	b	.LBB1_94
.LBB1_88:                               # %vector.scevcheck
	addi.d	$a3, $s6, -1
	add.w	$a4, $a1, $a3
	move	$a2, $zero
	blt	$a4, $a1, .LBB1_80
# %bb.89:                               # %vector.scevcheck
	srli.d	$a3, $a3, 32
	bnez	$a3, .LBB1_80
# %bb.90:                               # %vector.memcheck
	...
	ori	$a3, $zero, 64
	bltu	$a2, $a3, .LBB1_79
# %bb.91:                               # %vector.main.loop.iter.check323
	ori	$a2, $zero, 16
	bgeu	$s6, $a2, .LBB1_123
# %bb.92:
	move	$a2, $zero
...
# %bb.100:                              # %for.body226.lr.ph
	...
	move	$a3, $t2
	bgeu	$a2, $a4, .LBB1_116
.LBB1_101:                              # %for.body226.preheader
	alsl.d	$a2, $a3, $s7, 3
	add.d	$a0, $a0, $a3
	sub.w	$a0, $a0, $t2
	sub.d	$a3, $s0, $a3
	.p2align	4, , 16
.LBB1_102:                              # %for.body226
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a4, $a2, 0
	slli.d	$a5, $a0, 3
	stx.d	$a4, $a1, $a5
	...
	addi.w	$a0, $a0, 1
	bnez	$a3, .LBB1_102
.LBB1_103:                              # %for.cond239.preheader
	blez	$s0, .LBB1_108
# %bb.104:
	move	$fp, $s7
	b	.LBB1_106
...
.LBB1_110:                              # %if.end264
	ld.w	$a0, $s8, 0
	blez	$a0, .LBB1_113
# %bb.111:                              # %for.body269.lr.ph
	ld.d	$a0, $s3, 112
	move	$a1, $zero
	move	$a2, $zero
	.p2align	4, , 16
.LBB1_112:                              # %for.body269
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a3, $s3, 8
	add.d	$a3, $a1, $a3
	slli.d	$a3, $a3, 2
...
.LBB1_115:                              # %if.end278
	...
	addi.d	$sp, $sp, 1168
	ret
.LBB1_116:                              # %vector.scevcheck348
	nor	$a3, $t2, $zero
	add.d	$a4, $a3, $s0
	add.w	$a5, $a0, $a4
	move	$a3, $t2
	blt	$a5, $a0, .LBB1_101
# %bb.117:                              # %vector.scevcheck348
	srli.d	$a4, $a4, 32
	move	$a3, $t2
	bnez	$a4, .LBB1_101
# %bb.118:                              # %vector.memcheck350
	alsl.d	$a3, $t2, $s7, 3
	add.d	$a4, $s0, $a0
	sub.d	$a4, $a4, $t2
	alsl.d	$a4, $a4, $a1, 3
	bgeu	$a3, $a4, .LBB1_120
# %bb.119:                              # %vector.memcheck350
	alsl.d	$a4, $s0, $s7, 3
	alsl.d	$a5, $a0, $a1, 3
	move	$a3, $t2
	bltu	$a5, $a4, .LBB1_101
.LBB1_120:                              # %vector.ph356
	slli.d	$a5, $t2, 3
	move	$a4, $a2
...
.LBB1_121:                              # %vector.body359
	...
	addi.w	$a7, $a7, 8
	bnez	$a6, .LBB1_121
# %bb.122:                              # %middle.block365
	bne	$a2, $a4, .LBB1_101
	b	.LBB1_103
.LBB1_123:                              # %vector.ph324
	andi	$a3, $s6, 12
...
.LBB1_124:                              # %vector.body327
	...
	addi.w	$a5, $a5, 16
	bnez	$a6, .LBB1_124
# %bb.125:                              # %middle.block332
	beq	$a2, $s6, .LBB1_82
# %bb.126:                              # %vec.epilog.iter.check336
	beqz	$a3, .LBB1_80
.LBB1_127:                              # %vec.epilog.ph338
	move	$a5, $a2
	...
	add.w	$a5, $a1, $a5
	.p2align	4, , 16
.LBB1_128:                              # %vec.epilog.vector.body341
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	slli.d	$a6, $a5, 2
	vstx	$vr0, $s2, $a6
	...
	addi.w	$a5, $a5, 4
	bnez	$a3, .LBB1_128
# %bb.129:                              # %vec.epilog.middle.block345
	bne	$a2, $s6, .LBB1_80
	b	.LBB1_82
.Lfunc_end1:
...
# %bb.60:                               # %middle.block65
	beq	$a3, $s0, .LBB11_36
# %bb.61:                               # %vec.epilog.iter.check69
	beqz	$a4, .LBB11_34
.LBB11_62:                              # %vec.epilog.ph71
	move	$t0, $a3
	...
	alsl.d	$t0, $t0, $a1, 2
	.p2align	4, , 16
.LBB11_63:                              # %vec.epilog.vector.body74
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $t0, 0
	vst	$vr0, $a7, 0
	vld	$vr0, $a6, 0
	...
	addi.d	$t0, $t0, 16
	bnez	$a4, .LBB11_63
# %bb.64:                               # %vec.epilog.middle.block79
	bne	$a3, $s0, .LBB11_34
	b	.LBB11_36
.Lfunc_end11:
