...
# %bb.32:                               # %if.then2.i153
	...
	b	.LBB1_28
	.p2align	4, , 16
.LBB1_33:                               # %if.else9.i171
                                        #   in Loop: Header=BB1_30 Depth=1
	bnez	$a2, .LBB1_35
# %bb.34:                               #   in Loop: Header=BB1_30 Depth=1
	move	$a2, $zero
	b	.LBB1_29
.LBB1_35:                               # %if.then11.i172
                                        #   in Loop: Header=BB1_30 Depth=1
	sub.w	$a1, $s2, $fp
	move	$a2, $s3
	pcaddu18i	$ra, %call36(sf_delcol)
	...
	add.d	$fp, $s3, $fp
	b	.LBB1_29
.LBB1_36:                               # %for.end.i164
	beqz	$s4, .LBB1_38
# %bb.37:                               # %if.then16.i165
	sub.w	$a1, $s2, $fp
	move	$a2, $s3
	pcaddu18i	$ra, %call36(sf_delcol)
	jirl	$ra, $ra, 0
.LBB1_38:                               # %delvar.exit177
	ld.d	$a1, $s6, 8
	st.d	$a0, $s6, 16
	move	$a0, $a1
	move	$a1, $s8
...
# %bb.39:                               # %for.body.i180.preheader
	...
	b	.LBB1_43
	.p2align	4, , 16
.LBB1_40:                               # %if.then2.i191
                                        #   in Loop: Header=BB1_43 Depth=1
	ld.d	$a1, $s7, 32
	ldx.w	$a1, $a1, $s2
	add.w	$s3, $a1, $s3
.LBB1_41:                               # %for.inc.i194
                                        #   in Loop: Header=BB1_43 Depth=1
	ori	$a1, $zero, 1
.LBB1_42:                               # %for.inc.i194
                                        #   in Loop: Header=BB1_43 Depth=1
	addi.d	$s4, $s4, 1
	addi.d	$s2, $s2, 4
	bge	$s4, $s0, .LBB1_49
.LBB1_43:                               # %for.body.i180
                                        # =>This Inner Loop Header: Depth=1
	ldx.w	$s6, $a3, $s2
	beqz	$s6, .LBB1_46
# %bb.44:                               # %if.then.i190
...
# %bb.45:                               # %if.else.i206
	...
	b	.LBB1_41
	.p2align	4, , 16
.LBB1_46:                               # %if.else9.i209
                                        #   in Loop: Header=BB1_43 Depth=1
	bnez	$a1, .LBB1_48
# %bb.47:                               #   in Loop: Header=BB1_43 Depth=1
	move	$a1, $zero
	b	.LBB1_42
.LBB1_48:                               # %if.then11.i210
                                        #   in Loop: Header=BB1_43 Depth=1
	sub.w	$a1, $s5, $fp
	move	$a2, $s3
	pcaddu18i	$ra, %call36(sf_delcol)
	...
	add.d	$fp, $s3, $fp
	b	.LBB1_42
.LBB1_49:                               # %for.end.i202
	beqz	$s6, .LBB1_51
# %bb.50:                               # %if.then16.i203
	sub.w	$a1, $s5, $fp
	move	$a2, $s3
	pcaddu18i	$ra, %call36(sf_delcol)
	jirl	$ra, $ra, 0
...
# %bb.59:                               # %middle.block
	...
	beq	$a0, $s0, .LBB1_62
.LBB1_60:                               # %for.body60.preheader356
	ld.d	$a3, $sp, 56                    # 8-byte Folded Reload
	alsl.d	$a3, $a0, $a3, 2
	sub.d	$a0, $s0, $a0
	.p2align	4, , 16
...
# %bb.64:
	move	$a0, $zero
	b	.LBB1_74
.LBB1_65:                               # %vector.main.loop.iter.check
	ori	$a0, $zero, 16
	bgeu	$s2, $a0, .LBB1_67
# %bb.66:
	move	$a0, $zero
	b	.LBB1_71
.LBB1_67:                               # %vector.ph289
...
.LBB1_68:                               # %vector.body292
	...
	addi.d	$a3, $a3, 64
	bnez	$a4, .LBB1_68
# %bb.69:                               # %middle.block295
	beq	$a0, $s2, .LBB1_76
# %bb.70:                               # %vec.epilog.iter.check
	andi	$a3, $s2, 12
	beqz	$a3, .LBB1_74
.LBB1_71:                               # %vec.epilog.ph
	move	$a4, $a0
	...
	vrepli.w	$vr0, 4
	.p2align	4, , 16
.LBB1_72:                               # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a4, 0
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, 16
...
# %bb.103:                              # %vector.memcheck
	...
	ori	$a3, $zero, 64
	bltu	$a2, $a3, .LBB1_78
# %bb.104:                              # %vector.main.loop.iter.check309
	ori	$a2, $zero, 16
	bgeu	$s7, $a2, .LBB1_121
# %bb.105:
	move	$a2, $zero
...
.LBB1_108:                              # %if.end264
	...
	ori	$a1, $zero, 1
	blt	$a0, $a1, .LBB1_111
# %bb.109:                              # %for.body269.lr.ph
	ld.d	$a0, $s6, 112
	move	$a1, $zero
	move	$a2, $zero
	.p2align	4, , 16
.LBB1_110:                              # %for.body269
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a3, $s6, 8
	add.d	$a3, $a1, $a3
	slli.d	$a3, $a3, 2
...
.LBB1_113:                              # %if.end278
	...
	addi.d	$sp, $sp, 1152
	ret
.LBB1_114:                              # %vector.scevcheck335
	nor	$a3, $t2, $zero
	add.d	$a4, $a3, $s0
	add.w	$a5, $a0, $a4
	move	$a3, $t2
	blt	$a5, $a0, .LBB1_94
# %bb.115:                              # %vector.scevcheck335
	srli.d	$a4, $a4, 32
	move	$a3, $t2
	bnez	$a4, .LBB1_94
# %bb.116:                              # %vector.memcheck336
	alsl.d	$a3, $t2, $s1, 3
	add.d	$a4, $s0, $a0
	sub.d	$a4, $a4, $t2
	alsl.d	$a4, $a4, $a1, 3
	bgeu	$a3, $a4, .LBB1_118
# %bb.117:                              # %vector.memcheck336
	alsl.d	$a4, $s0, $s1, 3
	alsl.d	$a5, $a0, $a1, 3
	move	$a3, $t2
	bltu	$a5, $a4, .LBB1_94
.LBB1_118:                              # %vector.ph342
	slli.d	$a5, $t2, 3
	move	$a4, $a2
...
.LBB1_119:                              # %vector.body345
	...
	addi.w	$a7, $a7, 8
	bnez	$a6, .LBB1_119
# %bb.120:                              # %middle.block351
	bne	$a2, $a4, .LBB1_94
	b	.LBB1_96
.LBB1_121:                              # %vector.ph310
...
.LBB1_122:                              # %vector.body313
	...
	addi.w	$a4, $a4, 16
	bnez	$a5, .LBB1_122
# %bb.123:                              # %middle.block318
	beq	$a2, $s7, .LBB1_81
# %bb.124:                              # %vec.epilog.iter.check323
	andi	$a3, $s7, 12
	beqz	$a3, .LBB1_79
.LBB1_125:                              # %vec.epilog.ph322
	move	$a5, $a2
	...
	add.w	$a5, $a1, $a5
	.p2align	4, , 16
.LBB1_126:                              # %vec.epilog.vector.body328
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	slli.d	$a6, $a5, 2
	vstx	$vr0, $s3, $a6
	...
	addi.w	$a5, $a5, 4
	bnez	$a3, .LBB1_126
# %bb.127:                              # %vec.epilog.middle.block332
	bne	$a2, $s7, .LBB1_79
	b	.LBB1_81
.Lfunc_end1:
...
.LBB11_50:                              # %if.end99
	...
	addi.d	$sp, $sp, 128
	ret
.LBB11_51:                              # %vector.memcheck32
	sub.d	$a5, $a0, $s5
	ori	$a4, $zero, 64
	move	$a3, $zero
	bltu	$a5, $a4, .LBB11_34
# %bb.52:                               # %vector.memcheck32
	sub.d	$a5, $s5, $a1
	bltu	$a5, $a4, .LBB11_34
# %bb.53:                               # %vector.memcheck32
	sub.d	$a5, $a2, $s5
	ori	$a4, $zero, 64
	bltu	$a5, $a4, .LBB11_34
# %bb.54:                               # %vector.memcheck32
	sub.d	$a5, $a0, $a1
	bltu	$a5, $a4, .LBB11_34
# %bb.55:                               # %vector.memcheck32
	sub.d	$a4, $a0, $a2
	ori	$a5, $zero, 64
	bltu	$a4, $a5, .LBB11_34
# %bb.56:                               # %vector.main.loop.iter.check47
	ori	$a3, $zero, 16
	bgeu	$s0, $a3, .LBB11_58
# %bb.57:
	move	$a3, $zero
	b	.LBB11_62
.LBB11_58:                              # %vector.ph48
...
.LBB11_59:                              # %vector.body51
	...
	addi.d	$a7, $a7, 64
	bnez	$t0, .LBB11_59
# %bb.60:                               # %middle.block58
	beq	$a3, $s0, .LBB11_36
# %bb.61:                               # %vec.epilog.iter.check63
	andi	$a4, $s0, 12
	beqz	$a4, .LBB11_34
.LBB11_62:                              # %vec.epilog.ph62
	move	$t0, $a3
	...
	alsl.d	$t0, $t0, $a1, 2
	.p2align	4, , 16
.LBB11_63:                              # %vec.epilog.vector.body68
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $t0, 0
	vst	$vr0, $a7, 0
	vld	$vr0, $a6, 0
	...
	addi.d	$t0, $t0, 16
	bnez	$a4, .LBB11_63
# %bb.64:                               # %vec.epilog.middle.block73
	bne	$a3, $s0, .LBB11_34
	b	.LBB11_36
.Lfunc_end11:
