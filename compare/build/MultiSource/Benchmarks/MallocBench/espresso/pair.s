...
# %bb.60:                               # %middle.block
	...
	beq	$a0, $s0, .LBB1_63
.LBB1_61:                               # %for.body60.preheader352
	ld.d	$a3, $sp, 56                    # 8-byte Folded Reload
	alsl.d	$a3, $a0, $a3, 2
	sub.d	$a0, $s0, $a0
	.p2align	4, , 16
...
# %bb.104:                              # %vector.memcheck
	...
	ori	$a3, $zero, 64
	bltu	$a2, $a3, .LBB1_79
# %bb.105:                              # %vector.main.loop.iter.check305
	ori	$a2, $zero, 16
	bgeu	$s7, $a2, .LBB1_122
# %bb.106:
	move	$a2, $zero
...
.LBB1_114:                              # %if.end278
	...
	addi.d	$sp, $sp, 1152
	ret
.LBB1_115:                              # %vector.scevcheck331
	nor	$a3, $t2, $zero
	add.d	$a4, $a3, $s0
	add.w	$a5, $a0, $a4
	move	$a3, $t2
	blt	$a5, $a0, .LBB1_95
# %bb.116:                              # %vector.scevcheck331
	srli.d	$a4, $a4, 32
	move	$a3, $t2
	bnez	$a4, .LBB1_95
# %bb.117:                              # %vector.memcheck332
	alsl.d	$a3, $t2, $s1, 3
	add.d	$a4, $s0, $a0
	sub.d	$a4, $a4, $t2
	alsl.d	$a4, $a4, $a1, 3
	bgeu	$a3, $a4, .LBB1_119
# %bb.118:                              # %vector.memcheck332
	alsl.d	$a4, $s0, $s1, 3
	alsl.d	$a5, $a0, $a1, 3
	move	$a3, $t2
	bltu	$a5, $a4, .LBB1_95
.LBB1_119:                              # %vector.ph338
	slli.d	$a5, $t2, 3
	move	$a4, $a2
...
.LBB1_120:                              # %vector.body341
	...
	addi.w	$a7, $a7, 8
	bnez	$a6, .LBB1_120
# %bb.121:                              # %middle.block347
	bne	$a2, $a4, .LBB1_95
	b	.LBB1_97
.LBB1_122:                              # %vector.ph306
...
.LBB1_123:                              # %vector.body309
	...
	addi.w	$a4, $a4, 16
	bnez	$a5, .LBB1_123
# %bb.124:                              # %middle.block314
	beq	$a2, $s7, .LBB1_82
# %bb.125:                              # %vec.epilog.iter.check319
	andi	$a3, $s7, 12
	beqz	$a3, .LBB1_80
.LBB1_126:                              # %vec.epilog.ph318
	move	$a5, $a2
	...
	add.w	$a5, $a1, $a5
	.p2align	4, , 16
.LBB1_127:                              # %vec.epilog.vector.body324
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	slli.d	$a6, $a5, 2
	vstx	$vr0, $s3, $a6
	...
	addi.w	$a5, $a5, 4
	bnez	$a3, .LBB1_127
# %bb.128:                              # %vec.epilog.middle.block328
	bne	$a2, $s7, .LBB1_80
	b	.LBB1_82
.Lfunc_end1:
