...
# %bb.60:                               # %middle.block
	...
	beq	$a0, $s0, .LBB1_63
.LBB1_61:                               # %for.body60.preheader347
	alsl.d	$a3, $a0, $a5, 2
	sub.d	$a0, $s0, $a0
	.p2align	4, , 16
.LBB1_62:                               # %for.body60
...
.LBB1_67:                               # %vector.body303
	...
	addi.d	$a2, $a2, 32
	bnez	$a3, .LBB1_67
# %bb.68:                               # %middle.block306
	beq	$a0, $fp, .LBB1_71
.LBB1_69:                               # %for.body79.preheader346
	slli.d	$a2, $a0, 2
	alsl.d	$a1, $a1, $a2, 2
	add.d	$a1, $s3, $a1
	ori	$a2, $zero, 4
...
.LBB1_70:                               # %for.body79
	...
	addi.d	$a1, $a1, 4
	bltu	$a0, $fp, .LBB1_70
.LBB1_71:                               # %for.cond86.preheader
	blez	$s7, .LBB1_76
# %bb.72:                               # %for.body90.lr.ph
...
.LBB1_81:                               # %for.body115
	...
	blt	$s8, $a2, .LBB1_81
	b	.LBB1_89
.LBB1_82:                               # %vector.scevcheck
	addi.d	$a3, $s7, -1
	add.w	$a4, $a1, $a3
	move	$a2, $zero
	blt	$a4, $a1, .LBB1_74
# %bb.83:                               # %vector.scevcheck
	srli.d	$a3, $a3, 32
	bnez	$a3, .LBB1_74
...
.LBB1_86:                               # %vector.body316
	...
	addi.w	$a4, $a4, 8
	bnez	$a5, .LBB1_86
# %bb.87:                               # %middle.block321
	bne	$a2, $s7, .LBB1_74
	b	.LBB1_76
.LBB1_88:
	move	$a1, $a0
.LBB1_89:                               # %for.cond182.preheader
...
.LBB1_105:                              # %if.end264
	ld.w	$a0, $s8, 0
	blez	$a0, .LBB1_108
# %bb.106:                              # %for.body269.lr.ph
	ld.d	$a0, $s7, 112
	move	$a1, $zero
	move	$a2, $zero
	.p2align	4, , 16
.LBB1_107:                              # %for.body269
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a3, $s7, 8
	add.d	$a3, $a1, $a3
	slli.d	$a3, $a3, 2
...
.LBB1_110:                              # %if.end278
	...
	addi.d	$sp, $sp, 1152
	ret
.LBB1_111:                              # %vector.scevcheck324
	nor	$a3, $t2, $zero
	add.d	$a4, $a3, $s0
	add.w	$a5, $a0, $a4
	move	$a3, $t2
	blt	$a5, $a0, .LBB1_96
# %bb.112:                              # %vector.scevcheck324
	srli.d	$a4, $a4, 32
	move	$a3, $t2
	bnez	$a4, .LBB1_96
# %bb.113:                              # %vector.memcheck326
	alsl.d	$a3, $t2, $s2, 3
	add.d	$a4, $s0, $a0
	sub.d	$a4, $a4, $t2
	alsl.d	$a4, $a4, $a1, 3
	bgeu	$a3, $a4, .LBB1_115
# %bb.114:                              # %vector.memcheck326
	alsl.d	$a4, $s0, $s2, 3
	alsl.d	$a5, $a0, $a1, 3
	move	$a3, $t2
	bltu	$a5, $a4, .LBB1_96
.LBB1_115:                              # %vector.ph332
	slli.d	$a5, $t2, 3
	move	$a4, $a2
...
# %bb.16:                               # %if.then
	...
	move	$s5, $a0
	blez	$s8, .LBB5_24
# %bb.17:                               # %for.body44.lr.ph
                                        #   in Loop: Header=BB5_15 Depth=2
	ld.d	$a0, $s7, 32
	move	$a1, $zero
	ori	$a2, $zero, 8
	bltu	$s8, $a2, .LBB5_22
# %bb.18:                               # %for.body44.lr.ph
                                        #   in Loop: Header=BB5_15 Depth=2
	sub.d	$a2, $s5, $a0
	ori	$a3, $zero, 32
	bltu	$a2, $a3, .LBB5_22
...
# %bb.27:
	move	$a3, $zero
.LBB11_28:                              # %for.body.i16.preheader
	sub.d	$a4, $s0, $a3
	alsl.d	$a0, $a3, $a0, 2
	alsl.d	$a2, $a3, $a2, 2
	alsl.d	$a5, $a3, $s5, 2
...
.LBB11_44:                              # %if.end99
	...
	addi.d	$sp, $sp, 128
	ret
.LBB11_45:                              # %vector.memcheck32
	sub.d	$a5, $a0, $s5
	ori	$a4, $zero, 32
	move	$a3, $zero
	bltu	$a5, $a4, .LBB11_28
# %bb.46:                               # %vector.memcheck32
	sub.d	$a5, $s5, $a1
	bltu	$a5, $a4, .LBB11_28
# %bb.47:                               # %vector.memcheck32
	sub.d	$a5, $a2, $s5
	ori	$a4, $zero, 32
	bltu	$a5, $a4, .LBB11_28
# %bb.48:                               # %vector.memcheck32
	sub.d	$a5, $a0, $a1
	bltu	$a5, $a4, .LBB11_28
# %bb.49:                               # %vector.memcheck32
	sub.d	$a4, $a0, $a2
	ori	$a5, $zero, 32
	bltu	$a4, $a5, .LBB11_28
# %bb.50:                               # %vector.ph45
