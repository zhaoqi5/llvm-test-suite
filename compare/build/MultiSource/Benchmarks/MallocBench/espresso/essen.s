...
# %bb.28:                               # %middle.block
	bne	$a0, $a2, .LBB3_5
	b	.LBB3_7
.LBB3_29:                               # %vector.memcheck74
	sub.d	$a2, $s4, $s6
	ori	$a1, $zero, 32
	bltu	$a2, $a1, .LBB3_8
# %bb.30:                               # %vector.memcheck74
	sub.d	$a2, $s2, $s6
	bltu	$a2, $a1, .LBB3_8
# %bb.31:                               # %vector.ph83
	move	$a2, $a0
...
.LBB3_44:                               # %cleanup
	...
	addi.d	$sp, $sp, 176
	ret
.LBB3_45:                               # %vector.memcheck125
	sub.d	$a2, $s4, $s0
	ori	$a1, $zero, 32
	bltu	$a2, $a1, .LBB3_38
# %bb.46:                               # %vector.memcheck125
	sub.d	$a2, $s2, $s0
	bltu	$a2, $a1, .LBB3_38
# %bb.47:                               # %vector.ph134
	move	$a2, $a0
