...
.LBB2_15:                               # %do.end.i
	...
	ori	$a4, $zero, 16
	bltu	$a2, $a4, .LBB2_21
# %bb.16:                               # %vector.memcheck25
	alsl.d	$a6, $a3, $a0, 2
	slli.d	$a4, $a1, 2
	addi.d	$a5, $a4, 4
	add.d	$a7, $s2, $a5
	bgeu	$a6, $a7, .LBB2_18
# %bb.17:                               # %vector.memcheck25
	add.d	$a5, $a0, $a5
	alsl.d	$a3, $a3, $s2, 2
	bltu	$a3, $a5, .LBB2_21
.LBB2_18:                               # %vector.ph37
...
.LBB2_23:                               # %do.end28.i
	...
	ori	$a4, $zero, 16
	bltu	$a2, $a4, .LBB2_29
# %bb.24:                               # %vector.memcheck52
	alsl.d	$a6, $a3, $s0, 2
	slli.d	$a4, $a1, 2
	addi.d	$a5, $a4, 4
	add.d	$a7, $a0, $a5
	bgeu	$a6, $a7, .LBB2_26
# %bb.25:                               # %vector.memcheck52
	add.d	$a5, $s0, $a5
	alsl.d	$a3, $a3, $a0, 2
	bltu	$a3, $a5, .LBB2_29
.LBB2_26:                               # %vector.ph64
...
# %bb.33:                               # %vector.memcheck177
	...
	alsl.d	$a4, $a0, $s8, 2
	bgeu	$a5, $a6, .LBB5_35
# %bb.34:                               # %vector.memcheck177
                                        #   in Loop: Header=BB5_27 Depth=1
	addi.d	$a5, $a4, 4
	alsl.d	$a2, $a2, $s0, 2
	bltu	$a2, $a5, .LBB5_38
.LBB5_35:                               # %vector.ph191
                                        #   in Loop: Header=BB5_27 Depth=1
	move	$a2, $a1
	bstrins.d	$a2, $zero, 2, 0
	sub.d	$a0, $a0, $a2
...
.LBB5_39:                               # %do.body20.i
	...
	b	.LBB5_26
	.p2align	4, , 16
.LBB5_40:                               # %vector.memcheck206
                                        #   in Loop: Header=BB5_27 Depth=1
	sub.d	$a1, $s3, $s0
	ori	$a3, $zero, 32
	bltu	$a1, $a3, .LBB5_29
# %bb.41:                               # %vector.memcheck206
                                        #   in Loop: Header=BB5_27 Depth=1
	sub.d	$a1, $a0, $s0
	bltu	$a1, $a3, .LBB5_29
# %bb.42:                               # %vector.ph214
...
.LBB5_59:                               # %do.end.i105
	...
	ori	$a3, $zero, 16
	bltu	$a1, $a3, .LBB5_65
# %bb.60:                               # %vector.memcheck150
	alsl.d	$a5, $a2, $s2, 2
	slli.d	$a3, $a0, 2
	addi.d	$a4, $a3, 4
	add.d	$a6, $s3, $a4
	bgeu	$a5, $a6, .LBB5_62
# %bb.61:                               # %vector.memcheck150
	add.d	$a4, $s2, $a4
	alsl.d	$a2, $a2, $s3, 2
	bltu	$a2, $a4, .LBB5_65
.LBB5_62:                               # %vector.ph162
	move	$a2, $a1
	bstrins.d	$a2, $zero, 2, 0
	sub.d	$a0, $a0, $a2
	addi.d	$a4, $a3, -28
...
.LBB5_81:                               # %cleanup
	...
	addi.d	$sp, $sp, 112
	ret
.LBB5_82:                               # %vector.memcheck129
	sub.d	$a3, $s1, $s3
	ori	$a2, $zero, 32
	bltu	$a3, $a2, .LBB5_56
# %bb.83:                               # %vector.memcheck129
	sub.d	$a3, $a0, $s3
	bltu	$a3, $a2, .LBB5_56
# %bb.84:                               # %vector.ph135
	move	$a3, $a1
