...
.LBB0_33:                               # %cond.end184
	...
	st.d	$a0, $a1, 0
	blt	$s0, $s2, .LBB0_35
# %bb.34:                               # %cond.false179.1
	addi.d	$a0, $s0, -1
	srli.d	$a0, $a0, 3
	ori	$a1, $s1, 4092
	and	$a0, $a0, $a1
	addi.d	$fp, $a0, 8
.LBB0_35:                               # %cond.end184.1
	move	$a0, $fp
	pcaddu18i	$ra, %call36(malloc)
	jirl	$ra, $ra, 0
	move	$a1, $s0
	...
	ori	$a0, $zero, 8
	blt	$s0, $s2, .LBB0_37
# %bb.36:                               # %cond.false179.2
	addi.d	$a0, $s0, -1
	srli.d	$a0, $a0, 3
	ori	$a1, $s1, 4092
	and	$a0, $a0, $a1
	addi.d	$a0, $a0, 8
.LBB0_37:                               # %cond.end184.2
	pcaddu18i	$ra, %call36(malloc)
	jirl	$ra, $ra, 0
	move	$a1, $s0
	pcaddu18i	$ra, %call36(set_clear)
	...
	st.d	$a0, $a1, 16
	blt	$s0, $s2, .LBB0_39
# %bb.38:                               # %cond.false179.3
	addi.d	$a0, $s0, -1
	srli.d	$a0, $a0, 3
	ori	$a1, $s1, 4092
	and	$a0, $a0, $a1
	addi.d	$fp, $a0, 8
.LBB0_39:                               # %cond.end184.3
	move	$a0, $fp
	pcaddu18i	$ra, %call36(malloc)
	jirl	$ra, $ra, 0
	move	$a1, $s0
	...
	ori	$a0, $zero, 8
	blt	$s0, $s2, .LBB0_41
# %bb.40:                               # %cond.false179.4
	addi.d	$a0, $s0, -1
	srli.d	$a0, $a0, 3
	ori	$a1, $s1, 4092
	and	$a0, $a0, $a1
	addi.d	$a0, $a0, 8
.LBB0_41:                               # %cond.end184.4
	pcaddu18i	$ra, %call36(malloc)
	jirl	$ra, $ra, 0
	move	$a1, $s0
	pcaddu18i	$ra, %call36(set_clear)
	...
	st.d	$a0, $a1, 32
	blt	$s0, $s2, .LBB0_43
# %bb.42:                               # %cond.false179.5
	addi.d	$a0, $s0, -1
	srli.d	$a0, $a0, 3
	ori	$a1, $s1, 4092
	and	$a0, $a0, $a1
	addi.d	$fp, $a0, 8
.LBB0_43:                               # %cond.end184.5
	move	$a0, $fp
	pcaddu18i	$ra, %call36(malloc)
	jirl	$ra, $ra, 0
	move	$a1, $s0
	...
	ori	$a0, $zero, 8
	blt	$s0, $s2, .LBB0_45
# %bb.44:                               # %cond.false179.6
	addi.d	$a0, $s0, -1
	srli.d	$a0, $a0, 3
	ori	$a1, $s1, 4092
	and	$a0, $a0, $a1
	addi.d	$a0, $a0, 8
.LBB0_45:                               # %cond.end184.6
	pcaddu18i	$ra, %call36(malloc)
	jirl	$ra, $ra, 0
	move	$a1, $s0
	pcaddu18i	$ra, %call36(set_clear)
	...
	st.d	$a0, $a1, 48
	blt	$s0, $s2, .LBB0_47
# %bb.46:                               # %cond.false179.7
	addi.d	$a0, $s0, -1
	srli.d	$a0, $a0, 3
	ori	$a1, $s1, 4092
	and	$a0, $a0, $a1
	addi.d	$fp, $a0, 8
.LBB0_47:                               # %cond.end184.7
	move	$a0, $fp
	pcaddu18i	$ra, %call36(malloc)
	jirl	$ra, $ra, 0
	move	$a1, $s0
	...
	ori	$a0, $zero, 8
	blt	$s0, $s2, .LBB0_49
# %bb.48:                               # %cond.false179.8
	addi.d	$a0, $s0, -1
	srli.d	$a0, $a0, 3
	ori	$a1, $s1, 4092
	and	$a0, $a0, $a1
	addi.d	$a0, $a0, 8
.LBB0_49:                               # %cond.end184.8
	pcaddu18i	$ra, %call36(malloc)
	jirl	$ra, $ra, 0
	move	$a1, $s0
	pcaddu18i	$ra, %call36(set_clear)
	...
	st.d	$a0, $a1, 64
	blt	$s0, $s2, .LBB0_51
# %bb.50:                               # %cond.false179.9
	addi.d	$a0, $s0, -1
	srli.d	$a0, $a0, 3
	ori	$a1, $s1, 4092
	and	$a0, $a0, $a1
	addi.d	$fp, $a0, 8
.LBB0_51:                               # %cond.end184.9
	move	$a0, $fp
	pcaddu18i	$ra, %call36(malloc)
	jirl	$ra, $ra, 0
	move	$a1, $s0
