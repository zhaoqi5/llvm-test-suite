...
.LBB6_24:                               # %for.body23
	...
	addi.d	$a2, $a2, 1
	bltu	$a2, $s7, .LBB6_30
# %bb.25:                               # %vector.memcheck121
                                        #   in Loop: Header=BB6_24 Depth=2
	alsl.d	$a5, $a4, $s0, 2
	alsl.d	$a6, $a3, $a1, 2
	addi.d	$a7, $a6, 4
	bgeu	$a5, $a7, .LBB6_27
# %bb.26:                               # %vector.memcheck121
                                        #   in Loop: Header=BB6_24 Depth=2
	alsl.d	$a5, $a3, $s6, 2
	alsl.d	$a4, $a4, $a1, 2
	bltu	$a4, $a5, .LBB6_30
.LBB6_27:                               # %vector.ph135
                                        #   in Loop: Header=BB6_24 Depth=2
	move	$a4, $a2
