...
# %bb.27:                               # %if.then149
	...
	b	.LBB6_25
	.p2align	4, , 16
.LBB6_28:                               # %vector.memcheck238
                                        #   in Loop: Header=BB6_16 Depth=1
	sub.d	$a1, $s2, $t7
	bltu	$a1, $t6, .LBB6_17
# %bb.29:                               # %vector.memcheck238
                                        #   in Loop: Header=BB6_16 Depth=1
	sub.d	$a1, $a7, $t7
	bltu	$a1, $t6, .LBB6_17
# %bb.30:                               # %vector.ph246
...
.LBB6_60:                               # %for.inc291.thread
	...
	b	.LBB6_73
	.p2align	4, , 16
.LBB6_61:                               # %vector.memcheck284
                                        #   in Loop: Header=BB6_47 Depth=1
	sub.d	$a3, $s3, $t7
	bltu	$a3, $t6, .LBB6_48
# %bb.62:                               # %vector.memcheck284
                                        #   in Loop: Header=BB6_47 Depth=1
	sub.d	$a3, $a6, $t7
	bltu	$a3, $t6, .LBB6_48
# %bb.63:                               # %vector.ph291
...
.LBB6_64:                               # %vector.body294
	...
	addi.d	$a1, $a1, -32
	bnez	$fp, .LBB6_64
# %bb.65:                               # %middle.block303
                                        #   in Loop: Header=BB6_47 Depth=1
	bne	$ra, $t2, .LBB6_49
	b	.LBB6_51
	.p2align	4, , 16
.LBB6_66:                               # %vector.memcheck261
                                        #   in Loop: Header=BB6_47 Depth=1
	sub.d	$a3, $s2, $t8
	bltu	$a3, $t6, .LBB6_52
# %bb.67:                               # %vector.memcheck261
                                        #   in Loop: Header=BB6_47 Depth=1
	sub.d	$a3, $a6, $t8
	bltu	$a3, $t6, .LBB6_52
# %bb.68:                               # %vector.ph269
...
# %bb.89:                               # %if.then381
	...
	b	.LBB6_87
	.p2align	4, , 16
.LBB6_90:                               # %vector.memcheck306
                                        #   in Loop: Header=BB6_81 Depth=1
	sub.d	$t5, $s2, $t3
	bltu	$t5, $t2, .LBB6_82
# %bb.91:                               # %vector.memcheck306
                                        #   in Loop: Header=BB6_81 Depth=1
	sub.d	$t5, $a4, $t3
	bltu	$t5, $t2, .LBB6_82
# %bb.92:                               # %vector.ph314
