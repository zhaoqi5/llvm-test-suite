...
# %bb.0:                                # %entry
	...
	ld.d	$a0, $a0, %got_pc_lo12(print_solution)
	st.d	$a0, $sp, 72                    # 8-byte Folded Spill
	st.w	$s7, $a0, 0
	pcalau12i	$a0, %got_pc_hi20(summary)
	ld.d	$s6, $a0, %got_pc_lo12(summary)
	st.w	$zero, $s6, 0
	...
	ld.d	$a0, $a0, %got_pc_lo12(pla_types)
...
.LBB0_19:                               # %sw.bb103
	...
	st.w	$s7, $s5, 0
	b	.LBB0_2
.LBB0_20:                               # %for.cond45.preheader
                                        #   in Loop: Header=BB0_2 Depth=1
	ld.d	$a0, $sp, 40                    # 8-byte Folded Reload
	ld.d	$a1, $a0, 0
	ld.d	$s4, $s1, 0
	beqz	$a1, .LBB0_32
# %bb.21:                               # %for.body50.preheader
                                        #   in Loop: Header=BB0_2 Depth=1
...
.LBB0_48:                               # %if.end146
	...
	move	$a2, $s0
	move	$a3, $s3
.LBB0_49:                               # %sw.epilog149
	pcaddu18i	$ra, %call36(getPLA)
	jirl	$ra, $ra, 0
.LBB0_50:                               # %sw.epilog149
	pcalau12i	$a0, %got_pc_hi20(optind)
...
.LBB0_138:                              # %sw.bb478
	...
	pcaddu18i	$ra, %call36(sf_free)
	jirl	$ra, $ra, 0
.LBB0_139:                              # %sw.epilog530
	move	$a0, $s1
.LBB0_140:                              # %sw.epilog530
	pcaddu18i	$ra, %call36(sf_free)
	jirl	$ra, $ra, 0
	ld.w	$a0, $s5, 0
	beqz	$a0, .LBB0_147
	b	.LBB0_137
.LBB0_141:                              # %for.cond434.preheader
	pcalau12i	$a0, %got_pc_hi20(cube)
	ld.d	$fp, $a0, %got_pc_lo12(cube)
	ld.w	$a0, $fp, 8
	blez	$a0, .LBB0_146
# %bb.142:                              # %for.body436.preheader
	move	$s0, $zero
	.p2align	4, , 16
.LBB0_143:                              # %for.body436
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $sp, 136
	ld.d	$a0, $a0, 0
	move	$a1, $s0
...
.LJTI0_1:
	...
	.word	.LBB0_73-.LJTI0_1
	.word	.LBB0_74-.LJTI0_1
	.word	.LBB0_146-.LJTI0_1
	.word	.LBB0_75-.LJTI0_1
	.word	.LBB0_79-.LJTI0_1
	.word	.LBB0_83-.LJTI0_1
	.word	.LBB0_84-.LJTI0_1
	.word	.LBB0_85-.LJTI0_1
	.word	.LBB0_86-.LJTI0_1
...
.LBB6_5:                                # %for.cond2.preheader
	pcalau12i	$a0, %pc_hi20(option_table)
	addi.d	$s6, $a0, %pc_lo12(option_table)
	ld.d	$a1, $s6, 0
	beqz	$a1, .LBB6_9
...
.LBB6_16:                               # %for.body.i
	...
	addi.d	$a1, $a1, 8
	bnez	$a2, .LBB6_16
.LBB6_17:                               # %delete_arg.exit
	addi.w	$s3, $a0, -2
	ld.d	$a1, $sp, 48                    # 8-byte Folded Reload
	st.w	$s3, $a1, 0
	bge	$s4, $s3, .LBB6_25
# %bb.18:                               # %for.body.preheader.i63
	add.d	$a1, $s3, $s8
	addi.d	$a1, $a1, -1
	ori	$a2, $zero, 4
	bgeu	$a1, $a2, .LBB6_20
...
.LBB6_21:                               # %vector.body287
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB6_21
# %bb.22:                               # %middle.block293
	beq	$a1, $a3, .LBB6_25
.LBB6_23:                               # %for.body.i65.preheader
	alsl.d	$a1, $a2, $fp, 3
	addi.d	$a1, $a1, 8
	sub.d	$a2, $s3, $a2
	.p2align	4, , 16
...
.LBB6_25:                               # %for.end
	ld.d	$a1, $s6, 0
	beqz	$a1, .LBB6_9
# %bb.26:                               # %for.end.for.end31_crit_edge
	addi.w	$s6, $a0, -3
	ori	$a0, $zero, 3
	blt	$s3, $a0, .LBB6_51
.LBB6_27:                               # %for.body35.preheader
...
# %bb.29:                               # %for.inc75
	...
	bne	$s0, $s4, .LBB6_28
	b	.LBB6_51
.LBB6_30:                               # %for.cond41.preheader
	pcalau12i	$a0, %got_pc_hi20(pla_types)
	ld.d	$a1, $a0, %got_pc_lo12(pla_types)
	ld.d	$a0, $a1, 0
	beqz	$a0, .LBB6_34
# %bb.31:                               # %for.body45.lr.ph
	slli.d	$a2, $s6, 3
	ldx.d	$s1, $fp, $a2
	addi.w	$s0, $s6, -1
	addi.d	$s5, $a1, 8
...
.LBB6_39:                               # %vector.body301
	...
	addi.d	$a5, $a5, 32
	bnez	$a4, .LBB6_39
# %bb.40:                               # %middle.block307
	beq	$a2, $a3, .LBB6_43
.LBB6_41:                               # %for.body.i76.preheader
	alsl.d	$a2, $a1, $fp, 3
	addi.d	$a2, $a2, 8
	nor	$a1, $a1, $zero
	add.d	$a1, $a1, $a0
	.p2align	4, , 16
.LBB6_42:                               # %for.body.i76
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a3, $a2, 0
	st.d	$a3, $a2, -8
	addi.d	$a1, $a1, -1
	addi.d	$a2, $a2, 8
	bnez	$a1, .LBB6_42
.LBB6_43:                               # %delete_arg.exit82
	addi.w	$s3, $a0, -2
	ld.d	$a0, $sp, 48                    # 8-byte Folded Reload
	st.w	$s3, $a0, 0
	bge	$s0, $s3, .LBB6_50
# %bb.44:                               # %for.body.preheader.i85
...
.LBB6_46:                               # %vector.body315
	...
	addi.d	$a4, $a4, 32
	bnez	$a3, .LBB6_46
# %bb.47:                               # %middle.block321
	beq	$a1, $a2, .LBB6_50
.LBB6_48:                               # %for.body.i87.preheader
	alsl.d	$a1, $a0, $fp, 3
	addi.d	$a1, $a1, 8
	sub.d	$a0, $s3, $a0
	.p2align	4, , 16
.LBB6_49:                               # %for.body.i87
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a2, $a1, 0
	st.d	$a2, $a1, -8
	addi.d	$a0, $a0, -1
...
# %bb.52:                               # %for.body80.preheader
	...
	ori	$a2, $zero, 45
	pcalau12i	$a0, %pc_hi20(esp_opt_table)
	addi.d	$s5, $a0, %pc_lo12(esp_opt_table)
	move	$s2, $zero
	addi.w	$a0, $zero, -4
	st.d	$a0, $sp, 32                    # 8-byte Folded Spill
	b	.LBB6_56
.LBB6_53:                               # %delete_arg.exit104
...
.LBB6_64:                               # %vector.body331
	...
	addi.d	$a5, $a5, 32
	bnez	$a4, .LBB6_64
# %bb.65:                               # %middle.block337
                                        #   in Loop: Header=BB6_56 Depth=1
	beq	$a2, $a3, .LBB6_53
.LBB6_66:                               # %for.body.i98.preheader394
                                        #   in Loop: Header=BB6_56 Depth=1
	ld.d	$a2, $sp, 40                    # 8-byte Folded Reload
	alsl.d	$a2, $a1, $a2, 3
	sub.d	$a0, $a0, $a1
	.p2align	4, , 16
.LBB6_67:                               # %for.body.i98
                                        #   Parent Loop BB6_56 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a1, $a2, 0
	st.d	$a1, $a2, -8
...
.LBB6_76:                               # %vector.body347
	...
	addi.d	$s2, $s2, 32
	bnez	$a2, .LBB6_76
# %bb.77:                               # %middle.block353
	beq	$a0, $a1, .LBB6_80
.LBB6_78:                               # %for.body.i.i.preheader
	alsl.d	$a0, $s0, $fp, 3
	addi.d	$a0, $a0, 8
	sub.d	$a1, $s3, $s0
	.p2align	4, , 16
.LBB6_79:                               # %for.body.i.i
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a2, $a0, 0
	st.d	$a2, $a0, -8
	addi.d	$a1, $a1, -1
...
.LBB6_80:                               # %if.then119
	...
	ori	$a0, $zero, 2
	blt	$s3, $a0, .LBB6_106
.LBB6_81:                               # %for.body.preheader.i114
	addi.d	$s6, $s3, -1
	bstrpick.d	$s5, $s6, 31, 0
	addi.d	$s4, $s5, -1
	addi.d	$s2, $fp, 32
...
# %bb.84:                               # %if.end124
	...
	bge	$s3, $a0, .LBB6_93
	b	.LBB6_106
.LBB6_85:                               # %if.then.i124
	addi.w	$s3, $s6, 0
	ld.d	$a0, $sp, 48                    # 8-byte Folded Reload
	st.w	$s6, $a0, 0
	bge	$s7, $s3, .LBB6_92
# %bb.86:                               # %for.body.preheader.i.i127
	sub.d	$a0, $s3, $s0
	ori	$a1, $zero, 4
	bltu	$a0, $a1, .LBB6_90
# %bb.87:                               # %vector.ph360
...
.LBB6_88:                               # %vector.body363
	...
	addi.d	$s2, $s2, 32
	bnez	$a2, .LBB6_88
# %bb.89:                               # %middle.block369
	beq	$a0, $a1, .LBB6_92
.LBB6_90:                               # %for.body.i.i129.preheader
	alsl.d	$a0, $s0, $fp, 3
	addi.d	$a0, $a0, 8
	sub.d	$a1, $s3, $s0
	.p2align	4, , 16
.LBB6_91:                               # %for.body.i.i129
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a2, $a0, 0
	st.d	$a2, $a0, -8
	addi.d	$a1, $a1, -1
...
.LBB6_92:                               # %if.then123
	...
	ori	$a0, $zero, 2
	blt	$s3, $a0, .LBB6_106
.LBB6_93:                               # %for.body.preheader.i138
	addi.d	$a4, $s3, -1
...
# %bb.98:                               # %if.then.i148
	...
	st.w	$a4, $a7, 0
	bge	$a6, $a5, .LBB6_105
# %bb.99:                               # %for.body.preheader.i.i151
	sub.d	$a4, $a5, $a0
	ori	$a6, $zero, 4
	bltu	$a4, $a6, .LBB6_103
# %bb.100:                              # %vector.ph376
...
.LBB6_101:                              # %vector.body379
	...
	addi.d	$a1, $a1, 32
	bnez	$a2, .LBB6_101
# %bb.102:                              # %middle.block385
	beq	$a4, $a3, .LBB6_105
.LBB6_103:                              # %for.body.i.i153.preheader
	alsl.d	$a1, $a0, $fp, 3
	addi.d	$a1, $a1, 8
	sub.d	$a0, $a5, $a0
.LBB6_104:                              # %for.body.i.i153
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a2, $a1, 0
	st.d	$a2, $a1, -8
	addi.d	$a0, $a0, -1
