...
# %bb.35:                               # %if.then40.i
	...
	div.wu	$a0, $fp, $a0
	blt	$a4, $a5, .LBB0_32
# %bb.36:                               # %for.body47.lr.ph.i
                                        #   in Loop: Header=BB0_34 Depth=2
	blt	$a0, $s2, .LBB0_47
# %bb.37:                               # %for.body47.us.i.preheader
                                        #   in Loop: Header=BB0_34 Depth=2
	move	$a1, $zero
	alsl.d	$a2, $s5, $a2, 2
	b	.LBB0_40
	.p2align	4, , 16
.LBB0_38:                               # %for.end78.us.i
                                        #   in Loop: Header=BB0_40 Depth=3
	add.w	$a1, $a1, $a0
.LBB0_39:                               # %for.inc81.us.i
                                        #   in Loop: Header=BB0_40 Depth=3
	addi.w	$a5, $a3, 1
	bge	$a3, $a4, .LBB0_32
.LBB0_40:                               # %for.body47.us.i
                                        #   Parent Loop BB0_14 Depth=1
	...
	and	$a7, $a5, $a7
	beqz	$a7, .LBB0_39
# %bb.41:                               # %for.cond54.preheader.us.i
                                        #   in Loop: Header=BB0_40 Depth=3
	bge	$a1, $s8, .LBB0_38
# %bb.42:                               # %for.cond57.preheader.lr.ph.us.i
                                        #   in Loop: Header=BB0_40 Depth=3
	ld.d	$a4, $s3, 24
	alsl.d	$a4, $a6, $a4, 2
	add.d	$a6, $s0, $a1
	move	$a7, $a1
	.p2align	4, , 16
.LBB0_43:                               # %for.cond57.preheader.us.us.i
                                        #   Parent Loop BB0_14 Depth=1
                                        #     Parent Loop BB0_34 Depth=2
...
.LBB0_44:                               # %for.body59.us.us.i
	...
	addi.d	$t0, $t0, 1
	bnez	$t1, .LBB0_44
# %bb.45:                               # %for.cond57.for.inc76_crit_edge.us.us.i
                                        #   in Loop: Header=BB0_43 Depth=4
	add.w	$a7, $a7, $fp
	add.d	$a6, $a6, $fp
	blt	$a7, $s8, .LBB0_43
# %bb.46:                               # %for.end78.us.loopexit.i
                                        #   in Loop: Header=BB0_40 Depth=3
	ld.w	$a4, $a2, 0
	b	.LBB0_38
.LBB0_47:                               # %for.body47.lr.ph.split.i
                                        #   in Loop: Header=BB0_34 Depth=2
	srai.d	$a1, $a5, 5
	slli.d	$a1, $a1, 2
	...
	andi	$a1, $a1, 1
	beqz	$a1, .LBB0_32
# %bb.48:                               # %for.body47.lr.ph.split.i
                                        #   in Loop: Header=BB0_34 Depth=2
	blt	$s8, $s2, .LBB0_32
# %bb.49:                               # %for.cond57.preheader.i.preheader
                                        #   in Loop: Header=BB0_34 Depth=2
	move	$a1, $zero
	.p2align	4, , 16
.LBB0_50:                               # %for.cond57.preheader.i
                                        #   Parent Loop BB0_14 Depth=1
                                        #     Parent Loop BB0_34 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	add.w	$a1, $a1, $fp
