...
.LBB0_46:                               # %for.body47.lr.ph.split.i
	...
	andi	$a1, $a1, 1
	beqz	$a1, .LBB0_31
# %bb.47:                               # %for.cond57.preheader.i.preheader
                                        #   in Loop: Header=BB0_33 Depth=2
	move	$a1, $zero
	.p2align	4, , 16
.LBB0_48:                               # %for.cond57.preheader.i
                                        #   Parent Loop BB0_14 Depth=1
                                        #     Parent Loop BB0_33 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	add.w	$a1, $a1, $fp
...
.LBB0_49:                               # %for.end49
	...
	addi.d	$sp, $sp, 160
	ret
.LBB0_50:                               # %for.cond15.preheader.preheader
	slli.d	$a0, $s5, 3
	st.d	$a0, $sp, 24                    # 8-byte Folded Spill
	sub.d	$a0, $s2, $s5
	addi.d	$a0, $a0, 1
	...
	b	.LBB0_52
	.p2align	4, , 16
.LBB0_51:                               # %for.cond15.for.end28_crit_edge
...
# %bb.22:                               # %vector.memcheck115
	...
	alsl.d	$t5, $t2, $a2, 2
	bgeu	$t4, $t6, .LBB10_24
# %bb.23:                               # %vector.memcheck115
                                        #   in Loop: Header=BB10_21 Depth=2
	addi.d	$t4, $t5, 4
	alsl.d	$t3, $t3, $a3, 2
	bltu	$t3, $t4, .LBB10_27
.LBB10_24:                              # %vector.ph129
                                        #   in Loop: Header=BB10_21 Depth=2
	move	$t3, $t1
	bstrins.d	$t3, $zero, 2, 0
	sub.d	$t4, $t2, $t3
