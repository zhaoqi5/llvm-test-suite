...
# %bb.35:                               # %for.body47.lr.ph.i
                                        #   in Loop: Header=BB0_33 Depth=2
	bgeu	$s2, $a0, .LBB0_41
# %bb.36:                               # %for.body47.lr.ph.split.i
                                        #   in Loop: Header=BB0_33 Depth=2
	srai.d	$a0, $a5, 5
	alsl.d	$a0, $a0, $s4, 2
	ld.w	$a0, $a0, 4
	...
	move	$a1, $zero
	beqz	$a0, .LBB0_32
# %bb.37:                               # %for.body47.lr.ph.split.i
                                        #   in Loop: Header=BB0_33 Depth=2
	blez	$s8, .LBB0_32
# %bb.38:                               # %for.cond57.preheader.i.preheader
                                        #   in Loop: Header=BB0_33 Depth=2
	move	$a0, $zero
	.p2align	4, , 16
.LBB0_39:                               # %for.cond57.preheader.i
                                        #   Parent Loop BB0_14 Depth=1
...
# %bb.40:                               #   in Loop: Header=BB0_33 Depth=2
	move	$a1, $zero
	b	.LBB0_32
.LBB0_41:                               # %for.body47.us.i.preheader
                                        #   in Loop: Header=BB0_33 Depth=2
	move	$a0, $zero
	alsl.d	$a2, $s5, $a2, 2
	b	.LBB0_44
	.p2align	4, , 16
.LBB0_42:                               # %for.end78.us.i
                                        #   in Loop: Header=BB0_44 Depth=3
	add.w	$a0, $a0, $a1
.LBB0_43:                               # %for.inc81.us.i
                                        #   in Loop: Header=BB0_44 Depth=3
	addi.w	$a5, $a3, 1
	bge	$a3, $a4, .LBB0_32
.LBB0_44:                               # %for.body47.us.i
                                        #   Parent Loop BB0_14 Depth=1
                                        #     Parent Loop BB0_33 Depth=2
	...
	and	$a7, $a5, $a7
	beqz	$a7, .LBB0_43
# %bb.45:                               # %for.cond54.preheader.us.i
                                        #   in Loop: Header=BB0_44 Depth=3
	bge	$a0, $s8, .LBB0_42
# %bb.46:                               # %for.cond57.preheader.lr.ph.us.i
                                        #   in Loop: Header=BB0_44 Depth=3
	ld.d	$a4, $s3, 24
	alsl.d	$a4, $a6, $a4, 2
	add.d	$a6, $fp, $a0
	move	$a7, $a0
	.p2align	4, , 16
.LBB0_47:                               # %for.cond57.preheader.us.us.i
                                        #   Parent Loop BB0_14 Depth=1
                                        #     Parent Loop BB0_33 Depth=2
...
.LBB0_48:                               # %for.body59.us.us.i
	...
	stx.w	$t2, $a4, $t1
	blt	$t0, $a1, .LBB0_48
# %bb.49:                               # %for.cond57.for.inc76_crit_edge.us.us.i
                                        #   in Loop: Header=BB0_47 Depth=4
	add.w	$a7, $a7, $s2
	add.d	$a6, $a6, $s2
	blt	$a7, $s8, .LBB0_47
# %bb.50:                               # %for.end78.us.loopexit.i
                                        #   in Loop: Header=BB0_44 Depth=3
	ld.w	$a4, $a2, 0
	b	.LBB0_42
.LBB0_51:                               # %for.end49
	...
	addi.d	$sp, $sp, 160
	ret
.LBB0_52:                               # %for.cond15.preheader.preheader
	slli.d	$a0, $s4, 3
	...
	b	.LBB0_54
	.p2align	4, , 16
.LBB0_53:                               # %for.cond15.for.end28_crit_edge
...
.LBB10_7:                               # %for.body.i
	...
	addi.d	$t1, $t1, 1
	bltu	$t1, $s6, .LBB10_13
# %bb.8:                                # %vector.memcheck144
                                        #   in Loop: Header=BB10_7 Depth=2
	alsl.d	$t4, $t3, $a2, 2
	alsl.d	$t6, $t2, $a7, 2
	alsl.d	$t5, $t2, $a2, 2
	bgeu	$t4, $t6, .LBB10_10
# %bb.9:                                # %vector.memcheck144
                                        #   in Loop: Header=BB10_7 Depth=2
	addi.d	$t4, $t5, 4
	alsl.d	$t3, $t3, $a3, 2
	bltu	$t3, $t4, .LBB10_13
.LBB10_10:                              # %vector.ph158
                                        #   in Loop: Header=BB10_7 Depth=2
	move	$t3, $t1
...
.LBB10_20:                              # %for.body.i40
	...
	addi.d	$t1, $t1, 1
	bltu	$t1, $s6, .LBB10_26
# %bb.21:                               # %vector.memcheck115
                                        #   in Loop: Header=BB10_20 Depth=2
	alsl.d	$t4, $t3, $a2, 2
	alsl.d	$t6, $t2, $a7, 2
	alsl.d	$t5, $t2, $a2, 2
	bgeu	$t4, $t6, .LBB10_23
# %bb.22:                               # %vector.memcheck115
                                        #   in Loop: Header=BB10_20 Depth=2
	addi.d	$t4, $t5, 4
	alsl.d	$t3, $t3, $a3, 2
	bltu	$t3, $t4, .LBB10_26
.LBB10_23:                              # %vector.ph129
                                        #   in Loop: Header=BB10_20 Depth=2
	move	$t3, $t1
	bstrins.d	$t3, $zero, 1, 0
	sub.d	$t4, $t2, $t3
...
.LBB10_24:                              # %vector.body132
	...
	addi.d	$t5, $t5, -16
	bnez	$t6, .LBB10_24
# %bb.25:                               # %middle.block141
                                        #   in Loop: Header=BB10_20 Depth=2
	move	$t2, $t4
	beq	$t1, $t3, .LBB10_19
	.p2align	4, , 16
.LBB10_26:                              # %do.body.i42.preheader
                                        #   in Loop: Header=BB10_20 Depth=2
	addi.d	$t1, $t2, 1
	alsl.d	$t3, $t2, $a3, 2
	alsl.d	$t2, $t2, $a2, 2
	.p2align	4, , 16
.LBB10_27:                              # %do.body.i42
                                        #   Parent Loop BB10_2 Depth=1
                                        #     Parent Loop BB10_20 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.w	$t4, $t2, 0
	...
	b	.LBB10_19
	.p2align	4, , 16
.LBB10_28:                              # %uncof_output.exit56.loopexit
                                        #   in Loop: Header=BB10_2 Depth=1
	ld.w	$a3, $s4, 124
	slli.d	$a1, $a3, 2
	ldx.w	$a0, $a0, $a1
	add.w	$a6, $a0, $s2
.LBB10_29:                              # %uncof_output.exit56
                                        #   in Loop: Header=BB10_2 Depth=1
	ld.d	$a0, $s3, 8
	beqz	$a0, .LBB10_41
# %bb.30:                               # %if.end.i58
...
# %bb.38:                               # %middle.block
	...
	beq	$t0, $t2, .LBB10_32
	.p2align	4, , 16
.LBB10_39:                              # %do.body.i74.preheader
                                        #   in Loop: Header=BB10_33 Depth=2
	addi.d	$t0, $t1, 1
	alsl.d	$t2, $t1, $a2, 2
	alsl.d	$t1, $t1, $a1, 2
	.p2align	4, , 16
.LBB10_40:                              # %do.body.i74
                                        #   Parent Loop BB10_2 Depth=1
                                        #     Parent Loop BB10_33 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.w	$t3, $t1, 0
