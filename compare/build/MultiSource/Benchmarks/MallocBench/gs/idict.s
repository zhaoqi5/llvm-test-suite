...
# %bb.1:                                # %while.body.preheader
	...
	b	.LBB6_5
	.p2align	4, , 16
.LBB6_2:                                # %entry.if.end26_crit_edge.i
                                        #   in Loop: Header=BB6_5 Depth=1
	ld.d	$a0, $sp, 16
.LBB6_3:                                # %dict_put.exit.thread
                                        #   in Loop: Header=BB6_5 Depth=1
	vld	$vr0, $s0, 16
	vst	$vr0, $a0, 0
.LBB6_4:                                # %if.end11
...
# %bb.9:                                # %while.body.preheader.i4
	...
	b	.LBB7_13
	.p2align	4, , 16
.LBB7_10:                               # %entry.if.end26_crit_edge.i.i
                                        #   in Loop: Header=BB7_13 Depth=1
	ld.d	$a0, $sp, 32
.LBB7_11:                               # %dict_put.exit.thread.i
                                        #   in Loop: Header=BB7_13 Depth=1
	vld	$vr0, $s1, 16
	vst	$vr0, $a0, 0
.LBB7_12:                               # %if.end11.i
...
# %bb.19:                               # %lor.lhs.false.i.i
	...
	ld.d	$a3, $s6, 16
	bne	$fp, $a3, .LBB7_21
.LBB7_20:                               # %if.then21.i.i
                                        #   in Loop: Header=BB7_13 Depth=1
	move	$a2, $a0
.LBB7_21:                               # %if.end24.i.i
                                        #   in Loop: Header=BB7_13 Depth=1
	st.d	$a2, $a1, 24
	b	.LBB7_11
.LBB7_22:                               # %dict_copy.exit
	ld.d	$a0, $s0, 0
	ld.hu	$a1, $a0, 26
	ld.d	$a0, $s3, 16
	srli.d	$a1, $a1, 1
