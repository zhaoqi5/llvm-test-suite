...
.LBB11_26:                              #   in Loop: Header=BB11_23 Depth=1
	move	$t2, $t4
	move	$t1, $t5
.LBB11_27:                              # %while.body119.us.preheader471
                                        #   in Loop: Header=BB11_23 Depth=1
	move	$s5, $s1
	move	$a7, $t1
	.p2align	4, , 16
...
.LBB11_31:                              #   in Loop: Header=BB11_23 Depth=1
	move	$t2, $t4
	move	$t1, $t5
.LBB11_32:                              # %while.body119.preheader472
                                        #   in Loop: Header=BB11_23 Depth=1
	move	$s5, $s1
	move	$a7, $t1
	.p2align	4, , 16
...
.LBB11_39:                              # %vector.body420
	...
	vandn.v	$vr6, $vr10, $vr6
	vandn.v	$vr9, $vr10, $vr9
	vandn.v	$vr7, $vr10, $vr7
	vandn.v	$vr8, $vr10, $vr8
	vor.v	$vr4, $vr8, $vr4
	vor.v	$vr3, $vr7, $vr3
	vor.v	$vr5, $vr9, $vr5
	vor.v	$vr2, $vr6, $vr2
	...
	addi.d	$s5, $s5, 16
	bne	$ra, $s5, .LBB11_39
# %bb.40:                               # %middle.block427
                                        #   in Loop: Header=BB11_23 Depth=1
	ld.d	$t2, $sp, 24                    # 8-byte Folded Reload
	ld.d	$a6, $sp, 48                    # 8-byte Folded Reload
	bne	$ra, $a6, .LBB11_27
	b	.LBB11_34
.LBB11_41:                              # %vector.memcheck432
                                        #   in Loop: Header=BB11_23 Depth=1
	addi.d	$t2, $s1, 1
...
.LBB11_58:                              #   in Loop: Header=BB11_50 Depth=1
	...
	move	$ra, $t4
	move	$s1, $s5
.LBB11_59:                              # %while.body196.us.us.preheader474
                                        #   in Loop: Header=BB11_50 Depth=1
	move	$s3, $s1
	.p2align	4, , 16
...
.LBB11_64:                              #   in Loop: Header=BB11_50 Depth=1
	...
	move	$ra, $t4
	move	$s1, $s5
.LBB11_65:                              # %while.body196.us171.preheader475
                                        #   in Loop: Header=BB11_50 Depth=1
	move	$s3, $s1
	.p2align	4, , 16
...
.LBB11_71:                              # %vector.body
	...
	vxor.v	$vr6, $vr6, $vr1
	vilvh.b	$vr9, $vr8, $vr8
	vilvl.h	$vr10, $vr9, $vr9
	vilvh.h	$vr9, $vr9, $vr9
	vilvl.b	$vr8, $vr8, $vr8
	vilvl.h	$vr11, $vr8, $vr8
	vilvh.h	$vr8, $vr8, $vr8
	addi.d	$t1, $zero, -1
	maskeqz	$t1, $t1, $t7
	vreplgr2vr.w	$vr12, $t1
	vandn.v	$vr8, $vr12, $vr8
	vandn.v	$vr11, $vr12, $vr11
	vandn.v	$vr9, $vr12, $vr9
	vandn.v	$vr10, $vr12, $vr10
	vor.v	$vr6, $vr10, $vr6
	vor.v	$vr5, $vr9, $vr5
	vor.v	$vr7, $vr11, $vr7
	vor.v	$vr4, $vr8, $vr4
