...
# %bb.41:                               # %if.then91
	...
	st.d	$t2, $t3, 56
	beqz	$t5, .LBB2_65
# %bb.42:                               # %if.else47.i275
                                        #   in Loop: Header=BB2_4 Depth=1
	ld.d	$t2, $t5, 8
	bge	$t4, $t2, .LBB2_46
	.p2align	4, , 16
.LBB2_43:                               # %while.cond64.i294
                                        #   Parent Loop BB2_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$t2, $t5
	ld.d	$t5, $t5, 72
	beqz	$t5, .LBB2_87
# %bb.44:                               # %land.rhs67.i298
                                        #   in Loop: Header=BB2_43 Depth=2
	ld.d	$t6, $t5, 8
	blt	$t4, $t6, .LBB2_43
# %bb.45:                               # %if.then78.i301
                                        #   in Loop: Header=BB2_4 Depth=1
	st.d	$t5, $t3, 72
	st.d	$t2, $t3, 80
	st.d	$t3, $t2, 72
...
.LBB2_49:                               # %if.then44
	...
	ld.d	$t3, $a7, 32
	bge	$a4, $t5, .LBB2_51
# %bb.50:                               # %land.lhs.true50
                                        #   in Loop: Header=BB2_4 Depth=1
	ld.d	$t6, $a7, 24
	blt	$a4, $t6, .LBB2_54
.LBB2_51:                               # %cond.false55
                                        #   in Loop: Header=BB2_4 Depth=1
	sub.d	$t6, $t3, $t4
	blt	$t6, $a1, .LBB2_53
# %bb.52:                               # %cond.true58
...
# %bb.56:                               # %if.end.i
	...
	st.d	$t2, $t4, 56
	beqz	$t7, .LBB2_64
# %bb.57:                               # %if.else47.i143
                                        #   in Loop: Header=BB2_4 Depth=1
	ld.d	$t2, $t7, 8
	bge	$t6, $t2, .LBB2_61
	.p2align	4, , 16
.LBB2_58:                               # %while.cond64.i162
                                        #   Parent Loop BB2_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$t2, $t7
	ld.d	$t7, $t7, 72
	beqz	$t7, .LBB2_67
# %bb.59:                               # %land.rhs67.i166
                                        #   in Loop: Header=BB2_58 Depth=2
	ld.d	$t5, $t7, 8
	blt	$t6, $t5, .LBB2_58
# %bb.60:                               # %if.then78.i169
                                        #   in Loop: Header=BB2_4 Depth=1
	st.d	$t7, $t4, 72
	st.d	$t2, $t4, 80
	st.d	$t4, $t2, 72
...
# %bb.63:                               # %if.then60.i153
	...
	st.d	$t4, $t7, 72
	b	.LBB2_69
.LBB2_64:                               # %if.then44.i179
                                        #   in Loop: Header=BB2_4 Depth=1
	vst	$vr0, $t4, 72
	st.d	$t4, $a2, 24
	b	.LBB2_69
.LBB2_65:                               # %if.then44.i311
                                        #   in Loop: Header=BB2_4 Depth=1
	vst	$vr0, $t3, 72
	st.d	$t3, $a2, 24
	b	.LBB2_89
...
.LBB2_67:                               # %if.else80.i174
	...
	st.d	$t4, $a2, 24
	b	.LBB2_69
.LBB2_68:                               # %if.end84.critedge.i158
                                        #   in Loop: Header=BB2_4 Depth=1
	st.d	$zero, $t4, 80
	st.d	$t2, $t4, 72
	st.d	$t4, $t2, 80
.LBB2_69:                               # %add_y_line.exit183
                                        #   in Loop: Header=BB2_4 Depth=1
	st.d	$t4, $a2, 32
.LBB2_70:                               # %if.end83
                                        #   in Loop: Header=BB2_4 Depth=1
...
.LBB2_75:                               # %if.end.i196
	...
	st.d	$t7, $t2, 56
	beqz	$t6, .LBB2_83
# %bb.76:                               # %if.else47.i209
                                        #   in Loop: Header=BB2_4 Depth=1
	ld.d	$t4, $t6, 8
	bge	$t3, $t4, .LBB2_80
	.p2align	4, , 16
.LBB2_77:                               # %while.cond64.i228
                                        #   Parent Loop BB2_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	move	$t4, $t6
	ld.d	$t6, $t6, 72
	beqz	$t6, .LBB2_84
# %bb.78:                               # %land.rhs67.i232
                                        #   in Loop: Header=BB2_77 Depth=2
	ld.d	$t5, $t6, 8
	blt	$t3, $t5, .LBB2_77
# %bb.79:                               # %if.then78.i235
                                        #   in Loop: Header=BB2_4 Depth=1
	st.d	$t6, $t2, 72
	st.d	$t4, $t2, 80
	st.d	$t2, $t4, 72
...
# %bb.82:                               # %if.then60.i219
	...
	st.d	$t2, $a2, 32
	b	.LBB2_90
.LBB2_83:                               # %if.then44.i245
                                        #   in Loop: Header=BB2_4 Depth=1
	vst	$vr0, $t2, 72
	b	.LBB2_85
.LBB2_84:                               # %if.else80.i240
                                        #   in Loop: Header=BB2_4 Depth=1
	st.d	$zero, $t2, 72
	st.d	$t4, $t2, 80
	st.d	$t2, $t4, 72
.LBB2_85:                               # %sw.epilog
	...
	st.d	$t2, $a2, 32
	b	.LBB2_90
.LBB2_86:                               # %if.end84.critedge.i224
                                        #   in Loop: Header=BB2_4 Depth=1
	st.d	$zero, $t2, 80
	st.d	$t4, $t2, 72
	st.d	$t2, $t4, 80
...
.LBB2_87:                               # %if.else80.i306
	...
	st.d	$t3, $a2, 24
	b	.LBB2_89
.LBB2_88:                               # %if.end84.critedge.i290
                                        #   in Loop: Header=BB2_4 Depth=1
	st.d	$zero, $t3, 80
	st.d	$t2, $t3, 72
	st.d	$t3, $t2, 80
.LBB2_89:                               # %add_y_line.exit314
                                        #   in Loop: Header=BB2_4 Depth=1
	st.d	$t3, $a2, 32
	.p2align	4, , 16
.LBB2_90:                               # %sw.epilog
