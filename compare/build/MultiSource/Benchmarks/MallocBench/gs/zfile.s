...
.LBB2_11:                               # %if.then
	...
	masknez	$a1, $a1, $a0
	slli.d	$a2, $s2, 2
	pcalau12i	$a3, %pc_hi20(std_file_attrs)
	addi.d	$a3, $a3, %pc_lo12(std_file_attrs)
	ldx.w	$a2, $a3, $a2
	ori	$a3, $zero, 514
	maskeqz	$a0, $a3, $a0
	or	$a1, $a0, $a1
...
# %bb.12:                               # %if.end
	slli.d	$a2, $s2, 5
	pcalau12i	$a0, %pc_hi20(std_files)
	addi.d	$a0, $a0, %pc_lo12(std_files)
	add.d	$s3, $a0, $a2
	st.d	$s3, $fp, 0
	ori	$a1, $a1, 12
	addi.d	$a2, $s2, -3
...
# %bb.13:                               # %sw.bb
	...
	addi.d	$s6, $a0, %pc_lo12(lineedit_buf)
	addi.w	$s4, $zero, -1
	ori	$s5, $zero, 10
	ori	$s7, $zero, 13
	addi.w	$s1, $zero, -15
...
# %bb.7:                                # %sw.epilog
	...
	bne	$s2, $s4, .LBB13_2
	b	.LBB13_16
.LBB13_8:                               # %cleanup.sink.split.loopexit39
	move	$s1, $zero
	b	.LBB13_15
...
# %bb.7:                                # %sw.epilog.i
	...
	bne	$s2, $s4, .LBB14_2
	b	.LBB14_16
.LBB14_8:                               # %cleanup.sink.split.i.loopexit27
	move	$s0, $zero
	b	.LBB14_15
