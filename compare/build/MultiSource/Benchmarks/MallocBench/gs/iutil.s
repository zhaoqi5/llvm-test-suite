...
# %bb.1:                                # %if.end69
	...
	bnez	$a4, .LBB1_16
.LBB1_2:                                # %cond.end82
	bstrpick.d	$a4, $a2, 5, 2
	ori	$a2, $zero, 1
	slli.d	$a4, $a4, 2
	pcalau12i	$a5, %pc_hi20(.LJTI1_1)
	addi.d	$a5, $a5, %pc_lo12(.LJTI1_1)
	ldx.w	$a4, $a5, $a4
	add.d	$a4, $a5, $a4
	jr	$a4
.LBB1_3:                                # %sw.bb84
...
.LBB6_8:
	move	$a0, $zero
	ret
.LBB6_9:                                # %while.body.us.us.preheader
	addi.d	$a3, $a3, 8
	addi.w	$a2, $zero, -20
	ori	$a4, $zero, 11
	ori	$a5, $zero, 5
	b	.LBB6_11
	.p2align	4, , 16
.LBB6_10:                               # %sw.epilog.us.us
                                        #   in Loop: Header=BB6_11 Depth=1
	addi.w	$a1, $a1, -1
	addi.d	$a3, $a3, -16
	blez	$a1, .LBB6_7
.LBB6_11:                               # %while.body.us.us
                                        # =>This Inner Loop Header: Depth=1
	ld.h	$a6, $a3, 0
	bstrpick.d	$a6, $a6, 7, 2
	slli.w	$a0, $a0, 1
	beq	$a6, $a4, .LBB6_10
# %bb.12:                               # %while.body.us.us
                                        #   in Loop: Header=BB6_11 Depth=1
	bne	$a6, $a5, .LBB6_14
# %bb.13:                               # %sw.bb1.us.us
                                        #   in Loop: Header=BB6_11 Depth=1
