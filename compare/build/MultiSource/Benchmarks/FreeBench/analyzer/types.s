...
# %bb.0:                                # %entry
	...
	move	$s0, $a1
	move	$s1, $a0
	pcalau12i	$a0, %got_pc_hi20(def_table_size)
	ld.d	$a0, $a0, %got_pc_lo12(def_table_size)
	ld.w	$a0, $a0, 0
	mod.du	$s2, $s1, $a0
	pcalau12i	$a0, %got_pc_hi20(def_table)
	ld.d	$a0, $a0, %got_pc_lo12(def_table)
	ld.d	$s3, $a0, 0
	slli.d	$a0, $s2, 3
	ldx.d	$a0, $s3, $a0
	beqz	$a0, .LBB3_5
