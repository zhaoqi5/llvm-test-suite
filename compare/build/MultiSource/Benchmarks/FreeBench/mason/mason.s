...
# %bb.21:                               # %cond.false
	...
	ld.w	$t0, $a0, 20
	slli.d	$a7, $a7, 2
	pcalau12i	$t1, %pc_hi20(.L__const.m0u.m)
	addi.d	$t1, $t1, %pc_lo12(.L__const.m0u.m)
	ldx.w	$a7, $t1, $a7
	ld.w	$t2, $a0, 24
	ld.w	$t3, $a0, 28
	move	$s2, $a0
...
.LBB1_28:                               # %cond.end120
	...
	ld.w	$a7, $a0, 20
	slli.d	$a2, $a2, 2
	pcalau12i	$t0, %pc_hi20(.L__const.m2u.m)
	addi.d	$t0, $t0, %pc_lo12(.L__const.m2u.m)
	ldx.w	$a2, $t0, $a2
	ld.w	$t1, $a0, 24
	ld.w	$t2, $a0, 28
	ld.w	$a0, $a0, 32
...
# %bb.2:                                # %cond.false
	...
	ld.w	$a6, $s0, 20
	slli.d	$a0, $a0, 2
	pcalau12i	$a7, %pc_hi20(.L__const.m0d.m)
	addi.d	$a7, $a7, %pc_lo12(.L__const.m0d.m)
	ldx.w	$a0, $a7, $a0
	ld.w	$t0, $s0, 24
	ld.w	$t1, $s0, 28
	ld.w	$t2, $s0, 32
...
.LBB2_10:                               # %cond.end34
	...
	ld.w	$a6, $s0, 20
	slli.d	$a0, $a0, 2
	pcalau12i	$a7, %pc_hi20(.L__const.m2d.m)
	addi.d	$a7, $a7, %pc_lo12(.L__const.m2d.m)
	ldx.w	$a0, $a7, $a0
	ld.w	$t0, $s0, 24
	ld.w	$t1, $s0, 28
	ld.w	$t2, $s0, 32
