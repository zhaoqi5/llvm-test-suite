...
# %bb.36:                               #   in Loop: Header=BB0_35 Depth=2
	...
	b	.LBB0_40
	.p2align	4, , 16
.LBB0_37:                               # %vector.body143.preheader
                                        #   in Loop: Header=BB0_35 Depth=2
	addi.d	$t5, $t4, 16
	move	$t6, $t2
	move	$t7, $a5
...
# %bb.43:                               #   in Loop: Header=BB0_35 Depth=2
	...
	b	.LBB0_47
	.p2align	4, , 16
.LBB0_44:                               # %vector.body125.preheader
                                        #   in Loop: Header=BB0_35 Depth=2
	addi.d	$t6, $t4, 16
	move	$t7, $t2
	move	$t8, $a5
...
# %bb.46:                               # %middle.block133
	...
	move	$t8, $a5
	beq	$a5, $a4, .LBB0_34
.LBB0_47:                               # %for.body.i15.us.us.i.preheader227
                                        #   in Loop: Header=BB0_35 Depth=2
	sub.d	$t7, $a4, $t8
	alsl.d	$t4, $t8, $t4, 2
	alsl.d	$t8, $t8, $t1, 2
...
.LBB0_95:                               # %vec.epilog.ph182
	...
	alsl.d	$a7, $a7, $a1, 2
	.p2align	4, , 16
.LBB0_96:                               # %vec.epilog.vector.body187
                                        #   Parent Loop BB0_79 Depth=1
                                        #     Parent Loop BB0_83 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vld	$vr1, $a7, 0
	...
	addi.d	$a7, $a7, 16
	bnez	$a4, .LBB0_96
# %bb.97:                               # %vec.epilog.middle.block193
                                        #   in Loop: Header=BB0_83 Depth=2
	vslli.w	$vr0, $vr0, 31
	vmskltz.w	$vr0, $vr0
	vpickve2gr.hu	$a4, $vr0, 0
...
# %bb.63:                               # %middle.block
                                        #   in Loop: Header=BB2_7 Depth=1
	beq	$a0, $s8, .LBB2_6
.LBB2_64:                               # %for.body137.preheader44
                                        #   in Loop: Header=BB2_7 Depth=1
	alsl.d	$a1, $a0, $s1, 2
	alsl.d	$a2, $a0, $a7, 2
	sub.d	$a0, $s8, $a0
