...
# %bb.35:                               #   in Loop: Header=BB0_34 Depth=2
	...
	b	.LBB0_39
	.p2align	4, , 16
.LBB0_36:                               # %vector.body135.preheader
                                        #   in Loop: Header=BB0_34 Depth=2
	addi.d	$t5, $t4, 16
	move	$t6, $t2
	move	$t7, $a5
...
# %bb.42:                               #   in Loop: Header=BB0_34 Depth=2
	...
	b	.LBB0_46
	.p2align	4, , 16
.LBB0_43:                               # %vector.body117.preheader
                                        #   in Loop: Header=BB0_34 Depth=2
	addi.d	$t6, $t4, 16
	move	$t7, $t2
	move	$t8, $a5
...
# %bb.45:                               # %middle.block125
	...
	move	$t8, $a5
	beq	$a5, $a4, .LBB0_33
.LBB0_46:                               # %for.body.i15.us.us.i.preheader219
                                        #   in Loop: Header=BB0_34 Depth=2
	sub.d	$t7, $a4, $t8
	alsl.d	$t4, $t8, $t4, 2
	alsl.d	$t8, $t8, $t1, 2
...
# %bb.88:                               #   in Loop: Header=BB0_83 Depth=2
	...
	b	.LBB0_98
	.p2align	4, , 16
.LBB0_89:                               # %vector.main.loop.iter.check154
                                        #   in Loop: Header=BB0_83 Depth=2
	ori	$a3, $zero, 16
	bgeu	$a0, $a3, .LBB0_91
...
# %bb.93:                               # %middle.block167
	...
	maskeqz	$a4, $s5, $a4
	beq	$a3, $a0, .LBB0_100
# %bb.94:                               # %vec.epilog.iter.check173
                                        #   in Loop: Header=BB0_83 Depth=2
	andi	$a5, $a0, 12
	beqz	$a5, .LBB0_98
.LBB0_95:                               # %vec.epilog.ph172
                                        #   in Loop: Header=BB0_83 Depth=2
	move	$a7, $a3
	xor	$a3, $a4, $s5
	sltu	$a4, $zero, $a3
	...
	alsl.d	$a7, $a7, $a1, 2
	.p2align	4, , 16
.LBB0_96:                               # %vec.epilog.vector.body180
                                        #   Parent Loop BB0_79 Depth=1
                                        #     Parent Loop BB0_83 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vld	$vr1, $a7, 0
	...
	addi.d	$a7, $a7, 16
	bnez	$a4, .LBB0_96
# %bb.97:                               # %vec.epilog.middle.block186
                                        #   in Loop: Header=BB0_83 Depth=2
	vslli.w	$vr0, $vr0, 31
	vmskltz.w	$vr0, $vr0
	vpickve2gr.hu	$a4, $vr0, 0
...
# %bb.20:                               #   in Loop: Header=BB2_7 Depth=1
	...
	b	.LBB2_39
	.p2align	4, , 16
.LBB2_21:                               # %for.cond53.preheader.lr.ph
                                        #   in Loop: Header=BB2_7 Depth=1
	vld	$vr6, $sp, 112                  # 16-byte Folded Reload
	xvld	$xr7, $sp, 80                   # 32-byte Folded Reload
	blt	$s5, $s4, .LBB2_64
# %bb.22:                               # %for.cond53.preheader.preheader
                                        #   in Loop: Header=BB2_7 Depth=1
	move	$a0, $zero
	.p2align	4, , 16
.LBB2_23:                               # %for.cond53.preheader
                                        #   Parent Loop BB2_7 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB2_26 Depth 3
                                        #         Child Loop BB2_29 Depth 4
...
.LBB2_26:                               # %for.body56
	...
	bcnez	$fcc0, .LBB2_25
# %bb.27:                               # %for.cond63.preheader
                                        #   in Loop: Header=BB2_26 Depth=3
	fmov.d	$fa0, $fs0
	blt	$s5, $s4, .LBB2_31
# %bb.28:                               # %for.body66.lr.ph
                                        #   in Loop: Header=BB2_26 Depth=3
	slli.d	$a0, $s2, 3
	ldx.d	$a0, $fp, $a0
	move	$a1, $s1
...
# %bb.61:                               # %middle.block
                                        #   in Loop: Header=BB2_7 Depth=1
	beq	$a0, $s5, .LBB2_6
.LBB2_62:                               # %for.body137.preheader44
                                        #   in Loop: Header=BB2_7 Depth=1
	alsl.d	$a1, $a0, $s1, 2
	alsl.d	$a2, $a0, $a6, 2
	sub.d	$a0, $s5, $a0
