...
.LBB11_17:                              # %for.inc.i
	...
	ori	$a0, $zero, 2
	beqz	$a1, .LBB11_23
# %bb.18:                               # %for.cond.i21.1
                                        #   in Loop: Header=BB11_3 Depth=1
	andi	$a1, $fp, 256
	ori	$a0, $zero, 256
	beqz	$a1, .LBB11_23
# %bb.19:                               # %for.cond.1.i25.1
                                        #   in Loop: Header=BB11_3 Depth=1
	lu12i.w	$a0, 8
	and	$a1, $fp, $a0
	beqz	$a1, .LBB11_23
# %bb.20:                               # %for.cond.2.i29.1
                                        #   in Loop: Header=BB11_3 Depth=1
	lu12i.w	$a0, 1024
	and	$a1, $fp, $a0
	beqz	$a1, .LBB11_23
# %bb.21:                               # %for.cond.3.i33.1
                                        #   in Loop: Header=BB11_3 Depth=1
	lu12i.w	$a0, 131072
	and	$a1, $fp, $a0
	beqz	$a1, .LBB11_23
# %bb.22:                               # %for.cond.4.i37.1
                                        #   in Loop: Header=BB11_3 Depth=1
	ori	$a0, $zero, 0
	lu32i.d	$a0, 16
	and	$a1, $fp, $a0
...
# %bb.24:                               #   in Loop: Header=BB11_3 Depth=1
	...
	ori	$a0, $zero, 4
	beqz	$a1, .LBB11_35
.LBB11_25:                              # %for.cond.i21.2
                                        #   in Loop: Header=BB11_3 Depth=1
	andi	$a1, $fp, 512
	ori	$a0, $zero, 512
	beqz	$a1, .LBB11_35
# %bb.26:                               # %for.cond.1.i25.2
                                        #   in Loop: Header=BB11_3 Depth=1
	lu12i.w	$a0, 16
	and	$a1, $fp, $a0
	beqz	$a1, .LBB11_35
# %bb.27:                               # %for.cond.2.i29.2
                                        #   in Loop: Header=BB11_3 Depth=1
	lu12i.w	$a0, 2048
	and	$a1, $fp, $a0
	beqz	$a1, .LBB11_35
# %bb.28:                               # %for.cond.3.i33.2
                                        #   in Loop: Header=BB11_3 Depth=1
	lu12i.w	$a0, 262144
	and	$a1, $fp, $a0
	beqz	$a1, .LBB11_35
# %bb.29:                               # %for.cond.4.i37.2
                                        #   in Loop: Header=BB11_3 Depth=1
	ori	$a0, $zero, 0
	lu32i.d	$a0, 32
	and	$a1, $fp, $a0
...
# %bb.36:                               #   in Loop: Header=BB11_3 Depth=1
	...
	maskeqz	$a1, $s5, $a1
	or	$a3, $a1, $a2
.LBB11_37:                              # %for.inc.i.2
                                        #   in Loop: Header=BB11_3 Depth=1
	andi	$a2, $fp, 8
	ori	$a1, $zero, 8
	beqz	$a2, .LBB11_43
# %bb.38:                               # %for.cond.i21.3
                                        #   in Loop: Header=BB11_3 Depth=1
	andi	$a2, $fp, 1024
	ori	$a1, $zero, 1024
	beqz	$a2, .LBB11_43
# %bb.39:                               # %for.cond.1.i25.3
                                        #   in Loop: Header=BB11_3 Depth=1
	lu12i.w	$a1, 32
	and	$a2, $fp, $a1
	beqz	$a2, .LBB11_43
# %bb.40:                               # %for.cond.2.i29.3
                                        #   in Loop: Header=BB11_3 Depth=1
	lu12i.w	$a1, 4096
	and	$a2, $fp, $a1
	beqz	$a2, .LBB11_43
# %bb.41:                               # %for.cond.3.i33.3
                                        #   in Loop: Header=BB11_3 Depth=1
	ld.d	$a1, $sp, 24                    # 8-byte Folded Reload
	and	$a2, $fp, $a1
	beqz	$a2, .LBB11_43
# %bb.42:                               # %for.cond.4.i37.3
                                        #   in Loop: Header=BB11_3 Depth=1
	ori	$a1, $zero, 0
	lu32i.d	$a1, 64
	and	$a2, $fp, $a1
	bnez	$a2, .LBB11_51
.LBB11_43:                              # %if.end4.i.3
                                        #   in Loop: Header=BB11_3 Depth=1
	move	$s5, $a3
	or	$a1, $a1, $s2
	move	$s7, $a0
...
# %bb.44:                               #   in Loop: Header=BB11_3 Depth=1
	...
	ori	$a0, $zero, 16
	beqz	$a1, .LBB11_52
.LBB11_45:                              # %for.cond.i21.4
                                        #   in Loop: Header=BB11_3 Depth=1
	andi	$a1, $fp, 2048
	ori	$a0, $zero, 2048
	beqz	$a1, .LBB11_52
# %bb.46:                               # %for.cond.1.i25.4
                                        #   in Loop: Header=BB11_3 Depth=1
	lu12i.w	$a0, 64
	and	$a1, $fp, $a0
	beqz	$a1, .LBB11_52
# %bb.47:                               # %for.cond.2.i29.4
                                        #   in Loop: Header=BB11_3 Depth=1
	lu12i.w	$a0, 8192
	and	$a1, $fp, $a0
	beqz	$a1, .LBB11_52
# %bb.48:                               # %for.cond.3.i33.4
                                        #   in Loop: Header=BB11_3 Depth=1
	ori	$a0, $zero, 0
	lu32i.d	$a0, 1
	and	$a1, $fp, $a0
	beqz	$a1, .LBB11_52
# %bb.49:                               # %for.cond.4.i37.4
                                        #   in Loop: Header=BB11_3 Depth=1
	ori	$a0, $zero, 0
	lu32i.d	$a0, 128
	and	$a1, $fp, $a0
...
.LBB11_54:                              #   in Loop: Header=BB11_3 Depth=1
	...
	maskeqz	$a1, $s5, $a1
	or	$a3, $a1, $a2
.LBB11_55:                              # %for.inc.i.4
                                        #   in Loop: Header=BB11_3 Depth=1
	andi	$a2, $fp, 32
	ori	$a1, $zero, 32
	beqz	$a2, .LBB11_61
# %bb.56:                               # %for.cond.i21.5
                                        #   in Loop: Header=BB11_3 Depth=1
	lu12i.w	$a1, 1
	and	$a2, $fp, $a1
	beqz	$a2, .LBB11_61
# %bb.57:                               # %for.cond.1.i25.5
                                        #   in Loop: Header=BB11_3 Depth=1
	lu12i.w	$a1, 128
	and	$a2, $fp, $a1
	beqz	$a2, .LBB11_61
# %bb.58:                               # %for.cond.2.i29.5
                                        #   in Loop: Header=BB11_3 Depth=1
	lu12i.w	$a1, 16384
	and	$a2, $fp, $a1
	beqz	$a2, .LBB11_61
# %bb.59:                               # %for.cond.3.i33.5
                                        #   in Loop: Header=BB11_3 Depth=1
	ori	$a1, $zero, 0
	lu32i.d	$a1, 2
	and	$a2, $fp, $a1
	beqz	$a2, .LBB11_61
# %bb.60:                               # %for.cond.4.i37.5
                                        #   in Loop: Header=BB11_3 Depth=1
	ori	$a1, $zero, 0
	lu32i.d	$a1, 256
	and	$a2, $fp, $a1
	bnez	$a2, .LBB11_70
.LBB11_61:                              # %if.end4.i.5
                                        #   in Loop: Header=BB11_3 Depth=1
	move	$s5, $a3
	or	$a1, $a1, $s2
	move	$s7, $a0
...
.LBB11_63:                              #   in Loop: Header=BB11_3 Depth=1
	...
	ori	$a0, $zero, 64
	beqz	$a1, .LBB11_71
.LBB11_64:                              # %for.cond.i21.6
                                        #   in Loop: Header=BB11_3 Depth=1
	lu12i.w	$a0, 2
	and	$a1, $fp, $a0
	beqz	$a1, .LBB11_71
# %bb.65:                               # %for.cond.1.i25.6
                                        #   in Loop: Header=BB11_3 Depth=1
	lu12i.w	$a0, 256
	and	$a1, $fp, $a0
	beqz	$a1, .LBB11_71
# %bb.66:                               # %for.cond.2.i29.6
                                        #   in Loop: Header=BB11_3 Depth=1
	lu12i.w	$a0, 32768
	and	$a1, $fp, $a0
	beqz	$a1, .LBB11_71
# %bb.67:                               # %for.cond.3.i33.6
                                        #   in Loop: Header=BB11_3 Depth=1
	ld.d	$a0, $sp, 16                    # 8-byte Folded Reload
	and	$a1, $fp, $a0
	beqz	$a1, .LBB11_71
# %bb.68:                               # %for.cond.4.i37.6
                                        #   in Loop: Header=BB11_3 Depth=1
	ori	$a0, $zero, 0
	lu32i.d	$a0, 512
	and	$a1, $fp, $a0
...
# %bb.8:                                # %for.inc
	...
	ori	$a0, $zero, 2
	beqz	$a1, .LBB12_17
.LBB12_9:                               # %for.cond.i.1
	andi	$a1, $s5, 256
	ori	$a0, $zero, 256
	beqz	$a1, .LBB12_17
# %bb.10:                               # %for.cond.1.i.1
	lu12i.w	$a0, 8
	and	$a1, $s5, $a0
	beqz	$a1, .LBB12_17
# %bb.11:                               # %for.cond.2.i.1
	lu12i.w	$a0, 1024
	and	$a1, $s5, $a0
	beqz	$a1, .LBB12_17
# %bb.12:                               # %for.cond.3.i.1
	lu12i.w	$a0, 131072
	and	$a1, $s5, $a0
	beqz	$a1, .LBB12_17
# %bb.13:                               # %for.cond.4.i.1
	ori	$a0, $zero, 0
	lu32i.d	$a0, 16
	and	$a1, $s5, $a0
	beqz	$a1, .LBB12_17
...
# %bb.20:                               # %for.cond.i.2
	...
	ori	$a0, $zero, 512
	beqz	$a1, .LBB12_25
# %bb.21:                               # %for.cond.1.i.2
	lu12i.w	$a0, 16
	and	$a1, $s5, $a0
	beqz	$a1, .LBB12_25
# %bb.22:                               # %for.cond.2.i.2
	lu12i.w	$a0, 2048
	and	$a1, $s5, $a0
	beqz	$a1, .LBB12_25
# %bb.23:                               # %for.cond.3.i.2
	lu12i.w	$a0, 262144
	and	$a1, $s5, $a0
	beqz	$a1, .LBB12_25
# %bb.24:                               # %for.cond.4.i.2
	ori	$a0, $zero, 0
	lu32i.d	$a0, 32
	and	$a1, $s5, $a0
	bnez	$a1, .LBB12_33
...
# %bb.26:
	...
	ori	$a1, $zero, 8
	beqz	$a2, .LBB12_34
.LBB12_27:                              # %for.cond.i.3
	andi	$a2, $s5, 1024
	ori	$a1, $zero, 1024
	beqz	$a2, .LBB12_34
# %bb.28:                               # %for.cond.1.i.3
	lu12i.w	$a1, 32
	and	$a2, $s5, $a1
	beqz	$a2, .LBB12_34
# %bb.29:                               # %for.cond.2.i.3
	lu12i.w	$a1, 4096
	and	$a2, $s5, $a1
	beqz	$a2, .LBB12_34
# %bb.30:                               # %for.cond.3.i.3
	lu12i.w	$a1, -524288
	lu32i.d	$a1, 0
	and	$a2, $s5, $a1
	beqz	$a2, .LBB12_34
# %bb.31:                               # %for.cond.4.i.3
	ori	$a1, $zero, 0
	lu32i.d	$a1, 64
	and	$a2, $s5, $a1
	beqz	$a2, .LBB12_34
...
# %bb.37:                               # %for.cond.i.4
	...
	ori	$a0, $zero, 2048
	beqz	$a1, .LBB12_42
# %bb.38:                               # %for.cond.1.i.4
	lu12i.w	$a0, 64
	and	$a1, $s5, $a0
	beqz	$a1, .LBB12_42
# %bb.39:                               # %for.cond.2.i.4
	lu12i.w	$a0, 8192
	and	$a1, $s5, $a0
	beqz	$a1, .LBB12_42
# %bb.40:                               # %for.cond.3.i.4
	ori	$a0, $zero, 0
	lu32i.d	$a0, 1
	and	$a2, $s5, $a0
	ori	$a1, $zero, 0
	beqz	$a2, .LBB12_42
# %bb.41:                               # %for.cond.4.i.4
	lu32i.d	$a1, 128
	and	$a2, $s5, $a1
	move	$a0, $a1
	bnez	$a2, .LBB12_50
...
# %bb.43:
	...
	ori	$a1, $zero, 32
	beqz	$a2, .LBB12_51
.LBB12_44:                              # %for.cond.i.5
	lu12i.w	$a1, 1
	and	$a2, $s5, $a1
	beqz	$a2, .LBB12_51
# %bb.45:                               # %for.cond.1.i.5
	lu12i.w	$a1, 128
	and	$a2, $s5, $a1
	beqz	$a2, .LBB12_51
# %bb.46:                               # %for.cond.2.i.5
	lu12i.w	$a1, 16384
	and	$a2, $s5, $a1
	beqz	$a2, .LBB12_51
# %bb.47:                               # %for.cond.3.i.5
	ori	$a1, $zero, 0
	lu32i.d	$a1, 2
	and	$a3, $s5, $a1
	ori	$a2, $zero, 0
	beqz	$a3, .LBB12_51
# %bb.48:                               # %for.cond.4.i.5
	lu32i.d	$a2, 256
	and	$a3, $s5, $a2
	move	$a1, $a2
	beqz	$a3, .LBB12_51
...
# %bb.56:                               # %for.cond.i.6
	...
	and	$a1, $s5, $a0
	beqz	$a1, .LBB12_61
# %bb.57:                               # %for.cond.1.i.6
	lu12i.w	$a0, 256
	and	$a1, $s5, $a0
	beqz	$a1, .LBB12_61
# %bb.58:                               # %for.cond.2.i.6
	lu12i.w	$a0, 32768
	and	$a1, $s5, $a0
	beqz	$a1, .LBB12_61
# %bb.59:                               # %for.cond.3.i.6
	ori	$a0, $zero, 0
	lu32i.d	$a0, 4
	and	$a2, $s5, $a0
	ori	$a1, $zero, 0
	beqz	$a2, .LBB12_61
# %bb.60:                               # %for.cond.4.i.6
	lu32i.d	$a1, 512
	and	$a2, $s5, $a1
	move	$a0, $a1
	bnez	$a2, .LBB12_64
...
.LBB13_17:                              # %for.inc.i
	...
	ori	$a0, $zero, 2
	beqz	$a1, .LBB13_23
# %bb.18:                               # %for.cond.i18.1
                                        #   in Loop: Header=BB13_2 Depth=1
	andi	$a1, $s6, 256
	ori	$a0, $zero, 256
	beqz	$a1, .LBB13_23
# %bb.19:                               # %for.cond.1.i22.1
                                        #   in Loop: Header=BB13_2 Depth=1
	lu12i.w	$a0, 8
	and	$a1, $s6, $a0
	beqz	$a1, .LBB13_23
# %bb.20:                               # %for.cond.2.i26.1
                                        #   in Loop: Header=BB13_2 Depth=1
	lu12i.w	$a0, 1024
	and	$a1, $s6, $a0
	beqz	$a1, .LBB13_23
# %bb.21:                               # %for.cond.3.i30.1
                                        #   in Loop: Header=BB13_2 Depth=1
	lu12i.w	$a0, 131072
	and	$a1, $s6, $a0
	beqz	$a1, .LBB13_23
# %bb.22:                               # %for.cond.4.i34.1
                                        #   in Loop: Header=BB13_2 Depth=1
	ori	$a0, $zero, 0
	lu32i.d	$a0, 16
	and	$a1, $s6, $a0
...
.LBB13_23:                              # %if.end4.i.1
	...
	ori	$a0, $zero, 4
	beqz	$a1, .LBB13_32
.LBB13_24:                              # %for.cond.i18.2
                                        #   in Loop: Header=BB13_2 Depth=1
	andi	$a1, $s6, 512
	ori	$a0, $zero, 512
	beqz	$a1, .LBB13_32
# %bb.25:                               # %for.cond.1.i22.2
                                        #   in Loop: Header=BB13_2 Depth=1
	lu12i.w	$a0, 16
	and	$a1, $s6, $a0
	beqz	$a1, .LBB13_32
# %bb.26:                               # %for.cond.2.i26.2
                                        #   in Loop: Header=BB13_2 Depth=1
	lu12i.w	$a0, 2048
	and	$a1, $s6, $a0
	beqz	$a1, .LBB13_32
# %bb.27:                               # %for.cond.3.i30.2
                                        #   in Loop: Header=BB13_2 Depth=1
	lu12i.w	$a0, 262144
	and	$a1, $s6, $a0
	beqz	$a1, .LBB13_32
# %bb.28:                               # %for.cond.4.i34.2
                                        #   in Loop: Header=BB13_2 Depth=1
	ori	$a0, $zero, 0
	lu32i.d	$a0, 32
	and	$a1, $s6, $a0
...
.LBB13_32:                              # %if.end4.i.2
	...
	ori	$a0, $zero, 8
	beqz	$a1, .LBB13_38
.LBB13_33:                              # %for.cond.i18.3
                                        #   in Loop: Header=BB13_2 Depth=1
	andi	$a1, $s6, 1024
	ori	$a0, $zero, 1024
	beqz	$a1, .LBB13_38
# %bb.34:                               # %for.cond.1.i22.3
                                        #   in Loop: Header=BB13_2 Depth=1
	lu12i.w	$a0, 32
	and	$a1, $s6, $a0
	beqz	$a1, .LBB13_38
# %bb.35:                               # %for.cond.2.i26.3
                                        #   in Loop: Header=BB13_2 Depth=1
	lu12i.w	$a0, 4096
	and	$a1, $s6, $a0
	beqz	$a1, .LBB13_38
# %bb.36:                               # %for.cond.3.i30.3
                                        #   in Loop: Header=BB13_2 Depth=1
	ld.d	$a0, $sp, 8                     # 8-byte Folded Reload
	and	$a1, $s6, $a0
	beqz	$a1, .LBB13_38
# %bb.37:                               # %for.cond.4.i34.3
                                        #   in Loop: Header=BB13_2 Depth=1
	ori	$a0, $zero, 0
	lu32i.d	$a0, 64
	and	$a1, $s6, $a0
...
.LBB13_38:                              # %if.end4.i.3
	...
	maskeqz	$a1, $fp, $a1
	or	$fp, $a1, $a0
.LBB13_39:                              # %for.inc.i.3
                                        #   in Loop: Header=BB13_2 Depth=1
	andi	$a1, $s6, 16
	ori	$a0, $zero, 16
	beqz	$a1, .LBB13_45
# %bb.40:                               # %for.cond.i18.4
                                        #   in Loop: Header=BB13_2 Depth=1
	andi	$a1, $s6, 2048
	ori	$a0, $zero, 2048
	beqz	$a1, .LBB13_45
# %bb.41:                               # %for.cond.1.i22.4
                                        #   in Loop: Header=BB13_2 Depth=1
	lu12i.w	$a0, 64
	and	$a1, $s6, $a0
	beqz	$a1, .LBB13_45
# %bb.42:                               # %for.cond.2.i26.4
                                        #   in Loop: Header=BB13_2 Depth=1
	lu12i.w	$a0, 8192
	and	$a1, $s6, $a0
	beqz	$a1, .LBB13_45
# %bb.43:                               # %for.cond.3.i30.4
                                        #   in Loop: Header=BB13_2 Depth=1
	ori	$a0, $zero, 0
	lu32i.d	$a0, 1
	and	$a1, $s6, $a0
	beqz	$a1, .LBB13_45
# %bb.44:                               # %for.cond.4.i34.4
                                        #   in Loop: Header=BB13_2 Depth=1
	ori	$a0, $zero, 0
	lu32i.d	$a0, 128
	and	$a1, $s6, $a0
...
.LBB13_45:                              # %if.end4.i.4
	...
	maskeqz	$a1, $fp, $a1
	or	$fp, $a1, $a0
.LBB13_46:                              # %for.inc.i.4
                                        #   in Loop: Header=BB13_2 Depth=1
	andi	$a1, $s6, 32
	ori	$a0, $zero, 32
	beqz	$a1, .LBB13_52
# %bb.47:                               # %for.cond.i18.5
                                        #   in Loop: Header=BB13_2 Depth=1
	lu12i.w	$a0, 1
	and	$a1, $s6, $a0
	beqz	$a1, .LBB13_52
# %bb.48:                               # %for.cond.1.i22.5
                                        #   in Loop: Header=BB13_2 Depth=1
	lu12i.w	$a0, 128
	and	$a1, $s6, $a0
	beqz	$a1, .LBB13_52
# %bb.49:                               # %for.cond.2.i26.5
                                        #   in Loop: Header=BB13_2 Depth=1
	lu12i.w	$a0, 16384
	and	$a1, $s6, $a0
	beqz	$a1, .LBB13_52
# %bb.50:                               # %for.cond.3.i30.5
                                        #   in Loop: Header=BB13_2 Depth=1
	ori	$a0, $zero, 0
	lu32i.d	$a0, 2
	and	$a1, $s6, $a0
	beqz	$a1, .LBB13_52
# %bb.51:                               # %for.cond.4.i34.5
                                        #   in Loop: Header=BB13_2 Depth=1
	ori	$a0, $zero, 0
	lu32i.d	$a0, 256
	and	$a1, $s6, $a0
...
.LBB13_52:                              # %if.end4.i.5
	...
	maskeqz	$a1, $fp, $a1
	or	$fp, $a1, $a0
.LBB13_53:                              # %for.inc.i.5
                                        #   in Loop: Header=BB13_2 Depth=1
	andi	$a1, $s6, 64
	ori	$a0, $zero, 64
	beqz	$a1, .LBB13_59
# %bb.54:                               # %for.cond.i18.6
                                        #   in Loop: Header=BB13_2 Depth=1
	lu12i.w	$a0, 2
	and	$a1, $s6, $a0
	beqz	$a1, .LBB13_59
# %bb.55:                               # %for.cond.1.i22.6
                                        #   in Loop: Header=BB13_2 Depth=1
	lu12i.w	$a0, 256
	and	$a1, $s6, $a0
	beqz	$a1, .LBB13_59
# %bb.56:                               # %for.cond.2.i26.6
                                        #   in Loop: Header=BB13_2 Depth=1
	lu12i.w	$a0, 32768
	and	$a1, $s6, $a0
	beqz	$a1, .LBB13_59
# %bb.57:                               # %for.cond.3.i30.6
                                        #   in Loop: Header=BB13_2 Depth=1
	ld.d	$a0, $sp, 16                    # 8-byte Folded Reload
	and	$a1, $s6, $a0
	beqz	$a1, .LBB13_59
# %bb.58:                               # %for.cond.4.i34.6
                                        #   in Loop: Header=BB13_2 Depth=1
	ori	$a0, $zero, 0
	lu32i.d	$a0, 512
	and	$a1, $s6, $a0
...
# %bb.9:                                # %for.cond.1.i.1
	...
	and	$a1, $s4, $a0
	beqz	$a1, .LBB14_16
# %bb.10:                               # %for.cond.2.i.1
	lu12i.w	$a0, 1024
	and	$a1, $s4, $a0
	beqz	$a1, .LBB14_16
# %bb.11:                               # %for.cond.3.i.1
	lu12i.w	$a0, 131072
	and	$a1, $s4, $a0
	beqz	$a1, .LBB14_16
# %bb.12:                               # %for.cond.4.i.1
	ori	$a0, $zero, 0
	lu32i.d	$a0, 16
	and	$a1, $s4, $a0
	beqz	$a1, .LBB14_16
...
# %bb.18:                               # %for.cond.i.2
	...
	ori	$a0, $zero, 512
	beqz	$a1, .LBB14_23
# %bb.19:                               # %for.cond.1.i.2
	lu12i.w	$a0, 16
	and	$a1, $s4, $a0
	beqz	$a1, .LBB14_23
# %bb.20:                               # %for.cond.2.i.2
	lu12i.w	$a0, 2048
	and	$a1, $s4, $a0
	beqz	$a1, .LBB14_23
# %bb.21:                               # %for.cond.3.i.2
	lu12i.w	$a0, 262144
	and	$a1, $s4, $a0
	beqz	$a1, .LBB14_23
# %bb.22:                               # %for.cond.4.i.2
	ori	$a0, $zero, 0
	lu32i.d	$a0, 32
	and	$a1, $s4, $a0
	bnez	$a1, .LBB14_24
...
# %bb.25:                               # %for.cond.i.3
	...
	ori	$a0, $zero, 1024
	beqz	$a1, .LBB14_30
# %bb.26:                               # %for.cond.1.i.3
	lu12i.w	$a0, 32
	and	$a1, $s4, $a0
	beqz	$a1, .LBB14_30
# %bb.27:                               # %for.cond.2.i.3
	lu12i.w	$a0, 4096
	and	$a1, $s4, $a0
	beqz	$a1, .LBB14_30
# %bb.28:                               # %for.cond.3.i.3
	lu12i.w	$a0, -524288
	lu32i.d	$a0, 0
	and	$a1, $s4, $a0
	beqz	$a1, .LBB14_30
# %bb.29:                               # %for.cond.4.i.3
	ori	$a0, $zero, 0
	lu32i.d	$a0, 64
	and	$a1, $s4, $a0
	bnez	$a1, .LBB14_31
...
# %bb.32:                               # %for.cond.i.4
	...
	ori	$a0, $zero, 2048
	beqz	$a1, .LBB14_37
# %bb.33:                               # %for.cond.1.i.4
	lu12i.w	$a0, 64
	and	$a1, $s4, $a0
	beqz	$a1, .LBB14_37
# %bb.34:                               # %for.cond.2.i.4
	lu12i.w	$a0, 8192
	and	$a1, $s4, $a0
	beqz	$a1, .LBB14_37
# %bb.35:                               # %for.cond.3.i.4
	ori	$a0, $zero, 0
	lu32i.d	$a0, 1
	and	$a2, $s4, $a0
	ori	$a1, $zero, 0
	beqz	$a2, .LBB14_37
# %bb.36:                               # %for.cond.4.i.4
	lu32i.d	$a1, 128
	and	$a2, $s4, $a1
	move	$a0, $a1
	bnez	$a2, .LBB14_38
...
# %bb.39:                               # %for.cond.i.5
	...
	and	$a1, $s4, $a0
	beqz	$a1, .LBB14_44
# %bb.40:                               # %for.cond.1.i.5
	lu12i.w	$a0, 128
	and	$a1, $s4, $a0
	beqz	$a1, .LBB14_44
# %bb.41:                               # %for.cond.2.i.5
	lu12i.w	$a0, 16384
	and	$a1, $s4, $a0
	beqz	$a1, .LBB14_44
# %bb.42:                               # %for.cond.3.i.5
	ori	$a0, $zero, 0
	lu32i.d	$a0, 2
	and	$a2, $s4, $a0
	ori	$a1, $zero, 0
	beqz	$a2, .LBB14_44
# %bb.43:                               # %for.cond.4.i.5
	lu32i.d	$a1, 256
	and	$a2, $s4, $a1
	move	$a0, $a1
	bnez	$a2, .LBB14_45
...
# %bb.46:                               # %for.cond.i.6
	...
	and	$a1, $s4, $a0
	beqz	$a1, .LBB14_51
# %bb.47:                               # %for.cond.1.i.6
	lu12i.w	$a0, 256
	and	$a1, $s4, $a0
	beqz	$a1, .LBB14_51
# %bb.48:                               # %for.cond.2.i.6
	lu12i.w	$a0, 32768
	and	$a1, $s4, $a0
	beqz	$a1, .LBB14_51
# %bb.49:                               # %for.cond.3.i.6
	ori	$a0, $zero, 0
	lu32i.d	$a0, 4
	and	$a2, $s4, $a0
	ori	$a1, $zero, 0
	beqz	$a2, .LBB14_51
# %bb.50:                               # %for.cond.4.i.6
	lu32i.d	$a1, 512
	and	$a2, $s4, $a1
	move	$a0, $a1
	bnez	$a2, .LBB14_52
