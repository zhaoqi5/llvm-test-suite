...
# %bb.14:                               # %for.cond9.preheader
	blez	$a3, .LBB19_26
.LBB19_15:                              # %for.cond12.preheader.lr.ph
	move	$a4, $zero
	slli.d	$a5, $a3, 2
...
.LBB19_20:                              # %for.body14
	...
	bnez	$t5, .LBB19_20
	b	.LBB19_17
.LBB19_21:                              # %for.cond142.preheader
	ori	$a4, $zero, 2
	blt	$a3, $a4, .LBB19_26
# %bb.22:                               # %for.cond145.preheader.preheader
	...
	ori	$a5, $zero, 1
	.p2align	4, , 16
.LBB19_23:                              # %for.cond145.preheader
                                        # =>This Loop Header: Depth=1
...
.LBB27_12:                              # %while.end
	slli.d	$a4, $a5, 2
	bne	$a6, $a7, .LBB27_21
# %bb.13:                               # %for.cond9.preheader
	blez	$a3, .LBB27_26
.LBB27_14:                              # %for.cond12.preheader.lr.ph
	move	$a0, $zero
	slli.d	$a5, $a3, 2
...
.LBB27_16:                              # %for.end119
	...
	fst.d	$fa0, $a7, 8
	beq	$a0, $a3, .LBB27_26
.LBB27_17:                              # %for.cond12.preheader
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB27_19 Depth 2
	beqz	$a0, .LBB27_15
# %bb.18:                               # %for.body14.lr.ph
                                        #   in Loop: Header=BB27_17 Depth=1
	slli.d	$a7, $a0, 2
	ldx.w	$a7, $a1, $a7
	slli.d	$t0, $a0, 1
...
.LBB27_21:                              # %if.else
	...
	fst.d	$fa0, $a5, 8
	blt	$a3, $a6, .LBB27_26
# %bb.22:                               # %for.cond179.preheader.preheader
	slli.d	$a0, $a0, 3
	ori	$a5, $zero, 1
	.p2align	4, , 16
.LBB27_23:                              # %for.cond179.preheader
                                        # =>This Loop Header: Depth=1
