...
# %bb.10:                               # %for.body.preheader
	...
	slli.d	$a4, $ra, 3
	bgeu	$a5, $a6, .LBB12_61
.LBB12_11:                              # %for.body.preheader463
	slli.d	$a5, $a3, 3
	sub.d	$a4, $a4, $a5
	add.d	$a6, $a3, $ra
	sub.d	$a6, $a6, $s5
...
# %bb.46:                               #   in Loop: Header=BB12_28 Depth=1
	move	$a2, $zero
.LBB12_47:                              # %for.body176.preheader462
                                        #   in Loop: Header=BB12_28 Depth=1
	slli.d	$a4, $a2, 3
	alsl.d	$a3, $a2, $s0, 3
	sub.d	$a4, $s0, $a4
...
# %bb.51:                               # %vector.memcheck415
	...
	and	$a6, $t2, $a6
	bnez	$a6, .LBB12_57
# %bb.52:                               # %vector.memcheck415
                                        #   in Loop: Header=BB12_28 Depth=1
	sltu	$a6, $a3, $t1
	sltu	$a7, $a7, $a4
	and	$a6, $a6, $a7
	bnez	$a6, .LBB12_57
# %bb.53:                               # %vector.memcheck415
                                        #   in Loop: Header=BB12_28 Depth=1
	sltu	$a3, $a3, $a5
	sltu	$a4, $t0, $a4
	and	$a3, $a3, $a4
...
# %bb.54:                               # %vector.ph447
	...
	move	$a5, $a2
	.p2align	4, , 16
.LBB12_55:                              # %vector.body450
                                        #   Parent Loop BB12_28 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	xvldx	$xr0, $a3, $a1
	xvldx	$xr1, $a4, $a0
	xvpermi.d	$xr2, $xr0, 27
	xvfsub.d	$xr2, $xr2, $xr1
	xvst	$xr2, $a4, 0
	xvpermi.d	$xr1, $xr1, 27
...
.LBB12_76:                              # %vector.body
	...
	xvldx	$xr2, $fp, $a7
	xvldx	$xr3, $t0, $t2
	xvfsub.d	$xr4, $xr1, $xr0
	xvfadd.d	$xr0, $xr1, $xr0
	xvpermi.d	$xr1, $xr2, 27
	xvfsub.d	$xr2, $xr1, $xr3
	xvfadd.d	$xr1, $xr1, $xr3
	xvstx	$xr4, $fp, $t2
	xvpermi.d	$xr2, $xr2, 27
	xvstx	$xr2, $fp, $a7
...
# %bb.11:                               # %for.body.preheader
	...
	slli.d	$a2, $a1, 3
	bgeu	$a5, $a6, .LBB13_63
.LBB13_12:                              # %for.body.preheader457
	slli.d	$a5, $a3, 3
	sub.d	$a4, $a4, $a5
	add.d	$a6, $a3, $ra
	sub.d	$a1, $a6, $a1
...
.LBB13_13:                              # %for.body
	...
	bnez	$a3, .LBB13_13
	b	.LBB13_15
.LBB13_14:                              # %if.then8.for.end_crit_edge
	addi.w	$s3, $t4, 0
.LBB13_15:                              # %for.end
	slli.d	$a1, $s3, 3
	fldx.d	$fa0, $fp, $a1
...
# %bb.37:                               #   in Loop: Header=BB13_30 Depth=1
	...
	move	$t4, $s8
	b	.LBB13_41
.LBB13_38:                              # %for.body.preheader.i235
                                        #   in Loop: Header=BB13_30 Depth=1
	addi.w	$a0, $s6, 0
...
.LBB13_39:                              # %for.body.i238
	...
	addi.d	$a6, $a6, 16
	bltu	$a5, $s2, .LBB13_39
# %bb.40:                               #   in Loop: Header=BB13_30 Depth=1
	ld.d	$t7, $sp, 56                    # 8-byte Folded Reload
	ld.d	$t5, $sp, 40                    # 8-byte Folded Reload
	ld.d	$s7, $sp, 32                    # 8-byte Folded Reload
.LBB13_41:                              # %if.end121
...
# %bb.46:                               # %for.body164.preheader
	...
	ori	$a5, $zero, 12
	bgeu	$a4, $a5, .LBB13_49
.LBB13_47:                              # %for.body164.preheader451
                                        #   in Loop: Header=BB13_30 Depth=1
	slli.d	$a5, $a3, 3
	alsl.d	$a4, $a3, $s0, 3
	sub.d	$a5, $s0, $a5
...
.LBB13_55:                              # %vector.body438
	...
	addi.d	$a7, $a7, 32
	bnez	$a6, .LBB13_55
# %bb.56:                               # %middle.block448
                                        #   in Loop: Header=BB13_30 Depth=1
	beq	$a4, $a5, .LBB13_29
	b	.LBB13_47
.LBB13_57:                              #   in Loop: Header=BB13_30 Depth=1
	ori	$t3, $zero, 4
	b	.LBB13_47
.LBB13_58:                              # %while.cond.preheader.while.end_crit_edge
	fld.d	$fa0, $s0, 0
	ori	$s3, $zero, 2
	b	.LBB13_61
.LBB13_59:                              # %for.end159.thread
	slli.w	$s3, $s3, 1
.LBB13_60:                              # %while.end.loopexit
	slli.d	$a0, $a0, 3
	fldx.d	$fa0, $s0, $a0
	fst.d	$fa0, $s0, 0
.LBB13_61:                              # %while.end
...
.LBB13_78:                              # %vector.body
	...
	xvldx	$xr2, $fp, $a7
	xvldx	$xr3, $t0, $t2
	xvfadd.d	$xr4, $xr1, $xr0
	xvfsub.d	$xr0, $xr1, $xr0
	xvpermi.d	$xr1, $xr2, 27
	xvfadd.d	$xr2, $xr1, $xr3
...
.LBB14_2:                               # %for.body
	...
	fmadd.d	$ft14, $ft0, $ft4, $ft14
	fst.d	$ft14, $t7, 16
	fmul.d	$ft4, $ft2, $ft4
	fmadd.d	$ft4, $ft0, $ft9, $ft4
	fst.d	$ft4, $t7, 24
	fsub.d	$ft4, $ft5, $ft11
	fadd.d	$ft9, $ft6, $ft10
	fneg.d	$ft14, $ft9
	fmul.d	$ft14, $fa4, $ft14
	fmadd.d	$ft14, $fa6, $ft4, $ft14
	fst.d	$ft14, $t7, 32
	fmul.d	$ft4, $fa4, $ft4
	fmadd.d	$ft4, $fa6, $ft9, $ft4
	fst.d	$ft4, $t7, 40
	fadd.d	$ft4, $ft7, $ft13
	fsub.d	$ft7, $ft8, $ft12
	fmul.d	$ft8, $ft1, $ft7
	...
	fsub.d	$ft5, $ft6, $ft10
	fmul.d	$ft6, $ft5, $fa3
	fmadd.d	$ft6, $fa5, $ft4, $ft6
	fst.d	$ft6, $t5, 32
	fmul.d	$ft3, $ft3, $ft4
	fmadd.d	$ft3, $fa5, $ft5, $ft3
	fst.d	$ft3, $t5, 40
	add.d	$t6, $a1, $t1
	xvldx	$xr11, $a1, $a6
	xvld	$xr12, $t6, -32
	...
	fadd.d	$ft8, $ft7, $ft11
	fneg.d	$ft13, $ft8
	fmul.d	$ft13, $ft0, $ft13
	fmadd.d	$ft13, $ft2, $ft3, $ft13
	fst.d	$ft13, $t6, -16
	fmul.d	$ft0, $ft0, $ft3
	fmadd.d	$ft0, $ft2, $ft8, $ft0
	fst.d	$ft0, $t6, -8
	fsub.d	$ft0, $ft4, $ft10
	fadd.d	$ft2, $ft5, $ft9
	fneg.d	$ft3, $ft2
	fmul.d	$ft3, $fa6, $ft3
	fmadd.d	$ft3, $fa4, $ft0, $ft3
	fst.d	$ft3, $t6, -32
	fmul.d	$ft0, $fa6, $ft0
	fmadd.d	$ft0, $fa4, $ft2, $ft0
	fst.d	$ft0, $t6, -24
	fadd.d	$ft0, $ft6, $ft12
	fsub.d	$ft2, $ft7, $ft11
	fmul.d	$ft3, $fa7, $ft2
	...
	bltu	$t3, $a3, .LBB14_2
	b	.LBB14_4
.LBB14_3:                               # %entry.for.end_crit_edge
	movgr2fr.d	$fa4, $zero
	vldi	$vr6, -912
	vldi	$vr5, -912
	fmov.d	$fa3, $fa4
.LBB14_4:                               # %for.end
	...
	fneg.d	$ft0, $fa7
	fmul.d	$ft0, $fa6, $ft0
	fmadd.d	$ft0, $fa4, $fa5, $ft0
	fst.d	$ft0, $a2, 16
	fmul.d	$fa5, $fa6, $fa5
	fmadd.d	$fa4, $fa4, $fa7, $fa5
	fst.d	$fa4, $a2, 24
	fadd.d	$fa0, $fa0, $ft3
	fsub.d	$fa3, $fa3, $ft2
	fmul.d	$fa4, $fa2, $fa3
...
.LBB26_2:                               # %for.body
	...
	fneg.d	$ft8, $ft7
	fmul.d	$ft8, $fa3, $ft8
	fmadd.d	$ft8, $fa6, $ft6, $ft8
	fst.d	$ft8, $t5, -8
	fmul.d	$ft6, $fa3, $ft6
	fmadd.d	$ft6, $fa6, $ft7, $ft6
	fstx.d	$ft6, $a1, $a5
	fsub.d	$ft4, $ft4, $ft15
	fsub.d	$ft5, $ft5, $ft14
	fmul.d	$ft6, $ft0, $ft5
...
.LBB26_5:                               # %for.end
	...
	fneg.d	$ft0, $fa7
	fmul.d	$ft0, $fa6, $ft0
	fmadd.d	$ft0, $fa3, $fa5, $ft0
	fst.d	$ft0, $a2, 16
	fmul.d	$fa5, $fa6, $fa5
	fmadd.d	$fa3, $fa3, $fa7, $fa5
	fst.d	$fa3, $a2, 24
	fsub.d	$fa0, $fa0, $ft3
	fsub.d	$fa3, $fa4, $ft2
	fmul.d	$fa4, $fa2, $fa3
...
.LBB27_18:                              # %while.end
	slli.d	$a4, $a6, 2
	bne	$a7, $t0, .LBB27_27
# %bb.19:                               # %for.cond9.preheader
	blez	$a3, .LBB27_32
.LBB27_20:                              # %for.cond12.preheader.lr.ph
	move	$a0, $zero
	slli.d	$a5, $a3, 2
...
.LBB27_22:                              # %for.end119
	...
	fst.d	$fa0, $a7, 8
	beq	$a0, $a3, .LBB27_32
.LBB27_23:                              # %for.cond12.preheader
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB27_25 Depth 2
	beqz	$a0, .LBB27_21
# %bb.24:                               # %for.body14.lr.ph
                                        #   in Loop: Header=BB27_23 Depth=1
	slli.d	$a7, $a0, 2
	ldx.w	$a7, $a1, $a7
	slli.d	$t0, $a0, 1
...
.LBB27_27:                              # %if.else
	...
	fst.d	$fa0, $a5, 8
	blt	$a3, $a6, .LBB27_32
# %bb.28:                               # %for.cond179.preheader.preheader
	slli.d	$a0, $a0, 3
	ori	$a5, $zero, 1
	.p2align	4, , 16
.LBB27_29:                              # %for.cond179.preheader
                                        # =>This Loop Header: Depth=1
	...
	move	$t2, $a5
	.p2align	4, , 16
.LBB27_30:                              # %for.body181
                                        #   Parent Loop BB27_29 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t3, $t1, 0
	add.w	$t3, $t3, $a7
	fld.d	$fa0, $t0, 8
