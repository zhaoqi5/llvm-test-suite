...
# %bb.26:
	...
	b	.LBB0_34
.LBB0_27:                               # %for.body.preheader.i244
...
.LBB0_30:                               # %vector.body322
	...
	addi.d	$a7, $a7, 32
	bnez	$a4, .LBB0_30
# %bb.31:                               # %middle.block330
	vpickve2gr.w	$a4, $vr0, 3
	beq	$a5, $a6, .LBB0_34
.LBB0_32:                               # %for.body.i247.preheader
	sub.d	$a3, $a3, $t2
	alsl.d	$a7, $t2, $a2, 2
	.p2align	4, , 16
.LBB0_33:                               # %for.body.i247
                                        # =>This Inner Loop Header: Depth=1
	ldx.wu	$a5, $a7, $a1
	and	$a4, $a4, $s0
	add.w	$a6, $a5, $a4
	...
	addi.d	$a7, $a7, 4
	bnez	$a3, .LBB0_33
.LBB0_34:                               # %for.end.i259
	ori	$a1, $zero, 1
	bne	$a0, $a1, .LBB0_36
# %bb.35:                               # %if.then16.i261
	and	$a0, $a4, $s0
	bstrpick.d	$a0, $a0, 31, 1
	ld.d	$a1, $sp, 112                   # 8-byte Folded Reload
	st.w	$a0, $a1, 0
.LBB0_36:                               # %mp_idiv_2.exit266
	ld.w	$a4, $sp, 236
	move	$a0, $s2
	move	$a1, $s0
	move	$a3, $a2
...
# %bb.37:
	...
	b	.LBB0_45
.LBB0_38:                               # %for.body.preheader.i277
	ld.d	$a3, $sp, 120                   # 8-byte Folded Reload
	add.d	$a3, $a3, $a4
	bstrpick.d	$a3, $a3, 31, 0
	addi.d	$a5, $a3, -2
...
.LBB0_41:                               # %vector.body342
	...
	addi.d	$a7, $a7, 32
	bnez	$a4, .LBB0_41
# %bb.42:                               # %middle.block350
	vpickve2gr.w	$a4, $vr0, 3
	beq	$a5, $a6, .LBB0_45
.LBB0_43:                               # %for.body.i280.preheader
	sub.d	$a3, $a3, $a2
	alsl.d	$a2, $a2, $fp, 2
	.p2align	4, , 16
.LBB0_44:                               # %for.body.i280
                                        # =>This Inner Loop Header: Depth=1
	ldx.wu	$a5, $a2, $a1
	and	$a4, $a4, $s0
	add.w	$a6, $a5, $a4
	...
	addi.d	$a2, $a2, 4
	bnez	$a3, .LBB0_44
.LBB0_45:                               # %for.end.i292
	ori	$a1, $zero, 1
	bne	$a0, $a1, .LBB0_47
# %bb.46:                               # %if.then16.i294
	and	$a0, $a4, $s0
	bstrpick.d	$a0, $a0, 31, 1
	ld.d	$a1, $sp, 112                   # 8-byte Folded Reload
	st.w	$a0, $a1, 0
.LBB0_47:                               # %mp_idiv_2.exit299
	move	$a0, $s2
	move	$a1, $s0
	move	$a2, $s1
	move	$a3, $fp
...
# %bb.41:                               # %middle.block
	...
	beq	$a4, $a5, .LBB2_44
.LBB2_42:                               # %while.body153.preheader116
	addi.d	$a3, $a3, 1
	.p2align	4, , 16
.LBB2_43:                               # %while.body153
                                        # =>This Inner Loop Header: Depth=1
	slli.d	$a4, $a2, 3
	addi.w	$a3, $a3, -1
	alsl.w	$a2, $a2, $a4, 1
	bnez	$a3, .LBB2_43
.LBB2_44:                               # %while.cond156.preheader
	blt	$a1, $a0, .LBB2_52
# %bb.45:                               # %while.body160.preheader
	addi.w	$a3, $s0, 2
	addi.d	$a1, $a0, 1
	slli.d	$a4, $a0, 2
	addi.w	$a5, $a1, 0
	stx.w	$a2, $fp, $a4
	beq	$a3, $a5, .LBB2_52
# %bb.46:                               # %while.body160.preheader93
	sub.w	$a2, $s0, $a0
	ori	$a3, $zero, 7
	bltu	$a2, $a3, .LBB2_50
# %bb.47:                               # %vector.ph106
...
.LBB2_48:                               # %vector.body109
	...
	addi.d	$a0, $a0, 32
	bnez	$a4, .LBB2_48
# %bb.49:                               # %middle.block112
	beq	$a2, $a3, .LBB2_52
.LBB2_50:                               # %while.body160.preheader115
	alsl.d	$a0, $a1, $fp, 2
	sub.d	$a1, $s0, $a1
	addi.d	$a1, $a1, 2
	.p2align	4, , 16
.LBB2_51:                               # %while.body160
                                        # =>This Inner Loop Header: Depth=1
	st.w	$zero, $a0, 0
	addi.w	$a1, $a1, -1
	addi.d	$a0, $a0, 4
	bnez	$a1, .LBB2_51
.LBB2_52:                               # %while.end164
	ld.w	$a0, $fp, 8
	bnez	$a0, .LBB2_54
# %bb.53:                               # %if.then168
	st.d	$zero, $fp, 0
...
# %bb.19:                               # %middle.block
	beq	$a6, $a4, .LBB20_22
.LBB20_20:                              # %for.body41.preheader93
	alsl.d	$a7, $a6, $a5, 2
	add.d	$a3, $a7, $a3
	sub.d	$a4, $a4, $a6
	.p2align	4, , 16
...
# %bb.19:                               # %if.then10.i97
	bltz	$s7, .LBB36_23
# %bb.20:                               # %for.body14.preheader.i
	ori	$a0, $zero, 2
	.p2align	4, , 16
.LBB36_21:                              # %for.body14.i103
                                        # =>This Inner Loop Header: Depth=1
	addi.w	$s8, $s8, -1
	slli.d	$a1, $s8, 2
	ldx.w	$a1, $s0, $a1
...
.LBB36_23:                              # %if.then28.i98
	...
	st.w	$a0, $s0, 4
	b	.LBB36_25
.LBB36_24:                              # %if.then19.i112
	st.w	$a2, $a1, 0
.LBB36_25:                              # %mp_round.exit113
	...
	vst	$vr0, $s4, 8
	bge	$a0, $s3, .LBB36_28
# %bb.26:                               # %for.body.preheader.i.i125
	addi.d	$a1, $s4, 32
	addi.d	$a2, $s4, 8
	.p2align	4, , 16
.LBB36_27:                              # %for.body.i.i126
                                        # =>This Inner Loop Header: Depth=1
	fld.d	$fa0, $a1, 0
	fld.d	$fa1, $a1, -8
	fneg.d	$fa2, $fa0
	...
	bltu	$a0, $s3, .LBB36_27
	b	.LBB36_29
.LBB36_28:                              # %entry.for.end_crit_edge.i.i120
	addi.d	$a2, $s4, 8
.LBB36_29:                              # %mp_squh_use_in1fft.exit135
	alsl.d	$a0, $s3, $s4, 3
	fld.d	$fa0, $a0, 8
	fmul.d	$fa0, $fa0, $fa0
	fst.d	$fa0, $a0, 8
...
# %bb.31:                               # %for.body.preheader.i140
	...
	pcaddu18i	$ra, %call36(memset)
	jirl	$ra, $ra, 0
.LBB36_32:                              # %for.end.i143
	slli.d	$a0, $s8, 2
	ldx.w	$a1, $s6, $a0
	slli.w	$a1, $a1, 1
	stx.w	$zero, $s6, $a0
	blt	$a1, $s1, .LBB36_39
# %bb.33:                               # %if.then10.i148
	bltz	$s7, .LBB36_37
# %bb.34:                               # %for.body14.preheader.i154
	ori	$a0, $zero, 2
	.p2align	4, , 16
.LBB36_35:                              # %for.body14.i156
                                        # =>This Inner Loop Header: Depth=1
	addi.w	$s8, $s8, -1
	slli.d	$a1, $s8, 2
	ldx.w	$a1, $s6, $a1
...
.LBB36_37:                              # %if.then28.i150
	...
	st.w	$a0, $s6, 4
	b	.LBB36_39
.LBB36_38:                              # %if.then19.i165
	st.w	$a2, $a1, 0
.LBB36_39:                              # %mp_round.exit166
	ld.d	$a0, $sp, 112                   # 8-byte Folded Reload
	st.d	$a0, $sp, 8
	ld.d	$a0, $sp, 104                   # 8-byte Folded Reload
	st.d	$a0, $sp, 0
