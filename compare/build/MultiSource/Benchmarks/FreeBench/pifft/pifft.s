...
.LBB1_12:                               # %vector.body40
	...
	xvbitrevi.d	$xr3, $xr2, 63
	xvfmul.d	$xr3, $xr2, $xr3
	xvfmadd.d	$xr3, $xr1, $xr1, $xr3
	xvfadd.d	$xr1, $xr1, $xr1
...
# %bb.53:                               # %iter.check114
	...
	ori	$a2, $zero, 2
	bgeu	$a2, $a3, .LBB2_64
# %bb.54:                               # %vector.main.loop.iter.check116
...
.LBB2_57:                               # %vector.body120
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB2_57
# %bb.58:                               # %middle.block123
	beq	$a2, $a3, .LBB2_66
# %bb.59:                               # %vec.epilog.iter.check128
	andi	$a4, $a2, 12
	beqz	$a4, .LBB2_63
.LBB2_60:                               # %vec.epilog.ph127
	...
	vrepli.b	$vr0, 0
	.p2align	4, , 16
.LBB2_61:                               # %vec.epilog.vector.body133
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a0, 0
	addi.d	$a3, $a3, 4
	addi.d	$a0, $a0, 16
	bnez	$a3, .LBB2_61
# %bb.62:                               # %vec.epilog.middle.block136
	bne	$a2, $a4, .LBB2_64
	b	.LBB2_66
.LBB2_63:
	add.d	$a1, $a1, $a3
.LBB2_64:                               # %while.body160.preheader140
	alsl.d	$a0, $a1, $fp, 2
	sub.d	$a1, $s0, $a1
	addi.d	$a1, $a1, 2
	.p2align	4, , 16
...
# %bb.21:                               # %if.then16.i86
	bne	$s0, $a0, .LBB8_23
# %bb.22:                               # %if.then16.for.end35_crit_edge.i111
	move	$a0, $zero
	b	.LBB8_25
.LBB8_23:                               # %for.body21.preheader.i90
	move	$a0, $zero
	ld.d	$a1, $sp, 40                    # 8-byte Folded Reload
	add.w	$a1, $s1, $a1
	srai.d	$a1, $a1, 1
...
# %bb.33:                               # %for.body.preheader.i170
	...
	pcaddu18i	$ra, %call36(memset)
	jirl	$ra, $ra, 0
.LBB8_34:                               # %for.end.i135
	ori	$a0, $zero, 2
	blt	$s4, $a0, .LBB8_40
# %bb.35:                               # %if.then16.i142
	bne	$s4, $a0, .LBB8_37
# %bb.36:
	move	$a0, $zero
	b	.LBB8_39
.LBB8_37:                               # %for.body21.preheader.i146
	move	$a0, $zero
	ld.d	$a1, $sp, 40                    # 8-byte Folded Reload
	add.w	$a1, $s1, $a1
	srai.d	$a1, $a1, 1
...
.LBB8_40:                               # %mp_mul_i2d.exit179
	...
	fst.d	$fa0, $s7, 16
	blt	$s2, $a0, .LBB8_43
# %bb.41:                               # %for.body.preheader.i194
	addi.d	$a0, $s7, 32
	addi.d	$a1, $fp, 32
	ori	$a2, $zero, 3
	.p2align	4, , 16
.LBB8_42:                               # %for.body.i195
                                        # =>This Inner Loop Header: Depth=1
	fld.d	$fa0, $a1, -8
	fld.d	$fa1, $a0, 0
	fld.d	$fa2, $a1, 0
...
# %bb.47:                               # %for.body.preheader.i250
	...
	pcaddu18i	$ra, %call36(memset)
	jirl	$ra, $ra, 0
.LBB8_48:                               # %for.end.i214
	st.d	$s4, $sp, 80                    # 8-byte Folded Spill
	ori	$a0, $zero, 2
	blt	$s0, $a0, .LBB8_54
# %bb.49:                               # %if.then16.i221
	bne	$s0, $a0, .LBB8_51
# %bb.50:                               # %if.then16.for.end35_crit_edge.i248
	move	$a0, $zero
	b	.LBB8_53
.LBB8_51:                               # %for.body21.preheader.i225
	move	$a0, $zero
	ld.d	$a1, $sp, 40                    # 8-byte Folded Reload
	add.w	$a1, $s1, $a1
	srai.d	$a1, $a1, 1
...
# %bb.21:                               # %if.then16.i67
	bne	$s6, $a2, .LBB11_23
# %bb.22:                               # %if.then16.for.end35_crit_edge.i92
	move	$a2, $zero
	b	.LBB11_25
.LBB11_23:                              # %for.body21.preheader.i71
	move	$a2, $zero
...
# %bb.33:                               # %middle.block
	beq	$a1, $a2, .LBB11_36
.LBB11_34:                              # %for.body.i115.preheader
	ld.d	$a1, $sp, 96                    # 8-byte Folded Reload
	alsl.d	$a1, $a0, $a1, 3
	addi.d	$a1, $a1, 8
	.p2align	4, , 16
.LBB11_35:                              # %for.body.i115
                                        # =>This Inner Loop Header: Depth=1
	fld.d	$fa0, $a1, 0
	fld.d	$fa1, $a1, -8
	fneg.d	$fa2, $fa0
...
# %bb.16:                               # %middle.block
	beq	$a3, $a4, .LBB27_19
.LBB27_17:                              # %for.body110.preheader119
	addi.d	$a3, $a2, 1
	alsl.d	$a2, $a2, $fp, 2
	.p2align	4, , 16
...
# %bb.18:
	move	$a0, $zero
	b	.LBB29_21
.LBB29_19:                              # %for.body21.preheader.i39
	move	$a0, $zero
	ld.d	$a1, $sp, 8                     # 8-byte Folded Reload
	add.w	$a1, $s2, $a1
	srai.d	$a1, $a1, 1
...
.LBB29_20:                              # %for.body21.i41
	...
	addi.d	$a4, $a4, -4
	blt	$a5, $a2, .LBB29_20
.LBB29_21:                              # %for.end35.i54
	ld.w	$a1, $s7, 12
	sub.d	$a0, $a1, $a0
	movgr2fr.w	$fa0, $a0
	ffint.d.w	$fa0, $fa0
	fst.d	$fa0, $fp, 16
.LBB29_22:                              # %mp_mul_i2d.exit69
	movgr2fr.w	$fa0, $s5
	ld.w	$a0, $s7, 4
	ffint.d.w	$fa0, $fa0
	addi.d	$s7, $fp, 8
...
# %bb.14:                               # %middle.block
	beq	$a1, $t0, .LBB36_17
.LBB36_15:                              # %for.body.i.i.preheader213
	alsl.d	$a1, $a0, $s4, 3
	addi.d	$a1, $a1, 8
	.p2align	4, , 16
