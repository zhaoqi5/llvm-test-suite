...
.LBB0_29:                               # %vector.body321
	...
	addi.d	$a7, $a7, 32
	bnez	$a5, .LBB0_29
# %bb.30:                               # %middle.block328
	xvpickve2gr.w	$a5, $xr0, 7
	beq	$a4, $a6, .LBB0_33
.LBB0_31:                               # %for.body.i247.preheader
	sub.d	$a3, $a3, $t2
	alsl.d	$a7, $t2, $a2, 2
	.p2align	4, , 16
.LBB0_32:                               # %for.body.i247
                                        # =>This Inner Loop Header: Depth=1
	ldx.wu	$a4, $a7, $a1
	and	$a5, $a5, $s0
	add.w	$a6, $a4, $a5
	...
	addi.d	$a7, $a7, 4
	bnez	$a3, .LBB0_32
.LBB0_33:                               # %for.end.i259
	ori	$a1, $zero, 1
	bne	$a0, $a1, .LBB0_35
# %bb.34:                               # %if.then16.i261
	and	$a0, $a5, $s0
	bstrpick.d	$a0, $a0, 31, 1
	ld.d	$a1, $sp, 152                   # 8-byte Folded Reload
	st.w	$a0, $a1, 0
.LBB0_35:                               # %mp_idiv_2.exit266
	ld.w	$a4, $sp, 284
	move	$a0, $s2
	move	$a1, $s0
	move	$a3, $a2
...
# %bb.36:
	...
	b	.LBB0_44
.LBB0_37:                               # %for.body.preheader.i277
	ld.d	$a3, $sp, 160                   # 8-byte Folded Reload
	add.d	$a3, $a3, $a5
	bstrpick.d	$a3, $a3, 31, 0
	addi.d	$a4, $a3, -2
...
.LBB0_40:                               # %vector.body340
	...
	addi.d	$t0, $t0, 32
	bnez	$a5, .LBB0_40
# %bb.41:                               # %middle.block347
	xvpickve2gr.w	$a5, $xr0, 7
	beq	$a4, $a6, .LBB0_44
.LBB0_42:                               # %for.body.i280.preheader
	sub.d	$a3, $a3, $a2
	alsl.d	$a2, $a2, $fp, 2
	.p2align	4, , 16
.LBB0_43:                               # %for.body.i280
                                        # =>This Inner Loop Header: Depth=1
	ldx.wu	$a4, $a2, $a1
	and	$a5, $a5, $s0
	add.w	$a6, $a4, $a5
	...
	addi.d	$a2, $a2, 4
	bnez	$a3, .LBB0_43
.LBB0_44:                               # %for.end.i292
	ori	$a1, $zero, 1
	bne	$a0, $a1, .LBB0_46
# %bb.45:                               # %if.then16.i294
	and	$a0, $a5, $s0
	bstrpick.d	$a0, $a0, 31, 1
	ld.d	$a1, $sp, 152                   # 8-byte Folded Reload
	st.w	$a0, $a1, 0
.LBB0_46:                               # %mp_idiv_2.exit299
	move	$a0, $s2
	move	$a1, $s0
	move	$a2, $s1
	move	$a3, $fp
...
# %bb.47:                               # %vec.epilog.middle.block
	...
	beq	$a4, $a6, .LBB2_50
.LBB2_48:                               # %while.body153.preheader
	addi.d	$a2, $a2, 1
	.p2align	4, , 16
.LBB2_49:                               # %while.body153
                                        # =>This Inner Loop Header: Depth=1
	slli.d	$a4, $a3, 3
	addi.w	$a2, $a2, -1
	alsl.w	$a3, $a3, $a4, 1
	bnez	$a2, .LBB2_49
.LBB2_50:                               # %while.cond156.preheader
	blt	$a1, $a0, .LBB2_64
# %bb.51:                               # %while.body160.preheader
	addi.w	$a2, $s0, 2
	addi.d	$a1, $a0, 1
	slli.d	$a4, $a0, 2
	addi.w	$a5, $a1, 0
...
# %bb.52:                               # %iter.check114
	...
	ori	$a2, $zero, 3
	bltu	$a3, $a2, .LBB2_62
# %bb.53:                               # %vector.main.loop.iter.check116
...
.LBB2_56:                               # %vector.body120
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB2_56
# %bb.57:                               # %middle.block123
	beq	$a2, $a3, .LBB2_64
# %bb.58:                               # %vec.epilog.iter.check127
	beqz	$a4, .LBB2_68
.LBB2_59:                               # %vec.epilog.ph129
	...
	vrepli.b	$vr0, 0
	.p2align	4, , 16
.LBB2_60:                               # %vec.epilog.vector.body132
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a0, 0
	addi.d	$a3, $a3, 4
	addi.d	$a0, $a0, 16
	bnez	$a3, .LBB2_60
# %bb.61:                               # %vec.epilog.middle.block135
	beq	$a2, $a4, .LBB2_64
.LBB2_62:                               # %while.body160.preheader139
	alsl.d	$a0, $a1, $fp, 2
	sub.d	$a1, $s0, $a1
	addi.d	$a1, $a1, 2
	.p2align	4, , 16
.LBB2_63:                               # %while.body160
                                        # =>This Inner Loop Header: Depth=1
	st.w	$zero, $a0, 0
	addi.w	$a1, $a1, -1
	addi.d	$a0, $a0, 4
	bnez	$a1, .LBB2_63
.LBB2_64:                               # %while.end164
	ld.w	$a0, $fp, 8
	bnez	$a0, .LBB2_66
# %bb.65:                               # %if.then168
	st.d	$zero, $fp, 0
...
.LBB13_23:                              # %for.body37.us
	...
	move	$t4, $t5
	blt	$t1, $t3, .LBB13_23
# %bb.24:                               # %for.cond34.for.end46_crit_edge.us
