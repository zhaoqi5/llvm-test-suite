...
# %bb.12:                               # %for.end.i
	...
	ld.wu	$a3, $a2, %pc_lo12(in_pos)
	ld.w	$s5, $t1, %pc_lo12(garbage_bits)
	ld.w	$s7, $t0, %pc_lo12(buffer)
	ld.d	$a2, $sp, 72                    # 8-byte Folded Reload
	ld.wu	$t2, $a2, %pc_lo12(in_size)
...
# %bb.25:                               # %if.end
	...
	ld.wu	$a4, $t2, %pc_lo12(deari_pos)
	ld.d	$a0, $a0, 0
	addi.d	$a6, $a4, 1
	st.w	$a6, $t2, %pc_lo12(deari_pos)
	stx.b	$a2, $a0, $a4
	ld.d	$s7, $sp, 32                    # 8-byte Folded Reload
	ld.w	$a0, $s7, 0
	ld.d	$a4, $sp, 24                    # 8-byte Folded Reload
	bne	$a0, $a4, .LBB0_28
# %bb.26:                               # %for.body.i34.preheader
                                        #   in Loop: Header=BB0_10 Depth=1
	move	$a0, $zero
	ori	$a4, $zero, 1028
	.p2align	4, , 16
.LBB0_27:                               # %for.body.i34
                                        #   Parent Loop BB0_10 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ldx.w	$a6, $a5, $a4
	addi.d	$a6, $a6, 1
	bstrpick.d	$t2, $a6, 31, 31
	add.w	$a6, $a6, $t2
	srai.d	$a6, $a6, 1
	stx.w	$a6, $a5, $a4
	stx.w	$a0, $s7, $a4
