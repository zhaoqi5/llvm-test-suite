...
.Lfunc_end0:
	...
	.p2align	5, 0x0                          # -- Begin function old_main
.LCPI1_0:
...
# %bb.1:                                # %for.cond2.preheader.lr.ph
	...
	fld.d	$fa0, $a3, %pc_lo12(.LCPI10_0)
	lu12i.w	$a3, -419431
	ori	$a3, $a3, 2458
	lu32i.d	$a3, -419431
	pcalau12i	$a4, %pc_hi20(.LCPI10_1)
	fld.d	$fa1, $a4, %pc_lo12(.LCPI10_1)
	pcalau12i	$a4, %pc_hi20(.LCPI10_2)
	fld.d	$fa2, $a4, %pc_lo12(.LCPI10_2)
	lu52i.d	$a3, $a3, 1015
	vreplgr2vr.d	$vr3, $a3
	vldi	$vr4, -988
	.p2align	4, , 16
...
.LBB20_18:                              # %if.else.i
	...
	fld.d	$ft0, $sp, 48                   # 8-byte Folded Reload
	vldi	$vr7, -928
