...
# %bb.16:                               # %iter.check711
	...
	ori	$a2, $zero, 64
	bltu	$a1, $a2, .LBB2_26
# %bb.17:                               # %vector.main.loop.iter.check713
	ori	$a1, $zero, 16
	bgeu	$s8, $a1, .LBB2_19
# %bb.18:
	move	$a4, $zero
	b	.LBB2_23
.LBB2_19:                               # %vector.ph714
	bstrpick.d	$a1, $s8, 30, 4
	slli.d	$a4, $a1, 4
	move	$a1, $zero
	move	$a2, $a4
	.p2align	4, , 16
.LBB2_20:                               # %vector.body717
                                        # =>This Inner Loop Header: Depth=1
	add.d	$a3, $s2, $a1
	xvldx	$xr0, $s2, $a1
	xvld	$xr1, $a3, 32
	...
	addi.d	$a1, $a1, 64
	bnez	$a2, .LBB2_20
# %bb.21:                               # %middle.block722
	beq	$a4, $s8, .LBB2_28
# %bb.22:                               # %vec.epilog.iter.check727
	andi	$a1, $s8, 12
	beqz	$a1, .LBB2_26
.LBB2_23:                               # %vec.epilog.ph726
	move	$a2, $a4
	...
	slli.d	$a2, $a2, 2
	.p2align	4, , 16
.LBB2_24:                               # %vec.epilog.vector.body732
                                        # =>This Inner Loop Header: Depth=1
	vldx	$vr0, $s2, $a2
	vstx	$vr0, $a0, $a2
	addi.d	$a1, $a1, 4
	addi.d	$a2, $a2, 16
	bnez	$a1, .LBB2_24
# %bb.25:                               # %vec.epilog.middle.block736
	beq	$a4, $s8, .LBB2_28
