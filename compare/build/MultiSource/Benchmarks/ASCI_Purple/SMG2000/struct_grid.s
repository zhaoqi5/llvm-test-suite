...
.LBB8_29:                               # %vector.body162
	...
	addi.d	$a4, $a4, 8
	bnez	$a5, .LBB8_29
# %bb.30:                               # %middle.block165
	move	$s2, $a3
	bne	$a1, $a2, .LBB8_20
	b	.LBB8_22
.LBB8_31:                               # %vector.main.loop.iter.check173
	ori	$a2, $zero, 16
	bgeu	$a1, $a2, .LBB8_36
# %bb.32:
	move	$a2, $zero
	move	$a3, $zero
.LBB8_33:                               # %vec.epilog.ph187
	move	$a4, $a2
	...
	addi.d	$a4, $a4, 96
	.p2align	4, , 16
.LBB8_34:                               # %vec.epilog.vector.body193
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a5, $a4, -84
	ld.w	$a6, $a4, -60
	ld.w	$a7, $a4, -36
	...
	addi.d	$a4, $a4, 192
	bnez	$a3, .LBB8_34
# %bb.35:                               # %vec.epilog.middle.block197
	xvpermi.d	$xr1, $xr0, 78
	xvshuf4i.w	$xr1, $xr1, 228
	xvadd.w	$xr0, $xr0, $xr1
	xvpermi.d	$xr1, $xr0, 68
...
# %bb.38:                               # %middle.block182
	...
	xvpickve2gr.w	$a3, $xr0, 0
	beq	$a2, $a1, .LBB8_42
# %bb.39:                               # %vec.epilog.iter.check188
	andi	$a4, $a1, 8
	bnez	$a4, .LBB8_33
...
.LBB8_52:
	move	$a3, $zero
	b	.LBB8_64
.LBB8_53:                               # %vector.main.loop.iter.check206
	ori	$a2, $zero, 16
	bgeu	$a0, $a2, .LBB8_58
# %bb.54:
	move	$a2, $zero
	move	$a3, $zero
.LBB8_55:                               # %vec.epilog.ph221
	move	$a4, $a2
	...
	addi.d	$a4, $a4, 96
	.p2align	4, , 16
.LBB8_56:                               # %vec.epilog.vector.body227
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a5, $a4, -84
	ld.w	$a6, $a4, -60
	ld.w	$a7, $a4, -36
	...
	addi.d	$a4, $a4, 192
	bnez	$a3, .LBB8_56
# %bb.57:                               # %vec.epilog.middle.block231
	xvpermi.d	$xr1, $xr0, 78
	xvshuf4i.w	$xr1, $xr1, 228
	xvadd.w	$xr0, $xr0, $xr1
	xvpermi.d	$xr1, $xr0, 68
...
# %bb.60:                               # %middle.block215
	...
	xvpickve2gr.w	$a3, $xr0, 0
	beq	$a2, $a0, .LBB8_64
# %bb.61:                               # %vec.epilog.iter.check222
	andi	$a4, $a0, 8
	bnez	$a4, .LBB8_55
