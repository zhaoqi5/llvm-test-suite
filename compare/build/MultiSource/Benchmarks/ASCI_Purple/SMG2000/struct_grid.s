...
.LBB8_29:                               # %vector.body163
	...
	addi.d	$a4, $a4, 8
	bnez	$a5, .LBB8_29
# %bb.30:                               # %middle.block166
	move	$s2, $a3
	bne	$a1, $a2, .LBB8_20
	b	.LBB8_22
.LBB8_31:                               # %vector.main.loop.iter.check174
	ori	$a2, $zero, 16
	bgeu	$a1, $a2, .LBB8_36
# %bb.32:
	move	$a2, $zero
	move	$a4, $zero
.LBB8_33:                               # %vec.epilog.ph190
	move	$a5, $a2
...
.LBB8_55:                               # %vec.epilog.ph223
	...
	addi.d	$a4, $a4, 96
	.p2align	4, , 16
.LBB8_56:                               # %vec.epilog.vector.body226
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a5, $a4, -84
	ld.w	$a6, $a4, -60
	ld.w	$a7, $a4, -36
	...
	addi.d	$a4, $a4, 192
	bnez	$a3, .LBB8_56
# %bb.57:                               # %vec.epilog.middle.block230
	xvhaddw.d.w	$xr0, $xr0, $xr0
	xvhaddw.q.d	$xr0, $xr0, $xr0
	xvpermi.d	$xr1, $xr0, 2
	xvadd.d	$xr0, $xr1, $xr0
...
# %bb.60:                               # %middle.block215
	...
	xvpickve2gr.d	$a4, $xr0, 0
	beq	$a2, $a0, .LBB8_64
# %bb.61:                               # %vec.epilog.iter.check221
	bnez	$a3, .LBB8_55
