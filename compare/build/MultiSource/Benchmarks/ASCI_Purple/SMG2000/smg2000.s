...
# %bb.45:                               # %middle.block
	beq	$a0, $s8, .LBB0_48
.LBB0_46:                               # %for.body262.preheader893
	addi.d	$a1, $sp, 288
	alsl.d	$a1, $a0, $a1, 3
	addi.d	$a1, $a1, 4
	sub.d	$a0, $s8, $a0
...
# %bb.90:                               #   in Loop: Header=BB0_80 Depth=1
	move	$t3, $zero
	b	.LBB0_135
.LBB0_91:                               # %vector.main.loop.iter.check812
                                        #   in Loop: Header=BB0_80 Depth=1
	bgeu	$s5, $t1, .LBB0_99
# %bb.92:                               #   in Loop: Header=BB0_80 Depth=1
	move	$t5, $zero
	b	.LBB0_103
.LBB0_93:                               # %vector.main.loop.iter.check776
                                        #   in Loop: Header=BB0_80 Depth=1
	bgeu	$s5, $t1, .LBB0_108
# %bb.94:                               #   in Loop: Header=BB0_80 Depth=1
	move	$t5, $zero
	b	.LBB0_112
.LBB0_95:                               # %vector.main.loop.iter.check848
                                        #   in Loop: Header=BB0_80 Depth=1
	bgeu	$s5, $t1, .LBB0_118
...
# %bb.98:                               #   in Loop: Header=BB0_80 Depth=1
	move	$t4, $zero
	b	.LBB0_132
.LBB0_99:                               # %vector.body816.preheader
                                        #   in Loop: Header=BB0_80 Depth=1
...
.LBB0_100:                              # %vector.body816
	...
	addi.d	$t4, $t4, 64
	bnez	$t5, .LBB0_100
# %bb.101:                              # %middle.block822
                                        #   in Loop: Header=BB0_80 Depth=1
	beq	$a2, $a1, .LBB0_78
# %bb.102:                              # %vec.epilog.iter.check827
                                        #   in Loop: Header=BB0_80 Depth=1
	move	$t4, $a2
	move	$t5, $a2
	beqz	$a3, .LBB0_106
.LBB0_103:                              # %vec.epilog.ph826
                                        #   in Loop: Header=BB0_80 Depth=1
	...
	alsl.d	$t5, $t5, $s3, 2
	.p2align	4, , 16
.LBB0_104:                              # %vec.epilog.vector.body835
                                        #   Parent Loop BB0_80 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr6, $t5, 0
	vaddi.wu	$vr6, $vr6, 4
	...
	addi.d	$t5, $t5, 16
	bnez	$t4, .LBB0_104
# %bb.105:                              # %vec.epilog.middle.block840
                                        #   in Loop: Header=BB0_80 Depth=1
	move	$t4, $a4
	beq	$a4, $a1, .LBB0_78
.LBB0_106:                              # %for.body463.us544.preheader
                                        #   in Loop: Header=BB0_80 Depth=1
	alsl.d	$t5, $t4, $s3, 2
	sub.d	$t6, $a1, $t4
	.p2align	4, , 16
.LBB0_107:                              # %for.body463.us544
                                        #   Parent Loop BB0_80 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.w	$t4, $t5, 0
	addi.d	$t4, $t4, 1
	...
	bnez	$t6, .LBB0_107
	b	.LBB0_78
.LBB0_108:                              # %vector.body780.preheader
                                        #   in Loop: Header=BB0_80 Depth=1
	pcalau12i	$t4, %pc_hi20(.LCPI0_2)
	xvld	$xr6, $t4, %pc_lo12(.LCPI0_2)
	move	$t4, $a5
...
.LBB0_109:                              # %vector.body780
	...
	addi.d	$t4, $t4, 64
	bnez	$t5, .LBB0_109
# %bb.110:                              # %middle.block786
                                        #   in Loop: Header=BB0_80 Depth=1
	beq	$a2, $a1, .LBB0_117
# %bb.111:                              # %vec.epilog.iter.check791
                                        #   in Loop: Header=BB0_80 Depth=1
	move	$t4, $a2
	move	$t5, $a2
	beqz	$a3, .LBB0_115
.LBB0_112:                              # %vec.epilog.ph790
                                        #   in Loop: Header=BB0_80 Depth=1
	pcalau12i	$t4, %pc_hi20(.LCPI0_3)
	vld	$vr6, $t4, %pc_lo12(.LCPI0_3)
	vreplgr2vr.w	$vr7, $t5
	...
	alsl.d	$t5, $t5, $s3, 2
	.p2align	4, , 16
.LBB0_113:                              # %vec.epilog.vector.body799
                                        #   Parent Loop BB0_80 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr6, $t5, 0
	vaddi.wu	$vr6, $vr6, 4
	...
	addi.d	$t5, $t5, 16
	bnez	$t4, .LBB0_113
# %bb.114:                              # %vec.epilog.middle.block804
                                        #   in Loop: Header=BB0_80 Depth=1
	move	$t4, $a4
	beq	$a4, $a1, .LBB0_117
...
.LBB0_117:                              # %for.cond460.for.inc508_crit_edge.split.us
	...
	fst.d	$fa5, $t3, 8
	b	.LBB0_79
.LBB0_118:                              # %vector.body852.preheader
                                        #   in Loop: Header=BB0_80 Depth=1
	pcalau12i	$t4, %pc_hi20(.LCPI0_2)
	xvld	$xr6, $t4, %pc_lo12(.LCPI0_2)
	move	$t4, $a5
...
.LBB0_119:                              # %vector.body852
	...
	addi.d	$t4, $t4, 64
	bnez	$t5, .LBB0_119
# %bb.120:                              # %middle.block858
                                        #   in Loop: Header=BB0_80 Depth=1
	beq	$a2, $a1, .LBB0_127
# %bb.121:                              # %vec.epilog.iter.check863
                                        #   in Loop: Header=BB0_80 Depth=1
	move	$t4, $a2
	move	$t5, $a2
	beqz	$a3, .LBB0_125
.LBB0_122:                              # %vec.epilog.ph862
                                        #   in Loop: Header=BB0_80 Depth=1
	pcalau12i	$t4, %pc_hi20(.LCPI0_3)
	vld	$vr6, $t4, %pc_lo12(.LCPI0_3)
	vreplgr2vr.w	$vr7, $t5
	...
	alsl.d	$t5, $t5, $s3, 2
	.p2align	4, , 16
.LBB0_123:                              # %vec.epilog.vector.body871
                                        #   Parent Loop BB0_80 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr6, $t5, 0
	vaddi.wu	$vr6, $vr6, 4
	...
	addi.d	$t5, $t5, 16
	bnez	$t4, .LBB0_123
# %bb.124:                              # %vec.epilog.middle.block876
                                        #   in Loop: Header=BB0_80 Depth=1
	move	$t4, $a4
	beq	$a4, $a1, .LBB0_127
.LBB0_125:                              # %for.body463.us552.preheader
                                        #   in Loop: Header=BB0_80 Depth=1
	alsl.d	$t5, $t4, $s3, 2
	sub.d	$t6, $a1, $t4
	.p2align	4, , 16
.LBB0_126:                              # %for.body463.us552
                                        #   Parent Loop BB0_80 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.w	$t4, $t5, 0
	addi.d	$t4, $t4, 1
...
.LBB0_127:                              # %for.cond460.for.inc508_crit_edge.split.split.split.us
	...
	fst.d	$fa3, $t3, 24
	b	.LBB0_79
.LBB0_128:                              # %vector.body755.preheader
                                        #   in Loop: Header=BB0_80 Depth=1
...
.LBB0_154:                              # %vector.body884
	...
	addi.d	$a2, $a2, 64
	bnez	$a3, .LBB0_154
# %bb.155:                              # %middle.block887
	beq	$a1, $s5, .LBB0_158
.LBB0_156:                              # %for.body579.preheader890
	alsl.d	$a2, $a1, $fp, 3
	sub.d	$a1, $s5, $a1
	lu52i.d	$a3, $zero, 1023
	.p2align	4, , 16
