...
# %bb.45:                               # %middle.block
	beq	$a0, $s6, .LBB0_48
.LBB0_46:                               # %for.body262.preheader813
	addi.d	$a1, $sp, 272
	alsl.d	$a1, $a0, $a1, 3
	addi.d	$a1, $a1, 4
	sub.d	$a0, $s6, $a0
...
# %bb.82:                               # %for.cond460.preheader
                                        #   in Loop: Header=BB0_80 Depth=1
	bne	$s6, $t0, .LBB0_89
# %bb.83:                               # %for.body463.us545.preheader
                                        #   in Loop: Header=BB0_80 Depth=1
	bgeu	$s4, $a6, .LBB0_102
# %bb.84:                               #   in Loop: Header=BB0_80 Depth=1
	...
	b	.LBB0_105
	.p2align	4, , 16
.LBB0_85:                               # %for.body463.us537.preheader
                                        #   in Loop: Header=BB0_80 Depth=1
	bgeu	$s4, $a6, .LBB0_91
# %bb.86:                               #   in Loop: Header=BB0_80 Depth=1
	...
	b	.LBB0_94
	.p2align	4, , 16
.LBB0_87:                               # %for.body463.us.preheader
                                        #   in Loop: Header=BB0_80 Depth=1
	bgeu	$s4, $a6, .LBB0_96
# %bb.88:                               #   in Loop: Header=BB0_80 Depth=1
	...
	b	.LBB0_99
	.p2align	4, , 16
.LBB0_89:                               # %for.body463.preheader
                                        #   in Loop: Header=BB0_80 Depth=1
	bgeu	$s4, $a6, .LBB0_108
# %bb.90:                               #   in Loop: Header=BB0_80 Depth=1
	move	$t1, $zero
	b	.LBB0_111
.LBB0_91:                               # %vector.body772.preheader
                                        #   in Loop: Header=BB0_80 Depth=1
	vld	$vr7, $a5, %pc_lo12(.LCPI0_2)
	move	$t2, $a3
	move	$t3, $a2
	.p2align	4, , 16
.LBB0_92:                               # %vector.body772
	...
	addi.d	$t2, $t2, 32
	bnez	$t3, .LBB0_92
# %bb.93:                               # %middle.block778
                                        #   in Loop: Header=BB0_80 Depth=1
	move	$t2, $a2
	beq	$a2, $a1, .LBB0_78
.LBB0_94:                               # %for.body463.us537.preheader809
                                        #   in Loop: Header=BB0_80 Depth=1
	alsl.d	$t3, $t2, $s3, 2
	sub.d	$t4, $a1, $t2
	.p2align	4, , 16
.LBB0_95:                               # %for.body463.us537
                                        #   Parent Loop BB0_80 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.w	$t2, $t3, 0
	addi.d	$t2, $t2, 1
	...
	bnez	$t4, .LBB0_95
	b	.LBB0_78
.LBB0_96:                               # %vector.body758.preheader
                                        #   in Loop: Header=BB0_80 Depth=1
	move	$t2, $a3
	move	$t3, $a2
	vori.b	$vr7, $vr6, 0
	.p2align	4, , 16
.LBB0_97:                               # %vector.body758
                                        #   Parent Loop BB0_80 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vaddi.wu	$vr8, $vr7, 4
	vst	$vr7, $t2, -16
	...
	addi.d	$t2, $t2, 32
	bnez	$t3, .LBB0_97
# %bb.98:                               # %middle.block764
                                        #   in Loop: Header=BB0_80 Depth=1
	move	$t2, $a2
	beq	$a2, $a1, .LBB0_101
.LBB0_99:                               # %for.body463.us.preheader808
                                        #   in Loop: Header=BB0_80 Depth=1
	alsl.d	$t3, $t2, $s3, 2
	sub.d	$t4, $a1, $t2
	.p2align	4, , 16
.LBB0_100:                              # %for.body463.us
                                        #   Parent Loop BB0_80 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.w	$t2, $t3, 0
	addi.d	$t2, $t2, 1
	...
	addi.d	$t3, $t3, 4
	bnez	$t4, .LBB0_100
.LBB0_101:                              # %for.cond460.for.inc508_crit_edge.split.us
                                        #   in Loop: Header=BB0_80 Depth=1
	fst.d	$fa0, $t1, 0
	fst.d	$fa5, $t1, 8
	b	.LBB0_79
.LBB0_102:                              # %vector.body786.preheader
                                        #   in Loop: Header=BB0_80 Depth=1
	vld	$vr7, $a5, %pc_lo12(.LCPI0_2)
	move	$t2, $a3
	move	$t3, $a2
	.p2align	4, , 16
.LBB0_103:                              # %vector.body786
                                        #   Parent Loop BB0_80 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vaddi.wu	$vr8, $vr7, 4
	vst	$vr7, $t2, -16
	...
	addi.d	$t2, $t2, 32
	bnez	$t3, .LBB0_103
# %bb.104:                              # %middle.block792
                                        #   in Loop: Header=BB0_80 Depth=1
	move	$t2, $a2
	beq	$a2, $a1, .LBB0_107
.LBB0_105:                              # %for.body463.us545.preheader810
                                        #   in Loop: Header=BB0_80 Depth=1
	alsl.d	$t3, $t2, $s3, 2
	sub.d	$t4, $a1, $t2
	.p2align	4, , 16
.LBB0_106:                              # %for.body463.us545
                                        #   Parent Loop BB0_80 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.w	$t2, $t3, 0
	addi.d	$t2, $t2, 1
	...
	addi.d	$t3, $t3, 4
	bnez	$t4, .LBB0_106
.LBB0_107:                              # %for.cond460.for.inc508_crit_edge.split.split.split.us
                                        #   in Loop: Header=BB0_80 Depth=1
	fst.d	$fa0, $t1, 0
	fst.d	$fa1, $t1, 8
	fst.d	$fa2, $t1, 16
	fst.d	$fa3, $t1, 24
	b	.LBB0_79
.LBB0_108:                              # %vector.body745.preheader
                                        #   in Loop: Header=BB0_80 Depth=1
	vld	$vr7, $a5, %pc_lo12(.LCPI0_2)
	move	$t1, $a3
	move	$t2, $a2
	.p2align	4, , 16
.LBB0_109:                              # %vector.body745
                                        #   Parent Loop BB0_80 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vaddi.wu	$vr8, $vr7, 4
	vst	$vr7, $t1, -16
	...
	addi.d	$t1, $t1, 32
	bnez	$t2, .LBB0_109
# %bb.110:                              # %middle.block750
                                        #   in Loop: Header=BB0_80 Depth=1
	move	$t1, $a2
	beq	$a2, $a1, .LBB0_79
.LBB0_111:                              # %for.body463.preheader807
                                        #   in Loop: Header=BB0_80 Depth=1
	alsl.d	$t2, $t1, $s3, 2
	sub.d	$t3, $a1, $t1
	.p2align	4, , 16
.LBB0_112:                              # %for.body463
                                        #   Parent Loop BB0_80 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	st.w	$t1, $t2, 0
	addi.d	$t1, $t1, 1
	...
	bnez	$t3, .LBB0_112
	b	.LBB0_79
.LBB0_113:                              # %for.cond512.preheader
	addi.w	$fp, $s7, 0
	blez	$fp, .LBB0_116
# %bb.114:                              # %for.body514.preheader
	ld.d	$s1, $sp, 168                   # 8-byte Folded Reload
	ld.d	$s2, $sp, 160                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB0_115:                              # %for.body514
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $sp, 264
	ld.d	$a1, $s1, 0
	ld.d	$a2, $s2, 0
	...
	addi.d	$s1, $s1, 8
	bnez	$fp, .LBB0_115
.LBB0_116:                              # %for.cond524.preheader
	st.d	$s4, $sp, 136                   # 8-byte Folded Spill
	addi.w	$fp, $s5, 0
	blez	$fp, .LBB0_118
# %bb.117:                              # %for.body526.preheader
	slli.d	$a2, $fp, 3
	move	$a0, $s0
	move	$a1, $zero
	pcaddu18i	$ra, %call36(memset)
	jirl	$ra, $ra, 0
.LBB0_118:                              # %for.cond532.preheader
	st.d	$fp, $sp, 128                   # 8-byte Folded Spill
	blez	$s6, .LBB0_126
# %bb.119:                              # %for.cond532.preheader
	ld.d	$a0, $sp, 144                   # 8-byte Folded Reload
	addi.w	$s1, $a0, 0
	blez	$s1, .LBB0_126
# %bb.120:                              # %for.cond535.preheader.us.preheader
	move	$s7, $zero
	b	.LBB0_122
	.p2align	4, , 16
.LBB0_121:                              # %for.cond535.for.inc570_crit_edge.us
                                        #   in Loop: Header=BB0_122 Depth=1
	addi.d	$s7, $s7, 1
	ld.d	$s6, $sp, 152                   # 8-byte Folded Reload
	beq	$s7, $s6, .LBB0_126
.LBB0_122:                              # %for.cond535.preheader.us
                                        # =>This Loop Header: Depth=1
	...
	b	.LBB0_124
	.p2align	4, , 16
.LBB0_123:                              # %for.inc567.us
                                        #   in Loop: Header=BB0_124 Depth=2
	addi.d	$s5, $s5, 8
	addi.d	$s4, $s4, -1
	addi.d	$s6, $s6, 8
	beqz	$s4, .LBB0_121
.LBB0_124:                              # %for.body537.us
                                        #   Parent Loop BB0_122 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a1, $s5, 0
	ldx.w	$a0, $a1, $fp
	bne	$a0, $s2, .LBB0_123
# %bb.125:                              # %if.then545.us
                                        #   in Loop: Header=BB0_124 Depth=2
	ld.d	$a2, $s6, 0
	ldx.w	$s8, $a2, $fp
	ld.d	$a0, $sp, 264
...
.LBB0_126:                              # %for.end572
	...
	blez	$s5, .LBB0_134
# %bb.127:                              # %for.body579.preheader
	ori	$a0, $zero, 4
	bgeu	$s5, $a0, .LBB0_129
# %bb.128:
	move	$a0, $zero
	b	.LBB0_132
.LBB0_129:                              # %vector.ph797
...
.LBB0_130:                              # %vector.body800
	...
	addi.d	$a1, $a1, 32
	bnez	$a2, .LBB0_130
# %bb.131:                              # %middle.block803
	beq	$a0, $s5, .LBB0_134
.LBB0_132:                              # %for.body579.preheader806
	alsl.d	$a1, $a0, $s0, 3
	sub.d	$a0, $s5, $a0
	lu52i.d	$a2, $zero, 1023
	.p2align	4, , 16
.LBB0_133:                              # %for.body579
                                        # =>This Inner Loop Header: Depth=1
	st.d	$a2, $a1, 0
	addi.d	$a0, $a0, -1
	addi.d	$a1, $a1, 8
	bnez	$a0, .LBB0_133
.LBB0_134:                              # %for.cond585.preheader
	addi.w	$fp, $s4, 0
	blez	$fp, .LBB0_137
# %bb.135:                              # %for.body587.preheader
	ld.d	$s1, $sp, 168                   # 8-byte Folded Reload
	ld.d	$s2, $sp, 160                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB0_136:                              # %for.body587
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $sp, 256
	ld.d	$a1, $s1, 0
	ld.d	$a2, $s2, 0
...
.LBB0_137:                              # %for.end595
	...
	jirl	$ra, $ra, 0
	blez	$s5, .LBB0_139
# %bb.138:                              # %for.body601.preheader
	slli.d	$a2, $s5, 3
	move	$a0, $s0
	move	$a1, $zero
	pcaddu18i	$ra, %call36(memset)
	jirl	$ra, $ra, 0
.LBB0_139:                              # %for.cond607.preheader
	addi.w	$fp, $s4, 0
	blez	$fp, .LBB0_142
# %bb.140:                              # %for.body609.preheader
	ld.d	$s1, $sp, 168                   # 8-byte Folded Reload
	ld.d	$s2, $sp, 160                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB0_141:                              # %for.body609
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $sp, 248
	ld.d	$a1, $s1, 0
	ld.d	$a2, $s2, 0
...
.LBB0_154:                              # %if.end704
	...
	jirl	$ra, $ra, 0
	blez	$s0, .LBB0_157
# %bb.155:                              # %for.body712.preheader
	ld.d	$fp, $sp, 160                   # 8-byte Folded Reload
	ld.d	$s1, $sp, 168                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB0_156:                              # %for.body712
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $fp, 0
	pcaddu18i	$ra, %call36(hypre_Free)
	jirl	$ra, $ra, 0
...
.LBB0_157:                              # %for.end723
	...
	ld.d	$a0, $sp, 136                   # 8-byte Folded Reload
	bltz	$s6, .LBB0_160
# %bb.158:                              # %for.body727.preheader
	bstrpick.d	$fp, $a0, 31, 0
	ld.d	$s0, $sp, 120                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB0_159:                              # %for.body727
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $s0, 0
	pcaddu18i	$ra, %call36(hypre_Free)
	jirl	$ra, $ra, 0
