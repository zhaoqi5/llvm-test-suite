...
.LBB3_41:                               #   in Loop: Header=BB3_13 Depth=3
	move	$s8, $a3
.LBB3_42:                               # %for.body348.us.us.preheader
                                        #   in Loop: Header=BB3_13 Depth=3
	ld.d	$a3, $sp, 320                   # 8-byte Folded Reload
	ld.d	$s0, $sp, 328                   # 8-byte Folded Reload
	ld.d	$fp, $sp, 336                   # 8-byte Folded Reload
...
.LBB3_48:                               # %for.body348.us.us.preheader
                                        #   in Loop: Header=BB3_13 Depth=3
	ld.d	$a3, $sp, 320                   # 8-byte Folded Reload
.LBB3_49:                               # %for.body348.us.us.preheader
                                        #   in Loop: Header=BB3_13 Depth=3
	ld.d	$s0, $sp, 328                   # 8-byte Folded Reload
.LBB3_50:                               # %for.body348.us.us.preheader
                                        #   in Loop: Header=BB3_13 Depth=3
	ld.d	$fp, $sp, 336                   # 8-byte Folded Reload
	ld.d	$t3, $sp, 280                   # 8-byte Folded Reload
	b	.LBB3_16
...
.LBB3_53:                               #   in Loop: Header=BB3_13 Depth=3
	...
	b	.LBB3_16
	.p2align	4, , 16
.LBB3_54:                               # %for.cond584.preheader.lr.ph
                                        #   in Loop: Header=BB3_4 Depth=1
	move	$a0, $zero
	ld.d	$a1, $sp, 408                   # 8-byte Folded Reload
	ld.d	$a3, $sp, 16                    # 8-byte Folded Reload
	...
	b	.LBB3_57
	.p2align	4, , 16
.LBB3_55:                               # %for.cond587.preheader.us518.preheader
                                        #   in Loop: Header=BB3_57 Depth=2
	add.d	$a5, $a4, $a5
.LBB3_56:                               # %for.cond584.for.end609_crit_edge.us
                                        #   in Loop: Header=BB3_57 Depth=2
	addi.w	$a0, $a0, 1
	ld.d	$a1, $sp, 208                   # 8-byte Folded Reload
	add.w	$a5, $a5, $a1
	ld.d	$a1, $sp, 216                   # 8-byte Folded Reload
	beq	$a0, $a1, .LBB3_67
.LBB3_57:                               # %for.cond584.preheader.us
                                        #   Parent Loop BB3_4 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB3_60 Depth 3
                                        #         Child Loop BB3_63 Depth 4
	...
	ori	$a1, $zero, 1
	blt	$a3, $a1, .LBB3_55
# %bb.58:                               # %for.cond587.preheader.us.us.preheader
                                        #   in Loop: Header=BB3_57 Depth=2
	move	$t5, $zero
	b	.LBB3_60
	.p2align	4, , 16
.LBB3_59:                               # %for.cond587.for.end603_crit_edge.us.us
                                        #   in Loop: Header=BB3_60 Depth=3
	addi.w	$t5, $t5, 1
	ld.d	$a1, $sp, 408                   # 8-byte Folded Reload
	add.w	$a5, $a1, $t6
	beq	$t5, $s6, .LBB3_56
.LBB3_60:                               # %for.cond587.preheader.us.us
                                        #   Parent Loop BB3_4 Depth=1
...
.LBB3_63:                               # %vector.body739
	...
	addi.d	$a5, $a5, 64
	bnez	$s0, .LBB3_63
# %bb.64:                               # %middle.block743
                                        #   in Loop: Header=BB3_60 Depth=3
	move	$s0, $a7
	beq	$a7, $a2, .LBB3_59
.LBB3_65:                               # %for.body589.us.us.preheader
                                        #   in Loop: Header=BB3_60 Depth=3
	alsl.d	$a1, $t6, $s8, 3
	alsl.d	$a5, $t6, $ra, 3
	alsl.d	$t7, $t6, $s2, 3
...
# %bb.68:                               # %if.then620
	...
	ori	$a0, $zero, 1
	blt	$s6, $a0, .LBB3_3
# %bb.69:                               # %for.cond819.preheader.lr.ph
                                        #   in Loop: Header=BB3_4 Depth=1
	ld.w	$a1, $sp, 420
	ori	$a0, $zero, 1
	blt	$a1, $a0, .LBB3_3
# %bb.70:                               # %for.cond819.preheader.us.preheader
                                        #   in Loop: Header=BB3_4 Depth=1
	move	$t0, $zero
	...
	b	.LBB3_73
	.p2align	4, , 16
.LBB3_71:                               # %for.cond822.preheader.us539.preheader
                                        #   in Loop: Header=BB3_73 Depth=2
	ld.d	$a0, $sp, 312                   # 8-byte Folded Reload
	add.d	$s5, $a0, $s5
.LBB3_72:                               # %for.cond819.for.end854_crit_edge.us
                                        #   in Loop: Header=BB3_73 Depth=2
	addi.w	$t0, $t0, 1
	...
	beq	$t0, $s6, .LBB3_98
.LBB3_73:                               # %for.cond819.preheader.us
                                        #   Parent Loop BB3_4 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB3_75 Depth 3
                                        #         Child Loop BB3_92 Depth 4
	...
	blt	$a4, $a0, .LBB3_71
# %bb.74:                               # %for.cond822.preheader.us.us.preheader
                                        #   in Loop: Header=BB3_73 Depth=2
	move	$s6, $zero
	.p2align	4, , 16
.LBB3_75:                               # %for.cond822.preheader.us.us
                                        #   Parent Loop BB3_4 Depth=1
...
# %bb.76:                               #   in Loop: Header=BB3_75 Depth=3
	move	$s8, $zero
.LBB3_77:                               # %for.body824.us.us.preheader
...
.LBB3_78:                               # %for.body824.us.us
	...
	addi.d	$ra, $ra, 8
	bnez	$a0, .LBB3_78
.LBB3_79:                               # %for.cond822.for.end848_crit_edge.us.us
                                        #   in Loop: Header=BB3_75 Depth=3
	addi.w	$s6, $s6, 1
	add.w	$s5, $a3, $s5
	bne	$s6, $a1, .LBB3_75
...
.LBB3_97:                               #   in Loop: Header=BB3_75 Depth=3
	ld.d	$t4, $sp, 232                   # 8-byte Folded Reload
	b	.LBB3_77
.LBB3_98:                               # %for.cond1060.preheader.lr.ph
                                        #   in Loop: Header=BB3_4 Depth=1
	move	$t0, $zero
	ld.d	$a0, $sp, 296                   # 8-byte Folded Reload
	mul.d	$a0, $a3, $a0
	...
	b	.LBB3_101
	.p2align	4, , 16
.LBB3_99:                               # %for.cond1063.preheader.us560.preheader
                                        #   in Loop: Header=BB3_101 Depth=2
	add.d	$a6, $a7, $a6
.LBB3_100:                              # %for.cond1060.for.end1083_crit_edge.us
                                        #   in Loop: Header=BB3_101 Depth=2
	addi.w	$t0, $t0, 1
	add.w	$a6, $a6, $s8
	beq	$t0, $s6, .LBB3_3
.LBB3_101:                              # %for.cond1060.preheader.us
                                        #   Parent Loop BB3_4 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB3_104 Depth 3
                                        #         Child Loop BB3_107 Depth 4
	...
	ori	$a0, $zero, 1
	blt	$s2, $a0, .LBB3_99
# %bb.102:                              # %for.cond1063.preheader.us.us.preheader
                                        #   in Loop: Header=BB3_101 Depth=2
	move	$t7, $zero
	b	.LBB3_104
	.p2align	4, , 16
.LBB3_103:                              # %for.cond1063.for.end1077_crit_edge.us.us
                                        #   in Loop: Header=BB3_104 Depth=3
	addi.w	$t7, $t7, 1
	add.w	$a6, $a3, $t8
	beq	$t7, $a1, .LBB3_100
.LBB3_104:                              # %for.cond1063.preheader.us.us
                                        #   Parent Loop BB3_4 Depth=1
...
# %bb.108:                              # %middle.block
	...
	move	$a4, $t2
	beq	$t2, $a2, .LBB3_103
.LBB3_109:                              # %for.body1065.us.us.preheader
                                        #   in Loop: Header=BB3_104 Depth=3
	ld.d	$a0, $sp, 392                   # 8-byte Folded Reload
	alsl.d	$a0, $t8, $a0, 3
	ld.d	$a5, $sp, 384                   # 8-byte Folded Reload
