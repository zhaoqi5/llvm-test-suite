...
# %bb.18:                               # %middle.block63
	beq	$a2, $a1, .LBB17_39
.LBB17_19:                              # %for.body8.preheader102
	alsl.d	$a3, $a2, $a3, 3
	alsl.d	$a0, $a2, $a0, 3
	sub.d	$a1, $a1, $a2
	.p2align	4, , 16
...
.LBB17_25:                              # %vec.epilog.ph90
	...
	alsl.d	$a6, $a6, $a0, 2
	.p2align	4, , 16
.LBB17_26:                              # %vec.epilog.vector.body93
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a6, 0
	vst	$vr0, $a5, 0
	addi.d	$a4, $a4, 4
	...
	addi.d	$a6, $a6, 16
	bnez	$a4, .LBB17_26
# %bb.27:                               # %vec.epilog.middle.block97
	beq	$a2, $a1, .LBB17_39
...
# %bb.23:                               # %middle.block53
	beq	$a2, $a1, .LBB18_39
# %bb.24:                               # %vec.epilog.iter.check57
	beqz	$a4, .LBB18_28
.LBB18_25:                              # %vec.epilog.ph59
	move	$a6, $a2
	bstrpick.d	$a2, $a1, 30, 2
	slli.d	$a2, $a2, 2
	sub.d	$a4, $a6, $a2
	...
	alsl.d	$a6, $a6, $a0, 2
	.p2align	4, , 16
.LBB18_26:                              # %vec.epilog.vector.body62
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a6, 0
	vst	$vr0, $a5, 0
	addi.d	$a4, $a4, 4
	...
	addi.d	$a6, $a6, 16
	bnez	$a4, .LBB18_26
# %bb.27:                               # %vec.epilog.middle.block66
	beq	$a2, $a1, .LBB18_39
...
.LBB19_25:                              # %vec.epilog.ph59
	...
	alsl.d	$a6, $a6, $a0, 2
	.p2align	4, , 16
.LBB19_26:                              # %vec.epilog.vector.body62
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a6, 0
	vst	$vr0, $a5, 0
	addi.d	$a4, $a4, 4
...
.LBB20_25:                              # %vec.epilog.ph59
	...
	alsl.d	$a6, $a6, $a0, 2
	.p2align	4, , 16
.LBB20_26:                              # %vec.epilog.vector.body62
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a6, 0
	vst	$vr0, $a5, 0
	addi.d	$a4, $a4, 4
