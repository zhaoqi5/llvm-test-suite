...
.LBB5_4:
	...
	ori	$a0, $zero, 1
	blt	$s0, $a0, .LBB5_10
.LBB5_5:                                # %for.cond20.preheader.us
...
.LBB5_10:                               # %sw.epilog.1
	...
	blt	$a0, $a1, .LBB5_18
# %bb.11:                               # %for.cond20.preheader.lr.ph.1
	ld.w	$a0, $s2, 68
	st.d	$a0, $sp, 24                    # 8-byte Folded Spill
	blez	$a0, .LBB5_17
# %bb.12:                               # %for.cond20.preheader.us.preheader.1
	ld.d	$a0, $s2, 80
	st.d	$a0, $sp, 16                    # 8-byte Folded Spill
	move	$a1, $zero
	b	.LBB5_14
	.p2align	4, , 16
.LBB5_13:                               # %for.cond20.for.end_crit_edge.us.1
	...
	beq	$a1, $a0, .LBB5_18
.LBB5_14:                               # %for.cond20.preheader.us.1
...
.LBB5_16:                               # %for.body22.us45.1
	...
	bnez	$s6, .LBB5_16
	b	.LBB5_13
.LBB5_17:                               # %for.cond20.preheader.preheader.1
	ld.d	$a0, $sp, 32                    # 8-byte Folded Reload
	st.w	$a0, $s2, 192
.LBB5_18:                               # %for.inc38.1
	ld.w	$a0, $s2, 16
...
.LBB5_24:                               # %for.end.i
	...
	jirl	$ra, $ra, 0
	st.d	$zero, $s2, 160
.LBB5_25:                               # %hypre_SMGRelaxDestroyASol.exit
	ori	$a0, $zero, 1
	st.w	$a0, $s2, 8
.LBB5_26:                               # %if.end44
	ld.w	$a0, $s2, 196
