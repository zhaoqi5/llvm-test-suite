...
# %bb.2:                                # %for.body.lr.ph
	...
	xvst	$xr3, $sp, 752                  # 32-byte Folded Spill
	b	.LBB2_4
	.p2align	4, , 16
.LBB2_3:                                # %for.end205
...
.LBB2_84:                               # %for.body5833.us.us.us.us.us.us.preheader
	...
	move	$t3, $zero
	move	$s2, $zero
	ld.d	$s4, $sp, 784                   # 8-byte Folded Reload
	alsl.d	$s4, $s3, $s4, 3
	alsl.d	$s8, $s5, $s0, 3
	alsl.d	$ra, $s6, $t0, 3
...
.LBB2_113:                              # %for.cond5284.preheader.us.us.us.us.us
                                        ...
                                        #               Child Loop BB2_121 Depth 7
                                        #               Child Loop BB2_125 Depth 7
	st.d	$s7, $sp, 712                   # 8-byte Folded Spill
	move	$s5, $zero
	b	.LBB2_115
	.p2align	4, , 16
...
# %bb.129:                              # %for.cond4675.preheader.us.us.us.us.us.preheader
	...
	mul.d	$s8, $a6, $t5
	mul.d	$t5, $a7, $t5
	ld.d	$ra, $sp, 752                   # 8-byte Folded Reload
	mul.d	$t0, $ra, $a5
	sub.d	$a6, $s0, $t0
	sub.d	$a7, $a1, $t0
	sub.d	$t0, $t2, $t0
...
.LBB2_228:                              # %for.body2463.us.us.us.us.us.us.preheader
	...
	alsl.d	$s8, $a5, $t6, 3
	ld.d	$t6, $sp, 712                   # 8-byte Folded Reload
	alsl.d	$ra, $a5, $t6, 3
