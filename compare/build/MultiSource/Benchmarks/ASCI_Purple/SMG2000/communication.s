...
# %bb.6:                                # %for.cond18.preheader.lr.ph.split.us
	...
	b	.LBB7_8
	.p2align	4, , 16
.LBB7_7:                                # %for.cond18.for.inc58_crit_edge.us
	...
	beq	$a3, $a0, .LBB7_2
.LBB7_8:                                # %for.cond18.preheader.us
                                        ...
                                        #           Child Loop BB7_18 Depth 5
	blez	$s0, .LBB7_7
# %bb.9:                                # %for.cond22.preheader.lr.ph.split.us.us
                                        #   in Loop: Header=BB7_8 Depth=2
	move	$a6, $zero
	...
	b	.LBB7_11
	.p2align	4, , 16
.LBB7_10:                               # %for.cond22.for.inc55_crit_edge.us.us
	...
	beq	$a6, $a0, .LBB7_7
.LBB7_11:                               # %for.cond22.preheader.us.us
                                        #   Parent Loop BB7_3 Depth=1
	...
	addi.w	$a0, $s8, 0
	blez	$a0, .LBB7_10
# %bb.12:                               # %for.body25.lr.ph.split.us.us.us
                                        #   in Loop: Header=BB7_11 Depth=3
	ld.d	$a0, $sp, 88                    # 8-byte Folded Reload
	ld.w	$a4, $a0, 48
	...
	b	.LBB7_14
	.p2align	4, , 16
.LBB7_13:                               # %for.cond40.for.inc52_crit_edge.us.us.us
                                        #   in Loop: Header=BB7_14 Depth=4
	addi.w	$a5, $a5, 1
	add.w	$a7, $a7, $s6
	add.w	$t0, $t0, $ra
	beq	$a5, $s0, .LBB7_10
.LBB7_14:                               # %for.body25.us.us.us
                                        #   Parent Loop BB7_3 Depth=1
                                        #     Parent Loop BB7_8 Depth=2
...
.LBB7_16:                               #   in Loop: Header=BB7_14 Depth=4
	...
	move	$s7, $t0
	move	$s2, $a7
.LBB7_17:                               # %for.body43.us.us.us.preheader
                                        #   in Loop: Header=BB7_14 Depth=4
	alsl.d	$s3, $s7, $t7, 3
	alsl.d	$s2, $s2, $t6, 3
	sub.d	$s5, $s8, $a4
	.p2align	4, , 16
.LBB7_18:                               # %for.body43.us.us.us
                                        #   Parent Loop BB7_3 Depth=1
                                        #     Parent Loop BB7_8 Depth=2
                                        #       Parent Loop BB7_11 Depth=3
