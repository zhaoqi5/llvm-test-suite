...
# %bb.37:                               # %for.cond892.preheader.lr.ph
	...
	ori	$a2, $zero, 1
	blt	$a1, $a2, .LBB2_34
# %bb.38:                               # %for.cond892.preheader.lr.ph
                                        #   in Loop: Header=BB2_35 Depth=3
	ori	$a2, $zero, 1
	blt	$a0, $a2, .LBB2_34
# %bb.39:                               # %for.cond895.preheader.us.us.us.us.us.preheader
                                        #   in Loop: Header=BB2_35 Depth=3
	move	$a3, $zero
	ld.w	$a2, $sp, 204
	...
	b	.LBB2_41
	.p2align	4, , 16
.LBB2_40:                               # %for.cond895.for.end926_crit_edge.split.us.us.us.us.us.us
	...
	beq	$a3, $a2, .LBB2_34
.LBB2_41:                               # %for.cond895.preheader.us.us.us.us.us
                                        #   Parent Loop BB2_23 Depth=1
                                        #     Parent Loop BB2_29 Depth=2
	...
	b	.LBB2_43
	.p2align	4, , 16
.LBB2_42:                               # %for.cond898.for.end917_crit_edge.us.us.us.us.us.us
                                        #   in Loop: Header=BB2_43 Depth=5
	add.w	$a4, $a7, $a4
	addi.w	$t8, $t8, 1
	add.w	$a5, $t0, $a5
	beq	$t8, $a1, .LBB2_40
.LBB2_43:                               # %for.cond898.preheader.us.us.us.us.us.us
                                        #   Parent Loop BB2_23 Depth=1
                                        #     Parent Loop BB2_29 Depth=2
                                        #       Parent Loop BB2_35 Depth=3
...
.LBB2_51:                               #   in Loop: Header=BB2_43 Depth=5
	move	$ra, $zero
.LBB2_52:                               # %for.body900.us.us.us.us.us.us.preheader
                                        #   in Loop: Header=BB2_43 Depth=5
	alsl.d	$a2, $a5, $s5, 3
	alsl.d	$t1, $a4, $s4, 3
	alsl.d	$t2, $a4, $s7, 3
	sub.d	$ra, $a0, $ra
	.p2align	4, , 16
.LBB2_53:                               # %for.body900.us.us.us.us.us.us
                                        #   Parent Loop BB2_23 Depth=1
                                        #     Parent Loop BB2_29 Depth=2
                                        #       Parent Loop BB2_35 Depth=3
                                        #         Parent Loop BB2_41 Depth=4
