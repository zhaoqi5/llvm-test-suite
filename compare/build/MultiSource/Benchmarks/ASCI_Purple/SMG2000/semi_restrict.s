...
.LBB2_16:                               # %for.body203
	...
	blt	$a1, $a0, .LBB2_15
# %bb.17:                               # %for.cond617.preheader.lr.ph
                                        #   in Loop: Header=BB2_16 Depth=3
	ld.w	$a1, $sp, 328
	ori	$a0, $zero, 1
	blt	$a1, $a0, .LBB2_15
# %bb.18:                               # %for.cond617.preheader.us.preheader
                                        #   in Loop: Header=BB2_16 Depth=3
	move	$s7, $zero
	ld.w	$a5, $sp, 312
	...
	b	.LBB2_21
	.p2align	4, , 16
.LBB2_19:                               # %for.cond620.preheader.us282.preheader
	...
	add.d	$a5, $a2, $a5
.LBB2_20:                               # %for.cond617.for.end653_crit_edge.us
                                        #   in Loop: Header=BB2_21 Depth=4
	...
	beq	$s7, $a2, .LBB2_15
.LBB2_21:                               # %for.cond617.preheader.us
                                        #   Parent Loop BB2_2 Depth=1
                                        #     Parent Loop BB2_8 Depth=2
	...
	ori	$t3, $zero, 1
	blt	$a2, $t3, .LBB2_19
# %bb.22:                               # %for.cond620.preheader.us.us.preheader
                                        #   in Loop: Header=BB2_21 Depth=4
	move	$t3, $zero
	b	.LBB2_24
	.p2align	4, , 16
.LBB2_23:                               # %for.cond620.for.end_crit_edge.us.us
	...
	add.w	$a5, $t2, $a5
	beq	$t3, $a1, .LBB2_20
.LBB2_24:                               # %for.cond620.preheader.us.us
                                        #   Parent Loop BB2_2 Depth=1
                                        #     Parent Loop BB2_8 Depth=2
                                        #       Parent Loop BB2_16 Depth=3
...
.LBB2_33:                               #   in Loop: Header=BB2_24 Depth=5
	move	$ra, $zero
.LBB2_34:                               # %for.body622.us.us.preheader
                                        #   in Loop: Header=BB2_24 Depth=5
	alsl.d	$t5, $a5, $fp, 3
	alsl.d	$s8, $a4, $s5, 3
	alsl.d	$s7, $a3, $s4, 3
