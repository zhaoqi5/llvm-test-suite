...
# %bb.0:                                # %entry
	...
	andi	$a1, $a5, 15
	slli.d	$a1, $a1, 3
	pcalau12i	$a4, %pc_hi20(LHs)
	addi.d	$a4, $a4, %pc_lo12(LHs)
	ldx.d	$a1, $a4, $a1
	srli.d	$a6, $a5, 5
	andi	$a6, $a6, 120
	ldx.d	$a6, $a4, $a6
	...
	slli.d	$a1, $a2, 2
	andi	$a1, $a1, 120
	pcalau12i	$a4, %pc_hi20(RHs)
	addi.d	$a4, $a4, %pc_lo12(RHs)
	ldx.d	$a6, $a4, $a1
	move	$a1, $zero
	slli.d	$a6, $a6, 3
	srli.d	$a7, $a2, 9
...
.LBB10_4:                               # %for.body.us.preheader
	...
	addi.d	$s5, $a0, %pc_lo12(DES3_keys)
	lu12i.w	$a0, 2
	ori	$s3, $a0, 1808
...
.LBB10_13:                              # %for.body.i32.us.us
	...
	addi.d	$a1, $a1, 16
	bltu	$a0, $s6, .LBB10_13
.LBB10_14:                              # %sw.epilog.us.us
                                        #   in Loop: Header=BB10_7 Depth=3
	move	$s1, $s3
	beqz	$s7, .LBB10_18
# %bb.15:                               # %sw.epilog.split.us62.us
                                        #   in Loop: Header=BB10_7 Depth=3
	beqz	$s4, .LBB10_17
	.p2align	4, , 16
.LBB10_16:                              # %for.body27.us49.us.us
                                        #   Parent Loop BB10_5 Depth=1
                                        #     Parent Loop BB10_6 Depth=2
                                        #       Parent Loop BB10_7 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
...
.LBB10_17:                              # %for.body27.us58.us
	...
	b	.LBB10_22
	.p2align	4, , 16
.LBB10_18:                              # %sw.epilog.split.us.us.us
                                        #   in Loop: Header=BB10_7 Depth=3
	beqz	$s4, .LBB10_21
	.p2align	4, , 16
.LBB10_19:                              # %for.body27.us.us.us.us
                                        #   Parent Loop BB10_5 Depth=1
                                        #     Parent Loop BB10_6 Depth=2
                                        #       Parent Loop BB10_7 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
...
.LBB10_20:                              # %land.lhs.true.us.us
	...
	b	.LBB10_26
	.p2align	4, , 16
.LBB10_21:                              # %for.body27.us.us63.us
                                        #   Parent Loop BB10_5 Depth=1
                                        #     Parent Loop BB10_6 Depth=2
                                        #       Parent Loop BB10_7 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
	...
	addi.w	$s1, $s1, -1
	bnez	$s1, .LBB10_21
.LBB10_22:                              # %land.lhs.true57.us.us
                                        #   in Loop: Header=BB10_7 Depth=3
	ld.d	$a0, $sp, 104                   # 8-byte Folded Reload
	ld.d	$a0, $a0, 0
	ld.d	$a1, $sp, 128
	bne	$a1, $a0, .LBB10_26
.LBB10_23:                              # %for.inc67.us.us
                                        #   in Loop: Header=BB10_7 Depth=3
	addi.w	$s0, $s0, 1
	ld.d	$a0, $sp, 120                   # 8-byte Folded Reload
	bne	$s0, $a0, .LBB10_7
# %bb.24:                               # %for.cond17.for.end69_crit_edge.us.us
