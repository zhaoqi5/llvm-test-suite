...
.LBB10_11:                              # %sw.bb.us.us
	...
	add.d	$a0, $sp, $a0
	st.d	$a2, $a0, 0
.LBB10_12:                              # %sw.epilog.us.us
                                        #   in Loop: Header=BB10_7 Depth=3
	move	$s5, $s8
	beqz	$s7, .LBB10_17
.LBB10_13:                              # %sw.epilog.split.us47.us
                                        #   in Loop: Header=BB10_7 Depth=3
	beqz	$s2, .LBB10_15
	.p2align	4, , 16
.LBB10_14:                              # %for.body27.us34.us.us
                                        #   Parent Loop BB10_5 Depth=1
                                        #     Parent Loop BB10_6 Depth=2
                                        #       Parent Loop BB10_7 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
...
.LBB10_16:                              # %sw.bb23.us.us
	...
	move	$s5, $s8
	bnez	$s7, .LBB10_13
.LBB10_17:                              # %sw.epilog.split.us.us.us
                                        #   in Loop: Header=BB10_7 Depth=3
	beqz	$s2, .LBB10_20
	.p2align	4, , 16
.LBB10_18:                              # %for.body27.us.us.us.us
                                        #   Parent Loop BB10_5 Depth=1
                                        #     Parent Loop BB10_6 Depth=2
                                        #       Parent Loop BB10_7 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
...
.LBB10_19:                              # %land.lhs.true.us.us
	...
	b	.LBB10_25
	.p2align	4, , 16
.LBB10_20:                              # %for.body27.us.us48.us
                                        #   Parent Loop BB10_5 Depth=1
                                        #     Parent Loop BB10_6 Depth=2
                                        #       Parent Loop BB10_7 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
	...
	addi.w	$s5, $s5, -1
	bnez	$s5, .LBB10_20
.LBB10_21:                              # %land.lhs.true57.us.us
                                        #   in Loop: Header=BB10_7 Depth=3
	ld.d	$a0, $sp, 120                   # 8-byte Folded Reload
	ld.d	$a0, $a0, 0
	ld.d	$a1, $sp, 144
	bne	$a1, $a0, .LBB10_25
.LBB10_22:                              # %for.inc67.us.us
                                        #   in Loop: Header=BB10_7 Depth=3
	addi.w	$s6, $s6, 1
	ld.d	$a0, $sp, 136                   # 8-byte Folded Reload
	bne	$s6, $a0, .LBB10_7
# %bb.23:                               # %for.cond17.for.end69_crit_edge.us.us
