...
.LBB0_5:                                # %vector.body22
	...
	andi	$a4, $a4, 1020
	add.d	$a4, $a0, $a4
	xvstelm.w	$xr3, $a5, 0, 0
	xvstelm.w	$xr3, $a6, 0, 1
	xvstelm.w	$xr3, $a7, 0, 2
	xvstelm.w	$xr3, $t0, 0, 3
	xvstelm.w	$xr3, $t1, 0, 4
	xvstelm.w	$xr3, $t2, 0, 5
	xvstelm.w	$xr3, $t3, 0, 6
	xvstelm.w	$xr3, $a4, 0, 7
	xvaddi.wu	$xr1, $xr1, 8
	addi.d	$a3, $a3, -8
	addi.d	$a2, $a2, 8
	bnez	$a3, .LBB0_5
...
# %bb.15:                               # %if.else
	...
	or	$s5, $a1, $a0
	blt	$s5, $s8, .LBB2_13
# %bb.16:                               # %while.cond6.preheader.lr.ph.i67
                                        #   in Loop: Header=BB2_14 Depth=2
