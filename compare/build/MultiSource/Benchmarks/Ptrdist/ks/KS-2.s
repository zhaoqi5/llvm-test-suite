...
.LBB3_9:                                # %for.body.i
                                        ...
                                        #         Child Loop BB3_11 Depth 4
	ld.d	$fp, $t7, 8
	pcalau12i	$t8, %got_pc_hi20(nets)
	ld.d	$t8, $t8, %got_pc_lo12(nets)
	slli.d	$s0, $fp, 3
	ldx.d	$t8, $t8, $s0
	beqz	$t8, .LBB3_8
...
.LBB3_31:                               # %SwapNode.exit29
	...
	ld.d	$a5, $a2, %got_pc_lo12(swapToA)
	ld.d	$a4, $a5, 8
	ld.d	$a6, $a1, 8
	...
	stx.w	$a7, $a1, $a3
	sltui	$a7, $a4, 1
	pcalau12i	$a3, %got_pc_hi20(modules)
	ld.d	$a3, $a3, %got_pc_lo12(modules)
	masknez	$t0, $a4, $a7
	maskeqz	$a7, $a5, $a7
	slli.d	$a4, $a6, 3
	ldx.d	$a4, $a3, $a4
...
# %bb.40:
	...
	pcalau12i	$a3, %got_pc_hi20(cost)
	ld.d	$a3, $a3, %got_pc_lo12(cost)
	pcalau12i	$a4, %got_pc_hi20(D)
	ld.d	$a4, $a4, %got_pc_lo12(D)
	ori	$a5, $zero, 1
	b	.LBB3_42
	.p2align	4, , 16
...
# %bb.0:                                # %entry
	pcalau12i	$a1, %got_pc_hi20(swapToB)
	ld.d	$a5, $a1, %got_pc_lo12(swapToB)
	pcalau12i	$a1, %got_pc_hi20(swapToA)
	ld.d	$a4, $a1, %got_pc_lo12(swapToA)
	move	$a1, $zero
	move	$a2, $zero
	addi.d	$a6, $a0, 2
	.p2align	4, , 16
...
# %bb.2:                                # %for.end
	beqz	$a1, .LBB5_4
# %bb.3:                                # %if.else
	pcalau12i	$a4, %got_pc_hi20(swapToA)
	ld.d	$a4, $a4, %got_pc_lo12(swapToA)
	ld.d	$a5, $a4, 0
	pcalau12i	$a6, %got_pc_hi20(groupA)
	ld.d	$a6, $a6, %got_pc_lo12(groupA)
	pcalau12i	$a7, %got_pc_hi20(swapToB)
	ld.d	$a7, $a7, %got_pc_lo12(swapToB)
	st.d	$a2, $a3, 0
	st.d	$a5, $a6, 0
	ld.d	$a2, $a7, 8
	ld.d	$a3, $a7, 0
	pcalau12i	$a5, %got_pc_hi20(groupB)
	ld.d	$a5, $a5, %got_pc_lo12(groupB)
	ld.d	$a4, $a4, 8
	st.d	$a2, $a6, 8
	st.d	$a1, $a0, 0
	st.d	$a3, $a5, 0
...
.LBB5_4:                                # %if.then
	...
	pcalau12i	$a1, %got_pc_hi20(swapToB)
	ld.d	$a1, $a1, %got_pc_lo12(swapToB)
	vld	$vr0, $a0, 0
	pcalau12i	$a0, %got_pc_hi20(groupA)
	ld.d	$a0, $a0, %got_pc_lo12(groupA)
	vld	$vr1, $a1, 0
...
# %bb.8:                                # %for.body26.preheader
	...
	ld.d	$fp, $a0, %got_pc_lo12(moduleToGroup)
	addi.d	$s4, $s4, -16
