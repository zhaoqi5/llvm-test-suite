...
# %bb.3:                                # %for.body3.preheader
	pcalau12i	$a0, %pc_hi20(modules)
	addi.d	$s0, $a0, %pc_lo12(modules)
	pcalau12i	$a0, %pc_hi20(nets)
	addi.d	$s1, $a0, %pc_lo12(nets)
	move	$s2, $zero
	b	.LBB1_5
	.p2align	4, , 16
.LBB1_4:                                # %for.inc19
