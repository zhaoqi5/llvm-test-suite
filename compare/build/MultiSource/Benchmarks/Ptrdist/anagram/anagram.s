...
.LBB2_5:                                # %for.body.preheader
	...
	move	$a7, $zero
	move	$a1, $zero
	pcalau12i	$a2, %pc_hi20(auGlobalFrequency)
	addi.d	$a2, $a2, %pc_lo12(auGlobalFrequency)
	addi.w	$a3, $zero, -1
	lu32i.d	$a3, 0
	ori	$a4, $zero, 26
	ori	$a5, $zero, 65
...
.LBB6_8:                                # %for.cond.preheader
	...
	addi.d	$a3, $a1, %pc_lo12(auGlobalFrequency)
	xvld	$xr2, $a3, 0
	xvld	$xr3, $a3, 32
	xvadd.w	$xr0, $xr2, $xr0
	xvst	$xr0, $a3, 0
