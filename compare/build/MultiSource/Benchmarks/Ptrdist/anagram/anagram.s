...
.LBB14_2:                               # %if.end
	move	$fp, $a1
	ori	$a1, $zero, 3
	pcalau12i	$s7, %pc_hi20(cchMinLength)
	bne	$a0, $a1, .LBB14_4
# %bb.3:                                # %if.then3
	ld.d	$a0, $fp, 16
	ori	$a2, $zero, 10
	...
	jirl	$ra, $ra, 0
	st.w	$a0, $s7, %pc_lo12(cchMinLength)
.LBB14_4:                               # %if.end4
	ori	$a0, $zero, 1
	pcaddu18i	$ra, %call36(isatty)
	jirl	$ra, $ra, 0
	ld.d	$a1, $fp, 8
	pcalau12i	$s5, %pc_hi20(fInteractive)
	st.w	$a0, $s5, %pc_lo12(fInteractive)
	move	$a0, $a1
	...
	addi.d	$s8, $a0, %pc_lo12(achPhrase)
	pcalau12i	$s3, %pc_hi20(cpwCand)
	ori	$s0, $zero, 10
	pcalau12i	$a0, %pc_hi20(apwCand)
	...
	pcalau12i	$s6, %pc_hi20(cchPhraseLength)
...
.LBB14_6:                               # %while.cond
	...
	ld.w	$a0, $s5, %pc_lo12(fInteractive)
	beqz	$a0, .LBB14_8
# %bb.7:                                # %if.then.i
                                        #   in Loop: Header=BB14_6 Depth=1
	ori	$a0, $zero, 62
...
.LBB14_15:                              # %if.else19
	...
	move	$a1, $zero
	st.w	$zero, $s3, %pc_lo12(cpwCand)
	ld.bu	$a2, $a0, 0
	beqz	$a2, .LBB14_24
# %bb.16:                               # %while.body.preheader.i
                                        #   in Loop: Header=BB14_6 Depth=1
	ld.w	$a1, $s7, %pc_lo12(cchMinLength)
	move	$s8, $a0
	b	.LBB14_19
	.p2align	4, , 16
...
# %bb.20:                               # %lor.lhs.false.i
                                        #   in Loop: Header=BB14_19 Depth=2
	ld.w	$a3, $s6, %pc_lo12(cchPhraseLength)
	beq	$a3, $a0, .LBB14_17
	b	.LBB14_18
	.p2align	4, , 16
...
# %bb.25:                               # %AddWords.exit
                                        #   in Loop: Header=BB14_6 Depth=1
	ld.w	$a0, $s6, %pc_lo12(cchPhraseLength)
	beqz	$a0, .LBB14_6
# %bb.26:                               # %if.end25
                                        #   in Loop: Header=BB14_6 Depth=1
