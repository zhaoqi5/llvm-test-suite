...
# %bb.1:                                # %for.body.lr.ph
	...
	ld.d	$s2, $a0, %got_pc_lo12(CROSSING)
	ld.d	$a0, $s2, 0
	addi.d	$a0, $a0, 8
	addi.d	$a1, $a1, 8
	addi.d	$a2, $a2, 8
	ori	$a3, $zero, 1
	pcalau12i	$a4, %got_pc_hi20(channelDensityColumn)
	ld.d	$a4, $a4, %got_pc_lo12(channelDensityColumn)
	move	$s3, $zero
	ori	$a5, $zero, 1
	b	.LBB3_4
	.p2align	4, , 16
...
.LBB5_3:                                # %for.end
	...
	ld.d	$a5, $a0, %got_pc_lo12(channelColumns)
	ld.d	$a0, $a5, 0
	bgeu	$a0, $a4, .LBB5_5
.LBB5_4:                                # %for.end39
...
# %bb.0:                                # %entry
	...
	ld.d	$a3, $a1, %pc_lo12(cardBotNotPref)
	add.d	$a2, $a3, $a0
	pcalau12i	$a1, %got_pc_hi20(channelTracks)
...
.LBB9_9:                                # %for.body10.preheader
	...
	lu12i.w	$s7, 244
	ori	$s2, $s7, 576
	pcalau12i	$s5, %pc_hi20(cardNotPref)
	lu12i.w	$a0, 2
	ori	$fp, $a0, 1808
	b	.LBB9_11
	.p2align	4, , 16
...
# %bb.20:                               # %if.then18
                                        #   in Loop: Header=BB9_19 Depth=2
	ld.d	$a7, $s5, %pc_lo12(cardNotPref)
	bne	$a7, $a5, .LBB9_16
# %bb.21:                               # %if.else26
                                        #   in Loop: Header=BB9_19 Depth=2
