...
# %bb.0:                                # %entry
	...
	pcalau12i	$a0, %got_pc_hi20(channelNets)
	ld.d	$s6, $a0, %got_pc_lo12(channelNets)
	ld.d	$a0, $s6, 0
	beqz	$a0, .LBB4_13
# %bb.1:                                # %for.body.preheader
	ori	$s0, $zero, 1
...
# %bb.1:                                # %for.body.preheader
	...
	pcalau12i	$s8, %pc_hi20(removeTotalVCG)
...
.LBB12_36:                              # %for.end128
	...
	jirl	$ra, $ra, 0
	ld.d	$a3, $s8, %pc_lo12(removeTotalVCG)
	ld.d	$a0, $s7, 8
	addi.d	$a1, $a3, 1
	st.d	$a1, $s8, %pc_lo12(removeTotalVCG)
	slli.d	$a0, $a0, 6
	add.d	$a2, $s2, $a0
	ld.d	$a0, $a2, 40
	ld.d	$a1, $s7, 0
...
.LBB14_3:                               # %DFSClearVCG.exit
	...
	ld.d	$a1, $a1, %got_pc_lo12(cardBotNotPref)
	st.d	$a0, $a1, 0
...
.LBB14_9:                               # %DFSClearVCG.exit29
	...
	ld.d	$a1, $a1, %got_pc_lo12(cardTopNotPref)
	ld.d	$a2, $s1, 0
	st.d	$a0, $a1, 0
	beqz	$a2, .LBB14_19
# %bb.10:                               # %for.body8.lr.ph
	pcalau12i	$a1, %got_pc_hi20(tracksTopNotPref)
	ld.d	$a1, $a1, %got_pc_lo12(tracksTopNotPref)
	ld.d	$a2, $a1, 0
	addi.d	$a2, $a2, 8
	ori	$a3, $zero, 1
	.p2align	4, , 16
...
# %bb.13:                               # %for.body20.lr.ph
	ld.d	$a3, $a1, 0
	pcalau12i	$a0, %got_pc_hi20(tracksBotNotPref)
	ld.d	$a0, $a0, %got_pc_lo12(tracksBotNotPref)
	ld.d	$a2, $a0, 0
	pcalau12i	$a0, %got_pc_hi20(tracksNotPref)
	ld.d	$a0, $a0, %got_pc_lo12(tracksNotPref)
	ld.d	$a1, $a0, 0
	move	$a0, $zero
	addi.d	$a1, $a1, 8
	addi.d	$a2, $a2, 8
...
# %bb.0:                                # %entry
	...
	move	$s2, $a0
	pcalau12i	$a0, %got_pc_hi20(channelNets)
	ld.d	$s5, $a0, %got_pc_lo12(channelNets)
	ld.d	$a0, $s5, 0
	beqz	$a0, .LBB17_25
# %bb.1:                                # %for.body.lr.ph
	move	$fp, $a3
...
.LBB17_13:                              # %for.body.i.i23
	...
	addi.d	$a1, $a1, 64
	bgeu	$a2, $a0, .LBB17_13
.LBB17_14:                              # %ExistPathAboveVCG.exit32
                                        #   in Loop: Header=BB17_5 Depth=1
	move	$a0, $s2
	move	$a1, $s1
	pcaddu18i	$ra, %call36(DFSAboveVCG)
...
.LBB17_15:                              # %if.else14
                                        #   in Loop: Header=BB17_5 Depth=1
	beqz	$a0, .LBB17_18
# %bb.16:                               # %for.body.i.i34.preheader
                                        #   in Loop: Header=BB17_5 Depth=1
	ori	$a0, $zero, 1
	move	$a1, $s7
	.p2align	4, , 16
.LBB17_17:                              # %for.body.i.i34
                                        #   Parent Loop BB17_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr0, $a1, -32
	vst	$vr0, $a1, 0
	...
	addi.d	$a1, $a1, 64
	bgeu	$a2, $a0, .LBB17_17
.LBB17_18:                              # %ExistPathAboveVCG.exit43
                                        #   in Loop: Header=BB17_5 Depth=1
	move	$a0, $s2
	move	$a1, $s4
	pcaddu18i	$ra, %call36(DFSAboveVCG)
...
# %bb.19:                               # %lor.lhs.false
	...
	vld	$vr0, $sp, 16                   # 16-byte Folded Reload
	beqz	$a0, .LBB17_22
# %bb.20:                               # %for.body.i.i45.preheader
                                        #   in Loop: Header=BB17_5 Depth=1
	ori	$a0, $zero, 1
	move	$a1, $s7
	.p2align	4, , 16
.LBB17_21:                              # %for.body.i.i45
                                        #   Parent Loop BB17_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vst	$vr0, $a1, -32
	vst	$vr0, $a1, 0
	...
	addi.d	$a1, $a1, 64
	bgeu	$a2, $a0, .LBB17_21
.LBB17_22:                              # %ExistPathAboveVCG.exit54
                                        #   in Loop: Header=BB17_5 Depth=1
	move	$a0, $s2
	move	$a1, $s1
	pcaddu18i	$ra, %call36(DFSAboveVCG)
