...
.LBB0_148:                              # %sw.bb290
	...
	pcalau12i	$a0, %pc_hi20(.L.str.17)
	addi.d	$a1, $a0, %pc_lo12(.L.str.17)
.LBB0_149:                              # %yystack.backedge
                                        #   in Loop: Header=BB0_1 Depth=1
	move	$a0, $fp
	pcaddu18i	$ra, %call36(sprintf)
	jirl	$ra, $ra, 0
	move	$a0, $fp
.LBB0_150:                              # %yystack.backedge
                                        #   in Loop: Header=BB0_1 Depth=1
	pcaddu18i	$ra, %call36(generate)
	jirl	$ra, $ra, 0
.LBB0_151:                              # %yystack.backedge
                                        #   in Loop: Header=BB0_1 Depth=1
	ori	$t4, $zero, 705
	ori	$t3, $zero, 3
	ld.d	$t2, $sp, 56                    # 8-byte Folded Reload
...
.LBB0_191:                              # %if.end447
	...
	pcalau12i	$a0, %got_pc_hi20(genstr)
	ld.d	$a0, $a0, %got_pc_lo12(genstr)
.LBB0_192:                              # %yystack.backedge
                                        #   in Loop: Header=BB0_1 Depth=1
	pcaddu18i	$ra, %call36(generate)
	jirl	$ra, $ra, 0
.LBB0_193:                              # %yystack.backedge
                                        #   in Loop: Header=BB0_1 Depth=1
	ld.d	$a5, $sp, 96                    # 8-byte Folded Reload
	ld.d	$a6, $sp, 88                    # 8-byte Folded Reload
	ld.d	$a7, $sp, 80                    # 8-byte Folded Reload
	ld.d	$t0, $sp, 72                    # 8-byte Folded Reload
.LBB0_194:                              # %yystack.backedge
                                        #   in Loop: Header=BB0_1 Depth=1
	ld.d	$t1, $sp, 64                    # 8-byte Folded Reload
	ld.d	$t2, $sp, 56                    # 8-byte Folded Reload
	ori	$t3, $zero, 3
