...
.LBB2_91:                               # %sw.bb73
	...
	ld.d	$a0, $a0, %got_pc_lo12(ex_stack)
	ld.d	$a0, $a0, 0
.LBB2_92:                               # %sw.epilog488
                                        #   in Loop: Header=BB2_5 Depth=1
	ld.d	$a0, $a0, 0
	pcaddu18i	$ra, %call36(push_copy)
	jirl	$ra, $ra, 0
	b	.LBB2_119
.LBB2_93:                               # %while.cond283.preheader
                                        #   in Loop: Header=BB2_5 Depth=1
	srai.d	$a1, $a2, 10
	addi.d	$a3, $a3, 2
	st.w	$a3, $s4, 4
...
# %bb.100:                              # %if.then329
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB2_121
.LBB2_101:                              # %land.rhs317
                                        #   in Loop: Header=BB2_5 Depth=1
	ld.d	$a0, $s0, 0
	ld.d	$a0, $a0, 0
	pcaddu18i	$ra, %call36(is_zero)
	jirl	$ra, $ra, 0
.LBB2_102:                              # %land.end323
                                        #   in Loop: Header=BB2_5 Depth=1
	sltui	$a0, $a0, 1
.LBB2_103:                              # %land.end323
                                        #   in Loop: Header=BB2_5 Depth=1
	pcalau12i	$a1, %got_pc_hi20(c_code)
...
.LBB2_124:                              # %sw.bb187
	...
	ori	$a4, $zero, 1
	bne	$a2, $a4, .LBB2_130
# %bb.125:                              # %land.lhs.true191
                                        #   in Loop: Header=BB2_5 Depth=1
	beqz	$a1, .LBB2_129
# %bb.126:                              # %land.lhs.true195
                                        #   in Loop: Header=BB2_5 Depth=1
	ld.bu	$a3, $a3, 16
	bnez	$a3, .LBB2_130
# %bb.127:                              # %if.then201
...
.LBB2_130:                              # %if.else205
	...
	jirl	$ra, $ra, 0
	b	.LBB2_119
.LBB2_131:                              # %while.cond490thread-pre-split
	beqz	$a0, .LBB2_134
# %bb.132:
	ori	$fp, $zero, 168
	.p2align	4, , 16
.LBB2_133:                              # %while.body493
	...
	st.w	$a0, $s4, 0
	bnez	$a0, .LBB2_133
.LBB2_134:                              # %while.cond504.preheader
	pcalau12i	$a0, %got_pc_hi20(ex_stack)
	ld.d	$fp, $a0, %got_pc_lo12(ex_stack)
	ld.d	$a0, $fp, 0
	beqz	$a0, .LBB2_136
	.p2align	4, , 16
.LBB2_135:                              # %while.body507
                                        # =>This Inner Loop Header: Depth=1
	pcaddu18i	$ra, %call36(pop)
	jirl	$ra, $ra, 0
	ld.d	$a0, $fp, 0
	bnez	$a0, .LBB2_135
.LBB2_136:                              # %while.end508
	ld.bu	$a0, $s3, 0
	beqz	$a0, .LBB2_139
# %bb.137:                              # %if.then510
