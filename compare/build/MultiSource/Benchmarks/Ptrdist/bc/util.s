...
# %bb.0:                                # %entry
	...
	st.d	$a5, $sp, 88
	st.d	$a4, $sp, 80
	pcalau12i	$a4, %got_pc_hi20(is_std_in)
	ld.d	$a4, $a4, %got_pc_lo12(is_std_in)
	st.d	$a3, $sp, 72
	st.d	$a2, $sp, 64
	st.d	$a1, $sp, 56
	ld.bu	$a1, $a4, 0
...
.LBB6_3:                                # %if.end
	...
	ld.d	$a1, $a0, %got_pc_lo12(line_no)
	ld.d	$a0, $s0, 0
	ld.w	$a3, $a1, 0
...
# %bb.0:                                # %entry
	...
	st.d	$a5, $sp, 88
	st.d	$a4, $sp, 80
	pcalau12i	$a4, %got_pc_hi20(std_only)
	ld.d	$a4, $a4, %got_pc_lo12(std_only)
	st.d	$a3, $sp, 72
	st.d	$a2, $sp, 64
	st.d	$a1, $sp, 56
	ld.bu	$a1, $a4, 0
...
# %bb.0:                                # %entry
	...
	pcalau12i	$a2, %got_pc_hi20(continue_label)
	ori	$a3, $zero, 1
	st.w	$a3, $a1, 0
	pcalau12i	$a1, %got_pc_hi20(compile_only)
	ld.d	$a1, $a1, %got_pc_lo12(compile_only)
	pcalau12i	$a3, %got_pc_hi20(out_count)
	ld.d	$a3, $a3, %got_pc_lo12(out_count)
	ld.d	$a2, $a2, %got_pc_lo12(continue_label)
	ld.bu	$a1, $a1, 0
	ori	$a4, $zero, 2
	st.w	$a4, $a3, 0
	st.w	$zero, $a0, 0
...
# %bb.0:                                # %entry
	pcalau12i	$a1, %got_pc_hi20(compile_only)
	ld.d	$a1, $a1, %got_pc_lo12(compile_only)
	pcalau12i	$a2, %got_pc_hi20(did_gen)
	ld.d	$a2, $a2, %got_pc_lo12(did_gen)
	ld.bu	$a1, $a1, 0
	ori	$a3, $zero, 1
	st.b	$a3, $a2, 0
	beqz	$a1, .LBB9_4
...
# %bb.0:                                # %entry
	...
	ori	$a1, $zero, 1
	pcalau12i	$a2, %got_pc_hi20(next_func)
	ld.d	$a2, $a2, %got_pc_lo12(next_func)
	pcalau12i	$a3, %got_pc_hi20(next_var)
	ld.d	$a3, $a3, %got_pc_lo12(next_var)
	st.w	$a1, $a0, 0
	st.w	$a1, $a2, 0
	ori	$a0, $zero, 4
	st.w	$a0, $a3, 0
...
.LBB15_16:                              # %if.end31
	...
	ld.w	$a0, $a1, 0
	pcalau12i	$a2, %got_pc_hi20(f_names)
	ld.d	$a2, $a2, %got_pc_lo12(f_names)
	addi.d	$a3, $a0, 1
	st.w	$a3, $a1, 0
	st.w	$a0, $fp, 12
	ld.d	$a1, $a2, 0
...
.LBB15_19:                              # %if.end51
	...
	pcalau12i	$a0, %got_pc_hi20(v_names)
	ld.d	$a2, $a0, %got_pc_lo12(v_names)
	ld.w	$a0, $a1, 0
	ld.d	$a2, $a2, 0
	addi.d	$a3, $a0, 1
	st.w	$a3, $a1, 0
...
.LBB15_23:                              # %if.end13
	...
	ld.w	$a0, $a1, 0
	pcalau12i	$a2, %got_pc_hi20(a_names)
	ld.d	$a2, $a2, %got_pc_lo12(a_names)
	addi.d	$a3, $a0, 1
	st.w	$a3, $a1, 0
	st.w	$a0, $fp, 8
	ld.d	$a1, $a2, 0
...
# %bb.0:                                # %entry
	...
	pcalau12i	$a1, %got_pc_hi20(pc)
	ld.d	$a1, $a1, %got_pc_lo12(pc)
