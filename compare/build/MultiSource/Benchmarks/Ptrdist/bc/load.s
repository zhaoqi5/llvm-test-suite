...
# %bb.45:                               #   in Loop: Header=BB4_3 Depth=1
	...
	move	$s0, $s1
	b	.LBB4_48
.LBB4_46:                               # %while.body.i656.preheader
                                        #   in Loop: Header=BB4_3 Depth=1
	move	$a1, $zero
	.p2align	4, , 16
.LBB4_47:                               # %while.body.i656
...
# %bb.63:                               #   in Loop: Header=BB4_3 Depth=1
	...
	move	$s0, $s1
	b	.LBB4_66
.LBB4_64:                               # %while.body.i184.preheader
                                        #   in Loop: Header=BB4_3 Depth=1
	move	$a1, $zero
	.p2align	4, , 16
.LBB4_65:                               # %while.body.i184
                                        #   Parent Loop BB4_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.b	$a2, $s1, 1
	slli.d	$a3, $a1, 3
...
# %bb.116:                              #   in Loop: Header=BB4_3 Depth=1
	move	$a1, $zero
	b	.LBB4_119
.LBB4_117:                              # %while.body.i371.preheader
                                        #   in Loop: Header=BB4_3 Depth=1
	move	$a1, $zero
	move	$a2, $s1
	.p2align	4, , 16
.LBB4_118:                              # %while.body.i371
                                        #   Parent Loop BB4_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.b	$a3, $a2, 1
	slli.d	$a4, $a1, 3
...
# %bb.123:                              # %if.then1.i445
	...
	jirl	$ra, $ra, 0
	b	.LBB4_172
.LBB4_124:                              #   in Loop: Header=BB4_3 Depth=1
	addi.d	$fp, $s0, 1
	move	$s5, $s4
.LBB4_125:                              # %if.end.i261
                                        #   in Loop: Header=BB4_3 Depth=1
	pcaddu18i	$ra, %call36(__ctype_b_loc)
	jirl	$ra, $ra, 0
	move	$s1, $a0
...
# %bb.126:                              #   in Loop: Header=BB4_3 Depth=1
	move	$a1, $zero
	b	.LBB4_129
.LBB4_127:                              # %while.body.i267.preheader
                                        #   in Loop: Header=BB4_3 Depth=1
	move	$a1, $zero
	move	$a2, $fp
	.p2align	4, , 16
.LBB4_128:                              # %while.body.i267
                                        #   Parent Loop BB4_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.b	$a3, $a2, 1
	slli.d	$a4, $a1, 3
...
.LBB4_136:                              # %if.end.i286
	...
	slli.d	$a3, $a3, 52
	bgez	$a3, .LBB4_131
# %bb.137:                              # %while.body.i292.preheader
                                        #   in Loop: Header=BB4_133 Depth=2
	move	$a3, $zero
	move	$a4, $s0
	.p2align	4, , 16
.LBB4_138:                              # %while.body.i292
                                        #   Parent Loop BB4_3 Depth=1
	...
	bltz	$a6, .LBB4_138
	b	.LBB4_132
.LBB4_139:                              #   in Loop: Header=BB4_3 Depth=1
	addi.d	$s0, $s0, 1
.LBB4_140:                              # %if.end.i131
                                        #   in Loop: Header=BB4_3 Depth=1
	pcaddu18i	$ra, %call36(__ctype_b_loc)
	jirl	$ra, $ra, 0
	ld.d	$a0, $a0, 0
	...
	slli.d	$a1, $a1, 52
	bgez	$a1, .LBB4_143
# %bb.141:                              # %while.body.i.preheader
                                        #   in Loop: Header=BB4_3 Depth=1
	move	$a1, $s0
	.p2align	4, , 16
.LBB4_142:                              # %while.body.i
                                        #   Parent Loop BB4_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.b	$a2, $a1, 1
	slli.d	$a3, $s1, 3
...
.LBB4_145:                              # %if.end.i142
	...
	srai.d	$a0, $fp, 6
	blez	$a0, .LBB4_153
# %bb.146:                              # %while.body.i144.preheader
                                        #   in Loop: Header=BB4_3 Depth=1
	addi.d	$s1, $a0, 1
	ori	$s5, $zero, 1
	b	.LBB4_148
	.p2align	4, , 16
.LBB4_147:                              # %if.end22.i
                                        #   in Loop: Header=BB4_148 Depth=2
	addi.w	$s1, $s1, -1
	move	$s4, $a0
	bge	$s5, $s1, .LBB4_154
.LBB4_148:                              # %while.body.i144
                                        #   Parent Loop BB4_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a0, $s4, 512
	bnez	$a0, .LBB4_147
...
.LBB4_156:                              # %if.then76
	...
	b	.LBB4_159
	.p2align	4, , 16
.LBB4_157:                              #   in Loop: Header=BB4_159 Depth=2
	move	$a3, $zero
.LBB4_158:                              # %long_val.exit334
...
.LBB4_163:                              # %if.then95
	...
	ori	$a1, $zero, 45
	beq	$a0, $a1, .LBB4_162
.LBB4_164:                              #   in Loop: Header=BB4_159 Depth=2
	move	$a1, $a0
.LBB4_165:                              # %if.end.i311
                                        #   in Loop: Header=BB4_159 Depth=2
	ld.d	$a2, $s1, 0
	ext.w.b	$a3, $a1
	slli.d	$a3, $a3, 1
	...
	slli.d	$a3, $a3, 52
	bgez	$a3, .LBB4_157
# %bb.166:                              # %while.body.i317.preheader
                                        #   in Loop: Header=BB4_159 Depth=2
	move	$a3, $zero
	move	$a4, $s0
	.p2align	4, , 16
.LBB4_167:                              # %while.body.i317
                                        #   Parent Loop BB4_3 Depth=1
                                        #     Parent Loop BB4_159 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.b	$a5, $a4, 1
	slli.d	$a6, $a3, 3
	alsl.d	$a3, $a3, $a6, 1
...
.LBB4_171:                              # %if.end12.i431
	...
	addi.d	$a1, $a1, 1
	st.w	$a1, $a0, 136
.LBB4_172:                              # %addbyte.exit446
                                        #   in Loop: Header=BB4_3 Depth=1
	ld.w	$a0, $s2, 0
	bnez	$a0, .LBB4_178
.LBB4_173:                              # %if.end.i390
                                        #   in Loop: Header=BB4_3 Depth=1
	ld.w	$fp, $s6, 4
	srai.d	$s5, $fp, 10
	addi.d	$a0, $fp, 1
...
.LBB4_178:                              # %if.end128
	...
	add.d	$s0, $s1, $a0
	b	.LBB4_181
.LBB4_179:                              # %if.then1.i503
                                        #   in Loop: Header=BB4_181 Depth=2
	pcalau12i	$a0, %pc_hi20(.L.str)
	addi.d	$a0, $a0, %pc_lo12(.L.str)
	pcaddu18i	$ra, %call36(yyerror)
	jirl	$ra, $ra, 0
	.p2align	4, , 16
.LBB4_180:                              # %addbyte.exit504
                                        #   in Loop: Header=BB4_181 Depth=2
	addi.d	$s0, $s0, 1
	ld.bu	$fp, $s0, 0
.LBB4_181:                              # %if.end128
...
.LBB4_186:                              # %if.end12.i489
	...
	st.w	$a1, $a0, 136
	b	.LBB4_180
.LBB4_187:                              # %while.end142
                                        #   in Loop: Header=BB4_3 Depth=1
	ld.w	$a0, $s2, 0
	beqz	$a0, .LBB4_190
.LBB4_188:                              # %sw.epilog171
                                        #   in Loop: Header=BB4_3 Depth=1
	addi.d	$s5, $s0, 1
	ld.bu	$s1, $s5, 0
	beqz	$s1, .LBB4_194
