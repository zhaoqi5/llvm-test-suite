...
# %bb.44:                               #   in Loop: Header=BB4_3 Depth=1
	...
	move	$s0, $s4
	b	.LBB4_47
.LBB4_45:                               # %while.body.i656.preheader
                                        #   in Loop: Header=BB4_3 Depth=1
	move	$a1, $zero
	move	$s0, $s4
	.p2align	4, , 16
.LBB4_46:                               # %while.body.i656
...
# %bb.62:                               #   in Loop: Header=BB4_3 Depth=1
	...
	move	$s0, $s4
	b	.LBB4_65
.LBB4_63:                               # %while.body.i184.preheader
                                        #   in Loop: Header=BB4_3 Depth=1
	move	$a1, $zero
	move	$s0, $s4
	.p2align	4, , 16
.LBB4_64:                               # %while.body.i184
                                        #   Parent Loop BB4_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.b	$a2, $s0, 1
	slli.d	$a3, $a1, 3
...
# %bb.76:                               # %if.then1.i788
                                        #   in Loop: Header=BB4_3 Depth=1
	ld.d	$a0, $sp, 32                    # 8-byte Folded Reload
.LBB4_77:                               # %sw.epilog171
                                        #   in Loop: Header=BB4_3 Depth=1
	pcaddu18i	$ra, %call36(yyerror)
	jirl	$ra, $ra, 0
	b	.LBB4_190
.LBB4_78:                               # %if.end2.i767
                                        #   in Loop: Header=BB4_3 Depth=1
	ld.w	$a0, $s6, 0
	ld.d	$a1, $s8, 0
	ori	$a2, $zero, 168
...
# %bb.114:                              #   in Loop: Header=BB4_3 Depth=1
	move	$a1, $zero
	b	.LBB4_117
.LBB4_115:                              # %while.body.i371.preheader
                                        #   in Loop: Header=BB4_3 Depth=1
	move	$a1, $zero
	.p2align	4, , 16
.LBB4_116:                              # %while.body.i371
                                        #   Parent Loop BB4_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.b	$a2, $s1, 1
	slli.d	$a3, $a1, 3
...
# %bb.124:                              #   in Loop: Header=BB4_3 Depth=1
	move	$a1, $zero
	b	.LBB4_127
.LBB4_125:                              # %while.body.i267.preheader
                                        #   in Loop: Header=BB4_3 Depth=1
	move	$a1, $zero
	.p2align	4, , 16
.LBB4_126:                              # %while.body.i267
                                        #   Parent Loop BB4_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.b	$a2, $fp, 1
	slli.d	$a3, $a1, 3
...
.LBB4_134:                              # %if.end.i286
	...
	slli.d	$a3, $a3, 52
	bgez	$a3, .LBB4_129
# %bb.135:                              # %while.body.i292.preheader
                                        #   in Loop: Header=BB4_131 Depth=2
	move	$a3, $zero
	.p2align	4, , 16
.LBB4_136:                              # %while.body.i292
                                        #   Parent Loop BB4_3 Depth=1
...
.LBB4_142:                              # %if.end.i142
	...
	srai.d	$a0, $fp, 6
	blez	$a0, .LBB4_151
# %bb.143:                              # %while.body.i144.preheader
                                        #   in Loop: Header=BB4_3 Depth=1
	addi.d	$s1, $a0, 1
	ori	$s5, $zero, 1
	b	.LBB4_145
...
.LBB4_163:                              # %if.end.i311
	...
	slli.d	$a3, $a3, 52
	bgez	$a3, .LBB4_155
# %bb.164:                              # %while.body.i317.preheader
                                        #   in Loop: Header=BB4_157 Depth=2
	move	$a3, $zero
	.p2align	4, , 16
.LBB4_165:                              # %while.body.i317
                                        #   Parent Loop BB4_3 Depth=1
...
.LBB4_169:                              # %if.end12.i431
	...
	st.w	$a1, $a0, 136
	ori	$s7, $zero, 16
.LBB4_170:                              # %addbyte.exit446
                                        #   in Loop: Header=BB4_3 Depth=1
	ld.w	$a0, $s2, 0
	bnez	$a0, .LBB4_176
.LBB4_171:                              # %if.end.i390
                                        #   in Loop: Header=BB4_3 Depth=1
	ld.w	$fp, $s6, 4
	srai.d	$s5, $fp, 10
	addi.d	$a0, $fp, 1
