...
.LBB21_40:                              # %iter.check378
	...
	bltu	$fp, $a1, .LBB21_43
# %bb.41:                               # %vector.memcheck368
	bgeu	$a0, $s0, .LBB21_125
# %bb.42:                               # %vector.memcheck368
	addi.d	$a1, $fp, -1
	bstrpick.d	$a1, $a1, 31, 0
	ld.d	$a2, $sp, 96                    # 8-byte Folded Reload
	add.d	$a2, $a2, $a1
...
.LBB21_95:                              # %if.then7.i196
	...
	ori	$a1, $zero, 16
	bltu	$s2, $a1, .LBB21_98
.LBB21_96:                              # %vector.memcheck419
                                        #   in Loop: Header=BB21_81 Depth=1
	bgeu	$a0, $s5, .LBB21_110
# %bb.97:                               # %vector.memcheck419
                                        #   in Loop: Header=BB21_81 Depth=1
	addi.d	$a1, $s2, -1
	bstrpick.d	$a1, $a1, 31, 0
	add.d	$a2, $a7, $a1
...
.LBB21_109:                             # %out_long.exit228
	...
	b	.LBB21_80
	.p2align	4, , 16
.LBB21_110:                             # %vector.main.loop.iter.check433
                                        #   in Loop: Header=BB21_81 Depth=1
...
.LBB21_112:                             # %vec.epilog.ph448
	...
	.p2align	4, , 16
.LBB21_113:                             # %vec.epilog.vector.body455
                                        #   Parent Loop BB21_81 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a6, 0
	...
	addi.d	$a2, $a2, 16
	bnez	$a5, .LBB21_113
# %bb.114:                              # %vec.epilog.middle.block463
                                        #   in Loop: Header=BB21_81 Depth=1
	bne	$a4, $a1, .LBB21_99
	b	.LBB21_101
.LBB21_115:                             # %vector.ph434
                                        #   in Loop: Header=BB21_81 Depth=1
...
.LBB21_116:                             # %vector.body437
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB21_116
# %bb.117:                              # %middle.block444
                                        #   in Loop: Header=BB21_81 Depth=1
	beq	$a2, $a1, .LBB21_101
# %bb.118:                              # %vec.epilog.iter.check449
                                        #   in Loop: Header=BB21_81 Depth=1
	andi	$a3, $a1, 16
	bnez	$a3, .LBB21_112
...
# %bb.124:                              # %vec.epilog.middle.block
	bne	$a4, $a1, .LBB21_31
	b	.LBB21_33
.LBB21_125:                             # %vector.main.loop.iter.check380
	ori	$a2, $zero, 32
	bstrpick.d	$a1, $fp, 31, 0
	bgeu	$fp, $a2, .LBB21_145
# %bb.126:
	move	$a2, $zero
.LBB21_127:                             # %vec.epilog.ph395
	bstrpick.d	$a3, $a1, 31, 4
	slli.d	$a4, $a3, 4
	sub.d	$fp, $fp, $a4
	alsl.d	$a0, $a3, $a0, 4
	...
	addi.d	$a2, $a2, 16
	.p2align	4, , 16
.LBB21_128:                             # %vec.epilog.vector.body402
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a6, 0
	vshuf.b	$vr1, $vr0, $vr1, $vr0
	vst	$vr1, $a2, 0
	...
	addi.d	$a2, $a2, 16
	bnez	$a5, .LBB21_128
# %bb.129:                              # %vec.epilog.middle.block410
	bne	$a4, $a1, .LBB21_44
	b	.LBB21_46
...
.LBB21_146:                             # %vector.body384
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB21_146
# %bb.147:                              # %middle.block391
	beq	$a2, $a1, .LBB21_46
# %bb.148:                              # %vec.epilog.iter.check396
	andi	$a3, $a1, 16
	bnez	$a3, .LBB21_127
# %bb.149:
	sub.d	$fp, $fp, $a2
