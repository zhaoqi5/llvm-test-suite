...
.LBB21_95:                              # %if.then7.i196
	...
	ori	$a1, $zero, 16
	bltu	$s2, $a1, .LBB21_98
.LBB21_96:                              # %vector.memcheck433
                                        #   in Loop: Header=BB21_81 Depth=1
	bgeu	$a0, $s5, .LBB21_110
# %bb.97:                               # %vector.memcheck433
                                        #   in Loop: Header=BB21_81 Depth=1
	addi.d	$a1, $s2, -1
	bstrpick.d	$a1, $a1, 31, 0
	add.d	$a2, $a7, $a1
...
.LBB21_109:                             # %out_long.exit228
	...
	b	.LBB21_80
	.p2align	4, , 16
.LBB21_110:                             # %vector.main.loop.iter.check447
                                        #   in Loop: Header=BB21_81 Depth=1
...
.LBB21_112:                             # %vec.epilog.ph462
	...
	.p2align	4, , 16
.LBB21_113:                             # %vec.epilog.vector.body469
                                        #   Parent Loop BB21_81 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a6, 0
	...
	addi.d	$a2, $a2, 16
	bnez	$a5, .LBB21_113
# %bb.114:                              # %vec.epilog.middle.block477
                                        #   in Loop: Header=BB21_81 Depth=1
	bne	$a4, $a1, .LBB21_99
	b	.LBB21_101
.LBB21_115:                             # %vector.ph448
                                        #   in Loop: Header=BB21_81 Depth=1
...
.LBB21_116:                             # %vector.body451
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB21_116
# %bb.117:                              # %middle.block458
                                        #   in Loop: Header=BB21_81 Depth=1
	beq	$a2, $a1, .LBB21_101
# %bb.118:                              # %vec.epilog.iter.check463
                                        #   in Loop: Header=BB21_81 Depth=1
	andi	$a3, $a1, 16
	bnez	$a3, .LBB21_112
...
.LBB21_127:                             # %vec.epilog.ph409
	...
	addi.d	$a2, $a2, 16
	.p2align	4, , 16
.LBB21_128:                             # %vec.epilog.vector.body416
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a6, 0
	vshuf.b	$vr1, $vr0, $vr1, $vr0
	vst	$vr1, $a2, 0
	...
	addi.d	$a2, $a2, 16
	bnez	$a5, .LBB21_128
# %bb.129:                              # %vec.epilog.middle.block424
	bne	$a4, $a1, .LBB21_44
	b	.LBB21_46
...
# %bb.147:                              # %middle.block405
	beq	$a2, $a1, .LBB21_46
# %bb.148:                              # %vec.epilog.iter.check410
	andi	$a3, $a1, 16
	bnez	$a3, .LBB21_127
# %bb.149:
	sub.d	$fp, $fp, $a2
