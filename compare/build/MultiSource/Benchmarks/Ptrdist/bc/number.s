...
# %bb.10:                               # %for.end94
	sub.w	$a4, $t5, $t6
	blez	$a4, .LBB13_13
# %bb.11:                               # %for.body102.preheader
	addi.d	$a4, $a4, 1
	ori	$a5, $zero, 1
	.p2align	4, , 16
.LBB13_12:                              # %for.body102
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a6, $a1, 0
	addi.d	$a1, $a1, -1
	sub.w	$a2, $a6, $a2
...
.LBB13_22:
	move	$a4, $a3
	move	$a6, $a2
.LBB13_23:                              # %while.body10.i.preheader
	addi.d	$a2, $a6, 1
	ori	$a3, $zero, 1
	.p2align	4, , 16
.LBB13_24:                              # %while.body10.i
                                        # =>This Inner Loop Header: Depth=1
	ld.b	$a5, $a4, 0
	addi.d	$a4, $a4, 1
	addi.d	$a6, $a1, 1
	...
	move	$a1, $a6
	bltu	$a3, $a2, .LBB13_24
.LBB13_25:                              # %_rm_leading_zeros.exit
	...
	addi.d	$sp, $sp, 112
	ret
.LBB13_26:                              # %vector.main.loop.iter.check
	bgeu	$a2, $a4, .LBB13_28
# %bb.27:
	move	$a5, $zero
	b	.LBB13_32
...
.LBB13_32:                              # %vec.epilog.ph
	...
	add.d	$a3, $a3, $a5
	.p2align	4, , 16
.LBB13_33:                              # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a3, 0
	vst	$vr0, $t1, 0
	addi.d	$t0, $t0, 16
...
.LBB15_22:                              # %vector.ph162
	...
	or	$t4, $t4, $t5
	addi.d	$t4, $t4, 1
	bstrpick.d	$t4, $t4, 32, 3
	slli.d	$t4, $t4, 3
	addi.d	$s8, $fp, 1
	bstrpick.d	$t5, $s8, 32, 3
	slli.d	$fp, $t5, 3
	sub.d	$s6, $s6, $fp
	xvori.b	$xr1, $xr0, 0
	xvinsgr2vr.d	$xr1, $a5, 0
...
.LBB21_112:                             # %vec.epilog.ph463
	...
	addi.d	$a2, $a2, 16
	.p2align	4, , 16
.LBB21_113:                             # %vec.epilog.vector.body467
                                        #   Parent Loop BB21_81 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a6, 0
	vshuf4i.w	$vr0, $vr0, 27
	...
	addi.d	$a2, $a2, 16
	bnez	$a5, .LBB21_113
# %bb.114:                              # %vec.epilog.middle.block475
                                        #   in Loop: Header=BB21_81 Depth=1
	bne	$a4, $a1, .LBB21_99
	b	.LBB21_101
.LBB21_115:                             # %vector.ph447
                                        #   in Loop: Header=BB21_81 Depth=1
	andi	$a3, $a1, 16
...
.LBB21_116:                             # %vector.body450
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB21_116
# %bb.117:                              # %middle.block457
                                        #   in Loop: Header=BB21_81 Depth=1
	beq	$a2, $a1, .LBB21_101
# %bb.118:                              # %vec.epilog.iter.check461
                                        #   in Loop: Header=BB21_81 Depth=1
	bnez	$a3, .LBB21_112
...
# %bb.124:                              # %vec.epilog.middle.block
	bne	$a4, $a1, .LBB21_31
	b	.LBB21_33
.LBB21_125:                             # %vector.main.loop.iter.check394
	ori	$a2, $zero, 32
	bstrpick.d	$a1, $fp, 31, 0
	bgeu	$fp, $a2, .LBB21_145
# %bb.126:
	move	$a2, $zero
.LBB21_127:                             # %vec.epilog.ph411
	bstrpick.d	$a3, $a1, 31, 4
	slli.d	$a4, $a3, 4
	sub.d	$fp, $fp, $a4
	alsl.d	$a0, $a3, $a0, 4
	...
	addi.d	$a2, $a2, 16
	.p2align	4, , 16
.LBB21_128:                             # %vec.epilog.vector.body415
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a6, 0
	vshuf4i.w	$vr0, $vr0, 27
	vshuf4i.b	$vr0, $vr0, 27
	...
	addi.d	$a2, $a2, 16
	bnez	$a5, .LBB21_128
# %bb.129:                              # %vec.epilog.middle.block423
	bne	$a4, $a1, .LBB21_44
	b	.LBB21_46
.LBB21_130:                             # %if.then3.i256
	ld.d	$s8, $sp, 168                   # 8-byte Folded Reload
	ld.d	$s7, $sp, 176                   # 8-byte Folded Reload
	ld.d	$s6, $sp, 184                   # 8-byte Folded Reload
	ld.d	$s5, $sp, 192                   # 8-byte Folded Reload
...
.LBB21_135:                             # %for.cond.preheader.i
                                        #   in Loop: Header=BB21_133 Depth=1
	blez	$s1, .LBB21_132
# %bb.136:                              # %for.body.preheader.i136
                                        #   in Loop: Header=BB21_133 Depth=1
	bstrpick.d	$s0, $s7, 30, 0
	addi.d	$s1, $sp, 128
	.p2align	4, , 16
.LBB21_137:                             # %for.body.i137
                                        #   Parent Loop BB21_133 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.b	$a0, $s1, 0
	ld.d	$a1, $sp, 88                    # 8-byte Folded Reload
...
.LBB21_146:                             # %vector.body398
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB21_146
# %bb.147:                              # %middle.block405
	beq	$a2, $a1, .LBB21_46
# %bb.148:                              # %vec.epilog.iter.check409
	bnez	$a3, .LBB21_127
# %bb.149:
	sub.d	$fp, $fp, $a2
	add.d	$a0, $a0, $a2
