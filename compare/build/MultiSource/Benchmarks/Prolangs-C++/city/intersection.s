...
# %bb.0:                                # %entry
	...
	move	$s0, $a2
	move	$a0, $a1
	pcalau12i	$a1, %got_pc_hi20(_Z11green_lightP20intersection_roadletP7vehicle9direction)
	ld.d	$a4, $a1, %got_pc_lo12(_Z11green_lightP20intersection_roadletP7vehicle9direction)
	move	$a1, $a5
	move	$a2, $a6
...
# %bb.0:                                # %entry
	...
	move	$s0, $a2
	move	$a2, $a1
	pcalau12i	$a1, %got_pc_hi20(_Z6straitP7roadletP7vehicle9direction)
	ld.d	$a4, $a1, %got_pc_lo12(_Z6straitP7roadletP7vehicle9direction)
	move	$a1, $a5
	pcaddu18i	$ra, %call36(_Z7connectP7roadlet9directionS0_S1_PFS0_S0_P7vehicleS1_E)
	jirl	$ra, $ra, 0
	ld.d	$a0, $fp, 32
