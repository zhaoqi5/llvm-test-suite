...
# %bb.2:                                # %invoke.cont3
	...
	ld.w	$a1, $a2, 0
	alsl.d	$a0, $a0, $fp, 3
	pcalau12i	$a2, %got_pc_hi20(_Z11return_nullP7roadletP7vehicle9direction)
	ld.d	$a2, $a2, %got_pc_lo12(_Z11return_nullP7roadletP7vehicle9direction)
	st.d	$s0, $a0, 16
	alsl.d	$a1, $a1, $s0, 3
	st.d	$fp, $a1, 16
	...
	ld.d	$s8, $a0, %got_pc_lo12(_Z14lane_switch_okP7roadletP7vehicle9direction)
	pcalau12i	$a0, %got_pc_hi20(NE)
	ld.d	$a0, $a0, %got_pc_lo12(NE)
	st.d	$a0, $sp, 24                    # 8-byte Folded Spill
	pcalau12i	$a0, %got_pc_hi20(SW)
	ld.d	$s4, $a0, %got_pc_lo12(SW)
...
.LBB2_17:                               # %if.end.i125
	...
	pcaddu18i	$ra, %call36(_ZNSo3putEc)
	jirl	$ra, $ra, 0
.LBB2_18:                               # %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c.exit127
	addi.d	$a0, $sp, 248
	move	$a1, $s0
	move	$a2, $fp
