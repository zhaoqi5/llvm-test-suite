...
# %bb.5:                                # %invoke.cont10
	ld.d	$a0, $sp, 40
	pcalau12i	$a1, %pc_hi20(_ZTV10GrandChild+16)
	addi.d	$a1, $a1, %pc_lo12(_ZTV10GrandChild+16)
	st.d	$a1, $sp, 16
	beqz	$a0, .LBB0_7
...
.LBB0_9:                                # %delete.end.i.i
	ld.d	$a0, $sp, 24
	pcalau12i	$a1, %pc_hi20(_ZTV6Parent+16)
	addi.d	$s1, $a1, %pc_lo12(_ZTV6Parent+16)
	st.d	$s1, $sp, 16
	beqz	$a0, .LBB0_11
...
.LBB2_2:                                # %delete.end
	ld.d	$a0, $fp, 16
	pcalau12i	$a1, %pc_hi20(_ZTV5Child+16)
	addi.d	$a1, $a1, %pc_lo12(_ZTV5Child+16)
	st.d	$a1, $fp, 0
	beqz	$a0, .LBB2_4
...
.LBB2_4:                                # %delete.end.i
	ld.d	$a0, $fp, 8
	pcalau12i	$a1, %pc_hi20(_ZTV6Parent+16)
	addi.d	$a1, $a1, %pc_lo12(_ZTV6Parent+16)
	st.d	$a1, $fp, 0
	beqz	$a0, .LBB2_6
