...
# %bb.0:                                # %entry
	...
	addi.d	$a2, $a0, %pc_lo12(_ZTV7Vehicle+16)
	ld.d	$a0, $a1, 8
	st.d	$a2, $a1, 0
	beqz	$a0, .LBB5_2
# %bb.1:                                # %delete.notnull
...
.LBB6_2:
	addi.d	$a0, $fp, 8
.LBB6_3:                                # %for.body.lr.ph.i42
	pcalau12i	$a1, %pc_hi20(t1)
	addi.d	$a1, $a1, %pc_lo12(t1)
	ld.d	$a2, $fp, 0
	st.d	$a1, $a0, 0
	beqz	$a2, .LBB6_7
# %bb.4:                                # %for.inc.i49
...
# %bb.38:                               # %for.inc.i90.9
	ld.d	$a1, $fp, 80
	beqz	$a1, .LBB6_53
# %bb.39:                               # %for.inc.i90.10
	ld.d	$a1, $fp, 88
	beqz	$a1, .LBB6_54
# %bb.40:                               # %for.inc.i90.11
	ld.d	$a1, $fp, 96
	beqz	$a1, .LBB6_55
# %bb.41:                               # %for.inc.i90.12
	ld.d	$a1, $fp, 104
	beqz	$a1, .LBB6_56
# %bb.42:                               # %for.inc.i90.13
	ld.d	$a1, $fp, 112
	bnez	$a1, .LBB6_58
# %bb.43:
	addi.d	$a1, $fp, 112
...
.LBB6_57:                               # %for.body.lr.ph.i96
	...
	move	$a1, $fp
	beqz	$a2, .LBB6_86
.LBB6_58:                               # %for.inc.i103
	ld.d	$a1, $fp, 8
	beqz	$a1, .LBB6_73
# %bb.59:                               # %for.inc.i103.1
	ld.d	$a1, $fp, 16
	beqz	$a1, .LBB6_74
# %bb.60:                               # %for.inc.i103.2
	ld.d	$a1, $fp, 24
	beqz	$a1, .LBB6_75
# %bb.61:                               # %for.inc.i103.3
	ld.d	$a1, $fp, 32
	beqz	$a1, .LBB6_76
# %bb.62:                               # %for.inc.i103.4
	ld.d	$a1, $fp, 40
	beqz	$a1, .LBB6_77
# %bb.63:                               # %for.inc.i103.5
	ld.d	$a1, $fp, 48
	beqz	$a1, .LBB6_78
# %bb.64:                               # %for.inc.i103.6
	ld.d	$a1, $fp, 56
	beqz	$a1, .LBB6_79
# %bb.65:                               # %for.inc.i103.7
	ld.d	$a1, $fp, 64
	beqz	$a1, .LBB6_80
# %bb.66:                               # %for.inc.i103.8
	ld.d	$a1, $fp, 72
	beqz	$a1, .LBB6_81
# %bb.67:                               # %for.inc.i103.9
	ld.d	$a1, $fp, 80
	beqz	$a1, .LBB6_82
# %bb.68:                               # %for.inc.i103.10
	ld.d	$a1, $fp, 88
	beqz	$a1, .LBB6_83
# %bb.69:                               # %for.inc.i103.11
	ld.d	$a1, $fp, 96
	beqz	$a1, .LBB6_84
# %bb.70:                               # %for.inc.i103.12
	ld.d	$a1, $fp, 104
	beqz	$a1, .LBB6_85
# %bb.71:                               # %for.inc.i103.13
	ld.d	$a1, $fp, 112
	bnez	$a1, .LBB6_87
# %bb.72:
	addi.d	$a1, $fp, 112
...
.LBB6_85:
	addi.d	$a1, $fp, 104
.LBB6_86:                               # %cleanup.i106
	pcalau12i	$a2, %pc_hi20(t3)
	addi.d	$a2, $a2, %pc_lo12(t3)
	st.d	$a2, $a1, 0
.LBB6_87:                               # %for.body.lr.ph.i118
	slli.d	$a0, $a0, 3
	stx.d	$zero, $fp, $a0
	ld.d	$a1, $fp, 0
	move	$a0, $fp
...
# %bb.88:                               # %for.inc.i125
	ld.d	$a0, $fp, 8
	beqz	$a0, .LBB6_103
# %bb.89:                               # %for.inc.i125.1
	ld.d	$a0, $fp, 16
	beqz	$a0, .LBB6_104
# %bb.90:                               # %for.inc.i125.2
	ld.d	$a0, $fp, 24
	beqz	$a0, .LBB6_105
# %bb.91:                               # %for.inc.i125.3
	ld.d	$a0, $fp, 32
	beqz	$a0, .LBB6_106
# %bb.92:                               # %for.inc.i125.4
	ld.d	$a0, $fp, 40
	beqz	$a0, .LBB6_107
# %bb.93:                               # %for.inc.i125.5
	ld.d	$a0, $fp, 48
	beqz	$a0, .LBB6_108
# %bb.94:                               # %for.inc.i125.6
	ld.d	$a0, $fp, 56
	beqz	$a0, .LBB6_109
# %bb.95:                               # %for.inc.i125.7
	ld.d	$a0, $fp, 64
	beqz	$a0, .LBB6_110
# %bb.96:                               # %for.inc.i125.8
	ld.d	$a0, $fp, 72
	beqz	$a0, .LBB6_111
# %bb.97:                               # %for.inc.i125.9
	ld.d	$a0, $fp, 80
	beqz	$a0, .LBB6_112
# %bb.98:                               # %for.inc.i125.10
	ld.d	$a0, $fp, 88
	beqz	$a0, .LBB6_113
# %bb.99:                               # %for.inc.i125.11
	ld.d	$a0, $fp, 96
	beqz	$a0, .LBB6_114
# %bb.100:                              # %for.inc.i125.12
	ld.d	$a0, $fp, 104
	beqz	$a0, .LBB6_115
# %bb.101:                              # %for.inc.i125.13
	ld.d	$a0, $fp, 112
	bnez	$a0, .LBB6_117
# %bb.102:
	addi.d	$a0, $fp, 112
...
.LBB6_146:                              # %for.inc.i137.14
	...
	addi.d	$sp, $sp, 32
	ret
.LBB6_147:                              # %_ZN6GarageD2Ev.exit144
.Ltmp30:                                # EH_LABEL
	move	$s0, $a0
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_ZdaPv)
