...
# %bb.0:                                # %entry
	move	$a1, $a0
	ld.d	$a0, $a0, 16
	pcalau12i	$a2, %pc_hi20(_ZTV8RealNode+16)
	addi.d	$a2, $a2, %pc_lo12(_ZTV8RealNode+16)
	st.d	$a2, $a1, 0
	beqz	$a0, .LBB18_2
# %bb.1:                                # %delete.notnull
	ori	$a1, $zero, 1
...
# %bb.0:                                # %entry
	...
	move	$fp, $a0
	ld.d	$a0, $a0, 16
	pcalau12i	$a1, %pc_hi20(_ZTV9UnaryNode+16)
	addi.d	$a1, $a1, %pc_lo12(_ZTV9UnaryNode+16)
	st.d	$a1, $fp, 0
	beqz	$a0, .LBB20_2
# %bb.1:                                # %delete.notnull
	ori	$a1, $zero, 1
...
# %bb.0:                                # %entry
	...
	move	$fp, $a0
	ld.d	$a0, $a0, 16
	pcalau12i	$a1, %pc_hi20(_ZTV10BinaryNode+16)
	addi.d	$a1, $a1, %pc_lo12(_ZTV10BinaryNode+16)
	st.d	$a1, $fp, 0
	beqz	$a0, .LBB22_2
# %bb.1:                                # %delete.notnull
	ori	$a1, $zero, 1
