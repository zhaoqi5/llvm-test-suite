...
.LBB8_4:                                # %for.cond.cleanup.i.i
	...
	jirl	$ra, $ra, 0
	beqz	$s1, .LBB8_7
# %bb.5:                                # %for.body13.i.i.preheader
	addi.d	$a0, $s2, 12
	.p2align	4, , 16
.LBB8_6:                                # %for.body13.i.i
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a1, $a0, -8
	slli.d	$a1, $a1, 10
	add.d	$a1, $fp, $a1
