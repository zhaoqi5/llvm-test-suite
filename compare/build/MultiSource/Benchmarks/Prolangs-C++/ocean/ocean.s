...
# %bb.2:                                # %for.cond2.preheader.us.preheader
	...
	pcalau12i	$a0, %pc_hi20(_ZTV4Cell+16)
	addi.d	$s3, $a0, %pc_lo12(_ZTV4Cell+16)
	move	$s4, $zero
	ori	$s5, $zero, 45
	lu12i.w	$a0, 1
	ori	$s6, $a0, 3904
...
# %bb.1:                                # %for.body.lr.ph
	...
	addi.d	$s6, $a0, %pc_lo12(_ZTV8Obstacle+16)
	move	$s7, $zero
	.p2align	4, , 16
.LBB21_2:                               # %do.body.i
...
# %bb.1:                                # %for.body.lr.ph
	...
	st.d	$a0, $sp, 16                    # 8-byte Folded Spill
	pcalau12i	$a0, %pc_hi20(_ZTV4Prey+16)
	addi.d	$s6, $a0, %pc_lo12(_ZTV4Prey+16)
	move	$s7, $zero
	.p2align	4, , 16
.LBB23_2:                               # %do.body.i
                                        # =>This Inner Loop Header: Depth=1
...
# %bb.0:                                # %entry
	move	$a1, $a0
	pcalau12i	$a0, %pc_hi20(_ZTV4Cell+16)
	addi.d	$a2, $a0, %pc_lo12(_ZTV4Cell+16)
	ld.d	$a0, $a1, 8
	st.d	$a2, $a1, 0
	beqz	$a0, .LBB33_2
# %bb.1:                                # %delete.notnull
