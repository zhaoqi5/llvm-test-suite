...
# %bb.0:                                # %iter.check
	...
	xvld	$xr1, $a0, %pc_lo12(.LCPI1_9)
	pcalau12i	$a0, %pc_hi20(.LCPI1_10)
	xvld	$xr2, $a0, %pc_lo12(.LCPI1_10)
	pcalau12i	$a0, %pc_hi20(.LCPI1_11)
	xvld	$xr3, $a0, %pc_lo12(.LCPI1_11)
	xvst	$xr0, $sp, 536
	xvst	$xr1, $sp, 568
	xvst	$xr2, $sp, 600
	xvst	$xr3, $sp, 632
	...
	xvld	$xr2, $a0, %pc_lo12(.LCPI1_14)
	pcalau12i	$a0, %pc_hi20(.LCPI1_15)
	xvld	$xr3, $a0, %pc_lo12(.LCPI1_15)
	xvst	$xr0, $sp, 664
	xvst	$xr1, $sp, 696
	xvst	$xr2, $sp, 728
	xvst	$xr3, $sp, 760
	...
	xvld	$xr1, $a0, %pc_lo12(.LCPI1_17)
	pcalau12i	$a0, %pc_hi20(.LCPI1_18)
	xvld	$xr2, $a0, %pc_lo12(.LCPI1_18)
	pcalau12i	$a0, %pc_hi20(.LCPI1_19)
	xvld	$xr3, $a0, %pc_lo12(.LCPI1_19)
	xvst	$xr0, $sp, 792
	xvst	$xr1, $sp, 824
	xvst	$xr2, $sp, 856
	xvst	$xr3, $sp, 888
	pcalau12i	$a0, %pc_hi20(.LCPI1_20)
	xvld	$xr0, $a0, %pc_lo12(.LCPI1_20)
	pcalau12i	$a0, %pc_hi20(.LCPI1_21)
	xvld	$xr1, $a0, %pc_lo12(.LCPI1_21)
	pcalau12i	$a0, %pc_hi20(.LCPI1_22)
	xvld	$xr2, $a0, %pc_lo12(.LCPI1_22)
	pcalau12i	$a0, %pc_hi20(.LCPI1_23)
	xvld	$xr3, $a0, %pc_lo12(.LCPI1_23)
	xvst	$xr0, $sp, 920
	xvst	$xr1, $sp, 952
	xvst	$xr2, $sp, 984
	xvst	$xr3, $sp, 1016
	pcalau12i	$a0, %pc_hi20(.LCPI1_24)
	xvld	$xr0, $a0, %pc_lo12(.LCPI1_24)
	pcalau12i	$a0, %pc_hi20(.LCPI1_25)
	xvld	$xr1, $a0, %pc_lo12(.LCPI1_25)
	pcalau12i	$a0, %pc_hi20(.LCPI1_26)
	xvld	$xr2, $a0, %pc_lo12(.LCPI1_26)
	pcalau12i	$a0, %pc_hi20(.LCPI1_27)
	xvld	$xr3, $a0, %pc_lo12(.LCPI1_27)
	xvst	$xr0, $sp, 1048
	xvst	$xr1, $sp, 1080
	xvst	$xr2, $sp, 1112
	xvst	$xr3, $sp, 1144
	pcalau12i	$a0, %pc_hi20(.LCPI1_28)
	xvld	$xr0, $a0, %pc_lo12(.LCPI1_28)
	pcalau12i	$a0, %pc_hi20(.LCPI1_29)
	xvld	$xr1, $a0, %pc_lo12(.LCPI1_29)
	pcalau12i	$a0, %pc_hi20(.LCPI1_30)
	xvld	$xr2, $a0, %pc_lo12(.LCPI1_30)
	pcalau12i	$a0, %pc_hi20(.LCPI1_31)
	xvld	$xr3, $a0, %pc_lo12(.LCPI1_31)
	xvst	$xr0, $sp, 1176
	xvst	$xr1, $sp, 1208
	xvst	$xr2, $sp, 1240
	xvst	$xr3, $sp, 1272
	pcalau12i	$a0, %pc_hi20(.LCPI1_32)
	xvld	$xr0, $a0, %pc_lo12(.LCPI1_32)
	pcalau12i	$a0, %pc_hi20(.LCPI1_33)
	xvld	$xr1, $a0, %pc_lo12(.LCPI1_33)
	pcalau12i	$a0, %pc_hi20(.LCPI1_34)
	vld	$vr2, $a0, %pc_lo12(.LCPI1_34)
	pcalau12i	$a0, %pc_hi20(.LCPI1_35)
	vld	$vr3, $a0, %pc_lo12(.LCPI1_35)
	xvst	$xr0, $sp, 1304
	xvst	$xr1, $sp, 1336
	vst	$vr2, $sp, 1368
	vst	$vr3, $sp, 1384
	pcalau12i	$a0, %pc_hi20(.LCPI1_36)
	vld	$vr0, $a0, %pc_lo12(.LCPI1_36)
	ori	$a0, $zero, 352
	lu32i.d	$a0, 353
	st.d	$a0, $sp, 1416
	ori	$a0, $zero, 354
