...
# %bb.4:                                # %complex_mul_cont20.split
	...
	bceqz	$fcc0, .LBB0_35
# %bb.5:                                # %complex_mul_cont20.split.split
	fneg.d	$fs6, $fs3
	fmov.d	$fa0, $fs4
	fmov.d	$fa1, $fs5
	pcaddu18i	$ra, %call36(cexp)
...
.LBB0_10:                               # %complex_mul_cont157
	...
	fadd.d	$fs4, $fa2, $fa2
	bceqz	$fcc0, .LBB0_31
.LBB0_11:                               # %complex_mul_imag_nan199
...
.LBB0_13:                               # %return
	...
	addi.d	$sp, $sp, 464
	ret
.LBB0_14:                               # %complex_mul_imag_nan
	fcmp.cor.d	$fcc0, $fs5, $fs5
	fmov.d	$fa0, $fs4
	fmov.d	$fa1, $fs5
	bcnez	$fcc0, .LBB0_2
# %bb.15:                               # %complex_mul_libcall
	movgr2fr.d	$fa0, $zero
	vldi	$vr1, -984
	fmov.d	$fa2, $fs1
	fmov.d	$fa3, $fs0
	...
	jirl	$ra, $ra, 0
	b	.LBB0_2
.LBB0_16:                               # %complex_mul_imag_nan16
	fcmp.cor.d	$fcc0, $fa1, $fa1
	bcnez	$fcc0, .LBB0_3
# %bb.17:                               # %complex_mul_libcall18
	fneg.d	$fa3, $fa3
	movgr2fr.d	$fa0, $zero
	vldi	$vr1, -912
	pcaddu18i	$ra, %call36(__muldc3)
...
.LBB0_19:                               # %for.body.us
	...
	vst	$vr5, $sp, 288                  # 16-byte Folded Spill
	fldx.d	$fa0, $s0, $fp
...
.LBB0_21:                               # %complex_mul_cont75.us
	...
	vfmul.d	$vr0, $vr2, $vr0
	addi.d	$fp, $fp, 8
	vld	$vr5, $sp, 288                  # 16-byte Folded Reload
	vfadd.d	$vr5, $vr5, $vr0
	bne	$fp, $s3, .LBB0_19
	b	.LBB0_6
.LBB0_22:                               # %complex_mul_libcall42.us
                                        #   in Loop: Header=BB0_19 Depth=1
	vldi	$vr1, -984
	...
	jirl	$ra, $ra, 0
	b	.LBB0_20
.LBB0_23:                               # %complex_mul_imag_nan71.us
                                        #   in Loop: Header=BB0_19 Depth=1
	fmov.d	$fa0, $fs2
	fmov.d	$fa1, $fs3
	ld.d	$a0, $sp, 160
	movgr2cf	$fcc0, $a0
	bcnez	$fcc0, .LBB0_21
# %bb.24:                               # %complex_mul_libcall73.us
                                        #   in Loop: Header=BB0_19 Depth=1
	fmov.d	$fa0, $fs6
	fmov.d	$fa1, $fs7
	fmov.d	$fa2, $fs1
	...
	jirl	$ra, $ra, 0
	b	.LBB0_21
.LBB0_25:                               # %complex_mul_imag_nan106
	fcmp.cor.d	$fcc0, $fa1, $fa1
	bcnez	$fcc0, .LBB0_7
# %bb.26:                               # %complex_mul_libcall108
	movgr2fr.d	$fa0, $zero
	fmov.d	$fa1, $fa2
	fmov.d	$fa2, $fs1
	fmov.d	$fa3, $fs0
	...
	vld	$vr5, $sp, 288                  # 16-byte Folded Reload
	b	.LBB0_7
.LBB0_27:                               # %complex_mul_imag_nan124
	fcmp.cor.d	$fcc0, $fa5, $fa5
	bcnez	$fcc0, .LBB0_8
# %bb.28:                               # %complex_mul_libcall126
	...
	fmov.d	$fa5, $fa1
	b	.LBB0_8
.LBB0_29:                               # %complex_mul_imag_nan153
	fcmp.cor.d	$fcc0, $fs3, $fs3
	bcnez	$fcc0, .LBB0_10
# %bb.30:                               # %complex_mul_libcall155
	movgr2fr.d	$fa0, $zero
	vldi	$vr1, -912
	fmov.d	$fa2, $fs1
	fmov.d	$fa3, $fs0
	...
	fmov.d	$fs3, $fa1
	b	.LBB0_10
.LBB0_31:                               # %complex_mul_imag_nan175
	fcmp.cun.d	$fcc0, $fs4, $fs4
	bceqz	$fcc0, .LBB0_11
# %bb.32:                               # %complex_mul_libcall201
	fmov.d	$fa0, $fs1
	fmov.d	$fa1, $fs0
	fmov.d	$fa2, $fs1
	fmov.d	$fa3, $fs0
	...
	fmov.d	$fs4, $fa1
	b	.LBB0_12
.LBB0_33:                               # %complex_mul_imag_nan217
	fcmp.cor.d	$fcc0, $fa1, $fa1
	bcnez	$fcc0, .LBB0_13
# %bb.34:                               # %complex_mul_libcall219
	fmov.d	$fa0, $fs2
	fmov.d	$fa1, $fs3
	pcaddu18i	$ra, %call36(__muldc3)
	jirl	$ra, $ra, 0
	b	.LBB0_13
.LBB0_35:                               # %for.body.us14.preheader
	move	$fp, $zero
	vrepli.b	$vr5, 0
	pcalau12i	$a0, %pc_hi20(.L__const.fast_nuclear_W.neg_1n)
	addi.d	$s0, $a0, %pc_lo12(.L__const.fast_nuclear_W.neg_1n)
...
.LBB0_36:                               # %for.body.us14
	...
	movgr2cf	$fcc0, $a0
	bceqz	$fcc0, .LBB0_38
.LBB0_37:                               # %complex_mul_cont75.us28
	...
	bne	$fp, $s3, .LBB0_36
	b	.LBB0_6
.LBB0_38:                               # %complex_mul_libcall73.us26
                                        #   in Loop: Header=BB0_36 Depth=1
	fmov.d	$fa0, $fs6
	fmov.d	$fa1, $fs7
	fmov.d	$fa2, $fs1
