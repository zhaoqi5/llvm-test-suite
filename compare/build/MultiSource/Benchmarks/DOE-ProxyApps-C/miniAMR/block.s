...
.LBB0_74:                               # %for.cond347.preheader
	...
	pcalau12i	$a2, %pc_hi20(split_blocks.off)
	addi.d	$a2, $a2, %pc_lo12(split_blocks.off)
	add.d	$a2, $a2, $t0
	ld.w	$a2, $a2, -52
	ldx.w	$a4, $a0, $a1
	add.w	$a5, $a2, $a4
...
# %bb.5:                                # %for.body4.lr.ph
	...
	ld.d	$a5, $a0, %pc_lo12(sorted_list)
	addi.d	$t8, $a2, 4
	addi.d	$a0, $a6, 2
...
.LBB3_83:                               # %for.inc424.1
	...
	ld.w	$t4, $t4, 76
	bltz	$t4, .LBB3_86
# %bb.84:                               # %if.then348.1326
                                        #   in Loop: Header=BB3_73 Depth=3
	ldx.wu	$t5, $t5, $t6
	ld.d	$fp, $sp, 152                   # 8-byte Folded Reload
	beq	$fp, $t5, .LBB3_93
# %bb.85:                               # %if.end358.1334
                                        #   in Loop: Header=BB3_73 Depth=3
	st.w	$t4, $t2, 8
	ld.d	$t4, $sp, 144                   # 8-byte Folded Reload
	st.w	$t4, $t1, 0
