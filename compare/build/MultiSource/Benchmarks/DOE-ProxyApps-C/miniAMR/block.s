...
# %bb.6:                                # %for.body3.lr.ph
	...
	ld.d	$s4, $a2, %pc_lo12(sorted_index)
	move	$t1, $zero
	alsl.d	$a2, $s3, $a0, 2
...
# %bb.21:                               # %for.cond14.preheader.i
	...
	pcalau12i	$t7, %pc_hi20(num_refine)
	ld.w	$a3, $t7, %pc_lo12(num_refine)
...
# %bb.54:                               # %for.cond88.preheader.lr.ph.split.split.split
	...
	b	.LBB3_56
	.p2align	4, , 16
.LBB3_55:                               # %for.cond88.for.inc211_crit_edge.split.split
                                        #   in Loop: Header=BB3_56 Depth=4
	ld.d	$a6, $sp, 304                   # 8-byte Folded Reload
	addi.d	$a6, $a6, 1
	ld.d	$a0, $sp, 296                   # 8-byte Folded Reload
	beq	$a6, $a0, .LBB3_38
.LBB3_56:                               # %for.cond88.preheader
                                        #   Parent Loop BB3_4 Depth=1
                                        #     Parent Loop BB3_8 Depth=2
                                        #       Parent Loop BB3_39 Depth=3
                                        # =>      This Loop Header: Depth=4
	...
	b	.LBB3_58
	.p2align	4, , 16
.LBB3_57:                               # %for.cond91.for.inc207_crit_edge.split
...
.LBB3_58:                               # %for.cond91.preheader
	...
	b	.LBB3_60
	.p2align	4, , 16
.LBB3_59:                               # %for.cond94.for.inc203_crit_edge
                                        #   in Loop: Header=BB3_60 Depth=6
	addi.d	$s3, $s3, 1
	addi.d	$a7, $a7, 2
	beq	$s3, $s0, .LBB3_57
.LBB3_60:                               # %for.cond94.preheader
                                        #   Parent Loop BB3_4 Depth=1
                                        #     Parent Loop BB3_8 Depth=2
                                        #       Parent Loop BB3_39 Depth=3
                                        #         Parent Loop BB3_56 Depth=4
...
.LBB3_85:                               # %for.inc424.1
	...
	ld.w	$t3, $t2, 76
	bltz	$t3, .LBB3_88
# %bb.86:                               # %if.then348.1319
                                        #   in Loop: Header=BB3_75 Depth=3
	ldx.wu	$t4, $t4, $a2
	ld.d	$t8, $sp, 144                   # 8-byte Folded Reload
	beq	$t8, $t4, .LBB3_94
# %bb.87:                               # %if.end358.1332
                                        #   in Loop: Header=BB3_75 Depth=3
	st.w	$t3, $t0, 84
	ld.d	$a4, $sp, 136                   # 8-byte Folded Reload
	st.w	$a4, $a7, 52
