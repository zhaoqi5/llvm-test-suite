...
.LBB2_6:                                # %if.end8
	...
	blez	$a0, .LBB2_9
# %bb.7:                                # %if.end8
	ld.w	$a1, $s2, %pc_lo12(y_block_size)
	blez	$a1, .LBB2_9
# %bb.8:                                # %if.end8
...
# %bb.1:                                # %for.body.preheader
	...
	pcalau12i	$s8, %pc_hi20(y_block_size)
	pcalau12i	$s0, %pc_hi20(z_block_size)
...
# %bb.7:                                # %for.body34.preheader
                                        #   in Loop: Header=BB3_6 Depth=2
	ld.w	$a1, $s8, %pc_lo12(y_block_size)
	move	$a0, $zero
	b	.LBB3_9
	.p2align	4, , 16
.LBB3_8:                                # %for.inc64
...
.LBB3_11:                               # %for.body50
	...
	ld.w	$a0, $s0, %pc_lo12(z_block_size)
	slli.d	$a0, $a0, 3
	addi.d	$a0, $a0, 16
	ori	$a2, $zero, 231
	move	$a1, $fp
...
.LBB4_11:                               # %for.body10
	...
	pcaddu18i	$ra, %call36(free)
	jirl	$ra, $ra, 0
	ld.w	$a0, $s5, %pc_lo12(y_block_size)
	addi.d	$s4, $s4, 1
	addi.d	$s2, $s2, 8
	bge	$a0, $s4, .LBB4_11
	b	.LBB4_8
