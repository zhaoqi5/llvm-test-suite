...
# %bb.0:                                # %entry
	...
	ori	$a0, $zero, 500
	st.w	$a0, $s6, %pc_lo12(max_num_blocks)
	pcalau12i	$s7, %pc_hi20(target_active)
	st.w	$zero, $s7, %pc_lo12(target_active)
...
.LBB0_35:                               # %if.then8
	...
	pcaddu18i	$ra, %call36(strtol)
	jirl	$ra, $ra, 0
	st.w	$a0, $s7, %pc_lo12(target_active)
	b	.LBB0_3
.LBB0_36:                               # %if.then18
                                        #   in Loop: Header=BB0_4 Depth=1
	addi.w	$s5, $s5, 1
