...
# %bb.19:                               # %for.body490.preheader
	...
	ori	$a4, $zero, 5
	bltu	$a2, $a4, .LBB2_25
# %bb.20:                               # %vector.memcheck1441
                                        #   in Loop: Header=BB2_18 Depth=1
	addi.d	$a2, $t1, 8
	ld.d	$a4, $sp, 40                    # 8-byte Folded Reload
	add.d	$a4, $a0, $a4
	bgeu	$a2, $a4, .LBB2_22
# %bb.21:                               # %vector.memcheck1441
                                        #   in Loop: Header=BB2_18 Depth=1
	ld.d	$a2, $sp, 32                    # 8-byte Folded Reload
	add.d	$a2, $t1, $a2
	addi.d	$a2, $a2, -8
	...
	addi.d	$a4, $a4, 8
	bltu	$a4, $a2, .LBB2_25
.LBB2_22:                               # %vector.body1454.preheader
                                        #   in Loop: Header=BB2_18 Depth=1
...
.LBB2_23:                               # %vector.body1454
	...
	addi.d	$a1, $a1, 32
	bnez	$a2, .LBB2_23
# %bb.24:                               # %middle.block1461
                                        #   in Loop: Header=BB2_18 Depth=1
	ld.d	$a1, $sp, 16                    # 8-byte Folded Reload
	ld.d	$a2, $sp, 48                    # 8-byte Folded Reload
	beq	$s4, $a2, .LBB2_27
	.p2align	4, , 16
.LBB2_25:                               # %for.body490.preheader1467
                                        #   in Loop: Header=BB2_18 Depth=1
	add.d	$a2, $a0, $s1
	alsl.d	$a2, $a1, $a2, 3
	alsl.d	$a4, $a1, $t1, 4
...
# %bb.32:                               # %vector.memcheck1419
	...
	addi.d	$a4, $a4, -8
	bgeu	$a2, $a4, .LBB2_34
# %bb.33:                               # %vector.memcheck1419
                                        #   in Loop: Header=BB2_18 Depth=1
	ld.d	$a2, $sp, 40                    # 8-byte Folded Reload
	add.d	$a2, $t1, $a2
	addi.d	$a4, $t6, 8
	bltu	$a4, $a2, .LBB2_37
.LBB2_34:                               # %vector.body1432.preheader
                                        #   in Loop: Header=BB2_18 Depth=1
	ld.d	$a1, $sp, 24                    # 8-byte Folded Reload
	xvld	$xr2, $a1, %pc_lo12(.LCPI2_0)
	add.d	$t7, $t1, $s7
...
# %bb.48:                               # %for.body898.preheader
	...
	ori	$a4, $zero, 5
	bltu	$a2, $a4, .LBB2_54
# %bb.49:                               # %vector.memcheck1396
                                        #   in Loop: Header=BB2_18 Depth=1
	addi.d	$a2, $t6, 8
	ld.d	$a4, $sp, 40                    # 8-byte Folded Reload
	add.d	$a4, $t1, $a4
	bgeu	$a2, $a4, .LBB2_51
# %bb.50:                               # %vector.memcheck1396
                                        #   in Loop: Header=BB2_18 Depth=1
	ld.d	$a2, $sp, 32                    # 8-byte Folded Reload
	add.d	$a2, $t6, $a2
	addi.d	$a2, $a2, -8
	...
	addi.d	$a4, $a4, 8
	bltu	$a4, $a2, .LBB2_54
.LBB2_51:                               # %vector.body1409.preheader
                                        #   in Loop: Header=BB2_18 Depth=1
	ld.d	$a1, $sp, 24                    # 8-byte Folded Reload
	xvld	$xr2, $a1, %pc_lo12(.LCPI2_0)
	add.d	$a1, $t1, $s7
...
.LBB2_52:                               # %vector.body1409
	...
	addi.d	$a1, $a1, 32
	bnez	$a2, .LBB2_52
# %bb.53:                               # %middle.block1416
                                        #   in Loop: Header=BB2_18 Depth=1
	ld.d	$a1, $sp, 16                    # 8-byte Folded Reload
	ld.d	$a2, $sp, 48                    # 8-byte Folded Reload
	beq	$s4, $a2, .LBB2_56
	.p2align	4, , 16
.LBB2_54:                               # %for.body898.preheader1466
                                        #   in Loop: Header=BB2_18 Depth=1
	add.d	$a2, $t1, $s1
	alsl.d	$a2, $a1, $a2, 3
	alsl.d	$a4, $a1, $t6, 4
...
# %bb.61:                               # %vector.memcheck1374
	...
	addi.d	$a2, $a2, -8
	bgeu	$a1, $a2, .LBB2_63
# %bb.62:                               # %vector.memcheck1374
                                        #   in Loop: Header=BB2_18 Depth=1
	ld.d	$a1, $sp, 40                    # 8-byte Folded Reload
	add.d	$a1, $a6, $a1
	addi.d	$a2, $t4, 8
	bltu	$a2, $a1, .LBB2_66
.LBB2_63:                               # %vector.body1387.preheader
                                        #   in Loop: Header=BB2_18 Depth=1
...
# %bb.86:                               # %for.body1077.preheader
	...
	ori	$a4, $zero, 5
	bltu	$a2, $a4, .LBB2_92
# %bb.87:                               # %vector.memcheck1351
                                        #   in Loop: Header=BB2_85 Depth=1
	addi.d	$a2, $t8, 8
	ld.d	$a4, $sp, 40                    # 8-byte Folded Reload
	add.d	$a4, $a6, $a4
	bgeu	$a2, $a4, .LBB2_89
# %bb.88:                               # %vector.memcheck1351
                                        #   in Loop: Header=BB2_85 Depth=1
	ld.d	$a2, $sp, 32                    # 8-byte Folded Reload
	add.d	$a2, $t8, $a2
	addi.d	$a2, $a2, -8
	...
	addi.d	$a4, $a4, 8
	bltu	$a4, $a2, .LBB2_92
.LBB2_89:                               # %vector.body1364.preheader
                                        #   in Loop: Header=BB2_85 Depth=1
	ld.d	$a1, $sp, 24                    # 8-byte Folded Reload
	xvld	$xr2, $a1, %pc_lo12(.LCPI2_0)
	add.d	$a1, $a6, $a0
...
.LBB2_90:                               # %vector.body1364
	...
	addi.d	$a1, $a1, 32
	bnez	$a2, .LBB2_90
# %bb.91:                               # %middle.block1371
                                        #   in Loop: Header=BB2_85 Depth=1
	ld.d	$a1, $sp, 16                    # 8-byte Folded Reload
	ld.d	$a2, $sp, 48                    # 8-byte Folded Reload
	beq	$t5, $a2, .LBB2_94
	.p2align	4, , 16
.LBB2_92:                               # %for.body1077.preheader1470
                                        #   in Loop: Header=BB2_85 Depth=1
	add.d	$a2, $a6, $s3
	alsl.d	$a2, $a1, $a2, 3
	alsl.d	$a4, $a1, $t8, 4
...
# %bb.99:                               # %vector.memcheck1329
	...
	addi.d	$a4, $a4, -8
	bgeu	$a2, $a4, .LBB2_101
# %bb.100:                              # %vector.memcheck1329
                                        #   in Loop: Header=BB2_85 Depth=1
	ld.d	$a2, $sp, 40                    # 8-byte Folded Reload
	add.d	$a2, $t8, $a2
	addi.d	$a4, $t7, 8
	bltu	$a4, $a2, .LBB2_104
.LBB2_101:                              # %vector.body1342.preheader
                                        #   in Loop: Header=BB2_85 Depth=1
	ld.d	$a1, $sp, 24                    # 8-byte Folded Reload
	xvld	$xr2, $a1, %pc_lo12(.LCPI2_0)
	add.d	$a2, $t8, $a0
...
# %bb.115:                              # %for.body1485.preheader
	...
	ori	$t0, $zero, 5
	bltu	$a4, $t0, .LBB2_121
# %bb.116:                              # %vector.memcheck1307
                                        #   in Loop: Header=BB2_85 Depth=1
	addi.d	$a4, $a2, 8
	ld.d	$t0, $sp, 40                    # 8-byte Folded Reload
	add.d	$t0, $t7, $t0
	bgeu	$a4, $t0, .LBB2_118
# %bb.117:                              # %vector.memcheck1307
                                        #   in Loop: Header=BB2_85 Depth=1
	ld.d	$a4, $sp, 32                    # 8-byte Folded Reload
	add.d	$a4, $a2, $a4
	addi.d	$a4, $a4, -8
	...
	addi.d	$t0, $t0, 8
	bltu	$t0, $a4, .LBB2_121
.LBB2_118:                              # %vector.body1320.preheader
                                        #   in Loop: Header=BB2_85 Depth=1
	ld.d	$a1, $sp, 24                    # 8-byte Folded Reload
	xvld	$xr2, $a1, %pc_lo12(.LCPI2_0)
	add.d	$a1, $t7, $a0
...
.LBB2_119:                              # %vector.body1320
	...
	addi.d	$a1, $a1, 32
	bnez	$a4, .LBB2_119
# %bb.120:                              # %middle.block1326
                                        #   in Loop: Header=BB2_85 Depth=1
	ld.d	$a1, $sp, 16                    # 8-byte Folded Reload
	ld.d	$a4, $sp, 48                    # 8-byte Folded Reload
	beq	$t5, $a4, .LBB2_123
	.p2align	4, , 16
.LBB2_121:                              # %for.body1485.preheader1469
                                        #   in Loop: Header=BB2_85 Depth=1
	add.d	$a4, $t7, $s3
	alsl.d	$a4, $a1, $a4, 3
	alsl.d	$t0, $a1, $a2, 4
