...
.LBB1_12:                               # %for.body241
	...
	b	.LBB1_8
	.p2align	4, , 16
.LBB1_13:                               # %vector.memcheck346
                                        #   in Loop: Header=BB1_9 Depth=2
	sub.d	$s3, $s1, $fp
	move	$s2, $zero
	bltu	$s3, $t2, .LBB1_11
# %bb.14:                               # %vector.memcheck346
                                        #   in Loop: Header=BB1_9 Depth=2
	sub.d	$s3, $fp, $t8
	bltu	$s3, $t2, .LBB1_11
# %bb.15:                               # %vector.memcheck346
                                        #   in Loop: Header=BB1_9 Depth=2
	sub.d	$s3, $s0, $fp
	bltu	$s3, $t2, .LBB1_11
# %bb.16:                               # %vector.memcheck346
                                        #   in Loop: Header=BB1_9 Depth=2
	sub.d	$s3, $s1, $t8
	bltu	$s3, $t2, .LBB1_11
# %bb.17:                               # %vector.memcheck346
                                        #   in Loop: Header=BB1_9 Depth=2
	sub.d	$s3, $s1, $s0
	bltu	$s3, $t2, .LBB1_11
# %bb.18:                               # %vector.body361.preheader
                                        #   in Loop: Header=BB1_9 Depth=2
	addi.d	$s2, $t8, 32
	addi.d	$s3, $s1, 32
	addi.d	$s4, $fp, 32
...
.LBB1_31:                               # %for.body16
	...
	b	.LBB1_28
	.p2align	4, , 16
.LBB1_32:                               # %vector.memcheck396
                                        #   in Loop: Header=BB1_29 Depth=2
	sub.d	$s4, $s2, $s0
	ori	$s3, $zero, 1
	bltu	$s4, $t3, .LBB1_30
# %bb.33:                               # %vector.memcheck396
                                        #   in Loop: Header=BB1_29 Depth=2
	sub.d	$s4, $s0, $fp
	ori	$s3, $zero, 1
	bltu	$s4, $t3, .LBB1_30
# %bb.34:                               # %vector.memcheck396
                                        #   in Loop: Header=BB1_29 Depth=2
	sub.d	$s4, $s1, $s0
	ori	$s3, $zero, 1
	bltu	$s4, $t3, .LBB1_30
# %bb.35:                               # %vector.memcheck396
                                        #   in Loop: Header=BB1_29 Depth=2
	sub.d	$s4, $s2, $fp
	ori	$s3, $zero, 1
	bltu	$s4, $t3, .LBB1_30
# %bb.36:                               # %vector.memcheck396
                                        #   in Loop: Header=BB1_29 Depth=2
	sub.d	$s4, $s2, $s1
	ori	$s3, $zero, 1
	bltu	$s4, $t3, .LBB1_30
# %bb.37:                               # %vector.body411.preheader
                                        #   in Loop: Header=BB1_29 Depth=2
	addi.d	$s3, $fp, 40
	addi.d	$s4, $s0, 40
	addi.d	$s5, $s2, 40
...
.LBB1_72:                               # %for.body88
	...
	b	.LBB1_69
	.p2align	4, , 16
.LBB1_73:                               # %vector.memcheck371
                                        #   in Loop: Header=BB1_70 Depth=2
	sub.d	$s5, $s3, $s1
	bltu	$s5, $t4, .LBB1_71
# %bb.74:                               # %vector.memcheck371
                                        #   in Loop: Header=BB1_70 Depth=2
	sub.d	$s5, $s1, $s0
	bltu	$s5, $t4, .LBB1_71
# %bb.75:                               # %vector.memcheck371
                                        #   in Loop: Header=BB1_70 Depth=2
	sub.d	$s5, $s2, $s1
	bltu	$s5, $t4, .LBB1_71
# %bb.76:                               # %vector.memcheck371
                                        #   in Loop: Header=BB1_70 Depth=2
	sub.d	$s5, $s3, $s0
	bltu	$s5, $t4, .LBB1_71
# %bb.77:                               # %vector.memcheck371
                                        #   in Loop: Header=BB1_70 Depth=2
	sub.d	$s5, $s3, $s2
	bltu	$s5, $t4, .LBB1_71
# %bb.78:                               # %vector.body386.preheader
                                        #   in Loop: Header=BB1_70 Depth=2
	addi.d	$s4, $s0, 40
	addi.d	$s5, $s1, 40
	addi.d	$s6, $s3, 40
...
# %bb.9:                                # %if.then1041
	...
	ld.w	$fp, $a1, %pc_lo12(y_block_size)
	addi.w	$a2, $fp, 1
	bne	$a7, $a0, .LBB2_81
# %bb.10:                               # %if.then1043
...
.LBB2_16:                               # %for.body470.lr.ph
	...
	ld.w	$a2, $a2, %pc_lo12(y_block_size)
	addi.w	$t2, $t0, 1
	addi.w	$a1, $a1, 1
...
# %bb.19:                               # %for.body490.preheader
	...
	ori	$a4, $zero, 5
	bltu	$a2, $a4, .LBB2_25
# %bb.20:                               # %vector.memcheck1449
                                        #   in Loop: Header=BB2_18 Depth=1
	addi.d	$a2, $t1, 8
	ld.d	$a4, $sp, 40                    # 8-byte Folded Reload
	add.d	$a4, $a0, $a4
	bgeu	$a2, $a4, .LBB2_22
# %bb.21:                               # %vector.memcheck1449
                                        #   in Loop: Header=BB2_18 Depth=1
	ld.d	$a2, $sp, 32                    # 8-byte Folded Reload
	add.d	$a2, $t1, $a2
	addi.d	$a2, $a2, -8
...
.LBB2_23:                               # %vector.body1462
	...
	addi.d	$a1, $a1, 32
	bnez	$a2, .LBB2_23
# %bb.24:                               # %middle.block1469
                                        #   in Loop: Header=BB2_18 Depth=1
	ld.d	$a1, $sp, 8                     # 8-byte Folded Reload
	ld.d	$a2, $sp, 48                    # 8-byte Folded Reload
	beq	$s5, $a2, .LBB2_27
	.p2align	4, , 16
.LBB2_25:                               # %for.body490.preheader1475
                                        #   in Loop: Header=BB2_18 Depth=1
	add.d	$a2, $a0, $s2
	alsl.d	$a2, $a1, $a2, 3
	alsl.d	$a4, $a1, $t1, 4
...
# %bb.32:                               # %vector.memcheck1427
	...
	addi.d	$a4, $a4, -8
	bgeu	$a2, $a4, .LBB2_34
# %bb.33:                               # %vector.memcheck1427
                                        #   in Loop: Header=BB2_18 Depth=1
	ld.d	$a2, $sp, 40                    # 8-byte Folded Reload
	add.d	$a2, $a0, $a2
	addi.d	$a4, $t7, 8
	bltu	$a4, $a2, .LBB2_37
.LBB2_34:                               # %vector.ph1437
                                        #   in Loop: Header=BB2_18 Depth=1
	ld.d	$a1, $sp, 24                    # 8-byte Folded Reload
	xvld	$xr2, $a1, %pc_lo12(.LCPI2_0)
	ld.d	$a1, $sp, 16                    # 8-byte Folded Reload
...
# %bb.48:                               # %for.body898.preheader
	...
	ori	$a4, $zero, 5
	bltu	$a2, $a4, .LBB2_54
# %bb.49:                               # %vector.memcheck1404
                                        #   in Loop: Header=BB2_18 Depth=1
	addi.d	$a2, $t1, 8
	ld.d	$a4, $sp, 40                    # 8-byte Folded Reload
	add.d	$a4, $a0, $a4
	bgeu	$a2, $a4, .LBB2_51
# %bb.50:                               # %vector.memcheck1404
                                        #   in Loop: Header=BB2_18 Depth=1
	ld.d	$a2, $sp, 32                    # 8-byte Folded Reload
	add.d	$a2, $t1, $a2
	addi.d	$a2, $a2, -8
...
.LBB2_52:                               # %vector.body1417
	...
	xvstelm.d	$xr3, $t2, 0, 1
	xvstelm.d	$xr3, $t4, 0, 2
	xvstelm.d	$xr3, $t7, 0, 3
	xvstelm.d	$xr3, $a4, -8, 0
	xvstelm.d	$xr3, $t2, -8, 1
	xvstelm.d	$xr3, $t4, -8, 2
	xvstelm.d	$xr3, $t7, -8, 3
	xvaddi.du	$xr2, $xr2, 4
	addi.d	$a2, $a2, -4
	addi.d	$a1, $a1, 32
	bnez	$a2, .LBB2_52
# %bb.53:                               # %middle.block1424
                                        #   in Loop: Header=BB2_18 Depth=1
	ld.d	$a1, $sp, 8                     # 8-byte Folded Reload
	ld.d	$a2, $sp, 48                    # 8-byte Folded Reload
	beq	$s5, $a2, .LBB2_56
	.p2align	4, , 16
.LBB2_54:                               # %for.body898.preheader1474
                                        #   in Loop: Header=BB2_18 Depth=1
	add.d	$a2, $a0, $s2
	alsl.d	$a2, $a1, $a2, 3
	alsl.d	$a4, $a1, $t1, 4
...
# %bb.61:                               # %vector.memcheck1382
	...
	addi.d	$a4, $a4, -8
	bgeu	$a2, $a4, .LBB2_63
# %bb.62:                               # %vector.memcheck1382
                                        #   in Loop: Header=BB2_18 Depth=1
	ld.d	$a2, $sp, 40                    # 8-byte Folded Reload
	add.d	$a2, $a0, $a2
	addi.d	$a4, $t5, 8
	bltu	$a4, $a2, .LBB2_66
.LBB2_63:                               # %vector.ph1392
                                        #   in Loop: Header=BB2_18 Depth=1
	ld.d	$a1, $sp, 24                    # 8-byte Folded Reload
	xvld	$xr2, $a1, %pc_lo12(.LCPI2_0)
	ld.d	$a1, $sp, 16                    # 8-byte Folded Reload
...
# %bb.86:                               # %for.body1077.preheader
	...
	ori	$a4, $zero, 5
	bltu	$a2, $a4, .LBB2_92
# %bb.87:                               # %vector.memcheck1359
                                        #   in Loop: Header=BB2_85 Depth=1
	addi.d	$a2, $a6, 8
	ld.d	$a4, $sp, 40                    # 8-byte Folded Reload
	add.d	$a4, $a0, $a4
	bgeu	$a2, $a4, .LBB2_89
# %bb.88:                               # %vector.memcheck1359
                                        #   in Loop: Header=BB2_85 Depth=1
	ld.d	$a2, $sp, 32                    # 8-byte Folded Reload
	add.d	$a2, $a6, $a2
	addi.d	$a2, $a2, -8
...
.LBB2_90:                               # %vector.body1372
	...
	addi.d	$a1, $a1, 32
	bnez	$a2, .LBB2_90
# %bb.91:                               # %middle.block1379
                                        #   in Loop: Header=BB2_85 Depth=1
	ld.d	$a1, $sp, 8                     # 8-byte Folded Reload
	ld.d	$a2, $sp, 48                    # 8-byte Folded Reload
	beq	$s7, $a2, .LBB2_94
	.p2align	4, , 16
.LBB2_92:                               # %for.body1077.preheader1478
                                        #   in Loop: Header=BB2_85 Depth=1
	add.d	$a2, $a0, $s4
	alsl.d	$a2, $a1, $a2, 3
	alsl.d	$a4, $a1, $a6, 4
...
# %bb.99:                               # %vector.memcheck1337
	...
	addi.d	$a4, $a4, -8
	bgeu	$a2, $a4, .LBB2_101
# %bb.100:                              # %vector.memcheck1337
                                        #   in Loop: Header=BB2_85 Depth=1
	ld.d	$a2, $sp, 40                    # 8-byte Folded Reload
	add.d	$a2, $fp, $a2
	addi.d	$a4, $t8, 8
	bltu	$a4, $a2, .LBB2_104
.LBB2_101:                              # %vector.ph1347
                                        #   in Loop: Header=BB2_85 Depth=1
	ld.d	$a1, $sp, 24                    # 8-byte Folded Reload
	xvld	$xr2, $a1, %pc_lo12(.LCPI2_0)
	ld.d	$a1, $sp, 16                    # 8-byte Folded Reload
...
# %bb.115:                              # %for.body1485.preheader
	...
	ori	$a4, $zero, 5
	bltu	$a2, $a4, .LBB2_121
# %bb.116:                              # %vector.memcheck1315
                                        #   in Loop: Header=BB2_85 Depth=1
	addi.d	$a2, $t0, 8
	ld.d	$a4, $sp, 40                    # 8-byte Folded Reload
	add.d	$a4, $t8, $a4
	bgeu	$a2, $a4, .LBB2_118
# %bb.117:                              # %vector.memcheck1315
                                        #   in Loop: Header=BB2_85 Depth=1
	ld.d	$a2, $sp, 32                    # 8-byte Folded Reload
	add.d	$a2, $t0, $a2
	addi.d	$a2, $a2, -8
...
.LBB2_119:                              # %vector.body1328
	...
	addi.d	$a1, $a1, 32
	bnez	$a2, .LBB2_119
# %bb.120:                              # %middle.block1334
                                        #   in Loop: Header=BB2_85 Depth=1
	ld.d	$a1, $sp, 8                     # 8-byte Folded Reload
	ld.d	$a2, $sp, 48                    # 8-byte Folded Reload
	beq	$s7, $a2, .LBB2_123
	.p2align	4, , 16
.LBB2_121:                              # %for.body1485.preheader1477
                                        #   in Loop: Header=BB2_85 Depth=1
	add.d	$a2, $t8, $s4
	alsl.d	$a2, $a1, $a2, 3
	alsl.d	$a4, $a1, $t0, 4
...
# %bb.13:                               # %for.cond7.preheader
	...
	ori	$fp, $zero, 1
	bltu	$s0, $t3, .LBB3_17
# %bb.14:                               # %vector.body301.preheader
                                        #   in Loop: Header=BB3_12 Depth=2
	addi.d	$fp, $t7, 40
	addi.d	$s0, $t8, 40
	move	$s1, $t1
	.p2align	4, , 16
.LBB3_15:                               # %vector.body301
                                        #   Parent Loop BB3_10 Depth=1
...
# %bb.30:                               # %for.cond122.preheader
	...
	sub.d	$fp, $t7, $t6
	bltu	$fp, $t2, .LBB3_34
# %bb.31:                               # %vector.body271.preheader
                                        #   in Loop: Header=BB3_29 Depth=2
	addi.d	$t8, $t7, 32
	addi.d	$fp, $t6, 32
	move	$s0, $t0
	.p2align	4, , 16
.LBB3_32:                               # %vector.body271
                                        #   Parent Loop BB3_27 Depth=1
...
# %bb.60:                               # %for.cond41.preheader
	...
	ori	$t8, $zero, 1
	bltu	$fp, $t3, .LBB3_64
# %bb.61:                               # %vector.body286.preheader
                                        #   in Loop: Header=BB3_59 Depth=2
	addi.d	$t8, $t6, 40
	addi.d	$fp, $t7, 40
	move	$s0, $t0
	.p2align	4, , 16
.LBB3_62:                               # %vector.body286
                                        #   Parent Loop BB3_57 Depth=1
