...
# %bb.2:                                # %if.then454
	...
	ld.w	$s2, $a0, %pc_lo12(x_block_size)
	addi.w	$a0, $s2, 1
	beqz	$a7, .LBB2_15
# %bb.3:                                # %if.else458
...
.LBB2_16:                               # %for.body470.lr.ph
	...
	ld.w	$a7, $a1, %pc_lo12(z_block_half)
	pcalau12i	$a1, %pc_hi20(y_block_half)
	ld.w	$t0, $a1, %pc_lo12(y_block_half)
	add.w	$a1, $a6, $a5
...
.LBB2_23:                               # %vector.body1459
	...
	xvstelm.d	$xr3, $t3, 0, 2
	xvstelm.d	$xr3, $t6, 0, 3
	xvstelm.d	$xr3, $a4, -8, 0
	xvstelm.d	$xr3, $t0, -8, 1
	xvstelm.d	$xr3, $t3, -8, 2
	xvstelm.d	$xr3, $t6, -8, 3
	xvaddi.du	$xr2, $xr2, 4
	addi.d	$a2, $a2, -4
	addi.d	$a1, $a1, 32
	bnez	$a2, .LBB2_23
...
.LBB2_35:                               # %vector.body1437
	...
	vextrins.d	$vr4, $vr9, 16
	xvpermi.q	$xr4, $xr7, 2
	xvfadd.d	$xr3, $xr5, $xr4
	xvst	$xr3, $t6, 0
	xvaddi.du	$xr2, $xr2, 4
	addi.d	$t7, $t7, -4
	addi.d	$t6, $t6, 32
...
.LBB2_52:                               # %vector.body1414
	...
	xvstelm.d	$xr3, $a4, 0, 0
	xvstelm.d	$xr3, $t0, 0, 1
	xvstelm.d	$xr3, $t5, 0, 2
	xvstelm.d	$xr3, $t6, 0, 3
	xvstelm.d	$xr3, $a4, -8, 0
	xvstelm.d	$xr3, $t0, -8, 1
	xvstelm.d	$xr3, $t5, -8, 2
	xvstelm.d	$xr3, $t6, -8, 3
	xvaddi.du	$xr2, $xr2, 4
	addi.d	$a2, $a2, -4
	addi.d	$a1, $a1, 32
...
.LBB2_90:                               # %vector.body1369
	...
	xvstelm.d	$xr3, $t2, 0, 2
	xvstelm.d	$xr3, $t3, 0, 3
	xvstelm.d	$xr3, $a4, -8, 0
	xvstelm.d	$xr3, $a6, -8, 1
	xvstelm.d	$xr3, $t2, -8, 2
	xvstelm.d	$xr3, $t3, -8, 3
	xvaddi.du	$xr2, $xr2, 4
	addi.d	$a2, $a2, -4
	addi.d	$a1, $a1, 32
	bnez	$a2, .LBB2_90
...
# %bb.137:                              # %for.body1644.lr.ph
	pcalau12i	$a0, %pc_hi20(y_block_half)
	ld.w	$t0, $a0, %pc_lo12(y_block_half)
	pcalau12i	$a0, %pc_hi20(x_block_half)
	ld.w	$a7, $a0, %pc_lo12(x_block_half)
	add.w	$a0, $a6, $a5
	st.d	$a0, $sp, 96                    # 8-byte Folded Spill
