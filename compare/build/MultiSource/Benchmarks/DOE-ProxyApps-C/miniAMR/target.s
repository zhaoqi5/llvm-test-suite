...
# %bb.1:                                # %for.cond5.preheader.preheader
	...
	pcalau12i	$s3, %pc_hi20(parents)
	addi.w	$s4, $zero, -1
	lu32i.d	$s4, 0
	pcalau12i	$s5, %pc_hi20(blocks)
	pcalau12i	$s6, %pc_hi20(my_pe)
                                        # implicit-def: $f26_64
	b	.LBB0_3
	.p2align	4, , 16
.LBB0_2:                                # %for.end52
...
# %bb.8:                                # %if.then26
	...
	st.w	$s4, $a0, -24
	ld.w	$a4, $a0, 12
	ld.w	$a3, $s6, %pc_lo12(my_pe)
	ld.d	$a2, $s5, %pc_lo12(blocks)
	bne	$a4, $a3, .LBB0_11
# %bb.9:                                # %land.lhs.true
                                        #   in Loop: Header=BB0_6 Depth=2
	ld.w	$a5, $a0, -20
...
.LBB2_2:                                # %for.body.preheader
	...
	pcalau12i	$s6, %pc_hi20(sorted_list)
	pcalau12i	$s7, %pc_hi20(blocks)
	addi.w	$s8, $zero, -1
	ori	$s4, $zero, 1
	b	.LBB2_4
	.p2align	4, , 16
...
.LBB2_9:                                # %if.then8
	...
	bge	$s1, $fp, .LBB2_3
.LBB2_10:                               # %land.rhs.lr.ph
                                        #   in Loop: Header=BB2_4 Depth=1
	ld.d	$a1, $s5, %pc_lo12(sorted_index)
	ld.d	$a3, $s6, %pc_lo12(sorted_list)
	ld.d	$a2, $s7, %pc_lo12(blocks)
	addi.d	$a3, $a3, 4
	move	$a4, $s8
	b	.LBB2_12
	.p2align	4, , 16
