...
# %bb.41:                               # %land.lhs.true
	...
	addi.w	$a3, $a3, 3
	blt	$a3, $a0, .LBB0_44
.LBB0_42:                               # %lor.lhs.false91
	ld.w	$a3, $s0, %pc_lo12(target_max)
	beqz	$a3, .LBB0_45
# %bb.43:                               # %land.lhs.true93
...
# %bb.46:                               # %land.lhs.true101
	...
	addi.w	$a2, $a2, -3
	blt	$a0, $a2, .LBB0_49
.LBB0_47:                               # %lor.lhs.false105
	ld.w	$a2, $fp, %pc_lo12(target_min)
	beqz	$a2, .LBB0_50
# %bb.48:                               # %land.lhs.true107
...
.LBB0_56:                               # %if.end136.peel
	...
	bnez	$a3, .LBB0_59
# %bb.57:                               # %land.lhs.true138.peel
	ld.bu	$a2, $fp, %pc_lo12(report_perf)
	andi	$a2, $a2, 8
	beqz	$a2, .LBB0_59
# %bb.58:                               # %if.then140.peel
	ld.w	$a3, $a1, 0
	...
	jirl	$ra, $ra, 0
	ld.w	$a0, $s2, %pc_lo12(num_refine)
.LBB0_59:                               # %for.inc145.peel
	blez	$a0, .LBB0_65
# %bb.60:                               # %if.end136.preheader
	ori	$s0, $zero, 1
	ori	$s6, $zero, 4
