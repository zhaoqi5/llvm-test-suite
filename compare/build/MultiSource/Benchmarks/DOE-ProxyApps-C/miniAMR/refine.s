...
# %bb.31:                               # %middle.block
	...
	st.w	$a1, $s5, 0
	beq	$a5, $a3, .LBB0_34
.LBB0_32:                               # %for.body81.preheader96
	alsl.d	$a0, $a4, $a0, 2
	sub.d	$a2, $a2, $a4
	.p2align	4, , 16
.LBB0_33:                               # %for.body81
...
.LBB0_50:                               # %if.end136.peel
	...
	bnez	$a3, .LBB0_53
# %bb.51:                               # %land.lhs.true138.peel
	ld.bu	$a2, $fp, %pc_lo12(report_perf)
	andi	$a2, $a2, 8
	beqz	$a2, .LBB0_53
# %bb.52:                               # %if.then140.peel
	ld.w	$a3, $a1, 0
	...
	jirl	$ra, $ra, 0
	ld.w	$a0, $s2, %pc_lo12(num_refine)
.LBB0_53:                               # %for.inc145.peel
	blez	$a0, .LBB0_59
# %bb.54:                               # %if.end136.preheader
	ori	$s0, $zero, 1
	ori	$s6, $zero, 4
