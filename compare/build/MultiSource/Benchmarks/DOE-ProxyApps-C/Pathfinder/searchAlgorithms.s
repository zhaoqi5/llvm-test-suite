...
# %bb.15:                               # %for.body.lr.ph.i
	...
	b	.LBB4_23
	.p2align	4, , 16
.LBB4_16:                               # %for.inc.us.i
                                        #   in Loop: Header=BB4_17 Depth=3
	ld.w	$a0, $s6, 0
	addi.d	$s3, $s3, 1
	addi.d	$fp, $fp, 8
	bge	$s3, $a0, .LBB4_26
.LBB4_17:                               # %for.body.us.i
                                        #   Parent Loop BB4_4 Depth=1
...
# %bb.18:                               # %if.then21.us.i
	...
	jirl	$ra, $ra, 0
	bnez	$s7, .LBB4_27
# %bb.19:                               # %land.lhs.true.us.i
                                        #   in Loop: Header=BB4_17 Depth=3
	ld.w	$a0, $s4, 0
	bnez	$a0, .LBB4_21
	b	.LBB4_16
	.p2align	4, , 16
.LBB4_20:                               # %if.end31.us.i
                                        #   in Loop: Header=BB4_17 Depth=3
	move	$a0, $s5
	pcaddu18i	$ra, %call36(Bitfield_clear)
	jirl	$ra, $ra, 0
...
# %bb.25:                               # %if.then35.i
	...
	st.w	$zero, $s4, 0
	b	.LBB4_22
.LBB4_26:                               # %findLabelPath.exit.thread27
                                        #   in Loop: Header=BB4_9 Depth=2
	move	$a0, $s5
	pcaddu18i	$ra, %call36(Bitfield_delete)
	jirl	$ra, $ra, 0
