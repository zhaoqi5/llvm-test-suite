...
# %bb.40:
	move	$a1, $zero
.LBB0_41:                               # %for.body254.preheader910
	slli.d	$a2, $a1, 2
	sub.d	$a1, $t7, $a1
	vldi	$vr0, -1144
	vldi	$vr3, -1256
...
# %bb.68:                               # %middle.block635
	beq	$a1, $t7, .LBB0_75
# %bb.69:                               # %vec.epilog.iter.check639
	beqz	$a2, .LBB0_73
.LBB0_70:                               # %vec.epilog.ph641
	move	$t1, $a1
	bstrpick.d	$a1, $t7, 30, 2
	slli.d	$a1, $a1, 2
	...
	alsl.d	$t1, $t1, $s0, 2
	.p2align	4, , 16
.LBB0_71:                               # %vec.epilog.vector.body646
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr3, $t1, 0
	vfmul.s	$vr3, $vr0, $vr3
	vst	$vr3, $a5, 0
	...
	addi.d	$t1, $t1, 16
	bnez	$a2, .LBB0_71
# %bb.72:                               # %vec.epilog.middle.block650
	beq	$a1, $t7, .LBB0_75
...
.LBB0_74:                               # %for.body316
	...
	addi.d	$a5, $a5, 4
	bnez	$a1, .LBB0_74
.LBB0_75:                               # %iter.check662
	ori	$a1, $zero, 4
	bltu	$a7, $a1, .LBB0_78
# %bb.76:                               # %vector.memcheck653
	alsl.d	$a1, $t7, $fp, 2
	bgeu	$s4, $a1, .LBB0_127
# %bb.77:                               # %vector.memcheck653
	alsl.d	$a1, $t7, $s4, 2
	bgeu	$fp, $a1, .LBB0_127
.LBB0_78:
	move	$a1, $zero
...
.LBB0_101:                              # %for.cond.cleanup425
	...
	addi.d	$sp, $sp, 128
	ret
.LBB0_102:                              # %vector.memcheck692
	sub.d	$a5, $a3, $t6
	ori	$a2, $zero, 64
	move	$a1, $zero
	bltu	$a5, $a2, .LBB0_83
# %bb.103:                              # %vector.memcheck692
	sub.d	$a5, $a3, $t0
	bltu	$a5, $a2, .LBB0_83
# %bb.104:                              # %vector.memcheck692
	sub.d	$a2, $a3, $t8
	ori	$a5, $zero, 64
	bltu	$a2, $a5, .LBB0_83
# %bb.105:                              # %vector.main.loop.iter.check703
	ori	$a1, $zero, 16
	bgeu	$a7, $a1, .LBB0_181
# %bb.106:
	move	$a1, $zero
	b	.LBB0_185
.LBB0_107:                              # %vector.memcheck734
	sub.d	$a5, $a4, $t3
	ori	$a2, $zero, 64
	move	$a1, $zero
	bltu	$a5, $a2, .LBB0_87
# %bb.108:                              # %vector.memcheck734
	sub.d	$a5, $a4, $t4
	bltu	$a5, $a2, .LBB0_87
# %bb.109:                              # %vector.memcheck734
	sub.d	$a5, $a4, $t0
	ori	$a2, $zero, 64
	bltu	$a5, $a2, .LBB0_87
# %bb.110:                              # %vector.memcheck734
	sub.d	$a5, $a4, $t5
	bltu	$a5, $a2, .LBB0_87
# %bb.111:                              # %vector.main.loop.iter.check747
	ori	$a1, $zero, 16
	bgeu	$a7, $a1, .LBB0_209
# %bb.112:
	move	$a1, $zero
	b	.LBB0_213
.LBB0_113:                              # %vector.memcheck785
	sub.d	$a5, $s2, $a6
	ori	$a2, $zero, 64
	move	$a1, $zero
	bltu	$a5, $a2, .LBB0_91
# %bb.114:                              # %vector.memcheck785
	sub.d	$a5, $s2, $t2
	bltu	$a5, $a2, .LBB0_91
# %bb.115:                              # %vector.main.loop.iter.check794
	ori	$a1, $zero, 16
	bgeu	$a7, $a1, .LBB0_188
# %bb.116:
	move	$a1, $zero
	b	.LBB0_192
.LBB0_117:                              # %vector.memcheck826
	sub.d	$a5, $s3, $a0
	ori	$a2, $zero, 64
	move	$a1, $zero
	bltu	$a5, $a2, .LBB0_95
# %bb.118:                              # %vector.memcheck826
	sub.d	$a5, $s3, $t0
	bltu	$a5, $a2, .LBB0_95
# %bb.119:                              # %vector.main.loop.iter.check835
	ori	$a1, $zero, 16
	bgeu	$a7, $a1, .LBB0_195
# %bb.120:
	move	$a1, $zero
	b	.LBB0_199
.LBB0_121:                              # %vector.memcheck863
	sub.d	$a5, $a0, $a3
	ori	$a2, $zero, 64
	move	$a1, $zero
	bltu	$a5, $a2, .LBB0_99
# %bb.122:                              # %vector.memcheck863
	sub.d	$a5, $a0, $a4
	bltu	$a5, $a2, .LBB0_99
# %bb.123:                              # %vector.memcheck863
	sub.d	$a5, $a0, $s2
	ori	$a2, $zero, 64
	bltu	$a5, $a2, .LBB0_99
# %bb.124:                              # %vector.memcheck863
	sub.d	$a5, $a0, $s3
	bltu	$a5, $a2, .LBB0_99
# %bb.125:                              # %vector.main.loop.iter.check876
	ori	$a1, $zero, 16
	bgeu	$a7, $a1, .LBB0_216
# %bb.126:
	move	$a1, $zero
	b	.LBB0_220
.LBB0_127:                              # %vector.main.loop.iter.check664
	ori	$a1, $zero, 16
	bgeu	$a7, $a1, .LBB0_174
# %bb.128:
	move	$a1, $zero
...
.LBB0_175:                              # %vector.body668
	...
	addi.d	$t1, $t1, 64
	bnez	$s0, .LBB0_175
# %bb.176:                              # %middle.block675
	beq	$a1, $t7, .LBB0_81
# %bb.177:                              # %vec.epilog.iter.check679
	beqz	$a2, .LBB0_79
.LBB0_178:                              # %vec.epilog.ph681
	move	$t1, $a1
	bstrpick.d	$a1, $t7, 30, 2
	slli.d	$a1, $a1, 2
	sub.d	$a2, $t1, $a1
	...
	alsl.d	$t1, $t1, $fp, 2
	.p2align	4, , 16
.LBB0_179:                              # %vec.epilog.vector.body684
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $t1, 0
	vld	$vr3, $a5, 0
	vfadd.s	$vr0, $vr0, $vr3
	...
	addi.d	$t1, $t1, 16
	bnez	$a2, .LBB0_179
# %bb.180:                              # %vec.epilog.middle.block689
	beq	$a1, $t7, .LBB0_81
	b	.LBB0_79
.LBB0_181:                              # %vector.ph704
	andi	$a2, $t7, 12
	bstrpick.d	$a1, $t7, 30, 4
	slli.d	$a1, $a1, 4
	addi.d	$a5, $a3, 32
...
.LBB0_182:                              # %vector.body707
	...
	addi.d	$s0, $s0, 64
	bnez	$s1, .LBB0_182
# %bb.183:                              # %middle.block716
	beq	$a1, $t7, .LBB0_85
# %bb.184:                              # %vec.epilog.iter.check720
	beqz	$a2, .LBB0_83
.LBB0_185:                              # %vec.epilog.ph722
	...
	alsl.d	$s0, $s0, $t6, 2
	.p2align	4, , 16
.LBB0_186:                              # %vec.epilog.vector.body725
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $s0, 0
	vld	$vr3, $fp, 0
	vld	$vr4, $t1, 0
	...
	addi.d	$s0, $s0, 16
	bnez	$a2, .LBB0_186
# %bb.187:                              # %vec.epilog.middle.block731
	bne	$a1, $t7, .LBB0_83
	b	.LBB0_85
.LBB0_188:                              # %vector.ph795
	andi	$a2, $t7, 12
	bstrpick.d	$a1, $t7, 30, 4
	slli.d	$a1, $a1, 4
	xvreplve0.w	$xr0, $xr2
...
.LBB0_189:                              # %vector.body800
	...
	addi.d	$t3, $t3, 64
	bnez	$t4, .LBB0_189
# %bb.190:                              # %middle.block807
	beq	$a1, $t7, .LBB0_93
# %bb.191:                              # %vec.epilog.iter.check811
	beqz	$a2, .LBB0_91
.LBB0_192:                              # %vec.epilog.ph813
	move	$t3, $a1
	bstrpick.d	$a1, $t7, 30, 2
	slli.d	$a1, $a1, 2
	...
	alsl.d	$t3, $t3, $a6, 2
	.p2align	4, , 16
.LBB0_193:                              # %vec.epilog.vector.body818
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $t3, 0
	vld	$vr3, $t1, 0
	vfmul.s	$vr1, $vr0, $vr1
	...
	addi.d	$t3, $t3, 16
	bnez	$a2, .LBB0_193
# %bb.194:                              # %vec.epilog.middle.block823
	bne	$a1, $t7, .LBB0_91
	b	.LBB0_93
.LBB0_195:                              # %vector.ph836
	andi	$a2, $t7, 12
	bstrpick.d	$a1, $t7, 30, 4
	slli.d	$a1, $a1, 4
	addi.d	$a5, $s3, 32
...
.LBB0_196:                              # %vector.body839
	...
	addi.d	$t1, $t1, 64
	bnez	$t2, .LBB0_196
# %bb.197:                              # %middle.block846
	beq	$a1, $t7, .LBB0_97
# %bb.198:                              # %vec.epilog.iter.check850
	beqz	$a2, .LBB0_95
.LBB0_199:                              # %vec.epilog.ph852
	move	$t1, $a1
	bstrpick.d	$a1, $t7, 30, 2
	slli.d	$a1, $a1, 2
	sub.d	$a2, $t1, $a1
	...
	vldi	$vr0, -1424
	.p2align	4, , 16
.LBB0_200:                              # %vec.epilog.vector.body855
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a6, 0
	vld	$vr2, $t1, 0
	vfsub.s	$vr1, $vr0, $vr1
	...
	addi.d	$t1, $t1, 16
	bnez	$a2, .LBB0_200
# %bb.201:                              # %vec.epilog.middle.block860
	bne	$a1, $t7, .LBB0_95
	b	.LBB0_97
...
.LBB0_210:                              # %vector.body753
	...
	addi.d	$fp, $fp, 64
	bnez	$s0, .LBB0_210
# %bb.211:                              # %middle.block764
	beq	$a1, $t7, .LBB0_89
# %bb.212:                              # %vec.epilog.iter.check768
	beqz	$a2, .LBB0_87
.LBB0_213:                              # %vec.epilog.ph770
	move	$fp, $a1
	bstrpick.d	$a1, $t7, 30, 2
	slli.d	$a1, $a1, 2
	...
	alsl.d	$fp, $fp, $t3, 2
	.p2align	4, , 16
.LBB0_214:                              # %vec.epilog.vector.body775
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr3, $t8, 0
	vld	$vr4, $t6, 0
	vld	$vr5, $fp, 0
	...
	addi.d	$fp, $fp, 16
	bnez	$a2, .LBB0_214
# %bb.215:                              # %vec.epilog.middle.block782
	bne	$a1, $t7, .LBB0_87
	b	.LBB0_89
.LBB0_216:                              # %vector.ph877
	andi	$a2, $t7, 12
	bstrpick.d	$a1, $t7, 30, 4
	slli.d	$a1, $a1, 4
	addi.d	$a5, $a3, 32
...
.LBB0_217:                              # %vector.body880
	...
	addi.d	$t1, $t1, 64
	bnez	$t2, .LBB0_217
# %bb.218:                              # %middle.block891
	beq	$a1, $t7, .LBB0_101
# %bb.219:                              # %vec.epilog.iter.check895
	beqz	$a2, .LBB0_99
.LBB0_220:                              # %vec.epilog.ph897
	move	$t1, $a1
	bstrpick.d	$a1, $t7, 30, 2
	slli.d	$a1, $a1, 2
	sub.d	$a2, $t1, $a1
	...
	alsl.d	$t1, $t1, $a3, 2
	.p2align	4, , 16
.LBB0_221:                              # %vec.epilog.vector.body900
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $t1, 0
	vld	$vr1, $t0, 0
	vld	$vr2, $a7, 0
	...
	addi.d	$t1, $t1, 16
	bnez	$a2, .LBB0_221
# %bb.222:                              # %vec.epilog.middle.block907
	bne	$a1, $t7, .LBB0_99
	b	.LBB0_101
.Lfunc_end0:
...
.LBB2_37:                               # %vector.memcheck276
	...
	xvld	$xr7, $sp, 192                  # 32-byte Folded Reload
	bltu	$a7, $t0, .LBB2_34
# %bb.38:                               # %vector.memcheck276
                                        #   in Loop: Header=BB2_22 Depth=5
	ld.d	$a7, $sp, 168                   # 8-byte Folded Reload
	sub.d	$a7, $a7, $a5
	ori	$t0, $zero, 64
	bltu	$a7, $t0, .LBB2_34
# %bb.39:                               # %vector.memcheck276
                                        #   in Loop: Header=BB2_22 Depth=5
	ld.d	$a7, $sp, 128                   # 8-byte Folded Reload
	sub.d	$a7, $a7, $a5
	bltu	$a7, $t0, .LBB2_34
# %bb.40:                               # %vector.main.loop.iter.check287
                                        #   in Loop: Header=BB2_22 Depth=5
	ori	$a6, $zero, 16
	bgeu	$a0, $a6, .LBB2_42
...
.LBB2_43:                               # %vector.body293
	...
	addi.d	$t0, $t0, 64
	bnez	$t3, .LBB2_43
# %bb.44:                               # %middle.block298
                                        #   in Loop: Header=BB2_22 Depth=5
	ld.d	$a7, $sp, 96                    # 8-byte Folded Reload
	ld.d	$t0, $sp, 160                   # 8-byte Folded Reload
	move	$t2, $a0
	beq	$a6, $a0, .LBB2_51
# %bb.45:                               # %vec.epilog.iter.check302
                                        #   in Loop: Header=BB2_22 Depth=5
	beqz	$t1, .LBB2_34
.LBB2_46:                               # %vec.epilog.ph304
                                        #   in Loop: Header=BB2_22 Depth=5
	move	$t2, $a6
	...
	alsl.d	$t2, $t2, $a5, 2
	.p2align	4, , 16
.LBB2_47:                               # %vec.epilog.vector.body309
                                        #   Parent Loop BB2_7 Depth=1
                                        #     Parent Loop BB2_11 Depth=2
                                        #       Parent Loop BB2_15 Depth=3
                                        #         Parent Loop BB2_18 Depth=4
	...
	addi.d	$t2, $t2, 16
	bnez	$a7, .LBB2_47
# %bb.48:                               # %vec.epilog.middle.block313
                                        #   in Loop: Header=BB2_22 Depth=5
	ld.d	$a7, $sp, 96                    # 8-byte Folded Reload
	ld.d	$t0, $sp, 160                   # 8-byte Folded Reload
	move	$t2, $a0
...
# %bb.69:                               # %vector.memcheck226
	...
	and	$a6, $t2, $a6
	bnez	$a6, .LBB2_55
# %bb.70:                               # %vector.memcheck226
                                        #   in Loop: Header=BB2_22 Depth=5
	sltu	$a6, $a3, $a7
	sltu	$a7, $a2, $a5
	and	$a6, $a6, $a7
	bnez	$a6, .LBB2_55
# %bb.71:                               # %vector.memcheck226
                                        #   in Loop: Header=BB2_22 Depth=5
	sltu	$a6, $a3, $t0
...
.LBB5_12:                               # %for.body48
	...
	addi.d	$a1, $a1, 4
	bnez	$a4, .LBB5_12
.LBB5_13:                               # %iter.check139
	ori	$a1, $zero, 4
	bltu	$a6, $a1, .LBB5_16
# %bb.14:                               # %vector.memcheck130
	bgeu	$a3, $a0, .LBB5_36
# %bb.15:                               # %vector.memcheck130
	alsl.d	$a0, $a6, $a3, 2
	bgeu	$a7, $a0, .LBB5_36
.LBB5_16:
	move	$a0, $zero
.LBB5_17:                               # %for.body76.preheader
	alsl.d	$a1, $a0, $a3, 2
	alsl.d	$a2, $a0, $a7, 2
	sub.d	$a0, $a6, $a0
	.p2align	4, , 16
...
.LBB5_26:                               # %vector.memcheck84
	...
	move	$a4, $zero
	bnez	$t2, .LBB5_11
# %bb.27:                               # %vector.memcheck84
	alsl.d	$t2, $a6, $a1, 2
	sltu	$t3, $a7, $t2
	sltu	$t4, $a1, $a0
	and	$t3, $t3, $t4
	bnez	$t3, .LBB5_11
# %bb.28:                               # %vector.memcheck84
	alsl.d	$t3, $a6, $t0, 2
	sltu	$t4, $a7, $t3
	sltu	$t5, $t0, $a0
	and	$t4, $t4, $t5
	bnez	$t4, .LBB5_11
# %bb.29:                               # %vector.memcheck84
	alsl.d	$t4, $a6, $t1, 2
	sltu	$t5, $a7, $t4
	sltu	$t6, $t1, $a0
	and	$t5, $t5, $t6
	bnez	$t5, .LBB5_11
# %bb.30:                               # %vector.memcheck84
	sltu	$t2, $a2, $t2
	sltu	$t5, $a1, $a5
	and	$t2, $t2, $t5
	bnez	$t2, .LBB5_11
# %bb.31:                               # %vector.memcheck84
	sltu	$t2, $a2, $t3
	sltu	$t3, $t0, $a5
	and	$t2, $t2, $t3
	bnez	$t2, .LBB5_11
# %bb.32:                               # %vector.memcheck84
	sltu	$t2, $a2, $t4
	sltu	$a5, $t1, $a5
	and	$a5, $t2, $a5
	bnez	$a5, .LBB5_11
...
.LBB5_34:                               # %vector.body119
	...
	addi.d	$a5, $a5, 32
	bnez	$t6, .LBB5_34
# %bb.35:                               # %middle.block127
	bne	$a4, $a6, .LBB5_11
	b	.LBB5_13
.LBB5_36:                               # %vector.main.loop.iter.check141
	ori	$a0, $zero, 16
	bgeu	$a6, $a0, .LBB5_38
# %bb.37:
	move	$a0, $zero
	b	.LBB5_42
.LBB5_38:                               # %vector.ph142
	andi	$a1, $a6, 12
...
.LBB6_37:                               #   in Loop: Header=BB6_29 Depth=5
	xvld	$xr7, $sp, 304                  # 32-byte Folded Reload
	b	.LBB6_64
.LBB6_38:                               # %vector.memcheck655
                                        #   in Loop: Header=BB6_29 Depth=5
	ld.d	$a3, $sp, 176                   # 8-byte Folded Reload
	ori	$t0, $zero, 16
	ori	$t1, $zero, 64
	bltu	$a3, $t0, .LBB6_34
# %bb.39:                               # %vector.memcheck655
                                        #   in Loop: Header=BB6_29 Depth=5
	sub.d	$t0, $t7, $a6
	bltu	$t0, $t1, .LBB6_34
# %bb.40:                               # %vector.memcheck655
                                        #   in Loop: Header=BB6_29 Depth=5
	ld.d	$a3, $sp, 224                   # 8-byte Folded Reload
	sub.d	$t0, $a3, $a6
	bltu	$t0, $t1, .LBB6_34
# %bb.41:                               # %vector.main.loop.iter.check666
                                        #   in Loop: Header=BB6_29 Depth=5
	ori	$a3, $zero, 16
	bgeu	$a0, $a3, .LBB6_43
...
.LBB6_44:                               # %vector.body672
	...
	addi.d	$t1, $t1, 64
	bnez	$t4, .LBB6_44
# %bb.45:                               # %middle.block677
                                        #   in Loop: Header=BB6_29 Depth=5
	ld.d	$t0, $sp, 200                   # 8-byte Folded Reload
	move	$t1, $t6
	move	$t3, $a0
	beq	$a7, $a0, .LBB6_52
# %bb.46:                               # %vec.epilog.iter.check681
                                        #   in Loop: Header=BB6_29 Depth=5
	beqz	$t2, .LBB6_34
.LBB6_47:                               # %vec.epilog.ph683
                                        #   in Loop: Header=BB6_29 Depth=5
	move	$t3, $a7
	...
	alsl.d	$t3, $t3, $a6, 2
	.p2align	4, , 16
.LBB6_48:                               # %vec.epilog.vector.body688
                                        #   Parent Loop BB6_5 Depth=1
                                        #     Parent Loop BB6_15 Depth=2
                                        #       Parent Loop BB6_21 Depth=3
                                        #         Parent Loop BB6_24 Depth=4
	...
	addi.d	$t3, $t3, 16
	bnez	$t0, .LBB6_48
# %bb.49:                               # %vec.epilog.middle.block692
                                        #   in Loop: Header=BB6_29 Depth=5
	ld.d	$t0, $sp, 200                   # 8-byte Folded Reload
	move	$t1, $t6
	move	$t3, $a0
...
.LBB6_57:                               # %for.body48.i
	...
	addi.d	$a3, $a3, 4
	bnez	$a6, .LBB6_57
.LBB6_58:                               # %iter.check571
                                        #   in Loop: Header=BB6_29 Depth=5
	ori	$a3, $zero, 4
	bltu	$a0, $a3, .LBB6_61
# %bb.59:                               # %vector.memcheck561
                                        #   in Loop: Header=BB6_29 Depth=5
	ld.d	$a3, $sp, 248                   # 8-byte Folded Reload
	alsl.d	$a3, $a0, $a3, 2
	bgeu	$a2, $a3, .LBB6_76
# %bb.60:                               # %vector.memcheck561
                                        #   in Loop: Header=BB6_29 Depth=5
	alsl.d	$a3, $a0, $a2, 2
	bgeu	$fp, $a3, .LBB6_76
...
# %bb.69:                               # %vector.memcheck601
	...
	and	$a7, $t3, $a7
	bnez	$a7, .LBB6_56
# %bb.70:                               # %vector.memcheck601
                                        #   in Loop: Header=BB6_29 Depth=5
	sltu	$a7, $a4, $t0
	sltu	$t0, $a3, $a6
	and	$a7, $a7, $t0
	bnez	$a7, .LBB6_56
# %bb.71:                               # %vector.memcheck601
                                        #   in Loop: Header=BB6_29 Depth=5
	sltu	$a7, $a4, $t1
...
.LBB6_74:                               # %vector.body644
	...
	addi.d	$a6, $a6, 32
	bnez	$t3, .LBB6_74
# %bb.75:                               # %middle.block652
                                        #   in Loop: Header=BB6_29 Depth=5
	bne	$a5, $a0, .LBB6_56
	b	.LBB6_58
.LBB6_76:                               # %vector.main.loop.iter.check573
                                        #   in Loop: Header=BB6_29 Depth=5
	ori	$a3, $zero, 16
	bgeu	$a0, $a3, .LBB6_78
...
.LBB6_79:                               # %vector.body577
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB6_79
# %bb.80:                               # %middle.block584
                                        #   in Loop: Header=BB6_29 Depth=5
	beq	$a3, $a0, .LBB6_64
# %bb.81:                               # %vec.epilog.iter.check588
                                        #   in Loop: Header=BB6_29 Depth=5
	beqz	$a4, .LBB6_62
.LBB6_82:                               # %vec.epilog.ph590
                                        #   in Loop: Header=BB6_29 Depth=5
	move	$a6, $a3
	...
	alsl.d	$a6, $a6, $a7, 2
	.p2align	4, , 16
.LBB6_83:                               # %vec.epilog.vector.body593
                                        #   Parent Loop BB6_5 Depth=1
                                        #     Parent Loop BB6_15 Depth=2
                                        #       Parent Loop BB6_21 Depth=3
                                        #         Parent Loop BB6_24 Depth=4
	...
	addi.d	$a6, $a6, 16
	bnez	$a4, .LBB6_83
# %bb.84:                               # %vec.epilog.middle.block598
                                        #   in Loop: Header=BB6_29 Depth=5
	beq	$a3, $a0, .LBB6_64
	b	.LBB6_62
	.p2align	4, , 16
...
.LBB6_103:                              # %vector.memcheck521
	...
	ori	$t1, $zero, 64
	bltu	$a7, $t0, .LBB6_100
# %bb.104:                              # %vector.memcheck521
                                        #   in Loop: Header=BB6_94 Depth=4
	sub.d	$a7, $t6, $a5
	bltu	$a7, $t1, .LBB6_100
# %bb.105:                              # %vector.memcheck521
                                        #   in Loop: Header=BB6_94 Depth=4
	ld.d	$a7, $sp, 224                   # 8-byte Folded Reload
	sub.d	$a7, $a7, $a5
	bltu	$a7, $t1, .LBB6_100
# %bb.106:                              # %vector.main.loop.iter.check532
                                        #   in Loop: Header=BB6_94 Depth=4
	ori	$a6, $zero, 16
	bgeu	$a0, $a6, .LBB6_108
...
.LBB6_109:                              # %vector.body538
	...
	addi.d	$t0, $t0, 64
	bnez	$t3, .LBB6_109
# %bb.110:                              # %middle.block543
                                        #   in Loop: Header=BB6_94 Depth=4
	ld.d	$a7, $sp, 200                   # 8-byte Folded Reload
	move	$t0, $t5
	move	$t1, $a0
	beq	$a6, $a0, .LBB6_117
# %bb.111:                              # %vec.epilog.iter.check547
                                        #   in Loop: Header=BB6_94 Depth=4
	beqz	$t2, .LBB6_100
.LBB6_112:                              # %vec.epilog.ph549
                                        #   in Loop: Header=BB6_94 Depth=4
	move	$t2, $a6
	bstrpick.d	$a6, $a0, 30, 2
	slli.d	$a6, $a6, 2
	...
	alsl.d	$t2, $t2, $a5, 2
	.p2align	4, , 16
.LBB6_113:                              # %vec.epilog.vector.body554
                                        #   Parent Loop BB6_5 Depth=1
                                        #     Parent Loop BB6_15 Depth=2
                                        #       Parent Loop BB6_91 Depth=3
                                        #         Parent Loop BB6_94 Depth=4
	...
	addi.d	$t2, $t2, 16
	bnez	$a7, .LBB6_113
# %bb.114:                              # %vec.epilog.middle.block558
                                        #   in Loop: Header=BB6_94 Depth=4
	ld.d	$a7, $sp, 200                   # 8-byte Folded Reload
	move	$t0, $t5
	move	$t1, $a0
...
# %bb.132:                              # %vector.memcheck468
	...
	and	$a6, $t2, $a6
	bnez	$a6, .LBB6_121
# %bb.133:                              # %vector.memcheck468
                                        #   in Loop: Header=BB6_94 Depth=4
	sltu	$a6, $a3, $a7
	sltu	$a7, $a2, $a5
	and	$a6, $a6, $a7
	bnez	$a6, .LBB6_121
# %bb.134:                              # %vector.memcheck468
                                        #   in Loop: Header=BB6_94 Depth=4
	sltu	$a6, $a3, $t0
	ld.d	$a7, $sp, 208                   # 8-byte Folded Reload
	sltu	$a7, $a7, $a5
...
# %bb.156:                              # %middle.block
                                        #   in Loop: Header=BB6_15 Depth=2
	beq	$a1, $s2, .LBB6_14
.LBB6_157:                              # %for.body370.us.preheader695
                                        #   in Loop: Header=BB6_15 Depth=2
	slli.d	$a2, $a1, 5
	alsl.d	$a2, $a1, $a2, 3
	add.d	$a0, $a0, $a2
...
.LBB6_160:                              # %vector.body437
	...
	addi.d	$a2, $a2, 80
	bnez	$a4, .LBB6_160
# %bb.161:                              # %middle.block440
                                        #   in Loop: Header=BB6_15 Depth=2
	beq	$a1, $s2, .LBB6_14
.LBB6_162:                              # %for.body370.preheader696
                                        #   in Loop: Header=BB6_15 Depth=2
	slli.d	$a2, $a1, 5
	alsl.d	$a2, $a1, $a2, 3
	add.d	$a0, $a0, $a2
...
# %bb.28:                               # %vec.epilog.middle.block
	...
	move	$t6, $a7
	beq	$a7, $a2, .LBB9_17
.LBB9_29:                               # %for.body88.us.us.us.preheader
                                        #   in Loop: Header=BB9_18 Depth=2
	alsl.d	$t5, $t6, $t5, 2
	sub.d	$t6, $a2, $t6
	.p2align	4, , 16
.LBB9_30:                               # %for.body88.us.us.us
                                        #   Parent Loop BB9_16 Depth=1
                                        #     Parent Loop BB9_18 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	fld.s	$fa5, $t5, 0
...
# %bb.33:                               # %for.cond111.preheader.lr.ph.split.us
	ld.w	$a2, $fp, 88
	blez	$a2, .LBB9_50
# %bb.34:                               # %for.cond111.preheader.lr.ph.split.us.split.us
	ld.w	$a3, $fp, 36
	blez	$a3, .LBB9_50
# %bb.35:                               # %for.cond111.preheader.lr.ph.split.us.split.us.split.us
	move	$a4, $zero
	ld.d	$a5, $s0, 8
	slli.d	$a6, $a3, 2
	...
	b	.LBB9_37
	.p2align	4, , 16
.LBB9_36:                               # %for.cond111.for.cond.cleanup114_crit_edge.split.us.split.us.us.us.us
                                        #   in Loop: Header=BB9_37 Depth=1
	addi.d	$a4, $a4, 1
	beq	$a4, $a0, .LBB9_50
.LBB9_37:                               # %for.cond111.preheader.us.us.us
                                        # =>This Loop Header: Depth=1
	...
	b	.LBB9_39
	.p2align	4, , 16
.LBB9_38:                               # %for.cond117.for.cond.cleanup120_crit_edge.split.us.us.us.us.us.us
                                        #   in Loop: Header=BB9_39 Depth=2
	addi.d	$t2, $t2, 1
	beq	$t2, $a1, .LBB9_36
.LBB9_39:                               # %for.cond117.preheader.us.us.us.us.us
	...
	b	.LBB9_41
	.p2align	4, , 16
.LBB9_40:                               # %for.cond123.for.cond.cleanup127_crit_edge.us.us.us.us.us.us
                                        #   in Loop: Header=BB9_41 Depth=3
	addi.d	$t4, $t4, 1
	beq	$t4, $a2, .LBB9_38
.LBB9_41:                               # %for.cond123.preheader.us.us.us.us.us.us
                                        #   Parent Loop BB9_37 Depth=1
...
.LBB9_44:                               #   in Loop: Header=BB9_41 Depth=3
	move	$t7, $zero
.LBB9_45:                               # %for.body128.us.us.us.us.us.us.preheader
                                        #   in Loop: Header=BB9_41 Depth=3
	alsl.d	$t5, $t7, $t5, 2
	alsl.d	$t6, $t7, $t6, 2
	sub.d	$t7, $a3, $t7
	.p2align	4, , 16
.LBB9_46:                               # %for.body128.us.us.us.us.us.us
                                        #   Parent Loop BB9_37 Depth=1
                                        #     Parent Loop BB9_39 Depth=2
	...
	b	.LBB9_40
	.p2align	4, , 16
.LBB9_47:                               # %vector.body162.preheader
                                        #   in Loop: Header=BB9_41 Depth=3
	move	$t7, $t5
	move	$t8, $t6
	move	$s0, $a7
	.p2align	4, , 16
.LBB9_48:                               # %vector.body162
                                        #   Parent Loop BB9_37 Depth=1
                                        #     Parent Loop BB9_39 Depth=2
                                        #       Parent Loop BB9_41 Depth=3
                                        # =>      This Inner Loop Header: Depth=4
...
.LBB11_7:                               # %vector.body128
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB11_7
# %bb.8:                                # %middle.block133
                                        #   in Loop: Header=BB11_3 Depth=1
	beq	$a4, $a1, .LBB11_11
.LBB11_9:                               # %for.body17.preheader187
                                        #   in Loop: Header=BB11_3 Depth=1
	alsl.d	$a5, $a4, $fp, 2
	alsl.d	$a3, $a4, $a3, 3
	sub.d	$a1, $a1, $a4
...
.LBB11_35:                              # %vector.body176
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB11_35
# %bb.36:                               # %middle.block181
                                        #   in Loop: Header=BB11_31 Depth=1
	beq	$a4, $a1, .LBB11_39
.LBB11_37:                              # %for.body81.preheader185
                                        #   in Loop: Header=BB11_31 Depth=1
	alsl.d	$a5, $a4, $fp, 2
	alsl.d	$a3, $a4, $a3, 3
	sub.d	$a1, $a1, $a4
...
# %bb.44:                               # %iter.check141
	...
	sub.d	$a3, $s1, $a0
	bltu	$a3, $s4, .LBB11_54
# %bb.45:                               # %vector.main.loop.iter.check143
                                        #   in Loop: Header=BB11_42 Depth=2
	bgeu	$a1, $s6, .LBB11_47
# %bb.46:                               #   in Loop: Header=BB11_42 Depth=2
	move	$a2, $zero
	b	.LBB11_51
.LBB11_47:                              # %vector.ph144
                                        #   in Loop: Header=BB11_42 Depth=2
	andi	$a3, $a1, 12
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
...
.LBB11_48:                              # %vector.body147
	...
	addi.d	$a5, $a5, 64
	bnez	$a7, .LBB11_48
# %bb.49:                               # %middle.block154
                                        #   in Loop: Header=BB11_42 Depth=2
	beq	$a2, $a1, .LBB11_41
# %bb.50:                               # %vec.epilog.iter.check158
                                        #   in Loop: Header=BB11_42 Depth=2
	beqz	$a3, .LBB11_54
.LBB11_51:                              # %vec.epilog.ph160
                                        #   in Loop: Header=BB11_42 Depth=2
	move	$a6, $a2
	bstrpick.d	$a2, $a1, 30, 2
	slli.d	$a2, $a2, 2
	...
	alsl.d	$a6, $a6, $fp, 2
	.p2align	4, , 16
.LBB11_52:                              # %vec.epilog.vector.body163
                                        #   Parent Loop BB11_31 Depth=1
                                        #     Parent Loop BB11_42 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vld	$vr0, $a6, 0
	...
	addi.d	$a6, $a6, 16
	bnez	$a3, .LBB11_52
# %bb.53:                               # %vec.epilog.middle.block168
                                        #   in Loop: Header=BB11_42 Depth=2
	beq	$a2, $a1, .LBB11_41
