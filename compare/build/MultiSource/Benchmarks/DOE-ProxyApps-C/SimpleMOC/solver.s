...
# %bb.44:                               # %middle.block298
	...
	move	$t1, $a0
	beq	$a6, $a0, .LBB2_51
# %bb.45:                               # %vec.epilog.iter.check303
                                        #   in Loop: Header=BB2_22 Depth=5
	andi	$a7, $a0, 12
	beqz	$a7, .LBB2_34
.LBB2_46:                               # %vec.epilog.ph302
                                        #   in Loop: Header=BB2_22 Depth=5
	move	$t2, $a6
	...
	alsl.d	$t2, $t2, $a5, 2
	.p2align	4, , 16
.LBB2_47:                               # %vec.epilog.vector.body310
                                        #   Parent Loop BB2_7 Depth=1
                                        #     Parent Loop BB2_11 Depth=2
                                        #       Parent Loop BB2_15 Depth=3
                                        #         Parent Loop BB2_18 Depth=4
	...
	addi.d	$t2, $t2, 16
	bnez	$a7, .LBB2_47
# %bb.48:                               # %vec.epilog.middle.block314
                                        #   in Loop: Header=BB2_22 Depth=5
	ld.d	$a7, $sp, 112                   # 8-byte Folded Reload
	ld.d	$t0, $sp, 176                   # 8-byte Folded Reload
	move	$t1, $a0
...
.LBB5_13:                               # %for.body48
	...
	addi.d	$a1, $a1, 4
	bnez	$a4, .LBB5_13
.LBB5_14:                               # %iter.check139
	ori	$a1, $zero, 3
	bgeu	$a1, $a6, .LBB5_17
# %bb.15:                               # %vector.memcheck130
	bgeu	$a3, $a0, .LBB5_36
# %bb.16:                               # %vector.memcheck130
	alsl.d	$a0, $a6, $a3, 2
	bgeu	$a7, $a0, .LBB5_36
.LBB5_17:
	move	$a0, $zero
...
# %bb.40:                               # %middle.block152
	beq	$a0, $a6, .LBB5_20
# %bb.41:                               # %vec.epilog.iter.check157
	andi	$a1, $a6, 12
	beqz	$a1, .LBB5_18
.LBB5_42:                               # %vec.epilog.ph156
	move	$a4, $a0
	...
	alsl.d	$a4, $a4, $a7, 2
	.p2align	4, , 16
.LBB5_43:                               # %vec.epilog.vector.body162
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	vld	$vr1, $a2, 0
	vfadd.s	$vr0, $vr0, $vr1
	...
	addi.d	$a4, $a4, 16
	bnez	$a1, .LBB5_43
# %bb.44:                               # %vec.epilog.middle.block167
	bne	$a0, $a6, .LBB5_18
	b	.LBB5_20
.LBB5_45:                               # %vector.ph
...
.LBB6_37:                               #   in Loop: Header=BB6_29 Depth=5
	xvld	$xr7, $sp, 304                  # 32-byte Folded Reload
	b	.LBB6_64
.LBB6_38:                               # %vector.memcheck657
                                        #   in Loop: Header=BB6_29 Depth=5
	ld.d	$a3, $sp, 176                   # 8-byte Folded Reload
	ori	$t0, $zero, 16
	ori	$t1, $zero, 64
	bltu	$a3, $t0, .LBB6_34
# %bb.39:                               # %vector.memcheck657
                                        #   in Loop: Header=BB6_29 Depth=5
	sub.d	$t0, $t6, $a6
	bltu	$t0, $t1, .LBB6_34
# %bb.40:                               # %vector.memcheck657
                                        #   in Loop: Header=BB6_29 Depth=5
	ld.d	$a3, $sp, 224                   # 8-byte Folded Reload
	sub.d	$t0, $a3, $a6
	bltu	$t0, $t1, .LBB6_34
# %bb.41:                               # %vector.main.loop.iter.check668
                                        #   in Loop: Header=BB6_29 Depth=5
	ori	$a3, $zero, 16
	bgeu	$a0, $a3, .LBB6_43
...
.LBB6_44:                               # %vector.body674
	...
	addi.d	$t1, $t1, 64
	bnez	$t3, .LBB6_44
# %bb.45:                               # %middle.block679
                                        #   in Loop: Header=BB6_29 Depth=5
	ld.d	$t0, $sp, 200                   # 8-byte Folded Reload
	move	$t1, $t5
	move	$t2, $a0
	beq	$a7, $a0, .LBB6_52
# %bb.46:                               # %vec.epilog.iter.check684
                                        #   in Loop: Header=BB6_29 Depth=5
	andi	$t0, $a0, 12
	beqz	$t0, .LBB6_34
.LBB6_47:                               # %vec.epilog.ph683
	...
	alsl.d	$t3, $t3, $a6, 2
	.p2align	4, , 16
.LBB6_48:                               # %vec.epilog.vector.body691
                                        #   Parent Loop BB6_5 Depth=1
                                        #     Parent Loop BB6_15 Depth=2
                                        #       Parent Loop BB6_21 Depth=3
                                        #         Parent Loop BB6_24 Depth=4
	...
	addi.d	$t3, $t3, 16
	bnez	$t0, .LBB6_48
# %bb.49:                               # %vec.epilog.middle.block695
                                        #   in Loop: Header=BB6_29 Depth=5
	ld.d	$t0, $sp, 200                   # 8-byte Folded Reload
	move	$t1, $t5
	move	$t2, $a0
...
.LBB6_57:                               # %for.body48.i
	...
	addi.d	$a3, $a3, 4
	bnez	$a6, .LBB6_57
.LBB6_58:                               # %iter.check572
                                        #   in Loop: Header=BB6_29 Depth=5
	ori	$a3, $zero, 4
	bltu	$a0, $a3, .LBB6_61
# %bb.59:                               # %vector.memcheck562
                                        #   in Loop: Header=BB6_29 Depth=5
	ld.d	$a3, $sp, 248                   # 8-byte Folded Reload
	alsl.d	$a3, $a0, $a3, 2
	bgeu	$a2, $a3, .LBB6_76
# %bb.60:                               # %vector.memcheck562
                                        #   in Loop: Header=BB6_29 Depth=5
	alsl.d	$a3, $a0, $a2, 2
	bgeu	$fp, $a3, .LBB6_76
...
# %bb.69:                               # %vector.memcheck603
	...
	and	$a7, $t3, $a7
	bnez	$a7, .LBB6_56
# %bb.70:                               # %vector.memcheck603
                                        #   in Loop: Header=BB6_29 Depth=5
	sltu	$a7, $a4, $t0
	sltu	$t0, $a3, $a6
	and	$a7, $a7, $t0
	bnez	$a7, .LBB6_56
# %bb.71:                               # %vector.memcheck603
                                        #   in Loop: Header=BB6_29 Depth=5
	sltu	$a7, $a4, $t1
...
.LBB6_74:                               # %vector.body646
	...
	addi.d	$a6, $a6, 32
	bnez	$t3, .LBB6_74
# %bb.75:                               # %middle.block654
                                        #   in Loop: Header=BB6_29 Depth=5
	bne	$a5, $a0, .LBB6_56
	b	.LBB6_58
.LBB6_76:                               # %vector.main.loop.iter.check574
                                        #   in Loop: Header=BB6_29 Depth=5
	ori	$a3, $zero, 16
	bgeu	$a0, $a3, .LBB6_78
...
.LBB6_79:                               # %vector.body578
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB6_79
# %bb.80:                               # %middle.block585
                                        #   in Loop: Header=BB6_29 Depth=5
	beq	$a3, $a0, .LBB6_64
# %bb.81:                               # %vec.epilog.iter.check590
                                        #   in Loop: Header=BB6_29 Depth=5
	andi	$a4, $a0, 12
	beqz	$a4, .LBB6_62
.LBB6_82:                               # %vec.epilog.ph589
                                        #   in Loop: Header=BB6_29 Depth=5
	move	$a6, $a3
	...
	alsl.d	$a6, $a6, $a7, 2
	.p2align	4, , 16
.LBB6_83:                               # %vec.epilog.vector.body595
                                        #   Parent Loop BB6_5 Depth=1
                                        #     Parent Loop BB6_15 Depth=2
                                        #       Parent Loop BB6_21 Depth=3
                                        #         Parent Loop BB6_24 Depth=4
	...
	addi.d	$a6, $a6, 16
	bnez	$a4, .LBB6_83
# %bb.84:                               # %vec.epilog.middle.block600
                                        #   in Loop: Header=BB6_29 Depth=5
	beq	$a3, $a0, .LBB6_64
	b	.LBB6_62
	.p2align	4, , 16
...
# %bb.110:                              # %middle.block543
	...
	move	$t1, $a0
	beq	$a6, $a0, .LBB6_117
# %bb.111:                              # %vec.epilog.iter.check548
                                        #   in Loop: Header=BB6_94 Depth=4
	andi	$a7, $a0, 12
	beqz	$a7, .LBB6_100
.LBB6_112:                              # %vec.epilog.ph547
                                        #   in Loop: Header=BB6_94 Depth=4
	move	$t2, $a6
	bstrpick.d	$a6, $a0, 30, 2
	slli.d	$a6, $a6, 2
	...
	alsl.d	$t2, $t2, $a5, 2
	.p2align	4, , 16
.LBB6_113:                              # %vec.epilog.vector.body555
                                        #   Parent Loop BB6_5 Depth=1
                                        #     Parent Loop BB6_15 Depth=2
                                        #       Parent Loop BB6_91 Depth=3
                                        #         Parent Loop BB6_94 Depth=4
	...
	addi.d	$t2, $t2, 16
	bnez	$a7, .LBB6_113
# %bb.114:                              # %vec.epilog.middle.block559
                                        #   in Loop: Header=BB6_94 Depth=4
	ld.d	$a7, $sp, 200                   # 8-byte Folded Reload
	move	$t0, $t4
	move	$t1, $a0
...
# %bb.156:                              # %middle.block
                                        #   in Loop: Header=BB6_15 Depth=2
	beq	$a1, $s2, .LBB6_14
.LBB6_157:                              # %for.body370.us.preheader698
                                        #   in Loop: Header=BB6_15 Depth=2
	slli.d	$a2, $a1, 5
	alsl.d	$a2, $a1, $a2, 3
	add.d	$a0, $a0, $a2
...
# %bb.161:                              # %middle.block440
                                        #   in Loop: Header=BB6_15 Depth=2
	beq	$a1, $s2, .LBB6_14
.LBB6_162:                              # %for.body370.preheader699
                                        #   in Loop: Header=BB6_15 Depth=2
	slli.d	$a2, $a1, 5
	alsl.d	$a2, $a1, $a2, 3
	add.d	$a0, $a0, $a2
...
# %bb.8:                                # %middle.block133
                                        #   in Loop: Header=BB11_3 Depth=1
	beq	$a4, $a1, .LBB11_11
.LBB11_9:                               # %for.body17.preheader188
                                        #   in Loop: Header=BB11_3 Depth=1
	alsl.d	$a5, $a4, $fp, 2
	alsl.d	$a3, $a4, $a3, 3
	sub.d	$a1, $a1, $a4
...
.LBB11_35:                              # %vector.body177
	...
	addi.d	$a6, $a6, 32
	bnez	$a7, .LBB11_35
# %bb.36:                               # %middle.block182
                                        #   in Loop: Header=BB11_31 Depth=1
	beq	$a4, $a1, .LBB11_39
.LBB11_37:                              # %for.body81.preheader186
                                        #   in Loop: Header=BB11_31 Depth=1
	alsl.d	$a5, $a4, $fp, 2
	alsl.d	$a3, $a4, $a3, 3
	sub.d	$a1, $a1, $a4
...
# %bb.49:                               # %middle.block154
                                        #   in Loop: Header=BB11_42 Depth=2
	beq	$a2, $a1, .LBB11_41
# %bb.50:                               # %vec.epilog.iter.check159
                                        #   in Loop: Header=BB11_42 Depth=2
	andi	$a3, $a1, 12
	beqz	$a3, .LBB11_54
.LBB11_51:                              # %vec.epilog.ph158
                                        #   in Loop: Header=BB11_42 Depth=2
	move	$a6, $a2
	bstrpick.d	$a2, $a1, 30, 2
	slli.d	$a2, $a2, 2
	...
	alsl.d	$a6, $a6, $fp, 2
	.p2align	4, , 16
.LBB11_52:                              # %vec.epilog.vector.body164
                                        #   Parent Loop BB11_31 Depth=1
                                        #     Parent Loop BB11_42 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vld	$vr0, $a6, 0
	...
	addi.d	$a6, $a6, 16
	bnez	$a3, .LBB11_52
# %bb.53:                               # %vec.epilog.middle.block169
                                        #   in Loop: Header=BB11_42 Depth=2
	beq	$a2, $a1, .LBB11_41
