...
.LBB6_37:                               #   in Loop: Header=BB6_29 Depth=5
	xvld	$xr7, $sp, 304                  # 32-byte Folded Reload
	b	.LBB6_64
.LBB6_38:                               # %vector.memcheck646
                                        #   in Loop: Header=BB6_29 Depth=5
	ld.d	$a3, $sp, 176                   # 8-byte Folded Reload
	ori	$t0, $zero, 16
	ori	$t1, $zero, 64
	bltu	$a3, $t0, .LBB6_34
# %bb.39:                               # %vector.memcheck646
                                        #   in Loop: Header=BB6_29 Depth=5
	sub.d	$t0, $t6, $a6
	bltu	$t0, $t1, .LBB6_34
# %bb.40:                               # %vector.memcheck646
                                        #   in Loop: Header=BB6_29 Depth=5
	ld.d	$a3, $sp, 224                   # 8-byte Folded Reload
	sub.d	$t0, $a3, $a6
	bltu	$t0, $t1, .LBB6_34
# %bb.41:                               # %vector.main.loop.iter.check657
                                        #   in Loop: Header=BB6_29 Depth=5
	ori	$a3, $zero, 16
	bgeu	$a0, $a3, .LBB6_43
...
.LBB6_44:                               # %vector.body663
	...
	addi.d	$t1, $t1, 64
	bnez	$t3, .LBB6_44
# %bb.45:                               # %middle.block668
                                        #   in Loop: Header=BB6_29 Depth=5
	ld.d	$t0, $sp, 200                   # 8-byte Folded Reload
	move	$t1, $t5
	move	$t2, $a0
	beq	$a7, $a0, .LBB6_52
# %bb.46:                               # %vec.epilog.iter.check673
                                        #   in Loop: Header=BB6_29 Depth=5
	andi	$t0, $a0, 12
	beqz	$t0, .LBB6_34
.LBB6_47:                               # %vec.epilog.ph672
                                        #   in Loop: Header=BB6_29 Depth=5
	move	$t3, $a7
	...
	alsl.d	$t3, $t3, $a6, 2
	.p2align	4, , 16
.LBB6_48:                               # %vec.epilog.vector.body680
                                        #   Parent Loop BB6_5 Depth=1
                                        #     Parent Loop BB6_15 Depth=2
                                        #       Parent Loop BB6_21 Depth=3
                                        #         Parent Loop BB6_24 Depth=4
	...
	addi.d	$t3, $t3, 16
	bnez	$t0, .LBB6_48
# %bb.49:                               # %vec.epilog.middle.block684
                                        #   in Loop: Header=BB6_29 Depth=5
	ld.d	$t0, $sp, 200                   # 8-byte Folded Reload
	move	$t1, $t5
	move	$t2, $a0
...
.LBB6_57:                               # %for.body48.i
	...
	addi.d	$a3, $a3, 4
	bnez	$a6, .LBB6_57
.LBB6_58:                               # %iter.check561
                                        #   in Loop: Header=BB6_29 Depth=5
	ori	$a3, $zero, 4
	bltu	$a0, $a3, .LBB6_61
# %bb.59:                               # %vector.memcheck551
                                        #   in Loop: Header=BB6_29 Depth=5
	ld.d	$a3, $sp, 248                   # 8-byte Folded Reload
	alsl.d	$a3, $a0, $a3, 2
	bgeu	$a2, $a3, .LBB6_76
# %bb.60:                               # %vector.memcheck551
                                        #   in Loop: Header=BB6_29 Depth=5
	alsl.d	$a3, $a0, $a2, 2
	bgeu	$fp, $a3, .LBB6_76
...
# %bb.69:                               # %vector.memcheck592
	...
	and	$a7, $t3, $a7
	bnez	$a7, .LBB6_56
# %bb.70:                               # %vector.memcheck592
                                        #   in Loop: Header=BB6_29 Depth=5
	sltu	$a7, $a4, $t0
	sltu	$t0, $a3, $a6
	and	$a7, $a7, $t0
	bnez	$a7, .LBB6_56
# %bb.71:                               # %vector.memcheck592
                                        #   in Loop: Header=BB6_29 Depth=5
	sltu	$a7, $a4, $t1
...
.LBB6_74:                               # %vector.body635
	...
	addi.d	$a6, $a6, 32
	bnez	$t3, .LBB6_74
# %bb.75:                               # %middle.block643
                                        #   in Loop: Header=BB6_29 Depth=5
	bne	$a5, $a0, .LBB6_56
	b	.LBB6_58
.LBB6_76:                               # %vector.main.loop.iter.check563
                                        #   in Loop: Header=BB6_29 Depth=5
	ori	$a3, $zero, 16
	bgeu	$a0, $a3, .LBB6_78
...
.LBB6_79:                               # %vector.body567
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB6_79
# %bb.80:                               # %middle.block574
                                        #   in Loop: Header=BB6_29 Depth=5
	beq	$a3, $a0, .LBB6_64
# %bb.81:                               # %vec.epilog.iter.check579
                                        #   in Loop: Header=BB6_29 Depth=5
	andi	$a4, $a0, 12
	beqz	$a4, .LBB6_62
.LBB6_82:                               # %vec.epilog.ph578
                                        #   in Loop: Header=BB6_29 Depth=5
	move	$a6, $a3
	...
	alsl.d	$a6, $a6, $a7, 2
	.p2align	4, , 16
.LBB6_83:                               # %vec.epilog.vector.body584
                                        #   Parent Loop BB6_5 Depth=1
                                        #     Parent Loop BB6_15 Depth=2
                                        #       Parent Loop BB6_21 Depth=3
                                        #         Parent Loop BB6_24 Depth=4
	...
	addi.d	$a6, $a6, 16
	bnez	$a4, .LBB6_83
# %bb.84:                               # %vec.epilog.middle.block589
                                        #   in Loop: Header=BB6_29 Depth=5
	beq	$a3, $a0, .LBB6_64
	b	.LBB6_62
	.p2align	4, , 16
...
.LBB6_103:                              # %vector.memcheck510
	...
	ori	$t1, $zero, 64
	bltu	$a7, $t0, .LBB6_100
# %bb.104:                              # %vector.memcheck510
                                        #   in Loop: Header=BB6_94 Depth=4
	sub.d	$a7, $t5, $a5
	bltu	$a7, $t1, .LBB6_100
# %bb.105:                              # %vector.memcheck510
                                        #   in Loop: Header=BB6_94 Depth=4
	ld.d	$a7, $sp, 224                   # 8-byte Folded Reload
	sub.d	$a7, $a7, $a5
	bltu	$a7, $t1, .LBB6_100
# %bb.106:                              # %vector.main.loop.iter.check521
                                        #   in Loop: Header=BB6_94 Depth=4
	ori	$a6, $zero, 16
	bgeu	$a0, $a6, .LBB6_108
...
.LBB6_109:                              # %vector.body527
	...
	addi.d	$t0, $t0, 64
	bnez	$t2, .LBB6_109
# %bb.110:                              # %middle.block532
                                        #   in Loop: Header=BB6_94 Depth=4
	ld.d	$a7, $sp, 200                   # 8-byte Folded Reload
	move	$t0, $t4
	move	$t1, $a0
	beq	$a6, $a0, .LBB6_117
# %bb.111:                              # %vec.epilog.iter.check537
                                        #   in Loop: Header=BB6_94 Depth=4
	andi	$a7, $a0, 12
	beqz	$a7, .LBB6_100
.LBB6_112:                              # %vec.epilog.ph536
                                        #   in Loop: Header=BB6_94 Depth=4
	move	$t2, $a6
	bstrpick.d	$a6, $a0, 30, 2
	slli.d	$a6, $a6, 2
	...
	alsl.d	$t2, $t2, $a5, 2
	.p2align	4, , 16
.LBB6_113:                              # %vec.epilog.vector.body544
                                        #   Parent Loop BB6_5 Depth=1
                                        #     Parent Loop BB6_15 Depth=2
                                        #       Parent Loop BB6_91 Depth=3
                                        #         Parent Loop BB6_94 Depth=4
	...
	addi.d	$t2, $t2, 16
	bnez	$a7, .LBB6_113
# %bb.114:                              # %vec.epilog.middle.block548
                                        #   in Loop: Header=BB6_94 Depth=4
	ld.d	$a7, $sp, 200                   # 8-byte Folded Reload
	move	$t0, $t4
	move	$t1, $a0
...
# %bb.132:                              # %vector.memcheck457
	...
	and	$a6, $t2, $a6
	bnez	$a6, .LBB6_121
# %bb.133:                              # %vector.memcheck457
                                        #   in Loop: Header=BB6_94 Depth=4
	sltu	$a6, $a3, $a7
	sltu	$a7, $a2, $a5
	and	$a6, $a6, $a7
	bnez	$a6, .LBB6_121
# %bb.134:                              # %vector.memcheck457
                                        #   in Loop: Header=BB6_94 Depth=4
	sltu	$a6, $a3, $t0
	ld.d	$a7, $sp, 208                   # 8-byte Folded Reload
	sltu	$a7, $a7, $a5
...
# %bb.156:                              # %middle.block
                                        #   in Loop: Header=BB6_15 Depth=2
	beq	$a1, $s2, .LBB6_14
.LBB6_157:                              # %for.body370.us.preheader687
                                        #   in Loop: Header=BB6_15 Depth=2
	slli.d	$a2, $a1, 5
	alsl.d	$a2, $a1, $a2, 3
	add.d	$a0, $a0, $a2
...
.LBB6_160:                              # %vector.body426
	...
	addi.d	$a2, $a2, 80
	bnez	$a4, .LBB6_160
# %bb.161:                              # %middle.block429
                                        #   in Loop: Header=BB6_15 Depth=2
	beq	$a1, $s2, .LBB6_14
.LBB6_162:                              # %for.body370.preheader688
                                        #   in Loop: Header=BB6_15 Depth=2
	slli.d	$a2, $a1, 5
	alsl.d	$a2, $a1, $a2, 3
	add.d	$a0, $a0, $a2
