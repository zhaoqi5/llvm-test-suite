...
# %bb.10:                               # %for.body68.preheader
	...
	beqz	$t8, .LBB0_13
# %bb.11:                               # %vector.body1039.preheader
                                        #   in Loop: Header=BB0_6 Depth=1
	move	$a1, $zero
	lu12i.w	$a2, 2
	ori	$a2, $a2, 376
...
.LBB0_17:                               # %vector.body1027
	...
	addi.d	$a4, $a4, 288
	bnez	$a3, .LBB0_17
.LBB0_18:                               # %for.body82.preheader1054
                                        #   in Loop: Header=BB0_6 Depth=1
	slli.d	$a3, $a1, 7
	alsl.d	$a3, $a1, $a3, 4
	lu12i.w	$a4, 2
...
.LBB0_23:                               # %vector.body1013
	...
	addi.d	$a4, $a4, 64
	bnez	$a3, .LBB0_23
.LBB0_24:                               # %for.body94.preheader1053
                                        #   in Loop: Header=BB0_6 Depth=1
	slli.d	$a3, $a2, 7
	alsl.d	$a3, $a2, $a3, 4
	lu12i.w	$a4, 1
...
.LBB0_29:                               # %vector.body999
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB0_29
# %bb.30:                               # %middle.block1005
                                        #   in Loop: Header=BB0_6 Depth=1
	ld.d	$t5, $sp, 104                   # 8-byte Folded Reload
	beq	$a2, $a3, .LBB0_33
.LBB0_31:                               # %for.body109.preheader1052
                                        #   in Loop: Header=BB0_6 Depth=1
	slli.d	$a2, $a1, 7
	alsl.d	$a2, $a1, $a2, 4
	lu12i.w	$a3, 1
...
.LBB0_73:                               # %for.body.i297.preheader1051
                                        #   in Loop: Header=BB0_52 Depth=2
	add.d	$a0, $t8, $a3
	alsl.d	$a1, $a3, $t3, 3
	alsl.d	$a2, $a3, $t2, 3
...
# %bb.83:                               #   in Loop: Header=BB0_52 Depth=2
	ld.d	$a3, $sp, 184                   # 8-byte Folded Reload
.LBB0_84:                               # %for.body.i306.preheader1050
                                        #   in Loop: Header=BB0_52 Depth=2
	add.d	$a0, $t8, $a3
	alsl.d	$a1, $a3, $t5, 3
	alsl.d	$a2, $a3, $t0, 3
...
# %bb.101:                              #   in Loop: Header=BB0_52 Depth=2
	ld.d	$a3, $sp, 184                   # 8-byte Folded Reload
.LBB0_102:                              # %for.body.i354.preheader1049
                                        #   in Loop: Header=BB0_52 Depth=2
	add.d	$a0, $t8, $a3
	alsl.d	$a1, $a3, $t3, 3
	alsl.d	$a2, $a3, $t0, 3
...
# %bb.119:                              #   in Loop: Header=BB0_52 Depth=2
	ld.d	$a2, $sp, 184                   # 8-byte Folded Reload
.LBB0_120:                              # %for.body.i378.preheader1048
                                        #   in Loop: Header=BB0_52 Depth=2
	add.d	$a0, $t8, $a2
	alsl.d	$a1, $a2, $s8, 3
	alsl.d	$a2, $a2, $a7, 3
...
# %bb.133:                              #   in Loop: Header=BB0_52 Depth=2
	ld.d	$a2, $sp, 184                   # 8-byte Folded Reload
.LBB0_134:                              # %for.body.i402.preheader1047
                                        #   in Loop: Header=BB0_52 Depth=2
	add.d	$a0, $t8, $a2
	alsl.d	$a1, $a2, $t1, 3
	alsl.d	$a2, $a2, $s8, 3
...
# %bb.140:                              #   in Loop: Header=BB0_52 Depth=2
	ld.d	$a2, $sp, 184                   # 8-byte Folded Reload
.LBB0_141:                              # %for.body.i414.preheader1046
                                        #   in Loop: Header=BB0_52 Depth=2
	add.d	$a0, $t8, $a2
	alsl.d	$a1, $a2, $t0, 3
	alsl.d	$a2, $a2, $s8, 3
...
# %bb.168:                              #   in Loop: Header=BB0_52 Depth=2
	ld.d	$a2, $sp, 184                   # 8-byte Folded Reload
.LBB0_169:                              # %for.body.i462.preheader1045
                                        #   in Loop: Header=BB0_52 Depth=2
	ld.d	$a3, $sp, 168                   # 8-byte Folded Reload
	add.d	$a0, $t8, $a2
	alsl.d	$a1, $a2, $s7, 3
