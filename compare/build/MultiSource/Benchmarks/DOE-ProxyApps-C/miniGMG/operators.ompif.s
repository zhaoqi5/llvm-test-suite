...
.LBB1_12:                               # %vector.body83
	...
	st.w	$a0, $sp, 140
	b	.LBB1_17
.LBB1_13:                               # %pred.store.continue111.1.critedge
	xvld	$xr0, $sp, 72
...
# %bb.24:                               # %lor.lhs.false
	...
	ld.w	$a2, $a0, 4
	bnez	$a2, .LBB1_19
.LBB1_25:                               # %lor.lhs.false37
                                        #   in Loop: Header=BB1_21 Depth=1
	beqz	$s0, .LBB1_20
# %bb.26:                               # %lor.lhs.false37
                                        #   in Loop: Header=BB1_21 Depth=1
	ld.w	$a0, $a0, 8
	bnez	$a0, .LBB1_19
	b	.LBB1_20
...
.LBB8_14:                               # %vector.scevcheck343
	...
	move	$a5, $zero
	blt	$a3, $s7, .LBB8_11
# %bb.15:                               # %vector.scevcheck343
                                        #   in Loop: Header=BB8_9 Depth=3
	add.w	$t2, $s2, $a0
	add.w	$a3, $a0, $s0
	blt	$a3, $t2, .LBB8_11
# %bb.16:                               # %vector.scevcheck343
                                        #   in Loop: Header=BB8_9 Depth=3
...
# %bb.17:                               # %vector.scevcheck343
	...
	add.w	$a7, $a7, $t0
	blt	$a7, $a3, .LBB8_11
# %bb.18:                               # %vector.scevcheck343
                                        #   in Loop: Header=BB8_9 Depth=3
	add.w	$a7, $s5, $a0
	ld.d	$t0, $sp, 288                   # 8-byte Folded Reload
	add.w	$a0, $a0, $t0
	blt	$a0, $a7, .LBB8_11
# %bb.19:                               # %vector.scevcheck343
                                        #   in Loop: Header=BB8_9 Depth=3
	ld.d	$a0, $sp, 280                   # 8-byte Folded Reload
	srli.d	$a0, $a0, 31
	bnez	$a0, .LBB8_11
# %bb.20:                               # %vector.memcheck356
                                        #   in Loop: Header=BB8_9 Depth=3
...
.LBB8_27:                               # %for.end149
	...
	ori	$a0, $zero, 1
	blt	$t4, $a0, .LBB8_50
# %bb.28:                               # %for.cond186.preheader.us.preheader
                                        #   in Loop: Header=BB8_3 Depth=1
	ld.d	$a0, $sp, 64                    # 8-byte Folded Reload
	ld.d	$a0, $a0, 48
	...
	b	.LBB8_30
	.p2align	4, , 16
.LBB8_29:                               # %for.cond186.for.inc231_crit_edge.us
	...
	beq	$a3, $a1, .LBB8_50
.LBB8_30:                               # %for.cond186.preheader.us
                                        #   Parent Loop BB8_3 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB8_32 Depth 3
                                        #         Child Loop BB8_48 Depth 4
	...
	ld.d	$a2, $sp, 216                   # 8-byte Folded Reload
	blt	$a2, $a1, .LBB8_29
# %bb.31:                               # %for.cond190.preheader.us.us.preheader
                                        #   in Loop: Header=BB8_30 Depth=2
	move	$ra, $zero
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	ld.d	$a2, $sp, 200                   # 8-byte Folded Reload
	...
	.p2align	4, , 16
.LBB8_32:                               # %for.cond190.preheader.us.us
                                        #   Parent Loop BB8_3 Depth=1
...
# %bb.33:                               #   in Loop: Header=BB8_32 Depth=3
	move	$s7, $zero
.LBB8_34:                               # %for.body193.us.us.preheader
...
.LBB8_35:                               # %for.body193.us.us
	...
	addi.w	$a7, $a7, 1
	bnez	$s7, .LBB8_35
.LBB8_36:                               # %for.cond190.for.inc228_crit_edge.us.us
                                        #   in Loop: Header=BB8_32 Depth=3
	addi.w	$ra, $ra, 1
	add.w	$a3, $a3, $t1
	add.d	$a2, $a2, $t6
...
.LBB8_37:                               # %vector.scevcheck273
	...
	move	$s7, $zero
	blt	$a1, $s0, .LBB8_34
# %bb.38:                               # %vector.scevcheck273
                                        #   in Loop: Header=BB8_32 Depth=3
	add.w	$s5, $s1, $t2
	add.w	$a1, $t2, $t0
	blt	$a1, $s5, .LBB8_34
# %bb.39:                               # %vector.scevcheck273
                                        #   in Loop: Header=BB8_32 Depth=3
	add.w	$s3, $s2, $t2
	ld.d	$a1, $sp, 320                   # 8-byte Folded Reload
	add.w	$a1, $t2, $a1
	blt	$a1, $s3, .LBB8_34
# %bb.40:                               # %vector.scevcheck273
                                        #   in Loop: Header=BB8_32 Depth=3
	mul.d	$a7, $t1, $ra
	...
	add.w	$a7, $a7, $t7
	blt	$a7, $a1, .LBB8_34
# %bb.41:                               # %vector.scevcheck273
                                        #   in Loop: Header=BB8_32 Depth=3
	add.w	$a7, $a5, $t2
	ld.d	$t7, $sp, 296                   # 8-byte Folded Reload
	add.w	$t2, $t2, $t7
	blt	$t2, $a7, .LBB8_34
# %bb.42:                               # %vector.scevcheck273
                                        #   in Loop: Header=BB8_32 Depth=3
	ld.d	$t2, $sp, 288                   # 8-byte Folded Reload
	srli.d	$t2, $t2, 31
	bnez	$t2, .LBB8_34
# %bb.43:                               # %vector.memcheck286
                                        #   in Loop: Header=BB8_32 Depth=3
	ld.d	$t2, $sp, 280                   # 8-byte Folded Reload
	alsl.d	$t7, $a1, $t2, 3
...
.LBB8_50:                               # %for.end233
	...
	ori	$a0, $zero, 1
	blt	$t4, $a0, .LBB8_2
# %bb.51:                               # %for.cond270.preheader.us.preheader
                                        #   in Loop: Header=BB8_3 Depth=1
	ld.d	$a0, $sp, 64                    # 8-byte Folded Reload
	ld.d	$a0, $a0, 56
	st.d	$zero, $sp, 232                 # 8-byte Folded Spill
	...
	b	.LBB8_53
	.p2align	4, , 16
.LBB8_52:                               # %for.cond270.for.inc315_crit_edge.us
	...
	st.d	$a3, $sp, 200                   # 8-byte Folded Spill
	beq	$a3, $a1, .LBB8_2
.LBB8_53:                               # %for.cond270.preheader.us
                                        #   Parent Loop BB8_3 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB8_55 Depth 3
                                        #         Child Loop BB8_71 Depth 4
	...
	ld.d	$a2, $sp, 216                   # 8-byte Folded Reload
	blt	$a2, $a1, .LBB8_52
# %bb.54:                               # %for.cond274.preheader.us.us.preheader
                                        #   in Loop: Header=BB8_53 Depth=2
	move	$ra, $zero
	ld.d	$a1, $sp, 240                   # 8-byte Folded Reload
	ld.d	$a2, $sp, 200                   # 8-byte Folded Reload
	...
	ld.d	$a3, $sp, 208                   # 8-byte Folded Reload
	.p2align	4, , 16
.LBB8_55:                               # %for.cond274.preheader.us.us
                                        #   Parent Loop BB8_3 Depth=1
                                        ...
                                        #         Child Loop BB8_58 Depth 4
	bgeu	$t3, $a6, .LBB8_60
# %bb.56:                               #   in Loop: Header=BB8_55 Depth=3
	move	$s8, $zero
.LBB8_57:                               # %for.body277.us.us.preheader
...
.LBB8_58:                               # %for.body277.us.us
	...
	addi.w	$a7, $a7, 1
	bnez	$s8, .LBB8_58
.LBB8_59:                               # %for.cond274.for.inc312_crit_edge.us.us
                                        #   in Loop: Header=BB8_55 Depth=3
	addi.w	$ra, $ra, 1
	add.w	$a3, $a3, $t1
	add.d	$a2, $a2, $t6
