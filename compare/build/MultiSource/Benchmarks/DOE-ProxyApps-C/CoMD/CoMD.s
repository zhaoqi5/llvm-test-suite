...
# %bb.33:                               # %iter.check101
	...
	ld.d	$a2, $a2, 120
	bltu	$a1, $s6, .LBB0_36
# %bb.34:                               # %vector.memcheck93
                                        #   in Loop: Header=BB0_32 Depth=1
	alsl.d	$a3, $a1, $a2, 2
	bgeu	$a0, $a3, .LBB0_39
# %bb.35:                               # %vector.memcheck93
                                        #   in Loop: Header=BB0_32 Depth=1
	addi.d	$a3, $a0, 4
	bgeu	$a2, $a3, .LBB0_39
...
.LBB0_38:                               # %for.body.i
	...
	bnez	$a1, .LBB0_38
	b	.LBB0_31
.LBB0_39:                               # %vector.main.loop.iter.check103
                                        #   in Loop: Header=BB0_32 Depth=1
	bgeu	$a1, $s7, .LBB0_41
...
.LBB0_45:                               # %vec.epilog.ph122
	...
	alsl.d	$a5, $a5, $a2, 2
	.p2align	4, , 16
.LBB0_46:                               # %vec.epilog.vector.body125
                                        #   Parent Loop BB0_32 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr1, $a5, 0
	vadd.w	$vr0, $vr1, $vr0
...
# %bb.49:                               # %iter.check142
	...
	ori	$a3, $zero, 4
	bltu	$a1, $a3, .LBB0_52
# %bb.50:                               # %vector.memcheck134
	alsl.d	$a3, $a1, $a2, 2
	bgeu	$a0, $a3, .LBB0_64
# %bb.51:                               # %vector.memcheck134
	addi.d	$a3, $a0, 4
	bgeu	$a2, $a3, .LBB0_64
.LBB0_52:
	move	$a3, $zero
	move	$a4, $zero
.LBB0_53:                               # %for.body.i34.preheader
	sub.d	$a1, $a1, $a3
	alsl.d	$a2, $a3, $a2, 2
	.p2align	4, , 16
.LBB0_54:                               # %for.body.i34
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a3, $a2, 0
	add.d	$a4, $a3, $a4
	st.w	$a4, $a0, 0
...
# %bb.60:                               # %if.then6.i
	...
	addi.d	$a0, $sp, 64
	jirl	$ra, $a1, 0
.LBB0_61:                               # %destroySimulation.exit
	move	$a0, $s1
	...
	addi.d	$sp, $sp, 2032
	ret
.LBB0_62:                               # %vector.main.loop.iter.check
	ori	$a3, $zero, 16
	bgeu	$a1, $a3, .LBB0_66
# %bb.63:
	move	$a3, $zero
	move	$a4, $zero
	b	.LBB0_70
.LBB0_64:                               # %vector.main.loop.iter.check144
	ori	$a3, $zero, 16
	bgeu	$a1, $a3, .LBB0_73
# %bb.65:
	move	$a3, $zero
...
.LBB0_70:                               # %vec.epilog.ph
	...
	alsl.d	$a5, $a5, $a2, 2
	.p2align	4, , 16
.LBB0_71:                               # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr1, $a5, 0
	vadd.w	$vr0, $vr1, $vr0
	addi.d	$a4, $a4, 4
...
# %bb.75:                               # %middle.block155
	...
	st.w	$a4, $a0, 0
	beq	$a3, $a1, .LBB0_55
# %bb.76:                               # %vec.epilog.iter.check161
	beqz	$a5, .LBB0_53
.LBB0_77:                               # %vec.epilog.ph163
	move	$a5, $a3
	bstrpick.d	$a3, $a1, 30, 2
	slli.d	$a3, $a3, 2
	...
	alsl.d	$a5, $a5, $a2, 2
	.p2align	4, , 16
.LBB0_78:                               # %vec.epilog.vector.body166
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vadd.w	$vr1, $vr0, $vr1
	addi.d	$a4, $a4, 4
	addi.d	$a5, $a5, 16
	bnez	$a4, .LBB0_78
# %bb.79:                               # %vec.epilog.middle.block171
