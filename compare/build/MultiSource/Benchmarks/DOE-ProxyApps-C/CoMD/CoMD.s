...
# %bb.43:                               # %middle.block114
	...
	beq	$a3, $a1, .LBB0_31
# %bb.44:                               # %vec.epilog.iter.check121
                                        #   in Loop: Header=BB0_32 Depth=1
	andi	$a5, $a1, 12
	xvpickve2gr.w	$a4, $xr0, 0
	beqz	$a5, .LBB0_37
.LBB0_45:                               # %vec.epilog.ph120
                                        #   in Loop: Header=BB0_32 Depth=1
	move	$a5, $a3
	...
	alsl.d	$a5, $a5, $a2, 2
	.p2align	4, , 16
.LBB0_46:                               # %vec.epilog.vector.body126
                                        #   Parent Loop BB0_32 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr1, $a5, 0
	vadd.w	$vr0, $vr1, $vr0
	...
	addi.d	$a5, $a5, 16
	bnez	$a4, .LBB0_46
# %bb.47:                               # %vec.epilog.middle.block131
                                        #   in Loop: Header=BB0_32 Depth=1
...
# %bb.51:                               # %iter.check143
	...
	ori	$a3, $zero, 4
	bltu	$a1, $a3, .LBB0_54
# %bb.52:                               # %vector.memcheck135
	alsl.d	$a3, $a1, $a2, 2
	bgeu	$a0, $a3, .LBB0_66
# %bb.53:                               # %vector.memcheck135
	addi.d	$a3, $a0, 4
	bgeu	$a2, $a3, .LBB0_66
.LBB0_54:
	move	$a3, $zero
...
# %bb.65:
	...
	move	$a4, $zero
	b	.LBB0_72
.LBB0_66:                               # %vector.main.loop.iter.check145
	ori	$a3, $zero, 16
	bgeu	$a1, $a3, .LBB0_76
# %bb.67:
	move	$a3, $zero
...
# %bb.78:                               # %middle.block156
	...
	xvstelm.w	$xr0, $a0, 0, 0
	beq	$a3, $a1, .LBB0_57
# %bb.79:                               # %vec.epilog.iter.check163
	andi	$a5, $a1, 12
	xvpickve2gr.w	$a4, $xr0, 0
	beqz	$a5, .LBB0_55
.LBB0_80:                               # %vec.epilog.ph162
	move	$a5, $a3
	bstrpick.d	$a3, $a1, 30, 2
	slli.d	$a3, $a3, 2
	...
	alsl.d	$a5, $a5, $a2, 2
	.p2align	4, , 16
.LBB0_81:                               # %vec.epilog.vector.body168
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vadd.w	$vr1, $vr0, $vr1
	addi.d	$a4, $a4, 4
	addi.d	$a5, $a5, 16
	bnez	$a4, .LBB0_81
# %bb.82:                               # %vec.epilog.middle.block173
