...
.LBB0_2:                                # %for.body
	...
	bge	$s5, $a4, .LBB0_1
# %bb.3:                                # %for.cond35.preheader.lr.ph.i
                                        #   in Loop: Header=BB0_2 Depth=1
	ld.w	$a0, $s1, 4
	addi.w	$a0, $a0, 1
	...
	bge	$a0, $s2, .LBB0_1
# %bb.4:                                # %for.cond35.preheader.us.preheader.i
                                        #   in Loop: Header=BB0_2 Depth=1
	ld.w	$a0, $s1, 8
	move	$s3, $zero
	addi.w	$a0, $a0, 1
	...
	b	.LBB0_6
	.p2align	4, , 16
.LBB0_5:                                # %for.cond35.for.cond.cleanup38_crit_edge.us.i
                                        #   in Loop: Header=BB0_6 Depth=2
	addi.w	$s5, $s5, 1
	ld.d	$a0, $sp, 72                    # 8-byte Folded Reload
	beq	$s5, $a0, .LBB0_1
.LBB0_6:                                # %for.cond35.preheader.us.i
	...
	bge	$s8, $fp, .LBB0_5
	.p2align	4, , 16
.LBB0_7:                                # %for.cond40.preheader.us.us.i
                                        #   Parent Loop BB0_2 Depth=1
...
.LBB0_8:                                # %for.body44.us.us.i
	...
	addi.d	$s4, $s4, 4
	bne	$fp, $s7, .LBB0_8
# %bb.9:                                # %for.cond40.for.cond.cleanup43_crit_edge.us.us.i
                                        #   in Loop: Header=BB0_7 Depth=3
	addi.w	$s6, $s6, 1
	bne	$s6, $s2, .LBB0_7
	b	.LBB0_5
.LBB0_10:                               # %for.cond77.preheader
	ori	$a0, $zero, 1
	ori	$a1, $zero, 24
...
.LBB4_12:                               # %for.cond18.preheader.lr.ph.i
	...
	move	$s0, $s1
	bge	$a1, $s0, .LBB4_20
.LBB4_13:                               # %for.cond18.preheader.us.preheader.i
                                        #   in Loop: Header=BB4_2 Depth=1
	st.d	$s4, $sp, 56                    # 8-byte Folded Spill
	move	$s1, $zero
	sub.d	$s4, $s8, $s2
	...
	b	.LBB4_15
	.p2align	4, , 16
.LBB4_14:                               # %for.cond18.for.cond.cleanup21_crit_edge.us.i
                                        #   in Loop: Header=BB4_15 Depth=2
	addi.w	$s6, $s6, 1
	ld.d	$a1, $sp, 80                    # 8-byte Folded Reload
	ld.d	$a0, $sp, 88                    # 8-byte Folded Reload
	beq	$s6, $a0, .LBB4_19
.LBB4_15:                               # %for.cond18.preheader.us.i
	...
	bge	$s2, $s8, .LBB4_14
	.p2align	4, , 16
.LBB4_16:                               # %for.cond23.preheader.us.us.i
                                        #   Parent Loop BB4_2 Depth=1
...
.LBB4_17:                               # %for.body27.us.us.i
	...
	addi.d	$s5, $s5, 4
	bne	$s8, $s7, .LBB4_17
# %bb.18:                               # %for.cond23.for.cond.cleanup26_crit_edge.us.us.i
                                        #   in Loop: Header=BB4_16 Depth=3
	addi.w	$s3, $s3, 1
	bne	$s3, $s0, .LBB4_16
	b	.LBB4_14
	.p2align	4, , 16
.LBB4_19:                               # %mkForceSendCellList.exit.loopexit
                                        #   in Loop: Header=BB4_2 Depth=1
	ld.w	$s3, $fp, 0
	ld.w	$s1, $fp, 4
	ld.w	$s7, $fp, 8
	ld.d	$s5, $sp, 72                    # 8-byte Folded Reload
	ld.d	$s4, $sp, 56                    # 8-byte Folded Reload
.LBB4_20:                               # %mkForceSendCellList.exit
                                        #   in Loop: Header=BB4_2 Depth=1
	slli.d	$a2, $s5, 3
	...
	bltu	$a2, $a3, .LBB4_28
# %bb.21:                               # %mkForceSendCellList.exit
                                        #   in Loop: Header=BB4_2 Depth=1
	slli.d	$a2, $a3, 2
...
.LBB4_28:                               #   in Loop: Header=BB4_2 Depth=1
	...
	move	$s0, $a1
	bge	$s5, $s1, .LBB4_1
.LBB4_29:                               # %for.cond19.preheader.us.preheader.i
                                        #   in Loop: Header=BB4_2 Depth=1
	move	$s8, $zero
	sub.d	$s2, $s7, $s0
	...
	b	.LBB4_31
	.p2align	4, , 16
.LBB4_30:                               # %for.cond19.for.cond.cleanup22_crit_edge.us.i
                                        #   in Loop: Header=BB4_31 Depth=2
	addi.w	$s3, $s3, 1
	ld.d	$s5, $sp, 80                    # 8-byte Folded Reload
	ld.d	$a0, $sp, 88                    # 8-byte Folded Reload
	beq	$s3, $a0, .LBB4_1
.LBB4_31:                               # %for.cond19.preheader.us.i
                                        #   Parent Loop BB4_2 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB4_32 Depth 3
                                        #         Child Loop BB4_33 Depth 4
	bge	$s0, $s7, .LBB4_30
	.p2align	4, , 16
.LBB4_32:                               # %for.cond24.preheader.us.us.i
                                        #   Parent Loop BB4_2 Depth=1
...
.LBB4_33:                               # %for.body28.us.us.i
	...
	addi.d	$s1, $s1, 4
	bne	$s7, $s6, .LBB4_33
# %bb.34:                               # %for.cond24.for.cond.cleanup27_crit_edge.us.us.i
