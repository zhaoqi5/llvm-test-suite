...
# %bb.1:                                # %for.body19.lr.ph
	...
	andi	$a0, $a0, 1
	beqz	$a0, .LBB2_36
# %bb.2:                                # %for.body19.us.us.preheader
	...
	b	.LBB2_4
	.p2align	4, , 16
.LBB2_3:                                # %for.cond21.for.cond.cleanup25_crit_edge.split.us.us.us
...
.LBB2_4:                                # %for.body19.us.us
	...
	b	.LBB2_6
	.p2align	4, , 16
.LBB2_5:                                # %for.cond28.for.cond.cleanup32_crit_edge.us.us.us
                                        #   in Loop: Header=BB2_6 Depth=2
	addi.w	$s3, $s3, 1
	add.w	$s8, $s8, $s4
	beq	$s3, $s6, .LBB2_3
.LBB2_6:                                # %for.body26.us.us.us
	...
	b	.LBB2_8
	.p2align	4, , 16
.LBB2_7:                                # %cleanup.us.us.us.3
                                        #   in Loop: Header=BB2_8 Depth=3
	addi.w	$s5, $s5, 1
	addi.w	$s0, $s0, 4
	beq	$s7, $s5, .LBB2_5
.LBB2_8:                                # %for.cond34.preheader.us.us.us
                                        #   Parent Loop BB2_4 Depth=1
	...
	fmul.d	$fs5, $fa4, $fa1
	bcnez	$fcc0, .LBB2_15
# %bb.9:                                # %lor.lhs.false.us.us.us
                                        #   in Loop: Header=BB2_8 Depth=3
	fld.d	$fa1, $s1, 120
	fcmp.cle.d	$fcc0, $fa1, $fs1
	bcnez	$fcc0, .LBB2_15
# %bb.10:                               # %if.end.us.us.us
                                        #   in Loop: Header=BB2_8 Depth=3
	fld.d	$fa1, $s1, 104
	fcmp.clt.d	$fcc0, $fs3, $fa1
	bcnez	$fcc0, .LBB2_15
# %bb.11:                               # %lor.lhs.false64.us.us.us
                                        #   in Loop: Header=BB2_8 Depth=3
	fld.d	$fa1, $s1, 128
	fcmp.cle.d	$fcc0, $fa1, $fs3
	bcnez	$fcc0, .LBB2_15
# %bb.12:                               # %if.end69.us.us.us
                                        #   in Loop: Header=BB2_8 Depth=3
	fld.d	$fa1, $s1, 112
	fcmp.clt.d	$fcc0, $fs5, $fa1
	bcnez	$fcc0, .LBB2_15
# %bb.13:                               # %lor.lhs.false73.us.us.us
                                        #   in Loop: Header=BB2_8 Depth=3
	fld.d	$fa1, $s1, 136
	fcmp.cle.d	$fcc0, $fa1, $fs5
	bcnez	$fcc0, .LBB2_15
# %bb.14:                               # %if.end78.us.us.us
                                        #   in Loop: Header=BB2_8 Depth=3
	ld.d	$a0, $fp, 24
	ld.d	$a1, $fp, 32
	addi.w	$a2, $s0, -3
	...
	fld.d	$fa0, $s1, 96
	.p2align	4, , 16
.LBB2_15:                               # %cleanup.us.us.us
                                        #   in Loop: Header=BB2_8 Depth=3
	fadd.d	$fa1, $fs6, $fa3
	fcmp.clt.d	$fcc0, $fs1, $fa0
	fmul.d	$fs6, $fa4, $fa1
	bcnez	$fcc0, .LBB2_22
# %bb.16:                               # %lor.lhs.false.us.us.us.1
                                        #   in Loop: Header=BB2_8 Depth=3
	fld.d	$fa1, $s1, 120
	fcmp.cle.d	$fcc0, $fa1, $fs1
	bcnez	$fcc0, .LBB2_22
# %bb.17:                               # %if.end.us.us.us.1
                                        #   in Loop: Header=BB2_8 Depth=3
	fld.d	$fa1, $s1, 104
	fcmp.clt.d	$fcc0, $fs4, $fa1
	bcnez	$fcc0, .LBB2_22
# %bb.18:                               # %lor.lhs.false64.us.us.us.1
                                        #   in Loop: Header=BB2_8 Depth=3
	fld.d	$fa1, $s1, 128
	fcmp.cle.d	$fcc0, $fa1, $fs4
	bcnez	$fcc0, .LBB2_22
# %bb.19:                               # %if.end69.us.us.us.1
                                        #   in Loop: Header=BB2_8 Depth=3
	fld.d	$fa1, $s1, 112
	fcmp.clt.d	$fcc0, $fs6, $fa1
	bcnez	$fcc0, .LBB2_22
# %bb.20:                               # %lor.lhs.false73.us.us.us.1
                                        #   in Loop: Header=BB2_8 Depth=3
	fld.d	$fa1, $s1, 136
	fcmp.cle.d	$fcc0, $fa1, $fs6
	bcnez	$fcc0, .LBB2_22
# %bb.21:                               # %if.end78.us.us.us.1
                                        #   in Loop: Header=BB2_8 Depth=3
	ld.d	$a0, $fp, 24
	ld.d	$a1, $fp, 32
	addi.w	$a2, $s0, -2
	...
	fld.d	$fa0, $s1, 96
	.p2align	4, , 16
.LBB2_22:                               # %cleanup.us.us.us.1
                                        #   in Loop: Header=BB2_8 Depth=3
	fcmp.clt.d	$fcc0, $fs2, $fa0
	bcnez	$fcc0, .LBB2_29
# %bb.23:                               # %lor.lhs.false.us.us.us.2
                                        #   in Loop: Header=BB2_8 Depth=3
	fld.d	$fa1, $s1, 120
	fcmp.cle.d	$fcc0, $fa1, $fs2
	bcnez	$fcc0, .LBB2_29
# %bb.24:                               # %if.end.us.us.us.2
                                        #   in Loop: Header=BB2_8 Depth=3
	fld.d	$fa1, $s1, 104
	fcmp.clt.d	$fcc0, $fs3, $fa1
	bcnez	$fcc0, .LBB2_29
# %bb.25:                               # %lor.lhs.false64.us.us.us.2
                                        #   in Loop: Header=BB2_8 Depth=3
	fld.d	$fa1, $s1, 128
	fcmp.cle.d	$fcc0, $fa1, $fs3
	bcnez	$fcc0, .LBB2_29
# %bb.26:                               # %if.end69.us.us.us.2
                                        #   in Loop: Header=BB2_8 Depth=3
	fld.d	$fa1, $s1, 112
	fcmp.clt.d	$fcc0, $fs6, $fa1
	bcnez	$fcc0, .LBB2_29
# %bb.27:                               # %lor.lhs.false73.us.us.us.2
                                        #   in Loop: Header=BB2_8 Depth=3
	fld.d	$fa1, $s1, 136
	fcmp.cle.d	$fcc0, $fa1, $fs6
	bcnez	$fcc0, .LBB2_29
# %bb.28:                               # %if.end78.us.us.us.2
                                        #   in Loop: Header=BB2_8 Depth=3
	ld.d	$a0, $fp, 24
	ld.d	$a1, $fp, 32
	addi.w	$a2, $s0, -1
	...
	fld.d	$fa0, $s1, 96
	.p2align	4, , 16
.LBB2_29:                               # %cleanup.us.us.us.2
                                        #   in Loop: Header=BB2_8 Depth=3
	fcmp.clt.d	$fcc0, $fs2, $fa0
	bcnez	$fcc0, .LBB2_7
# %bb.30:                               # %lor.lhs.false.us.us.us.3
                                        #   in Loop: Header=BB2_8 Depth=3
	fld.d	$fa0, $s1, 120
	fcmp.cle.d	$fcc0, $fa0, $fs2
	bcnez	$fcc0, .LBB2_7
# %bb.31:                               # %if.end.us.us.us.3
                                        #   in Loop: Header=BB2_8 Depth=3
	fld.d	$fa0, $s1, 104
	fcmp.clt.d	$fcc0, $fs4, $fa0
	bcnez	$fcc0, .LBB2_7
# %bb.32:                               # %lor.lhs.false64.us.us.us.3
                                        #   in Loop: Header=BB2_8 Depth=3
	fld.d	$fa0, $s1, 128
	fcmp.cle.d	$fcc0, $fa0, $fs4
	bcnez	$fcc0, .LBB2_7
# %bb.33:                               # %if.end69.us.us.us.3
                                        #   in Loop: Header=BB2_8 Depth=3
	fld.d	$fa0, $s1, 112
	fcmp.clt.d	$fcc0, $fs5, $fa0
	bcnez	$fcc0, .LBB2_7
# %bb.34:                               # %lor.lhs.false73.us.us.us.3
                                        #   in Loop: Header=BB2_8 Depth=3
	fld.d	$fa0, $s1, 136
	fcmp.cle.d	$fcc0, $fa0, $fs5
	bcnez	$fcc0, .LBB2_7
# %bb.35:                               # %if.end78.us.us.us.3
                                        #   in Loop: Header=BB2_8 Depth=3
	ld.d	$a0, $fp, 24
	ld.d	$a1, $fp, 32
	move	$a2, $s0
