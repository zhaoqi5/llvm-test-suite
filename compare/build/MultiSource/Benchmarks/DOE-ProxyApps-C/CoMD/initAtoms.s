...
# %bb.2:                                # %for.body19.lr.ph
	...
	movfr2gr.s	$s7, $fa0
	bge	$s3, $s7, .LBB2_37
# %bb.3:                                # %for.body19.us.us.preheader
	mul.d	$a0, $a3, $a1
	...
	b	.LBB2_5
	.p2align	4, , 16
.LBB2_4:                                # %for.cond21.for.cond.cleanup25_crit_edge.split.us.us.us
...
.LBB2_5:                                # %for.body19.us.us
	...
	b	.LBB2_7
	.p2align	4, , 16
.LBB2_6:                                # %for.cond28.for.cond.cleanup32_crit_edge.us.us.us
                                        #   in Loop: Header=BB2_7 Depth=2
	addi.w	$s2, $s2, 1
	add.w	$s8, $s8, $s4
	beq	$s2, $s5, .LBB2_4
.LBB2_7:                                # %for.body26.us.us.us
	...
	b	.LBB2_9
	.p2align	4, , 16
.LBB2_8:                                # %cleanup.us.us.us.3
                                        #   in Loop: Header=BB2_9 Depth=3
	addi.w	$s6, $s6, 1
	addi.w	$s0, $s0, 4
	beq	$s7, $s6, .LBB2_6
.LBB2_9:                                # %for.cond34.preheader.us.us.us
                                        #   Parent Loop BB2_5 Depth=1
	...
	fmul.d	$fs6, $fs0, $fa1
	bcnez	$fcc0, .LBB2_16
# %bb.10:                               # %lor.lhs.false.us.us.us
                                        #   in Loop: Header=BB2_9 Depth=3
	fld.d	$fa1, $s1, 120
	fcmp.cle.d	$fcc0, $fa1, $fs2
	bcnez	$fcc0, .LBB2_16
# %bb.11:                               # %if.end.us.us.us
                                        #   in Loop: Header=BB2_9 Depth=3
	fld.d	$fa1, $s1, 104
	fcmp.clt.d	$fcc0, $fs4, $fa1
	bcnez	$fcc0, .LBB2_16
# %bb.12:                               # %lor.lhs.false64.us.us.us
                                        #   in Loop: Header=BB2_9 Depth=3
	fld.d	$fa1, $s1, 128
	fcmp.cle.d	$fcc0, $fa1, $fs4
	bcnez	$fcc0, .LBB2_16
# %bb.13:                               # %if.end69.us.us.us
                                        #   in Loop: Header=BB2_9 Depth=3
	fld.d	$fa1, $s1, 112
	fcmp.clt.d	$fcc0, $fs6, $fa1
	bcnez	$fcc0, .LBB2_16
# %bb.14:                               # %lor.lhs.false73.us.us.us
                                        #   in Loop: Header=BB2_9 Depth=3
	fld.d	$fa1, $s1, 136
	fcmp.cle.d	$fcc0, $fa1, $fs6
	bcnez	$fcc0, .LBB2_16
# %bb.15:                               # %if.end78.us.us.us
                                        #   in Loop: Header=BB2_9 Depth=3
	ld.d	$a0, $fp, 24
	ld.d	$a1, $fp, 32
	addi.w	$a2, $s0, -3
	...
	fld.d	$fa0, $s1, 96
	.p2align	4, , 16
.LBB2_16:                               # %cleanup.us.us.us
                                        #   in Loop: Header=BB2_9 Depth=3
	fadd.d	$fa1, $fs7, $fa3
	fcmp.clt.d	$fcc0, $fs2, $fa0
	fmul.d	$fs7, $fs0, $fa1
	bcnez	$fcc0, .LBB2_23
# %bb.17:                               # %lor.lhs.false.us.us.us.1
                                        #   in Loop: Header=BB2_9 Depth=3
	fld.d	$fa1, $s1, 120
	fcmp.cle.d	$fcc0, $fa1, $fs2
	bcnez	$fcc0, .LBB2_23
# %bb.18:                               # %if.end.us.us.us.1
                                        #   in Loop: Header=BB2_9 Depth=3
	fld.d	$fa1, $s1, 104
	fcmp.clt.d	$fcc0, $fs5, $fa1
	bcnez	$fcc0, .LBB2_23
# %bb.19:                               # %lor.lhs.false64.us.us.us.1
                                        #   in Loop: Header=BB2_9 Depth=3
	fld.d	$fa1, $s1, 128
	fcmp.cle.d	$fcc0, $fa1, $fs5
	bcnez	$fcc0, .LBB2_23
# %bb.20:                               # %if.end69.us.us.us.1
                                        #   in Loop: Header=BB2_9 Depth=3
	fld.d	$fa1, $s1, 112
	fcmp.clt.d	$fcc0, $fs7, $fa1
	bcnez	$fcc0, .LBB2_23
# %bb.21:                               # %lor.lhs.false73.us.us.us.1
                                        #   in Loop: Header=BB2_9 Depth=3
	fld.d	$fa1, $s1, 136
	fcmp.cle.d	$fcc0, $fa1, $fs7
	bcnez	$fcc0, .LBB2_23
# %bb.22:                               # %if.end78.us.us.us.1
                                        #   in Loop: Header=BB2_9 Depth=3
	ld.d	$a0, $fp, 24
	ld.d	$a1, $fp, 32
	addi.w	$a2, $s0, -2
	...
	fld.d	$fa0, $s1, 96
	.p2align	4, , 16
.LBB2_23:                               # %cleanup.us.us.us.1
                                        #   in Loop: Header=BB2_9 Depth=3
	fcmp.clt.d	$fcc0, $fs3, $fa0
	bcnez	$fcc0, .LBB2_30
# %bb.24:                               # %lor.lhs.false.us.us.us.2
                                        #   in Loop: Header=BB2_9 Depth=3
	fld.d	$fa1, $s1, 120
	fcmp.cle.d	$fcc0, $fa1, $fs3
	bcnez	$fcc0, .LBB2_30
# %bb.25:                               # %if.end.us.us.us.2
                                        #   in Loop: Header=BB2_9 Depth=3
	fld.d	$fa1, $s1, 104
	fcmp.clt.d	$fcc0, $fs4, $fa1
	bcnez	$fcc0, .LBB2_30
# %bb.26:                               # %lor.lhs.false64.us.us.us.2
                                        #   in Loop: Header=BB2_9 Depth=3
	fld.d	$fa1, $s1, 128
	fcmp.cle.d	$fcc0, $fa1, $fs4
	bcnez	$fcc0, .LBB2_30
# %bb.27:                               # %if.end69.us.us.us.2
                                        #   in Loop: Header=BB2_9 Depth=3
	fld.d	$fa1, $s1, 112
	fcmp.clt.d	$fcc0, $fs7, $fa1
	bcnez	$fcc0, .LBB2_30
# %bb.28:                               # %lor.lhs.false73.us.us.us.2
                                        #   in Loop: Header=BB2_9 Depth=3
	fld.d	$fa1, $s1, 136
	fcmp.cle.d	$fcc0, $fa1, $fs7
	bcnez	$fcc0, .LBB2_30
# %bb.29:                               # %if.end78.us.us.us.2
                                        #   in Loop: Header=BB2_9 Depth=3
	ld.d	$a0, $fp, 24
	ld.d	$a1, $fp, 32
	addi.w	$a2, $s0, -1
	...
	fld.d	$fa0, $s1, 96
	.p2align	4, , 16
.LBB2_30:                               # %cleanup.us.us.us.2
                                        #   in Loop: Header=BB2_9 Depth=3
	fcmp.clt.d	$fcc0, $fs3, $fa0
	bcnez	$fcc0, .LBB2_8
# %bb.31:                               # %lor.lhs.false.us.us.us.3
                                        #   in Loop: Header=BB2_9 Depth=3
	fld.d	$fa0, $s1, 120
	fcmp.cle.d	$fcc0, $fa0, $fs3
	bcnez	$fcc0, .LBB2_8
# %bb.32:                               # %if.end.us.us.us.3
                                        #   in Loop: Header=BB2_9 Depth=3
	fld.d	$fa0, $s1, 104
	fcmp.clt.d	$fcc0, $fs5, $fa0
	bcnez	$fcc0, .LBB2_8
# %bb.33:                               # %lor.lhs.false64.us.us.us.3
                                        #   in Loop: Header=BB2_9 Depth=3
	fld.d	$fa0, $s1, 128
	fcmp.cle.d	$fcc0, $fa0, $fs5
	bcnez	$fcc0, .LBB2_8
# %bb.34:                               # %if.end69.us.us.us.3
                                        #   in Loop: Header=BB2_9 Depth=3
	fld.d	$fa0, $s1, 112
	fcmp.clt.d	$fcc0, $fs6, $fa0
	bcnez	$fcc0, .LBB2_8
# %bb.35:                               # %lor.lhs.false73.us.us.us.3
                                        #   in Loop: Header=BB2_9 Depth=3
	fld.d	$fa0, $s1, 136
	fcmp.cle.d	$fcc0, $fa0, $fs6
	bcnez	$fcc0, .LBB2_8
# %bb.36:                               # %if.end78.us.us.us.3
                                        #   in Loop: Header=BB2_9 Depth=3
	ld.d	$a0, $fp, 24
	ld.d	$a1, $fp, 32
	move	$a2, $s0
