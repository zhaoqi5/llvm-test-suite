...
# %bb.0:                                # %entry
	...
	ldx.b	$a2, $a1, $a0
	addi.d	$a3, $a2, 1
	pcalau12i	$a4, %pc_hi20(nplies)
	ld.w	$a5, $a4, %pc_lo12(nplies)
	stx.b	$a3, $a1, $a0
	ori	$a1, $zero, 1
	sll.d	$a1, $a1, $a2
	andi	$a2, $a5, 1
	slli.d	$a2, $a2, 3
	pcalau12i	$a3, %pc_hi20(color)
	addi.d	$a3, $a3, %pc_lo12(color)
	ldx.d	$a6, $a3, $a2
	xor	$a1, $a6, $a1
	stx.d	$a1, $a3, $a2
	addi.d	$a1, $a5, 1
	st.w	$a1, $a4, %pc_lo12(nplies)
	slli.d	$a1, $a5, 2
	pcalau12i	$a2, %pc_hi20(moves)
	addi.d	$a2, $a2, %pc_lo12(moves)
	stx.w	$a0, $a2, $a1
...
# %bb.1:                                # %if.end
	...
	xori	$a4, $a3, 1
	slli.d	$a4, $a4, 3
	pcalau12i	$a5, %pc_hi20(color)
	addi.d	$s6, $a5, %pc_lo12(color)
	ldx.d	$a5, $s6, $a4
	pcalau12i	$a4, %pc_hi20(height)
	addi.d	$s0, $a4, %pc_lo12(height)
	move	$a4, $zero
	move	$a7, $zero
	move	$t8, $zero
	ori	$t0, $zero, 1
...
.LBB19_53:                              #   in Loop: Header=BB19_56 Depth=1
	move	$a3, $a1
	move	$a0, $s5
.LBB19_54:                              #   in Loop: Header=BB19_56 Depth=1
...
# %bb.64:                               # %middle.block
                                        #   in Loop: Header=BB19_56 Depth=1
	beq	$a5, $a6, .LBB19_67
.LBB19_65:                              # %for.body119.preheader241
                                        #   in Loop: Header=BB19_56 Depth=1
	alsl.d	$a5, $a4, $t5, 2
	.p2align	4, , 16
...
.LBB19_67:                              # %for.end126
	...
	st.w	$a1, $s6, %pc_lo12(nplies)
	slli.d	$a1, $a2, 2
	pcalau12i	$a2, %pc_hi20(moves)
	addi.d	$s1, $a2, %pc_lo12(moves)
	stx.w	$s3, $s1, $a1
	move	$s5, $a0
	sub.w	$a1, $s2, $a0
...
.LBB19_73:                              # %for.end187
	...
	ld.d	$a5, $a1, %pc_lo12(ht)
	masknez	$a3, $a3, $a4
	addi.d	$a0, $a0, 1
	st.d	$a0, $a6, %pc_lo12(posed)
...
# %bb.75:                               # %if.else.i
	...
	bstrins.d	$a1, $s7, 60, 58
	b	.LBB19_77
.LBB19_76:                              # %if.then.i154
	ori	$a3, $zero, 0
	lu32i.d	$a3, -1
	lu52i.d	$a3, $a3, 511
	and	$a1, $a1, $a3
...
.LBB19_79:                              # %if.then143
	...
	or	$a3, $a0, $a3
	beqz	$s4, .LBB19_73
# %bb.80:                               # %for.body158.preheader
	addi.d	$a0, $sp, 156
	move	$a1, $s4
.LBB19_81:                              # %for.body158
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a4, $a0, 0
	ldx.b	$a4, $s0, $a4
	slli.d	$a4, $a4, 2
...
# %bb.11:                               # %emptyTT.exit
	...
	st.d	$zero, $s2, %pc_lo12(posed)
	pcaddu18i	$ra, %call36(solve)
	jirl	$ra, $ra, 0
	ld.d	$a3, $s2, %pc_lo12(posed)
	move	$a1, $a0
