...
.LBB2_4:                                # %for.body5.us
	...
	addi.d	$t2, $t2, 8
	bnez	$t1, .LBB2_4
.LBB2_5:                                # %for.body12.us.preheader
                                        #   in Loop: Header=BB2_3 Depth=1
	add.d	$a7, $a7, $a6
	add.d	$t0, $t0, $a6
	move	$t1, $a4
	.p2align	4, , 16
.LBB2_6:                                # %for.body12.us
                                        #   Parent Loop BB2_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fld.d	$fa0, $t0, -16
	fst.d	$fa0, $a7, -16
	...
	addi.d	$t0, $t0, 32
	bltu	$t1, $a1, .LBB2_6
# %bb.7:                                # %for.cond10.for.end36_crit_edge.us
                                        #   in Loop: Header=BB2_3 Depth=1
	addi.d	$a5, $a5, 1
	bne	$a5, $a0, .LBB2_3
	b	.LBB2_13
.LBB2_8:                                # %for.body.lr.ph.split
	beqz	$a4, .LBB2_13
# %bb.9:                                # %for.body.us33.preheader
	move	$a1, $zero
	.p2align	4, , 16
.LBB2_10:                               # %for.body.us33
                                        # =>This Loop Header: Depth=1
...
.LBB2_11:                               # %for.body5.us38
	...
	addi.d	$a5, $a5, 8
	bnez	$a7, .LBB2_11
# %bb.12:                               # %for.cond3.for.cond10.preheader_crit_edge.us49
