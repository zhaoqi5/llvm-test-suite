...
.LBB2_12:                               # %if.end7
	...
	srli.d	$a4, $a3, 16
	srli.d	$a5, $a2, 28
	bstrins.d	$a7, $a5, 27, 24
	bstrins.d	$a7, $a3, 23, 16
	bstrins.d	$a7, $a4, 7, 0
	ori	$a3, $zero, 1
	lu12i.w	$a4, 8
	ori	$a4, $a4, 259
	pcalau12i	$a5, %pc_hi20(des_skb)
	addi.d	$a5, $a5, %pc_lo12(des_skb)
	lu12i.w	$a6, -16
...
.LBB2_13:                               # %for.body
	...
	srl.d	$t0, $a7, $t1
	srli.d	$t1, $t3, 6
	bstrpick.d	$t4, $t3, 12, 9
	bstrins.d	$t1, $t4, 63, 2
	srli.d	$t4, $t3, 13
	bstrpick.d	$t5, $t3, 19, 18
	bstrins.d	$t4, $t5, 63, 4
	andi	$t5, $t3, 63
	slli.d	$t5, $t5, 3
	ldx.d	$t5, $a5, $t5
	alsl.d	$t1, $t1, $a5, 3
	...
	ld.d	$t2, $t2, 1536
	srli.d	$t3, $t0, 7
	bstrpick.d	$t4, $t0, 13, 10
	bstrins.d	$t3, $t4, 63, 2
	srli.d	$t4, $t0, 21
	bstrpick.d	$t5, $a7, 27, 26
	bstrins.d	$t4, $t5, 63, 4
	andi	$t5, $t0, 63
	alsl.d	$t5, $t5, $a5, 3
	ldptr.d	$t5, $t5, 2048
