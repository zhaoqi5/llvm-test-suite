...
# %bb.0:                                # %entry
	...
	blez	$a5, .LBB2_7
# %bb.1:                                # %for.cond1.preheader.us.us.preheader
	add.w	$a3, $a5, $a0
	add.w	$a4, $a5, $a1
	add.w	$a5, $a5, $a2
	slli.d	$a6, $a0, 12
	...
	lu12i.w	$t1, 1
	.p2align	4, , 16
.LBB2_2:                                # %for.cond1.preheader.us.us
                                        # =>This Loop Header: Depth=1
...
.LBB2_4:                                # %for.body8.us.us.us
	...
	add.d	$t6, $t6, $t1
	blt	$t8, $a5, .LBB2_4
# %bb.5:                                # %for.cond5.for.inc19_crit_edge.us.us.us
                                        #   in Loop: Header=BB2_3 Depth=2
	fst.s	$fa0, $t5, 0
	addi.d	$t4, $t4, 1
	addi.d	$t3, $t3, 4
	blt	$t4, $a4, .LBB2_3
# %bb.6:                                # %for.cond1.for.inc22_crit_edge.split.us.us.us
...
# %bb.2:                                # %for.cond1.preheader.us.us.preheader
	...
	lu12i.w	$a7, 1
	.p2align	4, , 16
.LBB3_3:                                # %for.cond1.preheader.us.us
                                        # =>This Loop Header: Depth=1
	...
	move	$t2, $a5
	.p2align	4, , 16
.LBB3_4:                                # %for.cond4.preheader.us.us.us.us
	...
	move	$t6, $t2
	.p2align	4, , 16
.LBB3_5:                                # %for.body6.us.us.us.us.us
                                        #   Parent Loop BB3_3 Depth=1
	...
	move	$s0, $t0
	.p2align	4, , 16
.LBB3_6:                                # %for.cond1.preheader.us.us.i.us.us.us.us.us
                                        #   Parent Loop BB3_3 Depth=1
                                        #     Parent Loop BB3_4 Depth=2
	...
	move	$s3, $t3
	.p2align	4, , 16
.LBB3_7:                                # %for.cond5.preheader.us.us.us.i.us.us.us.us.us
                                        #   Parent Loop BB3_3 Depth=1
                                        #     Parent Loop BB3_4 Depth=2
                                        #       Parent Loop BB3_5 Depth=3
	...
	move	$s7, $t7
	.p2align	4, , 16
.LBB3_8:                                # %for.body8.us.us.us.i.us.us.us.us.us
                                        #   Parent Loop BB3_3 Depth=1
                                        #     Parent Loop BB3_4 Depth=2
                                        #       Parent Loop BB3_5 Depth=3
                                        #         Parent Loop BB3_6 Depth=4
	...
	addi.d	$s5, $s5, 4
	bltu	$s7, $t8, .LBB3_8
# %bb.9:                                # %for.cond5.for.inc19_crit_edge.us.us.us.i.us.us.us.us.us
                                        #   in Loop: Header=BB3_7 Depth=5
	fst.s	$fa0, $s4, 0
	addi.d	$s3, $s3, 1
	addi.d	$s2, $s2, 4
	bltu	$s3, $t4, .LBB3_7
# %bb.10:                               # %for.cond1.for.inc22_crit_edge.split.us.us.us.i.us.us.us.us.us
...
# %bb.11:                               # %mm_inner.exit.loopexit.us.us.us.us.us
	...
	move	$t7, $t8
	blt	$fp, $a0, .LBB3_5
# %bb.12:                               # %for.cond4.for.inc7_crit_edge.split.us.us.us.us.us
                                        #   in Loop: Header=BB3_4 Depth=2
	addi.w	$t5, $t4, 0
	add.d	$t2, $t2, $a2
	move	$t3, $t4
	blt	$t5, $a0, .LBB3_4
# %bb.13:                               # %for.cond1.for.inc10_crit_edge.split.us.split.us.us.us
...
# %bb.2:                                # %for.cond1.preheader.us.us.preheader
	...
	fmov.s	$fa0, $fa1
	.p2align	4, , 16
.LBB5_3:                                # %for.cond1.preheader.us.us
                                        # =>This Loop Header: Depth=1
...
.LBB5_4:                                # %for.body3.us.us.us
	...
	fmov.s	$fa2, $fa1
	.p2align	4, , 16
.LBB5_5:                                # %for.cond1.preheader.us.i.us.us.us
                                        #   Parent Loop BB5_3 Depth=1
	...
	move	$t6, $t1
	.p2align	4, , 16
.LBB5_6:                                # %for.body4.us.i.us.us.us
                                        #   Parent Loop BB5_3 Depth=1
                                        #     Parent Loop BB5_4 Depth=2
	...
	addi.d	$t5, $t5, 4
	bltu	$t6, $t2, .LBB5_6
# %bb.7:                                # %for.cond1.for.inc8_crit_edge.us.i.us.us.us
...
# %bb.8:                                # %mm_sum.exit.loopexit.us.us.us
	...
	move	$t1, $t2
	blt	$t3, $a0, .LBB5_4
# %bb.9:                                # %for.cond1.for.inc5_crit_edge.split.us.us.us
