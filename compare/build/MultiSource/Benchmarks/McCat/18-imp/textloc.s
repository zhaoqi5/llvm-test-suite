...
# %bb.2:                                # %for.cond3.preheader.us.preheader
	pcalau12i	$a1, %got_pc_hi20(HVAR_WINDOW)
	ld.d	$a1, $a1, %got_pc_lo12(HVAR_WINDOW)
	ld.w	$a1, $a1, 0
	move	$a2, $zero
	move	$a3, $zero
	slli.d	$a4, $a1, 1
	...
	fld.s	$fa7, $a4, %pc_lo12(.LCPI1_0)
	movgr2fr.w	$ft0, $zero
	lu12i.w	$a4, 276464
	vreplgr2vr.w	$vr9, $a4
	xvreplgr2vr.w	$xr10, $a4
	vslli.w	$vr11, $vr11, 31
	vsrai.w	$vr11, $vr11, 31
	b	.LBB1_4
	.p2align	4, , 16
.LBB1_3:                                # %for.cond3.for.inc74_crit_edge.us
...
.LBB1_4:                                # %for.cond3.preheader.us
	...
	bge	$s0, $a1, .LBB1_11
# %bb.5:                                # %for.body7.lr.ph.split.us72
                                        #   in Loop: Header=BB1_4 Depth=1
	ld.d	$s4, $fp, 48
	mul.d	$s6, $a3, $s1
	add.d	$s7, $s4, $t5
...
.LBB1_9:                                # %for.body26.us
	...
	addi.d	$s5, $s5, 1
	bnez	$a4, .LBB1_9
# %bb.10:                               # %for.cond23.for.end47_crit_edge.us
                                        #   in Loop: Header=BB1_6 Depth=2
	fdiv.s	$ft4, $ft4, $fa0
	fcmp.cult.s	$fcc0, $fa1, $ft4
	fsel	$ft5, $ft0, $fa7, $fcc0
	movgr2cf	$fcc0, $a5
...
.LBB1_15:                               # %vector.body
	...
	xvld	$xr12, $s6, -32
	xvld	$xr13, $s6, 0
	xvfdiv.s	$xr12, $xr12, $xr2
	xvfdiv.s	$xr13, $xr13, $xr2
	xvfcmp.cult.s	$xr14, $xr4, $xr12
	xvfcmp.cult.s	$xr15, $xr4, $xr13
	xvand.v	$xr14, $xr14, $xr10
	xvand.v	$xr15, $xr15, $xr10
	vpickve2gr.h	$a4, $vr3, 0
	xvinsgr2vr.w	$xr16, $a4, 0
	vpickve2gr.h	$a4, $vr3, 1
	xvinsgr2vr.w	$xr16, $a4, 1
	vpickve2gr.h	$a4, $vr3, 2
	xvinsgr2vr.w	$xr16, $a4, 2
	vpickve2gr.h	$a4, $vr3, 3
	xvinsgr2vr.w	$xr16, $a4, 3
	vpickve2gr.h	$a4, $vr3, 4
	xvinsgr2vr.w	$xr16, $a4, 4
	vpickve2gr.h	$a4, $vr3, 5
	xvinsgr2vr.w	$xr16, $a4, 5
	vpickve2gr.h	$a4, $vr3, 6
	xvinsgr2vr.w	$xr16, $a4, 6
	vpickve2gr.h	$a4, $vr3, 7
	xvinsgr2vr.w	$xr16, $a4, 7
	xvslli.w	$xr16, $xr16, 31
	xvsrai.w	$xr16, $xr16, 31
	xvbitsel.v	$xr12, $xr14, $xr12, $xr16
	xvbitsel.v	$xr13, $xr15, $xr13, $xr16
	xvst	$xr12, $s6, -32
	xvst	$xr13, $s6, 0
	addi.d	$s7, $s7, -16
	addi.d	$s6, $s6, 64
...
# %bb.17:                               # %vec.epilog.iter.check
	...
	beqz	$t6, .LBB1_21
.LBB1_18:                               # %vec.epilog.ph
                                        #   in Loop: Header=BB1_4 Depth=1
	alsl.d	$a4, $s4, $s5, 2
	add.d	$a4, $t7, $a4
	add.d	$s4, $t8, $s4
	.p2align	4, , 16
.LBB1_19:                               # %vec.epilog.vector.body
                                        #   Parent Loop BB1_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr12, $a4, 0
	vfdiv.s	$vr12, $vr12, $vr5
	vfcmp.cult.s	$vr13, $vr6, $vr12
	vand.v	$vr13, $vr13, $vr9
	vbitsel.v	$vr12, $vr13, $vr12, $vr11
	vst	$vr12, $a4, 0
	addi.d	$s4, $s4, 4
	addi.d	$a4, $a4, 16
	bnez	$s4, .LBB1_19
# %bb.20:                               # %vec.epilog.middle.block
	...
	move	$a4, $t4
	beq	$a7, $t3, .LBB1_3
.LBB1_21:                               # %for.end.us.us.preheader
                                        #   in Loop: Header=BB1_4 Depth=1
	alsl.d	$s4, $a4, $s5, 2
	add.d	$s5, $a0, $s4
	sub.d	$a4, $a6, $a4
	.p2align	4, , 16
.LBB1_22:                               # %for.end.us.us
                                        #   Parent Loop BB1_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	fld.s	$ft4, $s5, 0
	fdiv.s	$ft4, $ft4, $fa0
