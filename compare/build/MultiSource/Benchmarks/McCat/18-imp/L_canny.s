...
# %bb.2:                                # %for.cond7.preheader.lr.ph
	blez	$fp, .LBB3_13
# %bb.3:                                # %for.cond7.preheader.lr.ph
	...
	ext.w.h	$a2, $a1
	blt	$a0, $a2, .LBB3_13
# %bb.4:                                # %for.cond7.preheader.us.preheader
	move	$t0, $zero
	move	$a3, $zero
	move	$a4, $s1
	b	.LBB3_6
	.p2align	4, , 16
.LBB3_5:                                # %for.cond7.for.inc63_crit_edge.split.us86
                                        #   in Loop: Header=BB3_6 Depth=1
	addi.d	$a3, $a3, 1
	ext.w.h	$t0, $a3
	bge	$t0, $s8, .LBB3_13
.LBB3_6:                                # %for.cond7.preheader.us
	...
	b	.LBB3_8
	.p2align	4, , 16
.LBB3_7:                                # %for.cond14.for.end_crit_edge.us
                                        #   in Loop: Header=BB3_8 Depth=2
	addi.d	$a5, $a5, 1
	ext.w.h	$a6, $a5
	addi.d	$a4, $a4, 4
	bge	$a6, $fp, .LBB3_5
.LBB3_8:                                # %for.body12.us79
...
.LBB3_13:                               # %for.end65
	...
	jirl	$ra, $ra, 0
	beqz	$a0, .LBB3_26
# %bb.14:                               # %for.cond73.preheader
	blez	$fp, .LBB3_27
# %bb.15:                               # %for.cond79.preheader.lr.ph
	blez	$s8, .LBB3_27
# %bb.16:                               # %for.cond79.preheader.lr.ph
	...
	ext.w.h	$a3, $a2
	blt	$a1, $a3, .LBB3_27
# %bb.17:                               # %for.cond79.preheader.us.preheader
	move	$a5, $zero
	move	$a4, $zero
	addi.d	$a6, $s8, -1
	mul.d	$a6, $a6, $s2
	b	.LBB3_19
	.p2align	4, , 16
.LBB3_18:                               # %for.cond79.for.inc147_crit_edge.split.us105
                                        #   in Loop: Header=BB3_19 Depth=1
	addi.d	$a4, $a4, 1
	ext.w.h	$a5, $a4
	bge	$a5, $fp, .LBB3_27
.LBB3_19:                               # %for.cond79.preheader.us
                                        # =>This Loop Header: Depth=1
	...
	b	.LBB3_21
	.p2align	4, , 16
.LBB3_20:                               # %for.cond88.for.inc144_crit_edge.us
                                        #   in Loop: Header=BB3_21 Depth=2
	addi.d	$a7, $a7, 1
	ext.w.h	$t1, $a7
	fst.s	$fa0, $t4, 0
	bge	$t1, $s8, .LBB3_18
.LBB3_21:                               # %for.body84.us100
...
# %bb.2:                                # %for.cond2.preheader.us.preheader
	...
	fld.d	$fa0, $t2, %pc_lo12(.LCPI4_0)
	movgr2fr.w	$fa1, $zero
	pcalau12i	$t2, %pc_hi20(.LCPI4_1)
	fld.d	$fa2, $t2, %pc_lo12(.LCPI4_1)
	pcalau12i	$t2, %pc_hi20(.LCPI4_2)
	fld.d	$fa3, $t2, %pc_lo12(.LCPI4_2)
	vldi	$vr4, -912
	lu12i.w	$t2, 276464
	movgr2fr.w	$fa5, $t2
	b	.LBB4_4
