...
# %bb.25:                               # %middle.block
                                        #   in Loop: Header=BB8_6 Depth=1
	beq	$a4, $a3, .LBB8_30
.LBB8_26:                               # %for.body.i.i.i.preheader
                                        #   in Loop: Header=BB8_6 Depth=1
	sub.d	$a3, $a3, $a4
	alsl.d	$a5, $a4, $a1, 2
	alsl.d	$a4, $a4, $t2, 2
	.p2align	4, , 16
.LBB8_27:                               # %for.body.i.i.i
                                        #   Parent Loop BB8_6 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$a6, $a5, 0
	st.w	$a6, $a4, 0
...
.LBB8_29:                               # %_ZNK20btAlignedObjectArrayIiE4copyEiiPi.exit.i.i
                                        #   in Loop: Header=BB8_6 Depth=1
	beqz	$a1, .LBB8_3
.LBB8_30:                               # %if.then.i7.i.i
                                        #   in Loop: Header=BB8_6 Depth=1
	ld.bu	$a3, $a2, 24
	beqz	$a3, .LBB8_2
# %bb.31:                               # %if.then2.i.i.i
                                        #   in Loop: Header=BB8_6 Depth=1
	move	$a0, $a1
...
# %bb.28:                               # %middle.block
                                        #   in Loop: Header=BB9_6 Depth=1
	beq	$a6, $a5, .LBB9_33
.LBB9_29:                               # %for.body.i.i.i.preheader
                                        #   in Loop: Header=BB9_6 Depth=1
	sub.d	$a5, $a5, $a6
	alsl.d	$a7, $a6, $a4, 2
	alsl.d	$a6, $a6, $fp, 2
	.p2align	4, , 16
.LBB9_30:                               # %for.body.i.i.i
                                        #   Parent Loop BB9_6 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t0, $a7, 0
	st.w	$t0, $a6, 0
