...
# %bb.11:                               # %_ZN20btAlignedObjectArrayIfE8allocateEi.exit.i.i
	...
	ld.d	$a0, $fp, 152
	blez	$a1, .LBB0_22
# %bb.12:                               # %for.body.lr.ph.i.i.i44
	ori	$a3, $zero, 8
	move	$a2, $zero
	bltu	$a1, $a3, .LBB0_17
# %bb.13:                               # %for.body.lr.ph.i.i.i44
	sub.d	$a3, $s3, $a0
	ori	$a4, $zero, 32
	bltu	$a3, $a4, .LBB0_17
# %bb.14:                               # %vector.ph
...
# %bb.16:                               # %middle.block
	beq	$a2, $a1, .LBB0_19
.LBB0_17:                               # %for.body.i.i.i46.preheader
	sub.d	$a1, $a1, $a2
	alsl.d	$a3, $a2, $a0, 2
	alsl.d	$a2, $a2, $s3, 2
	.p2align	4, , 16
.LBB0_18:                               # %for.body.i.i.i46
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a3, 0
	fst.s	$fa0, $a2, 0
	addi.d	$a1, $a1, -1
	...
	addi.d	$a2, $a2, 4
	bnez	$a1, .LBB0_18
.LBB0_19:                               # %if.then.i7.i.i
	ld.bu	$a1, $fp, 160
	bnez	$a1, .LBB0_24
	b	.LBB0_25
.LBB0_20:                               # %invoke.cont11
	st.w	$s0, $fp, 108
	st.w	$s0, $fp, 140
	b	.LBB0_29
.LBB0_21:                               # %if.then5.i19.for.body10.lr.ph.i22_crit_edge
	ld.d	$s3, $fp, 152
	b	.LBB0_26
...
# %bb.0:                                # %entry
	...
	move	$fp, $a0
	pcalau12i	$a0, %pc_hi20(_ZTV18btMultiSphereShape+16)
	addi.d	$a1, $a0, %pc_lo12(_ZTV18btMultiSphereShape+16)
	ld.d	$a0, $fp, 152
	st.d	$a1, $fp, 0
	beqz	$a0, .LBB7_3
# %bb.1:                                # %entry
