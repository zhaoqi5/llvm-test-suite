...
.LBB2_22:                               # %for.end110
	...
	st.w	$fp, $s1, 0
	blt	$s0, $a0, .LBB2_37
# %bb.23:                               # %for.body116.lr.ph
	addi.d	$a0, $s1, 4
	beqz	$a1, .LBB2_31
# %bb.24:                               # %for.body116.us.preheader
	...
	b	.LBB2_26
	.p2align	4, , 16
.LBB2_25:                               # %for.cond126.for.end146_crit_edge.us
...
.LBB2_33:                               # %vector.body142
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB2_33
# %bb.34:                               # %middle.block145
	beq	$a3, $a2, .LBB2_37
.LBB2_35:                               # %for.body116.preheader149
	sub.d	$a1, $s0, $a1
	.p2align	4, , 16
.LBB2_36:                               # %for.body116
                                        # =>This Inner Loop Header: Depth=1
...
.LBB3_90:                               # %cleanup1317
	...
	addi.d	$sp, $sp, 592
	ret
.LBB3_91:                               # %for.body1207.lr.ph
	addi.d	$s1, $sp, 168
	addi.d	$s3, $sp, 208
	lu12i.w	$s6, -524288
	lu32i.d	$s6, 0
	move	$s7, $s0
.LBB3_92:                               # %for.body1207
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $s3, -8
	fld.s	$fa1, $s5, 0
	fld.s	$fa2, $s3, -4
