...
# %bb.0:                                # %entry
	...
	.cfi_offset 23, -24
	move	$fp, $a0
	pcalau12i	$a0, %pc_hi20(_ZTV16btRaycastVehicle+16)
	addi.d	$a1, $a0, %pc_lo12(_ZTV16btRaycastVehicle+16)
	ld.d	$a0, $fp, 208
	st.d	$a1, $fp, 0
	beqz	$a0, .LBB6_3
# %bb.1:                                # %entry
...
# %bb.23:                               # %_ZN20btAlignedObjectArrayIfE8allocateEi.exit.i.i
	...
	move	$s1, $a0
	blez	$a2, .LBB25_33
# %bb.24:                               # %for.body.lr.ph.i.i.i150
	ori	$a3, $zero, 8
	move	$a0, $zero
	bltu	$a2, $a3, .LBB25_29
# %bb.25:                               # %for.body.lr.ph.i.i.i150
	sub.d	$a3, $s1, $a1
	ori	$a4, $zero, 32
	bltu	$a3, $a4, .LBB25_29
# %bb.26:                               # %vector.ph
...
# %bb.28:                               # %middle.block
	beq	$a0, $a2, .LBB25_31
.LBB25_29:                              # %for.body.i.i.i152.preheader
	sub.d	$a2, $a2, $a0
	alsl.d	$a3, $a0, $a1, 2
	alsl.d	$a0, $a0, $s1, 2
	.p2align	4, , 16
.LBB25_30:                              # %for.body.i.i.i152
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a3, 0
	fst.s	$fa0, $a0, 0
	addi.d	$a2, $a2, -1
	...
	addi.d	$a0, $a0, 4
	bnez	$a2, .LBB25_30
.LBB25_31:                              # %if.then.i7.i.i
	ld.bu	$a0, $fp, 96
	bnez	$a0, .LBB25_35
	b	.LBB25_36
.LBB25_32:                              # %if.then5.i125.for.body10.lr.ph.i128_crit_edge
	ld.d	$s1, $fp, 88
	slli.d	$s0, $s2, 2
	b	.LBB25_37
.LBB25_33:                              # %_ZNK20btAlignedObjectArrayIfE4copyEiiPf.exit.i.i
	beqz	$a1, .LBB25_36
# %bb.34:                               # %_ZNK20btAlignedObjectArrayIfE4copyEiiPf.exit.i.i
	ld.b	$a0, $fp, 96
	andi	$a0, $a0, 1
	beqz	$a0, .LBB25_36
.LBB25_35:                              # %if.then2.i.i.i149
	move	$a0, $a1
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.LBB25_36:                              # %_ZN20btAlignedObjectArrayIfE10deallocateEv.exit.i.i
	ori	$a0, $zero, 1
	st.b	$a0, $fp, 96
	st.d	$s1, $fp, 88
	st.w	$s2, $fp, 80
.LBB25_37:                              # %for.body10.lr.ph.i128
	slli.d	$a1, $s3, 2
	alsl.d	$a0, $s3, $s1, 2
	sub.d	$a2, $s0, $a1
	move	$a1, $zero
	...
	st.w	$s2, $fp, 76
	bge	$s3, $s2, .LBB25_21
.LBB25_38:                              # %if.then5.i160
	ld.w	$a0, $fp, 112
	bge	$a0, $s2, .LBB25_48
# %bb.39:                               # %_ZN20btAlignedObjectArrayIfE8allocateEi.exit.i.i179
	slli.d	$s0, $s2, 2
	ori	$a1, $zero, 16
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_Z22btAlignedAllocInternalmi)
	...
	move	$s1, $a0
	blez	$a2, .LBB25_49
# %bb.40:                               # %for.body.lr.ph.i.i.i191
	ori	$a3, $zero, 8
	move	$a0, $zero
	bltu	$a2, $a3, .LBB25_45
# %bb.41:                               # %for.body.lr.ph.i.i.i191
	sub.d	$a3, $s1, $a1
	ori	$a4, $zero, 32
	bltu	$a3, $a4, .LBB25_45
# %bb.42:                               # %vector.ph480
...
.LBB25_43:                              # %vector.body483
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB25_43
# %bb.44:                               # %middle.block488
	beq	$a0, $a2, .LBB25_47
.LBB25_45:                              # %for.body.i.i.i193.preheader
	sub.d	$a2, $a2, $a0
	alsl.d	$a3, $a0, $a1, 2
	alsl.d	$a0, $a0, $s1, 2
	.p2align	4, , 16
.LBB25_46:                              # %for.body.i.i.i193
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a3, 0
	fst.s	$fa0, $a0, 0
	addi.d	$a2, $a2, -1
	...
	addi.d	$a0, $a0, 4
	bnez	$a2, .LBB25_46
.LBB25_47:                              # %if.then.i7.i.i199
	ld.bu	$a0, $fp, 128
	bnez	$a0, .LBB25_51
	b	.LBB25_52
.LBB25_48:                              # %if.then5.i160.for.body10.lr.ph.i163_crit_edge
	ld.d	$s1, $fp, 120
	slli.d	$s0, $s2, 2
	b	.LBB25_53
.LBB25_49:                              # %_ZNK20btAlignedObjectArrayIfE4copyEiiPf.exit.i.i183
	beqz	$a1, .LBB25_52
# %bb.50:                               # %_ZNK20btAlignedObjectArrayIfE4copyEiiPf.exit.i.i183
	ld.b	$a0, $fp, 128
	andi	$a0, $a0, 1
	beqz	$a0, .LBB25_52
.LBB25_51:                              # %if.then2.i.i.i190
	move	$a0, $a1
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.LBB25_52:                              # %_ZN20btAlignedObjectArrayIfE10deallocateEv.exit.i.i188
	ori	$a0, $zero, 1
	st.b	$a0, $fp, 128
	st.d	$s1, $fp, 120
	st.w	$s2, $fp, 112
.LBB25_53:                              # %for.body10.lr.ph.i163
	slli.d	$a1, $s3, 2
	alsl.d	$a0, $s3, $s1, 2
	sub.d	$a2, $s0, $a1
	move	$a1, $zero
...
.LBB25_57:                              # %vector.body498
	...
	addi.d	$a5, $a5, 32
	bnez	$a6, .LBB25_57
# %bb.58:                               # %middle.block501
	beq	$a3, $a0, .LBB25_61
.LBB25_59:                              # %for.body.preheader
	alsl.d	$a2, $a3, $a2, 2
	alsl.d	$a1, $a3, $a1, 2
	sub.d	$a3, $a0, $a3
	.p2align	4, , 16
...
# %bb.64:                               # %if.then28
	...
	ld.w	$a0, $fp, 196
	b	.LBB25_62
.LBB25_65:                              # %for.cond83.preheader
	blez	$a0, .LBB25_88
# %bb.66:                               # %for.body87.lr.ph
	ld.d	$a0, $fp, 208
	move	$s0, $zero
	move	$s1, $zero
	move	$s2, $zero
	...
	b	.LBB25_69
	.p2align	4, , 16
.LBB25_67:                              # %if.end140.critedge
                                        #   in Loop: Header=BB25_69 Depth=1
	ld.d	$a1, $fp, 88
	stx.w	$zero, $a1, $s1
	st.w	$s4, $s6, 284
.LBB25_68:                              # %if.end140
...
# %bb.74:                               # %if.then133
	...
	ori	$s5, $zero, 1
	b	.LBB25_68
.LBB25_75:                              # %for.cond.cleanup86
	slti	$a0, $a1, 1
	orn	$a0, $a0, $s5
	andi	$a0, $a0, 1
	bnez	$a0, .LBB25_81
# %bb.76:                               # %for.body150.lr.ph
	ld.d	$a3, $fp, 208
	ld.d	$a0, $fp, 120
	ld.d	$a2, $fp, 88
	addi.d	$a3, $a3, 284
...
# %bb.82:                               # %for.body183.lr.ph
	...
	.p2align	4, , 16
.LBB25_83:                              # %if.end234
                                        #   in Loop: Header=BB25_84 Depth=1
	ld.w	$a0, $fp, 196
	addi.d	$s4, $s4, 1
	addi.d	$s3, $s3, 16
	addi.d	$s2, $s2, 288
