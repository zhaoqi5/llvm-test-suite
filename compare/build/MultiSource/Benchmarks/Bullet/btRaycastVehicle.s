...
# %bb.55:                               # %middle.block498
	beq	$a0, $a2, .LBB25_62
# %bb.56:                               # %vec.epilog.iter.check503
	andi	$a3, $a2, 12
	beqz	$a3, .LBB25_60
.LBB25_57:                              # %vec.epilog.ph502
	move	$a5, $a0
	bstrpick.d	$a0, $a2, 30, 2
	slli.d	$a0, $a0, 2
	sub.d	$a3, $a5, $a0
	...
	alsl.d	$a5, $a5, $s1, 2
	.p2align	4, , 16
.LBB25_58:                              # %vec.epilog.vector.body508
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	vst	$vr0, $a5, 0
	addi.d	$a3, $a3, 4
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB25_58
# %bb.59:                               # %vec.epilog.middle.block512
	beq	$a0, $a2, .LBB25_62
...
# %bb.67:                               # %iter.check519
	...
	ori	$a5, $zero, 63
	bgeu	$a5, $a4, .LBB25_77
# %bb.68:                               # %vector.main.loop.iter.check521
	ori	$a3, $zero, 16
	bgeu	$a0, $a3, .LBB25_70
# %bb.69:
	move	$a3, $zero
	b	.LBB25_74
.LBB25_70:                              # %vector.ph522
...
.LBB25_71:                              # %vector.body525
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB25_71
# %bb.72:                               # %middle.block528
	beq	$a3, $a0, .LBB25_79
# %bb.73:                               # %vec.epilog.iter.check533
	andi	$a4, $a0, 12
	beqz	$a4, .LBB25_77
.LBB25_74:                              # %vec.epilog.ph532
	move	$a6, $a3
	...
	vrepli.b	$vr0, 0
	.p2align	4, , 16
.LBB25_75:                              # %vec.epilog.vector.body538
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a6, 0
	vst	$vr0, $a5, 0
	addi.d	$a4, $a4, 4
	...
	addi.d	$a6, $a6, 16
	bnez	$a4, .LBB25_75
# %bb.76:                               # %vec.epilog.middle.block541
	beq	$a3, $a0, .LBB25_79
