...
# %bb.47:                               # %iter.check479
	...
	ori	$a4, $zero, 64
	bltu	$a3, $a4, .LBB25_60
# %bb.48:                               # %vector.main.loop.iter.check481
	ori	$a0, $zero, 16
	bgeu	$a2, $a0, .LBB25_53
# %bb.49:
	move	$a0, $zero
...
.LBB25_54:                              # %vector.body485
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB25_54
# %bb.55:                               # %middle.block490
	beq	$a0, $a2, .LBB25_62
# %bb.56:                               # %vec.epilog.iter.check495
	andi	$a3, $a2, 12
	beqz	$a3, .LBB25_60
.LBB25_57:                              # %vec.epilog.ph494
	move	$a5, $a0
	bstrpick.d	$a0, $a2, 30, 2
	slli.d	$a0, $a0, 2
	sub.d	$a3, $a5, $a0
	...
	alsl.d	$a5, $a5, $s1, 2
	.p2align	4, , 16
.LBB25_58:                              # %vec.epilog.vector.body500
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	vst	$vr0, $a5, 0
	addi.d	$a3, $a3, 4
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB25_58
# %bb.59:                               # %vec.epilog.middle.block504
	beq	$a0, $a2, .LBB25_62
...
# %bb.67:                               # %iter.check511
	...
	ori	$a5, $zero, 63
	bgeu	$a5, $a4, .LBB25_77
# %bb.68:                               # %vector.main.loop.iter.check513
	ori	$a3, $zero, 16
	bgeu	$a0, $a3, .LBB25_70
# %bb.69:
	move	$a3, $zero
	b	.LBB25_74
.LBB25_70:                              # %vector.ph514
...
.LBB25_71:                              # %vector.body517
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB25_71
# %bb.72:                               # %middle.block520
	beq	$a3, $a0, .LBB25_79
# %bb.73:                               # %vec.epilog.iter.check525
	andi	$a4, $a0, 12
	beqz	$a4, .LBB25_77
.LBB25_74:                              # %vec.epilog.ph524
	move	$a6, $a3
	...
	vrepli.b	$vr0, 0
	.p2align	4, , 16
.LBB25_75:                              # %vec.epilog.vector.body530
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a6, 0
	vst	$vr0, $a5, 0
	addi.d	$a4, $a4, 4
	...
	addi.d	$a6, $a6, 16
	bnez	$a4, .LBB25_75
# %bb.76:                               # %vec.epilog.middle.block533
	beq	$a3, $a0, .LBB25_79
