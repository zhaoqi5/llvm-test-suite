...
# %bb.28:                               # %call.i.i.i.i.noexc70
	...
	ld.d	$a0, $fp, 48
	blez	$a1, .LBB5_39
.LBB5_29:                               # %for.body.lr.ph.i.i.i62
	ori	$a3, $zero, 8
	move	$a2, $zero
	bltu	$a1, $a3, .LBB5_34
# %bb.30:                               # %for.body.lr.ph.i.i.i62
	sub.d	$a3, $s1, $a0
	ori	$a4, $zero, 32
	bltu	$a3, $a4, .LBB5_34
# %bb.31:                               # %vector.ph
...
# %bb.33:                               # %middle.block
	beq	$a2, $a1, .LBB5_36
.LBB5_34:                               # %for.body.i.i.i64.preheader
	sub.d	$a1, $a1, $a2
	alsl.d	$a3, $a2, $a0, 2
	alsl.d	$a2, $a2, $s1, 2
	.p2align	4, , 16
.LBB5_35:                               # %for.body.i.i.i64
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a4, $a3, 0
	st.w	$a4, $a2, 0
	addi.d	$a1, $a1, -1
	...
	addi.d	$a2, $a2, 4
	bnez	$a1, .LBB5_35
.LBB5_36:                               # %if.then.i7.i.i
	ld.bu	$a1, $fp, 56
	bnez	$a1, .LBB5_41
	b	.LBB5_42
.LBB5_37:                               # %if.then5.i38.for.body10.lr.ph.i41_crit_edge
	ld.d	$s1, $fp, 48
	b	.LBB5_43
.LBB5_38:
	move	$s1, $zero
...
.LBB5_43:                               # %for.body10.lr.ph.i41
	...
	jirl	$ra, $ra, 0
	ld.w	$a0, $fp, 64
.LBB5_44:                               # %invoke.cont47
	st.w	$s2, $fp, 36
	blez	$a0, .LBB5_47
# %bb.45:                               # %for.body51.lr.ph
	ld.d	$a0, $sp, 72
	ld.d	$a1, $fp, 48
	move	$a2, $zero
	.p2align	4, , 16
...
# %bb.49:                               # %cleanup
	...
	andi	$a1, $a1, 1
	beqz	$a1, .LBB5_51
# %bb.50:                               # %if.then2.i.i.i.i
.Ltmp30:                                # EH_LABEL
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.Ltmp31:                                # EH_LABEL
.LBB5_51:                               # %invoke.cont.i
	ld.d	$a0, $sp, 32
	ori	$a1, $zero, 1
	st.b	$a1, $sp, 80
	st.d	$zero, $sp, 72
...
# %bb.52:                               # %invoke.cont.i
	...
	andi	$a1, $a1, 1
	beqz	$a1, .LBB5_54
# %bb.53:                               # %if.then2.i.i.i8.i
.Ltmp36:                                # EH_LABEL
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.Ltmp37:                                # EH_LABEL
.LBB5_54:                               # %invoke.cont62
	ld.d	$a0, $sp, 136
	beqz	$a0, .LBB5_57
# %bb.55:                               # %invoke.cont62
	ld.b	$a1, $sp, 144
	andi	$a1, $a1, 1
	beqz	$a1, .LBB5_57
# %bb.56:                               # %if.then2.i.i.i.i96
.Ltmp42:                                # EH_LABEL
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.Ltmp43:                                # EH_LABEL
.LBB5_57:                               # %invoke.cont.i85
	ld.d	$a0, $sp, 104
	ori	$a1, $zero, 1
	st.b	$a1, $sp, 144
	st.d	$zero, $sp, 136
	st.d	$zero, $sp, 124
	beqz	$a0, .LBB5_60
# %bb.58:                               # %invoke.cont.i85
	ld.b	$a1, $sp, 112
	andi	$a1, $a1, 1
	beqz	$a1, .LBB5_60
# %bb.59:                               # %if.then2.i.i.i8.i95
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
