...
.LBB0_47:                               # %if.end84
	...
	ld.w	$a1, $fp, 8
	bgeu	$a1, $a0, .LBB0_49
# %bb.48:                               # %entry._ZN9gim_arrayI11GIM_CONTACTE12growingCheckEv.exit_crit_edge.i140
                                        #   in Loop: Header=BB0_35 Depth=1
	ld.d	$a0, $fp, 0
	b	.LBB0_54
	.p2align	4, , 16
.LBB0_49:                               # %if.then.i.i118
                                        #   in Loop: Header=BB0_35 Depth=1
	move	$s7, $s0
	move	$s0, $s1
	ori	$a2, $zero, 4
	...
	st.w	$a0, $fp, 8
	beqz	$s1, .LBB0_56
# %bb.50:                               # %if.end.i.i.i122
                                        #   in Loop: Header=BB0_35 Depth=1
	beqz	$a0, .LBB0_52
# %bb.51:                               # %if.then3.i.i.i124
                                        #   in Loop: Header=BB0_35 Depth=1
	bstrpick.d	$a1, $a0, 31, 0
	ld.d	$a0, $fp, 0
	mul.d	$a1, $a1, $a5
...
.LBB0_62:                               # %lpad6
.Ltmp5:                                 # EH_LABEL
.LBB0_63:                               # %_ZN9gim_arrayI15GIM_RSORT_TOKENE5clearEv.exit.i.i155
	move	$fp, $a0
	bnez	$s2, .LBB0_67
	b	.LBB0_68
.LBB0_64:                               # %lpad52.loopexit.split-lp
.Ltmp20:                                # EH_LABEL
	b	.LBB0_66
.LBB0_65:                               # %lpad52.loopexit
.Ltmp17:                                # EH_LABEL
.LBB0_66:                               # %if.end.i.i.i158
	move	$fp, $a0
.LBB0_67:                               # %if.end.i.i.i158
.Ltmp21:                                # EH_LABEL
	move	$a0, $s2
	pcaddu18i	$ra, %call36(_Z8gim_freePv)
	jirl	$ra, $ra, 0
.Ltmp22:                                # EH_LABEL
.LBB0_68:                               # %invoke.cont98
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB0_69:                               # %terminate.lpad
.Ltmp23:                                # EH_LABEL
...
.LBB1_12:                               # %while.body
	...
	beqz	$a4, .LBB1_11
# %bb.13:                               # %while.body.i15.preheader
                                        #   in Loop: Header=BB1_12 Depth=1
	ori	$a6, $zero, 1
	addi.w	$a4, $a4, 0
	.p2align	4, , 16
.LBB1_14:                               # %while.body.i15
                                        #   Parent Loop BB1_12 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	slli.w	$a5, $a6, 1
	bge	$a5, $a1, .LBB1_16
# %bb.15:                               # %land.lhs.true.i35
...
.LBB1_18:                               #   in Loop: Header=BB1_12 Depth=1
	move	$a5, $a6
.LBB1_19:                               # %while.end.loopexit.i24
                                        #   in Loop: Header=BB1_12 Depth=1
	addi.d	$a4, $a5, -1
