...
# %bb.31:                               # %for.body124.lr.ph
	...
	fld.s	$fs1, $a0, %pc_lo12(.LCPI8_0)
	ori	$s2, $zero, 5
	pcalau12i	$a0, %pc_hi20(.Lswitch.table._ZN23btDiscreteDynamicsWorld14debugDrawWorldEv)
	addi.d	$s3, $a0, %pc_lo12(.Lswitch.table._ZN23btDiscreteDynamicsWorld14debugDrawWorldEv)
	pcalau12i	$a0, %pc_hi20(.Lswitch.table._ZN23btDiscreteDynamicsWorld14debugDrawWorldEv.1)
	addi.d	$s4, $a0, %pc_lo12(.Lswitch.table._ZN23btDiscreteDynamicsWorld14debugDrawWorldEv.1)
	pcalau12i	$a0, %pc_hi20(.Lswitch.table._ZN23btDiscreteDynamicsWorld14debugDrawWorldEv.2)
	addi.d	$s5, $a0, %pc_lo12(.Lswitch.table._ZN23btDiscreteDynamicsWorld14debugDrawWorldEv.2)
	b	.LBB8_33
	.p2align	4, , 16
.LBB8_32:                               # %if.end264
...
.Ltmp136:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp137:                               # EH_LABEL
# %bb.10:                               # %_ZN17DebugDrawcallbackD2Ev.exit1488
	addi.d	$a0, $sp, 80
	pcaddu18i	$ra, %call36(_ZN18btTriangleCallbackD2Ev)
	jirl	$ra, $ra, 0
	ld.w	$a0, $s2, 8
...
# %bb.11:                               # %invoke.cont18
	...
	ld.d	$a4, $s0, 104
	ld.d	$a0, $s0, 40
	pcalau12i	$a5, %pc_hi20(_ZTVZN23btDiscreteDynamicsWorld16solveConstraintsER19btContactSolverInfoE27InplaceSolverIslandCallback+16)
	addi.d	$a5, $a5, %pc_lo12(_ZTVZN23btDiscreteDynamicsWorld16solveConstraintsER19btContactSolverInfoE27InplaceSolverIslandCallback+16)
	st.d	$a5, $sp, 8
	st.d	$fp, $sp, 16
	st.d	$s1, $sp, 24
	ld.d	$a5, $a0, 0
...
# %bb.1:                                # %for.body.lr.ph
	...
	pcalau12i	$s6, %pc_hi20(gNumClampedCcdMotions)
	move	$s5, $s7
	pcalau12i	$a1, %got_pc_hi20(_ZTV13btSphereShape)
	ld.d	$a1, $a1, %got_pc_lo12(_ZTV13btSphereShape)
	lu32i.d	$s5, -65535
	pcalau12i	$a2, %pc_hi20(_ZTV34btClosestNotMeConvexResultCallback+16)
	addi.d	$a2, $a2, %pc_lo12(_ZTV34btClosestNotMeConvexResultCallback+16)
...
# %bb.16:                               # %if.then41
	...
	ld.d	$a0, $fp, 112
	ld.d	$a1, $a0, 0
	ld.w	$a2, $s6, %pc_lo12(gNumClampedCcdMotions)
	ld.d	$a1, $a1, 64
	addi.d	$a2, $a2, 1
	st.w	$a2, $s6, %pc_lo12(gNumClampedCcdMotions)
.Ltmp272:                               # EH_LABEL
	jirl	$ra, $a1, 0
.Ltmp273:                               # EH_LABEL
# %bb.17:                               # %invoke.cont55
...
.Lfunc_end59:
	...
	.cfi_endproc
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function _ZZN23btDiscreteDynamicsWorld16solveConstraintsER19btContactSolverInfoEN27InplaceSolverIslandCallbackD0Ev
...
.Lfunc_end60:
	...
	.cfi_endproc
                                        # -- End function
	.p2align	2                               # -- Begin function _ZZN23btDiscreteDynamicsWorld16solveConstraintsER19btContactSolverInfoEN27InplaceSolverIslandCallback13ProcessIslandEPP17btCollisionObjectiPP20btPersistentManifoldii
...
# %bb.20:                               # %ehcleanup39
	...
	andi	$a0, $a0, 1
	beqz	$a0, .LBB63_22
# %bb.21:                               # %if.then2.i.i.i36
.Ltmp325:                               # EH_LABEL
	move	$a0, $a1
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.Ltmp326:                               # EH_LABEL
.LBB63_22:                              # %invoke.cont42
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB63_23:                              # %terminate.lpad
.Ltmp327:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.Lfunc_end63:
