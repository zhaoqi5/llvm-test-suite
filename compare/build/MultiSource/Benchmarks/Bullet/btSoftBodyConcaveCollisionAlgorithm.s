...
# %bb.33:                               # %vec.epilog.middle.block
	beq	$a2, $a1, .LBB11_36
.LBB11_34:                              # %for.body.i.i.i47.preheader
	sub.d	$a1, $a1, $a2
	alsl.d	$a3, $a2, $a0, 2
	alsl.d	$a2, $a2, $s1, 2
	.p2align	4, , 16
.LBB11_35:                              # %for.body.i.i.i47
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a4, $a3, 0
	st.w	$a4, $a2, 0
	addi.d	$a1, $a1, -1
	...
	addi.d	$a2, $a2, 4
	bnez	$a1, .LBB11_35
.LBB11_36:                              # %if.then.i7.i.i
	ld.bu	$a1, $fp, 120
	ori	$a2, $zero, 1
	bne	$a1, $a2, .LBB11_38
# %bb.37:                               # %if.then2.i.i.i44
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.LBB11_38:                              # %if.end.i.i.i
	ld.w	$a1, $fp, 100
...
.Lfunc_end18:
	...
	.cfi_endproc
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function _ZZN35btSoftBodyConcaveCollisionAlgorithm21calculateTimeOfImpactEP17btCollisionObjectS1_RK16btDispatcherInfoP16btManifoldResultEN31LocalTriangleSphereCastCallbackD0Ev
...
.Lcst_end8:
	.p2align	2, 0x0
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function _ZZN35btSoftBodyConcaveCollisionAlgorithm21calculateTimeOfImpactEP17btCollisionObjectS1_RK16btDispatcherInfoP16btManifoldResultEN31LocalTriangleSphereCastCallback15processTriangleEP9btVector3ii
...
# %bb.7:
	move	$a2, $zero
	b	.LBB44_16
.LBB44_8:                               # %if.then5.i.for.body10.lr.ph.i_crit_edge
	ld.d	$s0, $fp, 16
	b	.LBB44_24
.LBB44_9:
	move	$s0, $zero
	...
	ori	$a2, $zero, 1
	bge	$a1, $a2, .LBB44_4
.LBB44_10:                              # %_ZNK20btAlignedObjectArrayIiE4copyEiiPi.exit.i.i
	beqz	$a0, .LBB44_23
...
.LBB44_16:                              # %vec.epilog.ph
	...
	alsl.d	$a5, $a5, $s0, 2
	.p2align	4, , 16
.LBB44_17:                              # %vec.epilog.vector.body
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	vst	$vr0, $a5, 0
	addi.d	$a3, $a3, 4
...
# %bb.18:                               # %vec.epilog.middle.block
	beq	$a2, $a1, .LBB44_21
.LBB44_19:                              # %for.body.i.i.i.preheader
	sub.d	$a1, $a1, $a2
	alsl.d	$a3, $a2, $a0, 2
	alsl.d	$a2, $a2, $s0, 2
	.p2align	4, , 16
.LBB44_20:                              # %for.body.i.i.i
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a4, $a3, 0
	st.w	$a4, $a2, 0
	addi.d	$a1, $a1, -1
	...
	addi.d	$a2, $a2, 4
	bnez	$a1, .LBB44_20
.LBB44_21:                              # %if.then.i7.i.i
	ld.bu	$a1, $fp, 24
	ori	$a2, $zero, 1
	bne	$a1, $a2, .LBB44_23
.LBB44_22:                              # %if.then2.i.i.i
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.LBB44_23:                              # %_ZN20btAlignedObjectArrayIiE10deallocateEv.exit.i.i
	ori	$a0, $zero, 1
	st.b	$a0, $fp, 24
	st.d	$s0, $fp, 16
	st.w	$s3, $fp, 8
.LBB44_24:                              # %for.body10.lr.ph.i
	slli.d	$a1, $s2, 2
	alsl.d	$a0, $s2, $s0, 2
	slli.d	$s0, $s3, 2
	sub.d	$a2, $s0, $a1
...
# %bb.29:                               # %iter.check101
	...
	ori	$a4, $zero, 64
	bltu	$a3, $a4, .LBB44_43
# %bb.30:                               # %vector.main.loop.iter.check103
	ori	$a2, $zero, 16
	bgeu	$a1, $a2, .LBB44_36
# %bb.31:
	move	$a2, $zero
	b	.LBB44_40
.LBB44_32:                              # %if.then5.i19.for.body10.lr.ph.i22_crit_edge
	ld.d	$s1, $fp, 48
	b	.LBB44_48
.LBB44_33:
	move	$s1, $zero
	...
	ori	$a2, $zero, 1
	bge	$a1, $a2, .LBB44_28
.LBB44_34:                              # %_ZNK20btAlignedObjectArrayIiE4copyEiiPi.exit.i.i42
	beqz	$a0, .LBB44_47
# %bb.35:                               # %_ZNK20btAlignedObjectArrayIiE4copyEiiPi.exit.i.i42
	ld.b	$a1, $fp, 56
	andi	$a1, $a1, 1
	bnez	$a1, .LBB44_46
	b	.LBB44_47
.LBB44_36:                              # %vector.ph104
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	addi.d	$a3, $a0, 32
	addi.d	$a4, $s1, 32
...
# %bb.38:                               # %middle.block112
	beq	$a2, $a1, .LBB44_45
# %bb.39:                               # %vec.epilog.iter.check117
	andi	$a3, $a1, 12
	beqz	$a3, .LBB44_43
.LBB44_40:                              # %vec.epilog.ph116
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 2
	slli.d	$a2, $a2, 2
	sub.d	$a3, $a5, $a2
	...
	alsl.d	$a5, $a5, $s1, 2
	.p2align	4, , 16
.LBB44_41:                              # %vec.epilog.vector.body122
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	vst	$vr0, $a5, 0
	addi.d	$a3, $a3, 4
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB44_41
# %bb.42:                               # %vec.epilog.middle.block126
	beq	$a2, $a1, .LBB44_45
.LBB44_43:                              # %for.body.i.i.i52.preheader
	sub.d	$a1, $a1, $a2
	alsl.d	$a3, $a2, $a0, 2
	alsl.d	$a2, $a2, $s1, 2
	.p2align	4, , 16
.LBB44_44:                              # %for.body.i.i.i52
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a4, $a3, 0
	st.w	$a4, $a2, 0
	addi.d	$a1, $a1, -1
	...
	addi.d	$a2, $a2, 4
	bnez	$a1, .LBB44_44
.LBB44_45:                              # %if.then.i7.i.i58
	ld.bu	$a1, $fp, 56
	ori	$a2, $zero, 1
	bne	$a1, $a2, .LBB44_47
.LBB44_46:                              # %if.then2.i.i.i49
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.LBB44_47:                              # %_ZN20btAlignedObjectArrayIiE10deallocateEv.exit.i.i47
	ori	$a0, $zero, 1
	st.b	$a0, $fp, 56
	st.d	$s1, $fp, 48
	st.w	$s3, $fp, 40
.LBB44_48:                              # %for.body10.lr.ph.i22
	slli.d	$a1, $s4, 2
	alsl.d	$a0, $s4, $s1, 2
	sub.d	$a2, $s0, $a1
	move	$a1, $zero
	pcaddu18i	$ra, %call36(memset)
	jirl	$ra, $ra, 0
.LBB44_49:                              # %_ZN20btAlignedObjectArrayIiE6resizeEiRKi.exit62
	ori	$s1, $zero, 1
	st.w	$s3, $fp, 36
	blt	$s3, $s1, .LBB44_51
