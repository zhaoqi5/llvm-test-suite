...
# %bb.0:                                # %entry
	...
	move	$fp, $a0
	pcalau12i	$a0, %pc_hi20(_ZTV20btDbvtNodeEnumerator+16)
	addi.d	$a1, $a0, %pc_lo12(_ZTV20btDbvtNodeEnumerator+16)
	ld.d	$a0, $fp, 24
	st.d	$a1, $fp, 0
	beqz	$a0, .LBB24_3
# %bb.1:                                # %entry
...
.Ltmp103:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp104:                               # EH_LABEL
# %bb.24:                               # %_ZN20btAlignedObjectArrayIN6btDbvt7sStkCLNEE8allocateEi.exit.i.i68
                                        #   in Loop: Header=BB25_13 Depth=1
	move	$s3, $a0
	ori	$a0, $zero, 2
	bltu	$s5, $a0, .LBB25_27
# %bb.25:                               # %for.body.lr.ph.i.i.i80
                                        #   in Loop: Header=BB25_13 Depth=1
	move	$a0, $s3
	move	$a1, $s1
	.p2align	4, , 16
.LBB25_26:                              # %for.body.i.i.i83
...
.Ltmp108:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp109:                               # EH_LABEL
# %bb.30:                               # %for.body.lr.ph.i.i.i125
                                        #   in Loop: Header=BB25_13 Depth=1
	move	$s1, $a0
	move	$a0, $zero
	move	$a1, $s5
	.p2align	4, , 16
.LBB25_31:                              # %for.body.i.i.i128
                                        #   Parent Loop BB25_13 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vldx	$vr0, $s3, $a0
	vstx	$vr0, $s1, $a0
...
.Ltmp111:                               # EH_LABEL
	b	.LBB25_34
	.p2align	4, , 16
.LBB25_33:                              # %invoke.cont30.invoke.cont36_crit_edge
                                        #   in Loop: Header=BB25_13 Depth=1
	move	$s1, $s3
.LBB25_34:                              # %invoke.cont36
                                        #   in Loop: Header=BB25_13 Depth=1
	alsl.d	$a0, $s5, $s1, 4
	slli.d	$a1, $s5, 4
	stx.d	$fp, $s1, $a1
...
.LBB25_38:                              # %lpad12
.Ltmp115:                               # EH_LABEL
.LBB25_39:                              # %if.then2.i.i.i154
	move	$fp, $a0
.LBB25_40:                              # %if.then2.i.i.i154
.Ltmp116:                               # EH_LABEL
	move	$a0, $s1
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
