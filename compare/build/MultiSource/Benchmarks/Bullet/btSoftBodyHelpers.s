...
.LJTI15_0:
	...
	.word	.LBB15_4-.LJTI15_0
                                        # -- End function
	.text
	.globl	_ZN17btSoftBodyHelpers15CreateEllipsoidER19btSoftBodyWorldInfoRK9btVector3S4_i # -- Begin function _ZN17btSoftBodyHelpers15CreateEllipsoidER19btSoftBodyWorldInfoRK9btVector3S4_i
	.p2align	5
...
.LBB18_8:                               # %for.body
	...
	addi.d	$a3, $a3, 4
	bnez	$a0, .LBB18_8
.LBB18_9:                               # %invoke.cont.loopexit
	addi.w	$s6, $a2, 1
.LBB18_10:                              # %if.then.i.i.i59
	mul.w	$s0, $s6, $s6
	ori	$a1, $zero, 16
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_Z22btAlignedAllocInternalmi)
...
.Ltmp146:                               # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp147:                               # EH_LABEL
# %bb.15:                               # %for.cond40.preheader
	blez	$s3, .LBB18_25
# %bb.16:                               # %for.body42.preheader
	move	$s7, $zero
	addi.d	$s8, $s2, 8
	.p2align	4, , 16
.LBB18_17:                              # %for.body42
...
.LBB18_33:                              # %lpad62
.Ltmp157:                               # EH_LABEL
.LBB18_34:                              # %ehcleanup100
	move	$s1, $a0
	ld.d	$a0, $sp, 16                    # 8-byte Folded Reload
	beqz	$a0, .LBB18_36
.LBB18_35:                              # %if.then2.i.i.i116
.Ltmp164:                               # EH_LABEL
	ld.d	$a0, $sp, 16                    # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.Ltmp165:                               # EH_LABEL
.LBB18_36:                              # %if.then2.i.i.i126
.Ltmp169:                               # EH_LABEL
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.Ltmp170:                               # EH_LABEL
# %bb.37:                               # %invoke.cont104
	move	$a0, $s1
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB18_38:                              # %terminate.lpad
.Ltmp171:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.Lfunc_end18:
