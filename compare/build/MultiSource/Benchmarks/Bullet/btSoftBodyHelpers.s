...
.LBB18_14:                              # %for.body
	...
	addi.d	$a3, $a3, 4
	bnez	$a0, .LBB18_14
.LBB18_15:                              # %invoke.cont.loopexit
	addi.w	$s6, $a2, 1
.LBB18_16:                              # %if.then.i.i.i59
	mul.w	$s3, $s6, $s6
	ori	$a1, $zero, 16
	move	$a0, $s3
	pcaddu18i	$ra, %call36(_Z22btAlignedAllocInternalmi)
...
.LBB18_39:                              # %lpad62
.Ltmp157:                               # EH_LABEL
.LBB18_40:                              # %ehcleanup100
	move	$s0, $a0
	ld.d	$a0, $sp, 16                    # 8-byte Folded Reload
	beqz	$a0, .LBB18_42
.LBB18_41:                              # %if.then2.i.i.i116
.Ltmp164:                               # EH_LABEL
	ld.d	$a0, $sp, 16                    # 8-byte Folded Reload
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.Ltmp165:                               # EH_LABEL
.LBB18_42:                              # %if.then2.i.i.i126
.Ltmp169:                               # EH_LABEL
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
