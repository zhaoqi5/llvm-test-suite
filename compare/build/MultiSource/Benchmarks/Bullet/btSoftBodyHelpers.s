...
# %bb.7:                                # %if.then18.us
	...
	jirl	$ra, $a3, 0
	b	.LBB9_3
.LBB9_8:                                # %for.body.lr.ph.split
	beqz	$s1, .LBB9_13
# %bb.9:                                # %for.body.us8.preheader
	move	$s2, $zero
	ori	$s3, $zero, 100
	pcalau12i	$a0, %pc_hi20(.L.str.1)
	...
	b	.LBB9_11
	.p2align	4, , 16
.LBB9_10:                               # %if.end20.us23
                                        #   in Loop: Header=BB9_11 Depth=1
	ld.w	$a0, $fp, 820
	addi.d	$s2, $s2, 1
	addi.d	$s3, $s3, 120
	bge	$s2, $a0, .LBB9_13
.LBB9_11:                               # %for.body.us8
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$s4, $fp, 832
	addi.d	$a0, $sp, 1032
	ori	$a2, $zero, 2048
...
# %bb.16:                               # %delete.notnull
	blt	$s0, $a0, .LBB13_34
# %bb.17:                               # %for.cond62.preheader.us.preheader
	move	$s5, $zero
	move	$s8, $zero
	st.d	$fp, $sp, 32                    # 8-byte Folded Spill
	b	.LBB13_19
	.p2align	4, , 16
.LBB13_18:                              # %for.cond62.for.cond.cleanup64_crit_edge.us
	...
	beq	$a0, $fp, .LBB13_34
.LBB13_19:                              # %for.cond62.preheader.us
                                        # =>This Loop Header: Depth=1
	...
	bge	$a0, $fp, .LBB13_30
# %bb.20:                               # %for.body65.us.us.preheader
                                        #   in Loop: Header=BB13_19 Depth=1
	move	$fp, $zero
	add.d	$s7, $s0, $s5
	b	.LBB13_24
	.p2align	4, , 16
.LBB13_21:                              # %if.end147.us.us.critedge
                                        #   in Loop: Header=BB13_24 Depth=2
	add.w	$a2, $s7, $s4
	move	$a0, $s6
	move	$a1, $s1
.LBB13_22:                              # %if.end147.us.us
                                        #   in Loop: Header=BB13_24 Depth=2
	move	$a3, $zero
	move	$a4, $zero
	pcaddu18i	$ra, %call36(_ZN10btSoftBody10appendLinkEiiPNS_8MaterialEb)
	jirl	$ra, $ra, 0
.LBB13_23:                              # %if.end147.us.us
                                        #   in Loop: Header=BB13_24 Depth=2
	beq	$s0, $fp, .LBB13_18
.LBB13_24:                              # %for.body65.us.us
...
# %bb.29:                               # %if.then111.us.us
	...
	b	.LBB13_22
	.p2align	4, , 16
.LBB13_30:                              # %for.body65.us158.preheader
                                        #   in Loop: Header=BB13_19 Depth=1
	move	$a0, $zero
	b	.LBB13_32
	.p2align	4, , 16
.LBB13_31:                              # %if.end78.us165
                                        #   in Loop: Header=BB13_32 Depth=2
	move	$a0, $fp
	beq	$s0, $fp, .LBB13_18
.LBB13_32:                              # %for.body65.us158
                                        #   Parent Loop BB13_19 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.w	$fp, $a0, 1
	bge	$fp, $s0, .LBB13_31
# %bb.33:                               # %if.then74.us163
                                        #   in Loop: Header=BB13_32 Depth=2
	add.w	$a1, $s5, $a0
	addi.w	$a2, $a1, 1
	move	$a0, $s6
...
.LBB14_20:                              # %delete.notnull
	...
	ori	$a0, $zero, 1
	blt	$s0, $a0, .LBB14_37
# %bb.21:                               # %for.cond106.preheader.lr.ph
	ld.d	$s2, $sp, 80                    # 8-byte Folded Reload
	blt	$s2, $a0, .LBB14_37
# %bb.22:                               # %for.cond106.preheader.us.preheader
	move	$s6, $zero
	move	$a1, $zero
	move	$fp, $zero
	movgr2fr.w	$fa0, $s1
	...
	b	.LBB14_24
	.p2align	4, , 16
.LBB14_23:                              # %for.cond106.for.cond.cleanup108_crit_edge.us
                                        #   in Loop: Header=BB14_24 Depth=1
	add.d	$s6, $s6, $s2
	ld.d	$s0, $sp, 48                    # 8-byte Folded Reload
	ld.d	$a1, $sp, 56                    # 8-byte Folded Reload
	beq	$a1, $s0, .LBB14_37
.LBB14_24:                              # %for.cond106.preheader.us
                                        # =>This Loop Header: Depth=1
	...
	bge	$a1, $s0, .LBB14_33
# %bb.25:                               # %for.body109.us.us.preheader
                                        #   in Loop: Header=BB14_24 Depth=1
	move	$s7, $zero
	...
	b	.LBB14_27
	.p2align	4, , 16
.LBB14_26:                              # %if.end192.us.us
                                        #   in Loop: Header=BB14_27 Depth=2
	addi.w	$fp, $fp, 12
	move	$s7, $s0
	ld.d	$s2, $sp, 80                    # 8-byte Folded Reload
	beq	$s2, $s0, .LBB14_23
.LBB14_27:                              # %for.body109.us.us
...
# %bb.29:                               # %if.then137.us.us
	...
	b	.LBB14_32
	.p2align	4, , 16
.LBB14_30:                              # %if.end194.us.us.critedge
                                        #   in Loop: Header=BB14_27 Depth=2
	move	$a0, $s4
	move	$a1, $s1
	move	$a2, $s5
	...
	bne	$s2, $s0, .LBB14_27
	b	.LBB14_23
.LBB14_31:                              # %if.end189.critedge.us.us
                                        #   in Loop: Header=BB14_27 Depth=2
	move	$a0, $s4
	move	$a1, $s2
	move	$a2, $s3
...
.LBB14_32:                              # %if.then191.us.us
	...
	b	.LBB14_26
	.p2align	4, , 16
.LBB14_33:                              # %for.body109.us263.preheader
                                        #   in Loop: Header=BB14_24 Depth=1
	move	$a0, $zero
	b	.LBB14_35
	.p2align	4, , 16
.LBB14_34:                              # %if.end129.us270
                                        #   in Loop: Header=BB14_35 Depth=2
	move	$a0, $s0
	beq	$s2, $s0, .LBB14_23
.LBB14_35:                              # %for.body109.us263
                                        #   Parent Loop BB14_24 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	addi.w	$s0, $a0, 1
	bge	$s0, $s2, .LBB14_34
# %bb.36:                               # %if.then128.us269
                                        #   in Loop: Header=BB14_35 Depth=2
	add.w	$a1, $s6, $a0
	addi.w	$a2, $a1, 1
	move	$a0, $s4
...
.LBB16_4:                               # %for.body3.i
	...
	bgeu	$a1, $s5, .LBB16_4
.LBB16_5:                               # %for.cond.cleanup2.i
                                        #   in Loop: Header=BB16_2 Depth=1
	vldi	$vr1, -1040
	vldi	$vr2, -1280
	fmadd.s	$fs5, $fa0, $fa2, $fa1
	fnmadd.s	$fa0, $fa0, $fa2, $fa1
	vldi	$vr1, -1168
	fmadd.s	$fa0, $fa0, $fs5, $fa1
	fsqrt.s	$fs0, $fa0
	fcmp.cor.s	$fcc0, $fs0, $fs0
	bceqz	$fcc0, .LBB16_7
.LBB16_6:                               # %for.cond.cleanup2.i.split
                                        #   in Loop: Header=BB16_2 Depth=1
	slli.d	$a0, $s4, 1
	bstrpick.d	$a0, $a0, 31, 1
	slli.d	$a0, $a0, 1
...
.Ltmp91:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp92:                                # EH_LABEL
# %bb.13:                               # %_ZN20btAlignedObjectArrayI9btVector3ED2Ev.exit
	move	$fp, $a0
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
