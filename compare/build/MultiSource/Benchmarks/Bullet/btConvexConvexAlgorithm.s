...
# %bb.0:                                # %entry
	...
	jirl	$ra, $ra, 0
	pcalau12i	$a0, %pc_hi20(_ZTV23btConvexConvexAlgorithm+16)
	addi.d	$a1, $a0, %pc_lo12(_ZTV23btConvexConvexAlgorithm+16)
	ld.d	$a0, $s5, 200
	st.d	$a1, $s0, 0
	ld.d	$a1, $a0, 0
	ld.d	$a1, $a1, 32
...
# %bb.0:                                # %entry
	...
	move	$fp, $a0
	pcalau12i	$a0, %pc_hi20(_ZTV23btConvexConvexAlgorithm+16)
	addi.d	$a0, $a0, %pc_lo12(_ZTV23btConvexConvexAlgorithm+16)
	ld.bu	$a1, $fp, 128
	st.d	$a0, $fp, 0
	beqz	$a1, .LBB5_3
# %bb.1:                                # %if.then
...
# %bb.24:                               # %invoke.cont135.lr.ph
	...
	fld.s	$fa2, $sp, 76                   # 4-byte Folded Reload
	fmul.s	$fa2, $fa2, $fa2
	fld.s	$fa3, $sp, 80                   # 4-byte Folded Reload
	fmadd.s	$fa2, $fa3, $fa3, $fa2
	fld.s	$fa3, $sp, 72                   # 4-byte Folded Reload
	fmadd.s	$fa2, $fa3, $fa3, $fa2
	fsqrt.s	$fa2, $fa2
	...
	move	$s4, $zero
	fst.s	$fs4, $sp, 68                   # 4-byte Folded Spill
	fst.s	$fs0, $sp, 64                   # 4-byte Folded Spill
	fst.s	$fs7, $sp, 60                   # 4-byte Folded Spill
	b	.LBB8_27
	.p2align	4, , 16
.LBB8_25:                               # %invoke.cont199
...
.LBB8_26:                               # %invoke.cont207
	...
	ld.w	$a0, $s2, 148
	addi.w	$s4, $s4, 1
	fld.s	$fs4, $sp, 68                   # 4-byte Folded Reload
	fld.s	$fs0, $sp, 64                   # 4-byte Folded Reload
	fld.s	$fs7, $sp, 60                   # 4-byte Folded Reload
	bge	$s4, $a0, .LBB8_29
.LBB8_27:                               # %invoke.cont135
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fs1, $sp, 52                   # 4-byte Folded Reload
	fmov.s	$fa0, $fs1
...
# %bb.36:                               # %if.else33.i.i
	...
	bcnez	$fcc0, .LBB8_39
.LBB8_37:                               # %_ZL21segmentsClosestPointsR9btVector3S0_S0_RfS1_RKS_S3_fS3_f.exit.i
	fmov.s	$ft9, $fa1
	b	.LBB8_40
.LBB8_38:                               # %if.else.i105
	fmul.s	$fa0, $fs7, $fs7
	fmadd.s	$fa0, $fs0, $fs0, $fa0
	frsqrt.s	$fa0, $fa0
	fneg.s	$fa1, $fs7
	fmul.s	$fa1, $fa0, $fa1
	fst.s	$fa1, $sp, 80                   # 4-byte Folded Spill
	fmul.s	$fa0, $fs0, $fa0
...
.LBB8_39:
	fmov.s	$ft9, $ft10
.LBB8_40:                               # %_ZL21segmentsClosestPointsR9btVector3S0_S0_RfS1_RKS_S3_fS3_f.exit.i
	fmul.s	$fa1, $fa7, $ft9
	fmul.s	$ft7, $fa5, $ft9
	fmul.s	$ft9, $ft0, $ft9
	fmul.s	$ft1, $ft1, $ft12
...
.LBB8_46:                               # %if.end18.i
	...
	st.d	$a0, $sp, 648
	st.d	$a1, $sp, 656
.LBB8_47:                               # %_ZL22capsuleCapsuleDistanceR9btVector3S0_ffffiiRK11btTransformS3_f.exit
