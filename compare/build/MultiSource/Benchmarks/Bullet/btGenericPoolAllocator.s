...
# %bb.0:                                # %entry
	...
	move	$fp, $a0
	ld.d	$a0, $a0, 152
	pcalau12i	$a1, %pc_hi20(_ZTV22btGenericPoolAllocator+16)
	addi.d	$a1, $a1, %pc_lo12(_ZTV22btGenericPoolAllocator+16)
	st.d	$a1, $fp, 0
	beqz	$a0, .LBB6_7
...
# %bb.0:                                # %entry
	...
	addi.d	$s0, $a1, %pc_lo12(g_main_allocator)
	ld.d	$a1, $s0, 152
	move	$fp, $a0
	beqz	$a1, .LBB13_6
...
# %bb.0:                                # %entry
	...
	.cfi_offset 26, -48
	.cfi_offset 27, -56
	pcalau12i	$a3, %pc_hi20(g_main_allocator)
	addi.d	$s2, $a3, %pc_lo12(g_main_allocator)
	ld.d	$a3, $s2, 152
	move	$s1, $a2
	move	$s0, $a1
	move	$fp, $a0
