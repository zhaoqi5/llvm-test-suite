...
.LBB2_3:                                # %invoke.cont47
	...
	fld.s	$ft9, $s1, 28
	fld.s	$ft8, $s1, 24
	fmadd.s	$fa3, $ft7, $fa2, $fa3
	fmadd.s	$fs3, $ft12, $fa1, $fa3
	fmul.s	$fa3, $fa4, $ft9
	...
	fld.s	$ft10, $s1, 40
	fld.s	$ft13, $s1, 48
	fmadd.s	$fs5, $ft14, $fa1, $fa3
	fmul.s	$fa3, $fa4, $ft11
	fmadd.s	$fa3, $ft10, $fa2, $fa3
	fmadd.s	$fs4, $ft13, $fa1, $fa3
	fmul.s	$fa3, $fa4, $fs5
	fmadd.s	$fa3, $fa2, $fs3, $fa3
...
.LBB2_6:                                # %if.end.i
	fneg.s	$fa0, $fs5
	fmul.s	$fa0, $fa1, $fa0
	fmadd.s	$fa5, $fa4, $fs4, $fa0
	fneg.s	$fa0, $fs4
	fmul.s	$fa0, $fa2, $fa0
	fmadd.s	$fs6, $fa1, $fs3, $fa0
	fneg.s	$fa0, $fs3
	fmul.s	$fa4, $fa4, $fa0
	vldi	$vr0, -1168
	fadd.s	$fa0, $fa3, $fa0
...
.LBB2_9:                                # %invoke.cont92
	...
	fmadd.s	$ft5, $ft2, $ft1, $ft5
	fmadd.s	$fa7, $ft0, $fa7, $ft5
	fmadd.s	$ft5, $fa2, $fa4, $fa7
	fmul.s	$fa0, $fa0, $ft0
	fmadd.s	$fa0, $ft2, $fa5, $fa0
	fmadd.s	$fa0, $fa2, $ft1, $fa0
	fmadd.s	$fa5, $fa6, $fa3, $fa0
	fnmadd.s	$fa2, $fa2, $fa4, $fa7
	fmul.s	$fa2, $fs4, $fa2
	fmadd.s	$fa2, $fs5, $fa5, $fa2
	fnmadd.s	$fa0, $fa6, $fa3, $fa0
	fmul.s	$fa0, $fs3, $fa0
	fmadd.s	$fa0, $fs4, $ft4, $fa0
	fnmadd.s	$fa1, $ft0, $fa1, $ft3
	fmul.s	$fa1, $fs5, $fa1
	fmadd.s	$fa1, $fs3, $ft5, $fa1
	fld.s	$fa3, $s2, 4
	fld.s	$fa4, $s2, 0
	fld.s	$fa6, $s2, 8
	fld.s	$fa7, $s1, 56
...
.LBB5_12:                               # %if.else.i112
	...
	fmul.s	$fa7, $fa1, $fa2
	movgr2fr.w	$fa6, $zero
.LBB5_13:                               # %_Z13btPlaneSpace1RK9btVector3RS_S2_.exit145
	ld.d	$a0, $fp, 24
	fld.s	$ft2, $a0, 8
	fld.s	$ft3, $a0, 12
	fld.s	$fa1, $a0, 16
