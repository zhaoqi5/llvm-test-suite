...
# %bb.0:                                # %invoke.cont3
	...
	st.d	$a0, $fp, 0
	ori	$a0, $zero, 1
	pcalau12i	$a1, %got_pc_hi20(_ZTV16btManifoldResult)
	ld.d	$a1, $a1, %got_pc_lo12(_ZTV16btManifoldResult)
	st.b	$a0, $fp, 40
	st.h	$a0, $fp, 48
	st.d	$zero, $fp, 20
	addi.d	$a0, $a1, 16
...
# %bb.0:                                # %entry
	...
	move	$fp, $a0
	ld.d	$a0, $a0, 32
	pcalau12i	$a1, %pc_hi20(_ZTV21btCollisionDispatcher+16)
	addi.d	$a1, $a1, %pc_lo12(_ZTV21btCollisionDispatcher+16)
	st.d	$a1, $fp, 0
	beqz	$a0, .LBB5_3
# %bb.1:                                # %entry
	ld.b	$a1, $fp, 40
...
# %bb.0:                                # %entry
	...
	move	$a4, $a1
	ld.d	$a1, $a1, 0
	pcalau12i	$a5, %pc_hi20(_ZTV23btCollisionPairCallback+16)
	addi.d	$a5, $a5, %pc_lo12(_ZTV23btCollisionPairCallback+16)
	ld.d	$a6, $a1, 96
	st.d	$a5, $sp, 0
	st.d	$a2, $sp, 8
	st.d	$a0, $sp, 16
