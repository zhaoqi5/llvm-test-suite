...
# %bb.6:                                # %iter.check69
	...
	ori	$a5, $zero, 64
	bltu	$a4, $a5, .LBB6_29
# %bb.7:                                # %vector.main.loop.iter.check71
	ori	$a3, $zero, 16
	bgeu	$a2, $a3, .LBB6_22
# %bb.8:
	move	$a3, $zero
...
.LBB6_23:                               # %vector.body75
	...
	addi.d	$a6, $a6, 64
	bnez	$a7, .LBB6_23
# %bb.24:                               # %middle.block80
	beq	$a3, $a2, .LBB6_31
# %bb.25:                               # %vec.epilog.iter.check84
	beqz	$a4, .LBB6_29
.LBB6_26:                               # %vec.epilog.ph86
	move	$a6, $a3
	...
	alsl.d	$a6, $a6, $s0, 2
	.p2align	4, , 16
.LBB6_27:                               # %vec.epilog.vector.body89
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a6, 0
	addi.d	$a4, $a4, 4
	...
	addi.d	$a6, $a6, 16
	bnez	$a4, .LBB6_27
# %bb.28:                               # %vec.epilog.middle.block93
	beq	$a3, $a2, .LBB6_31
...
# %bb.43:                               # %vec.epilog.middle.block
	beq	$a1, $a2, .LBB7_46
.LBB7_44:                               # %for.body.i.i.i85.preheader
	sub.d	$a3, $a2, $a1
	alsl.d	$a4, $a1, $a0, 2
	alsl.d	$a1, $a1, $s1, 2
	.p2align	4, , 16
.LBB7_45:                               # %for.body.i.i.i85
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a4, 0
	fst.s	$fa0, $a1, 0
	addi.d	$a3, $a3, -1
...
# %bb.50:                               # %if.then.i99
	...
	or	$s3, $a0, $a2
	bge	$s2, $s3, .LBB7_58
# %bb.51:                               # %if.then.i.i104
	beqz	$s3, .LBB7_59
# %bb.52:                               # %if.then.i.i.i106
	slli.d	$a0, $s3, 2
	ori	$a1, $zero, 16
	pcaddu18i	$ra, %call36(_Z22btAlignedAllocInternalmi)
	jirl	$ra, $ra, 0
...
# %bb.54:                               # %iter.check246
	...
	ori	$a3, $zero, 64
	bltu	$a2, $a3, .LBB7_69
# %bb.55:                               # %vector.main.loop.iter.check248
	ori	$a0, $zero, 16
	bgeu	$s2, $a0, .LBB7_62
# %bb.56:
	move	$a0, $zero
...
.LBB7_59:
	move	$s1, $zero
	bgtz	$s2, .LBB7_53
.LBB7_60:                               # %_ZNK20btAlignedObjectArrayIfE4copyEiiPf.exit.i.i115
	beqz	$a1, .LBB7_73
# %bb.61:                               # %_ZNK20btAlignedObjectArrayIfE4copyEiiPf.exit.i.i115
	ld.b	$a0, $fp, 160
	andi	$a0, $a0, 1
	bnez	$a0, .LBB7_72
	b	.LBB7_73
.LBB7_62:                               # %vector.ph249
	andi	$a2, $s2, 12
...
.LBB7_63:                               # %vector.body252
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB7_63
# %bb.64:                               # %middle.block257
	beq	$a0, $s2, .LBB7_71
# %bb.65:                               # %vec.epilog.iter.check261
	beqz	$a2, .LBB7_69
.LBB7_66:                               # %vec.epilog.ph263
	move	$a4, $a0
	...
	alsl.d	$a4, $a4, $s1, 2
	.p2align	4, , 16
.LBB7_67:                               # %vec.epilog.vector.body266
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a3, 0
	vst	$vr0, $a4, 0
	addi.d	$a2, $a2, 4
	...
	addi.d	$a4, $a4, 16
	bnez	$a2, .LBB7_67
# %bb.68:                               # %vec.epilog.middle.block270
	beq	$a0, $s2, .LBB7_71
.LBB7_69:                               # %for.body.i.i.i127.preheader
	sub.d	$a2, $s2, $a0
	alsl.d	$a3, $a0, $a1, 2
	alsl.d	$a0, $a0, $s1, 2
	.p2align	4, , 16
.LBB7_70:                               # %for.body.i.i.i127
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a3, 0
	fst.s	$fa0, $a0, 0
	addi.d	$a2, $a2, -1
	...
	addi.d	$a0, $a0, 4
	bnez	$a2, .LBB7_70
.LBB7_71:                               # %if.then.i7.i.i133
	ld.bu	$a0, $fp, 160
	beqz	$a0, .LBB7_73
.LBB7_72:                               # %if.then2.i.i.i123
	move	$a0, $a1
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
	ld.w	$s2, $fp, 140
.LBB7_73:                               # %_ZN20btAlignedObjectArrayIfE10deallocateEv.exit.i.i120
	ori	$a0, $zero, 1
	st.b	$a0, $fp, 160
	st.d	$s1, $fp, 152
	st.w	$s3, $fp, 144
.LBB7_74:                               # %_ZN20btAlignedObjectArrayIfE9push_backERKf.exit137
	move	$a0, $s2
.LBB7_75:                               # %_ZN20btAlignedObjectArrayIfE9push_backERKf.exit137
	slli.d	$a1, $a0, 2
	fstx.s	$fs0, $s1, $a1
	fld.s	$fs0, $s0, 8
	addi.w	$a0, $a0, 1
...
# %bb.76:                               # %if.then.i146
	...
	or	$s2, $a0, $a1
	bge	$s3, $s2, .LBB7_84
# %bb.77:                               # %if.then.i.i151
	beqz	$s2, .LBB7_85
# %bb.78:                               # %if.then.i.i.i153
	slli.d	$a0, $s2, 2
	ori	$a1, $zero, 16
	pcaddu18i	$ra, %call36(_Z22btAlignedAllocInternalmi)
	jirl	$ra, $ra, 0
...
# %bb.80:                               # %iter.check278
	...
	ori	$a2, $zero, 64
	bltu	$a1, $a2, .LBB7_95
# %bb.81:                               # %vector.main.loop.iter.check280
	ori	$a0, $zero, 16
	bgeu	$s3, $a0, .LBB7_88
# %bb.82:
	move	$a0, $zero
...
.LBB7_85:
	move	$s0, $zero
	bgtz	$s3, .LBB7_79
.LBB7_86:                               # %_ZNK20btAlignedObjectArrayIfE4copyEiiPf.exit.i.i162
	beqz	$s1, .LBB7_99
# %bb.87:                               # %_ZNK20btAlignedObjectArrayIfE4copyEiiPf.exit.i.i162
	ld.b	$a0, $fp, 160
	andi	$a0, $a0, 1
	bnez	$a0, .LBB7_98
	b	.LBB7_99
.LBB7_88:                               # %vector.ph281
	andi	$a1, $s3, 12
...
.LBB7_89:                               # %vector.body284
	...
	addi.d	$a3, $a3, 64
	bnez	$a4, .LBB7_89
# %bb.90:                               # %middle.block289
	beq	$a0, $s3, .LBB7_97
# %bb.91:                               # %vec.epilog.iter.check293
	beqz	$a1, .LBB7_95
.LBB7_92:                               # %vec.epilog.ph295
	move	$a3, $a0
	...
	alsl.d	$a3, $a3, $s0, 2
	.p2align	4, , 16
.LBB7_93:                               # %vec.epilog.vector.body298
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a2, 0
	vst	$vr0, $a3, 0
	addi.d	$a1, $a1, 4
	...
	addi.d	$a3, $a3, 16
	bnez	$a1, .LBB7_93
# %bb.94:                               # %vec.epilog.middle.block302
	beq	$a0, $s3, .LBB7_97
.LBB7_95:                               # %for.body.i.i.i174.preheader
	sub.d	$a1, $s3, $a0
	alsl.d	$a2, $a0, $s1, 2
	alsl.d	$a0, $a0, $s0, 2
	.p2align	4, , 16
.LBB7_96:                               # %for.body.i.i.i174
                                        # =>This Inner Loop Header: Depth=1
	fld.s	$fa0, $a2, 0
	fst.s	$fa0, $a0, 0
	addi.d	$a1, $a1, -1
	...
	addi.d	$a0, $a0, 4
	bnez	$a1, .LBB7_96
.LBB7_97:                               # %if.then.i7.i.i180
	ld.bu	$a0, $fp, 160
	beqz	$a0, .LBB7_99
.LBB7_98:                               # %if.then2.i.i.i170
	move	$a0, $s1
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
	ld.w	$s3, $fp, 140
.LBB7_99:                               # %_ZN20btAlignedObjectArrayIfE10deallocateEv.exit.i.i167
	ori	$a0, $zero, 1
	st.b	$a0, $fp, 160
	st.d	$s0, $fp, 152
	st.w	$s2, $fp, 144
.LBB7_100:                              # %_ZN20btAlignedObjectArrayIfE9push_backERKf.exit184
	move	$a0, $s3
.LBB7_101:                              # %_ZN20btAlignedObjectArrayIfE9push_backERKf.exit184
	ld.d	$a1, $fp, 40
	slli.d	$a2, $a0, 2
	ld.w	$a3, $a1, 20
	fstx.s	$fs0, $s0, $a2
