...
# %bb.54:                               # %iter.check233
	...
	ori	$a3, $zero, 64
	bltu	$a2, $a3, .LBB7_69
# %bb.55:                               # %vector.main.loop.iter.check235
	ori	$a0, $zero, 16
	bgeu	$s2, $a0, .LBB7_62
# %bb.56:
	move	$a0, $zero
...
.LBB7_63:                               # %vector.body239
	...
	addi.d	$a3, $a3, 64
	bnez	$a4, .LBB7_63
# %bb.64:                               # %middle.block244
	beq	$a0, $s2, .LBB7_71
# %bb.65:                               # %vec.epilog.iter.check249
	andi	$a2, $s2, 12
	beqz	$a2, .LBB7_69
.LBB7_66:                               # %vec.epilog.ph248
	move	$a4, $a0
	...
	alsl.d	$a4, $a4, $s1, 2
	.p2align	4, , 16
.LBB7_67:                               # %vec.epilog.vector.body254
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a3, 0
	vst	$vr0, $a4, 0
	addi.d	$a2, $a2, 4
	...
	addi.d	$a4, $a4, 16
	bnez	$a2, .LBB7_67
# %bb.68:                               # %vec.epilog.middle.block258
	beq	$a0, $s2, .LBB7_71
...
# %bb.80:                               # %iter.check266
	...
	ori	$a2, $zero, 64
	bltu	$a1, $a2, .LBB7_95
# %bb.81:                               # %vector.main.loop.iter.check268
	ori	$a0, $zero, 16
	bgeu	$s3, $a0, .LBB7_88
# %bb.82:
	move	$a0, $zero
...
.LBB7_89:                               # %vector.body272
	...
	addi.d	$a2, $a2, 64
	bnez	$a3, .LBB7_89
# %bb.90:                               # %middle.block277
	beq	$a0, $s3, .LBB7_97
# %bb.91:                               # %vec.epilog.iter.check282
	andi	$a1, $s3, 12
	beqz	$a1, .LBB7_95
.LBB7_92:                               # %vec.epilog.ph281
	move	$a3, $a0
	...
	alsl.d	$a3, $a3, $s0, 2
	.p2align	4, , 16
.LBB7_93:                               # %vec.epilog.vector.body287
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a2, 0
	vst	$vr0, $a3, 0
	addi.d	$a1, $a1, 4
	...
	addi.d	$a3, $a3, 16
	bnez	$a1, .LBB7_93
# %bb.94:                               # %vec.epilog.middle.block291
	beq	$a0, $s3, .LBB7_97
