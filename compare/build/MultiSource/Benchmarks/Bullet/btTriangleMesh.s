...
# %bb.24:                               # %middle.block80
	beq	$a3, $a2, .LBB6_31
# %bb.25:                               # %vec.epilog.iter.check85
	andi	$a4, $a2, 12
	beqz	$a4, .LBB6_29
.LBB6_26:                               # %vec.epilog.ph84
	move	$a6, $a3
	...
	alsl.d	$a6, $a6, $s0, 2
	.p2align	4, , 16
.LBB6_27:                               # %vec.epilog.vector.body90
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a5, 0
	vst	$vr0, $a6, 0
	addi.d	$a4, $a4, 4
	...
	addi.d	$a6, $a6, 16
	bnez	$a4, .LBB6_27
# %bb.28:                               # %vec.epilog.middle.block94
	beq	$a3, $a2, .LBB6_31
...
# %bb.54:                               # %iter.check251
	...
	ori	$a3, $zero, 64
	bltu	$a2, $a3, .LBB7_69
# %bb.55:                               # %vector.main.loop.iter.check253
	ori	$a0, $zero, 16
	bgeu	$s2, $a0, .LBB7_62
# %bb.56:
	move	$a0, $zero
...
.LBB7_63:                               # %vector.body257
	...
	addi.d	$a3, $a3, 64
	bnez	$a4, .LBB7_63
# %bb.64:                               # %middle.block262
	beq	$a0, $s2, .LBB7_71
# %bb.65:                               # %vec.epilog.iter.check267
	andi	$a2, $s2, 12
	beqz	$a2, .LBB7_69
.LBB7_66:                               # %vec.epilog.ph266
	move	$a4, $a0
	...
	alsl.d	$a4, $a4, $s1, 2
	.p2align	4, , 16
.LBB7_67:                               # %vec.epilog.vector.body272
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a3, 0
	vst	$vr0, $a4, 0
	addi.d	$a2, $a2, 4
	...
	addi.d	$a4, $a4, 16
	bnez	$a2, .LBB7_67
# %bb.68:                               # %vec.epilog.middle.block276
	beq	$a0, $s2, .LBB7_71
...
# %bb.80:                               # %iter.check284
	...
	ori	$a2, $zero, 64
	bltu	$a1, $a2, .LBB7_95
# %bb.81:                               # %vector.main.loop.iter.check286
	ori	$a0, $zero, 16
	bgeu	$s3, $a0, .LBB7_88
# %bb.82:
	move	$a0, $zero
...
.LBB7_89:                               # %vector.body290
	...
	addi.d	$a2, $a2, 64
	bnez	$a3, .LBB7_89
# %bb.90:                               # %middle.block295
	beq	$a0, $s3, .LBB7_97
# %bb.91:                               # %vec.epilog.iter.check300
	andi	$a1, $s3, 12
	beqz	$a1, .LBB7_95
.LBB7_92:                               # %vec.epilog.ph299
	move	$a3, $a0
	...
	alsl.d	$a3, $a3, $s0, 2
	.p2align	4, , 16
.LBB7_93:                               # %vec.epilog.vector.body305
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a2, 0
	vst	$vr0, $a3, 0
	addi.d	$a1, $a1, 4
	...
	addi.d	$a3, $a3, 16
	bnez	$a1, .LBB7_93
# %bb.94:                               # %vec.epilog.middle.block309
	beq	$a0, $s3, .LBB7_97
