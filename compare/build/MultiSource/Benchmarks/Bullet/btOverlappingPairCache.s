...
# %bb.29:                               # %iter.check103
	...
	ori	$a4, $zero, 64
	bltu	$a3, $a4, .LBB1_43
# %bb.30:                               # %vector.main.loop.iter.check105
	ori	$a2, $zero, 16
	bgeu	$a1, $a2, .LBB1_36
# %bb.31:
	move	$a2, $zero
...
# %bb.38:                               # %middle.block114
	beq	$a2, $a1, .LBB1_45
# %bb.39:                               # %vec.epilog.iter.check119
	andi	$a3, $a1, 12
	beqz	$a3, .LBB1_43
.LBB1_40:                               # %vec.epilog.ph118
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 2
	slli.d	$a2, $a2, 2
	sub.d	$a3, $a5, $a2
	...
	alsl.d	$a5, $a5, $s1, 2
	.p2align	4, , 16
.LBB1_41:                               # %vec.epilog.vector.body124
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	vst	$vr0, $a5, 0
	addi.d	$a3, $a3, 4
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB1_41
# %bb.42:                               # %vec.epilog.middle.block128
	beq	$a2, $a1, .LBB1_45
