...
.Ltmp4:                                 # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp5:                                 # EH_LABEL
# %bb.29:                               # %call.i.i.i.i74.noexc
                                        #   in Loop: Header=BB0_25 Depth=1
	move	$s3, $a0
	ld.w	$s4, $sp, 156
	ld.d	$s2, $sp, 168
	blt	$s4, $s5, .LBB0_35
.LBB0_30:                               # %for.body.lr.ph.i.i.i86
                                        #   in Loop: Header=BB0_25 Depth=1
	addi.d	$a0, $s2, 4
	addi.d	$a1, $s3, 4
	move	$a2, $s4
	.p2align	4, , 16
.LBB0_31:                               # %for.body.i.i.i88
...
.Ltmp9:                                 # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp10:                                # EH_LABEL
# %bb.44:                               # %if.then.i98.invoke.cont19_crit_edge
	ld.d	$s3, $sp, 168
.LBB0_45:                               # %invoke.cont19
	ld.w	$s4, $s3, 0
	ld.w	$s3, $s3, 4
	ld.w	$a0, $fp, 4
	ld.w	$a1, $fp, 8
...
# %bb.46:                               # %if.then.i122
	...
	or	$s6, $a1, $a2
	bge	$a0, $s6, .LBB0_57
# %bb.47:                               # %if.then.i.i127
	beqz	$s6, .LBB0_50
# %bb.48:                               # %if.then.i.i.i129
	slli.d	$a0, $s6, 5
	alsl.d	$a0, $s6, $a0, 4
.Ltmp12:                                # EH_LABEL
	ori	$a1, $zero, 16
...
.LBB0_50:
	...
	ori	$a1, $zero, 1
	blt	$a0, $a1, .LBB0_53
.LBB0_51:                               # %for.body.lr.ph.i.i.i146
	move	$a1, $zero
	slli.d	$a2, $a0, 5
	alsl.d	$a0, $a0, $a2, 4
	.p2align	4, , 16
.LBB0_52:                               # %for.body.i.i.i149
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a2, $fp, 16
	vldx	$vr0, $a2, $a1
	add.d	$a2, $a2, $a1
	...
	st.w	$a2, $a3, 44
	bne	$a0, $a1, .LBB0_52
.LBB0_53:                               # %_ZNK20btAlignedObjectArrayI11GIM_CONTACTE4copyEiiPS0_.exit.i.i137
	ld.d	$a0, $fp, 16
	beqz	$a0, .LBB0_56
# %bb.54:                               # %_ZNK20btAlignedObjectArrayI11GIM_CONTACTE4copyEiiPS0_.exit.i.i137
	ld.b	$a1, $fp, 24
	andi	$a1, $a1, 1
	beqz	$a1, .LBB0_56
# %bb.55:                               # %if.then2.i.i.i145
.Ltmp14:                                # EH_LABEL
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.Ltmp15:                                # EH_LABEL
.LBB0_56:                               # %_ZN20btAlignedObjectArrayI11GIM_CONTACTE10deallocateEv.exit.i.i143
	ori	$a1, $zero, 1
	ld.w	$a0, $fp, 4
	st.b	$a1, $fp, 24
	st.d	$s2, $fp, 16
...
# %bb.58:                               # %for.body38.preheader
	...
	ori	$s8, $zero, 1
	b	.LBB0_62
.LBB0_59:                               # %_ZN20btAlignedObjectArrayI11GIM_CONTACTE10deallocateEv.exit.i.i217
...
# %bb.72:                               # %if.then.i196
	...
	or	$s1, $a1, $a2
	bge	$a0, $s1, .LBB0_60
# %bb.73:                               # %if.then.i.i201
                                        #   in Loop: Header=BB0_62 Depth=1
	beqz	$s1, .LBB0_80
# %bb.74:                               # %if.then.i.i.i203
                                        #   in Loop: Header=BB0_62 Depth=1
	slli.d	$a0, $s1, 5
	alsl.d	$a0, $s1, $a0, 4
.Ltmp17:                                # EH_LABEL
...
.LBB0_80:                               #   in Loop: Header=BB0_62 Depth=1
	move	$s2, $zero
	blt	$a0, $s8, .LBB0_83
.LBB0_81:                               # %for.body.lr.ph.i.i.i220
                                        #   in Loop: Header=BB0_62 Depth=1
	move	$a1, $zero
	slli.d	$a2, $a0, 5
	alsl.d	$a0, $a0, $a2, 4
	.p2align	4, , 16
.LBB0_82:                               # %for.body.i.i.i223
                                        #   Parent Loop BB0_62 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a2, $fp, 16
	vldx	$vr0, $a2, $a1
	...
	st.w	$a2, $a3, 44
	bne	$a0, $a1, .LBB0_82
.LBB0_83:                               # %_ZNK20btAlignedObjectArrayI11GIM_CONTACTE4copyEiiPS0_.exit.i.i211
                                        #   in Loop: Header=BB0_62 Depth=1
	ld.d	$a0, $fp, 16
	beqz	$a0, .LBB0_59
# %bb.84:                               # %_ZNK20btAlignedObjectArrayI11GIM_CONTACTE4copyEiiPS0_.exit.i.i211
                                        #   in Loop: Header=BB0_62 Depth=1
	ld.b	$a1, $fp, 24
	andi	$a1, $a1, 1
	beqz	$a1, .LBB0_59
# %bb.85:                               # %if.then2.i.i.i219
                                        #   in Loop: Header=BB0_62 Depth=1
.Ltmp19:                                # EH_LABEL
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
...
# %bb.95:                               # %ehcleanup88
	...
	andi	$a1, $a1, 1
	beqz	$a1, .LBB0_97
# %bb.96:                               # %if.then2.i.i.i257
.Ltmp22:                                # EH_LABEL
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.Ltmp23:                                # EH_LABEL
.LBB0_97:                               # %invoke.cont89
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB0_98:                               # %terminate.lpad
.Ltmp24:                                # EH_LABEL
