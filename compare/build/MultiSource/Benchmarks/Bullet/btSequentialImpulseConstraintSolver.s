...
# %bb.7:                                #   in Loop: Header=BB22_3 Depth=1
	bstrpick.d	$a1, $a1, 31, 0
	b	.LBB22_11
.LBB22_8:                               # %_ZN35btSequentialImpulseConstraintSolver10btRandInt2Ei.exit.peel694
                                        #   in Loop: Header=BB22_3 Depth=1
	ld.d	$a0, $s0, 152
	mul.d	$a1, $a1, $t0
	add.d	$a2, $a1, $t1
	...
	ori	$a3, $zero, 2
	beq	$a7, $a3, .LBB22_11
# %bb.9:                                # %_ZN35btSequentialImpulseConstraintSolver10btRandInt2Ei.exit.peel726
                                        #   in Loop: Header=BB22_3 Depth=1
	mul.d	$a1, $a2, $t0
	add.d	$a2, $a1, $t1
	bstrpick.d	$a1, $a2, 31, 0
	...
	ori	$a3, $zero, 3
	beq	$a7, $a3, .LBB22_11
# %bb.10:                               # %_ZN35btSequentialImpulseConstraintSolver10btRandInt2Ei.exit.peel758
                                        #   in Loop: Header=BB22_3 Depth=1
	mul.d	$a1, $a2, $t0
	add.d	$a2, $a1, $t1
	bstrpick.d	$a1, $a2, 31, 0
...
# %bb.14:                               #   in Loop: Header=BB22_3 Depth=1
	bstrpick.d	$a1, $a1, 31, 0
	b	.LBB22_18
.LBB22_15:                              # %_ZN35btSequentialImpulseConstraintSolver10btRandInt2Ei.exit148.peel795
                                        #   in Loop: Header=BB22_3 Depth=1
	ld.d	$a0, $s0, 184
	mul.d	$a1, $a1, $t0
	add.d	$a2, $a1, $t1
	...
	ori	$a3, $zero, 2
	beq	$s7, $a3, .LBB22_18
# %bb.16:                               # %_ZN35btSequentialImpulseConstraintSolver10btRandInt2Ei.exit148.peel827
                                        #   in Loop: Header=BB22_3 Depth=1
	mul.d	$a1, $a2, $t0
	add.d	$a2, $a1, $t1
	bstrpick.d	$a1, $a2, 31, 0
	...
	ori	$a3, $zero, 3
	beq	$s7, $a3, .LBB22_18
# %bb.17:                               # %_ZN35btSequentialImpulseConstraintSolver10btRandInt2Ei.exit148.peel859
                                        #   in Loop: Header=BB22_3 Depth=1
	mul.d	$a1, $a2, $t0
	add.d	$a2, $a1, $t1
	bstrpick.d	$a1, $a2, 31, 0
...
# %bb.26:                               # %invoke.cont207
	...
	ld.w	$s1, $fp, 224
	blt	$s8, $s1, .LBB22_66
.LBB22_27:                              # %if.else.i381
                                        #   in Loop: Header=BB22_25 Depth=2
	ld.w	$a1, $fp, 256
	ori	$a2, $zero, 2
	bne	$a1, $a2, .LBB22_41
# %bb.28:                               # %land.lhs.true.i385
                                        #   in Loop: Header=BB22_25 Depth=2
	fld.s	$fa0, $fp, 360
...
# %bb.30:                               # %if.then.i.i424
	...
	move	$a0, $s1
	bge	$s1, $s2, .LBB22_62
# %bb.31:                               # %if.then.i.i.i429
                                        #   in Loop: Header=BB22_25 Depth=2
	st.d	$s2, $sp, 24                    # 8-byte Folded Spill
	beqz	$s2, .LBB22_55
# %bb.32:                               # %if.then.i.i.i.i431
                                        #   in Loop: Header=BB22_25 Depth=2
	mul.d	$a0, $s2, $s6
.Ltmp98:                                # EH_LABEL
	ori	$a1, $zero, 16
...
# %bb.33:                               # %call.i.i.i.i.i.noexc456
	...
	b	.LBB22_58
	.p2align	4, , 16
.LBB22_34:                              # %if.else.i299
                                        #   in Loop: Header=BB22_25 Depth=2
	ld.w	$a1, $s1, 256
	ori	$a2, $zero, 2
	bne	$a1, $a2, .LBB22_42
# %bb.35:                               # %land.lhs.true.i303
                                        #   in Loop: Header=BB22_25 Depth=2
	fld.s	$fa0, $s1, 360
	fcmp.ceq.s	$fcc0, $fa0, $fs0
	bcnez	$fcc0, .LBB22_43
...
# %bb.37:                               # %if.then.i.i342
	...
	move	$a0, $s7
	bge	$s7, $fp, .LBB22_51
# %bb.38:                               # %if.then.i.i.i347
                                        #   in Loop: Header=BB22_25 Depth=2
	st.d	$fp, $sp, 24                    # 8-byte Folded Spill
	beqz	$fp, .LBB22_44
# %bb.39:                               # %if.then.i.i.i.i349
                                        #   in Loop: Header=BB22_25 Depth=2
	mul.d	$a0, $fp, $s6
.Ltmp93:                                # EH_LABEL
	ori	$a1, $zero, 16
...
.LBB22_44:                              #   in Loop: Header=BB22_25 Depth=2
	...
	ori	$a1, $zero, 1
	blt	$a0, $a1, .LBB22_47
.LBB22_45:                              # %for.body.lr.ph.i.i.i.i365
                                        #   in Loop: Header=BB22_25 Depth=2
	move	$fp, $zero
	mul.d	$s2, $a0, $s6
	.p2align	4, , 16
.LBB22_46:                              # %for.body.i.i.i.i368
                                        #   Parent Loop BB22_3 Depth=1
	...
	addi.d	$fp, $fp, 112
	bne	$s2, $fp, .LBB22_46
.LBB22_47:                              # %_ZNK20btAlignedObjectArrayI12btSolverBodyE4copyEiiPS0_.exit.i.i.i356
                                        #   in Loop: Header=BB22_25 Depth=2
	ld.d	$a0, $s0, 24
	ld.d	$s2, $sp, 112                   # 8-byte Folded Reload
	ld.d	$fp, $sp, 24                    # 8-byte Folded Reload
	beqz	$a0, .LBB22_50
# %bb.48:                               # %_ZNK20btAlignedObjectArrayI12btSolverBodyE4copyEiiPS0_.exit.i.i.i356
                                        #   in Loop: Header=BB22_25 Depth=2
	ld.b	$a1, $s0, 32
	andi	$a1, $a1, 1
	beqz	$a1, .LBB22_50
# %bb.49:                               # %if.then2.i.i.i.i364
                                        #   in Loop: Header=BB22_25 Depth=2
.Ltmp95:                                # EH_LABEL
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.Ltmp96:                                # EH_LABEL
.LBB22_50:                              # %_ZN20btAlignedObjectArrayI12btSolverBodyE10deallocateEv.exit.i.i.i362
                                        #   in Loop: Header=BB22_25 Depth=2
	ld.w	$a0, $s0, 12
	ori	$a1, $zero, 1
	st.b	$a1, $s0, 32
...
.LBB22_51:                              # %_ZN20btAlignedObjectArrayI12btSolverBodyE6expandERKS0_.exit.i310
                                        #   in Loop: Header=BB22_25 Depth=2
	ld.d	$a1, $s0, 24
	addi.d	$a0, $a0, 1
	st.w	$a0, $s0, 12
...
.LBB22_55:                              #   in Loop: Header=BB22_25 Depth=2
	...
	ori	$a1, $zero, 1
	blt	$a0, $a1, .LBB22_58
.LBB22_56:                              # %for.body.lr.ph.i.i.i.i447
                                        #   in Loop: Header=BB22_25 Depth=2
	move	$s8, $zero
	mul.d	$s2, $a0, $s6
	.p2align	4, , 16
.LBB22_57:                              # %for.body.i.i.i.i450
                                        #   Parent Loop BB22_3 Depth=1
                                        #     Parent Loop BB22_25 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$a1, $s0, 24
	...
	addi.d	$s8, $s8, 112
	bne	$s2, $s8, .LBB22_57
.LBB22_58:                              # %_ZNK20btAlignedObjectArrayI12btSolverBodyE4copyEiiPS0_.exit.i.i.i438
                                        #   in Loop: Header=BB22_25 Depth=2
	ld.d	$a0, $s0, 24
	ld.d	$s2, $sp, 24                    # 8-byte Folded Reload
	beqz	$a0, .LBB22_61
# %bb.59:                               # %_ZNK20btAlignedObjectArrayI12btSolverBodyE4copyEiiPS0_.exit.i.i.i438
                                        #   in Loop: Header=BB22_25 Depth=2
	ld.b	$a1, $s0, 32
	andi	$a1, $a1, 1
	beqz	$a1, .LBB22_61
# %bb.60:                               # %if.then2.i.i.i.i446
                                        #   in Loop: Header=BB22_25 Depth=2
.Ltmp100:                               # EH_LABEL
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.Ltmp101:                               # EH_LABEL
.LBB22_61:                              # %_ZN20btAlignedObjectArrayI12btSolverBodyE10deallocateEv.exit.i.i.i444
                                        #   in Loop: Header=BB22_25 Depth=2
	ld.w	$a0, $s0, 12
	ori	$a1, $zero, 1
	st.b	$a1, $s0, 32
	...
	st.w	$s2, $s0, 16
	ld.d	$s3, $sp, 80                    # 8-byte Folded Reload
.LBB22_62:                              # %_ZN20btAlignedObjectArrayI12btSolverBodyE6expandERKS0_.exit.i392
                                        #   in Loop: Header=BB22_25 Depth=2
	ld.d	$a1, $s0, 24
	addi.d	$a0, $a0, 1
	st.w	$a0, $s0, 12
...
# %bb.86:                               # %if.then.i.i215
	...
	move	$a0, $s1
	bge	$s1, $s2, .LBB22_118
# %bb.87:                               # %if.then.i.i.i220
                                        #   in Loop: Header=BB22_81 Depth=2
	st.d	$s2, $sp, 24                    # 8-byte Folded Spill
	beqz	$s2, .LBB22_111
# %bb.88:                               # %if.then.i.i.i.i222
                                        #   in Loop: Header=BB22_81 Depth=2
	mul.d	$a0, $s2, $s6
.Ltmp85:                                # EH_LABEL
	ori	$a1, $zero, 16
...
.LBB22_111:                             #   in Loop: Header=BB22_81 Depth=2
	...
	ori	$a1, $zero, 1
	blt	$a0, $a1, .LBB22_114
.LBB22_112:                             # %for.body.lr.ph.i.i.i.i238
                                        #   in Loop: Header=BB22_81 Depth=2
	move	$s8, $zero
	mul.d	$s2, $a0, $s6
	.p2align	4, , 16
.LBB22_113:                             # %for.body.i.i.i.i241
                                        #   Parent Loop BB22_3 Depth=1
                                        #     Parent Loop BB22_81 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ld.d	$a1, $s0, 24
	...
	addi.d	$s8, $s8, 112
	bne	$s2, $s8, .LBB22_113
.LBB22_114:                             # %_ZNK20btAlignedObjectArrayI12btSolverBodyE4copyEiiPS0_.exit.i.i.i229
                                        #   in Loop: Header=BB22_81 Depth=2
	ld.d	$a0, $s0, 24
	ld.d	$s2, $sp, 24                    # 8-byte Folded Reload
	beqz	$a0, .LBB22_117
# %bb.115:                              # %_ZNK20btAlignedObjectArrayI12btSolverBodyE4copyEiiPS0_.exit.i.i.i229
                                        #   in Loop: Header=BB22_81 Depth=2
	ld.b	$a1, $s0, 32
	andi	$a1, $a1, 1
	beqz	$a1, .LBB22_117
# %bb.116:                              # %if.then2.i.i.i.i237
                                        #   in Loop: Header=BB22_81 Depth=2
.Ltmp87:                                # EH_LABEL
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.Ltmp88:                                # EH_LABEL
.LBB22_117:                             # %_ZN20btAlignedObjectArrayI12btSolverBodyE10deallocateEv.exit.i.i.i235
                                        #   in Loop: Header=BB22_81 Depth=2
	ld.w	$a0, $s0, 12
	ori	$a1, $zero, 1
	st.b	$a1, $s0, 32
