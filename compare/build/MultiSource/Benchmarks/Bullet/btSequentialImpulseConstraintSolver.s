...
# %bb.98:                               # %call.i.i.i.i.noexc455
	...
	ld.d	$a0, $s3, 184
	blez	$a1, .LBB21_105
.LBB21_99:                              # %iter.check543
	ori	$a3, $zero, 4
	move	$a2, $zero
	bltu	$a1, $a3, .LBB21_114
# %bb.100:                              # %iter.check543
	sub.d	$a3, $s0, $a0
	ori	$a4, $zero, 64
	bltu	$a3, $a4, .LBB21_114
# %bb.101:                              # %vector.main.loop.iter.check545
	ori	$a2, $zero, 16
...
.LBB21_108:                             # %vector.body549
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB21_108
# %bb.109:                              # %middle.block554
	beq	$a2, $a1, .LBB21_116
# %bb.110:                              # %vec.epilog.iter.check558
	beqz	$a3, .LBB21_114
.LBB21_111:                             # %vec.epilog.ph560
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 2
	slli.d	$a2, $a2, 2
	sub.d	$a3, $a5, $a2
	...
	alsl.d	$a5, $a5, $s0, 2
	.p2align	4, , 16
.LBB21_112:                             # %vec.epilog.vector.body563
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	vst	$vr0, $a5, 0
	addi.d	$a3, $a3, 4
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB21_112
# %bb.113:                              # %vec.epilog.middle.block567
	beq	$a2, $a1, .LBB21_116
...
.LBB21_120:                             # %invoke.cont308
	st.w	$s1, $s3, 172
	blez	$s2, .LBB21_134
# %bb.121:                              # %iter.check572
	ld.d	$a0, $s3, 152
	ori	$a1, $zero, 4
	bgeu	$s2, $a1, .LBB21_123
# %bb.122:
	move	$a1, $zero
	b	.LBB21_132
.LBB21_123:                             # %vector.main.loop.iter.check574
	ori	$a1, $zero, 16
	bgeu	$s2, $a1, .LBB21_125
# %bb.124:
	move	$a1, $zero
	b	.LBB21_129
.LBB21_125:                             # %vector.ph575
	andi	$a2, $s2, 12
...
.LBB21_126:                             # %vector.body578
	...
	addi.d	$a3, $a3, 64
	bnez	$a4, .LBB21_126
# %bb.127:                              # %middle.block581
	beq	$a1, $s2, .LBB21_134
# %bb.128:                              # %vec.epilog.iter.check585
	beqz	$a2, .LBB21_132
.LBB21_129:                             # %vec.epilog.ph587
	move	$a3, $a1
	...
	alsl.d	$a3, $a3, $a0, 2
	.p2align	4, , 16
.LBB21_130:                             # %vec.epilog.vector.body590
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a3, 0
	vaddi.wu	$vr0, $vr0, 4
	addi.d	$a2, $a2, 4
	addi.d	$a3, $a3, 16
	bnez	$a2, .LBB21_130
# %bb.131:                              # %vec.epilog.middle.block595
	beq	$a1, $s2, .LBB21_134
...
.LBB21_134:                             # %for.cond321.preheader
	blez	$s1, .LBB21_148
# %bb.135:                              # %iter.check600
	ld.d	$a0, $s3, 184
	ori	$a1, $zero, 4
	bgeu	$s1, $a1, .LBB21_137
# %bb.136:
	move	$a1, $zero
	b	.LBB21_146
.LBB21_137:                             # %vector.main.loop.iter.check602
	ori	$a1, $zero, 16
	bgeu	$s1, $a1, .LBB21_139
# %bb.138:
	move	$a1, $zero
	b	.LBB21_143
.LBB21_139:                             # %vector.ph603
	andi	$a2, $s1, 12
	pcalau12i	$a1, %pc_hi20(.LCPI21_1)
	xvld	$xr0, $a1, %pc_lo12(.LCPI21_1)
...
.LBB21_140:                             # %vector.body606
	...
	addi.d	$a3, $a3, 64
	bnez	$a4, .LBB21_140
# %bb.141:                              # %middle.block612
	beq	$a1, $s1, .LBB21_148
# %bb.142:                              # %vec.epilog.iter.check616
	beqz	$a2, .LBB21_146
.LBB21_143:                             # %vec.epilog.ph618
	move	$a3, $a1
	pcalau12i	$a1, %pc_hi20(.LCPI21_2)
	vld	$vr0, $a1, %pc_lo12(.LCPI21_2)
	...
	alsl.d	$a3, $a3, $a0, 2
	.p2align	4, , 16
.LBB21_144:                             # %vec.epilog.vector.body624
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a3, 0
	vaddi.wu	$vr0, $vr0, 4
	addi.d	$a2, $a2, 4
	addi.d	$a3, $a3, 16
	bnez	$a2, .LBB21_144
# %bb.145:                              # %vec.epilog.middle.block629
	beq	$a1, $s1, .LBB21_148
