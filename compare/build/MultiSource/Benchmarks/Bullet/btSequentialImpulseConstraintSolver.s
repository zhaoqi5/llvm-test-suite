...
# %bb.109:                              # %middle.block554
	beq	$a2, $a1, .LBB21_116
# %bb.110:                              # %vec.epilog.iter.check559
	andi	$a3, $a1, 12
	beqz	$a3, .LBB21_114
.LBB21_111:                             # %vec.epilog.ph558
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 2
	slli.d	$a2, $a2, 2
	sub.d	$a3, $a5, $a2
	...
	alsl.d	$a5, $a5, $s0, 2
	.p2align	4, , 16
.LBB21_112:                             # %vec.epilog.vector.body564
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	vst	$vr0, $a5, 0
	addi.d	$a3, $a3, 4
...
# %bb.122:
	move	$a2, $zero
	b	.LBB21_132
.LBB21_123:                             # %vector.main.loop.iter.check575
	ori	$a2, $zero, 16
	bgeu	$s2, $a2, .LBB21_125
# %bb.124:
	move	$a2, $zero
	b	.LBB21_129
.LBB21_125:                             # %vector.ph576
...
.LBB21_126:                             # %vector.body579
	...
	addi.d	$a3, $a3, 64
	bnez	$a4, .LBB21_126
# %bb.127:                              # %middle.block582
	beq	$a2, $s2, .LBB21_134
# %bb.128:                              # %vec.epilog.iter.check587
	andi	$a3, $s2, 12
	beqz	$a3, .LBB21_132
.LBB21_129:                             # %vec.epilog.ph586
	move	$a4, $a2
	...
	alsl.d	$a4, $a4, $a1, 2
	.p2align	4, , 16
.LBB21_130:                             # %vec.epilog.vector.body592
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a4, 0
	vaddi.wu	$vr0, $vr0, 4
	addi.d	$a3, $a3, 4
	addi.d	$a4, $a4, 16
	bnez	$a3, .LBB21_130
# %bb.131:                              # %vec.epilog.middle.block597
	beq	$a2, $s2, .LBB21_134
...
# %bb.136:
	move	$a1, $zero
	b	.LBB21_146
.LBB21_137:                             # %vector.main.loop.iter.check604
	ori	$a1, $zero, 16
	bgeu	$s1, $a1, .LBB21_139
# %bb.138:
	move	$a1, $zero
	b	.LBB21_143
.LBB21_139:                             # %vector.ph605
...
.LBB21_140:                             # %vector.body608
	...
	addi.d	$a2, $a2, 64
	bnez	$a3, .LBB21_140
# %bb.141:                              # %middle.block614
	beq	$a1, $s1, .LBB21_148
# %bb.142:                              # %vec.epilog.iter.check619
	andi	$a2, $s1, 12
	beqz	$a2, .LBB21_146
.LBB21_143:                             # %vec.epilog.ph618
	...
	alsl.d	$a3, $a3, $a0, 2
	.p2align	4, , 16
.LBB21_144:                             # %vec.epilog.vector.body627
                                        # =>This Inner Loop Header: Depth=1
	vst	$vr0, $a3, 0
	vaddi.wu	$vr0, $vr0, 4
	addi.d	$a2, $a2, 4
	addi.d	$a3, $a3, 16
	bnez	$a2, .LBB21_144
# %bb.145:                              # %vec.epilog.middle.block632
	beq	$a1, $s1, .LBB21_148
