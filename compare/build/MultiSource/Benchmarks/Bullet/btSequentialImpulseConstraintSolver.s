...
# %bb.0:                                # %entry
	...
	.cfi_offset 23, -24
	move	$fp, $a0
	pcalau12i	$a0, %pc_hi20(_ZTV35btSequentialImpulseConstraintSolver+16)
	addi.d	$a1, $a0, %pc_lo12(_ZTV35btSequentialImpulseConstraintSolver+16)
	ld.d	$a0, $fp, 216
	st.d	$a1, $fp, 0
	beqz	$a0, .LBB5_3
# %bb.1:                                # %entry
...
# %bb.72:                               # %call.i.i.i.i.noexc408
	...
	ld.d	$a0, $s4, 152
	blez	$a1, .LBB21_83
.LBB21_73:                              # %for.body.lr.ph.i.i.i400
	ori	$a3, $zero, 8
	move	$a2, $zero
	bltu	$a1, $a3, .LBB21_78
# %bb.74:                               # %for.body.lr.ph.i.i.i400
	sub.d	$a3, $s0, $a0
	ori	$a4, $zero, 32
	bltu	$a3, $a4, .LBB21_78
# %bb.75:                               # %vector.ph
...
# %bb.77:                               # %middle.block
	beq	$a2, $a1, .LBB21_80
.LBB21_78:                              # %for.body.i.i.i402.preheader
	sub.d	$a1, $a1, $a2
	alsl.d	$a3, $a2, $a0, 2
	alsl.d	$a2, $a2, $s0, 2
	.p2align	4, , 16
.LBB21_79:                              # %for.body.i.i.i402
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a4, $a3, 0
	st.w	$a4, $a2, 0
	addi.d	$a1, $a1, -1
	...
	addi.d	$a2, $a2, 4
	bnez	$a1, .LBB21_79
.LBB21_80:                              # %if.then.i7.i.i
	ld.bu	$a1, $s4, 160
	bnez	$a1, .LBB21_85
	b	.LBB21_86
.LBB21_81:                              # %if.then5.i376.for.body10.lr.ph.i379_crit_edge
	ld.d	$s0, $s4, 152
	b	.LBB21_87
.LBB21_82:
	move	$s0, $zero
...
.LBB21_86:                              # %_ZN20btAlignedObjectArrayIiE10deallocateEv.exit.i.i
	...
	st.d	$s0, $s4, 152
	st.w	$fp, $s4, 144
.LBB21_87:                              # %for.body10.lr.ph.i379
	alsl.d	$a0, $s2, $s0, 2
	sub.d	$a1, $fp, $s2
	slli.d	$a2, $a1, 2
	move	$a1, $zero
...
# %bb.89:                               # %if.then5.i413
	ld.w	$a0, $s4, 176
	bge	$a0, $s1, .LBB21_101
# %bb.90:                               # %if.then.i.i425
	beqz	$s1, .LBB21_102
# %bb.91:                               # %if.then.i.i.i427
	slli.d	$a0, $s1, 2
.Ltmp72:                                # EH_LABEL
	ori	$a1, $zero, 16
	pcaddu18i	$ra, %call36(_Z22btAlignedAllocInternalmi)
	jirl	$ra, $ra, 0
.Ltmp73:                                # EH_LABEL
# %bb.92:                               # %call.i.i.i.i.noexc455
	move	$s0, $a0
	ld.w	$a1, $s4, 172
	ld.d	$a0, $s4, 184
	blez	$a1, .LBB21_103
.LBB21_93:                              # %for.body.lr.ph.i.i.i443
	ori	$a3, $zero, 8
	move	$a2, $zero
	bltu	$a1, $a3, .LBB21_98
# %bb.94:                               # %for.body.lr.ph.i.i.i443
	sub.d	$a3, $s0, $a0
	ori	$a4, $zero, 32
	bltu	$a3, $a4, .LBB21_98
# %bb.95:                               # %vector.ph536
...
.LBB21_96:                              # %vector.body539
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB21_96
# %bb.97:                               # %middle.block544
	beq	$a2, $a1, .LBB21_100
.LBB21_98:                              # %for.body.i.i.i445.preheader
	sub.d	$a1, $a1, $a2
	alsl.d	$a3, $a2, $a0, 2
	alsl.d	$a2, $a2, $s0, 2
	.p2align	4, , 16
.LBB21_99:                              # %for.body.i.i.i445
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a4, $a3, 0
	st.w	$a4, $a2, 0
	addi.d	$a1, $a1, -1
	...
	addi.d	$a2, $a2, 4
	bnez	$a1, .LBB21_99
.LBB21_100:                             # %if.then.i7.i.i451
	ld.bu	$a1, $s4, 192
	bnez	$a1, .LBB21_105
	b	.LBB21_106
.LBB21_101:                             # %if.then5.i413.for.body10.lr.ph.i416_crit_edge
	ld.d	$s0, $s4, 184
	b	.LBB21_107
.LBB21_102:
	move	$s0, $zero
	...
	ld.d	$a0, $s4, 184
	bgtz	$a1, .LBB21_93
.LBB21_103:                             # %_ZNK20btAlignedObjectArrayIiE4copyEiiPi.exit.i.i435
	beqz	$a0, .LBB21_106
# %bb.104:                              # %_ZNK20btAlignedObjectArrayIiE4copyEiiPi.exit.i.i435
	ld.b	$a1, $s4, 192
	andi	$a1, $a1, 1
	beqz	$a1, .LBB21_106
.LBB21_105:                             # %if.then2.i.i.i442
.Ltmp74:                                # EH_LABEL
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.Ltmp75:                                # EH_LABEL
.LBB21_106:                             # %_ZN20btAlignedObjectArrayIiE10deallocateEv.exit.i.i440
	ori	$a0, $zero, 1
	st.b	$a0, $s4, 192
	st.d	$s0, $s4, 184
	st.w	$s1, $s4, 176
.LBB21_107:                             # %for.body10.lr.ph.i416
	alsl.d	$a0, $s2, $s0, 2
	sub.d	$a1, $s1, $s2
	slli.d	$a2, $a1, 2
	move	$a1, $zero
	pcaddu18i	$ra, %call36(memset)
	jirl	$ra, $ra, 0
.LBB21_108:                             # %invoke.cont308
	st.w	$s1, $s4, 172
	blez	$fp, .LBB21_116
# %bb.109:                              # %for.body313.lr.ph
	ld.d	$a1, $s4, 152
	ori	$a0, $zero, 8
...
.LBB21_112:                             # %vector.body552
	...
	addi.d	$a2, $a2, 32
	bnez	$a3, .LBB21_112
# %bb.113:                              # %middle.block555
	beq	$a0, $fp, .LBB21_116
.LBB21_114:                             # %for.body313.preheader
	alsl.d	$a1, $a0, $a1, 2
	sub.d	$a2, $fp, $a0
	.p2align	4, , 16
.LBB21_115:                             # %for.body313
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a0, $a1, 0
	addi.d	$a0, $a0, 1
	addi.d	$a2, $a2, -1
	addi.d	$a1, $a1, 4
	bnez	$a2, .LBB21_115
.LBB21_116:                             # %for.cond321.preheader
	blez	$s1, .LBB21_124
# %bb.117:                              # %for.body323.lr.ph
	ld.d	$a1, $s4, 184
	ori	$a0, $zero, 8
...
.LBB21_120:                             # %vector.body563
	...
	addi.d	$a2, $a2, 32
	bnez	$a3, .LBB21_120
# %bb.121:                              # %middle.block569
	beq	$a0, $s1, .LBB21_124
.LBB21_122:                             # %for.body323.preheader
	alsl.d	$a1, $a0, $a1, 2
	sub.d	$a2, $s1, $a0
	.p2align	4, , 16
.LBB21_123:                             # %for.body323
                                        # =>This Inner Loop Header: Depth=1
	st.w	$a0, $a1, 0
	addi.d	$a0, $a0, 1
	addi.d	$a2, $a2, -1
...
.LBB21_135:                             # %lpad
.Ltmp36:                                # EH_LABEL
.LBB21_136:                             # %ehcleanup335
	move	$fp, $a0
.Ltmp77:                                # EH_LABEL
	pcaddu18i	$ra, %call36(_ZN15CProfileManager12Stop_ProfileEv)
	jirl	$ra, $ra, 0
.Ltmp78:                                # EH_LABEL
# %bb.137:                              # %invoke.cont336
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB21_138:                             # %terminate.lpad
.Ltmp79:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.Lfunc_end21:
