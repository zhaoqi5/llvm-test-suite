...
# %bb.5:                                # %invoke.cont12
	ld.d	$a0, $fp, 48
	pcalau12i	$a2, %pc_hi20(_ZTVZN20btMultiSapBroadphaseC1EiP22btOverlappingPairCacheE31btMultiSapOverlapFilterCallback+16)
	addi.d	$a2, $a2, %pc_lo12(_ZTVZN20btMultiSapBroadphaseC1EiP22btOverlappingPairCacheE31btMultiSapOverlapFilterCallback+16)
	st.d	$a2, $a1, 0
	ld.d	$a2, $a0, 0
	st.d	$a1, $fp, 72
	ld.d	$a2, $a2, 88
...
# %bb.0:                                # %entry
	...
	move	$fp, $a0
	ld.bu	$a0, $a0, 64
	pcalau12i	$a1, %pc_hi20(_ZTV20btMultiSapBroadphase+16)
	addi.d	$a1, $a1, %pc_lo12(_ZTV20btMultiSapBroadphase+16)
	ori	$a2, $zero, 1
	st.d	$a1, $fp, 0
	bne	$a0, $a2, .LBB4_3
# %bb.1:                                # %if.then
...
.LBB15_48:                              # %for.body.i.i.i70
	...
	st.d	$a2, $a4, 24
	bne	$a1, $a0, .LBB15_48
.LBB15_49:                              # %_ZNK20btAlignedObjectArrayI16btBroadphasePairE4copyEiiPS0_.exit.i.i59
	ld.d	$a0, $s0, 16
	beqz	$a0, .LBB15_52
# %bb.50:                               # %_ZNK20btAlignedObjectArrayI16btBroadphasePairE4copyEiiPS0_.exit.i.i59
	ld.b	$a1, $s0, 24
	andi	$a1, $a1, 1
	beqz	$a1, .LBB15_52
# %bb.51:                               # %if.then2.i.i.i66
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.LBB15_52:                              # %_ZN20btAlignedObjectArrayI16btBroadphasePairE10deallocateEv.exit.i.i65
	ori	$a0, $zero, 1
	st.b	$a0, $s0, 24
	st.d	$s1, $s0, 16
	st.w	$s2, $s0, 8
.LBB15_53:                              # %for.body10.lr.ph.i37
	slli.d	$a0, $s3, 5
	xvrepli.b	$xr0, 0
	.p2align	4, , 16
.LBB15_54:                              # %for.body10.i42
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a1, $s0, 16
	xvstx	$xr0, $a1, $a0
	addi.d	$s5, $s5, 1
...
.LBB15_55:
	move	$s3, $s2
.LBB15_56:                              # %_ZN20btAlignedObjectArrayI16btBroadphasePairE6resizeEiRKS0_.exit80
	st.w	$s3, $s0, 4
	st.w	$zero, $fp, 80
.LBB15_57:                              # %if.end73
...
.Lfunc_end22:
	.size	_ZN23btOverlapFilterCallbackD2Ev, .Lfunc_end22-_ZN23btOverlapFilterCallbackD2Ev
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function _ZZN20btMultiSapBroadphaseC1EiP22btOverlappingPairCacheEN31btMultiSapOverlapFilterCallbackD0Ev
...
.Lfunc_end23:
	...
	.cfi_endproc
                                        # -- End function
	.p2align	2                               # -- Begin function _ZZN20btMultiSapBroadphaseC1EiP22btOverlappingPairCacheENK31btMultiSapOverlapFilterCallback23needBroadphaseCollisionEP17btBroadphaseProxyS4_
...
.Lfunc_end24:
	.size	_ZZN20btMultiSapBroadphaseC1EiP22btOverlappingPairCacheENK31btMultiSapOverlapFilterCallback23needBroadphaseCollisionEP17btBroadphaseProxyS4_, .Lfunc_end24-_ZZN20btMultiSapBroadphaseC1EiP22btOverlappingPairCacheENK31btMultiSapOverlapFilterCallback23needBroadphaseCollisionEP17btBroadphaseProxyS4_
                                        # -- End function
	.p2align	2                               # -- Begin function _ZZN20btMultiSapBroadphase7setAabbEP17btBroadphaseProxyRK9btVector3S4_P12btDispatcherEN21MyNodeOverlapCallbackD0Ev
...
.Lfunc_end25:
	...
	.cfi_endproc
                                        # -- End function
	.p2align	2                               # -- Begin function _ZZN20btMultiSapBroadphase7setAabbEP17btBroadphaseProxyRK9btVector3S4_P12btDispatcherEN21MyNodeOverlapCallback11processNodeEii
