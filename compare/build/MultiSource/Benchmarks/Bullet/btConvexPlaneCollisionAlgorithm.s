...
# %bb.0:                                # %entry
	ld.bu	$a1, $a0, 16
	pcalau12i	$a2, %pc_hi20(_ZTV31btConvexPlaneCollisionAlgorithm+16)
	addi.d	$a2, $a2, %pc_lo12(_ZTV31btConvexPlaneCollisionAlgorithm+16)
	ori	$a3, $zero, 1
	st.d	$a2, $a0, 0
	bne	$a1, $a3, .LBB1_3
# %bb.1:                                # %if.then
...
.LBB4_7:                                # %for.body
	...
	fmadd.s	$fa4, $fa2, $fs5, $fa4
	fmadd.s	$fa5, $fs3, $fs4, $fa4
	fmul.s	$fa2, $fs2, $fa2
	fmadd.s	$fa2, $fa0, $fs4, $fa2
	fmadd.s	$fa2, $fa3, $ft2, $fa2
	fmadd.s	$fa6, $fs0, $fs5, $fa2
	fmul.s	$fa3, $fs2, $fa3
