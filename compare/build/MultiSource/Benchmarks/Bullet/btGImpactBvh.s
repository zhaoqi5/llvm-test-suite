...
# %bb.16:                               # %if.then.i.i.i
	...
	ld.d	$a0, $s0, 16
	blez	$a1, .LBB7_27
.LBB7_17:                               # %for.body.lr.ph.i.i.i
                                        #   in Loop: Header=BB7_6 Depth=1
	move	$a2, $zero
	bltu	$a1, $s6, .LBB7_22
# %bb.18:                               # %for.body.lr.ph.i.i.i
                                        #   in Loop: Header=BB7_6 Depth=1
	sub.d	$a3, $s2, $a0
	ori	$a4, $zero, 32
	bltu	$a3, $a4, .LBB7_22
...
# %bb.21:                               # %middle.block
                                        #   in Loop: Header=BB7_6 Depth=1
	beq	$a2, $a1, .LBB7_28
.LBB7_22:                               # %for.body.i.i.i.preheader
                                        #   in Loop: Header=BB7_6 Depth=1
	sub.d	$a1, $a1, $a2
	alsl.d	$a3, $a2, $a0, 2
	alsl.d	$a2, $a2, $s2, 2
...
# %bb.28:                               # %middle.block
                                        #   in Loop: Header=BB8_6 Depth=1
	beq	$a6, $a5, .LBB8_33
.LBB8_29:                               # %for.body.i.i.i.preheader
                                        #   in Loop: Header=BB8_6 Depth=1
	sub.d	$a5, $a5, $a6
	alsl.d	$a7, $a6, $a4, 2
	alsl.d	$a6, $a6, $fp, 2
	.p2align	4, , 16
.LBB8_30:                               # %for.body.i.i.i
                                        #   Parent Loop BB8_6 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$t0, $a7, 0
	st.w	$t0, $a6, 0
