...
# %bb.0:                                # %entry
	...
	addi.d	$a1, $a0, %pc_lo12(_ZTV33btConvexConcaveCollisionAlgorithm+16)
	ld.d	$a0, $s0, 0
	st.d	$a1, $fp, 0
	st.b	$s1, $fp, 16
	addi.d	$s0, $fp, 24
...
# %bb.0:                                # %entry
	...
	addi.d	$a1, $a0, %pc_lo12(_ZTV24btConvexTriangleCallback+16)
	ld.d	$a0, $fp, 88
	st.d	$a1, $fp, 24
	ld.d	$a2, $a0, 0
	ld.d	$a1, $fp, 112
...
.Lfunc_end32:
	...
	.cfi_endproc
                                        # -- End function
	.text
	.p2align	5                               # -- Begin function _ZZN33btConvexConcaveCollisionAlgorithm21calculateTimeOfImpactEP17btCollisionObjectS1_RK16btDispatcherInfoP16btManifoldResultEN31LocalTriangleSphereCastCallbackD0Ev
...
.Lcst_end9:
	.p2align	2, 0x0
                                        # -- End function
	.text
	.p2align	5                               # -- Begin function _ZZN33btConvexConcaveCollisionAlgorithm21calculateTimeOfImpactEP17btCollisionObjectS1_RK16btDispatcherInfoP16btManifoldResultEN31LocalTriangleSphereCastCallback15processTriangleEP9btVector3ii
