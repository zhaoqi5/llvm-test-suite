...
# %bb.0:                                # %entry
	...
	move	$fp, $a0
	ld.d	$a0, $a0, 296
	pcalau12i	$a1, %pc_hi20(_ZTV13btGhostObject+16)
	addi.d	$a1, $a1, %pc_lo12(_ZTV13btGhostObject+16)
	st.d	$a1, $fp, 0
	beqz	$a0, .LBB2_3
# %bb.1:                                # %entry
	ld.b	$a1, $fp, 304
...
# %bb.0:                                # %entry
	...
	move	$fp, $a0
	ld.d	$a0, $a0, 312
	pcalau12i	$a1, %pc_hi20(_ZTV24btPairCachingGhostObject+16)
	addi.d	$a1, $a1, %pc_lo12(_ZTV24btPairCachingGhostObject+16)
	st.d	$a1, $fp, 0
	ld.d	$a1, $a0, 0
	ld.d	$a1, $a1, 0
.Ltmp26:                                # EH_LABEL
