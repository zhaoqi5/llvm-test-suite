...
.Lfunc_end16:
	...
	.cfi_endproc
                                        # -- End function
	.text
	.p2align	2                               # -- Begin function _ZZN22btBvhTriangleMeshShape14performRaycastEP18btTriangleCallbackRK9btVector3S4_EN21MyNodeOverlapCallbackD0Ev
...
.Lfunc_end17:
	...
	.cfi_endproc
                                        # -- End function
	.p2align	2                               # -- Begin function _ZZN22btBvhTriangleMeshShape14performRaycastEP18btTriangleCallbackRK9btVector3S4_EN21MyNodeOverlapCallback11processNodeEii
...
# %bb.9:                                # %cond.true.us.1
	ld.hu	$a4, $a2, 2
	b	.LBB18_11
.LBB18_10:                              # %cond.false.us.1
	ld.w	$a4, $a2, 4
.LBB18_11:                              # %cond.end.us.1
	mul.w	$a4, $a1, $a4
	add.d	$a5, $a0, $a4
	fldx.s	$fa3, $a0, $a4
	fld.s	$fa4, $a5, 4
	...
	st.w	$zero, $sp, 108
	bne	$a3, $a4, .LBB18_13
# %bb.12:                               # %cond.true.us.2
	ld.hu	$a2, $a2, 0
	b	.LBB18_14
.LBB18_13:                              # %cond.false.us.2
	ld.w	$a2, $a2, 0
.LBB18_14:                              # %cond.end.us.2
	mul.w	$a1, $a1, $a2
	add.d	$a2, $a0, $a1
	fldx.s	$fa3, $a0, $a1
	fld.s	$fa4, $a2, 4
...
.Lfunc_end18:
	...
	.cfi_endproc
                                        # -- End function
	.p2align	2                               # -- Begin function _ZZN22btBvhTriangleMeshShape17performConvexcastEP18btTriangleCallbackRK9btVector3S4_S4_S4_EN21MyNodeOverlapCallbackD0Ev
...
.Lfunc_end19:
	...
	.cfi_endproc
                                        # -- End function
	.p2align	2                               # -- Begin function _ZZN22btBvhTriangleMeshShape17performConvexcastEP18btTriangleCallbackRK9btVector3S4_S4_S4_EN21MyNodeOverlapCallback11processNodeEii
...
# %bb.9:                                # %cond.true.us.1
	ld.hu	$a4, $a2, 2
	b	.LBB20_11
.LBB20_10:                              # %cond.false.us.1
	ld.w	$a4, $a2, 4
.LBB20_11:                              # %cond.end.us.1
	mul.w	$a4, $a1, $a4
	add.d	$a5, $a0, $a4
	fldx.s	$fa3, $a0, $a4
	fld.s	$fa4, $a5, 4
...
# %bb.12:                               # %cond.true.us.2
	ld.hu	$a2, $a2, 0
	b	.LBB20_14
.LBB20_13:                              # %cond.false.us.2
	ld.w	$a2, $a2, 0
.LBB20_14:                              # %cond.end.us.2
	mul.w	$a1, $a1, $a2
	add.d	$a2, $a0, $a1
	fldx.s	$fa3, $a0, $a1
	fld.s	$fa4, $a2, 4
...
.Lfunc_end20:
	...
	.cfi_endproc
                                        # -- End function
	.p2align	2                               # -- Begin function _ZZNK22btBvhTriangleMeshShape19processAllTrianglesEP18btTriangleCallbackRK9btVector3S4_EN21MyNodeOverlapCallbackD0Ev
...
.Lfunc_end21:
	...
	.cfi_endproc
                                        # -- End function
	.p2align	2                               # -- Begin function _ZZNK22btBvhTriangleMeshShape19processAllTrianglesEP18btTriangleCallbackRK9btVector3S4_EN21MyNodeOverlapCallback11processNodeEii
...
# %bb.9:                                # %cond.true.us.1
	ld.hu	$a5, $a3, 2
	b	.LBB22_11
.LBB22_10:                              # %cond.false.us.1
	ld.w	$a5, $a3, 4
.LBB22_11:                              # %cond.end.us.1
	mul.w	$a5, $a2, $a5
	add.d	$a6, $a1, $a5
	fldx.s	$fa0, $a1, $a5
	fld.s	$fa1, $a0, 8
...
# %bb.12:                               # %cond.true.us.2
	ld.hu	$a3, $a3, 0
	b	.LBB22_14
.LBB22_13:                              # %cond.false.us.2
	ld.w	$a3, $a3, 0
.LBB22_14:                              # %cond.end.us.2
	mul.w	$a2, $a2, $a3
	add.d	$a3, $a1, $a2
	fldx.s	$fa0, $a1, $a2
	fld.s	$fa1, $a0, 8
