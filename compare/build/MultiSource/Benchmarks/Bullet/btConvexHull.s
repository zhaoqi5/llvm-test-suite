...
# %bb.30:                               # %iter.check786
	...
	ori	$a4, $zero, 64
	bltu	$a3, $a4, .LBB28_42
# %bb.31:                               # %vector.main.loop.iter.check788
                                        #   in Loop: Header=BB28_24 Depth=1
	ori	$a2, $zero, 16
	bgeu	$a1, $a2, .LBB28_35
...
.LBB28_36:                              # %vector.body792
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB28_36
# %bb.37:                               # %middle.block797
                                        #   in Loop: Header=BB28_24 Depth=1
	beq	$a2, $a1, .LBB28_44
# %bb.38:                               # %vec.epilog.iter.check801
                                        #   in Loop: Header=BB28_24 Depth=1
	beqz	$a3, .LBB28_42
.LBB28_39:                              # %vec.epilog.ph803
                                        #   in Loop: Header=BB28_24 Depth=1
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 2
	slli.d	$a2, $a2, 2
	...
	alsl.d	$a5, $a5, $s2, 2
	.p2align	4, , 16
.LBB28_40:                              # %vec.epilog.vector.body806
                                        #   Parent Loop BB28_24 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a4, 0
	vst	$vr0, $a5, 0
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB28_40
# %bb.41:                               # %vec.epilog.middle.block810
                                        #   in Loop: Header=BB28_24 Depth=1
	beq	$a2, $a1, .LBB28_44
...
# %bb.53:                               # %iter.check754
	...
	ori	$a2, $zero, 64
	bltu	$a1, $a2, .LBB28_65
# %bb.54:                               # %vector.main.loop.iter.check756
                                        #   in Loop: Header=BB28_24 Depth=1
	ori	$a0, $zero, 16
	bgeu	$s8, $a0, .LBB28_58
...
.LBB28_59:                              # %vector.body760
	...
	addi.d	$a4, $a4, 64
	bnez	$a2, .LBB28_59
# %bb.60:                               # %middle.block765
                                        #   in Loop: Header=BB28_24 Depth=1
	beq	$s8, $a0, .LBB28_67
# %bb.61:                               # %vec.epilog.iter.check769
                                        #   in Loop: Header=BB28_24 Depth=1
	beqz	$a1, .LBB28_65
.LBB28_62:                              # %vec.epilog.ph771
	...
	slli.d	$a0, $a4, 2
	.p2align	4, , 16
.LBB28_63:                              # %vec.epilog.vector.body774
                                        #   Parent Loop BB28_24 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a2, 0
	vst	$vr0, $a3, 0
	...
	addi.d	$a3, $a3, 16
	bnez	$a1, .LBB28_63
# %bb.64:                               # %vec.epilog.middle.block778
                                        #   in Loop: Header=BB28_24 Depth=1
	beq	$s8, $a0, .LBB28_67
...
# %bb.11:                               # %iter.check230
	...
	ori	$a2, $zero, 64
	bltu	$a1, $a2, .LBB29_24
# %bb.12:                               # %vector.main.loop.iter.check232
                                        #   in Loop: Header=BB29_4 Depth=1
	ori	$a0, $zero, 16
	bgeu	$s5, $a0, .LBB29_17
...
.LBB29_18:                              # %vector.body236
	...
	addi.d	$a2, $a2, 64
	bnez	$a3, .LBB29_18
# %bb.19:                               # %middle.block241
                                        #   in Loop: Header=BB29_4 Depth=1
	beq	$a0, $s5, .LBB29_26
# %bb.20:                               # %vec.epilog.iter.check245
                                        #   in Loop: Header=BB29_4 Depth=1
	andi	$a1, $s5, 12
	beqz	$a1, .LBB29_24
.LBB29_21:                              # %vec.epilog.ph247
                                        #   in Loop: Header=BB29_4 Depth=1
	move	$a3, $a0
	...
	alsl.d	$a3, $a3, $s2, 2
	.p2align	4, , 16
.LBB29_22:                              # %vec.epilog.vector.body250
                                        #   Parent Loop BB29_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a2, 0
	vst	$vr0, $a3, 0
	...
	addi.d	$a3, $a3, 16
	bnez	$a1, .LBB29_22
# %bb.23:                               # %vec.epilog.middle.block254
                                        #   in Loop: Header=BB29_4 Depth=1
	beq	$a0, $s5, .LBB29_26
...
# %bb.40:                               # %middle.block208
                                        #   in Loop: Header=BB29_4 Depth=1
	beq	$fp, $a0, .LBB29_47
# %bb.41:                               # %vec.epilog.iter.check212
                                        #   in Loop: Header=BB29_4 Depth=1
	beqz	$a1, .LBB29_45
.LBB29_42:                              # %vec.epilog.ph214
                                        #   in Loop: Header=BB29_4 Depth=1
	move	$a3, $a0
	...
	alsl.d	$a3, $a3, $s0, 2
	.p2align	4, , 16
.LBB29_43:                              # %vec.epilog.vector.body217
                                        #   Parent Loop BB29_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a2, 0
	vst	$vr0, $a3, 0
	...
	addi.d	$a3, $a3, 16
	bnez	$a1, .LBB29_43
# %bb.44:                               # %vec.epilog.middle.block221
                                        #   in Loop: Header=BB29_4 Depth=1
	beq	$fp, $a0, .LBB29_47
...
# %bb.79:                               # %iter.check262
	...
	ori	$a4, $zero, 64
	bltu	$a3, $a4, .LBB29_93
# %bb.80:                               # %vector.main.loop.iter.check264
	ori	$a2, $zero, 16
	bgeu	$a1, $a2, .LBB29_86
# %bb.81:
	move	$a2, $zero
...
.LBB29_87:                              # %vector.body268
	...
	addi.d	$a5, $a5, 64
	bnez	$a6, .LBB29_87
# %bb.88:                               # %middle.block273
	beq	$a2, $a1, .LBB29_95
# %bb.89:                               # %vec.epilog.iter.check277
	beqz	$a3, .LBB29_93
.LBB29_90:                              # %vec.epilog.ph279
	...
	alsl.d	$a5, $a5, $s1, 2
	.p2align	4, , 16
.LBB29_91:                              # %vec.epilog.vector.body282
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	vst	$vr0, $a5, 0
	addi.d	$a3, $a3, 4
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB29_91
# %bb.92:                               # %vec.epilog.middle.block286
	beq	$a2, $a1, .LBB29_95
...
.LBB29_99:                              # %invoke.cont31
	st.w	$s5, $fp, 4
	blez	$s5, .LBB29_113
# %bb.100:                              # %iter.check294
	ld.d	$a0, $fp, 16
	ori	$a2, $zero, 4
	move	$a1, $zero
	bltu	$s5, $a2, .LBB29_111
# %bb.101:                              # %iter.check294
	sub.d	$a2, $a0, $s2
	ori	$a3, $zero, 64
	bltu	$a2, $a3, .LBB29_111
# %bb.102:                              # %vector.main.loop.iter.check296
	ori	$a1, $zero, 16
	bgeu	$s5, $a1, .LBB29_104
# %bb.103:
	move	$a1, $zero
	b	.LBB29_108
.LBB29_104:                             # %vector.ph297
	andi	$a2, $s5, 12
...
.LBB29_105:                             # %vector.body300
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB29_105
# %bb.106:                              # %middle.block305
	beq	$a1, $s5, .LBB29_113
# %bb.107:                              # %vec.epilog.iter.check309
	beqz	$a2, .LBB29_111
.LBB29_108:                             # %vec.epilog.ph311
	move	$a4, $a1
	...
	alsl.d	$a4, $a4, $s2, 2
	.p2align	4, , 16
.LBB29_109:                             # %vec.epilog.vector.body314
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	vst	$vr0, $a3, 0
	addi.d	$a2, $a2, 4
	...
	addi.d	$a4, $a4, 16
	bnez	$a2, .LBB29_109
# %bb.110:                              # %vec.epilog.middle.block318
	beq	$a1, $s5, .LBB29_113
...
# %bb.71:                               # %middle.block479
	beq	$a2, $a1, .LBB32_78
# %bb.72:                               # %vec.epilog.iter.check483
	beqz	$a3, .LBB32_76
.LBB32_73:                              # %vec.epilog.ph485
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 2
	slli.d	$a2, $a2, 2
	sub.d	$a3, $a5, $a2
	...
	alsl.d	$a5, $a5, $s4, 2
	.p2align	4, , 16
.LBB32_74:                              # %vec.epilog.vector.body488
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	vst	$vr0, $a5, 0
	addi.d	$a3, $a3, 4
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB32_74
# %bb.75:                               # %vec.epilog.middle.block492
	beq	$a2, $a1, .LBB32_78
