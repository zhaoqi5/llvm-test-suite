...
# %bb.3:                                # %_ZN20btAlignedObjectArrayIiE8allocateEi.exit.i122
	...
	ld.d	$a0, $sp, 120
	blez	$a1, .LBB28_12
# %bb.4:                                # %for.body.lr.ph.i.i139
	ori	$a3, $zero, 8
	move	$a2, $zero
	bltu	$a1, $a3, .LBB28_9
# %bb.5:                                # %for.body.lr.ph.i.i139
	sub.d	$a3, $s4, $a0
	ori	$a4, $zero, 32
	bltu	$a3, $a4, .LBB28_9
# %bb.6:                                # %vector.ph
...
# %bb.8:                                # %middle.block
	beq	$a2, $a1, .LBB28_11
.LBB28_9:                               # %for.body.i.i141.preheader
	sub.d	$a1, $a1, $a2
	alsl.d	$a3, $a2, $a0, 2
	alsl.d	$a2, $a2, $s4, 2
	.p2align	4, , 16
.LBB28_10:                              # %for.body.i.i141
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a4, $a3, 0
	st.w	$a4, $a2, 0
	addi.d	$a1, $a1, -1
	...
	addi.d	$a2, $a2, 4
	bnez	$a1, .LBB28_10
.LBB28_11:                              # %if.then.i7.i130
	ld.bu	$a1, $sp, 128
	bnez	$a1, .LBB28_14
	b	.LBB28_15
.LBB28_12:                              # %_ZNK20btAlignedObjectArrayIiE4copyEiiPi.exit.i127
	beqz	$a0, .LBB28_15
# %bb.13:                               # %_ZNK20btAlignedObjectArrayIiE4copyEiiPi.exit.i127
	ld.b	$a1, $sp, 128
	andi	$a1, $a1, 1
	beqz	$a1, .LBB28_15
.LBB28_14:                              # %if.then2.i.i138
.Ltmp24:                                # EH_LABEL
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.Ltmp25:                                # EH_LABEL
.LBB28_15:                              # %for.body.preheader
...
# %bb.22:                               # %call.i.i.i.i.noexc
	...
	ld.d	$a0, $sp, 120
	blez	$a1, .LBB28_31
.LBB28_23:                              # %for.body.lr.ph.i.i.i
                                        #   in Loop: Header=BB28_18 Depth=1
	move	$a2, $zero
	bltu	$a1, $s5, .LBB28_28
# %bb.24:                               # %for.body.lr.ph.i.i.i
                                        #   in Loop: Header=BB28_18 Depth=1
	sub.d	$a3, $s2, $a0
	ori	$a4, $zero, 32
	bltu	$a3, $a4, .LBB28_28
...
.LBB28_26:                              # %vector.body766
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB28_26
# %bb.27:                               # %middle.block771
                                        #   in Loop: Header=BB28_18 Depth=1
	beq	$a2, $a1, .LBB28_32
.LBB28_28:                              # %for.body.i.i.i.preheader
                                        #   in Loop: Header=BB28_18 Depth=1
	sub.d	$a1, $a1, $a2
	alsl.d	$a3, $a2, $a0, 2
	alsl.d	$a2, $a2, $s2, 2
	.p2align	4, , 16
.LBB28_29:                              # %for.body.i.i.i
                                        #   Parent Loop BB28_18 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$a4, $a3, 0
	st.w	$a4, $a2, 0
...
.LBB28_31:                              # %_ZNK20btAlignedObjectArrayIiE4copyEiiPi.exit.i.i
                                        #   in Loop: Header=BB28_18 Depth=1
	beqz	$a0, .LBB28_35
.LBB28_32:                              # %if.then.i7.i.i
                                        #   in Loop: Header=BB28_18 Depth=1
	ld.bu	$a1, $sp, 128
	beqz	$a1, .LBB28_34
# %bb.33:                               # %if.then2.i.i.i
                                        #   in Loop: Header=BB28_18 Depth=1
.Ltmp29:                                # EH_LABEL
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.Ltmp30:                                # EH_LABEL
.LBB28_34:                              # %if.end.i.i.i
                                        #   in Loop: Header=BB28_18 Depth=1
	ld.w	$a1, $sp, 108
...
.Ltmp32:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp33:                                # EH_LABEL
# %bb.39:                               # %_ZN20btAlignedObjectArrayIiE8allocateEi.exit.i.i180
                                        #   in Loop: Header=BB28_18 Depth=1
	move	$s2, $a0
	beqz	$s7, .LBB28_47
# %bb.40:                               # %for.body.i.i.i197.preheader
                                        #   in Loop: Header=BB28_18 Depth=1
	move	$a0, $zero
	bltu	$s7, $s5, .LBB28_45
# %bb.41:                               # %for.body.i.i.i197.preheader
                                        #   in Loop: Header=BB28_18 Depth=1
	sub.d	$a1, $s2, $s4
	ori	$a2, $zero, 32
	bltu	$a1, $a2, .LBB28_45
...
.LBB28_43:                              # %vector.body750
	...
	addi.d	$a3, $a3, 32
	bnez	$a1, .LBB28_43
# %bb.44:                               # %middle.block755
                                        #   in Loop: Header=BB28_18 Depth=1
	beq	$s7, $a0, .LBB28_48
.LBB28_45:                              # %for.body.i.i.i197.preheader780
                                        #   in Loop: Header=BB28_18 Depth=1
	alsl.d	$a1, $a0, $s4, 2
	alsl.d	$a2, $a0, $s2, 2
	.p2align	4, , 16
.LBB28_46:                              # %for.body.i.i.i197
                                        #   Parent Loop BB28_18 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$a3, $a1, 0
	st.w	$a3, $a2, 0
	...
	bne	$s7, $a0, .LBB28_46
	b	.LBB28_48
.LBB28_47:                              # %_ZNK20btAlignedObjectArrayIiE4copyEiiPi.exit.i.i184
                                        #   in Loop: Header=BB28_18 Depth=1
	beqz	$s4, .LBB28_49
.LBB28_48:                              # %if.then2.i.i.i194
                                        #   in Loop: Header=BB28_18 Depth=1
.Ltmp34:                                # EH_LABEL
	move	$a0, $s4
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
...
# %bb.56:                               # %invoke.cont139
	...
	ld.w	$a0, $s1, 4
	blez	$a0, .LBB28_63
# %bb.57:                               # %for.body145.lr.ph
	move	$s3, $zero
	move	$s5, $zero
	lu12i.w	$s6, 260096
	movgr2fr.w	$fs6, $zero
	.p2align	4, , 16
.LBB28_58:                              # %for.body145
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a0, $s1, 16
	ldx.d	$s7, $a0, $s3
	ld.w	$a0, $s7, 0
...
# %bb.75:                               # %while.body202.lr.ph
	...
	b	.LBB28_77
	.p2align	4, , 16
.LBB28_76:                              # %while.cond201.backedge
                                        #   in Loop: Header=BB28_77 Depth=2
	addi.d	$s4, $s4, -1
	addi.d	$s6, $s6, -8
	beqz	$s4, .LBB28_82
.LBB28_77:                              # %while.body202
                                        #   Parent Loop BB28_66 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a0, $s1, 16
	ldx.d	$a1, $a0, $s6
...
.Ltmp58:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp59:                                # EH_LABEL
# %bb.85:                               # %invoke.cont305
                                        #   in Loop: Header=BB28_87 Depth=2
	ld.w	$s4, $s1, 4
	move	$a0, $s4
.LBB28_86:                              # %while.cond230.backedge
                                        #   in Loop: Header=BB28_87 Depth=2
	beqz	$a0, .LBB28_95
.LBB28_87:                              # %while.body233
                                        #   Parent Loop BB28_66 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.d	$a1, $s1, 16
	addi.w	$a0, $a0, -1
	...
	ldx.d	$a2, $a1, $a2
	beqz	$a2, .LBB28_86
# %bb.88:                               # %invoke.cont243
                                        #   in Loop: Header=BB28_87 Depth=2
	ld.w	$a5, $a2, 0
	ld.w	$a4, $a2, 4
	ld.w	$a3, $a2, 8
	beq	$a5, $s3, .LBB28_91
# %bb.89:                               # %invoke.cont243
                                        #   in Loop: Header=BB28_87 Depth=2
	beq	$a4, $s3, .LBB28_91
# %bb.90:                               # %invoke.cont243
                                        #   in Loop: Header=BB28_87 Depth=2
	bne	$a3, $s3, .LBB28_95
.LBB28_91:                              # %if.end247
                                        #   in Loop: Header=BB28_87 Depth=2
...
# %bb.94:                               # %invoke.cont253
	...
	b	.LBB28_84
	.p2align	4, , 16
.LBB28_95:                              # %while.end312
                                        #   in Loop: Header=BB28_66 Depth=1
	beqz	$s4, .LBB28_65
# %bb.96:                               # %while.body319.preheader
                                        #   in Loop: Header=BB28_66 Depth=1
	slli.d	$a0, $s4, 3
	addi.d	$s3, $a0, -8
	b	.LBB28_99
	.p2align	4, , 16
.LBB28_97:                              # %invoke.cont367
...
# %bb.109:                              # %cleanup394
	...
	andi	$a1, $a1, 1
	beqz	$a1, .LBB28_111
# %bb.110:                              # %if.then2.i.i.i546
.Ltmp66:                                # EH_LABEL
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.Ltmp67:                                # EH_LABEL
.LBB28_111:                             # %invoke.cont399
	beqz	$s2, .LBB28_113
# %bb.112:                              # %if.then2.i.i.i555
	move	$a0, $s2
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.LBB28_113:                             # %return
...
.LBB28_127:                             # %lpad211
.Ltmp57:                                # EH_LABEL
.LBB28_128:                             # %ehcleanup400
	move	$fp, $a0
.LBB28_129:                             # %ehcleanup400
	ld.d	$a0, $sp, 120
	beqz	$a0, .LBB28_132
# %bb.130:                              # %ehcleanup400
	ld.b	$a1, $sp, 128
	andi	$a1, $a1, 1
	beqz	$a1, .LBB28_132
# %bb.131:                              # %if.then2.i.i.i564
.Ltmp64:                                # EH_LABEL
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.Ltmp65:                                # EH_LABEL
.LBB28_132:                             # %ehcleanup405
	beqz	$s2, .LBB28_134
# %bb.133:                              # %if.then2.i.i.i574
.Ltmp69:                                # EH_LABEL
	move	$a0, $s2
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.Ltmp70:                                # EH_LABEL
.LBB28_134:                             # %invoke.cont406
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB28_135:                             # %terminate.lpad
.Ltmp71:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.Lfunc_end28:
...
# %bb.9:                                #   in Loop: Header=BB29_4 Depth=1
	move	$s2, $a0
	blez	$s5, .LBB29_19
.LBB29_10:                              # %for.body.i.i.i.preheader
                                        #   in Loop: Header=BB29_4 Depth=1
	move	$a0, $zero
	ori	$a1, $zero, 8
	bltu	$s5, $a1, .LBB29_15
...
.LBB29_13:                              # %vector.body210
	...
	addi.d	$a2, $a2, 32
	bnez	$a3, .LBB29_13
# %bb.14:                               # %middle.block215
                                        #   in Loop: Header=BB29_4 Depth=1
	beq	$a0, $s5, .LBB29_20
.LBB29_15:                              # %for.body.i.i.i.preheader257
                                        #   in Loop: Header=BB29_4 Depth=1
	sub.d	$a1, $s5, $a0
	alsl.d	$a2, $a0, $s4, 2
	alsl.d	$a0, $a0, $s2, 2
	.p2align	4, , 16
.LBB29_16:                              # %for.body.i.i.i
                                        #   Parent Loop BB29_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$a3, $a2, 0
	st.w	$a3, $a0, 0
...
.LBB29_27:                              #   in Loop: Header=BB29_4 Depth=1
	move	$s3, $zero
	bltz	$s5, .LBB29_35
.LBB29_28:                              # %for.body.i.i.i.1.preheader
                                        #   in Loop: Header=BB29_4 Depth=1
	move	$a0, $zero
	ori	$a1, $zero, 7
	bltu	$s5, $a1, .LBB29_33
# %bb.29:                               # %for.body.i.i.i.1.preheader
                                        #   in Loop: Header=BB29_4 Depth=1
	sub.d	$a1, $s3, $s2
	ori	$a2, $zero, 32
	bltu	$a1, $a2, .LBB29_33
...
# %bb.32:                               # %middle.block198
                                        #   in Loop: Header=BB29_4 Depth=1
	beq	$fp, $a0, .LBB29_35
.LBB29_33:                              # %for.body.i.i.i.1.preheader256
                                        #   in Loop: Header=BB29_4 Depth=1
	sub.d	$a1, $s5, $a0
	addi.d	$a1, $a1, 1
	alsl.d	$a2, $a0, $s2, 2
...
.LBB29_42:                              #   in Loop: Header=BB29_4 Depth=1
	...
	addi.w	$a0, $zero, -1
	blt	$s5, $a0, .LBB29_50
.LBB29_43:                              # %for.body.i.i.i.2.preheader
                                        #   in Loop: Header=BB29_4 Depth=1
	move	$a0, $zero
	ori	$a1, $zero, 8
	bltu	$s7, $a1, .LBB29_48
# %bb.44:                               # %for.body.i.i.i.2.preheader
                                        #   in Loop: Header=BB29_4 Depth=1
	sub.d	$a1, $s2, $s3
	ori	$a2, $zero, 32
	bltu	$a1, $a2, .LBB29_48
...
# %bb.47:                               # %middle.block
                                        #   in Loop: Header=BB29_4 Depth=1
	beq	$s7, $a0, .LBB29_50
.LBB29_48:                              # %for.body.i.i.i.2.preheader255
                                        #   in Loop: Header=BB29_4 Depth=1
	sub.d	$a1, $s5, $a0
	addi.d	$a1, $a1, 2
	alsl.d	$a2, $a0, $s3, 2
...
.Ltmp85:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp86:                                # EH_LABEL
# %bb.52:                               # %for.inc.2.for.inc23_crit_edge
                                        #   in Loop: Header=BB29_4 Depth=1
	ld.w	$a0, $s3, 4
	addi.w	$s5, $s5, 3
	move	$s4, $s2
...
.Ltmp88:                                # EH_LABEL
	...
	jirl	$ra, $ra, 0
.Ltmp89:                                # EH_LABEL
# %bb.59:                               # %call.i.i.i.i.noexc56
	move	$s1, $a0
	ld.w	$a1, $fp, 4
	ld.d	$a0, $fp, 16
	blez	$a1, .LBB29_70
.LBB29_60:                              # %for.body.lr.ph.i.i.i47
	ori	$a3, $zero, 8
	move	$a2, $zero
	bltu	$a1, $a3, .LBB29_65
# %bb.61:                               # %for.body.lr.ph.i.i.i47
	sub.d	$a3, $s1, $a0
	ori	$a4, $zero, 32
	bltu	$a3, $a4, .LBB29_65
# %bb.62:                               # %vector.ph223
...
.LBB29_63:                              # %vector.body226
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB29_63
# %bb.64:                               # %middle.block231
	beq	$a2, $a1, .LBB29_67
.LBB29_65:                              # %for.body.i.i.i49.preheader
	sub.d	$a1, $a1, $a2
	alsl.d	$a3, $a2, $a0, 2
	alsl.d	$a2, $a2, $s1, 2
	.p2align	4, , 16
.LBB29_66:                              # %for.body.i.i.i49
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a4, $a3, 0
	st.w	$a4, $a2, 0
	addi.d	$a1, $a1, -1
	...
	addi.d	$a2, $a2, 4
	bnez	$a1, .LBB29_66
.LBB29_67:                              # %if.then.i7.i.i55
	ld.bu	$a1, $fp, 24
	bnez	$a1, .LBB29_72
	b	.LBB29_73
.LBB29_68:                              # %if.then5.i.for.body10.lr.ph.i_crit_edge
	ld.d	$s1, $fp, 16
	b	.LBB29_74
.LBB29_69:
	move	$s1, $zero
...
.LBB29_74:                              # %for.body10.lr.ph.i
	...
	jirl	$ra, $ra, 0
.LBB29_75:                              # %invoke.cont31
	st.w	$s5, $fp, 4
	ld.d	$s0, $sp, 32                    # 8-byte Folded Reload
	blez	$s5, .LBB29_83
# %bb.76:                               # %for.body36.lr.ph
	ld.d	$a0, $fp, 16
	ori	$a2, $zero, 8
	move	$a1, $zero
	bltu	$s5, $a2, .LBB29_81
# %bb.77:                               # %for.body36.lr.ph
	sub.d	$a2, $a0, $s2
	ori	$a3, $zero, 32
	bltu	$a2, $a3, .LBB29_81
# %bb.78:                               # %vector.ph239
...
.LBB29_79:                              # %vector.body242
	...
	addi.d	$a3, $a3, 32
	bnez	$a4, .LBB29_79
# %bb.80:                               # %middle.block247
	beq	$a1, $s5, .LBB29_83
.LBB29_81:                              # %for.body36.preheader
	alsl.d	$a0, $a1, $a0, 2
	alsl.d	$a2, $a1, $s2, 2
	sub.d	$a1, $s5, $a1
	.p2align	4, , 16
...
.LBB29_89:                              # %for.body10.lr.ph.i71
	...
	pcaddu18i	$ra, %call36(memset)
	jirl	$ra, $ra, 0
.LBB29_90:                              # %invoke.cont47
	st.w	$zero, $s0, 4
	ori	$fp, $zero, 1
	beqz	$s2, .LBB29_92
# %bb.91:                               # %if.then2.i.i.i107
	move	$a0, $s2
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.LBB29_92:                              # %cleanup
...
.LBB29_98:                              # %ehcleanup
	beqz	$s2, .LBB29_100
.LBB29_99:                              # %if.then2.i.i.i115
.Ltmp96:                                # EH_LABEL
	move	$a0, $s2
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.Ltmp97:                                # EH_LABEL
.LBB29_100:                             # %invoke.cont49
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB29_101:                             # %terminate.lpad
.Ltmp98:                                # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.Lfunc_end29:
...
# %bb.39:                               # %call.i.i.i.i.noexc301
	...
	ld.d	$a0, $s1, 64
	blez	$a1, .LBB32_72
.LBB32_40:                              # %for.body.lr.ph.i.i.i289
	ori	$a3, $zero, 8
	move	$a2, $zero
	bltu	$a1, $a3, .LBB32_45
# %bb.41:                               # %for.body.lr.ph.i.i.i289
	sub.d	$a3, $s4, $a0
	ori	$a4, $zero, 32
	bltu	$a3, $a4, .LBB32_45
# %bb.42:                               # %vector.ph461
...
.LBB32_43:                              # %vector.body464
	...
	addi.d	$a4, $a4, 32
	bnez	$a5, .LBB32_43
# %bb.44:                               # %middle.block469
	beq	$a2, $a1, .LBB32_47
.LBB32_45:                              # %for.body.i.i.i291.preheader
	sub.d	$a1, $a1, $a2
	alsl.d	$a3, $a2, $a0, 2
	alsl.d	$a2, $a2, $s4, 2
	.p2align	4, , 16
.LBB32_46:                              # %for.body.i.i.i291
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a4, $a3, 0
	st.w	$a4, $a2, 0
	addi.d	$a1, $a1, -1
	...
	addi.d	$a2, $a2, 4
	bnez	$a1, .LBB32_46
.LBB32_47:                              # %if.then.i7.i.i297
	ld.bu	$a1, $s1, 72
	bnez	$a1, .LBB32_74
	b	.LBB32_75
.LBB32_48:                              # %if.then5.i259.for.body10.lr.ph.i262_crit_edge
	ld.d	$s4, $s1, 64
	b	.LBB32_76
.LBB32_49:
	move	$s5, $zero
.LBB32_50:                              # %_ZN20btAlignedObjectArrayI9btVector3E8allocateEi.exit.i.i138
	blez	$a0, .LBB32_53
# %bb.51:                               # %for.body.lr.ph.i.i.i149
	move	$a1, $zero
	slli.d	$a0, $a0, 4
	.p2align	4, , 16
.LBB32_52:                              # %for.body.i.i.i152
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a2, $s1, 24
	vldx	$vr0, $a2, $a1
	vstx	$vr0, $s5, $a1
	addi.d	$a1, $a1, 16
	bne	$a0, $a1, .LBB32_52
.LBB32_53:                              # %_ZNK20btAlignedObjectArrayI9btVector3E4copyEiiPS0_.exit.i.i141
	ld.d	$a0, $s1, 24
	beqz	$a0, .LBB32_56
# %bb.54:                               # %_ZNK20btAlignedObjectArrayI9btVector3E4copyEiiPS0_.exit.i.i141
	ld.b	$a1, $s1, 32
	andi	$a1, $a1, 1
	beqz	$a1, .LBB32_56
# %bb.55:                               # %if.then2.i.i.i148
.Ltmp115:                               # EH_LABEL
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.Ltmp116:                               # EH_LABEL
.LBB32_56:                              # %_ZN20btAlignedObjectArrayI9btVector3E10deallocateEv.exit.i.i147
	ori	$a0, $zero, 1
	st.b	$a0, $s1, 32
	st.d	$s5, $s1, 24
	st.w	$s3, $s1, 16
.LBB32_57:                              # %invoke.cont64
	ld.w	$s8, $s1, 52
	st.w	$s3, $s1, 12
	st.w	$s7, $s1, 40
	st.w	$s4, $s1, 44
...
# %bb.58:                               # %if.then5.i164
	ld.w	$a0, $s1, 56
	bge	$a0, $s4, .LBB32_70
# %bb.59:                               # %if.then.i.i175
	beqz	$s7, .LBB32_83
# %bb.60:                               # %if.then.i.i.i177
	slli.d	$a0, $s4, 2
.Ltmp118:                               # EH_LABEL
	ori	$a1, $zero, 16
	pcaddu18i	$ra, %call36(_Z22btAlignedAllocInternalmi)
	jirl	$ra, $ra, 0
.Ltmp119:                               # EH_LABEL
# %bb.61:                               # %call.i.i.i.i.noexc197
	move	$s5, $a0
	ld.w	$a1, $s1, 52
	ld.d	$a0, $s1, 64
	blez	$a1, .LBB32_84
.LBB32_62:                              # %for.body.lr.ph.i.i.i189
	ori	$a3, $zero, 8
	move	$a2, $zero
	bltu	$a1, $a3, .LBB32_67
# %bb.63:                               # %for.body.lr.ph.i.i.i189
	sub.d	$a3, $s5, $a0
	ori	$a4, $zero, 32
	bltu	$a3, $a4, .LBB32_67
# %bb.64:                               # %vector.ph
...
# %bb.66:                               # %middle.block
	beq	$a2, $a1, .LBB32_69
.LBB32_67:                              # %for.body.i.i.i191.preheader
	sub.d	$a1, $a1, $a2
	alsl.d	$a3, $a2, $a0, 2
	alsl.d	$a2, $a2, $s5, 2
	.p2align	4, , 16
.LBB32_68:                              # %for.body.i.i.i191
                                        # =>This Inner Loop Header: Depth=1
	ld.w	$a4, $a3, 0
	st.w	$a4, $a2, 0
	addi.d	$a1, $a1, -1
	...
	addi.d	$a2, $a2, 4
	bnez	$a1, .LBB32_68
.LBB32_69:                              # %if.then.i7.i.i
	ld.bu	$a1, $s1, 72
	bnez	$a1, .LBB32_86
	b	.LBB32_87
.LBB32_70:                              # %if.then5.i164.for.body10.lr.ph.i167_crit_edge
	ld.d	$s5, $s1, 64
	b	.LBB32_88
.LBB32_71:
	move	$s4, $zero
	...
	ld.d	$a0, $s1, 64
	bgtz	$a1, .LBB32_40
.LBB32_72:                              # %_ZNK20btAlignedObjectArrayIjE4copyEiiPj.exit.i.i281
	beqz	$a0, .LBB32_75
# %bb.73:                               # %_ZNK20btAlignedObjectArrayIjE4copyEiiPj.exit.i.i281
	ld.b	$a1, $s1, 72
	andi	$a1, $a1, 1
	beqz	$a1, .LBB32_75
.LBB32_74:                              # %if.then2.i.i.i288
.Ltmp130:                               # EH_LABEL
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.Ltmp131:                               # EH_LABEL
.LBB32_75:                              # %_ZN20btAlignedObjectArrayIjE10deallocateEv.exit.i.i286
	ori	$a0, $zero, 1
	st.b	$a0, $s1, 72
	st.d	$s4, $s1, 64
	st.w	$s6, $s1, 56
.LBB32_76:                              # %for.body10.lr.ph.i262
	alsl.d	$a0, $s8, $s4, 2
	sub.d	$a1, $s6, $s8
	slli.d	$a2, $a1, 2
	move	$a1, $zero
...
.LBB32_87:                              # %_ZN20btAlignedObjectArrayIjE10deallocateEv.exit.i.i
	...
	st.d	$s5, $s1, 64
	st.w	$s4, $s1, 56
.LBB32_88:                              # %for.body10.lr.ph.i167
	alsl.d	$a0, $s8, $s5, 2
	sub.d	$a1, $s4, $s8
	slli.d	$a2, $a1, 2
	move	$a1, $zero
...
# %bb.101:                              # %invoke.cont195
	ld.d	$a0, $sp, 80
	beqz	$a0, .LBB32_104
# %bb.102:                              # %invoke.cont195
	ld.b	$a1, $sp, 88
	andi	$a1, $a1, 1
	beqz	$a1, .LBB32_104
# %bb.103:                              # %if.then2.i.i.i.i
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
...
.Ltmp127:                               # EH_LABEL
	b	.LBB32_113
.LBB32_109:                             # %ehcleanup187
.Ltmp135:                               # EH_LABEL
	b	.LBB32_113
.LBB32_110:                             # %ehcleanup187.thread405
.Ltmp109:                               # EH_LABEL
	b	.LBB32_118
.LBB32_111:                             # %lpad43
.Ltmp140:                               # EH_LABEL
	b	.LBB32_118
.LBB32_112:                             # %ehcleanup187.thread409
.Ltmp112:                               # EH_LABEL
.LBB32_113:                             # %if.then2.i.i.i344
	st.d	$s2, $sp, 8                     # 8-byte Folded Spill
.LBB32_114:                             # %if.then2.i.i.i344
	move	$s0, $a0
.Ltmp136:                               # EH_LABEL
...
.LBB32_117:                             # %lpad8
.Ltmp106:                               # EH_LABEL
.LBB32_118:                             # %if.then2.i.i.i364
	move	$s0, $a0
.LBB32_119:                             # %if.then2.i.i.i364
.Ltmp141:                               # EH_LABEL
	move	$a0, $fp
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.Ltmp142:                               # EH_LABEL
.LBB32_120:                             # %ehcleanup198
	ld.d	$a0, $sp, 80
	beqz	$a0, .LBB32_123
# %bb.121:                              # %ehcleanup198
	ld.b	$a1, $sp, 88
	andi	$a1, $a1, 1
	beqz	$a1, .LBB32_123
# %bb.122:                              # %if.then2.i.i.i.i374
.Ltmp146:                               # EH_LABEL
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
.Ltmp147:                               # EH_LABEL
.LBB32_123:                             # %invoke.cont201
	move	$a0, $s0
	pcaddu18i	$ra, %call36(_Unwind_Resume)
	jirl	$ra, $ra, 0
.LBB32_124:                             # %terminate.lpad
.Ltmp148:                               # EH_LABEL
	pcaddu18i	$ra, %call36(__clang_call_terminate)
	jirl	$ra, $ra, 0
.Lfunc_end32:
...
# %bb.32:                               # %if.then.i.i.i
	...
	ld.d	$a0, $s3, 48
	blez	$a1, .LBB33_41
.LBB33_33:                              # %for.body.lr.ph.i.i.i294
                                        #   in Loop: Header=BB33_18 Depth=1
	move	$a2, $zero
	ori	$a3, $zero, 8
	bltu	$a1, $a3, .LBB33_38
# %bb.34:                               # %for.body.lr.ph.i.i.i294
                                        #   in Loop: Header=BB33_18 Depth=1
	sub.d	$a3, $s4, $a0
	ori	$a4, $zero, 32
	bltu	$a3, $a4, .LBB33_38
...
# %bb.37:                               # %middle.block
                                        #   in Loop: Header=BB33_18 Depth=1
	beq	$a2, $a1, .LBB33_42
.LBB33_38:                              # %for.body.i.i.i296.preheader
                                        #   in Loop: Header=BB33_18 Depth=1
	sub.d	$a1, $a1, $a2
	alsl.d	$a3, $a2, $a0, 2
	alsl.d	$a2, $a2, $s4, 2
	.p2align	4, , 16
.LBB33_39:                              # %for.body.i.i.i296
                                        #   Parent Loop BB33_18 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	ld.w	$a4, $a3, 0
	st.w	$a4, $a2, 0
...
.LBB33_40:                              #   in Loop: Header=BB33_18 Depth=1
	...
	ld.d	$a0, $s3, 48
	bgtz	$a1, .LBB33_33
.LBB33_41:                              # %_ZNK20btAlignedObjectArrayIiE4copyEiiPi.exit.i.i286
                                        #   in Loop: Header=BB33_18 Depth=1
	beqz	$a0, .LBB33_16
.LBB33_42:                              # %if.then.i7.i.i288
                                        #   in Loop: Header=BB33_18 Depth=1
	ld.bu	$a1, $s3, 56
	beqz	$a1, .LBB33_15
# %bb.43:                               # %if.then2.i.i.i293
                                        #   in Loop: Header=BB33_18 Depth=1
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
	ori	$a6, $zero, 1
	b	.LBB33_15
.LBB33_44:                              # %for.cond.cleanup139
	ld.w	$a0, $fp, 0
	beqz	$a0, .LBB33_49
# %bb.45:                               # %for.body234.preheader
	bstrpick.d	$a1, $a0, 31, 0
	ld.d	$a2, $sp, 16                    # 8-byte Folded Reload
	movgr2fr.w	$fa3, $a2
...
.LBB33_49:
	...
	fmov.s	$fa4, $fa3
	fmov.s	$fa5, $fa3
.LBB33_50:                              # %for.cond.cleanup233
	fsub.s	$fa5, $fa5, $fa2
	fsub.s	$fa4, $fa4, $fa1
	ori	$a1, $zero, 3
	fsub.s	$fa3, $fa3, $fa0
	bltu	$a0, $a1, .LBB33_54
# %bb.51:                               # %for.cond.cleanup233
	fcmp.clt.s	$fcc0, $fa5, $fs1
	bcnez	$fcc0, .LBB33_54
# %bb.52:                               # %for.cond.cleanup233
	fcmp.clt.s	$fcc0, $fa4, $fs1
	bcnez	$fcc0, .LBB33_54
# %bb.53:                               # %for.cond.cleanup233
	fcmp.clt.s	$fcc0, $fa3, $fs1
	bceqz	$fcc0, .LBB33_59
.LBB33_54:                              # %if.then296
	movgr2fr.w	$fa7, $a3
