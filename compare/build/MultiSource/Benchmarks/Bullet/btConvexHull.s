...
# %bb.30:                               # %iter.check773
	...
	ori	$a4, $zero, 64
	bltu	$a3, $a4, .LBB28_42
# %bb.31:                               # %vector.main.loop.iter.check775
                                        #   in Loop: Header=BB28_24 Depth=1
	ori	$a2, $zero, 16
	bgeu	$a1, $a2, .LBB28_35
...
.LBB28_36:                              # %vector.body779
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB28_36
# %bb.37:                               # %middle.block784
                                        #   in Loop: Header=BB28_24 Depth=1
	beq	$a2, $a1, .LBB28_44
# %bb.38:                               # %vec.epilog.iter.check789
                                        #   in Loop: Header=BB28_24 Depth=1
	andi	$a3, $a1, 12
	beqz	$a3, .LBB28_42
.LBB28_39:                              # %vec.epilog.ph788
                                        #   in Loop: Header=BB28_24 Depth=1
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 2
	slli.d	$a2, $a2, 2
	...
	alsl.d	$a5, $a5, $s2, 2
	.p2align	4, , 16
.LBB28_40:                              # %vec.epilog.vector.body794
                                        #   Parent Loop BB28_24 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a4, 0
	vst	$vr0, $a5, 0
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB28_40
# %bb.41:                               # %vec.epilog.middle.block798
                                        #   in Loop: Header=BB28_24 Depth=1
	beq	$a2, $a1, .LBB28_44
...
# %bb.53:                               # %iter.check740
	...
	ori	$a2, $zero, 64
	bltu	$a1, $a2, .LBB28_65
# %bb.54:                               # %vector.main.loop.iter.check742
                                        #   in Loop: Header=BB28_24 Depth=1
	ori	$a0, $zero, 16
	bgeu	$s8, $a0, .LBB28_58
...
.LBB28_59:                              # %vector.body746
	...
	addi.d	$a3, $a3, 64
	bnez	$a1, .LBB28_59
# %bb.60:                               # %middle.block751
                                        #   in Loop: Header=BB28_24 Depth=1
	beq	$s8, $a0, .LBB28_67
# %bb.61:                               # %vec.epilog.iter.check756
                                        #   in Loop: Header=BB28_24 Depth=1
	andi	$a1, $s8, 12
	beqz	$a1, .LBB28_65
.LBB28_62:                              # %vec.epilog.ph755
                                        #   in Loop: Header=BB28_24 Depth=1
	move	$a1, $s8
	...
	slli.d	$a0, $a4, 2
	.p2align	4, , 16
.LBB28_63:                              # %vec.epilog.vector.body761
                                        #   Parent Loop BB28_24 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a2, 0
	vst	$vr0, $a3, 0
	...
	addi.d	$a3, $a3, 16
	bnez	$a1, .LBB28_63
# %bb.64:                               # %vec.epilog.middle.block765
                                        #   in Loop: Header=BB28_24 Depth=1
	beq	$s8, $a0, .LBB28_67
...
# %bb.11:                               # %iter.check221
	...
	ori	$a2, $zero, 64
	bltu	$a1, $a2, .LBB29_24
# %bb.12:                               # %vector.main.loop.iter.check223
                                        #   in Loop: Header=BB29_4 Depth=1
	ori	$a0, $zero, 16
	bgeu	$s5, $a0, .LBB29_17
...
.LBB29_18:                              # %vector.body227
	...
	addi.d	$a2, $a2, 64
	bnez	$a3, .LBB29_18
# %bb.19:                               # %middle.block232
                                        #   in Loop: Header=BB29_4 Depth=1
	beq	$a0, $s5, .LBB29_26
# %bb.20:                               # %vec.epilog.iter.check237
                                        #   in Loop: Header=BB29_4 Depth=1
	andi	$a1, $s5, 12
	beqz	$a1, .LBB29_24
.LBB29_21:                              # %vec.epilog.ph236
                                        #   in Loop: Header=BB29_4 Depth=1
	move	$a3, $a0
	...
	alsl.d	$a3, $a3, $s2, 2
	.p2align	4, , 16
.LBB29_22:                              # %vec.epilog.vector.body242
                                        #   Parent Loop BB29_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a2, 0
	vst	$vr0, $a3, 0
	...
	addi.d	$a3, $a3, 16
	bnez	$a1, .LBB29_22
# %bb.23:                               # %vec.epilog.middle.block246
                                        #   in Loop: Header=BB29_4 Depth=1
	beq	$a0, $s5, .LBB29_26
...
# %bb.35:                               # %iter.check187
	...
	ori	$a2, $zero, 64
	bltu	$a1, $a2, .LBB29_45
# %bb.36:                               # %vector.main.loop.iter.check189
                                        #   in Loop: Header=BB29_4 Depth=1
	ori	$a0, $zero, 15
	bgeu	$s5, $a0, .LBB29_38
...
.LBB29_39:                              # %vector.body193
	...
	addi.d	$a2, $a2, 64
	bnez	$a3, .LBB29_39
# %bb.40:                               # %middle.block198
                                        #   in Loop: Header=BB29_4 Depth=1
	beq	$fp, $a0, .LBB29_47
# %bb.41:                               # %vec.epilog.iter.check203
                                        #   in Loop: Header=BB29_4 Depth=1
	andi	$a1, $fp, 12
	beqz	$a1, .LBB29_45
.LBB29_42:                              # %vec.epilog.ph202
                                        #   in Loop: Header=BB29_4 Depth=1
	move	$a3, $a0
	...
	alsl.d	$a3, $a3, $s0, 2
	.p2align	4, , 16
.LBB29_43:                              # %vec.epilog.vector.body208
                                        #   Parent Loop BB29_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vld	$vr0, $a2, 0
	vst	$vr0, $a3, 0
	...
	addi.d	$a3, $a3, 16
	bnez	$a1, .LBB29_43
# %bb.44:                               # %vec.epilog.middle.block212
                                        #   in Loop: Header=BB29_4 Depth=1
	beq	$fp, $a0, .LBB29_47
...
# %bb.79:                               # %iter.check254
	...
	ori	$a4, $zero, 64
	bltu	$a3, $a4, .LBB29_93
# %bb.80:                               # %vector.main.loop.iter.check256
	ori	$a2, $zero, 16
	bgeu	$a1, $a2, .LBB29_86
# %bb.81:
	move	$a2, $zero
...
.LBB29_87:                              # %vector.body260
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB29_87
# %bb.88:                               # %middle.block265
	beq	$a2, $a1, .LBB29_95
# %bb.89:                               # %vec.epilog.iter.check270
	andi	$a3, $a1, 12
	beqz	$a3, .LBB29_93
.LBB29_90:                              # %vec.epilog.ph269
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 2
	slli.d	$a2, $a2, 2
	sub.d	$a3, $a5, $a2
	...
	alsl.d	$a5, $a5, $s1, 2
	.p2align	4, , 16
.LBB29_91:                              # %vec.epilog.vector.body275
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	vst	$vr0, $a5, 0
	addi.d	$a3, $a3, 4
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB29_91
# %bb.92:                               # %vec.epilog.middle.block279
	beq	$a2, $a1, .LBB29_95
...
.LBB29_99:                              # %invoke.cont31
	...
	st.w	$s5, $fp, 4
	blt	$s5, $a0, .LBB29_113
# %bb.100:                              # %iter.check287
	ld.d	$a0, $fp, 16
	ori	$a2, $zero, 4
	move	$a1, $zero
	bltu	$s5, $a2, .LBB29_111
# %bb.101:                              # %iter.check287
	sub.d	$a2, $a0, $s2
	ori	$a3, $zero, 64
	bltu	$a2, $a3, .LBB29_111
# %bb.102:                              # %vector.main.loop.iter.check289
	ori	$a1, $zero, 16
	bgeu	$s5, $a1, .LBB29_104
# %bb.103:
	move	$a1, $zero
	b	.LBB29_108
.LBB29_104:                             # %vector.ph290
...
.LBB29_105:                             # %vector.body293
	...
	addi.d	$a3, $a3, 64
	bnez	$a4, .LBB29_105
# %bb.106:                              # %middle.block298
	beq	$a1, $s5, .LBB29_113
# %bb.107:                              # %vec.epilog.iter.check303
	andi	$a2, $s5, 12
	beqz	$a2, .LBB29_111
.LBB29_108:                             # %vec.epilog.ph302
	move	$a4, $a1
	...
	alsl.d	$a4, $a4, $s2, 2
	.p2align	4, , 16
.LBB29_109:                             # %vec.epilog.vector.body308
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	vst	$vr0, $a3, 0
	addi.d	$a2, $a2, 4
	...
	addi.d	$a4, $a4, 16
	bnez	$a2, .LBB29_109
# %bb.110:                              # %vec.epilog.middle.block312
	beq	$a1, $s5, .LBB29_113
...
# %bb.41:                               # %iter.check452
	...
	ori	$a4, $zero, 64
	bltu	$a3, $a4, .LBB32_76
# %bb.42:                               # %vector.main.loop.iter.check454
	ori	$a2, $zero, 16
	bgeu	$a1, $a2, .LBB32_69
# %bb.43:
	move	$a2, $zero
...
# %bb.68:                               # %_ZNK20btAlignedObjectArrayIjE4copyEiiPj.exit.i.i
	...
	bnez	$a1, .LBB32_98
	b	.LBB32_99
.LBB32_69:                              # %vector.ph455
	bstrpick.d	$a2, $a1, 30, 4
	slli.d	$a2, $a2, 4
	addi.d	$a3, $a0, 32
	addi.d	$a4, $s4, 32
	move	$a5, $a2
.LBB32_70:                              # %vector.body458
                                        # =>This Inner Loop Header: Depth=1
	xvld	$xr0, $a3, -32
	xvld	$xr1, $a3, 0
	xvst	$xr0, $a4, -32
	...
	addi.d	$a4, $a4, 64
	bnez	$a5, .LBB32_70
# %bb.71:                               # %middle.block463
	beq	$a2, $a1, .LBB32_78
# %bb.72:                               # %vec.epilog.iter.check468
	andi	$a3, $a1, 12
	beqz	$a3, .LBB32_76
.LBB32_73:                              # %vec.epilog.ph467
	move	$a5, $a2
	bstrpick.d	$a2, $a1, 30, 2
	slli.d	$a2, $a2, 2
	sub.d	$a3, $a5, $a2
	...
	alsl.d	$a5, $a5, $s4, 2
	.p2align	4, , 16
.LBB32_74:                              # %vec.epilog.vector.body473
                                        # =>This Inner Loop Header: Depth=1
	vld	$vr0, $a4, 0
	vst	$vr0, $a5, 0
	addi.d	$a3, $a3, 4
	...
	addi.d	$a5, $a5, 16
	bnez	$a3, .LBB32_74
# %bb.75:                               # %vec.epilog.middle.block477
	beq	$a2, $a1, .LBB32_78
