...
# %bb.0:                                # %entry
	...
	fst.s	$ft2, $a5, 104
	st.w	$zero, $a5, 108
	pcalau12i	$a2, %got_pc_hi20(_ZNK13btConvexShape44localGetSupportVertexWithoutMarginNonVirtualERK9btVector3)
	ld.d	$a2, $a2, %got_pc_lo12(_ZNK13btConvexShape44localGetSupportVertexWithoutMarginNonVirtualERK9btVector3)
	pcalau12i	$a3, %got_pc_hi20(_ZNK13btConvexShape31localGetSupportVertexNonVirtualERK9btVector3)
	ld.d	$a3, $a3, %got_pc_lo12(_ZNK13btConvexShape31localGetSupportVertexNonVirtualERK9btVector3)
	st.d	$a0, $a5, 112
	st.d	$a1, $a5, 120
	masknez	$a0, $a2, $a6
	maskeqz	$a1, $a3, $a6
...
.LBB14_2:                               # %if.then
	...
	slli.d	$a6, $s0, 2
	pcalau12i	$a2, %pc_hi20(_ZZN12gjkepa2_impl3EPA6expandEjPNS_3GJK3sSVEPNS0_5sFaceEjRNS0_8sHorizonEE4i1m3)
	fmadd.s	$fa0, $fa1, $fa2, $fa0
	fld.s	$fa1, $a3, 16
	pcalau12i	$a7, %pc_hi20(.LCPI14_0)
	fld.s	$fa2, $a7, %pc_lo12(.LCPI14_0)
	addi.d	$a2, $a2, %pc_lo12(_ZZN12gjkepa2_impl3EPA6expandEjPNS_3GJK3sSVEPNS0_5sFaceEjRNS0_8sHorizonEE4i1m3)
	ldx.wu	$a2, $a2, $a6
	fsub.s	$fa0, $fa0, $fa1
