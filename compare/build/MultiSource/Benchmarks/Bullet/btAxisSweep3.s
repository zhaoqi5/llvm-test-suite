...
# %bb.8:                                # %middle.block
	beq	$a3, $a4, .LBB3_11
.LBB3_9:                                # %invoke.cont46.preheader
	add.d	$a1, $a0, $a1
	.p2align	4, , 16
.LBB3_10:                               # %invoke.cont46
                                        # =>This Inner Loop Header: Depth=1
	st.d	$zero, $a2, 0
	st.d	$zero, $a2, 16
	addi.d	$a2, $a2, 96
	bne	$a2, $a1, .LBB3_10
.LBB3_11:                               # %arrayctor.cont
	st.d	$a0, $fp, 72
	st.w	$s4, $fp, 68
	st.w	$zero, $fp, 64
	ori	$a1, $zero, 1
...
.LBB3_14:                               # %vector.body62
	...
	addi.d	$a4, $a4, 768
	bnez	$a5, .LBB3_14
# %bb.15:                               # %middle.block66
	beq	$a2, $a3, .LBB3_19
.LBB3_16:                               # %for.body.preheader69
	alsl.d	$a2, $a1, $a1, 1
	slli.d	$a2, $a2, 5
	add.d	$a2, $a2, $a0
	addi.d	$a2, $a2, 60
...
.LBB11_37:
	vld	$vr0, $sp, 16                   # 16-byte Folded Reload
.LBB11_38:                              # %_ZNK20btAlignedObjectArrayI16btBroadphasePairE4copyEiiPS0_.exit.i.i52
	ld.d	$a0, $s0, 16
	beqz	$a0, .LBB11_41
# %bb.39:                               # %_ZNK20btAlignedObjectArrayI16btBroadphasePairE4copyEiiPS0_.exit.i.i52
	ld.b	$a1, $s0, 24
	andi	$a1, $a1, 1
	beqz	$a1, .LBB11_41
# %bb.40:                               # %if.then2.i.i.i59
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
	vld	$vr0, $sp, 16                   # 16-byte Folded Reload
.LBB11_41:                              # %_ZN20btAlignedObjectArrayI16btBroadphasePairE10deallocateEv.exit.i.i58
	ori	$a0, $zero, 1
	st.b	$a0, $s0, 24
	st.d	$s1, $s0, 16
	st.w	$s2, $s0, 8
.LBB11_42:                              # %for.body10.lr.ph.i30
	slli.d	$a0, $s3, 5
	.p2align	4, , 16
.LBB11_43:                              # %for.body10.i35
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a1, $s0, 16
	add.d	$a2, $a1, $a0
	vstx	$vr0, $a1, $a0
...
.LBB11_44:
	move	$s3, $s2
.LBB11_45:                              # %_ZN20btAlignedObjectArrayI16btBroadphasePairE6resizeEiRKS0_.exit73
	st.w	$s3, $s0, 4
	st.w	$zero, $fp, 148
.LBB11_46:                              # %if.end38
...
.LBB24_37:
	vld	$vr0, $sp, 16                   # 16-byte Folded Reload
.LBB24_38:                              # %_ZNK20btAlignedObjectArrayI16btBroadphasePairE4copyEiiPS0_.exit.i.i53
	ld.d	$a0, $s0, 16
	beqz	$a0, .LBB24_41
# %bb.39:                               # %_ZNK20btAlignedObjectArrayI16btBroadphasePairE4copyEiiPS0_.exit.i.i53
	ld.b	$a1, $s0, 24
	andi	$a1, $a1, 1
	beqz	$a1, .LBB24_41
# %bb.40:                               # %if.then2.i.i.i60
	pcaddu18i	$ra, %call36(_Z21btAlignedFreeInternalPv)
	jirl	$ra, $ra, 0
	vld	$vr0, $sp, 16                   # 16-byte Folded Reload
.LBB24_41:                              # %_ZN20btAlignedObjectArrayI16btBroadphasePairE10deallocateEv.exit.i.i59
	ori	$a0, $zero, 1
	st.b	$a0, $s0, 24
	st.d	$s1, $s0, 16
	st.w	$s2, $s0, 8
.LBB24_42:                              # %for.body10.lr.ph.i31
	slli.d	$a0, $s3, 5
	.p2align	4, , 16
.LBB24_43:                              # %for.body10.i36
                                        # =>This Inner Loop Header: Depth=1
	ld.d	$a1, $s0, 16
	add.d	$a2, $a1, $a0
	vstx	$vr0, $a1, $a0
...
.LBB24_44:
	move	$s3, $s2
.LBB24_45:                              # %_ZN20btAlignedObjectArrayI16btBroadphasePairE6resizeEiRKS0_.exit74
	st.w	$s3, $s0, 4
	st.w	$zero, $fp, 156
.LBB24_46:                              # %if.end38
	ld.d	$s8, $sp, 40                    # 8-byte Folded Reload
...
.LBB50_9:                               # %while.body.i82
	...
	move	$a0, $a5
	bltu	$a7, $a4, .LBB50_9
# %bb.10:                               # %_ZN20btAxisSweep3InternalItE11sortMinDownEitP12btDispatcherb.exit96.loopexit
	ld.d	$a0, $s0, 88
.LBB50_11:                              # %_ZN20btAxisSweep3InternalItE11sortMinDownEitP12btDispatcherb.exit96
	ld.hu	$a2, $s6, 68
	alsl.d	$a1, $a2, $a0, 2
	slli.d	$a2, $a2, 2
	ldx.hu	$a0, $a0, $a2
...
.LBB50_13:                              # %while.body.i111
	...
	move	$a0, $a5
	bltu	$a7, $a4, .LBB50_13
.LBB50_14:                              # %_ZN20btAxisSweep3InternalItE11sortMaxDownEitP12btDispatcherb.exit125
	ld.hu	$a2, $s6, 64
	ori	$a1, $zero, 2
	ori	$a4, $zero, 1
	move	$a0, $s0
...
# %bb.10:                               # %land.rhs.lr.ph.i29
	...
	ori	$a6, $zero, 60
	.p2align	4, , 16
.LBB54_11:                              # %land.rhs.i40
                                        # =>This Inner Loop Header: Depth=1
	ld.hu	$t1, $a4, 4
	ld.d	$a1, $fp, 64
	bltu	$t0, $t1, .LBB54_14
# %bb.12:                               # %while.body.i42
	...
	bnez	$a7, .LBB54_11
# %bb.13:                               # %while.body.i42._ZN20btAxisSweep3InternalItE9sortMinUpEitP12btDispatcherb.exit.loopexit_crit_edge
	ld.d	$a1, $fp, 64
...
# %bb.23:                               # %land.rhs.lr.ph.i29.1
	...
	ori	$a6, $zero, 60
	.p2align	4, , 16
.LBB54_24:                              # %land.rhs.i40.1
                                        # =>This Inner Loop Header: Depth=1
	ld.hu	$t1, $a4, 4
	ld.d	$a1, $fp, 64
	bltu	$t0, $t1, .LBB54_27
# %bb.25:                               # %while.body.i42.1
	...
	bstrpick.d	$t0, $t0, 15, 0
	bnez	$a7, .LBB54_24
# %bb.26:                               # %while.body.i42.1._ZN20btAxisSweep3InternalItE9sortMinUpEitP12btDispatcherb.exit.loopexit.1_crit_edge
	ld.d	$a1, $fp, 64
...
# %bb.36:                               # %land.rhs.lr.ph.i29.2
	...
	ori	$a6, $zero, 60
	.p2align	4, , 16
.LBB54_37:                              # %land.rhs.i40.2
                                        # =>This Inner Loop Header: Depth=1
	ld.hu	$t1, $a4, 4
	ld.d	$a1, $fp, 64
	bltu	$t0, $t1, .LBB54_40
# %bb.38:                               # %while.body.i42.2
	...
	bstrpick.d	$t0, $t0, 15, 0
	bnez	$a7, .LBB54_37
# %bb.39:                               # %while.body.i42.2._ZN20btAxisSweep3InternalItE9sortMinUpEitP12btDispatcherb.exit.loopexit.2_crit_edge
	ld.d	$a1, $fp, 64
...
.LBB59_9:                               # %while.body.i83
	...
	move	$a0, $a5
	bltu	$a7, $a4, .LBB59_9
# %bb.10:                               # %_ZN20btAxisSweep3InternalIjE11sortMinDownEijP12btDispatcherb.exit98.loopexit
	ld.d	$a0, $s0, 96
.LBB59_11:                              # %_ZN20btAxisSweep3InternalIjE11sortMinDownEijP12btDispatcherb.exit98
	ld.wu	$a2, $s6, 76
	alsl.d	$a1, $a2, $a0, 3
	slli.d	$a2, $a2, 3
	ldx.w	$a0, $a0, $a2
...
.LBB59_13:                              # %while.body.i113
	...
	move	$a0, $a5
	bltu	$a7, $a4, .LBB59_13
.LBB59_14:                              # %_ZN20btAxisSweep3InternalIjE11sortMaxDownEijP12btDispatcherb.exit128
	ld.w	$a2, $s6, 68
	ori	$a1, $zero, 2
	ori	$a4, $zero, 1
	move	$a0, $s0
...
# %bb.12:                               # %while.body.i42
	...
	move	$a4, $a1
	bnez	$a7, .LBB63_11
# %bb.13:                               # %while.body.i42._ZN20btAxisSweep3InternalIjE9sortMinUpEijP12btDispatcherb.exit.loopexit_crit_edge
	ld.d	$a1, $fp, 72
...
# %bb.25:                               # %while.body.i42.1
	...
	move	$a4, $a1
	bnez	$a7, .LBB63_24
# %bb.26:                               # %while.body.i42.1._ZN20btAxisSweep3InternalIjE9sortMinUpEijP12btDispatcherb.exit.loopexit.1_crit_edge
	ld.d	$a1, $fp, 72
...
# %bb.38:                               # %while.body.i42.2
	...
	move	$a4, $a1
	bnez	$a7, .LBB63_37
# %bb.39:                               # %while.body.i42.2._ZN20btAxisSweep3InternalIjE9sortMinUpEijP12btDispatcherb.exit.loopexit.2_crit_edge
	ld.d	$a1, $fp, 72
