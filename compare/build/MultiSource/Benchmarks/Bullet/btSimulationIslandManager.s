...
# %bb.0:                                # %entry
	...
	move	$fp, $a0
	ld.d	$a0, $a0, 88
	pcalau12i	$a1, %pc_hi20(_ZTV25btSimulationIslandManager+16)
	addi.d	$a1, $a1, %pc_lo12(_ZTV25btSimulationIslandManager+16)
	st.d	$a1, $fp, 0
	beqz	$a0, .LBB3_3
# %bb.1:                                # %entry
	ld.b	$a1, $fp, 96
...
# %bb.13:                               # %land.rhs
	...
	addi.d	$a6, $a6, 1
	beq	$a7, $s6, .LBB9_12
# %bb.14:                               # %for.end.split.loop.exit163
                                        #   in Loop: Header=BB9_11 Depth=1
	addi.w	$a4, $s5, -1
	blt	$a4, $a1, .LBB9_10
	b	.LBB9_16
...
# %bb.29:                               # %_ZNK20btAlignedObjectArrayIP17btCollisionObjectE4copyEiiPS1_.exit.i.i
	...
	b	.LBB10_11
	.p2align	4, , 16
.LBB10_30:                              # %for.end.split.loop.exit119
                                        #   in Loop: Header=BB10_8 Depth=1
